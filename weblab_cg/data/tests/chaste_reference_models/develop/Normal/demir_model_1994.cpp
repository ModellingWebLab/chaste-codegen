...
#include "MathsCustomFunctions.hpp"
    ...
    double Dynamicdemir_model_1994FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_delayed_rectifying_potassium_current__g_K = var_delayed_rectifying_potassium_current__g_K_max * pow(var_delayed_rectifying_potassium_current__K_b / 1.0, 0.58999999999999997); // microS
