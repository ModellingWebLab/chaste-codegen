...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Dynamicnoble_model_1998FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Dynamicnoble_model_1998FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    
    Dynamicnoble_model_1998FromCellML::Dynamicnoble_model_1998FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                22,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Dynamicnoble_model_1998FromCellML>::Instance();
        Init();
    ...
    Dynamicnoble_model_1998FromCellML::~Dynamicnoble_model_1998FromCellML()
    {
    }
    
    void Dynamicnoble_model_1998FromCellML::VerifyStateVariables()
    {
        ...
        if (var_chaste_interface__intracellular_calcium_concentration__Ca_ds < 0)
        {
    ...
    double Dynamicnoble_model_1998FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicnoble_model_1998FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        const double var_chaste_interface__intracellular_sodium_concentration__d_Na_i_d_environment__time_converter = var_intracellular_sodium_concentration__d_Na_i_d_environment__time; // ___units_36
...
template<>
void OdeSystemInformation<Dynamicnoble_model_1998FromCellML>::Initialise(void)
{
...
extern "C"
{
    ...
    {
        return new Dynamicnoble_model_1998FromCellML(pSolver, pStimulus);
    }
