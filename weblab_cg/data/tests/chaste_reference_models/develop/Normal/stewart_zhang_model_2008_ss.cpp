...
#include "MathsCustomFunctions.hpp"
    ...
    double Dynamicstewart_zhang_model_2008_ssFromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    
    Dynamicstewart_zhang_model_2008_ssFromCellML::Dynamicstewart_zhang_model_2008_ssFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                20,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Dynamicstewart_zhang_model_2008_ssFromCellML>::Instance();
        Init();

    }
    
    Dynamicstewart_zhang_model_2008_ssFromCellML::~Dynamicstewart_zhang_model_2008_ssFromCellML()
    {
    }
    
    double Dynamicstewart_zhang_model_2008_ssFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicstewart_zhang_model_2008_ssFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Dynamicstewart_zhang_model_2008_ssFromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Dynamicstewart_zhang_model_2008_ssFromCellML)
extern "C"
{
    ...
    {
        return new Dynamicstewart_zhang_model_2008_ssFromCellML(pSolver, pStimulus);
    }
