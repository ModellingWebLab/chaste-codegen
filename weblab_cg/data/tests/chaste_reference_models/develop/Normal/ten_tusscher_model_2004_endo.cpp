...
#include "MathsCustomFunctions.hpp"
    ...
    double Dynamicten_tusscher_model_2004_endoFromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    
    Dynamicten_tusscher_model_2004_endoFromCellML::Dynamicten_tusscher_model_2004_endoFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                17,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Dynamicten_tusscher_model_2004_endoFromCellML>::Instance();
        Init();

    }
    
    Dynamicten_tusscher_model_2004_endoFromCellML::~Dynamicten_tusscher_model_2004_endoFromCellML()
    {
    }
    
    double Dynamicten_tusscher_model_2004_endoFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicten_tusscher_model_2004_endoFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Dynamicten_tusscher_model_2004_endoFromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Dynamicten_tusscher_model_2004_endoFromCellML)
extern "C"
{
    ...
    {
        return new Dynamicten_tusscher_model_2004_endoFromCellML(pSolver, pStimulus);
    }
