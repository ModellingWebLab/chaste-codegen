...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Dynamicespinosa_model_1998_normalFromCellML::UseCellMLDefaultStimulus()
    {
    ...
    Dynamicespinosa_model_1998_normalFromCellML::Dynamicespinosa_model_1998_normalFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                21,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Dynamicespinosa_model_1998_normalFromCellML>::Instance();
        Init();
    ...
    Dynamicespinosa_model_1998_normalFromCellML::~Dynamicespinosa_model_1998_normalFromCellML()
    {
    }
    
    double Dynamicespinosa_model_1998_normalFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicespinosa_model_1998_normalFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        rDY[8] = d_dt_chaste_interface__transient_outward_current_s_gate__s;
...
template<>
void OdeSystemInformation<Dynamicespinosa_model_1998_normalFromCellML>::Initialise(void)
{
...
extern "C"
{
    ...
    {
        return new Dynamicespinosa_model_1998_normalFromCellML(pSolver, pStimulus);
    }
