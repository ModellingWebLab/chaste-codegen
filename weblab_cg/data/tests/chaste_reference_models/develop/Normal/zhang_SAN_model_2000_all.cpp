...
#include "MathsCustomFunctions.hpp"
    ...
    Dynamiczhang_SAN_model_2000_allFromCellML::Dynamiczhang_SAN_model_2000_allFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                15,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Dynamiczhang_SAN_model_2000_allFromCellML>::Instance();
        Init();

    }
    
    Dynamiczhang_SAN_model_2000_allFromCellML::~Dynamiczhang_SAN_model_2000_allFromCellML()
    {
    }
    
    double Dynamiczhang_SAN_model_2000_allFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamiczhang_SAN_model_2000_allFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Dynamiczhang_SAN_model_2000_allFromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Dynamiczhang_SAN_model_2000_allFromCellML)
extern "C"
{
    ...
    {
        return new Dynamiczhang_SAN_model_2000_allFromCellML(pSolver, pStimulus);
    }
