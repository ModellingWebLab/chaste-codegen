...
#include "MathsCustomFunctions.hpp"
    ...
    Dynamicnoble_noble_SAN_model_1984FromCellML::Dynamicnoble_noble_SAN_model_1984FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                15,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Dynamicnoble_noble_SAN_model_1984FromCellML>::Instance();
        Init();

    }
    
    Dynamicnoble_noble_SAN_model_1984FromCellML::~Dynamicnoble_noble_SAN_model_1984FromCellML()
    {
    }
    
    double Dynamicnoble_noble_SAN_model_1984FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicnoble_noble_SAN_model_1984FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Dynamicnoble_noble_SAN_model_1984FromCellML>::Initialise(void)
{
...
extern "C"
{
    ...
    {
        return new Dynamicnoble_noble_SAN_model_1984FromCellML(pSolver, pStimulus);
    }
