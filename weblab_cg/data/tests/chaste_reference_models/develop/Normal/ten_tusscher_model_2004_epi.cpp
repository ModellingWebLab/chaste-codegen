...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Dynamicten_tusscher_model_2004_epiFromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Dynamicten_tusscher_model_2004_epiFromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    
    Dynamicten_tusscher_model_2004_epiFromCellML::Dynamicten_tusscher_model_2004_epiFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                17,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Dynamicten_tusscher_model_2004_epiFromCellML>::Instance();
        Init();
    ...
    Dynamicten_tusscher_model_2004_epiFromCellML::~Dynamicten_tusscher_model_2004_epiFromCellML()
    {
    }
    
    double Dynamicten_tusscher_model_2004_epiFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicten_tusscher_model_2004_epiFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Dynamicten_tusscher_model_2004_epiFromCellML>::Initialise(void)
{
...
extern "C"
{
    ...
    {
        return new Dynamicten_tusscher_model_2004_epiFromCellML(pSolver, pStimulus);
    }
