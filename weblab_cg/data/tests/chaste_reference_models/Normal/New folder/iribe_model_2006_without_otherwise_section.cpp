...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface__Force__P_2 = 0.001 * (-var_Force__f_23 - var_Force__g_12) * var_chaste_interface__Force__P_2 + 0.001 * var_chaste_interface__Force__P_1 * var_Force__f_12 + 0.001 * var_chaste_interface__Force__P_3 * var_Force__g_23; // 1 / millisecond
        ...
        const double d_dt_chaste_interface__calmodulin__Cmdn_Ca = -0.001 * var_chaste_interface__calmodulin__Cmdn_Ca * var_calmodulin__beta_cmdn + 0.001 * (-var_chaste_interface__calmodulin__Cmdn_Ca + var_calmodulin__Cmdn_tot) * var_calmodulin__alpha_cmdn * var_chaste_interface__intracellular_calcium_concentration__Ca_i; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x = 0.001 * (1.0 - var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x) * var_time_dependent_rectifier_potassium_current_x_gate__alpha_x - 0.001 * var_time_dependent_rectifier_potassium_current_x_gate__beta_x * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x; // 1 / millisecond
        const double var_time_dependent_rectifier_potassium_current__i_K = 0.007142857142857143 * (-var_cell_parameters__K_o * exp(-var_cell_parameters__F * var_chaste_interface__membrane_potential__V / (var_cell_parameters__R * var_cell_parameters__T)) + var_chaste_interface__intracellular_potassium_concentration__K_i) * var_time_dependent_rectifier_potassium_current__i_Kmax * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x; // nanoA
        const double var_time_independent_potassium_current__K_mk1 = 10.0; // millimolar
        const double var_time_independent_potassium_current__g_K1 = 1.0; // microS
        const double var_time_independent_potassium_current__i_K1 = (-var_reversal_potentials__E_K + var_chaste_interface__membrane_potential__V) * var_cell_parameters__K_o * var_time_independent_potassium_current__g_K1 / ((1.0 + exp(2.0 * (-10.0 - var_reversal_potentials__E_K + var_chaste_interface__membrane_potential__V) * var_cell_parameters__F / (var_cell_parameters__R * var_cell_parameters__T))) * (var_cell_parameters__K_o + var_time_independent_potassium_current__K_mk1)); // nanoA
        ...
        const double var_transient_outward_current__i_to = (-var_reversal_potentials__E_K + var_chaste_interface__membrane_potential__V) * var_transient_outward_current__g_to * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // nanoA
        const double d_dt_chaste_interface__intracellular_potassium_concentration__K_i = 0.001 * (-var_L_type_Ca_channel__i_Ca_L_K - var_potassium_background_current__i_b_K - var_time_dependent_rectifier_potassium_current__i_K - var_time_independent_potassium_current__i_K1 - var_transient_outward_current__i_to + 2.0 * var_sodium_potassium_pump__i_NaK) / (var_cell_parameters__F * var_cell_parameters__v_i); // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__troponin__Trpn_Ca = 0.001 * (-var_chaste_interface__troponin__Trpn_Ca + var_troponin__Trpn_tot) * var_chaste_interface__intracellular_calcium_concentration__Ca_i * var_troponin__alpha_trpn - 0.0003333333333333333 * (3.0 - 2.0 * var_Force__Force_norm) * var_chaste_interface__troponin__Trpn_Ca * var_troponin__beta_trpn; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__Force__P_0 = 0.001 * (-var_Force__beta_tm - var_Force__f_01) * var_chaste_interface__Force__P_0 + 0.001 * var_chaste_interface__Force__N_0 * var_Force__alpha_tm + 0.001 * var_chaste_interface__Force__P_1 * var_Force__g_01; // 1 / millisecond
        const double d_dt_chaste_interface__Force__P_1 = 0.001 * (-var_Force__beta_tm - var_Force__f_12 - var_Force__g_01) * var_chaste_interface__Force__P_1 + 0.001 * var_Force__N_1 * var_Force__alpha_tm + 0.001 * var_chaste_interface__Force__P_0 * var_Force__f_01 + 0.001 * var_chaste_interface__Force__P_2 * var_Force__g_12; // 1 / millisecond
        ...
        const double d_dt_chaste_interface__intracellular_calcium_concentration__Ca_i = -0.001 * var_SERCA__j_up - 0.001 * var_calmodulin__dCmdn_Ca_dtime - 0.001 * var_troponin__dTrpn_Ca_dtime + 0.0005 * (-var_L_type_Ca_channel__i_Ca_L_Ca - var_calcium_background_current__i_b_Ca + 2.0 * var_sodium_calcium_exchanger__i_NaCa) / (var_cell_parameters__F * var_cell_parameters__v_i) + 0.001 * var_RyR__j_rel * var_cell_parameters__v_SR / var_cell_parameters__v_i; // millimolar / millisecond
