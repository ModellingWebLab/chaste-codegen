...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_model_2004_apexFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_L_type_calcium_current__alpha = 1.3280467690946194 * (1.0 + 0.7 * exp(-160.0 * pow((1 + 0.025 * var_chaste_interface__membrane__V), 2.0)) - 0.75 * exp(-1.0 * pow((1 + 0.05 * var_chaste_interface__membrane__V), 2.0))) * exp(0.1 * var_chaste_interface__membrane__V) / (1.0 + 0.39841403072838577 * exp(0.1 * var_chaste_interface__membrane__V)); // per_millisecond
        ...
        const double var_L_type_calcium_current__i_CaL = (-var_L_type_calcium_current__E_CaL + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_calcium_current__O * var_L_type_calcium_current__g_CaL; // picoA_per_picoF
        const double d_dt_chaste_interface__calcium_fluxes__P_RyR = -0.04 * var_chaste_interface__calcium_fluxes__P_RyR - 0.1 * var_L_type_calcium_current__i_CaL * exp(-0.038580246913580245 * pow((-1 + 0.2 * var_chaste_interface__membrane__V), 2.0)) / var_L_type_calcium_current__i_CaL_max; // 1 / millisecond
        const double var_calcium_background_current__i_Cab = (-var_calcium_background_current__E_CaN + var_chaste_interface__membrane__V) * var_calcium_background_current__g_Cab; // picoA_per_picoF
