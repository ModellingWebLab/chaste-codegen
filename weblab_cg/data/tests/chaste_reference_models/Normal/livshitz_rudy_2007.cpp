...
#include "MathsCustomFunctions.hpp"
    ...
    double Celllivshitz_rudy_2007FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_Ca__Ca_i = -0.3333333333333333 * var_Ca__bmyo + 1.1547005383792515 * sqrt(-var_Ca__cmyo + 0.3333333333333333 * pow(var_Ca__bmyo, 2)) * cos(0.3333333333333333 * acos(0.09622504486493763 * pow((-var_Ca__cmyo + 0.3333333333333333 * pow(var_Ca__bmyo, 2)), (-1.5)) * (-2.0 * pow(var_Ca__bmyo, 3) - 27.0 * var_Ca__dmyo + 9.0 * var_Ca__bmyo * var_Ca__cmyo))); // mM
        ...
        const double var_IKp__ikp = (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * var_IKp__GKpmax / (1.0 + exp(1.2521739130434784 - 0.16722408026755853 * var_chaste_interface__cell__V)); // uA_per_uF
    ...
    void Celllivshitz_rudy_2007FromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_ICaL__fss = 1.0 / (1.0 + exp(4.0 + 0.125 * var_chaste_interface__cell__V)) + 0.6 / (1.0 + exp(2.5 - 0.05 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL__ibarca = 4.0 * (-var_Environment__Ca_o * var_ICaL__gacao + var_Ca__Ca_i * var_ICaL__gacai * exp(2.0 * var_Environment__FonRT * var_chaste_interface__cell__V)) * var_Environment__F * var_Environment__FonRT * var_ICaL__pca * var_chaste_interface__cell__V / (-1.0 + exp(2.0 * var_Environment__FonRT * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_ICaL__ibark = (-var_Environment__K_o * var_ICaL__gako + var_ICaL__gaki * var_chaste_interface__K__K_i * exp(var_Environment__FonRT * var_chaste_interface__cell__V)) * var_Environment__F * var_Environment__FonRT * var_ICaL__pk * var_chaste_interface__cell__V / (-1.0 + exp(var_Environment__FonRT * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_ICaL__ibarna = (-var_Environment__Na_o * var_ICaL__ganao + var_ICaL__ganai * var_chaste_interface__Na__Na_i * exp(var_Environment__FonRT * var_chaste_interface__cell__V)) * var_Environment__F * var_Environment__FonRT * var_ICaL__pna * var_chaste_interface__cell__V / (-1.0 + exp(var_Environment__FonRT * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_ICaL__ilca = var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_ICaL__ibarca; // uA_per_uF
        const double var_ICaL__ilcak = var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_ICaL__ibark; // uA_per_uF
        const double var_ICaL__ilcana = var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_ICaL__ibarna; // uA_per_uF
        const double var_ICaL__taud = 28.57142857142857 * (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__cell__V)) * var_ICaL__dss0 / (10.0 + var_chaste_interface__cell__V); // ms
        const double d_dt_chaste_interface_var_ICaL__d = (-var_chaste_interface__ICaL__d + var_ICaL__dss) / var_ICaL__taud; // 1 / ms
        const double var_ICaL__tauf = 1.0 / (0.02 + 0.0197 * exp(-0.11356900000000002 * pow((1 + 0.09999999999999999 * var_chaste_interface__cell__V), 2.0))); // ms
        ...
        const double var_ICaT__bss = 1.0 / (1.0 + exp(-1.2962962962962963 - 0.09259259259259259 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_ICaT__taub = 3.7 + 6.1 / (1.0 + exp(5.555555555555555 + 0.2222222222222222 * var_chaste_interface__cell__V)); // ms
        ...
        const double var_ICab__icab = (-0.5 * log(var_Environment__Ca_o / var_Ca__Ca_i) / var_Environment__FonRT + var_chaste_interface__cell__V) * var_ICab__gcab; // uA_per_uF
        const double var_IKr__r = 1.0 / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__cell__V)); // dimensionless
        const double var_IKr__tauxr = 1.0 / (0.00061 * (38.9 + var_chaste_interface__cell__V) / (-1.0 + exp(5.640499999999999 + 0.145 * var_chaste_interface__cell__V)) + 0.00138 * (14.2 + var_chaste_interface__cell__V) / (1.0 - exp(-1.7466 - 0.123 * var_chaste_interface__cell__V))); // ms
        ...
        const double var_INa__aH = 0.135 * var_INa__a * exp(-11.764705882352942 + 0.14705882352941177 * var_INa__shift_h - 0.14705882352941177 * var_chaste_interface__cell__V); // per_ms
        const double var_INa__aj = 1.0 * (37.78 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.2444 * var_chaste_interface__cell__V - 0.2444 * var_INa__shift_h) - 3.474e-05 * exp(0.04391 * var_INa__shift_h - 0.04391 * var_chaste_interface__cell__V)) * var_INa__a / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)); // per_ms
        const double var_INa__am = 0.32 * (47.13 + var_chaste_interface__cell__V) / (1.0 - exp(-4.713 - 0.1 * var_chaste_interface__cell__V)); // per_ms
        const double var_INa__bH = (310000.0 * exp(0.35 * var_chaste_interface__cell__V - 0.35 * var_INa__shift_h) + 3.56 * exp(0.079 * var_chaste_interface__cell__V - 0.079 * var_INa__shift_h)) * var_INa__a + 7.692307692307692 * (1.0 - var_INa__a) / (1.0 + exp(-0.9603603603603604 - 0.0900900900900901 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_INa__bj = 0.1212 * var_INa__a * exp(0.01052 * var_INa__shift_h - 0.01052 * var_chaste_interface__cell__V) / (1.0 + exp(-5.5312920000000005 - 0.1378 * var_chaste_interface__cell__V)) + 0.3 * (1.0 - var_INa__a) * exp(2.535e-07 * var_INa__shift_h - 2.535e-07 * var_chaste_interface__cell__V) / (1.0 + exp(-3.2 - 0.1 * var_chaste_interface__cell__V)); // per_ms
