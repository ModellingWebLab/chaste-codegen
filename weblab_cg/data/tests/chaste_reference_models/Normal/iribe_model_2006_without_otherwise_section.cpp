...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celliribe_model_2006_without_otherwise_sectionFromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane_potential__stim_amplitude = -0.004 * HeartConfig::Instance()->GetCapacitance() / var_cell_parameters__Cm; // uA_per_cm2
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_fast_sodium_current_h_gate__beta_h = 2000.0 / (1.0 + 320.0 * exp(-7.5 + 0.1 * var_fast_sodium_current__shift_INa_inact - 0.1 * var_chaste_interface__membrane_potential__V)); // per_second
        ...
        const double var_fast_sodium_current_m_gate__beta_m = 8000.0 * exp(-3.696 - 0.056 * var_chaste_interface__membrane_potential__V); // per_second
        ...
        const double var_time_dependent_rectifier_potassium_current__i_Kmax = 1.0; // nanoA
        const double var_time_dependent_rectifier_potassium_current_x_gate__alpha_x = 0.5 * exp(4.130000000000001 + 0.0826 * var_chaste_interface__membrane_potential__V) / (1.0 + exp(2.85 + 0.057 * var_chaste_interface__membrane_potential__V)); // per_second
        const double var_time_dependent_rectifier_potassium_current_x_gate__beta_x = 1.3 * exp(-1.2 - 0.06 * var_chaste_interface__membrane_potential__V) / (1.0 + exp(-0.8 - 0.04 * var_chaste_interface__membrane_potential__V)); // per_second
        const double var_time_dependent_rectifier_potassium_current__i_K = 0.007142857142857143 * (-var_cell_parameters__K_o * exp(-var_cell_parameters__F * var_chaste_interface__membrane_potential__V / (var_cell_parameters__R * var_cell_parameters__T)) + var_chaste_interface__intracellular_potassium_concentration__K_i) * var_time_dependent_rectifier_potassium_current__i_Kmax * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x; // nanoA
        ...
        const double var_time_independent_potassium_current__i_K1 = (-var_reversal_potentials__E_K + var_chaste_interface__membrane_potential__V) * var_cell_parameters__K_o * var_time_independent_potassium_current__g_K1 / ((1.0 + exp(2.0 * (-10.0 - var_reversal_potentials__E_K + var_chaste_interface__membrane_potential__V) * var_cell_parameters__F / (var_cell_parameters__R * var_cell_parameters__T))) * (var_cell_parameters__K_o + var_time_independent_potassium_current__K_mk1)); // nanoA
        const double var_transient_outward_current__g_to = 0.005; // microS
        const double var_transient_outward_current_r_gate__r_orig_deriv = 333.0 / (1.0 + exp(-0.8 - 0.2 * var_chaste_interface__membrane_potential__V)) - 333.0 * var_chaste_interface__transient_outward_current_r_gate__r; // 1 / second
        ...
        const double var_troponin__Trpn_Ca_orig_deriv = (-var_chaste_interface__troponin__Trpn_Ca + var_troponin__Trpn_tot) * var_chaste_interface__intracellular_calcium_concentration__Ca_i * var_troponin__alpha_trpn - 0.3333333333333333 * (3.0 - 2.0 * var_Force__Force_norm) * var_chaste_interface__troponin__Trpn_Ca * var_troponin__beta_trpn; // millimolar / second
