...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celliribe_model_2006_without_otherwise_sectionFromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane_potential__stim_amplitude = 0.001 * HeartConfig::Instance()->GetCapacitance() * -4.0 / var_cell_parameters__Cm; // uA_per_cm2
