...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellhund_rudy_2004_aFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IKr__r = 1.0 / (1.0 + 1.9142973750952155 * exp(0.06493506493506493 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_IKp__IKp = 0.00276 * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) / (1.0 + 3.4979389130252434 * exp(-0.16722408026755853 * var_chaste_interface__cell__V)); // uA_per_uF
    ...
    void Cellhund_rudy_2004_aFromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface__Irel__CaMKtrap = -0.00068 * var_chaste_interface__Irel__CaMKtrap + 0.05 * (-var_chaste_interface__Irel__CaMKtrap + var_Irel__CaMKactive) * var_Irel__CaMKactive; // 1 / millisecond
        ...
        const double d_dt_chaste_interface__Ito2__AA = 1.0 * var_Ito2__AAss - 1.0 * var_chaste_interface__Ito2__AA; // 1 / millisecond
        const double var_Ito2__PCl = 4e-07; // L_per_F_ms
        ...
        const double var_INaCa__denom2 = pow(var_INaCa__KmNao, 3.0) * var_INaCa__ca_i_NaCa + pow(var_chaste_interface__Na__Na_i, 3.0) * var_INaCa__KmCao + pow(var_INaCa__KmNai, 3.0) * (1.0 + var_INaCa__ca_i_NaCa / var_INaCa__KmCai) * var_Environment__Ca_o; // mM4
        const double var_INaCa__denom3 = pow(var_Environment__Na_o, 3.0) * var_INaCa__ca_i_NaCa + pow(var_chaste_interface__Na__Na_i, 3.0) * var_Environment__Ca_o + pow(var_Environment__Na_o, 3.0) * (1.0 + pow((var_chaste_interface__Na__Na_i / var_INaCa__KmNai), 3.0)) * var_INaCa__KmCai; // mM4
        const double var_ICaL__dpss = 9.0 - 8.0 / (1.0 + 4.9809407465345154e-09 * exp(-0.29411764705882354 * var_chaste_interface__cell__V)); // dimensionless
        const double d_dt_chaste_interface__ICaL__dp = 0.1 * var_ICaL__dpss - 0.1 * var_chaste_interface__ICaL__dp; // 1 / millisecond
        const double var_ICaL__dss = 1.0 / (1.0 + 1.810262405327738 * exp(-0.14836795252225518 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL__f2ss = 0.23 + 0.77 / (1.0 + 11.538788647862374 * exp(0.14285714285714285 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL__fss = 0.3 + 0.7 / (1.0 + 11.538788647862374 * exp(0.14285714285714285 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL__ibarca = 4.0 * (-15.0 + var_chaste_interface__cell__V) * (-var_Environment__Ca_o * var_ICaL__gacao + var_chaste_interface__Ca__Ca_ss * var_ICaL__gacai * exp(2.0 * (-15.0 + var_chaste_interface__cell__V) * var_Environment__FonRT)) * var_Environment__F * var_Environment__FonRT * var_ICaL__G_CaL_mult * var_ICaL__pca / (-1.0 + exp(2.0 * (-15.0 + var_chaste_interface__cell__V) * var_Environment__FonRT)); // uA_per_uF
        const double var_ICaL__ICaL = ((var_Environment__tissue == 0.0) ? (pow(var_chaste_interface__ICaL__d, var_chaste_interface__ICaL__dp) * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca * var_chaste_interface__ICaL__fca2 * var_ICaL__ibarca) : (var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca * var_chaste_interface__ICaL__fca2 * var_ICaL__ibarca)); // uA_per_uF
        ...
        const double d_dt_chaste_interface__ICaL__fca = (-var_chaste_interface__ICaL__fca + var_ICaL__fcass) / var_ICaL__taufca; // 1 / millisecond
        const double var_ICaL__taud = 0.59 + 1.5727983930317806 * exp(0.052 * var_chaste_interface__cell__V) / (1.0 + 5.562234967137882 * exp(0.132 * var_chaste_interface__cell__V)); // ms
        const double d_dt_chaste_interface__ICaL__d = (-var_chaste_interface__ICaL__d + var_ICaL__dss) / var_ICaL__taud; // 1 / millisecond
        const double var_ICaL__tauf = 1.0 / (0.0529 + 0.2411 * exp(-pow((-0.436113 + 0.045 * var_chaste_interface__cell__V), 2.0))); // ms
        const double d_dt_chaste_interface__ICaL__f = (-var_chaste_interface__ICaL__f + var_ICaL__fss) / var_ICaL__tauf; // 1 / millisecond
        const double var_ICaL__tauf2 = 1.0 / (0.0054 + 0.0423 * exp(-pow((-1.0957834 + 0.059 * var_chaste_interface__cell__V), 2.0))); // ms
        const double d_dt_chaste_interface__ICaL__f2 = (-var_chaste_interface__ICaL__f2 + var_ICaL__f2ss) / var_ICaL__tauf2; // 1 / millisecond
        const double var_ICaL__taufca2 = 125.0 + 300.0 / (1.0 + 0.012588142242433998 * exp(-25.0 * var_ICaL__ICaL)); // ms
        const double d_dt_chaste_interface__ICaL__fca2 = (-var_chaste_interface__ICaL__fca2 + var_ICaL__fca2ss) / var_ICaL__taufca2; // 1 / millisecond
        const double var_ICab__ICab = 7.980336e-07 * (-0.341 * var_Environment__Ca_o + var_chaste_interface__Ca__Ca_i * exp(2.0 * var_Environment__FonRT * var_chaste_interface__cell__V)) * var_Environment__F * var_Environment__FonRT * var_chaste_interface__cell__V / (-1.0 + exp(2.0 * var_Environment__FonRT * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_IKr__r = 1.0 / (1.0 + 1.9142973750952155 * exp(0.06493506493506493 * var_chaste_interface__cell__V)); // dimensionless
        const double var_IKr__tauxr = 1.0 / (0.0003 * (38.3608 + var_chaste_interface__cell__V) / (-1.0 + 343.26878155836135 * exp(0.1522 * var_chaste_interface__cell__V)) + 0.0006 * (-1.7384 + var_chaste_interface__cell__V) / (1.0 - 1.2667092551679247 * exp(-0.136 * var_chaste_interface__cell__V))); // ms
        ...
        const double var_IKs__tauxs = 1.0 / (7.61e-05 * (44.6 + var_chaste_interface__cell__V) / (1.0 - 7.686826663777435e-194 * exp(-9.97 * var_chaste_interface__cell__V)) + 0.00036 * (-0.55 + var_chaste_interface__cell__V) / (-1.0 + 0.9320209369595469 * exp(0.128 * var_chaste_interface__cell__V))); // ms
        const double var_IKs__xss = 1.0 / (1.0 + 1.5297452443425992 * exp(-0.04048582995951417 * var_chaste_interface__cell__V)); // dimensionless
        const double d_dt_chaste_interface__IKs__xs1 = (-var_chaste_interface__IKs__xs1 + var_IKs__xss) / var_IKs__tauxs; // 1 / millisecond
        const double d_dt_chaste_interface__IKs__xs2 = 0.5 * (-var_chaste_interface__IKs__xs2 + var_IKs__xss) / var_IKs__tauxs; // 1 / millisecond
        const double var_INa__ah = ((var_chaste_interface__cell__V >= -40.0) ? (0.0) : (1.0495108254269642e-06 * exp(-0.14705882352941177 * var_chaste_interface__cell__V))); // per_ms
        const double var_INa__aj = ((var_chaste_interface__cell__V >= -40.0) ? (0.0) : (1.0 * (37.78 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.2444 * var_chaste_interface__cell__V) - 3.474e-05 * exp(-0.04391 * var_chaste_interface__cell__V)) / (1.0 + 50262745825.95399 * exp(0.311 * var_chaste_interface__cell__V)))); // per_ms
        ...
        const double var_INa__bh = ((var_chaste_interface__cell__V >= -40.0) ? (7.692307692307692 / (1.0 + 0.382754931414913 * exp(-0.0900900900900901 * var_chaste_interface__cell__V))) : (310000.0 * exp(0.35 * var_chaste_interface__cell__V) + 3.56 * exp(0.079 * var_chaste_interface__cell__V))); // per_ms
        ...
        const double var_INa__bj = ((var_chaste_interface__cell__V >= -40.0) ? (0.3 * exp(-2.535e-07 * var_chaste_interface__cell__V) / (1.0 + 0.040762203978366204 * exp(-0.1 * var_chaste_interface__cell__V))) : (0.1212 * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 + 0.003960868339904256 * exp(-0.1378 * var_chaste_interface__cell__V)))); // per_ms
        ...
        const double var_INaK__fnak = 1.0 / (1.0 + 0.1245 * exp(-0.1 * var_Environment__FonRT * var_chaste_interface__cell__V) + 0.0365 * var_INaK__sigma * exp(-var_Environment__FonRT * var_chaste_interface__cell__V)); // dimensionless
        const double var_INaK__INaK = 1.0 * var_Environment__K_o * var_INaK__fnak * var_INaK__ibarnak / ((1.0 + pow((var_INaK__kmnai / var_chaste_interface__Na__Na_i), 2.0)) * (var_Environment__K_o + var_INaK__kmko)); // uA_per_uF
        const double var_INal__amL = 0.32 * (47.13 + var_chaste_interface__cell__V) / (1.0 - 0.008977803730697244 * exp(-0.1 * var_chaste_interface__cell__V)); // per_ms
        const double var_INal__bmL = 0.08 * exp(-0.09090909090909091 * var_chaste_interface__cell__V); // per_ms
        const double d_dt_chaste_interface__INal__mL = (1.0 - var_chaste_interface__INal__mL) * var_INal__amL - var_INal__bmL * var_chaste_interface__INal__mL; // 1 / millisecond
        const double var_INal__hLss = 1.0 / (1.0 + 3011752.782123863 * exp(0.1639344262295082 * var_chaste_interface__cell__V)); // dimensionless
        const double d_dt_chaste_interface__INal__hL = 0.0016666666666666668 * var_INal__hLss - 0.0016666666666666668 * var_chaste_interface__INal__hL; // 1 / millisecond
        const double var_Irel__cafac = 1.0 / (1.0 + 28.03162489452615 * exp(66.66666666666667 * var_ICaL__ICaL)); // dimensionless
        const double var_Irel__riss = 1.0 / (1.0 + 1.1253517471925912e-07 * exp(80.0 * var_Irel__cafac + 40000.0 * var_chaste_interface__Ca__Ca_ss)); // dimensionless
        const double var_Irel__ross = var_Irel__dro_inf / (1.0 + 1.0 * pow(1 / var_ICaL__ICaL, 2.0)); // dimensionless
        const double d_dt_chaste_interface__Irel__ro = 0.3333333333333333 * var_Irel__ross - 0.3333333333333333 * var_chaste_interface__Irel__ro; // 1 / millisecond
        const double var_Irel__tauri = 3.0 + (350.0 - var_Irel__dtau_rel) / (1.0 + 3.059023205018258e-07 * exp(15.0 * var_Irel__cafac + 5000.0 * var_chaste_interface__Ca__Ca_ss)) + var_Irel__dtau_rel; // ms
        const double d_dt_chaste_interface__Irel__ri = (-var_chaste_interface__Irel__ri + var_Irel__riss) / var_Irel__tauri; // 1 / millisecond
        const double var_Irel__vg = ((var_Environment__tissue == 0.0) ? (1.0 / (1.0 + 13.463738035001692 * exp(0.2 * var_ICaL__ibarca))) : (1.0)); // dimensionless
        ...
        const double d_dt_chaste_interface__Ca__Ca_jsr = (-var_Irel__irelcicr + var_Idiff_Itr__itr) * var_Ca__bcsqn; // mM / millisecond
        const double var_Ito__ay = 5.047412949866384 * exp(0.04 * var_chaste_interface__cell__V) / (1.0 + 0.20189651799465538 * exp(0.04 * var_chaste_interface__cell__V)); // per_ms
        const double var_Ito__ay2 = 0.03 / (1.0 + 162754.79141900392 * exp(0.2 * var_chaste_interface__cell__V)); // per_ms
        const double var_Ito__ay3 = 0.00225 / (1.0 + 162754.79141900392 * exp(0.2 * var_chaste_interface__cell__V)); // per_ms
        const double var_Ito__by = 0.6830930611823139 * exp(-0.04 * var_chaste_interface__cell__V) / (1.0 + 0.02732372244729256 * exp(-0.04 * var_chaste_interface__cell__V)); // per_ms
        const double d_dt_chaste_interface__Ito__ydv = (1.0 - var_chaste_interface__Ito__ydv) * var_Ito__ay - var_Ito__by * var_chaste_interface__Ito__ydv; // 1 / millisecond
        const double var_Ito__by2 = 29.682631820515322 * exp(0.2 * var_chaste_interface__cell__V) / (1.0 + 148.4131591025766 * exp(0.2 * var_chaste_interface__cell__V)); // per_ms
        const double d_dt_chaste_interface__Ito__ydv2 = (1.0 - var_chaste_interface__Ito__ydv2) * var_Ito__ay2 - var_Ito__by2 * var_chaste_interface__Ito__ydv2; // 1 / millisecond
        const double var_Ito__by3 = 14.841315910257661 * exp(0.2 * var_chaste_interface__cell__V) / (1.0 + 148.4131591025766 * exp(0.2 * var_chaste_interface__cell__V)); // per_ms
        const double d_dt_chaste_interface__Ito__zdv = (1.0 - var_chaste_interface__Ito__zdv) * var_Ito__ay3 - var_Ito__by3 * var_chaste_interface__Ito__zdv; // 1 / millisecond
        const double var_Ito__rv = exp(0.0033333333333333335 * var_chaste_interface__cell__V); // dimensionless
        const double var_Ito2__Ito2_max = (-var_Environment__Cl_o * exp(var_Environment__FonRT * var_chaste_interface__cell__V) + var_chaste_interface__Cl__Cl_i) * var_Environment__F * var_Environment__FonRT * var_Ito2__PCl * var_chaste_interface__cell__V / (1.0 - exp(var_Environment__FonRT * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_Ito2__Ito2 = var_chaste_interface__Ito2__AA * var_Ito2__Ito2_max; // uA_per_uF
        ...
        const double d_dt_chaste_interface__Ca__Ca_nsr = -var_Iup_Ileak__ileak - var_Idiff_Itr__itr * var_cell__vjsr / var_cell__vnsr + var_Iup_Ileak__iup; // mM / millisecond
        const double var_cell__vss = 0.02 * var_cell__vcell; // uL
        const double d_dt_chaste_interface__Ca__Ca_i = ((-var_Iup_Ileak__iup + var_Iup_Ileak__ileak) * var_cell__vnsr / var_cell__vmyo + var_Idiff_Itr__idiff * var_cell__vss / var_cell__vmyo + 0.5 * (-var_ICab__ICab - var_IpCa__IpCa + 2.0 * var_INaCa__INaCa) * var_cell__AF / var_cell__vmyo) * var_Ca__bmyo; // millimolar / millisecond
        const double d_dt_chaste_interface__Ca__Ca_ss = (-var_Idiff_Itr__idiff + var_Irel__irelcicr * var_cell__vjsr / var_cell__vss - 0.5 * var_ICaL__ICaL * var_cell__AF / var_cell__vss) * var_Ca__bss; // mM / millisecond
        const double var_reversal_potentials__ECl = -log(var_Environment__Cl_o / var_chaste_interface__Cl__Cl_i) / var_Environment__FonRT; // mV
        const double var_IClb__IClb = (-var_reversal_potentials__ECl + var_chaste_interface__cell__V) * var_IClb__GClb; // uA_per_uF
        const double var_cell__clont = 0.5 * var_cell__i_Stim + var_IClb__IClb + var_Ito2__Ito2; // uA_per_uF
        const double var_reversal_potentials__EK = log(var_Environment__K_o / var_chaste_interface__K__K_i) / var_Environment__FonRT; // mV
        ...
        const double d_dt_chaste_interface__Cl__Cl_i = var_cell__AF * var_cell__clont / var_cell__vmyo + var_K__CTKCl + var_Na__CTNaCl; // mM / millisecond
        const double var_cell__naiont = 3.0 * var_INaCa__INaCa + 3.0 * var_INaK__INaK + var_INa__INa + var_INal__INal; // uA_per_uF
        const double d_dt_chaste_interface__Na__Na_i = -var_cell__AF * var_cell__naiont / var_cell__vmyo + var_Na__CTNaCl; // mM / millisecond
        const double var_reversal_potentials__prnak = 0.01833; // dimensionless
        const double var_reversal_potentials__EKs = log((var_Environment__Na_o * var_reversal_potentials__prnak + var_Environment__K_o) / (var_chaste_interface__Na__Na_i * var_reversal_potentials__prnak + var_chaste_interface__K__K_i)) / var_Environment__FonRT; // mV
        const double var_IKs__IKs = (-var_reversal_potentials__EKs + var_chaste_interface__cell__V) * var_IKs__gks * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2; // uA_per_uF
        const double var_cell__kiont = 0.5 * var_cell__i_Stim - 2.0 * var_INaK__INaK + var_IK1__IK1 + var_IKp__IKp + var_IKr__IKr + var_IKs__IKs + var_Ito__Ito; // uA_per_uF
        const double d_dt_chaste_interface__K__K_i = -var_cell__AF * var_cell__kiont / var_cell__vmyo + var_K__CTKCl; // mM / millisecond
        ...
        {
            const double var_cell__caiont = -2.0 * var_INaCa__INaCa + var_ICaL__ICaL + var_ICab__ICab + var_IpCa__IpCa; // uA_per_uF
            d_dt_chaste_interface__cell__V = -var_cell__caiont - var_cell__clont - var_cell__kiont - var_cell__naiont; // millivolt / millisecond
        }
