...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_noble_SAN_model_1984FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface__extracellular_potassium_concentration__Kc = 0.001 * ((-var_chaste_interface__extracellular_potassium_concentration__Kc + var_extracellular_potassium_concentration__Kb) * var_extracellular_potassium_concentration__V_e * var_extracellular_potassium_concentration__pf * var_membrane__F + var_extracellular_potassium_concentration__i_mK) / (var_extracellular_potassium_concentration__V_e * var_membrane__F); // millimolar / millisecond
