...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellten_tusscher_model_2004_epiFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_inward_rectifier_potassium_current__alpha_K1 = 0.1 / (1.0 + exp(-12.0 + 0.06 * var_chaste_interface__membrane__V - 0.06 * var_reversal_potentials__E_K)); // per_millisecond
        const double var_inward_rectifier_potassium_current__beta_K1 = (1.0 * exp(-1.0 + 0.1 * var_chaste_interface__membrane__V - 0.1 * var_reversal_potentials__E_K) + 3.0 * exp(0.02 + 0.0002 * var_chaste_interface__membrane__V - 0.0002 * var_reversal_potentials__E_K)) / (1.0 + exp(0.5 * var_reversal_potentials__E_K - 0.5 * var_chaste_interface__membrane__V)); // per_millisecond
