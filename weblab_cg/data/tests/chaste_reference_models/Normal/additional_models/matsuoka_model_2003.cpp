...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmatsuoka_model_2003FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_transient_outward_current_y2_gate__alpha_y2 = 0.0038 * exp(-1.1946902654867257 - 0.08849557522123894 * var_chaste_interface__membrane__Vm) / (1.0 + 0.051335 * exp(-1.1946902654867257 - 0.08849557522123894 * var_chaste_interface__membrane__Vm)); // per_millisecond
        const double var_transient_outward_current_y2_gate__beta_y2 = 0.0038 * exp(1.1946902654867257 + 0.08849557522123894 * var_chaste_interface__membrane__Vm) / (1.0 + 0.067083 * exp(1.1946902654867257 + 0.08849557522123894 * var_chaste_interface__membrane__Vm)); // per_millisecond
