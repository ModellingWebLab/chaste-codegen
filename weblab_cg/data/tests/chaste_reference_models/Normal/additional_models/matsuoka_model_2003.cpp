...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellmatsuoka_model_2003FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_internal_ion_concentrations__Cai = 0.5 * sqrt(pow(var_internal_ion_concentrations__b1, 2.0) + 4.0 * var_internal_ion_concentrations__c1) - 0.5 * var_internal_ion_concentrations__b1; // millimolar
    ...
    void Cellmatsuoka_model_2003FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_Ca_concentrations_in_SR__Carel = 0.5 * sqrt(pow(var_Ca_concentrations_in_SR__b1, 2.0) + 4.0 * var_Ca_concentrations_in_SR__c1) - 0.5 * var_Ca_concentrations_in_SR__b1; // millimolar
        const double var_L_type_Ca_channel__P_CaL = 8712.0; // picoA_per_millimolar
