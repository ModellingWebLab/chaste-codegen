...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellmatsuoka_model_2003FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = HeartConfig::Instance()->GetCapacitance() * -4000.0 / var_membrane__Cm; // uA_per_cm2
