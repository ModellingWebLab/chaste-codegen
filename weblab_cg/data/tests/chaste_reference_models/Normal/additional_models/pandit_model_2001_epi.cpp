...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellpandit_model_2001_epiFromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = -0.0006 * HeartConfig::Instance()->GetCapacitance() / var_membrane__Cm; // uA_per_cm2
    ...
    void Cellpandit_model_2001_epiFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_membrane__R = 8314.5; // millijoule_per_mole_kelvin
        const double var_membrane__T = 295.0; // kelvin
        const double var_Ca_independent_transient_outward_K_current_r_gate__r_infinity = 1.0 / (1.0 + exp(-0.9281961471103327 - 0.08756567425569177 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_Ca_independent_transient_outward_K_current_r_gate__tau_r = 1.0 / (45.16 * exp(1.7885000000000002 + 0.03577 * var_chaste_interface__membrane__V) + 98.9 * exp(-3.8000000000000003 - 0.1 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_Ca_independent_transient_outward_K_current_s_gate__s_infinity = 1.0 / (1.0 + exp(6.58038087767464 + 0.14526227103034528 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_Ca_independent_transient_outward_K_current_s_slow_gate__s_slow_infinity = 1.0 / (1.0 + exp(6.58038087767464 + 0.14526227103034528 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_L_type_Ca_channel__i_Ca_L = (-var_L_type_Ca_channel__E_Ca_L + var_chaste_interface__membrane__V) * ((0.1 - 0.1 * var_chaste_interface__L_type_Ca_channel_Ca_inact_gate__Ca_inact) * var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12 + (0.9 + 0.1 * var_chaste_interface__L_type_Ca_channel_Ca_inact_gate__Ca_inact) * var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11) * var_L_type_Ca_channel__g_Ca_L * var_chaste_interface__L_type_Ca_channel_d_gate__d; // nanoA
        const double var_L_type_Ca_channel_d_gate__d_infinity = 1.0 / (1.0 + exp(-3.0600000000000005 - 0.2 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_L_type_Ca_channel_f_11_gate__f_11_infinity = 1.0 / (1.0 + exp(4.944444444444444 + 0.18518518518518517 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_L_type_Ca_channel_f_11_gate__tau_f_11 = 0.0017 + 0.015 / (1.0 + exp(3.0 + 0.04 * var_chaste_interface__membrane__V)) + 0.04 / (1.0 + exp(1.0 - 0.04 * var_chaste_interface__membrane__V)) + 0.105 * exp(-14.0625 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2.0)); // second
        ...
        const double var_L_type_Ca_channel_f_12_gate__f_12_infinity = 1.0 / (1.0 + exp(4.944444444444444 + 0.18518518518518517 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_L_type_Ca_channel_f_12_gate__tau_f_12 = 0.0017 + 0.015 / (1.0 + exp(3.0 + 0.04 * var_chaste_interface__membrane__V)) + 0.08 / (1.0 + exp(-11.0 - 0.2 * var_chaste_interface__membrane__V)) + 0.041 * exp(-15.340277777777777 * pow((1 + 0.02127659574468085 * var_chaste_interface__membrane__V), 2.0)); // second
        ...
        const double var_hyperpolarisation_activated_current_y_gate__tau_y = 1.0 / (0.5623 * exp(-5.637773079633544 - 0.07047216349541931 * var_chaste_interface__membrane__V) + 0.11885 * exp(2.8198801550934083 + 0.035248501938667604 * var_chaste_interface__membrane__V)); // second
        const double var_hyperpolarisation_activated_current_y_gate__y_infinity = 1.0 / (1.0 + exp(13.225190839694655 + 0.09541984732824427 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_sodium_current_h_gate__tau_h = ((var_chaste_interface__membrane__V >= -40.0) ? (0.0004537 + 0.0004537 * exp(-0.9603603603603604 - 0.0900900900900901 * var_chaste_interface__membrane__V)) : (0.00349 / (310000.0 * exp(0.35 * var_chaste_interface__membrane__V) + 0.135 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V) + 3.56 * exp(0.079 * var_chaste_interface__membrane__V)))); // second
        ...
        const double var_sodium_current_j_gate__tau_j = ((var_chaste_interface__membrane__V >= -40.0) ? (0.01163 * (1.0 + exp(-3.2 - 0.1 * var_chaste_interface__membrane__V)) / exp(-2.535e-07 * var_chaste_interface__membrane__V)) : (0.00349 / (0.1212 * exp(-0.01052 * var_chaste_interface__membrane__V) / (1.0 + exp(-5.5312920000000005 - 0.1378 * var_chaste_interface__membrane__V)) + (37.78 + var_chaste_interface__membrane__V) * (-127140.0 * exp(0.2444 * var_chaste_interface__membrane__V) - 3.474e-05 * exp(-0.04391 * var_chaste_interface__membrane__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V))))); // second
        ...
        const double var_sodium_current_m_gate__m_infinity = 1.0 / (1.0 + exp(-6.923076923076923 - 0.15384615384615385 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_sodium_current_m_gate__tau_m = 0.00136 / (0.08 * exp(-0.09090909090909091 * var_chaste_interface__membrane__V) + 0.32 * (47.13 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.713 - 0.1 * var_chaste_interface__membrane__V))); // second
        ...
        const double var_steady_state_outward_K_current__g_ss = 0.007; // microS
        const double var_steady_state_outward_K_current_r_ss_gate__r_ss_infinity = 1.0 / (1.0 + exp(-0.9729272419627749 - 0.08460236886632826 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_steady_state_outward_K_current_r_ss_gate__tau_r_ss = 10.0 / (45.16 * exp(1.7885000000000002 + 0.03577 * var_chaste_interface__membrane__V) + 98.9 * exp(-3.8000000000000003 - 0.1 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_steady_state_outward_K_current_s_ss_gate__s_ss_infinity = 1.0 / (1.0 + exp(8.495145631067961 + 0.0970873786407767 * var_chaste_interface__membrane__V)); // dimensionless
