...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellpandit_model_2001_epiFromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = 0.001 * HeartConfig::Instance()->GetCapacitance() * -0.6 / var_membrane__Cm; // uA_per_cm2
