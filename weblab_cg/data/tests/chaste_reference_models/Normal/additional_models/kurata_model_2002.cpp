...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellkurata_model_2002FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_L_type_calcium_channel_current_f_gate__tau_f = 44.3 + 257.1 * exp(-pow((2.3381294964028774 + 0.07194244604316546 * var_chaste_interface__membrane__V), 2.0)); // millisecond
