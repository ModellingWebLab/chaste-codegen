...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellkurata_model_2002FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface__calcium_buffering__fCQ = var_calcium_buffering__delta_fCQ; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa = (-var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa + var_L_type_calcium_channel_current_fCa_gate__fCa_infinity) / var_L_type_calcium_channel_current_fCa_gate__tau_fCa; // 1 / millisecond
        ...
        const double d_dt_chaste_interface__calcium_buffering__fCMs = var_calcium_buffering__delta_fCMs; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__intracellular_ion_concentrations__Ca_rel = -var_intracellular_calcium_dynamics__j_rel - var_calcium_buffering__CQ_tot * var_calcium_buffering__delta_fCQ + var_intracellular_calcium_dynamics__j_tr; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__calcium_buffering__fCMi = var_calcium_buffering__delta_fCMi; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__calcium_buffering__fTC = var_calcium_buffering__delta_fTC; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__calcium_buffering__fTMC = var_calcium_buffering__delta_fTMC; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__calcium_buffering__fTMM = var_calcium_buffering__delta_fTMM; // millimolar / millisecond
        const double var_intracellular_ion_concentrations__Nao = 140.0; // millimolar
        ...
        const double d_dt_chaste_interface__intracellular_ion_concentrations__Ca_up = -var_intracellular_calcium_dynamics__j_tr * var_intracellular_ion_concentrations__V_rel / var_intracellular_ion_concentrations__V_up + var_intracellular_calcium_dynamics__j_up; // millimolar / millisecond
        const double d_dt_chaste_interface__intracellular_ion_concentrations__Cai = (var_intracellular_calcium_dynamics__j_Ca_dif * var_intracellular_ion_concentrations__V_sub - var_intracellular_calcium_dynamics__j_up * var_intracellular_ion_concentrations__V_up) / var_intracellular_ion_concentrations__V_i - var_calcium_buffering__CM_tot * var_calcium_buffering__delta_fCMi - var_calcium_buffering__TC_tot * var_calcium_buffering__delta_fTC - var_calcium_buffering__TMC_tot * var_calcium_buffering__delta_fTMC; // millimolar / millisecond
        const double var_membrane__Cm = 32.0; // picoF
        const double var_membrane__F = 9.6485e+16; // femtocoulomb_per_millimole
        const double var_membrane__R = 8314400000000000.0; // attojoule_per_millimole_kelvin
        const double var_membrane__T = 310.15; // kelvin
        const double var_AP_sensitive_currents_q_gate__q_infinity = 1.0 / (1.0 + 43.346708386257156 * exp(0.07692307692307693 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_AP_sensitive_currents_q_gate__tau_q = 6.06 + 39.102 / (0.01687167804569844 * exp(-0.08 * var_chaste_interface__membrane__V) + 6.421373212860154 * exp(0.1 * var_chaste_interface__membrane__V)); // millisecond
        const double var_AP_sensitive_currents_r_gate__r_infinity = 1.0 / (1.0 + 3.620697426975231 * exp(-0.06666666666666667 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_AP_sensitive_currents_r_gate__tau_r = 2.75352 + 14.405159999999999 / (16.301089225776582 * exp(0.09 * var_chaste_interface__membrane__V) + 0.021115273560419385 * exp(-0.12 * var_chaste_interface__membrane__V)); // millisecond
        const double d_dt_chaste_interface__AP_sensitive_currents_q_gate__q = (-var_chaste_interface__AP_sensitive_currents_q_gate__q + var_AP_sensitive_currents_q_gate__q_infinity) / var_AP_sensitive_currents_q_gate__tau_q; // 1 / millisecond
        const double d_dt_chaste_interface__AP_sensitive_currents_r_gate__r = (-var_chaste_interface__AP_sensitive_currents_r_gate__r + var_AP_sensitive_currents_r_gate__r_infinity) / var_AP_sensitive_currents_r_gate__tau_r; // 1 / millisecond
        const double var_L_type_calcium_channel_current__i_CaL = (-var_L_type_calcium_channel_current__E_CaL + var_chaste_interface__membrane__V) * var_L_type_calcium_channel_current__g_CaL * var_chaste_interface__L_type_calcium_channel_current_d_gate__d * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa * var_chaste_interface__L_type_calcium_channel_current_f_gate__f; // picoA
        const double var_L_type_calcium_channel_current_d_gate__alpha_d = -0.02839 * (35.0 + var_chaste_interface__membrane__V) / (-1.0 + 8.315287191035679e-07 * exp(-0.4 * var_chaste_interface__membrane__V)) - 0.0849 * var_chaste_interface__membrane__V / (-1.0 + exp(-0.2079866888519135 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_L_type_calcium_channel_current_d_gate__beta_d = 0.01143 * (-5.0 + var_chaste_interface__membrane__V) / (-1.0 + 0.1353352832366127 * exp(0.4 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_L_type_calcium_channel_current_d_gate__d_infinity = 1.0 / (1.0 + 0.09536916221554965 * exp(-0.16666666666666666 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double d_dt_chaste_interface__L_type_calcium_channel_current_d_gate__d = (-var_chaste_interface__L_type_calcium_channel_current_d_gate__d + var_L_type_calcium_channel_current_d_gate__d_infinity) / var_L_type_calcium_channel_current_d_gate__tau_d; // 1 / millisecond
        const double var_L_type_calcium_channel_current_f_gate__f_infinity = 1.0 / (1.0 + 403.4287934927351 * exp(0.2 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double d_dt_chaste_interface__L_type_calcium_channel_current_f_gate__f = (-var_chaste_interface__L_type_calcium_channel_current_f_gate__f + var_L_type_calcium_channel_current_f_gate__f_infinity) / var_L_type_calcium_channel_current_f_gate__tau_f; // 1 / millisecond
        const double var_T_type_calcium_channel_current__i_CaT = (-var_T_type_calcium_channel_current__E_CaT + var_chaste_interface__membrane__V) * var_T_type_calcium_channel_current__g_CaT * var_chaste_interface__T_type_calcium_channel_current_d_gate__d * var_chaste_interface__T_type_calcium_channel_current_f_gate__f; // picoA
        const double var_T_type_calcium_channel_current_d_gate__d_infinity = 1.0 / (1.0 + 0.01248367693374384 * exp(-0.16666666666666666 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_T_type_calcium_channel_current_d_gate__tau_d = 1.0 / (0.44446724062356635 * exp(-0.03333333333333333 * var_chaste_interface__membrane__V) + 2.566272372289483 * exp(0.03333333333333333 * var_chaste_interface__membrane__V)); // millisecond
        const double d_dt_chaste_interface__T_type_calcium_channel_current_d_gate__d = (-var_chaste_interface__T_type_calcium_channel_current_d_gate__d + var_T_type_calcium_channel_current_d_gate__d_infinity) / var_T_type_calcium_channel_current_d_gate__tau_d; // 1 / millisecond
        const double var_T_type_calcium_channel_current_f_gate__f_infinity = 1.0 / (1.0 + 60952.92615465271 * exp(0.17857142857142858 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_T_type_calcium_channel_current_f_gate__tau_f = 1.0 / (0.8286134089381241 * exp(0.06501950585175552 * var_chaste_interface__membrane__V) + 0.007294761952803773 * exp(-0.012004801920768308 * var_chaste_interface__membrane__V)); // millisecond
        const double d_dt_chaste_interface__T_type_calcium_channel_current_f_gate__f = (-var_chaste_interface__T_type_calcium_channel_current_f_gate__f + var_T_type_calcium_channel_current_f_gate__f_infinity) / var_T_type_calcium_channel_current_f_gate__tau_f; // 1 / millisecond
        const double var_background_muscarinic_potassium_channel_current__i_K_ACh = 1.0 * (-var_intracellular_ion_concentrations__Ko * exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + var_chaste_interface__intracellular_ion_concentrations__Ki) * var_background_muscarinic_potassium_channel_current__g_K_ACh; // picoA
        const double var_hyperpolarisation_activated_current_y_gate__tau_y = 0.7166529 / (0.00019540000558631698 * exp(-0.022074080614542406 * var_chaste_interface__membrane__V) + 0.02236821281695357 * exp(0.051999376007487906 * var_chaste_interface__membrane__V)); // millisecond
        const double var_hyperpolarisation_activated_current_y_gate__y_infinity = 1.0 / (1.0 + 114.51899915807324 * exp(0.07407407407407407 * var_chaste_interface__membrane__V)); // dimensionless
        const double d_dt_chaste_interface__hyperpolarisation_activated_current_y_gate__y = (-var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + var_hyperpolarisation_activated_current_y_gate__y_infinity) / var_hyperpolarisation_activated_current_y_gate__tau_y; // 1 / millisecond
        const double var_rapidly_activating_delayed_rectifier_potassium_current__g_Kr_max = 0.025; // nanoS
        const double var_rapidly_activating_delayed_rectifier_potassium_current__g_Kr = 1.0 * pow(var_intracellular_ion_concentrations__Ko, 0.59) * var_rapidly_activating_delayed_rectifier_potassium_current__g_Kr_max; // nanoS
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__pa_infinity = 1.0 / (1.0 + 0.11206466084736075 * exp(-0.09433962264150944 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double d_dt_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF = (-var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF + var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__pa_infinity) / var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__tau_paF; // 1 / millisecond
        ...
        const double d_dt_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS = (-var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS + var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__pa_infinity) / var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__tau_paS; // 1 / millisecond
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__pi_infinity = 1.0 / (1.0 + 5.325542689283013 * exp(0.05847953216374269 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double d_dt_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy = (-var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy + var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__pi_infinity) / var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__tau_pi; // 1 / millisecond
        const double var_reversal_potentials__E_K = var_membrane__R * var_membrane__T * log(var_intracellular_ion_concentrations__Ko / var_chaste_interface__intracellular_ion_concentrations__Ki) / var_membrane__F; // millivolt
        const double var_AP_sensitive_currents__i_sus = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_AP_sensitive_currents__g_sus * var_chaste_interface__AP_sensitive_currents_r_gate__r; // picoA
        const double var_AP_sensitive_currents__i_to = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_AP_sensitive_currents__g_to * var_chaste_interface__AP_sensitive_currents_q_gate__q * var_chaste_interface__AP_sensitive_currents_r_gate__r; // picoA
        const double var_hyperpolarisation_activated_current__i_h_K = pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2.0) * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_hyperpolarisation_activated_current__g_h_K; // picoA
        ...
        const double var_slowly_activating_delayed_rectifier_potassium_current__E_Ks = var_membrane__R * var_membrane__T * log((0.12 * var_intracellular_ion_concentrations__Nao + var_intracellular_ion_concentrations__Ko) / (0.12 * var_chaste_interface__intracellular_ion_concentrations__Nai + var_chaste_interface__intracellular_ion_concentrations__Ki)) / var_membrane__F; // millivolt
        const double var_slowly_activating_delayed_rectifier_potassium_current__g_Ks = 0.0259; // nanoS
        const double var_slowly_activating_delayed_rectifier_potassium_current_n_gate__alpha_n = 0.014 / (1.0 + 85.1525577175522 * exp(-0.1111111111111111 * var_chaste_interface__membrane__V)); // per_millisecond
        ...
        const double var_sodium_calcium_exchange_current__x4 = (var_sodium_calcium_exchange_current__k12 + var_sodium_calcium_exchange_current__k14) * var_sodium_calcium_exchange_current__k23 * var_sodium_calcium_exchange_current__k34 + (var_sodium_calcium_exchange_current__k32 + var_sodium_calcium_exchange_current__k34) * var_sodium_calcium_exchange_current__k14 * var_sodium_calcium_exchange_current__k21; // dimensionless
        const double var_sodium_calcium_exchange_current__i_NaCa = (var_sodium_calcium_exchange_current__k21 * var_sodium_calcium_exchange_current__x2 - var_sodium_calcium_exchange_current__k12 * var_sodium_calcium_exchange_current__x1) * var_sodium_calcium_exchange_current__kNaCa / (var_sodium_calcium_exchange_current__x1 + var_sodium_calcium_exchange_current__x2 + var_sodium_calcium_exchange_current__x3 + var_sodium_calcium_exchange_current__x4); // picoA
        const double d_dt_chaste_interface__intracellular_ion_concentrations__Ca_sub = -var_intracellular_calcium_dynamics__j_Ca_dif + (var_intracellular_calcium_dynamics__j_rel * var_intracellular_ion_concentrations__V_rel + 0.5 * (-var_L_type_calcium_channel_current__i_CaL - var_T_type_calcium_channel_current__i_CaT + 2.0 * var_sodium_calcium_exchange_current__i_NaCa) * var_membrane__Cm / var_membrane__F) / var_intracellular_ion_concentrations__V_sub - var_calcium_buffering__CM_tot * var_calcium_buffering__delta_fCMs; // millimolar / millisecond
        const double var_sodium_dependent_background_current__g_b_Na = 0.0054; // nanoS
        const double var_sodium_dependent_background_current__i_b_Na = (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__V) * var_sodium_dependent_background_current__g_b_Na; // picoA
        const double var_sodium_potassium_pump_current__Km_Kp = 1.4; // millimolar
        const double var_sodium_potassium_pump_current__Km_Nap = 14.0; // millimolar
        ...
        const double var_sustained_inward_current_qa_gate__qa_infinity = 1.0 / (1.0 + 1.119548484259094e-05 * exp(-0.2 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double d_dt_chaste_interface__sustained_inward_current_qa_gate__qa = (-var_chaste_interface__sustained_inward_current_qa_gate__qa + var_sustained_inward_current_qa_gate__qa_infinity) / var_sustained_inward_current_qa_gate__tau_qa; // 1 / millisecond
        ...
        const double var_sustained_inward_current__i_st = (-var_sustained_inward_current__E_st + var_chaste_interface__membrane__V) * var_sustained_inward_current__g_st * var_chaste_interface__sustained_inward_current_qa_gate__qa * var_chaste_interface__sustained_inward_current_qi_gate__qi; // picoA
        const double d_dt_chaste_interface__intracellular_ion_concentrations__Nai = 1.0 * (-var_hyperpolarisation_activated_current__i_h_Na - var_sodium_dependent_background_current__i_b_Na - var_sustained_inward_current__i_st - 3.0 * var_sodium_calcium_exchange_current__i_NaCa - 3.0 * var_sodium_potassium_pump_current__i_NaK) * var_membrane__Cm / ((var_intracellular_ion_concentrations__V_i + var_intracellular_ion_concentrations__V_sub) * var_membrane__F); // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__sustained_inward_current_qi_gate__qi = (-var_chaste_interface__sustained_inward_current_qi_gate__qi + var_sustained_inward_current_qi_gate__qi_infinity) / var_sustained_inward_current_qi_gate__tau_qi; // 1 / millisecond
        ...
        rDY[2] = d_dt_chaste_interface__L_type_calcium_channel_current_d_gate__d;
        rDY[3] = d_dt_chaste_interface__L_type_calcium_channel_current_f_gate__f;
        rDY[4] = d_dt_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa;
        rDY[5] = d_dt_chaste_interface__T_type_calcium_channel_current_d_gate__d;
        rDY[6] = d_dt_chaste_interface__T_type_calcium_channel_current_f_gate__f;
        rDY[7] = d_dt_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS;
        rDY[8] = d_dt_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF;
        rDY[9] = d_dt_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy;
        rDY[10] = d_dt_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n;
        rDY[11] = d_dt_chaste_interface__AP_sensitive_currents_q_gate__q;
        rDY[12] = d_dt_chaste_interface__AP_sensitive_currents_r_gate__r;
        rDY[13] = d_dt_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        rDY[14] = d_dt_chaste_interface__sustained_inward_current_qa_gate__qa;
        rDY[15] = d_dt_chaste_interface__sustained_inward_current_qi_gate__qi;
