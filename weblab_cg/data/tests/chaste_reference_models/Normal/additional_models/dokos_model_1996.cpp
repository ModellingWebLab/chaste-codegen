...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldokos_model_1996FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_L_type_calcium_current_f_gate__fL_infinity = 1.0 / (1.0 + exp(4.166666666666666 + 0.16666666666666666 * var_chaste_interface__membrane__E)); // dimensionless
        ...
        const double var_T_type_calcium_current_d_gate__dT_infinity = 1.0 / (1.0 + exp(-3.7704918032786887 - 0.1639344262295082 * var_chaste_interface__membrane__E)); // dimensionless
        const double var_T_type_calcium_current_d_gate__tau_dT = 0.0006 + 0.0054 / (1.0 + exp(3.0 + 0.03 * var_chaste_interface__membrane__E)); // second
        ...
        const double var_T_type_calcium_current_f_gate__fT_infinity = 1.0 / (1.0 + exp(11.363636363636363 + 0.15151515151515152 * var_chaste_interface__membrane__E)); // dimensionless
        const double var_T_type_calcium_current_f_gate__tau_fT = 0.001 + 0.04 / (1.0 + exp(5.2 + 0.08 * var_chaste_interface__membrane__E)); // second
        ...
        const double var_delayed_rectifying_potassium_current_x_gate__x_infinity = 1.0 / (1.0 + exp(-3.3918918918918917 - 0.13513513513513511 * var_chaste_interface__membrane__E)); // dimensionless
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = 32.4 * exp(-13.076000000000002 - 0.14 * var_chaste_interface__membrane__E); // per_second
        const double var_fast_sodium_current_h_gate__beta_h = 709.0 / (1.0 + 4.2 * exp(-2.7239999999999998 - 0.06 * var_chaste_interface__membrane__E)); // per_second
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = 200.0 * (34.3 + var_chaste_interface__membrane__E) / (1.0 - exp(-3.0869999999999997 - 0.09 * var_chaste_interface__membrane__E)); // per_second
        const double var_fast_sodium_current_m_gate__beta_m = 8000.0 * exp(-8.43 - 0.15 * var_chaste_interface__membrane__E); // per_second
        ...
        const double var_hyperpolarising_activated_current_y_gate__alpha_y = 0.36 * (137.8 + var_chaste_interface__membrane__E) / (-1.0 + exp(9.094800000000001 + 0.066 * var_chaste_interface__membrane__E)); // per_second
        const double var_hyperpolarising_activated_current_y_gate__beta_y = 0.1 * (76.3 + var_chaste_interface__membrane__E) / (1.0 - exp(-16.023 - 0.21 * var_chaste_interface__membrane__E)); // per_second
