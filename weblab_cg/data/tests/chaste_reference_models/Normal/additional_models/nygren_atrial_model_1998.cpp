...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellnygren_atrial_model_1998FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = -0.28 * HeartConfig::Instance()->GetCapacitance() / var_membrane__Cm; // uA_per_cm2
    ...
    void Cellnygren_atrial_model_1998FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_background_currents__E_Ca = 0.5 * var_membrane__R * var_membrane__T * log(var_chaste_interface__cleft_space_ion_concentrations__Ca_c / var_chaste_interface__intracellular_ion_concentrations__Ca_i) / var_membrane__F; // millivolt
        const double var_Ca_independent_transient_outward_K_current__i_t = (-var_Ca_independent_transient_outward_K_current__E_K + var_chaste_interface__membrane__V) * var_Ca_independent_transient_outward_K_current__g_t * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s; // picoA
        const double var_Ca_independent_transient_outward_K_current_r_gate__r_infinity = 1.0 / (1.0 + exp(0.09090909090909091 - 0.09090909090909091 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_Ca_independent_transient_outward_K_current_s_gate__s_infinity = 1.0 / (1.0 + exp(3.5217391304347827 + 0.08695652173913043 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_L_type_Ca_channel__i_Ca_L = (-var_L_type_Ca_channel__E_Ca_app + var_chaste_interface__membrane__V) * ((1.0 - var_L_type_Ca_channel__f_Ca) * var_chaste_interface__L_type_Ca_channel_f_L2_gate__f_L_2 + var_L_type_Ca_channel__f_Ca * var_chaste_interface__L_type_Ca_channel_f_L1_gate__f_L_1) * var_L_type_Ca_channel__g_Ca_L * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L; // picoA
        const double var_L_type_Ca_channel_d_L_gate__d_L_infinity = 1.0 / (1.0 + exp(-1.5517241379310347 - 0.1724137931034483 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_intracellular_ion_concentrations__Ca_i_orig_deriv = -0.045 * var_intracellular_Ca_buffering__dOCdt - 0.08 * var_intracellular_Ca_buffering__dOTCdt - 0.16 * var_intracellular_Ca_buffering__dOTMgCdt + 0.5 * (-var_Ca_handling_by_the_SR__i_up - var_background_currents__i_B_Ca - var_sarcolemmal_calcium_pump_current__i_CaP + 2.0 * var_Na_Ca_ion_exchanger_current__i_NaCa + var_Ca_handling_by_the_SR__i_rel + var_intracellular_ion_concentrations__i_di) / (var_intracellular_ion_concentrations__Vol_i * var_membrane__F); // millimolar / second
        ...
        const double var_sodium_current_h1_gate__h_infinity = 0.01 * var_sodium_current__perc_reduced_inact_for_IpNa + 1.0 * (1.0 - 0.01 * var_sodium_current__perc_reduced_inact_for_IpNa) / (1.0 + exp(12.000000000000002 + 0.18867924528301888 * var_chaste_interface__membrane__V - 0.18867924528301888 * var_sodium_current__shift_INa_inact)); // dimensionless
        const double var_sodium_current_h1_gate__tau_h1 = 0.0003 + 0.03 / (1.0 + exp(10.96875 + 0.3125 * var_chaste_interface__membrane__V - 0.3125 * var_sodium_current__shift_INa_inact)); // second
        ...
        const double var_sodium_current_h2_gate__tau_h2 = 0.003 + 0.12 / (1.0 + exp(10.96875 + 0.3125 * var_chaste_interface__membrane__V - 0.3125 * var_sodium_current__shift_INa_inact)); // second
        ...
        const double var_sustained_outward_K_current__g_sus = 2.75; // nanoS
        const double var_sustained_outward_K_current_r_sus_gate__r_sus_infinity = 1.0 / (1.0 + exp(-0.5375 - 0.125 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_sustained_outward_K_current_r_sus_gate__tau_r_sus = 0.0005 + 0.009 / (1.0 + exp(0.41666666666666663 + 0.08333333333333333 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_sustained_outward_K_current_s_sus_gate__s_sus_infinity = 0.6 + 0.4 / (1.0 + exp(2.0 + 0.1 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_sustained_outward_K_current_s_sus_gate__tau_s_sus = 0.3 + 0.047 / (1.0 + exp(6.0 + 0.1 * var_chaste_interface__membrane__V)); // second
