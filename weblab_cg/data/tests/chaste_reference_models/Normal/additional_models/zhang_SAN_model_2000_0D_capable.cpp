...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellzhang_SAN_model_2000_0D_capableFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_membrane__FCell = var_membrane__FCellConstant * var_membrane__dCell / (1.0 + 0.7745 * exp(6.9491525423728815 - 10.16949152542373 * var_membrane__dCell)); // dimensionless
        ...
        const double var_sodium_current_h_gate__F_Na = 0.08693 + 0.09518 * exp(-2.169264 - 0.06306 * var_chaste_interface__membrane__V) / (1.0 + 1.662 * exp(-14.33887 - 0.2251 * var_chaste_interface__membrane__V)); // dimensionless
    ...
    void Cellzhang_SAN_model_2000_0D_capableFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_membrane__FCellConstant = 1.0309347; // dimensionless
        const double var_L_type_Ca_channel_d_gate__alpha_d_L = -28.39 * (35.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-14.0 - 0.4 * var_chaste_interface__membrane__V)) - 84.9 * var_chaste_interface__membrane__V / (-1.0 + exp(-0.208 * var_chaste_interface__membrane__V)); // per_second
        const double var_L_type_Ca_channel_d_gate__beta_d_L = 11.43 * (-5.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.0 + 0.4 * var_chaste_interface__membrane__V)); // per_second
        ...
        const double var_T_type_Ca_channel_f_gate__beta_f_T = 15.0 * exp(4.616384915474642 + 0.06501950585175552 * var_chaste_interface__membrane__V); // per_second
        ...
        const double var_four_AP_sensitive_currents_r_gate__tau_r = 0.0029775 + 0.019595 / (1.037 * exp(2.7585732000000003 + 0.09012 * var_chaste_interface__membrane__V) + 0.369 * exp(-2.83696 - 0.119 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_hyperpolarisation_activated_current_y_gate__alpha_y = 1.0 * exp(-2.963199399173864 - 0.03755163349605708 * var_chaste_interface__membrane__V); // per_second
        ...
        const double var_membrane__dCell = 0.0; // dimensionless
        const double var_membrane__FCell = var_membrane__FCellConstant * var_membrane__dCell / (1.0 + 0.7745 * exp(6.9491525423728815 - 10.16949152542373 * var_membrane__dCell)); // dimensionless
        const double var_L_type_Ca_channel_d_gate__d_L_infinity = 1.0 / (1.0 + exp(-3.716666666666667 - 0.13333333333333333 * var_membrane__FCell - 0.16666666666666666 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_T_type_Ca_channel_f_gate__alpha_f_T = 15.3 * exp(-0.8523409363745499 - 0.012004801920768308 * var_chaste_interface__membrane__V - 0.008403361344537815 * var_membrane__FCell); // per_second
        ...
        const double var_four_AP_sensitive_currents_q_gate__tau_q = 0.010103333333333332 + 0.06516666666666666 / (0.5686 * exp(-3.1827900000000002 - 0.8161 * var_membrane__FCell - 0.08161 * var_chaste_interface__membrane__V) + 0.7174 * exp(1.0 * (0.2719 - 0.1719 * var_membrane__FCell) * (40.93 + 10.0 * var_membrane__FCell + var_chaste_interface__membrane__V))); // second
        ...
        const double var_rapid_delayed_rectifying_potassium_current_P_af_gate__tau_P_af = 1.0 / (0.96 * exp(0.4 - 0.044444444444444446 * var_chaste_interface__membrane__V) + 37.2 * exp(-0.5660377358490566 + 0.06289308176100629 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_rapid_delayed_rectifying_potassium_current_P_as_gate__tau_P_as = 1.0 / (4.2 * exp(-0.5294117647058824 + 0.058823529411764705 * var_chaste_interface__membrane__V) + 0.15 * exp(0.41666666666666663 - 0.046296296296296294 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_sodium_current_m_gate__m_infinity = 1.0 * pow(1 / (1.0 + exp(-5.553113553113553 - 0.18315018315018314 * var_chaste_interface__membrane__V)), 0.3333333333333333); // dimensionless
        const double var_sodium_current_m_gate__tau_m = 4.569e-05 + 0.0006247 / (0.6274 * exp(5.35057813 + 0.0823 * var_chaste_interface__membrane__V) + 0.8322166 * exp(-19.034003092000003 - 0.33566 * var_chaste_interface__membrane__V)); // second
