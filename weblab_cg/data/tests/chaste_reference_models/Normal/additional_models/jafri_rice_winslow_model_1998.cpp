...
#include "MathsCustomFunctions.hpp"
    ...
    double Celljafri_rice_winslow_model_1998FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_time_dependent_potassium_current_Xi_gate__Xi = 1.0 / (1.0 + exp(-1.7526479750778816 + 0.03115264797507788 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_time_independent_potassium_current_K1_gate__alpha_K1 = 1.02 / (1.0 + exp(-14.1227775 + 0.2385 * var_chaste_interface__membrane__V - 0.2385 * var_time_independent_potassium_current__E_K1)); // per_ms
        const double var_time_independent_potassium_current_K1_gate__beta_K1 = (0.49124 * exp(0.43983232 + 0.08032 * var_chaste_interface__membrane__V - 0.08032 * var_time_independent_potassium_current__E_K1) + exp(-36.6986425 + 0.06175 * var_chaste_interface__membrane__V - 0.06175 * var_time_independent_potassium_current__E_K1)) / (1.0 + exp(-2.4444679 + 0.5143 * var_time_independent_potassium_current__E_K1 - 0.5143 * var_chaste_interface__membrane__V)); // per_ms
    ...
    void Celljafri_rice_winslow_model_1998FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_L_type_Ca_channel_y_gate__y_infinity = 1.0 / (1.0 + exp(7.333333333333333 + 0.13333333333333333 * var_chaste_interface__membrane__V)) + 0.1 / (1.0 + exp(3.5 - 0.16666666666666666 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_calcium_background_current__i_Ca_b = (-var_calcium_background_current__E_CaN + var_chaste_interface__membrane__V) * var_calcium_background_current__g_Cab; // uA_per_mm2
        const double var_fast_sodium_current__i_Na = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (-var_fast_sodium_current__E_Na + var_chaste_interface__membrane__V) * var_fast_sodium_current__g_Na * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j; // uA_per_mm2
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40.0) ? (0.135 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0.0)); // per_ms
        const double var_fast_sodium_current_h_gate__beta_h = ((var_chaste_interface__membrane__V < -40.0) ? (310000.0 * exp(0.35 * var_chaste_interface__membrane__V) + 3.56 * exp(0.079 * var_chaste_interface__membrane__V)) : (7.692307692307692 / (1.0 + exp(-0.9603603603603604 - 0.0900900900900901 * var_chaste_interface__membrane__V)))); // per_ms
        ...
        const double var_fast_sodium_current_j_gate__beta_j = ((var_chaste_interface__membrane__V < -40.0) ? (0.1212 * exp(-0.01052 * var_chaste_interface__membrane__V) / (1.0 + exp(-5.5312920000000005 - 0.1378 * var_chaste_interface__membrane__V))) : (0.3 * exp(-2.535e-07 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.2 - 0.1 * var_chaste_interface__membrane__V)))); // per_ms
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = 0.32 * (47.13 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.713 - 0.1 * var_chaste_interface__membrane__V)); // per_ms
        ...
        const double var_time_dependent_potassium_current__g_K_max = 0.001128; // mS_per_mm2
        const double var_time_dependent_potassium_current__g_K = 0.4303314829119352 * sqrt(var_chaste_interface__ionic_concentrations__Ko) * var_time_dependent_potassium_current__g_K_max; // mS_per_mm2
        const double var_time_dependent_potassium_current_X_gate__alpha_X = 7.19e-05 * (30.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.4399999999999995 - 0.148 * var_chaste_interface__membrane__V)); // per_ms
        const double var_time_dependent_potassium_current_X_gate__beta_X = 0.000131 * (30.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(2.061 + 0.0687 * var_chaste_interface__membrane__V)); // per_ms
