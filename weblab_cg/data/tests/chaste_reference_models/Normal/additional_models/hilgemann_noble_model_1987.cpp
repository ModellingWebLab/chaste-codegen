...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellhilgemann_noble_model_1987FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = 0.001 * HeartConfig::Instance()->GetCapacitance() * -200.0 / var_membrane__C_m; // uA_per_cm2
