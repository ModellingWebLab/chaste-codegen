...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellhilgemann_noble_model_1987FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = -0.2 * HeartConfig::Instance()->GetCapacitance() / var_membrane__C_m; // uA_per_cm2
    ...
    void Cellhilgemann_noble_model_1987FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_calcium_release__ProdFrac_orig_deriv = -0.6 * var_chaste_interface__calcium_release__ProdFrac + var_chaste_interface__calcium_release__ActFrac * var_calcium_release__InactRate; // 1 / second
