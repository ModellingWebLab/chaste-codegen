...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> cellmatsuoka_model_2003FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double mParameters[0] = 132.0; // picoF
        const double var_chaste_interface__membrane__stim_amplitude = -4000.0 / mParameters[0] * HeartConfig::Instance()->GetCapacitance(); // uA_per_cm2
                ...
                pIntracellularStimulus)
    {
        ...
        this->mParameters[0] = 132.0; // (ar_membrane__Cm) [picoF]
    }
    ...
    double cellmatsuoka_model_2003FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_rapid_time_dependent_potassium_current__g_Kr = pow((var_external_ion_concentrations__Ko / 5.4), 0.2) * mParameters[0] * var_rapid_time_dependent_potassium_current__P_Kr; // nanoS
        ...
        const double var_time_independent_potassium_current__g_K1 = pow((var_external_ion_concentrations__Ko / 5.4), 0.4) * mParameters[0] * var_time_independent_potassium_current__P_K1_0; // nanoS
        ...
        const double var_chaste_interface__i_ionic = (1.0 * var_membrane__i_tot / mParameters[0]) * HeartConfig::Instance()->GetCapacitance(); // uA_per_cm2
    ...
    std::vector<double> cellmatsuoka_model_2003FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        ...
        const double var_internal_ion_concentrations__c1 = var_chaste_interface__internal_ion_concentrations__Ca_Total * var_internal_ion_concentrations__K_mCMDN; // millimolar2
        const double var_internal_ion_concentrations__Cai = (sqrt(pow(var_internal_ion_concentrations__b1, 2.0) + 4.0 * var_internal_ion_concentrations__c1) - var_internal_ion_concentrations__b1) / 2.0; // millimolar
        const double var_membrane__i_ext = GetIntracellularAreaStimulus(var_chaste_interface__environment__time); // picoA
        
        std::vector<double> dqs(2);
        dqs[0] = var_internal_ion_concentrations__Cai;
        dqs[1] = var_membrane__i_ext;
        return dqs;
    }
