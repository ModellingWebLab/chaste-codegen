...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellnoble_model_1998FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = -0.003 * HeartConfig::Instance()->GetCapacitance() / var_membrane__Cm; // uA_per_cm2
    ...
    void Cellnoble_model_1998FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_fast_sodium_current_h_gate__beta_h = 2000.0 / (1.0 + 320.0 * exp(-7.5 + 0.1 * var_fast_sodium_current__shift_INa_inact - 0.1 * var_chaste_interface__membrane__V)); // per_second
        ...
        const double var_fast_sodium_current_m_gate__beta_m = 8000.0 * exp(-3.696 - 0.056 * var_chaste_interface__membrane__V); // per_second
        ...
        const double var_rapid_delayed_rectifier_potassium_current__g_Kr1 = 0.0021; // microS
        const double var_rapid_delayed_rectifier_potassium_current__g_Kr2 = 0.0013; // microS
        const double var_rapid_delayed_rectifier_potassium_current_xr1_gate__alpha_xr1 = 50.0 / (1.0 + exp(0.5555555555555556 - 0.1111111111111111 * var_chaste_interface__membrane__V)); // per_second
        const double var_rapid_delayed_rectifier_potassium_current_xr1_gate__beta_xr1 = 0.05 * exp(1.3333333333333333 - 0.06666666666666667 * var_chaste_interface__membrane__V); // per_second
        ...
        const double var_rapid_delayed_rectifier_potassium_current_xr2_gate__alpha_xr2 = 50.0 / (1.0 + exp(0.5555555555555556 - 0.1111111111111111 * var_chaste_interface__membrane__V)); // per_second
        ...
        const double var_slow_delayed_rectifier_potassium_current__g_Ks = 0.0026; // microS
        const double var_slow_delayed_rectifier_potassium_current_xs_gate__alpha_xs = 14.0 / (1.0 + exp(4.444444444444445 - 0.1111111111111111 * var_chaste_interface__membrane__V)); // per_second
        ...
        const double var_transient_outward_current__g_to = 0.005; // microS
        const double var_transient_outward_current__g_tos = 0.0; // dimensionless
        const double var_transient_outward_current_r_gate__r_orig_deriv = 333.0 / (1.0 + exp(-0.8 - 0.2 * var_chaste_interface__membrane__V)) - 333.0 * var_chaste_interface__transient_outward_current_r_gate__r; // 1 / second
