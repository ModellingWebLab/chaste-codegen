...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellnoble_model_1998FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = 0.001 * HeartConfig::Instance()->GetCapacitance() * -3.0 / var_membrane__Cm; // uA_per_cm2
