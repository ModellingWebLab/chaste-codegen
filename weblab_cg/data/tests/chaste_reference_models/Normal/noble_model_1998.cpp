...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1998FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        rDY[2] = d_dt_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1;
        rDY[3] = d_dt_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2;
        rDY[4] = d_dt_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs;
        ...
        rDY[9] = d_dt_chaste_interface__L_type_Ca_channel_f2_gate__f2;
        rDY[10] = d_dt_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds;
        ...
        rDY[13] = d_dt_chaste_interface__calcium_release__ActFrac;
        rDY[14] = d_dt_chaste_interface__calcium_release__ProdFrac;
        rDY[15] = d_dt_chaste_interface__intracellular_sodium_concentration__Na_i;
        rDY[16] = d_dt_chaste_interface__intracellular_potassium_concentration__K_i;
