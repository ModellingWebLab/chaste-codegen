...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellfink_noble_giles_model_2008FromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_iCaL_f2_gate__tau_f2 = 40.0 / (1.0 + 20.085536923187668 * exp(0.1 * var_chaste_interface__cell__V)) + 15.5 / (1.0 + 12.182493960703473 * exp(-0.1 * var_chaste_interface__cell__V)) + 281.0 * exp(-3.0375 * pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2.0)); // millisecond
        ...
        const double var_iCaL_f_gate__tau_f = 5.0 + 50.0 / (1.0 + 3.6692966676192444 * exp(-0.1 * var_chaste_interface__cell__V)) + 45.0 / (1.0 + 20.085536923187668 * exp(0.1 * var_chaste_interface__cell__V)) + 275.625 * exp(-3.24 * pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2.0)); // millisecond
        ...
        const double var_iKs_Xs_gate__alpha_xs = 922.9368822806213 / sqrt(0.4345982085070783 + exp(-0.16666666666666666 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_iNa_h_gate__h_inf = 4.321091783768971e-09 * pow((6.573501185646026e-05 + exp(0.13458950201884254 * var_chaste_interface__cell__V - 0.13458950201884254 * var_INa__shift_INa_inact)), (-2.0)); // dimensionless
        ...
        const double var_iNa_j_gate__j_inf = 4.321091783768971e-09 * pow((6.573501185646026e-05 + exp(0.13458950201884254 * var_chaste_interface__cell__V - 0.13458950201884254 * var_INa__shift_INa_inact)), (-2.0)); // dimensionless
        ...
        const double var_ito_r_gate__tau_r = 0.8 + 9.5 * exp(-0.8888888888888888 * pow((1 + 0.025 * var_chaste_interface__cell__V), 2.0)); // millisecond
        ...
        const double var_ito_s_gate__tau_s = 3.0 + 5.0 / (1.0 + 0.01831563888873418 * exp(0.2 * var_chaste_interface__cell__V)) + 85.0 * exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__cell__V), 2.0)); // millisecond
