...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellfink_noble_giles_model_2008FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IpK__i_p_K = (-var_reversal_potentials__E_K + var_chaste_interface__cell__V) * var_IpK__g_pK / (1.0 + exp(4.1806020066889635 - 0.16722408026755853 * var_chaste_interface__cell__V)); // nanoA_per_nanoF
    ...
    void Cellfink_noble_giles_model_2008FromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_iCaL_d_gate__alpha_d = 0.25 + 1.4 / (1.0 + exp(-2.6923076923076925 - 0.07692307692307693 * var_chaste_interface__cell__V)); // dimensionless
        const double var_iCaL_d_gate__beta_d = 1.4 / (1.0 + exp(1.0 + 0.2 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_iCaL_d_gate__gamma_d = 1.0 / (1.0 + exp(2.5 - 0.05 * var_chaste_interface__cell__V)); // millisecond
        ...
        const double var_iCaL_f2_gate__tau_f2 = 40.0 / (1.0 + exp(3.0 + 0.1 * var_chaste_interface__cell__V)) + 15.5 / (1.0 + exp(2.5 - 0.1 * var_chaste_interface__cell__V)) + 281.0 * exp(-3.0375 * pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2.0)); // millisecond
        ...
        const double var_iCaL_f_gate__f_inf = 1.0 / (1.0 + exp(2.8571428571428568 + 0.14285714285714285 * var_chaste_interface__cell__V)); // dimensionless
        const double var_iCaL_f_gate__tau_f = 5.0 + 50.0 / (1.0 + exp(1.3 - 0.1 * var_chaste_interface__cell__V)) + 45.0 / (1.0 + exp(3.0 + 0.1 * var_chaste_interface__cell__V)) + 275.625 * exp(-3.24 * pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2.0)); // millisecond
        ...
        const double var_iKr_Markov__alpha_xr1 = 1.0 * var_Environment__T * exp(24.335 + (-25.914 + 0.0112 * var_chaste_interface__cell__V) * var_iKr_Markov__T_Base / var_Environment__T) / var_iKr_Markov__T_Base; // per_millisecond
        const double var_iKr_Markov__alpha_xr2 = 1.0 * var_Environment__T * exp(22.746 - 25.914 * var_iKr_Markov__T_Base / var_Environment__T) / var_iKr_Markov__T_Base; // per_millisecond
        const double var_iKr_Markov__alpha_xr3 = 1.0 * var_Environment__T * exp(22.098 + (-25.914 + 0.0365 * var_chaste_interface__cell__V) * var_iKr_Markov__T_Base / var_Environment__T) / var_iKr_Markov__T_Base; // per_millisecond
        const double var_iKr_Markov__alpha_xr4 = 1.9631681698237122 * pow(1 / var_Environment__K_o, 0.4) * var_Environment__T * exp(30.016 + (-30.888 + 0.0223 * var_chaste_interface__cell__V) * var_iKr_Markov__T_Base / var_Environment__T) / var_iKr_Markov__T_Base; // per_millisecond
        const double var_iKr_Markov__beta_xr1 = 1.0 * var_Environment__T * exp(13.688 + (-15.707 - 0.0603 * var_chaste_interface__cell__V) * var_iKr_Markov__T_Base / var_Environment__T) / var_iKr_Markov__T_Base; // per_millisecond
        ...
        const double var_iKr_Markov__beta_xr2 = 1.0 * var_Environment__T * exp(13.193 - 15.707 * var_iKr_Markov__T_Base / var_Environment__T) / var_iKr_Markov__T_Base; // per_millisecond
        ...
        const double var_iKr_Markov__beta_xr3 = 1.0 * var_Environment__T * exp(7.313 + (-15.707 - 0.0399 * var_chaste_interface__cell__V) * var_iKr_Markov__T_Base / var_Environment__T) / var_iKr_Markov__T_Base; // per_millisecond
        ...
        const double var_iKr_Markov__beta_xr4 = 1.0 * var_Environment__T * exp(30.061 + (-33.243 - 0.0312 * var_chaste_interface__cell__V) * var_iKr_Markov__T_Base / var_Environment__T) / var_iKr_Markov__T_Base; // per_millisecond
        ...
        const double var_iKs_Xs_gate__alpha_xs = 1400.0 / sqrt(1.0 + exp(0.8333333333333333 - 0.16666666666666666 * var_chaste_interface__cell__V)); // dimensionless
        const double var_iKs_Xs_gate__beta_xs = 1.0 / (1.0 + exp(-2.3333333333333335 + 0.06666666666666667 * var_chaste_interface__cell__V)); // dimensionless
        const double var_iKs_Xs_gate__tau_xs = 80.0 + 1.0 * var_iKs_Xs_gate__alpha_xs * var_iKs_Xs_gate__beta_xs; // millisecond
        const double var_iKs_Xs_gate__xs_inf = 1.0 / (1.0 + exp(-0.3571428571428571 - 0.07142857142857142 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_iNa_h_gate__alpha_h = ((var_chaste_interface__cell__V < -40.0 + var_INa__shift_INa_inact) ? (0.057 * exp(-11.764705882352942 + 0.14705882352941177 * var_INa__shift_INa_inact - 0.14705882352941177 * var_chaste_interface__cell__V)) : (0.0)); // per_millisecond
        const double var_iNa_h_gate__beta_h = ((var_chaste_interface__cell__V < -40.0 + var_INa__shift_INa_inact) ? (310000.0 * exp(0.3485 * var_chaste_interface__cell__V - 0.3485 * var_INa__shift_INa_inact) + 2.7 * exp(0.079 * var_chaste_interface__cell__V - 0.079 * var_INa__shift_INa_inact)) : (5.9230769230769225 / (1.0 + exp(-0.9603603603603604 + 0.0900900900900901 * var_INa__shift_INa_inact - 0.0900900900900901 * var_chaste_interface__cell__V)))); // per_millisecond
        const double var_iNa_h_gate__h_inf = 1.0 * pow((1.0 + exp(9.629878869448182 + 0.13458950201884254 * var_chaste_interface__cell__V - 0.13458950201884254 * var_INa__shift_INa_inact)), (-2.0)); // dimensionless
        ...
        const double var_iNa_j_gate__alpha_j = ((var_chaste_interface__cell__V < -40.0 + var_INa__shift_INa_inact) ? (1.0 * (37.78 + var_chaste_interface__cell__V) * (-25428.0 * exp(0.2444 * var_chaste_interface__cell__V - 0.2444 * var_INa__shift_INa_inact) - 6.948e-06 * exp(0.04391 * var_INa__shift_INa_inact - 0.04391 * var_chaste_interface__cell__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V - 0.311 * var_INa__shift_INa_inact))) : (0.0)); // per_millisecond
        const double var_iNa_j_gate__beta_j = ((var_chaste_interface__cell__V < -40.0 + var_INa__shift_INa_inact) ? (0.02424 * exp(0.01052 * var_INa__shift_INa_inact - 0.01052 * var_chaste_interface__cell__V) / (1.0 + exp(-5.5312920000000005 + 0.1378 * var_INa__shift_INa_inact - 0.1378 * var_chaste_interface__cell__V))) : (0.6 * exp(0.057 * var_chaste_interface__cell__V - 0.057 * var_INa__shift_INa_inact) / (1.0 + exp(-3.2 + 0.1 * var_INa__shift_INa_inact - 0.1 * var_chaste_interface__cell__V)))); // per_millisecond
        const double var_iNa_j_gate__j_inf = 1.0 * pow((1.0 + exp(9.629878869448182 + 0.13458950201884254 * var_chaste_interface__cell__V - 0.13458950201884254 * var_INa__shift_INa_inact)), (-2.0)); // dimensionless
        ...
        const double var_iNa_m_gate__alpha_m = 1.0 / (1.0 + exp(-12.0 - 0.2 * var_chaste_interface__cell__V)); // dimensionless
        const double var_iNa_m_gate__beta_m = 0.1 / (1.0 + exp(7.0 + 0.2 * var_chaste_interface__cell__V)) + 0.1 / (1.0 + exp(-0.25 + 0.005 * var_chaste_interface__cell__V)); // dimensionless
        const double var_iNa_m_gate__m_inf = 1.0 * pow((1.0 + exp(-6.2967884828349945 - 0.1107419712070875 * var_chaste_interface__cell__V)), (-2.0)); // dimensionless
        ...
        const double var_ito_r_gate__r_inf = 1.0 / (1.0 + exp(3.333333333333333 - 0.16666666666666666 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_ito_s_gate__s_inf = 1.0 / (1.0 + exp(4.0 + 0.2 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ito_s_gate__tau_s = 3.0 + 5.0 / (1.0 + exp(-4.0 + 0.2 * var_chaste_interface__cell__V)) + 85.0 * exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__cell__V), 2.0)); // millisecond
