...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellbondarenko_model_2004_apexFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_activated_chloride_current__i_ClCa = 2.0 * (40.0 + var_chaste_interface__membrane__V) * var_chaste_interface__calcium_concentration__Cai / ((1.0 + exp(5.987179487179488 - 0.12820512820512822 * var_chaste_interface__membrane__V)) * (10.0 + var_chaste_interface__calcium_concentration__Cai)); // picoA_per_picoF
        const double var_calcium_background_current__i_Cab = 0.000367 * var_chaste_interface__membrane__V - 0.0047112379481865285 * log(1800.0 / var_chaste_interface__calcium_concentration__Cai); // picoA_per_picoF
        ...
        const double var_fast_transient_outward_potassium_current__i_Kto_f = 0.4067 * pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 3.0) * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f; // picoA_per_picoF
        const double var_non_inactivating_steady_state_potassium_current__i_Kss = 0.05 * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss; // picoA_per_picoF
        const double var_slow_delayed_rectifier_potassium_current__i_Ks = 0.00575 * pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 2.0) * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V); // picoA_per_picoF
        const double var_slow_transient_outward_potassium_current__i_Kto_s = 0; // picoA_per_picoF
        const double var_fast_sodium_current__E_Na = 25.674321243523316 * log(126540.0 / (0.1 * var_chaste_interface__potassium_concentration__Ki + 0.9 * var_chaste_interface__sodium_concentration__Nai)); // millivolt
        ...
        const double var_rapid_delayed_rectifier_potassium_current__i_Kr = 0.078 * (-25.674321243523316 * log(8092.0 / (0.98 * var_chaste_interface__potassium_concentration__Ki + 0.02 * var_chaste_interface__sodium_concentration__Nai)) + var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K; // picoA_per_picoF
        const double var_sodium_background_current__i_Nab = 0.0026 * var_chaste_interface__membrane__V - 0.0026 * var_fast_sodium_current__E_Na; // picoA_per_picoF
        const double var_sodium_calcium_exchange_current__i_NaCa = 2.6970585464294846e-17 * (1800.0 * pow(var_chaste_interface__sodium_concentration__Nai, 3.0) * exp(0.01363229807246772 * var_chaste_interface__membrane__V) - 2744000000000000.0 * var_chaste_interface__calcium_concentration__Cai * exp(-0.025317124991725767 * var_chaste_interface__membrane__V)) / (1.0 + 0.1 * exp(-0.025317124991725767 * var_chaste_interface__membrane__V)); // picoA_per_picoF
        const double var_sodium_potassium_pump_current__i_NaK = 0.688695652173913 / ((1.0 + 3043189.116699782 * pow(1 / var_chaste_interface__sodium_concentration__Nai, 1.5)) * (1.0 + 0.1245 * exp(-0.0038949423064193493 * var_chaste_interface__membrane__V) + 0.0365 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.080237741456166)) * exp(-0.03894942306419349 * var_chaste_interface__membrane__V))); // picoA_per_picoF
        const double var_time_independent_potassium_current__i_K1 = 0.2828021390374332 * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(0.0896 * var_chaste_interface__membrane__V - 0.0896 * var_fast_transient_outward_potassium_current__E_K)); // picoA_per_picoF
    ...
    void Cellbondarenko_model_2004_apexFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_calcium_buffering__HTRPN_Ca = -3.2e-05 * var_chaste_interface__calcium_buffering__HTRPN_Ca + 0.00237 * (140.0 - var_chaste_interface__calcium_buffering__HTRPN_Ca) * var_chaste_interface__calcium_concentration__Cai; // micromolar / millisecond
        const double d_dt_chaste_interface_var_calcium_buffering__LTRPN_Ca = -0.0196 * var_chaste_interface__calcium_buffering__LTRPN_Ca + 0.0327 * (70.0 - var_chaste_interface__calcium_buffering__LTRPN_Ca) * var_chaste_interface__calcium_concentration__Cai; // micromolar / millisecond
        const double var_calcium_fluxes__J_tr = 0.05 * var_chaste_interface__calcium_concentration__CaNSR - 0.05 * var_chaste_interface__calcium_concentration__CaJSR; // micromolar_per_millisecond
        ...
        const double var_calcium_fluxes__J_leak = 1.74e-05 * var_chaste_interface__calcium_concentration__CaNSR - 1.74e-05 * var_chaste_interface__calcium_concentration__Cai; // micromolar_per_millisecond
        const double var_calcium_fluxes__J_up = 0.45 * pow(var_chaste_interface__calcium_concentration__Cai, 2.0) / (0.25 + pow(var_chaste_interface__calcium_concentration__Cai, 2.0)); // micromolar_per_millisecond
        const double var_calcium_pump_current__i_pCa = 1.0 * pow(var_chaste_interface__calcium_concentration__Cai, 2.0) / (0.25 + pow(var_chaste_interface__calcium_concentration__Cai, 2.0)); // picoA_per_picoF
        ...
        const double var_L_type_calcium_current__Kpcf = 13.0 - 13.0 * exp(-2.1025 * pow((1 + 0.06896551724137931 * var_chaste_interface__membrane__V), 2.0)); // per_millisecond
        const double var_L_type_calcium_current__alpha = 0.4 * (1.0 + 0.7 * exp(-160.0 * pow((1 + 0.025 * var_chaste_interface__membrane__V), 2.0)) - 0.75 * exp(-1.0 * pow((1 + 0.05 * var_chaste_interface__membrane__V), 2.0))) * exp(1.2000000000000002 + 0.1 * var_chaste_interface__membrane__V) / (1.0 + 0.12 * exp(1.2000000000000002 + 0.1 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_L_type_calcium_current__beta = 0.05 * exp(-0.9230769230769231 - 0.07692307692307693 * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double d_dt_chaste_interface_var_L_type_calcium_current__C4 = -var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__alpha + 2.0 * var_chaste_interface__L_type_calcium_current__C3 * var_L_type_calcium_current__alpha + 4.0 * var_chaste_interface__L_type_calcium_current__O * var_L_type_calcium_current__beta + 0.002 * var_chaste_interface__L_type_calcium_current__I3 * var_L_type_calcium_current__beta + 0.008 * var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__beta + 2e-05 * var_chaste_interface__L_type_calcium_current__I1 * var_L_type_calcium_current__beta - 3.0 * var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__beta - 0.002 * var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__Kpcf - 1.0 * var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__Kpcf * var_L_type_calcium_current__gamma - 0.01 * var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__alpha * var_L_type_calcium_current__gamma; // 1 / millisecond
        const double d_dt_chaste_interface_var_L_type_calcium_current__I1 = -0.0005 * var_chaste_interface__L_type_calcium_current__I1 + var_chaste_interface__L_type_calcium_current__O * var_L_type_calcium_current__gamma + 0.001 * var_chaste_interface__L_type_calcium_current__I3 * var_L_type_calcium_current__alpha - 0.001 * var_chaste_interface__L_type_calcium_current__I1 * var_L_type_calcium_current__Kpcf + 0.01 * var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__alpha * var_L_type_calcium_current__gamma - 0.04 * var_chaste_interface__L_type_calcium_current__I1 * var_L_type_calcium_current__Kpcf * var_L_type_calcium_current__beta; // 1 / millisecond
        const double d_dt_chaste_interface_var_L_type_calcium_current__I2 = 0.0005 * var_chaste_interface__L_type_calcium_current__I3 - var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__gamma + 0.001 * var_L_type_calcium_current__Kpcf * var_chaste_interface__L_type_calcium_current__O + 0.002 * var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__Kpcf - 0.001 * var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__alpha - 0.008 * var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__beta; // 1 / millisecond
        const double d_dt_chaste_interface_var_L_type_calcium_current__I3 = -0.0005 * var_chaste_interface__L_type_calcium_current__I3 + var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__gamma + 0.001 * var_chaste_interface__L_type_calcium_current__I1 * var_L_type_calcium_current__Kpcf - 0.001 * var_chaste_interface__L_type_calcium_current__I3 * var_L_type_calcium_current__alpha - 0.002 * var_chaste_interface__L_type_calcium_current__I3 * var_L_type_calcium_current__beta + 1.0 * var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__Kpcf * var_L_type_calcium_current__gamma; // 1 / millisecond
        const double d_dt_chaste_interface_var_L_type_calcium_current__O = 0.0005 * var_chaste_interface__L_type_calcium_current__I1 + var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__alpha - var_chaste_interface__L_type_calcium_current__O * var_L_type_calcium_current__gamma + 0.001 * var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__alpha - 4.0 * var_chaste_interface__L_type_calcium_current__O * var_L_type_calcium_current__beta - 0.001 * var_L_type_calcium_current__Kpcf * var_chaste_interface__L_type_calcium_current__O; // 1 / millisecond
        const double var_L_type_calcium_current__i_CaL = 0.1729 * (-63.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_calcium_current__O; // picoA_per_picoF
        const double d_dt_chaste_interface_var_calcium_fluxes__P_RyR = -0.04 * var_chaste_interface__calcium_fluxes__P_RyR - 0.014285714285714285 * var_L_type_calcium_current__i_CaL * exp(-0.038580246913580245 * pow((-1 + 0.2 * var_chaste_interface__membrane__V), 2.0)); // 1 / millisecond
        const double var_calcium_background_current__i_Cab = 0.000367 * var_chaste_interface__membrane__V - 0.0047112379481865285 * log(1800.0 / var_chaste_interface__calcium_concentration__Cai); // picoA_per_picoF
        const double var_fast_sodium_current__alpha_Na11 = 3.802 / (0.2 * exp(-0.016666666666666666 - 0.006666666666666667 * var_chaste_interface__membrane__V) + 0.1027 * exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_fast_sodium_current__alpha_Na12 = 3.802 / (0.1027 * exp(-0.16666666666666666 - 0.06666666666666667 * var_chaste_interface__membrane__V) + 0.23 * exp(-0.016666666666666666 - 0.006666666666666667 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_fast_sodium_current__alpha_Na13 = 3.802 / (0.25 * exp(-0.016666666666666666 - 0.006666666666666667 * var_chaste_interface__membrane__V) + 0.1027 * exp(-0.20833333333333331 - 0.08333333333333333 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_fast_sodium_current__alpha_Na2 = 1.0 / (0.393956 + 0.188495 * exp(-0.4216867469879518 - 0.06024096385542168 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_fast_sodium_current__alpha_Na3 = 7e-07 * exp(-0.909090909090909 - 0.12987012987012986 * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double var_fast_sodium_current__beta_Na11 = 0.1917 * exp(-0.1231527093596059 - 0.04926108374384236 * var_chaste_interface__membrane__V); // per_millisecond
        const double var_fast_sodium_current__beta_Na12 = 0.2 * exp(0.1231527093596059 - 0.04926108374384236 * var_chaste_interface__membrane__V); // per_millisecond
        const double var_fast_sodium_current__beta_Na13 = 0.22 * exp(0.3694581280788177 - 0.04926108374384236 * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double d_dt_chaste_interface_var_fast_transient_outward_potassium_current__ato_f = 0.18064 * (1.0 - var_chaste_interface__fast_transient_outward_potassium_current__ato_f) * exp(1.0731000000000002 + 0.03577 * var_chaste_interface__membrane__V) - 0.3956 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f * exp(-1.8711 - 0.06237 * var_chaste_interface__membrane__V); // 1 / millisecond
        const double d_dt_chaste_interface_var_fast_transient_outward_potassium_current__ito_f = 0.000152 * (1.0 - var_chaste_interface__fast_transient_outward_potassium_current__ito_f) * exp(-1.9285714285714284 - 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + 0.0067083 * exp(-4.785714285714286 - 0.14285714285714285 * var_chaste_interface__membrane__V)) - 0.00095 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f * exp(4.785714285714286 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + 0.051335 * exp(4.785714285714286 + 0.14285714285714285 * var_chaste_interface__membrane__V)); // 1 / millisecond
        const double d_dt_chaste_interface_var_calcium_concentration__CaNSR = 12.316491897044804 * var_calcium_fluxes__J_up - 0.05719733079122974 * var_calcium_fluxes__J_tr - 12.316491897044804 * var_calcium_fluxes__J_leak; // micromolar / millisecond
        const double var_fast_transient_outward_potassium_current__E_K = 25.674321243523316 * log(5400.0 / var_chaste_interface__potassium_concentration__Ki); // millivolt
        const double var_fast_transient_outward_potassium_current__i_Kto_f = 0.4067 * pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 3.0) * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f; // picoA_per_picoF
        const double var_non_inactivating_steady_state_potassium_current__i_Kss = 0.05 * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss; // picoA_per_picoF
        ...
        const double var_rapid_delayed_rectifier_potassium_current__alpha_i = 0.090821 * exp(0.11695499999999999 + 0.023391 * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double var_rapid_delayed_rectifier_potassium_current__beta_i = 0.006497 * exp(-0.1634 - 0.03268 * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double d_dt_chaste_interface_var_rapid_delayed_rectifier_potassium_current__C_K1 = 0.036778 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - 0.023761 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 + 0.022348 * (1.0 - var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K - var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K) * exp(0.01176 * var_chaste_interface__membrane__V) - 0.047002 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 * exp(-0.0631 * var_chaste_interface__membrane__V); // 1 / millisecond
        const double d_dt_chaste_interface_var_rapid_delayed_rectifier_potassium_current__C_K2 = 0.023761 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - 0.036778 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 + var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K * var_rapid_delayed_rectifier_potassium_current__beta_a1 - var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 * var_rapid_delayed_rectifier_potassium_current__alpha_a1; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_calcium_concentration__Cass = pow((1.0 + 11.899999999999999 * pow((0.238 + var_chaste_interface__calcium_concentration__Cass), (-2.0))), (-1.0)) * (80.8080808080808 * var_calcium_fluxes__J_rel - 535.2314160604316 * var_L_type_calcium_current__i_CaL - 17400.6734006734 * var_calcium_fluxes__J_xfer); // micromolar / millisecond
        const double d_dt_chaste_interface_var_ryanodine_receptors__P_C2 = 0.009 * var_chaste_interface__ryanodine_receptors__P_O1 - 0.0008 * var_chaste_interface__ryanodine_receptors__P_C2; // 1 / millisecond
        const double d_dt_chaste_interface_var_ryanodine_receptors__P_O2 = -0.965 * var_chaste_interface__ryanodine_receptors__P_O2 + 0.00405 * pow(var_chaste_interface__calcium_concentration__Cass, 3.0) * var_chaste_interface__ryanodine_receptors__P_O1; // 1 / millisecond
        const double d_dt_chaste_interface_var_ryanodine_receptors__P_O1 = 0.0008 * var_chaste_interface__ryanodine_receptors__P_C2 + 0.965 * var_chaste_interface__ryanodine_receptors__P_O2 - 0.08024999999999999 * var_chaste_interface__ryanodine_receptors__P_O1 + 0.006075 * pow(var_chaste_interface__calcium_concentration__Cass, 4.0) * (1.0 - var_chaste_interface__ryanodine_receptors__P_C2 - var_chaste_interface__ryanodine_receptors__P_O1 - var_chaste_interface__ryanodine_receptors__P_O2) - 0.00405 * pow(var_chaste_interface__calcium_concentration__Cass, 3.0) * var_chaste_interface__ryanodine_receptors__P_O1; // 1 / millisecond
        const double d_dt_chaste_interface_var_slow_delayed_rectifier_potassium_current__nKs = -9.53333e-05 * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs * exp(-1.007 - 0.038 * var_chaste_interface__membrane__V) + 4.81333e-06 * (1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs) * (26.5 + var_chaste_interface__membrane__V) / (1.0 - exp(-3.392 - 0.128 * var_chaste_interface__membrane__V)); // 1 / millisecond
        const double var_slow_delayed_rectifier_potassium_current__i_Ks = 0.00575 * pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 2.0) * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V); // picoA_per_picoF
        const double var_slow_transient_outward_potassium_current__ass = 1.0 / (1.0 + exp(-2.922077922077922 - 0.12987012987012986 * var_chaste_interface__membrane__V)); // dimensionless
        const double d_dt_chaste_interface_var_non_inactivating_steady_state_potassium_current__aKss = (-var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss + var_slow_transient_outward_potassium_current__ass) / (13.17 + 39.3 * exp(-0.0862 * var_chaste_interface__membrane__V)); // 1 / millisecond
        const double var_slow_transient_outward_potassium_current__iss = 1.0 / (1.0 + exp(7.9298245614035086 + 0.17543859649122806 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_slow_transient_outward_potassium_current__i_Kto_s = 0; // picoA_per_picoF
        const double d_dt_chaste_interface_var_slow_transient_outward_potassium_current__ato_s = (-var_chaste_interface__slow_transient_outward_potassium_current__ato_s + var_slow_transient_outward_potassium_current__ass) / (2.058 + 0.493 * exp(-0.0629 * var_chaste_interface__membrane__V)); // 1 / millisecond
        const double d_dt_chaste_interface_var_slow_transient_outward_potassium_current__ito_s = (-var_chaste_interface__slow_transient_outward_potassium_current__ito_s + var_slow_transient_outward_potassium_current__iss) / (270.0 + 1050.0 / (1.0 + exp(7.9298245614035086 + 0.17543859649122806 * var_chaste_interface__membrane__V))); // 1 / millisecond
        const double var_fast_sodium_current__E_Na = 25.674321243523316 * log(126540.0 / (0.1 * var_chaste_interface__potassium_concentration__Ki + 0.9 * var_chaste_interface__sodium_concentration__Nai)); // millivolt
        const double var_fast_sodium_current__i_Na = 13.0 * (-var_fast_sodium_current__E_Na + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current__O_Na; // picoA_per_picoF
        const double var_rapid_delayed_rectifier_potassium_current__i_Kr = 0.078 * (-25.674321243523316 * log(8092.0 / (0.98 * var_chaste_interface__potassium_concentration__Ki + 0.02 * var_chaste_interface__sodium_concentration__Nai)) + var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K; // picoA_per_picoF
        const double var_sodium_background_current__i_Nab = 0.0026 * var_chaste_interface__membrane__V - 0.0026 * var_fast_sodium_current__E_Na; // picoA_per_picoF
        const double var_sodium_calcium_exchange_current__i_NaCa = 2.6970585464294846e-17 * (1800.0 * pow(var_chaste_interface__sodium_concentration__Nai, 3.0) * exp(0.01363229807246772 * var_chaste_interface__membrane__V) - 2744000000000000.0 * var_chaste_interface__calcium_concentration__Cai * exp(-0.025317124991725767 * var_chaste_interface__membrane__V)) / (1.0 + 0.1 * exp(-0.025317124991725767 * var_chaste_interface__membrane__V)); // picoA_per_picoF
        const double d_dt_chaste_interface_var_calcium_concentration__Cai = pow((1.0 + 11.899999999999999 * pow((0.238 + var_chaste_interface__calcium_concentration__Cai), (-2.0))), (-1.0)) * (-var_calcium_fluxes__J_up + 0.0196 * var_chaste_interface__calcium_buffering__LTRPN_Ca + 3.2e-05 * var_chaste_interface__calcium_buffering__HTRPN_Ca + 0.06151847158279728 * var_sodium_calcium_exchange_current__i_NaCa - 0.03075923579139864 * var_calcium_background_current__i_Cab - 0.03075923579139864 * var_calcium_pump_current__i_pCa - 0.0327 * (70.0 - var_chaste_interface__calcium_buffering__LTRPN_Ca) * var_chaste_interface__calcium_concentration__Cai - 0.00237 * (140.0 - var_chaste_interface__calcium_buffering__HTRPN_Ca) * var_chaste_interface__calcium_concentration__Cai + var_calcium_fluxes__J_leak + var_calcium_fluxes__J_xfer); // micromolar / millisecond
        const double var_sodium_potassium_pump_current__i_NaK = 0.688695652173913 / ((1.0 + 3043189.116699782 * pow(1 / var_chaste_interface__sodium_concentration__Nai, 1.5)) * (1.0 + 0.1245 * exp(-0.0038949423064193493 * var_chaste_interface__membrane__V) + 0.0365 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.080237741456166)) * exp(-0.03894942306419349 * var_chaste_interface__membrane__V))); // picoA_per_picoF
        const double d_dt_chaste_interface_var_sodium_concentration__Nai = -0.18455541474839185 * var_sodium_calcium_exchange_current__i_NaCa - 0.18455541474839185 * var_sodium_potassium_pump_current__i_NaK - 0.06151847158279728 * var_fast_sodium_current__i_Na - 0.06151847158279728 * var_sodium_background_current__i_Nab; // micromolar / millisecond
        const double var_time_independent_potassium_current__i_K1 = 0.2828021390374332 * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(0.0896 * var_chaste_interface__membrane__V - 0.0896 * var_fast_transient_outward_potassium_current__E_K)); // picoA_per_picoF
        const double var_ultra_rapidly_activating_delayed_rectifier_potassium_current__i_Kur = 0.16 * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur; // picoA_per_picoF
        const double d_dt_chaste_interface_var_potassium_concentration__Ki = 0.12303694316559456 * var_sodium_potassium_pump_current__i_NaK - 0.06151847158279728 * var_fast_transient_outward_potassium_current__i_Kto_f - 0.06151847158279728 * var_non_inactivating_steady_state_potassium_current__i_Kss - 0.06151847158279728 * var_rapid_delayed_rectifier_potassium_current__i_Kr - 0.06151847158279728 * var_slow_delayed_rectifier_potassium_current__i_Ks - 0.06151847158279728 * var_slow_transient_outward_potassium_current__i_Kto_s - 0.06151847158279728 * var_time_independent_potassium_current__i_K1 - 0.06151847158279728 * var_ultra_rapidly_activating_delayed_rectifier_potassium_current__i_Kur; // micromolar / millisecond
        const double d_dt_chaste_interface_var_ultra_rapidly_activating_delayed_rectifier_potassium_current__aur = (-var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur + var_slow_transient_outward_potassium_current__ass) / (2.058 + 0.493 * exp(-0.0629 * var_chaste_interface__membrane__V)); // 1 / millisecond
        const double d_dt_chaste_interface_var_ultra_rapidly_activating_delayed_rectifier_potassium_current__iur = (-var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur + var_slow_transient_outward_potassium_current__iss) / (1200.0 - 170.0 / (1.0 + exp(7.9298245614035086 + 0.17543859649122806 * var_chaste_interface__membrane__V))); // 1 / millisecond
