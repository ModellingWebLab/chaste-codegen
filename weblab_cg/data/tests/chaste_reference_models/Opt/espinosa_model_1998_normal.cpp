...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellespinosa_model_1998_normalFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel__i_Ca_L_Ca_ds = 0.008984133797458913 * (-50.0 + var_chaste_interface__membrane__V) * (-2.5 * exp(3.7433890822745473 - 0.07486778164549095 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(3.7433890822745473)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(3.7433890822745473 - 0.07486778164549095 * var_chaste_interface__membrane__V)); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_K_cyt = 0; // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_K_ds = 6.738100348094186e-06 * (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372736) - var_chaste_interface__extracellular_potassium_concentration__K_o * exp(1.8716945411372736 - 0.03743389082274547 * var_chaste_interface__membrane__V)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 0.03743389082274547 * var_chaste_interface__membrane__V)); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_Na_cyt = 0; // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_Na_ds = 2.246033449364728e-05 * (-50.0 + var_chaste_interface__membrane__V) * (-148.5 * exp(1.8716945411372736 - 0.03743389082274547 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 0.03743389082274547 * var_chaste_interface__membrane__V)); // nanoA
        const double var_calcium_background_current__i_b_Ca = 0.00025 * var_chaste_interface__membrane__V - 0.0033392200824619565 * log(2.5 / var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
        const double var_reversal_potentials__E_K = 26.71376065969565 * log(var_chaste_interface__extracellular_potassium_concentration__K_o / var_chaste_interface__intracellular_potassium_concentration__K_i); // millivolt
        const double var_potassium_background_current__i_b_K = 0.004 * var_chaste_interface__membrane__V - 0.004 * var_reversal_potentials__E_K; // nanoA
        const double var_fast_sodium_current__i_Na = 0.6 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (-26.71376065969565 * log((148.5 + 0.12 * var_chaste_interface__extracellular_potassium_concentration__K_o) / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i)) + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current_h_gate__h; // nanoA
        const double var_sodium_background_current__i_b_Na = 0.0001 * var_chaste_interface__membrane__V - 0.0026713760659695654 * log(148.5 / var_chaste_interface__intracellular_sodium_concentration__Na_i); // nanoA
        const double var_sodium_calcium_exchanger__i_NaCa_cyt = 0.0001998 * (2.5 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) * exp(0.018716945411372737 * var_chaste_interface__membrane__V) - 3274759.125 * var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(-0.018716945411372737 * var_chaste_interface__membrane__V)) / ((1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) * (1.0 + 0.0125 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) + 16373.795625 * var_chaste_interface__intracellular_calcium_concentration__Ca_i)); // nanoA
        const double var_sodium_calcium_exchanger__i_NaCa_ds = 2.0000000000000002e-07 * (2.5 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) * exp(0.018716945411372737 * var_chaste_interface__membrane__V) - 3274759.125 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds * exp(-0.018716945411372737 * var_chaste_interface__membrane__V)) / ((1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds) * (1.0 + 0.0125 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) + 16373.795625 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds)); // nanoA
        const double var_sodium_potassium_pump__i_NaK = 0.7 * var_chaste_interface__extracellular_potassium_concentration__K_o * var_chaste_interface__intracellular_sodium_concentration__Na_i / ((1.0 + var_chaste_interface__extracellular_potassium_concentration__K_o) * (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i)); // nanoA
        const double var_time_dependent_potassium_current__i_K = (0.010714285714285714 * var_chaste_interface__intracellular_potassium_concentration__K_i - 0.010714285714285714 * var_chaste_interface__extracellular_potassium_concentration__K_o * exp(-0.03743389082274547 * var_chaste_interface__membrane__V)) * var_chaste_interface__time_dependent_potassium_current_x_gate__x; // nanoA
        const double var_time_independent_potassium_current__i_K1 = 0.12 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__extracellular_potassium_concentration__K_o / ((1.0 + exp(0.6251459767398493 + 0.06251459767398493 * var_chaste_interface__membrane__V - 0.06251459767398493 * var_reversal_potentials__E_K)) * (10.0 + var_chaste_interface__extracellular_potassium_concentration__K_o)); // nanoA
        const double var_transient_outward_current__i_to = 0.08 * (0.15 + 0.85 * var_chaste_interface__transient_outward_current_s_gate__s) * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_r_gate__r; // nanoA
    ...
    void Cellespinosa_model_1998_normalFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_channel_d_gate__d = 0.01 * (1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d) * ((fabs(var_L_type_Ca_channel_d_gate__E0_d) < 0.0001) ? (120.0) : (30.0 * var_L_type_Ca_channel_d_gate__E0_d / (1.0 - exp(-0.3333333333333333 * var_L_type_Ca_channel_d_gate__E0_d)))) - 0.01 * ((fabs(var_L_type_Ca_channel_d_gate__E0_d) < 0.0001) ? (120.0) : (12.0 * var_L_type_Ca_channel_d_gate__E0_d / (-1.0 + exp(0.13333333333333333 * var_L_type_Ca_channel_d_gate__E0_d)))) * var_chaste_interface__L_type_Ca_channel_d_gate__d; // 1 / millisecond
        const double d_dt_chaste_interface_var_L_type_Ca_channel_f_gate__f = 0.002 * (1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f) * ((fabs(24.0 + var_chaste_interface__membrane__V) < 0.0001) ? (25.0) : (6.25 * (24.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(4.363636363636363 + 0.18181818181818182 * var_chaste_interface__membrane__V)))) - 0.024 * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 + exp(-6.181818181818182 - 0.18181818181818182 * var_chaste_interface__membrane__V)); // 1 / millisecond
        ...
        const double var_fast_sodium_current_h_gate__beta_h = 2000.0 / (1.0 + 320.0 * exp(-7.5 - 0.1 * var_chaste_interface__membrane__V)); // per_second
        ...
        const double var_sodium_potassium_pump__i_NaK = 0.7 * var_chaste_interface__extracellular_potassium_concentration__K_o * var_chaste_interface__intracellular_sodium_concentration__Na_i / ((1.0 + var_chaste_interface__extracellular_potassium_concentration__K_o) * (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i)); // nanoA
        const double d_dt_chaste_interface_var_intracellular_sodium_concentration__Na_i = -0.0006318274601684922 * var_L_type_Ca_channel__i_Ca_L_Na_cyt - 0.0006318274601684922 * var_L_type_Ca_channel__i_Ca_L_Na_ds - 0.0006318274601684922 * var_fast_sodium_current__i_Na - 0.0006318274601684922 * var_sodium_background_current__i_b_Na - 0.001895482380505477 * var_sodium_calcium_exchanger__i_NaCa_cyt - 0.001895482380505477 * var_sodium_potassium_pump__i_NaK; // millimolar / millisecond
        const double var_time_dependent_potassium_current_x_gate__E0_x = -18.0 + var_chaste_interface__membrane__V; // millivolt
        const double var_time_dependent_potassium_current__i_K = (0.010714285714285714 * var_chaste_interface__intracellular_potassium_concentration__K_i - 0.010714285714285714 * var_chaste_interface__extracellular_potassium_concentration__K_o * exp(-0.03743389082274547 * var_chaste_interface__membrane__V)) * var_chaste_interface__time_dependent_potassium_current_x_gate__x; // nanoA
        const double d_dt_chaste_interface_var_time_dependent_potassium_current_x_gate__x = 0.001 * (1.0 - var_chaste_interface__time_dependent_potassium_current_x_gate__x) * ((fabs(var_time_dependent_potassium_current_x_gate__E0_x) < 0.0001) ? (2.5) : (1.5 * var_time_dependent_potassium_current_x_gate__E0_x / (1.0 - exp(-0.2 * var_time_dependent_potassium_current_x_gate__E0_x)))) - 0.001 * ((fabs(var_time_dependent_potassium_current_x_gate__E0_x) < 0.0001) ? (2.5) : (0.534 * var_time_dependent_potassium_current_x_gate__E0_x / (-1.0 + exp(0.06666666666666667 * var_time_dependent_potassium_current_x_gate__E0_x)))) * var_chaste_interface__time_dependent_potassium_current_x_gate__x; // 1 / millisecond
        const double var_time_independent_potassium_current__i_K1 = 0.12 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__extracellular_potassium_concentration__K_o / ((1.0 + exp(0.6251459767398493 + 0.06251459767398493 * var_chaste_interface__membrane__V - 0.06251459767398493 * var_reversal_potentials__E_K)) * (10.0 + var_chaste_interface__extracellular_potassium_concentration__K_o)); // nanoA
        const double d_dt_chaste_interface_var_transient_outward_current_r_gate__r = 0.333 / (1.0 + exp(2.0000000000000004 - 0.1 * var_chaste_interface__membrane__V)) - 0.333 * var_chaste_interface__transient_outward_current_r_gate__r; // 1 / millisecond
        const double var_transient_outward_current__i_to = 0.08 * (0.15 + 0.85 * var_chaste_interface__transient_outward_current_s_gate__s) * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_r_gate__r; // nanoA
        const double d_dt_chaste_interface_var_extracellular_potassium_concentration__K_o = 0.00378 + 0.0007739886387064027 * var_L_type_Ca_channel__i_Ca_L_K_cyt + 0.0007739886387064027 * var_L_type_Ca_channel__i_Ca_L_K_ds + 0.0007739886387064027 * var_potassium_background_current__i_b_K + 0.0007739886387064027 * var_time_dependent_potassium_current__i_K + 0.0007739886387064027 * var_time_independent_potassium_current__i_K1 + 0.0007739886387064027 * var_transient_outward_current__i_to - 0.0007 * var_chaste_interface__extracellular_potassium_concentration__K_o - 0.0015479772774128055 * var_sodium_potassium_pump__i_NaK; // millimolar / millisecond
        const double d_dt_chaste_interface_var_intracellular_potassium_concentration__K_i = 0.0012636549203369845 * var_sodium_potassium_pump__i_NaK - 0.0006318274601684922 * var_L_type_Ca_channel__i_Ca_L_K_cyt - 0.0006318274601684922 * var_L_type_Ca_channel__i_Ca_L_K_ds - 0.0006318274601684922 * var_potassium_background_current__i_b_K - 0.0006318274601684922 * var_time_dependent_potassium_current__i_K - 0.0006318274601684922 * var_time_independent_potassium_current__i_K1 - 0.0006318274601684922 * var_transient_outward_current__i_to; // millimolar / millisecond
        const double d_dt_chaste_interface_var_transient_outward_current_s_gate__s = 8.580000000000001e-06 * (1.0 - var_chaste_interface__transient_outward_current_s_gate__s) * exp(-0.06722689075630252 * var_chaste_interface__membrane__V) - 0.00858 * var_chaste_interface__transient_outward_current_s_gate__s / (1.0 + exp(-1.4285714285714284 - 0.14285714285714285 * var_chaste_interface__membrane__V)); // 1 / millisecond
