...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellstewart_zhang_model_2008_ssFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_pump_current__i_p_Ca = 0.1238 * var_chaste_interface__calcium_dynamics__Ca_i / (0.0005 + var_chaste_interface__calcium_dynamics__Ca_i); // picoA_per_picoF
        const double var_L_type_Ca_current__i_CaL = 0.5750020209612451 * (-2.0 + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * exp(-1.1230167246823641 + 0.07486778164549095 * var_chaste_interface__membrane__V)) * (-15.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f / (-1.0 + exp(-1.1230167246823641 + 0.07486778164549095 * var_chaste_interface__membrane__V)); // picoA_per_picoF
        ...
        const double var_inward_rectifier_potassium_current__i_K1 = 0.065 * (-8.0 - var_reversal_potentials__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(7.5440000000000005 + 0.1 * var_chaste_interface__membrane__V)); // picoA_per_picoF
        ...
        const double var_rapid_time_dependent_potassium_current__i_Kr = 0.0918 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2; // picoA_per_picoF
        ...
        const double var_sodium_potassium_pump_current__i_NaK = 2.298375 * var_chaste_interface__sodium_dynamics__Na_i / ((40.0 + var_chaste_interface__sodium_dynamics__Na_i) * (1.0 + 0.0353 * exp(-0.03743389082274547 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0.0037433890822745476 * var_chaste_interface__membrane__V))); // picoA_per_picoF
        const double var_sustained_outward_current__i_sus = 0.0227 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(0.29411764705882354 - 0.058823529411764705 * var_chaste_interface__membrane__V)); // picoA_per_picoF
        const double var_transient_outward_current__i_to = 0.08184 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // picoA_per_picoF
    ...
    void Cellstewart_zhang_model_2008_ssFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_current_fCass_gate__fCass = (0.4 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.6 / (1.0 + 400.0 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2.0))) / (2.0 + 80.0 / (1.0 + 400.0 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2.0))); // 1 / millisecond
        const double var_calcium_dynamics__i_leak = 0.00036 * var_chaste_interface__calcium_dynamics__Ca_SR - 0.00036 * var_chaste_interface__calcium_dynamics__Ca_i; // millimolar_per_millisecond
        const double var_calcium_dynamics__i_up = 0.006375 / (1.0 + 6.25e-08 * pow(var_chaste_interface__calcium_dynamics__Ca_i, (-2.0))); // millimolar_per_millisecond
        ...
        const double var_calcium_dynamics__i_rel = 0.015299999999999998 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2.0) * (-var_chaste_interface__calcium_dynamics__Ca_ss + var_chaste_interface__calcium_dynamics__Ca_SR) * var_chaste_interface__calcium_dynamics__R_prime / ((0.06 + 0.15 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2.0) / var_calcium_dynamics__kcasr) * var_calcium_dynamics__kcasr); // millimolar_per_millisecond
        const double d_dt_chaste_interface_var_calcium_dynamics__Ca_SR = 1.0 * (-var_calcium_dynamics__i_leak - var_calcium_dynamics__i_rel + var_calcium_dynamics__i_up) / (1.0 + 3.0 * pow((0.3 + var_chaste_interface__calcium_dynamics__Ca_SR), (-2.0))); // millimolar / millisecond
        const double d_dt_chaste_interface_var_calcium_dynamics__R_prime = 0.005 - 0.005 * var_chaste_interface__calcium_dynamics__R_prime - 0.045 * var_chaste_interface__calcium_dynamics__Ca_ss * var_chaste_interface__calcium_dynamics__R_prime * var_calcium_dynamics__kcasr; // 1 / millisecond
        const double var_calcium_pump_current__i_p_Ca = 0.1238 * var_chaste_interface__calcium_dynamics__Ca_i / (0.0005 + var_chaste_interface__calcium_dynamics__Ca_i); // picoA_per_picoF
        const double var_L_type_Ca_current__i_CaL = 0.5750020209612451 * (-2.0 + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * exp(-1.1230167246823641 + 0.07486778164549095 * var_chaste_interface__membrane__V)) * (-15.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f / (-1.0 + exp(-1.1230167246823641 + 0.07486778164549095 * var_chaste_interface__membrane__V)); // picoA_per_picoF
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_current_f2_gate__f2 = (0.33 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67 / (1.0 + exp(5.0 + 0.14285714285714285 * var_chaste_interface__membrane__V))) / (80.0 / (1.0 + exp(3.0 + 0.1 * var_chaste_interface__membrane__V)) + 31.0 / (1.0 + exp(2.5 - 0.1 * var_chaste_interface__membrane__V)) + 562.0 * exp(-3.0375 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0))); // 1 / millisecond
        const double d_dt_chaste_interface_var_L_type_Ca_current_f_gate__f = (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1.0 / (1.0 + exp(2.8571428571428568 + 0.14285714285714285 * var_chaste_interface__membrane__V))) / (20.0 + 200.0 / (1.0 + exp(1.3 - 0.1 * var_chaste_interface__membrane__V)) + 180.0 / (1.0 + exp(3.0 + 0.1 * var_chaste_interface__membrane__V)) + 1102.5 * exp(-3.24 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0))); // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_hyperpolarization_activated_current_y_gate__y = (-var_chaste_interface__hyperpolarization_activated_current_y_gate__y + 1.0 / (1.0 + exp(11.852941176470587 + 0.14705882352941177 * var_chaste_interface__membrane__V))) * (0.00025 * exp(3.6 + 0.11 * var_chaste_interface__membrane__V) + 0.00025 * exp(-2.9 - 0.04 * var_chaste_interface__membrane__V)); // 1 / millisecond
        const double d_dt_chaste_interface_var_calcium_dynamics__Ca_ss = 1.0 * (20.00731528895391 * var_calcium_dynamics__i_rel - 300.0 * var_calcium_dynamics__i_xfer - 0.017532824616602913 * var_L_type_Ca_current__i_CaL) / (1.0 + 0.0001 * pow((0.00025 + var_chaste_interface__calcium_dynamics__Ca_ss), (-2.0))); // millimolar / millisecond
        ...
        const double var_potassium_pump_current__i_p_K = 0.0146 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(4.1806020066889635 - 0.16722408026755853 * var_chaste_interface__membrane__V)); // picoA_per_picoF
        const double var_rapid_time_dependent_potassium_current__i_Kr = 0.0918 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2; // picoA_per_picoF
        const double d_dt_chaste_interface_var_slow_time_dependent_potassium_current_Xs_gate__Xs = (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1.0 / (1.0 + exp(-0.3571428571428571 - 0.07142857142857142 * var_chaste_interface__membrane__V))) / (80.0 + 1400.0 / (sqrt(1.0 + exp(0.8333333333333333 - 0.16666666666666666 * var_chaste_interface__membrane__V)) * (1.0 + exp(-2.3333333333333335 + 0.06666666666666667 * var_chaste_interface__membrane__V)))); // 1 / millisecond
        const double var_reversal_potentials__E_Na = 26.71376065969565 * log(140.0 / var_chaste_interface__sodium_dynamics__Na_i); // millivolt
        const double var_fast_sodium_current__i_Na = 130.5744 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j; // picoA_per_picoF
        const double var_hyperpolarization_activated_current__i_f_Na = 0.0145654 * (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarization_activated_current_y_gate__y; // picoA_per_picoF
        const double var_slow_time_dependent_potassium_current__i_Ks = 0.2352 * pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2.0) * (-26.71376065969565 * log(9.600000000000001 / (0.03 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i)) + var_chaste_interface__membrane__V); // picoA_per_picoF
        const double var_sodium_background_current__i_b_Na = 0.00029 * var_chaste_interface__membrane__V - 0.00029 * var_reversal_potentials__E_Na; // picoA_per_picoF
        const double var_sodium_calcium_exchanger_current__i_NaCa = 8.666220229942446e-05 * (2.0 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3.0) * exp(0.013101861787960915 * var_chaste_interface__membrane__V) - 6860000.0 * var_chaste_interface__calcium_dynamics__Ca_i * exp(-0.02433202903478456 * var_chaste_interface__membrane__V)) / (1.0 + 0.1 * exp(-0.02433202903478456 * var_chaste_interface__membrane__V)); // picoA_per_picoF
        const double d_dt_chaste_interface_var_calcium_dynamics__Ca_i = 1.0 * (0.06669105096317972 * var_calcium_dynamics__i_leak + 0.00011688549744401942 * var_sodium_calcium_exchanger_current__i_NaCa - 0.06669105096317972 * var_calcium_dynamics__i_up - 5.844274872200971e-05 * var_calcium_background_current__i_b_Ca - 5.844274872200971e-05 * var_calcium_pump_current__i_p_Ca + var_calcium_dynamics__i_xfer) / (1.0 + 0.0002 * pow((0.001 + var_chaste_interface__calcium_dynamics__Ca_i), (-2.0))); // millimolar / millisecond
        const double var_sodium_potassium_pump_current__i_NaK = 2.298375 * var_chaste_interface__sodium_dynamics__Na_i / ((40.0 + var_chaste_interface__sodium_dynamics__Na_i) * (1.0 + 0.0353 * exp(-0.03743389082274547 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0.0037433890822745476 * var_chaste_interface__membrane__V))); // picoA_per_picoF
        ...
        const double var_sustained_outward_current__i_sus = 0.0227 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(0.29411764705882354 - 0.058823529411764705 * var_chaste_interface__membrane__V)); // picoA_per_picoF
        const double d_dt_chaste_interface_var_transient_outward_current_r_gate__r = (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / (1.0 + exp(1.5384615384615385 - 0.07692307692307693 * var_chaste_interface__membrane__V))) / (7.3 + 10.45 * exp(-0.8888888888888888 * pow((1 + 0.025 * var_chaste_interface__membrane__V), 2.0))); // 1 / millisecond
        const double var_transient_outward_current__i_to = 0.08184 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // picoA_per_picoF
        ...
        const double d_dt_chaste_interface_var_transient_outward_current_s_gate__s = (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / (1.0 + exp(2.076923076923077 + 0.07692307692307693 * var_chaste_interface__membrane__V))) / (42.0 + 5.0 / (1.0 + exp(-8.0 + 0.2 * var_chaste_interface__membrane__V)) + 85.0 * exp(-1.953125 * pow((1 + 0.04 * var_chaste_interface__membrane__V), 2.0))); // 1 / millisecond
