...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellnoble_model_1991FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = -63.1578947368421 * HeartConfig::Instance()->GetCapacitance(); // uA_per_cm2
    ...
    double Cellnoble_model_1991FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_potassium_background_current__i_b_K = 0.0006 * var_chaste_interface__membrane__V - 0.0006 * var_reversal_potentials__E_K; // nanoA
        ...
        const double var_time_dependent_potassium_current__i_K = (0.007142857142857143 * var_chaste_interface__intracellular_potassium_concentration__K_i - 0.02857142857142857 * exp(-0.03743389082274547 * var_chaste_interface__membrane__V)) * var_chaste_interface__time_dependent_potassium_current_x_gate__x; // nanoA
        const double var_time_independent_potassium_current__i_K1 = 0.2857142857142857 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(-0.7486778164549095 + 0.07486778164549095 * var_chaste_interface__membrane__V - 0.07486778164549095 * var_reversal_potentials__E_K)); // nanoA
    ...
    void Cellnoble_model_1991FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_channel_f_gate__f = 0.0005 * (1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f) * ((fabs(34.0 + var_chaste_interface__membrane__V) < 0.0001) ? (25.0) : (6.25 * (34.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V)))) - 0.025 * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 + exp(-8.5 - 0.25 * var_chaste_interface__membrane__V)); // 1 / millisecond
        ...
        const double var_sodium_background_current__i_b_Na = 0.0006 * var_chaste_interface__membrane__V - 0.01602825639581739 * log(140.0 / var_chaste_interface__intracellular_sodium_concentration__Na_i); // nanoA
        const double var_sodium_calcium_exchanger__i_NaCa = 0.0005 * (2.0 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) * exp(0.018716945411372737 * var_chaste_interface__membrane__V) - 2744000.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(-0.018716945411372737 * var_chaste_interface__membrane__V)) / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
        const double d_dt_chaste_interface_var_intracellular_calcium_concentration__Ca_i = 0.0006318274601684922 * var_sodium_calcium_exchanger__i_NaCa + 0.00020408163265306123 * var_calcium_release__i_rel - 0.001 * var_intracellular_calcium_concentration__Ca_Calmod_orig_deriv - 0.001 * var_intracellular_calcium_concentration__Ca_Trop_orig_deriv - 0.001 * var_sarcoplasmic_reticulum_calcium_pump__i_up - 0.0003159137300842461 * var_L_type_Ca_channel__i_Ca_L_Ca - 0.0003159137300842461 * var_calcium_background_current__i_b_Ca; // millimolar / millisecond
        const double var_sodium_potassium_pump__i_NaK = 0.5599999999999999 * var_chaste_interface__intracellular_sodium_concentration__Na_i / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i); // nanoA
        const double d_dt_chaste_interface_var_intracellular_sodium_concentration__Na_i = -0.0006318274601684922 * var_L_type_Ca_channel__i_Ca_L_Na - 0.0006318274601684922 * var_fast_sodium_current__i_Na - 0.0006318274601684922 * var_sodium_background_current__i_b_Na - 0.001895482380505477 * var_sodium_calcium_exchanger__i_NaCa - 0.001895482380505477 * var_sodium_potassium_pump__i_NaK; // millimolar / millisecond
        const double var_time_dependent_potassium_current__i_K = (0.007142857142857143 * var_chaste_interface__intracellular_potassium_concentration__K_i - 0.02857142857142857 * exp(-0.03743389082274547 * var_chaste_interface__membrane__V)) * var_chaste_interface__time_dependent_potassium_current_x_gate__x; // nanoA
        const double d_dt_chaste_interface_var_time_dependent_potassium_current_x_gate__x = 0.0005 * (1.0 - var_chaste_interface__time_dependent_potassium_current_x_gate__x) * exp(4.130000000000001 + 0.0826 * var_chaste_interface__membrane__V) / (1.0 + exp(2.85 + 0.057 * var_chaste_interface__membrane__V)) - 0.0013000000000000002 * var_chaste_interface__time_dependent_potassium_current_x_gate__x * exp(-1.2 - 0.06 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.8 - 0.04 * var_chaste_interface__membrane__V)); // 1 / millisecond
        const double var_time_independent_potassium_current__i_K1 = 0.2857142857142857 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(-0.7486778164549095 + 0.07486778164549095 * var_chaste_interface__membrane__V - 0.07486778164549095 * var_reversal_potentials__E_K)); // nanoA
        ...
        const double var_transient_outward_current__i_to = 0.005 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // nanoA
        const double d_dt_chaste_interface_var_intracellular_potassium_concentration__K_i = 0.0012636549203369845 * var_sodium_potassium_pump__i_NaK - 0.0006318274601684922 * var_L_type_Ca_channel__i_Ca_L_K - 0.0006318274601684922 * var_potassium_background_current__i_b_K - 0.0006318274601684922 * var_time_dependent_potassium_current__i_K - 0.0006318274601684922 * var_time_independent_potassium_current__i_K1 - 0.0006318274601684922 * var_transient_outward_current__i_to; // millimolar / millisecond
