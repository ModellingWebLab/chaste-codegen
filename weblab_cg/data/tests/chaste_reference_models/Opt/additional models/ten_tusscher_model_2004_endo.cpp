...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellten_tusscher_model_2004_endoFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_transient_outward_current__i_to = 0.073 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // picoA_per_picoF
    ...
    void Cellten_tusscher_model_2004_endoFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_transient_outward_current_s_gate__s = (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / (1.0 + exp(5.6000000000000005 + 0.2 * var_chaste_interface__membrane__V))) / (8.0 + 1000.0 * exp(-4.489 * pow((1 + 0.014925373134328358 * var_chaste_interface__membrane__V), 2.0))); // 1 / millisecond
