...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellmatsuoka_model_2003FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_rapid_time_dependent_potassium_current__g_Kr = 0.7137091227794412 * pow(var_external_ion_concentrations__Ko, 0.2) * mParameters[0] * var_rapid_time_dependent_potassium_current__P_Kr; // nanoS
        ...
        const double var_time_independent_potassium_current__g_K1 = 0.5093807119385996 * pow(var_external_ion_concentrations__Ko, 0.4) * mParameters[0] * var_time_independent_potassium_current__P_K1_0; // nanoS
