...
#include "MathsCustomFunctions.hpp"
    ...
    void Dynamicluo_rudy_1994FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface__L_type_Ca_channel_d_gate__d = ((var_L_type_Ca_channel_d_gate__d_infinity / var_L_type_Ca_channel_d_gate__tau_d) * (1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d)) - (((1.0 - var_L_type_Ca_channel_d_gate__d_infinity) / var_L_type_Ca_channel_d_gate__tau_d) * var_chaste_interface__L_type_Ca_channel_d_gate__d); // 'per millisecond'
        const double d_dt_chaste_interface__L_type_Ca_channel_f_gate__f = ((var_L_type_Ca_channel_f_gate__f_infinity / var_L_type_Ca_channel_f_gate__tau_f) * (1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f)) - (((1.0 - var_L_type_Ca_channel_f_gate__f_infinity) / var_L_type_Ca_channel_f_gate__tau_f) * var_chaste_interface__L_type_Ca_channel_f_gate__f); // 'per millisecond'
        const double d_dt_chaste_interface__time_dependent_potassium_current_X_gate__X = (((7.1899999999999999e-05 * (var_chaste_interface__membrane__V + 30.0)) / (1.0 - exp( -0.14799999999999999 * (var_chaste_interface__membrane__V + 30.0)))) * (1.0 - var_chaste_interface__time_dependent_potassium_current_X_gate__X)) - (((0.00013100000000000001 * (var_chaste_interface__membrane__V + 30.0)) / ( -1.0 + exp(0.068699999999999997 * (var_chaste_interface__membrane__V + 30.0)))) * var_chaste_interface__time_dependent_potassium_current_X_gate__X); // 'per millisecond'
