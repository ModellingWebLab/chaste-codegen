...
#include "MathsCustomFunctions.hpp"
    ...
    double CellFoxModel2002FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_current__Ca_i = 1000.0 * var_chaste_interface__calcium_dynamics__Ca_i; // micromolar
        const double var_L_type_Ca_current__i_Ca_max = (((var_chaste_interface__membrane__V * 0.46933739999999996) * 0.00038799692706433761) * ((var_L_type_Ca_current__Ca_i * exp((var_chaste_interface__membrane__V * 193.0) * 0.00038799692706433761)) - 682.0)) / (exp((var_chaste_interface__membrane__V * 193.0) * 0.00038799692706433761) - 1.0); // microA_per_microF
        ...
        const double var_sarcolemmal_calcium_pump__Ca_i = 1000.0 * var_chaste_interface__calcium_dynamics__Ca_i; // micromolar
        const double var_sarcolemmal_calcium_pump__i_p_Ca = (0.050000000000000003 * var_sarcolemmal_calcium_pump__Ca_i) / (0.050000000000000003 + var_sarcolemmal_calcium_pump__Ca_i); // microA_per_microF
        const double var_calcium_background_current__i_Ca_b = 0.00038420000000000001 * (var_chaste_interface__membrane__V - (13.354093264248705 * log(2000.0 / (1000.0 * var_chaste_interface__calcium_dynamics__Ca_i)))); // microA_per_microF
    ...
    void CellFoxModel2002FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_calcium_dynamics__Ca_i = 1000.0 * var_chaste_interface__calcium_dynamics__Ca_i; // micromolar
        const double var_calcium_dynamics__J_rel = (6.0 * var_chaste_interface__L_type_Ca_current_f_gate__f * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f_Ca_gate__f_Ca * (((1.0 / (1.0 + pow(2000.0 / var_chaste_interface__calcium_dynamics__Ca_SR, 3.0))) * var_chaste_interface__calcium_dynamics__Ca_SR) - var_calcium_dynamics__Ca_i)) / (1.0 + (1.6499999999999999 * exp(var_chaste_interface__membrane__V * 0.050000000000000003))); // micromolar_per_millisecond
        const double var_calcium_dynamics__J_leak = 9.9999999999999995e-07 * (var_chaste_interface__calcium_dynamics__Ca_SR - var_calcium_dynamics__Ca_i); // micromolar_per_millisecond
        const double var_calcium_dynamics__J_up = 0.10000000000000001 / (1.0 + pow(0.32000000000000001 / var_calcium_dynamics__Ca_i, 2.0)); // micromolar_per_millisecond
        const double d_dt_chaste_interface__calcium_dynamics__Ca_i = 0.001 * ((1.0 / (1.0 + (20.0 / pow(2.0 + var_calcium_dynamics__Ca_i, 2.0)))) * (((var_calcium_dynamics__J_rel + var_calcium_dynamics__J_leak) - var_calcium_dynamics__J_up) - (0.03075923579139864 * ((var_L_type_Ca_current__i_Ca + var_calcium_background_current__i_Ca_b + var_sarcolemmal_calcium_pump__i_p_Ca) - (2.0 * var_Na_Ca_exchanger__i_NaCa))))); // 'millimole per litre per millisecond'
        ...
        const double d_dt_chaste_interface__L_type_Ca_current_f_Ca_gate__f_Ca = ((1.0 / (1.0 + pow(var_L_type_Ca_current__Ca_i * 5.5555555555555554, 3.0))) - var_chaste_interface__L_type_Ca_current_f_Ca_gate__f_Ca) * 0.033333333333333333; // per_millisecond
        ...
        rDY[7] = d_dt_chaste_interface__transient_outward_potassium_current_X_to_gate__X_to;
        rDY[8] = d_dt_chaste_interface__transient_outward_potassium_current_Y_to_gate__Y_to;
        rDY[9] = d_dt_chaste_interface__L_type_Ca_current_f_gate__f;
        rDY[10] = d_dt_chaste_interface__L_type_Ca_current_d_gate__d;
        rDY[11] = d_dt_chaste_interface__L_type_Ca_current_f_Ca_gate__f_Ca;
