...
class Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__Vms__Vms)
    {
        ...
        const double* const _lt_0_row = Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables(const Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables&);
    Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables&);
    Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables> Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt::Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt::~Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__Vms__Vms);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__Vms__Vms);
    ...
    void Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_i_Cas__Coinf = _lt_0_row[8]; // dimensionless
        const double var_i_Cas__tauC1 = _lt_0_row[6]; // second
        const double var_i_Cas__tauC2 = _lt_0_row[7]; // second
        const double var_i_Cas__tauCcast = 0.0089999999999999993; // second
        const double var_i_Cas__tauCo = _lt_0_row[9]; // second
        ...
        const double var_i_Kfs_qs_gate__qinfs = _lt_0_row[10]; // dimensionless
        const double var_i_Kfs_qs_gate__tauqs = 1 / (_lt_0_row[11]); // second
        ...
        const double var_i_Ksts_rsts_gate__rstinfs = _lt_0_row[12]; // dimensionless
        const double var_i_Ksts_rsts_gate__taursts = 10.0 / (_lt_0_row[16]); // second
        ...
        const double var_i_Ktos_rs_gate__rinfs = _lt_0_row[15]; // dimensionless
        const double var_i_Ktos_rs_gate__taurs = 1 / (_lt_0_row[16]); // second
        const double var_i_Ktos_ss_gate__sinfs = _lt_0_row[17]; // dimensionless
        const double var_i_Ktos_ss_gate__tauss = _lt_0_row[18]; // second
        const double var_i_Ktos_sss_gate__ssinfs = _lt_0_row[17]; // dimensionless
        const double var_i_Ktos_sss_gate__tausss = _lt_0_row[19]; // second
        ...
        const double var_i_Nas_h_gate__alpha_h = 284.39999999999998 / (_lt_0_row[20]); // per_second
        const double var_i_Nas_h_gate__beta_h = _lt_0_row[21]; // per_second
        const double var_i_Nas_m_gate__alpha_m = _lt_0_row[22]; // per_second
        const double var_i_Nas_m_gate__beta_m = 3800.0 * _lt_0_row[23]; // per_second
        ...
        const double var_i_NaCas__i_NaCas = (pow(var_chaste_interface__ion_concentrations__Nai, 3) * var_model_parameters__Cae * _lt_0_row[2] - pow(var_model_parameters__Nae, 3) * var_chaste_interface__ion_concentrations__Cai * _lt_0_row[3]) * var_membrane_permeabilities__i_NaCa_maxs / (1.0 + 0.0001 * pow(var_chaste_interface__ion_concentrations__Nai, 3) * var_model_parameters__Cae + 0.0001 * pow(var_model_parameters__Nae, 3) * var_chaste_interface__ion_concentrations__Cai); // microA
        ...
        rDY[0] = d_dt_chaste_interface_var_Vms__Vms;
        rDY[1] = d_dt_chaste_interface_var_ion_concentrations__Cai;
        rAlphaOrTau[2] = 0.001 * var_i_Nas_m_gate__alpha_m;
        rBetaOrInf[2] = 0.001 * var_i_Nas_m_gate__beta_m;
        rAlphaOrTau[3] = 0.001 * var_i_Nas_h_gate__alpha_h;
        rBetaOrInf[3] = 0.001 * var_i_Nas_h_gate__beta_h;
        rDY[4] = d_dt_chaste_interface_var_i_Nat_m_gate__m;
        rDY[5] = d_dt_chaste_interface_var_i_Nat_h_gate__h;
        rAlphaOrTau[6] = 1000.0 * var_i_Cas__tauCo;
        rBetaOrInf[6] = var_i_Cas__Coinf;
        rAlphaOrTau[7] = 1000.0 * var_i_Cas__tauC1;
        rBetaOrInf[7] = var_i_Cas__C1inf;
        rAlphaOrTau[8] = 1000.0 * var_i_Cas__tauC2;
        rBetaOrInf[8] = var_i_Cas__C2inf;
        rDY[9] = d_dt_chaste_interface_var_i_Cas__Ccast;
        rDY[10] = d_dt_chaste_interface_var_i_Cat__Co;
        rDY[11] = d_dt_chaste_interface_var_i_Cat__C1;
        rDY[12] = d_dt_chaste_interface_var_i_Cat__C2;
        rDY[13] = d_dt_chaste_interface_var_i_Cat__Ccast;
        rAlphaOrTau[14] = 1000.0 * var_i_Ktos_rs_gate__taurs;
        rBetaOrInf[14] = var_i_Ktos_rs_gate__rinfs;
        rAlphaOrTau[15] = 1000.0 * var_i_Ktos_ss_gate__tauss;
        rBetaOrInf[15] = var_i_Ktos_ss_gate__sinfs;
        rAlphaOrTau[16] = 1000.0 * var_i_Ktos_sss_gate__tausss;
        rBetaOrInf[16] = var_i_Ktos_sss_gate__ssinfs;
        rDY[17] = d_dt_chaste_interface_var_i_Ktot_rt_gate__rt;
        rDY[18] = d_dt_chaste_interface_var_i_Ktot_st_gate__st;
        rDY[19] = d_dt_chaste_interface_var_i_Ktot_sst_gate__sst;
        rAlphaOrTau[20] = 1000.0 * var_i_Ksts_rsts_gate__taursts;
        rBetaOrInf[20] = var_i_Ksts_rsts_gate__rstinfs;
        rAlphaOrTau[21] = 1000.0 * var_i_Ksts_ssts_gate__taussts;
        rBetaOrInf[21] = var_i_Ksts_ssts_gate__sstinfs;
        rDY[22] = d_dt_chaste_interface_var_i_Kstt_rstt_gate__rstt;
        rDY[23] = d_dt_chaste_interface_var_i_Kstt_sstt_gate__sstt;
        rAlphaOrTau[24] = 1000.0 * var_i_Kfs_qs_gate__tauqs;
        rBetaOrInf[24] = var_i_Kfs_qs_gate__qinfs;
        rDY[25] = d_dt_chaste_interface_var_i_Kft_qt_gate__qt;
        rDY[26] = d_dt_chaste_interface_var_JCaSRrel__F1;
        rDY[27] = d_dt_chaste_interface_var_JCaSRrel__F2;
        rDY[28] = d_dt_chaste_interface_var_JCaSRrel__F3;
        rDY[29] = d_dt_chaste_interface_var_JCaSRrel__F4;
        rDY[30] = d_dt_chaste_interface_var_CaSRup__CaSRup;
        rDY[31] = d_dt_chaste_interface_var_CaSRrel__CaSRrel;
        rDY[32] = d_dt_chaste_interface_var_ion_concentrations__Nai;
        rDY[33] = d_dt_chaste_interface_var_ion_concentrations__Ki;
        rDY[34] = d_dt_chaste_interface_var_ion_concentrations__Nat;
        rDY[35] = d_dt_chaste_interface_var_ion_concentrations__Cat;
        rDY[36] = d_dt_chaste_interface_var_ion_concentrations__Kt;
        rDY[37] = d_dt_chaste_interface_var_ion_concentrations__Cass;
        rDY[38] = d_dt_chaste_interface_var_ion_concentrations__BTRH;
        rDY[39] = d_dt_chaste_interface_var_ion_concentrations__BTRL;
        rDY[40] = d_dt_chaste_interface_var_Vmt__Vmt;
    }
    void Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpasek_simurda_christe_2006FromCellMLRushLarsenOpt)
