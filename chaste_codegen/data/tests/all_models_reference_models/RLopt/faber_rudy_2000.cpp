...
class Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables(const Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables&);
    Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables&);
    Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables> Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellfaber_rudy_2000FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellfaber_rudy_2000FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellfaber_rudy_2000FromCellMLRushLarsenOpt::Cellfaber_rudy_2000FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellfaber_rudy_2000FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellfaber_rudy_2000FromCellMLRushLarsenOpt::~Cellfaber_rudy_2000FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellfaber_rudy_2000FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellfaber_rudy_2000FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellfaber_rudy_2000FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellfaber_rudy_2000FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_T_type_Ca_channel_b_gate__b_inf = _lt_0_row[15]; // dimensionless
        const double var_T_type_Ca_channel_b_gate__tau_b = _lt_0_row[16]; // ms
        const double var_T_type_Ca_channel_g_gate__g_inf = _lt_0_row[17]; // dimensionless
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = _lt_0_row[18]; // per_ms
        const double var_fast_sodium_current_m_gate__beta_m = 0.080000000000000002 * _lt_0_row[19]; // per_ms
        ...
        const double var_sodium_activated_potassium_current__pov = _lt_0_row[9]; // dimensionless
    ...
    void Cellfaber_rudy_2000FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellfaber_rudy_2000FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellfaber_rudy_2000FromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellfaber_rudy_2000FromCellMLRushLarsenOpt)
