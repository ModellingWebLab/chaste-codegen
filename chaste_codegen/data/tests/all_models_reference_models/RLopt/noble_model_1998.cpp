...
// LCOV_EXCL_STOP
        ...
        else
        {
            ...
            const double var_rapid_delayed_rectifier_potassium_current_xr1_gate__alpha_xr1 = 50.0 * _lt_0_row[13]; // per_second
            const double var_rapid_delayed_rectifier_potassium_current_xr1_gate__beta_xr1 = 0.050000000000000003 * _lt_0_row[14]; // per_second
            const double var_rapid_delayed_rectifier_potassium_current_xr2_gate__alpha_xr2 = 50.0 * _lt_0_row[13]; // per_second
            const double var_rapid_delayed_rectifier_potassium_current_xr2_gate__beta_xr2 = 0.40000000000000002 * _lt_0_row[15]; // per_second
            ...
            const double var_rapid_delayed_rectifier_potassium_current__i_Kr = _lt_0_row[5] * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * (var_rapid_delayed_rectifier_potassium_current__g_Kr1 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1 + var_rapid_delayed_rectifier_potassium_current__g_Kr2 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2); // nanoA
            ...
            const double var_persistent_sodium_current__i_p_Na = _lt_0_row[6] * (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__V) * var_persistent_sodium_current__g_pna; // nanoA
            ...
            const double var_slow_delayed_rectifier_potassium_current_xs_gate__alpha_xs = 14.0 * _lt_0_row[16]; // per_second
            const double var_slow_delayed_rectifier_potassium_current_xs_gate__beta_xs = _lt_0_row[17]; // per_second
            ...
            const double var_transient_outward_current_s_gate__alpha_s = 0.033000000000000002 * _lt_0_row[19]; // per_second
            const double var_transient_outward_current_s_gate__beta_s = 33.0 * _lt_0_row[20]; // per_second
