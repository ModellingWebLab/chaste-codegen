...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double var_fast_sodium_current_h_gate__tau_h = 1.0 / (((var_chaste_interface__membrane__V < -40) ? (057000000000000002 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0)) + ((var_chaste_interface__membrane__V < -40) ? (310000 * exp(0.34849999999999998 * var_chaste_interface__membrane__V) + 2.7000000000000002 * exp(079000000000000001 * var_chaste_interface__membrane__V)) : (5.9230769230769234 / (1.0 + exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__membrane__V))))); // millisecond
        ...
        const double d_dt_chaste_interface_var_calcium_dynamics__Ca_i = 1.0 * (0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973232e-7 * log(2.0 / var_chaste_interface__calcium_dynamics__Ca_i) - 0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 00042515544989027063 / (1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2)) + 1.0129554625362472e-8 * (2.0 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) * exp(013101861787960915 * var_chaste_interface__membrane__V) - 6860000 * var_chaste_interface__calcium_dynamics__Ca_i * exp(-024332029034784559 * var_chaste_interface__membrane__V)) / (1.0 + 0.10000000000000001 * exp(-024332029034784559 * var_chaste_interface__membrane__V)) - 7.2352122917848019e-6 * var_chaste_interface__calcium_dynamics__Ca_i / (00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i)) / (1.0 + 00020000000000000001 / pow((001 + var_chaste_interface__calcium_dynamics__Ca_i), 2)); // millimolar / millisecond
        const double d_dt_chaste_interface_var_sodium_dynamics__Na_i = 9.0551084895961074e-7 * log(140 / var_chaste_interface__sodium_dynamics__Na_i) - 3.389679425876563e-8 * var_chaste_interface__membrane__V - 3.0388663876087418e-8 * (2.0 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) * exp(013101861787960915 * var_chaste_interface__membrane__V) - 6860000 * var_chaste_interface__calcium_dynamics__Ca_i * exp(-024332029034784559 * var_chaste_interface__membrane__V)) / (1.0 + 0.10000000000000001 * exp(-024332029034784559 * var_chaste_interface__membrane__V)) - 00080594011556369446 * var_chaste_interface__sodium_dynamics__Na_i / ((40 + var_chaste_interface__sodium_dynamics__Na_i) * (1.0 + 035299999999999998 * exp(-037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0037433890822745472 * var_chaste_interface__membrane__V))) - 00011688549744401942 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-26.713760659695652 * log(140 / var_chaste_interface__sodium_dynamics__Na_i) + var_chaste_interface__membrane__V) * mParameters[1] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_potassium_dynamics__K_i = -00011688549744401942 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() - 4.5819114998055616e-5 * pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * (-26.713760659695652 * log(9.5999999999999996 / (029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i)) + var_chaste_interface__membrane__V) - 1.7065282626826835e-6 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 00053729341037579627 * var_chaste_interface__sodium_dynamics__Na_i / ((40 + var_chaste_interface__sodium_dynamics__Na_i) * (1.0 + 035299999999999998 * exp(-037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0037433890822745472 * var_chaste_interface__membrane__V))) - 6.3176611368492499e-5 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) / ((1.0 + exp(-12.0 + 059999999999999998 * var_chaste_interface__membrane__V - 1.6028256395817388 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i))) * (0.10000000000000001 / (1.0 + exp(-12.0 + 059999999999999998 * var_chaste_interface__membrane__V - 1.6028256395817388 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i))) + (3.0 * exp(02 + 00020000000000000001 * var_chaste_interface__membrane__V - 0053427521319391299 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i)) + exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__V - 2.6713760659695653 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i))) / (1.0 + exp(13.356880329847826 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) - 0.5 * var_chaste_interface__membrane__V)))) - 00011688549744401942 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) * mParameters[3] * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 00011688549744401942 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) * mParameters[2] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2; // millimolar / millisecond
        ...
        const double var_transient_outward_current_s_gate__tau_s = 3.0 + 5.0 / (1.0 + exp(-4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(-6.328125 * pow((1 + 022222222222222223 * var_chaste_interface__membrane__V), 2)); // millisecond
        ...
        {
            d_dt_chaste_interface_var_membrane__V = 0079072731552699126 * log(2.0 / var_chaste_interface__calcium_dynamics__Ca_i) + 0077469905913117388 * log(140 / var_chaste_interface__sodium_dynamics__Na_i) - 00088199999999999997 * var_chaste_interface__membrane__V - GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() - 0.39200000000000002 * pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * (-26.713760659695652 * log(9.5999999999999996 / (029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i)) + var_chaste_interface__membrane__V) - 0.12379999999999999 * var_chaste_interface__calcium_dynamics__Ca_i / (00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i) - 0146 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) - 8.6662202299424464e-5 * (2.0 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) * exp(013101861787960915 * var_chaste_interface__membrane__V) - 6860000 * var_chaste_interface__calcium_dynamics__Ca_i * exp(-024332029034784559 * var_chaste_interface__membrane__V)) / (1.0 + 0.10000000000000001 * exp(-024332029034784559 * var_chaste_interface__membrane__V)) - 0.54050000000000009 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) / ((1.0 + exp(-12.0 + 059999999999999998 * var_chaste_interface__membrane__V - 1.6028256395817388 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i))) * (0.10000000000000001 / (1.0 + exp(-12.0 + 059999999999999998 * var_chaste_interface__membrane__V - 1.6028256395817388 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i))) + (3.0 * exp(02 + 00020000000000000001 * var_chaste_interface__membrane__V - 0053427521319391299 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i)) + exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__V - 2.6713760659695653 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i))) / (1.0 + exp(13.356880329847826 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) - 0.5 * var_chaste_interface__membrane__V)))) - 2.2983750000000001 * var_chaste_interface__sodium_dynamics__Na_i / ((40 + var_chaste_interface__sodium_dynamics__Na_i) * (1.0 + 035299999999999998 * exp(-037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0037433890822745472 * var_chaste_interface__membrane__V))) - (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) * mParameters[3] * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 1.0 * (-26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i) + var_chaste_interface__membrane__V) * mParameters[2] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 - pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-26.713760659695652 * log(140 / var_chaste_interface__sodium_dynamics__Na_i) + var_chaste_interface__membrane__V) * mParameters[1] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j - 14447.286958825251 * (-2.0 + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * exp(-1.1230167246823641 + 074867781645490947 * var_chaste_interface__membrane__V)) * (-15.0 + var_chaste_interface__membrane__V) * mParameters[0] * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f / (-1.0 + exp(-1.1230167246823641 + 074867781645490947 * var_chaste_interface__membrane__V)); // millivolt / millisecond
        }
