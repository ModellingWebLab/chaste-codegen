...
class Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables(const Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables&);
    Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables& operator= (const Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables&);
    Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables> Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    ...
    double Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellzhang_SAN_model_2000_allFromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_f_gate__f_L_infinity = _lt_0_row[14]; // dimensionless
        ...
        const double var_T_type_Ca_channel_d_gate__d_T_infinity = _lt_0_row[7]; // dimensionless
        ...
        const double var_T_type_Ca_channel_f_gate__f_T_infinity = _lt_0_row[16]; // dimensionless
        const double var_four_AP_sensitive_currents_q_gate__q_infinity = _lt_0_row[18]; // dimensionless
        const double var_four_AP_sensitive_currents_r_gate__r_infinity = _lt_0_row[9]; // dimensionless
        const double var_hyperpolarisation_activated_current_y_gate__beta_y = _lt_0_row[12]; // per_second
        ...
        const double var_T_type_Ca_channel_f_gate__beta_f_T = ((var_membrane__Version == 1.0) ? (_lt_0_row[17]) : (15.0 * exp(4.6618985695708712 + 0.065019505851755519 * var_chaste_interface__membrane__V))); // per_second
        ...
        const double var_hyperpolarisation_activated_current_y_gate__alpha_y = ((var_membrane__Version == 0) ? (exp(-2.9643125469571747 - 0.037565740045078885 * var_chaste_interface__membrane__V)) : (_lt_0_row[11])); // per_second
        ...
        const double var_rapid_delayed_rectifying_potassium_current_P_af_gate__P_af_infinity = ((var_membrane__Version != 2.0) ? (_lt_0_row[19]) : (1 / (1.0 + exp(-1.2452830188679245 - 0.094339622641509441 * var_chaste_interface__membrane__V)))); // dimensionless
        ...
        const double var_slow_delayed_rectifying_potassium_current_xs_gate__alpha_xs = 14.0 * _lt_0_row[23]; // per_second
        const double var_slow_delayed_rectifying_potassium_current_xs_gate__beta_xs = _lt_0_row[24]; // per_second
        ...
        const double var_sodium_current_m_gate__m_infinity = ((var_membrane__Version == 0) ? (pow(1 / (1.0 + exp(-0.18315018315018314 * var_chaste_interface__membrane__V)), 0.33333333333333331)) : (_lt_0_row[28])); // dimensionless
        ...
        else
        {
            ...
            const double var_L_type_Ca_channel__i_Ca_L = (-var_L_type_Ca_channel__E_Ca_L + var_chaste_interface__membrane__V) * (_lt_0_row[0] + var_chaste_interface__L_type_Ca_channel_d_gate__d_L * var_chaste_interface__L_type_Ca_channel_f_gate__f_L) * var_L_type_Ca_channel__g_Ca_L; // nanoA
            ...
            const double var_sodium_current_h_gate__F_Na = ((var_membrane__Version == 0) ? (0.086900000000000005 + 0.095200000000000007 * exp(-2.1671999999999998 - 0.063 * var_chaste_interface__membrane__V) / (1.0 + 1.6599999999999999 * exp(-14.332500000000001 - 0.22500000000000001 * var_chaste_interface__membrane__V))) : (_lt_0_row[2])); // dimensionless
            ...
            const double var_sodium_potassium_pump__i_p = 1.6000000000000001 * _lt_0_row[6] * pow(var_ionic_concentrations__K_o, 2) * pow(var_ionic_concentrations__Na_i, 3) * var_sodium_potassium_pump__i_p_max / (pow((var_ionic_concentrations__K_o + var_sodium_potassium_pump__K_m_K), 2) * pow((var_ionic_concentrations__Na_i + var_sodium_potassium_pump__K_m_Na), 3)); // nanoA
