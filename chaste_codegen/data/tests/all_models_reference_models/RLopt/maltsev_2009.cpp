...
class Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__Vm__Vm)
    {
        ...
        const double* const _lt_0_row = Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables(const Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables&);
    Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables&);
    Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables> Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables::mpInstance;


    double Cellmaltsev_2009FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellmaltsev_2009FromCellMLRushLarsenOpt::Cellmaltsev_2009FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmaltsev_2009FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellmaltsev_2009FromCellMLRushLarsenOpt::~Cellmaltsev_2009FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellmaltsev_2009FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellmaltsev_2009FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__Vm__Vm);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellmaltsev_2009FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__Vm__Vm);
    ...
    void Cellmaltsev_2009FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_AP_sensitive_currents_q_gate__q_infinity = _lt_0_row[3]; // dimensionless
        const double var_AP_sensitive_currents_q_gate__tau_q = _lt_0_row[4]; // millisecond
        const double var_AP_sensitive_currents_r_gate__r_infinity = _lt_0_row[5]; // dimensionless
        const double var_AP_sensitive_currents_r_gate__tau_r = _lt_0_row[6]; // millisecond
        ...
        const double var_i_CaL_dL_gate__dL_infinity = _lt_0_row[7]; // dimensionless
        ...
        const double var_i_CaL_fL_gate__fL_infinity = _lt_0_row[9]; // dimensionless
        const double var_i_CaL_fL_gate__tau_fL = _lt_0_row[10]; // millisecond
        const double var_i_CaT__E_CaT = 45.0; // millivolt
        const double var_i_CaT__g_CaT = 0.1832; // nanoS_per_picoF
        const double var_i_CaT_dT_gate__dT_infinity = _lt_0_row[11]; // dimensionless
        const double var_i_CaT_dT_gate__tau_dT = 1 / (_lt_0_row[12]); // millisecond
        const double var_i_CaT_fT_gate__fT_infinity = _lt_0_row[13]; // dimensionless
        const double var_i_CaT_fT_gate__tau_fT = 1 / (_lt_0_row[14]); // millisecond
        ...
        const double var_i_Kr_pi_gate__pi_infinity = _lt_0_row[18]; // dimensionless
        const double var_i_Kr_pi_gate__tau_pi = 1 / (_lt_0_row[19]); // millisecond
        ...
        const double var_i_st_qa_gate__qa_infinity = _lt_0_row[24]; // dimensionless
    ...
    void Cellmaltsev_2009FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellmaltsev_2009FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Vm__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellmaltsev_2009FromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellmaltsev_2009FromCellMLRushLarsenOpt)
