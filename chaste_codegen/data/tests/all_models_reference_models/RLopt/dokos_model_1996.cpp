...
class Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__E)
    {
        ...
        const double* const _lt_0_row = Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables(const Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables&);
    Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables& operator= (const Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables&);
    Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables> Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Celldokos_model_1996FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    ...
    double Celldokos_model_1996FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__E);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celldokos_model_1996FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__E);
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_calcium_current_f_gate__fL_infinity = _lt_0_row[5]; // dimensionless
        ...
        const double var_T_type_calcium_current_d_gate__dT_infinity = _lt_0_row[7]; // dimensionless
        ...
        const double var_T_type_calcium_current_f_gate__fT_infinity = _lt_0_row[9]; // dimensionless
        ...
        const double var_delayed_rectifying_potassium_current_x_gate__tau_x = 1 / (_lt_0_row[12]); // second
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = 200.0 * _lt_0_row[16] * (34.299999999999997 + var_chaste_interface__membrane__E); // per_second
        const double var_fast_sodium_current_m_gate__beta_m = 8000.0 * _lt_0_row[15]; // per_second
        const double var_hyperpolarising_activated_current_y_gate__alpha_y = 0.35999999999999999 * _lt_0_row[17] * (137.80000000000001 + var_chaste_interface__membrane__E); // per_second
        const double var_hyperpolarising_activated_current_y_gate__beta_y = 0.10000000000000001 * _lt_0_row[18] * (76.299999999999997 + var_chaste_interface__membrane__E); // per_second
