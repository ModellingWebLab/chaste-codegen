...
// LCOV_EXCL_STOP
        ...
        const double var_ICaL__dss1 = 1 / (_lt_0_row[10]); // dimensionless
        const double var_ICaL__dss = var_ICaL__dss0 * var_ICaL__dss1; // dimensionless
        const double var_ICaL__fss = _lt_0_row[12] + _lt_0_row[13]; // dimensionless
        ...
        const double var_ICaL__taud = 28.571428571428569 * (_lt_0_row[11]) * var_ICaL__dss0 / (10.0 + var_chaste_interface__cell__V); // ms
        ...
        const double var_ICaT__bss = _lt_0_row[15]; // dimensionless
        const double var_ICaT__gss = _lt_0_row[17]; // dimensionless
        const double var_ICaT__taub = _lt_0_row[16]; // ms
        ...
        const double var_IKr__tauxr = 1 / (_lt_0_row[20]); // ms
        const double var_IKr__xrss = _lt_0_row[19]; // dimensionless
        ...
        const double var_INa__am = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__cell__V) / (_lt_0_row[29]); // per_ms
