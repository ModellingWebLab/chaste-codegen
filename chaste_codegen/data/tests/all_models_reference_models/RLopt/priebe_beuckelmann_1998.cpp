...
class Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables(const Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables&);
    Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables&);
    Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables> Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt::Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt::~Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_ICa_d_gate__alpha_d = 0.63524014987941491 * _lt_0_row[2] / sqrt(M_PI); // per_ms
        const double var_ICa_d_gate__beta_d = _lt_0_row[1]; // per_ms
        ...
        const double var_IKr_Xr_gate__alpha_Xr = 0.0050000000000000001 * _lt_0_row[6] / (_lt_0_row[5]); // per_ms
        const double var_IKr_Xr_gate__beta_Xr = 0.016 * _lt_0_row[8] / (_lt_0_row[7]); // per_ms
        ...
        const double var_IKs_Xs_gate__alpha_Xs = 0.0030130000000000001 / (_lt_0_row[9]); // per_ms
        const double var_IKs_Xs_gate__beta_Xs = 0.0058700000000000002 / (_lt_0_row[10]); // per_ms
        ...
        const double var_INa_m_gate__alpha_m = _lt_0_row[11]; // per_ms
        const double var_INa_m_gate__beta_m = 0.080000000000000002 * _lt_0_row[12]; // per_ms
        const double var_Ito_r_gate__alpha_r = 0.52659999999999996 * _lt_0_row[16] / (_lt_0_row[15]); // per_ms
        const double var_Ito_r_gate__beta_r = (_lt_0_row[14]) / (_lt_0_row[13]); // per_ms
        const double var_Ito_t_gate__alpha_t = (_lt_0_row[18]) / (_lt_0_row[17]); // per_ms
        const double var_Ito_t_gate__beta_t = (_lt_0_row[20]) / (_lt_0_row[19]); // per_ms
        const double var_cell__failing = 0; // dimensionless
        ...
        rAlphaOrTau[3] = var_INa_h_gate__tau_h;
        rBetaOrInf[3] = var_INa_h_gate__h_inf;
        rAlphaOrTau[4] = var_INa_j_gate__tau_j;
        rBetaOrInf[4] = var_INa_j_gate__j_inf;
    ...
    void Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpriebe_beuckelmann_1998FromCellMLRushLarsenOpt)
