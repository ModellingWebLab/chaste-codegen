...
// LCOV_EXCL_STOP
        ...
        const double var_INa_m_gate__alpha_m = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__cell__V) / (_lt_0_row[12]); // per_ms
        const double var_INa_m_gate__beta_m = 0.080000000000000002 * _lt_0_row[11]; // per_ms
