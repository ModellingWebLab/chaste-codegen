...
class Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables(const Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables&);
    Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables& operator= (const Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables&);
    Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables> Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt::Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt::~Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    
    void Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt::VerifyStateVariables()
    {
    ...
    double Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -85.423
...
// LCOV_EXCL_STOP
    ...
    void Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2006_MFromCellMLRushLarsenOpt>::Initialise(void)
{
