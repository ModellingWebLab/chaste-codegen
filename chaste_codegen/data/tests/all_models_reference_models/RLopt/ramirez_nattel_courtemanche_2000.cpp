...
class Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables(const Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables&);
    Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables&);
    Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return ((fabs(163.0 + var_chaste_interface__membrane__V) < 2.0999999890136678e-6) ? (5.8799999692382698e-8 / (-1.0 + exp(9.9999999476841319e-8)) - 238095.23934085399 * (162.99999790000001 + var_chaste_interface__membrane__V) * (-5.8799999692382698e-8 / (-1.0 + exp(9.9999999476841319e-8)) - 5.8799999692382698e-8 / (-1.0 + exp(-9.9999999476841319e-8)))) : (0.028000000000000001 * (163.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(7.7619047619047619 + 0.047619047619047616 * var_chaste_interface__membrane__V)))) + ((fabs(-248.0 + var_chaste_interface__membrane__V) < 2.8000000042993634e-6) ? (-1.1200000017197454e-7 / (1.0 - exp(1.0000000015354869e-7)) + 178571.42829723447 * (-247.9999972 + var_chaste_interface__membrane__V) * (1.1200000017197454e-7 / (1.0 - exp(1.0000000015354869e-7)) + 1.1200000017197454e-7 / (1.0 - exp(-1.0000000015354869e-7)))) : (0.040000000000000001 * (-248.0 + var_chaste_interface__membrane__V) / (1.0 - exp(8.8571428571428577 - 0.035714285714285712 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
private:
    ...
    static std::shared_ptr<Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables> Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt::Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt::~Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_Ca_release_current_from_JSR_w_gate__tau_w = (_lt_0_row[9]) / ((_lt_0_row[10]) * (-7.9000000000000004 + var_chaste_interface__membrane__V)); // millisecond
        const double var_Ca_release_current_from_JSR_w_gate__w_infinity = 1.0 + _lt_0_row[8]; // dimensionless
        const double var_fast_sodium_current_h_gate__alpha_h = _lt_0_row[11]; // per_millisecond
        const double var_fast_sodium_current_h_gate__beta_h = _lt_0_row[12]; // per_millisecond
        const double var_fast_sodium_current_j_gate__alpha_j = _lt_0_row[13]; // per_millisecond
        const double var_fast_sodium_current_j_gate__beta_j = _lt_0_row[14]; // per_millisecond
        const double var_fast_sodium_current_m_gate__alpha_m = _lt_0_row[15]; // per_millisecond
        const double var_fast_sodium_current_m_gate__beta_m = 0.080000000000000002 * _lt_0_row[16]; // per_millisecond
        ...
        const double var_rapid_delayed_rectifier_K_current_xr_gate__xr_infinity = 1 / (_lt_0_row[17]); // dimensionless
        const double var_sarcolemmal_Ca_current__g_Ca = 0.23999999999999999; // nanoS_per_picoF
        const double var_sarcolemmal_Ca_current_d_gate__d_infinity = 1 / (_lt_0_row[19]); // dimensionless
        ...
        const double var_sarcolemmal_Ca_current_f_gate__f_infinity = 1 / (_lt_0_row[21]); // dimensionless
        ...
        const double var_slow_delayed_rectifier_K_current_xs_gate__xs_infinity = _lt_0_row[23]; // dimensionless
        ...
        const double var_transient_outward_K_current_oa_gate__oa_infinity = _lt_0_row[25]; // dimensionless
        ...
        const double var_transient_outward_K_current_oi_gate__oi_infinity = 1 / (_lt_0_row[27]); // dimensionless
        ...
        const double var_ultrarapid_delayed_rectifier_K_current__g_Kur_d = _lt_0_row[7]; // nanoS_per_picoF
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ua_gate__ua_infinity = _lt_0_row[29]; // dimensionless
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__ui_infinity = 1 / (_lt_0_row[31]); // dimensionless
    ...
    void Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellramirez_nattel_courtemanche_2000FromCellMLRushLarsenOpt>::Initialise(void)
{
