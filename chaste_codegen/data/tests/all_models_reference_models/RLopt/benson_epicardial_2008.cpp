...
class Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables(const Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables&);
    Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables&);
    Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables> Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellbenson_epicardial_2008FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellbenson_epicardial_2008FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellbenson_epicardial_2008FromCellMLRushLarsenOpt::Cellbenson_epicardial_2008FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbenson_epicardial_2008FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellbenson_epicardial_2008FromCellMLRushLarsenOpt::~Cellbenson_epicardial_2008FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellbenson_epicardial_2008FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellbenson_epicardial_2008FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbenson_epicardial_2008FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellbenson_epicardial_2008FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__Environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_ICaL__dss = _lt_0_row[15]; // dimensionless
        const double var_ICaL__f2ss = 0.23000000000000001 + _lt_0_row[19]; // dimensionless
        const double var_ICaL__fss = 0.29999999999999999 + _lt_0_row[17]; // dimensionless
        ...
        const double var_ICaL__taud = _lt_0_row[16]; // ms
        ...
        const double var_IKr__xrss = _lt_0_row[21]; // dimensionless
        ...
        const double var_INa__ah = _lt_0_row[25]; // per_ms
        const double var_INa__aj = _lt_0_row[27]; // per_ms
        const double var_INa__am = _lt_0_row[29]; // per_ms
        const double var_INa__bh = _lt_0_row[26]; // per_ms
        const double var_INa__bj = _lt_0_row[28]; // per_ms
        const double var_INa__bm = 0.080000000000000002 * _lt_0_row[30]; // per_ms
        ...
        const double var_INal__amL = _lt_0_row[29]; // per_ms
        const double var_INal__bmL = 0.080000000000000002 * _lt_0_row[30]; // per_ms
        ...
        const double var_Ito__ay = 25.0 * _lt_0_row[33] / (_lt_0_row[32]); // per_ms
        const double var_Ito__ay2 = 0.029999999999999999 / (_lt_0_row[36]); // per_ms
        const double var_Ito__ay3 = 0.0038999999999999998 / (_lt_0_row[39]); // per_ms
        const double var_Ito__by = 25.0 * _lt_0_row[35] / (_lt_0_row[34]); // per_ms
        const double var_Ito__by2 = 0.20000000000000001 * _lt_0_row[38] / (_lt_0_row[37]); // per_ms
        const double var_Ito__by3 = 0.10000000000000001 * _lt_0_row[38] / (_lt_0_row[37]); // per_ms
        const double var_Ito__rv = _lt_0_row[13]; // dimensionless
        const double var_Ito2__Ito2_max = ((fabs(var_chaste_interface__cell__V) < 2.6712338705500134e-6) ? (3.8594000000000001e-9 * (-100.0 * exp(1.0000000000000001e-7) + var_chaste_interface__Cl__Cl_i) / (1.0 - exp(1.0000000000000001e-7)) - 187179.41753899999 * (-2.6712338705500134e-6 + var_chaste_interface__cell__V) * (-3.8594000000000001e-9 * (-100.0 * exp(1.0000000000000001e-7) + var_chaste_interface__Cl__Cl_i) / (1.0 - exp(1.0000000000000001e-7)) - 3.8594000000000001e-9 * (-100.0 * exp(-1.0000000000000001e-7) + var_chaste_interface__Cl__Cl_i) / (1.0 - exp(-1.0000000000000001e-7)))) : (0.001444800488100033 * (_lt_0_row[9] + var_chaste_interface__Cl__Cl_i) * var_chaste_interface__cell__V / (_lt_0_row[10]))); // uA_per_uF
        ...
        const double var_IKp__IKp = 0.0027599999999999999 * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) / (_lt_0_row[11]); // uA_per_uF
    ...
    void Cellbenson_epicardial_2008FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellbenson_epicardial_2008FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellbenson_epicardial_2008FromCellMLRushLarsenOpt>::Initialise(void)
{
