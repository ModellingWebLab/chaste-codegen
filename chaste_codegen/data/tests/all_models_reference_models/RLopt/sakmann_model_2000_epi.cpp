...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_m_gate__beta_m = 8000.0 * _lt_0_row[14]; // per_second
        ...
        const double var_rapid_delayed_rectifier_potassium_current_xr_gate__xr_inf = _lt_0_row[15]; // dimensionless
        ...
        const double var_slow_delayed_rectifier_potassium_current_xs_gate__xs_inf = _lt_0_row[17]; // dimensionless
        ...
        else
        {
            ...
            const double var_persistent_sodium_current__i_p_Na = 1000.0 * _lt_0_row[5] * (-51.539700000000003 + var_chaste_interface__membrane__V) * mParameters[0] * var_persistent_sodium_current__g_pna; // nanoA
            ...
            const double var_rapid_delayed_rectifier_potassium_current__i_Kr = _lt_0_row[6] * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_rapid_delayed_rectifier_potassium_current__g_Kr * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr; // nanoA
