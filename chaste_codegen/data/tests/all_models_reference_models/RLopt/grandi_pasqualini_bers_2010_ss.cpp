...
class Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane_potential__V_m)
    {
        ...
        const double* const _lt_0_row = Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables(const Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables&);
    Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables& operator= (const Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables&);
    Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables> Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt::Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt::~Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane_potential__V_m);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane_potential__V_m);
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_I_Ca__fss = _lt_0_row[4] + _lt_0_row[5]; // dimensionless
        const double var_I_Ca__taud = 28.571428571428569 * (_lt_0_row[3]) * var_I_Ca__dss / (5.0 + var_chaste_interface__membrane_potential__V_m); // msec
        const double var_I_Ca__tauf = 1 / (_lt_0_row[6]); // msec
        const double var_I_Kr__tauxr = _lt_0_row[8]; // msec
        const double var_I_Kr__xrss = _lt_0_row[7]; // dimensionless
        ...
        const double var_I_Ks__xsss = _lt_0_row[9]; // dimensionless
        ...
        const double var_I_Na__mss = _lt_0_row[11]; // dimensionless
        const double var_I_Na__tauh = 1 / (var_I_Na__ah + var_I_Na__bh); // msec
        const double var_I_Na__tauj = 1 / (var_I_Na__aj + var_I_Na__bj); // msec
        const double var_I_Na__taum = _lt_0_row[12]; // msec
        const double var_I_to__tauxtof = _lt_0_row[14]; // msec
        const double var_I_to__tauxtos = _lt_0_row[15]; // msec
        const double var_I_to__tauytof = _lt_0_row[17]; // msec
        const double var_I_to__tauytos = _lt_0_row[18]; // msec
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellgrandi_pasqualini_bers_2010_ssFromCellMLRushLarsenOpt)
