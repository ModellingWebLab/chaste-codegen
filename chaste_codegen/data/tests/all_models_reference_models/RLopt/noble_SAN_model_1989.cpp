...
// LCOV_EXCL_STOP
        ...
        const double var_hyperpolarising_activated_current_y_gate__alpha_y = 0.014 * _lt_0_row[11]; // per_second
        const double var_hyperpolarising_activated_current_y_gate__beta_y = 9.75 * _lt_0_row[12]; // per_second
        ...
        const double var_time_dependent_potassium_current_x_gate__alpha_x = 2.1000000000000001 * _lt_0_row[19]; // per_second
        const double var_time_dependent_potassium_current_x_gate__beta_x = 0.95999999999999996 * _lt_0_row[20]; // per_second
