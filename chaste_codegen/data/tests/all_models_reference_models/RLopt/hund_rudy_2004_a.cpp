...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhund_rudy_2004_aFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__Environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_Cl__Cl_i = 1.3842167148532964e-8 * var_chaste_interface__cell__V + 7.0755999999999996e-6 * (26.712338705500134 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + 26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) / (87.825100000000006 + 26.712338705500134 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + 26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) + 5.0122473098513041 * pow((log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + log(10) * log10(140.0 / var_chaste_interface__Na__Na_i)), 4) / (59494197.640692554 + 509152.23122530844 * pow((log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + log(10) * log10(140.0 / var_chaste_interface__Na__Na_i)), 4)) + 3.0760371441184366e-5 * GetIntracellularAreaStimulus(var_chaste_interface__Environment__time) / HeartConfig::Instance()->GetCapacitance() + 3.6975665728975948e-7 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + 8.8885199344722979e-8 * (-100.0 * exp(0.0374358835078 * var_chaste_interface__cell__V) + var_chaste_interface__Cl__Cl_i) * var_chaste_interface__Ito2__AA * var_chaste_interface__cell__V / (1.0 - exp(0.0374358835078 * var_chaste_interface__cell__V)); // mM / ms
        const double d_dt_chaste_interface_var_Na__Na_i = 5.0122473098513041 * pow((log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + log(10) * log10(140.0 / var_chaste_interface__Na__Na_i)), 4) / (59494197.640692554 + 509152.23122530844 * pow((log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + log(10) * log10(140.0 / var_chaste_interface__Na__Na_i)), 4)) - 8.9372253111180233e-5 / ((1.0 + 100.0 / pow(var_chaste_interface__Na__Na_i, 2)) * (1.0 + 0.1245 * exp(-0.00374358835078 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.0374358835078 * var_chaste_interface__cell__V))) - 3.998848287353967e-7 * pow(var_chaste_interface__INal__mL, 3) * (-26.712338705500134 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__cell__V) * var_chaste_interface__INal__hL - 0.00083053002891197785 * (1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(0.01310255922773 * var_chaste_interface__cell__V) - 4116000.0 * var_chaste_interface__Ca__Ca_i * exp(-0.024333324280070002 * var_chaste_interface__cell__V)) / ((1.0 + 0.27000000000000002 * exp(-0.024333324280070002 * var_chaste_interface__cell__V)) * (1.0 + 6.9444444444444451e-9 / pow(var_chaste_interface__Ca__Ca_i, 2)) * (13227.9606 + 8.4084932990912282 * pow(var_chaste_interface__Na__Na_i, 3) + 6516533.0625 * var_chaste_interface__Ca__Ca_i)) - 0.00050754612877954204 * pow(var_chaste_interface__INa__m, 3) * (-26.712338705500134 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__cell__V) * mParameters[1] * var_chaste_interface__INa__H * var_chaste_interface__INa__J; // mM / ms
        const double d_dt_chaste_interface_var_K__K_i = 7.0755999999999996e-6 * (26.712338705500134 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + 26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) / (87.825100000000006 + 26.712338705500134 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + 26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) + 5.9581502074120151e-5 / ((1.0 + 100.0 / pow(var_chaste_interface__Na__Na_i, 2)) * (1.0 + 0.1245 * exp(-0.00374358835078 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.0374358835078 * var_chaste_interface__cell__V))) - 1.6979725035533768e-7 * (-26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V)) - 3.0760371441184366e-5 * GetIntracellularAreaStimulus(var_chaste_interface__Environment__time) / HeartConfig::Instance()->GetCapacitance() - 3.137557887000805e-5 * (-26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 6.370892781261781 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) * (1.02 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 6.370892781261781 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) + (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 2.1455350448257708 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) / (1.0 + exp(-2.4444678999999998 - 0.51429999999999998 * var_chaste_interface__cell__V + 13.738155796238718 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))))) - 8.5232067604091287e-7 * (-26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) * mParameters[2] * var_chaste_interface__IKr__xr / (1.0 + exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__cell__V)) - 6.1520742882368733e-5 * (0.024897499999999999 + 0.014938499999999999 / (1.0 + 6.4818210260626455e-7 * pow(1 / var_chaste_interface__Ca__Ca_i, 1.3999999999999999))) * (-26.712338705500134 * log(10) * log10(7.9662000000000006 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i)) + var_chaste_interface__cell__V) * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2 - 1.1688941147650058e-5 * pow(var_chaste_interface__Ito__ydv, 3) * (-26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv * exp(0.0033333333333333335 * var_chaste_interface__cell__V); // mM / ms
        ...
        {
            d_dt_chaste_interface_var_cell__V = -0.00022499999999999999 * var_chaste_interface__cell__V - 1.0 * GetIntracellularAreaStimulus(var_chaste_interface__Environment__time) / HeartConfig::Instance()->GetCapacitance() - 0.0027599999999999999 * (-26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V)) - 0.057500000000000002 * var_chaste_interface__Ca__Ca_i / (0.00050000000000000001 + var_chaste_interface__Ca__Ca_i) - 0.48423913043478262 / ((1.0 + 100.0 / pow(var_chaste_interface__Na__Na_i, 2)) * (1.0 + 0.1245 * exp(-0.00374358835078 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.0374358835078 * var_chaste_interface__cell__V))) - 0.00601027620873753 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) - 0.0064999999999999997 * pow(var_chaste_interface__INal__mL, 3) * (-26.712338705500134 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__cell__V) * var_chaste_interface__INal__hL - 0.0028824983370005666 * (-0.61380000000000001 + var_chaste_interface__Ca__Ca_i * exp(0.074871767015599999 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(0.074871767015599999 * var_chaste_interface__cell__V)) - 0.51000000000000001 * (-26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 6.370892781261781 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) * (1.02 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 6.370892781261781 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) + (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 2.1455350448257708 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) / (1.0 + exp(-2.4444678999999998 - 0.51429999999999998 * var_chaste_interface__cell__V + 13.738155796238718 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))))) - (0.024897499999999999 + 0.014938499999999999 / (1.0 + 6.4818210260626455e-7 * pow(1 / var_chaste_interface__Ca__Ca_i, 1.3999999999999999))) * (-26.712338705500134 * log(10) * log10(7.9662000000000006 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i)) + var_chaste_interface__cell__V) * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2 - 4.5 * (1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(0.01310255922773 * var_chaste_interface__cell__V) - 4116000.0 * var_chaste_interface__Ca__Ca_i * exp(-0.024333324280070002 * var_chaste_interface__cell__V)) / ((1.0 + 0.27000000000000002 * exp(-0.024333324280070002 * var_chaste_interface__cell__V)) * (1.0 + 6.9444444444444451e-9 / pow(var_chaste_interface__Ca__Ca_i, 2)) * (13227.9606 + 8.4084932990912282 * pow(var_chaste_interface__Na__Na_i, 3) + 6516533.0625 * var_chaste_interface__Ca__Ca_i)) - 0.013854200000000001 * (-26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) * mParameters[2] * var_chaste_interface__IKr__xr / (1.0 + exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__cell__V)) - 0.001444800488100033 * (-100.0 * exp(0.0374358835078 * var_chaste_interface__cell__V) + var_chaste_interface__Cl__Cl_i) * var_chaste_interface__Ito2__AA * var_chaste_interface__cell__V / (1.0 - exp(0.0374358835078 * var_chaste_interface__cell__V)) - 8.25 * pow(var_chaste_interface__INa__m, 3) * (-26.712338705500134 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__cell__V) * mParameters[1] * var_chaste_interface__INa__H * var_chaste_interface__INa__J - 0.19 * pow(var_chaste_interface__Ito__ydv, 3) * (-26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv * exp(0.0033333333333333335 * var_chaste_interface__cell__V) - 3.5108651860830804 * pow(var_chaste_interface__ICaL__d, var_chaste_interface__ICaL__dp) * (-15.0 + var_chaste_interface__cell__V) * (-0.61380000000000001 + 1.0 * var_chaste_interface__Ca__Ca_ss * exp(-1.1230765052339999 + 0.074871767015599999 * var_chaste_interface__cell__V)) * mParameters[0] * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca * var_chaste_interface__ICaL__fca2 / (-1.0 + exp(-1.1230765052339999 + 0.074871767015599999 * var_chaste_interface__cell__V)); // mV / ms
        }
