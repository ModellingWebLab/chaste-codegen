...
class Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables(const Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables&);
    Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables& operator= (const Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables&);
    Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables> Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt::Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt::~Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
    ...
    void Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
    ...
    void Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellohara_rudy_2011_epiFromCellMLRushLarsenOpt>::Initialise(void)
{
