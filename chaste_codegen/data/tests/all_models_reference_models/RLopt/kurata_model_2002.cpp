...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellkurata_model_2002FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_background_muscarinic_potassium_channel_current__i_K_ACh = 0021962113249247841 * var_chaste_interface__intracellular_ion_concentrations__Ki - 011859541154593834 * exp(-037415977988011655 * var_chaste_interface__membrane__V); // picoA
        ...
        const double var_AP_sensitive_currents__i_sus = 02 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__AP_sensitive_currents_r_gate__r; // picoA
        ...
        const double var_slowly_activating_delayed_rectifier_potassium_current__i_Ks = 025899999999999999 * pow(var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n, 2) * (-26.726549826397882 * log(22.199999999999999 / (1.0 * var_chaste_interface__intracellular_ion_concentrations__Ki + 0.12 * var_chaste_interface__intracellular_ion_concentrations__Nai)) + var_chaste_interface__membrane__V); // picoA
        const double var_sodium_calcium_exchange_current__di = 1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai; // dimensionless
        const double var_sodium_calcium_exchange_current__do = 4.8791826399715319 + 0.54600054600054604 * exp(0); // dimensionless
        const double var_sodium_calcium_exchange_current__k12 = 48.309178743961354 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / var_sodium_calcium_exchange_current__di; // dimensionless
        const double var_sodium_calcium_exchange_current__k14 = 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / var_sodium_calcium_exchange_current__di; // dimensionless
        ...
        const double var_sodium_calcium_exchange_current__k23 = 0.66530580717983756 * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / var_sodium_calcium_exchange_current__do; // dimensionless
        const double var_sodium_calcium_exchange_current__k32 = exp(0080724972509135153 * var_chaste_interface__membrane__V); // dimensionless
        const double var_sodium_calcium_exchange_current__k41 = exp(-0080724972509135153 * var_chaste_interface__membrane__V); // dimensionless
        ...
        const double var_sodium_dependent_background_current__i_b_Na = 0054000000000000003 * var_chaste_interface__membrane__V - 0054000000000000003 * var_reversal_potentials__E_Na; // picoA
        const double var_sodium_potassium_pump_current__i_NaK = 3.0052188053939588 / ((1.0 + 30.900566853219949 * pow(1 / var_chaste_interface__intracellular_ion_concentrations__Nai, 1.3)) * (1.0 + exp(-4.0 + 033333333333333333 * var_reversal_potentials__E_Na - 033333333333333333 * var_chaste_interface__membrane__V))); // picoA
        const double var_sustained_inward_current__i_st = 014999999999999999 * (-37.399999999999999 + var_chaste_interface__membrane__V) * var_chaste_interface__sustained_inward_current_qa_gate__qa * var_chaste_interface__sustained_inward_current_qi_gate__qi; // picoA
    ...
    void Cellkurata_model_2002FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        // Units: millimolar; Initial value: 000312494921
        ...
        // Units: millimolar; Initial value: 074631965653
        double var_chaste_interface__calcium_buffering__fTC = rY[24];
        // Units: millimolar; Initial value: 059206293446
        ...
        const double d_dt_chaste_interface_var_L_type_calcium_channel_current_fCa_gate__fCa = (021000000000000001 + 60 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub) * (-var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa + 00035 / (00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_sub)); // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Ca_up = 0050000000000000001 / (1.0 + 00059999999999999995 / var_chaste_interface__intracellular_ion_concentrations__Cai) + 0017241196262903437 * var_chaste_interface__intracellular_ion_concentrations__Ca_rel - 0017241196262903437 * var_chaste_interface__intracellular_ion_concentrations__Ca_up; // millimolar / millisecond
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Cai = 024390000000000002 * var_chaste_interface__calcium_buffering__fCMi + 0.55412061888222286 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 013826 * var_chaste_interface__calcium_buffering__fTC + 00046562000000000003 * var_chaste_interface__calcium_buffering__fTMC - 00012887906536154087 / (1.0 + 00059999999999999995 / var_chaste_interface__intracellular_ion_concentrations__Cai) - 0.55412061888222286 * var_chaste_interface__intracellular_ion_concentrations__Cai - 10.246499999999999 * (1.0 - var_chaste_interface__calcium_buffering__fCMi) * var_chaste_interface__intracellular_ion_concentrations__Cai - 2.7527999999999997 * (1.0 - var_chaste_interface__calcium_buffering__fTC) * var_chaste_interface__intracellular_ion_concentrations__Cai - 14.1174 * (1.0 - var_chaste_interface__calcium_buffering__fTMC - var_chaste_interface__calcium_buffering__fTMM) * var_chaste_interface__intracellular_ion_concentrations__Cai; // millimolar / millisecond
        const double var_AP_sensitive_currents_q_gate__q_infinity = 1.0 / (1.0 + exp(3.7692307692307692 + 076923076923076927 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_AP_sensitive_currents_q_gate__tau_q = 6.0599999999999996 + 39.101999999999997 / (065000000000000002 * exp(4.593 + 0.10000000000000001 * var_chaste_interface__membrane__V) + 0.56999999999999995 * exp(-3.52 - 080000000000000002 * var_chaste_interface__membrane__V)); // millisecond
        const double var_AP_sensitive_currents_r_gate__r_infinity = 1.0 / (1.0 + exp(1.2866666666666666 - 066666666666666666 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_AP_sensitive_currents_r_gate__tau_r = 2.75352 + 14.40516 / (1.0369999999999999 * exp(2.7548999999999997 + 089999999999999997 * var_chaste_interface__membrane__V) + 0.36899999999999999 * exp(-2.8607999999999998 - 0.12 * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_L_type_calcium_channel_current_d_gate__tau_d = 1.0 / (011429999999999999 * (-5.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V)) - 028389999999999999 * (35.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)) - 084900000000000003 * var_chaste_interface__membrane__V / (-1.0 + exp(-0.20798668885191349 * var_chaste_interface__membrane__V))); // millisecond
        ...
        const double var_L_type_calcium_channel_current_f_gate__tau_f = 44.299999999999997 + 257.10000000000002 * exp(-5.4668495419491743 * pow((1 + 030769230769230771 * var_chaste_interface__membrane__V), 2)); // millisecond
        ...
        const double var_T_type_calcium_channel_current_d_gate__tau_d = 1.0 / (1.0680000000000001 * exp(0.87666666666666671 + 033333333333333333 * var_chaste_interface__membrane__V) + 1.0680000000000001 * exp(-0.87666666666666671 - 033333333333333333 * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_T_type_calcium_channel_current_f_gate__tau_f = 1.0 / (014999999999999999 * exp(4.0117035110533159 + 065019505851755519 * var_chaste_interface__membrane__V) + 015299999999999999 * exp(-0.74069627851140463 - 012004801920768308 * var_chaste_interface__membrane__V)); // millisecond
        const double var_hyperpolarisation_activated_current_y_gate__tau_y = 0.71665290000000004 / (exp(-8.5404617897664554 - 022074080614542406 * var_chaste_interface__membrane__V) + exp(-3.8001143986272159 + 051999376007487906 * var_chaste_interface__membrane__V)); // millisecond
        const double var_hyperpolarisation_activated_current_y_gate__y_infinity = 1.0 / (1.0 + exp(4.7407407407407405 + 07407407407407407 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__pa_infinity = 1.0 / (1.0 + exp(-2.1886792452830188 - 094339622641509441 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__tau_paF = 0.84655354000000005 / (037199999999999997 * exp(062893081761006289 * var_chaste_interface__membrane__V) + 00096000000000000002 * exp(-044444444444444446 * var_chaste_interface__membrane__V)); // millisecond
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__tau_paS = 0.84655354000000005 / (0041999999999999997 * exp(058823529411764705 * var_chaste_interface__membrane__V) + 00014999999999999999 * exp(-046296296296296294 * var_chaste_interface__membrane__V)); // millisecond
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__pi_infinity = 1.0 / (1.0 + exp(1.672514619883041 + 058479532163742687 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__tau_pi = 1.0 / (0.10000000000000001 * exp(-018299935950224173 * var_chaste_interface__membrane__V) + 0.65600000000000003 * exp(009420009985210585 * var_chaste_interface__membrane__V)); // millisecond
        const double var_slowly_activating_delayed_rectifier_potassium_current_n_gate__n_infinity = 014 / ((1.0 + exp(4.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane__V)) * (001 * exp(-022222222222222223 * var_chaste_interface__membrane__V) + 014 / (1.0 + exp(4.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane__V)))); // dimensionless
        const double var_slowly_activating_delayed_rectifier_potassium_current_n_gate__tau_n = 1.0 / (001 * exp(-022222222222222223 * var_chaste_interface__membrane__V) + 014 / (1.0 + exp(4.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane__V))); // millisecond
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Ca_sub = 024390000000000002 * var_chaste_interface__calcium_buffering__fCMs + 25.0 * var_chaste_interface__intracellular_ion_concentrations__Cai - 25.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 00014764809009680174 * (250 * (0.54600054600054604 * ((48.309178743961354 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) + 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) * var_chaste_interface__intracellular_ion_concentrations__Nai * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + 48.309178743961354 * (0.96776646412697098 + exp(0080724972509135153 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) * exp(0) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) - 48.309178743961354 * (0.96776646412697098 * (0.54600054600054604 * exp(0) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + 0.66530580717983756 * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0))) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) + 0.54600054600054604 * (var_chaste_interface__intracellular_ion_concentrations__Nai / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + exp(-0080724972509135153 * var_chaste_interface__membrane__V)) * exp(0) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0))) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) / (0.96776646412697098 * (0.54600054600054604 * exp(0) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + 0.66530580717983756 * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0))) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) + 0.64386064857757164 * (48.309178743961354 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) + 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + (48.309178743961354 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) + 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) * var_chaste_interface__intracellular_ion_concentrations__Nai * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + 0.54600054600054604 * (var_chaste_interface__intracellular_ion_concentrations__Nai / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + exp(-0080724972509135153 * var_chaste_interface__membrane__V)) * exp(0) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + 48.309178743961354 * (0.96776646412697098 + exp(0080724972509135153 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) + 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 3) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * (0.54600054600054604 * exp(0) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + 0.66530580717983756 * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0))) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / ((26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) * (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) + 32.140377158446256 * (var_chaste_interface__intracellular_ion_concentrations__Nai / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + exp(-0080724972509135153 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / ((4.8791826399715319 + 0.54600054600054604 * exp(0)) * (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) + 00060342106912241779 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * (0.96776646412697098 + exp(0080724972509135153 * var_chaste_interface__membrane__V)) * exp(0) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / ((4.8791826399715319 + 0.54600054600054604 * exp(0)) * (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai))) - 0.45800000000000002 * (-45.0 + var_chaste_interface__membrane__V) * var_chaste_interface__T_type_calcium_channel_current_d_gate__d * var_chaste_interface__T_type_calcium_channel_current_f_gate__f - 0.57999999999999996 * (-45.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_calcium_channel_current_d_gate__d * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa * var_chaste_interface__L_type_calcium_channel_current_f_gate__f) * mParameters[0] + 060150151005755319 * (-var_chaste_interface__intracellular_ion_concentrations__Ca_sub + var_chaste_interface__intracellular_ion_concentrations__Ca_rel) / (1.0 + 1.4399999999999998e-6 / pow(var_chaste_interface__intracellular_ion_concentrations__Ca_sub, 2)) - 10.246499999999999 * (1.0 - var_chaste_interface__calcium_buffering__fCMs) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub; // millimolar / millisecond
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Ki = 6.4032609285536579e-6 * (011859541154593834 * exp(-037415977988011655 * var_chaste_interface__membrane__V) - 0021962113249247841 * var_chaste_interface__intracellular_ion_concentrations__Ki + 6.0104376107879176 / ((1.0 + 30.900566853219949 * pow(1 / var_chaste_interface__intracellular_ion_concentrations__Nai, 1.3)) * (1.0 + exp(-4.0 + 0.89088499421326284 * log(140 / var_chaste_interface__intracellular_ion_concentrations__Nai) - 033333333333333333 * var_chaste_interface__membrane__V))) - 025899999999999999 * pow(var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n, 2) * (-26.726549826397882 * log(22.199999999999999 / (1.0 * var_chaste_interface__intracellular_ion_concentrations__Ki + 0.12 * var_chaste_interface__intracellular_ion_concentrations__Nai)) + var_chaste_interface__membrane__V) - 02 * (-26.726549826397882 * log(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki) + var_chaste_interface__membrane__V) * var_chaste_interface__AP_sensitive_currents_r_gate__r - 0.23126250000000001 * pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2) * (-26.726549826397882 * log(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki) + var_chaste_interface__membrane__V) - 0.17999999999999999 * (-26.726549826397882 * log(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki) + var_chaste_interface__membrane__V) * var_chaste_interface__AP_sensitive_currents_q_gate__q * var_chaste_interface__AP_sensitive_currents_r_gate__r - 067616443970885107 * (0.40000000000000002 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS + 0.59999999999999998 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF) * (-26.726549826397882 * log(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki) + var_chaste_interface__membrane__V) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy) * mParameters[0]; // millimolar / millisecond
        ...
        const double var_sustained_inward_current_qa_gate__tau_qa = 1.0 / (1.0 / (16.0 * exp(0.125 * var_chaste_interface__membrane__V) + 15.0 * exp(02 * var_chaste_interface__membrane__V)) + 1.0 / (0.20000000000000001 * exp(-0014285714285714286 * var_chaste_interface__membrane__V) + 0.14999999999999999 * exp(-090909090909090912 * var_chaste_interface__membrane__V))); // millisecond
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Nai = 6.4032609285536579e-6 * (0.14432336906254858 * log(140 / var_chaste_interface__intracellular_ion_concentrations__Nai) - 0054000000000000003 * var_chaste_interface__membrane__V - 375.0 * (0.54600054600054604 * ((48.309178743961354 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) + 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) * var_chaste_interface__intracellular_ion_concentrations__Nai * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + 48.309178743961354 * (0.96776646412697098 + exp(0080724972509135153 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) * exp(0) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) - 48.309178743961354 * (0.96776646412697098 * (0.54600054600054604 * exp(0) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + 0.66530580717983756 * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0))) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) + 0.54600054600054604 * (var_chaste_interface__intracellular_ion_concentrations__Nai / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + exp(-0080724972509135153 * var_chaste_interface__membrane__V)) * exp(0) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0))) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) / (0.96776646412697098 * (0.54600054600054604 * exp(0) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + 0.66530580717983756 * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0))) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) + 0.64386064857757164 * (48.309178743961354 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) + 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + (48.309178743961354 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) + 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) * var_chaste_interface__intracellular_ion_concentrations__Nai * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + 0.54600054600054604 * (var_chaste_interface__intracellular_ion_concentrations__Nai / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + exp(-0080724972509135153 * var_chaste_interface__membrane__V)) * exp(0) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + 48.309178743961354 * (0.96776646412697098 + exp(0080724972509135153 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) + 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 3) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * (0.54600054600054604 * exp(0) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + 0.66530580717983756 * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0))) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / ((26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) * (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) + 32.140377158446256 * (var_chaste_interface__intracellular_ion_concentrations__Nai / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + exp(-0080724972509135153 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / ((4.8791826399715319 + 0.54600054600054604 * exp(0)) * (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) + 00060342106912241779 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * (0.96776646412697098 + exp(0080724972509135153 * var_chaste_interface__membrane__V)) * exp(0) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / ((4.8791826399715319 + 0.54600054600054604 * exp(0)) * (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai))) - 0.14373749999999999 * pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2) * (-26.726549826397882 * log(140 / var_chaste_interface__intracellular_ion_concentrations__Nai) + var_chaste_interface__membrane__V) - 9.0156564161818764 / ((1.0 + 30.900566853219949 * pow(1 / var_chaste_interface__intracellular_ion_concentrations__Nai, 1.3)) * (1.0 + exp(-4.0 + 0.89088499421326284 * log(140 / var_chaste_interface__intracellular_ion_concentrations__Nai) - 033333333333333333 * var_chaste_interface__membrane__V))) - 014999999999999999 * (-37.399999999999999 + var_chaste_interface__membrane__V) * var_chaste_interface__sustained_inward_current_qa_gate__qa * var_chaste_interface__sustained_inward_current_qi_gate__qi) * mParameters[0]; // millimolar / millisecond
        const double var_sustained_inward_current_qi_gate__qi_infinity = 1.0 / ((700 * exp(014285714285714285 * var_chaste_interface__membrane__V) + 3100 * exp(076923076923076927 * var_chaste_interface__membrane__V)) * (1.0 / (50 * exp(-0014285714285714286 * var_chaste_interface__membrane__V) + 95.0 * exp(-0.10000000000000001 * var_chaste_interface__membrane__V)) + 1.0 / (700 * exp(014285714285714285 * var_chaste_interface__membrane__V) + 3100 * exp(076923076923076927 * var_chaste_interface__membrane__V)) + 00022900000000000001 / (1.0 + exp(-0.20000000000000001 * var_chaste_interface__membrane__V)))); // dimensionless
        const double var_sustained_inward_current_qi_gate__tau_qi = 6.6500000000000004 / (1.0 / (50 * exp(-0014285714285714286 * var_chaste_interface__membrane__V) + 95.0 * exp(-0.10000000000000001 * var_chaste_interface__membrane__V)) + 1.0 / (700 * exp(014285714285714285 * var_chaste_interface__membrane__V) + 3100 * exp(076923076923076927 * var_chaste_interface__membrane__V)) + 00022900000000000001 / (1.0 + exp(-0.20000000000000001 * var_chaste_interface__membrane__V))); // millisecond
        ...
        {
            d_dt_chaste_interface_var_membrane__V = 0.14432336906254858 * log(140 / var_chaste_interface__intracellular_ion_concentrations__Nai) + 011859541154593834 * exp(-037415977988011655 * var_chaste_interface__membrane__V) - 0054000000000000003 * var_chaste_interface__membrane__V - 0021962113249247841 * var_chaste_interface__intracellular_ion_concentrations__Ki - 125.0 * (0.54600054600054604 * ((48.309178743961354 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) + 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) * var_chaste_interface__intracellular_ion_concentrations__Nai * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + 48.309178743961354 * (0.96776646412697098 + exp(0080724972509135153 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) * exp(0) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) - 48.309178743961354 * (0.96776646412697098 * (0.54600054600054604 * exp(0) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + 0.66530580717983756 * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0))) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) + 0.54600054600054604 * (var_chaste_interface__intracellular_ion_concentrations__Nai / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + exp(-0080724972509135153 * var_chaste_interface__membrane__V)) * exp(0) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0))) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) / (0.96776646412697098 * (0.54600054600054604 * exp(0) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + 0.66530580717983756 * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0))) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) + 0.64386064857757164 * (48.309178743961354 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) + 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + (48.309178743961354 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) + 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) * var_chaste_interface__intracellular_ion_concentrations__Nai * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + 0.54600054600054604 * (var_chaste_interface__intracellular_ion_concentrations__Nai / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + exp(-0080724972509135153 * var_chaste_interface__membrane__V)) * exp(0) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + 48.309178743961354 * (0.96776646412697098 + exp(0080724972509135153 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) + 0011051656880977081 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 3) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * (0.54600054600054604 * exp(0) / (4.8791826399715319 + 0.54600054600054604 * exp(0)) + 0.66530580717983756 * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / (4.8791826399715319 + 0.54600054600054604 * exp(0))) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / ((26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) * (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) + 32.140377158446256 * (var_chaste_interface__intracellular_ion_concentrations__Nai / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai) + exp(-0080724972509135153 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub * exp(-0051222473865587953 * var_chaste_interface__membrane__V) * exp(-0080724972509135153 * var_chaste_interface__membrane__V) / ((4.8791826399715319 + 0.54600054600054604 * exp(0)) * (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai)) + 00060342106912241779 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2) * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * (0.96776646412697098 + exp(0080724972509135153 * var_chaste_interface__membrane__V)) * exp(0) * exp(0080724972509135153 * var_chaste_interface__membrane__V) / ((4.8791826399715319 + 0.54600054600054604 * exp(0)) * (1.0 + 48.309178743961354 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai + exp(-0051222473865587953 * var_chaste_interface__membrane__V)) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub + 0025297242600556538 * (1.0 + 0.43687199650502401 * (1.0 + 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai))) - 025899999999999999 * pow(var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n, 2) * (-26.726549826397882 * log(22.199999999999999 / (1.0 * var_chaste_interface__intracellular_ion_concentrations__Ki + 0.12 * var_chaste_interface__intracellular_ion_concentrations__Nai)) + var_chaste_interface__membrane__V) - 0.14373749999999999 * pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2) * (-26.726549826397882 * log(140 / var_chaste_interface__intracellular_ion_concentrations__Nai) + var_chaste_interface__membrane__V) - 02 * (-26.726549826397882 * log(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki) + var_chaste_interface__membrane__V) * var_chaste_interface__AP_sensitive_currents_r_gate__r - 0.23126250000000001 * pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2) * (-26.726549826397882 * log(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki) + var_chaste_interface__membrane__V) - 3.0052188053939588 / ((1.0 + 30.900566853219949 * pow(1 / var_chaste_interface__intracellular_ion_concentrations__Nai, 1.3)) * (1.0 + exp(-4.0 + 0.89088499421326284 * log(140 / var_chaste_interface__intracellular_ion_concentrations__Nai) - 033333333333333333 * var_chaste_interface__membrane__V))) - 014999999999999999 * (-37.399999999999999 + var_chaste_interface__membrane__V) * var_chaste_interface__sustained_inward_current_qa_gate__qa * var_chaste_interface__sustained_inward_current_qi_gate__qi - 0.17999999999999999 * (-26.726549826397882 * log(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki) + var_chaste_interface__membrane__V) * var_chaste_interface__AP_sensitive_currents_q_gate__q * var_chaste_interface__AP_sensitive_currents_r_gate__r - 0.45800000000000002 * (-45.0 + var_chaste_interface__membrane__V) * var_chaste_interface__T_type_calcium_channel_current_d_gate__d * var_chaste_interface__T_type_calcium_channel_current_f_gate__f - 067616443970885107 * (0.40000000000000002 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS + 0.59999999999999998 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF) * (-26.726549826397882 * log(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki) + var_chaste_interface__membrane__V) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy - 0.57999999999999996 * (-45.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_calcium_channel_current_d_gate__d * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa * var_chaste_interface__L_type_calcium_channel_current_f_gate__f; // millivolt / millisecond
        }
