...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellkurata_model_2002FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_reversal_potentials__E_K = 26.726549826397882 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki); // millivolt
        ...
        const double var_reversal_potentials__E_Na = 26.726549826397882 * log(10) * log10(140.0 / var_chaste_interface__intracellular_ion_concentrations__Nai); // millivolt
    ...
    void Cellkurata_model_2002FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Ki = 6.4032609285536579e-6 * (0.011859541154593834 * exp(-0.037415977988011655 * var_chaste_interface__membrane__V) - 0.0021962113249247841 * var_chaste_interface__intracellular_ion_concentrations__Ki + 6.0104376107879176 / ((1.0 + 30.900566853219949 * pow(1 / var_chaste_interface__intracellular_ion_concentrations__Nai, 1.3)) * (1.0 + exp(-4.0 - 0.033333333333333333 * var_chaste_interface__membrane__V + 0.89088499421326284 * log(10) * log10(140.0 / var_chaste_interface__intracellular_ion_concentrations__Nai)))) - 0.025899999999999999 * pow(var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n, 2) * (-26.726549826397882 * log(10) * log10(22.199999999999999 / (0.12 * var_chaste_interface__intracellular_ion_concentrations__Nai + var_chaste_interface__intracellular_ion_concentrations__Ki)) + var_chaste_interface__membrane__V) - 0.02 * (-26.726549826397882 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki) + var_chaste_interface__membrane__V) * var_chaste_interface__AP_sensitive_currents_r_gate__r - 0.23126250000000001 * pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2) * (-26.726549826397882 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki) + var_chaste_interface__membrane__V) - 0.17999999999999999 * (-26.726549826397882 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki) + var_chaste_interface__membrane__V) * var_chaste_interface__AP_sensitive_currents_q_gate__q * var_chaste_interface__AP_sensitive_currents_r_gate__r - 0.067616443970885107 * (0.40000000000000002 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS + 0.59999999999999998 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF) * (-26.726549826397882 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__Ki) + var_chaste_interface__membrane__V) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy) * mParameters[0]; // millimolar / millisecond
