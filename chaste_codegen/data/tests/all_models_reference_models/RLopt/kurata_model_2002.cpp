...
class Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables(const Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables&);
    Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables&);
    Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables> Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables::mpInstance;


    double Cellkurata_model_2002FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
    ...
    AbstractLookupTableCollection* Cellkurata_model_2002FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    ...
    double Cellkurata_model_2002FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellkurata_model_2002FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        ...
        const double var_AP_sensitive_currents_q_gate__q_infinity = _lt_0_row[4]; // dimensionless
        const double var_AP_sensitive_currents_q_gate__tau_q = _lt_0_row[5]; // millisecond
        const double var_AP_sensitive_currents_r_gate__r_infinity = _lt_0_row[6]; // dimensionless
        const double var_AP_sensitive_currents_r_gate__tau_r = _lt_0_row[7]; // millisecond
        ...
        const double var_L_type_calcium_channel_current_d_gate__alpha_d = -0.028389999999999999 * (35.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)) + ((fabs(var_chaste_interface__membrane__V) < 4.8080000000000002e-7) ? (4.0819920000000005e-8 / (-1.0 + exp(1.0000000000000001e-7)) + 1039933.4442595673 * (4.8080000000000002e-7 + var_chaste_interface__membrane__V) * (-4.0819920000000005e-8 / (-1.0 + exp(1.0000000000000001e-7)) - 4.0819920000000005e-8 / (-1.0 + exp(-1.0000000000000001e-7)))) : (-0.084900000000000003 * var_chaste_interface__membrane__V / (-1.0 + exp(-0.20798668885191349 * var_chaste_interface__membrane__V)))); // per_millisecond
        const double var_L_type_calcium_channel_current_d_gate__beta_d = ((fabs(-5.0 + var_chaste_interface__membrane__V) < 2.500000002569891e-7) ? (2.8575000029373851e-9 / (-1.0 + exp(1.0000000010279564e-7)) - 1999999.9979440873 * (-5.0000002500000003 + var_chaste_interface__membrane__V) * (-2.8575000029373851e-9 / (-1.0 + exp(1.0000000010279564e-7)) - 2.8575000029373851e-9 / (-1.0 + exp(-1.0000000010279564e-7)))) : (0.011429999999999999 * (-5.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V)))); // per_millisecond
        const double var_L_type_calcium_channel_current_d_gate__d_infinity = _lt_0_row[8]; // dimensionless
        ...
        const double var_L_type_calcium_channel_current_f_gate__f_infinity = _lt_0_row[10]; // dimensionless
        const double var_L_type_calcium_channel_current_f_gate__tau_f = _lt_0_row[11]; // millisecond
        ...
        const double var_T_type_calcium_channel_current_d_gate__d_infinity = _lt_0_row[12]; // dimensionless
        const double var_T_type_calcium_channel_current_d_gate__tau_d = 1 / (_lt_0_row[13]); // millisecond
        const double var_T_type_calcium_channel_current_f_gate__f_infinity = _lt_0_row[14]; // dimensionless
        const double var_T_type_calcium_channel_current_f_gate__tau_f = 1 / (_lt_0_row[15]); // millisecond
        ...
        const double var_hyperpolarisation_activated_current_y_gate__y_infinity = _lt_0_row[16]; // dimensionless
        ...
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__pi_infinity = _lt_0_row[21]; // dimensionless
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__tau_pi = 1 / (_lt_0_row[22]); // millisecond
        ...
        const double var_sustained_inward_current_qa_gate__qa_infinity = _lt_0_row[25]; // dimensionless
        ...
        rAlphaOrTau[2] = var_L_type_calcium_channel_current_d_gate__tau_d;
        rBetaOrInf[2] = var_L_type_calcium_channel_current_d_gate__d_infinity;
        rAlphaOrTau[3] = var_L_type_calcium_channel_current_f_gate__tau_f;
        rBetaOrInf[3] = var_L_type_calcium_channel_current_f_gate__f_infinity;
        rDY[4] = d_dt_chaste_interface_var_L_type_calcium_channel_current_fCa_gate__fCa;
        rAlphaOrTau[5] = var_T_type_calcium_channel_current_d_gate__tau_d;
        rBetaOrInf[5] = var_T_type_calcium_channel_current_d_gate__d_infinity;
        rAlphaOrTau[6] = var_T_type_calcium_channel_current_f_gate__tau_f;
        rBetaOrInf[6] = var_T_type_calcium_channel_current_f_gate__f_infinity;
        rAlphaOrTau[7] = var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__tau_paS;
        rBetaOrInf[7] = var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__pa_infinity;
        rAlphaOrTau[8] = var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__tau_paF;
        rBetaOrInf[8] = var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__pa_infinity;
        rAlphaOrTau[9] = var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__tau_pi;
        rBetaOrInf[9] = var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__pi_infinity;
        rAlphaOrTau[10] = var_slowly_activating_delayed_rectifier_potassium_current_n_gate__tau_n;
        rBetaOrInf[10] = var_slowly_activating_delayed_rectifier_potassium_current_n_gate__n_infinity;
        ...
        rAlphaOrTau[13] = var_hyperpolarisation_activated_current_y_gate__tau_y;
        rBetaOrInf[13] = var_hyperpolarisation_activated_current_y_gate__y_infinity;
        rAlphaOrTau[14] = var_sustained_inward_current_qa_gate__tau_qa;
        rBetaOrInf[14] = var_sustained_inward_current_qa_gate__qa_infinity;
        rAlphaOrTau[15] = var_sustained_inward_current_qi_gate__tau_qi;
        rBetaOrInf[15] = var_sustained_inward_current_qi_gate__qi_infinity;
