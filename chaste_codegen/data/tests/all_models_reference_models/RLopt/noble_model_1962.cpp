...
// LCOV_EXCL_STOP
        ...
        const double var_potassium_channel_n_gate__alpha_n = 0.0001 * (-50.0 - var_chaste_interface__membrane__V) / (_lt_0_row[3]); // per_millisecond
        const double var_potassium_channel_n_gate__beta_n = 0.002 * _lt_0_row[2]; // per_millisecond
        ...
        const double var_sodium_channel_m_gate__alpha_m = 0.10000000000000001 * (-48.0 - var_chaste_interface__membrane__V) / (_lt_0_row[4]); // per_millisecond
        const double var_sodium_channel_m_gate__beta_m = 0.12 * (8.0 + var_chaste_interface__membrane__V) / (_lt_0_row[5]); // per_millisecond
