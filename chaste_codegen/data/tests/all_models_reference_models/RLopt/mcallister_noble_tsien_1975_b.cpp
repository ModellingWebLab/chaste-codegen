...
// LCOV_EXCL_STOP
        ...
        const double var_secondary_inward_current__i_si = (_lt_0_row[3] + 0.80000000000000004 * (-70.0 + var_chaste_interface__membrane__V) * var_chaste_interface__secondary_inward_current_d_gate__d * var_chaste_interface__secondary_inward_current_f_gate__f) * mParameters[0]; // microA_per_cm2
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = 0.0085000000000000006 * _lt_0_row[5]; // per_millisecond
        const double var_fast_sodium_current_h_gate__beta_h = 2.5 / (_lt_0_row[6]); // per_millisecond
        const double var_fast_sodium_current_m_gate__alpha_m = (47.0 + var_chaste_interface__membrane__V) / (_lt_0_row[8]); // per_millisecond
        const double var_fast_sodium_current_m_gate__beta_m = 40.0 * _lt_0_row[7]; // per_millisecond
        ...
        const double var_plateau_potassium_current1_x1_gate__alpha_x1 = 0.00050000000000000001 * _lt_0_row[12] / (_lt_0_row[11]); // per_millisecond
        const double var_plateau_potassium_current1_x1_gate__beta_x1 = 0.0012999999999999999 * _lt_0_row[14] / (_lt_0_row[13]); // per_millisecond
        const double var_plateau_potassium_current2_x2_gate__alpha_x2 = 0.000127 / (_lt_0_row[15]); // per_millisecond
        const double var_plateau_potassium_current2_x2_gate__beta_x2 = 0.00029999999999999997 * _lt_0_row[14] / (_lt_0_row[13]); // per_millisecond
        const double var_secondary_inward_current_d_gate__alpha_d = 0.002 * (40.0 + var_chaste_interface__membrane__V) / (_lt_0_row[17]); // per_millisecond
        const double var_secondary_inward_current_d_gate__beta_d = 0.02 * _lt_0_row[16]; // per_millisecond
        const double var_secondary_inward_current_f_gate__alpha_f = 0.00098700000000000003 * _lt_0_row[18]; // per_millisecond
        const double var_secondary_inward_current_f_gate__beta_f = 0.02 / (_lt_0_row[19]); // per_millisecond
        const double var_transient_chloride_current_q_gate__alpha_q = 0.0080000000000000002 * var_chaste_interface__membrane__V / (_lt_0_row[21]); // per_millisecond
        const double var_transient_chloride_current_q_gate__beta_q = 0.080000000000000002 * _lt_0_row[20]; // per_millisecond
        const double var_transient_chloride_current_r_gate__alpha_r = 3.3000000000000003e-5 * _lt_0_row[22]; // per_millisecond
        const double var_transient_chloride_current_r_gate__beta_r = 0.033000000000000002 / (_lt_0_row[23]); // per_millisecond
        ...
        else
        {
            ...
            const double var_pacemaker_potassium_current__i_K2 = var_pacemaker_potassium_current__I_K2 * var_chaste_interface__pacemaker_potassium_current_s_gate__s; // microA_per_cm2
            const double var_plateau_potassium_current1__I_x1 = 1.2 * (_lt_0_row[2]) / _lt_0_row[1]; // microA_per_cm2
