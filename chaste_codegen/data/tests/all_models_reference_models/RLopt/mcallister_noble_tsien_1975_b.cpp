...
class Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables(const Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables&);
    Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables& operator= (const Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables&);
    Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables> Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables::mpInstance;



    Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt::Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt::~Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = 0.0085000000000000006 * _lt_0_row[6]; // per_millisecond
        const double var_fast_sodium_current_h_gate__beta_h = 2.5 / (_lt_0_row[7]); // per_millisecond
        const double var_fast_sodium_current_m_gate__alpha_m = _lt_0_row[8]; // per_millisecond
        const double var_fast_sodium_current_m_gate__beta_m = 40.0 * _lt_0_row[9]; // per_millisecond
        const double var_pacemaker_potassium_current_s_gate__E_s = -52.0; // millivolt
        const double var_pacemaker_potassium_current_s_gate__alpha_s = _lt_0_row[10]; // per_millisecond
        ...
        const double var_plateau_potassium_current1_x1_gate__alpha_x1 = 0.00050000000000000001 * _lt_0_row[13] / (_lt_0_row[12]); // per_millisecond
        const double var_plateau_potassium_current1_x1_gate__beta_x1 = 0.0012999999999999999 * _lt_0_row[15] / (_lt_0_row[14]); // per_millisecond
        const double var_plateau_potassium_current2_x2_gate__alpha_x2 = 0.000127 / (_lt_0_row[16]); // per_millisecond
        const double var_plateau_potassium_current2_x2_gate__beta_x2 = 0.00029999999999999997 * _lt_0_row[15] / (_lt_0_row[14]); // per_millisecond
        const double var_secondary_inward_current_d_gate__alpha_d = 0.002 * (40.0 + var_chaste_interface__membrane__V) / (_lt_0_row[18]); // per_millisecond
        const double var_secondary_inward_current_d_gate__beta_d = 0.02 * _lt_0_row[17]; // per_millisecond
        const double var_secondary_inward_current_f_gate__alpha_f = 0.00098700000000000003 * _lt_0_row[19]; // per_millisecond
        const double var_secondary_inward_current_f_gate__beta_f = 0.02 / (_lt_0_row[20]); // per_millisecond
        const double var_transient_chloride_current_q_gate__alpha_q = _lt_0_row[21]; // per_millisecond
        const double var_transient_chloride_current_q_gate__beta_q = 0.080000000000000002 * _lt_0_row[22]; // per_millisecond
        const double var_transient_chloride_current_r_gate__alpha_r = 3.3000000000000003e-5 * _lt_0_row[23]; // per_millisecond
        const double var_transient_chloride_current_r_gate__beta_r = 0.033000000000000002 / (_lt_0_row[24]); // per_millisecond
        ...
        else
        {
            ...
            const double var_pacemaker_potassium_current__I_K2 = 2.7999999999999998 * (-1.0 + exp(0.040000000000000001 * var_chaste_interface__membrane__V - 0.040000000000000001 * var_pacemaker_potassium_current__E_K)) / (_lt_0_row[0]); // microA_per_cm2
            ...
            const double var_plateau_potassium_current1__I_x1 = 1.2 * (_lt_0_row[3]) / _lt_0_row[2]; // microA_per_cm2
        ...
        rAlphaOrTau[3] = var_secondary_inward_current_d_gate__alpha_d;
        rBetaOrInf[3] = var_secondary_inward_current_d_gate__beta_d;
        rAlphaOrTau[4] = var_secondary_inward_current_f_gate__alpha_f;
        rBetaOrInf[4] = var_secondary_inward_current_f_gate__beta_f;
        rAlphaOrTau[5] = var_pacemaker_potassium_current_s_gate__alpha_s;
        rBetaOrInf[5] = var_pacemaker_potassium_current_s_gate__beta_s;
        rAlphaOrTau[6] = var_plateau_potassium_current1_x1_gate__alpha_x1;
        rBetaOrInf[6] = var_plateau_potassium_current1_x1_gate__beta_x1;
        rAlphaOrTau[7] = var_plateau_potassium_current2_x2_gate__alpha_x2;
        rBetaOrInf[7] = var_plateau_potassium_current2_x2_gate__beta_x2;
        rAlphaOrTau[8] = var_transient_chloride_current_q_gate__alpha_q;
        rBetaOrInf[8] = var_transient_chloride_current_q_gate__beta_q;
        rAlphaOrTau[9] = var_transient_chloride_current_r_gate__alpha_r;
        rBetaOrInf[9] = var_transient_chloride_current_r_gate__beta_r;
    }
    void Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsenOpt)
