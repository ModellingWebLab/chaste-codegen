...
class Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    ~Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables()
    {

    }

protected:
    Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables(const Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables&);
    Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables& operator= (const Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables&);
    Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables> mpInstance;

};

std::shared_ptr<Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables> Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellbueno_2007_endoFromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    Cellbueno_2007_endoFromCellMLRushLarsenOpt::Cellbueno_2007_endoFromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbueno_2007_endoFromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellbueno_2007_endoFromCellMLRushLarsenOpt::~Cellbueno_2007_endoFromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellbueno_2007_endoFromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellbueno_2007_endoFromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellbueno_2007_endoFromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbueno_2007_endoFromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Cellbueno_2007_endoFromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Cellbueno_2007_endoFromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellbueno_2007_endoFromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbueno_2007_endoFromCellMLRushLarsenOpt)
