...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_d_gate__alpha_d = 30.0 * (19.0 + var_chaste_interface__membrane__V) / (_lt_0_row[8]); // per_second
        const double var_L_type_Ca_channel_d_gate__beta_d = 12.0 * (19.0 + var_chaste_interface__membrane__V) / (_lt_0_row[9]); // per_second
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = 200.0 * (41.0 + var_chaste_interface__membrane__V) / (_lt_0_row[13]); // per_second
        const double var_fast_sodium_current_m_gate__beta_m = 8000.0 * _lt_0_row[12]; // per_second
