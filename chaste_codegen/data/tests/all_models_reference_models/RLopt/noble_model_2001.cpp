...
class Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables(const Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables&);
    Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables&);
    Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables> Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellnoble_model_2001FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellnoble_model_2001FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellnoble_model_2001FromCellMLRushLarsenOpt::Cellnoble_model_2001FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnoble_model_2001FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellnoble_model_2001FromCellMLRushLarsenOpt::~Cellnoble_model_2001FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellnoble_model_2001FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellnoble_model_2001FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellnoble_model_2001FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellnoble_model_2001FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = _lt_0_row[12]; // per_second
        const double var_fast_sodium_current_m_gate__beta_m = 8000.0 * _lt_0_row[13]; // per_second
        ...
        const double var_rapid_delayed_rectifier_potassium_current_xr1_gate__alpha_xr1 = 50.0 / (_lt_0_row[14]); // per_second
        const double var_rapid_delayed_rectifier_potassium_current_xr1_gate__beta_xr1 = 0.050000000000000003 * _lt_0_row[15]; // per_second
        const double var_rapid_delayed_rectifier_potassium_current_xr2_gate__alpha_xr2 = 50.0 / (_lt_0_row[14]); // per_second
        const double var_rapid_delayed_rectifier_potassium_current_xr2_gate__beta_xr2 = 0.40000000000000002 * _lt_0_row[16]; // per_second
        ...
        const double var_persistent_sodium_current__i_p_Na = (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__V) * var_persistent_sodium_current__g_pna / (_lt_0_row[5]); // nanoA
        ...
        const double var_slow_delayed_rectifier_potassium_current_xs_gate__alpha_xs = 14.0 / (_lt_0_row[17]); // per_second
        const double var_slow_delayed_rectifier_potassium_current_xs_gate__beta_xs = _lt_0_row[18]; // per_second
        ...
        const double var_transient_outward_current_s_gate__alpha_s = 0.033000000000000002 * _lt_0_row[20]; // per_second
        const double var_transient_outward_current_s_gate__beta_s = 33.0 / (_lt_0_row[21]); // per_second
    ...
    void Cellnoble_model_2001FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellnoble_model_2001FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellnoble_model_2001FromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellnoble_model_2001FromCellMLRushLarsenOpt)
