...
// LCOV_EXCL_STOP
        ...
        else
        {
            ...
            const double var_ICaL_f_gate__f_infinity = _lt_0_row[13] + _lt_0_row[14]; // dimensionless
            ...
            const double var_IKr_Xr_gate__Xr_infinity = _lt_0_row[16]; // dimensionless
            const double var_IKr_Xr_gate__tau_Xr = 1 / (_lt_0_row[17]); // millisecond
            const double var_IKs_Xs_gate__Xs_infinity = _lt_0_row[18]; // dimensionless
            const double var_IKs_Xs_gate__tau_Xs = 1 / (_lt_0_row[19]); // millisecond
            const double var_INa_h_gate__alpha_h = _lt_0_row[20]; // per_millisecond
            const double var_INa_h_gate__beta_h = _lt_0_row[21]; // per_millisecond
            const double var_INa_j_gate__alpha_j = _lt_0_row[22]; // per_millisecond
            const double var_INa_j_gate__beta_j = _lt_0_row[23]; // per_millisecond
            const double var_INa_m_gate__alpha_m = 0.32000000000000001 * _lt_0_row[25] * (47.130000000000003 + var_chaste_interface__cell__V); // per_millisecond
            const double var_INa_m_gate__beta_m = 0.080000000000000002 * _lt_0_row[24]; // per_millisecond
            const double var_Itof_X_gate__X_tof_infinity = _lt_0_row[26]; // dimensionless
            ...
            const double var_Itof_Y_gate__Y_tof_infinity = _lt_0_row[28]; // dimensionless
            ...
            const double var_Itos_R_gate__R_tos_infinity = _lt_0_row[28]; // dimensionless
            ...
            const double var_Itos_X_gate__X_tos_infinity = _lt_0_row[26]; // dimensionless
            ...
            const double var_Itos_Y_gate__Y_tos_infinity = _lt_0_row[28]; // dimensionless
            ...
            const double d_dt_chaste_interface_var_Ca_buffer__Cai = -var_cytosolic_Ca_buffer__dCa_cytosol_tot_bound + var_ion_diffusion__J_Ca_SL_myo / var_model_parameters__Vol_myo - var_Jpump_SR__j_pump_SR * var_model_parameters__Vol_SR / var_model_parameters__Vol_myo; // millimolar / millisecond
            ...
            const double d_dt_chaste_interface_var_Ca_buffer__Ca_SL = -var_Ca_buffer__dCa_SL_tot_bound + (-var_ion_diffusion__J_Ca_SL_myo + var_ion_diffusion__J_Ca_jct_SL) / var_model_parameters__Vol_SL - 0.5 * var_Ca_buffer__i_Ca_SL_tot * var_model_parameters__Cm / (var_model_parameters__F * var_model_parameters__Vol_SL); // millimolar / millisecond
            ...
            const double var_IKp__i_Kp = _lt_0_row[9] * (-var_reversal_potentials__E_K + var_chaste_interface__cell__V) * var_IKp__g_Kp; // microA_per_microF
