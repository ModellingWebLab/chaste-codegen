...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_current_fCa_gate__fCa = (((var_chaste_interface__membrane__V > -60) && (var_chaste_interface__L_type_Ca_current_fCa_gate__fCa < 0.15753424657534248 + 068493150684931517 / (1.0 + exp(-5.0 + 10000 * var_chaste_interface__calcium_dynamics__Ca_i)) + 0.13698630136986303 / (1.0 + exp(-0.9375 + 1250 * var_chaste_interface__calcium_dynamics__Ca_i)) + 0.68493150684931503 / (1.0 + 8.034023767017109e+27 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 8)))) ? (0) : (078767123287671242 + 034246575342465758 / (1.0 + exp(-5.0 + 10000 * var_chaste_interface__calcium_dynamics__Ca_i)) + 068493150684931517 / (1.0 + exp(-0.9375 + 1250 * var_chaste_interface__calcium_dynamics__Ca_i)) + 0.34246575342465752 / (1.0 + 8.034023767017109e+27 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 8)) - 0.5 * var_chaste_interface__L_type_Ca_current_fCa_gate__fCa)); // 1 / millisecond
        const double d_dt_chaste_interface_var_calcium_dynamics__g = (((((var_chaste_interface__calcium_dynamics__Ca_i >= 00035) || (var_chaste_interface__membrane__V > -60))) && (((var_chaste_interface__membrane__V > -60) || (var_chaste_interface__calcium_dynamics__Ca_i < 00035))) && (((var_chaste_interface__calcium_dynamics__Ca_i >= 00035) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 5.439910241481016e+20 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 6))))) && (((var_chaste_interface__calcium_dynamics__Ca_i < 00035) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 1.9720198874049176e+55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 16)))))) ? (0) : ((var_chaste_interface__calcium_dynamics__Ca_i < 00035) ? (0.5 / (1.0 + 5.439910241481016e+20 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 6)) - 0.5 * var_chaste_interface__calcium_dynamics__g) : (0.5 / (1.0 + 1.9720198874049176e+55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 16)) - 0.5 * var_chaste_interface__calcium_dynamics__g))); // 1 / millisecond
        ...
        const double var_slow_time_dependent_potassium_current_Xs_gate__tau_xs = 1100 / ((1.0 + exp(-3.0 + 050000000000000003 * var_chaste_interface__membrane__V)) * sqrt(1.0 + exp(-1.6666666666666667 - 0.16666666666666666 * var_chaste_interface__membrane__V))); // millisecond
        ...
        const double var_transient_outward_current_s_gate__tau_s = 8.0 + 1000 * exp(-4.4889999999999999 * pow((1 + 014925373134328358 * var_chaste_interface__membrane__V), 2)); // millisecond
