...
class Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane_potential__V_m)
    {
        ...
        const double* const _lt_0_row = Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables(const Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables&);
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables& operator= (const Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables&);
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables> Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt::Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt::~Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane_potential__V_m);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane_potential__V_m);
    ...
    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_I_Ca__fss = _lt_0_row[13] + _lt_0_row[14]; // dimensionless
        ...
        const double var_I_Kr__tauxr = _lt_0_row[17]; // msec
        const double var_I_Kr__xrss = _lt_0_row[16]; // dimensionless
        ...
        const double var_I_Ks__xsss = _lt_0_row[18]; // dimensionless
        ...
        const double var_I_Na__mss = _lt_0_row[20]; // dimensionless
        const double var_I_Na__tauh = 1 / (var_I_Na__ah + var_I_Na__bh); // msec
        const double var_I_Na__tauj = 1 / (var_I_Na__aj + var_I_Na__bj); // msec
        const double var_I_Na__taum = _lt_0_row[21]; // msec
        const double var_I_to__tauxtof = _lt_0_row[23]; // msec
        const double var_I_to__tauxtos = _lt_0_row[24]; // msec
        const double var_I_to__tauytof = _lt_0_row[26]; // msec
        const double var_I_to__tauytos = _lt_0_row[27]; // msec
        ...
        const double var_I_Ca__ibarna_j = ((fabs(var_chaste_interface__membrane_potential__V_m) < 2.6712338705498262e-6) ? (7.236374999999999e-11 * (-0.75 * mParameters[6] + 0.75 * var_chaste_interface__Na_Concentrations__Na_j * exp(9.9999999999999995e-8)) / (-1.0 + exp(9.9999999999999995e-8)) - 187179.41753901311 * (-2.6712338705498262e-6 + var_chaste_interface__membrane_potential__V_m) * (-7.236374999999999e-11 * (-0.75 * mParameters[6] + 0.75 * var_chaste_interface__Na_Concentrations__Na_j * exp(9.9999999999999995e-8)) / (-1.0 + exp(9.9999999999999995e-8)) - 7.236374999999999e-11 * (-0.75 * mParameters[6] + 0.75 * var_chaste_interface__Na_Concentrations__Na_j * exp(-9.9999999999999995e-8)) / (-1.0 + exp(-9.9999999999999995e-8)))) : (2.7090009151877515e-5 * (-0.75 * mParameters[6] + 0.75 * var_chaste_interface__Na_Concentrations__Na_j * _lt_0_row[6]) * var_chaste_interface__membrane_potential__V_m / (_lt_0_row[7]))); // uA_per_uF
        const double var_I_Ca__ibarna_sl = ((fabs(var_chaste_interface__membrane_potential__V_m) < 2.6712338705498262e-6) ? (7.236374999999999e-11 * (-0.75 * mParameters[6] + 0.75 * var_chaste_interface__Na_Concentrations__Na_sl * exp(9.9999999999999995e-8)) / (-1.0 + exp(9.9999999999999995e-8)) - 187179.41753901311 * (-2.6712338705498262e-6 + var_chaste_interface__membrane_potential__V_m) * (-7.236374999999999e-11 * (-0.75 * mParameters[6] + 0.75 * var_chaste_interface__Na_Concentrations__Na_sl * exp(9.9999999999999995e-8)) / (-1.0 + exp(9.9999999999999995e-8)) - 7.236374999999999e-11 * (-0.75 * mParameters[6] + 0.75 * var_chaste_interface__Na_Concentrations__Na_sl * exp(-9.9999999999999995e-8)) / (-1.0 + exp(-9.9999999999999995e-8)))) : (2.7090009151877515e-5 * (-0.75 * mParameters[6] + 0.75 * var_chaste_interface__Na_Concentrations__Na_sl * _lt_0_row[6]) * var_chaste_interface__membrane_potential__V_m / (_lt_0_row[7]))); // uA_per_uF
        ...
        else
        {
            ...
            const double var_I_Ca__ibark = ((fabs(var_chaste_interface__membrane_potential__V_m) < 2.6712338705498262e-6) ? (1.3025475e-9 * (-0.75 * mParameters[5] + 0.75 * var_chaste_interface__K_Concentration__K_i * exp(9.9999999999999995e-8)) / (-1.0 + exp(9.9999999999999995e-8)) - 187179.41753901311 * (-2.6712338705498262e-6 + var_chaste_interface__membrane_potential__V_m) * (-1.3025475e-9 * (-0.75 * mParameters[5] + 0.75 * var_chaste_interface__K_Concentration__K_i * exp(9.9999999999999995e-8)) / (-1.0 + exp(9.9999999999999995e-8)) - 1.3025475e-9 * (-0.75 * mParameters[5] + 0.75 * var_chaste_interface__K_Concentration__K_i * exp(-9.9999999999999995e-8)) / (-1.0 + exp(-9.9999999999999995e-8)))) : (0.00048762016473379531 * (-0.75 * mParameters[5] + 0.75 * var_chaste_interface__K_Concentration__K_i * _lt_0_row[6]) * var_chaste_interface__membrane_potential__V_m / (_lt_0_row[7]))); // uA_per_uF
        ...
        rAlphaOrTau[2] = var_I_Na__taum;
        rBetaOrInf[2] = var_I_Na__mss;
        rAlphaOrTau[3] = var_I_Na__tauh;
        rBetaOrInf[3] = var_I_Na__hss;
        rAlphaOrTau[4] = var_I_Na__tauj;
        rBetaOrInf[4] = var_I_Na__jss;
        rAlphaOrTau[5] = var_I_Kr__tauxr;
        rBetaOrInf[5] = var_I_Kr__xrss;
        rAlphaOrTau[6] = var_I_Ks__tauxs;
        rBetaOrInf[6] = var_I_Ks__xsss;
        rAlphaOrTau[7] = var_I_to__tauxtos;
        rBetaOrInf[7] = var_I_to__xtoss;
        rAlphaOrTau[8] = var_I_to__tauytos;
        rBetaOrInf[8] = var_I_to__ytoss;
        rAlphaOrTau[9] = var_I_to__tauxtof;
        rBetaOrInf[9] = var_I_to__xtoss;
        rAlphaOrTau[10] = var_I_to__tauytof;
        rBetaOrInf[10] = var_I_to__ytoss;
        rAlphaOrTau[11] = var_I_Ca__taud;
        rBetaOrInf[11] = var_I_Ca__dss;
        rAlphaOrTau[12] = var_I_Ca__tauf;
        rBetaOrInf[12] = var_I_Ca__fss;
    ...
    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsenOpt)
