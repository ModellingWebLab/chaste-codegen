...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellbondarenko_model_2004_apexFromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_background_current__i_Cab = 0.00036699999999999998 * var_chaste_interface__membrane__V - 0.0047112379481865285 * log(10) * log10(1800.0 / var_chaste_interface__calcium_concentration__Cai); // picoA_per_picoF
        const double var_fast_transient_outward_potassium_current__E_K = 25.674321243523316 * log(10) * log10(5400.0 / var_chaste_interface__potassium_concentration__Ki); // millivolt
        ...
        const double var_fast_sodium_current__E_Na = 25.674321243523316 * log(10) * log10(140600.0 / (0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki + var_chaste_interface__sodium_concentration__Nai)); // millivolt
        ...
        const double var_rapid_delayed_rectifier_potassium_current__i_Kr = 0.078 * (-25.674321243523316 * log(10) * log10(8257.1428571428569 / (0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai + var_chaste_interface__potassium_concentration__Ki)) + var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K; // picoA_per_picoF
