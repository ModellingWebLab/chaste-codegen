...
class Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane_potential__V)
    {
        ...
        const double* const _lt_0_row = Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables(const Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables&);
    Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables& operator= (const Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables&);
    Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables> Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Celliribe_model_2006FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Celliribe_model_2006FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celliribe_model_2006FromCellMLRushLarsenOpt::Celliribe_model_2006FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celliribe_model_2006FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Celliribe_model_2006FromCellMLRushLarsenOpt::~Celliribe_model_2006FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Celliribe_model_2006FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Celliribe_model_2006FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane_potential__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliribe_model_2006FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane_potential__V);
    ...
    void Celliribe_model_2006FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_d_gate__alpha_d = 30.0 * (19.0 + var_chaste_interface__membrane_potential__V) * var_L_type_Ca_channel_d_gate__speed_d / (_lt_0_row[9]); // per_second
        const double var_L_type_Ca_channel_d_gate__beta_d = -12.0 * (19.0 + var_chaste_interface__membrane_potential__V) * var_L_type_Ca_channel_d_gate__speed_d / (_lt_0_row[8]); // per_second
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = 200.0 * (41.0 + var_chaste_interface__membrane_potential__V) / (_lt_0_row[13]); // per_second
        ...
        const double var_time_dependent_rectifier_potassium_current_x_gate__alpha_x = 0.5 * _lt_0_row[15] / (_lt_0_row[14]); // per_second
        const double var_time_dependent_rectifier_potassium_current_x_gate__beta_x = 1.3 * _lt_0_row[17] / (_lt_0_row[16]); // per_second
    ...
    void Celliribe_model_2006FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Celliribe_model_2006FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celliribe_model_2006FromCellMLRushLarsenOpt>::Initialise(void)
{
