...
class Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables(const Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables&);
    Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables&);
    Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables> Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables::mpInstance;
    ...
    double Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
    ...
    AbstractLookupTableCollection* Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    ...
    double Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
...
// LCOV_EXCL_STOP
        ...
        const double var_iCaL_f2_gate__f2_inf = 0.25 + _lt_0_row[9]; // dimensionless
        ...
        const double var_iCaL_f_gate__f_inf = _lt_0_row[11]; // dimensionless
        ...
        const double var_iKs_Xs_gate__xs_inf = _lt_0_row[19]; // dimensionless
        ...
        const double var_iNa_m_gate__alpha_m = 1 / (_lt_0_row[23]); // dimensionless
        const double var_iNa_m_gate__beta_m = _lt_0_row[22]; // dimensionless
        const double var_iNa_m_gate__m_inf = _lt_0_row[21]; // dimensionless
        const double var_iNa_m_gate__tau_m = var_iNa_m_gate__alpha_m * var_iNa_m_gate__beta_m; // millisecond
        const double var_ito_r_gate__r_inf = _lt_0_row[24]; // dimensionless
        const double var_ito_r_gate__tau_r = _lt_0_row[25]; // millisecond
        const double var_ito_s_gate__s_inf = _lt_0_row[26]; // dimensionless
        const double var_ito_s_gate__tau_s = _lt_0_row[27]; // millisecond
        ...
        const double var_IpK__i_p_K = (-var_reversal_potentials__E_K + var_chaste_interface__cell__V) * var_IpK__g_pK / (_lt_0_row[0]); // nanoA_per_nanoF
