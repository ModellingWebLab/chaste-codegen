...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellfink_noble_giles_model_2008FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__Environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_iKr_Markov__Cr1 = var_chaste_interface__iKr_Markov__Cr2 * exp(-2.0190000000000001 - 0.060299999999999999 * var_chaste_interface__cell__V) - var_chaste_interface__iKr_Markov__Cr1 * exp(-1.5790000000000006 + 0.0112 * var_chaste_interface__cell__V); // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_iKr_Markov__Ir5 = var_chaste_interface__iKr_Markov__Or4 * exp(-0.87200000000000344 + 0.0223 * var_chaste_interface__cell__V) - var_chaste_interface__iKr_Markov__Ir5 * exp(-3.1820000000000022 - 0.031199999999999999 * var_chaste_interface__cell__V); // 1 / millisecond
        const double d_dt_chaste_interface_var_iKr_Markov_Sotalol_block__BCr1 = var_chaste_interface__iKr_Markov_Sotalol_block__BCr2 * exp(-2.0190000000000001 - 0.060299999999999999 * var_chaste_interface__cell__V) - var_chaste_interface__iKr_Markov_Sotalol_block__BCr1 * exp(-1.5790000000000006 + 0.0112 * var_chaste_interface__cell__V); // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_iKr_Markov_Sotalol_block__BIr5 = var_chaste_interface__iKr_Markov_Sotalol_block__BOr4 * exp(-0.87200000000000344 + 0.0223 * var_chaste_interface__cell__V) - var_chaste_interface__iKr_Markov_Sotalol_block__BIr5 * exp(-3.1820000000000022 - 0.031199999999999999 * var_chaste_interface__cell__V); // 1 / millisecond
