...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellfink_noble_giles_model_2008FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__Environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_Ca__Ca_i = (0.0038 * var_chaste_interface__Ca__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__Ca__Ca_SR - 0.0038240087783467445 * var_chaste_interface__Ca__Ca_i - 1.7205545223759661e-8 * var_chaste_interface__cell__V - 0.00042515544989027063 / (1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__Ca__Ca_i, 2)) + 1.2593500345045236e-9 * (2.0 * pow(var_chaste_interface__Na__Na_i, 3) * exp(0.013101861787960915 * var_chaste_interface__cell__V) - 6860000.0 * var_chaste_interface__Ca__Ca_i * exp(-0.024332029034784559 * var_chaste_interface__cell__V)) / (1.0 + 0.10000000000000001 * exp(-0.024332029034784559 * var_chaste_interface__cell__V)) + 2.298124085635426e-7 * log(10) * log10(2.0 / var_chaste_interface__Ca__Ca_i) - 2.2487821987979791e-6 * var_chaste_interface__Ca__Ca_i / (0.00050000000000000001 + var_chaste_interface__Ca__Ca_i)) / (1.0 + 0.00020000000000000001 / pow((0.001 + var_chaste_interface__Ca__Ca_i), 2)); // millimolar / millisecond
        const double d_dt_chaste_interface_var_Na__Na_i = -2.1070980214908366e-8 * var_chaste_interface__cell__V + 5.6288512232624455e-7 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i) - 3.7780501035135707e-9 * (2.0 * pow(var_chaste_interface__Na__Na_i, 3) * exp(0.013101861787960915 * var_chaste_interface__cell__V) - 6860000.0 * var_chaste_interface__Ca__Ca_i * exp(-0.024332029034784559 * var_chaste_interface__cell__V)) / (1.0 + 0.10000000000000001 * exp(-0.024332029034784559 * var_chaste_interface__cell__V)) - 0.00023854029832302029 * var_chaste_interface__Na__Na_i / ((40.0 + var_chaste_interface__Na__Na_i) * (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__cell__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__cell__V))) - 0.00079924407711721393 * pow(var_chaste_interface__iNa_m_gate__m, 3) * (-26.713760659695652 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__cell__V) * var_chaste_interface__iNa_h_gate__h * var_chaste_interface__iNa_j_gate__j; // millimolar / millisecond
        const double d_dt_chaste_interface_var_K__K_i = -4.9560398636513786e-5 * (0.11619999999999997 / (1.0 + 0.036532500000000002 / exp(-0.10989010989010989 * var_chaste_interface__cell__V + 3.1258035549938383 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) + 0.88380000000000003 * pow((1.0 + 0.079111111111111104 / exp(-0.050000000000000003 * var_chaste_interface__cell__V + 1.4222406175221964 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))), 2) / (pow((1.0 + 0.079111111111111104 / exp(-0.050000000000000003 * var_chaste_interface__cell__V + 1.4222406175221964 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))), 3) + 2.0875714285714286 / exp(-0.059333333333333335 - 0.20833333333333334 * var_chaste_interface__cell__V + 5.9260025730091517 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) + 0.012714285714285714 / exp(-0.0055555555555555558 * var_chaste_interface__cell__V + 0.15802673528024405 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)))) * (-26.713760659695652 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) - 1.7438052591648303e-6 * (-26.713760659695652 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) * var_chaste_interface__iKr_Markov__Or4 - 7.265855246520128e-5 * GetIntracellularAreaStimulus(var_chaste_interface__Environment__time) / HeartConfig::Instance()->GetCapacitance() - 7.0696771548640841e-7 * (-26.713760659695652 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__cell__V)) - 2.8482152566358896e-6 * pow(var_chaste_interface__iKs_Xs_gate__Xs, 2) * (-26.713760659695652 * log(10) * log10(9.5999999999999996 / (0.029999999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i)) + var_chaste_interface__cell__V) + 0.00015902686554868019 * var_chaste_interface__Na__Na_i / ((40.0 + var_chaste_interface__Na__Na_i) * (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__cell__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__cell__V))) - 1.4531710493040254e-5 * (-26.713760659695652 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) * var_chaste_interface__ito_r_gate__r * var_chaste_interface__ito_s_gate__s; // millimolar / millisecond
        ...
        {
            d_dt_chaste_interface_var_cell__V = -0.00076360000000000002 * var_chaste_interface__cell__V + 0.0063258185242159298 * log(10) * log10(2.0 / var_chaste_interface__Ca__Ca_i) + 0.0077469905913117388 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i) - 0.039199999999999999 * pow(var_chaste_interface__iKs_Xs_gate__Xs, 2) * (-26.713760659695652 * log(10) * log10(9.5999999999999996 / (0.029999999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i)) + var_chaste_interface__cell__V) - 0.061899999999999997 * var_chaste_interface__Ca__Ca_i / (0.00050000000000000001 + var_chaste_interface__Ca__Ca_i) - 1.0000000000000002 * GetIntracellularAreaStimulus(var_chaste_interface__Environment__time) / HeartConfig::Instance()->GetCapacitance() - 0.0097300000000000008 * (-26.713760659695652 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__cell__V)) - 0.68210000000000004 * (0.11619999999999997 / (1.0 + 0.036532500000000002 / exp(-0.10989010989010989 * var_chaste_interface__cell__V + 3.1258035549938383 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) + 0.88380000000000003 * pow((1.0 + 0.079111111111111104 / exp(-0.050000000000000003 * var_chaste_interface__cell__V + 1.4222406175221964 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))), 2) / (pow((1.0 + 0.079111111111111104 / exp(-0.050000000000000003 * var_chaste_interface__cell__V + 1.4222406175221964 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))), 3) + 2.0875714285714286 / exp(-0.059333333333333335 - 0.20833333333333334 * var_chaste_interface__cell__V + 5.9260025730091517 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) + 0.012714285714285714 / exp(-0.0055555555555555558 * var_chaste_interface__cell__V + 0.15802673528024405 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)))) * (-26.713760659695652 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) - 1.7332440459884893e-5 * (2.0 * pow(var_chaste_interface__Na__Na_i, 3) * exp(0.013101861787960915 * var_chaste_interface__cell__V) - 6860000.0 * var_chaste_interface__Ca__Ca_i * exp(-0.024332029034784559 * var_chaste_interface__cell__V)) / (1.0 + 0.10000000000000001 * exp(-0.024332029034784559 * var_chaste_interface__cell__V)) - 0.024 * (-26.713760659695652 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) * var_chaste_interface__iKr_Markov__Or4 - 0.20000000000000001 * (-26.713760659695652 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__cell__V) * var_chaste_interface__ito_r_gate__r * var_chaste_interface__ito_s_gate__s - 1.0943437499999999 * var_chaste_interface__Na__Na_i / ((40.0 + var_chaste_interface__Na__Na_i) * (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__cell__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__cell__V))) - 11.0 * pow(var_chaste_interface__iNa_m_gate__m, 3) * (-26.713760659695652 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__cell__V) * var_chaste_interface__iNa_h_gate__h * var_chaste_interface__iNa_j_gate__j - 0.28894573917650501 * (-2.0 + 0.25 * var_chaste_interface__Ca__Ca_ss * exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__cell__V)) * (-15.0 + var_chaste_interface__cell__V) * var_chaste_interface__iCaL_d_gate__d * var_chaste_interface__iCaL_f2_gate__f2 * var_chaste_interface__iCaL_fCass_gate__fCass * var_chaste_interface__iCaL_f_gate__f / (-1.0 + exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__cell__V)); // millivolt / millisecond
        }
