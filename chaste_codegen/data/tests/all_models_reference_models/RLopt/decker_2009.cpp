...
// LCOV_EXCL_STOP
        ...
        const double var_IKr_xr_gate__tau_xr = 1 / (_lt_0_row[21]); // ms
        ...
        const double var_INaL_mL_gate__amL = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__Vm) / (_lt_0_row[24]); // per_ms
        const double var_INaL_mL_gate__bmL = 0.080000000000000002 * _lt_0_row[23]; // per_ms
        ...
        const double var_INa_m_gate__am = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__Vm) / (_lt_0_row[24]); // per_ms
        const double var_INa_m_gate__bm = 0.080000000000000002 * _lt_0_row[23]; // per_ms
