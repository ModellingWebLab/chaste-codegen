...
class Celldecker_2009FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celldecker_2009FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celldecker_2009FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__Vm)
    {
        ...
        const double* const _lt_0_row = Celldecker_2009FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celldecker_2009FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Celldecker_2009FromCellMLRushLarsenOpt_LookupTables(const Celldecker_2009FromCellMLRushLarsenOpt_LookupTables&);
    Celldecker_2009FromCellMLRushLarsenOpt_LookupTables& operator= (const Celldecker_2009FromCellMLRushLarsenOpt_LookupTables&);
    Celldecker_2009FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Celldecker_2009FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celldecker_2009FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celldecker_2009FromCellMLRushLarsenOpt_LookupTables> Celldecker_2009FromCellMLRushLarsenOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Celldecker_2009FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Celldecker_2009FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    ...
    double Celldecker_2009FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celldecker_2009FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__Vm);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celldecker_2009FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
...
// LCOV_EXCL_STOP
        ...
        const double var_ICaL__IV_beta_star = 1 / ((_lt_0_row[18]) * var_ICaL__IV_beta_infinity_star); // dimensionless
        ...
        const double var_ICaL__IV_tau_star = 1 / (_lt_0_row[19] + var_ICaL__IV_beta_star); // ms
        ...
        const double var_IKr_xr_gate__tau_xr = 1 / (((fabs(38.360799999999998 + var_chaste_interface__membrane__Vm) < 6.5703022045227044e-7) ? (1.9710906613568111e-10 / (-1.0 + exp(9.9999999552835566e-8)) - 761000.00340292137 * (38.360799342969777 + var_chaste_interface__membrane__Vm) * (-1.9710906613568111e-10 / (-1.0 + exp(9.9999999552835566e-8)) - 1.9710906613568111e-10 / (-1.0 + exp(-9.9999999552835566e-8)))) : (0.00029999999999999997 * (38.360799999999998 + var_chaste_interface__membrane__Vm) / (-1.0 + exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm)))) + ((fabs(-1.7384000000000002 + var_chaste_interface__membrane__Vm) < 7.3529411770412167e-7) ? (-4.4117647055585959e-10 / (1.0 - exp(9.9999999992661527e-8)) + 679999.99994722824 * (-1.7383992647058824 + var_chaste_interface__membrane__Vm) * (4.4117647055585959e-10 / (1.0 - exp(9.9999999992661527e-8)) + 4.4117647068908634e-10 / (1.0 - exp(-1.0000000002285959e-7)))) : (0.00059999999999999995 * (-1.7383999999999999 + var_chaste_interface__membrane__Vm) / (1.0 - exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm))))); // ms
        const double var_IKr_xr_gate__xr_infinity = _lt_0_row[20]; // dimensionless
        ...
        const double var_INaL_mL_gate__amL = _lt_0_row[23]; // per_ms
        const double var_INaL_mL_gate__bmL = 0.080000000000000002 * _lt_0_row[24]; // per_ms
        const double var_INa_h_gate__ah = _lt_0_row[25]; // per_ms
        const double var_INa_h_gate__bh = _lt_0_row[26]; // per_ms
        const double var_INa_j_gate__aj = _lt_0_row[27]; // per_ms
        const double var_INa_j_gate__bj = _lt_0_row[28]; // per_ms
        const double var_INa_m_gate__am = _lt_0_row[23]; // per_ms
        const double var_INa_m_gate__bm = 0.080000000000000002 * _lt_0_row[24]; // per_ms
        const double var_Ito1__rto1 = _lt_0_row[12]; // dimensionless
        const double var_Ito1_a_gate__a_infinity = _lt_0_row[29]; // dimensionless
        ...
        const double var_Ito1_i1f_gate__alpha_i1f = 0.025000000000000001 / (_lt_0_row[31]); // per_ms
        const double var_Ito1_i1f_gate__beta_i1f = 0.10208977775055385 / (_lt_0_row[32]); // per_ms
        const double var_Ito1_i1s_gate__alpha_i1s = 0.0040000000000000001 / (_lt_0_row[33]); // per_ms
        const double var_Ito1_i1s_gate__beta_i1s = 0.10208977775055385 / (_lt_0_row[32]); // per_ms
        ...
        const double var_Ito2_i2f_gate__alpha_i2f = 0.025000000000000001 / (_lt_0_row[31]); // per_ms
        const double var_Ito2_i2f_gate__beta_i2f = 0.20000000000000001 / (_lt_0_row[32]); // per_ms
        ...
        rAlphaOrTau[25] = var_INa_m_gate__am;
        rBetaOrInf[25] = var_INa_m_gate__bm;
        rAlphaOrTau[26] = var_INa_h_gate__ah;
        rBetaOrInf[26] = var_INa_h_gate__bh;
        rAlphaOrTau[27] = var_INa_j_gate__aj;
        rBetaOrInf[27] = var_INa_j_gate__bj;
        rAlphaOrTau[28] = var_INaL_mL_gate__amL;
        rBetaOrInf[28] = var_INaL_mL_gate__bmL;
        rAlphaOrTau[29] = var_INaL_hL_gate__tau_hL;
        rBetaOrInf[29] = var_INaL_hL_gate__hL_infinity;
        rAlphaOrTau[30] = var_IKr_xr_gate__tau_xr;
        rBetaOrInf[30] = var_IKr_xr_gate__xr_infinity;
        rAlphaOrTau[31] = var_Ito1_a_gate__tau_a;
        rBetaOrInf[31] = var_Ito1_a_gate__a_infinity;
        rAlphaOrTau[32] = var_Ito1_i1f_gate__alpha_i1f;
        rBetaOrInf[32] = var_Ito1_i1f_gate__beta_i1f;
        rAlphaOrTau[33] = var_Ito1_i1s_gate__alpha_i1s;
        rBetaOrInf[33] = var_Ito1_i1s_gate__beta_i1s;
        rAlphaOrTau[34] = var_Ito2_i2f_gate__tau_i2f;
        rBetaOrInf[34] = var_Ito2_i2f_gate__i2f_infinity;
    ...
    void Celldecker_2009FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        ...
        {
            const double tau_inv = rAlphaOrTau[26] + rBetaOrInf[26];
            const double y_inf = rAlphaOrTau[26] / tau_inv;
            rY[26] = y_inf + (rY[26] - y_inf)*exp(-mDt*tau_inv);
        }
        {
        ...
        {
            const double tau_inv = rAlphaOrTau[33] + rBetaOrInf[33];
            const double y_inf = rAlphaOrTau[33] / tau_inv;
            rY[33] = y_inf + (rY[33] - y_inf)*exp(-mDt*tau_inv);
        }
