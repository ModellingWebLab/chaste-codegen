...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldecker_2009FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_Cl__Cl_i = 0.14749262536873156 * var_chaste_interface__Cl__Cl_ss + 1.3882711730677125e-8 * var_chaste_interface__membrane__Vm - 0.14749262536873156 * var_chaste_interface__Cl__Cl_i + 1.77e-5 * (26.711785007306684 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + 26.711785007306684 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) / (87.825100000000006 + 26.711785007306684 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + 26.711785007306684 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) + 3.7083201106826184e-7 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + 12.529604814733942 * pow((log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + log(10) * log10(140.0 / var_chaste_interface__Na__Na_i)), 4) / (59494197.640692554 + 509110.01733929582 * pow((log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + log(10) * log10(140.0 / var_chaste_interface__Na__Na_i)), 4)); // mM / ms
        const double d_dt_chaste_interface_var_Na__Na_i = 0.14749262536873156 * var_chaste_interface__Na__Na_ss_sr - 0.14749262536873156 * var_chaste_interface__Na__Na_i + 12.529604814733942 * pow((log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + log(10) * log10(140.0 / var_chaste_interface__Na__Na_i)), 4) / (59494197.640692554 + 509110.01733929582 * pow((log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + log(10) * log10(140.0 / var_chaste_interface__Na__Na_i)), 4)) - 7.1319396379664657e-10 * (-140.0 + var_chaste_interface__Na__Na_i * exp(0.037436659501656748 * var_chaste_interface__membrane__Vm)) * var_chaste_interface__membrane__Vm / (-1.0 + exp(0.037436659501656748 * var_chaste_interface__membrane__Vm)) - 4.0105611666400582e-7 * pow(var_chaste_interface__INaL_mL_gate__mL, 3) * (-26.711785007306684 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__membrane__Vm) * var_chaste_interface__INaL_hL_gate__hL - 1.1538934370751403e-5 * pow(var_chaste_interface__Na__Na_i, 3) / (pow((1 + 0.38461538461538458 * var_chaste_interface__Na__Na_i), 3) * (1.0 + exp(-3.4441726741524206 - 0.037436659501656748 * var_chaste_interface__membrane__Vm))) - 0.00018510282307569501 * (6.4800000000000004 * pow(var_chaste_interface__Na__Na_i, 3) * exp(0.010107898065447322 * var_chaste_interface__membrane__Vm) - 9878400.0 * var_chaste_interface__Ca__Ca_i * exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm)) / ((1.0 + 0.32000000000000001 * exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm)) * (1.0 + 1.5624999999999999e-8 / pow(var_chaste_interface__Ca__Ca_i, 2)) * (13227.9606 + 8.4084932990912282 * pow(var_chaste_interface__Na__Na_i, 3) + 4344355.375 * var_chaste_interface__Ca__Ca_i)) - 6.1700941025231664e-5 * pow(var_chaste_interface__INa_m_gate__m, 3) * (-26.711785007306684 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__membrane__Vm) * mParameters[1] * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j; // mM / ms
        const double d_dt_chaste_interface_var_K__K_i = 1.77e-5 * (26.711785007306684 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + 26.711785007306684 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) / (87.825100000000006 + 26.711785007306684 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + 26.711785007306684 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) - 6.1700941025231664e-5 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() - 1.7029459722963939e-7 * (-26.711785007306684 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__membrane__Vm) / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__Vm)) + 7.6926229138342684e-6 * pow(var_chaste_interface__Na__Na_i, 3) / (pow((1 + 0.38461538461538458 * var_chaste_interface__Na__Na_i), 3) * (1.0 + exp(-3.4441726741524206 - 0.037436659501656748 * var_chaste_interface__membrane__Vm))) - 6.1700941025231664e-5 * (0.082600000000000007 + 0.04956 / (1.0 + 6.4818210260626455e-7 * pow(1 / var_chaste_interface__Ca__Ca_i, 1.3999999999999999))) * (-26.711785007306684 * log(10) * log10(7.9662000000000006 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i)) + var_chaste_interface__membrane__Vm) * (var_chaste_interface__IKs__O1 + var_chaste_interface__IKs__O2) - 3.1467479922868152e-5 * (-26.711785007306684 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__membrane__Vm) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__Vm - 6.3707607242426434 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) * (1.02 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__Vm - 6.3707607242426434 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) + (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__Vm - 2.1454905717868731 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__Vm - 1.6494527242011876 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) / (1.0 + exp(-2.4444678999999998 - 0.51429999999999998 * var_chaste_interface__membrane__Vm + 13.737871029257827 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))))) - 6.1700941025231664e-5 * (-26.711785007306684 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__membrane__Vm) * mParameters[2] * var_chaste_interface__IKr_xr_gate__xr / (1.0 + exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__membrane__Vm)) - 3.0696218160052752e-5 * pow(var_chaste_interface__Ito1_a_gate__a, 3) * (-26.711785007306684 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__membrane__Vm) * var_chaste_interface__Ito1_i1f_gate__i1f * var_chaste_interface__Ito1_i1s_gate__i1s * exp(0.0018181818181818182 * var_chaste_interface__membrane__Vm); // mM / ms
        ...
        {
            d_dt_chaste_interface_var_membrane__Vm = -0.00022499999999999999 * var_chaste_interface__membrane__Vm - GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() - 0.0027599999999999999 * (-26.711785007306684 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__membrane__Vm) / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__Vm)) - 0.057500000000000002 * var_chaste_interface__Ca__Ca_i / (0.00050000000000000001 + var_chaste_interface__Ca__Ca_i) - 0.0060101516266440041 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) - (0.082600000000000007 + 0.04956 / (1.0 + 6.4818210260626455e-7 * pow(1 / var_chaste_interface__Ca__Ca_i, 1.3999999999999999))) * (-26.711785007306684 * log(10) * log10(7.9662000000000006 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i)) + var_chaste_interface__membrane__Vm) * (var_chaste_interface__IKs__O1 + var_chaste_interface__IKs__O2) - 0.0064999999999999997 * pow(var_chaste_interface__INaL_mL_gate__mL, 3) * (-26.711785007306684 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__membrane__Vm) * var_chaste_interface__INaL_hL_gate__hL - 1.1558883089076335e-5 * (-140.0 + var_chaste_interface__Na__Na_i * exp(0.037436659501656748 * var_chaste_interface__membrane__Vm)) * var_chaste_interface__membrane__Vm / (-1.0 + exp(0.037436659501656748 * var_chaste_interface__membrane__Vm)) - 0.062337970750628316 * pow(var_chaste_interface__Na__Na_i, 3) / (pow((1 + 0.38461538461538458 * var_chaste_interface__Na__Na_i), 3) * (1.0 + exp(-3.4441726741524206 - 0.037436659501656748 * var_chaste_interface__membrane__Vm))) - 0.51000000000000001 * (-26.711785007306684 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__membrane__Vm) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__Vm - 6.3707607242426434 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) * (1.02 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__Vm - 6.3707607242426434 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) + (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__Vm - 2.1454905717868731 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i)) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__Vm - 1.6494527242011876 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))) / (1.0 + exp(-2.4444678999999998 - 0.51429999999999998 * var_chaste_interface__membrane__Vm + 13.737871029257827 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i))))) - 0.0028826178386108462 * (-0.61380000000000001 + 1.0 * var_chaste_interface__Ca__Ca_i * exp(0.074873319003313496 * var_chaste_interface__membrane__Vm)) * var_chaste_interface__membrane__Vm / (-1.0 + exp(0.074873319003313496 * var_chaste_interface__membrane__Vm)) - 1.0 * (6.4800000000000004 * pow(var_chaste_interface__Na__Na_i, 3) * exp(0.010107898065447322 * var_chaste_interface__membrane__Vm) - 9878400.0 * var_chaste_interface__Ca__Ca_i * exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm)) / ((1.0 + 0.32000000000000001 * exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm)) * (1.0 + 1.5624999999999999e-8 / pow(var_chaste_interface__Ca__Ca_i, 2)) * (13227.9606 + 8.4084932990912282 * pow(var_chaste_interface__Na__Na_i, 3) + 4344355.375 * var_chaste_interface__Ca__Ca_i)) - 1.0 * (1.6200000000000001 * pow(var_chaste_interface__Na__Na_ss_sr, 3) * exp(0.010107898065447322 * var_chaste_interface__membrane__Vm) - 2469600.0 * var_chaste_interface__Ca__Ca_ss_sr * exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm)) / ((1.0 + 0.32000000000000001 * exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm)) * (1.0 + 1.5624999999999999e-8 / pow(var_chaste_interface__Ca__Ca_ss_sr, 2)) * (13227.9606 + 8.4084932990912282 * pow(var_chaste_interface__Na__Na_ss_sr, 3) + 4344355.375 * var_chaste_interface__Ca__Ca_ss_sr)) - 1.0 * (-26.711785007306684 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__membrane__Vm) * mParameters[2] * var_chaste_interface__IKr_xr_gate__xr / (1.0 + exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__membrane__Vm)) - pow(var_chaste_interface__INa_m_gate__m, 3) * (-26.711785007306684 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__membrane__Vm) * mParameters[1] * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j - 0.4975 * pow(var_chaste_interface__Ito1_a_gate__a, 3) * (-26.711785007306684 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i) + var_chaste_interface__membrane__Vm) * var_chaste_interface__Ito1_i1f_gate__i1f * var_chaste_interface__Ito1_i1s_gate__i1s * exp(0.0018181818181818182 * var_chaste_interface__membrane__Vm) - 14448.603861345418 * (-0.61380000000000001 + 1.0 * var_chaste_interface__Ca__Ca_ss_CaL * exp(0.074873319003313496 * var_chaste_interface__membrane__Vm)) * (var_chaste_interface__ICaL__O + var_chaste_interface__ICaL__O_star) * mParameters[0] * var_chaste_interface__membrane__Vm / (-1.0 + exp(0.074873319003313496 * var_chaste_interface__membrane__Vm)) - 0.0032509358688027189 * (1.0 - 1.0 / (1.0 + 6.2499999999999991 * pow(var_chaste_interface__Irel__Irel, 2))) * (-100.0 * exp(0.037436659501656748 * var_chaste_interface__membrane__Vm) + var_chaste_interface__Cl__Cl_i) * var_chaste_interface__Ito2_i2f_gate__i2f * var_chaste_interface__membrane__Vm / (1.0 - exp(0.037436659501656748 * var_chaste_interface__membrane__Vm)); // mV / ms
        }
