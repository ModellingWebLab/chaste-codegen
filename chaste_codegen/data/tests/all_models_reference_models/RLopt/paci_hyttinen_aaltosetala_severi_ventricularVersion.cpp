...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_calcium_dynamics__g = 0.5 * (-var_chaste_interface__calcium_dynamics__g + ((var_chaste_interface__calcium_dynamics__Cai <= 0.00035) ? (1 / (1.0 + 5.439910241481016e+20 * pow(var_chaste_interface__calcium_dynamics__Cai, 6))) : (1 / (1.0 + 1.9720198874049176e+55 * pow(var_chaste_interface__calcium_dynamics__Cai, 16))))) * (((((var_chaste_interface__calcium_dynamics__Cai <= 0.00035) || (var_chaste_interface__Membrane__Vm_converted > -60.0))) && (((var_chaste_interface__Membrane__Vm_converted > -60.0) || (var_chaste_interface__calcium_dynamics__Cai > 0.00035))) && (((var_chaste_interface__calcium_dynamics__Cai <= 0.00035) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * pow(var_chaste_interface__calcium_dynamics__Cai, 16))))) && (((var_chaste_interface__calcium_dynamics__Cai > 0.00035) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * pow(var_chaste_interface__calcium_dynamics__Cai, 6)))))) ? (0) : (1.0)); // 1 / millisecond
        const double var_i_CaL_d_gate__d_infinity = 1 / (1.0 + exp(-1.3 - 0.14285714285714285 * var_chaste_interface__Membrane__Vm_converted)); // dimensionless
        const double var_i_CaL_d_gate__tau_d = 0.001 / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__Membrane__Vm_converted)) + 0.0014 * (0.25 + 1.3999999999999999 / (1.0 + exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__Membrane__Vm_converted))) / (1.0 + exp(1.0 + 0.20000000000000001 * var_chaste_interface__Membrane__Vm_converted)); // second
        const double d_dt_chaste_interface_var_i_CaL_f1_gate__f1 = (-var_chaste_interface__i_CaL_f1_gate__f1 + 1 / (1.0 + exp(8.6666666666666661 + 0.33333333333333331 * var_chaste_interface__Membrane__Vm_converted))) * ((-1.0 / (1.0 + exp(8.6666666666666661 + 0.33333333333333331 * var_chaste_interface__Membrane__Vm_converted)) + var_chaste_interface__i_CaL_f1_gate__f1 < 0) ? (1 / (0.92835000000000001 + 1433.0 * var_chaste_interface__calcium_dynamics__Cai)) : (1.0)) / (20.0 + 200.0 / (1.0 + exp(1.3 - 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted)) + 180.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted)) + 1102.5 * exp(-2361.96 * pow((1 + 0.037037037037037035 * var_chaste_interface__Membrane__Vm_converted), 4))); // 1 / millisecond
        const double var_i_CaL_f2_gate__f2_inf = 0.33000000000000002 + 0.67000000000000004 / (1.0 + exp(8.75 + 0.25 * var_chaste_interface__Membrane__Vm_converted)); // dimensionless
        const double var_i_CaL_f2_gate__tau_f2 = 0.016 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted)) + 0.59999999999999998 * exp(-3.6764705882352939 * pow((1 + 0.040000000000000001 * var_chaste_interface__Membrane__Vm_converted), 2)) + 0.031 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted)); // second
        const double d_dt_chaste_interface_var_i_CaL_fCa_gate__fCa = 0.5 * (-var_chaste_interface__i_CaL_fCa_gate__fCa + 0.22803283672848887 / (1.0 + exp(-0.9375 + 1250.0 * var_chaste_interface__calcium_dynamics__Cai)) + 0.076010945576162961 / (1.0 + exp(-9.0 + 10000.0 * var_chaste_interface__calcium_dynamics__Cai)) + 0.76010945576162958 / (1.0 + 5.9537418076512766e+25 * pow(var_chaste_interface__calcium_dynamics__Cai, 8))) * (((0.001 * var_chaste_interface__Membrane__Vm_converted > -0.059999999999999998) && (var_chaste_interface__i_CaL_fCa_gate__fCa < 0.22803283672848887 / (1.0 + exp(-0.9375 + 1250.0 * var_chaste_interface__calcium_dynamics__Cai)) + 0.076010945576162961 / (1.0 + exp(-9.0 + 10000.0 * var_chaste_interface__calcium_dynamics__Cai)) + 0.76010945576162958 / (1.0 + 5.9537418076512766e+25 * pow(var_chaste_interface__calcium_dynamics__Cai, 8)))) ? (0) : (1.0)); // 1 / millisecond
        const double var_i_Kr_Xr1_gate__tau_Xr1 = 2.7000000000000002 / ((1.0 + exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__Membrane__Vm_converted)) * (1.0 + exp(-4.5 - 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted))); // second
        const double var_i_Kr_Xr2_gate__Xr2_infinity = 1 / (1.0 + exp(1.76 + 0.02 * var_chaste_interface__Membrane__Vm_converted)); // dimensionless
        const double var_i_Kr_Xr2_gate__tau_Xr2 = 0.0033600000000000001 / ((1.0 + exp(-3.0 + 0.050000000000000003 * var_chaste_interface__Membrane__Vm_converted)) * (1.0 + exp(-3.0 - 0.050000000000000003 * var_chaste_interface__Membrane__Vm_converted))); // second
        const double var_i_Ks_Xs_gate__Xs_infinity = 1 / (1.0 + exp(-1.25 - 0.0625 * var_chaste_interface__Membrane__Vm_converted)); // dimensionless
        const double var_i_Ks_Xs_gate__tau_Xs = 1.1000000000000001 / ((1.0 + exp(-3.0 + 0.050000000000000003 * var_chaste_interface__Membrane__Vm_converted)) * sqrt(1.0 + exp(-1.6666666666666667 - 0.16666666666666666 * var_chaste_interface__Membrane__Vm_converted))); // second
        const double var_i_Na_h_gate__h_inf = 1 / sqrt(1.0 + exp(12.649122807017543 + 0.17543859649122806 * var_chaste_interface__Membrane__Vm_converted)); // dimensionless
        const double var_i_Na_h_gate__tau_h = ((0.001 * var_chaste_interface__Membrane__Vm_converted < -0.040000000000000001) ? (0.0015 / (2.7000000000000002 * exp(0.079000000000000001 * var_chaste_interface__Membrane__Vm_converted) + 0.057000000000000002 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__Membrane__Vm_converted) + 310000.0 * exp(0.34849999999999998 * var_chaste_interface__Membrane__Vm_converted))) : (0.002542)); // second
        const double var_i_Na_j_gate__j_inf = 1 / sqrt(1.0 + exp(12.649122807017543 + 0.17543859649122806 * var_chaste_interface__Membrane__Vm_converted)); // dimensionless
        const double var_i_Na_j_gate__tau_j = 0.0070000000000000001 / (((0.001 * var_chaste_interface__Membrane__Vm_converted < -0.040000000000000001) ? (0.024240000000000001 * exp(-0.01052 * var_chaste_interface__Membrane__Vm_converted) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__Membrane__Vm_converted))) : (0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__Membrane__Vm_converted) / (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted)))) + ((0.001 * var_chaste_interface__Membrane__Vm_converted < -0.040000000000000001) ? ((37.780000000000001 + var_chaste_interface__Membrane__Vm_converted) * (-25428.0 * exp(0.24440000000000001 * var_chaste_interface__Membrane__Vm_converted) - 6.9480000000000002e-6 * exp(-0.043909999999999998 * var_chaste_interface__Membrane__Vm_converted)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__Membrane__Vm_converted))) : (0))); // second
        const double var_i_Na_m_gate__m_inf = pow((1.0 + exp(-5.7796610169491522 - 0.16949152542372881 * var_chaste_interface__Membrane__Vm_converted)), (-0.33333333333333331)); // dimensionless
        const double var_i_Na_m_gate__tau_m = 0.001 * (0.10000000000000001 / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__Membrane__Vm_converted)) + 0.10000000000000001 / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__Membrane__Vm_converted))) / (1.0 + exp(-12.0 - 0.20000000000000001 * var_chaste_interface__Membrane__Vm_converted)); // second
        const double var_i_f_Xf_gate__Xf_infinity = 1 / (1.0 + exp(15.569999999999999 + 0.20000000000000001 * var_chaste_interface__Membrane__Vm_converted)); // dimensionless
        const double var_i_f_Xf_gate__tau_Xf = 1.8999999999999999 / (1.0 + exp(1.5 + 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted)); // second
        const double var_i_to_q_gate__q_inf = 1 / (1.0 + exp(4.0769230769230766 + 0.076923076923076927 * var_chaste_interface__Membrane__Vm_converted)); // dimensionless
        const double var_i_to_q_gate__tau_q = 0.0060599999999999994 + 0.039101999999999998 / (0.065000000000000002 * exp(4.593 + 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted) + 0.56999999999999995 * exp(-3.52 - 0.080000000000000002 * var_chaste_interface__Membrane__Vm_converted)); // second
        const double var_i_to_r_gate__r_inf = 1 / (1.0 + exp(1.1893333333333334 - 0.053333333333333337 * var_chaste_interface__Membrane__Vm_converted)); // dimensionless
        const double var_i_to_r_gate__tau_r = 0.0027535199999999998 + 0.01440516 / (1.0369999999999999 * exp(2.7548999999999997 + 0.089999999999999997 * var_chaste_interface__Membrane__Vm_converted) + 0.36899999999999999 * exp(-2.8607999999999998 - 0.12 * var_chaste_interface__Membrane__Vm_converted)); // second
        const double var_i_Kr_Xr1_gate__Xr1_inf = 1 / (1.0 + exp(-3.8775510204081627 - 0.2040816326530612 * var_chaste_interface__Membrane__Vm_converted - 0.0076462663250123509 * (-2.1789087017666886 + log(40.0 * pow((1.0 + 0.38461538461538458 * mParameters[1]), 4) / pow((0.57999999999999996 + mParameters[1]), 4))) * mParameters[12])); // dimensionless
        const double d_dt_chaste_interface_var_calcium_dynamics__Ca_SR = 0.015075462970894076 * (0.56064000000000003 / (1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Cai, 2)) + 0.00044443999999999999 * var_chaste_interface__calcium_dynamics__Cai - 0.00044443999999999999 * var_chaste_interface__calcium_dynamics__Ca_SR - 0.041099999999999998 * (8.2319999999999993 + 16.463999999999999 * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 2) / (0.0625 + pow(var_chaste_interface__calcium_dynamics__Ca_SR, 2))) * var_chaste_interface__calcium_dynamics__g * var_chaste_interface__i_CaL_d_gate__d) / (1.0 + 3.0 / pow((0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR), 2)); // millimolar / millisecond
        const double d_dt_chaste_interface_var_calcium_dynamics__Cai = 0.001 * (0.00044443999999999999 * var_chaste_interface__calcium_dynamics__Ca_SR - 0.56064000000000003 / (1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Cai, 2)) - 0.00044443999999999999 * var_chaste_interface__calcium_dynamics__Cai - 588878900.51341963 * (0.00069264000000000001 * var_chaste_interface__Membrane__Vm_converted + 0.41249999999999998 * var_chaste_interface__calcium_dynamics__Cai / (0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai) - 2.9843579327954189e-5 * mParameters[12] * log(mParameters[1] / var_chaste_interface__calcium_dynamics__Cai) - 9800.0 * (pow(var_chaste_interface__sodium_dynamics__Nai, 3) * mParameters[1] * exp(4.0615771542678836 * var_chaste_interface__Membrane__Vm_converted / mParameters[12]) - 2.8571431999999999 * pow(mParameters[3], 3) * var_chaste_interface__calcium_dynamics__Cai * exp(-7.5429290007832126 * var_chaste_interface__Membrane__Vm_converted / mParameters[12])) / ((1.0 + 0.10000000000000001 * exp(-7.5429290007832126 * var_chaste_interface__Membrane__Vm_converted / mParameters[12])) * (669921.875 + pow(mParameters[3], 3)) * (1.3799999999999999 + mParameters[1])) + 4478658.9572358271 * (-0.34100000000000003 * mParameters[1] + var_chaste_interface__calcium_dynamics__Cai * exp(23.209012310102192 * var_chaste_interface__Membrane__Vm_converted / mParameters[12])) * var_chaste_interface__Membrane__Vm_converted * mParameters[4] * var_chaste_interface__i_CaL_d_gate__d * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_f2_gate__f2 * var_chaste_interface__i_CaL_fCa_gate__fCa / ((-1.0 + exp(23.209012310102192 * var_chaste_interface__Membrane__Vm_converted / mParameters[12])) * mParameters[12])) * mParameters[11] + 0.041099999999999998 * (8.2319999999999993 + 16.463999999999999 * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 2) / (0.0625 + pow(var_chaste_interface__calcium_dynamics__Ca_SR, 2))) * var_chaste_interface__calcium_dynamics__g * var_chaste_interface__i_CaL_d_gate__d) / (1.0 + 0.00025000000000000001 / pow((0.001 + var_chaste_interface__calcium_dynamics__Cai), 2)); // millimolar / millisecond
        const double d_dt_chaste_interface_var_sodium_dynamics__Nai = -1177757.8010268393 * (0.00089999999999999998 * var_chaste_interface__Membrane__Vm_converted - 7.7556079334600278e-5 * mParameters[12] * log(mParameters[3] / var_chaste_interface__sodium_dynamics__Nai) + 14700.0 * (pow(var_chaste_interface__sodium_dynamics__Nai, 3) * mParameters[1] * exp(4.0615771542678836 * var_chaste_interface__Membrane__Vm_converted / mParameters[12]) - 2.8571431999999999 * pow(mParameters[3], 3) * var_chaste_interface__calcium_dynamics__Cai * exp(-7.5429290007832126 * var_chaste_interface__Membrane__Vm_converted / mParameters[12])) / ((1.0 + 0.10000000000000001 * exp(-7.5429290007832126 * var_chaste_interface__Membrane__Vm_converted / mParameters[12])) * (669921.875 + pow(mParameters[3], 3)) * (1.3799999999999999 + mParameters[1])) + pow(var_chaste_interface__i_Na_m_gate__m, 3) * (0.001 * var_chaste_interface__Membrane__Vm_converted - 8.6173421482889202e-5 * mParameters[12] * log(mParameters[3] / var_chaste_interface__sodium_dynamics__Nai)) * mParameters[5] * var_chaste_interface__i_Na_h_gate__h * var_chaste_interface__i_Na_j_gate__j + 5.5242719999999998 * mParameters[2] * var_chaste_interface__sodium_dynamics__Nai / ((1.0 + mParameters[2]) * (40.0 + var_chaste_interface__sodium_dynamics__Nai) * (1.0 + 0.035299999999999998 * exp(-11.604506155051096 * var_chaste_interface__Membrane__Vm_converted / mParameters[12]) + 0.1245 * exp(-1.1604506155051095 * var_chaste_interface__Membrane__Vm_converted / mParameters[12])))) * mParameters[11]; // millimolar / millisecond
        ...
        {
            d_dt_chaste_interface_var_Membrane__Vm_converted = -0.00159264 * var_chaste_interface__Membrane__Vm_converted + 7.7556079334600278e-5 * mParameters[12] * log(mParameters[3] / var_chaste_interface__sodium_dynamics__Nai) + 2.9843579327954189e-5 * mParameters[12] * log(mParameters[1] / var_chaste_interface__calcium_dynamics__Cai) - 1.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() - 0.41249999999999998 * var_chaste_interface__calcium_dynamics__Cai / (0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai) - 1.0 * (0.017000000000000001 + 0.001 * var_chaste_interface__Membrane__Vm_converted) * mParameters[6] * var_chaste_interface__i_f_Xf_gate__Xf - 1.0 * pow(var_chaste_interface__i_Ks_Xs_gate__Xs, 2) * (1.0 + 0.59999999999999998 / (1.0 + 6.4818210260626455e-7 * pow(1 / var_chaste_interface__calcium_dynamics__Cai, 1.3999999999999999))) * (0.001 * var_chaste_interface__Membrane__Vm_converted - 8.6173421482889202e-5 * mParameters[12] * log((0.029999999999999999 * mParameters[3] + mParameters[2]) / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Nai + mParameters[0]))) * mParameters[9] - 1.0 * (0.001 * var_chaste_interface__Membrane__Vm_converted - 8.6173421482889202e-5 * mParameters[12] * log(mParameters[2] / mParameters[0])) * mParameters[10] * var_chaste_interface__i_to_q_gate__q * var_chaste_interface__i_to_r_gate__r - 4900.0 * (pow(var_chaste_interface__sodium_dynamics__Nai, 3) * mParameters[1] * exp(4.0615771542678836 * var_chaste_interface__Membrane__Vm_converted / mParameters[12]) - 2.8571431999999999 * pow(mParameters[3], 3) * var_chaste_interface__calcium_dynamics__Cai * exp(-7.5429290007832126 * var_chaste_interface__Membrane__Vm_converted / mParameters[12])) / ((1.0 + 0.10000000000000001 * exp(-7.5429290007832126 * var_chaste_interface__Membrane__Vm_converted / mParameters[12])) * (669921.875 + pow(mParameters[3], 3)) * (1.3799999999999999 + mParameters[1])) - 1.0 * pow(var_chaste_interface__i_Na_m_gate__m, 3) * (0.001 * var_chaste_interface__Membrane__Vm_converted - 8.6173421482889202e-5 * mParameters[12] * log(mParameters[3] / var_chaste_interface__sodium_dynamics__Nai)) * mParameters[5] * var_chaste_interface__i_Na_h_gate__h * var_chaste_interface__i_Na_j_gate__j - 1.6825960981856667 * sqrt(mParameters[2]) * (0.001 * var_chaste_interface__Membrane__Vm_converted - 8.6173421482889202e-5 * mParameters[12] * log(mParameters[2] / mParameters[0])) * mParameters[7] / ((1.0 + exp(-118.83999999999999 + 0.59419999999999995 * var_chaste_interface__Membrane__Vm_converted - 0.05120424704513276 * mParameters[12] * log(mParameters[2] / mParameters[0]))) * (3.9100000000000001 / (1.0 + exp(-118.83999999999999 + 0.59419999999999995 * var_chaste_interface__Membrane__Vm_converted - 0.05120424704513276 * mParameters[12] * log(mParameters[2] / mParameters[0]))) + (-1.5089999999999999 * exp(0.02 + 0.00020000000000000001 * var_chaste_interface__Membrane__Vm_converted - 1.7234684296577842e-5 * mParameters[12] * log(mParameters[2] / mParameters[0])) + exp(-5.8860000000000001 + 0.58860000000000001 * var_chaste_interface__Membrane__Vm_converted - 0.050721675884828586 * mParameters[12] * log(mParameters[2] / mParameters[0]))) / (1.0 + exp(0.45469999999999999 * var_chaste_interface__Membrane__Vm_converted - 0.039183054748269719 * mParameters[12] * log(mParameters[2] / mParameters[0]))))) - 0.43033148291193518 * sqrt(mParameters[2]) * (0.001 * var_chaste_interface__Membrane__Vm_converted - 8.6173421482889202e-5 * mParameters[12] * log(mParameters[2] / mParameters[0])) * mParameters[8] * var_chaste_interface__i_Kr_Xr1_gate__Xr1 * var_chaste_interface__i_Kr_Xr2_gate__Xr2 - 1.8414239999999999 * mParameters[2] * var_chaste_interface__sodium_dynamics__Nai / ((1.0 + mParameters[2]) * (40.0 + var_chaste_interface__sodium_dynamics__Nai) * (1.0 + 0.035299999999999998 * exp(-11.604506155051096 * var_chaste_interface__Membrane__Vm_converted / mParameters[12]) + 0.1245 * exp(-1.1604506155051095 * var_chaste_interface__Membrane__Vm_converted / mParameters[12]))) - 4478658.9572358271 * (-0.34100000000000003 * mParameters[1] + var_chaste_interface__calcium_dynamics__Cai * exp(23.209012310102192 * var_chaste_interface__Membrane__Vm_converted / mParameters[12])) * var_chaste_interface__Membrane__Vm_converted * mParameters[4] * var_chaste_interface__i_CaL_d_gate__d * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_f2_gate__f2 * var_chaste_interface__i_CaL_fCa_gate__fCa / ((-1.0 + exp(23.209012310102192 * var_chaste_interface__Membrane__Vm_converted / mParameters[12])) * mParameters[12]); // millivolt / millisecond
        }
