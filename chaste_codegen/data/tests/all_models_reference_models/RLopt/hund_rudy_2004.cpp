...
// LCOV_EXCL_STOP
        ...
        const double var_INa__am = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__cell__V) / (_lt_0_row[26]); // per_ms
        ...
        const double var_INa__bm = 0.080000000000000002 * _lt_0_row[25]; // per_ms
        ...
        const double var_INal__amL = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__cell__V) / (_lt_0_row[26]); // per_ms
        const double var_INal__bmL = 0.080000000000000002 * _lt_0_row[25]; // per_ms
