...
class Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables(const Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables&);
    Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables&);
    Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables> Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellhund_rudy_2004FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellhund_rudy_2004FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellhund_rudy_2004FromCellMLRushLarsenOpt::Cellhund_rudy_2004FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellhund_rudy_2004FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellhund_rudy_2004FromCellMLRushLarsenOpt::~Cellhund_rudy_2004FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellhund_rudy_2004FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellhund_rudy_2004FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellhund_rudy_2004FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellhund_rudy_2004FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__Environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_INa__am = _lt_0_row[25]; // per_ms
        ...
        const double var_INa__bm = 0.080000000000000002 * _lt_0_row[26]; // per_ms
        ...
        const double var_INal__amL = _lt_0_row[25]; // per_ms
        const double var_INal__bmL = 0.080000000000000002 * _lt_0_row[26]; // per_ms
        ...
        const double var_Ito__ay = 25.0 * _lt_0_row[29] / (_lt_0_row[28]); // per_ms
        const double var_Ito__ay2 = 0.029999999999999999 / (_lt_0_row[32]); // per_ms
        const double var_Ito__ay3 = 0.0022499999999999998 / (_lt_0_row[32]); // per_ms
        const double var_Ito__by = 25.0 * _lt_0_row[31] / (_lt_0_row[30]); // per_ms
        const double var_Ito__by2 = 0.20000000000000001 * _lt_0_row[34] / (_lt_0_row[33]); // per_ms
        const double var_Ito__by3 = 0.10000000000000001 * _lt_0_row[34] / (_lt_0_row[33]); // per_ms
    ...
    void Cellhund_rudy_2004FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellhund_rudy_2004FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellhund_rudy_2004FromCellMLRushLarsenOpt>::Initialise(void)
{
