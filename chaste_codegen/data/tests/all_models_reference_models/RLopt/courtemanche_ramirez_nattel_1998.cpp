...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_d_gate__d_infinity = 1 / (_lt_0_row[10]); // dimensionless
        ...
        const double var_rapid_delayed_rectifier_K_current_xr_gate__xr_infinity = 1 / (_lt_0_row[16]); // dimensionless
        ...
        const double var_slow_delayed_rectifier_K_current_xs_gate__xs_infinity = _lt_0_row[18]; // dimensionless
        ...
        const double var_transient_outward_K_current_oa_gate__oa_infinity = 1 / (_lt_0_row[20]); // dimensionless
        ...
        const double var_transient_outward_K_current_oi_gate__oi_infinity = 1 / (_lt_0_row[22]); // dimensionless
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ua_gate__ua_infinity = 1 / (_lt_0_row[24]); // dimensionless
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__ui_infinity = 1 / (_lt_0_row[25]); // dimensionless
