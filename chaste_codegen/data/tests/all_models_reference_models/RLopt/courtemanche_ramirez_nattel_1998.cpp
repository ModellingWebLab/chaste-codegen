...
class Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables(const Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables&);
    Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables&);
    Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables> Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt::Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt::~Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_Ca_release_current_from_JSR_w_gate__tau_w = 6.0 * (_lt_0_row[9]) / ((_lt_0_row[10]) * (-7.9000000000000004 + var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_L_type_Ca_channel_d_gate__d_infinity = 1 / (_lt_0_row[11]); // dimensionless
        const double var_L_type_Ca_channel_d_gate__tau_d = 28.571428571428569 * (_lt_0_row[12]) / ((_lt_0_row[13]) * (10.0 + var_chaste_interface__membrane__V)); // millisecond
        const double var_L_type_Ca_channel_f_gate__f_infinity = _lt_0_row[14]; // dimensionless
        ...
        const double var_rapid_delayed_rectifier_K_current_xr_gate__xr_infinity = 1 / (_lt_0_row[18]); // dimensionless
        ...
        const double var_slow_delayed_rectifier_K_current_xs_gate__xs_infinity = _lt_0_row[20]; // dimensionless
        ...
        const double var_transient_outward_K_current_oa_gate__oa_infinity = 1 / (_lt_0_row[22]); // dimensionless
        ...
        const double var_transient_outward_K_current_oi_gate__oi_infinity = 1 / (_lt_0_row[24]); // dimensionless
        ...
        const double var_ultrarapid_delayed_rectifier_K_current__g_Kur = _lt_0_row[7]; // nanoS_per_picoF
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ua_gate__ua_infinity = 1 / (_lt_0_row[26]); // dimensionless
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__ui_infinity = 1 / (_lt_0_row[27]); // dimensionless
        ...
        rAlphaOrTau[2] = var_fast_sodium_current_m_gate__tau_m;
        rBetaOrInf[2] = var_fast_sodium_current_m_gate__m_inf;
        ...
        rAlphaOrTau[11] = var_L_type_Ca_channel_d_gate__tau_d;
        rBetaOrInf[11] = var_L_type_Ca_channel_d_gate__d_infinity;
        rAlphaOrTau[12] = var_L_type_Ca_channel_f_gate__tau_f;
        rBetaOrInf[12] = var_L_type_Ca_channel_f_gate__f_infinity;
    ...
    void Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsenOpt)
