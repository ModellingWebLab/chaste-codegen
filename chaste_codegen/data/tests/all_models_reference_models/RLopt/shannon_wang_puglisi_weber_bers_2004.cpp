...
class Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables(const Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables&);
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables&);
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables> Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt::Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt::~Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_ICaL_d_gate__tau_d = 28.571428571428569 * (_lt_0_row[2]) * var_ICaL_d_gate__d_infinity / (14.5 + var_chaste_interface__cell__V); // millisecond
        const double var_ICaL_f_gate__f_infinity = _lt_0_row[3] + _lt_0_row[4]; // dimensionless
        const double var_ICaL_f_gate__tau_f = 1 / (_lt_0_row[5]); // millisecond
        const double var_IKr_Xr_gate__Xr_infinity = _lt_0_row[6]; // dimensionless
        const double var_IKr_Xr_gate__tau_Xr = 1 / (_lt_0_row[7]); // millisecond
        const double var_IKs_Xs_gate__Xs_infinity = _lt_0_row[8]; // dimensionless
        const double var_IKs_Xs_gate__tau_Xs = 1 / (_lt_0_row[9]); // millisecond
        ...
        const double var_Itof_X_gate__X_tof_infinity = _lt_0_row[12]; // dimensionless
        const double var_Itof_X_gate__tau_X_tof = _lt_0_row[13]; // millisecond
        const double var_Itof_Y_gate__Y_tof_infinity = _lt_0_row[14]; // dimensionless
        const double var_Itof_Y_gate__tau_Y_tof = _lt_0_row[15]; // millisecond
        const double var_Itos_R_gate__R_tos_infinity = _lt_0_row[14]; // dimensionless
        const double var_Itos_R_gate__tau_R_tos = _lt_0_row[16]; // millisecond
        const double var_Itos_X_gate__X_tos_infinity = _lt_0_row[12]; // dimensionless
        const double var_Itos_X_gate__tau_X_tos = _lt_0_row[17]; // millisecond
        const double var_Itos_Y_gate__Y_tos_infinity = _lt_0_row[14]; // dimensionless
        const double var_Itos_Y_gate__tau_Y_tos = _lt_0_row[18]; // millisecond
        ...
        rAlphaOrTau[2] = var_INa_h_gate__tau_h;
        rBetaOrInf[2] = var_INa_h_gate__h_infinity;
        rAlphaOrTau[3] = var_INa_j_gate__tau_j;
        rBetaOrInf[3] = var_INa_j_gate__j_infinity;
        rAlphaOrTau[4] = var_INa_m_gate__tau_m;
        rBetaOrInf[4] = var_INa_m_gate__m_infinity;
    ...
    void Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellshannon_wang_puglisi_weber_bers_2004FromCellMLRushLarsenOpt)
