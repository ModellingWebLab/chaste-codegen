...
class Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables(const Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables&);
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables&);
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt::Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt::~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_calcium_current_f_gate__alpha_f = 0.0068700000000000002 / (_lt_0_row[11]); // per_millisecond
        const double var_calcium_current_f_gate__beta_f = _lt_0_row[10]; // per_millisecond
        const double var_delayed_rectifier_potassium_current_X_gate__X_infinity = _lt_0_row[12]; // dimensionless
        ...
        const double var_sodium_current_m_gate__alpha_m = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__V) / (_lt_0_row[15]); // per_millisecond
        const double var_sodium_current_m_gate__beta_m = 0.080000000000000002 * _lt_0_row[14]; // per_millisecond
        const double var_sodium_current_v_gate__tau_v = _lt_0_row[17]; // millisecond
        const double var_sodium_current_v_gate__v_infinity = 0.5 + _lt_0_row[16]; // dimensionless
        const double var_transient_outward_current_to_gate__alpha_to = (_lt_0_row[19]) / (_lt_0_row[18]); // per_millisecond
        const double var_transient_outward_current_to_gate__beta_to = (_lt_0_row[21]) / (_lt_0_row[20]); // per_millisecond
        ...
        else
        {
            ...
            const double var_sodium_calcium_pump__f_NaCa = (pow(mParameters[2], 3) * mParameters[3] * _lt_0_row[2] - pow(mParameters[5], 3) * mParameters[0] * _lt_0_row[3]) / ((_lt_0_row[4]) * (669921.875 + pow(mParameters[5], 3)) * (1.3799999999999999 + mParameters[3])); // dimensionless
            ...
            const double var_sodium_potassium_pump__f_NaK = 1 / (1.0 + _lt_0_row[6] + 0.036499999999999998 * var_sodium_potassium_pump__sigma * _lt_0_row[5]); // dimensionless
            ...
            const double var_transient_outward_current_r_gate__alpha_r = 0.52659999999999996 * _lt_0_row[9] / (_lt_0_row[7]); // per_millisecond
        ...
        rAlphaOrTau[1] = var_sodium_current_m_gate__alpha_m;
        rBetaOrInf[1] = var_sodium_current_m_gate__beta_m;
        rAlphaOrTau[2] = var_sodium_current_v_gate__tau_v;
        rBetaOrInf[2] = var_sodium_current_v_gate__v_infinity;
        rAlphaOrTau[3] = var_calcium_current_f_gate__alpha_f;
        rBetaOrInf[3] = var_calcium_current_f_gate__beta_f;
        rAlphaOrTau[4] = var_transient_outward_current_to_gate__alpha_to;
        rBetaOrInf[4] = var_transient_outward_current_to_gate__beta_to;
        rAlphaOrTau[5] = var_delayed_rectifier_potassium_current_X_gate__tau_X;
        rBetaOrInf[5] = var_delayed_rectifier_potassium_current_X_gate__X_infinity;
    }
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLRushLarsenOpt>::Initialise(void)
{
