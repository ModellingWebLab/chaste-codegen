...
class Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables(const Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables&);
    Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables&);
    Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables> Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt::Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt::~Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__Environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_IKr__xkrinf = _lt_0_row[7]; // dimensionless
        ...
        const double var_INa__am = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__cell__V) / (_lt_0_row[15]); // per_ms
        ...
        const double var_INa__bm = 0.080000000000000002 * _lt_0_row[14]; // per_ms
        ...
        rAlphaOrTau[3] = var_INa__tau_h;
        rBetaOrInf[3] = var_INa__h_inf;
    ...
    void Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellmahajan_shiferaw_2008FromCellMLRushLarsenOpt>::Initialise(void)
{
