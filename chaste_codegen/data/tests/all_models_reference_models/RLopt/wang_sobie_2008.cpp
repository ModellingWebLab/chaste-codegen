...
class Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables(const Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables&);
    Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables&);
    Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables> Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellwang_sobie_2008FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellwang_sobie_2008FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellwang_sobie_2008FromCellMLRushLarsenOpt::Cellwang_sobie_2008FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellwang_sobie_2008FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellwang_sobie_2008FromCellMLRushLarsenOpt::~Cellwang_sobie_2008FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellwang_sobie_2008FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellwang_sobie_2008FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellwang_sobie_2008FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellwang_sobie_2008FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_T_type_calcium_current_b_gate__b_infinity = _lt_0_row[11]; // dimensionless
        const double var_T_type_calcium_current_b_gate__tau_b = _lt_0_row[12]; // millisecond
        const double var_T_type_calcium_current_g_gate__g_infinity = _lt_0_row[13]; // dimensionless
        const double var_T_type_calcium_current_g_gate__tau_g = _lt_0_row[14]; // millisecond
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = _lt_0_row[16]; // per_millisecond
        ...
        const double var_fast_sodium_current_j_gate__alpha_j = _lt_0_row[18]; // per_millisecond
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = _lt_0_row[20]; // per_millisecond
        ...
        const double var_fast_transient_outward_potassium_current__alpha_a = 0.18064 * _lt_0_row[21]; // per_millisecond
        ...
        const double var_fast_transient_outward_potassium_current__beta_a = 0.39560000000000001 * _lt_0_row[22]; // per_millisecond
        ...
        const double var_fast_transient_outward_potassium_current__tau_ito_f = 1 / (_lt_0_row[24]); // millisecond
        ...
        const double var_non_inactivating_steady_state_potassium_current__tau_Kss = _lt_0_row[34]; // millisecond
        ...
        const double var_rapid_delayed_rectifier_potassium_current__alpha_a0 = 0.022348 * _lt_0_row[29]; // per_millisecond
        ...
        const double var_rapid_delayed_rectifier_potassium_current__beta_a0 = 0.047002000000000002 * _lt_0_row[30]; // per_millisecond
        ...
        const double var_slow_delayed_rectifier_potassium_current__alpha_n = 4.8133299999999997e-6 * (26.5 + var_chaste_interface__membrane__V) / (_lt_0_row[32]); // per_millisecond
        const double var_slow_delayed_rectifier_potassium_current__beta_n = 9.5333299999999997e-5 * _lt_0_row[31]; // per_millisecond
        ...
        const double var_ultra_rapidly_activating_delayed_rectifier_potassium_current__iss = _lt_0_row[36]; // dimensionless
        ...
        const double var_ultra_rapidly_activating_delayed_rectifier_potassium_current__tau_aur = _lt_0_row[35]; // millisecond
        const double var_ultra_rapidly_activating_delayed_rectifier_potassium_current__tau_iur = _lt_0_row[37]; // millisecond
    ...
    void Cellwang_sobie_2008FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellwang_sobie_2008FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellwang_sobie_2008FromCellMLRushLarsenOpt>::Initialise(void)
{
