...
// LCOV_EXCL_STOP
        ...
        else
        {
            ...
            const double var_delayed_rectifier_K_currents_pi_gate__p_i = _lt_0_row[2]; // dimensionless
            ...
            const double var_sustained_outward_K_current_r_sus_gate__r_sus_infinity = _lt_0_row[22]; // dimensionless
            ...
            const double var_sustained_outward_K_current_s_sus_gate__s_sus_infinity = 0.59999999999999998 + _lt_0_row[24]; // dimensionless
