...
class Celliyer_2004FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celliyer_2004FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celliyer_2004FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V)
    {
        ...
        const double* const _lt_0_row = Celliyer_2004FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celliyer_2004FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Celliyer_2004FromCellMLRushLarsenOpt_LookupTables(const Celliyer_2004FromCellMLRushLarsenOpt_LookupTables&);
    Celliyer_2004FromCellMLRushLarsenOpt_LookupTables& operator= (const Celliyer_2004FromCellMLRushLarsenOpt_LookupTables&);
    Celliyer_2004FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Celliyer_2004FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celliyer_2004FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celliyer_2004FromCellMLRushLarsenOpt_LookupTables> Celliyer_2004FromCellMLRushLarsenOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Celliyer_2004FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Celliyer_2004FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celliyer_2004FromCellMLRushLarsenOpt::Celliyer_2004FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celliyer_2004FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Celliyer_2004FromCellMLRushLarsenOpt::~Celliyer_2004FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Celliyer_2004FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Celliyer_2004FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Celliyer_2004FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celliyer_2004FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliyer_2004FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
    ...
    void Celliyer_2004FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
    ...
    void Celliyer_2004FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Celliyer_2004FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celliyer_2004FromCellMLRushLarsenOpt>::Initialise(void)
{
