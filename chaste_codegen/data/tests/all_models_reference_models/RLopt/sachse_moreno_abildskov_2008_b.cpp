...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellsachse_moreno_abildskov_2008_bFromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_I_Shkr__C0Shkr = 0.002 * var_chaste_interface__I_Shkr__C1Shkr * exp(-17.767148014440433 * var_chaste_interface__membrane__Vm / mParameters[6]) - 0.12 * var_chaste_interface__I_Shkr__C0Shkr * exp(14.864019253910952 * var_chaste_interface__membrane__Vm / mParameters[6]); // 1 / millisecond
        const double d_dt_chaste_interface_var_I_Shkr__C1Shkr = 0.0040000000000000001 * var_chaste_interface__I_Shkr__C2Shkr * exp(-17.767148014440433 * var_chaste_interface__membrane__Vm / mParameters[6]) + 0.12 * var_chaste_interface__I_Shkr__C0Shkr * exp(14.864019253910952 * var_chaste_interface__membrane__Vm / mParameters[6]) - 0.001 * (2.0 * exp(-17.767148014440433 * var_chaste_interface__membrane__Vm / mParameters[6]) + 90.0 * exp(14.864019253910952 * var_chaste_interface__membrane__Vm / mParameters[6])) * var_chaste_interface__I_Shkr__C1Shkr; // 1 / millisecond
        const double d_dt_chaste_interface_var_I_Shkr__C2Shkr = 0.0060000000000000001 * var_chaste_interface__I_Shkr__C3Shkr * exp(-17.767148014440433 * var_chaste_interface__membrane__Vm / mParameters[6]) + 0.089999999999999997 * var_chaste_interface__I_Shkr__C1Shkr * exp(14.864019253910952 * var_chaste_interface__membrane__Vm / mParameters[6]) - 0.001 * (4.0 * exp(-17.767148014440433 * var_chaste_interface__membrane__Vm / mParameters[6]) + 60.0 * exp(14.864019253910952 * var_chaste_interface__membrane__Vm / mParameters[6])) * var_chaste_interface__I_Shkr__C2Shkr; // 1 / millisecond
        const double d_dt_chaste_interface_var_I_Shkr__C3Shkr = 0.0080000000000000002 * var_chaste_interface__I_Shkr__C4Shkr * exp(-17.767148014440433 * var_chaste_interface__membrane__Vm / mParameters[6]) + 0.059999999999999998 * var_chaste_interface__I_Shkr__C2Shkr * exp(14.864019253910952 * var_chaste_interface__membrane__Vm / mParameters[6]) - 0.001 * (6.0 * exp(-17.767148014440433 * var_chaste_interface__membrane__Vm / mParameters[6]) + 30.0 * exp(14.864019253910952 * var_chaste_interface__membrane__Vm / mParameters[6])) * var_chaste_interface__I_Shkr__C3Shkr; // 1 / millisecond
        const double d_dt_chaste_interface_var_I_Shkr__C4Shkr = 0.017999999999999999 * var_chaste_interface__I_Shkr__OShkr + 0.029999999999999999 * var_chaste_interface__I_Shkr__C3Shkr * exp(14.864019253910952 * var_chaste_interface__membrane__Vm / mParameters[6]) - 0.001 * (77.0 + 8.0 * exp(-17.767148014440433 * var_chaste_interface__membrane__Vm / mParameters[6])) * var_chaste_interface__I_Shkr__C4Shkr; // 1 / millisecond
        ...
        {
            d_dt_chaste_interface_var_membrane__Vm = 0.001 * (-mParameters[5] * var_chaste_interface__membrane__Vm - 1000.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) * mParameters[2] / HeartConfig::Instance()->GetCapacitance() - 0.031622776601683791 * sqrt(mParameters[1]) * (-0.086113989637305696 * mParameters[6] * log(mParameters[1] / mParameters[0]) + var_chaste_interface__membrane__Vm) * mParameters[4] / (0.93999999999999995 + exp(14.631768953068592 * (-0.086113989637305696 * mParameters[6] * log(mParameters[1] / mParameters[0]) + var_chaste_interface__membrane__Vm) / mParameters[6])) - 1120607.7015643802 * (-mParameters[1] * exp(-11.612515042117931 * var_chaste_interface__membrane__Vm / mParameters[6]) + mParameters[0]) * var_chaste_interface__I_Shkr__OShkr * mParameters[3] * var_chaste_interface__membrane__Vm / ((1.0 - exp(-11.612515042117931 * var_chaste_interface__membrane__Vm / mParameters[6])) * mParameters[6])) / mParameters[2]; // millivolt / millisecond
        }
