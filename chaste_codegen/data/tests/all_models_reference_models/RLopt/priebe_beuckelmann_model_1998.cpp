...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_Ionic_concentrations__Cai = (2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR + 0.0070588235294117632 * (-var_chaste_interface__Ionic_concentrations__Cai + var_chaste_interface__Ionic_concentrations__Ca_JSR) * ((var_chaste_interface__Irel__Cainfluxtrack > 5.0000000000000004e-6) ? (22.0 * (1.0 - var_chaste_interface__Irel__APtrack2) * (-5.0000000000000004e-6 + var_chaste_interface__Irel__Cainfluxtrack) * var_chaste_interface__Irel__APtrack2 / (0.00079500000000000003 + var_chaste_interface__Irel__Cainfluxtrack)) : (0)) - 0.00036529411764705876 * var_chaste_interface__Ionic_concentrations__Cai / (0.00092000000000000003 + var_chaste_interface__Ionic_concentrations__Cai) - 9.661256841321762e-5 * (0.00084999999999999995 * var_chaste_interface__cell__V - 0.011358446932323314 * log(10) * log10(2.0 / var_chaste_interface__Ionic_concentrations__Cai) - 0.00017941694216498839 * (2.0 * pow(var_chaste_interface__Ionic_concentrations__Nai, 3) * exp(0.013095980540851452 * var_chaste_interface__cell__V) - 2628072.0 * var_chaste_interface__Ionic_concentrations__Cai * exp(-0.024321106718724127 * var_chaste_interface__cell__V)) / (1.0 + 0.10000000000000001 * exp(-0.024321106718724127 * var_chaste_interface__cell__V)) + 0.00059999999999999995 * (-13.36287874390978 * log(10) * log10(2.0 / var_chaste_interface__Ionic_concentrations__Cai) + var_chaste_interface__cell__V) * mParameters[0] * var_chaste_interface__ICa_d_gate__d * var_chaste_interface__ICa_f_gate__f / (0.00059999999999999995 + var_chaste_interface__Ionic_concentrations__Cai)) / M_PI) / (1.0 + 0.00011900000000000002 / pow((0.0023800000000000002 + var_chaste_interface__Ionic_concentrations__Cai), 2) + 3.5000000000000004e-5 / pow((0.00050000000000000001 + var_chaste_interface__Ionic_concentrations__Cai), 2)); // mM / ms
        const double d_dt_chaste_interface_var_Ionic_concentrations__Ki = -0.00019322513682643524 * (GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() + 0.02 * pow(var_chaste_interface__IKs_Xs_gate__Xs, 2) * (-26.725757487819561 * log(10) * log10(6.5295399999999999 / (0.018329999999999999 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki)) + var_chaste_interface__cell__V) - 1.8909090909090909 / ((1.0 + 31.622776601683793 * pow(1 / var_chaste_interface__Ionic_concentrations__Nai, 1.5)) * (1.0 + 0.1245 * exp(-0.0037417087259575582 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0505200594353643)) * exp(-0.037417087259575585 * var_chaste_interface__cell__V))) + 0.29999999999999999 * (-26.725757487819561 * log(10) * log10(9.9339999999999993 / (0.042999999999999997 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki)) + var_chaste_interface__cell__V) * var_chaste_interface__Ito_r_gate__r * var_chaste_interface__Ito_t_gate__t + 0.25 * (-26.725757487819561 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki) + var_chaste_interface__cell__V) / ((1.0 + exp(-12.0 + 0.059999999999999998 * var_chaste_interface__cell__V - 1.6035454492691736 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki))) * (0.10000000000000001 / (1.0 + exp(-12.0 + 0.059999999999999998 * var_chaste_interface__cell__V - 1.6035454492691736 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki))) + (3.0 * exp(0.02 + 0.00020000000000000001 * var_chaste_interface__cell__V - 0.0053451514975639122 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki)) + exp(-1.0 + 0.10000000000000001 * var_chaste_interface__cell__V - 2.6725757487819561 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki))) / (1.0 + exp(-0.5 * var_chaste_interface__cell__V + 13.36287874390978 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki))))) + (-26.725757487819561 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki) + var_chaste_interface__cell__V) * mParameters[2] * var_chaste_interface__IKr_Xr_gate__Xr / (1.0 + exp(1.1304347826086956 + 0.043478260869565216 * var_chaste_interface__cell__V))) / M_PI; // mM / ms
        const double d_dt_chaste_interface_var_Irel__APtrack = ((0.0018500000000000001 * var_chaste_interface__cell__V + 1.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() + 0.02 * pow(var_chaste_interface__IKs_Xs_gate__Xs, 2) * (-26.725757487819561 * log(10) * log10(6.5295399999999999 / (0.018329999999999999 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki)) + var_chaste_interface__cell__V) + 8.9708471082494196e-5 * (2.0 * pow(var_chaste_interface__Ionic_concentrations__Nai, 3) * exp(0.013095980540851452 * var_chaste_interface__cell__V) - 2628072.0 * var_chaste_interface__Ionic_concentrations__Cai * exp(-0.024321106718724127 * var_chaste_interface__cell__V)) / (1.0 + 0.10000000000000001 * exp(-0.024321106718724127 * var_chaste_interface__cell__V)) + 0.94545454545454544 / ((1.0 + 31.622776601683793 * pow(1 / var_chaste_interface__Ionic_concentrations__Nai, 1.5)) * (1.0 + 0.1245 * exp(-0.0037417087259575582 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0505200594353643)) * exp(-0.037417087259575585 * var_chaste_interface__cell__V))) - 0.026725757487819562 * log(10) * log10(138.0 / var_chaste_interface__Ionic_concentrations__Nai) - 0.011358446932323314 * log(10) * log10(2.0 / var_chaste_interface__Ionic_concentrations__Cai) + 0.29999999999999999 * (-26.725757487819561 * log(10) * log10(9.9339999999999993 / (0.042999999999999997 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki)) + var_chaste_interface__cell__V) * var_chaste_interface__Ito_r_gate__r * var_chaste_interface__Ito_t_gate__t + 0.25 * (-26.725757487819561 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki) + var_chaste_interface__cell__V) / ((1.0 + exp(-12.0 + 0.059999999999999998 * var_chaste_interface__cell__V - 1.6035454492691736 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki))) * (0.10000000000000001 / (1.0 + exp(-12.0 + 0.059999999999999998 * var_chaste_interface__cell__V - 1.6035454492691736 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki))) + (3.0 * exp(0.02 + 0.00020000000000000001 * var_chaste_interface__cell__V - 0.0053451514975639122 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki)) + exp(-1.0 + 0.10000000000000001 * var_chaste_interface__cell__V - 2.6725757487819561 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki))) / (1.0 + exp(-0.5 * var_chaste_interface__cell__V + 13.36287874390978 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki))))) + 1.0 * (-26.725757487819561 * log(10) * log10(4.0 / var_chaste_interface__Ionic_concentrations__Ki) + var_chaste_interface__cell__V) * mParameters[2] * var_chaste_interface__IKr_Xr_gate__Xr / (1.0 + exp(1.1304347826086956 + 0.043478260869565216 * var_chaste_interface__cell__V)) + 1.0 * pow(var_chaste_interface__INa_m_gate__m, 3) * (-26.725757487819561 * log(10) * log10(138.0 / var_chaste_interface__Ionic_concentrations__Nai) + var_chaste_interface__cell__V) * mParameters[1] * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j + 0.00059999999999999995 * (-13.36287874390978 * log(10) * log10(2.0 / var_chaste_interface__Ionic_concentrations__Cai) + var_chaste_interface__cell__V) * mParameters[0] * var_chaste_interface__ICa_d_gate__d * var_chaste_interface__ICa_f_gate__f / (0.00059999999999999995 + var_chaste_interface__Ionic_concentrations__Cai) < -150.0) ? (100.0 - 100.5 * var_chaste_interface__Irel__APtrack) : (-0.5 * var_chaste_interface__Irel__APtrack)); // 1 / ms
