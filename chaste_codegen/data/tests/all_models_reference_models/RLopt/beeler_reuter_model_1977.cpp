...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbeeler_reuter_model_1977FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        {
            d_dt_chaste_interface_var_membrane__V = -0.99999999999999978 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) - 070000000000000007 * (23.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-0.92000000000000004 - 040000000000000001 * var_chaste_interface__membrane__V)) - 1.3999999999999999 * (-1.0 + exp(3.3999999999999999 + 040000000000000001 * var_chaste_interface__membrane__V)) / (exp(2.1200000000000001 + 040000000000000001 * var_chaste_interface__membrane__V) + exp(4.2400000000000002 + 080000000000000002 * var_chaste_interface__membrane__V)) - 100 * (3.0000000000000001e-5 + 040000000000000001 * pow(var_chaste_interface__sodium_current_m_gate__m, 3) * var_chaste_interface__sodium_current_h_gate__h * var_chaste_interface__sodium_current_j_gate__j) * (-50 + var_chaste_interface__membrane__V) - 089999999999999997 * (-7.6990712032745758 + 13.028700000000001 * log(var_chaste_interface__slow_inward_current__Cai) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f - 0.80000000000000004 * (-1.0 + exp(3.0800000000000001 + 040000000000000001 * var_chaste_interface__membrane__V)) * var_chaste_interface__time_dependent_outward_current_x1_gate__x1 / exp(1.4000000000000001 + 040000000000000001 * var_chaste_interface__membrane__V); // mV / ms
        }
