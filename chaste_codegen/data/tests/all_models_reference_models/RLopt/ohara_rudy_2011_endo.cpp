...
class Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables(const Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables&);
    Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables& operator= (const Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables&);
    Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables> Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt::Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt::~Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
    ...
    void Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_IKr__txrf = _lt_0_row[15]; // millisecond
        const double var_IKr__txrs = _lt_0_row[16]; // millisecond
        ...
        const double var_IKs__txs2 = 1 / (_lt_0_row[19]); // millisecond
        ...
        const double var_INa__hssp = _lt_0_row[23]; // dimensionless
        ...
        const double var_INa__thf = 1 / (_lt_0_row[21]); // millisecond
        ...
        const double var_INaL__mLss = _lt_0_row[29]; // dimensionless
        const double var_INaL__tmL = var_INa__tm; // millisecond
        const double var_Ito__AiF = _lt_0_row[2]; // dimensionless
        const double var_Ito__AiS = 1.0 - var_Ito__AiF; // dimensionless
        const double var_Ito__ass = _lt_0_row[35]; // dimensionless
        const double var_Ito__assp = _lt_0_row[36]; // dimensionless
        ...
        const double var_Ito__tiF_b = _lt_0_row[37]; // millisecond
        ...
        const double var_Ito__tiS_b = _lt_0_row[38]; // millisecond
    ...
    void Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellohara_rudy_2011_endoFromCellMLRushLarsenOpt)
