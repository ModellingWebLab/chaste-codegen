...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_y_gate__y_infinity = _lt_0_row[11] + _lt_0_row[12]; // dimensionless
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = _lt_0_row[14]; // per_ms
        const double var_fast_sodium_current_h_gate__beta_h = _lt_0_row[15]; // per_ms
        const double var_fast_sodium_current_j_gate__alpha_j = _lt_0_row[16]; // per_ms
        const double var_fast_sodium_current_j_gate__beta_j = _lt_0_row[17]; // per_ms
        const double var_fast_sodium_current_m_gate__alpha_m = 0.32000000000000001 * _lt_0_row[19] * (47.130000000000003 + var_chaste_interface__membrane__V); // per_ms
        const double var_fast_sodium_current_m_gate__beta_m = 0.080000000000000002 * _lt_0_row[18]; // per_ms
        ...
        const double var_plateau_potassium_current__Kp = _lt_0_row[8]; // dimensionless
        ...
        const double var_time_dependent_potassium_current_X_gate__alpha_X = 7.1899999999999999e-5 * _lt_0_row[20] * (30.0 + var_chaste_interface__membrane__V); // per_ms
        const double var_time_dependent_potassium_current_X_gate__beta_X = 0.00013100000000000001 * _lt_0_row[21] * (30.0 + var_chaste_interface__membrane__V); // per_ms
        const double var_time_dependent_potassium_current_Xi_gate__Xi = _lt_0_row[7]; // dimensionless
