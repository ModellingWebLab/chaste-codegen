...
// LCOV_EXCL_STOP
        ...
        const double var_intracellular_calcium_concentration__alpha_p = _lt_0_row[14]; // per_second
        const double var_intracellular_calcium_concentration__beta_p = 5.0 / (_lt_0_row[15]); // per_second
        ...
        const double var_time_dependent_potassium_current_x_gate__alpha_x = 0.5 * _lt_0_row[20] / (_lt_0_row[19]); // per_second
        const double var_time_dependent_potassium_current_x_gate__beta_x = 1.3 * _lt_0_row[22] / (_lt_0_row[21]); // per_second
        ...
        const double var_transient_outward_current_s_gate__alpha_s = 0.033000000000000002 * _lt_0_row[23]; // per_second
        const double var_transient_outward_current_s_gate__beta_s = 33.0 / (_lt_0_row[24]); // per_second
