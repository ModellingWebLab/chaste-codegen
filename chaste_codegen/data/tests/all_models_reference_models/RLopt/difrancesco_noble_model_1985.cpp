...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = _lt_0_row[10]; // per_second
        ...
        const double var_hyperpolarising_activated_current_y_gate__alpha_y = 0.050000000000000003 * _lt_0_row[12]; // per_second
        const double var_hyperpolarising_activated_current_y_gate__beta_y = _lt_0_row[13]; // per_second
        const double var_intracellular_calcium_concentration__alpha_p = 0.625 * (34.0 + var_chaste_interface__membrane__V) / (_lt_0_row[15]); // per_second
        const double var_intracellular_calcium_concentration__beta_p = 5.0 / (_lt_0_row[14]); // per_second
        const double var_second_inward_current_d_gate__alpha_d = _lt_0_row[16]; // per_second
        const double var_second_inward_current_d_gate__beta_d = _lt_0_row[17]; // per_second
        ...
        const double var_time_dependent_potassium_current_x_gate__alpha_x = 0.5 * _lt_0_row[19] / (_lt_0_row[18]); // per_second
        const double var_time_dependent_potassium_current_x_gate__beta_x = 1.3 * _lt_0_row[21] / (_lt_0_row[20]); // per_second
        ...
        const double var_transient_outward_current_s_gate__alpha_s = 0.033000000000000002 * _lt_0_row[22]; // per_second
        const double var_transient_outward_current_s_gate__beta_s = 33.0 / (_lt_0_row[23]); // per_second
