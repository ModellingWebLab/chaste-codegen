...
// LCOV_EXCL_STOP
        ...
        const double var_background_Kpl_current__i_Kpl = (3.0 + var_chaste_interface__membrane__Vm) * var_background_Kpl_current__P_Kpl * var_constant_field_equations__CF_K / (_lt_0_row[7]); // picoA
