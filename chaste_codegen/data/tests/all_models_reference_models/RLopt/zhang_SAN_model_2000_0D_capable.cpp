...
// LCOV_EXCL_STOP
        ...
        const double var_T_type_Ca_channel_f_gate__beta_f_T = _lt_0_row[17]; // per_second
        ...
        const double var_four_AP_sensitive_currents_r_gate__tau_r = _lt_0_row[10]; // second
        const double var_hyperpolarisation_activated_current_y_gate__alpha_y = _lt_0_row[11]; // per_second
        ...
        const double var_rapid_delayed_rectifying_potassium_current_P_af_gate__tau_P_af = 1 / (_lt_0_row[20]); // second
        ...
        const double var_rapid_delayed_rectifying_potassium_current_P_as_gate__tau_P_as = 1 / (_lt_0_row[21]); // second
        ...
        const double var_sodium_current_h_gate__tau_h1 = _lt_0_row[26]; // second
        const double var_sodium_current_h_gate__tau_h2 = _lt_0_row[27]; // second
        const double var_sodium_current_m_gate__m_infinity = _lt_0_row[28]; // dimensionless
        const double var_sodium_current_m_gate__tau_m = _lt_0_row[29]; // second
        ...
        else
        {
            ...
            const double var_sodium_potassium_pump__i_p = 1.6000000000000001 * pow(mParameters[4], 2) * pow(mParameters[2], 3) * var_sodium_potassium_pump__i_p_max / ((_lt_0_row[6]) * pow((mParameters[4] + var_sodium_potassium_pump__K_m_K), 2) * pow((mParameters[2] + var_sodium_potassium_pump__K_m_Na), 3)); // nanoA
