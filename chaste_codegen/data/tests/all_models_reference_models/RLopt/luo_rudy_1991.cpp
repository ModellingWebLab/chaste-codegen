...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__V) / (_lt_0_row[3]); // per_millisecond
        const double var_fast_sodium_current_m_gate__beta_m = 0.080000000000000002 * _lt_0_row[2]; // per_millisecond
