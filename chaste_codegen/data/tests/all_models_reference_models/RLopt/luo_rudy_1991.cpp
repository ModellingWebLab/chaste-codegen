...
class Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables(const Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables&);
    Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables&);
    Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables> Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellluo_rudy_1991FromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellluo_rudy_1991FromCellMLRushLarsenOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellluo_rudy_1991FromCellMLRushLarsenOpt::Cellluo_rudy_1991FromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellluo_rudy_1991FromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellluo_rudy_1991FromCellMLRushLarsenOpt::~Cellluo_rudy_1991FromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellluo_rudy_1991FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    
    void Cellluo_rudy_1991FromCellMLRushLarsenOpt::VerifyStateVariables()
    {
    ...
    double Cellluo_rudy_1991FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellluo_rudy_1991FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellluo_rudy_1991FromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -83.853
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = _lt_0_row[2]; // per_millisecond
        const double var_fast_sodium_current_m_gate__beta_m = 0.080000000000000002 * _lt_0_row[3]; // per_millisecond
        ...
        const double var_slow_inward_current_d_gate__alpha_d = 0.095000000000000001 * _lt_0_row[5] / (_lt_0_row[4]); // per_millisecond
        const double var_slow_inward_current_d_gate__beta_d = 0.070000000000000007 * _lt_0_row[7] / (_lt_0_row[6]); // per_millisecond
        ...
        const double var_time_dependent_potassium_current_X_gate__alpha_X = 0.00050000000000000001 * _lt_0_row[13] / (_lt_0_row[12]); // per_millisecond
        const double var_time_dependent_potassium_current_X_gate__beta_X = 0.0012999999999999999 * _lt_0_row[15] / (_lt_0_row[14]); // per_millisecond
    ...
    void Cellluo_rudy_1991FromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
    ...
    std::vector<double> Cellluo_rudy_1991FromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellluo_rudy_1991FromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellluo_rudy_1991FromCellMLRushLarsenOpt)
