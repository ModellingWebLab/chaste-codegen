...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_current_y_gate__y_infinity = 0.20000000000000001 + _lt_0_row[11]; // dimensionless
        const double var_fast_sodium_current_h_gate__alpha_h = _lt_0_row[13]; // per_second
        const double var_fast_sodium_current_h_gate__beta_h = _lt_0_row[14]; // per_second
        const double var_fast_sodium_current_j_gate__alpha_j = _lt_0_row[15]; // per_second
        const double var_fast_sodium_current_j_gate__beta_j = _lt_0_row[16]; // per_second
        ...
        const double var_fast_sodium_current_m_gate__beta_m = 80.0 * _lt_0_row[17]; // per_second
        ...
        const double var_slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks_infinity = _lt_0_row[21]; // dimensionless
        ...
        const double var_transient_outward_potassium_current_X_to1_gate__alpha_X_to1 = 45.159999999999997 * _lt_0_row[23]; // per_second
        const double var_transient_outward_potassium_current_X_to1_gate__beta_X_to1 = 98.900000000000006 * _lt_0_row[24]; // per_second
        const double var_transient_outward_potassium_current_Y_to1_gate__alpha_Y_to1 = 5.415 * _lt_0_row[25] * _lt_0_row[26]; // per_second
        const double var_transient_outward_potassium_current_Y_to1_gate__beta_Y_to1 = 5.415 * _lt_0_row[27] * _lt_0_row[28]; // per_second
        ...
        else
        {
            ...
            const double var_plateau_potassium_current_Kp_gate__Kp_V = _lt_0_row[3]; // dimensionless
            const double var_rapid_activating_delayed_rectifiyer_K_current__R_V = _lt_0_row[4]; // dimensionless
