...
// LCOV_EXCL_STOP
        ...
        const double var_plateau_potassium_current__Kp = _lt_0_row[7]; // dimensionless
        const double var_plateau_potassium_current__g_Kp = 0.0055199999999999997; // milliS_per_microF
        const double var_rapid_delayed_rectifier_potassium_current__Rect = _lt_0_row[8]; // dimensionless
