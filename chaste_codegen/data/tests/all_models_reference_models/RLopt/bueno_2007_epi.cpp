...
class Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    ~Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables()
    {

    }

protected:
    Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables(const Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables&);
    Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables& operator= (const Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables&);
    Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables> mpInstance;

};

std::shared_ptr<Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables> Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellbueno_2007_epiFromCellMLRushLarsenOpt::UseCellMLDefaultStimulus()
    {
    ...
    Cellbueno_2007_epiFromCellMLRushLarsenOpt::Cellbueno_2007_epiFromCellMLRushLarsenOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbueno_2007_epiFromCellMLRushLarsenOpt>::Instance();
        Init();
    ...
    Cellbueno_2007_epiFromCellMLRushLarsenOpt::~Cellbueno_2007_epiFromCellMLRushLarsenOpt()
    {
    }

    AbstractLookupTableCollection* Cellbueno_2007_epiFromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellbueno_2007_epiFromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    
    double Cellbueno_2007_epiFromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbueno_2007_epiFromCellMLRushLarsenOpt::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Cellbueno_2007_epiFromCellMLRushLarsenOpt::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Cellbueno_2007_epiFromCellMLRushLarsenOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellbueno_2007_epiFromCellMLRushLarsenOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbueno_2007_epiFromCellMLRushLarsenOpt)
