...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_model_2009FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double var_Ca_independent_transient_outward_K_current_r_gate__tau_r = 00040000000000000002 + 1.0 / (8.0109999999999992 * exp(-0.1388888888888889 * var_chaste_interface__membrane__V) + 386.60000000000002 * exp(083333333333333329 * var_chaste_interface__membrane__V)); // second
        ...
        const double d_dt_chaste_interface_var_Ca_handling_by_the_SR__F1 = 00081499999999999997 * var_chaste_interface__Ca_handling_by_the_SR__F3 - 001 * (240 * exp(-1.6000000000000001 + 080000000000000002 * var_chaste_interface__membrane__V) + 203.80000000000001 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 4) / pow((00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 4)) * var_chaste_interface__Ca_handling_by_the_SR__F1; // 1 / millisecond
        const double d_dt_chaste_interface_var_Ca_handling_by_the_SR__F2 = 001 * (240 * exp(-1.6000000000000001 + 080000000000000002 * var_chaste_interface__membrane__V) + 203.80000000000001 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 4) / pow((00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 4)) * var_chaste_interface__Ca_handling_by_the_SR__F1 - 001 * (33.960000000000001 + 339.60000000000002 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 4) / pow((00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 4)) * var_chaste_interface__Ca_handling_by_the_SR__F2; // 1 / millisecond
        ...
        const double var_L_type_Ca_channel_d_L_gate__tau_d_L = 1.0 / (4.4800000000000004 * (5.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V)) - 50 * (10 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V)) - 16.719999999999999 * (45.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-18.0 - 0.40000000000000002 * var_chaste_interface__membrane__V))); // second
        ...
        const double var_T_type_Ca_channel_d_T_gate__tau_d_T = 1.0 / (674.173 * exp(0.77666666666666673 + 033333333333333333 * var_chaste_interface__membrane__V) + 674.173 * exp(-0.77666666666666673 - 033333333333333333 * var_chaste_interface__membrane__V)); // second
        const double var_T_type_Ca_channel_f_T_gate__f_T_infinity = 9.6370000000000005 * exp(-0.9003601440576231 - 012004801920768308 * var_chaste_interface__membrane__V) / (9.6370000000000005 * exp(4.876462938881664 + 065019505851755519 * var_chaste_interface__membrane__V) + 9.6370000000000005 * exp(-0.9003601440576231 - 012004801920768308 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_T_type_Ca_channel_f_T_gate__tau_f_T = 1.0 / (9.6370000000000005 * exp(4.876462938881664 + 065019505851755519 * var_chaste_interface__membrane__V) + 9.6370000000000005 * exp(-0.9003601440576231 - 012004801920768308 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_delayed_rectifier_K_current_pa_gate__tau_p_a = 1.0 / (9.0 * exp(03941508020968823 * var_chaste_interface__membrane__V) + 1.3 * exp(-076769537847382163 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_delayed_rectifier_K_current_pi_gate__tau_p_i = 1.0 / (100 * exp(-018299935950224173 * var_chaste_interface__membrane__V) + 656.0 * exp(009420009985210585 * var_chaste_interface__membrane__V)); // second
        const double var_delayed_rectifier_K_current_z_gate__tau_z = 059999999999999998 + 1.0 / (0.29999999999999999 * exp(-045816915605241454 * var_chaste_interface__membrane__V) + 1.6599999999999999 * exp(014398433450440593 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_sodium_current_m_gate__alpha_m = -460 * (44.399999999999999 + var_chaste_interface__membrane__V) / (-1.0 + exp(-3.5035114021936398 - 078907914463820727 * var_chaste_interface__membrane__V)); // per_second
        const double var_sodium_current_m_gate__beta_m = 18400 * exp(-3.5035114021936398 - 078907914463820727 * var_chaste_interface__membrane__V); // per_second
        const double d_dt_chaste_interface_var_cleft_space_ion_concentrations__K_c = 00040627234757013896 + 5.8038906795734136e-6 * var_chaste_interface__membrane__V + 1.0364090499238238e-5 * (-26.53945091048535 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__delayed_rectifier_K_current_z_gate__z + 1.4509726698933535e-5 * (-26.53945091048535 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i + 4.2119663788904208e-5 * pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 3) * (-26.53945091048535 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) / ((1.0 + exp(0.18895643383558949 + 052487898287663745 * var_chaste_interface__membrane__V - 1.393 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i))) * pow((0.58999999999999997 + var_chaste_interface__cleft_space_ion_concentrations__K_c), 3)) + 4.1458020251432836e-5 * (0.40000000000000002 + 0.59999999999999998 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3, 6)) * (0.58999999999999997 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1, 3) + 0.40999999999999998 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2, 3)) * (-26.53945091048535 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r - 00085446536839159674 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c / ((1.0 + var_chaste_interface__cleft_space_ion_concentrations__K_c) * (1.5 + exp(-1.5 - 025000000000000001 * var_chaste_interface__membrane__V)) * (36.4828726939094 + pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5))); // millimolar / millisecond
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__K_i = -8.0609592771852979e-5 - 1.151565611026471e-6 * var_chaste_interface__membrane__V - 2.0563671625472697e-6 * (-26.53945091048535 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__delayed_rectifier_K_current_z_gate__z - 2.8789140275661778e-6 * (-26.53945091048535 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i - 8.3570761485921043e-6 * pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 3) * (-26.53945091048535 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) / ((1.0 + exp(0.18895643383558949 + 052487898287663745 * var_chaste_interface__membrane__V - 1.393 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i))) * pow((0.58999999999999997 + var_chaste_interface__cleft_space_ion_concentrations__K_c), 3)) - 8.2257976689350868e-6 * (0.40000000000000002 + 0.59999999999999998 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3, 6)) * (0.58999999999999997 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1, 3) + 0.40999999999999998 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2, 3)) * (-26.53945091048535 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + 00016953677944277714 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c / ((1.0 + var_chaste_interface__cleft_space_ion_concentrations__K_c) * (1.5 + exp(-1.5 - 025000000000000001 * var_chaste_interface__membrane__V)) * (36.4828726939094 + pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5))); // millimolar / millisecond
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Na_i = 4.3659884291485854e-7 * log(140 / var_chaste_interface__intracellular_ion_concentrations__Na_i) - 1.6450937300378158e-8 * var_chaste_interface__membrane__V - 4.9352811901134478e-8 * (2.5 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * exp(016955889611951675 * var_chaste_interface__membrane__V) - 2744000 * var_chaste_interface__intracellular_ion_concentrations__Ca_i * exp(-02072386508127427 * var_chaste_interface__membrane__V)) / (1.0 + 00074999999999999991 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) + 823.19999999999993 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) - 00025430516916416572 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c / ((1.0 + var_chaste_interface__cleft_space_ion_concentrations__K_c) * (1.5 + exp(-1.5 - 025000000000000001 * var_chaste_interface__membrane__V)) * (36.4828726939094 + pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5))) - 00058612951745018135 * pow(var_chaste_interface__sodium_current_m_gate__m, 3) * (-1.0 + exp(037679754693225945 * var_chaste_interface__membrane__V - 1.0 * log(140 / var_chaste_interface__intracellular_ion_concentrations__Na_i))) * (0.36499999999999999 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.63500000000000001 * var_chaste_interface__sodium_current_h1_gate__h1) * var_chaste_interface__membrane__V / (-1.0 + exp(037679754693225945 * var_chaste_interface__membrane__V)); // millimolar / millisecond
        ...
        {
            d_dt_chaste_interface_var_membrane__V = -001 * (098000000000000004 + 0014400000000000001 * var_chaste_interface__membrane__V - 0002653945091048535 * log(2.5 / var_chaste_interface__intracellular_ion_concentrations__Ca_i) - 00053078901820970701 * log(140 / var_chaste_interface__intracellular_ion_concentrations__Na_i) + 0095090000000000001 * var_chaste_interface__intracellular_ion_concentrations__Ca_i / (00020000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i) + 0025000000000000001 * (-26.53945091048535 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__delayed_rectifier_K_current_z_gate__z + 2.0000000000000002e-5 * (2.5 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * exp(016955889611951675 * var_chaste_interface__membrane__V) - 2744000 * var_chaste_interface__intracellular_ion_concentrations__Ca_i * exp(-02072386508127427 * var_chaste_interface__membrane__V)) / (1.0 + 00074999999999999991 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) + 823.19999999999993 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) + 0072000000000000007 * (-50 + var_chaste_interface__membrane__V) * (1.0 / (1.0 + exp(1.9166666666666667 - 083333333333333329 * var_chaste_interface__membrane__V)) + var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L * var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L) + 0060000000000000001 * (-38.0 + var_chaste_interface__membrane__V) * var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T * var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T + 0035000000000000001 * (-26.53945091048535 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i + 1000000000000001 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) * mParameters[0] / HeartConfig::Instance()->GetCapacitance() + 010160000000000001 * pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 3) * (-26.53945091048535 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) / ((1.0 + exp(0.18895643383558949 + 052487898287663745 * var_chaste_interface__membrane__V - 1.393 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i))) * pow((0.58999999999999997 + var_chaste_interface__cleft_space_ion_concentrations__K_c), 3)) + 0100004 * (0.40000000000000002 + 0.59999999999999998 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3, 6)) * (0.58999999999999997 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1, 3) + 0.40999999999999998 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2, 3)) * (-26.53945091048535 * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + 0.71257887225271721 * pow(var_chaste_interface__sodium_current_m_gate__m, 3) * (-1.0 + exp(037679754693225945 * var_chaste_interface__membrane__V - 1.0 * log(140 / var_chaste_interface__intracellular_ion_concentrations__Na_i))) * (0.36499999999999999 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.63500000000000001 * var_chaste_interface__sodium_current_h1_gate__h1) * var_chaste_interface__membrane__V / (-1.0 + exp(037679754693225945 * var_chaste_interface__membrane__V)) + 0.10305599999999999 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c / ((1.0 + var_chaste_interface__cleft_space_ion_concentrations__K_c) * (1.5 + exp(-1.5 - 025000000000000001 * var_chaste_interface__membrane__V)) * (36.4828726939094 + pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5)))) / mParameters[0]; // millivolt / millisecond
        }
