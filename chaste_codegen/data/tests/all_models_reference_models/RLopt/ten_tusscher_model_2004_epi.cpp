...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_h_gate__h_inf = _lt_0_row[11]; // dimensionless
        ...
        const double var_fast_sodium_current_j_gate__j_inf = _lt_0_row[11]; // dimensionless
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = 1 / (_lt_0_row[16]); // dimensionless
        ...
        const double var_fast_sodium_current_m_gate__m_inf = _lt_0_row[14]; // dimensionless
        ...
        const double var_rapid_time_dependent_potassium_current_Xr1_gate__alpha_xr1 = 450.0 / (_lt_0_row[19]); // dimensionless
        const double var_rapid_time_dependent_potassium_current_Xr1_gate__beta_xr1 = 6.0 / (_lt_0_row[18]); // dimensionless
        ...
        const double var_rapid_time_dependent_potassium_current_Xr1_gate__xr1_inf = _lt_0_row[17]; // dimensionless
        const double var_rapid_time_dependent_potassium_current_Xr2_gate__alpha_xr2 = 3.0 / (_lt_0_row[22]); // dimensionless
        const double var_rapid_time_dependent_potassium_current_Xr2_gate__beta_xr2 = 1.1200000000000001 / (_lt_0_row[21]); // dimensionless
        ...
        const double var_rapid_time_dependent_potassium_current_Xr2_gate__xr2_inf = _lt_0_row[20]; // dimensionless
        const double var_slow_time_dependent_potassium_current_Xs_gate__alpha_xs = 1100.0 / _lt_0_row[24]; // dimensionless
        const double var_slow_time_dependent_potassium_current_Xs_gate__beta_xs = 1 / (_lt_0_row[21]); // dimensionless
        ...
        const double var_slow_time_dependent_potassium_current_Xs_gate__xs_inf = _lt_0_row[23]; // dimensionless
        ...
        const double var_transient_outward_current_r_gate__r_inf = _lt_0_row[25]; // dimensionless
