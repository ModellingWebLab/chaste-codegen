...
class Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables(const Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables&);
    Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables& operator= (const Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables&);
    Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables> Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellluo_rudy_1994FromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    ...
    double Cellluo_rudy_1994FromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellluo_rudy_1994FromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = _lt_0_row[15]; // per_ms
        const double var_fast_sodium_current_h_gate__beta_h = _lt_0_row[16]; // per_ms
        const double var_fast_sodium_current_j_gate__alpha_j = _lt_0_row[17]; // per_ms
        const double var_fast_sodium_current_j_gate__beta_j = _lt_0_row[18]; // per_ms
        const double var_fast_sodium_current_m_gate__alpha_m = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__V) / (_lt_0_row[20]); // per_ms
        ...
        const double var_time_dependent_potassium_current_X_gate__alpha_X = 7.1899999999999999e-5 * (30.0 + var_chaste_interface__membrane__V) / (_lt_0_row[21]); // per_ms
        const double var_time_dependent_potassium_current_X_gate__beta_X = 0.00013100000000000001 * (30.0 + var_chaste_interface__membrane__V) / (_lt_0_row[22]); // per_ms
