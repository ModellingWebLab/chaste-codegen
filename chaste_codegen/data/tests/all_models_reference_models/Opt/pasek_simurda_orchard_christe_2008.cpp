...
class Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__Vm_s__Vm_s)
    {
        ...
        const double* const _lt_0_row = Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables(const Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables&);
    Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables& operator= (const Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables&);
    Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables()
    {
        ...
        Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables> Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellpasek_simurda_orchard_christe_2008FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpasek_simurda_orchard_christe_2008FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellpasek_simurda_orchard_christe_2008FromCellMLOpt::Cellpasek_simurda_orchard_christe_2008FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                55,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpasek_simurda_orchard_christe_2008FromCellMLOpt>::Instance();
        Init();
    ...
    Cellpasek_simurda_orchard_christe_2008FromCellMLOpt::~Cellpasek_simurda_orchard_christe_2008FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellpasek_simurda_orchard_christe_2008FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellpasek_simurda_orchard_christe_2008FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__Vm_s__Vm_s);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellpasek_simurda_orchard_christe_2008FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__Vm_s__Vm_s);
    ...
    void Cellpasek_simurda_orchard_christe_2008FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Vm_s__Vm_s = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Cellpasek_simurda_orchard_christe_2008FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Vm_s__Vm_s = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellpasek_simurda_orchard_christe_2008FromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpasek_simurda_orchard_christe_2008FromCellMLOpt)
