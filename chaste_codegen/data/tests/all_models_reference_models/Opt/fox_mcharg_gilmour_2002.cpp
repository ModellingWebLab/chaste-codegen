...
class Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables(const Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables&);
    Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables& operator= (const Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables&);
    Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables()
    {
        ...
        Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables> Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellfox_mcharg_gilmour_2002FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellfox_mcharg_gilmour_2002FromCellMLOpt::Cellfox_mcharg_gilmour_2002FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                13,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellfox_mcharg_gilmour_2002FromCellMLOpt>::Instance();
        Init();
    ...
    Cellfox_mcharg_gilmour_2002FromCellMLOpt::~Cellfox_mcharg_gilmour_2002FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellfox_mcharg_gilmour_2002FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellfox_mcharg_gilmour_2002FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellfox_mcharg_gilmour_2002FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
        ...
        const double var_L_type_Ca_current__i_Ca_max = ((fabs(var_chaste_interface__membrane__V) < 1.3354093264248706e-6) ? (-374417.03461708582 * (-1.3354093264248706e-6 + var_chaste_interface__membrane__V) * (-1.9300000000000002e-5 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(1.0000000000000001e-7)) * mParameters[8] / (-1.0 + exp(1.0000000000000001e-7)) - 1.9300000000000002e-5 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(-1.0000000000000001e-7)) * mParameters[8] / (-1.0 + exp(-1.0000000000000001e-7))) + 1.9300000000000002e-5 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(1.0000000000000001e-7)) * mParameters[8] / (-1.0 + exp(1.0000000000000001e-7))) : (14.452497536219512 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * _lt_0_row[0]) * mParameters[8] * var_chaste_interface__membrane__V / (_lt_0_row[1]))); // microA_per_microF
    ...
    void Cellfox_mcharg_gilmour_2002FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Cellfox_mcharg_gilmour_2002FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellfox_mcharg_gilmour_2002FromCellMLOpt>::Initialise(void)
{
