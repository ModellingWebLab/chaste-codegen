...
class Celliyer_model_2004FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celliyer_model_2004FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celliyer_model_2004FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V)
    {
        ...
        const double* const _lt_0_row = Celliyer_model_2004FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celliyer_model_2004FromCellMLOpt_LookupTables()
    {
...
protected:
    Celliyer_model_2004FromCellMLOpt_LookupTables(const Celliyer_model_2004FromCellMLOpt_LookupTables&);
    Celliyer_model_2004FromCellMLOpt_LookupTables& operator= (const Celliyer_model_2004FromCellMLOpt_LookupTables&);
    Celliyer_model_2004FromCellMLOpt_LookupTables()
    {
        ...
        Celliyer_model_2004FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celliyer_model_2004FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celliyer_model_2004FromCellMLOpt_LookupTables> Celliyer_model_2004FromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Celliyer_model_2004FromCellMLOpt::GetLookupTableCollection()
    {
        return Celliyer_model_2004FromCellMLOpt_LookupTables::Instance();
    }
    ...
    void Celliyer_model_2004FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const bool _oob_0 = Celliyer_model_2004FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY , var_chaste_interface__environment__time));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliyer_model_2004FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
