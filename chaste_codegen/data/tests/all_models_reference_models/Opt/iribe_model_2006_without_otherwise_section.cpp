...
class Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane_potential__V)
    {
        ...
        const double* const _lt_0_row = Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables()
    {
...
protected:
    Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables(const Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables&);
    Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables& operator= (const Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables&);
    Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables()
    {
        ...
        Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables> Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt::GetLookupTableCollection()
    {
        return Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane_potential__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliribe_model_2006_without_otherwise_sectionFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane_potential__V);
