...
class Cellnoble_model_1998FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellnoble_model_1998FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellnoble_model_1998FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellnoble_model_1998FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellnoble_model_1998FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellnoble_model_1998FromCellMLOpt_LookupTables(const Cellnoble_model_1998FromCellMLOpt_LookupTables&);
    Cellnoble_model_1998FromCellMLOpt_LookupTables& operator= (const Cellnoble_model_1998FromCellMLOpt_LookupTables&);
    Cellnoble_model_1998FromCellMLOpt_LookupTables()
    {
        ...
        Cellnoble_model_1998FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellnoble_model_1998FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellnoble_model_1998FromCellMLOpt_LookupTables> Cellnoble_model_1998FromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellnoble_model_1998FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellnoble_model_1998FromCellMLOpt_LookupTables::Instance();
    }
    
    
    void Cellnoble_model_1998FromCellMLOpt::VerifyStateVariables()
    {
    ...
    double Cellnoble_model_1998FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellnoble_model_1998FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellnoble_model_1998FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
