...
private:
    ...
    static std::shared_ptr<Cellohara_rudy_2011_endoFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellohara_rudy_2011_endoFromCellMLOpt_LookupTables> Cellohara_rudy_2011_endoFromCellMLOpt_LookupTables::mpInstance;
