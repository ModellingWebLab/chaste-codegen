...
class Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables(const Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables&);
    Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables& operator= (const Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables&);
    Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables()
    {
        ...
        Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables> Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellcourtemanche_ramirez_nattel_model_1998FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
