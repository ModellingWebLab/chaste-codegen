...
class Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables(const Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables&);
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables& operator= (const Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables&);
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables()
    {
        ...
        Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables> Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt::Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                45,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt>::Instance();
        Init();
    ...
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt::~Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellshannon_wang_puglisi_weber_bers_2004FromCellMLOpt>::Initialise(void)
{
