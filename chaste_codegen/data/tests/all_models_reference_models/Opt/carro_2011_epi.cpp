...
class Cellcarro_2011_epiFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellcarro_2011_epiFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellcarro_2011_epiFromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellcarro_2011_epiFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellcarro_2011_epiFromCellMLOpt_LookupTables()
    {
...
protected:
    Cellcarro_2011_epiFromCellMLOpt_LookupTables(const Cellcarro_2011_epiFromCellMLOpt_LookupTables&);
    Cellcarro_2011_epiFromCellMLOpt_LookupTables& operator= (const Cellcarro_2011_epiFromCellMLOpt_LookupTables&);
    Cellcarro_2011_epiFromCellMLOpt_LookupTables()
    {
        ...
        Cellcarro_2011_epiFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellcarro_2011_epiFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellcarro_2011_epiFromCellMLOpt_LookupTables> Cellcarro_2011_epiFromCellMLOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellcarro_2011_epiFromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellcarro_2011_epiFromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellcarro_2011_epiFromCellMLOpt::Cellcarro_2011_epiFromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                39,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellcarro_2011_epiFromCellMLOpt>::Instance();
        Init();
    ...
    Cellcarro_2011_epiFromCellMLOpt::~Cellcarro_2011_epiFromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellcarro_2011_epiFromCellMLOpt::GetLookupTableCollection()
    {
        return Cellcarro_2011_epiFromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellcarro_2011_epiFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellcarro_2011_epiFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellcarro_2011_epiFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellcarro_2011_epiFromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__t, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Cellcarro_2011_epiFromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__t, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellcarro_2011_epiFromCellMLOpt>::Initialise(void)
{
