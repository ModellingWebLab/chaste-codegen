...
class Cellhund_rudy_2004FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellhund_rudy_2004FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellhund_rudy_2004FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellhund_rudy_2004FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellhund_rudy_2004FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellhund_rudy_2004FromCellMLOpt_LookupTables(const Cellhund_rudy_2004FromCellMLOpt_LookupTables&);
    Cellhund_rudy_2004FromCellMLOpt_LookupTables& operator= (const Cellhund_rudy_2004FromCellMLOpt_LookupTables&);
    Cellhund_rudy_2004FromCellMLOpt_LookupTables()
    {
        ...
        Cellhund_rudy_2004FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellhund_rudy_2004FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellhund_rudy_2004FromCellMLOpt_LookupTables> Cellhund_rudy_2004FromCellMLOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellhund_rudy_2004FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellhund_rudy_2004FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellhund_rudy_2004FromCellMLOpt::Cellhund_rudy_2004FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                29,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellhund_rudy_2004FromCellMLOpt>::Instance();
        Init();
    ...
    Cellhund_rudy_2004FromCellMLOpt::~Cellhund_rudy_2004FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellhund_rudy_2004FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellhund_rudy_2004FromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellhund_rudy_2004FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellhund_rudy_2004FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellhund_rudy_2004FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellhund_rudy_2004FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Cellhund_rudy_2004FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellhund_rudy_2004FromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellhund_rudy_2004FromCellMLOpt)
