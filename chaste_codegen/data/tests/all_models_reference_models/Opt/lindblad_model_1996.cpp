...
class Celllindblad_model_1996FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celllindblad_model_1996FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celllindblad_model_1996FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Celllindblad_model_1996FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celllindblad_model_1996FromCellMLOpt_LookupTables()
    {
...
protected:
    Celllindblad_model_1996FromCellMLOpt_LookupTables(const Celllindblad_model_1996FromCellMLOpt_LookupTables&);
    Celllindblad_model_1996FromCellMLOpt_LookupTables& operator= (const Celllindblad_model_1996FromCellMLOpt_LookupTables&);
    Celllindblad_model_1996FromCellMLOpt_LookupTables()
    {
        ...
        Celllindblad_model_1996FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celllindblad_model_1996FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celllindblad_model_1996FromCellMLOpt_LookupTables> Celllindblad_model_1996FromCellMLOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Celllindblad_model_1996FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Celllindblad_model_1996FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celllindblad_model_1996FromCellMLOpt::Celllindblad_model_1996FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                28,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celllindblad_model_1996FromCellMLOpt>::Instance();
        Init();
    ...
    Celllindblad_model_1996FromCellMLOpt::~Celllindblad_model_1996FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Celllindblad_model_1996FromCellMLOpt::GetLookupTableCollection()
    {
        return Celllindblad_model_1996FromCellMLOpt_LookupTables::Instance();
    }
    
    double Celllindblad_model_1996FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celllindblad_model_1996FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celllindblad_model_1996FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Celllindblad_model_1996FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Celllindblad_model_1996FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celllindblad_model_1996FromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celllindblad_model_1996FromCellMLOpt)
