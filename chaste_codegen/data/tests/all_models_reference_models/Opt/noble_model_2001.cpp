...
class Cellnoble_model_2001FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellnoble_model_2001FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellnoble_model_2001FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellnoble_model_2001FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellnoble_model_2001FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellnoble_model_2001FromCellMLOpt_LookupTables(const Cellnoble_model_2001FromCellMLOpt_LookupTables&);
    Cellnoble_model_2001FromCellMLOpt_LookupTables& operator= (const Cellnoble_model_2001FromCellMLOpt_LookupTables&);
    Cellnoble_model_2001FromCellMLOpt_LookupTables()
    {
        ...
        Cellnoble_model_2001FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellnoble_model_2001FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellnoble_model_2001FromCellMLOpt_LookupTables> Cellnoble_model_2001FromCellMLOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellnoble_model_2001FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellnoble_model_2001FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellnoble_model_2001FromCellMLOpt::Cellnoble_model_2001FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                20,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnoble_model_2001FromCellMLOpt>::Instance();
        Init();
    ...
    Cellnoble_model_2001FromCellMLOpt::~Cellnoble_model_2001FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellnoble_model_2001FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellnoble_model_2001FromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellnoble_model_2001FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellnoble_model_2001FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellnoble_model_2001FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellnoble_model_2001FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Cellnoble_model_2001FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellnoble_model_2001FromCellMLOpt>::Initialise(void)
{
