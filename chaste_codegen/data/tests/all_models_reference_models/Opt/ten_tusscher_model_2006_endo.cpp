...
class Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables()
    {
...
protected:
    Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables(const Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables&);
    Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables& operator= (const Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables&);
    Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables()
    {
        ...
        Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables> Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2006_endoFromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2006_endoFromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellten_tusscher_model_2006_endoFromCellMLOpt::Cellten_tusscher_model_2006_endoFromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                19,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2006_endoFromCellMLOpt>::Instance();
        Init();
    ...
    Cellten_tusscher_model_2006_endoFromCellMLOpt::~Cellten_tusscher_model_2006_endoFromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellten_tusscher_model_2006_endoFromCellMLOpt::GetLookupTableCollection()
    {
        return Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables::Instance();
    }
    
    
    void Cellten_tusscher_model_2006_endoFromCellMLOpt::VerifyStateVariables()
    {
    ...
    double Cellten_tusscher_model_2006_endoFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2006_endoFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellten_tusscher_model_2006_endoFromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Cellten_tusscher_model_2006_endoFromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2006_endoFromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellten_tusscher_model_2006_endoFromCellMLOpt)
