...
class CellShannon2004FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellShannon2004FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellShannon2004FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = CellShannon2004FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellShannon2004FromCellMLOpt_LookupTables()
    {
...
protected:
    CellShannon2004FromCellMLOpt_LookupTables(const CellShannon2004FromCellMLOpt_LookupTables&);
    CellShannon2004FromCellMLOpt_LookupTables& operator= (const CellShannon2004FromCellMLOpt_LookupTables&);
    CellShannon2004FromCellMLOpt_LookupTables()
    {
        ...
        CellShannon2004FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellShannon2004FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellShannon2004FromCellMLOpt_LookupTables> CellShannon2004FromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* CellShannon2004FromCellMLOpt::GetLookupTableCollection()
    {
        return CellShannon2004FromCellMLOpt_LookupTables::Instance();
    }
    ...
    double CellShannon2004FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellShannon2004FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellShannon2004FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
