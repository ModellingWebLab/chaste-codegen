...
class Cellwang_sobie_2008FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellwang_sobie_2008FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellwang_sobie_2008FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellwang_sobie_2008FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellwang_sobie_2008FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellwang_sobie_2008FromCellMLOpt_LookupTables(const Cellwang_sobie_2008FromCellMLOpt_LookupTables&);
    Cellwang_sobie_2008FromCellMLOpt_LookupTables& operator= (const Cellwang_sobie_2008FromCellMLOpt_LookupTables&);
    Cellwang_sobie_2008FromCellMLOpt_LookupTables()
    {
        ...
        Cellwang_sobie_2008FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellwang_sobie_2008FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellwang_sobie_2008FromCellMLOpt_LookupTables> Cellwang_sobie_2008FromCellMLOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellwang_sobie_2008FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellwang_sobie_2008FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellwang_sobie_2008FromCellMLOpt::Cellwang_sobie_2008FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                35,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellwang_sobie_2008FromCellMLOpt>::Instance();
        Init();
    ...
    Cellwang_sobie_2008FromCellMLOpt::~Cellwang_sobie_2008FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellwang_sobie_2008FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellwang_sobie_2008FromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellwang_sobie_2008FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellwang_sobie_2008FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellwang_sobie_2008FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
        ...
        const double var_calcium_activated_chloride_current__i_ClCa = 1.02986169524034e-6 * pow((var_chaste_interface__calcium_concentration__Cass / (4.0 + var_chaste_interface__calcium_concentration__Cass)), 3.0) * (-mParameters[0] + mParameters[2] * _lt_0_row[0]) * var_chaste_interface__membrane__V / (_lt_0_row[1]); // picoA_per_picoF
    ...
    void Cellwang_sobie_2008FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        rDY[18] = d_dt_chaste_interface_var_T_type_calcium_current_b_gate__b;
        rDY[19] = d_dt_chaste_interface_var_T_type_calcium_current_g_gate__g;
        rDY[20] = d_dt_chaste_interface_var_sodium_concentration__Nai;
        rDY[21] = d_dt_chaste_interface_var_fast_sodium_current_m_gate__m;
        rDY[22] = d_dt_chaste_interface_var_fast_sodium_current_h_gate__h;
        rDY[23] = d_dt_chaste_interface_var_fast_sodium_current_j_gate__j;
        rDY[24] = d_dt_chaste_interface_var_potassium_concentration__Ki;
        rDY[25] = d_dt_chaste_interface_var_fast_transient_outward_potassium_current__ato_f;
        rDY[26] = d_dt_chaste_interface_var_fast_transient_outward_potassium_current__ito_f;
        rDY[27] = d_dt_chaste_interface_var_ultra_rapidly_activating_delayed_rectifier_potassium_current__aur;
        rDY[28] = d_dt_chaste_interface_var_ultra_rapidly_activating_delayed_rectifier_potassium_current__iur;
        rDY[29] = d_dt_chaste_interface_var_non_inactivating_steady_state_potassium_current__aKss;
        rDY[30] = d_dt_chaste_interface_var_slow_delayed_rectifier_potassium_current__nKs;
    ...
    std::vector<double> Cellwang_sobie_2008FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellwang_sobie_2008FromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellwang_sobie_2008FromCellMLOpt)
