...
class Cellbueno_2007_epiFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbueno_2007_epiFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbueno_2007_epiFromCellMLOpt_LookupTables);
        }
    ...
    ~Cellbueno_2007_epiFromCellMLOpt_LookupTables()
    {

    }

protected:
    Cellbueno_2007_epiFromCellMLOpt_LookupTables(const Cellbueno_2007_epiFromCellMLOpt_LookupTables&);
    Cellbueno_2007_epiFromCellMLOpt_LookupTables& operator= (const Cellbueno_2007_epiFromCellMLOpt_LookupTables&);
    Cellbueno_2007_epiFromCellMLOpt_LookupTables()
    {
        ...
        Cellbueno_2007_epiFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbueno_2007_epiFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellbueno_2007_epiFromCellMLOpt_LookupTables> Cellbueno_2007_epiFromCellMLOpt_LookupTables::mpInstance;
    ...
    Cellbueno_2007_epiFromCellMLOpt::Cellbueno_2007_epiFromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                4,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbueno_2007_epiFromCellMLOpt>::Instance();
        Init();
    ...
    Cellbueno_2007_epiFromCellMLOpt::~Cellbueno_2007_epiFromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellbueno_2007_epiFromCellMLOpt::GetLookupTableCollection()
    {
        return Cellbueno_2007_epiFromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellbueno_2007_epiFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbueno_2007_epiFromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellbueno_2007_epiFromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellbueno_2007_epiFromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbueno_2007_epiFromCellMLOpt)
