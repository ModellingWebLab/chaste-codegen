...
class Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables()
    {
...
protected:
    Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables(const Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables&);
    Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables& operator= (const Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables&);
    Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables()
    {
        ...
        Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables> Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellbondarenko_model_2004_apexFromCellMLOpt::GetLookupTableCollection()
    {
        return Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Cellbondarenko_model_2004_apexFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbondarenko_model_2004_apexFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
