...
class Cellpandit_model_2001_epiFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellpandit_model_2001_epiFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellpandit_model_2001_epiFromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellpandit_model_2001_epiFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellpandit_model_2001_epiFromCellMLOpt_LookupTables()
    {
...
protected:
    Cellpandit_model_2001_epiFromCellMLOpt_LookupTables(const Cellpandit_model_2001_epiFromCellMLOpt_LookupTables&);
    Cellpandit_model_2001_epiFromCellMLOpt_LookupTables& operator= (const Cellpandit_model_2001_epiFromCellMLOpt_LookupTables&);
    Cellpandit_model_2001_epiFromCellMLOpt_LookupTables()
    {
        ...
        Cellpandit_model_2001_epiFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellpandit_model_2001_epiFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellpandit_model_2001_epiFromCellMLOpt_LookupTables> Cellpandit_model_2001_epiFromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellpandit_model_2001_epiFromCellMLOpt::GetLookupTableCollection()
    {
        return Cellpandit_model_2001_epiFromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Cellpandit_model_2001_epiFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellpandit_model_2001_epiFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellpandit_model_2001_epiFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
