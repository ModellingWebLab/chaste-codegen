...
class Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables(const Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables&);
    Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables& operator= (const Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables&);
    Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables()
    {
        ...
        Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables> Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellpriebe_beuckelmann_model_1998FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellpriebe_beuckelmann_model_1998FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
