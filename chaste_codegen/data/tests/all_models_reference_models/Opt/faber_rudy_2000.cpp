...
class Cellfaber_rudy_2000FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellfaber_rudy_2000FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellfaber_rudy_2000FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellfaber_rudy_2000FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellfaber_rudy_2000FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellfaber_rudy_2000FromCellMLOpt_LookupTables(const Cellfaber_rudy_2000FromCellMLOpt_LookupTables&);
    Cellfaber_rudy_2000FromCellMLOpt_LookupTables& operator= (const Cellfaber_rudy_2000FromCellMLOpt_LookupTables&);
    Cellfaber_rudy_2000FromCellMLOpt_LookupTables()
    {
        ...
        Cellfaber_rudy_2000FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellfaber_rudy_2000FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellfaber_rudy_2000FromCellMLOpt_LookupTables> Cellfaber_rudy_2000FromCellMLOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellfaber_rudy_2000FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellfaber_rudy_2000FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellfaber_rudy_2000FromCellMLOpt::Cellfaber_rudy_2000FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                25,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellfaber_rudy_2000FromCellMLOpt>::Instance();
        Init();
    ...
    Cellfaber_rudy_2000FromCellMLOpt::~Cellfaber_rudy_2000FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellfaber_rudy_2000FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellfaber_rudy_2000FromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellfaber_rudy_2000FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellfaber_rudy_2000FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellfaber_rudy_2000FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellfaber_rudy_2000FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Cellfaber_rudy_2000FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellfaber_rudy_2000FromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellfaber_rudy_2000FromCellMLOpt)
