...
class Cellli_mouse_2010FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellli_mouse_2010FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellli_mouse_2010FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellli_mouse_2010FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellli_mouse_2010FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellli_mouse_2010FromCellMLOpt_LookupTables(const Cellli_mouse_2010FromCellMLOpt_LookupTables&);
    Cellli_mouse_2010FromCellMLOpt_LookupTables& operator= (const Cellli_mouse_2010FromCellMLOpt_LookupTables&);
    Cellli_mouse_2010FromCellMLOpt_LookupTables()
    {
        ...
        Cellli_mouse_2010FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellli_mouse_2010FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellli_mouse_2010FromCellMLOpt_LookupTables> Cellli_mouse_2010FromCellMLOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellli_mouse_2010FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellli_mouse_2010FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellli_mouse_2010FromCellMLOpt::Cellli_mouse_2010FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                36,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellli_mouse_2010FromCellMLOpt>::Instance();
        Init();
    ...
    Cellli_mouse_2010FromCellMLOpt::~Cellli_mouse_2010FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellli_mouse_2010FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellli_mouse_2010FromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellli_mouse_2010FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellli_mouse_2010FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellli_mouse_2010FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellli_mouse_2010FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        rDY[12] = d_dt_chaste_interface_var_L_type_calcium_current__y_gate;
        ...
        rDY[23] = d_dt_chaste_interface_var_ultra_rapidly_activating_delayed_rectifier_K_I__aur;
        rDY[24] = d_dt_chaste_interface_var_ultra_rapidly_activating_delayed_rectifier_K_I__iur;
        rDY[25] = d_dt_chaste_interface_var_non_inactivating_steady_state_K_I__aKss;
        ...
        rDY[31] = d_dt_chaste_interface_var_slow_delayed_rectifier_K_I__nKs;
        rDY[32] = d_dt_chaste_interface_var_fast_transient_outward_K_I__ato_f;
        rDY[33] = d_dt_chaste_interface_var_fast_transient_outward_K_I__ito_f;
        rDY[34] = d_dt_chaste_interface_var_slow_transient_outward_K_I__ato_s;
        rDY[35] = d_dt_chaste_interface_var_slow_transient_outward_K_I__ito_s;
    }

    std::vector<double> Cellli_mouse_2010FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellli_mouse_2010FromCellMLOpt>::Initialise(void)
{
