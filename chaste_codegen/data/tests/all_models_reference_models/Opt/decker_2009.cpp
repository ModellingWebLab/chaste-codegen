...
#include "MathsCustomFunctions.hpp"
    ...
    double Celldecker_2009FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_INaCa__INaCa = (6.4800000000000004 * pow(var_chaste_interface__Na__Na_i, 3.0) * exp(0.010107898065447322 * var_chaste_interface__membrane__Vm) - 9878400.0 * var_chaste_interface__Ca__Ca_i * exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm)) / ((1.0 + 0.32000000000000001 * exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm)) * (1.0 + 1.5624999999999999e-8 * pow(1 / var_chaste_interface__Ca__Ca_i, 2.0)) * (13227.9606 + 4344355.375 * var_chaste_interface__Ca__Ca_i + 8.4084932990912282 * pow(var_chaste_interface__Na__Na_i, 3.0))); // uA_per_uF
        const double var_INaCa__INaCa_ss_sr = (1.6200000000000001 * pow(var_chaste_interface__Na__Na_ss_sr, 3.0) * exp(0.010107898065447322 * var_chaste_interface__membrane__Vm) - 2469600.0 * var_chaste_interface__Ca__Ca_ss_sr * exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm)) / ((1.0 + 0.32000000000000001 * exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm)) * (1.0 + 1.5624999999999999e-8 * pow(1 / var_chaste_interface__Ca__Ca_ss_sr, 2.0)) * (13227.9606 + 4344355.375 * var_chaste_interface__Ca__Ca_ss_sr + 8.4084932990912282 * pow(var_chaste_interface__Na__Na_ss_sr, 3.0))); // uA_per_uF
        const double var_INaK__INaK = 1.0956521739130434 * pow((var_chaste_interface__Na__Na_i / (2.6000000000000001 + var_chaste_interface__Na__Na_i)), 3.0) / (1.0 + exp(-3.4441726741524206 - 0.037436659501656748 * var_chaste_interface__membrane__Vm)); // uA_per_uF
        ...
        const double var_membrane__naiont = 3.0 * var_INaCa__INaCa + 3.0 * var_INaCa__INaCa_ss_sr + 3.0 * var_INaK__INaK + 0.0064999999999999997 * pow(var_chaste_interface__INaL_mL_gate__mL, 3.0) * (-var_reversal_potentials__ENa + var_chaste_interface__membrane__Vm) * var_chaste_interface__INaL_hL_gate__hL + 1.1558883089076335e-5 * (-140.0 + var_chaste_interface__Na__Na_i * exp(0.037436659501656748 * var_chaste_interface__membrane__Vm)) * var_chaste_interface__membrane__Vm / (-1.0 + exp(0.037436659501656748 * var_chaste_interface__membrane__Vm)) + 9.0749999999999993 * pow(var_chaste_interface__INa_m_gate__m, 3.0) * (-var_reversal_potentials__ENa + var_chaste_interface__membrane__Vm) * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j; // uA_per_uF
    ...
    void Celldecker_2009FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_Ca__Ca_JSR = 1.0 * (-var_chaste_interface__Irel__Irel + var_Itr__Itr) / (1.0 + 8.0 * pow((0.80000000000000004 + var_chaste_interface__Ca__Ca_JSR), (-2.0))); // mM / ms
        ...
        const double var_reversal_potentials__ENa = 26.711785007306684 * log(140.0 / var_chaste_interface__Na__Na_i); // mV
        const double var_CT_Na_Cl__CT_Na_Cl = 2.4610800000000002e-5 * pow((-var_reversal_potentials__ECl + var_reversal_potentials__ENa), 4.0) / (59494197.640692554 + pow((-var_reversal_potentials__ECl + var_reversal_potentials__ENa), 4.0)); // mM_per_ms
        ...
        const double var_INa__INa = 9.0749999999999993 * pow(var_chaste_interface__INa_m_gate__m, 3.0) * (-var_reversal_potentials__ENa + var_chaste_interface__membrane__Vm) * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j; // uA_per_uF
        const double var_INaL__INaL = 0.0064999999999999997 * pow(var_chaste_interface__INaL_mL_gate__mL, 3.0) * (-var_reversal_potentials__ENa + var_chaste_interface__membrane__Vm) * var_chaste_interface__INaL_hL_gate__hL; // uA_per_uF
