...
class Celliyer_2004FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celliyer_2004FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celliyer_2004FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V)
    {
        ...
        const double* const _lt_0_row = Celliyer_2004FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celliyer_2004FromCellMLOpt_LookupTables()
    {
...
protected:
    Celliyer_2004FromCellMLOpt_LookupTables(const Celliyer_2004FromCellMLOpt_LookupTables&);
    Celliyer_2004FromCellMLOpt_LookupTables& operator= (const Celliyer_2004FromCellMLOpt_LookupTables&);
    Celliyer_2004FromCellMLOpt_LookupTables()
    {
        ...
        Celliyer_2004FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celliyer_2004FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celliyer_2004FromCellMLOpt_LookupTables> Celliyer_2004FromCellMLOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Celliyer_2004FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Celliyer_2004FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celliyer_2004FromCellMLOpt::Celliyer_2004FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                67,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celliyer_2004FromCellMLOpt>::Instance();
        Init();
    ...
    Celliyer_2004FromCellMLOpt::~Celliyer_2004FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Celliyer_2004FromCellMLOpt::GetLookupTableCollection()
    {
        return Celliyer_2004FromCellMLOpt_LookupTables::Instance();
    }
    
    double Celliyer_2004FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celliyer_2004FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliyer_2004FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
    ...
    void Celliyer_2004FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Celliyer_2004FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celliyer_2004FromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celliyer_2004FromCellMLOpt)
