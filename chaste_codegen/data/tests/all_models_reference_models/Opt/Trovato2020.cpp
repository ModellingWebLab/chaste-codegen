...
class CellTrovato2020FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellTrovato2020FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellTrovato2020FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = CellTrovato2020FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellTrovato2020FromCellMLOpt_LookupTables()
    {
...
protected:
    CellTrovato2020FromCellMLOpt_LookupTables(const CellTrovato2020FromCellMLOpt_LookupTables&);
    CellTrovato2020FromCellMLOpt_LookupTables& operator= (const CellTrovato2020FromCellMLOpt_LookupTables&);
    CellTrovato2020FromCellMLOpt_LookupTables()
    {
        ...
        CellTrovato2020FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellTrovato2020FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellTrovato2020FromCellMLOpt_LookupTables> CellTrovato2020FromCellMLOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> CellTrovato2020FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellTrovato2020FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    CellTrovato2020FromCellMLOpt::CellTrovato2020FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                46,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<CellTrovato2020FromCellMLOpt>::Instance();
        Init();
    ...
    CellTrovato2020FromCellMLOpt::~CellTrovato2020FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* CellTrovato2020FromCellMLOpt::GetLookupTableCollection()
    {
        return CellTrovato2020FromCellMLOpt_LookupTables::Instance();
    }
    
    double CellTrovato2020FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellTrovato2020FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellTrovato2020FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
    ...
    void CellTrovato2020FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> CellTrovato2020FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<CellTrovato2020FromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellTrovato2020FromCellMLOpt)
