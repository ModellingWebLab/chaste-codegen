...
class Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables()
    {
...
protected:
    Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables(const Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables&);
    Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables& operator= (const Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables&);
    Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables()
    {
        ...
        Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables> Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellten_tusscher_model_2006_epiFromCellMLOpt::GetLookupTableCollection()
    {
        return Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables::Instance();
    }
    
    
    void Cellten_tusscher_model_2006_epiFromCellMLOpt::VerifyStateVariables()
    {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2006_epiFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
