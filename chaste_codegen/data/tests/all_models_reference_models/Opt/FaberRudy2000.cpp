...
private:
    ...
    static std::shared_ptr<CellFaberRudy2000FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellFaberRudy2000FromCellMLOpt_LookupTables> CellFaberRudy2000FromCellMLOpt_LookupTables::mpInstance;
