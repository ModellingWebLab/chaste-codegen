...
class Celldavies_isap_2012FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celldavies_isap_2012FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celldavies_isap_2012FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Celldavies_isap_2012FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celldavies_isap_2012FromCellMLOpt_LookupTables()
    {
...
protected:
    Celldavies_isap_2012FromCellMLOpt_LookupTables(const Celldavies_isap_2012FromCellMLOpt_LookupTables&);
    Celldavies_isap_2012FromCellMLOpt_LookupTables& operator= (const Celldavies_isap_2012FromCellMLOpt_LookupTables&);
    Celldavies_isap_2012FromCellMLOpt_LookupTables()
    {
        ...
        Celldavies_isap_2012FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celldavies_isap_2012FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celldavies_isap_2012FromCellMLOpt_LookupTables> Celldavies_isap_2012FromCellMLOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Celldavies_isap_2012FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Celldavies_isap_2012FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celldavies_isap_2012FromCellMLOpt::Celldavies_isap_2012FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                29,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celldavies_isap_2012FromCellMLOpt>::Instance();
        Init();
    ...
    Celldavies_isap_2012FromCellMLOpt::~Celldavies_isap_2012FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Celldavies_isap_2012FromCellMLOpt::GetLookupTableCollection()
    {
        return Celldavies_isap_2012FromCellMLOpt_LookupTables::Instance();
    }
    
    double Celldavies_isap_2012FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celldavies_isap_2012FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celldavies_isap_2012FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Celldavies_isap_2012FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        const double var_cell__clont = 0.5 * var_cell__i_Stim + (-var_reversal_potentials__ECl + var_chaste_interface__cell__V) * mParameters[7] + ((fabs(var_chaste_interface__cell__V) < 2.6712338705500134e-6) ? (-187179.41753899999 * (-2.6712338705500134e-6 + var_chaste_interface__cell__V) * (-0.0096485000000000008 * (-mParameters[1] * exp(1.0000000000000001e-7) + var_chaste_interface__Cl__Cl_i) * mParameters[17] / (1.0 - exp(1.0000000000000001e-7)) - 0.0096485000000000008 * (-mParameters[1] * exp(-1.0000000000000001e-7) + var_chaste_interface__Cl__Cl_i) * mParameters[17] / (1.0 - exp(-1.0000000000000001e-7))) + 0.0096485000000000008 * (-mParameters[1] * exp(1.0000000000000001e-7) + var_chaste_interface__Cl__Cl_i) * mParameters[17] / (1.0 - exp(1.0000000000000001e-7))) : (3612.001220250083 * (-mParameters[1] * _lt_0_row[9] + var_chaste_interface__Cl__Cl_i) * mParameters[17] * var_chaste_interface__cell__V / (_lt_0_row[10]))) * var_chaste_interface__Ito2__AA; // uA_per_uF
        const double var_reversal_potentials__EK = 26.712338705500134 * log(mParameters[2] / var_chaste_interface__K__K_i); // mV
    ...
    std::vector<double> Celldavies_isap_2012FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celldavies_isap_2012FromCellMLOpt>::Initialise(void)
{
