...
class Celldemir_model_1994FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celldemir_model_1994FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celldemir_model_1994FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Celldemir_model_1994FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celldemir_model_1994FromCellMLOpt_LookupTables()
    {
...
protected:
    Celldemir_model_1994FromCellMLOpt_LookupTables(const Celldemir_model_1994FromCellMLOpt_LookupTables&);
    Celldemir_model_1994FromCellMLOpt_LookupTables& operator= (const Celldemir_model_1994FromCellMLOpt_LookupTables&);
    Celldemir_model_1994FromCellMLOpt_LookupTables()
    {
        ...
        Celldemir_model_1994FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celldemir_model_1994FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celldemir_model_1994FromCellMLOpt_LookupTables> Celldemir_model_1994FromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Celldemir_model_1994FromCellMLOpt::GetLookupTableCollection()
    {
        return Celldemir_model_1994FromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Celldemir_model_1994FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celldemir_model_1994FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celldemir_model_1994FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
