...
class Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables(const Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables&);
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables& operator= (const Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables&);
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables()
    {
        ...
        Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt::Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                6,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt>::Instance();
        Init();
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt::~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLOpt>::Initialise(void)
{
