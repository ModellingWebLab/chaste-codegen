...
class Cellnoble_model_1962FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellnoble_model_1962FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellnoble_model_1962FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellnoble_model_1962FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellnoble_model_1962FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellnoble_model_1962FromCellMLOpt_LookupTables(const Cellnoble_model_1962FromCellMLOpt_LookupTables&);
    Cellnoble_model_1962FromCellMLOpt_LookupTables& operator= (const Cellnoble_model_1962FromCellMLOpt_LookupTables&);
    Cellnoble_model_1962FromCellMLOpt_LookupTables()
    {
        ...
        Cellnoble_model_1962FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellnoble_model_1962FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellnoble_model_1962FromCellMLOpt_LookupTables> Cellnoble_model_1962FromCellMLOpt_LookupTables::mpInstance;


    Cellnoble_model_1962FromCellMLOpt::Cellnoble_model_1962FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                4,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnoble_model_1962FromCellMLOpt>::Instance();
        Init();
    ...
    Cellnoble_model_1962FromCellMLOpt::~Cellnoble_model_1962FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellnoble_model_1962FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellnoble_model_1962FromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellnoble_model_1962FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellnoble_model_1962FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellnoble_model_1962FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellnoble_model_1962FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Cellnoble_model_1962FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellnoble_model_1962FromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellnoble_model_1962FromCellMLOpt)
