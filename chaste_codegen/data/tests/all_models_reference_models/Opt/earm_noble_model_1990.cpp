...
class Cellearm_noble_model_1990FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellearm_noble_model_1990FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellearm_noble_model_1990FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellearm_noble_model_1990FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellearm_noble_model_1990FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellearm_noble_model_1990FromCellMLOpt_LookupTables(const Cellearm_noble_model_1990FromCellMLOpt_LookupTables&);
    Cellearm_noble_model_1990FromCellMLOpt_LookupTables& operator= (const Cellearm_noble_model_1990FromCellMLOpt_LookupTables&);
    Cellearm_noble_model_1990FromCellMLOpt_LookupTables()
    {
        ...
        Cellearm_noble_model_1990FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellearm_noble_model_1990FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellearm_noble_model_1990FromCellMLOpt_LookupTables> Cellearm_noble_model_1990FromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellearm_noble_model_1990FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellearm_noble_model_1990FromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Cellearm_noble_model_1990FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellearm_noble_model_1990FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellearm_noble_model_1990FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
