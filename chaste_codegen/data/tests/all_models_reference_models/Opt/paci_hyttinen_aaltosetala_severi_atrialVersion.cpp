...
class Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables);
        }
    ...
    ~Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables()
    {

    }

protected:
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables(const Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables&);
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables& operator= (const Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables&);
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables()
    {
        ...
        Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables> mpInstance;

};

std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables> Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt::Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                18,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt>::Instance();
        Init();
    ...
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt::~Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt::GetLookupTableCollection()
    {
        return Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Membrane__Vm_converted = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Membrane__Vm_converted = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLOpt>::Initialise(void)
{
