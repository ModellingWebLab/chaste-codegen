...
class Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables()
    {
...
protected:
    Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables(const Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables&);
    Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables& operator= (const Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables&);
    Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables()
    {
        ...
        Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables> Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellviswanathan_model_1999_epiFromCellMLOpt::GetLookupTableCollection()
    {
        return Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Cellviswanathan_model_1999_epiFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellviswanathan_model_1999_epiFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
