...
#include "MathsCustomFunctions.hpp"
    ...
    double Celldokos_model_1996FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_sodium_calcium_exchange_current__k23 = (2.3464309350494594e-7 * pow(var_chaste_interface__ion_concentrations__Nao, 3.0) + 1.094140745013563e-6 * pow(var_chaste_interface__ion_concentrations__Nao, 2.0)) * exp(-0.0080763619450073352 * var_chaste_interface__membrane__E) / var_sodium_calcium_exchange_current__do; // dimensionless
