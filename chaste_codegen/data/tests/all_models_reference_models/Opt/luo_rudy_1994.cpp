...
class Cellluo_rudy_1994FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellluo_rudy_1994FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellluo_rudy_1994FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellluo_rudy_1994FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellluo_rudy_1994FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellluo_rudy_1994FromCellMLOpt_LookupTables(const Cellluo_rudy_1994FromCellMLOpt_LookupTables&);
    Cellluo_rudy_1994FromCellMLOpt_LookupTables& operator= (const Cellluo_rudy_1994FromCellMLOpt_LookupTables&);
    Cellluo_rudy_1994FromCellMLOpt_LookupTables()
    {
        ...
        Cellluo_rudy_1994FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellluo_rudy_1994FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellluo_rudy_1994FromCellMLOpt_LookupTables> Cellluo_rudy_1994FromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellluo_rudy_1994FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellluo_rudy_1994FromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Cellluo_rudy_1994FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellluo_rudy_1994FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellluo_rudy_1994FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
