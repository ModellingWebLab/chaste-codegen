...
class Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__Vm)
    {
        ...
        const double* const _lt_0_row = Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables(const Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables&);
    Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables& operator= (const Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables&);
    Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables()
    {
        ...
        Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables> Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellcorrias_purkinje_2011FromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellcorrias_purkinje_2011FromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellcorrias_purkinje_2011FromCellMLOpt::Cellcorrias_purkinje_2011FromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                22,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellcorrias_purkinje_2011FromCellMLOpt>::Instance();
        Init();
    ...
    Cellcorrias_purkinje_2011FromCellMLOpt::~Cellcorrias_purkinje_2011FromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Cellcorrias_purkinje_2011FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables::Instance();
    }
    
    double Cellcorrias_purkinje_2011FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__Vm);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellcorrias_purkinje_2011FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
    ...
    void Cellcorrias_purkinje_2011FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__Time__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Cellcorrias_purkinje_2011FromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__Time__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellcorrias_purkinje_2011FromCellMLOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellcorrias_purkinje_2011FromCellMLOpt)
