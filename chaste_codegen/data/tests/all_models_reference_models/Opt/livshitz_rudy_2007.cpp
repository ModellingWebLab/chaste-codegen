...
class Celllivshitz_rudy_2007FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celllivshitz_rudy_2007FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celllivshitz_rudy_2007FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Celllivshitz_rudy_2007FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celllivshitz_rudy_2007FromCellMLOpt_LookupTables()
    {
...
protected:
    Celllivshitz_rudy_2007FromCellMLOpt_LookupTables(const Celllivshitz_rudy_2007FromCellMLOpt_LookupTables&);
    Celllivshitz_rudy_2007FromCellMLOpt_LookupTables& operator= (const Celllivshitz_rudy_2007FromCellMLOpt_LookupTables&);
    Celllivshitz_rudy_2007FromCellMLOpt_LookupTables()
    {
        ...
        Celllivshitz_rudy_2007FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celllivshitz_rudy_2007FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celllivshitz_rudy_2007FromCellMLOpt_LookupTables> Celllivshitz_rudy_2007FromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Celllivshitz_rudy_2007FromCellMLOpt::GetLookupTableCollection()
    {
        return Celllivshitz_rudy_2007FromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Celllivshitz_rudy_2007FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celllivshitz_rudy_2007FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celllivshitz_rudy_2007FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
