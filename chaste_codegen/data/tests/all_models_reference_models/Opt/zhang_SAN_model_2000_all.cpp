...
class Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables()
    {
...
protected:
    Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables(const Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables&);
    Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables& operator= (const Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables&);
    Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables()
    {
        ...
        Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables> Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellzhang_SAN_model_2000_allFromCellMLOpt::GetLookupTableCollection()
    {
        return Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Cellzhang_SAN_model_2000_allFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellzhang_SAN_model_2000_allFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
