...
class Cellgrandi2010ssFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellgrandi2010ssFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellgrandi2010ssFromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__sVm)
    {
        ...
        const double* const _lt_0_row = Cellgrandi2010ssFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellgrandi2010ssFromCellMLOpt_LookupTables()
    {
...
protected:
    Cellgrandi2010ssFromCellMLOpt_LookupTables(const Cellgrandi2010ssFromCellMLOpt_LookupTables&);
    Cellgrandi2010ssFromCellMLOpt_LookupTables& operator= (const Cellgrandi2010ssFromCellMLOpt_LookupTables&);
    Cellgrandi2010ssFromCellMLOpt_LookupTables()
    {
        ...
        Cellgrandi2010ssFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellgrandi2010ssFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellgrandi2010ssFromCellMLOpt_LookupTables> Cellgrandi2010ssFromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellgrandi2010ssFromCellMLOpt::GetLookupTableCollection()
    {
        return Cellgrandi2010ssFromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Cellgrandi2010ssFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellgrandi2010ssFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__sVm);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellgrandi2010ssFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__sVm);
