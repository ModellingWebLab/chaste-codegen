...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellTrovato2020FromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double CellTrovato2020FromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    CellTrovato2020FromCellMLRushLarsen::CellTrovato2020FromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<CellTrovato2020FromCellMLRushLarsen>::Instance();
        Init();
    ...
    CellTrovato2020FromCellMLRushLarsen::~CellTrovato2020FromCellMLRushLarsen()
    {
    }

    
    double CellTrovato2020FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void CellTrovato2020FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        rDY[4] = d_dt_chaste_interface_var_intracellular_ions__nasl;
        rDY[5] = d_dt_chaste_interface_var_intracellular_ions__nass;
        rDY[6] = d_dt_chaste_interface_var_intracellular_ions__ki;
        rDY[7] = d_dt_chaste_interface_var_intracellular_ions__kss;
        rDY[8] = d_dt_chaste_interface_var_intracellular_ions__ksl;
        rDY[9] = d_dt_chaste_interface_var_intracellular_ions__cass;
        rDY[10] = d_dt_chaste_interface_var_intracellular_ions__casl;
        rDY[11] = d_dt_chaste_interface_var_intracellular_ions__cansr;
        rDY[12] = d_dt_chaste_interface_var_intracellular_ions__cajsr;
        rDY[13] = d_dt_chaste_interface_var_intracellular_ions__cacsr;
        rAlphaOrTau[14] = var_INa__tm;
        rBetaOrInf[14] = var_INa__mss;
        rAlphaOrTau[15] = var_INa__thf;
        rBetaOrInf[15] = var_INa__hss;
        rAlphaOrTau[16] = var_INa__ths;
        rBetaOrInf[16] = var_INa__hss;
        rAlphaOrTau[17] = var_INa__tj;
        rBetaOrInf[17] = var_INa__jss;
        rAlphaOrTau[18] = var_INa__thsp;
        rBetaOrInf[18] = var_INa__hssp;
        rAlphaOrTau[19] = var_INa__tjp;
        rBetaOrInf[19] = var_INa__jss;
        rAlphaOrTau[20] = var_INaL__tmL;
        rBetaOrInf[20] = var_INaL__mLss;
        rAlphaOrTau[21] = var_INaL__thL;
        rBetaOrInf[21] = var_INaL__hLss;
        rAlphaOrTau[22] = var_INaL__thLp;
        rBetaOrInf[22] = var_INaL__hLssp;
        rAlphaOrTau[23] = var_Ito__taua;
        rBetaOrInf[23] = var_Ito__ass;
        rAlphaOrTau[24] = var_Ito__tauis;
        rBetaOrInf[24] = var_Ito__iss;
        rAlphaOrTau[25] = var_Ito__tauif;
        rBetaOrInf[25] = var_Ito__iss;
        rAlphaOrTau[26] = var_ICaL__td;
        rBetaOrInf[26] = var_ICaL__dss;
        rAlphaOrTau[27] = var_ICaL__tff;
        rBetaOrInf[27] = var_ICaL__fss;
        rAlphaOrTau[28] = var_ICaL__tfs;
        rBetaOrInf[28] = var_ICaL__fss;
        rAlphaOrTau[29] = var_ICaL__tfcaf;
        rBetaOrInf[29] = var_ICaL__fcass;
        rAlphaOrTau[30] = var_ICaL__tfcas;
        rBetaOrInf[30] = var_ICaL__fcass;
        rAlphaOrTau[31] = var_ICaL__tjca;
        rBetaOrInf[31] = var_ICaL__fcass;
        rAlphaOrTau[32] = var_ICaL__tffp;
        rBetaOrInf[32] = var_ICaL__fss;
        rAlphaOrTau[33] = var_ICaL__tfcafp;
        rBetaOrInf[33] = var_ICaL__fcass;
        rDY[34] = d_dt_chaste_interface_var_ICaL__nca;
        rAlphaOrTau[35] = var_ICaT__taub;
        rBetaOrInf[35] = var_ICaT__bss;
        rAlphaOrTau[36] = var_ICaT__taug;
        rBetaOrInf[36] = var_ICaT__gss;
        rAlphaOrTau[37] = var_IKr__txrf;
        rBetaOrInf[37] = var_IKr__xrss;
        rAlphaOrTau[38] = var_IKr__txrs;
        rBetaOrInf[38] = var_IKr__xrss;
        rAlphaOrTau[39] = var_IKs__txs1;
        rBetaOrInf[39] = var_IKs__xs1ss;
        rAlphaOrTau[40] = var_IKs__txs2;
        rBetaOrInf[40] = var_IKs__xs2ss;
        rAlphaOrTau[41] = var_If__tauy;
        rBetaOrInf[41] = var_If__yss;
        rAlphaOrTau[42] = var_IK1__txk1;
        rBetaOrInf[42] = var_IK1__xk1ss;
        rDY[43] = d_dt_chaste_interface_var_ryr__Jrel1;
        rDY[44] = d_dt_chaste_interface_var_ryr__Jrel2;
        rDY[45] = d_dt_chaste_interface_var_IP3__u;
    }
    void CellTrovato2020FromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
        ...
        rY[41] = rBetaOrInf[41] + (rY[41] - rBetaOrInf[41])*exp(-mDt/rAlphaOrTau[41]);
        rY[42] = rBetaOrInf[42] + (rY[42] - rBetaOrInf[42])*exp(-mDt/rAlphaOrTau[42]);
        rY[43] += mDt * rDY[43];
        rY[44] += mDt * rDY[44];
        rY[45] += mDt * rDY[45];
    }

    std::vector<double> CellTrovato2020FromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<CellTrovato2020FromCellMLRushLarsen>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellTrovato2020FromCellMLRushLarsen)
