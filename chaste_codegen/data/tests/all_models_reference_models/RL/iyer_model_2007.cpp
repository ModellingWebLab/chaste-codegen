...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celliyer_model_2007FromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Celliyer_model_2007FromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
    ...
    double Celliyer_model_2007FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_COMPUTE_ICa_ICaK__ICamax = ((fabs(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) < 1.3355699481865285e-6) ? (-374372.00550889375 * (-1.3355699481865285e-6 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * (-0.019300000000000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * mParameters[2]) * var_COMPUTE_ICa_ICaK__PCa / (-1.0 + exp(1.0000000000000001e-7)) - 0.019300000000000001 * (0.001 * exp(-1.0000000000000001e-7) - 0.34100000000000003 * mParameters[2]) * var_COMPUTE_ICa_ICaK__PCa / (-1.0 + exp(-1.0000000000000001e-7))) + 0.019300000000000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * mParameters[2]) * var_COMPUTE_ICa_ICaK__PCa / (-1.0 + exp(1.0000000000000001e-7))) : (14450.7594126433 * (0.001 * exp(0.074874401101778759 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) - 0.34100000000000003 * mParameters[2]) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V * var_COMPUTE_ICa_ICaK__PCa / (-1.0 + exp(0.074874401101778759 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V)))); // uA_per_uF
