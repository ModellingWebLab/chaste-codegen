...
#include "MathsCustomFunctions.hpp"
    ...
    Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsen::Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsen>::Instance();
        Init();
    ...
    Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsen::~Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsen()
    {
    }

    
    double Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellmcallister_noble_tsien_1975_bFromCellMLRushLarsen>::Initialise(void)
{
