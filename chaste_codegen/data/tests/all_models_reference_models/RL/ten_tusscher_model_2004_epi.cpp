...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Dynamicten_tusscher_model_2004_epiFromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Dynamicten_tusscher_model_2004_epiFromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    
    Dynamicten_tusscher_model_2004_epiFromCellMLRushLarsen::Dynamicten_tusscher_model_2004_epiFromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Dynamicten_tusscher_model_2004_epiFromCellMLRushLarsen>::Instance();
        Init();
    ...
    Dynamicten_tusscher_model_2004_epiFromCellMLRushLarsen::~Dynamicten_tusscher_model_2004_epiFromCellMLRushLarsen()
    {
    }
    
    double Dynamicten_tusscher_model_2004_epiFromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicten_tusscher_model_2004_epiFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        rAlphaOrTau[4] = 1.0 * (1100.0 / sqrt(1.0 + exp(( -10.0 - var_chaste_interface__membrane__V) * 0.16666666666666666))) * (1.0 / (1.0 + exp((var_chaste_interface__membrane__V - 60.0) * 0.050000000000000003)));
        ...
        rBetaOrInf[8] = 1.0 / (1.0 + exp(( -5.0 - var_chaste_interface__membrane__V) * 0.13333333333333333));
        rAlphaOrTau[9] = (1125.0 * exp((-pow(var_chaste_interface__membrane__V + 27.0, 2.0)) * 0.0041666666666666666)) + 80.0 + (165.0 / (1.0 + exp((25.0 - var_chaste_interface__membrane__V) * 0.10000000000000001)));
        ...
        rAlphaOrTau[11] = (85.0 * exp((-pow(var_chaste_interface__membrane__V + 45.0, 2.0)) * 0.0031250000000000002)) + (5.0 / (1.0 + exp((var_chaste_interface__membrane__V - 20.0) * 0.20000000000000001))) + 3.0;
        rBetaOrInf[11] = 1.0 / (1.0 + exp((var_chaste_interface__membrane__V + 20.0) * 0.20000000000000001));
        rAlphaOrTau[12] = (9.5 * exp((-pow(var_chaste_interface__membrane__V + 40.0, 2.0)) * 0.00055555555555555556)) + 0.80000000000000004;
        rBetaOrInf[12] = 1.0 / (1.0 + exp((20.0 - var_chaste_interface__membrane__V) * 0.16666666666666666));
    ...
    void Dynamicten_tusscher_model_2004_epiFromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
        rY[1] += mDt * rDY[1];
...
template<>
void OdeSystemInformation<Dynamicten_tusscher_model_2004_epiFromCellMLRushLarsen>::Initialise(void)
{
...
extern "C"
{
    ...
    {
        return new Dynamicten_tusscher_model_2004_epiFromCellMLRushLarsen(pSolver, pStimulus);
    }
