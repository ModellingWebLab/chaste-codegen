...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celldavies_isap_2012FromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Celldavies_isap_2012FromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celldavies_isap_2012FromCellMLRushLarsen::Celldavies_isap_2012FromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celldavies_isap_2012FromCellMLRushLarsen>::Instance();
        Init();
    ...
    Celldavies_isap_2012FromCellMLRushLarsen::~Celldavies_isap_2012FromCellMLRushLarsen()
    {
    }

    
    double Celldavies_isap_2012FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Celldavies_isap_2012FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__Environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Celldavies_isap_2012FromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Celldavies_isap_2012FromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celldavies_isap_2012FromCellMLRushLarsen>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celldavies_isap_2012FromCellMLRushLarsen)
