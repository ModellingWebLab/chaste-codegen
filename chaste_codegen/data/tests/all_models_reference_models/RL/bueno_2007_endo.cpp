...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellbueno_2007_endoFromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    Cellbueno_2007_endoFromCellMLRushLarsen::Cellbueno_2007_endoFromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbueno_2007_endoFromCellMLRushLarsen>::Instance();
        Init();
    ...
    Cellbueno_2007_endoFromCellMLRushLarsen::~Cellbueno_2007_endoFromCellMLRushLarsen()
    {
    }

    
    double Cellbueno_2007_endoFromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbueno_2007_endoFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Cellbueno_2007_endoFromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Cellbueno_2007_endoFromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellbueno_2007_endoFromCellMLRushLarsen>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbueno_2007_endoFromCellMLRushLarsen)
