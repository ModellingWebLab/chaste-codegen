...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_current__i_Ca_max = ((fabs(var_chaste_interface__membrane__V) < 1.3354093264248704e-6) ? (374417.03461708582 * (1.3354093264248704e-6 + var_chaste_interface__membrane__V) * (1.9299999999999998e-5 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(9.9999999999999995e-8)) * mParameters[8] / (-1.0 + exp(9.9999999999999995e-8)) + 1.9299999999999998e-5 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(-9.9999999999999995e-8)) * mParameters[8] / (-1.0 + exp(-9.9999999999999995e-8))) - 1.9299999999999998e-5 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(-9.9999999999999995e-8)) * mParameters[8] / (-1.0 + exp(-9.9999999999999995e-8))) : (14.452497536219512 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(0.074883406923417162 * var_chaste_interface__membrane__V)) * mParameters[8] * var_chaste_interface__membrane__V / (-1.0 + exp(0.074883406923417162 * var_chaste_interface__membrane__V)))); // microA_per_microF
