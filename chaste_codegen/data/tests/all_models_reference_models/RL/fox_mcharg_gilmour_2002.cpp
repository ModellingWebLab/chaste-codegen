...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen::Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen>::Instance();
        Init();
    ...
    Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen::~Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen()
    {
    }

    
    double Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_current__i_Ca_max = ((fabs(var_chaste_interface__membrane__V) < 1.3354093264248706e-6) ? (-374417.03461708582 * (-1.3354093264248706e-6 + var_chaste_interface__membrane__V) * (-1.9300000000000002e-5 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(1.0000000000000001e-7)) * mParameters[8] / (-1.0 + exp(1.0000000000000001e-7)) - 1.9300000000000002e-5 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(-1.0000000000000001e-7)) * mParameters[8] / (-1.0 + exp(-1.0000000000000001e-7))) + 1.9300000000000002e-5 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(1.0000000000000001e-7)) * mParameters[8] / (-1.0 + exp(1.0000000000000001e-7))) : (14.452497536219512 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(0.074883406923417162 * var_chaste_interface__membrane__V)) * mParameters[8] * var_chaste_interface__membrane__V / (-1.0 + exp(0.074883406923417162 * var_chaste_interface__membrane__V)))); // microA_per_microF
    ...
    void Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellfox_mcharg_gilmour_2002FromCellMLRushLarsen)
