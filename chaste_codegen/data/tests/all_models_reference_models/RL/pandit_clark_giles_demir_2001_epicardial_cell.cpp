...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen::Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen>::Instance();
        Init();
    ...
    Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen::~Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen()
    {
    }

    
    double Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        rBetaOrInf[2] = var_sodium_current_m_gate__m_max;
        rAlphaOrTau[3] = 1000.0 * var_sodium_current_h_gate__tau_h;
        rBetaOrInf[3] = var_sodium_current_h_gate__h_max;
        rAlphaOrTau[4] = 1000.0 * var_sodium_current_j_gate__tau_j;
        rBetaOrInf[4] = var_sodium_current_j_gate__j_max;
        rAlphaOrTau[5] = 1000.0 * var_L_type_Ca_channel_d_gate__tau_d;
        rBetaOrInf[5] = var_L_type_Ca_channel_d_gate__d_max;
        rAlphaOrTau[6] = 1000.0 * var_L_type_Ca_channel_f_11_gate__tau_f_11;
        rBetaOrInf[6] = var_L_type_Ca_channel_f_11_gate__f_11_max;
        rAlphaOrTau[7] = 1000.0 * var_L_type_Ca_channel_f_12_gate__tau_f_12;
        rBetaOrInf[7] = var_L_type_Ca_channel_f_12_gate__f_12_max;
        ...
        rBetaOrInf[9] = var_Ca_independent_transient_outward_K_current_r_gate__r_max;
        rAlphaOrTau[10] = 1000.0 * var_Ca_independent_transient_outward_K_current_s_gate__tau_s;
        rBetaOrInf[10] = var_Ca_independent_transient_outward_K_current_s_gate__s_max;
        rAlphaOrTau[11] = 1000.0 * var_Ca_independent_transient_outward_K_current_s_slow_gate__tau_s_slow;
        rBetaOrInf[11] = var_Ca_independent_transient_outward_K_current_s_slow_gate__s_slow_max;
        rAlphaOrTau[12] = 1000.0 * var_steady_state_outward_K_current_r_ss_gate__tau_r_ss;
        rBetaOrInf[12] = var_steady_state_outward_K_current_r_ss_gate__r_ss_max;
        rAlphaOrTau[13] = 1000.0 * var_steady_state_outward_K_current_s_ss_gate__tau_s_ss;
        rBetaOrInf[13] = var_steady_state_outward_K_current_s_ss_gate__s_ss_max;
    ...
    void Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellMLRushLarsen)
