...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celllindblad_model_1996FromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Celllindblad_model_1996FromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celllindblad_model_1996FromCellMLRushLarsen::Celllindblad_model_1996FromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celllindblad_model_1996FromCellMLRushLarsen>::Instance();
        Init();
    ...
    Celllindblad_model_1996FromCellMLRushLarsen::~Celllindblad_model_1996FromCellMLRushLarsen()
    {
    }

    
    double Celllindblad_model_1996FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Celllindblad_model_1996FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Celllindblad_model_1996FromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Celllindblad_model_1996FromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celllindblad_model_1996FromCellMLRushLarsen>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celllindblad_model_1996FromCellMLRushLarsen)
