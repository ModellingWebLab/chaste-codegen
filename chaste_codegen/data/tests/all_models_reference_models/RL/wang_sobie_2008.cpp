...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellwang_sobie_2008FromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Cellwang_sobie_2008FromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellwang_sobie_2008FromCellMLRushLarsen::Cellwang_sobie_2008FromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellwang_sobie_2008FromCellMLRushLarsen>::Instance();
        Init();
    ...
    Cellwang_sobie_2008FromCellMLRushLarsen::~Cellwang_sobie_2008FromCellMLRushLarsen()
    {
    }

    
    double Cellwang_sobie_2008FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellwang_sobie_2008FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        rAlphaOrTau[18] = var_T_type_calcium_current_b_gate__tau_b;
        rBetaOrInf[18] = var_T_type_calcium_current_b_gate__b_infinity;
        rAlphaOrTau[19] = var_T_type_calcium_current_g_gate__tau_g;
        rBetaOrInf[19] = var_T_type_calcium_current_g_gate__g_infinity;
        rDY[20] = d_dt_chaste_interface_var_sodium_concentration__Nai;
        rAlphaOrTau[21] = var_fast_sodium_current_m_gate__alpha_m;
        rBetaOrInf[21] = var_fast_sodium_current_m_gate__beta_m;
        rAlphaOrTau[22] = var_fast_sodium_current_h_gate__alpha_h;
        rBetaOrInf[22] = var_fast_sodium_current_h_gate__beta_h;
        rAlphaOrTau[23] = var_fast_sodium_current_j_gate__alpha_j;
        rBetaOrInf[23] = var_fast_sodium_current_j_gate__beta_j;
        rDY[24] = d_dt_chaste_interface_var_potassium_concentration__Ki;
        rAlphaOrTau[25] = var_fast_transient_outward_potassium_current__alpha_a;
        rBetaOrInf[25] = var_fast_transient_outward_potassium_current__beta_a;
        rAlphaOrTau[26] = var_fast_transient_outward_potassium_current__tau_ito_f;
        rBetaOrInf[26] = var_fast_transient_outward_potassium_current__ito_f_infinity;
        rAlphaOrTau[27] = var_ultra_rapidly_activating_delayed_rectifier_potassium_current__tau_aur;
        rBetaOrInf[27] = var_ultra_rapidly_activating_delayed_rectifier_potassium_current__ass;
        rAlphaOrTau[28] = var_ultra_rapidly_activating_delayed_rectifier_potassium_current__tau_iur;
        rBetaOrInf[28] = var_ultra_rapidly_activating_delayed_rectifier_potassium_current__iss;
        rAlphaOrTau[29] = var_non_inactivating_steady_state_potassium_current__tau_Kss;
        rBetaOrInf[29] = var_ultra_rapidly_activating_delayed_rectifier_potassium_current__ass;
        rAlphaOrTau[30] = var_slow_delayed_rectifier_potassium_current__alpha_n;
        rBetaOrInf[30] = var_slow_delayed_rectifier_potassium_current__beta_n;
        rDY[31] = d_dt_chaste_interface_var_rapid_delayed_rectifier_potassium_current__O_K;
        rDY[32] = d_dt_chaste_interface_var_rapid_delayed_rectifier_potassium_current__C_K1;
        rDY[33] = d_dt_chaste_interface_var_rapid_delayed_rectifier_potassium_current__C_K2;
        rDY[34] = d_dt_chaste_interface_var_rapid_delayed_rectifier_potassium_current__I_K;
    }
    void Cellwang_sobie_2008FromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
        ...
        {
            const double tau_inv = rAlphaOrTau[23] + rBetaOrInf[23];
            const double y_inf = rAlphaOrTau[23] / tau_inv;
            rY[23] = y_inf + (rY[23] - y_inf)*exp(-mDt*tau_inv);
        }
        rY[24] += mDt * rDY[24];
        {
    ...
    std::vector<double> Cellwang_sobie_2008FromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellwang_sobie_2008FromCellMLRushLarsen>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellwang_sobie_2008FromCellMLRushLarsen)
