...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        rAlphaOrTau[3] = 1000 * var_fast_sodium_current_h_gate__tau_h;
        rBetaOrInf[3] = var_fast_sodium_current_h_gate__h_inf;
        rAlphaOrTau[4] = 001 * var_time_dependent_rectifier_potassium_current_x_gate__alpha_x;
        rBetaOrInf[4] = 001 * var_time_dependent_rectifier_potassium_current_x_gate__beta_x;
        ...
        rAlphaOrTau[7] = 001 * var_L_type_Ca_channel_d_gate__alpha_d;
        rBetaOrInf[7] = 001 * var_L_type_Ca_channel_d_gate__beta_d;
        rAlphaOrTau[8] = 001 * var_L_type_Ca_channel_f_gate__alpha_f;
        rBetaOrInf[8] = 001 * var_L_type_Ca_channel_f_gate__beta_f;
