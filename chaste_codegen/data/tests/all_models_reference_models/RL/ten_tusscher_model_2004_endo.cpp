...
#include "MathsCustomFunctions.hpp"
    ...
    double Dynamicten_tusscher_model_2004_endoFromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    
    Dynamicten_tusscher_model_2004_endoFromCellMLRushLarsen::Dynamicten_tusscher_model_2004_endoFromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Dynamicten_tusscher_model_2004_endoFromCellMLRushLarsen>::Instance();
        Init();

    }
    
    Dynamicten_tusscher_model_2004_endoFromCellMLRushLarsen::~Dynamicten_tusscher_model_2004_endoFromCellMLRushLarsen()
    {
    }
    
    double Dynamicten_tusscher_model_2004_endoFromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicten_tusscher_model_2004_endoFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        rAlphaOrTau[11] = (1000.0 * exp((-pow(var_chaste_interface__membrane__V + 67.0, 2.0)) * 0.001)) + (0.0 / (1.0 + exp((var_chaste_interface__membrane__V - 20.0) * 0.20000000000000001))) + 8.0;
        rBetaOrInf[11] = 1.0 / (1.0 + exp((var_chaste_interface__membrane__V + 28.0) * 0.20000000000000001));
    ...
    void Dynamicten_tusscher_model_2004_endoFromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
        rY[1] += mDt * rDY[1];
...
template<>
void OdeSystemInformation<Dynamicten_tusscher_model_2004_endoFromCellMLRushLarsen>::Initialise(void)
{
...
extern "C"
{
    ...
    {
        return new Dynamicten_tusscher_model_2004_endoFromCellMLRushLarsen(pSolver, pStimulus);
    }
