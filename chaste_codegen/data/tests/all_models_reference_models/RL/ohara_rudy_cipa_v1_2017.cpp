...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen::Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen>::Instance();
        Init();
    ...
    Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen::~Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen()
    {
    }

    
    double Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        rAlphaOrTau[43] = var_IKs__txs1;
        rBetaOrInf[43] = var_IKs__xs1ss;
        rAlphaOrTau[44] = var_IKs__txs2;
        rBetaOrInf[44] = var_IKs__xs2ss;
        rAlphaOrTau[45] = var_IK1__txk1;
        rBetaOrInf[45] = var_IK1__xk1ss;
        rDY[46] = d_dt_chaste_interface_var_ryr__Jrelnp;
        rDY[47] = d_dt_chaste_interface_var_ryr__Jrelp;
    }
    void Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
        ...
        rY[41] += mDt * rDY[41];
        rY[42] += mDt * rDY[42];
        rY[43] = rBetaOrInf[43] + (rY[43] - rBetaOrInf[43])*exp(-mDt/rAlphaOrTau[43]);
        rY[44] = rBetaOrInf[44] + (rY[44] - rBetaOrInf[44])*exp(-mDt/rAlphaOrTau[44]);
        rY[45] = rBetaOrInf[45] + (rY[45] - rBetaOrInf[45])*exp(-mDt/rAlphaOrTau[45]);
        rY[46] += mDt * rDY[46];
        rY[47] += mDt * rDY[47];
    }

    std::vector<double> Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellohara_rudy_cipa_v1_2017FromCellMLRushLarsen)
