...
#include "MathsCustomFunctions.hpp"
    ...
    Dynamiczhang_SAN_model_2000_0D_capableFromCellMLRushLarsen::Dynamiczhang_SAN_model_2000_0D_capableFromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Dynamiczhang_SAN_model_2000_0D_capableFromCellMLRushLarsen>::Instance();
        Init();

    }
    
    Dynamiczhang_SAN_model_2000_0D_capableFromCellMLRushLarsen::~Dynamiczhang_SAN_model_2000_0D_capableFromCellMLRushLarsen()
    {
    }
    
    double Dynamiczhang_SAN_model_2000_0D_capableFromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamiczhang_SAN_model_2000_0D_capableFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Dynamiczhang_SAN_model_2000_0D_capableFromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
...
template<>
void OdeSystemInformation<Dynamiczhang_SAN_model_2000_0D_capableFromCellMLRushLarsen>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Dynamiczhang_SAN_model_2000_0D_capableFromCellMLRushLarsen)
extern "C"
{
    ...
    {
        return new Dynamiczhang_SAN_model_2000_0D_capableFromCellMLRushLarsen(pSolver, pStimulus);
    }
