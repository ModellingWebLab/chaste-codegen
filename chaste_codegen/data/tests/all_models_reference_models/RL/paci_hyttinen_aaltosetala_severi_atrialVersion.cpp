...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen::Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen>::Instance();
        Init();
    ...
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen::~Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen()
    {
    }

    
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Membrane__Vm_converted = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLRushLarsen)
