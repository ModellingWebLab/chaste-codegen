...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellespinosa_model_1998_normalFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        rAlphaOrTau[2] = 001 * var_time_dependent_potassium_current_x_gate__alpha_x;
        rBetaOrInf[2] = 001 * var_time_dependent_potassium_current_x_gate__beta_x;
        rAlphaOrTau[3] = 001 * var_fast_sodium_current_m_gate__alpha_m;
        rBetaOrInf[3] = 001 * var_fast_sodium_current_m_gate__beta_m;
        rAlphaOrTau[4] = 001 * var_fast_sodium_current_h_gate__alpha_h;
        rBetaOrInf[4] = 001 * var_fast_sodium_current_h_gate__beta_h;
        rAlphaOrTau[5] = 001 * var_L_type_Ca_channel_d_gate__alpha_d * var_L_type_Ca_channel_d_gate__speed_d;
        rBetaOrInf[5] = 001 * var_L_type_Ca_channel_d_gate__beta_d * var_L_type_Ca_channel_d_gate__speed_d;
        rAlphaOrTau[6] = 001 * var_L_type_Ca_channel_f_gate__alpha_f * var_L_type_Ca_channel_f_gate__speed_f;
        rBetaOrInf[6] = 001 * var_L_type_Ca_channel_f_gate__beta_f * var_L_type_Ca_channel_f_gate__speed_f;
        ...
        rAlphaOrTau[9] = 001 * var_transient_outward_current_s_gate__alpha_s;
        rBetaOrInf[9] = 001 * var_transient_outward_current_s_gate__beta_s;
