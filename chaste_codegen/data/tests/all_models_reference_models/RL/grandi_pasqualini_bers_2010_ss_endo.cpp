...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsen::Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsen>::Instance();
        Init();
    ...
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsen::~Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsen()
    {
    }

    
    double Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLRushLarsen>::Initialise(void)
{
