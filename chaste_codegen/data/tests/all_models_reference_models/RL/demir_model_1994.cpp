...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldemir_model_1994FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        rAlphaOrTau[3] = 1000 * var_sodium_current_h_gate__tau_h1;
        rBetaOrInf[3] = var_sodium_current_h_gate__h1_infinity;
        rAlphaOrTau[4] = 1000 * var_sodium_current_h_gate__tau_h2;
        rBetaOrInf[4] = var_sodium_current_h_gate__h2_infinity;
        rAlphaOrTau[5] = 1000 * var_L_type_Ca_channel_d_gate__tau_d_L;
        rBetaOrInf[5] = var_L_type_Ca_channel_d_gate__d_L_infinity;
        rAlphaOrTau[6] = 1000 * var_L_type_Ca_channel_f_gate__tau_f_L;
        rBetaOrInf[6] = var_L_type_Ca_channel_f_gate__f_L_infinity;
        rAlphaOrTau[7] = 1000 * var_T_type_Ca_channel_d_gate__tau_d_T;
        rBetaOrInf[7] = var_T_type_Ca_channel_d_gate__d_T_infinity;
        rAlphaOrTau[8] = 1000 * var_T_type_Ca_channel_f_gate__tau_f_T;
        rBetaOrInf[8] = var_T_type_Ca_channel_f_gate__f_T_infinity;
        rAlphaOrTau[9] = 1000 * var_delayed_rectifying_potassium_current_P_a_gate__tau_P_a;
        rBetaOrInf[9] = var_delayed_rectifying_potassium_current_P_a_gate__P_a_infinity;
        rAlphaOrTau[10] = 001 * var_delayed_rectifying_potassium_current_P_i_gate__alpha_P_i;
        rBetaOrInf[10] = 001 * var_delayed_rectifying_potassium_current_P_i_gate__beta_P_i;
        rAlphaOrTau[11] = 1000 * var_hyperpolarisation_activated_current_y_gate__tau_y;
