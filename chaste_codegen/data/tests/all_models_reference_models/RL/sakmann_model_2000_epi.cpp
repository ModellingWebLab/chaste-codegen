...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellsakmann_model_2000_epiFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        rAlphaOrTau[2] = 1000 * var_rapid_delayed_rectifier_potassium_current_xr_gate__tau_xr;
        rBetaOrInf[2] = var_rapid_delayed_rectifier_potassium_current_xr_gate__xr_inf;
        rAlphaOrTau[3] = 1000 * var_slow_delayed_rectifier_potassium_current_xs_gate__tau_xs;
        ...
        rAlphaOrTau[6] = 001 * var_L_type_Ca_channel_d_gate__alpha_d * var_L_type_Ca_channel_d_gate__speed_d;
        rBetaOrInf[6] = 001 * var_L_type_Ca_channel_d_gate__beta_d * var_L_type_Ca_channel_d_gate__speed_d;
        rAlphaOrTau[7] = 001 * var_L_type_Ca_channel_f_gate__alpha_f * var_L_type_Ca_channel_f_gate__speed_f;
        rBetaOrInf[7] = 001 * var_L_type_Ca_channel_f_gate__beta_f * var_L_type_Ca_channel_f_gate__speed_f;
        ...
        rAlphaOrTau[10] = 001 * var_transient_outward_current_s_gate__alpha_s;
        rBetaOrInf[10] = 001 * var_transient_outward_current_s_gate__beta_s;
