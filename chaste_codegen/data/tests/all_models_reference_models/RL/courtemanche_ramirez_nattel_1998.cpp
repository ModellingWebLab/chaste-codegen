...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsen::Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsen>::Instance();
        Init();
    ...
    Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsen::~Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsen()
    {
    }

    
    double Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellcourtemanche_ramirez_nattel_1998FromCellMLRushLarsen>::Initialise(void)
{
