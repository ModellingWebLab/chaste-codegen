...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellaslanidi_atrial_model_2009FromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellaslanidi_atrial_model_2009FromCellMLRushLarsen::Cellaslanidi_atrial_model_2009FromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellaslanidi_atrial_model_2009FromCellMLRushLarsen>::Instance();
        Init();
    ...
    Cellaslanidi_atrial_model_2009FromCellMLRushLarsen::~Cellaslanidi_atrial_model_2009FromCellMLRushLarsen()
    {
    }

    
    double Cellaslanidi_atrial_model_2009FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellaslanidi_atrial_model_2009FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
    ...
    void Cellaslanidi_atrial_model_2009FromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Cellaslanidi_atrial_model_2009FromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellaslanidi_atrial_model_2009FromCellMLRushLarsen>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellaslanidi_atrial_model_2009FromCellMLRushLarsen)
