...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellhund_rudy_2004FromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
    ...
    double Cellhund_rudy_2004FromCellMLRushLarsen::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellhund_rudy_2004FromCellMLRushLarsen::Cellhund_rudy_2004FromCellMLRushLarsen(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellhund_rudy_2004FromCellMLRushLarsen>::Instance();
        Init();
    ...
    Cellhund_rudy_2004FromCellMLRushLarsen::~Cellhund_rudy_2004FromCellMLRushLarsen()
    {
    }

    
    double Cellhund_rudy_2004FromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellhund_rudy_2004FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__Environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        rAlphaOrTau[2] = var_INa__tau_h;
        rBetaOrInf[2] = var_INa__h_inf;
        rAlphaOrTau[3] = var_INa__am;
        rBetaOrInf[3] = var_INa__bm;
        rAlphaOrTau[4] = var_INa__tau_j;
        rBetaOrInf[4] = var_INa__j_inf;
    ...
    void Cellhund_rudy_2004FromCellMLRushLarsen::ComputeOneStepExceptVoltage(const std::vector<double> &rDY, const std::vector<double> &rAlphaOrTau, const std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    std::vector<double> Cellhund_rudy_2004FromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellhund_rudy_2004FromCellMLRushLarsen>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellhund_rudy_2004FromCellMLRushLarsen)
