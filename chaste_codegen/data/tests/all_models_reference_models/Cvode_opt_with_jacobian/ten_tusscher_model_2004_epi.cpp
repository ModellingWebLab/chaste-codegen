...
class Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables()
    {
...
protected:
    Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables(const Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables&);
    Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables& operator= (const Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables&);
    Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables()
    {
        ...
        Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables> Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt::Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                17,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt>::Instance();
        Init();
    ...
    Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt::~Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt()
    {
    }

    AbstractLookupTableCollection* Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -86.2
        double var_chaste_interface__calcium_dynamics__Ca_i = NV_Ith_S(rY, 1);
...
const double var_x0 = exp(9.9999999999999995e-8);
        ...
        const double var_x31 = var_x30 * NV_Ith_S(mParameters, 13) * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x77 = 1 / (1.0 + NV_Ith_S(mParameters, 5));
        const double var_x78 = var_x77 * NV_Ith_S(mParameters, 5) * NV_Ith_S(mParameters, 21) / (40.0 + var_chaste_interface__sodium_dynamics__Na_i);
        ...
        const double var_x97 = var_x96 * NV_Ith_S(mParameters, 13) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x98 = var_x97 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x99 = var_x31 * var_x96;
        const double var_x100 = var_x30 * var_x97;
        const double var_x101 = var_x3 * var_x82;
        const double var_x102 = var_x10 * var_x82;
        const double var_x103 = var_x15 * var_x19;
        const double var_x104 = var_x103 * var_x22;
        const double var_x105 = ((var_x12) ? (-var_x102 + var_x80 * (var_x101 + var_x102)) : (var_x104 * var_chaste_interface__L_type_Ca_current_f_gate__f));
        const double var_x106 = var_x81 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        const double var_x107 = var_x10 * var_x106;
        const double var_x108 = ((var_x12) ? (-var_x107 + var_x80 * (var_x107 + var_x106 * var_x3)) : (var_x104 * var_chaste_interface__L_type_Ca_current_d_gate__d));
        const double var_x109 = 0.019297068299999998 * NV_Ith_S(mParameters, 7);
        const double var_x110 = var_x109 * var_x11;
        const double var_x111 = ((var_x12) ? (-var_x110 + var_x80 * (var_x110 + var_x109 * var_x5)) : (var_x103 * var_x4 * NV_Ith_S(mParameters, 7) * var_chaste_interface__membrane__V));
        const double var_x112 = var_x51 - var_chaste_interface__membrane__V;
        const double var_x113 = NV_Ith_S(mParameters, 22) * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x114 = var_x95 * NV_Ith_S(mParameters, 10);
        ...
        const double var_x119 = var_x116 * var_x77 * NV_Ith_S(mParameters, 5) * var_chaste_interface__sodium_dynamics__Na_i * NV_Ith_S(mParameters, 21) / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        ...
        const double var_x133 = -NV_Ith_S(mParameters, 0);
        const double var_x134 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
        const double var_x135 = 1.2499999999999999e-7 * NV_Ith_S(mParameters, 2) / (pow(var_x134, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
        const double var_x136 = (-var_chaste_interface__calcium_dynamics__Ca_i + var_chaste_interface__calcium_dynamics__Ca_SR) * NV_Ith_S(mParameters, 0);
        ...
        const double var_x139 = 0.00031590674984870116 * NV_Ith_S(mParameters, 12);
        const double var_x140 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, 2);
        const double var_x141 = 0.0625 + var_x140;
        const double var_x142 = NV_Ith_S(mParameters, 1) / var_x141;
        ...
        const double var_x147 = var_x131 * var_x139;
        const double var_x148 = 2 * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3) * NV_Ith_S(mParameters, 1) / pow(var_x141, 2);
        ...
        const double var_x154 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x155 = exp(-3.7142857142857144 - var_x154);
        const double var_x156 = 1.0 + var_x155;
        const double var_x157 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + 1 / var_x156;
        ...
        const double var_x165 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x166 = 1.0 + var_x165;
        const double var_x167 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 + 1 / var_x166;
        ...
        const double var_x174 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        const double var_x175 = 1.0 + var_x174;
        const double var_x176 = -var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1 / var_x175;
        ...
        const double var_x187 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x188 = 1.0 + var_x187;
        const double var_x189 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1 / pow(var_x188, 2);
        const double var_x190 = exp(-12.0 - var_x179);
        const double var_x191 = 1.0 + var_x190;
        const double var_x192 = var_x186 * var_x191;
        const double var_x193 = 0.01 * NV_Ith_S(mParameters, 14);
        const double var_x194 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 15));
        const double var_x195 = 1.0 + var_x194;
        const double var_x196 = 1.0 - var_x193;
        const double var_x197 = var_x193 + var_x196 / pow(var_x195, 2);
        const double var_x198 = var_x197 - var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x205 = var_x194 * var_x196 / pow(var_x195, 3);
        const double var_x206 = 0.26917900403768508 * var_x205;
        ...
        const double var_x211 = var_x197 - var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x240 = exp(-0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x247 = exp(2.8571428571428572 + var_x154);
        ...
        const double var_x258 = 1 / NV_Ith_S(mParameters, 8);
        ...
        const double var_x274 = var_x273 * (-0.0082319999999999997 - var_x143);
        ...
        const double var_x279 = NV_Ith_S(mParameters, 12) * NV_Ith_S(mParameters, 3);
        const double var_x280 = 0.00063181349969740233 * var_x279;
        const double var_x281 = 2.7188924024856265e-5 * var_x72;
        const double var_x282 = 0.00027188924024856262 * var_x279;
        const double var_x283 = var_x280 * var_x52;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x23 - var_x26 - var_x27 - var_x29 - var_x32 - var_x63 - var_x79 - NV_Ith_S(mParameters, 9) - NV_Ith_S(mParameters, 10) + 0.0025819888974716113 * var_x66 - 0.0024332029034784559 * var_x68 - 0.043033148291193521 * var_x50 - 0.16722408026755853 * var_x53 - var_x35 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x70 * var_x73);
        IJth(rJacobian, 1, 0) = var_x132 * (0.00063181349969740233 * var_x63 + 1.5373304419206038e-6 * var_x68 - 0.00031590674984870116 * var_x23 - 0.00031590674984870116 * NV_Ith_S(mParameters, 9)) * NV_Ith_S(mParameters, 12);
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x153 * var_x157 * var_x158 + 0.14285714285714285 * var_x155 * var_x160 / pow(var_x156, 2) - 0.10000000000000001 * var_x152 * var_x157 * var_x159;
        IJth(rJacobian, 3, 0) = 0.01488095238095238 * var_x164 * var_x167 * var_x168 - 0.041666666666666664 * var_x165 * var_x170 / pow(var_x166, 2) - 0.050000000000000003 * var_x163 * var_x167 * var_x169;
        IJth(rJacobian, 4, 0) = 4.5454545454545452e-5 * var_x168 * var_x173 * var_x176 + 6.4935064935064935e-5 * var_x174 * var_x178 / pow(var_x175, 2) - 7.5757575757575758e-5 * var_x172 * var_x176 * var_x177 / var_x173;
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x187 * var_x192 / pow(var_x188, 3) - 0.20000000000000001 * var_x186 * var_x189 * var_x190 + 99.999999999999986 * var_x189 * var_x191 * (0.02 * var_x180 / pow(var_x181, 2) + 0.00050000000000000001 * var_x183 / pow(var_x184, 2)) / pow((var_x182 + var_x185), 2);
        IJth(rJacobian, 6, 0) = ((var_x207) ? (var_x198 * (108035.0 * var_x199 + 0.21330000000000002 * var_x200 - 0.008382352941176471 * var_x201) - var_x206 * (var_x202 + var_x203 + var_x204)) : (-1.5943679469924423 * var_x205 * var_x210 + 0.53361053361053368 * var_x198 * var_x208 / pow(var_x209, 2)));
        IJth(rJacobian, 7, 0) = ((var_x207) ? (var_x211 * (var_x218 - 0.00025500480000000003 * var_x222 + var_x217 * var_x223 * (3.0508668000000001e-7 * var_x213 - 6214.6032000000005 * var_x212) + 0.0033402720000000005 * var_x219 * var_x221 / pow(var_x220, 2) - 0.311 * var_x214 * var_x215 * var_x223 / pow(var_x216, 2)) - var_x206 * (var_x224 + var_x225)) : (0.034200000000000001 * var_x211 * var_x229 - 0.16150740242261102 * var_x205 * var_x229 + 0.059999999999999998 * var_x211 * var_x226 * var_x228 / pow(var_x227, 2)));
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x241) * (-0.050000000000000003 * var_x230 / pow(var_x231, 2) + 0.27999999999999997 * var_x233 * var_x238 / pow(var_x234, 2) - 0.15076923076923074 * var_x235 * var_x236 / pow(var_x237, 2)) / pow((var_x239 + 0.7142857142857143 * var_x232), 2) + 0.13333333333333333 * var_x240 * var_x242 / pow(var_x241, 2);
        IJth(rJacobian, 9, 0) = 7.9012345679012348e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x248) * (-var_x249 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 16.5 * var_x243 / pow(var_x244, 2)) / pow((0.071111111111111111 + var_x246 + 0.14666666666666667 * var_x245), 2) - 0.14285714285714285 * var_x247 * var_x250 / pow(var_x248, 2);
        IJth(rJacobian, 11, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x264) * (-var_x265 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + var_x259 / pow(var_x260, 2)) / pow((0.035294117647058823 + var_x262 + 0.058823529411764705 * var_x261), 2) - 0.20000000000000001 * var_x263 * var_x266 / pow(var_x264, 2);
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x267 * var_x270 / pow(var_x268, 2) - 0.10526315789473684 * var_x269 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x268) / pow((0.084210526315789472 + var_x269), 2);
        IJth(rJacobian, 15, 0) = var_x279 * (-0.0018954404990922068 * var_x63 - 0.0018954404990922068 * var_x79 - 4.6119913257618111e-6 * var_x68 - 0.00063181349969740233 * var_x32 - 0.00063181349969740233 * NV_Ith_S(mParameters, 10));
        IJth(rJacobian, 16, 0) = var_x279 * (0.0012636269993948047 * var_x79 + 1.631335441491376e-6 * var_x66 - 0.00027188924024856262 * var_x124 - 2.7188924024856265e-5 * var_x50 - 0.00010565443138752546 * var_x53 - 0.00063181349969740233 * var_x26 - 0.00063181349969740233 * var_x27 - 0.00063181349969740233 * var_x29 - var_x281 * var_x70);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x90 - var_x85 - var_x87 + 2.5 * var_x91 - 13.356880329847826 * var_x89);
        IJth(rJacobian, 1, 1) = var_x132 * (var_x133 - var_x135 + (0.00031590674984870116 * var_x90 - 0.0042195286531202733 * var_x89 - 0.0015795337492435057 * var_x91 - 0.00031590674984870116 * var_x85 - 0.00031590674984870116 * var_x87) * NV_Ith_S(mParameters, 12)) + 0.00029999999999999997 * (var_x136 + var_x146 - var_x137 - var_x139 * (var_x87 * var_chaste_interface__calcium_dynamics__Ca_i + (-13.356880329847826 * log(var_x88 * NV_Ith_S(mParameters, 4)) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 9) - 2.0 * var_x62 * var_x67 + ((var_x12) ? (-var_x138 + 374338.90822745475 * (1.3356880329847825e-6 + var_chaste_interface__membrane__V) * (var_x138 + var_x101 * var_chaste_interface__L_type_Ca_current_d_gate__d)) : (var_x20 * var_chaste_interface__membrane__V)))) / (pow(var_x129, 3) * pow(var_x130, 2));
        IJth(rJacobian, 10, 1) = ((var_x257) ? (0) : (var_x258 * (-6.8203084950904297e-28 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 7) / pow((1.2447063003540035e-28 + var_x256), 2) - 171.23287671232876 * var_x254 / pow(var_x255, 2) - 684.93150684931504 * var_x252 / pow(var_x253, 2))));
        IJth(rJacobian, 13, 1) = var_x273 * (var_x135 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 14, 1) = ((var_x278) ? (0) : ((var_x276) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5) / pow((1.8382656249999998e-21 + var_x275), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15) / pow((5.0709427749024951e-56 + var_x277), 2))));
        IJth(rJacobian, 15, 1) = 0.0047386012477305169 * var_x279 * var_x91;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x35 * var_x52);
        IJth(rJacobian, 2, 2) = -var_x160;
        IJth(rJacobian, 16, 2) = -var_x282 * var_x34 * var_x52;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.43033148291193518 * var_x92);
        IJth(rJacobian, 3, 3) = -var_x170;
        IJth(rJacobian, 16, 3) = -var_x282 * var_x92;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-2 * var_x94);
        IJth(rJacobian, 4, 4) = -0.00090909090909090909 * var_x178;
        IJth(rJacobian, 16, 4) = -0.0012636269993948047 * var_x279 * var_x94;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x98);
        IJth(rJacobian, 5, 5) = -var_x192;
        IJth(rJacobian, 15, 5) = -0.0018954404990922068 * var_x279 * var_x98;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x99);
        IJth(rJacobian, 6, 6) = ((var_x207) ? (-var_x202 - var_x203 - var_x204) : (-5.9230769230769234 * var_x210));
        IJth(rJacobian, 15, 6) = -var_x280 * var_x99;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x100);
        IJth(rJacobian, 7, 7) = ((var_x207) ? (-var_x224 - var_x225) : (-0.59999999999999998 * var_x229));
        IJth(rJacobian, 15, 7) = -var_x100 * var_x280;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x105);
        IJth(rJacobian, 1, 8) = var_x132 * (var_x145 - var_x105 * var_x139);
        IJth(rJacobian, 8, 8) = -var_x242;
        IJth(rJacobian, 13, 8) = var_x274 * var_chaste_interface__calcium_dynamics__g;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x108);
        IJth(rJacobian, 1, 9) = -var_x108 * var_x147;
        IJth(rJacobian, 9, 9) = -var_x250;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x111);
        IJth(rJacobian, 1, 10) = -var_x111 * var_x147;
        IJth(rJacobian, 10, 10) = ((var_x257) ? (0) : (-var_x258));
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x112 * var_x28);
        IJth(rJacobian, 11, 11) = -var_x266;
        IJth(rJacobian, 16, 11) = -var_x28 * var_x283;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x112 * var_x113);
        IJth(rJacobian, 12, 12) = -var_x270;
        IJth(rJacobian, 16, 12) = -var_x113 * var_x283;
        IJth(rJacobian, 1, 13) = var_x132 * (var_x150 * (var_x149 - var_x148) + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 13, 13) = var_x273 * (var_x133 + var_x150 * (var_x148 - var_x149)) + 9.9963436928702016 * (var_x137 - var_x136 - var_x146) / (pow(var_x271, 3) * pow((0.33333333333333337 + var_x272), 2));
        IJth(rJacobian, 1, 14) = var_x132 * var_x144 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 13, 14) = var_x274 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 14, 14) = ((var_x278) ? (0) : (-0.5));
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x117 - 3 * var_x120 + 0.00062500000000000001 * var_x119 - 26.713760659695652 * var_x114 - 26.713760659695652 * var_x118 - 0.80141281979086942 * var_x115);
        IJth(rJacobian, 1, 15) = 0.0018954404990922068 * var_x120 * var_x131 * NV_Ith_S(mParameters, 12);
        IJth(rJacobian, 15, 15) = var_x279 * (1.1846503119326294e-6 * var_x119 - 0.0018954404990922068 * var_x117 - 0.016878114612481093 * var_x114 - 0.016878114612481093 * var_x118 - 0.0056863214972766203 * var_x120);
        IJth(rJacobian, 16, 15) = var_x279 * (0.0012636269993948047 * var_x117 - 0.00050634343837443281 * var_x115 - 7.8976687462175284e-7 * var_x119);
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (0.068974633433048077 * var_x128 - 26.713760659695652 * var_x115 - 26.713760659695652 * var_x121 - 26.713760659695652 * var_x122 - 1.1495772238841346 * var_x123 - 11.495772238841345 * var_x125 - var_x127 * var_x73);
        IJth(rJacobian, 16, 16) = var_x279 * (4.357910453967955e-5 * var_x128 - 0.016878114612481093 * var_x115 - 0.016878114612481093 * var_x121 - 0.016878114612481093 * var_x122 - 0.00072631840899465921 * var_x123 - 0.0072631840899465916 * var_x125 - var_x127 * var_x281);
    }

    N_Vector Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2004_epiFromCellMLCvodeOpt>::Initialise(void)
{
