...
const double var_x0 = exp(9.9999999999999995e-8);
        ...
        const double var_x105 = ((var_x12) ? (var_x101 + var_x80 * (-var_x101 - var_x102)) : (var_x104 * var_chaste_interface__L_type_Ca_current_f_gate__f));
        const double var_x106 = var_x81 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        const double var_x107 = var_x106 * var_x3;
        const double var_x108 = ((var_x12) ? (var_x107 + var_x80 * (-var_x107 - var_x10 * var_x106)) : (var_x104 * var_chaste_interface__L_type_Ca_current_d_gate__d));
        const double var_x109 = 0.019297068299999998 * NV_Ith_S(mParameters, 7);
        const double var_x110 = var_x109 * var_x5;
        const double var_x111 = ((var_x12) ? (var_x110 + var_x80 * (-var_x110 - var_x109 * var_x11)) : (var_x103 * var_x4 * NV_Ith_S(mParameters, 7) * var_chaste_interface__membrane__V));
