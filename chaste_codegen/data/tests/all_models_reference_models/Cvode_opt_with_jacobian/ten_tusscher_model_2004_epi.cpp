...
const double var_x0 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2);
        ...
        const double var_x236 = var_x235 * (-0.0082319999999999997 - var_x108);
        ...
        const double var_x243 = (0.0031224512033090025 * var_x12 - 0.00011688549744401942 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2);
        const double var_x244 = 0.0031224512033090025 * var_x12 - 0.00011688549744401942 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x229 * var_x232 / pow(var_x230, 2) - 0.10526315789473684 * var_x231 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x230) / pow((0.084210526315789472 + var_x231), 2);
        ...
        IJth(rJacobian, 16, 0) = 0.00026864670518789814 * var_x48 + 3.79059668210955e-6 * var_x39 - 2.8537261917770623e-7 * var_x30 - 0.00011688549744401942 * var_x27 - 6.3176611368492499e-5 * var_x25 - 1.7065282626826835e-6 * var_x3 - 2.8636946873784758e-5 * var_x0 - 0.00011688549744401942 * var_x33 - var_x242 * var_x41;
        ...
        IJth(rJacobian, 13, 1) = var_x235 * (8.0000000000000007e-5 + var_x101);
        IJth(rJacobian, 14, 1) = ((var_x241) ? (0) : ((var_x238) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5) / pow((1.8382656249999998e-21 + var_x239), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15) / pow((5.0709427749024951e-56 + var_x240), 2))));
        ...
        IJth(rJacobian, 16, 2) = var_x243 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        IJth(rJacobian, 16, 3) = var_x243 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        IJth(rJacobian, 13, 8) = var_x236 * var_chaste_interface__calcium_dynamics__g;
        ...
        IJth(rJacobian, 16, 11) = var_x244 * var_x26;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79 * var_x80);
        IJth(rJacobian, 12, 12) = -var_x232;
        IJth(rJacobian, 16, 12) = var_x244 * var_x80;
        IJth(rJacobian, 1, 13) = var_x98 * (8.0000000000000007e-5 + var_x115 * (var_x113 - var_x114));
        IJth(rJacobian, 13, 13) = var_x235 * (-8.0000000000000007e-5 + var_x115 * (var_x114 - var_x113)) + 9.9963436928702016 * (var_x103 + var_x104 - var_x102 - var_x111) / (pow(var_x233, 3) * pow((0.33333333333333337 + var_x234), 2));
        IJth(rJacobian, 1, 14) = var_x109 * var_x98 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 13, 14) = var_x236 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 14, 14) = ((var_x241) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 16, 16) = 0.00010126109252331096 * var_x93 - 0.0073440052301827737 * var_x85 - 0.0031224512033090025 * var_x92 - 0.0016876848753885161 * var_x88 - 4.5587787568311439e-5 * var_x87 - 0.0031224512033090025 * var_x89 - var_x242 * var_x91;
    }
