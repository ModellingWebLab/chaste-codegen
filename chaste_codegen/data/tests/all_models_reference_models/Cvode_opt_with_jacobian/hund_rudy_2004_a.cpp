...
// LCOV_EXCL_STOP
    ...
    void Cellhund_rudy_2004_aFromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: mV; Initial value: -85.781844107117
        double var_chaste_interface__Ca__Ca_i = NV_Ith_S(rY, 1);
...
const double var_x0 = exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V);
        ...
        const double var_x308 = 1.0 - var_chaste_interface__Ito__ydv;
        ...
        const double var_x312 = var_chaste_interface__Ito__ydv;
        ...
        const double var_x328 = pow(var_x97, (-2));
        const double var_x329 = pow(NV_Ith_S(mParameters, 0), (-2));
        const double var_x330 = pow(var_chaste_interface__ICaL__d, (-2 * var_chaste_interface__ICaL__dp));
        const double var_x331 = pow(var_chaste_interface__ICaL__f, (-2));
        const double var_x332 = pow(var_chaste_interface__ICaL__f2, (-2));
        const double var_x333 = pow(var_chaste_interface__ICaL__fca, (-2));
        const double var_x334 = pow(var_chaste_interface__ICaL__fca2, (-2));
        const double var_x335 = var_x104 * var_x328 * var_x329 * var_x330 * var_x331 * var_x332 * var_x333 * var_x334;
        const double var_x336 = pow(var_x327, (-2));
        const double var_x337 = var_x328 * var_x329 * var_x330 * var_x332 * var_x333 * var_x334 * var_x336;
        const double var_x338 = 5.399297452372711e-5 * var_x331;
        const double var_x339 = var_x104 * var_x329 * var_x330 * var_x332 * var_x334 * var_x336;
        const double var_x340 = var_x333 * var_x339 / pow(var_x97, 3);
        ...
        const double var_x346 = var_x335 * var_x336;
        const double var_x347 = 1.0 + 0.00036056965579880955 * var_x346;
        const double var_x348 = var_x341 * var_x345 / pow(var_x347, 2);
        const double var_x349 = 0.00024037977053253972 * var_x348;
        const double var_x350 = var_x346 * var_x349;
        const double var_x351 = var_x104 * var_x349;
        const double var_x352 = var_x328 * var_x331;
        const double var_x353 = var_x329 * var_x330 * var_x333 * var_x336 * var_x351 * var_x352;
        const double var_x354 = 1 / var_x347;
        const double var_x355 = var_x354 / pow((var_x344 + 0.00060803092942449902 * var_x341), 2);
        ...
        const double var_x359 = exp(-16.0 + 80.0 * var_x358 + 40000.0 * var_chaste_interface__Ca__Ca_ss);
        ...
        const double var_x367 = var_x359 * var_x366 / pow(var_x360, 2);
        const double var_x368 = 17.524312015706236 * var_x109;
        const double var_x369 = var_x356 / pow(var_x357, 2);
        const double var_x370 = var_x369 * (234.05767907220539 * var_x241 + var_x111 * var_x368 - var_x105 * var_x368);
        const double var_x371 = (-var_chaste_interface__Irel__ri + 1 / var_x360) / pow((0.29999999999999999 + var_x172 + 0.10000000000000001 * var_x365), 2);
        const double var_x372 = var_x361 * var_x364 / pow(var_x362, 2);
        ...
        const double var_x378 = var_x254 * var_x369;
        const double var_x379 = 0.01 * var_x371;
        const double var_x380 = var_x261 * var_x369;
        const double var_x381 = 3.998848287353967e-7 * var_x3;
        const double var_x382 = 0.00050754612877954204 * var_x76;
        ...
        const double var_x393 = 8.5232067604091287e-7 * var_x35;
        const double var_x394 = 1.1688941147650058e-5 * var_x80;
        ...
        const double var_x402 = 8.8885199344722979e-8 * var_x42;
        ...
        const double var_x406 = 3000.0 * var_x405;
        const double var_x407 = 0.70217303721661617 * var_x100;
        const double var_x408 = 0.052572936047118712 * var_x106;
        ...
        const double var_x414 = var_x413 * (var_x407 + var_x111 * var_x408 - var_x105 * var_x408);
        const double var_x415 = 1 / var_x410;
        const double var_x416 = var_x415 * var_chaste_interface__Irel__ri;
        const double var_x417 = var_x411 * var_x416;
        const double var_x418 = var_x412 * var_x415;
        ...
        const double var_x423 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x424 = var_x179 * var_x423;
        const double var_x425 = var_x174 * var_x423;
        const double var_x426 = 0.0002749177168957104 * var_x109;
        ...
        const double var_x432 = 0.0036718475849305066 * var_x430;
        const double var_x433 = 719.99999999999989 * var_x430;
        ...
        IJth(rJacobian, 5, 0) = 1.5624999999999998 * (-var_chaste_interface__ICaL__d + 1 / var_x233) * (-0.041599999999999998 * var_x231 + 0.10560000000000001 * var_x228 * var_x230 / pow(var_x229, 2)) / pow((0.73749999999999993 + var_x231), 2) + 0.14836795252225518 * var_x232 * var_x234 / pow(var_x233, 2);
        ...
        IJth(rJacobian, 11, 0) = (-var_chaste_interface__IKr__xr + 1 / var_x276) * (var_x279 + var_x282 - 8.1600000000000005e-5 * var_x280 * var_x283 / pow(var_x281, 2) - 4.566e-5 * var_x277 * var_x284 / pow(var_x278, 2)) + 0.23529411764705882 * var_x275 * (var_x285 + var_x286) / pow(var_x276, 2);
        IJth(rJacobian, 12, 0) = 0.04048582995951417 * var_x303 + var_x300 * (-var_chaste_interface__IKs__xs1 + var_x289);
        ...
        IJth(rJacobian, 21, 0) = 0.33333333333333331 * var_x348 * (4.8075954106507941e-5 * var_x335 / pow(var_x327, 3) + var_x338 * var_x340 * var_x96 - var_x337 * var_x338 * var_x95 * var_x98);
        IJth(rJacobian, 22, 0) = 80.0 * var_x367 * var_x370 - 0.14999999999999999 * var_x370 * var_x373;
        IJth(rJacobian, 23, 0) = -8.9372253111180233e-5 * var_x50 - 5.456580259819789e-6 * var_x93 - 0.00083053002891197785 * var_x74 - var_x381 * var_chaste_interface__INal__hL - var_x382 * var_chaste_interface__INa__H;
        IJth(rJacobian, 24, 0) = var_x392 + 5.5345498444215123e-8 * var_x87 + 5.9581502074120151e-5 * var_x50 + 7.4830755604969202e-6 * var_x61 - 1.6979725035533768e-7 * var_x2 - 3.137557887000805e-5 * var_x25 - 3.8963137158833531e-8 * var_x90 - 2.8394189022631718e-8 * var_x53 - var_x393 * var_chaste_interface__IKr__xr - var_x394 * var_chaste_interface__Ito__ydv2 - var_x395 * var_x84;
        IJth(rJacobian, 25, 0) = 1.3842167148532964e-8 + 3.3274959682366304e-9 * var_x88 - 3.3274959682366302e-7 * var_x58 + var_x402 * var_chaste_interface__Ito2__AA;
        IJth(rJacobian, 26, 0) = var_x406 * var_x414;
        IJth(rJacobian, 28, 0) = var_x431 * (-719.99999999999989 * var_x414 - 0.0036718475849305066 * var_x241 + var_x105 * var_x426 - var_x111 * var_x426);
        ...
        IJth(rJacobian, 27, 1) = -var_x424 + 0.0043750000000000004 * var_x176;
        IJth(rJacobian, 28, 1) = 5.0 * var_x430;
        ...
        IJth(rJacobian, 23, 2) = -var_x126 * var_x382;
        ...
        IJth(rJacobian, 21, 5) = var_x131 * var_x350;
        IJth(rJacobian, 22, 5) = var_x251 * var_x375 - var_x251 * var_x377;
        IJth(rJacobian, 28, 5) = -var_x251 * var_x432;
        ...
        IJth(rJacobian, 21, 6) = var_x132 * var_x350;
        IJth(rJacobian, 22, 6) = var_x252 * var_x375 - var_x252 * var_x377;
        IJth(rJacobian, 28, 6) = -var_x252 * var_x432;
        ...
        IJth(rJacobian, 21, 7) = var_x337 * var_x351 / pow(var_chaste_interface__ICaL__f, 3);
        IJth(rJacobian, 22, 7) = var_x374 * var_x378 - var_x376 * var_x378;
        IJth(rJacobian, 28, 7) = -var_x254 * var_x432;
        ...
        IJth(rJacobian, 21, 8) = var_x339 * var_x349 * var_x352 / pow(var_chaste_interface__ICaL__fca, 3);
        IJth(rJacobian, 22, 8) = var_x135 * var_x375 - var_x135 * var_x377;
        IJth(rJacobian, 28, 8) = -var_x135 * var_x432;
        ...
        IJth(rJacobian, 21, 9) = var_x332 * var_x353 / pow(var_chaste_interface__ICaL__fca2, 3);
        IJth(rJacobian, 22, 9) = var_x256 * var_x375 - var_x256 * var_x377;
        IJth(rJacobian, 28, 9) = -var_x256 * var_x432;
        ...
        IJth(rJacobian, 21, 10) = var_x334 * var_x353 / pow(var_chaste_interface__ICaL__f2, 3);
        IJth(rJacobian, 22, 10) = var_x257 * var_x375 - var_x257 * var_x377;
        IJth(rJacobian, 28, 10) = -var_x257 * var_x432;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x36 * var_x52);
        IJth(rJacobian, 11, 11) = -var_x285 - var_x286;
        IJth(rJacobian, 24, 11) = -var_x393 * var_x52;
        ...
        IJth(rJacobian, 24, 15) = -var_x394 * var_x52;
        ...
        IJth(rJacobian, 25, 17) = var_x402 * var_chaste_interface__cell__V;
        ...
        IJth(rJacobian, 23, 19) = -var_x126 * var_x381;
        ...
        IJth(rJacobian, 22, 20) = var_x379 * (var_x258 - var_x258 * var_x363);
        IJth(rJacobian, 27, 20) = var_x185 * var_x425 + var_x187 * var_x424;
        IJth(rJacobian, 21, 21) = -0.33333333333333331;
        IJth(rJacobian, 26, 21) = -var_x406 * var_x417;
        IJth(rJacobian, 28, 21) = var_x417 * var_x433;
        IJth(rJacobian, 22, 22) = -var_x366;
        IJth(rJacobian, 26, 22) = -var_x406 * var_x418;
        IJth(rJacobian, 28, 22) = var_x418 * var_x433;
        ...
        IJth(rJacobian, 23, 23) = var_x388 + 4.9335731356566794e-16 * var_x143 - 1.7874450622236046e-6 * var_x141 - 1.068185898837083e-5 * var_x142 - 0.013557744100624516 * var_x147 - 0.0044848621561246801 * var_x146;
        IJth(rJacobian, 24, 23) = 3.9005476114801918 * var_x396 + 1.191630041482403e-6 * var_x141;
        IJth(rJacobian, 25, 23) = var_x388;
        ...
        IJth(rJacobian, 24, 24) = var_x400 + 212.79583259575517 * var_x396 + 0.00019989044893084398 * var_x153 - 4.535681662754383e-6 * var_x148 - 0.00031223895504468581 * var_x154 - 2.2767478584105716e-5 * var_x150 - 0.0008381150898567882 * var_x149 - var_x152 * var_x395;
        IJth(rJacobian, 25, 24) = var_x400;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (0.00601027620873753 * var_x155 - 0.001444800488100033 * var_x57);
        IJth(rJacobian, 23, 25) = var_x389;
        IJth(rJacobian, 24, 25) = var_x401;
        IJth(rJacobian, 25, 25) = var_x389 + var_x401 + 8.8885199344722979e-8 * var_x57 - 3.6975665728975948e-7 * var_x155;
        IJth(rJacobian, 21, 26) = -2.3414435371998602e-7 * var_x355 * pow(var_chaste_interface__Ca__Ca_jsr, 2.7999999999999998) + 0.6333333333333333 * var_x345 * var_x354 * pow(var_chaste_interface__Ca__Ca_jsr, 0.89999999999999991);
        IJth(rJacobian, 26, 26) = var_x421 * (-0.0083333333333333332 - var_x420) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0.0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x411 * var_x420) / (pow(var_x403, 3) * pow((0.125 + var_x404), 2));
        IJth(rJacobian, 27, 26) = 0.00072463768115942019;
        IJth(rJacobian, 28, 26) = var_x430 * var_x434;
        IJth(rJacobian, 1, 27) = 2.3676470588235295e-5 * var_x161;
        IJth(rJacobian, 26, 27) = 0.0083333333333333332 * var_x405;
        ...
        IJth(rJacobian, 21, 28) = var_x331 * var_x340 * var_x349 * var_x95 - 0.00020267697647483301 * var_x165 * var_x341 * var_x342 * var_x344 * var_x355 * (1.8999999999999999 * var_x343 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x342, 2));
        IJth(rJacobian, 22, 28) = var_x379 * (var_x262 + var_x372 * (5000.0 - 3510.8651860830805 * var_x380) - var_x262 * var_x363) - var_x367 * (40000.0 - 18724.614325776431 * var_x380);
        IJth(rJacobian, 26, 28) = var_x421 * (var_x420 + 2106.5191116498486 * var_x422);
        IJth(rJacobian, 27, 28) = var_x192 * var_x425 + var_x193 * var_x424;
        IJth(rJacobian, 28, 28) = var_x431 * (-5.0 - var_x434 - 0.0036718475849305066 * var_x261 - 505.56458679596358 * var_x422) + (0.019557600000000001 / pow(var_x427, 3) + 8.1780000000000006e-5 / pow(var_x428, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0.0036718475849305066 * var_x246 + var_x411 * var_x434) / pow(var_x429, 2);
    }
