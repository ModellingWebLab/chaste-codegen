...
const double var_x0 = exp(1.0000000000609274e-7);
        ...
        const double var_x93 = ((var_x14) ? (var_x89 + var_x86 * (-var_x89 - var_x90)) : (var_x92 * var_chaste_interface__L_type_Ca_current_f_gate__f));
        const double var_x94 = var_x87 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        const double var_x95 = var_x4 * var_x94;
        const double var_x96 = ((var_x14) ? (var_x95 + var_x86 * (-var_x95 - var_x11 * var_x94)) : (var_x92 * var_chaste_interface__L_type_Ca_current_d_gate__d));
        const double var_x97 = 0.01929706830117572 * NV_Ith_S(mParameters, 7);
        const double var_x98 = var_x97 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x99 = var_x6 * var_x98;
        const double var_x100 = var_x5 * var_x91 * NV_Ith_S(mParameters, 7);
        const double var_x101 = ((var_x14) ? (var_x99 + var_x86 * (-var_x99 - var_x12 * var_x98)) : (var_x100 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass));
        const double var_x102 = var_x97 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        const double var_x103 = var_x102 * var_x6;
        const double var_x104 = ((var_x14) ? (var_x103 + var_x86 * (-var_x103 - var_x102 * var_x12)) : (var_x100 * var_chaste_interface__L_type_Ca_current_f2_gate__f2));
