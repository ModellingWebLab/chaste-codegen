...
const double var_x0 = exp(0.29411764705882354 - 0.058823529411764705 * var_chaste_interface__membrane__V);
        ...
        const double var_x30 = NV_Ith_S(mParameters, 4) * _lt_0_row[4];
        ...
        const double var_x154 = 0.01 * NV_Ith_S(mParameters, 10);
        const double var_x155 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 11));
        const double var_x156 = 1.0 + var_x155;
        const double var_x157 = 1.0 - var_x154;
        const double var_x158 = var_x154 + var_x157 / pow(var_x156, 2);
        const double var_x159 = var_x158 - var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x160 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 11));
        const double var_x161 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x162 = exp(-11.764705882352942 - var_x102 + 0.14705882352941177 * NV_Ith_S(mParameters, 11));
        ...
        const double var_x166 = var_x155 * var_x157 / pow(var_x156, 3);
        const double var_x167 = 0.26917900403768508 * var_x166;
        const double var_x168 = var_chaste_interface__membrane__V < -40.0;
        const double var_x169 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 11) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x170 = 1.0 + var_x169;
        const double var_x171 = 1 / var_x170;
        const double var_x172 = var_x158 - var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x173 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x174 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 11) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x175 = -25428.0 * var_x173 - 6.9480000000000002e-6 * var_x174;
        const double var_x176 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 11));
        const double var_x177 = 1.0 + var_x176;
        const double var_x178 = 1 / var_x177;
        const double var_x179 = var_x175 * var_x178;
        const double var_x180 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 11) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x181 = 1.0 + var_x180;
        const double var_x182 = exp(0.01052 * NV_Ith_S(mParameters, 11) - 0.01052 * var_chaste_interface__membrane__V);
        ...
        const double var_x187 = exp(-3.2000000000000002 - var_x7 + 0.10000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x188 = 1.0 + var_x187;
        const double var_x189 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * NV_Ith_S(mParameters, 11));
        ...
        const double var_x203 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x214 = exp(2.8571428571428572 + var_x113);
        const double var_x215 = 1.0 + var_x214;
        const double var_x216 = var_x206 / pow(var_x207, 2);
        ...
        const double var_x223 = exp(5.0 + var_x113);
        ...
        const double var_x230 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x227), 2);
        ...
        const double var_x253 = var_chaste_interface__calcium_dynamics__R_prime * NV_Ith_S(mParameters, 1);
        ...
        const double var_x264 = var_x252 * var_x257 * NV_Ith_S(mParameters, 1);
        const double var_x265 = var_x249 * var_x263 * var_x264;
        const double var_x266 = var_x49 * NV_Ith_S(mParameters, 8);
        ...
        const double var_x272 = var_x267 * var_x270 * var_x46;
        const double var_x273 = var_x272 * var_x73;
        ...
        const double var_x277 = NV_Ith_S(mParameters, 8) * NV_Ith_S(mParameters, 3);
        const double var_x278 = 0.00063181349969740233 * var_x277;
        const double var_x279 = 0.00027188924024856262 * var_x277;
        const double var_x280 = var_x16 * var_x278;
        ...
        IJth(rJacobian, 7, 0) = ((var_x168) ? (var_x159 * (108035.0 * var_x160 + 0.21330000000000002 * var_x161 - 0.008382352941176471 * var_x162) - var_x167 * (var_x163 + var_x164 + var_x165)) : (-1.5943679469924423 * var_x166 * var_x171 + 0.53361053361053368 * var_x159 * var_x169 / pow(var_x170, 2)));
        IJth(rJacobian, 8, 0) = ((var_x168) ? (var_x172 * (var_x179 - 0.00025500480000000003 * var_x183 + var_x178 * var_x184 * (3.0508668000000001e-7 * var_x174 - 6214.6032000000005 * var_x173) + 0.0033402720000000005 * var_x180 * var_x182 / pow(var_x181, 2) - 0.311 * var_x175 * var_x176 * var_x184 / pow(var_x177, 2)) - var_x167 * (var_x185 + var_x186)) : (0.034200000000000001 * var_x172 * var_x190 - 0.16150740242261102 * var_x166 * var_x190 + 0.059999999999999998 * var_x172 * var_x187 * var_x189 / pow(var_x188, 2)));
        IJth(rJacobian, 9, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x204) * (-0.050000000000000003 * var_x191 / pow(var_x192, 2) + 0.27999999999999997 * var_x194 * var_x201 / pow(var_x195, 2) - 0.15076923076923074 * var_x196 * var_x199 / pow(var_x200, 2)) / pow((var_x202 + 0.7142857142857143 * var_x193), 2) + 0.13333333333333333 * var_x203 * var_x205 / pow(var_x204, 2);
        IJth(rJacobian, 10, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x215) * (18.0 * var_x216 - var_x217 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x209 / pow(var_x210, 2)) / pow((0.018140589569160998 + var_x213 + 0.16326530612244897 * var_x208 + 0.18140589569160998 * var_x211), 2) - 0.14285714285714285 * var_x214 * var_x218 / pow(var_x215, 2);
        IJth(rJacobian, 11, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x224) * (8.0 * var_x216 - var_x225 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x219 / pow(var_x220, 2)) / pow((var_x222 + 0.055160142348754451 * var_x221 + 0.14234875444839859 * var_x208), 2) - 0.095714285714285724 * var_x223 * var_x226 / pow(var_x224, 2);
        IJth(rJacobian, 13, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x236) * (-var_x237 * (-0.15625 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + var_x231 / pow(var_x232, 2)) / pow((0.49411764705882355 + var_x234 + 0.058823529411764705 * var_x233), 2) - 0.076923076923076927 * var_x235 * var_x238 / pow(var_x236, 2);
        IJth(rJacobian, 14, 0) = 0.076923076923076927 * var_x239 * var_x242 / pow(var_x240, 2) - 0.09569377990430622 * var_x241 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x240) / pow((0.69856459330143539 + var_x241), 2);
        IJth(rJacobian, 16, 0) = var_x271 * (-var_x267 * var_x47 + 102.50886482291351 * var_x266 * var_x53 - 25.627216205728377 * var_x55 * NV_Ith_S(mParameters, 8));
        IJth(rJacobian, 18, 0) = var_x277 * (-1.8322591491224666e-7 - 0.0018954404990922068 * var_x35 - 9.2026163484925422e-6 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 4.6119913257618111e-6 * var_x43 - 0.00063181349969740233 * var_x21 - 0.0051631799195271718 * var_x41);
        IJth(rJacobian, 19, 0) = var_x277 * (6.318134996974023e-5 * var_x22 + 0.0034421199463514477 * var_x41 - 0.00027188924024856262 * var_x91 - 9.2244770955820725e-6 * var_x5 - 1.4806296640008744e-5 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 0.00063181349969740233 * var_x10 - 0.00063181349969740233 * var_x12 - 0.00063181349969740233 * var_x6 - 1.5425546982578716e-6 * var_x17 - 8.4365684959594308e-7 * var_x18 - 1.4342166443131033e-5 * var_x2);
        ...
        IJth(rJacobian, 15, 1) = var_x246 * (1.2499999999999999e-7 * var_x99 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 16, 1) = 1.1399999999999999 * var_x270;
        IJth(rJacobian, 18, 1) = 0.0047386012477305169 * var_x277 * var_x61;
        ...
        IJth(rJacobian, 18, 2) = var_x277 * (0.00024583649057663214 * var_x63 - 9.2026163484925422e-6 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 19, 2) = var_x277 * (0.00039553186469764944 * var_x14 - 1.4806296640008744e-5 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x16 * var_x25);
        IJth(rJacobian, 3, 3) = -var_x119;
        IJth(rJacobian, 19, 3) = -var_x16 * var_x24 * var_x279;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.43033148291193518 * var_x64);
        IJth(rJacobian, 4, 4) = -var_x129;
        IJth(rJacobian, 19, 4) = -var_x279 * var_x64;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-2 * var_x66);
        IJth(rJacobian, 5, 5) = -var_x139;
        IJth(rJacobian, 19, 5) = -0.0012636269993948047 * var_x277 * var_x66;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x69);
        IJth(rJacobian, 6, 6) = -var_x153;
        IJth(rJacobian, 18, 6) = -0.0018954404990922068 * var_x277 * var_x69;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x70);
        IJth(rJacobian, 7, 7) = ((var_x168) ? (-var_x163 - var_x164 - var_x165) : (-5.9230769230769234 * var_x171));
        IJth(rJacobian, 18, 7) = -var_x278 * var_x70;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x71);
        IJth(rJacobian, 8, 8) = ((var_x168) ? (-var_x185 - var_x186) : (-0.59999999999999998 * var_x190));
        IJth(rJacobian, 18, 8) = -var_x278 * var_x71;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x52 * var_x72);
        IJth(rJacobian, 9, 9) = -var_x205;
        IJth(rJacobian, 16, 9) = -var_x272 * var_x52;
        ...
        IJth(rJacobian, 16, 10) = -var_x273 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x74 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 11, 11) = -var_x226;
        IJth(rJacobian, 16, 11) = -var_x273 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x72 * var_x75);
        IJth(rJacobian, 12, 12) = -var_x229;
        IJth(rJacobian, 16, 12) = -var_x272 * var_x75;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x11 * var_x76);
        IJth(rJacobian, 13, 13) = -var_x238;
        IJth(rJacobian, 19, 13) = -var_x11 * var_x280;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x76 * var_x77);
        IJth(rJacobian, 14, 14) = -var_x242;
        IJth(rJacobian, 19, 14) = -var_x280 * var_x77;
        IJth(rJacobian, 1, 15) = var_x95 * var_x97;
        IJth(rJacobian, 15, 15) = var_x246 * (-var_x255 - NV_Ith_S(mParameters, 0) + 0.21333333333333335 * var_x261 - 0.032000000000000001 * var_x259) + 0.66666666666666674 * (var_x101 - var_x100 * NV_Ith_S(mParameters, 0) - var_x255 * var_x257) / (pow(var_x243, 3) * pow((0.33333333333333337 + var_x244), 2));
        IJth(rJacobian, 16, 15) = var_x271 * (var_x275 + 0.64023408924652514 * var_x259 - 4.2682272616435011 * var_x261);
        IJth(rJacobian, 17, 15) = 0.059999999999999998 * var_x256 * var_x263;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-3611.8217397063127 * var_x78);
        IJth(rJacobian, 1, 16) = 0.0038 * var_x95;
        IJth(rJacobian, 12, 16) = -0.0030000000000000001 * var_x229 * var_x230 + 6.2500000000000001e-5 * var_x230 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x228) / pow((0.025000000000000001 + var_x228), 2);
        IJth(rJacobian, 15, 16) = var_x246 * (var_x255 + 0.32000000000000001 * var_x262 - 0.29999999999999999 * var_x265);
        IJth(rJacobian, 16, 16) = var_x271 * (-1.1399999999999999 - var_x275 + 6.0021945866861737 * var_x265 - 6.4023408924652525 * var_x262 - 342.29966004705079 * var_x78 * NV_Ith_S(mParameters, 8)) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x257 * var_x275 - var_x267 * var_x54) / (pow(var_x268, 3) * pow(var_x269, 2));
        IJth(rJacobian, 17, 16) = var_x276 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 15, 17) = -var_x245 * var_x251 * var_x264;
        IJth(rJacobian, 16, 17) = var_x264 * var_x270 * var_x274;
        IJth(rJacobian, 17, 17) = -0.0050000000000000001 + var_x276 * var_chaste_interface__calcium_dynamics__Ca_ss;
        ...
        IJth(rJacobian, 18, 18) = var_x277 * (3.2269874497044823e-6 * var_x83 - 0.016878114612481093 * var_x84 - 4.8946532376195178e-6 * var_x62 - 0.0056863214972766203 * var_x85 - 0.00024583649057663214 * var_x79 - 0.0051631799195271718 * var_x82);
        IJth(rJacobian, 19, 18) = var_x277 * (0.0034421199463514477 * var_x82 - 2.151324966469655e-6 * var_x83 - 0.00050634343837443281 * var_x80);
        ...
        IJth(rJacobian, 19, 19) = var_x277 * (-0.00024642047334222399 * var_x88 - 0.016878114612481093 * var_x80 - 0.016878114612481093 * var_x89 - 0.016878114612481093 * var_x90 - 0.00038313320170332084 * var_x87 - 0.00039553186469764944 * var_x86 - 0.0072631840899465916 * var_x92);
    }
