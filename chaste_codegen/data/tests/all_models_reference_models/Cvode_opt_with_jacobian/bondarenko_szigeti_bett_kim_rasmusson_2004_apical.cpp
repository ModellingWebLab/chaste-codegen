...
class Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables()
    {
...
protected:
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables(const Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables&);
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables& operator= (const Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables&);
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables()
    {
        ...
        Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables> Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt::Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt>::Instance();
        Init();
    ...
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt::~Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt()
    {
    }

    AbstractLookupTableCollection* Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -82.4202
        double var_chaste_interface__calcium_concentration__Cai_converted = NV_Ith_S(rY, 1);
...
const double var_x0 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 2) * NV_Ith_S(mParameters, 14);
        ...
        const double var_x5 = pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 3) * NV_Ith_S(mParameters, 16);
        const double var_x6 = var_x5 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x7 = NV_Ith_S(mParameters, 12) * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss;
        ...
        const double var_x21 = NV_Ith_S(mParameters, 11) / (210.0 + NV_Ith_S(mParameters, 5));
        const double var_x22 = var_x21 / var_x20;
        const double var_x23 = var_x22 * NV_Ith_S(mParameters, 5);
        const double var_x24 = _lt_0_row[2];
        const double var_x25 = pow(NV_Ith_S(mParameters, 6), 3);
        const double var_x26 = var_x24 * var_x25;
        const double var_x27 = NV_Ith_S(mParameters, 4) * _lt_0_row[1];
        ...
        const double var_x30 = NV_Ith_S(mParameters, 15) / ((1380.0 + NV_Ith_S(mParameters, 4)) * (669921875000000.0 + var_x25));
        ...
        const double var_x36 = exp(1.4858841010401188e-5 * NV_Ith_S(mParameters, 6));
        ...
        const double var_x39 = NV_Ith_S(mParameters, 5) / (1500.0 + NV_Ith_S(mParameters, 5));
        ...
        const double var_x45 = var_x44 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x57 = -var_chaste_interface__membrane__V;
        ...
        const double var_x64 = 25.674321243523316 * log(var_x58 * (NV_Ith_S(mParameters, 6) + 0.1111111111111111 * NV_Ith_S(mParameters, 5)));
        const double var_x65 = var_x16 * var_x4;
        const double var_x66 = var_x0 * var_x16;
        const double var_x67 = 25.674321243523316 * var_x16;
        const double var_x68 = var_x17 * var_x22;
        const double var_x69 = var_x17 * var_x44;
        const double var_x70 = var_x43 * pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 2) * NV_Ith_S(mParameters, 16) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x71 = var_x43 * var_x5;
        const double var_x72 = var_x43 * NV_Ith_S(mParameters, 14) * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        const double var_x73 = 4.1078913989637309 * var_x18;
        const double var_x74 = 0.16 * var_chaste_interface__membrane__V;
        const double var_x75 = var_x73 - var_x74;
        const double var_x76 = var_x42 + var_x57;
        const double var_x77 = var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss * NV_Ith_S(mParameters, 12);
        const double var_x78 = 25.674321243523316 * log(var_x59 * (NV_Ith_S(mParameters, 5) + 0.020408163265306124 * NV_Ith_S(mParameters, 6)));
        ...
        const double var_x91 = var_x90 * NV_Ith_S(mParameters, 8);
        ...
        const double var_x95 = var_chaste_interface__calcium_fluxes__P_RyR * NV_Ith_S(mParameters, 1);
        ...
        const double var_x99 = var_x90 * var_x95;
        const double var_x100 = 80.808080808080803 * var_chaste_interface__calcium_concentration__CaJSR - 80.808080808080803 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x101 = var_x96 * NV_Ith_S(mParameters, 1);
        const double var_x102 = var_x100 * var_x99;
        ...
        const double var_x107 = var_x105 * (-var_chaste_interface__calcium_concentration__CaJSR + var_chaste_interface__calcium_concentration__Cass);
        const double var_x108 = var_x107 * var_x95;
        const double var_x109 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x110 = exp(-0.038580246913580245 * pow((-1 + var_x109), 2));
        const double var_x111 = var_x110 * (0.90000000000000002 - 0.014285714285714287 * var_chaste_interface__membrane__V);
        ...
        const double var_x117 = 0.015384615384615385 * var_x116 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x118 = -0.28999999999999998 - 0.02 * var_chaste_interface__membrane__V;
        ...
        const double var_x122 = var_x121 * var_chaste_interface__L_type_calcium_current__O;
        ...
        const double var_x128 = var_x127 * (var_x123 * (-8.0 - var_x109) - var_x124 * (-0.10000000000000001 - 0.0050000000000000001 * var_chaste_interface__membrane__V));
        const double var_x129 = var_x128 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x130 = 0.40000000000000002 * var_x129;
        const double var_x131 = 1.0 + var_x123 - var_x124;
        const double var_x132 = var_x127 * var_x131;
        const double var_x133 = 4.0000000000000003e-5 * var_x132;
        const double var_x134 = var_x133 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x135 = var_x132 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x136 = 0.040000000000000001 * var_x135;
        const double var_x137 = 0.00040000000000000002 * var_x128;
        const double var_x138 = var_x137 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x139 = var_x131 * pow(var_x125, 2) / pow(var_x126, 2);
        const double var_x140 = 4.7999999999999998e-6 * var_x139;
        const double var_x141 = var_x140 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x142 = var_x139 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x143 = 0.0048000000000000004 * var_x142;
        const double var_x144 = 1 / (20.0 + var_chaste_interface__calcium_concentration__Cass);
        const double var_x145 = 0.23324 * var_x144;
        const double var_x146 = var_x145 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x147 = var_chaste_interface__calcium_concentration__Cass / pow((1 + 0.050000000000000003 * var_chaste_interface__calcium_concentration__Cass), 2);
        const double var_x148 = 0.00058310000000000002 * var_x147;
        const double var_x149 = var_x148 * var_chaste_interface__L_type_calcium_current__O;
        ...
        const double var_x155 = 0.0076923076923076927 * var_x116 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x156 = 1.0 - var_chaste_interface__L_type_calcium_current__C2 - var_chaste_interface__L_type_calcium_current__C3 - var_chaste_interface__L_type_calcium_current__C4 - var_chaste_interface__L_type_calcium_current__I1 - var_chaste_interface__L_type_calcium_current__I2 - var_chaste_interface__L_type_calcium_current__I3 - var_chaste_interface__L_type_calcium_current__O;
        const double var_x157 = 0.0144 * var_x139 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x158 = 1.2000000000000002 * var_x128 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x159 = 0.12000000000000001 * var_x132 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x160 = -1.6000000000000001 * var_x132;
        const double var_x161 = 0.10000000000000001 * var_x116;
        const double var_x162 = 0.011538461538461539 * var_x116 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x163 = 0.0096000000000000009 * var_x139 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x164 = 0.80000000000000004 * var_x128 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x165 = 0.080000000000000002 * var_x132 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x166 = 0.80000000000000004 * var_x132;
        const double var_x167 = 0.15000000000000002 * var_x116;
        const double var_x168 = 7.6923076923076936e-6 * var_x116 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x169 = 3.0769230769230774e-5 * var_x116 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x170 = var_x116 * var_chaste_interface__L_type_calcium_current__I1;
        const double var_x171 = 0.026000000000000002 * var_x119;
        const double var_x172 = var_x118 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x173 = var_x171 * var_x172;
        const double var_x174 = var_x144 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x175 = 3.0321199999999999 * var_x119 * var_x172 * var_x174;
        const double var_x176 = 1.1195520000000001e-5 * var_x142 * var_x174;
        const double var_x177 = 0.00093296000000000004 * var_x174;
        const double var_x178 = var_x129 * var_x177;
        const double var_x179 = 9.3296000000000009e-5 * var_x135 * var_x174;
        const double var_x180 = 13.0 - 13.0 * var_x119;
        const double var_x181 = var_x180 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x182 = var_x145 * var_x181;
        const double var_x183 = var_x148 * var_x181;
        const double var_x184 = 0.00093296000000000004 * var_x135 * var_x144;
        const double var_x185 = 2.3324000000000003e-6 * var_x135 * var_x147;
        ...
        const double var_x190 = var_x121 * var_chaste_interface__L_type_calcium_current__I1;
        const double var_x191 = 0.026000000000000002 * var_x119;
        const double var_x192 = var_x116 * (-0.026000000000000002 + var_x191);
        const double var_x193 = var_x133 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x194 = var_x137 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x195 = var_x140 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x196 = var_x145 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x197 = var_x148 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x198 = 0.013000000000000001 - var_x120;
        const double var_x199 = -var_x154;
        const double var_x200 = NV_Ith_S(mParameters, 8) * NV_Ith_S(mParameters, 3);
        const double var_x201 = 0.061518471582797281 * var_x200;
        ...
        const double var_x204 = 0.01083743842364532 * var_x203 * var_chaste_interface__fast_sodium_current__O_Na;
        ...
        const double var_x207 = (0.0085583333333333327 * var_x205 + 0.0016666666666666668 * var_x206) / pow((var_x206 + 0.4108 * var_x205), 2);
        const double var_x208 = 60.832000000000001 * var_x207 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x209 = exp(-0.42168674698795178 + 0.060240963855421679 * NV_Ith_S(mParameters, 10) - 0.060240963855421679 * var_chaste_interface__membrane__V);
        const double var_x210 = var_x209 / pow((1 + 0.47846713846216332 * var_x209), 2);
        const double var_x211 = 0.073163809141391992 * var_x210 * var_chaste_interface__fast_sodium_current__O_Na;
        ...
        const double var_x222 = 9.7514961527500711e-7 * var_x221 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x223 = 3.317429681310359e-6 * var_x220 * var_chaste_interface__fast_sodium_current__IF_Na / pow((1 + 0.0023419203747072604 * var_chaste_interface__membrane__V), 2);
        const double var_x224 = var_x210 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x225 = var_x214 * var_x218 * var_x219;
        const double var_x226 = 8.8508255294954831e-7 * var_x216 * var_x224 * var_x225;
        const double var_x227 = 0.00019355636363636362 * var_x207 * var_x215 * var_x225 * var_chaste_interface__fast_sodium_current__IF_Na;
        ...
        const double var_x232 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x233 = -var_x232;
        const double var_x234 = exp(0.12315270935960591 + var_x202);
        const double var_x235 = 0.009852216748768473 * var_x234;
        const double var_x236 = var_x235 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x237 = 9.0909090909090901e-8 * var_x218;
        const double var_x238 = var_x237 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x239 = exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x240 = 71.871455576559541 * (0.0068466666666666667 * var_x239 + 0.0015333333333333334 * var_x206) / pow((var_x206 + 0.44652173913043475 * var_x239), 2);
        const double var_x241 = var_x240 * var_chaste_interface__fast_sodium_current__C_Na2;
        ...
        const double var_x247 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x248 = -var_x247;
        const double var_x249 = exp(-0.12315270935960591 + var_x202);
        const double var_x250 = 0.0094433497536945809 * var_x249;
        const double var_x251 = var_x237 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x252 = exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x253 = 95.049999999999997 * (0.0013333333333333335 * var_x206 + 0.0060411764705882356 * var_x252) / pow((var_x206 + 0.51349999999999996 * var_x252), 2);
        ...
        const double var_x259 = var_x237 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x260 = 1.818181818181818e-9 * var_x218 * var_chaste_interface__fast_sodium_current__I2_Na;
        const double var_x261 = 7.3163809141391995e-5 * var_x224;
        const double var_x262 = 7.7014535938307356e-7 * var_x210 * var_chaste_interface__fast_sodium_current__I1_Na;
        ...
        const double var_x267 = var_x235 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x268 = var_x240 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x269 = var_x250 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x270 = var_x253 * var_chaste_interface__fast_sodium_current__IC_Na3;
        const double var_x271 = 1.5794450018272976 * var_x16;
        const double var_x272 = var_x201 * (var_x74 - var_x73);
        const double var_x273 = var_x201 * var_x43;
        ...
        const double var_x280 = 1.0 - var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        ...
        const double var_x286 = exp(-2.9220779220779218 + var_x217);
        ...
        const double var_x290 = 0.0073216139155926159 * var_x289 / pow((1 + 0.23955296404275997 * var_x289), 2);
        const double var_x291 = 1 / (2.0579999999999998 + 0.49299999999999999 * var_x289);
        const double var_x292 = 0.12987012987012986 * var_x286 / pow(var_x287, 2);
        ...
        const double var_x299 = var_x295 / pow(var_x296, 2);
        const double var_x300 = 0.17543859649122806 * var_x299;
        const double var_x301 = var_x297;
        const double var_x302 = 1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        const double var_x303 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x304 = 1 / (1.0 - exp(1.0000000020227162e-7));
        const double var_x305 = _lt_0_row[30];
        const double var_x306 = 3.6226653999999999e-6 * var_x305 * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        const double var_x307 = 26.5 + var_chaste_interface__membrane__V;
        const double var_x308 = fabs(var_x307) < 7.812499998038902e-7;
        ...
        const double var_x312 = 3.7604140701062501e-12 * var_x304;
        const double var_x313 = -9.5333299999999997e-5 * var_x305;
        ...
        const double var_x318 = 0.00052457313400000008 * var_x317 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2;
        const double var_x319 = exp(-0.041779999999999998 * var_chaste_interface__membrane__V);
        const double var_x320 = 2.8786419999999997e-6 * var_x319 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x321 = exp(0.11695499999999999 + 0.023390999999999999 * var_chaste_interface__membrane__V);
        const double var_x322 = 0.0021243940109999999 * var_x321 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x323 = exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x324 = 0.00021232196 * var_x323 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.002967 - var_x0 - var_x1 - var_x2 - var_x23 - var_x3 - var_x6 - var_x8 + 0.089599999999999999 * var_x45 - var_x32 - 0.16 * var_x4 - 0.88 * var_x40 - 0.0025317124991725772 * var_x47 - var_x12 * var_x15 - 256.41025641025641 * var_x14 * var_x41 * var_x9 * var_chaste_interface__calcium_concentration__Cai_converted / pow(var_x10, 2));
        IJth(rJacobian, 1, 0) = var_x82 * (-1.12886395354433e-5 + 0.00015574708343616086 * var_x47 + 0.061518471582797281 * var_x32) * NV_Ith_S(mParameters, 8);
        IJth(rJacobian, 2, 0) = -var_x91 * var_x92;
        IJth(rJacobian, 5, 0) = -0.014285714285714287 * var_x1 * var_x110 + var_x1 * var_x111 * (0.015432098765432098 - 0.0030864197530864196 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 11, 0) = var_x117 + var_x122 + var_x130 + var_x134 + var_x136 + var_x138 - var_x141 - var_x143;
        IJth(rJacobian, 12, 0) = var_x157 - var_x155 - var_x158 - var_x159 + 1.6000000000000001 * var_x128 * var_x156 + 0.16 * var_x132 * var_x156 + 0.0038461538461538464 * var_x116 * var_chaste_interface__L_type_calcium_current__C2 - 0.019200000000000002 * var_x139 * var_x156;
        IJth(rJacobian, 13, 0) = var_x155 + var_x158 + var_x159 + var_x163 - var_x157 - var_x162 - var_x164 - var_x165;
        IJth(rJacobian, 14, 0) = var_x143 + var_x162 + var_x164 + var_x165 + var_x173 + var_x175 + var_x176 - var_x117 - var_x130 - var_x136 - var_x163 - var_x168 - var_x169 - var_x178 - var_x179 - 7.6923076923076936e-8 * var_x170;
        IJth(rJacobian, 15, 0) = var_x178 + var_x179 + var_x190 + var_x193 + var_x194 - var_x176 - var_x195 - 0.076923076923076927 * var_x192 * var_chaste_interface__L_type_calcium_current__I1 + var_x118 * var_x170 * var_x191;
        IJth(rJacobian, 16, 0) = var_x141 + var_x169 - var_x122 - var_x134 - var_x138 - var_x173;
        IJth(rJacobian, 17, 0) = var_x168 + var_x195 - var_x175 - var_x190 - var_x193 - var_x194;
        IJth(rJacobian, 18, 0) = var_x200 * (-0.00015994802611527293 - 0.16240876497858484 * var_x40 - 0.18455541474839185 * var_x32 - 0.00046724125030848262 * var_x47 - 0.061518471582797281 * var_x2);
        IJth(rJacobian, 19, 0) = var_x204 + var_x208 + var_x226 + var_x227 - var_x211 - var_x222 - var_x223;
        IJth(rJacobian, 20, 0) = var_x233 + var_x236 + var_x241 - var_x204 - var_x208 - var_x238;
        IJth(rJacobian, 21, 0) = var_x248 - var_x236 - var_x241 - var_x251 + var_x250 * var_chaste_interface__fast_sodium_current__C_Na2 + var_x253 * (1.0 - var_chaste_interface__fast_sodium_current__C_Na1 - var_chaste_interface__fast_sodium_current__C_Na2 - var_chaste_interface__fast_sodium_current__I1_Na - var_chaste_interface__fast_sodium_current__I2_Na - var_chaste_interface__fast_sodium_current__IC_Na2 - var_chaste_interface__fast_sodium_current__IC_Na3 - var_chaste_interface__fast_sodium_current__IF_Na - var_chaste_interface__fast_sodium_current__O_Na);
        IJth(rJacobian, 22, 0) = var_x259 + var_x261 - var_x260 - var_x262;
        IJth(rJacobian, 23, 0) = var_x260 + var_x262;
        IJth(rJacobian, 24, 0) = var_x211 + var_x222 + var_x223 + var_x232 + var_x238 + var_x267 + var_x268 - var_x226 - var_x227 - var_x259 - var_x261;
        IJth(rJacobian, 25, 0) = var_x247 + var_x251 + var_x269 + var_x270 - var_x267 - var_x268;
        IJth(rJacobian, 26, 0) = 2.0000000000000002e-5 + var_x233 + var_x248 - var_x269 - var_x270 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I1_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I2_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na2 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na3 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IF_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__O_Na + var_x237 * var_chaste_interface__fast_sodium_current__IC_Na3;
        IJth(rJacobian, 27, 0) = var_x200 * (0.10827250998572321 * var_x40 + 0.0055120550538186363 * var_x45 - 0.061518471582797281 * var_x0 - 0.061518471582797281 * var_x23 - 0.061518471582797281 * var_x3 - 0.061518471582797281 * var_x6 - 0.061518471582797281 * var_x8 - 0.0098429554532475649 * var_x4);
        IJth(rJacobian, 28, 0) = 0.035770000000000003 * var_x274 * (0.18064 - 0.18064 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f) + 0.024673572000000001 * var_x275 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f;
        IJth(rJacobian, 29, 0) = -0.00013571428571428572 * var_x279 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 2.1714285714285715e-5 * var_x280 * var_x285 + 6.9668928571428572e-6 * pow(var_x277, 2) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f / pow(var_x278, 2) + 1.4566594285714287e-7 * var_x280 * var_x282 * var_x284 / pow(var_x283, 2);
        IJth(rJacobian, 30, 0) = var_x293 + var_x290 * (var_x288 - var_chaste_interface__slow_transient_outward_potassium_current__ato_s);
        IJth(rJacobian, 31, 0) = -var_x298 * var_x300 + 0.00016708437761069341 * var_x299 * (var_x301 - var_chaste_interface__slow_transient_outward_potassium_current__ito_s) / pow((0.25714285714285712 + var_x297), 2);
        IJth(rJacobian, 32, 0) = ((var_x308) ? (var_x306 + var_x302 * (2.4066649945278773e-6 * var_x303 + 2.4066650054721224e-6 * var_x304)) : (var_x306 + var_x302 * var_x311 - 6.1610624e-7 * var_x302 * var_x307 * var_x309 / pow(var_x310, 2)));
        IJth(rJacobian, 33, 0) = var_x293 + var_x290 * (var_x288 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur);
        IJth(rJacobian, 34, 0) = -var_x300 * var_x314 - 2.0711500974658867e-5 * var_x299 * (var_x301 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur) / pow((1 - 0.14166666666666666 * var_x297), 2);
        IJth(rJacobian, 35, 0) = var_x292 * var_x316 + 0.0021933842239185751 * var_x315 * (var_x288 - var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss) / pow((0.33511450381679392 + var_x315), 2);
        IJth(rJacobian, 37, 0) = var_x318 + var_x320 - var_x322 - var_x324;
        IJth(rJacobian, 38, 0) = 0.01176 * var_x329 * (0.022348 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K) + 0.0029658262000000005 * var_x330 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1;
        IJth(rJacobian, 39, 0) = -var_x318 - var_x320;
        IJth(rJacobian, 40, 0) = var_x322 + var_x324;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x51 - var_x55 + 1000.0 * var_x56 - 0.0047112379481865285 * var_x48 - var_x11 * var_x15 * var_x41 + 2.0 * var_x12 * var_x41 / pow((0.01 + var_chaste_interface__calcium_concentration__Cai_converted), 2));
        IJth(rJacobian, 1, 1) = var_x82 * (-2745.8000000000002 + var_x83 + var_x84 - 1000.0 * NV_Ith_S(mParameters, 0) + var_x51 * NV_Ith_S(mParameters, 2) + (0.061518471582797281 * var_x50 - 61518.471582797276 * var_x54 - 61.518471582797282 * var_x56 - 0.00014491407891765456 * var_x48) * NV_Ith_S(mParameters, 8) - var_x55 * NV_Ith_S(mParameters, 2)) + 2.3800000000000001e-8 * (0.125 * var_chaste_interface__calcium_concentration__Cass + 0.019599999999999999 * var_chaste_interface__calcium_buffering__LTRPN_Ca + 3.1999999999999999e-5 * var_chaste_interface__calcium_buffering__HTRPN_Ca - 125.0 * var_chaste_interface__calcium_concentration__Cai_converted + (-var_x13 + var_chaste_interface__calcium_concentration__CaNSR) * NV_Ith_S(mParameters, 0) - var_x85 * NV_Ith_S(mParameters, 2) - var_x86 * (70.0 - var_chaste_interface__calcium_buffering__LTRPN_Ca) - var_x87 * (140.0 - var_chaste_interface__calcium_buffering__HTRPN_Ca) - 0.03075923579139864 * (var_x85 + 0.00036699999999999998 * var_chaste_interface__membrane__V - 0.0047112379481865285 * log(0.001 * var_x48 * NV_Ith_S(mParameters, 4)) - 2.0 * var_x31 * var_x46) * NV_Ith_S(mParameters, 8)) / (pow(var_x79, 3) * pow(var_x80, 2));
        IJth(rJacobian, 2, 1) = 2175084.1750841751 * var_x90;
        IJth(rJacobian, 4, 1) = 12316.491897044803 * NV_Ith_S(mParameters, 0) + 24632983.794089608 * var_x54 * NV_Ith_S(mParameters, 2) - 24.632983794089608 * var_x50 * NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 6, 1) = 2289.0 - var_x83;
        IJth(rJacobian, 7, 1) = 331.80000000000001 - var_x84;
        IJth(rJacobian, 18, 1) = 184.55541474839183 * var_x200 * var_x56;
        IJth(rJacobian, 1, 2) = 0.000125 * var_x81;
        IJth(rJacobian, 2, 2) = var_x90 * (-2175.0841750841751 + var_x95 * (-var_x93 - var_x94)) + 0.16806722689075632 * (80.808080808080803 * var_x98 + 2175084.1750841751 * var_chaste_interface__calcium_concentration__Cai_converted - 2175.0841750841751 * var_chaste_interface__calcium_concentration__Cass - var_x92 * (-63.0 + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 8)) / (pow(var_x88, 3) * pow((0.084033613445378158 + var_x89), 2));
        IJth(rJacobian, 3, 2) = var_x105 * var_x97;
        IJth(rJacobian, 8, 2) = -var_x113 + 0.024299999999999999 * var_x112 * (1.0 + var_x106 - var_chaste_interface__ryanodine_receptors__P_C2);
        IJth(rJacobian, 9, 2) = var_x113;
        IJth(rJacobian, 11, 2) = var_x149 - var_x146;
        IJth(rJacobian, 14, 2) = var_x183 + var_x185 - var_x182 - var_x184;
        IJth(rJacobian, 15, 2) = var_x146 + var_x184 - var_x149 - var_x185;
        IJth(rJacobian, 16, 2) = var_x197 - var_x196;
        IJth(rJacobian, 17, 2) = var_x182 + var_x196 - var_x183 - var_x197;
        IJth(rJacobian, 2, 3) = var_x99 * (var_x93 + var_x94);
        IJth(rJacobian, 3, 3) = var_x105 * (-0.050000000000000003 + var_x106 * var_x95) + 0.00013333333333333334 * (-var_x98 + 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR) / (pow(var_x103, 3) * pow((0.053333333333333337 + var_x104), 2));
        IJth(rJacobian, 4, 3) = 0.0028598665395614866;
        IJth(rJacobian, 1, 4) = var_x82 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 3, 4) = 0.050000000000000003 * var_x105;
        IJth(rJacobian, 4, 4) = -0.0028598665395614866 - 12.316491897044804 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 2, 5) = var_x100 * var_x101 * var_x90;
        IJth(rJacobian, 3, 5) = var_x101 * var_x107;
        IJth(rJacobian, 5, 5) = -0.040000000000000001;
        IJth(rJacobian, 1, 6) = var_x82 * (0.019599999999999999 + var_x86);
        IJth(rJacobian, 6, 6) = -0.019599999999999999 - var_x86;
        IJth(rJacobian, 1, 7) = var_x82 * (3.1999999999999999e-5 + var_x87);
        IJth(rJacobian, 7, 7) = -3.1999999999999999e-5 - var_x87;
        IJth(rJacobian, 2, 8) = var_x102;
        IJth(rJacobian, 3, 8) = var_x108;
        IJth(rJacobian, 8, 8) = -0.080249999999999988 + var_x115 - var_x114;
        IJth(rJacobian, 9, 8) = var_x114;
        IJth(rJacobian, 10, 8) = 0.0089999999999999993;
        IJth(rJacobian, 2, 9) = var_x102;
        IJth(rJacobian, 3, 9) = var_x108;
        IJth(rJacobian, 8, 9) = 0.96499999999999997 + var_x115;
        IJth(rJacobian, 9, 9) = -0.96499999999999997;
        IJth(rJacobian, 8, 10) = 0.00080000000000000004 + var_x115;
        IJth(rJacobian, 10, 10) = -0.00080000000000000004;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : ((63.0 + var_x57) * NV_Ith_S(mParameters, 7));
        IJth(rJacobian, 2, 11) = var_x91 * (33719.579211807191 - 535.23141606043157 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 7);
        IJth(rJacobian, 5, 11) = var_x111 * NV_Ith_S(mParameters, 7);
        IJth(rJacobian, 11, 11) = -0.013000000000000001 + var_x120 + var_x152 - var_x150;
        IJth(rJacobian, 12, 11) = var_x160;
        IJth(rJacobian, 14, 11) = var_x150;
        IJth(rJacobian, 15, 11) = var_x151;
        IJth(rJacobian, 16, 11) = var_x198;
        IJth(rJacobian, 12, 12) = -0.050000000000000003 * var_x116 - 2.8000000000000003 * var_x132;
        IJth(rJacobian, 13, 12) = 1.2000000000000002 * var_x132;
        IJth(rJacobian, 12, 13) = var_x160 + var_x161;
        IJth(rJacobian, 13, 13) = -var_x161 - var_x166;
        IJth(rJacobian, 14, 13) = var_x166;
        IJth(rJacobian, 11, 14) = var_x153;
        IJth(rJacobian, 12, 14) = var_x160;
        IJth(rJacobian, 13, 14) = var_x167;
        IJth(rJacobian, 14, 14) = -0.026000000000000002 + var_x171 - var_x153 - var_x167 - var_x186 - var_x187;
        IJth(rJacobian, 15, 14) = var_x187;
        IJth(rJacobian, 16, 14) = 0.026000000000000002 - var_x171;
        IJth(rJacobian, 17, 14) = var_x186;
        IJth(rJacobian, 11, 15) = 0.00050000000000000001;
        IJth(rJacobian, 12, 15) = var_x160;
        IJth(rJacobian, 14, 15) = 1.0000000000000002e-6 * var_x116;
        IJth(rJacobian, 15, 15) = -0.0135 + var_x120 + var_x192;
        IJth(rJacobian, 17, 15) = var_x198;
        IJth(rJacobian, 11, 16) = var_x154;
        IJth(rJacobian, 12, 16) = var_x160;
        IJth(rJacobian, 14, 16) = var_x188;
        IJth(rJacobian, 16, 16) = var_x152 + var_x199 - var_x188;
        IJth(rJacobian, 17, 16) = var_x151;
        IJth(rJacobian, 12, 17) = var_x160;
        IJth(rJacobian, 14, 17) = var_x189;
        IJth(rJacobian, 15, 17) = var_x154;
        IJth(rJacobian, 16, 17) = 0.00050000000000000001;
        IJth(rJacobian, 17, 17) = -0.00050000000000000001 + var_x199 - var_x189;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x63 - 4.3375549444376549e-7 * var_x62 - 0.52396573966374116 * var_x60 - 0.066753235233160624 * var_x58 - 25.674321243523316 * var_x61);
        IJth(rJacobian, 1, 18) = 0.00018455541474839184 * var_x63 * var_x81 * NV_Ith_S(mParameters, 8);
        IJth(rJacobian, 18, 18) = var_x200 * (-1.5794450018272976 * var_x61 - 0.0041065570047509742 * var_x58 - 0.55366624424517552 * var_x63 - 8.0051925176462917e-8 * var_x62);
        IJth(rJacobian, 27, 18) = var_x200 * (5.3367950117641947e-8 * var_x62 - 0.032233571465863219 * var_x60);
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : ((var_x57 + var_x64) * NV_Ith_S(mParameters, 9));
        IJth(rJacobian, 18, 19) = -var_x201 * (-var_x64 + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 9);
        IJth(rJacobian, 19, 19) = -var_x228 - var_x229;
        IJth(rJacobian, 20, 19) = var_x229;
        IJth(rJacobian, 21, 19) = var_x255;
        IJth(rJacobian, 24, 19) = var_x228;
        IJth(rJacobian, 26, 19) = var_x244;
        IJth(rJacobian, 19, 20) = var_x230;
        IJth(rJacobian, 20, 20) = var_x243 + var_x244 - var_x230;
        IJth(rJacobian, 21, 20) = var_x242 + var_x255;
        IJth(rJacobian, 24, 20) = var_x213;
        IJth(rJacobian, 26, 20) = var_x244;
        IJth(rJacobian, 20, 21) = var_x245;
        IJth(rJacobian, 21, 21) = var_x257 + var_x258;
        IJth(rJacobian, 25, 21) = var_x213;
        IJth(rJacobian, 26, 21) = var_x244;
        IJth(rJacobian, 21, 22) = var_x255;
        IJth(rJacobian, 22, 22) = var_x263 - var_x264;
        IJth(rJacobian, 23, 22) = var_x264;
        IJth(rJacobian, 24, 22) = var_x246;
        IJth(rJacobian, 26, 22) = var_x244;
        IJth(rJacobian, 21, 23) = var_x255;
        IJth(rJacobian, 22, 23) = var_x265;
        IJth(rJacobian, 23, 23) = -var_x265;
        IJth(rJacobian, 26, 23) = var_x244;
        IJth(rJacobian, 19, 24) = var_x231;
        IJth(rJacobian, 20, 24) = var_x246;
        IJth(rJacobian, 21, 24) = var_x255;
        IJth(rJacobian, 22, 24) = var_x266;
        IJth(rJacobian, 24, 24) = var_x243 + var_x263 - var_x231 - var_x266;
        IJth(rJacobian, 25, 24) = var_x242;
        IJth(rJacobian, 26, 24) = var_x244;
        IJth(rJacobian, 21, 25) = var_x246 + var_x255;
        IJth(rJacobian, 24, 25) = var_x245;
        IJth(rJacobian, 25, 25) = var_x257 + var_x263;
        IJth(rJacobian, 26, 25) = var_x244 + var_x256;
        IJth(rJacobian, 21, 26) = var_x255;
        IJth(rJacobian, 25, 26) = var_x254;
        IJth(rJacobian, 26, 26) = var_x258 + var_x263;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (2.300419183419689 * var_x69 - 4.1078913989637309 * var_x65 - 2.8527023603914796 * var_x61 - 25.674321243523316 * var_x60 - 25.674321243523316 * var_x66 - 25.674321243523316 * var_x68 - 0.007417026137017846 * var_x58 - var_x6 * var_x67 - var_x67 * var_x8);
        IJth(rJacobian, 18, 27) = var_x200 * (-0.00045628411163899709 * var_x58 - 0.17549388909192196 * var_x61);
        IJth(rJacobian, 27, 27) = var_x200 * (0.14151827216372587 * var_x69 - 1.5794450018272976 * var_x60 - 1.5794450018272976 * var_x66 - 1.5794450018272976 * var_x68 - 0.25271120029236765 * var_x65 - var_x271 * var_x6 - var_x271 * var_x8);
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x70);
        IJth(rJacobian, 27, 28) = -0.18455541474839185 * var_x200 * var_x70;
        IJth(rJacobian, 28, 28) = -0.18064 * var_x274 - 0.39560000000000001 * var_x275;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x71);
        IJth(rJacobian, 27, 29) = -var_x201 * var_x71;
        IJth(rJacobian, 29, 29) = -0.00015200000000000001 * var_x285 - 0.00095 * var_x279;
        IJth(rJacobian, 30, 30) = var_x294;
        IJth(rJacobian, 31, 31) = -var_x298;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-2 * var_x72);
        IJth(rJacobian, 27, 32) = -0.12303694316559456 * var_x200 * var_x72;
        IJth(rJacobian, 32, 32) = ((var_x308) ? (var_x312 + var_x313 - 640000.00016065314 * (26.500000781250002 + var_chaste_interface__membrane__V) * (var_x312 + 3.760414053005867e-12 * var_x303)) : (var_x313 - var_x307 * var_x311));
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur);
        IJth(rJacobian, 27, 33) = -var_x272 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur;
        IJth(rJacobian, 33, 33) = var_x294;
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur);
        IJth(rJacobian, 27, 34) = -var_x272 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur;
        IJth(rJacobian, 34, 34) = -var_x314;
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (var_x7 * var_x76);
        IJth(rJacobian, 27, 35) = -var_x273 * var_x7;
        IJth(rJacobian, 35, 35) = -var_x316;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (var_x76 * var_x77);
        IJth(rJacobian, 27, 36) = -var_x273 * var_x77;
        IJth(rJacobian, 0, 37) = mSetVoltageDerivativeToZero ? 0.0 : ((var_x57 + var_x78) * NV_Ith_S(mParameters, 13));
        IJth(rJacobian, 27, 37) = -var_x201 * (-var_x78 + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 13);
        IJth(rJacobian, 37, 37) = -var_x325 - var_x326;
        IJth(rJacobian, 38, 37) = var_x331;
        IJth(rJacobian, 39, 37) = var_x325;
        IJth(rJacobian, 40, 37) = var_x326;
        IJth(rJacobian, 38, 38) = -0.023761000000000001 + var_x331 - 0.047002000000000002 * var_x330;
        IJth(rJacobian, 39, 38) = 0.023761000000000001;
        IJth(rJacobian, 37, 39) = var_x327;
        IJth(rJacobian, 38, 39) = 0.036777999999999998 + var_x331;
        IJth(rJacobian, 39, 39) = -0.036777999999999998 - var_x327;
        IJth(rJacobian, 37, 40) = var_x328;
        IJth(rJacobian, 38, 40) = var_x331;
        IJth(rJacobian, 40, 40) = -var_x328;
    }

    N_Vector Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvodeOpt>::Initialise(void)
{
