...
// LCOV_EXCL_STOP
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -82.4202
        double var_chaste_interface__calcium_concentration__Cai_converted = NV_Ith_S(rY, 1);
...
const double var_x0 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 2) * NV_Ith_S(mParameters, 14);
        ...
        const double var_x28 = NV_Ith_S(mParameters, 4) * _lt_0_row[1];
        ...
        const double var_x313 = 3.6226653999999999e-6 * var_x312 * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        ...
        const double var_x325 = 0.00052457313400000008 * var_x324 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2;
        const double var_x326 = exp(-0.041779999999999998 * var_chaste_interface__membrane__V);
        const double var_x327 = 2.8786419999999997e-6 * var_x326 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x328 = exp(0.11695499999999999 + 0.023390999999999999 * var_chaste_interface__membrane__V);
        const double var_x329 = 0.0021243940109999999 * var_x328 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x330 = exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x331 = 0.00021232196 * var_x330 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K;
        ...
        IJth(rJacobian, 32, 0) = ((var_x315) ? (var_x313 + var_x309 * (2.4066649999999999e-6 * var_x310 + 2.4066649999999999e-6 * var_x311)) : (var_x313 + var_x309 * var_x318 - 6.1610624e-7 * var_x309 * var_x314 * var_x316 / pow(var_x317, 2)));
        ...
        IJth(rJacobian, 34, 0) = -var_x307 * var_x321 - 2.0711500974658867e-5 * var_x306 * (var_x308 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur) / pow((1 - 0.14166666666666666 * var_x304), 2);
        IJth(rJacobian, 35, 0) = var_x299 * var_x323 + 0.0021933842239185751 * var_x322 * (var_x295 - var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss) / pow((0.33511450381679392 + var_x322), 2);
        IJth(rJacobian, 37, 0) = var_x325 + var_x327 - var_x329 - var_x331;
        IJth(rJacobian, 38, 0) = 0.01176 * var_x336 * (0.022348 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K) + 0.0029658262000000005 * var_x337 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1;
        IJth(rJacobian, 39, 0) = -var_x325 - var_x327;
        IJth(rJacobian, 40, 0) = var_x329 + var_x331;
        ...
        IJth(rJacobian, 32, 32) = ((var_x315) ? (var_x319 + var_x320 + 640000.00000149151 * (26.499999218749998 + var_chaste_interface__membrane__V) * (var_x320 - 3.7604140624912359e-12 * var_x310)) : (var_x319 - var_x314 * var_x318));
        ...
        IJth(rJacobian, 37, 37) = -var_x332 - var_x333;
        IJth(rJacobian, 38, 37) = var_x338;
        IJth(rJacobian, 39, 37) = var_x332;
        IJth(rJacobian, 40, 37) = var_x333;
        IJth(rJacobian, 38, 38) = -0.023761000000000001 + var_x338 - 0.047002000000000002 * var_x337;
        IJth(rJacobian, 39, 38) = 0.023761000000000001;
        IJth(rJacobian, 37, 39) = var_x334;
        IJth(rJacobian, 38, 39) = 0.036777999999999998 + var_x338;
        IJth(rJacobian, 39, 39) = -0.036777999999999998 - var_x334;
        IJth(rJacobian, 37, 40) = var_x335;
        IJth(rJacobian, 38, 40) = var_x338;
        IJth(rJacobian, 40, 40) = -var_x335;
    }
