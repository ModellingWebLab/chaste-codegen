...
const double var_x0 = 1 / NV_Ith_S(mParameters, 9);
        ...
        const double var_x136 = -var_x135 - 0.017687500000000002 * var_x133 * var_chaste_interface__Vm__Vm / pow(var_x134, 2);
        ...
        const double var_x142 = -var_x140 - 0.011356 * var_x138 * var_x141 / pow(var_x139, 2);
        const double var_x143 = var_x136 + var_x142;
        ...
        const double var_x151 = 0.16666666666666666 * var_x128 / pow(var_x129, 2);
        ...
        const double var_x159 = var_x158 - 0.0045719999999999997 * var_x152 * var_x156 / pow(var_x157, 2);
        ...
        const double var_x171 = exp(4.794520547945206 + 0.13698630136986301 * var_chaste_interface__Vm__Vm);
        ...
        const double var_x176 = 0.00035 + var_chaste_interface__calcium_dynamics__Ca_sub;
        const double var_x177 = exp(-4.3833333333333337 + var_x127);
        ...
        const double var_x183 = exp(11.017857142857144 + 0.17857142857142858 * var_chaste_interface__Vm__Vm);
        ...
        const double var_x189 = exp(-2.1886792452830188 - 0.094339622641509441 * var_chaste_interface__Vm__Vm);
        ...
        const double var_x196 = 0.094339622641509441 * var_x189 / pow(var_x190, 2);
        ...
        const double var_x201 = exp(1.672514619883041 + 0.058479532163742687 * var_chaste_interface__Vm__Vm);
        ...
        const double var_x213 = var_x208 + var_x212;
        const double var_x214 = 1 / var_x213;
        const double var_x215 = 2.2222222222222223e-5 * var_x207;
        const double var_x216 = 0.0015555555555555557 * var_x209 / pow(var_x210, 2);
        const double var_x217 = 0.076923076923076927 * var_chaste_interface__Vm__Vm;
        const double var_x218 = exp(3.7692307692307692 + var_x217);
        ...
        const double var_x224 = exp(1.2866666666666666 - 0.066666666666666666 * var_chaste_interface__Vm__Vm);
        ...
        const double var_x230 = exp(4.7407407407407405 + 0.07407407407407407 * var_chaste_interface__Vm__Vm);
        ...
        const double var_x237 = exp(-11.4 + var_x236);
        ...
        const double var_x254 = var_x250 + var_x246 + 0.00022900000000000001 * var_x253;
        const double var_x255 = 1 / var_x254;
        const double var_x256 = var_x251 / pow(var_x252, 2);
        const double var_x257 = (9.5 * var_x245 + 0.071428571428571425 * var_x242) / pow((var_x245 + 0.52631578947368418 * var_x242), 2);
        const double var_x258 = (-10.0 * var_x247 - 238.46153846153845 * var_x248) / pow((var_x248 + 0.22580645161290322 * var_x247), 2);
        const double var_x259 = 1.0405827263267429e-7 * var_x258;
        ...
        const double var_x273 = var_chaste_interface__calcium_dynamics__Ca_sub * var_chaste_interface__j_SRCarel__R;
        const double var_x274 = var_x263 * var_x264 / pow(var_x265, 2);
        const double var_x275 = 2.3772197685794643 * var_x274;
        const double var_x276 = var_x273 * var_x275;
        const double var_x277 = 0.21130842387373014 * var_x2 * var_x274 / pow((1 - 0.93333333333333335 * var_x266), 2);
        const double var_x278 = var_x277 * var_chaste_interface__j_SRCarel__R;
        const double var_x279 = 20.0 * var_x270;
        const double var_x280 = var_x273 * var_x279;
        const double var_x281 = var_x275 * var_chaste_interface__calcium_dynamics__Ca_sub * var_chaste_interface__j_SRCarel__O;
        const double var_x282 = 7.5 - var_x267;
        const double var_x283 = var_x282 * var_chaste_interface__calcium_dynamics__Ca_sub;
        const double var_x284 = var_x277 * var_chaste_interface__j_SRCarel__RI;
        const double var_x285 = var_x279 * var_chaste_interface__calcium_dynamics__Ca_sub * var_chaste_interface__j_SRCarel__RI;
        ...
        const double var_x291 = var_x290 * (-45.0 + var_chaste_interface__Vm__Vm);
        const double var_x292 = var_x291 * var_x97;
        const double var_x293 = var_x290 * (-8.2439999999999998 + var_x107);
        ...
        IJth(rJacobian, 2, 0) = ((var_x153) ? (var_x130 * (var_x143 + 0.0057149999999999996 * var_x131 + 0.0057149999999999996 * var_x132) + var_x151 * (var_x145 + var_x150 - var_x144)) : ((var_x163) ? (var_x130 * (var_x136 + var_x159 - 0.014194999998424038 * var_x154 - 0.014195000001575961 * var_x155) + var_x151 * (var_x149 + var_x161 - var_x160 - var_x162)) : ((var_x168) ? (var_x130 * (var_x142 + var_x159 - 0.042450000000000002 * var_x164 - 0.042450000000000002 * var_x165) + var_x151 * (var_x147 + var_x161 - var_x166 - var_x167)) : (var_x130 * (var_x143 + var_x159) + var_x151 * (var_x150 + var_x161)))));
        IJth(rJacobian, 3, 0) = -0.13698630136986301 * var_x171 * var_x174 / pow(var_x172, 2) - 0.0038895371450797353 * var_x173 * (-0.33642151027379535 - 0.010351431085347548 * var_chaste_interface__Vm__Vm) * (-var_chaste_interface__i_CaL_fL_gate__fL + 1 / var_x172) / pow((0.17230649552703226 + var_x173), 2);
        IJth(rJacobian, 5, 0) = (-var_chaste_interface__i_CaT_dT_gate__dT + 1 / var_x178) * (0.0356 * var_x179 - 0.0356 * var_x180) + 0.16666666666666666 * var_x177 * (var_x181 + var_x182) / pow(var_x178, 2);
        IJth(rJacobian, 6, 0) = (-var_chaste_interface__i_CaT_fT_gate__fT + 1 / var_x184) * (0.00097529258777633281 * var_x185 - 0.00018367346938775509 * var_x186) - 0.17857142857142858 * var_x183 * (var_x187 + var_x188) / pow(var_x184, 2);
        IJth(rJacobian, 7, 0) = var_x196 * (var_x194 + var_x195) + (var_x191 - var_chaste_interface__i_Kr_pa_gate__paS) * (0.00029184075413518645 * var_x192 - 8.2031958007575546e-6 * var_x193);
        IJth(rJacobian, 8, 0) = var_x196 * (var_x199 + var_x200) + (var_x191 - var_chaste_interface__i_Kr_pa_gate__paF) * (0.0027637030984589985 * var_x197 - 5.0400434999854427e-5 * var_x198);
        IJth(rJacobian, 9, 0) = (-var_chaste_interface__i_Kr_pi_gate__pi_ + 1 / var_x202) * (0.0061795265502981441 * var_x203 - 0.0018299935950224174 * var_x204) - 0.058479532163742687 * var_x201 * (var_x205 + var_x206) / pow(var_x202, 2);
        IJth(rJacobian, 10, 0) = var_x213 * (var_x214 * var_x216 + 71.428571428571431 * var_x211 * (var_x215 - var_x216) / pow((var_x211 + 0.071428571428571425 * var_x207), 2)) + (var_x216 - var_x215) * (-var_chaste_interface__i_Ks_n_gate__n + var_x212 * var_x214);
        IJth(rJacobian, 11, 0) = -0.076923076923076927 * var_x218 * var_x223 / pow(var_x219, 2) - 0.078713879440468384 * (-var_chaste_interface__AP_sensitive_currents_q_gate__q + 1 / var_x219) * (0.045599999999999995 * var_x221 - 0.0065000000000000006 * var_x220) / (pow((0.15497928494706154 + var_x222), 2) * pow((var_x221 + 0.11403508771929825 * var_x220), 2));
        IJth(rJacobian, 12, 0) = 0.066666666666666666 * var_x224 * var_x229 / pow(var_x225, 2) - 0.064554184748538135 * (-var_chaste_interface__AP_sensitive_currents_r_gate__r + 1 / var_x225) * (0.04428 * var_x227 - 0.093329999999999996 * var_x226) / (pow((0.19114817190506733 + var_x228), 2) * pow((var_x226 + 0.35583413693346194 * var_x227), 2));
        IJth(rJacobian, 13, 0) = (-var_chaste_interface__i_f_y_gate__y + 1 / var_x231) * (0.0725586626489447 * var_x232 - 0.030801634395873377 * var_x233) - 0.07407407407407407 * var_x230 * (var_x234 + var_x235) / pow(var_x231, 2);
        IJth(rJacobian, 14, 0) = (-var_chaste_interface__i_st_qa_gate__qa + 1 / var_x238) * (0.00390625 * (-2.0 * var_x240 - 0.29999999999999999 * var_x239) / pow((var_x240 + 0.9375 * var_x239), 2) + 24.999999999999996 * (0.013636363636363636 * var_x241 + 0.00028571428571428574 * var_x242) / pow((var_x242 + 0.74999999999999989 * var_x241), 2)) + 0.20000000000000001 * var_x237 * (var_x243 + var_x244) / pow(var_x238, 2);
        IJth(rJacobian, 15, 0) = (-var_chaste_interface__i_st_qi_gate__qi + var_x250 * var_x255) * (6.8872180451127816e-6 * var_x256 + 1.6662153999958345e-5 * var_x257 + 1.5647860546266811e-8 * var_x258) + (var_x255 * var_x259 + var_x250 * (-var_x259 - 4.5800000000000002e-5 * var_x256 - 0.00011080332409972299 * var_x257) / pow(var_x254, 2)) * (var_x260 + var_x261 + var_x262);
        IJth(rJacobian, 28, 0) = -var_x290 * (var_x84 + var_x98 + 0.00059999999999999995 * NV_Ith_S(mParameters, 9) - var_x288 * var_x67 - var_x289 * var_x91);
        ...
        IJth(rJacobian, 2, 2) = ((var_x153) ? (var_x144 + var_x169 - var_x145) : ((var_x163) ? (var_x148 + var_x160 + var_x162 + var_x170) : ((var_x168) ? (var_x146 + var_x166 + var_x167 + var_x170) : (var_x169 + var_x170))));
        IJth(rJacobian, 28, 2) = -var_x292 * var_chaste_interface__i_CaL_fL_gate__fL;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (var_x105 * var_chaste_interface__i_CaL_dL_gate__dL);
        IJth(rJacobian, 3, 3) = -var_x174;
        IJth(rJacobian, 28, 3) = -var_x292 * var_chaste_interface__i_CaL_dL_gate__dL;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x104 * var_x106);
        IJth(rJacobian, 4, 4) = -0.021000000000000001 - var_x175;
        IJth(rJacobian, 28, 4) = -var_x106 * var_x291 * NV_Ith_S(mParameters, 9);
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x108 * var_chaste_interface__i_CaT_fT_gate__fT);
        IJth(rJacobian, 5, 5) = -var_x181 - var_x182;
        IJth(rJacobian, 28, 5) = -var_x293 * var_x83;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x108 * var_chaste_interface__i_CaT_dT_gate__dT);
        IJth(rJacobian, 6, 6) = -var_x187 - var_x188;
        IJth(rJacobian, 28, 6) = -var_x293 * var_chaste_interface__i_CaT_dT_gate__dT * NV_Ith_S(mParameters, 9);
        ...
        IJth(rJacobian, 10, 10) = -var_x208 - var_x212;
        ...
        IJth(rJacobian, 13, 13) = -var_x234 - var_x235;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x113 * var_chaste_interface__i_st_qi_gate__qi);
        IJth(rJacobian, 14, 14) = -var_x243 - var_x244;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (var_x113 * var_chaste_interface__i_st_qa_gate__qa);
        IJth(rJacobian, 15, 15) = -var_x260 - var_x261 - var_x262;
        IJth(rJacobian, 16, 16) = var_x269 + var_x272;
        IJth(rJacobian, 17, 16) = var_x271;
        IJth(rJacobian, 19, 16) = var_x283;
        IJth(rJacobian, 16, 17) = 0.059999999999999998;
        IJth(rJacobian, 17, 17) = -0.059999999999999998 + var_x269;
        IJth(rJacobian, 18, 17) = var_x283;
        ...
        IJth(rJacobian, 24, 24) = -0.0075100000000000002 + var_x286;
        ...
        IJth(rJacobian, 16, 27) = var_x276 - var_x278;
        IJth(rJacobian, 17, 27) = var_x278 + var_x281;
        IJth(rJacobian, 18, 27) = var_x284 - var_x281;
        IJth(rJacobian, 19, 27) = -var_x276 - var_x284;
        ...
        IJth(rJacobian, 27, 27) = -5.3650000000000002 - var_x287 + 5.3399999999999999 * var_chaste_interface__calcium_buffering__fCQ;
        IJth(rJacobian, 28, 27) = var_x294;
        ...
        IJth(rJacobian, 4, 28) = 0.021000000000000001 / var_x176 - 60.000000000000007 * var_chaste_interface__i_CaL_fCa_gate__fCa - 0.00035 * (0.021000000000000001 + var_x175) / pow(var_x176, 2);
        IJth(rJacobian, 16, 28) = -var_x280 + var_x268 * var_chaste_interface__j_SRCarel__R;
        IJth(rJacobian, 17, 28) = var_x280 + var_x268 * var_chaste_interface__j_SRCarel__O;
        IJth(rJacobian, 18, 28) = var_x285 + var_x282 * var_chaste_interface__j_SRCarel__O;
        IJth(rJacobian, 19, 28) = -var_x285 + var_x282 * var_chaste_interface__j_SRCarel__R;
        IJth(rJacobian, 22, 28) = 227.69999999999999 - 227.69999999999999 * var_chaste_interface__calcium_buffering__fCMs;
        IJth(rJacobian, 27, 28) = var_x287;
        IJth(rJacobian, 28, 28) = -35.246499999999997 - var_x294 + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMs - var_x290 * (-var_x122 * var_x288 - var_x123 * var_x289);
    }
