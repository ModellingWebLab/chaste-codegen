...
const double var_x0 = exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V);
        ...
        const double var_x109 = var_x108 * var_x67;
        const double var_x110 = var_x86 * var_chaste_interface__membrane__V;
        const double var_x111 = ((var_x79) ? (var_x109 + var_x65 * (-var_x109 - var_x108 * var_x74)) : (var_x110 * var_x76));
        const double var_x112 = -var_x90 * (var_x106 + var_x111);
        const double var_x113 = var_x107 * var_x4;
        const double var_x114 = var_x113 * var_x67;
        const double var_x115 = ((var_x79) ? (var_x114 + var_x65 * (-var_x114 - var_x113 * var_x74)) : (var_x110 * var_x4 * var_x75));
        ...
        IJth(rJacobian, 2, 0) = ((var_x147) ? (var_x146 + (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * (159.99999943156581 * var_x143 + 160.00000056843419 * var_x144)) : ((var_x154) ? (var_x146 + var_x148 * var_x152 - 0.032000000000000001 * var_x148 * var_x150 * var_x153 / pow(var_x151, 2)) : (0)));
        ...
        IJth(rJacobian, 6, 0) = ((var_x213) ? (var_x205 * (0.035949999999999996 * var_x206 + 0.035949999999999996 * var_x207 + 0.065500000000000003 * var_x208 + 0.065500000000000003 * var_x209) + var_x211 * (343499999.83666253 * var_x210 - 1.9068413400624708e-7 * var_x209 - 1.0465793309197835e-7 * var_x206)) : (var_x205 * (var_x217 + var_x221 - 0.0089997000000000011 * var_x212 * var_x214 / pow(var_x215, 2) - 0.0106412 * var_x212 * var_x218 / pow(var_x219, 2)) + var_x211 * (var_x212 * var_x217 + var_x212 * var_x221)));
        ...
        IJth(rJacobian, 2, 2) = ((var_x147) ? (var_x155 + 3.200000014658144e-7 * var_x144 - 499.99999948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (0.00031999999919207767 * var_x143 + 0.00032000000146581442 * var_x144)) : ((var_x154) ? (var_x155 - var_x152 * var_x153) : (0)));
        ...
        IJth(rJacobian, 6, 6) = ((var_x213) ? (1.9068413400624708e-10 * var_x209 + 1.0465793309197834e-10 * var_x206 - 343499.99983666249 * var_x210) : (-0.00013100000000000001 * var_x212 * var_x216 - 7.1899999999999999e-5 * var_x212 * var_x220));
