...
const double var_x0 = -0.16666666666666666 * var_chaste_interface__membrane__V;
        ...
        const double var_x49 = 14.195 * var_x48;
        const double var_x50 = 35.0 + var_chaste_interface__membrane__V;
        const double var_x51 = -var_x49 - 5.6779999999999999 * var_x46 * var_x50 / pow(var_x47, 2);
        const double var_x52 = var_x51 - var_x45 - 8.829600000000001 * var_x42 * var_chaste_interface__membrane__V / pow(var_x43, 2);
        ...
        const double var_x54 = -var_x49 * var_x50;
        const double var_x55 = var_x54 - var_x45 * var_chaste_interface__membrane__V;
        const double var_x56 = 0.00016666666666666666 * var_x37 / pow(var_x38, 2);
        ...
        const double var_x64 = 5.7149999999999999 * var_x63;
        const double var_x65 = var_x64 - 2.286 * var_x57 * var_x61 / pow(var_x62, 2);
        const double var_x66 = var_x57 * var_x64;
        ...
        const double var_x72 = exp(9.0 + 0.20000000000000001 * var_chaste_interface__membrane__V);
        ...
        const double var_x78 = 3.75 * var_x77;
        ...
        IJth(rJacobian, 4, 0) = ((var_x58) ? (var_x39 * (var_x52 + 2.8574999949240603 * var_x40 + 2.8575000050759396 * var_x41) + var_x56 * (var_x55 + 1.4287500014686927e-6 * var_x41 - 1000000.0007484005 * var_x53)) : ((var_x68) ? (var_x39 * (var_x51 + var_x65 - 21.225000000000001 * var_x59 - 21.225000000000001 * var_x60) + var_x56 * (var_x54 + var_x66 + 2.0408653846153847e-5 * var_x59 + 520000.0 * var_x67)) : (var_x39 * (var_x52 + var_x65) + var_x56 * (var_x55 + var_x66))));
        IJth(rJacobian, 5, 0) = (0.00083333333333333339 / var_x73 - 0.00083333333333333339 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L) * (var_x78 + 7.5 * var_x79 / pow(var_x80, 2) - 0.9375 * var_x75 * var_x81 / pow(var_x76, 2)) - 0.00016666666666666666 * var_x72 * (30.0 * var_x82 + var_x78 * var_x81) / pow(var_x73, 2);
        ...
        IJth(rJacobian, 4, 4) = ((var_x58) ? (var_x70 + 1000.0000007484005 * var_x53 - 1.4287500014686927e-9 * var_x41) : ((var_x68) ? (var_x69 + var_x71 - 520.0 * var_x67 - 2.0408653846153846e-8 * var_x59) : (var_x70 + var_x71)));
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x10 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L);
        IJth(rJacobian, 5, 5) = -0.025000000000000001 * var_x82 - 0.0031250000000000002 * var_x77 * var_x81;
