...
const double var_x0 = -0.16666666666666666 * var_chaste_interface__membrane__V;
        ...
        const double var_x59 = 3.75 * var_x58;
        ...
        IJth(rJacobian, 5, 0) = (0.00083333333333333339 / var_x54 - 0.00083333333333333339 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L) * (var_x59 + 7.5 * var_x60 / pow(var_x61, 2) - 0.9375 * var_x56 * var_x62 / pow(var_x57, 2)) - 0.00016666666666666666 * var_x53 * (30.0 * var_x63 + var_x59 * var_x62) / pow(var_x54, 2);
