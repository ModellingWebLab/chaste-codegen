...
std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeOpt_LookupTables> Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeOpt_LookupTables::mpInstance;
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x156 = 1 / sqrt(var_x155);
        const double var_x157 = 0.001 * var_x156;
        ...
        const double var_x161 = var_x154 / pow(var_x155, (3 / 2));
        const double var_x162 = 8.7719298245614029e-5 * var_x161;
        ...
        const double var_x170 = 142.85714285714286 * var_x169;
        ...
        const double var_x178 = -var_chaste_interface__i_Na_j_gate__j + var_x156;
        ...
        const double var_x184 = exp(-0.85514285714285709 - 0.14285714285714285 * var_chaste_interface__Membrane__Vm_converted);
        ...
        const double var_x214 = var_x213 - var_chaste_interface__i_CaL_f1_gate__f1;
        const double var_x215 = var_x202 / pow(var_x203, 2);
        const double var_x216 = 8.2270247479188195e-7 * var_x214 * (18.0 * var_x215 + 385786.79999999999 * var_x210 * pow(var_x209, 3) - 20.0 * var_x206 / pow(var_x207, 2)) / pow((0.018140589569160998 + var_x210 + 0.16326530612244897 * var_x204 + 0.18140589569160998 * var_x208), 2);
        const double var_x217 = 1 / (20.0 + 200.0 * var_x208 + 180.0 * var_x204 + 1102.5 * var_x210);
        const double var_x218 = 0.33333333333333331 * var_x211 * var_x217 / pow(var_x212, 2);
        ...
        const double var_x225 = exp(7.8064999999999998 + 0.25 * var_chaste_interface__Membrane__Vm_converted);
        ...
        const double var_x238 = exp(-3.8775510204081627 - 0.2040816326530612 * var_chaste_interface__Membrane__Vm_converted - 0.0076462663250123509 * (-2.1789087017666886 + log(40.0 * pow((1.0 + 0.38461538461538458 * NV_Ith_S(mParameters, 1)), 4) / pow((0.57999999999999996 + NV_Ith_S(mParameters, 1)), 4))) * NV_Ith_S(mParameters, 17));
        const double var_x239 = 1.0 + var_x238;
        const double var_x240 = -var_chaste_interface__i_Kr_Xr1_gate__Xr1 + 1 / var_x239;
        ...
        const double var_x246 = exp(1.76 + 0.02 * var_chaste_interface__Membrane__Vm_converted);
        const double var_x247 = 1.0 + var_x246;
        const double var_x248 = -var_chaste_interface__i_Kr_Xr2_gate__Xr2 + 1 / var_x247;
        ...
        const double var_x254 = exp(-1.25 - 0.0625 * var_chaste_interface__Membrane__Vm_converted);
        const double var_x255 = 1.0 + var_x254;
        const double var_x256 = -var_chaste_interface__i_Ks_Xs_gate__Xs + 1 / var_x255;
        const double var_x257 = 1.0 + var_x249;
        const double var_x258 = var_x253 * var_x257;
        const double var_x259 = exp(15.569999999999999 + var_x140);
        ...
        const double var_x263 = exp(4.0769230769230766 + var_x194);
        ...
        const double var_x269 = exp(1.1893333333333334 - 0.053333333333333337 * var_chaste_interface__Membrane__Vm_converted);
        ...
        const double var_x275 = 1478075.9624980299 * var_x89 * NV_Ith_S(mParameters, 16);
        const double var_x276 = 127.37086290006985 * NV_Ith_S(mParameters, 17);
        ...
        const double var_x280 = var_x279 * (-0.45769919999999992 - var_x134);
        ...
        IJth(rJacobian, 3, 0) = ((var_x163) ? ((var_x157 - var_x35) * (72023333.333333328 * var_x158 + 142.20000000000002 * var_x159 - 5.5882352941176476 * var_x160) - var_x162 * (38.0 * var_x160 + 206666666.66666669 * var_x158 + 1800.0000000000002 * var_x159)) : (-0.034507985147763195 * var_x161));
        IJth(rJacobian, 4, 0) = ((var_x163) ? ((var_x157 - 0.001 * var_chaste_interface__i_Na_j_gate__j) * (var_x171 - 0.036429257142857142 * var_x175 + var_x170 * var_x176 * (3.0508668000000001e-7 * var_x165 - 6214.6032000000005 * var_x164) + 0.47718171428571432 * var_x172 * var_x174 / pow(var_x173, 2) - 44.428571428571431 * var_x167 * var_x177 / pow(var_x168, 2)) - var_x162 * (3.4628571428571431 * var_x175 + var_x171 * var_x176)) : (0.0048857142857142858 * var_x178 * var_x183 - 0.0075187969924812026 * var_x161 * var_x183 + 0.0085714285714285719 * var_x178 * var_x180 * var_x182 / pow(var_x181, 2)));
        IJth(rJacobian, 5, 0) = 0.00014285714285714287 * var_x184 * var_x199 / pow(var_x185, 2) + 510.20408163265313 * (-var_chaste_interface__i_CaL_d_gate__d + 1 / var_x185) * (-5.0000000000000002e-5 * var_x188 / pow(var_x189, 2) + 0.00027999999999999998 * var_x191 * var_x197 / pow(var_x192, 2) - 0.00015076923076923074 * var_x193 * var_x195 / pow(var_x196, 2)) / pow((var_x198 + 0.7142857142857143 * var_x190), 2);
        IJth(rJacobian, 6, 0) = ((var_x219) ? (var_x200 * var_x216 - var_x200 * var_x218) : (var_x216 - var_x218));
        IJth(rJacobian, 7, 0) = 0.00069444444444444447 * (0.33000000000000002 - var_chaste_interface__i_CaL_f2_gate__f2 + 0.67000000000000004 / var_x226) * (0.0032000000000000002 * var_x215 - var_x227 * (-0.29411764705882354 - 0.011764705882352941 * var_chaste_interface__Membrane__Vm_converted) - 0.0061999999999999998 * var_x221 / pow(var_x222, 2)) / pow((var_x224 + 0.051666666666666666 * var_x223 + 0.026666666666666668 * var_x204), 2) - 0.00016750000000000001 * var_x225 * var_x228 / pow(var_x226, 2);
        IJth(rJacobian, 9, 0) = 3.2206119162640899e-5 * var_x237 * var_x240 * var_x241 + 0.2040816326530612 * var_x238 * var_x243 / pow(var_x239, 2) - 0.10000000000000001 * var_x236 * var_x240 * var_x242;
        IJth(rJacobian, 10, 0) = 0.01488095238095238 * var_x245 * var_x248 * var_x249 - 0.02 * var_x246 * var_x251 / pow(var_x247, 2) - 0.050000000000000003 * var_x244 * var_x248 * var_x250;
        IJth(rJacobian, 11, 0) = 5.6818181818181818e-5 * var_x254 * var_x258 / pow(var_x255, 2) + 4.5454545454545452e-5 * var_x249 * var_x253 * var_x256 - 7.5757575757575758e-5 * var_x252 * var_x256 * var_x257 / var_x253;
        IJth(rJacobian, 12, 0) = 5.2631578947368424e-5 * var_x261 * (-var_chaste_interface__i_f_Xf_gate__Xf + 1 / var_x260) - 0.20000000000000001 * var_x259 * (0.0005263157894736842 + var_x262) / pow(var_x260, 2);
        IJth(rJacobian, 13, 0) = -7.6923076923076926e-5 * var_x263 * var_x268 / pow(var_x264, 2) - 0.078713879440468384 * (-var_chaste_interface__i_to_q_gate__q + 1 / var_x264) * (0.045599999999999995 * var_x266 - 0.0065000000000000006 * var_x265) / (pow((0.15497928494706154 + var_x267), 2) * pow((var_x266 + 0.11403508771929825 * var_x265), 2));
        IJth(rJacobian, 14, 0) = 5.3333333333333333e-5 * var_x269 * var_x274 / pow(var_x270, 2) - 0.064554184748538135 * (-var_chaste_interface__i_to_r_gate__r + 1 / var_x270) * (0.04428 * var_x272 - 0.093329999999999996 * var_x271) / (pow((0.19114817190506733 + var_x273), 2) * pow((var_x271 + 0.35583413693346194 * var_x272), 2));
        ...
        IJth(rJacobian, 6, 1) = ((var_x219) ? (-0.00069783670621074664 * var_x214 * var_x217 / pow((0.00064783670621074672 + var_chaste_interface__calcium_dynamics__Cai), 2)) : (0));
        IJth(rJacobian, 8, 1) = ((var_x235) ? (0) : (-5.1067680145940974e-26 * pow(var_chaste_interface__calcium_dynamics__Cai, 7) / pow((1.6796159999999989e-26 + var_x234), 2) - 380.05472788081482 * var_x232 / pow(var_x233, 2) - 142.52052295530555 * var_x230 / pow(var_x231, 2)));
        IJth(rJacobian, 15, 1) = 12669224.056004103 * var_x84 * NV_Ith_S(mParameters, 16);
        IJth(rJacobian, 16, 1) = var_x279 * (0.00044443999999999999 + var_x123);
        IJth(rJacobian, 17, 1) = ((var_x286) ? (0) : ((var_x281) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Cai, 5) / pow((1.8382656249999998e-21 + var_x284), 2)) : ((var_x287) ? (0) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Cai, 15) / pow((5.0709427749024951e-56 + var_x282), 2)))));
        ...
        IJth(rJacobian, 3, 3) = ((var_x163) ? (-0.037999999999999999 * var_x160 - 1.8 * var_x159 - 206666.66666666669 * var_x158) : (-0.39339103068450043));
        IJth(rJacobian, 15, 3) = -var_x275 * var_x37;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x91 * var_x92);
        IJth(rJacobian, 4, 4) = ((var_x163) ? (-0.003462857142857143 * var_x175 - 0.14285714285714285 * var_x169 * var_x177) : (-0.085714285714285715 * var_x183));
        IJth(rJacobian, 15, 4) = -var_x275 * var_x92;
        ...
        IJth(rJacobian, 14, 14) = -0.001 * var_x274;
        ...
        IJth(rJacobian, 15, 15) = (2771.3924296838059 * var_x114 - 13302683.662482269 * var_x117 - 4434227.8874940891 * var_x113 - var_x111 * var_x276 - var_x116 * var_x276) * NV_Ith_S(mParameters, 16);
        IJth(rJacobian, 1, 16) = var_x121 * (0.00044443999999999999 + var_x132 * (var_x138 - var_x139));
        IJth(rJacobian, 16, 16) = var_x279 * (-0.00044443999999999999 + var_x132 * (var_x139 - var_x138)) + 0.010048724562912011 * (var_x125 + var_x126 - var_x124 - var_x133) / (pow(var_x277, 3) * pow((0.33333333333333337 + var_x278), 2));
        IJth(rJacobian, 1, 17) = var_x121 * var_x135 * var_chaste_interface__i_CaL_d_gate__d;
        IJth(rJacobian, 16, 17) = var_x280 * var_chaste_interface__i_CaL_d_gate__d;
        IJth(rJacobian, 17, 17) = ((var_x286) ? (0) : ((var_x281) ? (-0.5) : ((var_x287) ? (0) : (-0.5))));
    }
