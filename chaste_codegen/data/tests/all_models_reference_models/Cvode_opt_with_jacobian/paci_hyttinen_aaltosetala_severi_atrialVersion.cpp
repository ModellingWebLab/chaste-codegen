...
std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeOpt_LookupTables> Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeOpt_LookupTables::mpInstance;
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_i_CaL__i_CaL = 4478658957.2358274 * (-0.34100000000000003 * NV_Ith_S(mParameters, 1) + var_chaste_interface__calcium_dynamics__Cai * exp(23209.012310102189 * var_Membrane__Vm / NV_Ith_S(mParameters, 17))) * var_Membrane__Vm * NV_Ith_S(mParameters, 4) * var_chaste_interface__i_CaL_d_gate__d * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_f2_gate__f2 * var_chaste_interface__i_CaL_fCa_gate__fCa / ((-1.0 + exp(23209.012310102189 * var_Membrane__Vm / NV_Ith_S(mParameters, 17))) * NV_Ith_S(mParameters, 17)); // A_per_F
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x131 = 1 / sqrt(var_x130);
        ...
        const double var_x136 = var_x129 / pow(var_x130, (3 / 2));
        const double var_x137 = 8.7719298245614029e-5 * var_x136;
        ...
        const double var_x145 = 142.85714285714286 * var_x144;
        ...
        const double var_x153 = -var_chaste_interface__i_Na_j_gate__j + var_x131;
        ...
        const double var_x159 = exp(-0.85514285714285709 - 0.14285714285714285 * var_chaste_interface__Membrane__Vm_converted);
        ...
        const double var_x189 = var_x188 - var_chaste_interface__i_CaL_f1_gate__f1;
        const double var_x190 = var_x177 / pow(var_x178, 2);
        const double var_x191 = 8.2270247479188195e-7 * var_x189 * (18.0 * var_x190 + 385786.79999999999 * var_x185 * pow(var_x184, 3) - 20.0 * var_x181 / pow(var_x182, 2)) / pow((0.018140589569160998 + var_x185 + 0.16326530612244897 * var_x179 + 0.18140589569160998 * var_x183), 2);
        const double var_x192 = 1 / (20.0 + 200.0 * var_x183 + 180.0 * var_x179 + 1102.5 * var_x185);
        const double var_x193 = 0.33333333333333331 * var_x186 * var_x192 / pow(var_x187, 2);
        ...
        const double var_x200 = exp(7.8064999999999998 + 0.25 * var_chaste_interface__Membrane__Vm_converted);
        ...
        const double var_x212 = exp(-3.8775510204081627 - 0.2040816326530612 * var_chaste_interface__Membrane__Vm_converted - 0.0076462663250123509 * (-2.1789087017666886 + log(40.0 * pow((1.0 + 0.38461538461538458 * NV_Ith_S(mParameters, 1)), 4) / pow((0.57999999999999996 + NV_Ith_S(mParameters, 1)), 4))) * NV_Ith_S(mParameters, 17));
        const double var_x213 = 1.0 + var_x212;
        const double var_x214 = -var_chaste_interface__i_Kr_Xr1_gate__Xr1 + 1 / var_x213;
        ...
        const double var_x220 = exp(1.76 + 0.02 * var_chaste_interface__Membrane__Vm_converted);
        const double var_x221 = 1.0 + var_x220;
        const double var_x222 = -var_chaste_interface__i_Kr_Xr2_gate__Xr2 + 1 / var_x221;
        ...
        const double var_x228 = exp(-1.25 - 0.0625 * var_chaste_interface__Membrane__Vm_converted);
        const double var_x229 = 1.0 + var_x228;
        const double var_x230 = -var_chaste_interface__i_Ks_Xs_gate__Xs + 1 / var_x229;
        const double var_x231 = 1.0 + var_x223;
        const double var_x232 = var_x227 * var_x231;
        const double var_x233 = exp(15.569999999999999 + var_x115);
        ...
        const double var_x237 = exp(4.0769230769230766 + var_x169);
        ...
        const double var_x243 = exp(1.1893333333333334 - 0.053333333333333337 * var_chaste_interface__Membrane__Vm_converted);
        ...
        const double var_x249 = 1478075.9624980299 * var_x71 * NV_Ith_S(mParameters, 16);
        const double var_x250 = 127.37086290006985 * NV_Ith_S(mParameters, 17);
        ...
        const double var_x254 = var_x253 * (-0.45769919999999992 - var_x107);
        ...
        IJth(rJacobian, 3, 0) = ((var_x138) ? ((var_x132 - var_x6) * (72023333.333333328 * var_x133 + 142.20000000000002 * var_x134 - 5.5882352941176476 * var_x135) - var_x137 * (38.0 * var_x135 + 206666666.66666669 * var_x133 + 1800.0000000000002 * var_x134)) : (-0.034507985147763195 * var_x136));
        IJth(rJacobian, 4, 0) = ((var_x138) ? ((var_x132 - 0.001 * var_chaste_interface__i_Na_j_gate__j) * (var_x146 - 0.036429257142857142 * var_x150 + var_x145 * var_x151 * (3.0508668000000001e-7 * var_x140 - 6214.6032000000005 * var_x139) + 0.47718171428571432 * var_x147 * var_x149 / pow(var_x148, 2) - 44.428571428571431 * var_x142 * var_x152 / pow(var_x143, 2)) - var_x137 * (3.4628571428571431 * var_x150 + var_x146 * var_x151)) : (0.0048857142857142858 * var_x153 * var_x158 - 0.0075187969924812026 * var_x136 * var_x158 + 0.0085714285714285719 * var_x153 * var_x155 * var_x157 / pow(var_x156, 2)));
        IJth(rJacobian, 5, 0) = 0.00014285714285714287 * var_x159 * var_x174 / pow(var_x160, 2) + 510.20408163265313 * (-var_chaste_interface__i_CaL_d_gate__d + 1 / var_x160) * (-5.0000000000000002e-5 * var_x163 / pow(var_x164, 2) + 0.00027999999999999998 * var_x166 * var_x172 / pow(var_x167, 2) - 0.00015076923076923074 * var_x168 * var_x170 / pow(var_x171, 2)) / pow((var_x173 + 0.7142857142857143 * var_x165), 2);
        IJth(rJacobian, 6, 0) = ((var_x194) ? (var_x175 * var_x191 - var_x175 * var_x193) : (var_x191 - var_x193));
        IJth(rJacobian, 7, 0) = 0.00069444444444444447 * (0.33000000000000002 - var_chaste_interface__i_CaL_f2_gate__f2 + 0.67000000000000004 / var_x201) * (0.0032000000000000002 * var_x190 - var_x202 * (-0.29411764705882354 - 0.011764705882352941 * var_chaste_interface__Membrane__Vm_converted) - 0.0061999999999999998 * var_x196 / pow(var_x197, 2)) / pow((var_x199 + 0.051666666666666666 * var_x198 + 0.026666666666666668 * var_x179), 2) - 0.00016750000000000001 * var_x200 * var_x203 / pow(var_x201, 2);
        IJth(rJacobian, 9, 0) = 3.2206119162640899e-5 * var_x211 * var_x214 * var_x215 + 0.2040816326530612 * var_x212 * var_x217 / pow(var_x213, 2) - 0.10000000000000001 * var_x210 * var_x214 * var_x216;
        IJth(rJacobian, 10, 0) = 0.01488095238095238 * var_x219 * var_x222 * var_x223 - 0.02 * var_x220 * var_x225 / pow(var_x221, 2) - 0.050000000000000003 * var_x218 * var_x222 * var_x224;
        IJth(rJacobian, 11, 0) = 5.6818181818181818e-5 * var_x228 * var_x232 / pow(var_x229, 2) + 4.5454545454545452e-5 * var_x223 * var_x227 * var_x230 - 7.5757575757575758e-5 * var_x226 * var_x230 * var_x231 / var_x227;
        IJth(rJacobian, 12, 0) = 5.2631578947368424e-5 * var_x235 * (-var_chaste_interface__i_f_Xf_gate__Xf + 1 / var_x234) - 0.20000000000000001 * var_x233 * (0.0005263157894736842 + var_x236) / pow(var_x234, 2);
        IJth(rJacobian, 13, 0) = -7.6923076923076926e-5 * var_x237 * var_x242 / pow(var_x238, 2) - 0.078713879440468384 * (-var_chaste_interface__i_to_q_gate__q + 1 / var_x238) * (0.045599999999999995 * var_x240 - 0.0065000000000000006 * var_x239) / (pow((0.15497928494706154 + var_x241), 2) * pow((var_x240 + 0.11403508771929825 * var_x239), 2));
        IJth(rJacobian, 14, 0) = 5.3333333333333333e-5 * var_x243 * var_x248 / pow(var_x244, 2) - 0.064554184748538135 * (-var_chaste_interface__i_to_r_gate__r + 1 / var_x244) * (0.04428 * var_x246 - 0.093329999999999996 * var_x245) / (pow((0.19114817190506733 + var_x247), 2) * pow((var_x245 + 0.35583413693346194 * var_x246), 2));
        ...
        IJth(rJacobian, 6, 1) = ((var_x194) ? (-0.00069783670621074664 * var_x189 * var_x192 / pow((0.00064783670621074672 + var_chaste_interface__calcium_dynamics__Cai), 2)) : (0));
        IJth(rJacobian, 8, 1) = ((var_x209) ? (0) : (-5.1067680145940974e-26 * pow(var_chaste_interface__calcium_dynamics__Cai, 7) / pow((1.6796159999999989e-26 + var_x208), 2) - 380.05472788081482 * var_x206 / pow(var_x207, 2) - 142.52052295530555 * var_x204 / pow(var_x205, 2)));
        IJth(rJacobian, 15, 1) = 12669224.056004103 * var_x65 * NV_Ith_S(mParameters, 16);
        IJth(rJacobian, 16, 1) = var_x253 * (0.00044443999999999999 + var_x97);
        IJth(rJacobian, 17, 1) = ((var_x264) ? (0) : ((var_x255) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Cai, 5) / pow((1.8382656249999998e-21 + var_x262), 2)) : ((var_x265) ? (0) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Cai, 15) / pow((5.0709427749024951e-56 + var_x260), 2)))));
        ...
        IJth(rJacobian, 3, 3) = ((var_x138) ? (-0.037999999999999999 * var_x135 - 1.8 * var_x134 - 206666.66666666669 * var_x133) : (-0.39339103068450043));
        IJth(rJacobian, 15, 3) = -var_x249 * var_x8;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x73 * var_x74);
        IJth(rJacobian, 4, 4) = ((var_x138) ? (-0.003462857142857143 * var_x150 - 0.14285714285714285 * var_x144 * var_x152) : (-0.085714285714285715 * var_x158));
        IJth(rJacobian, 15, 4) = -var_x249 * var_x74;
        ...
        IJth(rJacobian, 5, 5) = -0.001 * var_x174;
        IJth(rJacobian, 16, 5) = var_x254 * var_chaste_interface__calcium_dynamics__g;
        ...
        IJth(rJacobian, 6, 6) = ((var_x194) ? (-var_x175 * var_x195) : (-var_x195));
        ...
        IJth(rJacobian, 15, 15) = (2771.3924296838059 * var_x86 - 13302683.662482269 * var_x89 - 4434227.8874940891 * var_x85 - var_x250 * var_x83 - var_x250 * var_x88) * NV_Ith_S(mParameters, 16);
        IJth(rJacobian, 1, 16) = var_x95 * (0.00044443999999999999 + var_x105 * (var_x113 - var_x114));
        IJth(rJacobian, 16, 16) = var_x253 * (-0.00044443999999999999 + var_x105 * (var_x114 - var_x113)) + 0.010048724562912011 * (var_x100 + var_x99 - var_x106 - var_x98) / (pow(var_x251, 3) * pow((0.33333333333333337 + var_x252), 2));
        IJth(rJacobian, 1, 17) = var_x108 * var_x95 * var_chaste_interface__i_CaL_d_gate__d;
        IJth(rJacobian, 16, 17) = var_x254 * var_chaste_interface__i_CaL_d_gate__d;
        IJth(rJacobian, 17, 17) = ((var_x264) ? (0) : ((var_x255) ? (-0.5) : ((var_x265) ? (0) : (-0.5))));
    }
