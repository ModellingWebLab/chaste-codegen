...
const double var_x0 = pow(var_chaste_interface__iKs_Xs_gate__Xs, 2);
        ...
        const double var_x174 = var_x160 - var_chaste_interface__iNa_j_gate__j;
        ...
        const double var_x203 = exp(0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__cell__V);
        ...
        const double var_x216 = 0.14285714285714285 * var_chaste_interface__cell__V;
        const double var_x217 = exp(2.8571428571428572 + var_x216);
        const double var_x218 = 1.0 + var_x217;
        const double var_x219 = var_x207 / pow(var_x208, 2);
        ...
        const double var_x226 = exp(5.0 + var_x216);
        ...
        const double var_x233 = var_chaste_interface__Ca__Ca_ss / pow((0.0025000000000000005 + var_x230), 2);
        ...
        const double var_x263 = var_x249 * var_x250 * var_x255;
        ...
        const double var_x270 = var_x264 * var_x268;
        const double var_x271 = var_x270 * var_x64;
        const double var_x272 = var_x270 * var_x66;
        ...
        const double var_x275 = 0.00079924407711721393 * var_x32;
        ...
        const double var_x278 = 0.00038819663608706523 * var_x5 - 1.4531710493040254e-5 * var_chaste_interface__cell__V;
        ...
        IJth(rJacobian, 15, 0) = ((var_x170) ? (var_x161 * (108035.0 * var_x162 + 0.21330000000000002 * var_x163 - 0.008382352941176471 * var_x164) - var_x169 * (var_x165 + var_x166 + var_x167)) : (-1.5943679469924423 * var_x168 * var_x173 + 0.53361053361053368 * var_x161 * var_x171 / pow(var_x172, 2)));
        IJth(rJacobian, 16, 0) = ((var_x170) ? (var_x174 * (var_x181 - 0.00025500480000000003 * var_x185 + var_x180 * var_x186 * (3.0508668000000001e-7 * var_x176 - 6214.6032000000005 * var_x175) + 0.0033402720000000005 * var_x182 * var_x184 / pow(var_x183, 2) - 0.311 * var_x177 * var_x178 * var_x186 / pow(var_x179, 2)) - var_x169 * (var_x187 + var_x188)) : (0.034200000000000001 * var_x174 * var_x192 - 0.16150740242261102 * var_x168 * var_x192 + 0.059999999999999998 * var_x174 * var_x189 * var_x191 / pow(var_x190, 2)));
        IJth(rJacobian, 17, 0) = 0.51020408163265307 * (-var_chaste_interface__iCaL_d_gate__d + 1 / var_x204) * (-0.050000000000000003 * var_x193 / pow(var_x194, 2) + 0.27999999999999997 * var_x196 * var_x201 / pow(var_x197, 2) - 0.15076923076923074 * var_x198 * var_x199 / pow(var_x200, 2)) / pow((var_x202 + 0.7142857142857143 * var_x195), 2) + 0.13333333333333333 * var_x203 * var_x205 / pow(var_x204, 2);
        IJth(rJacobian, 18, 0) = 1.3163239596670111e-5 * (-var_chaste_interface__iCaL_f_gate__f + 1 / var_x218) * (4.5 * var_x219 - var_x220 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__cell__V) - 5.0 * var_x211 / pow(var_x212, 2)) / pow((0.018140589569160998 + var_x215 + 0.16326530612244897 * var_x209 + 0.18140589569160998 * var_x213), 2) - 0.14285714285714285 * var_x217 * var_x221 / pow(var_x218, 2);
        IJth(rJacobian, 19, 0) = 1.2664479933131545e-5 * (0.25 - var_chaste_interface__iCaL_f2_gate__f2 + 0.75 / var_x227) * (4.0 * var_x219 - var_x228 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__cell__V) - 1.55 * var_x222 / pow(var_x223, 2)) / pow((var_x225 + 0.055160142348754451 * var_x224 + 0.14234875444839859 * var_x209), 2) - 0.10714285714285714 * var_x226 * var_x229 / pow(var_x227, 2);
        IJth(rJacobian, 21, 0) = var_x237 * (-1.7205545223759661e-8 + 3.0642541604521007e-12 * var_x35 + 1.2593500345045236e-9 * var_x30);
        IJth(rJacobian, 23, 0) = var_x269 * (-var_x265 + 0.00023577038909270109 * var_x51 - 5.8942597273175273e-5 * var_x52);
        IJth(rJacobian, 25, 0) = -2.1070980214908366e-8 - 3.7780501035135707e-9 * var_x30 - 9.1927624813563017e-12 * var_x35 - 0.00023854029832302029 * var_x41 - var_x275 * var_chaste_interface__iNa_h_gate__h;
        IJth(rJacobian, 26, 0) = var_x277 + 0.00015902686554868019 * var_x41 - 1.7438052591648303e-6 * var_chaste_interface__iKr_Markov__Or4 - 1.4531710493040254e-5 * var_x23 - 1.1822202600107163e-7 * var_x36 - 7.0696771548640841e-7 * var_x3 - 2.8482152566358896e-6 * var_x0 + var_x6 * (2.3119525668406228e-8 * var_x9 - 3.4651837760272254e-7 * var_x17 - var_x20 * var_x276);
        ...
        IJth(rJacobian, 26, 12) = var_x278 * var_chaste_interface__ito_r_gate__r;
        ...
        IJth(rJacobian, 26, 13) = var_x278 * var_chaste_interface__ito_s_gate__s;
        ...
        IJth(rJacobian, 15, 15) = ((var_x170) ? (-var_x165 - var_x166 - var_x167) : (-5.9230769230769234 * var_x173));
        IJth(rJacobian, 25, 15) = -var_x275 * var_x60;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-11.0 * var_x63);
        IJth(rJacobian, 16, 16) = ((var_x170) ? (-var_x187 - var_x188) : (-0.59999999999999998 * var_x192));
        ...
        IJth(rJacobian, 23, 17) = -var_x271 * var_chaste_interface__iCaL_f_gate__f;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * var_chaste_interface__iCaL_d_gate__d);
        IJth(rJacobian, 18, 18) = -var_x221;
        IJth(rJacobian, 23, 18) = -var_x271 * var_chaste_interface__iCaL_d_gate__d;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * var_chaste_interface__iCaL_fCass_gate__fCass);
        IJth(rJacobian, 19, 19) = -var_x229;
        IJth(rJacobian, 23, 19) = -var_x272 * var_chaste_interface__iCaL_fCass_gate__fCass;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * var_chaste_interface__iCaL_f2_gate__f2);
        IJth(rJacobian, 20, 20) = -var_x232;
        IJth(rJacobian, 23, 20) = -var_x272 * var_chaste_interface__iCaL_f2_gate__f2;
        ...
        IJth(rJacobian, 21, 21) = var_x237 * (-0.0038240087783467445 - var_x238 + 2.2487821987979791e-6 * var_x71 - 0.0086391412367010315 * var_x72 - 5.3144431236283834e-11 * var_x240 - 2.298124085635426e-7 * var_x70) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__Ca__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__Ca__Ca_SR + 2.298124085635426e-7 * log(2.0 * var_x70) - 0.0038240087783467445 * var_chaste_interface__Ca__Ca_i - 1.7205545223759661e-8 * var_chaste_interface__cell__V - 0.00042515544989027063 * var_x241 - var_x238 * var_chaste_interface__Ca__Ca_i + 1.2593500345045236e-9 * var_x26 * var_x34) / (pow(var_x234, 3) * pow(var_x235, 2));
        IJth(rJacobian, 22, 21) = var_x245 * (0.00036000000000000002 + 7.96875e-10 * var_x240);
        IJth(rJacobian, 23, 21) = 1.1399999999999999 * var_x268;
        IJth(rJacobian, 25, 21) = 0.025917423710103096 * var_x72;
        IJth(rJacobian, 21, 22) = 2.40087783467447e-5 * var_x236;
        IJth(rJacobian, 22, 22) = var_x245 * (-0.00036000000000000002 - var_x253 + 0.065280000000000005 * var_x260 - 0.0097919999999999986 * var_x257) + 0.66666666666666674 * (0.00036000000000000002 * var_chaste_interface__Ca__Ca_i + 0.0063749999999999996 * var_x241 - 0.00036000000000000002 * var_chaste_interface__Ca__Ca_SR - var_x253 * var_x255) / (pow(var_x242, 3) * pow((0.33333333333333337 + var_x243), 2));
        IJth(rJacobian, 23, 22) = var_x269 * (var_x273 + 0.1959116313094367 * var_x257 - 1.3060775420629114 * var_x260);
        IJth(rJacobian, 24, 22) = 0.059999999999999998 * var_x258 * var_chaste_interface__Ca__Ca_ss;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.072236434794126253 * var_x73);
        IJth(rJacobian, 20, 23) = -0.0020000000000000005 * var_x232 * var_x233 + 6.2500000000000001e-5 * var_x233 * (0.59999999999999998 - var_chaste_interface__iCaL_fCass_gate__fCass + 0.40000000000000002 * var_x231) / pow((0.025000000000000001 + var_x231), 2);
        IJth(rJacobian, 21, 23) = 0.0038 * var_x236;
        IJth(rJacobian, 22, 23) = var_x245 * (var_x253 + 0.097919999999999993 * var_x261 - 0.091799999999999993 * var_x262);
        IJth(rJacobian, 23, 23) = var_x269 * (-1.1399999999999999 - var_x273 + 1.8366715435259691 * var_x262 - 0.00078728921810821686 * var_x73 - 1.9591163130943672 * var_x261) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__Ca__Ca_i - 1.1399999999999999 * var_chaste_interface__Ca__Ca_ss + var_x255 * var_x273 - var_x265 * var_x49) / (pow(var_x266, 3) * pow(var_x267, 2));
        IJth(rJacobian, 24, 23) = var_x274 * var_chaste_interface__Irel__R_prime;
        IJth(rJacobian, 22, 24) = -0.045899999999999996 * var_x244 * var_x263;
        IJth(rJacobian, 23, 24) = 0.91833577176298453 * var_x263 * var_x268;
        IJth(rJacobian, 24, 24) = -0.0050000000000000001 + var_x274 * var_chaste_interface__Ca__Ca_ss;
        ...
        IJth(rJacobian, 21, 25) = 7.5561002070271413e-9 * var_x236 * var_x77;
        IJth(rJacobian, 25, 25) = 1.4908768645188767e-7 * var_x76 - 5.6288512232624455e-7 * var_x59 - 0.021350814984788587 * var_x79 - 2.2668300621081427e-8 * var_x77 - 0.00023854029832302029 * var_x75;
        ...
        IJth(rJacobian, 26, 26) = -4.6583596330447822e-5 * var_x84 - 1.8885766345635723e-5 * var_x85 - 0.00038819663608706523 * var_x86 - 0.00073043079046142181 * var_x78 + var_x277 * var_x83 + var_x6 * (6.576305692690868e-7 * var_x80 - 9.8566502268897146e-6 * var_x82 - var_x276 * var_x81);
    }
