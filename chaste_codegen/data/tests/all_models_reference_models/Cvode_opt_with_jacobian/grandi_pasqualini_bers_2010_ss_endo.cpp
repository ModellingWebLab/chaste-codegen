...
const double var_x0 = exp(7.4880000000000004 - 0.16722408026755853 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x258 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 10) - 0.0900900900900901 * var_chaste_interface__membrane_potential__V_m);
        const double var_x259 = 1.0 + var_x258;
        const double var_x260 = 0.01 * NV_Ith_S(mParameters, 9);
        const double var_x261 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * NV_Ith_S(mParameters, 10));
        const double var_x262 = 1.0 + var_x261;
        const double var_x263 = 1.0 - var_x260;
        const double var_x264 = var_x260 + var_x263 / pow(var_x262, 2);
        const double var_x265 = var_x264 - var_chaste_interface__I_Na__h;
        const double var_x266 = 1 / var_x259;
        const double var_x267 = var_x261 * var_x263 / pow(var_x262, 3);
        const double var_x268 = var_chaste_interface__membrane_potential__V_m >= -40.0;
        const double var_x269 = exp(0.34849999999999998 * var_chaste_interface__membrane_potential__V_m - 0.34849999999999998 * NV_Ith_S(mParameters, 10));
        const double var_x270 = exp(0.079000000000000001 * var_chaste_interface__membrane_potential__V_m - 0.079000000000000001 * NV_Ith_S(mParameters, 10));
        const double var_x271 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 10) - 0.14705882352941177 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x275 = 0.26917900403768508 * var_x267;
        const double var_x276 = var_x264 - var_chaste_interface__I_Na__j;
        const double var_x277 = exp(-3.2000000000000002 + 0.10000000000000001 * NV_Ith_S(mParameters, 10) - 0.10000000000000001 * var_chaste_interface__membrane_potential__V_m);
        const double var_x278 = 1.0 + var_x277;
        const double var_x279 = exp(0.057000000000000002 * var_chaste_interface__membrane_potential__V_m - 0.057000000000000002 * NV_Ith_S(mParameters, 10));
        const double var_x280 = var_x279 / var_x278;
        const double var_x281 = exp(0.24440000000000001 * var_chaste_interface__membrane_potential__V_m - 0.24440000000000001 * NV_Ith_S(mParameters, 10));
        const double var_x282 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 10) - 0.043909999999999998 * var_chaste_interface__membrane_potential__V_m);
        const double var_x283 = -25428.0 * var_x281 - 6.9480000000000002e-6 * var_x282;
        const double var_x284 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane_potential__V_m - 0.311 * NV_Ith_S(mParameters, 10));
        const double var_x285 = 1.0 + var_x284;
        const double var_x286 = 1 / var_x285;
        const double var_x287 = var_x283 * var_x286;
        const double var_x288 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 10) - 0.13780000000000001 * var_chaste_interface__membrane_potential__V_m);
        const double var_x289 = 1.0 + var_x288;
        const double var_x290 = exp(0.01052 * NV_Ith_S(mParameters, 10) - 0.01052 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x307 = 0.20000000000000001 * var_chaste_interface__membrane_potential__V_m;
        const double var_x308 = exp(-2.0 - var_x307);
        const double var_x309 = 1.0 + var_x308;
        const double var_x310 = 1 / (230.0 * var_x298 + 3300.0 * var_x306);
        const double var_x311 = exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x319 = exp(1.4615384615384615 - 0.076923076923076927 * var_chaste_interface__membrane_potential__V_m);
        const double var_x320 = 1.0 + var_x319;
        const double var_x321 = 0.076923076923076927 * var_x319 / pow(var_x320, 2);
        ...
        const double var_x327 = exp(3.8999999999999999 + var_x307);
        const double var_x328 = 1.0 + var_x327;
        const double var_x329 = 0.20000000000000001 * var_x327 / pow(var_x328, 2);
        ...
        const double var_x339 = -var_chaste_interface__I_Ca__d + 1 / var_x338;
        ...
        const double var_x344 = 0.0058333333333333336 * var_x335;
        ...
        const double var_x348 = exp(2.5 - var_x295);
        const double var_x349 = 1.0 + var_x348;
        const double var_x350 = exp(3.8888888888888888 + var_x299);
        ...
        const double var_x362 = var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x363 = var_x352 * var_x353 / pow(var_x354, 2);
        const double var_x364 = 2.3772197685794643 * var_x363;
        const double var_x365 = 0.21130842387373014 * var_x363 * var_x45 / pow((1 - 0.93333333333333335 * var_x355), 2);
        const double var_x366 = var_x365 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x367 = 20.0 * var_x359;
        const double var_x368 = var_x362 * var_x367;
        const double var_x369 = var_x364 * var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x370 = 7.5 - var_x356;
        const double var_x371 = 1.0 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        ...
        const double var_x388 = 18.571428571428569 * NV_Ith_S(mParameters, 0);
        const double var_x389 = var_chaste_interface__SR_Fluxes__Ry_Ro * NV_Ith_S(mParameters, 1);
        const double var_x390 = var_x389;
        const double var_x391 = var_x232 * NV_Ith_S(mParameters, 3);
        const double var_x392 = var_x391 * NV_Ith_S(mParameters, 18);
        const double var_x393 = 1830221710.9367213 * var_x392;
        const double var_x394 = var_x15 * var_x392;
        const double var_x395 = 201324388.20303935 * var_x149;
        const double var_x396 = var_x158 * var_x392;
        const double var_x397 = 20080.192774192485 * var_x392 * var_x72;
        const double var_x398 = var_x397 * var_x69;
        const double var_x399 = 3.2338732908121872 * var_x232;
        const double var_x400 = 7.3530178752050587e-13 * var_x189;
        const double var_x401 = var_x232 * NV_Ith_S(mParameters, 18);
        const double var_x402 = 49324475.109744638 * var_x392;
        const double var_x403 = 43898782.847672731 * var_x154;
        const double var_x404 = 60.129021696054153 * var_x392 * var_x66;
        ...
        const double var_x408 = 2891547759.4837179 * var_x113 * var_x401;
        const double var_x409 = var_x408 * var_x69;
        const double var_x410 = 1205.9369202226344 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x415 = 8658579.1242317986 * var_x122 * var_x401;
        ...
        IJth(rJacobian, 3, 0) = ((var_x268) ? (-1.5943679469924423 * var_x266 * var_x267 + 0.53361053361053368 * var_x258 * var_x265 / pow(var_x259, 2)) : (var_x265 * (108035.0 * var_x269 + 0.21330000000000002 * var_x270 - 0.008382352941176471 * var_x271) - var_x275 * (var_x272 + var_x273 + var_x274)));
        IJth(rJacobian, 4, 0) = ((var_x268) ? (0.034200000000000001 * var_x276 * var_x280 - 0.16150740242261102 * var_x267 * var_x280 + 0.059999999999999998 * var_x276 * var_x277 * var_x279 / pow(var_x278, 2)) : (var_x276 * (var_x287 - 0.00025500480000000003 * var_x291 + var_x286 * var_x292 * (3.0508668000000001e-7 * var_x282 - 6214.6032000000005 * var_x281) + 0.0033402720000000005 * var_x288 * var_x290 / pow(var_x289, 2) - 0.311 * var_x283 * var_x284 * var_x292 / pow(var_x285, 2)) - var_x275 * (var_x293 + var_x294)));
        IJth(rJacobian, 5, 0) = 9.1827364554637282e-8 * (-var_chaste_interface__I_Kr__x_kr + 1 / var_x309) * (11.5 * var_x296 / pow(var_x297, 2) + 366.66666666666669 * var_x300 * var_x305 / pow(var_x301, 2) - 366.66666666666669 * var_x302 * var_x303 / pow(var_x304, 2)) / pow((var_x306 + 0.069696969696969702 * var_x298), 2) + 0.20000000000000001 * var_x308 * var_x310 / pow(var_x309, 2);
        IJth(rJacobian, 6, 0) = -7.1529673512819408e-5 * var_x313 * (-var_chaste_interface__I_Ks__x_ks + 1 / var_x312) + 0.070175438596491224 * var_x311 * (0.00100999899000101 + var_x314) / pow(var_x312, 2);
        IJth(rJacobian, 7, 0) = var_x318 * var_x321 + 0.0074074074074074077 * var_x315 * (var_x322 - var_chaste_interface__I_to__x_to_s) / (pow(var_x316, 2) * pow((0.055555555555555552 + var_x317), 2));
        IJth(rJacobian, 8, 0) = -var_x326 * var_x329 + 0.000125 * var_x323 * (var_x330 - var_chaste_interface__I_to__y_to_s) / (pow(var_x324, 2) * pow((0.037499999999999999 + var_x325), 2));
        IJth(rJacobian, 9, 0) = var_x321 * var_x332 - 0.11764705882352941 * var_x331 * (-0.035999999999999997 - 0.00080000000000000004 * var_chaste_interface__membrane_potential__V_m) * (var_x322 - var_chaste_interface__I_to__x_to_f) / pow((0.058823529411764705 + var_x331), 2);
        IJth(rJacobian, 10, 0) = -var_x329 * var_x334 - 0.011764705882352941 * var_x333 * (-0.36363636363636365 - 0.0090909090909090905 * var_chaste_interface__membrane_potential__V_m) * (var_x330 - var_chaste_interface__I_to__y_to_f) / pow((0.082352941176470587 + var_x333), 2);
        IJth(rJacobian, 11, 0) = var_x340 * var_x342 - var_x340 * var_x345 + var_x341 * var_x344 * var_x346 / pow(var_x338, 2) - var_x339 * var_x341 * var_x345 / pow(var_x336, 2);
        IJth(rJacobian, 12, 0) = (0.02 + var_x347) * (0.029999999999999999 * var_x348 / pow(var_x349, 2) - 0.1111111111111111 * var_x350 / pow(var_x351, 2)) + var_x347 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__membrane_potential__V_m) * (-var_chaste_interface__I_Ca__f + 1 / var_x351 + 0.59999999999999998 / var_x349);
        IJth(rJacobian, 33, 0) = -var_x393 * (6.567e-5 + var_x139 + var_x74 - var_x131 + 0.11 * var_x16 + 0.33000000000000002 * var_x102 + 0.33000000000000002 * var_x55 + 0.0028858573878494881 * var_x128);
        IJth(rJacobian, 34, 0) = -var_x402 * (0.00053133 + var_x135 + var_x68 - var_x133 + 0.89000000000000001 * var_x16 + 2.6699999999999999 * var_x104 + 2.6699999999999999 * var_x88 + 0.023349209774418588 * var_x121);
        IJth(rJacobian, 37, 0) = -var_x407 * (6.0643000000000002e-5 + var_x115 + var_x147 - var_x143 - 0.22 * var_x55 - 0.0019239049252329922 * var_x128);
        IJth(rJacobian, 38, 0) = -var_x414 * (0.00049065700000000003 + var_x126 + var_x145 - var_x142 - 1.78 * var_x88 - 0.015566139849612391 * var_x121);
        ...
        IJth(rJacobian, 11, 11) = -var_x342 * var_x346;
        IJth(rJacobian, 33, 11) = -var_x163 * var_x398;
        IJth(rJacobian, 34, 11) = -var_x164 * var_x404;
        IJth(rJacobian, 37, 11) = -var_x167 * var_x409;
        IJth(rJacobian, 38, 11) = -var_x169 * var_x415;
        ...
        IJth(rJacobian, 12, 12) = -0.02 - var_x347;
        IJth(rJacobian, 33, 12) = -var_x172 * var_x398;
        IJth(rJacobian, 34, 12) = -var_x171 * var_x404;
        IJth(rJacobian, 37, 12) = -var_x174 * var_x409;
        IJth(rJacobian, 38, 12) = -var_x173 * var_x415 * var_x62;
        ...
        IJth(rJacobian, 33, 13) = var_x136 * var_x397;
        IJth(rJacobian, 37, 13) = var_x177 * var_x408;
        ...
        IJth(rJacobian, 34, 14) = var_x136 * var_x404;
        IJth(rJacobian, 38, 14) = var_x177 * var_x415;
        IJth(rJacobian, 15, 15) = -0.0050000000000000001 + var_x358 + var_x361;
        IJth(rJacobian, 16, 15) = var_x360;
        IJth(rJacobian, 17, 15) = var_x361;
        IJth(rJacobian, 15, 16) = 0.055;
        IJth(rJacobian, 16, 16) = -0.059999999999999998 + var_x358;
        IJth(rJacobian, 17, 16) = var_x361 + var_x370 * var_chaste_interface__Ca_Concentrations__Ca_j;
        ...
        IJth(rJacobian, 17, 17) = -0.065000000000000002 + var_x361;
        IJth(rJacobian, 18, 18) = -0.001 - var_x372;
        IJth(rJacobian, 33, 18) = (0.001 + var_x372) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 19, 19) = -0.001 - var_x374;
        IJth(rJacobian, 34, 19) = (0.001 + var_x374) * NV_Ith_S(mParameters, 3);
        ...
        IJth(rJacobian, 21, 21) = -3.1999999999999999e-5 + var_x376;
        ...
        IJth(rJacobian, 24, 24) = -0.00046000000000000001 + var_x377;
        IJth(rJacobian, 25, 24) = -0.015699999999999999;
        IJth(rJacobian, 1, 25) = 0.015757 + var_x246;
        IJth(rJacobian, 24, 25) = var_x377;
        ...
        IJth(rJacobian, 37, 27) = 1.3 + var_x378;
        IJth(rJacobian, 28, 28) = -1.3 + var_x382;
        IJth(rJacobian, 38, 28) = 1.3 + var_x381;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x379;
        IJth(rJacobian, 37, 29) = 0.029999999999999999 + var_x378;
        IJth(rJacobian, 30, 30) = -0.029999999999999999 + var_x382;
        IJth(rJacobian, 38, 30) = 0.029999999999999999 + var_x381;
        IJth(rJacobian, 31, 31) = -65.0 - var_x386;
        IJth(rJacobian, 32, 31) = 65.0 + var_x386;
        IJth(rJacobian, 1, 32) = 0.037279237232671424 * var_x249 + 4.7061860318210743e-15 * var_x250;
        IJth(rJacobian, 15, 32) = -var_x366 + var_x362 * var_x364;
        IJth(rJacobian, 16, 32) = var_x366 + var_x369;
        IJth(rJacobian, 17, 32) = -var_x369 + var_x365 * var_x371;
        IJth(rJacobian, 31, 32) = 260.0 - var_x387;
        IJth(rJacobian, 32, 32) = -260.0 + var_x387 - var_x388 - var_x390 - 0.69232869146389786 * var_x249 - 8.7400597733819945e-14 * var_x250;
        IJth(rJacobian, 37, 32) = var_x410 + var_x411;
        ...
        IJth(rJacobian, 18, 33) = 0.0007561 - var_x373;
        IJth(rJacobian, 33, 33) = (-0.0007561 + var_x373 - var_x399 - 1830221710.9367213 * var_x401 * (var_x178 + var_x179 + var_x180 + 9.0157776108189337e-5 * var_x182 + 0.98999999999999999 * var_x192 + var_x186 * var_x400)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 34, 33) = 0.087152885187388451 * var_x391;
        IJth(rJacobian, 37, 33) = -var_x407 * (-0.66000000000000003 * var_x192 - var_x186 * var_x412);
        ...
        IJth(rJacobian, 19, 34) = 0.000165 - var_x375;
        IJth(rJacobian, 33, 34) = var_x399 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 34, 34) = (-0.000165 + var_x375 - 7.8853682331945256 * var_x232 - 49324475.109744638 * var_x401 * (var_x193 + var_x194 + var_x195 + 8.0099999999999998 * var_x202 + 0.00072945837032989554 * var_x201 + var_x197 * var_x405)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 35, 34) = var_x406;
        IJth(rJacobian, 38, 34) = -var_x414 * (-5.3399999999999999 * var_x202 - var_x197 * var_x416);
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00018851030986163651 * var_x203 - 0.43577707993988701 * var_x204);
        IJth(rJacobian, 34, 35) = 7.7982153480071377 * var_x391;
        IJth(rJacobian, 35, 35) = -var_x406;
        ...
        IJth(rJacobian, 15, 37) = -var_x368 + var_x357 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        IJth(rJacobian, 16, 37) = var_x368 + var_x357 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        IJth(rJacobian, 17, 37) = var_x370 * var_chaste_interface__SR_Fluxes__Ry_Ro + var_x367 * var_x371 * var_chaste_interface__Ca_Concentrations__Ca_j;
        IJth(rJacobian, 27, 37) = 55.473098330241186 - var_x380;
        IJth(rJacobian, 29, 37) = 19.897959183673468 - var_x384;
        IJth(rJacobian, 32, 37) = var_x388 + var_x390;
        IJth(rJacobian, 33, 37) = -var_x393 * (1.4849999999999997e-8 * var_x215 - 0.33000000000000002 * var_x212 + var_x214 * var_x400);
        IJth(rJacobian, 37, 37) = -75.37105751391465 + var_x380 + var_x384 - var_x410 - var_x411 - var_x413 - var_x407 * (var_x206 + var_x209 + var_x216 - var_x208 + 0.22 * var_x212 - 9.8999999999999977e-9 * var_x215 - var_x214 * var_x412);
        ...
        IJth(rJacobian, 28, 38) = 121.55000000000001 - var_x383;
        IJth(rJacobian, 30, 38) = 43.550000000000004 - var_x385;
        IJth(rJacobian, 34, 38) = -var_x402 * (1.2014999999999997e-7 * var_x223 - 2.6699999999999999 * var_x221 + var_x222 * var_x405);
        IJth(rJacobian, 37, 38) = var_x413;
        IJth(rJacobian, 38, 38) = -165.10000000000002 + var_x383 + var_x385 - 19.504723378941105 * var_x232 - var_x414 * (var_x217 + var_x220 + var_x224 - var_x219 + 1.78 * var_x221 - 8.0099999999999983e-8 * var_x223 - var_x222 * var_x416);
    }
