...
const double var_x0 = -0.34100000000000003 * NV_Ith_S(mParameters, 4);
        ...
        const double var_x204 = 1.042038e-5 * NV_Ith_S(mParameters, 7);
        const double var_x205 = var_x204 * var_x4;
        const double var_x206 = var_x205 * var_x3;
        const double var_x207 = var_x204 * var_x9;
        const double var_x208 = -var_x206 - var_x207 * var_x8;
        const double var_x209 = var_x203 * var_x208;
        const double var_x210 = var_x206 - var_x209;
        const double var_x211 = var_x17 * var_x205;
        const double var_x212 = -var_x211 - var_x18 * var_x207;
        const double var_x213 = var_x203 * var_x212;
        ...
        const double var_x218 = var_x217 * var_x26;
        const double var_x219 = 7.236374999999999e-11 * var_x9;
        const double var_x220 = -var_x218 - var_x219 * var_x28;
        const double var_x221 = var_x216 * var_x220;
        const double var_x222 = var_x218 - var_x221;
        const double var_x223 = var_x217 * var_x32;
        const double var_x224 = -var_x223 - var_x219 * var_x33;
        const double var_x225 = var_x216 * var_x224;
        const double var_x226 = var_x223 - var_x225;
        const double var_x227 = var_x216 * (-1.3025475e-9 * var_x37 - 1.3025475e-9 * var_x38);
        const double var_x228 = var_x39 * (0.45000000000000001 * var_x227 - 5.8614637499999997e-10 * var_x37);
        const double var_x229 = var_x14 * var_x222 + var_x22 * var_x226 + var_x228 * var_chaste_interface__I_Ca__f;
        const double var_x230 = var_x139 * var_chaste_interface__membrane_potential__V_m;
        const double var_x231 = var_x230 * var_chaste_interface__I_Ca__f;
        const double var_x232 = var_x140 * var_x144;
        const double var_x233 = var_x231 * var_x232;
        const double var_x234 = var_x146 * var_x150;
        const double var_x235 = var_x231 * var_x234;
        const double var_x236 = -var_x233 - var_x235;
        const double var_x237 = var_x165 * var_chaste_interface__membrane_potential__V_m;
        const double var_x238 = var_x237 * var_chaste_interface__I_Ca__f;
        const double var_x239 = var_x146 * var_x169;
        const double var_x240 = var_x238 * var_x239;
        const double var_x241 = var_x140 * var_x173;
        const double var_x242 = var_x238 * var_x241;
        const double var_x243 = var_x177 * var_x39;
        const double var_x244 = var_x13 * var_chaste_interface__I_Ca__d;
        const double var_x245 = var_x21 * var_chaste_interface__I_Ca__d;
        const double var_x246 = var_x222 * var_x244 + var_x226 * var_x245 + var_x228 * var_chaste_interface__I_Ca__d;
        const double var_x247 = var_x230 * var_chaste_interface__I_Ca__d;
        const double var_x248 = var_x232 * var_x247;
        const double var_x249 = var_x234 * var_x247;
        const double var_x250 = -var_x248 - var_x249;
        const double var_x251 = var_x237 * var_chaste_interface__I_Ca__d;
        const double var_x252 = var_x239 * var_x251;
        const double var_x253 = var_x241 * var_x251;
        const double var_x254 = var_x4 * NV_Ith_S(mParameters, 7);
        const double var_x255 = 4.2202539000000001e-6 * var_x17 * var_x254;
        const double var_x256 = 2.9307318749999998e-11 * var_x32 * var_x4;
        const double var_x257 = var_x40 * (var_x256 - 0.40500000000000003 * var_x225) + var_x40 * (5.2753173749999997e-10 * var_x37 - 0.40500000000000003 * var_x227);
        const double var_x258 = var_x147 * var_chaste_interface__membrane_potential__V_m;
        const double var_x259 = var_x144 * var_x258;
        const double var_x260 = var_x166 * var_chaste_interface__membrane_potential__V_m;
        const double var_x261 = var_x173 * var_x260;
        const double var_x262 = var_x176 * var_x260;
        const double var_x263 = 4.689170999999999e-7 * var_x254 * var_x3;
        const double var_x264 = 3.2563687499999987e-12 * var_x26 * var_x4;
        const double var_x265 = var_x40 * (var_x264 - 0.044999999999999991 * var_x221) + var_x40 * (5.8614637499999984e-11 * var_x37 - 0.044999999999999991 * var_x227);
        const double var_x266 = var_x150 * var_x258;
        const double var_x267 = var_x169 * var_x260;
        ...
        const double var_x278 = 3 * NV_Ith_S(mParameters, 4);
        ...
        const double var_x284 = 2.4510059584016866e-13 * var_x283;
        const double var_x285 = var_x77 * NV_Ith_S(mParameters, 4);
        const double var_x286 = var_x277 * var_x285 * var_x96;
        const double var_x287 = -var_x273 - var_x274 - 0.33000000000000002 * var_x286 - 3.0052592036063111e-5 * var_x276 - var_x280 * var_x284;
        ...
        const double var_x295 = 1.9830866390704552e-12 * var_x294;
        ...
        const double var_x298 = -var_x289 - var_x290 - 2.6699999999999999 * var_x297 - 0.00024315279010996517 * var_x296 - var_x292 * var_x295;
        const double var_x299 = 9.1428780887586595e-7 * var_x182;
        const double var_x300 = var_x198 * var_x49;
        const double var_x301 = var_x198 * var_x50;
        const double var_x302 = var_x112 * var_x51;
        const double var_x303 = -23.773981447893455 * var_x301 - 0.010284250401616832 * var_x300 - var_x127 * (6.4983106368865622 * var_x302 - var_x70 * (1.053972635420138 * var_x51 * var_x71 + 1.6494869150645177 * var_x51 * var_x72) - 13.738155796237757 * var_x125 * var_x51) + 2.7964276527937963 * var_x113 * var_x302 - 1.0042770859719128 * var_x51 * var_x54 - 11.72506353372661 * var_x51 * var_x76 - 0.037504123542519557 * var_x51 * var_x55 - 0.053424677410996532 * var_x44 * var_x51 - 11.495160327182951 * var_x51 * var_x60 * var_x63;
        const double var_x304 = 3.5533495800000002e-6 * NV_Ith_S(mParameters, 7);
        ...
        const double var_x311 = 61.507432902288166 + var_chaste_interface__membrane_potential__V_m;
        ...
        const double var_x317 = var_x309 - var_x307 - var_x310 + 0.11 * var_x313 - 4.9499999999999988e-9 * var_x316 - var_x284 * var_x315 - 0.00060293750000000007 * var_x311 * var_x88 / pow(var_x46, 2);
        ...
        const double var_x326 = var_x321 - var_x319 - var_x322 + 0.89000000000000001 * var_x323 - 4.0049999999999991e-8 * var_x325 - var_x295 * var_x324 - 0.0048783125000000007 * var_x103 * var_x311 / pow(var_x48, 2);
        ...
        const double var_x342 = NV_Ith_S(mParameters, 2) / (1.0 + var_x339 + var_x341);
        const double var_x343 = var_x337 * var_x342;
        const double var_x344 = (var_x341 - var_x339) * NV_Ith_S(mParameters, 2) / pow((3.5530476870814998e-7 + var_x340 + 1.3765399305573384e-7 * var_x338), 2);
        ...
        const double var_x356 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x361 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 10) - 0.0900900900900901 * var_chaste_interface__membrane_potential__V_m);
        const double var_x362 = 1.0 + var_x361;
        const double var_x363 = 0.01 * NV_Ith_S(mParameters, 9);
        const double var_x364 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * NV_Ith_S(mParameters, 10));
        const double var_x365 = 1.0 + var_x364;
        const double var_x366 = 1.0 - var_x363;
        const double var_x367 = var_x363 + var_x366 / pow(var_x365, 2);
        const double var_x368 = var_x367 - var_chaste_interface__I_Na__h;
        const double var_x369 = 1 / var_x362;
        const double var_x370 = var_x364 * var_x366 / pow(var_x365, 3);
        const double var_x371 = var_chaste_interface__membrane_potential__V_m >= -40.0;
        const double var_x372 = exp(0.34849999999999998 * var_chaste_interface__membrane_potential__V_m - 0.34849999999999998 * NV_Ith_S(mParameters, 10));
        const double var_x373 = exp(0.079000000000000001 * var_chaste_interface__membrane_potential__V_m - 0.079000000000000001 * NV_Ith_S(mParameters, 10));
        const double var_x374 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 10) - 0.14705882352941177 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x378 = 0.26917900403768508 * var_x370;
        const double var_x379 = var_x367 - var_chaste_interface__I_Na__j;
        const double var_x380 = exp(-3.2000000000000002 + 0.10000000000000001 * NV_Ith_S(mParameters, 10) - 0.10000000000000001 * var_chaste_interface__membrane_potential__V_m);
        const double var_x381 = 1.0 + var_x380;
        const double var_x382 = exp(0.057000000000000002 * var_chaste_interface__membrane_potential__V_m - 0.057000000000000002 * NV_Ith_S(mParameters, 10));
        const double var_x383 = var_x382 / var_x381;
        const double var_x384 = exp(0.24440000000000001 * var_chaste_interface__membrane_potential__V_m - 0.24440000000000001 * NV_Ith_S(mParameters, 10));
        const double var_x385 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 10) - 0.043909999999999998 * var_chaste_interface__membrane_potential__V_m);
        const double var_x386 = -25428.0 * var_x384 - 6.9480000000000002e-6 * var_x385;
        const double var_x387 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane_potential__V_m - 0.311 * NV_Ith_S(mParameters, 10));
        const double var_x388 = 1.0 + var_x387;
        const double var_x389 = 1 / var_x388;
        const double var_x390 = var_x386 * var_x389;
        const double var_x391 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 10) - 0.13780000000000001 * var_chaste_interface__membrane_potential__V_m);
        const double var_x392 = 1.0 + var_x391;
        const double var_x393 = exp(0.01052 * NV_Ith_S(mParameters, 10) - 0.01052 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x410 = 0.20000000000000001 * var_chaste_interface__membrane_potential__V_m;
        const double var_x411 = exp(-2.0 - var_x410);
        const double var_x412 = 1.0 + var_x411;
        const double var_x413 = 1 / (230.0 * var_x401 + 3300.0 * var_x409);
        const double var_x414 = exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x422 = exp(1.4615384615384615 - 0.076923076923076927 * var_chaste_interface__membrane_potential__V_m);
        const double var_x423 = 1.0 + var_x422;
        const double var_x424 = 0.076923076923076927 * var_x422 / pow(var_x423, 2);
        const double var_x425 = 1 / var_x423;
        ...
        const double var_x430 = exp(3.8999999999999999 + var_x410);
        const double var_x431 = 1.0 + var_x430;
        const double var_x432 = 0.20000000000000001 * var_x430 / pow(var_x431, 2);
        const double var_x433 = 1 / var_x431;
        ...
        const double var_x447 = -var_chaste_interface__I_Ca__d + var_x446;
        ...
        const double var_x456 = 0.0058333333333333336 * var_x444;
        const double var_x457 = var_x449 * var_x456;
        ...
        const double var_x459 = exp(2.5 - var_x398);
        const double var_x460 = 1.0 + var_x459;
        const double var_x461 = exp(3.8888888888888888 + var_x402);
        ...
        const double var_x473 = var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x474 = var_x463 * var_x464 / pow(var_x465, 2);
        const double var_x475 = 2.3772197685794643 * var_x474;
        const double var_x476 = 0.21130842387373014 * var_x474 * var_x87 / pow((1 - 0.93333333333333335 * var_x466), 2);
        const double var_x477 = var_x476 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x478 = 20.0 * var_x470;
        const double var_x479 = var_x473 * var_x478;
        const double var_x480 = var_x475 * var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x481 = 7.5 - var_x467;
        const double var_x482 = 1.0 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        ...
        const double var_x499 = 18.571428571428569 * NV_Ith_S(mParameters, 0);
        const double var_x500 = var_chaste_interface__SR_Fluxes__Ry_Ro * NV_Ith_S(mParameters, 1);
        const double var_x501 = var_x500;
        const double var_x502 = 0.40500000000000003 - var_x20;
        const double var_x503 = var_x40 * var_x502;
        const double var_x504 = 6.567e-5 + 0.11 * var_x58 + 0.33000000000000002 * var_x122 + 0.33000000000000002 * var_x97 + 0.0028858573878494881 * var_x132;
        const double var_x505 = var_x335 * NV_Ith_S(mParameters, 3);
        const double var_x506 = var_x505 * NV_Ith_S(mParameters, 18);
        const double var_x507 = 1830221710.9367213 * var_x506;
        const double var_x508 = var_x506 * var_x57;
        const double var_x509 = 201324388.20303935 * var_x188;
        const double var_x510 = var_x197 * var_x506;
        const double var_x511 = -2.6712338705498262e-6 + var_chaste_interface__membrane_potential__V_m;
        const double var_x512 = var_x224 * var_x511;
        const double var_x513 = var_x502 * (var_x223 - 187179.41753901311 * var_x512);
        ...
        const double var_x517 = var_x335 * NV_Ith_S(mParameters, 18);
        const double var_x518 = 0.044999999999999991 - var_x12;
        const double var_x519 = var_x40 * var_x518;
        const double var_x520 = 0.00053133 + 0.89000000000000001 * var_x58 + 2.6699999999999999 * var_x111 + 2.6699999999999999 * var_x124 + 0.023349209774418588 * var_x130;
        const double var_x521 = 49324475.109744638 * var_x506;
        const double var_x522 = 43898782.847672731 * var_x193;
        const double var_x523 = var_x220 * var_x511;
        const double var_x524 = var_x518 * (var_x218 - 187179.41753901311 * var_x523);
        ...
        const double var_x528 = 6.0643000000000002e-5 - 0.22 * var_x97 - 0.0019239049252329922 * var_x132;
        const double var_x529 = 915110855.46836066 * var_x517;
        const double var_x530 = -1.3356169352749131e-6 + var_chaste_interface__membrane_potential__V_m;
        const double var_x531 = var_x212 * var_x530;
        const double var_x532 = var_x502 * (var_x211 - 374358.83507802623 * var_x531);
        const double var_x533 = 1205.9369202226344 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x538 = 0.00049065700000000003 - 1.78 * var_x111 - 0.015566139849612391 * var_x130;
        const double var_x539 = 24662237.554872319 * var_x517;
        const double var_x540 = var_x208 * var_x530;
        const double var_x541 = var_x518 * (var_x206 - 374358.83507802623 * var_x540);
        ...
        IJth(rJacobian, 2, 0) = 59.906641489902128 * (-var_chaste_interface__I_Na__m + 1 / pow(var_x357, 2)) * (-var_x358 * (-0.3792264410025028 - 0.0082818615637148471 * var_chaste_interface__membrane_potential__V_m) - var_x359 * (0.0036911829173615863 - 0.00076532923851577563 * var_chaste_interface__membrane_potential__V_m)) / pow((var_x355 + 0.5020897832817337 * var_x354), 2) + 0.22148394241417499 * var_x356 * var_x360 / pow(var_x357, 3);
        IJth(rJacobian, 3, 0) = ((var_x371) ? (-1.5943679469924423 * var_x369 * var_x370 + 0.53361053361053368 * var_x361 * var_x368 / pow(var_x362, 2)) : (var_x368 * (108035.0 * var_x372 + 0.21330000000000002 * var_x373 - 0.008382352941176471 * var_x374) - var_x378 * (var_x375 + var_x376 + var_x377)));
        IJth(rJacobian, 4, 0) = ((var_x371) ? (0.034200000000000001 * var_x379 * var_x383 - 0.16150740242261102 * var_x370 * var_x383 + 0.059999999999999998 * var_x379 * var_x380 * var_x382 / pow(var_x381, 2)) : (var_x379 * (var_x390 - 0.00025500480000000003 * var_x394 + var_x389 * var_x395 * (3.0508668000000001e-7 * var_x385 - 6214.6032000000005 * var_x384) + 0.0033402720000000005 * var_x391 * var_x393 / pow(var_x392, 2) - 0.311 * var_x386 * var_x387 * var_x395 / pow(var_x388, 2)) - var_x378 * (var_x396 + var_x397)));
        IJth(rJacobian, 5, 0) = 9.1827364554637282e-8 * (-var_chaste_interface__I_Kr__x_kr + 1 / var_x412) * (11.5 * var_x399 / pow(var_x400, 2) + 366.66666666666669 * var_x403 * var_x408 / pow(var_x404, 2) - 366.66666666666669 * var_x405 * var_x406 / pow(var_x407, 2)) / pow((var_x409 + 0.069696969696969702 * var_x401), 2) + 0.20000000000000001 * var_x411 * var_x413 / pow(var_x412, 2);
        IJth(rJacobian, 6, 0) = -7.1529673512819408e-5 * var_x416 * (-var_chaste_interface__I_Ks__x_ks + 1 / var_x415) + 0.070175438596491224 * var_x414 * (0.00100999899000101 + var_x417) / pow(var_x415, 2);
        IJth(rJacobian, 7, 0) = var_x421 * var_x424 + 0.0074074074074074077 * var_x418 * (var_x425 - var_chaste_interface__I_to__x_to_s) / (pow(var_x419, 2) * pow((0.055555555555555552 + var_x420), 2));
        IJth(rJacobian, 8, 0) = -var_x429 * var_x432 + 0.000125 * var_x426 * (var_x433 - var_chaste_interface__I_to__y_to_s) / (pow(var_x427, 2) * pow((0.037499999999999999 + var_x428), 2));
        IJth(rJacobian, 9, 0) = var_x424 * var_x435 - 0.11764705882352941 * var_x434 * (-0.035999999999999997 - 0.00080000000000000004 * var_chaste_interface__membrane_potential__V_m) * (var_x425 - var_chaste_interface__I_to__x_to_f) / pow((0.058823529411764705 + var_x434), 2);
        IJth(rJacobian, 10, 0) = -var_x432 * var_x437 - 0.011764705882352941 * var_x436 * (-0.36363636363636365 - 0.0090909090909090905 * var_chaste_interface__membrane_potential__V_m) * (var_x433 - var_chaste_interface__I_to__y_to_f) / pow((0.082352941176470587 + var_x436), 2);
        IJth(rJacobian, 11, 0) = ((var_x450) ? (4.4099999986215979e-16 * var_x447 * (-39682539694942.977 * var_x439 - 39682539694942.977 * var_x442) / pow((-var_x439 + 0.017500000000000002 * var_x443), 2) + 0.16666666666666666 * var_x444 * var_x448 / pow(var_x445, 2)) : (var_x453 * var_x454 - var_x453 * var_x457 + var_x446 * var_x455 * var_x456 - var_x445 * var_x447 * var_x457 / pow(var_x451, 2)));
        IJth(rJacobian, 12, 0) = (0.02 + var_x458) * (0.029999999999999999 * var_x459 / pow(var_x460, 2) - 0.1111111111111111 * var_x461 / pow(var_x462, 2)) + var_x458 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__membrane_potential__V_m) * (-var_chaste_interface__I_Ca__f + 1 / var_x462 + 0.59999999999999998 / var_x460);
        IJth(rJacobian, 33, 0) = -var_x507 * ((var_x162) ? (var_x504 + var_x34 * var_x503) : (var_x174 + var_x186 + var_x504 - var_x180));
        IJth(rJacobian, 34, 0) = -var_x521 * ((var_x162) ? (var_x520 + var_x30 * var_x519) : (var_x170 + var_x183 + var_x520 - var_x181));
        IJth(rJacobian, 37, 0) = -var_x529 * ((var_x136) ? (var_x528 + var_x19 * var_x503) : (var_x145 + var_x160 + var_x528 - var_x156));
        IJth(rJacobian, 38, 0) = -var_x539 * ((var_x136) ? (var_x538 + var_x11 * var_x519) : (var_x151 + var_x158 + var_x538 - var_x155));
        IJth(rJacobian, 1, 1) = -7.0788000000000011 + var_x328 + var_x329 + var_x330 + var_x331 + var_x332 + var_x333 + var_x334 - var_x336 + 3.4188518090540365e-8 * var_x345 - 270818.42237280885 * var_x343;
        IJth(rJacobian, 20, 1) = 2.2890000000000006 - var_x330;
        IJth(rJacobian, 21, 1) = 0.33180000000000004 - var_x331 - var_x332;
        IJth(rJacobian, 23, 1) = 0.81600000000000006 - var_x328;
        IJth(rJacobian, 24, 1) = 1.9320000000000004 - var_x333 - var_x334;
        IJth(rJacobian, 26, 1) = 1.71 - var_x329;
        IJth(rJacobian, 32, 1) = 5029484.9869235931 * var_x343 - 6.3492962168146398e-7 * var_x345;
        IJth(rJacobian, 38, 1) = 15.582629387269481 * var_x335;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.33000000000000002 * var_x191 - 2.6699999999999999 * var_x194);
        IJth(rJacobian, 2, 2) = -var_x360;
        IJth(rJacobian, 33, 2) = -603973164.60911798 * var_x191 * var_x506;
        IJth(rJacobian, 34, 2) = -131696348.54301819 * var_x194 * var_x506;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x195 * var_x57 - var_x196 * var_x57);
        IJth(rJacobian, 3, 3) = ((var_x371) ? (-5.9230769230769234 * var_x369) : (-var_x375 - var_x376 - var_x377));
        IJth(rJacobian, 33, 3) = -var_x508 * var_x509;
        IJth(rJacobian, 34, 3) = -var_x508 * var_x522;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x195 * var_x197 - var_x196 * var_x197);
        IJth(rJacobian, 4, 4) = ((var_x371) ? (-0.59999999999999998 * var_x383) : (-var_x396 - var_x397));
        IJth(rJacobian, 33, 4) = -var_x509 * var_x510;
        IJth(rJacobian, 34, 4) = -var_x510 * var_x522;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * var_x64 * NV_Ith_S(mParameters, 13));
        IJth(rJacobian, 5, 5) = -var_x413;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00077000000000000007 * var_x199 - 1.78 * var_x199 * NV_Ith_S(mParameters, 14));
        IJth(rJacobian, 6, 6) = -0.00100999899000101 - var_x417;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x200 * var_chaste_interface__I_to__y_to_s);
        IJth(rJacobian, 7, 7) = -var_x421;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x200 * var_chaste_interface__I_to__x_to_s);
        IJth(rJacobian, 8, 8) = -var_x429;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x201 * var_chaste_interface__I_to__y_to_f);
        IJth(rJacobian, 9, 9) = -var_x435;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x201 * var_chaste_interface__I_to__x_to_f);
        IJth(rJacobian, 10, 10) = -var_x437;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x136) ? (var_x229 + var_x14 * var_x210 + var_x214 * var_x22) : ((var_x162) ? (var_x229 + var_x236) : (var_x236 - var_x240 - var_x242 - var_x238 * var_x243))));
        IJth(rJacobian, 11, 11) = ((var_x450) ? (-var_x448) : (-var_x454 * var_x455));
        IJth(rJacobian, 33, 11) = -var_x507 * ((var_x162) ? (var_x513 * var_chaste_interface__I_Ca__f) : (var_x242));
        IJth(rJacobian, 34, 11) = -var_x521 * ((var_x162) ? (var_x524 * var_chaste_interface__I_Ca__f) : (var_x240));
        IJth(rJacobian, 37, 11) = -var_x529 * ((var_x136) ? (var_x532 * var_chaste_interface__I_Ca__f) : (var_x233));
        IJth(rJacobian, 38, 11) = -var_x539 * ((var_x136) ? (var_x541 * var_chaste_interface__I_Ca__f) : (var_x235));
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x136) ? (var_x246 + var_x210 * var_x244 + var_x214 * var_x245) : ((var_x162) ? (var_x246 + var_x250) : (var_x250 - var_x252 - var_x253 - var_x243 * var_x251))));
        IJth(rJacobian, 12, 12) = -0.02 - var_x458;
        IJth(rJacobian, 33, 12) = -var_x507 * ((var_x162) ? (var_x513 * var_chaste_interface__I_Ca__d) : (var_x253));
        IJth(rJacobian, 34, 12) = -var_x521 * ((var_x162) ? (var_x524 * var_chaste_interface__I_Ca__d) : (var_x252));
        IJth(rJacobian, 37, 12) = -var_x529 * ((var_x136) ? (var_x532 * var_chaste_interface__I_Ca__d) : (var_x248));
        IJth(rJacobian, 38, 12) = -var_x539 * ((var_x136) ? (var_x541 * var_chaste_interface__I_Ca__d) : (var_x249));
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x136) ? (var_x257 + var_x40 * (var_x255 - 0.40500000000000003 * var_x213)) : ((var_x162) ? (var_x257 + var_x259) : (var_x259 + var_x261 + 0.00019748616671718712 * var_x262))));
        IJth(rJacobian, 13, 13) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_Concentrations__Ca_j;
        IJth(rJacobian, 33, 13) = -var_x507 * ((var_x162) ? (var_x40 * (-var_x256 + 75807.664103300311 * var_x512)) : (-var_x261));
        IJth(rJacobian, 37, 13) = -var_x529 * ((var_x136) ? (var_x40 * (-var_x255 + 151615.32820660062 * var_x531)) : (-var_x259));
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x136) ? (var_x265 + var_x40 * (var_x263 - 0.044999999999999991 * var_x209)) : ((var_x162) ? (var_x265 + var_x266) : (var_x266 + var_x267 + 2.1942907413020785e-5 * var_x262))));
        IJth(rJacobian, 14, 14) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        IJth(rJacobian, 34, 14) = -var_x521 * ((var_x162) ? (var_x40 * (-var_x264 + 8423.0737892555881 * var_x523)) : (-var_x267));
        IJth(rJacobian, 38, 14) = -var_x539 * ((var_x136) ? (var_x40 * (-var_x263 + 16846.147578511176 * var_x540)) : (-var_x266));
        IJth(rJacobian, 15, 15) = -0.0050000000000000001 + var_x469 + var_x472;
        IJth(rJacobian, 16, 15) = var_x471;
        IJth(rJacobian, 17, 15) = var_x472;
        IJth(rJacobian, 15, 16) = 0.055;
        IJth(rJacobian, 16, 16) = -0.059999999999999998 + var_x469;
        IJth(rJacobian, 17, 16) = var_x472 + var_x481 * var_chaste_interface__Ca_Concentrations__Ca_j;
        ...
        IJth(rJacobian, 17, 17) = -0.065000000000000002 + var_x472;
        IJth(rJacobian, 18, 18) = -0.001 - var_x483;
        IJth(rJacobian, 33, 18) = (0.001 + var_x483) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 19, 19) = -0.001 - var_x485;
        IJth(rJacobian, 34, 19) = (0.001 + var_x485) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 1, 20) = 0.019599999999999999 + var_x346;
        IJth(rJacobian, 20, 20) = -0.019599999999999999 - var_x346;
        IJth(rJacobian, 1, 21) = 0.003032 + var_x347;
        IJth(rJacobian, 21, 21) = -3.1999999999999999e-5 + var_x487;
        IJth(rJacobian, 22, 21) = -0.0030000000000000001;
        IJth(rJacobian, 1, 22) = 0.0063300000000000006 + var_x347;
        IJth(rJacobian, 21, 22) = var_x487;
        IJth(rJacobian, 22, 22) = -0.0063300000000000006;
        IJth(rJacobian, 1, 23) = 0.23799999999999999 + var_x348;
        IJth(rJacobian, 23, 23) = -0.23799999999999999 - var_x348;
        IJth(rJacobian, 1, 24) = 0.016159999999999997 + var_x349;
        IJth(rJacobian, 24, 24) = -0.00046000000000000001 + var_x488;
        IJth(rJacobian, 25, 24) = -0.015699999999999999;
        IJth(rJacobian, 1, 25) = 0.015757 + var_x349;
        IJth(rJacobian, 24, 25) = var_x488;
        IJth(rJacobian, 25, 25) = -0.015757;
        IJth(rJacobian, 1, 26) = 0.059999999999999998 + var_x350;
        IJth(rJacobian, 26, 26) = -0.059999999999999998 - var_x350;
        IJth(rJacobian, 27, 27) = -1.3 + var_x490;
        IJth(rJacobian, 37, 27) = 1.3 + var_x489;
        IJth(rJacobian, 28, 28) = -1.3 + var_x493;
        IJth(rJacobian, 38, 28) = 1.3 + var_x492;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x490;
        IJth(rJacobian, 37, 29) = 0.029999999999999999 + var_x489;
        IJth(rJacobian, 30, 30) = -0.029999999999999999 + var_x493;
        IJth(rJacobian, 38, 30) = 0.029999999999999999 + var_x492;
        IJth(rJacobian, 31, 31) = -65.0 - var_x497;
        IJth(rJacobian, 32, 31) = 65.0 + var_x497;
        IJth(rJacobian, 1, 32) = 0.037279237232671424 * var_x352 + 4.7061860318210743e-15 * var_x353;
        IJth(rJacobian, 15, 32) = -var_x477 + var_x473 * var_x475;
        IJth(rJacobian, 16, 32) = var_x477 + var_x480;
        IJth(rJacobian, 17, 32) = -var_x480 + var_x476 * var_x482;
        IJth(rJacobian, 31, 32) = 260.0 - var_x498;
        IJth(rJacobian, 32, 32) = -260.0 + var_x498 - var_x499 - var_x501 - 0.69232869146389786 * var_x352 - 8.7400597733819945e-14 * var_x353;
        IJth(rJacobian, 37, 32) = var_x533 + var_x534;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x162) ? (var_x287 + var_x23 * var_x272) : (var_x287 - var_x288)));
        IJth(rJacobian, 18, 33) = 0.0007561 - var_x484;
        IJth(rJacobian, 33, 33) = (-0.0007561 + var_x484 - var_x514 - 1830221710.9367213 * var_x517 * ((var_x162) ? (var_x516 + var_x272 * var_x503) : (var_x288 + var_x516))) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 34, 33) = 0.087152885187388451 * var_x505;
        IJth(rJacobian, 37, 33) = -var_x529 * (-0.66000000000000003 * var_x286 - var_x280 * var_x535);
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x162) ? (var_x298 + var_x15 * var_x272) : (var_x298 - var_x299)));
        IJth(rJacobian, 19, 34) = 0.000165 - var_x486;
        IJth(rJacobian, 33, 34) = var_x514 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 34, 34) = (-0.000165 + var_x486 - 7.8853682331945256 * var_x335 - 49324475.109744638 * var_x517 * ((var_x162) ? (var_x526 + var_x272 * var_x519) : (var_x299 + var_x526))) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 35, 34) = var_x527;
        IJth(rJacobian, 38, 34) = -var_x539 * (-5.3399999999999999 * var_x297 - var_x292 * var_x542);
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00018851030986163651 * var_x300 - 0.43577707993988701 * var_x301);
        IJth(rJacobian, 34, 35) = 7.7982153480071377 * var_x505;
        IJth(rJacobian, 35, 35) = -var_x527;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x162) ? (var_x303 + var_x41 * (-4.3960978124999998e-10 * var_x269 - 0.45000000000000001 * var_x268 * (-9.7691062499999988e-10 * var_x269 - 9.7691062499999988e-10 * var_x271))) : (var_x303 - 0.00016457180559765593 * var_x184)));
        IJth(rJacobian, 0, 37) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x136) ? (var_x317 + var_x23 * var_x306) : (var_x317 - var_x318)));
        IJth(rJacobian, 13, 37) = 1.7 - 1.7 * var_chaste_interface__I_Ca__f_Ca_Bj;
        IJth(rJacobian, 15, 37) = -var_x479 + var_x468 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        IJth(rJacobian, 16, 37) = var_x479 + var_x468 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        IJth(rJacobian, 17, 37) = var_x481 * var_chaste_interface__SR_Fluxes__Ry_Ro + var_x478 * var_x482 * var_chaste_interface__Ca_Concentrations__Ca_j;
        IJth(rJacobian, 27, 37) = 55.473098330241186 - var_x491;
        IJth(rJacobian, 29, 37) = 19.897959183673468 - var_x495;
        IJth(rJacobian, 32, 37) = var_x499 + var_x501;
        IJth(rJacobian, 33, 37) = -var_x507 * (1.4849999999999997e-8 * var_x316 - 0.33000000000000002 * var_x313 + var_x315 * var_x515);
        IJth(rJacobian, 37, 37) = -75.37105751391465 + var_x491 + var_x495 - var_x533 - var_x534 - var_x536 - var_x529 * ((var_x136) ? (var_x537 + var_x306 * var_x503) : (var_x318 + var_x537));
        IJth(rJacobian, 38, 37) = 3.9220939916716238 * var_x335;
        IJth(rJacobian, 0, 38) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x136) ? (var_x326 + var_x15 * var_x306) : (var_x326 - var_x327)));
        IJth(rJacobian, 1, 38) = var_x336;
        IJth(rJacobian, 14, 38) = 1.7 - 1.7 * var_chaste_interface__I_Ca__f_Ca_Bsl;
        IJth(rJacobian, 28, 38) = 121.55000000000001 - var_x494;
        IJth(rJacobian, 30, 38) = 43.550000000000004 - var_x496;
        IJth(rJacobian, 34, 38) = -var_x521 * (1.2014999999999997e-7 * var_x325 - 2.6699999999999999 * var_x323 + var_x324 * var_x525);
        IJth(rJacobian, 37, 38) = var_x536;
        IJth(rJacobian, 38, 38) = -165.10000000000002 + var_x494 + var_x496 - 19.504723378941105 * var_x335 - var_x539 * ((var_x136) ? (var_x543 + var_x306 * var_x519) : (var_x327 + var_x543));
    }
