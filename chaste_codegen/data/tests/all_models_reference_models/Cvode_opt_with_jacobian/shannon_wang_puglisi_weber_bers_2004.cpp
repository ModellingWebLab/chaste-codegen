...
const double var_x0 = exp(9.9999999999999995e-8);
        ...
        const double var_x245 = -var_x14;
        const double var_x246 = -var_x31;
        const double var_x247 = var_x24 * (-4.9999999999999998e-8 * var_x61 + var_chaste_interface__cell__V);
        const double var_x248 = var_x247 * (var_x245 - var_x21);
        const double var_x249 = var_x247 * (var_x246 - var_x34);
        const double var_x250 = var_x245 + var_x246 + var_x248 + var_x249;
        const double var_x251 = -var_x142;
        const double var_x252 = -var_x152;
        const double var_x253 = -var_x163;
        const double var_x254 = var_x146 * (-9.9999999999999995e-8 * var_x61 + var_chaste_interface__cell__V);
        const double var_x255 = var_x254 * (var_x251 - var_x145);
        const double var_x256 = var_x254 * (var_x252 - var_x155);
        const double var_x257 = var_x251 + var_x252 + var_x253 + var_x255 + var_x256 + var_x254 * (var_x253 - var_x166);
        const double var_x258 = var_x174 * var_chaste_interface__cell__V;
        const double var_x259 = var_x180 * var_x258;
        const double var_x260 = var_x183 * var_x259;
        const double var_x261 = var_x11 * var_x260;
        const double var_x262 = var_x188 * var_x259;
        const double var_x263 = var_x262 * var_x28;
        const double var_x264 = -var_x261 - var_x263;
        const double var_x265 = var_x209 * var_chaste_interface__cell__V;
        const double var_x266 = var_x11 * var_x202 * var_x265;
        const double var_x267 = var_x213 * var_x265 * var_x28;
        const double var_x268 = -var_x266 - var_x267 - var_x219 * var_x265;
        const double var_x269 = var_x4 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x270 = var_x1 * var_x269;
        const double var_x271 = var_x270 * NV_Ith_S(mParameters, 12);
        const double var_x272 = var_x13 * var_x271;
        const double var_x273 = -var_x272;
        const double var_x274 = var_x271 * var_x30;
        const double var_x275 = -var_x274;
        const double var_x276 = var_x16 * var_x269;
        const double var_x277 = var_x276 * NV_Ith_S(mParameters, 12);
        const double var_x278 = var_x247 * (var_x273 - var_x20 * var_x277);
        const double var_x279 = var_x247 * (var_x275 - var_x277 * var_x33);
        const double var_x280 = var_x273 + var_x275 + var_x278 + var_x279;
        const double var_x281 = var_x141 * var_x270;
        const double var_x282 = -var_x281;
        const double var_x283 = var_x151 * var_x270;
        const double var_x284 = -var_x283;
        const double var_x285 = -var_x158 * var_x161 * var_x270;
        const double var_x286 = var_x254 * (var_x282 - var_x144 * var_x276);
        const double var_x287 = var_x254 * (var_x284 - var_x154 * var_x276);
        const double var_x288 = var_x282 + var_x284 + var_x285 + var_x286 + var_x287 + var_x254 * (var_x285 - var_x165 * var_x276);
        const double var_x289 = var_x179 * var_x3;
        const double var_x290 = var_x175 * var_x183 * var_x289 * var_chaste_interface__cell__V;
        const double var_x291 = var_x185 * var_x188 * var_x258 * var_x289;
        const double var_x292 = -var_x290 - var_x291;
        const double var_x293 = var_x204 * var_x3;
        const double var_x294 = var_x175 * var_x216 * var_x293;
        const double var_x295 = var_x258 * var_x293;
        const double var_x296 = var_x224 * var_x295;
        const double var_x297 = -var_x294 - var_x296 - var_x220 * var_x295;
        const double var_x298 = 8.9999999999999995e-9 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x299 = var_x10 * var_x298 * var_x7;
        const double var_x300 = var_x247 * (var_x299 + var_x18 * var_x19 * var_x298);
        const double var_x301 = var_x299 + var_x300;
        const double var_x302 = 1.215e-15 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x303 = var_x162 * var_x302;
        const double var_x304 = 6.75e-17 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x305 = var_x139 * var_x304 * var_x6;
        const double var_x306 = var_x164 * var_x17;
        const double var_x307 = var_x254 * (var_x305 + var_x143 * var_x17 * var_x304);
        const double var_x308 = var_x303 + var_x305 + var_x307 + var_x254 * (var_x303 + var_x302 * var_x306);
        const double var_x309 = var_x260 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x310 = var_x210 * var_x216;
        const double var_x311 = var_x211 * var_chaste_interface__cell__V;
        const double var_x312 = var_x310 + 1.2150000000000001e-8 * var_x311;
        const double var_x313 = 8.0999999999999997e-8 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x314 = var_x27 * var_x313 * var_x7;
        const double var_x315 = var_x247 * (var_x314 + var_x18 * var_x313 * var_x32);
        const double var_x316 = var_x314 + var_x315;
        const double var_x317 = 6.0749999999999991e-16 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x318 = var_x149 * var_x317 * var_x6;
        const double var_x319 = 1.0935000000000001e-14 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x320 = var_x162 * var_x319;
        const double var_x321 = var_x254 * (var_x318 + var_x153 * var_x17 * var_x317);
        const double var_x322 = var_x318 + var_x320 + var_x321 + var_x254 * (var_x320 + var_x306 * var_x319);
        const double var_x323 = var_x262 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x324 = var_x210 * var_x213 * var_chaste_interface__cell__V;
        const double var_x325 = var_x324 + 1.0935000000000001e-7 * var_x311;
        ...
        const double var_x335 = 3.0 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x340 = 1.9830866390704556e-12 * var_x339;
        const double var_x341 = 0.89000000000000001 * var_x59;
        const double var_x342 = var_x332 * var_x341;
        const double var_x343 = var_x77 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x347 = -var_x333 - var_x342 - 2.6699999999999999 * var_x344 - 0.00046442182911003347 * var_x346 - var_x337 * var_x340;
        const double var_x348 = (var_x171) && (((var_x170) || (var_x171)));
        ...
        const double var_x359 = 2.4510059584016866e-13 * var_x358;
        ...
        const double var_x364 = -var_x355 - var_x361 - 0.33000000000000002 * var_x362 - 5.7400450788880541e-5 * var_x363 - var_x357 * var_x359;
        const double var_x365 = var_x214 * var_x228;
        const double var_x366 = var_x240 * var_x61;
        ...
        const double var_x373 = var_x61 * log(NV_Ith_S(mParameters, 7) / NV_Ith_S(mParameters, 4)) + var_chaste_interface__cell__V;
        ...
        const double var_x380 = var_x241 * var_x46 / log(10);
        ...
        const double var_x384 = -var_x376 - var_x377 + 0.89000000000000001 * var_x379 - 4.4795166719999994e-11 * var_x381 - var_x340 * var_x383 - 0.0097566250000000014 * var_x373 / (pow(var_x39, 2) * pow(var_chaste_interface__Ca_buffer__Ca_SL, 2)) - 0.28183333333333332 * var_x38 * var_x380 * var_x48 / pow(var_x49, 2);
        const double var_x385 = var_x370 + var_x372 + var_x384;
        const double var_x386 = 0.061380000000000011 * var_x181 * var_x192;
        const double var_x387 = var_x384 - var_x386;
        ...
        const double var_x399 = -var_x393 - var_x395 + 0.11 * var_x396 - 5.5364812799999996e-12 * var_x398 - var_x359 * var_x397 - 0.0012058750000000001 * var_x373 / (pow(var_x37, 2) * var_x392) - 0.034833333333333334 * var_x36 * var_x380 * var_x43 / pow(var_x44, 2);
        const double var_x400 = var_x390 + var_x391 + var_x399;
        const double var_x401 = 0.55242000000000002 * var_x177 * var_x186 * var_x258;
        const double var_x402 = var_x399 - var_x401;
        ...
        const double var_x415 = pow(2.6000000000000001, var_x2) * NV_Ith_S(mParameters, 2);
        ...
        const double var_x428 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 16) - 0.14705882352941177 * var_chaste_interface__cell__V);
        ...
        const double var_x432 = exp(var_x76 - 0.34999999999999998 * NV_Ith_S(mParameters, 16));
        const double var_x433 = exp(0.079000000000000001 * var_chaste_interface__cell__V - 0.079000000000000001 * NV_Ith_S(mParameters, 16));
        const double var_x434 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 16) - 0.0900900900900901 * var_chaste_interface__cell__V);
        ...
        const double var_x438 = ((var_x429) ? (-0.019852941176470591 * var_x428) : (0));
        const double var_x439 = var_x430 + var_x436;
        const double var_x440 = 0.01 * NV_Ith_S(mParameters, 15);
        const double var_x441 = 1.0 - var_x440;
        const double var_x442 = var_x441 / var_x439;
        const double var_x443 = ((var_x429) ? (0.28123999999999999 * var_x433 + 108500.0 * var_x432) : (0.693000693000693 * var_x434 / pow(var_x435, 2)));
        const double var_x444 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 16) - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x445 = 1.0 + var_x444;
        const double var_x446 = exp(0.01052 * NV_Ith_S(mParameters, 16) - 0.01052 * var_chaste_interface__cell__V);
        const double var_x447 = var_x446 / var_x445;
        const double var_x448 = -var_x117;
        const double var_x449 = exp(-3.2000000000000002 + var_x448 + 0.10000000000000001 * NV_Ith_S(mParameters, 16));
        const double var_x450 = 1.0 + var_x449;
        const double var_x451 = exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 16) - 2.5349999999999999e-7 * var_chaste_interface__cell__V);
        ...
        const double var_x456 = exp(0.24440000000000001 * var_chaste_interface__cell__V - 0.24440000000000001 * NV_Ith_S(mParameters, 16));
        const double var_x457 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 16) - 0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x458 = -127140.0 * var_x456 - 3.4740000000000003e-5 * var_x457;
        const double var_x459 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V - 0.311 * NV_Ith_S(mParameters, 16));
        ...
        const double var_x465 = ((var_x429) ? (var_x462 + var_x455 * var_x461 * (1.5254334000000001e-6 * var_x457 - 31073.016 * var_x456) - 0.311 * var_x455 * var_x458 * var_x459 / pow(var_x460, 2)) : (0));
        const double var_x466 = var_x453 + var_x463;
        const double var_x467 = var_x441 / var_x466;
        const double var_x468 = ((var_x429) ? (-0.001275024 * var_x447 + 0.016701360000000002 * var_x444 * var_x446 / pow(var_x445, 2)) : (-7.6049999999999996e-8 * var_x452 + 0.029999999999999999 * var_x449 * var_x451 / pow(var_x450, 2)));
        ...
        const double var_x480 = var_x470 + var_x479;
        const double var_x481 = 1 / var_x480;
        const double var_x482 = ((var_x475) ? (0.15999999943156581 * var_x473 + 0.16000000056843419 * var_x471) : (var_x478 - 0.032000000000000001 * var_x474 * var_x476 / pow(var_x477, 2)));
        const double var_x483 = 0.0072727272727272727 * var_x469;
        const double var_x484 = var_x479;
        const double var_x485 = exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x486 = 1.0 + var_x485;
        const double var_x487 = -var_chaste_interface__IKr_Xr_gate__Xr + 1 / var_x486;
        ...
        const double var_x494 = var_x492 - 0.00016973999999999998 * var_x490 * var_x493 / pow(var_x491, 2);
        ...
        const double var_x499 = 0.13333333333333333 * var_x485 / pow(var_x486, 2);
        ...
        const double var_x507 = var_x506 - 8.8449999999999995e-5 * var_x500 * var_x504 / pow(var_x505, 2);
        ...
        const double var_x514 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        const double var_x515 = 1.0 + var_x514;
        const double var_x516 = -var_chaste_interface__IKs_Xs_gate__Xs + 1 / var_x515;
        ...
        const double var_x525 = 0.059880239520958084 * var_x514 / pow(var_x515, 2);
        ...
        const double var_x541 = exp(-0.20000000000000001 - var_x536);
        const double var_x542 = 1.0 + var_x541;
        const double var_x543 = 0.066666666666666666 * var_x541 / pow(var_x542, 2);
        const double var_x544 = 1 / var_x542;
        ...
        const double var_x552 = var_x550 / pow(var_x551, 2);
        const double var_x553 = 0.10000000000000001 * var_x552;
        const double var_x554 = 1 / var_x551;
        const double var_x555 = var_x554;
        const double var_x556 = var_x546 / pow(var_x547, 2);
        ...
        const double var_x569 = 1 / var_x568;
        const double var_x570 = -var_chaste_interface__ICaL_d_gate__d + var_x569;
        ...
        const double var_x576 = var_x570 * var_x575;
        const double var_x577 = 0.035000000000000003 * var_x568;
        const double var_x578 = var_x572 * var_x575;
        const double var_x579 = 0.0058333333333333336 * var_x567;
        const double var_x580 = var_x572 * var_x579;
        ...
        const double var_x582 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x583 = 1.0 + var_x582;
        const double var_x584 = exp(9.7388888888888889 + 0.27777777777777779 * var_chaste_interface__cell__V);
        ...
        const double var_x596 = var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__R;
        const double var_x597 = var_x586 * var_x587 / pow(var_x588, 2);
        const double var_x598 = 2.3772197685794643 * var_x597;
        const double var_x599 = 0.21130842387373014 * var_x392 * var_x597 / pow((1 - 0.93333333333333335 * var_x589), 2);
        const double var_x600 = var_x599 * var_chaste_interface__Jrel_SR__R;
        const double var_x601 = 20.0 * var_x593;
        const double var_x602 = var_x596 * var_x601;
        const double var_x603 = 7.5 - var_x590;
        const double var_x604 = var_x598 * var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__O;
        const double var_x605 = 1.0 - var_chaste_interface__Jrel_SR__I - var_chaste_interface__Jrel_SR__O - var_chaste_interface__Jrel_SR__R;
        ...
        const double var_x609 = var_x606 * NV_Ith_S(mParameters, 3);
        const double var_x610 = var_x58 * var_x609;
        const double var_x611 = 55.277229008113743 * var_x233;
        const double var_x612 = var_x236 * var_x609;
        ...
        const double var_x617 = var_x616 * NV_Ith_S(mParameters, 3);
        const double var_x618 = 267.92223797719811 * var_x231;
        ...
        const double var_x622 = 0.076376893524206985 * NV_Ith_S(mParameters, 3);
        const double var_x623 = 100.0 * var_chaste_interface__Ca_buffer__Ca_Calsequestrin;
        const double var_x624 = 18.571428571428569 * NV_Ith_S(mParameters, 0);
        const double var_x625 = var_chaste_interface__Jrel_SR__O * NV_Ith_S(mParameters, 1);
        ...
        const double var_x634 = 1274.5098039215686 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x644 = -var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_Cytosol - 0.030769230769230767 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL - 0.00078461538461538469 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        ...
        const double var_x648 = 100.0 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL;
        const double var_x649 = 100.0 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x650 = 100.0 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol;
        const double var_x651 = -var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol - 0.030769230769230767 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL - 0.00078461538461538469 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        ...
        const double var_x655 = 100.0 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL;
        const double var_x656 = 100.0 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        ...
        IJth(rJacobian, 2, 0) = (var_x431 + var_x437) * (var_x438 * var_x442 + var_x430 * var_x441 * (-var_x438 - var_x443) / pow(var_x439, 2)) + (var_x438 + var_x443) * (var_x440 - var_chaste_interface__INa_h_gate__h + var_x430 * var_x442);
        IJth(rJacobian, 3, 0) = (var_x454 + var_x464) * (var_x465 * var_x467 + var_x441 * var_x463 * (-var_x465 - var_x468) / pow(var_x466, 2)) + (var_x465 + var_x468) * (var_x440 - var_chaste_interface__INa_j_gate__j + var_x463 * var_x467);
        IJth(rJacobian, 4, 0) = (var_x470 + var_x484) * (var_x481 * var_x482 + var_x479 * (var_x483 - var_x482) / pow(var_x480, 2)) + (-var_x483 + var_x482) * (-var_chaste_interface__INa_m_gate__m + var_x479 * var_x481);
        IJth(rJacobian, 5, 0) = ((var_x501) ? (var_x487 * (var_x494 + 0.00030499999960720308 * var_x488 + 0.00030500000039279689 * var_x489) + var_x499 * (var_x495 + var_x496 - var_x498)) : ((var_x511) ? (var_x487 * (var_x507 + 0.00068999999999999997 * var_x502 + 0.00068999999999999997 * var_x503) + var_x499 * (var_x509 + var_x510 - var_x508)) : (var_x487 * (var_x494 + var_x507) + var_x499 * (var_x496 + var_x509))));
        IJth(rJacobian, 6, 0) = ((var_x527) ? (var_x516 * (6.5500000000000006e-5 * var_x517 + 6.5500000000000006e-5 * var_x518 + 3.595e-5 * var_x519 + 3.595e-5 * var_x520) + var_x525 * (var_x524 - var_x521 - var_x522)) : (var_x516 * (var_x530 + var_x533 - 8.9997000000000013e-6 * var_x526 * var_x528 / pow(var_x529, 2) - 1.0641199999999999e-5 * var_x526 * var_x531 / pow(var_x532, 2)) + var_x525 * (var_x534 + var_x535)));
        IJth(rJacobian, 7, 0) = var_x540 * var_x543 + 0.0074074074074074077 * var_x537 * (var_x544 - var_chaste_interface__Itos_X_gate__X_tos) / (pow(var_x538, 2) * pow((0.055555555555555552 + var_x539), 2));
        IJth(rJacobian, 8, 0) = -var_x549 * var_x553 + 3.3333333333333335e-5 * var_x556 * (var_x40 + var_x555) / pow((0.01 + var_x548), 2);
        IJth(rJacobian, 9, 0) = -var_x553 * var_x557 + 3.5714285714285717e-5 * var_x556 * (var_x555 - var_chaste_interface__Itos_R_gate__R_tos) / pow((0.07857142857142857 + var_x548), 2);
        IJth(rJacobian, 10, 0) = var_x543 * var_x559 + 0.00063492063492063492 * var_x558 * (var_x544 - var_chaste_interface__Itof_X_gate__X_tof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x558), 2);
        IJth(rJacobian, 11, 0) = -var_x553 * var_x560 + 0.0050000000000000001 * var_x552 * (var_x555 - var_chaste_interface__Itof_Y_gate__Y_tof) / pow((1 + var_x554), 2);
        IJth(rJacobian, 12, 0) = ((var_x573) ? (4.4099999986215979e-16 * var_x570 * (-39682539694942.977 * var_x562 - 39682539694942.977 * var_x565) / pow((-var_x562 + 0.017500000000000002 * var_x566), 2) + 0.16666666666666666 * var_x567 * var_x571 / pow(var_x568, 2)) : (var_x576 * var_x577 - var_x576 * var_x580 + var_x569 * var_x578 * var_x579 - var_x568 * var_x570 * var_x580 / pow(var_x574, 2)));
        IJth(rJacobian, 13, 0) = (0.02 + var_x581) * (0.029999999999999999 * var_x582 / pow(var_x583, 2) - 0.27777777777777779 * var_x584 / pow(var_x585, 2)) + var_x581 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__cell__V) * (-var_chaste_interface__ICaL_f_gate__f + 1 / var_x585 + 0.59999999999999998 / var_x583);
        IJth(rJacobian, 19, 0) = -var_x608 * (0.00026433000000000001 + var_x341 + 2.6699999999999999 * var_x112 + 5.0996999999999995 * var_x127 + 0.46858500000000003 * var_x131 + ((var_x171) ? (-var_x147) : (var_x207 + var_x227 - var_x218)));
        IJth(rJacobian, 20, 0) = -var_x617 * (3.2670000000000004e-5 + var_x360 + 0.33000000000000002 * var_x99 + 0.63029999999999997 * var_x124 + 0.057915000000000008 * var_x134 + ((var_x171) ? (-var_x156) : (var_x215 + var_x229 - var_x225)));
        IJth(rJacobian, 25, 0) = -var_x627 * (0.00022365699999999999 - 1.78 * var_x112 - 0.31239000000000006 * var_x131 + ((var_x170) ? (-var_x25) : (var_x184 + var_x199 - var_x195)));
        IJth(rJacobian, 26, 0) = -var_x632 * (2.7642999999999999e-5 - 0.22 * var_x99 - 0.038610000000000005 * var_x134 + ((var_x170) ? (-var_x35) : (var_x189 + var_x198 - var_x197)));
        IJth(rJacobian, 1, 1) = -7.2523935948689155 + var_x403 + var_x404 + var_x405 + var_x406 + var_x407 + var_x408 + var_x409 + 6.3492962168146398e-7 * var_x419 - 5029484.9869235931 * var_x417;
        IJth(rJacobian, 24, 1) = 93404721.185723871 * var_x417 - 1.1791550116941473e-5 * var_x419;
        IJth(rJacobian, 25, 1) = 5.6417918332397381;
        IJth(rJacobian, 32, 1) = 2.2890000000000006 - var_x405;
        IJth(rJacobian, 33, 1) = 0.33180000000000004 - var_x406 - var_x407;
        IJth(rJacobian, 35, 1) = 0.81600000000000006 - var_x403;
        IJth(rJacobian, 36, 1) = 1.9320000000000004 - var_x408 - var_x409;
        IJth(rJacobian, 38, 1) = 1.71 - var_x404;
        IJth(rJacobian, 39, 1) = var_x644 * (2.5 - var_x643);
        IJth(rJacobian, 42, 1) = var_x651 * (2.5 - var_x650);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x232 * var_x58 - var_x234 * var_x58);
        IJth(rJacobian, 2, 2) = -var_x431 - var_x437;
        IJth(rJacobian, 19, 2) = -var_x610 * var_x611;
        IJth(rJacobian, 20, 2) = -var_x610 * var_x618;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x232 * var_x236 - var_x234 * var_x236);
        IJth(rJacobian, 3, 3) = -var_x454 - var_x464;
        IJth(rJacobian, 19, 3) = -var_x611 * var_x612;
        IJth(rJacobian, 20, 3) = -var_x612 * var_x618;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.33000000000000002 * var_x238 - 2.6699999999999999 * var_x239);
        IJth(rJacobian, 4, 4) = -var_x470 - var_x484;
        IJth(rJacobian, 19, 4) = -165.83168702434122 * var_x239 * var_x609;
        IJth(rJacobian, 20, 4) = -803.76671393159438 * var_x238 * var_x609;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x113 * var_x56 * NV_Ith_S(mParameters, 19));
        IJth(rJacobian, 5, 5) = ((var_x501) ? (var_x497 + var_x498 + var_x512) : ((var_x511) ? (var_x508 + var_x513 - var_x510) : (var_x512 + var_x513)));
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.22 * var_x242 * var_x45 - 1.78 * var_x242 * var_x50);
        IJth(rJacobian, 6, 6) = ((var_x527) ? (var_x523 - var_x524) : (-var_x534 - var_x535));
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x41 * var_x74);
        IJth(rJacobian, 7, 7) = -var_x540;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x243 * var_x244);
        IJth(rJacobian, 8, 8) = -var_x549;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x244 * (0.5 * var_x62 - 0.5 * var_chaste_interface__cell__V));
        IJth(rJacobian, 9, 9) = -var_x557;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x243 * var_x42);
        IJth(rJacobian, 10, 10) = -var_x559;
        ...
        IJth(rJacobian, 11, 11) = -var_x560;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x172) ? (var_x250 + var_x257) : ((var_x171) ? (var_x257 + var_x264) : ((var_x170) ? (var_x250 + var_x268) : (var_x264 + var_x268)))));
        IJth(rJacobian, 12, 12) = ((var_x573) ? (-var_x571) : (-var_x577 * var_x578));
        IJth(rJacobian, 19, 12) = -var_x608 * ((var_x171) ? (var_x142 - var_x255) : (var_x266));
        IJth(rJacobian, 20, 12) = -var_x617 * ((var_x171) ? (var_x152 - var_x256) : (var_x267));
        IJth(rJacobian, 25, 12) = -var_x627 * ((var_x170) ? (var_x14 - var_x248) : (var_x261));
        IJth(rJacobian, 26, 12) = -var_x632 * ((var_x170) ? (var_x31 - var_x249) : (var_x263));
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x172) ? (var_x280 + var_x288) : ((var_x171) ? (var_x288 + var_x292) : ((var_x170) ? (var_x280 + var_x297) : (var_x292 + var_x297)))));
        IJth(rJacobian, 13, 13) = -0.02 - var_x581;
        IJth(rJacobian, 19, 13) = -var_x608 * ((var_x171) ? (var_x281 - var_x286) : (var_x294));
        IJth(rJacobian, 20, 13) = -var_x617 * ((var_x171) ? (var_x283 - var_x287) : (var_x296));
        IJth(rJacobian, 25, 13) = -var_x627 * ((var_x170) ? (var_x272 - var_x278) : (var_x290));
        IJth(rJacobian, 26, 13) = -var_x632 * ((var_x170) ? (var_x274 - var_x279) : (var_x291));
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x172) ? (var_x301 + var_x308) : ((var_x171) ? (var_x308 + var_x309) : ((var_x170) ? (var_x301 + var_x312) : (var_x309 + var_x312)))));
        IJth(rJacobian, 14, 14) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_buffer__Ca_SL;
        IJth(rJacobian, 19, 14) = -var_x608 * ((var_x171) ? (-var_x305 - var_x307) : (-var_x310));
        IJth(rJacobian, 25, 14) = -var_x627 * ((var_x170) ? (-var_x299 - var_x300) : (-var_x309));
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x172) ? (var_x316 + var_x322) : ((var_x171) ? (var_x322 + var_x323) : ((var_x170) ? (var_x316 + var_x325) : (var_x323 + var_x325)))));
        IJth(rJacobian, 15, 15) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 20, 15) = -var_x617 * ((var_x171) ? (-var_x318 - var_x321) : (-var_x324));
        IJth(rJacobian, 26, 15) = -var_x632 * ((var_x170) ? (-var_x314 - var_x315) : (-var_x323));
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x592 + var_x595;
        IJth(rJacobian, 17, 16) = var_x595;
        IJth(rJacobian, 18, 16) = var_x594;
        IJth(rJacobian, 16, 17) = -0.0050000000000000001;
        IJth(rJacobian, 17, 17) = -0.065000000000000002 + var_x595;
        IJth(rJacobian, 18, 17) = 0.0050000000000000001;
        IJth(rJacobian, 16, 18) = 0.055;
        IJth(rJacobian, 17, 18) = var_x595 + var_x603 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 18, 18) = -0.059999999999999998 + var_x592;
        ...
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x348) ? (var_x329 + var_x331 + var_x347) : (var_x347 - var_x349)));
        IJth(rJacobian, 19, 19) = (-2.5101556644976917 + var_x613 - var_x607 * (var_x333 + var_x342 + 8.0099999999999998 * var_x344 + 0.0013932654873301004 * var_x346 + var_x337 * var_x614 + ((var_x171) ? (var_x328 - var_x331) : (var_x349)))) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 20, 19) = 1.0879068612142859 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 19) = 0.000165 - var_x613;
        IJth(rJacobian, 23, 19) = var_x622;
        IJth(rJacobian, 25, 19) = -var_x627 * (-5.3399999999999999 * var_x344 - var_x337 * var_x628);
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x348) ? (var_x352 + var_x353 + var_x364) : (var_x364 - var_x365)));
        IJth(rJacobian, 19, 20) = 0.02774162496096429 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 20, 20) = (-1.0886629612142857 + var_x619 - var_x616 * (var_x355 + var_x361 + 0.98999999999999999 * var_x362 + 0.00017220135236664162 * var_x363 + var_x357 * var_x620 + ((var_x171) ? (var_x351 - var_x353) : (var_x365)))) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 20) = 0.0007561 - var_x619;
        IJth(rJacobian, 26, 20) = -var_x632 * (-0.66000000000000003 * var_x362 - var_x357 * var_x633);
        IJth(rJacobian, 19, 21) = (0.001 + var_x615) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 21) = -0.001 - var_x615;
        IJth(rJacobian, 20, 22) = (0.001 + var_x621) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 22) = -0.001 - var_x621;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0020162999999999999 * var_x366 * var_x47 - 0.0163137 * var_x366 * var_x51);
        IJth(rJacobian, 19, 23) = 2.4822490395367272 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 23) = -var_x622;
        IJth(rJacobian, 1, 24) = 0.69232869146389786 * var_x421 + 8.7400597733819945e-14 * var_x422;
        IJth(rJacobian, 16, 24) = -var_x600 + var_x596 * var_x598;
        IJth(rJacobian, 17, 24) = -var_x604 + var_x599 * var_x605;
        IJth(rJacobian, 18, 24) = var_x600 + var_x604;
        IJth(rJacobian, 24, 24) = -260.0 + var_x623 - var_x624 - var_x625 - 1.6231539579137989e-12 * var_x422 - 12.857532841472388 * var_x421;
        IJth(rJacobian, 26, 24) = var_x634 + var_x635;
        IJth(rJacobian, 31, 24) = 260.0 - var_x623;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x172) ? (var_x385) : ((var_x171) ? (var_x387) : ((var_x170) ? (var_x385) : (var_x387)))));
        IJth(rJacobian, 1, 25) = 0.17359359486891501;
        IJth(rJacobian, 14, 25) = 1.7 - 1.7 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL;
        IJth(rJacobian, 19, 25) = -var_x608 * (1.3438550016e-10 * var_x381 - 2.6699999999999999 * var_x379 + var_x383 * var_x614);
        IJth(rJacobian, 25, 25) = -171.99023312516786 + var_x629 + var_x630 - var_x627 * (var_x376 + var_x377 + 1.78 * var_x379 - 8.9590333439999989e-11 * var_x381 - var_x383 * var_x628 + ((var_x170) ? (var_x369 - var_x372) : (var_x386)));
        IJth(rJacobian, 26, 25) = 48.958482036396518;
        IJth(rJacobian, 27, 25) = 121.55000000000001 - var_x629;
        IJth(rJacobian, 29, 25) = 43.550000000000004 - var_x630;
        IJth(rJacobian, 40, 25) = var_x644 * (2.5024999999999999 - var_x648);
        IJth(rJacobian, 43, 25) = var_x651 * (2.5024999999999999 - var_x655);
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x172) ? (var_x400) : ((var_x171) ? (var_x402) : ((var_x170) ? (var_x400) : (var_x402)))));
        IJth(rJacobian, 15, 26) = 1.7 - 1.7 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        IJth(rJacobian, 16, 26) = -var_x602 + var_x591 * var_chaste_interface__Jrel_SR__R;
        IJth(rJacobian, 17, 26) = var_x603 * var_chaste_interface__Jrel_SR__O + var_x601 * var_x605 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 18, 26) = var_x602 + var_x591 * var_chaste_interface__Jrel_SR__O;
        IJth(rJacobian, 20, 26) = -var_x617 * (1.6609443839999999e-11 * var_x398 - 0.33000000000000002 * var_x396 + var_x397 * var_x620);
        IJth(rJacobian, 24, 26) = var_x624 + var_x625;
        IJth(rJacobian, 25, 26) = 1.2484412919281114;
        IJth(rJacobian, 26, 26) = -128.61534478149457 + var_x636 + var_x637 - var_x634 - var_x635 - var_x632 * (var_x393 + var_x395 + 0.22 * var_x396 - 1.1072962559999999e-11 * var_x398 - var_x397 * var_x633 + ((var_x170) ? (var_x389 - var_x391) : (var_x401)));
        IJth(rJacobian, 28, 26) = 58.627450980392155 - var_x636;
        IJth(rJacobian, 30, 26) = 21.029411764705884 - var_x637;
        IJth(rJacobian, 41, 26) = var_x644 * (2.5490196078431375 - var_x649);
        IJth(rJacobian, 44, 26) = var_x651 * (2.5490196078431375 - var_x656);
        IJth(rJacobian, 25, 27) = 1.3 + var_x631;
        IJth(rJacobian, 27, 27) = -1.3 + var_x639;
        IJth(rJacobian, 26, 28) = 1.3 + var_x638;
        IJth(rJacobian, 28, 28) = -1.3 + var_x640;
        IJth(rJacobian, 25, 29) = 0.029999999999999999 + var_x631;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x639;
        IJth(rJacobian, 26, 30) = 0.029999999999999999 + var_x638;
        IJth(rJacobian, 30, 30) = -0.029999999999999999 + var_x640;
        IJth(rJacobian, 24, 31) = 65.0 + var_x626;
        IJth(rJacobian, 31, 31) = -65.0 - var_x626;
        IJth(rJacobian, 1, 32) = 0.019599999999999999 + var_x423;
        IJth(rJacobian, 32, 32) = -0.019599999999999999 - var_x423;
        IJth(rJacobian, 1, 33) = 0.003032 + var_x424;
        IJth(rJacobian, 33, 33) = -3.1999999999999999e-5 + var_x641;
        IJth(rJacobian, 34, 33) = -0.0030000000000000001;
        IJth(rJacobian, 1, 34) = 0.0063300000000000006 + var_x424;
        IJth(rJacobian, 33, 34) = var_x641;
        IJth(rJacobian, 34, 34) = -0.0063300000000000006;
        IJth(rJacobian, 1, 35) = 0.23799999999999999 + var_x425;
        IJth(rJacobian, 35, 35) = -0.23799999999999999 - var_x425;
        IJth(rJacobian, 1, 36) = 0.016159999999999997 + var_x426;
        IJth(rJacobian, 36, 36) = -0.00046000000000000001 + var_x642;
        IJth(rJacobian, 37, 36) = -0.015699999999999999;
        IJth(rJacobian, 1, 37) = 0.015757 + var_x426;
        IJth(rJacobian, 36, 37) = var_x642;
        IJth(rJacobian, 37, 37) = -0.015757;
        IJth(rJacobian, 1, 38) = 0.059999999999999998 + var_x427;
        IJth(rJacobian, 38, 38) = -0.059999999999999998 - var_x427;
        IJth(rJacobian, 39, 39) = -0.059999999999999998 + var_x647 * var_chaste_interface__Ca_buffer__Cai + (-2.5 + var_x643) * var_chaste_interface__Ca_buffer__Cai;
        IJth(rJacobian, 40, 39) = (-2.5024999999999999 + var_x648) * var_chaste_interface__Ca_buffer__Ca_SL;
        IJth(rJacobian, 41, 39) = (-2.5490196078431375 + var_x649) * var_chaste_interface__Ca_buffer__Ca_jct;
        ...
        IJth(rJacobian, 40, 40) = -0.059999999999999998 + var_x647 * var_chaste_interface__Ca_buffer__Ca_SL + (-0.076999999999999999 + var_x646) * var_chaste_interface__Ca_buffer__Ca_SL;
        ...
        IJth(rJacobian, 41, 41) = -0.059999999999999998 + var_x647 * var_chaste_interface__Ca_buffer__Ca_jct + (-0.002 + var_x645) * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 42, 42) = -0.11 + var_x654 * var_chaste_interface__Ca_buffer__Cai + (-2.5 + var_x650) * var_chaste_interface__Ca_buffer__Cai;
        IJth(rJacobian, 43, 42) = (-2.5024999999999999 + var_x655) * var_chaste_interface__Ca_buffer__Ca_SL;
        IJth(rJacobian, 44, 42) = (-2.5490196078431375 + var_x656) * var_chaste_interface__Ca_buffer__Ca_jct;
        ...
        IJth(rJacobian, 43, 43) = -0.11 + var_x654 * var_chaste_interface__Ca_buffer__Ca_SL + (-0.076999999999999999 + var_x653) * var_chaste_interface__Ca_buffer__Ca_SL;
        ...
        IJth(rJacobian, 44, 44) = -0.11 + var_x654 * var_chaste_interface__Ca_buffer__Ca_jct + (-0.002 + var_x652) * var_chaste_interface__Ca_buffer__Ca_jct;
    }
