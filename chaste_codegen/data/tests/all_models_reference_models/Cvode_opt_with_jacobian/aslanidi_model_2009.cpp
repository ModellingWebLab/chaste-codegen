...
// LCOV_EXCL_STOP
    ...
    void Cellaslanidi_model_2009FromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -80.0
        double var_chaste_interface__sodium_current_m_gate__m = NV_Ith_S(rY, 1);
...
const double var_x0 = 0.083333333333333329 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 15, 0) = -1.6450937300378158e-8 - 2.2085216435981733e-5 * var_x85 - 0.00058612951745018135 * var_x41 - 2.8256129907129523e-6 * var_x54 - 4.9352811901134478e-8 * var_x11 + 2.2085216435981733e-5 * var_x36 * var_x55;
        ...
        IJth(rJacobian, 17, 0) = -1.151565611026471e-6 + var_x228 + 4.3864536286956306e-7 * var_x47 + 1.8837419938086349e-6 * var_x54 - 2.8789140275661778e-6 * var_x12 - 2.0563671625472697e-6 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z - 8.3570761485921043e-6 * var_x28;
        IJth(rJacobian, 22, 0) = 5.8038906795734136e-6 + var_x239 + 4.2119663788904201e-5 * var_x28 + 1.4509726698933535e-5 * var_x12 + 1.0364090499238238e-5 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z - 9.4940596487955185e-6 * var_x54 - 2.2107726288625975e-6 * var_x47;
        ...
        IJth(rJacobian, 15, 15) = 1.638640545085862e-16 * var_x79 + 2.8659485630822583e-7 * var_x84 - 3.701460892585086e-7 * var_x77 - 0.00038145775374624855 * var_x83 - 4.3659884291485854e-7 * var_x37 - 0.00058612951745018135 * var_x86;
        ...
        IJth(rJacobian, 22, 22) = 5.8672691657943555e-5 * var_x103 + 0.00085446536839159674 * var_x104 - 0.0011178327494917705 * var_x99 - 0.00085446536839159674 * var_x101 + var_x245 * var_x99 - var_x102 * var_x245 - var_x242 * var_x97 - var_x243 * var_x97 - var_x244 * var_x97;
