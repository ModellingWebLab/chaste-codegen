...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellnoble_noble_SAN_model_1984FromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
const double var_x0 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * NV_Ith_S(mParameters, 5);
        ...
        const double var_x4 = pow(NV_Ith_S(mParameters, 1), 3.0);
        ...
        const double var_x21 = NV_Ith_S(mParameters, 8) / (10.0 + var_chaste_interface__extracellular_potassium_concentration__Kc);
        ...
        const double var_x28 = var_x26 * NV_Ith_S(mParameters, 7);
        ...
        const double var_x32 = NV_Ith_S(mParameters, 4) * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        ...
        const double var_x45 = NV_Ith_S(mParameters, 2) * var_chaste_interface__second_inward_current_f2_gate__f2 * var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x46 = var_x45 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x47 = var_x44 * var_x46;
        const double var_x48 = var_x38 * NV_Ith_S(mParameters, 1);
        ...
        const double var_x69 = 1 / NV_Ith_S(mParameters, 3);
        ...
        const double var_x78 = var_x34 * NV_Ith_S(mParameters, 6);
        const double var_x79 = var_x25 * var_x78;
        const double var_x80 = 1 / var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x81 = (-26.713760659695652 * log(var_x80 * NV_Ith_S(mParameters, 1)) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 7);
        const double var_x82 = var_x25 * var_x81;
        ...
        const double var_x84 = NV_Ith_S(mParameters, 1) + 0.12 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x85 = -26.713760659695652 * log(var_x83 * var_x84) + var_chaste_interface__membrane__V;
        const double var_x86 = var_x85 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * NV_Ith_S(mParameters, 5) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x87 = var_x0 * var_x85;
        const double var_x88 = var_x45 * var_x59;
        const double var_x89 = var_x41 * var_x44;
        const double var_x90 = var_x59 * NV_Ith_S(mParameters, 2) * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x91 = var_x90 * var_chaste_interface__second_inward_current_f2_gate__f2;
        const double var_x92 = var_x90 * var_chaste_interface__second_inward_current_f_gate__f;
        ...
        const double var_x97 = 50.0 * var_x96;
        ...
        const double var_x101 = pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 2.0) * NV_Ith_S(mParameters, 0);
        const double var_x102 = var_x101 * var_x75;
        const double var_x103 = var_x101 * var_x13 * var_x7;
        const double var_x104 = var_x28 * var_x80;
        const double var_x105 = var_x41 * var_x60;
        const double var_x106 = -var_x105 * var_x42;
        const double var_x107 = 26.713760659695652 * var_x22;
        const double var_x108 = var_x24 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        const double var_x109 = var_x108 * NV_Ith_S(mParameters, 6);
        const double var_x110 = 26.713760659695652 * var_x109;
        const double var_x111 = 0.0071428571428571426 * var_x32;
        const double var_x112 = var_x22 * var_x34;
        const double var_x113 = var_x108 * var_x78;
        const double var_x114 = var_x108 * var_x81;
        const double var_x115 = var_x95 * var_x98 / pow(var_x93, 2);
        const double var_x116 = var_x1 / var_x84;
        ...
        const double var_x118 = 0.00049382716049382717 * var_x117;
        const double var_x119 = var_x20 * var_x35 * NV_Ith_S(mParameters, 8) / pow((1 + 0.10000000000000001 * var_chaste_interface__extracellular_potassium_concentration__Kc), 2);
        const double var_x120 = var_x34 * var_x36;
        const double var_x121 = 2.0 * var_x120;
        const double var_x122 = 5.3600801468854619e-7 * var_x57;
        ...
        const double var_x130 = _lt_0_row[11];
        ...
        const double var_x135 = 1.0 - var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        ...
        const double var_x143 = _lt_0_row[9];
        const double var_x144 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x150 = _lt_0_row[7];
        const double var_x151 = exp(-7.5 + var_x145);
        const double var_x152 = 1.0 - var_chaste_interface__second_inward_current_d_gate__d;
        ...
        const double var_x162 = 1.0 - var_chaste_interface__second_inward_current_f_gate__f;
        ...
        const double var_x170 = 1.0032432750983795e-10 * var_x62;
        const double var_x171 = 1.0032432750983795e-10 * var_x67;
        const double var_x172 = var_x169 * var_x49;
        ...
        const double var_x176 = 3.5355036582885069e-9 * var_x117;
        ...
        const double var_x188 = var_x187 * var_x44;
        ...
        const double var_x195 = var_x169 * var_x44;
        const double var_x196 = 0.00071593949080342272 * var_x96;
        const double var_x197 = 5.1138535057387335e-8 * var_x32;
        const double var_x198 = 0.00019125436204147007 * var_x22;
        const double var_x199 = 0.00019125436204147007 * var_x109;
        const double var_x200 = 1.4318789816068454e-5 * var_x120;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x70 * (-0.080000000000000002 - var_x1 - var_x23 - var_x27 - var_x28 + 0.074867781645490947 * var_x37 + 0.011210369457033822 * var_x61 - 0.002 * var_x14 - 0.00026738493444818193 * var_x33 - 0.011210369457033822 * var_x66 + var_x47 * var_x63 + var_x63 * var_x64 - var_x41 * var_x47 - var_x43 * var_x68 - var_x46 * var_x50 - var_x46 * var_x58 - var_x48 * var_x68));
        IJth(rJacobian, 1, 0) = -3.5796974540171133e-8 + 4.0129731003935176e-8 * var_x61 + 1.4318789816068453e-8 * var_x14 - 4.0129731003935176e-8 * var_x66 - var_x122 * var_x46;
        IJth(rJacobian, 2, 0) = -var_x133 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y - 0.067000000000000004 * var_x130 * (0.0001 - 0.0001 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y) + 0.00040000000000000002 * var_x131 * var_x134 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow(var_x132, 2);
        IJth(rJacobian, 3, 0) = var_x135 * var_x138 - var_x141 * var_chaste_interface__time_dependent_potassium_current_x_gate__x + 1.1866666666666666e-5 * var_x139 * var_x142 * var_chaste_interface__time_dependent_potassium_current_x_gate__x / pow(var_x140, 2) - 0.0001 * var_x135 * var_x136 * var_x142 / pow(var_x137, 2);
        IJth(rJacobian, 4, 0) = var_x144 * var_x148 + 0.44800000000000001 * var_x143 * var_chaste_interface__fast_sodium_current_m_gate__m - 0.02 * var_x144 * var_x146 * var_x149 / pow(var_x147, 2);
        IJth(rJacobian, 5, 0) = -0.125 * var_x150 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x151 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x151), 2);
        IJth(rJacobian, 6, 0) = var_x152 * var_x157 - var_x160 * var_chaste_interface__second_inward_current_d_gate__d + 0.0011999999999999999 * var_x158 * var_x161 * var_chaste_interface__second_inward_current_d_gate__d / pow(var_x159, 2) - 0.0074999999999999997 * var_x152 * var_x155 * var_x161 / pow(var_x156, 2);
        IJth(rJacobian, 7, 0) = var_x162 * var_x165 - 0.012500000000000001 * var_x166 * var_chaste_interface__second_inward_current_f_gate__f / pow(var_x167, 2) - 0.0015625000000000001 * var_x162 * var_x163 * var_x168 / pow(var_x164, 2);
        IJth(rJacobian, 9, 0) = -5.0115764356239594e-7 - 4.2956369448205359e-8 * var_x14 - 7.1593949080342271e-6 * var_x1 - 7.1593949080342271e-6 * var_x28 + var_x170 * var_x64 - var_x169 * var_x64 - var_x171 * var_x48;
        ...
        IJth(rJacobian, 13, 0) = 6.4466434341209093e-5 * var_x23 + 6.4466434341209093e-5 * var_x27 + 1.7237353320432221e-8 * var_x33 - 4.8264589297210214e-6 * var_x37 + var_x187 * var_x47 + 9.0336568317820839e-10 * var_x43 * var_x67 - 9.0336568317820839e-10 * var_x47 * var_x62;
        IJth(rJacobian, 14, 0) = 5.3600801468854619e-7 * var_x37 - 1.9143143381733793e-9 * var_x33 - 7.1593949080342271e-6 * var_x23 - 7.1593949080342271e-6 * var_x27 + var_x170 * var_x47 - var_x169 * var_x47 - var_x171 * var_x43;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x70 * (0.002 * var_x74 + 1.38e-5 * var_x73 + 2.0000000000000002e-7 * var_x76 - 0.13356880329847826 * var_x71 - 0.14973556329098189 * var_x77));
        IJth(rJacobian, 1, 1) = -0.19999999999999998 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 9.8799649730872331e-11 * var_x73 - 4.7813590510367518e-7 * var_x71 - 1.4318789816068454e-12 * var_x76 - 5.3600801468854619e-7 * var_x77 - 1.4318789816068453e-8 * var_x74 + var_x123 * var_x127 - var_x123 * var_x128;
        IJth(rJacobian, 8, 1) = -20.0 * var_chaste_interface__second_inward_current_f2_gate__f2;
        IJth(rJacobian, 9, 1) = 4.2956369448205366e-12 * var_x76 + 2.9639894919261698e-10 * var_x73 + 4.2956369448205359e-8 * var_x74;
        ...
        IJth(rJacobian, 11, 1) = var_x128 * var_x178 - var_x127 * var_x178;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x70 * (-var_x79 - var_x82));
        IJth(rJacobian, 2, 2) = -0.0001 * var_x130 - var_x133 * var_x134;
        IJth(rJacobian, 9, 2) = -7.1593949080342271e-6 * var_x82;
        IJth(rJacobian, 13, 2) = 6.4466434341209093e-5 * var_x79;
        IJth(rJacobian, 14, 2) = -7.1593949080342271e-6 * var_x79;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (var_x70 * (0.0071428571428571426 * var_x31 - 0.0071428571428571426 * var_chaste_interface__intracellular_potassium_concentration__Ki) * NV_Ith_S(mParameters, 4));
        IJth(rJacobian, 3, 3) = -var_x138 * var_x142 - var_x141 * var_x142;
        IJth(rJacobian, 13, 3) = (4.6047453100863642e-7 * var_chaste_interface__intracellular_potassium_concentration__Ki - 4.6047453100863642e-7 * var_x31) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 14, 3) = (5.1138535057387335e-8 * var_x31 - 5.1138535057387335e-8 * var_chaste_interface__intracellular_potassium_concentration__Ki) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0030000000000000001 * var_x69 * var_x86);
        IJth(rJacobian, 4, 4) = -8.0 * var_x143 - var_x148 * var_x149;
        IJth(rJacobian, 9, 4) = -2.147818472410268e-5 * var_x86;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x70 * var_x87);
        IJth(rJacobian, 5, 5) = -2.0 / (1.0 + 320.0 * var_x151) - 0.02 * var_x150;
        IJth(rJacobian, 9, 5) = -7.1593949080342271e-6 * var_x87;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x70 * (-var_x50 * var_x88 - var_x58 * var_x88 - var_x88 * var_x89));
        IJth(rJacobian, 1, 6) = -var_x122 * var_x88;
        IJth(rJacobian, 6, 6) = -var_x157 * var_x161 - var_x160 * var_x161;
        IJth(rJacobian, 9, 6) = -var_x172 * var_x88;
        IJth(rJacobian, 13, 6) = var_x188 * var_x88;
        IJth(rJacobian, 14, 6) = -var_x195 * var_x88;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x70 * (-var_x50 * var_x91 - var_x58 * var_x91 - var_x89 * var_x91));
        IJth(rJacobian, 1, 7) = -var_x122 * var_x91;
        IJth(rJacobian, 7, 7) = -0.050000000000000003 / var_x167 - var_x165 * var_x168;
        IJth(rJacobian, 9, 7) = -var_x172 * var_x91;
        IJth(rJacobian, 13, 7) = var_x188 * var_x91;
        IJth(rJacobian, 14, 7) = -var_x195 * var_x91;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x70 * (-var_x50 * var_x92 - var_x58 * var_x92 - var_x89 * var_x92));
        IJth(rJacobian, 1, 8) = -var_x122 * var_x92;
        IJth(rJacobian, 8, 8) = -0.01 - 20.0 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 9, 8) = -var_x172 * var_x92;
        IJth(rJacobian, 13, 8) = var_x188 * var_x92;
        IJth(rJacobian, 14, 8) = -var_x195 * var_x92;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x70 * (var_x106 + 0.03125 * var_x99 + 6.0000000000000008e-7 * var_x102 - 0.0060000000000000001 * var_x103 - 26.713760659695652 * var_x100 - 26.713760659695652 * var_x104 - 1.8699632461786957 * var_x80 - var_x97 * var_chaste_interface__extracellular_potassium_concentration__Kc));
        IJth(rJacobian, 1, 9) = 4.2956369448205359e-8 * var_x103 - 4.2956369448205366e-12 * var_x102;
        IJth(rJacobian, 9, 9) = var_x175 + 1.2886910834461608e-11 * var_x102 + 6.7119327262820874e-7 * var_x99 - 1.2886910834461608e-7 * var_x103 - 0.00019125436204147007 * var_x100 - 0.00019125436204147007 * var_x104 - 1.3387805342902908e-5 * var_x80 - var_x173 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 13, 9) = 4.0291521463255683e-6 * var_x99 - var_x189 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 14, 9) = -4.4746218175213919e-7 * var_x99 + var_x196 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        ...
        IJth(rJacobian, 1, 11) = 0.002 * var_x129;
        IJth(rJacobian, 10, 11) = var_x177;
        IJth(rJacobian, 11, 11) = -var_x179 - 0.099999999999999992 * var_x129;
        ...
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x70 * (var_x107 + var_x110 - var_x112 - var_x113 - var_x114 - var_x121 + 50.0 * var_x115 + 0.01 * var_x119 + 3.2056512791634777 * var_x116 + var_x105 * var_x38 + var_x111 * var_x30 + var_x118 * var_x78 + var_x118 * var_x81 - var_x97 * var_chaste_interface__intracellular_sodium_concentration__Nai));
        IJth(rJacobian, 9, 13) = 2.2950523444976409e-5 * var_x116 + 0.0010739092362051341 * var_x115 - 7.1593949080342271e-6 * var_x114 + var_x176 * var_x81 - var_x173 * var_chaste_interface__intracellular_sodium_concentration__Nai;
        IJth(rJacobian, 13, 13) = -0.001 + var_x193 - var_x190 - var_x191 + 6.4466434341209093e-5 * var_x112 + 6.4466434341209093e-5 * var_x113 + 0.0064466434341209095 * var_x115 - 6.4466434341209093e-7 * var_x119 - var_x187 * var_x194 - var_x189 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x192 * var_x30 - 3.1835276217881036e-8 * var_x117 * var_x78;
        IJth(rJacobian, 14, 13) = var_x198 + var_x199 - var_x200 + 7.1593949080342266e-8 * var_x119 - 0.00071593949080342272 * var_x115 - 7.1593949080342271e-6 * var_x112 - 7.1593949080342271e-6 * var_x113 + var_x169 * var_x194 + var_x176 * var_x78 + var_x196 * var_chaste_interface__intracellular_sodium_concentration__Nai + var_x197 * var_x30;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x70 * (var_x106 - var_x111 - 3.2056512791634777 * var_x100 + var_x121 * var_x16 - var_x107 * var_x16 - var_x110 * var_x16));
        IJth(rJacobian, 9, 14) = -2.2950523444976409e-5 * var_x100;
        IJth(rJacobian, 13, 14) = var_x192 + var_x16 * var_x190 + var_x16 * var_x191 + var_x174 * var_x187 - var_x16 * var_x193;
        IJth(rJacobian, 14, 14) = var_x175 - var_x197 + var_x16 * var_x200 - var_x16 * var_x198 - var_x16 * var_x199;
    }
