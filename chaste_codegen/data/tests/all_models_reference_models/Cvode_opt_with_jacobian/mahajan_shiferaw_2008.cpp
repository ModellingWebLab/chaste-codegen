...
const double var_x0 = -var_chaste_interface__Ito__ytos;
        ...
        const double var_x303 = var_x297 + var_x301 - 8.9997000000000013e-6 * var_x294 * var_x302 / pow(var_x295, 2) - 1.0641199999999999e-5 * var_x298 * var_x302 / pow(var_x299, 2);
        const double var_x304 = var_x297 * var_x302;
        const double var_x305 = var_x301 * var_x302;
        const double var_x306 = var_x291 * (var_x304 + var_x305) / pow(var_x292, 2);
        ...
        const double var_x312 = exp(-0.20000000000000001 - var_x307);
        const double var_x313 = 1.0 + var_x312;
        const double var_x314 = 0.066666666666666666 * var_x312 / pow(var_x313, 2);
        ...
        const double var_x320 = 0.10000000000000001 * var_x36;
        const double var_x321 = var_x4;
        ...
        const double var_x325 = _lt_0_row[17];
        const double var_x326 = 1.0 + var_x325;
        const double var_x327 = 4.0 * var_x78;
        const double var_x328 = fabs(var_x327 * var_chaste_interface__cell__V);
        const double var_x329 = 0.011111111111111112 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x330 = (var_chaste_interface__Irel__Ca_JSR > 50.0) && (var_chaste_interface__Irel__Ca_JSR < 90.0);
        const double var_x331 = var_chaste_interface__Irel__Ca_JSR >= 90.0;
        const double var_x332 = ((var_x330) ? (var_x329 * (-50.0 + var_chaste_interface__Irel__Ca_JSR)) : ((var_x331) ? (var_x329 * (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR)) : (0)));
        const double var_x333 = var_x328 * var_x332;
        const double var_x334 = 0.1290395 * var_x71;
        const double var_x335 = var_x325 / var_x326;
        const double var_x336 = var_x333 * var_x335;
        const double var_x337 = 2.5807899999999999 * var_x335;
        const double var_x338 = Signum(var_x100);
        const double var_x339 = var_x338 * (var_x327 + 0.0080000000000000002 * var_x88 - 8.0 * var_x80 * var_x83);
        const double var_x340 = var_x332 * var_x71;
        const double var_x341 = var_x339 * var_x340;
        const double var_x342 = var_x121 + var_x125 - var_x118;
        const double var_x343 = 1 / var_chaste_interface__Ca__Ca_NSR;
        const double var_x344 = var_x343 * var_chaste_interface__Irel__xir;
        const double var_x345 = -2.5807899999999999 * var_x336;
        const double var_x346 = var_x328 * var_x71;
        const double var_x347 = var_x346 * ((var_x330) ? (var_x329) : ((var_x331) ? (0.12555555555555556 * var_chaste_interface__Ca__Ca_NSR) : (0)));
        const double var_x348 = var_x134 - var_x136 - var_chaste_interface__Irel__xir;
        const double var_x349 = var_x338 * var_x77 * var_x80;
        const double var_x350 = var_x340 * var_x349;
        const double var_x351 = var_x139 - var_x137 - var_x138;
        const double var_x352 = var_x346 * ((var_x330) ? (-0.55555555555555558 + 0.011111111111111112 * var_chaste_interface__Irel__Ca_JSR) : ((var_x331) ? (-10.855555555555556 + 0.12555555555555556 * var_chaste_interface__Irel__Ca_JSR) : (0)));
        const double var_x353 = 0.000125 * var_x14;
        const double var_x354 = 0.000125 * NV_Ith_S(mParameters, 3);
        const double var_x355 = 8.6634442712402744e-10 * var_x109;
        const double var_x356 = 9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca;
        const double var_x357 = _lt_0_row[19];
        const double var_x358 = 1.0 + var_x357;
        const double var_x359 = 9598.6276799999996 * var_x71;
        const double var_x360 = var_x357 / var_x358;
        const double var_x361 = var_x333 * var_x360;
        const double var_x362 = 26841.799999999999 * var_x360;
        const double var_x363 = (-9000.0 * var_x328 - 26841.799999999999 * var_x361) * NV_Ith_S(mParameters, 1);
        const double var_x364 = var_x362 * NV_Ith_S(mParameters, 1);
        ...
        IJth(rJacobian, 12, 0) = 0.059880239520958084 * var_x306 + var_x303 * (-var_chaste_interface__IKs__xs1 + var_x293);
        IJth(rJacobian, 13, 0) = 0.014970059880239521 * var_x306 + var_x303 * (0.25 * var_x293 - 0.25 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 14, 0) = var_x311 * var_x314 + 0.0074074074074074077 * var_x308 * (var_x315 - var_chaste_interface__Ito__xtos) / (pow(var_x309, 2) * pow((0.055555555555555552 + var_x310), 2));
        IJth(rJacobian, 15, 0) = -var_x319 * var_x320 + 3.3333333333333335e-5 * var_x316 * (var_x0 + var_x321) / (pow(var_x317, 2) * pow((0.01 + var_x318), 2));
        IJth(rJacobian, 16, 0) = var_x314 * var_x323 + 0.00063492063492063492 * var_x322 * (var_x315 - var_chaste_interface__Ito__xtof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x322), 2);
        IJth(rJacobian, 17, 0) = -var_x320 * var_x324 + 0.0050000000000000001 * var_x36 * (var_x321 - var_chaste_interface__Ito__ytof) / pow((1 + var_x4), 2);
        IJth(rJacobian, 19, 0) = var_x337 * var_x341 - var_x334 * var_x336 + var_x333 * var_x334 * pow(var_x325, 2) / pow(var_x326, 2);
        IJth(rJacobian, 20, 0) = (-var_x353 - 0.00039000000000000005 * var_x87 - 0.00056249999999999996 * var_x69 - 0.0030000000000000001 * var_x60) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 0) = (var_x339 * var_x356 + var_x341 * var_x362 - var_x359 * var_x361 + var_x333 * var_x359 * pow(var_x357, 2) / pow(var_x358, 2)) * NV_Ith_S(mParameters, 1);
        IJth(rJacobian, 22, 0) = var_x374 * (50.0 * var_x60 + 72800.0 * var_x84 + 6.5000000000000009 * var_x87 - 36400.0 * var_x79 - 72.799999999999997 * var_x89);
        ...
        IJth(rJacobian, 19, 5) = var_x345;
        IJth(rJacobian, 21, 5) = var_x363;
        IJth(rJacobian, 22, 5) = var_x376;
        ...
        IJth(rJacobian, 19, 6) = var_x345;
        IJth(rJacobian, 21, 6) = var_x363;
        IJth(rJacobian, 22, 6) = var_x376;
        ...
        IJth(rJacobian, 19, 7) = var_x345;
        IJth(rJacobian, 21, 7) = var_x363;
        IJth(rJacobian, 22, 7) = var_x376;
        ...
        IJth(rJacobian, 19, 8) = var_x345;
        IJth(rJacobian, 21, 8) = var_x363;
        IJth(rJacobian, 22, 8) = var_x376;
        ...
        IJth(rJacobian, 19, 9) = var_x345;
        IJth(rJacobian, 21, 9) = var_x363;
        IJth(rJacobian, 22, 9) = var_x376;
        ...
        IJth(rJacobian, 19, 10) = var_x345;
        IJth(rJacobian, 21, 10) = var_x363;
        IJth(rJacobian, 22, 10) = var_x376;
        ...
        IJth(rJacobian, 13, 13) = -3.2750000000000003e-5 * var_x296 * var_x302 - 1.7975e-5 * var_x300 * var_x302;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x34 * var_x5);
        IJth(rJacobian, 14, 14) = -var_x311;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (var_x102 * var_x35);
        IJth(rJacobian, 15, 15) = -var_x319;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x102 * var_x6);
        IJth(rJacobian, 16, 16) = -var_x323;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x102 * NV_Ith_S(mParameters, 14) * var_chaste_interface__Ito__xtof);
        IJth(rJacobian, 17, 17) = -var_x324;
        IJth(rJacobian, 18, 18) = -0.01;
        IJth(rJacobian, 19, 18) = var_x337 * var_x347;
        IJth(rJacobian, 21, 18) = var_x347 * var_x364;
        IJth(rJacobian, 19, 19) = -0.033333333333333333 - var_x344 + var_x343 * var_x348;
        IJth(rJacobian, 22, 19) = 50.0 * var_x373;
        ...
        IJth(rJacobian, 20, 20) = (3.9062500000000001e-6 * var_x105 - 0.00056249999999999996 * var_x104 - 0.0089999999999999993 * var_x111 - var_x108 * var_x355 - var_x20 * var_x353 * var_x94) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 20) = var_x374 * (150.0 * var_x111 + var_x108 * var_x377);
        ...
        IJth(rJacobian, 19, 22) = 0.01032316 * var_x335 * var_x350;
        IJth(rJacobian, 20, 22) = (3.0000000000000001e-6 * var_x112 - 0.00024299999999999997 * var_x113 - var_x114 * var_x355) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 22) = 2.0 + (0.0040000000000000001 * var_x349 * var_x356 + 107.3672 * var_x350 * var_x360) * NV_Ith_S(mParameters, 1);
        IJth(rJacobian, 22, 22) = var_x374 * (-14.789 + var_x378 + 4.0499999999999998 * var_x113 - 36.399999999999999 * var_x115 - 0.050000000000000003 * var_x112 + var_x114 * var_x377) + 0.0012574820180071425 * (9.0 / pow(var_x365, 3) + 56.399999999999999 / pow(var_x369, 3) + 0.97959183673469385 / pow(var_x371, 3) + 0.49704142011834318 / pow(var_x367, 3)) * (50.0 * var_chaste_interface__Irel__xir + 0.019599999999999999 * var_chaste_interface__Ca__trops + 12500.0 * var_chaste_interface__Ca__Ca_i_converted - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x375 * var_x71 - var_x379 * (70.0 - var_chaste_interface__Ca__trops) + 50.0 * var_x59 * var_x85) / pow((0.035460992907801421 + var_x370 + 0.15957446808510639 * var_x366 + 0.12158054711246201 * var_x372 + 0.11456628477905074 * var_x368), 2);
        IJth(rJacobian, 25, 22) = 2.2890000000000001 - var_x378;
        IJth(rJacobian, 1, 23) = var_x132 * (var_x137 + var_x138 - var_x139);
        IJth(rJacobian, 18, 23) = 0.01;
        IJth(rJacobian, 19, 23) = var_x337 * var_x352 + (var_x343 * var_x351 - var_x348 / var_x122) * var_chaste_interface__Irel__xir;
        IJth(rJacobian, 21, 23) = var_x352 * var_x364;
        IJth(rJacobian, 23, 23) = var_x351;
        IJth(rJacobian, 1, 24) = var_x132 * (0.019599999999999999 + var_x133);
        IJth(rJacobian, 24, 24) = -0.019599999999999999 - var_x133;
        IJth(rJacobian, 22, 25) = var_x374 * (0.019599999999999999 + var_x379);
        IJth(rJacobian, 25, 25) = -0.019599999999999999 - var_x379;
    }
