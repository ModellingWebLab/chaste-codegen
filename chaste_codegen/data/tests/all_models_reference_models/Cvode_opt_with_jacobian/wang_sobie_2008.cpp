...
const double var_x0 = 1 + 0.25 * var_chaste_interface__calcium_concentration__Cass;
        ...
        const double var_x11 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 2) * NV_Ith_S(mParameters, 12);
        const double var_x12 = var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss * NV_Ith_S(mParameters, 10);
        const double var_x13 = var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K * NV_Ith_S(mParameters, 11);
        ...
        const double var_x16 = pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 6.5) * NV_Ith_S(mParameters, 8);
        const double var_x17 = var_x16 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x18 = NV_Ith_S(mParameters, 13) * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur;
        ...
        const double var_x44 = exp(1.4858841010401188e-5 * NV_Ith_S(mParameters, 4));
        ...
        const double var_x60 = var_x57 * NV_Ith_S(mParameters, 2);
        ...
        const double var_x69 = var_x33 * var_x39;
        const double var_x70 = var_x2 / pow(var_x0, 4);
        const double var_x71 = 3.0985546875e-14 * var_x70;
        const double var_x72 = var_x1 * pow(var_chaste_interface__calcium_concentration__Cass, 2);
        const double var_x73 = 1.239421875e-13 * var_x72;
        const double var_x74 = var_x7 * var_x71 - var_x7 * var_x73;
        const double var_x75 = var_x62 * var_chaste_interface__membrane__V;
        ...
        const double var_x82 = -25.674321243523316 * log(var_x41 * NV_Ith_S(mParameters, 4)) + var_chaste_interface__membrane__V;
        ...
        const double var_x85 = var_x29 * var_x82;
        const double var_x86 = var_x28 * var_x83;
        const double var_x87 = 25.674321243523316 * var_x20;
        const double var_x88 = var_x21 * var_x26;
        const double var_x89 = var_x21 * var_x53;
        const double var_x90 = var_x52 * pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 5.5) * NV_Ith_S(mParameters, 8) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x91 = var_x16 * var_x52;
        const double var_x92 = var_x51 - var_chaste_interface__membrane__V;
        ...
        const double var_x96 = var_x52 * NV_Ith_S(mParameters, 12) * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        ...
        const double var_x242 = ((var_x237) ? (0.15999999943156581 * var_x234 + 0.16000000056843419 * var_x235) : (var_x241 - 0.032000000000000001 * var_x236 * var_x239 / pow(var_x240, 2)));
        ...
        const double var_x262 = ((var_x246) ? (var_x260 + var_x256 * var_x261 * (1.5254334000000001e-6 * var_x258 - 31073.016 * var_x257) - 0.311 * var_x254 * var_x259 * var_x261 / pow(var_x255, 2)) : (0));
        ...
        const double var_x276 = 0.063492063492063489 * var_chaste_interface__membrane__V;
        const double var_x277 = -var_x276;
        const double var_x278 = exp(-8.3841269841269845 + var_x277);
        const double var_x279 = 1.0 + 0.0067083000000000004 * var_x278;
        const double var_x280 = exp(0.2419047619047619 + var_x277);
        const double var_x281 = var_x280 / var_x279;
        const double var_x282 = 0.00015200000000000001 * var_x281;
        const double var_x283 = exp(8.3841269841269845 + var_x276);
        const double var_x284 = 1.0 + 0.051334999999999999 * var_x283;
        const double var_x285 = var_x283 / var_x284;
        const double var_x286 = 1 / (var_x282 + 0.00095 * var_x285);
        ...
        const double var_x298 = 9.6507936507936517e-6 * var_x281;
        const double var_x299 = 6.4740419047619061e-8 * var_x278 * var_x280 / pow(var_x279, 2);
        const double var_x300 = exp(-0.062899999999999998 * var_chaste_interface__membrane__V);
        const double var_x301 = exp(-2.9220779220779218 - 0.12987012987012986 * var_chaste_interface__membrane__V);
        ...
        const double var_x305 = 0.12987012987012986 * var_x301 / pow(var_x302, 2);
        ...
        const double var_x310 = var_x306 / pow(var_x307, 2);
        ...
        const double var_x313 = 1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        const double var_x314 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x315 = 1 / (1.0 - exp(1.0000000020227162e-7));
        const double var_x316 = _lt_0_row[32];
        const double var_x317 = 3.6226653999999999e-6 * var_x316 * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        const double var_x318 = 26.5 + var_chaste_interface__membrane__V;
        const double var_x319 = fabs(var_x318) < 7.812499998038902e-7;
        ...
        const double var_x323 = 3.7604140701062501e-12 * var_x315;
        const double var_x324 = -9.5333299999999997e-5 * var_x316;
        const double var_x325 = exp(0.038198000000000003 * var_chaste_interface__membrane__V);
        const double var_x326 = 0.00052457313400000008 * var_x325 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2;
        const double var_x327 = exp(-0.041779999999999998 * var_chaste_interface__membrane__V);
        const double var_x328 = 2.8786419999999997e-6 * var_x327 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x329 = exp(0.11695499999999999 + 0.023390999999999999 * var_chaste_interface__membrane__V);
        const double var_x330 = 0.0021243940109999999 * var_x329 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x331 = exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x332 = 0.00021232196 * var_x331 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x56) ? (var_x55 - var_x4 * var_x7 - var_x4 * var_x9) : (var_x55 - 1.6091588988130313e-8 * var_x3 * var_x62 - var_x59 * var_x60 * var_x63 + var_x57 * var_x61 * var_x63 / pow(var_x58, 2))));
        IJth(rJacobian, 2, 0) = var_x111 * (-0.00064948070203595543 + 0.14288575444791021 * var_x14 - 0.49409893888087347 * var_chaste_interface__L_type_calcium_current__O);
        ...
        IJth(rJacobian, 22, 0) = ((var_x246) ? (var_x247 + (var_x248 - 0.28123999999999999 * var_x249 - 108500.0 * var_x250) * var_chaste_interface__fast_sodium_current_h_gate__h) : (var_x247 + (var_x248 - 0.693000693000693 * var_x251 / pow(var_x252, 2)) * var_chaste_interface__fast_sodium_current_h_gate__h));
        IJth(rJacobian, 23, 0) = ((var_x246) ? (var_x262 + (var_x263 + 0.001275024 * var_x267 - 0.016701360000000002 * var_x264 * var_x266 / pow(var_x265, 2)) * var_chaste_interface__fast_sodium_current_j_gate__j) : (var_x262 + (var_x263 + 7.6049999999999996e-8 * var_x271 - 0.029999999999999999 * var_x268 * var_x270 / pow(var_x269, 2)) * var_chaste_interface__fast_sodium_current_j_gate__j));
        IJth(rJacobian, 24, 0) = (0.12312838418511024 * var_x49 + 0.0062683541039692484 * var_x54 - 0.069959309196085367 * var_x11 - 0.069959309196085367 * var_x12 - 0.069959309196085367 * var_x13 - 0.069959309196085367 * var_x17 - 0.069959309196085367 * var_x19 - 0.069959309196085367 * var_x27) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 25, 0) = 0.035770000000000003 * var_x274 * (0.18064 - 0.18064 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f) + 0.024673572000000001 * var_x275 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f;
        IJth(rJacobian, 26, 0) = (var_x296 + var_x297) * (var_x286 * var_x299 - var_x286 * var_x298 + 168.42105263157896 * var_x281 * (var_x298 - var_x299 - 6.0317460317460316e-5 * var_x285 + 3.0963968253968251e-6 * pow(var_x283, 2) / pow(var_x284, 2)) / pow((var_x285 + 0.16 * var_x281), 2)) + (-var_chaste_interface__fast_transient_outward_potassium_current__ito_f + var_x282 * var_x286) * (0.00013571428571428572 * var_x290 - 2.1714285714285715e-5 * var_x295 - 6.9668928571428572e-6 * pow(var_x288, 2) / pow(var_x289, 2) + 1.4566594285714287e-6 * var_x292 * var_x294 / pow(var_x293, 2));
        IJth(rJacobian, 27, 0) = var_x304 * var_x305 + 0.0073216139155926159 * var_x300 * (var_x303 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur) / pow((1 + 0.23955296404275997 * var_x300), 2);
        IJth(rJacobian, 28, 0) = -0.17543859649122806 * var_x309 * var_x310 - 2.0711500974658867e-5 * var_x310 * (-var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur + var_x308) / pow((1 - 0.14166666666666666 * var_x308), 2);
        IJth(rJacobian, 29, 0) = var_x305 * var_x312 + 0.0021933842239185751 * var_x311 * (var_x303 - var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss) / pow((0.33511450381679392 + var_x311), 2);
        IJth(rJacobian, 30, 0) = ((var_x319) ? (var_x317 + var_x313 * (2.4066649945278773e-6 * var_x314 + 2.4066650054721224e-6 * var_x315)) : (var_x317 + var_x313 * var_x322 - 6.1610624e-7 * var_x313 * var_x318 * var_x320 / pow(var_x321, 2)));
        IJth(rJacobian, 31, 0) = var_x326 + var_x328 - var_x330 - var_x332;
        IJth(rJacobian, 32, 0) = 0.01176 * var_x337 * (0.022348 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K) + 0.0029658262000000005 * var_x338 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1;
        IJth(rJacobian, 33, 0) = -var_x326 - var_x328;
        IJth(rJacobian, 34, 0) = var_x330 + var_x332;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.40000000000000002 * var_x66 + 907679.99999999988 * var_x69 - 0.0032092901554404145 * var_x64 - 400000.0 * var_x68);
        IJth(rJacobian, 1, 1) = var_x103 * (-1435.4208799999999 + var_x98 + var_x99 + 0.17999999999999999 * var_x66 - 180000.0 * var_x68) + 1.1900000000000001e-8 * (var_x104 + 0.019599999999999999 * var_chaste_interface__calcium_buffering__LTRPN_Ca + 3.1999999999999999e-5 * var_chaste_interface__calcium_buffering__HTRPN_Ca + 2.088e-5 * var_chaste_interface__calcium_concentration__CaNSR - 90000.0 * var_x105 - 125.02087999999999 * var_chaste_interface__calcium_concentration__Cai_converted - var_x106 * (35.0 - var_chaste_interface__calcium_buffering__LTRPN_Ca) - var_x107 * (70.0 - var_chaste_interface__calcium_buffering__HTRPN_Ca)) / (pow(var_x100, 3) * pow(var_x101, 2));
        IJth(rJacobian, 2, 1) = var_x110 * (9283.6923277152328 + (1.0391691232575289 * var_x66 - 0.0083374880927700838 * var_x64 - 1039169.1232575288 * var_x68) * NV_Ith_S(mParameters, 6));
        IJth(rJacobian, 3, 1) = -125.0 * var_x123;
        IJth(rJacobian, 4, 1) = 0.22717201143946614 + 1958379.4089609149 * var_x68 - 1.958379408960915 * var_x66;
        IJth(rJacobian, 6, 1) = 1144.5 - var_x98;
        IJth(rJacobian, 7, 1) = 165.90000000000001 - var_x99;
        IJth(rJacobian, 20, 1) = 190501.99731330827 * var_x69 * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x56) ? (var_x74 + (-0.5 + 194747.11532096745 * var_chaste_interface__membrane__V) * (var_x74 + var_x71 * var_x9 - var_x73 * var_x9)) : (1.2068691741097736e-8 * var_x70 * var_x75 - 4.8274766964390942e-8 * var_x72 * var_x75)));
        IJth(rJacobian, 1, 2) = 0.000125 * var_x102;
        IJth(rJacobian, 2, 2) = var_x110 * (-9.283692327715233 + (-var_x112 - var_x113) * var_chaste_interface__calcium_fluxes__P_RyR) + 0.33613445378151263 * (0.017570117784863667 * var_x116 + 9283.6923277152328 * var_chaste_interface__calcium_concentration__Cai_converted - 9.283692327715233 * var_chaste_interface__calcium_concentration__Cass - 2.5979228081438217 * (0.00025000000000000001 * var_chaste_interface__membrane__V + 200000.0 * var_x105 - 0.0032092901554404145 * log(0.001 * var_x64 * NV_Ith_S(mParameters, 1)) + var_x10 * var_x114 - var_x15 * (-50.0 + var_chaste_interface__membrane__V)) * NV_Ith_S(mParameters, 6)) / (pow(var_x108, 3) * pow((0.16806722689075632 + var_x109), 2));
        ...
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-2723.04 * var_x80 - 4.3375549444376549e-7 * var_x81 - 0.066753235233160624 * var_x41 - 25.674321243523316 * var_x79);
        IJth(rJacobian, 20, 20) = (-571.5059919399248 * var_x80 - 9.1035704253876838e-8 * var_x81 - 0.004670010223515703 * var_x41 - 1.7961577782752707 * var_x79) * NV_Ith_S(mParameters, 6);
        ...
        IJth(rJacobian, 21, 21) = -((var_x237) ? (-var_x244 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x244 + 3.1999999919207769e-7 * var_x234)) : (var_x236 * var_x241)) - 0.080000000000000002 * var_x243;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x85);
        IJth(rJacobian, 20, 22) = -var_x233 * var_x85;
        IJth(rJacobian, 22, 22) = ((var_x246) ? (var_x253 - 310000.0 * var_x250 - 3.5600000000000001 * var_x249) : (var_x253 - 7.6923076923076916 / var_x252));
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x86);
        IJth(rJacobian, 20, 23) = -var_x233 * var_x86;
        IJth(rJacobian, 23, 23) = ((var_x246) ? (var_x272 - 0.1212 * var_x267) : (var_x272 - 0.29999999999999999 * var_x271));
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (2.300419183419689 * var_x89 - 25.674321243523316 * var_x88 - var_x11 * var_x87 - var_x12 * var_x87 - var_x13 * var_x87 - var_x17 * var_x87 - var_x19 * var_x87);
        IJth(rJacobian, 24, 24) = (0.16093573693346425 * var_x89 - 1.7961577782752707 * var_x88 - var_x11 * var_x273 - var_x12 * var_x273 - var_x13 * var_x273 - var_x17 * var_x273 - var_x19 * var_x273) * NV_Ith_S(mParameters, 6);
        ...
        IJth(rJacobian, 30, 30) = ((var_x319) ? (var_x323 + var_x324 - 640000.00016065314 * (26.500000781250002 + var_chaste_interface__membrane__V) * (var_x323 + 3.760414053005867e-12 * var_x314)) : (var_x324 - var_x318 * var_x322));
        IJth(rJacobian, 0, 31) = mSetVoltageDerivativeToZero ? 0.0 : (var_x97);
        IJth(rJacobian, 24, 31) = var_x233 * var_x97;
        IJth(rJacobian, 31, 31) = -var_x333 - var_x334;
        IJth(rJacobian, 32, 31) = var_x339;
        IJth(rJacobian, 33, 31) = var_x333;
        IJth(rJacobian, 34, 31) = var_x334;
        IJth(rJacobian, 32, 32) = -0.023761000000000001 + var_x339 - 0.047002000000000002 * var_x338;
        IJth(rJacobian, 33, 32) = 0.023761000000000001;
        IJth(rJacobian, 31, 33) = var_x335;
        IJth(rJacobian, 32, 33) = 0.036777999999999998 + var_x339;
        IJth(rJacobian, 33, 33) = -0.036777999999999998 - var_x335;
        IJth(rJacobian, 31, 34) = var_x336;
        IJth(rJacobian, 32, 34) = var_x339;
        IJth(rJacobian, 34, 34) = -var_x336;
    }
