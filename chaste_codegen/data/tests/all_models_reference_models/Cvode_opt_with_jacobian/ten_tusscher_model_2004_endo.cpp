...
const double var_x0 = exp(9.9999999999999995e-8);
        ...
        const double var_x58 = NV_Ith_S(mParameters, 4) * _lt_0_row[3];
        ...
        const double var_x104 = ((var_x12) ? (var_x100 + var_x80 * (-var_x100 - var_x101)) : (var_x103 * var_chaste_interface__L_type_Ca_current_f_gate__f));
        const double var_x105 = var_x81 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        const double var_x106 = var_x105 * var_x3;
        const double var_x107 = ((var_x12) ? (var_x106 + var_x80 * (-var_x106 - var_x10 * var_x105)) : (var_x103 * var_chaste_interface__L_type_Ca_current_d_gate__d));
        const double var_x108 = 0.019297068299999998 * NV_Ith_S(mParameters, 7);
        const double var_x109 = var_x108 * var_x5;
        const double var_x110 = ((var_x12) ? (var_x109 + var_x80 * (-var_x109 - var_x108 * var_x11)) : (var_x102 * var_x4 * NV_Ith_S(mParameters, 7) * var_chaste_interface__membrane__V));
        ...
        const double var_x192 = 0.01 * NV_Ith_S(mParameters, 14);
        const double var_x193 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 15));
        const double var_x194 = 1.0 + var_x193;
        const double var_x195 = 1.0 - var_x192;
        const double var_x196 = var_x192 + var_x195 / pow(var_x194, 2);
        const double var_x197 = var_x196 - var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x204 = var_x193 * var_x195 / pow(var_x194, 3);
        const double var_x205 = 0.26917900403768508 * var_x204;
        ...
        const double var_x210 = var_x196 - var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x239 = exp(-0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x246 = exp(2.8571428571428572 + var_x153);
        ...
        const double var_x258 = exp(5.5999999999999996 + var_x178);
        const double var_x259 = 1.0 + var_x258;
        const double var_x260 = exp(-4.4889999999999999 * pow((1 + 0.014925373134328358 * var_chaste_interface__membrane__V), 2));
        const double var_x261 = 1 / (8.0 + 1000.0 * var_x260);
        const double var_x262 = exp(3.3333333333333335 + var_x170);
        const double var_x263 = 1.0 + var_x262;
        const double var_x264 = exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_x265 = 1 / (0.80000000000000004 + 9.5 * var_x264);
        const double var_x266 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x267 = pow(var_x266, (-2));
        const double var_x268 = 14.994515539305301 / (1.0 + 3.0 * var_x267);
        const double var_x269 = var_x268 * (-0.0082319999999999997 - var_x142);
        const double var_x270 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6);
        const double var_x271 = var_chaste_interface__calcium_dynamics__Ca_i < 0.00035;
        const double var_x272 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16);
        const double var_x273 = (var_x250) && (((var_x271) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x272)))) && (((var_chaste_interface__calcium_dynamics__Ca_i >= 0.00035) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x270))));
        const double var_x274 = NV_Ith_S(mParameters, 12) * NV_Ith_S(mParameters, 3);
        const double var_x275 = 0.00063181349969740233 * var_x274;
        const double var_x276 = var_x275 * var_x31 * var_x98;
        const double var_x277 = 2.7188924024856265e-5 * var_x72;
        const double var_x278 = 0.00027188924024856262 * var_x274;
        const double var_x279 = var_x275 * var_x52;
        ...
        IJth(rJacobian, 6, 0) = ((var_x206) ? (var_x197 * (108035.0 * var_x198 + 0.21330000000000002 * var_x199 - 0.008382352941176471 * var_x200) - var_x205 * (var_x201 + var_x202 + var_x203)) : (-1.5943679469924423 * var_x204 * var_x209 + 0.53361053361053368 * var_x197 * var_x207 / pow(var_x208, 2)));
        IJth(rJacobian, 7, 0) = ((var_x206) ? (var_x210 * (var_x217 - 0.00025500480000000003 * var_x221 + var_x216 * var_x222 * (3.0508668000000001e-7 * var_x212 - 6214.6032000000005 * var_x211) + 0.0033402720000000005 * var_x218 * var_x220 / pow(var_x219, 2) - 0.311 * var_x213 * var_x214 * var_x222 / pow(var_x215, 2)) - var_x205 * (var_x223 + var_x224)) : (0.034200000000000001 * var_x210 * var_x228 - 0.16150740242261102 * var_x204 * var_x228 + 0.059999999999999998 * var_x210 * var_x225 * var_x227 / pow(var_x226, 2)));
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x240) * (-0.050000000000000003 * var_x229 / pow(var_x230, 2) + 0.27999999999999997 * var_x232 * var_x237 / pow(var_x233, 2) - 0.15076923076923074 * var_x234 * var_x235 / pow(var_x236, 2)) / pow((var_x238 + 0.7142857142857143 * var_x231), 2) + 0.13333333333333333 * var_x239 * var_x241 / pow(var_x240, 2);
        IJth(rJacobian, 9, 0) = 7.9012345679012348e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x247) * (-var_x248 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 16.5 * var_x242 / pow(var_x243, 2)) / pow((0.071111111111111111 + var_x245 + 0.14666666666666667 * var_x244), 2) - 0.14285714285714285 * var_x246 * var_x249 / pow(var_x247, 2);
        IJth(rJacobian, 11, 0) = -0.20000000000000001 * var_x258 * var_x261 / pow(var_x259, 2) - 0.001 * var_x260 * (-0.13400000000000001 - 0.002 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x259) / pow((0.0080000000000000002 + var_x260), 2);
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x262 * var_x265 / pow(var_x263, 2) - 0.10526315789473684 * var_x264 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x263) / pow((0.084210526315789472 + var_x264), 2);
        IJth(rJacobian, 15, 0) = var_x274 * (-0.0018954404990922068 * var_x63 - 0.0018954404990922068 * var_x79 - 4.6119913257618111e-6 * var_x68 - 0.00063181349969740233 * var_x116 - 0.00063181349969740233 * NV_Ith_S(mParameters, 10));
        IJth(rJacobian, 16, 0) = var_x274 * (0.0012636269993948047 * var_x79 + 1.631335441491376e-6 * var_x66 - 0.00027188924024856262 * var_x123 - 2.7188924024856265e-5 * var_x50 - 0.00010565443138752546 * var_x53 - 0.00063181349969740233 * var_x26 - 0.00063181349969740233 * var_x27 - 0.00063181349969740233 * var_x29 - var_x277 * var_x70);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x90 + 2.5 * var_x91 - var_x85 - var_x87 - 13.356880329847826 * var_x89);
        IJth(rJacobian, 1, 1) = var_x131 * (var_x132 - var_x134 + (0.00031590674984870116 * var_x90 - 0.0042195286531202733 * var_x89 - 0.0015795337492435057 * var_x91 - 0.00031590674984870116 * var_x85 - 0.00031590674984870116 * var_x87) * NV_Ith_S(mParameters, 12)) + 0.00029999999999999997 * (var_x135 + var_x145 - var_x136 - var_x138 * (var_x87 * var_chaste_interface__calcium_dynamics__Ca_i + (-13.356880329847826 * log(var_x88 * NV_Ith_S(mParameters, 4)) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 9) - 2.0 * var_x62 * var_x67 + ((var_x12) ? (var_x137 - 374338.9082274547 * (-1.3356880329847825e-6 + var_chaste_interface__membrane__V) * (-var_x137 - var_x101 * var_chaste_interface__L_type_Ca_current_d_gate__d)) : (var_x20 * var_chaste_interface__membrane__V)))) / (pow(var_x128, 3) * pow(var_x129, 2));
        IJth(rJacobian, 10, 1) = ((var_x256) ? (0) : (var_x257 * (-6.8203084950904297e-28 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 7) / pow((1.2447063003540035e-28 + var_x255), 2) - 171.23287671232876 * var_x253 / pow(var_x254, 2) - 684.93150684931504 * var_x251 / pow(var_x252, 2))));
        IJth(rJacobian, 13, 1) = var_x268 * (var_x134 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 14, 1) = ((var_x273) ? (0) : ((var_x271) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5) / pow((1.8382656249999998e-21 + var_x270), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15) / pow((5.0709427749024951e-56 + var_x272), 2))));
        IJth(rJacobian, 15, 1) = 0.0047386012477305169 * var_x274 * var_x91;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x35 * var_x52);
        IJth(rJacobian, 2, 2) = -var_x159;
        IJth(rJacobian, 16, 2) = -var_x278 * var_x34 * var_x52;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.43033148291193518 * var_x92);
        IJth(rJacobian, 3, 3) = -var_x169;
        IJth(rJacobian, 16, 3) = -var_x278 * var_x92;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-2.0 * var_x94);
        IJth(rJacobian, 4, 4) = -0.00090909090909090909 * var_x177;
        IJth(rJacobian, 16, 4) = -0.0012636269993948047 * var_x274 * var_x94;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x97);
        IJth(rJacobian, 5, 5) = -var_x191;
        IJth(rJacobian, 15, 5) = -0.0018954404990922068 * var_x274 * var_x97;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x99 * var_chaste_interface__fast_sodium_current_j_gate__j);
        IJth(rJacobian, 6, 6) = ((var_x206) ? (-var_x201 - var_x202 - var_x203) : (-5.9230769230769234 * var_x209));
        IJth(rJacobian, 15, 6) = -var_x276 * var_chaste_interface__fast_sodium_current_j_gate__j;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x99 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 7, 7) = ((var_x206) ? (-var_x223 - var_x224) : (-0.59999999999999998 * var_x228));
        IJth(rJacobian, 15, 7) = -var_x276 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x104);
        IJth(rJacobian, 1, 8) = var_x131 * (var_x144 - var_x104 * var_x138);
        IJth(rJacobian, 8, 8) = -var_x241;
        IJth(rJacobian, 13, 8) = var_x269 * var_chaste_interface__calcium_dynamics__g;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x107);
        IJth(rJacobian, 1, 9) = -var_x107 * var_x146;
        IJth(rJacobian, 9, 9) = -var_x249;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x110);
        IJth(rJacobian, 1, 10) = -var_x110 * var_x146;
        IJth(rJacobian, 10, 10) = ((var_x256) ? (0) : (-var_x257));
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x111 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 11, 11) = -var_x261;
        IJth(rJacobian, 16, 11) = -var_x279 * var_x28;
        ...
        IJth(rJacobian, 16, 12) = -var_x279 * NV_Ith_S(mParameters, 22) * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 13) = var_x131 * (var_x149 * (var_x148 - var_x147) + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 13, 13) = var_x268 * (var_x132 + var_x149 * (var_x147 - var_x148)) + 9.9963436928702016 * (var_x136 - var_x135 - var_x145) / (pow(var_x266, 3) * pow((0.33333333333333337 + var_x267), 2));
        IJth(rJacobian, 1, 14) = var_x131 * var_x143 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 13, 14) = var_x269 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 14, 14) = ((var_x273) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 15, 15) = var_x274 * (1.1846503119326294e-6 * var_x118 - 0.0018954404990922068 * var_x115 - 0.016878114612481093 * var_x112 - 0.016878114612481093 * var_x117 - 0.0056863214972766203 * var_x119);
        IJth(rJacobian, 16, 15) = var_x274 * (0.0012636269993948047 * var_x115 - 0.00050634343837443281 * var_x113 - 7.8976687462175284e-7 * var_x118);
        ...
        IJth(rJacobian, 16, 16) = var_x274 * (4.357910453967955e-5 * var_x127 - 0.016878114612481093 * var_x113 - 0.016878114612481093 * var_x120 - 0.016878114612481093 * var_x121 - 0.00072631840899465921 * var_x122 - 0.0072631840899465916 * var_x124 - var_x126 * var_x277);
    }
