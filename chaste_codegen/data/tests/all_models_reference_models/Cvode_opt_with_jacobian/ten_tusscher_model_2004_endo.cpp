...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_current_f_gate__f = _lt_0_row[10] * (-var_chaste_interface__L_type_Ca_current_f_gate__f + _lt_0_row[9]); // 1 / millisecond
        const double d_dt_chaste_interface_var_fast_sodium_current_h_gate__h = (-var_chaste_interface__fast_sodium_current_h_gate__h + _lt_0_row[11]) * (_lt_0_row[12]); // 1 / millisecond
        const double d_dt_chaste_interface_var_fast_sodium_current_j_gate__j = (-var_chaste_interface__fast_sodium_current_j_gate__j + _lt_0_row[11]) * (_lt_0_row[13]); // 1 / millisecond
        const double d_dt_chaste_interface_var_fast_sodium_current_m_gate__m = _lt_0_row[15] * (_lt_0_row[16]) * (-var_chaste_interface__fast_sodium_current_m_gate__m + _lt_0_row[14]); // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_rapid_time_dependent_potassium_current_Xr1_gate__Xr1 = 0.00037037037037037035 * (_lt_0_row[18]) * (_lt_0_row[19]) * (-var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + _lt_0_row[17]); // 1 / millisecond
        const double d_dt_chaste_interface_var_rapid_time_dependent_potassium_current_Xr2_gate__Xr2 = 0.29761904761904762 * (_lt_0_row[21]) * (_lt_0_row[22]) * (-var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 + _lt_0_row[20]); // 1 / millisecond
        const double var_calcium_background_current__i_b_Ca = 0.00059199999999999997 * var_chaste_interface__membrane__V - 0.0079072731552699126 * log(2.0 / var_chaste_interface__calcium_dynamics__Ca_i); // picoA_per_picoF
        const double var_reversal_potentials__E_K = 26.713760659695652 * log(5.4000000000000004 / var_chaste_interface__potassium_dynamics__K_i); // millivolt
        const double var_inward_rectifier_potassium_current__i_K1 = 0.54050000000000009 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) / ((1.0 + exp(-12.0 + 0.059999999999999998 * var_chaste_interface__membrane__V - 0.059999999999999998 * var_reversal_potentials__E_K)) * (0.10000000000000001 / (1.0 + exp(-12.0 + 0.059999999999999998 * var_chaste_interface__membrane__V - 0.059999999999999998 * var_reversal_potentials__E_K)) + (3.0 * exp(0.02 + 0.00020000000000000001 * var_chaste_interface__membrane__V - 0.00020000000000000001 * var_reversal_potentials__E_K) + exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__V - 0.10000000000000001 * var_reversal_potentials__E_K)) / (1.0 + exp(0.5 * var_reversal_potentials__E_K - 0.5 * var_chaste_interface__membrane__V)))); // picoA_per_picoF
        const double var_potassium_pump_current__i_p_K = 0.0146 * _lt_0_row[2] * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V); // picoA_per_picoF
        const double var_rapid_time_dependent_potassium_current__i_Kr = 1.0 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2) * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2; // picoA_per_picoF
        const double d_dt_chaste_interface_var_slow_time_dependent_potassium_current_Xs_gate__Xs = 0.00090909090909090909 * _lt_0_row[24] * (_lt_0_row[21]) * (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + _lt_0_row[23]); // 1 / millisecond
        const double var_reversal_potentials__E_Na = 26.713760659695652 * log(140.0 / var_chaste_interface__sodium_dynamics__Na_i); // millivolt
        const double var_fast_sodium_current__i_Na = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 1) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j; // picoA_per_picoF
        const double var_slow_time_dependent_potassium_current__i_Ks = 0.245 * pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * (-26.713760659695652 * log(9.5999999999999996 / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i)) + var_chaste_interface__membrane__V); // picoA_per_picoF
        const double var_sodium_background_current__i_b_Na = 0.00029 * var_chaste_interface__membrane__V - 0.00029 * var_reversal_potentials__E_Na; // picoA_per_picoF
        ...
        const double d_dt_chaste_interface_var_transient_outward_current_r_gate__r = _lt_0_row[26] * (-var_chaste_interface__transient_outward_current_r_gate__r + _lt_0_row[25]); // 1 / millisecond
        const double var_transient_outward_current__i_to = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 3) * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // picoA_per_picoF
        ...
        const double d_dt_chaste_interface_var_transient_outward_current_s_gate__s = _lt_0_row[28] * (-var_chaste_interface__transient_outward_current_s_gate__s + _lt_0_row[27]); // 1 / millisecond
...
const double var_x0 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2);
        ...
        const double var_x161 = var_x160 - var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x174 = var_x160 - var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x203 = exp(-0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x210 = exp(2.8571428571428572 + var_x119);
        ...
        const double var_x221 = exp(5.5999999999999996 + var_x144);
        ...
        const double var_x225 = exp(3.3333333333333335 + var_x136);
        ...
        IJth(rJacobian, 6, 0) = ((var_x170) ? (var_x161 * (108035.0 * var_x162 + 0.21330000000000002 * var_x163 - 0.008382352941176471 * var_x164) - var_x169 * (var_x165 + var_x166 + var_x167)) : (-1.5943679469924423 * var_x168 * var_x173 + 0.53361053361053368 * var_x161 * var_x171 / pow(var_x172, 2)));
        IJth(rJacobian, 7, 0) = ((var_x170) ? (var_x174 * (var_x181 - 0.00025500480000000003 * var_x185 + var_x180 * var_x186 * (3.0508668000000001e-7 * var_x176 - 6214.6032000000005 * var_x175) + 0.0033402720000000005 * var_x182 * var_x184 / pow(var_x183, 2) - 0.311 * var_x177 * var_x178 * var_x186 / pow(var_x179, 2)) - var_x169 * (var_x187 + var_x188)) : (0.034200000000000001 * var_x174 * var_x192 - 0.16150740242261102 * var_x168 * var_x192 + 0.059999999999999998 * var_x174 * var_x189 * var_x191 / pow(var_x190, 2)));
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x204) * (-0.050000000000000003 * var_x193 / pow(var_x194, 2) + 0.27999999999999997 * var_x196 * var_x201 / pow(var_x197, 2) - 0.15076923076923074 * var_x198 * var_x199 / pow(var_x200, 2)) / pow((var_x202 + 0.7142857142857143 * var_x195), 2) + 0.13333333333333333 * var_x203 * var_x205 / pow(var_x204, 2);
        IJth(rJacobian, 9, 0) = 7.9012345679012348e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x211) * (-var_x212 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 16.5 * var_x206 / pow(var_x207, 2)) / pow((0.071111111111111111 + var_x209 + 0.14666666666666667 * var_x208), 2) - 0.14285714285714285 * var_x210 * var_x213 / pow(var_x211, 2);
        IJth(rJacobian, 11, 0) = -0.20000000000000001 * var_x221 * var_x224 / pow(var_x222, 2) - 0.001 * var_x223 * (-0.13400000000000001 - 0.002 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x222) / pow((0.0080000000000000002 + var_x223), 2);
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x225 * var_x228 / pow(var_x226, 2) - 0.10526315789473684 * var_x227 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x226) / pow((0.084210526315789472 + var_x227), 2);
        IJth(rJacobian, 15, 0) = -3.389679425876563e-8 - 7.3941785176126768e-11 * var_x32 - 0.00011688549744401942 * var_x36 - 3.0388663876087418e-8 * var_x10 - 0.00040297005778184723 * var_x48;
        ...
        IJth(rJacobian, 10, 1) = ((var_x220) ? (0) : (-3.4101542475452148e-28 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 7) / pow((1.2447063003540035e-28 + var_x219), 2) - 85.61643835616438 * var_x217 / pow(var_x218, 2) - 342.46575342465752 * var_x215 / pow(var_x216, 2)));
        IJth(rJacobian, 13, 1) = var_x231 * (8.0000000000000007e-5 + var_x101);
        ...
        IJth(rJacobian, 10, 10) = ((var_x220) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 13, 13) = var_x231 * (-8.0000000000000007e-5 + var_x115 * (var_x114 - var_x113)) + 9.9963436928702016 * (var_x103 + var_x104 - var_x102 - var_x111) / (pow(var_x229, 3) * pow((0.33333333333333337 + var_x230), 2));
        ...
        IJth(rJacobian, 15, 15) = 2.5185628611365452e-7 * var_x83 - 1.823319832565245e-7 * var_x84 - 9.0551084895961074e-7 * var_x71 - 0.0031224512033090025 * var_x86 - 0.00040297005778184723 * var_x82;
