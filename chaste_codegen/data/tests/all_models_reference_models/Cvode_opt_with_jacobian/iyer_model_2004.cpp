...
const double var_x0 = exp(0.03743720055088938 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        ...
        IJth(rJacobian, 2, 0) = 0.00021359213333547216 * var_x48 + 3.4618327348681446e-10 * var_x56 + 7.2724087660027779e-7 * var_x39 - 2.1531465053979051e-7 * var_chaste_interface__IKs__O1ks - 2.1531465053979051e-7 * var_chaste_interface__IKs__O2ks - 6.1518471582797284e-5 * var_x26 - 1.5417159680637438e-5 * var_x31 - 1.1442435714400293e-6 * var_chaste_interface__IKr__OHerg - 4.7689611318757119e-6 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - 3.4618327348681446e-10 * var_x59 - var_x49 * var_x89;
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x68 + 0.31576891781939609 * var_x73 - 0.093489896373056991 * var_x69 - 0.49683202072538851 * var_x70 - 2.0706890167875649 * var_x71 - 0.00015031321966819388 * var_x66 - 6.6941504319201117 * var_x72);
        IJth(rJacobian, 2, 2) = 1.9425621197603171e-5 * var_x73 - 6.1518471582797284e-5 * var_x68 - 0.00012738562343605624 * var_x71 - 3.0564346548418563e-5 * var_x70 - 9.2470395326765519e-9 * var_x66 - 5.7513555333045694e-6 * var_x69 - 0.00041181390311704753 * var_x72;
