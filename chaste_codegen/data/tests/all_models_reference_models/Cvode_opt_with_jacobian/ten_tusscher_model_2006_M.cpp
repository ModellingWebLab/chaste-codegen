...
const double var_x0 = exp(1.0000000000609274e-7);
        ...
        const double var_x94 = 1.3356880330661625e-6 * var_x4;
        const double var_x95 = (-15.000001335688033 + var_chaste_interface__membrane__V) * (-var_x94 - 1.3356880330661625e-6 * var_x7);
        const double var_x96 = 0.01929706830117572 * var_x4 - 5408181626.6858826 * var_x95;
        ...
        const double var_x109 = var_x0 * var_x1;
        const double var_x110 = ((var_x12) ? (var_x10 * (0.0048242670752939301 * var_x109 + 14447.286958825251 * (5615084.1230697082 - 374338.90820464725 * var_chaste_interface__membrane__V) * (-3.3392200826654062e-7 * var_x109 - 3.3392200826654062e-7 * var_x5 * var_x6))) : (3611.8217397063127 * var_x21));
        ...
        IJth(rJacobian, 15, 15) = var_x298 * (-1.1399999999999999 - var_x297 + 6.0021945866861737 * var_x290 - 6.4023408924652525 * var_x287 - var_x110 * var_x294) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x282 * var_x297 - var_x294 * ((var_x12) ? (var_x13 * (var_x94 - 374338.90820464725 * var_x95)) : (var_x11 * var_x19))) / (pow(var_x291, 3) * pow(var_x292, 2));
