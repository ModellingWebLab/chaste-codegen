...
const double var_x0 = exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V);
        ...
        const double var_x160 = 0.01 * NV_Ith_S(mParameters, 13);
        const double var_x161 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 14));
        ...
        const double var_x165 = var_x164 - var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x166 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 14));
        const double var_x167 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 14));
        ...
        const double var_x172 = var_x161 * var_x163 / pow(var_x162, 3);
        const double var_x173 = 0.26917900403768508 * var_x172;
        const double var_x174 = var_chaste_interface__membrane__V < -40.0 + NV_Ith_S(mParameters, 14);
        ...
        const double var_x178 = var_x164 - var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x179 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x180 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 14) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x181 = -25428.0 * var_x179 - 6.9480000000000002e-6 * var_x180;
        const double var_x182 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 14));
        ...
        const double var_x193 = exp(-3.2000000000000002 - var_x21 + 0.10000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x194 = 1.0 + var_x193;
        const double var_x195 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * NV_Ith_S(mParameters, 14));
        ...
        const double var_x207 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x218 = exp(2.8571428571428572 + var_x118);
        const double var_x219 = 1.0 + var_x218;
        const double var_x220 = var_x210 / pow(var_x211, 2);
        ...
        const double var_x227 = exp(5.0 + var_x118);
        ...
        const double var_x234 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x231), 2);
        ...
        const double var_x257 = var_chaste_interface__calcium_dynamics__R_prime * NV_Ith_S(mParameters, 1);
        ...
        const double var_x268 = var_x256 * var_x261 * NV_Ith_S(mParameters, 1);
        const double var_x269 = var_x253 * var_x267 * var_x268;
        const double var_x270 = var_x61 * NV_Ith_S(mParameters, 11);
        ...
        const double var_x276 = var_x271 * var_x274 * var_x58;
        const double var_x277 = var_x276 * var_x84;
        ...
        const double var_x281 = NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 3);
        const double var_x282 = 0.00063181349969740233 * var_x281;
        const double var_x283 = 2.7188924024856265e-5 * var_x48;
        const double var_x284 = 0.00027188924024856262 * var_x281;
        const double var_x285 = var_x28 * var_x282;
        ...
        IJth(rJacobian, 6, 0) = ((var_x174) ? (var_x165 * (108035.0 * var_x166 + 0.21330000000000002 * var_x167 - 0.008382352941176471 * var_x168) - var_x173 * (var_x169 + var_x170 + var_x171)) : (-1.5943679469924423 * var_x172 * var_x177 + 0.53361053361053368 * var_x165 * var_x175 / pow(var_x176, 2)));
        IJth(rJacobian, 7, 0) = ((var_x174) ? (var_x178 * (var_x185 - 0.00025500480000000003 * var_x189 + var_x184 * var_x190 * (3.0508668000000001e-7 * var_x180 - 6214.6032000000005 * var_x179) + 0.0033402720000000005 * var_x186 * var_x188 / pow(var_x187, 2) - 0.311 * var_x181 * var_x182 * var_x190 / pow(var_x183, 2)) - var_x173 * (var_x191 + var_x192)) : (0.034200000000000001 * var_x178 * var_x196 - 0.16150740242261102 * var_x172 * var_x196 + 0.059999999999999998 * var_x178 * var_x193 * var_x195 / pow(var_x194, 2)));
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x208) * (-0.050000000000000003 * var_x197 / pow(var_x198, 2) + 0.27999999999999997 * var_x200 * var_x205 / pow(var_x201, 2) - 0.15076923076923074 * var_x202 * var_x203 / pow(var_x204, 2)) / pow((var_x206 + 0.7142857142857143 * var_x199), 2) + 0.13333333333333333 * var_x207 * var_x209 / pow(var_x208, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x219) * (18.0 * var_x220 - var_x221 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x213 / pow(var_x214, 2)) / pow((0.018140589569160998 + var_x217 + 0.16326530612244897 * var_x212 + 0.18140589569160998 * var_x215), 2) - 0.14285714285714285 * var_x218 * var_x222 / pow(var_x219, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x228) * (8.0 * var_x220 - var_x229 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x223 / pow(var_x224, 2)) / pow((var_x226 + 0.055160142348754451 * var_x225 + 0.14234875444839859 * var_x212), 2) - 0.095714285714285724 * var_x227 * var_x230 / pow(var_x228, 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x240) * (-var_x241 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + var_x235 / pow(var_x236, 2)) / pow((0.035294117647058823 + var_x238 + 0.058823529411764705 * var_x237), 2) - 0.20000000000000001 * var_x239 * var_x242 / pow(var_x240, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x243 * var_x246 / pow(var_x244, 2) - 0.10526315789473684 * var_x245 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x244) / pow((0.084210526315789472 + var_x245), 2);
        IJth(rJacobian, 15, 0) = var_x275 * (-var_x271 * var_x59 + 102.50886482291351 * var_x270 * var_x65 - 25.627216205728377 * var_x67 * NV_Ith_S(mParameters, 11));
        IJth(rJacobian, 17, 0) = var_x281 * (-0.0018954404990922068 * var_x39 - 0.0018954404990922068 * var_x55 - 4.6119913257618111e-6 * var_x44 - 0.00063181349969740233 * var_x8 - 0.00063181349969740233 * NV_Ith_S(mParameters, 9));
        IJth(rJacobian, 18, 0) = var_x281 * (0.0012636269993948047 * var_x55 + 1.631335441491376e-6 * var_x42 - 0.00027188924024856262 * var_x100 - 2.7188924024856265e-5 * var_x26 - 0.00010565443138752546 * var_x29 - 0.00063181349969740233 * var_x2 - 0.00063181349969740233 * var_x3 - 0.00063181349969740233 * var_x5 - var_x283 * var_x46);
        ...
        IJth(rJacobian, 14, 1) = var_x250 * (1.2499999999999999e-7 * var_x111 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 15, 1) = 1.1399999999999999 * var_x274;
        IJth(rJacobian, 17, 1) = 0.0047386012477305169 * var_x281 * var_x73;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x28);
        IJth(rJacobian, 2, 2) = -var_x124;
        IJth(rJacobian, 18, 2) = -var_x10 * var_x28 * var_x284;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.43033148291193518 * var_x74);
        IJth(rJacobian, 3, 3) = -var_x134;
        IJth(rJacobian, 18, 3) = -var_x284 * var_x74;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-2 * var_x76);
        IJth(rJacobian, 4, 4) = -var_x145;
        IJth(rJacobian, 18, 4) = -0.0012636269993948047 * var_x281 * var_x76;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x80);
        IJth(rJacobian, 5, 5) = -var_x159;
        IJth(rJacobian, 17, 5) = -0.0018954404990922068 * var_x281 * var_x80;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x81);
        IJth(rJacobian, 6, 6) = ((var_x174) ? (-var_x169 - var_x170 - var_x171) : (-5.9230769230769234 * var_x177));
        IJth(rJacobian, 17, 6) = -var_x282 * var_x81;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x82);
        IJth(rJacobian, 7, 7) = ((var_x174) ? (-var_x191 - var_x192) : (-0.59999999999999998 * var_x196));
        IJth(rJacobian, 17, 7) = -var_x282 * var_x82;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * var_x83);
        IJth(rJacobian, 8, 8) = -var_x209;
        IJth(rJacobian, 15, 8) = -var_x276 * var_x64;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x85 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 9, 9) = -var_x222;
        IJth(rJacobian, 15, 9) = -var_x277 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        ...
        IJth(rJacobian, 15, 10) = -var_x277 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x83 * var_x86);
        IJth(rJacobian, 11, 11) = -var_x233;
        IJth(rJacobian, 15, 11) = -var_x276 * var_x86;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x4 * var_x87);
        IJth(rJacobian, 12, 12) = -var_x242;
        IJth(rJacobian, 18, 12) = -var_x285 * var_x4;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x87 * var_x88);
        IJth(rJacobian, 13, 13) = -var_x246;
        IJth(rJacobian, 18, 13) = -var_x285 * var_x88;
        IJth(rJacobian, 1, 14) = var_x107 * var_x109;
        IJth(rJacobian, 14, 14) = var_x250 * (-var_x259 - NV_Ith_S(mParameters, 0) + 0.21333333333333335 * var_x265 - 0.032000000000000001 * var_x263) + 0.66666666666666674 * (var_x113 - var_x112 * NV_Ith_S(mParameters, 0) - var_x259 * var_x261) / (pow(var_x247, 3) * pow((0.33333333333333337 + var_x248), 2));
        IJth(rJacobian, 15, 14) = var_x275 * (var_x279 + 0.64023408924652514 * var_x263 - 4.2682272616435011 * var_x265);
        IJth(rJacobian, 16, 14) = 0.059999999999999998 * var_x260 * var_x267;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-3611.8217397063127 * var_x89);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x107;
        IJth(rJacobian, 11, 15) = -0.0030000000000000001 * var_x233 * var_x234 + 6.2500000000000001e-5 * var_x234 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x232) / pow((0.025000000000000001 + var_x232), 2);
        IJth(rJacobian, 14, 15) = var_x250 * (var_x259 + 0.32000000000000001 * var_x266 - 0.29999999999999999 * var_x269);
        IJth(rJacobian, 15, 15) = var_x275 * (-1.1399999999999999 - var_x279 + 6.0021945866861737 * var_x269 - 6.4023408924652525 * var_x266 - 342.29966004705079 * var_x89 * NV_Ith_S(mParameters, 11)) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x261 * var_x279 - var_x271 * var_x66) / (pow(var_x272, 3) * pow(var_x273, 2));
        IJth(rJacobian, 16, 15) = var_x280 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -var_x249 * var_x255 * var_x268;
        IJth(rJacobian, 15, 16) = var_x268 * var_x274 * var_x278;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x280 * var_chaste_interface__calcium_dynamics__Ca_ss;
        ...
        IJth(rJacobian, 17, 17) = var_x281 * (1.1846503119326294e-6 * var_x95 - 0.0018954404990922068 * var_x93 - 0.016878114612481093 * var_x90 - 0.016878114612481093 * var_x94 - 0.0056863214972766203 * var_x96);
        IJth(rJacobian, 18, 17) = var_x281 * (0.0012636269993948047 * var_x93 - 0.00050634343837443281 * var_x91 - 7.8976687462175284e-7 * var_x95);
        ...
        IJth(rJacobian, 18, 18) = var_x281 * (4.357910453967955e-5 * var_x104 - 0.016878114612481093 * var_x91 - 0.016878114612481093 * var_x97 - 0.016878114612481093 * var_x98 - 0.00072631840899465921 * var_x99 - 0.0072631840899465916 * var_x101 - var_x103 * var_x283);
    }
