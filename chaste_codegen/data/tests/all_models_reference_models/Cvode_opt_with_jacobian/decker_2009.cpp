...
const double var_x0 = 7224.0024405006716 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x160 = var_x6 * var_x7;
        const double var_x161 = ((var_x11) ? (var_x159 + var_x156 * (-var_x159 - var_x157 * var_x160)) : (var_x17 * var_x58));
        ...
        const double var_x180 = var_x179 * var_x5;
        const double var_x181 = -0.5 + 374358.83507802623 * var_chaste_interface__membrane__Vm;
        const double var_x182 = var_x180 - var_x181 * (-var_x180 - var_x179 * var_x8);
        ...
        const double var_x200 = var_x199 * var_x26;
        const double var_x201 = var_x198 * var_x28;
        const double var_x202 = var_x200 - 187179.41753901311 * (-2.6712338705498262e-6 + var_chaste_interface__membrane__Vm) * (-var_x200 - var_x201 * var_x29);
        ...
        const double var_x212 = var_x158 * var_x179;
        const double var_x213 = ((var_x11) ? (var_x9 * (var_x212 + var_x156 * (-var_x212 - var_x160 * var_x179))) : (var_x17 * var_x22));
        ...
        const double var_x216 = var_x158 * var_x215;
        const double var_x217 = ((var_x33) ? (var_x216 + var_x214 * (-var_x216 - var_x160 * var_x215)) : (var_x41 * var_x50));
        ...
        const double var_x233 = ((var_x33) ? (var_x32 * (var_x199 + var_x214 * (-var_x199 - var_x201))) : (3612.0012202503358 * var_x38 * var_chaste_interface__membrane__Vm));
        ...
        const double var_x266 = var_x157 * var_x54;
        ...
        const double var_x429 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x430 = 1 / (1.0 - exp(1.0000000045806701e-7));
        const double var_x431 = 0.15999999943156581 * var_x429 + 0.16000000056843419 * var_x430;
        ...
        const double var_x436 = fabs(var_x435) < 1.0000000010279564e-6;
        ...
        const double var_x442 = 3.2000000146581445e-7 * var_x430;
        const double var_x443 = -0.080000000000000002 * var_x432;
        const double var_x444 = ((var_x436) ? (var_x442 + var_x443 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__Vm) * (var_x442 + 3.1999999919207769e-7 * var_x429)) : (var_x443 - var_x435 * var_x440));
        ...
        const double var_x475 = 1 / (-1.0 + exp(9.9999999552835566e-8));
        const double var_x476 = 1 / (-1.0 + exp(-9.9999999552835566e-8));
        ...
        const double var_x482 = 1.9710906613568111e-10 * var_x475;
        const double var_x483 = var_x479 * var_x480;
        const double var_x484 = -var_x482;
        const double var_x485 = 761000.00340292137 * (38.360799342969777 + var_chaste_interface__membrane__Vm) * (var_x484 - 1.9710906613568111e-10 * var_x476);
        const double var_x486 = 0.23529411764705882 * var_x472 / pow(var_x473, 2);
        const double var_x487 = 38.360799999999998 + var_chaste_interface__membrane__Vm;
        const double var_x488 = fabs(var_x487) < 6.5703022045227044e-7;
        const double var_x489 = 1 / (1.0 - exp(9.9999999992661527e-8));
        const double var_x490 = 1 / (1.0 - exp(-1.0000000002285959e-7));
        const double var_x491 = exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm);
        const double var_x492 = -1.0 + var_x491;
        const double var_x493 = 0.00029999999999999997 / var_x492;
        const double var_x494 = var_x493 - 4.566e-5 * var_x487 * var_x491 / pow(var_x492, 2);
        const double var_x495 = 4.4117647055585959e-10 * var_x489;
        const double var_x496 = var_x487 * var_x493;
        const double var_x497 = 679999.99994722824 * (-1.7383992647058824 + var_chaste_interface__membrane__Vm) * (var_x495 + 4.4117647068908634e-10 * var_x490);
        const double var_x498 = fabs(-1.7384000000000002 + var_chaste_interface__membrane__Vm) < 7.3529411770412167e-7;
        const double var_x499 = -var_x483;
        const double var_x500 = -var_x496;
        ...
        IJth(rJacobian, 30, 0) = ((var_x488) ? (var_x474 * (var_x481 + 0.00014999999999999999 * var_x475 + 0.00014999999999999999 * var_x476) + var_x486 * (var_x482 + var_x483 - var_x485)) : ((var_x498) ? (var_x474 * (var_x494 + 0.00029999999995470287 * var_x489 + 0.00030000000004529707 * var_x490) + var_x486 * (var_x496 + var_x497 - var_x495)) : (var_x474 * (var_x481 + var_x494) + var_x486 * (var_x483 + var_x496))));
        ...
        IJth(rJacobian, 30, 30) = ((var_x488) ? (var_x484 + var_x485 + var_x499) : ((var_x498) ? (var_x495 + var_x500 - var_x497) : (var_x499 + var_x500)));
