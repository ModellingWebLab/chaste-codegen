...
const double var_x0 = -0.34100000000000003 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x4 = NV_Ith_S(mParameters, 9) * NV_Ith_S(mParameters, 11);
        const double var_x5 = 1.08e-10 * var_x4;
        const double var_x6 = var_x3 * var_x5;
        const double var_x7 = var_x6 * (var_x0 + var_x1 * var_x2);
        const double var_x8 = exp(-9.9999999999999995e-8);
        const double var_x9 = 1 / (-1.0 + var_x8);
        const double var_x10 = var_x5 * var_x9;
        const double var_x11 = -var_x7 - var_x10 * (var_x0 + var_x2 * var_x8);
        const double var_x12 = 1.0 - var_chaste_interface__I_Ca__f_Ca_Bj;
        const double var_x13 = 1 / (NV_Ith_S(mParameters, 10) * NV_Ith_S(mParameters, 23));
        const double var_x14 = var_x13 * NV_Ith_S(mParameters, 9);
        const double var_x15 = -31.0 + 0.10000000000000001 * NV_Ith_S(mParameters, 23);
        ...
        const double var_x23 = var_x6 * (var_x0 + var_x1 * var_x22);
        const double var_x24 = var_x14 * (-var_x23 - var_x10 * (var_x0 + var_x22 * var_x8));
        ...
        const double var_x35 = pow(var_chaste_interface__I_Ks__x_ks, 2) * NV_Ith_S(mParameters, 18);
        const double var_x36 = 0.0035000000000000001 * var_x35;
        const double var_x37 = 1 / var_chaste_interface__K_Concentration__K_i;
        const double var_x38 = 1 / NV_Ith_S(mParameters, 9);
        const double var_x39 = var_x38 * NV_Ith_S(mParameters, 10) * NV_Ith_S(mParameters, 23);
        const double var_x40 = var_x39 * log(var_x37 * NV_Ith_S(mParameters, 7));
        const double var_x41 = -var_x40 + var_chaste_interface__membrane_potential__V_m;
        const double var_x42 = 0.1144 * NV_Ith_S(mParameters, 15) * var_chaste_interface__I_to__x_to_f * var_chaste_interface__I_to__y_to_f;
        const double var_x43 = 0.015599999999999999 * NV_Ith_S(mParameters, 19) * var_chaste_interface__I_to__x_to_s * var_chaste_interface__I_to__y_to_s;
        const double var_x44 = pow(var_chaste_interface__I_Na__m, 3);
        const double var_x45 = var_x44 * var_chaste_interface__I_Na__j * NV_Ith_S(mParameters, 12);
        const double var_x46 = var_x45 * var_chaste_interface__I_Na__h;
        const double var_x47 = sqrt(NV_Ith_S(mParameters, 7));
        const double var_x48 = var_x47 * NV_Ith_S(mParameters, 17) * var_chaste_interface__I_Kr__x_kr;
        ...
        const double var_x63 = var_x47 * NV_Ith_S(mParameters, 16) / (var_x62 + 1.02 * var_x55);
        ...
        const double var_x70 = var_x69 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x74 = pow(NV_Ith_S(mParameters, 8), 3);
        ...
        const double var_x87 = pow(1.5700000000000001, var_x15) * NV_Ith_S(mParameters, 20);
        ...
        const double var_x95 = exp(0.01485884101040119 * NV_Ith_S(mParameters, 8));
        ...
        const double var_x98 = NV_Ith_S(mParameters, 21) * NV_Ith_S(mParameters, 7) / (1.5 + NV_Ith_S(mParameters, 7));
        ...
        const double var_x102 = var_x101 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x122 = 0.42189361069797565 * var_x121 * var_x55 * NV_Ith_S(mParameters, 16) / pow((var_x55 + 0.98039215686274506 * var_x62), 2);
        ...
        const double var_x132 = -0.75 * NV_Ith_S(mParameters, 8);
        const double var_x133 = 0.75 * var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x134 = 7.4999999999999986e-16 * NV_Ith_S(mParameters, 9);
        const double var_x135 = var_x134 * var_x3;
        const double var_x136 = var_x135 * (var_x132 + var_x1 * var_x133);
        const double var_x137 = var_x134 * var_x9;
        const double var_x138 = -var_x136 - var_x137 * (var_x132 + var_x133 * var_x8);
        const double var_x139 = 2025000.0000000002 * var_x138 * var_x20;
        const double var_x140 = -0.75 * NV_Ith_S(mParameters, 7);
        const double var_x141 = 0.75 * var_chaste_interface__K_Concentration__K_i;
        const double var_x142 = 1.3499999999999999e-14 * NV_Ith_S(mParameters, 9);
        const double var_x143 = var_x142 * var_x3 * (var_x140 + var_x1 * var_x141);
        const double var_x144 = var_x14 * (-var_x143 - var_x142 * var_x9 * (var_x140 + var_x141 * var_x8));
        ...
        const double var_x148 = var_x135 * (var_x132 + var_x1 * var_x147);
        const double var_x149 = -var_x148 - var_x137 * (var_x132 + var_x147 * var_x8);
        ...
        const double var_x159 = var_x13 * pow(NV_Ith_S(mParameters, 9), 2);
        ...
        const double var_x174 = pow(NV_Ith_S(mParameters, 9), 3) / (pow(NV_Ith_S(mParameters, 10), 2) * pow(NV_Ith_S(mParameters, 23), 2));
        ...
        const double var_x192 = NV_Ith_S(mParameters, 11) / var_x191;
        ...
        const double var_x202 = var_x174 * NV_Ith_S(mParameters, 11) / pow(var_x191, 2);
        ...
        const double var_x213 = var_x39;
        const double var_x214 = -var_x213 * log(var_x212 * NV_Ith_S(mParameters, 8)) + var_chaste_interface__membrane_potential__V_m;
        const double var_x215 = var_chaste_interface__I_Na__h * NV_Ith_S(mParameters, 12);
        const double var_x216 = var_x215 * pow(var_chaste_interface__I_Na__m, 2) * var_chaste_interface__I_Na__j;
        const double var_x217 = var_x214 * var_x216;
        const double var_x218 = 1 / var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x219 = -var_x213 * log(var_x218 * NV_Ith_S(mParameters, 8)) + var_chaste_interface__membrane_potential__V_m;
        const double var_x220 = var_x216 * var_x219;
        const double var_x221 = 0.11 * var_x214;
        const double var_x222 = 0.89000000000000001 * var_x219;
        const double var_x223 = var_x215 * var_x44;
        const double var_x224 = 1 / (0.018329999999999999 * var_chaste_interface__Na_Concentrations__Na_i + var_chaste_interface__K_Concentration__K_i);
        const double var_x225 = (0.015599999999999999 * var_x40 - 0.015599999999999999 * var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 19);
        const double var_x226 = (0.1144 * var_x40 - 0.1144 * var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 15);
        const double var_x227 = 10000000.0 * var_chaste_interface__membrane_potential__V_m - 0.5 * var_x39;
        const double var_x228 = var_x23 - var_x227 * var_x24;
        ...
        const double var_x233 = var_x7 - var_x11 * var_x232;
        ...
        const double var_x237 = -var_x231 - var_x236;
        const double var_x238 = 5000000.0 * var_chaste_interface__membrane_potential__V_m - 0.5 * var_x39;
        const double var_x239 = var_x143 - var_x144 * var_x238;
        const double var_x240 = var_x17 * var_x239;
        const double var_x241 = 0.45000000000000001 * var_x145;
        const double var_x242 = var_x14 * var_x238;
        const double var_x243 = var_x148 - var_x149 * var_x242;
        const double var_x244 = var_x230 * var_x243;
        const double var_x245 = var_x136 - var_x138 * var_x242;
        const double var_x246 = var_x235 * var_x245;
        const double var_x247 = -var_x244 - var_x246 - var_x240 * var_x241;
        const double var_x248 = var_x17 * var_chaste_interface__membrane_potential__V_m;
        const double var_x249 = var_x166 * var_x248;
        const double var_x250 = var_x158 * var_x25;
        const double var_x251 = var_x249 * var_x250;
        const double var_x252 = 6.0749999999999998e-8 * var_x145 * var_x167;
        const double var_x253 = var_x178 * var_x249;
        const double var_x254 = -var_x251 - var_x253 - var_x248 * var_x252;
        const double var_x255 = var_x189 * var_x194;
        const double var_x256 = var_x25 * var_x255;
        const double var_x257 = var_x248 * var_x256;
        const double var_x258 = var_x199 * var_x248;
        const double var_x259 = -var_x257 - var_x258;
        const double var_x260 = var_x16 * var_chaste_interface__I_Ca__d;
        const double var_x261 = var_x229 * var_x260;
        const double var_x262 = var_x228 * var_x261;
        const double var_x263 = var_x234 * var_x260;
        const double var_x264 = var_x233 * var_x263;
        const double var_x265 = -var_x262 - var_x264;
        const double var_x266 = var_x243 * var_x261;
        const double var_x267 = var_x245 * var_x263;
        const double var_x268 = -var_x266 - var_x267 - var_x239 * var_x241 * var_x260;
        const double var_x269 = var_x260 * var_chaste_interface__membrane_potential__V_m;
        const double var_x270 = var_x166 * var_x269;
        const double var_x271 = var_x250 * var_x270;
        const double var_x272 = var_x178 * var_x270;
        const double var_x273 = -var_x271 - var_x272 - var_x252 * var_x269;
        const double var_x274 = var_x256 * var_x269;
        const double var_x275 = var_x199 * var_x269;
        const double var_x276 = -var_x274 - var_x275;
        const double var_x277 = 0.40500000000000003 * var_chaste_interface__I_Ca__d;
        const double var_x278 = var_x17 * var_x277;
        const double var_x279 = var_x233 * var_x278;
        const double var_x280 = var_x245 * var_x278;
        const double var_x281 = var_x280 + var_x240 * var_x277;
        const double var_x282 = var_x169 * var_chaste_interface__membrane_potential__V_m;
        const double var_x283 = var_x171 * var_x282;
        const double var_x284 = var_x167 * var_x179;
        const double var_x285 = var_x283 + 5.4675000000000005e-8 * var_x284;
        const double var_x286 = var_x179 * var_x193 * var_x198;
        const double var_x287 = 0.044999999999999991 * var_chaste_interface__I_Ca__d;
        const double var_x288 = var_x17 * var_x287;
        const double var_x289 = var_x228 * var_x288;
        const double var_x290 = var_x243 * var_x288;
        const double var_x291 = var_x290 + var_x240 * var_x287;
        const double var_x292 = var_x158 * var_x282;
        const double var_x293 = var_x292 + 6.074999999999999e-9 * var_x284;
        const double var_x294 = var_x179 * var_x255;
        const double var_x295 = 5.6249999999999997e-16 * NV_Ith_S(mParameters, 9);
        const double var_x296 = var_x1 * var_x3;
        const double var_x297 = var_x295 * var_x296;
        const double var_x298 = var_x8 * var_x9;
        ...
        const double var_x306 = 3 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x311 = 2.4510059584016866e-13 * var_x310;
        const double var_x312 = 0.11 * var_x46;
        const double var_x313 = var_x301 * var_x312;
        const double var_x314 = var_x68 * NV_Ith_S(mParameters, 5);
        const double var_x315 = var_x305 * var_x314 * var_x90;
        const double var_x316 = -var_x302 - var_x313 - 0.33000000000000002 * var_x315 - 3.0052592036063111e-5 * var_x304 - var_x308 * var_x311;
        const double var_x317 = var_x316 - var_x300;
        ...
        const double var_x327 = 1.9830866390704552e-12 * var_x326;
        ...
        const double var_x331 = -var_x322 - var_x329 - 2.6699999999999999 * var_x330 - 0.00024315279010996517 * var_x323 - var_x325 * var_x327;
        const double var_x332 = var_x331 - var_x320;
        const double var_x333 = var_x163 * var_x182;
        const double var_x334 = var_x331 - var_x333;
        const double var_x335 = var_x224 * var_x39;
        const double var_x336 = 1.0124999999999999e-14 * NV_Ith_S(mParameters, 9);
        const double var_x337 = var_x296 * var_x336;
        const double var_x338 = var_x37 * var_x39;
        const double var_x339 = var_x338 * var_x66 - var_x122 * (var_x119 * var_x338 - var_x120 * var_x338 - var_x58 * (var_x117 * var_x338 + var_x118 * var_x338)) - var_x30 * var_x338 - var_x335 * var_x36 - var_x338 * var_x42 - var_x338 * var_x43 - var_x338 * var_x52 - var_x338 * var_x64;
        const double var_x340 = var_x339 - var_x18 * var_x241 * (var_x337 - var_x242 * (-var_x337 - var_x298 * var_x336));
        const double var_x341 = var_x339 - var_x166 * var_x184;
        ...
        const double var_x350 = -var_x213 * log(NV_Ith_S(mParameters, 4) / NV_Ith_S(mParameters, 6)) + var_chaste_interface__membrane_potential__V_m;
        ...
        const double var_x358 = var_x349 - var_x351 - var_x352 + 0.11 * var_x354 - 4.9499999999999988e-9 * var_x357 - var_x311 * var_x356 - 0.00060293750000000007 * var_x350 * var_x83 / pow(var_x32, 2);
        const double var_x359 = (var_x154) && (((var_x154) || (var_x155)));
        ...
        const double var_x370 = var_x364 - var_x365 - var_x366 + 0.89000000000000001 * var_x367 - 4.0049999999999991e-8 * var_x369 - var_x327 * var_x368 - 0.0048783125000000007 * var_x109 * var_x350 / pow(var_x34, 2);
        ...
        const double var_x386 = pow(2.6000000000000001, var_x15) * NV_Ith_S(mParameters, 2);
        ...
        const double var_x401 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x406 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 14) - 0.0900900900900901 * var_chaste_interface__membrane_potential__V_m);
        const double var_x407 = 1.0 + var_x406;
        const double var_x408 = 0.01 * NV_Ith_S(mParameters, 13);
        const double var_x409 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * NV_Ith_S(mParameters, 14));
        const double var_x410 = 1.0 + var_x409;
        const double var_x411 = 1.0 - var_x408;
        const double var_x412 = var_x408 + var_x411 / pow(var_x410, 2);
        const double var_x413 = var_x412 - var_chaste_interface__I_Na__h;
        const double var_x414 = 1 / var_x407;
        const double var_x415 = var_x409 * var_x411 / pow(var_x410, 3);
        const double var_x416 = var_chaste_interface__membrane_potential__V_m >= -40.0;
        const double var_x417 = exp(0.34849999999999998 * var_chaste_interface__membrane_potential__V_m - 0.34849999999999998 * NV_Ith_S(mParameters, 14));
        const double var_x418 = exp(0.079000000000000001 * var_chaste_interface__membrane_potential__V_m - 0.079000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x419 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 14) - 0.14705882352941177 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x423 = 0.26917900403768508 * var_x415;
        const double var_x424 = var_x412 - var_chaste_interface__I_Na__j;
        const double var_x425 = exp(-3.2000000000000002 - var_x93 + 0.10000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x426 = 1.0 + var_x425;
        const double var_x427 = exp(0.057000000000000002 * var_chaste_interface__membrane_potential__V_m - 0.057000000000000002 * NV_Ith_S(mParameters, 14));
        const double var_x428 = var_x427 / var_x426;
        const double var_x429 = exp(0.24440000000000001 * var_chaste_interface__membrane_potential__V_m - 0.24440000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x430 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 14) - 0.043909999999999998 * var_chaste_interface__membrane_potential__V_m);
        const double var_x431 = -25428.0 * var_x429 - 6.9480000000000002e-6 * var_x430;
        const double var_x432 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane_potential__V_m - 0.311 * NV_Ith_S(mParameters, 14));
        const double var_x433 = 1.0 + var_x432;
        const double var_x434 = 1 / var_x433;
        const double var_x435 = var_x431 * var_x434;
        const double var_x436 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 14) - 0.13780000000000001 * var_chaste_interface__membrane_potential__V_m);
        const double var_x437 = 1.0 + var_x436;
        const double var_x438 = exp(0.01052 * NV_Ith_S(mParameters, 14) - 0.01052 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x455 = 0.20000000000000001 * var_chaste_interface__membrane_potential__V_m;
        const double var_x456 = exp(-2.0 - var_x455);
        const double var_x457 = 1.0 + var_x456;
        const double var_x458 = 1 / (230.0 * var_x446 + 3300.0 * var_x454);
        const double var_x459 = exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x467 = exp(1.4615384615384615 - 0.076923076923076927 * var_chaste_interface__membrane_potential__V_m);
        const double var_x468 = 1.0 + var_x467;
        const double var_x469 = 0.076923076923076927 * var_x467 / pow(var_x468, 2);
        const double var_x470 = 1 / var_x468;
        ...
        const double var_x475 = exp(3.8999999999999999 + var_x455);
        const double var_x476 = 1.0 + var_x475;
        const double var_x477 = 0.20000000000000001 * var_x475 / pow(var_x476, 2);
        const double var_x478 = 1 / var_x476;
        ...
        const double var_x483 = exp(9.9999999984371854e-8);
        const double var_x484 = (1.0 - var_x483) / (1.0 + var_x483);
        const double var_x485 = 47619047.626489595 * var_x484;
        const double var_x486 = exp(-9.9999999984371854e-8);
        const double var_x487 = (1.0 - var_x486) / (1.0 + var_x486);
        const double var_x488 = (5.0000005999999999 + var_chaste_interface__membrane_potential__V_m) * (var_x485 + 47619047.626489595 * var_x487);
        const double var_x489 = exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane_potential__V_m);
        const double var_x490 = 1.0 + var_x489;
        const double var_x491 = 1 / var_x490;
        const double var_x492 = -var_chaste_interface__I_Ca__d + var_x491;
        const double var_x493 = 1 / (-var_x485 + 833333.33346356789 * var_x488);
        const double var_x494 = 5.0 + var_chaste_interface__membrane_potential__V_m;
        const double var_x495 = fabs(var_x494) < 5.999999999062311e-7;
        const double var_x496 = 1.0 - var_x489;
        const double var_x497 = 1 / var_x496;
        const double var_x498 = var_x492 * var_x497;
        const double var_x499 = 0.035000000000000003 * var_x490;
        const double var_x500 = var_x494 * var_x497;
        const double var_x501 = 0.0058333333333333336 * var_x489;
        const double var_x502 = var_x494 * var_x501;
        ...
        const double var_x504 = exp(2.5 - var_x443);
        const double var_x505 = 1.0 + var_x504;
        const double var_x506 = exp(3.8888888888888888 + var_x447);
        ...
        const double var_x518 = var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x519 = var_x508 * var_x509 / pow(var_x510, 2);
        const double var_x520 = 2.3772197685794643 * var_x519;
        const double var_x521 = 0.21130842387373014 * var_x519 * var_x82 / pow((1 - 0.93333333333333335 * var_x511), 2);
        const double var_x522 = var_x521 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x523 = 20.0 * var_x515;
        const double var_x524 = var_x518 * var_x523;
        const double var_x525 = var_x520 * var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x526 = 7.5 - var_x512;
        const double var_x527 = 1.0 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        ...
        const double var_x544 = 18.571428571428569 * NV_Ith_S(mParameters, 0);
        const double var_x545 = var_chaste_interface__SR_Fluxes__Ry_Ro * NV_Ith_S(mParameters, 1);
        const double var_x546 = var_x545;
        const double var_x547 = 6.567e-5 + var_x312 + 0.33000000000000002 * var_x100 + 0.33000000000000002 * var_x91 + 0.077088000000000004 * var_x126;
        const double var_x548 = var_x379 * NV_Ith_S(mParameters, 3);
        const double var_x549 = var_x38 * NV_Ith_S(mParameters, 22);
        const double var_x550 = var_x548 * var_x549;
        const double var_x551 = 176588941779729.56 * var_x550;
        const double var_x552 = var_x45 * var_x550;
        const double var_x553 = 19424783595770.25 * var_x214;
        const double var_x554 = var_x223 * var_x550;
        ...
        const double var_x559 = 0.00053133 + var_x328 + 2.6699999999999999 * var_x114 + 2.6699999999999999 * var_x116 + 0.62371200000000004 * var_x129;
        const double var_x560 = 4759071980963.7119 * var_x550;
        const double var_x561 = 4235574063057.7031 * var_x219;
        ...
        const double var_x565 = 6.0643000000000002e-5 - 0.22 * var_x91 - 0.051392 * var_x126;
        const double var_x566 = 88294470889864.781 * var_x558;
        const double var_x567 = 1205.9369202226344 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x572 = 0.00049065700000000003 - 1.78 * var_x114 - 0.41580800000000001 * var_x129;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x156) ? (var_x131 + var_x151) : ((var_x154) ? (var_x131 + var_x187) : ((var_x155) ? (var_x151 + var_x211) : (var_x187 + var_x211)))));
        IJth(rJacobian, 2, 0) = 59.906641489902128 * (-var_chaste_interface__I_Na__m + 1 / pow(var_x402, 2)) * (-var_x403 * (-0.3792264410025028 - 0.0082818615637148471 * var_chaste_interface__membrane_potential__V_m) - var_x404 * (0.0036911829173615863 - 0.00076532923851577563 * var_chaste_interface__membrane_potential__V_m)) / pow((var_x400 + 0.5020897832817337 * var_x399), 2) + 0.22148394241417499 * var_x401 * var_x405 / pow(var_x402, 3);
        IJth(rJacobian, 3, 0) = ((var_x416) ? (-1.5943679469924423 * var_x414 * var_x415 + 0.53361053361053368 * var_x406 * var_x413 / pow(var_x407, 2)) : (var_x413 * (108035.0 * var_x417 + 0.21330000000000002 * var_x418 - 0.008382352941176471 * var_x419) - var_x423 * (var_x420 + var_x421 + var_x422)));
        IJth(rJacobian, 4, 0) = ((var_x416) ? (0.034200000000000001 * var_x424 * var_x428 - 0.16150740242261102 * var_x415 * var_x428 + 0.059999999999999998 * var_x424 * var_x425 * var_x427 / pow(var_x426, 2)) : (var_x424 * (var_x435 - 0.00025500480000000003 * var_x439 + var_x434 * var_x440 * (3.0508668000000001e-7 * var_x430 - 6214.6032000000005 * var_x429) + 0.0033402720000000005 * var_x436 * var_x438 / pow(var_x437, 2) - 0.311 * var_x431 * var_x432 * var_x440 / pow(var_x433, 2)) - var_x423 * (var_x441 + var_x442)));
        IJth(rJacobian, 5, 0) = 9.1827364554637282e-8 * (-var_chaste_interface__I_Kr__x_kr + 1 / var_x457) * (11.5 * var_x444 / pow(var_x445, 2) + 366.66666666666669 * var_x448 * var_x453 / pow(var_x449, 2) - 366.66666666666669 * var_x450 * var_x451 / pow(var_x452, 2)) / pow((var_x454 + 0.069696969696969702 * var_x446), 2) + 0.20000000000000001 * var_x456 * var_x458 / pow(var_x457, 2);
        IJth(rJacobian, 6, 0) = -7.1529673512819408e-5 * var_x461 * (-var_chaste_interface__I_Ks__x_ks + 1 / var_x460) + 0.070175438596491224 * var_x459 * (0.00100999899000101 + var_x462) / pow(var_x460, 2);
        IJth(rJacobian, 7, 0) = var_x466 * var_x469 + 0.0074074074074074077 * var_x463 * (var_x470 - var_chaste_interface__I_to__x_to_s) / (pow(var_x464, 2) * pow((0.055555555555555552 + var_x465), 2));
        IJth(rJacobian, 8, 0) = -var_x474 * var_x477 + 0.000125 * var_x471 * (var_x478 - var_chaste_interface__I_to__y_to_s) / (pow(var_x472, 2) * pow((0.037499999999999999 + var_x473), 2));
        IJth(rJacobian, 9, 0) = var_x469 * var_x480 - 0.11764705882352941 * var_x479 * (-0.035999999999999997 - 0.00080000000000000004 * var_chaste_interface__membrane_potential__V_m) * (var_x470 - var_chaste_interface__I_to__x_to_f) / pow((0.058823529411764705 + var_x479), 2);
        IJth(rJacobian, 10, 0) = -var_x477 * var_x482 - 0.011764705882352941 * var_x481 * (-0.36363636363636365 - 0.0090909090909090905 * var_chaste_interface__membrane_potential__V_m) * (var_x478 - var_chaste_interface__I_to__y_to_f) / pow((0.082352941176470587 + var_x481), 2);
        IJth(rJacobian, 11, 0) = ((var_x495) ? (4.4099999986215979e-16 * var_x492 * (-39682539694942.977 * var_x484 - 39682539694942.977 * var_x487) / pow((-var_x484 + 0.017500000000000002 * var_x488), 2) + 0.16666666666666666 * var_x489 * var_x493 / pow(var_x490, 2)) : (var_x498 * var_x499 - var_x498 * var_x502 + var_x491 * var_x500 * var_x501 - var_x490 * var_x492 * var_x502 / pow(var_x496, 2)));
        IJth(rJacobian, 12, 0) = (0.02 + var_x503) * (0.029999999999999999 * var_x504 / pow(var_x505, 2) - 0.1111111111111111 * var_x506 / pow(var_x507, 2)) + var_x503 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__membrane_potential__V_m) * (-var_chaste_interface__I_Ca__f + 1 / var_x507 + 0.59999999999999998 / var_x505);
        IJth(rJacobian, 33, 0) = -var_x551 * ((var_x155) ? (var_x547 - var_x139) : (var_x172 + var_x186 + var_x547 - var_x181));
        IJth(rJacobian, 34, 0) = -var_x560 * ((var_x155) ? (var_x559 - var_x150) : (var_x164 + var_x183 + var_x559 - var_x177));
        IJth(rJacobian, 37, 0) = -var_x566 * ((var_x154) ? (var_x565 - var_x21) : (var_x200 + var_x210 + var_x565 - var_x206));
        IJth(rJacobian, 38, 0) = -var_x573 * ((var_x154) ? (var_x572 - var_x27) : (var_x195 + var_x209 + var_x572 - var_x203));
        IJth(rJacobian, 1, 1) = -7.0788000000000011 + var_x372 + var_x373 + var_x374 + var_x375 + var_x376 + var_x377 + var_x378 - var_x380 + 3.4188518090540365e-8 * var_x390 - 270818.42237280885 * var_x388;
        IJth(rJacobian, 20, 1) = 2.2890000000000006 - var_x374;
        IJth(rJacobian, 21, 1) = 0.33180000000000004 - var_x375 - var_x376;
        IJth(rJacobian, 23, 1) = 0.81600000000000006 - var_x372;
        IJth(rJacobian, 24, 1) = 1.9320000000000004 - var_x377 - var_x378;
        IJth(rJacobian, 26, 1) = 1.71 - var_x373;
        IJth(rJacobian, 32, 1) = 5029484.9869235931 * var_x388 - 6.3492962168146398e-7 * var_x390;
        IJth(rJacobian, 38, 1) = 15.582629387269481 * var_x379;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.33000000000000002 * var_x217 - 2.6699999999999999 * var_x220);
        IJth(rJacobian, 2, 2) = -var_x405;
        IJth(rJacobian, 33, 2) = -58274350787310.75 * var_x217 * var_x550;
        IJth(rJacobian, 34, 2) = -12706722189173.109 * var_x220 * var_x550;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x221 * var_x45 - var_x222 * var_x45);
        IJth(rJacobian, 3, 3) = ((var_x416) ? (-5.9230769230769234 * var_x414) : (-var_x420 - var_x421 - var_x422));
        IJth(rJacobian, 33, 3) = -var_x552 * var_x553;
        IJth(rJacobian, 34, 3) = -var_x552 * var_x561;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x221 * var_x223 - var_x222 * var_x223);
        IJth(rJacobian, 4, 4) = ((var_x416) ? (-0.59999999999999998 * var_x428) : (-var_x441 - var_x442));
        IJth(rJacobian, 33, 4) = -var_x553 * var_x554;
        IJth(rJacobian, 34, 4) = -var_x554 * var_x561;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x121 * var_x51 * NV_Ith_S(mParameters, 17));
        IJth(rJacobian, 5, 5) = -var_x458;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0070000000000000001 * (-var_x213 * log(var_x224 * (0.018329999999999999 * NV_Ith_S(mParameters, 8) + NV_Ith_S(mParameters, 7))) + var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 18) * var_chaste_interface__I_Ks__x_ks);
        IJth(rJacobian, 6, 6) = -0.00100999899000101 - var_x462;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x225 * var_chaste_interface__I_to__y_to_s);
        IJth(rJacobian, 7, 7) = -var_x466;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x225 * var_chaste_interface__I_to__x_to_s);
        IJth(rJacobian, 8, 8) = -var_x474;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x226 * var_chaste_interface__I_to__y_to_f);
        IJth(rJacobian, 9, 9) = -var_x480;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x226 * var_chaste_interface__I_to__x_to_f);
        IJth(rJacobian, 10, 10) = -var_x482;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x156) ? (var_x237 + var_x247) : ((var_x154) ? (var_x237 + var_x254) : ((var_x155) ? (var_x247 + var_x259) : (var_x254 + var_x259)))));
        IJth(rJacobian, 11, 11) = ((var_x495) ? (-var_x493) : (-var_x499 * var_x500));
        IJth(rJacobian, 33, 11) = -var_x551 * ((var_x155) ? (var_x246) : (var_x253));
        IJth(rJacobian, 34, 11) = -var_x560 * ((var_x155) ? (var_x244) : (var_x251));
        IJth(rJacobian, 37, 11) = -var_x566 * ((var_x154) ? (var_x236) : (var_x258));
        IJth(rJacobian, 38, 11) = -var_x573 * ((var_x154) ? (var_x231) : (var_x257));
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x156) ? (var_x265 + var_x268) : ((var_x154) ? (var_x265 + var_x273) : ((var_x155) ? (var_x268 + var_x276) : (var_x273 + var_x276)))));
        IJth(rJacobian, 12, 12) = -0.02 - var_x503;
        IJth(rJacobian, 33, 12) = -var_x551 * ((var_x155) ? (var_x267) : (var_x272));
        IJth(rJacobian, 34, 12) = -var_x560 * ((var_x155) ? (var_x266) : (var_x271));
        IJth(rJacobian, 37, 12) = -var_x566 * ((var_x154) ? (var_x264) : (var_x275));
        IJth(rJacobian, 38, 12) = -var_x573 * ((var_x154) ? (var_x262) : (var_x274));
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x156) ? (var_x279 + var_x281) : ((var_x154) ? (var_x279 + var_x285) : ((var_x155) ? (var_x281 + var_x286) : (var_x285 + var_x286)))));
        IJth(rJacobian, 13, 13) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_Concentrations__Ca_j;
        IJth(rJacobian, 33, 13) = -var_x551 * ((var_x155) ? (-var_x280) : (-var_x283));
        IJth(rJacobian, 37, 13) = -var_x566 * ((var_x154) ? (-var_x279) : (-var_x286));
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x156) ? (var_x289 + var_x291) : ((var_x154) ? (var_x289 + var_x293) : ((var_x155) ? (var_x291 + var_x294) : (var_x293 + var_x294)))));
        IJth(rJacobian, 14, 14) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        IJth(rJacobian, 34, 14) = -var_x560 * ((var_x155) ? (-var_x290) : (-var_x292));
        IJth(rJacobian, 38, 14) = -var_x573 * ((var_x154) ? (-var_x289) : (-var_x294));
        IJth(rJacobian, 15, 15) = -0.0050000000000000001 + var_x514 + var_x517;
        IJth(rJacobian, 16, 15) = var_x516;
        IJth(rJacobian, 17, 15) = var_x517;
        IJth(rJacobian, 15, 16) = 0.055;
        IJth(rJacobian, 16, 16) = -0.059999999999999998 + var_x514;
        IJth(rJacobian, 17, 16) = var_x517 + var_x526 * var_chaste_interface__Ca_Concentrations__Ca_j;
        ...
        IJth(rJacobian, 17, 17) = -0.065000000000000002 + var_x517;
        IJth(rJacobian, 18, 18) = -0.001 - var_x528;
        IJth(rJacobian, 33, 18) = (0.001 + var_x528) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 19, 19) = -0.001 - var_x530;
        IJth(rJacobian, 34, 19) = (0.001 + var_x530) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 1, 20) = 0.019599999999999999 + var_x391;
        IJth(rJacobian, 20, 20) = -0.019599999999999999 - var_x391;
        IJth(rJacobian, 1, 21) = 0.003032 + var_x392;
        IJth(rJacobian, 21, 21) = -3.1999999999999999e-5 + var_x532;
        IJth(rJacobian, 22, 21) = -0.0030000000000000001;
        IJth(rJacobian, 1, 22) = 0.0063300000000000006 + var_x392;
        IJth(rJacobian, 21, 22) = var_x532;
        IJth(rJacobian, 22, 22) = -0.0063300000000000006;
        IJth(rJacobian, 1, 23) = 0.23799999999999999 + var_x393;
        IJth(rJacobian, 23, 23) = -0.23799999999999999 - var_x393;
        IJth(rJacobian, 1, 24) = 0.016159999999999997 + var_x394;
        IJth(rJacobian, 24, 24) = -0.00046000000000000001 + var_x533;
        IJth(rJacobian, 25, 24) = -0.015699999999999999;
        IJth(rJacobian, 1, 25) = 0.015757 + var_x394;
        IJth(rJacobian, 24, 25) = var_x533;
        IJth(rJacobian, 25, 25) = -0.015757;
        IJth(rJacobian, 1, 26) = 0.059999999999999998 + var_x395;
        IJth(rJacobian, 26, 26) = -0.059999999999999998 - var_x395;
        IJth(rJacobian, 27, 27) = -1.3 + var_x535;
        IJth(rJacobian, 37, 27) = 1.3 + var_x534;
        IJth(rJacobian, 28, 28) = -1.3 + var_x538;
        IJth(rJacobian, 38, 28) = 1.3 + var_x537;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x535;
        IJth(rJacobian, 37, 29) = 0.029999999999999999 + var_x534;
        IJth(rJacobian, 30, 30) = -0.029999999999999999 + var_x538;
        IJth(rJacobian, 38, 30) = 0.029999999999999999 + var_x537;
        IJth(rJacobian, 31, 31) = -65.0 - var_x542;
        IJth(rJacobian, 32, 31) = 65.0 + var_x542;
        IJth(rJacobian, 1, 32) = 0.037279237232671424 * var_x397 + 4.7061860318210743e-15 * var_x398;
        IJth(rJacobian, 15, 32) = -var_x522 + var_x518 * var_x520;
        IJth(rJacobian, 16, 32) = var_x522 + var_x525;
        IJth(rJacobian, 17, 32) = -var_x525 + var_x521 * var_x527;
        IJth(rJacobian, 31, 32) = 260.0 - var_x543;
        IJth(rJacobian, 32, 32) = -260.0 + var_x543 - var_x544 - var_x546 - 0.69232869146389786 * var_x397 - 8.7400597733819945e-14 * var_x398;
        IJth(rJacobian, 37, 32) = var_x567 + var_x568;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x156) ? (var_x317) : ((var_x154) ? (var_x319) : ((var_x155) ? (var_x317) : (var_x319)))));
        IJth(rJacobian, 18, 33) = 0.0007561 - var_x529;
        IJth(rJacobian, 33, 33) = (-0.0007561 + var_x529 - var_x555 - 176588941779729.56 * var_x558 * ((var_x155) ? (var_x300 + var_x557) : (var_x318 + var_x557))) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 34, 33) = 0.087152885187388451 * var_x548;
        IJth(rJacobian, 37, 33) = -var_x566 * (-0.66000000000000003 * var_x315 - var_x308 * var_x569);
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x156) ? (var_x332) : ((var_x154) ? (var_x334) : ((var_x155) ? (var_x332) : (var_x334)))));
        IJth(rJacobian, 19, 34) = 0.000165 - var_x531;
        IJth(rJacobian, 33, 34) = var_x555 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 34, 34) = (-0.000165 + var_x531 - 7.8853682331945256 * var_x379 - 4759071980963.7119 * var_x558 * ((var_x155) ? (var_x320 + var_x563) : (var_x333 + var_x563))) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 35, 34) = var_x564;
        IJth(rJacobian, 38, 34) = -var_x573 * (-5.3399999999999999 * var_x330 - var_x325 * var_x574);
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (-6.4154999999999998e-5 * var_x335 * var_x35);
        IJth(rJacobian, 34, 35) = 7.7982153480071377 * var_x548;
        IJth(rJacobian, 35, 35) = -var_x564;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x156) ? (var_x340) : ((var_x154) ? (var_x341) : ((var_x155) ? (var_x340) : (var_x341)))));
        IJth(rJacobian, 0, 37) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x359) ? (var_x358 - var_x345) : (var_x358 - var_x360)));
        IJth(rJacobian, 13, 37) = 1.7 - 1.7 * var_chaste_interface__I_Ca__f_Ca_Bj;
        IJth(rJacobian, 15, 37) = -var_x524 + var_x513 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        IJth(rJacobian, 16, 37) = var_x524 + var_x513 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        IJth(rJacobian, 17, 37) = var_x526 * var_chaste_interface__SR_Fluxes__Ry_Ro + var_x523 * var_x527 * var_chaste_interface__Ca_Concentrations__Ca_j;
        IJth(rJacobian, 27, 37) = 55.473098330241186 - var_x536;
        IJth(rJacobian, 29, 37) = 19.897959183673468 - var_x540;
        IJth(rJacobian, 32, 37) = var_x544 + var_x546;
        IJth(rJacobian, 33, 37) = -var_x551 * (1.4849999999999997e-8 * var_x357 - 0.33000000000000002 * var_x354 + var_x356 * var_x556);
        IJth(rJacobian, 37, 37) = -75.37105751391465 + var_x536 + var_x540 - var_x567 - var_x568 - var_x570 - var_x566 * ((var_x154) ? (var_x345 + var_x571) : (var_x360 + var_x571));
        IJth(rJacobian, 38, 37) = 3.9220939916716238 * var_x379;
        IJth(rJacobian, 0, 38) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x359) ? (var_x370 - var_x361) : (var_x370 - var_x371)));
        IJth(rJacobian, 1, 38) = var_x380;
        IJth(rJacobian, 14, 38) = 1.7 - 1.7 * var_chaste_interface__I_Ca__f_Ca_Bsl;
        IJth(rJacobian, 28, 38) = 121.55000000000001 - var_x539;
        IJth(rJacobian, 30, 38) = 43.550000000000004 - var_x541;
        IJth(rJacobian, 34, 38) = -var_x560 * (1.2014999999999997e-7 * var_x369 - 2.6699999999999999 * var_x367 + var_x368 * var_x562);
        IJth(rJacobian, 37, 38) = var_x570;
        IJth(rJacobian, 38, 38) = -165.10000000000002 + var_x539 + var_x541 - 19.504723378941105 * var_x379 - var_x573 * ((var_x154) ? (var_x361 + var_x575) : (var_x371 + var_x575));
    }
