...
const double var_x0 = 1 / NV_Ith_S(mParameters, 7);
        ...
        const double var_x67 = 3.2000000146581445e-7 * var_x59;
        ...
        IJth(rJacobian, 1, 0) = ((var_x63) ? (var_x61 + var_x57 * (0.15999999943156581 * var_x58 + 0.16000000056843419 * var_x59)) : (var_x61 + var_x57 * var_x66 - 0.032000000000000001 * var_x57 * var_x62 * var_x64 / pow(var_x65, 2)));
        ...
        IJth(rJacobian, 1, 1) = ((var_x63) ? (var_x67 + var_x68 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x67 + 3.1999999919207769e-7 * var_x58)) : (var_x68 - var_x62 * var_x66));
