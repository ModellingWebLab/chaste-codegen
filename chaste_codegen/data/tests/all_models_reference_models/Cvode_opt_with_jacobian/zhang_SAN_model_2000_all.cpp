...
class Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables()
    {
...
protected:
    Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables(const Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables&);
    Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables& operator= (const Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables&);
    Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables()
    {
        ...
        Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables> Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables::mpInstance;


    Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt::Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                15,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt>::Instance();
        Init();
    ...
    Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt::~Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt()
    {
    }

    AbstractLookupTableCollection* Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_four_AP_sensitive_currents_r_gate__r = 0.001 * _lt_0_row[10] * (-var_chaste_interface__four_AP_sensitive_currents_r_gate__r + _lt_0_row[9]); // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_slow_delayed_rectifying_potassium_current_xs_gate__xs = 0.014 * _lt_0_row[23] * (1.0 - var_chaste_interface__slow_delayed_rectifying_potassium_current_xs_gate__xs) - 0.001 * var_chaste_interface__slow_delayed_rectifying_potassium_current_xs_gate__xs * _lt_0_row[24]; // 1 / millisecond
        const double var_sodium_current_h_gate__h1_infinity = _lt_0_row[25]; // dimensionless
        const double d_dt_chaste_interface_var_sodium_current_h_gate__h1 = 0.001 * _lt_0_row[26] * (-var_chaste_interface__sodium_current_h_gate__h1 + var_sodium_current_h_gate__h1_infinity); // 1 / millisecond
        const double d_dt_chaste_interface_var_sodium_current_h_gate__h2 = 0.001 * _lt_0_row[27] * (-var_chaste_interface__sodium_current_h_gate__h2 + var_sodium_current_h_gate__h1_infinity); // 1 / millisecond
        const double d_dt_chaste_interface_var_sodium_current_m_gate__m = 0.001 * _lt_0_row[29] * (-var_chaste_interface__sodium_current_m_gate__m + _lt_0_row[28]); // 1 / millisecond
    ...
    void Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -39.013558536
        double var_chaste_interface__sodium_current_m_gate__m = NV_Ith_S(rY, 1);
...
const double var_x0 = 0.018714999999999999 * var_chaste_interface__membrane__V;
    ...
    N_Vector Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellzhang_SAN_model_2000_allFromCellMLCvodeOpt)
