...
const double var_x0 = 1 / NV_Ith_S(mParameters, 3);
        ...
        const double var_x169 = 0.1859773107680863 * var_x155 / pow(var_x156, 2);
        ...
        const double var_x177 = var_x176 - 0.0013333333333333333 * var_x170 * var_x174 / pow(var_x175, 2);
        ...
        const double var_x191 = 5.0000000000000004e-6 * var_x189 + 5.0000000000000004e-6 * var_x190;
        ...
        IJth(rJacobian, 2, 0) = ((var_x94) ? (var_x92 + var_x88 * (0.15999999943156581 * var_x89 + 0.16000000056843419 * var_x90)) : (var_x92 + var_x88 * var_x98 - 0.032000000000000001 * var_x88 * var_x93 * var_x96 / pow(var_x97, 2)));
        ...
        IJth(rJacobian, 9, 0) = ((var_x171) ? (var_x157 * (var_x164 + 0.014 * var_x158 + 0.014 * var_x159) + var_x169 * (var_x165 + var_x166 - var_x168)) : ((var_x181) ? (var_x157 * (var_x177 + 0.02 * var_x172 + 0.02 * var_x173) + var_x169 * (var_x179 + var_x180 - var_x178)) : (var_x157 * (var_x164 + var_x177) + var_x169 * (var_x166 + var_x179))));
        IJth(rJacobian, 10, 0) = ((var_x201) ? (var_x186 * (var_x191 + 0.00011500000061903345 * var_x187 + 0.00011499999938096656 * var_x188) + var_x198 * (var_x192 + var_x197 - var_x194)) : ((var_x207) ? (var_x186 * (var_x191 + var_x205) + var_x198 * (var_x197 + var_x206)) : (var_x186 * (var_x205 + var_x210 - 8.6956521739130438e-8 * var_x199 * var_x208 / pow(var_x209, 2)) + var_x198 * (var_x206 + var_x211))));
        IJth(rJacobian, 11, 0) = ((var_x226) ? (0.16666666666666666 * var_x223 * var_x224 + 4.7698560017679535e-16 * var_x222 * (-36688738598216.805 * var_x215 - 36688738598216.805 * var_x218) / pow((-var_x215 + 0.017500000000000002 * var_x219), 2)) : (var_x230 * var_x232 - var_x230 * var_x233 + 0.0058333333333333336 * var_x224 * var_x231 * var_x234 - var_x222 * var_x231 * var_x233 / pow(var_x228, 2)));
        ...
        IJth(rJacobian, 2, 2) = ((var_x94) ? (var_x100 + var_x99 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x99 + 3.1999999919207769e-7 * var_x89)) : (var_x100 - var_x93 * var_x98));
        ...
        IJth(rJacobian, 9, 9) = ((var_x171) ? (var_x167 + var_x168 + var_x182) : ((var_x181) ? (var_x178 + var_x183 - var_x180) : (var_x182 + var_x183)));
        ...
        IJth(rJacobian, 10, 10) = ((var_x201) ? (var_x193 + var_x194 + var_x212) : ((var_x207) ? (var_x212 + var_x213) : (var_x213 - var_x211)));
