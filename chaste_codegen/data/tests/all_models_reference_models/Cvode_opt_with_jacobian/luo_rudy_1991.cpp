        ...
        if (mNeedsRegeneration[0])
        {
            ...
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return (((var_chaste_interface__membrane__V > -77.000002499999994) && (var_chaste_interface__membrane__V < -76.999997500000006)) ? ((-1134800.0028650947 + 1134800.0028650947 * exp(9.9999999747524276e-8) - 199999.99993651727 * (76.999997500000006 + var_chaste_interface__membrane__V) * (2269599.9992795982 - 1134799.9964145035 * exp(-1.0000000031595847e-7) - 1134800.0028650947 * exp(9.9999999747524276e-8))) / exp(1.4000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V)) : ((var_chaste_interface__membrane__V > -100.0) ? (2.8370000000000002 * (-1.0 + exp(3.0800000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V)) / ((77.0 + var_chaste_interface__membrane__V) * exp(1.4000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V))) : (1.0)));
                };
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1.0 + exp(0.35999999999999999 - 0.071999999999999995 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-0.748 - 0.017000000000000001 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1.0 + exp(4.2000000000000002 + 0.14999999999999999 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(4.1500000000000004 + 0.083000000000000004 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellluo_rudy_1991FromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
const double var_x0 = exp(9.9999999747524276e-8);
        const double var_x1 = 1134800.0028650947 * var_x0;
        const double var_x2 = exp(-1.0000000031595847e-7);
        const double var_x3 = -1134800.0028650947 + var_x1 - 199999.99993651727 * (76.999997500000006 + var_chaste_interface__membrane__V) * (2269599.9992795982 - var_x1 - 1134799.9964145035 * var_x2);
        ...
        const double var_x6 = sqrt(NV_Ith_S(mParameters, 2));
        const double var_x7 = var_x6 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x11 = -26.712449447891164 * log((0.018329999999999999 * NV_Ith_S(mParameters, 3) + NV_Ith_S(mParameters, 2)) / (0.018329999999999999 * NV_Ith_S(mParameters, 1) + NV_Ith_S(mParameters, 0))) + var_chaste_interface__membrane__V;
        ...
        const double var_x17 = NV_Ith_S(mParameters, 4) * var_chaste_interface__slow_inward_current_f_gate__f;
        ...
        const double var_x20 = var_x19 * NV_Ith_S(mParameters, 7) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x21 = log(NV_Ith_S(mParameters, 2) / NV_Ith_S(mParameters, 0));
        ...
        const double var_x34 = var_x25 * var_x6 * NV_Ith_S(mParameters, 10);
        const double var_x35 = var_x23 / pow(var_x24, 2);
        const double var_x36 = var_x18 + var_x20 * var_chaste_interface__fast_sodium_current_h_gate__h + NV_Ith_S(mParameters, 12) / var_x16 + 0.4389381125701739 * var_x33 * var_x34 + 0.42189361069797565 * var_x22 * var_x34 * (0.24326999999999999 * var_x35 - var_x28 * (0.061749999999999999 * var_x29 + 0.039456396800000001 * var_x30) - 0.51429999999999998 * var_x26 * var_x31 / pow(var_x27, 2)) / pow((var_x25 + 0.98039215686274506 * var_x32), 2) + 0.16722408026755853 * var_x15 * var_x22 * NV_Ith_S(mParameters, 12) / pow(var_x16, 2) - 0.10468673984798647 * var_x22 * var_x33 * var_x35 * var_x6 * NV_Ith_S(mParameters, 10) + NV_Ith_S(mParameters, 11);
        const double var_x37 = 1 / NV_Ith_S(mParameters, 5);
        ...
        const double var_x48 = -26.712449447891164 * log(NV_Ith_S(mParameters, 3) / NV_Ith_S(mParameters, 1)) + var_chaste_interface__membrane__V;
        const double var_x49 = NV_Ith_S(mParameters, 7) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x50 = var_x38 * var_x48;
        const double var_x51 = log(var_chaste_interface__intracellular_calcium_concentration__Cai);
        const double var_x52 = var_x38 * (-7.7000000000000002 + 13.028700000000001 * var_x51 + var_chaste_interface__membrane__V);
        const double var_x53 = NV_Ith_S(mParameters, 4) * var_chaste_interface__slow_inward_current_d_gate__d;
        const double var_x54 = var_x11 * var_x37;
        const double var_x55 = var_x54 * var_x8;
        const double var_x56 = 0.00077000000000000007 - 0.0001 * var_chaste_interface__membrane__V - 0.00130287 * var_x51;
        const double var_x57 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x58 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x59 = 1 / (1.0 - exp(1.0000000045806701e-7));
        const double var_x60 = _lt_0_row[3];
        const double var_x61 = 0.0072727272727272727 * var_x60 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x62 = 47.130000000000003 + var_chaste_interface__membrane__V;
        const double var_x63 = fabs(var_x62) < 1.0000000010279564e-6;
        ...
        const double var_x68 = 3.2000000146581445e-7 * var_x59;
        const double var_x69 = -0.080000000000000002 * var_x60;
        const double var_x70 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 9) - 0.14705882352941177 * var_chaste_interface__membrane__V);
        ...
        const double var_x74 = exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * NV_Ith_S(mParameters, 9));
        const double var_x75 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 9));
        const double var_x76 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 9) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        ...
        const double var_x80 = ((var_x71) ? (-0.019852941176470591 * var_x70) : (0));
        const double var_x81 = var_x72 + var_x78;
        const double var_x82 = 0.01 * NV_Ith_S(mParameters, 8);
        const double var_x83 = 1.0 - var_x82;
        const double var_x84 = var_x83 / var_x81;
        const double var_x85 = ((var_x71) ? (0.28123999999999999 * var_x75 + 108500.0 * var_x74) : (0.693000693000693 * var_x76 / pow(var_x77, 2)));
        const double var_x86 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 9) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x87 = 1.0 + var_x86;
        const double var_x88 = exp(0.01052 * NV_Ith_S(mParameters, 9) - 0.01052 * var_chaste_interface__membrane__V);
        const double var_x89 = var_x88 / var_x87;
        const double var_x90 = exp(-3.2000000000000002 + var_x64 + 0.10000000000000001 * NV_Ith_S(mParameters, 9));
        const double var_x91 = 1.0 + var_x90;
        const double var_x92 = exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 9) - 2.5349999999999999e-7 * var_chaste_interface__membrane__V);
        ...
        const double var_x97 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 9));
        const double var_x98 = 1.0 + var_x97;
        const double var_x99 = 1 / var_x98;
        const double var_x100 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 9));
        const double var_x101 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 9) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        ...
        const double var_x106 = ((var_x71) ? (var_x103 + var_x96 * var_x99 * (1.5254334000000001e-6 * var_x101 - 31073.016 * var_x100) - 0.311 * var_x102 * var_x96 * var_x97 / pow(var_x98, 2)) : (0));
        const double var_x107 = var_x104 + var_x94;
        const double var_x108 = var_x83 / var_x107;
        const double var_x109 = ((var_x71) ? (-0.001275024 * var_x89 + 0.016701360000000002 * var_x86 * var_x88 / pow(var_x87, 2)) : (-7.6049999999999996e-8 * var_x93 + 0.029999999999999999 * var_x90 * var_x92 / pow(var_x91, 2)));
        ...
        const double var_x114 = 1.0 - var_chaste_interface__slow_inward_current_d_gate__d;
        ...
        const double var_x123 = 1.0 - var_chaste_interface__slow_inward_current_f_gate__f;
        ...
        const double var_x132 = 1.0 - var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x39) ? (-var_x38 * (var_x36 + var_x10 * var_x3 - 0.017213259316477408 * var_x12 * var_x14 + var_x10 * var_x11 * (-453919999711.83923 + 226960000500.97873 * var_x0 + 226959999210.8605 * var_x2))) : ((var_x46) ? (-var_x38 * (var_x36 + var_x13 * var_x44 - var_x43 * var_x45 + var_x40 * var_x42 * var_x45 - 0.00020591169118251986 * var_x14 * var_x41 * var_x5 / pow((1 + 0.012987012987012988 * var_chaste_interface__membrane__V), 2))) : (-var_x38 * (var_x36 + var_x9)))));
        IJth(rJacobian, 1, 0) = -0.0001 * var_x18;
        IJth(rJacobian, 2, 0) = ((var_x63) ? (var_x61 + var_x57 * (0.15999999943156581 * var_x58 + 0.16000000056843419 * var_x59)) : (var_x61 + var_x57 * var_x67 - 0.032000000000000001 * var_x57 * var_x62 * var_x65 / pow(var_x66, 2)));
        IJth(rJacobian, 3, 0) = (var_x73 + var_x79) * (var_x80 * var_x84 + var_x72 * var_x83 * (-var_x80 - var_x85) / pow(var_x81, 2)) + (var_x80 + var_x85) * (var_x82 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x72 * var_x84);
        IJth(rJacobian, 4, 0) = (var_x105 + var_x95) * (var_x106 * var_x108 + var_x104 * var_x83 * (-var_x106 - var_x109) / pow(var_x107, 2)) + (var_x106 + var_x109) * (var_x82 - var_chaste_interface__fast_sodium_current_j_gate__j + var_x104 * var_x108);
        IJth(rJacobian, 5, 0) = 0.0011900000000000003 * var_x113 * var_chaste_interface__slow_inward_current_d_gate__d - 0.00095 * var_x114 * var_x118 + 0.0068399999999999997 * var_x114 * var_x115 * var_x117 / pow(var_x116, 2) + 0.0035000000000000005 * var_x110 * var_x112 * var_chaste_interface__slow_inward_current_d_gate__d / pow(var_x111, 2);
        IJth(rJacobian, 6, 0) = 0.00012999999999999999 * var_x122 * var_chaste_interface__slow_inward_current_f_gate__f - 9.6000000000000002e-5 * var_x123 * var_x127 - 0.0018 * var_x123 * var_x124 * var_x126 / pow(var_x125, 2) - 0.0012999999999999999 * var_x119 * var_x121 * var_chaste_interface__slow_inward_current_f_gate__f / pow(var_x120, 2);
        IJth(rJacobian, 7, 0) = 7.7999999999999999e-5 * var_x131 * var_chaste_interface__time_dependent_potassium_current_X_gate__X + 4.1500000000000006e-5 * var_x132 * var_x136 - 5.1999999999999997e-5 * var_x128 * var_x130 * var_chaste_interface__time_dependent_potassium_current_X_gate__X / pow(var_x129, 2) - 2.8500000000000002e-5 * var_x132 * var_x133 * var_x135 / pow(var_x134, 2);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-13.028700000000001 * var_x37 * var_x47);
        IJth(rJacobian, 1, 1) = -0.070000000000000007 - 0.00130287 * var_x47;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x37 * var_x48 * var_x49 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j);
        IJth(rJacobian, 2, 2) = ((var_x63) ? (var_x68 + var_x69 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x68 + 3.1999999919207769e-7 * var_x58)) : (var_x69 - var_x62 * var_x67));
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x20 * var_x50);
        IJth(rJacobian, 3, 3) = -var_x73 - var_x79;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x19 * var_x49 * var_x50);
        IJth(rJacobian, 4, 4) = -var_x105 - var_x95;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x52);
        IJth(rJacobian, 1, 5) = var_x17 * var_x56;
        IJth(rJacobian, 5, 5) = -0.070000000000000007 * var_x113 - 0.095000000000000001 * var_x118;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x52 * var_x53);
        IJth(rJacobian, 1, 6) = var_x53 * var_x56;
        IJth(rJacobian, 6, 6) = -0.012 * var_x127 - 0.0064999999999999997 * var_x122;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x39) ? (-var_x12 * var_x55) : ((var_x46) ? (-var_x44 * var_x54 * var_x7) : (-var_x55))));
        IJth(rJacobian, 7, 7) = -0.00050000000000000001 * var_x136 - 0.0012999999999999999 * var_x131;
    }
...
// LCOV_EXCL_STOP
        ...
        const double var_time_dependent_potassium_current_Xi_gate__temp_Xi = ((fabs(77.0 + var_chaste_interface__membrane__V) < 2.5000000007935341e-6) ? (-1134800.0028650947 + 1134800.0028650947 * exp(9.9999999747524276e-8) - 199999.99993651727 * (76.999997500000006 + var_chaste_interface__membrane__V) * (2269599.9992795982 - 1134799.9964145035 * exp(-1.0000000031595847e-7) - 1134800.0028650947 * exp(9.9999999747524276e-8))) : (2.8370000000000002 * (-1.0 + exp(3.0800000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V)) / (77.0 + var_chaste_interface__membrane__V))); // dimensionless
