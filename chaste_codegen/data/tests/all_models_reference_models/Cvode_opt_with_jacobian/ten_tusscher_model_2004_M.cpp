...
const double var_x0 = exp(9.9999999999999995e-8);
        ...
        const double var_x273 = var_x272 * (-0.0082319999999999997 - var_x142);
        ...
        const double var_x278 = NV_Ith_S(mParameters, 12) * NV_Ith_S(mParameters, 3);
        const double var_x279 = 0.00063181349969740233 * var_x278;
        const double var_x280 = var_x279 * var_x31 * var_x98;
        const double var_x281 = 2.7188924024856265e-5 * var_x72;
        const double var_x282 = 0.00027188924024856262 * var_x278;
        const double var_x283 = var_x279 * var_x52;
        ...
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x266 * var_x269 / pow(var_x267, 2) - 0.10526315789473684 * var_x268 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x267) / pow((0.084210526315789472 + var_x268), 2);
        IJth(rJacobian, 15, 0) = var_x278 * (-0.0018954404990922068 * var_x63 - 0.0018954404990922068 * var_x79 - 4.6119913257618111e-6 * var_x68 - 0.00063181349969740233 * var_x116 - 0.00063181349969740233 * NV_Ith_S(mParameters, 10));
        IJth(rJacobian, 16, 0) = var_x278 * (0.0012636269993948047 * var_x79 + 1.631335441491376e-6 * var_x66 - 0.00027188924024856262 * var_x123 - 2.7188924024856265e-5 * var_x50 - 0.00010565443138752546 * var_x53 - 0.00063181349969740233 * var_x26 - 0.00063181349969740233 * var_x27 - 0.00063181349969740233 * var_x29 - var_x281 * var_x70);
        ...
        IJth(rJacobian, 13, 1) = var_x272 * (var_x134 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 14, 1) = ((var_x277) ? (0) : ((var_x275) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5) / pow((1.8382656249999998e-21 + var_x274), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15) / pow((5.0709427749024951e-56 + var_x276), 2))));
        IJth(rJacobian, 15, 1) = 0.0047386012477305169 * var_x278 * var_x91;
        ...
        IJth(rJacobian, 16, 4) = -0.0012636269993948047 * var_x278 * var_x94;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x97);
        IJth(rJacobian, 5, 5) = -var_x191;
        IJth(rJacobian, 15, 5) = -0.0018954404990922068 * var_x278 * var_x97;
        ...
        IJth(rJacobian, 15, 6) = -var_x280 * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        IJth(rJacobian, 15, 7) = -var_x280 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        IJth(rJacobian, 13, 8) = var_x273 * var_chaste_interface__calcium_dynamics__g;
        ...
        IJth(rJacobian, 12, 12) = -var_x269;
        IJth(rJacobian, 16, 12) = -var_x283 * NV_Ith_S(mParameters, 22) * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 13) = var_x131 * (var_x149 * (var_x148 - var_x147) + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 13, 13) = var_x272 * (var_x132 + var_x149 * (var_x147 - var_x148)) + 9.9963436928702016 * (var_x136 - var_x135 - var_x145) / (pow(var_x270, 3) * pow((0.33333333333333337 + var_x271), 2));
        IJth(rJacobian, 1, 14) = var_x131 * var_x143 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 13, 14) = var_x273 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 14, 14) = ((var_x277) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 15, 15) = var_x278 * (1.1846503119326294e-6 * var_x118 - 0.0018954404990922068 * var_x115 - 0.016878114612481093 * var_x112 - 0.016878114612481093 * var_x117 - 0.0056863214972766203 * var_x119);
        IJth(rJacobian, 16, 15) = var_x278 * (0.0012636269993948047 * var_x115 - 0.00050634343837443281 * var_x113 - 7.8976687462175284e-7 * var_x118);
        ...
        IJth(rJacobian, 16, 16) = var_x278 * (4.357910453967955e-5 * var_x127 - 0.016878114612481093 * var_x113 - 0.016878114612481093 * var_x120 - 0.016878114612481093 * var_x121 - 0.00072631840899465921 * var_x122 - 0.0072631840899465916 * var_x124 - var_x126 * var_x281);
    }
