...
const double var_x0 = exp(1.0000000000609274e-7);
        ...
        const double var_x192 = exp(-7.5 + var_x187 + 0.10000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x193 = 1 / (1.0 + 320.0 * var_x192);
        const double var_x194 = 2.0 * var_x193;
        const double var_x195 = exp(-9.375 + 0.125 * NV_Ith_S(mParameters, 11) - 0.125 * var_chaste_interface__membrane__V);
        const double var_x196 = 0.02 * var_x195;
        const double var_x197 = 2.5 * var_x195;
        const double var_x198 = 20.0 * var_x195;
        const double var_x199 = 0.01 * NV_Ith_S(mParameters, 10);
        const double var_x200 = 1.0 - var_x199;
        const double var_x201 = var_x200 / (var_x198 + 2000.0 * var_x193);
        const double var_x202 = var_x192 / pow((0.0031250000000000002 + var_x192), 2);
        ...
        const double var_x207 = (-0.0060000000000000001 * var_x205 - 0.0060000000000000001 * var_x206) * var_chaste_interface__second_inward_calcium_current_d_gate__d;
        ...
        const double var_x211 = 1.0 - var_chaste_interface__second_inward_calcium_current_d_gate__d;
        ...
        const double var_x217 = var_x211 * var_x216 - 0.0074999999999999997 * var_x208 * var_x211 * var_x214 / pow(var_x215, 2);
        ...
        const double var_x229 = 120.0 * var_x5;
        const double var_x230 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x231 = 0.012 / var_x228;
        const double var_x232 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x233 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x234 = NV_Ith_S(mParameters, 2) + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x237 = var_x236 / pow(var_x234, 3);
        const double var_x238 = pow(var_x234, (-2));
        const double var_x239 = var_x238 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x240 = var_x239 - var_x237;
        const double var_x241 = -0.59999999999999998 * var_x233;
        const double var_x242 = 0.5 * var_x235 * var_x238;
        const double var_x243 = 1.3149909014756744e-5 * NV_Ith_S(mParameters, 4);
        const double var_x244 = 8.0543192715385049e-10 * var_x112;
        const double var_x245 = 8.054319271538504e-6 * NV_Ith_S(mParameters, 4);
        const double var_x246 = 0.002 * NV_Ith_S(mParameters, 1);
        ...
        IJth(rJacobian, 3, 0) = (var_x194 + var_x196) * (-var_x197 * var_x201 + 5.0000000000000004e-6 * var_x195 * var_x200 * (var_x197 - 0.625 * var_x202) / pow((var_x193 + 0.01 * var_x195), 2)) + (0.00062500000000000001 * var_x202 - 0.0025000000000000001 * var_x195) * (var_x199 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x198 * var_x201);
        IJth(rJacobian, 4, 0) = ((var_x210) ? (var_x207 + (0.001 - 0.001 * var_chaste_interface__second_inward_calcium_current_d_gate__d) * (15.0 * var_x203 + 15.0 * var_x204)) : ((var_x218) ? (var_x207 + var_x217) : (var_x217 - var_x221 * var_chaste_interface__second_inward_calcium_current_d_gate__d + 0.0011999999999999999 * var_x208 * var_x219 * var_chaste_interface__second_inward_calcium_current_d_gate__d / pow(var_x220, 2))));
        IJth(rJacobian, 5, 0) = -var_x226 * var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca + 0.0030000000000000001 * var_x227 * (var_x10 + var_x229 * var_x8) / pow(var_x228, 2) + 0.0015625000000000001 * var_x224 * var_x230 * var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca / pow(var_x225, 2);
        IJth(rJacobian, 6, 0) = 0.048000000000000001 * var_x232 * var_x233;
        ...
        IJth(rJacobian, 5, 1) = var_x231 * (var_x86 + var_x229 * var_x7 - var_x229 * var_x85);
        IJth(rJacobian, 6, 1) = var_x232 * var_x240 + (var_x237 - var_x239) * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 7, 1) = var_x240 * var_chaste_interface__calcium_release__ActFrac;
        ...
        IJth(rJacobian, 9, 1) = (8.054319271538504e-6 * var_x111 + 5.5574802973615678e-8 * var_x110 - 8.054319271538504e-6 * var_x107 - 5.3790289324163455e-7 * var_x108 + var_x244 * var_x60) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 10, 1) = -var_x243 * var_x96;
        ...
        IJth(rJacobian, 2, 2) = ((var_x185) ? (var_x191 + 2.0000000091613402e-7 * var_x181 - 499.99999948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (0.00019999999949504854 * var_x180 + 0.00020000000091613401 * var_x181)) : (var_x191 - var_x184 * var_x190));
        ...
        IJth(rJacobian, 3, 3) = -var_x194 - var_x196;
        IJth(rJacobian, 8, 3) = -var_x117 * var_x243;
        ...
        IJth(rJacobian, 4, 4) = ((var_x210) ? (var_x222 + 1.2000000033651759e-8 * var_x203 - 1249.9999964946085 * (19.000000400000001 + var_chaste_interface__membrane__V) * (1.2000000033651759e-5 * var_x203 + 1.2000000033651759e-5 * var_x204)) : ((var_x218) ? (var_x222 + var_x223) : (var_x223 - var_x208 * var_x221)));
        IJth(rJacobian, 8, 4) = -var_x122 * var_x243;
        IJth(rJacobian, 9, 4) = -var_x127 * var_x245;
        IJth(rJacobian, 10, 4) = -var_x125 * var_x243;
        ...
        IJth(rJacobian, 5, 5) = var_x231 * (-1.0 - 119.0 * var_x8) - var_x226 * var_x230;
        IJth(rJacobian, 8, 5) = -var_x134 * var_x243;
        IJth(rJacobian, 9, 5) = -var_x140 * var_x245;
        IJth(rJacobian, 10, 5) = -var_x137 * var_x243;
        IJth(rJacobian, 1, 6) = (var_x171 * var_x174 - var_x171 * var_x176) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 6, 6) = -0.059999999999999998 + var_x241 - var_x236 * var_x238;
        IJth(rJacobian, 7, 6) = 0.059999999999999998 + var_x242;
        IJth(rJacobian, 12, 6) = (var_x176 * var_x246 - var_x174 * var_x246) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 6, 7) = var_x241 - var_x242;
        ...
        IJth(rJacobian, 9, 9) = (-4.9999999999999998e-7 + 5.3790289324163455e-7 * var_x156 - 8.054319271538504e-6 * var_x155 - 8.054319271538504e-6 * var_x157 + var_x244 * var_x64) * NV_Ith_S(mParameters, 4);
        ...
        IJth(rJacobian, 13, 13) = -0.050000000000000003 + var_x247;
        IJth(rJacobian, 1, 14) = 0.20000000000000001 + var_x179;
        IJth(rJacobian, 14, 14) = -0.20000000000000001 + var_x247;
    }
