...
const double var_x0 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * NV_Ith_S(mParameters, 11);
        ...
        const double var_x152 = _lt_0_row[16];
        ...
        const double var_x157 = _lt_0_row[14];
        ...
        const double var_x161 = _lt_0_row[12];
        const double var_x162 = 0.44800000000000001 * var_x161 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x163 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x164 = fabs(var_x163) < 1.0000000010279564e-6;
        const double var_x165 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x169 = 0.20000000000000001 / var_x168;
        const double var_x170 = -8.0 * var_x161;
        const double var_x171 = exp(-7.5 + var_x166 + 0.10000000000000001 * NV_Ith_S(mParameters, 13));
        const double var_x172 = 1 / (1.0 + 320.0 * var_x171);
        const double var_x173 = 2.0 * var_x172;
        const double var_x174 = -0.125 * var_chaste_interface__membrane__V;
        const double var_x175 = exp(-9.375 + var_x174 + 0.125 * NV_Ith_S(mParameters, 13));
        const double var_x176 = 0.02 * var_x175;
        const double var_x177 = 2.5 * var_x175;
        const double var_x178 = 20.0 * var_x175;
        const double var_x179 = 0.01 * NV_Ith_S(mParameters, 12);
        const double var_x180 = 1.0 - var_x179;
        const double var_x181 = var_x180 / (var_x178 + 2000.0 * var_x172);
        const double var_x182 = var_x171 / pow((0.0031250000000000002 + var_x171), 2);
        const double var_x183 = 1 / (1.0 - exp(1.0000000028043132e-7));
        const double var_x184 = 1 / (1.0 - exp(-1.0000000028043132e-7));
        const double var_x185 = 1 / (-1.0 + exp(1.0000000010279564e-7));
        const double var_x186 = 1 / (-1.0 + exp(-1.0000000010279564e-7));
        const double var_x187 = (-0.017999999999999999 * var_x185 - 0.017999999999999999 * var_x186) * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x188 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x189 = fabs(var_x188);
        const double var_x190 = var_x189 < 4.0000000112172529e-7;
        const double var_x191 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x196 = 0.089999999999999997 / var_x195;
        const double var_x197 = var_x191 * var_x196 - 0.022499999999999999 * var_x188 * var_x191 * var_x194 / pow(var_x195, 2);
        const double var_x198 = var_x189 < 1.0000000010279564e-6;
        const double var_x199 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x200 = -1.0 + var_x199;
        const double var_x201 = 0.035999999999999997 / var_x200;
        const double var_x202 = -3.6000000037006431e-8 * var_x185 + 1499.9999984580654 * (18.999998999999999 + var_chaste_interface__membrane__V) * (-1.2000000012335477e-5 * var_x185 - 1.2000000012335477e-5 * var_x186);
        const double var_x203 = -var_x188 * var_x196;
        const double var_x204 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x205 = exp(8.5 + var_x192);
        const double var_x206 = -1.0 + var_x205;
        const double var_x207 = 0.0031250000000000002 / var_x206;
        const double var_x208 = exp(-8.5 + var_x193);
        const double var_x209 = 1.0 + var_x208;
        const double var_x210 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x211 = _lt_0_row[18];
        const double var_x212 = exp(-1.25 + var_x174);
        const double var_x213 = 1.0 + var_x212;
        const double var_x214 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x215 = NV_Ith_S(mParameters, 2) + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x216 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2);
        const double var_x217 = var_x216;
        const double var_x218 = var_x217 / pow(var_x215, 3);
        const double var_x219 = pow(var_x215, (-2));
        const double var_x220 = var_x219 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x221 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x222 = 0.5 * var_x216 * var_x219;
        const double var_x223 = 0.00063182746016849224 * NV_Ith_S(mParameters, 4);
        const double var_x224 = var_x116 * var_x223;
        const double var_x225 = 0.002 * NV_Ith_S(mParameters, 1);
        const double var_x226 = -var_x149;
        ...
        IJth(rJacobian, 3, 0) = ((var_x164) ? (var_x162 + (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * (99.999999644728632 * var_x159 + 100.00000035527137 * var_x160)) : (var_x162 + var_x165 * var_x169 - 0.02 * var_x163 * var_x165 * var_x167 / pow(var_x168, 2)));
        IJth(rJacobian, 4, 0) = (var_x173 + var_x176) * (-var_x177 * var_x181 + 5.0000000000000004e-6 * var_x175 * var_x180 * (var_x177 - 0.625 * var_x182) / pow((var_x172 + 0.01 * var_x175), 2)) + (0.00062500000000000001 * var_x182 - 0.0025000000000000001 * var_x175) * (var_x179 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x178 * var_x181);
        IJth(rJacobian, 5, 0) = ((var_x190) ? (var_x187 + (0.0030000000000000001 - 0.0030000000000000001 * var_chaste_interface__L_type_Ca_channel_d_gate__d) * (15.0 * var_x183 + 15.0 * var_x184)) : ((var_x198) ? (var_x187 + var_x197) : (var_x197 - var_x201 * var_chaste_interface__L_type_Ca_channel_d_gate__d + 0.0035999999999999999 * var_x188 * var_x199 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x200, 2))));
        IJth(rJacobian, 6, 0) = var_x204 * var_x207 - 0.0062500000000000003 * var_x208 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x209, 2) - 0.00078125000000000004 * var_x204 * var_x205 * var_x210 / pow(var_x206, 2);
        IJth(rJacobian, 7, 0) = -0.058823529411764705 * var_x211 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x212 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x213, 2);
        IJth(rJacobian, 8, 0) = 0.066600000000000006 * var_x214 / pow((1.0 + var_x214), 2);
        ...
        IJth(rJacobian, 1, 1) = -7.0 + var_x135 + var_x136 - 4.3596094751625959e-6 * var_x78 - 0.00031591373008424612 * var_x86 - 0.00063182746016849224 * var_x79 - 1.0549054718227806e-6 * var_x77 + (0.00040000000000000002 * var_x140 - 0.00040000000000000002 * var_x138 - 7.1999999999999991e-9 * var_x141) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 9, 1) = var_x220 * var_x221 + (var_x218 - var_x220) * var_chaste_interface__calcium_release__ActFrac - var_x218 * var_x221;
        IJth(rJacobian, 10, 1) = (var_x220 - var_x218) * var_chaste_interface__calcium_release__ActFrac;
        ...
        IJth(rJacobian, 12, 2) = -var_x223 * var_x87;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0030000000000000001 * var_x75 * var_x90);
        IJth(rJacobian, 3, 3) = ((var_x164) ? (var_x170 + 2.0000000091613402e-7 * var_x160 - 499.99999948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (0.00019999999949504854 * var_x159 + 0.00020000000091613401 * var_x160)) : (var_x170 - var_x163 * var_x169));
        ...
        IJth(rJacobian, 4, 4) = -var_x173 - var_x176;
        IJth(rJacobian, 11, 4) = -var_x223 * var_x91;
        ...
        IJth(rJacobian, 5, 5) = ((var_x190) ? (var_x202 + 3.6000000100955274e-8 * var_x183 - 3749.9999894838256 * (19.000000400000001 + var_chaste_interface__membrane__V) * (1.2000000033651759e-5 * var_x183 + 1.2000000033651759e-5 * var_x184)) : ((var_x198) ? (var_x202 + var_x203) : (var_x203 - var_x188 * var_x201)));
        IJth(rJacobian, 11, 5) = -var_x223 * var_x97;
        IJth(rJacobian, 12, 5) = -var_x100 * var_x223;
        ...
        IJth(rJacobian, 6, 6) = -0.025000000000000001 / var_x209 - var_x207 * var_x210;
        IJth(rJacobian, 11, 6) = -var_x109 * var_x223;
        IJth(rJacobian, 12, 6) = -var_x112 * var_x223;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x117 * var_x9);
        IJth(rJacobian, 7, 7) = -0.033000000000000002 / var_x213 - 3.3000000000000003e-5 * var_x211;
        IJth(rJacobian, 12, 7) = -var_x224 * var_x9;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x117 * var_x118);
        IJth(rJacobian, 8, 8) = -0.33300000000000002;
        IJth(rJacobian, 12, 8) = -var_x118 * var_x224;
        IJth(rJacobian, 1, 9) = (var_x142 * var_x145 - var_x142 * var_x147) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 9, 9) = -0.059999999999999998 - var_x217 * var_x219;
        IJth(rJacobian, 10, 9) = 0.059999999999999998 + var_x222;
        IJth(rJacobian, 14, 9) = (var_x147 * var_x225 - var_x145 * var_x225) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 9, 10) = -var_x222;
        ...
        IJth(rJacobian, 15, 15) = -0.050000000000000003 + var_x226;
        IJth(rJacobian, 1, 16) = 0.20000000000000001 + var_x149;
        IJth(rJacobian, 16, 16) = -0.20000000000000001 + var_x226;
    }
