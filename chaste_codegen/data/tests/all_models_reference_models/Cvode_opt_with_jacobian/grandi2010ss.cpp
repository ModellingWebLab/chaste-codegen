...
class Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__sVm)
    {
        ...
        const double* const _lt_0_row = Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables()
    {
...
protected:
    Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables(const Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables&);
    Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables& operator= (const Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables&);
    Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables()
    {
        ...
        Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables> Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellgrandi2010ssFromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellgrandi2010ssFromCellMLCvodeOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 37);
    }
    
    Cellgrandi2010ssFromCellMLCvodeOpt::Cellgrandi2010ssFromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                38,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellgrandi2010ssFromCellMLCvodeOpt>::Instance();
        Init();
    ...
    Cellgrandi2010ssFromCellMLCvodeOpt::~Cellgrandi2010ssFromCellMLCvodeOpt()
    {
    }

    AbstractLookupTableCollection* Cellgrandi2010ssFromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double Cellgrandi2010ssFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__sVm);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellgrandi2010ssFromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__sVm);
    ...
    void Cellgrandi2010ssFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__cell__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__sVm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    void Cellgrandi2010ssFromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__cell__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__cell__sVm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -81.3842590704928
        double var_chaste_interface__cell__sm = NV_Ith_S(rY, 1);
...
const double var_x0 = exp(7.4880000000000004 - 0.16722408026755853 * var_chaste_interface__cell__sVm);
        ...
        const double var_x196 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__sVm);
        const double var_x197 = 1.0 + var_x196;
        const double var_x198 = 1 / pow(var_x197, 2);
        const double var_x199 = var_x198 - var_chaste_interface__cell__sh;
        const double var_x200 = 1 / var_x195;
        const double var_x201 = var_x196 / pow(var_x197, 3);
        ...
        const double var_x209 = 0.26917900403768508 * var_x201;
        const double var_x210 = var_x198 - var_chaste_interface__cell__sj;
        ...
        const double var_x233 = -var_chaste_interface__cell__sd + 1 / var_x232;
        ...
        const double var_x238 = 0.0058333333333333336 * var_x229;
        ...
        const double var_x252 = exp(1.4615384615384615 - 0.076923076923076927 * var_chaste_interface__cell__sVm);
        const double var_x253 = 1.0 + var_x252;
        const double var_x254 = 0.076923076923076927 * var_x252 / pow(var_x253, 2);
        const double var_x255 = 1 / var_x253;
        ...
        const double var_x260 = 0.20000000000000001 * var_chaste_interface__cell__sVm;
        const double var_x261 = exp(3.8999999999999999 + var_x260);
        const double var_x262 = 1.0 + var_x261;
        const double var_x263 = 0.20000000000000001 * var_x261 / pow(var_x262, 2);
        ...
        const double var_x279 = exp(-2.0 - var_x260);
        const double var_x280 = 1.0 + var_x279;
        const double var_x281 = 1 / (230.0 * var_x271 + 3300.0 * var_x278);
        const double var_x282 = exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__cell__sVm);
        ...
        const double var_x296 = var_chaste_interface__cell__sCaj * var_chaste_interface__cell__sRyRr;
        const double var_x297 = var_x286 * var_x287 / pow(var_x288, 2);
        const double var_x298 = 2.3772197685794643 * var_x297;
        const double var_x299 = 0.21130842387373014 * var_x297 * var_x44 / pow((1 - 0.93333333333333335 * var_x289), 2);
        const double var_x300 = var_x299 * var_chaste_interface__cell__sRyRr;
        const double var_x301 = 20.0 * var_x293;
        const double var_x302 = var_x296 * var_x301;
        const double var_x303 = var_x298 * var_chaste_interface__cell__sCaj * var_chaste_interface__cell__sRyRo;
        const double var_x304 = 7.5 - var_x290;
        ...
        const double var_x349 = var_x347 * var_x35;
        const double var_x350 = 0.027802898010839731 * var_x126;
        const double var_x351 = var_x135 * var_x347;
        const double var_x352 = var_x137 * var_x347;
        const double var_x353 = 2.7730746221159819e-6 * var_x106;
        const double var_x354 = var_x145 * var_x347;
        const double var_x355 = var_x104 * var_x347;
        const double var_x356 = 3.2338348512952546 * var_x347;
        const double var_x357 = 0.0068117100126557344 * var_x347;
        const double var_x358 = 0.0060624219112636038 * var_x131;
        const double var_x359 = 8.3038178962250779e-9 * var_x79;
        const double var_x360 = var_x359 * var_x70;
        const double var_x361 = 0.23994917636495411 * var_x347;
        const double var_x362 = 0.1263768091401806 * var_x347;
        const double var_x363 = var_x140 * var_x347;
        const double var_x364 = 0.19966137279235072 * var_x115;
        const double var_x365 = var_x146 * var_x347;
        const double var_x366 = var_x147 * var_x347;
        ...
        const double var_x370 = 0.00059787488852820563 * var_x97;
        const double var_x371 = var_x370 * var_x70;
        ...
        IJth(rJacobian, 2, 0) = ((var_x202) ? (-1.5943679469924423 * var_x200 * var_x201 + 0.53361053361053368 * var_x194 * var_x199 / pow(var_x195, 2)) : (var_x199 * (108035.0 * var_x203 + 0.21330000000000002 * var_x204 - 0.008382352941176471 * var_x205) - var_x209 * (var_x206 + var_x207 + var_x208)));
        IJth(rJacobian, 3, 0) = ((var_x202) ? (0.034200000000000001 * var_x210 * var_x214 - 0.16150740242261102 * var_x201 * var_x214 + 0.059999999999999998 * var_x210 * var_x211 * var_x213 / pow(var_x212, 2)) : (var_x210 * (var_x221 - 0.00025500480000000003 * var_x225 + var_x220 * var_x226 * (3.0508668000000001e-7 * var_x216 - 6214.6032000000005 * var_x215) + 0.0033402720000000005 * var_x222 * var_x224 / pow(var_x223, 2) - 0.311 * var_x217 * var_x218 * var_x226 / pow(var_x219, 2)) - var_x209 * (var_x227 + var_x228)));
        IJth(rJacobian, 4, 0) = var_x234 * var_x236 - var_x234 * var_x239 + var_x235 * var_x238 * var_x240 / pow(var_x232, 2) - var_x233 * var_x235 * var_x239 / pow(var_x230, 2);
        IJth(rJacobian, 5, 0) = (0.02 + var_x241) * (0.029999999999999999 * var_x243 / pow(var_x244, 2) - 0.1111111111111111 * var_x246 / pow(var_x247, 2)) + var_x241 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__cell__sVm) * (-var_chaste_interface__cell__sf + 1 / var_x247 + 0.59999999999999998 / var_x244);
        IJth(rJacobian, 8, 0) = var_x251 * var_x254 + 0.0074074074074074077 * var_x248 * (var_x255 - var_chaste_interface__cell__sxtos) / (pow(var_x249, 2) * pow((0.055555555555555552 + var_x250), 2));
        IJth(rJacobian, 9, 0) = -var_x259 * var_x263 + 0.000125 * var_x256 * (var_x264 - var_chaste_interface__cell__sytos) / (pow(var_x257, 2) * pow((0.037499999999999999 + var_x258), 2));
        IJth(rJacobian, 10, 0) = var_x254 * var_x266 - 0.11764705882352941 * var_x265 * (-0.035999999999999997 - 0.00080000000000000004 * var_chaste_interface__cell__sVm) * (var_x255 - var_chaste_interface__cell__sxtof) / pow((0.058823529411764705 + var_x265), 2);
        IJth(rJacobian, 11, 0) = -var_x263 * var_x268 - 0.011764705882352941 * var_x267 * (-0.36363636363636365 - 0.0090909090909090905 * var_chaste_interface__cell__sVm) * (var_x264 - var_chaste_interface__cell__sytof) / pow((0.082352941176470587 + var_x267), 2);
        IJth(rJacobian, 12, 0) = 9.1827364554637282e-8 * (-var_chaste_interface__cell__sxkr + 1 / var_x280) * (11.5 * var_x269 / pow(var_x270, 2) + 366.66666666666669 * var_x272 * var_x277 / pow(var_x273, 2) - 366.66666666666669 * var_x274 * var_x275 / pow(var_x276, 2)) / pow((var_x278 + 0.069696969696969702 * var_x271), 2) + 0.20000000000000001 * var_x279 * var_x281 / pow(var_x280, 2);
        IJth(rJacobian, 13, 0) = -7.1529673512819408e-5 * var_x284 * (-var_chaste_interface__cell__sxks + 1 / var_x283) + 0.070175438596491224 * var_x282 * (0.00100999899000101 + var_x285) / pow(var_x283, 2);
        IJth(rJacobian, 32, 0) = -var_x348 * (6.567e-5 + var_x124 + var_x86 - var_x110 + 0.11 * var_x36 + 1.4850000000000001 * var_x53 + 0.012986358245322698 * var_x67 + 0.46486956521739131 * var_x30);
        IJth(rJacobian, 33, 0) = -var_x357 * (0.00053133 + var_x118 + var_x81 - var_x111 + 0.89000000000000001 * var_x36 + 12.015000000000001 * var_x63 + 0.10507144398488363 * var_x69 + 3.7612173913043478 * var_x32);
        IJth(rJacobian, 35, 0) = -var_x362 * (6.0643000000000002e-5 + var_x122 + var_x95 - var_x116 - 0.98999999999999999 * var_x53 - 0.0086575721635484652 * var_x67);
        IJth(rJacobian, 36, 0) = -var_x369 * (0.00049065700000000003 + var_x120 + var_x99 - var_x114 - 0.070047629323255756 * var_x69 - 8.0099999999999998 * var_x63);
        ...
        IJth(rJacobian, 32, 1) = -0.083408694032519187 * var_x129 * var_x347;
        IJth(rJacobian, 33, 1) = -0.01818726573379081 * var_x132 * var_x347;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x133 * var_x35 - var_x134 * var_x35);
        IJth(rJacobian, 2, 2) = ((var_x202) ? (-5.9230769230769234 * var_x200) : (-var_x206 - var_x207 - var_x208));
        ...
        IJth(rJacobian, 3, 3) = ((var_x202) ? (-0.59999999999999998 * var_x214) : (-var_x227 - var_x228));
        ...
        IJth(rJacobian, 4, 4) = -var_x236 * var_x240;
        ...
        IJth(rJacobian, 5, 5) = -0.02 - var_x241;
        ...
        IJth(rJacobian, 32, 6) = 2.7730746221159819e-6 * var_x355 * var_x84;
        IJth(rJacobian, 35, 6) = 0.19966137279235072 * var_x366 * var_x93;
        ...
        IJth(rJacobian, 13, 13) = -0.00100999899000101 - var_x285;
        IJth(rJacobian, 14, 14) = -0.0050000000000000001 + var_x292 + var_x295;
        IJth(rJacobian, 15, 14) = var_x294;
        IJth(rJacobian, 16, 14) = var_x295;
        IJth(rJacobian, 14, 15) = 0.055;
        IJth(rJacobian, 15, 15) = -0.059999999999999998 + var_x292;
        ...
        IJth(rJacobian, 14, 31) = -var_x300 + var_x296 * var_x298;
        IJth(rJacobian, 15, 31) = var_x300 + var_x303;
        IJth(rJacobian, 16, 31) = -var_x303 + var_x299 * var_x305;
        ...
        IJth(rJacobian, 32, 32) = -0.0007561 + var_x307 - var_x356 - var_x348 * (var_x151 + var_x159 + var_x160 + 8.0190000000000001 * var_x158 + 0.0001270048672132754 * var_x153 - 4.973979775839485e-12 * var_x157);
        IJth(rJacobian, 33, 32) = 0.087151849242407126 * var_x347;
        IJth(rJacobian, 35, 32) = -var_x362 * (3.3159865172263233e-12 * var_x157 - 5.3460000000000001 * var_x158);
        ...
        IJth(rJacobian, 33, 33) = -0.000165 + var_x309 - 7.8855000811034159 * var_x347 - var_x357 * (var_x161 + var_x167 + var_x169 + 0.001027584834725592 * var_x162 + 64.881 * var_x168 - 4.0244018186337653e-11 * var_x166);
        IJth(rJacobian, 34, 33) = var_x361;
        IJth(rJacobian, 36, 33) = -var_x369 * (2.6829345457558432e-11 * var_x166 - 43.253999999999998 * var_x168);
        ...
        IJth(rJacobian, 14, 35) = -var_x302 + var_x291 * var_chaste_interface__cell__sRyRr;
        IJth(rJacobian, 15, 35) = var_x302 + var_x291 * var_chaste_interface__cell__sRyRo;
        IJth(rJacobian, 16, 35) = var_x304 * var_chaste_interface__cell__sRyRo + var_x301 * var_x305 * var_chaste_interface__cell__sCaj;
        ...
        IJth(rJacobian, 32, 35) = -var_x348 * (1.9722330831541279e-13 * var_x176 + 6.6824999999999991e-8 * var_x177 - 4074840.0 * var_x175);
        IJth(rJacobian, 35, 35) = -75.377506864564012 + var_x326 + var_x330 - var_x367 - var_x368 - var_x362 * (var_x170 + var_x173 + var_x178 - var_x172 + 2716560.0 * var_x175 - 1.3148220554360853e-13 * var_x176 - 4.4549999999999992e-8 * var_x177);
        ...
        IJth(rJacobian, 33, 36) = -var_x357 * (5.4067499999999991e-7 * var_x185 + 1.5957158581883399e-12 * var_x184 - 32969160.0 * var_x183);
        IJth(rJacobian, 35, 36) = var_x368;
        IJth(rJacobian, 36, 36) = -165.10000000000002 + var_x329 + var_x331 - 21.646099331949777 * var_x347 - var_x369 * (var_x179 + var_x182 + var_x186 - var_x181 + 21979440.0 * var_x183 - 1.0638105721255599e-12 * var_x184 - 3.6044999999999992e-7 * var_x185);
    ...
    N_Vector Cellgrandi2010ssFromCellMLCvodeOpt::ComputeDerivedQuantities(double var_chaste_interface__cell__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellgrandi2010ssFromCellMLCvodeOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellgrandi2010ssFromCellMLCvodeOpt)
