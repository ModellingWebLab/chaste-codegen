...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_rapid_delayed_rectifier_potassium_current_xr1_gate__xr1 = 0.050000000000000003 * _lt_0_row[13] * (1.0 - var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1) - 5.0000000000000002e-5 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1 * _lt_0_row[14]; // 1 / millisecond
        const double d_dt_chaste_interface_var_rapid_delayed_rectifier_potassium_current_xr2_gate__xr2 = 0.050000000000000003 * _lt_0_row[13] * (1.0 - var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2) - 0.00040000000000000002 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2 * _lt_0_row[15]; // 1 / millisecond
        const double var_calcium_background_current__i_b_Ca = 0.00025000000000000001 * var_chaste_interface__membrane__V - 0.0033392200824619565 * log(2.0 / var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
        const double var_reversal_potentials__E_K = 26.713760659695652 * log(4.0 / var_chaste_interface__intracellular_potassium_concentration__K_i); // millivolt
        const double var_rapid_delayed_rectifier_potassium_current__i_Kr = _lt_0_row[5] * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * (0.0012999999999999999 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2 + 0.0020999999999999999 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1); // nanoA
        const double var_reversal_potentials__E_Na = 26.713760659695652 * log(140.0 / var_chaste_interface__intracellular_sodium_concentration__Na_i); // millivolt
        ...
        const double var_slow_delayed_rectifier_potassium_current__i_Ks = 0.0025999999999999999 * pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2) * (-26.713760659695652 * log(8.1999999999999993 / (0.029999999999999999 * var_chaste_interface__intracellular_sodium_concentration__Na_i + var_chaste_interface__intracellular_potassium_concentration__K_i)) + var_chaste_interface__membrane__V); // nanoA
        const double d_dt_chaste_interface_var_slow_delayed_rectifier_potassium_current_xs_gate__xs = 0.014 * _lt_0_row[16] * (1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs) - 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs * _lt_0_row[17]; // 1 / millisecond
        const double var_sodium_background_current__i_b_Na = 0.00059999999999999995 * var_chaste_interface__membrane__V - 0.00059999999999999995 * var_reversal_potentials__E_Na; // nanoA
        const double var_sodium_calcium_exchanger__d_NaCa = 0; // dimensionless
        const double var_sodium_calcium_exchanger__i_NaCa_cyt = 0.00049950000000000005 * (2.0 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) * _lt_0_row[7] - 2744000.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i * _lt_0_row[8]) / ((1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) * (1.0 + (2.0 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) + 2744000.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) * var_sodium_calcium_exchanger__d_NaCa)); // nanoA
        const double var_sodium_calcium_exchanger__i_NaCa_ds = 4.9999999999999998e-7 * (2.0 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) * _lt_0_row[7] - 2744000.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds * _lt_0_row[8]) / ((1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds) * (1.0 + (2.0 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) + 2744000.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds) * var_sodium_calcium_exchanger__d_NaCa)); // nanoA
...
const double var_x0 = -0.125 * var_chaste_interface__membrane__V;
        ...
        const double var_x114 = _lt_0_row[14];
        ...
        const double var_x122 = _lt_0_row[17];
        const double var_x123 = exp(4.4444444444444446 + var_x115);
        const double var_x124 = 1.0 + var_x123;
        const double var_x125 = _lt_0_row[12];
        const double var_x126 = 0.44800000000000001 * var_x125 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x127 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x128 = fabs(var_x127) < 1.0000000000000001e-5;
        const double var_x129 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x150 = -0.00089999999999999998 * var_x148 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x149, 2);
        ...
        const double var_x158 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x159 = _lt_0_row[19];
        const double var_x160 = exp(-1.25 + var_x0);
        const double var_x161 = 1.0 + var_x160;
        const double var_x162 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x163 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        ...
        const double var_x166 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x164, 2);
        ...
        const double var_x169 = 2 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        ...
        const double var_x175 = 0.5 * var_x170 * var_x174;
        const double var_x176 = var_x175 * (-2 * var_x166 + 2 * var_x165 + var_x168 * var_x169 * (var_x166 - var_x165));
        ...
        const double var_x180 = var_x175 * (2 * var_x173 - var_x169 * var_x172 / pow(var_x167, 2));
        const double var_x181 = var_x180 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x182 = 2.3651760162759904e-8 * var_x40;
        const double var_x183 = 4.7303520325519805e-9 * var_x49;
        const double var_x184 = 8.4392437745822447e-5 * var_x6 - 3.1591373008424612e-6 * var_chaste_interface__membrane__V;
        const double var_x185 = 4.7303520325519803e-5 * var_x47;
        ...
        IJth(rJacobian, 5, 0) = ((var_x128) ? (var_x126) : (var_x126 + var_x129 * var_x133 - 0.02 * var_x127 * var_x129 * var_x131 / pow(var_x132, 2)));
        IJth(rJacobian, 6, 0) = -0.125 * var_x135 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x136 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x136), 2);
        IJth(rJacobian, 7, 0) = ((var_x138) ? (0) : (var_x139 * var_x144 - var_x147 * var_chaste_interface__L_type_Ca_channel_d_gate__d + 0.0035999999999999999 * var_x137 * var_x145 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x146, 2) - 0.022499999999999999 * var_x137 * var_x139 * var_x142 / pow(var_x143, 2)));
        IJth(rJacobian, 8, 0) = ((var_x152) ? (var_x150) : (var_x150 + var_x153 * var_x156 - 0.00046874999999999998 * var_x151 * var_x153 * var_x154 / pow(var_x155, 2)));
        IJth(rJacobian, 11, 0) = -0.058823529411764705 * var_x159 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x160 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x161, 2);
        IJth(rJacobian, 12, 0) = 0.066600000000000006 * var_x162 / pow((1.0 + var_x162), 2);
        IJth(rJacobian, 15, 0) = -3.7909647610109532e-7 + 8.8537740769851485e-10 * var_x60 - 9.4679344906248566e-7 * var_x25 - 1.2395283707779208e-7 * var_x56 - 0.0015795686504212305 * var_x16 - 3.1591373008424611e-7 * var_x29 - 2.5273098406739689e-6 * var_x3 - var_x182 * var_x38;
        IJth(rJacobian, 16, 0) = 1.7707548153970298e-10 * var_x59 + 2.8206583043236264e-5 * var_x32 + 4.2235286004928392e-6 * var_x31 - 7.0830192615881192e-10 * var_x56 - 3.1591373008424612e-6 * var_x17 - 0.00063182746016849224 * var_x14 - 9.0261065738356038e-5 * var_x9 - 1.6427513964380798e-6 * var_x4 - var_x183 * var_x38;
        IJth(rJacobian, 17, 0) = 3.5415096307940594e-6 * var_x57 - 7.0830192615881188e-6 * var_x54 - var_x185 * var_x37;
        ...
        IJth(rJacobian, 1, 1) = -7.0 + var_x100 + var_x101 + 0.00040000000000000002 * var_x105 - 0.00040000000000000002 * var_x103 - 0.86600040807582024 * var_x64 - 1.0549054718227806e-6 * var_x63 - 2.1776249328437171e-9 * var_x67 - 7.1999999999999991e-9 * var_x106;
        ...
        IJth(rJacobian, 13, 1) = -var_x177 + var_x163 * var_x176;
        IJth(rJacobian, 14, 1) = var_x177;
        ...
        IJth(rJacobian, 18, 1) = 3.5279999999999993e-7 * var_x106 + 0.019599999999999999 * var_x103 - 0.019599999999999999 * var_x105;
        ...
        IJth(rJacobian, 5, 5) = ((var_x128) ? (-2.0 + var_x134) : (var_x134 - var_x127 * var_x133));
        ...
        IJth(rJacobian, 6, 6) = -2.0 / (1.0 + 320.0 * var_x136) - 0.02 * var_x135;
        ...
        IJth(rJacobian, 7, 7) = ((var_x138) ? (-0.71999999999999997) : (-var_x137 * var_x144 - var_x137 * var_x147));
        IJth(rJacobian, 15, 7) = -var_x182 * var_x78;
        IJth(rJacobian, 16, 7) = -var_x183 * var_x78;
        IJth(rJacobian, 17, 7) = -var_x185 * var_x77;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x62 * (var_x41 * var_x81 + var_x48 * var_x80 + var_x50 * var_x81));
        IJth(rJacobian, 8, 8) = ((var_x152) ? (-0.0074999999999999997 + var_x157) : (var_x157 - var_x151 * var_x156));
        IJth(rJacobian, 15, 8) = -var_x182 * var_x81;
        IJth(rJacobian, 16, 8) = -var_x183 * var_x81;
        IJth(rJacobian, 17, 8) = -var_x185 * var_x80;
        ...
        IJth(rJacobian, 15, 10) = -var_x182 * var_x83;
        IJth(rJacobian, 16, 10) = -var_x183 * var_x83;
        IJth(rJacobian, 17, 10) = -var_x185 * var_x82;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x84 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 11, 11) = -0.033000000000000002 / var_x161 - 3.3000000000000003e-5 * var_x159;
        IJth(rJacobian, 16, 11) = var_x184 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        IJth(rJacobian, 16, 12) = var_x184 * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        IJth(rJacobian, 13, 13) = var_x179 + var_x170 * (-0.059999999999999998 - var_x178);
        IJth(rJacobian, 14, 13) = var_x170 * (0.059999999999999998 + var_x178);
        IJth(rJacobian, 19, 13) = (0.5 * var_x111 - 0.5 * var_x109) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 13, 14) = var_x179;
        IJth(rJacobian, 14, 14) = -0.001 * var_x170;
        ...
        IJth(rJacobian, 15, 15) = 6.634188331769168e-7 * var_x87 - 6.7513950196657958e-5 * var_x86 - 0.0010614701330830668 * var_x85 - 1.0127092529498693e-5 * var_x28 - 5.6807606943749135e-6 * var_x91 - 2.3651760162759904e-8 * var_x93 - 5.9277248272665686 * var_x92;
        ...
        IJth(rJacobian, 16, 16) = 0.00011282633217294504 * var_x97 - 0.0024112125070234981 * var_x94 - 8.4392437745822447e-5 * var_x96 - 0.00035984935454818685 * var_x90 - 0.016878487549164489 * var_x95 - 4.7303520325519805e-9 * var_x93;
        ...
        IJth(rJacobian, 10, 17) = -0.02 / var_x158 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x158, 2);
        IJth(rJacobian, 13, 17) = -var_x181 + var_x163 * var_x180;
        IJth(rJacobian, 14, 17) = var_x181;
        ...
        IJth(rJacobian, 18, 18) = -0.050000000000000003 + 8.4671999999999982e-11 * var_x106 - 4.7039999999999993e-6 * var_x105 - 3.5279999999999993e-7 * var_x103;
