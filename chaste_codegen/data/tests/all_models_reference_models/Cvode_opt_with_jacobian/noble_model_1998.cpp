...
const double var_x0 = -0.125 * var_chaste_interface__membrane__V;
        ...
        const double var_x55 = _lt_0_row[0];
        ...
        const double var_x188 = _lt_0_row[15];
        ...
        const double var_x201 = _lt_0_row[13];
        const double var_x202 = 0.44800000000000001 * var_x201 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x203 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x204 = fabs(var_x203) < 1.0000000010279564e-6;
        const double var_x205 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x209 = 0.20000000000000001 / var_x208;
        const double var_x210 = -8.0 * var_x201;
        const double var_x211 = exp(-7.5 + var_x206 + 0.10000000000000001 * NV_Ith_S(mParameters, 13));
        const double var_x212 = 1 / (1.0 + 320.0 * var_x211);
        const double var_x213 = 2.0 * var_x212;
        const double var_x214 = exp(-9.375 + var_x0 + 0.125 * NV_Ith_S(mParameters, 13));
        const double var_x215 = 0.02 * var_x214;
        const double var_x216 = 2.5 * var_x214;
        const double var_x217 = 20.0 * var_x214;
        const double var_x218 = 0.01 * NV_Ith_S(mParameters, 12);
        const double var_x219 = 1.0 - var_x218;
        const double var_x220 = var_x219 / (var_x217 + 2000.0 * var_x212);
        const double var_x221 = var_x211 / pow((0.0031250000000000002 + var_x211), 2);
        const double var_x222 = 1 / (1.0 - exp(1.0000000028043132e-7));
        const double var_x223 = 1 / (1.0 - exp(-1.0000000028043132e-7));
        const double var_x224 = 1 / (-1.0 + exp(1.0000000010279564e-7));
        const double var_x225 = 1 / (-1.0 + exp(-1.0000000010279564e-7));
        const double var_x226 = (-0.017999999999999999 * var_x224 - 0.017999999999999999 * var_x225) * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x227 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x228 = fabs(var_x227);
        const double var_x229 = var_x228 < 4.0000000112172529e-7;
        ...
        const double var_x237 = var_x228 < 1.0000000010279564e-6;
        const double var_x238 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x239 = -1.0 + var_x238;
        const double var_x240 = 0.035999999999999997 / var_x239;
        const double var_x241 = -3.6000000037006431e-8 * var_x224 + 1499.9999984580654 * (18.999998999999999 + var_chaste_interface__membrane__V) * (-1.2000000012335477e-5 * var_x224 - 1.2000000012335477e-5 * var_x225);
        const double var_x242 = -var_x227 * var_x235;
        const double var_x243 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x244 = exp(8.5 + var_x231);
        const double var_x245 = -1.0 + var_x244;
        const double var_x246 = 0.0018749999999999999 / var_x245;
        const double var_x247 = exp(-8.5 + var_x232);
        const double var_x248 = 1.0 + var_x247;
        const double var_x249 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x250 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x251 = _lt_0_row[20];
        const double var_x252 = exp(-1.25 + var_x0);
        const double var_x253 = 1.0 + var_x252;
        const double var_x254 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x255 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x256 = NV_Ith_S(mParameters, 2) + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x257 = 1 / var_x256;
        const double var_x258 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x256, 2);
        const double var_x259 = NV_Ith_S(mParameters, 3) + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x260 = 1 / var_x259;
        const double var_x261 = 2 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x262 = ((var_chaste_interface__membrane__V < -50.0) ? (5.0) : (1.0));
        const double var_x263 = var_x257 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x264 = 1.0 - var_x263;
        const double var_x265 = var_x260 * var_x264;
        const double var_x266 = var_x263 + var_x265 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x267 = 0.5 * var_x262 * var_x266;
        const double var_x268 = var_x267 * (-2 * var_x258 + 2 * var_x257 + var_x260 * var_x261 * (var_x258 - var_x257));
        const double var_x269 = var_x268 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x270 = 0.5 * pow(var_x266, 2);
        const double var_x271 = -var_x262 * var_x270;
        const double var_x272 = var_x267 * (2 * var_x265 - var_x261 * var_x264 / pow(var_x259, 2));
        const double var_x273 = var_x272 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x274 = 0.00063182746016849224 * NV_Ith_S(mParameters, 5);
        const double var_x275 = var_x103 * var_x274;
        const double var_x276 = var_x148 * var_x274;
        const double var_x277 = 0.002 * NV_Ith_S(mParameters, 1);
        const double var_x278 = -var_x187;
        ...
        IJth(rJacobian, 5, 0) = ((var_x204) ? (var_x202 + (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * (99.999999644728632 * var_x199 + 100.00000035527137 * var_x200)) : (var_x202 + var_x205 * var_x209 - 0.02 * var_x203 * var_x205 * var_x207 / pow(var_x208, 2)));
        IJth(rJacobian, 6, 0) = (var_x213 + var_x215) * (-var_x216 * var_x220 + 5.0000000000000004e-6 * var_x214 * var_x219 * (var_x216 - 0.625 * var_x221) / pow((var_x212 + 0.01 * var_x214), 2)) + (0.00062500000000000001 * var_x221 - 0.0025000000000000001 * var_x214) * (var_x218 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x217 * var_x220);
        IJth(rJacobian, 7, 0) = ((var_x229) ? (var_x226 + (0.0030000000000000001 - 0.0030000000000000001 * var_chaste_interface__L_type_Ca_channel_d_gate__d) * (15.0 * var_x222 + 15.0 * var_x223)) : ((var_x237) ? (var_x226 + var_x236) : (var_x236 - var_x240 * var_chaste_interface__L_type_Ca_channel_d_gate__d + 0.0035999999999999999 * var_x227 * var_x238 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x239, 2))));
        IJth(rJacobian, 8, 0) = var_x243 * var_x246 - 0.00089999999999999998 * var_x247 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x248, 2) - 0.00046874999999999998 * var_x243 * var_x244 * var_x249 / pow(var_x245, 2);
        IJth(rJacobian, 11, 0) = -0.058823529411764705 * var_x251 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x252 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x253, 2);
        IJth(rJacobian, 12, 0) = 0.066600000000000006 * var_x254 / pow((1.0 + var_x254), 2);
        ...
        IJth(rJacobian, 1, 1) = -7.0 + var_x173 + var_x174 - 0.00063119563270832375 * var_x95 - 4.3552498656874335e-6 * var_x94 - 1.0549054718227806e-6 * var_x93 + (0.00040000000000000002 * var_x178 - 0.00040000000000000002 * var_x176 - 7.1999999999999991e-9 * var_x179) * NV_Ith_S(mParameters, 4);
        ...
        IJth(rJacobian, 13, 1) = -var_x269 + var_x255 * var_x268;
        IJth(rJacobian, 14, 1) = var_x269;
        ...
        IJth(rJacobian, 16, 2) = -var_x275 * NV_Ith_S(mParameters, 15);
        ...
        IJth(rJacobian, 16, 3) = -var_x275 * NV_Ith_S(mParameters, 16);
        ...
        IJth(rJacobian, 5, 5) = ((var_x204) ? (var_x210 + 2.0000000091613402e-7 * var_x200 - 499.99999948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (0.00019999999949504854 * var_x199 + 0.00020000000091613401 * var_x200)) : (var_x210 - var_x203 * var_x209));
        ...
        IJth(rJacobian, 15, 6) = -var_x110 * var_x274;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x92 * (var_x116 + var_x119 + var_x122));
        IJth(rJacobian, 7, 7) = ((var_x229) ? (var_x241 + 3.6000000100955274e-8 * var_x222 - 3749.9999894838256 * (19.000000400000001 + var_chaste_interface__membrane__V) * (1.2000000033651759e-5 * var_x222 + 1.2000000033651759e-5 * var_x223)) : ((var_x237) ? (var_x241 + var_x242) : (var_x242 - var_x227 * var_x240)));
        IJth(rJacobian, 15, 7) = -var_x116 * var_x274;
        IJth(rJacobian, 16, 7) = -var_x119 * var_x274;
        ...
        IJth(rJacobian, 8, 8) = -0.0035999999999999999 / var_x248 - var_x246 * var_x249;
        IJth(rJacobian, 15, 8) = -var_x128 * var_x274;
        IJth(rJacobian, 16, 8) = -var_x131 * var_x274;
        ...
        IJth(rJacobian, 15, 10) = -var_x141 * var_x274;
        IJth(rJacobian, 16, 10) = -var_x144 * var_x274;
        IJth(rJacobian, 17, 10) = -0.003159137300842461 * var_x147;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x12 * var_x149);
        IJth(rJacobian, 11, 11) = -0.033000000000000002 / var_x253 - 3.3000000000000003e-5 * var_x251;
        IJth(rJacobian, 16, 11) = -var_x12 * var_x276;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x149 * var_x150);
        IJth(rJacobian, 12, 12) = -0.33300000000000002;
        IJth(rJacobian, 16, 12) = -var_x150 * var_x276;
        ...
        IJth(rJacobian, 13, 13) = var_x271 + var_x262 * (-0.059999999999999998 - var_x270);
        IJth(rJacobian, 14, 13) = var_x262 * (0.059999999999999998 + var_x270);
        IJth(rJacobian, 19, 13) = (var_x185 * var_x277 - var_x183 * var_x277) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 13, 14) = var_x271;
        IJth(rJacobian, 14, 14) = -0.001 * var_x262;
        ...
        IJth(rJacobian, 10, 17) = -0.02 / var_x250 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x250, 2);
        IJth(rJacobian, 13, 17) = -var_x273 + var_x255 * var_x272;
        IJth(rJacobian, 14, 17) = var_x273;
        ...
        IJth(rJacobian, 20, 20) = -0.050000000000000003 + var_x278;
        IJth(rJacobian, 1, 21) = 0.20000000000000001 + var_x187;
        IJth(rJacobian, 21, 21) = -0.20000000000000001 + var_x278;
    }
