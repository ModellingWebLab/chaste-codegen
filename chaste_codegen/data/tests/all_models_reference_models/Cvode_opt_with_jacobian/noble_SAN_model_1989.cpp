...
const double var_x0 = exp(1.0000000000609274e-7);
        ...
        const double var_x82 = NV_Ith_S(mParameters, 1) * _lt_0_row[6];
        ...
        const double var_x167 = _lt_0_row[11];
        const double var_x168 = _lt_0_row[12];
        const double var_x169 = _lt_0_row[19];
        const double var_x170 = _lt_0_row[20];
        const double var_x171 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x172 = 1 / (1.0 - exp(1.0000000045806701e-7));
        const double var_x173 = _lt_0_row[10];
        const double var_x174 = 0.44800000000000001 * var_x173 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x175 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x176 = fabs(var_x175) < 1.0000000010279564e-6;
        ...
        const double var_x182 = -8.0 * var_x173;
        const double var_x183 = _lt_0_row[7];
        const double var_x184 = exp(-7.5 + var_x178);
        const double var_x185 = 1 / (1.0 - exp(1.0000000028043132e-7));
        const double var_x186 = 1 / (1.0 - exp(-1.0000000028043132e-7));
        const double var_x187 = 1 / (-1.0 + exp(1.0000000010279564e-7));
        const double var_x188 = 1 / (-1.0 + exp(-1.0000000010279564e-7));
        const double var_x189 = (-0.0060000000000000001 * var_x187 - 0.0060000000000000001 * var_x188) * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x190 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x191 = fabs(var_x190);
        const double var_x192 = var_x191 < 4.0000000112172529e-7;
        const double var_x193 = 1.0 - var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x194 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x195 = -var_x194;
        const double var_x196 = exp(-4.75 + var_x195);
        const double var_x197 = 1.0 - var_x196;
        const double var_x198 = 0.029999999999999999 / var_x197;
        const double var_x199 = var_x193 * var_x198 - 0.0074999999999999997 * var_x190 * var_x193 * var_x196 / pow(var_x197, 2);
        const double var_x200 = var_x191 < 1.0000000010279564e-6;
        const double var_x201 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x202 = -1.0 + var_x201;
        const double var_x203 = 0.012 / var_x202;
        const double var_x204 = -1.2000000012335476e-8 * var_x187 + 499.99999948602181 * (18.999998999999999 + var_chaste_interface__membrane__V) * (-1.2000000012335477e-5 * var_x187 - 1.2000000012335477e-5 * var_x188);
        const double var_x205 = -var_x190 * var_x198;
        const double var_x206 = 1.0 - var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x207 = exp(8.5 + var_x194);
        const double var_x208 = -1.0 + var_x207;
        const double var_x209 = 0.0062500000000000003 / var_x208;
        const double var_x210 = exp(-8.5 + var_x195);
        const double var_x211 = 1.0 + var_x210;
        const double var_x212 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x213 = 0.0026182929949382316 * var_x101;
        const double var_x214 = -0.0013091464974691158 * var_x147;
        const double var_x215 = 0.002 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x216 = 0.19999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x217 = 0.0050000000000000001 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x218 = 1.0 - var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x219 = exp(16.0 + var_x194);
        const double var_x220 = -1.0 + var_x219;
        const double var_x221 = 0.00062500000000000001 / var_x220;
        const double var_x222 = exp(-16.0 + var_x195);
        const double var_x223 = 1.0 + var_x222;
        const double var_x224 = 64.0 + var_chaste_interface__membrane__V;
        const double var_x225 = 0.034972226201868815 * var_x69;
        ...
        IJth(rJacobian, 4, 0) = ((var_x176) ? (var_x174 + (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * (99.999999644728632 * var_x171 + 100.00000035527137 * var_x172)) : (var_x174 + var_x177 * var_x181 - 0.02 * var_x175 * var_x177 * var_x179 / pow(var_x180, 2)));
        IJth(rJacobian, 5, 0) = -0.125 * var_x183 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x184 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x184), 2);
        IJth(rJacobian, 6, 0) = ((var_x192) ? (var_x189 + (0.001 - 0.001 * var_chaste_interface__second_inward_current_d_gate__d) * (15.0 * var_x185 + 15.0 * var_x186)) : ((var_x200) ? (var_x189 + var_x199) : (var_x199 - var_x203 * var_chaste_interface__second_inward_current_d_gate__d + 0.0011999999999999999 * var_x190 * var_x201 * var_chaste_interface__second_inward_current_d_gate__d / pow(var_x202, 2))));
        IJth(rJacobian, 7, 0) = var_x206 * var_x209 - 0.012500000000000001 * var_x210 * var_chaste_interface__second_inward_current_f_gate__f / pow(var_x211, 2) - 0.0015625000000000001 * var_x206 * var_x207 * var_x212 / pow(var_x208, 2);
        ...
        IJth(rJacobian, 12, 0) = var_x218 * var_x221 - 0.00125 * var_x222 * var_chaste_interface__intracellular_calcium_concentration__p / pow(var_x223, 2) - 0.00015625 * var_x218 * var_x219 * var_x224 / pow(var_x220, 2);
        ...
        IJth(rJacobian, 1, 1) = -0.19999999999999998 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 2.6182929949382317e-12 * var_x100 - 8.7430565504672044e-7 * var_x95 - 0.00065457324873455789 * var_x94 - 1.8066221665073799e-10 * var_x97 - 2.6182929949382318e-8 * var_x98 + var_x160 * var_x164 - var_x160 * var_x165;
        ...
        IJth(rJacobian, 11, 1) = var_x165 * var_x216 - var_x164 * var_x216;
        ...
        IJth(rJacobian, 9, 2) = -var_x105 * var_x213;
        IJth(rJacobian, 13, 2) = -var_x103 * var_x213;
        ...
        IJth(rJacobian, 4, 4) = ((var_x176) ? (var_x182 + 2.0000000091613402e-7 * var_x172 - 499.99999948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (0.00019999999949504854 * var_x171 + 0.00020000000091613401 * var_x172)) : (var_x182 - var_x175 * var_x181));
        IJth(rJacobian, 9, 4) = -0.0039274394924073471 * var_x108;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x109 * var_x89);
        IJth(rJacobian, 5, 5) = -2.0 / (1.0 + 320.0 * var_x184) - 0.02 * var_x183;
        ...
        IJth(rJacobian, 6, 6) = ((var_x192) ? (var_x204 + 1.2000000033651759e-8 * var_x185 - 1249.9999964946085 * (19.000000400000001 + var_chaste_interface__membrane__V) * (1.2000000033651759e-5 * var_x185 + 1.2000000033651759e-5 * var_x186)) : ((var_x200) ? (var_x204 + var_x205) : (var_x205 - var_x190 * var_x203)));
        ...
        IJth(rJacobian, 7, 7) = -0.050000000000000003 / var_x211 - var_x209 * var_x212;
        ...
        IJth(rJacobian, 9, 9) = var_x214 + 2.3564636954444086e-11 * var_x154 + 1.1045923572395664e-6 * var_x151 - 2.4480558341308171e-5 * var_x104 - 0.0017673477715833062 * var_x150 - 0.034972226201868815 * var_x152 - 0.034972226201868815 * var_x155 - 2.3564636954444086e-7 * var_x156;
        ...
        IJth(rJacobian, 10, 10) = -var_x215 - 0.79999999999999993 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 11, 10) = var_x217;
        IJth(rJacobian, 1, 11) = 0.002 * var_x166;
        IJth(rJacobian, 10, 11) = var_x215;
        IJth(rJacobian, 11, 11) = -var_x217 - 0.099999999999999992 * var_x166;
        ...
        IJth(rJacobian, 12, 12) = -0.0050000000000000001 / var_x223 - var_x221 * var_x224;
        ...
        IJth(rJacobian, 13, 13) = var_x214 + 0.0026182929949382316 * var_x159 - 9.3510464104936842e-6 * var_x83 - var_x158 * var_x225 - var_x225 * var_x74;
    }
