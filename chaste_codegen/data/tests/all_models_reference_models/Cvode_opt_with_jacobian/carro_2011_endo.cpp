...
const double var_x0 = -NV_Ith_S(mParameters, 2);
        ...
        const double var_x197 = -0.5 + var_x196;
        const double var_x198 = 9.5939859749999992e-7 * NV_Ith_S(mParameters, 5);
        const double var_x199 = var_x198 * var_x3;
        const double var_x200 = var_x199 * var_x2;
        const double var_x201 = var_x198 * var_x8;
        const double var_x202 = -var_x200 - var_x201 * var_x7;
        const double var_x203 = var_x197 * var_x202;
        const double var_x204 = var_x200 - var_x203;
        const double var_x205 = var_x16 * var_x199;
        const double var_x206 = -var_x205 - var_x17 * var_x201;
        const double var_x207 = var_x197 * var_x206;
        const double var_x208 = var_x205 - var_x207;
        const double var_x209 = 187179.41753901311 * var_chaste_interface__membrane__V;
        const double var_x210 = -0.5 + var_x209;
        const double var_x211 = 2.9307318749999998e-11 * NV_Ith_S(mParameters, 5);
        const double var_x212 = var_x211 * var_x3;
        const double var_x213 = var_x212 * var_x24;
        const double var_x214 = var_x211 * var_x8;
        const double var_x215 = -var_x213 - var_x214 * var_x27;
        const double var_x216 = var_x210 * var_x215;
        const double var_x217 = var_x213 - var_x216;
        const double var_x218 = var_x212 * var_x30;
        const double var_x219 = -var_x218 - var_x214 * var_x31;
        const double var_x220 = var_x210 * var_x219;
        const double var_x221 = var_x218 - var_x220;
        const double var_x222 = 5.2753173749999997e-10 * NV_Ith_S(mParameters, 5);
        const double var_x223 = -var_x222 * var_x35;
        const double var_x224 = var_x210 * (var_x223 - var_x222 * var_x36);
        const double var_x225 = var_x39 * (var_x223 + var_x224);
        const double var_x226 = var_x13 * var_x225 + var_x14 * var_x217 + var_x21 * var_x221;
        const double var_x227 = var_x13 * var_chaste_interface__membrane__V;
        const double var_x228 = var_x132 * NV_Ith_S(mParameters, 5);
        const double var_x229 = var_x227 * var_x228;
        const double var_x230 = var_x139 * var_x229;
        const double var_x231 = var_x145 * var_x229;
        const double var_x232 = -var_x230 - var_x231;
        const double var_x233 = var_x173 * var_x227;
        const double var_x234 = var_x163 * var_x233;
        const double var_x235 = var_x168 * var_x233;
        const double var_x236 = var_x171 * var_x174 * var_x39;
        const double var_x237 = var_chaste_interface__L_Type_Calcium_Current__d * var_chaste_interface__L_Type_Calcium_Current__f_2;
        const double var_x238 = var_x12 * var_x237;
        const double var_x239 = var_x20 * var_x237;
        const double var_x240 = var_x217 * var_x238 + var_x221 * var_x239 + var_x225 * var_x237;
        const double var_x241 = var_x237 * var_chaste_interface__membrane__V;
        const double var_x242 = var_x228 * var_x241;
        const double var_x243 = var_x139 * var_x242;
        const double var_x244 = var_x145 * var_x242;
        const double var_x245 = -var_x243 - var_x244;
        const double var_x246 = var_x173 * var_x241;
        const double var_x247 = var_x163 * var_x246;
        const double var_x248 = var_x168 * var_x246;
        const double var_x249 = var_chaste_interface__L_Type_Calcium_Current__d * var_chaste_interface__L_Type_Calcium_Current__f;
        const double var_x250 = var_x12 * var_x249;
        const double var_x251 = var_x20 * var_x249;
        const double var_x252 = var_x217 * var_x250 + var_x221 * var_x251 + var_x225 * var_x249;
        const double var_x253 = var_x249 * var_chaste_interface__membrane__V;
        const double var_x254 = var_x228 * var_x253;
        const double var_x255 = var_x139 * var_x254;
        const double var_x256 = var_x145 * var_x254;
        const double var_x257 = -var_x255 - var_x256;
        const double var_x258 = var_x173 * var_x253;
        const double var_x259 = var_x163 * var_x258;
        const double var_x260 = var_x168 * var_x258;
        const double var_x261 = var_x3 * NV_Ith_S(mParameters, 5);
        const double var_x262 = 8.6345873774999993e-7 * var_x16 * var_x261;
        const double var_x263 = var_x35 * NV_Ith_S(mParameters, 5);
        const double var_x264 = 2.6376586874999999e-11 * var_x261 * var_x30;
        const double var_x265 = var_x40 * (var_x264 - 0.90000000000000002 * var_x220) + var_x40 * (4.7477856374999992e-10 * var_x263 - 0.90000000000000002 * var_x224);
        const double var_x266 = 0.64648681440406586 * var_x151;
        const double var_x267 = var_x143 * var_x266;
        const double var_x268 = 9.8743083358593546e-6 * var_x180;
        const double var_x269 = var_x166 * var_x268;
        const double var_x270 = var_x171 * var_x180;
        const double var_x271 = 9.5939859749999965e-8 * var_x2 * var_x261;
        const double var_x272 = 2.930731874999999e-12 * var_x24 * var_x261;
        const double var_x273 = var_x40 * (var_x272 - 0.099999999999999978 * var_x216) + var_x40 * (5.2753173749999984e-11 * var_x263 - 0.099999999999999978 * var_x224);
        const double var_x274 = 0.071831868267118404 * var_x151;
        const double var_x275 = var_x137 * var_x274;
        const double var_x276 = 1.0971453706510391e-6 * var_x180;
        const double var_x277 = var_x161 * var_x276;
        ...
        const double var_x285 = 3 * NV_Ith_S(mParameters, 2);
        ...
        const double var_x291 = 2.4510059584016866e-13 * var_x290;
        const double var_x292 = var_x73 * NV_Ith_S(mParameters, 2);
        const double var_x293 = var_x284 * var_x292 * var_x92;
        const double var_x294 = -var_x280 - var_x281 - 0.33000000000000002 * var_x293 - 3.0052592036063111e-5 * var_x283 - var_x287 * var_x291;
        ...
        const double var_x302 = 1.9830866390704552e-12 * var_x301;
        ...
        const double var_x305 = -var_x296 - var_x297 - 2.6699999999999999 * var_x304 - 0.00024315279010996517 * var_x303 - var_x299 * var_x302;
        ...
        const double var_x313 = 61.507432902288166 + var_chaste_interface__membrane__V;
        ...
        const double var_x319 = var_x311 - var_x309 - var_x312 + 0.11 * var_x315 - 4.9499999999999988e-9 * var_x318 - var_x291 * var_x317 - 0.00060294299999999999 * var_x313 * var_x84 / pow(var_x47, 2);
        ...
        const double var_x328 = var_x323 - var_x321 - var_x324 + 0.89000000000000001 * var_x325 - 4.0049999999999991e-8 * var_x327 - var_x302 * var_x326 - 0.0048783570000000007 * var_x313 * var_x99 / pow(var_x45, 2);
        ...
        const double var_x344 = NV_Ith_S(mParameters, 0) / (1.0 + var_x341 + var_x343);
        const double var_x345 = var_x339 * var_x344;
        const double var_x346 = (var_x343 - var_x341) * NV_Ith_S(mParameters, 0) / pow((3.5530476870814998e-7 + var_x342 + 1.3765399305573384e-7 * var_x340), 2);
        ...
        const double var_x358 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        ...
        const double var_x365 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V);
        const double var_x366 = 1.0 + var_x365;
        const double var_x367 = 1 / pow(var_x366, 2);
        const double var_x368 = var_x367 - var_chaste_interface__Fast_Na_Current__h;
        const double var_x369 = 1 / var_x364;
        const double var_x370 = var_x365 / pow(var_x366, 3);
        ...
        const double var_x379 = var_x367 - var_chaste_interface__Fast_Na_Current__j;
        ...
        const double var_x414 = exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__membrane__V);
        ...
        const double var_x423 = exp(1.4615384615384615 + var_x422);
        ...
        const double var_x432 = exp(3.8999999999999999 + var_x410);
        const double var_x433 = 1.0 + var_x432;
        const double var_x434 = 0.20000000000000001 * var_x432 / pow(var_x433, 2);
        const double var_x435 = 1 / var_x433;
        ...
        const double var_x450 = exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V);
        ...
        const double var_x461 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x462 = exp(2.8571428571428572 + var_x461);
        const double var_x463 = 1.0 + var_x462;
        const double var_x464 = var_x453 / pow(var_x454, 2);
        ...
        const double var_x471 = exp(5.0 + var_x461);
        ...
        const double var_x485 = var_chaste_interface__Calcium_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x486 = 20.0 * var_x482;
        const double var_x487 = var_x485 * var_x486;
        const double var_x488 = var_x475 * var_x476 / pow(var_x477, 2);
        const double var_x489 = 2.3772197685794643 * var_x488;
        const double var_x490 = 0.21130842387373014 * var_x488 * var_x83 / pow((1 - 0.93333333333333335 * var_x478), 2);
        const double var_x491 = var_x490 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x492 = var_x489 * var_chaste_interface__Calcium_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x493 = 7.5 - var_x479;
        const double var_x494 = 1.0 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        ...
        const double var_x507 = 6.567e-5 + 0.11 * var_x56 + 0.33000000000000002 * var_x117 + 0.33000000000000002 * var_x93 + 0.0028858573878494881 * var_x125;
        const double var_x508 = var_x337 * NV_Ith_S(mParameters, 6);
        const double var_x509 = 1830221710.9367216 * var_x508;
        const double var_x510 = var_x508 * var_x55;
        const double var_x511 = 201324388.20303938 * var_x184;
        const double var_x512 = var_x193 * var_x508;
        const double var_x513 = -2.6712338705498262e-6 + var_chaste_interface__membrane__V;
        const double var_x514 = var_x219 * var_x513;
        const double var_x515 = var_x505 * (var_x218 - 187179.41753901311 * var_x514);
        ...
        const double var_x523 = 0.00053133 + 0.89000000000000001 * var_x56 + 2.6699999999999999 * var_x107 + 2.6699999999999999 * var_x119 + 0.023349209774418588 * var_x122;
        const double var_x524 = 49324475.109744646 * var_x508;
        const double var_x525 = 43898782.847672731 * var_x189;
        const double var_x526 = var_x215 * var_x513;
        const double var_x527 = var_x521 * (var_x213 - 187179.41753901311 * var_x526);
        ...
        const double var_x533 = 6.0643000000000002e-5 - 0.22 * var_x93 - 0.0019239049252329922 * var_x125;
        const double var_x534 = 915110855.46836078 * var_x508;
        const double var_x535 = -1.3356169352749131e-6 + var_chaste_interface__membrane__V;
        const double var_x536 = var_x206 * var_x535;
        const double var_x537 = var_x505 * (var_x205 - 374358.83507802623 * var_x536);
        ...
        const double var_x542 = 0.00049065700000000003 - 1.78 * var_x107 - 0.015566139849612391 * var_x122;
        const double var_x543 = 24662237.554872323 * var_x508;
        const double var_x544 = var_x202 * var_x535;
        const double var_x545 = var_x521 * (var_x200 - 374358.83507802623 * var_x544);
        ...
        IJth(rJacobian, 2, 0) = 59.906641489902128 * (-var_chaste_interface__Fast_Na_Current__m + 1 / pow(var_x359, 2)) * (-var_x360 * (-0.3792264410025028 - 0.0082818615637148471 * var_chaste_interface__membrane__V) - var_x361 * (0.0036911829173615863 - 0.00076532923851577563 * var_chaste_interface__membrane__V)) / pow((var_x357 + 0.5020897832817337 * var_x356), 2) + 0.22148394241417499 * var_x358 * var_x362 / pow(var_x359, 3);
        IJth(rJacobian, 3, 0) = ((var_x371) ? (-1.5943741588156124 * var_x369 * var_x370 + 0.53361261261261261 * var_x363 * var_x368 / pow(var_x364, 2)) : (var_x368 * (108035.0 * var_x372 + 0.21330000000000002 * var_x373 - 0.008382352941176471 * var_x374) - var_x378 * (var_x375 + var_x376 + var_x377)));
        ...
        IJth(rJacobian, 6, 0) = -7.1529673512819408e-5 * var_x416 * (-var_chaste_interface__Slowly_Activating_K_Current__x_Ks + 1 / var_x415) + 0.070175438596491224 * var_x414 * (0.00100999899000101 + var_x417) / pow(var_x415, 2);
        IJth(rJacobian, 7, 0) = var_x421 * var_x425 + 0.0074074074074074077 * var_x418 * (var_x426 - var_chaste_interface__Transient_Outward_K_Current__x_to_s) / (pow(var_x419, 2) * pow((0.055555555555555552 + var_x420), 2));
        IJth(rJacobian, 8, 0) = -var_x431 * var_x434 + 0.000125 * var_x428 * (var_x435 - var_chaste_interface__Transient_Outward_K_Current__y_to_s) / (pow(var_x429, 2) * pow((0.037499999999999999 + var_x430), 2));
        IJth(rJacobian, 9, 0) = var_x425 * var_x437 - 0.11764705882352941 * var_x436 * (-0.035999999999999997 - 0.00080000000000000004 * var_chaste_interface__membrane__V) * (var_x426 - var_chaste_interface__Transient_Outward_K_Current__x_to_f) / pow((0.058823529411764705 + var_x436), 2);
        IJth(rJacobian, 10, 0) = -var_x434 * var_x439 - 0.011764705882352941 * var_x438 * (-0.36363636363636365 - 0.0090909090909090905 * var_chaste_interface__membrane__V) * (var_x435 - var_chaste_interface__Transient_Outward_K_Current__y_to_f) / pow((0.082352941176470587 + var_x438), 2);
        IJth(rJacobian, 11, 0) = 0.51020408163265307 * (-var_chaste_interface__L_Type_Calcium_Current__d + 1 / var_x451) * (-0.050000000000000003 * var_x440 / pow(var_x441, 2) + 0.27999999999999997 * var_x443 * var_x448 / pow(var_x444, 2) - 0.15076923076923074 * var_x445 * var_x446 / pow(var_x447, 2)) / pow((var_x449 + 0.7142857142857143 * var_x442), 2) + 0.16666666666666666 * var_x450 * var_x452 / pow(var_x451, 2);
        IJth(rJacobian, 12, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_Type_Calcium_Current__f + 1 / var_x463) * (18.0 * var_x464 - var_x465 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x457 / pow(var_x458, 2)) / pow((0.018140589569160998 + var_x460 + 0.16326530612244897 * var_x455 + 0.18140589569160998 * var_x459), 2) - 0.14285714285714285 * var_x462 * var_x466 / pow(var_x463, 2);
        IJth(rJacobian, 13, 0) = 1.1111111111111112e-5 * (0.33000000000000002 - var_chaste_interface__L_Type_Calcium_Current__f_2 + 0.67000000000000004 / var_x472) * (1.6000000000000001 * var_x464 - var_x473 * (-0.29411764705882354 - 0.011764705882352941 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x467 / pow(var_x468, 2)) / pow((var_x470 + 0.10333333333333333 * var_x469 + 0.053333333333333337 * var_x455), 2) - 0.095714285714285724 * var_x471 * var_x474 / pow(var_x472, 2);
        IJth(rJacobian, 30, 0) = -var_x509 * ((var_x155) ? (var_x507 + var_x32 * var_x506) : (var_x169 + var_x182 + var_x507 - var_x178));
        IJth(rJacobian, 31, 0) = -var_x524 * ((var_x155) ? (var_x523 + var_x29 * var_x522) : (var_x164 + var_x181 + var_x523 - var_x177));
        IJth(rJacobian, 35, 0) = -var_x534 * ((var_x129) ? (var_x533 + var_x18 * var_x506) : (var_x146 + var_x152 + var_x533 - var_x149));
        IJth(rJacobian, 36, 0) = -var_x543 * ((var_x129) ? (var_x542 + var_x10 * var_x522) : (var_x140 + var_x153 + var_x542 - var_x150));
        IJth(rJacobian, 1, 1) = -7.0788000000000011 + var_x330 + var_x331 + var_x332 + var_x333 + var_x334 + var_x335 + var_x336 - var_x338 + 3.4188518090540365e-8 * var_x347 - 270818.42237280885 * var_x345;
        IJth(rJacobian, 19, 1) = 2.2890000000000006 - var_x332;
        IJth(rJacobian, 20, 1) = 0.33180000000000004 - var_x333 - var_x334;
        IJth(rJacobian, 22, 1) = 0.81600000000000006 - var_x330;
        IJth(rJacobian, 23, 1) = 1.9320000000000004 - var_x335 - var_x336;
        IJth(rJacobian, 25, 1) = 1.71 - var_x331;
        IJth(rJacobian, 36, 1) = 17.724211778703154 * var_x337;
        IJth(rJacobian, 37, 1) = 5029484.9869235931 * var_x345 - 6.3492962168146398e-7 * var_x347;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.33000000000000002 * var_x187 - 2.6699999999999999 * var_x190);
        IJth(rJacobian, 2, 2) = -var_x362;
        IJth(rJacobian, 30, 2) = -603973164.6091181 * var_x187 * var_x508;
        IJth(rJacobian, 31, 2) = -131696348.54301821 * var_x190 * var_x508;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x191 * var_x55 - var_x192 * var_x55);
        IJth(rJacobian, 3, 3) = ((var_x371) ? (-5.9230999999999998 * var_x369) : (-var_x375 - var_x376 - var_x377));
        IJth(rJacobian, 30, 3) = -var_x510 * var_x511;
        IJth(rJacobian, 31, 3) = -var_x510 * var_x525;
        ...
        IJth(rJacobian, 30, 4) = -var_x511 * var_x512;
        IJth(rJacobian, 31, 4) = -var_x512 * var_x525;
        ...
        IJth(rJacobian, 10, 10) = -var_x439;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x129) ? (var_x226 + var_x14 * var_x204 + var_x208 * var_x21) : ((var_x155) ? (var_x226 + var_x232) : (var_x232 - var_x234 - var_x235 - var_x227 * var_x236))));
        IJth(rJacobian, 11, 11) = -var_x452;
        IJth(rJacobian, 30, 11) = -var_x509 * ((var_x155) ? (var_x13 * var_x515) : (var_x235));
        IJth(rJacobian, 31, 11) = -var_x524 * ((var_x155) ? (var_x13 * var_x527) : (var_x234));
        IJth(rJacobian, 35, 11) = -var_x534 * ((var_x129) ? (var_x13 * var_x537) : (var_x231));
        IJth(rJacobian, 36, 11) = -var_x543 * ((var_x129) ? (var_x13 * var_x545) : (var_x230));
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x129) ? (var_x240 + var_x204 * var_x238 + var_x208 * var_x239) : ((var_x155) ? (var_x240 + var_x245) : (var_x245 - var_x247 - var_x248 - var_x236 * var_x241))));
        IJth(rJacobian, 12, 12) = -var_x466;
        IJth(rJacobian, 30, 12) = -var_x509 * ((var_x155) ? (var_x237 * var_x515) : (var_x248));
        IJth(rJacobian, 31, 12) = -var_x524 * ((var_x155) ? (var_x237 * var_x527) : (var_x247));
        IJth(rJacobian, 35, 12) = -var_x534 * ((var_x129) ? (var_x237 * var_x537) : (var_x244));
        IJth(rJacobian, 36, 12) = -var_x543 * ((var_x129) ? (var_x237 * var_x545) : (var_x243));
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x129) ? (var_x252 + var_x204 * var_x250 + var_x208 * var_x251) : ((var_x155) ? (var_x252 + var_x257) : (var_x257 - var_x259 - var_x260 - var_x236 * var_x253))));
        IJth(rJacobian, 13, 13) = -var_x474;
        IJth(rJacobian, 30, 13) = -var_x509 * ((var_x155) ? (var_x249 * var_x515) : (var_x260));
        IJth(rJacobian, 31, 13) = -var_x524 * ((var_x155) ? (var_x249 * var_x527) : (var_x259));
        IJth(rJacobian, 35, 13) = -var_x534 * ((var_x129) ? (var_x249 * var_x537) : (var_x256));
        IJth(rJacobian, 36, 13) = -var_x543 * ((var_x129) ? (var_x249 * var_x545) : (var_x255));
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x129) ? (var_x265 + var_x40 * (var_x262 - 0.90000000000000002 * var_x207)) : ((var_x155) ? (var_x265 + var_x267) : (var_x267 + var_x269 + 0.0001777375500454684 * var_x270))));
        IJth(rJacobian, 14, 14) = -0.011900000000000001 - 1.7 * var_chaste_interface__Calcium_Concentrations__Ca_j;
        IJth(rJacobian, 30, 14) = -var_x509 * ((var_x155) ? (var_x40 * (-var_x264 + 168461.4757851118 * var_x514)) : (-var_x269));
        IJth(rJacobian, 35, 14) = -var_x534 * ((var_x129) ? (var_x40 * (-var_x262 + 336922.95157022361 * var_x536)) : (-var_x267));
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x129) ? (var_x273 + var_x40 * (var_x271 - 0.099999999999999978 * var_x203)) : ((var_x155) ? (var_x273 + var_x275) : (var_x275 + var_x277 + 1.9748616671718706e-5 * var_x270))));
        IJth(rJacobian, 15, 15) = -0.011900000000000001 - 1.7 * var_chaste_interface__Calcium_Concentrations__Ca_sl;
        IJth(rJacobian, 31, 15) = -var_x524 * ((var_x155) ? (var_x40 * (-var_x272 + 18717.941753901305 * var_x526)) : (-var_x277));
        IJth(rJacobian, 36, 15) = -var_x543 * ((var_x129) ? (var_x40 * (-var_x271 + 37435.88350780261 * var_x544)) : (-var_x275));
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x481 + var_x484;
        IJth(rJacobian, 17, 16) = var_x483;
        IJth(rJacobian, 18, 16) = var_x484;
        IJth(rJacobian, 16, 17) = 0.055;
        IJth(rJacobian, 17, 17) = -0.059999999999999998 + var_x481;
        IJth(rJacobian, 18, 17) = var_x484 + var_x493 * var_chaste_interface__Calcium_Concentrations__Ca_j;
        ...
        IJth(rJacobian, 18, 18) = -0.065000000000000002 + var_x484;
        IJth(rJacobian, 1, 19) = 0.019599999999999999 + var_x348;
        IJth(rJacobian, 19, 19) = -0.019599999999999999 - var_x348;
        IJth(rJacobian, 1, 20) = 0.003032 + var_x349;
        IJth(rJacobian, 20, 20) = -3.1999999999999999e-5 + var_x495;
        IJth(rJacobian, 21, 20) = -0.0030000000000000001;
        IJth(rJacobian, 1, 21) = 0.0063300000000000006 + var_x349;
        IJth(rJacobian, 20, 21) = var_x495;
        IJth(rJacobian, 21, 21) = -0.0063300000000000006;
        IJth(rJacobian, 1, 22) = 0.23799999999999999 + var_x350;
        IJth(rJacobian, 22, 22) = -0.23799999999999999 - var_x350;
        IJth(rJacobian, 1, 23) = 0.016159999999999997 + var_x351;
        IJth(rJacobian, 23, 23) = -0.00046000000000000001 + var_x496;
        IJth(rJacobian, 24, 23) = -0.015699999999999999;
        IJth(rJacobian, 1, 24) = 0.015757 + var_x351;
        IJth(rJacobian, 23, 24) = var_x496;
        IJth(rJacobian, 24, 24) = -0.015757;
        IJth(rJacobian, 1, 25) = 0.059999999999999998 + var_x352;
        IJth(rJacobian, 25, 25) = -0.059999999999999998 - var_x352;
        IJth(rJacobian, 26, 26) = -1.3 + var_x498;
        IJth(rJacobian, 35, 26) = 1.3 + var_x497;
        IJth(rJacobian, 27, 27) = -1.3 + var_x501;
        IJth(rJacobian, 36, 27) = 1.3 + var_x500;
        IJth(rJacobian, 28, 28) = -0.029999999999999999 + var_x498;
        IJth(rJacobian, 35, 28) = 0.029999999999999999 + var_x497;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x501;
        IJth(rJacobian, 36, 29) = 0.029999999999999999 + var_x500;
        IJth(rJacobian, 0, 30) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x155) ? (var_x294 + var_x22 * var_x279) : (var_x294 - var_x295)));
        IJth(rJacobian, 30, 30) = -0.0007561 + var_x516 - var_x517 - var_x509 * ((var_x155) ? (var_x519 + var_x279 * var_x506) : (var_x295 + var_x519));
        IJth(rJacobian, 31, 30) = 0.087152885187388451 * var_x337;
        IJth(rJacobian, 33, 30) = 0.0007561 - var_x516;
        IJth(rJacobian, 35, 30) = -var_x534 * (-0.66000000000000003 * var_x293 - var_x287 * var_x538);
        IJth(rJacobian, 0, 31) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x155) ? (var_x305 + var_x15 * var_x279) : (var_x305 - var_x306)));
        IJth(rJacobian, 30, 31) = var_x517;
        IJth(rJacobian, 31, 31) = -0.000165 + var_x528 - 7.8853682331945265 * var_x337 - var_x524 * ((var_x155) ? (var_x530 + var_x279 * var_x522) : (var_x306 + var_x530));
        IJth(rJacobian, 32, 31) = var_x532;
        IJth(rJacobian, 34, 31) = 0.000165 - var_x528;
        IJth(rJacobian, 36, 31) = -var_x543 * (-5.3399999999999999 * var_x304 - var_x299 * var_x546);
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-0.48963716847178318 * var_x194 * var_x48);
        IJth(rJacobian, 31, 32) = 7.7982153480071386 * var_x337;
        IJth(rJacobian, 32, 32) = -var_x532;
        IJth(rJacobian, 30, 33) = 0.001 + var_x520;
        IJth(rJacobian, 33, 33) = -0.001 - var_x520;
        IJth(rJacobian, 31, 34) = 0.001 + var_x531;
        IJth(rJacobian, 34, 34) = -0.001 - var_x531;
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x129) ? (var_x319 + var_x22 * var_x308) : (var_x319 - var_x320)));
        IJth(rJacobian, 14, 35) = 1.7 - 1.7 * var_chaste_interface__L_Type_Calcium_Current__f_Ca_B_j;
        IJth(rJacobian, 16, 35) = -var_x487 + var_x480 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        IJth(rJacobian, 17, 35) = var_x487 + var_x480 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        IJth(rJacobian, 18, 35) = var_x493 * var_chaste_interface__SR_Fluxes__Ry_Ro + var_x486 * var_x494 * var_chaste_interface__Calcium_Concentrations__Ca_j;
        IJth(rJacobian, 26, 35) = 55.473098330241193 - var_x499;
        IJth(rJacobian, 28, 35) = 19.897959183673471 - var_x503;
        IJth(rJacobian, 30, 35) = -var_x509 * (1.4849999999999997e-8 * var_x318 - 0.33000000000000002 * var_x315 + var_x317 * var_x518);
        IJth(rJacobian, 35, 35) = -75.377506864564012 + var_x499 + var_x503 - var_x539 - var_x540 - var_x534 * ((var_x129) ? (var_x541 + var_x308 * var_x506) : (var_x320 + var_x541));
        IJth(rJacobian, 36, 35) = 3.9220939916716242 * var_x337;
        IJth(rJacobian, 37, 35) = 9.9320000000000005e-5 + var_x548;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x129) ? (var_x328 + var_x15 * var_x308) : (var_x328 - var_x329)));
        IJth(rJacobian, 1, 36) = var_x338;
        IJth(rJacobian, 15, 36) = 1.7 - 1.7 * var_chaste_interface__L_Type_Calcium_Current__f_Ca_B_sl;
        IJth(rJacobian, 27, 36) = 121.55000000000001 - var_x502;
        IJth(rJacobian, 29, 36) = 43.550000000000004 - var_x504;
        IJth(rJacobian, 31, 36) = -var_x524 * (1.2014999999999997e-7 * var_x327 - 2.6699999999999999 * var_x325 + var_x326 * var_x529);
        IJth(rJacobian, 35, 36) = var_x540;
        IJth(rJacobian, 36, 36) = -165.10000000000002 + var_x502 + var_x504 - 21.646305770374777 * var_x337 - var_x543 * ((var_x129) ? (var_x547 + var_x308 * var_x522) : (var_x329 + var_x547));
        IJth(rJacobian, 1, 37) = 0.037279237232671424 * var_x354 + 4.7061860318210743e-15 * var_x355;
        IJth(rJacobian, 16, 37) = -var_x491 + var_x485 * var_x489;
        IJth(rJacobian, 17, 37) = var_x491 + var_x492;
        IJth(rJacobian, 18, 37) = -var_x492 + var_x490 * var_x494;
        IJth(rJacobian, 35, 37) = 0.00644935064935065 + var_x539;
        IJth(rJacobian, 37, 37) = -260.00009932 + var_x549 - var_x548 - 0.69232869146389786 * var_x354 - 8.7400597733819945e-14 * var_x355;
        IJth(rJacobian, 38, 37) = 260.0 - var_x549;
        IJth(rJacobian, 37, 38) = 65.0 + var_x550;
        IJth(rJacobian, 38, 38) = -65.0 - var_x550;
    }
