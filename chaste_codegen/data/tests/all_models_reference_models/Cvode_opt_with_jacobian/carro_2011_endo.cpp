...
// LCOV_EXCL_STOP
    ...
    void Cellcarro_2011_endoFromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__environment__t, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -84.10546
        double var_chaste_interface__Calcium_Concentrations__Ca_i = NV_Ith_S(rY, 1);
...
const double var_x0 = exp(7.4880000000000004 - 0.16722408026755853 * var_chaste_interface__membrane__V);
        ...
        const double var_x245 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V);
        const double var_x246 = 1.0 + var_x245;
        const double var_x247 = 1 / pow(var_x246, 2);
        const double var_x248 = var_x247 - var_chaste_interface__Fast_Na_Current__h;
        const double var_x249 = 1 / var_x244;
        const double var_x250 = var_x245 / pow(var_x246, 3);
        ...
        const double var_x258 = 0.26917900403768508 * var_x250;
        const double var_x259 = var_x247 - var_chaste_interface__Fast_Na_Current__j;
        ...
        const double var_x294 = exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__membrane__V);
        ...
        const double var_x303 = exp(1.4615384615384615 + var_x302);
        const double var_x304 = 1.0 + var_x303;
        const double var_x305 = 0.076923076923076927 * var_x303 / pow(var_x304, 2);
        const double var_x306 = 1 / var_x304;
        ...
        const double var_x312 = exp(3.8999999999999999 + var_x290);
        const double var_x313 = 1.0 + var_x312;
        const double var_x314 = 0.20000000000000001 * var_x312 / pow(var_x313, 2);
        const double var_x315 = 1 / var_x313;
        ...
        const double var_x330 = exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V);
        ...
        const double var_x341 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x342 = exp(2.8571428571428572 + var_x341);
        const double var_x343 = 1.0 + var_x342;
        const double var_x344 = var_x333 / pow(var_x334, 2);
        ...
        const double var_x351 = exp(5.0 + var_x341);
        ...
        const double var_x365 = var_chaste_interface__Calcium_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x366 = 20.0 * var_x362;
        const double var_x367 = var_x365 * var_x366;
        const double var_x368 = var_x355 * var_x356 / pow(var_x357, 2);
        const double var_x369 = 2.3772197685794643 * var_x368;
        const double var_x370 = 0.21130842387373014 * var_x368 * var_x41 / pow((1 - 0.93333333333333335 * var_x358), 2);
        const double var_x371 = var_x370 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x372 = var_x369 * var_chaste_interface__Calcium_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x373 = 7.5 - var_x359;
        const double var_x374 = 1.0 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        ...
        const double var_x385 = var_x217 * NV_Ith_S(mParameters, 6);
        const double var_x386 = 1830221710.9367216 * var_x385;
        const double var_x387 = var_x13 * var_x385;
        const double var_x388 = 201324388.20303938 * var_x138;
        const double var_x389 = var_x147 * var_x385;
        const double var_x390 = 18072.173496773241 * var_x385;
        const double var_x391 = var_x120 * var_x390;
        ...
        const double var_x397 = 43898782.847672731 * var_x143;
        const double var_x398 = 54.116119526448742 * var_x385;
        const double var_x399 = var_x115 * var_x398;
        ...
        const double var_x405 = 591607101.77832007 * var_x385;
        const double var_x406 = var_x405 * var_x94;
        ...
        const double var_x411 = 1771534.599213969 * var_x385;
        const double var_x412 = var_x100 * var_x411;
        ...
        IJth(rJacobian, 3, 0) = ((var_x251) ? (-1.5943741588156124 * var_x249 * var_x250 + 0.53361261261261261 * var_x243 * var_x248 / pow(var_x244, 2)) : (var_x248 * (108035.0 * var_x252 + 0.21330000000000002 * var_x253 - 0.008382352941176471 * var_x254) - var_x258 * (var_x255 + var_x256 + var_x257)));
        IJth(rJacobian, 4, 0) = ((var_x251) ? (0.034200000000000001 * var_x259 * var_x263 - 0.16150740242261102 * var_x250 * var_x263 + 0.059999999999999998 * var_x259 * var_x260 * var_x262 / pow(var_x261, 2)) : (var_x259 * (var_x270 - 0.00025500480000000003 * var_x274 + var_x269 * var_x275 * (3.0508668000000001e-7 * var_x265 - 6214.6032000000005 * var_x264) + 0.0033402720000000005 * var_x271 * var_x273 / pow(var_x272, 2) - 0.311 * var_x266 * var_x267 * var_x275 / pow(var_x268, 2)) - var_x258 * (var_x276 + var_x277)));
        IJth(rJacobian, 5, 0) = 9.1827364554637282e-8 * (-var_chaste_interface__Rapidly_Activating_K_Current__x_Kr + 1 / var_x292) * (11.5 * var_x279 / pow(var_x280, 2) + 366.66666666666669 * var_x283 * var_x288 / pow(var_x284, 2) - 366.66666666666669 * var_x285 * var_x286 / pow(var_x287, 2)) / pow((var_x289 + 0.069696969696969702 * var_x281), 2) + 0.20000000000000001 * var_x291 * var_x293 / pow(var_x292, 2);
        IJth(rJacobian, 6, 0) = -7.1529673512819408e-5 * var_x296 * (-var_chaste_interface__Slowly_Activating_K_Current__x_Ks + 1 / var_x295) + 0.070175438596491224 * var_x294 * (0.00100999899000101 + var_x297) / pow(var_x295, 2);
        IJth(rJacobian, 7, 0) = var_x301 * var_x305 + 0.0074074074074074077 * var_x298 * (var_x306 - var_chaste_interface__Transient_Outward_K_Current__x_to_s) / (pow(var_x299, 2) * pow((0.055555555555555552 + var_x300), 2));
        IJth(rJacobian, 8, 0) = -var_x311 * var_x314 + 0.000125 * var_x308 * (var_x315 - var_chaste_interface__Transient_Outward_K_Current__y_to_s) / (pow(var_x309, 2) * pow((0.037499999999999999 + var_x310), 2));
        IJth(rJacobian, 9, 0) = var_x305 * var_x317 - 0.11764705882352941 * var_x316 * (-0.035999999999999997 - 0.00080000000000000004 * var_chaste_interface__membrane__V) * (var_x306 - var_chaste_interface__Transient_Outward_K_Current__x_to_f) / pow((0.058823529411764705 + var_x316), 2);
        IJth(rJacobian, 10, 0) = -var_x314 * var_x319 - 0.011764705882352941 * var_x318 * (-0.36363636363636365 - 0.0090909090909090905 * var_chaste_interface__membrane__V) * (var_x315 - var_chaste_interface__Transient_Outward_K_Current__y_to_f) / pow((0.082352941176470587 + var_x318), 2);
        IJth(rJacobian, 11, 0) = 0.51020408163265307 * (-var_chaste_interface__L_Type_Calcium_Current__d + 1 / var_x331) * (-0.050000000000000003 * var_x320 / pow(var_x321, 2) + 0.27999999999999997 * var_x323 * var_x328 / pow(var_x324, 2) - 0.15076923076923074 * var_x325 * var_x326 / pow(var_x327, 2)) / pow((var_x329 + 0.7142857142857143 * var_x322), 2) + 0.16666666666666666 * var_x330 * var_x332 / pow(var_x331, 2);
        IJth(rJacobian, 12, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_Type_Calcium_Current__f + 1 / var_x343) * (18.0 * var_x344 - var_x345 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x337 / pow(var_x338, 2)) / pow((0.018140589569160998 + var_x340 + 0.16326530612244897 * var_x335 + 0.18140589569160998 * var_x339), 2) - 0.14285714285714285 * var_x342 * var_x346 / pow(var_x343, 2);
        IJth(rJacobian, 13, 0) = 1.1111111111111112e-5 * (0.33000000000000002 - var_chaste_interface__L_Type_Calcium_Current__f_2 + 0.67000000000000004 / var_x352) * (1.6000000000000001 * var_x344 - var_x353 * (-0.29411764705882354 - 0.011764705882352941 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x347 / pow(var_x348, 2)) / pow((var_x350 + 0.10333333333333333 * var_x349 + 0.053333333333333337 * var_x335), 2) - 0.095714285714285724 * var_x351 * var_x354 / pow(var_x352, 2);
        IJth(rJacobian, 30, 0) = -var_x386 * (6.567e-5 + var_x122 + var_x133 - var_x126 + 0.11 * var_x14 + 0.33000000000000002 * var_x51 + 0.33000000000000002 * var_x75 + 0.0028858573878494881 * var_x83);
        IJth(rJacobian, 31, 0) = -var_x396 * (0.00053133 + var_x117 + var_x132 - var_x125 + 0.89000000000000001 * var_x14 + 2.6699999999999999 * var_x65 + 2.6699999999999999 * var_x77 + 0.023349209774418588 * var_x80);
        IJth(rJacobian, 35, 0) = -var_x404 * (6.0643000000000002e-5 + var_x136 + var_x96 - var_x130 - 0.22 * var_x51 - 0.0019239049252329922 * var_x83);
        IJth(rJacobian, 36, 0) = -var_x410 * (0.00049065700000000003 + var_x102 + var_x135 - var_x129 - 1.78 * var_x65 - 0.015566139849612391 * var_x80);
        ...
        IJth(rJacobian, 30, 2) = -603973164.6091181 * var_x141 * var_x385;
        IJth(rJacobian, 31, 2) = -131696348.54301821 * var_x144 * var_x385;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x13 * var_x145 - var_x13 * var_x146);
        IJth(rJacobian, 3, 3) = ((var_x251) ? (-5.9230999999999998 * var_x249) : (-var_x255 - var_x256 - var_x257));
        IJth(rJacobian, 30, 3) = -var_x387 * var_x388;
        IJth(rJacobian, 31, 3) = -var_x387 * var_x397;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x145 * var_x147 - var_x146 * var_x147);
        IJth(rJacobian, 4, 4) = ((var_x251) ? (-0.59999999999999998 * var_x263) : (-var_x276 - var_x277));
        IJth(rJacobian, 30, 4) = -var_x388 * var_x389;
        IJth(rJacobian, 31, 4) = -var_x389 * var_x397;
        ...
        IJth(rJacobian, 6, 6) = -0.00100999899000101 - var_x297;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x149 * var_x8);
        IJth(rJacobian, 7, 7) = -var_x301;
        ...
        IJth(rJacobian, 11, 11) = -var_x332;
        IJth(rJacobian, 30, 11) = -var_x152 * var_x391;
        IJth(rJacobian, 31, 11) = -var_x152 * var_x399;
        IJth(rJacobian, 35, 11) = -var_x151 * var_x406;
        IJth(rJacobian, 36, 11) = -var_x151 * var_x412;
        ...
        IJth(rJacobian, 12, 12) = -var_x346;
        IJth(rJacobian, 30, 12) = -var_x157 * var_x391;
        IJth(rJacobian, 31, 12) = -var_x157 * var_x399;
        IJth(rJacobian, 35, 12) = -var_x156 * var_x406;
        IJth(rJacobian, 36, 12) = -var_x156 * var_x412;
        ...
        IJth(rJacobian, 13, 13) = -var_x354;
        IJth(rJacobian, 30, 13) = -var_x160 * var_x391;
        IJth(rJacobian, 31, 13) = -var_x160 * var_x399;
        IJth(rJacobian, 35, 13) = -var_x159 * var_x406;
        IJth(rJacobian, 36, 13) = -var_x159 * var_x412;
        ...
        IJth(rJacobian, 30, 14) = var_x119 * var_x131 * var_x390;
        IJth(rJacobian, 35, 14) = var_x134 * var_x405 * var_x93;
        ...
        IJth(rJacobian, 31, 15) = var_x114 * var_x131 * var_x398;
        IJth(rJacobian, 36, 15) = var_x134 * var_x411 * var_x99;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x361 + var_x364;
        IJth(rJacobian, 17, 16) = var_x363;
        IJth(rJacobian, 18, 16) = var_x364;
        IJth(rJacobian, 16, 17) = 0.055;
        IJth(rJacobian, 17, 17) = -0.059999999999999998 + var_x361;
        IJth(rJacobian, 18, 17) = var_x364 + var_x373 * var_chaste_interface__Calcium_Concentrations__Ca_j;
        ...
        IJth(rJacobian, 18, 18) = -0.065000000000000002 + var_x364;
        ...
        IJth(rJacobian, 23, 23) = -0.00046000000000000001 + var_x376;
        IJth(rJacobian, 24, 23) = -0.015699999999999999;
        IJth(rJacobian, 1, 24) = 0.015757 + var_x231;
        IJth(rJacobian, 23, 24) = var_x376;
        ...
        IJth(rJacobian, 26, 26) = -1.3 + var_x378;
        IJth(rJacobian, 35, 26) = 1.3 + var_x377;
        IJth(rJacobian, 27, 27) = -1.3 + var_x381;
        IJth(rJacobian, 36, 27) = 1.3 + var_x380;
        IJth(rJacobian, 28, 28) = -0.029999999999999999 + var_x378;
        IJth(rJacobian, 35, 28) = 0.029999999999999999 + var_x377;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x381;
        IJth(rJacobian, 36, 29) = 0.029999999999999999 + var_x380;
        ...
        IJth(rJacobian, 30, 30) = -0.0007561 + var_x392 - var_x393 - var_x386 * (var_x166 + var_x167 + var_x180 + 9.0157776108189337e-5 * var_x169 + 0.98999999999999999 * var_x179 + var_x173 * var_x394);
        IJth(rJacobian, 31, 30) = 0.087152885187388451 * var_x217;
        IJth(rJacobian, 33, 30) = 0.0007561 - var_x392;
        IJth(rJacobian, 35, 30) = -var_x404 * (-0.66000000000000003 * var_x179 - var_x173 * var_x407);
        ...
        IJth(rJacobian, 30, 31) = var_x393;
        IJth(rJacobian, 31, 31) = -0.000165 + var_x400 - 7.8853682331945265 * var_x217 - var_x396 * (var_x181 + var_x182 + var_x190 + 8.0099999999999998 * var_x189 + 0.00072945837032989554 * var_x188 + var_x184 * var_x401);
        IJth(rJacobian, 32, 31) = var_x403;
        IJth(rJacobian, 34, 31) = 0.000165 - var_x400;
        IJth(rJacobian, 36, 31) = -var_x410 * (-5.3399999999999999 * var_x189 - var_x184 * var_x413);
        ...
        IJth(rJacobian, 32, 32) = -var_x403;
        IJth(rJacobian, 30, 33) = 0.001 + var_x395;
        IJth(rJacobian, 33, 33) = -0.001 - var_x395;
        IJth(rJacobian, 31, 34) = 0.001 + var_x402;
        IJth(rJacobian, 34, 34) = -0.001 - var_x402;
        ...
        IJth(rJacobian, 16, 35) = -var_x367 + var_x360 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        IJth(rJacobian, 17, 35) = var_x367 + var_x360 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        IJth(rJacobian, 18, 35) = var_x373 * var_chaste_interface__SR_Fluxes__Ry_Ro + var_x366 * var_x374 * var_chaste_interface__Calcium_Concentrations__Ca_j;
        IJth(rJacobian, 26, 35) = 55.473098330241193 - var_x379;
        IJth(rJacobian, 28, 35) = 19.897959183673471 - var_x383;
        IJth(rJacobian, 30, 35) = -var_x386 * (1.4849999999999997e-8 * var_x200 - 0.33000000000000002 * var_x197 + var_x199 * var_x394);
        IJth(rJacobian, 35, 35) = -75.377506864564012 + var_x379 + var_x383 - var_x408 - var_x409 - var_x404 * (var_x191 + var_x194 + var_x201 - var_x193 + 0.22 * var_x197 - 9.8999999999999977e-9 * var_x200 - var_x199 * var_x407);
        IJth(rJacobian, 36, 35) = 3.9220939916716242 * var_x217;
        IJth(rJacobian, 37, 35) = 9.9320000000000005e-5 + var_x414;
        ...
        IJth(rJacobian, 27, 36) = 121.55000000000001 - var_x382;
        IJth(rJacobian, 29, 36) = 43.550000000000004 - var_x384;
        IJth(rJacobian, 31, 36) = -var_x396 * (1.2014999999999997e-7 * var_x208 - 2.6699999999999999 * var_x206 + var_x207 * var_x401);
        IJth(rJacobian, 35, 36) = var_x409;
        IJth(rJacobian, 36, 36) = -165.10000000000002 + var_x382 + var_x384 - 21.646305770374777 * var_x217 - var_x410 * (var_x202 + var_x205 + var_x209 - var_x204 + 1.78 * var_x206 - 8.0099999999999983e-8 * var_x208 - var_x207 * var_x413);
        IJth(rJacobian, 1, 37) = 0.037279237232671424 * var_x234 + 4.7061860318210743e-15 * var_x235;
        IJth(rJacobian, 16, 37) = -var_x371 + var_x365 * var_x369;
        IJth(rJacobian, 17, 37) = var_x371 + var_x372;
        IJth(rJacobian, 18, 37) = -var_x372 + var_x370 * var_x374;
        IJth(rJacobian, 35, 37) = 0.00644935064935065 + var_x408;
        IJth(rJacobian, 37, 37) = -260.00009932 + var_x415 - var_x414 - 0.69232869146389786 * var_x234 - 8.7400597733819945e-14 * var_x235;
        IJth(rJacobian, 38, 37) = 260.0 - var_x415;
        IJth(rJacobian, 37, 38) = 65.0 + var_x416;
        IJth(rJacobian, 38, 38) = -65.0 - var_x416;
    }
