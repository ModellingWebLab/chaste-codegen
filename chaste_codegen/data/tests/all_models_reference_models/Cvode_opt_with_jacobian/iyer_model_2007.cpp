...
// LCOV_EXCL_STOP
        ...
        const double var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__IKv14_Na = ((fabs(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) < 2.671139896373057e-6) ? (-187186.00275444688 * (-2.671139896373057e-6 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * (-8.0301527601600006e-12 * (-NV_Ith_S(mParameters, 4) + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai * exp(1.0000000000000001e-7)) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14 / (-1.0 + exp(1.0000000000000001e-7)) - 8.0301527601600006e-12 * (-NV_Ith_S(mParameters, 4) + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai * exp(-1.0000000000000001e-7)) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14 / (-1.0 + exp(-1.0000000000000001e-7))) + 8.0301527601600006e-12 * (-NV_Ith_S(mParameters, 4) + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai * exp(1.0000000000000001e-7)) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14 / (-1.0 + exp(1.0000000000000001e-7))) : (3.006264393363878e-6 * (-NV_Ith_S(mParameters, 4) + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai * _lt_0_row[2]) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14 / (_lt_0_row[3]))); // uA_per_uF
        ...
        const double var_COMPUTE_ICa_ICaK__ICamax = ((fabs(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) < 1.3355699481865285e-6) ? (-374372.00550889375 * (-1.3355699481865285e-6 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * (-0.019300000000000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * NV_Ith_S(mParameters, 2)) * ((var_environment__iso == 0) ? (7.0 * NV_Ith_S(mParameters, 5)) : (10.5 * NV_Ith_S(mParameters, 5))) / (-1.0 + exp(1.0000000000000001e-7)) - 0.019300000000000001 * (0.001 * exp(-1.0000000000000001e-7) - 0.34100000000000003 * NV_Ith_S(mParameters, 2)) * ((var_environment__iso == 0) ? (7.0 * NV_Ith_S(mParameters, 5)) : (10.5 * NV_Ith_S(mParameters, 5))) / (-1.0 + exp(-1.0000000000000001e-7))) + 0.019300000000000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * NV_Ith_S(mParameters, 2)) * ((var_environment__iso == 0) ? (7.0 * NV_Ith_S(mParameters, 5)) : (10.5 * NV_Ith_S(mParameters, 5))) / (-1.0 + exp(1.0000000000000001e-7))) : (14450.7594126433 * (_lt_0_row[0] - 0.34100000000000003 * NV_Ith_S(mParameters, 2)) * ((var_environment__iso == 0) ? (7.0 * NV_Ith_S(mParameters, 5)) : (10.5 * NV_Ith_S(mParameters, 5))) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V / (_lt_0_row[1]))); // uA_per_uF
        ...
        const double var_COMPUTE_ICa_ICaK__ICaK = ((fabs(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) < 2.671139896373057e-6) ? (-187186.00275444688 * (-2.671139896373057e-6 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * (-3.0897370000000001e-8 * (-NV_Ith_S(mParameters, 3) + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki * exp(1.0000000000000001e-7)) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa / ((1.0 - 3.773584905660377 * ((var_COMPUTE_ICa_ICaK__ICamax >= 0) ? (0) : (var_COMPUTE_ICa_ICaK__ICamax))) * (-1.0 + exp(1.0000000000000001e-7))) - 3.0897370000000001e-8 * (-NV_Ith_S(mParameters, 3) + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki * exp(-1.0000000000000001e-7)) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa / ((1.0 - 3.773584905660377 * ((var_COMPUTE_ICa_ICaK__ICamax >= 0) ? (0) : (var_COMPUTE_ICa_ICaK__ICamax))) * (-1.0 + exp(-1.0000000000000001e-7)))) + 3.0897370000000001e-8 * (-NV_Ith_S(mParameters, 3) + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki * exp(1.0000000000000001e-7)) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa / ((1.0 - 3.773584905660377 * ((var_COMPUTE_ICa_ICaK__ICamax >= 0) ? (0) : (var_COMPUTE_ICa_ICaK__ICamax))) * (-1.0 + exp(1.0000000000000001e-7)))) : (0.01156711037185033 * (-NV_Ith_S(mParameters, 3) + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki * _lt_0_row[2]) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa / ((1.0 - 3.773584905660377 * ((var_COMPUTE_ICa_ICaK__ICamax >= 0) ? (0) : (var_COMPUTE_ICa_ICaK__ICamax))) * (_lt_0_row[3])))); // uA_per_uF
...
const double var_x0 = exp(1.0000000000000001e-7);
        ...
        const double var_x5 = exp(-1.0000000000000001e-7);
        ...
        const double var_x9 = var_x8 < 2.671139896373057e-6;
        ...
        const double var_x29 = 0.5 - 187186.00275444688 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x30 = var_x8 < 1.3355699481865285e-6;
        ...
        const double var_x35 = var_x6 * (var_x32 + 0.001 * var_x5);
        const double var_x36 = var_x34 - 374372.00550889375 * (-1.3355699481865285e-6 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * (-var_x34 - var_x31 * var_x35);
        ...
        const double var_x43 = ((var_x30) ? (var_x36 >= 0) : (var_x42 >= 0));
        const double var_x44 = ((var_x30) ? (var_x36) : (var_x42));
        ...
        const double var_x48 = ((var_x30) ? (var_x33 * var_x46 + var_x35 * var_x46) : (var_x41 + 7.5739436954129147 * var_x40 * var_x47 - 7573.9436954129151 * var_x38 * var_x47 * NV_Ith_S(mParameters, 5) / pow(var_x39, 2)));
        ...
        const double var_x51 = 8.1878030500000012e-9 * var_x50;
        const double var_x52 = var_x3 * var_x51;
        ...
        const double var_x59 = ((var_x9) ? (var_x52 + var_x29 * (-var_x52 - var_x51 * var_x7) + var_x3 * var_x55 + var_x55 * var_x7) : (0.00043304023078523341 * var_x14 * var_x58 + var_x12 * var_x54 * var_x56 + 0.0030652842485403373 * var_x15 * var_x50 * var_x57 - 0.00043304023078523341 * var_x10 * var_x15 * var_x18 * var_x54 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V));
        ...
        const double var_x97 = 8.0301527601600006e-12 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
        ...
        const double var_x102 = ((var_x9) ? (var_x99 + var_x29 * (-var_x99 - var_x100 * var_x97)) : (3.006264393363878e-6 * var_x101));
        ...
        const double var_x108 = 4.0150763800800001e-10 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
        const double var_x109 = var_x108 * var_x98;
        const double var_x110 = ((var_x9) ? (var_x109 + var_x29 * (-var_x109 - var_x100 * var_x108)) : (0.00015031321966819388 * var_x101));
        const double var_x111 = 3.0897370000000001e-8 * var_x53;
        const double var_x112 = var_x111 * var_x49;
        const double var_x113 = var_x112 * var_x98;
        const double var_x114 = ((var_x9) ? (var_x113 + var_x29 * (-var_x113 - var_x100 * var_x112)) : (0.01156711037185033 * var_x10 * var_x58));
        ...
        const double var_x120 = var_x119 * var_x3;
        const double var_x121 = var_x53 * var_x56 * var_x57;
        const double var_x122 = ((var_x9) ? (var_x120 + var_x29 * (-var_x120 - var_x119 * var_x7)) : (var_x121 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa));
        ...
        const double var_x125 = var_x124 * var_x3;
        const double var_x126 = ((var_x9) ? (var_x125 + var_x29 * (-var_x125 - var_x124 * var_x7)) : (var_x121 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open));
        const double var_x127 = var_x44 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open;
        const double var_x128 = 4.0150763800800001e-10 * var_x3;
        const double var_x129 = ((var_x9) ? (var_x128 + var_x29 * (-var_x128 - 4.0150763800800001e-10 * var_x7)) : (var_x16 * var_x57));
        const double var_x130 = 8.0301527601600006e-12 * var_x22;
        const double var_x131 = ((var_x9) ? (var_x130 + var_x29 * (-var_x130 - 8.0301527601600006e-12 * var_x24)) : (var_x27 * var_x57));
        ...
        IJth(rJacobian, 3, 39) = -6.1518471582797284e-5 * var_x129;
...
// LCOV_EXCL_STOP
        ...
        const double var_COMPUTE_ICa_ICaK__ICamax = ((fabs(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) < 1.3355699481865285e-6) ? (-374372.00550889375 * (-1.3355699481865285e-6 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * (-0.019300000000000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * NV_Ith_S(mParameters, 2)) * var_COMPUTE_ICa_ICaK__PCa / (-1.0 + exp(1.0000000000000001e-7)) - 0.019300000000000001 * (0.001 * exp(-1.0000000000000001e-7) - 0.34100000000000003 * NV_Ith_S(mParameters, 2)) * var_COMPUTE_ICa_ICaK__PCa / (-1.0 + exp(-1.0000000000000001e-7))) + 0.019300000000000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * NV_Ith_S(mParameters, 2)) * var_COMPUTE_ICa_ICaK__PCa / (-1.0 + exp(1.0000000000000001e-7))) : (14450.7594126433 * (_lt_0_row[0] - 0.34100000000000003 * NV_Ith_S(mParameters, 2)) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V * var_COMPUTE_ICa_ICaK__PCa / (_lt_0_row[1]))); // uA_per_uF
        const double var_COMPUTE_ICa_ICaK__ICa = var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa * var_COMPUTE_ICa_ICaK__ICamax; // uA_per_uF
