...
const double var_x0 = exp(0.03743720055088938 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        ...
        const double var_x79 = var_x6 * var_x8;
        const double var_x80 = var_x79 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa;
        const double var_x81 = ((var_x21) ? (var_x80) : (var_x22 * var_x80));
        const double var_x82 = var_x79 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open;
        const double var_x83 = ((var_x21) ? (var_x82) : (var_x22 * var_x82));
        const double var_x84 = log(138.0 * var_x42);
        const double var_x85 = 1504.3859896373056 * var_x84 - 56.32 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x86 = 0.093489896373056991 * var_x28 - 0.0035000000000000001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x87 = 1.8494079065353104e-10 * var_x52;
        const double var_x88 = 0.092547526753060952 * var_x84 - 0.0034647203195431429 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x89 = 9.2470395326765519e-9 * var_x5;
        const double var_x90 = 5.7513555333045694e-6 * var_x28 - 2.1531465053979051e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        ...
        const double var_x113 = var_x108 * (240.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR - 240.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS);
        const double var_x114 = var_x107 * var_x112;
        ...
        IJth(rJacobian, 1, 0) = -6.1518471582797284e-8 + 6.9236654697362894e-12 * var_x57 - 0.00032038820000320823 * var_x48 - 0.0034647203195431429 * var_chaste_interface__INa__na6 - 0.0034647203195431429 * var_chaste_interface__INa__na7 - 3.6423604991562432e-8 * var_x38 - 1.7726771463121479e-10 * var_x41 - 6.9236654697362894e-12 * var_x60 - var_x49 * var_x87;
        IJth(rJacobian, 2, 0) = 7.272408766002779e-7 * var_x39 + 0.00021359213333547216 * var_x48 + 3.4618327348681446e-10 * var_x56 - 2.1531465053979051e-7 * var_chaste_interface__IKs__O1ks - 2.1531465053979051e-7 * var_chaste_interface__IKs__O2ks - 6.1518471582797284e-5 * var_x26 - 1.5417159680637441e-5 * var_x31 - 1.1442435714400293e-6 * var_chaste_interface__IKr__OHerg - 4.7689611318757119e-6 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - 3.4618327348681446e-10 * var_x59 - var_x49 * var_x89;
        IJth(rJacobian, 3, 0) = var_x94 * (-2.3635396782110715e-9 + 5.908923821040493e-11 * var_x41 + 1.2141201663854144e-8 * var_x38);
        IJth(rJacobian, 4, 0) = var_x108 * (1.2385968373668765 * var_x62 - 0.0012385968373668766 * var_x61 - 16.54232713906077 * var_x54);
        ...
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-1504.3859896373056 * var_x63 - 0.029113605067047261 * var_x65 - 0.0011841518182889234 * var_x64 - 3.006264393363878e-6 * var_x66 - 0.026711398963730568 * var_x42);
        IJth(rJacobian, 1, 1) = -1.8494079065353104e-10 * var_x66 - 5.3730734579697901e-6 * var_x65 - 0.092547526753060952 * var_x63 - 1.6432444380870198e-6 * var_x42 - 2.1854162994937459e-7 * var_x64;
        IJth(rJacobian, 2, 1) = 3.58204897197986e-6 * var_x65;
        IJth(rJacobian, 3, 1) = 7.2847209983124865e-8 * var_x64 * var_x93;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x68 + 0.3157689178193962 * var_x73 - 0.093489896373056991 * var_x69 - 6.6941504319201126 * var_x70 - 0.49683202072538851 * var_x71 - 2.0706890167875649 * var_x72 - 0.00015031321966819388 * var_x66);
        IJth(rJacobian, 2, 2) = 1.9425621197603174e-5 * var_x73 - 6.1518471582797284e-5 * var_x68 - 0.00012738562343605624 * var_x72 - 3.0564346548418563e-5 * var_x71 - 9.2470395326765519e-9 * var_x66 - 5.7513555333045694e-6 * var_x69 - 0.00041181390311704764 * var_x70;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (0.050000000000000003 * var_x77 + 518.67270623236789 * var_x78 - 0.050000000000000003 * var_x75 - 0.0010262519481865284 * var_x76);
        IJth(rJacobian, 1, 3) = 0.095723856417385469 * var_x78;
        IJth(rJacobian, 3, 3) = var_x94 * (-5.6374531835205994 - var_x95 + 2.8000000000000003 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa + 2.8000000000000003 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa + 1.5379617895699322e-6 * var_x77 + 4.2533745697546539e-5 * var_x103 - 0.03190795213912849 * var_x78 - 3.1566725655651652e-8 * var_x76 - 3.6466405075851775 * var_x100) + 0.00023800000000000004 * (0.0028000000000000004 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa + 9.2400000000000013e-6 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa + 3.1566725655651652e-8 * log(2.0 * var_x76) + 0.037453183520599252 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS - 0.037453183520599252 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - 2.3635396782110715e-9 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V - var_x104 * (1.0 - var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa) - var_x104 * (1.0 - var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa) - var_x95 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai + 1.2141201663854144e-8 * var_x34 * var_x40 - 1.2 * var_x101 * var_x98) / (pow(var_x91, 3) * pow(var_x92, 2));
        IJth(rJacobian, 4, 3) = 806.49188514357058 * var_x107;
        IJth(rJacobian, 6, 3) = 44.871043198095713 * var_x100 - 0.00052336761372600129 * var_x103;
        ...
        IJth(rJacobian, 4, 4) = var_x108 * (-806.49188514357058 - var_x109 - var_x110) + 0.00023800000000000004 * (806.49188514357058 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai + 240.0 * var_x111 - 806.49188514357058 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS - var_x112 * var_x3) / (pow(var_x105, 3) * pow(var_x106, 2));
        ...
        IJth(rJacobian, 4, 5) = var_x108 * (var_x109 + var_x110);
        ...
        IJth(rJacobian, 3, 6) = var_x94 * (3.1822011198770807e-10 * var_x102 + 0.00011598784194528874 * var_x98);
        IJth(rJacobian, 5, 6) = 1.7400382808421786 * var_x119;
        IJth(rJacobian, 6, 6) = -0.13257434520702313 - 3.9156227113154178e-9 * var_x102 - 0.001427202778983934 * var_x98;
        IJth(rJacobian, 3, 7) = var_x94 * (0.0028000000000000004 + var_x104);
        IJth(rJacobian, 7, 7) = -0.040000000000000001 - 40.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        IJth(rJacobian, 3, 8) = var_x94 * (9.2400000000000013e-6 + var_x104);
        ...
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x81 - var_x20 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa);
        IJth(rJacobian, 2, 23) = -6.1518471582797284e-5 * var_x81;
        ...
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x83 - var_x20 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open);
        IJth(rJacobian, 2, 24) = -6.1518471582797284e-5 * var_x83;
        ...
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (2.0706890167875649 * var_x28 - 0.077520800000000001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        IJth(rJacobian, 2, 29) = 0.00012738562343605624 * var_x28 - 4.7689611318757119e-6 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        ...
        IJth(rJacobian, 0, 39) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x50 * var_x8 - var_x53 * var_x8);
        IJth(rJacobian, 1, 39) = -var_x8 * var_x87;
        IJth(rJacobian, 2, 39) = -var_x8 * var_x89;
        ...
        IJth(rJacobian, 0, 50) = mSetVoltageDerivativeToZero ? 0.0 : (var_x85);
        IJth(rJacobian, 1, 50) = var_x88;
        ...
        IJth(rJacobian, 0, 51) = mSetVoltageDerivativeToZero ? 0.0 : (var_x85);
        IJth(rJacobian, 1, 51) = var_x88;
        ...
        IJth(rJacobian, 0, 61) = mSetVoltageDerivativeToZero ? 0.0 : (0.49683202072538851 * var_x28 - 0.018599999999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        IJth(rJacobian, 2, 61) = 3.0564346548418563e-5 * var_x28 - 1.1442435714400293e-6 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        ...
        IJth(rJacobian, 0, 65) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86);
        ...
        IJth(rJacobian, 0, 66) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86);
