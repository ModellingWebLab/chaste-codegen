...
const double var_x0 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * NV_Ith_S(mParameters, 10);
        ...
        const double var_x182 = 0.44800000000000001 * var_x181 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x183 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x184 = fabs(var_x183) < 1.0000000000000001e-5;
        const double var_x185 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x191 = exp(-7.5 + var_x186 + 0.10000000000000001 * NV_Ith_S(mParameters, 12));
        ...
        const double var_x195 = exp(-9.375 + var_x194 + 0.125 * NV_Ith_S(mParameters, 12));
        const double var_x196 = 0.02 * var_x195;
        const double var_x197 = 2.5 * var_x195;
        const double var_x198 = 20.0 * var_x195;
        const double var_x199 = 0.01 * NV_Ith_S(mParameters, 11);
        const double var_x200 = 1.0 - var_x199;
        const double var_x201 = var_x200 / (var_x198 + 2000.0 * var_x192);
        const double var_x202 = var_x191 / pow((0.0031250000000000002 + var_x191), 2);
        const double var_x203 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        ...
        const double var_x209 = 1.0 - var_chaste_interface__L_type_calcium_current_d_gate__d;
        ...
        const double var_x220 = 120.0 * var_x33;
        const double var_x221 = 0.0030000000000000001 * var_x218 * (var_x38 + var_x220 * var_x36) / pow(var_x219, 2);
        ...
        const double var_x229 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x230 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x231 = NV_Ith_S(mParameters, 2) + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x234 = var_x233 / pow(var_x231, 3);
        const double var_x235 = pow(var_x231, (-2));
        const double var_x236 = var_x235 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x237 = var_x236 - var_x234;
        const double var_x238 = -0.59999999999999998 * var_x230;
        const double var_x239 = 0.5 * var_x232 * var_x235;
        const double var_x240 = 0.00084159417694443163 * NV_Ith_S(mParameters, 4);
        const double var_x241 = var_x121 * var_x240;
        const double var_x242 = 0.002 * NV_Ith_S(mParameters, 1);
        ...
        IJth(rJacobian, 2, 0) = ((var_x184) ? (var_x182) : (var_x182 + var_x185 * var_x189 - 0.02 * var_x183 * var_x185 * var_x187 / pow(var_x188, 2)));
        IJth(rJacobian, 3, 0) = (var_x193 + var_x196) * (-var_x197 * var_x201 + 5.0000000000000004e-6 * var_x195 * var_x200 * (var_x197 - 0.625 * var_x202) / pow((var_x192 + 0.01 * var_x195), 2)) + (0.00062500000000000001 * var_x202 - 0.0025000000000000001 * var_x195) * (var_x199 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x198 * var_x201);
        IJth(rJacobian, 4, 0) = 0.066600000000000006 * var_x203 / pow((1.0 + var_x203), 2);
        IJth(rJacobian, 5, 0) = -0.058823529411764705 * var_x204 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x205 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x206, 2);
        IJth(rJacobian, 6, 0) = ((var_x208) ? (0) : (var_x209 * var_x214 - var_x217 * var_chaste_interface__L_type_calcium_current_d_gate__d + 0.0011999999999999999 * var_x207 * var_x215 * var_chaste_interface__L_type_calcium_current_d_gate__d / pow(var_x216, 2) - 0.0074999999999999997 * var_x207 * var_x209 * var_x212 / pow(var_x213, 2)));
        IJth(rJacobian, 7, 0) = ((var_x223) ? (var_x221) : (var_x221 - var_x226 * var_chaste_interface__L_type_calcium_current_f_Ca_gate__f_Ca + 0.0015625000000000001 * var_x222 * var_x224 * var_chaste_interface__L_type_calcium_current_f_Ca_gate__f_Ca / pow(var_x225, 2)));
        IJth(rJacobian, 8, 0) = 0.048000000000000001 * var_x229 * var_x230;
        ...
        IJth(rJacobian, 7, 1) = var_x227 * (var_x98 + var_x220 * var_x35 - var_x220 * var_x97);
        IJth(rJacobian, 8, 1) = var_x229 * var_x237 + (var_x234 - var_x236) * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 9, 1) = var_x237 * var_chaste_interface__calcium_release__ActFrac;
        ...
        IJth(rJacobian, 11, 1) = -var_x108 * var_x240;
        ...
        IJth(rJacobian, 2, 2) = ((var_x184) ? (-2.0 + var_x190) : (var_x190 - var_x183 * var_x189));
        ...
        IJth(rJacobian, 3, 3) = -var_x193 - var_x196;
        IJth(rJacobian, 10, 3) = -var_x120 * var_x240;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x122 * var_x2);
        IJth(rJacobian, 4, 4) = -0.33300000000000002;
        IJth(rJacobian, 11, 4) = -var_x2 * var_x241;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x122 * var_x123);
        IJth(rJacobian, 5, 5) = -0.033000000000000002 / var_x206 - 3.3000000000000003e-5 * var_x204;
        IJth(rJacobian, 11, 5) = -var_x123 * var_x241;
        ...
        IJth(rJacobian, 6, 6) = ((var_x208) ? (-0.23999999999999999) : (-var_x207 * var_x214 - var_x207 * var_x217));
        IJth(rJacobian, 10, 6) = -var_x128 * var_x240;
        IJth(rJacobian, 11, 6) = -var_x131 * var_x240;
        ...
        IJth(rJacobian, 7, 7) = ((var_x223) ? (-0.025000000000000001 + var_x228) : (var_x228 - var_x222 * var_x226));
        IJth(rJacobian, 10, 7) = -var_x140 * var_x240;
        IJth(rJacobian, 11, 7) = -var_x143 * var_x240;
        IJth(rJacobian, 1, 8) = (var_x173 * var_x176 - var_x173 * var_x178) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 8, 8) = -0.059999999999999998 + var_x238 - var_x233 * var_x235;
        IJth(rJacobian, 9, 8) = 0.059999999999999998 + var_x239;
        IJth(rJacobian, 13, 8) = (var_x178 * var_x242 - var_x176 * var_x242) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 8, 9) = var_x238 - var_x239;
        ...
        IJth(rJacobian, 14, 14) = -0.050000000000000003 + var_x243;
        IJth(rJacobian, 1, 15) = 0.20000000000000001 + var_x180;
        IJth(rJacobian, 15, 15) = -0.20000000000000001 + var_x243;
    }
