...
const double var_x0 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * NV_Ith_S(mParameters, 10);
        ...
        const double var_x23 = NV_Ith_S(mParameters, 13) / (10.0 + NV_Ith_S(mParameters, 6));
        const double var_x24 = var_x23 / var_x22;
        const double var_x25 = var_x24 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x35 = var_x34 * NV_Ith_S(mParameters, 8);
        ...
        const double var_x39 = var_x26 * NV_Ith_S(mParameters, 7);
        ...
        const double var_x46 = var_x42 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x50 = var_x26 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x67 = 1 / NV_Ith_S(mParameters, 9);
        ...
        const double var_x73 = var_x12 * var_x70 * NV_Ith_S(mParameters, 14) / pow(var_x13, 2);
        ...
        const double var_x77 = var_x56 * NV_Ith_S(mParameters, 8) * var_chaste_interface__L_type_calcium_current_d_gate__d;
        const double var_x78 = var_x76 * var_x77;
        const double var_x79 = var_x28 * var_x78;
        ...
        const double var_x82 = -26.713760659695652 * log(var_x81 * (NV_Ith_S(mParameters, 7) + 0.12 * NV_Ith_S(mParameters, 6))) + var_chaste_interface__membrane__V;
        const double var_x83 = var_x82 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * NV_Ith_S(mParameters, 10) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x84 = var_x0 * var_x82;
        const double var_x85 = var_x53 + var_chaste_interface__membrane__V;
        const double var_x86 = var_x68 * var_x85;
        const double var_x87 = NV_Ith_S(mParameters, 15) * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x88 = var_x35 * var_x56;
        const double var_x89 = var_x28 * var_x88;
        const double var_x90 = var_x33 * var_x77;
        const double var_x91 = var_x28 * var_x90;
        const double var_x92 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x93 = NV_Ith_S(mParameters, 6) / (1.0 + NV_Ith_S(mParameters, 6));
        ...
        const double var_x97 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0) * NV_Ith_S(mParameters, 5);
        ...
        const double var_x112 = 0.00040816326530612252 * NV_Ith_S(mParameters, 1);
        const double var_x113 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
        const double var_x114 = pow(var_x113, (-2));
        const double var_x115 = var_x114 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x116 = pow(var_chaste_interface__calcium_release__ActFrac, 2);
        const double var_x117 = var_x116 / pow(var_x113, 3);
        const double var_x118 = var_x114 * var_x116 * NV_Ith_S(mParameters, 1);
        ...
        const double var_x130 = exp(-7.5 + var_x125 + 0.10000000000000001 * NV_Ith_S(mParameters, 12));
        ...
        const double var_x134 = exp(-9.375 + var_x133 + 0.125 * NV_Ith_S(mParameters, 12));
        const double var_x135 = 0.02 * var_x134;
        const double var_x136 = 2.5 * var_x134;
        const double var_x137 = 20.0 * var_x134;
        const double var_x138 = 0.01 * NV_Ith_S(mParameters, 11);
        const double var_x139 = 1.0 - var_x138;
        const double var_x140 = var_x139 / (var_x137 + 2000.0 * var_x131);
        const double var_x141 = var_x130 / pow((0.0031250000000000002 + var_x130), 2);
        ...
        const double var_x148 = 1.0 - var_chaste_interface__L_type_calcium_current_d_gate__d;
        ...
        const double var_x159 = 120.0 * var_x29;
        const double var_x160 = 0.0030000000000000001 * var_x157 * (var_x34 + var_x159 * var_x32) / pow(var_x158, 2);
        ...
        const double var_x170 = NV_Ith_S(mParameters, 2) + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x173 = var_x172 / pow(var_x170, 3);
        ...
        const double var_x178 = 0.5 * var_x171 * var_x174;
        const double var_x179 = 3.1504144536796185e-7 * var_x40;
        const double var_x180 = 0.00084159417694443163 * NV_Ith_S(mParameters, 4);
        const double var_x181 = var_x179 * NV_Ith_S(mParameters, 4);
        const double var_x182 = 6.3008289073592373e-8 * var_x51;
        const double var_x183 = var_x182 * NV_Ith_S(mParameters, 4);
        const double var_x184 = var_x180 * var_x85;
        const double var_x185 = 0.002 * NV_Ith_S(mParameters, 1);
        const double var_x186 = -var_x119;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x68 * (0.0018699999999999999 + var_x1 + var_x16 + var_x25 + var_x3 + 2.8025923642584555e-6 * var_x58 + 0.011210369457033822 * var_x61 + 1.4012961821292276e-5 * var_x62 - 2.8025923642584555e-6 * var_x64 - 0.074867781645490947 * var_x55 - 0.011210369457033822 * var_x65 - 1.4012961821292276e-5 * var_x66 + var_x36 * var_x49 + var_x37 * var_x41 + var_x37 * var_x52));
        IJth(rJacobian, 1, 0) = -2.103985442361079e-8 + 4.7172908282176865e-6 * var_x65 + 0.00084159417694443163 * var_x16 - 4.7172908282176865e-6 * var_x61 - var_x104 * var_x36;
        IJth(rJacobian, 2, 0) = ((var_x123) ? (var_x121) : (var_x121 + var_x124 * var_x128 - 0.02 * var_x122 * var_x124 * var_x126 / pow(var_x127, 2)));
        IJth(rJacobian, 3, 0) = (var_x132 + var_x135) * (-var_x136 * var_x140 + 5.0000000000000004e-6 * var_x134 * var_x139 * (var_x136 - 0.625 * var_x141) / pow((var_x131 + 0.01 * var_x134), 2)) + (0.00062500000000000001 * var_x141 - 0.0025000000000000001 * var_x134) * (var_x138 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x137 * var_x140);
        IJth(rJacobian, 4, 0) = 0.066600000000000006 * var_x142 / pow((1.0 + var_x142), 2);
        IJth(rJacobian, 5, 0) = -0.058823529411764705 * var_x143 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x144 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x145, 2);
        IJth(rJacobian, 6, 0) = ((var_x147) ? (0) : (var_x148 * var_x153 - var_x156 * var_chaste_interface__L_type_calcium_current_d_gate__d + 0.0011999999999999999 * var_x146 * var_x154 * var_chaste_interface__L_type_calcium_current_d_gate__d / pow(var_x155, 2) - 0.0074999999999999997 * var_x146 * var_x148 * var_x151 / pow(var_x152, 2)));
        IJth(rJacobian, 7, 0) = ((var_x162) ? (var_x160) : (var_x160 - var_x165 * var_chaste_interface__L_type_calcium_current_f_Ca_gate__f_Ca + 0.0015625000000000001 * var_x161 * var_x163 * var_chaste_interface__L_type_calcium_current_f_Ca_gate__f_Ca / pow(var_x164, 2)));
        IJth(rJacobian, 8, 0) = 0.048000000000000001 * var_x168 * var_x169;
        IJth(rJacobian, 10, 0) = (-1.009913012333318e-7 + 1.1793227070544217e-8 * var_x66 - 0.0025247825308332946 * var_x16 - 1.1793227070544217e-8 * var_x62 - 0.00084159417694443163 * var_x1 - var_x179 * var_x37) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 11, 0) = (-1.4307101008055335e-6 + 6.3008289073592378e-5 * var_x55 + 2.3586454141088434e-9 * var_x64 - 2.3586454141088434e-9 * var_x58 - 0.00084159417694443163 * var_x25 - 0.00084159417694443163 * var_x3 - var_x182 * var_x37) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x68 * (-var_x72 + 0.14973556329098189 * var_x80 + 0.00066784401649239123 * var_x69 - 0.0068999999999999999 * var_x71 - 0.0001 * var_x74 + var_x41 * var_x79 + var_x49 * var_x78 + var_x52 * var_x79));
        IJth(rJacobian, 1, 1) = -17.0 + var_x105 + var_x106 - 2.8102681769358871e-7 * var_x69 - 5.806999820916578e-6 * var_x71 - 6.3008289073592378e-5 * var_x80 - 8.4159417694443161e-8 * var_x74 - 0.00084159417694443163 * var_x72 + (0.0030000000000000001 * var_x110 - 5.5199999999999998e-8 * var_x111 - 0.0030000000000000001 * var_x108) * NV_Ith_S(mParameters, 3) - var_x104 * var_x78;
        IJth(rJacobian, 7, 1) = var_x166 * (var_x76 + var_x159 * var_x31 - var_x159 * var_x75);
        IJth(rJacobian, 8, 1) = var_x168 * var_x176 + (var_x173 - var_x175) * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 9, 1) = var_x176 * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 10, 1) = (2.5247825308332947e-7 * var_x74 + 1.7420999462749734e-5 * var_x71 + 0.0025247825308332946 * var_x72 - var_x179 * var_x79) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 11, 1) = -var_x183 * var_x79;
        IJth(rJacobian, 12, 1) = (2.7047999999999999e-6 * var_x111 + 0.14699999999999999 * var_x108 - 0.14699999999999999 * var_x110) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 14, 1) = 2.0 - var_x105;
        IJth(rJacobian, 15, 1) = 15.0 - var_x106;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0030000000000000001 * var_x67 * var_x83);
        IJth(rJacobian, 2, 2) = ((var_x123) ? (-2.0 + var_x129) : (var_x129 - var_x122 * var_x128));
        IJth(rJacobian, 10, 2) = -0.0025247825308332946 * var_x83 * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x68 * var_x84);
        IJth(rJacobian, 3, 3) = -var_x132 - var_x135;
        IJth(rJacobian, 10, 3) = -var_x180 * var_x84;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x2 * var_x86);
        IJth(rJacobian, 4, 4) = -0.33300000000000002;
        IJth(rJacobian, 11, 4) = -var_x184 * var_x2;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x86 * var_x87);
        IJth(rJacobian, 5, 5) = -0.033000000000000002 / var_x145 - 3.3000000000000003e-5 * var_x143;
        IJth(rJacobian, 11, 5) = -var_x184 * var_x87;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x68 * (var_x41 * var_x89 + var_x49 * var_x88 + var_x52 * var_x89));
        IJth(rJacobian, 1, 6) = -var_x104 * var_x88;
        IJth(rJacobian, 6, 6) = ((var_x147) ? (-0.23999999999999999) : (-var_x146 * var_x153 - var_x146 * var_x156));
        IJth(rJacobian, 10, 6) = -var_x181 * var_x89;
        IJth(rJacobian, 11, 6) = -var_x183 * var_x89;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x68 * (-var_x41 * var_x91 - var_x49 * var_x90 - var_x52 * var_x91));
        IJth(rJacobian, 1, 7) = var_x104 * var_x90;
        IJth(rJacobian, 7, 7) = ((var_x162) ? (-0.025000000000000001 + var_x167) : (var_x167 - var_x161 * var_x165));
        IJth(rJacobian, 10, 7) = var_x181 * var_x91;
        IJth(rJacobian, 11, 7) = var_x183 * var_x91;
        IJth(rJacobian, 1, 8) = (var_x112 * var_x115 - var_x112 * var_x117) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 8, 8) = -0.059999999999999998 + var_x177 - var_x172 * var_x174;
        IJth(rJacobian, 9, 8) = 0.059999999999999998 + var_x178;
        IJth(rJacobian, 13, 8) = (var_x117 * var_x185 - var_x115 * var_x185) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 8, 9) = var_x177 - var_x178;
        IJth(rJacobian, 9, 9) = -0.001;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x68 * (3.0 * var_x98 + 0.14000000000000001 * var_x94 + 26.713760659695652 * var_x95 + 0.00037433890822745472 * var_x100 + 0.0032056512791634783 * var_x92 - 0.00030000000000000003 * var_x99 - 8.7500000000000013e-5 * var_x96));
        IJth(rJacobian, 1, 10) = 0.0025247825308332946 * var_x98 - 2.5247825308332947e-7 * var_x99;
        IJth(rJacobian, 10, 10) = (2.2091847144791331e-7 * var_x96 + 7.5743475924998847e-7 * var_x99 - 2.6978574498584515e-6 * var_x92 - 3.1504144536796185e-7 * var_x100 - 0.022482145415487095 * var_x95 - 0.00035346955431666128 * var_x94 - 0.0075743475924998846 * var_x98) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 11, 10) = (0.00023564636954444087 * var_x94 - 1.4727898096527556e-7 * var_x96) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x68 * (26.713760659695652 * var_x101 + 26.713760659695652 * var_x102 + 7.4867781645490941e-5 * var_x100 + 0.045413393121482605 * var_x18 + 3.2056512791634777 * var_x95 - 2.0 * var_x103));
        IJth(rJacobian, 10, 11) = -0.0026978574498584514 * var_x95 * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 11, 11) = (0.0016831883538888633 * var_x103 - 3.8219647206328062e-5 * var_x18 - 6.3008289073592373e-8 * var_x100 - 0.022482145415487095 * var_x101 - 0.022482145415487095 * var_x102) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 1, 12) = (5.5199999999999998e-8 * var_x108 + 7.1999999999999999e-7 * var_x110 - 1.3248e-11 * var_x111) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 12, 12) = -0.050000000000000003 + (6.4915199999999989e-10 * var_x111 - 2.7047999999999999e-6 * var_x108 - 3.5279999999999994e-5 * var_x110) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 13, 12) = 0.0050000000000000001;
        IJth(rJacobian, 1, 13) = 0.00020408163265306126 * var_x118 + 0.00020408163265306126 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 12, 13) = 0.050000000000000003;
        IJth(rJacobian, 13, 13) = -0.0050000000000000001 - 0.001 * var_x118 - 0.001 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 1, 14) = 0.050000000000000003 + var_x119;
        IJth(rJacobian, 14, 14) = -0.050000000000000003 + var_x186;
        IJth(rJacobian, 1, 15) = 0.20000000000000001 + var_x119;
        IJth(rJacobian, 15, 15) = -0.20000000000000001 + var_x186;
    }
