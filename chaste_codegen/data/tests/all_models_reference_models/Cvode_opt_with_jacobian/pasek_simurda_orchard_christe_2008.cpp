...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__Vm_s__Vm_s) {
                    return ((fabs(38.899999999999999 + var_chaste_interface__Vm_s__Vm_s) < 6.8965517030505907e-7) ? (4.2068965605324133e-7 / (-1.0 + exp(1.0000000020937704e-7)) + 1.3799999999999999 * (14.199999999999999 + var_chaste_interface__Vm_s__Vm_s) / (1.0 - exp(-1.7465999999999999 - 0.123 * var_chaste_interface__Vm_s__Vm_s)) - 725000002.21680665 * (38.899999310344825 + var_chaste_interface__Vm_s__Vm_s) * (-4.2068965171893065e-10 / (-1.0 + exp(-9.9999999179090074e-8)) - 4.2068965605324136e-10 / (-1.0 + exp(1.0000000020937704e-7)))) : ((fabs(14.199999999999999 + var_chaste_interface__Vm_s__Vm_s) < 8.1300813015161566e-7) ? (-1.1219512196092295e-6 / (1.0 - exp(1.0000000000864873e-7)) + 614999999.94681036 * (14.200000813008129 + var_chaste_interface__Vm_s__Vm_s) * (1.1219512196092296e-9 / (1.0 - exp(1.0000000000864873e-7)) + 1.1219512196092296e-9 / (1.0 - exp(-1.0000000000864873e-7))) + 0.60999999999999999 * (38.899999999999999 + var_chaste_interface__Vm_s__Vm_s) / (-1.0 + exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__Vm_s__Vm_s))) : (0.60999999999999999 * (38.899999999999999 + var_chaste_interface__Vm_s__Vm_s) / (-1.0 + exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__Vm_s__Vm_s)) + 1.3799999999999999 * (14.199999999999999 + var_chaste_interface__Vm_s__Vm_s) / (1.0 - exp(-1.7465999999999999 - 0.123 * var_chaste_interface__Vm_s__Vm_s)))));
                };
                const double var_chaste_interface__Vm_s__Vm_s = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__Vm_s__Vm_s);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
...
const double var_x0 = exp(-6.75 - 0.125 * var_chaste_interface__Vm_s__Vm_s);
        ...
        const double var_x186 = var_x10 * var_x185;
        const double var_x187 = var_x13 * var_x185;
        const double var_x188 = 1.5021437874668512e-15 * var_x184 * var_x21 * var_chaste_interface__Vm_s__Vm_s;
        const double var_x189 = ((var_x16) ? (var_x186 + var_x55 * (-var_x186 - var_x12 * var_x187)) : (var_x188 * var_x19));
        const double var_x190 = var_x185 * var_x30;
        const double var_x191 = ((var_x16) ? (var_x190 + var_x55 * (-var_x190 - var_x187 * var_x32)) : (var_x188 * var_x34));
        ...
        const double var_x203 = ((var_x44) ? (var_x70 + var_x201 * (-var_x70 - var_x73)) : (var_x202 * var_x93 * NV_Ith_S(mParameters, 4)));
        const double var_x204 = 1.7821037222369758e-12 * var_x85;
        const double var_x205 = var_x204 * var_x57;
        const double var_x206 = var_x204 * var_x81;
        const double var_x207 = var_x203 * var_x78;
        const double var_x208 = var_x207 * var_x57;
        const double var_x209 = ((var_x16) ? (var_x205 + var_x208 + var_x55 * (-var_x205 - var_x208 - var_x206 * var_x43 - var_x207 * var_x82)) : (var_x203 * var_x95 + var_x85 * var_x91 * var_x93));
        const double var_x210 = -19744.697669435584 * var_x203 - 19744.697669435584 * var_x209;
        const double var_x211 = var_x39 * var_x8;
        const double var_x212 = var_x211 * var_x69;
        const double var_x213 = var_x13 * var_x39;
        const double var_x214 = ((var_x44) ? (var_x212 + var_x201 * (-var_x212 - var_x213 * var_x72)) : (var_x202 * var_x40 * var_chaste_interface__Vm_s__Vm_s));
        const double var_x215 = var_x204 * var_x211 * var_x56;
        const double var_x216 = var_x214 * var_x78;
        const double var_x217 = var_x216 * var_x57;
        const double var_x218 = ((var_x16) ? (var_x215 + var_x217 + var_x55 * (-var_x215 - var_x217 - var_x206 * var_x213 - var_x216 * var_x82)) : (var_x214 * var_x95 + var_x86 * var_x91 * var_chaste_interface__Vm_s__Vm_s));
        ...
        const double var_x226 = var_x220 * var_x82;
        ...
        const double var_x229 = ((var_x16) ? (var_x225 + var_x55 * (-var_x225 - var_x224 * var_x226)) : (var_x223 * var_x228));
        ...
        const double var_x234 = ((var_x16) ? (var_x233 + var_x55 * (-var_x233 - var_x226 * var_x232)) : (var_x228 * var_x231));
        ...
        const double var_x238 = var_x221 * var_x237;
        const double var_x239 = ((var_x16) ? (-var_x238 + var_x55 * (var_x238 + var_x226 * var_x237)) : (-1.1019785879924185e-11 * var_x227 * var_x236));
        ...
        const double var_x279 = var_x278 * var_x57;
        const double var_x280 = ((var_x16) ? (var_x279 + var_x55 * (-var_x279 - var_x278 * var_x82)) : (1.5993826505742774e-15 * var_x277 * var_x94));
        ...
        const double var_x451 = 1 / (-1.0 + exp(-9.9999999179090074e-8));
        const double var_x452 = 1 / (-1.0 + exp(1.0000000020937704e-7));
        ...
        const double var_x459 = var_x456 * var_x457;
        const double var_x460 = (38.899999310344825 + var_chaste_interface__Vm_s__Vm_s) * (-4.2068965171893065e-10 * var_x451 - 4.2068965605324136e-10 * var_x452);
        ...
        const double var_x463 = fabs(var_x462) < 6.8965517030505907e-7;
        const double var_x464 = 1 / (1.0 - exp(1.0000000000864873e-7));
        const double var_x465 = 1 / (1.0 - exp(-1.0000000000864873e-7));
        ...
        const double var_x471 = (14.200000813008129 + var_chaste_interface__Vm_s__Vm_s) * (1.1219512196092296e-9 * var_x464 + 1.1219512196092296e-9 * var_x465);
        const double var_x472 = var_x462 * var_x469;
        const double var_x473 = fabs(var_x457) < 8.1300813015161566e-7;
        ...
        const double var_x491 = 1 / (-1.0 + exp(9.9999999925515227e-8));
        const double var_x492 = 1 / (-1.0 + exp(-9.9999999925515227e-8));
        const double var_x493 = 1 / (1.0 - exp(2.1542940304186685e-7));
        const double var_x494 = 1 / (1.0 - exp(-2.1542940304186685e-7));
        const double var_x495 = (30.000001455604075 + var_chaste_interface__Vm_s__Vm_s) * (1.9068413377354434e-10 * var_x491 + 1.9068413377354434e-10 * var_x492 + 1.0465793296425829e-10 * var_x493 + 1.0465793296425829e-10 * var_x494);
        ...
        const double var_x498 = fabs(var_x497) < 1.4556040746072085e-6;
        ...
        IJth(rJacobian, 32, 0) = ((var_x463) ? (var_x450 * (var_x458 + 0.30499999842881237 * var_x451 + 0.30500000157118762 * var_x452) + var_x461 * (var_x459 + 4.2068965605324133e-7 * var_x452 - 725000002.21680665 * var_x460)) : ((var_x473) ? (var_x450 * (var_x470 + 0.68999999999999995 * var_x464 + 0.68999999999999995 * var_x465) + var_x461 * (var_x472 + 614999999.94681036 * var_x471 - 1.1219512196092295e-6 * var_x464)) : (var_x450 * (var_x458 + var_x470) + var_x461 * (var_x459 + var_x472))));
        IJth(rJacobian, 34, 0) = ((var_x498) ? (var_x490 * (0.065500000000000003 * var_x491 + 0.065500000000000003 * var_x492 + 0.035949999999999996 * var_x493 + 0.035949999999999996 * var_x494) + var_x496 * (343500000.2558552 * var_x495 - 1.9068413377354434e-7 * var_x492 - 1.0465793296425829e-7 * var_x493)) : (var_x490 * (var_x502 + var_x506 - 0.0089997000000000011 * var_x497 * var_x499 / pow(var_x500, 2) - 0.0106412 * var_x497 * var_x503 / pow(var_x504, 2)) + var_x496 * (var_x497 * var_x502 + var_x497 * var_x506)));
        ...
        IJth(rJacobian, 32, 32) = ((var_x463) ? (var_x474 + 725000.00221680664 * var_x460 - 4.2068965605324136e-10 * var_x452) : ((var_x473) ? (var_x475 + 1.1219512196092296e-9 * var_x464 - 614999.99994681031 * var_x471) : (var_x474 + var_x475)));
        ...
        IJth(rJacobian, 34, 34) = ((var_x498) ? (1.9068413377354434e-10 * var_x492 + 1.0465793296425829e-10 * var_x493 - 343500.00025585521 * var_x495) : (-0.00013100000000000001 * var_x497 * var_x501 - 7.1899999999999999e-5 * var_x497 * var_x505));
