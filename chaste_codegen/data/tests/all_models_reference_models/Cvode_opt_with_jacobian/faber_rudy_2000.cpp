...
const double var_x0 = exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V);
        ...
        const double var_x349 = var_x346 / pow(var_x347, 2);
        const double var_x350 = var_chaste_interface__cell__V <= 0;
        const double var_x351 = exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        ...
        const double var_x363 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        ...
        const double var_x375 = var_x366 * var_x374 / pow(var_x367, 2);
        const double var_x376 = var_x370 * var_x374 / pow(var_x371, 2);
        const double var_x377 = var_x369 * var_x374;
        const double var_x378 = var_x373 * var_x374;
        const double var_x379 = 0.059880239520958084 * var_x363 / pow(var_x364, 2);
        ...
        const double var_x395 = 0.40000000000000002 * var_x387;
        const double var_x396 = 0.40000000000000002 * pow(var_x389, 2) / pow(var_x390, 2);
        const double var_x397 = 0.40000000000000002 * pow(var_x385, 2) / pow(var_x386, 2);
        const double var_x398 = 0.40000000000000002 * var_x391;
        ...
        const double var_x408 = var_x403 + var_x407;
        const double var_x409 = 1 / var_x408;
        const double var_x410 = 0.02 * var_x406;
        const double var_x411 = 0.02 * pow(var_x404, 2) / pow(var_x405, 2);
        const double var_x412 = 0.0030000000000000001 * var_x400 / pow(var_x401, 2);
        ...
        const double var_x416 = 150.0 * var_x230;
        const double var_x417 = var_x415 * var_x416;
        const double var_x418 = 150.0 * var_x241;
        const double var_x419 = var_x229 * var_x418;
        const double var_x420 = var_x415;
        const double var_x421 = 2408000.8135002237 * var_x230 * var_x415;
        ...
        const double var_x427 = var_x90 * var_x97;
        const double var_x428 = var_x213 * NV_Ith_S(mParameters, 4);
        const double var_x429 = 0.00019322854132177239 * var_x428;
        const double var_x430 = 0.00057968562396531716 * var_x428;
        const double var_x431 = 4.711106657529681e-7 * var_x428;
        const double var_x432 = var_x423 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
        const double var_x433 = 1.3470275331899681e-7 * var_x428;
        ...
        IJth(rJacobian, 8, 0) = ((var_x350) ? (0.006076388888888889 * (-var_chaste_interface__T_type_Ca_channel_g_gate__g + 1 / var_x347) / pow((1 - 0.072916666666666671 * var_chaste_interface__cell__V), 2) - 0.17857142857142858 * var_x348 * var_x349) : (-0.014880952380952382 * var_x349));
        IJth(rJacobian, 9, 0) = (-var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr + 1 / var_x352) * (var_x355 + var_x358 - 0.00016973999999999998 * var_x356 * var_x359 / pow(var_x357, 2) - 8.8449999999999995e-5 * var_x353 * var_x360 / pow(var_x354, 2)) + 0.13333333333333333 * var_x351 * (var_x361 + var_x362) / pow(var_x352, 2);
        IJth(rJacobian, 10, 0) = var_x379 * (var_x377 + var_x378) + (var_x365 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1) * (var_x369 + var_x373 - 8.9997000000000013e-6 * var_x375 - 1.0641199999999999e-5 * var_x376);
        IJth(rJacobian, 11, 0) = var_x379 * (var_x382 + var_x383) + (var_x365 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2) * (var_x380 + var_x381 - 2.2499250000000003e-6 * var_x375 - 2.6602999999999998e-6 * var_x376);
        IJth(rJacobian, 12, 0) = var_x393 * (var_x394 * var_x395 - var_x394 * var_x397 + 0.10000000000000001 * var_x387 * (var_x397 + var_x398 - var_x395 - var_x396) / pow((var_x387 + var_x391), 2)) + (-var_chaste_interface__transient_outward_current_zdv_gate__zdv + var_x388 * var_x394) * (var_x395 + var_x396 - var_x397 - var_x398);
        IJth(rJacobian, 13, 0) = var_x408 * (-var_x409 * var_x412 + 1.4999999999999998 * var_x402 * (var_x411 + var_x412 - var_x410) / pow((var_x406 + 0.14999999999999999 * var_x402), 2)) + (-var_chaste_interface__transient_outward_current_ydv_gate__ydv + var_x403 * var_x409) * (var_x410 - var_x411 - var_x412);
        IJth(rJacobian, 14, 0) = var_x220 * var_x417;
        IJth(rJacobian, 19, 0) = ((var_x425) ? (var_x215) : (0));
        IJth(rJacobian, 23, 0) = -var_x429 * (0.0040000000000000001 + var_x101 + var_x107 + var_x135 + var_x29 + var_x44 - var_x133 - var_x87 + 3.0 * var_x80 + 6.75 * var_x427 + 0.11230765052340785 * var_x118 - 0.095461502944896678 * var_x212);
        IJth(rJacobian, 24, 0) = -var_x429 * (var_x100 + var_x110 + var_x112 + var_x123 + var_x136 + var_x16 + var_x27 + var_x3 + var_x33 + var_x432 + var_x47 + var_x5 + var_x64 + var_x65 + var_x78 - var_x115 - var_x116 - var_x132 - var_x85 - 4.5 * var_x427);
        ...
        IJth(rJacobian, 14, 1) = var_x420 * (var_x419 + var_x244 * var_x416);
        IJth(rJacobian, 15, 1) = var_x237 - var_x240;
        IJth(rJacobian, 19, 1) = ((var_x425) ? (var_x239) : (0));
        IJth(rJacobian, 23, 1) = -var_x429 * (var_x160 - var_x163 - 3.0 * var_x153 - 0.00030000000000000003 * var_x155);
        IJth(rJacobian, 24, 1) = -var_x429 * (var_x158 + var_x172 - var_x165);
        ...
        IJth(rJacobian, 14, 5) = var_x248 * var_x421;
        IJth(rJacobian, 19, 5) = ((var_x425) ? (var_x250) : (0));
        IJth(rJacobian, 23, 5) = -var_x103 * var_x159 * var_x431;
        IJth(rJacobian, 24, 5) = -var_x103 * var_x156 * var_x433;
        ...
        IJth(rJacobian, 14, 6) = var_x252 * var_x421;
        IJth(rJacobian, 19, 6) = ((var_x425) ? (var_x253) : (0));
        IJth(rJacobian, 23, 6) = -var_x102 * var_x162 * var_x431;
        IJth(rJacobian, 24, 6) = -var_x102 * var_x164 * var_x433;
        ...
        IJth(rJacobian, 14, 7) = 16.666666666666668 * var_x255 * var_x415;
        IJth(rJacobian, 19, 7) = ((var_x425) ? (var_x254) : (0));
        ...
        IJth(rJacobian, 8, 8) = ((var_x350) ? (-var_x348) : (-0.083333333333333329));
        IJth(rJacobian, 14, 8) = 8.3333333333333339 * var_x258 * var_x415;
        IJth(rJacobian, 19, 8) = ((var_x425) ? (var_x257) : (0));
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x186 * var_x63);
        IJth(rJacobian, 9, 9) = -var_x361 - var_x362;
        IJth(rJacobian, 24, 9) = -8.3152324727908455e-5 * var_x186 * var_x428 * var_x62;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x170 * var_x40);
        IJth(rJacobian, 10, 10) = -var_x377 - var_x378;
        IJth(rJacobian, 24, 10) = -var_x170 * var_x423 * var_x429;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x187 * var_x38);
        IJth(rJacobian, 11, 11) = -var_x382 - var_x383;
        IJth(rJacobian, 24, 11) = -var_x187 * var_x422 * var_x429;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x188);
        IJth(rJacobian, 12, 12) = -var_x388 - var_x392;
        IJth(rJacobian, 24, 12) = -var_x188 * var_x430;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x189);
        IJth(rJacobian, 13, 13) = -var_x403 - var_x407;
        IJth(rJacobian, 24, 13) = -var_x189 * var_x429;
        IJth(rJacobian, 1, 14) = var_x234 * var_x243;
        IJth(rJacobian, 14, 14) = var_x420 * (-0.0055555555555555558 - var_x419) + 0.25 * (0.0055555555555555558 * var_chaste_interface__calcium_dynamics__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__calcium_dynamics__Ca_JSR - var_x221 * var_x419) / (pow(var_x413, 3) * pow((0.125 + var_x414), 2));
        IJth(rJacobian, 15, 14) = 0.00048309178743961351;
        IJth(rJacobian, 1, 15) = var_x234 * var_x247;
        IJth(rJacobian, 14, 15) = 0.0055555555555555558 * var_x415;
        IJth(rJacobian, 15, 15) = -0.00048309178743961351 - 0.066666666666666666 * var_x246;
        IJth(rJacobian, 16, 16) = ((var_x111 + var_x212 + var_x245 + 0.0070159999999999997 * var_chaste_interface__cell__V - 0.10684935482199306 * var_x175 + var_x107 * var_chaste_interface__cell__V + var_x110 * var_chaste_interface__cell__V + var_x16 * var_x32 + var_x171 * var_x423 + var_x176 * var_x44 + var_x195 * var_x91 + var_x27 * var_chaste_interface__cell__V + var_x29 * var_chaste_interface__cell__V + var_x3 * var_x32 + var_x32 * var_x5 + var_x32 * var_x64 + var_x32 * var_x78 + GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() < -150.0) ? (-100.5) : (-0.5));
        IJth(rJacobian, 1, 17) = var_x235 * (var_x242 * var_x260 - var_x242 * var_x261);
        IJth(rJacobian, 14, 17) = var_x420 * (var_x261 * var_x418 - var_x260 * var_x418);
        IJth(rJacobian, 17, 17) = ((var_x424) ? (-100.5) : (-0.5));
        IJth(rJacobian, 18, 18) = ((var_x424) ? (-100.5) : (-0.01));
        IJth(rJacobian, 19, 19) = (((var_x425) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 21, 21) = (((var_x426) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50.0) : (-0.5));
        IJth(rJacobian, 22, 22) = (((var_x426) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50.0) : (-0.01));
        ...
        IJth(rJacobian, 14, 23) = var_x263 * var_x417;
        IJth(rJacobian, 19, 23) = ((var_x425) ? (var_x262) : (0));
        IJth(rJacobian, 23, 23) = -var_x429 * (var_x190 + var_x191 + var_x197 + var_x200 + 9.0 * var_x199 + 0.13500000000000001 * var_x196 - 0.00090000000000000008 * var_x201);
        IJth(rJacobian, 24, 23) = -var_x429 * (var_x194 + 0.48963716847178318 * var_x434 - 0.089999999999999997 * var_x196);
        ...
        IJth(rJacobian, 24, 24) = -var_x429 * (var_x191 + var_x202 + var_x203 + var_x204 + var_x205 + var_x206 + var_x207 + var_x209 + var_x210 - var_x211 + 26.712338705498265 * var_x434);
    }
