...
const double var_x0 = -0.75 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x169 = 1 / (pow(var_x10, 2) * pow(var_chaste_interface__calcium_dynamics__Cai, 4));
        const double var_x170 = 5.1839999999999986e-9 * var_x169;
        const double var_x171 = var_x53 * var_chaste_interface__cell__V;
        const double var_x172 = 3.2768075070111035e-12 * var_x169;
        const double var_x173 = ((var_x14) ? (var_x170 * (var_x166 - var_x167 * var_x168)) : (var_x171 * var_x172));
        const double var_x174 = 1.6884874999999999e-9 * var_x38;
        const double var_x175 = -var_x174 - 1.6884874999999999e-9 * var_x39;
        const double var_x176 = var_x46 * var_chaste_interface__cell__V;
        const double var_x177 = ((var_x14) ? (var_x170 * (var_x174 - var_x168 * var_x175)) : (var_x172 * var_x176));
        const double var_x178 = 6.5127374999999992e-9 * var_x38;
        const double var_x179 = -var_x178 - 6.5127374999999992e-9 * var_x39;
        const double var_x180 = var_x178 - var_x168 * var_x179;
        const double var_x181 = var_x180 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        const double var_x185 = ((var_x14) ? (-var_x181 * var_x183) : (-1.4628604942013857e-6 * var_x176 * var_x184));
        const double var_x186 = 1.8621604999999999e-9 * var_x51;
        const double var_x187 = -var_x186 - 1.8621604999999999e-9 * var_x52;
        const double var_x188 = var_x186 - var_x168 * var_x187;
        const double var_x189 = var_x183 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x190 = ((var_x14) ? (-var_x188 * var_x189) : (-4.1826974130498884e-7 * var_x171 * var_x184));
        ...
        const double var_x216 = -26.712338705498265 * log(var_x215 * (0.018329999999999999 * NV_Ith_S(mParameters, 7) + NV_Ith_S(mParameters, 6))) + var_chaste_interface__cell__V;
        const double var_x217 = var_x216 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
        const double var_x218 = 5.4447296618926212e-7 * var_x101 * var_x217 * var_x96 * var_x97 / pow(var_x98, 2);
        const double var_x219 = log(var_x84 * NV_Ith_S(mParameters, 7));
        const double var_x220 = -26.712338705498265 * var_x219 + var_chaste_interface__cell__V;
        const double var_x221 = var_x220 * NV_Ith_S(mParameters, 9) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x222 = var_x221 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x223 = var_x105 * var_x220;
        const double var_x224 = var_x104 * var_x221;
        const double var_x225 = var_x44 * var_chaste_interface__cell__V;
        const double var_x226 = ((var_x14) ? (var_x181 * var_x41) : (var_x225 * var_x47));
        const double var_x227 = ((var_x14) ? (var_x188 * var_x42) : (var_x225 * var_x54));
        const double var_x228 = var_x198 * var_x42;
        const double var_x229 = ((var_x63) ? (var_x228) : (var_x225 * var_x69));
        const double var_x230 = var_x41 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x231 = var_x40 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x232 = var_x231 * var_chaste_interface__cell__V;
        const double var_x233 = ((var_x14) ? (var_x180 * var_x230) : (var_x232 * var_x47));
        const double var_x234 = ((var_x14) ? (var_x188 * var_x230) : (var_x232 * var_x54));
        const double var_x235 = ((var_x63) ? (var_x198 * var_x230) : (var_x232 * var_x69));
        const double var_x236 = log(var_x96 * NV_Ith_S(mParameters, 5));
        const double var_x237 = -13.356169352749133 * var_x236 + var_chaste_interface__cell__V;
        const double var_x238 = var_x237 * var_chaste_interface__T_type_Ca_channel_b_gate__b * var_chaste_interface__T_type_Ca_channel_g_gate__g;
        const double var_x239 = var_x163 * NV_Ith_S(mParameters, 13);
        const double var_x240 = var_x217 * NV_Ith_S(mParameters, 14);
        const double var_x241 = var_x107 * var_x94 * pow(var_chaste_interface__transient_outward_current_zdv_gate__zdv, 2) * NV_Ith_S(mParameters, 16) * var_chaste_interface__transient_outward_current_ydv_gate__ydv;
        const double var_x242 = var_x108 * var_x94;
        ...
        const double var_x251 = var_x103 * var_x215;
        const double var_x252 = 2.4586089909663641e-6 * var_x84 * var_x85 * var_x89 * var_x94 / pow((8.0403875140176932e-6 + var_x85), 2);
        const double var_x253 = var_x147 * NV_Ith_S(mParameters, 6) / var_x151;
        ...
        const double var_x271 = 0.003016 + var_x83 + 0.063641001963264457 * var_x270 - 2.0 * var_x142 - 0.074871767015605231 * var_x160;
        ...
        const double var_x275 = 0.0033511111111111111 + var_x274 + 1.1111111111111112 * var_x74 + 0.070712224403627164 * var_x270 - 2.2222222222222223 * var_x142 - 0.083190852239561366 * var_x160;
        ...
        const double var_x294 = NV_Ith_S(mParameters, 3) / var_x293;
        ...
        const double var_x297 = var_chaste_interface__calcium_dynamics__Cai * NV_Ith_S(mParameters, 3) / pow(var_x293, 2);
        ...
        const double var_x303 = NV_Ith_S(mParameters, 3) * NV_Ith_S(mParameters, 0);
        const double var_x304 = 0.0054117647058823529 * var_x303;
        const double var_x305 = 1.1764705882352939 * var_x287;
        const double var_x306 = -9.6614270660886201e-6 * var_x238 * var_x272;
        const double var_x307 = var_x237 * var_x81;
        const double var_x308 = -4.83071353304431e-6 * var_x272 * var_x307;
        const double var_x309 = var_x287 * var_x307;
        const double var_x310 = var_x276 * var_x282;
        const double var_x311 = var_x310 / pow(var_x283, 3);
        const double var_x312 = var_x285 * var_x310 / pow(var_x283, 2);
        const double var_x313 = -var_x273 * (0.00060000000000000006 * var_x258 - 6.0 * var_x257);
        const double var_x314 = 0.00066666666666666664 * var_x258 - 6.6666666666666661 * var_x257;
        const double var_x315 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x319 = 0.0072727272727272727 * var_x318 * var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x328 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 11) - 0.14705882352941177 * var_chaste_interface__cell__V);
        ...
        const double var_x332 = exp(0.34999999999999998 * var_chaste_interface__cell__V - 0.34999999999999998 * NV_Ith_S(mParameters, 11));
        const double var_x333 = exp(0.079000000000000001 * var_chaste_interface__cell__V - 0.079000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x334 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 11) - 0.0900900900900901 * var_chaste_interface__cell__V);
        ...
        const double var_x338 = ((var_x329) ? (-0.019852941176470591 * var_x328) : (0));
        const double var_x339 = var_x330 + var_x336;
        const double var_x340 = 0.01 * NV_Ith_S(mParameters, 10);
        const double var_x341 = 1.0 - var_x340;
        const double var_x342 = var_x341 / var_x339;
        const double var_x343 = ((var_x329) ? (0.28123999999999999 * var_x333 + 108500.0 * var_x332) : (0.693000693000693 * var_x334 / pow(var_x335, 2)));
        const double var_x344 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 11) - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x345 = 1.0 + var_x344;
        const double var_x346 = exp(0.01052 * NV_Ith_S(mParameters, 11) - 0.01052 * var_chaste_interface__cell__V);
        const double var_x347 = var_x346 / var_x345;
        const double var_x348 = exp(-3.2000000000000002 + var_x322 + 0.10000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x349 = 1.0 + var_x348;
        const double var_x350 = exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 11) - 2.5349999999999999e-7 * var_chaste_interface__cell__V);
        ...
        const double var_x355 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V - 0.311 * NV_Ith_S(mParameters, 11));
        const double var_x356 = 1.0 + var_x355;
        const double var_x357 = 1 / var_x356;
        const double var_x358 = exp(0.24440000000000001 * var_chaste_interface__cell__V - 0.24440000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x359 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 11) - 0.043909999999999998 * var_chaste_interface__cell__V);
        ...
        const double var_x364 = ((var_x329) ? (var_x361 + var_x354 * var_x357 * (1.5254334000000001e-6 * var_x359 - 31073.016 * var_x358) - 0.311 * var_x354 * var_x355 * var_x360 / pow(var_x356, 2)) : (0));
        const double var_x365 = var_x352 + var_x362;
        const double var_x366 = var_x341 / var_x365;
        const double var_x367 = ((var_x329) ? (-0.001275024 * var_x347 + 0.016701360000000002 * var_x344 * var_x346 / pow(var_x345, 2)) : (-7.6049999999999996e-8 * var_x351 + 0.029999999999999999 * var_x348 * var_x350 / pow(var_x349, 2)));
        ...
        const double var_x383 = 0.005608974358974359 * var_x368 * var_x378;
        const double var_x384 = ((var_x379) ? (4.7698560017679535e-16 * (-36688738598216.805 * var_x373 - 36688738598216.805 * var_x376) / pow((-var_x373 + 0.017500000000000002 * var_x377), 2)) : (var_x382 - var_x381 * var_x383 - var_x369 * var_x383 / pow(var_x380, 2)));
        const double var_x385 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x386 = ((var_x379) ? (1 / (-var_x374 + 801282.05113355326 * var_x377)) : (var_x378 * var_x382));
        const double var_x387 = 0.16025641025641024 * var_x368 * var_x386 / pow(var_x369, 2);
        const double var_x388 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        const double var_x392 = 0.029999999999999999 * var_x390 / pow(var_x391, 2);
        ...
        const double var_x395 = 0.11627906976744186 * var_x393 / pow(var_x394, 2);
        ...
        const double var_x400 = var_x389 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__cell__V);
        const double var_x401 = 1.0 - var_x397 - var_x398;
        const double var_x402 = exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__cell__V);
        ...
        const double var_x408 = exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__cell__V);
        const double var_x409 = 1.0 + var_x408;
        const double var_x410 = 1 / (12.0 - 0.875 * var_chaste_interface__cell__V);
        const double var_x411 = var_x408 / pow(var_x409, 2);
        const double var_x412 = var_chaste_interface__cell__V <= 0;
        const double var_x413 = exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x414 = 1.0 + var_x413;
        const double var_x415 = -var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr + 1 / var_x414;
        ...
        const double var_x422 = var_x420 - 0.00016973999999999998 * var_x418 * var_x421 / pow(var_x419, 2);
        ...
        const double var_x427 = 0.13333333333333333 * var_x413 / pow(var_x414, 2);
        ...
        const double var_x435 = var_x434 - 8.8449999999999995e-5 * var_x428 * var_x432 / pow(var_x433, 2);
        ...
        const double var_x442 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        const double var_x443 = 1.0 + var_x442;
        const double var_x444 = 1 / var_x443;
        const double var_x445 = var_x444 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
        ...
        const double var_x455 = 0.059880239520958084 * var_x442 / pow(var_x443, 2);
        ...
        const double var_x466 = var_x456 * var_x458 / pow(var_x459, 2);
        const double var_x467 = var_x456 * var_x462 / pow(var_x463, 2);
        const double var_x468 = var_x456 * var_x461;
        const double var_x469 = var_x456 * var_x465;
        const double var_x470 = var_x444 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        ...
        const double var_x487 = var_x482 + var_x486;
        const double var_x488 = 1 / var_x487;
        const double var_x489 = 0.40000000000000002 * var_x481;
        const double var_x490 = 0.40000000000000002 * pow(var_x483, 2) / pow(var_x484, 2);
        const double var_x491 = 0.40000000000000002 * pow(var_x479, 2) / pow(var_x480, 2);
        const double var_x492 = 0.40000000000000002 * var_x485;
        ...
        const double var_x504 = 0.02 * var_x500;
        const double var_x505 = 0.02 * pow(var_x498, 2) / pow(var_x499, 2);
        const double var_x506 = 0.0030000000000000001 * var_x494 / pow(var_x495, 2);
        ...
        const double var_x510 = 150.0 * var_x287;
        ...
        const double var_x515 = var_x287 * var_x509;
        const double var_x516 = 166.66666666666666 * var_x515;
        ...
        const double var_x525 = (var_x524) && (var_x63);
        const double var_x526 = var_x198 * var_x273;
        const double var_x527 = 1.3958834540828686 * var_x272 * var_x68;
        const double var_x528 = (var_x524) && (((var_x524) || (var_x63)));
        ...
        const double var_x531 = var_x145 * var_x152;
        const double var_x532 = var_x272 * NV_Ith_S(mParameters, 4);
        const double var_x533 = 0.00019322854132177239 * var_x532;
        const double var_x534 = 0.00057968562396531716 * var_x532;
        ...
        IJth(rJacobian, 1, 0) = var_x292 * (-var_x273 * (var_x271 + var_x74) - var_x275 * var_x288);
        IJth(rJacobian, 2, 0) = ((var_x321) ? (var_x319 + var_x315 * (0.15999999943156581 * var_x316 + 0.16000000056843419 * var_x317)) : (var_x319 + var_x315 * var_x325 - 0.032000000000000001 * var_x315 * var_x320 * var_x323 / pow(var_x324, 2)));
        IJth(rJacobian, 3, 0) = (var_x331 + var_x337) * (var_x338 * var_x342 + var_x330 * var_x341 * (-var_x338 - var_x343) / pow(var_x339, 2)) + (var_x338 + var_x343) * (var_x340 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x330 * var_x342);
        IJth(rJacobian, 4, 0) = (var_x353 + var_x363) * (var_x364 * var_x366 + var_x341 * var_x362 * (-var_x364 - var_x367) / pow(var_x365, 2)) + (var_x364 + var_x367) * (var_x340 - var_chaste_interface__fast_sodium_current_j_gate__j + var_x362 * var_x366);
        IJth(rJacobian, 5, 0) = var_x385 * var_x387 + var_x387 * var_chaste_interface__L_type_Ca_channel_d_gate__d + var_x370 * var_x384 * var_x385 + var_x371 * var_x384 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        IJth(rJacobian, 6, 0) = var_x388 * var_x399 * var_x400 + var_x388 * (0.02 + var_x389) * (var_x392 - var_x395) + var_x396 * (var_x395 - var_x392) * var_chaste_interface__L_type_Ca_channel_f_gate__f - var_x400 * var_x401 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 7, 0) = 0.092592592592592587 * var_x402 * var_x407 / pow(var_x403, 2) + 0.036429872495446269 * var_x404 * (-var_chaste_interface__T_type_Ca_channel_b_gate__b + 1 / var_x403) / (pow(var_x405, 2) * pow((0.60655737704918045 + var_x406), 2));
        IJth(rJacobian, 8, 0) = ((var_x412) ? (0.006076388888888889 * (-var_chaste_interface__T_type_Ca_channel_g_gate__g + 1 / var_x409) / pow((1 - 0.072916666666666671 * var_chaste_interface__cell__V), 2) - 0.17857142857142858 * var_x410 * var_x411) : (-0.014880952380952382 * var_x411));
        IJth(rJacobian, 9, 0) = ((var_x429) ? (var_x415 * (var_x422 + 0.00030499999842881236 * var_x416 + 0.00030500000157118761 * var_x417) + var_x427 * (var_x423 + var_x424 - var_x426)) : ((var_x439) ? (var_x415 * (var_x435 + 0.00068999999999999997 * var_x430 + 0.00068999999999999997 * var_x431) + var_x427 * (var_x437 + var_x438 - var_x436)) : (var_x415 * (var_x422 + var_x435) + var_x427 * (var_x424 + var_x437))));
        IJth(rJacobian, 10, 0) = ((var_x457) ? (var_x445 * (6.5500000000000006e-5 * var_x446 + 6.5500000000000006e-5 * var_x447 + 3.595e-5 * var_x448 + 3.595e-5 * var_x449) + var_x455 * (var_x454 - var_x450 - var_x451)) : (var_x445 * (var_x461 + var_x465 - 8.9997000000000013e-6 * var_x466 - 1.0641199999999999e-5 * var_x467) + var_x455 * (var_x468 + var_x469)));
        IJth(rJacobian, 11, 0) = ((var_x457) ? (var_x455 * (var_x473 - var_x471 - var_x472) + var_x470 * (1.6375000000000002e-5 * var_x446 + 1.6375000000000002e-5 * var_x447 + 8.9874999999999999e-6 * var_x448 + 8.9874999999999999e-6 * var_x449)) : (var_x455 * (var_x476 + var_x477) + var_x470 * (var_x474 + var_x475 - 2.2499250000000003e-6 * var_x466 - 2.6602999999999998e-6 * var_x467)));
        IJth(rJacobian, 12, 0) = var_x487 * (var_x488 * var_x489 - var_x488 * var_x491 + 0.10000000000000001 * var_x481 * (var_x491 + var_x492 - var_x489 - var_x490) / pow((var_x481 + var_x485), 2)) + (-var_chaste_interface__transient_outward_current_zdv_gate__zdv + var_x482 * var_x488) * (var_x489 + var_x490 - var_x491 - var_x492);
        IJth(rJacobian, 13, 0) = var_x502 * (-var_x503 * var_x506 + 1.4999999999999998 * var_x496 * (var_x505 + var_x506 - var_x504) / pow((var_x500 + 0.14999999999999999 * var_x496), 2)) + (-var_chaste_interface__transient_outward_current_ydv_gate__ydv + var_x497 * var_x503) * (var_x504 - var_x505 - var_x506);
        IJth(rJacobian, 14, 0) = var_x275 * var_x511;
        IJth(rJacobian, 19, 0) = ((var_x525) ? (-var_x273 * (var_x271 + var_x62)) : ((var_x524) ? (-var_x273 * (var_x271 + var_x73)) : (0)));
        IJth(rJacobian, 23, 0) = -var_x533 * (0.0040000000000000001 + var_x106 + var_x37 + var_x50 + 3.0 * var_x142 + 6.75 * var_x531 + 0.11230765052340785 * var_x160 - 0.095461502944896678 * var_x270);
        IJth(rJacobian, 24, 0) = -var_x533 * (var_x109 + var_x126 + var_x127 + var_x140 + var_x154 + var_x165 + var_x29 + var_x535 + var_x56 + var_x78 + var_x80 + var_x91 + var_x95 - var_x157 - var_x158 - 4.5 * var_x531);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x208 + var_x212 - var_x173 - var_x177 - var_x185 - var_x190 - var_x201 - var_x204 - var_x205 - var_x211 - var_x218 + 0.0001 * var_x214);
        IJth(rJacobian, 1, 1) = var_x292 * (-var_x295 - var_x300 + 0.081176470588235281 * var_x297 - var_x273 * (var_x201 + var_x296) - var_x288 * var_x301) + (0.00023800000000000004 / pow(var_x289, 3) + 7.0000000000000007e-5 / pow(var_x202, 3)) * (var_x276 * var_x300 + var_x304 * var_chaste_interface__calcium_dynamics__Ca_NSR - var_x273 * (var_x278 + var_x302 + 0.003016 * var_chaste_interface__cell__V - 2.0 * var_x270) - var_x295 * var_chaste_interface__calcium_dynamics__Cai) / pow(var_x290, 2);
        IJth(rJacobian, 14, 1) = var_x514 * (var_x513 + var_x301 * var_x510);
        IJth(rJacobian, 15, 1) = var_x294 - var_x297;
        IJth(rJacobian, 19, 1) = ((var_x525) ? (-var_x273 * (var_x199 + var_x296)) : ((var_x524) ? (-var_x273 * (var_x200 + var_x296)) : (0)));
        IJth(rJacobian, 23, 1) = -var_x533 * (var_x177 + var_x185 - 3.0 * var_x212 - 0.00030000000000000003 * var_x214);
        IJth(rJacobian, 24, 1) = -var_x533 * (var_x173 + var_x190 + var_x218);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x222);
        IJth(rJacobian, 2, 2) = ((var_x321) ? (var_x326 + var_x327 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__cell__V) * (var_x326 + 3.1999999919207769e-7 * var_x316)) : (var_x327 - var_x320 * var_x325));
        IJth(rJacobian, 23, 2) = -var_x222 * var_x534;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x223);
        IJth(rJacobian, 3, 3) = -var_x331 - var_x337;
        IJth(rJacobian, 23, 3) = -var_x223 * var_x533;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x224);
        IJth(rJacobian, 4, 4) = -var_x353 - var_x363;
        IJth(rJacobian, 23, 4) = -var_x224 * var_x533;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x226 - var_x227 - var_x229);
        IJth(rJacobian, 1, 5) = var_x292 * (-var_x229 * var_x273 - var_x229 * var_x305);
        IJth(rJacobian, 5, 5) = var_x371 * var_x386 - var_x370 * var_x386;
        IJth(rJacobian, 14, 5) = var_x229 * var_x516;
        IJth(rJacobian, 19, 5) = ((var_x525) ? (-var_x44 * var_x526) : ((var_x524) ? (-var_x225 * var_x527) : (0)));
        IJth(rJacobian, 23, 5) = -var_x226 * var_x533;
        IJth(rJacobian, 24, 5) = -var_x227 * var_x533;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x233 - var_x234 - var_x235);
        IJth(rJacobian, 1, 6) = var_x292 * (-var_x235 * var_x273 - var_x235 * var_x305);
        IJth(rJacobian, 6, 6) = var_x396 * var_x399 + var_x396 * var_x401;
        IJth(rJacobian, 14, 6) = var_x235 * var_x516;
        IJth(rJacobian, 19, 6) = ((var_x525) ? (-var_x231 * var_x526) : ((var_x524) ? (-var_x232 * var_x527) : (0)));
        IJth(rJacobian, 23, 6) = -var_x233 * var_x533;
        IJth(rJacobian, 24, 6) = -var_x234 * var_x533;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.10000000000000001 * var_x238);
        IJth(rJacobian, 1, 7) = var_x292 * (var_x306 - 0.1176470588235294 * var_x238 * var_x287);
        IJth(rJacobian, 7, 7) = -var_x407;
        IJth(rJacobian, 14, 7) = 16.666666666666668 * var_x238 * var_x515;
        IJth(rJacobian, 19, 7) = ((var_x528) ? (var_x306) : (0));
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x237 * var_x82);
        IJth(rJacobian, 1, 8) = var_x292 * (var_x308 - 0.058823529411764698 * var_x309);
        IJth(rJacobian, 8, 8) = ((var_x412) ? (-var_x410) : (-0.083333333333333329));
        IJth(rJacobian, 14, 8) = 8.3333333333333339 * var_x309 * var_x509;
        IJth(rJacobian, 19, 8) = ((var_x528) ? (var_x308) : (0));
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x125 * var_x239);
        IJth(rJacobian, 9, 9) = ((var_x429) ? (var_x425 + var_x426 + var_x440) : ((var_x439) ? (var_x436 + var_x441 - var_x438) : (var_x440 + var_x441)));
        IJth(rJacobian, 24, 9) = -8.3152324727908455e-5 * var_x124 * var_x239 * var_x532;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x102 * var_x216);
        IJth(rJacobian, 10, 10) = ((var_x457) ? (var_x452 - var_x454) : (-var_x468 - var_x469));
        IJth(rJacobian, 24, 10) = -var_x216 * var_x518 * var_x533;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x100 * var_x240);
        IJth(rJacobian, 11, 11) = ((var_x457) ? (var_x471 + var_x472 - var_x473) : (-var_x476 - var_x477));
        IJth(rJacobian, 24, 11) = -var_x240 * var_x517 * var_x533;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x241);
        IJth(rJacobian, 12, 12) = -var_x482 - var_x486;
        IJth(rJacobian, 24, 12) = -var_x241 * var_x534;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x242);
        IJth(rJacobian, 13, 13) = -var_x497 - var_x501;
        IJth(rJacobian, 24, 13) = -var_x242 * var_x533;
        IJth(rJacobian, 1, 14) = var_x291 * var_x300;
        IJth(rJacobian, 14, 14) = var_x514 * (-0.0055555555555555558 - var_x513) + 0.25 * (0.0055555555555555558 * var_chaste_interface__calcium_dynamics__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__calcium_dynamics__Ca_JSR - var_x276 * var_x513) / (pow(var_x507, 3) * pow((0.125 + var_x508), 2));
        IJth(rJacobian, 15, 14) = 0.00048309178743961351;
        IJth(rJacobian, 1, 15) = var_x291 * var_x304;
        IJth(rJacobian, 14, 15) = 0.0055555555555555558 * var_x509;
        IJth(rJacobian, 15, 15) = -0.00048309178743961351 - 0.066666666666666666 * var_x303;
        IJth(rJacobian, 16, 16) = (((((var_x63) || (var_x13 >= 2.6712338705498262e-6) || (var_x520 + var_x522 < -150.0))) && (((var_x13 >= 1.3356169352749131e-6) || (var_x519 + var_x522 + var_x43 * (var_x195 + var_x197 * (var_x195 + var_x196)) < -150.0))) && (((var_x14) || (var_x63) || (var_x520 + var_x22 * var_chaste_interface__cell__V + var_x35 * var_chaste_interface__cell__V + var_x48 * var_chaste_interface__cell__V + var_x55 * var_chaste_interface__cell__V < -150.0)))) ? (-100.5) : (-0.5));
        IJth(rJacobian, 1, 17) = var_x292 * (var_x299 * var_x311 - var_x299 * var_x312);
        IJth(rJacobian, 14, 17) = var_x514 * (var_x312 * var_x512 - var_x311 * var_x512);
        IJth(rJacobian, 17, 17) = ((var_x523) ? (-100.5) : (-0.5));
        IJth(rJacobian, 18, 18) = ((var_x523) ? (-100.5) : (-0.01));
        IJth(rJacobian, 19, 19) = (((((var_x524) || (var_x529))) && (((var_x524) || (var_x529) || (var_x63)))) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 21, 21) = (((var_x530) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50.0) : (-0.5));
        IJth(rJacobian, 22, 22) = (((var_x530) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50.0) : (-0.01));
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (var_x247 - var_x249 - var_x250 - var_x252 - var_x255 - 3 * var_x257 + 0.00030000000000000003 * var_x258 + 0.48963716847178318 * var_x251 - 0.044999999999999998 * var_x254);
        IJth(rJacobian, 1, 23) = var_x292 * (var_x313 - var_x288 * var_x314);
        IJth(rJacobian, 14, 23) = var_x314 * var_x511;
        IJth(rJacobian, 19, 23) = ((var_x528) ? (var_x313) : (0));
        IJth(rJacobian, 23, 23) = -var_x533 * (var_x246 + var_x249 + var_x250 + var_x255 + 9.0 * var_x257 + 0.13500000000000001 * var_x254 - 0.00090000000000000008 * var_x258);
        IJth(rJacobian, 24, 23) = -var_x533 * (var_x252 + 0.48963716847178318 * var_x536 - 0.089999999999999997 * var_x254);
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (var_x247 + var_x269 - var_x260 - var_x261 - var_x262 - var_x263 - var_x264 - var_x265 - var_x266 - var_x268 + 26.712338705498265 * var_x251);
        IJth(rJacobian, 24, 24) = -var_x533 * (var_x246 + var_x260 + var_x261 + var_x262 + var_x263 + var_x264 + var_x265 + var_x266 + var_x268 - var_x269 + 26.712338705498265 * var_x536);
    }
