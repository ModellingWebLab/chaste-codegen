...
class Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables()
    {
...
protected:
    Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables(const Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables&);
    Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables& operator= (const Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables&);
    Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables()
    {
        ...
        Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables> Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt::Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                22,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt>::Instance();
        Init();
    ...
    Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt::~Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt()
    {
    }

    AbstractLookupTableCollection* Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
        ...
        const double var_cell__dVdt = -(-var_ICa__E_Ca + var_chaste_interface__cell__V) * ((var_cell__failing == 0) ? (0.00084999999999999995) : (0.0012999999999999999)) - (-var_INa__E_Na + var_chaste_interface__cell__V) * ((var_cell__failing == 0) ? (0.001) : (0)) - pow(var_chaste_interface__IKs_Xs_gate__Xs, 2) * (-log((NV_Ith_S(mParameters, 4) + 0.018329999999999999 * NV_Ith_S(mParameters, 5)) / (var_chaste_interface__Ionic_concentrations__Ki + 0.018329999999999999 * var_chaste_interface__Ionic_concentrations__Nai)) / var_cell__FonRT + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 14) - (-log(NV_Ith_S(mParameters, 4) / var_chaste_interface__Ionic_concentrations__Ki) / var_cell__FonRT + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 13) * var_chaste_interface__IKr_Xr_gate__Xr / (_lt_0_row[0]) - (-log((NV_Ith_S(mParameters, 4) + 0.042999999999999997 * NV_Ith_S(mParameters, 5)) / (var_chaste_interface__Ionic_concentrations__Ki + 0.042999999999999997 * var_chaste_interface__Ionic_concentrations__Nai)) / var_cell__FonRT + var_chaste_interface__cell__V) * ((var_cell__failing == 0) ? (0.29999999999999999 * NV_Ith_S(mParameters, 16)) : (0.191 * NV_Ith_S(mParameters, 16))) * var_chaste_interface__Ito_r_gate__r * var_chaste_interface__Ito_t_gate__t - (pow(var_chaste_interface__Ionic_concentrations__Nai, 3) * NV_Ith_S(mParameters, 3) * exp(0.34999999999999998 * var_cell__FonRT * var_chaste_interface__cell__V) - pow(NV_Ith_S(mParameters, 5), 3) * var_chaste_interface__Ionic_concentrations__Cai * exp(-0.65000000000000002 * var_cell__FonRT * var_chaste_interface__cell__V)) * ((var_cell__failing == 0) ? (NV_Ith_S(mParameters, 15)) : (1650.0)) / ((1.0 + 0.10000000000000001 * exp(-0.65000000000000002 * var_cell__FonRT * var_chaste_interface__cell__V)) * (669921.875 + pow(NV_Ith_S(mParameters, 5), 3)) * (1.3799999999999999 + NV_Ith_S(mParameters, 3))) - ((var_cell__failing == 0) ? (1.3) : (0.75)) * NV_Ith_S(mParameters, 4) / ((1.0 + 31.622776601683793 * pow((1 / var_chaste_interface__Ionic_concentrations__Nai), 1.5)) * (1.5 + NV_Ith_S(mParameters, 4)) * (1.0 + 0.1245 * exp(-0.10000000000000001 * var_cell__FonRT * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * NV_Ith_S(mParameters, 5))) * exp(-var_cell__FonRT * var_chaste_interface__cell__V))) - pow(var_chaste_interface__INa_m_gate__m, 3) * (-var_INa__E_Na + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 9) * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j - 0.10000000000000001 * (-var_IK1__E_K1 + var_chaste_interface__cell__V) * ((var_cell__failing == 0) ? (2.5) : (2.0)) * NV_Ith_S(mParameters, 12) / ((1.0 + exp(-12.0 + 0.059999999999999998 * var_chaste_interface__cell__V - 0.059999999999999998 * var_IK1__E_K1)) * (0.10000000000000001 / (1.0 + exp(-12.0 + 0.059999999999999998 * var_chaste_interface__cell__V - 0.059999999999999998 * var_IK1__E_K1)) + (exp(-1.0 + 0.10000000000000001 * var_chaste_interface__cell__V - 0.10000000000000001 * var_IK1__E_K1) + 3.0 * exp(0.02 + 0.00020000000000000001 * var_chaste_interface__cell__V - 0.00020000000000000001 * var_IK1__E_K1)) / (1.0 + exp(0.5 * var_IK1__E_K1 - 0.5 * var_chaste_interface__cell__V)))) - 0.00059999999999999995 * (-var_ICa__E_Ca + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 8) * var_chaste_interface__ICa_d_gate__d * var_chaste_interface__ICa_f_gate__f / (0.00059999999999999995 + var_chaste_interface__Ionic_concentrations__Cai); // mV_per_ms
    ...
    void Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_IK1__E_K1 = log(NV_Ith_S(mParameters, 4) / var_chaste_interface__Ionic_concentrations__Ki) / var_cell__FonRT; // mV
        const double var_INa__E_Na = log(NV_Ith_S(mParameters, 5) / var_chaste_interface__Ionic_concentrations__Nai) / var_cell__FonRT; // mV
        const double var_ICa__i_Ca = 0.00059999999999999995 * (-var_ICa__E_Ca + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 8) * var_chaste_interface__ICa_d_gate__d * var_chaste_interface__ICa_f_gate__f / (0.00059999999999999995 + var_chaste_interface__Ionic_concentrations__Cai); // uA_per_uF
        ...
        const double var_IKr__i_Kr = (-log(NV_Ith_S(mParameters, 4) / var_chaste_interface__Ionic_concentrations__Ki) / var_cell__FonRT + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 13) * var_chaste_interface__IKr_Xr_gate__Xr / (_lt_0_row[0]); // uA_per_uF
        ...
        const double d_dt_chaste_interface_var_INa_h_gate__h = (var_INa_h_gate__alpha_h + var_INa_h_gate__beta_h) * (-var_chaste_interface__INa_h_gate__h + 0.01 * NV_Ith_S(mParameters, 10) + (1.0 - 0.01 * NV_Ith_S(mParameters, 10)) * var_INa_h_gate__alpha_h / (var_INa_h_gate__alpha_h + var_INa_h_gate__beta_h)); // 1 / ms
        ...
        const double d_dt_chaste_interface_var_INa_j_gate__j = (var_INa_j_gate__alpha_j + var_INa_j_gate__beta_j) * (-var_chaste_interface__INa_j_gate__j + 0.01 * NV_Ith_S(mParameters, 10) + (1.0 - 0.01 * NV_Ith_S(mParameters, 10)) * var_INa_j_gate__alpha_j / (var_INa_j_gate__alpha_j + var_INa_j_gate__beta_j)); // 1 / ms
        const double d_dt_chaste_interface_var_INa_m_gate__m = -0.080000000000000002 * var_chaste_interface__INa_m_gate__m * _lt_0_row[11] + 0.32000000000000001 * (1.0 - var_chaste_interface__INa_m_gate__m) * (47.130000000000003 + var_chaste_interface__cell__V) / (_lt_0_row[12]); // 1 / ms
        ...
        const double var_IK1__i_K1 = 0.10000000000000001 * (-var_IK1__E_K1 + var_chaste_interface__cell__V) * ((var_cell__failing == 0) ? (2.5) : (2.0)) * NV_Ith_S(mParameters, 12) / ((1.0 + exp(-12.0 + 0.059999999999999998 * var_chaste_interface__cell__V - 0.059999999999999998 * var_IK1__E_K1)) * (0.10000000000000001 / (1.0 + exp(-12.0 + 0.059999999999999998 * var_chaste_interface__cell__V - 0.059999999999999998 * var_IK1__E_K1)) + (exp(-1.0 + 0.10000000000000001 * var_chaste_interface__cell__V - 0.10000000000000001 * var_IK1__E_K1) + 3.0 * exp(0.02 + 0.00020000000000000001 * var_chaste_interface__cell__V - 0.00020000000000000001 * var_IK1__E_K1)) / (1.0 + exp(0.5 * var_IK1__E_K1 - 0.5 * var_chaste_interface__cell__V)))); // uA_per_uF
        ...
        const double var_INaK__i_NaK = ((var_cell__failing == 0) ? (1.3) : (0.75)) * NV_Ith_S(mParameters, 4) / ((1.0 + 31.622776601683793 * pow((1 / var_chaste_interface__Ionic_concentrations__Nai), 1.5)) * (1.5 + NV_Ith_S(mParameters, 4)) * (1.0 + 0.1245 * exp(-0.10000000000000001 * var_cell__FonRT * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * NV_Ith_S(mParameters, 5))) * exp(-var_cell__FonRT * var_chaste_interface__cell__V))); // uA_per_uF
        ...
        const double var_Ito__i_to = (-log((NV_Ith_S(mParameters, 4) + 0.042999999999999997 * NV_Ith_S(mParameters, 5)) / (var_chaste_interface__Ionic_concentrations__Ki + 0.042999999999999997 * var_chaste_interface__Ionic_concentrations__Nai)) / var_cell__FonRT + var_chaste_interface__cell__V) * ((var_cell__failing == 0) ? (0.29999999999999999 * NV_Ith_S(mParameters, 16)) : (0.191 * NV_Ith_S(mParameters, 16))) * var_chaste_interface__Ito_r_gate__r * var_chaste_interface__Ito_t_gate__t; // uA_per_uF
    ...
    void Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: mV; Initial value: -90.7796417483135
        double var_chaste_interface__Ionic_concentrations__Cai = NV_Ith_S(rY, 1);
...
const double var_x0 = pow(var_chaste_interface__IKs_Xs_gate__Xs, 2) * NV_Ith_S(mParameters, 14);
        ...
        const double var_x128 = var_x125 * var_x126 * var_x127 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x141 = 3.6460865337870681e-8 * var_x122 * var_x78;
        const double var_x142 = var_x141 * var_x35;
        const double var_x143 = var_x141 * var_x34 * NV_Ith_S(mParameters, 8) * var_chaste_interface__ICa_d_gate__d;
        const double var_x144 = var_x125 * var_x137 * var_chaste_interface__Irel__APtrack2 * NV_Ith_S(mParameters, 0);
        const double var_x145 = ((var_x130) ? (var_x128 * var_x137 - var_x127 * var_x144) : (0));
        const double var_x146 = 0.0070588235294117632 * var_x120;
        const double var_x147 = ((var_x130) ? (var_x126 * var_x144 - var_x126 * var_x127 * var_x137 * var_chaste_interface__Irel__APtrack2 * NV_Ith_S(mParameters, 0) / pow(var_x124, 2)) : (0));
        ...
        const double var_x155 = _lt_0_row[11];
        const double var_x156 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x157 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 11) - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x158 = var_chaste_interface__cell__V < -40.0;
        const double var_x159 = ((var_x158) ? (0.13500000000000001 * var_x157) : (0));
        const double var_x160 = var_x159;
        const double var_x161 = exp(var_x60 - 0.34999999999999998 * NV_Ith_S(mParameters, 11));
        const double var_x162 = exp(0.079000000000000001 * var_chaste_interface__cell__V - 0.079000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x163 = exp(-0.96036036036036043 - 0.0900900900900901 * NV_Ith_S(mParameters, 11) - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x164 = 1.0 + var_x163;
        const double var_x165 = ((var_x158) ? (310000.0 * var_x161 + 3.5600000000000001 * var_x162) : (7.6923076923076916 / var_x164));
        const double var_x166 = var_x165;
        const double var_x167 = ((var_x158) ? (-0.019852941176470591 * var_x157) : (0));
        const double var_x168 = var_x159 + var_x165;
        const double var_x169 = 0.01 * NV_Ith_S(mParameters, 10);
        const double var_x170 = 1.0 - var_x169;
        const double var_x171 = var_x170 / var_x168;
        const double var_x172 = ((var_x158) ? (0.28123999999999999 * var_x162 + 108500.0 * var_x161) : (0.693000693000693 * var_x163 / pow(var_x164, 2)));
        const double var_x173 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 11) - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x174 = 1.0 + var_x173;
        const double var_x175 = exp(0.01052 * NV_Ith_S(mParameters, 11) - 0.01052 * var_chaste_interface__cell__V);
        const double var_x176 = var_x175 / var_x174;
        const double var_x177 = exp(-3.2000000000000002 + var_x151 + 0.10000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x178 = 1.0 + var_x177;
        const double var_x179 = exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 11) - 2.5349999999999999e-7 * var_chaste_interface__cell__V);
        const double var_x180 = var_x179 / var_x178;
        const double var_x181 = ((var_x158) ? (0.1212 * var_x176) : (0.29999999999999999 * var_x180));
        const double var_x182 = var_x181;
        const double var_x183 = 37.780000000000001 + var_chaste_interface__cell__V;
        const double var_x184 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V - 0.311 * NV_Ith_S(mParameters, 11));
        const double var_x185 = 1.0 + var_x184;
        const double var_x186 = 1 / var_x185;
        const double var_x187 = exp(0.24399999999999999 * var_chaste_interface__cell__V - 0.24399999999999999 * NV_Ith_S(mParameters, 11));
        const double var_x188 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 11) - 0.043909999999999998 * var_chaste_interface__cell__V);
        ...
        const double var_x193 = ((var_x158) ? (var_x190 + var_x183 * var_x186 * (1.5254334000000001e-6 * var_x188 - 31022.16 * var_x187) - 0.311 * var_x183 * var_x184 * var_x189 / pow(var_x185, 2)) : (0));
        const double var_x194 = var_x181 + var_x191;
        const double var_x195 = var_x170 / var_x194;
        const double var_x196 = ((var_x158) ? (-0.001275024 * var_x176 + 0.016701360000000002 * var_x173 * var_x175 / pow(var_x174, 2)) : (-7.6049999999999996e-8 * var_x180 + 0.029999999999999999 * var_x177 * var_x179 / pow(var_x178, 2)));
        const double var_x197 = 1 / sqrt(M_PI);
        const double var_x198 = 0.25101580310038191 * var_x197 * exp(-0.08830693125184777 * pow((-1 + 0.15937778911130945 * var_chaste_interface__cell__V), 2));
        const double var_x199 = 0.63524014987941491 * var_x197 * _lt_0_row[2];
        const double var_x200 = exp(-2.7305064499999996 - 0.27789999999999998 * var_chaste_interface__cell__V);
        const double var_x201 = 1.0 + var_x200;
        const double var_x202 = 1 / var_x201;
        const double var_x203 = exp(-1.06213655 - 0.1081 * var_chaste_interface__cell__V);
        const double var_x204 = 0.0112 + 0.068699999999999997 * var_x203;
        const double var_x205 = exp(-1.0052757950443461 + 0.16333730787449161 * var_chaste_interface__cell__V);
        const double var_x206 = 1.0 + var_x205;
        const double var_x207 = exp(6.9907280000000006e-6 - 0.1348 * var_chaste_interface__cell__V);
        const double var_x208 = 1.0 + var_x207;
        const double var_x209 = 1 / var_x208;
        const double var_x210 = exp(0.67236288 - 0.13439999999999999 * var_chaste_interface__cell__V);
        const double var_x211 = 1.0 - var_chaste_interface__Ito_r_gate__r;
        const double var_x212 = exp(3.9880601600000003 - 0.094299999999999995 * var_chaste_interface__cell__V);
        const double var_x213 = 1.0 + var_x212;
        const double var_x214 = _lt_0_row[16];
        const double var_x215 = var_x214 / var_x213;
        const double var_x216 = 0.51490000000000002 * var_x210 + 5.1860000000000002e-5 * var_chaste_interface__cell__V;
        const double var_x217 = exp(-5.9326369200000002 - 0.17319999999999999 * var_chaste_interface__cell__V);
        const double var_x218 = 1.0 + var_x217;
        const double var_x219 = 1 / var_x218;
        const double var_x220 = 1.0 - var_chaste_interface__Ito_t_gate__t;
        const double var_x221 = exp(-5.9257863000000004 - 0.17299999999999999 * var_chaste_interface__cell__V);
        const double var_x222 = exp(-5.4573693999999993 - 0.16039999999999999 * var_chaste_interface__cell__V);
        const double var_x223 = 1.0 + var_x222;
        const double var_x224 = 1 / var_x223;
        const double var_x225 = exp(-5.6479010000000002e-8 - 1.6600000000000001e-9 * var_chaste_interface__cell__V);
        const double var_x226 = 5.6119999999999998e-5 * var_chaste_interface__cell__V + 0.072099999999999997 * var_x221;
        const double var_x227 = 0.0001215 * var_chaste_interface__cell__V + 0.076700000000000004 * var_x225;
        const double var_x228 = exp(-0.17842998931347828 - 0.069846547135942336 * var_chaste_interface__cell__V);
        const double var_x229 = 1.0 + var_x228;
        const double var_x230 = exp(1.0082174462705435 + 0.063211125158027806 * var_chaste_interface__cell__V);
        const double var_x231 = 1.0 + var_x230;
        const double var_x232 = 1.0 - var_chaste_interface__IKr_Xr_gate__Xr;
        const double var_x233 = exp(-0.51325540000000003 - 0.12620000000000001 * var_chaste_interface__cell__V);
        const double var_x234 = 1.0 + var_x233;
        const double var_x235 = _lt_0_row[6];
        const double var_x236 = var_x235 / var_x234;
        const double var_x237 = exp(5.1411779999999991 + 0.078299999999999995 * var_chaste_interface__cell__V);
        const double var_x238 = 1.0 + var_x237;
        const double var_x239 = _lt_0_row[8];
        const double var_x240 = var_x239 / var_x238;
        const double var_x241 = (var_chaste_interface__Irel__APtrack > 0.17999999999999999) && (var_chaste_interface__Irel__APtrack < 0.20000000000000001);
        const double var_x242 = var_chaste_interface__Irel__APtrack > 0.20000000000000001;
        const double var_x243 = var_x45 * var_x53;
        const double var_x244 = var_x122 * NV_Ith_S(mParameters, 2);
        const double var_x245 = 0.00012153621779290228 * var_x244;
        const double var_x246 = 0.00036460865337870681 * var_x244;
        const double var_x247 = var_x245 * var_x85;
        const double var_x248 = var_x245 * (var_x90 - var_x95);
        const double var_x249 = 0.80000000000000004 + var_chaste_interface__Ionic_concentrations__Ca_JSR;
        ...
        IJth(rJacobian, 2, 0) = var_x150 * var_x154 + 0.0072727272727272727 * var_x155 * var_chaste_interface__INa_m_gate__m - 0.032000000000000001 * var_x150 * var_x152 * var_x156 / pow(var_x153, 2);
        IJth(rJacobian, 3, 0) = (var_x160 + var_x166) * (var_x167 * var_x171 + var_x159 * var_x170 * (-var_x167 - var_x172) / pow(var_x168, 2)) + (var_x167 + var_x172) * (var_x169 - var_chaste_interface__INa_h_gate__h + var_x159 * var_x171);
        IJth(rJacobian, 4, 0) = (var_x182 + var_x192) * (var_x193 * var_x195 + var_x170 * var_x191 * (-var_x193 - var_x196) / pow(var_x194, 2)) + (var_x193 + var_x196) * (var_x169 - var_chaste_interface__INa_j_gate__j + var_x191 * var_x195);
        IJth(rJacobian, 5, 0) = var_x198 * (0.028148326932247791 - 0.0044862181136439798 * var_chaste_interface__cell__V) * var_chaste_interface__ICa_d_gate__d + var_x199 * (1.0 - var_chaste_interface__ICa_d_gate__d) * (0.080354834965543909 - 0.0035936867158114449 * var_chaste_interface__cell__V);
        IJth(rJacobian, 6, 0) = (0.0074264700000000001 * var_x202 * var_x203 - 0.27789999999999998 * var_x200 * var_x204 / pow(var_x201, 2)) * var_chaste_interface__ICa_f_gate__f - 0.0011224539797135063 * var_x205 * (1.0 - var_chaste_interface__ICa_f_gate__f) / pow(var_x206, 2);
        IJth(rJacobian, 7, 0) = -0.0087415599999999989 * var_x211 * var_x215 - var_x209 * (5.1860000000000002e-5 - 0.069202559999999996 * var_x210) * var_chaste_interface__Ito_r_gate__r + 0.049658379999999995 * var_x211 * var_x212 * var_x214 / pow(var_x213, 2) - 0.1348 * var_x207 * var_x216 * var_chaste_interface__Ito_r_gate__r / pow(var_x208, 2);
        IJth(rJacobian, 8, 0) = var_x219 * var_x220 * (5.6119999999999998e-5 - 0.012473299999999998 * var_x221) - var_x224 * (0.0001215 - 1.2732200000000002e-10 * var_x225) * var_chaste_interface__Ito_t_gate__t + 0.17319999999999999 * var_x217 * var_x220 * var_x226 / pow(var_x218, 2) - 0.16039999999999999 * var_x222 * var_x227 * var_chaste_interface__Ito_t_gate__t / pow(var_x223, 2);
        IJth(rJacobian, 9, 0) = 0.00021044764652059425 * var_x228 * (1.0 - var_chaste_interface__IKs_Xs_gate__Xs) / pow(var_x229, 2) + 0.00037104930467762328 * var_x230 * var_chaste_interface__IKs_Xs_gate__Xs / pow(var_x231, 2);
        IJth(rJacobian, 10, 0) = 2.633e-6 * var_x232 * var_x236 - 2.5600000000000002e-5 * var_x240 * var_chaste_interface__IKr_Xr_gate__Xr + 0.0012527999999999999 * var_x237 * var_x239 * var_chaste_interface__IKr_Xr_gate__Xr / pow(var_x238, 2) + 0.00063100000000000005 * var_x232 * var_x233 * var_x235 / pow(var_x234, 2);
        IJth(rJacobian, 14, 0) = ((var_x242) ? (-var_x123 * (var_x121 + var_x73)) : (0));
        IJth(rJacobian, 18, 0) = -var_x245 * (0.001 + var_x31 + 3.0 * var_x70 + 3.9000000000000004 * var_x243 + 0.19500000000000001 * var_x72);
        IJth(rJacobian, 19, 0) = -var_x245 * (var_x0 + var_x10 + var_x28 + var_x59 + var_x7 - var_x39 - var_x41 - 2.6000000000000001 * var_x243);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x80 + var_x82 - var_x76 - var_x83);
        IJth(rJacobian, 1, 1) = var_x120 * (-var_x134 + 0.0070588235294117632 * var_x131 + 0.00036529411764705876 * var_x135 - var_x123 * (var_x136 + 2.0 * var_x81)) + (0.00023800000000000004 / pow(var_x117, 3) + 7.0000000000000007e-5 / pow(var_x118, 3)) * (0.0070588235294117632 * var_x138 + 2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR - var_x123 * (var_x140 + 0.00084999999999999995 * var_chaste_interface__cell__V - 2.0 * var_x139) - var_x134 * var_chaste_interface__Ionic_concentrations__Cai) / pow(var_x119, 2);
        IJth(rJacobian, 14, 1) = ((var_x242) ? (-var_x123 * (var_x136 + var_x82)) : (0));
        IJth(rJacobian, 18, 1) = var_x246 * var_x81;
        IJth(rJacobian, 20, 1) = -var_x131 * var_x252;
        ...
        IJth(rJacobian, 18, 2) = -var_x246 * var_x87;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x30 * var_x88);
        IJth(rJacobian, 3, 3) = -var_x160 - var_x166;
        IJth(rJacobian, 18, 3) = -var_x247 * var_x30;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x88 * var_x89);
        IJth(rJacobian, 4, 4) = -var_x182 - var_x192;
        IJth(rJacobian, 18, 4) = -var_x247 * var_x89;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x36 * var_x78);
        IJth(rJacobian, 1, 5) = -var_x120 * var_x142;
        IJth(rJacobian, 5, 5) = -0.14710000000000001 + var_x198 - var_x199;
        IJth(rJacobian, 14, 5) = ((var_x242) ? (-var_x142) : (0));
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x34 * var_x79);
        IJth(rJacobian, 1, 6) = -var_x120 * var_x143;
        IJth(rJacobian, 6, 6) = -0.00054739999999999997 - 0.0068719999999999996 / var_x206 - var_x202 * var_x204;
        IJth(rJacobian, 14, 6) = ((var_x242) ? (-var_x143) : (0));
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x96 * var_chaste_interface__Ito_t_gate__t);
        IJth(rJacobian, 7, 7) = -0.52659999999999996 * var_x215 - var_x209 * var_x216;
        IJth(rJacobian, 19, 7) = -var_x248 * var_x8;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x96 * var_chaste_interface__Ito_r_gate__r);
        IJth(rJacobian, 8, 8) = -var_x219 * var_x226 - var_x224 * var_x227;
        IJth(rJacobian, 19, 8) = -var_x248 * NV_Ith_S(mParameters, 16) * var_chaste_interface__Ito_r_gate__r;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-2.0 * var_x99);
        IJth(rJacobian, 9, 9) = -0.0058700000000000002 / var_x231 - 0.0030130000000000001 / var_x229;
        IJth(rJacobian, 19, 9) = -0.00024307243558580456 * var_x244 * var_x99;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x100 * var_x6);
        IJth(rJacobian, 10, 10) = -0.016 * var_x240 - 0.0050000000000000001 * var_x236;
        IJth(rJacobian, 19, 10) = -var_x100 * var_x245 * var_x5;
        IJth(rJacobian, 11, 11) = ((var_x140 + var_x139 + 0.0018500000000000001 * var_chaste_interface__cell__V - 0.001 * var_x84 + var_x1 * var_x98 + var_x10 * (-var_x94 + var_chaste_interface__cell__V) + var_x105 * var_x46 + var_x28 * var_x38 + var_x32 * var_x85 + var_x38 * var_x7 + GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() < -150.0) ? (-100.5) : (-0.5));
        IJth(rJacobian, 1, 12) = var_x145 * var_x146;
        IJth(rJacobian, 12, 12) = ((var_x241) ? (-100.5) : (-0.5));
        IJth(rJacobian, 20, 12) = -var_x145 * var_x252;
        IJth(rJacobian, 13, 13) = ((var_x241) ? (-100.5) : (-0.01));
        IJth(rJacobian, 1, 14) = var_x146 * var_x147;
        IJth(rJacobian, 14, 14) = (((var_x242) || (var_chaste_interface__Irel__APtrack2 > 0.01)) ? (0) : (-0.5));
        IJth(rJacobian, 20, 14) = -var_x147 * var_x252;
        ...
        IJth(rJacobian, 1, 18) = 0.00036460865337870681 * var_x120 * var_x148;
        IJth(rJacobian, 14, 18) = ((var_x242) ? (0.00018230432668935341 * var_x148) : (0));
        IJth(rJacobian, 18, 18) = -var_x245 * (var_x102 + 9.0 * var_x107 + 0.18499324311985019 * var_x106 + var_x101 * var_x31);
        IJth(rJacobian, 19, 18) = -var_x245 * (var_x104 + var_x109 - 0.1233288287465668 * var_x106);
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x116 - var_x111 - var_x112 - var_x113 - var_x114 - var_x115);
        IJth(rJacobian, 19, 19) = -var_x245 * (var_x111 + var_x112 + var_x113 + var_x114 + var_x115 - var_x116);
        IJth(rJacobian, 1, 20) = var_x146 * var_x149;
        IJth(rJacobian, 20, 20) = var_x252 * (-0.0055555555555555558 - var_x149) + 0.25 * (-var_x138 + 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_JSR) / (pow(var_x249, 3) * pow((0.125 + var_x250), 2));
        IJth(rJacobian, 21, 20) = 0.00048309178743961351;
        IJth(rJacobian, 1, 21) = 2.1105882352941172e-5 * var_x120;
        IJth(rJacobian, 20, 21) = 0.0055555555555555558 * var_x251;
        IJth(rJacobian, 21, 21) = -0.00074309178743961349;
    }

    N_Vector Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpriebe_beuckelmann_1998FromCellMLCvodeOpt)
