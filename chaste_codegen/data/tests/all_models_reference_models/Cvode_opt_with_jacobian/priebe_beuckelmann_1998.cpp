        ...
        if (mNeedsRegeneration[0])
        {
            ...
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 1.0 + exp(1.1304347826086956 + 0.043478260869565216 * var_chaste_interface__cell__V);
                };
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 0.14710000000000001 - 0.25101580310038191 * exp(-0.08830693125184777 * pow((-1 + 0.15937778911130945 * var_chaste_interface__cell__V), 2)) / sqrt(M_PI);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return exp(-0.89836705491478086 * pow((-1 + 0.044722719141323794 * var_chaste_interface__cell__V), 2));
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 0.00054739999999999997 + (0.0112 + 0.068699999999999997 * exp(-1.06213655 - 0.1081 * var_chaste_interface__cell__V)) / (1.0 + exp(-2.7305064499999996 - 0.27789999999999998 * var_chaste_interface__cell__V));
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 1.0 + exp(-1.0052757950443461 + 0.16333730787449161 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 1.0 + exp(-0.51325540000000003 - 0.12620000000000001 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return exp(0.0021416822000000003 + 0.00052660000000000001 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 1.0 + exp(5.1411779999999991 + 0.078299999999999995 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return exp(0.105056 + 0.0016000000000000001 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 1.0 + exp(-0.17842998931347828 - 0.069846547135942336 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 1.0 + exp(1.0082174462705435 + 0.063211125158027806 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 1.0 + exp(6.9907280000000006e-6 - 0.1348 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 0.51490000000000002 * exp(0.67236288 - 0.13439999999999999 * var_chaste_interface__cell__V) + 5.1860000000000002e-5 * var_chaste_interface__cell__V;
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 1.0 + exp(3.9880601600000003 - 0.094299999999999995 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return exp(0.70203392000000009 - 0.0166 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 1.0 + exp(-5.9326369200000002 - 0.17319999999999999 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 5.6119999999999998e-5 * var_chaste_interface__cell__V + 0.072099999999999997 * exp(-5.9257863000000004 - 0.17299999999999999 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 1.0 + exp(-5.4573693999999993 - 0.16039999999999999 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return 0.0001215 * var_chaste_interface__cell__V + 0.076700000000000004 * exp(-5.6479010000000002e-8 - 1.6600000000000001e-9 * var_chaste_interface__cell__V);
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
...
const double var_x0 = pow(var_chaste_interface__IKs_Xs_gate__Xs, 2) * NV_Ith_S(mParameters, 14);
        ...
        const double var_x167 = exp(var_x60 - 0.34999999999999998 * NV_Ith_S(mParameters, 11));
        const double var_x168 = exp(0.079000000000000001 * var_chaste_interface__cell__V - 0.079000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x169 = exp(-0.96036036036036043 - 0.0900900900900901 * NV_Ith_S(mParameters, 11) - 0.0900900900900901 * var_chaste_interface__cell__V);
        ...
        const double var_x173 = ((var_x164) ? (-0.019852941176470591 * var_x163) : (0));
        const double var_x174 = var_x165 + var_x171;
        const double var_x175 = 0.01 * NV_Ith_S(mParameters, 10);
        const double var_x176 = 1.0 - var_x175;
        const double var_x177 = var_x176 / var_x174;
        const double var_x178 = ((var_x164) ? (0.28123999999999999 * var_x168 + 108500.0 * var_x167) : (0.693000693000693 * var_x169 / pow(var_x170, 2)));
        const double var_x179 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 11) - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x180 = 1.0 + var_x179;
        const double var_x181 = exp(0.01052 * NV_Ith_S(mParameters, 11) - 0.01052 * var_chaste_interface__cell__V);
        const double var_x182 = var_x181 / var_x180;
        const double var_x183 = exp(-3.2000000000000002 + var_x157 + 0.10000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x184 = 1.0 + var_x183;
        const double var_x185 = exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 11) - 2.5349999999999999e-7 * var_chaste_interface__cell__V);
        ...
        const double var_x190 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V - 0.311 * NV_Ith_S(mParameters, 11));
        const double var_x191 = 1.0 + var_x190;
        const double var_x192 = 1 / var_x191;
        const double var_x193 = exp(0.24399999999999999 * var_chaste_interface__cell__V - 0.24399999999999999 * NV_Ith_S(mParameters, 11));
        const double var_x194 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 11) - 0.043909999999999998 * var_chaste_interface__cell__V);
        ...
        const double var_x199 = ((var_x164) ? (var_x196 + var_x189 * var_x192 * (1.5254334000000001e-6 * var_x194 - 31022.16 * var_x193) - 0.311 * var_x189 * var_x190 * var_x195 / pow(var_x191, 2)) : (0));
        const double var_x200 = var_x187 + var_x197;
        const double var_x201 = var_x176 / var_x200;
        const double var_x202 = ((var_x164) ? (-0.001275024 * var_x182 + 0.016701360000000002 * var_x179 * var_x181 / pow(var_x180, 2)) : (-7.6049999999999996e-8 * var_x186 + 0.029999999999999999 * var_x183 * var_x185 / pow(var_x184, 2)));
        ...
        const double var_x217 = 1.0 - var_chaste_interface__Ito_r_gate__r;
        ...
        const double var_x226 = 1.0 - var_chaste_interface__Ito_t_gate__t;
        ...
        const double var_x238 = 1.0 - var_chaste_interface__IKr_Xr_gate__Xr;
        ...
        const double var_x249 = var_x45 * var_x53;
        const double var_x250 = var_x122 * NV_Ith_S(mParameters, 2);
        const double var_x251 = 0.00012153621779290228 * var_x250;
        const double var_x252 = 0.00036460865337870681 * var_x250;
        const double var_x253 = var_x251 * var_x85;
        const double var_x254 = var_x251 * (var_x90 - var_x95);
        ...
        IJth(rJacobian, 6, 0) = (0.0074264700000000001 * var_x208 * var_x209 - 0.27789999999999998 * var_x206 * var_x210 / pow(var_x207, 2)) * var_chaste_interface__ICa_f_gate__f - 0.0011224539797135063 * var_x211 * (1.0 - var_chaste_interface__ICa_f_gate__f) / pow(var_x212, 2);
        IJth(rJacobian, 7, 0) = -0.0087415599999999989 * var_x217 * var_x221 - var_x215 * (5.1860000000000002e-5 - 0.069202559999999996 * var_x216) * var_chaste_interface__Ito_r_gate__r + 0.049658379999999995 * var_x217 * var_x218 * var_x220 / pow(var_x219, 2) - 0.1348 * var_x213 * var_x222 * var_chaste_interface__Ito_r_gate__r / pow(var_x214, 2);
        IJth(rJacobian, 8, 0) = var_x225 * var_x226 * (5.6119999999999998e-5 - 0.012473299999999998 * var_x227) - var_x230 * (0.0001215 - 1.2732200000000002e-10 * var_x231) * var_chaste_interface__Ito_t_gate__t + 0.17319999999999999 * var_x223 * var_x226 * var_x232 / pow(var_x224, 2) - 0.16039999999999999 * var_x228 * var_x233 * var_chaste_interface__Ito_t_gate__t / pow(var_x229, 2);
        IJth(rJacobian, 9, 0) = 0.00021044764652059425 * var_x234 * (1.0 - var_chaste_interface__IKs_Xs_gate__Xs) / pow(var_x235, 2) + 0.00037104930467762328 * var_x236 * var_chaste_interface__IKs_Xs_gate__Xs / pow(var_x237, 2);
        IJth(rJacobian, 10, 0) = 2.633e-6 * var_x238 * var_x242 - 2.5600000000000002e-5 * var_x246 * var_chaste_interface__IKr_Xr_gate__Xr + 0.0012527999999999999 * var_x243 * var_x245 * var_chaste_interface__IKr_Xr_gate__Xr / pow(var_x244, 2) + 0.00063100000000000005 * var_x238 * var_x239 * var_x241 / pow(var_x240, 2);
        IJth(rJacobian, 14, 0) = ((var_x248) ? (-var_x123 * (var_x121 + var_x73)) : (0));
        IJth(rJacobian, 18, 0) = -var_x251 * (0.001 + var_x31 + 3.0 * var_x70 + 3.9000000000000004 * var_x249 + 0.19500000000000001 * var_x72);
        IJth(rJacobian, 19, 0) = -var_x251 * (var_x0 + var_x10 + var_x28 + var_x59 + var_x7 - var_x39 - var_x41 - 2.6000000000000001 * var_x249);
        ...
        IJth(rJacobian, 14, 1) = ((var_x248) ? (-var_x123 * (var_x136 + var_x82)) : (0));
        IJth(rJacobian, 18, 1) = var_x252 * var_x81;
        ...
        IJth(rJacobian, 18, 3) = -var_x253 * var_x30;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x88 * var_x89);
        IJth(rJacobian, 4, 4) = -var_x188 - var_x198;
        IJth(rJacobian, 18, 4) = -var_x253 * var_x89;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x36 * var_x78);
        IJth(rJacobian, 1, 5) = -var_x120 * var_x142;
        IJth(rJacobian, 5, 5) = -0.14710000000000001 + var_x204 - var_x205;
        IJth(rJacobian, 14, 5) = ((var_x248) ? (-var_x142) : (0));
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x34 * var_x79);
        IJth(rJacobian, 1, 6) = -var_x120 * var_x143;
        IJth(rJacobian, 6, 6) = -0.00054739999999999997 - 0.0068719999999999996 / var_x212 - var_x208 * var_x210;
        IJth(rJacobian, 14, 6) = ((var_x248) ? (-var_x143) : (0));
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x96 * var_chaste_interface__Ito_t_gate__t);
        IJth(rJacobian, 7, 7) = -0.52659999999999996 * var_x221 - var_x215 * var_x222;
        IJth(rJacobian, 19, 7) = -var_x254 * var_x8;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x96 * var_chaste_interface__Ito_r_gate__r);
        IJth(rJacobian, 8, 8) = -var_x225 * var_x232 - var_x230 * var_x233;
        IJth(rJacobian, 19, 8) = -var_x254 * NV_Ith_S(mParameters, 16) * var_chaste_interface__Ito_r_gate__r;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-2.0 * var_x99);
        IJth(rJacobian, 9, 9) = -0.0058700000000000002 / var_x237 - 0.0030130000000000001 / var_x235;
        IJth(rJacobian, 19, 9) = -0.00024307243558580456 * var_x250 * var_x99;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x100 * var_x6);
        IJth(rJacobian, 10, 10) = -0.016 * var_x246 - 0.0050000000000000001 * var_x242;
        IJth(rJacobian, 19, 10) = -var_x100 * var_x251 * var_x5;
        ...
        IJth(rJacobian, 12, 12) = ((var_x247) ? (-100.5) : (-0.5));
        IJth(rJacobian, 20, 12) = -var_x145 * var_x258;
        IJth(rJacobian, 13, 13) = ((var_x247) ? (-100.5) : (-0.01));
        IJth(rJacobian, 1, 14) = var_x146 * var_x147;
        IJth(rJacobian, 14, 14) = (((var_x248) || (var_chaste_interface__Irel__APtrack2 > 0.01)) ? (0) : (-0.5));
        IJth(rJacobian, 20, 14) = -var_x147 * var_x258;
        ...
        IJth(rJacobian, 14, 18) = ((var_x248) ? (0.00018230432668935341 * var_x148) : (0));
        IJth(rJacobian, 18, 18) = -var_x251 * (var_x102 + 9.0 * var_x107 + 0.18499324311985019 * var_x106 + var_x101 * var_x31);
        IJth(rJacobian, 19, 18) = -var_x251 * (var_x104 + var_x109 - 0.1233288287465668 * var_x106);
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x116 - var_x111 - var_x112 - var_x113 - var_x114 - var_x115);
        IJth(rJacobian, 19, 19) = -var_x251 * (var_x111 + var_x112 + var_x113 + var_x114 + var_x115 - var_x116);
        IJth(rJacobian, 1, 20) = var_x146 * var_x149;
        IJth(rJacobian, 20, 20) = var_x258 * (-0.0055555555555555558 - var_x149) + 0.25 * (-var_x138 + 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_JSR) / (pow(var_x255, 3) * pow((0.125 + var_x256), 2));
        IJth(rJacobian, 21, 20) = 0.00048309178743961351;
        IJth(rJacobian, 1, 21) = 2.1105882352941172e-5 * var_x120;
        IJth(rJacobian, 20, 21) = 0.0055555555555555558 * var_x257;
