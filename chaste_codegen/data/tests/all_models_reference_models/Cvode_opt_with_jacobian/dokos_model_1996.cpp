...
const double var_x0 = pow(var_chaste_interface__ion_concentrations__Nai, 2);
        ...
        const double var_x297 = 0.77732014867771382 + 0.010364268649036185 * var_chaste_interface__membrane__E - 0.1384342960515699 * var_x131;
        const double var_x298 = var_x133 * var_x297;
        const double var_x299 = 0.066072212637605682 + 0.00088096283516807576 * var_chaste_interface__membrane__E - 0.011766915164383442 * var_x131;
        const double var_x300 = 0.39999999999999997 * var_chaste_interface__ion_concentrations__Carel;
        const double var_x301 = 0.049748489515373688 * var_x74;
        const double var_x302 = 2.131673027244247e-5 * var_x90;
        const double var_x303 = 0.0028107896576186134 * var_x103;
        ...
        const double var_x315 = 0.014053948288093067 * var_x182;
        const double var_x316 = 0.5537371842062796 * var_x80;
        const double var_x317 = 0.5537371842062796 * var_x98;
        const double var_x318 = 0.0018738597717457423 * var_x103;
        const double var_x319 = 0.0041457074596144743 * var_x110;
        const double var_x320 = 0.0018738597717457423 * var_x182;
        ...
        IJth(rJacobian, 1, 0) = -0.00017619256703361517 * var_x76 - 0.0020728537298072371 * var_x100 + var_x220 * var_x66 + var_x221 * var_x88;
        ...
        IJth(rJacobian, 16, 0) = -0.0001551899604262497 * var_x102 - 1.0863297229837478e-8 * var_x78 - 0.0041457074596144743 * var_x96 + var_x108 * var_x318;
        IJth(rJacobian, 17, 0) = 5.4316486149187388e-8 * var_x78 + 0.020728537298072371 * var_x96 + 0.00077594980213124853 * var_x102 - var_x108 * var_x324;
        ...
        IJth(rJacobian, 11, 1) = var_x125 * var_x295 + var_x125 * var_x296 - var_x124 * var_x293 - var_x129 * var_x294;
        IJth(rJacobian, 12, 1) = 0.0062777855817019177 * var_x225 - 0.0062777855817019177 * var_x224;
        IJth(rJacobian, 13, 1) = var_x231 * var_x300 - var_x229 * var_x300;
        IJth(rJacobian, 14, 1) = -var_x124 * var_x301 - var_x129 * var_x302;
        IJth(rJacobian, 15, 1) = var_x124 * var_x310 + var_x129 * var_x311;
        ...
        IJth(rJacobian, 11, 2) = var_x297 * var_x99;
        ...
        IJth(rJacobian, 11, 3) = var_x298 * var_chaste_interface__L_type_calcium_current_f2_gate__fL2;
        ...
        IJth(rJacobian, 11, 4) = var_x298 * var_chaste_interface__L_type_calcium_current_f_gate__fL;
        ...
        IJth(rJacobian, 11, 5) = var_x299 * var_chaste_interface__T_type_calcium_current_f_gate__fT;
        ...
        IJth(rJacobian, 8, 8) = -0.032399999999999998 * var_x268 - 0.70899999999999996 / (1.0 + 4.2000000000000002 * var_x269);
        ...
        IJth(rJacobian, 9, 9) = -0.00021100000000000001 * var_x271 - 0.017000000000000001 * var_x270;
        IJth(rJacobian, 14, 9) = -var_x142 * var_x304;
        IJth(rJacobian, 15, 9) = var_x142 * var_x313;
        ...
        IJth(rJacobian, 11, 11) = -0.01 - var_x160 * var_x293 - var_x164 * var_x294 - var_x165 * var_x295 - var_x165 * var_x296;
        IJth(rJacobian, 14, 11) = -var_x160 * var_x301 - var_x164 * var_x302;
        IJth(rJacobian, 15, 11) = var_x160 * var_x310 + var_x164 * var_x311;
        ...
        IJth(rJacobian, 11, 14) = -var_x178 * var_x293 - var_x180 * var_x294;
        IJth(rJacobian, 14, 14) = -var_x305 + 1.7567435360116334e-6 * var_x186 - 2.6579384841901423e-5 * var_x136 - var_x136 * var_x306 - var_x136 * var_x308 - var_x178 * var_x301 - var_x180 * var_x302 - var_x307 * var_chaste_interface__ion_concentrations__Ko;
        IJth(rJacobian, 15, 14) = var_x314 + 0.0001328969242095071 * var_x136 - 8.7837176800581675e-6 * var_x186 + var_x136 * var_x316 + var_x136 * var_x317 + var_x178 * var_x310 + var_x180 * var_x311 + var_x315 * var_chaste_interface__ion_concentrations__Ko;
        IJth(rJacobian, 16, 14) = -1.171162357341089e-6 * var_x186 + var_x320 * var_chaste_interface__ion_concentrations__Ko;
        IJth(rJacobian, 17, 14) = 5.8558117867054447e-6 * var_x186 - var_x326 * var_chaste_interface__ion_concentrations__Ko;
        ...
        IJth(rJacobian, 11, 15) = -var_x201 * var_x293 - var_x202 * var_x294;
        IJth(rJacobian, 14, 15) = 2.6579384841901423e-5 * var_x187 + var_x187 * var_x306 + var_x187 * var_x308 + var_x305 * var_x77 - var_x201 * var_x301 - var_x202 * var_x302;
        IJth(rJacobian, 15, 15) = -0.01 - 0.0001328969242095071 * var_x187 + var_x201 * var_x310 + var_x202 * var_x311 - var_x187 * var_x316 - var_x187 * var_x317 - var_x314 * var_x77;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x113 * (var_x204 + var_x205 + 26.713760659695652 * var_x206));
        IJth(rJacobian, 16, 16) = -var_x321 - var_x322 - 0.11074743684125593 * var_x206;
        IJth(rJacobian, 17, 16) = var_x327 + var_x328 + 0.5537371842062796 * var_x206;
        ...
        IJth(rJacobian, 14, 17) = 1.4895857201494236e-6 * var_x309 - 8.5608859041038889e-5 * var_x210 - 0.0075866446510944882 * var_x215 + var_x216 * var_x303 - var_x307 * var_chaste_interface__ion_concentrations__Nai;
        IJth(rJacobian, 15, 17) = 0.00042804429520519442 * var_x210 + 0.037933223255472437 * var_x215 - 7.4479286007471168e-6 * var_x309 + var_x315 * var_chaste_interface__ion_concentrations__Nai - var_x216 * var_x312;
        IJth(rJacobian, 16, 17) = 0.11074743684125593 * var_x212 + 1.4895857201494236e-6 * var_x323 - 1.1898180409093538e-7 * var_x207 - 0.0024459674011725395 * var_x209 - 0.0075866446510944882 * var_x213 + var_x320 * var_chaste_interface__ion_concentrations__Nai + var_x321 * var_x77 + var_x322 * var_x77 - var_x216 * var_x318;
        IJth(rJacobian, 17, 17) = -0.01 + 0.037933223255472437 * var_x213 + 5.9490902045467693e-7 * var_x207 + 0.012229837005862698 * var_x209 - 7.4479286007471168e-6 * var_x323 - 0.5537371842062796 * var_x212 + var_x216 * var_x324 - var_x326 * var_chaste_interface__ion_concentrations__Nai - var_x327 * var_x77 - var_x328 * var_x77;
    }
