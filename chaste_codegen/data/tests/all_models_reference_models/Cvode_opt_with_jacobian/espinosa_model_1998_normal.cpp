...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return ((fabs(4.0 + var_chaste_interface__membrane__V) < 2.9999999995311555e-7) ? (-8.9999999985934664e-6 / (1.0 - exp(9.9999999984371854e-8)) + 1666666.6669271358 * (4.0000003 + var_chaste_interface__membrane__V) * (8.9999999985934664e-6 / (1.0 - exp(9.9999999984371854e-8)) + 8.9999999985934664e-6 / (1.0 - exp(-9.9999999984371854e-8)))) : (30.0 * (4.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-1.3333333333333333 - 0.33333333333333331 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return ((fabs(4.0 + var_chaste_interface__membrane__V) < 7.4999999988278887e-7) ? (8.9999999985934664e-6 / (-1.0 + exp(9.9999999984371854e-8)) - 666666.66677085438 * (3.9999992500000001 + var_chaste_interface__membrane__V) * (-8.9999999985934664e-6 / (-1.0 + exp(9.9999999984371854e-8)) - 8.9999999985934664e-6 / (-1.0 + exp(-9.9999999984371854e-8)))) : (12.0 * (4.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(0.53333333333333333 + 0.13333333333333333 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1.0 + exp(-6.1818181818181817 - 0.18181818181818182 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return ((fabs(-18.0 + var_chaste_interface__membrane__V) < 4.9999999873762135e-7) ? (-7.4999999810643203e-7 / (1.0 - exp(9.9999999747524276e-8)) + 1000000.0025247573 * (-17.999999500000001 + var_chaste_interface__membrane__V) * (7.4999999810643203e-7 / (1.0 - exp(9.9999999747524276e-8)) + 7.4999999810643203e-7 / (1.0 - exp(-9.9999999747524276e-8)))) : (1.5 * (-18.0 + var_chaste_interface__membrane__V) / (1.0 - exp(3.6000000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.33300000000000002 / (1.0 + exp(2.0 - 0.10000000000000001 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-0.067226890756302518 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1.0 + exp(-1.4285714285714286 - 0.14285714285714285 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
const double var_x0 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * NV_Ith_S(mParameters, 12);
        ...
        const double var_x58 = _lt_0_row[0];
        ...
        const double var_x206 = 1 / (1.0 - exp(9.9999999747524276e-8));
        const double var_x207 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x208 = exp(9.9999999984371854e-8);
        const double var_x209 = 1 / (-1.0 + var_x208);
        const double var_x210 = exp(-9.9999999984371854e-8);
        const double var_x211 = 1 / (-1.0 + var_x210);
        const double var_x212 = (-0.00026699999999999998 * var_x209 - 0.00026699999999999998 * var_x211) * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x213 = -18.0 + var_chaste_interface__membrane__V;
        const double var_x214 = fabs(var_x213);
        const double var_x215 = var_x214 < 4.9999999873762135e-7;
        const double var_x216 = 1.0 - var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x217 = exp(3.6000000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x218 = 1.0 - var_x217;
        const double var_x219 = 0.0015 / var_x218;
        const double var_x220 = var_x216 * var_x219 - 0.00029999999999999997 * var_x213 * var_x216 * var_x217 / pow(var_x218, 2);
        const double var_x221 = var_x214 < 1.4999999997655777e-6;
        const double var_x222 = exp(-1.2 + 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x223 = -1.0 + var_x222;
        const double var_x224 = 0.00053399999999999997 / var_x223;
        const double var_x225 = -8.0099999987481844e-10 * var_x209 + 333.33333338542718 * (-18.0000015 + var_chaste_interface__membrane__V) * (-8.0099999987481852e-7 * var_x209 - 8.0099999987481852e-7 * var_x211);
        const double var_x226 = -var_x213 * var_x219;
        const double var_x227 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x228 = 1 / (1.0 - exp(1.0000000045806701e-7));
        const double var_x229 = _lt_0_row[12];
        const double var_x230 = 0.44800000000000001 * var_x229 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x231 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x232 = fabs(var_x231) < 1.0000000010279564e-6;
        const double var_x233 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x234 = -0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x235 = exp(-4.1000000000000005 + var_x234);
        const double var_x236 = 1.0 - var_x235;
        const double var_x237 = 0.20000000000000001 / var_x236;
        const double var_x238 = -8.0 * var_x229;
        const double var_x239 = exp(-7.5 + var_x234 + 0.10000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x240 = 1 / (1.0 + 320.0 * var_x239);
        const double var_x241 = 2.0 * var_x240;
        const double var_x242 = exp(-9.375 + 0.125 * NV_Ith_S(mParameters, 14) - 0.125 * var_chaste_interface__membrane__V);
        const double var_x243 = 0.02 * var_x242;
        const double var_x244 = 2.5 * var_x242;
        const double var_x245 = 20.0 * var_x242;
        const double var_x246 = 0.01 * NV_Ith_S(mParameters, 13);
        const double var_x247 = 1.0 - var_x246;
        const double var_x248 = var_x247 / (var_x245 + 2000.0 * var_x240);
        const double var_x249 = var_x239 / pow((0.0031250000000000002 + var_x239), 2);
        const double var_x250 = 1 / (1.0 - var_x208);
        const double var_x251 = 1 / (1.0 - var_x210);
        const double var_x252 = (-0.059999999999999998 * var_x209 - 0.059999999999999998 * var_x211) * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x253 = 4.0 + var_chaste_interface__membrane__V;
        const double var_x254 = fabs(var_x253);
        const double var_x255 = var_x254 < 2.9999999995311555e-7;
        const double var_x256 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x257 = exp(-1.3333333333333333 - 0.33333333333333331 * var_chaste_interface__membrane__V);
        const double var_x258 = 1.0 - var_x257;
        const double var_x259 = 0.29999999999999999 / var_x258;
        const double var_x260 = var_x256 * var_x259 - 0.10000000000000001 * var_x253 * var_x256 * var_x257 / pow(var_x258, 2);
        const double var_x261 = var_x254 < 7.4999999988278887e-7;
        const double var_x262 = exp(0.53333333333333333 + 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x263 = -1.0 + var_x262;
        const double var_x264 = 0.12 / var_x263;
        const double var_x265 = -8.9999999985934659e-8 * var_x209 + 6666.6666677085432 * (3.9999992500000001 + var_chaste_interface__membrane__V) * (-8.9999999985934664e-6 * var_x209 - 8.9999999985934664e-6 * var_x211);
        const double var_x266 = -var_x253 * var_x259;
        const double var_x267 = 1 / (-1.0 + exp(9.999999987671386e-8));
        const double var_x268 = 1 / (-1.0 + exp(-9.999999987671386e-8));
        const double var_x269 = 0.18181818181818182 * var_chaste_interface__membrane__V;
        const double var_x270 = exp(-6.1818181818181817 - var_x269);
        const double var_x271 = 1.0 + var_x270;
        const double var_x272 = -0.0043636363636363638 * var_x270 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x271, 2);
        const double var_x273 = 24.0 + var_chaste_interface__membrane__V;
        const double var_x274 = fabs(var_x273) < 5.4999999932192623e-7;
        const double var_x275 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x276 = exp(4.3636363636363633 + var_x269);
        const double var_x277 = -1.0 + var_x276;
        const double var_x278 = 0.012500000000000001 / var_x277;
        const double var_x279 = -0.024 / var_x271;
        const double var_x280 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x281 = _lt_0_row[16];
        const double var_x282 = exp(-1.4285714285714286 - 0.14285714285714285 * var_chaste_interface__membrane__V);
        const double var_x283 = 1.0 + var_x282;
        const double var_x284 = exp(2.0 - 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x285 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x286 = NV_Ith_S(mParameters, 2) + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x287 = 1 / var_x286;
        const double var_x288 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x286, 2);
        const double var_x289 = NV_Ith_S(mParameters, 3) + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x290 = 1 / var_x289;
        const double var_x291 = 2 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x292 = ((var_chaste_interface__membrane__V < -50.0) ? (5.0) : (1.0));
        const double var_x293 = var_x287 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x294 = 1.0 - var_x293;
        const double var_x295 = var_x290 * var_x294;
        const double var_x296 = var_x293 + var_x295 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x297 = 0.5 * var_x292 * var_x296;
        const double var_x298 = var_x297 * (-2 * var_x288 + 2 * var_x287 + var_x290 * var_x291 * (var_x288 - var_x287));
        const double var_x299 = var_x298 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x300 = 0.5 * pow(var_x296, 2);
        const double var_x301 = -var_x292 * var_x300;
        const double var_x302 = var_x297 * (2 * var_x295 - var_x291 * var_x294 / pow(var_x289, 2));
        const double var_x303 = var_x302 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x304 = 0.00063182746016849224 * NV_Ith_S(mParameters, 6);
        const double var_x305 = 0.0013268376663538336 * var_x160;
        const double var_x306 = 0.11609829580596043 + 0.65789034290044246 * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x307 = 0.001 * var_x3;
        const double var_x308 = 0.001 * NV_Ith_S(mParameters, 6);
        const double var_x309 = 0.00077398863870640285 * NV_Ith_S(mParameters, 6);
        const double var_x310 = 0.001083584094188964 * var_x160;
        const double var_x311 = 5.5284902764743067e-6 * var_x32;
        const double var_x312 = 0.020676147247726494 * var_x12;
        const double var_x313 = 0.026713760659695648 * var_x3 * var_x306;
        const double var_x314 = 0.0012925610266396929 * var_x41;
        const double var_x315 = 0.00088455844423588909 * var_x160;
        const double var_x316 = 0.016878487549164489 * var_x12;
        const double var_x317 = 4.5130532869178019e-6 * var_x32;
        const double var_x318 = 0.016878487549164489 * var_x4;
        const double var_x319 = 0.001055151858481382 * var_x41;
        const double var_x320 = 0.002 * NV_Ith_S(mParameters, 1);
        const double var_x321 = -var_x205;
        ...
        IJth(rJacobian, 2, 0) = ((var_x215) ? (var_x212 + (0.001 - 0.001 * var_chaste_interface__time_dependent_potassium_current_x_gate__x) * (0.75 * var_x206 + 0.75 * var_x207)) : ((var_x221) ? (var_x212 + var_x220) : (var_x220 - var_x224 * var_chaste_interface__time_dependent_potassium_current_x_gate__x + 3.5599999999999998e-5 * var_x213 * var_x222 * var_chaste_interface__time_dependent_potassium_current_x_gate__x / pow(var_x223, 2))));
        IJth(rJacobian, 3, 0) = ((var_x232) ? (var_x230 + (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * (99.999999644728632 * var_x227 + 100.00000035527137 * var_x228)) : (var_x230 + var_x233 * var_x237 - 0.02 * var_x231 * var_x233 * var_x235 / pow(var_x236, 2)));
        IJth(rJacobian, 4, 0) = (var_x241 + var_x243) * (-var_x244 * var_x248 + 5.0000000000000004e-6 * var_x242 * var_x247 * (var_x244 - 0.625 * var_x249) / pow((var_x240 + 0.01 * var_x242), 2)) + (0.00062500000000000001 * var_x249 - 0.0025000000000000001 * var_x242) * (var_x246 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x245 * var_x248);
        IJth(rJacobian, 5, 0) = ((var_x255) ? (var_x252 + (0.01 - 0.01 * var_chaste_interface__L_type_Ca_channel_d_gate__d) * (15.0 * var_x250 + 15.0 * var_x251)) : ((var_x261) ? (var_x252 + var_x260) : (var_x260 - var_x264 * var_chaste_interface__L_type_Ca_channel_d_gate__d + 0.016 * var_x253 * var_x262 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x263, 2))));
        IJth(rJacobian, 6, 0) = ((var_x274) ? (var_x272 + (0.002 - 0.002 * var_chaste_interface__L_type_Ca_channel_f_gate__f) * (3.125 * var_x267 + 3.125 * var_x268)) : (var_x272 + var_x275 * var_x278 - 0.0022727272727272726 * var_x273 * var_x275 * var_x276 / pow(var_x277, 2)));
        IJth(rJacobian, 9, 0) = -0.067226890756302518 * var_x281 * (8.5800000000000009e-6 - 8.5800000000000009e-6 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0012257142857142857 * var_x282 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x283, 2);
        IJth(rJacobian, 10, 0) = 0.033300000000000003 * var_x284 / pow((1.0 + var_x284), 2);
        ...
        IJth(rJacobian, 14, 0) = (3.0959545548256117e-6 + 0.00077398863870640285 * var_x13 + 0.00077398863870640285 * var_x83 + 2.069529014241491e-7 * var_x33 - 4.8385588352966063e-5 * var_x42 + var_x306 * var_x307) * NV_Ith_S(mParameters, 6);
        ...
        IJth(rJacobian, 11, 1) = -var_x299 + var_x285 * var_x298;
        IJth(rJacobian, 12, 1) = var_x299;
        ...
        IJth(rJacobian, 2, 2) = ((var_x215) ? (var_x225 + 7.4999999810643199e-10 * var_x206 - 1000.0000025247573 * (-17.999999500000001 + var_chaste_interface__membrane__V) * (7.4999999810643203e-7 * var_x206 + 7.4999999810643203e-7 * var_x207)) : ((var_x221) ? (var_x225 + var_x226) : (var_x226 - var_x213 * var_x224)));
        IJth(rJacobian, 14, 2) = var_x308 * (0.0055284902764743066 * var_chaste_interface__intracellular_potassium_concentration__K_i - 0.0055284902764743066 * var_x31) * NV_Ith_S(mParameters, 11);
        IJth(rJacobian, 15, 2) = -var_x110 * var_x304;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0030000000000000001 * var_x114 * var_x94);
        IJth(rJacobian, 3, 3) = ((var_x232) ? (var_x238 + 2.0000000091613402e-7 * var_x228 - 499.99999948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (0.00019999999949504854 * var_x227 + 0.00020000000091613401 * var_x228)) : (var_x238 - var_x231 * var_x237));
        ...
        IJth(rJacobian, 4, 4) = -var_x241 - var_x243;
        IJth(rJacobian, 13, 4) = -var_x115 * var_x304;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 * (var_x121 + var_x124 + var_x127));
        IJth(rJacobian, 5, 5) = ((var_x255) ? (var_x265 + 8.9999999985934659e-8 * var_x250 - 16666.666669271359 * (4.0000003 + var_chaste_interface__membrane__V) * (8.9999999985934664e-6 * var_x250 + 8.9999999985934664e-6 * var_x251)) : ((var_x261) ? (var_x265 + var_x266) : (var_x266 - var_x253 * var_x264)));
        IJth(rJacobian, 13, 5) = -var_x121 * var_x304;
        IJth(rJacobian, 14, 5) = var_x124 * var_x309;
        IJth(rJacobian, 15, 5) = -var_x124 * var_x304;
        ...
        IJth(rJacobian, 6, 6) = ((var_x274) ? (var_x279 - 6.8749999915240775e-9 * var_x267 + 1818.1818204233844 * (23.999999450000001 + var_chaste_interface__membrane__V) * (-3.4374999957620389e-6 * var_x267 - 3.4374999957620389e-6 * var_x268)) : (var_x279 - var_x273 * var_x278));
        IJth(rJacobian, 13, 6) = -var_x133 * var_x304;
        IJth(rJacobian, 14, 6) = var_x136 * var_x309;
        IJth(rJacobian, 15, 6) = -var_x136 * var_x304;
        ...
        IJth(rJacobian, 13, 8) = -var_x146 * var_x304;
        IJth(rJacobian, 14, 8) = var_x149 * var_x309;
        IJth(rJacobian, 15, 8) = -var_x149 * var_x304;
        IJth(rJacobian, 16, 8) = -0.003159137300842461 * var_x152;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x153 * var_x95);
        IJth(rJacobian, 9, 9) = -8.5800000000000009e-6 * var_x281 - 0.0085800000000000008 / var_x283;
        IJth(rJacobian, 14, 9) = var_x307 * (0.65789034290044246 * var_chaste_interface__membrane__V - 17.574725160567521 * var_x7) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 15, 9) = -var_x153 * var_x304;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x155 * var_x95);
        IJth(rJacobian, 10, 10) = -0.33300000000000002;
        IJth(rJacobian, 14, 10) = var_x154 * var_x306 * var_x308;
        IJth(rJacobian, 15, 10) = -var_x155 * var_x304;
        ...
        IJth(rJacobian, 11, 11) = var_x301 + var_x292 * (-0.059999999999999998 - var_x300);
        IJth(rJacobian, 12, 11) = var_x292 * (0.059999999999999998 + var_x300);
        IJth(rJacobian, 18, 11) = (var_x203 * var_x320 - var_x201 * var_x320) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 11, 12) = var_x301;
        IJth(rJacobian, 12, 12) = -0.001 * var_x292;
        ...
        IJth(rJacobian, 13, 13) = (8.2927354147114598e-7 * var_x164 + 2.8403803471874569e-5 * var_x171 - 0.016878487549164489 * var_x162 - 0.00063182746016849224 * var_x175 - 0.0056807606943749134 * var_x167 - 1.6878487549164488e-6 * var_x156 - var_x305 * var_chaste_interface__extracellular_potassium_concentration__K_o) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 14, 13) = (6.7724005886810246e-7 * var_x164 - var_x310 * var_chaste_interface__extracellular_potassium_concentration__K_o) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 15, 13) = (-5.5284902764743069e-7 * var_x164 + var_x315 * var_chaste_interface__extracellular_potassium_concentration__K_o) * NV_Ith_S(mParameters, 6);
        ...
        IJth(rJacobian, 13, 14) = (0.0020254185058997385 * var_x182 + 0.0013268376663538336 * var_x180 - var_x305 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 14, 14) = (-0.00069999999999999999 + var_x314 - var_x312 + 0.00077398863870640285 * var_x179 + 0.00077398863870640285 * var_x188 + 0.001083584094188964 * var_x180 - 8.2704588990905987e-5 * var_x176 - 7.7398863870640281e-6 * var_x184 - var_x176 * var_x313 - var_x30 * var_x311 - var_x310 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 15, 14) = (var_x316 - var_x319 + 6.7513950196657958e-5 * var_x176 + 6.3182746016849225e-6 * var_x184 - 0.00088455844423588909 * var_x180 - 0.00063182746016849224 * var_x179 - 0.00063182746016849224 * var_x188 + var_x176 * var_x318 + var_x30 * var_x317 + var_x315 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * NV_Ith_S(mParameters, 6);
        ...
        IJth(rJacobian, 14, 15) = (var_x311 + 8.2704588990905987e-5 * var_x5 + 0.00077398863870640285 * var_x190 + var_x312 * var_x6 + var_x313 * var_x5 - var_x314 * var_x6) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 15, 15) = (-var_x317 - 6.7513950196657958e-5 * var_x5 - 0.00063182746016849224 * var_x190 + var_x319 * var_x6 - var_x316 * var_x6 - var_x318 * var_x5) * NV_Ith_S(mParameters, 6);
        ...
        IJth(rJacobian, 8, 16) = -0.02 / var_x280 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x280, 2);
        IJth(rJacobian, 11, 16) = -var_x303 + var_x285 * var_x302;
        IJth(rJacobian, 12, 16) = var_x303;
        ...
        IJth(rJacobian, 19, 19) = -0.050000000000000003 + var_x321;
        IJth(rJacobian, 1, 20) = 0.20000000000000001 + var_x205;
        IJth(rJacobian, 20, 20) = -0.20000000000000001 + var_x321;
    }
