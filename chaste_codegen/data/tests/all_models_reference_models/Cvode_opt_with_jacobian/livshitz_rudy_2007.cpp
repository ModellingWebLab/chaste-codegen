...
const double var_x0 = exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V);
        ...
        const double var_x219 = 0.005608974358974359 * var_x205 * var_x217;
        const double var_x220 = 0.019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__cell__V), 2));
        const double var_x221 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x222 = 1.0 + var_x221;
        const double var_x223 = exp(4.0 + 0.125 * var_chaste_interface__cell__V);
        const double var_x224 = 1.0 + var_x223;
        const double var_x225 = exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__cell__V);
        ...
        const double var_x249 = var_x243 + var_x247 - 8.9997000000000013e-6 * var_x240 * var_x248 / pow(var_x241, 2) - 1.0641199999999999e-5 * var_x244 * var_x248 / pow(var_x245, 2);
        const double var_x250 = var_x243 * var_x248;
        const double var_x251 = var_x247 * var_x248;
        const double var_x252 = var_x237 * (var_x250 + var_x251) / pow(var_x238, 2);
        const double var_x253 = exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__cell__V);
        ...
        const double var_x264 = exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__cell__V);
        const double var_x265 = 1.0 + var_x264;
        const double var_x266 = var_x259 / pow(var_x260, 2);
        ...
        const double var_x273 = 0.21052631578947367 + var_x272;
        const double var_x274 = pow(var_x271, 9.0);
        const double var_x275 = 1.0 + var_x274;
        const double var_x276 = 1 / var_x275;
        const double var_x277 = var_x276 * var_x81;
        const double var_x278 = 4.6323915649710559 * var_x87;
        const double var_x279 = var_x277 * var_x278;
        const double var_x280 = var_x277 * var_chaste_interface__cell__V;
        const double var_x281 = 0.34683534197756777 * var_x280;
        const double var_x282 = var_x273 * var_x276 * var_x278;
        const double var_x283 = (-0.078875171467764058 + 0.0085733882030178329 * var_chaste_interface__Ca__Ca_JSR_T) / var_x269;
        const double var_x284 = (-0.5 - 5.4000000000000004 * var_x283) / pow((-1 + var_x268 + var_x269), 2);
        const double var_x285 = 4.6140557161776547e-8 * var_x70;
        const double var_x286 = 1.4999377389423053e-7 * var_x93;
        ...
        const double var_x290 = 5.6160497718581238e-5 * var_x60;
        const double var_x291 = 4.129448361660385e-5 * var_x76;
        const double var_x292 = 4.288710868383184e-8 * var_x95;
        ...
        const double var_x296 = 0.00023999003823076885 * var_x87;
        const double var_x297 = 1.796847822848032e-5 * var_x100;
        ...
        IJth(rJacobian, 4, 0) = var_x214 * var_x216 + var_x218 * (0.16025641025641024 * var_x205 * var_x212 / pow(var_x208, 2) + 41.666666666666664 * var_x209 * var_x210 / pow(var_x211, 2)) - var_x214 * var_x219 - var_x213 * var_x215 * var_x219 / pow(var_x206, 2);
        IJth(rJacobian, 5, 0) = (0.02 + var_x220) * (0.029999999999999999 * var_x221 / pow(var_x222, 2) - 0.125 * var_x223 / pow(var_x224, 2)) + var_x220 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__cell__V) * (-var_chaste_interface__ICaL__f + 1 / var_x224 + 0.59999999999999998 / var_x222);
        IJth(rJacobian, 6, 0) = (-var_chaste_interface__IKr__xr + 1 / var_x226) * (var_x229 + var_x232 - 0.00016973999999999998 * var_x230 * var_x233 / pow(var_x231, 2) - 8.8449999999999995e-5 * var_x227 * var_x234 / pow(var_x228, 2)) + 0.23529411764705882 * var_x225 * (var_x235 + var_x236) / pow(var_x226, 2);
        IJth(rJacobian, 7, 0) = 0.059880239520958084 * var_x252 + var_x249 * (-var_chaste_interface__IKs__xs1 + var_x239);
        IJth(rJacobian, 8, 0) = 0.014970059880239521 * var_x252 + var_x249 * (0.25 * var_x239 - 0.25 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 9, 0) = 0.092592592592592587 * var_x253 * var_x258 / pow(var_x254, 2) + 0.036429872495446269 * var_x255 * (-var_chaste_interface__ICaT__b + 1 / var_x254) / (pow(var_x256, 2) * pow((0.60655737704918045 + var_x257), 2));
        IJth(rJacobian, 10, 0) = 0.0069444444444444441 * (-var_chaste_interface__ICaT__g + 1 / var_x265) * (0.875 - 0.875 * var_x261 - 5000.0 * var_x266 + 416.66666666666669 * var_x262 * var_x266) / pow((var_x261 + 0.083333333333333329 * var_x263), 2) - 0.17857142857142858 * var_x264 * var_x267 / pow(var_x265, 2);
        IJth(rJacobian, 11, 0) = var_x273 * (-var_x279 + var_x102 * var_x281 - var_x106 * var_x281);
        IJth(rJacobian, 12, 0) = -2.4608297152947492e-7 + 5.615149446400099e-9 * var_x103 + 1.4682156444593685e-9 * var_x50 - 0.00031144876084199171 * var_x57 - 4.2113620848000749e-9 * var_x105 - 3.1091625412080743e-9 * var_x73 - 6.1520742882368733e-5 * var_x66 - var_x285 * var_x72 - var_x286 * var_x91;
        IJth(rJacobian, 13, 0) = var_x289 + 1.6055168046743987e-9 * var_x99 + 2.5071650767223771e-6 * var_x78 + 1.0246623209999443e-5 * var_x69 + 0.00020763250722799446 * var_x57 - 4.296278075471465e-5 * var_x18 - 3.3959450071067536e-7 * var_x2 - 1.2041376035057991e-9 * var_x107 - 5.6788378045263436e-8 * var_x63 - var_x290 * var_chaste_interface__IKr__xr - var_x291 * var_x75 - var_x292 * var_x91;
        IJth(rJacobian, 14, 0) = -9.277328026661204e-8 + 1.0363875137360248e-9 * var_x73 - 4.8940521481978945e-10 * var_x50 + var_x102 * var_x297 + var_x295 * var_x72 - var_x106 * var_x297 - var_x294 * var_chaste_interface__ICaT__g - var_x296 * var_x81;
        ...
        IJth(rJacobian, 4, 4) = -var_x218;
        IJth(rJacobian, 11, 4) = -var_x114 * var_x282;
        IJth(rJacobian, 12, 4) = -var_x115 * var_x286;
        IJth(rJacobian, 13, 4) = -var_x115 * var_x292;
        IJth(rJacobian, 14, 4) = -var_x114 * var_x296;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x117 * var_x88 - var_x118 * var_x94 - var_x118 * var_x96);
        IJth(rJacobian, 5, 5) = -0.02 - var_x220;
        IJth(rJacobian, 11, 5) = -var_x117 * var_x282;
        IJth(rJacobian, 12, 5) = -var_x118 * var_x286;
        IJth(rJacobian, 13, 5) = -var_x118 * var_x292;
        IJth(rJacobian, 14, 5) = -var_x117 * var_x296;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x61 * var_x62);
        IJth(rJacobian, 6, 6) = -var_x235 - var_x236;
        IJth(rJacobian, 13, 6) = -var_x290 * var_x62;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x120 * var_x37);
        IJth(rJacobian, 7, 7) = -var_x250 - var_x251;
        IJth(rJacobian, 13, 7) = var_x120 * var_x288;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x121 * var_x36);
        IJth(rJacobian, 8, 8) = -3.2750000000000003e-5 * var_x242 * var_x248 - 1.7975e-5 * var_x246 * var_x248;
        IJth(rJacobian, 13, 8) = var_x121 * var_x287;
        ...
        IJth(rJacobian, 10, 10) = -var_x267;
        IJth(rJacobian, 14, 10) = -var_x122 * var_x294;
        IJth(rJacobian, 11, 11) = -0.21052631578947367 - var_x272;
        ...
        IJth(rJacobian, 13, 12) = 3.459874159855314 * var_x293 + 4.1526501445598893e-6 * var_x124;
        ...
        IJth(rJacobian, 13, 13) = 188.75472776079184 * var_x293 + 0.000273711269773125 * var_x137 - 0.0015001782369281045 * var_x136 - 9.0713633255081308e-6 * var_x132 - 3.2165331512873877e-8 * var_x104 - 0.0011476363512500001 * var_x133 - var_x135 * var_x291;
        ...
        IJth(rJacobian, 11, 14) = var_x273 * (-3.7522371676265542e-6 * var_x160 * var_x276 - 4.6323915649710559 * var_x157 * var_x280);
        IJth(rJacobian, 12, 14) = -1.214949568543267e-13 * var_x156 - 4.6140557161776547e-8 * var_x148 + var_x151 * var_x285;
        IJth(rJacobian, 13, 14) = 3.2633849539327485e-11 * var_x153 - 3.4738558033903784e-14 * var_x159;
        IJth(rJacobian, 14, 14) = 8.319524789019007e-5 * var_x152 + 1.5380185720592182e-8 * var_x148 + 5.0183373527362646e-6 * var_x147 - 0.0015981617647058825 * var_x299 - 0.00023999003823076885 * var_x158 - 3.5374427157362017e-5 * var_x143 - 1.9439193096692272e-10 * var_x160 - 7.9592461104064537e-5 * var_x150 - 0.00071029411764705886 * var_x298 - var_x151 * var_x295;
        IJth(rJacobian, 16, 14) = 0.0087500000000000008 * var_x298 + 0.0196875 * var_x299;
        IJth(rJacobian, 11, 15) = 8.8802252544942608e-5 * var_x284 * (-var_chaste_interface__Irel__Rel - var_x279 * var_chaste_interface__cell__V) + 1.4297504830157579 * var_x100 * var_x270 * var_x273 * var_x274 * var_x284 * var_x87 / pow(var_x275, 2);
        IJth(rJacobian, 15, 15) = -0.0041666666666666666 - 0.044999999999999998 * var_x283;
        IJth(rJacobian, 16, 15) = 0.0003623188405797101 + 0.003913043478260869 * var_x283;
