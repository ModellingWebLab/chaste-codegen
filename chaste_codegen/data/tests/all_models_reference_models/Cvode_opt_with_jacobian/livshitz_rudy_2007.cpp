...
const double var_x0 = 7224.0024405006716 * NV_Ith_S(mParameters, 7);
        ...
        const double var_x145 = 6.5127374999999992e-9 * var_x49;
        const double var_x146 = -0.5 + 187179.41753901311 * var_chaste_interface__cell__V;
        const double var_x147 = var_x145 - var_x146 * (-var_x145 - 6.5127374999999992e-9 * var_x50);
        ...
        const double var_x152 = 1.8621604999999999e-9 * var_x96;
        const double var_x153 = var_x152 - var_x146 * (-var_x152 - 1.8621604999999999e-9 * var_x97);
        ...
        const double var_x344 = 0.23529411764705882 * var_x330 / pow(var_x331, 2);
        ...
        const double var_x352 = var_x351 - 8.8449999999999995e-5 * var_x345 * var_x349 / pow(var_x350, 2);
        ...
        IJth(rJacobian, 2, 0) = ((var_x260) ? (var_x258 + var_x254 * (0.15999999943156581 * var_x255 + 0.16000000056843419 * var_x256)) : (var_x258 + var_x254 * var_x264 - 0.032000000000000001 * var_x254 * var_x259 * var_x262 / pow(var_x263, 2)));
        ...
        IJth(rJacobian, 4, 0) = ((var_x318) ? (var_x308 * var_x315 + 4.7698560017679535e-16 * var_x316 * (-36688738598216.805 * var_x303 - 36688738598216.805 * var_x306) / pow((-var_x303 + 0.017500000000000002 * var_x307), 2)) : (var_x315 * var_x323 + var_x321 * var_x322 - var_x321 * var_x324 - var_x310 * var_x316 * var_x324 / pow(var_x319, 2)));
        ...
        IJth(rJacobian, 6, 0) = ((var_x346) ? (var_x332 * (var_x339 + 0.00030499999842881236 * var_x333 + 0.00030500000157118761 * var_x334) + var_x344 * (var_x340 + var_x341 - var_x343)) : ((var_x356) ? (var_x332 * (var_x352 + 0.00068999999999999997 * var_x347 + 0.00068999999999999997 * var_x348) + var_x344 * (var_x354 + var_x355 - var_x353)) : (var_x332 * (var_x339 + var_x352) + var_x344 * (var_x341 + var_x354))));
        ...
        IJth(rJacobian, 2, 2) = ((var_x260) ? (var_x265 + var_x266 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__cell__V) * (var_x265 + 3.1999999919207769e-7 * var_x255)) : (var_x266 - var_x259 * var_x264));
        ...
        IJth(rJacobian, 6, 6) = ((var_x346) ? (var_x342 + var_x343 + var_x357) : ((var_x356) ? (var_x353 + var_x358 - var_x355) : (var_x357 + var_x358)));
