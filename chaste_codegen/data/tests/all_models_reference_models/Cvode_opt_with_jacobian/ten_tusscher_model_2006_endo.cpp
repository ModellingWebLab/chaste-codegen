...
const double var_x0 = exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V);
        ...
        const double var_x159 = 0.01 * NV_Ith_S(mParameters, 13);
        const double var_x160 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 14));
        const double var_x161 = 1.0 + var_x160;
        const double var_x162 = 1.0 - var_x159;
        const double var_x163 = var_x159 + var_x162 / pow(var_x161, 2);
        const double var_x164 = var_x163 - var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x165 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 14));
        const double var_x166 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 14));
        ...
        const double var_x171 = var_x160 * var_x162 / pow(var_x161, 3);
        const double var_x172 = 0.26917900403768508 * var_x171;
        const double var_x173 = var_chaste_interface__membrane__V < -40.0 + NV_Ith_S(mParameters, 14);
        const double var_x174 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 14) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x175 = 1.0 + var_x174;
        const double var_x176 = 1 / var_x175;
        const double var_x177 = var_x163 - var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x178 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x179 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 14) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x180 = -25428.0 * var_x178 - 6.9480000000000002e-6 * var_x179;
        const double var_x181 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 14));
        ...
        const double var_x192 = exp(-3.2000000000000002 - var_x21 + 0.10000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x193 = 1.0 + var_x192;
        const double var_x194 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * NV_Ith_S(mParameters, 14));
        ...
        const double var_x206 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x217 = exp(2.8571428571428572 + var_x117);
        const double var_x218 = 1.0 + var_x217;
        const double var_x219 = var_x209 / pow(var_x210, 2);
        ...
        const double var_x226 = exp(5.0 + var_x117);
        ...
        const double var_x233 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x230), 2);
        const double var_x234 = exp(5.5999999999999996 + var_x145);
        ...
        const double var_x238 = exp(3.3333333333333335 + var_x134);
        ...
        const double var_x272 = var_x271 * var_x83;
        ...
        const double var_x278 = var_x277 * var_x7 * var_x80;
        const double var_x279 = 2.7188924024856265e-5 * var_x48;
        const double var_x280 = 0.00027188924024856262 * var_x276;
        const double var_x281 = var_x277 * var_x28;
        ...
        IJth(rJacobian, 6, 0) = ((var_x173) ? (var_x164 * (108035.0 * var_x165 + 0.21330000000000002 * var_x166 - 0.008382352941176471 * var_x167) - var_x172 * (var_x168 + var_x169 + var_x170)) : (-1.5943679469924423 * var_x171 * var_x176 + 0.53361053361053368 * var_x164 * var_x174 / pow(var_x175, 2)));
        IJth(rJacobian, 7, 0) = ((var_x173) ? (var_x177 * (var_x184 - 0.00025500480000000003 * var_x188 + var_x183 * var_x189 * (3.0508668000000001e-7 * var_x179 - 6214.6032000000005 * var_x178) + 0.0033402720000000005 * var_x185 * var_x187 / pow(var_x186, 2) - 0.311 * var_x180 * var_x181 * var_x189 / pow(var_x182, 2)) - var_x172 * (var_x190 + var_x191)) : (0.034200000000000001 * var_x177 * var_x195 - 0.16150740242261102 * var_x171 * var_x195 + 0.059999999999999998 * var_x177 * var_x192 * var_x194 / pow(var_x193, 2)));
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x207) * (-0.050000000000000003 * var_x196 / pow(var_x197, 2) + 0.27999999999999997 * var_x199 * var_x204 / pow(var_x200, 2) - 0.15076923076923074 * var_x201 * var_x202 / pow(var_x203, 2)) / pow((var_x205 + 0.7142857142857143 * var_x198), 2) + 0.13333333333333333 * var_x206 * var_x208 / pow(var_x207, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x218) * (18.0 * var_x219 - var_x220 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x212 / pow(var_x213, 2)) / pow((0.018140589569160998 + var_x216 + 0.16326530612244897 * var_x211 + 0.18140589569160998 * var_x214), 2) - 0.14285714285714285 * var_x217 * var_x221 / pow(var_x218, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x227) * (8.0 * var_x219 - var_x228 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x222 / pow(var_x223, 2)) / pow((var_x225 + 0.055160142348754451 * var_x224 + 0.14234875444839859 * var_x211), 2) - 0.095714285714285724 * var_x226 * var_x229 / pow(var_x227, 2);
        IJth(rJacobian, 12, 0) = -0.20000000000000001 * var_x234 * var_x237 / pow(var_x235, 2) - 0.001 * var_x236 * (-0.13400000000000001 - 0.002 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x235) / pow((0.0080000000000000002 + var_x236), 2);
        ...
        IJth(rJacobian, 17, 0) = var_x276 * (-0.0018954404990922068 * var_x39 - 0.0018954404990922068 * var_x55 - 4.6119913257618111e-6 * var_x44 - 0.00063181349969740233 * var_x92 - 0.00063181349969740233 * NV_Ith_S(mParameters, 9));
        IJth(rJacobian, 18, 0) = var_x276 * (0.0012636269993948047 * var_x55 + 1.631335441491376e-6 * var_x42 - 0.00027188924024856262 * var_x99 - 2.7188924024856265e-5 * var_x26 - 0.00010565443138752546 * var_x29 - 0.00063181349969740233 * var_x2 - 0.00063181349969740233 * var_x3 - 0.00063181349969740233 * var_x5 - var_x279 * var_x46);
        ...
        IJth(rJacobian, 14, 1) = var_x245 * (1.2499999999999999e-7 * var_x110 + NV_Ith_S(mParameters, 0));
        ...
        IJth(rJacobian, 17, 5) = -0.0018954404990922068 * var_x276 * var_x79;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x81 * var_chaste_interface__fast_sodium_current_j_gate__j);
        IJth(rJacobian, 6, 6) = ((var_x173) ? (-var_x168 - var_x169 - var_x170) : (-5.9230769230769234 * var_x176));
        IJth(rJacobian, 17, 6) = -var_x278 * var_chaste_interface__fast_sodium_current_j_gate__j;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x81 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 7, 7) = ((var_x173) ? (-var_x190 - var_x191) : (-0.59999999999999998 * var_x195));
        IJth(rJacobian, 17, 7) = -var_x278 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * var_x82);
        IJth(rJacobian, 8, 8) = -var_x208;
        ...
        IJth(rJacobian, 11, 11) = -var_x232;
        IJth(rJacobian, 15, 11) = -var_x271 * var_x85;
        ...
        IJth(rJacobian, 18, 12) = -var_x281 * var_x4;
        ...
        IJth(rJacobian, 18, 13) = -var_x281 * NV_Ith_S(mParameters, 21) * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 14) = var_x106 * var_x108;
        IJth(rJacobian, 14, 14) = var_x245 * (-var_x254 - NV_Ith_S(mParameters, 0) + 0.21333333333333335 * var_x260 - 0.032000000000000001 * var_x258) + 0.66666666666666674 * (var_x112 - var_x111 * NV_Ith_S(mParameters, 0) - var_x254 * var_x256) / (pow(var_x242, 3) * pow((0.33333333333333337 + var_x243), 2));
        ...
        IJth(rJacobian, 17, 17) = var_x276 * (1.1846503119326294e-6 * var_x94 - 0.0018954404990922068 * var_x91 - 0.016878114612481093 * var_x88 - 0.016878114612481093 * var_x93 - 0.0056863214972766203 * var_x95);
        IJth(rJacobian, 18, 17) = var_x276 * (0.0012636269993948047 * var_x91 - 0.00050634343837443281 * var_x89 - 7.8976687462175284e-7 * var_x94);
        ...
        IJth(rJacobian, 18, 18) = var_x276 * (4.357910453967955e-5 * var_x103 - 0.016878114612481093 * var_x89 - 0.016878114612481093 * var_x96 - 0.016878114612481093 * var_x97 - 0.00072631840899465921 * var_x98 - 0.0072631840899465916 * var_x100 - var_x102 * var_x279);
    }
