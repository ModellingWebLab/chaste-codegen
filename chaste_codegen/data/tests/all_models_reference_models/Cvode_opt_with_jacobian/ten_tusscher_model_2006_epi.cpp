...
const double var_x0 = NV_Ith_S(mParameters, 11);
        ...
        const double var_x177 = 0.01 * NV_Ith_S(mParameters, 14);
        const double var_x178 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 15));
        ...
        const double var_x182 = var_x181 - var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x183 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 15));
        const double var_x184 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 15));
        const double var_x185 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 15) - 0.14705882352941177 * var_chaste_interface__membrane__V);
        ...
        const double var_x189 = var_x178 * var_x180 / pow(var_x179, 3);
        const double var_x190 = 0.26917900403768508 * var_x189;
        const double var_x191 = var_chaste_interface__membrane__V < -40.0 + NV_Ith_S(mParameters, 15);
        ...
        const double var_x195 = var_x181 - var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x196 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 15));
        const double var_x197 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 15) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x198 = -25428.0 * var_x196 - 6.9480000000000002e-6 * var_x197;
        const double var_x199 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 15));
        const double var_x200 = 1.0 + var_x199;
        const double var_x201 = 1 / var_x200;
        const double var_x202 = var_x198 * var_x201;
        const double var_x203 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 15) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x204 = 1.0 + var_x203;
        const double var_x205 = exp(0.01052 * NV_Ith_S(mParameters, 15) - 0.01052 * var_chaste_interface__membrane__V);
        ...
        const double var_x210 = exp(-3.2000000000000002 - var_x29 + 0.10000000000000001 * NV_Ith_S(mParameters, 15));
        const double var_x211 = 1.0 + var_x210;
        const double var_x212 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * NV_Ith_S(mParameters, 15));
        ...
        const double var_x235 = exp(2.8571428571428572 + var_x135);
        ...
        const double var_x244 = exp(5.0 + var_x135);
        ...
        const double var_x287 = var_x39 * NV_Ith_S(mParameters, 12);
        const double var_x288 = 36576.444769568399 * var_x287;
        const double var_x289 = var_x288 * var_x76;
        const double var_x290 = var_x77 * var_x80 * NV_Ith_S(mParameters, 12);
        ...
        const double var_x295 = var_x288 * var_x293 * var_x74;
        const double var_x296 = var_x102 * var_x295;
        ...
        const double var_x300 = var_x124 * NV_Ith_S(mParameters, 3);
        const double var_x301 = 60.960741282614002 * var_x300;
        const double var_x302 = var_x301 * var_x95;
        const double var_x303 = 26.23332619555811 * var_x300;
        const double var_x304 = var_x301 * var_x36;
        ...
        IJth(rJacobian, 6, 0) = ((var_x191) ? (var_x182 * (108035.0 * var_x183 + 0.21330000000000002 * var_x184 - 0.008382352941176471 * var_x185) - var_x190 * (var_x186 + var_x187 + var_x188)) : (-1.5943679469924423 * var_x189 * var_x194 + 0.53361053361053368 * var_x182 * var_x192 / pow(var_x193, 2)));
        IJth(rJacobian, 7, 0) = ((var_x191) ? (var_x195 * (var_x202 - 0.00025500480000000003 * var_x206 + var_x201 * var_x207 * (3.0508668000000001e-7 * var_x197 - 6214.6032000000005 * var_x196) + 0.0033402720000000005 * var_x203 * var_x205 / pow(var_x204, 2) - 0.311 * var_x198 * var_x199 * var_x207 / pow(var_x200, 2)) - var_x190 * (var_x208 + var_x209)) : (0.034200000000000001 * var_x195 * var_x213 - 0.16150740242261102 * var_x189 * var_x213 + 0.059999999999999998 * var_x195 * var_x210 * var_x212 / pow(var_x211, 2)));
        ...
        IJth(rJacobian, 15, 0) = var_x294 * (-var_x289 + 73152.889539136799 * var_x290 * var_x82 - 18288.2223847842 * var_x106 * var_x290 * var_x73);
        IJth(rJacobian, 17, 0) = -var_x301 * (var_x12 + 3.0 * var_x50 + 8.1720000000000006 * var_x58 + 0.19500000000000001 * var_x67 + NV_Ith_S(mParameters, 11));
        IJth(rJacobian, 18, 0) = -var_x301 * (var_x17 + var_x3 + var_x35 + var_x37 + var_x5 + var_x65 + var_x8 - var_x52 - 5.4480000000000004 * var_x58);
        ...
        IJth(rJacobian, 15, 9) = -var_x296 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        ...
        IJth(rJacobian, 15, 10) = -var_x296 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x101 * var_x104);
        IJth(rJacobian, 11, 11) = -var_x250;
        IJth(rJacobian, 15, 11) = -var_x104 * var_x295;
        ...
        IJth(rJacobian, 18, 12) = -var_x304 * var_x7;
        ...
        IJth(rJacobian, 18, 13) = -var_x304 * NV_Ith_S(mParameters, 21) * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 14) = var_x123 * var_x126;
        IJth(rJacobian, 14, 14) = var_x267 * (-var_x276 - NV_Ith_S(mParameters, 0) + 0.21333333333333335 * var_x282 - 0.032000000000000001 * var_x280) + 0.66666666666666674 * (var_x130 - var_x129 * NV_Ith_S(mParameters, 0) - var_x276 * var_x278) / (pow(var_x264, 3) * pow((0.33333333333333337 + var_x265), 2));
        IJth(rJacobian, 15, 14) = var_x294 * (var_x298 + 0.64023408924652514 * var_x280 - 4.2682272616435011 * var_x282);
        ...
        IJth(rJacobian, 15, 16) = var_x285 * var_x293 * var_x297;
        ...
        IJth(rJacobian, 17, 17) = -var_x301 * (9.0 * var_x115 + 8.1720000000000006 * var_x109 - 0.0051075000000000001 * var_x110 + var_x111 * var_x12 + var_x111 * NV_Ith_S(mParameters, 11));
        IJth(rJacobian, 18, 17) = -var_x301 * (var_x114 + 0.003405 * var_x110 - 5.4480000000000004 * var_x109);
        ...
        IJth(rJacobian, 18, 18) = -var_x301 * (var_x113 + var_x117 + var_x118 + var_x119 - var_x120 + var_x116 * var_x3 + var_x116 * var_x8);
    }
