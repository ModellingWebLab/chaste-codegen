...
std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLCvodeOpt_LookupTables> Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLCvodeOpt_LookupTables::mpInstance;
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x72 = var_x67 * var_x68 * (0.14447610163038616 * var_x13 * var_x70 + 0.40963906727330363 * var_x13 * var_x69) * NV_Ith_S(mParameters, 2) * var_chaste_interface__sodium_dynamics__Nai / pow(var_x71, 2);
        ...
        const double var_x113 = var_x67 * NV_Ith_S(mParameters, 2) / var_x71;
        ...
        const double var_x184 = exp(-1.3 - 0.14285714285714285 * var_chaste_interface__Membrane__Vm_converted);
        ...
        const double var_x225 = exp(8.75 + 0.25 * var_chaste_interface__Membrane__Vm_converted);
        ...
        const double var_x238 = exp(-3.8775510204081627 - 0.2040816326530612 * var_chaste_interface__Membrane__Vm_converted - 0.0076462663250123509 * (-2.1789087017666886 + log(40.0 * pow((1.0 + 0.38461538461538458 * NV_Ith_S(mParameters, 1)), 4) / pow((0.57999999999999996 + NV_Ith_S(mParameters, 1)), 4))) * NV_Ith_S(mParameters, 12));
        ...
        const double var_x275 = 1177757.8010268393 * var_x90 * NV_Ith_S(mParameters, 11);
        ...
        const double var_x279 = var_x278 * (-0.33833519999999995 - var_x134);
        ...
        IJth(rJacobian, 3, 0) = ((var_x163) ? ((var_x157 - var_x46) * (72023333.333333328 * var_x158 + 142.20000000000002 * var_x159 - 5.5882352941176476 * var_x160) - var_x162 * (38.0 * var_x160 + 206666666.66666669 * var_x158 + 1800.0000000000002 * var_x159)) : (-0.034507985147763195 * var_x161));
        ...
        IJth(rJacobian, 7, 0) = 0.0027777777777777779 * (0.33000000000000002 - var_chaste_interface__i_CaL_f2_gate__f2 + 0.67000000000000004 / var_x226) * (0.0016000000000000001 * var_x215 - var_x227 * (-0.29411764705882354 - 0.011764705882352941 * var_chaste_interface__Membrane__Vm_converted) - 0.0030999999999999999 * var_x221 / pow(var_x222, 2)) / pow((var_x224 + 0.051666666666666666 * var_x223 + 0.026666666666666668 * var_x204), 2) - 0.00016750000000000001 * var_x225 * var_x228 / pow(var_x226, 2);
        ...
        IJth(rJacobian, 15, 0) = (-1059.9820209241554 - 17313039675.094536 * var_x45 - 1177.7578010268392 * var_x117 - 13059102905.698095 * var_x74 - 6506254.4429941392 * var_x72) * NV_Ith_S(mParameters, 11);
        ...
        IJth(rJacobian, 16, 1) = var_x278 * (0.00044443999999999999 + var_x123);
        IJth(rJacobian, 17, 1) = ((var_x285) ? (0) : ((var_x280) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Cai, 5) / pow((1.8382656249999998e-21 + var_x283), 2)) : ((var_x286) ? (0) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Cai, 15) / pow((5.0709427749024951e-56 + var_x281), 2)))));
        ...
        IJth(rJacobian, 15, 3) = -var_x275 * var_x48;
        ...
        IJth(rJacobian, 15, 4) = -var_x275 * var_x93;
        ...
        IJth(rJacobian, 16, 5) = var_x279 * var_chaste_interface__calcium_dynamics__g;
        ...
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.0011508899999999999 * var_x115 - 14700.0 * var_x116 - 1.8414239999999999 * var_x114 - 7.7556079334600278e-5 * var_x112 - var_x117 * var_x87 * var_x89 - 2.585202644486676e-6 * var_x35 * var_x86 * NV_Ith_S(mParameters, 12));
        ...
        IJth(rJacobian, 16, 16) = var_x278 * (-0.00044443999999999999 + var_x132 * (var_x139 - var_x138)) + 0.010050308647262718 * (var_x125 + var_x126 - var_x124 - var_x133) / (pow(var_x276, 3) * pow((0.33333333333333337 + var_x277), 2));
        IJth(rJacobian, 1, 17) = var_x121 * var_x135 * var_chaste_interface__i_CaL_d_gate__d;
        IJth(rJacobian, 16, 17) = var_x279 * var_chaste_interface__i_CaL_d_gate__d;
        IJth(rJacobian, 17, 17) = ((var_x285) ? (0) : ((var_x280) ? (-0.5) : ((var_x286) ? (0) : (-0.5))));
    }
