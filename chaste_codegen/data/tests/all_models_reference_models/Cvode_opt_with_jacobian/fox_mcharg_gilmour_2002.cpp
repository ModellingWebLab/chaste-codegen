        ...
        if (mNeedsRegeneration[0])
        {
            ...
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(0.074883406923417162 * var_chaste_interface__membrane__V);
                };
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return -1.0 + exp(0.074883406923417162 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(0.037441703461708581 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return -1.0 + exp(0.037441703461708581 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1.0 + 2.5 * exp(2.8000000000000003 + 0.10000000000000001 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(0.013104596211598003 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-0.024337107250110578 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1.0 + 0.20000000000000001 * exp(-0.024337107250110578 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.1245 * exp(-0.0037441703461708587 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.25 * exp(-0.01 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.070000000000000007 * var_chaste_interface__membrane__V)) + 0.070000000000000007 * exp(-2.0 - 0.050000000000000003 * var_chaste_interface__membrane__V) / (1.0 + exp(2.0 + 0.050000000000000003 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1.0 + exp(2.5 + 0.20000000000000001 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 30.0 + 200.0 / (1.0 + exp(2.1052631578947367 + 0.10526315789473684 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1.0 + 1.6499999999999999 * exp(0.050000000000000003 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1.0 + exp(-2.1819999999999999 - 0.18190000000000001 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 43.0 + 1 / (exp(-7.6769999999999996 - 0.012800000000000001 * var_chaste_interface__membrane__V) + exp(-5.4950000000000001 + 0.1691 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1.0 + exp(1.1764705882352942 - 0.073529411764705885 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return ((fabs(-10.0 + var_chaste_interface__membrane__V) < 1.4556040763835654e-6) ? (-1.0465793309197835e-10 / (1.0 - exp(2.1542940330476766e-7)) - 1.9068413400624708e-10 / (-1.0 + exp(-1.0000000004755094e-7)) + 343499.99983666249 * (-9.9999985443959236 + var_chaste_interface__membrane__V) * (1.0465793309197835e-10 / (1.0 - exp(2.1542940330476766e-7)) + 1.0465793309197835e-10 / (1.0 - exp(-2.1542940330476766e-7)) + 1.9068413400624708e-10 / (-1.0 + exp(1.0000000004755094e-7)) + 1.9068413400624708e-10 / (-1.0 + exp(-1.0000000004755094e-7)))) : (0.00013100000000000001 * (-10.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-0.68699999999999994 + 0.068699999999999997 * var_chaste_interface__membrane__V)) + 7.1899999999999999e-5 * (-10.0 + var_chaste_interface__membrane__V) / (1.0 - exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_current__i_Ca_max = ((fabs(var_chaste_interface__membrane__V) < 1.3354093264248706e-6) ? (-374417.03461708582 * (-1.3354093264248706e-6 + var_chaste_interface__membrane__V) * (-1.9300000000000002e-5 * (-0.34100000000000003 * NV_Ith_S(mParameters, 5) + var_calcium_dynamics__Ca_i * exp(1.0000000000000001e-7)) * NV_Ith_S(mParameters, 8) / (-1.0 + exp(1.0000000000000001e-7)) - 1.9300000000000002e-5 * (-0.34100000000000003 * NV_Ith_S(mParameters, 5) + var_calcium_dynamics__Ca_i * exp(-1.0000000000000001e-7)) * NV_Ith_S(mParameters, 8) / (-1.0 + exp(-1.0000000000000001e-7))) + 1.9300000000000002e-5 * (-0.34100000000000003 * NV_Ith_S(mParameters, 5) + var_calcium_dynamics__Ca_i * exp(1.0000000000000001e-7)) * NV_Ith_S(mParameters, 8) / (-1.0 + exp(1.0000000000000001e-7))) : (14.452497536219512 * (-0.34100000000000003 * NV_Ith_S(mParameters, 5) + var_calcium_dynamics__Ca_i * _lt_0_row[0]) * NV_Ith_S(mParameters, 8) * var_chaste_interface__membrane__V / (_lt_0_row[1]))); // microA_per_microF
        ...
        const double var_L_type_Ca_current__i_CaK = ((fabs(var_chaste_interface__membrane__V) < 2.6708186528497411e-6) ? (-187208.51730854291 * (-2.6708186528497411e-6 + var_chaste_interface__membrane__V) * (-5.5873500000000006e-9 * (-NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 3) * exp(1.0000000000000001e-7)) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f_Ca_gate__f_Ca * var_chaste_interface__L_type_Ca_current_f_gate__f / ((1.0 - 3.773584905660377 * var_L_type_Ca_current__i_Ca_max) * (-1.0 + exp(1.0000000000000001e-7))) - 5.5873500000000006e-9 * (-NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 3) * exp(-1.0000000000000001e-7)) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f_Ca_gate__f_Ca * var_chaste_interface__L_type_Ca_current_f_gate__f / ((1.0 - 3.773584905660377 * var_L_type_Ca_current__i_Ca_max) * (-1.0 + exp(-1.0000000000000001e-7)))) + 5.5873500000000006e-9 * (-NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 3) * exp(1.0000000000000001e-7)) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f_Ca_gate__f_Ca * var_chaste_interface__L_type_Ca_current_f_gate__f / ((1.0 - 3.773584905660377 * var_L_type_Ca_current__i_Ca_max) * (-1.0 + exp(1.0000000000000001e-7)))) : (0.0020919990183677745 * (-NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 3) * _lt_0_row[2]) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f_Ca_gate__f_Ca * var_chaste_interface__L_type_Ca_current_f_gate__f * var_chaste_interface__membrane__V / ((1.0 - 3.773584905660377 * var_L_type_Ca_current__i_Ca_max) * (_lt_0_row[3])))); // microA_per_microF
...
const double var_x0 = exp(1.0000000000000001e-7);
        ...
        const double var_x4 = -0.34100000000000003 * NV_Ith_S(mParameters, 5);
        const double var_x5 = 1000.0 * var_chaste_interface__calcium_dynamics__Ca_i_converted;
        const double var_x6 = var_x1 * (var_x4 + var_x0 * var_x5);
        const double var_x7 = 7.2262487681097562 * NV_Ith_S(mParameters, 8);
        const double var_x8 = exp(-1.0000000000000001e-7);
        const double var_x9 = 1 / (-1.0 + var_x8);
        const double var_x10 = var_x9 * (var_x4 + var_x5 * var_x8);
        const double var_x11 = fabs(var_chaste_interface__membrane__V);
        const double var_x12 = var_x11 < 1.3354093264248706e-6;
        const double var_x13 = _lt_0_row[0];
        const double var_x14 = var_x4 + var_x13 * var_x5;
        ...
        const double var_x22 = var_x21 * ((var_x12) ? (var_x10 * var_x7 + var_x6 * var_x7) : (var_x17 + 1082.2522540644097 * var_x19 * var_chaste_interface__calcium_dynamics__Ca_i_converted - 1.0822522540644097 * var_x14 * var_x18 * NV_Ith_S(mParameters, 8) / pow(var_x15, 2)));
        const double var_x23 = 1.9300000000000002e-5 * NV_Ith_S(mParameters, 8);
        const double var_x24 = var_x23 * var_x6;
        const double var_x25 = ((var_x12) ? (var_x24 - 374417.03461708582 * (-1.3354093264248706e-6 + var_chaste_interface__membrane__V) * (-var_x24 - var_x10 * var_x23)) : (var_x17 * var_chaste_interface__membrane__V));
        const double var_x26 = pow((0.26500000000000001 - var_x25), (-2));
        const double var_x27 = 1.4806477500000002e-9 * var_x26;
        ...
        const double var_x31 = var_x9 * (var_x2 + var_x8 * NV_Ith_S(mParameters, 3));
        ...
        const double var_x64 = var_x54 - var_x5 * var_x53;
        ...
        const double var_x67 = var_x11 < 2.6708186528497411e-6;
        ...
        const double var_x78 = 0.019300000000000001 * NV_Ith_S(mParameters, 8);
        const double var_x79 = var_x0 * var_x1 * var_x78;
        const double var_x80 = var_x21 * ((var_x12) ? (var_x79 + (0.5 - 374417.03461708582 * var_chaste_interface__membrane__V) * (-var_x79 - var_x78 * var_x8 * var_x9)) : (14452.497536219513 * var_x19));
        const double var_x81 = var_x27 * var_x80;
        const double var_x82 = -var_x3 * var_x81;
        const double var_x83 = 1 / (0.050000000000000003 + var_x5);
        ...
        const double var_x92 = 5.5873500000000006e-9 * var_x32;
        ...
        const double var_x136 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x137 = 1 / (1.0 - exp(1.0000000045806701e-7));
        ...
        const double var_x141 = fabs(var_x140) < 1.0000000010279564e-6;
        ...
        const double var_x146 = 3.2000000146581445e-7 * var_x137;
        const double var_x147 = -0.080000000000000002 * var_x138;
        ...
        const double var_x185 = 1 / (-1.0 + exp(1.0000000004755094e-7));
        const double var_x186 = 1 / (-1.0 + exp(-1.0000000004755094e-7));
        const double var_x187 = 1 / (1.0 - exp(2.1542940330476766e-7));
        const double var_x188 = 1 / (1.0 - exp(-2.1542940330476766e-7));
        const double var_x189 = 1.0465793309197835e-10 * var_x187;
        const double var_x190 = 1.9068413400624708e-10 * var_x186;
        const double var_x191 = var_x189 + var_x190;
        const double var_x192 = 343499.99983666249 * (-9.9999985443959236 + var_chaste_interface__membrane__V) * (var_x191 + 1.0465793309197835e-10 * var_x188 + 1.9068413400624708e-10 * var_x185);
        ...
        const double var_x195 = fabs(var_x194) < 1.4556040763835654e-6;
        ...
        IJth(rJacobian, 2, 0) = ((var_x141) ? (var_x139 + var_x135 * (0.15999999943156581 * var_x136 + 0.16000000056843419 * var_x137)) : (var_x139 + var_x135 * var_x145 - 0.032000000000000001 * var_x135 * var_x140 * var_x143 / pow(var_x144, 2)));
        ...
        IJth(rJacobian, 2, 2) = ((var_x141) ? (var_x146 + var_x147 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x146 + 3.1999999919207769e-7 * var_x136)) : (var_x147 - var_x140 * var_x145));
