    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                ...
                _lookup_table_0[i][0] = 1 / (1.0 + exp(5.9871794871794881 - 0.12820512820512822 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][1] = exp(-0.075369662812530269 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][2] = 1 / (1.0 - exp(-0.075369662812530269 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][3] = exp(0.013189690992192795 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][4] = exp(-0.024495140414072337 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][5] = 1 / (1.0 + 0.27000000000000002 * exp(-0.024495140414072337 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][6] = exp(-0.037684831406265135 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][7] = 0.1245 * exp(-0.0037684831406265135 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][8] = exp(0.15506520491866829 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][9] = 1 / (1.0 + exp(4.024390243902439 + 0.12195121951219513 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][10] = 0.10000000000000001 / (1.0 + exp(6.666666666666667 - 0.16666666666666666 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][11] = 1 / (8.0 + 315.0 / (1.0 + exp(7.5 + 0.25 * var_chaste_interface__cell__V)));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][12] = exp(-0.038580246913580245 * pow((-1 + 0.20000000000000001 * var_chaste_interface__cell__V), 2));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][13] = 3.802 / (0.20000000000000001 * exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__cell__V) + 0.1027 * exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][14] = 3.802 / (0.1027 * exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__cell__V) + 0.23000000000000001 * exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][15] = 3.802 / (0.25 * exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__cell__V) + 0.1027 * exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][16] = 1 / (0.39395599999999997 + 0.188495 * exp(-0.42168674698795178 - 0.060240963855421679 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][17] = 6.9999999999999997e-7 * exp(-0.90909090909090906 - 0.12987012987012986 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][18] = 0.19170000000000001 * exp(-0.12315270935960591 - 0.04926108374384236 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][19] = 0.20000000000000001 * exp(0.12315270935960591 - 0.04926108374384236 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][20] = 0.22 * exp(0.36945812807881773 - 0.04926108374384236 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][21] = exp(1.6096500000000002 + 0.035770000000000003 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][22] = exp(-2.8066499999999999 - 0.062370000000000002 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][23] = 1 / (1.0 + exp(10.279999999999999 + 0.20000000000000001 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][24] = 1 / (9.6645000000000003 + 10.936199999999999 / (1.0 + exp(10.279999999999999 + 0.20000000000000001 * var_chaste_interface__cell__V)));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][25] = 0.033500000000000002 * exp(0.0109 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][26] = 0.070300000000000001 * exp(0.14349999999999999 + 0.0287 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][27] = 6.8899999999999994e-5 * exp(-0.041779999999999998 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][28] = 0.0064970000000000002 * exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][29] = exp(0.01176 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][30] = exp(-0.063100000000000003 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][31] = exp(-1.0069999999999999 - 0.037999999999999999 * var_chaste_interface__cell__V);
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][32] = 1 / (1.0 - exp(-3.3919999999999999 - 0.128 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][33] = 1 / (1.0 + exp(-0.64479166666666676 - 0.10416666666666667 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][34] = 1 / (13.17 + 39.299999999999997 * exp(-0.050000000000000003 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][35] = 1 / (2.0579999999999998 + 0.49299999999999999 * exp(-0.062899999999999998 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][36] = 1 / (1.0 + exp(7.7962962962962958 + 0.18518518518518517 * var_chaste_interface__cell__V));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][37] = 1 / (270.0 + 1050.0 / (1.0 + exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__cell__V)));
            }

            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][38] = 1 / (643.0 + 1000.0 / (1.0 + exp(7.7962962962962958 + 0.18518518518518517 * var_chaste_interface__cell__V)));
            }
...
// LCOV_EXCL_STOP
        ...
        const double var_calcium_activated_chloride_current__i_ClCa = 2.0 * _lt_0_row[0] * (40.0 + var_chaste_interface__cell__V) * var_calcium_concentration__Cai / (10.0 + var_calcium_concentration__Cai); // picoA_per_picoF
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_L_type_calcium_current__y_gate = _lt_0_row[11] * (-var_chaste_interface__L_type_calcium_current__y_gate + _lt_0_row[9] + _lt_0_row[10]); // 1 / millisecond
        const double var_calcium_background_current__i_Cab = 0.00069999999999999999 * var_chaste_interface__cell__V - 0.0092875564766839377 * log(NV_Ith_S(mParameters, 1) / var_calcium_concentration__Cai); // picoA_per_picoF
        ...
        const double d_dt_chaste_interface_var_fast_transient_outward_K_I__ito_f = _lt_0_row[24] * (-var_chaste_interface__fast_transient_outward_K_I__ito_f + _lt_0_row[23]); // 1 / millisecond
        const double var_fast_transient_outward_K_I__E_K = 26.535875647668394 * log(NV_Ith_S(mParameters, 2) / var_chaste_interface__potassium_concentration__Ki); // millivolt
        const double var_fast_transient_outward_K_I__i_Kto_f = 0.53469999999999995 * pow(var_chaste_interface__fast_transient_outward_K_I__ato_f, 3) * (-var_fast_transient_outward_K_I__E_K + var_chaste_interface__cell__V) * var_chaste_interface__fast_transient_outward_K_I__ito_f; // picoA_per_picoF
        ...
        const double var_sodium_background_current__i_Nab = 0.0025999999999999999 * var_chaste_interface__cell__V - 0.0025999999999999999 * var_fast_sodium_current__E_Na; // picoA_per_picoF
        const double var_sodium_calcium_exchange_current__i_NCX = _lt_0_row[5] * (pow(var_chaste_interface__sodium_concentration__Nai, 3) * NV_Ith_S(mParameters, 1) * _lt_0_row[3] - pow(NV_Ith_S(mParameters, 3), 3) * var_calcium_concentration__Cai * _lt_0_row[4]) * NV_Ith_S(mParameters, 11) / (1400.0 * pow(var_chaste_interface__sodium_concentration__Nai, 3) + 681472000000000.0 * var_calcium_concentration__Cai + pow(NV_Ith_S(mParameters, 3), 3) * var_calcium_concentration__Cai + pow(var_chaste_interface__sodium_concentration__Nai, 3) * NV_Ith_S(mParameters, 1) + 1728000000000.0 * (1.0 + 0.27777777777777779 * var_calcium_concentration__Cai) * NV_Ith_S(mParameters, 1) + 3.6000000000000001 * pow(NV_Ith_S(mParameters, 3), 3) * (1.0 + 5.7870370370370368e-13 * pow(var_chaste_interface__sodium_concentration__Nai, 3))); // picoA_per_picoF
        ...
        const double d_dt_chaste_interface_var_non_inactivating_steady_state_K_I__aKss = _lt_0_row[34] * (-var_chaste_interface__non_inactivating_steady_state_K_I__aKss + var_ultra_rapidly_activating_delayed_rectifier_K_I__ass); // 1 / millisecond
        const double d_dt_chaste_interface_var_slow_transient_outward_K_I__ato_s = _lt_0_row[35] * (-var_chaste_interface__slow_transient_outward_K_I__ato_s + var_ultra_rapidly_activating_delayed_rectifier_K_I__ass); // 1 / millisecond
        const double var_ultra_rapidly_activating_delayed_rectifier_K_I__iss = _lt_0_row[36]; // dimensionless
        const double d_dt_chaste_interface_var_slow_transient_outward_K_I__ito_s = _lt_0_row[37] * (-var_chaste_interface__slow_transient_outward_K_I__ito_s + var_ultra_rapidly_activating_delayed_rectifier_K_I__iss); // 1 / millisecond
        const double var_ultra_rapidly_activating_delayed_rectifier_K_I__i_Kur = 0.25 * (-var_fast_transient_outward_K_I__E_K + var_chaste_interface__cell__V) * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__aur * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__iur; // picoA_per_picoF
        ...
        const double d_dt_chaste_interface_var_ultra_rapidly_activating_delayed_rectifier_K_I__aur = _lt_0_row[35] * (-var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__aur + var_ultra_rapidly_activating_delayed_rectifier_K_I__ass); // 1 / millisecond
        const double d_dt_chaste_interface_var_ultra_rapidly_activating_delayed_rectifier_K_I__iur = _lt_0_row[38] * (-var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__iur + var_ultra_rapidly_activating_delayed_rectifier_K_I__iss); // 1 / millisecond
...
const double var_x0 = -var_chaste_interface__calcium_concentration__Cass;
        ...
        const double var_x3 = var_x2 * NV_Ith_S(mParameters, 1);
        const double var_x4 = var_x0 + var_x3;
        const double var_x5 = 1.0 - var_x2;
        const double var_x6 = 1 / var_x5;
        const double var_x7 = 1 / NV_Ith_S(mParameters, 5);
        const double var_x8 = var_x7 * NV_Ith_S(mParameters, 4) * var_chaste_interface__L_type_calcium_current__y_gate;
        ...
        const double var_x16 = pow(var_chaste_interface__slow_delayed_rectifier_K_I__nKs, 2) * NV_Ith_S(mParameters, 10);
        const double var_x17 = var_chaste_interface__fast_sodium_current__O_Na * NV_Ith_S(mParameters, 6);
        const double var_x18 = var_chaste_interface__rapid_delayed_rectifier_K_I__O_K * NV_Ith_S(mParameters, 9);
        ...
        const double var_x22 = NV_Ith_S(mParameters, 8) * var_chaste_interface__non_inactivating_steady_state_K_I__iKss;
        ...
        const double var_x32 = var_x31 * NV_Ith_S(mParameters, 2);
        ...
        const double var_x36 = NV_Ith_S(mParameters, 7) / (210.0 + NV_Ith_S(mParameters, 2));
        const double var_x37 = var_x36 / var_x35;
        const double var_x38 = var_x37 * NV_Ith_S(mParameters, 2);
        const double var_x39 = _lt_0_row[3];
        const double var_x40 = pow(var_chaste_interface__sodium_concentration__Nai, 3);
        const double var_x41 = var_x40 * NV_Ith_S(mParameters, 1);
        const double var_x42 = var_x39 * var_x41;
        const double var_x43 = _lt_0_row[4];
        const double var_x44 = pow(NV_Ith_S(mParameters, 3), 3);
        ...
        const double var_x48 = (1.0 + 277.77777777777777 * var_chaste_interface__calcium_concentration__Cai_converted) * NV_Ith_S(mParameters, 1);
        const double var_x49 = var_x44 * (1.0 + 5.7870370370370368e-13 * var_x40);
        const double var_x50 = var_x28 * var_x44;
        const double var_x51 = NV_Ith_S(mParameters, 11) / (var_x41 + var_x50 + 1400.0 * var_x40 + 1728000000000.0 * var_x48 + 3.6000000000000001 * var_x49 + 6.81472e+17 * var_chaste_interface__calcium_concentration__Cai_converted);
        ...
        const double var_x57 = exp(1.4858841010401188e-5 * NV_Ith_S(mParameters, 3));
        const double var_x58 = _lt_0_row[6];
        const double var_x59 = 1.0 + 0.1245 * var_x56 + 0.036499999999999998 * var_x58 * (-0.14285714285714285 + 0.14285714285714285 * var_x57);
        const double var_x60 = NV_Ith_S(mParameters, 2) / (1500.0 + NV_Ith_S(mParameters, 2));
        ...
        const double var_x68 = var_x67 * NV_Ith_S(mParameters, 2);
        ...
        const double var_x78 = -6.81472e+17 - var_x76 - 480000000000000.0 * NV_Ith_S(mParameters, 1);
        const double var_x79 = var_x47 * var_x62 * NV_Ith_S(mParameters, 11) / pow((2.0543764087152516e-15 * var_x40 + 5.282682193839219e-18 * var_x49 + 2.535687453042825e-6 * var_x48 + 1.4674117205108941e-18 * var_x41 + 1.4674117205108941e-15 * var_x45 + var_chaste_interface__calcium_concentration__Cai_converted), 2);
        const double var_x80 = 2.1532971574927423e-36 * var_x79;
        ...
        const double var_x85 = 0.0023079445283571576 * var_x13 * var_x6;
        const double var_x86 = var_x0 + var_x81 * NV_Ith_S(mParameters, 1);
        const double var_x87 = var_x82 * var_x86;
        const double var_x88 = ((var_x14) ? (-var_x8 * var_x85) : (-var_x8 * var_x87));
        const double var_x89 = var_x7 * var_chaste_interface__L_type_calcium_current__O * NV_Ith_S(mParameters, 4);
        const double var_x90 = ((var_x14) ? (-var_x85 * var_x89) : (-var_x87 * var_x89));
        ...
        const double var_x96 = var_x95 * NV_Ith_S(mParameters, 1);
        ...
        const double var_x100 = -var_chaste_interface__cell__V;
        const double var_x101 = (var_x100 + 26.535875647668394 * log(var_x91 * (NV_Ith_S(mParameters, 3) + 0.1111111111111111 * NV_Ith_S(mParameters, 2)))) * NV_Ith_S(mParameters, 6);
        ...
        const double var_x110 = -var_x109 + 6.6339689119170986 * var_x33;
        const double var_x111 = var_x110 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__iur;
        const double var_x112 = var_x110 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__aur;
        const double var_x113 = var_x100 + var_x65;
        const double var_x114 = var_x113 * var_x22;
        const double var_x115 = var_x113 * var_chaste_interface__non_inactivating_steady_state_K_I__aKss * NV_Ith_S(mParameters, 8);
        const double var_x116 = (var_x100 + 26.535875647668394 * log(var_x92 * (NV_Ith_S(mParameters, 2) + 0.020408163265306124 * NV_Ith_S(mParameters, 3)))) * NV_Ith_S(mParameters, 9);
        const double var_x117 = var_x66 * NV_Ith_S(mParameters, 10) * var_chaste_interface__slow_delayed_rectifier_K_I__nKs;
        const double var_x118 = var_x66 * pow(var_chaste_interface__fast_transient_outward_K_I__ato_f, 2) * var_chaste_interface__fast_transient_outward_K_I__ito_f;
        ...
        const double var_x123 = var_x122 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x141 = pow(var_x130, 1.5830000000000002);
        const double var_x142 = pow(var_chaste_interface__calcium_concentration__Cass, (-2));
        const double var_x143 = var_x126 * var_x142 / pow(var_x127, 2);
        const double var_x144 = pow(var_x130, 4.1660000000000004) / pow((1 + 0.56848408867329814 * var_x131), 2);
        const double var_x145 = var_x136 * (-0.044315367702357472 * var_x143 * var_x144 + 0.13712534389890002 * var_x132 * var_x141 * var_x143);
        const double var_x146 = ((var_x139) ? (3.0000000000000001e-5) : (0.10000000000000001));
        const double var_x147 = 2.5830000000000002 - 0.12915000000000001 * var_x128;
        const double var_x148 = var_x136 * (-0.49018713237495126 * var_x144 * var_x147 + var_x133 * var_x141 * var_x147);
        ...
        const double var_x152 = 32.656617993405561 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x155 = var_chaste_interface__calcium_fluxes__P_RyR * NV_Ith_S(mParameters, 0);
        ...
        const double var_x163 = 3.5000000000000004 * var_x151;
        const double var_x164 = ((var_x139) ? (var_x157 * var_x158 * NV_Ith_S(mParameters, 0)) : (0));
        const double var_x165 = ((var_x139) ? (var_x155 * var_x157) : (0));
        ...
        const double var_x171 = 95238095.238095239 * var_x70;
        const double var_x172 = 0.20000000000000001 * var_chaste_interface__cell__V;
        const double var_x173 = 0.2857142857142857 * exp(-0.038580246913580245 * pow((-1 + var_x172), 2));
        ...
        const double var_x176 = 0.012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2.0) * var_chaste_interface__ryanodine_receptors__P_O1;
        ...
        const double var_x179 = _lt_0_row[8];
        const double var_x180 = 1.0 + var_x179;
        const double var_x181 = 1 / var_x180;
        const double var_x182 = var_x179 * var_x181;
        const double var_x183 = 1.0 - var_chaste_interface__L_type_calcium_current__I - var_chaste_interface__L_type_calcium_current__O;
        const double var_x184 = 0.10337680327911219 * var_x183;
        const double var_x185 = pow(var_x180, (-2));
        const double var_x186 = -0.66666666666666663 * var_x182;
        const double var_x187 = 1 / (0.0625 + 0.40000000000000002 * var_x179);
        const double var_x188 = var_x179 * var_chaste_interface__L_type_calcium_current__I;
        const double var_x189 = 0.0625 + var_x179;
        const double var_x190 = 0.00044946436208309653 * var_chaste_interface__calcium_concentration__Cass;
        ...
        const double var_x198 = exp(6.666666666666667 - 0.16666666666666666 * var_chaste_interface__cell__V);
        const double var_x199 = 1.0 + var_x198;
        const double var_x200 = exp(4.024390243902439 + 0.12195121951219513 * var_chaste_interface__cell__V);
        const double var_x201 = 1.0 + var_x200;
        const double var_x202 = 4.2191641619115923e-37 * var_x79;
        const double var_x203 = 0.065313235986811116 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x206 = 0.01083743842364532 * var_x205 * var_chaste_interface__fast_sodium_current__O_Na;
        ...
        const double var_x209 = (0.0085583333333333327 * var_x207 + 0.0016666666666666668 * var_x208) / pow((var_x208 + 0.4108 * var_x207), 2);
        const double var_x210 = 60.832000000000001 * var_x209 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x211 = exp(-0.42168674698795178 - 0.060240963855421679 * var_chaste_interface__cell__V);
        const double var_x212 = var_x211 / pow((1 + 0.47846713846216332 * var_x211), 2);
        const double var_x213 = 0.073163809141391992 * var_x212 * var_chaste_interface__fast_sodium_current__O_Na;
        ...
        const double var_x223 = 9.7514961527500711e-7 * var_x222 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x224 = 3.317429681310359e-6 * var_x221 * var_chaste_interface__fast_sodium_current__IF_Na / pow((1 + 0.0023419203747072604 * var_chaste_interface__cell__V), 2);
        const double var_x225 = var_x212 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x226 = var_x216 * var_x219 * var_x220;
        const double var_x227 = 8.8508255294954831e-7 * var_x218 * var_x225 * var_x226;
        const double var_x228 = 0.00019355636363636362 * var_x209 * var_x217 * var_x226 * var_chaste_interface__fast_sodium_current__IF_Na;
        ...
        const double var_x233 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x234 = -var_x233;
        const double var_x235 = exp(0.12315270935960591 + var_x204);
        const double var_x236 = 0.009852216748768473 * var_x235;
        const double var_x237 = var_x236 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x238 = 9.0909090909090901e-8 * var_x219;
        const double var_x239 = var_x238 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x240 = exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__cell__V);
        const double var_x241 = 71.871455576559541 * (0.0068466666666666667 * var_x240 + 0.0015333333333333334 * var_x208) / pow((var_x208 + 0.44652173913043475 * var_x240), 2);
        const double var_x242 = var_x241 * var_chaste_interface__fast_sodium_current__C_Na2;
        ...
        const double var_x248 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x249 = -var_x248;
        const double var_x250 = exp(-0.12315270935960591 + var_x204);
        const double var_x251 = 0.0094433497536945809 * var_x250;
        const double var_x252 = var_x238 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x253 = exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__cell__V);
        const double var_x254 = 95.049999999999997 * (0.0013333333333333335 * var_x208 + 0.0060411764705882356 * var_x253) / pow((var_x208 + 0.51349999999999996 * var_x253), 2);
        ...
        const double var_x260 = var_x238 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x261 = 1.818181818181818e-9 * var_x219 * var_chaste_interface__fast_sodium_current__I2_Na;
        const double var_x262 = 7.3163809141391995e-5 * var_x225;
        const double var_x263 = 7.7014535938307356e-7 * var_x212 * var_chaste_interface__fast_sodium_current__I1_Na;
        ...
        const double var_x268 = var_x236 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x269 = var_x241 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x270 = var_x251 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x271 = var_x254 * var_chaste_interface__fast_sodium_current__IC_Na3;
        const double var_x272 = exp(-0.64479166666666676 - 0.10416666666666667 * var_chaste_interface__cell__V);
        ...
        const double var_x276 = 0.0073216139155926159 * var_x275 / pow((1 + 0.23955296404275997 * var_x275), 2);
        const double var_x277 = 1 / (2.0579999999999998 + 0.49299999999999999 * var_x275);
        const double var_x278 = 0.10416666666666667 * var_x272 / pow(var_x273, 2);
        ...
        const double var_x285 = var_x281 / pow(var_x282, 2);
        const double var_x286 = 0.18518518518518517 * var_x285;
        ...
        const double var_x291 = 0.00036515000000000001 * var_x290 * var_chaste_interface__rapid_delayed_rectifier_K_I__C_K2;
        const double var_x292 = exp(-0.041779999999999998 * var_chaste_interface__cell__V);
        const double var_x293 = 2.8786419999999997e-6 * var_x292 * var_chaste_interface__rapid_delayed_rectifier_K_I__O_K;
        const double var_x294 = exp(0.14349999999999999 + 0.0287 * var_chaste_interface__cell__V);
        const double var_x295 = 0.00201761 * var_x294 * var_chaste_interface__rapid_delayed_rectifier_K_I__O_K;
        const double var_x296 = exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__cell__V);
        const double var_x297 = 0.00021232196 * var_x296 * var_chaste_interface__rapid_delayed_rectifier_K_I__I_K;
        ...
        const double var_x302 = _lt_0_row[29];
        const double var_x303 = _lt_0_row[30];
        const double var_x304 = -0.022348 * var_x302;
        const double var_x305 = 1.0 - var_chaste_interface__slow_delayed_rectifier_K_I__nKs;
        ...
        const double var_x309 = _lt_0_row[31];
        const double var_x310 = 26.5 + var_chaste_interface__cell__V;
        const double var_x311 = _lt_0_row[21];
        const double var_x312 = _lt_0_row[22];
        ...
        const double var_x317 = var_x313 / pow(var_x314, 2);
        ...
        IJth(rJacobian, 10, 0) = var_x182 * var_x184 - var_x184 * var_x185 * pow(var_x179, 2);
        IJth(rJacobian, 11, 0) = -5.3935723449971585e-5 * var_x187 * var_x188 + var_x182 * var_x183 * var_x190 + 0.00013483930862492896 * var_x188 * var_x189 / pow((0.15625 + var_x179), 2) - var_x179 * var_x185 * var_x190 * var_x191;
        IJth(rJacobian, 12, 0) = var_x197 * (0.016666666666666666 * var_x198 / pow(var_x199, 2) - 0.12195121951219513 * var_x200 / pow(var_x201, 2)) + 0.00079365079365079365 * var_x194 * (-var_chaste_interface__L_type_calcium_current__y_gate + 1 / var_x201 + 0.10000000000000001 / var_x199) / (pow(var_x195, 2) * pow((0.025396825396825397 + var_x196), 2));
        IJth(rJacobian, 13, 0) = (-0.0001698144135657089 - 0.065313235986811116 * var_x17 - 0.0012958840779794486 * var_x63 - 0.48710611398963738 * var_x61 - 0.19593970796043336 * var_x53) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 14, 0) = var_x206 + var_x210 + var_x227 + var_x228 - var_x213 - var_x223 - var_x224;
        IJth(rJacobian, 15, 0) = var_x234 + var_x237 + var_x242 - var_x206 - var_x210 - var_x239;
        IJth(rJacobian, 16, 0) = var_x249 - var_x237 - var_x242 - var_x252 + var_x251 * var_chaste_interface__fast_sodium_current__C_Na2 + var_x254 * (1.0 - var_chaste_interface__fast_sodium_current__C_Na1 - var_chaste_interface__fast_sodium_current__C_Na2 - var_chaste_interface__fast_sodium_current__I1_Na - var_chaste_interface__fast_sodium_current__I2_Na - var_chaste_interface__fast_sodium_current__IC_Na2 - var_chaste_interface__fast_sodium_current__IC_Na3 - var_chaste_interface__fast_sodium_current__IF_Na - var_chaste_interface__fast_sodium_current__O_Na);
        IJth(rJacobian, 17, 0) = var_x260 + var_x262 - var_x261 - var_x263;
        IJth(rJacobian, 18, 0) = var_x261 + var_x263;
        IJth(rJacobian, 19, 0) = var_x213 + var_x223 + var_x224 + var_x233 + var_x239 + var_x268 + var_x269 - var_x227 - var_x228 - var_x260 - var_x262;
        IJth(rJacobian, 20, 0) = var_x248 + var_x252 + var_x270 + var_x271 - var_x268 - var_x269;
        IJth(rJacobian, 21, 0) = 2.0000000000000002e-5 + var_x234 + var_x249 - var_x270 - var_x271 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I1_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I2_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na2 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na3 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IF_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__O_Na + var_x238 * var_chaste_interface__fast_sodium_current__IC_Na3;
        IJth(rJacobian, 22, 0) = (0.0058520659444182763 * var_x68 + 0.32473740932642492 * var_x61 - 0.016328308996702779 * var_x19 - 0.065313235986811116 * var_x16 - 0.065313235986811116 * var_x18 - 0.065313235986811116 * var_x23 - 0.065313235986811116 * var_x38 - 0.034922987282147905 * var_x102) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 23, 0) = var_x279 + var_x276 * (var_x274 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__aur);
        IJth(rJacobian, 24, 0) = -var_x284 * var_x286 + 0.00018518518518518518 * var_x285 * (var_x287 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__iur) / pow((0.64300000000000002 + var_x283), 2);
        IJth(rJacobian, 25, 0) = var_x278 * var_x289 + 0.0012722646310432571 * var_x288 * (var_x274 - var_chaste_interface__non_inactivating_steady_state_K_I__aKss) / pow((0.33511450381679392 + var_x288), 2);
        IJth(rJacobian, 27, 0) = var_x291 + var_x293 - var_x295 - var_x297;
        IJth(rJacobian, 28, 0) = 0.01176 * var_x302 * (0.022348 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_K_I__C_K1 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_K_I__C_K2 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_K_I__I_K - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_K_I__O_K) + 0.0029658262000000005 * var_x303 * var_chaste_interface__rapid_delayed_rectifier_K_I__C_K1;
        IJth(rJacobian, 29, 0) = -var_x291 - var_x293;
        IJth(rJacobian, 30, 0) = var_x295 + var_x297;
        IJth(rJacobian, 31, 0) = var_x305 * var_x308 + 3.6226653999999999e-6 * var_x309 * var_chaste_interface__slow_delayed_rectifier_K_I__nKs - 6.1610624e-7 * var_x305 * var_x306 * var_x310 / pow(var_x307, 2);
        IJth(rJacobian, 32, 0) = 0.035770000000000003 * var_x311 * (0.18064 - 0.18064 * var_chaste_interface__fast_transient_outward_K_I__ato_f) + 0.024673572000000001 * var_x312 * var_chaste_interface__fast_transient_outward_K_I__ato_f;
        IJth(rJacobian, 33, 0) = -0.20000000000000001 * var_x316 * var_x317 + 0.018287887931822754 * var_x317 * (-var_chaste_interface__fast_transient_outward_K_I__ito_f + var_x315) / pow((0.88371646458550512 + var_x315), 2);
        IJth(rJacobian, 34, 0) = var_x279 + var_x276 * (var_x274 - var_chaste_interface__slow_transient_outward_K_I__ato_s);
        IJth(rJacobian, 35, 0) = -var_x286 * var_x321 + 0.00016708437761069341 * var_x318 * (var_x287 - var_chaste_interface__slow_transient_outward_K_I__ito_s) / (pow(var_x319, 2) * pow((0.25714285714285712 + var_x320), 2));
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.191 * var_x72 - 0.0092875564766839377 * var_x69 - 191000.0 * var_x75 + var_x76 * var_x77 - var_x78 * var_x80 - var_x26 * var_x30 * var_x64 + 2.0 * var_x27 * var_x64 / pow((0.01 + var_chaste_interface__calcium_concentration__Cai_converted), 2));
        IJth(rJacobian, 1, 1) = var_x122 * (-125.0 + var_x140 + 2.0 * var_x135 - 2000000.0 * var_x138 + (0.0062374140367404624 * var_x72 - 6237.4140367404616 * var_x75 - 65.313235986811122 * var_x125 - 0.00030330018395124703 * var_x69 + var_x124 * var_x78) * NV_Ith_S(mParameters, 5)) + 1.3080000000000001e-7 * (0.125 * var_chaste_interface__calcium_concentration__Cass - 125.0 * var_chaste_interface__calcium_concentration__Cai_converted - var_x137 * var_x73 - 0.032656617993405558 * (0.00069999999999999999 * var_chaste_interface__cell__V - 0.0092875564766839377 * log(0.001 * var_x69 * NV_Ith_S(mParameters, 1)) + 95500.0 * var_x70 * var_x74 - 2.0 * var_x52 * var_x62) * NV_Ith_S(mParameters, 5) + ((var_x139) ? (3.0000000000000001e-5 * var_chaste_interface__calcium_concentration__CaNSR - 0.029999999999999999 * var_chaste_interface__calcium_concentration__Cai_converted) : (0.10000000000000001 * var_chaste_interface__calcium_concentration__CaNSR - 100.0 * var_chaste_interface__calcium_concentration__Cai_converted))) / (pow(var_x119, 3) * pow(var_x120, 2));
        IJth(rJacobian, 2, 1) = 125000.0 * var_x151;
        IJth(rJacobian, 4, 1) = 190476190.47619048 * var_x138 - 95.238095238095241 * var_x140 - 190.47619047619048 * var_x135;
        IJth(rJacobian, 13, 1) = (195.93970796043337 * var_x125 - var_x202 * var_x78) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x84);
        IJth(rJacobian, 1, 2) = var_x122 * (0.125 - var_x145 * var_x73);
        IJth(rJacobian, 2, 2) = var_x151 * (-125.0 + 3.5000000000000004 * var_x156 - var_x152 * var_x84) + 0.030581039755351685 * (125000.0 * var_chaste_interface__calcium_concentration__Cai_converted + 3.5000000000000004 * var_x160 - 125.0 * var_chaste_interface__calcium_concentration__Cass - var_x152 * var_x161) / (pow(var_x149, 3) * pow((0.015290519877675841 + var_x150), 2));
        IJth(rJacobian, 3, 2) = -var_x156 * var_x169;
        IJth(rJacobian, 4, 2) = var_x145 * var_x171;
        IJth(rJacobian, 5, 2) = -var_x173 * var_x84;
        IJth(rJacobian, 6, 2) = 0.00175 * var_x130 * var_x143 + 8.7500000000000013e-5 * var_x142 * pow(var_x126, 2) / pow(var_x127, 3);
        IJth(rJacobian, 7, 2) = -var_x176 + 0.024299999999999999 * var_x175 * (1.0 + var_x154 - var_chaste_interface__ryanodine_receptors__P_C2);
        IJth(rJacobian, 8, 2) = var_x176;
        IJth(rJacobian, 11, 2) = var_x191 * var_x192;
        IJth(rJacobian, 2, 3) = var_x162 * var_x163;
        IJth(rJacobian, 3, 3) = var_x169 * (-0.050000000000000003 - var_x162) + 4.0000000000000003e-5 * (-var_x160 + 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR) / (pow(var_x167, 3) * pow((0.0126 + var_x168), 2));
        IJth(rJacobian, 4, 3) = 0.016666666666666666;
        IJth(rJacobian, 1, 4) = var_x122 * var_x146;
        IJth(rJacobian, 3, 4) = 0.050000000000000003 * var_x169;
        IJth(rJacobian, 4, 4) = -0.016666666666666666 - 95.238095238095241 * var_x146;
        IJth(rJacobian, 2, 5) = var_x163 * var_x164;
        IJth(rJacobian, 3, 5) = -var_x164 * var_x169;
        IJth(rJacobian, 5, 5) = -0.01;
        IJth(rJacobian, 1, 6) = -1000.0 * var_x121 * var_x148 * var_x70;
        IJth(rJacobian, 4, 6) = var_x148 * var_x171;
        IJth(rJacobian, 6, 6) = -0.00020000000000000001 - var_x130 * var_x174 + var_x126 * var_x174 * (1 - var_x129);
        IJth(rJacobian, 2, 7) = var_x166;
        IJth(rJacobian, 3, 7) = var_x170;
        IJth(rJacobian, 7, 7) = -0.080249999999999988 + var_x178 - var_x177;
        IJth(rJacobian, 8, 7) = var_x177;
        IJth(rJacobian, 9, 7) = 0.0089999999999999993;
        IJth(rJacobian, 2, 8) = var_x166;
        IJth(rJacobian, 3, 8) = var_x170;
        IJth(rJacobian, 7, 8) = 0.96499999999999997 + var_x178;
        IJth(rJacobian, 8, 8) = -0.96499999999999997;
        IJth(rJacobian, 7, 9) = 0.00080000000000000004 + var_x178;
        IJth(rJacobian, 9, 9) = -0.00080000000000000004;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x88);
        IJth(rJacobian, 2, 10) = -var_x153 * var_x88;
        IJth(rJacobian, 5, 10) = -var_x173 * var_x88;
        IJth(rJacobian, 10, 10) = -1.1986666666666668 + var_x186;
        IJth(rJacobian, 11, 10) = var_x193;
        IJth(rJacobian, 10, 11) = var_x186;
        IJth(rJacobian, 11, 11) = var_x193 - 0.00034782608695652176 * var_x187 * var_x189;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x90);
        IJth(rJacobian, 2, 12) = -var_x153 * var_x90;
        IJth(rJacobian, 5, 12) = -var_x173 * var_x90;
        IJth(rJacobian, 12, 12) = -var_x197;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x98 - 4.4407155437233767e-10 * var_x99 - 0.54154848260547739 * var_x93 - 0.068993276683937815 * var_x91 - 26.535875647668394 * var_x94 - var_x80 * var_x97);
        IJth(rJacobian, 1, 13) = var_x123 * (0.19593970796043336 * var_x98 + var_x124 * var_x97);
        IJth(rJacobian, 13, 13) = (-1.7331439082928402 * var_x94 - 0.004506174161561384 * var_x91 - 0.58781912388130009 * var_x98 - 8.7011250677251544e-11 * var_x99 - var_x202 * var_x97) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 22, 13) = (5.8007500451501034e-11 * var_x99 - 0.035370283842711021 * var_x93) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x101);
        IJth(rJacobian, 13, 14) = var_x101 * var_x203;
        IJth(rJacobian, 14, 14) = -var_x229 - var_x230;
        IJth(rJacobian, 15, 14) = var_x230;
        IJth(rJacobian, 16, 14) = var_x256;
        IJth(rJacobian, 19, 14) = var_x229;
        IJth(rJacobian, 21, 14) = var_x245;
        IJth(rJacobian, 14, 15) = var_x231;
        IJth(rJacobian, 15, 15) = var_x244 + var_x245 - var_x231;
        IJth(rJacobian, 16, 15) = var_x243 + var_x256;
        IJth(rJacobian, 19, 15) = var_x215;
        IJth(rJacobian, 21, 15) = var_x245;
        IJth(rJacobian, 15, 16) = var_x246;
        IJth(rJacobian, 16, 16) = var_x258 + var_x259;
        IJth(rJacobian, 20, 16) = var_x215;
        IJth(rJacobian, 21, 16) = var_x245;
        IJth(rJacobian, 16, 17) = var_x256;
        IJth(rJacobian, 17, 17) = var_x264 - var_x265;
        IJth(rJacobian, 18, 17) = var_x265;
        IJth(rJacobian, 19, 17) = var_x247;
        IJth(rJacobian, 21, 17) = var_x245;
        IJth(rJacobian, 16, 18) = var_x256;
        IJth(rJacobian, 17, 18) = var_x266;
        IJth(rJacobian, 18, 18) = -var_x266;
        IJth(rJacobian, 21, 18) = var_x245;
        IJth(rJacobian, 14, 19) = var_x232;
        IJth(rJacobian, 15, 19) = var_x247;
        IJth(rJacobian, 16, 19) = var_x256;
        IJth(rJacobian, 17, 19) = var_x267;
        IJth(rJacobian, 19, 19) = var_x244 + var_x264 - var_x232 - var_x267;
        IJth(rJacobian, 20, 19) = var_x243;
        IJth(rJacobian, 21, 19) = var_x245;
        IJth(rJacobian, 16, 20) = var_x247 + var_x256;
        IJth(rJacobian, 19, 20) = var_x246;
        IJth(rJacobian, 20, 20) = var_x258 + var_x264;
        IJth(rJacobian, 21, 20) = var_x245 + var_x257;
        IJth(rJacobian, 16, 21) = var_x256;
        IJth(rJacobian, 20, 21) = var_x255;
        IJth(rJacobian, 21, 21) = var_x259 + var_x264;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (2.3776144580310881 * var_x108 - 2.9484306275187104 * var_x94 - 14.188732708808288 * var_x103 - 6.6339689119170986 * var_x104 - 26.535875647668394 * var_x105 - 26.535875647668394 * var_x106 - 26.535875647668394 * var_x107 - 26.535875647668394 * var_x93 - 0.0076659196315486469 * var_x91);
        IJth(rJacobian, 13, 22) = (-0.0005006860179512649 * var_x91 - 0.19257154536587112 * var_x94) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 22, 22) = (0.15528969418303848 * var_x108 - 0.43328597707321004 * var_x104 - 1.7331439082928402 * var_x105 - 1.7331439082928402 * var_x106 - 1.7331439082928402 * var_x107 - 1.7331439082928402 * var_x93 - 0.92671204776418159 * var_x103) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (var_x111);
        IJth(rJacobian, 22, 23) = var_x111 * var_x203;
        IJth(rJacobian, 23, 23) = var_x280;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (var_x112);
        IJth(rJacobian, 22, 24) = var_x112 * var_x203;
        IJth(rJacobian, 24, 24) = -var_x284;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (var_x114);
        IJth(rJacobian, 22, 25) = var_x114 * var_x203;
        IJth(rJacobian, 25, 25) = -var_x289;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (var_x115);
        IJth(rJacobian, 22, 26) = var_x115 * var_x203;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (var_x116);
        IJth(rJacobian, 22, 27) = var_x116 * var_x203;
        IJth(rJacobian, 27, 27) = -var_x298 - var_x299;
        IJth(rJacobian, 28, 27) = var_x304;
        IJth(rJacobian, 29, 27) = var_x298;
        IJth(rJacobian, 30, 27) = var_x299;
        IJth(rJacobian, 28, 28) = -0.023761000000000001 + var_x304 - 0.047002000000000002 * var_x303;
        IJth(rJacobian, 29, 28) = 0.023761000000000001;
        IJth(rJacobian, 27, 29) = var_x300;
        IJth(rJacobian, 28, 29) = 0.036777999999999998 + var_x304;
        IJth(rJacobian, 29, 29) = -0.036777999999999998 - var_x300;
        IJth(rJacobian, 27, 30) = var_x301;
        IJth(rJacobian, 28, 30) = var_x304;
        IJth(rJacobian, 30, 30) = -var_x301;
        IJth(rJacobian, 0, 31) = mSetVoltageDerivativeToZero ? 0.0 : (-2 * var_x117);
        IJth(rJacobian, 22, 31) = -0.13062647197362223 * var_x117 * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 31, 31) = -9.5333299999999997e-5 * var_x309 - var_x308 * var_x310;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-1.6040999999999999 * var_x118);
        IJth(rJacobian, 22, 32) = -0.10476896184644371 * var_x118 * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 32, 32) = -0.18064 * var_x311 - 0.39560000000000001 * var_x312;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x21 * var_x66);
        IJth(rJacobian, 22, 33) = -0.034922987282147905 * var_x20 * var_x66 * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 33, 33) = -var_x316;
        IJth(rJacobian, 34, 34) = var_x280;
        IJth(rJacobian, 35, 35) = -var_x321;
    }
