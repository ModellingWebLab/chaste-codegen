...
const double var_x0 = exp(9.9999999999999995e-8);
        ...
        const double var_x96 = var_x4 * var_x91;
        const double var_x97 = 0.0023079445283571576 * var_x19;
        const double var_x98 = ((var_x14) ? (var_x96 + var_x90 * (-var_x96 - var_x12 * var_x91)) : (-var_x23 * var_x97));
        const double var_x99 = var_x6 * NV_Ith_S(mParameters, 4);
        const double var_x100 = 3.0621664503101105e-9 * var_x99;
        const double var_x101 = var_x100 * var_x5;
        const double var_x102 = ((var_x14) ? (var_x101 + var_x90 * (-var_x101 - var_x100 * var_x13)) : (-var_x17 * var_x97 * var_x99 * var_chaste_interface__L_type_calcium_current__O * var_chaste_interface__cell__V));
        ...
        IJth(rJacobian, 31, 0) = ((var_x324) ? (var_x322 + var_x318 * (2.4066649945278773e-6 * var_x319 + 2.4066650054721224e-6 * var_x320)) : (var_x322 + var_x318 * var_x327 - 6.1610624e-7 * var_x318 * var_x323 * var_x325 / pow(var_x326, 2)));
        ...
        IJth(rJacobian, 31, 31) = ((var_x324) ? (var_x328 + var_x329 - 640000.00016065314 * (26.500000781250002 + var_chaste_interface__cell__V) * (var_x328 + 3.760414053005867e-12 * var_x319)) : (var_x329 - var_x323 * var_x327));
