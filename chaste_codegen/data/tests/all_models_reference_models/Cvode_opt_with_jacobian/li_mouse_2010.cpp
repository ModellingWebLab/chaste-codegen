...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellli_mouse_2010FromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
const double var_x0 = pow(var_chaste_interface__slow_delayed_rectifier_K_I__nKs, 2) * NV_Ith_S(mParameters, 10);
        const double var_x1 = var_chaste_interface__fast_sodium_current__O_Na * NV_Ith_S(mParameters, 6);
        const double var_x2 = var_chaste_interface__rapid_delayed_rectifier_K_I__O_K * NV_Ith_S(mParameters, 9);
        const double var_x3 = var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__aur * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__iur;
        const double var_x4 = pow(var_chaste_interface__fast_transient_outward_K_I__ato_f, 3);
        const double var_x5 = 0.53469999999999995 * var_x4;
        const double var_x6 = NV_Ith_S(mParameters, 8) * var_chaste_interface__non_inactivating_steady_state_K_I__iKss;
        const double var_x7 = var_x6 * var_chaste_interface__non_inactivating_steady_state_K_I__aKss;
        const double var_x8 = exp(5.9871794871794881 - 0.12820512820512822 * var_chaste_interface__cell__V);
        const double var_x9 = 1.0 + var_x8;
        const double var_x10 = 1 / var_x9;
        const double var_x11 = var_x10 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x12 = 1000.0 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x13 = 1 / (10.0 + var_x12);
        const double var_x14 = 2000.0 * var_x13;
        const double var_x15 = 1 / var_chaste_interface__potassium_concentration__Ki;
        const double var_x16 = var_x15 * NV_Ith_S(mParameters, 2);
        const double var_x17 = log(var_x16);
        const double var_x18 = exp(0.089599999999999999 * var_chaste_interface__cell__V - 2.3776144580310881 * var_x17);
        const double var_x19 = 1.0 + var_x18;
        const double var_x20 = NV_Ith_S(mParameters, 7) / (210.0 + NV_Ith_S(mParameters, 2));
        const double var_x21 = var_x20 / var_x19;
        const double var_x22 = var_x21 * NV_Ith_S(mParameters, 2);
        const double var_x23 = _lt_0_row[3];
        const double var_x24 = pow(var_chaste_interface__sodium_concentration__Nai, 3);
        const double var_x25 = var_x24 * NV_Ith_S(mParameters, 1);
        const double var_x26 = var_x23 * var_x25;
        const double var_x27 = _lt_0_row[4];
        const double var_x28 = pow(NV_Ith_S(mParameters, 3), 3);
        const double var_x29 = var_x28 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x30 = 1.0 + 0.27000000000000002 * var_x27;
        const double var_x31 = 1 / var_x30;
        const double var_x32 = (1.0 + 277.77777777777777 * var_chaste_interface__calcium_concentration__Cai_converted) * NV_Ith_S(mParameters, 1);
        const double var_x33 = var_x28 * (1.0 + 5.7870370370370368e-13 * var_x24);
        const double var_x34 = var_x12 * var_x28;
        const double var_x35 = NV_Ith_S(mParameters, 11) / (var_x25 + var_x34 + 1400.0 * var_x24 + 1728000000000.0 * var_x32 + 3.6000000000000001 * var_x33 + 6.81472e+17 * var_chaste_interface__calcium_concentration__Cai_converted);
        const double var_x36 = var_x31 * var_x35;
        const double var_x37 = var_x36 * (0.013189690992192795 * var_x26 + 24.495140414072335 * var_x27 * var_x29);
        const double var_x38 = 1 / var_chaste_interface__sodium_concentration__Nai;
        const double var_x39 = pow(var_x38, 2.3999999999999999);
        const double var_x40 = exp(-0.0037684831406265135 * var_chaste_interface__cell__V);
        const double var_x41 = exp(1.4858841010401188e-5 * NV_Ith_S(mParameters, 3));
        const double var_x42 = _lt_0_row[6];
        const double var_x43 = 1.0 + 0.1245 * var_x40 + 0.036499999999999998 * var_x42 * (-0.14285714285714285 + 0.14285714285714285 * var_x41);
        const double var_x44 = NV_Ith_S(mParameters, 2) / (1500.0 + NV_Ith_S(mParameters, 2));
        const double var_x45 = var_x44 * (0.00046917615100800094 * var_x40 + 0.037684831406265135 * var_x42 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x41)) / (pow(var_x43, 2) * (1.0 + 13435672565.051065 * var_x39));
        const double var_x46 = var_x26 - var_x27 * var_x34;
        const double var_x47 = var_x27 * var_x35 * var_x46 / pow(var_x30, 2);
        const double var_x48 = 40.0 + var_chaste_interface__cell__V;
        const double var_x49 = 26.535875647668394 * var_x17;
        const double var_x50 = -var_x49 + var_chaste_interface__cell__V;
        const double var_x51 = var_x18 * var_x20 * var_x50 / pow(var_x19, 2);
        const double var_x52 = var_x51 * NV_Ith_S(mParameters, 2);
        const double var_x53 = -var_chaste_interface__calcium_concentration__Cass;
        const double var_x54 = _lt_0_row[1];
        const double var_x55 = var_x54 * NV_Ith_S(mParameters, 1);
        const double var_x56 = var_x53 + var_x55;
        const double var_x57 = 1 / NV_Ith_S(mParameters, 5);
        const double var_x58 = 1.0 - var_x54;
        const double var_x59 = 1 / var_x58;
        const double var_x60 = var_x59 * var_chaste_interface__L_type_calcium_current__O * NV_Ith_S(mParameters, 4) * var_chaste_interface__L_type_calcium_current__y_gate;
        const double var_x61 = var_x57 * var_x60;
        const double var_x62 = 0.0023079445283571576 * var_x61;
        const double var_x63 = var_x55 * var_chaste_interface__cell__V;
        const double var_x64 = var_x61 * var_x63;
        const double var_x65 = var_x56 * var_chaste_interface__cell__V;
        const double var_x66 = var_x54 * var_x65 * var_chaste_interface__L_type_calcium_current__O * NV_Ith_S(mParameters, 4) * var_chaste_interface__L_type_calcium_current__y_gate / pow(var_x58, 2);
        const double var_x67 = var_x57 * var_x66;
        const double var_x68 = 1 / var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x69 = pow(var_chaste_interface__calcium_concentration__Cai_converted, 2);
        const double var_x70 = pow(var_chaste_interface__calcium_concentration__Cai_converted, 3);
        const double var_x71 = var_x70 / pow((8.3232249999999994e-8 + var_x69), 2);
        const double var_x72 = 1000000.0 * var_x69;
        const double var_x73 = 1 / (0.083232249999999994 + var_x72);
        const double var_x74 = var_x73 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x75 = 1000.0 * var_x28;
        const double var_x76 = var_x27 * var_x36;
        const double var_x77 = -6.81472e+17 - var_x75 - 480000000000000.0 * NV_Ith_S(mParameters, 1);
        const double var_x78 = var_x31 * var_x46 * NV_Ith_S(mParameters, 11) / pow((2.0543764087152516e-15 * var_x24 + 5.282682193839219e-18 * var_x33 + 2.535687453042825e-6 * var_x32 + 1.4674117205108941e-18 * var_x25 + 1.4674117205108941e-15 * var_x29 + var_chaste_interface__calcium_concentration__Cai_converted), 2);
        const double var_x79 = 2.1532971574927423e-36 * var_x78;
        const double var_x80 = var_x59 * var_x65 * NV_Ith_S(mParameters, 4);
        const double var_x81 = var_x80 * var_chaste_interface__L_type_calcium_current__y_gate;
        const double var_x82 = 0.0023079445283571576 * var_x57;
        const double var_x83 = var_x80 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x84 = 1 / (var_chaste_interface__sodium_concentration__Nai + 0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki);
        const double var_x85 = 1 / (var_chaste_interface__potassium_concentration__Ki + 0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai);
        const double var_x86 = var_x2 * var_x85;
        const double var_x87 = var_x1 * var_x84;
        const double var_x88 = pow(var_chaste_interface__sodium_concentration__Nai, 2);
        const double var_x89 = var_x88 * NV_Ith_S(mParameters, 1);
        const double var_x90 = -3 * var_x89 - 4200.0 * var_x88 - 6.2500000000000002e-12 * var_x28 * var_x88;
        const double var_x91 = var_x23 * var_x36 * var_x89;
        const double var_x92 = var_x38 * var_x39 * var_x44 / (var_x43 * pow((7.44287265976699e-11 + var_x39), 2));
        const double var_x93 = -var_chaste_interface__cell__V;
        const double var_x94 = (var_x93 + 26.535875647668394 * log(var_x84 * (NV_Ith_S(mParameters, 3) + 0.1111111111111111 * NV_Ith_S(mParameters, 2)))) * NV_Ith_S(mParameters, 6);
        const double var_x95 = var_x4 * var_chaste_interface__fast_transient_outward_K_I__ito_f;
        const double var_x96 = var_x15 * var_x95;
        const double var_x97 = var_x15 * var_x3;
        const double var_x98 = var_x0 * var_x15;
        const double var_x99 = var_x15 * var_x7;
        const double var_x100 = var_x16 * var_x21;
        const double var_x101 = var_x16 * var_x51;
        const double var_x102 = 0.25 * var_chaste_interface__cell__V;
        const double var_x103 = -var_x102 + 6.6339689119170986 * var_x17;
        const double var_x104 = var_x103 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__iur;
        const double var_x105 = var_x103 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__aur;
        const double var_x106 = var_x49 + var_x93;
        const double var_x107 = var_x106 * var_x6;
        const double var_x108 = var_x106 * var_chaste_interface__non_inactivating_steady_state_K_I__aKss * NV_Ith_S(mParameters, 8);
        const double var_x109 = (var_x93 + 26.535875647668394 * log(var_x85 * (NV_Ith_S(mParameters, 2) + 0.020408163265306124 * NV_Ith_S(mParameters, 3)))) * NV_Ith_S(mParameters, 9);
        const double var_x110 = var_x50 * NV_Ith_S(mParameters, 10) * var_chaste_interface__slow_delayed_rectifier_K_I__nKs;
        const double var_x111 = var_x50 * pow(var_chaste_interface__fast_transient_outward_K_I__ato_f, 2) * var_chaste_interface__fast_transient_outward_K_I__ito_f;
        const double var_x112 = 0.00059999999999999995 + var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x113 = 1.0 + 6.5400000000000004e-5 / pow(var_x112, 2);
        const double var_x114 = 1 / var_x113;
        const double var_x115 = 0.001 * var_x114;
        const double var_x116 = var_x115 * NV_Ith_S(mParameters, 5);
        const double var_x117 = 1.4063880539705308e-37 * var_x78;
        const double var_x118 = var_x28 * var_x76;
        const double var_x119 = 1.0 - var_chaste_interface__calcium_fluxes__CaMKt;
        const double var_x120 = 1.0 + 0.69999999999999996 / var_chaste_interface__calcium_concentration__Cass;
        const double var_x121 = 1 / var_x120;
        const double var_x122 = 0.050000000000000003 * var_x121;
        const double var_x123 = var_x119 * var_x122 + var_chaste_interface__calcium_fluxes__CaMKt;
        const double var_x124 = pow(var_x123, 2.5830000000000002);
        const double var_x125 = 1 / (1.7590641847756086 + var_x124);
        const double var_x126 = 1.5167893800000001 * var_x125;
        const double var_x127 = 0.50590000000000002 + var_x124 * var_x126;
        const double var_x128 = var_x127 * var_x70 / pow((1.6974399999999999e-7 + var_x69), 2);
        const double var_x129 = 1 / (0.16974399999999998 + var_x72);
        const double var_x130 = var_x127 * var_x129;
        const double var_x131 = var_x130 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x132 = var_chaste_interface__environment__time < 3333330000000.0005;
        const double var_x133 = ((var_x132) ? (-0.029999999999999999) : (-100.0));
        const double var_x134 = pow(var_x123, 1.5830000000000002);
        const double var_x135 = pow(var_chaste_interface__calcium_concentration__Cass, (-2));
        const double var_x136 = var_x119 * var_x135 / pow(var_x120, 2);
        const double var_x137 = pow(var_x123, 4.1660000000000004) / pow((1 + 0.56848408867329814 * var_x124), 2);
        const double var_x138 = var_x129 * (-0.044315367702357472 * var_x136 * var_x137 + 0.13712534389890002 * var_x125 * var_x134 * var_x136);
        const double var_x139 = ((var_x132) ? (3.0000000000000001e-5) : (0.10000000000000001));
        const double var_x140 = 2.5830000000000002 - 0.12915000000000001 * var_x121;
        const double var_x141 = var_x129 * (-0.49018713237495126 * var_x137 * var_x140 + var_x126 * var_x134 * var_x140);
        const double var_x142 = 0.59999999999999998 + var_chaste_interface__calcium_concentration__Cass;
        const double var_x143 = pow(var_x142, (-2));
        const double var_x144 = 1 / (1.0 + 65.399999999999991 * var_x143);
        const double var_x145 = 0.075369662812530269 * var_x60;
        const double var_x146 = var_x145 * var_x56;
        const double var_x147 = -var_chaste_interface__ryanodine_receptors__P_O1 - var_chaste_interface__ryanodine_receptors__P_O2;
        const double var_x148 = var_chaste_interface__calcium_fluxes__P_RyR * NV_Ith_S(mParameters, 0);
        const double var_x149 = ((var_x132) ? (var_x147 * var_x148) : (-10.0));
        const double var_x150 = var_x53 + var_chaste_interface__calcium_concentration__CaJSR;
        const double var_x151 = var_chaste_interface__ryanodine_receptors__P_O1 + var_chaste_interface__ryanodine_receptors__P_O2;
        const double var_x152 = var_x148 * var_x151;
        const double var_x153 = ((var_x132) ? (var_x150 * var_x152) : (10.0 * var_chaste_interface__calcium_concentration__CaJSR - 10.0 * var_chaste_interface__calcium_concentration__Cass));
        const double var_x154 = ((var_x132) ? (var_x152) : (10.0));
        const double var_x155 = 3.5000000000000004 * var_x144;
        const double var_x156 = ((var_x132) ? (var_x150 * var_x151 * NV_Ith_S(mParameters, 0)) : (0));
        const double var_x157 = ((var_x132) ? (var_x148 * var_x150) : (0));
        const double var_x158 = var_x155 * var_x157;
        const double var_x159 = 0.075369662812530269 * var_x144;
        const double var_x160 = 1 + 0.0015873015873015873 * var_chaste_interface__calcium_concentration__CaJSR;
        const double var_x161 = pow(var_x160, (-2));
        const double var_x162 = 1 / (1.0 + 79.365079365079367 * var_x161);
        const double var_x163 = -var_x157 * var_x162;
        const double var_x164 = 95238095.238095239 * var_x69;
        const double var_x165 = 0.20000000000000001 * var_chaste_interface__cell__V;
        const double var_x166 = exp(-0.038580246913580245 * pow((-1 + var_x165), 2));
        const double var_x167 = 0.00065941272238775927 * var_x166;
        const double var_x168 = var_x167 * var_x61;
        const double var_x169 = 4.9699714540658047e-5 * var_x166;
        const double var_x170 = var_x167 * var_x57;
        const double var_x171 = 0.0025000000000000005 * var_x121;
        const double var_x172 = pow(var_chaste_interface__calcium_concentration__Cass, 3.0);
        const double var_x173 = 0.012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2.0) * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x174 = 0.0040499999999999998 * var_x172;
        const double var_x175 = -0.0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4.0);
        ...
        const double var_x180 = 1.0 - var_chaste_interface__L_type_calcium_current__I - var_chaste_interface__L_type_calcium_current__O;
        const double var_x181 = 0.10337680327911219 * var_x180;
        const double var_x182 = pow(var_x177, (-2));
        const double var_x183 = -0.66666666666666663 * var_x179;
        const double var_x184 = 1 / (0.0625 + 0.40000000000000002 * var_x176);
        const double var_x185 = var_x176 * var_chaste_interface__L_type_calcium_current__I;
        const double var_x186 = 0.0625 + var_x176;
        const double var_x187 = 0.00044946436208309653 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x188 = var_x180 * var_x186;
        const double var_x189 = 0.0028985507246376812 * var_x178;
        const double var_x190 = -var_x186 * var_x189 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x191 = exp(7.5 + var_x102);
        const double var_x192 = 1.0 + var_x191;
        const double var_x193 = 1 / var_x192;
        const double var_x194 = 1 / (8.0 + 315.0 * var_x193);
        const double var_x195 = exp(6.666666666666667 - 0.16666666666666666 * var_chaste_interface__cell__V);
        const double var_x196 = 1.0 + var_x195;
        const double var_x197 = exp(4.024390243902439 + 0.12195121951219513 * var_chaste_interface__cell__V);
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = 4.2191641619115923e-37 * var_x78;
        const double var_x200 = 0.065313235986811116 * NV_Ith_S(mParameters, 5);
        const double var_x201 = -0.04926108374384236 * var_chaste_interface__cell__V;
        const double var_x202 = exp(0.36945812807881773 + var_x201);
        const double var_x203 = 0.01083743842364532 * var_x202 * var_chaste_interface__fast_sodium_current__O_Na;
        const double var_x204 = exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__cell__V);
        const double var_x205 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__cell__V);
        const double var_x206 = (0.0085583333333333327 * var_x204 + 0.0016666666666666668 * var_x205) / pow((var_x205 + 0.4108 * var_x204), 2);
        const double var_x207 = 60.832000000000001 * var_x206 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x208 = exp(-0.42168674698795178 - 0.060240963855421679 * var_chaste_interface__cell__V);
        const double var_x209 = var_x208 / pow((1 + 0.47846713846216332 * var_x208), 2);
        const double var_x210 = 0.073163809141391992 * var_x209 * var_chaste_interface__fast_sodium_current__O_Na;
        const double var_x211 = 2.0000000000000002e-5 * var_chaste_interface__cell__V;
        const double var_x212 = 0.008539999999999999 + var_x211;
        const double var_x213 = 1 / var_x212;
        const double var_x214 = 1 / (0.39395599999999997 + 0.188495 * var_x208);
        const double var_x215 = 1 / (0.25 * var_x205 + 0.1027 * var_x204);
        const double var_x216 = exp(-0.90909090909090906 - 0.12987012987012986 * var_chaste_interface__cell__V);
        const double var_x217 = 1 / var_x202;
        const double var_x218 = var_x214 * var_x215 * var_x216 * var_x217;
        const double var_x219 = var_x213 * var_x218;
        const double var_x220 = 9.7514961527500711e-7 * var_x219 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x221 = 3.317429681310359e-6 * var_x218 * var_chaste_interface__fast_sodium_current__IF_Na / pow((1 + 0.0023419203747072604 * var_chaste_interface__cell__V), 2);
        const double var_x222 = var_x209 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x223 = var_x213 * var_x216 * var_x217;
        const double var_x224 = 8.8508255294954831e-7 * var_x215 * var_x222 * var_x223;
        const double var_x225 = 0.00019355636363636362 * var_x206 * var_x214 * var_x223 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x226 = var_x214;
        const double var_x227 = 0.22 * var_x202;
        const double var_x228 = 3.802 * var_x215;
        const double var_x229 = 1.2097272727272726e-5 * var_x219;
        const double var_x230 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x231 = -var_x230;
        const double var_x232 = exp(0.12315270935960591 + var_x201);
        const double var_x233 = 0.009852216748768473 * var_x232;
        const double var_x234 = var_x233 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x235 = 9.0909090909090901e-8 * var_x216;
        const double var_x236 = var_x235 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x237 = exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__cell__V);
        const double var_x238 = 71.871455576559541 * (0.0068466666666666667 * var_x237 + 0.0015333333333333334 * var_x205) / pow((var_x205 + 0.44652173913043475 * var_x237), 2);
        const double var_x239 = var_x238 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x240 = 0.20000000000000001 * var_x232;
        const double var_x241 = -var_x240;
        const double var_x242 = -0.008539999999999999 - var_x211;
        const double var_x243 = 3.802 / (0.1027 * var_x237 + 0.23000000000000001 * var_x205);
        const double var_x244 = 6.9999999999999997e-7 * var_x216;
        const double var_x245 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x246 = -var_x245;
        const double var_x247 = exp(-0.12315270935960591 + var_x201);
        const double var_x248 = 0.0094433497536945809 * var_x247;
        const double var_x249 = var_x235 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x250 = exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__cell__V);
        const double var_x251 = 95.049999999999997 * (0.0013333333333333335 * var_x205 + 0.0060411764705882356 * var_x250) / pow((var_x205 + 0.51349999999999996 * var_x250), 2);
        const double var_x252 = 3.802 / (0.20000000000000001 * var_x205 + 0.1027 * var_x250);
        const double var_x253 = -var_x252;
        const double var_x254 = 0.19170000000000001 * var_x247;
        const double var_x255 = -var_x243 - var_x254;
        const double var_x256 = var_x242 + var_x253;
        const double var_x257 = var_x235 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x258 = 1.818181818181818e-9 * var_x216 * var_chaste_interface__fast_sodium_current__I2_Na;
        const double var_x259 = 7.3163809141391995e-5 * var_x222;
        const double var_x260 = 7.7014535938307356e-7 * var_x209 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x261 = -var_x244;
        const double var_x262 = 1.0526315789473684e-5 * var_x214;
        const double var_x263 = 1.4e-8 * var_x216;
        const double var_x264 = 0.001 * var_x214;
        const double var_x265 = var_x233 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x266 = var_x238 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x267 = var_x248 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x268 = var_x251 * var_chaste_interface__fast_sodium_current__IC_Na3;
        const double var_x269 = exp(-0.64479166666666676 - 0.10416666666666667 * var_chaste_interface__cell__V);
        const double var_x270 = 1.0 + var_x269;
        const double var_x271 = 1 / var_x270;
        const double var_x272 = exp(-0.062899999999999998 * var_chaste_interface__cell__V);
        const double var_x273 = 0.0073216139155926159 * var_x272 / pow((1 + 0.23955296404275997 * var_x272), 2);
        const double var_x274 = 1 / (2.0579999999999998 + 0.49299999999999999 * var_x272);
        const double var_x275 = 0.10416666666666667 * var_x269 / pow(var_x270, 2);
        const double var_x276 = var_x274 * var_x275;
        const double var_x277 = -var_x274;
        const double var_x278 = exp(7.7962962962962958 + 0.18518518518518517 * var_chaste_interface__cell__V);
        const double var_x279 = 1.0 + var_x278;
        const double var_x280 = 1 / var_x279;
        const double var_x281 = 1 / (643.0 + 1000.0 * var_x280);
        const double var_x282 = var_x278 / pow(var_x279, 2);
        const double var_x283 = 0.18518518518518517 * var_x282;
        const double var_x284 = var_x280;
        const double var_x285 = exp(-0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x286 = 1 / (13.17 + 39.299999999999997 * var_x285);
        const double var_x287 = exp(0.0109 * var_chaste_interface__cell__V);
        const double var_x288 = 0.00036515000000000001 * var_x287 * var_chaste_interface__rapid_delayed_rectifier_K_I__C_K2;
        const double var_x289 = exp(-0.041779999999999998 * var_chaste_interface__cell__V);
        const double var_x290 = 2.8786419999999997e-6 * var_x289 * var_chaste_interface__rapid_delayed_rectifier_K_I__O_K;
        const double var_x291 = exp(0.14349999999999999 + 0.0287 * var_chaste_interface__cell__V);
        const double var_x292 = 0.00201761 * var_x291 * var_chaste_interface__rapid_delayed_rectifier_K_I__O_K;
        const double var_x293 = exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__cell__V);
        const double var_x294 = 0.00021232196 * var_x293 * var_chaste_interface__rapid_delayed_rectifier_K_I__I_K;
        const double var_x295 = 6.8899999999999994e-5 * var_x289;
        const double var_x296 = 0.070300000000000001 * var_x291;
        const double var_x297 = 0.033500000000000002 * var_x287;
        const double var_x298 = 0.0064970000000000002 * var_x293;
        const double var_x299 = _lt_0_row[29];
        const double var_x300 = _lt_0_row[30];
        const double var_x301 = -0.022348 * var_x299;
        const double var_x302 = 1.0 - var_chaste_interface__slow_delayed_rectifier_K_I__nKs;
        const double var_x303 = exp(-3.3919999999999999 - 0.128 * var_chaste_interface__cell__V);
        const double var_x304 = 1.0 - var_x303;
        const double var_x305 = 4.8133299999999997e-6 / var_x304;
        const double var_x306 = _lt_0_row[31];
        const double var_x307 = 26.5 + var_chaste_interface__cell__V;
        const double var_x308 = _lt_0_row[21];
        const double var_x309 = _lt_0_row[22];
        const double var_x310 = exp(10.279999999999999 + var_x165);
        const double var_x311 = 1.0 + var_x310;
        const double var_x312 = 1 / var_x311;
        const double var_x313 = 1 / (9.6645000000000003 + 10.936199999999999 * var_x312);
        const double var_x314 = var_x310 / pow(var_x311, 2);
        const double var_x315 = exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__cell__V);
        const double var_x316 = 1.0 + var_x315;
        const double var_x317 = 1 / var_x316;
        const double var_x318 = 1 / (270.0 + 1050.0 * var_x317);
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0033 - var_x0 - var_x1 - var_x2 - var_x22 - var_x7 + 0.089599999999999999 * var_x52 - 0.25 * var_x3 - var_x37 - 2.4860000000000002 * var_x45 - 0.0066136879117995317 * var_x47 - 0.00017394900089230317 * var_x64 - 0.00017394900089230317 * var_x67 + var_x56 * var_x62 - var_x11 * var_x14 - var_x5 * var_chaste_interface__fast_transient_outward_K_I__ito_f - 256.41025641025641 * var_x13 * var_x48 * var_x8 * var_chaste_interface__calcium_concentration__Cai_converted / pow(var_x9, 2));
        IJth(rJacobian, 1, 0) = var_x116 * (-2.2859632595383892e-5 + 0.065313235986811116 * var_x37 + 0.00043196135932648281 * var_x47);
        IJth(rJacobian, 2, 0) = var_x144 * (var_x146 - 0.0056805860724745078 * var_x66 - 0.0056805860724745078 * var_x60 * var_x63);
        IJth(rJacobian, 5, 0) = var_x168 * var_x56 - var_x169 * var_x64 - var_x169 * var_x67 + var_x168 * var_x65 * (0.015432098765432098 - 0.0030864197530864196 * var_chaste_interface__cell__V);
        IJth(rJacobian, 10, 0) = var_x179 * var_x181 - var_x181 * var_x182 * pow(var_x176, 2);
        IJth(rJacobian, 11, 0) = -5.3935723449971585e-5 * var_x184 * var_x185 + var_x179 * var_x180 * var_x187 + 0.00013483930862492896 * var_x185 * var_x186 / pow((0.15625 + var_x176), 2) - var_x176 * var_x182 * var_x187 * var_x188;
        IJth(rJacobian, 12, 0) = var_x194 * (0.016666666666666666 * var_x195 / pow(var_x196, 2) - 0.12195121951219513 * var_x197 / pow(var_x198, 2)) + 0.00079365079365079365 * var_x191 * (-var_chaste_interface__L_type_calcium_current__y_gate + 1 / var_x198 + 0.10000000000000001 / var_x196) / (pow(var_x192, 2) * pow((0.025396825396825397 + var_x193), 2));
        IJth(rJacobian, 13, 0) = (-0.0001698144135657089 - 0.065313235986811116 * var_x1 - 0.0012958840779794486 * var_x47 - 0.48710611398963738 * var_x45 - 0.19593970796043336 * var_x37) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 14, 0) = var_x203 + var_x207 + var_x224 + var_x225 - var_x210 - var_x220 - var_x221;
        IJth(rJacobian, 15, 0) = var_x231 + var_x234 + var_x239 - var_x203 - var_x207 - var_x236;
        IJth(rJacobian, 16, 0) = var_x246 - var_x234 - var_x239 - var_x249 + var_x248 * var_chaste_interface__fast_sodium_current__C_Na2 + var_x251 * (1.0 - var_chaste_interface__fast_sodium_current__C_Na1 - var_chaste_interface__fast_sodium_current__C_Na2 - var_chaste_interface__fast_sodium_current__I1_Na - var_chaste_interface__fast_sodium_current__I2_Na - var_chaste_interface__fast_sodium_current__IC_Na2 - var_chaste_interface__fast_sodium_current__IC_Na3 - var_chaste_interface__fast_sodium_current__IF_Na - var_chaste_interface__fast_sodium_current__O_Na);
        IJth(rJacobian, 17, 0) = var_x257 + var_x259 - var_x258 - var_x260;
        IJth(rJacobian, 18, 0) = var_x258 + var_x260;
        IJth(rJacobian, 19, 0) = var_x210 + var_x220 + var_x221 + var_x230 + var_x236 + var_x265 + var_x266 - var_x224 - var_x225 - var_x257 - var_x259;
        IJth(rJacobian, 20, 0) = var_x245 + var_x249 + var_x267 + var_x268 - var_x265 - var_x266;
        IJth(rJacobian, 21, 0) = 2.0000000000000002e-5 + var_x231 + var_x246 - var_x267 - var_x268 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I1_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I2_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na2 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na3 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IF_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__O_Na + var_x235 * var_chaste_interface__fast_sodium_current__IC_Na3;
        IJth(rJacobian, 22, 0) = (0.0058520659444182763 * var_x52 + 0.32473740932642492 * var_x45 - 0.016328308996702779 * var_x3 - 0.065313235986811116 * var_x0 - 0.065313235986811116 * var_x2 - 0.065313235986811116 * var_x22 - 0.065313235986811116 * var_x7 - 0.034922987282147905 * var_x95) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 23, 0) = var_x276 + var_x273 * (var_x271 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__aur);
        IJth(rJacobian, 24, 0) = -var_x281 * var_x283 + 0.00018518518518518518 * var_x282 * (var_x284 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__iur) / pow((0.64300000000000002 + var_x280), 2);
        IJth(rJacobian, 25, 0) = var_x275 * var_x286 + 0.0012722646310432571 * var_x285 * (var_x271 - var_chaste_interface__non_inactivating_steady_state_K_I__aKss) / pow((0.33511450381679392 + var_x285), 2);
        IJth(rJacobian, 27, 0) = var_x288 + var_x290 - var_x292 - var_x294;
        IJth(rJacobian, 28, 0) = 0.01176 * var_x299 * (0.022348 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_K_I__C_K1 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_K_I__C_K2 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_K_I__I_K - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_K_I__O_K) + 0.0029658262000000005 * var_x300 * var_chaste_interface__rapid_delayed_rectifier_K_I__C_K1;
        IJth(rJacobian, 29, 0) = -var_x288 - var_x290;
        IJth(rJacobian, 30, 0) = var_x292 + var_x294;
        IJth(rJacobian, 31, 0) = var_x302 * var_x305 + 3.6226653999999999e-6 * var_x306 * var_chaste_interface__slow_delayed_rectifier_K_I__nKs - 6.1610624e-7 * var_x302 * var_x303 * var_x307 / pow(var_x304, 2);
        IJth(rJacobian, 32, 0) = 0.035770000000000003 * var_x308 * (0.18064 - 0.18064 * var_chaste_interface__fast_transient_outward_K_I__ato_f) + 0.024673572000000001 * var_x309 * var_chaste_interface__fast_transient_outward_K_I__ato_f;
        IJth(rJacobian, 33, 0) = -0.20000000000000001 * var_x313 * var_x314 + 0.018287887931822754 * var_x314 * (-var_chaste_interface__fast_transient_outward_K_I__ito_f + var_x312) / pow((0.88371646458550512 + var_x312), 2);
        IJth(rJacobian, 34, 0) = var_x276 + var_x273 * (var_x271 - var_chaste_interface__slow_transient_outward_K_I__ato_s);
        IJth(rJacobian, 35, 0) = -var_x283 * var_x318 + 0.00016708437761069341 * var_x315 * (var_x284 - var_chaste_interface__slow_transient_outward_K_I__ito_s) / (pow(var_x316, 2) * pow((0.25714285714285712 + var_x317), 2));
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.191 * var_x71 - 0.0092875564766839377 * var_x68 - 191000.0 * var_x74 + var_x75 * var_x76 - var_x77 * var_x79 - var_x10 * var_x14 * var_x48 + 2.0 * var_x11 * var_x48 / pow((0.01 + var_chaste_interface__calcium_concentration__Cai_converted), 2));
        IJth(rJacobian, 1, 1) = var_x115 * (-125.0 + var_x133 + 2.0 * var_x128 - 2000000.0 * var_x131 + (0.0062374140367404624 * var_x71 - 6237.4140367404616 * var_x74 - 65.313235986811122 * var_x118 - 0.00030330018395124703 * var_x68 + var_x117 * var_x77) * NV_Ith_S(mParameters, 5)) + 1.3080000000000001e-7 * (0.125 * var_chaste_interface__calcium_concentration__Cass - 125.0 * var_chaste_interface__calcium_concentration__Cai_converted - var_x130 * var_x72 - 0.032656617993405558 * (0.00069999999999999999 * var_chaste_interface__cell__V - 0.0092875564766839377 * log(0.001 * var_x68 * NV_Ith_S(mParameters, 1)) + 95500.0 * var_x69 * var_x73 - 2.0 * var_x36 * var_x46) * NV_Ith_S(mParameters, 5) + ((var_x132) ? (3.0000000000000001e-5 * var_chaste_interface__calcium_concentration__CaNSR - 0.029999999999999999 * var_chaste_interface__calcium_concentration__Cai_converted) : (0.10000000000000001 * var_chaste_interface__calcium_concentration__CaNSR - 100.0 * var_chaste_interface__calcium_concentration__Cai_converted))) / (pow(var_x112, 3) * pow(var_x113, 2));
        IJth(rJacobian, 2, 1) = 125000.0 * var_x144;
        IJth(rJacobian, 4, 1) = 190476190.47619048 * var_x131 - 95.238095238095241 * var_x133 - 190.47619047619048 * var_x128;
        IJth(rJacobian, 13, 1) = (195.93970796043337 * var_x118 - var_x199 * var_x77) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x62 * var_chaste_interface__cell__V);
        IJth(rJacobian, 1, 2) = var_x115 * (0.125 - var_x138 * var_x72);
        IJth(rJacobian, 2, 2) = var_x144 * (-125.0 + 3.5000000000000004 * var_x149 - var_x145 * var_chaste_interface__cell__V) + 0.030581039755351685 * (125000.0 * var_chaste_interface__calcium_concentration__Cai_converted + 3.5000000000000004 * var_x153 - 125.0 * var_chaste_interface__calcium_concentration__Cass + var_x146 * var_chaste_interface__cell__V) / (pow(var_x142, 3) * pow((0.015290519877675841 + var_x143), 2));
        IJth(rJacobian, 3, 2) = -var_x149 * var_x162;
        IJth(rJacobian, 4, 2) = var_x138 * var_x164;
        IJth(rJacobian, 5, 2) = -var_x168 * var_chaste_interface__cell__V;
        IJth(rJacobian, 6, 2) = 0.00175 * var_x123 * var_x136 + 8.7500000000000013e-5 * var_x135 * pow(var_x119, 2) / pow(var_x120, 3);
        IJth(rJacobian, 7, 2) = -var_x173 + 0.024299999999999999 * var_x172 * (1.0 + var_x147 - var_chaste_interface__ryanodine_receptors__P_C2);
        IJth(rJacobian, 8, 2) = var_x173;
        IJth(rJacobian, 11, 2) = var_x188 * var_x189;
        IJth(rJacobian, 2, 3) = var_x154 * var_x155;
        IJth(rJacobian, 3, 3) = var_x162 * (-0.050000000000000003 - var_x154) + 4.0000000000000003e-5 * (-var_x153 + 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR) / (pow(var_x160, 3) * pow((0.0126 + var_x161), 2));
        IJth(rJacobian, 4, 3) = 0.016666666666666666;
        IJth(rJacobian, 1, 4) = var_x115 * var_x139;
        IJth(rJacobian, 3, 4) = 0.050000000000000003 * var_x162;
        IJth(rJacobian, 4, 4) = -0.016666666666666666 - 95.238095238095241 * var_x139;
        IJth(rJacobian, 2, 5) = var_x155 * var_x156;
        IJth(rJacobian, 3, 5) = -var_x156 * var_x162;
        IJth(rJacobian, 5, 5) = -0.01;
        IJth(rJacobian, 1, 6) = -1000.0 * var_x114 * var_x141 * var_x69;
        IJth(rJacobian, 4, 6) = var_x141 * var_x164;
        IJth(rJacobian, 6, 6) = -0.00020000000000000001 - var_x123 * var_x171 + var_x119 * var_x171 * (1 - var_x122);
        IJth(rJacobian, 2, 7) = var_x158;
        IJth(rJacobian, 3, 7) = var_x163;
        IJth(rJacobian, 7, 7) = -0.080249999999999988 + var_x175 - var_x174;
        IJth(rJacobian, 8, 7) = var_x174;
        IJth(rJacobian, 9, 7) = 0.0089999999999999993;
        IJth(rJacobian, 2, 8) = var_x158;
        IJth(rJacobian, 3, 8) = var_x163;
        IJth(rJacobian, 7, 8) = 0.96499999999999997 + var_x175;
        IJth(rJacobian, 8, 8) = -0.96499999999999997;
        IJth(rJacobian, 7, 9) = 0.00080000000000000004 + var_x175;
        IJth(rJacobian, 9, 9) = -0.00080000000000000004;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x81 * var_x82);
        IJth(rJacobian, 2, 10) = var_x159 * var_x81;
        IJth(rJacobian, 5, 10) = var_x170 * var_x81;
        IJth(rJacobian, 10, 10) = -1.1986666666666668 + var_x183;
        IJth(rJacobian, 11, 10) = var_x190;
        IJth(rJacobian, 10, 11) = var_x183;
        IJth(rJacobian, 11, 11) = var_x190 - 0.00034782608695652176 * var_x184 * var_x186;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x82 * var_x83);
        IJth(rJacobian, 2, 12) = var_x159 * var_x83;
        IJth(rJacobian, 5, 12) = var_x170 * var_x83;
        IJth(rJacobian, 12, 12) = -var_x194;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x91 - 4.4407155437233767e-10 * var_x92 - 0.54154848260547739 * var_x86 - 0.068993276683937815 * var_x84 - 26.535875647668394 * var_x87 - var_x79 * var_x90);
        IJth(rJacobian, 1, 13) = var_x116 * (0.19593970796043336 * var_x91 + var_x117 * var_x90);
        IJth(rJacobian, 13, 13) = (-1.7331439082928402 * var_x87 - 0.004506174161561384 * var_x84 - 0.58781912388130009 * var_x91 - 8.7011250677251544e-11 * var_x92 - var_x199 * var_x90) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 22, 13) = (5.8007500451501034e-11 * var_x92 - 0.035370283842711021 * var_x86) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x94);
        IJth(rJacobian, 13, 14) = var_x200 * var_x94;
        IJth(rJacobian, 14, 14) = -var_x226 - var_x227;
        IJth(rJacobian, 15, 14) = var_x227;
        IJth(rJacobian, 16, 14) = var_x253;
        IJth(rJacobian, 19, 14) = var_x226;
        IJth(rJacobian, 21, 14) = var_x242;
        IJth(rJacobian, 14, 15) = var_x228;
        IJth(rJacobian, 15, 15) = var_x241 + var_x242 - var_x228;
        IJth(rJacobian, 16, 15) = var_x240 + var_x253;
        IJth(rJacobian, 19, 15) = var_x212;
        IJth(rJacobian, 21, 15) = var_x242;
        IJth(rJacobian, 15, 16) = var_x243;
        IJth(rJacobian, 16, 16) = var_x255 + var_x256;
        IJth(rJacobian, 20, 16) = var_x212;
        IJth(rJacobian, 21, 16) = var_x242;
        IJth(rJacobian, 16, 17) = var_x253;
        IJth(rJacobian, 17, 17) = var_x261 - var_x262;
        IJth(rJacobian, 18, 17) = var_x262;
        IJth(rJacobian, 19, 17) = var_x244;
        IJth(rJacobian, 21, 17) = var_x242;
        IJth(rJacobian, 16, 18) = var_x253;
        IJth(rJacobian, 17, 18) = var_x263;
        IJth(rJacobian, 18, 18) = -var_x263;
        IJth(rJacobian, 21, 18) = var_x242;
        IJth(rJacobian, 14, 19) = var_x229;
        IJth(rJacobian, 15, 19) = var_x244;
        IJth(rJacobian, 16, 19) = var_x253;
        IJth(rJacobian, 17, 19) = var_x264;
        IJth(rJacobian, 19, 19) = var_x241 + var_x261 - var_x229 - var_x264;
        IJth(rJacobian, 20, 19) = var_x240;
        IJth(rJacobian, 21, 19) = var_x242;
        IJth(rJacobian, 16, 20) = var_x244 + var_x253;
        IJth(rJacobian, 19, 20) = var_x243;
        IJth(rJacobian, 20, 20) = var_x255 + var_x261;
        IJth(rJacobian, 21, 20) = var_x242 + var_x254;
        IJth(rJacobian, 16, 21) = var_x253;
        IJth(rJacobian, 20, 21) = var_x252;
        IJth(rJacobian, 21, 21) = var_x256 + var_x261;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (2.3776144580310881 * var_x101 - 2.9484306275187104 * var_x87 - 14.188732708808288 * var_x96 - 6.6339689119170986 * var_x97 - 26.535875647668394 * var_x100 - 26.535875647668394 * var_x86 - 26.535875647668394 * var_x98 - 26.535875647668394 * var_x99 - 0.0076659196315486469 * var_x84);
        IJth(rJacobian, 13, 22) = (-0.0005006860179512649 * var_x84 - 0.19257154536587112 * var_x87) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 22, 22) = (0.15528969418303848 * var_x101 - 0.43328597707321004 * var_x97 - 1.7331439082928402 * var_x100 - 1.7331439082928402 * var_x86 - 1.7331439082928402 * var_x98 - 1.7331439082928402 * var_x99 - 0.92671204776418159 * var_x96) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (var_x104);
        IJth(rJacobian, 22, 23) = var_x104 * var_x200;
        IJth(rJacobian, 23, 23) = var_x277;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (var_x105);
        IJth(rJacobian, 22, 24) = var_x105 * var_x200;
        IJth(rJacobian, 24, 24) = -var_x281;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (var_x107);
        IJth(rJacobian, 22, 25) = var_x107 * var_x200;
        IJth(rJacobian, 25, 25) = -var_x286;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (var_x108);
        IJth(rJacobian, 22, 26) = var_x108 * var_x200;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (var_x109);
        IJth(rJacobian, 22, 27) = var_x109 * var_x200;
        IJth(rJacobian, 27, 27) = -var_x295 - var_x296;
        IJth(rJacobian, 28, 27) = var_x301;
        IJth(rJacobian, 29, 27) = var_x295;
        IJth(rJacobian, 30, 27) = var_x296;
        IJth(rJacobian, 28, 28) = -0.023761000000000001 + var_x301 - 0.047002000000000002 * var_x300;
        IJth(rJacobian, 29, 28) = 0.023761000000000001;
        IJth(rJacobian, 27, 29) = var_x297;
        IJth(rJacobian, 28, 29) = 0.036777999999999998 + var_x301;
        IJth(rJacobian, 29, 29) = -0.036777999999999998 - var_x297;
        IJth(rJacobian, 27, 30) = var_x298;
        IJth(rJacobian, 28, 30) = var_x301;
        IJth(rJacobian, 30, 30) = -var_x298;
        IJth(rJacobian, 0, 31) = mSetVoltageDerivativeToZero ? 0.0 : (-2 * var_x110);
        IJth(rJacobian, 22, 31) = -0.13062647197362223 * var_x110 * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 31, 31) = -9.5333299999999997e-5 * var_x306 - var_x305 * var_x307;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-1.6040999999999999 * var_x111);
        IJth(rJacobian, 22, 32) = -0.10476896184644371 * var_x111 * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 32, 32) = -0.18064 * var_x308 - 0.39560000000000001 * var_x309;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x5 * var_x50);
        IJth(rJacobian, 22, 33) = -0.034922987282147905 * var_x4 * var_x50 * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 33, 33) = -var_x313;
        IJth(rJacobian, 34, 34) = var_x277;
        IJth(rJacobian, 35, 35) = -var_x318;
    }
