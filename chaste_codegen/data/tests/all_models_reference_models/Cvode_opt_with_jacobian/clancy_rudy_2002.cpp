...
const double var_x0 = exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V);
        ...
        const double var_x86 = 0.0012190504118344883 * NV_Ith_S(mParameters, 4);
        const double var_x87 = -0.75 * NV_Ith_S(mParameters, 3);
        const double var_x88 = 0.75 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x89 = var_x74 * (var_x87 + var_x73 * var_x88);
        const double var_x90 = var_x79 * (var_x87 + var_x78 * var_x88);
        const double var_x91 = 0.0003485581177541574 * NV_Ith_S(mParameters, 4);
        const double var_x92 = -0.75 * NV_Ith_S(mParameters, 2);
        const double var_x93 = 0.75 * var_chaste_interface__ionic_concentrations__Ki;
        ...
        const double var_x137 = var_x78 * var_x79;
        const double var_x138 = var_x134 * var_x77;
        const double var_x139 = var_x134 * var_x80;
        const double var_x140 = -0.5 + 374358.83507802623 * var_chaste_interface__membrane__V;
        const double var_x141 = var_x138 - var_x140 * (-var_x138 - var_x139);
        const double var_x142 = var_chaste_interface__L_type_Ca_channel_d_gate__d / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x143 = 0.00059999999999999995 * var_x142;
        const double var_x144 = var_x143 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x145 = var_x84 * (var_x136 + (0.5 - 374358.83507802623 * var_chaste_interface__membrane__V) * (-var_x136 - var_x134 * var_x137)) - var_x141 * var_x144;
        const double var_x146 = 187179.41753901311 * var_chaste_interface__membrane__V;
        const double var_x147 = -0.5 + var_x146;
        const double var_x148 = 6.5127374999999992e-9 * NV_Ith_S(mParameters, 4);
        const double var_x149 = var_x148 * var_x89;
        const double var_x150 = var_x149 - var_x147 * (-var_x149 - var_x148 * var_x90);
        const double var_x151 = var_x150 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x152 = 1.8621604999999999e-9 * NV_Ith_S(mParameters, 4);
        const double var_x153 = var_x152 * var_x94;
        const double var_x154 = var_x153 - var_x147 * (-var_x153 - var_x152 * var_x95);
        const double var_x155 = -var_x143 * var_x151 - var_x144 * var_x154;
        const double var_x156 = NV_Ith_S(mParameters, 4) * var_chaste_interface__membrane__V;
        const double var_x157 = var_x142 * var_x156 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x158 = 7.8019226357407252 * var_x111 - 0.0046811535814444347 * var_x106 * var_x157;
        const double var_x159 = var_x115 * var_x157;
        ...
        const double var_x162 = pow(var_x160, (-2));
        const double var_x163 = var_x161 + 0.040282206767891383 * var_x15 + 0.6678084676374566 * var_x15 * var_x8 - 1.1499999999999999 * var_x162 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x164 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x165 = log(var_x164 * NV_Ith_S(mParameters, 3));
        const double var_x166 = -26.712338705498265 * var_x165 + var_chaste_interface__membrane__V;
        const double var_x167 = var_x141 * var_x83;
        const double var_x168 = var_x151 * var_x82;
        const double var_x169 = var_x154 * var_x83;
        const double var_x170 = var_x168 + var_x169;
        const double var_x171 = var_x100 * var_chaste_interface__membrane__V;
        const double var_x172 = var_x107 * var_x171;
        const double var_x173 = var_x115 * var_x171;
        const double var_x174 = var_x82 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x175 = var_x141 * var_x174;
        const double var_x176 = var_x150 * var_x174 + var_x154 * var_x174;
        const double var_x177 = var_x81 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x178 = var_x156 * var_x177;
        const double var_x179 = var_x107 * var_x178;
        const double var_x180 = var_x115 * var_x178;
        const double var_x181 = log(var_x15 * NV_Ith_S(mParameters, 1));
        ...
        const double var_x184 = var_x182 * var_x7;
        const double var_x185 = 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        const double var_x186 = var_x125 * var_x132 * var_x19;
        const double var_x187 = 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
        const double var_x188 = var_x125 * var_x14;
        const double var_x189 = var_x56 * NV_Ith_S(mParameters, 2) / var_x60;
        const double var_x190 = var_x131 * var_x21;
        const double var_x191 = var_x46 * var_x61;
        const double var_x192 = var_x191 * var_x64;
        const double var_x193 = 3 * var_x192;
        const double var_x194 = var_x128 * var_x191;
        const double var_x195 = 0.00030000000000000003 * var_x194;
        const double var_x196 = 0.5 - var_x146;
        const double var_x197 = 4.8845531249999998e-9 * NV_Ith_S(mParameters, 4);
        const double var_x198 = var_x135 * var_x197;
        const double var_x199 = var_x12 * var_x67;
        const double var_x200 = 1.3966203749999998e-9 * NV_Ith_S(mParameters, 4);
        const double var_x201 = var_x135 * var_x200;
        const double var_x202 = var_x48 * var_x64;
        const double var_x203 = 0.003016 + var_x9;
        const double var_x204 = 0.0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x205 = 1.0 + 0.00011900000000000002 / pow(var_x204, 2) + 3.5000000000000004e-5 * var_x162;
        const double var_x206 = 1 / var_x205;
        const double var_x207 = 1 / M_PI;
        const double var_x208 = 9.0316078310111333e-5 * var_x207;
        const double var_x209 = var_x206 * var_x208;
        const double var_x210 = 0.00062 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x211 = 1 / var_x210;
        const double var_x212 = 1.0 - var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x213 = -0.00018000000000000001 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x214 = var_x211 * var_x212 * var_x213 * NV_Ith_S(mParameters, 0);
        const double var_x215 = var_x214 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x216 = var_chaste_interface__calcium_dynamics__Cainfluxtrack > 0.00018000000000000001;
        const double var_x217 = 4000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2;
        const double var_x218 = var_chaste_interface__calcium_dynamics__OVRLDtrack2 > 0;
        const double var_x219 = ((var_x216) ? (-var_x215) : ((var_x218) ? ((-4000.0 + var_x217) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x220 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x221 = 1 / var_x220;
        const double var_x222 = 0.71029411764705874 * var_x221;
        const double var_x223 = var_chaste_interface__calcium_dynamics__Cai / pow(var_x220, 2);
        const double var_x224 = 0.090316078310111333 * var_x207;
        const double var_x225 = -var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x226 = ((var_x216) ? (var_x215 * var_x225) : ((var_x218) ? (var_x217 * var_x225 * (1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2)) : (0)));
        const double var_x227 = var_x108 * var_chaste_interface__membrane__V;
        const double var_x228 = -0.040282206767891383 * var_x181 + var_x161 * var_chaste_interface__calcium_dynamics__Cai + var_x182 * var_x9;
        const double var_x229 = 9.0316078310111336e-6 * var_x183 * var_x207;
        const double var_x230 = 4.5158039155055668e-6 * var_x184 * var_x207;
        const double var_x231 = 4000.0 - var_x217;
        const double var_x232 = ((var_x216) ? (var_x215) : ((var_x218) ? (var_x231 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x233 = 7.0588235294117632e-6 * var_x206;
        const double var_x234 = var_x211 * var_x225 * var_chaste_interface__calcium_dynamics__APtrack2 * NV_Ith_S(mParameters, 0);
        const double var_x235 = ((var_x216) ? (var_x214 * var_x225 - var_x213 * var_x234) : (0));
        const double var_x236 = ((var_x216) ? (var_x212 * var_x234 - var_x212 * var_x213 * var_x225 * var_chaste_interface__calcium_dynamics__APtrack2 * NV_Ith_S(mParameters, 0) / pow(var_x210, 2)) : (0));
        const double var_x237 = ((var_x216) ? (0) : ((var_x218) ? (var_x225 * var_x231 + (4000.0 * var_chaste_interface__calcium_dynamics__Cai - 4000.0 * var_chaste_interface__calcium_dynamics__Ca_JSR) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        ...
        const double var_x291 = exp(1.0000000001853256e-7);
        const double var_x292 = (1.0 - var_x291) / (1.0 + var_x291);
        const double var_x293 = 45787.545779060179 * var_x292;
        const double var_x294 = exp(-1.0000000001853256e-7);
        const double var_x295 = (1.0 - var_x294) / (1.0 + var_x294);
        const double var_x296 = (10.000000624 + var_chaste_interface__membrane__V) * (var_x293 + 45787.545779060179 * var_x295);
        const double var_x297 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x298 = fabs(var_x297) < 6.2400000011564316e-7;
        ...
        const double var_x303 = ((var_x298) ? (1.5575040005772907e-12 * (-36688738598.216812 * var_x292 - 36688738598.216812 * var_x295) / pow((var_x296 - 0.057142857142857141 * var_x292), 2)) : (var_x301 - var_x300 * var_x302 - var_x288 * var_x302 / pow(var_x299, 2)));
        const double var_x304 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x305 = ((var_x298) ? (1 / (-var_x293 + 801282.05113355326 * var_x296)) : (var_x297 * var_x301));
        ...
        const double var_x361 = var_x360 - var_x187;
        const double var_x362 = 1 / (-1.0 + exp(9.9999999925515227e-8));
        const double var_x363 = 1 / (-1.0 + exp(-9.9999999925515227e-8));
        const double var_x364 = 1 / (1.0 - exp(2.1542940304186685e-7));
        const double var_x365 = 1 / (1.0 - exp(-2.1542940304186685e-7));
        const double var_x366 = (30.000001455604075 + var_chaste_interface__membrane__V) * (1.9068413377354434e-10 * var_x362 + 1.9068413377354434e-10 * var_x363 + 1.0465793296425829e-10 * var_x364 + 1.0465793296425829e-10 * var_x365);
        ...
        const double var_x369 = fabs(var_x368) < 1.4556040746072085e-6;
        ...
        const double var_x382 = var_x360 - var_x185;
        ...
        const double var_x419 = var_x202 + var_x228 + 0.0070159999999999997 * var_chaste_interface__membrane__V - 0.10684935482199306 * var_x165 + var_x11 * var_x14 + var_x14 * var_x25 + var_x14 * var_x3 + var_x14 * var_x40 + var_x14 * var_x5 + var_x166 * var_x6 + var_x189 * var_x63 + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 0.433 * var_x133 * (1.0 + 0.59999999999999998 * var_x18);
        const double var_x420 = var_x227 + var_x419;
        const double var_x421 = var_x125;
        const double var_x422 = var_x168 * var_chaste_interface__L_type_Ca_channel_d_gate__d + var_x169 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x424 = var_x203 + var_x53 - var_x55 - var_x66;
        const double var_x425 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
        const double var_x426 = (var_x425) && (var_x98);
        const double var_x427 = var_x127 + var_x130 + var_x163;
        const double var_x428 = var_x141 * var_x208;
        const double var_x429 = 0.00070463905573898956 * var_x106 * var_x207;
        const double var_x430 = (var_x425) && (((var_x425) || (var_x98)));
        const double var_x431 = var_chaste_interface__calcium_dynamics__APtrack2 > 0.01;
        const double var_x432 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        ...
        IJth(rJacobian, 1, 0) = -var_x209 * (var_x203 + 0.063641001963264457 * var_x202 - 2.0 * var_x55 - 0.074871767015605231 * var_x65 + ((var_x98) ? (var_x85) : (var_x112)));
        ...
        IJth(rJacobian, 20, 0) = ((var_x369) ? (var_x361 * (0.065500000000000003 * var_x362 + 0.065500000000000003 * var_x363 + 0.035949999999999996 * var_x364 + 0.035949999999999996 * var_x365) + var_x367 * (343500000.2558552 * var_x366 - 1.9068413377354434e-7 * var_x363 - 1.0465793296425829e-7 * var_x364)) : (var_x361 * (var_x373 + var_x377 - 0.0089997000000000011 * var_x378 - 0.0106412 * var_x379) + var_x367 * (var_x368 * var_x373 + var_x368 * var_x377)));
        IJth(rJacobian, 21, 0) = ((var_x369) ? (var_x367 * (85875000.063963801 * var_x366 - 4.7671033443386084e-8 * var_x363 - 2.6164483241064571e-8 * var_x364) + var_x382 * (0.016375000000000001 * var_x362 + 0.016375000000000001 * var_x363 + 0.008987499999999999 * var_x364 + 0.008987499999999999 * var_x365)) : (var_x367 * (var_x368 * var_x383 + var_x368 * var_x384) + var_x382 * (var_x383 + var_x384 - 0.0022499250000000003 * var_x378 - 0.0026603 * var_x379)));
        ...
        IJth(rJacobian, 29, 0) = ((var_x426) ? (-var_x208 * (var_x424 + var_x85)) : ((var_x425) ? (-var_x208 * (var_x112 + var_x424)) : (0)));
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * (var_x163 - var_x127 - var_x130 + 2.3575679435995052e-7 * var_x133 * var_x15 * var_x16 / pow(var_x17, 2) + ((var_x98) ? (var_x145 + var_x155) : ((var_x113) ? (var_x155 + var_x158) : (var_x158 - 1.4628604942013857e-6 * var_x117 * var_x159 - 4.1826974130498884e-7 * var_x120 * var_x159)))));
        IJth(rJacobian, 1, 1) = 0.001 * var_x206 * (-var_x222 + 0.71029411764705874 * var_x223 + 0.0070588235294117632 * var_x219 - var_x224 * (var_x163 + 2.0 * var_x127 + 0.00020000000000000001 * var_x129 + ((var_x98) ? (var_x145) : (var_x158)))) + 0.001 * (0.00023800000000000004 / pow(var_x204, 3) + 7.0000000000000007e-5 / pow(var_x160, 3)) * (0.047352941176470584 * var_chaste_interface__calcium_dynamics__Ca_NSR + 0.0070588235294117632 * var_x226 - var_x222 * var_chaste_interface__calcium_dynamics__Cai - var_x224 * (var_x228 + 0.003016 * var_chaste_interface__membrane__V - 2.0 * var_x202 + ((var_x98) ? (var_x167 * var_chaste_interface__L_type_Ca_channel_d_gate__d) : (var_x227)))) / pow(var_x205, 2);
        IJth(rJacobian, 24, 1) = -var_x219 * var_x418;
        IJth(rJacobian, 25, 1) = 0.0087500000000000008 * var_x221 - 0.0087500000000000008 * var_x223;
        IJth(rJacobian, 29, 1) = ((var_x426) ? (-var_x208 * (var_x145 + var_x427)) : ((var_x425) ? (-var_x208 * (var_x158 + var_x427)) : (0)));
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * var_x166 * NV_Ith_S(mParameters, 6));
        ...
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * ((var_x98) ? (var_x167 + var_x170) : ((var_x113) ? (var_x170 + var_x172) : (var_x172 + var_x118 * var_x173 + var_x121 * var_x173))));
        IJth(rJacobian, 1, 11) = -var_x209 * ((var_x98) ? (var_x167) : (var_x172));
        IJth(rJacobian, 11, 11) = var_x290 * var_x305 - var_x289 * var_x305;
        IJth(rJacobian, 29, 11) = ((var_x426) ? (-var_x428 * var_x99) : ((var_x425) ? (-var_x171 * var_x429) : (0)));
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * ((var_x98) ? (var_x175 + var_x176) : ((var_x113) ? (var_x176 + var_x179) : (var_x179 + var_x118 * var_x180 + var_x121 * var_x180))));
        IJth(rJacobian, 1, 12) = -var_x209 * ((var_x98) ? (var_x175) : (var_x179));
        IJth(rJacobian, 12, 12) = var_x317 * var_x320 + var_x317 * var_x322;
        IJth(rJacobian, 29, 12) = ((var_x426) ? (-var_x177 * var_x428) : ((var_x425) ? (-var_x178 * var_x429) : (0)));
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0001 * var_x125 * var_x183);
        IJth(rJacobian, 1, 13) = -var_x206 * var_x229;
        IJth(rJacobian, 13, 13) = -0.001 * var_x328;
        IJth(rJacobian, 29, 13) = ((var_x430) ? (-var_x229) : (0));
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-5.0000000000000002e-5 * var_x125 * var_x184);
        IJth(rJacobian, 1, 14) = -var_x206 * var_x230;
        IJth(rJacobian, 14, 14) = ((var_x333) ? (-0.001 * var_x331) : (-0.083333333333333329));
        IJth(rJacobian, 29, 14) = ((var_x430) ? (-var_x230) : (0));
        ...
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x185 * var_x186);
        IJth(rJacobian, 20, 20) = ((var_x369) ? (1.9068413377354434e-10 * var_x363 + 1.0465793296425829e-10 * var_x364 - 343500.00025585521 * var_x366) : (-0.00013100000000000001 * var_x380 - 7.1899999999999999e-5 * var_x381));
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x186 * var_x187);
        IJth(rJacobian, 21, 21) = ((var_x369) ? (4.7671033443386086e-11 * var_x363 + 2.6164483241064574e-11 * var_x364 - 85875.000063963802 * var_x366) : (-3.2750000000000003e-5 * var_x380 - 1.7975e-5 * var_x381));
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0033000000000000004 * var_x188 * var_x22 * pow(var_chaste_interface__transient_outward_current_zdv_gate__zdv, 2) * NV_Ith_S(mParameters, 11) * var_chaste_interface__transient_outward_current_ydv_gate__ydv);
        IJth(rJacobian, 22, 22) = -var_x394 - 10.0 * var_x391;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0011000000000000001 * var_x188 * var_x23);
        IJth(rJacobian, 23, 23) = -var_x414 - 0.10000000000000001 * var_x407;
        IJth(rJacobian, 1, 24) = var_x232 * var_x233;
        IJth(rJacobian, 24, 24) = var_x418 * (-5.5555555555555554 - var_x232) + 0.00025000000000000001 * (-var_x226 + 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR) / (pow(var_x415, 3) * pow((0.125 + var_x416), 2));
        IJth(rJacobian, 25, 24) = 0.00048309178743961351;
        IJth(rJacobian, 1, 25) = 4.7352941176470584e-5 * var_x206;
        IJth(rJacobian, 24, 25) = 0.0055555555555555558 * var_x417;
        IJth(rJacobian, 25, 25) = -0.001066425120772947;
        IJth(rJacobian, 26, 26) = (((((var_x98) || (var_x97 >= 2.6712338705498262e-6) || (var_x421 * (var_x420 + var_x422) < -150000.0))) && (((var_x113) || (var_x98) || (var_x421 * (var_x420 + var_x119 * var_chaste_interface__membrane__V + var_x122 * var_chaste_interface__membrane__V) < -150000.0))) && (((var_x97 >= 1.3356169352749131e-6) || (var_x421 * (var_x419 + var_x422 + var_x84 * (var_x138 + var_x140 * (var_x138 + var_x139))) < -150000.0)))) ? (-100.5) : (-0.5));
        IJth(rJacobian, 1, 27) = var_x233 * var_x235;
        IJth(rJacobian, 24, 27) = -var_x235 * var_x418;
        IJth(rJacobian, 27, 27) = ((var_x423) ? (-100.5) : (-0.5));
        IJth(rJacobian, 28, 28) = ((var_x423) ? (-100.5) : (-0.01));
        IJth(rJacobian, 1, 29) = var_x233 * var_x236;
        IJth(rJacobian, 24, 29) = -var_x236 * var_x418;
        IJth(rJacobian, 29, 29) = (((((var_x425) || (var_x431))) && (((var_x425) || (var_x431) || (var_x98)))) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 31, 31) = (((var_x432) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50.0) : (-0.5));
        IJth(rJacobian, 32, 32) = (((var_x432) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50.0) : (-0.01));
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * (var_x193 - var_x195 + 0.10684935482199306 * var_x164 + 0.48963716847178318 * var_x190 + 26.712338705498265 * var_x164 * var_x6 + 0.044999999999999998 * var_x189 / (var_x43 * pow((0.01 + var_x62), 2)) + ((var_x113) ? (var_x84 * (var_x198 + var_x196 * (-var_x198 - var_x137 * var_x197))) : (0.0018285756177517324 * var_x123))));
        IJth(rJacobian, 1, 33) = -var_x209 * (0.00060000000000000006 * var_x194 - 6.0 * var_x192);
        IJth(rJacobian, 29, 33) = ((var_x430) ? (-var_x208 * (var_x195 - var_x193)) : (0));
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * (26.712338705498265 * var_x190 + var_x70 * (6498.310636886562 * var_x199 - var_x68 * (1.053972635420138 * var_x12 * var_x32 + 1.6494869150645177 * var_x12 * var_x33) - 13738.155796237757 * var_x12 * var_x69) + 29.383572576048092 * var_x12 * var_x24 + 5.1338399412861326e-7 * var_x12 * var_x4 + 0.14745210965435041 * var_x12 * var_x2 + 11725.06353372661 * var_x12 * var_x39 + 26.712338705498265 * var_x11 * var_x12 - 2796.4276527937964 * var_x199 * var_x71 + ((var_x113) ? (var_x84 * (var_x201 + var_x196 * (-var_x201 - var_x137 * var_x200))) : (0.00052283717663123607 * var_x123))));
    }
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel__I_CaNa = ((fabs(var_chaste_interface__membrane__V) < 2.6712338705498262e-6) ? (-187179.41753901311 * (-2.6712338705498262e-6 + var_chaste_interface__membrane__V) * (-6.5127374999999992e-9 * (-0.75 * NV_Ith_S(mParameters, 3) + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(9.9999999999999995e-8)) * NV_Ith_S(mParameters, 4) / (-1.0 + exp(9.9999999999999995e-8)) - 6.5127374999999992e-9 * (-0.75 * NV_Ith_S(mParameters, 3) + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(-9.9999999999999995e-8)) * NV_Ith_S(mParameters, 4) / (-1.0 + exp(-9.9999999999999995e-8))) + 6.5127374999999992e-9 * (-0.75 * NV_Ith_S(mParameters, 3) + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(9.9999999999999995e-8)) * NV_Ith_S(mParameters, 4) / (-1.0 + exp(9.9999999999999995e-8))) : (0.0024381008236689767 * (-0.75 * NV_Ith_S(mParameters, 3) + 0.75 * var_chaste_interface__ionic_concentrations__Nai * _lt_0_row[0]) * NV_Ith_S(mParameters, 4) * var_chaste_interface__membrane__V / (_lt_0_row[1]))); // microA_per_microF
