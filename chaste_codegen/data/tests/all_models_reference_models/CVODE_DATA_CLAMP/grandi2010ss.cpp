...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellgrandi2010ssFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__cell__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        {const double var_cell__Cli = 15.0; // dimensionless
            ...
            if (mDataClampIsOn)
            {
                var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__cell__time) + var_chaste_interface__cell__sVm) * NV_Ith_S(mParameters, 3); // uA_per_cm2
            }
