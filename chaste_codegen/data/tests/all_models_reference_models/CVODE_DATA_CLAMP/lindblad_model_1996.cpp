...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celllindblad_model_1996FromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Celllindblad_model_1996FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Celllindblad_model_1996FromCellMLCvodeDataClamp::Celllindblad_model_1996FromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celllindblad_model_1996FromCellMLCvodeDataClamp>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 10) = 1.3999999999999999e-6; // (var_sodium_current__P_Na) [nanolitre_per_second]
        ...
        NV_Ith_S(this->mParameters, 13) = 0.0050879999999999996; // (var_inward_rectifier__g_K1) [nanoS]
        NV_Ith_S(this->mParameters, 14) = 0.0035000000000000001; // (var_delayed_rectifier_K_current__g_Kr) [nanoS]
        NV_Ith_S(this->mParameters, 15) = 0.0025000000000000001; // (var_delayed_rectifier_K_current__g_Ks) [nanoS]
        NV_Ith_S(this->mParameters, 16) = 2.0000000000000002e-5; // (var_Na_Ca_ion_exchanger_current__k_NaCa) [picoA_per_millimolar_4]
        NV_Ith_S(this->mParameters, 17) = 0.050001999999999998; // (var_Ca_independent_transient_outward_K_current__g_to) [nanoS]
    }

    Celllindblad_model_1996FromCellMLCvodeDataClamp::~Celllindblad_model_1996FromCellMLCvodeDataClamp()
    {
    }

    
    double Celllindblad_model_1996FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_delayed_rectifier_K_current__i_Kr = (-var_Ca_independent_transient_outward_K_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 14) * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i; // picoA
        ...
        const double var_delayed_rectifier_K_current__i_Ks = (-var_Ca_independent_transient_outward_K_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 15) * var_chaste_interface__delayed_rectifier_K_current_z_gate__z; // picoA
    ...
    void Celllindblad_model_1996FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_sodium_current__E_Na = var_membrane__R * var_membrane__T * log(NV_Ith_S(mParameters, 6) / var_chaste_interface__intracellular_ion_concentrations__Na_i) / var_membrane__F; // millivolt
        const double var_background_currents__i_B_Na = (-var_sodium_current__E_Na + var_chaste_interface__membrane__V) * var_background_currents__g_B_Na; // picoA
        const double var_sodium_current_h1_gate__alpha_h = 44.899999999999999 * exp(-12.010771992818672 + 0.17953321364452424 * NV_Ith_S(mParameters, 12) - 0.17953321364452424 * var_chaste_interface__membrane__V); // per_second
        const double var_sodium_current_h1_gate__beta_h = 1491.0 / (1.0 + 323.30000000000001 * exp(-7.333333333333333 + 0.077519379844961239 * NV_Ith_S(mParameters, 12) - 0.077519379844961239 * var_chaste_interface__membrane__V)); // per_second
        const double var_sodium_current_h1_gate__h_infinity = 0.01 * NV_Ith_S(mParameters, 11) + (1.0 - 0.01 * NV_Ith_S(mParameters, 11)) * var_sodium_current_h1_gate__alpha_h / (var_sodium_current_h1_gate__alpha_h + var_sodium_current_h1_gate__beta_h); // dimensionless
    ...
    N_Vector Celllindblad_model_1996FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        NV_Ith_S(dqs, 9) = var_delayed_rectifier_K_current__i_Kr_converted;
        NV_Ith_S(dqs, 10) = var_delayed_rectifier_K_current__i_Ks_converted;
        NV_Ith_S(dqs, 11) = var_Na_Ca_ion_exchanger_current__i_NaCa_converted;
        NV_Ith_S(dqs, 12) = var_membrane__i_Stim_converted;
        NV_Ith_S(dqs, 13) = var_Ca_independent_transient_outward_K_current__i_to_converted;
        NV_Ith_S(dqs, 14) = var_chaste_interface__environment__time_converted;
        return dqs;
    }

template<>
void OdeSystemInformation<Celllindblad_model_1996FromCellMLCvodeDataClamp>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celllindblad_model_1996FromCellMLCvodeDataClamp)
