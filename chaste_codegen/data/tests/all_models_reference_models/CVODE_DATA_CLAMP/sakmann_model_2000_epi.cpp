...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 5) = 1075.0; // (var_fast_sodium_current__nachanneldensity) [per_microF]
        NV_Ith_S(this->mParameters, 6) = 0.20000000000000001; // (var_time_independent_potassium_current__g_K1) [microS]
        NV_Ith_S(this->mParameters, 7) = 7.7000000000000002; // (var_rapid_delayed_rectifier_potassium_current__g_Kr_max) [microS_per_microF]
        NV_Ith_S(this->mParameters, 8) = 26.600000000000001; // (var_slow_delayed_rectifier_potassium_current__g_Ks_max) [microS_per_microF]
    }
    ...
    double Cellsakmann_model_2000_epiFromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_fast_sodium_current__g_Na = 0.63291139240506322 * (0.34000000000000002 + 1.26 / (1.0 + 398.10502010430349 * var_fast_sodium_current_h_gate__proton)) * var_fast_sodium_current__gnachannel * NV_Ith_S(mParameters, 5) * NV_Ith_S(mParameters, 3); // microS
        ...
        const double var_rapid_delayed_rectifier_potassium_current__g_Kr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 1)) * NV_Ith_S(mParameters, 3) * NV_Ith_S(mParameters, 7); // microS
        ...
        const double var_slow_delayed_rectifier_potassium_current__g_Ks = NV_Ith_S(mParameters, 3) * NV_Ith_S(mParameters, 8); // microS
    ...
    N_Vector Cellsakmann_model_2000_epiFromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        ...
        NV_Ith_S(dqs, 6) = var_membrane__i_Stim_converted;
