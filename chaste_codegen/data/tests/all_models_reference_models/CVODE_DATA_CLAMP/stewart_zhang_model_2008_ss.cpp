...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 6) = 0; // (var_sodium_calcium_exchanger_current__K_NaCa) [picoA_per_picoF]
    }
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_membrane__T = 310.0; // kelvin
        const double var_L_type_Ca_current__i_CaL_converted = 4.0 * pow(var_membrane__F, 2) * (-15.0 + var_chaste_interface__membrane__V) * (-var_calcium_dynamics__Ca_o + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * exp(2.0 * (-15.0 + var_chaste_interface__membrane__V) * var_membrane__F / (var_membrane__R * var_membrane__T))) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f / ((-1.0 + exp(2.0 * (-15.0 + var_chaste_interface__membrane__V) * var_membrane__F / (var_membrane__R * var_membrane__T))) * var_membrane__R * var_membrane__T); // uA_per_cm2
        const double var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 1); // uA_per_cm2
        const double var_L_type_Ca_current__i_CaL = (var_L_type_Ca_current__i_CaL_converted + var_chaste_interface__membrane_data_clamp_current) / HeartConfig::Instance()->GetCapacitance(); // picoA_per_picoF
    ...
    N_Vector Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        ...
        NV_Ith_S(dqs, 6) = var_sodium_calcium_exchanger_current__K_NaCa_converted;
        return dqs;
    }
