...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 7) = 0; // (var_time_dependent_rectifier_potassium_current__i_Kmax) [nanoA]
    }
