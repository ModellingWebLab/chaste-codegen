...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClamp::Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClamp>::Instance();
        Init();
    ...
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClamp::~Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClamp()
    {
    }

    
    double Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClamp>::Initialise(void)
{
