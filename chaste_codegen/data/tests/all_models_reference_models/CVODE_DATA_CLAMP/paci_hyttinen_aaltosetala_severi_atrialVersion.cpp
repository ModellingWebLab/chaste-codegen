...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClamp::Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClamp>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 9) = 6646.1850000000004; // (var_i_Na__g_Na) [S_per_F]
        NV_Ith_S(this->mParameters, 10) = 30.103120000000001; // (var_i_f__g_f) [S_per_F]
        NV_Ith_S(this->mParameters, 11) = 19.192499999999999; // (var_i_K1__g_K1) [S_per_F]
        NV_Ith_S(this->mParameters, 12) = 29.866700000000002; // (var_i_Kr__g_Kr) [S_per_F]
        NV_Ith_S(this->mParameters, 13) = 2.0409999999999999; // (var_i_Ks__g_Ks) [S_per_F]
        NV_Ith_S(this->mParameters, 14) = 2450.0; // (var_i_NaCa__kNaCa) [A_per_F]
        NV_Ith_S(this->mParameters, 15) = 1.4731392000000001; // (var_i_NaK__PNaK) [A_per_F]
        NV_Ith_S(this->mParameters, 16) = 59.807699999999997; // (var_i_to__g_to) [S_per_F]
        NV_Ith_S(this->mParameters, 17) = 7.8667100000000004e-11; // (var_model_parameters__Cm) [farad]
        NV_Ith_S(this->mParameters, 18) = 310.0; // (var_model_parameters__T) [kelvin]
    }

    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClamp::~Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClamp()
    {
    }

    
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_i_f__i_f = (-var_i_f__E_f + var_Membrane__Vm) * NV_Ith_S(mParameters, 10) * var_chaste_interface__i_f_Xf_gate__Xf; // A_per_F
        ...
        const double var_i_K1__i_K1 = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 2)) * (-var_electric_potentials__E_K + var_Membrane__Vm) * var_i_K1__XK1_inf * NV_Ith_S(mParameters, 11); // A_per_F
        const double var_i_K1__i_K1_converted = HeartConfig::Instance()->GetCapacitance() * var_i_K1__i_K1; // uA_per_cm2
        const double var_i_Kr__i_Kr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 2)) * (-var_electric_potentials__E_K + var_Membrane__Vm) * NV_Ith_S(mParameters, 12) * var_chaste_interface__i_Kr_Xr1_gate__Xr1 * var_chaste_interface__i_Kr_Xr2_gate__Xr2; // A_per_F
        ...
        const double var_i_to__i_to = (-var_electric_potentials__E_K + var_Membrane__Vm) * NV_Ith_S(mParameters, 16) * var_chaste_interface__i_to_q_gate__q * var_chaste_interface__i_to_r_gate__r; // A_per_F
        const double var_i_to__i_to_converted = HeartConfig::Instance()->GetCapacitance() * var_i_to__i_to; // uA_per_cm2
        const double var_electric_potentials__E_Ks = var_model_parameters__R * NV_Ith_S(mParameters, 18) * log((var_electric_potentials__PkNa * NV_Ith_S(mParameters, 3) + NV_Ith_S(mParameters, 2)) / (var_electric_potentials__PkNa * var_chaste_interface__sodium_dynamics__Nai + NV_Ith_S(mParameters, 0))) / var_model_parameters__F; // volt
        const double var_electric_potentials__E_Na = var_model_parameters__R * NV_Ith_S(mParameters, 18) * log(NV_Ith_S(mParameters, 3) / var_chaste_interface__sodium_dynamics__Nai) / var_model_parameters__F; // volt
        const double var_i_Ks__i_Ks = pow(var_chaste_interface__i_Ks_Xs_gate__Xs, 2) * (1.0 + 0.59999999999999998 / (1.0 + 6.4818210260626455e-7 * pow((1 / var_chaste_interface__calcium_dynamics__Cai), 1.3999999999999999))) * (-var_electric_potentials__E_Ks + var_Membrane__Vm) * NV_Ith_S(mParameters, 13); // A_per_F
        const double var_i_Ks__i_Ks_converted = HeartConfig::Instance()->GetCapacitance() * var_i_Ks__i_Ks; // uA_per_cm2
        const double var_i_Na__i_Na = pow(var_chaste_interface__i_Na_m_gate__m, 3) * (-var_electric_potentials__E_Na + var_Membrane__Vm) * NV_Ith_S(mParameters, 9) * var_chaste_interface__i_Na_h_gate__h * var_chaste_interface__i_Na_j_gate__j; // A_per_F
        const double var_i_Na__i_Na_converted = HeartConfig::Instance()->GetCapacitance() * var_i_Na__i_Na; // uA_per_cm2
        const double var_i_NaCa__i_NaCa = (pow(var_chaste_interface__sodium_dynamics__Nai, 3) * NV_Ith_S(mParameters, 1) * exp(var_Membrane__Vm * var_i_NaCa__gamma * var_model_parameters__F / (var_model_parameters__R * NV_Ith_S(mParameters, 18))) - pow(NV_Ith_S(mParameters, 3), 3) * var_chaste_interface__calcium_dynamics__Cai * var_i_NaCa__alpha * exp((-1.0 + var_i_NaCa__gamma) * var_Membrane__Vm * var_model_parameters__F / (var_model_parameters__R * NV_Ith_S(mParameters, 18)))) * NV_Ith_S(mParameters, 14) / ((1.0 + var_i_NaCa__Ksat * exp((-1.0 + var_i_NaCa__gamma) * var_Membrane__Vm * var_model_parameters__F / (var_model_parameters__R * NV_Ith_S(mParameters, 18)))) * (pow(var_i_NaCa__KmNai, 3) + pow(NV_Ith_S(mParameters, 3), 3)) * (var_i_NaCa__KmCa + NV_Ith_S(mParameters, 1))); // A_per_F
        const double var_i_NaCa__i_NaCa_converted = HeartConfig::Instance()->GetCapacitance() * var_i_NaCa__i_NaCa; // uA_per_cm2
        const double var_i_NaK__i_NaK = NV_Ith_S(mParameters, 15) * NV_Ith_S(mParameters, 2) * var_chaste_interface__sodium_dynamics__Nai / ((var_i_NaK__Km_K + NV_Ith_S(mParameters, 2)) * (var_i_NaK__Km_Na + var_chaste_interface__sodium_dynamics__Nai) * (1.0 + 0.035299999999999998 * exp(-var_Membrane__Vm * var_model_parameters__F / (var_model_parameters__R * NV_Ith_S(mParameters, 18))) + 0.1245 * exp(-0.10000000000000001 * var_Membrane__Vm * var_model_parameters__F / (var_model_parameters__R * NV_Ith_S(mParameters, 18))))); // A_per_F
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Membrane__Vm_converted = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_electric_potentials__E_Ca = 0.5 * var_model_parameters__R * NV_Ith_S(mParameters, 18) * log(NV_Ith_S(mParameters, 1) / var_chaste_interface__calcium_dynamics__Cai) / var_model_parameters__F; // volt
        const double var_i_CaL__i_CaL = ((fabs(var_Membrane__Vm) < 4.3086710741444596e-12 * fabs(NV_Ith_S(mParameters, 18))) ? (116045061550.51096 * (4.3086710741444596e-12 * NV_Ith_S(mParameters, 18) + var_Membrane__Vm) * (0.019297068299999998 * (-0.34100000000000003 * NV_Ith_S(mParameters, 1) + var_chaste_interface__calcium_dynamics__Cai * exp(9.9999999999999995e-8)) * NV_Ith_S(mParameters, 4) * var_chaste_interface__i_CaL_d_gate__d * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_f2_gate__f2 * var_chaste_interface__i_CaL_fCa_gate__fCa / (-1.0 + exp(9.9999999999999995e-8)) + 0.019297068299999998 * (-0.34100000000000003 * NV_Ith_S(mParameters, 1) + var_chaste_interface__calcium_dynamics__Cai * exp(-9.9999999999999995e-8)) * NV_Ith_S(mParameters, 4) * var_chaste_interface__i_CaL_d_gate__d * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_f2_gate__f2 * var_chaste_interface__i_CaL_fCa_gate__fCa / (-1.0 + exp(-9.9999999999999995e-8))) / NV_Ith_S(mParameters, 18) - 0.019297068299999998 * (-0.34100000000000003 * NV_Ith_S(mParameters, 1) + var_chaste_interface__calcium_dynamics__Cai * exp(-9.9999999999999995e-8)) * NV_Ith_S(mParameters, 4) * var_chaste_interface__i_CaL_d_gate__d * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_f2_gate__f2 * var_chaste_interface__i_CaL_fCa_gate__fCa / (-1.0 + exp(-9.9999999999999995e-8))) : (4478658957.2358274 * (-0.34100000000000003 * NV_Ith_S(mParameters, 1) + var_chaste_interface__calcium_dynamics__Cai * exp(23209.012310102189 * var_Membrane__Vm / NV_Ith_S(mParameters, 18))) * var_Membrane__Vm * NV_Ith_S(mParameters, 4) * var_chaste_interface__i_CaL_d_gate__d * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_f2_gate__f2 * var_chaste_interface__i_CaL_fCa_gate__fCa / ((-1.0 + exp(23209.012310102189 * var_Membrane__Vm / NV_Ith_S(mParameters, 18))) * NV_Ith_S(mParameters, 18)))); // A_per_F
        const double var_i_Kr_Xr1_gate__V_half = -19.0 - 1000.0 * (-2.1789087017666886 + log(pow((1.0 + 0.38461538461538458 * NV_Ith_S(mParameters, 1)), 4) / (pow((0.57999999999999996 + NV_Ith_S(mParameters, 1)), 4) * var_i_Kr_Xr1_gate__L0))) * var_model_parameters__R * NV_Ith_S(mParameters, 18) / (var_i_Kr_Xr1_gate__Q * var_model_parameters__F); // millivolt
        ...
        const double var_i_NaK__i_NaK = NV_Ith_S(mParameters, 15) * NV_Ith_S(mParameters, 2) * var_chaste_interface__sodium_dynamics__Nai / ((var_i_NaK__Km_K + NV_Ith_S(mParameters, 2)) * (var_i_NaK__Km_Na + var_chaste_interface__sodium_dynamics__Nai) * (1.0 + 0.035299999999999998 * exp(-var_Membrane__Vm * var_model_parameters__F / (var_model_parameters__R * NV_Ith_S(mParameters, 18))) + 0.1245 * exp(-0.10000000000000001 * var_Membrane__Vm * var_model_parameters__F / (var_model_parameters__R * NV_Ith_S(mParameters, 18))))); // A_per_F
        const double var_i_b_Na__i_b_Na = (-var_electric_potentials__E_Na + var_Membrane__Vm) * NV_Ith_S(mParameters, 6); // A_per_F
        const double var_sodium_dynamics__Nai_orig_deriv = -9.9999999999999987e+17 * (3.0 * var_i_NaCa__i_NaCa + 3.0 * var_i_NaK__i_NaK + var_i_Na__i_Na + var_i_b_Na__i_b_Na) * NV_Ith_S(mParameters, 17) / (var_model_parameters__F * var_model_parameters__Vc); // millimolar / second
        ...
        else
        {
            ...
            if (mDataClampIsOn)
            {
                var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time_converted) + var_chaste_interface__Membrane__Vm_converted) * NV_Ith_S(mParameters, 8); // uA_per_cm2
            }
            const double var_Membrane__Vm_orig_deriv = -var_i_CaL__i_CaL - var_i_K1__i_K1 - var_i_Kr__i_Kr - var_i_Ks__i_Ks - var_i_Na__i_Na - var_i_NaCa__i_NaCa - var_i_NaK__i_NaK - var_i_PCa__i_PCa - var_i_b_Ca__i_b_Ca - var_i_b_Na__i_b_Na - var_i_f__i_f - var_i_to__i_to - var_chaste_interface__membrane_data_clamp_current + var_stim_mode__i_stim; // volt / second
    ...
    N_Vector Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Membrane__Vm_converted = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_model_parameters__Cm_converted = 1000000.0 * NV_Ith_S(mParameters, 17); // uF
        const double var_model_parameters__F = 96485.341499999995; // coulomb_per_mole
        const double var_model_parameters__R = 8.3144720000000003; // joule_per_mole_kelvin
        const double var_electric_potentials__E_K = var_model_parameters__R * NV_Ith_S(mParameters, 18) * log(NV_Ith_S(mParameters, 2) / NV_Ith_S(mParameters, 0)) / var_model_parameters__F; // volt
        const double var_i_CaL__i_CaL = ((fabs(var_Membrane__Vm) < 4.3086710741444596e-12 * fabs(NV_Ith_S(mParameters, 18))) ? (116045061550.51096 * (4.3086710741444596e-12 * NV_Ith_S(mParameters, 18) + var_Membrane__Vm) * (0.019297068299999998 * (-0.34100000000000003 * NV_Ith_S(mParameters, 1) + var_chaste_interface__calcium_dynamics__Cai * exp(9.9999999999999995e-8)) * NV_Ith_S(mParameters, 4) * var_chaste_interface__i_CaL_d_gate__d * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_f2_gate__f2 * var_chaste_interface__i_CaL_fCa_gate__fCa / (-1.0 + exp(9.9999999999999995e-8)) + 0.019297068299999998 * (-0.34100000000000003 * NV_Ith_S(mParameters, 1) + var_chaste_interface__calcium_dynamics__Cai * exp(-9.9999999999999995e-8)) * NV_Ith_S(mParameters, 4) * var_chaste_interface__i_CaL_d_gate__d * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_f2_gate__f2 * var_chaste_interface__i_CaL_fCa_gate__fCa / (-1.0 + exp(-9.9999999999999995e-8))) / NV_Ith_S(mParameters, 18) - 0.019297068299999998 * (-0.34100000000000003 * NV_Ith_S(mParameters, 1) + var_chaste_interface__calcium_dynamics__Cai * exp(-9.9999999999999995e-8)) * NV_Ith_S(mParameters, 4) * var_chaste_interface__i_CaL_d_gate__d * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_f2_gate__f2 * var_chaste_interface__i_CaL_fCa_gate__fCa / (-1.0 + exp(-9.9999999999999995e-8))) : (4478658957.2358274 * (-0.34100000000000003 * NV_Ith_S(mParameters, 1) + var_chaste_interface__calcium_dynamics__Cai * exp(23209.012310102189 * var_Membrane__Vm / NV_Ith_S(mParameters, 18))) * var_Membrane__Vm * NV_Ith_S(mParameters, 4) * var_chaste_interface__i_CaL_d_gate__d * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_f2_gate__f2 * var_chaste_interface__i_CaL_fCa_gate__fCa / ((-1.0 + exp(23209.012310102189 * var_Membrane__Vm / NV_Ith_S(mParameters, 18))) * NV_Ith_S(mParameters, 18)))); // A_per_F
        ...
        NV_Ith_S(dqs, 3) = var_i_Na__i_Na_converted;
        NV_Ith_S(dqs, 4) = var_i_f__i_f_converted;
        ...
        NV_Ith_S(dqs, 9) = var_i_NaK__i_NaK_converted;
        NV_Ith_S(dqs, 10) = var_stim_mode__i_stim_converted;
        NV_Ith_S(dqs, 11) = var_i_to__i_to_converted;
        NV_Ith_S(dqs, 12) = var_chaste_interface__Membrane__Vm_converted;
        NV_Ith_S(dqs, 13) = var_chaste_interface__environment__time_converted;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClamp>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClamp)
