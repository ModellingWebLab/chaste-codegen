...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClamp::Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClamp>::Instance();
        Init();
    ...
    Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClamp::~Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClamp()
    {
    }

    
    double Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClamp>::Initialise(void)
{
