...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClamp::Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClamp>::Instance();
        Init();
    ...
    Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClamp::~Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClamp()
    {
    }

    

    void Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClamp::VerifyStateVariables()
    {
    ...
    double Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClamp>::Initialise(void)
{
