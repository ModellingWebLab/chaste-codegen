...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClamp::Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClamp>::Instance();
        Init();
    ...
    Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClamp::~Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClamp()
    {
    }

    
    double Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_time_independent_potassium_current__i_K1 = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 6) / (1.0 + exp(5.6000000000000005 + 0.070000000000000007 * var_chaste_interface__membrane__V)); // picoA_per_picoF
    ...
    void Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        else
        {
            ...
            d_dt_chaste_interface_var_membrane__V = (-var_Ca_activated_Cl_current__i_Cl_Ca - var_Ca_pump_current__i_p_Ca - var_Na_Ca_exchanger_current__i_NaCa - var_background_currents__i_B_Ca - var_background_currents__i_B_Na - var_fast_sodium_current__i_Na - var_membrane__i_stim - var_chaste_interface__membrane_data_clamp_current - var_rapid_delayed_rectifier_K_current__i_Kr - var_sarcolemmal_Ca_current__i_Ca - var_slow_delayed_rectifier_K_current__i_Ks - var_sodium_potassium_pump__i_NaK - var_time_independent_potassium_current__i_K1 - var_transient_outward_K_current__i_to - var_ultrarapid_delayed_rectifier_K_current__i_Kur_d) / NV_Ith_S(mParameters, 3); // millivolt / millisecond
        }
    ...
    N_Vector Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClamp>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClamp)
