...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmatsuoka_model_2003FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        else
        {
            ...
            d_dt_chaste_interface_var_membrane__Vm = (-var_membrane__i_ext - var_membrane__i_tot - var_chaste_interface__membrane_data_clamp_current) / NV_Ith_S(mParameters, 9); // millivolt / millisecond
        }
