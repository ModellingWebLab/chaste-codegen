...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellfink_noble_giles_model_2008FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
    ...
    void Cellfink_noble_giles_model_2008FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_iNa_h_gate__h_inf = 0.01 * NV_Ith_S(mParameters, 11) + (1.0 - 0.01 * NV_Ith_S(mParameters, 11)) / pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V - 0.13458950201884254 * NV_Ith_S(mParameters, 12))), 2); // dimensionless
        ...
        const double var_iNa_j_gate__j_inf = 0.01 * NV_Ith_S(mParameters, 11) + (1.0 - 0.01 * NV_Ith_S(mParameters, 11)) / pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V - 0.13458950201884254 * NV_Ith_S(mParameters, 12))), 2); // dimensionless
