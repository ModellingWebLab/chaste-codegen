...
#include "MathsCustomFunctions.hpp"
    ...
    Cellmcallister_noble_tsien_1975_bFromCellMLCvodeDataClamp::Cellmcallister_noble_tsien_1975_bFromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmcallister_noble_tsien_1975_bFromCellMLCvodeDataClamp>::Instance();
        Init();
    ...
    Cellmcallister_noble_tsien_1975_bFromCellMLCvodeDataClamp::~Cellmcallister_noble_tsien_1975_bFromCellMLCvodeDataClamp()
    {
    }

    
    double Cellmcallister_noble_tsien_1975_bFromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_plateau_potassium_current2__I_x2 = 25.0 + 0.38500000000000001 * var_chaste_interface__membrane__V + NV_Ith_S(mParameters, 4); // microA_per_cm2
    ...
    void Cellmcallister_noble_tsien_1975_bFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        else
        {
            ...
            d_dt_chaste_interface_var_membrane__V = (-var_chloride_background_current__i_Cl_b - var_fast_sodium_current__i_Na - var_chaste_interface__membrane_data_clamp_current - var_pacemaker_potassium_current__i_K2 - var_plateau_potassium_current1__i_x1 - var_plateau_potassium_current2__i_x2 - var_secondary_inward_current__i_si - var_sodium_background_current__i_Na_b - var_time_independent_outward_current__i_K1 - var_transient_chloride_current__i_qr) / NV_Ith_S(mParameters, 1); // millivolt / millisecond
        }
    ...
    N_Vector Cellmcallister_noble_tsien_1975_bFromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellmcallister_noble_tsien_1975_bFromCellMLCvodeDataClamp>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellmcallister_noble_tsien_1975_bFromCellMLCvodeDataClamp)
