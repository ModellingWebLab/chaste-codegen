...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2004_MFromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2004_MFromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellten_tusscher_model_2004_MFromCellMLCvodeDataClamp::Cellten_tusscher_model_2004_MFromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2004_MFromCellMLCvodeDataClamp>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 20) = 0.062; // (var_slow_time_dependent_potassium_current__g_Ks) [nanoS_per_picoF]
    ...
    Cellten_tusscher_model_2004_MFromCellMLCvodeDataClamp::~Cellten_tusscher_model_2004_MFromCellMLCvodeDataClamp()
    {
    }

    
    double Cellten_tusscher_model_2004_MFromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellten_tusscher_model_2004_MFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector Cellten_tusscher_model_2004_MFromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2004_MFromCellMLCvodeDataClamp>::Initialise(void)
{
