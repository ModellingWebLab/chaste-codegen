...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellbueno_2007_epiFromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    Cellbueno_2007_epiFromCellMLCvodeDataClamp::Cellbueno_2007_epiFromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbueno_2007_epiFromCellMLCvodeDataClamp>::Instance();
        Init();
    ...
    Cellbueno_2007_epiFromCellMLCvodeDataClamp::~Cellbueno_2007_epiFromCellMLCvodeDataClamp()
    {
    }

    
    double Cellbueno_2007_epiFromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbueno_2007_epiFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        else
        {
            ...
            d_dt_chaste_interface_var_membrane__V = -(var_fast_inward_current__i_fi + var_membrane__i_stim + var_chaste_interface__membrane_data_clamp_current + var_slow_inward_current__i_si + var_slow_outward_current__i_so) / NV_Ith_S(mParameters, 0); // mV / ms
        }
    ...
    N_Vector Cellbueno_2007_epiFromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellbueno_2007_epiFromCellMLCvodeDataClamp>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbueno_2007_epiFromCellMLCvodeDataClamp)
