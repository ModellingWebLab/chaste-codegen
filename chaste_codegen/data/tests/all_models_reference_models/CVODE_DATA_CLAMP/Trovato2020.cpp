...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellTrovato2020FromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double CellTrovato2020FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    CellTrovato2020FromCellMLCvodeDataClamp::CellTrovato2020FromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<CellTrovato2020FromCellMLCvodeDataClamp>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 7) = 39.4572; // (var_INa__GNa) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 8) = 0.023199999999999998; // (var_If__GfK) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 9) = 0.011599999999999999; // (var_If__GfNa) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 10) = 0.045499999999999999; // (var_IK1__GK1) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 11) = 0.0189; // (var_INaL__GNaL) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 12) = 0.034200000000000001; // (var_IKr__GKr) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 13) = 0.0028999999999999998; // (var_IKs__GKs) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 14) = 0.192; // (var_Ito__Gto) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 15) = 310.0; // (var_physical_constants__T) [kelvin]
    }

    CellTrovato2020FromCellMLCvodeDataClamp::~CellTrovato2020FromCellMLCvodeDataClamp()
    {
    }

    
    double CellTrovato2020FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IK1__GK1Total = 1.000004299990755 * sqrt(NV_Ith_S(mParameters, 1)) * NV_Ith_S(mParameters, 10); // milliS_per_microF
        const double var_IKr__GKr_total = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 1)) * NV_Ith_S(mParameters, 12); // milliS_per_microF
        ...
        const double var_IKs__GKsTotal = NV_Ith_S(mParameters, 13) * var_IKs__KsCa; // milliS_per_microF
        ...
        const double var_INaCa_i__hca = exp(var_INaCa_i__qca * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 3) / (NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15))); // dimensionless
        const double var_INaCa_i__hna = exp(var_INaCa_i__qna * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 3) / (NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15))); // dimensionless
        ...
        const double var_INaK__Knai = var_INaK__Knai0 * exp(0.33333333333333331 * var_INaK__delta * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 3) / (NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15))); // millimolar
        const double var_INaK__Knao = var_INaK__Knao0 * exp(0.33333333333333331 * (1.0 - var_INaK__delta) * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 3) / (NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15))); // millimolar
        ...
        const double var_membrane__vffrt = pow(NV_Ith_S(mParameters, 3), 2) * var_chaste_interface__membrane__v / (NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15)); // coulomb_per_mole
        const double var_membrane__vfrt = var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 3) / (NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15)); // dimensionless
        ...
        const double var_reversal_potentials__ECa = 0.5 * NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15) * log(NV_Ith_S(mParameters, 0) / var_chaste_interface__intracellular_ions__casl) / NV_Ith_S(mParameters, 3); // millivolt
        ...
        const double var_reversal_potentials__EK = NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15) * log(NV_Ith_S(mParameters, 1) / var_chaste_interface__intracellular_ions__ksl) / NV_Ith_S(mParameters, 3); // millivolt
        ...
        const double var_If__IfK = pow(var_chaste_interface__If__y, 2) * (-var_reversal_potentials__EK + var_chaste_interface__membrane__v) * NV_Ith_S(mParameters, 8); // microA_per_microF
        ...
        const double var_Ito__Ito = (-var_reversal_potentials__EK + var_chaste_interface__membrane__v) * NV_Ith_S(mParameters, 14) * var_chaste_interface__Ito__a * var_chaste_interface__Ito__i1 * var_chaste_interface__Ito__i2; // microA_per_microF
        const double var_Ito__Ito_converted = HeartConfig::Instance()->GetCapacitance() * var_Ito__Ito; // uA_per_cm2
        const double var_reversal_potentials__ENa = NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15) * log(NV_Ith_S(mParameters, 2) / var_chaste_interface__intracellular_ions__nasl) / NV_Ith_S(mParameters, 3); // millivolt
        const double var_INa__INa = pow(var_chaste_interface__INa__m, 3) * (-var_reversal_potentials__ENa + var_chaste_interface__membrane__v) * ((1.0 - var_INa__fINap) * var_INa__h * var_chaste_interface__INa__j + var_INa__fINap * var_INa__hp * var_chaste_interface__INa__jp) * NV_Ith_S(mParameters, 7); // microA_per_microF
        const double var_INa__INa_converted = HeartConfig::Instance()->GetCapacitance() * var_INa__INa; // uA_per_cm2
        const double var_INaL__INaL = (-var_reversal_potentials__ENa + var_chaste_interface__membrane__v) * ((1.0 - var_INaL__fINaLp) * var_chaste_interface__INaL__hL + var_INaL__fINaLp * var_chaste_interface__INaL__hLp) * NV_Ith_S(mParameters, 11) * var_chaste_interface__INaL__mL; // microA_per_microF
        const double var_INaL__INaL_converted = HeartConfig::Instance()->GetCapacitance() * var_INaL__INaL; // uA_per_cm2
        const double var_If__IfNa = pow(var_chaste_interface__If__y, 2) * (-var_reversal_potentials__ENa + var_chaste_interface__membrane__v) * NV_Ith_S(mParameters, 9); // microA_per_microF
    ...
    void CellTrovato2020FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector CellTrovato2020FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        NV_Ith_S(dqs, 3) = var_If__If_converted;
        NV_Ith_S(dqs, 4) = var_IK1__IK1_converted;
        NV_Ith_S(dqs, 5) = var_IK1__GK1Total;
        NV_Ith_S(dqs, 6) = var_INaL__INaL_converted;
        NV_Ith_S(dqs, 7) = var_IKr__IKr_converted;
        NV_Ith_S(dqs, 8) = var_IKr__GKr_total;
        NV_Ith_S(dqs, 9) = var_IKs__IKs_converted;
        NV_Ith_S(dqs, 10) = var_IKs__GKsTotal;
        NV_Ith_S(dqs, 11) = var_membrane__Istim_converted;
        NV_Ith_S(dqs, 12) = var_Ito__Ito_converted;
        NV_Ith_S(dqs, 13) = var_reversal_potentials__EK;
        NV_Ith_S(dqs, 14) = var_reversal_potentials__EKs;
...
template<>
void OdeSystemInformation<CellTrovato2020FromCellMLCvodeDataClamp>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellTrovato2020FromCellMLCvodeDataClamp)
