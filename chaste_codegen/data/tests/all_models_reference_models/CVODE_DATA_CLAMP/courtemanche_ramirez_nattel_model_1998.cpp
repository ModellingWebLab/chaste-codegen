...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellcourtemanche_ramirez_nattel_model_1998FromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = -2000 * HeartConfig::Instance()->GetCapacitance() / NV_Ith_S(mParameters, 0); // uA_per_cm2
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 0) = 100; // (var_membrane__Cm) [picoF]
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_sarcolemmal_calcium_pump_current__i_CaP = var_chaste_interface__intracellular_ion_concentrations__Ca_i * NV_Ith_S(mParameters, 0) * var_sarcolemmal_calcium_pump_current__i_CaP_max / (00050000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i); // picoA
        ...
        const double var_time_independent_potassium_current__i_K1 = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 0) * var_time_independent_potassium_current__g_K1 / (1.0 + exp(5.6000000000000005 + 070000000000000007 * var_chaste_interface__membrane__V)); // picoA
