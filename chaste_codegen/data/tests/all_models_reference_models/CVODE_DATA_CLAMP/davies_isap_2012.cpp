...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celldavies_isap_2012FromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Celldavies_isap_2012FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Celldavies_isap_2012FromCellMLCvodeDataClamp::Celldavies_isap_2012FromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celldavies_isap_2012FromCellMLCvodeDataClamp>::Instance();
        Init();
    ...
    Celldavies_isap_2012FromCellMLCvodeDataClamp::~Celldavies_isap_2012FromCellMLCvodeDataClamp()
    {
    }

    
    double Celldavies_isap_2012FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IKp__IKp = (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 13) / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V)); // uA_per_uF
    ...
    void Celldavies_isap_2012FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector Celldavies_isap_2012FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Celldavies_isap_2012FromCellMLCvodeDataClamp>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celldavies_isap_2012FromCellMLCvodeDataClamp)
