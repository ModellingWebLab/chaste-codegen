...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celliyer_model_2007FromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Celliyer_model_2007FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 8) = 0.12530512611880801; // (var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__GK1) [mS_per_uF]
        NV_Ith_S(this->mParameters, 9) = 0.018599999999999998; // (var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__GKr) [mS_per_uF]
        NV_Ith_S(this->mParameters, 10) = 0.0035000000000000001; // (var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__GKs) [mS_per_uF]
        NV_Ith_S(this->mParameters, 11) = 0.44; // (var_COMPUTE_INaK_INaCa_ICab_IpCa__kNaCa) [uA_per_uF]
        NV_Ith_S(this->mParameters, 12) = 2.387; // (var_COMPUTE_INaK_INaCa_ICab_IpCa__INaKmax) [uA_per_uF]
    }
    ...
    double Celliyer_model_2007FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_COMPUTE_INaK_INaCa_ICab_IpCa__INaCa = (-var_COMPUTE_INaK_INaCa_ICab_IpCa__a2_ncx + var_COMPUTE_INaK_INaCa_ICab_IpCa__a1_ncx) * NV_Ith_S(mParameters, 11) / (var_COMPUTE_INaK_INaCa_ICab_IpCa__a3_ncx * var_COMPUTE_INaK_INaCa_ICab_IpCa__a4_ncx * var_COMPUTE_INaK_INaCa_ICab_IpCa__a5_ncx); // uA_per_uF
        ...
        const double var_COMPUTE_INaK_INaCa_ICab_IpCa__INaK = NV_Ith_S(mParameters, 12) * var_COMPUTE_INaK_INaCa_ICab_IpCa__a1_K * var_COMPUTE_INaK_INaCa_ICab_IpCa__fNaK / var_COMPUTE_INaK_INaCa_ICab_IpCa__a2_K; // uA_per_uF
        ...
        const double var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__IK1 = sqrt(NV_Ith_S(mParameters, 3)) * (-var_COMPUTE_REVERSAL_POTENTIALS__EK + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * NV_Ith_S(mParameters, 8) * var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__K1_inf; // uA_per_uF
        ...
        const double var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__IKr = (-var_COMPUTE_REVERSAL_POTENTIALS__EK + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * NV_Ith_S(mParameters, 9) * var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__fKo * var_chaste_interface__IKr__OHerg; // uA_per_uF
        const double var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__IKs = (-var_COMPUTE_REVERSAL_POTENTIALS__EKs + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * (var_chaste_interface__IKs__O1ks + var_chaste_interface__IKs__O2ks) * NV_Ith_S(mParameters, 10); // uA_per_uF
    ...
    void Celliyer_model_2007FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        else
        {
            ...
            if (mDataClampIsOn)
            {
                var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * NV_Ith_S(mParameters, 6); // uA_per_cm2
            }
