...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClamp::Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClamp>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 11) = 7.7999999999999998; // (var_fast_sodium_current__g_Na) [nanoS_per_picoF]
        ...
        NV_Ith_S(this->mParameters, 14) = 0.089999999999999997; // (var_time_independent_potassium_current__g_K1) [nanoS_per_picoF]
        NV_Ith_S(this->mParameters, 15) = 0.029411764999999999; // (var_rapid_delayed_rectifier_K_current__g_Kr) [nanoS_per_picoF]
        NV_Ith_S(this->mParameters, 16) = 0.12941175999999999; // (var_slow_delayed_rectifier_K_current__g_Ks) [nanoS_per_picoF]
        NV_Ith_S(this->mParameters, 17) = 1600.0; // (var_Na_Ca_exchanger_current__I_NaCa_max) [picoA_per_picoF]
        NV_Ith_S(this->mParameters, 18) = 0.16520000000000001; // (var_transient_outward_K_current__g_to) [nanoS_per_picoF]
    }

    Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClamp::~Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClamp()
    {
    }

    
    double Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_slow_delayed_rectifier_K_current__i_Ks = pow(var_chaste_interface__slow_delayed_rectifier_K_current_xs_gate__xs, 2) * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 9) * NV_Ith_S(mParameters, 16); // picoA
        ...
        const double var_time_independent_potassium_current__i_K1 = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 9) * NV_Ith_S(mParameters, 14) / (1.0 + exp(5.6000000000000005 + 0.070000000000000007 * var_chaste_interface__membrane__V)); // picoA
    ...
    void Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40.0) ? (0.13500000000000001 * exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 13) - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0)); // per_millisecond
        const double var_fast_sodium_current_h_gate__beta_h = ((var_chaste_interface__membrane__V < -40.0) ? (310000.0 * exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * NV_Ith_S(mParameters, 13)) + 3.5600000000000001 * exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 13))) : (7.6923076923076916 / (1.0 + exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 13) - 0.0900900900900901 * var_chaste_interface__membrane__V)))); // per_millisecond
    ...
    N_Vector Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        NV_Ith_S(dqs, 9) = var_rapid_delayed_rectifier_K_current__i_Kr_converted;
        NV_Ith_S(dqs, 10) = var_slow_delayed_rectifier_K_current__i_Ks_converted;
        NV_Ith_S(dqs, 11) = var_Na_Ca_exchanger_current__i_NaCa_converted;
        NV_Ith_S(dqs, 12) = var_membrane__i_st_converted;
        NV_Ith_S(dqs, 13) = var_transient_outward_K_current__i_to_converted;
        NV_Ith_S(dqs, 14) = var_chaste_interface__environment__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClamp>::Initialise(void)
{
