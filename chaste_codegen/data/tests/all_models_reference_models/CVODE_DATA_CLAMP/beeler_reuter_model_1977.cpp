...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbeeler_reuter_model_1977FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_sodium_current_h_gate__h_inf = 0.01 * NV_Ith_S(mParameters, 4) + (1.0 - 0.01 * NV_Ith_S(mParameters, 4)) * var_sodium_current_h_gate__alpha_h / (var_sodium_current_h_gate__alpha_h + var_sodium_current_h_gate__beta_h); // dimensionless
        ...
        const double var_sodium_current_j_gate__j_inf = 0.01 * NV_Ith_S(mParameters, 4) + (1.0 - 0.01 * NV_Ith_S(mParameters, 4)) * var_sodium_current_j_gate__alpha_j / (var_sodium_current_j_gate__alpha_j + var_sodium_current_j_gate__beta_j); // dimensionless
        ...
        const double var_sodium_current_m_gate__alpha_m = ((fabs(47.0 + var_chaste_interface__membrane__V) < 1.0000000010279564e-6) ? (1.0000000045806701e-6 / (-1.0 + exp(1.0000000045806701e-7)) + 499999.99948602181 * (47.000001000000005 + var_chaste_interface__membrane__V) * (-9.9999999747524271e-7 / (-1.0 + exp(-9.9999999747524276e-8)) - 1.0000000045806701e-6 / (-1.0 + exp(1.0000000045806701e-7)))) : (-(47.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-4.7000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V)))); // per_ms
