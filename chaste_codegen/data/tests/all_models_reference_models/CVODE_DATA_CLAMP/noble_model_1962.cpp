...
#include "MathsCustomFunctions.hpp"
    ...
    Cellnoble_model_1962FromCellMLCvodeDataClamp::Cellnoble_model_1962FromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnoble_model_1962FromCellMLCvodeDataClamp>::Instance();
        Init();
    ...
    Cellnoble_model_1962FromCellMLCvodeDataClamp::~Cellnoble_model_1962FromCellMLCvodeDataClamp()
    {
    }

    
    double Cellnoble_model_1962FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_potassium_channel__g_K1 = NV_Ith_S(mParameters, 6) * exp(1.5 + 0.016666666666666666 * var_chaste_interface__membrane__V) + NV_Ith_S(mParameters, 2) * exp(-1.8 - 0.02 * var_chaste_interface__membrane__V); // milliS_per_cm2
    ...
    void Cellnoble_model_1962FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_sodium_channel_h_gate__h_inf = 0.01 * NV_Ith_S(mParameters, 4) + (1.0 - 0.01 * NV_Ith_S(mParameters, 4)) * var_sodium_channel_h_gate__alpha_h / (var_sodium_channel_h_gate__alpha_h + var_sodium_channel_h_gate__beta_h); // dimensionless
        ...
        else
        {
            ...
            d_dt_chaste_interface_var_membrane__V = (-var_leakage_current__i_Leak - var_chaste_interface__membrane_data_clamp_current - var_potassium_channel__i_K - var_sodium_channel__i_Na) / NV_Ith_S(mParameters, 0); // millivolt / millisecond
        }
    ...
    N_Vector Cellnoble_model_1962FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellnoble_model_1962FromCellMLCvodeDataClamp>::Initialise(void)
{
