...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellbueno_2007_endoFromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    Cellbueno_2007_endoFromCellMLCvodeDataClamp::Cellbueno_2007_endoFromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbueno_2007_endoFromCellMLCvodeDataClamp>::Instance();
        Init();
    ...
    Cellbueno_2007_endoFromCellMLCvodeDataClamp::~Cellbueno_2007_endoFromCellMLCvodeDataClamp()
    {
    }

    
    double Cellbueno_2007_endoFromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbueno_2007_endoFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector Cellbueno_2007_endoFromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellbueno_2007_endoFromCellMLCvodeDataClamp>::Initialise(void)
{
