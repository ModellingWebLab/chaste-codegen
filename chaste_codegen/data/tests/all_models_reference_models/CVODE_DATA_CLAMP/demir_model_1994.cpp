...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 3) = 0.0069300000000000004; // (var_delayed_rectifying_potassium_current__g_K_max) [microS]
        NV_Ith_S(this->mParameters, 4) = 0.0034399999999999999; // (var_sodium_current__P_Na) [mul_per_second]
        NV_Ith_S(this->mParameters, 5) = 0.0128821; // (var_hyperpolarisation_activated_current__g_f_K) [microS]
        NV_Ith_S(this->mParameters, 6) = 0.0067478; // (var_hyperpolarisation_activated_current__g_f_Na) [microS]
    }
    ...
    double Celldemir_model_1994FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_delayed_rectifying_potassium_current__g_K = pow(var_cleft_space_equations__K_b, 0.58999999999999997) * NV_Ith_S(mParameters, 3); // microS
        ...
        const double var_hyperpolarisation_activated_current__i_f_K = pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2) * (85.0 + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 5); // nanoA
        const double var_hyperpolarisation_activated_current__i_f_Na = pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2) * (-75.0 + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 6); // nanoA
    ...
    void Celldemir_model_1994FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        else
        {
            ...
            if (mDataClampIsOn)
            {
                var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time_converted) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2); // uA_per_cm2
            }
    ...
    N_Vector Celldemir_model_1994FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        ...
        NV_Ith_S(dqs, 4) = var_hyperpolarisation_activated_current__i_f_converted;
        NV_Ith_S(dqs, 5) = var_hyperpolarisation_activated_current__i_f_K;
        NV_Ith_S(dqs, 6) = var_hyperpolarisation_activated_current__i_f_Na;
