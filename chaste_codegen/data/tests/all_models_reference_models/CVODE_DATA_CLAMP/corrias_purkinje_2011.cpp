...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellcorrias_purkinje_2011FromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Cellcorrias_purkinje_2011FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellcorrias_purkinje_2011FromCellMLCvodeDataClamp::Cellcorrias_purkinje_2011FromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellcorrias_purkinje_2011FromCellMLCvodeDataClamp>::Instance();
        Init();
    ...
    Cellcorrias_purkinje_2011FromCellMLCvodeDataClamp::~Cellcorrias_purkinje_2011FromCellMLCvodeDataClamp()
    {
    }

    
    double Cellcorrias_purkinje_2011FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellcorrias_purkinje_2011FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__Time__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_y_na_fast__y_inf_na_fast = 1 / (1.0 + exp(17.424242424242426 + 0.25252525252525254 * var_chaste_interface__membrane__Vm - 0.25252525252525254 * NV_Ith_S(mParameters, 11))); // dimensionless
    ...
    N_Vector Cellcorrias_purkinje_2011FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__Time__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellcorrias_purkinje_2011FromCellMLCvodeDataClamp>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellcorrias_purkinje_2011FromCellMLCvodeDataClamp)
