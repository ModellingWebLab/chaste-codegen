...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellmahajan_shiferaw_2008FromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    double Cellmahajan_shiferaw_2008FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellmahajan_shiferaw_2008FromCellMLCvodeDataClamp::Cellmahajan_shiferaw_2008FromCellMLCvodeDataClamp(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmahajan_shiferaw_2008FromCellMLCvodeDataClamp>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 12) = 12.0; // (var_INa__gna) [uS_per_nF]
        NV_Ith_S(this->mParameters, 13) = 0; // (var_INa__perc_reduced_inact_for_IpNa) [dimensionless]
        NV_Ith_S(this->mParameters, 14) = 0; // (var_INa__shift_h) [mV]
        NV_Ith_S(this->mParameters, 15) = 0.11; // (var_Ito__gtof) [uS_per_nF]
        NV_Ith_S(this->mParameters, 16) = 0.29999999999999999; // (var_IK1__gkix) [uS_per_nF]
        NV_Ith_S(this->mParameters, 17) = 0.012500000000000001; // (var_IKr__gkr) [uS_per_nF]
        NV_Ith_S(this->mParameters, 18) = 0.1386; // (var_IKs__gks) [uS_per_nF]
        NV_Ith_S(this->mParameters, 19) = 0.040000000000000001; // (var_Ito__gtos) [uS_per_nF]
        NV_Ith_S(this->mParameters, 20) = 0.83999999999999997; // (var_INaCa__gNaCa) [uM_per_ms]
        NV_Ith_S(this->mParameters, 21) = 308.0; // (var_Environment__T) [kelvin]
    }

    Cellmahajan_shiferaw_2008FromCellMLCvodeDataClamp::~Cellmahajan_shiferaw_2008FromCellMLCvodeDataClamp()
    {
    }

    
    double Cellmahajan_shiferaw_2008FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_Environment__FonRT = NV_Ith_S(mParameters, 8) / (NV_Ith_S(mParameters, 9) * NV_Ith_S(mParameters, 21)); // per_mV
        ...
        const double var_IK1__gkix_total = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 6)) * NV_Ith_S(mParameters, 16); // uS_per_nF
        const double var_IKr__gkr_total = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 6)) * NV_Ith_S(mParameters, 17); // uS_per_nF
        const double var_IKs__gksx = 1.0 + 0.80000000000000004 / (1.0 + 0.125 / pow(var_Ca__Ca_i, 3)); // dimensionless
        const double var_IKs__gks_total = NV_Ith_S(mParameters, 18) * var_IKs__gksx; // uS_per_nF
        ...
        const double var_INaCa__jNaCa = var_INaCa__aloss * NV_Ith_S(mParameters, 20) * var_INaCa__zw3 / (var_INaCa__zw4 * var_INaCa__zw8); // uM_per_ms
        ...
        const double var_Ito__xitof = (-var_reversal_potentials__ek + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 15) * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof; // nA_per_nF
        const double var_Ito__xitos = (-var_reversal_potentials__ek + var_chaste_interface__cell__V) * (0.5 * var_Ito__rs_inf + var_chaste_interface__Ito__ytos) * NV_Ith_S(mParameters, 19) * var_chaste_interface__Ito__xtos; // nA_per_nF
        ...
        const double var_INa__xina = pow(var_chaste_interface__INa__xm, 3) * (-var_reversal_potentials__ena + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 12) * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj; // nA_per_nF
    ...
    void Cellmahajan_shiferaw_2008FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_INa__ah = ((var_chaste_interface__cell__V < -40.0) ? (0.13500000000000001 * exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 14) - 0.14705882352941177 * var_chaste_interface__cell__V)) : (0)); // per_ms
        const double var_INa__aj = ((var_chaste_interface__cell__V < -40.0) ? ((37.780000000000001 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.24440000000000001 * var_chaste_interface__cell__V - 0.24440000000000001 * NV_Ith_S(mParameters, 14)) - 3.4740000000000003e-5 * exp(0.043909999999999998 * NV_Ith_S(mParameters, 14) - 0.043909999999999998 * var_chaste_interface__cell__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))) : (0)); // per_ms
        ...
        const double var_INa__h_inf = 0.01 * NV_Ith_S(mParameters, 13) + (1.0 - 0.01 * NV_Ith_S(mParameters, 13)) * var_INa__ah / (var_INa__ah + var_INa__bh); // dimensionless
        const double var_INa__j_inf = 0.01 * NV_Ith_S(mParameters, 13) + (1.0 - 0.01 * NV_Ith_S(mParameters, 13)) * var_INa__aj / (var_INa__aj + var_INa__bj); // dimensionless
        ...
        else
        {
            ...
            if (mDataClampIsOn)
            {
                var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__Environment__time) + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 11); // uA_per_cm2
            }
    ...
    N_Vector Cellmahajan_shiferaw_2008FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        NV_Ith_S(dqs, 7) = var_INa__xina_converted;
        NV_Ith_S(dqs, 8) = var_INa__tau_h;
        NV_Ith_S(dqs, 9) = var_INa__tau_j;
        NV_Ith_S(dqs, 10) = var_IK1__xik1_converted;
        NV_Ith_S(dqs, 11) = var_IK1__gkix_total;
        NV_Ith_S(dqs, 12) = var_IKr__xikr_converted;
        NV_Ith_S(dqs, 13) = var_IKr__gkr_total;
        NV_Ith_S(dqs, 14) = var_IKs__xiks_converted;
        NV_Ith_S(dqs, 15) = var_IKs__gks_total;
        NV_Ith_S(dqs, 16) = var_INaCa__xiNaCa_converted;
        NV_Ith_S(dqs, 17) = var_cell__i_Stim_converted;
        NV_Ith_S(dqs, 18) = var_Ito__xito_converted;
        NV_Ith_S(dqs, 19) = var_reversal_potentials__ek;
        NV_Ith_S(dqs, 20) = var_reversal_potentials__ena;
        NV_Ith_S(dqs, 21) = var_Ca__dcsib;
        NV_Ith_S(dqs, 22) = var_chaste_interface__Environment__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellmahajan_shiferaw_2008FromCellMLCvodeDataClamp>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellmahajan_shiferaw_2008FromCellMLCvodeDataClamp)
