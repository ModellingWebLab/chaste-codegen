...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celldifrancesco_noble_model_1985FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        const double var_x13 = exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V);
        ...
        const double var_x46 = 1 / (1.0 - exp(-2.0 - 0.20000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_x70 = exp(-0.037433890822745473 * var_chaste_interface__membrane__V);
        ...
        const double var_x118 = exp(3.7433890822745473 - 0.074867781645490947 * var_chaste_interface__membrane__V);
