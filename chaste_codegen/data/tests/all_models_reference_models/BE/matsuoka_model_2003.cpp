...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellmatsuoka_model_2003FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[25], double rJacobian[25][25])
    {
        ...
        const double var_x66 = 0.13513513513513511 * var_chaste_interface__membrane__Vm;
        const double var_x67 = 0.01 * var_chaste_interface__membrane__Vm;
        const double var_x68 = 1 / (2.0 * exp(-var_x67) + 0.0018 * exp(-var_x66));
        const double var_x69 = -1.0 * var_x68;
        const double var_x70 = 11.0 * exp(var_x67) + 2200000.0 * exp(var_x66);
        ...
        const double var_x77 = 780.0 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x78 = pow((0.95737999754118841 - var_chaste_interface__NL_model__X), 2);
        const double var_x79 = -0.038879999999999998 * var_x78;
        const double var_x80 = 780.0 * var_x9;
        ...
        const double var_x157 = exp(-2.1000000000000001 + 0.014999999999999999 * var_chaste_interface__membrane__Vm - 0.40069247885978065 * var_x135);
        const double var_x158 = 1.0 + var_x157;
        const double var_x159 = exp(-0.35000000000000003 + 0.035000000000000003 * var_chaste_interface__membrane__Vm - 0.93494911733948827 * var_x135);
        const double var_x160 = var_x159 / var_x158;
        const double var_x161 = exp(-2.4319999999999999 + 0.064000000000000001 * var_chaste_interface__membrane__Vm - 1.7096212431350641 * var_x135);
        const double var_x162 = 1.0 + var_x161;
        const double var_x163 = exp(0.47999999999999998 + 1.282215932351298 * var_x135 - 0.048000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x164 = var_x163 / var_x155;
        const double var_x165 = var_x162 * var_x164;
        const double var_x166 = var_x165 + 0.25 * var_x160;
        const double var_x167 = pow(var_x166, (-4));
        const double var_x168 = pow(var_x163, 4);
        const double var_x169 = var_x156 * var_x167 * var_x168;
        const double var_x170 = var_x134 * var_x169;
        const double var_x171 = pow(var_x162, 4);
        const double var_x172 = 5.1288637294051922 * var_x171;
        const double var_x173 = 3.2055398308782452 * var_x154;
        const double var_x174 = var_x134 * var_x173;
        const double var_x175 = var_x167 * var_x168 * var_x171 / pow(var_x155, 5);
        const double var_x176 = pow(var_x162, 3);
        const double var_x177 = 6.8384849725402566 * var_x161;
        const double var_x178 = var_x176 * var_x177;
        const double var_x179 = pow(var_x158, (-2));
        const double var_x180 = var_x134 * var_x179;
        const double var_x181 = pow(var_x155, (-2));
        const double var_x182 = pow(var_x162, 2);
        const double var_x183 = pow(var_x163, 2);
        const double var_x184 = pow(var_x159, 2);
        const double var_x185 = var_x167 * var_x183 * var_x184;
        const double var_x186 = var_x182 * var_x185;
        const double var_x187 = var_x181 * var_x186;
        const double var_x188 = var_x162 * var_x181;
        const double var_x189 = pow(var_x155, (-3));
        const double var_x190 = pow(var_x163, 3);
        const double var_x191 = var_x189 * var_x190;
        const double var_x192 = var_x176 * var_x191;
        const double var_x193 = pow(var_x166, (-3));
        const double var_x194 = 1 / (0.75 * var_x160 + 3.0 * var_x165);
        const double var_x195 = var_x134 * var_x160;
        const double var_x196 = var_x193 * var_x194 * var_x195;
        const double var_x197 = var_x157 * var_x159 * var_x180;
        const double var_x198 = 1.0 * var_x171;
        const double var_x199 = pow(var_x166, (-5));
        const double var_x200 = var_x134 * var_x164;
        const double var_x201 = var_x134 * var_x165;
        const double var_x202 = var_x163 * var_x188;
        const double var_x203 = var_x199 * (0.40069247885978065 * var_x197 + 5.1288637294051922 * var_x201 - 0.93494911733948827 * var_x195 + var_x174 * var_x202 - var_x177 * var_x200);
        const double var_x204 = var_x156 * var_x168 * var_x198 * var_x203;
        const double var_x205 = var_x160 * var_x192;
        const double var_x206 = var_x205 * (0.30051935914483546 * var_x197 + 3.8466477970538944 * var_x201 - 0.70121183800461617 * var_x195 - 5.1288637294051922 * var_x161 * var_x200 + 2.4041548731586837 * var_x134 * var_x154 * var_x202);
        const double var_x207 = 0.125 * var_x179;
        const double var_x208 = 2.0 * var_x194;
        const double var_x209 = var_x169 * var_x198;
        const double var_x210 = var_x209 + var_x187 * var_x207 + var_x193 * var_x205 * var_x208;
        const double var_x211 = var_x134 * var_chaste_interface__time_independent_potassium_current_y_gate__y;
        const double var_x212 = -1.3515109780067695e-5 * var_x34 - 0.005235052487551543 * var_x210 * var_x211 - 0.0022848291065246224 * var_x134 / (1.0 + 99.999999999999986 * var_x6) + var_x153 * (var_x204 + var_x170 * var_x178 - var_x170 * var_x172 - var_x174 * var_x175 + 0.22222222222222221 * var_x199 * var_x206 - 0.086816703752952459 * var_x180 * var_x187 - 5.823397359428812 * var_x192 * var_x196 + var_x167 * var_x206 * var_x208 + 10.257727458810384 * var_x161 * var_x182 * var_x191 * var_x196 + 0.42740531078376603 * var_x161 * var_x180 * var_x185 * var_x188 - 0.10017311971494516 * var_x134 * var_x157 * var_x187 / pow(var_x158, 3) - 0.20034623942989033 * var_x154 * var_x180 * var_x186 * var_x189 - 0.80138495771956131 * var_x192 * var_x193 * var_x194 * var_x197 - 4.8083097463173674 * var_x154 * var_x156 * var_x176 * var_x190 * var_x196 + var_x181 * var_x182 * var_x183 * var_x184 * var_x203 * var_x207) * var_chaste_interface__time_independent_potassium_current_y_gate__y + 26.712831923985377 * var_x134 * (-5.9100373419341736e-7 * var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2 - 8.8650560129012604e-7 * var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1) * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3;
        ...
        const double var_x234 = exp(-0.0025000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x235 = 1 / (5.0 * var_x234 + 0.0001027 * var_x233);
        ...
        const double var_x239 = 1.25 / var_x234;
        ...
        const double var_x242 = 0.25 * exp(-0.02 * var_chaste_interface__membrane__Vm) + 0.1027 * var_x233;
        const double var_x243 = 1.0 / var_x242;
        const double var_x244 = -0.01 + 0.01 / (1.0 + 7.0000000000000007e-5 * var_x234 * var_x235 * var_x238 * var_x240 * var_x242);
        ...
        const double var_x249 = exp(-0.32333333333333331 + 0.0033333333333333335 * var_chaste_interface__membrane__Vm - 0.08904277307995126 * var_x135);
        ...
        const double var_x254 = var_x169 * var_x253;
        ...
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        rJacobian[9][9] = 1.0 - (mDt * (40.736400000000003 + var_x79 - var_x77 - var_x80));
        rJacobian[9][10] = 0.0;
        ...
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = -(mDt * (-40.856400000000001 + var_x77 + var_x80));
        rJacobian[11][10] = -(mDt * (var_x83));
        rJacobian[11][11] = 1.0 - (mDt * (-0.0339 + var_x79));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = 0.0;
        ...
        rJacobian[15][11] = -(mDt * (var_x120 + 0.0027216000000000002 * var_x78));
        rJacobian[15][12] = 0.0;
        ...
        rJacobian[24][14] = 0.0;
        rJacobian[24][15] = 0.0;
        rJacobian[24][16] = -(mDt * (var_x172 * var_x254 - var_x178 * var_x254 + var_x173 * var_x175 * var_x253 - var_x204 * var_x252 * var_chaste_interface__time_independent_potassium_current_y_gate__y + 1.5624999999999999e-8 * (1.0 - var_chaste_interface__time_independent_potassium_current_y_gate__y) * (-0.62329941155965873 * var_x134 * var_x249 - 25141.488869633296 * var_x134 * var_x248) / pow((var_x248 + 0.00087500000000000002 * var_x249), 2) - 24.999999999999996 * var_x169 * var_x171 * (0.010685132769594151 * var_x134 * var_x251 + 0.00041096664498439041 * var_x134 * var_x250) * var_chaste_interface__time_independent_potassium_current_y_gate__y / pow((var_x251 + 0.00069999999999999988 * var_x250), 2)));
        rJacobian[24][17] = 0.0;
        rJacobian[24][18] = 0.0;
        rJacobian[24][19] = 0.0;
        rJacobian[24][20] = 0.0;
        ...
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-1.0 / (7.0 * var_x249 + 8000.0 * var_x248) - var_x209 * var_x252));
    }
