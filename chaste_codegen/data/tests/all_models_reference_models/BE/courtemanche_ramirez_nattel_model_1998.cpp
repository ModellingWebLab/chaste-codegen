...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellcourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[8], double rJacobian[8][8])
    {
        ...
        const double var_x0 = exp(013102317305629283 * var_chaste_interface__membrane__V);
        const double var_x1 = exp(-024332874996168673 * var_chaste_interface__membrane__V);
        const double var_x2 = mParameters[0] / (1.0 + 0.10000000000000001 * var_x1);
        const double var_x3 = var_x2 * (1.8 * var_x0 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) - 2744000 * var_x1 * var_chaste_interface__intracellular_ion_concentrations__Ca_i);
        ...
        const double var_x10 = 0.23455745922671672 * var_x9 - 00011173862339878819 * var_x3 - var_x4 * var_x7;
        const double var_x11 = exp(250 + var_x10);
        ...
        const double var_x27 = exp(50 + var_x10);
        ...
        const double var_x32 = 1013080166606582 * var_x13 * var_x31;
        const double var_x33 = 0.47846889952153115 * var_x31;
        const double var_x34 = 0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x35 = 00050000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x36 = pow(var_x35, (-2));
        const double var_x37 = 1.0 + 00011900000000000002 / pow(var_x34, 2) + 3.5000000000000004e-5 * var_x36;
        const double var_x38 = 1 / var_x37;
        const double var_x39 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x40 = 1.0 + 00092000000000000003 * var_x39;
        ...
        const double var_x48 = 30 * var_x6;
        ...
        const double var_x53 = var_x51 * var_x52 / (pow((031622776601683791 + var_x51), 2) * (1.0 + 0.1245 * exp(-0037435192301797956 * var_chaste_interface__membrane__V) + 036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-037435192301797954 * var_chaste_interface__membrane__V)));
        ...
        rJacobian[1][0] = -(mDt * (-4234674.4696415514 * var_x14 * var_x30 - 2026160333213164 * var_x15 * var_x31));
        ...
        rJacobian[1][5] = 0;
        rJacobian[1][6] = 0;
        rJacobian[1][7] = -(mDt * (-00028870266332701257 * var_x24 * var_x31 - 00060338856635345627 * var_x23 * var_x30));
        rJacobian[2][0] = 0;
        rJacobian[2][1] = 0;
        rJacobian[2][2] = 1.0 - (mDt * (-0.5));
        rJacobian[2][3] = -(mDt * (-000175 / pow((00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2)));
        rJacobian[2][4] = 0;
        rJacobian[2][5] = 0;
        rJacobian[2][6] = 0;
        rJacobian[2][7] = 0;
        ...
        rJacobian[3][3] = 1.0 - (mDt * (var_x38 * (-var_x43 - var_x44 - 00030665564809977873 * var_x20 - 3.7341176470588232e-7 * var_x41 - 5.7273025005690459e-9 * var_x39 * mParameters[0] + var_x36 * var_x42 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) + (00023800000000000004 / pow(var_x34, 3) + 7.0000000000000007e-5 / pow(var_x35, 3)) * (2.7058823529411762e-5 * var_chaste_interface__intracellular_ion_concentrations__Ca_up + 1.1175497379729545e-10 * var_x3 - 4.6918356272010785e-8 * var_x9 - 00040588235294117644 / var_x40 + var_x4 * var_x44 - var_x43 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 4.2880534095874102e-10 * (-13.356415961992688 * log(1.8 * var_x39) + var_chaste_interface__membrane__V) * mParameters[0]) / pow(var_x37, 2)));
        ...
        rJacobian[4][0] = -(mDt * (-60 * var_x14 * var_x47));
        rJacobian[4][1] = -(mDt * (-30 * var_x16 * var_x47));
        rJacobian[4][2] = 0;
        rJacobian[4][3] = -(mDt * (var_x47 * var_x48));
        rJacobian[4][4] = 1.0 - (mDt * (var_x47 * (-0055555555555555558 - var_x48) + 0.25 * (0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_rel - var_x4 * var_x48) / (pow(var_x45, 3) * pow((0.125 + var_x46), 2))));
        rJacobian[4][5] = -(mDt * (0055555555555555558 * var_x47));
        rJacobian[4][6] = 0;
        rJacobian[4][7] = 0;
        rJacobian[5][0] = 0;
        rJacobian[5][1] = 0;
        ...
        rJacobian[5][4] = -(mDt * (00048309178743961351));
        rJacobian[5][5] = 1.0 - (mDt * (-00081642512077294684));
        rJacobian[5][6] = 0;
        rJacobian[5][7] = 0;
        rJacobian[6][0] = 0;
        rJacobian[6][1] = 0;
    ...
    void Cellcourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_Ca_release_current_from_JSR_w_gate__w_infinity = 1.0 - 1 / (1.0 + exp(2.3529411764705883 - 058823529411764705 * var_chaste_interface__membrane__V));
        ...
        const double var_L_type_Ca_channel_f_gate__tau_f = 9.0 / (02 + 019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2)));
        ...
        const double var_rapid_delayed_rectifier_K_current_xr_gate__alpha_xr = ((fabs(14.1 + var_chaste_interface__membrane__V) < 1.0e-10) ? (0015) : (00029999999999999997 * (14.1 + var_chaste_interface__membrane__V) / (1.0 - exp(-2.8199999999999998 - 0.20000000000000001 * var_chaste_interface__membrane__V))));
        ...
        const double var_slow_delayed_rectifier_K_current_xs_gate__alpha_xs = ((fabs(-19.899999999999999 + var_chaste_interface__membrane__V) < 1.0e-10) ? (00068000000000000005) : (4.0000000000000003e-5 * (-19.899999999999999 + var_chaste_interface__membrane__V) / (1.0 - exp(1.1705882352941175 - 058823529411764705 * var_chaste_interface__membrane__V))));
        ...
        const double var_slow_delayed_rectifier_K_current_xs_gate__xs_infinity = pow((1.0 + exp(1.5669291338582676 - 07874015748031496 * var_chaste_interface__membrane__V)), (-0.5));
        const double var_transient_outward_K_current__K_Q10 = 3.0;
        const double var_transient_outward_K_current_oa_gate__alpha_oa = 0.65000000000000002 / (exp(0.50847457627118642 - 016949152542372881 * var_chaste_interface__membrane__V) + exp(-1.1764705882352942 - 0.11764705882352941 * var_chaste_interface__membrane__V));
        const double var_transient_outward_K_current_oa_gate__beta_oa = 0.65000000000000002 / (2.5 + exp(4.8235294117647056 + 058823529411764705 * var_chaste_interface__membrane__V));
        const double var_transient_outward_K_current_oa_gate__oa_infinity = 1 / (1.0 + exp(-1.1670467502850628 - 057012542759407071 * var_chaste_interface__membrane__V));
        ...
        const double var_transient_outward_K_current_oi_gate__alpha_oi = 1 / (18.530000000000001 + 1.0 * exp(10.383561643835618 + 091324200913242018 * var_chaste_interface__membrane__V));
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ua_gate__alpha_ua = 0.65000000000000002 / (exp(0.50847457627118642 - 016949152542372881 * var_chaste_interface__membrane__V) + exp(-1.1764705882352942 - 0.11764705882352941 * var_chaste_interface__membrane__V));
        const double var_ultrarapid_delayed_rectifier_K_current_ua_gate__beta_ua = 0.65000000000000002 / (2.5 + exp(4.8235294117647056 + 058823529411764705 * var_chaste_interface__membrane__V));
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__alpha_ui = 1 / (21.0 + 1.0 * exp(6.6071428571428568 - 035714285714285712 * var_chaste_interface__membrane__V));
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__beta_ui = 1.0 / exp(9.875 - 0625 * var_chaste_interface__membrane__V);
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__ui_infinity = 1 / (1.0 + exp(-3.6189956331877728 + 036390101892285295 * var_chaste_interface__membrane__V));
