...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[15], double rJacobian[15][15])
    {
        ...
        const double var_x11 = exp(1.8716945411372736);
        const double var_x12 = -0.037433890822745473 * var_chaste_interface__membrane_potential__V;
        const double var_x13 = exp(1.8716945411372736 + var_x12);
        ...
        const double var_x17 = var_x16 * (-4.0 * var_x13 + var_x11 * var_chaste_interface__intracellular_potassium_concentration__K_i);
        const double var_x18 = 2.2928258128931602e-5 * var_x15;
        const double var_x19 = var_x18 * (-140.0 * var_x13 + var_x11 * var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x20 = exp(3.7433890822745473);
        const double var_x21 = 0.074867781645490947 * var_chaste_interface__membrane_potential__V;
        const double var_x22 = exp(3.7433890822745473 - var_x21);
        const double var_x23 = var_x14 / (1.0 - var_x22);
        const double var_x24 = 0.0091713032515726399 * var_x23;
        const double var_x25 = var_x24 * (-2.0 * var_x22 + var_x20 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x26 = 61250.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x27 = var_x20 * var_x24;
        const double var_x28 = var_x11 * var_chaste_interface__RyR__F_1;
        const double var_x29 = var_x16 * var_x28;
        const double var_x30 = var_x18 * var_x28;
        ...
        const double var_x41 = var_x39 * var_x40 * var_chaste_interface__RyR__F_2 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x42 = pow(var_chaste_interface__RyR__F_2, 2);
        const double var_x43 = var_x40 * var_x42 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x44 = var_x43 / pow(var_x38, 3);
        const double var_x45 = var_x36 * var_x39 * var_x42;
        const double var_x46 = 0.5 * var_x45;
        const double var_x47 = var_x39 * var_x43 / pow(var_x35, 2);
        const double var_x48 = var_x46 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x49 = var_x33 * var_chaste_interface__SR_calcium_concentration__Ca_SR;
        const double var_x50 = (-0.14537477691850093 * var_x32 + 5069444.444444444 * var_x8 * var_chaste_interface__CaMKII_factor__F_CaMK) / pow((5.7600000000000006e-8 + var_x8 + 2.1415823914336707e-8 * var_x32), 2);
        const double var_x51 = var_x50 * var_chaste_interface__SR_calcium_concentration__Ca_SR;
        ...
        const double var_x53 = var_x50 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x70 = 0.080480480480480482 * var_chaste_interface__Force__N_0;
        const double var_x71 = 0.080480480480480482 * var_chaste_interface__Force__P_0;
        const double var_x72 = 0.080480480480480482 * var_chaste_interface__Force__P_2;
        const double var_x73 = 0.16096096096096096 * var_chaste_interface__Force__P_3;
        const double var_x74 = 80.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x75 = 1 / var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x76 = var_x11 * var_x15;
        const double var_x77 = log(4.0 * var_x75);
        const double var_x78 = exp(-0.74867781645490938 + var_x21 - 2.0 * var_x77);
        const double var_x79 = 1.0 + var_x78;
        const double var_x80 = 1 / (1.0 + 0.035299999999999998 * exp(var_x12) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane_potential__V));
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.0018000000000000002 + var_x10 + var_x17 + var_x19 + var_x25 - var_x9));
        ...
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = -(mDt * (var_x9 - var_x17 - var_x19 - var_x25));
        ...
        rJacobian[9][5] = 0.0;
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = -(mDt * (var_x37 * var_x44 - var_x37 * var_x41));
        rJacobian[9][8] = -(mDt * (0.5 * var_x47 - var_x40 * var_x46));
        rJacobian[9][9] = 1.0 - (mDt * (-var_x48 - 0.001424696263447196 * var_x49 - 1.2089003260906828e-17 * var_x51));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = -(mDt * (var_x48 + 49681.373281158201 * var_x52 - 5.6448929115512146e-10 * var_x53));
        rJacobian[9][12] = 0.0;
        rJacobian[9][13] = 0.0;
        rJacobian[9][14] = 0.0;
        rJacobian[10][0] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-1.0126868767488654e-5 * var_x75 - 4.5129535692671587e-6 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x - 1.1825618784004642e-8 * var_x76 - 0.0048223184607088833 * var_x75 / var_x79 - 8.4390573062405468e-5 * var_x75 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s + 0.00036103628554137268 * var_x75 * var_x78 * (-26.713760659695652 * var_x77 + var_chaste_interface__membrane_potential__V) / pow(var_x79, 2)));
        ...
        rJacobian[13][13] = 1.0 - (mDt * (4.3794501115171722e-6 * var_x82 - 1.0126868767488654e-5 / var_chaste_interface__intracellular_sodium_concentration__Na_i - 5.9275938519033593 * var_x83 - 0.0020622392630123211 * var_x81 - 5.6863214972766202e-6 * var_x69 - 5.9128093920023211e-8 * var_x76));
        rJacobian[13][14] = 0.0;
        rJacobian[14][0] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-0.11951951951951952 + var_x72 + var_x73 - var_x70 - var_x71 - var_x74));
    }
