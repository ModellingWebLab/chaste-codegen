...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        const double var_x2 = 1 / (2.0 + 80 * var_x1);
        const double var_x3 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0025000000000000005 + var_x0), 2);
        ...
        const double var_x8 = 1 / (059999999999999998 + 0.14999999999999999 * var_x7);
        const double var_x9 = var_x8 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x10 = var_x7 * var_x9;
        const double var_x11 = 015299999999999998 * var_x10;
        ...
        const double var_x29 = 001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x30 = 1.0 + 00020000000000000001 / pow(var_x29, 2);
        const double var_x31 = 1 / var_x30;
        const double var_x32 = 00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x33 = 7.2352122917848019e-6 / var_x32;
        const double var_x34 = 1 / var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x35 = exp(-024332029034784559 * var_chaste_interface__membrane__V);
        const double var_x36 = 1 / (1.0 + 0.10000000000000001 * var_x35);
        const double var_x37 = var_x35 * var_x36;
        const double var_x38 = exp(013101861787960915 * var_chaste_interface__membrane__V);
        const double var_x39 = var_x36 * var_x38 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2);
        const double var_x40 = 00025000000000000001 + var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x41 = 1.0 + 0001 / pow(var_x40, 2);
        const double var_x42 = 1 / var_x41;
        const double var_x43 = exp(-1.1230167246823641 + 074867781645490947 * var_chaste_interface__membrane__V);
        ...
        const double var_x48 = -0.11249999999999999 + 067500000000000004 * var_x5;
        const double var_x49 = 1 / var_chaste_interface__potassium_dynamics__K_i;
        const double var_x50 = log(5.4000000000000004 * var_x49);
        const double var_x51 = exp(-12.0 + 059999999999999998 * var_chaste_interface__membrane__V - 1.6028256395817388 * var_x50);
        ...
        const double var_x57 = exp(02 + 00020000000000000001 * var_chaste_interface__membrane__V - 0053427521319391299 * var_x50);
        ...
        const double var_x62 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * (0031249999999999997 * var_chaste_interface__sodium_dynamics__Na_i + 0.10416666666666667 * var_chaste_interface__potassium_dynamics__K_i) / pow((029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i), 2);
        ...
        const double var_x65 = 1 / (1.0 + 035299999999999998 * exp(-037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0037433890822745472 * var_chaste_interface__membrane__V));
        const double var_x66 = var_x65 / (40 + var_chaste_interface__sodium_dynamics__Na_i);
        const double var_x67 = var_x65 * var_chaste_interface__sodium_dynamics__Na_i / pow((1 + 025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        ...
        rJacobian[0][1] = 0;
        rJacobian[0][2] = 0;
        rJacobian[0][3] = -(mDt * (-0030000000000000001 * var_x2 * var_x3 + 6.2500000000000001e-5 * var_x3 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x1) / pow((025000000000000001 + var_x1), 2)));
        rJacobian[0][4] = 0;
        rJacobian[0][5] = 0;
        rJacobian[0][6] = 0;
        rJacobian[1][0] = 0;
        rJacobian[1][1] = 1.0 - (mDt * (var_x22 * (-00036000000000000002 - var_x11 + 021759999999999998 * var_x18 - 0032639999999999995 * var_x15) + 0.66666666666666674 * (00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0063749999999999996 * var_x24 - 00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x11 * var_x13) / (pow(var_x19, 3) * pow((0.33333333333333337 + var_x20), 2))));
        rJacobian[1][2] = -(mDt * (var_x22 * (00036000000000000002 + 7.96875e-10 * var_x25)));
        rJacobian[1][3] = -(mDt * (var_x22 * (var_x11 + 032639999999999995 * var_x26 - 030599999999999995 * var_x27)));
        rJacobian[1][4] = -(mDt * (-015299999999999998 * var_x21 * var_x28));
        rJacobian[1][5] = 0;
        rJacobian[1][6] = 0;
        rJacobian[2][0] = 0;
        rJacobian[2][1] = -(mDt * (2.40087783467447e-5 * var_x31));
        rJacobian[2][2] = 1.0 - (mDt * (1.0 * var_x31 * (-0038240087783467445 - var_x33 - 069488744729986562 * var_x37 - 5.3144431236283834e-11 * var_x25 - 4.6212277808973232e-7 * var_x34 + 7.2352122917848019e-6 * var_chaste_interface__calcium_dynamics__Ca_i / pow(var_x32, 2)) + 00040000000000000002 * (0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973232e-7 * log(2.0 * var_x34) - 0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 00042515544989027063 * var_x24 - var_x33 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x36 * (2.0 * var_x38 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) - 6860000 * var_x35 * var_chaste_interface__calcium_dynamics__Ca_i)) / (pow(var_x29, 3) * pow(var_x30, 2))));
        rJacobian[2][3] = -(mDt * (0038 * var_x31));
        rJacobian[2][4] = 0;
        rJacobian[2][5] = 0;
        rJacobian[2][6] = -(mDt * (6.0777327752174836e-8 * var_x31 * var_x39));
        rJacobian[3][0] = -(mDt * (-var_x42 * var_x45));
        rJacobian[3][1] = -(mDt * (var_x47 * (var_x46 + 065303877103145572 * var_x15 - 0.43535918068763713 * var_x18)));
        rJacobian[3][2] = -(mDt * (1.1399999999999999 * var_x42));
        rJacobian[3][3] = 1.0 - (mDt * (var_x47 * (-1.1399999999999999 - var_x46 + 0.61222384784198969 * var_x27 - 0.65303877103145569 * var_x26 - 63.325437108704392 * var_x43 * var_x44 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass) + 00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x13 * var_x46 - var_x45 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass) / (pow(var_x40, 3) * pow(var_x41, 2))));
        rJacobian[3][4] = -(mDt * (0.30611192392099484 * var_x28 * var_x42));
        rJacobian[3][5] = 0;
        rJacobian[3][6] = 0;
        rJacobian[4][0] = 0;
        rJacobian[4][1] = -(mDt * (059999999999999998 * var_x16 * var_chaste_interface__calcium_dynamics__Ca_ss));
        rJacobian[4][2] = 0;
        rJacobian[4][3] = -(mDt * (var_x48 * var_chaste_interface__calcium_dynamics__R_prime));
        rJacobian[4][4] = 1.0 - (mDt * (-0050000000000000001 + var_x48 * var_chaste_interface__calcium_dynamics__Ca_ss));
        rJacobian[4][5] = 0;
        rJacobian[4][6] = 0;
        rJacobian[5][0] = 0;
        rJacobian[5][1] = 0;
        ...
        rJacobian[5][3] = 0;
        rJacobian[5][4] = 0;
        rJacobian[5][5] = 1.0 - (mDt * (-011750408368292439 * var_x62 - 0016876848753885161 * var_x53 * var_x61 - 4.5587787568311439e-5 * var_x49 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 00010126109252331096 * var_x61 * var_x63 * var_x64 - 0031224512033090025 * var_x49 * mParameters[2] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 - 6.3176611368492499e-5 * var_x53 * var_x63 * (-var_x56 * (2.6713760659695653 * var_x49 * var_x58 + 01602825639581739 * var_x49 * var_x57) + 0.16028256395817389 * var_x49 * var_x64 - 13.356880329847826 * var_x49 * var_x54 * var_x59 / pow(var_x55, 2)) / pow(var_x60, 2) - 0031224512033090025 * var_x49 * mParameters[3] * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s));
        rJacobian[5][6] = -(mDt * (00053729341037579627 * var_x66 - 00035251225104877316 * var_x62 - 3.3580838148487267e-7 * var_x67));
        rJacobian[6][0] = 0;
        rJacobian[6][1] = 0;
        ...
        rJacobian[6][4] = 0;
        rJacobian[6][5] = 0;
        rJacobian[6][6] = 1.0 - (mDt * (5.0371257222730904e-7 * var_x67 - 9.0551084895961074e-7 * var_x68 - 1.823319832565245e-7 * var_x39 - 00080594011556369446 * var_x66 - 0031224512033090025 * var_x68 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * mParameters[1] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_L_type_Ca_current_f2_gate__tau_f2 = 80 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 31.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 562.0 * exp(-3.0375000000000001 * pow((1 + 037037037037037035 * var_chaste_interface__membrane__V), 2));
        ...
        const double var_L_type_Ca_current_f_gate__tau_f = 20 + 200 / (1.0 + exp(1.3 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 180 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1102.5 * exp(-3.2400000000000002 * pow((1 + 037037037037037035 * var_chaste_interface__membrane__V), 2));
        ...
        const double var_slow_time_dependent_potassium_current_Xs_gate__alpha_xs = 1400 / sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V));
        const double var_slow_time_dependent_potassium_current_Xs_gate__beta_xs = 1.0 / (1.0 + exp(-2.3333333333333335 + 066666666666666666 * var_chaste_interface__membrane__V));
        const double var_slow_time_dependent_potassium_current_Xs_gate__tau_xs = 80 + 1.0 * var_slow_time_dependent_potassium_current_Xs_gate__alpha_xs * var_slow_time_dependent_potassium_current_Xs_gate__beta_xs;
