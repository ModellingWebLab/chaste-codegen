...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        const double var_x38 = log(10);
        const double var_x39 = var_x35 * var_x37 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2);
        ...
        const double var_x46 = 0.30611192392099484 * var_x13;
        const double var_x47 = -0.11249999999999999 + 0.067500000000000004 * var_x8;
        const double var_x48 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i);
        const double var_x49 = 1 / var_chaste_interface__potassium_dynamics__K_i;
        const double var_x50 = var_x38 * log10(5.4000000000000004 * var_x49);
        ...
        const double var_x64 = 1 / (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane__V));
        const double var_x65 = var_x64 / (40.0 + var_chaste_interface__sodium_dynamics__Na_i);
        const double var_x66 = var_x64 * var_chaste_interface__sodium_dynamics__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        const double var_x67 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        ...
        rJacobian[2][2] = 1.0 - (mDt * (var_x30 * (-0.0038240087783467445 - var_x32 - 0.069488744729986562 * var_x36 - 5.3144431236283834e-11 * var_x24 - 4.6212277808973232e-7 * var_x33 + 7.2352122917848019e-6 * var_chaste_interface__calcium_dynamics__Ca_i / pow(var_x31, 2)) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027063 * var_x23 - var_x32 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x35 * (2.0 * var_x37 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) - 6860000.0 * var_x34 * var_chaste_interface__calcium_dynamics__Ca_i) + 4.6212277808973232e-7 * var_x38 * log10(2.0 * var_x33)) / (pow(var_x28, 3) * pow(var_x29, 2))));
        rJacobian[2][3] = -(mDt * (0.0038 * var_x30));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = -(mDt * (6.0777327752174836e-8 * var_x30 * var_x39));
        rJacobian[3][0] = -(mDt * (-var_x42 * var_x45));
        rJacobian[3][1] = -(mDt * (var_x42 * (var_x46 + 0.065303877103145572 * var_x18 - 0.43535918068763713 * var_x21)));
        rJacobian[3][2] = -(mDt * (1.1399999999999999 * var_x42));
        rJacobian[3][3] = 1.0 - (mDt * (var_x42 * (-1.1399999999999999 - var_x46 + 0.61222384784198969 * var_x26 - 0.65303877103145569 * var_x25 - 63.325437108704392 * var_x43 * var_x44 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x16 * var_x46 - var_x45 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass) / (pow(var_x40, 3) * pow(var_x41, 2))));
        rJacobian[3][4] = -(mDt * (0.30611192392099484 * var_x27 * var_x42));
        rJacobian[3][5] = 0.0;
        rJacobian[3][6] = 0.0;
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = -(mDt * (0.059999999999999998 * var_x19 * var_chaste_interface__calcium_dynamics__Ca_ss));
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = -(mDt * (var_x47 * var_chaste_interface__calcium_dynamics__R_prime));
        rJacobian[4][4] = 1.0 - (mDt * (-0.0050000000000000001 + var_x47 * var_chaste_interface__calcium_dynamics__Ca_ss));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        ...
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (-0.001224000871697129 * var_x48 - 0.0016876848753885161 * var_x53 * var_x61 - 4.5587787568311439e-5 * var_x49 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 0.00010126109252331096 * var_x61 * var_x62 * var_x63 - 0.0031224512033090025 * var_x49 * mParameters[2] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 - 6.3176611368492499e-5 * var_x53 * var_x62 * (-var_x56 * (2.6713760659695653 * var_x49 * var_x58 + 0.01602825639581739 * var_x49 * var_x57) + 0.16028256395817389 * var_x49 * var_x63 - 13.356880329847826 * var_x49 * var_x54 * var_x59 / pow(var_x55, 2)) / pow(var_x60, 2) - 0.0031224512033090025 * var_x49 * mParameters[3] * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s));
        rJacobian[5][6] = -(mDt * (0.00053729341037579627 * var_x65 - 3.6720026150913867e-5 * var_x48 - 3.3580838148487267e-7 * var_x66));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (5.0371257222730904e-7 * var_x66 - 9.0551084895961074e-7 * var_x67 - 1.823319832565245e-7 * var_x39 - 0.00080594011556369446 * var_x65 - 0.0031224512033090025 * var_x67 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * mParameters[1] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
