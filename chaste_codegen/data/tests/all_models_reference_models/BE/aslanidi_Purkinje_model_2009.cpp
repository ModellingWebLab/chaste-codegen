...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellaslanidi_Purkinje_model_2009FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x4 = 0.074871767015605231 * var_chaste_interface__membrane__V;
        const double var_x5 = exp(-1.1230765052340785 + var_x4);
        const double var_x6 = var_x3 + var_x5 * var_chaste_interface__Ca_r__Ca_r;
        const double var_x7 = -1.0 + var_x5;
        const double var_x8 = (-15.0 + var_chaste_interface__membrane__V) * mParameters[7] / var_x7;
        const double var_x9 = var_x6 * var_x8;
        const double var_x10 = exp(2.6000000000000001 + 0.70217303721666524 * var_x9);
        const double var_x11 = 1.0 + var_x10;
        const double var_x12 = 1 / var_x11;
        const double var_x13 = var_x12 * mParameters[1] * var_chaste_interface__q_rel_ro_gate__ro;
        const double var_x14 = var_x13 * var_chaste_interface__q_rel_ri_gate__ri;
        const double var_x15 = var_x14;
        const double var_x16 = -var_chaste_interface__Ca_r__Ca_r + var_chaste_interface__Ca_JSR__Ca_JSR;
        const double var_x17 = var_x16 * mParameters[1] * var_chaste_interface__q_rel_ri_gate__ri;
        const double var_x18 = var_x5 * var_x8;
        const double var_x19 = var_x10 * var_x17 * var_x18 * var_chaste_interface__q_rel_ro_gate__ro / pow(var_x11, 2);
        const double var_x20 = var_x13 * var_x16;
        const double var_x21 = var_x2;
        const double var_x22 = var_x12 * var_x17;
        const double var_x23 = 1.0 - var_chaste_interface__Ca_MK_act__Ca_MK_trap;
        const double var_x24 = 1 / var_chaste_interface__Ca_r__Ca_r;
        const double var_x25 = 1.0 + 0.14999999999999999 * var_x24;
        const double var_x26 = 1 / var_x25;
        const double var_x27 = 0.050000000000000003 * var_x26;
        const double var_x28 = var_x23 * var_x27;
        const double var_x29 = var_x28 + var_chaste_interface__Ca_MK_act__Ca_MK_trap;
        const double var_x30 = 0.0025000000000000005 * var_x26;
        const double var_x31 = 1 - var_x27;
        const double var_x32 = pow(var_chaste_interface__Ca_r__Ca_r, (-2));
        const double var_x33 = var_x23 * var_x32 / pow(var_x25, 2);
        const double var_x34 = 0.14999999999999999 + var_x28 + var_chaste_interface__Ca_MK_act__Ca_MK_trap;
        const double var_x35 = 1 / var_x34;
        const double var_x36 = var_x31 * var_x35;
        const double var_x37 = var_x29 / pow(var_x34, 2);
        const double var_x38 = var_x37 * (-1.0 + var_x27);
        const double var_x39 = 0.75 * var_x36 + 0.75 * var_x38;
        const double var_x40 = var_x29 * var_x35;
        const double var_x41 = 0.00092000000000000003 - 0.00017000000000000001 * var_x40 + var_chaste_interface__Ca_i__Ca_i;
        const double var_x42 = mParameters[2] / var_x41;
        const double var_x43 = 0.5 * var_chaste_interface__Ca_i__Ca_i;
        const double var_x44 = var_x42 * var_x43;
        const double var_x45 = 0.00017000000000000001 * var_x36 + 0.00017000000000000001 * var_x38;
        const double var_x46 = 1.0 + 0.75 * var_x40;
        const double var_x47 = var_x46 * mParameters[2] / pow(var_x41, 2);
        const double var_x48 = var_x43 * var_x47;
        const double var_x49 = var_x42 * var_x46;
        const double var_x50 = var_x33 * var_x35;
        const double var_x51 = var_x33 * var_x37;
        const double var_x52 = 0.0056249999999999998 * var_x50 - 0.0056249999999999998 * var_x51;
        const double var_x53 = 1.2750000000000001e-6 * var_x50 - 1.2750000000000001e-6 * var_x51;
        const double var_x54 = 0.04058823529411764 * var_chaste_interface__Ca_i__Ca_i;
        const double var_x55 = var_x42 * var_x54;
        const double var_x56 = var_x47 * var_x54;
        const double var_x57 = 0.00050000000000000001 + var_chaste_interface__Ca_i__Ca_i;
        const double var_x58 = pow(var_x57, (-2));
        const double var_x59 = 0.14000000000000001 * var_x58;
        const double var_x60 = 0.0023800000000000002 + var_chaste_interface__Ca_i__Ca_i;
        const double var_x61 = 0.10000000000000001 / pow(var_x60, 2);
        const double var_x62 = 1.0 + var_x59 * var_chaste_interface__Ca_i__Ca_i + var_x61 * var_chaste_interface__Ca_i__Ca_i;
        const double var_x63 = 1 / var_x62;
        const double var_x64 = var_x63;
        const double var_x65 = 0.005411764705882352 * mParameters[0];
        const double var_x66 = 1.9455934936549115e-10 / var_x57;
        const double var_x67 = 0.04058823529411764 * var_x49;
        const double var_x68 = exp(var_x4);
        const double var_x69 = 9.753339147721386e-12 * var_chaste_interface__membrane__V / (-1.0 + var_x68);
        const double var_x70 = exp(-0.024333324280071702 * var_chaste_interface__membrane__V);
        const double var_x71 = pow(mParameters[6], 3);
        const double var_x72 = 1 / (1.0 + 0.27000000000000002 * var_x70);
        const double var_x73 = 1.0 + 6.9444444444444451e-9 / pow(var_chaste_interface__Ca_i__Ca_i, 2);
        const double var_x74 = 1 / var_x73;
        const double var_x75 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3);
        const double var_x76 = var_x75 * mParameters[4];
        const double var_x77 = 1.5 * var_x71;
        const double var_x78 = var_x77 * var_chaste_interface__Ca_i__Ca_i;
        const double var_x79 = var_x71 * (1.0 + 0.081300813008130079 * var_chaste_interface__intracellular_ion_concentrations__Na_i);
        const double var_x80 = (1.0 + 416.66666666666669 * var_chaste_interface__Ca_i__Ca_i) * mParameters[4];
        const double var_x81 = 1 / (var_x76 + var_x78 + 1004882.8125 * var_chaste_interface__Ca_i__Ca_i + 0.0035999999999999999 * var_x79 + 1.3 * var_x75 + 1860.8670000000004 * var_x80);
        const double var_x82 = var_x72 * var_x74 * var_x81;
        const double var_x83 = var_x70 * var_x71 * var_x82;
        const double var_x84 = -1004882.8125 - var_x77 - 775361.25000000012 * mParameters[4];
        const double var_x85 = mParameters[14] * exp(0.013102559227730915 * var_chaste_interface__membrane__V);
        const double var_x86 = -var_x70 * var_x78 + 0.40000000000000002 * var_x76 * var_x85;
        const double var_x87 = var_x72 * var_x86;
        const double var_x88 = var_x74 * var_x87 / pow((1.2936831875607387e-6 * var_x75 + 0.0018518248862973764 * var_x80 + 9.9514091350826051e-7 * var_x76 + 3.5825072886297377e-9 * var_x79 + 1.4927113702623908e-6 * var_x71 * var_chaste_interface__Ca_i__Ca_i + var_chaste_interface__Ca_i__Ca_i), 2);
        const double var_x89 = 6.7016758831103969e-21 * var_x88;
        const double var_x90 = var_x81 * var_x87 / (pow(var_x73, 2) * pow(var_chaste_interface__Ca_i__Ca_i, 3));
        const double var_x91 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2);
        const double var_x92 = var_x91 * mParameters[4];
        const double var_x93 = -3 * var_x92 - 3.9000000000000004 * var_x91 - 0.00029268292682926828 * var_x71;
        const double var_x94 = var_x82 * var_x85 * var_x92;
        const double var_x95 = 0.0086999999999999994 + var_chaste_interface__Ca_r__Ca_r;
        const double var_x96 = pow(var_x95, (-2));
        const double var_x97 = var_x96 * var_chaste_interface__Ca_r__Ca_r;
        const double var_x98 = 0.00087000000000000001 + var_chaste_interface__Ca_r__Ca_r;
        const double var_x99 = pow(var_x98, (-2));
        const double var_x100 = 0.094 * var_x99;
        const double var_x101 = 1 / (1.0 + 2.2480000000000002 * var_x97 + var_x100 * var_chaste_interface__Ca_r__Ca_r);
        const double var_x102 = 0.23999999999999996 * var_x14;
        const double var_x103 = var_chaste_interface__i_Ca_L_d_gate__d * var_chaste_interface__i_Ca_L_f2_gate__f2 * var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2 * var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca * var_chaste_interface__i_Ca_L_f_gate__f;
        const double var_x104 = var_x103 * var_x18;
        const double var_x105 = var_x103 * var_x9;
        const double var_x106 = var_x9 * var_chaste_interface__i_Ca_L_d_gate__d * var_chaste_interface__i_Ca_L_f2_gate__f2 * var_chaste_interface__i_Ca_L_f_gate__f;
        const double var_x107 = var_x106 * var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca;
        const double var_x108 = 4.0390323434238405e-7 * var_x101;
        const double var_x109 = var_x106 * var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2;
        const double var_x110 = 0.23999999999999996 * var_x101;
        const double var_x111 = exp(-4.375 - 87.771629652083149 * var_x105);
        const double var_x112 = 1.0 + var_x111;
        const double var_x113 = 1 / var_x112;
        const double var_x114 = 1 / (125.0 + 300.0 * var_x113);
        const double var_x115 = -var_x105;
        const double var_x116 = 0.0028483007663293006 / pow((0.0028483007663293006 + var_x115), 2);
        const double var_x117 = var_x114 * var_x116;
        const double var_x118 = 0.29257209884027718 * var_x111 * (-var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2 + 1 / (1.0 - 351.0865186083326 * var_x105)) / (pow(var_x112, 2) * pow((0.41666666666666669 + var_x113), 2));
        const double var_x119 = -10.0 * var_x36 - 10.0 * var_x38;
        const double var_x120 = 1 / (1.0 + 333.33333333333331 * var_chaste_interface__Ca_r__Ca_r);
        const double var_x121 = 0.01 * (0.14999999999999999 - var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca + 0.55000000000000004 * var_x120 + 0.29999999999999999 / (1.0 - 70.217303721666525 * var_x105)) / pow((0.050000000000000003 + var_x40 + 0.10000000000000001 * var_x120), 2);
        const double var_x122 = 10.0 * var_x40;
        const double var_x123 = 1 / (0.5 + var_x122 + var_x120);
        const double var_x124 = pow((0.0030000000000000001 + var_chaste_interface__Ca_r__Ca_r), (-2));
        const double var_x125 = 0.0042724511494939511 / pow((0.014241503831646503 + var_x115), 2);
        const double var_x126 = 0.074999999999999997 * var_x51 - 0.074999999999999997 * var_x50;
        const double var_x127 = 0.037435883507802616 * var_chaste_interface__membrane__V;
        const double var_x128 = exp(var_x127);
        const double var_x129 = 1.9554743855840427e-10 * var_chaste_interface__membrane__V / (1.0 - var_x128);
        const double var_x130 = 1 / var_chaste_interface__intracellular_ion_concentrations__Cl_i;
        const double var_x131 = log(100.0 * var_x130);
        const double var_x132 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x133 = log(var_x132 * mParameters[5]);
        const double var_x134 = 26.712338705498265 * var_x133;
        const double var_x135 = var_x134 + 26.712338705498265 * var_x131;
        const double var_x136 = 0.00018900582374462349 / (87.825100000000006 + var_x135);
        const double var_x137 = 2.4504050574882179e-8 * var_x135 / pow((1 + 0.30415380916729118 * var_x131 + 0.30415380916729118 * var_x133), 2);
        const double var_x138 = var_x130 * var_x137 - var_x130 * var_x136;
        const double var_x139 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x140 = var_x131 + log(var_x139 * mParameters[6]);
        const double var_x141 = pow(var_x140, 4);
        const double var_x142 = 2.8839711417365218e-9 * pow(var_x140, 7) / pow((1 + 0.0085580149227345564 * var_x141), 2);
        const double var_x143 = 20.048989239399607 * pow(var_x140, 3) / (59494197.640692554 + 509152.231225166 * var_x141);
        const double var_x144 = var_x130 * var_x142 - var_x130 * var_x143;
        const double var_x145 = var_x132 * var_x137 - var_x132 * var_x136;
        const double var_x146 = var_x139 * var_x142 - var_x139 * var_x143;
        const double var_x147 = 1 / var_chaste_interface__Ca_i__Ca_i;
        const double var_x148 = pow(var_x147, 1.3999999999999999);
        const double var_x149 = 1.0 + 6.4818210260626455e-7 * var_x148;
        const double var_x150 = 1 / (0.018329999999999999 * var_chaste_interface__intracellular_ion_concentrations__Na_i + var_chaste_interface__intracellular_ion_concentrations__K_i);
        const double var_x151 = mParameters[13] * var_chaste_interface__i_Ks_xs1_gate__xs1 * var_chaste_interface__i_Ks_xs2_gate__xs2;
        const double var_x152 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * var_x133);
        const double var_x153 = 1.0 + var_x152;
        const double var_x154 = 1 / var_x153;
        const double var_x155 = exp(-2.4444678999999998 + 13.738155796237757 * var_x133 - 0.51429999999999998 * var_chaste_interface__membrane__V);
        const double var_x156 = 1.0 + var_x155;
        const double var_x157 = 1 / var_x156;
        const double var_x158 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * var_x133);
        const double var_x159 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * var_x133);
        const double var_x160 = var_x159 + 0.49124000000000001 * var_x158;
        const double var_x161 = var_x157 * var_x160;
        const double var_x162 = var_x132 * var_x152 / pow(var_x153, 2);
        const double var_x163 = sqrt(mParameters[5]);
        const double var_x164 = var_x154 * var_x163 * mParameters[11];
        const double var_x165 = 1 / (var_x161 + 1.02 * var_x154);
        const double var_x166 = 26.712338705498265 * var_x132;
        const double var_x167 = var_x150 * var_x151 * (-6.767281717060562e-9 - 4.0603690302363372e-9 / var_x149);
        const double var_x168 = mParameters[5] / (var_x75 * (1.5 + mParameters[5]) * pow((0.01 + 1 / var_x91), 2) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[6])) * exp(-var_x127)));
        const double var_x169 = 2.010502764933119e-20 * var_x88;
        const double var_x170 = exp(3.3333333333333335 + 234.05767907222176 * var_x105);
        const double var_x171 = 1.0 + var_x170;
        const double var_x172 = 1 / var_x171;
        const double var_x173 = exp(-15.0 + 5000.0 * var_chaste_interface__Ca_r__Ca_r + 15.0 * var_x172);
        const double var_x174 = 1.0 + var_x173;
        const double var_x175 = 1 / var_x174;
        const double var_x176 = 350.0 - var_x122;
        const double var_x177 = var_x175 * var_x176;
        const double var_x178 = exp(-16.0 + 80.0 * var_x172 + 40000.0 * var_chaste_interface__Ca_r__Ca_r);
        const double var_x179 = 1.0 + var_x178;
        const double var_x180 = (-var_chaste_interface__q_rel_ri_gate__ri + 1 / var_x179) / pow((0.29999999999999999 + var_x40 + 0.10000000000000001 * var_x177), 2);
        const double var_x181 = 0.01 * var_x180;
        const double var_x182 = var_x170 / pow(var_x171, 2);
        const double var_x183 = var_x104 * var_x182;
        const double var_x184 = var_x173 * var_x176 / pow(var_x174, 2);
        const double var_x185 = 1 / (3.0 + var_x122 + var_x177);
        const double var_x186 = var_x178 * var_x185 / pow(var_x179, 2);
        const double var_x187 = var_x107 * var_x182;
        const double var_x188 = 18724.61432577774 * var_x186;
        const double var_x189 = 35.108651860833263 * var_x180 * var_x184;
        const double var_x190 = var_x109 * var_x182;
        const double var_x191 = pow(var_chaste_interface__Ca_JSR__Ca_JSR, 1.8999999999999999);
        const double var_x192 = 0.0028 + var_chaste_interface__Ca_r__Ca_r;
        const double var_x193 = 1 / var_x192;
        const double var_x194 = pow((var_x193 * var_chaste_interface__Ca_r__Ca_r), 1.8999999999999999);
        const double var_x195 = 1 / (var_x191 + 1644.6531773416521 * var_x194);
        const double var_x196 = pow(var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2, 2);
        const double var_x197 = -1 + 0.066666666666666666 * var_chaste_interface__membrane__V;
        const double var_x198 = pow(var_x197, 2);
        const double var_x199 = pow(var_x7, (-2));
        const double var_x200 = pow(var_x6, 2);
        const double var_x201 = pow(mParameters[7], 2);
        const double var_x202 = pow(var_chaste_interface__i_Ca_L_d_gate__d, 2);
        const double var_x203 = pow(var_chaste_interface__i_Ca_L_f2_gate__f2, 2);
        const double var_x204 = pow(var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca, 2);
        const double var_x205 = pow(var_chaste_interface__i_Ca_L_f_gate__f, 2);
        const double var_x206 = var_x198 * var_x199 * var_x200 * var_x201 * var_x202 * var_x203 * var_x204 * var_x205;
        const double var_x207 = var_x196 * var_x206;
        const double var_x208 = 1 / (1.0 + 2773.3892298416795 * var_x207);
        const double var_x209 = var_x207 * var_x208;
        const double var_x210 = var_x209 / pow((var_x194 + 0.00060803092942449902 * var_x191), 2);
        const double var_x211 = var_x191 * var_x195;
        const double var_x212 = 1848.9261532277862 * var_x208 * var_x211;
        const double var_x213 = var_x196 * var_x198 * var_x199 * var_x201 * var_x202 * var_x203 * var_x205 * var_x212;
        const double var_x214 = pow(var_x197, 4);
        const double var_x215 = pow((0.00036056965579875914 + var_x207), (-2));
        const double var_x216 = pow(var_x7, (-4));
        const double var_x217 = pow(mParameters[7], 4);
        const double var_x218 = pow(var_chaste_interface__i_Ca_L_d_gate__d, 4);
        const double var_x219 = pow(var_chaste_interface__i_Ca_L_f2_gate__f2, 4);
        const double var_x220 = pow(var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca, 4);
        const double var_x221 = pow(var_chaste_interface__i_Ca_L_f_gate__f, 4);
        const double var_x222 = pow(var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2, 4);
        const double var_x223 = 0.66666666666666663 * var_x211 * var_x214 * var_x215 * var_x216 * var_x217 * var_x218 * var_x219 * var_x221 * pow(var_x6, 4);
        
        
        rJacobian[0][0] = 1.0 - (mDt * (var_x2 * (-0.0083333333333333332 - var_x15) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca_NSR__Ca_NSR - 0.0083333333333333332 * var_chaste_interface__Ca_JSR__Ca_JSR - var_x15 * var_x16) / (pow(var_x0, 3) * pow((0.125 + var_x1), 2))));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = -(mDt * (0.0083333333333333332 * var_x2));
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = -(mDt * (var_x2 * (var_x15 + 0.70217303721666524 * var_x19)));
        rJacobian[0][5] = 0.0;
        rJacobian[0][6] = 0.0;
        rJacobian[0][7] = 0.0;
        rJacobian[0][8] = 0.0;
        rJacobian[0][9] = 0.0;
        rJacobian[0][10] = 0.0;
        rJacobian[0][11] = -(mDt * (-var_x20 * var_x21));
        rJacobian[0][12] = -(mDt * (-var_x21 * var_x22));
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (-0.00068000000000000005 - var_x29 * var_x30 + var_x23 * var_x30 * var_x31));
        rJacobian[1][2] = 0.0;
        rJacobian[1][3] = 0.0;
        rJacobian[1][4] = -(mDt * (0.00037500000000000001 * var_x29 * var_x33 + 1.8750000000000002e-5 * var_x32 * pow(var_x23, 2) / pow(var_x25, 3)));
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[1][7] = 0.0;
        rJacobian[1][8] = 0.0;
        ...
        rJacobian[2][1] = -(mDt * (var_x39 * var_x44 + var_x45 * var_x48));
        rJacobian[2][2] = 1.0 - (mDt * (-0.00072463768115942019 - 0.066666666666666666 * mParameters[0]));
        rJacobian[2][3] = -(mDt * (-var_x48 + 0.5 * var_x49));
        rJacobian[2][4] = -(mDt * (var_x44 * var_x52 + var_x48 * var_x53));
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = 0.0;
        rJacobian[2][8] = 0.0;
        ...
        rJacobian[2][12] = 0.0;
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = -(mDt * (-var_x64 * (var_x39 * var_x55 + var_x45 * var_x56)));
        rJacobian[3][2] = -(mDt * (var_x63 * var_x65));
        rJacobian[3][3] = 1.0 - (mDt * (-var_x64 * (0.14705882352941174 + var_x66 + var_x67 - var_x56 + 1.0150922575590843e-8 * var_x83 - 9.3990023848063356e-17 * var_x90 + var_x68 * var_x69 - var_x84 * var_x89 - 1.9455934936549115e-10 * var_x58 * var_chaste_interface__Ca_i__Ca_i) - (-var_x59 - var_x61 + 0.28000000000000003 * var_chaste_interface__Ca_i__Ca_i / pow(var_x57, 3) + 0.20000000000000001 * var_chaste_interface__Ca_i__Ca_i / pow(var_x60, 3)) * (0.14705882352941174 * var_chaste_interface__Ca_i__Ca_i - 0.14705882352941174 * var_chaste_interface__Ca_r__Ca_r + var_x66 * var_chaste_interface__Ca_i__Ca_i + var_x67 * var_chaste_interface__Ca_i__Ca_i + var_x69 * (var_x3 + var_x68 * var_chaste_interface__Ca_i__Ca_i) - var_x65 * var_chaste_interface__Ca_NSR__Ca_NSR - 6.767281717060562e-9 * var_x82 * var_x86) / pow(var_x62, 2)));
        rJacobian[3][4] = -(mDt * (-var_x64 * (-0.14705882352941174 + var_x52 * var_x55 + var_x53 * var_x56)));
        rJacobian[3][5] = 0.0;
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = 0.0;
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = -(mDt * (-var_x64 * (-8.1207380604726744e-9 * var_x94 - var_x89 * var_x93)));
        rJacobian[3][11] = 0.0;
        rJacobian[3][12] = 0.0;
        rJacobian[4][0] = -(mDt * (var_x101 * var_x102));
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = -(mDt * (5.0 * var_x101));
        rJacobian[4][4] = 1.0 - (mDt * (var_x101 * (-5.0 - var_x102 - 0.16852152893199965 * var_x19 - 4.0390323434238405e-7 * var_x104) + 0.19788249895518037 * (-var_x100 - 2.2480000000000002 * var_x96 + 4.4960000000000004 * var_chaste_interface__Ca_r__Ca_r / pow(var_x95, 3) + 0.188 * var_chaste_interface__Ca_r__Ca_r / pow(var_x98, 3)) * (5.0 * var_chaste_interface__Ca_i__Ca_i - 5.0 * var_chaste_interface__Ca_r__Ca_r - 4.0390323434238405e-7 * var_x105 + var_x102 * var_x16) / pow((0.44483985765124551 + var_x97 + 0.041814946619217079 * var_x99 * var_chaste_interface__Ca_r__Ca_r), 2)));
        rJacobian[4][5] = -(mDt * (-var_x107 * var_x108));
        rJacobian[4][6] = -(mDt * (-var_x108 * var_x109));
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = 0.0;
        rJacobian[4][11] = -(mDt * (var_x110 * var_x20));
        rJacobian[4][12] = -(mDt * (var_x110 * var_x22));
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = -(mDt * (var_x104 * var_x117 - var_x104 * var_x118));
        rJacobian[5][5] = 1.0 - (mDt * (var_x114 * (-1 + var_x107 * var_x116) - var_x107 * var_x118));
        rJacobian[5][6] = -(mDt * (var_x109 * var_x117 - var_x109 * var_x118));
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        ...
        rJacobian[5][12] = 0.0;
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = -(mDt * (var_x119 * var_x121));
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = -(mDt * (var_x121 * (var_x126 + 0.0030000000000000001 * var_x124) + var_x123 * (-0.0016500000000000002 * var_x124 + var_x104 * var_x125)));
        rJacobian[6][5] = -(mDt * (var_x107 * var_x123 * var_x125));
        rJacobian[6][6] = 1.0 - (mDt * (var_x123 * (-1 + var_x109 * var_x125)));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = -(mDt * (0.1502 * var_x32 / pow((1.0 + 0.1502 * var_x24), 2)));
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        ...
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = -(mDt * (-var_x129 * (-100.0 * var_x128 + var_chaste_interface__intracellular_ion_concentrations__Cl_i) * mParameters[3]));
        rJacobian[8][8] = 1.0 - (mDt * ((var_x138 + var_x144 + 4.0673232301870709e-11 * var_x130 - var_x129 * var_chaste_interface__i_to_2_a_gate__a) * mParameters[3]));
        rJacobian[8][9] = -(mDt * (var_x145 * mParameters[3]));
        rJacobian[8][10] = -(mDt * (var_x146 * mParameters[3]));
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = 0.0;
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = -(mDt * (-3.6846019495263273e-15 * var_x147 * var_x148 * var_x151 * (-26.712338705498265 * log(var_x150 * (0.018329999999999999 * mParameters[6] + mParameters[5])) + var_chaste_interface__membrane__V) * mParameters[3] / pow(var_x149, 2)));
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = 0.0;
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = -(mDt * (var_x138 * mParameters[3]));
        rJacobian[9][9] = 1.0 - (mDt * ((var_x145 + 26.712338705498265 * var_x167 - 9.0384960670823802e-10 * var_x132 + var_x166 * (-2.7069126868242249e-11 - 2.9704178641172085e-9 * var_x164 * var_x165) + (-var_x134 + var_chaste_interface__membrane__V) * (-2.8550729182210769e-9 * var_x164 * (6.4983106368865622 * var_x162 - var_x157 * (1.053972635420138 * var_x132 * var_x158 + 1.6494869150645177 * var_x132 * var_x159) - 13.738155796237757 * var_x132 * var_x155 * var_x160 / pow(var_x156, 2)) / pow((var_x154 + 0.98039215686274506 * var_x161), 2) + 1.892421372783404e-8 * var_x162 * var_x163 * var_x165 * mParameters[11]) - 4.9892498290294737e-10 * var_x132 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + var_x166 * (-1.3534563434121124e-9 * var_chaste_interface__i_to_1_i2_gate__i2 - 5.4138253736484496e-9 * var_chaste_interface__i_to_1_i_gate__i) * mParameters[15] * var_chaste_interface__i_to_1_a_gate__a - 7.7790988316825085e-8 * var_x132 * var_x163 * mParameters[12] * var_chaste_interface__i_Kr_xr_gate__xr / (1.0 + exp(-0.26470588235294124 + 0.049019607843137261 * var_chaste_interface__membrane__V))) * mParameters[3]));
        rJacobian[9][10] = -(mDt * ((1.6749022249724892e-10 * var_x168 + 0.48963716847178318 * var_x167) * mParameters[3]));
        rJacobian[9][11] = 0.0;
        rJacobian[9][12] = 0.0;
        rJacobian[10][0] = 0.0;
        rJacobian[10][1] = 0.0;
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = -(mDt * ((3.045276772677253e-8 * var_x83 - 2.8197007154419011e-16 * var_x90 - var_x169 * var_x84) * mParameters[3]));
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = 0.0;
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = -(mDt * (var_x144 * mParameters[3]));
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * ((var_x146 - 2.5123533374587338e-10 * var_x168 - 2.4362214181418025e-8 * var_x94 - 4.5192480335411901e-10 * var_x139 - var_x169 * var_x93 - 6.7562758101440786e-9 * var_x139 * pow(var_chaste_interface__i_Na_L_m_L_gate__m_L, 3) * var_chaste_interface__i_Na_L_h_L_gate__h_L - 1.8076992134164759e-7 * var_x139 * pow(var_chaste_interface__i_Na_m_gate__m, 3) * (0.20000000000000001 * var_chaste_interface__i_Na_j_gate__j + 0.80000000000000004 * var_chaste_interface__i_Na_h_gate__h) * mParameters[8]) * mParameters[3]));
        rJacobian[10][11] = 0.0;
        rJacobian[10][12] = 0.0;
        rJacobian[11][0] = 0.0;
        rJacobian[11][1] = -(mDt * (var_x181 * (var_x119 - var_x119 * var_x175)));
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = -(mDt * (var_x181 * (var_x126 + var_x184 * (5000.0 - 3510.8651860833261 * var_x183) - var_x126 * var_x175) - var_x186 * (40000.0 - 18724.61432577774 * var_x183)));
        rJacobian[11][5] = -(mDt * (var_x187 * var_x188 - var_x187 * var_x189));
        rJacobian[11][6] = -(mDt * (var_x188 * var_x190 - var_x189 * var_x190));
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (-var_x185));
        rJacobian[11][12] = 0.0;
        rJacobian[12][0] = -(mDt * (-0.00064937342883524983 * var_x210 * pow(var_chaste_interface__Ca_JSR__Ca_JSR, 2.7999999999999998) + 1756.479845566397 * var_x195 * var_x209 * pow(var_chaste_interface__Ca_JSR__Ca_JSR, 0.89999999999999991)));
        rJacobian[12][1] = 0.0;
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (var_x204 * var_x213 * var_x5 * var_x6 - 0.56210214369217726 * var_x191 * var_x192 * var_x194 * var_x210 * var_x24 * (1.8999999999999999 * var_x193 - 1.8999999999999999 * var_chaste_interface__Ca_r__Ca_r / pow(var_x192, 2)) - 0.66666666666666663 * var_x211 * var_x214 * var_x215 * var_x216 * var_x217 * var_x218 * var_x219 * var_x220 * var_x221 * var_x222 * var_x5 * pow(var_x6, 3)));
        rJacobian[12][5] = -(mDt * (var_x206 * var_x212 * var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2 - var_x220 * var_x223 * pow(var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2, 3)));
        rJacobian[12][6] = -(mDt * (var_x200 * var_x213 * var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca - var_x222 * var_x223 * pow(var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca, 3)));
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
    ...
    void Cellaslanidi_Purkinje_model_2009FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_i_Na_L_m_L_gate__alpha_m_L = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_i_Na_m_gate__alpha_m = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V));
