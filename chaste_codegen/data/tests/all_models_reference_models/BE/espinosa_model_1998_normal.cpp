...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellespinosa_model_1998_normalFromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = -0018000000000000002 * HeartConfig::Instance()->GetCapacitance() / mParameters[0]; // uA_per_cm2
    ...
    void Cellespinosa_model_1998_normalFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x21 = -037433890822745473 * var_chaste_interface__membrane__V;
        const double var_x22 = exp(1.8716945411372736 + var_x21);
        const double var_x23 = (-50 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        const double var_x30 = exp(0.6251459767398494 + 062514597673984929 * var_chaste_interface__membrane__V - 1.6699999999999999 * var_x29);
        const double var_x31 = 1.0 + var_x30;
        const double var_x32 = 1 / var_x31;
        const double var_x33 = 1 / (10 + var_chaste_interface__extracellular_potassium_concentration__K_o);
        const double var_x34 = var_x32 * var_x33;
        const double var_x35 = 0024811376697271795 * var_x34;
        ...
        const double var_x44 = 1 / (40 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x45 = var_x43 * var_x44;
        const double var_x46 = 001083584094188964 * var_x45;
        ...
        const double var_x50 = 00015510732319676314 * var_x49;
        ...
        const double var_x54 = var_x43 * var_x47 / pow((1 + 025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x55 = 100 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x56 = -var_x55;
        const double var_x57 = 100 * var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod;
        const double var_x58 = 100 * var_chaste_interface__intracellular_calcium_concentration__Ca_Trop;
        const double var_x59 = exp(3.7433890822745473 - 074867781645490947 * var_chaste_interface__membrane__V);
        ...
        const double var_x67 = 00041999999999999996 + 00023999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_up + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x74 = 018716945411372737 * var_chaste_interface__membrane__V;
        ...
        const double var_x79 = 1 / (1.0 + 012500000000000001 * var_x73 + 16373.795625000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x80 = var_x72 * var_x79;
        const double var_x81 = var_x76 * var_x80;
        const double var_x82 = var_x77 * var_x79 / pow((0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        ...
        const double var_x88 = 0020254185058997385 * var_x34;
        const double var_x89 = 00088455844423588909 * var_x45;
        ...
        const double var_x91 = 00012661822301776582 * var_x49;
        ...
        const double var_x95 = 001215251103539843 * var_x94;
        const double var_x96 = 0013268376663538336 * var_x45;
        ...
        rJacobian[0][6] = 0;
        rJacobian[0][7] = 0;
        rJacobian[0][8] = -(mDt * (-001 / (100000 + var_chaste_interface__intracellular_calcium_concentration__Ca_i) + 1.0e-13 * var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow((1 + 1.0000000000000001e-5 * var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2)));
        rJacobian[0][9] = 0;
        rJacobian[0][10] = 0;
        rJacobian[0][11] = 0;
        rJacobian[0][12] = 0;
        ...
        rJacobian[1][5] = 0;
        rJacobian[1][6] = 0;
        rJacobian[1][7] = -(mDt * (-02 / var_x0 + 02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x0, 2)));
        rJacobian[1][8] = 0;
        rJacobian[1][9] = 0;
        rJacobian[1][10] = 0;
        rJacobian[1][11] = 0;
        ...
        rJacobian[4][2] = 0;
        rJacobian[4][3] = 0;
        rJacobian[4][4] = 1.0 - (mDt * (-00069999999999999999 + var_x50 - var_x35 + 001083584094188964 * var_x48 + 9.2878636644768344e-5 * var_x39 - 8.2704588990905987e-5 * var_x26 - 9.2878636644768348e-7 * var_x51 - var_x22 * var_x53 - var_x26 * var_x41 - var_x36 * var_x37 - var_x46 * var_chaste_interface__intracellular_sodium_concentration__Na_i));
        rJacobian[4][5] = 0;
        rJacobian[4][6] = 0;
        rJacobian[4][7] = 0;
        rJacobian[4][8] = 0;
        ...
        rJacobian[5][3] = 0;
        rJacobian[5][4] = 0;
        rJacobian[5][5] = 1.0 - (mDt * (-050000000000000003 + var_x56));
        rJacobian[5][6] = 0;
        rJacobian[5][7] = 0;
        ...
        rJacobian[8][3] = 0;
        rJacobian[8][4] = 0;
        rJacobian[8][5] = -(mDt * (050000000000000003 + var_x55));
        rJacobian[8][6] = -(mDt * (0.20000000000000001 + var_x55));
        rJacobian[8][7] = -(mDt * (001));
        rJacobian[8][8] = 1.0 - (mDt * (-7.0000000000000009 + var_x57 + var_x58 + 00040000000000000002 * var_x70 - 7.7098266909426358e-12 * var_x78 - 0.41340273157434637 * var_x81 - 7.2e-9 * var_x71 - 1.0549054718227806e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i - 00040000000000000002 * var_x68 - 8.7104997313748684e-10 * var_x82));
        rJacobian[8][9] = -(mDt * (1.0204081632653063e-5 + 051020408163265314 * var_x83));
        ...
        rJacobian[9][7] = 0;
        rJacobian[9][8] = 0;
        rJacobian[9][9] = 1.0 - (mDt * (-0050499999999999998 - 0.25 * var_x83));
        rJacobian[9][10] = -(mDt * (0050000000000000001));
        rJacobian[9][11] = 0;
        rJacobian[9][12] = 0;
        rJacobian[10][0] = 0;
        rJacobian[10][1] = 0;
        ...
        rJacobian[10][6] = 0;
        rJacobian[10][7] = 0;
        rJacobian[10][8] = -(mDt * (019599999999999999 * var_x68 + 3.5279999999999993e-7 * var_x71 - 019599999999999999 * var_x70));
        rJacobian[10][9] = -(mDt * (050000000000000003));
        rJacobian[10][10] = 1.0 - (mDt * (-050000000000000003 + 8.4671999999999982e-11 * var_x71 - 3.5279999999999993e-7 * var_x68 - 4.7040000000000002e-6 * var_x70));
        rJacobian[10][11] = 0;
        rJacobian[10][12] = 0;
        rJacobian[11][0] = 0;
        ...
        rJacobian[11][2] = 0;
        rJacobian[11][3] = 0;
        rJacobian[11][4] = -(mDt * (var_x88 - var_x91 + 7.5819295220219063e-7 * var_x51 + 6.7513950196657958e-5 * var_x26 - 7.5819295220219067e-5 * var_x39 - 00088455844423588909 * var_x48 + var_x22 * var_x92 + var_x36 * var_x87 + var_x89 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x26 * var_x90));
        rJacobian[11][5] = 0;
        rJacobian[11][6] = 0;
        rJacobian[11][7] = 0;
        rJacobian[11][8] = 0;
        ...
        rJacobian[12][2] = 0;
        rJacobian[12][3] = 0;
        rJacobian[12][4] = -(mDt * (0013268376663538336 * var_x48 + var_x95 / (148.5 + 0.12 * var_chaste_interface__extracellular_potassium_concentration__K_o) - var_x96 * var_chaste_interface__intracellular_sodium_concentration__Na_i));
        rJacobian[12][5] = 0;
        rJacobian[12][6] = 0;
        rJacobian[12][7] = 0;
    ...
    void Cellespinosa_model_1998_normalFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_L_type_Ca_channel_d_gate__speed_d = 10;
        ...
        const double var_L_type_Ca_channel_d_gate__alpha_d = ((fabs(var_L_type_Ca_channel_d_gate__E0_d) < 0001) ? (120) : (30 * var_L_type_Ca_channel_d_gate__E0_d / (1.0 - exp(-0.33333333333333331 * var_L_type_Ca_channel_d_gate__E0_d))));
        const double var_L_type_Ca_channel_d_gate__beta_d = ((fabs(var_L_type_Ca_channel_d_gate__E0_d) < 0001) ? (120) : (12.0 * var_L_type_Ca_channel_d_gate__E0_d / (-1.0 + exp(0.13333333333333333 * var_L_type_Ca_channel_d_gate__E0_d))));
        ...
        const double var_time_dependent_potassium_current_x_gate__delta_x = 0001;
        ...
        rY[4] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((001 * var_fast_sodium_current_h_gate__alpha_h) * mDt)) / (1.0 - ((-001 * var_fast_sodium_current_h_gate__alpha_h - 001 * var_fast_sodium_current_h_gate__beta_h) * mDt));
        rY[3] = (var_chaste_interface__fast_sodium_current_m_gate__m + ((001 * var_fast_sodium_current_m_gate__alpha_m) * mDt)) / (1.0 - ((-001 * var_fast_sodium_current_m_gate__alpha_m - 001 * var_fast_sodium_current_m_gate__beta_m) * mDt));
        rY[2] = (var_chaste_interface__time_dependent_potassium_current_x_gate__x + ((001 * var_time_dependent_potassium_current_x_gate__alpha_x) * mDt)) / (1.0 - ((-001 * var_time_dependent_potassium_current_x_gate__alpha_x - 001 * var_time_dependent_potassium_current_x_gate__beta_x) * mDt));
        ...
        rY[9] = (var_chaste_interface__transient_outward_current_s_gate__s + ((001 * var_transient_outward_current_s_gate__alpha_s) * mDt)) / (1.0 - ((-001 * var_transient_outward_current_s_gate__alpha_s - 001 * var_transient_outward_current_s_gate__beta_s) * mDt));
