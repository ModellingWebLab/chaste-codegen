...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celldavies_isap_2012FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x31 = exp(-0.024333324280070002 * var_chaste_interface__cell__V);
        ...
        const double var_x35 = exp(0.01310255922773 * var_chaste_interface__cell__V);
        ...
        const double var_x190 = 0.0016433629212878199 * var_x112;
        const double var_x191 = var_x188 * var_x189 * (-6.1520742882368733e-5 - 3.6912445729421236e-5 / var_x187);
        const double var_x192 = sqrt(mParameters[2]);
        const double var_x193 = var_x112 * var_x192;
        const double var_x194 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 6.370892781261781 * var_x113);
        const double var_x195 = 1.0 + var_x194;
        const double var_x196 = 1 / var_x195;
        const double var_x197 = exp(-2.4444678999999998 + 13.738155796238718 * var_x113 - 0.51429999999999998 * var_chaste_interface__cell__V);
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = 1 / var_x198;
        const double var_x200 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * var_x113);
        const double var_x201 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 2.1455350448257708 * var_x113);
        const double var_x202 = var_x200 + 0.49124000000000001 * var_x201;
        const double var_x203 = var_x199 * var_x202;
        const double var_x204 = 1 / (var_x203 + 1.02 * var_x196);
        const double var_x205 = var_x196 * mParameters[10];
        const double var_x206 = var_x112 * var_x194 / pow(var_x195, 2);
        const double var_x207 = var_x192 * (-var_x114 + var_chaste_interface__cell__V);
        const double var_x208 = mParameters[2] * mParameters[16] / (var_x27 * (1.5 + mParameters[2]) * pow((0.01 + 1 / var_x64), 2) * (1.0 + 0.1245 * exp(-0.00374358835078 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[3])) * exp(-var_x108)));
        const double var_x209 = 1.827729786302835e-16 * var_x39;
        const double var_x210 = 0.0016433629212878199 * var_x119;
        ...
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x125 + 26.712338705500134 * var_x191 - var_x190 * mParameters[12] / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V)) - 0.0008381150898567882 * var_x193 * var_x204 * var_x205 + 0.00019989044893084398 * var_x204 * var_x206 * var_x207 * mParameters[10] - 0.00082168146064390995 * var_x193 * mParameters[13] * var_chaste_interface__IKr__xr / (1.0 + 2.5 * exp(2.8000000000000003 + 0.10000000000000001 * var_chaste_interface__cell__V)) - 3.0157226903121925e-5 * var_x205 * var_x207 * (6.4983106368870169 * var_x206 - var_x199 * (1.6494869150646332 * var_x112 * var_x200 + 1.0539726354202117 * var_x112 * var_x201) - 13.738155796238718 * var_x112 * var_x197 * var_x202 / pow(var_x198, 2)) / pow((var_x196 + 0.98039215686274506 * var_x203), 2) - var_x190 * pow(var_chaste_interface__Ito__ydv, 3) * ((var_chaste_interface__cell__V <= 0) ? (exp(var_chaste_interface__cell__V / mParameters[19])) : (1.0)) * mParameters[18] * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv));
        rJacobian[11][12] = -(mDt * (0.48963716847181743 * var_x191 + 2.460829715294749e-6 * var_x208));
        rJacobian[12][0] = -(mDt * (0.00027684334297065928 * var_x45 - 2.563364286765364e-12 * var_x43 - var_x209 * var_x26));
        rJacobian[12][1] = 0.0;
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x126 - 3.6912445729421236e-6 * var_x208 - 0.00055368668594131857 * var_x67 - var_x209 * var_x66 - var_x210 * pow(var_chaste_interface__INal__mL, 3) * mParameters[11] * var_chaste_interface__INal__hL - var_x210 * pow(var_chaste_interface__INa__m, 3) * mParameters[9] * var_chaste_interface__INa__H * var_chaste_interface__INa__J));
    }
