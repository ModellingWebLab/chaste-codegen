...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellfink_noble_giles_model_2008FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[17], double rJacobian[17][17])
    {
        ...
        const double var_x35 = log(10);
        const double var_x36 = var_x32 * var_x34 * pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x37 = 0.00025000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x38 = 1.0 + 0.0001 / pow(var_x37, 2);
        const double var_x39 = 1 / var_x38;
        const double var_x40 = 0.91833577176298453 * var_x10;
        const double var_x41 = exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__cell__V);
        const double var_x42 = (-15.0 + var_chaste_interface__cell__V) * var_chaste_interface__iCaL_d_gate__d * var_chaste_interface__iCaL_f2_gate__f2 * var_chaste_interface__iCaL_f_gate__f / (-1.0 + var_x41);
        const double var_x43 = var_x42 * var_chaste_interface__iCaL_fCass_gate__fCass;
        const double var_x44 = -0.0062983137448657349 + 0.00078728921810821686 * var_x41 * var_chaste_interface__Ca__Ca_ss;
        const double var_x45 = -0.11249999999999999 + 0.067500000000000004 * var_x4;
        const double var_x46 = 1 / var_chaste_interface__K__K_i;
        const double var_x47 = var_x35 * log10(5.4000000000000004 * var_x46);
        const double var_x48 = 1 / exp(3.1258035549938383 * var_x47 - 0.10989010989010989 * var_chaste_interface__cell__V);
        const double var_x49 = 1.0 + 0.036532500000000002 * var_x48;
        const double var_x50 = 1 / exp(1.4222406175221964 * var_x47 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x51 = 1.0 + 0.079111111111111104 * var_x50;
        const double var_x52 = pow(var_x51, 2);
        const double var_x53 = 1 / exp(-0.059333333333333335 + 5.9260025730091517 * var_x47 - 0.20833333333333334 * var_chaste_interface__cell__V);
        const double var_x54 = 1 / exp(0.15802673528024405 * var_x47 - 0.0055555555555555558 * var_chaste_interface__cell__V);
        const double var_x55 = pow(var_x51, 3);
        const double var_x56 = var_x46 * var_x50;
        const double var_x57 = 1 / (var_x55 + 2.0875714285714286 * var_x53 + 0.012714285714285714 * var_x54);
        const double var_x58 = pow(var_chaste_interface__iKs_Xs_gate__Xs, 2) / (0.029999999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
        const double var_x59 = 1 / (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__cell__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__cell__V));
        const double var_x60 = var_x59 / (40.0 + var_chaste_interface__Na__Na_i);
        const double var_x61 = var_x59 * var_chaste_interface__Na__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__Na__Na_i), 2);
        const double var_x62 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x63 = 1 / (1.0 + 399.99999999999994 * var_x6);
        const double var_x64 = 1 / (2.0 + 80.0 * var_x63);
        const double var_x65 = var_chaste_interface__Ca__Ca_ss / pow((0.0025000000000000005 + var_x6), 2);
        const double var_x66 = 1.0 * exp(-1.5790000000000006 + 0.0112 * var_chaste_interface__cell__V);
        const double var_x67 = -var_x66;
        const double var_x68 = 1.0 * exp(-2.0190000000000001 - 0.060299999999999999 * var_chaste_interface__cell__V);
        const double var_x69 = 1.0 * exp(-3.1680000000000028);
        const double var_x70 = -var_x68 - var_x69;
        const double var_x71 = 1.0 * exp(-2.5140000000000011);
        const double var_x72 = 1.0 * exp(-3.8160000000000025 + 0.036499999999999998 * var_chaste_interface__cell__V);
        const double var_x73 = -var_x71 - var_x72;
        const double var_x74 = 1.0 * exp(-8.3940000000000019 - 0.039899999999999998 * var_chaste_interface__cell__V);
        const double var_x75 = 1.0 * exp(-3.1820000000000022 - 0.031199999999999999 * var_chaste_interface__cell__V);
        const double var_x76 = -var_x75;
        const double var_x77 = 1.0 * exp(-0.87200000000000344 + 0.0223 * var_chaste_interface__cell__V);
        ...
        rJacobian[1][15] = 0.0;
        rJacobian[1][16] = 0.0;
        rJacobian[2][0] = -(mDt * (var_x39 * (var_x40 + 0.1959116313094367 * var_x15 - 1.3060775420629114 * var_x18)));
        rJacobian[2][1] = -(mDt * (1.1399999999999999 * var_x39));
        rJacobian[2][2] = 1.0 - (mDt * (var_x39 * (-1.1399999999999999 - var_x40 + 1.8366715435259691 * var_x23 - 1.9591163130943672 * var_x22 - 0.00078728921810821686 * var_x41 * var_x43) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__Ca__Ca_i - 1.1399999999999999 * var_chaste_interface__Ca__Ca_ss + var_x13 * var_x40 - var_x43 * var_x44) / (pow(var_x37, 3) * pow(var_x38, 2))));
        rJacobian[2][3] = -(mDt * (0.91833577176298453 * var_x24 * var_x39));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = -(mDt * (-var_x39 * var_x42 * var_x44));
        rJacobian[2][7] = 0.0;
        rJacobian[2][8] = 0.0;
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        ...
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = -(mDt * (var_x45 * var_chaste_interface__Irel__R_prime));
        rJacobian[3][3] = 1.0 - (mDt * (-0.0050000000000000001 + var_x45 * var_chaste_interface__Ca__Ca_ss));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = 0.0;
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = 0.0;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-7.6086540673064781e-5 * var_x58 + (-26.713760659695652 * var_x47 + var_chaste_interface__cell__V) * (6.576305692690868e-7 * var_x46 * var_x48 / pow(var_x49, 2) - 9.8566502268897146e-6 * var_x51 * var_x56 * var_x57 - 1.0050926558006126e-5 * var_x52 * (-12.370953657054676 * var_x46 * var_x53 - 0.33754510655860126 * var_x52 * var_x56 - 0.0020091970628488172 * var_x46 * var_x54) / pow((var_x53 + 0.0060904673920481765 * var_x54 + 0.47902552521727226 * var_x55), 2)) + 26.713760659695652 * var_x46 * (-5.7589183215629007e-6 / var_x49 - 4.3801480314950888e-5 * var_x52 * var_x57) - 4.6583596330447822e-5 * var_x46 * var_chaste_interface__iKr_Markov__Or4 - 1.8885766345635723e-5 * var_x46 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__cell__V)) - 0.00038819663608706523 * var_x46 * var_chaste_interface__ito_r_gate__r * var_chaste_interface__ito_s_gate__s));
        rJacobian[4][5] = -(mDt * (0.00015902686554868019 * var_x60 - 9.9391790967925116e-8 * var_x61 - 2.282596220191943e-6 * var_x58));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        ...
        rJacobian[4][14] = 0.0;
        rJacobian[4][15] = 0.0;
        rJacobian[4][16] = -(mDt * (4.6583596330447822e-5 * var_x47 - 1.7438052591648303e-6 * var_chaste_interface__cell__V));
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = -(mDt * (0.025917423710103096 * var_x33));
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (1.4908768645188767e-7 * var_x61 - 5.6288512232624455e-7 * var_x62 - 2.2668300621081427e-8 * var_x36 - 0.00023854029832302029 * var_x60 - 0.021350814984788587 * var_x62 * pow(var_chaste_interface__iNa_m_gate__m, 3) * var_chaste_interface__iNa_h_gate__h * var_chaste_interface__iNa_j_gate__j));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        ...
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = -(mDt * (-0.0020000000000000005 * var_x64 * var_x65 + 6.2500000000000001e-5 * var_x65 * (0.59999999999999998 - var_chaste_interface__iCaL_fCass_gate__fCass + 0.40000000000000002 * var_x63) / pow((0.025000000000000001 + var_x63), 2)));
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-var_x64));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = -(mDt * (var_x66));
        rJacobian[8][8] = 1.0 - (mDt * (var_x70));
        rJacobian[8][9] = -(mDt * (var_x71));
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        rJacobian[8][13] = 0.0;
        ...
        rJacobian[9][9] = 1.0 - (mDt * (var_x73));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = -(mDt * (var_x74));
        rJacobian[9][12] = 0.0;
        rJacobian[9][13] = 0.0;
        rJacobian[9][14] = 0.0;
        rJacobian[9][15] = 0.0;
        ...
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (var_x76));
        ...
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = -(mDt * (var_x72));
        rJacobian[11][10] = -(mDt * (var_x75));
        rJacobian[11][11] = 1.0 - (mDt * (-0.00125 + var_x78));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = 0.0;
        rJacobian[11][15] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x67));
        rJacobian[12][13] = -(mDt * (var_x68));
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        rJacobian[13][0] = 0.0;
        ...
        rJacobian[13][10] = 0.0;
        rJacobian[13][11] = 0.0;
        rJacobian[13][12] = -(mDt * (var_x66));
        rJacobian[13][13] = 1.0 - (mDt * (var_x70));
        ...
        rJacobian[14][11] = 0.0;
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = -(mDt * (var_x69));
        rJacobian[14][14] = 1.0 - (mDt * (var_x73));
        rJacobian[14][15] = 0.0;
        rJacobian[14][16] = -(mDt * (var_x74));
        rJacobian[15][0] = 0.0;
        rJacobian[15][1] = 0.0;
        rJacobian[15][2] = 0.0;
        rJacobian[15][3] = 0.0;
        ...
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (var_x76));
        rJacobian[15][16] = -(mDt * (var_x77));
        rJacobian[16][0] = 0.0;
        rJacobian[16][1] = 0.0;
        rJacobian[16][2] = 0.0;
        rJacobian[16][3] = 0.0;
        ...
        rJacobian[16][12] = 0.0;
        rJacobian[16][13] = 0.0;
        rJacobian[16][14] = -(mDt * (var_x72));
        rJacobian[16][15] = -(mDt * (var_x75));
        rJacobian[16][16] = 1.0 - (mDt * (var_x78));
    }
