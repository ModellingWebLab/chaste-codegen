...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellfink_noble_giles_model_2008FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[17], double rJacobian[17][17])
    {
        ...
        const double var_x59 = exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__cell__V);
        ...
        const double var_x89 = mParameters[6] / ((1.0 + mParameters[6]) * (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__cell__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__cell__V)));
        ...
        const double var_x96 = exp(-1.5790000000000006 + 0.0112 * var_chaste_interface__cell__V);
        const double var_x97 = -var_x96;
        const double var_x98 = exp(-2.0190000000000001 - 0.060299999999999999 * var_chaste_interface__cell__V);
        ...
        const double var_x102 = exp(-3.8160000000000025 + 0.036499999999999998 * var_chaste_interface__cell__V);
        ...
        const double var_x105 = exp(-3.1820000000000022 - 0.031199999999999999 * var_chaste_interface__cell__V);
        const double var_x106 = -var_x105;
        const double var_x107 = 1.9631681698237122 * pow((1 / mParameters[6]), 0.40000000000000002) * exp(-0.87200000000000344 + 0.0223 * var_chaste_interface__cell__V);
