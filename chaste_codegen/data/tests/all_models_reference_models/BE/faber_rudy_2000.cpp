...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellfaber_rudy_2000FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x3 = 1.0 + 1.7279999999999996e-9 / pow(var_chaste_interface__calcium_dynamics__Cai, 3);
        const double var_x4 = 1 / var_x3;
        const double var_x5 = -0.75 * mParameters[6];
        const double var_x6 = 0.037435883507802616 * var_chaste_interface__cell__V;
        const double var_x7 = exp(var_x6);
        const double var_x8 = 0.75 * var_x7;
        const double var_x9 = var_chaste_interface__cell__V / (-1.0 + var_x7);
        const double var_x10 = var_x9 * (var_x5 + var_x8 * var_chaste_interface__ionic_concentrations__Ki);
        const double var_x11 = 0.00063210021354380874 * var_x10;
        const double var_x12 = -0.75 * mParameters[7];
        const double var_x13 = var_x9 * (var_x12 + var_x8 * var_chaste_interface__ionic_concentrations__Nai);
        const double var_x14 = 0.00063210021354380874 * var_x13;
        const double var_x15 = 0.0024381008236689767 * var_x13;
        const double var_x16 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x17 = var_x16 / (1.0 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x18 = 0.00069711623550831479 * var_x10;
        const double var_x19 = -0.34100000000000003 * mParameters[5];
        const double var_x20 = exp(0.074871767015605231 * var_chaste_interface__cell__V);
        const double var_x21 = var_chaste_interface__calcium_dynamics__Cai;
        const double var_x22 = var_x19 + var_x20 * var_x21;
        const double var_x23 = 1 / (-1.0 + var_x20);
        const double var_x24 = 14448.004881001343 * var_x23 * mParameters[8] * var_chaste_interface__cell__V;
        ...
        const double var_x28 = 1 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V));
        ...
        const double var_x34 = 0.80000000000000004 - 0.65000000000000002 / (1.0 + exp(8.3333333333333339 + 0.066666666666666666 * var_chaste_interface__cell__V));
        ...
        const double var_x39 = var_x7 * mParameters[5];
        const double var_x40 = var_x38 * var_x39;
        const double var_x41 = (var_x40 - var_x37) * mParameters[15];
        const double var_x42 = exp(-0.031820500981632228 * var_chaste_interface__cell__V);
        ...
        const double var_x48 = mParameters[6] / ((1.5 + mParameters[6]) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[7])) * exp(-var_x6)));
        ...
        const double var_x50 = pow(var_chaste_interface__transient_outward_current_zdv_gate__zdv, 3) * mParameters[16] * var_chaste_interface__transient_outward_current_ydv_gate__ydv * exp(0.01 * var_chaste_interface__cell__V);
        ...
        const double var_x59 = mParameters[13] * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__cell__V));
        ...
        const double var_x80 = var_x79 + var_x17 * var_x25;
        ...
        const double var_x84 = var_x5 + var_x82 * var_x83;
        ...
        const double var_x88 = var_x5 + var_x83 * var_x87;
        ...
        const double var_x94 = var_x4;
        const double var_x95 = 0.75 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x96 = var_x12 + var_x82 * var_x95;
        const double var_x97 = var_x12 + var_x87 * var_x95;
        ...
        const double var_x110 = var_x109 * var_x89 * (var_x19 + var_x21 * var_x87);
        const double var_x111 = 374358.83507802623 * (1.3356169352749131e-6 + var_chaste_interface__cell__V) * (var_x110 + var_x109 * var_x85 * (var_x19 + var_x21 * var_x82));
        ...
        const double var_x113 = 1.2777777777777777 * var_x74;
        const double var_x114 = var_x111 - var_x110;
        const double var_x115 = ((var_x1) ? (var_x114) : (var_x25));
        const double var_x116 = 1.1111111111111112 * var_x17;
        const double var_x117 = exp(5.5555555555555554 + 0.0033511111111111111 * var_chaste_interface__cell__V + 0.055555555555555559 * var_x77 - 0.044758007519879316 * var_x72 - 2.2222222222222223 * var_x45 + var_x113 * var_chaste_interface__calcium_dynamics__Cai + var_x115 * var_x116);
        const double var_x118 = 1.0 + var_x117;
        const double var_x119 = 1 / var_x118;
        const double var_x120 = 150.0 * var_x119;
        const double var_x121 = exp(2.0);
        const double var_x122 = 1.0 + var_x121 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x123 = -var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x124 = var_x121 * var_x123;
        const double var_x125 = var_x124 / pow(var_x122, 3);
        const double var_x126 = 1 / var_x122;
        const double var_x127 = 1.0 - var_x126;
        const double var_x128 = var_x124 * var_x127 / pow(var_x122, 2);
        const double var_x129 = 0.80000000000000004 + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x130 = pow(var_x129, (-2));
        const double var_x131 = 1 / (1.0 + 8.0 * var_x130);
        const double var_x132 = var_x131;
        const double var_x133 = var_x126 * var_x127;
        const double var_x134 = var_x120 * var_x133;
        const double var_x135 = pow(var_x73, (-2));
        const double var_x136 = var_x135 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x137 = var_x53 * var_x76;
        const double var_x138 = var_x82 * var_x85;
        const double var_x139 = var_x87 * var_x89;
        const double var_x140 = var_x109 * var_x139;
        const double var_x141 = -var_x140 + (0.5 + 374358.83507802623 * var_chaste_interface__cell__V) * (var_x140 + var_x109 * var_x138);
        const double var_x142 = var_x20 * var_x24;
        const double var_x143 = ((var_x1) ? (var_x141) : (var_x142));
        const double var_x144 = var_x44 * mParameters[15];
        const double var_x145 = var_x144 * var_x36;
        const double var_x146 = var_x16 / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x147 = var_x115 * var_x146;
        const double var_x148 = var_x41 * pow(var_x42, 2) / pow(var_x43, 2);
        const double var_x149 = var_x148 * var_x36;
        const double var_x150 = var_x117 * var_x123 * var_x133 / pow(var_x118, 2);
        const double var_x151 = var_x150 * (var_x113 + 0.044758007519879316 * var_x53 + 2.2222222222222223 * var_x145 + 0.74200940848606289 * var_x137 + 0.00022222222222222223 * var_x149 - 1.2777777777777777 * var_x136 - 0.00066666666666666664 * var_x147 + var_x116 * var_x143);
        const double var_x152 = var_x39 * var_x46;
        const double var_x153 = var_x144 * var_x152;
        const double var_x154 = var_x148 * var_x152;
        const double var_x155 = var_x150 * (0.00066666666666666664 * var_x154 - 6.6666666666666661 * var_x153);
        const double var_x156 = mParameters[3] * mParameters[0];
        const double var_x157 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x158 = mParameters[3] / var_x157;
        const double var_x159 = var_chaste_interface__calcium_dynamics__Cai * mParameters[3] / pow(var_x157, 2);
        const double var_x160 = 1.0588235294117645 * var_x119;
        const double var_x161 = 0.0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x162 = 1.0 + 0.00011900000000000002 / pow(var_x161, 2) + 3.5000000000000004e-5 * var_x135;
        const double var_x163 = 1 / var_x162;
        const double var_x164 = var_x163;
        const double var_x165 = var_x133 * var_x160;
        const double var_x166 = 0.0054117647058823529 * var_x156;
        const double var_x167 = 0.081176470588235281 * var_x158;
        const double var_x168 = var_x75 + 2.0 * var_x145 + 0.00020000000000000001 * var_x149 + 0.040282206767891383 * var_x53 + 0.6678084676374566 * var_x137 - 1.1499999999999999 * var_x136;
        const double var_x169 = 1 / M_PI;
        const double var_x170 = 9.6614270660886194e-5 * var_x169;
        const double var_x171 = -var_x170 * (0.00060000000000000006 * var_x154 - 6.0 * var_x153);
        const double var_x172 = 0.00059999999999999995 * var_x146;
        const double var_x173 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
        const double var_x174 = var_chaste_interface__calcium_dynamics__APtrack2 > 0.01;
        const double var_x175 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        const double var_x176 = 0.5 + 187179.41753901311 * var_chaste_interface__cell__V;
        const double var_x177 = 5.1839999999999986e-9 / (pow(var_x3, 2) * pow(var_chaste_interface__calcium_dynamics__Cai, 4));
        const double var_x178 = 0.00019322854132177239 * var_x169 * mParameters[4];
        const double var_x179 = 1.2663656249999999e-9 * var_x139;
        const double var_x180 = var_x7 * var_x9;
        const double var_x181 = var_x94 * ((var_x2) ? (-var_x179 + var_x81 * (var_x179 + 1.2663656249999999e-9 * var_x138)) : (0.0004740751601578565 * var_x180));
        const double var_x182 = 1.396620375e-9 * var_x139;
        const double var_x183 = var_x29 * var_x57;
        const double var_x184 = var_x51 * var_x56;
        const double var_x185 = var_x29 * var_x60 / pow(var_x61, 2);
        const double var_x186 = var_x58 * mParameters[12];
        const double var_x187 = var_x48 / (var_x38 * pow((0.01 + var_x47), 2));
        const double var_x188 = 4.8845531249999998e-9 * var_x139;
        
        
        rJacobian[0][0] = 1.0 - (mDt * ((((((var_x1) || (var_x0 >= 2.6712338705498262e-6) || (var_x108 + var_x80 < -150.0))) && (((var_x0 >= 1.3356169352749131e-6) || (var_x108 + var_x79 - var_x104 * (var_x110 - var_x111) < -150.0))) && (((var_x1) || (var_x2) || (var_x80 + var_x11 * var_x4 + var_x14 * var_x4 + var_x15 * var_x17 + var_x17 * var_x18 < -150.0)))) ? (-100.5) : (-0.5))));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = 0.0;
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = 0.0;
        ...
        rJacobian[2][11] = 0.0;
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = -(mDt * (var_x132 * (var_x120 * var_x128 - var_x120 * var_x125)));
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (var_x132 * (-0.0055555555555555558 - var_x134) + 0.25 * (0.0055555555555555558 * var_chaste_interface__calcium_dynamics__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__calcium_dynamics__Ca_JSR - var_x123 * var_x134) / (pow(var_x129, 3) * pow((0.125 + var_x130), 2))));
        rJacobian[3][4] = -(mDt * (0.0055555555555555558 * var_x131));
        rJacobian[3][5] = -(mDt * (var_x132 * (var_x134 + 150.0 * var_x151)));
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = 0.0;
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = -(mDt * (150.0 * var_x131 * var_x155));
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = -(mDt * (0.00048309178743961351));
        rJacobian[4][4] = 1.0 - (mDt * (-0.00048309178743961351 - 0.066666666666666666 * var_x156));
        rJacobian[4][5] = -(mDt * (var_x158 - var_x159));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        ...
        rJacobian[4][11] = 0.0;
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = -(mDt * (var_x164 * (var_x125 * var_x160 - var_x128 * var_x160)));
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (var_x163 * var_x165));
        rJacobian[5][4] = -(mDt * (var_x163 * var_x166));
        rJacobian[5][5] = 1.0 - (mDt * (var_x164 * (-var_x165 - var_x167 + 0.081176470588235281 * var_x159 - 1.0588235294117645 * var_x151 - var_x170 * (var_x168 - 0.00059999999999999995 * var_x147 + var_x104 * var_x143)) + (0.00023800000000000004 / pow(var_x161, 3) + 7.0000000000000007e-5 / pow(var_x73, 3)) * (var_x123 * var_x165 + var_x166 * var_chaste_interface__calcium_dynamics__Ca_NSR - var_x167 * var_chaste_interface__calcium_dynamics__Cai - var_x170 * (var_x78 + 0.003016 * var_chaste_interface__cell__V - 2.0 * var_x45 + var_x104 * var_x115)) / pow(var_x162, 2)));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = -(mDt * (var_x164 * (var_x171 - 1.0588235294117645 * var_x155)));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * ((((var_x1) && (var_x173)) ? (-var_x170 * (var_x168 + var_x104 * var_x141 - var_x114 * var_x172)) : ((var_x173) ? (-var_x170 * (var_x168 + var_x142 * var_x17 - 8.6688029286008046 * var_x146 * var_x22 * var_x23 * mParameters[8] * var_chaste_interface__cell__V)) : (0)))));
        rJacobian[6][6] = 1.0 - (mDt * ((((((var_x173) || (var_x174))) && (((var_x1) || (var_x173) || (var_x174)))) ? (0) : (-0.5))));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = -(mDt * ((((var_x173) && (((var_x1) || (var_x173)))) ? (var_x171) : (0))));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        ...
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * ((((var_x175) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50.0) : (-0.5))));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[9][0] = 0.0;
        ...
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        rJacobian[9][9] = 1.0 - (mDt * ((((var_x175) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50.0) : (-0.01))));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = 0.0;
        rJacobian[10][0] = 0.0;
        rJacobian[10][1] = 0.0;
        ...
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = -(mDt * (-var_x178 * (var_x177 * ((var_x2) ? (var_x93 + var_x176 * var_x92) : (var_x11)) - var_x172 * ((var_x2) ? (var_x107 + var_x106 * var_x176) : (var_x18)) + 5.4447296618926212e-7 * var_x52 * var_x53 * var_x54 * mParameters[14] * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2 / pow(var_x55, 2))));
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-var_x178 * (var_x181 + 26.712338705498265 * var_x184 + var_x104 * ((var_x2) ? (-var_x182 + var_x81 * (var_x182 + 1.396620375e-9 * var_x138)) : (0.00052283717663123607 * var_x180)) + 2.9172010853500545 * var_x29 * var_x35 + 11.72506353372661 * var_x183 * var_x71 + 11.495160327182951 * var_x183 * var_x59 + 5.1338399412861326e-7 * var_x29 * var_x32 + 0.14745210965435041 * var_x28 * var_x29 + 26.712338705498265 * var_x29 * var_x50 - 2.7964276527937963 * var_x185 * var_x186 * var_x70 + 0.42189361069797565 * var_x186 * var_x62 * (6.4983106368865622 * var_x185 - var_x65 * (1.053972635420138 * var_x29 * var_x66 + 1.6494869150645177 * var_x29 * var_x67) - 13.738155796237757 * var_x29 * var_x63 * var_x68 / pow(var_x64, 2)) / pow((var_x62 + 0.98039215686274506 * var_x69), 2))));
        rJacobian[10][11] = -(mDt * (-var_x178 * (0.48963716847178318 * var_x184 - 0.089999999999999997 * var_x187 + 2.4586089909663641e-6 * var_x26 * var_x31 * var_x33 * var_x34 / pow((8.0403875140176932e-6 + var_x33), 2))));
        rJacobian[11][0] = 0.0;
        rJacobian[11][1] = 0.0;
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = -(mDt * (-var_x178 * (-3.0 * var_x145 - 0.00030000000000000003 * var_x149 + var_x177 * ((var_x2) ? (var_x100 + var_x176 * var_x99) : (var_x14)) - var_x172 * ((var_x2) ? (var_x103 + var_x102 * var_x176) : (var_x15)))));
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (-var_x178 * (var_x181 + 9.0 * var_x153 + 0.10684935482199306 * var_x26 + 0.13500000000000001 * var_x187 - 0.00090000000000000008 * var_x154 + var_x104 * ((var_x2) ? (-var_x188 + var_x81 * (var_x188 + 4.8845531249999998e-9 * var_x138)) : (0.0018285756177517324 * var_x180)) + 26.712338705498265 * var_x26 * var_x49)));
    }
