...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut::Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut::~Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut()
    {
    }

    
    double Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rResidual[12])
    {
    ...
    void Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: mV; Initial value: -90.7796417483135
        ...
        const double var_x4 = var_x2 * var_x3 * mParameters[0];
        ...
        const double var_x15 = var_x0 * var_chaste_interface__Irel__APtrack2 * mParameters[0];
        ...
        const double var_x26 = mParameters[6] / (mParameters[7] * mParameters[17]);
        const double var_x27 = var_x26 * var_chaste_interface__cell__V;
        const double var_x28 = exp(-0.65000000000000002 * var_x27);
        const double var_x29 = pow(mParameters[5], 3);
        const double var_x30 = var_x28 * var_x29;
        const double var_x31 = mParameters[15] / ((1.0 + 0.10000000000000001 * var_x28) * (669921.875 + var_x29) * (1.3799999999999999 + mParameters[3]));
        const double var_x32 = var_x30 * var_x31;
        const double var_x33 = 1 / var_chaste_interface__Ionic_concentrations__Cai;
        const double var_x34 = 1 / mParameters[6];
        const double var_x35 = var_x34 * mParameters[7] * mParameters[17];
        const double var_x36 = 0.00042499999999999998 * var_x35;
        const double var_x37 = 0.00059999999999999995 + var_chaste_interface__Ionic_concentrations__Cai;
        const double var_x38 = log(var_x33 * mParameters[3]);
        const double var_x39 = 0.5 * var_x35;
        const double var_x40 = mParameters[8] * var_chaste_interface__ICa_d_gate__d * var_chaste_interface__ICa_f_gate__f;
        const double var_x41 = 0.00059999999999999995 * var_x40 * (-var_x38 * var_x39 + var_chaste_interface__cell__V);
        const double var_x42 = 1 / var_x37;
        const double var_x43 = var_x33 * var_x36 - var_x41 / pow(var_x37, 2) + 0.00029999999999999997 * var_x33 * var_x35 * var_x40 * var_x42;
        const double var_x44 = var_x34 * mParameters[1] / M_PI;
        const double var_x45 = 6.076810889645114e-5 * var_x44;
        const double var_x46 = var_x23;
        const double var_x47 = mParameters[3] * exp(0.34999999999999998 * var_x27);
        const double var_x48 = var_x31 * (var_x47 * pow(var_chaste_interface__Ionic_concentrations__Nai, 3) - var_x30 * var_chaste_interface__Ionic_concentrations__Cai);
        const double var_x49 = var_x41 * var_x42 - var_x36 * var_x38;
        const double var_x50 = var_x31 * var_x47 * pow(var_chaste_interface__Ionic_concentrations__Nai, 2);
        const double var_x51 = var_x44 * var_x50;
        const double var_x52 = var_x46 * (0.0070588235294117632 * var_chaste_interface__Ionic_concentrations__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__Ionic_concentrations__Cai);
        const double var_x53 = 1 / var_chaste_interface__Ionic_concentrations__Ki;
        const double var_x54 = var_x35 * log(var_x53 * mParameters[4]);
        const double var_x55 = -var_x54 + var_chaste_interface__cell__V;
        const double var_x56 = exp(-12.0 + 0.059999999999999998 * var_chaste_interface__cell__V - 0.059999999999999998 * var_x54);
        const double var_x57 = 1.0 + var_x56;
        const double var_x58 = 1 / var_x57;
        const double var_x59 = exp(0.5 * var_x54 - 0.5 * var_chaste_interface__cell__V);
        const double var_x60 = 1.0 + var_x59;
        const double var_x61 = 1 / var_x60;
        const double var_x62 = 0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x63 = exp(-1.0 + var_x62 - 0.10000000000000001 * var_x54);
        const double var_x64 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__cell__V - 0.00020000000000000001 * var_x54);
        const double var_x65 = var_x63 + 3.0 * var_x64;
        const double var_x66 = 0.10000000000000001 * var_x58 + var_x61 * var_x65;
        const double var_x67 = var_x35 * var_x53;
        const double var_x68 = var_x56 * var_x67 / pow(var_x57, 2);
        const double var_x69 = 0.25 * var_x58;
        const double var_x70 = var_x69 * mParameters[12];
        const double var_x71 = pow(var_chaste_interface__IKs_Xs_gate__Xs, 2) * mParameters[14];
        const double var_x72 = var_x71;
        const double var_x73 = var_chaste_interface__Ionic_concentrations__Ki;
        const double var_x74 = 1 / (var_x73 + 0.018329999999999999 * var_chaste_interface__Ionic_concentrations__Nai);
        const double var_x75 = var_x35 * var_x74;
        const double var_x76 = mParameters[13] * var_chaste_interface__IKr_Xr_gate__Xr / (1.0 + exp(1.1304347826086956 + 0.043478260869565216 * var_chaste_interface__cell__V));
        const double var_x77 = mParameters[16] * var_chaste_interface__Ito_r_gate__r * var_chaste_interface__Ito_t_gate__t;
        const double var_x78 = 0.29999999999999999 * var_x77;
        const double var_x79 = 1 / (var_x73 + 0.042999999999999997 * var_chaste_interface__Ionic_concentrations__Nai);
        const double var_x80 = var_x35 * var_x79;
        const double var_x81 = 1 / var_x66;
        const double var_x82 = var_x55 * var_x81 * mParameters[12];
        const double var_x83 = var_x44 * mParameters[2];
        const double var_x84 = 0.00012153621779290228 * var_x83;
        const double var_x85 = 1 / var_chaste_interface__Ionic_concentrations__Nai;
        const double var_x86 = pow(var_x85, 1.5);
        const double var_x87 = mParameters[4] / ((1.5 + mParameters[4]) * (1.0 + 0.1245 * exp(-var_x26 * var_x62) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[5])) * exp(-var_x27)));
        const double var_x88 = var_x85 * var_x86 * var_x87 / pow((0.031622776601683791 + var_x86), 2);
        const double var_x89 = var_x35 * var_x85;
        const double var_x90 = pow(var_chaste_interface__INa_m_gate__m, 3) * mParameters[9] * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j;
        const double var_x91 = mParameters[4];
        const double var_x92 = var_x35 * log(var_x85 * mParameters[5]);
        const double var_x93 = (var_chaste_interface__Irel__APtrack > 0.17999999999999999) && (var_chaste_interface__Irel__APtrack < 0.20000000000000001);
        const double var_x94 = var_chaste_interface__Irel__APtrack > 0.20000000000000001;
        ...
        rJacobian[2][2] = 1.0 - (mDt * (var_x46 * (-var_x24 - var_x25 + 0.00036529411764705876 * var_x19 - var_x45 * (var_x43 + 2.0 * var_x32)) + (0.00023800000000000004 / pow(var_x20, 3) + 7.0000000000000007e-5 / pow(var_x21, 3)) * (0.0070588235294117632 * var_x12 + 2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR - var_x25 * var_chaste_interface__Ionic_concentrations__Cai - var_x45 * (var_x49 + 0.00084999999999999995 * var_chaste_interface__cell__V - 2.0 * var_x48)) / pow(var_x22, 2)));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = -(mDt * (0.00036460865337870681 * var_x23 * var_x51));
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = -(mDt * (var_x13 * var_x52));
        rJacobian[2][7] = 0.0;
        rJacobian[2][8] = -(mDt * (var_x16 * var_x52));
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = 0.0;
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (-var_x84 * (var_x67 * var_x76 + var_x72 * var_x75 + var_x78 * var_x80 - 0.014999999999999999 * var_x68 * var_x82 + var_x67 * var_x70 * var_x81 + var_x55 * var_x70 * (0.0060000000000000001 * var_x68 - var_x61 * (0.10000000000000001 * var_x63 * var_x67 + 0.00060000000000000006 * var_x64 * var_x67) - var_x39 * var_x53 * var_x59 * var_x65 / pow(var_x60, 2)) / pow(var_x66, 2))));
        rJacobian[3][4] = -(mDt * (-var_x84 * (-0.1233288287465668 * var_x88 + 0.018329999999999999 * var_x71 * var_x75 + 0.012899999999999998 * var_x77 * var_x80)));
        rJacobian[3][5] = 0.0;
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = 0.0;
        ...
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = -(mDt * (0.00036460865337870681 * var_x32 * var_x83));
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-var_x84 * (9.0 * var_x50 + 0.001 * var_x89 + 0.18499324311985019 * var_x88 + var_x89 * var_x90)));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        ...
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (((var_x49 + var_x48 + 0.0018500000000000001 * var_chaste_interface__cell__V - 0.001 * var_x92 + var_x55 * var_x76 + var_x69 * var_x82 + var_x72 * (-var_x35 * log(var_x74 * (var_x91 + 0.018329999999999999 * mParameters[5])) + var_chaste_interface__cell__V) + var_x78 * (-var_x35 * log(var_x79 * (var_x91 + 0.042999999999999997 * mParameters[5])) + var_chaste_interface__cell__V) + var_x90 * (-var_x92 + var_chaste_interface__cell__V) + GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() + 1.3 * var_x87 / (1.0 + 31.622776601683793 * var_x86) < -150.0) ? (-100.5) : (-0.5))));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (((var_x93) ? (-100.5) : (-0.5))));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (((var_x93) ? (-100.5) : (-0.01))));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[8][0] = 0.0;
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = -(mDt * (((var_x94) ? (-var_x45 * (var_x43 + var_x32)) : (0))));
        rJacobian[8][3] = 0.0;
        rJacobian[8][4] = -(mDt * (((var_x94) ? (0.00018230432668935341 * var_x51) : (0))));
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * ((((var_x94) || (var_chaste_interface__Irel__APtrack2 > 0.01)) ? (0) : (-0.5))));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[9][0] = 0.0;
    ...
    void Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        CardiacNewtonSolver<12,Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<12,Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpriebe_beuckelmann_1998FromCellMLBackwardEulerNoLut)
