...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellohara_rudy_2011_endoFromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x202 = 0.59999999999999998 / (1.0 + exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__v));
        ...
        const double var_x336 = 1 / (1.0 + exp(-1.4126984126984128 + 0.0066137566137566143 * var_chaste_interface__membrane__v));
        ...
        const double var_x440 = 1 / (1.0 + exp(1.4344412457471867 + 0.026171159382360639 * var_chaste_interface__membrane__v));
        ...
        const double var_x504 = pow(var_chaste_interface__intracellular_ions__cajsr, (-8));
        const double var_x505 = 1 / (1.0 + 25.62890625 * var_x504);
        const double var_x506 = var_x505 * (var_x215 - var_x211);
        const double var_x507 = 1 / var_chaste_interface__intracellular_ions__cajsr;
        const double var_x508 = 1 / (1.0 + 0.0123 * var_x507);
        const double var_x509 = 4.75 * var_x508 < 0.001;
        const double var_x510 = ((var_x509) ? (1000.0) : (0.21052631578947367 + 0.0025894736842105265 * var_x507));
        const double var_x511 = 2.375 * var_x510;
        const double var_x512 = var_x226 + var_x229;
        const double var_x513 = var_x505 * var_x511;
        const double var_x514 = var_x297 + var_x298;
        const double var_x515 = var_x505 * var_x514;
        const double var_x516 = pow(var_chaste_interface__intracellular_ions__cajsr, (-2));
        const double var_x517 = var_x514 / (pow((0.039018442310623382 + var_x504), 2) * pow(var_chaste_interface__intracellular_ions__cajsr, 9));
        const double var_x518 = var_x291 + var_x293 + var_x296 - var_x295;
        const double var_x519 = 5.9375 * var_x508 < 0.001;
        const double var_x520 = ((var_x519) ? (1000.0) : (0.16842105263157894 + 0.0020715789473684213 * var_x507));
        const double var_x521 = 2.96875 * var_x520;
        const double var_x522 = var_x505 * var_x521;
        ...
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = 0.0;
        rJacobian[10][0] = -(mDt * (-var_x506 * var_x511));
        rJacobian[10][1] = -(mDt * (-var_x512 * var_x513));
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = -(mDt * ((-var_chaste_interface__ryr__Jrelnp - 2.375 * var_x515) * ((var_x509) ? (0) : (-0.0025894736842105265 * var_x516)) - 0.74135040390184426 * var_x510 * var_x517));
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = -(mDt * (-var_x513 * var_x518));
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-var_x510));
        rJacobian[10][11] = 0.0;
        rJacobian[11][0] = -(mDt * (-var_x506 * var_x521));
        rJacobian[11][1] = -(mDt * (-var_x512 * var_x522));
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = -(mDt * ((-var_chaste_interface__ryr__Jrelp - 2.96875 * var_x515) * ((var_x519) ? (0) : (-0.0020715789473684213 * var_x516)) - 0.92668800487730529 * var_x517 * var_x520));
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = -(mDt * (-var_x518 * var_x522));
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (-var_x520));
    }
