...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellclancy_rudy_2002FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[26], double rJacobian[26][26])
    {
        ...
        const double var_x47 = exp(-0.031820500981632228 * var_chaste_interface__membrane__V);
        ...
        const double var_x61 = exp(0.074871767015605231 * var_chaste_interface__membrane__V);
        ...
        const double var_x68 = 0.00062 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x69 = 1 / var_x68;
        const double var_x70 = -0.00018000000000000001 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x71 = var_x69 * var_x70 * mParameters[0];
        const double var_x72 = var_x67 * var_x71;
        const double var_x73 = var_chaste_interface__calcium_dynamics__Cainfluxtrack > 0.00018000000000000001;
        const double var_x74 = ((var_x73) ? (var_x72 - var_x71 * var_chaste_interface__calcium_dynamics__APtrack2) : (0));
        const double var_x75 = 0.80000000000000004 + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x76 = pow(var_x75, (-2));
        const double var_x77 = 1 / (1.0 + 8.0 * var_x76);
        const double var_x78 = 0.001 * var_x77;
        const double var_x79 = var_x78 * (-var_chaste_interface__calcium_dynamics__Ca_JSR + var_chaste_interface__calcium_dynamics__Cai);
        const double var_x80 = var_chaste_interface__calcium_dynamics__OVRLDtrack2 > 0;
        const double var_x81 = ((var_x73) ? (var_x72 * var_chaste_interface__calcium_dynamics__APtrack2) : ((var_x80) ? (4000.0 * (1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x82 = var_x81 * (-var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR);
        const double var_x83 = var_x67 * var_chaste_interface__calcium_dynamics__APtrack2 * mParameters[0];
        const double var_x84 = ((var_x73) ? (var_x69 * var_x83 - var_x70 * var_x83 / pow(var_x68, 2)) : (0));
        const double var_x85 = ((var_x73) ? (0) : ((var_x80) ? (4000.0 - 8000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x86 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x87 = 1 / var_x86;
        const double var_x88 = var_chaste_interface__calcium_dynamics__Cai / pow(var_x86, 2);
        const double var_x89 = 0.0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x90 = pow(var_x58, (-2));
        const double var_x91 = 1.0 + 0.00011900000000000002 / pow(var_x89, 2) + 3.5000000000000004e-5 * var_x90;
        const double var_x92 = 1 / var_x91;
        const double var_x93 = 0.001 * var_x92;
        const double var_x94 = var_x93 * (0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x95 = 0.71029411764705874 * var_x87;
        const double var_x96 = var_x49 * mParameters[10];
        const double var_x97 = var_x40 * var_x96;
        const double var_x98 = var_x46 * pow(var_x47, 2) / pow(var_x48, 2);
        const double var_x99 = var_x40 * var_x98;
        const double var_x100 = var_x59 + 0.040282206767891383 * var_x52 + 0.6678084676374566 * var_x52 * var_x60 - 1.1499999999999999 * var_x90 * var_chaste_interface__calcium_dynamics__Cai + var_x61 * var_x62 * var_x64 - 0.0046811535814444347 * var_x63 * mParameters[4] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x101 = 1 / M_PI;
        const double var_x102 = 0.090316078310111333 * var_x101;
        const double var_x103 = var_x44 * var_x51;
        const double var_x104 = var_x103 * var_x96;
        const double var_x105 = var_x103 * var_x98;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (0.001 * (((var_x50 + var_x65 + 0.0070159999999999997 * var_chaste_interface__membrane__V - 0.10684935482199306 * var_x37 + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 0.0055199999999999997 * var_x39 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 0.0024381008236689767 * var_x56 * (-0.75 * mParameters[3] + var_x54 * var_chaste_interface__ionic_concentrations__Nai) + 0.00069711623550831479 * var_x56 * (-0.75 * mParameters[2] + var_x54 * var_chaste_interface__ionic_concentrations__Ki) + 1.921898339896919e-8 * var_x39 * pow(mParameters[2], 0.23999999999999999) + (-26.712338705498265 * var_x37 + var_chaste_interface__membrane__V) * var_chaste_interface__Na_channel_states__P_O_Na * mParameters[6] + var_x39 * pow(mParameters[2], 0.58999999999999997) * var_chaste_interface__Kr_channel_states__P_O * mParameters[8] + 2.25 * mParameters[2] / ((1.0 + 100.0 / var_x51) * (1.5 + mParameters[2]) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[3])) * exp(-var_x42))) + 1.1000000000000001 * var_x39 * pow(var_chaste_interface__transient_outward_current_zdv_gate__zdv, 3) * mParameters[11] * var_chaste_interface__transient_outward_current_ydv_gate__ydv * exp(0.01 * var_chaste_interface__membrane__V) + 0.433 * (1.0 + 0.59999999999999998 / (1.0 + 6.4818210260626455e-7 * pow(var_x52, 1.3999999999999999))) * (-26.712338705498265 * log((0.018329999999999999 * mParameters[3] + mParameters[2]) / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki)) + var_chaste_interface__membrane__V) * mParameters[9] * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2 + 438.93811257017387 * var_x39 * var_x53 * sqrt(mParameters[2]) * mParameters[7] / (1020.0 * var_x53 + 1000.0 * (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * var_x38) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * var_x38)) / (1.0 + exp(-2.4444678999999998 + 13.738155796237757 * var_x38 - 0.51429999999999998 * var_chaste_interface__membrane__V)))) / mParameters[5] < -150000.0) ? (-100500.0) : (-500.0))));
        rJacobian[14][15] = 0.0;
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        ...
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (0.001 * ((var_x66) ? (-100500.0) : (-500.0))));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (0.001 * ((var_x66) ? (-100500.0) : (-10.0))));
        rJacobian[16][17] = 0.0;
        rJacobian[16][18] = 0.0;
        rJacobian[16][19] = 0.0;
        rJacobian[16][20] = 0.0;
        ...
        rJacobian[17][13] = 0.0;
        rJacobian[17][14] = 0.0;
        rJacobian[17][15] = -(mDt * (var_x74 * var_x79));
        rJacobian[17][16] = 0.0;
        rJacobian[17][17] = 1.0 - (mDt * (var_x78 * (-5.5555555555555554 - var_x81) + 0.00025000000000000001 * (-var_x82 + 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR) / (pow(var_x75, 3) * pow((0.125 + var_x76), 2))));
        rJacobian[17][18] = -(mDt * (0.0055555555555555558 * var_x77));
        rJacobian[17][19] = -(mDt * (var_x78 * var_x81));
        rJacobian[17][20] = -(mDt * (var_x79 * var_x84));
        rJacobian[17][21] = 0.0;
        rJacobian[17][22] = -(mDt * (var_x79 * var_x85));
        rJacobian[17][23] = 0.0;
        rJacobian[17][24] = 0.0;
        rJacobian[17][25] = 0.0;
        rJacobian[18][0] = 0.0;
        ...
        rJacobian[18][19] = -(mDt * (0.0087500000000000008 * var_x87 - 0.0087500000000000008 * var_x88));
        rJacobian[18][20] = 0.0;
        rJacobian[18][21] = 0.0;
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        ...
        rJacobian[19][13] = 0.0;
        rJacobian[19][14] = 0.0;
        rJacobian[19][15] = -(mDt * (var_x74 * var_x94));
        rJacobian[19][16] = 0.0;
        rJacobian[19][17] = -(mDt * (7.0588235294117632e-6 * var_x81 * var_x92));
        rJacobian[19][18] = -(mDt * (4.7352941176470584e-5 * var_x92));
        rJacobian[19][19] = 1.0 - (mDt * (var_x93 * (-var_x95 + 0.71029411764705874 * var_x88 - 0.0070588235294117632 * var_x81 - var_x102 * (var_x100 + 2.0 * var_x97 + 0.00020000000000000001 * var_x99)) + 0.001 * (0.00023800000000000004 / pow(var_x89, 3) + 7.0000000000000007e-5 / pow(var_x58, 3)) * (0.047352941176470584 * var_chaste_interface__calcium_dynamics__Ca_NSR + 0.0070588235294117632 * var_x82 - var_x102 * (var_x65 + 0.003016 * var_chaste_interface__membrane__V - 2.0 * var_x50) - var_x95 * var_chaste_interface__calcium_dynamics__Cai) / pow(var_x91, 2)));
        rJacobian[19][20] = -(mDt * (var_x84 * var_x94));
        rJacobian[19][21] = 0.0;
        rJacobian[19][22] = -(mDt * (var_x85 * var_x94));
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = -(mDt * (-9.0316078310111333e-5 * var_x101 * var_x92 * (0.00060000000000000006 * var_x105 - 6.0 * var_x104)));
        rJacobian[20][0] = 0.0;
        rJacobian[20][1] = 0.0;
        rJacobian[20][2] = 0.0;
        rJacobian[20][3] = 0.0;
        ...
        rJacobian[20][17] = 0.0;
        rJacobian[20][18] = 0.0;
        rJacobian[20][19] = -(mDt * (0.001 * ((var_x106) ? (-var_x102 * (var_x100 + var_x97 + 0.0001 * var_x99)) : (0))));
        rJacobian[20][20] = 1.0 - (mDt * (0.001 * (((var_x106) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-500.0))));
        rJacobian[20][21] = 0.0;
        rJacobian[20][22] = 0.0;
        rJacobian[20][23] = 0.0;
        rJacobian[20][24] = 0.0;
        rJacobian[20][25] = -(mDt * (0.001 * ((var_x106) ? (-var_x102 * (-3 * var_x104 + 0.00030000000000000003 * var_x105)) : (0))));
        rJacobian[21][0] = 0.0;
        rJacobian[21][1] = 0.0;
        rJacobian[21][2] = 0.0;
        rJacobian[21][3] = 0.0;
        ...
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (0.001 * (((var_x107) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50000.0) : (-500.0))));
        rJacobian[22][23] = 0.0;
        rJacobian[22][24] = 0.0;
        rJacobian[22][25] = 0.0;
        rJacobian[23][0] = 0.0;
        ...
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = 0.0;
        rJacobian[23][23] = 1.0 - (mDt * (0.001 * (((var_x107) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50000.0) : (-10.0))));
        rJacobian[23][24] = 0.0;
        rJacobian[23][25] = 0.0;
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = 0.0;
