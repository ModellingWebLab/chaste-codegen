...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut::Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut::~Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut()
    {
    }

    
    
    void Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut::VerifyStateVariables()
    {
    ...
    double Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[13], double rResidual[13])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -80.50146
    ...
    void Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -80.50146
        ...
        const double var_x68 = var_x66 * var_x67 * mParameters[4] / ((1.5 + mParameters[4]) * pow((0.031622776601683791 + var_x67), 2) * (1.0 + 0.1245 * exp(-0.0039337852699643568 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[5])) * exp(-0.039337852699643565 * var_chaste_interface__membrane__V)));
    ...
    void Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__environment__time_converted)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        const double var_Ca_independent_transient_outward_K_current_s_gate__tau_s_endo = 0.049000000000000002 + 0.55000000000000004 * exp(-7.8399999999999999 * pow((1 + 0.014285714285714285 * var_chaste_interface__membrane__V), 2));
        ...
        const double var_Ca_independent_transient_outward_K_current_s_slow_gate__tau_s_slow_endo = 0.049000000000000002 + 3.2999999999999998 * exp(-5.4444444444444446 * pow((1 + 0.014285714285714285 * var_chaste_interface__membrane__V), 2));
        ...
        CardiacNewtonSolver<13,Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<13,Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLBackwardEulerNoLut>::Initialise(void)
{
