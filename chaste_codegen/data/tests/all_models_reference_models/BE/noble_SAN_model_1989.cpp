...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnoble_SAN_model_1989FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        ...
        const double var_x0 = 0050000000000000001 * var_chaste_interface__intracellular_calcium_concentration__p;
        ...
        const double var_x8 = 002 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x9 = 0040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        ...
        const double var_x12 = 018716945411372737 * var_chaste_interface__membrane__V;
        const double var_x13 = exp(var_x12);
        const double var_x14 = exp(-var_x12);
        const double var_x15 = 2.0 * var_x11 * var_x13 - 2744000 * var_x14 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        const double var_x16 = var_x10 * var_x15 / pow((0036443148688046646 + 7.2886297376093296e-7 * var_x11 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x17 = 1 / (1.0 + 00020000000000000001 * var_x11 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Cai);
        const double var_x18 = var_x15 * var_x17 / pow((0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x19 = var_x10 * var_x17;
        const double var_x20 = var_x14 * var_x19;
        const double var_x21 = exp(3.7433890822745473);
        const double var_x22 = 074867781645490947 * var_chaste_interface__membrane__V;
        const double var_x23 = exp(3.7433890822745473 - var_x22);
        const double var_x24 = (-50 + var_chaste_interface__membrane__V) * var_chaste_interface__second_inward_current_d_gate__d * var_chaste_interface__second_inward_current_f_gate__f;
        ...
        const double var_x30 = 00013114584825700806 * pow(var_chaste_interface__hyperpolarising_activated_current_y_gate__y, 2);
        ...
        const double var_x35 = exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane__V);
        ...
        const double var_x38 = 1 / (40 + var_chaste_interface__intracellular_sodium_concentration__Nai);
        const double var_x39 = var_chaste_interface__intracellular_sodium_concentration__Nai / pow((1 + 025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Nai), 2);
        const double var_x40 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (0008549444286121402 * var_chaste_interface__intracellular_potassium_concentration__Ki + 0071245369051011684 * var_chaste_interface__intracellular_sodium_concentration__Nai) * var_chaste_interface__fast_sodium_current_h_gate__h / pow((1.0 * var_chaste_interface__intracellular_sodium_concentration__Nai + 0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki), 2);
        ...
        rJacobian[1][4] = 0;
        rJacobian[1][5] = 0;
        rJacobian[2][0] = -(mDt * (002 * var_x4));
        rJacobian[2][1] = -(mDt * (040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Cai));
        rJacobian[2][2] = 1.0 - (mDt * (-0.20000000000000001 + 040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 9.5418840923404938e-11 * var_x16 - 1.8066221665073799e-10 * var_x18 - 8.7430565504672044e-7 / var_chaste_interface__intracellular_calcium_concentration__Cai - 071845959781105084 * var_x20 + var_x7 * var_x9 - var_x6 * var_x9 - var_x21 * var_x25 * var_chaste_interface__second_inward_current_f2_gate__f2));
        rJacobian[2][3] = 0;
        ...
        rJacobian[3][4] = -(mDt * (00088367388579165321 * var_x38 - 5.5229617861978321e-7 * var_x39));
        ...
        rJacobian[4][3] = -(mDt * (-0073630525045414608 * var_x40));
        rJacobian[4][4] = 1.0 - (mDt * (var_x37 + 6.2592534133428895e-16 * var_x28 + 8.2844426792967482e-7 * var_x39 - 061358770871178837 * var_x40 - 0013255108286874798 * var_x38 - 2.4480558341308171e-5 * var_x41 - 4.7129273908888172e-7 * var_x27 - var_x30 * var_x41));
        rJacobian[4][5] = -(mDt * (-var_x36 * (-140 * var_x35 + var_x34 * var_chaste_interface__intracellular_sodium_concentration__Nai)));
        rJacobian[5][0] = 0;
        rJacobian[5][1] = 0;
        rJacobian[5][2] = -(mDt * (-20 * var_chaste_interface__second_inward_current_f2_gate__f2));
        rJacobian[5][3] = 0;
        rJacobian[5][4] = 0;
        rJacobian[5][5] = 1.0 - (mDt * (-01 - 20 * var_chaste_interface__intracellular_calcium_concentration__Cai));
    }
    ...
    void Cellnoble_SAN_model_1989FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = 20 * exp(-9.375 - 0.125 * var_chaste_interface__membrane__V);
        const double var_fast_sodium_current_h_gate__beta_h = 2000 / (1.0 + 320 * exp(-7.5 - 0.10000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_hyperpolarising_activated_current_y_gate__alpha_y = 014 * exp(-0625 * var_chaste_interface__membrane__V);
        const double var_hyperpolarising_activated_current_y_gate__beta_y = 9.75 * exp(052631578947368418 * var_chaste_interface__membrane__V);
        ...
        const double var_second_inward_current_d_gate__delta_d = 0001;
        const double var_second_inward_current_d_gate__alpha_d = ((var_second_inward_current_d_gate__delta_d > fabs(var_second_inward_current_d_gate__E0_d)) ? (120) : (30 * var_second_inward_current_d_gate__E0_d / (1.0 - exp(-0.25 * var_second_inward_current_d_gate__E0_d))));
        const double var_second_inward_current_d_gate__beta_d = ((var_second_inward_current_d_gate__delta_d > fabs(var_second_inward_current_d_gate__E0_d)) ? (120) : (12.0 * var_second_inward_current_d_gate__E0_d / (-1.0 + exp(0.10000000000000001 * var_second_inward_current_d_gate__E0_d))));
        const double var_second_inward_current_f_gate__E0_f = 34.0 + var_chaste_interface__membrane__V;
        const double var_second_inward_current_f_gate__beta_f = 50 / (1.0 + exp(-8.5 - 0.25 * var_chaste_interface__membrane__V));
        const double var_second_inward_current_f_gate__delta_f = 0001;
        ...
        const double var_time_dependent_potassium_current_x_gate__alpha_x = 2.1000000000000001 * exp(035714285714285712 * var_chaste_interface__membrane__V);
        const double var_time_dependent_potassium_current_x_gate__beta_x = 0.95999999999999996 * exp(-041666666666666664 * var_chaste_interface__membrane__V);
        
        
        rY[5] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((001 * var_fast_sodium_current_h_gate__alpha_h) * mDt)) / (1.0 - ((-001 * var_fast_sodium_current_h_gate__alpha_h - 001 * var_fast_sodium_current_h_gate__beta_h) * mDt));
        rY[4] = (var_chaste_interface__fast_sodium_current_m_gate__m + ((001 * var_fast_sodium_current_m_gate__alpha_m) * mDt)) / (1.0 - ((-001 * var_fast_sodium_current_m_gate__alpha_m - 001 * var_fast_sodium_current_m_gate__beta_m) * mDt));
        rY[2] = (var_chaste_interface__hyperpolarising_activated_current_y_gate__y + ((001 * var_hyperpolarising_activated_current_y_gate__alpha_y * var_hyperpolarising_activated_current_y_gate__speed_y) * mDt)) / (1.0 - ((-001 * var_hyperpolarising_activated_current_y_gate__alpha_y * var_hyperpolarising_activated_current_y_gate__speed_y - 001 * var_hyperpolarising_activated_current_y_gate__beta_y * var_hyperpolarising_activated_current_y_gate__speed_y) * mDt));
        rY[12] = (var_chaste_interface__intracellular_calcium_concentration__p + ((001 * var_intracellular_calcium_concentration__alpha_p) * mDt)) / (1.0 - ((-001 * var_intracellular_calcium_concentration__alpha_p - 001 * var_intracellular_calcium_concentration__beta_p) * mDt));
        rY[6] = (var_chaste_interface__second_inward_current_d_gate__d + ((001 * var_second_inward_current_d_gate__alpha_d) * mDt)) / (1.0 - ((-001 * var_second_inward_current_d_gate__alpha_d - 001 * var_second_inward_current_d_gate__beta_d) * mDt));
        rY[7] = (var_chaste_interface__second_inward_current_f_gate__f + ((001 * var_second_inward_current_f_gate__alpha_f) * mDt)) / (1.0 - ((-001 * var_second_inward_current_f_gate__alpha_f - 001 * var_second_inward_current_f_gate__beta_f) * mDt));
        rY[3] = (var_chaste_interface__time_dependent_potassium_current_x_gate__x + ((001 * var_time_dependent_potassium_current_x_gate__alpha_x) * mDt)) / (1.0 - ((-001 * var_time_dependent_potassium_current_x_gate__alpha_x - 001 * var_time_dependent_potassium_current_x_gate__beta_x) * mDt));
