...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celliribe_model_2006FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[15], double rJacobian[15][15])
    {
        ...
        const double var_x82 = mParameters[5] / ((1.0 + mParameters[5]) * (1.0 + 0.035299999999999998 * exp(var_x19) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane_potential__V)));
    ...
    void Celliribe_model_2006FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_L_type_Ca_channel_d_gate__alpha_d = 30.0 * (19.0 + var_chaste_interface__membrane_potential__V) * var_L_type_Ca_channel_d_gate__speed_d / (1.0 - exp(-4.75 - 0.25 * var_chaste_interface__membrane_potential__V));
        const double var_L_type_Ca_channel_d_gate__beta_d = -12.0 * (19.0 + var_chaste_interface__membrane_potential__V) * var_L_type_Ca_channel_d_gate__speed_d / (1.0 - exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane_potential__V));
        const double var_L_type_Ca_channel_f_gate__alpha_f = 6.25 * (34.0 + var_chaste_interface__membrane_potential__V) * var_L_type_Ca_channel_f_gate__speed_f / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane_potential__V));
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = 200.0 * (41.0 + var_chaste_interface__membrane_potential__V) / (1.0 - exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane_potential__V));
