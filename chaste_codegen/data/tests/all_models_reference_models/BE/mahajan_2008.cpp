...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellmahajan_2008FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[15], double rJacobian[15][15])
    {
        ...
        const double var_x5 = 4.138e-5 * var_x1 * var_x4 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x6 = 6.6208000000000002e-12 * var_x4 * pow(var_chaste_interface__Ca__Ca_NSR, 3) / pow((1 + 0.00040000000000000002 * var_x0), 2);
        ...
        const double var_x10 = 0.80000000000000004 * pow(var_chaste_interface__Ca__Ca_i_converted, 3) / pow((2.4999999999999999e-7 + var_x9), 2);
        const double var_x11 = 1 / (0.25 + 1000000.0 * var_x9);
        const double var_x12 = 800000.0 * var_x11 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x13 = var_x12 + var_x8 - var_x10;
        ...
        const double var_x62 = 0.00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x63 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x64 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x65 = 0.012999999999999999 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x66 = 1.0 + 0.00016799999999999999 / pow(var_x64, 2) + 0.00054599999999999994 / pow(var_x65, 2) + 4.4999999999999993e-6 / pow(var_x62, 2) + 2.8199999999999998e-5 / pow(var_x63, 2);
        ...
        const double var_x71 = 400000.0 * var_x11 * var_x9;
        ...
        const double var_x75 = 0.59999999999999998 + var_chaste_interface__Ca__Ca_submem;
        const double var_x76 = pow(var_x75, (-2));
        const double var_x77 = 1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem;
        ...
        const double var_x81 = 1 / (1.0 + 4.5 * var_x74 + 3.2307692307692308 * var_x78 + 28.199999999999999 * var_x76 + 3.4285714285714284 * var_x80);
        const double var_x82 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
        const double var_x83 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x84 = 1 / (12405.2022 + 7.9663561662386391 * var_x83 + 4115.8113750000002 * var_chaste_interface__Ca__Ca_submem);
        ...
        const double var_x87 = 1.8 * var_x83 * var_x86 - 2515.4560000000001 * var_x85 * var_chaste_interface__Ca__Ca_submem;
        const double var_x88 = 1 / (1.0 + 0.20000000000000001 * var_x85);
        const double var_x89 = 1.0 + 0.026999999999999996 / pow(var_chaste_interface__Ca__Ca_submem, 3);
        const double var_x90 = var_x88 / var_x89;
        const double var_x91 = var_x87 * var_x90;
        const double var_x92 = 50.0 * var_chaste_interface__Irel__xir + 12500.0 * var_chaste_interface__Ca__Ca_i_converted + 0.019599999999999999 * var_chaste_interface__Ca__trops - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x82 * (70.0 - var_chaste_interface__Ca__trops) + 42.0 * var_x84 * var_x91;
        const double var_x93 = 0.0012574820180071425 * (9.0 / pow(var_x73, 3) + 56.399999999999999 / pow(var_x75, 3) + 0.97959183673469385 / pow(var_x79, 3) + 0.49704142011834318 / pow(var_x77, 3)) / pow((0.035460992907801421 + var_x76 + 0.15957446808510639 * var_x74 + 0.12158054711246201 * var_x80 + 0.11456628477905074 * var_x78), 2);
        const double var_x94 = 0.0327 * var_chaste_interface__Ca__trops;
        const double var_x95 = var_x91 / pow((1 + 0.0006421786632577935 * var_x83 + 0.33178107931203249 * var_chaste_interface__Ca__Ca_submem), 2);
        const double var_x96 = var_x84 * var_x90;
        const double var_x97 = var_x85 * var_x96;
        const double var_x98 = var_x84 * var_x87 * var_x88 / (pow(var_x89, 2) * pow(var_chaste_interface__Ca__Ca_submem, 4));
        const double var_x99 = -14.789 + var_x94 + 3.4019999999999997 * var_x98 - 0.0011233033614805057 * var_x95 - 105649.152 * var_x97;
        const double var_x100 = 1.0 * var_x81;
        const double var_x101 = 71.454967908626173 * var_x35;
        const double var_x102 = ((var_x28) ? (var_x100 * (-582.04072127761572 + 0.94825793626200006 * var_x20)) : (var_x101 * var_x81));
        const double var_x103 = pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x104 = var_x103 * var_x86 * var_x96;
        const double var_x105 = var_x103 * var_x95;
        ...
        const double var_x119 = 1.0 + 0.00072525373756441506 * var_x106;
        const double var_x120 = 1 / var_x119;
        const double var_x121 = 1.0 - 1.0 / (1.0 + exp(-10.0 - 0.25 * var_chaste_interface__cell__V));
        const double var_x122 = 4954.0 * exp(0.064102564102564111 * var_chaste_interface__cell__V);
        const double var_x123 = 78.032899999999998 * var_x120;
        const double var_x124 = var_x121 * (9.9000000000000004 + var_x122 - var_x123);
        const double var_x125 = 0.22637460951196098 * var_x108 / pow(var_x119, 2);
        const double var_x126 = 0.00016422697956757767 * (var_x125 - var_x121 * var_x125) / pow((0.0012815107473898831 + var_x120 + 0.012815107473898831 * var_x124), 2);
        const double var_x127 = var_x118 * var_x126 * var_chaste_interface__ICaL__xi2ca;
        const double var_x128 = 1 / (0.10000000000000001 + var_x123 + var_x124);
        const double var_x129 = 0.1111111111111111 * var_x110 * var_x116 * var_x128;
        const double var_x130 = var_x114 * var_x116 * var_x126;
        const double var_x131 = -var_x113;
        const double var_x132 = 1.0 + var_x131;
        const double var_x133 = 1 / (450.0 + var_x121 * (-440.0 + var_x122));
        const double var_x134 = var_x117 * var_x133;
        const double var_x135 = var_x114 * var_x117 * var_x128;
        const double var_x136 = var_x118 * var_x133;
        const double var_x137 = var_x118 * var_x128;
        ...
        const double var_x140 = var_x112 * var_x115 * var_x118 * var_x139 / var_x132;
        ...
        const double var_x145 = exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x146 = var_x145 / (1.0 + var_x145);
        const double var_x147 = 0.028675444444444444 * var_x146;
        const double var_x148 = var_x71 - var_x72 - var_chaste_interface__Irel__xir;
        const double var_x149 = 1.0 / var_chaste_interface__Ca__Ca_NSR;
        const double var_x150 = (var_x149 * var_x7 - 1.0 * var_x148 / var_x0) * var_chaste_interface__Irel__xir;
        const double var_x151 = var_x147 * var_x30;
        const double var_x152 = var_x147 * var_x17;
        const double var_x153 = var_x149 * var_chaste_interface__Irel__xir;
        const double var_x154 = var_x146 * var_chaste_interface__Ca__Ca_NSR;
        ...
        const double var_x160 = 0.32403252222222223 * var_x146;
        ...
        rJacobian[1][13] = 0.0;
        rJacobian[1][14] = 0.0;
        rJacobian[2][0] = -(mDt * (var_x68 * (var_x3 + var_x5 - var_x6)));
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (var_x68 * (-2539.0 + var_x10 + var_x69 - var_x12 - var_x8) + 0.001 * (0.00033599999999999998 / pow(var_x64, 3) + 0.0010919999999999999 / pow(var_x65, 3) + 8.9999999999999985e-6 / pow(var_x62, 3) + 5.6399999999999995e-5 / pow(var_x63, 3)) * (var_x72 - var_x71 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x70 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x66, 2)));
        ...
        rJacobian[3][3] = 1.0 - (mDt * (((var_x28) ? (var_x100 * (var_x99 - 0.94825793626200006 * var_x43) + var_x93 * (var_x92 - 9100.0 * var_x21 * var_x23)) : (var_x100 * (var_x99 - 0.071454967908626169 * var_x50) + var_x93 * (var_x92 - var_x101 * var_x23)))));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (var_x100 * (0.019599999999999999 + var_x82)));
        ...
        rJacobian[3][14] = -(mDt * (var_x100 * (226.80000000000001 * var_x104 - 6.52262738373438e-6 * var_x105)));
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        ...
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (2.2890000000000001 - var_x94));
        rJacobian[5][4] = 0.0;
        ...
        rJacobian[6][14] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = -(mDt * (var_x127 + (-var_x129 - var_x130) * var_chaste_interface__ICaL__c2));
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        ...
        rJacobian[10][14] = 0.0;
        rJacobian[11][0] = 0.0;
        rJacobian[11][1] = -(mDt * (-var_x127 + var_x129 * var_chaste_interface__ICaL__c2 + var_x130 * var_chaste_interface__ICaL__c2));
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = 0.0;
        ...
        rJacobian[12][13] = 0.0;
        rJacobian[12][14] = 0.0;
        rJacobian[13][0] = -(mDt * (((var_x29) ? (var_x150 + var_x147 * var_x25) : ((var_x33) ? (var_x150 + var_x151 * var_x24) : ((var_x28) ? (var_x150) : ((var_x39) ? (var_x150 + var_x152 * var_x37) : ((var_x32) ? (var_x150 + var_x151 * var_x37) : (var_x150))))))));
        rJacobian[13][1] = 0.0;
        ...
        rJacobian[13][12] = -(mDt * (((var_x29) ? (var_x147 * var_x59) : ((var_x33) ? (var_x160 * var_x59) : ((var_x28) ? (0) : ((var_x39) ? (var_x147 * var_x61) : ((var_x32) ? (var_x160 * var_x61) : (0))))))));
        rJacobian[13][13] = 1.0 - (mDt * (-0.033333333333333333 - var_x153 + var_x148 * var_x149));
        rJacobian[13][14] = 0.0;
        rJacobian[14][0] = 0.0;
        rJacobian[14][1] = 0.0;
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = -(mDt * (6.3389491199999997 * var_x97 + 6.7398201688830334e-8 * var_x95 - 0.00020411999999999996 * var_x98));
        rJacobian[14][4] = 0.0;
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = 0.0;
        rJacobian[14][7] = 0.0;
