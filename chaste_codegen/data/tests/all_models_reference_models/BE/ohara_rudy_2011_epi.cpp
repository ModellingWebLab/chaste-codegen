...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut::Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut::~Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut()
    {
    }

    
    double Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rResidual[12])
    {
    ...
    void Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -87.0
        ...
        const double var_x219 = 0.59999999999999998 / (1.0 + exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__v));
        ...
        const double var_x355 = 1 / (1.0 + exp(-1.4126984126984128 + 0.0066137566137566143 * var_chaste_interface__membrane__v));
        ...
        const double var_x459 = 1 / (1.0 + exp(1.4344412457471867 + 0.026171159382360639 * var_chaste_interface__membrane__v));
        ...
        const double var_x546 = pow(var_chaste_interface__intracellular_ions__cajsr, (-8));
        const double var_x547 = 1 / (1.0 + 25.62890625 * var_x546);
        const double var_x548 = var_x547 * (var_x234 - var_x229);
        const double var_x549 = 1 / var_chaste_interface__intracellular_ions__cajsr;
        const double var_x550 = 1 / (1.0 + 0.0123 * var_x549);
        const double var_x551 = 4.75 * var_x550 < 0.001;
        const double var_x552 = ((var_x551) ? (1000.0) : (0.21052631578947367 + 0.0025894736842105265 * var_x549));
        const double var_x553 = 2.375 * var_x552;
        const double var_x554 = var_x226 * (1.2 - var_x241);
        const double var_x555 = var_x249 + var_x245 * var_x554;
        const double var_x556 = var_x547 * var_x553;
        const double var_x557 = var_x316 + var_x317;
        const double var_x558 = var_x547 * var_x557;
        const double var_x559 = pow(var_chaste_interface__intracellular_ions__cajsr, (-2));
        const double var_x560 = var_x557 / (pow((0.039018442310623382 + var_x546), 2) * pow(var_chaste_interface__intracellular_ions__cajsr, 9));
        const double var_x561 = var_x313 + var_x315 - var_x314 + var_x311 * var_x554;
        const double var_x562 = 5.9375 * var_x550 < 0.001;
        const double var_x563 = ((var_x562) ? (1000.0) : (0.16842105263157894 + 0.0020715789473684213 * var_x549));
        const double var_x564 = 2.96875 * var_x563;
        const double var_x565 = var_x547 * var_x564;
        ...
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = 0.0;
        rJacobian[10][0] = -(mDt * (-var_x548 * var_x553));
        rJacobian[10][1] = -(mDt * (-var_x555 * var_x556));
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = -(mDt * ((-var_chaste_interface__ryr__Jrelnp - 2.375 * var_x558) * ((var_x551) ? (0) : (-0.0025894736842105265 * var_x559)) - 0.74135040390184426 * var_x552 * var_x560));
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = -(mDt * (-var_x556 * var_x561));
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-var_x552));
        rJacobian[10][11] = 0.0;
        rJacobian[11][0] = -(mDt * (-var_x548 * var_x564));
        rJacobian[11][1] = -(mDt * (-var_x555 * var_x565));
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = -(mDt * ((-var_chaste_interface__ryr__Jrelp - 2.96875 * var_x558) * ((var_x562) ? (0) : (-0.0020715789473684213 * var_x559)) - 0.92668800487730529 * var_x560 * var_x563));
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = -(mDt * (-var_x561 * var_x565));
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (-var_x563));
    }

    void Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        CardiacNewtonSolver<12,Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<12,Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut)
