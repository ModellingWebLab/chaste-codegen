...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellohara_rudy_2011_epiFromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x338 = 1 / (1.0 + exp(-1.4126984126984128 + 0.0066137566137566143 * var_chaste_interface__membrane__v));
        ...
        const double var_x443 = 1 / (1.0 + exp(1.4344412457471867 + 0.026171159382360639 * var_chaste_interface__membrane__v));
        ...
        const double var_x510 = pow(var_chaste_interface__intracellular_ions__cajsr, (-8));
        const double var_x511 = 1 / (1.0 + 25.62890625 * var_x510);
        const double var_x512 = var_x511 * (var_x215 - var_x211);
        const double var_x513 = 1 / var_chaste_interface__intracellular_ions__cajsr;
        const double var_x514 = 1 / (1.0 + 0.0123 * var_x513);
        const double var_x515 = 4.75 * var_x514 < 0.001;
        const double var_x516 = ((var_x515) ? (1000.0) : (0.21052631578947367 + 0.0025894736842105265 * var_x513));
        const double var_x517 = 2.375 * var_x516;
        const double var_x518 = var_x227 + var_x232;
        const double var_x519 = var_x511 * var_x517;
        const double var_x520 = var_x299 + var_x300;
        const double var_x521 = var_x511 * var_x520;
        const double var_x522 = pow(var_chaste_interface__intracellular_ions__cajsr, (-2));
        const double var_x523 = var_x520 / (pow((0.039018442310623382 + var_x510), 2) * pow(var_chaste_interface__intracellular_ions__cajsr, 9));
        const double var_x524 = var_x293 + var_x294 + var_x298 - var_x297;
        const double var_x525 = 5.9375 * var_x514 < 0.001;
        const double var_x526 = ((var_x525) ? (1000.0) : (0.16842105263157894 + 0.0020715789473684213 * var_x513));
        const double var_x527 = 2.96875 * var_x526;
        const double var_x528 = var_x511 * var_x527;
        ...
        rJacobian[6][6] = 1.0 - (mDt * (-0.014705882352941176 + var_x345 * (var_x441 + (6.0045682186055913e-14 * var_x439 + 4.2270410939725255e-12 * var_x405 - 0.28603867298173646 * var_x436 + var_x389 * var_x402 + var_x418 * var_x423 + var_x427 * var_x429 + var_x430 * var_x434 - var_x424 * var_x426 - var_x430 * var_x432 - var_x430 * var_x438) * mParameters[17] + var_x440 * (-4.0 * var_x26 * var_x340 - 4.0 * var_x29 * var_x342) * mParameters[18] - 0.59999999999999998 * var_x440 * mParameters[9] / (1.0 + exp(0.78953107960741553 - 0.054525627044711013 * var_chaste_interface__membrane__v)) - 1.2 * var_x442 * mParameters[12] * var_chaste_interface__IK1__xk1 / (1.0 + exp(11.145054250500367 + 0.10534077741493732 * var_chaste_interface__membrane__v - 0.27388602127883704 * mParameters[3])) - 0.55943092778551573 * var_x442 * (var_x443 * var_chaste_interface__IKr__xrf + (1.0 - var_x443) * var_chaste_interface__IKr__xrs) * mParameters[14] / ((1.0 + exp(0.73333333333333328 + 0.013333333333333334 * var_chaste_interface__membrane__v)) * (1.0 + exp(-0.33333333333333331 + 0.033333333333333333 * var_chaste_interface__membrane__v))))));
        ...
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = 0.0;
        rJacobian[10][0] = -(mDt * (-var_x512 * var_x517));
        rJacobian[10][1] = -(mDt * (-var_x518 * var_x519));
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = -(mDt * ((-var_chaste_interface__ryr__Jrelnp - 2.375 * var_x521) * ((var_x515) ? (0) : (-0.0025894736842105265 * var_x522)) - 0.74135040390184426 * var_x516 * var_x523));
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = -(mDt * (-var_x519 * var_x524));
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-var_x516));
        rJacobian[10][11] = 0.0;
        rJacobian[11][0] = -(mDt * (-var_x512 * var_x527));
        rJacobian[11][1] = -(mDt * (-var_x518 * var_x528));
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = -(mDt * ((-var_chaste_interface__ryr__Jrelp - 2.96875 * var_x521) * ((var_x525) ? (0) : (-0.0020715789473684213 * var_x522)) - 0.92668800487730529 * var_x523 * var_x526));
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = -(mDt * (-var_x524 * var_x528));
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (-var_x526));
    }
