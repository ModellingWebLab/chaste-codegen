...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    double Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::~Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut()
    {
    }

    
    double Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[27], double rResidual[27])
    {
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[27], double rJacobian[27][27])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: mV; Initial value: -81.4229700631461
        ...
        const double var_x34 = 5.2281977629563632e-6 + pow(var_chaste_interface__Ca_Concentrations__Ca_j, 1.6000000000000001);
        const double var_x35 = pow(2.3500000000000001, var_x14);
        const double var_x36 = 0.011844800000000001 * var_x35;
        const double var_x37 = 1 / mParameters[9];
        const double var_x38 = var_x37 * mParameters[10] * mParameters[23];
        const double var_x39 = exp(-9.9999999999999995e-8);
        const double var_x40 = 1 / (-1.0 + var_x39);
        const double var_x41 = var_x39 * var_x40;
        const double var_x42 = mParameters[9] * mParameters[11];
        const double var_x43 = 3.6827999999999999e-11 * var_x42;
        ...
        const double var_x48 = 1 / mParameters[10];
        const double var_x49 = 1 / mParameters[23];
        const double var_x50 = var_x48 * var_x49 * mParameters[9];
        const double var_x51 = 10000000.0 * var_x50 * (4.9999999999999998e-8 * var_x38 + var_chaste_interface__membrane_potential__V_m);
        const double var_x52 = fabs(var_chaste_interface__membrane_potential__V_m);
        const double var_x53 = fabs(var_x38);
        const double var_x54 = var_x52 < 4.9999999999999998e-8 * var_x53;
        const double var_x55 = var_x50 * var_chaste_interface__membrane_potential__V_m;
        const double var_x56 = exp(2.0 * var_x55);
        const double var_x57 = var_x48 * var_x49 * pow(mParameters[9], 2) * var_chaste_interface__membrane_potential__V_m;
        const double var_x58 = var_x57 * mParameters[11] / (-1.0 + var_x56);
        const double var_x59 = pow(1.8, var_x14) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f;
        const double var_x60 = var_x59 * ((var_x54) ? (-var_x44 + var_x51 * (var_x44 + var_x43 * var_x47)) : (0.00073656000000000004 * var_x56 * var_x58));
        const double var_x61 = 0.40500000000000003 - 0.40500000000000003 * var_chaste_interface__I_Ca__f_Ca_Bj;
        const double var_x62 = exp(-0.72999999999999998 * var_x55);
        const double var_x63 = pow(mParameters[8], 3);
        const double var_x64 = var_x62 * var_x63;
        const double var_x65 = pow(var_chaste_interface__Na_Concentrations__Na_j, 3);
        const double var_x66 = var_x65 * mParameters[5];
        const double var_x67 = var_x63 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x68 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_j) * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x69 = var_x63 * (1.0 + 0.00053869674493876331 * var_x65);
        const double var_x70 = 1 / (var_x66 + var_x67 + 669921.875 * var_x68 + 1.3 * var_x65 + 0.0035899999999999999 * var_x69);
        const double var_x71 = pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2);
        const double var_x72 = 1.0 + 2.2499999999999996e-8 / var_x71;
        const double var_x73 = pow(1.5700000000000001, var_x14) * mParameters[20] / (1.0 + 0.32000000000000001 * var_x62);
        const double var_x74 = var_x73 / var_x72;
        const double var_x75 = var_x70 * var_x74;
        const double var_x76 = var_x64 * var_x75;
        const double var_x77 = -669921.875 - var_x63;
        const double var_x78 = var_x77 - 373215529.24791086 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x79 = exp(0.27000000000000002 * var_x55);
        const double var_x80 = var_x66 * var_x79 - var_x62 * var_x67;
        const double var_x81 = var_x74 * var_x80 / pow((var_x68 + 1.9405247813411081e-6 * var_x65 + 5.3588338192419823e-9 * var_x69 + 1.4927113702623908e-6 * var_x66 + 1.4927113702623908e-6 * var_x67), 2);
        const double var_x82 = 4.9020119168033731e-13 * var_x81;
        const double var_x83 = var_x70 * var_x73 * var_x80 / (pow(var_x72, 2) * pow(var_chaste_interface__Ca_Concentrations__Ca_j, 3));
        const double var_x84 = var_x37 * mParameters[22];
        const double var_x85 = var_x7 * var_x84;
        const double var_x86 = 88294470889864.781 * var_x85;
        const double var_x87 = -0.34100000000000003 * mParameters[5];
        const double var_x88 = 0.34100000000000003 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x89 = 1.08e-10 * var_x42;
        const double var_x90 = var_x40 * var_x89;
        const double var_x91 = var_x90 * (var_x87 + var_x39 * var_x88);
        const double var_x92 = var_x46 * var_x89;
        const double var_x93 = 0.00216 * var_x58;
        const double var_x94 = var_x59 * var_x85;
        const double var_x95 = 100.0 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x96 = pow(var_chaste_interface__Na_Concentrations__Na_j, 2);
        const double var_x97 = 3 * mParameters[5];
        const double var_x98 = 5.8017639429904805e-6 * var_x63;
        const double var_x99 = -3.9000000000000004 * var_x96 - var_x96 * var_x97 - var_x96 * var_x98;
        const double var_x100 = var_x79 * mParameters[5];
        const double var_x101 = var_x100 * var_x75 * var_x96;
        const double var_x102 = 100.0 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_sl;
        const double var_x103 = 100.0 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_sl;
        const double var_x104 = 5.2281977629563632e-6 + pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 1.6000000000000001);
        const double var_x105 = 0.095835200000000009 * var_x35;
        const double var_x106 = 0.044999999999999991 - 0.044999999999999991 * var_chaste_interface__I_Ca__f_Ca_Bsl;
        const double var_x107 = pow(var_chaste_interface__Na_Concentrations__Na_sl, 3);
        const double var_x108 = var_x107 * mParameters[5];
        const double var_x109 = var_x63 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x110 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_sl) * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x111 = var_x63 * (1.0 + 0.00053869674493876331 * var_x107);
        const double var_x112 = 1 / (var_x108 + var_x109 + 669921.875 * var_x110 + 1.3 * var_x107 + 0.0035899999999999999 * var_x111);
        const double var_x113 = 1.0 + 2.2499999999999996e-8 / pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2);
        const double var_x114 = var_x73 / var_x113;
        const double var_x115 = var_x112 * var_x114;
        const double var_x116 = var_x115 * var_x64;
        const double var_x117 = var_x77 - 373215529.24791086 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x118 = var_x108 * var_x79 - var_x109 * var_x62;
        const double var_x119 = var_x114 * var_x118 / pow((var_x110 + 1.9405247813411081e-6 * var_x107 + 5.3588338192419823e-9 * var_x111 + 1.4927113702623908e-6 * var_x108 + 1.4927113702623908e-6 * var_x109), 2);
        const double var_x120 = 3.9661732781409103e-12 * var_x119;
        const double var_x121 = var_x112 * var_x118 * var_x73 / (pow(var_x113, 2) * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 3));
        const double var_x122 = 2379535990481.856 * var_x85;
        const double var_x123 = 0.34100000000000003 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x124 = var_x90 * (var_x87 + var_x123 * var_x39);
        const double var_x125 = 100.0 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x126 = pow(var_chaste_interface__Na_Concentrations__Na_sl, 2);
        const double var_x127 = -3.9000000000000004 * var_x126 - var_x126 * var_x97 - var_x126 * var_x98;
        const double var_x128 = var_x100 * var_x115 * var_x126;
        const double var_x129 = -var_x21;
        const double var_x130 = -var_x23;
        const double var_x131 = -var_x95;
        const double var_x132 = -var_x125;
        const double var_x133 = 0.0001 * var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x134 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bj;
        const double var_x135 = 0.0001 * var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x136 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bsl;
        const double var_x137 = var_x7 * mParameters[3];
        const double var_x138 = 0.23994508763098885 * var_x137;
        const double var_x139 = 7.3530178752050587e-13 * var_x81;
        const double var_x140 = var_x137 * var_x84;
        const double var_x141 = -0.75 * mParameters[8];
        const double var_x142 = 0.75 * var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x143 = 7.4999999999999986e-16 * mParameters[9];
        const double var_x144 = var_x143 * var_x40;
        const double var_x145 = var_x144 * (var_x141 + var_x142 * var_x39);
        const double var_x146 = var_x143 * var_x46;
        const double var_x147 = 5000000.0 * var_x50 * (9.9999999999999995e-8 * var_x38 + var_chaste_interface__membrane_potential__V_m);
        const double var_x148 = var_x52 < 9.9999999999999995e-8 * var_x53;
        const double var_x149 = exp(var_x55);
        const double var_x150 = var_x57 / (-1.0 + var_x149);
        const double var_x151 = 7.4999999999999993e-9 * var_x150;
        const double var_x152 = var_x140 * var_x59;
        const double var_x153 = 3.2338732908121872 * var_x7;
        const double var_x154 = var_x38 / var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x155 = 5.6249999999999997e-16 * mParameters[9];
        const double var_x156 = var_x155 * var_x41;
        const double var_x157 = var_x59 * ((var_x148) ? (-var_x156 + var_x147 * (var_x156 + var_x155 * var_x47)) : (5.6249999999999991e-9 * var_x149 * var_x150));
        const double var_x158 = mParameters[21] * mParameters[7] / ((1.5 + mParameters[7]) * (1.0 + 0.1245 * exp(-0.10000000000000001 * var_x55) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[8])) * exp(-var_x55)));
        const double var_x159 = pow(var_chaste_interface__I_Na__m, 3) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * mParameters[12];
        const double var_x160 = 5.9492599172113663e-12 * var_x119;
        const double var_x161 = 0.75 * var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x162 = var_x144 * (var_x141 + var_x161 * var_x39);
        const double var_x163 = var_x38 / var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x164 = 18.571428571428569 * mParameters[0];
        const double var_x165 = var_x32;
        const double var_x166 = 100.0 * var_chaste_interface__SR_Ca_Concentrations__Csqn_b;
        const double var_x167 = 100.0 * var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x168 = 1 / var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x169 = pow(var_x168, 2.5);
        const double var_x170 = 1.0 + 0.13584112963311223 * var_x169;
        const double var_x171 = 1 / var_x170;
        const double var_x172 = 7.0 * var_x171;
        const double var_x173 = 7.5 - var_x172;
        const double var_x174 = 1.0 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x175 = 1 / (15.0 - 14.0 * var_x171);
        const double var_x176 = 20.0 * var_x175 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x177 = var_x168 * var_x169 / pow(var_x170, 2);
        const double var_x178 = 2.3772197685794643 * var_x177 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x179 = var_x178 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x180 = 0.21130842387373014 * var_x177 * var_x71 / pow((1 - 0.93333333333333335 * var_x171), 2);
        const double var_x181 = 10.0 * var_x175 * var_x71;
        const double var_x182 = -var_x181;
        const double var_x183 = -7.5 + var_x172;
        const double var_x184 = var_x176 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x185 = var_x180 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x186 = var_x183 * var_chaste_interface__Ca_Concentrations__Ca_j;
        ...
        rJacobian[0][26] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (-75.37105751391465 + var_x28 + var_x29 - var_x30 - var_x31 - var_x33 - var_x86 * (0.22 * var_x76 - 9.8999999999999977e-9 * var_x83 + var_x60 * var_x61 - var_x78 * var_x82 + 3.0321500000000001e-5 * var_x38 / var_chaste_interface__Ca_Concentrations__Ca_j + var_x36 * pow(var_chaste_interface__Ca_Concentrations__Ca_j, 0.60000000000000009) / var_x34 - var_x36 * pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2.2000000000000002) / pow(var_x34, 2))));
        ...
        rJacobian[1][8] = 0.0;
        rJacobian[1][9] = 0.0;
        rJacobian[1][10] = -(mDt * (35759260710395.234 * var_x94 * ((var_x54) ? (-var_x91 + var_x51 * (var_x91 + var_x92 * (var_x87 + var_x45 * var_x88))) : (var_x93 * (var_x87 + var_x56 * var_x88)))));
        rJacobian[1][11] = 0.0;
        rJacobian[1][12] = -(mDt * (0.029999999999999999 + var_x95));
        rJacobian[1][13] = 0.0;
        rJacobian[1][14] = -(mDt * (1.3 + var_x95));
        rJacobian[1][15] = 0.0;
        rJacobian[1][16] = 0.0;
        rJacobian[1][17] = 0.0;
        rJacobian[1][18] = 0.0;
        rJacobian[1][19] = 0.0;
        rJacobian[1][20] = -(mDt * (-var_x86 * (-0.66000000000000003 * var_x101 - var_x82 * var_x99)));
        rJacobian[1][21] = 0.0;
        ...
        rJacobian[2][2] = 1.0 - (mDt * (-165.10000000000002 + var_x102 + var_x103 - 19.504723378941105 * var_x7 - var_x122 * (1.78 * var_x116 - 8.0099999999999983e-8 * var_x121 + var_x106 * var_x60 - var_x117 * var_x120 + 0.00024532850000000001 * var_x38 / var_chaste_interface__Ca_Concentrations__Ca_sl + var_x105 * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 0.60000000000000009) / var_x104 - var_x105 * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2.2000000000000002) / pow(var_x104, 2))));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        ...
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = -(mDt * (107079119571.68349 * var_x94 * ((var_x54) ? (-var_x124 + var_x51 * (var_x124 + var_x92 * (var_x87 + var_x123 * var_x45))) : (var_x93 * (var_x87 + var_x123 * var_x56)))));
        rJacobian[2][12] = 0.0;
        rJacobian[2][13] = -(mDt * (0.029999999999999999 + var_x125));
        rJacobian[2][14] = 0.0;
        rJacobian[2][15] = -(mDt * (1.3 + var_x125));
        rJacobian[2][16] = 0.0;
        rJacobian[2][17] = 0.0;
        rJacobian[2][18] = 0.0;
        rJacobian[2][19] = 0.0;
        rJacobian[2][20] = 0.0;
        rJacobian[2][21] = -(mDt * (-var_x122 * (-5.3399999999999999 * var_x128 - var_x120 * var_x127)));
        rJacobian[2][22] = 0.0;
        rJacobian[2][23] = 0.0;
        rJacobian[2][24] = 0.0;
        rJacobian[2][25] = 0.0;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-0.00046000000000000001 + var_x129));
        rJacobian[4][5] = -(mDt * (var_x129));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        ...
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-3.1999999999999999e-5 + var_x130));
        rJacobian[7][8] = -(mDt * (var_x130));
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[7][12] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-0.029999999999999999 + var_x131));
        rJacobian[12][13] = 0.0;
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        ...
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = -(mDt * (43.550000000000004 - var_x102));
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = 0.0;
        ...
        rJacobian[13][11] = 0.0;
        rJacobian[13][12] = 0.0;
        rJacobian[13][13] = 1.0 - (mDt * (-0.029999999999999999 + var_x132));
        rJacobian[13][14] = 0.0;
        rJacobian[13][15] = 0.0;
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-1.3 + var_x131));
        rJacobian[14][15] = 0.0;
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        ...
        rJacobian[15][0] = 0.0;
        rJacobian[15][1] = 0.0;
        rJacobian[15][2] = -(mDt * (121.55000000000001 - var_x103));
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = 0.0;
        rJacobian[15][5] = 0.0;
        rJacobian[15][6] = 0.0;
        ...
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (-1.3 + var_x132));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = 0.0;
        rJacobian[17][17] = 1.0 - (mDt * (-0.001 - var_x133));
        rJacobian[17][18] = 0.0;
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = -(mDt * (0.0007561 - var_x134));
        rJacobian[17][21] = 0.0;
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = 0.0;
        rJacobian[17][24] = 0.0;
        ...
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-0.001 - var_x135));
        rJacobian[18][19] = 0.0;
        rJacobian[18][20] = 0.0;
        rJacobian[18][21] = -(mDt * (0.000165 - var_x136));
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        rJacobian[18][25] = 0.0;
        ...
        rJacobian[19][17] = 0.0;
        rJacobian[19][18] = 0.0;
        rJacobian[19][19] = 1.0 - (mDt * (-var_x138));
        rJacobian[19][20] = 0.0;
        ...
        rJacobian[19][26] = 0.0;
        rJacobian[20][0] = 0.0;
        rJacobian[20][1] = -(mDt * (-176588941779729.56 * var_x140 * (1.4849999999999997e-8 * var_x83 - 0.33000000000000002 * var_x76 + var_x139 * var_x78)));
        rJacobian[20][2] = 0.0;
        rJacobian[20][3] = 0.0;
        rJacobian[20][4] = 0.0;
        rJacobian[20][5] = 0.0;
        ...
        rJacobian[20][8] = 0.0;
        rJacobian[20][9] = 0.0;
        rJacobian[20][10] = -(mDt * (71518521420790.469 * var_x152 * ((var_x148) ? (-var_x145 + var_x147 * (var_x145 + var_x146 * (var_x141 + var_x142 * var_x45))) : (var_x151 * (var_x141 + var_x142 * var_x149)))));
        rJacobian[20][11] = 0.0;
        rJacobian[20][12] = 0.0;
        rJacobian[20][13] = 0.0;
        rJacobian[20][14] = 0.0;
        rJacobian[20][15] = 0.0;
        rJacobian[20][16] = 0.0;
        rJacobian[20][17] = -(mDt * ((0.001 + var_x133) * mParameters[3]));
        rJacobian[20][18] = 0.0;
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * ((-0.0007561 + var_x134 - var_x153 - 176588941779729.56 * var_x85 * (0.98999999999999999 * var_x101 + 6.567e-5 * var_x154 + var_x139 * var_x99 + var_x157 * var_x61 + 0.11 * var_x154 * var_x159 + 9.0157776108189337e-5 * var_x158 / (pow((6.8301345536507063e-5 + pow(var_chaste_interface__Na_Concentrations__Na_j, (-4))), 2) * pow(var_chaste_interface__Na_Concentrations__Na_j, 5)))) * mParameters[3]));
        rJacobian[20][21] = -(mDt * (var_x153 * mParameters[3]));
        rJacobian[20][22] = 0.0;
        rJacobian[20][23] = 0.0;
        rJacobian[20][24] = 0.0;
        rJacobian[20][25] = 0.0;
        ...
        rJacobian[21][0] = 0.0;
        rJacobian[21][1] = 0.0;
        rJacobian[21][2] = -(mDt * (-4759071980963.7119 * var_x140 * (1.2014999999999997e-7 * var_x121 - 2.6699999999999999 * var_x116 + var_x117 * var_x160)));
        rJacobian[21][3] = 0.0;
        rJacobian[21][4] = 0.0;
        rJacobian[21][5] = 0.0;
        rJacobian[21][6] = 0.0;
        ...
        rJacobian[21][9] = 0.0;
        rJacobian[21][10] = 0.0;
        rJacobian[21][11] = -(mDt * (214158239143.36697 * var_x152 * ((var_x148) ? (-var_x162 + var_x147 * (var_x162 + var_x146 * (var_x141 + var_x161 * var_x45))) : (var_x151 * (var_x141 + var_x149 * var_x161)))));
        rJacobian[21][12] = 0.0;
        rJacobian[21][13] = 0.0;
        rJacobian[21][14] = 0.0;
        rJacobian[21][15] = 0.0;
        rJacobian[21][16] = 0.0;
        rJacobian[21][17] = 0.0;
        rJacobian[21][18] = -(mDt * ((0.001 + var_x135) * mParameters[3]));
        rJacobian[21][19] = -(mDt * (7.7982153480071377 * var_x137));
        rJacobian[21][20] = -(mDt * (0.087152885187388451 * var_x137));
        rJacobian[21][21] = 1.0 - (mDt * ((-0.000165 + var_x136 - 7.8853682331945256 * var_x7 - 4759071980963.7119 * var_x85 * (0.00053133 * var_x163 + 8.0099999999999998 * var_x128 + var_x106 * var_x157 + var_x127 * var_x160 + 0.89000000000000001 * var_x159 * var_x163 + 0.00072945837032989554 * var_x158 / (pow((6.8301345536507063e-5 + pow(var_chaste_interface__Na_Concentrations__Na_sl, (-4))), 2) * pow(var_chaste_interface__Na_Concentrations__Na_sl, 5)))) * mParameters[3]));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        ...
        rJacobian[22][1] = -(mDt * (var_x164 + var_x165));
        rJacobian[22][2] = 0.0;
        rJacobian[22][3] = 0.0;
        rJacobian[22][4] = 0.0;
        rJacobian[22][5] = 0.0;
        ...
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (-260.0 + var_x166 - var_x164 - var_x165 - 0.69232869146389786 * var_x26 - 8.7400597733819945e-14 * var_x27));
        rJacobian[22][23] = -(mDt * (65.0 + var_x167));
        rJacobian[22][24] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (260.0 - var_x166));
        rJacobian[23][23] = 1.0 - (mDt * (-65.0 - var_x167));
        rJacobian[23][24] = 0.0;
        rJacobian[23][25] = 0.0;
        rJacobian[23][26] = 0.0;
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = -(mDt * (var_x173 * var_chaste_interface__SR_Fluxes__Ry_Ro + var_x174 * var_x176));
        rJacobian[24][2] = 0.0;
        rJacobian[24][3] = 0.0;
        rJacobian[24][4] = 0.0;
        rJacobian[24][5] = 0.0;
        ...
        rJacobian[24][20] = 0.0;
        rJacobian[24][21] = 0.0;
        rJacobian[24][22] = -(mDt * (-var_x179 + var_x174 * var_x180));
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-0.065000000000000002 + var_x182));
        rJacobian[24][25] = -(mDt * (var_x182 + var_x173 * var_chaste_interface__Ca_Concentrations__Ca_j));
        rJacobian[24][26] = -(mDt * (var_x182));
        rJacobian[25][0] = 0.0;
        rJacobian[25][1] = -(mDt * (var_x184 + var_x183 * var_chaste_interface__SR_Fluxes__Ry_Ro));
        rJacobian[25][2] = 0.0;
        rJacobian[25][3] = 0.0;
        rJacobian[25][4] = 0.0;
        rJacobian[25][5] = 0.0;
        ...
        rJacobian[25][20] = 0.0;
        rJacobian[25][21] = 0.0;
        rJacobian[25][22] = -(mDt * (var_x179 + var_x185));
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = -(mDt * (0.0050000000000000001));
        rJacobian[25][25] = 1.0 - (mDt * (-0.059999999999999998 + var_x186));
        rJacobian[25][26] = -(mDt * (var_x181));
        rJacobian[26][0] = 0.0;
        rJacobian[26][1] = -(mDt * (-var_x184 + var_x183 * var_chaste_interface__SR_Fluxes__Ry_Rr));
        rJacobian[26][2] = 0.0;
        rJacobian[26][3] = 0.0;
        rJacobian[26][4] = 0.0;
        rJacobian[26][5] = 0.0;
        ...
        rJacobian[26][20] = 0.0;
        rJacobian[26][21] = 0.0;
        rJacobian[26][22] = -(mDt * (-var_x185 + var_x178 * var_chaste_interface__SR_Fluxes__Ry_Rr));
        rJacobian[26][23] = 0.0;
        rJacobian[26][24] = -(mDt * (-0.0050000000000000001));
        rJacobian[26][25] = -(mDt * (0.055));
        rJacobian[26][26] = 1.0 - (mDt * (-0.0050000000000000001 + var_x182 + var_x186));
    }

    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        const double var_I_Ca__dss = 1 / (1.0 + exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane_potential__V_m));
        const double var_I_Ca__fss = 1 / (1.0 + exp(3.8888888888888888 + 0.1111111111111111 * var_chaste_interface__membrane_potential__V_m)) + 0.59999999999999998 / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane_potential__V_m));
        ...
        const double var_I_Kr__tauxr = 230.0 / (1.0 + exp(2.0 + 0.050000000000000003 * var_chaste_interface__membrane_potential__V_m)) + 3300.0 / ((1.0 + exp(1.2222222222222223 + 0.1111111111111111 * var_chaste_interface__membrane_potential__V_m)) * (1.0 + exp(-2.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane_potential__V_m)));
        const double var_I_Kr__xrss = 1 / (1.0 + exp(-2.0 - 0.20000000000000001 * var_chaste_interface__membrane_potential__V_m));
        ...
        const double var_I_Ks__xsss = 1 / (1.0 + exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__membrane_potential__V_m));
        ...
        const double var_I_Na__mss = 1 / pow((1.0 + exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane_potential__V_m)), 2);
        ...
        const double var_I_to__tauxtos = 0.5 + 9.0 / (1.0 + exp(0.20000000000000001 + 0.066666666666666666 * var_chaste_interface__membrane_potential__V_m));
        const double var_I_to__tauytof = 7.0 + 85.0 * exp(-7.2727272727272725 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane_potential__V_m), 2));
        const double var_I_to__tauytos = 30.0 + 800.0 / (1.0 + exp(6.0 + 0.10000000000000001 * var_chaste_interface__membrane_potential__V_m));
        const double var_I_to__xtoss = 1 / (1.0 + exp(1.4615384615384615 - 0.076923076923076927 * var_chaste_interface__membrane_potential__V_m));
        const double var_I_to__ytoss = 1 / (1.0 + exp(3.8999999999999999 + 0.20000000000000001 * var_chaste_interface__membrane_potential__V_m));
        ...
        CardiacNewtonSolver<27,Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<27,Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut)
