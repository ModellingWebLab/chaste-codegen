...
#include "CardiacNewtonSolver.hpp"
    ...
    double Cellpandit_model_2001_epiFromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_Ca_independent_transient_outward_K_current__g_t = 035000000000000003; // microS
        const double var_L_type_Ca_channel__E_Ca_L = 65.0; // millivolt
        const double var_L_type_Ca_channel__g_Ca_L = 031; // microS
        const double var_Na_Ca_ion_exchanger_current__K_NaCa = 9.9839999999999996e-6; // nanoA_millimolar_4
        const double var_Na_Ca_ion_exchanger_current__d_NaCa = 0001; // millimolar_4
        ...
        const double var_background_currents__g_B_K = 00013799999999999999; // microS
        ...
        const double var_hyperpolarisation_activated_current__g_f = 0014499999999999999; // microS
        const double var_inward_rectifier__g_K1 = 024; // microS
        ...
        const double var_sarcolemmal_calcium_pump_current__i_Ca_P_max = 0040000000000000001; // nanoA
        const double var_sarcolemmal_calcium_pump_current__i_Ca_P = var_chaste_interface__intracellular_ion_concentrations__Ca_i * var_sarcolemmal_calcium_pump_current__i_Ca_P_max / (00040000000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i); // nanoA
        ...
        const double var_sodium_potassium_pump__K_m_Na = 10; // millimolar
        const double var_sodium_potassium_pump__i_NaK_max = 080000000000000002; // nanoA
        ...
        const double var_sodium_potassium_pump__i_NaK = var_sodium_potassium_pump__i_NaK_max * var_standard_ionic_concentrations__K_o / ((1.0 + pow((var_sodium_potassium_pump__K_m_Na / var_chaste_interface__intracellular_ion_concentrations__Na_i), 1.5)) * (var_sodium_potassium_pump__K_m_K + var_standard_ionic_concentrations__K_o) * (1.0 + 0.1245 * exp(-0.10000000000000001 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + 036499999999999998 * var_sodium_potassium_pump__sigma * exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)))); // nanoA
        const double var_steady_state_outward_K_current__g_ss = 0070000000000000001; // microS
    ...
    void Cellpandit_model_2001_epiFromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[13], double rResidual[13])
    {
        ...
        const double var_L_type_Ca_channel__E_Ca_L = 65.0; // millivolt
        const double var_L_type_Ca_channel__g_Ca_L = 031; // microS
        const double var_L_type_Ca_channel_Ca_inact_gate__tau_Ca_inact = 0089999999999999993; // second
        const double var_Na_Ca_ion_exchanger_current__K_NaCa = 9.9839999999999996e-6; // nanoA_millimolar_4
        const double var_Na_Ca_ion_exchanger_current__d_NaCa = 0001; // millimolar_4
        const double var_Na_Ca_ion_exchanger_current__gamma_NaCa = 0.5; // dimensionless
        ...
        const double var_SERCA2a_pump__Vmaxf = 040000000000000001; // millimolar_per_second
        ...
        const double var_SR_Ca_release_channel__k_a_plus = 12150000000000; // per_second
        const double var_SR_Ca_release_channel__k_b_minus = 1930; // per_second
        const double var_SR_Ca_release_channel__k_b_plus = 4050000000; // per_second
        const double var_SR_Ca_release_channel__k_c_minus = 0.80000000000000004; // per_second
        const double var_SR_Ca_release_channel__k_c_plus = 100; // per_second
        ...
        const double d_dt_chaste_interface_var_SR_Ca_release_channel__P_C2 = 001 * var_SR_Ca_release_channel__P_C2_orig_deriv; // 1 / millisecond
        const double var_SR_Ca_release_channel__m = 3.0; // dimensionless
        const double var_SR_Ca_release_channel__n = 4.0; // dimensionless
        const double var_SR_Ca_release_channel__v1 = 1800; // per_second
        const double var_background_currents__g_B_Ca = 3.2400000000000001e-5; // microS
        const double var_background_currents__g_B_K = 00013799999999999999; // microS
        const double var_background_currents__g_B_Na = 8.0149999999999997e-5; // microS
        const double var_hyperpolarisation_activated_current__f_Na = 0.20000000000000001; // dimensionless
        ...
        const double var_intracellular_and_SR_Ca_fluxes__LTRPN_tot = 070000000000000007; // millimolar
        const double var_intracellular_and_SR_Ca_fluxes__k_htrpn_minus = 066000000000000003; // per_second
        const double var_intracellular_and_SR_Ca_fluxes__k_htrpn_plus = 200000; // per_millimolar_per_second
        const double var_intracellular_and_SR_Ca_fluxes__k_ltrpn_minus = 40; // per_second
        const double var_intracellular_and_SR_Ca_fluxes__k_ltrpn_plus = 40000; // per_millimolar_per_second
        const double var_intracellular_and_SR_Ca_fluxes__tau_tr = 00057470000000000004; // second
        const double var_intracellular_and_SR_Ca_fluxes__tau_xfer = 026700000000000002; // second
        ...
        const double d_dt_chaste_interface_var_intracellular_and_SR_Ca_fluxes__HTRPNCa = 001 * var_intracellular_and_SR_Ca_fluxes__HTRPNCa_orig_deriv; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_intracellular_and_SR_Ca_fluxes__LTRPNCa = 001 * var_intracellular_and_SR_Ca_fluxes__LTRPNCa_orig_deriv; // millimolar / millisecond
        const double var_L_type_Ca_channel_Ca_inact_gate__Ca_inact_infinity = 1.0 / (1.0 + 100 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss); // dimensionless
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_channel_Ca_inact_gate__Ca_inact = 001 * var_L_type_Ca_channel_Ca_inact_gate__Ca_inact_orig_deriv; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_SR_Ca_release_channel__P_C1 = 001 * var_SR_Ca_release_channel__P_C1_orig_deriv; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_SR_Ca_release_channel__P_O1 = 001 * var_SR_Ca_release_channel__P_O1_orig_deriv; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_SR_Ca_release_channel__P_O2 = 001 * var_SR_Ca_release_channel__P_O2_orig_deriv; // 1 / millisecond
        ...
        const double var_intracellular_ion_concentrations__EGTA_tot = 10; // millimolar
    ...
    void Cellpandit_model_2001_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x0 = 12150000000 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 4.0);
        const double var_x1 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 3.0);
        const double var_x2 = 48600000000 * var_x1 * var_chaste_interface__SR_Ca_release_channel__P_C1;
        const double var_x3 = 4050000 * var_x1;
        const double var_x4 = 12150000 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 2.0) * var_chaste_interface__SR_Ca_release_channel__P_O1;
        ...
        const double var_x8 = 001 * var_x7;
        const double var_x9 = var_x8 * (1800 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 1800 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR);
        const double var_x10 = 1800 * var_chaste_interface__SR_Ca_release_channel__P_O1;
        const double var_x11 = 1800 * var_chaste_interface__SR_Ca_release_channel__P_O2;
        ...
        const double var_x21 = 200000 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x22 = 00014999999999999999 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x23 = 0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x24 = 1.0 + 0014999999999999998 / pow(var_x22, 2) + 00011900000000000002 / pow(var_x23, 2);
        const double var_x25 = 1 / var_x24;
        const double var_x26 = 001 * var_x25;
        const double var_x27 = 40000 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x28 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x29 = 00040000000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x30 = 0022145492519739826 / var_x29;
        const double var_x31 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3);
        const double var_x32 = 018714999999999999 * var_chaste_interface__membrane__V;
        const double var_x33 = exp(var_x32);
        const double var_x34 = exp(-var_x32);
        const double var_x35 = 1.2 * var_x31 * var_x33 - 2744000 * var_x34 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x36 = var_x35 / pow((0036443148688046646 + 4.3731778425655972e-7 * var_x31 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x37 = 1 / (1.0 + 00012 * var_x31 + 274.40000000000003 * var_chaste_interface__intracellular_ion_concentrations__Ca_i);
        ...
        const double var_x42 = 0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x43 = 1.0 + 00011900000000000002 / pow(var_x42, 2);
        const double var_x44 = 1 / var_x43;
        const double var_x45 = 001 * var_x44;
        const double var_x46 = var_x45 * (84000 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR - 84000 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss);
        const double var_x47 = 84000 * var_chaste_interface__SR_Ca_release_channel__P_O1;
        const double var_x48 = 84000 * var_chaste_interface__SR_Ca_release_channel__P_O2;
        ...
        const double var_x52 = exp(-0.10977188457982838 + 06345195640452507 * var_chaste_interface__membrane__V - 1.613 * var_x51);
        const double var_x53 = 1.0 + var_x52;
        const double var_x54 = var_x50 / (1.0 + exp(-35.49354838709678));
        const double var_x55 = exp(4.5158823529411762 + 1.4953416461467837 * var_x51 - 058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x56 = 040000000000000001 * var_chaste_interface__membrane__V;
        const double var_x57 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x58 = pow(var_x57, 1.5);
        const double var_x59 = var_x57 * var_x58 / (pow((031622776601683791 + var_x58), 2) * (1.0 + 0.1245 * exp(-0039337852699643568 * var_chaste_interface__membrane__V) + 036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-039337852699643565 * var_chaste_interface__membrane__V)));
        ...
        rJacobian[0][8] = 0;
        rJacobian[0][9] = 0;
        rJacobian[0][10] = -(mDt * (-0011111111111111113 / pow((01 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss), 2)));
        rJacobian[0][11] = 0;
        rJacobian[0][12] = 0;
        rJacobian[1][0] = 0;
        ...
        rJacobian[2][0] = 0;
        rJacobian[2][1] = 0;
        rJacobian[2][2] = 1.0 - (mDt * (-00080000000000000004));
        ...
        rJacobian[3][2] = -(mDt * (00080000000000000004));
        ...
        rJacobian[5][3] = 0;
        rJacobian[5][4] = 0;
        rJacobian[5][5] = 1.0 - (mDt * (-6.6000000000000005e-5 - 200 * var_chaste_interface__intracellular_ion_concentrations__Ca_i));
        rJacobian[5][6] = 0;
        rJacobian[5][7] = 0;
        rJacobian[5][8] = 0;
        rJacobian[5][9] = -(mDt * (28.000000000000004 - 200 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa));
        rJacobian[5][10] = 0;
        rJacobian[5][11] = 0;
        rJacobian[5][12] = 0;
        rJacobian[6][0] = 0;
        ...
        rJacobian[6][4] = 0;
        rJacobian[6][5] = 0;
        rJacobian[6][6] = 1.0 - (mDt * (-040000000000000001 - 40 * var_chaste_interface__intracellular_ion_concentrations__Ca_i));
        rJacobian[6][7] = 0;
        rJacobian[6][8] = 0;
        rJacobian[6][9] = -(mDt * (2.8000000000000003 - 40 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa));
        rJacobian[6][10] = 0;
        rJacobian[6][11] = 0;
        rJacobian[6][12] = 0;
        rJacobian[7][0] = 0;
        ...
        rJacobian[7][5] = 0;
        rJacobian[7][6] = 0;
        rJacobian[7][7] = 1.0 - (mDt * (var_x8 * (-1740382808421784 - var_x10 - var_x11) + 00016666666666666666 * (1740382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800 * var_x12 - 1740382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / (pow(var_x5, 3) * pow((083333333333333329 + var_x6), 2))));
        ...
        rJacobian[8][8] = 1.0 - (mDt * (-0.19333758676024207 - 4.9248350664764349e-13 * var_x17 - 00050803300043421621 * var_x15));
        ...
        rJacobian[9][3] = 0;
        rJacobian[9][4] = 0;
        rJacobian[9][5] = -(mDt * (var_x26 * (066000000000000003 + var_x21)));
        rJacobian[9][6] = -(mDt * (var_x26 * (40 + var_x27)));
        rJacobian[9][7] = 0;
        rJacobian[9][8] = -(mDt * (var_x26 * (0.2735562310030395 * var_x15 + 2.651834266564234e-10 * var_x17)));
        rJacobian[9][9] = 1.0 - (mDt * (var_x26 * (-30837.453183520603 - var_x30 + 40000 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 200000 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 3.5444788081288787e-5 * var_x20 - 4.0288009715211813e-8 * var_x36 - 00022799730679188537 * var_x28 - 30.33500195190371 * var_x38 - 1625.0626147884036 * var_x19 + 0022145492519739826 * var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x29, 2)) + 001 * (0029999999999999996 / pow(var_x22, 3) + 00023800000000000004 / pow(var_x23, 3)) * (40 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 066000000000000003 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 00022799730679188537 * log(1.2 * var_x28) + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 1.7937848940989261e-5 * var_chaste_interface__membrane__V - var_x21 * (0.14000000000000001 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa) - var_x27 * (070000000000000007 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa) - var_x30 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 1.1055029865854122e-5 * var_x35 * var_x37 - 1.0 * var_x15 * var_x16) / pow(var_x24, 2)));
        rJacobian[9][10] = -(mDt * (037453183520599252 * var_x25));
        rJacobian[9][11] = 0;
        ...
        rJacobian[11][9] = 0;
        rJacobian[11][10] = 0;
        rJacobian[11][11] = 1.0 - (mDt * (-3.8843985601580465e-6 * var_x50 - 00067554757567966038 * var_x54 / var_x53 - 3.2651466157850246e-5 * var_x50 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + 25.420807984495319 * var_x50 * (-3.433658615185661e-5 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s - 4.4180257576880966e-6 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r - 00019703470957323427 * var_x50 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss + 4.286481532120841e-5 * var_x52 * var_x54 * (-1.73 - 25.420807984495319 * var_x51 + var_chaste_interface__membrane__V) / pow(var_x53, 2) - 1.6557538619599519e-7 * var_x50 * var_x55 * (10 + 48.0 / (exp(1.48 + var_x56) + exp(-1.48 - var_x56))) / pow((1.0 + var_x55), 2)));
        ...
        rJacobian[12][7] = 0;
        rJacobian[12][8] = 0;
        rJacobian[12][9] = -(mDt * (1.2086402914563544e-10 * var_x36 + 091005005855711127 * var_x38));
        rJacobian[12][10] = 0;
        rJacobian[12][11] = 0;
        rJacobian[12][12] = 1.0 - (mDt * (1.5856796826686865e-16 * var_x41 - 9.8651233004461501e-6 * var_x59 - 1.193943225512245e-7 * var_x40 - 2.2560474246135324e-6 * var_x57 - 8.1628665394625614e-6 * var_x57 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 022518252522655345 * var_x57 * pow(var_chaste_interface__sodium_current_m_gate__m, 3) * var_chaste_interface__sodium_current_h_gate__h * var_chaste_interface__sodium_current_j_gate__j));
    }
    ...
    void Cellpandit_model_2001_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_Ca_independent_transient_outward_K_current_r_gate__r_infinity = 1.0 / (1.0 + exp(-0.92819614711033271 - 087565674255691769 * var_chaste_interface__membrane__V));
        const double var_Ca_independent_transient_outward_K_current_r_gate__tau_r = 1.0 / (45.159999999999997 * exp(1.7885000000000002 + 035770000000000003 * var_chaste_interface__membrane__V) + 98.900000000000006 * exp(-3.8000000000000003 - 0.10000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_Ca_independent_transient_outward_K_current_s_gate__tau_s = 035000000000000003 + 0.34999999999999998 * exp(-21.777777777777779 * pow((1 + 014285714285714285 * var_chaste_interface__membrane__V), 2));
        ...
        const double var_Ca_independent_transient_outward_K_current_s_slow_gate__tau_s_slow = 035000000000000003 + 3.7000000000000002 * exp(-5.4444444444444446 * pow((1 + 014285714285714285 * var_chaste_interface__membrane__V), 2));
        ...
        const double var_L_type_Ca_channel_d_gate__tau_d = 00025000000000000001 + 0010499999999999999 * exp(-0.64800000000000002 * pow((-1 + 055555555555555552 * var_chaste_interface__membrane__V), 2)) + 0030500000000000002 * exp(-0.22049999999999997 * pow((1 + 0.14285714285714285 * var_chaste_interface__membrane__V), 2));
        ...
        const double var_L_type_Ca_channel_f_11_gate__tau_f_11 = 0016999999999999999 + 014999999999999999 / (1.0 + exp(3.0 + 040000000000000001 * var_chaste_interface__membrane__V)) + 040000000000000001 / (1.0 + exp(1.0 - 040000000000000001 * var_chaste_interface__membrane__V)) + 0.105 * exp(-14.0625 * pow((1 + 022222222222222223 * var_chaste_interface__membrane__V), 2));
        ...
        const double var_L_type_Ca_channel_f_12_gate__tau_f_12 = 0016999999999999999 + 014999999999999999 / (1.0 + exp(3.0 + 040000000000000001 * var_chaste_interface__membrane__V)) + 080000000000000002 / (1.0 + exp(-11.0 - 0.20000000000000001 * var_chaste_interface__membrane__V)) + 041000000000000002 * exp(-15.340277777777779 * pow((1 + 021276595744680851 * var_chaste_interface__membrane__V), 2));
        const double var_hyperpolarisation_activated_current_y_gate__tau_y = 1.0 / (0.56230000000000002 * exp(-5.6377730796335452 - 070472163495419307 * var_chaste_interface__membrane__V) + 0.11885 * exp(2.8198801550934083 + 035248501938667604 * var_chaste_interface__membrane__V));
        const double var_hyperpolarisation_activated_current_y_gate__y_infinity = 1.0 / (1.0 + exp(13.225190839694655 + 095419847328244267 * var_chaste_interface__membrane__V));
        ...
        const double var_sodium_current_h_gate__tau_h = ((var_chaste_interface__membrane__V >= -40) ? (00045370000000000002 + 00045370000000000002 * exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__membrane__V)) : (00349 / (310000 * exp(0.34999999999999998 * var_chaste_interface__membrane__V) + 0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V) + 3.5600000000000001 * exp(079000000000000001 * var_chaste_interface__membrane__V))));
        ...
        const double var_sodium_current_j_gate__tau_j = ((var_chaste_interface__membrane__V >= -40) ? (01163 * (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V)) / exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V)) : (00349 / (0.1212 * exp(-01052 * var_chaste_interface__membrane__V) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V)) + (37.780000000000001 + var_chaste_interface__membrane__V) * (-127140 * exp(0.24440000000000001 * var_chaste_interface__membrane__V) - 3.4740000000000003e-5 * exp(-043909999999999998 * var_chaste_interface__membrane__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)))));
        ...
        const double var_sodium_current_m_gate__tau_m = 0013600000000000001 / (080000000000000002 * exp(-090909090909090912 * var_chaste_interface__membrane__V) + 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V)));
        const double var_steady_state_outward_K_current_r_ss_gate__r_ss_infinity = 1.0 / (1.0 + exp(-0.97292724196277491 - 084602368866328256 * var_chaste_interface__membrane__V));
        const double var_steady_state_outward_K_current_r_ss_gate__tau_r_ss = 10 / (45.159999999999997 * exp(1.7885000000000002 + 035770000000000003 * var_chaste_interface__membrane__V) + 98.900000000000006 * exp(-3.8000000000000003 - 0.10000000000000001 * var_chaste_interface__membrane__V));
        const double var_steady_state_outward_K_current_s_ss_gate__s_ss_infinity = 1.0 / (1.0 + exp(8.4951456310679614 + 097087378640776698 * var_chaste_interface__membrane__V));
        ...
        rY[10] = (var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow + ((001 * var_Ca_independent_transient_outward_K_current_s_slow_gate__s_slow_infinity / var_Ca_independent_transient_outward_K_current_s_slow_gate__tau_s_slow) * mDt)) / (1.0 - ((-001 / var_Ca_independent_transient_outward_K_current_s_slow_gate__tau_s_slow) * mDt));
        rY[4] = (var_chaste_interface__L_type_Ca_channel_d_gate__d + ((001 * var_L_type_Ca_channel_d_gate__d_infinity / var_L_type_Ca_channel_d_gate__tau_d) * mDt)) / (1.0 - ((-001 / var_L_type_Ca_channel_d_gate__tau_d) * mDt));
        rY[5] = (var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11 + ((001 * var_L_type_Ca_channel_f_11_gate__f_11_infinity / var_L_type_Ca_channel_f_11_gate__tau_f_11) * mDt)) / (1.0 - ((-001 / var_L_type_Ca_channel_f_11_gate__tau_f_11) * mDt));
        rY[6] = (var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12 + ((001 * var_L_type_Ca_channel_f_12_gate__f_12_infinity / var_L_type_Ca_channel_f_12_gate__tau_f_12) * mDt)) / (1.0 - ((-001 / var_L_type_Ca_channel_f_12_gate__tau_f_12) * mDt));
        rY[13] = (var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + ((001 * var_hyperpolarisation_activated_current_y_gate__y_infinity / var_hyperpolarisation_activated_current_y_gate__tau_y) * mDt)) / (1.0 - ((-001 / var_hyperpolarisation_activated_current_y_gate__tau_y) * mDt));
        rY[2] = (var_chaste_interface__sodium_current_h_gate__h + ((001 * var_sodium_current_h_gate__h_infinity / var_sodium_current_h_gate__tau_h) * mDt)) / (1.0 - ((-001 / var_sodium_current_h_gate__tau_h) * mDt));
        rY[3] = (var_chaste_interface__sodium_current_j_gate__j + ((001 * var_sodium_current_j_gate__j_infinity / var_sodium_current_j_gate__tau_j) * mDt)) / (1.0 - ((-001 / var_sodium_current_j_gate__tau_j) * mDt));
        rY[1] = (var_chaste_interface__sodium_current_m_gate__m + ((001 * var_sodium_current_m_gate__m_infinity / var_sodium_current_m_gate__tau_m) * mDt)) / (1.0 - ((-001 / var_sodium_current_m_gate__tau_m) * mDt));
        rY[11] = (var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss + ((001 * var_steady_state_outward_K_current_r_ss_gate__r_ss_infinity / var_steady_state_outward_K_current_r_ss_gate__tau_r_ss) * mDt)) / (1.0 - ((-001 / var_steady_state_outward_K_current_r_ss_gate__tau_r_ss) * mDt));
        rY[12] = (var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss + ((001 * var_steady_state_outward_K_current_s_ss_gate__s_ss_infinity / var_steady_state_outward_K_current_s_ss_gate__tau_s_ss) * mDt)) / (1.0 - ((-001 / var_steady_state_outward_K_current_s_ss_gate__tau_s_ss) * mDt));
