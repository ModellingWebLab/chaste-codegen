...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellpandit_model_2001_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x13 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_NSR, 1.0);
        const double var_x14 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 1.2);
        const double var_x15 = 1 / (1.0 + 33855.471141425078 * var_x14 + 0.303951367781155 * var_x13);
        const double var_x16 = 1354.2188456570032 * var_x14 - 0.2735562310030395 * var_x13;
        const double var_x17 = var_x16 / pow((2.9537323401073989e-5 + var_x14 + 8.9779098483507565e-6 * var_x13), 2);
        ...
        const double var_x28 = 0.00040000000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x29 = 0.0022145492519739826 / var_x28;
        const double var_x30 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x31 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3);
        const double var_x32 = 1 / (1.0 + 0.00012 * var_x31 + 274.40000000000003 * var_chaste_interface__intracellular_ion_concentrations__Ca_i);
        ...
        const double var_x36 = 1.2 * var_x31 * var_x35 - 2744000.0 * var_x34 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x37 = var_x32 * var_x34;
        const double var_x38 = var_x36 / pow((0.0036443148688046646 + 4.3731778425655972e-7 * var_x31 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x39 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2);
        const double var_x40 = var_x32 * var_x35 * var_x39;
        const double var_x41 = var_x38 * var_x39;
        ...
        rJacobian[9][9] = 1.0 - (mDt * (var_x26 * (-30837.453183520603 - var_x29 + 40000.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 200000.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 3.5444788081288787e-5 * var_x20 - 4.0288009715211813e-8 * var_x38 - 0.00022799730679188537 * var_x30 - 30.33500195190371 * var_x37 - 1625.0626147884036 * var_x19 + 0.0022145492519739826 * var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x28, 2)) + 0.001 * (0.0029999999999999996 / pow(var_x22, 3) + 0.00023800000000000004 / pow(var_x23, 3)) * (40.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 0.066000000000000003 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 0.00022799730679188537 * log(1.2 * var_x30) + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 1.7937848940989261e-5 * var_chaste_interface__membrane__V - var_x21 * (0.14000000000000001 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa) - var_x27 * (0.070000000000000007 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa) - var_x29 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 1.1055029865854122e-5 * var_x32 * var_x36 - 1.0 * var_x15 * var_x16) / pow(var_x24, 2)));
        ...
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = -(mDt * (1.2086402914563544e-10 * var_x38 + 0.091005005855711127 * var_x37));
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
