...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celldokos_model_1996FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[9], double rJacobian[9][9])
    {
        ...
        const double var_x3 = var_chaste_interface__T_type_calcium_current_d_gate__dT * var_chaste_interface__T_type_calcium_current_f_gate__fT;
        const double var_x4 = 0.0023533830328766889 * var_x3;
        const double var_x5 = var_x2 * var_chaste_interface__L_type_calcium_current_f2_gate__fL2;
        const double var_x6 = 0.011074743684125594 * var_x5;
        const double var_x7 = pow(var_chaste_interface__ion_concentrations__Cai, 2);
        const double var_x8 = 2.4999999999999999e-7 + var_x7;
        const double var_x9 = var_chaste_interface__ion_concentrations__Cai / var_x8;
        const double var_x10 = 0.0024000000000000002 * var_chaste_interface__ion_concentrations__Carel;
        const double var_x11 = 9.9999999999999995e-7 + var_x7;
        const double var_x12 = 1 / var_x11;
        const double var_x13 = var_x12 * var_chaste_interface__ion_concentrations__Cai;
        const double var_x14 = pow(var_chaste_interface__ion_concentrations__Cai, 3);
        const double var_x15 = var_x14 / pow(var_x8, 2);
        const double var_x16 = var_x14 / pow(var_x11, 2);
        const double var_x17 = 0.27300027300027302 * var_chaste_interface__ion_concentrations__Cao;
        const double var_x18 = exp(0);
        const double var_x19 = var_x17 * var_x18;
        const double var_x20 = pow(var_chaste_interface__ion_concentrations__Nao, 2);
        const double var_x21 = 2.3464309350494594e-7 * pow(var_chaste_interface__ion_concentrations__Nao, 3) + 1.094140745013563e-6 * var_x20;
        const double var_x22 = 1.0 + var_x17 + var_x19 + var_x21 + 0.00061425061425061424 * var_chaste_interface__ion_concentrations__Nao;
        const double var_x23 = 1 / var_x22;
        const double var_x24 = var_x19 * var_x23;
        const double var_x25 = 0.0080763619450073352 * var_chaste_interface__membrane__E;
        const double var_x26 = exp(var_x25);
        const double var_x27 = exp(-var_x25);
        ...
        const double var_x32 = 1 / (4.6630000000000003 + var_chaste_interface__ion_concentrations__Nao);
        const double var_x33 = var_x32 * var_chaste_interface__ion_concentrations__Nao;
        const double var_x34 = var_x23 * var_x27;
        const double var_x35 = var_x21 * var_x34;
        const double var_x36 = var_x24 + var_x35;
        const double var_x37 = var_x27 * var_x36;
        const double var_x38 = var_x33 * var_x37;
        const double var_x39 = var_x38 + var_x24 * var_x31;
        const double var_x40 = 48.309178743961354 * var_chaste_interface__ion_concentrations__Cai;
        const double var_x41 = exp(-0.0051246996536338544 * var_chaste_interface__membrane__E);
        const double var_x42 = var_x40 * var_x41;
        const double var_x43 = 1.8271247633873431 * var_chaste_interface__ion_concentrations__Nai;
        const double var_x44 = pow(var_chaste_interface__ion_concentrations__Nai, 2);
        const double var_x45 = pow(var_chaste_interface__ion_concentrations__Nai, 3);
        const double var_x46 = 0.0011051656880977081 * var_x44 + 4.1799004844845232e-5 * var_x45;
        const double var_x47 = 1 / (1.0 + var_x40 + var_x42 + var_x46 + 0.0025297242600556538 * var_chaste_interface__ion_concentrations__Nai + var_x43 * var_chaste_interface__ion_concentrations__Cai);
        const double var_x48 = 48.309178743961354 * var_x41;
        const double var_x49 = var_x47 * var_x48;
        const double var_x50 = 0.037821482602117998 * var_chaste_interface__ion_concentrations__Nai;
        const double var_x51 = var_x41 * var_chaste_interface__ion_concentrations__Cai;
        const double var_x52 = pow((0.0207 + var_x51 + 2.2876929743622558e-5 * var_x44 + 5.2365292183152033e-5 * var_chaste_interface__ion_concentrations__Nai + 8.6523940028829632e-7 * var_x45 + var_x50 * var_chaste_interface__ion_concentrations__Cai + var_chaste_interface__ion_concentrations__Cai), (-2));
        const double var_x53 = var_x52 * (-48.309178743961354 - var_x43 - var_x48);
        const double var_x54 = 0.0207 * var_x51;
        const double var_x55 = var_x53 * var_x54;
        const double var_x56 = var_x26 + var_x33;
        const double var_x57 = var_x27 * var_x56;
        const double var_x58 = var_x49 * var_x57;
        const double var_x59 = var_x55 * var_x57;
        const double var_x60 = 0.00042849000000000001 * var_x46;
        const double var_x61 = var_x26 * var_x60;
        const double var_x62 = var_x49 + var_x55 + var_x53 * var_x61;
        const double var_x63 = var_x26 * var_x29;
        const double var_x64 = var_x62 * var_x63;
        const double var_x65 = var_x24 * (var_x58 + var_x59 + var_x64) - var_x39 * var_x49 - var_x39 * var_x55;
        const double var_x66 = var_x42 * var_x47;
        const double var_x67 = var_x26 * var_x47;
        const double var_x68 = var_x46 * var_x67;
        const double var_x69 = var_x66 + var_x68;
        const double var_x70 = var_x35 * var_x69;
        const double var_x71 = var_x33 * var_x70;
        const double var_x72 = var_x36 * var_x68;
        const double var_x73 = var_x29 * var_x72;
        const double var_x74 = var_x56 * var_x68;
        const double var_x75 = var_x30 * var_x35;
        const double var_x76 = var_x26 * var_x69;
        const double var_x77 = var_x29 * var_x76;
        const double var_x78 = var_x77 + var_x57 * var_x66;
        const double var_x79 = 1 / (var_x39 + var_x71 + var_x73 + var_x78 + var_x24 * var_x74 + var_x66 * var_x75);
        const double var_x80 = 0.016582829838457897 * var_x79;
        const double var_x81 = var_x18 * var_chaste_interface__ion_concentrations__Cao;
        const double var_x82 = var_x23 * var_x81;
        const double var_x83 = 0.00011697788697788699 * var_x26 * var_x46 * var_x56 * var_x82;
        const double var_x84 = var_x36 * var_x60 * var_x63;
        const double var_x85 = var_x33 * var_x35;
        const double var_x86 = -var_x58 - var_x59 - var_x64 - var_x49 * var_x75 - var_x53 * var_x83 - var_x53 * var_x84 - var_x55 * var_x75 - var_x62 * var_x85;
        const double var_x87 = 0.0056511056511056512 * var_x82;
        const double var_x88 = var_x47 * var_x51;
        const double var_x89 = (var_x24 * var_x78 - var_x39 * var_x66) / pow((0.0207 * var_x38 + 0.0207 * var_x71 + 0.0207 * var_x73 + 0.0207 * var_x77 + var_x31 * var_x87 + var_x57 * var_x88 + var_x74 * var_x87 + var_x75 * var_x88), 2);
        const double var_x90 = 7.1055767574808238e-6 * var_x89;
        const double var_x91 = 1 / var_chaste_interface__ion_concentrations__Cao;
        const double var_x92 = 0.27300027300027302 * var_x18;
        const double var_x93 = var_x23 * var_x92;
        const double var_x94 = pow(var_x22, (-2));
        const double var_x95 = var_x94 * (-0.27300027300027302 - var_x92);
        const double var_x96 = var_x19 * var_x95;
        const double var_x97 = var_x31 * var_x93;
        const double var_x98 = var_x31 * var_x96;
        const double var_x99 = var_x21 * var_x27;
        const double var_x100 = var_x95 * var_x99;
        const double var_x101 = var_x100 + var_x93 + var_x96;
        const double var_x102 = var_x27 * var_x33;
        const double var_x103 = var_x101 * var_x102;
        const double var_x104 = var_x78 * var_x93 + var_x78 * var_x96 - var_x66 * (var_x103 + var_x97 + var_x98);
        const double var_x105 = var_x30 * var_x66;
        const double var_x106 = var_x33 * var_x69;
        const double var_x107 = var_x29 * var_x68;
        const double var_x108 = -var_x103 - var_x97 - var_x98 - var_x100 * var_x105 - var_x100 * var_x106 - var_x101 * var_x107 - var_x74 * var_x93 - var_x74 * var_x96;
        const double var_x109 = var_x12 * var_x7;
        const double var_x110 = 0.0014304645462223146 * var_chaste_interface__ion_concentrations__Nai / pow((1 + var_x50), 2);
        const double var_x111 = var_x28 - var_x110;
        const double var_x112 = 0.0022103313761954162 * var_chaste_interface__ion_concentrations__Nai;
        const double var_x113 = 0.0001253970145345357 * var_x44;
        const double var_x114 = var_x52 * (-0.0025297242600556538 - var_x112 - var_x113 - 1.8271247633873431 * var_chaste_interface__ion_concentrations__Cai);
        const double var_x115 = var_x114 * var_x54;
        const double var_x116 = var_x115 * var_x57;
        const double var_x117 = var_x28 * var_x76;
        const double var_x118 = var_x110 * var_x76;
        const double var_x119 = var_x67 * (var_x112 + var_x113);
        const double var_x120 = var_x115 + var_x119 + var_x114 * var_x61;
        const double var_x121 = var_x120 * var_x63;
        const double var_x122 = var_x24 * (var_x116 + var_x117 + var_x121 - var_x118) - var_x115 * var_x39 - 13.188418985520435 * var_x111 * var_x51 * var_x67 * var_x82;
        const double var_x123 = var_x118 - var_x116 - var_x117 - var_x121 + var_x110 * var_x72 - var_x114 * var_x83 - var_x114 * var_x84 - var_x115 * var_x75 - var_x120 * var_x85 - var_x28 * var_x72 - var_x111 * var_x24 * var_x26 - var_x111 * var_x35 * var_x66 - var_x119 * var_x24 * var_x56 - var_x119 * var_x29 * var_x36;
        const double var_x124 = 0.045990609913211578 * var_chaste_interface__ion_concentrations__Nao / pow((1 + 0.2144542140253056 * var_chaste_interface__ion_concentrations__Nao), 2);
        const double var_x125 = var_x32 - var_x124;
        const double var_x126 = 2.1882814900271261e-6 * var_chaste_interface__ion_concentrations__Nao;
        const double var_x127 = 7.0392928051483781e-7 * var_x20;
        const double var_x128 = var_x94 * (-0.00061425061425061424 - var_x126 - var_x127);
        const double var_x129 = var_x128 * var_x19;
        const double var_x130 = var_x129 * var_x31;
        const double var_x131 = var_x32 * var_x37;
        const double var_x132 = var_x124 * var_x37;
        const double var_x133 = var_x34 * (var_x126 + var_x127);
        const double var_x134 = var_x128 * var_x99;
        const double var_x135 = var_x129 + var_x133 + var_x134;
        const double var_x136 = var_x102 * var_x135;
        const double var_x137 = var_x129 * var_x78 - var_x66 * (var_x130 + var_x131 + var_x136 - var_x132) + 13.188418985520435 * var_x125 * var_x34 * var_x81 * var_x88;
        const double var_x138 = var_x132 - var_x130 - var_x131 - var_x136 + var_x124 * var_x70 - var_x105 * var_x133 - var_x105 * var_x134 - var_x106 * var_x133 - var_x106 * var_x134 - var_x107 * var_x135 - var_x129 * var_x74 - var_x32 * var_x70 - var_x125 * var_x24 * var_x68 - var_x125 * var_x27 * var_x66;
        const double var_x139 = 0.011766915164383444 * var_x3;
        const double var_x140 = 0.055373718420627965 * var_x5;
        const double var_x141 = 0.082914149192289482 * var_x79;
        const double var_x142 = 3.5527883787404114e-5 * var_x89;
        ...
        const double var_x154 = var_x150 * pow(var_chaste_interface__ion_concentrations__Ko, 0.83000000000000007);
        const double var_x155 = -var_x153 * var_chaste_interface__ion_concentrations__Ko + var_chaste_interface__ion_concentrations__Ki;
        ...
        const double var_x161 = 1.0 + var_chaste_interface__ion_concentrations__Ko;
        const double var_x162 = 1 / var_x161;
        const double var_x163 = 1 / (40.0 + var_chaste_interface__ion_concentrations__Nai);
        const double var_x164 = 1.0 - 0.035938096628557313 * pow((-1 + 0.025000000000000001 * var_chaste_interface__membrane__E), 2);
        const double var_x165 = var_x162 * var_x163 * var_x164;
        const double var_x166 = 0.0018738597717457425 * var_x165;
        const double var_x167 = pow(var_chaste_interface__ion_concentrations__Ko, 2.6600000000000001) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow((1 + 0.014012250051496243 * var_x149), 2);
        const double var_x168 = var_x159 * var_x167;
        const double var_x169 = var_x164 * var_chaste_interface__ion_concentrations__Ko * var_chaste_interface__ion_concentrations__Nai;
        const double var_x170 = var_x163 * var_x169 / pow(var_x161, 2);
        const double var_x171 = var_x162 * var_x169 / pow((1 + 0.025000000000000001 * var_chaste_interface__ion_concentrations__Nai), 2);
        const double var_x172 = 1.4509976108650658e-6 * var_x144;
        const double var_x173 = 5.3894196974988154e-6 * var_x146;
        const double var_x174 = 0.0093692988587287113 * var_x165;
        const double var_x175 = 0.049748489515373688 * var_x79;
        const double var_x176 = 2.1316730272442473e-5 * var_x89;
        ...
        const double var_x181 = 0.0028107896576186134 * var_x165;
        const double var_x182 = var_x167 * var_x179;
        ...
        const double var_x188 = 0.24874244757686845 * var_x79;
        const double var_x189 = 0.00010658365136221236 * var_x89;
        const double var_x190 = 0.014053948288093067 * var_x165;
        ...
        rJacobian[1][1] = 1.0 - (mDt * (8.7888998143826851e-5 * var_x15 - 8.7888998143826851e-5 * var_x9 + var_x10 * var_x13 + var_x65 * var_x80 + var_x86 * var_x90 - var_x0 * var_x4 - var_x0 * var_x6 - var_x10 * var_x16));
        rJacobian[1][2] = -(mDt * (var_x104 * var_x80 + var_x108 * var_x90 + var_x4 * var_x91 + var_x6 * var_x91));
        rJacobian[1][3] = -(mDt * (0.0012000000000000001 * var_x109));
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[1][7] = -(mDt * (var_x122 * var_x80 + var_x123 * var_x90));
        rJacobian[1][8] = -(mDt * (var_x137 * var_x80 + var_x138 * var_x90));
        ...
        rJacobian[2][1] = -(mDt * (var_x0 * var_x139 + var_x0 * var_x140 - var_x141 * var_x65 - var_x142 * var_x86));
        rJacobian[2][2] = 1.0 - (mDt * (-0.01 - var_x104 * var_x141 - var_x108 * var_x142 - var_x139 * var_x91 - var_x140 * var_x91));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = -(mDt * (-var_x122 * var_x141 - var_x123 * var_x142));
        rJacobian[2][8] = -(mDt * (-var_x137 * var_x141 - var_x138 * var_x142));
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = -(mDt * (var_x143 * var_x16 - var_x13 * var_x143));
        rJacobian[3][2] = 0.0;
        ...
        rJacobian[3][8] = 0.0;
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = -(mDt * (0.0062777855817019177 * var_x9 - 0.0062777855817019177 * var_x15));
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        ...
        rJacobian[5][6] = -(mDt * (0.001495090397356955 * var_x154 + 2.0109407222017218e-8 * var_x168 - 1.189818040909354e-7 * var_x156 - 6.3595152430486023e-7 * var_x158 - 0.00010241970278977559 * var_x160 - 0.0018738597717457425 * var_x170 + var_x145 * var_x153 + var_x147 * var_x153 + var_x166 * var_chaste_interface__ion_concentrations__Nai));
        rJacobian[5][7] = -(mDt * (-1.171162357341089e-6 * var_x171 + var_x166 * var_chaste_interface__ion_concentrations__Ko));
        rJacobian[5][8] = 0.0;
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        ...
        rJacobian[6][6] = 1.0 - (mDt * (-0.01 + 5.9490902045467693e-7 * var_x156 + 0.0093692988587287113 * var_x170 + 0.00051209851394887792 * var_x160 + 3.179757621524301e-6 * var_x158 - 1.0054703611008608e-7 * var_x168 - 0.0074754519867847747 * var_x154 - var_x153 * var_x172 - var_x153 * var_x173 - var_x174 * var_chaste_interface__ion_concentrations__Nai));
        rJacobian[6][7] = -(mDt * (5.8558117867054447e-6 * var_x171 - var_x174 * var_chaste_interface__ion_concentrations__Ko));
        rJacobian[6][8] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = -(mDt * (-var_x175 * var_x65 - var_x176 * var_x86));
        rJacobian[7][2] = -(mDt * (-var_x104 * var_x175 - var_x108 * var_x176));
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = -(mDt * (1.206564433321033e-8 * var_x182 + 0.0028107896576186134 * var_x170 - 2.2258303350670112e-8 * var_x177 - 6.1451821673865346e-5 * var_x180 - var_x181 * var_chaste_interface__ion_concentrations__Nai));
        ...
        rJacobian[8][0] = 0.0;
        rJacobian[8][1] = -(mDt * (var_x188 * var_x65 + var_x189 * var_x86));
        rJacobian[8][2] = -(mDt * (var_x104 * var_x188 + var_x108 * var_x189));
        rJacobian[8][3] = 0.0;
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = -(mDt * (0.00030725910836932674 * var_x180 + 1.1129151675335055e-7 * var_x177 - 0.014053948288093067 * var_x170 - 6.0328221666051643e-8 * var_x182 + var_x190 * var_chaste_interface__ion_concentrations__Nai));
