...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celllivshitz_rudy_2007FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        const double var_x29 = exp(-0.031820500981632228 * var_chaste_interface__cell__V);
        ...
        const double var_x42 = exp(0.074871767015605231 * var_chaste_interface__cell__V);
        ...
        const double var_x89 = 1 / (var_x31 * (1.0 + 1.5 / mParameters[5]) * pow((0.01 + 1 / var_x49), 2) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[6])) * exp(-var_x32)));
        ...
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * ((-3.2165331512873877e-8 * var_x88 - 0.001643362921287705 * var_x87 - 9.0713633255081308e-6 * var_x70 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V)) + 0.00012902872996250477 * var_x82 * var_x85 * var_x86 - 0.0005410009642033744 * var_x74 * var_x82 * var_x84 - 0.00070719080288022792 * var_x84 * mParameters[11] * var_chaste_interface__IKr__xr / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__cell__V)) - 1.9466406260598248e-5 * var_x74 * var_x86 * (6.4983106368865622 * var_x85 - var_x77 * (1.053972635420138 * var_x70 * var_x79 + 1.6494869150645177 * var_x70 * var_x78) - 13.738155796237757 * var_x70 * var_x75 * var_x80 / pow(var_x76, 2)) / pow((var_x74 + 0.98039215686274506 * var_x81), 2)) * mParameters[3]));
