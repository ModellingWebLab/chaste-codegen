...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x46 = 0.018329999999999999 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki;
        const double var_x47 = var_x45 * (0.15315014533948793 * var_chaste_interface__Ionic_concentrations__Ki + 0.0028072421640728137 * var_chaste_interface__Ionic_concentrations__Nai) / pow(var_x46, 2);
        ...
        const double var_x65 = 0.042999999999999997 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki;
        ...
        const double var_x68 = mParameters[2] * var_chaste_interface__IKr_Xr_gate__Xr / (1.0 + exp(1.1304347826086956 + 0.043478260869565216 * var_chaste_interface__cell__V));
        const double var_x69 = 0.00019322513682643524 * var_x36;
        const double var_x70 = 1 / var_chaste_interface__Ionic_concentrations__Nai;
        const double var_x71 = pow(var_x70, 1.5);
        const double var_x72 = 1 / (1.0 + 0.1245 * exp(-0.0037417087259575582 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0505200594353643)) * exp(-0.037417087259575585 * var_chaste_interface__cell__V));
        ...
        rJacobian[8][0] = 0.0;
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = -(mDt * (((var_x77) ? (-var_x37 * (var_x35 + 235.7603210147127 * var_x28)) : (0))));
        rJacobian[8][3] = 0.0;
