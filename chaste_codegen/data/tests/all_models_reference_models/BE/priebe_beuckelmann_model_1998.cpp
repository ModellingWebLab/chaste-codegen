...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x32 = log(10);
        const double var_x33 = var_x32 * log10(2.0 * var_x28);
        const double var_x34 = 0.00059999999999999995 * var_chaste_interface__cell__V - 0.0080177272463458679 * var_x33;
        const double var_x35 = 0.011358446932323314 * var_x28 + 0.0080177272463458679 * var_x28 * var_x31 - var_x30 * var_x34 / pow(var_x29, 2);
        const double var_x36 = 1 / M_PI;
        const double var_x37 = 9.661256841321762e-5 * var_x36;
        const double var_x38 = exp(0.013095980540851452 * var_chaste_interface__cell__V);
        const double var_x39 = var_x26 * (2.0 * var_x38 * pow(var_chaste_interface__Ionic_concentrations__Nai, 3) - 2628072.0 * var_x25 * var_chaste_interface__Ionic_concentrations__Cai);
        const double var_x40 = -0.011358446932323314 * var_x33 + var_x31 * var_x34;
        const double var_x41 = var_x26 * var_x38 * pow(var_chaste_interface__Ionic_concentrations__Nai, 2);
        const double var_x42 = var_x36 * var_x41;
        const double var_x43 = var_x22 * (0.0070588235294117632 * var_chaste_interface__Ionic_concentrations__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__Ionic_concentrations__Cai);
        ...
        const double var_x48 = var_x32 * log10(4.0 * var_x47);
        const double var_x49 = exp(-12.0 + 0.059999999999999998 * var_chaste_interface__cell__V - 1.6035454492691736 * var_x48);
        const double var_x50 = 1.0 + var_x49;
        const double var_x51 = 1 / var_x50;
        const double var_x52 = exp(13.36287874390978 * var_x48 - 0.5 * var_chaste_interface__cell__V);
        const double var_x53 = 1.0 + var_x52;
        const double var_x54 = 1 / var_x53;
        const double var_x55 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__cell__V - 0.0053451514975639122 * var_x48);
        const double var_x56 = exp(-1.0 + 0.10000000000000001 * var_chaste_interface__cell__V - 2.6725757487819561 * var_x48);
        ...
        const double var_x61 = 1 / (0.042999999999999997 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki);
        const double var_x62 = var_chaste_interface__Ito_r_gate__r * var_chaste_interface__Ito_t_gate__t;
        const double var_x63 = var_x61 * var_x62;
        const double var_x64 = var_x47 * var_x49 / pow(var_x50, 2);
        const double var_x65 = -26.725757487819561 * var_x48 + var_chaste_interface__cell__V;
        const double var_x66 = 0.25 * var_x65;
        const double var_x67 = mParameters[2] * var_chaste_interface__IKr_Xr_gate__Xr / (1.0 + exp(1.1304347826086956 + 0.043478260869565216 * var_chaste_interface__cell__V));
        const double var_x68 = 0.00019322513682643524 * var_x36;
        const double var_x69 = 1 / var_chaste_interface__Ionic_concentrations__Nai;
        const double var_x70 = pow(var_x69, 1.5);
        const double var_x71 = 1 / (1.0 + 0.1245 * exp(-0.0037417087259575582 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0505200594353643)) * exp(-0.037417087259575585 * var_chaste_interface__cell__V));
        const double var_x72 = var_x69 * var_x70 * var_x71 / pow((0.031622776601683791 + var_x70), 2);
        const double var_x73 = pow(var_chaste_interface__INa_m_gate__m, 3) * mParameters[1] * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j;
        const double var_x74 = 26.725757487819561 * var_x32;
        const double var_x75 = log10(138.0 * var_x69);
        ...
        rJacobian[2][2] = 1.0 - (mDt * (var_x22 * (-var_x23 - var_x24 + 0.00036529411764705876 * var_x18 - var_x37 * (var_x35 + 471.5206420294254 * var_x27)) + (0.00023800000000000004 / pow(var_x19, 3) + 7.0000000000000007e-5 / pow(var_x20, 3)) * (0.0070588235294117632 * var_x11 + 2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR - var_x24 * var_chaste_interface__Ionic_concentrations__Cai - var_x37 * (var_x40 + 0.00084999999999999995 * var_chaste_interface__cell__V - 0.00017941694216498839 * var_x39)) / pow(var_x21, 2)));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = -(mDt * (1.040035895964315e-7 * var_x22 * var_x42));
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = -(mDt * (var_x12 * var_x43));
        rJacobian[2][7] = 0.0;
        rJacobian[2][8] = -(mDt * (var_x15 * var_x43));
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = 0.0;
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (-var_x68 * (0.53451514975639125 * var_x46 + 8.0177272463458689 * var_x63 + 6.681439371954891 * var_x47 * var_x60 + 26.725757487819561 * var_x47 * var_x67 - 0.40088636231729341 * var_x59 * var_x64 * var_x65 + var_x51 * var_x66 * (0.16035454492691736 * var_x64 - var_x54 * (2.6725757487819561 * var_x47 * var_x56 + 0.016035454492691736 * var_x47 * var_x55) - 13.36287874390978 * var_x47 * var_x52 * var_x57 / pow(var_x53, 2)) / pow(var_x58, 2))));
        rJacobian[3][4] = -(mDt * (-var_x68 * (0.00979766269503465 * var_x46 + 0.34476227159287232 * var_x63 - 0.089693693633866756 * var_x72)));
        rJacobian[3][5] = 0.0;
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = 0.0;
        ...
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = -(mDt * (0.13666446085893647 * var_x27 * var_x36));
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-var_x68 * (0.026725757487819562 * var_x69 + 0.0016147524794848955 * var_x41 + 0.13454054045080013 * var_x72 + 26.725757487819561 * var_x69 * var_x73)));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        ...
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (((var_x40 + 0.0018500000000000001 * var_chaste_interface__cell__V + 8.9708471082494196e-5 * var_x39 + var_x60 * var_x66 + 1.0 * var_x65 * var_x67 + 1.0 * var_x73 * (-var_x74 * var_x75 + var_chaste_interface__cell__V) + 1.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() + 0.29999999999999999 * var_x62 * (-var_x74 * log10(9.9339999999999993 * var_x61) + var_chaste_interface__cell__V) + 0.02 * var_x45 * (-var_x74 * log10(6.5295399999999999 * var_x44) + var_chaste_interface__cell__V) + 0.94545454545454544 * var_x71 / (1.0 + 31.622776601683793 * var_x70) - 0.026725757487819562 * var_x32 * var_x75 < -150.0) ? (-100.5) : (-0.5))));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        ...
        rJacobian[8][0] = 0.0;
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = -(mDt * (((var_x77) ? (-var_x37 * (var_x35 + 235.7603210147127 * var_x27)) : (0))));
        rJacobian[8][3] = 0.0;
        rJacobian[8][4] = -(mDt * (((var_x77) ? (5.200179479821575e-8 * var_x42) : (0))));
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
