...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        ...
        const double var_x65 = 1 / (1.0 + exp(8.6666666666666661 + 0.33333333333333331 * var_chaste_interface__Membrane__Vm_converted));
        ...
        const double var_x75 = mParameters[12] / var_chaste_interface__sodium_dynamics__Nai;
        const double var_x76 = mParameters[2] / ((1.0 + mParameters[2]) * (1.0 + 0.035299999999999998 * exp(-11.604506155051096 * var_x34) + 0.1245 * exp(-1.1604506155051095 * var_x34)));
        ...
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * ((-51939119025.283607 * var_x58 - 91.342277453381911 * var_x75 - 6506254.4429941392 * var_x76 / (40.0 + var_chaste_interface__sodium_dynamics__Nai) + 4066.4090268713371 * var_x76 * var_chaste_interface__sodium_dynamics__Nai / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Nai), 2) - 101.49141939264658 * var_x75 * pow(var_chaste_interface__i_Na_m_gate__m, 3) * mParameters[5] * var_chaste_interface__i_Na_h_gate__h * var_chaste_interface__i_Na_j_gate__j) * mParameters[11]));
    }
