...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut::Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut::~Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut()
    {
    }

    
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rResidual[32])
    {
    ...
    void Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rJacobian[32][32])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -85.721630473733
    ...
    void Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        CardiacNewtonSolver<32,Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<32,Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellshannon_wang_puglisi_weber_bers_2004FromCellMLBackwardEulerNoLut>::Initialise(void)
{
