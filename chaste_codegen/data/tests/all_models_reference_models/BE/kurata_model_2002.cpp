...
#include "CardiacNewtonSolver.hpp"
    ...
    double Cellkurata_model_2002FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        // Units: dimensionless; Initial value: 000602055134
        ...
        // Units: dimensionless; Initial value: 004571884917
        ...
        // Units: dimensionless; Initial value: 054409723782
        ...
        // Units: dimensionless; Initial value: 005550489445
        double var_chaste_interface__hyperpolarisation_activated_current_y_gate__y = rY[12];
        // Units: dimensionless; Initial value: 067156687129
        ...
        // Units: millimolar; Initial value: 00019074741
        ...
        const double var_AP_sensitive_currents__g_sus = 02; // nanoS
        ...
        const double var_background_muscarinic_potassium_channel_current__g_K_ACh = 0011000000000000001 * pow(var_intracellular_ion_concentrations__Ko, 0.40999999999999998); // picoA
        const double var_intracellular_ion_concentrations__Nao = 140; // millimolar
        const double var_membrane__F = 96485000000000000; // femtocoulomb_per_millimole
        const double var_membrane__R = 8314400000000000; // attojoule_per_millimole_kelvin
        ...
        const double var_rapidly_activating_delayed_rectifier_potassium_current__g_Kr = 025000000000000001 * pow(var_intracellular_ion_concentrations__Ko, 0.58999999999999997); // nanoS
        ...
        const double var_slowly_activating_delayed_rectifier_potassium_current__g_Ks = 025899999999999999; // nanoS
        ...
        const double var_sodium_dependent_background_current__g_b_Na = 0054000000000000003; // nanoS
        ...
        const double var_sodium_potassium_pump_current__i_NaK = var_sodium_potassium_pump_current__i_NaK_max / ((1.0 + pow((var_sodium_potassium_pump_current__Km_Kp / var_intracellular_ion_concentrations__Ko), 1.2)) * (1.0 + pow((var_sodium_potassium_pump_current__Km_Nap / var_chaste_interface__intracellular_ion_concentrations__Nai), 1.3)) * (1.0 + exp(-4.0 + 033333333333333333 * var_reversal_potentials__E_Na - 033333333333333333 * var_chaste_interface__membrane__V))); // picoA
        const double var_sustained_inward_current__E_st = 37.399999999999999; // millivolt
        const double var_sustained_inward_current__g_st = 014999999999999999; // nanoS
    ...
    void Cellkurata_model_2002FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[13], double rResidual[13])
    {
        ...
        const double var_L_type_calcium_channel_current__E_CaL = 45.0; // millivolt
        const double var_L_type_calcium_channel_current__g_CaL = 0.57999999999999996; // nanoS
        const double var_L_type_calcium_channel_current_fCa_gate__Km_fCa = 00035; // millimolar
        const double var_L_type_calcium_channel_current_fCa_gate__beta_fCa = 60; // per_millimolar_millisecond
        ...
        const double var_T_type_calcium_channel_current__E_CaT = 45.0; // millivolt
        const double var_T_type_calcium_channel_current__g_CaT = 0.45800000000000002; // nanoS
        const double var_calcium_buffering__CM_tot = 044999999999999998; // dimensionless
        const double var_calcium_buffering__CQ_tot = 10; // dimensionless
        const double var_calcium_buffering__TC_tot = 031; // dimensionless
        const double var_calcium_buffering__TMC_tot = 062; // dimensionless
        ...
        const double var_calcium_buffering__kb_TMC = 0075100000000000002; // per_millisecond
        ...
        const double var_hyperpolarisation_activated_current__g_h_K = 0.23126250000000001; // nanoS
        const double var_hyperpolarisation_activated_current__g_h_Na = 0.14373749999999999; // nanoS
        const double var_intracellular_calcium_dynamics__K_rel = 0011999999999999999; // millimolar
        const double var_intracellular_calcium_dynamics__K_up = 00059999999999999995; // millimolar
        const double var_intracellular_calcium_dynamics__P_rel = 0.5; // per_millisecond
        const double var_intracellular_calcium_dynamics__P_up = 0050000000000000001; // millimolar_per_millisecond
        const double var_intracellular_calcium_dynamics__tau_dif_Ca = 040000000000000001; // millisecond
        const double var_intracellular_calcium_dynamics__tau_tr = 60; // millisecond
    ...
    void Cellkurata_model_2002FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x0 = 60 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x1 = 00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        ...
        const double var_x7 = 060150151005755319 * var_x4;
        const double var_x8 = exp(-0051222473865587953 * var_chaste_interface__membrane__V);
        const double var_x9 = 037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai;
        ...
        const double var_x14 = 1 / (1.0 + 48.309178743961354 * var_x11 + 0025297242600556538 * var_x13);
        const double var_x15 = 48.309178743961354 * var_x8;
        const double var_x16 = var_x14 * var_x15;
        const double var_x17 = pow((0207 + var_x11 + 5.2365292183152033e-5 * var_x13), (-2));
        ...
        const double var_x20 = 0207 * var_x19;
        ...
        const double var_x23 = 0080724972509135153 * var_chaste_interface__membrane__V;
        ...
        const double var_x52 = 0011051656880977081 * var_x10;
        ...
        const double var_x69 = 1 / (var_x47 + var_x68 + 00060342106912241779 * var_x65 + 0.64386064857757164 * var_x54 + var_x52 * var_x58 + var_x59 * var_x61);
        const double var_x70 = 036912022524200436 * var_x69;
        const double var_x71 = 0.64386064857757164 * var_x41;
        const double var_x72 = 013771830208622637 * var_x19 * var_x41 * var_x45;
        ...
        const double var_x76 = (var_x40 * var_x68 - var_x47 * var_x49) / pow((0207 * var_x67 + 020032765807428299 * var_x44 + 1.2490816130834047e-5 * var_x65 + 013327915425555734 * var_x54 + var_x34 * var_x59 + 2.2876929743622558e-5 * var_x10 * var_x58 + 011302211302211302 * var_x46 * var_x63 + var_x42 * var_x45 * var_x59), 2);
        const double var_x77 = 1.5816432531394641e-5 * var_x76;
        const double var_x78 = var_x28 * var_x66;
        const double var_x79 = var_x17 * (-0025297242600556538 - 0011051656880977081 * var_x12 - 1.8271247633873431 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub - (0011051656880977081 + 8.3598009689690465e-5 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai);
        const double var_x80 = var_x20 * var_x79;
        const double var_x81 = var_x12 * var_x50;
        const double var_x82 = var_x80 + 0022103313761954162 * var_x81 + 4.1799004844845232e-5 * var_x51 + var_x26 * var_x79;
        const double var_x83 = var_x30 * var_x82;
        const double var_x84 = pow((1 + var_x9), (-2));
        const double var_x85 = 0014304645462223146 * var_x84 * var_chaste_interface__intracellular_ion_concentrations__Nai;
        ...
        const double var_x90 = var_x86 - var_x78 - var_x83 - var_x87 - 4.1799004844845232e-5 * var_x58 - var_x71 * var_x82 - var_x72 * var_x79 - var_x73 * var_x79 - var_x74 * var_x79 - 0033154970642931239 * var_x55 * var_x62 - 0012068421382448356 * var_x64 * var_x81 - 2.2822279467564968e-5 * var_x51 * var_x64 - var_x24 * var_x40 * var_x88 - var_x59 * var_x60 * var_x88 + 1.5809003345251601e-6 * var_x10 * var_x43 * var_x57 * var_x84;
        const double var_x91 = 1 / (pow((1.0 + 00059999999999999995 / var_chaste_interface__intracellular_ion_concentrations__Cai), 2) * pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 2));
        ...
        rJacobian[0][6] = 0;
        rJacobian[0][7] = 0;
        rJacobian[0][8] = -(mDt * (021000000000000001 / var_x1 - 60 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa - 00035 * (021000000000000001 + var_x0) / pow(var_x1, 2)));
        rJacobian[0][9] = 0;
        rJacobian[0][10] = 0;
        rJacobian[0][11] = 0;
        rJacobian[0][12] = 0;
        ...
        rJacobian[5][3] = 0;
        rJacobian[5][4] = 0;
        rJacobian[5][5] = 1.0 - (mDt * (-0075100000000000002 + var_x2));
        ...
        rJacobian[7][9] = -(mDt * (016666666666666666));
        rJacobian[7][10] = 0;
        rJacobian[7][11] = 0;
        rJacobian[7][12] = 0;
        rJacobian[8][0] = -(mDt * (00014764809009680174 * (26.099999999999998 - 0.57999999999999996 * var_chaste_interface__membrane__V) * var_chaste_interface__L_type_calcium_channel_current_d_gate__d * var_chaste_interface__L_type_calcium_channel_current_f_gate__f * mParameters[0]));
        rJacobian[8][1] = 0;
        rJacobian[8][2] = -(mDt * (024390000000000002 + 10.246499999999999 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub));
        rJacobian[8][3] = 0;
        rJacobian[8][4] = 0;
        rJacobian[8][5] = 0;
        rJacobian[8][6] = 0;
        ...
        rJacobian[9][5] = 0;
        rJacobian[9][6] = 0;
        rJacobian[9][7] = -(mDt * (0017241196262903437));
        rJacobian[9][8] = 0;
        rJacobian[9][9] = 1.0 - (mDt * (-0017241196262903437));
        rJacobian[9][10] = -(mDt * (2.9999999999999997e-6 * var_x91));
        rJacobian[9][11] = 0;
        rJacobian[9][12] = 0;
        rJacobian[10][0] = 0;
        rJacobian[10][1] = -(mDt * (024390000000000002 + 10.246499999999999 * var_chaste_interface__intracellular_ion_concentrations__Cai));
        rJacobian[10][2] = 0;
        rJacobian[10][3] = 0;
        rJacobian[10][4] = -(mDt * (013826 + 2.7527999999999997 * var_chaste_interface__intracellular_ion_concentrations__Cai));
        rJacobian[10][5] = -(mDt * (00046562000000000003 + var_x92));
        ...
        rJacobian[11][9] = 0;
        rJacobian[11][10] = 0;
        rJacobian[11][11] = 1.0 - (mDt * ((-1.406291416773793e-8 - 3.4227414451683221e-6 * var_x94 - 9.8400393807144087e-5 * var_x96 - 3.0804673006514896e-5 * var_x94 * var_chaste_interface__AP_sensitive_currents_q_gate__q - 3.9577587173161957e-5 * var_x93 * var_x95 + 0001711370722584161 * var_x93 * (-040569866382531065 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF - 027046577588354045 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy) * mParameters[0]));
    ...
    void Cellkurata_model_2002FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_AP_sensitive_currents_q_gate__q_infinity = 1.0 / (1.0 + exp(3.7692307692307692 + 076923076923076927 * var_chaste_interface__membrane__V));
        const double var_AP_sensitive_currents_q_gate__tau_q = 6.0599999999999996 + 39.101999999999997 / (065000000000000002 * exp(4.593 + 0.10000000000000001 * var_chaste_interface__membrane__V) + 0.56999999999999995 * exp(-3.52 - 080000000000000002 * var_chaste_interface__membrane__V));
        const double var_AP_sensitive_currents_r_gate__r_infinity = 1.0 / (1.0 + exp(1.2866666666666666 - 066666666666666666 * var_chaste_interface__membrane__V));
        const double var_AP_sensitive_currents_r_gate__tau_r = 2.75352 + 14.40516 / (1.0369999999999999 * exp(2.7548999999999997 + 089999999999999997 * var_chaste_interface__membrane__V) + 0.36899999999999999 * exp(-2.8607999999999998 - 0.12 * var_chaste_interface__membrane__V));
        const double var_L_type_calcium_channel_current_d_gate__alpha_d = -028389999999999999 * (35.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)) - 084900000000000003 * var_chaste_interface__membrane__V / (-1.0 + exp(-0.20798668885191349 * var_chaste_interface__membrane__V));
        const double var_L_type_calcium_channel_current_d_gate__beta_d = 011429999999999999 * (-5.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V));
        ...
        const double var_L_type_calcium_channel_current_f_gate__tau_f = 44.299999999999997 + 257.10000000000002 * exp(-5.4668495419491743 * pow((1 + 030769230769230771 * var_chaste_interface__membrane__V), 2));
        ...
        const double var_T_type_calcium_channel_current_d_gate__tau_d = 1.0 / (1.0680000000000001 * exp(0.87666666666666671 + 033333333333333333 * var_chaste_interface__membrane__V) + 1.0680000000000001 * exp(-0.87666666666666671 - 033333333333333333 * var_chaste_interface__membrane__V));
        ...
        const double var_T_type_calcium_channel_current_f_gate__tau_f = 1.0 / (014999999999999999 * exp(4.0117035110533159 + 065019505851755519 * var_chaste_interface__membrane__V) + 015299999999999999 * exp(-0.74069627851140463 - 012004801920768308 * var_chaste_interface__membrane__V));
        const double var_hyperpolarisation_activated_current_y_gate__tau_y = 0.71665290000000004 / (exp(-8.5404617897664554 - 022074080614542406 * var_chaste_interface__membrane__V) + exp(-3.8001143986272159 + 051999376007487906 * var_chaste_interface__membrane__V));
        const double var_hyperpolarisation_activated_current_y_gate__y_infinity = 1.0 / (1.0 + exp(4.7407407407407405 + 07407407407407407 * var_chaste_interface__membrane__V));
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__pa_infinity = 1.0 / (1.0 + exp(-2.1886792452830188 - 094339622641509441 * var_chaste_interface__membrane__V));
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__tau_paF = 0.84655354000000005 / (037199999999999997 * exp(062893081761006289 * var_chaste_interface__membrane__V) + 00096000000000000002 * exp(-044444444444444446 * var_chaste_interface__membrane__V));
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__tau_paS = 0.84655354000000005 / (0041999999999999997 * exp(058823529411764705 * var_chaste_interface__membrane__V) + 00014999999999999999 * exp(-046296296296296294 * var_chaste_interface__membrane__V));
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__pi_infinity = 1.0 / (1.0 + exp(1.672514619883041 + 058479532163742687 * var_chaste_interface__membrane__V));
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__tau_pi = 1.0 / (0.10000000000000001 * exp(-018299935950224173 * var_chaste_interface__membrane__V) + 0.65600000000000003 * exp(009420009985210585 * var_chaste_interface__membrane__V));
        const double var_slowly_activating_delayed_rectifier_potassium_current_n_gate__alpha_n = 014 / (1.0 + exp(4.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane__V));
        const double var_slowly_activating_delayed_rectifier_potassium_current_n_gate__beta_n = 001 * exp(-022222222222222223 * var_chaste_interface__membrane__V);
        ...
        const double var_sustained_inward_current_qa_gate__alpha_qa = 1.0 / (0.20000000000000001 * exp(-0014285714285714286 * var_chaste_interface__membrane__V) + 0.14999999999999999 * exp(-090909090909090912 * var_chaste_interface__membrane__V));
        const double var_sustained_inward_current_qa_gate__beta_qa = 1.0 / (16.0 * exp(0.125 * var_chaste_interface__membrane__V) + 15.0 * exp(02 * var_chaste_interface__membrane__V));
        ...
        const double var_sustained_inward_current_qi_gate__alpha_qi = 1.0 / (700 * exp(014285714285714285 * var_chaste_interface__membrane__V) + 3100 * exp(076923076923076927 * var_chaste_interface__membrane__V));
        const double var_sustained_inward_current_qi_gate__beta_qi = 1.0 / (50 * exp(-0014285714285714286 * var_chaste_interface__membrane__V) + 95.0 * exp(-0.10000000000000001 * var_chaste_interface__membrane__V)) + 00022900000000000001 / (1.0 + exp(-0.20000000000000001 * var_chaste_interface__membrane__V));
...
void OdeSystemInformation<Cellkurata_model_2002FromCellMLBackwardEuler>::Initialise(void)
{
    ...
    this->mInitialConditions.push_back(000602055134);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(004571884917);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(054409723782);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(005550489445);

    // rY[12]:
    this->mVariableNames.push_back("hyperpolarisation_activated_current_y_gate__y");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(067156687129);
    ...
    this->mInitialConditions.push_back(000312494921);
    ...
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(00019074741);
    ...
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(074631965653);

    // rY[24]:
    this->mVariableNames.push_back("calcium_buffering__fTC");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(059206293446);
