...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellkurata_model_2002FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x8 = exp(0);
        const double var_x9 = 0.54600054600054604 * var_x8;
        const double var_x10 = 1 / (4.8791826399715319 + var_x9);
        const double var_x11 = var_x10 * var_x9;
        const double var_x12 = 0.0080724972509135153 * var_chaste_interface__membrane__V;
        const double var_x13 = exp(var_x12);
        const double var_x14 = exp(-var_x12);
        const double var_x15 = 1 / (26.440000000000001 + var_chaste_interface__intracellular_ion_concentrations__Nai);
        const double var_x16 = var_x15 * var_chaste_interface__intracellular_ion_concentrations__Nai;
        const double var_x17 = var_x14 + var_x16;
        const double var_x18 = var_x13 * var_x17;
        const double var_x19 = var_x10 * var_x14;
        const double var_x20 = 0.66530580717983756 * var_x19;
        const double var_x21 = var_x11 + var_x20;
        const double var_x22 = var_x14 * var_x21;
        const double var_x23 = 0.96776646412697098 * var_x22 + var_x11 * var_x18;
        const double var_x24 = exp(-0.0051222473865587953 * var_chaste_interface__membrane__V);
        const double var_x25 = 0.037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai;
        const double var_x26 = 1.0 + var_x25;
        const double var_x27 = (var_x24 + var_x26) * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x28 = var_x26 * var_chaste_interface__intracellular_ion_concentrations__Nai;
        const double var_x29 = (1.0 + 0.43687199650502401 * var_x28) * var_chaste_interface__intracellular_ion_concentrations__Nai;
        const double var_x30 = 1 / (1.0 + 48.309178743961354 * var_x27 + 0.0025297242600556538 * var_x29);
        const double var_x31 = 48.309178743961354 * var_x24;
        const double var_x32 = var_x30 * var_x31;
        const double var_x33 = pow((0.0207 + var_x27 + 5.2365292183152033e-5 * var_x29), (-2));
        const double var_x34 = var_x33 * (-48.309178743961354 - var_x31 - 1.8271247633873431 * var_chaste_interface__intracellular_ion_concentrations__Nai);
        const double var_x35 = var_x24 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x36 = 0.0207 * var_x35;
        const double var_x37 = var_x34 * var_x36;
        const double var_x38 = 0.96776646412697098 + var_x13;
        const double var_x39 = var_x14 * var_x38;
        const double var_x40 = var_x32 * var_x39;
        const double var_x41 = var_x37 * var_x39;
        const double var_x42 = pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2);
        const double var_x43 = 4.7355244569298691e-7 * var_x13 * var_x26;
        const double var_x44 = var_x42 * var_x43;
        const double var_x45 = var_x32 + var_x37 + var_x34 * var_x44;
        const double var_x46 = var_x13 * var_x16;
        const double var_x47 = var_x45 * var_x46;
        const double var_x48 = var_x11 * (var_x40 + var_x41 + var_x47) - var_x23 * var_x32 - var_x23 * var_x37;
        const double var_x49 = var_x32 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x50 = var_x13 * var_x30;
        const double var_x51 = var_x42 * var_x50;
        const double var_x52 = 0.0011051656880977081 * var_x26;
        const double var_x53 = var_x49 + var_x51 * var_x52;
        const double var_x54 = var_x19 * var_x53;
        const double var_x55 = var_x15 * var_x21;
        ...
        const double var_x59 = var_x30 * var_x35;
        const double var_x60 = 32.140377158446256 * var_x19;
        const double var_x61 = var_x17 * var_x60;
        const double var_x62 = var_x26 * var_x51;
        const double var_x63 = var_x10 * var_x8;
        const double var_x64 = var_x38 * var_x63;
        const double var_x65 = var_x62 * var_x64;
        const double var_x66 = var_x13 * var_x53;
        const double var_x67 = var_x16 * var_x66;
        const double var_x68 = var_x67 + var_x39 * var_x49;
        const double var_x69 = 1 / (var_x23 + var_x68 + 0.00060342106912241779 * var_x65 + 0.64386064857757164 * var_x54 + var_x52 * var_x58 + var_x59 * var_x61);
        const double var_x70 = 1.1811847207744139 * var_x69;
        const double var_x71 = 2.5855989390826479e-7 * var_x13 * var_x26 * var_x42 * var_x64;
        const double var_x72 = 0.013771830208622637 * var_x17 * var_x19 * var_x35;
        const double var_x73 = var_x43 * var_x55 * var_x56;
        const double var_x74 = 0.64386064857757164 * var_x19;
        const double var_x75 = -var_x40 - var_x41 - var_x47 - var_x34 * var_x71 - var_x34 * var_x72 - var_x34 * var_x73 - var_x45 * var_x74 - var_x24 * var_x30 * var_x61;
        const double var_x76 = (var_x11 * var_x68 - var_x23 * var_x49) / pow((0.0207 * var_x67 + 0.020032765807428299 * var_x22 + 1.2490816130834047e-5 * var_x65 + 0.013327915425555734 * var_x54 + var_x39 * var_x59 + 2.2876929743622558e-5 * var_x26 * var_x58 + 0.011302211302211302 * var_x18 * var_x63 + var_x17 * var_x20 * var_x59), 2);
        const double var_x77 = 0.00050612584100462852 * var_x76;
        const double var_x78 = pow((1 + var_x25), (-2));
        const double var_x79 = 0.0014304645462223146 * var_x78 * var_chaste_interface__intracellular_ion_concentrations__Nai;
        const double var_x80 = var_x15 - var_x79;
        const double var_x81 = var_x33 * (-0.0025297242600556538 - 0.0011051656880977081 * var_x28 - 1.8271247633873431 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub - (0.0011051656880977081 + 8.3598009689690465e-5 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai);
        const double var_x82 = var_x36 * var_x81;
        const double var_x83 = var_x39 * var_x82;
        const double var_x84 = var_x15 * var_x66;
        const double var_x85 = var_x66 * var_x79;
        const double var_x86 = var_x28 * var_x50;
        const double var_x87 = var_x82 + 0.0022103313761954162 * var_x86 + 4.1799004844845232e-5 * var_x51 + var_x44 * var_x81;
        const double var_x88 = var_x46 * var_x87;
        const double var_x89 = var_x11 * (var_x83 + var_x84 + var_x88 - var_x85) - var_x23 * var_x82 - 26.376837971040871 * var_x35 * var_x50 * var_x63 * var_x80;
        const double var_x90 = var_x85 - var_x83 - var_x84 - var_x88 - 4.1799004844845232e-5 * var_x58 - var_x71 * var_x81 - var_x72 * var_x81 - var_x73 * var_x81 - var_x74 * var_x87 - 0.0033154970642931239 * var_x55 * var_x62 - 0.0012068421382448356 * var_x64 * var_x86 - 2.2822279467564968e-5 * var_x51 * var_x64 - var_x11 * var_x13 * var_x80 - var_x59 * var_x60 * var_x80 + 1.5809003345251601e-6 * var_x21 * var_x26 * var_x57 * var_x78;
        ...
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (-4.5001325336761377e-7 - 0.0031488126018286108 * var_x96 - 0.00010952772624538631 * var_x94 - 0.0012664827895411826 * var_x93 * var_x95 - 0.00098574953620847667 * var_x94 * var_chaste_interface__AP_sensitive_currents_q_gate__q + 26.726549826397882 * var_x93 * (-8.3129420890849178e-6 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF - 5.5419613927232791e-6 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy));
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-7.7718683646407365e-5 * var_x101 - 0.0016457739131233819 * var_x102 - 2.9572486086254304e-5 * var_x97 - var_x103 * var_x89 - var_x104 * var_x90 - 0.00078716207755981068 * var_x95 * var_x97));
    }
