...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellsakmann_model_2000_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x33 = 00041999999999999996 + 00023999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_up + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x38 = 018716945411372737 * var_chaste_interface__membrane__V;
        ...
        const double var_x43 = (2.0 * var_x42 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) - 2744000 * var_x39 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) / pow((0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        ...
        const double var_x46 = exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane__V);
        ...
        const double var_x52 = exp(-0.56150836234118207 + 056150836234118207 * var_chaste_interface__membrane__V - 1.5 * var_x51);
        const double var_x53 = 1.0 + var_x52;
        const double var_x54 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2) * (0.12195121951219512 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0036585365853658534 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * mParameters[0] / pow((029999999999999999 * var_chaste_interface__intracellular_sodium_concentration__Na_i + var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        const double var_x55 = var_x47 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds;
        const double var_x56 = 1 / (40 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x57 = var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x58 = 2.6016936179035892e-8 * var_x48;
        const double var_x59 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * var_chaste_interface__fast_sodium_current_h_gate__h * mParameters[0] / pow((1.0 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        ...
        rJacobian[7][7] = 1.0 - (mDt * (-7.0000000000000009 + var_x22 + var_x23 + 00040000000000000002 * var_x36 - 0.20784009793819685 * var_x40 - 7.2e-9 * var_x41 - 1.0549054718227806e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i - 5.2262998388249204e-10 * var_x43 - 00040000000000000002 * var_x34));
        rJacobian[7][8] = -(mDt * (1.0204081632653063e-5 + 051020408163265314 * var_x44));
        ...
        rJacobian[8][6] = 0;
        rJacobian[8][7] = 0;
        rJacobian[8][8] = 1.0 - (mDt * (-0050499999999999998 - 0.25 * var_x44));
        ...
        rJacobian[9][5] = 0;
        rJacobian[9][6] = 0;
        rJacobian[9][7] = -(mDt * (019599999999999999 * var_x34 + 3.5279999999999993e-7 * var_x41 - 019599999999999999 * var_x36));
        rJacobian[9][8] = -(mDt * (050000000000000003));
        rJacobian[9][9] = 1.0 - (mDt * (-050000000000000003 + 8.4671999999999982e-11 * var_x41 - 3.5279999999999993e-7 * var_x34 - 4.7040000000000002e-6 * var_x36));
        rJacobian[9][10] = 0;
        rJacobian[9][11] = 0;
        rJacobian[10][0] = 0;
        ...
        rJacobian[10][8] = 0;
        rJacobian[10][9] = 0;
        rJacobian[10][10] = 1.0 - (mDt * (-3.6815357042237582 * var_x54 - var_x49 * var_x55 - 00096448500280939937 * var_x50 / var_x53 - 8.4392437745822447e-5 * var_x50 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s + 5.4156639443013623e-5 * var_x50 * var_x52 * (-26.713760659695652 * var_x51 + var_chaste_interface__membrane__V) / pow(var_x53, 2) - 0.11185550647567587 * var_x50 * mParameters[0] * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 044642857142857144 * var_chaste_interface__membrane__V))));
        rJacobian[10][11] = -(mDt * (00070764675538871125 * var_x56 - 0.11044607112671274 * var_x54 - 4.4227922211794452e-7 * var_x57));
        rJacobian[11][0] = 0;
        rJacobian[11][1] = -(mDt * (-var_x58 * (-140 * var_x46 + var_x47 * var_chaste_interface__intracellular_sodium_concentration__Na_i)));
        rJacobian[11][2] = 0;
        rJacobian[11][3] = 0;
        rJacobian[11][4] = 0;
        rJacobian[11][5] = 0;
        ...
        rJacobian[11][11] = 1.0 - (mDt * (6.634188331769168e-7 * var_x57 - 0010614701330830668 * var_x56 - 1.0127092529498693e-5 / var_chaste_interface__intracellular_sodium_concentration__Na_i - 1.3633825666499794e-6 * var_x45 - 50989.636493120743 * var_x59 - var_x55 * var_x58));
    }
    ...
    void Cellsakmann_model_2000_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_L_type_Ca_channel_d_gate__alpha_d = ((fabs(var_L_type_Ca_channel_d_gate__E0_d) < 0001) ? (120) : (30 * var_L_type_Ca_channel_d_gate__E0_d / (1.0 - exp(-0.1388888888888889 * var_L_type_Ca_channel_d_gate__E0_d))));
        const double var_L_type_Ca_channel_d_gate__beta_d = ((fabs(var_L_type_Ca_channel_d_gate__E0_d) < 0001) ? (120) : (12.0 * var_L_type_Ca_channel_d_gate__E0_d / (-1.0 + exp(055555555555555552 * var_L_type_Ca_channel_d_gate__E0_d))));
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = 20 * exp(-9.375 + 0.125 * var_fast_sodium_current_h_gate__shifth - 0.125 * var_chaste_interface__membrane__V);
        const double var_fast_sodium_current_h_gate__beta_h = 2000 / (1.0 + 320 * exp(-7.5 + 0.10000000000000001 * var_fast_sodium_current_h_gate__shifth - 0.10000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_slow_delayed_rectifier_potassium_current_xs_gate__xs_inf = 1.0 / (1.0 + exp(089820359281437126 - 059880239520958084 * var_chaste_interface__membrane__V));
        ...
        rY[2] = (var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr + ((001 * var_rapid_delayed_rectifier_potassium_current_xr_gate__xr_inf / var_rapid_delayed_rectifier_potassium_current_xr_gate__tau_xr) * mDt)) / (1.0 - ((-001 / var_rapid_delayed_rectifier_potassium_current_xr_gate__tau_xr) * mDt));
        rY[3] = (var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs + ((001 * var_slow_delayed_rectifier_potassium_current_xs_gate__xs_inf / var_slow_delayed_rectifier_potassium_current_xs_gate__tau_xs) * mDt)) / (1.0 - ((-001 / var_slow_delayed_rectifier_potassium_current_xs_gate__tau_xs) * mDt));
        ...
        rY[10] = (var_chaste_interface__transient_outward_current_s_gate__s + ((001 * var_transient_outward_current_s_gate__alpha_s) * mDt)) / (1.0 - ((-001 * var_transient_outward_current_s_gate__alpha_s - 001 * var_transient_outward_current_s_gate__beta_s) * mDt));
