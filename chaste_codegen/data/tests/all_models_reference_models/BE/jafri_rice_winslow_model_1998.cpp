...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celljafri_rice_winslow_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[25], double rJacobian[25][25])
    {
        ...
        const double var_x4 = exp(-0.92307692307692313 - 076923076923076927 * var_chaste_interface__membrane__V);
        const double var_x5 = 050000000000000003 * var_x4;
        ...
        const double var_x24 = 025000000000000001 * var_x4;
        const double var_x25 = 2.4000000000000004 * var_x1;
        const double var_x26 = 075000000000000011 * var_x4;
        ...
        const double var_x41 = 0023800000000000002 + var_chaste_interface__calcium_subsystem__Ca_SS;
        const double var_x42 = 1.0 + 00011900000000000002 / pow(var_x41, 2);
        const double var_x43 = 1 / var_x42;
        const double var_x44 = exp(075146605522028176 * var_chaste_interface__membrane__V);
        const double var_x45 = (-0.61380000000000001 + 001 * var_x44) * var_chaste_interface__membrane__V / (-1.0 + var_x44);
        ...
        const double var_x53 = 0023800000000000002 + var_chaste_interface__calcium_subsystem__Cai;
        const double var_x54 = 1.0 + 00011900000000000002 / pow(var_x53, 2);
        const double var_x55 = 1 / var_x54;
        const double var_x56 = 20 * var_chaste_interface__calcium_subsystem__HTRPNCa;
        const double var_x57 = 40 * var_chaste_interface__calcium_subsystem__LTRPNCa;
        const double var_x58 = 00050000000000000001 + var_chaste_interface__calcium_subsystem__Cai;
        const double var_x59 = 3.5281248386597142e-5 / var_x58;
        const double var_x60 = 1 / var_chaste_interface__calcium_subsystem__Cai;
        const double var_x61 = exp(-024422646794659157 * var_chaste_interface__membrane__V);
        ...
        const double var_x65 = exp(013150655966354929 * var_chaste_interface__membrane__V);
        const double var_x66 = 20 * var_chaste_interface__calcium_subsystem__Cai;
        const double var_x67 = 40 * var_chaste_interface__calcium_subsystem__Cai;
        ...
        const double var_x70 = 48600000000 * var_x69 * var_chaste_interface__calcium_subsystem__P_C1;
        const double var_x71 = 12150000000 * pow(var_chaste_interface__calcium_subsystem__Ca_SS, 4.0);
        const double var_x72 = 121500000 * pow(var_chaste_interface__calcium_subsystem__Ca_SS, 2.0) * var_chaste_interface__calcium_subsystem__P_O1;
        const double var_x73 = 40500000 * var_x69;
        const double var_x74 = 037573302761014088 * var_chaste_interface__membrane__V;
        ...
        const double var_x80 = 140 + var_chaste_interface__ionic_concentrations__Ko;
        ...
        const double var_x95 = 1 / (018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki);
        const double var_x96 = sqrt(var_chaste_interface__ionic_concentrations__Ko);
        const double var_x97 = pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 2) / (1.0 + exp(-1.7526479750778814 + 031152647975077882 * var_chaste_interface__membrane__V));
        ...
        const double var_x109 = 0005376025032790136 * var_x108;
        ...
        const double var_x113 = exp(0.43983232 + 080320000000000003 * var_chaste_interface__membrane__V - 2.1376880417161446 * var_x105);
        const double var_x114 = exp(-36.698642499999998 + 061749999999999999 * var_chaste_interface__membrane__V - 1.6434541406371006 * var_x105);
        ...
        const double var_x129 = 00012821819703204474 * var_x122 * var_x125;
        ...
        const double var_x144 = 1 / (1.0 + 0.1245 * exp(-0037573302761014088 * var_chaste_interface__membrane__V) + 036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x74));
        const double var_x145 = var_x144 / (1.0 + 31.622776601683793 * var_x143);
        const double var_x146 = var_x141 * var_x145;
        const double var_x147 = 00015953260140026533 * var_x146;
        ...
        const double var_x166 = var_x141 * var_x142 * var_x143 * var_x144 * var_chaste_interface__ionic_concentrations__Ko / pow((031622776601683791 + var_x143), 2);
        ...
        rJacobian[1][4] = 0;
        rJacobian[1][5] = 0;
        rJacobian[1][6] = -(mDt * (0050000000000000001));
        rJacobian[1][7] = 0;
        rJacobian[1][8] = 0;
        rJacobian[1][9] = 0;
        rJacobian[1][10] = 0;
        ...
        rJacobian[2][5] = 0;
        rJacobian[2][6] = 0;
        rJacobian[2][7] = -(mDt * (0025000000000000001));
        rJacobian[2][8] = 0;
        rJacobian[2][9] = 0;
        rJacobian[2][10] = 0;
        rJacobian[2][11] = 0;
        ...
        rJacobian[4][7] = 0;
        rJacobian[4][8] = 0;
        rJacobian[4][9] = -(mDt * (00062500000000000001));
        ...
        rJacobian[5][3] = 0;
        rJacobian[5][4] = 0;
        rJacobian[5][5] = 1.0 - (mDt * (-01 + var_x0 - var_x23));
        ...
        rJacobian[6][6] = 1.0 - (mDt * (-0050000000000000001 - var_x24 - var_x25));
        ...
        rJacobian[7][7] = 1.0 - (mDt * (-0025000000000000001 + var_x3 + var_x7));
        ...
        rJacobian[8][8] = 1.0 - (mDt * (-00125 + var_x14 - var_x26));
        ...
        rJacobian[9][9] = 1.0 - (mDt * (-00062500000000000001 + var_x12));
        rJacobian[9][10] = 0;
        rJacobian[9][11] = 0;
        rJacobian[9][12] = 0;
        rJacobian[9][13] = 0;
        ...
        rJacobian[12][10] = 0;
        rJacobian[12][11] = 0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x32 * (-029002320185614851 - var_x27 - var_x28) + 0.16666666666666666 * (029002320185614851 * var_chaste_interface__calcium_subsystem__Ca_NSR - 1.8 * var_x33 - 029002320185614851 * var_chaste_interface__calcium_subsystem__Ca_JSR) / (pow(var_x29, 3) * pow((083333333333333329 + var_x30), 2))));
        rJacobian[12][13] = -(mDt * (029002320185614851 * var_x31));
        ...
        rJacobian[13][10] = 0;
        rJacobian[13][11] = 0;
        rJacobian[13][12] = -(mDt * (0016613674772994187));
        rJacobian[13][13] = 1.0 - (mDt * (-0023774168600154679));
        rJacobian[13][14] = 0;
        rJacobian[13][15] = -(mDt * (00071604938271604935 + 044444444444444439 * var_x38 - 044444444444444439 * var_x40));
        rJacobian[13][16] = 0;
        rJacobian[13][17] = 0;
        rJacobian[13][18] = 0;
        rJacobian[13][19] = 0;
        ...
        rJacobian[14][13] = 0;
        rJacobian[14][14] = 1.0 - (mDt * (var_x50 * (-5490.7343857240912 - var_x48 - var_x49) + 00023800000000000004 * (143.30816746739879 * var_x33 + 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Cai - 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Ca_SS - var_x46 * var_x51) / (pow(var_x41, 3) * pow(var_x42, 2))));
        ...
        rJacobian[15][15] = 1.0 - (mDt * (var_x64 * (-5.9200580000000009 + var_x56 + var_x57 - var_x59 + 0035999999999999999 * var_x40 - 0035999999999999999 * var_x38 - 077544234316921451 * var_x63 - 2.4626237783962268e-6 * var_x60 + 3.5281248386597142e-5 * var_chaste_interface__calcium_subsystem__Cai / pow(var_x58, 2)) + 00023800000000000004 * (5.8e-5 * var_chaste_interface__calcium_subsystem__Ca_NSR + 6.6000000000000005e-5 * var_chaste_interface__calcium_subsystem__HTRPNCa + 040000000000000001 * var_chaste_interface__calcium_subsystem__LTRPNCa + 0.32000000000000001 * var_chaste_interface__calcium_subsystem__Ca_SS + 2.4626237783962268e-6 * log(1.8 * var_x60) - 0.32005800000000001 * var_chaste_interface__calcium_subsystem__Cai - 1.8505781762430779e-7 * var_chaste_interface__membrane__V - var_x59 * var_chaste_interface__calcium_subsystem__Cai - var_x66 * (0.14000000000000001 - var_chaste_interface__calcium_subsystem__HTRPNCa) - var_x67 * (070000000000000007 - var_chaste_interface__calcium_subsystem__LTRPNCa) + 2.8259560611122977e-8 * var_x62 * (1.8 * var_x65 * pow(var_chaste_interface__ionic_concentrations__Nai, 3) - 2744000 * var_x61 * var_chaste_interface__calcium_subsystem__Cai) - 0018 * var_x35 * var_x37) / (pow(var_x53, 3) * pow(var_x54, 2))));
        rJacobian[15][16] = -(mDt * (var_x64 * (6.6000000000000005e-5 + var_x66)));
        rJacobian[15][17] = -(mDt * (var_x64 * (040000000000000001 + var_x67)));
        rJacobian[15][18] = 0;
        rJacobian[15][19] = 0;
        rJacobian[15][20] = 0;
        rJacobian[15][21] = 0;
        ...
        rJacobian[17][16] = 0;
        rJacobian[17][17] = 1.0 - (mDt * (-040000000000000001 - var_x67));
        rJacobian[17][18] = 0;
        rJacobian[17][19] = 0;
        rJacobian[17][20] = 0;
        rJacobian[17][21] = 0;
        ...
        rJacobian[19][17] = 0;
        rJacobian[19][18] = 0;
        rJacobian[19][19] = 1.0 - (mDt * (-00080000000000000004));
        rJacobian[19][20] = -(mDt * (017999999999999999));
        rJacobian[19][21] = 0;
        rJacobian[19][22] = 0;
        rJacobian[19][23] = 0;
        rJacobian[19][24] = 0;
        ...
        rJacobian[20][19] = -(mDt * (00080000000000000004));
        ...
        rJacobian[24][23] = -(mDt * (00010635506760017689 * var_x158 - 000239298902100398 * var_x146 + var_x152 * var_x173 - var_x163 * var_x173 + var_x151 * var_x168 * var_chaste_interface__ionic_concentrations__Nai));
        rJacobian[24][24] = 1.0 - (mDt * (var_x175 - 1.1350943583223629e-5 * var_x166 - 4.5780488190019227e-7 * var_x68 - 2.3025858935932891e-6 * var_x142 - var_x103 * (var_x83 + var_x172 * var_x79) - 020902907402832696 * var_x142 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
    ...
    void Celljafri_rice_winslow_model_1998FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_L_type_Ca_channel_y_gate__tau_y = 20 + 600 / (1.0 + exp(3.1578947368421053 + 0.10526315789473684 * var_chaste_interface__membrane__V));
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40) ? (0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0));
        const double var_fast_sodium_current_h_gate__beta_h = ((var_chaste_interface__membrane__V < -40) ? (310000 * exp(0.34999999999999998 * var_chaste_interface__membrane__V) + 3.5600000000000001 * exp(079000000000000001 * var_chaste_interface__membrane__V)) : (7.6923076923076916 / (1.0 + exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__membrane__V))));
        ...
        const double var_fast_sodium_current_m_gate__beta_m = 080000000000000002 * exp(-090909090909090912 * var_chaste_interface__membrane__V);
        const double var_time_dependent_potassium_current_X_gate__alpha_X = 7.1899999999999999e-5 * (30 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V));
        const double var_time_dependent_potassium_current_X_gate__beta_X = 00013100000000000001 * (30 + var_chaste_interface__membrane__V) / (-1.0 + exp(2.0609999999999999 + 068699999999999997 * var_chaste_interface__membrane__V));
