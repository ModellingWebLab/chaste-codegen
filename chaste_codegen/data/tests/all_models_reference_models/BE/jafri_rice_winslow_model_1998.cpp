...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celljafri_rice_winslow_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[25], double rJacobian[25][25])
    {
        ...
        const double var_x62 = log(10);
        const double var_x63 = exp(0.013150655966354929 * var_chaste_interface__membrane__V);
        const double var_x64 = 20.0 * var_chaste_interface__calcium_subsystem__Cai;
        const double var_x65 = 40.0 * var_chaste_interface__calcium_subsystem__Cai;
        const double var_x66 = var_x60 * var_x63 * pow(var_chaste_interface__ionic_concentrations__Nai, 2);
        const double var_x67 = pow(var_chaste_interface__calcium_subsystem__Ca_SS, 3.0);
        const double var_x68 = 48600000000.0 * var_x67 * var_chaste_interface__calcium_subsystem__P_C1;
        const double var_x69 = 12150000000.0 * pow(var_chaste_interface__calcium_subsystem__Ca_SS, 4.0);
        const double var_x70 = 121500000.0 * pow(var_chaste_interface__calcium_subsystem__Ca_SS, 2.0) * var_chaste_interface__calcium_subsystem__P_O1;
        const double var_x71 = 40500000.0 * var_x67;
        const double var_x72 = 0.037573302761014088 * var_chaste_interface__membrane__V;
        const double var_x73 = exp(var_x72);
        const double var_x74 = 2.2327118354803037e-8 * var_chaste_interface__L_type_Ca_channel_y_gate__y * var_chaste_interface__membrane__V / ((1.0 - 107.25680748803607 * var_x44) * (-1.0 + var_x73));
        const double var_x75 = var_x74 * (-var_chaste_interface__ionic_concentrations__Ko + var_x73 * var_chaste_interface__ionic_concentrations__Ki);
        const double var_x76 = -var_x75;
        const double var_x77 = 1 / (var_chaste_interface__ionic_concentrations__Ki + var_chaste_interface__ionic_concentrations__Nai);
        const double var_x78 = 140.0 + var_chaste_interface__ionic_concentrations__Ko;
        const double var_x79 = var_x62 * log10(var_x77 * var_x78);
        const double var_x80 = exp(var_x72 - 1.0 * var_x79);
        const double var_x81 = 0.75 * var_x80;
        const double var_x82 = var_x81 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x83 = var_x82 - 0.75 * var_chaste_interface__ionic_concentrations__Ko;
        const double var_x84 = -1.0 + var_x80;
        const double var_x85 = 1 / var_x84;
        const double var_x86 = -26.614641953637257 * var_x79 + var_chaste_interface__membrane__V;
        const double var_x87 = 1.0 + 1.7279999999999996e-9 / var_x38;
        const double var_x88 = 2.0255161771477306e-16 * var_x85 * var_x86 / (pow(var_x87, 2) * pow(var_chaste_interface__calcium_subsystem__Cai, 4));
        const double var_x89 = var_x83 * var_x88;
        const double var_x90 = 1 / var_chaste_interface__ionic_concentrations__Ki;
        const double var_x91 = 1.3521568226207399e-5 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V));
        const double var_x92 = var_x90 * var_x91;
        const double var_x93 = 1 / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki);
        const double var_x94 = sqrt(var_chaste_interface__ionic_concentrations__Ko);
        const double var_x95 = pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 2) / (1.0 + exp(-1.7526479750778814 + 0.031152647975077882 * var_chaste_interface__membrane__V));
        const double var_x96 = 7.9270016169768288e-5 * var_x94 * var_x95;
        const double var_x97 = var_x93 * var_x96;
        const double var_x98 = 1 / var_x87;
        const double var_x99 = var_x85 * var_x98;
        const double var_x100 = 3.9072457120905308e-8 * var_x86;
        const double var_x101 = var_x100 * var_x99;
        const double var_x102 = var_x101 * (var_x81 + var_x77 * var_x82);
        const double var_x103 = var_x62 * log10(var_x90 * var_chaste_interface__ionic_concentrations__Ko);
        const double var_x104 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3475921059424856 * var_x103);
        const double var_x105 = 1.0 + var_x104;
        const double var_x106 = 1 / var_x105;
        const double var_x107 = 0.0005376025032790136 * var_x106;
        const double var_x108 = exp(-2.4444678999999998 + 13.687910356755641 * var_x103 - 0.51429999999999998 * var_chaste_interface__membrane__V);
        const double var_x109 = 1.0 + var_x108;
        const double var_x110 = 1 / var_x109;
        const double var_x111 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1376880417161446 * var_x103);
        const double var_x112 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6434541406371006 * var_x103);
        const double var_x113 = var_x112 + 0.49124000000000001 * var_x111;
        const double var_x114 = var_x110 * var_x113;
        const double var_x115 = 1 / (var_x114 + 1.02 * var_x106);
        const double var_x116 = var_x115 * var_x90 * var_x94;
        const double var_x117 = var_x107 * var_x116;
        const double var_x118 = 1.0501178736126389 * var_x111;
        const double var_x119 = 1.6434541406371006 * var_x112;
        const double var_x120 = var_x104 / pow(var_x105, 2);
        const double var_x121 = 6.4745439480613349 * var_x120;
        const double var_x122 = 13.687910356755641 * var_x108 * var_x113 / pow(var_x109, 2);
        const double var_x123 = -26.614641953637257 * var_x103 + var_chaste_interface__membrane__V;
        const double var_x124 = var_x106 * var_x123;
        const double var_x125 = 1.9415130354461213e-5 * var_x124 * var_x94 / pow((var_x106 + 0.98039215686274506 * var_x114), 2);
        const double var_x126 = var_x125 * (var_x121 * var_x90 - var_x110 * (var_x118 * var_x90 + var_x119 * var_x90) - var_x122 * var_x90);
        const double var_x127 = 0.00012821819703204474 * var_x120 * var_x123;
        const double var_x128 = var_x116 * var_x127;
        const double var_x129 = var_x49 * var_x74;
        const double var_x130 = var_x129 * var_x73;
        const double var_x131 = 1.0398994565217392e-6 * var_x99;
        const double var_x132 = var_x77 * var_x83;
        const double var_x133 = var_x131 * var_x132;
        const double var_x134 = var_x100 * var_x80 * var_x98 / pow(var_x84, 2);
        const double var_x135 = var_x132 * var_x134;
        const double var_x136 = var_x135 - var_x133;
        const double var_x137 = 1 / var_chaste_interface__ionic_concentrations__Ko;
        const double var_x138 = var_x137 * var_x91;
        const double var_x139 = 1 / (1.5 + var_chaste_interface__ionic_concentrations__Ko);
        const double var_x140 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x141 = pow(var_x140, 1.5);
        const double var_x142 = 1 / (1.0 + 0.1245 * exp(-0.0037573302761014088 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x72));
        const double var_x143 = var_x142 / (1.0 + 31.622776601683793 * var_x141);
        const double var_x144 = var_x139 * var_x143;
        const double var_x145 = 0.00015953260140026533 * var_x144;
        const double var_x146 = 1 / var_x94;
        const double var_x147 = var_x115 * var_x146;
        const double var_x148 = var_x107 * var_x147;
        const double var_x149 = 1 / var_x78;
        const double var_x150 = var_x131 * var_x149;
        const double var_x151 = var_x150 * var_x83;
        const double var_x152 = 2.5661999999999998 + var_chaste_interface__ionic_concentrations__Ko;
        const double var_x153 = var_x96 / var_x152;
        const double var_x154 = 1.0099750810390723e-5 * var_x124 * var_x147;
        const double var_x155 = var_x101 * (-0.75 - var_x149 * var_x82);
        const double var_x156 = var_x143 * var_chaste_interface__ionic_concentrations__Ko / pow((1 + 0.66666666666666663 * var_chaste_interface__ionic_concentrations__Ko), 2);
        const double var_x157 = 7.090337840011793e-5 * var_x156;
        const double var_x158 = 1.4892181587085931e-6 * var_x146 * var_x95 * (-26.614641953637257 * var_x62 * log10(var_x152 * var_x93) + var_chaste_interface__membrane__V);
        const double var_x159 = var_x127 * var_x147;
        const double var_x160 = var_x125 * (var_x122 * var_x137 - var_x110 * (-var_x118 * var_x137 - var_x119 * var_x137) - var_x121 * var_x137);
        const double var_x161 = var_x134 * var_x149;
        const double var_x162 = var_x161 * var_x83;
        const double var_x163 = 1.4530193963918526e-6 * var_x93 * var_x94 * var_x95;
        const double var_x164 = var_x139 * var_x140 * var_x141 * var_x142 * var_chaste_interface__ionic_concentrations__Ko / pow((0.031622776601683791 + var_x141), 2);
        const double var_x165 = 7.5672957221490862e-6 * var_x164;
        const double var_x166 = 2.9304342840678981e-8 * var_x80 * var_x86 * var_x99;
        const double var_x167 = var_x166 * var_x77;
        const double var_x168 = var_x167 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x169 = var_x133 - var_x135;
        const double var_x170 = var_x81 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x171 = -105.0 + var_x170;
        const double var_x172 = var_x171 * var_x77;
        const double var_x173 = var_x134 * var_x172 - var_x131 * var_x172;
        ...
        rJacobian[15][15] = 1.0 - (mDt * (var_x53 * (-5.9200580000000009 + var_x54 + var_x55 - var_x57 + 0.0035999999999999999 * var_x39 - 0.0035999999999999999 * var_x37 - 0.077544234316921451 * var_x61 - 2.4626237783962268e-6 * var_x58 + 3.5281248386597142e-5 * var_chaste_interface__calcium_subsystem__Cai / pow(var_x56, 2)) + 0.00023800000000000004 * (5.8e-5 * var_chaste_interface__calcium_subsystem__Ca_NSR + 6.6000000000000005e-5 * var_chaste_interface__calcium_subsystem__HTRPNCa + 0.040000000000000001 * var_chaste_interface__calcium_subsystem__LTRPNCa + 0.32000000000000001 * var_chaste_interface__calcium_subsystem__Ca_SS - 0.32005800000000001 * var_chaste_interface__calcium_subsystem__Cai - 1.8505781762430779e-7 * var_chaste_interface__membrane__V - var_x57 * var_chaste_interface__calcium_subsystem__Cai - var_x64 * (0.14000000000000001 - var_chaste_interface__calcium_subsystem__HTRPNCa) - var_x65 * (0.070000000000000007 - var_chaste_interface__calcium_subsystem__LTRPNCa) + 2.4626237783962268e-6 * var_x62 * log10(1.8 * var_x58) + 2.8259560611122977e-8 * var_x60 * (1.8 * var_x63 * pow(var_chaste_interface__ionic_concentrations__Nai, 3) - 2744000.0 * var_x59 * var_chaste_interface__calcium_subsystem__Cai) - 0.0018 * var_x34 * var_x36) / (pow(var_x51, 3) * pow(var_x52, 2))));
        rJacobian[15][16] = -(mDt * (var_x53 * (6.6000000000000005e-5 + var_x64)));
        rJacobian[15][17] = -(mDt * (var_x53 * (0.040000000000000001 + var_x65)));
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        rJacobian[15][20] = 0.0;
        rJacobian[15][21] = 0.0;
        rJacobian[15][22] = 0.0;
        rJacobian[15][23] = 0.0;
        rJacobian[15][24] = -(mDt * (1.5260162730006407e-7 * var_x53 * var_x66));
        rJacobian[16][0] = 0.0;
        rJacobian[16][1] = 0.0;
        rJacobian[16][2] = 0.0;
        rJacobian[16][3] = 0.0;
        ...
        rJacobian[16][16] = 1.0 - (mDt * (-6.6000000000000005e-5 - var_x64));
        rJacobian[16][17] = 0.0;
        rJacobian[16][18] = 0.0;
        rJacobian[16][19] = 0.0;
        rJacobian[16][20] = 0.0;
        ...
        rJacobian[17][16] = 0.0;
        rJacobian[17][17] = 1.0 - (mDt * (-0.040000000000000001 - var_x65));
        rJacobian[17][18] = 0.0;
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = 0.0;
        rJacobian[17][21] = 0.0;
        ...
        rJacobian[18][12] = 0.0;
        rJacobian[18][13] = 0.0;
        rJacobian[18][14] = -(mDt * (-var_x68));
        rJacobian[18][15] = 0.0;
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-var_x69));
        rJacobian[18][19] = 0.0;
        ...
        rJacobian[20][12] = 0.0;
        rJacobian[20][13] = 0.0;
        rJacobian[20][14] = -(mDt * (var_x68 - var_x70));
        rJacobian[20][15] = 0.0;
        rJacobian[20][16] = 0.0;
        rJacobian[20][17] = 0.0;
        rJacobian[20][18] = -(mDt * (var_x69));
        rJacobian[20][19] = -(mDt * (0.00080000000000000004));
        rJacobian[20][20] = 1.0 - (mDt * (-0.16049999999999998 - var_x71));
        ...
        rJacobian[22][8] = 0.0;
        rJacobian[22][9] = 0.0;
        rJacobian[22][10] = -(mDt * (var_x76));
        rJacobian[22][11] = -(mDt * (var_x76));
        rJacobian[22][12] = 0.0;
        rJacobian[22][13] = 0.0;
        rJacobian[22][14] = 0.0;
        rJacobian[22][15] = -(mDt * (-var_x89));
        rJacobian[22][16] = 0.0;
        rJacobian[22][17] = 0.0;
        rJacobian[22][18] = 0.0;
        rJacobian[22][19] = 0.0;
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (var_x128 + var_x136 - var_x102 - var_x117 - var_x126 - var_x130 - var_x92 - var_x97));
        rJacobian[22][23] = -(mDt * (var_x129 + var_x138 + var_x145 + var_x148 + var_x151 + var_x153 - var_x154 - var_x155 - var_x157 - var_x158 - var_x159 - var_x160 - var_x162));
        rJacobian[22][24] = -(mDt * (var_x136 + var_x165 - var_x163 - var_x168));
        rJacobian[23][0] = 0.0;
        rJacobian[23][1] = 0.0;
        rJacobian[23][2] = 0.0;
        rJacobian[23][3] = 0.0;
        ...
        rJacobian[23][8] = 0.0;
        rJacobian[23][9] = 0.0;
        rJacobian[23][10] = -(mDt * (var_x75));
        rJacobian[23][11] = -(mDt * (var_x75));
        rJacobian[23][12] = 0.0;
        rJacobian[23][13] = 0.0;
        rJacobian[23][14] = 0.0;
        rJacobian[23][15] = -(mDt * (var_x89));
        rJacobian[23][16] = 0.0;
        rJacobian[23][17] = 0.0;
        rJacobian[23][18] = 0.0;
        rJacobian[23][19] = 0.0;
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (var_x102 + var_x117 + var_x126 + var_x130 + var_x169 + var_x92 + var_x97 - var_x128));
        rJacobian[23][23] = 1.0 - (mDt * (var_x154 + var_x155 + var_x157 + var_x158 + var_x159 + var_x160 + var_x162 - var_x129 - var_x138 - var_x145 - var_x148 - var_x151 - var_x153));
        rJacobian[23][24] = -(mDt * (var_x163 + var_x168 + var_x169 - var_x165));
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = 0.0;
        rJacobian[24][2] = 0.0;
        rJacobian[24][3] = 0.0;
        ...
        rJacobian[24][13] = 0.0;
        rJacobian[24][14] = 0.0;
        rJacobian[24][15] = -(mDt * (0.23263270295076435 * var_x61 - var_x171 * var_x88));
        rJacobian[24][16] = 0.0;
        rJacobian[24][17] = 0.0;
        rJacobian[24][18] = 0.0;
        rJacobian[24][19] = 0.0;
        rJacobian[24][20] = 0.0;
        rJacobian[24][21] = 0.0;
        rJacobian[24][22] = -(mDt * (var_x173 - var_x167 * var_chaste_interface__ionic_concentrations__Nai));
        rJacobian[24][23] = -(mDt * (0.00010635506760017689 * var_x156 - 0.000239298902100398 * var_x144 + var_x150 * var_x171 - var_x161 * var_x171 + var_x149 * var_x166 * var_chaste_interface__ionic_concentrations__Nai));
        rJacobian[24][24] = 1.0 - (mDt * (var_x173 - 1.1350943583223629e-5 * var_x164 - 4.5780488190019227e-7 * var_x66 - 2.3025858935932891e-6 * var_x140 - var_x101 * (var_x81 + var_x170 * var_x77) - 0.020902907402832696 * var_x140 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
