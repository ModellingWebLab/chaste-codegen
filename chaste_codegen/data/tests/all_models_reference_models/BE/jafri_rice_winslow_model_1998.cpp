...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celljafri_rice_winslow_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[25], double rJacobian[25][25])
    {
        ...
        const double var_x59 = 0.00050000000000000001 + var_chaste_interface__calcium_subsystem__Cai;
        const double var_x60 = 3.5281248386597142e-5 / var_x59;
        ...
        const double var_x67 = exp(0.013150655966354929 * var_chaste_interface__membrane__V);
        const double var_x68 = var_x62 * var_x67 * pow(var_chaste_interface__ionic_concentrations__Nai, 2);
        ...
        const double var_x79 = 140.0 + var_chaste_interface__ionic_concentrations__Ko;
        const double var_x80 = 1 / (var_chaste_interface__ionic_concentrations__Ki + var_chaste_interface__ionic_concentrations__Nai);
        ...
        const double var_x104 = var_x103 * (var_x83 + var_x80 * var_x84);
        ...
        const double var_x113 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6434541406371006 * var_x105);
        const double var_x114 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1376880417161446 * var_x105);
        const double var_x115 = var_x113 + 0.49124000000000001 * var_x114;
        ...
        const double var_x120 = var_x106 / pow(var_x107, 2);
        const double var_x121 = 6.4745439480613349 * var_x120;
        const double var_x122 = 1.6434541406371006 * var_x113;
        const double var_x123 = 1.0501178736126389 * var_x114;
        ...
        const double var_x128 = var_x127 * (var_x121 * var_x92 - var_x112 * (var_x122 * var_x92 + var_x123 * var_x92) - var_x124 * var_x92);
        const double var_x129 = 0.00012821819703204474 * var_x120 * var_x125;
        ...
        const double var_x134 = var_x80 * var_x85;
        ...
        const double var_x141 = 2.5661999999999998 + var_chaste_interface__ionic_concentrations__Ko;
        const double var_x142 = var_x98 / var_x141;
        const double var_x143 = 1 / var_x96;
        const double var_x144 = 1.4892181587085931e-6 * var_x143 * var_x97 * (-26.614641953637257 * log(var_x141 * var_x95) + var_chaste_interface__membrane__V);
        const double var_x145 = 1 / (1.5 + var_chaste_interface__ionic_concentrations__Ko);
        const double var_x146 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x147 = pow(var_x146, 1.5);
        const double var_x148 = 1 / (1.0 + 0.1245 * exp(-0.0037573302761014088 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x74));
        const double var_x149 = var_x148 / (1.0 + 31.622776601683793 * var_x147);
        const double var_x150 = var_x145 * var_x149;
        const double var_x151 = 0.00015953260140026533 * var_x150;
        const double var_x152 = var_x149 * var_chaste_interface__ionic_concentrations__Ko / pow((1 + 0.66666666666666663 * var_chaste_interface__ionic_concentrations__Ko), 2);
        const double var_x153 = 7.090337840011793e-5 * var_x152;
        const double var_x154 = 1 / var_x79;
        const double var_x155 = var_x133 * var_x154;
        const double var_x156 = var_x155 * var_x85;
        const double var_x157 = var_x103 * (-0.75 - var_x154 * var_x84);
        const double var_x158 = var_x136 * var_x154;
        const double var_x159 = var_x158 * var_x85;
        const double var_x160 = var_x117 * var_x143;
        const double var_x161 = var_x109 * var_x160;
        const double var_x162 = 1.0099750810390723e-5 * var_x126 * var_x160;
        const double var_x163 = var_x129 * var_x160;
        const double var_x164 = var_x127 * (var_x124 * var_x139 - var_x112 * (-var_x122 * var_x139 - var_x123 * var_x139) - var_x121 * var_x139);
        const double var_x165 = 1.4530193963918526e-6 * var_x95 * var_x96 * var_x97;
        const double var_x166 = var_x145 * var_x146 * var_x147 * var_x148 * var_chaste_interface__ionic_concentrations__Ko / pow((0.031622776601683791 + var_x147), 2);
        const double var_x167 = 7.5672957221490862e-6 * var_x166;
        const double var_x168 = 2.9304342840678981e-8 * var_x101 * var_x82 * var_x88;
        const double var_x169 = var_x168 * var_x80;
        ...
        const double var_x174 = var_x173 * var_x80;
        ...
        rJacobian[15][15] = 1.0 - (mDt * (var_x64 * (-5.9200580000000009 + var_x56 + var_x57 - var_x60 + 0.0035999999999999999 * var_x40 - 0.0035999999999999999 * var_x38 - 0.077544234316921451 * var_x63 - 2.4626237783962268e-6 * var_x58 + 3.5281248386597142e-5 * var_chaste_interface__calcium_subsystem__Cai / pow(var_x59, 2)) + 0.00023800000000000004 * (5.8e-5 * var_chaste_interface__calcium_subsystem__Ca_NSR + 6.6000000000000005e-5 * var_chaste_interface__calcium_subsystem__HTRPNCa + 0.040000000000000001 * var_chaste_interface__calcium_subsystem__LTRPNCa + 0.32000000000000001 * var_chaste_interface__calcium_subsystem__Ca_SS + 2.4626237783962268e-6 * log(1.8 * var_x58) - 0.32005800000000001 * var_chaste_interface__calcium_subsystem__Cai - 1.8505781762430779e-7 * var_chaste_interface__membrane__V - var_x60 * var_chaste_interface__calcium_subsystem__Cai - var_x65 * (0.070000000000000007 - var_chaste_interface__calcium_subsystem__LTRPNCa) - var_x66 * (0.14000000000000001 - var_chaste_interface__calcium_subsystem__HTRPNCa) + 2.8259560611122977e-8 * var_x62 * (1.8 * var_x67 * pow(var_chaste_interface__ionic_concentrations__Nai, 3) - 2744000.0 * var_x61 * var_chaste_interface__calcium_subsystem__Cai) - 0.0018 * var_x35 * var_x37) / (pow(var_x53, 3) * pow(var_x54, 2))));
        rJacobian[15][16] = -(mDt * (var_x64 * (6.6000000000000005e-5 + var_x66)));
        rJacobian[15][17] = -(mDt * (var_x64 * (0.040000000000000001 + var_x65)));
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        rJacobian[15][20] = 0.0;
        rJacobian[15][21] = 0.0;
        ...
        rJacobian[22][23] = -(mDt * (var_x131 + var_x140 + var_x142 + var_x151 + var_x156 + var_x161 - var_x144 - var_x153 - var_x157 - var_x159 - var_x162 - var_x163 - var_x164));
        ...
        rJacobian[23][23] = 1.0 - (mDt * (var_x144 + var_x153 + var_x157 + var_x159 + var_x162 + var_x163 + var_x164 - var_x131 - var_x140 - var_x142 - var_x151 - var_x156 - var_x161));
        ...
        rJacobian[24][23] = -(mDt * (0.00010635506760017689 * var_x152 - 0.000239298902100398 * var_x150 + var_x155 * var_x173 - var_x158 * var_x173 + var_x154 * var_x168 * var_chaste_interface__ionic_concentrations__Nai));
        rJacobian[24][24] = 1.0 - (mDt * (var_x175 - 1.1350943583223629e-5 * var_x166 - 4.5780488190019227e-7 * var_x68 - 2.3025858935932891e-6 * var_x146 - var_x103 * (var_x83 + var_x172 * var_x80) - 0.020902907402832696 * var_x146 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
