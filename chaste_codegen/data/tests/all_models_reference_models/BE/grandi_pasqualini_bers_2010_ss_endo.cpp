...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    double Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut::Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut::~Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut()
    {
    }

    
    double Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[27], double rResidual[27])
    {
    ...
    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[27], double rJacobian[27][27])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: mV; Initial value: -81.4229700631461
        ...
        const double var_x33 = 0.40500000000000003 - 0.40500000000000003 * var_chaste_interface__I_Ca__f_Ca_Bj;
        const double var_x34 = exp(9.9999999999999995e-8);
        const double var_x35 = 1 / (-1.0 + var_x34);
        const double var_x36 = var_x34 * var_x35;
        const double var_x37 = 3.5533495800000002e-6 * mParameters[7];
        ...
        const double var_x42 = fabs(var_chaste_interface__membrane_potential__V_m);
        const double var_x43 = var_x42 < 1.3356169352749131e-6;
        const double var_x44 = exp(0.074871767015605231 * var_chaste_interface__membrane_potential__V_m);
        const double var_x45 = var_chaste_interface__membrane_potential__V_m * mParameters[7] / (-1.0 + var_x44);
        const double var_x46 = var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f;
        const double var_x47 = var_x46 * ((var_x43) ? (-var_x41 + (0.5 + 374358.83507802623 * var_chaste_interface__membrane_potential__V_m) * (var_x41 + var_x36 * var_x37)) : (2.6604556187875876 * var_x44 * var_x45));
        const double var_x48 = exp(-0.027328194960695912 * var_chaste_interface__membrane_potential__V_m);
        const double var_x49 = pow(mParameters[6], 3);
        const double var_x50 = var_x48 * var_x49;
        const double var_x51 = pow(var_chaste_interface__Na_Concentrations__Na_j, 3);
        const double var_x52 = var_x51 * mParameters[4];
        const double var_x53 = var_x49 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x54 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_j) * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x55 = var_x49 * (1.0 + 0.00053869674493876331 * var_x51);
        const double var_x56 = 1 / (var_x52 + var_x53 + 669921.875 * var_x54 + 1.3 * var_x51 + 0.0035899999999999999 * var_x55);
        const double var_x57 = pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2);
        const double var_x58 = 1.0 + 2.2499999999999996e-8 / var_x57;
        const double var_x59 = mParameters[16] / (1.0 + 0.32000000000000001 * var_x48);
        const double var_x60 = var_x59 / var_x58;
        const double var_x61 = var_x56 * var_x60;
        const double var_x62 = var_x50 * var_x61;
        const double var_x63 = -669921.875 - var_x49;
        const double var_x64 = var_x63 - 373215529.24791086 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x65 = exp(0.010107688547106707 * var_chaste_interface__membrane_potential__V_m);
        const double var_x66 = var_x52 * var_x65 - var_x48 * var_x53;
        const double var_x67 = var_x60 * var_x66 / pow((var_x54 + 1.9405247813411081e-6 * var_x51 + 5.3588338192419823e-9 * var_x55 + 1.4927113702623908e-6 * var_x52 + 1.4927113702623908e-6 * var_x53), 2);
        const double var_x68 = 4.9020119168033731e-13 * var_x67;
        const double var_x69 = var_x56 * var_x59 * var_x66 / (pow(var_x58, 2) * pow(var_chaste_interface__Ca_Concentrations__Ca_j, 3));
        const double var_x70 = var_x7 * mParameters[18];
        const double var_x71 = 915110855.46836066 * var_x70;
        const double var_x72 = -0.34100000000000003 * mParameters[4];
        const double var_x73 = 0.34100000000000003 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x74 = 1.042038e-5 * mParameters[7];
        const double var_x75 = var_x35 * var_x74;
        const double var_x76 = var_x39 * var_x74;
        const double var_x77 = var_x76 * (var_x72 + var_x38 * var_x73);
        const double var_x78 = 0.5 + 374358.83507802623 * var_chaste_interface__membrane_potential__V_m;
        const double var_x79 = 7.8019226357407252 * var_x45;
        const double var_x80 = var_x46 * var_x70;
        const double var_x81 = 100.0 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x82 = pow(var_chaste_interface__Na_Concentrations__Na_j, 2);
        const double var_x83 = 3 * mParameters[4];
        const double var_x84 = 5.8017639429904805e-6 * var_x49;
        const double var_x85 = -3.9000000000000004 * var_x82 - var_x82 * var_x83 - var_x82 * var_x84;
        const double var_x86 = var_x65 * mParameters[4];
        const double var_x87 = var_x61 * var_x82 * var_x86;
        ...
        const double var_x90 = 5.2281977629563632e-6 + pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 1.6000000000000001);
        const double var_x91 = 0.044999999999999991 - 0.044999999999999991 * var_chaste_interface__I_Ca__f_Ca_Bsl;
        const double var_x92 = pow(var_chaste_interface__Na_Concentrations__Na_sl, 3);
        const double var_x93 = var_x92 * mParameters[4];
        const double var_x94 = var_x49 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x95 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_sl) * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x96 = var_x49 * (1.0 + 0.00053869674493876331 * var_x92);
        const double var_x97 = 1 / (var_x93 + var_x94 + 669921.875 * var_x95 + 1.3 * var_x92 + 0.0035899999999999999 * var_x96);
        const double var_x98 = 1.0 + 2.2499999999999996e-8 / pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2);
        const double var_x99 = var_x59 / var_x98;
        const double var_x100 = var_x97 * var_x99;
        const double var_x101 = var_x100 * var_x50;
        const double var_x102 = var_x63 - 373215529.24791086 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x103 = var_x65 * var_x93 - var_x48 * var_x94;
        ...
        const double var_x106 = var_x103 * var_x59 * var_x97 / (pow(var_x98, 2) * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 3));
        const double var_x107 = 24662237.554872319 * var_x70;
        const double var_x108 = 0.34100000000000003 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x109 = var_x76 * (var_x72 + var_x108 * var_x38);
        const double var_x110 = 100.0 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x111 = pow(var_chaste_interface__Na_Concentrations__Na_sl, 2);
        const double var_x112 = -3.9000000000000004 * var_x111 - var_x111 * var_x83 - var_x111 * var_x84;
        const double var_x113 = var_x100 * var_x111 * var_x86;
        const double var_x114 = -var_x19;
        const double var_x115 = -var_x21;
        const double var_x116 = -var_x81;
        const double var_x117 = -var_x110;
        const double var_x118 = 0.0001 * var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x119 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bj;
        const double var_x120 = 0.0001 * var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x121 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bsl;
        const double var_x122 = var_x7 * mParameters[3];
        const double var_x123 = 0.23994508763098885 * var_x122;
        const double var_x124 = 7.3530178752050587e-13 * var_x67;
        const double var_x125 = var_x122 * mParameters[18];
        const double var_x126 = -0.75 * mParameters[6];
        const double var_x127 = 0.75 * var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x128 = 7.236374999999999e-11 * var_x35;
        const double var_x129 = 7.236374999999999e-11 * var_x39;
        const double var_x130 = var_x129 * (var_x126 + var_x127 * var_x38);
        const double var_x131 = 0.5 + 187179.41753901311 * var_chaste_interface__membrane_potential__V_m;
        const double var_x132 = var_x42 < 2.6712338705498262e-6;
        const double var_x133 = 0.037435883507802616 * var_chaste_interface__membrane_potential__V_m;
        const double var_x134 = exp(var_x133);
        const double var_x135 = var_chaste_interface__membrane_potential__V_m / (-1.0 + var_x134);
        const double var_x136 = 2.7090009151877515e-5 * var_x135;
        const double var_x137 = var_x125 * var_x46;
        const double var_x138 = 3.2338732908121872 * var_x7;
        const double var_x139 = 1 / var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x140 = 5.4272812499999995e-11 * var_x40;
        const double var_x141 = var_x46 * ((var_x132) ? (-var_x140 + (0.5 + 187179.41753901311 * var_chaste_interface__membrane_potential__V_m) * (var_x140 + 5.4272812499999995e-11 * var_x36)) : (2.0317506863908137e-5 * var_x134 * var_x135));
        const double var_x142 = pow(var_chaste_interface__I_Na__m, 3) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * mParameters[8];
        const double var_x143 = mParameters[17] * mParameters[5] / ((1.5 + mParameters[5]) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__membrane_potential__V_m) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[6])) * exp(-var_x133)));
        const double var_x144 = 5.9492599172113663e-12 * var_x104;
        const double var_x145 = 0.75 * var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x146 = var_x129 * (var_x126 + var_x145 * var_x38);
        const double var_x147 = 1 / var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x148 = 18.571428571428569 * mParameters[0];
        const double var_x149 = var_x30;
        const double var_x150 = 100.0 * var_chaste_interface__SR_Ca_Concentrations__Csqn_b;
        const double var_x151 = 100.0 * var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x152 = 1 / var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x153 = pow(var_x152, 2.5);
        const double var_x154 = 1.0 + 0.13584112963311223 * var_x153;
        const double var_x155 = 1 / var_x154;
        const double var_x156 = 7.0 * var_x155;
        const double var_x157 = 7.5 - var_x156;
        const double var_x158 = 1.0 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x159 = 1 / (15.0 - 14.0 * var_x155);
        const double var_x160 = 20.0 * var_x159 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x161 = var_x152 * var_x153 / pow(var_x154, 2);
        const double var_x162 = 2.3772197685794643 * var_x161 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x163 = var_x162 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x164 = 0.21130842387373014 * var_x161 * var_x57 / pow((1 - 0.93333333333333335 * var_x155), 2);
        const double var_x165 = 10.0 * var_x159 * var_x57;
        const double var_x166 = -var_x165;
        const double var_x167 = -7.5 + var_x156;
        const double var_x168 = var_x160 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x169 = var_x164 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x170 = var_x167 * var_chaste_interface__Ca_Concentrations__Ca_j;
        ...
        rJacobian[0][26] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (-75.37105751391465 + var_x26 + var_x27 - var_x28 - var_x29 - var_x31 - var_x71 * (0.22 * var_x62 + 0.00080995817805876559 / var_chaste_interface__Ca_Concentrations__Ca_j - 9.8999999999999977e-9 * var_x69 + var_x33 * var_x47 - var_x64 * var_x68 + 0.011844800000000001 * pow(var_chaste_interface__Ca_Concentrations__Ca_j, 0.60000000000000009) / var_x32 - 0.011844800000000001 * pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2.2000000000000002) / pow(var_x32, 2))));
        ...
        rJacobian[1][8] = 0.0;
        rJacobian[1][9] = 0.0;
        rJacobian[1][10] = -(mDt * (370619896.46468604 * var_x80 * ((var_x43) ? (-var_x77 + var_x78 * (var_x77 + var_x75 * (var_x72 + var_x34 * var_x73))) : (var_x79 * (var_x72 + var_x44 * var_x73)))));
        rJacobian[1][11] = 0.0;
        rJacobian[1][12] = -(mDt * (0.029999999999999999 + var_x81));
        rJacobian[1][13] = 0.0;
        rJacobian[1][14] = -(mDt * (1.3 + var_x81));
        rJacobian[1][15] = 0.0;
        rJacobian[1][16] = 0.0;
        rJacobian[1][17] = 0.0;
        rJacobian[1][18] = 0.0;
        rJacobian[1][19] = 0.0;
        rJacobian[1][20] = -(mDt * (-var_x71 * (-0.66000000000000003 * var_x87 - var_x68 * var_x85)));
        rJacobian[1][21] = 0.0;
        ...
        rJacobian[2][2] = 1.0 - (mDt * (-165.10000000000002 + var_x88 + var_x89 - 19.504723378941105 * var_x7 - var_x107 * (1.78 * var_x101 + 0.0065532979861118307 / var_chaste_interface__Ca_Concentrations__Ca_sl - 8.0099999999999983e-8 * var_x106 + var_x47 * var_x91 - var_x102 * var_x105 + 0.095835200000000009 * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 0.60000000000000009) / var_x90 - 0.095835200000000009 * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2.2000000000000002) / pow(var_x90, 2))));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        ...
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = -(mDt * (1109800.6899692542 * var_x80 * ((var_x43) ? (-var_x109 + var_x78 * (var_x109 + var_x75 * (var_x72 + var_x108 * var_x34))) : (var_x79 * (var_x72 + var_x108 * var_x44)))));
        rJacobian[2][12] = 0.0;
        rJacobian[2][13] = -(mDt * (0.029999999999999999 + var_x110));
        rJacobian[2][14] = 0.0;
        rJacobian[2][15] = -(mDt * (1.3 + var_x110));
        rJacobian[2][16] = 0.0;
        rJacobian[2][17] = 0.0;
        rJacobian[2][18] = 0.0;
        rJacobian[2][19] = 0.0;
        rJacobian[2][20] = 0.0;
        rJacobian[2][21] = -(mDt * (-var_x107 * (-5.3399999999999999 * var_x113 - var_x105 * var_x112)));
        rJacobian[2][22] = 0.0;
        rJacobian[2][23] = 0.0;
        rJacobian[2][24] = 0.0;
        rJacobian[2][25] = 0.0;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-0.00046000000000000001 + var_x114));
        rJacobian[4][5] = -(mDt * (var_x114));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        ...
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-3.1999999999999999e-5 + var_x115));
        rJacobian[7][8] = -(mDt * (var_x115));
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[7][12] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-0.029999999999999999 + var_x116));
        rJacobian[12][13] = 0.0;
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        ...
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = -(mDt * (43.550000000000004 - var_x88));
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = 0.0;
        ...
        rJacobian[13][11] = 0.0;
        rJacobian[13][12] = 0.0;
        rJacobian[13][13] = 1.0 - (mDt * (-0.029999999999999999 + var_x117));
        rJacobian[13][14] = 0.0;
        rJacobian[13][15] = 0.0;
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-1.3 + var_x116));
        rJacobian[14][15] = 0.0;
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        ...
        rJacobian[15][0] = 0.0;
        rJacobian[15][1] = 0.0;
        rJacobian[15][2] = -(mDt * (121.55000000000001 - var_x89));
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = 0.0;
        rJacobian[15][5] = 0.0;
        rJacobian[15][6] = 0.0;
        ...
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (-1.3 + var_x117));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = 0.0;
        rJacobian[17][17] = 1.0 - (mDt * (-0.001 - var_x118));
        rJacobian[17][18] = 0.0;
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = -(mDt * (0.0007561 - var_x119));
        rJacobian[17][21] = 0.0;
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = 0.0;
        rJacobian[17][24] = 0.0;
        ...
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-0.001 - var_x120));
        rJacobian[18][19] = 0.0;
        rJacobian[18][20] = 0.0;
        rJacobian[18][21] = -(mDt * (0.000165 - var_x121));
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        rJacobian[18][25] = 0.0;
        ...
        rJacobian[19][17] = 0.0;
        rJacobian[19][18] = 0.0;
        rJacobian[19][19] = 1.0 - (mDt * (-var_x123));
        rJacobian[19][20] = 0.0;
        rJacobian[19][21] = -(mDt * (var_x123));
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = 0.0;
        rJacobian[19][26] = 0.0;
        rJacobian[20][0] = 0.0;
        rJacobian[20][1] = -(mDt * (-1830221710.9367213 * var_x125 * (1.4849999999999997e-8 * var_x69 - 0.33000000000000002 * var_x62 + var_x124 * var_x64)));
        rJacobian[20][2] = 0.0;
        rJacobian[20][3] = 0.0;
        rJacobian[20][4] = 0.0;
        rJacobian[20][5] = 0.0;
        ...
        rJacobian[20][8] = 0.0;
        rJacobian[20][9] = 0.0;
        rJacobian[20][10] = -(mDt * (741239792.92937207 * var_x137 * ((var_x132) ? (-var_x130 + var_x131 * (var_x130 + var_x128 * (var_x126 + var_x127 * var_x34))) : (var_x136 * (var_x126 + var_x127 * var_x134)))));
        rJacobian[20][11] = 0.0;
        rJacobian[20][12] = 0.0;
        rJacobian[20][13] = 0.0;
        rJacobian[20][14] = 0.0;
        rJacobian[20][15] = 0.0;
        rJacobian[20][16] = 0.0;
        rJacobian[20][17] = -(mDt * ((0.001 + var_x118) * mParameters[3]));
        rJacobian[20][18] = 0.0;
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * ((-0.0007561 + var_x119 - var_x138 - 1830221710.9367213 * var_x70 * (0.98999999999999999 * var_x87 + 0.001754199282790071 * var_x139 + var_x124 * var_x85 + var_x141 * var_x33 + 2.9383572576048089 * var_x139 * var_x142 + 9.0157776108189337e-5 * var_x143 / (pow((6.8301345536507063e-5 + pow(var_chaste_interface__Na_Concentrations__Na_j, (-4))), 2) * pow(var_chaste_interface__Na_Concentrations__Na_j, 5)))) * mParameters[3]));
        rJacobian[20][21] = -(mDt * (var_x138 * mParameters[3]));
        rJacobian[20][22] = 0.0;
        rJacobian[20][23] = 0.0;
        rJacobian[20][24] = 0.0;
        rJacobian[20][25] = 0.0;
        ...
        rJacobian[21][0] = 0.0;
        rJacobian[21][1] = 0.0;
        rJacobian[21][2] = -(mDt * (-49324475.109744638 * var_x125 * (1.2014999999999997e-7 * var_x106 - 2.6699999999999999 * var_x101 + var_x102 * var_x144)));
        rJacobian[21][3] = 0.0;
        rJacobian[21][4] = 0.0;
        rJacobian[21][5] = 0.0;
        rJacobian[21][6] = 0.0;
        ...
        rJacobian[21][9] = 0.0;
        rJacobian[21][10] = 0.0;
        rJacobian[21][11] = -(mDt * (2219601.3799385084 * var_x137 * ((var_x132) ? (-var_x146 + var_x131 * (var_x146 + var_x128 * (var_x126 + var_x145 * var_x34))) : (var_x136 * (var_x126 + var_x134 * var_x145)))));
        rJacobian[21][12] = 0.0;
        rJacobian[21][13] = 0.0;
        rJacobian[21][14] = 0.0;
        rJacobian[21][15] = 0.0;
        rJacobian[21][16] = 0.0;
        rJacobian[21][17] = 0.0;
        rJacobian[21][18] = -(mDt * ((0.001 + var_x120) * mParameters[3]));
        rJacobian[21][19] = -(mDt * (7.7982153480071377 * var_x122));
        rJacobian[21][20] = -(mDt * (0.087152885187388451 * var_x122));
        rJacobian[21][21] = 1.0 - (mDt * ((-0.000165 + var_x121 - 7.8853682331945256 * var_x7 - 49324475.109744638 * var_x70 * (0.014193066924392391 * var_x147 + 8.0099999999999998 * var_x113 + var_x112 * var_x144 + var_x141 * var_x91 + 23.773981447893455 * var_x142 * var_x147 + 0.00072945837032989554 * var_x143 / (pow((6.8301345536507063e-5 + pow(var_chaste_interface__Na_Concentrations__Na_sl, (-4))), 2) * pow(var_chaste_interface__Na_Concentrations__Na_sl, 5)))) * mParameters[3]));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        ...
        rJacobian[22][1] = -(mDt * (var_x148 + var_x149));
        rJacobian[22][2] = 0.0;
        rJacobian[22][3] = 0.0;
        rJacobian[22][4] = 0.0;
        rJacobian[22][5] = 0.0;
        ...
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (-260.0 + var_x150 - var_x148 - var_x149 - 0.69232869146389786 * var_x24 - 8.7400597733819945e-14 * var_x25));
        rJacobian[22][23] = -(mDt * (65.0 + var_x151));
        rJacobian[22][24] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (260.0 - var_x150));
        rJacobian[23][23] = 1.0 - (mDt * (-65.0 - var_x151));
        rJacobian[23][24] = 0.0;
        rJacobian[23][25] = 0.0;
        rJacobian[23][26] = 0.0;
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = -(mDt * (var_x157 * var_chaste_interface__SR_Fluxes__Ry_Ro + var_x158 * var_x160));
        rJacobian[24][2] = 0.0;
        rJacobian[24][3] = 0.0;
        rJacobian[24][4] = 0.0;
        rJacobian[24][5] = 0.0;
        ...
        rJacobian[24][20] = 0.0;
        rJacobian[24][21] = 0.0;
        rJacobian[24][22] = -(mDt * (-var_x163 + var_x158 * var_x164));
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-0.065000000000000002 + var_x166));
        rJacobian[24][25] = -(mDt * (var_x166 + var_x157 * var_chaste_interface__Ca_Concentrations__Ca_j));
        rJacobian[24][26] = -(mDt * (var_x166));
        rJacobian[25][0] = 0.0;
        rJacobian[25][1] = -(mDt * (var_x168 + var_x167 * var_chaste_interface__SR_Fluxes__Ry_Ro));
        rJacobian[25][2] = 0.0;
        rJacobian[25][3] = 0.0;
        rJacobian[25][4] = 0.0;
        rJacobian[25][5] = 0.0;
        ...
        rJacobian[25][20] = 0.0;
        rJacobian[25][21] = 0.0;
        rJacobian[25][22] = -(mDt * (var_x163 + var_x169));
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = -(mDt * (0.0050000000000000001));
        rJacobian[25][25] = 1.0 - (mDt * (-0.059999999999999998 + var_x170));
        rJacobian[25][26] = -(mDt * (var_x165));
        rJacobian[26][0] = 0.0;
        rJacobian[26][1] = -(mDt * (-var_x168 + var_x167 * var_chaste_interface__SR_Fluxes__Ry_Rr));
        rJacobian[26][2] = 0.0;
        rJacobian[26][3] = 0.0;
        rJacobian[26][4] = 0.0;
        rJacobian[26][5] = 0.0;
        ...
        rJacobian[26][20] = 0.0;
        rJacobian[26][21] = 0.0;
        rJacobian[26][22] = -(mDt * (-var_x169 + var_x162 * var_chaste_interface__SR_Fluxes__Ry_Rr));
        rJacobian[26][23] = 0.0;
        rJacobian[26][24] = -(mDt * (-0.0050000000000000001));
        rJacobian[26][25] = -(mDt * (0.055));
        rJacobian[26][26] = 1.0 - (mDt * (-0.0050000000000000001 + var_x166 + var_x170));
    }

    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        CardiacNewtonSolver<27,Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<27,Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut>::Initialise(void)
{
