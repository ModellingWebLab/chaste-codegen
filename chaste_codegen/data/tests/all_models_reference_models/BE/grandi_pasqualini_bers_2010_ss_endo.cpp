...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[27], double rJacobian[27][27])
    {
        ...
        const double var_x33 = exp(-0.027328194960695912 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x50 = exp(0.010107688547106707 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x57 = exp(0.074871767015605231 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x117 = mParameters[17] * mParameters[5] / ((1.5 + mParameters[5]) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__membrane_potential__V_m) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[6])) * exp(-var_x109)));
