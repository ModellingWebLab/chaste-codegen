...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celldemir_model_1994FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[16], double rJacobian[16][16])
    {
        ...
        const double var_x5 = var_x1 * var_chaste_interface__SR_Ca_uptake_and_release__F2;
        const double var_x6 = var_x2 / pow(var_x0, 3);
        ...
        const double var_x11 = pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i, 4);
        const double var_x12 = 0.0040000000000000001 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x13 = pow(var_x12, (-4));
        const double var_x14 = 0.23999999999999999 * var_x11 * var_x13;
        const double var_x15 = -var_x14;
        const double var_x16 = 0.95999999999999996 * var_x13 * pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i, 3);
        const double var_x17 = 0.95999999999999996 * var_x11 / pow(var_x12, 5);
        const double var_x18 = var_x17 - var_x16;
        const double var_x19 = var_x16 - var_x17;
        const double var_x20 = 1 / var_chaste_interface__cleft_space_equations__Ca_c;
        const double var_x21 = pow(var_chaste_interface__cleft_space_equations__Na_c, 3);
        const double var_x22 = var_x21 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x23 = pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i, 3);
        const double var_x24 = var_x23 * var_chaste_interface__cleft_space_equations__Ca_c;
        const double var_x25 = 1.0 + 0.0001 * var_x22 + 0.0001 * var_x24;
        const double var_x26 = 1 / var_x25;
        const double var_x27 = 2.7196856284372236e-7 * var_x26;
        const double var_x28 = 0.018714999999999999 * var_chaste_interface__membrane__V;
        const double var_x29 = exp(var_x28);
        const double var_x30 = var_x23 * var_x29;
        const double var_x31 = exp(-var_x28);
        const double var_x32 = (var_x24 * var_x29 - var_x22 * var_x31) / pow(var_x25, 2);
        const double var_x33 = 2.7196856284372237e-11 * var_x32;
        const double var_x34 = 8.1590568853116704e-7 * var_x26;
        ...
        const double var_x37 = 8.159056885311671e-11 * var_x32;
        ...
        const double var_x42 = var_x21 * var_x31;
        ...
        const double var_x52 = 1 / (1.5 + exp(-1.5 - 0.025000000000000001 * var_chaste_interface__membrane__V));
        const double var_x53 = 0.621 + var_chaste_interface__cleft_space_equations__K_c;
        const double var_x54 = pow(var_x53, (-2));
        const double var_x55 = var_x52 * var_x54;
        const double var_x56 = var_x23 * var_x55 * var_chaste_interface__cleft_space_equations__K_c;
        const double var_x57 = pow(var_chaste_interface__cleft_space_equations__K_c, 2);
        const double var_x58 = var_x23 * var_x52 * var_x57;
        const double var_x59 = var_x58 / pow(var_x53, 3);
        const double var_x60 = 1 / var_chaste_interface__intracellular_concentrations_and_buffer_equations__K_i;
        const double var_x61 = 0.00028173316601141397 * var_x50;
        const double var_x62 = var_x43 * var_x55 * var_x57;
        const double var_x63 = var_x54 * var_x58 / pow(var_x49, 4);
        const double var_x64 = 1 / var_chaste_interface__cleft_space_equations__Na_c;
        const double var_x65 = 2.447717065593501e-6 * var_x26;
        const double var_x66 = 0.037433890822745473 * var_chaste_interface__membrane__V;
        const double var_x67 = 1 / var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i;
        const double var_x68 = var_x67 * var_chaste_interface__cleft_space_equations__Na_c;
        const double var_x69 = exp(var_x66 - 1.0 * log(var_x68));
        const double var_x70 = pow(var_chaste_interface__sodium_current_m_gate__m, 3) * var_chaste_interface__membrane__V * var_chaste_interface__sodium_current_h_gate__h1 * var_chaste_interface__sodium_current_h_gate__h2 / (-1.0 + exp(var_x66));
        const double var_x71 = var_x69 * var_x70;
        const double var_x72 = 0.27076272189238759 * var_x71;
        const double var_x73 = var_x70 * (-1.0 + var_x69);
        const double var_x74 = 2.4477170655935014e-10 * var_x32;
        const double var_x75 = var_x50 * var_x62;
        ...
        const double var_x78 = 7.9543493648916641e-8 * var_x26;
        const double var_x79 = 7.9543493648916655e-12 * var_x32;
        const double var_x80 = 2.3863048094674991e-7 * var_x26;
        const double var_x81 = 2.3863048094674993e-11 * var_x32;
        ...
        const double var_x86 = 7.1589144284024978e-7 * var_x26;
        const double var_x87 = 0.079190817585730572 * var_x71;
        const double var_x88 = 7.158914428402498e-11 * var_x32;
        ...
        rJacobian[1][3] = 0.0;
        rJacobian[1][4] = -(mDt * (var_x4 * var_x6 - var_x4 * var_x5));
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[1][7] = 0.0;
        rJacobian[1][8] = 0.0;
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.10000000000000001 - 5.2976168399354324e-6 * var_x20 + var_x23 * var_x33 - var_x27 * var_x30));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = -(mDt * (var_x34 * var_x36 + var_x35 * var_x37));
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = 0.0;
        rJacobian[6][12] = -(mDt * (0.00031261130080073693 * var_x40 + 5.2976168399354324e-6 * var_x38 - 0.00031261130080073693 * var_x41 + var_x21 * var_x33 + var_x27 * var_x42));
        rJacobian[6][13] = 0.0;
        rJacobian[6][14] = 0.0;
        ...
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-0.10000000000000001 - 4.040160535071638e-5 * var_x46 + var_x51 * var_x59 - var_x46 * var_x48 - var_x51 * var_x56));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        ...
        rJacobian[7][14] = 0.0;
        rJacobian[7][15] = -(mDt * (5.1599480954471424e-5 * var_x63 - var_x61 * var_x62));
        rJacobian[8][0] = 0.0;
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = 0.0;
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = -(mDt * (var_x30 * var_x34 - var_x23 * var_x37));
        rJacobian[8][7] = -(mDt * (var_x56 * var_x61 - var_x59 * var_x61));
        rJacobian[8][8] = 1.0 - (mDt * (-0.10000000000000001 - var_x72 + 0.27076272189238759 * var_x73 - 9.3144911471392233e-5 * var_x64 - var_x35 * var_x74 - var_x36 * var_x65));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = -(mDt * (-var_x21 * var_x37 - var_x34 * var_x42));
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = 0.0;
        rJacobian[8][15] = -(mDt * (0.00042259974901712096 * var_x75 + 9.3144911471392233e-5 * var_x67 - 7.739922143170714e-5 * var_x63 + var_x45 * var_x65 + var_x68 * var_x72 - var_x44 * var_x74));
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = 0.0;
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = 0.0;
        ...
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (var_x5 * var_x77 - var_x6 * var_x77));
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = -(mDt * (1.5494105166262771e-6 * var_x20 + var_x30 * var_x78 - var_x23 * var_x79));
        rJacobian[12][7] = 0.0;
        ...
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = -(mDt * (1.1816383500424576e-5 * var_x46 + var_x46 * var_x83 + var_x56 * var_x84 - var_x59 * var_x84));
        rJacobian[13][8] = 0.0;
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = 0.0;
        rJacobian[13][11] = 0.0;
        ...
        rJacobian[13][14] = 0.0;
        rJacobian[13][15] = -(mDt * (8.2399377586133985e-5 * var_x75 - 1.5091461096361535e-5 * var_x63));
        rJacobian[14][0] = 0.0;
        rJacobian[14][1] = 0.0;
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = 0.0;
        ...
        rJacobian[15][4] = 0.0;
        rJacobian[15][5] = 0.0;
        rJacobian[15][6] = -(mDt * (var_x23 * var_x81 - var_x30 * var_x80));
        rJacobian[15][7] = -(mDt * (var_x59 * var_x85 - var_x56 * var_x85));
        rJacobian[15][8] = -(mDt * (var_x87 + 2.7242382709912566e-5 * var_x64 - 0.079190817585730572 * var_x73 + var_x35 * var_x88 + var_x36 * var_x86));
        rJacobian[15][9] = 0.0;
        rJacobian[15][10] = 0.0;
        rJacobian[15][11] = 0.0;
        rJacobian[15][12] = -(mDt * (var_x21 * var_x81 + var_x42 * var_x80));
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (2.2637191644542304e-5 * var_x63 - 0.00012359906637920097 * var_x75 - 2.7242382709912566e-5 * var_x67 + var_x44 * var_x88 - var_x45 * var_x86 - var_x68 * var_x87));
    }
