...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellgrandi2010ssFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__cell__time, const double rCurrentGuess[26], double rJacobian[26][26])
    {
        ...
        const double var_x17 = 13.800000000000001 * var_chaste_interface__cell__sMyoc;
        const double var_x18 = 13.800000000000001 * var_chaste_interface__cell__sMyom;
        const double var_x19 = 100.0 * var_chaste_interface__cell__sSRB;
        const double var_x20 = 2.3700000000000001 * var_chaste_interface__cell__sTnCHc;
        const double var_x21 = 2.3700000000000001 * var_chaste_interface__cell__sTnCHm;
        const double var_x22 = 32.700000000000003 * var_chaste_interface__cell__sTnCL;
        ...
        const double var_x34 = 1.0 - var_chaste_interface__cell__sfcaBj;
        const double var_x35 = exp(0.074871767015605231 * var_chaste_interface__cell__sVm);
        const double var_x36 = var_chaste_interface__cell__sVm * var_chaste_interface__cell__sd * var_chaste_interface__cell__sf;
        const double var_x37 = var_x36 / (-1.0 + var_x35);
        const double var_x38 = var_x35 * var_x37;
        const double var_x39 = exp(-0.027328194960695912 * var_chaste_interface__cell__sVm);
        const double var_x40 = 1 / (1.0 + 0.32000000000000001 * var_x39);
        const double var_x41 = var_x39 * var_x40;
        const double var_x42 = pow(var_chaste_interface__cell__sCaj, 2);
        const double var_x43 = 1.0 + 2.2499999999999996e-8 / var_x42;
        const double var_x44 = 1 / var_x43;
        const double var_x45 = 2744000.0 * var_chaste_interface__cell__sCaj;
        const double var_x46 = pow(var_chaste_interface__cell__sNaj, 3);
        const double var_x47 = (1.0 + 278.55153203342621 * var_chaste_interface__cell__sCaj) * var_chaste_interface__cell__sCaj;
        const double var_x48 = 1 / (9850.9599999999991 + var_x45 + 669921.875 * var_x47 + 8.4066800865219591 * var_x46);
        const double var_x49 = var_x44 * var_x48;
        const double var_x50 = var_x41 * var_x49;
        const double var_x51 = exp(0.010107688547106707 * var_chaste_interface__cell__sVm);
        const double var_x52 = 1.8 * var_x51;
        const double var_x53 = var_x40 * (var_x46 * var_x52 - var_x39 * var_x45);
        const double var_x54 = var_x48 * var_x53 / (pow(var_x43, 2) * pow(var_chaste_interface__cell__sCaj, 3));
        const double var_x55 = var_x44 * var_x53 / pow((0.0035899999999999999 + 0.244140625 * var_x47 + 3.0636589236596063e-6 * var_x46 + var_chaste_interface__cell__sCaj), 2);
        const double var_x56 = var_x55 * (-3413921.875 - 373215529.24791086 * var_chaste_interface__cell__sCaj);
        const double var_x57 = 0.1263768091401806 * var_x23;
        const double var_x58 = pow(var_chaste_interface__cell__sNaj, 2);
        const double var_x59 = var_x40 * var_x51;
        const double var_x60 = var_x49 * var_x58 * var_x59;
        const double var_x61 = var_x55 * var_x58;
        const double var_x62 = 100.0 * var_chaste_interface__cell__sCaj;
        const double var_x63 = 0.34100000000000003 * var_x35;
        const double var_x64 = var_x23 * var_x37;
        ...
        const double var_x69 = 1.0 + 2.2499999999999996e-8 / pow(var_chaste_interface__cell__sCasl, 2);
        const double var_x70 = 1 / var_x69;
        const double var_x71 = 2744000.0 * var_chaste_interface__cell__sCasl;
        const double var_x72 = pow(var_chaste_interface__cell__sNasl, 3);
        const double var_x73 = (1.0 + 278.55153203342621 * var_chaste_interface__cell__sCasl) * var_chaste_interface__cell__sCasl;
        const double var_x74 = 1 / (9850.9599999999991 + var_x71 + 669921.875 * var_x73 + 8.4066800865219591 * var_x72);
        const double var_x75 = var_x70 * var_x74;
        const double var_x76 = var_x41 * var_x75;
        const double var_x77 = var_x40 * (var_x52 * var_x72 - var_x39 * var_x71);
        const double var_x78 = var_x74 * var_x77 / (pow(var_x69, 2) * pow(var_chaste_interface__cell__sCasl, 3));
        const double var_x79 = var_x70 * var_x77 / pow((0.0035899999999999999 + 0.244140625 * var_x73 + 3.0636589236596063e-6 * var_x72 + var_chaste_interface__cell__sCasl), 2);
        const double var_x80 = var_x79 * (-3413921.875 - 373215529.24791086 * var_chaste_interface__cell__sCasl);
        const double var_x81 = 0.0034058550063278672 * var_x23;
        const double var_x82 = pow(var_chaste_interface__cell__sNasl, 2);
        const double var_x83 = var_x59 * var_x75 * var_x82;
        const double var_x84 = var_x79 * var_x82;
        ...
        const double var_x95 = pow(var_chaste_interface__cell__sm, 3) * var_chaste_interface__cell__sh * var_chaste_interface__cell__sj;
        const double var_x96 = 0.037435883507802616 * var_chaste_interface__cell__sVm;
        const double var_x97 = exp(var_x96);
        const double var_x98 = var_x36 / (-1.0 + var_x97);
        const double var_x99 = var_x97 * var_x98;
        const double var_x100 = 1 / (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__cell__sVm) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x96));
        const double var_x101 = 0.75 * var_x97;
        const double var_x102 = var_x23 * var_x98;
        ...
        const double var_x113 = 0.21130842387373014 * var_x108 * var_x42 / pow((1 - 0.93333333333333335 * var_x112), 2);
        ...
        const double var_x118 = 10.0 * var_x116 * var_x42;
        ...
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = -(mDt * (-var_x57 * (3.3159865172263233e-12 * var_x61 - 5.3460000000000001 * var_x60)));
        rJacobian[3][12] = 0.0;
        rJacobian[3][13] = 0.0;
        ...
        rJacobian[4][4] = 1.0 - (mDt * (-165.10000000000002 + var_x65 + var_x66 - 21.646099331949777 * var_x23 - var_x81 * (21979440.0 * var_x76 + 0.0065532979861118307 / var_chaste_interface__cell__sCasl - 1.0638105721255599e-12 * var_x80 - 3.6044999999999992e-7 * var_x78 + 0.095835200000000009 * pow(var_chaste_interface__cell__sCasl, 0.60000000000000009) / var_x67 + 0.059860251422720709 * var_x38 * var_x68 - 0.095835200000000009 * pow(var_chaste_interface__cell__sCasl, 2.2000000000000002) / pow(var_x67, 2))));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        ...
        rJacobian[4][10] = 0.0;
        rJacobian[4][11] = 0.0;
        rJacobian[4][12] = -(mDt * (-var_x81 * (2.6829345457558432e-11 * var_x84 - 43.253999999999998 * var_x83)));
        rJacobian[4][13] = 0.0;
        rJacobian[4][14] = 0.0;
        rJacobian[4][15] = 0.0;
        rJacobian[4][16] = 0.0;
        ...
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = -(mDt * (1.9320000000000004 - var_x17 - var_x18));
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        ...
        rJacobian[11][1] = 0.0;
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = -(mDt * (-var_x92 * (1.9722330831541279e-13 * var_x56 + 6.6824999999999991e-8 * var_x54 - 4074840.0 * var_x50)));
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        ...
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (-0.0007561 + var_x88 - var_x93 - var_x92 * (8.0190000000000001 * var_x60 + 0.001754199282790071 * var_x94 - 4.973979775839485e-12 * var_x61 + 8.228590279882795e-6 * var_x34 * var_x99 + 67.582216924910611 * var_x94 * var_x95 + 0.0001270048672132754 * var_x100 / (pow((6.8301345536507063e-5 + pow(var_chaste_interface__cell__sNaj, (-4))), 2) * pow(var_chaste_interface__cell__sNaj, 5)))));
        ...
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (-var_x103 * (5.4067499999999991e-7 * var_x78 + 1.5957158581883399e-12 * var_x80 - 32969160.0 * var_x76)));
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = 0.0;
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        ...
        rJacobian[12][12] = 1.0 - (mDt * (-0.000165 + var_x90 - 7.8855000811034159 * var_x23 - var_x103 * (64.881 * var_x83 + 0.014193066924392391 * var_x104 - 4.0244018186337653e-11 * var_x84 + 9.1428780887586595e-7 * var_x68 * var_x99 + 546.80157330154941 * var_x104 * var_x95 + 0.001027584834725592 * var_x100 / (pow((6.8301345536507063e-5 + pow(var_chaste_interface__cell__sNasl, (-4))), 2) * pow(var_chaste_interface__cell__sNasl, 5)))));
        rJacobian[12][13] = 0.0;
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        ...
        rJacobian[20][0] = 0.0;
        rJacobian[20][1] = 0.0;
        rJacobian[20][2] = -(mDt * (1.71 - var_x19));
        rJacobian[20][3] = 0.0;
        rJacobian[20][4] = 0.0;
        rJacobian[20][5] = 0.0;
        rJacobian[20][6] = 0.0;
        ...
        rJacobian[21][0] = 0.0;
        rJacobian[21][1] = 0.0;
        rJacobian[21][2] = -(mDt * (0.33180000000000004 - var_x20 - var_x21));
        rJacobian[21][3] = 0.0;
        rJacobian[21][4] = 0.0;
        rJacobian[21][5] = 0.0;
        rJacobian[21][6] = 0.0;
        ...
        rJacobian[23][0] = 0.0;
        rJacobian[23][1] = 0.0;
        rJacobian[23][2] = -(mDt * (2.2890000000000006 - var_x22));
        rJacobian[23][3] = 0.0;
        rJacobian[23][4] = 0.0;
        rJacobian[23][5] = 0.0;
        rJacobian[23][6] = 0.0;
