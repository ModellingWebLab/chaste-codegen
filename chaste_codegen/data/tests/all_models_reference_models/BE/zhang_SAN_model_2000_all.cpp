...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellzhang_SAN_model_2000_allFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_hyperpolarisation_activated_current_y_gate__alpha_y = ((var_membrane__Version == 0) ? (1.0 * exp(-2.9643125469571747 - 0.037565740045078885 * var_chaste_interface__membrane__V)) : (1.0 * exp(-2.9631993991738641 - 0.037551633496057078 * var_chaste_interface__membrane__V)));
