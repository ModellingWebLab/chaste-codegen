...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        const double var_x50 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * (0031249999999999997 * var_chaste_interface__sodium_dynamics__Na_i + 0.10416666666666667 * var_chaste_interface__potassium_dynamics__K_i) / pow((029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i), 2);
        const double var_x51 = 1 / (1.0 + 035299999999999998 * exp(-037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0037433890822745472 * var_chaste_interface__membrane__V));
        const double var_x52 = var_x51 / (40 + var_chaste_interface__sodium_dynamics__Na_i);
        const double var_x53 = var_x51 * var_chaste_interface__sodium_dynamics__Na_i / pow((1 + 025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        ...
        rJacobian[5][3] = 0;
        rJacobian[5][4] = 0;
        rJacobian[5][5] = 1.0 - (mDt * (-0070502450209754628 * var_x50 - 7.3173394969065143e-5 * var_x49 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 7.0879642315114355e-5 * var_x49 / (1.0 + exp(0.29411764705882354 - 058823529411764705 * var_chaste_interface__membrane__V)) - 4.5587787568311439e-5 * var_x49 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) - 00020295932821508516 * var_x49 / (1.0 + exp(7.5440000000000005 + 0.10000000000000001 * var_chaste_interface__membrane__V)) - 00025554140647880875 * var_x49 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 0031224512033090025 * var_x49 * mParameters[4] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2));
        rJacobian[5][6] = -(mDt * (00053729341037579627 * var_x52 - 3.3580838148487267e-7 * var_x53 - 00021150735062926387 * var_x50));
        rJacobian[6][0] = 0;
        rJacobian[6][1] = 0;
        rJacobian[6][2] = -(mDt * (00020846623418995967 * var_x37));
        rJacobian[6][3] = 0;
        rJacobian[6][4] = 0;
        rJacobian[6][5] = 0;
        rJacobian[6][6] = 1.0 - (mDt * (5.0371257222730904e-7 * var_x53 - 1.823319832565245e-10 * var_x39 - 9.0551084895961074e-7 * var_x54 - 00080594011556369446 * var_x52 - 4.5479750756676942e-5 * var_x54 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 0031224512033090025 * var_x54 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * mParameters[1] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40) ? (057000000000000002 * exp(-11.764705882352942 + 0.14705882352941177 * mParameters[3] - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0));
        ...
        const double var_fast_sodium_current_h_gate__h_inf = 01 * mParameters[2] + 1.0 * (1.0 - 01 * mParameters[2]) / pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * mParameters[3])), 2);
        ...
        const double var_fast_sodium_current_j_gate__j_inf = 01 * mParameters[2] + 1.0 * (1.0 - 01 * mParameters[2]) / pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * mParameters[3])), 2);
        ...
        const double var_hyperpolarization_activated_current_y_gate__alpha_y = 1.0 * exp(-2.8999999999999999 - 040000000000000001 * var_chaste_interface__membrane__V);
        ...
        const double var_hyperpolarization_activated_current_y_gate__tau_y = 4000 / (var_hyperpolarization_activated_current_y_gate__alpha_y + var_hyperpolarization_activated_current_y_gate__beta_y);
        ...
        const double var_transient_outward_current_r_gate__r_inf = 1.0 / (1.0 + exp(1.5384615384615385 - 076923076923076927 * var_chaste_interface__membrane__V));
        const double var_transient_outward_current_r_gate__tau_r = 7.2999999999999998 + 10.449999999999999 * exp(-0.88888888888888884 * pow((1 + 025000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_transient_outward_current_s_gate__s_inf = 1.0 / (1.0 + exp(2.0769230769230771 + 076923076923076927 * var_chaste_interface__membrane__V));
        const double var_transient_outward_current_s_gate__tau_s = 42.0 + 5.0 / (1.0 + exp(-8.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(-1.953125 * pow((1 + 040000000000000001 * var_chaste_interface__membrane__V), 2));
