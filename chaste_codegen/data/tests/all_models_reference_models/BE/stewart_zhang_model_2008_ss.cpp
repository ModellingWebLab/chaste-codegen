...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        const double var_x6 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
        const double var_x7 = 1 / var_x6;
        const double var_x8 = -var_chaste_interface__calcium_dynamics__Ca_ss + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x9 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
        const double var_x10 = 1 / (1.0 + 2.25 * var_x9);
        const double var_x11 = 1 / (2.5 - 1.5 * var_x10);
        const double var_x12 = var_x0 * var_x11;
        const double var_x13 = 1 / (0.059999999999999998 + 0.14999999999999999 * var_x12);
        const double var_x14 = var_x13 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x15 = var_x12 * var_x14;
        const double var_x16 = 0.015299999999999998 * var_x15;
        const double var_x17 = 1 / (pow((0.44444444444444442 + var_x9), 2) * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3));
        const double var_x18 = var_x8 / pow((1 - 0.59999999999999998 * var_x10), 2);
        const double var_x19 = var_x0 * var_x14 * var_x17 * var_x18;
        const double var_x20 = var_x17 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x21 = var_x18 / pow((0.40000000000000002 + var_x12), 2);
        const double var_x22 = var_x11 * var_x20 * var_x21 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4);
        const double var_x23 = 1 / (1.0 + 3.0 * var_x5);
        const double var_x24 = 1.0 * var_x23;
        const double var_x25 = 1 / (pow(var_x6, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
        const double var_x26 = var_x11 * var_x14 * var_x8 * var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x27 = var_x21 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3) * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x28 = var_x12 * var_x13 * var_x8;
        ...
        const double var_x32 = 1 / var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x33 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x34 = 7.2352122917848019e-6 / var_x33;
        ...
        const double var_x46 = 0.30611192392099484 * var_x15;
        const double var_x47 = 1.0 * var_x42;
        const double var_x48 = -0.11249999999999999 + 0.067500000000000004 * var_x10;
        ...
        rJacobian[0][6] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (var_x24 * (-0.00036000000000000002 - var_x16 + 0.021759999999999998 * var_x22 - 0.0032639999999999995 * var_x19) + 0.66666666666666674 * (0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0.0063749999999999996 * var_x7 - 0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x16 * var_x8) / (pow(var_x4, 3) * pow((0.33333333333333337 + var_x5), 2))));
        rJacobian[1][2] = -(mDt * (var_x24 * (0.00036000000000000002 + 7.96875e-10 * var_x25)));
        rJacobian[1][3] = -(mDt * (var_x24 * (var_x16 + 0.032639999999999995 * var_x27 - 0.030599999999999995 * var_x26)));
        rJacobian[1][4] = -(mDt * (-0.015299999999999998 * var_x23 * var_x28));
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = -(mDt * (2.40087783467447e-5 * var_x31));
        rJacobian[2][2] = 1.0 - (mDt * (1.0 * var_x31 * (-0.0038240087783467445 - var_x34 - 0.069488744729986562 * var_x37 - 5.3144431236283834e-11 * var_x25 - 4.6212277808973232e-7 * var_x32 + 7.2352122917848019e-6 * var_chaste_interface__calcium_dynamics__Ca_i / pow(var_x33, 2)) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973232e-7 * log(2.0 * var_x32) - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027063 * var_x7 - var_x34 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x36 * (2.0 * var_x38 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) - 6860000.0 * var_x35 * var_chaste_interface__calcium_dynamics__Ca_i)) / (pow(var_x29, 3) * pow(var_x30, 2))));
        rJacobian[2][3] = -(mDt * (0.0038 * var_x31));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = -(mDt * (6.0777327752174836e-8 * var_x31 * var_x39));
        rJacobian[3][0] = -(mDt * (-var_x42 * var_x45));
        rJacobian[3][1] = -(mDt * (var_x47 * (var_x46 + 0.065303877103145572 * var_x19 - 0.43535918068763713 * var_x22)));
        rJacobian[3][2] = -(mDt * (1.1399999999999999 * var_x42));
        rJacobian[3][3] = 1.0 - (mDt * (var_x47 * (-1.1399999999999999 - var_x46 + 0.61222384784198969 * var_x26 - 0.65303877103145569 * var_x27 - 0.0025203523969264349 * var_x43 * var_x44 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x46 * var_x8 - var_x45 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass) / (pow(var_x40, 3) * pow(var_x41, 2))));
        rJacobian[3][4] = -(mDt * (0.30611192392099484 * var_x28 * var_x42));
        rJacobian[3][5] = 0.0;
        rJacobian[3][6] = 0.0;
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = -(mDt * (0.059999999999999998 * var_x20 * var_chaste_interface__calcium_dynamics__Ca_ss));
        rJacobian[4][2] = 0.0;
