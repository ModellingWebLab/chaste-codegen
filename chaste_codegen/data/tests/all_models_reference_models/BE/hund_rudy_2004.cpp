...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellhund_rudy_2004FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x29 = exp(-0.024333324280070002 * var_chaste_interface__cell__V);
        ...
        const double var_x33 = exp(0.01310255922773 * var_chaste_interface__cell__V);
        ...
        const double var_x203 = mParameters[7] / (var_x25 * (1.5 + mParameters[7]) * pow((0.01 + 1 / var_x64), 2) * (1.0 + 0.1245 * exp(-0.00374358835078 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[8])) * exp(-var_x104)));
        ...
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * ((var_x121 + 26.712338705500134 * var_x186 - 4.535681662754383e-6 * var_x108 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V)) - 0.00072133461893788295 * var_x188 * var_x199 * var_x200 + 0.00017203830661668509 * var_x199 * var_x201 * var_x202 * mParameters[13] - 0.00070719080288027735 * var_x188 * mParameters[15] * var_chaste_interface__IKr__xr / (1.0 + exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__cell__V)) - 2.595520834746433e-5 * var_x200 * var_x202 * (6.4983106368870169 * var_x201 - var_x194 * (1.6494869150646332 * var_x108 * var_x195 + 1.0539726354202117 * var_x108 * var_x196) - 13.738155796238718 * var_x108 * var_x192 * var_x197 / pow(var_x193, 2)) / pow((var_x191 + 0.98039215686274506 * var_x198), 2) - 0.0016433629212878199 * var_x108 * pow(var_chaste_interface__Ito__ydv, 3) * mParameters[18] * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv * exp(0.0033333333333333335 * var_chaste_interface__cell__V)) * mParameters[4]));
