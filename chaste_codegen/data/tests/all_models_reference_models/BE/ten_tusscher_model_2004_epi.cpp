...
#include "CardiacNewtonSolver.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        this->mParameters[0] = 000175; // (var_L_type_Ca_current__g_CaL) [litre_per_farad_second]
        this->mParameters[1] = 14.837999999999999; // (var_fast_sodium_current__g_Na) [nanoS_per_picoF]
        this->mParameters[2] = 096000000000000002; // (var_rapid_time_dependent_potassium_current__g_Kr) [nanoS_per_picoF]
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        // Units: dimensionless; Initial value: 000181047174425323
        ...
        // Units: dimensionless; Initial value: 00299295753178171
        double var_chaste_interface__fast_sodium_current_m_gate__m = rY[5];
        // Units: dimensionless; Initial value: 00136056171664744
        ...
        const double var_inward_rectifier_potassium_current__alpha_K1 = 0.10000000000000001 / (1.0 + exp(-12.0 + 059999999999999998 * var_chaste_interface__membrane__V - 059999999999999998 * var_reversal_potentials__E_K)); // per_millisecond
        const double var_inward_rectifier_potassium_current__beta_K1 = (1.0 * exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__V - 0.10000000000000001 * var_reversal_potentials__E_K) + 3.0 * exp(02 + 00020000000000000001 * var_chaste_interface__membrane__V - 00020000000000000001 * var_reversal_potentials__E_K)) / (1.0 + exp(0.5 * var_reversal_potentials__E_K - 0.5 * var_chaste_interface__membrane__V)); // per_millisecond
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        ...
        const double var_x0 = var_chaste_interface__membrane__V > -60;
        const double var_x1 = exp(-5.0 + 10000 * var_chaste_interface__calcium_dynamics__Ca_i);
        const double var_x2 = 1.0 + var_x1;
        const double var_x3 = exp(-0.9375 + 1250 * var_chaste_interface__calcium_dynamics__Ca_i);
        const double var_x4 = 1.0 + var_x3;
        const double var_x5 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 8);
        const double var_x6 = (var_x0) && (var_chaste_interface__L_type_Ca_current_fCa_gate__fCa < 0.15753424657534248 + 068493150684931517 / var_x2 + 0.13698630136986303 / var_x4 + 0.68493150684931503 / (1.0 + 8.034023767017109e+27 * var_x5));
        const double var_x7 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, 2);
        const double var_x8 = 0625 + var_x7;
        const double var_x9 = 032927999999999999 * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3) / pow(var_x8, 2);
        const double var_x10 = 1 / var_x8;
        const double var_x11 = 032927999999999999 * var_x10 * var_chaste_interface__calcium_dynamics__Ca_SR;
        ...
        const double var_x18 = 00042499999999999998 / var_x17;
        const double var_x19 = 8.0000000000000007e-5 * var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x20 = 016463999999999999 * var_x10 * var_x7;
        const double var_x21 = 0082319999999999997 + var_x20;
        ...
        const double var_x24 = 001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x25 = 1.0 + 00014999999999999999 / pow(var_x24, 2);
        const double var_x26 = 1 / var_x25;
        const double var_x27 = exp(074867781645490947 * var_chaste_interface__membrane__V);
        ...
        const double var_x31 = 00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x32 = 4.8215267695658011e-5 / var_x31;
        const double var_x33 = 1 / var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x34 = exp(-024332029034784559 * var_chaste_interface__membrane__V);
        const double var_x35 = 1 / (1.0 + 0.10000000000000001 * var_x34);
        const double var_x36 = var_x34 * var_x35;
        const double var_x37 = exp(013101861787960915 * var_chaste_interface__membrane__V);
        const double var_x38 = var_x35 * var_x37 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2);
        const double var_x39 = var_chaste_interface__calcium_dynamics__Ca_i >= 00035;
        const double var_x40 = var_chaste_interface__calcium_dynamics__Ca_i < 00035;
        ...
        const double var_x45 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * (0031249999999999997 * var_chaste_interface__sodium_dynamics__Na_i + 0.10416666666666667 * var_chaste_interface__potassium_dynamics__K_i) / pow((029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i), 2);
        const double var_x46 = log(5.4000000000000004 * var_x44);
        const double var_x47 = exp(-12.0 + 059999999999999998 * var_chaste_interface__membrane__V - 1.6028256395817388 * var_x46);
        ...
        const double var_x54 = exp(02 + 00020000000000000001 * var_chaste_interface__membrane__V - 0053427521319391299 * var_x46);
        ...
        const double var_x60 = 1 / (1.0 + 035299999999999998 * exp(-037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0037433890822745472 * var_chaste_interface__membrane__V));
        const double var_x61 = var_x60 / (40 + var_chaste_interface__sodium_dynamics__Na_i);
        const double var_x62 = var_x60 * var_chaste_interface__sodium_dynamics__Na_i / pow((1 + 025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        ...
        rJacobian[4][2] = 0;
        rJacobian[4][3] = 0;
        rJacobian[4][4] = 1.0 - (mDt * (-0073440052301827737 * var_x45 - 0016876848753885161 * var_x49 * var_x57 - 4.5587787568311439e-5 * var_x44 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 00010126109252331096 * var_x57 * var_x58 * var_x59 - 0031224512033090025 * var_x44 * mParameters[2] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 - 6.3176611368492499e-5 * var_x49 * var_x58 * (-var_x52 * (2.6713760659695653 * var_x44 * var_x53 + 01602825639581739 * var_x44 * var_x54) + 0.16028256395817389 * var_x44 * var_x59 - 13.356880329847826 * var_x44 * var_x50 * var_x55 / pow(var_x51, 2)) / pow(var_x56, 2) - 0031224512033090025 * var_x44 * mParameters[3] * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s));
        rJacobian[4][5] = -(mDt * (00026864670518789814 * var_x61 - 00022032015690548321 * var_x45 - 1.6790419074243634e-7 * var_x62));
        rJacobian[5][0] = 0;
        rJacobian[5][1] = 0;
        rJacobian[5][2] = -(mDt * (0.20846623418995969 * var_x36));
        rJacobian[5][3] = 0;
        rJacobian[5][4] = 0;
        rJacobian[5][5] = 1.0 - (mDt * (2.5185628611365452e-7 * var_x62 - 9.0551084895961074e-7 * var_x63 - 1.823319832565245e-7 * var_x38 - 00040297005778184723 * var_x61 - 0031224512033090025 * var_x63 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * mParameters[1] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_L_type_Ca_current_d_gate__alpha_d = 0.25 + 1.3999999999999999 / (1.0 + exp(-2.6923076923076925 - 076923076923076927 * var_chaste_interface__membrane__V));
        ...
        const double var_L_type_Ca_current_d_gate__gamma_d = 1.0 / (1.0 + exp(2.5 - 050000000000000003 * var_chaste_interface__membrane__V));
        ...
        const double var_L_type_Ca_current_f_gate__tau_f = 80 + 165.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1125.0 * exp(-3.0375000000000001 * pow((1 + 037037037037037035 * var_chaste_interface__membrane__V), 2));
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40) ? (057000000000000002 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0));
        const double var_fast_sodium_current_h_gate__beta_h = ((var_chaste_interface__membrane__V < -40) ? (310000 * exp(0.34849999999999998 * var_chaste_interface__membrane__V) + 2.7000000000000002 * exp(079000000000000001 * var_chaste_interface__membrane__V)) : (5.9230769230769234 / (1.0 + exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__membrane__V))));
        ...
        const double var_fast_sodium_current_m_gate__beta_m = 0.10000000000000001 / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 / (1.0 + exp(-0.25 + 0050000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_rapid_time_dependent_potassium_current_Xr1_gate__alpha_xr1 = 450 / (1.0 + exp(-4.5 - 0.10000000000000001 * var_chaste_interface__membrane__V));
        const double var_rapid_time_dependent_potassium_current_Xr1_gate__beta_xr1 = 6.0 / (1.0 + exp(2.6086956521739131 + 086956521739130432 * var_chaste_interface__membrane__V));
        ...
        const double var_rapid_time_dependent_potassium_current_Xr2_gate__alpha_xr2 = 3.0 / (1.0 + exp(-3.0 - 050000000000000003 * var_chaste_interface__membrane__V));
        const double var_rapid_time_dependent_potassium_current_Xr2_gate__beta_xr2 = 1.1200000000000001 / (1.0 + exp(-3.0 + 050000000000000003 * var_chaste_interface__membrane__V));
        ...
        const double var_rapid_time_dependent_potassium_current_Xr2_gate__xr2_inf = 1.0 / (1.0 + exp(3.6666666666666665 + 041666666666666664 * var_chaste_interface__membrane__V));
        const double var_slow_time_dependent_potassium_current_Xs_gate__alpha_xs = 1100 / sqrt(1.0 + exp(-1.6666666666666667 - 0.16666666666666666 * var_chaste_interface__membrane__V));
        const double var_slow_time_dependent_potassium_current_Xs_gate__beta_xs = 1.0 / (1.0 + exp(-3.0 + 050000000000000003 * var_chaste_interface__membrane__V));
        ...
        const double var_slow_time_dependent_potassium_current_Xs_gate__xs_inf = 1.0 / (1.0 + exp(-0.35714285714285715 - 071428571428571425 * var_chaste_interface__membrane__V));
        ...
        const double var_transient_outward_current_r_gate__tau_r = 0.80000000000000004 + 9.5 * exp(-0.88888888888888884 * pow((1 + 025000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_transient_outward_current_s_gate__s_gateparam = 20;
        ...
        const double var_transient_outward_current_s_gate__tau_s_t1Vdenom = 320;
...
void OdeSystemInformation<Cellten_tusscher_model_2004_epiFromCellMLBackwardEuler>::Initialise(void)
{
    ...
    this->mInitialConditions.push_back(000181047174425323);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(00299295753178171);

    // rY[5]:
    this->mVariableNames.push_back("fast_sodium_current_m_gate__m");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(00136056171664744);
