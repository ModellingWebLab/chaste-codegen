...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        ...
        const double var_x39 = log(10);
        const double var_x40 = var_x35 * var_x38 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2);
        const double var_x41 = var_chaste_interface__calcium_dynamics__Ca_i >= 0.00035;
        const double var_x42 = var_chaste_interface__calcium_dynamics__Ca_i < 0.00035;
        const double var_x43 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6);
        const double var_x44 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16);
        const double var_x45 = (((var_x0) || (var_x41))) && (((var_x0) || (var_x42))) && (((var_x41) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x43)))) && (((var_x42) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x44))));
        const double var_x46 = 1 / var_chaste_interface__potassium_dynamics__K_i;
        const double var_x47 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i);
        const double var_x48 = var_x39 * log10(5.4000000000000004 * var_x46);
        ...
        const double var_x60 = -26.713760659695652 * var_x48 + var_chaste_interface__membrane__V;
        const double var_x61 = var_x49 / pow(var_x50, 2);
        const double var_x62 = 1 / (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane__V));
        const double var_x63 = var_x62 / (40.0 + var_chaste_interface__sodium_dynamics__Na_i);
        const double var_x64 = var_x62 * var_chaste_interface__sodium_dynamics__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        const double var_x65 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        ...
        rJacobian[2][2] = 1.0 - (mDt * (var_x26 * (-8.0000000000000007e-5 - var_x23 - var_x32 - 0.069488744729986562 * var_x36 - 4.6212277808973232e-7 * var_x33 + 4.8215267695658011e-5 * var_chaste_interface__calcium_dynamics__Ca_i / pow(var_x31, 2) - var_x28 * var_x29 * var_x37) + 0.00029999999999999997 * (var_x19 + var_x22 - var_x16 - var_x18 - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - var_x30 * var_x37 - var_x32 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x35 * (2.0 * var_x38 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) - 6860000.0 * var_x34 * var_chaste_interface__calcium_dynamics__Ca_i) + 4.6212277808973232e-7 * var_x39 * log10(2.0 * var_x33)) / (pow(var_x24, 3) * pow(var_x25, 2))));
        rJacobian[2][3] = -(mDt * (var_x21 * var_x27));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = -(mDt * (6.0777327752174836e-8 * var_x26 * var_x40));
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = -(mDt * (((var_x45) ? (0) : ((var_x42) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5) / pow((1.8382656249999998e-21 + var_x43), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15) / pow((5.0709427749024951e-56 + var_x44), 2))))));
        rJacobian[3][3] = 1.0 - (mDt * (((var_x45) ? (0) : (-0.5))));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = 0.0;
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-0.00076500054481070561 * var_x47 - 0.0016876848753885161 * var_x51 * var_x59 - 4.5587787568311439e-5 * var_x46 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 0.00010126109252331096 * var_x59 * var_x60 * var_x61 - 0.0031224512033090025 * var_x46 * mParameters[2] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 - 6.3176611368492499e-5 * var_x51 * var_x60 * (-var_x54 * (2.6713760659695653 * var_x46 * var_x56 + 0.01602825639581739 * var_x46 * var_x55) + 0.16028256395817389 * var_x46 * var_x61 - 13.356880329847826 * var_x46 * var_x52 * var_x57 / pow(var_x53, 2)) / pow(var_x58, 2) - 0.0031224512033090025 * var_x46 * mParameters[3] * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s));
        rJacobian[4][5] = -(mDt * (0.00026864670518789814 * var_x63 - 1.6790419074243634e-7 * var_x64 - 2.2950016344321166e-5 * var_x47));
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = -(mDt * (0.20846623418995969 * var_x36));
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (2.5185628611365452e-7 * var_x64 - 9.0551084895961074e-7 * var_x65 - 1.823319832565245e-7 * var_x40 - 0.00040297005778184723 * var_x63 - 0.0031224512033090025 * var_x65 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * mParameters[1] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
