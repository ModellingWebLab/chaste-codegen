...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        ...
        const double var_x25 = exp(0.074867781645490947 * var_chaste_interface__membrane__V);
        ...
        const double var_x36 = exp(-0.024332029034784559 * var_chaste_interface__membrane__V);
        ...
        const double var_x42 = mParameters[4] * exp(0.013101861787960915 * var_chaste_interface__membrane__V);
        ...
        const double var_x70 = mParameters[5] * mParameters[21] / ((1.0 + mParameters[5]) * (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane__V)));
