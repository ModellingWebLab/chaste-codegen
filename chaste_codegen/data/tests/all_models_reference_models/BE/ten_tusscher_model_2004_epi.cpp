...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        ...
        const double var_x1 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 8);
        const double var_x2 = exp(-0.9375 + 1250.0 * var_chaste_interface__calcium_dynamics__Ca_i);
        const double var_x3 = 1.0 + var_x2;
        const double var_x4 = exp(-5.0 + 10000.0 * var_chaste_interface__calcium_dynamics__Ca_i);
        const double var_x5 = 1.0 + var_x4;
        const double var_x6 = (var_x0) && (var_chaste_interface__L_type_Ca_current_fCa_gate__fCa < 0.15753424657534248 + 0.068493150684931517 / var_x5 + 0.13698630136986303 / var_x3 + 0.68493150684931503 / (1.0 + 8.034023767017109e+27 * var_x1));
        ...
        const double var_x10 = 0.032927999999999999 * var_x9 * var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x11 = 0.032927999999999999 * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3) / pow(var_x8, 2);
        ...
        const double var_x16 = 8.0000000000000007e-5 * var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x17 = 8.0000000000000007e-5 * var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x18 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
        const double var_x19 = 0.00042499999999999998 / var_x18;
        const double var_x20 = 0.016463999999999999 * var_x7 * var_x9;
        const double var_x21 = 0.0082319999999999997 + var_x20;
        const double var_x22 = var_x12 * var_x21;
        const double var_x23 = 5.3124999999999997e-11 / (pow(var_x18, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
        ...
        const double var_x31 = 1 / var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x32 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x33 = 4.8215267695658011e-5 / var_x32;
        ...
        const double var_x55 = 1.0 * var_x54 + 3.0 * var_x53;
        ...
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = -(mDt * (((var_x6) ? (0) : (-3.4101542475452148e-28 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 7) / pow((1.2447063003540035e-28 + var_x1), 2) - 85.61643835616438 * var_x2 / pow(var_x3, 2) - 342.46575342465752 * var_x4 / pow(var_x5, 2)))));
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = 0.0;
        rJacobian[0][5] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (var_x15 * (-8.0000000000000007e-5 + var_x12 * (var_x11 - var_x10)) + 9.9963436928702016 * (var_x17 + var_x19 - var_x16 - var_x22) / (pow(var_x13, 3) * pow((0.33333333333333337 + var_x14), 2))));
        ...
        rJacobian[2][1] = -(mDt * (var_x30 * (8.0000000000000007e-5 + var_x12 * (var_x10 - var_x11))));
        rJacobian[2][2] = 1.0 - (mDt * (var_x30 * (-8.0000000000000007e-5 - var_x23 - var_x33 - 0.069488744729986562 * var_x36 - 4.6212277808973232e-7 * var_x31 + 4.8215267695658011e-5 * var_chaste_interface__calcium_dynamics__Ca_i / pow(var_x32, 2) - var_x27 * var_x28 * var_chaste_interface__L_type_Ca_current_fCa_gate__fCa) + 0.00029999999999999997 * (var_x16 + var_x22 - var_x17 - var_x19 + 4.6212277808973232e-7 * log(2.0 * var_x31) - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - var_x29 * var_chaste_interface__L_type_Ca_current_fCa_gate__fCa - var_x33 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x35 * (2.0 * var_x37 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) - 6860000.0 * var_x34 * var_chaste_interface__calcium_dynamics__Ca_i)) / (pow(var_x24, 3) * pow(var_x25, 2))));
