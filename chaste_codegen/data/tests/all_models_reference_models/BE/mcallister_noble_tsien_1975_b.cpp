...
#include "CardiacNewtonSolver.hpp"
    ...
    Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEulerNoLut::Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEulerNoLut::~Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEulerNoLut()
    {
    }

    
    double Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
    ...
    void Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = 0.0085000000000000006 * exp(-13.064 - 0.184 * var_chaste_interface__membrane__V);
        const double var_fast_sodium_current_h_gate__beta_h = 2.5 / (1.0 + exp(-0.82000000000000006 - 0.082000000000000003 * var_chaste_interface__membrane__V));
        const double var_fast_sodium_current_m_gate__alpha_m = (47.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.7000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V));
        const double var_fast_sodium_current_m_gate__beta_m = 40.0 * exp(-4.032 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        ...
        const double var_plateau_potassium_current1_x1_gate__alpha_x1 = 0.00050000000000000001 * exp(4.1322314049586781 + 0.082644628099173556 * var_chaste_interface__membrane__V) / (1.0 + exp(2.8571428571428572 + 0.057142857142857141 * var_chaste_interface__membrane__V));
        const double var_plateau_potassium_current1_x1_gate__beta_x1 = 0.0012999999999999999 * exp(-1.1997600479904018 - 0.059988002399520089 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.80000000000000004 - 0.040000000000000001 * var_chaste_interface__membrane__V));
        const double var_plateau_potassium_current2_x2_gate__alpha_x2 = 0.000127 / (1.0 + exp(-3.7999999999999998 - 0.20000000000000001 * var_chaste_interface__membrane__V));
        const double var_plateau_potassium_current2_x2_gate__beta_x2 = 0.00029999999999999997 * exp(-1.1997600479904018 - 0.059988002399520089 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.80000000000000004 - 0.040000000000000001 * var_chaste_interface__membrane__V));
        const double var_secondary_inward_current_d_gate__alpha_d = 0.002 * (40.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.0 - 0.10000000000000001 * var_chaste_interface__membrane__V));
        const double var_secondary_inward_current_d_gate__beta_d = 0.02 * exp(-3.552 - 0.088800000000000004 * var_chaste_interface__membrane__V);
        const double var_secondary_inward_current_f_gate__alpha_f = 0.00098700000000000003 * exp(-2.3999999999999999 - 0.040000000000000001 * var_chaste_interface__membrane__V);
        const double var_secondary_inward_current_f_gate__beta_f = 0.02 / (1.0 + exp(-2.262 - 0.086999999999999994 * var_chaste_interface__membrane__V));
        const double var_transient_chloride_current_q_gate__alpha_q = 0.0080000000000000002 * var_chaste_interface__membrane__V / (1.0 - exp(-0.10000000000000001 * var_chaste_interface__membrane__V));
        const double var_transient_chloride_current_q_gate__beta_q = 0.080000000000000002 * exp(-0.088800000000000004 * var_chaste_interface__membrane__V);
        const double var_transient_chloride_current_r_gate__alpha_r = 3.3000000000000003e-5 * exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_transient_chloride_current_r_gate__beta_r = 0.033000000000000002 / (1.0 + exp(-3.75 - 0.125 * var_chaste_interface__membrane__V));
    ...
    std::vector<double> Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEulerNoLut>::Initialise(void)
{
