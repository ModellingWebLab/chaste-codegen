...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellhilgemann_noble_model_1987FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[11], double rJacobian[11][11])
    {
        ...
        const double var_x6 = 1.0 * var_x2 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x7 = 1.0 * var_x3 / pow(var_x1, 3);
        ...
        const double var_x15 = 1 / (1.0 + 0.0001 * var_x14 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x16 = var_x13 * var_x15;
        const double var_x17 = var_x12 * var_x16;
        const double var_x18 = var_x10 * var_x17;
        const double var_x19 = 0.074867781645490947 * var_chaste_interface__membrane__V;
        const double var_x20 = exp(3.7433890822745473 - var_x19);
        const double var_x21 = 1.0 - var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca;
        const double var_x22 = 1 / (1.0 - var_x20);
        const double var_x23 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x26 = (-50.0 + var_chaste_interface__membrane__V) * var_chaste_interface__second_inward_calcium_current_d_gate__d;
        const double var_x27 = var_x26 * (1.0 - var_x25);
        const double var_x28 = var_x22 * var_x27;
        const double var_x29 = var_x21 * var_x28;
        const double var_x30 = 6.0300901652461443e-6 * var_x29;
        const double var_x31 = exp(-var_x11);
        const double var_x32 = var_x12 * var_x14 - 2744000.0 * var_x31 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x33 = var_x13 * var_x32 / pow((0.0036443148688046646 + 3.6443148688046648e-7 * var_x14 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x34 = var_x10 * var_x33;
        const double var_x35 = 1 / var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x36 = var_x16 * var_x31;
        const double var_x37 = exp(3.7433890822745473);
        const double var_x38 = var_x15 * var_x32 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x39 = var_x37 * var_chaste_interface__intracellular_calcium_concentration__Ca_i - var_x20 * var_chaste_interface__extracellular_calcium_concentration__Ca_o;
        const double var_x40 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x23, 2);
        const double var_x41 = var_x21 * (var_x40 - var_x24);
        const double var_x42 = var_x26 * var_x41;
        const double var_x43 = var_x22 * var_x39 * var_x42;
        ...
        const double var_x46 = var_x33 * var_x44;
        const double var_x47 = var_x28 * var_x39;
        ...
        const double var_x58 = 4.9225225838744041e-6 * var_x29;
        ...
        const double var_x66 = exp(1.8716945411372736);
        const double var_x67 = exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V);
        const double var_x68 = -1.9690090335497616e-8 * var_x67 + 4.922522583874404e-9 * var_x66 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x69 = 1 / (1.0 - var_x67);
        ...
        const double var_x73 = exp(-0.74867781645490938 + var_x19 - 2.0 * var_x72);
        const double var_x74 = 1.0 + var_x73;
        const double var_x75 = var_x27 * var_x69;
        const double var_x76 = var_x21 * var_x66 * var_x75;
        ...
        const double var_x79 = -3.445765808712083e-6 * var_x67 + 2.4612612919372021e-8 * var_x66 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        ...
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = 0.0;
        rJacobian[0][5] = -(mDt * (var_x8 * (1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac) + (var_x7 - var_x6) * var_chaste_interface__calcium_release__ActFrac));
        rJacobian[0][6] = 0.0;
        rJacobian[0][7] = 0.0;
        rJacobian[0][8] = 0.0;
        rJacobian[0][9] = 0.0;
        ...
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (-4.9999999999999998e-7 + 5.3790289324163455e-7 * var_x9 + 1.0696966282568414e-16 * var_x34 - 8.0543192715385052e-8 * var_x18 + var_x20 * var_x30));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = -(mDt * (2.9352475479367729e-10 * var_x33 + 5.5574802973615687e-10 * var_x38 + 0.22101052081101658 * var_x36 - 5.3790289324163455e-7 * var_x35 - 6.0300901652461443e-6 * var_x43 - var_x30 * var_x37));
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = 0.0;
        rJacobian[2][8] = 0.0;
        rJacobian[2][9] = -(mDt * (3.2090898847705241e-16 * var_x46 - 2.4162957814615514e-7 * var_x45));
        ...
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = -(mDt * (4.3910440264623239e-7 * var_x9 + 1.3149909014756745e-7 * var_x18 - 1.7464434747050473e-16 * var_x34 + var_x20 * var_x58));
        rJacobian[5][3] = -(mDt * (0.050000000000000003 + var_x48));
        rJacobian[5][4] = -(mDt * (0.20000000000000001 + var_x48));
        rJacobian[5][5] = 1.0 - (mDt * (-17.0 + var_x50 + var_x51 + 0.0030000000000000001 * var_x62 - 0.0030000000000000001 * var_x60 - 9.0734372201821535e-10 * var_x38 - 4.3910440264623239e-7 * var_x35 - 4.7922408945906498e-10 * var_x33 - 0.36083350336492503 * var_x36 - 4.9225225838744041e-6 * var_x43 - 5.5200000000000005e-8 * var_x63 - var_x37 * var_x58));
        ...
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = -(mDt * (3.9449727044270234e-7 * var_x45 - 5.2393304241151422e-16 * var_x46));
        ...
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = 0.0;
        rJacobian[9][2] = -(mDt * (5.2393304241151422e-16 * var_x34 - 3.9449727044270234e-7 * var_x18));
        rJacobian[9][3] = 0.0;
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = -(mDt * (1.0825005100947751 * var_x36 + 2.7220311660546458e-9 * var_x38 + 1.4376722683771949e-9 * var_x33 - var_x70 * var_x79));
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = -(mDt * (-0.29608985512196506 * var_x80));
        rJacobian[9][9] = 1.0 - (mDt * (2.7614808930989161e-7 * var_x78 + 1.5717991272345426e-15 * var_x46 - 0.00044183694289582661 * var_x77 - 4.215402265403831e-6 / var_chaste_interface__intracellular_sodium_concentration__Na_i - 2.4612612919372021e-8 * var_x76 - 2.4674154593497089 * var_x80 - 1.1834918113281069e-6 * var_x45));
        ...
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = -(mDt * (var_x83 * (var_x41 + var_x24 * var_x81 - var_x40 * var_x81)));
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
