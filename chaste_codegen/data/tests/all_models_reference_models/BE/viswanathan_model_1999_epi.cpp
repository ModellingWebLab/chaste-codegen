...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellviswanathan_model_1999_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x0 = pow(var_chaste_interface__ionic_concentrations__Nai, (-2));
        const double var_x1 = 0.037435883507802616 * var_chaste_interface__membrane__V;
        const double var_x2 = 1 / (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.961367013372957)) * exp(-var_x1));
        const double var_x3 = 1 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V));
        ...
        const double var_x7 = -26.712338705498265 * var_x6 + var_chaste_interface__membrane__V;
        const double var_x8 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x9 = var_x4 * log10(132.0 * var_x8);
        const double var_x10 = pow(var_chaste_interface__ionic_concentrations__Nai, 3.0);
        const double var_x11 = 0.018717941753901308 * var_chaste_interface__membrane__V;
        const double var_x12 = exp(var_x11);
        const double var_x13 = exp(-var_x11);
        const double var_x14 = 1.8 * var_x10 * var_x12 - 2299968.0 * var_x13 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x15 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x16 = 1 / (1.0 + 2299.9679999999998 * var_chaste_interface__calcium_dynamics__Cai + 0.0018000000000000002 * var_x10);
        const double var_x17 = var_x15 * var_x16;
        const double var_x18 = 0.002 * var_x14 * var_x17;
        const double var_x19 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * var_x6);
        const double var_x20 = 1.0 + var_x19;
        const double var_x21 = 1 / var_x20;
        const double var_x22 = exp(-2.4444678999999998 + 13.738155796237757 * var_x6 - 0.51429999999999998 * var_chaste_interface__membrane__V);
        const double var_x23 = 1.0 + var_x22;
        const double var_x24 = 1 / var_x23;
        const double var_x25 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * var_x6);
        const double var_x26 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * var_x6);
        ...
        const double var_x31 = var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V));
        const double var_x32 = 1 / var_chaste_interface__calcium_dynamics__Cai;
        const double var_x33 = pow(var_x32, 1.3999999999999999);
        const double var_x34 = 1.0 + 6.4818210260626455e-7 * var_x33;
        const double var_x35 = 0.25979999999999998 / var_x34;
        const double var_x36 = 1 / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki);
        const double var_x37 = var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        const double var_x38 = var_x37 * (-26.712338705498265 * var_x4 * log10(6.9195599999999997 * var_x36) + var_chaste_interface__membrane__V);
        const double var_x39 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x40 = exp(var_x1);
        const double var_x41 = 0.75 * var_x40;
        const double var_x42 = -99.0 + var_x41 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x43 = 1 / (-1.0 + var_x40);
        ...
        const double var_x50 = var_x4 * log10(1.8 * var_x32);
        ...
        const double var_x54 = var_x53 * (-0.61380000000000001 + 1.0 * var_x52 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x55 = 7.8019226357407252 * var_x45;
        const double var_x56 = -0.040282206767891383 * var_x50 + var_x49 * var_chaste_interface__calcium_dynamics__Cai + var_x54 * var_x55 + 0.050000000000000003 * var_x51 * (-13.356169352749133 * var_x50 + var_chaste_interface__membrane__V);
        ...
        const double var_x81 = pow(var_x48, (-2));
        ...
        const double var_x87 = var_x13 * var_x17;
        const double var_x88 = var_x14 * var_x16 / pow((0.0068999999999999999 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x89 = var_x14 * var_x15 / pow((0.00043478865792915378 + 7.8261958427247687e-7 * var_x10 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x90 = var_x44 / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x91 = 1 / M_PI;
        const double var_x92 = 0.090316078310111333 * var_x91;
        const double var_x93 = -var_x92 * (var_x49 + 4599.9359999999997 * var_x87 + 0.040282206767891383 * var_x32 + 1.38e-5 * var_x88 + 8.6957731585830757e-7 * var_x89 + 0.6678084676374566 * var_x32 * var_x51 - 1.1499999999999999 * var_x81 * var_chaste_interface__calcium_dynamics__Cai - 0.0046811535814444347 * var_x54 * var_x90 + var_x52 * var_x53 * var_x55);
        const double var_x94 = pow(var_chaste_interface__ionic_concentrations__Nai, 2.0);
        const double var_x95 = var_x89 * var_x94;
        const double var_x96 = var_x12 * var_x17 * var_x94;
        const double var_x97 = 2.0416447122894152e-12 * var_x95 - 0.010800000000000001 * var_x96;
        const double var_x98 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
        const double var_x99 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        const double var_x100 = var_x43 * var_x90;
        const double var_x101 = 0.00018063215662022267 * var_x91;
        const double var_x102 = var_x36 * var_x37 * (-0.433 - var_x35);
        const double var_x103 = var_x19 * var_x5 / pow(var_x20, 2);
        const double var_x104 = var_x40 * var_x46;
        const double var_x105 = var_x2 / (pow((0.01 + var_x0), 2) * pow(var_chaste_interface__ionic_concentrations__Nai, 3));
        
        
        rJacobian[0][0] = 1.0 - (mDt * (0.001 * ((1.0 * (var_x18 + var_x56 + 0.0070160275741043606 * var_chaste_interface__membrane__V - 0.10684935482199306 * var_x9 - 7.3656881518639831e-7 * var_x6 + var_x38 * (0.433 + var_x35) + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 16.0 * var_x39 * (-26.712338705498265 * var_x9 + var_chaste_interface__membrane__V) + 1.5 * var_x2 / (1.0 + 100.0 * var_x0) + 0.0055199999999999997 * var_x3 * var_x7 + 0.0024381008236689767 * var_x42 * var_x46 + 0.00069711623550831479 * var_x46 * var_x47 + 698.34626081908675 * var_x30 * var_x7 + 0.023862446088641735 * var_x31 * var_x7) / mParameters[0] < -150000.0) ? (-100500.0) : (-500.0))));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = 0.0;
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = 0.0;
        ...
        rJacobian[5][5] = 1.0 - (mDt * (var_x84 * (var_x93 - var_x86 + 0.40588235294117642 * var_x79 - 0.0070588235294117632 * var_x72) + 0.001 * (0.00023800000000000004 / pow(var_x80, 3) + 7.0000000000000007e-5 / pow(var_x48, 3)) * (0.027058823529411764 * var_chaste_interface__calcium_dynamics__Ca_NSR + 0.0070588235294117632 * var_x73 - var_x86 * var_chaste_interface__calcium_dynamics__Cai - var_x92 * (var_x56 - var_x18 + 0.003016 * var_chaste_interface__membrane__V)) / pow(var_x82, 2)));
        rJacobian[5][6] = -(mDt * (var_x75 * var_x85));
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = -(mDt * (var_x76 * var_x85));
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = -(mDt * (-9.0316078310111333e-5 * var_x83 * var_x91 * var_x97));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (0.001 * ((var_x98) ? (var_x93) : (0))));
        rJacobian[6][6] = 1.0 - (mDt * (0.001 * (((var_x98) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-500.0))));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = -(mDt * (0.001 * ((var_x98) ? (-var_x92 * var_x97) : (0))));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        ...
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (0.001 * (((var_x99) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50000.0) : (-500.0))));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[9][0] = 0.0;
        ...
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        rJacobian[9][9] = 1.0 - (mDt * (0.001 * (((var_x99) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50000.0) : (-10.0))));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = 0.0;
        rJacobian[10][0] = 0.0;
        rJacobian[10][1] = 0.0;
        ...
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = -(mDt * (var_x101 * (4.1826974130498884e-7 * var_x100 * var_x47 - 2.3575679435995052e-7 * var_x32 * var_x33 * var_x38 / pow(var_x34, 2))));
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (var_x101 * (26.712338705498265 * var_x102 - 0.00052283717663123607 * var_x104 - 7.3656881518639831e-7 * var_x5 - 18654.461852717679 * var_x30 * var_x5 - 0.63742174226149029 * var_x31 * var_x5 - 0.14745210965435041 * var_x3 * var_x5 + 4449.089151873166 * var_x103 * var_x29 * var_x7 - 0.00067122862439358594 * var_x21 * var_x7 * (6498.310636886562 * var_x103 - 1000.0 * var_x24 * (1.053972635420138 * var_x25 * var_x5 + 1.6494869150645177 * var_x26 * var_x5) - 13738.155796237757 * var_x22 * var_x27 * var_x5 / pow(var_x23, 2)) / pow((var_x21 + 0.98039215686274506 * var_x28), 2))));
        rJacobian[10][11] = -(mDt * (var_x101 * (0.48963716847178318 * var_x102 + 0.059999999999999998 * var_x105)));
        rJacobian[11][0] = 0.0;
        rJacobian[11][1] = 0.0;
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = -(mDt * (var_x101 * (2.6087319475749228e-6 * var_x89 + 4.1400000000000003e-5 * var_x88 + 13799.808000000001 * var_x87 + 1.4628604942013857e-6 * var_x100 * var_x42)));
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x101 * (6.124934136868245e-12 * var_x95 - 0.032399999999999998 * var_x96 - 0.10684935482199306 * var_x8 - 0.0018285756177517324 * var_x104 - 0.089999999999999997 * var_x105 - 427.39741928797224 * var_x39 * var_x8)));
    }
