...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellviswanathan_model_1999_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x5 = 037435883507802616 * var_chaste_interface__membrane__V;
        const double var_x6 = 1 / (1.0 + 0.1245 * exp(-003743588350780262 * var_chaste_interface__membrane__V) + 036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.961367013372957)) * exp(-var_x5));
        ...
        const double var_x10 = 018717941753901308 * var_chaste_interface__membrane__V;
        ...
        const double var_x15 = 1 / (1.0 + 2299.9679999999998 * var_chaste_interface__calcium_dynamics__Cai + 0018000000000000002 * var_x9);
        const double var_x16 = var_x14 * var_x15;
        const double var_x17 = 002 * var_x13 * var_x16;
        ...
        const double var_x24 = exp(0.43983232 + 080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * var_x3);
        const double var_x25 = exp(-36.698642499999998 + 061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * var_x3);
        const double var_x26 = var_x25 + 0.49124000000000001 * var_x24;
        const double var_x27 = var_x23 * var_x26;
        const double var_x28 = 1 / (1000 * var_x27 + 1020 * var_x20);
        const double var_x29 = var_x20 * var_x28;
        const double var_x30 = var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 044642857142857144 * var_chaste_interface__membrane__V));
        ...
        const double var_x35 = 018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki;
        ...
        const double var_x48 = 00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai;
        ...
        const double var_x51 = exp(074871767015605231 * var_chaste_interface__membrane__V);
        ...
        const double var_x55 = -040282206767891383 * var_x47 + var_x49 * var_chaste_interface__calcium_dynamics__Cai + var_x53 * var_x54 + 050000000000000003 * var_x50 * (-13.356169352749133 * var_x47 + var_chaste_interface__membrane__V);
        ...
        const double var_x58 = 00062 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x59 = 1 / var_x58;
        const double var_x60 = -00018000000000000001 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x61 = 60000 * var_x59 * var_x60;
        const double var_x62 = var_x57 * var_x61;
        const double var_x63 = var_chaste_interface__calcium_dynamics__Cainfluxtrack > 00018000000000000001;
        ...
        const double var_x68 = 001 * var_x67;
        ...
        const double var_x71 = ((var_x63) ? (var_x62 * var_chaste_interface__calcium_dynamics__APtrack2) : ((var_x70) ? (4000 * (1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x72 = var_x71 * (-var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR);
        const double var_x73 = 60000 * var_x57 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x74 = ((var_x63) ? (var_x59 * var_x73 - var_x60 * var_x73 / pow(var_x58, 2)) : (0));
        const double var_x75 = ((var_x63) ? (0) : ((var_x70) ? (4000 - 8000 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x76 = 00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x77 = 1 / var_x76;
        const double var_x78 = var_chaste_interface__calcium_dynamics__Cai / pow(var_x76, 2);
        const double var_x79 = 0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x80 = pow(var_x48, (-2));
        const double var_x81 = 1.0 + 00011900000000000002 / pow(var_x79, 2) + 3.5000000000000004e-5 * var_x80;
        const double var_x82 = 1 / var_x81;
        const double var_x83 = 001 * var_x82;
        const double var_x84 = var_x83 * (0070588235294117632 * var_chaste_interface__calcium_dynamics__Ca_JSR - 0070588235294117632 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x85 = 0.40588235294117642 * var_x77;
        const double var_x86 = var_x12 * var_x16;
        const double var_x87 = var_x13 * var_x15 / pow((0068999999999999999 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x88 = var_x13 * var_x14 / pow((00043478865792915378 + 7.8261958427247687e-7 * var_x9 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x89 = var_x43 / pow((00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x90 = 1 / M_PI;
        const double var_x91 = 090316078310111333 * var_x90;
        const double var_x92 = -var_x91 * (var_x49 + 4599.9359999999997 * var_x86 + 040282206767891383 * var_x31 + 1.38e-5 * var_x87 + 8.6957731585830757e-7 * var_x88 + 0.6678084676374566 * var_x31 * var_x50 - 1.1499999999999999 * var_x80 * var_chaste_interface__calcium_dynamics__Cai - 0046811535814444347 * var_x53 * var_x89 + var_x51 * var_x52 * var_x54);
        ...
        const double var_x96 = 2.0416447122894152e-12 * var_x94 - 010800000000000001 * var_x95;
        ...
        const double var_x100 = 00018063215662022267 * var_x90;
        const double var_x101 = var_x18 * var_x2 / pow(var_x19, 2);
        const double var_x102 = var_x36 * (-0.433 - var_x34) * (0.14451785951707913 * var_chaste_interface__ionic_concentrations__Ki + 0026490123649480601 * var_chaste_interface__ionic_concentrations__Nai) / pow(var_x35, 2);
        const double var_x103 = var_x39 * var_x45;
        const double var_x104 = var_x6 / (pow((01 + var_x4), 2) * pow(var_chaste_interface__ionic_concentrations__Nai, 3));
        
        
        rJacobian[0][0] = 1.0 - (mDt * (001 * ((1.0 * (var_x17 + var_x55 + 0070160275741043606 * var_chaste_interface__membrane__V - 0.10684935482199306 * var_x1 - 7.3656881518639831e-7 * var_x3 + var_x37 * (0.433 + var_x34) + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 16.0 * var_x38 * (-26.712338705498265 * var_x1 + var_chaste_interface__membrane__V) + 1.5 * var_x6 / (1.0 + 100 * var_x4) + 0055199999999999997 * var_x7 * var_x8 + 0024381008236689767 * var_x41 * var_x45 + 00069711623550831479 * var_x45 * var_x46 + 698.34626081908675 * var_x29 * var_x8 + 023862446088641735 * var_x30 * var_x8) / mParameters[0] < -150000) ? (-100500) : (-500))));
        rJacobian[0][1] = 0;
        rJacobian[0][2] = 0;
        rJacobian[0][3] = 0;
        rJacobian[0][4] = 0;
        ...
        rJacobian[0][11] = 0;
        rJacobian[1][0] = 0;
        rJacobian[1][1] = 1.0 - (mDt * (001 * ((var_x56) ? (-100500) : (-500))));
        rJacobian[1][2] = 0;
        rJacobian[1][3] = 0;
        rJacobian[1][4] = 0;
        rJacobian[1][5] = 0;
        ...
        rJacobian[2][0] = 0;
        rJacobian[2][1] = 0;
        rJacobian[2][2] = 1.0 - (mDt * (001 * ((var_x56) ? (-100500) : (-10))));
        rJacobian[2][3] = 0;
        rJacobian[2][4] = 0;
        rJacobian[2][5] = 0;
        rJacobian[2][6] = 0;
        ...
        rJacobian[3][2] = 0;
        rJacobian[3][3] = 1.0 - (mDt * (var_x68 * (-5.5555555555555554 - var_x71) + 00025000000000000001 * (-var_x72 + 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR) / (pow(var_x65, 3) * pow((0.125 + var_x66), 2))));
        rJacobian[3][4] = -(mDt * (0055555555555555558 * var_x67));
        ...
        rJacobian[4][1] = 0;
        rJacobian[4][2] = 0;
        rJacobian[4][3] = -(mDt * (00048309178743961351));
        rJacobian[4][4] = 1.0 - (mDt * (-00081642512077294684));
        rJacobian[4][5] = -(mDt * (0050000000000000001 * var_x77 - 0050000000000000001 * var_x78));
        rJacobian[4][6] = 0;
        rJacobian[4][7] = 0;
        rJacobian[4][8] = 0;
        rJacobian[4][9] = 0;
        ...
        rJacobian[5][5] = 1.0 - (mDt * (var_x83 * (var_x92 - var_x85 + 0.40588235294117642 * var_x78 - 0070588235294117632 * var_x71) + 001 * (00023800000000000004 / pow(var_x79, 3) + 7.0000000000000007e-5 / pow(var_x48, 3)) * (027058823529411764 * var_chaste_interface__calcium_dynamics__Ca_NSR + 0070588235294117632 * var_x72 - var_x85 * var_chaste_interface__calcium_dynamics__Cai - var_x91 * (var_x55 - var_x17 + 003016 * var_chaste_interface__membrane__V)) / pow(var_x81, 2)));
        ...
        rJacobian[6][3] = 0;
        rJacobian[6][4] = 0;
        rJacobian[6][5] = -(mDt * (001 * ((var_x97) ? (var_x92) : (0))));
        rJacobian[6][6] = 1.0 - (mDt * (001 * (((var_x97) || (var_chaste_interface__calcium_dynamics__APtrack2 > 01)) ? (0) : (-500))));
        rJacobian[6][7] = 0;
        rJacobian[6][8] = 0;
        rJacobian[6][9] = 0;
        rJacobian[6][10] = 0;
        rJacobian[6][11] = -(mDt * (001 * ((var_x97) ? (-var_x91 * var_x96) : (0))));
        rJacobian[7][0] = 0;
        rJacobian[7][1] = 0;
        rJacobian[7][2] = 0;
        rJacobian[7][3] = 0;
        ...
        rJacobian[7][5] = 0;
        rJacobian[7][6] = 0;
        rJacobian[7][7] = 1.0 - (mDt * (001 * (((var_chaste_interface__calcium_dynamics__APtrack3 < 0.37) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.37) && (1.0 / (1.0 + 0.80000000000000004 / var_chaste_interface__calcium_dynamics__Ca_JSR) > 0.69999999999999996)) ? (-50000) : (-500))));
        rJacobian[7][8] = 0;
        rJacobian[7][9] = 0;
        rJacobian[7][10] = 0;
        rJacobian[7][11] = 0;
        ...
        rJacobian[8][6] = 0;
        rJacobian[8][7] = 0;
        rJacobian[8][8] = 1.0 - (mDt * (001 * (((var_x98) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50000) : (-500))));
        rJacobian[8][9] = 0;
        rJacobian[8][10] = 0;
        rJacobian[8][11] = 0;
        rJacobian[9][0] = 0;
        ...
        rJacobian[9][7] = 0;
        rJacobian[9][8] = 0;
        rJacobian[9][9] = 1.0 - (mDt * (001 * (((var_x98) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50000) : (-10))));
        rJacobian[9][10] = 0;
        rJacobian[9][11] = 0;
        rJacobian[10][0] = 0;
        rJacobian[10][1] = 0;
        ...
        rJacobian[10][8] = 0;
        rJacobian[10][9] = 0;
        rJacobian[10][10] = 1.0 - (mDt * (var_x100 * (184.83763041301756 * var_x102 - 00052283717663123607 * var_x103 - 7.3656881518639831e-7 * var_x2 - 18654.461852717679 * var_x2 * var_x29 - 0.63742174226149029 * var_x2 * var_x30 - 0.14745210965435041 * var_x2 * var_x7 + 4449.089151873166 * var_x101 * var_x28 * var_x8 - 00067122862439358594 * var_x20 * var_x8 * (6498.310636886562 * var_x101 - 1000 * var_x23 * (1.053972635420138 * var_x2 * var_x24 + 1.6494869150645177 * var_x2 * var_x25) - 13738.155796237757 * var_x2 * var_x21 * var_x26 / pow(var_x22, 2)) / pow((var_x20 + 0.98039215686274506 * var_x27), 2))));
        rJacobian[10][11] = -(mDt * (var_x100 * (3.3880737654706117 * var_x102 + 059999999999999998 * var_x104)));
        rJacobian[11][0] = 0;
        rJacobian[11][1] = 0;
        rJacobian[11][2] = 0;
        rJacobian[11][3] = 0;
        ...
        rJacobian[11][9] = 0;
        rJacobian[11][10] = 0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x100 * (6.124934136868245e-12 * var_x94 - 032399999999999998 * var_x95 - 0.10684935482199306 * var_x0 - 0018285756177517324 * var_x103 - 089999999999999997 * var_x104 - 427.39741928797224 * var_x0 * var_x38)));
    }
    ...
    void Cellviswanathan_model_1999_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_L_type_Ca_channel_d_gate__E0_d = 10 + var_chaste_interface__membrane__V;
        const double var_L_type_Ca_channel_d_gate__d_infinity = 1.0 / (1.0 + exp(-0.16025641025641024 * var_L_type_Ca_channel_d_gate__E0_d));
        const double var_L_type_Ca_channel_d_gate__tau_d = ((fabs(var_L_type_Ca_channel_d_gate__E0_d) < 1.0000000000000001e-5) ? (0045787545787545781) : (028571428571428571 * (1.0 - exp(-0.16025641025641024 * var_L_type_Ca_channel_d_gate__E0_d)) * var_L_type_Ca_channel_d_gate__d_infinity / var_L_type_Ca_channel_d_gate__E0_d));
        ...
        const double var_L_type_Ca_channel_f_gate__f_infinity = 1.0 / (1.0 + exp(4.0 + 0.125 * var_chaste_interface__membrane__V)) + 0.59999999999999998 / (1.0 + exp(2.5 - 050000000000000003 * var_chaste_interface__membrane__V));
        const double var_L_type_Ca_channel_f_gate__tau_f = 001 / (02 + 019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2)));
        ...
        const double var_T_type_Ca_channel_b_gate__b_inf = 1.0 / (1.0 + exp(-1.2962962962962963 - 092592592592592587 * var_chaste_interface__membrane__V));
        const double var_T_type_Ca_channel_b_gate__tau_b = 0037000000000000002 + 0061000000000000004 / (1.0 + exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__membrane__V));
        ...
        const double var_T_type_Ca_channel_g_gate__tau_g = ((var_chaste_interface__membrane__V <= 0) ? (012 - 00087500000000000002 * var_chaste_interface__membrane__V) : (012));
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40) ? (135.0 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0));
        const double var_fast_sodium_current_h_gate__beta_h = ((var_chaste_interface__membrane__V < -40) ? (3560 * exp(079000000000000001 * var_chaste_interface__membrane__V) + 310000000 * exp(0.34999999999999998 * var_chaste_interface__membrane__V)) : (7692.3076923076933 / (1.0 + exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__membrane__V))));
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = ((var_fast_sodium_current_m_gate__delta_m <= fabs(var_fast_sodium_current_m_gate__E0_m)) ? (320 * var_fast_sodium_current_m_gate__E0_m / (1.0 - exp(-0.10000000000000001 * var_fast_sodium_current_m_gate__E0_m))) : (3200));
        const double var_fast_sodium_current_m_gate__beta_m = 80 * exp(-090909090909090912 * var_chaste_interface__membrane__V);
        ...
        const double var_slow_delayed_rectifier_potassium_current_xs1_gate__xs1_infinity = 1.0 / (1.0 + exp(089820359281437126 - 059880239520958084 * var_chaste_interface__membrane__V));
        ...
        const double var_slow_delayed_rectifier_potassium_current_xs2_gate__xs2_infinity = 1.0 / (1.0 + exp(089820359281437126 - 059880239520958084 * var_chaste_interface__membrane__V));
        ...
        const double var_transient_outward_current_ydv_gate__beta_ydv = 100 * exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_transient_outward_current_zdv_gate__alpha_zdv = 10000 * exp(-1.6000000000000001 + 040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-1.6000000000000001 + 040000000000000001 * var_chaste_interface__membrane__V));
        const double var_transient_outward_current_zdv_gate__beta_zdv = 10000 * exp(-3.6000000000000001 - 040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.6000000000000001 - 040000000000000001 * var_chaste_interface__membrane__V));
        ...
        rY[5] = (var_chaste_interface__L_type_Ca_channel_d_gate__d + ((001 * var_L_type_Ca_channel_d_gate__alpha_d) * mDt)) / (1.0 - ((-001 * var_L_type_Ca_channel_d_gate__alpha_d - 001 * var_L_type_Ca_channel_d_gate__beta_d) * mDt));
        rY[6] = (var_chaste_interface__L_type_Ca_channel_f_gate__f + ((001 * var_L_type_Ca_channel_f_gate__alpha_f) * mDt)) / (1.0 - ((-001 * var_L_type_Ca_channel_f_gate__alpha_f - 001 * var_L_type_Ca_channel_f_gate__beta_f) * mDt));
        rY[7] = (var_chaste_interface__T_type_Ca_channel_b_gate__b + ((001 * var_T_type_Ca_channel_b_gate__b_inf / var_T_type_Ca_channel_b_gate__tau_b) * mDt)) / (1.0 - ((-001 / var_T_type_Ca_channel_b_gate__tau_b) * mDt));
        rY[8] = (var_chaste_interface__T_type_Ca_channel_g_gate__g + ((001 * var_T_type_Ca_channel_g_gate__g_inf / var_T_type_Ca_channel_g_gate__tau_g) * mDt)) / (1.0 - ((-001 / var_T_type_Ca_channel_g_gate__tau_g) * mDt));
        ...
        rY[4] = (var_chaste_interface__fast_sodium_current_j_gate__j + ((001 * var_fast_sodium_current_j_gate__alpha_j) * mDt)) / (1.0 - ((-001 * var_fast_sodium_current_j_gate__alpha_j - 001 * var_fast_sodium_current_j_gate__beta_j) * mDt));
        ...
        rY[9] = (var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr + ((001 * var_rapid_delayed_rectifier_potassium_current_xr_gate__xr_infinity / var_rapid_delayed_rectifier_potassium_current_xr_gate__tau_xr) * mDt)) / (1.0 - ((-001 / var_rapid_delayed_rectifier_potassium_current_xr_gate__tau_xr) * mDt));
        rY[10] = (var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 + ((001 * var_slow_delayed_rectifier_potassium_current_xs1_gate__xs1_infinity / var_slow_delayed_rectifier_potassium_current_xs1_gate__tau_xs1) * mDt)) / (1.0 - ((-001 / var_slow_delayed_rectifier_potassium_current_xs1_gate__tau_xs1) * mDt));
        rY[11] = (var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2 + ((001 * var_slow_delayed_rectifier_potassium_current_xs2_gate__xs2_infinity / var_slow_delayed_rectifier_potassium_current_xs2_gate__tau_xs2) * mDt)) / (1.0 - ((-001 / var_slow_delayed_rectifier_potassium_current_xs2_gate__tau_xs2) * mDt));
        rY[13] = (var_chaste_interface__transient_outward_current_ydv_gate__ydv + ((001 * var_transient_outward_current_ydv_gate__ydv_ss / var_transient_outward_current_ydv_gate__tau_ydv) * mDt)) / (1.0 - ((-001 / var_transient_outward_current_ydv_gate__tau_ydv) * mDt));
        rY[12] = (var_chaste_interface__transient_outward_current_zdv_gate__zdv + ((001 * var_transient_outward_current_zdv_gate__zdv_ss / var_transient_outward_current_zdv_gate__tau_zdv) * mDt)) / (1.0 - ((-001 / var_transient_outward_current_zdv_gate__tau_zdv) * mDt));
