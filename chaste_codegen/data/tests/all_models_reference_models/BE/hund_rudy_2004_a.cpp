...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellhund_rudy_2004_aFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x1 = 0.0023800000000000002 + var_chaste_interface__Ca__Ca_i;
        const double var_x2 = pow(var_x0, (-2));
        const double var_x3 = 1.0 + 0.00011900000000000002 / pow(var_x1, 2) + 3.5000000000000004e-5 * var_x2;
        const double var_x4 = 1.768721357868101e-6 / var_x0;
        const double var_x5 = 0.074871767015599999 * var_chaste_interface__cell__V;
        const double var_x6 = exp(var_x5);
        const double var_x7 = 8.8666719524733664e-8 * var_chaste_interface__cell__V / (-1.0 + var_x6);
        const double var_x8 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x9 = 1 / (13227.9606 + 8.4084932990912282 * var_x8 + 6516533.0625 * var_chaste_interface__Ca__Ca_i);
        const double var_x10 = exp(-0.024333324280070002 * var_chaste_interface__cell__V);
        const double var_x11 = exp(0.01310255922773 * var_chaste_interface__cell__V);
        const double var_x12 = 1.8 * var_x11 * var_x8 - 4116000.0 * var_x10 * var_chaste_interface__Ca__Ca_i;
        const double var_x13 = 1 / (1.0 + 0.27000000000000002 * var_x10);
        const double var_x14 = 1.0 + 6.9444444444444451e-9 / pow(var_chaste_interface__Ca__Ca_i, 2);
        const double var_x15 = var_x13 / var_x14;
        const double var_x16 = var_x12 * var_x15;
        const double var_x17 = 1.0 - var_chaste_interface__Irel__CaMKtrap;
        const double var_x18 = 1 / var_chaste_interface__Ca__Ca_ss;
        const double var_x19 = 1.0 + 0.0015 * var_x18;
        const double var_x20 = 1 / var_x19;
        const double var_x21 = 0.050000000000000003 * var_x20;
        const double var_x22 = var_x17 * var_x21 + var_chaste_interface__Irel__CaMKtrap;
        const double var_x23 = 0.14999999999999999 + var_x22;
        const double var_x24 = 1 / var_x23;
        const double var_x25 = var_x22 * var_x24;
        const double var_x26 = 0.00092000000000000003 - 0.00017000000000000001 * var_x25 + var_chaste_interface__Ca__Ca_i;
        const double var_x27 = 1 / var_x26;
        const double var_x28 = 1.0 + 0.75 * var_x25;
        const double var_x29 = var_x27 * var_x28;
        const double var_x30 = 0.00035514705882352943 * var_x29;
        const double var_x31 = var_x15 * var_x9;
        const double var_x32 = var_x10 * var_x31;
        const double var_x33 = var_x16 / pow((0.0020299076937277489 + 1.2903323313862536e-6 * var_x8 + var_chaste_interface__Ca__Ca_i), 2);
        const double var_x34 = var_x12 * var_x13 * var_x9 / (pow(var_x14, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
        const double var_x35 = 0.00035514705882352943 * var_chaste_interface__Ca__Ca_i;
        const double var_x36 = var_x28 / pow(var_x26, 2);
        const double var_x37 = var_x35 * var_x36;
        const double var_x38 = 1 / var_x3;
        const double var_x39 = 1.0 * var_x38;
        const double var_x40 = pow(var_chaste_interface__Ca__Ca_ss, (-2));
        const double var_x41 = var_x17 * var_x40 / pow(var_x19, 2);
        const double var_x42 = var_x24 * var_x41;
        const double var_x43 = var_x22 / pow(var_x23, 2);
        const double var_x44 = var_x41 * var_x43;
        const double var_x45 = 5.6250000000000005e-5 * var_x42 - 5.6250000000000005e-5 * var_x44;
        const double var_x46 = var_x27 * var_x35;
        const double var_x47 = 1.2750000000000002e-8 * var_x42 - 1.2750000000000002e-8 * var_x44;
        const double var_x48 = 1 - var_x21;
        const double var_x49 = var_x24 * var_x48;
        const double var_x50 = var_x43 * (-1 + var_x21);
        ...
        const double var_x54 = var_x11 * var_x31 * var_x53;
        const double var_x55 = var_x33 * var_x53;
        const double var_x56 = exp(-1.1230765052339999 + var_x5);
        ...
        const double var_x80 = var_x27 * var_x78;
        const double var_x81 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x82 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss;
        const double var_x83 = 1.0 + 0.0097788000000000007 / pow(var_x82, 2) + 4.0890000000000003e-5 / pow(var_x81, 2);
        ...
        const double var_x89 = var_x73 * var_x87;
        ...
        const double var_x116 = 10.0 * var_x25;
        ...
        const double var_x122 = 0.01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x115 + 0.29999999999999999 / (1.0 - 70.217303721661608 * var_x88)) / pow((0.050000000000000003 + var_x25 + 0.10000000000000001 * var_x115), 2);
        const double var_x123 = -10.0 * var_x49 - 10.0 * var_x50;
        const double var_x124 = exp(-4.375 - 87.77162965207701 * var_x88);
        ...
        const double var_x130 = 0.2925720988402567 * var_x124 * (-var_chaste_interface__ICaL__fca2 + 1.0 / (1.0 - 351.08651860830804 * var_x88)) / (pow(var_x125, 2) * pow((0.41666666666666669 + var_x126), 2));
        const double var_x131 = 0.0025000000000000005 * var_x20;
        const double var_x132 = exp(3.3333333333333335 + 234.05767907220539 * var_x88);
        const double var_x133 = 1.0 + var_x132;
        const double var_x134 = var_x132 / pow(var_x133, 2);
        const double var_x135 = var_x134 * var_x89;
        const double var_x136 = 1 / var_x133;
        const double var_x137 = exp(-16.0 + 80.0 * var_x136 + 40000.0 * var_chaste_interface__Ca__Ca_ss);
        const double var_x138 = 1.0 + var_x137;
        const double var_x139 = 350.0 - var_x116;
        const double var_x140 = exp(-15.0 + 5000.0 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_x136);
        const double var_x141 = 1.0 + var_x140;
        const double var_x142 = 1 / var_x141;
        const double var_x143 = var_x139 * var_x142;
        const double var_x144 = 1 / (3.0 + var_x116 + var_x143);
        const double var_x145 = var_x137 * var_x144 / pow(var_x138, 2);
        const double var_x146 = var_x139 * var_x140 / pow(var_x141, 2);
        const double var_x147 = (-var_chaste_interface__Irel__ri + 1.0 / var_x138) / pow((0.29999999999999999 + var_x25 + 0.10000000000000001 * var_x143), 2);
        const double var_x148 = 0.01 * var_x147;
        const double var_x149 = var_x134 * var_x91;
        const double var_x150 = 18724.614325776431 * var_x145;
        const double var_x151 = 35.108651860830804 * var_x146 * var_x147;
        const double var_x152 = var_x134 * var_x93;
        const double var_x153 = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999);
        const double var_x154 = 0.0028 + var_chaste_interface__Ca__Ca_ss;
        const double var_x155 = 1 / var_x154;
        const double var_x156 = pow((var_x155 * var_chaste_interface__Ca__Ca_ss), 1.8999999999999999);
        const double var_x157 = 1 / (var_x153 + 1644.6531773416521 * var_x156);
        const double var_x158 = pow(var_chaste_interface__ICaL__fca, (-2));
        const double var_x159 = pow((-1 + 0.066666666666666666 * var_chaste_interface__cell__V), (-2));
        const double var_x160 = pow(var_x58, 2);
        const double var_x161 = pow(var_x57, (-2));
        const double var_x162 = pow(var_chaste_interface__ICaL__d, (-2 * var_chaste_interface__ICaL__dp));
        const double var_x163 = pow(var_chaste_interface__ICaL__f, (-2));
        const double var_x164 = pow(var_chaste_interface__ICaL__f2, (-2));
        const double var_x165 = pow(var_chaste_interface__ICaL__fca2, (-2));
        const double var_x166 = var_x159 * var_x160 * var_x161 * var_x162 * var_x163 * var_x164 * var_x165;
        const double var_x167 = 1.0 + 0.00036056965579880955 * var_x158 * var_x166;
        const double var_x168 = 1 / var_x167;
        const double var_x169 = var_x168 / pow((var_x156 + 0.00060803092942449902 * var_x153), 2);
        const double var_x170 = 0.00024037977053253972 * var_x153 * var_x157 / pow(var_x167, 2);
        const double var_x171 = var_x158 * var_x159 * var_x160 * var_x162 * var_x163 * var_x164 * var_x170;
        ...
        const double var_x191 = 1 / (var_x8 * pow((0.01 + 1 / var_x53), 2) * (1.0 + 0.1245 * exp(-0.00374358835078 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x96)));
        
        
        rJacobian[0][0] = 1.0 - (mDt * (var_x39 * (-0.14705882352941174 + var_x37 - var_x30 - var_x4 + 3.8450464301480458e-12 * var_x34 - 4.2483225407660435e-11 * var_x33 - 1139.4871996672337 * var_x32 - var_x6 * var_x7 + 1.768721357868101e-6 * var_x2 * var_chaste_interface__Ca__Ca_i) + 1.0 * (0.00023800000000000004 / pow(var_x1, 3) + 7.0000000000000007e-5 / pow(var_x0, 3)) * (0.14705882352941174 * var_chaste_interface__Ca__Ca_ss + 2.3676470588235295e-5 * var_chaste_interface__Ca__Ca_nsr - 0.14705882352941174 * var_chaste_interface__Ca__Ca_i - var_x30 * var_chaste_interface__Ca__Ca_i - var_x4 * var_chaste_interface__Ca__Ca_i - var_x7 * (-0.61380000000000001 + var_x6 * var_chaste_interface__Ca__Ca_i) + 0.00027684334297065928 * var_x16 * var_x9) / pow(var_x3, 2)));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = -(mDt * (2.3676470588235295e-5 * var_x38));
        rJacobian[0][3] = -(mDt * (var_x39 * (0.14705882352941174 - var_x37 * var_x47 - var_x45 * var_x46)));
        rJacobian[0][4] = 0.0;
        rJacobian[0][5] = 0.0;
        rJacobian[0][6] = 0.0;
        rJacobian[0][7] = -(mDt * (var_x39 * (-var_x37 * var_x52 - var_x46 * var_x51)));
        rJacobian[0][8] = 0.0;
        rJacobian[0][9] = 0.0;
        rJacobian[0][10] = 0.0;
        rJacobian[0][11] = 0.0;
        ...
        rJacobian[1][11] = 0.0;
        rJacobian[1][12] = 0.0;
        rJacobian[2][0] = -(mDt * (-var_x79 + 0.0043750000000000004 * var_x29));
        ...
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (1.0 * var_x84 * (-5.0 - var_x85 - 0.0036718475849305066 * var_x89 - 505.56458679596358 * var_x74) + 1.0 * (0.019557600000000001 / pow(var_x82, 3) + 8.1780000000000006e-5 / pow(var_x81, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0.0036718475849305066 * var_x88 + var_x71 * var_x85) / pow(var_x83, 2)));
        rJacobian[3][4] = 0.0;
        ...
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (var_x117 * (-0.0016500000000000002 * var_x118 + var_x120 * var_x89) + var_x122 * (var_x121 + 0.0030000000000000001 * var_x118)));
        rJacobian[5][4] = 0.0;
        ...
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = -(mDt * (var_x129 * var_x89 - var_x130 * var_x89));
        rJacobian[6][4] = 0.0;
        ...
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = -(mDt * (3.7500000000000005e-6 * var_x22 * var_x41 + 1.8750000000000003e-7 * var_x40 * pow(var_x17, 2) / pow(var_x19, 3)));
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-0.00068000000000000005 - var_x131 * var_x22 + var_x131 * var_x17 * var_x48));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        ...
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = -(mDt * (var_x148 * (var_x121 + var_x146 * (5000.0 - 3510.8651860830805 * var_x135) - var_x121 * var_x142) - 1.0 * var_x145 * (40000.0 - 18724.614325776431 * var_x135)));
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = -(mDt * (var_x149 * var_x150 - var_x149 * var_x151));
        rJacobian[8][6] = -(mDt * (var_x150 * var_x152 - var_x151 * var_x152));
        rJacobian[8][7] = -(mDt * (var_x148 * (var_x123 - var_x123 * var_x142)));
        rJacobian[8][8] = 1.0 - (mDt * (-var_x144));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = -(mDt * (-2.3414435371998602e-7 * var_x169 * pow(var_chaste_interface__Ca__Ca_jsr, 2.7999999999999998) + 0.6333333333333333 * var_x157 * var_x168 * pow(var_chaste_interface__Ca__Ca_jsr, 0.89999999999999991)));
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = -(mDt * (var_x165 * var_x171 * var_x56 / pow(var_x57, 3) - 0.00020267697647483301 * var_x153 * var_x154 * var_x156 * var_x169 * var_x18 * (1.8999999999999999 * var_x155 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x154, 2))));
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = -(mDt * (var_x166 * var_x170 / pow(var_chaste_interface__ICaL__fca, 3)));
        rJacobian[9][6] = -(mDt * (var_x161 * var_x171 / pow(var_chaste_interface__ICaL__fca2, 3)));
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        ...
        rJacobian[10][1] = 0.0;
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = -(mDt * (0.1502 * var_x40 / pow((1.0 + 0.1502 * var_x18), 2)));
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = 0.0;
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        ...
        rJacobian[12][0] = -(mDt * (1.274496762229813e-10 * var_x33 + 3418.461599001701 * var_x32 - 1.1535139290444137e-11 * var_x34));
        rJacobian[12][1] = 0.0;
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
