...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellhund_rudy_2004_aFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x0 = 00050000000000000001 + var_chaste_interface__Ca__Ca_i;
        ...
        const double var_x5 = 1.0 + 0015 * var_x4;
        const double var_x6 = 1 / var_x5;
        const double var_x7 = 050000000000000003 * var_x6;
        ...
        const double var_x12 = 00092000000000000003 - 00017000000000000001 * var_x11 + var_chaste_interface__Ca__Ca_i;
        const double var_x13 = 1 / var_x12;
        const double var_x14 = 1.0 + 0.75 * var_x11;
        const double var_x15 = var_x13 * var_x14;
        const double var_x16 = 00035514705882352943 * var_x15;
        const double var_x17 = 00035514705882352943 * var_chaste_interface__Ca__Ca_i;
        const double var_x18 = var_x14 / pow(var_x12, 2);
        const double var_x19 = var_x17 * var_x18;
        const double var_x20 = 074871767015599999 * var_chaste_interface__cell__V;
        ...
        const double var_x24 = exp(01310255922773 * var_chaste_interface__cell__V);
        const double var_x25 = exp(-024333324280070002 * var_chaste_interface__cell__V);
        const double var_x26 = 1.8 * var_x23 * var_x24 - 4116000 * var_x25 * var_chaste_interface__Ca__Ca_i;
        ...
        const double var_x31 = var_x30 / pow((0020299076937277489 + 1.2903323313862536e-6 * var_x23 + var_chaste_interface__Ca__Ca_i), 2);
        ...
        const double var_x36 = 0023800000000000002 + var_chaste_interface__Ca__Ca_i;
        const double var_x37 = 1.0 + 00011900000000000002 / pow(var_x36, 2) + 3.5000000000000004e-5 * var_x2;
        ...
        const double var_x52 = 00017000000000000001 * var_x49 + 00017000000000000001 * var_x50;
        ...
        const double var_x66 = 3000 * var_x65;
        ...
        const double var_x76 = 3000 * var_x69;
        const double var_x77 = var_x63 * var_x72;
        const double var_x78 = 0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x79 = var_x18 * var_x78;
        const double var_x80 = var_x13 * var_x78;
        const double var_x81 = 0086999999999999994 + var_chaste_interface__Ca__Ca_ss;
        const double var_x82 = 00087000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x83 = 1.0 + 0097788000000000007 / pow(var_x81, 2) + 4.0890000000000003e-5 / pow(var_x82, 2);
        ...
        const double var_x92 = 0036718475849305066 * var_x84;
        ...
        const double var_x104 = 00018900582374463672 / (87.825100000000006 + var_x103);
        ...
        const double var_x108 = var_x99 + log(140 * var_x107);
        const double var_x109 = pow(var_x108, 4);
        const double var_x110 = 2.8839711417381356e-9 * pow(var_x108, 7) / pow((1 + 008558014922736952 * var_x109), 2);
        const double var_x111 = 2048989239405216 * pow(var_x108, 3) / (59494197.640692554 + 509152.23122530844 * var_x109);
        ...
        const double var_x116 = 10 * var_x11;
        const double var_x117 = 1 / (0.5 + var_x116 + 1.0 * var_x115);
        const double var_x118 = pow((0030000000000000001 + var_chaste_interface__Ca__Ca_ss), (-2));
        const double var_x119 = -var_x89;
        const double var_x120 = 0042724511494942495 / pow((0142415038316475 + var_x119), 2);
        const double var_x121 = 00075000000000000002 * var_x44 - 00075000000000000002 * var_x42;
        const double var_x122 = 01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x115 + 0.29999999999999999 / (1.0 - 70.217303721661608 * var_x89)) / pow((050000000000000003 + var_x11 + 0.10000000000000001 * var_x115), 2);
        const double var_x123 = -10 * var_x49 - 10 * var_x50;
        ...
        const double var_x127 = 1 / (125.0 + 300 * var_x126);
        const double var_x128 = 0028483007663294996 / pow((0028483007663294996 + var_x119), 2);
        ...
        const double var_x131 = 0025000000000000005 * var_x6;
        ...
        const double var_x135 = exp(-15.0 + 5000 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_x134);
        ...
        const double var_x140 = 350 - var_x116;
        const double var_x141 = var_x135 * var_x140 / pow(var_x136, 2);
        const double var_x142 = var_x137 * var_x140;
        const double var_x143 = exp(-16.0 + 80 * var_x134 + 40000 * var_chaste_interface__Ca__Ca_ss);
        ...
        const double var_x146 = 01 * var_x145;
        ...
        const double var_x154 = pow((-1 + 066666666666666666 * var_chaste_interface__cell__V), (-2));
        ...
        const double var_x163 = 1.0 + 00036056965579880955 * var_x153 * var_x162;
        const double var_x164 = 1 / var_x163;
        const double var_x165 = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999);
        const double var_x166 = 0028 + var_chaste_interface__Ca__Ca_ss;
        ...
        const double var_x170 = var_x164 / pow((var_x168 + 00060803092942449902 * var_x165), 2);
        const double var_x171 = 00024037977053253972 * var_x165 * var_x169 / pow(var_x163, 2);
        ...
        const double var_x176 = 018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i;
        ...
        const double var_x184 = exp(-36.698642499999998 + 061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * var_x101);
        const double var_x185 = exp(0.43983232 + 080320000000000003 * var_chaste_interface__cell__V - 2.1455350448257708 * var_x101);
        ...
        const double var_x191 = var_x177 * (-1.5317126959137754e-6 - 9.1902761754826519e-7 / var_x175) * (0.12553036579548593 * var_chaste_interface__K__K_i + 002300971605031257 * var_chaste_interface__Na__Na_i) / pow(var_x176, 2);
        const double var_x192 = 1 / (var_x23 * pow((01 + 1 / var_x53), 2) * (1.0 + 0.1245 * exp(-00374358835078 * var_chaste_interface__cell__V) + 036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x96)));
        
        
        rJacobian[0][0] = 1.0 - (mDt * (var_x39 * (-0.14705882352941174 + var_x19 - var_x1 - var_x16 + 3.8450464301480458e-12 * var_x35 - 4.2483225407660435e-11 * var_x31 - 1139.4871996672337 * var_x34 - var_x21 * var_x22 + 1.768721357868101e-6 * var_x2 * var_chaste_interface__Ca__Ca_i) + 1.0 * (00023800000000000004 / pow(var_x36, 3) + 7.0000000000000007e-5 / pow(var_x0, 3)) * (0.14705882352941174 * var_chaste_interface__Ca__Ca_ss + 2.3676470588235295e-5 * var_chaste_interface__Ca__Ca_nsr - 0.14705882352941174 * var_chaste_interface__Ca__Ca_i - var_x1 * var_chaste_interface__Ca__Ca_i - var_x16 * var_chaste_interface__Ca__Ca_i - var_x22 * (-0.61380000000000001 + var_x21 * var_chaste_interface__Ca__Ca_i) + 00027684334297065928 * var_x30 * var_x32) / pow(var_x37, 2)));
        rJacobian[0][1] = 0;
        ...
        rJacobian[0][10] = 0;
        rJacobian[0][11] = 0;
        rJacobian[0][12] = -(mDt * (var_x39 * (0014949540520415602 * var_x54 - 1.6445243785522266e-16 * var_x55)));
        rJacobian[1][0] = 0;
        rJacobian[1][1] = 1.0 - (mDt * (var_x70 * (-0083333333333333332 - var_x66) + 0.25 * (0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x66 * var_x71) / (pow(var_x67, 3) * pow((0.125 + var_x68), 2))));
        rJacobian[1][2] = -(mDt * (0083333333333333332 * var_x69));
        ...
        rJacobian[1][11] = 0;
        rJacobian[1][12] = 0;
        rJacobian[2][0] = -(mDt * (-var_x79 + 0043750000000000004 * var_x15));
        rJacobian[2][1] = -(mDt * (00072463768115942019));
        rJacobian[2][2] = 1.0 - (mDt * (-0010163043478260869));
        ...
        rJacobian[3][2] = 0;
        rJacobian[3][3] = 1.0 - (mDt * (1.0 * var_x84 * (-5.0 - var_x85 - 0036718475849305066 * var_x88 - 505.56458679596358 * var_x74) + 1.0 * (019557600000000001 / pow(var_x81, 3) + 8.1780000000000006e-5 / pow(var_x82, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0036718475849305066 * var_x89 + var_x71 * var_x85) / pow(var_x83, 2)));
        rJacobian[3][4] = 0;
        ...
        rJacobian[4][8] = 0;
        rJacobian[4][9] = 0;
        rJacobian[4][10] = -(mDt * (var_x98 * (-100 * var_x97 + var_chaste_interface__Cl__Cl_i)));
        rJacobian[4][11] = -(mDt * (var_x113));
        rJacobian[4][12] = -(mDt * (var_x114));
        rJacobian[5][0] = 0;
        rJacobian[5][1] = 0;
        rJacobian[5][2] = 0;
        rJacobian[5][3] = -(mDt * (var_x117 * (-0016500000000000002 * var_x118 + var_x120 * var_x88) + var_x122 * (var_x121 + 0030000000000000001 * var_x118)));
        rJacobian[5][4] = 0;
        ...
        rJacobian[7][5] = 0;
        rJacobian[7][6] = 0;
        rJacobian[7][7] = 1.0 - (mDt * (-00068000000000000005 - var_x131 * var_x8 + var_x131 * var_x3 * var_x48));
        rJacobian[7][8] = 0;
        rJacobian[7][9] = 0;
        rJacobian[7][10] = 0;
        rJacobian[7][11] = 0;
        ...
        rJacobian[8][1] = 0;
        rJacobian[8][2] = 0;
        rJacobian[8][3] = -(mDt * (var_x146 * (var_x121 + var_x141 * (5000 - 3510.8651860830805 * var_x139) - var_x121 * var_x137) - 1.0 * var_x148 * (40000 - 18724.614325776431 * var_x139)));
        rJacobian[8][4] = 0;
        ...
        rJacobian[9][2] = 0;
        rJacobian[9][3] = -(mDt * (var_x161 * var_x172 * var_x56 / pow(var_x57, 3) - 00020267697647483301 * var_x165 * var_x166 * var_x168 * var_x170 * var_x4 * (1.8999999999999999 * var_x167 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x166, 2))));
        rJacobian[9][4] = 0;
        ...
        rJacobian[11][9] = 0;
        rJacobian[11][10] = 0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x113 + 212.79583259575517 * var_x191 - 4.535681662754383e-6 * var_x100 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V)) - 0008381150898567882 * var_x180 * var_x188 + 00019989044893084398 * var_x188 * var_x189 * var_x190 - 2.2767478584105716e-5 * var_x100 * mParameters[2] * var_chaste_interface__IKr__xr / (1.0 + exp(0.64935064935064934 + 064935064935064929 * var_chaste_interface__cell__V)) - 3.0157226903121925e-5 * var_x180 * var_x189 * (-var_x183 * (1.6494869150646332 * var_x100 * var_x184 + 1.0539726354202117 * var_x100 * var_x185) + 6.4983106368870169 * var_x100 * var_x190 - 13.738155796238718 * var_x100 * var_x181 * var_x186 / pow(var_x182, 2)) / pow((var_x180 + 0.98039215686274506 * var_x187), 2) - 00031223895504468581 * var_x100 * pow(var_chaste_interface__Ito__ydv, 3) * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv * exp(0033333333333333335 * var_chaste_interface__cell__V)));
        ...
        rJacobian[12][10] = 0;
        rJacobian[12][11] = 0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x114 + 4.9335731356566794e-16 * var_x55 - 1.7874450622236046e-6 * var_x192 - 0044848621561246801 * var_x54 - 1.068185898837083e-5 * var_x107 * pow(var_chaste_interface__INal__mL, 3) * var_chaste_interface__INal__hL - 013557744100624516 * var_x107 * pow(var_chaste_interface__INa__m, 3) * mParameters[1] * var_chaste_interface__INa__H * var_chaste_interface__INa__J));
    }
    ...
    void Cellhund_rudy_2004_aFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        ...
        const double var_ICaL__taud = 0.58999999999999997 + 0.80000000000000004 * exp(0.67599999999999993 + 051999999999999998 * var_chaste_interface__cell__V) / (1.0 + exp(1.7160000000000002 + 0.13200000000000001 * var_chaste_interface__cell__V));
        ...
        const double var_ICaL__tauf2 = 1.0 / (0054000000000000003 + 042299999999999997 * exp(-1.20074125971556 * pow((-1 + 053842757610673787 * var_chaste_interface__cell__V), 2)));
        ...
        const double var_IKs__xss = 1.0 / (1.0 + exp(0.4251012145748988 - 04048582995951417 * var_chaste_interface__cell__V));
        const double var_INa__ah = ((var_chaste_interface__cell__V >= -40) ? (0) : (0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V)));
        const double var_INa__aj = ((var_chaste_interface__cell__V >= -40) ? (0) : (1.0 * (37.780000000000001 + var_chaste_interface__cell__V) * (-127140 * exp(0.24440000000000001 * var_chaste_interface__cell__V) - 3.4740000000000003e-5 * exp(-043909999999999998 * var_chaste_interface__cell__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))));
        ...
        const double var_INa__bh = ((var_chaste_interface__cell__V >= -40) ? (7.6923076923076916 / (1.0 + exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__cell__V))) : (310000 * exp(0.34999999999999998 * var_chaste_interface__cell__V) + 3.5600000000000001 * exp(079000000000000001 * var_chaste_interface__cell__V)));
        ...
        const double var_INal__bmL = 080000000000000002 * exp(-090909090909090912 * var_chaste_interface__cell__V);
        const double var_INal__hLss = 1.0 / (1.0 + exp(14.918032786885247 + 0.16393442622950821 * var_chaste_interface__cell__V));
        const double var_Ito__ay = 25.0 * exp(-1.6000000000000001 + 040000000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(-1.6000000000000001 + 040000000000000001 * var_chaste_interface__cell__V));
        const double var_Ito__ay2 = 029999999999999999 / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__cell__V));
        const double var_Ito__ay3 = 0022499999999999998 / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__cell__V));
        const double var_Ito__by = 25.0 * exp(-3.6000000000000001 - 040000000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(-3.6000000000000001 - 040000000000000001 * var_chaste_interface__cell__V));
        ...
        rY[19] = (var_chaste_interface__INal__hL + ((0016666666666666668 * var_INal__hLss) * mDt)) / (1.0 - ((-0016666666666666668) * mDt));
