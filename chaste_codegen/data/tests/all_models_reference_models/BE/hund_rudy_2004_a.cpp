...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellhund_rudy_2004_aFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x99 = log(10);
        const double var_x100 = var_x99 * log10(100.0 * var_x95);
        const double var_x101 = 1 / var_chaste_interface__K__K_i;
        const double var_x102 = var_x99 * log10(5.4000000000000004 * var_x101);
        const double var_x103 = 26.712338705500134 * var_x102;
        const double var_x104 = var_x103 + 26.712338705500134 * var_x100;
        const double var_x105 = 0.00018900582374463672 / (87.825100000000006 + var_x104);
        const double var_x106 = 2.4504050574883893e-8 * var_x104 / pow((1 + 0.30415380916731244 * var_x100 + 0.30415380916731244 * var_x102), 2);
        const double var_x107 = var_x106 * var_x95 - var_x105 * var_x95;
        const double var_x108 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x109 = var_x100 + var_x99 * log10(140.0 * var_x108);
        const double var_x110 = pow(var_x109, 4);
        const double var_x111 = 2.8839711417381356e-9 * pow(var_x109, 7) / pow((1 + 0.008558014922736952 * var_x110), 2);
        const double var_x112 = 20.048989239405216 * pow(var_x109, 3) / (59494197.640692554 + 509152.23122530844 * var_x110);
        const double var_x113 = var_x111 * var_x95 - var_x112 * var_x95;
        const double var_x114 = var_x101 * var_x106 - var_x101 * var_x105;
        const double var_x115 = var_x108 * var_x111 - var_x108 * var_x112;
        const double var_x116 = 1 / (1.0 + 333.33333333333331 * var_chaste_interface__Ca__Ca_ss);
        const double var_x117 = 10.0 * var_x14;
        const double var_x118 = 1 / (0.5 + var_x116 + var_x117);
        const double var_x119 = pow((0.0030000000000000001 + var_chaste_interface__Ca__Ca_ss), (-2));
        const double var_x120 = -var_x89;
        const double var_x121 = 0.0042724511494942495 / pow((0.0142415038316475 + var_x120), 2);
        const double var_x122 = 0.00075000000000000002 * var_x43 - 0.00075000000000000002 * var_x41;
        const double var_x123 = 0.01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x116 + 0.29999999999999999 / (1.0 - 70.217303721661608 * var_x89)) / pow((0.050000000000000003 + var_x14 + 0.10000000000000001 * var_x116), 2);
        const double var_x124 = -10.0 * var_x48 - 10.0 * var_x49;
        const double var_x125 = exp(-4.375 - 87.77162965207701 * var_x89);
        const double var_x126 = 1.0 + var_x125;
        const double var_x127 = 1 / var_x126;
        const double var_x128 = 1 / (125.0 + 300.0 * var_x127);
        const double var_x129 = pow((0.0028483007663294996 + var_x120), (-2));
        const double var_x130 = 0.0028483007663294996 * var_x128 * var_x129;
        const double var_x131 = 0.2925720988402567 * var_x125 * (1 / (1.0 - 351.08651860830804 * var_x89) - var_chaste_interface__ICaL__fca2) / (pow(var_x126, 2) * pow((0.41666666666666669 + var_x127), 2));
        const double var_x132 = 0.0025000000000000005 * var_x9;
        const double var_x133 = exp(3.3333333333333335 + 234.05767907220539 * var_x89);
        const double var_x134 = 1.0 + var_x133;
        const double var_x135 = 1 / var_x134;
        const double var_x136 = exp(-15.0 + 5000.0 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_x135);
        const double var_x137 = 1.0 + var_x136;
        const double var_x138 = 1 / var_x137;
        const double var_x139 = var_x133 / pow(var_x134, 2);
        const double var_x140 = var_x139 * var_x88;
        const double var_x141 = 350.0 - var_x117;
        const double var_x142 = var_x136 * var_x141 / pow(var_x137, 2);
        const double var_x143 = var_x138 * var_x141;
        const double var_x144 = exp(-16.0 + 80.0 * var_x135 + 40000.0 * var_chaste_interface__Ca__Ca_ss);
        const double var_x145 = 1.0 + var_x144;
        const double var_x146 = (1 / var_x145 - var_chaste_interface__Irel__ri) / pow((0.29999999999999999 + var_x14 + 0.10000000000000001 * var_x143), 2);
        const double var_x147 = 0.01 * var_x146;
        const double var_x148 = 1 / (3.0 + var_x117 + var_x143);
        const double var_x149 = var_x144 * var_x148 / pow(var_x145, 2);
        const double var_x150 = var_x139 * var_x91;
        const double var_x151 = 18724.614325776431 * var_x149;
        const double var_x152 = 35.108651860830804 * var_x142 * var_x146;
        const double var_x153 = var_x139 * var_x93;
        const double var_x154 = pow(var_chaste_interface__ICaL__fca, (-2));
        const double var_x155 = pow((-1 + 0.066666666666666666 * var_chaste_interface__cell__V), (-2));
        const double var_x156 = pow(var_x60, 2);
        const double var_x157 = pow(var_x59, (-2));
        const double var_x158 = pow(mParameters[0], (-2));
        const double var_x159 = pow(var_chaste_interface__ICaL__d, (-2 * var_chaste_interface__ICaL__dp));
        const double var_x160 = pow(var_chaste_interface__ICaL__f, (-2));
        const double var_x161 = pow(var_chaste_interface__ICaL__f2, (-2));
        const double var_x162 = pow(var_chaste_interface__ICaL__fca2, (-2));
        const double var_x163 = var_x155 * var_x156 * var_x157 * var_x158 * var_x159 * var_x160 * var_x161 * var_x162;
        const double var_x164 = 1.0 + 0.00036056965579880955 * var_x154 * var_x163;
        const double var_x165 = 1 / var_x164;
        const double var_x166 = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999);
        const double var_x167 = 0.0028 + var_chaste_interface__Ca__Ca_ss;
        const double var_x168 = 1 / var_x167;
        const double var_x169 = pow((var_x168 * var_chaste_interface__Ca__Ca_ss), 1.8999999999999999);
        const double var_x170 = 1 / (var_x166 + 1644.6531773416521 * var_x169);
        const double var_x171 = var_x165 / pow((var_x169 + 0.00060803092942449902 * var_x166), 2);
        const double var_x172 = 0.00024037977053253972 * var_x166 * var_x170 / pow(var_x164, 2);
        const double var_x173 = var_x154 * var_x155 * var_x156 * var_x158 * var_x159 * var_x160 * var_x161 * var_x172;
        const double var_x174 = 1 / var_chaste_interface__Ca__Ca_i;
        const double var_x175 = pow(var_x174, 1.3999999999999999);
        const double var_x176 = 1.0 + 6.4818210260626455e-7 * var_x175;
        const double var_x177 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
        const double var_x178 = var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2;
        const double var_x179 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 6.370892781261781 * var_x102);
        const double var_x180 = 1.0 + var_x179;
        const double var_x181 = 1 / var_x180;
        const double var_x182 = exp(-2.4444678999999998 + 13.738155796238718 * var_x102 - 0.51429999999999998 * var_chaste_interface__cell__V);
        const double var_x183 = 1.0 + var_x182;
        const double var_x184 = 1 / var_x183;
        const double var_x185 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 2.1455350448257708 * var_x102);
        const double var_x186 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * var_x102);
        const double var_x187 = var_x186 + 0.49124000000000001 * var_x185;
        const double var_x188 = var_x184 * var_x187;
        const double var_x189 = var_x101 / (var_x188 + 1.02 * var_x181);
        const double var_x190 = var_x177 * var_x178 * (-1.5317126959137754e-6 - 9.1902761754826519e-7 / var_x176);
        const double var_x191 = -var_x103 + var_chaste_interface__cell__V;
        const double var_x192 = var_x179 / pow(var_x180, 2);
        const double var_x193 = 1 / (var_x26 * pow((0.01 + 1 / var_x52), 2) * (1.0 + 0.1245 * exp(-0.00374358835078 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x96)));
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (var_x107 + var_x113 - 3.6975665728975948e-7 * var_x95 + var_x98 * var_chaste_interface__Ito2__AA));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        ...
        rJacobian[4][11] = -(mDt * (var_x114));
        rJacobian[4][12] = -(mDt * (var_x115));
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (var_x118 * (-0.0016500000000000002 * var_x119 + var_x121 * var_x88) + var_x123 * (var_x122 + 0.0030000000000000001 * var_x119)));
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (var_x118 * (-1 + var_x121 * var_x91)));
        rJacobian[5][6] = -(mDt * (var_x118 * var_x121 * var_x93));
        rJacobian[5][7] = -(mDt * (var_x123 * var_x124));
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = 0.0;
        ...
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = -(mDt * (var_x130 * var_x88 - var_x131 * var_x88));
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (var_x130 * var_x91 - var_x131 * var_x91));
        rJacobian[6][6] = 1.0 - (mDt * (var_x128 * (-1 + 0.0028483007663294996 * var_x129 * var_x59 * var_x61 * var_x62 * var_x86 * mParameters[0] * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca) - var_x131 * var_x93));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-0.00068000000000000005 - var_x11 * var_x132 + var_x132 * var_x47 * var_x6));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        ...
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = -(mDt * (var_x147 * (var_x122 + var_x142 * (5000.0 - 3510.8651860830805 * var_x140) - var_x122 * var_x138) - var_x149 * (40000.0 - 18724.614325776431 * var_x140)));
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = -(mDt * (var_x150 * var_x151 - var_x150 * var_x152));
        rJacobian[8][6] = -(mDt * (var_x151 * var_x153 - var_x152 * var_x153));
        rJacobian[8][7] = -(mDt * (var_x147 * (var_x124 - var_x124 * var_x138)));
        rJacobian[8][8] = 1.0 - (mDt * (-var_x148));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = -(mDt * (-2.3414435371998602e-7 * var_x171 * pow(var_chaste_interface__Ca__Ca_jsr, 2.7999999999999998) + 0.6333333333333333 * var_x165 * var_x170 * pow(var_chaste_interface__Ca__Ca_jsr, 0.89999999999999991)));
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = -(mDt * (var_x162 * var_x173 * var_x58 / pow(var_x59, 3) - 0.00020267697647483301 * var_x166 * var_x167 * var_x169 * var_x171 * var_x7 * (1.8999999999999999 * var_x168 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x167, 2))));
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = -(mDt * (var_x163 * var_x172 / pow(var_chaste_interface__ICaL__fca, 3)));
        rJacobian[9][6] = -(mDt * (var_x157 * var_x173 / pow(var_chaste_interface__ICaL__fca2, 3)));
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        ...
        rJacobian[10][11] = 0.0;
        rJacobian[10][12] = 0.0;
        rJacobian[11][0] = -(mDt * (-8.3397615489392458e-13 * var_x174 * var_x175 * var_x178 * (-26.712338705500134 * var_x99 * log10(7.9662000000000006 * var_x177) + var_chaste_interface__cell__V) / pow(var_x176, 2)));
        rJacobian[11][1] = 0.0;
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = -(mDt * (var_x107));
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x114 + 26.712338705500134 * var_x190 - 4.535681662754383e-6 * var_x101 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V)) - 0.0008381150898567882 * var_x181 * var_x189 + 0.00019989044893084398 * var_x189 * var_x191 * var_x192 - 2.2767478584105716e-5 * var_x101 * mParameters[2] * var_chaste_interface__IKr__xr / (1.0 + exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__cell__V)) - 3.0157226903121925e-5 * var_x181 * var_x191 * (-var_x184 * (1.6494869150646332 * var_x101 * var_x186 + 1.0539726354202117 * var_x101 * var_x185) + 6.4983106368870169 * var_x101 * var_x192 - 13.738155796238718 * var_x101 * var_x182 * var_x187 / pow(var_x183, 2)) / pow((var_x181 + 0.98039215686274506 * var_x188), 2) - 0.00031223895504468581 * var_x101 * pow(var_chaste_interface__Ito__ydv, 3) * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv * exp(0.0033333333333333335 * var_chaste_interface__cell__V)));
        rJacobian[11][12] = -(mDt * (0.48963716847181737 * var_x190 + 1.191630041482403e-6 * var_x193));
        rJacobian[12][0] = -(mDt * (1.274496762229813e-10 * var_x34 + 3418.461599001701 * var_x37 - 1.1535139290444137e-11 * var_x38));
        rJacobian[12][1] = 0.0;
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (var_x113));
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = 0.0;
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x115 + 4.9335731356566794e-16 * var_x54 - 1.7874450622236046e-6 * var_x193 - 0.0044848621561246801 * var_x53 - 1.068185898837083e-5 * var_x108 * pow(var_chaste_interface__INal__mL, 3) * var_chaste_interface__INal__hL - 0.013557744100624516 * var_x108 * pow(var_chaste_interface__INa__m, 3) * mParameters[1] * var_chaste_interface__INa__H * var_chaste_interface__INa__J));
    }
