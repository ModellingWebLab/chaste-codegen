...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    double Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut::Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut::~Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut()
    {
    }

    
    double Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__Environment__time, const double rCurrentGuess[13], double rResidual[13])
    {
    ...
    void Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: mV; Initial value: -85.781844107117
        ...
        const double var_x37 = exp(-0.024333324280070002 * var_chaste_interface__cell__V);
        ...
        const double var_x41 = exp(0.01310255922773 * var_chaste_interface__cell__V);
        ...
        const double var_x88 = -15.0 + var_chaste_interface__cell__V;
        const double var_x89 = fabs(var_x88) < 1.3356169352718439e-6;
        const double var_x90 = exp(-1.1230765052339999 + var_x7);
        const double var_x91 = var_x56 + var_x77 * var_x90;
        const double var_x92 = -1.0 + var_x90;
        const double var_x93 = var_x88 * mParameters[4] / var_x92;
        const double var_x94 = 2889.6009762000663 * var_x93;
        const double var_x95 = exp(2.6000000000000001 + var_x91 * var_x94);
        const double var_x96 = 1.0 + var_x95;
        const double var_x97 = ((var_x89) ? (1 / var_x87) : (1 / var_x96));
        const double var_x98 = mParameters[0] * var_chaste_interface__Irel__ri * var_chaste_interface__Irel__ro;
        const double var_x99 = var_x97 * var_x98;
        const double var_x100 = 0.80000000000000004 + var_chaste_interface__Ca__Ca_jsr;
        const double var_x101 = pow(var_x100, (-2));
        const double var_x102 = 1 / (1.0 + 8.0 * var_x101);
        const double var_x103 = var_x102;
        const double var_x104 = var_x99 * (-var_chaste_interface__Ca__Ca_ss + var_chaste_interface__Ca__Ca_jsr);
        const double var_x105 = -var_chaste_interface__Ca__Ca_jsr + var_chaste_interface__Ca__Ca_ss;
        const double var_x106 = var_x80 * var_x81;
        const double var_x107 = var_x106 * var_x78;
        const double var_x108 = var_x107 + var_x76 * var_x79;
        const double var_x109 = var_x98 * ((var_x89) ? (-var_x86 * (var_x108 * (-1123076.4052366593 + 74871.767015777295 * var_chaste_interface__cell__V) - var_x106 * var_x85) / pow(var_x87, 2)) : (-var_x90 * var_x94 * var_x95 / pow(var_x96, 2)));
        const double var_x110 = var_x97 * mParameters[0];
        const double var_x111 = var_x110 * var_chaste_interface__Irel__ro;
        const double var_x112 = var_x103 * var_x105;
        const double var_x113 = var_x110 * var_chaste_interface__Irel__ri;
        const double var_x114 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x115 = var_x114 * var_x28;
        const double var_x116 = var_x114 * var_x23;
        const double var_x117 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss;
        const double var_x118 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x119 = 1.0 + 0.0097788000000000007 / pow(var_x117, 2) + 4.0890000000000003e-5 / pow(var_x118, 2);
        const double var_x120 = 1 / var_x119;
        const double var_x121 = 0.23999999999999996 * var_x99;
        const double var_x122 = pow(var_chaste_interface__ICaL__d, var_chaste_interface__ICaL__dp) * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2;
        const double var_x123 = var_x122 * var_chaste_interface__ICaL__fca2;
        const double var_x124 = var_x123 * var_chaste_interface__ICaL__fca;
        const double var_x125 = 14448.004881000332 * var_x93;
        const double var_x126 = ((var_x89) ? (var_x124 * (-var_x107 + var_x108 * (-5615382.0261832969 + 374358.83507888648 * var_chaste_interface__cell__V))) : (var_x124 * var_x125 * var_x90));
        const double var_x127 = 0.23999999999999996 * var_chaste_interface__Ca__Ca_jsr - 0.23999999999999996 * var_chaste_interface__Ca__Ca_ss;
        const double var_x128 = var_x120;
        const double var_x129 = var_x122 * (-var_x83 + 374358.83507888648 * var_x84);
        const double var_x130 = var_x129 * var_chaste_interface__ICaL__fca2;
        const double var_x131 = var_x125 * var_x91;
        const double var_x132 = ((var_x89) ? (var_x130 * var_chaste_interface__ICaL__fca) : (var_x124 * var_x131));
        const double var_x133 = ((var_x89) ? (var_x130) : (var_x123 * var_x131));
        const double var_x134 = 0.0010458526290002684 * var_x120;
        const double var_x135 = ((var_x89) ? (var_x129 * var_chaste_interface__ICaL__fca) : (var_x122 * var_x131 * var_chaste_interface__ICaL__fca));
        const double var_x136 = var_x127 * var_x128;
        const double var_x137 = 1 / var_chaste_interface__Cl__Cl_i;
        const double var_x138 = 3.8593999999999993e-9 / (1.0 - var_x2);
        const double var_x139 = 3.8593999999999993e-9 / (1.0 - var_x0);
        const double var_x140 = var_x5 < 2.671233870550013e-6;
        const double var_x141 = 0.0374358835078 * var_chaste_interface__cell__V;
        const double var_x142 = exp(var_x141);
        const double var_x143 = 0.001444800488100033 * var_chaste_interface__cell__V / (1.0 - var_x142);
        const double var_x144 = log(100.0 * var_x137);
        const double var_x145 = 1 / var_chaste_interface__K__K_i;
        const double var_x146 = log(var_x145 * mParameters[2]);
        const double var_x147 = 26.712338705500134 * var_x146;
        const double var_x148 = var_x147 + 26.712338705500134 * var_x144;
        const double var_x149 = 0.00018900582374463672 / (87.825100000000006 + var_x148);
        const double var_x150 = 2.4504050574883893e-8 * var_x148 / pow((1 + 0.30415380916731244 * var_x144 + 0.30415380916731244 * var_x146), 2);
        const double var_x151 = var_x137 * var_x150 - var_x137 * var_x149;
        const double var_x152 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x153 = var_x144 + log(var_x152 * mParameters[3]);
        const double var_x154 = pow(var_x153, 4);
        const double var_x155 = 2.8839711417381356e-9 * pow(var_x153, 7) / pow((1 + 0.008558014922736952 * var_x154), 2);
        const double var_x156 = 20.048989239405216 * pow(var_x153, 3) / (59494197.640692554 + 509152.23122530844 * var_x154);
        const double var_x157 = var_x137 * var_x155 - var_x137 * var_x156;
        const double var_x158 = var_x138 * (-100.0 * var_x2 + var_chaste_interface__Cl__Cl_i);
        const double var_x159 = var_x145 * var_x150 - var_x145 * var_x149;
        const double var_x160 = var_x152 * var_x155 - var_x152 * var_x156;
        const double var_x161 = 1 / (1.0 + 333.33333333333331 * var_chaste_interface__Ca__Ca_ss);
        const double var_x162 = 10.0 * var_x21;
        const double var_x163 = 1 / (0.5 + var_x162 + var_x161);
        const double var_x164 = pow((0.0030000000000000001 + var_chaste_interface__Ca__Ca_ss), (-2));
        const double var_x165 = -var_x132;
        const double var_x166 = 0.014999999999999999 / pow((0.050000000000000003 + var_x165), 2);
        const double var_x167 = 0.00075000000000000002 * var_x62 - 0.00075000000000000002 * var_x60;
        const double var_x168 = 0.01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x161 + 0.29999999999999999 / (1.0 - 20.0 * var_x132)) / pow((0.050000000000000003 + var_x21 + 0.10000000000000001 * var_x161), 2);
        const double var_x169 = -10.0 * var_x67 - 10.0 * var_x68;
        const double var_x170 = exp(-4.375 - 25.0 * var_x132);
        const double var_x171 = 1.0 + var_x170;
        const double var_x172 = 1 / var_x171;
        const double var_x173 = 1 / (125.0 + 300.0 * var_x172);
        const double var_x174 = 0.01 / pow((0.01 + var_x165), 2);
        const double var_x175 = var_x173 * var_x174;
        const double var_x176 = 0.083333333333333329 * var_x170 * (-var_chaste_interface__ICaL__fca2 + 1 / (1.0 - 100.0 * var_x132)) / (pow(var_x171, 2) * pow((0.41666666666666669 + var_x172), 2));
        const double var_x177 = 0.0025000000000000005 * var_x16;
        const double var_x178 = exp(3.3333333333333335 + 66.666666666666671 * var_x132);
        const double var_x179 = 1.0 + var_x178;
        const double var_x180 = 1 / var_x179;
        const double var_x181 = exp(-15.0 + 5000.0 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_x180);
        const double var_x182 = 1.0 + var_x181;
        const double var_x183 = 1 / var_x182;
        const double var_x184 = var_x178 / pow(var_x179, 2);
        const double var_x185 = var_x126 * var_x184;
        const double var_x186 = 350.0 - var_x162;
        const double var_x187 = var_x181 * var_x186 / pow(var_x182, 2);
        const double var_x188 = var_x183 * var_x186;
        const double var_x189 = exp(-16.0 + 80.0 * var_x180 + 40000.0 * var_chaste_interface__Ca__Ca_ss);
        const double var_x190 = 1.0 + var_x189;
        const double var_x191 = (-var_chaste_interface__Irel__ri + 1 / var_x190) / pow((0.29999999999999999 + var_x21 + 0.10000000000000001 * var_x188), 2);
        const double var_x192 = 0.01 * var_x191;
        const double var_x193 = 1 / (3.0 + var_x162 + var_x188);
        const double var_x194 = var_x189 * var_x193 / pow(var_x190, 2);
        const double var_x195 = var_x133 * var_x184;
        const double var_x196 = 5333.333333333333 * var_x194;
        const double var_x197 = 10.0 * var_x187 * var_x191;
        const double var_x198 = var_x135 * var_x184;
        const double var_x199 = var_x84 - 5.1546799999759483e-8 * var_x82 * mParameters[4];
        const double var_x200 = pow(var_x199, (-2));
        const double var_x201 = pow(var_chaste_interface__ICaL__d, (-2 * var_chaste_interface__ICaL__dp));
        const double var_x202 = pow(var_chaste_interface__ICaL__f, (-2));
        const double var_x203 = pow(var_chaste_interface__ICaL__f2, (-2));
        const double var_x204 = var_x201 * var_x202 * var_x203 / pow(var_chaste_interface__ICaL__fca2, 2);
        const double var_x205 = var_x200 * var_x204;
        const double var_x206 = pow(var_chaste_interface__ICaL__fca, (-2));
        const double var_x207 = 7.1354903911398109e-12 * var_x206;
        const double var_x208 = pow((-1 + 0.066666666666666666 * var_chaste_interface__cell__V), (-2));
        const double var_x209 = pow(var_x92, 2);
        const double var_x210 = pow(mParameters[4], (-2));
        const double var_x211 = var_x208 * var_x209 * var_x210 / pow(var_x91, 2);
        const double var_x212 = var_x204 * var_x211;
        const double var_x213 = 1.0 + ((var_x89) ? (var_x205 * var_x207) : (2.1291277605263905e-11 * var_x206 * var_x212));
        const double var_x214 = 1 / var_x213;
        const double var_x215 = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999);
        const double var_x216 = 0.0028 + var_chaste_interface__Ca__Ca_ss;
        const double var_x217 = 1 / var_x216;
        const double var_x218 = pow((var_x217 * var_chaste_interface__Ca__Ca_ss), 1.8999999999999999);
        const double var_x219 = 1 / (var_x215 + 1644.6531773416521 * var_x218);
        const double var_x220 = var_x214 / pow((var_x218 + 0.00060803092942449902 * var_x215), 2);
        const double var_x221 = 0.33333333333333331 * var_x215 * var_x219 / pow(var_x213, 2);
        const double var_x222 = pow(var_chaste_interface__ICaL__fca, (-3));
        const double var_x223 = var_x201 * var_x202 * var_x203 * var_x206 / pow(var_chaste_interface__ICaL__fca2, 3);
        const double var_x224 = 1 / var_chaste_interface__Ca__Ca_i;
        const double var_x225 = pow(var_x224, 1.3999999999999999);
        const double var_x226 = 1.0 + 6.4818210260626455e-7 * var_x225;
        const double var_x227 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
        const double var_x228 = mParameters[8] * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2;
        const double var_x229 = var_x227 * var_x228 * (-6.1520742882368733e-5 - 3.6912445729421236e-5 / var_x226);
        const double var_x230 = sqrt(mParameters[2]);
        const double var_x231 = var_x145 * var_x230;
        const double var_x232 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 6.370892781261781 * var_x146);
        const double var_x233 = 1.0 + var_x232;
        const double var_x234 = 1 / var_x233;
        const double var_x235 = exp(-2.4444678999999998 + 13.738155796238718 * var_x146 - 0.51429999999999998 * var_chaste_interface__cell__V);
        const double var_x236 = 1.0 + var_x235;
        const double var_x237 = 1 / var_x236;
        const double var_x238 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * var_x146);
        const double var_x239 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 2.1455350448257708 * var_x146);
        const double var_x240 = var_x238 + 0.49124000000000001 * var_x239;
        const double var_x241 = var_x237 * var_x240;
        const double var_x242 = 1 / (var_x241 + 1.02 * var_x234);
        const double var_x243 = var_x234 * mParameters[6];
        const double var_x244 = var_x145 * var_x232 / pow(var_x233, 2);
        const double var_x245 = var_x230 * (-var_x147 + var_chaste_interface__cell__V);
        const double var_x246 = mParameters[2] / (var_x33 * (1.5 + mParameters[2]) * pow((0.01 + 1 / var_x71), 2) * (1.0 + 0.1245 * exp(-0.00374358835078 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[3])) * exp(-var_x141)));
        const double var_x247 = 1.827729786302835e-16 * var_x45;
        ...
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (var_x103 * (-0.0083333333333333332 - var_x99) + 0.25 * (-var_x104 + 0.0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0.0083333333333333332 * var_chaste_interface__Ca__Ca_jsr) / (pow(var_x100, 3) * pow((0.125 + var_x101), 2))));
        rJacobian[1][2] = -(mDt * (0.0083333333333333332 * var_x102));
        rJacobian[1][3] = -(mDt * (var_x103 * (var_x99 + var_x105 * var_x109)));
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[1][7] = 0.0;
        rJacobian[1][8] = -(mDt * (var_x111 * var_x112));
        rJacobian[1][9] = -(mDt * (var_x112 * var_x113));
        rJacobian[1][10] = 0.0;
        rJacobian[1][11] = 0.0;
        rJacobian[1][12] = 0.0;
        rJacobian[2][0] = -(mDt * (-var_x115 + 0.0043750000000000004 * var_x25));
        rJacobian[2][1] = -(mDt * (0.00072463768115942019));
        rJacobian[2][2] = 1.0 - (mDt * (-0.0010163043478260869));
        rJacobian[2][3] = -(mDt * (var_x115 * var_x65 + var_x116 * var_x63));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = -(mDt * (var_x115 * var_x70 + var_x116 * var_x69));
        rJacobian[2][8] = 0.0;
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = 0.0;
        rJacobian[2][12] = 0.0;
        rJacobian[3][0] = -(mDt * (5.0 * var_x120));
        rJacobian[3][1] = -(mDt * (var_x120 * var_x121));
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (var_x128 * (-5.0 - var_x121 - 0.0010458526290002684 * var_x126 + var_x109 * var_x127) + (0.019557600000000001 / pow(var_x117, 3) + 8.1780000000000006e-5 / pow(var_x118, 3)) * (0.23999999999999996 * var_x104 + 5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0.0010458526290002684 * var_x132) / pow(var_x119, 2)));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (-var_x133 * var_x134));
        rJacobian[3][6] = -(mDt * (-var_x134 * var_x135));
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = -(mDt * (var_x111 * var_x136));
        rJacobian[3][9] = -(mDt * (var_x113 * var_x136));
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = 0.0;
        rJacobian[3][12] = 0.0;
        rJacobian[4][0] = 0.0;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (var_x151 + var_x157 - 3.6975665728975948e-7 * var_x137 + 6.1520742882368733e-5 * ((var_x140) ? (-var_x138 + (0.5 + 187179.41753900002 * var_chaste_interface__cell__V) * (var_x138 + var_x139)) : (var_x143)) * var_chaste_interface__Ito2__AA));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = -(mDt * (6.1520742882368733e-5 * ((var_x140) ? (-var_x158 + 187179.41753900002 * (2.671233870550013e-6 + var_chaste_interface__cell__V) * (var_x158 + var_x139 * (-100.0 * var_x0 + var_chaste_interface__Cl__Cl_i))) : (var_x143 * (-100.0 * var_x142 + var_chaste_interface__Cl__Cl_i)))));
        rJacobian[4][11] = -(mDt * (var_x159));
        rJacobian[4][12] = -(mDt * (var_x160));
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (var_x163 * (-0.0016500000000000002 * var_x164 + var_x126 * var_x166) + var_x168 * (var_x167 + 0.0030000000000000001 * var_x164)));
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (var_x163 * (-1 + var_x133 * var_x166)));
        rJacobian[5][6] = -(mDt * (var_x135 * var_x163 * var_x166));
        rJacobian[5][7] = -(mDt * (var_x168 * var_x169));
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = 0.0;
        ...
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = -(mDt * (var_x126 * var_x175 - var_x126 * var_x176));
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (var_x133 * var_x175 - var_x133 * var_x176));
        rJacobian[6][6] = 1.0 - (mDt * (var_x173 * (-1 + var_x135 * var_x174) - var_x135 * var_x176));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-0.00068000000000000005 - var_x177 * var_x18 + var_x13 * var_x177 * var_x66));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        ...
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = -(mDt * (var_x192 * (var_x167 + var_x187 * (5000.0 - 1000.0 * var_x185) - var_x167 * var_x183) - var_x194 * (40000.0 - 5333.333333333333 * var_x185)));
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = -(mDt * (var_x195 * var_x196 - var_x195 * var_x197));
        rJacobian[8][6] = -(mDt * (var_x196 * var_x198 - var_x197 * var_x198));
        rJacobian[8][7] = -(mDt * (var_x192 * (var_x169 - var_x169 * var_x183)));
        rJacobian[8][8] = 1.0 - (mDt * (-var_x193));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = -(mDt * (-2.3414435371998602e-7 * var_x220 * pow(var_chaste_interface__Ca__Ca_jsr, 2.7999999999999998) + 0.6333333333333333 * var_x214 * var_x219 * pow(var_chaste_interface__Ca__Ca_jsr, 0.89999999999999991)));
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = -(mDt * (-var_x221 * ((var_x89) ? (var_x204 * var_x207 * (-2 * var_x108 * var_x75 + 1.0309359999951897e-7 * var_x106 * mParameters[4]) / pow(var_x199, 3)) : (-4.258255521052781e-11 * var_x204 * var_x206 * var_x208 * var_x209 * var_x210 * var_x90 / pow(var_x91, 3))) - 0.00020267697647483301 * var_x14 * var_x215 * var_x216 * var_x218 * var_x220 * (1.8999999999999999 * var_x217 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x216, 2))));
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = -(mDt * (-var_x221 * ((var_x89) ? (-1.4270980782279622e-11 * var_x205 * var_x222) : (-4.258255521052781e-11 * var_x212 * var_x222))));
        rJacobian[9][6] = -(mDt * (-var_x221 * ((var_x89) ? (-1.4270980782279622e-11 * var_x200 * var_x223) : (-4.258255521052781e-11 * var_x211 * var_x223))));
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        ...
        rJacobian[10][11] = 0.0;
        rJacobian[10][12] = 0.0;
        rJacobian[11][0] = -(mDt * (-3.3496381359330236e-11 * var_x224 * var_x225 * var_x228 * (-26.712338705500134 * log(var_x227 * (0.018329999999999999 * mParameters[3] + mParameters[2])) + var_chaste_interface__cell__V) / pow(var_x226, 2)));
        rJacobian[11][1] = 0.0;
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = -(mDt * (var_x151));
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x159 + 26.712338705500134 * var_x229 - 4.535681662754383e-6 * var_x145 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V)) - 0.00072133461893788295 * var_x231 * var_x242 * var_x243 + 0.00017203830661668509 * var_x242 * var_x244 * var_x245 * mParameters[6] - 0.00070719080288027735 * var_x231 * mParameters[7] * var_chaste_interface__IKr__xr / (1.0 + exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__cell__V)) - 2.595520834746433e-5 * var_x243 * var_x245 * (6.4983106368870169 * var_x244 - var_x237 * (1.6494869150646332 * var_x145 * var_x238 + 1.0539726354202117 * var_x145 * var_x239) - 13.738155796238718 * var_x145 * var_x235 * var_x240 / pow(var_x236, 2)) / pow((var_x234 + 0.98039215686274506 * var_x241), 2) - 0.0016433629212878199 * var_x145 * pow(var_chaste_interface__Ito__ydv, 3) * mParameters[10] * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv * exp(0.0033333333333333335 * var_chaste_interface__cell__V)));
        rJacobian[11][12] = -(mDt * (1.5226383863386261e-6 * var_x246 + 0.48963716847181743 * var_x229));
        rJacobian[12][0] = -(mDt * (0.00027684334297065928 * var_x51 - 2.563364286765364e-12 * var_x49 - var_x247 * var_x32));
        rJacobian[12][1] = 0.0;
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (var_x157));
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = 0.0;
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x160 - 0.00055368668594131857 * var_x74 - 2.283957579507939e-6 * var_x246 - var_x247 * var_x73 - 1.068185898837083e-5 * var_x152 * pow(var_chaste_interface__INal__mL, 3) * var_chaste_interface__INal__hL - 0.0016433629212878199 * var_x152 * pow(var_chaste_interface__INa__m, 3) * mParameters[5] * var_chaste_interface__INa__H * var_chaste_interface__INa__J));
    }

    void Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__Environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        const double var_Ito__ay3 = 0.0038999999999999998 / (1.0 + exp(12.6 + 0.20000000000000001 * var_chaste_interface__cell__V));
        ...
        CardiacNewtonSolver<13,Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<13,Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut)
