...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellbenson_epicardial_2008FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x30 = exp(-0.024333324280070002 * var_chaste_interface__cell__V);
        ...
        const double var_x34 = exp(0.01310255922773 * var_chaste_interface__cell__V);
        ...
        const double var_x205 = mParameters[2] / (var_x26 * (1.5 + mParameters[2]) * pow((0.01 + 1 / var_x63), 2) * (1.0 + 0.1245 * exp(-0.00374358835078 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[3])) * exp(-var_x106)));
