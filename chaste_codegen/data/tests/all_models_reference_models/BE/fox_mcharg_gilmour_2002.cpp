...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut::Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut::~Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut()
    {
    }

    
    double Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[3], double rResidual[3])
    {
    ...
    void Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[3], double rJacobian[3][3])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -94.7
        ...
        const double var_x11 = var_x10 * mParameters[1] / (1.0 + 1.6499999999999999 * exp(0.050000000000000003 * var_chaste_interface__membrane__V));
        ...
        const double var_x30 = exp(0.074883406923417162 * var_chaste_interface__membrane__V);
        ...
        const double var_x41 = exp(-0.024337107250110578 * var_chaste_interface__membrane__V);
    ...
    void Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        CardiacNewtonSolver<3,Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<3,Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellfox_mcharg_gilmour_2002FromCellMLBackwardEulerNoLut)
