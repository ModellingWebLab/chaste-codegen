...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellbeeler_reuter_model_1977FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[1], double rJacobian[1][1])
    {
        ...
        rJacobian[0][0] = 1.0 - (mDt * (-070000000000000007 - 0001172583 * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f / var_chaste_interface__slow_inward_current__Cai));
    }
    ...
    void Cellbeeler_reuter_model_1977FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_slow_inward_current_d_gate__alpha_d = 095000000000000001 * exp(050000000000000003 - 01 * var_chaste_interface__membrane__V) / (1.0 + exp(0.35997120230381568 - 071994240460763137 * var_chaste_interface__membrane__V));
        const double var_slow_inward_current_d_gate__beta_d = 070000000000000007 * exp(-0.74576271186440679 - 016949152542372881 * var_chaste_interface__membrane__V) / (1.0 + exp(2.2000000000000002 + 050000000000000003 * var_chaste_interface__membrane__V));
        const double var_slow_inward_current_f_gate__alpha_f = 012 * exp(-0.224 - 0080000000000000002 * var_chaste_interface__membrane__V) / (1.0 + exp(4.197901049475262 + 0.14992503748125938 * var_chaste_interface__membrane__V));
        const double var_slow_inward_current_f_gate__beta_f = 0064999999999999997 * exp(-0.59999999999999998 - 02 * var_chaste_interface__membrane__V) / (1.0 + exp(-6.0 - 0.20000000000000001 * var_chaste_interface__membrane__V));
        const double var_sodium_current_h_gate__alpha_h = 0.126 * exp(-19.25 - 0.25 * var_chaste_interface__membrane__V);
        const double var_sodium_current_h_gate__beta_h = 1.7 / (1.0 + exp(-1.845 - 082000000000000003 * var_chaste_interface__membrane__V));
        const double var_sodium_current_j_gate__alpha_j = 055 * exp(-19.5 - 0.25 * var_chaste_interface__membrane__V) / (1.0 + exp(-15.600000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_sodium_current_m_gate__beta_m = 40 * exp(-4.032 - 056000000000000001 * var_chaste_interface__membrane__V);
        const double var_time_dependent_outward_current_x1_gate__alpha_x1 = 00050000000000000001 * exp(4.1322314049586781 + 082644628099173556 * var_chaste_interface__membrane__V) / (1.0 + exp(2.8571428571428572 + 057142857142857141 * var_chaste_interface__membrane__V));
        const double var_time_dependent_outward_current_x1_gate__beta_x1 = 0012999999999999999 * exp(-1.1997600479904018 - 059988002399520089 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.80000000000000004 - 040000000000000001 * var_chaste_interface__membrane__V));
