...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celliyer_model_2004FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[65], double rJacobian[65][65])
    {
        ...
        const double var_x74 = 00074179401705723523 * var_x59;
        ...
        const double var_x134 = 48600000000 * var_x133 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C1_RyR;
        const double var_x135 = 12150000000 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 4.0);
        const double var_x136 = 12150000 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 2.0) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR;
        const double var_x137 = 4050000 * var_x133;
        const double var_x138 = 091225454037165171 * exp(033046080388350003 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x139 = 0.21116826991639448 * exp(-043060541639799998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x140 = exp(026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        ...
        const double var_x143 = 00042769471831999382 * var_x142;
        const double var_x144 = exp(0056890885971700002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x145 = exp(-045366429595429997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x146 = exp(-026913854983990002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x147 = 1.6926962184371784e-6 * var_x142 * var_x145 * var_x146 / (var_x140 * var_x144);
        const double var_x148 = 0071483033566472664 * var_x146;
        const double var_x149 = 034388156021070745 * var_x145;
        ...
        const double var_x152 = 0070080662892900002 * exp(-0.14999754700285001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x153 = 00767254363063 * exp(08662945914655 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x154 = 0037973799836799999 * exp(-014256681268810001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x155 = exp(-23.156677820503301);
        const double var_x156 = 8513540195.0827656 * var_x155;
        const double var_x157 = exp(-19.657914992626967 + 011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x158 = 34054160780.331062 * var_x157;
        const double var_x159 = exp(-26.232056238852348 - 090161609404259865 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        ...
        const double var_x174 = 8513540195.0827656 * exp(-21.949261959797553 + 030147161449011892 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        ...
        const double var_x177 = 8513540195.0827656 * exp(-39.744904705650839 + 0027019947965296331 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x178 = 8513540195.0827656 * exp(-20.6726464954126 + 011394696340402199 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        ...
        const double var_x188 = 8513540195.0827656 * exp(-19.672905196314268 + 084272054104636354 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x189 = 8513540195.0827656 * exp(-27.092641999412571 - 061469636400174388 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x190 = 8513540195.0827656 * exp(-26.358496255772213 - 068762962366201316 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        ...
        rJacobian[38][36] = 0;
        rJacobian[38][37] = 0;
        rJacobian[38][38] = 1.0 - (mDt * (-00080000000000000004));
        ...
        rJacobian[39][38] = -(mDt * (00080000000000000004));
        ...
        rJacobian[49][49] = 1.0 - (mDt * (-039667206760709998 - var_x151));
