...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celliyer_model_2004FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[65], double rJacobian[65][65])
    {
        ...
        const double var_x143 = exp(6.9808923999999997e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x144 = 0.00042769471831999382 * var_x143;
        const double var_x145 = exp(0.026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x146 = 0.10945626585855089 * var_x145;
        ...
        const double var_x149 = exp(0.0056890885971700002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x150 = 1.6926962184371784e-6 * var_x143 * var_x147 * var_x148 / (var_x145 * var_x149);
        const double var_x151 = 0.0071483033566472664 * var_x148;
        const double var_x152 = 0.034388156021070745 * var_x147;
        const double var_x153 = 0.56744803744318484 * var_x149;
        ...
        const double var_x167 = 12158498408.695736 * var_x162;
        const double var_x168 = 23845170420.535503 * var_x160;
        ...
        const double var_x172 = 3099769910.3661275 * var_x164;
        const double var_x173 = 11922585210.267752 * var_x160;
        ...
        const double var_x190 = 8513540195.0827656 * exp(-19.672905196314268 + 0.084272054104636354 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x191 = 8513540195.0827656 * exp(-16.535928437145476 + 0.1097131992444229 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
