...
#include "CardiacNewtonSolver.hpp"
    ...
    Celliyer_model_2004FromCellMLBackwardEulerNoLut::Celliyer_model_2004FromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celliyer_model_2004FromCellMLBackwardEulerNoLut>::Instance();
        Init();
        
    }

    Celliyer_model_2004FromCellMLBackwardEulerNoLut::~Celliyer_model_2004FromCellMLBackwardEulerNoLut()
    {
    }

    
    double Celliyer_model_2004FromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Celliyer_model_2004FromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[65], double rResidual[65])
    {
    ...
    void Celliyer_model_2004FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[65], double rJacobian[65][65])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: mV; Initial value: -90.65755929
    ...
    void Celliyer_model_2004FromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Celliyer_model_2004FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        CardiacNewtonSolver<65,Celliyer_model_2004FromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<65,Celliyer_model_2004FromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> Celliyer_model_2004FromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Celliyer_model_2004FromCellMLBackwardEulerNoLut>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celliyer_model_2004FromCellMLBackwardEulerNoLut)
