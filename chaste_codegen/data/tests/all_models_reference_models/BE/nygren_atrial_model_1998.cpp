...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnygren_atrial_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[16], double rJacobian[16][16])
    {
        ...
        const double var_x7 = var_x1 * var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x8 = var_x2 / pow(var_x0, 3);
        ...
        const double var_x12 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_d, 4);
        const double var_x13 = 0.0030000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_d;
        const double var_x14 = pow(var_x13, (-4));
        const double var_x15 = 0.20380000000000001 * var_x12 * var_x14;
        ...
        const double var_x21 = 0.81520000000000004 * var_x14 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_d, 3);
        const double var_x22 = 0.81520000000000004 * var_x12 / pow(var_x13, 5);
        const double var_x23 = var_x17 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 3);
        const double var_x24 = 0.81520000000000004 * var_x23;
        const double var_x25 = var_x18 / pow(var_x16, 5);
        ...
        const double var_x28 = pow(var_chaste_interface__cleft_space_ion_concentrations__Na_c, 3);
        const double var_x29 = var_x28 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x30 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3);
        const double var_x31 = var_x30 * var_chaste_interface__cleft_space_ion_concentrations__Ca_c;
        const double var_x32 = 1.0 + 0.00029999999999999997 * var_x29 + 0.00029999999999999997 * var_x31;
        const double var_x33 = 1 / var_x32;
        const double var_x34 = 4.8547611805137808e-7 * var_x33;
        const double var_x35 = exp(0.017058350483361479 * var_chaste_interface__membrane__V);
        const double var_x36 = var_x30 * var_x35;
        const double var_x37 = exp(-0.020849095035219586 * var_chaste_interface__membrane__V);
        const double var_x38 = (var_x31 * var_x35 - var_x29 * var_x37) / pow(var_x32, 2);
        const double var_x39 = 1.4564283541541343e-10 * var_x38;
        const double var_x40 = 1.4564283541541343e-6 * var_x33;
        ...
        const double var_x43 = 4.3692850624624026e-10 * var_x38;
        ...
        const double var_x52 = var_x28 * var_x37;
        ...
        const double var_x57 = var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s;
        const double var_x58 = 0.0025624557123127439 * var_x57;
        const double var_x59 = var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus;
        const double var_x60 = 0.00093956709451467277 * var_x59;
        const double var_x61 = var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a / (1.0 + exp(2.2916666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V));
        const double var_x62 = 0.00017083038082084959 * var_x61;
        const double var_x63 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x64 = log(var_x63 * var_chaste_interface__cleft_space_ion_concentrations__K_c);
        const double var_x65 = exp(0.20470020580033774 + 0.056861168277871597 * var_chaste_interface__membrane__V - 1.5 * var_x64);
        const double var_x66 = 1.0 + var_x65;
        const double var_x67 = 1 / var_x66;
        const double var_x68 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, (-0.55430000000000001));
        const double var_x69 = var_x67 * var_x68;
        const double var_x70 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5);
        const double var_x71 = 1 / (36.4828726939094 + var_x70);
        const double var_x72 = 1.0 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x73 = 1 / (200.0 + var_chaste_interface__membrane__V);
        const double var_x74 = 150.0 + var_chaste_interface__membrane__V;
        const double var_x75 = var_x73 * var_x74 / var_x72;
        const double var_x76 = var_x71 * var_x75;
        const double var_x77 = var_x70 * var_x76;
        const double var_x78 = var_x70 * var_x71 * var_x73 * var_x74 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow(var_x72, 2);
        const double var_x79 = -26.380041870925616 * var_x64 + var_chaste_interface__membrane__V;
        const double var_x80 = var_x69 * var_x79;
        const double var_x81 = var_x65 * var_x79 / pow(var_x66, 2);
        const double var_x82 = var_x68 * var_x81;
        const double var_x83 = var_x63 * pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 0.44569999999999999);
        const double var_x84 = var_x67 * var_x83;
        const double var_x85 = var_x81 * var_x83;
        const double var_x86 = var_x76 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 0.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x87 = var_x75 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0) * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow((1 + 0.027410122234342148 * var_x70), 2);
        const double var_x88 = 4.3692850624624026e-10 * var_x38;
        const double var_x89 = 1 / var_chaste_interface__cleft_space_ion_concentrations__Na_c;
        const double var_x90 = 4.369285062462403e-6 * var_x33;
        const double var_x91 = 0.037907445518581065 * var_chaste_interface__membrane__V;
        const double var_x92 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x93 = var_x92 * var_chaste_interface__cleft_space_ion_concentrations__Na_c;
        const double var_x94 = exp(var_x91 - 1.0 * log(var_x93));
        const double var_x95 = pow(var_chaste_interface__sodium_current_m_gate__m, 3) * (0.10000000000000001 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.90000000000000002 * var_chaste_interface__sodium_current_h1_gate__h1) * var_chaste_interface__membrane__V / (-1.0 + exp(var_x91));
        const double var_x96 = 7.5793668809895348e-5 * var_x95;
        const double var_x97 = var_x94 * var_x96;
        const double var_x98 = -1.0 + var_x94;
        const double var_x99 = 1.3107855187387207e-9 * var_x38;
        ...
        const double var_x103 = 6.6024752054987431e-8 * var_x33;
        const double var_x104 = 1.9807425616496228e-11 * var_x38;
        const double var_x105 = 1.9807425616496229e-7 * var_x33;
        const double var_x106 = 5.9422276849488674e-11 * var_x38;
        ...
        const double var_x109 = 0.00034849397687453321 * var_x57;
        const double var_x110 = 0.00012778112485399551 * var_x59;
        const double var_x111 = 2.3232931791635546e-5 * var_x61;
        const double var_x112 = 1.9807425616496229e-7 * var_x33;
        const double var_x113 = 5.942227684948868e-7 * var_x33;
        const double var_x114 = 1.0307938958145768e-5 * var_x95;
        const double var_x115 = var_x114 * var_x94;
        const double var_x116 = 1.7826683054846605e-10 * var_x38;
        ...
        rJacobian[0][2] = 0.0;
        rJacobian[0][3] = -(mDt * (var_x6 * var_x8 - var_x6 * var_x7));
        ...
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = 0.0;
        rJacobian[2][12] = -(mDt * ((var_x22 - var_x21) * var_chaste_interface__Ca_handling_by_the_SR__F1));
        rJacobian[2][13] = -(mDt * ((var_x26 - var_x24) * var_chaste_interface__Ca_handling_by_the_SR__F1));
        rJacobian[2][14] = 0.0;
        rJacobian[2][15] = 0.0;
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = 0.0;
        ...
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = 0.0;
        rJacobian[3][12] = -(mDt * ((var_x21 - var_x22) * var_chaste_interface__Ca_handling_by_the_SR__F1));
        rJacobian[3][13] = -(mDt * ((var_x24 - var_x26) * var_chaste_interface__Ca_handling_by_the_SR__F1 + (1.3584000000000001 * var_x25 - 1.3584000000000001 * var_x23) * var_chaste_interface__Ca_handling_by_the_SR__F2));
        rJacobian[3][14] = 0.0;
        rJacobian[3][15] = 0.0;
        ...
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (-4.048582995951417e-5 - 6.7205525966826332e-6 * var_x27 + var_x30 * var_x39 - var_x34 * var_x36));
        rJacobian[5][6] = 0.0;
        ...
        rJacobian[5][13] = -(mDt * (2.5902973415539245e-5 * var_x50 + 6.7205525966826332e-6 * var_x48 - 2.5902973415539245e-5 * var_x51 + var_x28 * var_x39 + var_x34 * var_x52));
        rJacobian[5][14] = 0.0;
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.0001 + 1.7317432876958762e-5 * var_x80 + 0.0018345858630475916 * var_x78 + 5.8281690184963299e-5 * var_x82 - 0.0010249822849250976 * var_x69 - 0.0018345858630475916 * var_x77 - var_x55 * var_x56 - var_x55 * var_x58 - var_x55 * var_x60 - var_x55 * var_x62));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[6][12] = 0.0;
        rJacobian[6][13] = 0.0;
        rJacobian[6][14] = -(mDt * (0.0010249822849250976 * var_x84 - 5.8281690184963299e-5 * var_x85 + var_x56 * var_x63 + var_x58 * var_x63 + var_x60 * var_x63 + var_x62 * var_x63));
        rJacobian[6][15] = -(mDt * (2.067527268648676e-6 * var_x87 - 0.0027518787945713876 * var_x86));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = -(mDt * (var_x36 * var_x40 - var_x30 * var_x88));
        rJacobian[7][6] = -(mDt * (0.0027518787945713876 * var_x77 - 0.0027518787945713876 * var_x78));
        rJacobian[7][7] = 1.0 - (mDt * (-6.993006993006993e-5 - var_x97 - 2.0704300494725328e-5 * var_x89 + var_x96 * var_x98 - var_x41 * var_x99 - var_x42 * var_x90));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[7][12] = 0.0;
        rJacobian[7][13] = -(mDt * (-var_x28 * var_x88 - var_x40 * var_x52));
        rJacobian[7][14] = 0.0;
        rJacobian[7][15] = -(mDt * (0.0041278181918570815 * var_x86 + 2.0704300494725328e-5 * var_x92 - 3.1012909029730135e-6 * var_x87 + var_x54 * var_x90 + var_x93 * var_x97 - var_x53 * var_x99));
        rJacobian[8][0] = 0.0;
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = 0.0;
        ...
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = -(mDt * (var_x102 * var_x7 - var_x102 * var_x8));
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = -(mDt * (9.1399515314883825e-7 * var_x27 + var_x103 * var_x36 - var_x104 * var_x30));
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = -(mDt * (-var_x105 * var_x42 - var_x106 * var_x41));
        ...
        rJacobian[14][4] = 0.0;
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = -(mDt * (0.00013939759074981328 * var_x69 + 0.00024950367737447247 * var_x77 - 7.9263098651550091e-6 * var_x82 - 2.3551708712663917e-6 * var_x80 - 0.00024950367737447247 * var_x78 + var_x108 * var_x55 + var_x109 * var_x55 + var_x110 * var_x55 + var_x111 * var_x55));
        rJacobian[14][7] = 0.0;
        rJacobian[14][8] = 0.0;
        rJacobian[14][9] = 0.0;
        rJacobian[14][10] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (7.9263098651550091e-6 * var_x85 - 0.00013939759074981328 * var_x84 - var_x108 * var_x63 - var_x109 * var_x63 - var_x110 * var_x63 - var_x111 * var_x63));
        rJacobian[14][15] = -(mDt * (0.00037425551606170871 * var_x86 - 2.8118370853621991e-7 * var_x87));
        rJacobian[15][0] = 0.0;
        rJacobian[15][1] = 0.0;
        rJacobian[15][2] = 0.0;
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = 0.0;
        rJacobian[15][5] = -(mDt * (var_x106 * var_x30 - var_x112 * var_x36));
        rJacobian[15][6] = -(mDt * (0.00037425551606170871 * var_x78 - 0.00037425551606170871 * var_x77));
        rJacobian[15][7] = -(mDt * (var_x115 + 2.8157848672826448e-6 * var_x89 + var_x113 * var_x42 + var_x116 * var_x41 - var_x114 * var_x98));
        rJacobian[15][8] = 0.0;
        rJacobian[15][9] = 0.0;
        rJacobian[15][10] = 0.0;
        rJacobian[15][11] = 0.0;
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = -(mDt * (var_x106 * var_x28 + var_x112 * var_x52));
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (4.2177556280432989e-7 * var_x87 - 0.00056138327409256303 * var_x86 - 2.8157848672826448e-6 * var_x92 + var_x116 * var_x53 - var_x113 * var_x54 - var_x115 * var_x93));
    }
