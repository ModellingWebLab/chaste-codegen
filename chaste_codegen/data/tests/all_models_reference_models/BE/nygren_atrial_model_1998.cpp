...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnygren_atrial_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[16], double rJacobian[16][16])
    {
        ...
        const double var_x55 = log(10);
        const double var_x56 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x57 = var_x55 * log10(var_x56 * var_chaste_interface__cleft_space_ion_concentrations__K_c);
        const double var_x58 = exp(0.20470020580033774 + 0.056861168277871597 * var_chaste_interface__membrane__V - 1.5 * var_x57);
        const double var_x59 = 1.0 + var_x58;
        const double var_x60 = 1 / var_x59;
        const double var_x61 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, (-0.55430000000000001));
        const double var_x62 = var_x60 * var_x61;
        const double var_x63 = 1 / var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x64 = 0.00034166076164169918 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x65 = -26.380041870925616 * var_x57 + var_chaste_interface__membrane__V;
        const double var_x66 = var_x62 * var_x65;
        const double var_x67 = var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s;
        const double var_x68 = 0.0025624557123127439 * var_x67;
        const double var_x69 = var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a / (1.0 + exp(2.2916666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V));
        const double var_x70 = 0.00017083038082084959 * var_x69;
        const double var_x71 = var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus;
        const double var_x72 = 0.00093956709451467277 * var_x71;
        const double var_x73 = var_x58 * var_x65 / pow(var_x59, 2);
        const double var_x74 = var_x61 * var_x73;
        const double var_x75 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5);
        const double var_x76 = 1 / (36.4828726939094 + var_x75);
        const double var_x77 = 1.0 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x78 = 1 / (200.0 + var_chaste_interface__membrane__V);
        const double var_x79 = 150.0 + var_chaste_interface__membrane__V;
        const double var_x80 = var_x78 * var_x79 / var_x77;
        const double var_x81 = var_x76 * var_x80;
        const double var_x82 = var_x75 * var_x81;
        const double var_x83 = var_x75 * var_x76 * var_x78 * var_x79 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow(var_x77, 2);
        const double var_x84 = var_x56 * pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 0.44569999999999999);
        const double var_x85 = var_x60 * var_x84;
        const double var_x86 = var_x73 * var_x84;
        const double var_x87 = var_x80 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0) * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow((1 + 0.027410122234342148 * var_x75), 2);
        const double var_x88 = var_x81 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 0.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x89 = 4.3692850624624026e-10 * var_x35;
        const double var_x90 = 1 / var_chaste_interface__cleft_space_ion_concentrations__Na_c;
        const double var_x91 = 4.369285062462403e-6 * var_x37;
        const double var_x92 = 1.3107855187387207e-9 * var_x35;
        const double var_x93 = 0.037907445518581065 * var_chaste_interface__membrane__V;
        ...
        const double var_x96 = exp(var_x93 - 1.0 * var_x55 * log10(var_x95));
        const double var_x97 = -1.0 + var_x96;
        const double var_x98 = pow(var_chaste_interface__sodium_current_m_gate__m, 3) * (0.10000000000000001 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.90000000000000002 * var_chaste_interface__sodium_current_h1_gate__h1) * var_chaste_interface__membrane__V / (-1.0 + exp(var_x93));
        const double var_x99 = 7.5793668809895348e-5 * var_x98;
        const double var_x100 = var_x96 * var_x99;
        const double var_x101 = -200.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x102 = 0.17614021922566686 * var_x3;
        const double var_x103 = 0.35228043845133372 * var_x5;
        const double var_x104 = 6.6024752054987431e-8 * var_x37;
        const double var_x105 = 1.9807425616496225e-11 * var_x35;
        const double var_x106 = 5.9422276849488674e-11 * var_x35;
        const double var_x107 = 1.9807425616496227e-7 * var_x37;
        const double var_x108 = 32.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x109 = 4.6465863583271093e-5 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x110 = 0.00034849397687453315 * var_x67;
        const double var_x111 = 0.00012778112485399551 * var_x71;
        const double var_x112 = 2.3232931791635546e-5 * var_x69;
        const double var_x113 = 5.942227684948868e-7 * var_x37;
        const double var_x114 = 1.7826683054846602e-10 * var_x35;
        const double var_x115 = 1.0307938958145768e-5 * var_x98;
        const double var_x116 = var_x115 * var_x96;
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.0001 + 1.7317432876958762e-5 * var_x66 + 0.0018345858630475916 * var_x83 + 5.8281690184963299e-5 * var_x74 - 0.0010249822849250974 * var_x62 - 0.0018345858630475916 * var_x82 - var_x63 * var_x64 - var_x63 * var_x68 - var_x63 * var_x70 - var_x63 * var_x72));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[6][12] = 0.0;
        rJacobian[6][13] = 0.0;
        rJacobian[6][14] = -(mDt * (0.0010249822849250974 * var_x85 - 5.8281690184963299e-5 * var_x86 + var_x56 * var_x64 + var_x56 * var_x68 + var_x56 * var_x70 + var_x56 * var_x72));
        rJacobian[6][15] = -(mDt * (2.0675272686486755e-6 * var_x87 - 0.0027518787945713876 * var_x88));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = -(mDt * (var_x39 * var_x42 - var_x28 * var_x89));
        rJacobian[7][6] = -(mDt * (0.0027518787945713876 * var_x82 - 0.0027518787945713876 * var_x83));
        rJacobian[7][7] = 1.0 - (mDt * (-6.993006993006993e-5 - var_x100 - 2.0704300494725328e-5 * var_x90 + var_x97 * var_x99 - var_x40 * var_x92 - var_x43 * var_x91));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[7][12] = 0.0;
        rJacobian[7][13] = -(mDt * (-var_x29 * var_x89 - var_x42 * var_x52));
        rJacobian[7][14] = 0.0;
        rJacobian[7][15] = -(mDt * (0.0041278181918570807 * var_x88 + 2.0704300494725328e-5 * var_x94 - 3.1012909029730135e-6 * var_x87 + var_x100 * var_x95 + var_x54 * var_x91 - var_x53 * var_x92));
        rJacobian[8][0] = 0.0;
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = 0.0;
        ...
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (-0.47599999999999998 + var_x101));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        ...
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-0.0066 + var_x101));
        rJacobian[10][11] = -(mDt * (var_x101));
        rJacobian[10][12] = 0.0;
        ...
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[13][0] = -(mDt * (var_x102));
        rJacobian[13][1] = -(mDt * (0.00078910818213098765 * var_x10 + 1.7754934097947219e-10 * var_x11));
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = -(mDt * (var_x103 * var_x8 - var_x103 * var_x7));
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = -(mDt * (9.1399515314883814e-7 * var_x27 + var_x104 * var_x39 - var_x105 * var_x28));
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = -(mDt * (-var_x106 * var_x40 - var_x107 * var_x43));
        ...
        rJacobian[13][10] = -(mDt * (0.0010559999999999999 + var_x108));
        rJacobian[13][11] = -(mDt * (var_x108));
        rJacobian[13][12] = -(mDt * (0.002));
        rJacobian[13][13] = 1.0 - (mDt * (-47.274000000000001 - var_x102 + 6.2720000000000002 * var_chaste_interface__intracellular_Ca_buffering__O_TC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 7.3978892074780085e-7 * var_x11 + 3.5228043845133373e-6 * var_x51 + 9.0 * var_chaste_interface__intracellular_Ca_buffering__O_C - 3.5228043845133373e-6 * var_x50 - 8.2198768971977874 * var_x10 - 9.1399515314883814e-7 * var_x48 - var_x104 * var_x52 - var_x105 * var_x29));
        rJacobian[13][14] = 0.0;
        rJacobian[13][15] = -(mDt * (var_x107 * var_x54 - var_x106 * var_x53));
        rJacobian[14][0] = 0.0;
        rJacobian[14][1] = 0.0;
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = 0.0;
        rJacobian[14][4] = 0.0;
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = -(mDt * (0.00024950367737447247 * var_x82 + 0.00013939759074981328 * var_x62 - 7.9263098651550091e-6 * var_x74 - 0.00024950367737447247 * var_x83 - 2.3551708712663917e-6 * var_x66 + var_x109 * var_x63 + var_x110 * var_x63 + var_x111 * var_x63 + var_x112 * var_x63));
        rJacobian[14][7] = 0.0;
        rJacobian[14][8] = 0.0;
        rJacobian[14][9] = 0.0;
        rJacobian[14][10] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (7.9263098651550091e-6 * var_x86 - 0.00013939759074981328 * var_x85 - var_x109 * var_x56 - var_x110 * var_x56 - var_x111 * var_x56 - var_x112 * var_x56));
        rJacobian[14][15] = -(mDt * (0.00037425551606170871 * var_x88 - 2.8118370853621991e-7 * var_x87));
        rJacobian[15][0] = 0.0;
        rJacobian[15][1] = 0.0;
        rJacobian[15][2] = 0.0;
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = 0.0;
        rJacobian[15][5] = -(mDt * (var_x106 * var_x28 - var_x107 * var_x39));
        rJacobian[15][6] = -(mDt * (0.00037425551606170871 * var_x83 - 0.00037425551606170871 * var_x82));
        rJacobian[15][7] = -(mDt * (var_x116 + 2.8157848672826448e-6 * var_x90 + var_x113 * var_x43 + var_x114 * var_x40 - var_x115 * var_x97));
        rJacobian[15][8] = 0.0;
        rJacobian[15][9] = 0.0;
        rJacobian[15][10] = 0.0;
        rJacobian[15][11] = 0.0;
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = -(mDt * (var_x106 * var_x29 + var_x107 * var_x52));
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (4.2177556280432989e-7 * var_x87 - 0.00056138327409256303 * var_x88 - 2.8157848672826448e-6 * var_x94 + var_x114 * var_x53 - var_x113 * var_x54 - var_x116 * var_x95));
    }
