...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellwinslow_model_1999FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[25], double rJacobian[25][25])
    {
        ...
        const double var_x4 = exp(-0.15384615384615385 - 076923076923076927 * var_chaste_interface__membrane__V);
        ...
        const double var_x25 = 025000000000000001 * var_x4;
        const double var_x26 = 2.3999999999999999 * var_x0;
        const double var_x27 = 074999999999999997 * var_x4;
        const double var_x28 = 12150000000 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 4.0);
        const double var_x29 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 3.0);
        const double var_x30 = 48600000000 * var_x29 * var_chaste_interface__RyR_channel__P_C1;
        const double var_x31 = 4050000 * var_x29;
        const double var_x32 = 12150000 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 2.0) * var_chaste_interface__RyR_channel__P_O1;
        const double var_x33 = -80 * exp(-090909090909090912 * var_chaste_interface__membrane__V);
        const double var_x34 = var_chaste_interface__membrane__V >= -90;
        ...
        const double var_x39 = 001 * var_x38;
        const double var_x40 = var_x39 * (1800 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 1800 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR);
        const double var_x41 = 1800 * var_chaste_interface__RyR_channel__P_O1;
        const double var_x42 = 1800 * var_chaste_interface__RyR_channel__P_O2;
        ...
        const double var_x47 = 2752.4498037978587 * var_x44 - 096656534954407292 * var_x45;
        ...
        const double var_x52 = 0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x53 = 1.0 + 00011900000000000002 / pow(var_x52, 2);
        const double var_x54 = 1 / var_x53;
        const double var_x55 = exp(074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x56 = (-0.68200000000000005 + 001 * var_x55) * var_chaste_interface__L_type_Ca_current_y_gate__y * var_chaste_interface__membrane__V / (-1.0 + var_x55);
        const double var_x57 = -2.9908119021922683 * var_x54 * var_x56;
        const double var_x58 = 001 * var_x54;
        const double var_x59 = var_x58 * (240000 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR - 240000 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss);
        const double var_x60 = 240000 * var_chaste_interface__RyR_channel__P_O1;
        const double var_x61 = 240000 * var_chaste_interface__RyR_channel__P_O2;
        const double var_x62 = 2800000000000005 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        const double var_x63 = 0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Cai;
        const double var_x64 = 1.0 + 00011900000000000002 / pow(var_x63, 2);
        ...
        const double var_x68 = 0015381954438488301 / var_x67;
        const double var_x69 = 1 / var_chaste_interface__intracellular_ion_concentrations__Cai;
        const double var_x70 = exp(-024332029034784559 * var_chaste_interface__membrane__V);
        const double var_x71 = 1 / (1.0 + 0.20000000000000001 * var_x70);
        const double var_x72 = exp(013101861787960915 * var_chaste_interface__membrane__V);
        ...
        rJacobian[5][3] = 0;
        rJacobian[5][4] = 0;
        rJacobian[5][5] = 1.0 - (mDt * (-01 - var_x24));
        ...
        rJacobian[6][6] = 1.0 - (mDt * (-0050000000000000001 - var_x25 - var_x26));
        ...
        rJacobian[7][7] = 1.0 - (mDt * (-0025000000000000001 + var_x2 + var_x7));
        ...
        rJacobian[8][8] = 1.0 - (mDt * (-00125 + var_x14 - var_x27));
        ...
        rJacobian[9][9] = 1.0 - (mDt * (-0076249999999999998 + var_x12));
        rJacobian[9][10] = 0;
        ...
        rJacobian[11][7] = 0;
        rJacobian[11][8] = 0;
        rJacobian[11][9] = -(mDt * (0070000000000000001));
        rJacobian[11][10] = 0;
        ...
        rJacobian[13][11] = 0;
        rJacobian[13][12] = 0;
        rJacobian[13][13] = 1.0 - (mDt * (-00080000000000000004));
        ...
        rJacobian[14][13] = -(mDt * (00080000000000000004));
        ...
        rJacobian[16][14] = 0;
        rJacobian[16][15] = 0;
        rJacobian[16][16] = 1.0 - (mDt * (001 * (((var_x34) && (fabs(var_x35) < 1.0000000000000001e-5)) ? (var_x33 - 1000 / (-0.13565000000000002 - 0050000000000000001 * var_chaste_interface__membrane__V)) : ((var_x34) ? (var_x33 - 320 * var_x35 / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V))) : (0)))));
        rJacobian[16][17] = 0;
        rJacobian[16][18] = 0;
        rJacobian[16][19] = 0;
        rJacobian[16][20] = 0;
        ...
        rJacobian[17][15] = 0;
        rJacobian[17][16] = 0;
        rJacobian[17][17] = 1.0 - (mDt * (-6.6000000000000005e-5 - 20 * var_chaste_interface__intracellular_ion_concentrations__Cai));
        rJacobian[17][18] = 0;
        rJacobian[17][19] = 0;
        rJacobian[17][20] = 0;
        rJacobian[17][21] = 0;
        rJacobian[17][22] = -(mDt * (20 - 20 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa));
        rJacobian[17][23] = 0;
        rJacobian[17][24] = 0;
        rJacobian[18][0] = 0;
        rJacobian[18][1] = 0;
        ...
        rJacobian[18][16] = 0;
        rJacobian[18][17] = 0;
        rJacobian[18][18] = 1.0 - (mDt * (-040000000000000001 - 40 * var_chaste_interface__intracellular_ion_concentrations__Cai));
        rJacobian[18][19] = 0;
        rJacobian[18][20] = 0;
        rJacobian[18][21] = 0;
        rJacobian[18][22] = -(mDt * (40 - 40 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa));
        rJacobian[18][23] = 0;
        rJacobian[18][24] = 0;
        rJacobian[19][0] = 0;
        rJacobian[19][1] = 0;
        ...
        rJacobian[19][17] = 0;
        rJacobian[19][18] = 0;
        rJacobian[19][19] = 1.0 - (mDt * (var_x39 * (-1740382808421784 - var_x41 - var_x42) + 00016666666666666666 * (1740382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800 * var_x43 - 1740382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / (pow(var_x36, 3) * pow((083333333333333329 + var_x37), 2))));
        ...
        rJacobian[20][20] = 1.0 - (mDt * (-0.13257434520702313 - 0011893356491532786 * var_x46 - 3.2630189260961817e-12 * var_x48));
        rJacobian[20][21] = 0;
        ...
        rJacobian[22][15] = 0;
        rJacobian[22][16] = 0;
        rJacobian[22][17] = -(mDt * (var_x66 * (0092400000000000017 + var_x62)));
        rJacobian[22][18] = -(mDt * (var_x66 * (2.8000000000000003 + var_x62)));
        rJacobian[22][19] = 0;
        rJacobian[22][20] = -(mDt * (var_x66 * (096656534954407292 * var_x46 + 2.651834266564234e-10 * var_x48)));
        rJacobian[22][21] = -(mDt * (037453183520599252 * var_x65));
        rJacobian[22][22] = 1.0 - (mDt * (var_x66 * (-5637.4531835205999 - var_x68 + 3.5444788081288787e-5 * var_x51 + 2800000000000005 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 2800000000000005 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa - 00015787156411954756 * var_x69 - 3302.9397645574304 * var_x50 + 0015381954438488301 * var_chaste_interface__intracellular_ion_concentrations__Cai / pow(var_x67, 2) - 21.758727097510118 * var_x70 * var_x71) + 2.3800000000000004e-7 * (2.8000000000000003 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss + 0092400000000000017 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 00015787156411954756 * log(2.0 * var_x69) - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Cai - 1.181949379053441e-5 * var_chaste_interface__membrane__V - var_x62 * (1.0 - var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa) - var_x62 * (1.0 - var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa) - var_x68 * var_chaste_interface__intracellular_ion_concentrations__Cai + 8.279349689624225e-6 * var_x71 * (2.0 * var_x72 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 3) - 2628072.0 * var_x70 * var_chaste_interface__intracellular_ion_concentrations__Cai) - 1.0 * var_x46 * var_x47) / (pow(var_x63, 3) * pow(var_x64, 2))));
        rJacobian[22][23] = 0;
    ...
    void Cellwinslow_model_1999FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_L_type_Ca_current_y_gate__tau_y = 02 + 0.59999999999999998 / (1.0 + exp(2.1052631578947367 + 0.10526315789473684 * var_chaste_interface__membrane__V));
        ...
        const double var_rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__K21 = exp(-7.6769999999999996 - 012800000000000001 * var_chaste_interface__membrane__V);
        ...
        const double var_rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__tau_X_kr = 001 / (var_rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__K12 + var_rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__K21) + 027 * var_rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__tau_factor;
        const double var_slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks_infinity = 1.0 / (1.0 + exp(1.8161764705882353 - 073529411764705885 * var_chaste_interface__membrane__V));
        ...
        const double var_transient_outward_potassium_current_X_to1_gate__alpha_X_to1 = 45.159999999999997 * exp(035770000000000003 * var_chaste_interface__membrane__V);
        const double var_transient_outward_potassium_current_X_to1_gate__beta_X_to1 = 98.900000000000006 * exp(-062370000000000002 * var_chaste_interface__membrane__V);
        const double var_transient_outward_potassium_current_Y_to1_gate__alpha_Y_to1 = 5.415 * exp(-6.7000000000000002 - 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + 051334999999999999 * exp(-6.7000000000000002 - 0.20000000000000001 * var_chaste_interface__membrane__V));
        const double var_transient_outward_potassium_current_Y_to1_gate__beta_Y_to1 = 5.415 * exp(6.7000000000000002 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + 051334999999999999 * exp(6.7000000000000002 + 0.20000000000000001 * var_chaste_interface__membrane__V));
        
        
        rY[20] = (var_chaste_interface__L_type_Ca_current_y_gate__y + ((001 * var_L_type_Ca_current_y_gate__y_infinity / var_L_type_Ca_current_y_gate__tau_y) * mDt)) / (1.0 - ((-001 / var_L_type_Ca_current_y_gate__tau_y) * mDt));
        rY[2] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((001 * var_fast_sodium_current_h_gate__alpha_h) * mDt)) / (1.0 - ((-001 * var_fast_sodium_current_h_gate__alpha_h - 001 * var_fast_sodium_current_h_gate__beta_h) * mDt));
        rY[3] = (var_chaste_interface__fast_sodium_current_j_gate__j + ((001 * var_fast_sodium_current_j_gate__alpha_j) * mDt)) / (1.0 - ((-001 * var_fast_sodium_current_j_gate__alpha_j - 001 * var_fast_sodium_current_j_gate__beta_j) * mDt));
        rY[4] = (var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr + ((001 * var_rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr_inf / var_rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__tau_X_kr) * mDt)) / (1.0 - ((-001 / var_rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__tau_X_kr) * mDt));
        rY[5] = (var_chaste_interface__slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks + ((001 * var_slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks_infinity / var_slow_activating_delayed_rectifiyer_K_current_X_ks_gate__tau_X_ks) * mDt)) / (1.0 - ((-001 / var_slow_activating_delayed_rectifiyer_K_current_X_ks_gate__tau_X_ks) * mDt));
        rY[6] = (var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1 + ((001 * var_transient_outward_potassium_current_X_to1_gate__alpha_X_to1) * mDt)) / (1.0 - ((-001 * var_transient_outward_potassium_current_X_to1_gate__alpha_X_to1 - 001 * var_transient_outward_potassium_current_X_to1_gate__beta_X_to1) * mDt));
        rY[7] = (var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1 + ((001 * var_transient_outward_potassium_current_Y_to1_gate__alpha_Y_to1) * mDt)) / (1.0 - ((-001 * var_transient_outward_potassium_current_Y_to1_gate__alpha_Y_to1 - 001 * var_transient_outward_potassium_current_Y_to1_gate__beta_Y_to1) * mDt));
