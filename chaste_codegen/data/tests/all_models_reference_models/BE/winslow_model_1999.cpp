...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellwinslow_model_1999FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[25], double rJacobian[25][25])
    {
        ...
        const double var_x34 = -0.00032000000000920181 / (1.0 - exp(-1.0000000000287557e-7));
        ...
        const double var_x61 = exp(0.074867781645490947 * var_chaste_interface__membrane__V);
        ...
        const double var_x79 = exp(-0.024332029034784559 * var_chaste_interface__membrane__V);
        ...
        const double var_x84 = mParameters[3] * exp(0.013101861787960915 * var_chaste_interface__membrane__V);
        ...
        const double var_x107 = var_x105 * var_x106 * mParameters[4] / ((1.5 + mParameters[4]) * pow((0.031622776601683791 + var_x106), 2) * (1.0 + 0.1245 * exp(-0.0037433890822745476 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[5])) * exp(-var_x94)));
        ...
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (0.001 * (((var_chaste_interface__membrane__V > -47.130001) && (var_chaste_interface__membrane__V < -47.129999000000005)) ? (var_x33 + var_x34 + 499999.99998562218 * (47.129999000000005 + var_chaste_interface__membrane__V) * (var_x34 - 0.00032000000000920181 / (1.0 - exp(1.0000000000287557e-7)))) : ((var_chaste_interface__membrane__V >= -90.0) ? (var_x33 - 320.0 * (47.130000000000003 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V))) : (0)))));
        rJacobian[16][17] = 0.0;
        rJacobian[16][18] = 0.0;
        rJacobian[16][19] = 0.0;
        rJacobian[16][20] = 0.0;
