...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellwinslow_model_1999FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[25], double rJacobian[25][25])
    {
        ...
        const double var_x0 = 0.10375000000000001 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x1 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        ...
        const double var_x7 = 0.20750000000000002 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x8 = -var_x5;
        const double var_x9 = 1.2 * var_x1;
        ...
        const double var_x12 = 0.41500000000000004 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x13 = -var_x10;
        const double var_x14 = 0.80000000000000004 * var_x1;
        ...
        const double var_x18 = 0.83000000000000007 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x19 = 0.40000000000000002 * var_x1;
        ...
        const double var_x24 = 3.2000000000000002 * var_x1;
        const double var_x25 = 0.025000000000000001 * var_x4;
        const double var_x26 = 2.3999999999999999 * var_x1;
        ...
        const double var_x44 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_NSR, 1.0);
        const double var_x45 = pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 1.2);
        const double var_x46 = 1 / (1.0 + 33855.471141425078 * var_x45 + 0.303951367781155 * var_x44);
        const double var_x47 = 2752.4498037978587 * var_x45 - 0.096656534954407292 * var_x44;
        const double var_x48 = var_x47 / pow((2.9537323401073989e-5 + var_x45 + 8.9779098483507565e-6 * var_x44), 2);
        ...
        const double var_x67 = 1 / var_chaste_interface__intracellular_ion_concentrations__Cai;
        const double var_x68 = 5.0000000000000002e-5 + var_chaste_interface__intracellular_ion_concentrations__Cai;
        const double var_x69 = 0.0015381954438488301 / var_x68;
        ...
        rJacobian[1][24] = 0.0;
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = -(mDt * (var_x9));
        rJacobian[2][2] = 1.0 - (mDt * (var_x13 + var_x15 - var_x12));
        ...
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = -(mDt * (var_x12));
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = -(mDt * (var_x26));
        rJacobian[7][7] = 1.0 - (mDt * (-0.0025000000000000001 + var_x3 + var_x8));
        ...
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = -(mDt * (var_x18));
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = -(mDt * (var_x2));
        rJacobian[8][8] = 1.0 - (mDt * (-0.00125 + var_x15 - var_x27));
        ...
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = -(mDt * (var_x14));
        rJacobian[9][9] = 1.0 - (mDt * (-0.0076249999999999998 + var_x13));
        rJacobian[9][10] = 0.0;
        ...
        rJacobian[22][22] = 1.0 - (mDt * (var_x66 * (-5637.4531835205999 - var_x69 + 3.5444788081288787e-5 * var_x51 + 2800.0000000000005 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 2800.0000000000005 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa - 0.00015787156411954756 * var_x67 - 3302.9397645574304 * var_x50 + 0.0015381954438488301 * var_chaste_interface__intracellular_ion_concentrations__Cai / pow(var_x68, 2) - 21.758727097510118 * var_x70 * var_x71) + 2.3800000000000004e-7 * (2.8000000000000003 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss + 0.0092400000000000017 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 0.00015787156411954756 * log(2.0 * var_x67) - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Cai - 1.181949379053441e-5 * var_chaste_interface__membrane__V - var_x62 * (1.0 - var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa) - var_x62 * (1.0 - var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa) - var_x69 * var_chaste_interface__intracellular_ion_concentrations__Cai + 8.279349689624225e-6 * var_x71 * (2.0 * var_x72 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 3) - 2628072.0 * var_x70 * var_chaste_interface__intracellular_ion_concentrations__Cai) - 1.0 * var_x46 * var_x47) / (pow(var_x63, 3) * pow(var_x64, 2))));
        rJacobian[22][23] = 0.0;
