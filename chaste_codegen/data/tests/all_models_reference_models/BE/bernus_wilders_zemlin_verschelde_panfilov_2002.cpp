...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEulerNoLut::Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEulerNoLut::~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEulerNoLut()
    {
    }

    
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        ...
        const double var_transient_outward_current_r_gate__r_infinity = var_transient_outward_current_r_gate__alpha_r / (var_transient_outward_current_r_gate__alpha_r + var_transient_outward_current_r_gate__beta_r); // dimensionless
        const double var_transient_outward_current__i_to = (-var_transient_outward_current__E_to + var_chaste_interface__membrane__V) * var_transient_outward_current__g_to * var_transient_outward_current_r_gate__r_infinity * var_chaste_interface__transient_outward_current_to_gate__to; // picoA_per_picoF
        const double d_dt_chaste_interface_var_membrane__V = (-var_calcium_background_current__i_b_Ca - var_calcium_current__i_Ca - var_delayed_rectifier_potassium_current__i_K - var_inward_rectifier_potassium_current__i_K1 - var_sodium_background_current__i_b_Na - var_sodium_calcium_pump__i_NaCa - var_sodium_current__i_Na - var_sodium_potassium_pump__i_NaK - var_stimulus_protocol__i_stim - var_transient_outward_current__i_to) / mParameters[7]; // millivolt / millisecond
        
        rY[0] += mDt*d_dt_chaste_interface_var_membrane__V;
    }
    
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        const double var_calcium_current_f_gate__alpha_f = 0.0068700000000000002 / (1.0 + exp(-1.0056535947712419 + 0.16339869281045752 * var_chaste_interface__membrane__V));
        const double var_calcium_current_f_gate__beta_f = 0.00057499999999999999 + (0.010999999999999999 + 0.069000000000000006 * exp(-108.07499999999999 - 11.0 * var_chaste_interface__membrane__V)) / (1.0 + exp(-2.7313499999999999 - 0.27800000000000002 * var_chaste_interface__membrane__V));
        const double var_delayed_rectifier_potassium_current_X_gate__X_infinity = 0.98799999999999999 / (1.0 + exp(-0.86099999999999999 - 0.062 * var_chaste_interface__membrane__V));
        ...
        const double var_sodium_current_m_gate__alpha_m = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V));
        const double var_sodium_current_m_gate__beta_m = 0.080000000000000002 * exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
        const double var_sodium_current_v_gate__tau_v = 0.25 + 2.2400000000000002 * (1.0 - tanh(7.7400000000000002 + 0.12 * var_chaste_interface__membrane__V)) / (1.0 - tanh(6.4680000000000009 + 0.070000000000000007 * var_chaste_interface__membrane__V));
        const double var_sodium_current_v_gate__v_infinity = 0.5 - 0.5 * tanh(7.7400000000000002 + 0.12 * var_chaste_interface__membrane__V);
        const double var_transient_outward_current_to_gate__alpha_to = (5.6119999999999998e-5 * var_chaste_interface__membrane__V + 0.072099999999999997 * exp(-5.9257863000000004 - 0.17299999999999999 * var_chaste_interface__membrane__V)) / (1.0 + exp(-5.9326369200000002 - 0.17319999999999999 * var_chaste_interface__membrane__V));
        const double var_transient_outward_current_to_gate__beta_to = (0.0001215 * var_chaste_interface__membrane__V + 0.076700000000000004 * exp(-5.6479010000000002e-8 - 1.6600000000000001e-9 * var_chaste_interface__membrane__V)) / (1.0 + exp(-5.4573693999999993 - 0.16039999999999999 * var_chaste_interface__membrane__V));
    ...
    std::vector<double> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEulerNoLut>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEulerNoLut)
