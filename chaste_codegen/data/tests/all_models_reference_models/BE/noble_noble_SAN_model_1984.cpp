...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        const double var_x29 = 1.0 + var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x30 = 1 / var_x29;
        const double var_x31 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Nai);
        const double var_x32 = var_x30 * var_x31;
        const double var_x33 = 0.0064466434341209095 * var_x32;
        const double var_x34 = exp(-0.037433890822745473 * var_chaste_interface__membrane__V);
        const double var_x35 = mParameters[4] * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x36 = 4.6047453100863642e-7 * var_x35;
        ...
        const double var_x40 = var_x31 * var_x39 / pow(var_x29, 2);
        ...
        const double var_x50 = var_x30 * var_x39 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Nai), 2);
        ...
        const double var_x73 = exp(3.7433890822745473 - 0.074867781645490947 * var_chaste_interface__membrane__V);
        ...
        const double var_x96 = 0.00071593949080342272 * var_x32;
        const double var_x97 = 0.00019125436204147007 * var_x24;
        const double var_x98 = 0.00019125436204147007 * var_x27;
        const double var_x99 = 5.1138535057387335e-8 * var_x35;
        ...
        const double var_x103 = 0.0010739092362051341 * var_x32;
        ...
        rJacobian[0][0] = 1.0 - (mDt * (-0.001 + var_x42 - var_x25 - var_x28 + 6.4466434341209093e-5 * var_x17 + 0.0064466434341209095 * var_x40 - 3.1835276217881036e-8 * var_x45 - 6.4466434341209093e-7 * var_x46 + var_x24 * var_x38 + var_x27 * var_x38 - var_x33 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x34 * var_x36));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = 0.0;
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = -(mDt * (var_x36 + 6.4466434341209093e-5 * var_x49 + var_x18 * var_x25 + var_x18 * var_x28 - var_x18 * var_x42));
        rJacobian[0][5] = -(mDt * (4.0291521463255683e-6 * var_x50 - var_x33 * var_chaste_interface__extracellular_potassium_concentration__Kc));
        ...
        rJacobian[4][0] = -(mDt * (var_x97 + var_x98 - var_x101 + 7.1593949080342266e-8 * var_x46 + 3.5355036582885069e-9 * var_x45 - 0.00071593949080342272 * var_x40 - 7.1593949080342271e-6 * var_x17 + var_x34 * var_x99 + var_x96 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x100 * var_x24 - var_x100 * var_x27));
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (var_x102 - var_x99 + var_x101 * var_x18 - var_x18 * var_x97 - var_x18 * var_x98));
        rJacobian[4][5] = -(mDt * (-4.4746218175213919e-7 * var_x50 + var_x96 * var_chaste_interface__extracellular_potassium_concentration__Kc));
        ...
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (4.2956369448205359e-8 * var_x90 + 4.2956369448205366e-12 * var_x89 + 2.9639894919261698e-10 * var_x85));
        rJacobian[5][4] = -(mDt * (-var_x105 * var_x108));
        rJacobian[5][5] = 1.0 - (mDt * (var_x102 + 6.7119327262820874e-7 * var_x50 + 1.2886910834461608e-11 * var_x93 - 1.2886910834461608e-7 * var_x92 - 1.3387805342902908e-5 * var_x106 - var_x103 * var_chaste_interface__extracellular_potassium_concentration__Kc - 0.00019125436204147007 * var_x104 * var_x108 - 0.00019125436204147007 * var_x106 * var_x26 * var_chaste_interface__extracellular_potassium_concentration__Kc * mParameters[7]));
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_hyperpolarising_activated_current_y_gate__alpha_y = 0.050000000000000003 * exp(-3.484 - 0.067000000000000004 * var_chaste_interface__membrane__V);
