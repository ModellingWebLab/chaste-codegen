...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        const double var_x12 = 1.0 + var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x13 = 1 / var_x12;
        const double var_x14 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Nai);
        const double var_x15 = var_x13 * var_x14;
        const double var_x16 = 0.0064466434341209095 * var_x15;
        const double var_x17 = -0.037433890822745473 * var_chaste_interface__membrane__V;
        const double var_x18 = exp(var_x17);
        const double var_x19 = mParameters[4] * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x20 = 4.6047453100863642e-7 * var_x19;
        ...
        const double var_x24 = var_x14 * var_x23 / pow(var_x12, 2);
        ...
        const double var_x38 = var_x13 * var_x23 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Nai), 2);
        ...
        const double var_x71 = 0.00071593949080342272 * var_x15;
        const double var_x72 = 0.00019125436204147007 * var_x7;
        const double var_x73 = 0.00019125436204147007 * var_x10;
        const double var_x74 = 5.1138535057387335e-8 * var_x19;
        ...
        const double var_x79 = 0.0010739092362051341 * var_x15;
        ...
        rJacobian[0][0] = 1.0 - (mDt * (-0.001 + var_x26 - var_x11 - var_x8 + 0.0064466434341209095 * var_x24 - 3.1835276217881036e-8 * var_x29 - 6.4466434341209093e-7 * var_x30 + var_x10 * var_x22 + var_x22 * var_x7 - var_x16 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x18 * var_x20 - var_x32 * var_x35));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = 0.0;
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = -(mDt * (var_x20 + var_x1 * var_x11 + var_x1 * var_x8 + var_x35 * var_x37 - var_x1 * var_x26));
        rJacobian[0][5] = -(mDt * (4.0291521463255683e-6 * var_x38 - var_x16 * var_chaste_interface__extracellular_potassium_concentration__Kc));
        ...
        rJacobian[4][0] = -(mDt * (var_x72 + var_x73 - var_x76 + 7.1593949080342266e-8 * var_x30 + 3.5355036582885069e-9 * var_x29 - 0.00071593949080342272 * var_x24 + var_x18 * var_x74 + var_x32 * var_x77 + var_x71 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x10 * var_x75 - var_x7 * var_x75));
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (var_x78 - var_x74 + var_x1 * var_x76 - var_x1 * var_x72 - var_x1 * var_x73));
        rJacobian[4][5] = -(mDt * (-4.4746218175213919e-7 * var_x38 + var_x71 * var_chaste_interface__extracellular_potassium_concentration__Kc));
        ...
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (4.2956369448205359e-8 * var_x64 + 4.2956369448205366e-12 * var_x63 + 2.9639894919261698e-10 * var_x59));
        rJacobian[5][4] = -(mDt * (-var_x81 * var_x84));
        rJacobian[5][5] = 1.0 - (mDt * (var_x78 + 6.7119327262820874e-7 * var_x38 + 1.2886910834461608e-11 * var_x70 - 1.2886910834461608e-7 * var_x69 - 1.3387805342902908e-5 * var_x82 - var_x79 * var_chaste_interface__extracellular_potassium_concentration__Kc - 0.00019125436204147007 * var_x80 * var_x84 - 0.00019125436204147007 * var_x82 * var_x9 * var_chaste_interface__extracellular_potassium_concentration__Kc * mParameters[7]));
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_hyperpolarising_activated_current_y_gate__beta_y = (52.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-10.4 - 0.20000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_time_dependent_potassium_current_x_gate__alpha_x = 0.5 * (22.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.4000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V));
        const double var_time_dependent_potassium_current_x_gate__beta_x = 0.17799999999999999 * (22.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(1.4666666666666666 + 0.066666666666666666 * var_chaste_interface__membrane__V));
