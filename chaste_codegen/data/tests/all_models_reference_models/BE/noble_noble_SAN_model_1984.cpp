...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        const double var_x3 = var_chaste_interface__hyperpolarising_activated_current_y_gate__y / (45.0 + var_chaste_interface__extracellular_potassium_concentration__Kc);
        const double var_x4 = 0.010332845385450266 * var_x3;
        const double var_x5 = 1.0 + var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x6 = 1 / var_x5;
        const double var_x7 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Nai);
        const double var_x8 = var_x6 * var_x7;
        const double var_x9 = 0.0064466434341209095 * var_x8;
        const double var_x10 = var_chaste_interface__extracellular_potassium_concentration__Kc * var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x11 = var_x10 * var_x7 / pow(var_x5, 2);
        const double var_x12 = var_chaste_interface__extracellular_potassium_concentration__Kc / var_chaste_interface__intracellular_potassium_concentration__Ki;
        const double var_x13 = log(var_x12);
        const double var_x14 = -26.713760659695652 * var_x13 + var_chaste_interface__membrane__V;
        const double var_x15 = var_x14 * var_x3;
        const double var_x16 = var_x14 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x17 = var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow((1 + 0.022222222222222223 * var_chaste_interface__extracellular_potassium_concentration__Kc), 2);
        const double var_x18 = var_x16 * var_x17;
        const double var_x19 = 0.074867781645490947 * var_chaste_interface__membrane__V;
        const double var_x20 = exp(0.74867781645490938 + var_x19 - 2.0 * var_x13);
        const double var_x21 = 1.0 + var_x20;
        const double var_x22 = 1 / var_x21;
        const double var_x23 = 1 / (10.0 + var_chaste_interface__extracellular_potassium_concentration__Kc);
        const double var_x24 = var_x22 * var_x23;
        const double var_x25 = 0.0012916056731812832 * var_x24;
        const double var_x26 = exp(1.8716945411372736 + var_x0);
        const double var_x27 = var_x26 * var_chaste_interface__second_inward_current_f2_gate__f2;
        const double var_x28 = (-50.0 + var_chaste_interface__membrane__V) * var_chaste_interface__second_inward_current_d_gate__d * var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x29 = var_x28 / (1.0 - var_x26);
        const double var_x30 = 1.8099220986453831e-7 * var_x29;
        const double var_x31 = var_x14 * var_x24;
        const double var_x32 = var_x16 * var_x22 / pow((1 + 0.10000000000000001 * var_chaste_interface__extracellular_potassium_concentration__Kc), 2);
        const double var_x33 = var_x14 * var_x20 * var_x23 / pow(var_x21, 2);
        const double var_x34 = 9.6699651511813646e-5 * var_x33;
        ...
        const double var_x37 = var_x10 * var_x6 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Nai), 2);
        const double var_x38 = var_x29 * (var_x35 * var_chaste_interface__intracellular_potassium_concentration__Ki - var_x26 * var_chaste_interface__extracellular_potassium_concentration__Kc);
        ...
        const double var_x45 = var_x42 * pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 1.0);
        const double var_x46 = pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 3.0) / pow(var_x41, 2);
        ...
        const double var_x50 = exp(3.7433890822745473 - var_x19);
        const double var_x51 = 4.0200601101640967e-6 * var_x28 / (1.0 - var_x50);
        const double var_x52 = 0.018716945411372737 * var_chaste_interface__membrane__V;
        const double var_x53 = exp(-var_x52);
        const double var_x54 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Cai);
        const double var_x55 = pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 3.0);
        const double var_x56 = 1 / (1.0 + 0.00020000000000000001 * var_x55 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Cai);
        const double var_x57 = var_x54 * var_x56;
        const double var_x58 = var_x53 * var_x57;
        const double var_x59 = exp(var_x52);
        const double var_x60 = 2.0 * var_x55 * var_x59 - 2744000.0 * var_x53 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        const double var_x61 = var_x54 * var_x60 / pow((0.0036443148688046646 + 7.2886297376093296e-7 * var_x55 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x62 = var_x56 * var_x60 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x63 = pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 2.0);
        const double var_x64 = var_x57 * var_x59 * var_x63;
        const double var_x65 = var_x61 * var_x63;
        const double var_x66 = 1.0227707011477468e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x67 = 0.0011475261722488205 * var_x3;
        const double var_x68 = 0.00071593949080342272 * var_x8;
        const double var_x69 = 0.00014344077153110256 * var_x24;
        const double var_x70 = 2.0100300550820484e-8 * var_x29;
        const double var_x71 = 1.073909236205134e-5 * var_x33;
        const double var_x72 = -var_x36 * var_x70;
        ...
        const double var_x75 = 0.0010739092362051341 * var_x8;
        ...
        rJacobian[0][0] = 1.0 - (mDt * (-0.001 + var_x34 - var_x25 - var_x4 + 4.8349825755906823e-5 * var_x31 + 0.00038679860604725458 * var_x15 + 0.0064466434341209095 * var_x11 - 1.9101165730728621e-7 * var_x18 - 4.8349825755906825e-7 * var_x32 - var_x1 * var_x2 - var_x27 * var_x30 - var_x9 * var_chaste_interface__intracellular_sodium_concentration__Nai));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = 0.0;
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = -(mDt * (var_x2 + var_x12 * var_x25 + var_x12 * var_x4 + var_x30 * var_x36 - var_x12 * var_x34));
        rJacobian[0][5] = -(mDt * (4.0291521463255683e-6 * var_x37 - var_x9 * var_chaste_interface__extracellular_potassium_concentration__Kc));
        ...
        rJacobian[1][3] = -(mDt * (var_x44 * var_x46 - var_x44 * var_x45));
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[2][0] = 0.0;
        ...
        rJacobian[3][3] = 1.0 - (mDt * (-0.20000000000000001 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 5.2182178629987073e-11 * var_x61 - 9.8799649730872331e-11 * var_x62 - 4.7813590510367518e-7 / var_chaste_interface__intracellular_calcium_concentration__Cai - 0.039290759255291838 * var_x58 + var_x45 * var_x48 - var_x46 * var_x48 - var_x49 * var_x51 * var_chaste_interface__second_inward_current_f2_gate__f2));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (8.5912738896410719e-8 * var_x64 - 1.1410097368072975e-16 * var_x65));
        rJacobian[3][6] = -(mDt * (-var_x51 * (-2.0 * var_x50 + var_x49 * var_chaste_interface__intracellular_calcium_concentration__Cai)));
        rJacobian[4][0] = -(mDt * (var_x67 + var_x69 - var_x71 + 2.1213021949731043e-8 * var_x18 + 5.3695461810256699e-8 * var_x32 - 0.00071593949080342272 * var_x11 - 5.3695461810256699e-6 * var_x31 - 4.2956369448205359e-5 * var_x15 + var_x1 * var_x66 + var_x27 * var_x70 + var_x68 * var_chaste_interface__intracellular_sodium_concentration__Nai));
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (var_x72 - var_x66 + var_x12 * var_x71 - var_x12 * var_x67 - var_x12 * var_x69));
        rJacobian[4][5] = -(mDt * (-4.4746218175213919e-7 * var_x37 + var_x68 * var_chaste_interface__extracellular_potassium_concentration__Kc));
        rJacobian[4][6] = -(mDt * (-2.0100300550820484e-8 * var_x38));
        rJacobian[5][0] = -(mDt * (0.0010739092362051341 * var_x11 + var_x74 / (140.0 + 0.12 * var_chaste_interface__extracellular_potassium_concentration__Kc) - var_x75 * var_chaste_interface__intracellular_sodium_concentration__Nai - 4.2956369448205359e-5 * var_x3 * var_x77 + 2.1213021949731043e-8 * var_x17 * var_x77 * var_chaste_interface__extracellular_potassium_concentration__Kc));
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (1.5654653588996123e-10 * var_x61 + 0.11787227776587551 * var_x58 + 2.9639894919261698e-10 * var_x62));
        ...
        rJacobian[5][6] = -(mDt * (-var_x70 * (-140.0 * var_x26 + var_x35 * var_chaste_interface__intracellular_sodium_concentration__Nai)));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
