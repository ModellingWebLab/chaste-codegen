...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellzhang_SAN_model_2000_0D_capableFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_T_type_Ca_channel_f_gate__beta_f_T = 15.0 * exp(4.6163849154746419 + 065019505851755519 * var_chaste_interface__membrane__V);
        ...
        const double var_four_AP_sensitive_currents_q_gate__q_infinity = 1.0 / (1.0 + exp(4.5320610687022898 + 076335877862595422 * var_chaste_interface__membrane__V));
        const double var_four_AP_sensitive_currents_r_gate__r_infinity = 1.0 / (1.0 + exp(0.5548223350253807 - 050761421319796954 * var_chaste_interface__membrane__V));
        const double var_four_AP_sensitive_currents_r_gate__tau_r = 0029775000000000001 + 019595000000000001 / (1.0369999999999999 * exp(2.7585732000000003 + 090120000000000006 * var_chaste_interface__membrane__V) + 0.36899999999999999 * exp(-2.8369599999999999 - 0.11899999999999999 * var_chaste_interface__membrane__V));
        const double var_hyperpolarisation_activated_current_y_gate__alpha_y = 1.0 * exp(-2.9631993991738641 - 037551633496057078 * var_chaste_interface__membrane__V);
        const double var_hyperpolarisation_activated_current_y_gate__beta_y = 1.0 * exp(3.5355294117647058 + 047058823529411764 * var_chaste_interface__membrane__V);
        ...
        const double var_T_type_Ca_channel_f_gate__alpha_f_T = 15.300000000000001 * exp(-0.85234093637454988 - 0084033613445378148 * var_membrane__FCell - 012004801920768308 * var_chaste_interface__membrane__V);
        ...
        const double var_rapid_delayed_rectifying_potassium_current_P_af_gate__P_af_infinity = 1.0 / (1.0 + exp(-1.3396226415094339 - 094339622641509441 * var_chaste_interface__membrane__V));
        const double var_rapid_delayed_rectifying_potassium_current_P_af_gate__tau_P_af = 1.0 / (0.95999999999999996 * exp(0.40000000000000002 - 044444444444444446 * var_chaste_interface__membrane__V) + 37.200000000000003 * exp(-0.56603773584905659 + 062893081761006289 * var_chaste_interface__membrane__V));
        ...
        const double var_rapid_delayed_rectifying_potassium_current_P_as_gate__tau_P_as = 1.0 / (4.2000000000000002 * exp(-0.52941176470588236 + 058823529411764705 * var_chaste_interface__membrane__V) + 0.14999999999999999 * exp(0.41666666666666663 - 046296296296296294 * var_chaste_interface__membrane__V));
        const double var_rapid_delayed_rectifying_potassium_current_P_i_gate__P_i_infinity = 1.0 / (1.0 + exp(1.8415841584158419 + 099009900990099015 * var_chaste_interface__membrane__V));
        const double var_rapid_delayed_rectifying_potassium_current_P_i_gate__tau_P_i = 002;
        ...
        const double var_slow_delayed_rectifying_potassium_current_xs_gate__beta_xs = 1.0 * exp(-022222222222222223 * var_chaste_interface__membrane__V);
        ...
        const double var_sodium_current_h_gate__tau_h1 = 00059770000000000005 + 3.7170000000000002e-6 * exp(-4.8164649999999991 - 0.28149999999999997 * var_chaste_interface__membrane__V) / (1.0 + 0037320000000000001 * exp(-12.936576000000001 - 0.34260000000000002 * var_chaste_interface__membrane__V));
        const double var_sodium_current_h_gate__tau_h2 = 0035560000000000001 + 3.1860000000000002e-8 * exp(-11.69172 - 0.62190000000000001 * var_chaste_interface__membrane__V) / (1.0 + 7.1890000000000005e-5 * exp(-22.768981 - 0.66830000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_sodium_current_m_gate__tau_m = 4.5689999999999998e-5 + 00062469999999999995 / (0.62739999999999996 * exp(5.3505781299999997 + 082299999999999998 * var_chaste_interface__membrane__V) + 0.83221659999999997 * exp(-19.034003092000003 - 0.33566000000000001 * var_chaste_interface__membrane__V));
        
        
        rY[4] = (var_chaste_interface__L_type_Ca_channel_d_gate__d_L + ((001 * var_L_type_Ca_channel_d_gate__d_L_infinity / var_L_type_Ca_channel_d_gate__tau_d_L) * mDt)) / (1.0 - ((-001 / var_L_type_Ca_channel_d_gate__tau_d_L) * mDt));
        rY[5] = (var_chaste_interface__L_type_Ca_channel_f_gate__f_L + ((001 * var_L_type_Ca_channel_f_gate__f_L_infinity / var_L_type_Ca_channel_f_gate__tau_f_L) * mDt)) / (1.0 - ((-001 / var_L_type_Ca_channel_f_gate__tau_f_L) * mDt));
        rY[6] = (var_chaste_interface__T_type_Ca_channel_d_gate__d_T + ((001 * var_T_type_Ca_channel_d_gate__d_T_infinity / var_T_type_Ca_channel_d_gate__tau_d_T) * mDt)) / (1.0 - ((-001 / var_T_type_Ca_channel_d_gate__tau_d_T) * mDt));
        rY[7] = (var_chaste_interface__T_type_Ca_channel_f_gate__f_T + ((001 * var_T_type_Ca_channel_f_gate__f_T_infinity / var_T_type_Ca_channel_f_gate__tau_f_T) * mDt)) / (1.0 - ((-001 / var_T_type_Ca_channel_f_gate__tau_f_T) * mDt));
        rY[8] = (var_chaste_interface__four_AP_sensitive_currents_q_gate__q + ((001 * var_four_AP_sensitive_currents_q_gate__q_infinity / var_four_AP_sensitive_currents_q_gate__tau_q) * mDt)) / (1.0 - ((-001 / var_four_AP_sensitive_currents_q_gate__tau_q) * mDt));
        rY[9] = (var_chaste_interface__four_AP_sensitive_currents_r_gate__r + ((001 * var_four_AP_sensitive_currents_r_gate__r_infinity / var_four_AP_sensitive_currents_r_gate__tau_r) * mDt)) / (1.0 - ((-001 / var_four_AP_sensitive_currents_r_gate__tau_r) * mDt));
        rY[14] = (var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + ((001 * var_hyperpolarisation_activated_current_y_gate__alpha_y) * mDt)) / (1.0 - ((-001 * var_hyperpolarisation_activated_current_y_gate__alpha_y - 001 * var_hyperpolarisation_activated_current_y_gate__beta_y) * mDt));
        rY[10] = (var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_af_gate__P_af + ((001 * var_rapid_delayed_rectifying_potassium_current_P_af_gate__P_af_infinity / var_rapid_delayed_rectifying_potassium_current_P_af_gate__tau_P_af) * mDt)) / (1.0 - ((-001 / var_rapid_delayed_rectifying_potassium_current_P_af_gate__tau_P_af) * mDt));
        rY[11] = (var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_as_gate__P_as + ((001 * var_rapid_delayed_rectifying_potassium_current_P_as_gate__P_as_infinity / var_rapid_delayed_rectifying_potassium_current_P_as_gate__tau_P_as) * mDt)) / (1.0 - ((-001 / var_rapid_delayed_rectifying_potassium_current_P_as_gate__tau_P_as) * mDt));
        rY[12] = (var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_i_gate__P_i + ((001 * var_rapid_delayed_rectifying_potassium_current_P_i_gate__P_i_infinity / var_rapid_delayed_rectifying_potassium_current_P_i_gate__tau_P_i) * mDt)) / (1.0 - ((-001 / var_rapid_delayed_rectifying_potassium_current_P_i_gate__tau_P_i) * mDt));
        rY[13] = (var_chaste_interface__slow_delayed_rectifying_potassium_current_xs_gate__xs + ((001 * var_slow_delayed_rectifying_potassium_current_xs_gate__alpha_xs) * mDt)) / (1.0 - ((-001 * var_slow_delayed_rectifying_potassium_current_xs_gate__alpha_xs - 001 * var_slow_delayed_rectifying_potassium_current_xs_gate__beta_xs) * mDt));
        rY[2] = (var_chaste_interface__sodium_current_h_gate__h1 + ((001 * var_sodium_current_h_gate__h1_infinity / var_sodium_current_h_gate__tau_h1) * mDt)) / (1.0 - ((-001 / var_sodium_current_h_gate__tau_h1) * mDt));
        rY[3] = (var_chaste_interface__sodium_current_h_gate__h2 + ((001 * var_sodium_current_h_gate__h2_infinity / var_sodium_current_h_gate__tau_h2) * mDt)) / (1.0 - ((-001 / var_sodium_current_h_gate__tau_h2) * mDt));
