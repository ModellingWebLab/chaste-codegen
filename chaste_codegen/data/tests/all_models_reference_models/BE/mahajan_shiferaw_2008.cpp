...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[15], double rJacobian[15][15])
    {
        ...
        const double var_x16 = exp(-9.9999999999999995e-8);
        const double var_x17 = 1 / (-1.0 + var_x16);
        const double var_x18 = -0.34100000000000003 * mParameters[5];
        const double var_x19 = 0.001 * var_chaste_interface__Ca__Ca_submem;
        const double var_x20 = mParameters[8] * mParameters[10];
        const double var_x21 = 1.9999999999999999e-7 * var_x20;
        const double var_x22 = var_x17 * var_x21 * (var_x18 + var_x16 * var_x19);
        const double var_x23 = exp(9.9999999999999995e-8);
        const double var_x24 = 1 / (-1.0 + var_x23);
        const double var_x25 = mParameters[9] * mParameters[20] / mParameters[8];
        const double var_x26 = 1 / mParameters[9];
        const double var_x27 = 1 / mParameters[20];
        const double var_x28 = var_x26 * var_x27 * mParameters[8];
        const double var_x29 = 10000000.0 * var_x28 * (4.9999999999999998e-8 * var_x25 + var_chaste_interface__cell__V);
        const double var_x30 = fabs(var_chaste_interface__cell__V) < 4.9999999999999998e-8 * fabs(var_x25);
        const double var_x31 = var_x28 * var_chaste_interface__cell__V;
        const double var_x32 = exp(2.0 * var_x31);
        const double var_x33 = var_x26 * var_x27 * pow(mParameters[8], 2) * mParameters[10] * var_chaste_interface__cell__V / (-1.0 + var_x32);
        const double var_x34 = ((var_x30) ? (-var_x22 + var_x29 * (var_x22 + var_x21 * var_x24 * (var_x18 + var_x19 * var_x23))) : (4.0 * var_x33 * (var_x18 + var_x19 * var_x32)));
        const double var_x35 = fabs(var_x34);
        const double var_x36 = (var_chaste_interface__Irel__Ca_JSR > 50.0) && (var_chaste_interface__Irel__Ca_JSR < 90.0);
        const double var_x37 = var_chaste_interface__Irel__Ca_JSR >= 90.0;
        const double var_x38 = ((var_x36) ? (-50.0 + var_chaste_interface__Irel__Ca_JSR) : ((var_x37) ? (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR) : (0)));
        const double var_x39 = var_x35 * var_x38;
        const double var_x40 = var_x15 * var_x39;
        const double var_x41 = exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V);
        const double var_x42 = 298.24222222222221 * var_x41 / (1.0 + var_x41);
        const double var_x43 = var_x42 * mParameters[1];
        const double var_x44 = 1.9999999999999998e-10 * var_x20;
        const double var_x45 = var_x16 * var_x17 * var_x44;
        const double var_x46 = ((var_x30) ? (-var_x45 + var_x29 * (var_x45 + var_x23 * var_x24 * var_x44)) : (0.0040000000000000001 * var_x32 * var_x33));
        const double var_x47 = var_x46 * Signum(var_x34);
        const double var_x48 = var_x15 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x49 = var_x38 * var_x47;
        const double var_x50 = var_x39 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x51 = (-9000.0 * var_x35 - var_x42 * var_x50) * mParameters[1];
        const double var_x52 = var_x35 * ((var_x36) ? (1.0) : ((var_x37) ? (11.300000000000001) : (0)));
        const double var_x53 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x54 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x55 = 0.013000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x56 = 0.00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x57 = 1.0 + 0.00016800000000000002 / pow(var_x53, 2) + 2.8200000000000001e-5 / pow(var_x54, 2) + 0.00054600000000000004 / pow(var_x55, 2) + 4.5000000000000001e-6 / pow(var_x56, 2);
        ...
        const double var_x81 = exp(-0.65000000000000002 * var_x31);
        ...
        const double var_x85 = exp(0.34999999999999998 * var_x31);
        ...
        const double var_x98 = 9100.0 * var_x34;
        ...
        const double var_x111 = 1 / (1.0 + exp(-0.125 * var_chaste_interface__cell__V));
        const double var_x112 = var_x111;
        const double var_x113 = 1 / (1.0 + 27.0 * var_x108);
        const double var_x114 = 1.0 + exp(-3.5335689045936394 - 0.088339222614840993 * var_chaste_interface__cell__V);
        ...
        const double var_x118 = 1.0 - 1 / (1.0 + exp(-10.0 - 0.25 * var_chaste_interface__cell__V));
        const double var_x119 = 4954.0 * exp(0.064102564102564111 * var_chaste_interface__cell__V);
        ...
        const double var_x137 = 0.33333333333333331 / (1.0 + exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V));
        ...
        const double var_x146 = exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x147 = 0.028675444444444444 * var_x146 / (1.0 + var_x146);
        const double var_x148 = var_x144 * var_chaste_interface__Irel__xir;
        const double var_x149 = var_x147 * var_x48;
        const double var_x150 = -var_x147 * var_x50;
        const double var_x151 = 8.6634442712402744e-10 * var_x90;
        const double var_x152 = mParameters[6] / ((1.5 + mParameters[6]) * (1.0 + 0.1245 * exp(-0.10000000000000001 * var_x31) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[7])) * exp(-var_x31)));
        ...
        rJacobian[0][14] = 0.0;
        rJacobian[1][0] = -(mDt * (var_x40 * var_x43));
        rJacobian[1][1] = 1.0 - (mDt * (-2.0));
        rJacobian[1][2] = 0.0;
        rJacobian[1][3] = -(mDt * (2.0 + (var_x47 * (9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca) + var_x42 * var_x48 * var_x49) * mParameters[1]));
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        ...
        rJacobian[1][12] = -(mDt * (var_x43 * var_x48 * var_x52));
        rJacobian[1][13] = 0.0;
        rJacobian[1][14] = 0.0;
        rJacobian[2][0] = -(mDt * (var_x59 * (var_x3 + var_x5 - var_x6)));
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (var_x59 * (-2539.0 + var_x13 + var_x60 - var_x11 - var_x12) + 0.001 * (0.00033600000000000004 / pow(var_x53, 3) + 5.6400000000000002e-5 / pow(var_x54, 3) + 0.0010920000000000001 / pow(var_x55, 3) + 9.0000000000000002e-6 / pow(var_x56, 3)) * (var_x63 - var_x62 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x61 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x57, 2)));
        ...
        rJacobian[8][14] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = -(mDt * (var_x110 + (0.00063442013684210537 * var_x106 * var_x113 - 2.1032463466666669e-8 * var_x109 * var_x141) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x109 * var_x15));
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = 0.0;
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = 0.0;
        ...
        rJacobian[12][13] = 0.0;
        rJacobian[12][14] = 0.0;
        rJacobian[13][0] = -(mDt * (var_x147 * var_x40 + (var_x144 * var_x7 - var_x145 / var_x0) * var_chaste_interface__Irel__xir));
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = -(mDt * (var_x14 * var_x148));
        rJacobian[13][3] = -(mDt * (var_x149 * var_x49));
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        ...
        rJacobian[13][12] = -(mDt * (var_x149 * var_x52));
        rJacobian[13][13] = 1.0 - (mDt * (-0.033333333333333333 - var_x148 + var_x144 * var_x145));
        rJacobian[13][14] = 0.0;
        rJacobian[14][0] = 0.0;
        rJacobian[14][1] = 0.0;
        rJacobian[14][2] = 0.0;
