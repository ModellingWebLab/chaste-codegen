...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    double Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut::Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut::~Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut()
    {
    }

    
    double Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__Environment__time, const double rCurrentGuess[15], double rResidual[15])
    {
    ...
    void Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[15], double rJacobian[15][15])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: mV; Initial value: -87.169816169406
        ...
        const double var_x15 = 1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca;
        const double var_x16 = var_chaste_interface__cell__V / (mParameters[9] * mParameters[20]);
        const double var_x17 = var_x16 * mParameters[8];
        const double var_x18 = exp(2.0 * var_x17);
        const double var_x19 = var_x16 * pow(mParameters[8], 2) * mParameters[10] / (-1.0 + var_x18);
        const double var_x20 = var_x19 * (-0.34100000000000003 * mParameters[5] + 0.001 * var_x18 * var_chaste_interface__Ca__Ca_submem);
        const double var_x21 = fabs(4.0 * var_x20);
        ...
        const double var_x26 = var_x15 * var_x25;
        const double var_x27 = exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V);
        const double var_x28 = var_x27 / (1.0 + var_x27);
        const double var_x29 = 298.24222222222221 * var_x28;
        const double var_x30 = var_x29 * mParameters[1];
        const double var_x31 = var_x18 * var_x19;
        const double var_x32 = var_x31 * Signum(var_x20);
        const double var_x33 = var_x15 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x34 = var_x24 * var_x32 * var_x33;
        const double var_x35 = var_x25 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x36 = (-9000.0 * var_x21 - var_x29 * var_x35) * mParameters[1];
        const double var_x37 = var_x21 * var_x33 * ((var_x22) ? (1.0) : ((var_x23) ? (11.300000000000001) : (0)));
        const double var_x38 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x39 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x40 = 0.013000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x41 = 0.00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x42 = 1.0 + 0.00016800000000000002 / pow(var_x38, 2) + 2.8200000000000001e-5 / pow(var_x39, 2) + 0.00054600000000000004 / pow(var_x40, 2) + 4.5000000000000001e-6 / pow(var_x41, 2);
        const double var_x43 = 1 / var_x42;
        const double var_x44 = 0.001 * var_x43;
        const double var_x45 = 32.699999999999996 * var_chaste_interface__Ca__tropi;
        const double var_x46 = 32.699999999999996 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x47 = var_x10 * var_x9;
        const double var_x48 = var_x2 * var_x4;
        const double var_x49 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_submem;
        const double var_x50 = pow(var_x49, (-2));
        const double var_x51 = 1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem;
        const double var_x52 = pow(var_x51, (-2));
        const double var_x53 = 0.59999999999999998 + var_chaste_interface__Ca__Ca_submem;
        const double var_x54 = pow(var_x53, (-2));
        const double var_x55 = 1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem;
        const double var_x56 = pow(var_x55, (-2));
        const double var_x57 = 1 / (1.0 + 4.5 * var_x50 + 3.2307692307692308 * var_x52 + 28.199999999999999 * var_x54 + 3.4285714285714284 * var_x56);
        const double var_x58 = 0.0327 * var_chaste_interface__Ca__trops;
        const double var_x59 = pow(mParameters[7], 3);
        const double var_x60 = 0.001 * var_x59;
        const double var_x61 = -669.921875 - var_x60 - 516.90750000000014 * mParameters[5];
        const double var_x62 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x63 = (1.0 + 0.27777777777777779 * var_chaste_interface__Ca__Ca_submem) * mParameters[5];
        const double var_x64 = 0.00053738391835633597 * var_x62;
        const double var_x65 = var_x59 * (1.0 + var_x64);
        const double var_x66 = exp(-0.65000000000000002 * var_x17);
        const double var_x67 = 1 / (1.0 + 0.20000000000000001 * var_x66);
        const double var_x68 = 1.0 + 0.026999999999999996 / pow(var_chaste_interface__Ca__Ca_submem, 3);
        const double var_x69 = 1 / var_x68;
        const double var_x70 = exp(0.34999999999999998 * var_x17);
        const double var_x71 = var_x62 * mParameters[5];
        const double var_x72 = var_x60 * var_chaste_interface__Ca__Ca_submem;
        const double var_x73 = var_x70 * var_x71 - var_x66 * var_x72;
        const double var_x74 = var_x67 * var_x69 * var_x73 * mParameters[19];
        const double var_x75 = var_x74 / pow((var_x63 + 0.00069859909386323679 * var_x62 + 1.9345821060828095e-6 * var_x65 + 0.36000524218012353 * var_chaste_interface__Ca__Ca_submem + var_x64 * mParameters[5] + 5.37383918356336e-7 * var_x59 * var_chaste_interface__Ca__Ca_submem), 2);
        const double var_x76 = 1.4439073785400458e-5 * var_x75;
        const double var_x77 = 1 / (var_x71 + var_x72 + 669.921875 * var_chaste_interface__Ca__Ca_submem + 0.0035999999999999999 * var_x65 + 1.3 * var_x62 + 1860.8670000000004 * var_x63);
        const double var_x78 = var_x67 * var_x77 * mParameters[19];
        const double var_x79 = var_x73 * var_x78 / (pow(var_x68, 2) * pow(var_chaste_interface__Ca__Ca_submem, 4));
        const double var_x80 = var_x69 * var_x78;
        const double var_x81 = var_x59 * var_x66 * var_x80;
        const double var_x82 = var_x57;
        const double var_x83 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
        const double var_x84 = 36400.0 * var_x20;
        const double var_x85 = var_x57 * var_x84;
        const double var_x86 = pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x87 = var_x86 * mParameters[5];
        const double var_x88 = -3 * var_x87 - 3.9000000000000004 * var_x86 - 5.8037463182484285e-6 * var_x59 * var_x86;
        const double var_x89 = var_x70 * var_x80 * var_x87;
        ...
        const double var_x103 = 1.0 - 1 / (1.0 + exp(-10.0 - 0.25 * var_chaste_interface__cell__V));
        ...
        const double var_x130 = var_x47 - var_x48 - var_chaste_interface__Irel__xir;
        const double var_x131 = exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x132 = 1 / (1.0 + var_x131);
        const double var_x133 = 0.028675444444444444 * var_x131 * var_x132;
        const double var_x134 = var_x129 * var_chaste_interface__Irel__xir;
        const double var_x135 = -var_x133 * var_x35;
        const double var_x136 = 8.6634442712402744e-10 * var_x75;
        const double var_x137 = mParameters[6] / ((1.5 + mParameters[6]) * (1.0 + 0.1245 * exp(-0.10000000000000001 * var_x17) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[7])) * exp(-var_x17)));
        ...
        rJacobian[0][14] = 0.0;
        rJacobian[1][0] = -(mDt * (var_x26 * var_x30));
        rJacobian[1][1] = 1.0 - (mDt * (-2.0));
        rJacobian[1][2] = 0.0;
        rJacobian[1][3] = -(mDt * (2.0 + (0.0040000000000000001 * var_x32 * (9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca) + 1.192968888888889 * var_x28 * var_x34) * mParameters[1]));
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = -(mDt * (var_x36));
        rJacobian[1][7] = -(mDt * (var_x36));
        rJacobian[1][8] = -(mDt * (var_x36));
        rJacobian[1][9] = -(mDt * (var_x36));
        rJacobian[1][10] = -(mDt * (var_x36));
        rJacobian[1][11] = -(mDt * (var_x36));
        rJacobian[1][12] = -(mDt * (var_x30 * var_x37));
        rJacobian[1][13] = 0.0;
        rJacobian[1][14] = 0.0;
        rJacobian[2][0] = -(mDt * (var_x44 * (var_x3 + var_x5 - var_x6)));
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (var_x44 * (-2539.0 + var_x13 + var_x45 - var_x11 - var_x12) + 0.001 * (0.00033600000000000004 / pow(var_x38, 3) + 5.6400000000000002e-5 / pow(var_x39, 3) + 0.0010920000000000001 / pow(var_x40, 3) + 9.0000000000000002e-6 / pow(var_x41, 3)) * (var_x48 - var_x47 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x46 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x42, 2)));
        rJacobian[2][3] = -(mDt * (0.00025000000000000001 * var_x43));
        rJacobian[2][4] = -(mDt * (var_x44 * (0.019599999999999999 + var_x46)));
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = 0.0;
        rJacobian[2][8] = 0.0;
        ...
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = -(mDt * (12500.0 * var_x57));
        rJacobian[3][3] = 1.0 - (mDt * (var_x82 * (-14.789 + var_x58 + 4.0499999999999998 * var_x79 - 0.050000000000000003 * var_x81 + var_x61 * var_x76 - 36.399999999999999 * var_x15 * var_x31) + 0.0012574820180071425 * (9.0 / pow(var_x49, 3) + 56.399999999999999 / pow(var_x53, 3) + 0.97959183673469385 / pow(var_x55, 3) + 0.49704142011834318 / pow(var_x51, 3)) * (50.0 * var_chaste_interface__Irel__xir + 0.019599999999999999 * var_chaste_interface__Ca__trops + 12500.0 * var_chaste_interface__Ca__Ca_i_converted - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x15 * var_x84 - var_x83 * (70.0 - var_chaste_interface__Ca__trops) + 50.0 * var_x74 * var_x77) / pow((0.035460992907801421 + var_x54 + 0.15957446808510639 * var_x50 + 0.12158054711246201 * var_x56 + 0.11456628477905074 * var_x52), 2)));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (var_x82 * (0.019599999999999999 + var_x83)));
        ...
        rJacobian[3][12] = 0.0;
        rJacobian[3][13] = -(mDt * (50.0 * var_x57));
        rJacobian[3][14] = -(mDt * (var_x82 * (150.0 * var_x89 + var_x76 * var_x88)));
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = -(mDt * (2289.0 - var_x45));
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-0.019599999999999999 - var_x46));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        ...
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (2.2890000000000001 - var_x58));
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (-0.019599999999999999 - var_x83));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        ...
        rJacobian[8][14] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = -(mDt * (var_x95 + (0.00063442013684210537 * var_x91 * var_x98 - 2.1032463466666669e-8 * var_x126 * var_x94) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x15 * var_x94));
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = 0.0;
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = 0.0;
        ...
        rJacobian[12][13] = 0.0;
        rJacobian[12][14] = 0.0;
        rJacobian[13][0] = -(mDt * (var_x133 * var_x26 + (var_x129 * var_x7 - var_x130 / var_x0) * var_chaste_interface__Irel__xir));
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = -(mDt * (var_x134 * var_x14));
        rJacobian[13][3] = -(mDt * (0.00011470177777777777 * var_x131 * var_x132 * var_x34));
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        ...
        rJacobian[13][12] = -(mDt * (var_x133 * var_x37));
        rJacobian[13][13] = 1.0 - (mDt * (-0.033333333333333333 - var_x134 + var_x129 * var_x130));
        rJacobian[13][14] = 0.0;
        rJacobian[14][0] = 0.0;
        rJacobian[14][1] = 0.0;
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = -(mDt * ((3.0000000000000001e-6 * var_x81 - 0.00024299999999999997 * var_x79 - var_x136 * var_x61) * mParameters[3]));
        rJacobian[14][4] = 0.0;
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = 0.0;
        rJacobian[14][7] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * ((-0.0089999999999999993 * var_x89 - var_x136 * var_x88 - 0.00056249999999999996 * var_x137 / (12.0 + var_chaste_interface__Na__Na_i) + 3.9062500000000001e-6 * var_x137 * var_chaste_interface__Na__Na_i / pow((1 + 0.083333333333333329 * var_chaste_interface__Na__Na_i), 2) - 0.000125 * pow(var_chaste_interface__INa__xm, 3) * mParameters[9] * mParameters[20] * mParameters[11] * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj / (mParameters[8] * var_chaste_interface__Na__Na_i)) * mParameters[3]));
    }

    void Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__Environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        const double var_IKs__tauxs1 = 1 / (0.00013100000000000001 * (30.0 + var_chaste_interface__cell__V) / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V)) + 7.1899999999999999e-5 * (30.0 + var_chaste_interface__cell__V) / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V)));
        ...
        const double var_INa__aj = ((var_chaste_interface__cell__V < -40.0) ? ((37.780000000000001 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.24440000000000001 * var_chaste_interface__cell__V - 0.24440000000000001 * mParameters[13]) - 3.4740000000000003e-5 * exp(0.043909999999999998 * mParameters[13] - 0.043909999999999998 * var_chaste_interface__cell__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))) : (0));
        ...
        CardiacNewtonSolver<15,Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<15,Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellmahajan_shiferaw_2008FromCellMLBackwardEulerNoLut)
