...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnoble_model_1998FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x25 = exp(3.7433890822745473 - 0.074867781645490947 * var_chaste_interface__membrane__V);
        ...
        rJacobian[7][7] = 1.0 - (mDt * (-7.0 + var_x22 + var_x23 - 0.00063119563270832375 * var_x47 - 1.0549054718227806e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i - 4.3552498656874335e-6 * var_x45 + (0.00040000000000000002 * var_x43 - 0.00040000000000000002 * var_x41 - 7.1999999999999991e-9 * var_x44) * mParameters[4]));
        ...
        rJacobian[11][11] = 1.0 - (mDt * ((8.2927354147114598e-7 * var_x67 - 1.0127092529498693e-5 * var_x70 - 0.0013268376663538336 * var_x66 - 0.016878487549164489 * var_x69 - 0.0056807606943749134 * var_x50 - var_x64 * var_x68 - 6.7513950196657958e-5 * var_x70 / (1.0 + exp(-6.5 - 0.125 * var_chaste_interface__membrane__V))) * mParameters[5]));
    }
    ...
    void Cellnoble_model_1998FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_L_type_Ca_channel_d_gate__alpha_d = 30.0 * (19.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.75 - 0.25 * var_chaste_interface__membrane__V));
        const double var_L_type_Ca_channel_d_gate__beta_d = 12.0 * (19.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V));
        const double var_L_type_Ca_channel_f_gate__alpha_f = 6.25 * (34.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V));
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = 200.0 * (41.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane__V));
