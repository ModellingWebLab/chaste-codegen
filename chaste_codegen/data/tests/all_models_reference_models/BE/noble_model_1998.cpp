...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnoble_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x14 = var_x8 * (2 * var_x7 - var_x13 * var_x6 / pow(var_x4, 2));
        const double var_x15 = 2.5 * var_x14;
        const double var_x16 = var_x15 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x17 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x18 = 0.5 * var_x14;
        ...
        const double var_x21 = var_x8 * (-2 * var_x20 + 2 * var_x2 + var_x13 * var_x5 * (var_x20 - var_x2));
        ...
        const double var_x31 = exp(3.7433890822745473 - 0.074867781645490947 * var_chaste_interface__membrane__V);
        ...
        const double var_x33 = 4.7303520325519803e-5 * var_x32 / (1.0 - var_x31);
        ...
        const double var_x41 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x42 = 2744000.0 * var_x40;
        const double var_x43 = exp(var_x39);
        const double var_x44 = 2.0 * var_x43 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        ...
        const double var_x49 = var_x47 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
        ...
        const double var_x52 = (var_x44 - var_x42 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x53 = var_x35 * var_x37;
        const double var_x54 = var_x43 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x55 = var_x50 * var_x54;
        const double var_x56 = exp(1.8716945411372736);
        const double var_x57 = exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V);
        const double var_x58 = var_x32 / (1.0 - var_x57);
        ...
        const double var_x61 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2) * (0.12195121951219512 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0036585365853658534 * var_chaste_interface__intracellular_sodium_concentration__Na_i) / pow((0.029999999999999999 * var_chaste_interface__intracellular_sodium_concentration__Na_i + var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        const double var_x62 = var_x56 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds;
        const double var_x63 = log(4.0 * var_x60);
        const double var_x64 = exp(-0.46792363528431841 + 0.046792363528431836 * var_chaste_interface__membrane__V - 1.25 * var_x63);
        ...
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = -(mDt * (((var_x10) ? (-var_x16 + var_x15 * var_x17) : (-var_x19 + var_x17 * var_x18))));
        rJacobian[2][7] = -(mDt * (((var_x10) ? (-var_x23 + var_x17 * var_x22) : (-var_x25 + var_x17 * var_x24))));
        rJacobian[2][8] = 0.0;
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = 0.0;
        ...
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = 0.0;
        rJacobian[3][6] = -(mDt * (((var_x10) ? (var_x16) : (var_x19))));
        ...
        rJacobian[5][11] = 0.0;
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = -(mDt * (-var_x33 * (-2.0 * var_x31 + var_x30 * var_chaste_interface__intracellular_calcium_concentration__Ca_i)));
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.01));
        rJacobian[6][7] = -(mDt * (-var_x30 * var_x33 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds));
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = 0.0;
        ...
        rJacobian[7][6] = -(mDt * (0.001 - 2.1798047375812983e-12 * (var_x44 - var_x42 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2) - 0.00086686727535117145 * var_x40 * var_x41));
        rJacobian[7][7] = 1.0 - (mDt * (-7.0000000000000009 + var_x28 + var_x29 + 0.00040000000000000002 * var_x48 - 0.86600040807582024 * var_x51 - 7.2e-9 * var_x49 - 1.0549054718227806e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i - 2.1776249328437171e-9 * var_x52 - 0.00040000000000000002 * var_x46));
        rJacobian[7][8] = -(mDt * (1.0204081632653063e-5 + 0.051020408163265314 * var_x53));
        rJacobian[7][9] = -(mDt * (7.2e-9 * var_x46 + 9.5999999999999999e-8 * var_x48 - 1.7279999999999999e-12 * var_x49));
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = -(mDt * (1.8935868981249713e-6 * var_x55 + 1.8954823805054768e-9 * var_x41 * var_x54));
        rJacobian[8][0] = 0.0;
        rJacobian[8][1] = 0.0;
        ...
        rJacobian[9][5] = 0.0;
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = -(mDt * (0.019599999999999999 * var_x46 + 3.5279999999999993e-7 * var_x49 - 0.019599999999999999 * var_x48));
        rJacobian[9][8] = -(mDt * (0.050000000000000003));
        rJacobian[9][9] = 1.0 - (mDt * (-0.050000000000000003 + 8.4671999999999982e-11 * var_x49 - 3.5279999999999993e-7 * var_x46 - 4.7040000000000002e-6 * var_x48));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = 0.0;
        rJacobian[10][0] = 0.0;
        rJacobian[10][1] = -(mDt * (-var_x59 * (-4.0 * var_x57 + var_x56 * var_chaste_interface__intracellular_potassium_concentration__K_i)));
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = 0.0;
        ...
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-0.00035984935454818685 * var_x61 - var_x59 * var_x62 - 0.0024112125070234985 * var_x60 / var_x65 - 0.016878487549164489 * var_x60 * (0.0012999999999999999 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2 + 0.0020999999999999999 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1) / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V)) - 8.4392437745822447e-5 * var_x60 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s + 0.00011282633217294504 * var_x60 * var_x64 * (-26.713760659695652 * var_x63 + var_chaste_interface__membrane__V) / pow(var_x65, 2)));
        rJacobian[10][11] = -(mDt * (0.00070764675538871125 * var_x66 - 1.0795480636445605e-5 * var_x61 - 4.4227922211794452e-7 * var_x67));
        rJacobian[11][0] = 0.0;
        rJacobian[11][1] = -(mDt * (-var_x68 * (-140.0 * var_x57 + var_x56 * var_chaste_interface__intracellular_sodium_concentration__Na_i)));
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = -(mDt * (6.5328747985311509e-9 * var_x52 + 2.5980012242274606 * var_x51));
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = -(mDt * (-0.71132697927198818 * var_x69));
        rJacobian[11][11] = 1.0 - (mDt * (6.634188331769168e-7 * var_x67 - 1.0127092529498693e-5 * var_x70 - 0.0010614701330830668 * var_x66 - 5.9277248272665686 * var_x69 - 5.6807606943749135e-6 * var_x55 - var_x62 * var_x68 - 6.7513950196657958e-5 * var_x70 / (1.0 + exp(-6.5 - 0.125 * var_chaste_interface__membrane__V))));
    }
