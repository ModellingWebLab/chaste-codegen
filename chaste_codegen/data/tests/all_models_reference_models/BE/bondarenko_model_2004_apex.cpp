...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellbondarenko_model_2004_apexFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rJacobian[32][32])
    {
        ...
        const double var_x0 = exp(-0.92307692307692313 - 076923076923076927 * var_chaste_interface__membrane__V);
        const double var_x1 = exp(1.2 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x2 = var_x1 * (1.0 + 0.69999999999999996 * exp(-160 * pow((1 + 025000000000000001 * var_chaste_interface__membrane__V), 2)) - 0.75 * exp(-1.0 * pow((1 + 050000000000000003 * var_chaste_interface__membrane__V), 2))) / (1.0 + 0.12 * var_x1);
        ...
        const double var_x7 = exp(-2.1025 * pow((1 + 068965517241379309 * var_chaste_interface__membrane__V), 2));
        const double var_x8 = 026000000000000002 * var_x7;
        ...
        const double var_x15 = 00093296000000000004 * var_x10 * var_x2;
        const double var_x16 = var_x15 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x17 = 00040000000000000002 * var_x0;
        const double var_x18 = 0001 * var_x0;
        ...
        const double var_x22 = var_chaste_interface__calcium_concentration__Cass / pow((1 + 050000000000000003 * var_chaste_interface__calcium_concentration__Cass), 2);
        const double var_x23 = 00058310000000000002 * var_x22;
        ...
        const double var_x27 = 013000000000000001 * var_x7;
        const double var_x28 = 00040000000000000002 * var_x2;
        ...
        const double var_x33 = 013000000000000001 - var_x27;
        ...
        const double var_x36 = 0023700000000000001 * var_chaste_interface__calcium_concentration__Cai;
        const double var_x37 = 0023700000000000001 * var_chaste_interface__calcium_buffering__HTRPN_Ca;
        const double var_x38 = 0327 * var_chaste_interface__calcium_concentration__Cai;
        const double var_x39 = 0327 * var_chaste_interface__calcium_buffering__LTRPN_Ca;
        const double var_x40 = 1 + 00125 * var_chaste_interface__calcium_concentration__CaJSR;
        ...
        const double var_x59 = exp(-025317124991725771 * var_chaste_interface__membrane__V);
        const double var_x60 = 1 / (1.0 + 0.10000000000000001 * var_x59);
        const double var_x61 = var_x59 * var_x60;
        const double var_x62 = exp(013632298072467722 * var_chaste_interface__membrane__V);
        ...
        const double var_x72 = -04926108374384236 * var_chaste_interface__membrane__V;
        const double var_x73 = 0.20000000000000001 * exp(0.12315270935960591 + var_x72);
        const double var_x74 = -var_x73;
        const double var_x75 = exp(-016666666666666666 - 0066666666666666671 * var_chaste_interface__membrane__V);
        const double var_x76 = 1 / (0.25 * var_x75 + 0.1027 * exp(-0.20833333333333334 - 083333333333333329 * var_chaste_interface__membrane__V));
        const double var_x77 = 3.802 * var_x76;
        const double var_x78 = 2.0000000000000002e-5 * var_chaste_interface__membrane__V;
        const double var_x79 = -008539999999999999 - var_x78;
        const double var_x80 = 3.802 / (0.1027 * exp(-0.16666666666666666 - 066666666666666666 * var_chaste_interface__membrane__V) + 0.23000000000000001 * var_x75);
        ...
        const double var_x85 = 3.802 / (0.20000000000000001 * var_x75 + 0.1027 * exp(-0.14705882352941177 - 058823529411764705 * var_chaste_interface__membrane__V));
        ...
        const double var_x91 = 1 / (0.39395599999999997 + 0.188495 * exp(-0.42168674698795178 - 060240963855421679 * var_chaste_interface__membrane__V));
        const double var_x92 = 1.0526315789473684e-5 * var_x91;
        const double var_x93 = 1.4e-8 * var_x81;
        const double var_x94 = 001 * var_x91;
        const double var_x95 = 008539999999999999 + var_x78;
        ...
        const double var_x99 = log(5400 * var_x98);
        const double var_x100 = exp(089599999999999999 * var_chaste_interface__membrane__V - 2.300419183419689 * var_x99);
        const double var_x101 = 1.0 + var_x100;
        const double var_x102 = 1.0 * var_chaste_interface__potassium_concentration__Ki + 020408163265306124 * var_chaste_interface__sodium_concentration__Nai;
        const double var_x103 = (2.4715768660405338e-6 * var_chaste_interface__sodium_concentration__Nai + 00012110726643598615 * var_chaste_interface__potassium_concentration__Ki) * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K / pow(var_x102, 2);
        const double var_x104 = 1 / var_chaste_interface__sodium_concentration__Nai;
        const double var_x105 = pow(var_x104, 1.5);
        const double var_x106 = var_x104 * var_x105 / (pow((3.2860264730588296e-7 + var_x105), 2) * (1.0 + 0.1245 * exp(-0038949423064193493 * var_chaste_interface__membrane__V) + 036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-038949423064193495 * var_chaste_interface__membrane__V)));
        const double var_x107 = -022348 * exp(01176 * var_chaste_interface__membrane__V);
        const double var_x108 = 013733 * exp(038198000000000003 * var_chaste_interface__membrane__V);
        const double var_x109 = 6.8899999999999994e-5 * exp(-041779999999999998 * var_chaste_interface__membrane__V);
        const double var_x110 = 0064970000000000002 * exp(-0.16339999999999999 - 032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x111 = 090820999999999999 * exp(0.11695499999999999 + 023390999999999999 * var_chaste_interface__membrane__V);
        const double var_x112 = pow(var_chaste_interface__calcium_concentration__Cass, 3.0);
        const double var_x113 = 012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2.0) * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x114 = -0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4.0);
        const double var_x115 = 0040499999999999998 * var_x112;
        ...
        rJacobian[0][0] = 1.0 - (mDt * (-050000000000000003 * var_x0 - 4.4000000000000004 * var_x2));
        ...
        rJacobian[2][2] = 1.0 - (mDt * (-026000000000000002 + var_x8 - var_x13 - var_x14 - var_x16 - var_x6));
        ...
        rJacobian[3][3] = 1.0 - (mDt * (-0135 + var_x27 + var_x0 * (-026000000000000002 + 026000000000000002 * var_x7)));
        rJacobian[3][4] = 0;
        ...
        rJacobian[4][0] = 0;
        rJacobian[4][1] = 0;
        rJacobian[4][2] = -(mDt * (026000000000000002 - var_x8));
        rJacobian[4][3] = 0;
        rJacobian[4][4] = 1.0 - (mDt * (var_x31 + var_x32 - var_x17));
        rJacobian[4][5] = -(mDt * (00050000000000000001));
        ...
        rJacobian[5][5] = 1.0 - (mDt * (-00050000000000000001 + var_x32 - var_x18));
        rJacobian[5][6] = 0;
        rJacobian[5][7] = 0;
        rJacobian[5][8] = 0;
        rJacobian[5][9] = 0;
        ...
        rJacobian[6][3] = -(mDt * (00050000000000000001));
        rJacobian[6][4] = -(mDt * (var_x28));
        rJacobian[6][5] = 0;
        rJacobian[6][6] = 1.0 - (mDt * (-013000000000000001 + var_x27 + var_x31 - var_x19));
        rJacobian[6][7] = 0;
        rJacobian[6][8] = 0;
        rJacobian[6][9] = 0;
        rJacobian[6][10] = 0;
        ...
        rJacobian[8][6] = 0;
        rJacobian[8][7] = 0;
        rJacobian[8][8] = 1.0 - (mDt * (-019599999999999999 - var_x38));
        rJacobian[8][9] = 0;
        rJacobian[8][10] = 0;
        ...
        rJacobian[9][7] = 0;
        rJacobian[9][8] = 0;
        rJacobian[9][9] = 1.0 - (mDt * (var_x42 * (-050000000000000003 + (-var_x43 - var_x44) * var_chaste_interface__calcium_fluxes__P_RyR) + 00013333333333333334 * (050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 4.5 * var_x46 - 050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR) / (pow(var_x40, 3) * pow((053333333333333337 + var_x41), 2))));
        rJacobian[9][10] = -(mDt * (050000000000000003 * var_x42));
        rJacobian[9][11] = 0;
        ...
        rJacobian[10][7] = 0;
        rJacobian[10][8] = 0;
        rJacobian[10][9] = -(mDt * (0028598665395614866));
        rJacobian[10][10] = 1.0 - (mDt * (-0030741734985700662));
        rJacobian[10][11] = -(mDt * (0002143069590085796 + 11.084842707340323 * var_x53 - 11.084842707340323 * var_x54));
        rJacobian[10][12] = 0;
        rJacobian[10][13] = 0;
        rJacobian[10][14] = 0;
        rJacobian[10][15] = 0;
        ...
        rJacobian[11][8] = -(mDt * (var_x57 * (019599999999999999 + var_x38)));
        rJacobian[11][9] = 0;
        rJacobian[11][10] = -(mDt * (1.7399999999999999e-5 * var_x57));
        rJacobian[11][11] = 1.0 - (mDt * (var_x57 * (-2.7458174 + var_x37 + var_x39 + 0.96151847158279735 * var_x54 - 0045528151523329874 * var_x61 - 0.96151847158279735 * var_x53 - 00014491407891765456 * var_x58) + 0.16806722689075632 * (0.125 * var_chaste_interface__calcium_concentration__Cass + 019599999999999999 * var_chaste_interface__calcium_buffering__LTRPN_Ca + 3.1999999999999999e-5 * var_chaste_interface__calcium_buffering__HTRPN_Ca + 1.7399999999999999e-5 * var_chaste_interface__calcium_concentration__CaNSR + 00014491407891765456 * log(1800 * var_x58) - 0.1250174 * var_chaste_interface__calcium_concentration__Cai - 1.12886395354433e-5 * var_chaste_interface__membrane__V - var_x36 * (140 - var_chaste_interface__calcium_buffering__HTRPN_Ca) - var_x38 * (70 - var_chaste_interface__calcium_buffering__LTRPN_Ca) + 1.6591891954566281e-18 * var_x60 * (1800 * var_x62 * pow(var_chaste_interface__sodium_concentration__Nai, 3) - 2744000000000000 * var_x59 * var_chaste_interface__calcium_concentration__Cai) - 0.48075923579139868 * var_x50 * var_x52) / (pow(var_x55, 3) * pow((084033613445378158 + var_x56), 2))));
        ...
        rJacobian[13][4] = 0;
        rJacobian[13][5] = 0;
        rJacobian[13][6] = -(mDt * ((0.15561 - 00247 * var_chaste_interface__membrane__V) * exp(-038580246913580245 * pow((-1 + 0.20000000000000001 * var_chaste_interface__membrane__V), 2))));
        rJacobian[13][7] = 0;
        rJacobian[13][8] = 0;
        rJacobian[13][9] = 0;
        rJacobian[13][10] = 0;
        rJacobian[13][11] = 0;
        rJacobian[13][12] = 0;
        rJacobian[13][13] = 1.0 - (mDt * (-040000000000000001));
        rJacobian[13][14] = 0;
        rJacobian[13][15] = 0;
        rJacobian[13][16] = 0;
        rJacobian[13][17] = 0;
        ...
        rJacobian[23][20] = 0;
        rJacobian[23][21] = 0;
        rJacobian[23][22] = -(mDt * ((078972250091364882 * var_x99 - 003075923579139864 * var_chaste_interface__membrane__V) * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss));
        rJacobian[23][23] = 1.0 - (mDt * (-1017.2528351768841 * var_x103 - 0090818087605069615 * var_x98 * pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 2) - 0.44667042500874232 * var_x98 / var_x101 - 078972250091364882 * var_x98 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss - 0.642360282243162 * var_x98 * pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 3) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 0.25271120029236765 * var_x98 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur + 040021670080783313 * var_x100 * var_x98 * (-25.674321243523316 * var_x99 + var_chaste_interface__membrane__V) / pow(var_x101, 2)));
        rJacobian[23][24] = 0;
        rJacobian[23][25] = 0;
        rJacobian[23][26] = 0;
        rJacobian[23][27] = -(mDt * (0.12319671014252923 * log(8257.1428571428569 / var_x102) - 0047984407834581883 * var_chaste_interface__membrane__V));
        rJacobian[23][28] = 0;
        rJacobian[23][29] = 0;
        rJacobian[23][30] = 0;
        ...
        rJacobian[24][22] = 0;
        rJacobian[24][23] = 0;
        rJacobian[24][24] = 1.0 - (mDt * (-023761000000000001 + var_x107 - 047002000000000002 * exp(-063100000000000003 * var_chaste_interface__membrane__V)));
        rJacobian[24][25] = -(mDt * (036777999999999998 + var_x107));
        ...
        rJacobian[25][22] = 0;
        rJacobian[25][23] = 0;
        rJacobian[25][24] = -(mDt * (023761000000000001));
        rJacobian[25][25] = 1.0 - (mDt * (-036777999999999998 - var_x108));
        rJacobian[25][26] = 0;
        ...
        rJacobian[28][26] = 0;
        rJacobian[28][27] = 0;
        rJacobian[28][28] = 1.0 - (mDt * (-00080000000000000004));
        rJacobian[28][29] = -(mDt * (0089999999999999993));
        rJacobian[28][30] = 0;
        rJacobian[28][31] = 0;
        rJacobian[29][0] = 0;
        rJacobian[29][1] = 0;
        ...
        rJacobian[29][10] = 0;
        rJacobian[29][11] = 0;
        rJacobian[29][12] = -(mDt * (-var_x113 + 024299999999999999 * var_x112 * (1.0 - var_chaste_interface__ryanodine_receptors__P_C2 - var_chaste_interface__ryanodine_receptors__P_O1 - var_chaste_interface__ryanodine_receptors__P_O2)));
        rJacobian[29][13] = 0;
        rJacobian[29][14] = 0;
        rJacobian[29][15] = 0;
        rJacobian[29][16] = 0;
        ...
        rJacobian[29][26] = 0;
        rJacobian[29][27] = 0;
        rJacobian[29][28] = -(mDt * (00080000000000000004 + var_x114));
        rJacobian[29][29] = 1.0 - (mDt * (-080249999999999988 + var_x114 - var_x115));
        ...
        rJacobian[31][9] = 0;
        rJacobian[31][10] = 0;
        rJacobian[31][11] = -(mDt * (013658445456998961 * var_x61));
        rJacobian[31][12] = 0;
        rJacobian[31][13] = 0;
        rJacobian[31][14] = 0;
        rJacobian[31][15] = 0;
        ...
        rJacobian[31][19] = 0;
        rJacobian[31][20] = 0;
        rJacobian[31][21] = -(mDt * (20.532785023754869 * log(140600 / var_x116) - 0.79974013057636462 * var_chaste_interface__membrane__V));
        rJacobian[31][22] = 0;
    ...
    void Cellbondarenko_model_2004_apexFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_fast_transient_outward_potassium_current__alpha_a = 0.18064 * exp(1.0731000000000002 + 035770000000000003 * var_chaste_interface__membrane__V);
        const double var_fast_transient_outward_potassium_current__alpha_i = 00015200000000000001 * exp(-1.9285714285714286 - 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + 0067083000000000004 * exp(-4.7857142857142856 - 0.14285714285714285 * var_chaste_interface__membrane__V));
        const double var_fast_transient_outward_potassium_current__beta_a = 0.39560000000000001 * exp(-1.8711 - 062370000000000002 * var_chaste_interface__membrane__V);
        const double var_fast_transient_outward_potassium_current__beta_i = 00095 * exp(4.7857142857142856 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + 051334999999999999 * exp(4.7857142857142856 + 0.14285714285714285 * var_chaste_interface__membrane__V));
        const double var_non_inactivating_steady_state_potassium_current__tau_Kss = 13.17 + 39.299999999999997 * exp(-086199999999999999 * var_chaste_interface__membrane__V);
        ...
        const double var_slow_delayed_rectifier_potassium_current__beta_n = 9.5333299999999997e-5 * exp(-1.0069999999999999 - 037999999999999999 * var_chaste_interface__membrane__V);
        ...
        const double var_slow_transient_outward_potassium_current__tau_ta_s = 2.0579999999999998 + 0.49299999999999999 * exp(-062899999999999998 * var_chaste_interface__membrane__V);
        const double var_slow_transient_outward_potassium_current__tau_ti_s = 270 + 1050 / (1.0 + exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V));
        const double var_ultra_rapidly_activating_delayed_rectifier_potassium_current__tau_aur = 2.0579999999999998 + 0.49299999999999999 * exp(-062899999999999998 * var_chaste_interface__membrane__V);
        const double var_ultra_rapidly_activating_delayed_rectifier_potassium_current__tau_iur = 1200 - 170 / (1.0 + exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V));
