...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellbondarenko_model_2004_apexFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rJacobian[32][32])
    {
        ...
        const double var_x115 = (7.1123755334281649e-6 * var_chaste_interface__sodium_concentration__Nai + 7.9026394815868502e-7 * var_chaste_interface__potassium_concentration__Ki) / pow((0.11111111111111112 * var_chaste_interface__potassium_concentration__Ki + var_chaste_interface__sodium_concentration__Nai), 2);
        const double var_x116 = var_x115 * var_chaste_interface__fast_sodium_current__O_Na;
        ...
        rJacobian[31][19] = 0.0;
        rJacobian[31][20] = 0.0;
        rJacobian[31][21] = -(mDt * (20.532785023754869 * log(126540.0 / (0.10000000000000001 * var_chaste_interface__potassium_concentration__Ki + 0.90000000000000002 * var_chaste_interface__sodium_concentration__Nai)) - 0.79974013057636462 * var_chaste_interface__membrane__V));
        rJacobian[31][22] = 0.0;
        rJacobian[31][23] = -(mDt * (-64.153546096442994 * var_x115 - 320767.730482215 * var_x116));
        rJacobian[31][24] = 0.0;
        rJacobian[31][25] = 0.0;
        rJacobian[31][26] = 0.0;
        rJacobian[31][27] = 0.0;
        ...
        rJacobian[31][29] = 0.0;
        rJacobian[31][30] = 0.0;
        rJacobian[31][31] = 1.0 - (mDt * (-6.2649332746797061e-8 * var_x105 - 577.38191486798689 * var_x115 - 2886909.5743399346 * var_x116 - 2.6878864966397372e-14 * var_x63));
    }
