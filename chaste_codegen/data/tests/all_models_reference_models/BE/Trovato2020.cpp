...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellTrovato2020FromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    double CellTrovato2020FromCellMLBackwardEulerNoLut::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    CellTrovato2020FromCellMLBackwardEulerNoLut::CellTrovato2020FromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<CellTrovato2020FromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    CellTrovato2020FromCellMLBackwardEulerNoLut::~CellTrovato2020FromCellMLBackwardEulerNoLut()
    {
    }

    
    double CellTrovato2020FromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void CellTrovato2020FromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[17], double rResidual[17])
    {
    ...
    void CellTrovato2020FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[17], double rJacobian[17][17])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -86.6814002878592
        ...
        const double var_x86 = 0.00050000000000000001 / var_x81;
        const double var_x87 = var_chaste_interface__membrane__v / (mParameters[4] * mParameters[14]);
        const double var_x88 = var_x87 * mParameters[3];
        const double var_x89 = exp(0.52239999999999998 * var_x88);
        const double var_x90 = 1 / var_x89;
        const double var_x91 = 1 / (1.0 + 0.011348161597821153 * (1.0 + var_x90) * mParameters[2]);
        const double var_x92 = var_x90 * var_x91;
        const double var_x93 = var_x92 * mParameters[2];
        const double var_x94 = 56.740807989105761 * var_x93;
        const double var_x95 = var_x94 + 60000.0 * var_x91;
        const double var_x96 = 1 / (13.5 + 0.066666666666666666 * (1.0 + 0.20000000000000001 * mParameters[2]) * mParameters[2]);
        const double var_x97 = var_x96 * mParameters[0];
        const double var_x98 = 1500000.0 * var_x97;
        const double var_x99 = pow(mParameters[2], 3);
        const double var_x100 = var_x96 * var_x99;
        const double var_x101 = var_x100 * var_x92;
        const double var_x102 = var_x98 + 9.0785292782569211 * var_x101;
        const double var_x103 = var_x102 * var_x95;
        const double var_x104 = 0.00036716666666666668 * var_x103;
        const double var_x105 = 1.0 + 0.066666666666666666 * (1.0 + 0.20000000000000001 * var_chaste_interface__intracellular_ions__nasl) * var_chaste_interface__intracellular_ions__nasl;
        const double var_x106 = 1 / var_x105;
        const double var_x107 = 1500000.0 * var_x106;
        const double var_x108 = var_x107 * var_chaste_interface__intracellular_ions__casl;
        const double var_x109 = pow(var_chaste_interface__intracellular_ions__nasl, 3);
        const double var_x110 = 0.011348161597821153 + 0.011348161597821153 * var_x89;
        const double var_x111 = 1.0 + var_x110 * var_chaste_interface__intracellular_ions__nasl;
        const double var_x112 = 1 / var_x111;
        const double var_x113 = var_x112 * var_x89;
        const double var_x114 = var_x106 * var_x113;
        const double var_x115 = var_x109 * var_x114;
        const double var_x116 = var_x108 + 9.0785292782569211 * var_x115;
        const double var_x117 = 1 / exp(0.16700000000000001 * var_x88);
        const double var_x118 = var_x112 * var_x117;
        const double var_x119 = 56.740807989105761 * var_x113;
        const double var_x120 = var_x119 * var_chaste_interface__intracellular_ions__nasl;
        const double var_x121 = var_x120 + 60000.0 * var_x118;
        const double var_x122 = var_x116 * var_x121;
        const double var_x123 = var_x102 * var_x121;
        const double var_x124 = var_x106 * var_x123;
        const double var_x125 = var_x95 * var_x97;
        const double var_x126 = 0.11015000000000001 * var_x125;
        const double var_x127 = 5000.0 + var_x121;
        const double var_x128 = var_x101 * var_x127;
        const double var_x129 = 5000.0 + var_x95;
        const double var_x130 = var_x115 * var_x129;
        const double var_x131 = var_x101 * var_x129;
        const double var_x132 = var_x106 * var_x131;
        const double var_x133 = var_x132 * var_chaste_interface__intracellular_ions__casl;
        const double var_x134 = var_x127 * var_x97;
        const double var_x135 = var_x115 * var_x134;
        const double var_x136 = pow((var_x104 + var_x133 + var_x135 + 0.0033333333333333331 * var_x128 + 0.0033333333333333331 * var_x130 + 0.00036716666666666668 * var_x122 + var_x116 * var_x126 + 0.11015000000000001 * var_x124 * var_chaste_interface__intracellular_ions__casl), (-2));
        const double var_x137 = 283704.03994552878 * var_x113;
        const double var_x138 = 300000000.0 * var_x118 + var_x137 * var_chaste_interface__intracellular_ions__nasl;
        const double var_x139 = 2250000000000.0 * var_x125;
        const double var_x140 = var_x106 * var_x139;
        const double var_x141 = 13617793.917385383 * var_x132;
        const double var_x142 = var_x136 * (-var_x140 - var_x141 - var_x107 * var_x123 - var_x107 * var_x138);
        const double var_x143 = 13617793.917385383 * var_x135 + var_x108 * var_x123;
        const double var_x144 = 5.3924544444444452e-11 * var_x143;
        const double var_x145 = 5000.0 * var_x122 + 45392.646391284608 * var_x130;
        const double var_x146 = var_x95 * var_x98;
        const double var_x147 = 13617793.917385383 * var_x133 + var_x116 * var_x146;
        const double var_x148 = 5000.0 * var_x103;
        const double var_x149 = var_x148 + 45392.646391284608 * var_x128;
        const double var_x150 = 1 / (var_x143 + var_x145 + var_x147 + var_x149);
        const double var_x151 = var_x124 * var_x150;
        const double var_x152 = var_x120 * var_x150;
        const double var_x153 = 4500000000000.0 * var_x97;
        const double var_x154 = var_x106 * var_x150;
        const double var_x155 = var_x138 * var_x154;
        const double var_x156 = 1.6177363333333335e-8 * var_x97;
        const double var_x157 = var_x142 * var_x145;
        const double var_x158 = 3.0597222222222222e-13 * var_x142;
        const double var_x159 = var_x113 * var_x147 * var_chaste_interface__intracellular_ions__nasl;
        const double var_x160 = var_x143 * var_x93;
        const double var_x161 = 1.4686666666666667e-13 * var_x115 * var_x149;
        const double var_x162 = 40853381.752156146 * var_x101;
        const double var_x163 = 85111211.983658642 * var_x93;
        const double var_x164 = 1.4686666666666667e-13 * var_x101;
        const double var_x165 = 15000000000.0 * var_x151 + var_x142 * var_x144 + var_x142 * var_x161 + var_x152 * (var_x140 + var_x141) + var_x158 * var_x159 - var_x151 * var_x163 - var_x153 * var_x155 - var_x155 * var_x162 - var_x156 * var_x157 - var_x157 * var_x164 - var_x158 * var_x160;
        const double var_x166 = 1.0 + 2.2499999999999996e-8 * var_x75;
        const double var_x167 = 1 / var_x166;
        const double var_x168 = 0.001531344 * var_x167;
        const double var_x169 = 10000.0 * var_x150;
        const double var_x170 = 3000000.0 * var_x97;
        const double var_x171 = var_x145 * var_x150;
        const double var_x172 = var_x147 * var_x150;
        const double var_x173 = var_x150 * var_x94;
        const double var_x174 = var_x149 * var_x150;
        const double var_x175 = 27.235587834770765 * var_x174;
        const double var_x176 = 27.235587834770765 * var_x101;
        const double var_x177 = var_x115 * var_x175 + var_x120 * var_x172 + var_x143 * var_x169 - var_x143 * var_x173 - var_x170 * var_x171 - var_x171 * var_x176;
        const double var_x178 = var_x177 / (pow(var_x166, 2) * pow(var_chaste_interface__intracellular_ions__casl, 3));
        const double var_x179 = exp(2.0 * var_x88);
        const double var_x180 = var_x87 * pow(mParameters[3], 2);
        const double var_x181 = var_x180 / (-1.0 + var_x179);
        const double var_x182 = 9.9999999999999995e-8 * var_x181;
        const double var_x183 = var_chaste_interface__ICaT__b * var_chaste_interface__ICaT__g;
        const double var_x184 = 1 / mParameters[3];
        const double var_x185 = var_x184 * mParameters[4] * mParameters[14];
        const double var_x186 = 8.4320557491289208 * var_x184;
        const double var_x187 = -0.34100000000000003 * mParameters[0];
        const double var_x188 = pow(var_x111, (-2));
        const double var_x189 = -0.011348161597821153 - 0.011348161597821153 * var_x89;
        const double var_x190 = var_x117 * var_x189;
        const double var_x191 = var_x188 * var_x190;
        const double var_x192 = var_x189 * var_x89;
        const double var_x193 = 56.740807989105761 * var_x192;
        const double var_x194 = var_x188 * var_chaste_interface__intracellular_ions__nasl;
        const double var_x195 = var_x193 * var_x194;
        const double var_x196 = var_x119 + var_x195 + 60000.0 * var_x191;
        const double var_x197 = var_x102 * var_x108 * var_x196;
        const double var_x198 = (-0.066666666666666666 - 0.026666666666666668 * var_chaste_interface__intracellular_ions__nasl) / pow(var_x105, 2);
        const double var_x199 = var_x198 * var_chaste_interface__intracellular_ions__casl;
        const double var_x200 = 1500000.0 * var_x199;
        const double var_x201 = var_x123 * var_x200;
        const double var_x202 = pow(var_chaste_interface__intracellular_ions__nasl, 2);
        const double var_x203 = var_x114 * var_x202;
        const double var_x204 = 40853381.752156146 * var_x134 * var_x203;
        const double var_x205 = 13617793.917385383 * var_x97;
        const double var_x206 = var_x115 * var_x196 * var_x205;
        const double var_x207 = var_x113 * var_x198;
        const double var_x208 = var_x109 * var_x207;
        const double var_x209 = 13617793.917385383 * var_x134;
        const double var_x210 = var_x208 * var_x209;
        const double var_x211 = var_x188 * var_x192;
        const double var_x212 = var_x106 * var_x211;
        const double var_x213 = var_x109 * var_x212;
        const double var_x214 = var_x209 * var_x213;
        const double var_x215 = var_x197 + var_x201 + var_x204 + var_x206 + var_x210 + var_x214;
        const double var_x216 = 283704.03994552878 * var_x192;
        const double var_x217 = var_x116 * (var_x137 + 300000000.0 * var_x191 + var_x194 * var_x216);
        const double var_x218 = 9.0785292782569211 * var_x109;
        const double var_x219 = var_x200 + 27.235587834770765 * var_x203 + var_x207 * var_x218 + var_x212 * var_x218;
        const double var_x220 = var_x138 * var_x219;
        const double var_x221 = var_x146 * var_x219;
        const double var_x222 = 136177.93917385384 * var_x129;
        const double var_x223 = var_x203 * var_x222;
        const double var_x224 = 45392.646391284608 * var_x101;
        const double var_x225 = 45392.646391284608 * var_x129;
        const double var_x226 = var_x208 * var_x225;
        const double var_x227 = var_x213 * var_x225;
        const double var_x228 = 13617793.917385383 * var_x131;
        const double var_x229 = var_x199 * var_x228;
        const double var_x230 = var_x136 * (-var_x197 - var_x201 - var_x204 - var_x206 - var_x210 - var_x214 - var_x217 - var_x220 - var_x221 - var_x223 - var_x226 - var_x227 - var_x229 - var_x196 * var_x224);
        const double var_x231 = var_x150 * (var_x217 + var_x220 + var_x223 + var_x226 + var_x227);
        const double var_x232 = var_x145 * var_x230;
        const double var_x233 = 3.0597222222222222e-13 * var_x230;
        const double var_x234 = var_x109 * var_x154;
        const double var_x235 = 1236295.4078425223 * var_x100 * var_x91;
        const double var_x236 = var_x119 * var_x172 + var_x144 * var_x230 + var_x152 * (var_x221 + var_x229) + var_x159 * var_x233 + var_x161 * var_x230 + var_x169 * var_x215 + var_x172 * var_x195 + var_x175 * var_x208 - var_x156 * var_x232 - var_x160 * var_x233 - var_x164 * var_x232 - var_x170 * var_x231 - var_x173 * var_x215 - var_x176 * var_x231 + 81.706763504312292 * var_x174 * var_x203 + 27.235587834770765 * var_x149 * var_x211 * var_x234 + var_x112 * var_x196 * var_x234 * var_x235;
        const double var_x237 = 1.0 - var_chaste_interface__ICaL__nca;
        const double var_x238 = 0.40000000000000002 * var_chaste_interface__ICaL__fs;
        const double var_x239 = 0.59999999999999998 * var_chaste_interface__ICaL__ffp;
        const double var_x240 = 0.59999999999999998 / (1.0 + exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__v));
        const double var_x241 = 0.29999999999999999 + var_x240;
        const double var_x242 = (0.69999999999999996 - var_x240) * var_chaste_interface__ICaL__fcas;
        const double var_x243 = (var_x242 + var_x241 * var_chaste_interface__ICaL__fcafp) * var_chaste_interface__ICaL__jca;
        const double var_x244 = var_x237 * (var_x238 + var_x239) + var_x243 * var_chaste_interface__ICaL__nca;
        const double var_x245 = mParameters[5] * var_chaste_interface__ICaL__d;
        const double var_x246 = var_x181 * var_x245;
        const double var_x247 = var_x246 * (var_x187 + var_x179 * var_chaste_interface__intracellular_ions__cass);
        const double var_x248 = 1.0 + 0.14999999999999999 / var_x5;
        const double var_x249 = 1 / (pow(var_x248, 2) * pow(var_x5, 2));
        const double var_x250 = var_x20 * var_x249;
        const double var_x251 = var_x247 * var_x250;
        const double var_x252 = 0.66000000000000003 * var_x244 * var_x251;
        const double var_x253 = 0.59999999999999998 * var_chaste_interface__ICaL__ff;
        const double var_x254 = (var_x242 + var_x241 * var_chaste_interface__ICaL__fcaf) * var_chaste_interface__ICaL__jca;
        const double var_x255 = var_x237 * (var_x238 + var_x253) + var_x254 * var_chaste_interface__ICaL__nca;
        const double var_x256 = 0.59999999999999998 * var_x251 * var_x255;
        const double var_x257 = 0.0086999999999999994 + var_chaste_interface__intracellular_ions__cass;
        const double var_x258 = 0.00087000000000000001 + var_chaste_interface__intracellular_ions__cass;
        const double var_x259 = 1.0 + 0.00415599 / pow(var_x257, 2) + 1.7378249999999999e-5 / pow(var_x258, 2);
        const double var_x260 = 1 / var_x259;
        const double var_x261 = 63.240418118466899 * var_x184;
        const double var_x262 = var_x260 * var_x261;
        const double var_x263 = 1 / var_x248;
        const double var_x264 = var_x263;
        const double var_x265 = 1.0 - var_x264;
        const double var_x266 = -var_x238;
        const double var_x267 = var_x265 * (var_x254 + var_x266 - var_x253);
        const double var_x268 = 4.0 * var_x247;
        const double var_x269 = var_x267 * var_x268;
        const double var_x270 = var_x243 + var_x266 - var_x239;
        const double var_x271 = 4.4000000000000004 * var_x263;
        const double var_x272 = var_x247 * var_x271;
        const double var_x273 = var_x270 * var_x272;
        const double var_x274 = 0.00020202000000000002 * var_x59;
        const double var_x275 = var_x274 * var_chaste_interface__intracellular_ions__cass;
        const double var_x276 = 1.0 + 0.066666666666666666 * (1.0 + 0.20000000000000001 * var_chaste_interface__intracellular_ions__nass) * var_chaste_interface__intracellular_ions__nass;
        const double var_x277 = 1 / var_x276;
        const double var_x278 = 1500000.0 * var_x277;
        const double var_x279 = var_x278 * var_chaste_interface__intracellular_ions__cass;
        const double var_x280 = pow(var_chaste_interface__intracellular_ions__nass, 3);
        const double var_x281 = 1.0 + var_x110 * var_chaste_interface__intracellular_ions__nass;
        const double var_x282 = 1 / var_x281;
        const double var_x283 = var_x282 * var_x89;
        const double var_x284 = var_x277 * var_x283;
        const double var_x285 = var_x280 * var_x284;
        const double var_x286 = var_x279 + 9.0785292782569211 * var_x285;
        const double var_x287 = var_x117 * var_x282;
        const double var_x288 = 56.740807989105761 * var_x283;
        const double var_x289 = var_x288 * var_chaste_interface__intracellular_ions__nass;
        const double var_x290 = var_x289 + 60000.0 * var_x287;
        const double var_x291 = var_x286 * var_x290;
        const double var_x292 = var_x102 * var_x290;
        const double var_x293 = var_x277 * var_x292;
        const double var_x294 = 5000.0 + var_x290;
        const double var_x295 = var_x129 * var_x285;
        const double var_x296 = var_x131 * var_x277;
        const double var_x297 = var_x296 * var_chaste_interface__intracellular_ions__cass;
        const double var_x298 = var_x294 * var_x97;
        const double var_x299 = var_x285 * var_x298;
        const double var_x300 = pow((var_x104 + var_x297 + var_x299 + 0.0033333333333333331 * var_x295 + 0.00036716666666666668 * var_x291 + var_x126 * var_x286 + 0.0033333333333333331 * var_x101 * var_x294 + 0.11015000000000001 * var_x293 * var_chaste_interface__intracellular_ions__cass), (-2));
        const double var_x301 = 283704.03994552878 * var_x283;
        const double var_x302 = 300000000.0 * var_x287 + var_x301 * var_chaste_interface__intracellular_ions__nass;
        const double var_x303 = var_x139 * var_x277;
        const double var_x304 = 13617793.917385383 * var_x296;
        const double var_x305 = var_x300 * (-var_x303 - var_x304 - var_x278 * var_x292 - var_x278 * var_x302);
        const double var_x306 = 13617793.917385383 * var_x299 + var_x279 * var_x292;
        const double var_x307 = 5.3924544444444452e-11 * var_x306;
        const double var_x308 = 5000.0 * var_x291 + 45392.646391284608 * var_x295;
        const double var_x309 = 13617793.917385383 * var_x297 + var_x146 * var_x286;
        const double var_x310 = var_x148 + var_x224 * var_x294;
        const double var_x311 = 1 / (var_x306 + var_x308 + var_x309 + var_x310);
        const double var_x312 = var_x293 * var_x311;
        const double var_x313 = var_x289 * var_x311;
        const double var_x314 = var_x277 * var_x311;
        const double var_x315 = var_x302 * var_x314;
        const double var_x316 = var_x156 * var_x308;
        const double var_x317 = 3.0597222222222222e-13 * var_x305;
        const double var_x318 = var_x283 * var_x309 * var_chaste_interface__intracellular_ions__nass;
        const double var_x319 = var_x306 * var_x93;
        const double var_x320 = 1.4686666666666667e-13 * var_x285 * var_x310;
        const double var_x321 = var_x164 * var_x308;
        const double var_x322 = 15000000000.0 * var_x312 + var_x305 * var_x307 + var_x305 * var_x320 + var_x313 * (var_x303 + var_x304) + var_x317 * var_x318 - var_x153 * var_x315 - var_x162 * var_x315 - var_x163 * var_x312 - var_x305 * var_x316 - var_x305 * var_x321 - var_x317 * var_x319;
        const double var_x323 = 1.0 + 2.2499999999999996e-8 * var_x8;
        const double var_x324 = 1 / var_x323;
        const double var_x325 = 0.00038283600000000001 * var_x324;
        const double var_x326 = 10000.0 * var_x311;
        const double var_x327 = var_x170 * var_x311;
        const double var_x328 = var_x309 * var_x311;
        const double var_x329 = var_x311 * var_x94;
        const double var_x330 = var_x310 * var_x311;
        const double var_x331 = 27.235587834770765 * var_x330;
        const double var_x332 = var_x176 * var_x311;
        const double var_x333 = var_x285 * var_x331 + var_x289 * var_x328 + var_x306 * var_x326 - var_x306 * var_x329 - var_x308 * var_x327 - var_x308 * var_x332;
        const double var_x334 = var_x333 / (pow(var_x323, 2) * pow(var_chaste_interface__intracellular_ions__cass, 3));
        const double var_x335 = var_x179 * var_x246;
        const double var_x336 = var_x255 * var_x265;
        const double var_x337 = 4.0 * var_x335 * var_x336;
        const double var_x338 = var_x244 * var_x271 * var_x335;
        const double var_x339 = var_x249 * var_x9;
        const double var_x340 = var_x247 * var_x339;
        const double var_x341 = 4.5000000000000003e-5 * var_x255 * var_x340;
        const double var_x342 = 4.9500000000000004e-5 * var_x244 * var_x340;
        const double var_x343 = var_x274 * var_x55;
        const double var_x344 = -5.0 + var_x343 - var_x275 - 2.22222e-8 * var_x64;
        const double var_x345 = var_x268 * var_x336;
        const double var_x346 = var_x244 * var_x272;
        const double var_x347 = 5.0 * var_chaste_interface__intracellular_ions__casl + 0.10000000000000001 * var_chaste_interface__ryr__Jrel1 - 5.0 * var_chaste_interface__intracellular_ions__cass + var_x343 * var_chaste_interface__intracellular_ions__cass;
        const double var_x348 = pow(var_x281, (-2));
        const double var_x349 = var_x190 * var_x348;
        const double var_x350 = var_x348 * var_chaste_interface__intracellular_ions__nass;
        const double var_x351 = var_x193 * var_x350;
        const double var_x352 = var_x288 + var_x351 + 60000.0 * var_x349;
        const double var_x353 = var_x102 * var_x279 * var_x352;
        const double var_x354 = (-0.066666666666666666 - 0.026666666666666668 * var_chaste_interface__intracellular_ions__nass) / pow(var_x276, 2);
        const double var_x355 = var_x354 * var_chaste_interface__intracellular_ions__cass;
        const double var_x356 = 1500000.0 * var_x355;
        const double var_x357 = var_x292 * var_x356;
        const double var_x358 = var_x284 * pow(var_chaste_interface__intracellular_ions__nass, 2);
        const double var_x359 = 40853381.752156146 * var_x298 * var_x358;
        const double var_x360 = var_x205 * var_x285 * var_x352;
        const double var_x361 = var_x283 * var_x354;
        const double var_x362 = var_x280 * var_x361;
        const double var_x363 = 13617793.917385383 * var_x298;
        const double var_x364 = var_x362 * var_x363;
        const double var_x365 = var_x192 * var_x348;
        const double var_x366 = var_x277 * var_x365;
        const double var_x367 = var_x280 * var_x363 * var_x366;
        const double var_x368 = var_x353 + var_x357 + var_x359 + var_x360 + var_x364 + var_x367;
        const double var_x369 = var_x286 * (var_x301 + 300000000.0 * var_x349 + var_x216 * var_x350);
        const double var_x370 = 9.0785292782569211 * var_x280;
        const double var_x371 = var_x356 + 27.235587834770765 * var_x358 + var_x361 * var_x370 + var_x366 * var_x370;
        const double var_x372 = var_x302 * var_x371;
        const double var_x373 = var_x146 * var_x371;
        const double var_x374 = var_x222 * var_x358;
        const double var_x375 = var_x225 * var_x280;
        const double var_x376 = var_x361 * var_x375;
        const double var_x377 = var_x366 * var_x375;
        const double var_x378 = var_x228 * var_x355;
        const double var_x379 = var_x300 * (-var_x353 - var_x357 - var_x359 - var_x360 - var_x364 - var_x367 - var_x369 - var_x372 - var_x373 - var_x374 - var_x376 - var_x377 - var_x378 - var_x224 * var_x352);
        const double var_x380 = var_x369 + var_x372 + var_x374 + var_x376 + var_x377;
        const double var_x381 = 3.0597222222222222e-13 * var_x379;
        const double var_x382 = var_x280 * var_x314;
        const double var_x383 = var_x288 * var_x328 + var_x307 * var_x379 + var_x313 * (var_x373 + var_x378) + var_x318 * var_x381 + var_x320 * var_x379 + var_x326 * var_x368 + var_x328 * var_x351 + var_x331 * var_x362 - var_x316 * var_x379 - var_x319 * var_x381 - var_x321 * var_x379 - var_x327 * var_x380 - var_x329 * var_x368 - var_x332 * var_x380 + 81.706763504312292 * var_x330 * var_x358 + 27.235587834770765 * var_x310 * var_x365 * var_x382 + var_x235 * var_x282 * var_x352 * var_x382;
        const double var_x384 = pow(var_x66, 1.3999999999999999);
        const double var_x385 = 1.0 + 6.4818210260626455e-7 * var_x384;
        const double var_x386 = 1 / (0.018329999999999999 * var_chaste_interface__intracellular_ions__nasl + var_chaste_interface__intracellular_ions__ksl);
        const double var_x387 = mParameters[12] * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2;
        const double var_x388 = exp(0.38500000000000001 * var_x88);
        const double var_x389 = 1 / (-1.0 + pow((1.0 + 0.035997120230381568 * mParameters[2] / var_x388), 3) + 7.7937924625297832 * pow((0.35820000000000002 + mParameters[1]), 2));
        const double var_x390 = var_x389 * pow(mParameters[1], 2);
        const double var_x391 = pow((0.5 + var_chaste_interface__intracellular_ions__ksl), 2);
        const double var_x392 = exp(-0.051666666666666666 * var_x88);
        const double var_x393 = 1 / var_x392;
        const double var_x394 = 1.0 + 0.11021712774165104 * var_x393 * var_chaste_interface__intracellular_ions__nasl;
        const double var_x395 = pow(var_x394, 3);
        const double var_x396 = pow((-0.25 + var_x391 + 0.25 * var_x395), (-2));
        const double var_x397 = var_x396 * (-4.0 - 8.0 * var_chaste_interface__intracellular_ions__ksl);
        const double var_x398 = pow(var_x392, (-3));
        const double var_x399 = var_x109 * var_x398;
        const double var_x400 = var_x397 * var_x399;
        const double var_x401 = var_x390 * var_x400;
        const double var_x402 = var_x389 * var_x99 / pow(var_x388, 3);
        const double var_x403 = 0.09330879953375748 * var_x400 * var_x402;
        const double var_x404 = pow((1 + 0.0028096208831939005 * var_chaste_interface__intracellular_ions__nasl + 0.0021553256090254577 * var_chaste_interface__intracellular_ions__ksl), (-2));
        const double var_x405 = 1 / (-1.0 + var_x395 + 4.0 * var_x391);
        const double var_x406 = var_x398 * var_x405;
        const double var_x407 = var_x109 * var_x406;
        const double var_x408 = var_x404 * var_x407;
        const double var_x409 = var_x402 * var_x408;
        const double var_x410 = 1.8288767722361083e-15 * var_x409;
        const double var_x411 = 1 / (1.5889281507656066 + 0.0034246575342465752 * var_chaste_interface__intracellular_ions__ksl + 0.004464285714285714 * var_chaste_interface__intracellular_ions__nasl);
        const double var_x412 = var_x402 * var_x411;
        const double var_x413 = 8.4266669949965062e-14 * var_x400 * var_x412;
        const double var_x414 = var_x405 * var_chaste_interface__intracellular_ions__ksl;
        const double var_x415 = var_x411 * var_x414;
        const double var_x416 = 3.3937789869608994e-10 * var_x402;
        const double var_x417 = pow(var_chaste_interface__intracellular_ions__ksl, 2);
        const double var_x418 = var_x405 * var_x417;
        const double var_x419 = var_x404 * var_x418;
        const double var_x420 = var_x402 * var_x419;
        const double var_x421 = var_x397 * var_x417;
        const double var_x422 = var_x412 * var_x421;
        const double var_x423 = 1.0605559334252811e-11 * var_x422 - 2.3017714043409702e-13 * var_x420 + var_x415 * var_x416;
        const double var_x424 = var_x403 + var_x413 + var_x423 - var_x410 + 751444.4931407267 * var_x401;
        const double var_x425 = var_x390 * var_x407;
        const double var_x426 = var_x411 * var_x418;
        const double var_x427 = var_x390 * var_x418;
        const double var_x428 = var_x402 * var_x418;
        const double var_x429 = 2.6817254812739919 * var_x428 + 1648931648.7518551 * var_x427;
        const double var_x430 = 6585420658.1002293 * var_x390 + 9.6722701128385645e-12 * var_x412 + 10.71014095526842 * var_x402;
        const double var_x431 = var_x402 * var_x407;
        const double var_x432 = var_x407 * var_x411;
        const double var_x433 = var_x402 * var_x432;
        const double var_x434 = 1.348266719199441e-12 * var_x433 + 1.4929407925401197 * var_x431;
        const double var_x435 = 6.3450816326903207e-5 * var_x426 + 5.041496472709802e-7 * var_x432 + 558246.7943749798 * var_x407;
        const double var_x436 = 1 / (var_x429 + var_x430 + var_x434 + var_x435 + 24953131.661984976 * var_x425 + var_x416 * var_x426);
        const double var_x437 = 1185.1330560000001 * var_x436;
        const double var_x438 = 8.6068818956382799e-8 * var_x419;
        const double var_x439 = 0.00012690163265380641 * var_x415;
        const double var_x440 = 6.8386140998302939e-10 * var_x408;
        const double var_x441 = var_x402 * var_x404;
        const double var_x442 = var_x397 * var_x411;
        const double var_x443 = 3.9656760204314505e-6 * var_x417 * var_x442;
        const double var_x444 = 34890.424648436237 * var_x400;
        const double var_x445 = 3297863297.5037103 * var_x390 * var_x414;
        const double var_x446 = 3.1509352954436263e-8 * var_x399 * var_x442;
        const double var_x447 = 5.3634509625479838 * var_x402 * var_x414;
        const double var_x448 = 103058228.04699095 * var_x390 * var_x421;
        const double var_x449 = 0.16760784257962449 * var_x402 * var_x421;
        const double var_x450 = var_x410 + var_x438 + var_x440 - var_x403 - var_x413 - var_x439 - var_x443 - var_x444 - var_x445 - var_x446 - var_x447 - var_x448 - var_x449 + 4.6035428086819405e-13 * var_x420 + 1.3120097004743531e-14 * var_x441 - 2.1211118668505621e-11 * var_x422 - 1559570.728874061 * var_x401 - 6.7875579739217989e-10 * var_x402 * var_x415;
        const double var_x451 = var_x402 * var_x426;
        const double var_x452 = pow((var_x390 + 0.25039124064514068 * var_x427 + 7.6555420442407695e-17 * var_x432 + 8.4770104046173956e-5 * var_x407 + 2.0473509426327076e-22 * var_x433 + 0.0037891477184972245 * var_x425 + 9.6350437764149725e-15 * var_x426 + 4.0722159152815902e-10 * var_x428 + 1.4687399051632995e-21 * var_x412 + 1.6263412029867345e-9 * var_x402 + 5.1534733514501733e-20 * var_x451 + 2.2670393738686469e-10 * var_x431), (-2));
        const double var_x453 = 1.6968894934804497e-10 * var_x451;
        const double var_x454 = var_x452 * (var_x434 + var_x453 + 12023111.890251627 * var_x425);
        const double var_x455 = 2.7327510406137971e-17 * var_x454;
        const double var_x456 = var_x429 + 12930019.771733347 * var_x425;
        const double var_x457 = var_x404 * var_x436;
        const double var_x458 = var_x456 * var_x457;
        const double var_x459 = var_x445 + var_x447 + var_x448 + var_x449 + 808126.23573333421 * var_x401;
        const double var_x460 = var_x411 * var_x436;
        const double var_x461 = 1.1248577707592603e-7 * var_x460;
        const double var_x462 = var_x423 + var_x439 + var_x443 + var_x444 + var_x446 - var_x438 - var_x440;
        const double var_x463 = var_x390 * var_x436;
        const double var_x464 = 2884943.6462042201 * var_x463;
        const double var_x465 = var_x450 * var_x452;
        const double var_x466 = var_x411 * var_x456;
        const double var_x467 = 2.5937646646697565e-27 * var_x466;
        const double var_x468 = var_x390 * (var_x435 + var_x453);
        const double var_x469 = 6.6522764776183441e-14 * var_x468;
        const double var_x470 = var_x185 / var_chaste_interface__intracellular_ions__ksl;
        const double var_x471 = pow(var_chaste_interface__If__y, 2);
        const double var_x472 = var_x430 * var_x436;
        const double var_x473 = var_x400 * var_x472;
        const double var_x474 = var_x407 * var_x430;
        const double var_x475 = 3.8093200840479037e-18 * var_x474;
        const double var_x476 = var_x185 * var_x386 * var_x387 * (-1.0 - 0.59999999999999998 / var_x385);
        const double var_x477 = var_x431 * var_x457;
        const double var_x478 = var_x470 * sqrt(mParameters[1]);
        const double var_x479 = 1 / (1.0 + exp(1.4344412457471867 + 0.026171159382360639 * var_chaste_interface__membrane__v));
        const double var_x480 = 16.864111498257842 * var_x184;
        const double var_x481 = var_x202 * var_x406;
        const double var_x482 = var_x390 * var_x481;
        const double var_x483 = 4.4788223776203591 * var_x402 * var_x481;
        const double var_x484 = var_x396 * pow(var_x394, 2);
        const double var_x485 = var_x109 * var_x484 / pow(var_x392, 4);
        const double var_x486 = var_x390 * var_x485;
        const double var_x487 = 4.0448001575983228e-12 * var_x412 * var_x481;
        const double var_x488 = 2.3840715066649271e-15 * var_x409;
        const double var_x489 = 0.030852683632896775 * var_x402 * var_x485;
        const double var_x490 = 2.786289097871654e-14 * var_x412 * var_x485;
        const double var_x491 = var_x393 * var_x417 * var_x484;
        const double var_x492 = var_x412 * var_x491;
        const double var_x493 = -3.0005234378016216e-13 * var_x420 - 3.5067428637450051e-12 * var_x492;
        const double var_x494 = var_x483 + var_x487 + var_x493 - var_x488 - var_x489 - var_x490 + 36069335.67075488 * var_x482 - 248466.16107375509 * var_x486;
        const double var_x495 = 1.1219685328242758e-7 * var_x419;
        const double var_x496 = 1674740.3831249396 * var_x481;
        const double var_x497 = 8.9146219515644901e-10 * var_x408;
        const double var_x498 = 11536.567171311443 * var_x485;
        const double var_x499 = 1.5124489418129408e-6 * var_x411 * var_x481;
        const double var_x500 = 1.3112562615776865e-6 * var_x411 * var_x491;
        const double var_x501 = 1.0418611138907615e-8 * var_x411 * var_x485;
        const double var_x502 = 34076345.656450219 * var_x390 * var_x491;
        const double var_x503 = 0.055419764988303033 * var_x402 * var_x491;
        const double var_x504 = var_x488 + var_x489 + var_x490 + var_x495 + var_x497 + var_x498 + var_x500 + var_x501 + var_x502 + var_x503 - var_x483 - var_x487 - var_x496 - var_x499 + 6.0010468756032432e-13 * var_x420 + 7.0134857274900101e-12 * var_x492 + 1.7102983595469244e-14 * var_x441 + 515674.21873935661 * var_x486 - 74859394.985954925 * var_x482;
        const double var_x505 = -var_x502 - var_x503 + 38790059.315200046 * var_x482 - 267208.05766560155 * var_x486;
        const double var_x506 = var_x493 + var_x496 + var_x499 - var_x495 - var_x497 - var_x498 - var_x500 - var_x501;
        const double var_x507 = var_x452 * var_x504;
        const double var_x508 = var_x472 * var_x481;
        const double var_x509 = var_x472 * var_x485;
        const double var_x510 = exp(var_x88);
        const double var_x511 = 0.75 * var_x510;
        const double var_x512 = var_x180 * var_x245 / (-1.0 + var_x510);
        const double var_x513 = var_x512 * (-0.75 * mParameters[1] + var_x511 * var_chaste_interface__intracellular_ions__kss);
        const double var_x514 = var_x250 * var_x513;
        const double var_x515 = 126.4808362369338 * var_x184;
        const double var_x516 = var_x263 * var_x270;
        const double var_x517 = var_x339 * var_x513;
        const double var_x518 = var_x510 * var_x512;
        const double var_x519 = var_x336 * var_x518;
        const double var_x520 = var_x244 * var_x263 * var_x518;
        const double var_x521 = var_x249 * var_chaste_interface__INaL__hLp;
        const double var_x522 = 0.14999999999999999 * var_x20;
        const double var_x523 = var_x249 * var_x522;
        const double var_x524 = 1 / var_chaste_interface__intracellular_ions__nasl;
        const double var_x525 = -var_x185 * log(var_x524 * mParameters[2]) + var_chaste_interface__membrane__v;
        const double var_x526 = mParameters[10] * var_chaste_interface__INaL__mL;
        const double var_x527 = var_x525 * var_x526;
        const double var_x528 = 0.98999999999999999 * var_chaste_interface__INa__hf;
        const double var_x529 = (var_x528 + 0.010000000000000009 * var_chaste_interface__INa__hs) * var_chaste_interface__INa__j;
        const double var_x530 = (var_x528 + 0.010000000000000009 * var_chaste_interface__INa__hsp) * var_chaste_interface__INa__jp;
        const double var_x531 = pow(var_chaste_interface__INa__m, 3) * mParameters[6];
        const double var_x532 = var_x525 * var_x531;
        const double var_x533 = 0.0022970159999999998 * var_x167;
        const double var_x534 = 1.1250000000000001e-5 * var_x9;
        const double var_x535 = var_x249 * var_x534;
        const double var_x536 = 1777.6995840000002 * var_x436;
        const double var_x537 = 1.6872866561388904e-7 * var_x460;
        const double var_x538 = 4.0991265609206957e-17 * var_x454;
        const double var_x539 = 3.8906469970046351e-27 * var_x466;
        const double var_x540 = 4327415.4693063302 * var_x463;
        const double var_x541 = 9.9784147164275156e-14 * var_x468;
        const double var_x542 = 5.7139801260718552e-18 * var_x474;
        const double var_x543 = var_x185 * var_x524;
        const double var_x544 = exp(var_x88);
        const double var_x545 = var_x512 * (-0.75 * mParameters[2] + var_x511 * var_chaste_interface__intracellular_ions__nass);
        const double var_x546 = var_x250 * var_x545;
        const double var_x547 = 0.00057425399999999995 * var_x324;
        const double var_x548 = var_x339 * var_x545;
        const double var_x549 = 1.0 + 1 / pow(var_chaste_interface__intracellular_ions__cajsr, 8);
        const double var_x550 = 1 / var_x549;
        const double var_x551 = 1.0 + 3.7780199833600026e-5 / pow(var_x5, 8);
        const double var_x552 = 1.0 + 1 / var_x551;
        const double var_x553 = var_x550 * var_x552;
        const double var_x554 = 948.60627177700349 * var_x184 * var_x553;
        const double var_x555 = 1 / (pow(var_x5, 9) * pow(var_x551, 2));
        const double var_x556 = var_x555 * (-8 + 0.40000000000000002 * var_x3);
        const double var_x557 = var_x347 - var_x261 * (var_x345 + var_x346);
        const double var_x558 = var_x550 * var_x557;
        const double var_x559 = var_x557 > 0;
        const double var_x560 = 1 / var_x552;
        const double var_x561 = 1.0 + 0.0123 / var_chaste_interface__intracellular_ions__cajsr;
        const double var_x562 = 0.5 * var_x560 * var_x561;
        const double var_x563 = pow(var_x552, (-2));
        const double var_x564 = var_x556 * var_x563;
        const double var_x565 = 15.0 * var_x553;
        const double var_x566 = var_x63 + ((var_x559) ? (var_x557 * var_x565) : (0));
        const double var_x567 = var_x561 * var_x566;
        const double var_x568 = 0.0030303000000000001 * var_x553;
        const double var_x569 = var_x555 * var_x9;
        const double var_x570 = var_x563 * var_x569;
        const double var_x571 = 1.0 + 1 / pow(var_chaste_interface__intracellular_ions__cacsr, 8);
        const double var_x572 = 1 / var_x571;
        const double var_x573 = var_x552 * var_x572;
        const double var_x574 = 91.0 * var_x573;
        const double var_x575 = var_x45 * var_x572;
        const double var_x576 = var_x45 > 0;
        const double var_x577 = 1.0 + 0.0123 / var_chaste_interface__intracellular_ions__cacsr;
        const double var_x578 = 0.16666666666666666 * var_x560 * var_x577;
        const double var_x579 = var_x15 + ((var_x576) ? (var_x45 * var_x574) : (0));
        const double var_x580 = var_x577 * var_x579;
        ...
        rJacobian[7][7] = 1.0 - (mDt * (var_x85 * (-0.75 + var_x186 * (-var_x86 + 6.8910479999999991e-11 * var_x178 + var_x165 * var_x168 - var_x179 * var_x182 + 0.00050000000000000001 * var_x82 * var_chaste_interface__intracellular_ions__casl - 0.037699999999999997 * var_x183 * var_x185 * var_x66) - var_x76 * var_x78) + (5.950000000000001e-5 / pow(var_x80, 3) + 3.4999999999999999e-6 / pow(var_x81, 3)) * (var_x44 + 0.66666666666666663 * var_chaste_interface__intracellular_ions__cass + 0.083333333333333329 * var_chaste_interface__intracellular_ions__cai - 0.75 * var_chaste_interface__intracellular_ions__casl + var_x186 * (var_x168 * var_x177 - var_x182 * (var_x187 + var_x179 * var_chaste_interface__intracellular_ions__casl) - var_x86 * var_chaste_interface__intracellular_ions__casl - 0.075399999999999995 * var_x183 * (-0.5 * var_x185 * log(var_x66 * mParameters[0]) + var_chaste_interface__membrane__v)) - var_x30 * var_x77) / pow(var_x83, 2)));
        rJacobian[7][8] = -(mDt * (var_x85 * (0.66666666666666663 + var_x49 * var_x79 - var_x48 * var_x77)));
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[7][12] = 0.0;
        rJacobian[7][13] = -(mDt * (0.012912377979094078 * var_x167 * var_x184 * var_x236 * var_x84));
        rJacobian[7][14] = 0.0;
        rJacobian[7][15] = 0.0;
        rJacobian[7][16] = 0.0;
        rJacobian[8][0] = -(mDt * (var_x262 * (var_x252 - var_x256)));
        rJacobian[8][1] = -(mDt * (var_x262 * (-var_x269 - var_x273)));
        rJacobian[8][2] = -(mDt * (-0.00020202000000000002 * var_x260 * var_x57));
        rJacobian[8][3] = 0.0;
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = -(mDt * (var_x260 * var_x275));
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = -(mDt * (5.0 * var_x260));
        rJacobian[8][8] = 1.0 - (mDt * (var_x260 * (var_x344 + var_x261 * (var_x341 - var_x337 - var_x338 - var_x342 + 1.7227619999999998e-11 * var_x334 + var_x322 * var_x325)) + (var_x347 + var_x261 * (-var_x345 - var_x346 + var_x325 * var_x333)) * (0.0083119800000000001 / pow(var_x257, 3) + 3.4756499999999998e-5 / pow(var_x258, 3)) / pow(var_x259, 2)));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = -(mDt * (0.024210708710801394 * var_x184 * var_x260 * var_x324 * var_x383));
        rJacobian[8][15] = -(mDt * (0.10000000000000001 * var_x260));
        rJacobian[8][16] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = 0.0;
        rJacobian[9][2] = 0.0;
        ...
        rJacobian[10][5] = 0.0;
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = -(mDt * (-9.1820528096028884e-6 * var_x184 * var_x384 * var_x387 * var_x66 * (-var_x185 * log(var_x386 * (0.018329999999999999 * mParameters[2] + mParameters[1])) + var_chaste_interface__membrane__v) / pow(var_x385, 2)));
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = -(mDt * (0.083333333333333329));
        rJacobian[10][10] = 1.0 - (mDt * (-0.75 + var_x480 * (var_x476 + 2.1674623181275951e-12 * var_x477 + 1.5258303269789357e-10 * var_x458 - 10.325106196546965 * var_x473 + var_x424 * var_x437 + var_x450 * var_x455 + var_x462 * var_x464 + var_x465 * var_x469 - var_x459 * var_x461 - var_x465 * var_x467 - var_x465 * var_x475 - 0.030099999999999998 * var_x470 / (1.0 + exp(0.75 - 0.0625 * var_chaste_interface__membrane__v)) - var_x470 * var_x471 * mParameters[7] - 1.000004299990755 * var_x478 * mParameters[9] * var_chaste_interface__IK1__xk1 / (1.0 + exp(10.545454545454545 + 0.090909090909090912 * var_chaste_interface__membrane__v - 0.5 * mParameters[1])) - var_x470 * mParameters[13] * var_chaste_interface__Ito__a * var_chaste_interface__Ito__i1 * var_chaste_interface__Ito__i2 - 0.43033148291193518 * var_x478 * (var_x479 * var_chaste_interface__IKr__xrf + (1.0 - var_x479) * var_chaste_interface__IKr__xrs) * mParameters[11] / ((1.0 + exp(2.2916666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__v)) * (1.0 + exp(-1.0416666666666667 + 0.10416666666666667 * var_chaste_interface__membrane__v))))));
        rJacobian[10][11] = -(mDt * (0.66666666666666663));
        rJacobian[10][12] = 0.0;
        rJacobian[10][13] = -(mDt * (var_x480 * (0.018329999999999999 * var_x476 + 2.8254419504163296e-12 * var_x477 + 3.4140106458327888 * var_x509 + 1.9890288190975413e-10 * var_x458 - 495.60509743425433 * var_x508 + var_x437 * var_x494 + var_x455 * var_x504 + var_x464 * var_x506 + var_x469 * var_x507 - var_x461 * var_x505 - var_x467 * var_x507 - var_x475 * var_x507)));
        rJacobian[10][14] = 0.0;
        rJacobian[10][15] = 0.0;
        rJacobian[10][16] = 0.0;
        rJacobian[11][0] = -(mDt * (-var_x515 * (5.3610000000000003e-5 * var_x255 * var_x514 - 5.8971000000000002e-5 * var_x244 * var_x514)));
        rJacobian[11][1] = -(mDt * (-var_x515 * (0.00035740000000000001 * var_x267 * var_x513 + 0.00039314000000000005 * var_x513 * var_x516)));
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = -(mDt * (-var_x515 * (4.4228250000000006e-9 * var_x244 * var_x517 - 4.0207500000000006e-9 * var_x255 * var_x517)));
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = -(mDt * (5.0));
        rJacobian[11][11] = 1.0 - (mDt * (-5.0 - var_x515 * (0.00026805000000000004 * var_x519 + 0.00029485500000000001 * var_x520)));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = 0.0;
        rJacobian[11][15] = 0.0;
        ...
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        rJacobian[13][0] = -(mDt * (var_x480 * (var_x527 * (var_x521 * var_x522 - var_x523 * var_chaste_interface__INaL__hL) - var_x532 * (var_x523 * var_x529 - var_x523 * var_x530))));
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = -(mDt * (var_x480 * (-1.0336571999999999e-10 * var_x178 - var_x165 * var_x533)));
        rJacobian[13][8] = -(mDt * (var_x480 * (var_x527 * (var_x535 * var_chaste_interface__INaL__hL - var_x521 * var_x534) - var_x532 * (var_x530 * var_x535 - var_x529 * var_x535))));
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = -(mDt * (var_x480 * (15.487659294820448 * var_x473 - 2.2887454904684036e-10 * var_x458 - 3.2511934771913929e-12 * var_x477 + var_x459 * var_x537 + var_x465 * var_x539 + var_x465 * var_x542 - var_x424 * var_x536 - var_x450 * var_x538 - var_x462 * var_x540 - var_x465 * var_x541)));
        rJacobian[13][11] = 0.0;
        rJacobian[13][12] = -(mDt * (0.083333333333333329));
        rJacobian[13][13] = 1.0 - (mDt * (-0.75 + var_x480 * (743.40764615138153 * var_x508 - 2.9835432286463117e-10 * var_x458 - 4.2381629256244946e-12 * var_x477 - 5.1210159687491839 * var_x509 + var_x505 * var_x537 + var_x507 * var_x539 + var_x507 * var_x542 - var_x236 * var_x533 - var_x494 * var_x536 - var_x504 * var_x538 - var_x506 * var_x540 - var_x507 * var_x541 + var_x526 * var_x543 * (-var_x264 * var_chaste_interface__INaL__hLp - var_x265 * var_chaste_interface__INaL__hL) - var_x471 * var_x543 * mParameters[8] - var_x531 * var_x543 * (var_x264 * var_x530 + var_x265 * var_x529) - 9.3749999999999992e-10 * var_x180 * var_x544 / (-1.0 + var_x544))));
        rJacobian[13][14] = -(mDt * (0.66666666666666663));
        rJacobian[13][15] = 0.0;
        rJacobian[13][16] = 0.0;
        rJacobian[14][0] = -(mDt * (var_x515 * (0.00020625000000000003 * var_x244 * var_x546 - 0.0001875 * var_x255 * var_x546)));
        rJacobian[14][1] = -(mDt * (var_x515 * (-0.00125 * var_x267 * var_x545 - 0.0013750000000000001 * var_x516 * var_x545)));
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = 0.0;
        rJacobian[14][4] = 0.0;
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = 0.0;
        rJacobian[14][7] = 0.0;
        rJacobian[14][8] = -(mDt * (var_x515 * (-2.5841429999999996e-11 * var_x334 - var_x322 * var_x547 + 1.4062500000000001e-8 * var_x255 * var_x548 - 1.5468750000000001e-8 * var_x244 * var_x548)));
        rJacobian[14][9] = 0.0;
        rJacobian[14][10] = 0.0;
        rJacobian[14][11] = 0.0;
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = -(mDt * (5.0));
        rJacobian[14][14] = 1.0 - (mDt * (-5.0 + var_x515 * (-0.00093749999999999997 * var_x519 - 0.00103125 * var_x520 - var_x383 * var_x547)));
        rJacobian[14][15] = 0.0;
        rJacobian[14][16] = 0.0;
        rJacobian[15][0] = -(mDt * (var_x562 * ((var_x559) ? (-var_x554 * (var_x256 - var_x252) - 0.00056670299750400039 * var_x556 * var_x558) : (0)) + 1.8890099916800013e-5 * var_x564 * var_x567));
        rJacobian[15][1] = -(mDt * (var_x562 * ((var_x559) ? (-var_x554 * (var_x269 + var_x273)) : (0))));
        rJacobian[15][2] = -(mDt * (var_x562 * ((var_x559) ? (-var_x568 * var_x57) : (0))));
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = 0.0;
        rJacobian[15][5] = -(mDt * (var_x562 * ((var_x559) ? (var_x568 * var_x59 * var_chaste_interface__intracellular_ions__cass + 120.0 * var_x552 * var_x557 / (pow(var_x549, 2) * pow(var_chaste_interface__intracellular_ions__cajsr, 9))) : (0)) - 0.0061500000000000001 * var_x560 * var_x566 / pow(var_chaste_interface__intracellular_ions__cajsr, 2)));
        rJacobian[15][6] = 0.0;
        rJacobian[15][7] = -(mDt * (var_x562 * ((var_x559) ? (75.0 * var_x553) : (0))));
        rJacobian[15][8] = -(mDt * (var_x562 * ((var_x559) ? (var_x565 * (var_x344 - var_x261 * (var_x337 + var_x338 + var_x342 - var_x341)) + 3.4002179850240029e-7 * var_x558 * var_x569) : (0)) - 1.1334059950080009e-8 * var_x567 * var_x570));
        rJacobian[15][9] = 0.0;
        rJacobian[15][10] = 0.0;
        rJacobian[15][11] = 0.0;
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (var_x562 * (-1 + ((var_x559) ? (1.5 * var_x553) : (0)))));
        rJacobian[15][16] = 0.0;
        rJacobian[16][0] = -(mDt * (var_x578 * ((var_x576) ? (var_x35 * var_x574 - 0.0034379981848576026 * var_x556 * var_x575) : (0)) + 6.2966999722666711e-6 * var_x564 * var_x580));
        rJacobian[16][1] = 0.0;
        rJacobian[16][2] = 0.0;
        rJacobian[16][3] = -(mDt * (var_x578 * ((var_x576) ? (728.0 * var_x45 * var_x552 / (pow(var_x571, 2) * pow(var_chaste_interface__intracellular_ions__cacsr, 9))) : (0)) - 0.0020500000000000002 * var_x560 * var_x579 / pow(var_chaste_interface__intracellular_ions__cacsr, 2)));
        rJacobian[16][4] = -(mDt * (var_x578 * ((var_x576) ? (var_x43 * var_x574) : (0))));
        rJacobian[16][5] = 0.0;
        rJacobian[16][6] = -(mDt * (var_x578 * ((var_x576) ? (0.0016986666666666667 * var_x573) : (0))));
        rJacobian[16][7] = -(mDt * (var_x578 * ((var_x576) ? (1.8958333333333333 * var_x573) : (0))));
        rJacobian[16][8] = -(mDt * (var_x578 * ((var_x576) ? (var_x50 * var_x574 + 2.0627989109145618e-6 * var_x569 * var_x575) : (0)) - 3.7780199833600036e-9 * var_x570 * var_x580));
        rJacobian[16][9] = 0.0;
        rJacobian[16][10] = 0.0;
        rJacobian[16][11] = 0.0;
        rJacobian[16][12] = 0.0;
        ...
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (var_x578 * (-1 + ((var_x576) ? (1.2133333333333334 * var_x573) : (0)))));
    }

    void CellTrovato2020FromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void CellTrovato2020FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        const double var_ICaL__dss = 1 / (1.0 + exp(-1.7115839243498816 - 0.23640661938534277 * var_chaste_interface__membrane__v));
        const double var_ICaL__fss = 1 / (1.0 + exp(6.1904761904761898 + 0.27056277056277056 * var_chaste_interface__membrane__v));
        ...
        const double var_ICaL__tfcaf = 5.04 + 0.71999999999999997 / (0.040000000000000001 * exp(1.5985714285714285 + 0.14285714285714285 * var_chaste_interface__membrane__v) + 0.040000000000000001 * exp(-1.5985714285714285 - 0.14285714285714285 * var_chaste_interface__membrane__v));
        const double var_ICaL__tfcafp = 2.5 * var_ICaL__tfcaf;
        const double var_ICaL__tfcas = 49.0 + 0.48999999999999999 / (0.00012 * exp(2.1699999999999999 + 0.14285714285714285 * var_chaste_interface__membrane__v) + 0.00012 * exp(-5.0633333333333335 - 0.33333333333333331 * var_chaste_interface__membrane__v));
        const double var_ICaL__tff = 7.0 + 1 / (0.0044999999999999997 * exp(3.5190000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__v) + 0.0044999999999999997 * exp(-3.5190000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__v));
        const double var_ICaL__tffp = 2.5 * var_ICaL__tff;
        const double var_ICaL__tfs = 1000.0 + 1 / (3.4999999999999997e-5 * exp(3.3649999999999998 + 0.16666666666666666 * var_chaste_interface__membrane__v) + 3.4999999999999997e-5 * exp(-5.0474999999999994 - 0.25 * var_chaste_interface__membrane__v));
        const double var_ICaT__bss = 1 / (1.0 + exp(-4.2857142857142856 - 0.14285714285714285 * var_chaste_interface__membrane__v));
        const double var_ICaT__gss = 1 / (1.0 + exp(12.199999999999999 + 0.20000000000000001 * var_chaste_interface__membrane__v));
        const double var_ICaT__taub = 1 / (1.0680000000000001 * exp(0.54333333333333333 + 0.033333333333333333 * var_chaste_interface__membrane__v) + 1.0680000000000001 * exp(-0.54333333333333333 - 0.033333333333333333 * var_chaste_interface__membrane__v));
        const double var_ICaT__taug = 1 / (0.014999999999999999 * exp(4.6558441558441563 + 0.064935064935064929 * var_chaste_interface__membrane__v) + 0.014999999999999999 * exp(-0.86074429771908767 - 0.012004801920768308 * var_chaste_interface__membrane__v));
        ...
        const double var_IKr__txrf = 12.98 + 1 / (4.1230000000000003e-5 * exp(1.4808635917566242 - 0.049067713444553483 * var_chaste_interface__membrane__v) + 0.36520000000000002 * exp(-3.6340139570948562 + 0.25846471956577927 * var_chaste_interface__membrane__v));
        const double var_IKr__txrs = 1.865 + 1 / (1.128e-5 * exp(0.4834232845026985 - 0.038550501156515031 * var_chaste_interface__membrane__v) + 0.066290000000000002 * exp(-2.3793337865397692 + 0.13596193065941536 * var_chaste_interface__membrane__v));
        ...
        const double var_INa__hssp = 1 / (1.0 + exp(13.617363344051448 + 0.16077170418006431 * var_chaste_interface__membrane__v));
        ...
        const double var_INa__thf = 1 / (16.0 * exp(-0.054037868972050131 + 0.10888146075367747 * var_chaste_interface__membrane__v) + 3.6859999999999999e-6 * exp(-0.49472505376754605 - 0.12726046399165172 * var_chaste_interface__membrane__v));
        ...
        const double var_INa__tj = 4.859 + 1 / (0.86280000000000001 * exp(-15.357647523189264 - 0.13157029142819551 * var_chaste_interface__membrane__v) + 1.1095999999999999 * exp(0.69411673565151943 + 0.11067088691648774 * var_chaste_interface__membrane__v));
        ...
        const double var_If__yss = 1 / (1.0 + exp(9.1578947368421044 + 0.10526315789473684 * var_chaste_interface__membrane__v));
        const double var_Ito__ass = 1 / (1.0 + exp(1.5384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__v));
        const double var_Ito__iss = 1 / (1.0 + exp(2.0769230769230771 + 0.076923076923076927 * var_chaste_interface__membrane__v));
        ...
        const double var_Ito__tauif = 6.1619999999999999 + 1 / (0.39329999999999998 * exp(-1.0 - 0.01 * var_chaste_interface__membrane__v) + 0.08004 * exp(-0.93131548311990686 + 0.11641443538998836 * var_chaste_interface__membrane__v));
        const double var_Ito__tauis = 43.0 + 1 / (1.7800000000000001e-8 * exp(14.123035029087756 + 0.12377769525931426 * var_chaste_interface__membrane__v) + 0.0014159999999999999 * exp(-1.6345469940728197 - 0.016934801016088061 * var_chaste_interface__membrane__v));
        ...
        CardiacNewtonSolver<17,CellTrovato2020FromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<17,CellTrovato2020FromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> CellTrovato2020FromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<CellTrovato2020FromCellMLBackwardEulerNoLut>::Initialise(void)
{
