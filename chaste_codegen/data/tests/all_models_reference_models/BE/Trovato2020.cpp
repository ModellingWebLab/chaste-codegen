...
#include "CardiacNewtonSolver.hpp"
    ...
    void CellTrovato2020FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[17], double rJacobian[17][17])
    {
        ...
        const double var_x267 = 0.59999999999999998 / (1.0 + exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__v));
        ...
        const double var_x509 = 1 / (1.0 + exp(1.4344412457471867 + 0.026171159382360639 * var_chaste_interface__membrane__v));
        ...
        const double var_x600 = 948.60627177700349 * var_x599 * var_x94;
        const double var_x601 = 1 / (pow(var_x5, 9) * pow(var_x597, 2));
        const double var_x602 = var_x601 * (-8 + 0.40000000000000002 * var_x3);
        const double var_x603 = var_x377 - var_x288 * (var_x375 + var_x376);
        const double var_x604 = var_x596 * var_x603;
        const double var_x605 = var_x262 * var_x288;
        const double var_x606 = (((var_x100 >= var_x102) || (var_x377 - var_x257 * var_x605 * (var_x362 + var_x373) > 0))) && (((var_x103) || (var_x377 - var_x605 * (var_x260 * var_x373 + 4.4000000000000004 * var_x107 * var_x258 * var_x271 * var_x290) > 0)));
        const double var_x607 = 1 / var_x598;
        const double var_x608 = 1.0 + 0.0123 / var_chaste_interface__intracellular_ions__cajsr;
        const double var_x609 = 0.5 * var_x607 * var_x608;
        const double var_x610 = pow(var_x598, (-2));
        const double var_x611 = var_x602 * var_x610;
        const double var_x612 = 15.0 * var_x599;
        const double var_x613 = var_x63 + ((var_x606) ? (var_x603 * var_x612) : (0));
        const double var_x614 = var_x608 * var_x613;
        const double var_x615 = 0.0030303000000000001 * var_x599;
        const double var_x616 = var_x601 * var_x9;
        const double var_x617 = var_x610 * var_x616;
        const double var_x618 = 1.0 + 1 / pow(var_chaste_interface__intracellular_ions__cacsr, 8);
        const double var_x619 = 1 / var_x618;
        const double var_x620 = var_x598 * var_x619;
        const double var_x621 = 91.0 * var_x620;
        const double var_x622 = var_x45 * var_x619;
        const double var_x623 = var_x45 > 0;
        const double var_x624 = 1.0 + 0.0123 / var_chaste_interface__intracellular_ions__cacsr;
        const double var_x625 = 0.16666666666666666 * var_x607 * var_x624;
        const double var_x626 = var_x15 + ((var_x623) ? (var_x45 * var_x621) : (0));
        const double var_x627 = var_x624 * var_x626;
        ...
        rJacobian[10][10] = 1.0 - (mDt * (-0.75 + var_x510 * (var_x506 + 2.1674623181275951e-12 * var_x507 + 1.5258303269789357e-10 * var_x488 - 10.325106196546965 * var_x503 + var_x454 * var_x467 + var_x480 * var_x485 + var_x492 * var_x494 + var_x495 * var_x499 - var_x489 * var_x491 - var_x495 * var_x497 - var_x495 * var_x505 - 0.030099999999999998 * var_x500 / (1.0 + exp(0.75 - 0.0625 * var_chaste_interface__membrane__v)) - var_x500 * var_x501 * mParameters[7] - 1.000004299990755 * var_x508 * mParameters[9] * var_chaste_interface__IK1__xk1 / (1.0 + exp(10.545454545454545 + 0.090909090909090912 * var_chaste_interface__membrane__v - 0.5 * mParameters[1])) - var_x500 * mParameters[13] * var_chaste_interface__Ito__a * var_chaste_interface__Ito__i1 * var_chaste_interface__Ito__i2 - 0.43033148291193518 * var_x508 * (var_x509 * var_chaste_interface__IKr__xrf + (1.0 - var_x509) * var_chaste_interface__IKr__xrs) * mParameters[11] / ((1.0 + exp(2.2916666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__v)) * (1.0 + exp(-1.0416666666666667 + 0.10416666666666667 * var_chaste_interface__membrane__v))))));
        ...
        rJacobian[14][15] = 0.0;
        rJacobian[14][16] = 0.0;
        rJacobian[15][0] = -(mDt * (var_x609 * ((var_x606) ? (-var_x600 * (var_x283 - var_x276) - 0.00056670299750400039 * var_x602 * var_x604) : (0)) + 1.8890099916800013e-5 * var_x611 * var_x614));
        rJacobian[15][1] = -(mDt * (var_x609 * ((var_x606) ? (-var_x600 * (var_x298 + var_x262 * var_x295 * var_x372)) : (0))));
        rJacobian[15][2] = -(mDt * (var_x609 * ((var_x606) ? (-var_x57 * var_x615) : (0))));
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = 0.0;
        rJacobian[15][5] = -(mDt * (var_x609 * ((var_x606) ? (var_x59 * var_x615 * var_chaste_interface__intracellular_ions__cass + 120.0 * var_x598 * var_x603 / (pow(var_x595, 2) * pow(var_chaste_interface__intracellular_ions__cajsr, 9))) : (0)) - 0.0061500000000000001 * var_x607 * var_x613 / pow(var_chaste_interface__intracellular_ions__cajsr, 2)));
        rJacobian[15][6] = 0.0;
        rJacobian[15][7] = -(mDt * (var_x609 * ((var_x606) ? (75.0 * var_x599) : (0))));
        rJacobian[15][8] = -(mDt * (var_x609 * ((var_x606) ? (var_x612 * (var_x371 - var_x288 * (var_x363 + var_x369 - var_x366 + var_x361 * var_x374)) + 3.4002179850240029e-7 * var_x604 * var_x616) : (0)) - 1.1334059950080009e-8 * var_x614 * var_x617));
        rJacobian[15][9] = 0.0;
        rJacobian[15][10] = 0.0;
        rJacobian[15][11] = 0.0;
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (var_x609 * (-1 + ((var_x606) ? (1.5 * var_x599) : (0)))));
        rJacobian[15][16] = 0.0;
        rJacobian[16][0] = -(mDt * (var_x625 * ((var_x623) ? (var_x35 * var_x621 - 0.0034379981848576026 * var_x602 * var_x622) : (0)) + 6.2966999722666711e-6 * var_x611 * var_x627));
        rJacobian[16][1] = 0.0;
        rJacobian[16][2] = 0.0;
        rJacobian[16][3] = -(mDt * (var_x625 * ((var_x623) ? (728.0 * var_x45 * var_x598 / (pow(var_x618, 2) * pow(var_chaste_interface__intracellular_ions__cacsr, 9))) : (0)) - 0.0020500000000000002 * var_x607 * var_x626 / pow(var_chaste_interface__intracellular_ions__cacsr, 2)));
        rJacobian[16][4] = -(mDt * (var_x625 * ((var_x623) ? (var_x43 * var_x621) : (0))));
        rJacobian[16][5] = 0.0;
        rJacobian[16][6] = -(mDt * (var_x625 * ((var_x623) ? (0.0016986666666666667 * var_x620) : (0))));
        rJacobian[16][7] = -(mDt * (var_x625 * ((var_x623) ? (1.8958333333333333 * var_x620) : (0))));
        rJacobian[16][8] = -(mDt * (var_x625 * ((var_x623) ? (var_x50 * var_x621 + 2.0627989109145618e-6 * var_x616 * var_x622) : (0)) - 3.7780199833600036e-9 * var_x617 * var_x627));
        rJacobian[16][9] = 0.0;
        rJacobian[16][10] = 0.0;
        rJacobian[16][11] = 0.0;
        rJacobian[16][12] = 0.0;
        ...
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (var_x625 * (-1 + ((var_x623) ? (1.2133333333333334 * var_x620) : (0)))));
    }
