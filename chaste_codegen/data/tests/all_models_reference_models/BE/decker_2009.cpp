...
#include "CardiacNewtonSolver.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celldecker_2009FromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    double Celldecker_2009FromCellMLBackwardEulerNoLut::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celldecker_2009FromCellMLBackwardEulerNoLut::Celldecker_2009FromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celldecker_2009FromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Celldecker_2009FromCellMLBackwardEulerNoLut::~Celldecker_2009FromCellMLBackwardEulerNoLut()
    {
    }

    
    double Celldecker_2009FromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Celldecker_2009FromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[35], double rResidual[35])
    {
    ...
    void Celldecker_2009FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[35], double rJacobian[35][35])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: mV; Initial value: -87.4947322902196
        ...
        const double var_x51 = exp(0.074871767015605231 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x67 = exp(-0.027328194960695912 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x116 = var_x52 * mParameters[6];
        const double var_x117 = ((var_x50) ? (-var_x115 + var_x40 * (var_x115 + var_x113 * var_x44)) : (var_x116 * var_x51));
        ...
        const double var_x121 = ((var_x50) ? (-var_x120 + var_x81 * (var_x120 + var_x113 * var_x43 * (var_x78 + var_x119 * var_x42))) : (var_x116 * (var_x78 + var_x119 * var_x51)));
        const double var_x122 = 0.010458526290002684 * var_x121;
        const double var_x123 = -var_x112 * var_x122;
        const double var_x124 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x125 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x126 = 1.0 + 0.0097788000000000007 / pow(var_x124, 2) + 4.0890000000000003e-5 / pow(var_x125, 2);
        const double var_x127 = 1 / var_x126;
        const double var_x128 = 9.3214219101444593e-16 * var_x93;
        const double var_x129 = var_x127;
        const double var_x130 = 1 / var_chaste_interface__Cl__Cl_i;
        const double var_x131 = log(100.0 * var_x130);
        const double var_x132 = 1 / var_chaste_interface__K__K_i;
        const double var_x133 = log(var_x132 * mParameters[4]);
        const double var_x134 = 26.712338705498265 * var_x133;
        const double var_x135 = var_x134 + 26.712338705498265 * var_x131;
        const double var_x136 = 0.00047280839508731927 / (87.825100000000006 + var_x135);
        const double var_x137 = 6.1298221377044294e-8 * var_x135 / pow((1 + 0.30415380916729118 * var_x131 + 0.30415380916729118 * var_x133), 2);
        const double var_x138 = var_x130 * var_x137 - var_x130 * var_x136;
        const double var_x139 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x140 = var_x131 + log(var_x139 * mParameters[5]);
        const double var_x141 = pow(var_x140, 4);
        const double var_x142 = 7.2099425022651882e-9 * pow(var_x140, 7) / pow((1 + 0.0085580149227345564 * var_x141), 2);
        const double var_x143 = 50.122574928945262 * pow(var_x140, 3) / (59494197.640692554 + 509152.231225166 * var_x141);
        ...
        const double var_x147 = pow(var_chaste_interface__Irel__Irel, 2);
        ...
        const double var_x152 = var_x49 < 2.6712338705498262e-6;
        const double var_x153 = 0.037435883507802616 * var_chaste_interface__membrane__Vm;
        const double var_x154 = exp(var_x153);
        const double var_x155 = 3612.0012202503358 * var_chaste_interface__membrane__Vm;
        const double var_x156 = var_x155 * mParameters[19] / (1.0 - var_x154);
        const double var_x157 = var_x151 * (-100.0 * var_x45 + var_chaste_interface__Cl__Cl_i);
        const double var_x158 = 1.0 + 8.1000000000000005e-11 / pow(var_chaste_interface__Ca__Ca_ss_CaL, 4);
        const double var_x159 = 1 / (pow(var_x158, 2) * pow(var_chaste_interface__Ca__Ca_ss_CaL, 5));
        const double var_x160 = 9.7200000000000016e-10 * var_x159;
        const double var_x161 = var_x160 * var_chaste_interface__ICaL__C;
        const double var_x162 = 1 / (0.58999999999999997 + 0.80000000000000004 * exp(0.67599999999999993 + 0.051999999999999998 * var_chaste_interface__membrane__Vm) / (1.0 + exp(1.7160000000000002 + 0.13200000000000001 * var_chaste_interface__membrane__Vm)));
        const double var_x163 = 1 / (1.0 + exp(1.4349206349206352 - 0.10582010582010583 * var_chaste_interface__membrane__Vm));
        const double var_x164 = var_x162 * var_x163;
        const double var_x165 = -var_x164;
        const double var_x166 = 1 / var_x158;
        const double var_x167 = 3.0 * var_x166;
        const double var_x168 = 1 / (1.0 + exp(5.833333333333333 + 0.33333333333333331 * var_chaste_interface__membrane__Vm));
        const double var_x169 = 0.80000000000000004 * var_x168;
        const double var_x170 = 0.80000000000000004 - var_x169;
        const double var_x171 = 0.040277106492669565 / (1.0 + exp(4.7444197507005512 + 0.096627693496956227 * var_chaste_interface__membrane__Vm));
        const double var_x172 = 1 / (1.0 + exp(-0.019709447580272044 - 0.092532617747756077 * var_chaste_interface__membrane__Vm));
        const double var_x173 = var_x171 + 0.032730010146303147 * var_x172;
        const double var_x174 = var_x170 * var_x173;
        const double var_x175 = -var_x167 - var_x174;
        const double var_x176 = 0.20000000000000001 + var_x169;
        const double var_x177 = var_x173 * var_x176;
        const double var_x178 = var_x162 * (1.0 - var_x163);
        const double var_x179 = 0.99990000999900008 * var_x168;
        const double var_x180 = -var_x179;
        const double var_x181 = 0.99990000999900008 + var_x180;
        const double var_x182 = 9.9990000999900015e-5 + var_x179;
        const double var_x183 = var_x176 * var_x181 / (var_x170 * var_x182);
        const double var_x184 = 9.7200000000000002e-16 * var_x159 * var_x183;
        const double var_x185 = var_x184 * var_chaste_interface__ICaL__CI;
        const double var_x186 = 3.0000000000000001e-6 * var_x166 * var_x183;
        const double var_x187 = -var_x177 - var_x186;
        const double var_x188 = 9.0720000000000001e-12 * var_x159 * var_x172 / pow((1 - 0.69999999999999996 * var_x166), 2);
        const double var_x189 = var_x188 * var_chaste_interface__ICaL__C_star;
        const double var_x190 = var_x188 * var_chaste_interface__ICaL__CI_star;
        const double var_x191 = -var_x178;
        const double var_x192 = var_x171 + var_x172 / (25.0 - 17.5 * var_x166);
        const double var_x193 = var_x182 * var_x192;
        const double var_x194 = -var_x193;
        const double var_x195 = -9.9999999999999995e-7 + var_x191;
        const double var_x196 = var_x181 * var_x192;
        const double var_x197 = -0.99990000999900008 + var_x179;
        const double var_x198 = -1.0 - var_x196;
        const double var_x199 = var_x160 * var_chaste_interface__ICaL__O;
        const double var_x200 = exp(0.0011184831685939309 * var_chaste_interface__membrane__Vm);
        const double var_x201 = 0.059458391923439997 * var_x200;
        const double var_x202 = exp(-0.0020762336738124813 * var_chaste_interface__membrane__Vm);
        const double var_x203 = 0.083986312199829993 * var_x202;
        const double var_x204 = exp(-0.015957214534570986 * var_chaste_interface__membrane__Vm);
        const double var_x205 = 0.0062346537747999999 * var_x204;
        const double var_x206 = -var_x205;
        const double var_x207 = 0.029729195961719999 * var_x200;
        const double var_x208 = -var_x207;
        const double var_x209 = exp(0.0091586713426216482 * var_chaste_interface__membrane__Vm);
        const double var_x210 = 0.01460066118316 * var_x209;
        const double var_x211 = 0.014864597980859999 * var_x200;
        const double var_x212 = -var_x211;
        const double var_x213 = -var_x203 - var_x210;
        const double var_x214 = 0.16797262439965999 * var_x202;
        const double var_x215 = 0.009351980662199999 * var_x204;
        const double var_x216 = 0.02920132236632 * var_x209;
        const double var_x217 = -var_x214 - var_x216;
        const double var_x218 = 0.043801983549479999 * var_x209;
        const double var_x219 = -var_x215;
        const double var_x220 = 0.0124693075496 * var_x204;
        const double var_x221 = 0.077319900973309999 * exp(-0.002423079581399111 * var_chaste_interface__membrane__Vm);
        const double var_x222 = 0.04459379394258 * var_x200;
        const double var_x223 = -var_x222;
        const double var_x224 = 0.0031173268874 * var_x204;
        const double var_x225 = 0.25195893659948998 * var_x202;
        const double var_x226 = -var_x218 - var_x225;
        const double var_x227 = 0.33594524879931997 * var_x202;
        const double var_x228 = 0.058402644732640001 * var_x209;
        const double var_x229 = -var_x224;
        const double var_x230 = -0.79405459958640001 * exp(-0.00300137636070284 * var_chaste_interface__membrane__Vm);
        const double var_x231 = 1 / var_x5;
        const double var_x232 = pow(var_x231, 10.0);
        const double var_x233 = 1.0 + 2.9619676669542428e-6 * var_x232;
        const double var_x234 = var_x231 * var_x232 / pow(var_x233, 2);
        const double var_x235 = var_x234 * (-1 + var_x3);
        const double var_x236 = 1 / var_chaste_interface__Ca__Ca_JSR;
        const double var_x237 = 1.0 + 0.0123 * var_x236;
        const double var_x238 = 1 / var_x233;
        const double var_x239 = 4.75 + 4.75 * var_x238;
        const double var_x240 = pow(var_x236, 8.0);
        const double var_x241 = 1.0 + var_x240;
        const double var_x242 = 1 / var_x241;
        const double var_x243 = var_x121 * var_x242 * mParameters[1];
        const double var_x244 = var_x118 * var_x243;
        const double var_x245 = var_x14 - var_x239 * var_x244;
        const double var_x246 = var_x237 * var_x245 / pow((1 + var_x238), 2);
        const double var_x247 = 1 / var_x239;
        const double var_x248 = var_x237 * var_x247;
        const double var_x249 = var_x244 * var_x248;
        const double var_x250 = var_x118 * var_x237 * mParameters[1];
        const double var_x251 = var_x234 * var_x9;
        const double var_x252 = -var_x237 * var_x243;
        const double var_x253 = 1 / var_chaste_interface__Ca__Ca_i;
        const double var_x254 = pow(var_x253, 1.3999999999999999);
        const double var_x255 = 1.0 + 6.4818210260626455e-7 * var_x254;
        const double var_x256 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
        const double var_x257 = -26.712338705498265 * log(var_x256 * (0.018329999999999999 * mParameters[5] + mParameters[4])) + var_chaste_interface__membrane__Vm;
        const double var_x258 = 1.0 - var_chaste_interface__IKs__C1 - var_chaste_interface__IKs__C10 - var_chaste_interface__IKs__C11 - var_chaste_interface__IKs__C12 - var_chaste_interface__IKs__C13 - var_chaste_interface__IKs__C14 - var_chaste_interface__IKs__C15 - var_chaste_interface__IKs__C2 - var_chaste_interface__IKs__C3 - var_chaste_interface__IKs__C4 - var_chaste_interface__IKs__C5 - var_chaste_interface__IKs__C6 - var_chaste_interface__IKs__C7 - var_chaste_interface__IKs__C8 - var_chaste_interface__IKs__C9;
        const double var_x259 = (-6.1702220000015831e-5 - 3.7021332000009499e-5 / var_x255) * mParameters[16];
        const double var_x260 = -var_x257 * var_x259;
        const double var_x261 = 0.0016482105995215921 * var_x132;
        const double var_x262 = var_x256 * var_x258 * var_x259;
        const double var_x263 = sqrt(mParameters[4]);
        const double var_x264 = var_x132 * var_x263;
        const double var_x265 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__Vm - 6.3708927812613361 * var_x133);
        const double var_x266 = 1.0 + var_x265;
        const double var_x267 = 1 / var_x266;
        const double var_x268 = exp(-2.4444678999999998 + 13.738155796237757 * var_x133 - 0.51429999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x269 = 1.0 + var_x268;
        const double var_x270 = 1 / var_x269;
        const double var_x271 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__Vm - 2.1455350448256207 * var_x133);
        const double var_x272 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__Vm - 1.6494869150645177 * var_x133);
        const double var_x273 = var_x272 + 0.49124000000000001 * var_x271;
        const double var_x274 = var_x270 * var_x273;
        const double var_x275 = 1 / (var_x274 + 1.02 * var_x267);
        const double var_x276 = var_x267 * mParameters[12];
        const double var_x277 = var_x132 * var_x265 / pow(var_x266, 2);
        const double var_x278 = var_x263 * (-var_x134 + var_chaste_interface__membrane__Vm);
        const double var_x279 = 1 + 0.38461538461538458 * var_chaste_interface__Na__Na_i;
        const double var_x280 = mParameters[18] * mParameters[4] / ((1.0 + exp(-3.444101282717841 - var_x153)) * (1.5 + mParameters[4]));
        const double var_x281 = var_x280 * var_x98 / pow(var_x279, 3);
        const double var_x282 = var_x280 * var_x59 / pow(var_x279, 4);
        const double var_x283 = 3.299618375272375e-16 * var_x71;
        const double var_x284 = 8.2490459381809375e-17 * var_x93;
        const double var_x285 = 0.0096484999999999991 * mParameters[9];
        const double var_x286 = var_x285 * var_x45 * var_x46;
        const double var_x287 = 0.0016482105995215921 * var_x139;
        const double var_x288 = 2.796426573043338e-15 * var_x93;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-var_x112 * (5.0 + var_x117 * (0.010458526290002684 * var_chaste_interface__ICaL__O + 0.010458526290002684 * var_chaste_interface__ICaL__O_star)) - (0.019557600000000001 / pow(var_x109, 3) + 8.1780000000000006e-5 / pow(var_x110, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_CaL - 5.0 * var_chaste_interface__Ca__Ca_ss_sr + var_x118 * var_x122) / pow(var_x111, 2)));
        ...
        rJacobian[4][10] = 0.0;
        rJacobian[4][11] = 0.0;
        rJacobian[4][12] = -(mDt * (var_x123));
        rJacobian[4][13] = 0.0;
        rJacobian[4][14] = -(mDt * (var_x123));
        rJacobian[4][15] = 0.0;
        rJacobian[4][16] = 0.0;
        rJacobian[4][17] = 0.0;
        rJacobian[4][18] = 0.0;
        ...
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (5.0 * var_x127));
        rJacobian[5][4] = -(mDt * (0.5 * var_x127));
        rJacobian[5][5] = 1.0 - (mDt * (-var_x129 * (5.5 + 0.0004183410516001074 * var_x97 - 1.3073157862503357e-11 * var_x96 - var_x128 * var_x58) - (0.019557600000000001 / pow(var_x124, 3) + 8.1780000000000006e-5 / pow(var_x125, 3)) * (5.5 * var_chaste_interface__Ca__Ca_ss_sr - 0.5 * var_chaste_interface__Ca__Ca_ss_CaL - 0.23999999999999996 * var_chaste_interface__Irel__Irel - 5.0 * var_chaste_interface__Ca__Ca_i - 0.0004183410516001074 * var_x92) / pow(var_x126, 2)));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        ...
        rJacobian[5][29] = 0.0;
        rJacobian[5][30] = 0.0;
        rJacobian[5][31] = -(mDt * (0.23999999999999996 * var_x127));
        rJacobian[5][32] = 0.0;
        rJacobian[5][33] = 0.0;
        rJacobian[5][34] = -(mDt * (-var_x129 * (-0.0012550231548003222 * var_x108 - var_x107 * var_x128)));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.14749262536873156 + var_x138 + var_x144 - 0.0016482105995215921 * var_x130 * mParameters[8]));
        ...
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = -(mDt * (5.0 + (0.0020917052580005369 - 0.0020917052580005369 / (1.0 + 6.2499999999999991 * var_x147)) * ((var_x152) ? (-var_x151 + var_x148 * (var_x150 + var_x151)) : (var_x156)) * var_chaste_interface__Ito2_i2f_gate__i2f));
        ...
        rJacobian[7][29] = 0.0;
        rJacobian[7][30] = 0.0;
        rJacobian[7][31] = -(mDt * (0.00066934568256017191 * ((var_x152) ? (-var_x157 + 187179.41753901311 * (2.6712338705498262e-6 + var_chaste_interface__membrane__Vm) * (var_x157 + var_x150 * (-100.0 * var_x42 + var_chaste_interface__Cl__Cl_i))) : (var_x156 * (-100.0 * var_x154 + var_chaste_interface__Cl__Cl_i))) * var_chaste_interface__Irel__Irel * var_chaste_interface__Ito2_i2f_gate__i2f / pow((0.16000000000000003 + var_x147), 2)));
        rJacobian[7][32] = 0.0;
        rJacobian[7][33] = 0.0;
        rJacobian[7][34] = 0.0;
        rJacobian[8][0] = 0.0;
        ...
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = 0.0;
        rJacobian[8][4] = -(mDt * (-var_x161));
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (var_x165 + var_x175));
        rJacobian[8][9] = -(mDt * (var_x177));
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = -(mDt * (1.0));
        rJacobian[8][12] = -(mDt * (var_x178));
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = 0.0;
        rJacobian[8][15] = 0.0;
        rJacobian[8][16] = 0.0;
        ...
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = 0.0;
        rJacobian[9][4] = -(mDt * (-var_x185));
        rJacobian[9][5] = 0.0;
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = -(mDt * (var_x174));
        rJacobian[9][9] = 1.0 - (mDt * (var_x165 + var_x187));
        rJacobian[9][10] = -(mDt * (9.9999999999999995e-7));
        rJacobian[9][11] = 0.0;
        rJacobian[9][12] = 0.0;
        rJacobian[9][13] = -(mDt * (var_x178));
        rJacobian[9][14] = 0.0;
        rJacobian[9][15] = 0.0;
        rJacobian[9][16] = 0.0;
        rJacobian[9][17] = 0.0;
        ...
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = -(mDt * (var_x185 + var_x181 * var_x189 + var_x190 * (-9.9990000999900015e-5 + var_x180)));
        rJacobian[10][5] = 0.0;
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = -(mDt * (var_x191));
        rJacobian[10][9] = -(mDt * (var_x186 + var_x191));
        rJacobian[10][10] = 1.0 - (mDt * (var_x165 + var_x194 + var_x195));
        rJacobian[10][11] = -(mDt * (var_x191 + var_x196));
        ...
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = -(mDt * (var_x161 + var_x182 * var_x190 + var_x189 * var_x197));
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        ...
        rJacobian[11][11] = 1.0 - (mDt * (var_x165 + var_x198));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = -(mDt * (var_x178));
        rJacobian[11][15] = 0.0;
        rJacobian[11][16] = 0.0;
        rJacobian[11][17] = 0.0;
        rJacobian[11][18] = 0.0;
        ...
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (-var_x199));
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = 0.0;
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = -(mDt * (var_x164));
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x175 + var_x191));
        rJacobian[12][13] = -(mDt * (var_x177));
        ...
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = -(mDt * (-var_x184 * var_chaste_interface__ICaL__OI));
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = -(mDt * (-9.9999999999999995e-7));
        rJacobian[13][9] = -(mDt * (-9.9999999999999995e-7 + var_x164));
        rJacobian[13][10] = -(mDt * (-9.9999999999999995e-7));
        rJacobian[13][11] = -(mDt * (-9.9999999999999995e-7));
        rJacobian[13][12] = -(mDt * (-9.9999999999999995e-7 + var_x174));
        rJacobian[13][13] = 1.0 - (mDt * (var_x187 + var_x195));
        ...
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = 0.0;
        rJacobian[14][4] = -(mDt * (var_x199 + var_x182 * var_x188 * (1.0 - var_chaste_interface__ICaL__C - var_chaste_interface__ICaL__CI - var_chaste_interface__ICaL__CI_star - var_chaste_interface__ICaL__C_star - var_chaste_interface__ICaL__O - var_chaste_interface__ICaL__OI - var_chaste_interface__ICaL__O_star) + var_x188 * var_x197 * var_chaste_interface__ICaL__O_star));
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = 0.0;
        rJacobian[14][7] = 0.0;
        ...
        rJacobian[14][11] = -(mDt * (var_x164 + var_x194));
        rJacobian[14][12] = -(mDt * (var_x167 + var_x194));
        rJacobian[14][13] = -(mDt * (var_x194));
        rJacobian[14][14] = 1.0 - (mDt * (var_x191 + var_x194 + var_x198));
        rJacobian[14][15] = 0.0;
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        ...
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (var_x206 + var_x208));
        ...
        rJacobian[17][14] = 0.0;
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = -(mDt * (var_x207));
        rJacobian[17][17] = 1.0 - (mDt * (var_x206 + var_x212 + var_x213));
        rJacobian[17][18] = -(mDt * (var_x214));
        rJacobian[17][19] = -(mDt * (var_x215));
        rJacobian[17][20] = 0.0;
        rJacobian[17][21] = 0.0;
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = 0.0;
        ...
        rJacobian[18][15] = 0.0;
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = -(mDt * (var_x211));
        rJacobian[18][18] = 1.0 - (mDt * (var_x206 + var_x217));
        rJacobian[18][19] = 0.0;
        rJacobian[18][20] = -(mDt * (var_x215));
        rJacobian[18][21] = 0.0;
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        ...
        rJacobian[19][15] = 0.0;
        rJacobian[19][16] = 0.0;
        rJacobian[19][17] = -(mDt * (var_x210));
        rJacobian[19][18] = 0.0;
        rJacobian[19][19] = 1.0 - (mDt * (var_x212 + var_x219));
        ...
        rJacobian[20][16] = 0.0;
        rJacobian[20][17] = 0.0;
        rJacobian[20][18] = -(mDt * (var_x216));
        rJacobian[20][19] = -(mDt * (var_x211));
        rJacobian[20][20] = 1.0 - (mDt * (var_x213 + var_x219));
        rJacobian[20][21] = -(mDt * (var_x220));
        rJacobian[20][22] = 0.0;
        rJacobian[20][23] = 0.0;
        rJacobian[20][24] = 0.0;
        rJacobian[20][25] = 0.0;
        ...
        rJacobian[21][18] = 0.0;
        rJacobian[21][19] = 0.0;
        rJacobian[21][20] = -(mDt * (var_x210));
        rJacobian[21][21] = 1.0 - (mDt * (-0.089538306411019994 - var_x220));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        ...
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (var_x213 + var_x223));
        rJacobian[22][23] = -(mDt * (var_x214));
        rJacobian[22][24] = 0.0;
        rJacobian[22][25] = 0.0;
        rJacobian[22][26] = -(mDt * (var_x224));
        rJacobian[22][27] = 0.0;
        rJacobian[22][28] = 0.0;
        rJacobian[22][29] = 0.0;
        rJacobian[22][30] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (var_x222));
        rJacobian[23][23] = 1.0 - (mDt * (var_x208 + var_x217));
        rJacobian[23][24] = -(mDt * (var_x225));
        rJacobian[23][25] = 0.0;
        rJacobian[23][26] = 0.0;
        rJacobian[23][27] = -(mDt * (var_x224));
        rJacobian[23][28] = 0.0;
        rJacobian[23][29] = 0.0;
        rJacobian[23][30] = 0.0;
        rJacobian[23][31] = 0.0;
        ...
        rJacobian[24][21] = 0.0;
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = -(mDt * (var_x207));
        rJacobian[24][24] = 1.0 - (mDt * (var_x212 + var_x226));
        rJacobian[24][25] = -(mDt * (var_x227));
        rJacobian[24][26] = 0.0;
        rJacobian[24][27] = 0.0;
        rJacobian[24][28] = -(mDt * (var_x224));
        rJacobian[24][29] = 0.0;
        rJacobian[24][30] = 0.0;
        rJacobian[24][31] = 0.0;
        rJacobian[24][32] = 0.0;
        ...
        rJacobian[25][22] = 0.0;
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = -(mDt * (var_x211));
        rJacobian[25][25] = 1.0 - (mDt * (-var_x227 - var_x228));
        rJacobian[25][26] = 0.0;
        rJacobian[25][27] = 0.0;
        rJacobian[25][28] = 0.0;
        rJacobian[25][29] = -(mDt * (var_x224));
        rJacobian[25][30] = 0.0;
        rJacobian[25][31] = 0.0;
        rJacobian[25][32] = 0.0;
        rJacobian[25][33] = 0.0;
        ...
        rJacobian[26][20] = 0.0;
        rJacobian[26][21] = 0.0;
        rJacobian[26][22] = -(mDt * (var_x210));
        rJacobian[26][23] = 0.0;
        rJacobian[26][24] = 0.0;
        rJacobian[26][25] = 0.0;
        rJacobian[26][26] = 1.0 - (mDt * (var_x223 + var_x229));
        ...
        rJacobian[27][21] = 0.0;
        rJacobian[27][22] = 0.0;
        rJacobian[27][23] = -(mDt * (var_x216));
        rJacobian[27][24] = 0.0;
        rJacobian[27][25] = 0.0;
        rJacobian[27][26] = -(mDt * (var_x222));
        rJacobian[27][27] = 1.0 - (mDt * (var_x208 + var_x213 + var_x229));
        rJacobian[27][28] = -(mDt * (var_x214));
        rJacobian[27][29] = 0.0;
        rJacobian[27][30] = 0.0;
        rJacobian[27][31] = 0.0;
        rJacobian[27][32] = 0.0;
        ...
        rJacobian[28][22] = 0.0;
        rJacobian[28][23] = 0.0;
        rJacobian[28][24] = -(mDt * (var_x218));
        rJacobian[28][25] = 0.0;
        rJacobian[28][26] = 0.0;
        rJacobian[28][27] = -(mDt * (var_x207));
        rJacobian[28][28] = 1.0 - (mDt * (var_x212 + var_x217 + var_x229));
        rJacobian[28][29] = -(mDt * (var_x225));
        rJacobian[28][30] = 0.0;
        rJacobian[28][31] = 0.0;
        rJacobian[28][32] = 0.0;
        rJacobian[28][33] = 0.0;
        ...
        rJacobian[29][23] = 0.0;
        rJacobian[29][24] = 0.0;
        rJacobian[29][25] = -(mDt * (var_x228));
        rJacobian[29][26] = 0.0;
        rJacobian[29][27] = 0.0;
        rJacobian[29][28] = -(mDt * (var_x211));
        rJacobian[29][29] = 1.0 - (mDt * (var_x226 + var_x229));
        rJacobian[29][30] = 0.0;
        rJacobian[29][31] = 0.0;
        rJacobian[29][32] = 0.0;
        rJacobian[29][33] = 0.0;
        ...
        rJacobian[30][13] = 0.0;
        rJacobian[30][14] = 0.0;
        rJacobian[30][15] = -(mDt * (var_x230));
        rJacobian[30][16] = -(mDt * (var_x230));
        rJacobian[30][17] = -(mDt * (var_x230));
        rJacobian[30][18] = -(mDt * (var_x230));
        rJacobian[30][19] = -(mDt * (var_x230));
        rJacobian[30][20] = -(mDt * (var_x230));
        rJacobian[30][21] = -(mDt * (0.089538306411019994 + var_x230));
        rJacobian[30][22] = -(mDt * (var_x230));
        rJacobian[30][23] = -(mDt * (var_x230));
        rJacobian[30][24] = -(mDt * (var_x230));
        rJacobian[30][25] = -(mDt * (var_x230));
        rJacobian[30][26] = -(mDt * (var_x230));
        rJacobian[30][27] = -(mDt * (var_x230));
        rJacobian[30][28] = -(mDt * (var_x230));
        rJacobian[30][29] = -(mDt * (var_x230));
        rJacobian[30][30] = 1.0 - (mDt * (var_x230 - var_x221 - 0.58638228663014003 * exp(0.010558998462268819 * var_chaste_interface__membrane__Vm)));
        rJacobian[30][31] = 0.0;
        rJacobian[30][32] = 0.0;
        rJacobian[30][33] = 0.0;
        rJacobian[30][34] = 0.0;
        rJacobian[31][0] = -(mDt * (6.2357214041141957e-6 * var_x235 * var_x246 + 0.00014069346418032653 * var_x235 * var_x249));
        rJacobian[31][1] = -(mDt * (-0.0123 * var_x245 * var_x247 / pow(var_chaste_interface__Ca__Ca_JSR, 2) - 8.0 * var_x121 * var_x236 * var_x240 * var_x250 / pow(var_x241, 2)));
        rJacobian[31][2] = 0.0;
        rJacobian[31][3] = 0.0;
        rJacobian[31][4] = -(mDt * (-var_x117 * var_x242 * var_x250));
        rJacobian[31][5] = -(mDt * (-4.6767910530856466e-10 * var_x246 * var_x251 - 1.0552009813524491e-8 * var_x249 * var_x251));
        rJacobian[31][6] = 0.0;
        rJacobian[31][7] = 0.0;
        rJacobian[31][8] = 0.0;
        rJacobian[31][9] = 0.0;
        rJacobian[31][10] = 0.0;
        rJacobian[31][11] = 0.0;
        rJacobian[31][12] = -(mDt * (var_x252));
        rJacobian[31][13] = 0.0;
        rJacobian[31][14] = -(mDt * (var_x252));
        rJacobian[31][15] = 0.0;
        rJacobian[31][16] = 0.0;
        rJacobian[31][17] = 0.0;
        rJacobian[31][18] = 0.0;
        ...
        rJacobian[31][29] = 0.0;
        rJacobian[31][30] = 0.0;
        rJacobian[31][31] = 1.0 - (mDt * (-var_x248));
        rJacobian[31][32] = 0.0;
        rJacobian[31][33] = 0.0;
        rJacobian[31][34] = 0.0;
        rJacobian[32][0] = 0.0;
        rJacobian[32][1] = 0.0;
        rJacobian[32][2] = 0.0;
        rJacobian[32][3] = -(mDt * (-3.3595190743871034e-11 * var_x253 * var_x254 * var_x257 * var_x258 * mParameters[16] / pow(var_x255, 2)));
        rJacobian[32][4] = 0.0;
        rJacobian[32][5] = 0.0;
        rJacobian[32][6] = -(mDt * (var_x138));
        rJacobian[32][7] = 0.0;
        rJacobian[32][8] = 0.0;
        rJacobian[32][9] = 0.0;
        rJacobian[32][10] = 0.0;
        ...
        rJacobian[32][13] = 0.0;
        rJacobian[32][14] = 0.0;
        rJacobian[32][15] = -(mDt * (var_x260));
        rJacobian[32][16] = -(mDt * (var_x260));
        rJacobian[32][17] = -(mDt * (var_x260));
        rJacobian[32][18] = -(mDt * (var_x260));
        rJacobian[32][19] = -(mDt * (var_x260));
        rJacobian[32][20] = -(mDt * (var_x260));
        rJacobian[32][21] = -(mDt * (var_x260));
        rJacobian[32][22] = -(mDt * (var_x260));
        rJacobian[32][23] = -(mDt * (var_x260));
        rJacobian[32][24] = -(mDt * (var_x260));
        rJacobian[32][25] = -(mDt * (var_x260));
        rJacobian[32][26] = -(mDt * (var_x260));
        rJacobian[32][27] = -(mDt * (var_x260));
        rJacobian[32][28] = -(mDt * (var_x260));
        rJacobian[32][29] = -(mDt * (var_x260));
        rJacobian[32][30] = 0.0;
        rJacobian[32][31] = 0.0;
        rJacobian[32][32] = 1.0 - (mDt * (var_x145 + 26.712338705498265 * var_x262 - var_x261 * mParameters[14] / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__Vm)) - 0.00072346244967216237 * var_x264 * var_x275 * var_x276 + 0.00017254579424681073 * var_x275 * var_x277 * var_x278 * mParameters[12] - 0.00070927691144329649 * var_x264 * mParameters[15] * var_chaste_interface__IKr_xr_gate__xr / (1.0 + exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__membrane__Vm)) - 2.6031772383887529e-5 * var_x276 * var_x278 * (6.4983106368865622 * var_x277 - var_x270 * (1.053972635420138 * var_x132 * var_x271 + 1.6494869150645177 * var_x132 * var_x272) - 13.738155796237757 * var_x132 * var_x268 * var_x273 / pow(var_x269, 2)) / pow((var_x267 + 0.98039215686274506 * var_x274), 2) - var_x261 * pow(var_chaste_interface__Ito1_a_gate__a, 3) * mParameters[20] * var_chaste_interface__Ito1_i1f_gate__i1f * var_chaste_interface__Ito1_i1s_gate__i1s * exp(0.0018181818181818182 * var_chaste_interface__membrane__Vm)));
        rJacobian[32][33] = -(mDt * (2.1063570778339494e-5 * var_x281 + 0.48963716847178318 * var_x262 - 8.1013733762844218e-6 * var_x282));
        rJacobian[32][34] = 0.0;
        rJacobian[33][0] = 0.0;
        rJacobian[33][1] = 0.0;
        rJacobian[33][2] = 0.0;
        rJacobian[33][3] = -(mDt * (-4.6276665000011881e-12 * var_x75 - var_x283 * var_x58 + var_x103 * var_x57 * var_x67));
        rJacobian[33][4] = 0.0;
        rJacobian[33][5] = -(mDt * (3.7021332000009505e-5 * var_x97 - 1.156916625000297e-12 * var_x96 - var_x284 * var_x58));
        rJacobian[33][6] = -(mDt * (var_x144));
        rJacobian[33][7] = 0.0;
        rJacobian[33][8] = 0.0;
        rJacobian[33][9] = 0.0;
        rJacobian[33][10] = 0.0;
        ...
        rJacobian[33][31] = 0.0;
        rJacobian[33][32] = 0.0;
        rJacobian[33][33] = 1.0 - (mDt * (-0.14749262536873156 + var_x146 + 1.2152060064426631e-5 * var_x282 - 3.1595356167509241e-5 * var_x281 - 6.1702220000015831e-5 * ((var_x152) ? (-var_x286 + var_x148 * (var_x286 + var_x285 * var_x44)) : (var_x154 * var_x155 * mParameters[9] / (-1.0 + var_x154))) - var_x101 * var_x283 - 0.00044425598400011404 * var_x102 * var_x105 - var_x287 * pow(var_chaste_interface__INaL_mL_gate__mL, 3) * mParameters[13] * var_chaste_interface__INaL_hL_gate__hL - var_x287 * pow(var_chaste_interface__INa_m_gate__m, 3) * mParameters[11] * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j));
        rJacobian[33][34] = -(mDt * (0.14749262536873156 - 0.00011106399600002851 * var_x108 - var_x107 * var_x284));
        rJacobian[34][0] = 0.0;
        rJacobian[34][1] = 0.0;
        rJacobian[34][2] = 0.0;
        rJacobian[34][3] = 0.0;
        rJacobian[34][4] = 0.0;
        rJacobian[34][5] = -(mDt * (0.0012550231548003222 * var_x97 - 3.9219473587510072e-11 * var_x96 - var_x288 * var_x58));
        rJacobian[34][6] = 0.0;
        rJacobian[34][7] = 0.0;
        rJacobian[34][8] = 0.0;
        rJacobian[34][9] = 0.0;
        ...
        rJacobian[34][34] = 1.0 - (mDt * (-5.0 - 0.0037650694644009667 * var_x108 - var_x107 * var_x288));
    }

    void Celldecker_2009FromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Celldecker_2009FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        CardiacNewtonSolver<35,Celldecker_2009FromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<35,Celldecker_2009FromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> Celldecker_2009FromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celldecker_2009FromCellMLBackwardEulerNoLut>::Initialise(void)
{
