...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celldecker_2009FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[37], double rJacobian[37][37])
    {
        ...
        const double var_x38 = 0.00050000000000000001 + var_chaste_interface__Ca__Ca_i;
        const double var_x39 = pow(var_x38, (-2));
        const double var_x40 = 0.0023800000000000002 + var_chaste_interface__Ca__Ca_i;
        const double var_x41 = 1.0 + 0.00011900000000000002 / pow(var_x40, 2) + 3.5000000000000004e-5 * var_x39;
        const double var_x42 = 1 / var_x41;
        const double var_x43 = 1.0 * var_x42;
        const double var_x44 = 1.7739020544754105e-6 / var_x38;
        const double var_x45 = exp(0.074873319003313496 * var_chaste_interface__membrane__Vm);
        const double var_x46 = 1.0 * var_x45;
        const double var_x47 = var_chaste_interface__membrane__Vm / (-1.0 + var_x45);
        ...
        const double var_x51 = exp(0.010107898065447322 * var_chaste_interface__membrane__Vm);
        const double var_x52 = 6.4800000000000004 * var_x50 * var_x51 - 9878400.0 * var_x49 * var_chaste_interface__Ca__Ca_i;
        const double var_x53 = 1 / (13227.9606 + 8.4084932990912282 * var_x50 + 4344355.375 * var_chaste_interface__Ca__Ca_i);
        const double var_x54 = 1 / (1.0 + 0.32000000000000001 * var_x49);
        const double var_x55 = 1.0 + 1.5624999999999999e-8 / pow(var_chaste_interface__Ca__Ca_i, 2);
        ...
        const double var_x59 = var_x49 * var_x57;
        const double var_x60 = var_x52 * var_x56 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x50 + var_chaste_interface__Ca__Ca_i), 2);
        const double var_x61 = var_x52 * var_x53 * var_x54 / (pow(var_x55, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
        const double var_x62 = pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x63 = var_x51 * var_x57 * var_x62;
        const double var_x64 = var_x60 * var_x62;
        const double var_x65 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x66 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x67 = 1.0 + 0.0097788000000000007 / pow(var_x66, 2) + 4.0890000000000003e-5 / pow(var_x65, 2);
        ...
        const double var_x72 = -0.61380000000000001 + var_x46 * var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x73 = -var_x68 * var_x70 * var_x72;
        const double var_x74 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x75 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x76 = 1.0 + 0.0097788000000000007 / pow(var_x75, 2) + 4.0890000000000003e-5 / pow(var_x74, 2);
        const double var_x77 = 1 / var_x76;
        const double var_x78 = pow(var_chaste_interface__Na__Na_ss_sr, 3);
        const double var_x79 = 1 / (13227.9606 + 8.4084932990912282 * var_x78 + 4344355.375 * var_chaste_interface__Ca__Ca_ss_sr);
        const double var_x80 = 1.6200000000000001 * var_x51 * var_x78 - 2469600.0 * var_x49 * var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x81 = 1.0 + 1.5624999999999999e-8 * var_x8;
        const double var_x82 = var_x54 / var_x81;
        const double var_x83 = var_x80 * var_x82;
        const double var_x84 = var_x79 * var_x82;
        const double var_x85 = var_x49 * var_x84;
        const double var_x86 = var_x83 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x78 + var_chaste_interface__Ca__Ca_ss_sr), 2);
        const double var_x87 = var_x54 * var_x79 * var_x80 / (pow(var_x81, 2) * pow(var_chaste_interface__Ca__Ca_ss_sr, 3));
        const double var_x88 = 1.0 * var_x77;
        const double var_x89 = pow(var_chaste_interface__Na__Na_ss_sr, 2);
        const double var_x90 = var_x51 * var_x84 * var_x89;
        const double var_x91 = var_x86 * var_x89;
        ...
        const double var_x128 = var_x127 + 0.032730010146303147 * var_x126;
        ...
        const double var_x143 = -9.9990000999900015e-5 + var_x135;
        const double var_x144 = 9.0720000000000001e-12 * var_x114 * var_x126 / pow((1 - 0.69999999999999996 * var_x121), 2);
        const double var_x145 = var_x144 * var_chaste_interface__ICaL__CI_star;
        const double var_x146 = var_x144 * var_chaste_interface__ICaL__C_star;
        const double var_x147 = var_x127 + 1.0 * var_x126 / (25.0 - 17.5 * var_x121);
        ...
        const double var_x156 = var_x144 * var_chaste_interface__ICaL__OI_star;
        ...
        const double var_x196 = pow(var_x195, 8.0);
        const double var_x197 = 1.0 + 1.0 * var_x196;
        const double var_x198 = 1 / var_x197;
        const double var_x199 = 1.0 + 0.0123 * var_x195;
        const double var_x200 = 1 / var_x192;
        const double var_x201 = 1 / (4.75 + 4.75 * var_x200);
        const double var_x202 = var_x199 * var_x201;
        const double var_x203 = var_x202 * var_x47 * var_x72;
        const double var_x204 = var_x198 * var_x203 * var_x69;
        const double var_x205 = 0.53437500000000004 + 0.53437500000000004 * var_x200;
        const double var_x206 = var_x205 * var_x47 * var_x69 * var_x72;
        const double var_x207 = 2.2470468725164396 * var_x198;
        const double var_x208 = var_x14 - var_x206 * var_x207;
        const double var_x209 = var_x199 * var_x208 / pow((1 + var_x200), 2);
        const double var_x210 = var_x205 * var_x207;
        ...
        const double var_x214 = var_chaste_interface__IKs__O1 + var_chaste_interface__IKs__O2;
        const double var_x215 = pow(var_x213, 1.3999999999999999);
        ...
        const double var_x219 = -5.0964977286841363e-6 - 3.0578986372104813e-6 / var_x216;
        ...
        const double var_x227 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__Vm - 1.6494527242011876 * var_x95);
        const double var_x228 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__Vm - 2.1454905717868731 * var_x95);
        const double var_x229 = var_x227 + 0.49124000000000001 * var_x228;
        const double var_x230 = var_x226 * var_x229;
        const double var_x231 = var_x94 / (var_x230 + 1.02 * var_x223);
        const double var_x232 = var_x214 * var_x219 * (0.12553036579548593 * var_chaste_interface__K__K_i + 0.002300971605031257 * var_chaste_interface__Na__Na_i) / pow(var_x217, 2);
        ...
        rJacobian[3][3] = 1.0 - (mDt * (var_x43 * (-0.014749262536873154 + var_x37 - var_x44 - var_x58 + 1.9281544070384897e-12 * var_x61 - 609.50657582364852 * var_x59 - 1.4202553819674954e-11 * var_x60 - var_x45 * var_x48 + 1.7739020544754105e-6 * var_x39 * var_chaste_interface__Ca__Ca_i) + 1.0 * (0.00023800000000000004 / pow(var_x40, 3) + 7.0000000000000007e-5 / pow(var_x38, 3)) * (2.3746312684365782e-5 * var_chaste_interface__Ca__Ca_NSR + 0.014749262536873154 * var_chaste_interface__Ca__Ca_ss_sr - 0.014749262536873154 * var_chaste_interface__Ca__Ca_i - var_x44 * var_chaste_interface__Ca__Ca_i - var_x48 * (-0.61380000000000001 + var_x46 * var_chaste_interface__Ca__Ca_i) - var_x58 * var_chaste_interface__Ca__Ca_i + 6.1700941025231664e-5 * var_x52 * var_x57) / pow(var_x41, 2)));
        rJacobian[3][4] = 0.0;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (1.0 * var_x68 * (-5.0 - var_x45 * var_x71) + 1.0 * (0.019557600000000001 / pow(var_x66, 3) + 8.1780000000000006e-5 / pow(var_x65, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x71 * var_x72) / pow(var_x67, 2)));
        ...
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = -(mDt * (var_x140 + var_x136 * var_x146 + var_x143 * var_x145));
        rJacobian[10][5] = 0.0;
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        ...
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = -(mDt * (var_x116 + var_x137 * var_x145 + var_x146 * var_x151));
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        ...
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = 0.0;
        rJacobian[14][4] = -(mDt * (var_x155 + var_x136 * var_x157 + var_x143 * var_x156));
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = 0.0;
        rJacobian[14][7] = 0.0;
        rJacobian[14][8] = 0.0;
        ...
        rJacobian[15][2] = 0.0;
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = -(mDt * (var_x153 + var_x137 * var_x156 + var_x151 * var_x157));
        rJacobian[15][5] = 0.0;
        rJacobian[15][6] = 0.0;
        rJacobian[15][7] = 0.0;
        rJacobian[15][8] = 0.0;
        ...
        rJacobian[32][35] = 0.0;
        rJacobian[32][36] = 0.0;
        rJacobian[33][0] = -(mDt * (3.5566290975364474e-5 * var_x194 * var_x204 + 6.2357214041141957e-6 * var_x194 * var_x209));
        rJacobian[33][1] = -(mDt * (-0.0123 * var_x201 * var_x208 / pow(var_chaste_interface__Ca__Ca_JSR, 2) - 17.976374980131517 * var_x195 * var_x196 * var_x202 * var_x206 / pow(var_x197, 2)));
        rJacobian[33][2] = 0.0;
        rJacobian[33][3] = 0.0;
        rJacobian[33][4] = -(mDt * (-var_x202 * var_x210 * var_x45 * var_x47 * var_x69));
        rJacobian[33][5] = -(mDt * (-4.6767910530856466e-10 * var_x209 * var_x211 - 2.667471823152336e-9 * var_x204 * var_x211));
        rJacobian[33][6] = 0.0;
        rJacobian[33][7] = 0.0;
        rJacobian[33][8] = 0.0;
        rJacobian[33][9] = 0.0;
        ...
        rJacobian[33][31] = 0.0;
        rJacobian[33][32] = 0.0;
        rJacobian[33][33] = 1.0 - (mDt * (-var_x202));
        rJacobian[33][34] = 0.0;
        rJacobian[33][35] = 0.0;
        rJacobian[33][36] = 0.0;
        rJacobian[34][0] = 0.0;
        rJacobian[34][1] = 0.0;
        rJacobian[34][2] = 0.0;
        rJacobian[34][3] = -(mDt * (-2.774905235513489e-12 * var_x213 * var_x214 * var_x215 * var_x218 / pow(var_x216, 2)));
        rJacobian[34][4] = 0.0;
        rJacobian[34][5] = 0.0;
        ...
        rJacobian[36][3] = 0.0;
        rJacobian[36][4] = 0.0;
        rJacobian[36][5] = -(mDt * (15496.704690316265 * var_x85 + 1.4443997234609428e-9 * var_x86 - 1.960933031958144e-10 * var_x87));
        rJacobian[36][6] = 0.0;
        rJacobian[36][7] = 0.0;
        rJacobian[36][8] = 0.0;
        rJacobian[36][9] = 0.0;
