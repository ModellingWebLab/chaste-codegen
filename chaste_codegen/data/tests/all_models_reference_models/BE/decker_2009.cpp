...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celldecker_2009FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[37], double rJacobian[37][37])
    {
        ...
        const double var_x92 = log(10);
        const double var_x93 = var_x92 * log10(100.0 * var_x91);
        const double var_x94 = 1 / var_chaste_interface__K__K_i;
        const double var_x95 = var_x92 * log10(5.4000000000000004 * var_x94);
        ...
        const double var_x100 = var_x91 * var_x99 - var_x91 * var_x98;
        const double var_x101 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x102 = var_x93 + var_x92 * log10(140.0 * var_x101);
        ...
        const double var_x106 = var_x104 * var_x91 - var_x105 * var_x91;
        ...
        const double var_x117 = 1 / (1.0 + exp(1.4349206349206352 - 0.10582010582010583 * var_chaste_interface__membrane__Vm));
        ...
        const double var_x133 = var_x118 * (1.0 - var_x117);
        ...
        const double var_x147 = var_x126 + var_x127 / (25.0 - 17.5 * var_x121);
        ...
        const double var_x190 = 1 / var_x4;
        ...
        const double var_x194 = var_x17 * var_x193;
        ...
        const double var_x199 = var_x198 * var_x68 * var_x69 * var_x72;
        const double var_x200 = pow(var_x195, 8.0);
        const double var_x201 = 1.0 + 1.0 * var_x200;
        const double var_x202 = 1 / var_x201;
        const double var_x203 = 14448.603861345418 * var_x202;
        const double var_x204 = var_x13 - var_x199 * var_x203;
        ...
        const double var_x208 = var_x207 * var_x69 * var_x72;
        const double var_x209 = var_x202 * var_x208 * var_x68;
        const double var_x210 = var_x198 * var_x203;
        const double var_x211 = var_x193 * var_x8;
        ...
        const double var_x216 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
        const double var_x217 = -26.711785007306684 * var_x92 * log10(7.9662000000000006 * var_x216) + var_chaste_interface__membrane__Vm;
        ...
        const double var_x221 = var_x216 * var_x218 * var_x219;
        const double var_x222 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__Vm - 6.3707607242426434 * var_x95);
        const double var_x223 = 1.0 + var_x222;
        const double var_x224 = 1 / var_x223;
        const double var_x225 = exp(-2.4444678999999998 + 13.737871029257827 * var_x95 - 0.51429999999999998 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x229 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__Vm - 1.6494527242011876 * var_x95);
        const double var_x230 = var_x229 + 0.49124000000000001 * var_x228;
        const double var_x231 = var_x227 * var_x230;
        const double var_x232 = var_x94 / (var_x231 + 1.02 * var_x224);
        const double var_x233 = -var_x96 + var_chaste_interface__membrane__Vm;
        const double var_x234 = var_x222 / pow(var_x223, 2);
        ...
        const double var_x237 = var_x236 * var_x61 / pow(var_x235, 3);
        const double var_x238 = var_x236 * var_x49 / pow(var_x235, 4);
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.14749262536873156 + var_x100 + var_x106 - 3.7083201106826184e-7 * var_x91));
        ...
        rJacobian[32][35] = 0.0;
        rJacobian[32][36] = 0.0;
        rJacobian[33][0] = -(mDt * (0.22869271460496704 * var_x194 * var_x209 + 6.2357214041141957e-6 * var_x194 * var_x205));
        rJacobian[33][1] = -(mDt * (-0.0123 * var_x204 * var_x206 / pow(var_chaste_interface__Ca__Ca_JSR, 2) - 115588.83089076335 * var_x195 * var_x199 * var_x200 * var_x207 / pow(var_x201, 2)));
        rJacobian[33][2] = 0.0;
        rJacobian[33][3] = 0.0;
        rJacobian[33][4] = -(mDt * (-var_x207 * var_x210 * var_x45 * var_x68 * var_x69));
        rJacobian[33][5] = -(mDt * (-4.6767910530856466e-10 * var_x205 * var_x211 - 1.7151953595372529e-5 * var_x209 * var_x211));
        rJacobian[33][6] = 0.0;
        rJacobian[33][7] = 0.0;
        rJacobian[33][8] = 0.0;
        rJacobian[33][9] = 0.0;
        ...
        rJacobian[34][33] = 0.0;
        rJacobian[34][34] = 1.0 - (mDt * (var_x107 + 26.711785007306684 * var_x221 - 4.5488726691040119e-6 * var_x94 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__Vm)) - 0.0008405525584213936 * var_x224 * var_x232 + 0.00020047178518350236 * var_x232 * var_x233 * var_x234 - 3.0245559326093954e-5 * var_x224 * var_x233 * (-var_x227 * (1.0539507884845836 * var_x228 * var_x94 + 1.6494527242011876 * var_x229 * var_x94) + 6.4981759387274964 * var_x234 * var_x94 - 13.737871029257827 * var_x225 * var_x230 * var_x94 / pow(var_x226, 2)) / pow((var_x224 + 0.98039215686274506 * var_x231), 2) - 0.0016481422714144972 * var_x94 * mParameters[2] * var_chaste_interface__IKr_xr_gate__xr / (1.0 + exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__membrane__Vm)) - 0.00081995078002871237 * var_x94 * pow(var_chaste_interface__Ito1_a_gate__a, 3) * var_chaste_interface__Ito1_i1f_gate__i1f * var_chaste_interface__Ito1_i1s_gate__i1s * exp(0.0018181818181818182 * var_chaste_interface__membrane__Vm)));
        rJacobian[34][35] = -(mDt * (2.3077868741502807e-5 * var_x237 + 0.48962701918393148 * var_x221 - 8.8761033621164642e-6 * var_x238));
        rJacobian[34][36] = 0.0;
        rJacobian[35][0] = 0.0;
        rJacobian[35][1] = 0.0;
        rJacobian[35][2] = 0.0;
        ...
        rJacobian[35][33] = 0.0;
        rJacobian[35][34] = 0.0;
        rJacobian[35][35] = 1.0 - (mDt * (-0.14749262536873156 + var_x108 + 2.4740119415402899e-16 * var_x63 + 1.3314155043174696e-5 * var_x238 - 3.4616803112254212e-5 * var_x237 - 0.0035983988805915112 * var_x62 - 7.1319396379664657e-10 * var_x111 * var_chaste_interface__membrane__Vm / (-1.0 + var_x111) - 1.0712924764194231e-5 * var_x101 * pow(var_chaste_interface__INaL_mL_gate__mL, 3) * var_chaste_interface__INaL_hL_gate__hL - 0.0016481422714144972 * var_x101 * pow(var_chaste_interface__INa_m_gate__m, 3) * mParameters[1] * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j));
