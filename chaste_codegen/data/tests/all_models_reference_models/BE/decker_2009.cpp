...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celldecker_2009FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[37], double rJacobian[37][37])
    {
        ...
        const double var_x13 = 040000000000000001 * var_x12;
        ...
        const double var_x22 = 00092000000000000003 - 00017000000000000001 * var_x21 + var_chaste_interface__Ca__Ca_i;
        const double var_x23 = 1 / var_x22;
        const double var_x24 = 0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x25 = var_x23 * var_x24;
        const double var_x26 = 00017000000000000001 * var_x17 + 00017000000000000001 * var_x19;
        ...
        const double var_x35 = 00035619469026548675 * var_chaste_interface__Ca__Ca_i;
        const double var_x36 = var_x23 * var_x35;
        const double var_x37 = var_x28 * var_x35;
        const double var_x38 = 0023800000000000002 + var_chaste_interface__Ca__Ca_i;
        const double var_x39 = 00050000000000000001 + var_chaste_interface__Ca__Ca_i;
        const double var_x40 = pow(var_x39, (-2));
        const double var_x41 = 1.0 + 00011900000000000002 / pow(var_x38, 2) + 3.5000000000000004e-5 * var_x40;
        const double var_x42 = 1 / var_x41;
        const double var_x43 = 1.0 * var_x42;
        const double var_x44 = 1.7739020544754105e-6 / var_x39;
        const double var_x45 = 00035619469026548675 * var_x30;
        const double var_x46 = exp(074873319003313496 * var_chaste_interface__membrane__Vm);
        const double var_x47 = var_chaste_interface__membrane__Vm / (-1.0 + var_x46);
        const double var_x48 = 8.8930116629204303e-8 * var_x47;
        const double var_x49 = exp(-027328761436209426 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x57 = exp(010107898065447322 * var_chaste_interface__membrane__Vm);
        const double var_x58 = 6.4800000000000004 * var_x50 * var_x57 - 9878400 * var_x49 * var_chaste_interface__Ca__Ca_i;
        const double var_x59 = var_x54 * var_x58 / pow((0030448615405916234 + 1.9354984970793804e-6 * var_x50 + var_chaste_interface__Ca__Ca_i), 2);
        ...
        const double var_x65 = 0086999999999999994 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x66 = 00087000000000000001 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x67 = 1.0 + 0097788000000000007 / pow(var_x65, 2) + 4.0890000000000003e-5 / pow(var_x66, 2);
        ...
        const double var_x75 = 0086999999999999994 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x76 = 00087000000000000001 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x77 = 1.0 + 0097788000000000007 / pow(var_x75, 2) + 4.0890000000000003e-5 / pow(var_x76, 2);
        const double var_x78 = 1 / var_x77;
        const double var_x79 = pow(var_chaste_interface__Na__Na_ss_sr, 3);
        const double var_x80 = 1.6200000000000001 * var_x57 * var_x79 - 2469600 * var_x49 * var_chaste_interface__Ca__Ca_ss_sr;
        ...
        const double var_x84 = var_x83 / pow((0030448615405916234 + 1.9354984970793804e-6 * var_x79 + var_chaste_interface__Ca__Ca_ss_sr), 2);
        ...
        const double var_x94 = log(100 * var_x93);
        ...
        const double var_x99 = 00047279859462932828 / (87.825100000000006 + var_x98);
        ...
        const double var_x103 = var_x94 + log(140 * var_x102);
        const double var_x104 = pow(var_x103, 4);
        const double var_x105 = 7.2087469970547496e-9 * pow(var_x103, 7) / pow((1 + 0085573053764671191 * var_x104), 2);
        const double var_x106 = 50.118419258935766 * pow(var_x103, 3) / (59494197.640692554 + 5091101733929582 * var_x104);
        ...
        const double var_x111 = 037436659501656748 * var_chaste_interface__membrane__Vm;
        ...
        const double var_x118 = 1 / (0.58999999999999997 + 0.80000000000000004 * exp(0.67599999999999993 + 051999999999999998 * var_chaste_interface__membrane__Vm) / (1.0 + exp(1.7160000000000002 + 0.13200000000000001 * var_chaste_interface__membrane__Vm)));
        ...
        const double var_x127 = 040277106492669565 / (1.0 + exp(4.7444197507005512 + 096627693496956227 * var_chaste_interface__membrane__Vm));
        const double var_x128 = 1 / (1.0 + exp(-019709447580272044 - 092532617747756077 * var_chaste_interface__membrane__Vm));
        const double var_x129 = var_x127 + 032730010146303147 * var_x128;
        ...
        const double var_x159 = exp(0011184950759309986 * var_chaste_interface__membrane__Vm);
        const double var_x160 = 059456000000000002 * var_x159;
        const double var_x161 = exp(-0020762745726213851 * var_chaste_interface__membrane__Vm);
        const double var_x162 = 083986000000000005 * var_x161;
        const double var_x163 = exp(-01595737611258119 * var_chaste_interface__membrane__Vm);
        const double var_x164 = 0062345999999999999 * var_x163;
        const double var_x165 = -var_x164;
        const double var_x166 = 029728000000000001 * var_x159;
        const double var_x167 = -var_x166;
        const double var_x168 = exp(0091588787470803235 * var_chaste_interface__membrane__Vm);
        const double var_x169 = 014600999999999999 * var_x168;
        const double var_x170 = 014864 * var_x159;
        const double var_x171 = -var_x170;
        const double var_x172 = -var_x162 - var_x169;
        const double var_x173 = 0.16797200000000001 * var_x161;
        const double var_x174 = 0093518999999999998 * var_x163;
        const double var_x175 = 029201999999999999 * var_x168;
        const double var_x176 = -var_x173 - var_x175;
        const double var_x177 = 043802999999999995 * var_x168;
        const double var_x178 = -var_x174;
        const double var_x179 = 0124692 * var_x163;
        const double var_x180 = 07732 * exp(-0024231252229042349 * var_chaste_interface__membrane__Vm);
        const double var_x181 = 044592 * var_x159;
        const double var_x182 = -var_x181;
        const double var_x183 = 0031172999999999999 * var_x163;
        ...
        const double var_x187 = 058403999999999998 * var_x168;
        const double var_x188 = -var_x183;
        const double var_x189 = 0.58638000000000001 * exp(0105593841790373 * var_chaste_interface__membrane__Vm);
        const double var_x190 = 0.79405000000000003 * exp(-003001446738885828 * var_chaste_interface__membrane__Vm);
        const double var_x191 = 1 / var_x5;
        const double var_x192 = pow(var_x191, 10);
        ...
        const double var_x197 = 1.0 + 0123 * var_x196;
        ...
        const double var_x217 = 018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i;
        ...
        const double var_x228 = exp(0.43983232 + 080320000000000003 * var_chaste_interface__membrane__Vm - 2.1454905717868731 * var_x96);
        const double var_x229 = exp(-36.698642499999998 + 061749999999999999 * var_chaste_interface__membrane__Vm - 1.6494527242011876 * var_x96);
        ...
        const double var_x233 = var_x219 * var_x220 * (0.12553036579548593 * var_chaste_interface__K__K_i + 002300971605031257 * var_chaste_interface__Na__Na_i) / pow(var_x217, 2);
        ...
        rJacobian[0][0] = 1.0 - (mDt * (-00068000000000000005 - var_x5 * var_x6 + var_x0 * var_x6 * var_x7));
        rJacobian[0][1] = 0;
        rJacobian[0][2] = 0;
        rJacobian[0][3] = 0;
        rJacobian[0][4] = 0;
        ...
        rJacobian[0][36] = 0;
        rJacobian[1][0] = 0;
        rJacobian[1][1] = 1.0 - (mDt * (-var_x13 + 0.25 * (var_x14 + 040000000000000001 * var_chaste_interface__Ca__Ca_NSR - 040000000000000001 * var_chaste_interface__Ca__Ca_JSR) / (pow(var_x10, 3) * pow((0.125 + var_x11), 2))));
        ...
        rJacobian[2][1] = -(mDt * (0034782608695652171));
        rJacobian[2][2] = 1.0 - (mDt * (-0037699275362318837));
        rJacobian[2][3] = -(mDt * (-var_x29 + 0043750000000000004 * var_x30));
        rJacobian[2][4] = 0;
        ...
        rJacobian[3][3] = 1.0 - (mDt * (var_x43 * (-014749262536873154 + var_x37 - var_x44 - var_x45 + 1.9281544070384897e-12 * var_x60 - 609.50657582364852 * var_x56 - 1.4202553819674954e-11 * var_x59 - var_x46 * var_x48 + 1.7739020544754105e-6 * var_x40 * var_chaste_interface__Ca__Ca_i) + 1.0 * (00023800000000000004 / pow(var_x38, 3) + 7.0000000000000007e-5 / pow(var_x39, 3)) * (2.3746312684365782e-5 * var_chaste_interface__Ca__Ca_NSR + 014749262536873154 * var_chaste_interface__Ca__Ca_ss_sr - 014749262536873154 * var_chaste_interface__Ca__Ca_i - var_x44 * var_chaste_interface__Ca__Ca_i - var_x45 * var_chaste_interface__Ca__Ca_i - var_x48 * (-0.61380000000000001 + var_x61 * var_chaste_interface__Ca__Ca_i) + 6.1700941025231664e-5 * var_x55 * var_x58) / pow(var_x41, 2)));
        rJacobian[3][4] = 0;
        rJacobian[3][5] = -(mDt * (var_x43 * (014749262536873154 - var_x33 * var_x36 - var_x34 * var_x37)));
        rJacobian[3][6] = 0;
        rJacobian[3][7] = 0;
        rJacobian[3][8] = 0;
        rJacobian[3][9] = 0;
        ...
        rJacobian[3][33] = 0;
        rJacobian[3][34] = 0;
        rJacobian[3][35] = -(mDt * (var_x43 * (0011994662935305037 * var_x63 - 8.2467064718009662e-17 * var_x64)));
        rJacobian[3][36] = 0;
        rJacobian[4][0] = 0;
        rJacobian[4][1] = 0;
        rJacobian[4][2] = 0;
        rJacobian[4][3] = 0;
        rJacobian[4][4] = 1.0 - (mDt * (1.0 * var_x68 * (-5.0 - var_x46 * var_x72) + 1.0 * (019557600000000001 / pow(var_x65, 3) + 8.1780000000000006e-5 / pow(var_x66, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x72 * var_x73) / pow(var_x67, 2)));
        ...
        rJacobian[5][5] = 1.0 - (mDt * (var_x89 * (-5.5 + 6.53644343986048e-11 * var_x88 - 4.8146657448698097e-10 * var_x84 - 5165.5682301054212 * var_x87) + 1.0 * (019557600000000001 / pow(var_x75, 3) + 8.1780000000000006e-5 / pow(var_x76, 3)) * (0.5 * var_chaste_interface__Ca__Ca_ss_CaL + 0.23999999999999996 * var_chaste_interface__Irel__Irel + 5.0 * var_chaste_interface__Ca__Ca_i - 5.5 * var_chaste_interface__Ca__Ca_ss_sr + 0020916619007553534 * var_x83 * var_x85) / pow(var_x77, 2)));
        rJacobian[5][6] = 0;
        rJacobian[5][7] = 0;
        rJacobian[5][8] = 0;
        rJacobian[5][9] = 0;
        ...
        rJacobian[5][34] = 0;
        rJacobian[5][35] = 0;
        rJacobian[5][36] = -(mDt * (var_x89 * (010165476837671019 * var_x91 - 2.7956334939405277e-15 * var_x92)));
        rJacobian[6][0] = 0;
        rJacobian[6][1] = 0;
        rJacobian[6][2] = 0;
        rJacobian[6][3] = 0;
        ...
        rJacobian[7][31] = 0;
        rJacobian[7][32] = 0;
        rJacobian[7][33] = -(mDt * (2.175954783543569e-6 * var_x113 * (-100 * var_x112 + var_chaste_interface__Cl__Cl_i) * var_chaste_interface__Irel__Irel / pow((0.16000000000000003 + var_x110), 2)));
        rJacobian[7][34] = 0;
        rJacobian[7][35] = 0;
        rJacobian[7][36] = 0;
        rJacobian[8][0] = 0;
        ...
        rJacobian[22][22] = 1.0 - (mDt * (-089538000000000006 - var_x179));
        rJacobian[22][23] = 0;
        rJacobian[22][24] = 0;
        rJacobian[22][25] = 0;
        rJacobian[22][26] = 0;
        ...
        rJacobian[31][20] = 0;
        rJacobian[31][21] = 0;
        rJacobian[31][22] = -(mDt * (089538000000000006));
        rJacobian[31][23] = 0;
        rJacobian[31][24] = 0;
        rJacobian[31][25] = 0;
        rJacobian[31][26] = 0;
        ...
        rJacobian[33][1] = -(mDt * (-0123 * var_x205 * var_x207 / pow(var_chaste_interface__Ca__Ca_JSR, 2) - 115588.83089076335 * var_x196 * var_x200 * var_x201 * var_x208 / pow(var_x202, 2)));
        rJacobian[33][2] = 0;
        rJacobian[33][3] = 0;
        ...
        rJacobian[34][33] = 0;
        rJacobian[34][34] = 1.0 - (mDt * (var_x108 + 212.7914217252065 * var_x233 - 4.5488726691040119e-6 * var_x95 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__Vm)) - 0008405525584213936 * var_x224 * var_x232 + 00020047178518350236 * var_x232 * var_x234 * var_x235 - 3.0245559326093954e-5 * var_x224 * var_x234 * (-var_x227 * (1.0539507884845836 * var_x228 * var_x95 + 1.6494527242011876 * var_x229 * var_x95) + 6.4981759387274964 * var_x235 * var_x95 - 13.737871029257827 * var_x225 * var_x230 * var_x95 / pow(var_x226, 2)) / pow((var_x224 + 0.98039215686274506 * var_x231), 2) - 0016481422714144972 * var_x95 * mParameters[2] * var_chaste_interface__IKr_xr_gate__xr / (1.0 + exp(0.64935064935064934 + 064935064935064929 * var_chaste_interface__membrane__Vm)) - 00081995078002871237 * var_x95 * pow(var_chaste_interface__Ito1_a_gate__a, 3) * var_chaste_interface__Ito1_i1f_gate__i1f * var_chaste_interface__Ito1_i1s_gate__i1s * exp(0018181818181818182 * var_chaste_interface__membrane__Vm)));
        ...
        rJacobian[36][36] = 1.0 - (mDt * (-5.0 + 8.386900481821583e-15 * var_x92 - 030496430513013057 * var_x91));
    }
    ...
    void Celldecker_2009FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_IKr_xr_gate__tau_xr = 1.0 / (00029999999999999997 * (38.360799999999998 + var_chaste_interface__membrane__Vm) / (-1.0 + exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm)) + 00059999999999999995 * (-1.7383999999999999 + var_chaste_interface__membrane__Vm) / (1.0 - exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm)));
        ...
        const double var_INaL_mL_gate__bmL = 080000000000000002 * exp(-090909090909090912 * var_chaste_interface__membrane__Vm);
        ...
        const double var_INa_m_gate__bm = 080000000000000002 * exp(-090909090909090912 * var_chaste_interface__membrane__Vm);
        ...
        const double var_Ito1_a_gate__alpha_a = 0.82719827942757873 / (1.0 + exp(0.62658348478969694 - 034035137876343539 * var_chaste_interface__membrane__Vm));
        const double var_Ito1_a_gate__beta_a = 3.5 / (1.0 + exp(3.403513787634354 + 034035137876343539 * var_chaste_interface__membrane__Vm));
        const double var_Ito1_a_gate__tau_a = 1.0 / (var_Ito1_a_gate__alpha_a + var_Ito1_a_gate__beta_a);
        const double var_Ito1_i1f_gate__alpha_i1f = 025000000000000001 / (1.0 + exp(11.6 + 0.20000000000000001 * var_chaste_interface__membrane__Vm));
        ...
        const double var_Ito1_i1s_gate__alpha_i1s = 0040000000000000001 / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__Vm));
        ...
        const double var_Ito2_i2f_gate__alpha_i2f = 025000000000000001 / (1.0 + exp(11.6 + 0.20000000000000001 * var_chaste_interface__membrane__Vm));
