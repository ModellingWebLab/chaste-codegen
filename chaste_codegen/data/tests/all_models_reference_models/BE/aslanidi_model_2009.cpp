...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellaslanidi_model_2009FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[14], double rJacobian[14][14])
    {
        ...
        const double var_x18 = var_x14 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 3);
        const double var_x19 = 0.81520000000000004 * var_x18;
        const double var_x20 = var_x15 / pow(var_x13, 5);
        ...
        const double var_x27 = var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i;
        const double var_x28 = 0.00038508017945090519 * var_x27;
        const double var_x29 = pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3, 6);
        const double var_x30 = 26.53945091048535 * (0.58999999999999997 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1, 3) + 0.40999999999999998 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2, 3)) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x31 = var_x30 * (1.6583208100573134e-5 + 2.4874812150859699e-5 * var_x29);
        const double var_x32 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5);
        const double var_x33 = 1 / (36.4828726939094 + var_x32);
        const double var_x34 = 1.0 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x35 = 1 / (1.5 + exp(-1.5 - 0.025000000000000001 * var_chaste_interface__membrane__V));
        const double var_x36 = var_x35 / var_x34;
        const double var_x37 = var_x33 * var_x36;
        const double var_x38 = var_x32 * var_x37;
        const double var_x39 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 2);
        const double var_x40 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x41 = log(var_x40 * var_chaste_interface__cleft_space_ion_concentrations__K_c);
        const double var_x42 = exp(0.18895643383558949 + 0.052487898287663745 * var_chaste_interface__membrane__V - 1.393 * var_x41);
        const double var_x43 = 1.0 + var_x42;
        const double var_x44 = 1 / var_x43;
        const double var_x45 = 0.58999999999999997 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x46 = pow(var_x45, (-3));
        const double var_x47 = var_x44 * var_x46;
        const double var_x48 = var_x39 * var_x47;
        const double var_x49 = var_x32 * var_x33 * var_x35 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow(var_x34, 2);
        const double var_x50 = -26.53945091048535 * var_x41 + var_chaste_interface__membrane__V;
        const double var_x51 = 0.00012635899136671262 * var_x50;
        const double var_x52 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 3);
        const double var_x53 = var_x44 * var_x52 / pow(var_x45, 4);
        const double var_x54 = var_x42 * var_x46 * var_x50 / pow(var_x43, 2);
        const double var_x55 = var_x39 * var_x54;
        const double var_x56 = var_x40 * var_x52;
        const double var_x57 = var_x47 * var_x56;
        const double var_x58 = var_x54 * var_x56;
        const double var_x59 = var_x37 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 0.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x60 = var_x36 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0) * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow((1 + 0.027410122234342148 * var_x32), 2);
        ...
        const double var_x76 = 7.6404797510100245e-5 * var_x27;
        const double var_x77 = var_x30 * (-3.290319067574035e-6 - 4.9354786013610522e-6 * var_x29);
        const double var_x78 = 2.5071228445776315e-5 * var_x50;
        ...
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = -(mDt * ((var_x21 - var_x19) * var_chaste_interface__Ca_handling_by_the_SR__F1));
        rJacobian[2][12] = 0.0;
        rJacobian[2][13] = 0.0;
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = 0.0;
        ...
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = -(mDt * ((var_x19 - var_x21) * var_chaste_interface__Ca_handling_by_the_SR__F1 + (var_x24 - var_x23) * var_chaste_interface__Ca_handling_by_the_SR__F2));
        rJacobian[3][12] = 0.0;
        rJacobian[3][13] = 0.0;
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        ...
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = 0.0;
        rJacobian[4][11] = -(mDt * ((var_x23 - var_x24) * var_chaste_interface__Ca_handling_by_the_SR__F2));
        rJacobian[4][12] = 0.0;
        rJacobian[4][13] = 0.0;
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (5.8672691657943555e-5 * var_x55 + 0.00085446536839159674 * var_x49 - 0.0011178327494917705 * var_x48 - 0.00085446536839159674 * var_x38 + var_x48 * var_x51 - var_x25 * var_x26 - var_x25 * var_x28 - var_x25 * var_x31 - var_x51 * var_x53));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = 0.0;
        rJacobian[6][12] = -(mDt * (0.0011178327494917705 * var_x57 - 5.8672691657943555e-5 * var_x58 + var_x26 * var_x40 + var_x28 * var_x40 + var_x31 * var_x40));
        rJacobian[6][13] = -(mDt * (9.6295871719563877e-7 * var_x60 - 0.0012816980525873951 * var_x59));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        ...
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = -(mDt * (var_x63 * var_x7 - var_x63 * var_x8));
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        ...
        rJacobian[12][4] = 0.0;
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = -(mDt * (0.00016953677944277714 * var_x38 + 0.00022179221220074814 * var_x48 - 1.1641407074988802e-5 * var_x55 - 0.00016953677944277714 * var_x49 + var_x25 * var_x75 + var_x25 * var_x76 + var_x53 * var_x78 - var_x25 * var_x77 - var_x48 * var_x78));
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (1.1641407074988802e-5 * var_x58 - 0.00022179221220074814 * var_x57 + var_x40 * var_x77 - var_x40 * var_x75 - var_x40 * var_x76));
        rJacobian[12][13] = -(mDt * (0.00025430516916416572 * var_x59 - 1.9106323753881723e-7 * var_x60));
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = -(mDt * (0.00025430516916416572 * var_x49 - 0.00025430516916416572 * var_x38));
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = 0.0;
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = 0.0;
