...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellaslanidi_model_2009FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[14], double rJacobian[14][14])
    {
        ...
        const double var_x29 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x30 = var_x28 * log10(var_x29 * var_chaste_interface__cleft_space_ion_concentrations__K_c);
        const double var_x31 = exp(0.18895643383558949 + 0.052487898287663745 * var_chaste_interface__membrane__V - 1.393 * var_x30);
        const double var_x32 = 1.0 + var_x31;
        const double var_x33 = 1 / var_x32;
        const double var_x34 = 0.58999999999999997 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x35 = pow(var_x34, (-3));
        const double var_x36 = var_x33 * var_x35;
        const double var_x37 = var_x27 * var_x36;
        const double var_x38 = var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i;
        const double var_x39 = 0.00038508017945090519 * var_x38;
        const double var_x40 = -26.53945091048535 * var_x30 + var_chaste_interface__membrane__V;
        const double var_x41 = 0.00012635899136671262 * var_x40;
        const double var_x42 = pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3, 6);
        const double var_x43 = 26.53945091048535 * (0.58999999999999997 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1, 3) + 0.40999999999999998 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2, 3)) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x44 = var_x43 * (1.6583208100573134e-5 + 2.4874812150859699e-5 * var_x42);
        const double var_x45 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 3);
        const double var_x46 = var_x33 * var_x45 / pow(var_x34, 4);
        ...
        const double var_x54 = var_x47 * var_x48 * var_x50 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow(var_x49, 2);
        const double var_x55 = var_x31 * var_x35 * var_x40 / pow(var_x32, 2);
        const double var_x56 = var_x27 * var_x55;
        const double var_x57 = var_x29 * var_x45;
        const double var_x58 = var_x36 * var_x57;
        const double var_x59 = var_x55 * var_x57;
        const double var_x60 = var_x51 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0) * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow((1 + 0.027410122234342148 * var_x47), 2);
        const double var_x61 = var_x52 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 0.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x62 = -200.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x63 = 0.17614021922566689 * var_x3;
        const double var_x64 = 0.35228043845133378 * var_x5;
        const double var_x65 = 32.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x66 = 0.00020000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x67 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3);
        const double var_x68 = 1 / (1.0 + 0.00074999999999999991 * var_x67 + 823.19999999999993 * var_chaste_interface__intracellular_ion_concentrations__Ca_i);
        const double var_x69 = exp(-0.02072386508127427 * var_chaste_interface__membrane__V);
        const double var_x70 = var_x68 * var_x69;
        const double var_x71 = exp(0.016955889611951675 * var_chaste_interface__membrane__V);
        const double var_x72 = (2.5 * var_x67 * var_x71 - 2744000.0 * var_x69 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) / pow((0.0012147716229348883 + 9.1107871720116623e-7 * var_x67 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x73 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2);
        const double var_x74 = var_x68 * var_x71 * var_x73;
        const double var_x75 = var_x72 * var_x73;
        const double var_x76 = 5.4574855364357316e-5 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x77 = 7.6404797510100245e-5 * var_x38;
        const double var_x78 = 2.5071228445776315e-5 * var_x40;
        const double var_x79 = var_x43 * (-3.290319067574035e-6 - 4.9354786013610522e-6 * var_x42);
        const double var_x80 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x81 = 0.037679754693225945 * var_chaste_interface__membrane__V;
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (0.00085446536839159674 * var_x54 + 5.8672691657943555e-5 * var_x56 - 0.0011178327494917705 * var_x37 - 0.00085446536839159674 * var_x53 + var_x37 * var_x41 - var_x25 * var_x26 - var_x25 * var_x39 - var_x25 * var_x44 - var_x41 * var_x46));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = 0.0;
        rJacobian[6][12] = -(mDt * (0.0011178327494917705 * var_x58 - 5.8672691657943555e-5 * var_x59 + var_x26 * var_x29 + var_x29 * var_x39 + var_x29 * var_x44));
        rJacobian[6][13] = -(mDt * (9.6295871719563877e-7 * var_x60 - 0.0012816980525873951 * var_x61));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        ...
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = -(mDt * (var_x64 * var_x8 - var_x64 * var_x7));
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        ...
        rJacobian[12][4] = 0.0;
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = -(mDt * (0.00016953677944277714 * var_x53 + 0.00022179221220074814 * var_x37 - 1.1641407074988802e-5 * var_x56 - 0.00016953677944277714 * var_x54 + var_x25 * var_x76 + var_x25 * var_x77 + var_x46 * var_x78 - var_x25 * var_x79 - var_x37 * var_x78));
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (1.1641407074988802e-5 * var_x59 - 0.00022179221220074814 * var_x58 + var_x29 * var_x79 - var_x29 * var_x76 - var_x29 * var_x77));
        rJacobian[12][13] = -(mDt * (0.00025430516916416572 * var_x61 - 1.9106323753881723e-7 * var_x60));
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = -(mDt * (0.00025430516916416572 * var_x54 - 0.00025430516916416572 * var_x53));
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = 0.0;
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = 0.0;
        rJacobian[13][11] = -(mDt * (5.9952395409541403e-11 * var_x72 + 0.13542411585671302 * var_x70));
        rJacobian[13][12] = 0.0;
        rJacobian[13][13] = 1.0 - (mDt * (2.8659485630822583e-7 * var_x60 + 1.638640545085862e-16 * var_x75 - 0.00038145775374624855 * var_x61 - 4.3659884291485854e-7 * var_x80 - 3.701460892585086e-7 * var_x74 - 0.00058612951745018135 * var_x80 * pow(var_chaste_interface__sodium_current_m_gate__m, 3) * (0.36499999999999999 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.63500000000000001 * var_chaste_interface__sodium_current_h1_gate__h1) * var_chaste_interface__membrane__V * exp(var_x81 - 1.0 * var_x28 * log10(140.0 * var_x80)) / (-1.0 + exp(var_x81))));
    }
