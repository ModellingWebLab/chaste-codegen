...
#include "CardiacNewtonSolver.hpp"
    ...
    void CellShannon2004FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[26], double rJacobian[26][26])
    {
        ...
        const double var_x6 = 1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL;
        const double var_x7 = exp(0.07486906546164343 * var_chaste_interface__cell__V);
        const double var_x8 = var_chaste_interface__ICaL_d_gate__d * var_chaste_interface__ICaL_f_gate__f * var_chaste_interface__cell__V;
        const double var_x9 = var_x8 / (-1.0 + var_x7);
        const double var_x10 = var_x7 * var_x9;
        const double var_x11 = exp(-0.024332446275034118 * var_chaste_interface__cell__V);
        const double var_x12 = 1 / (1.0 + 0.27000000000000002 * var_x11);
        const double var_x13 = var_x11 * var_x12;
        const double var_x14 = 1.0 + 1.6777215999999998e-11 / pow(var_chaste_interface__Ca_buffer__Ca_SL, 3);
        const double var_x15 = 1 / var_x14;
        const double var_x16 = 2744000.0 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x17 = pow(var_chaste_interface__Na_buffer__Na_SL, 3.0);
        const double var_x18 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_SL) * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x19 = 1 / (9850.9599999999991 + var_x16 + 669921.875 * var_x18 + 8.4066800865219591 * var_x17);
        const double var_x20 = var_x15 * var_x19;
        const double var_x21 = var_x13 * var_x20;
        const double var_x22 = exp(0.013102086455787599 * var_chaste_interface__cell__V);
        const double var_x23 = 1.8 * var_x22;
        const double var_x24 = var_x12 * (var_x17 * var_x23 - var_x11 * var_x16);
        const double var_x25 = var_x19 * var_x24 / (pow(var_x14, 2) * pow(var_chaste_interface__Ca_buffer__Ca_SL, 4));
        const double var_x26 = var_x15 * var_x24 / pow((0.0035899999999999999 + 0.244140625 * var_x18 + 3.0636589236596063e-6 * var_x17 + var_chaste_interface__Ca_buffer__Ca_SL), 2);
        const double var_x27 = var_x26 * (-3413921.875 - 373215529.24791086 * var_chaste_interface__Ca_buffer__Ca_SL);
        const double var_x28 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x29 = 0.34100000000000003 * var_x7;
        const double var_x30 = pow(var_chaste_interface__Na_buffer__Na_SL, 2.0);
        const double var_x31 = var_x12 * var_x22;
        const double var_x32 = var_x20 * var_x30 * var_x31;
        const double var_x33 = var_x26 * var_x30;
        ...
        const double var_x55 = 1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        const double var_x56 = 1.0 + 1.6777215999999998e-11 / pow(var_chaste_interface__Ca_buffer__Ca_jct, 3);
        const double var_x57 = 1 / var_x56;
        const double var_x58 = 2744000.0 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x59 = pow(var_chaste_interface__Na_buffer__Na_jct, 3.0);
        ...
        const double var_x61 = 1 / (9850.9599999999991 + var_x58 + 669921.875 * var_x60 + 8.4066800865219591 * var_x59);
        const double var_x62 = var_x57 * var_x61;
        const double var_x63 = var_x13 * var_x62;
        const double var_x64 = var_x12 * (var_x23 * var_x59 - var_x11 * var_x58);
        const double var_x65 = var_x61 * var_x64 / (pow(var_x56, 2) * pow(var_chaste_interface__Ca_buffer__Ca_jct, 4));
        const double var_x66 = var_x57 * var_x64 / pow((0.0035899999999999999 + 0.244140625 * var_x60 + 3.0636589236596063e-6 * var_x59 + var_chaste_interface__Ca_buffer__Ca_jct), 2);
        const double var_x67 = var_x66 * (-3413921.875 - 373215529.24791086 * var_chaste_interface__Ca_buffer__Ca_jct);
        const double var_x68 = pow(var_chaste_interface__Na_buffer__Na_jct, 2.0);
        const double var_x69 = var_x31 * var_x62 * var_x68;
        const double var_x70 = var_x66 * var_x68;
        const double var_x71 = 34.0 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Calmodulin;
        const double var_x72 = 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Myosin;
        const double var_x73 = 100.0 * var_chaste_interface__cytosolic_Ca_buffer__Ca_SRB;
        const double var_x74 = 32.700000000000003 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC;
        const double var_x75 = 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC_Ca_Mg;
        const double var_x76 = 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_Myosin;
        const double var_x77 = 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_TroponinC_Ca_Mg;
        ...
        const double var_x106 = var_x8 / (-1.0 + var_x104);
        ...
        const double var_x109 = pow(var_chaste_interface__INa_m_gate__m, 3) * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j;
        const double var_x110 = var_x104 * var_x106;
        const double var_x111 = pow(var_x108, 4.0);
        const double var_x112 = 1 / (1.0 + 0.1245 * exp(-0.0037434532730821718 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x103));
        ...
        rJacobian[0][25] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (-171.99023312516786 + var_x2 + var_x3 + 2.3065909313514399e-15 * var_x27 + 8.7413788910230311e-13 * var_x25 - 47656.583144202239 * var_x21 - 3.2385929460103637e-6 * var_x4 - 0.00012978638743287919 * var_x10 * var_x6 - 5.4319197230928918e-10 * var_x4 * var_x5 / pow((1.0 + 5.2281977629563632e-6 * var_x5), 2)));
        ...
        rJacobian[1][9] = -(mDt * (0.00038060524173864864 * var_x9 * (-0.61380000000000001 + var_x29 * var_chaste_interface__Ca_buffer__Ca_SL)));
        rJacobian[1][10] = 0.0;
        rJacobian[1][11] = 0.0;
        rJacobian[1][12] = 0.0;
        rJacobian[1][13] = 0.0;
        ...
        rJacobian[7][7] = 1.0 - (mDt * (-121.70185906968872 + var_x37 + var_x38 - var_x52 + 4.0088873611662605e-12 * var_x65 + 1.0578266137819032e-14 * var_x67 - 1.4852524402707469e-5 * var_x53 - 218558.051567082 * var_x63 - 0.043342392834727739 * var_x10 * var_x55 - 2.4911349337733966e-9 * var_x53 * var_x54 / pow((1.0 + 5.2281977629563632e-6 * var_x54), 2)));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = -(mDt * (0.12710379130418692 * var_x9 * (-0.61380000000000001 + var_x29 * var_chaste_interface__Ca_buffer__Ca_jct)));
        rJacobian[7][11] = 0.0;
        ...
        rJacobian[13][25] = 0.0;
        rJacobian[14][0] = 0.0;
        rJacobian[14][1] = -(mDt * (142969.74943260671 * var_x21 - 6.9197727940543202e-15 * var_x27 - 2.6224136673069093e-12 * var_x25));
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = 0.0;
        rJacobian[14][4] = 0.0;
        rJacobian[14][5] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-2.5101556644976917 + var_x107 + 1.7451694845309862e-13 * var_x33 - 1.5310180739595352e-5 * var_x108 - 0.28135446316912399 * var_x32 - 3.9646379347775894e-9 * var_x110 * var_x6 - 0.82479088159436242 * var_x108 * var_x109 - 2.3607251144114479e-6 * var_x108 * var_x111 * var_x112 / pow((6.8301345536507063e-5 + var_x111), 2)));
        ...
        rJacobian[16][5] = 0.0;
        rJacobian[16][6] = 0.0;
        rJacobian[16][7] = -(mDt * (655674.15470124607 * var_x63 - 1.2026662083498781e-11 * var_x65 - 3.1734798413457098e-14 * var_x67));
        rJacobian[16][8] = 0.0;
        rJacobian[16][9] = 0.0;
        ...
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (-1.0301299389968197 + var_x114 + 8.0035289361659539e-13 * var_x70 - 7.0214082731462295e-5 * var_x115 - 1.2903208583770878 * var_x69 - 1.3239978260852802e-6 * var_x110 * var_x55 - 3.7825768474861841 * var_x109 * var_x115 - 1.0826531136947708e-5 * var_x112 * var_x115 * var_x116 / pow((6.8301345536507063e-5 + var_x116), 2)));
        ...
        rJacobian[20][6] = 0.0;
        rJacobian[20][7] = 0.0;
        rJacobian[20][8] = -(mDt * (1.9320000000000004 - var_x72 - var_x76));
        rJacobian[20][9] = 0.0;
        rJacobian[20][10] = 0.0;
        rJacobian[20][11] = 0.0;
        rJacobian[20][12] = 0.0;
        ...
        rJacobian[21][6] = 0.0;
        rJacobian[21][7] = 0.0;
        rJacobian[21][8] = -(mDt * (1.71 - var_x73));
        rJacobian[21][9] = 0.0;
        rJacobian[21][10] = 0.0;
        rJacobian[21][11] = 0.0;
        rJacobian[21][12] = 0.0;
        ...
        rJacobian[22][6] = 0.0;
        rJacobian[22][7] = 0.0;
        rJacobian[22][8] = -(mDt * (2.2890000000000006 - var_x74));
        rJacobian[22][9] = 0.0;
        rJacobian[22][10] = 0.0;
        rJacobian[22][11] = 0.0;
        rJacobian[22][12] = 0.0;
        ...
        rJacobian[23][6] = 0.0;
        rJacobian[23][7] = 0.0;
        rJacobian[23][8] = -(mDt * (0.33180000000000004 - var_x75 - var_x77));
        rJacobian[23][9] = 0.0;
        rJacobian[23][10] = 0.0;
        rJacobian[23][11] = 0.0;
        rJacobian[23][12] = 0.0;
