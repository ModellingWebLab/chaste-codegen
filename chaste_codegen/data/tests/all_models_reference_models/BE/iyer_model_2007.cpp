...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celliyer_model_2007FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[65], double rJacobian[65][65])
    {
        ...
        const double var_x9 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai, 1.2);
        const double var_x10 = 1 / (1.0 + 33855.471141425078 * var_x9 + 0.303951367781155 * var_x8);
        const double var_x11 = 2.532389241378596 * var_x9 - 9.6656534954407287e-5 * var_x8;
        const double var_x12 = var_x11 / pow((2.9537323401073989e-5 + var_x9 + 8.9779098483507565e-6 * var_x8), 2);
        ...
        const double var_x36 = 2.8000000000000003 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x37 = exp(0.013103020192811281 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x38 = var_x34 * var_x37 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai, 2);
        ...
        const double var_x78 = exp(5.3739999999999997e-8 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x79 = 0.00081948199999999996 * var_x78;
        const double var_x80 = exp(0.028982999999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x81 = 2.1748319999999999 * var_x80;
        ...
        const double var_x116 = 0.11079599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x117 = -var_x114;
        const double var_x118 = 5.9903999999999993 * var_x110;
        ...
        const double var_x155 = exp(6.9808923999999997e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x156 = 0.00042769471831999382 * var_x155;
        const double var_x157 = exp(0.026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x158 = 0.10945626585855089 * var_x157;
        const double var_x159 = exp(-0.045366429595429997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x160 = exp(-0.026913854983990002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x161 = exp(0.0056890885971700002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x162 = 1.6926962184371784e-6 * var_x155 * var_x159 * var_x160 / (var_x157 * var_x161);
        const double var_x163 = 0.0071483033566472664 * var_x160;
        const double var_x164 = 0.034388156021070745 * var_x159;
        const double var_x165 = 0.56744803744318484 * var_x161;
        ...
        const double var_x179 = 12158498408.695736 * var_x174;
        const double var_x180 = 23845170420.535503 * var_x172;
        ...
        const double var_x184 = 3099769910.3661275 * var_x176;
        const double var_x185 = 11922585210.267752 * var_x172;
        ...
        const double var_x202 = 8513540195.0827656 * exp(-19.672905196314268 + 0.084272054104636354 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x203 = 8513540195.0827656 * exp(-16.535928437145476 + 0.1097131992444229 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        ...
        rJacobian[3][3] = 1.0 - (mDt * (var_x29 * (-5.6374531835205994 - var_x32 + 2.8000000000000003 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa + 2.8000000000000003 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa + 4.2533745697546539e-5 * var_x15 - 0.03190795213912849 * var_x35 - 3.1566725655651652e-8 * var_x30 - 3.6466405075851775 * var_x14 + 1.5379617895699322e-6 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai / pow(var_x31, 2)) + 0.00023800000000000004 * (0.0028000000000000004 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa + 9.2400000000000013e-6 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa + 3.1566725655651652e-8 * log(2.0 * var_x30) + 0.037453183520599252 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS - 0.037453183520599252 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - 2.3635396782110715e-9 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V - var_x32 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - var_x36 * (1.0 - var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa) - var_x36 * (1.0 - var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa) + 1.2141201663854144e-8 * var_x34 * (2.0 * var_x37 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai, 3) - 2628072.0 * var_x33 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai) - 1.2 * var_x10 * var_x11) / (pow(var_x26, 3) * pow(var_x27, 2))));
        rJacobian[3][4] = 0.0;
        ...
        rJacobian[3][39] = 0.0;
        rJacobian[3][40] = 0.0;
        rJacobian[3][41] = -(mDt * (var_x29 * (9.2400000000000013e-6 + var_x36)));
        rJacobian[3][42] = -(mDt * (var_x29 * (0.0028000000000000004 + var_x36)));
        rJacobian[3][43] = 0.0;
        rJacobian[3][44] = 0.0;
        rJacobian[3][45] = 0.0;
        rJacobian[3][46] = 0.0;
        ...
        rJacobian[27][27] = 1.0 - (mDt * (var_x117 - var_x116 - var_x118));
        ...
        rJacobian[33][33] = 1.0 - (mDt * (-0.00062500000000000001 + var_x112 + var_x117));
