#ifndef CELLFOX_MCHARG_GILMOUR_2002FROMCELLMLGRL2OPT_HPP_
#define CELLFOX_MCHARG_GILMOUR_2002FROMCELLMLGRL2OPT_HPP_
...
class Cellfox_mcharg_gilmour_2002FromCellMLGRL2Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellfox_mcharg_gilmour_2002FromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellfox_mcharg_gilmour_2002FromCellMLGRL2Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellfox_mcharg_gilmour_2002FromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellfox_mcharg_gilmour_2002FromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellfox_mcharg_gilmour_2002FromCellMLGRL2Opt(p_solver, p_stimulus);
        }
...
#endif // CELLFOX_MCHARG_GILMOUR_2002FROMCELLMLGRL2OPT_HPP_