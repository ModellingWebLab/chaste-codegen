...
// LCOV_EXCL_STOP
        ...
        const double var_sodium_current__E_Na = 26.541413816729872 * log(mParameters[6] / var_chaste_interface__intracellular_ion_concentrations__Na_i); // millivolt
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celllindblad_model_1996FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x48 = var_x45 * var_x46 * var_x47 * mParameters[9];
            const double var_x49 = var_x48 * mParameters[6];
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celllindblad_model_1996FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x64 = (var_x5 - var_x9) * mParameters[15] / pow(var_x10, 2);
            ...
            const double var_x99 = mParameters[2] / (1.3999999999999999 + var_x98 + 0.80000000000000004 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up);
            const double var_x100 = (var_x98 - 0.32000000000000006 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up) * mParameters[2] / pow((0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
    ...
    double Celllindblad_model_1996FromCellMLGRL2Opt::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -18.399999999999999 * var_x115 + var_x118 * var_x119;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celllindblad_model_1996FromCellMLGRL2Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 0.016719999999999999 * var_x151 * var_x153 + 0.050000000000000003 * var_x147 * var_chaste_interface__membrane__V - 0.0044800000000000005 * var_x143 * var_x154;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celllindblad_model_1996FromCellMLGRL2Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.67417300000000002 * var_x173 - 0.67417300000000002 * var_x174;
        }
        else
        {
    ...
    double Celllindblad_model_1996FromCellMLGRL2Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x181 - 0.0096369999999999997 * var_x175;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celllindblad_model_1996FromCellMLGRL2Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0089999999999999993 * var_x215 - 0.0012999999999999999 * var_x216;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celllindblad_model_1996FromCellMLGRL2Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.65600000000000003 * var_x217 - 0.10000000000000001 * var_x218;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celllindblad_model_1996FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x63 = 0.00029999999999999997 + 0.043478260869565216 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
            const double var_x64 = (var_x5 - var_x9) * mParameters[15] / pow(var_x10, 2);
            const double var_x86 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2) * mParameters[4];
            const double var_x88 = var_x11 * var_x3;
            const double var_x89 = var_x33 * mParameters[5] / (1.5 + var_x31);
            ...
            partialF = (0.0074030490350258478 * var_x109 + 2.865997826272065e-7 * var_x91 - 0.0074030490350258478 * var_x108 - 1.3972436476029424e-6 * var_x39 - 2.9902355584031892 * var_x93 - 0.00038146431067681184 * var_x90) * mParameters[3];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celllindblad_model_1996FromCellMLGRL2Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (0.0011458274784212229 * var_x97 - 0.021831931993795975 * var_x94 - 0.021831931993795975 * var_x95 - var_x18 * var_x226 - var_x226 * var_x30) * mParameters[3];
        }
        else
        {
    ...
    double Celllindblad_model_1996FromCellMLGRL2Opt::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.47599999999999998 + var_x227;
        }
        else
        {
    ...
    double Celllindblad_model_1996FromCellMLGRL2Opt::EvaluatePartialDerivative23(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.01111111111111111 - 0.0041780876388152937 * var_x99 - 9.4006971873344073e-10 * var_x100;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celllindblad_model_1996FromCellMLGRL2Opt::EvaluatePartialDerivative25(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x232 = mParameters[1] + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
...
// LCOV_EXCL_STOP
    ...
    double Celllindblad_model_1996FromCellMLGRL2Opt::EvaluatePartialDerivative26(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.033960000000000004 - var_x244;
        }
        else
        {
