#ifndef CELLTORORD_FKATP_EPIFROMCELLMLGRL2OPT_HPP_
#define CELLTORORD_FKATP_EPIFROMCELLMLGRL2OPT_HPP_
...
class CellToRORd_fkatp_epiFromCellMLGRL2Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    CellToRORd_fkatp_epiFromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~CellToRORd_fkatp_epiFromCellMLGRL2Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const CellToRORd_fkatp_epiFromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, CellToRORd_fkatp_epiFromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)CellToRORd_fkatp_epiFromCellMLGRL2Opt(p_solver, p_stimulus);
        }
...
#endif // CELLTORORD_FKATP_EPIFROMCELLMLGRL2OPT_HPP_