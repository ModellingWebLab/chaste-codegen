...
// LCOV_EXCL_STOP
        ...
        const double var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__IKv14_Na = ((fabs(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) < 2.671139896373057e-6) ? (-187186.00275444688 * (-2.671139896373057e-6 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * (-8.0301527601600006e-12 * (-mParameters[4] + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai * exp(1.0000000000000001e-7)) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14 / (-1.0 + exp(1.0000000000000001e-7)) - 8.0301527601600006e-12 * (-mParameters[4] + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai * exp(-1.0000000000000001e-7)) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14 / (-1.0 + exp(-1.0000000000000001e-7))) + 8.0301527601600006e-12 * (-mParameters[4] + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai * exp(1.0000000000000001e-7)) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14 / (-1.0 + exp(1.0000000000000001e-7))) : (3.006264393363878e-6 * (-mParameters[4] + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai * _lt_0_row[2]) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14 / (_lt_0_row[3]))); // uA_per_uF
        ...
        const double var_COMPUTE_ICa_ICaK__ICamax = ((fabs(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) < 1.3355699481865285e-6) ? (-374372.00550889375 * (-1.3355699481865285e-6 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * (-0.019300000000000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * mParameters[2]) * ((var_environment__iso == 0) ? (7.0 * mParameters[5]) : (10.5 * mParameters[5])) / (-1.0 + exp(1.0000000000000001e-7)) - 0.019300000000000001 * (0.001 * exp(-1.0000000000000001e-7) - 0.34100000000000003 * mParameters[2]) * ((var_environment__iso == 0) ? (7.0 * mParameters[5]) : (10.5 * mParameters[5])) / (-1.0 + exp(-1.0000000000000001e-7))) + 0.019300000000000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * mParameters[2]) * ((var_environment__iso == 0) ? (7.0 * mParameters[5]) : (10.5 * mParameters[5])) / (-1.0 + exp(1.0000000000000001e-7))) : (14450.7594126433 * (_lt_0_row[0] - 0.34100000000000003 * mParameters[2]) * ((var_environment__iso == 0) ? (7.0 * mParameters[5]) : (10.5 * mParameters[5])) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V / (_lt_0_row[1]))); // uA_per_uF
        ...
        const double var_COMPUTE_ICa_ICaK__ICaK = ((fabs(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) < 2.671139896373057e-6) ? (-187186.00275444688 * (-2.671139896373057e-6 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * (-3.0897370000000001e-8 * (-mParameters[3] + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki * exp(1.0000000000000001e-7)) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa / ((1.0 - 3.773584905660377 * ((var_COMPUTE_ICa_ICaK__ICamax >= 0) ? (0) : (var_COMPUTE_ICa_ICaK__ICamax))) * (-1.0 + exp(1.0000000000000001e-7))) - 3.0897370000000001e-8 * (-mParameters[3] + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki * exp(-1.0000000000000001e-7)) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa / ((1.0 - 3.773584905660377 * ((var_COMPUTE_ICa_ICaK__ICamax >= 0) ? (0) : (var_COMPUTE_ICa_ICaK__ICamax))) * (-1.0 + exp(-1.0000000000000001e-7)))) + 3.0897370000000001e-8 * (-mParameters[3] + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki * exp(1.0000000000000001e-7)) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa / ((1.0 - 3.773584905660377 * ((var_COMPUTE_ICa_ICaK__ICamax >= 0) ? (0) : (var_COMPUTE_ICa_ICaK__ICamax))) * (-1.0 + exp(1.0000000000000001e-7)))) : (0.01156711037185033 * (-mParameters[3] + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki * _lt_0_row[2]) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa / ((1.0 - 3.773584905660377 * ((var_COMPUTE_ICa_ICaK__ICamax >= 0) ? (0) : (var_COMPUTE_ICa_ICaK__ICamax))) * (_lt_0_row[3])))); // uA_per_uF
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliyer_model_2007FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            ...
            const double var_x48 = ((var_x30) ? (var_x33 * var_x46 + var_x35 * var_x46) : (var_x41 + 7.5739436954129147 * var_x40 * var_x47 - 7573.9436954129151 * var_x38 * var_x47 * mParameters[5] / pow(var_x39, 2)));
...
// LCOV_EXCL_STOP
        ...
        const double var_COMPUTE_ICa_ICaK__ICamax = ((fabs(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) < 1.3355699481865285e-6) ? (-374372.00550889375 * (-1.3355699481865285e-6 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * (-0.019300000000000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * mParameters[2]) * var_COMPUTE_ICa_ICaK__PCa / (-1.0 + exp(1.0000000000000001e-7)) - 0.019300000000000001 * (0.001 * exp(-1.0000000000000001e-7) - 0.34100000000000003 * mParameters[2]) * var_COMPUTE_ICa_ICaK__PCa / (-1.0 + exp(-1.0000000000000001e-7))) + 0.019300000000000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * mParameters[2]) * var_COMPUTE_ICa_ICaK__PCa / (-1.0 + exp(1.0000000000000001e-7))) : (14450.7594126433 * (_lt_0_row[0] - 0.34100000000000003 * mParameters[2]) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V * var_COMPUTE_ICa_ICaK__PCa / (_lt_0_row[1]))); // uA_per_uF
        const double var_COMPUTE_ICa_ICaK__ICa = var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa * var_COMPUTE_ICa_ICaK__ICamax; // uA_per_uF
