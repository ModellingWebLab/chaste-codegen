...
#include "MathsCustomFunctions.hpp"
    ...
    double Celliyer_model_2007FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x71 = var_x28 * var_x32;
            const double var_x72 = var_x28 * var_chaste_interface__IKr__OHerg;
            const double var_x73 = var_x28 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43;
            const double var_x74 = var_x28 * var_x40;
            
            partialF = 1.9425621197603174e-5 * var_x74 - 6.1518471582797284e-5 * var_x69 - 0.00012738562343605624 * var_x73 - 3.0564346548418563e-5 * var_x72 - 9.2470395326765519e-9 * var_x67 - 5.7513555333045694e-6 * var_x70 - 0.00041181390311704764 * var_x71;
        }
        else
        {
