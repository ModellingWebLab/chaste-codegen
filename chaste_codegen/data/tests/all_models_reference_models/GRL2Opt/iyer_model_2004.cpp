...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliyer_model_2004FromCellMLGRL2::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        ...
        const double var_COMPUTE_INaK_INaCa_ICab_IpCa__ICab = 7.6840000000000003e-5 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V - 0.0010262519481865284 * log(10) * log10(2.0 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai); // uA_per_uF
        const double var_COMPUTE_REVERSAL_POTENTIALS__EK = 26.71139896373057 * log(10) * log10(4.0 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki); // mV
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x27 = log(10);
            const double var_x28 = 1 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki;
            const double var_x29 = var_x27 * log10(4.0 * var_x28);
            const double var_x30 = exp(0.047170872694120618 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V - 1.26 * var_x29);
            const double var_x31 = 0.93999999999999995 + var_x30;
            ...
            const double var_x34 = 1.0 + 0.20000000000000001 * var_x33;
            const double var_x35 = 1 / var_x34;
            const double var_x36 = var_x33 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
            const double var_x37 = exp(0.013103020192811281 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x38 = var_x37 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai, 3);
            const double var_x39 = var_x35 * (63951.97804201502 * var_x36 + 0.026206040385622562 * var_x38);
            const double var_x40 = var_x30 * (-26.71139896373057 * var_x29 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) / pow(var_x31, 2);
            const double var_x41 = 2.0 * var_x38 - 2628072.0 * var_x36;
            const double var_x42 = var_x33 * var_x41 / pow(var_x34, 2);
            const double var_x43 = 1 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai;
            const double var_x44 = pow(var_x43, 1.5);
            const double var_x45 = exp(-0.003743720055088938 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x46 = exp(2.0505200594353643);
            const double var_x47 = exp(-0.049791476732682874 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x48 = 1.0 + 0.1245 * var_x45 + 0.036499999999999998 * var_x47 * (-0.14285714285714285 + 0.14285714285714285 * var_x46);
            const double var_x49 = (0.00046609314685857277 * var_x45 + 0.049791476732682874 * var_x47 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x46)) / (pow(var_x48, 2) * (1.0 + 89.442719099991592 * var_x44));
            const double var_x50 = var_x2 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
            const double var_x51 = 0.00015031321966819388 * var_x5;
            const double var_x52 = var_x0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai;
            const double var_x53 = -138.0 + var_x52;
            const double var_x54 = 3.006264393363878e-6 * var_x53;
            const double var_x55 = var_x18 * var_x3;
            const double var_x56 = var_x11 * var_x12 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
            const double var_x57 = var_x5 * var_x56;
            const double var_x58 = var_x53 * var_x56;
            const double var_x59 = var_x50 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
            const double var_x60 = var_x4 * var_x59;
            const double var_x61 = var_x52 * var_x59;
            const double var_x62 = var_x24 * var_x3;
            const double var_x63 = var_x25 * var_x3;
            
            partialF = -0.0010768399999999999 - var_x26 + 0.01182150430414204 * var_x40 + 5.6273061501680649e-6 * var_x57 + 1.8700066983974486 * var_x63 + 1.1254612300336129e-7 * var_x58 - 0.018599999999999998 * var_chaste_interface__IKr__OHerg - 0.25061025223761596 * var_x32 - 56.32 * var_chaste_interface__INa__na6 - 56.32 * var_chaste_interface__INa__na7 - 0.0035000000000000001 * var_chaste_interface__IKs__O1ks - 0.0035000000000000001 * var_chaste_interface__IKs__O2ks - 0.077520800000000001 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - 9.6051213058629282e-7 * var_x42 - 24.975247492871414 * var_x55 - 1.736 * var_x49 - 5.6273061501680649e-6 * var_x60 - 0.00019735863638148724 * var_x39 - 1.1254612300336129e-7 * var_x61 - 0.0018700066983974486 * var_x62 - var_x50 * var_x51 - var_x50 * var_x54;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x48 = 1.0 + 0.1245 * var_x45 + 0.036499999999999998 * var_x47 * (-0.14285714285714285 + 0.14285714285714285 * var_x46);
            const double var_x50 = var_x2 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
            const double var_x64 = var_x43 * (var_chaste_interface__INa__na6 + var_chaste_interface__INa__na7);
            const double var_x65 = var_x35 * var_x37 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai, 2);
            const double var_x66 = var_x43 * var_x44 / (var_x48 * pow((0.011180339887498949 + var_x44), 2));
            const double var_x67 = var_x12 * var_x50;
            
            partialF = -1.8494079065353104e-10 * var_x67 - 5.3730734579697901e-6 * var_x66 - 0.092547526753060952 * var_x64 - 1.6432444380870198e-6 * var_x43 - 2.1854162994937459e-7 * var_x65;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x50 = var_x2 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
            const double var_x67 = var_x12 * var_x50;
            const double var_x68 = 0.01156711037185033 * var_x0 * var_x9;
            const double var_x69 = ((var_x21) ? (var_x68) : (var_x22 * var_x68));
            const double var_x70 = var_x28 * (var_chaste_interface__IKs__O1ks + var_chaste_interface__IKs__O2ks);
            const double var_x71 = var_x28 * var_chaste_interface__IKr__OHerg;
            const double var_x72 = var_x28 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43;
            const double var_x73 = var_x28 * var_x32;
            const double var_x74 = var_x28 * var_x40;
            
            partialF = 1.9425621197603171e-5 * var_x74 - 6.1518471582797284e-5 * var_x69 - 0.00012738562343605624 * var_x72 - 3.0564346548418563e-5 * var_x71 - 9.2470395326765519e-9 * var_x67 - 5.7513555333045694e-6 * var_x70 - 0.00041181390311704753 * var_x73;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x79 = var_x33 * var_x35;
            const double var_x92 = 0.0023800000000000002 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
            const double var_x93 = 1.0 + 0.00011900000000000002 / pow(var_x92, 2);
            const double var_x94 = 1 / var_x93;
            const double var_x95 = 1.5379617895699322e-6 * var_x76;
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x111 = 16.54232713906077 * var_x19;
            
            partialF = var_x107 * (-806.49188514357058 - var_x108 - var_x109) + 0.00023800000000000004 * (806.49188514357058 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai + 240.0 * var_x110 - 806.49188514357058 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS - var_x111 * var_x3) / (pow(var_x105, 3) * pow(var_x106, 2));
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x110 = (-var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR) * (var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR + var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O2_RyR);
            const double var_x114 = 0.80000000000000004 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR;
            const double var_x115 = pow(var_x114, (-2));
            const double var_x116 = 1 / (1.0 + 12.0 * var_x115);
            const double var_x117 = 1.8 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR;
            const double var_x118 = 1.8 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O2_RyR;
            
            partialF = var_x116 * (-1.7400382808421786 - var_x117 - var_x118) + 0.16666666666666666 * (1.7400382808421786 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaNSR - 1.8 * var_x110 - 1.7400382808421786 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR) / (pow(var_x114, 3) * pow((0.083333333333333329 + var_x115), 2));
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x122 = 12150000000.0 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 4.0);
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x120 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 3.0);
            const double var_x124 = 4050000.0 * var_x120;
            
            partialF = -0.67599999999999993 - var_x124;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x127 = exp(-0.41999999999999998 + 0.012 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x131 = 0.055397999999999996 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
            const double var_x132 = 7.9871999999999996 * var_x127;
            const double var_x133 = -var_x132;
            
            partialF = var_x133 - var_x131;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x125 = exp(1.4300000000000002 - 0.065000000000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x127 = exp(-0.41999999999999998 + 0.012 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x134 = 0.088200000000000001 * var_x125;
            const double var_x138 = 5.9903999999999993 * var_x127;
            const double var_x139 = 0.11079599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
            const double var_x140 = -var_x134;
            
            partialF = var_x140 - var_x138 - var_x139;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x125 = exp(1.4300000000000002 - 0.065000000000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x127 = exp(-0.41999999999999998 + 0.012 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x141 = 0.1764 * var_x125;
            const double var_x146 = 0.22159199999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
            const double var_x147 = -var_x141;
            const double var_x148 = 3.9935999999999998 * var_x127;
            const double var_x149 = -var_x148;
            
            partialF = var_x147 + var_x149 - var_x146;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x125 = exp(1.4300000000000002 - 0.065000000000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x127 = exp(-0.41999999999999998 + 0.012 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x150 = 0.2646 * var_x125;
            const double var_x154 = 0.44318399999999997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
            const double var_x155 = 1.9967999999999999 * var_x127;
            
            partialF = -var_x150 - var_x154 - var_x155;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x125 = exp(1.4300000000000002 - 0.065000000000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x156 = 0.3528 * var_x125;
            const double var_x158 = 0.88636799999999993 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
            
            partialF = -0.29999999999999999 - var_x156 - var_x158;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x127 = exp(-0.41999999999999998 + 0.012 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x161 = 15.974399999999999 * var_x127;
            
            partialF = -0.0025000000000000001 - var_x161;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x125 = exp(1.4300000000000002 - 0.065000000000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x127 = exp(-0.41999999999999998 + 0.012 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x162 = 0.0441 * var_x125;
            const double var_x164 = 11.980799999999999 * var_x127;
            
            partialF = -0.00125 - var_x162 - var_x164;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.00062500000000000001 + var_x133 + var_x140;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x148 = 3.9935999999999998 * var_x127;
            const double var_x149 = -var_x148;
            const double var_x166 = 0.1323 * var_x125;
            
            partialF = -0.00031250000000000001 + var_x149 - var_x166;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x168 = exp(-0.02019777813343069 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x169 = exp(-0.18053804430634462 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x170 = 0.5 + var_x169;
            const double var_x173 = 0.0033633620945199998 / var_x170;
            const double var_x174 = 0.0077904657073700001 * var_x168;
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x175 = exp(5.3739999999999997e-8 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x177 = exp(0.028982999999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x183 = 2.1748319999999999 * var_x177;
            const double var_x184 = 0.00081948199999999996 * var_x175;
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative26(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x175 = exp(5.3739999999999997e-8 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x177 = exp(0.028982999999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x181 = exp(-0.046843700000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x185 = 0.080185000000000006 * var_x181;
            const double var_x191 = 1.6311239999999998 * var_x177;
            const double var_x192 = 0.0015517711151999999 * var_x175;
            
            partialF = -var_x185 - var_x191 - var_x192;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative27(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x177 = exp(0.028982999999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x181 = exp(-0.046843700000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x193 = 0.16037000000000001 * var_x181;
            const double var_x199 = 1.0874159999999999 * var_x177;
            const double var_x200 = 0.011656842546537791 * var_x175;
            
            partialF = -var_x193 - var_x199 - var_x200;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative28(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x177 = exp(0.028982999999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x181 = exp(-0.046843700000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x201 = 0.24055500000000002 * var_x181;
            const double var_x207 = 0.54370799999999997 * var_x177;
            const double var_x208 = 0.12994884875097448 * var_x175;
            
            partialF = -var_x201 - var_x207 - var_x208;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x175 = exp(5.3739999999999997e-8 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x181 = exp(-0.046843700000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x209 = 0.32074000000000003 * var_x181;
            const double var_x213 = 0.11713400800552819 * var_x175;
            
            partialF = -var_x209 - var_x213;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x177 = exp(0.028982999999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x179 = exp(-0.00037301599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x186 = 0.049842400000000002 * var_x179;
            const double var_x217 = 14.731181055359999 * var_x177;
            
            partialF = -var_x186 - var_x217;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative31(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x179 = exp(-0.00037301599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x181 = exp(-0.046843700000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x194 = 0.0073584627104531205 * var_x179;
            const double var_x218 = 0.042345268272074361 * var_x181;
            const double var_x221 = 3.7617634137599998 * var_x177;
            
            partialF = -var_x194 - var_x218 - var_x221;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative32(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x179 = exp(-0.00037301599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x181 = exp(-0.046843700000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x202 = 0.0031906751727717496 * var_x179;
            const double var_x222 = 0.021348622729620501 * var_x181;
            const double var_x225 = 2.0015500855706554 * var_x177;
            
            partialF = -var_x202 - var_x222 - var_x225;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative33(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x179 = exp(-0.00037301599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x181 = exp(-0.046843700000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x210 = 0.0017334521172801731 * var_x179;
            const double var_x226 = 0.021578581001175438 * var_x181;
            const double var_x229 = 9.9194413744637924 * var_x177;
            
            partialF = -var_x210 - var_x226 - var_x229;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative34(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x179 = exp(-0.00037301599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x181 = exp(-0.046843700000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x214 = 9.5014602960251466e-5 * var_x179;
            const double var_x230 = 0.35582999726621212 * var_x181;
            
            partialF = -var_x214 - var_x230;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative35(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x233 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x235 = 7.3600965821599997 * var_x233;
            
            partialF = -2.44936e-6 - var_x235;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative36(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x231 = exp(-0.077933781739999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x233 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x236 = 0.010817483399999999 * var_x231;
            const double var_x239 = 5.5200724366199996 * var_x233;
            
            partialF = -1.2850585364284256e-6 - var_x236 - var_x239;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative37(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x231 = exp(-0.077933781739999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x233 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x240 = 0.021634966799999999 * var_x231;
            const double var_x243 = 3.6800482910799999 * var_x233;
            
            partialF = -4.290998044504021e-5 - var_x240 - var_x243;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative38(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x231 = exp(-0.077933781739999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x233 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x244 = 0.032452450199999996 * var_x231;
            const double var_x247 = 1.8400241455399999 * var_x233;
            
            partialF = -0.0022989390350036006 - var_x244 - var_x247;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative39(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x231 = exp(-0.077933781739999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x248 = 0.043269933599999998 * var_x231;
            
            partialF = -0.1341004876120194 - var_x248;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative40(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x233 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x251 = 7.4298590445392074 * var_x233;
            
            partialF = -0.00305767916 - var_x251;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative41(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x231 = exp(-0.077933781739999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x233 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x252 = 0.020618446856331008 * var_x231;
            const double var_x255 = 6.4033407827395079 * var_x233;
            
            partialF = -0.0030289691634726814 - var_x252 - var_x255;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative42(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x231 = exp(-0.077933781739999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x233 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x256 = 0.00064791916666788224 * var_x231;
            const double var_x259 = 2.0082338973371909 * var_x233;
            
            partialF = -0.0026111571690401588 - var_x256 - var_x259;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative43(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x231 = exp(-0.077933781739999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x233 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x260 = 0.00060572898292340319 * var_x231;
            const double var_x263 = 6.1053726595326019 * var_x233;
            
            partialF = -0.0047848930796401661 - var_x260 - var_x263;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative44(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x231 = exp(-0.077933781739999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x264 = 0.00074179401705723523 * var_x231;
            
            partialF = -0.0014420608358145942 - var_x264;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative45(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x267 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x269 = exp(-23.156677820503301);
            const double var_x270 = 8513540195.0827656 * var_x269;
            const double var_x271 = 34054160780.331062 * var_x267;
            
            partialF = -var_x270 - var_x271;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative46(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x265 = exp(-26.232056238852348 - 0.090161609404259865 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x267 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x269 = exp(-23.156677820503301);
            const double var_x272 = 8513540195.0827656 * var_x265;
            const double var_x277 = 11922585210.267752 * var_x269;
            const double var_x278 = 25540620585.248295 * var_x267;
            
            partialF = -var_x272 - var_x277 - var_x278;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative47(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x267 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x269 = exp(-23.156677820503301);
            const double var_x279 = 17027080390.165531 * var_x265;
            const double var_x283 = 16696701353.239271 * var_x269;
            const double var_x284 = 17027080390.165531 * var_x267;
            
            partialF = -var_x279 - var_x283 - var_x284;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative48(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x267 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x269 = exp(-23.156677820503301);
            const double var_x285 = 25540620585.248295 * var_x265;
            const double var_x289 = 23382498943.197018 * var_x269;
            const double var_x290 = 8513540195.0827656 * var_x267;
            
            partialF = -var_x285 - var_x289 - var_x290;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative49(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x265 = exp(-26.232056238852348 - 0.090161609404259865 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x269 = exp(-23.156677820503301);
            const double var_x291 = 34054160780.331062 * var_x265;
            const double var_x293 = exp(-19.672905196314268 + 0.084272054104636354 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x295 = exp(-16.535928437145476 + 0.1097131992444229 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x301 = 32745465422.278648 * var_x269;
            const double var_x302 = 8513540195.0827656 * var_x295;
            const double var_x303 = 8513540195.0827656 * var_x293;
            
            partialF = -var_x291 - var_x301 - var_x302 - var_x303;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative50(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x297 = exp(-27.092641999412571 - 0.061469636400174388 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x304 = 8513540195.0827656 * var_x297;
            const double var_x307 = exp(-20.6726464954126 + 0.011394696340402199 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x311 = 8513540195.0827656 * exp(-26.650781465416159);
            const double var_x312 = 8513540195.0827656 * var_x307;
            
            partialF = -var_x304 - var_x311 - var_x312;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative51(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x299 = exp(-26.358496255772213 - 0.068762962366201316 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x305 = 8513540195.0827656 * var_x299;
            const double var_x313 = 8513540195.0827656 * exp(-22.779658962607588);
            
            partialF = -var_x305 - var_x313;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative52(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x267 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x273 = exp(-24.35183300086069);
            const double var_x274 = 8513540195.0827656 * var_x273;
            const double var_x317 = 47690340841.071007 * var_x267;
            
            partialF = -var_x274 - var_x317;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative53(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x267 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x273 = exp(-24.35183300086069);
            const double var_x280 = 6079249204.347868 * var_x273;
            const double var_x318 = 6079249204.347868 * var_x265;
            const double var_x321 = 35767755630.803253 * var_x267;
            
            partialF = -var_x280 - var_x318 - var_x321;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative54(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x267 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x273 = exp(-24.35183300086069);
            const double var_x286 = 4340999166.2352047 * var_x273;
            const double var_x322 = 12158498408.695736 * var_x265;
            const double var_x325 = 23845170420.535503 * var_x267;
            
            partialF = -var_x286 - var_x322 - var_x325;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative55(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x267 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x273 = exp(-24.35183300086069);
            const double var_x292 = 3099769910.3661275 * var_x273;
            const double var_x326 = 18237747613.043602 * var_x265;
            const double var_x329 = 11922585210.267752 * var_x267;
            
            partialF = -var_x292 - var_x326 - var_x329;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative56(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x265 = exp(-26.232056238852348 - 0.090161609404259865 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x273 = exp(-24.35183300086069);
            const double var_x306 = 2213447441.3051791 * var_x273;
            const double var_x330 = 24316996817.391472 * var_x265;
            const double var_x331 = exp(-21.949261959797553 + 0.030147161449011892 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x335 = 8513540195.0827656 * var_x331;
            
            partialF = -var_x306 - var_x330 - var_x335;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative57(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x309 = exp(-39.744904705650839 + 0.0027019947965296331 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x314 = 8513540195.0827656 * var_x309;
            const double var_x333 = exp(-38.483942906307405 - 0.14399668707161886 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x336 = 8513540195.0827656 * var_x333;
            
            partialF = -var_x314 - var_x336;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative58(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x337 = exp(0.033046080388350003 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x341 = 0.091225454037165171 * var_x337;
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative59(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x339 = exp(-0.043060541639799998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x342 = 0.21116826991639448 * var_x339;
            
            partialF = -0.13876486073161204 - var_x342;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative60(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x343 = exp(6.9808923999999997e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x345 = exp(0.026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x353 = 0.10945626585855089 * var_x345;
            const double var_x354 = 0.00042769471831999382 * var_x343;
            
            partialF = -0.78911443677844384 - var_x353 - var_x354;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative61(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x347 = exp(-0.026913854983990002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x350 = exp(0.0056890885971700002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x355 = 0.0071483033566472664 * var_x347;
            const double var_x359 = 0.56744803744318484 * var_x350;
            
            partialF = -var_x355 - var_x359;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative62(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x345 = exp(0.026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x347 = exp(-0.026913854983990002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x349 = exp(-0.045366429595429997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x350 = exp(0.0056890885971700002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x351 = var_x343 * var_x347 * var_x349 / (var_x345 * var_x350);
            const double var_x356 = 1.6926962184371784e-6 * var_x351;
            const double var_x360 = 0.034388156021070745 * var_x349;
            
            partialF = -var_x356 - var_x360;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative64(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x361 = exp(-1.8891230210000001e-5 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x363 = 0.21625575895849999 * var_x361;
            
            partialF = -0.039667206760709998 - var_x363;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative65(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x364 = exp(-0.14999754700285001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x366 = 0.0070080662892900002 * var_x364;
            const double var_x367 = exp(0.08662945914655 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x371 = 0.00767254363063 * var_x367;
            
            partialF = -var_x366 - var_x371;
        }
        else
        {
    ...
    double Celliyer_model_2004FromCellMLGRL2::EvaluatePartialDerivative66(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x369 = exp(-0.014256681268810001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
            const double var_x372 = 0.0037973799836799999 * var_x369;
