...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellespinosa_model_1998_normalFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x47 = var_x44 * (var_x46 - var_x43 * mParameters[7]);
            ...
            const double var_x54 = var_x53 * (var_x46 - var_x52 * mParameters[7]);
            ...
            const double var_x62 = var_x58 * mParameters[7];
            ...
            const double var_x85 = var_x44 * (var_x84 - var_x43 * mParameters[8]);
            ...
            const double var_x88 = var_x53 * (var_x84 - var_x52 * mParameters[8]);
            const double var_x89 = var_x88 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
            const double var_x90 = var_x74 * mParameters[8];
            ...
            const double var_x94 = 1 / mParameters[10];
            const double var_x95 = 0.001 * var_x94;
            
            partialF = -var_x95 * (0.0043499999999999997 + var_x1 + var_x13 + var_x4 + var_x67 + var_x83 + var_x93 + 0.00026738493444818193 * var_x33 + 0.999 * var_x39 - 0.062514597673984929 * var_x42 + var_x28 * (var_x21 + 0.018716945411372737 * var_x17));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x99 = var_x14 * mParameters[16];
            ...
            partialF = -7.0 + var_x191 + var_x192 - 0.00063119563270832375 * var_x102 - 1.0549054718227806e-6 * var_x96 - 4.3552498656874335e-6 * var_x98 - 3.1559781635416187e-6 * var_x101 + (0.00040000000000000002 * var_x196 - 0.00040000000000000002 * var_x194 - 7.1999999999999991e-9 * var_x197) * mParameters[4];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x215) ? (var_x225 + 7.4999999810643199e-10 * var_x206 - 1000.0000025247573 * (-17.999999500000001 + var_chaste_interface__membrane__V) * (7.4999999810643203e-7 * var_x206 + 7.4999999810643203e-7 * var_x207)) : ((var_x221) ? (var_x225 + var_x226) : (var_x226 - var_x213 * var_x224)));
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellespinosa_model_1998_normalFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            partialF = ((var_x232) ? (var_x238 + 2.0000000091613402e-7 * var_x228 - 499.99999948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (0.00019999999949504854 * var_x227 + 0.00020000000091613401 * var_x228)) : (var_x238 - var_x231 * var_x237));
        }
        else
        {
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x234 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x239 = exp(-7.5 + var_x234 + 0.10000000000000001 * mParameters[14]);
            const double var_x240 = 1 / (1.0 + 320.0 * var_x239);
            const double var_x241 = 2.0 * var_x240;
            const double var_x242 = exp(-9.375 + 0.125 * mParameters[14] - 0.125 * var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x255) ? (var_x265 + 8.9999999985934659e-8 * var_x250 - 16666.666669271359 * (4.0000003 + var_chaste_interface__membrane__V) * (8.9999999985934664e-6 * var_x250 + 8.9999999985934664e-6 * var_x251)) : ((var_x261) ? (var_x265 + var_x266) : (var_x266 - var_x253 * var_x264)));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x274) ? (var_x279 - 6.8749999915240775e-9 * var_x267 + 1818.1818204233844 * (23.999999450000001 + var_chaste_interface__membrane__V) * (-3.4374999957620389e-6 * var_x267 - 3.4374999957620389e-6 * var_x268)) : (var_x279 - var_x273 * var_x278));
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellespinosa_model_1998_normalFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            partialF = -8.5800000000000009e-6 * var_x281 - 0.0085800000000000008 / var_x283;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x286 = mParameters[2] + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            const double var_x287 = 1 / var_x286;
            const double var_x289 = mParameters[3] + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
            ...
            partialF = var_x301 + var_x292 * (-0.059999999999999998 - var_x300);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x165 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0) * mParameters[7];
            const double var_x166 = var_x165 * var_x18;
            const double var_x167 = var_x166 * var_x38;
            const double var_x170 = var_x165 * mParameters[16];
            ...
            partialF = (8.2927354147114598e-7 * var_x164 + 2.8403803471874569e-5 * var_x171 - 0.016878487549164489 * var_x162 - 0.00063182746016849224 * var_x175 - 0.0056807606943749134 * var_x167 - 1.6878487549164488e-6 * var_x156 - var_x305 * var_chaste_interface__extracellular_potassium_concentration__K_o) * mParameters[6];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x184 = var_x10 * var_x40 * var_chaste_interface__extracellular_potassium_concentration__K_o * mParameters[15] / pow((1 + 0.10000000000000001 * var_chaste_interface__extracellular_potassium_concentration__K_o), 2);
            ...
            partialF = (-0.00069999999999999999 + var_x314 - var_x312 + 0.00077398863870640285 * var_x179 + 0.00077398863870640285 * var_x188 + 0.001083584094188964 * var_x180 - 8.2704588990905987e-5 * var_x176 - 7.7398863870640281e-6 * var_x184 - var_x176 * var_x313 - var_x30 * var_x311 - var_x310 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * mParameters[6];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (-var_x317 - 6.7513950196657958e-5 * var_x5 - 0.00063182746016849224 * var_x190 + var_x319 * var_x6 - var_x316 * var_x6 - var_x318 * var_x5) * mParameters[6];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.050000000000000003 + (8.4671999999999982e-11 * var_x197 - 4.7039999999999993e-6 * var_x196 - 3.5279999999999993e-7 * var_x194) * mParameters[4];
        }
        else
        {
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x204 = var_x200 * var_x202 * mParameters[1];
            
            partialF = -0.0050000000000000001 - 0.001 * var_x204 - 0.001 * mParameters[0];
        }
        else
        {
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative19(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.050000000000000003 + var_x321;
        }
        else
        {
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL2Opt::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.20000000000000001 + var_x321;
        }
        else
        {
