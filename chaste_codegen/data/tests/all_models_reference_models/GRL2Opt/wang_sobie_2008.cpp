...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellwang_sobie_2008FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            partialF = ((var_x319) ? (var_x323 + var_x324 - 640000.00016065314 * (26.500000781250002 + var_chaste_interface__membrane__V) * (var_x323 + 3.760414053005867e-12 * var_x314)) : (var_x324 - var_x318 * var_x322));
        }
        else
        {
