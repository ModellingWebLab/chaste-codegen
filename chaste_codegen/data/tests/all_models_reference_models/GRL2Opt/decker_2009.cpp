...
#include "MathsCustomFunctions.hpp"
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x84 = 1 + 0.38461538461538458 * var_chaste_interface__Na__Na_i;
            const double var_x85 = pow(var_x84, (-3));
            const double var_x86 = exp(-3.4441726741524206 - var_x12);
            const double var_x87 = 1.0 + var_x86;
            const double var_x88 = var_x62 * var_x85 * var_x86 / pow(var_x87, 2);
            const double var_x89 = (var_chaste_interface__ICaL__O + var_chaste_interface__ICaL__O_star) * mParameters[0];
            const double var_x90 = 14448.603861345418 * var_x89;
            const double var_x91 = -0.61380000000000001 + var_x37 * var_chaste_interface__Ca__Ca_ss_CaL;
            const double var_x92 = var_x36 * var_x91;
            const double var_x93 = var_x36 * var_x50;
            ...
            const double var_x96 = var_x25 * var_x30 / pow(var_x26, 2);
            const double var_x97 = 0.24326999999999999 * var_x55 - 0.51429999999999998 * var_x96 - var_x27 * (0.061749999999999999 * var_x29 + 0.039456396800000001 * var_x28);
            const double var_x98 = var_x24 * var_x41 / pow((var_x24 + 0.98039215686274506 * var_x31), 2);
            ...
            const double var_x109 = var_x108 * var_x53;
            const double var_x110 = var_x41 * var_x43 * mParameters[2] * var_chaste_interface__IKr_xr_gate__xr / pow(var_x44, 2);
            const double var_x111 = var_x41 * var_chaste_interface__Ito1_i1f_gate__i1f;
            const double var_x112 = var_x111 * var_x82;
            const double var_x113 = 6.4800000000000004 * var_x64 - 9878400.0 * var_x65;
            const double var_x114 = var_x113 * var_x69;
            const double var_x115 = var_x58 / pow(var_x59, 2);
            const double var_x116 = 0.0087452036595870152 * var_x115;
            const double var_x117 = 1.6200000000000001 * var_x72 - 2469600.0 * var_x73;
            const double var_x118 = var_x117 * var_x78;
            const double var_x119 = 1081.8149260630225 * var_x89;
            const double var_x120 = var_x51 * var_x91;
            const double var_x121 = var_x104 * var_x107 * var_x53 / pow(var_x100, 2);
            const double var_x122 = var_x93 * var_chaste_interface__Ca__Ca_ss_CaL;
            
            partialF = -0.00022499999999999999 + var_x9 - var_x49 + 0.012170417918209005 * var_x109 + 0.064935064935064929 * var_x110 + 0.00021583116499495196 * var_x52 + 4.3272597042520909e-7 * var_x54 + 0.12163499999999999 * var_x57 - 0.0027599999999999999 * var_x2 - 0.00012170417918209004 * var_x121 - 0.00233372538501551 * var_x88 - 1.1558883089076335e-5 * var_x18 - 0.00021583116499495196 * var_x94 - 4.3272597042520909e-7 * var_x95 - 0.00090454545454545453 * var_x112 - 0.51000000000000001 * var_x33 - 0.0028826178386108462 * var_x39 - 0.00046153846153846147 * var_x42 + var_x119 * var_x120 - var_x106 * var_chaste_interface__Ito2_i2f_gate__i2f - var_x11 * var_chaste_interface__INaL_hL_gate__hL - var_x114 * var_x116 - var_x116 * var_x118 - var_x119 * var_x122 - var_x46 * var_chaste_interface__IKr_xr_gate__xr - var_x61 * var_x70 - var_x61 * var_x79 - var_x83 * var_chaste_interface__Ito1_i1f_gate__i1f - var_x90 * var_x92 - var_x97 * var_x99;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x113 = 6.4800000000000004 * var_x64 - 9878400.0 * var_x65;
            const double var_x114 = var_x113 * var_x69;
            const double var_x123 = 0.00050000000000000001 + var_chaste_interface__Ca__Ca_i;
            const double var_x124 = 1 / var_x123;
            const double var_x125 = pow(var_x123, (-2));
            const double var_x126 = var_x125 * var_chaste_interface__Ca__Ca_i;
            const double var_x127 = var_x58 * var_x60;
            const double var_x128 = var_x127 * var_x69;
            const double var_x130 = var_x113 * var_x67 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x62 + var_chaste_interface__Ca__Ca_i), 2);
            const double var_x132 = var_x113 * var_x68 / (pow(var_x66, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
            const double var_x162 = var_x130 * var_x60;
            const double var_x180 = 0.0023800000000000002 + var_chaste_interface__Ca__Ca_i;
            const double var_x181 = 1.0 + 0.00011900000000000002 / pow(var_x180, 2) + 3.5000000000000004e-5 * var_x125;
            const double var_x182 = 1 / var_x181;
            const double var_x183 = 8.8930116629204303e-8 * var_x39;
            const double var_x184 = 6.1700941025231664e-5 * var_x60;
            const double var_x186 = 1.7739020544754105e-6 * var_x124;
            const double var_x187 = 1.0 - var_chaste_interface__CaMK_active__CaMK_trap;
            const double var_x188 = 1.0 + 0.0015 / var_chaste_interface__Ca__Ca_ss_sr;
            const double var_x189 = 1 / var_x188;
            const double var_x190 = 0.050000000000000003 * var_x189;
            const double var_x191 = var_x187 * var_x190 + var_chaste_interface__CaMK_active__CaMK_trap;
            const double var_x192 = 0.14999999999999999 + var_x191;
            const double var_x193 = 1 / var_x192;
            const double var_x194 = var_x191 * var_x193;
            const double var_x195 = 0.00092000000000000003 - 0.00017000000000000001 * var_x194 + var_chaste_interface__Ca__Ca_i;
            const double var_x196 = 1 / var_x195;
            const double var_x197 = 1.0 + 0.75 * var_x194;
            const double var_x198 = var_x196 * var_x197;
            const double var_x199 = 0.00035619469026548675 * var_x198;
            const double var_x200 = 0.00035619469026548675 * var_chaste_interface__Ca__Ca_i;
            const double var_x201 = var_x197 / pow(var_x195, 2);
            const double var_x202 = var_x200 * var_x201;
            const double var_x203 = var_x132 * var_x60;
            
            partialF = var_x182 * (-0.014749262536873154 + var_x202 - var_x186 - var_x199 + 1.9281544070384897e-12 * var_x203 + 1.7739020544754105e-6 * var_x126 - 609.50657582364852 * var_x128 - 1.4202553819674954e-11 * var_x162 - 8.8930116629204303e-8 * var_x93) + (0.00023800000000000004 / pow(var_x180, 3) + 7.0000000000000007e-5 / pow(var_x123, 3)) * (2.3746312684365782e-5 * var_chaste_interface__Ca__Ca_NSR + 0.014749262536873154 * var_chaste_interface__Ca__Ca_ss_sr - 0.014749262536873154 * var_chaste_interface__Ca__Ca_i + var_x114 * var_x184 - var_x183 * var_chaste_interface__membrane__Vm - var_x186 * var_chaste_interface__Ca__Ca_i - var_x199 * var_chaste_interface__Ca__Ca_i) / pow(var_x181, 2);
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x217 = exp(0.0011184950759309986 * var_chaste_interface__membrane__Vm);
            const double var_x221 = 0.059456000000000002 * var_x217;
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x217 = exp(0.0011184950759309986 * var_chaste_interface__membrane__Vm);
            const double var_x219 = exp(-0.0020762745726213851 * var_chaste_interface__membrane__Vm);
            const double var_x222 = 0.083986000000000005 * var_x219;
            const double var_x225 = exp(0.0091588787470803235 * var_chaste_interface__membrane__Vm);
            const double var_x231 = 0.044592 * var_x217;
            const double var_x232 = -var_x231;
            const double var_x233 = 0.014600999999999999 * var_x225;
            const double var_x234 = -var_x222 - var_x233;
            
            partialF = var_x232 + var_x234;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x219 = exp(-0.0020762745726213851 * var_chaste_interface__membrane__Vm);
            const double var_x225 = exp(0.0091588787470803235 * var_chaste_interface__membrane__Vm);
            const double var_x235 = 0.16797200000000001 * var_x219;
            const double var_x242 = 0.029728000000000001 * var_x217;
            const double var_x243 = -var_x242;
            const double var_x244 = 0.029201999999999999 * var_x225;
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x219 = exp(-0.0020762745726213851 * var_chaste_interface__membrane__Vm);
            const double var_x225 = exp(0.0091588787470803235 * var_chaste_interface__membrane__Vm);
            const double var_x246 = 0.25195800000000002 * var_x219;
            const double var_x252 = 0.014864 * var_x217;
            const double var_x253 = -var_x252;
            const double var_x254 = 0.043802999999999995 * var_x225;
            const double var_x255 = -var_x246 - var_x254;
            
            partialF = var_x253 + var_x255;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x219 = exp(-0.0020762745726213851 * var_chaste_interface__membrane__Vm);
            const double var_x225 = exp(0.0091588787470803235 * var_chaste_interface__membrane__Vm);
            const double var_x256 = 0.33594400000000002 * var_x219;
            const double var_x258 = 0.058403999999999998 * var_x225;
            
            partialF = -var_x256 - var_x258;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x217 = exp(0.0011184950759309986 * var_chaste_interface__membrane__Vm);
            const double var_x228 = exp(-0.01595737611258119 * var_chaste_interface__membrane__Vm);
            const double var_x231 = 0.044592 * var_x217;
            const double var_x232 = -var_x231;
            const double var_x236 = 0.0031172999999999999 * var_x228;
            const double var_x259 = -var_x236;
            
            partialF = var_x232 + var_x259;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x234 + var_x243 + var_x259;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x245 + var_x253 + var_x259;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x242 = 0.029728000000000001 * var_x217;
            const double var_x243 = -var_x242;
            const double var_x261 = 0.0062345999999999999 * var_x228;
            const double var_x262 = -var_x261;
            
            partialF = var_x243 + var_x262;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x234 + var_x253 + var_x262;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x252 = 0.014864 * var_x217;
            const double var_x253 = -var_x252;
            const double var_x264 = 0.0093518999999999998 * var_x228;
            const double var_x265 = -var_x264;
            
            partialF = var_x253 + var_x265;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x228 = exp(-0.01595737611258119 * var_chaste_interface__membrane__Vm);
            const double var_x267 = 0.0124692 * var_x228;
            
            partialF = -0.089538000000000006 - var_x267;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x268 = exp(-0.0024231252229042349 * var_chaste_interface__membrane__Vm);
            const double var_x270 = 0.07732 * var_x268;
            const double var_x271 = exp(0.0105593841790373 * var_chaste_interface__membrane__Vm);
            const double var_x275 = 0.58638000000000001 * var_x271;
            
            partialF = -var_x270 - var_x275;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x273 = exp(-0.003001446738885828 * var_chaste_interface__membrane__Vm);
            const double var_x276 = 0.79405000000000003 * var_x273;
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x277 = exp(5.833333333333333 + 0.33333333333333331 * var_chaste_interface__membrane__Vm);
            const double var_x278 = 1.0 + var_x277;
            const double var_x279 = 1 / var_x278;
            const double var_x280 = 0.80000000000000004 * var_x279;
            const double var_x281 = exp(-0.019709447580272044 - 0.092532617747756077 * var_chaste_interface__membrane__Vm);
            const double var_x282 = 1.0 + var_x281;
            const double var_x284 = exp(4.7444197507005512 + 0.096627693496956227 * var_chaste_interface__membrane__Vm);
            const double var_x285 = 1.0 + var_x284;
            const double var_x288 = 0.040277106492669565 / var_x285;
            const double var_x289 = 1 / var_x282;
            const double var_x290 = var_x288 + 0.032730010146303147 * var_x289;
            const double var_x294 = exp(1.4349206349206352 - 0.10582010582010583 * var_chaste_interface__membrane__Vm);
            const double var_x295 = 1.0 + var_x294;
            const double var_x296 = exp(1.7160000000000002 + 0.13200000000000001 * var_chaste_interface__membrane__Vm);
            const double var_x297 = 1.0 + var_x296;
            const double var_x298 = exp(0.67599999999999993 + 0.051999999999999998 * var_chaste_interface__membrane__Vm);
            const double var_x299 = var_x298 / var_x297;
            const double var_x300 = 1 / (0.58999999999999997 + 0.80000000000000004 * var_x299);
            const double var_x302 = 1 / var_x295;
            const double var_x310 = var_x300 * var_x302;
            const double var_x311 = -var_x310;
            const double var_x312 = 1.0 + 8.1000000000000005e-11 / pow(var_chaste_interface__Ca__Ca_ss_CaL, 4);
            const double var_x313 = 1 / var_x312;
            const double var_x314 = 3.0 * var_x313;
            const double var_x315 = -var_x280;
            const double var_x316 = 0.80000000000000004 + var_x315;
            const double var_x317 = var_x290 * var_x316;
            const double var_x318 = -var_x314 - var_x317;
            
            partialF = var_x311 + var_x318;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x300 = 1 / (0.58999999999999997 + 0.80000000000000004 * var_x299);
            const double var_x302 = 1 / var_x295;
            const double var_x308 = 1.0 - var_x302;
            const double var_x312 = 1.0 + 8.1000000000000005e-11 / pow(var_chaste_interface__Ca__Ca_ss_CaL, 4);
            const double var_x313 = 1 / var_x312;
            const double var_x314 = 3.0 * var_x313;
            const double var_x315 = -var_x280;
            ...
            const double var_x317 = var_x290 * var_x316;
            const double var_x318 = -var_x314 - var_x317;
            const double var_x319 = var_x300 * var_x308;
            const double var_x325 = -var_x319;
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x312 = 1.0 + 8.1000000000000005e-11 / pow(var_chaste_interface__Ca__Ca_ss_CaL, 4);
            const double var_x313 = 1 / var_x312;
            const double var_x327 = 0.99990000999900008 * var_x279;
            const double var_x329 = 1 / (25.0 - 17.5 * var_x313);
            const double var_x331 = var_x288 + var_x289 * var_x329;
            const double var_x336 = -var_x327;
            const double var_x337 = 0.99990000999900008 + var_x336;
            const double var_x338 = var_x331 * var_x337;
            const double var_x339 = -1.0 - var_x338;
            
            partialF = var_x311 + var_x339;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative23(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x300 = 1 / (0.58999999999999997 + 0.80000000000000004 * var_x299);
            const double var_x302 = 1 / var_x295;
            const double var_x306 = 0.20000000000000001 + var_x280;
            const double var_x310 = var_x300 * var_x302;
            const double var_x311 = -var_x310;
            const double var_x312 = 1.0 + 8.1000000000000005e-11 / pow(var_chaste_interface__Ca__Ca_ss_CaL, 4);
            const double var_x313 = 1 / var_x312;
            const double var_x315 = -var_x280;
            const double var_x316 = 0.80000000000000004 + var_x315;
            const double var_x320 = var_x290 * var_x306;
            const double var_x327 = 0.99990000999900008 * var_x279;
            const double var_x334 = 9.9990000999900015e-5 + var_x327;
            const double var_x336 = -var_x327;
            const double var_x337 = 0.99990000999900008 + var_x336;
            const double var_x344 = 1 / var_x316;
            const double var_x345 = 1 / var_x334;
            const double var_x346 = var_x313 * var_x337 * var_x344 * var_x345;
            const double var_x356 = 3.0000000000000001e-6 * var_x306 * var_x346;
            const double var_x357 = -var_x320 - var_x356;
            
            partialF = var_x311 + var_x357;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x331 = var_x288 + var_x289 * var_x329;
            const double var_x334 = 9.9990000999900015e-5 + var_x327;
            const double var_x340 = var_x331 * var_x334;
            const double var_x364 = -9.9999999999999995e-7 - var_x340;
            
            partialF = var_x311 + var_x364;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative27(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x368 = -0.10000000000000001 * var_chaste_interface__membrane__Vm;
            const double var_x369 = exp(-4.7130000000000001 + var_x368);
            const double var_x370 = 1.0 - var_x369;
            const double var_x371 = 0.32000000000000001 / var_x370;
            const double var_x372 = exp(-0.090909090909090912 * var_chaste_interface__membrane__Vm);
            const double var_x374 = 47.130000000000003 + var_chaste_interface__membrane__Vm;
            const double var_x376 = -0.080000000000000002 * var_x372 - var_x371 * var_x374;
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative28(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x377 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__Vm);
            const double var_x378 = 1.0 + var_x377;
            const double var_x379 = var_chaste_interface__membrane__Vm >= -40.0;
            const double var_x380 = exp(0.079000000000000001 * var_chaste_interface__membrane__Vm);
            const double var_x381 = exp(0.34999999999999998 * var_chaste_interface__membrane__Vm);
            const double var_x382 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__Vm);
            
            partialF = ((var_x379) ? (-7.6923076923076916 / var_x378) : (-310000.0 * var_x381 - 0.13500000000000001 * var_x382 - 3.5600000000000001 * var_x380));
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x368 = -0.10000000000000001 * var_chaste_interface__membrane__Vm;
            const double var_x379 = var_chaste_interface__membrane__Vm >= -40.0;
            const double var_x383 = exp(-3.2000000000000002 + var_x368);
            const double var_x384 = 1.0 + var_x383;
            const double var_x385 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__Vm);
            const double var_x386 = var_x385 / var_x384;
            ...
            const double var_x395 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__Vm);
            const double var_x396 = 1.0 + var_x395;
            const double var_x397 = exp(-0.01052 * var_chaste_interface__membrane__Vm);
            const double var_x398 = var_x397 / var_x396;
            const double var_x399 = 37.780000000000001 + var_chaste_interface__membrane__Vm;
            
            partialF = ((var_x379) ? (-0.29999999999999999 * var_x386) : (-0.1212 * var_x398 - var_x394 * var_x399));
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative32(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x405 = exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm);
            const double var_x406 = -1.0 + var_x405;
            const double var_x407 = 0.00029999999999999997 / var_x406;
            const double var_x408 = exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm);
            const double var_x409 = 1.0 - var_x408;
            const double var_x410 = 0.00059999999999999995 / var_x409;
            const double var_x411 = -1.7383999999999999 + var_chaste_interface__membrane__Vm;
            const double var_x412 = 38.360799999999998 + var_chaste_interface__membrane__Vm;
            const double var_x413 = var_x407 * var_x412;
            const double var_x414 = var_x410 * var_x411;
            
            partialF = -var_x413 - var_x414;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative33(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x417 = 0.034035137876343539 * var_chaste_interface__membrane__Vm;
            const double var_x418 = exp(0.62658348478969694 - var_x417);
            const double var_x419 = 1.0 + var_x418;
            const double var_x420 = exp(3.403513787634354 + var_x417);
            const double var_x421 = 1.0 + var_x420;
            const double var_x422 = 3.5 / var_x421;
            const double var_x423 = 0.82719827942757873 / var_x419;
            
            partialF = -var_x422 - var_x423;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative34(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x424 = 0.20000000000000001 * var_chaste_interface__membrane__Vm;
            const double var_x425 = exp(11.6 + var_x424);
            const double var_x426 = 1.0 + var_x425;
            const double var_x429 = exp(-2.1111111111111112 - 0.1111111111111111 * var_chaste_interface__membrane__Vm);
            const double var_x430 = 1.0 + var_x429;
            const double var_x433 = 1 / var_x426;
            const double var_x434 = 0.025000000000000001 * var_x433;
            const double var_x435 = 1 / var_x430;
            const double var_x436 = -0.10208977775055385 * var_x435;
            
            partialF = var_x436 - var_x434;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative35(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x435 = 1 / var_x430;
            const double var_x436 = -0.10208977775055385 * var_x435;
            const double var_x437 = exp(12.0 + var_x424);
            const double var_x438 = 1.0 + var_x437;
            
            partialF = var_x436 - 0.0040000000000000001 / var_x438;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative37(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x190 = 0.050000000000000003 * var_x189;
            const double var_x191 = var_x187 * var_x190 + var_chaste_interface__CaMK_active__CaMK_trap;
            const double var_x439 = 1 / var_x191;
            const double var_x440 = pow(var_x439, 10.0);
            const double var_x441 = 1.0 + 2.9619676669542428e-6 * var_x440;
            const double var_x442 = 1 / var_x441;
            const double var_x443 = 4.75 + 4.75 * var_x442;
            const double var_x444 = 1 / var_chaste_interface__Ca__Ca_JSR;
            const double var_x453 = 1 / var_x443;
            const double var_x454 = 1.0 + 0.0123 * var_x444;
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative38(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x467 + 0.25 * (var_x457 + 0.040000000000000001 * var_chaste_interface__Ca__Ca_NSR - 0.040000000000000001 * var_chaste_interface__Ca__Ca_JSR) / (pow(var_x464, 3) * pow((0.125 + var_x465), 2));
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative40(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x118 = var_x117 * var_x78;
            const double var_x127 = var_x58 * var_x60;
            const double var_x152 = var_x127 * var_x78;
            const double var_x153 = var_x117 * var_x76 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x71 + var_chaste_interface__Ca__Ca_ss_sr), 2);
            const double var_x154 = var_x117 * var_x77 / (pow(var_x75, 2) * pow(var_chaste_interface__Ca__Ca_ss_sr, 3));
            const double var_x168 = var_x153 * var_x60;
            const double var_x471 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_sr;
            const double var_x472 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_sr;
            ...
            const double var_x475 = 0.0020916619007553534 * var_x60;
            const double var_x477 = var_x154 * var_x60;
            
            partialF = var_x474 * (-5.5 + 6.53644343986048e-11 * var_x477 - 4.8146657448698097e-10 * var_x168 - 5165.5682301054212 * var_x152) + (0.019557600000000001 / pow(var_x471, 3) + 8.1780000000000006e-5 / pow(var_x472, 3)) * (0.5 * var_chaste_interface__Ca__Ca_ss_CaL + 0.23999999999999996 * var_chaste_interface__Irel__Irel + 5.0 * var_chaste_interface__Ca__Ca_i - 5.5 * var_chaste_interface__Ca__Ca_ss_sr + var_x118 * var_x475) / pow(var_x473, 2);
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative41(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x92 = var_x36 * var_x91;
            const double var_x93 = var_x36 * var_x50;
            const double var_x137 = var_x92 * var_chaste_interface__membrane__Vm;
            const double var_x478 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_CaL;
            const double var_x479 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_CaL;
            const double var_x480 = 1.0 + 0.0097788000000000007 / pow(var_x478, 2) + 4.0890000000000003e-5 / pow(var_x479, 2);
            const double var_x481 = 1 / var_x480;
            const double var_x482 = 151.10797107941448 * var_x89;
            
            partialF = var_x481 * (-5.0 - var_x482 * var_x93) + (0.019557600000000001 / pow(var_x478, 3) + 8.1780000000000006e-5 / pow(var_x479, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x137 * var_x482) / pow(var_x480, 2);
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative42(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x141 = var_x19 * log10(140.0 * var_x140);
            const double var_x155 = 1 / var_x87;
            const double var_x156 = var_x155 * var_x62 / pow(var_x84, 4);
            const double var_x158 = var_x15 * var_x53;
            const double var_x159 = var_x10 * var_x140 * var_chaste_interface__INaL_hL_gate__hL;
            const double var_x160 = pow(var_chaste_interface__Na__Na_i, 2);
            const double var_x161 = var_x155 * var_x160 * var_x85;
            const double var_x162 = var_x130 * var_x60;
            const double var_x163 = var_x160 * var_x162;
            const double var_x164 = var_x140 * var_x49;
            const double var_x165 = var_x60 * var_x63;
            const double var_x166 = var_x160 * var_x165 * var_x69;
            const double var_x171 = 1 / var_chaste_interface__Cl__Cl_i;
            const double var_x486 = var_x19 * log10(100.0 * var_x171);
            const double var_x487 = var_x141 + var_x486;
            const double var_x488 = pow(var_x487, 4);
            const double var_x489 = 7.2087469970547496e-9 * pow(var_x487, 7) / pow((1 + 0.0085573053764671191 * var_x488), 2);
            const double var_x490 = 50.118419258935766 * pow(var_x487, 3) / (59494197.640692554 + 509110.01733929582 * var_x488);
            const double var_x491 = var_x140 * var_x489 - var_x140 * var_x490;
            
            partialF = -0.14749262536873156 + var_x491 + 2.4740119415402899e-16 * var_x163 + 1.3314155043174696e-5 * var_x156 - 3.4616803112254212e-5 * var_x161 - 7.1319396379664657e-10 * var_x158 - 0.0016481422714144972 * var_x164 - 1.0712924764194231e-5 * var_x159 - 0.0035983988805915112 * var_x166;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative43(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x170 = var_x165 * var_x167 * var_x78;
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative44(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x489 = 7.2087469970547496e-9 * pow(var_x487, 7) / pow((1 + 0.0085573053764671191 * var_x488), 2);
            const double var_x490 = 50.118419258935766 * pow(var_x487, 3) / (59494197.640692554 + 509110.01733929582 * var_x488);
            const double var_x492 = var_x171 * var_x489 - var_x171 * var_x490;
            const double var_x493 = var_x40 + 26.711785007306684 * var_x486;
            const double var_x494 = 0.00047279859462932828 / (87.825100000000006 + var_x493);
            const double var_x495 = 6.1296950776416711e-8 * var_x493 / pow((1 + 0.30414750461208334 * var_x21 + 0.30414750461208334 * var_x486), 2);
            const double var_x496 = var_x171 * var_x495 - var_x171 * var_x494;
            
            partialF = -0.14749262536873156 + var_x492 + var_x496 - 3.7083201106826184e-7 * var_x171;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative46(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x171 = 1 / var_chaste_interface__Cl__Cl_i;
            const double var_x173 = var_x2 * var_x20;
            const double var_x174 = var_x20 * var_x33;
            const double var_x175 = var_x20 * var_x55;
            const double var_x176 = 6.4981759387274964 * var_x175 - var_x27 * (1.0539507884845836 * var_x20 * var_x28 + 1.6494527242011876 * var_x20 * var_x29) - 13.737871029257827 * var_x20 * var_x96;
            const double var_x177 = var_x20 * var_x45 * var_chaste_interface__IKr_xr_gate__xr;
            const double var_x178 = var_x175 * var_x56;
            const double var_x179 = var_x20 * var_x82 * var_chaste_interface__Ito1_i1f_gate__i1f;
            const double var_x486 = var_x19 * log10(100.0 * var_x171);
            const double var_x493 = var_x40 + 26.711785007306684 * var_x486;
            const double var_x494 = 0.00047279859462932828 / (87.825100000000006 + var_x493);
            const double var_x495 = 6.1296950776416711e-8 * var_x493 / pow((1 + 0.30414750461208334 * var_x21 + 0.30414750461208334 * var_x486), 2);
            const double var_x497 = var_x20 * var_x495 - var_x20 * var_x494;
            const double var_x499 = -5.0964977286841363e-6 - 3.0578986372104813e-6 * var_x6;
            const double var_x500 = var_x499 * var_x8;
            const double var_x503 = 3.0245559326093954e-5 * var_x98;
            const double var_x505 = var_x133 * var_x500;
            
            partialF = var_x497 + 0.00020047178518350236 * var_x178 + 26.711785007306684 * var_x505 - 4.5488726691040119e-6 * var_x173 - 0.00081995078002871237 * var_x179 - 0.0016481422714144972 * var_x177 - 0.0008405525584213936 * var_x174 - var_x176 * var_x503;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL2::EvaluatePartialDerivative47(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x190 = 0.050000000000000003 * var_x189;
            const double var_x191 = var_x187 * var_x190 + var_chaste_interface__CaMK_active__CaMK_trap;
            const double var_x211 = 1 - var_x190;
            const double var_x506 = 0.0025000000000000005 * var_x189;
            
            partialF = -0.00068000000000000005 - var_x191 * var_x506 + var_x187 * var_x211 * var_x506;
        }
        else
        {
