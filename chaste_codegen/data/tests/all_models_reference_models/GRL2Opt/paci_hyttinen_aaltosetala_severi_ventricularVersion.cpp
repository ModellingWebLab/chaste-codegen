...
std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables> Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables::mpInstance;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x41 = exp(-11.604506155051096 * var_x7);
            const double var_x42 = exp(-1.1604506155051095 * var_x7);
            const double var_x43 = 1.0 + 0.035299999999999998 * var_x41 + 0.1245 * var_x42;
            const double var_x44 = var_x39 * var_x40 * (0.14447610163038616 * var_x42 * var_x6 + 0.40963906727330363 * var_x41 * var_x6) * mParameters[2] * var_chaste_interface__sodium_dynamics__Nai / pow(var_x43, 2);
            const double var_x45 = var_x9 - 2.8571431999999999 * var_x13;
            const double var_x46 = var_x10 * var_x15 * var_x45 * var_x6 / pow(var_x14, 2);
            ...
            partialF = -0.00159264 - 4900.0 * var_x17 - 1.8414239999999999 * var_x44 - 0.001 * var_x5 - 3696.035210383774 * var_x46 + var_x56 * var_x58 - var_x18 * var_x20 - var_x50 * var_x54 - var_x56 * var_x59 - 0.001 * mParameters[6] * var_chaste_interface__i_f_Xf_gate__Xf - 0.0016825960981856666 * var_x24 * var_x33 - 0.00043033148291193521 * var_x34 * var_chaste_interface__i_Kr_Xr1_gate__Xr1 + 0.99979860154192302 * var_x33 * var_x37 * var_x38 - 0.001 * mParameters[10] * var_chaste_interface__i_to_q_gate__q * var_chaste_interface__i_to_r_gate__r - 0.11005920279077626 * var_x24 * var_x32 * var_x37 * (2.3233220000000001 * var_x38 - var_x27 * (0.58860000000000001 * var_x29 - 0.00030180000000000002 * var_x28) + 0.45469999999999999 * var_x25 * var_x30 / pow(var_x26, 2)) * mParameters[7] / pow((var_x24 + 0.25575447570332482 * var_x31), 2);
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x137 = var_x35 < -0.040000000000000001;
            
            partialF = ((var_x137) ? (-0.037999999999999999 * var_x134 - 1.8 * var_x133 - 206666.66666666669 * var_x132) : (-0.39339103068450043));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x35 = 0.001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x137 = var_x35 < -0.040000000000000001;
            const double var_x138 = exp(0.24440000000000001 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x139 = exp(-0.043909999999999998 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x140 = -25428.0 * var_x138 - 6.9480000000000002e-6 * var_x139;
            const double var_x141 = exp(24.640530000000002 + 0.311 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x142 = 1.0 + var_x141;
            const double var_x143 = 1 / var_x142;
            const double var_x146 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x147 = 1.0 + var_x146;
            const double var_x148 = exp(-0.01052 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x149 = var_x148 / var_x147;
            const double var_x150 = 37.780000000000001 + var_chaste_interface__Membrane__Vm_converted;
            const double var_x151 = var_x140 * var_x150;
            const double var_x153 = 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x154 = exp(-3.2000000000000002 - var_x153);
            const double var_x155 = 1.0 + var_x154;
            const double var_x156 = exp(0.057000000000000002 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x157 = var_x156 / var_x155;
            
            partialF = ((var_x137) ? (-0.003462857142857143 * var_x149 - 0.14285714285714285 * var_x143 * var_x151) : (-0.085714285714285715 * var_x157));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x114 = 0.20000000000000001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x160 = 0.050000000000000003 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x161 = -var_x160;
            const double var_x162 = exp(2.5 + var_x161);
            const double var_x163 = 1.0 + var_x162;
            const double var_x164 = 1 / var_x163;
            const double var_x165 = exp(1.0 + var_x114);
            const double var_x166 = 1.0 + var_x165;
            const double var_x167 = 1 / var_x166;
            const double var_x168 = 0.076923076923076927 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x169 = exp(-2.6923076923076925 - var_x168);
            const double var_x170 = 1.0 + var_x169;
            const double var_x171 = 0.25 + 1.3999999999999999 / var_x170;
            const double var_x172 = var_x167 * var_x171;
            const double var_x173 = 1 / (0.001 * var_x164 + 0.0014 * var_x172);
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x174 = 1 / (0.92835000000000001 + 1433.0 * var_chaste_interface__calcium_dynamics__Cai);
            const double var_x175 = 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x176 = exp(3.0 + var_x175);
            const double var_x177 = 1.0 + var_x176;
            const double var_x178 = 1 / var_x177;
            const double var_x179 = -var_x175;
            const double var_x180 = exp(1.3 + var_x179);
            const double var_x181 = 1.0 + var_x180;
            const double var_x182 = 1 / var_x181;
            const double var_x183 = 1 + 0.037037037037037035 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x184 = exp(-2361.96 * pow(var_x183, 4));
            const double var_x185 = exp(8.6666666666666661 + 0.33333333333333331 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x186 = 1.0 + var_x185;
            const double var_x187 = 1 / var_x186;
            const double var_x191 = 1 / (20.0 + 200.0 * var_x182 + 180.0 * var_x178 + 1102.5 * var_x184);
            const double var_x193 = -var_x187 + var_chaste_interface__i_CaL_f1_gate__f1 < 0;
            const double var_x194 = var_x191;
            
            partialF = ((var_x193) ? (-var_x174 * var_x194) : (-var_x194));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x178 = 1 / var_x177;
            const double var_x179 = -var_x175;
            const double var_x195 = exp(2.5 + var_x179);
            const double var_x196 = 1.0 + var_x195;
            const double var_x197 = 1 / var_x196;
            const double var_x198 = exp(-3.6764705882352939 * pow((1 + 0.040000000000000001 * var_chaste_interface__Membrane__Vm_converted), 2));
            const double var_x201 = 0.59999999999999998 * var_x198;
            const double var_x202 = 1 / (var_x201 + 0.016 * var_x178 + 0.031 * var_x197);
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x35 = 0.001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x203 = exp(-0.9375 + 1250.0 * var_chaste_interface__calcium_dynamics__Cai);
            const double var_x204 = 1.0 + var_x203;
            const double var_x205 = exp(-9.0 + 10000.0 * var_chaste_interface__calcium_dynamics__Cai);
            const double var_x206 = 1.0 + var_x205;
            const double var_x207 = pow(var_chaste_interface__calcium_dynamics__Cai, 8);
            const double var_x208 = (var_x35 > -0.059999999999999998) && (var_chaste_interface__i_CaL_fCa_gate__fCa < 0.22803283672848887 / var_x204 + 0.076010945576162961 / var_x206 + 0.76010945576162958 / (1.0 + 5.9537418076512766e+25 * var_x207));
            
            partialF = ((var_x208) ? (0) : (-0.5));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x175 = 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x179 = -var_x175;
            const double var_x209 = exp(-4.5 + var_x179);
            const double var_x210 = 1.0 + var_x209;
            const double var_x214 = exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x215 = 0.00037037037037037035 + 0.00037037037037037035 * var_x214;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative10(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x160 = 0.050000000000000003 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x161 = -var_x160;
            const double var_x217 = exp(-3.0 + var_x161);
            const double var_x218 = 1.0 + var_x217;
            const double var_x222 = exp(-3.0 + var_x160);
            const double var_x223 = 0.29761904761904762 + 0.29761904761904762 * var_x222;
            const double var_x224 = var_x218 * var_x223;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x160 = 0.050000000000000003 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x222 = exp(-3.0 + var_x160);
            const double var_x225 = exp(-1.6666666666666667 - 0.16666666666666666 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x226 = sqrt(1.0 + var_x225);
            const double var_x230 = 1.0 + var_x222;
            const double var_x231 = var_x226 * var_x230;
            
            partialF = -0.00090909090909090909 * var_x231;
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x175 = 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x234 = exp(1.5 + var_x175);
            const double var_x235 = 0.0005263157894736842 * var_x234;
            
            partialF = -0.0005263157894736842 - var_x235;
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x153 = 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x238 = exp(4.593 + var_x153);
            const double var_x239 = exp(-3.52 - 0.080000000000000002 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x240 = 1 / (0.065000000000000002 * var_x238 + 0.56999999999999995 * var_x239);
            const double var_x241 = 1 / (0.0060599999999999994 + 0.039101999999999998 * var_x240);
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x244 = exp(2.7548999999999997 + 0.089999999999999997 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x245 = exp(-2.8607999999999998 - 0.12 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x246 = 1 / (1.0369999999999999 * var_x244 + 0.36899999999999999 * var_x245);
            const double var_x247 = 1 / (0.0027535199999999998 + 0.01440516 * var_x246);
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x84 = var_x39 * mParameters[2] / var_x43;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x251 = 0.015075462970894076 / (1.0 + 3.0 * var_x250);
            
            partialF = var_x251 * (-0.00044443999999999999 + var_x104 * (var_x113 - var_x112)) + 0.010050308647262718 * (var_x98 + var_x99 - var_x105 - var_x97) / (pow(var_x249, 3) * pow((0.33333333333333337 + var_x250), 2));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x256 = var_chaste_interface__calcium_dynamics__Cai > 0.00035;
            const double var_x257 = (var_x254) || (var_x256);
            const double var_x258 = pow(var_chaste_interface__calcium_dynamics__Cai, 16);
            const double var_x259 = (var_x253) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x258));
            const double var_x260 = pow(var_chaste_interface__calcium_dynamics__Cai, 6);
            const double var_x261 = (var_x256) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x260));
            const double var_x262 = (var_x253) && (var_x255) && (var_x257) && (var_x259) && (var_x261);
            const double var_x263 = (var_x255) && (var_x257) && (var_x259) && (var_x261);
            
            partialF = ((var_x262) ? (0) : ((var_x253) ? (-0.5) : ((var_x263) ? (0) : (-0.5))));
        }
        else
        {
