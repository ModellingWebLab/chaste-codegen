...
class Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables);
        }
    ...
    ~Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables()
    {

    }

protected:
    Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables(const Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables&);
    Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables& operator= (const Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables&);
    Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables()
    {
        ...
        Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables> mpInstance;

};

std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables> Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt>::Instance();
        Init();
    ...
    Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::~Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt()
    {
    }

    AbstractLookupTableCollection* Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::GetLookupTableCollection()
    {
        return Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt_LookupTables::Instance();
    }
    
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::UpdateTransmembranePotential(double var_chaste_interface__environment__time_converted)
    {
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        std::vector<double>& rY = rGetStateVariables();
        const double delta=1e-8;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
        double d_dt_chaste_interface_var_Membrane__Vm_converted;
        double var_chaste_interface__Membrane__Vm_converted = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -74.3340057623841
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x71 = var_x66 * var_x67 * (0.14447610163038616 * var_x0 * var_x69 + 0.40963906727330363 * var_x0 * var_x68) * mParameters[2] * var_chaste_interface__sodium_dynamics__Nai / pow(var_x70, 2);
            const double var_x72 = var_x36 - 2.8571431999999999 * var_x40;
            const double var_x73 = var_x0 * var_x37 * var_x42 * var_x72 / pow(var_x41, 2);
            
            partialF = -0.00159264 - var_x28 - 4900.0 * var_x44 - 1.8414239999999999 * var_x71 - 0.001 * var_x34 - 3696.035210383774 * var_x73 - var_x45 * var_x47 - 0.001 * mParameters[6] * var_chaste_interface__i_f_Xf_gate__Xf - 0.0016825960981856666 * var_x51 * var_x60 - 0.00043033148291193521 * var_x61 * var_chaste_interface__i_Kr_Xr1_gate__Xr1 + 0.99979860154192302 * var_x60 * var_x64 * var_x65 - 0.001 * mParameters[10] * var_chaste_interface__i_to_q_gate__q * var_chaste_interface__i_to_r_gate__r - 0.11005920279077626 * var_x51 * var_x59 * var_x64 * (2.3233220000000001 * var_x65 - var_x54 * (0.58860000000000001 * var_x56 - 0.00030180000000000002 * var_x55) + 0.45469999999999999 * var_x52 * var_x57 / pow(var_x53, 2)) * mParameters[7] / pow((var_x51 + 0.25575447570332482 * var_x58), 2);
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x162 = var_x62 < -0.040000000000000001;
            
            partialF = ((var_x162) ? (-0.037999999999999999 * var_x159 - 1.8 * var_x158 - 206666.66666666669 * var_x157) : (-0.39339103068450043));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x62 = 0.001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x162 = var_x62 < -0.040000000000000001;
            const double var_x163 = exp(0.24440000000000001 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x164 = exp(-0.043909999999999998 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x165 = -25428.0 * var_x163 - 6.9480000000000002e-6 * var_x164;
            const double var_x166 = exp(24.640530000000002 + 0.311 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x167 = 1.0 + var_x166;
            const double var_x168 = 1 / var_x167;
            const double var_x171 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x172 = 1.0 + var_x171;
            const double var_x173 = exp(-0.01052 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x174 = var_x173 / var_x172;
            const double var_x175 = 37.780000000000001 + var_chaste_interface__Membrane__Vm_converted;
            const double var_x176 = var_x165 * var_x175;
            const double var_x178 = 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x179 = exp(-3.2000000000000002 - var_x178);
            const double var_x180 = 1.0 + var_x179;
            const double var_x181 = exp(0.057000000000000002 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x182 = var_x181 / var_x180;
            
            partialF = ((var_x162) ? (-0.003462857142857143 * var_x174 - 0.14285714285714285 * var_x168 * var_x176) : (-0.085714285714285715 * var_x182));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x190 = exp(1.0 + var_x139);
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x199 = 1 / (0.92835000000000001 + 1433.0 * var_chaste_interface__calcium_dynamics__Cai);
            const double var_x200 = 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x201 = exp(3.0 + var_x200);
            const double var_x202 = 1.0 + var_x201;
            const double var_x203 = 1 / var_x202;
            const double var_x204 = -var_x200;
            const double var_x205 = exp(1.3 + var_x204);
            const double var_x206 = 1.0 + var_x205;
            const double var_x207 = 1 / var_x206;
            const double var_x208 = 1 + 0.037037037037037035 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x209 = exp(-2361.96 * pow(var_x208, 4));
            const double var_x210 = exp(8.6666666666666661 + 0.33333333333333331 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x211 = 1.0 + var_x210;
            const double var_x212 = 1 / var_x211;
            const double var_x216 = 1 / (20.0 + 200.0 * var_x207 + 180.0 * var_x203 + 1102.5 * var_x209);
            const double var_x218 = -var_x212 + var_chaste_interface__i_CaL_f1_gate__f1 < 0;
            const double var_x219 = var_x216;
            
            partialF = ((var_x218) ? (-var_x199 * var_x219) : (-var_x219));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x203 = 1 / var_x202;
            const double var_x204 = -var_x200;
            const double var_x220 = exp(2.5 + var_x204);
            const double var_x221 = 1.0 + var_x220;
            const double var_x222 = 1 / var_x221;
            const double var_x223 = exp(-3.6764705882352939 * pow((1 + 0.040000000000000001 * var_chaste_interface__Membrane__Vm_converted), 2));
            const double var_x226 = 0.59999999999999998 * var_x223;
            const double var_x227 = 1 / (var_x226 + 0.016 * var_x203 + 0.031 * var_x222);
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x62 = 0.001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x228 = var_x62 > -0.059999999999999998;
            const double var_x229 = exp(-0.9375 + 1250.0 * var_chaste_interface__calcium_dynamics__Cai);
            const double var_x230 = 1.0 + var_x229;
            const double var_x231 = exp(-9.0 + 10000.0 * var_chaste_interface__calcium_dynamics__Cai);
            const double var_x232 = 1.0 + var_x231;
            const double var_x233 = pow(var_chaste_interface__calcium_dynamics__Cai, 8);
            const double var_x234 = (var_x228) && (var_chaste_interface__i_CaL_fCa_gate__fCa < 0.22803283672848887 / var_x230 + 0.076010945576162961 / var_x232 + 0.76010945576162958 / (1.0 + 5.9537418076512766e+25 * var_x233));
            
            partialF = ((var_x234) ? (0) : (-0.5));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x200 = 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x204 = -var_x200;
            const double var_x235 = exp(-4.5 + var_x204);
            const double var_x236 = 1.0 + var_x235;
            const double var_x240 = exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x241 = 0.00037037037037037035 + 0.00037037037037037035 * var_x240;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative10(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative10(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x185 = 0.050000000000000003 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x186 = -var_x185;
            const double var_x243 = exp(-3.0 + var_x186);
            const double var_x244 = 1.0 + var_x243;
            const double var_x248 = exp(-3.0 + var_x185);
            const double var_x249 = 0.29761904761904762 + 0.29761904761904762 * var_x248;
            const double var_x250 = var_x244 * var_x249;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x185 = 0.050000000000000003 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x248 = exp(-3.0 + var_x185);
            const double var_x251 = exp(-1.6666666666666667 - 0.16666666666666666 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x252 = sqrt(1.0 + var_x251);
            const double var_x256 = 1.0 + var_x248;
            const double var_x257 = var_x252 * var_x256;
            
            partialF = -0.00090909090909090909 * var_x257;
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x200 = 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x260 = exp(1.5 + var_x200);
            const double var_x261 = 0.0005263157894736842 * var_x260;
            
            partialF = -0.0005263157894736842 - var_x261;
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x178 = 0.10000000000000001 * var_chaste_interface__Membrane__Vm_converted;
            const double var_x264 = exp(4.593 + var_x178);
            const double var_x265 = exp(-3.52 - 0.080000000000000002 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x266 = 1 / (0.065000000000000002 * var_x264 + 0.56999999999999995 * var_x265);
            const double var_x267 = 1 / (0.0060599999999999994 + 0.039101999999999998 * var_x266);
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x270 = exp(2.7548999999999997 + 0.089999999999999997 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x271 = exp(-2.8607999999999998 - 0.12 * var_chaste_interface__Membrane__Vm_converted);
            const double var_x272 = 1 / (1.0369999999999999 * var_x270 + 0.36899999999999999 * var_x271);
            const double var_x273 = 1 / (0.0027535199999999998 + 0.01440516 * var_x272);
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x112 = var_x66 * mParameters[2] / var_x70;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x275 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
            const double var_x276 = pow(var_x275, (-2));
            const double var_x277 = 0.015075462970894076 / (1.0 + 3.0 * var_x276);
            
            partialF = var_x277 * (-0.00044443999999999999 + var_x131 * (var_x138 - var_x137)) + 0.010050308647262718 * (var_x124 + var_x125 - var_x123 - var_x132) / (pow(var_x275, 3) * pow((0.33333333333333337 + var_x276), 2));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluateYDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x281 = (var_x279) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x280));
            const double var_x282 = pow(var_chaste_interface__calcium_dynamics__Cai, 6);
            const double var_x283 = (var_chaste_interface__calcium_dynamics__Cai > 0.00035) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x282));
            const double var_x284 = (var_x228) && (var_x279) && (var_x281) && (var_x283);
            const double var_x285 = (var_x228) && (var_x281) && (var_x283);
            
            partialF = ((var_x284) ? (0) : ((var_x279) ? (-0.5) : ((var_x285) ? (0) : (-0.5))));
        }
        else
        {
    ...
    std::vector<double> Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Membrane__Vm_converted = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2Opt)
