...
class Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables()
    {
...
protected:
    Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables(const Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables&);
    Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables& operator= (const Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables&);
    Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables()
    {
        ...
        Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables> mpInstance;
...
std::shared_ptr<Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables> Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables::mpInstance;


    Cellnoble_model_1962FromCellMLGRL2Opt::Cellnoble_model_1962FromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnoble_model_1962FromCellMLGRL2Opt>::Instance();
        Init();
    ...
    Cellnoble_model_1962FromCellMLGRL2Opt::~Cellnoble_model_1962FromCellMLGRL2Opt()
    {
    }

    AbstractLookupTableCollection* Cellnoble_model_1962FromCellMLGRL2Opt::GetLookupTableCollection()
    {
        return Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables::Instance();
    }
    
    double Cellnoble_model_1962FromCellMLGRL2Opt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellnoble_model_1962FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellnoble_model_1962FromCellMLGRL2Opt::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
...
// LCOV_EXCL_STOP
    ...
    void Cellnoble_model_1962FromCellMLGRL2Opt::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        std::vector<double>& rY = rGetStateVariables();
        const double delta=1e-8;
...
// LCOV_EXCL_STOP
    ...
    double Cellnoble_model_1962FromCellMLGRL2Opt::EvaluateYDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
        double d_dt_chaste_interface_var_membrane__V;
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -81.4147357
...
// LCOV_EXCL_STOP
    ...
    double Cellnoble_model_1962FromCellMLGRL2Opt::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
...
// LCOV_EXCL_STOP
    ...
    double Cellnoble_model_1962FromCellMLGRL2Opt::EvaluateYDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
...
// LCOV_EXCL_STOP
    ...
    double Cellnoble_model_1962FromCellMLGRL2Opt::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellnoble_model_1962FromCellMLGRL2Opt::EvaluateYDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellnoble_model_1962FromCellMLGRL2Opt::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellnoble_model_1962FromCellMLGRL2Opt::EvaluateYDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
...
// LCOV_EXCL_STOP
    ...
    double Cellnoble_model_1962FromCellMLGRL2Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Cellnoble_model_1962FromCellMLGRL2Opt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellnoble_model_1962FromCellMLGRL2Opt>::Initialise(void)
{
