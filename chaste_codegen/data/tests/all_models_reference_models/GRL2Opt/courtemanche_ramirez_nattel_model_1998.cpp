...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x159 = exp(-2.8199999999999998 + var_x158);
            const double var_x160 = 1.0 - var_x159;
            const double var_x161 = 0.00029999999999999997 / var_x160;
            const double var_x163 = var_x154 * var_x161;
            const double var_x165 = exp(-0.65046743564221166 + 0.19517145812596365 * var_chaste_interface__membrane__V);
            const double var_x166 = -1.0 + var_x165;
            const double var_x167 = 7.3898000000000003e-5 / var_x166;
            const double var_x169 = var_x152 * var_x167;
            const double var_x170 = -var_x163;
            const double var_x171 = -var_x169;
            
            partialF = ((var_x156) ? (-0.00187836118) : ((var_x153) ? (-0.00037836118 + var_x170) : ((var_x155) ? (-0.0015 + var_x171) : (var_x170 + var_x171))));
        }
        else
        {
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x128 = 0.058823529411764705 * var_chaste_interface__membrane__V;
            const double var_x175 = -19.899999999999999 + var_chaste_interface__membrane__V;
            const double var_x176 = fabs(var_x175) < 1.0e-10;
            const double var_x177 = exp(-2.2111111111111108 + 0.1111111111111111 * var_chaste_interface__membrane__V);
            const double var_x178 = -1.0 + var_x177;
            const double var_x179 = 6.9999999999999994e-5 / var_x178;
            const double var_x180 = -var_x128;
            const double var_x181 = exp(1.1705882352941175 + var_x180);
            const double var_x182 = 1.0 - var_x181;
            const double var_x183 = 8.0000000000000007e-5 / var_x182;
            const double var_x184 = var_x175 * var_x179;
            const double var_x185 = var_x175 * var_x183;
            
            partialF = ((var_x176) ? (-0.00199) : (-var_x184 - var_x185));
        }
        else
        {
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x186 = exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V);
            const double var_x191 = 0.21838829438742086 * var_x186;
            const double var_x193 = 10.0 + var_chaste_interface__membrane__V;
            const double var_x194 = fabs(var_x193) < 1.0e-10;
            const double var_x195 = 1.0 - var_x186;
            const double var_x196 = 1 / var_x195;
            const double var_x197 = 1.0 + var_x186;
            const double var_x198 = var_x196 * var_x197;
            const double var_x199 = 0.035000000000000003 * var_x198;
            
            partialF = ((var_x194) ? (-0.21838829438742086 - var_x191) : (-var_x193 * var_x199));
        }
        else
        {
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x201 = 0.0021888888888888887 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
            
            partialF = -0.0022222222222222222 - var_x201;
        }
        else
        {
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x35 = var_x33 * var_x34;
            const double var_x47 = 1.8 * var_x16 - 2744000.0 * var_x14;
            const double var_x205 = 0.23455745922671672 * var_x35;
            const double var_x207 = var_x18 * var_x47;
            ...
            const double var_x213 = -65.0 + var_chaste_interface__membrane__V;
            const double var_x214 = -0.00011173862339878819 * var_x207 + var_x205 * var_x213 - var_x208 * var_x212;
            const double var_x215 = exp(250.0 + var_x214);
            const double var_x216 = 1.0 + var_x215;
            const double var_x217 = var_x215 / pow(var_x216, 2);
            const double var_x224 = var_x208 * var_chaste_interface__Ca_release_current_from_JSR_v_gate__v;
            const double var_x225 = var_x224 * var_chaste_interface__Ca_release_current_from_JSR_u_gate__u * var_chaste_interface__Ca_release_current_from_JSR_w_gate__w;
            
            partialF = -0.125 + 529334.30870519392 * var_x217 * var_x225;
        }
        else
        {
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x216 = 1.0 + var_x215;
            const double var_x217 = var_x215 / pow(var_x216, 2);
            const double var_x226 = var_x208 * var_x210;
            const double var_x230 = 1 / var_x216;
            const double var_x231 = 1 / (1.9099999999999999 + 2.0899999999999999 * var_x230);
            const double var_x232 = exp(50.0 + var_x214);
            const double var_x233 = 1.0 + var_x232;
            const double var_x234 = var_x232 / pow(var_x233, 2);
            const double var_x236 = var_x217 * (1.0 - 1 / var_x233 - var_chaste_interface__Ca_release_current_from_JSR_v_gate__v) / pow((0.9138755980861244 + var_x230), 2);
            const double var_x240 = 1013080.0166606582 * var_x236;
            
            partialF = var_x231 * (-1 - 2117337.2348207757 * var_x226 * var_x234) - var_x226 * var_x240;
        }
        else
        {
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x246 = exp(1.5800000000000001 + var_x158);
            ...
            partialF = ((var_x245) ? (-1.0833333333333333) : (-var_x252 * var_x254));
        }
        else
        {
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x211 = var_x210 * var_chaste_interface__Ca_release_current_from_JSR_v_gate__v;
            const double var_x213 = -65.0 + var_chaste_interface__membrane__V;
            const double var_x257 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
            const double var_x258 = 1.0 + 0.00011900000000000002 / pow(var_x257, 2) + 3.5000000000000004e-5 * var_x68;
            const double var_x259 = 1 / var_x258;
            const double var_x260 = 4.2880534095874102e-10 * mParameters[0];
            const double var_x261 = 4.6918356272010785e-8 * var_x35;
            const double var_x264 = 1.0 + 0.00092000000000000003 * var_x66;
            const double var_x265 = 1 / (pow(var_x264, 2) * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 2));
            const double var_x266 = 1.0426301393780176e-7 * var_x65;
            const double var_x267 = 0.21176470588235291 * var_x211;
            
            partialF = var_x259 * (-var_x266 - var_x267 + 1.0426301393780176e-7 * var_x69 - 0.00030665564809977873 * var_x70 - 3.7341176470588232e-7 * var_x265 - 5.7273025005690459e-9 * var_x67) + (0.00023800000000000004 / pow(var_x257, 3) + 7.0000000000000007e-5 / pow(var_x64, 3)) * (2.7058823529411762e-5 * var_chaste_interface__intracellular_ion_concentrations__Ca_up + 1.1175497379729545e-10 * var_x207 - 0.00040588235294117644 / var_x264 + var_x208 * var_x267 - var_x213 * var_x261 - var_x260 * (-13.356415961992688 * var_x28 * log10(1.8 * var_x66) + var_chaste_interface__membrane__V) - var_x266 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) / pow(var_x258, 2);
        }
        else
        {
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x210 = var_x209 * var_chaste_interface__Ca_release_current_from_JSR_w_gate__w;
            const double var_x211 = var_x210 * var_chaste_interface__Ca_release_current_from_JSR_v_gate__v;
            const double var_x270 = 0.80000000000000004 + var_chaste_interface__intracellular_ion_concentrations__Ca_rel;
            const double var_x271 = pow(var_x270, (-2));
            const double var_x272 = 1 / (1.0 + 8.0 * var_x271);
            const double var_x274 = 30.0 * var_x211;
            
            partialF = var_x272 * (-0.0055555555555555558 - var_x274) + 0.25 * (0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_rel - var_x208 * var_x274) / (pow(var_x270, 3) * pow((0.125 + var_x271), 2));
        }
        else
        {
