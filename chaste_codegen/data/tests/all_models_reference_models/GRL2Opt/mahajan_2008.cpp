...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmahajan_2008FromCellMLGRL2::UpdateTransmembranePotential(double var_chaste_interface__Environment__time)
    {
        ...
        const double var_reversal_potentials__ek = -37.522506442369647 * log(10); // mV
        const double var_INa__xina = pow(var_chaste_interface__INa__xm, 3) * (-26.541413816729872 * log(10) * log10(136.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__cell__V) * mParameters[4] * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj; // nA_per_nF
        d_dt_chaste_interface_var_cell__V = -var_INa__xina - var_INaCa__xiNaCa - var_INaK__xiNaK - 16.0 * var_ICaL__jca - 1.0000000000000002 * GetIntracellularAreaStimulus(var_chaste_interface__Environment__time) / HeartConfig::Instance()->GetCapacitance() - 0.040000000000000001 * (-var_reversal_potentials__ek + var_chaste_interface__cell__V) * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof - 0.30599999999999999 * (-var_reversal_potentials__ek + var_chaste_interface__cell__V) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 0.23849999999999999 * var_reversal_potentials__ek)) * (1.02 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 0.23849999999999999 * var_reversal_potentials__ek)) + (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 0.080320000000000003 * var_reversal_potentials__ek) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 0.061749999999999999 * var_reversal_potentials__ek)) / (1.0 + exp(-2.4444678999999998 + 0.51429999999999998 * var_reversal_potentials__ek - 0.51429999999999998 * var_chaste_interface__cell__V)))) - 0.11 * (-var_reversal_potentials__ek + var_chaste_interface__cell__V) * (0.5 / (1.0 + exp(var_Ito__rt2)) + var_chaste_interface__Ito__ytos) * mParameters[2] * var_chaste_interface__Ito__xtos - 0.1386 * (1.0 + 0.80000000000000004 / (1.0 + 0.125 / pow(var_Ca__Ca_i, 3))) * (-26.541413816729872 * log(10) * log10(7.8928799999999999 / (140.0 + 0.018329999999999999 * var_chaste_interface__Na__Na_i)) + var_chaste_interface__cell__V) * mParameters[1] * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2 - 1.0 * (-var_reversal_potentials__ek + var_chaste_interface__cell__V) * mParameters[0] * mParameters[5] * var_chaste_interface__IKr__xr / (1.0 + exp(1.4732142857142858 + 0.044642857142857144 * var_chaste_interface__cell__V)); // mV / ms
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V + 8.9491177865051608 * var_x0);
            const double var_x2 = 1.0 + var_x1;
            const double var_x3 = 1 / var_x2;
            const double var_x4 = exp(-2.4444678999999998 - 0.51429999999999998 * var_chaste_interface__cell__V - 19.297825063310711 * var_x0);
            const double var_x5 = 1.0 + var_x4;
            const double var_x6 = 1 / var_x5;
            const double var_x7 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V + 3.0138077174511304 * var_x0);
            const double var_x8 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V + 2.317014772816326 * var_x0);
            const double var_x9 = var_x8 + 0.49124000000000001 * var_x7;
            const double var_x10 = var_x6 * var_x9;
            const double var_x11 = 1 / (var_x10 + 1.02 * var_x3);
            const double var_x12 = 0.10000000000000001 * var_chaste_interface__cell__V;
            const double var_x13 = exp(3.3500000000000001 + var_x12);
            const double var_x14 = 1.0 + var_x13;
            const double var_x15 = 1 / var_x14;
            const double var_x16 = (-0.055 * var_x15 - 0.11 * var_chaste_interface__Ito__ytos) * mParameters[2];
            const double var_x17 = 0.075353936071760372 * var_chaste_interface__cell__V;
            const double var_x18 = exp(var_x17);
            const double var_x19 = var_x18 * var_chaste_interface__Ca__Ca_submem;
            const double var_x20 = fabs(var_x17) < 0.001;
            const double var_x21 = -1.0 + var_x18;
            const double var_x22 = 1 / var_x21;
            const double var_x23 = -0.61380000000000001 + 0.001 * var_x19;
            const double var_x24 = 0.0078521942756732046 * var_x22 * var_x23;
            const double var_x25 = var_x22 * var_chaste_interface__cell__V;
            const double var_x26 = ((var_x20) ? (7.8521942756732062e-6 * var_x19) : (var_x24 + 5.916937454721214e-7 * var_x19 * var_x25 - 0.00059169374547212144 * var_x18 * var_x23 * var_chaste_interface__cell__V / pow(var_x21, 2)));
            const double var_x27 = (-16.0 + 16.0 * var_chaste_interface__ICaL__c1 + 16.0 * var_chaste_interface__ICaL__c2 + 16.0 * var_chaste_interface__ICaL__xi1ba + 16.0 * var_chaste_interface__ICaL__xi1ca + 16.0 * var_chaste_interface__ICaL__xi2ba + 16.0 * var_chaste_interface__ICaL__xi2ca) * mParameters[3];
            ...
            const double var_x31 = var_x30 * mParameters[1] * var_chaste_interface__IKs__xs2;
            const double var_x32 = var_x31 * var_chaste_interface__IKs__xs1;
            const double var_x33 = pow(var_chaste_interface__INa__xm, 3);
            const double var_x34 = var_x33 * mParameters[4] * var_chaste_interface__INa__xj;
            const double var_x35 = var_x34 * var_chaste_interface__INa__xh;
            const double var_x36 = 37.522506442369647 * var_x0 + var_chaste_interface__cell__V;
            const double var_x37 = var_x1 / pow(var_x2, 2);
            const double var_x38 = pow(var_chaste_interface__Na__Na_i, 3);
            const double var_x39 = exp(0.013186938812558063 * var_chaste_interface__cell__V);
            const double var_x40 = var_x38 * var_x39;
            const double var_x41 = exp(-0.024490029223322121 * var_chaste_interface__cell__V);
            const double var_x42 = var_x41 * var_chaste_interface__Ca__Ca_submem;
            const double var_x43 = 1 / (12405.2022 + 7.9663561662386391 * var_x38 + 4115.8113750000002 * var_chaste_interface__Ca__Ca_submem);
            const double var_x44 = 1.0 + 0.20000000000000001 * var_x41;
            ...
            const double var_x50 = var_x49 * (0.023736489862604515 * var_x40 + 61.603590949980969 * var_x42);
            ...
            const double var_x57 = mParameters[0] * mParameters[5] * var_chaste_interface__IKr__xr;
            const double var_x58 = exp(1.4732142857142858 + 0.044642857142857144 * var_chaste_interface__cell__V);
            const double var_x59 = 1.0 + var_x58;
            const double var_x60 = 1.0 / var_x59;
            const double var_x61 = mParameters[2] * var_chaste_interface__Ito__xtos;
            const double var_x62 = var_x13 / pow(var_x14, 2);
            const double var_x63 = 1.8 * var_x40 - 2515.4560000000001 * var_x42;
            const double var_x64 = var_x43 * var_x63;
            const double var_x65 = var_x41 * var_x47 * var_x64 / pow(var_x44, 2);
            
            partialF = var_x32 - var_x35 - 6.7199999999999998 * var_x50 - 1.173913043478261 * var_x56 - 0.032914599276144929 * var_x65 + var_x16 * var_chaste_interface__Ito__xtos + var_x26 * var_x27 - var_x57 * var_x60 - 0.040000000000000001 * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof - 0.30599999999999999 * var_x11 * var_x3 + 0.07298099999999999 * var_x11 * var_x36 * var_x37 + 0.0054999999999999997 * var_x36 * var_x61 * var_x62 + 0.044642857142857144 * var_x36 * var_x57 * var_x58 / pow(var_x59, 2) - 0.29411764705882354 * var_x3 * var_x36 * (0.24326999999999999 * var_x37 - var_x6 * (0.061749999999999999 * var_x8 + 0.039456396800000001 * var_x7) - 0.51429999999999998 * var_x4 * var_x9 / pow(var_x5, 2)) / pow((var_x3 + 0.98039215686274506 * var_x10), 2);
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x28 = pow(var_chaste_interface__Ca__Ca_i_converted, 3);
            const double var_x92 = 32.699999999999996 * var_chaste_interface__Ca__tropi;
            const double var_x93 = pow(var_chaste_interface__Ca__Ca_i_converted, 2);
            const double var_x94 = 0.80000000000000004 * var_x28 / pow((2.4999999999999999e-7 + var_x93), 2);
            const double var_x95 = pow(var_chaste_interface__Ca__Ca_NSR, 2);
            const double var_x96 = 1 / (2500.0 + var_x95);
            const double var_x97 = var_x95 * var_x96;
            const double var_x98 = 0.02069 * var_x97;
            const double var_x99 = 1 / (0.25 + 1000000.0 * var_x93);
            const double var_x100 = 800000.0 * var_x99 * var_chaste_interface__Ca__Ca_i_converted;
            const double var_x101 = 0.012999999999999999 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x102 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x103 = 0.00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x104 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x105 = 1.0 + 0.00054600000000000004 / pow(var_x101, 2) + 2.8200000000000001e-5 / pow(var_x102, 2) + 4.5000000000000001e-6 / pow(var_x103, 2) + 0.00016800000000000002 / pow(var_x104, 2);
            const double var_x106 = 1 / var_x105;
            const double var_x107 = 0.001 * var_x106;
            const double var_x108 = 32.699999999999996 * var_chaste_interface__Ca__Ca_i_converted;
            const double var_x109 = 400000.0 * var_x93 * var_x99;
            const double var_x110 = 16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted;
            const double var_x111 = 2.069e-5 * var_x110 * var_x97;
            
            partialF = var_x107 * (-2539.0 + var_x92 + var_x94 - var_x100 - var_x98) + 0.001 * (0.0010920000000000001 / pow(var_x101, 3) + 5.6400000000000002e-5 / pow(var_x102, 3) + 9.0000000000000002e-6 / pow(var_x103, 3) + 0.00033600000000000004 / pow(var_x104, 3)) * (var_x111 - var_x109 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x108 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x105, 2);
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x116 = -0.10000000000000001 * var_chaste_interface__cell__V;
            ...
            const double var_x120 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
            const double var_x122 = 47.130000000000003 + var_chaste_interface__cell__V;
            const double var_x123 = fabs(var_x122) > 0.001;
            const double var_x124 = -0.080000000000000002 * var_x120;
            
            partialF = ((var_x123) ? (var_x124 - var_x119 * var_x122) : (-3.2000000000000002 + var_x124));
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x125 = exp(0.079000000000000001 * var_chaste_interface__cell__V);
            const double var_x126 = exp(0.34999999999999998 * var_chaste_interface__cell__V);
            const double var_x127 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V);
            const double var_x128 = var_chaste_interface__cell__V < -40.0;
            const double var_x129 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V);
            const double var_x130 = 1.0 + var_x129;
            
            partialF = ((var_x128) ? (-310000.0 * var_x126 - 0.13500000000000001 * var_x127 - 3.5600000000000001 * var_x125) : (-7.6923076923076916 / var_x130));
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x135 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
            const double var_x136 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
            const double var_x137 = -127140.0 * var_x135 - 3.4740000000000003e-5 * var_x136;
            const double var_x138 = var_x134 * var_x137;
            const double var_x139 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V);
            const double var_x140 = 1.0 + var_x139;
            const double var_x141 = exp(-0.01052 * var_chaste_interface__cell__V);
            const double var_x142 = var_x141 / var_x140;
            const double var_x143 = 37.780000000000001 + var_chaste_interface__cell__V;
            const double var_x145 = exp(-3.2000000000000002 + var_x116);
            const double var_x146 = 1.0 + var_x145;
            const double var_x147 = exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V);
            const double var_x148 = var_x147 / var_x146;
            
            partialF = ((var_x128) ? (-0.1212 * var_x142 - var_x138 * var_x143) : (-0.29999999999999999 * var_x148));
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x149 = exp(-0.125 * var_chaste_interface__cell__V);
            const double var_x150 = 1.0 + var_x149;
            const double var_x154 = 1 / var_x150;
            const double var_x155 = 1.0 * var_x154;
            const double var_x156 = pow(var_chaste_interface__Ca__Ca_dyad, 3);
            const double var_x157 = 1 / var_x156;
            const double var_x158 = 1 / (1.0 + 27.0 * var_x157);
            
            partialF = -4.3041299999999998 + var_x155 - 0.024167999999999999 * var_x158;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x157 = 1 / var_x156;
            const double var_x158 = 1 / (1.0 + 27.0 * var_x157);
            const double var_x159 = pow(var_chaste_interface__Ca__Ca_dyad, 4);
            const double var_x163 = exp(-10.0 - 0.25 * var_chaste_interface__cell__V);
            const double var_x164 = 1.0 + var_x163;
            const double var_x165 = 1.0 - 1.0 / var_x164;
            const double var_x166 = exp(0.064102564102564111 * var_chaste_interface__cell__V);
            const double var_x167 = 4954.0 * var_x166;
            const double var_x168 = -440.0 + var_x167;
            const double var_x169 = var_x165 * var_x168;
            const double var_x170 = 1 / (450.0 + var_x169);
            const double var_x171 = exp(-3.5335689045936394 - 0.088339222614840993 * var_chaste_interface__cell__V);
            const double var_x172 = 1.0 + var_x171;
            const double var_x175 = 1 / var_x172;
            const double var_x180 = 1.0 + 0.00072525373756441506 * var_x159;
            const double var_x181 = 1 / var_x180;
            const double var_x182 = 78.032899999999998 * var_x181;
            const double var_x183 = 9.9000000000000004 + var_x167 - var_x182;
            const double var_x184 = var_x165 * var_x183;
            const double var_x185 = 1 / (0.10000000000000001 + var_x182 + var_x184);
            const double var_x186 = var_x158 * var_x185;
            const double var_x196 = -var_x155;
            const double var_x198 = var_x170 * var_x175;
            const double var_x199 = var_x175 * var_x186;
            
            partialF = var_x196 - var_x198 - var_x199;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x157 = 1 / var_x156;
            const double var_x158 = 1 / (1.0 + 27.0 * var_x157);
            const double var_x208 = exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V);
            const double var_x209 = 1.0 + var_x208;
            const double var_x213 = 0.33333333333333331 / var_x209;
            const double var_x224 = -0.018268800000000002 * var_x158;
            const double var_x225 = 41.377027474346242 + 1117.1797418073486 * var_x157;
            
            partialF = -0.33343694833333332 + var_x213 + var_x224 - 1.8929217120000003e-7 * var_x158 * var_x225;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.33762909604519775 + var_x213;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x184 = var_x165 * var_x183;
            const double var_x185 = 1 / (0.10000000000000001 + var_x182 + var_x184);
            const double var_x192 = 1.0 - var_x175;
            const double var_x196 = -var_x155;
            const double var_x197 = 1.0 + var_x196;
            const double var_x200 = var_x185 * var_x192;
            const double var_x208 = exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V);
            const double var_x209 = 1.0 + var_x208;
            const double var_x213 = 0.33333333333333331 / var_x209;
            const double var_x214 = 0.33333333333333331 - var_x213;
            const double var_x215 = 1 / var_x197;
            const double var_x216 = var_x154 * var_x215;
            const double var_x221 = var_x172 * var_x214;
            const double var_x226 = var_x192 * var_x221;
            const double var_x227 = var_x216 * var_x226;
            const double var_x228 = 233.2480818414322 * var_x227;
            
            partialF = -var_x200 - var_x228;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x196 = -var_x155;
            const double var_x197 = 1.0 + var_x196;
            const double var_x201 = var_x170 * var_x192;
            const double var_x208 = exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V);
            const double var_x209 = 1.0 + var_x208;
            const double var_x213 = 0.33333333333333331 / var_x209;
            const double var_x214 = 0.33333333333333331 - var_x213;
            ...
            const double var_x226 = var_x192 * var_x221;
            const double var_x227 = var_x216 * var_x226;
            const double var_x239 = 1.8437500000000002 * var_x227;
            
            partialF = -var_x201 - var_x239;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x244 = exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V);
            const double var_x245 = 1.0 - var_x244;
            const double var_x246 = 0.0013799999999999999 / var_x245;
            const double var_x247 = 7.0 + var_chaste_interface__cell__V;
            const double var_x249 = exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V);
            const double var_x250 = -1.0 + var_x249;
            const double var_x251 = 0.00060999999999999997 / var_x250;
            const double var_x252 = 10.0 + var_chaste_interface__cell__V;
            const double var_x254 = var_x251 * var_x252;
            const double var_x255 = var_x246 * var_x247;
            const double var_x258 = fabs(var_x247) > 0.001;
            const double var_x259 = fabs(var_x252) > 0.001;
            const double var_x260 = (var_x258) && (var_x259);
            const double var_x261 = -var_x254;
            const double var_x262 = -var_x255;
            
            partialF = ((var_x260) ? (var_x261 + var_x262) : ((var_x258) ? (-0.0042068965517241376 + var_x262) : ((var_x259) ? (-0.011219512195121951 + var_x261) : (-0.015426408746846089))));
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x266 = 30.0 + var_chaste_interface__cell__V;
            const double var_x267 = fabs(var_x266) < 0.014556040756914121;
            const double var_x268 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V);
            const double var_x269 = -1.0 + var_x268;
            const double var_x270 = 0.00013100000000000001 / var_x269;
            const double var_x271 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V);
            const double var_x272 = 1.0 - var_x271;
            const double var_x273 = 7.1899999999999999e-5 / var_x272;
            const double var_x275 = ((var_x267) ? (0.0023926521499665608) : (var_x266 * var_x270 + var_x266 * var_x273));
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x277 = 0.066666666666666666 * var_chaste_interface__cell__V;
            const double var_x278 = exp(0.20000000000000001 + var_x277);
            const double var_x279 = 1.0 + var_x278;
            const double var_x280 = 1 / var_x279;
            const double var_x281 = 1 / (0.5 + 9.0 * var_x280);
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x12 = 0.10000000000000001 * var_chaste_interface__cell__V;
            const double var_x286 = exp(6.0 + var_x12);
            const double var_x287 = 1.0 + var_x286;
            const double var_x288 = 1 / var_x287;
            const double var_x289 = 1 / (30.0 + 3000.0 * var_x288);
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x14 = 1.0 + var_x13;
            const double var_x15 = 1 / var_x14;
            const double var_x293 = 1 / (20.0 + 20.0 * var_x15);
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x315 = var_x109 - var_x111 - var_chaste_interface__Irel__xir;
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x55 = 1.0 + 0.1245 * var_x52 + 0.036499999999999998 * var_x54 * (-0.14285714285714285 + 0.14285714285714285 * var_x53);
            const double var_x63 = 1.8 * var_x40 - 2515.4560000000001 * var_x42;
            const double var_x70 = 1 / var_chaste_interface__Na__Na_i;
            const double var_x81 = 1 / var_x55;
            const double var_x82 = var_x51 * var_x81;
            const double var_x83 = var_x81 * var_chaste_interface__Na__Na_i / pow((1 + 0.083333333333333329 * var_chaste_interface__Na__Na_i), 2);
            const double var_x84 = pow(var_chaste_interface__Na__Na_i, 2);
            const double var_x85 = var_x48 * var_x63 / pow((1 + 0.0006421786632577935 * var_x38 + 0.33178107931203249 * var_chaste_interface__Ca__Ca_submem), 2);
            const double var_x86 = var_x84 * var_x85;
            const double var_x87 = var_x35 * var_x70;
            const double var_x88 = var_x39 * var_x49 * var_x84;
            
            partialF = 3.0570652173913045e-6 * var_x83 + 3.9135764302406278e-10 * var_x86 - 0.0033176767270912339 * var_x87 - 0.013608 * var_x88 - 0.00044021739130434783 * var_x82;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x63 = 1.8 * var_x40 - 2515.4560000000001 * var_x42;
            const double var_x64 = var_x43 * var_x63;
            const double var_x76 = 0.00010420416882000001 * var_x18;
            const double var_x77 = ((var_x20) ? (-0.063960518821716009 + var_x76 * var_chaste_interface__Ca__Ca_submem) : (var_x24 * var_chaste_interface__cell__V));
            const double var_x78 = var_x77 * mParameters[3];
            const double var_x85 = var_x48 * var_x63 / pow((1 + 0.0006421786632577935 * var_x38 + 0.33178107931203249 * var_chaste_interface__Ca__Ca_submem), 2);
            const double var_x89 = ((var_x20) ? (var_x76) : (7.8521942756732062e-6 * var_x18 * var_x25));
            const double var_x90 = var_x41 * var_x49;
            const double var_x91 = var_x45 * var_x64 / (pow(var_x46, 2) * pow(var_chaste_interface__Ca__Ca_submem, 4));
            const double var_x229 = 1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca;
            ...
            const double var_x336 = (-50.0 + 50.0 * var_chaste_interface__ICaL__c1 + 50.0 * var_chaste_interface__ICaL__c2 + 50.0 * var_chaste_interface__ICaL__xi1ba + 50.0 * var_chaste_interface__ICaL__xi1ca + 50.0 * var_chaste_interface__ICaL__xi2ba + 50.0 * var_chaste_interface__ICaL__xi2ca) * mParameters[3];
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative23(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x97 = var_x95 * var_x96;
            const double var_x110 = 16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted;
            const double var_x112 = 0.00034484023000000001 * var_x97;
            const double var_x113 = 4.138e-5 * var_x110 * var_x96 * var_chaste_interface__Ca__Ca_NSR;
            const double var_x114 = 6.6208000000000002e-12 * var_x110 * pow(var_chaste_interface__Ca__Ca_NSR, 3) / pow((1 + 0.00040000000000000002 * var_x95), 2);
            const double var_x316 = var_x114 - var_x112 - var_x113;
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.019599999999999999 - var_x108;
        }
        else
        {
