...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        this->mParameters[0] = 182.0; // (var_ICaL__gca) [mmole_per_coulomb_cm]
        this->mParameters[1] = 12.0; // (var_INa__gna) [uS_per_nF]
        this->mParameters[2] = 0.012500000000000001; // (var_IKr__gkr) [uS_per_nF]
    }
    ...
    double Cellmahajan_2008FromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_cell__Itotal = -16.0 * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * ((fabs(0.075353936071760372 * var_chaste_interface__cell__V) < 0.001) ? (-0.063960518821716009 + 0.10420416882000001 * var_Ca__csm * exp(0.075353936071760372 * var_chaste_interface__cell__V)) : (0.0078521942756732046 * (-0.61380000000000001 + var_Ca__csm * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(0.075353936071760372 * var_chaste_interface__cell__V)))) * mParameters[0] - 0.040000000000000001 * (86.398763985973389 + var_chaste_interface__cell__V) * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof - 0.11 * (86.398763985973389 + var_chaste_interface__cell__V) * (0.5 / (1.0 + exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V)) + var_chaste_interface__Ito__ytos) * var_chaste_interface__Ito__xtos - 1.173913043478261 * var_chaste_interface__Na__Na_i / ((12.0 + var_chaste_interface__Na__Na_i) * (1.0 + 0.1245 * exp(-0.0037676968035880187 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0208023774145616)) * exp(-0.037676968035880186 * var_chaste_interface__cell__V))) - 0.30599999999999999 * (86.398763985973389 + var_chaste_interface__cell__V) / ((1.0 + exp(6.4833277106546534 + 0.23849999999999999 * var_chaste_interface__cell__V)) * (1.02 / (1.0 + exp(6.4833277106546534 + 0.23849999999999999 * var_chaste_interface__cell__V)) + (1.0 * exp(-31.363518823866141 + 0.061749999999999999 * var_chaste_interface__cell__V) + 0.49124000000000001 * exp(7.3793810433533835 + 0.080320000000000003 * var_chaste_interface__cell__V)) / (1.0 + exp(-46.879352217986117 - 0.51429999999999998 * var_chaste_interface__cell__V)))) - 0.1386 * (1.0 + 0.80000000000000004 / (1.0 + 1.2500000000000001e-10 / pow(var_chaste_interface__Ca__Ca_i_converted, 3))) * (-26.541413816729872 * log(7.8928799999999999 / (140.0 + 0.018329999999999999 * var_chaste_interface__Na__Na_i)) + var_chaste_interface__cell__V) * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2 - 6.7199999999999998 * (1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(0.013186938812558063 * var_chaste_interface__cell__V) - 2515456.0 * var_Ca__csm * exp(-0.024490029223322121 * var_chaste_interface__cell__V)) / ((1.0 + 0.20000000000000001 * exp(-0.024490029223322121 * var_chaste_interface__cell__V)) * (1.0 + 0.026999999999999996 / pow(var_chaste_interface__Ca__Ca_submem, 3)) * (12405.2022 + 7.9663561662386391 * pow(var_chaste_interface__Na__Na_i, 3) + 4115811.375 * var_Ca__csm)) - 1.0 * (86.398763985973389 + var_chaste_interface__cell__V) * mParameters[2] * var_chaste_interface__IKr__xr / (1.0 + exp(1.4732142857142858 + 0.044642857142857144 * var_chaste_interface__cell__V)) - pow(var_chaste_interface__INa__xm, 3) * (-26.541413816729872 * log(136.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__cell__V) * mParameters[1] * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj; // nA_per_nF
    ...
    void Cellmahajan_2008FromCellMLGRL2::UpdateTransmembranePotential(double var_chaste_interface__Environment__time)
    {
        ...
        const double var_ICaL__jca = mParameters[0] * var_ICaL__po * var_ICaL__rxa; // uM_per_ms
        ...
        const double var_INa__xina = pow(var_chaste_interface__INa__xm, 3) * (-26.541413816729872 * log(136.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__cell__V) * mParameters[1] * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj; // nA_per_nF
        d_dt_chaste_interface_var_cell__V = -var_INa__xina - var_INaCa__xiNaCa - var_INaK__xiNaK - 16.0 * var_ICaL__jca - GetIntracellularAreaStimulus(var_chaste_interface__Environment__time) / HeartConfig::Instance()->GetCapacitance() - 0.040000000000000001 * (86.398763985973389 + var_chaste_interface__cell__V) * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof - 0.11 * (86.398763985973389 + var_chaste_interface__cell__V) * (0.5 / (1.0 + exp(var_Ito__rt2)) + var_chaste_interface__Ito__ytos) * var_chaste_interface__Ito__xtos - 0.30599999999999999 * (86.398763985973389 + var_chaste_interface__cell__V) / ((1.0 + exp(6.4833277106546534 + 0.23849999999999999 * var_chaste_interface__cell__V)) * (1.02 / (1.0 + exp(6.4833277106546534 + 0.23849999999999999 * var_chaste_interface__cell__V)) + (1.0 * exp(-31.363518823866141 + 0.061749999999999999 * var_chaste_interface__cell__V) + 0.49124000000000001 * exp(7.3793810433533835 + 0.080320000000000003 * var_chaste_interface__cell__V)) / (1.0 + exp(-46.879352217986117 - 0.51429999999999998 * var_chaste_interface__cell__V)))) - 0.1386 * (1.0 + 0.80000000000000004 / (1.0 + 0.125 / pow(var_Ca__Ca_i, 3))) * (-26.541413816729872 * log(7.8928799999999999 / (140.0 + 0.018329999999999999 * var_chaste_interface__Na__Na_i)) + var_chaste_interface__cell__V) * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2 - 1.0 * (86.398763985973389 + var_chaste_interface__cell__V) * mParameters[2] * var_chaste_interface__IKr__xr / (1.0 + exp(1.4732142857142858 + 0.044642857142857144 * var_chaste_interface__cell__V)); // mV / ms
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x4 = exp(6.4833277106546534 + 0.23849999999999999 * var_chaste_interface__cell__V);
            const double var_x5 = 1.0 + var_x4;
            const double var_x6 = 1 / var_x5;
            const double var_x7 = exp(-46.879352217986117 - 0.51429999999999998 * var_chaste_interface__cell__V);
            const double var_x8 = 1.0 + var_x7;
            const double var_x9 = 1 / var_x8;
            const double var_x10 = exp(-31.363518823866141 + 0.061749999999999999 * var_chaste_interface__cell__V);
            const double var_x11 = exp(7.3793810433533835 + 0.080320000000000003 * var_chaste_interface__cell__V);
            const double var_x12 = 1.0 * var_x10 + 0.49124000000000001 * var_x11;
            const double var_x13 = var_x12 * var_x9;
            const double var_x14 = 1 / (var_x13 + 1.02 * var_x6);
            const double var_x15 = pow(var_chaste_interface__Ca__Ca_i_converted, 3);
            const double var_x16 = 1.0 + 1.2500000000000001e-10 / var_x15;
            const double var_x17 = -0.1386 - 0.11088000000000001 / var_x16;
            const double var_x18 = var_x17 * var_chaste_interface__IKs__xs2;
            const double var_x19 = var_x18 * var_chaste_interface__IKs__xs1;
            const double var_x20 = 0.075353936071760372 * var_chaste_interface__cell__V;
            const double var_x21 = exp(var_x20);
            const double var_x22 = var_x21 * var_chaste_interface__Ca__Ca_submem;
            const double var_x23 = fabs(var_x20) < 0.001;
            const double var_x24 = -1.0 + var_x21;
            const double var_x25 = 1 / var_x24;
            const double var_x26 = -0.61380000000000001 + 0.001 * var_x22;
            const double var_x27 = 0.0078521942756732046 * var_x25 * var_x26;
            const double var_x28 = var_x25 * var_chaste_interface__cell__V;
            const double var_x29 = ((var_x23) ? (7.8521942756732062e-6 * var_x22) : (var_x27 + 5.916937454721214e-7 * var_x22 * var_x28 - 0.00059169374547212144 * var_x21 * var_x26 * var_chaste_interface__cell__V / pow(var_x24, 2)));
            const double var_x30 = (-16.0 + 16.0 * var_chaste_interface__ICaL__c1 + 16.0 * var_chaste_interface__ICaL__c2 + 16.0 * var_chaste_interface__ICaL__xi1ba + 16.0 * var_chaste_interface__ICaL__xi1ca + 16.0 * var_chaste_interface__ICaL__xi2ba + 16.0 * var_chaste_interface__ICaL__xi2ca) * mParameters[0];
            const double var_x31 = mParameters[2] * var_chaste_interface__IKr__xr;
            const double var_x32 = exp(1.4732142857142858 + 0.044642857142857144 * var_chaste_interface__cell__V);
            const double var_x33 = 1.0 + var_x32;
            const double var_x34 = 1.0 / var_x33;
            const double var_x35 = pow(var_chaste_interface__INa__xm, 3);
            const double var_x36 = var_x35 * mParameters[1] * var_chaste_interface__INa__xj;
            const double var_x37 = var_x36 * var_chaste_interface__INa__xh;
            const double var_x38 = 86.398763985973389 + var_chaste_interface__cell__V;
            const double var_x39 = var_x4 / pow(var_x5, 2);
            const double var_x40 = pow(var_chaste_interface__Na__Na_i, 3);
            const double var_x41 = exp(0.013186938812558063 * var_chaste_interface__cell__V);
            const double var_x42 = var_x40 * var_x41;
            const double var_x43 = exp(-0.024490029223322121 * var_chaste_interface__cell__V);
            const double var_x44 = var_x43 * var_chaste_interface__Ca__Ca_submem;
            const double var_x45 = 1 / (12405.2022 + 7.9663561662386391 * var_x40 + 4115.8113750000002 * var_chaste_interface__Ca__Ca_submem);
            const double var_x46 = 1.0 + 0.20000000000000001 * var_x43;
            const double var_x47 = 1 / var_x46;
            const double var_x48 = 1.0 + 0.026999999999999996 / pow(var_chaste_interface__Ca__Ca_submem, 3);
            const double var_x49 = 1 / var_x48;
            const double var_x50 = var_x47 * var_x49;
            const double var_x51 = var_x45 * var_x50;
            const double var_x52 = var_x51 * (0.023736489862604515 * var_x42 + 61.603590949980969 * var_x44);
            const double var_x53 = 1 / (12.0 + var_chaste_interface__Na__Na_i);
            const double var_x54 = exp(-0.0037676968035880187 * var_chaste_interface__cell__V);
            const double var_x55 = exp(2.0208023774145616);
            const double var_x56 = exp(-0.037676968035880186 * var_chaste_interface__cell__V);
            const double var_x57 = 1.0 + 0.1245 * var_x54 + 0.036499999999999998 * var_x56 * (-0.14285714285714285 + 0.14285714285714285 * var_x55);
            const double var_x58 = var_x53 * (0.00046907825204670832 * var_x54 + 0.037676968035880186 * var_x56 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x55)) * var_chaste_interface__Na__Na_i / pow(var_x57, 2);
            const double var_x59 = -9.5038640384570741 - 0.11 * var_chaste_interface__cell__V;
            const double var_x60 = var_x59 * var_chaste_interface__Ito__xtos;
            const double var_x61 = var_x1 / pow(var_x2, 2);
            const double var_x62 = 1.8 * var_x42 - 2515.4560000000001 * var_x44;
            const double var_x63 = var_x45 * var_x62;
            const double var_x64 = var_x43 * var_x49 * var_x63 / pow(var_x46, 2);
            
            partialF = var_x19 - var_x37 - 6.7199999999999998 * var_x52 - 1.173913043478261 * var_x58 - 0.032914599276144929 * var_x64 + var_x29 * var_x30 + (-0.055 * var_x3 - 0.11 * var_chaste_interface__Ito__ytos) * var_chaste_interface__Ito__xtos - var_x31 * var_x34 - 0.040000000000000001 * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof - 0.30599999999999999 * var_x14 * var_x6 - 0.050000000000000003 * var_x60 * var_x61 + 0.07298099999999999 * var_x14 * var_x38 * var_x39 + 0.044642857142857144 * var_x31 * var_x32 * var_x38 / pow(var_x33, 2) - 0.29411764705882354 * var_x38 * var_x6 * (0.24326999999999999 * var_x39 - var_x9 * (0.061749999999999999 * var_x10 + 0.039456396800000001 * var_x11) - 0.51429999999999998 * var_x12 * var_x7 / pow(var_x8, 2)) / pow((var_x6 + 0.98039215686274506 * var_x13), 2);
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x15 = pow(var_chaste_interface__Ca__Ca_i_converted, 3);
            const double var_x89 = 32.700000000000003 * var_chaste_interface__Ca__tropi;
            const double var_x90 = pow(var_chaste_interface__Ca__Ca_i_converted, 2);
            const double var_x91 = 0.80000000000000004 * var_x15 / pow((2.4999999999999999e-7 + var_x90), 2);
            const double var_x92 = pow(var_chaste_interface__Ca__Ca_NSR, 2);
            const double var_x93 = 1 / (2500.0 + var_x92);
            const double var_x94 = var_x92 * var_x93;
            const double var_x95 = 0.02069 * var_x94;
            const double var_x96 = 1 / (0.25 + 1000000.0 * var_x90);
            const double var_x97 = 800000.0 * var_x96 * var_chaste_interface__Ca__Ca_i_converted;
            ...
            const double var_x100 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x101 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x102 = 1.0 + 0.00054600000000000004 / pow(var_x98, 2) + 4.4999999999999993e-6 / pow(var_x99, 2) + 0.00016799999999999999 / pow(var_x100, 2) + 2.8199999999999998e-5 / pow(var_x101, 2);
            const double var_x103 = 1 / var_x102;
            const double var_x104 = 0.001 * var_x103;
            const double var_x105 = 32.700000000000003 * var_chaste_interface__Ca__Ca_i_converted;
            const double var_x106 = 400000.0 * var_x90 * var_x96;
            const double var_x107 = 16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted;
            const double var_x108 = 2.069e-5 * var_x107 * var_x94;
            
            partialF = var_x104 * (-2539.0 + var_x89 + var_x91 - var_x95 - var_x97) + 0.001 * (0.0010920000000000001 / pow(var_x98, 3) + 8.9999999999999985e-6 / pow(var_x99, 3) + 0.00033599999999999998 / pow(var_x100, 3) + 5.6399999999999995e-5 / pow(var_x101, 3)) * (var_x108 - var_x106 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x105 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x102, 2);
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x119 = 47.130000000000003 + var_chaste_interface__cell__V;
            const double var_x120 = fabs(var_x119) > 0.001;
            const double var_x121 = -0.080000000000000002 * var_x117;
            
            partialF = ((var_x120) ? (var_x121 - var_x116 * var_x119) : (-3.2000000000000002 + var_x121));
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x124 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V);
            const double var_x125 = var_chaste_interface__cell__V < -40.0;
            const double var_x126 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V);
            const double var_x127 = 1.0 + var_x126;
            
            partialF = ((var_x125) ? (-310000.0 * var_x123 - 0.13500000000000001 * var_x124 - 3.5600000000000001 * var_x122) : (-7.6923076923076916 / var_x127));
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x133 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V);
            const double var_x134 = 1.0 + var_x133;
            const double var_x135 = 1.0 / var_x134;
            const double var_x136 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V);
            const double var_x137 = 1.0 + var_x136;
            const double var_x138 = exp(-0.01052 * var_chaste_interface__cell__V);
            const double var_x139 = var_x138 / var_x137;
            const double var_x140 = 37.780000000000001 + var_chaste_interface__cell__V;
            const double var_x141 = var_x135 * var_x140;
            const double var_x142 = exp(-3.2000000000000002 + var_x113);
            const double var_x143 = 1.0 + var_x142;
            const double var_x144 = exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V);
            const double var_x145 = var_x144 / var_x143;
            
            partialF = ((var_x125) ? (-0.1212 * var_x139 - var_x131 * var_x141) : (-0.29999999999999999 * var_x145));
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x146 = exp(-0.125 * var_chaste_interface__cell__V);
            const double var_x147 = 1.0 + var_x146;
            const double var_x151 = 1 / var_x147;
            const double var_x152 = 1.0 * var_x151;
            const double var_x153 = pow(var_chaste_interface__Ca__Ca_dyad, 3);
            const double var_x154 = 1 / var_x153;
            const double var_x155 = 1 / (1.0 + 27.0 * var_x154);
            
            partialF = -4.3041299999999998 + var_x152 - 0.024167999999999999 * var_x155;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x154 = 1 / var_x153;
            const double var_x155 = 1 / (1.0 + 27.0 * var_x154);
            const double var_x156 = pow(var_chaste_interface__Ca__Ca_dyad, 4);
            const double var_x160 = exp(-10.0 - 0.25 * var_chaste_interface__cell__V);
            const double var_x161 = 1.0 + var_x160;
            const double var_x162 = 1.0 - 1.0 / var_x161;
            const double var_x163 = exp(0.064102564102564111 * var_chaste_interface__cell__V);
            const double var_x164 = 4954.0 * var_x163;
            const double var_x165 = -440.0 + var_x164;
            const double var_x166 = var_x162 * var_x165;
            const double var_x167 = 1 / (450.0 + var_x166);
            const double var_x168 = exp(-3.5335689045936394 - 0.088339222614840993 * var_chaste_interface__cell__V);
            const double var_x169 = 1.0 + var_x168;
            const double var_x172 = 1 / var_x169;
            const double var_x177 = 1.0 + 0.00072525373756441506 * var_x156;
            const double var_x178 = 1 / var_x177;
            const double var_x179 = 78.032899999999998 * var_x178;
            const double var_x180 = 9.9000000000000004 + var_x164 - var_x179;
            const double var_x181 = var_x162 * var_x180;
            const double var_x182 = 1 / (0.10000000000000001 + var_x179 + var_x181);
            const double var_x183 = var_x155 * var_x182;
            const double var_x189 = 1.0 * var_x172;
            const double var_x194 = -var_x152;
            const double var_x196 = var_x167 * var_x189;
            const double var_x197 = var_x183 * var_x189;
            
            partialF = var_x194 - var_x196 - var_x197;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x154 = 1 / var_x153;
            const double var_x155 = 1 / (1.0 + 27.0 * var_x154);
            const double var_x206 = exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V);
            const double var_x207 = 1.0 + var_x206;
            const double var_x211 = 0.33333333333333331 / var_x207;
            const double var_x222 = -0.018268800000000002 * var_x155;
            const double var_x223 = 41.377027474346242 + 1117.1797418073486 * var_x154;
            
            partialF = -0.33343694833333332 + var_x211 + var_x222 - 1.8929217120000003e-7 * var_x155 * var_x223;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.33762909604519775 + var_x211;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x198 = var_x182 * var_x190;
            const double var_x206 = exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V);
            const double var_x207 = 1.0 + var_x206;
            const double var_x211 = 0.33333333333333331 / var_x207;
            const double var_x212 = 0.33333333333333331 - var_x211;
            const double var_x213 = 1 / var_x195;
            const double var_x214 = var_x151 * var_x213;
            const double var_x219 = var_x169 * var_x212;
            const double var_x224 = var_x190 * var_x219;
            const double var_x225 = var_x214 * var_x224;
            const double var_x226 = 233.2480818414322 * var_x225;
            
            partialF = -var_x198 - var_x226;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x194 = -var_x152;
            const double var_x195 = 1.0 + var_x194;
            const double var_x199 = var_x167 * var_x190;
            const double var_x206 = exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V);
            const double var_x207 = 1.0 + var_x206;
            const double var_x211 = 0.33333333333333331 / var_x207;
            const double var_x212 = 0.33333333333333331 - var_x211;
            ...
            const double var_x224 = var_x190 * var_x219;
            const double var_x225 = var_x214 * var_x224;
            const double var_x237 = 1.8437500000000002 * var_x225;
            
            partialF = -var_x199 - var_x237;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x242 = exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V);
            const double var_x243 = -1.0 + var_x242;
            const double var_x244 = 0.00060999999999999997 / var_x243;
            const double var_x245 = 10.0 + var_chaste_interface__cell__V;
            const double var_x247 = exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V);
            const double var_x248 = 1.0 - var_x247;
            const double var_x249 = 0.0013799999999999999 / var_x248;
            const double var_x250 = 7.0 + var_chaste_interface__cell__V;
            const double var_x252 = var_x244 * var_x245;
            const double var_x253 = var_x249 * var_x250;
            const double var_x256 = fabs(var_x250) > 0.001;
            const double var_x257 = fabs(var_x245) > 0.001;
            const double var_x258 = (var_x256) && (var_x257);
            const double var_x259 = -var_x252;
            const double var_x260 = -var_x253;
            
            partialF = ((var_x258) ? (var_x259 + var_x260) : ((var_x257) ? (-0.011219512195121951 + var_x259) : ((var_x256) ? (-0.0042068965517241376 + var_x260) : (-0.015426408746846089))));
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x264 = 30.0 + var_chaste_interface__cell__V;
            const double var_x265 = fabs(var_x264) < 0.014556040756914121;
            const double var_x266 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V);
            const double var_x267 = -1.0 + var_x266;
            const double var_x268 = 0.00013100000000000001 / var_x267;
            const double var_x269 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V);
            const double var_x270 = 1.0 - var_x269;
            const double var_x271 = 7.1899999999999999e-5 / var_x270;
            const double var_x273 = ((var_x265) ? (0.0023926521499665608) : (var_x264 * var_x268 + var_x264 * var_x271));
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x275 = 0.066666666666666666 * var_chaste_interface__cell__V;
            const double var_x276 = exp(0.20000000000000001 + var_x275);
            const double var_x277 = 1.0 + var_x276;
            const double var_x278 = 1 / var_x277;
            const double var_x279 = 1 / (0.5 + 9.0 * var_x278);
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x0 = 0.10000000000000001 * var_chaste_interface__cell__V;
            const double var_x284 = exp(6.0 + var_x0);
            const double var_x285 = 1.0 + var_x284;
            const double var_x286 = 1 / var_x285;
            const double var_x287 = 1 / (30.0 + 3000.0 * var_x286);
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x290 = exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2));
            const double var_x291 = 1 / (1.5 + 3.5 * var_x290);
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x2 = 1.0 + var_x1;
            const double var_x3 = 1 / var_x2;
            const double var_x292 = 1 / (20.0 + 20.0 * var_x3);
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x107 = 16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted;
            const double var_x108 = 2.069e-5 * var_x107 * var_x94;
            const double var_x309 = 1.0 / var_chaste_interface__Ca__Ca_NSR;
            const double var_x310 = var_x309 * var_chaste_interface__Irel__xir;
            const double var_x314 = var_x106 - var_x108 - var_chaste_interface__Irel__xir;
            
            partialF = -0.033333333333333333 - var_x310 + var_x309 * var_x314;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x57 = 1.0 + 0.1245 * var_x54 + 0.036499999999999998 * var_x56 * (-0.14285714285714285 + 0.14285714285714285 * var_x55);
            const double var_x62 = 1.8 * var_x42 - 2515.4560000000001 * var_x44;
            const double var_x67 = 1 / var_chaste_interface__Na__Na_i;
            const double var_x78 = 1 / var_x57;
            const double var_x79 = var_x53 * var_x78;
            const double var_x80 = var_x78 * var_chaste_interface__Na__Na_i / pow((1 + 0.083333333333333329 * var_chaste_interface__Na__Na_i), 2);
            const double var_x81 = pow(var_chaste_interface__Na__Na_i, 2);
            const double var_x82 = var_x50 * var_x62 / pow((1 + 0.0006421786632577935 * var_x40 + 0.33178107931203249 * var_chaste_interface__Ca__Ca_submem), 2);
            const double var_x83 = var_x81 * var_x82;
            const double var_x84 = var_x37 * var_x67;
            const double var_x85 = var_x41 * var_x51 * var_x81;
            
            partialF = 3.0570652173913045e-6 * var_x80 + 3.9135764302406278e-10 * var_x83 - 0.0033176767270912339 * var_x84 - 0.013608 * var_x85 - 0.00044021739130434783 * var_x79;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x62 = 1.8 * var_x42 - 2515.4560000000001 * var_x44;
            const double var_x63 = var_x45 * var_x62;
            const double var_x73 = 0.00010420416882000001 * var_x21;
            const double var_x74 = ((var_x23) ? (-0.063960518821716009 + var_x73 * var_chaste_interface__Ca__Ca_submem) : (var_x27 * var_chaste_interface__cell__V));
            const double var_x75 = var_x74 * mParameters[0];
            const double var_x82 = var_x50 * var_x62 / pow((1 + 0.0006421786632577935 * var_x40 + 0.33178107931203249 * var_chaste_interface__Ca__Ca_submem), 2);
            const double var_x86 = ((var_x23) ? (var_x73) : (7.8521942756732062e-6 * var_x21 * var_x28));
            const double var_x87 = var_x43 * var_x51;
            const double var_x88 = var_x47 * var_x63 / (pow(var_x48, 2) * pow(var_chaste_interface__Ca__Ca_submem, 4));
            const double var_x227 = 1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca;
            const double var_x326 = (-50.0 + 50.0 * var_chaste_interface__ICaL__c1 + 50.0 * var_chaste_interface__ICaL__c2 + 50.0 * var_chaste_interface__ICaL__xi1ba + 50.0 * var_chaste_interface__ICaL__xi1ca + 50.0 * var_chaste_interface__ICaL__xi2ba + 50.0 * var_chaste_interface__ICaL__xi2ca) * mParameters[0];
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative23(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x94 = var_x92 * var_x93;
            const double var_x107 = 16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted;
            const double var_x109 = 0.00034484023000000001 * var_x94;
            const double var_x110 = 4.138e-5 * var_x107 * var_x93 * var_chaste_interface__Ca__Ca_NSR;
            const double var_x111 = 6.6208000000000002e-12 * var_x107 * pow(var_chaste_interface__Ca__Ca_NSR, 3) / pow((1 + 0.00040000000000000002 * var_x92), 2);
            const double var_x315 = var_x111 - var_x109 - var_x110;
    ...
    double Cellmahajan_2008FromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.019599999999999999 - var_x105;
        }
        else
        {
