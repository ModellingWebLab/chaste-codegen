#ifndef CELLPASEK_SIMURDA_CHRISTE_2006FROMCELLMLGRL2OPT_HPP_
#define CELLPASEK_SIMURDA_CHRISTE_2006FROMCELLMLGRL2OPT_HPP_
...
class Cellpasek_simurda_christe_2006FromCellMLGRL2Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellpasek_simurda_christe_2006FromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellpasek_simurda_christe_2006FromCellMLGRL2Opt();
...
CHASTE_CLASS_EXPORT(Cellpasek_simurda_christe_2006FromCellMLGRL2Opt)
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellpasek_simurda_christe_2006FromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellpasek_simurda_christe_2006FromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellpasek_simurda_christe_2006FromCellMLGRL2Opt(p_solver, p_stimulus);
        }
...
#endif // CELLPASEK_SIMURDA_CHRISTE_2006FROMCELLMLGRL2OPT_HPP_