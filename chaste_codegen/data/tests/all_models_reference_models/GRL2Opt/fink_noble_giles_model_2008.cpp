...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x163 = exp(079000000000000001 * var_chaste_interface__cell__V);
            const double var_x164 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V);
            const double var_x165 = 310000 * var_x162;
            const double var_x166 = 2.7000000000000002 * var_x163;
            const double var_x167 = 057000000000000002 * var_x164;
            const double var_x170 = var_chaste_interface__cell__V < -40;
            const double var_x171 = exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__cell__V);
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x176 = exp(-043909999999999998 * var_chaste_interface__cell__V);
            ...
            const double var_x184 = exp(-01052 * var_chaste_interface__cell__V);
            const double var_x185 = var_x184 / var_x183;
            const double var_x186 = 37.780000000000001 + var_chaste_interface__cell__V;
            const double var_x187 = 024240000000000001 * var_x185;
            ...
            const double var_x191 = exp(057000000000000002 * var_chaste_interface__cell__V);
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x199 = exp(-2.6923076923076925 - 076923076923076927 * var_chaste_interface__cell__V);
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x214 = pow((1 + 037037037037037035 * var_chaste_interface__cell__V), 2);
            const double var_x215 = exp(-3.2400000000000002 * var_x214);
            const double var_x220 = 275.625 * var_x215;
            const double var_x221 = 1 / (5.0 + var_x220 + 50 * var_x213 + 45.0 * var_x209);
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x229 = 1 / (var_x228 + 40 * var_x209 + 15.5 * var_x224);
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x232 = 1 / (2.0 + 80 * var_x231);
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative21(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x234 = 001 + var_chaste_interface__Ca__Ca_i;
            const double var_x235 = 1.0 + 00020000000000000001 / pow(var_x234, 2);
            ...
            partialF = var_x237 * (-0038240087783467445 - var_x238 + 2.2487821987979791e-6 * var_x71 - 0086391412367010315 * var_x72 - 5.3144431236283834e-11 * var_x240 - 2.298124085635426e-7 * var_x70) + 00040000000000000002 * (0038 * var_chaste_interface__Ca__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__Ca__Ca_SR + 2.298124085635426e-7 * log(2.0 * var_x70) - 0038240087783467445 * var_chaste_interface__Ca__Ca_i - 1.7205545223759661e-8 * var_chaste_interface__cell__V - 00042515544989027063 * var_x241 - var_x238 * var_chaste_interface__Ca__Ca_i + 1.2593500345045236e-9 * var_x26 * var_x34) / (pow(var_x234, 3) * pow(var_x235, 2));
        }
        else
        {
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x250 = 1 / (059999999999999998 + 0.14999999999999999 * var_x249);
            const double var_x251 = var_x250 * var_chaste_interface__Irel__R_prime;
            const double var_x252 = var_x249 * var_x251;
            const double var_x253 = 045899999999999996 * var_x252;
            ...
            partialF = var_x245 * (-00036000000000000002 - var_x253 + 065280000000000005 * var_x260 - 0097919999999999986 * var_x257) + 0.66666666666666674 * (00036000000000000002 * var_chaste_interface__Ca__Ca_i + 0063749999999999996 * var_x241 - 00036000000000000002 * var_chaste_interface__Ca__Ca_SR - var_x253 * var_x255) / (pow(var_x242, 3) * pow((0.33333333333333337 + var_x243), 2));
        }
        else
        {
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative23(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x264 = 0031491568724328674 * var_x47;
            const double var_x265 = var_x264 * var_x45;
            const double var_x266 = 00025000000000000001 + var_chaste_interface__Ca__Ca_ss;
            const double var_x267 = 1.0 + 0001 / pow(var_x266, 2);
            const double var_x268 = 1 / var_x267;
            const double var_x269 = 1.0 * var_x268;
            const double var_x273 = 0.91833577176298453 * var_x252;
            
            partialF = var_x269 * (-1.1399999999999999 - var_x273 + 1.8366715435259691 * var_x262 - 00078728921810821686 * var_x73 - 1.9591163130943672 * var_x261) + 00020000000000000001 * (1.1399999999999999 * var_chaste_interface__Ca__Ca_i - 1.1399999999999999 * var_chaste_interface__Ca__Ca_ss + var_x255 * var_x273 - var_x265 * var_x49) / (pow(var_x266, 3) * pow(var_x267, 2));
        }
        else
        {
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x246 = pow(var_chaste_interface__Ca__Ca_SR, (-2));
            const double var_x247 = 1 / (1.0 + 2.25 * var_x246);
            const double var_x274 = -0.11249999999999999 + 067500000000000004 * var_x247;
            
            partialF = -0050000000000000001 + var_x274 * var_chaste_interface__Ca__Ca_ss;
        }
        else
        {
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative25(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 1.4908768645188767e-7 * var_x76 - 5.6288512232624455e-7 * var_x59 - 021350814984788587 * var_x79 - 2.2668300621081427e-8 * var_x77 - 00023854029832302029 * var_x75;
        }
        else
        {
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative26(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -4.6583596330447822e-5 * var_x84 - 1.8885766345635723e-5 * var_x85 - 00038819663608706523 * var_x86 - 00073043079046142181 * var_x78 + var_x277 * var_x83 + var_x6 * (6.576305692690868e-7 * var_x80 - 9.8566502268897146e-6 * var_x82 - var_x276 * var_x81);
        }
        else
        {
