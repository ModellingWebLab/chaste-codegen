...
class Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables()
    {
...
protected:
    Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables(const Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables&);
    Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables& operator= (const Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables&);
    Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables()
    {
        ...
        Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables::RegenerateTables();
    }
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = 1.0 + exp(7.5440000000000005 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            ...
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = 1.0 + exp(0.29411764705882354 - 0.058823529411764705 * var_chaste_interface__membrane__V);
            ...
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = 1 / (1.0 + exp(11.852941176470587 + 0.14705882352941177 * var_chaste_interface__membrane__V));
            ...
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = 0.00025000000000000001 * exp(3.6000000000000001 + 0.11 * var_chaste_interface__membrane__V) + 0.00025000000000000001 * exp(-2.8999999999999999 - 0.040000000000000001 * var_chaste_interface__membrane__V);
            ...
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = 7.2999999999999998 + 10.449999999999999 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2));
            ...
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = 42.0 + 5.0 / (1.0 + exp(-8.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(-1.953125 * pow((1 + 0.040000000000000001 * var_chaste_interface__membrane__V), 2));
...
private:
    ...
    static std::shared_ptr<Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables> mpInstance;
...
std::shared_ptr<Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables> Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::GetLookupTableCollection()
    {
        return Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables::Instance();
    }
    ...
    double Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x6 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * mParameters[14];
            ...
            const double var_x10 = mParameters[12] / var_x9;
            const double var_x11 = mParameters[16] * var_chaste_interface__transient_outward_current_r_gate__r;
            ...
            const double var_x14 = log(var_x13 * mParameters[5]);
            ...
            const double var_x20 = var_x19 * mParameters[9] * var_chaste_interface__fast_sodium_current_j_gate__j;
            const double var_x21 = var_x20 * var_chaste_interface__fast_sodium_current_h_gate__h;
            const double var_x22 = var_x8 * (-8.0 + var_x16) * mParameters[12] / pow(var_x9, 2);
            const double var_x23 = sqrt(mParameters[5]);
            const double var_x24 = var_x23 * mParameters[13] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
            const double var_x25 = 0.43033148291193518 * var_x24;
            const double var_x26 = _lt_0_row[5];
            const double var_x27 = pow(mParameters[6], 3);
            const double var_x28 = var_x26 * var_x27;
            const double var_x29 = var_x28 * var_chaste_interface__calcium_dynamics__Ca_i;
            const double var_x30 = mParameters[4] * _lt_0_row[4];
            ...
            const double var_x33 = mParameters[15] / ((669921.875 + var_x27) * (1.3799999999999999 + mParameters[4]));
            ...
            const double var_x36 = 1 / (1.0 + mParameters[5]);
            ...
            const double var_x41 = var_x36 * var_x37 * (0.001321416346042915 * var_x38 + 0.00046605194074318115 * var_x39) * mParameters[5] * var_chaste_interface__sodium_dynamics__Na_i / pow(var_x40, 2);
            const double var_x42 = var_x31 - 2.5 * var_x29;
            const double var_x43 = var_x26 * var_x33 * var_x42 / pow(var_x32, 2);
            const double var_x44 = _lt_0_row[0];
            const double var_x45 = -1.0 + var_x44;
            const double var_x46 = 1 / var_x45;
            const double var_x47 = var_x46 * mParameters[7] * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f;
            const double var_x48 = var_x44 * var_chaste_interface__calcium_dynamics__Ca_ss;
            const double var_x49 = -mParameters[4] + 0.25 * var_x48;
            const double var_x50 = 14447.286958825251 * var_x49;
            const double var_x51 = -15.0 + var_chaste_interface__membrane__V;
            const double var_x52 = var_x51 * mParameters[7] * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f;
...
// LCOV_EXCL_STOP
    ...
    double Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x160 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * mParameters[11]);
            const double var_x161 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * mParameters[11]);
            const double var_x162 = exp(-11.764705882352942 - var_x102 + 0.14705882352941177 * mParameters[11]);
            const double var_x163 = 310000.0 * var_x160;
            const double var_x164 = 2.7000000000000002 * var_x161;
            const double var_x165 = 0.057000000000000002 * var_x162;
            const double var_x168 = var_chaste_interface__membrane__V < -40.0;
            const double var_x169 = exp(-0.96036036036036043 + 0.0900900900900901 * mParameters[11] - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x170 = 1.0 + var_x169;
            const double var_x171 = 1 / var_x170;
            
            partialF = ((var_x168) ? (-var_x163 - var_x164 - var_x165) : (-5.9230769230769234 * var_x171));
        }
        else
        {
    ...
    double Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x7 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x168 = var_chaste_interface__membrane__V < -40.0;
            const double var_x173 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * mParameters[11]);
            const double var_x174 = exp(0.043909999999999998 * mParameters[11] - 0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x175 = -25428.0 * var_x173 - 6.9480000000000002e-6 * var_x174;
            const double var_x176 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * mParameters[11]);
            const double var_x177 = 1.0 + var_x176;
            const double var_x178 = 1 / var_x177;
            const double var_x179 = var_x175 * var_x178;
            const double var_x180 = exp(-5.5312920000000005 + 0.13780000000000001 * mParameters[11] - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x181 = 1.0 + var_x180;
            const double var_x182 = exp(0.01052 * mParameters[11] - 0.01052 * var_chaste_interface__membrane__V);
            const double var_x183 = var_x182 / var_x181;
            const double var_x184 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x185 = 0.024240000000000001 * var_x183;
            const double var_x186 = var_x179 * var_x184;
            const double var_x187 = exp(-3.2000000000000002 - var_x7 + 0.10000000000000001 * mParameters[11]);
            const double var_x188 = 1.0 + var_x187;
            const double var_x189 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * mParameters[11]);
            const double var_x190 = var_x189 / var_x188;
            
            partialF = ((var_x168) ? (-var_x185 - var_x186) : (-0.59999999999999998 * var_x190));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x121 = -var_x120;
            const double var_x140 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x191 = exp(2.5 + var_x121);
            const double var_x192 = 1.0 + var_x191;
            const double var_x193 = 1 / var_x192;
            const double var_x194 = exp(1.0 + var_x140);
            const double var_x195 = 1.0 + var_x194;
            const double var_x196 = 1 / var_x195;
            const double var_x197 = 0.076923076923076927 * var_chaste_interface__membrane__V;
            const double var_x198 = -var_x197;
            const double var_x199 = exp(-2.6923076923076925 + var_x198);
            ...
            const double var_x205 = 1 / (var_x193 + 1.3999999999999999 * var_x202);
...
// LCOV_EXCL_STOP
    ...
    double Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x109 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x110 = -var_x109;
            const double var_x206 = exp(3.0 + var_x109);
            const double var_x207 = 1.0 + var_x206;
            const double var_x208 = 1 / var_x207;
            const double var_x209 = exp(1.3 + var_x110);
            const double var_x210 = 1.0 + var_x209;
            const double var_x211 = 1 / var_x210;
            const double var_x212 = pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2);
            const double var_x213 = exp(-3.2400000000000002 * var_x212);
            const double var_x217 = 1102.5 * var_x213;
            const double var_x218 = 1 / (20.0 + var_x217 + 200.0 * var_x211 + 180.0 * var_x208);
...
// LCOV_EXCL_STOP
    ...
    double Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x208 = 1 / var_x207;
            const double var_x212 = pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2);
            const double var_x219 = exp(2.5 + var_x110);
            const double var_x220 = 1.0 + var_x219;
            const double var_x221 = 1 / var_x220;
            const double var_x222 = exp(-3.0375000000000001 * var_x212);
            const double var_x225 = 562.0 * var_x222;
            const double var_x226 = 1 / (var_x225 + 80.0 * var_x208 + 31.0 * var_x221);
    ...
    double Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x227 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2);
...
// LCOV_EXCL_STOP
    ...
    double Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x140 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x231 = exp(-8.0 + var_x140);
            const double var_x232 = 1.0 + var_x231;
            const double var_x233 = 1 / var_x232;
            const double var_x234 = exp(-1.953125 * pow((1 + 0.040000000000000001 * var_chaste_interface__membrane__V), 2));
            const double var_x237 = 85.0 * var_x234;
            const double var_x238 = 1 / (42.0 + var_x237 + 5.0 * var_x233);
...
// LCOV_EXCL_STOP
    ...
    double Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x241 = exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2));
            const double var_x242 = 1 / (7.2999999999999998 + 10.449999999999999 * var_x241);
    ...
    double Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x101 = mParameters[2] / var_x98;
            const double var_x227 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2);
            const double var_x243 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
            const double var_x244 = pow(var_x243, (-2));
            const double var_x245 = 1 / (1.0 + 3.0 * var_x244);
            const double var_x246 = var_x245;
            const double var_x247 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
            const double var_x248 = 1 / (1.0 + 2.25 * var_x247);
            const double var_x249 = 1 / (2.5 - 1.5 * var_x248);
            const double var_x250 = var_x227 * var_x249;
            const double var_x251 = 0.14999999999999999 * var_x250;
            const double var_x252 = 1 / (0.059999999999999998 + var_x251);
            const double var_x253 = var_chaste_interface__calcium_dynamics__R_prime * mParameters[1];
            const double var_x254 = var_x252 * var_x253;
            const double var_x255 = var_x251 * var_x254;
            const double var_x256 = 1 / (pow((0.44444444444444442 + var_x247), 2) * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3));
            const double var_x257 = -var_chaste_interface__calcium_dynamics__Ca_ss + var_chaste_interface__calcium_dynamics__Ca_SR;
            const double var_x258 = var_x257 / pow((1 - 0.59999999999999998 * var_x248), 2);
            const double var_x259 = var_x227 * var_x254 * var_x256 * var_x258;
            const double var_x260 = var_x253 * var_x258 / pow((0.40000000000000002 + var_x250), 2);
            const double var_x261 = var_x249 * var_x256 * var_x260 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4);
            
            partialF = var_x246 * (-var_x255 - mParameters[0] + 0.21333333333333335 * var_x261 - 0.032000000000000001 * var_x259) + 0.66666666666666674 * (var_x101 - var_x100 * mParameters[0] - var_x255 * var_x257) / (pow(var_x243, 3) * pow((0.33333333333333337 + var_x244), 2));
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x258 = var_x257 / pow((1 - 0.59999999999999998 * var_x248), 2);
            const double var_x260 = var_x253 * var_x258 / pow((0.40000000000000002 + var_x250), 2);
            const double var_x262 = var_x260 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3);
            const double var_x263 = var_chaste_interface__calcium_dynamics__Ca_ss * var_chaste_interface__calcium_dynamics__R_prime;
            const double var_x264 = var_x252 * var_x257 * mParameters[1];
            const double var_x265 = var_x249 * var_x263 * var_x264;
            const double var_x266 = var_x49 * mParameters[8];
            const double var_x267 = 1369.1986401882032 * var_x266;
            const double var_x268 = 0.00025000000000000001 + var_chaste_interface__calcium_dynamics__Ca_ss;
            const double var_x269 = 1.0 + 0.0001 / pow(var_x268, 2);
            const double var_x270 = 1 / var_x269;
            const double var_x271 = var_x270;
            const double var_x274 = 3.0010972933430868 * var_x250;
            const double var_x275 = var_x254 * var_x274;
            
            partialF = var_x271 * (-1.1399999999999999 - var_x275 + 6.0021945866861737 * var_x265 - 6.4023408924652525 * var_x262 - 342.29966004705079 * var_x78 * mParameters[8]) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x257 * var_x275 - var_x267 * var_x54) / (pow(var_x268, 3) * pow(var_x269, 2));
        }
        else
        {
    ...
    double Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x247 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
            const double var_x248 = 1 / (1.0 + 2.25 * var_x247);
            const double var_x276 = -0.11249999999999999 + 0.067500000000000004 * var_x248;
            
            partialF = -0.0050000000000000001 + var_x276 * var_chaste_interface__calcium_dynamics__Ca_ss;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x81 = var_x36 * mParameters[5] / var_x40;
            ...
            const double var_x277 = mParameters[8] * mParameters[3];
            
            partialF = var_x277 * (3.2269874497044823e-6 * var_x83 - 0.016878114612481093 * var_x84 - 4.8946532376195178e-6 * var_x62 - 0.0056863214972766203 * var_x85 - 0.00024583649057663214 * var_x79 - 0.0051631799195271718 * var_x82);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellstewart_zhang_model_2008_ssFromCellMLGRL2Opt::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x277 * (-0.00024642047334222399 * var_x88 - 0.016878114612481093 * var_x80 - 0.016878114612481093 * var_x89 - 0.016878114612481093 * var_x90 - 0.00038313320170332084 * var_x87 - 0.00039553186469764944 * var_x86 - 0.0072631840899465916 * var_x92);
        }
        else
        {
