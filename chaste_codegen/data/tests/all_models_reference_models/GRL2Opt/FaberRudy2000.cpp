...
class CellFaberRudy2000FromCellMLGRL2Opt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellFaberRudy2000FromCellMLGRL2Opt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellFaberRudy2000FromCellMLGRL2Opt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = CellFaberRudy2000FromCellMLGRL2Opt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellFaberRudy2000FromCellMLGRL2Opt_LookupTables()
    {
...
protected:
    CellFaberRudy2000FromCellMLGRL2Opt_LookupTables(const CellFaberRudy2000FromCellMLGRL2Opt_LookupTables&);
    CellFaberRudy2000FromCellMLGRL2Opt_LookupTables& operator= (const CellFaberRudy2000FromCellMLGRL2Opt_LookupTables&);
    CellFaberRudy2000FromCellMLGRL2Opt_LookupTables()
    {
        ...
        CellFaberRudy2000FromCellMLGRL2Opt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellFaberRudy2000FromCellMLGRL2Opt_LookupTables> mpInstance;
...
std::shared_ptr<CellFaberRudy2000FromCellMLGRL2Opt_LookupTables> CellFaberRudy2000FromCellMLGRL2Opt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* CellFaberRudy2000FromCellMLGRL2Opt::GetLookupTableCollection()
    {
        return CellFaberRudy2000FromCellMLGRL2Opt_LookupTables::Instance();
    }
    ...
    double CellFaberRudy2000FromCellMLGRL2Opt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellFaberRudy2000FromCellMLGRL2Opt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellFaberRudy2000FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
