...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhund_rudy_2004_aFromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        ...
        const double var_Irel__irelcicr = 3000.0 * (-var_chaste_interface__Ca__Ca_ss + var_chaste_interface__Ca__Ca_jsr) * ((var_Environment__tissue == 0) ? (1.0 / (1.0 + exp(2.6000000000000001 + 0.20000000000000001 * var_ICaL__ibarca))) : (1.0)) * var_chaste_interface__Irel__ri * var_chaste_interface__Irel__ro; // mM_per_ms
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative28(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x431 * (-5.0 - var_x434 - 0.0036718475849305066 * var_x261 - 505.56458679596358 * var_x422) + 1.0 * (0.019557600000000001 / pow(var_x427, 3) + 8.1780000000000006e-5 / pow(var_x428, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0.0036718475849305066 * var_x246 + var_x411 * var_x434) / pow(var_x429, 2);
        }
        else
        {
