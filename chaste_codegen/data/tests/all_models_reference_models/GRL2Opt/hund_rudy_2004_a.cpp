...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        // Units: mM; Initial value: 00012131666
        ...
        // Units: dimensionless; Initial value: 001356538159
        ...
        // Units: dimensionless; Initial value: 019883138161
        double var_chaste_interface__IKs__xs2 = rY[13];
        // Units: dimensionless; Initial value: 019890650554
        double var_chaste_interface__Ito__ydv = rY[14];
        // Units: dimensionless; Initial value: 013970786703
        ...
        // Units: dimensionless; Initial value: 000816605172
        ...
        // Units: mM; Initial value: 00012271265
        
        const double var_INaCa__ca_i_NaCa = 1.5 * var_chaste_interface__Ca__Ca_i; // mM
        const double var_INaCa__INaCa = 4.5 * (1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(01310255922773 * var_chaste_interface__cell__V) - 2744000 * var_INaCa__ca_i_NaCa * exp(-024333324280070002 * var_chaste_interface__cell__V)) / ((1.0 + 0.27000000000000002 * exp(-024333324280070002 * var_chaste_interface__cell__V)) * (1.0 + 1.5624999999999999e-8 / pow(var_INaCa__ca_i_NaCa, 2)) * (13227.9606 + 8.4084932990912282 * pow(var_chaste_interface__Na__Na_i, 3) + 4344355.375 * var_INaCa__ca_i_NaCa)); // uA_per_uF
        const double var_INaK__INaK = 0.48423913043478262 / ((1.0 + 100 / pow(var_chaste_interface__Na__Na_i, 2)) * (1.0 + 0.1245 * exp(-00374358835078 * var_chaste_interface__cell__V) + 036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0374358835078 * var_chaste_interface__cell__V))); // uA_per_uF
        const double var_cell__caiont = -2.0 * var_INaCa__INaCa + 057500000000000002 * var_chaste_interface__Ca__Ca_i / (00050000000000000001 + var_chaste_interface__Ca__Ca_i) + 0028824983370005666 * (-0.61380000000000001 + var_chaste_interface__Ca__Ca_i * exp(074871767015599999 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(074871767015599999 * var_chaste_interface__cell__V)) + 3.5108651860830804 * pow(var_chaste_interface__ICaL__d, var_chaste_interface__ICaL__dp) * (-15.0 + var_chaste_interface__cell__V) * (-0.61380000000000001 + 1.0 * var_chaste_interface__Ca__Ca_ss * exp(-1.1230765052339999 + 074871767015599999 * var_chaste_interface__cell__V)) * mParameters[0] * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca * var_chaste_interface__ICaL__fca2 / (-1.0 + exp(-1.1230765052339999 + 074871767015599999 * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_cell__clont = 00022499999999999999 * var_chaste_interface__cell__V + 00601027620873753 * log(100 / var_chaste_interface__Cl__Cl_i) + 001444800488100033 * (-100 * exp(0374358835078 * var_chaste_interface__cell__V) + var_chaste_interface__Cl__Cl_i) * var_chaste_interface__Ito2__AA * var_chaste_interface__cell__V / (1.0 - exp(0374358835078 * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_reversal_potentials__EK = 26.712338705500134 * log(5.4000000000000004 / var_chaste_interface__K__K_i); // mV
        const double var_reversal_potentials__ENa = 26.712338705500134 * log(140 / var_chaste_interface__Na__Na_i); // mV
        const double var_cell__naiont = 3.0 * var_INaCa__INaCa + 3.0 * var_INaK__INaK + 0064999999999999997 * pow(var_chaste_interface__INal__mL, 3) * (-var_reversal_potentials__ENa + var_chaste_interface__cell__V) * var_chaste_interface__INal__hL + 8.25 * pow(var_chaste_interface__INa__m, 3) * (-var_reversal_potentials__ENa + var_chaste_interface__cell__V) * mParameters[1] * var_chaste_interface__INa__H * var_chaste_interface__INa__J; // uA_per_uF
        const double var_cell__kiont = -2.0 * var_INaK__INaK + 0027599999999999999 * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V)) + 0.51000000000000001 * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 0.23849999999999999 * var_reversal_potentials__EK)) * (1.02 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 0.23849999999999999 * var_reversal_potentials__EK)) + (1.0 * exp(-36.698642499999998 + 061749999999999999 * var_chaste_interface__cell__V - 061749999999999999 * var_reversal_potentials__EK) + 0.49124000000000001 * exp(0.43983232 + 080320000000000003 * var_chaste_interface__cell__V - 080320000000000003 * var_reversal_potentials__EK)) / (1.0 + exp(-2.4444678999999998 + 0.51429999999999998 * var_reversal_potentials__EK - 0.51429999999999998 * var_chaste_interface__cell__V)))) + (024897499999999999 + 014938499999999999 / (1.0 + 6.4818210260626455e-7 * pow(1 / var_chaste_interface__Ca__Ca_i, 1.3999999999999999))) * (-26.712338705500134 * log(7.9662000000000006 / (018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i)) + var_chaste_interface__cell__V) * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2 + 013854200000000001 * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * mParameters[2] * var_chaste_interface__IKr__xr / (1.0 + exp(0.64935064935064934 + 064935064935064929 * var_chaste_interface__cell__V)) + 0.19 * pow(var_chaste_interface__Ito__ydv, 3) * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv * exp(0033333333333333335 * var_chaste_interface__cell__V); // uA_per_uF
    ...
    void Cellhund_rudy_2004_aFromCellMLGRL2::UpdateTransmembranePotential(double var_chaste_interface__Environment__time)
    {
        ...
        const double var_INaCa__ca_i_NaCa = 1.5 * var_chaste_interface__Ca__Ca_i; // mM
        const double var_IpCa__IpCa = 057500000000000002 * var_chaste_interface__Ca__Ca_i / (00050000000000000001 + var_chaste_interface__Ca__Ca_i); // uA_per_uF
        const double var_ICaL__ibarca = 3.5108651860830804 * (-15.0 + var_chaste_interface__cell__V) * (-0.61380000000000001 + 1.0 * var_chaste_interface__Ca__Ca_ss * exp(-1.1230765052339999 + 074871767015599999 * var_chaste_interface__cell__V)) * mParameters[0] / (-1.0 + exp(-1.1230765052339999 + 074871767015599999 * var_chaste_interface__cell__V)); // uA_per_uF
        ...
        const double var_ICab__ICab = 0028824983370005666 * (-0.61380000000000001 + var_chaste_interface__Ca__Ca_i * exp(074871767015599999 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(074871767015599999 * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_INaCa__INaCa = 4.5 * (1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(01310255922773 * var_chaste_interface__cell__V) - 2744000 * var_INaCa__ca_i_NaCa * exp(-024333324280070002 * var_chaste_interface__cell__V)) / ((1.0 + 0.27000000000000002 * exp(-024333324280070002 * var_chaste_interface__cell__V)) * (1.0 + 1.5624999999999999e-8 / pow(var_INaCa__ca_i_NaCa, 2)) * (13227.9606 + 8.4084932990912282 * pow(var_chaste_interface__Na__Na_i, 3) + 4344355.375 * var_INaCa__ca_i_NaCa)); // uA_per_uF
        const double var_INaK__INaK = 0.48423913043478262 / ((1.0 + 100 / pow(var_chaste_interface__Na__Na_i, 2)) * (1.0 + 0.1245 * exp(-00374358835078 * var_chaste_interface__cell__V) + 036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0374358835078 * var_chaste_interface__cell__V))); // uA_per_uF
        ...
        const double var_reversal_potentials__ECl = -26.712338705500134 * log(100 / var_chaste_interface__Cl__Cl_i); // mV
        const double var_cell__clont = 0.5 * var_cell__i_Stim + 00022499999999999999 * var_chaste_interface__cell__V - 00022499999999999999 * var_reversal_potentials__ECl + 001444800488100033 * (-100 * exp(0374358835078 * var_chaste_interface__cell__V) + var_chaste_interface__Cl__Cl_i) * var_chaste_interface__Ito2__AA * var_chaste_interface__cell__V / (1.0 - exp(0374358835078 * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_reversal_potentials__EK = 26.712338705500134 * log(5.4000000000000004 / var_chaste_interface__K__K_i); // mV
        const double var_reversal_potentials__ENa = 26.712338705500134 * log(140 / var_chaste_interface__Na__Na_i); // mV
        const double var_cell__naiont = 3.0 * var_INaCa__INaCa + 3.0 * var_INaK__INaK + 0064999999999999997 * pow(var_chaste_interface__INal__mL, 3) * (-var_reversal_potentials__ENa + var_chaste_interface__cell__V) * var_chaste_interface__INal__hL + 8.25 * pow(var_chaste_interface__INa__m, 3) * (-var_reversal_potentials__ENa + var_chaste_interface__cell__V) * mParameters[1] * var_chaste_interface__INa__H * var_chaste_interface__INa__J; // uA_per_uF
        const double var_cell__kiont = 0.5 * var_cell__i_Stim - 2.0 * var_INaK__INaK + 0027599999999999999 * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V)) + 0.51000000000000001 * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 0.23849999999999999 * var_reversal_potentials__EK)) * (1.02 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 0.23849999999999999 * var_reversal_potentials__EK)) + (1.0 * exp(-36.698642499999998 + 061749999999999999 * var_chaste_interface__cell__V - 061749999999999999 * var_reversal_potentials__EK) + 0.49124000000000001 * exp(0.43983232 + 080320000000000003 * var_chaste_interface__cell__V - 080320000000000003 * var_reversal_potentials__EK)) / (1.0 + exp(-2.4444678999999998 + 0.51429999999999998 * var_reversal_potentials__EK - 0.51429999999999998 * var_chaste_interface__cell__V)))) + (024897499999999999 + 014938499999999999 / (1.0 + 6.4818210260626455e-7 * pow(1 / var_chaste_interface__Ca__Ca_i, 1.3999999999999999))) * (-26.712338705500134 * log(7.9662000000000006 / (018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i)) + var_chaste_interface__cell__V) * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2 + 013854200000000001 * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * mParameters[2] * var_chaste_interface__IKr__xr / (1.0 + exp(0.64935064935064934 + 064935064935064929 * var_chaste_interface__cell__V)) + 0.19 * pow(var_chaste_interface__Ito__ydv, 3) * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv * exp(0033333333333333335 * var_chaste_interface__cell__V); // uA_per_uF
    ...
    void Cellhund_rudy_2004_aFromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        ...
        // Units: dimensionless; Initial value: 021123704774
        ...
        const double var_Idiff_Itr__itr = 0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0083333333333333332 * var_chaste_interface__Ca__Ca_jsr; // mM_per_ms
        const double var_IpCa__IpCa = 057500000000000002 * var_chaste_interface__Ca__Ca_i / (00050000000000000001 + var_chaste_interface__Ca__Ca_i); // uA_per_uF
        const double var_Irel__CaMKactive = 050000000000000003 * (1.0 - var_chaste_interface__Irel__CaMKtrap) / (1.0 + 0015 / var_chaste_interface__Ca__Ca_ss) + var_chaste_interface__Irel__CaMKtrap; // dimensionless
        const double d_dt_chaste_interface_var_Irel__CaMKtrap = -00068000000000000005 * var_chaste_interface__Irel__CaMKtrap + 050000000000000003 * (-var_chaste_interface__Irel__CaMKtrap + var_Irel__CaMKactive) * var_Irel__CaMKactive; // 1 / ms
        ...
        const double var_Iup_Ileak__iup = 0043750000000000004 * (1.0 + 0.75 * var_Irel__CaMKactive / (0.14999999999999999 + var_Irel__CaMKactive)) * var_chaste_interface__Ca__Ca_i / (00092000000000000003 - 00017000000000000001 * var_Irel__CaMKactive / (0.14999999999999999 + var_Irel__CaMKactive) + var_chaste_interface__Ca__Ca_i); // mM_per_ms
        const double var_Iup_Ileak__ileak = 00029166666666666669 * var_chaste_interface__Ca__Ca_nsr; // mM_per_ms
        ...
        const double var_ICaL__ibarca = 3.5108651860830804 * (-15.0 + var_chaste_interface__cell__V) * (-0.61380000000000001 + 1.0 * var_chaste_interface__Ca__Ca_ss * exp(-1.1230765052339999 + 074871767015599999 * var_chaste_interface__cell__V)) * mParameters[0] / (-1.0 + exp(-1.1230765052339999 + 074871767015599999 * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_ICaL__ICaL = pow(var_chaste_interface__ICaL__d, var_chaste_interface__ICaL__dp) * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca * var_chaste_interface__ICaL__fca2 * var_ICaL__ibarca; // uA_per_uF
        const double d_dt_chaste_interface_var_ICaL__fca = (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 / (1.0 + 333.33333333333331 * var_chaste_interface__Ca__Ca_ss) + 0.29999999999999999 / (1.0 - 20 * var_ICaL__ICaL)) / (0.5 + 1.0 / (1.0 + 333.33333333333331 * var_chaste_interface__Ca__Ca_ss) + 10 * var_Irel__CaMKactive / (0.14999999999999999 + var_Irel__CaMKactive)); // 1 / ms
        const double d_dt_chaste_interface_var_ICaL__d = (-var_chaste_interface__ICaL__d + 1.0 / (1.0 + exp(0.59347181008902072 - 0.14836795252225518 * var_chaste_interface__cell__V))) / (0.58999999999999997 + 0.80000000000000004 * exp(0.67599999999999993 + 051999999999999998 * var_chaste_interface__cell__V) / (1.0 + exp(1.7160000000000002 + 0.13200000000000001 * var_chaste_interface__cell__V))); // 1 / ms
        const double d_dt_chaste_interface_var_ICaL__f = (052900000000000003 + 0.24110000000000001 * exp(-0.19019454876899997 * pow((-1 + 0.10318426646304972 * var_chaste_interface__cell__V), 2))) * (0.29999999999999999 - var_chaste_interface__ICaL__f + 0.69999999999999996 / (1.0 + exp(2.4457142857142857 + 0.14285714285714285 * var_chaste_interface__cell__V))); // 1 / ms
        const double d_dt_chaste_interface_var_ICaL__f2 = (0054000000000000003 + 042299999999999997 * exp(-1.20074125971556 * pow((-1 + 053842757610673787 * var_chaste_interface__cell__V), 2))) * (0.23000000000000001 - var_chaste_interface__ICaL__f2 + 0.77000000000000002 / (1.0 + exp(2.4457142857142857 + 0.14285714285714285 * var_chaste_interface__cell__V))); // 1 / ms
        const double d_dt_chaste_interface_var_ICaL__fca2 = (-var_chaste_interface__ICaL__fca2 + 1.0 / (1.0 - 100 * var_ICaL__ICaL)) / (125.0 + 300 / (1.0 + exp(-4.375 - 25.0 * var_ICaL__ICaL))); // 1 / ms
        const double var_ICab__ICab = 0028824983370005666 * (-0.61380000000000001 + var_chaste_interface__Ca__Ca_i * exp(074871767015599999 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(074871767015599999 * var_chaste_interface__cell__V)); // uA_per_uF
        const double d_dt_chaste_interface_var_IKr__xr = (-var_chaste_interface__IKr__xr + 1.0 / (1.0 + exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__cell__V))) * (00029999999999999997 * (38.360799999999998 + var_chaste_interface__cell__V) / (-1.0 + exp(5.8385137599999997 + 0.1522 * var_chaste_interface__cell__V)) + 00059999999999999995 * (-1.7383999999999999 + var_chaste_interface__cell__V) / (1.0 - exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__cell__V))); // 1 / ms
        const double var_IKs__tauxs = 1.0 / (7.6100000000000007e-5 * (44.600000000000001 + var_chaste_interface__cell__V) / (1.0 - exp(-444.66200000000003 - 9.9700000000000006 * var_chaste_interface__cell__V)) + 00036000000000000002 * (-0.55000000000000004 + var_chaste_interface__cell__V) / (-1.0 + exp(-070400000000000004 + 0.128 * var_chaste_interface__cell__V))); // ms
        const double var_IKs__xss = 1.0 / (1.0 + exp(0.4251012145748988 - 04048582995951417 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double d_dt_chaste_interface_var_INa__H = (1.0 - var_chaste_interface__INa__H) * ((var_chaste_interface__cell__V >= -40) ? (0) : (0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V))) - ((var_chaste_interface__cell__V >= -40) ? (7.6923076923076916 / (1.0 + exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__cell__V))) : (310000 * exp(0.34999999999999998 * var_chaste_interface__cell__V) + 3.5600000000000001 * exp(079000000000000001 * var_chaste_interface__cell__V))) * var_chaste_interface__INa__H; // 1 / ms
        const double d_dt_chaste_interface_var_INa__J = (1.0 - var_chaste_interface__INa__J) * ((var_chaste_interface__cell__V >= -40) ? (0) : (1.0 * (37.780000000000001 + var_chaste_interface__cell__V) * (-127140 * exp(0.24440000000000001 * var_chaste_interface__cell__V) - 3.4740000000000003e-5 * exp(-043909999999999998 * var_chaste_interface__cell__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)))) - ((var_chaste_interface__cell__V >= -40) ? (0.29999999999999999 * exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V) / (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__cell__V))) : (0.1212 * exp(-01052 * var_chaste_interface__cell__V) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V)))) * var_chaste_interface__INa__J; // 1 / ms
        const double d_dt_chaste_interface_var_INa__m = -080000000000000002 * var_chaste_interface__INa__m * exp(-090909090909090912 * var_chaste_interface__cell__V) + 0.32000000000000001 * (1.0 - var_chaste_interface__INa__m) * (47.130000000000003 + var_chaste_interface__cell__V) / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__cell__V)); // 1 / ms
        const double var_INaCa__INaCa = 4.5 * (1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(01310255922773 * var_chaste_interface__cell__V) - 2744000 * var_INaCa__ca_i_NaCa * exp(-024333324280070002 * var_chaste_interface__cell__V)) / ((1.0 + 0.27000000000000002 * exp(-024333324280070002 * var_chaste_interface__cell__V)) * (1.0 + 1.5624999999999999e-8 / pow(var_INaCa__ca_i_NaCa, 2)) * (13227.9606 + 8.4084932990912282 * pow(var_chaste_interface__Na__Na_i, 3) + 4344355.375 * var_INaCa__ca_i_NaCa)); // uA_per_uF
        const double var_INaK__INaK = 0.48423913043478262 / ((1.0 + 100 / pow(var_chaste_interface__Na__Na_i, 2)) * (1.0 + 0.1245 * exp(-00374358835078 * var_chaste_interface__cell__V) + 036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0374358835078 * var_chaste_interface__cell__V))); // uA_per_uF
        const double d_dt_chaste_interface_var_INal__mL = -080000000000000002 * var_chaste_interface__INal__mL * exp(-090909090909090912 * var_chaste_interface__cell__V) + 0.32000000000000001 * (1.0 - var_chaste_interface__INal__mL) * (47.130000000000003 + var_chaste_interface__cell__V) / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__cell__V)); // 1 / ms
        const double d_dt_chaste_interface_var_INal__hL = 0016666666666666668 / (1.0 + exp(14.918032786885247 + 0.16393442622950821 * var_chaste_interface__cell__V)) - 0016666666666666668 * var_chaste_interface__INal__hL; // 1 / ms
        const double var_Irel__cafac = 1.0 / (1.0 + exp(3.3333333333333335 + 66.666666666666671 * var_ICaL__ICaL)); // dimensionless
        const double d_dt_chaste_interface_var_Irel__ro = -0.33333333333333331 * var_chaste_interface__Irel__ro + 0.33333333333333331 * pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999) / ((1.0 + 1.0 / pow(var_ICaL__ICaL, 2)) * (pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999) + 1644.6531773416521 * pow((var_chaste_interface__Ca__Ca_ss / (0028 + var_chaste_interface__Ca__Ca_ss)), 1.8999999999999999))); // 1 / ms
        const double d_dt_chaste_interface_var_Irel__ri = (-var_chaste_interface__Irel__ri + 1.0 / (1.0 + exp(-16.0 + 80 * var_Irel__cafac + 40000 * var_chaste_interface__Ca__Ca_ss))) / (3.0 + (350 - 10 * var_Irel__CaMKactive / (0.14999999999999999 + var_Irel__CaMKactive)) / (1.0 + exp(-15.0 + 5000 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_Irel__cafac)) + 10 * var_Irel__CaMKactive / (0.14999999999999999 + var_Irel__CaMKactive)); // 1 / ms
        const double var_Irel__irelcicr = 3000 * (-var_chaste_interface__Ca__Ca_ss + var_chaste_interface__Ca__Ca_jsr) * var_chaste_interface__Irel__ri * var_chaste_interface__Irel__ro / (1.0 + exp(2.6000000000000001 + 0.20000000000000001 * var_ICaL__ibarca)); // mM_per_ms
        ...
        const double d_dt_chaste_interface_var_Ito__ydv = 25.0 * (1.0 - var_chaste_interface__Ito__ydv) * exp(-1.6000000000000001 + 040000000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(-1.6000000000000001 + 040000000000000001 * var_chaste_interface__cell__V)) - 25.0 * var_chaste_interface__Ito__ydv * exp(-3.6000000000000001 - 040000000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(-3.6000000000000001 - 040000000000000001 * var_chaste_interface__cell__V)); // 1 / ms
        const double d_dt_chaste_interface_var_Ito__ydv2 = 029999999999999999 * (1.0 - var_chaste_interface__Ito__ydv2) / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) - 0.20000000000000001 * var_chaste_interface__Ito__ydv2 * exp(5.0 + 0.20000000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(5.0 + 0.20000000000000001 * var_chaste_interface__cell__V)); // 1 / ms
        const double d_dt_chaste_interface_var_Ito__zdv = 0022499999999999998 * (1.0 - var_chaste_interface__Ito__zdv) / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) - 0.10000000000000001 * var_chaste_interface__Ito__zdv * exp(5.0 + 0.20000000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(5.0 + 0.20000000000000001 * var_chaste_interface__cell__V)); // 1 / ms
        const double var_cell__i_Stim = GetIntracellularAreaStimulus(var_chaste_interface__Environment__time) / HeartConfig::Instance()->GetCapacitance(); // uA_per_uF
        ...
        const double var_cell__vjsr = 0047999999999999996 * var_cell__vcell; // uL
        const double var_cell__vmyo = 0.68000000000000005 * var_cell__vcell; // uL
        const double var_cell__vnsr = 055199999999999999 * var_cell__vcell; // uL
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x4 = 0064999999999999997 * var_x3;
            const double var_x5 = 074871767015599999 * var_chaste_interface__cell__V;
            ...
            const double var_x20 = exp(-36.698642499999998 + 061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * var_x13);
            const double var_x21 = exp(0.43983232 + 080320000000000003 * var_chaste_interface__cell__V - 2.1455350448257708 * var_x13);
            ...
            const double var_x30 = -024897499999999999 - 014938499999999999 * var_x29;
            const double var_x31 = var_x30 * var_chaste_interface__IKs__xs2;
            const double var_x32 = var_x31 * var_chaste_interface__IKs__xs1;
            const double var_x33 = exp(0.64935064935064934 + 064935064935064929 * var_chaste_interface__cell__V);
            const double var_x34 = 1.0 + var_x33;
            const double var_x35 = mParameters[2] / var_x34;
            const double var_x36 = 013854200000000001 * var_x35;
            const double var_x37 = 0374358835078 * var_chaste_interface__cell__V;
            const double var_x38 = exp(var_x37);
            const double var_x39 = 1.0 - var_x38;
            const double var_x40 = 1 / var_x39;
            const double var_x41 = -100 * var_x38 + var_chaste_interface__Cl__Cl_i;
            const double var_x42 = var_x40 * var_x41;
            const double var_x43 = 001444800488100033 * var_x42;
            const double var_x44 = pow(var_chaste_interface__Na__Na_i, 2);
            const double var_x45 = 1 / var_x44;
            const double var_x46 = exp(-00374358835078 * var_chaste_interface__cell__V);
            const double var_x47 = exp(2.0802377414561666);
            const double var_x48 = exp(-var_x37);
            const double var_x49 = 1.0 + 0.1245 * var_x46 + 036499999999999998 * var_x48 * (-0.14285714285714285 + 0.14285714285714285 * var_x47);
            const double var_x50 = (00046607674967211004 * var_x46 + 0374358835078 * var_x48 * (-0052142857142857138 + 0052142857142857138 * var_x47)) / (pow(var_x49, 2) * (1.0 + 100 * var_x45));
            ...
            const double var_x63 = exp(01310255922773 * var_chaste_interface__cell__V);
            const double var_x64 = var_x62 * var_x63;
            const double var_x65 = exp(-024333324280070002 * var_chaste_interface__cell__V);
            ...
            const double var_x74 = var_x73 * (023584606609913999 * var_x64 + 100155.96273676812 * var_x66);
            ...
            const double var_x79 = exp(0033333333333333335 * var_chaste_interface__cell__V);
            ...
            const double var_x84 = 0.24326999999999999 * var_x59 - 0.51429999999999998 * var_x83 - var_x19 * (061749999999999999 * var_x20 + 039456396800000001 * var_x21);
            ...
            const double var_x91 = 1.8 * var_x64 - 4116000 * var_x66;
            ...
            partialF = -00022499999999999999 + var_x32 - var_x103 + 00021581774391076088 * var_x55 + 00089962337662337659 * var_x87 + 005408738276452542 * var_x58 + 0.12163499999999999 * var_x61 - 4.5 * var_x74 - 0027599999999999999 * var_x2 - 00021581774391076088 * var_x82 - 5.4087382764525417e-5 * var_x88 - 0028824983370005666 * var_x11 - 0.48423913043478262 * var_x50 - 0.51000000000000001 * var_x25 - 0006333333333333333 * var_x90 - 00046153846153846147 * var_x53 - 029564989000285053 * var_x93 + var_x105 * var_x110 - var_x110 * var_x111 - var_x36 * var_chaste_interface__IKr__xr - var_x4 * var_chaste_interface__INal__hL - var_x43 * var_chaste_interface__Ito2__AA - var_x77 * var_chaste_interface__INa__H - var_x81 * var_chaste_interface__Ito__ydv2 - var_x84 * var_x86;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x91 = 1.8 * var_x64 - 4116000 * var_x66;
            const double var_x92 = var_x67 * var_x91;
            const double var_x112 = 00050000000000000001 + var_chaste_interface__Ca__Ca_i;
            ...
            const double var_x118 = var_x72 * var_x91 / pow((0020299076937277489 + 1.2903323313862536e-6 * var_x62 + var_chaste_interface__Ca__Ca_i), 2);
            ...
            const double var_x159 = 0023800000000000002 + var_chaste_interface__Ca__Ca_i;
            const double var_x160 = 1.0 + 00011900000000000002 / pow(var_x159, 2) + 3.5000000000000004e-5 * var_x114;
            ...
            const double var_x166 = 1.0 + 0015 * var_x165;
            const double var_x167 = 1 / var_x166;
            const double var_x168 = 050000000000000003 * var_x167;
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x194 = exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__cell__V);
            const double var_x195 = 1.0 + var_x194;
            const double var_x196 = var_chaste_interface__cell__V >= -40;
            const double var_x197 = exp(079000000000000001 * var_chaste_interface__cell__V);
            ...
            partialF = ((var_x196) ? (-7.6923076923076916 / var_x195) : (-310000 * var_x198 - 0.13500000000000001 * var_x199 - 3.5600000000000001 * var_x197));
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x205 = exp(-090909090909090912 * var_chaste_interface__cell__V);
            const double var_x207 = 47.130000000000003 + var_chaste_interface__cell__V;
            const double var_x209 = -080000000000000002 * var_x205 - var_x204 * var_x207;
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x216 = exp(-043909999999999998 * var_chaste_interface__cell__V);
            const double var_x217 = -127140 * var_x215 - 3.4740000000000003e-5 * var_x216;
            ...
            const double var_x224 = exp(-01052 * var_chaste_interface__cell__V);
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x230 = exp(0.67599999999999993 + 051999999999999998 * var_chaste_interface__cell__V);
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -052900000000000003 - var_x239;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x244 = 10 * var_x172;
            ...
            const double var_x248 = pow((0142415038316475 + var_x247), (-2));
            const double var_x255 = 0042724511494942495 * var_x248;
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x267 = 1 / (125.0 + 300 * var_x266);
            const double var_x268 = pow((0028483007663294996 + var_x247), (-2));
            ...
            partialF = var_x267 * (-1 + 0028483007663294996 * var_x256 * var_x268) - var_x256 * var_x273;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x274 = 042299999999999997 * exp(-1.20074125971556 * pow((-1 + 053842757610673787 * var_chaste_interface__cell__V), 2));
            
            partialF = -0054000000000000003 - var_x274;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x294 = exp(-070400000000000004 + 0.128 * var_chaste_interface__cell__V);
            const double var_x295 = -1.0 + var_x294;
            const double var_x296 = 1 / var_x295;
            const double var_x297 = 00036000000000000002 * var_x296;
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -3.8050000000000003e-5 * var_x292 * var_x299 - 00018000000000000001 * var_x296 * var_x298;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x304 = 040000000000000001 * var_chaste_interface__cell__V;
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -029999999999999999 * var_x322 - 0.20000000000000001 * var_x318;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.10000000000000001 * var_x318 - 0022499999999999998 * var_x322;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x326 = 0025000000000000005 * var_x167;
            
            partialF = -00068000000000000005 - var_x169 * var_x326 + var_x164 * var_x181 * var_x326;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x361 = exp(-15.0 + 5000 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_x358);
            const double var_x362 = 1.0 + var_x361;
            const double var_x363 = 1 / var_x362;
            const double var_x364 = 350 - var_x244;
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative23(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x125 = log(140 * var_x124);
            const double var_x141 = 1 / (var_x49 * var_x62 * pow((01 + var_x45), 2));
            ...
            const double var_x383 = log(100 * var_x155);
            const double var_x384 = var_x125 + var_x383;
            const double var_x385 = pow(var_x384, 4);
            const double var_x386 = 2.8839711417381356e-9 * pow(var_x384, 7) / pow((1 + 008558014922736952 * var_x385), 2);
            const double var_x387 = 2048989239405216 * pow(var_x384, 3) / (59494197.640692554 + 509152.23122530844 * var_x385);
            const double var_x388 = var_x124 * var_x386 - var_x124 * var_x387;
            
            partialF = var_x388 + 4.9335731356566794e-16 * var_x143 - 1.7874450622236046e-6 * var_x141 - 1.068185898837083e-5 * var_x142 - 013557744100624516 * var_x147 - 0044848621561246801 * var_x146;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x83 = var_x17 * var_x22 / pow(var_x18, 2);
            const double var_x85 = var_x16 * var_x52 / pow((var_x16 + 0.98039215686274506 * var_x23), 2);
            const double var_x120 = 018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i;
            const double var_x144 = (0.12553036579548593 * var_chaste_interface__K__K_i + 002300971605031257 * var_chaste_interface__Na__Na_i) / pow(var_x120, 2);
            ...
            const double var_x398 = 00018900582374463672 / (87.825100000000006 + var_x397);
            ...
            partialF = var_x400 + 212.79583259575517 * var_x396 + 00019989044893084398 * var_x153 - 4.535681662754383e-6 * var_x148 - 00031223895504468581 * var_x154 - 2.2767478584105716e-5 * var_x150 - 0008381150898567882 * var_x149 - var_x152 * var_x395;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative26(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x420 = 3000 * var_x419;
            const double var_x421 = 1.0 * var_x405;
            
            partialF = var_x421 * (-0083333333333333332 - var_x420) + 0.25 * (0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x411 * var_x420) / (pow(var_x403, 3) * pow((0.125 + var_x404), 2));
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative28(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x427 = 0086999999999999994 + var_chaste_interface__Ca__Ca_ss;
            const double var_x428 = 00087000000000000001 + var_chaste_interface__Ca__Ca_ss;
            const double var_x429 = 1.0 + 0097788000000000007 / pow(var_x427, 2) + 4.0890000000000003e-5 / pow(var_x428, 2);
            const double var_x430 = 1 / var_x429;
            const double var_x431 = 1.0 * var_x430;
            const double var_x434 = 719.99999999999989 * var_x419;
            
            partialF = var_x431 * (-5.0 - var_x434 - 0036718475849305066 * var_x261 - 505.56458679596358 * var_x422) + 1.0 * (019557600000000001 / pow(var_x427, 3) + 8.1780000000000006e-5 / pow(var_x428, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0036718475849305066 * var_x246 + var_x411 * var_x434) / pow(var_x429, 2);
        }
        else
        {
...
void OdeSystemInformation<Cellhund_rudy_2004_aFromCellMLGRL2>::Initialise(void)
{
    ...
    this->mInitialConditions.push_back(00012131666);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(001356538159);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(019883138161);

    // rY[13]:
    this->mVariableNames.push_back("IKs__xs2");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(019890650554);

    // rY[14]:
    this->mVariableNames.push_back("Ito__ydv");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(013970786703);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(000816605172);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(021123704774);
    ...
    this->mVariableUnits.push_back("mM");
    this->mInitialConditions.push_back(00012271265);
