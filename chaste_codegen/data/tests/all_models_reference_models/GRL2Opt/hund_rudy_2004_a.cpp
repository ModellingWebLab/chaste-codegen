...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_cell__clont = 0.00022499999999999999 * var_chaste_interface__cell__V + 0.00601027620873753 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i) + 0.001444800488100033 * (-100.0 * exp(0.0374358835078 * var_chaste_interface__cell__V) + var_chaste_interface__Cl__Cl_i) * var_chaste_interface__Ito2__AA * var_chaste_interface__cell__V / (1.0 - exp(0.0374358835078 * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_reversal_potentials__EK = 26.712338705500134 * log(10) * log10(5.4000000000000004 / var_chaste_interface__K__K_i); // mV
        const double var_reversal_potentials__ENa = 26.712338705500134 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i); // mV
    ...
    void Cellhund_rudy_2004_aFromCellMLGRL2::UpdateTransmembranePotential(double var_chaste_interface__Environment__time)
    {
        ...
        const double var_reversal_potentials__ECl = -26.712338705500134 * log(10) * log10(100.0 / var_chaste_interface__Cl__Cl_i); // mV
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x13 = 1 / var_chaste_interface__K__K_i;
            const double var_x14 = var_x12 * log10(5.4000000000000004 * var_x13);
            const double var_x15 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 6.370892781261781 * var_x14);
            const double var_x16 = 1.0 + var_x15;
            const double var_x17 = 1 / var_x16;
            const double var_x18 = exp(-2.4444678999999998 + 13.738155796238718 * var_x14 - 0.51429999999999998 * var_chaste_interface__cell__V);
            const double var_x19 = 1.0 + var_x18;
            const double var_x20 = 1 / var_x19;
            const double var_x21 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 2.1455350448257708 * var_x14);
            const double var_x22 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * var_x14);
            const double var_x23 = var_x22 + 0.49124000000000001 * var_x21;
            const double var_x24 = var_x20 * var_x23;
            const double var_x25 = 1 / (var_x24 + 1.02 * var_x17);
            const double var_x26 = var_x17 * var_x25;
            const double var_x27 = 1 / var_chaste_interface__Ca__Ca_i;
            const double var_x28 = pow(var_x27, 1.3999999999999999);
            const double var_x29 = 1.0 + 6.4818210260626455e-7 * var_x28;
            const double var_x30 = 1 / var_x29;
            const double var_x31 = -0.024897499999999999 - 0.014938499999999999 * var_x30;
            const double var_x32 = var_x31 * var_chaste_interface__IKs__xs2;
            const double var_x33 = var_x32 * var_chaste_interface__IKs__xs1;
            const double var_x34 = exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__cell__V);
            const double var_x35 = 1.0 + var_x34;
            const double var_x36 = mParameters[2] / var_x35;
            const double var_x37 = 0.013854200000000001 * var_x36;
            ...
            const double var_x42 = -100.0 * var_x39 + var_chaste_interface__Cl__Cl_i;
            const double var_x43 = var_x41 * var_x42;
            const double var_x44 = 0.001444800488100033 * var_x43;
            const double var_x45 = pow(var_chaste_interface__Na__Na_i, 2);
            const double var_x46 = 1 / var_x45;
            const double var_x47 = exp(-0.00374358835078 * var_chaste_interface__cell__V);
            const double var_x48 = exp(2.0802377414561666);
            const double var_x49 = exp(-var_x38);
            const double var_x50 = 1.0 + 0.1245 * var_x47 + 0.036499999999999998 * var_x49 * (-0.14285714285714285 + 0.14285714285714285 * var_x48);
            const double var_x51 = (0.00046607674967211004 * var_x47 + 0.0374358835078 * var_x49 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x48)) / (pow(var_x50, 2) * (1.0 + 100.0 * var_x46));
            const double var_x52 = 26.712338705500134 * var_x14;
            const double var_x53 = -var_x52 + var_chaste_interface__cell__V;
            const double var_x54 = var_x0 * var_x53 / pow(var_x1, 2);
            const double var_x55 = var_x6 * var_chaste_interface__cell__V;
            const double var_x56 = var_x10 * var_x55 / pow(var_x7, 2);
            const double var_x57 = var_chaste_interface__Ito2__AA * var_chaste_interface__cell__V;
            const double var_x58 = var_x41 * var_x57;
            const double var_x59 = var_x39 * var_x58;
            const double var_x60 = var_x15 / pow(var_x16, 2);
            const double var_x61 = var_x25 * var_x53;
            const double var_x62 = var_x60 * var_x61;
            const double var_x63 = pow(var_chaste_interface__Na__Na_i, 3);
            const double var_x64 = exp(0.01310255922773 * var_chaste_interface__cell__V);
            const double var_x65 = var_x63 * var_x64;
            const double var_x66 = exp(-0.024333324280070002 * var_chaste_interface__cell__V);
            const double var_x67 = var_x66 * var_chaste_interface__Ca__Ca_i;
            const double var_x68 = 1 / (13227.9606 + 6516533.0625 * var_chaste_interface__Ca__Ca_i + 8.4084932990912282 * var_x63);
            const double var_x69 = 1.0 + 0.27000000000000002 * var_x66;
            const double var_x70 = 1 / var_x69;
            const double var_x71 = 1.0 + 6.9444444444444451e-9 / pow(var_chaste_interface__Ca__Ca_i, 2);
            const double var_x72 = 1 / var_x71;
            const double var_x73 = var_x70 * var_x72;
            const double var_x74 = var_x68 * var_x73;
            const double var_x75 = var_x74 * (0.023584606609913999 * var_x65 + 100155.96273676812 * var_x67);
            const double var_x76 = pow(var_chaste_interface__INa__m, 3);
            const double var_x77 = var_x76 * mParameters[1] * var_chaste_interface__INa__J;
            const double var_x78 = 8.25 * var_x77;
            ...
            const double var_x83 = var_x8 * var_x9 * var_chaste_interface__cell__V;
            const double var_x84 = var_x18 * var_x23 / pow(var_x19, 2);
            const double var_x85 = 0.24326999999999999 * var_x60 - 0.51429999999999998 * var_x84 - var_x20 * (0.061749999999999999 * var_x22 + 0.039456396800000001 * var_x21);
            const double var_x86 = var_x17 * var_x53 / pow((var_x17 + 0.98039215686274506 * var_x24), 2);
            const double var_x87 = 0.49019607843137253 * var_x86;
            const double var_x88 = var_x34 * var_x53 * mParameters[2] * var_chaste_interface__IKr__xr / pow(var_x35, 2);
            const double var_x89 = var_x39 * var_x42 * var_x57 / pow(var_x40, 2);
            const double var_x90 = var_x53 * var_chaste_interface__Ito__ydv2;
            const double var_x91 = var_x81 * var_x90;
            const double var_x92 = 1.8 * var_x65 - 4116000.0 * var_x67;
            const double var_x93 = var_x68 * var_x92;
            const double var_x94 = var_x66 * var_x72 * var_x93 / pow(var_x69, 2);
            const double var_x95 = pow(var_chaste_interface__ICaL__d, var_chaste_interface__ICaL__dp);
            const double var_x96 = exp(-1.1230765052339999 + var_x5);
            const double var_x97 = var_x96 * var_chaste_interface__Ca__Ca_ss;
            const double var_x98 = -0.61380000000000001 + 1.0 * var_x97;
            const double var_x99 = -1.0 + var_x96;
            const double var_x100 = 1 / var_x99;
            const double var_x101 = var_x100 * mParameters[0];
            const double var_x102 = var_x101 * var_x98;
            const double var_x103 = var_x102 * var_x95 * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca2;
            const double var_x104 = 3.5108651860830804 * var_chaste_interface__ICaL__fca;
            const double var_x105 = var_x103 * var_x104;
            const double var_x106 = pow(var_x99, 2);
            const double var_x107 = var_x96 * var_x98 * mParameters[0] / var_x106;
            const double var_x108 = -15.0 + var_chaste_interface__cell__V;
            const double var_x109 = var_x108 * var_x95 * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__fca2;
            const double var_x110 = var_x109 * var_chaste_interface__ICaL__fca;
            const double var_x111 = var_x110 * var_chaste_interface__ICaL__f2;
            const double var_x112 = 0.26286468023559356 * var_x111;
            const double var_x113 = var_x101 * var_x97;
            
            partialF = -0.00022499999999999999 + var_x33 - var_x105 + 0.00021581774391076088 * var_x56 + 0.00089962337662337659 * var_x88 + 0.005408738276452542 * var_x59 + 0.12163499999999999 * var_x62 - 4.5 * var_x75 - 0.0027599999999999999 * var_x2 - 0.00021581774391076088 * var_x83 - 5.4087382764525417e-5 * var_x89 - 0.0028824983370005666 * var_x11 - 0.48423913043478262 * var_x51 - 0.51000000000000001 * var_x26 - 0.0006333333333333333 * var_x91 - 0.00046153846153846147 * var_x54 - 0.029564989000285053 * var_x94 + var_x107 * var_x112 - var_x112 * var_x113 - var_x37 * var_chaste_interface__IKr__xr - var_x4 * var_chaste_interface__INal__hL - var_x44 * var_chaste_interface__Ito2__AA - var_x78 * var_chaste_interface__INa__H - var_x82 * var_chaste_interface__Ito__ydv2 - var_x85 * var_x87;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x92 = 1.8 * var_x65 - 4116000.0 * var_x67;
            const double var_x93 = var_x68 * var_x92;
            const double var_x114 = 0.00050000000000000001 + var_chaste_interface__Ca__Ca_i;
            const double var_x115 = 1 / var_x114;
            const double var_x116 = pow(var_x114, (-2));
            const double var_x117 = var_x116 * var_chaste_interface__Ca__Ca_i;
            const double var_x118 = var_x55 * var_x8;
            const double var_x119 = var_x66 * var_x74;
            const double var_x120 = var_x73 * var_x92 / pow((0.0020299076937277489 + 1.2903323313862536e-6 * var_x63 + var_chaste_interface__Ca__Ca_i), 2);
            const double var_x121 = var_x70 * var_x93 / (pow(var_x71, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
            const double var_x159 = 0.0023800000000000002 + var_chaste_interface__Ca__Ca_i;
            const double var_x160 = 1.0 + 0.00011900000000000002 / pow(var_x159, 2) + 3.5000000000000004e-5 * var_x116;
            const double var_x161 = 1 / var_x160;
            const double var_x162 = 8.8666719524733664e-8 * var_x11;
            const double var_x163 = 1.768721357868101e-6 * var_x115;
            ...
            partialF = var_x161 * (-0.14705882352941174 + var_x180 - var_x163 - var_x177 + 3.8450464301480458e-12 * var_x121 + 1.768721357868101e-6 * var_x117 - 1139.4871996672337 * var_x119 - 8.8666719524733664e-8 * var_x118 - 4.2483225407660435e-11 * var_x120) + (0.00023800000000000004 / pow(var_x159, 3) + 7.0000000000000007e-5 / pow(var_x114, 3)) * (0.14705882352941174 * var_chaste_interface__Ca__Ca_ss + 2.3676470588235295e-5 * var_chaste_interface__Ca__Ca_nsr - 0.14705882352941174 * var_chaste_interface__Ca__Ca_i - var_x162 * var_chaste_interface__cell__V - var_x163 * var_chaste_interface__Ca__Ca_i - var_x177 * var_chaste_interface__Ca__Ca_i + 0.00027684334297065928 * var_x74 * var_x92) / pow(var_x160, 2);
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x215 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V);
            const double var_x216 = 1.0 + var_x215;
            const double var_x217 = 1 / var_x216;
            const double var_x218 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
            const double var_x219 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
            ...
            partialF = ((var_x196) ? (-0.29999999999999999 * var_x213) : (-0.1212 * var_x225 - var_x221 * var_x226));
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x245 = 1 / (0.5 + var_x243 + var_x244);
            const double var_x246 = var_x137 * var_chaste_interface__ICaL__fca;
            ...
            partialF = var_x245 * (-1 + var_x137 * var_x255);
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x103 = var_x102 * var_x95 * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca2;
            const double var_x108 = -15.0 + var_chaste_interface__cell__V;
            const double var_x135 = var_x102 * var_x108 * var_x95 * var_chaste_interface__ICaL__f2;
            const double var_x137 = var_x103 * var_x108;
            const double var_x246 = var_x137 * var_chaste_interface__ICaL__fca;
            const double var_x247 = -var_x246;
            const double var_x253 = var_x135 * var_chaste_interface__ICaL__fca;
            const double var_x256 = var_x253 * var_chaste_interface__ICaL__f;
            const double var_x263 = exp(-4.375 - 87.77162965207701 * var_x246);
            const double var_x264 = 1.0 + var_x263;
            const double var_x265 = 1 / var_x264;
            const double var_x266 = 1 / (125.0 + 300.0 * var_x265);
            const double var_x268 = pow((0.0028483007663294996 + var_x247), (-2));
            const double var_x269 = 8.1128172554732154e-6 * var_x268;
            const double var_x271 = var_x263 * (1 / (1.0 - 351.08651860830804 * var_x246) - var_chaste_interface__ICaL__fca2) / (pow(var_x264, 2) * pow((0.41666666666666669 + var_x265), 2));
            const double var_x273 = 0.2925720988402567 * var_x271;
            
            partialF = var_x266 * (-1 + 351.08651860830804 * var_x100 * var_x108 * var_x269 * var_x95 * var_x98 * mParameters[0] * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca) - var_x256 * var_x273;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative23(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x127 = var_x12 * log10(140.0 * var_x126);
            const double var_x143 = 1 / (var_x50 * var_x63 * pow((0.01 + var_x46), 2));
            const double var_x144 = var_x126 * var_x3 * var_chaste_interface__INal__hL;
            const double var_x146 = var_x120 * var_x45;
            const double var_x147 = var_x45 * var_x64 * var_x74;
            const double var_x148 = var_x126 * var_x77 * var_chaste_interface__INa__H;
            const double var_x156 = 1 / var_chaste_interface__Cl__Cl_i;
            const double var_x383 = var_x12 * log10(100.0 * var_x156);
            const double var_x384 = var_x127 + var_x383;
            ...
            const double var_x388 = var_x126 * var_x386 - var_x126 * var_x387;
            
            partialF = var_x388 + 4.9335731356566794e-16 * var_x146 - 1.7874450622236046e-6 * var_x143 - 1.068185898837083e-5 * var_x144 - 0.013557744100624516 * var_x148 - 0.0044848621561246801 * var_x147;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x84 = var_x18 * var_x23 / pow(var_x19, 2);
            const double var_x86 = var_x17 * var_x53 / pow((var_x17 + 0.98039215686274506 * var_x24), 2);
            const double var_x122 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
            const double var_x149 = var_x13 * var_x2;
            const double var_x150 = var_x13 * var_x26;
            const double var_x151 = var_x13 * var_x36 * var_chaste_interface__IKr__xr;
            const double var_x152 = var_x13 * var_x60;
            const double var_x153 = 6.4983106368870169 * var_x152 - var_x20 * (1.6494869150646332 * var_x13 * var_x22 + 1.0539726354202117 * var_x13 * var_x21) - 13.738155796238718 * var_x13 * var_x84;
            const double var_x154 = var_x152 * var_x61;
            const double var_x155 = var_x13 * var_x81 * var_chaste_interface__Ito__ydv2;
            const double var_x156 = 1 / var_chaste_interface__Cl__Cl_i;
            const double var_x383 = var_x12 * log10(100.0 * var_x156);
            const double var_x390 = -1.5317126959137754e-6 - 9.1902761754826519e-7 * var_x30;
            ...
            const double var_x395 = 3.0157226903121925e-5 * var_x86;
            const double var_x396 = var_x122 * var_x392;
            const double var_x397 = var_x52 + 26.712338705500134 * var_x383;
            const double var_x398 = 0.00018900582374463672 / (87.825100000000006 + var_x397);
            const double var_x399 = 2.4504050574883893e-8 * var_x397 / pow((1 + 0.30415380916731244 * var_x14 + 0.30415380916731244 * var_x383), 2);
            const double var_x400 = var_x13 * var_x399 - var_x13 * var_x398;
            
            partialF = var_x400 + 0.00019989044893084398 * var_x154 + 26.712338705500134 * var_x396 - 4.535681662754383e-6 * var_x149 - 0.00031223895504468581 * var_x155 - 2.2767478584105716e-5 * var_x151 - 0.0008381150898567882 * var_x150 - var_x153 * var_x395;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative25(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x386 = 2.8839711417381356e-9 * pow(var_x384, 7) / pow((1 + 0.008558014922736952 * var_x385), 2);
            const double var_x387 = 20.048989239405216 * pow(var_x384, 3) / (59494197.640692554 + 509152.23122530844 * var_x385);
            const double var_x389 = var_x156 * var_x386 - var_x156 * var_x387;
            const double var_x397 = var_x52 + 26.712338705500134 * var_x383;
            const double var_x398 = 0.00018900582374463672 / (87.825100000000006 + var_x397);
            const double var_x399 = 2.4504050574883893e-8 * var_x397 / pow((1 + 0.30415380916731244 * var_x14 + 0.30415380916731244 * var_x383), 2);
            const double var_x401 = var_x156 * var_x399 - var_x156 * var_x398;
            
            partialF = var_x389 + var_x401 + 8.8885199344722979e-8 * var_x58 - 3.6975665728975948e-7 * var_x156;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative26(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x407 = 0.70217303721661617 * var_x102;
            const double var_x409 = exp(2.6000000000000001 + var_x108 * var_x407);
            ...
            partialF = var_x405 * (-0.0083333333333333332 - var_x420) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0.0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x411 * var_x420) / (pow(var_x403, 3) * pow((0.125 + var_x404), 2));
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative28(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x110 = var_x109 * var_chaste_interface__ICaL__fca;
            const double var_x137 = var_x103 * var_x108;
            const double var_x157 = var_x101 * var_x96;
            const double var_x158 = var_x157 * var_chaste_interface__ICaL__f2;
            const double var_x246 = var_x137 * var_chaste_interface__ICaL__fca;
            const double var_x261 = var_x110 * var_x158;
            const double var_x407 = 0.70217303721661617 * var_x102;
            const double var_x409 = exp(2.6000000000000001 + var_x108 * var_x407);
            const double var_x410 = 1.0 + var_x409;
            const double var_x411 = -var_chaste_interface__Ca__Ca_ss + var_chaste_interface__Ca__Ca_jsr;
            ...
            const double var_x416 = var_x415 * var_chaste_interface__Irel__ri;
            const double var_x419 = var_x416 * var_chaste_interface__Irel__ro;
            const double var_x421 = var_x108 * var_x157 * var_x413;
            ...
            const double var_x432 = 719.99999999999989 * var_x419;
            
            partialF = var_x428 * (-5.0 - var_x432 - 0.0036718475849305066 * var_x261 - 505.56458679596358 * var_x421) + (0.019557600000000001 / pow(var_x425, 3) + 8.1780000000000006e-5 / pow(var_x426, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0.0036718475849305066 * var_x246 + var_x411 * var_x432) / pow(var_x427, 2);
        }
        else
        {
