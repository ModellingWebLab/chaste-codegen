...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x224 = exp(-4.4889999999999999 * pow((1 + 0.014925373134328358 * var_chaste_interface__membrane__V), 2));
            const double var_x225 = 1 / (8.0 + 1000.0 * var_x224);
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x228 = exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2));
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x232 = 14.994515539305301 / (1.0 + 3.0 * var_x231);
            
            partialF = var_x232 * (-8.0000000000000007e-5 + var_x116 * (var_x115 - var_x114)) + 9.9963436928702016 * (var_x103 + var_x104 - var_x102 - var_x111) / (pow(var_x230, 3) * pow((0.33333333333333337 + var_x231), 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x235 = var_chaste_interface__calcium_dynamics__Ca_i < 0.00035;
            const double var_x236 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6);
            const double var_x237 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16);
            const double var_x238 = (((var_x215) || (var_x234))) && (((var_x215) || (var_x235))) && (((var_x234) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x236)))) && (((var_x235) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x237))));
            
            partialF = ((var_x238) ? (0) : (-0.5));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x239 = 6.3176611368492499e-5 * var_x42;
            
            partialF = 0.00010126109252331096 * var_x93 - 0.0073440052301827737 * var_x85 - 0.0031224512033090025 * var_x92 - 0.0016876848753885161 * var_x88 - 4.5587787568311439e-5 * var_x87 - 0.0031224512033090025 * var_x89 - var_x239 * var_x91;
        }
        else
        {
