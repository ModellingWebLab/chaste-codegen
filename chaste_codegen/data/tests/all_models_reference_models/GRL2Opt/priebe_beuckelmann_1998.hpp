#ifndef CELLPRIEBE_BEUCKELMANN_1998FROMCELLMLGRL2OPT_HPP_
#define CELLPRIEBE_BEUCKELMANN_1998FROMCELLMLGRL2OPT_HPP_
...
class Cellpriebe_beuckelmann_1998FromCellMLGRL2Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellpriebe_beuckelmann_1998FromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellpriebe_beuckelmann_1998FromCellMLGRL2Opt();
...
CHASTE_CLASS_EXPORT(Cellpriebe_beuckelmann_1998FromCellMLGRL2Opt)
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellpriebe_beuckelmann_1998FromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellpriebe_beuckelmann_1998FromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellpriebe_beuckelmann_1998FromCellMLGRL2Opt(p_solver, p_stimulus);
        }
...
#endif // CELLPRIEBE_BEUCKELMANN_1998FROMCELLMLGRL2OPT_HPP_