#ifndef CELLOHARA_RUDY_CIPA_V1_2017FROMCELLMLGRL2OPT_HPP_
#define CELLOHARA_RUDY_CIPA_V1_2017FROMCELLMLGRL2OPT_HPP_
...
class Cellohara_rudy_cipa_v1_2017FromCellMLGRL2Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellohara_rudy_cipa_v1_2017FromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellohara_rudy_cipa_v1_2017FromCellMLGRL2Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellohara_rudy_cipa_v1_2017FromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellohara_rudy_cipa_v1_2017FromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellohara_rudy_cipa_v1_2017FromCellMLGRL2Opt(p_solver, p_stimulus);
        }
...
#endif // CELLOHARA_RUDY_CIPA_V1_2017FROMCELLMLGRL2OPT_HPP_