#ifndef CELLBERNUS_WILDERS_ZEMLIN_VERSCHELDE_PANFILOV_2002FROMCELLMLGRL2OPT_HPP_
#define CELLBERNUS_WILDERS_ZEMLIN_VERSCHELDE_PANFILOV_2002FROMCELLMLGRL2OPT_HPP_
...
class Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt(p_solver, p_stimulus);
        }
...
#endif // CELLBERNUS_WILDERS_ZEMLIN_VERSCHELDE_PANFILOV_2002FROMCELLMLGRL2OPT_HPP_