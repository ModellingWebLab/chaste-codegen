...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliribe_model_2006FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane_potential__V);
            ...
            partialF = ((var_x185) ? (var_x191 + 2.0000000091613402e-7 * var_x181 - 499.99999948602181 * (41.000001000000005 + var_chaste_interface__membrane_potential__V) * (0.00019999999949504854 * var_x180 + 0.00020000000091613401 * var_x181)) : (var_x191 - var_x184 * var_x190));
        }
        else
        {
    ...
    double Celliribe_model_2006FromCellMLGRL2Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x187 = -0.10000000000000001 * var_chaste_interface__membrane_potential__V;
            const double var_x192 = exp(-7.5 + var_x187 + 0.10000000000000001 * mParameters[12]);
            ...
            const double var_x196 = exp(-9.375 + var_x195 + 0.125 * mParameters[12]);
            const double var_x197 = 0.02 * var_x196;
            
            partialF = -var_x194 - var_x197;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliribe_model_2006FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane_potential__V);
            ...
            partialF = -0.00050000000000000001 * var_x212 - 0.0012999999999999999 * var_x207;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliribe_model_2006FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane_potential__V);
            ...
            partialF = -0.033000000000000002 / var_x215 - 3.3000000000000003e-5 * var_x213;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celliribe_model_2006FromCellMLGRL2Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x224) ? (var_x236 + 3.6000000100955274e-8 * var_x217 - 1249.9999964946085 * (19.000000400000001 + var_chaste_interface__membrane_potential__V) * (3.6000000100955276e-5 * var_x217 + 3.6000000100955276e-5 * var_x218)) : ((var_x232) ? (var_x236 + var_x237) : (var_x237 + var_x222 * var_x235)));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celliribe_model_2006FromCellMLGRL2Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.025000000000000001 / var_x243 - var_x241 * var_x244;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celliribe_model_2006FromCellMLGRL2Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0018 + var_x262 + var_x264 + var_x266 + var_x268 - var_x267;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celliribe_model_2006FromCellMLGRL2Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.45000000000000001 / var_x272;
        }
        else
        {
    ...
    double Celliribe_model_2006FromCellMLGRL2Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x273 = 0.001 * mParameters[0];
            const double var_x274 = 0.001 * var_x162;
            
            partialF = -var_x273 - var_x274 - 0.001424696263447196 * var_x175 - 1.2089003260906828e-17 * var_x176;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celliribe_model_2006FromCellMLGRL2Opt::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.040714285714285717 + var_x281;
        }
        else
        {
    ...
    double Celliribe_model_2006FromCellMLGRL2Opt::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.18071428571428572 + var_x281;
        }
        else
        {
