...
std::shared_ptr<Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt_LookupTables> Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt_LookupTables::mpInstance;
    ...
    Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt::Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt>::Instance();
        Init();
    ...
    void Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt::UpdateTransmembranePotential(double var_chaste_interface__environment__time_converted)
    {
    ...
    void Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        std::vector<double>& rY = rGetStateVariables();
        const double delta=1e-8;
    ...
    double Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt::EvaluateYDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
        double d_dt_chaste_interface_var_membrane__Vm;
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -58.0
    ...
    double Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt::EvaluateYDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt::EvaluateYDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt::EvaluateYDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt::EvaluateYDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt::EvaluateYDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    double Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt::EvaluateYDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY)
    {
    ...
    std::vector<double> Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2Opt>::Initialise(void)
{
