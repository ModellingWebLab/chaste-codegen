...
std::shared_ptr<Cellbueno_2007_endoFromCellMLGRL2Opt_LookupTables> Cellbueno_2007_endoFromCellMLGRL2Opt_LookupTables::mpInstance;
    ...
    double Cellbueno_2007_endoFromCellMLGRL2Opt::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x5 = var_x0 < 0.29999999999999999;
            const double var_x6 = ((var_x5) ? (0) : (1.0));
            const double var_x7 = var_x6 * var_chaste_interface__fast_inward_current_v_gate__v;
            const double var_x8 = tanh(-1.3 + 2.0 * var_chaste_interface__membrane__V);
            const double var_x9 = 1 / mParameters[0];
            const double var_x10 = var_x9;
            
            partialF = -var_x10 * (var_x4 * var_x7 + var_x7 * (-2.8846153846153846 + var_x3) + (1.0 - var_x2) / (470.0 - 464.0 * var_x1) + 0.0023564897728343857 * var_x2 * (38.799999999999997 - 38.799999999999997 * pow(var_x8, 2)) / pow((1 - 0.94174757281553401 * var_x8), 2));
        }
        else
        {
    ...
    double Cellbueno_2007_endoFromCellMLGRL2Opt::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_chaste_interface__membrane__V < 0.024) ? (-0.013333333333333334) : ((var_x5) ? (-0.10000000000000001) : (-0.68936991589687036)));
        }
        else
        {
    ...
    double Cellbueno_2007_endoFromCellMLGRL2Opt::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x0 = var_chaste_interface__membrane__V;
            const double var_x1 = ((var_x0 < 0.0060000000000000001) ? (0) : (1.0));
            const double var_x12 = tanh(-3.2000000000000002 + 200.0 * var_chaste_interface__membrane__V);
            const double var_x13 = 1.0 - var_x1;
            const double var_x14 = var_x13 / (73.0 + 67.0 * var_x12);
            
            partialF = -var_x14 - 0.0035714285714285713 * var_x1;
        }
        else
        {
    ...
    double Cellbueno_2007_endoFromCellMLGRL2Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x0 = var_chaste_interface__membrane__V;
            const double var_x2 = ((var_x0 < 0.13) ? (0) : (1.0));
            const double var_x15 = 1 / (2.7342 - 0.73419999999999996 * var_x2);
