...
class Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables()
    {
...
protected:
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables(const Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables&);
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables& operator= (const Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables&);
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables()
    {
        ...
        Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables> mpInstance;
...
std::shared_ptr<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::UseCellMLDefaultStimulus()
    {
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt>::Instance();
        Init();
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt()
    {
    }

    AbstractLookupTableCollection* Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::GetLookupTableCollection()
    {
        return Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables::Instance();
    }
    
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
...
// LCOV_EXCL_STOP
    ...
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        std::vector<double>& rY = rGetStateVariables();
        const double delta=1e-8;
...
// LCOV_EXCL_STOP
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::EvaluateYDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
        double d_dt_chaste_interface_var_membrane__V;
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -90.2
...
// LCOV_EXCL_STOP
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x20 = pow(mParameters[2], 3) * mParameters[3] * _lt_0_row[2];
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::EvaluateYDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
...
// LCOV_EXCL_STOP
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            partialF = ((var_x63) ? (var_x67 + var_x68 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x67 + 3.1999999919207769e-7 * var_x58)) : (var_x68 - var_x62 * var_x66));
        }
        else
        {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::EvaluateYDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
...
// LCOV_EXCL_STOP
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::EvaluateYDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
...
// LCOV_EXCL_STOP
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::EvaluateYDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
...
// LCOV_EXCL_STOP
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::EvaluateYDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
...
// LCOV_EXCL_STOP
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    std::vector<double> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2Opt)
