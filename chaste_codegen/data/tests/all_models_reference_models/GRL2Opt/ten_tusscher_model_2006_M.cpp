...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2006_MFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x7 = var_x6 * mParameters[12] * var_chaste_interface__fast_sodium_current_j_gate__j;
            ...
            const double var_x54 = var_x53 * mParameters[5] * mParameters[20] / (40.0 + var_chaste_interface__sodium_dynamics__Na_i);
            ...
            partialF = -var_x2 - var_x3 - var_x39 - var_x5 - var_x55 - var_x8 - mParameters[8] - mParameters[9] + 0.0025819888974716113 * var_x42 - 0.0024332029034784559 * var_x44 - 270.40908135076944 * var_x67 - 0.043033148291193521 * var_x26 - 0.16722408026755853 * var_x29 - var_x11 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x46 * var_x49 - var_x59 * var_x62 + 1081.6363254030778 * var_x61 * var_x65;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2006_MFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x109 = 0.066691050963179718 * mParameters[0];
            const double var_x110 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
            const double var_x111 = mParameters[2] / (pow(var_x110, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x166 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * mParameters[14]);
            const double var_x167 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * mParameters[14]);
            const double var_x168 = exp(-11.764705882352942 + 0.14705882352941177 * mParameters[14] - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x169 = 310000.0 * var_x166;
            const double var_x170 = 2.7000000000000002 * var_x167;
            const double var_x171 = 0.057000000000000002 * var_x168;
            const double var_x174 = var_chaste_interface__membrane__V < -40.0 + mParameters[14];
            ...
            partialF = ((var_x174) ? (-var_x169 - var_x170 - var_x171) : (-5.9230769230769234 * var_x177));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x21 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x174 = var_chaste_interface__membrane__V < -40.0 + mParameters[14];
            const double var_x179 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * mParameters[14]);
            const double var_x180 = exp(0.043909999999999998 * mParameters[14] - 0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x181 = -25428.0 * var_x179 - 6.9480000000000002e-6 * var_x180;
            const double var_x182 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * mParameters[14]);
            const double var_x183 = 1.0 + var_x182;
            const double var_x184 = 1 / var_x183;
            const double var_x185 = var_x181 * var_x184;
            const double var_x186 = exp(-5.5312920000000005 + 0.13780000000000001 * mParameters[14] - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x187 = 1.0 + var_x186;
            const double var_x188 = exp(0.01052 * mParameters[14] - 0.01052 * var_chaste_interface__membrane__V);
            const double var_x189 = var_x188 / var_x187;
            const double var_x190 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x191 = 0.024240000000000001 * var_x189;
            const double var_x192 = var_x185 * var_x190;
            const double var_x193 = exp(-3.2000000000000002 - var_x21 + 0.10000000000000001 * mParameters[14]);
            const double var_x194 = 1.0 + var_x193;
            const double var_x195 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * mParameters[14]);
            const double var_x196 = var_x195 / var_x194;
            
            partialF = ((var_x174) ? (-var_x191 - var_x192) : (-0.59999999999999998 * var_x196));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x126 = -var_x125;
            const double var_x146 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x197 = exp(2.5 + var_x126);
            const double var_x198 = 1.0 + var_x197;
            const double var_x199 = 1 / var_x198;
            const double var_x200 = exp(1.0 + var_x146);
            const double var_x201 = 1.0 + var_x200;
            const double var_x202 = 1 / var_x201;
            const double var_x203 = exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x204 = 1.0 + var_x203;
            const double var_x205 = 0.25 + 1.3999999999999999 / var_x204;
            const double var_x206 = var_x202 * var_x205;
            const double var_x209 = 1 / (var_x199 + 1.3999999999999999 * var_x206);
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x114 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x115 = -var_x114;
            const double var_x210 = exp(3.0 + var_x114);
            const double var_x211 = 1.0 + var_x210;
            const double var_x212 = 1 / var_x211;
            const double var_x213 = exp(1.3 + var_x115);
            const double var_x214 = 1.0 + var_x213;
            const double var_x215 = 1 / var_x214;
            const double var_x216 = pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2);
            const double var_x217 = exp(-3.2400000000000002 * var_x216);
            const double var_x221 = 1102.5 * var_x217;
            const double var_x222 = 1 / (20.0 + var_x221 + 200.0 * var_x215 + 180.0 * var_x212);
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2Opt::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x212 = 1 / var_x211;
            const double var_x216 = pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2);
            const double var_x223 = exp(2.5 + var_x115);
            const double var_x224 = 1.0 + var_x223;
            const double var_x225 = 1 / var_x224;
            const double var_x226 = exp(-3.0375000000000001 * var_x216);
            const double var_x229 = 562.0 * var_x226;
            const double var_x230 = 1 / (var_x229 + 80.0 * var_x212 + 31.0 * var_x225);
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x231 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2);
            const double var_x232 = 1 / (1.0 + 399.99999999999994 * var_x231);
            const double var_x233 = 1 / (2.0 + 80.0 * var_x232);
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x146 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x235 = exp(-4.0 + var_x146);
            const double var_x236 = 1.0 + var_x235;
            const double var_x237 = 1 / var_x236;
            const double var_x238 = exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2));
            const double var_x241 = 85.0 * var_x238;
            const double var_x242 = 1 / (3.0 + var_x241 + 5.0 * var_x237);
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2Opt::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x245 = exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2));
            const double var_x246 = 1 / (0.80000000000000004 + 9.5 * var_x245);
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x249 = 1 / (1.0 + 3.0 * var_x248);
            const double var_x250 = var_x249;
            const double var_x251 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
            const double var_x252 = 1 / (1.0 + 2.25 * var_x251);
            const double var_x253 = 1 / (2.5 - 1.5 * var_x252);
            const double var_x254 = var_x231 * var_x253;
            const double var_x255 = 0.14999999999999999 * var_x254;
            const double var_x256 = 1 / (0.059999999999999998 + var_x255);
            const double var_x257 = var_chaste_interface__calcium_dynamics__R_prime * mParameters[1];
            const double var_x258 = var_x256 * var_x257;
            const double var_x259 = var_x255 * var_x258;
            const double var_x260 = 1 / (pow((0.44444444444444442 + var_x251), 2) * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3));
            const double var_x261 = -var_chaste_interface__calcium_dynamics__Ca_ss + var_chaste_interface__calcium_dynamics__Ca_SR;
            const double var_x262 = var_x261 / pow((1 - 0.59999999999999998 * var_x252), 2);
            const double var_x263 = var_x231 * var_x258 * var_x260 * var_x262;
            const double var_x264 = var_x257 * var_x262 / pow((0.40000000000000002 + var_x254), 2);
            const double var_x265 = var_x253 * var_x260 * var_x264 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4);
            
            partialF = var_x250 * (-var_x259 - mParameters[0] + 0.21333333333333335 * var_x265 - 0.032000000000000001 * var_x263) + 0.66666666666666674 * (var_x113 - var_x112 * mParameters[0] - var_x259 * var_x261) / (pow(var_x247, 3) * pow((0.33333333333333337 + var_x248), 2));
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2006_MFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x262 = var_x261 / pow((1 - 0.59999999999999998 * var_x252), 2);
            const double var_x264 = var_x257 * var_x262 / pow((0.40000000000000002 + var_x254), 2);
            const double var_x266 = var_x264 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3);
            const double var_x267 = var_chaste_interface__calcium_dynamics__Ca_ss * var_chaste_interface__calcium_dynamics__R_prime;
            const double var_x268 = var_x256 * var_x261 * mParameters[1];
            const double var_x269 = var_x253 * var_x267 * var_x268;
            const double var_x270 = var_x61 * mParameters[11];
            const double var_x271 = 1369.1986401882032 * var_x270;
            ...
            const double var_x278 = 3.0010972933430868 * var_x254;
            const double var_x279 = var_x258 * var_x278;
            
            partialF = var_x275 * (-1.1399999999999999 - var_x279 + 6.0021945866861737 * var_x269 - 6.4023408924652525 * var_x266 - 342.29966004705079 * var_x89 * mParameters[11]) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x261 * var_x279 - var_x271 * var_x66) / (pow(var_x272, 3) * pow(var_x273, 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x251 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
            const double var_x252 = 1 / (1.0 + 2.25 * var_x251);
            const double var_x280 = -0.11249999999999999 + 0.067500000000000004 * var_x252;
            
            partialF = -0.0050000000000000001 + var_x280 * var_chaste_interface__calcium_dynamics__Ca_ss;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2006_MFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x90 = var_x77 * mParameters[9];
            const double var_x92 = 1 / var_x52;
            const double var_x93 = var_x54 * var_x92;
            const double var_x94 = var_x77 * var_x8;
            const double var_x95 = var_x53 * var_x92 * mParameters[5] * var_chaste_interface__sodium_dynamics__Na_i * mParameters[20] / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
            const double var_x96 = var_x34 * var_x38 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2);
            const double var_x281 = mParameters[11] * mParameters[3];
            
            partialF = var_x281 * (1.1846503119326294e-6 * var_x95 - 0.0018954404990922068 * var_x93 - 0.016878114612481093 * var_x90 - 0.016878114612481093 * var_x94 - 0.0056863214972766203 * var_x96);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2Opt::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x281 = mParameters[11] * mParameters[3];
            const double var_x283 = 2.7188924024856265e-5 * var_x48;
            
            partialF = var_x281 * (4.357910453967955e-5 * var_x104 - 0.016878114612481093 * var_x91 - 0.016878114612481093 * var_x97 - 0.016878114612481093 * var_x98 - 0.00072631840899465921 * var_x99 - 0.0072631840899465916 * var_x101 - var_x103 * var_x283);
        }
        else
        {
