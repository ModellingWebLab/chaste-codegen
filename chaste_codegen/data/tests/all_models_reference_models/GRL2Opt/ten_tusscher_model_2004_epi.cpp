...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x166 = 310000.0 * var_x163;
            const double var_x167 = 2.7000000000000002 * var_x164;
            const double var_x168 = 0.057000000000000002 * var_x165;
            ...
            partialF = ((var_x171) ? (-var_x166 - var_x167 - var_x168) : (-5.9230769230769234 * var_x174));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x20 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x171 = var_chaste_interface__membrane__V < -40.0;
            const double var_x176 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
            const double var_x177 = 1.0 + var_x176;
            const double var_x178 = 1 / var_x177;
            const double var_x179 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
            const double var_x180 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x181 = -25428.0 * var_x179 - 6.9480000000000002e-6 * var_x180;
            const double var_x182 = var_x178 * var_x181;
            const double var_x183 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x184 = 1.0 + var_x183;
            const double var_x185 = exp(-0.01052 * var_chaste_interface__membrane__V);
            const double var_x186 = var_x185 / var_x184;
            const double var_x187 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x188 = 0.024240000000000001 * var_x186;
            const double var_x189 = var_x182 * var_x187;
            const double var_x190 = exp(-3.2000000000000002 - var_x20);
            const double var_x191 = 1.0 + var_x190;
            const double var_x192 = exp(0.057000000000000002 * var_chaste_interface__membrane__V);
            const double var_x193 = var_x192 / var_x191;
            
            partialF = ((var_x171) ? (-var_x188 - var_x189) : (-0.59999999999999998 * var_x193));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x128 = -var_x127;
            const double var_x145 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x194 = exp(2.5 + var_x128);
            const double var_x195 = 1.0 + var_x194;
            const double var_x196 = 1 / var_x195;
            const double var_x197 = exp(1.0 + var_x145);
            const double var_x198 = 1.0 + var_x197;
            const double var_x199 = 1 / var_x198;
            const double var_x200 = exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x201 = 1.0 + var_x200;
            const double var_x202 = 0.25 + 1.3999999999999999 / var_x201;
            const double var_x203 = var_x199 * var_x202;
            const double var_x206 = 1 / (var_x196 + 1.3999999999999999 * var_x203);
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x117 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x207 = exp(2.5 + var_x117);
            const double var_x208 = 1.0 + var_x207;
            const double var_x209 = 1 / var_x208;
            const double var_x210 = exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2));
            const double var_x213 = 1125.0 * var_x210;
            const double var_x214 = 1 / (80.0 + var_x213 + 165.0 * var_x209);
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x215 = var_chaste_interface__membrane__V > -60.0;
            const double var_x216 = exp(-5.0 + 10000.0 * var_chaste_interface__calcium_dynamics__Ca_i);
            const double var_x217 = 1.0 + var_x216;
            const double var_x218 = exp(-0.9375 + 1250.0 * var_chaste_interface__calcium_dynamics__Ca_i);
            const double var_x219 = 1.0 + var_x218;
            const double var_x220 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 8);
            const double var_x221 = (var_x215) && (var_chaste_interface__L_type_Ca_current_fCa_gate__fCa < 0.15753424657534248 + 0.068493150684931517 / var_x217 + 0.13698630136986303 / var_x219 + 0.68493150684931503 / (1.0 + 8.034023767017109e+27 * var_x220));
            
            partialF = ((var_x221) ? (0) : (-0.5));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x145 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x222 = exp(-4.0 + var_x145);
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x236 = 14.994515539305301 / (1.0 + 3.0 * var_x235);
            
            partialF = var_x236 * (-8.0000000000000007e-5 + var_x116 * (var_x115 - var_x114)) + 9.9963436928702016 * (var_x103 + var_x104 - var_x102 - var_x111) / (pow(var_x234, 3) * pow((0.33333333333333337 + var_x235), 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x239 = var_chaste_interface__calcium_dynamics__Ca_i < 0.00035;
            const double var_x240 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6);
            const double var_x241 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16);
            const double var_x242 = (((var_x215) || (var_x238))) && (((var_x215) || (var_x239))) && (((var_x238) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x240)))) && (((var_x239) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x241))));
            
            partialF = ((var_x242) ? (0) : (-0.5));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 2.5185628611365452e-7 * var_x83 - 1.823319832565245e-7 * var_x84 - 9.0551084895961074e-7 * var_x73 - 0.0031224512033090025 * var_x86 - 0.00040297005778184723 * var_x82;
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x243 = 6.3176611368492499e-5 * var_x42;
            
            partialF = 0.00010126109252331096 * var_x93 - 0.0073440052301827737 * var_x85 - 0.0031224512033090025 * var_x92 - 0.0016876848753885161 * var_x88 - 4.5587787568311439e-5 * var_x87 - 0.0031224512033090025 * var_x89 - var_x243 * var_x91;
        }
        else
        {
