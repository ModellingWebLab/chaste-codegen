...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x31 = var_x30 * mParameters[13] * var_chaste_interface__fast_sodium_current_j_gate__j;
            ...
            const double var_x45 = exp(-1.0 + var_x44 - 2.6713760659695653 * var_x37);
            const double var_x46 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__membrane__V - 0.0053427521319391299 * var_x37);
            const double var_x47 = var_x45 + 3.0 * var_x46;
            ...
            const double var_x70 = 0.0060000000000000001 * var_x64 - 0.5 * var_x69 - var_x43 * (0.10000000000000001 * var_x45 + 0.00060000000000000006 * var_x46);
            ...
            const double var_x74 = exp(-0.037433890822745473 * var_chaste_interface__membrane__V);
            const double var_x75 = exp(-0.0037433890822745472 * var_chaste_interface__membrane__V);
            const double var_x76 = 1.0 + 0.035299999999999998 * var_x74 + 0.1245 * var_x75;
            const double var_x77 = 1 / (1.0 + mParameters[5]);
            const double var_x78 = var_x77 * mParameters[5] * mParameters[21] / (40.0 + var_chaste_interface__sodium_dynamics__Na_i);
            const double var_x79 = var_x78 * (0.001321416346042915 * var_x74 + 0.00046605194074318115 * var_x75) * var_chaste_interface__sodium_dynamics__Na_i / pow(var_x76, 2);
            
            partialF = -var_x23 - var_x26 - var_x27 - var_x29 - var_x32 - var_x63 - var_x79 - mParameters[9] - mParameters[10] + 0.0025819888974716113 * var_x66 - 0.0024332029034784559 * var_x68 - 0.043033148291193521 * var_x50 - 0.16722408026755853 * var_x53 - var_x35 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x70 * var_x73;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x101 = var_x3 * var_x82;
            const double var_x102 = var_x10 * var_x82;
            const double var_x129 = 0.001 + var_chaste_interface__calcium_dynamics__Ca_i;
            const double var_x130 = 1.0 + 0.00014999999999999999 / pow(var_x129, 2);
            const double var_x131 = 1 / var_x130;
            const double var_x132 = var_x131;
            const double var_x133 = -mParameters[0];
            const double var_x134 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
            const double var_x135 = 1.2499999999999999e-7 * mParameters[2] / (pow(var_x134, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
            const double var_x136 = (-var_chaste_interface__calcium_dynamics__Ca_i + var_chaste_interface__calcium_dynamics__Ca_SR) * mParameters[0];
            const double var_x137 = mParameters[2] / var_x134;
            const double var_x138 = var_x101 * var_chaste_interface__L_type_Ca_current_d_gate__d;
            const double var_x139 = 0.00031590674984870116 * mParameters[12];
            const double var_x140 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, 2);
            const double var_x141 = 0.0625 + var_x140;
            const double var_x142 = mParameters[1] / var_x141;
            const double var_x143 = var_x140 * var_x142;
            const double var_x144 = 0.0082319999999999997 + var_x143;
            const double var_x145 = var_x144 * var_chaste_interface__calcium_dynamics__g;
            const double var_x146 = var_x145 * var_chaste_interface__L_type_Ca_current_d_gate__d;
            
            partialF = var_x132 * (var_x133 - var_x135 + (0.00031590674984870116 * var_x90 - 0.0042195286531202733 * var_x89 - 0.0015795337492435057 * var_x91 - 0.00031590674984870116 * var_x85 - 0.00031590674984870116 * var_x87) * mParameters[12]) + 0.00029999999999999997 * (var_x136 + var_x146 - var_x137 - var_x139 * (var_x87 * var_chaste_interface__calcium_dynamics__Ca_i + (-13.356880329847826 * log(var_x88 * mParameters[4]) + var_chaste_interface__membrane__V) * mParameters[9] - 2.0 * var_x62 * var_x67 + ((var_x12) ? (var_x138 - 374338.9082274547 * (-1.3356880329847825e-6 + var_chaste_interface__membrane__V) * (-var_x138 - var_x102 * var_chaste_interface__L_type_Ca_current_d_gate__d)) : (var_x20 * var_chaste_interface__membrane__V)))) / (pow(var_x129, 3) * pow(var_x130, 2));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x151 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x152 = exp(-4.5 + var_x151);
            const double var_x153 = 1.0 + var_x152;
            const double var_x158 = exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__membrane__V);
            const double var_x159 = 0.00037037037037037035 + 0.00037037037037037035 * var_x158;
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x161 = 0.050000000000000003 * var_chaste_interface__membrane__V;
            const double var_x162 = -var_x161;
            const double var_x163 = exp(-3.0 + var_x162);
            const double var_x164 = 1.0 + var_x163;
            const double var_x168 = exp(-3.0 + var_x161);
            const double var_x169 = 0.29761904761904762 + 0.29761904761904762 * var_x168;
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x161 = 0.050000000000000003 * var_chaste_interface__membrane__V;
            const double var_x168 = exp(-3.0 + var_x161);
            const double var_x171 = -0.16666666666666666 * var_chaste_interface__membrane__V;
            const double var_x172 = exp(-1.6666666666666667 + var_x171);
            const double var_x173 = sqrt(1.0 + var_x172);
            const double var_x177 = 1.0 + var_x168;
            const double var_x178 = var_x173 * var_x177;
            
            partialF = -0.00090909090909090909 * var_x178;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x179 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x180 = exp(7.0 + var_x179);
            const double var_x181 = 1.0 + var_x180;
            const double var_x182 = 1 / var_x181;
            const double var_x183 = exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V);
            const double var_x184 = 1.0 + var_x183;
            const double var_x185 = 1 / var_x184;
            const double var_x186 = 1 / (0.10000000000000001 * var_x182 + 0.10000000000000001 * var_x185);
            const double var_x190 = exp(-12.0 - var_x179);
            const double var_x191 = 1.0 + var_x190;
            const double var_x192 = var_x186 * var_x191;
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x199 = exp(0.34849999999999998 * var_chaste_interface__membrane__V);
            const double var_x200 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
            const double var_x201 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
            ...
            partialF = ((var_x207) ? (-var_x202 - var_x203 - var_x204) : (-5.9230769230769234 * var_x210));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x219 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x220 = 1.0 + var_x219;
            const double var_x221 = exp(-0.01052 * var_chaste_interface__membrane__V);
            ...
            const double var_x226 = exp(-3.2000000000000002 - var_x44);
            const double var_x227 = 1.0 + var_x226;
            const double var_x228 = exp(0.057000000000000002 * var_chaste_interface__membrane__V);
            const double var_x229 = var_x228 / var_x227;
            
            partialF = ((var_x207) ? (-var_x224 - var_x225) : (-0.59999999999999998 * var_x229));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x162 = -var_x161;
            const double var_x179 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x230 = exp(2.5 + var_x162);
            const double var_x231 = 1.0 + var_x230;
            const double var_x232 = 1 / var_x231;
            const double var_x233 = exp(1.0 + var_x179);
            const double var_x234 = 1.0 + var_x233;
            const double var_x235 = 1 / var_x234;
            const double var_x236 = exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x237 = 1.0 + var_x236;
            const double var_x238 = 0.25 + 1.3999999999999999 / var_x237;
            const double var_x239 = var_x235 * var_x238;
            const double var_x242 = 1 / (var_x232 + 1.3999999999999999 * var_x239);
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x151 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x243 = exp(2.5 + var_x151);
            const double var_x244 = 1.0 + var_x243;
            const double var_x245 = 1 / var_x244;
            const double var_x246 = exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2));
            const double var_x249 = 1125.0 * var_x246;
            const double var_x250 = 1 / (80.0 + var_x249 + 165.0 * var_x245);
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x251 = var_chaste_interface__membrane__V > -60.0;
            const double var_x252 = exp(-5.0 + 10000.0 * var_chaste_interface__calcium_dynamics__Ca_i);
            const double var_x253 = 1.0 + var_x252;
            const double var_x254 = exp(-0.9375 + 1250.0 * var_chaste_interface__calcium_dynamics__Ca_i);
            const double var_x255 = 1.0 + var_x254;
            const double var_x256 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 8);
            const double var_x257 = (var_x251) && (var_chaste_interface__L_type_Ca_current_fCa_gate__fCa < 0.15753424657534248 + 0.068493150684931517 / var_x253 + 0.13698630136986303 / var_x255 + 0.68493150684931503 / (1.0 + 8.034023767017109e+27 * var_x256));
            const double var_x258 = 1 / mParameters[8];
            
            partialF = ((var_x257) ? (0) : (-var_x258));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x179 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x259 = exp(-4.0 + var_x179);
            const double var_x260 = 1.0 + var_x259;
            const double var_x261 = 1 / var_x260;
            const double var_x262 = exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2));
            const double var_x265 = 85.0 * var_x262;
            const double var_x266 = 1 / (3.0 + var_x265 + 5.0 * var_x261);
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x269 = exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2));
            const double var_x270 = 1 / (0.80000000000000004 + 9.5 * var_x269);
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x145 = var_x144 * var_chaste_interface__calcium_dynamics__g;
            const double var_x146 = var_x145 * var_chaste_interface__L_type_Ca_current_d_gate__d;
            const double var_x148 = 2 * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3) * mParameters[1] / pow(var_x141, 2);
            const double var_x149 = 2 * var_x142 * var_chaste_interface__calcium_dynamics__Ca_SR;
            const double var_x150 = var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__calcium_dynamics__g;
            ...
            const double var_x273 = 14.994515539305301 / (1.0 + 3.0 * var_x272);
            
            partialF = var_x273 * (var_x133 + var_x150 * (var_x148 - var_x149)) + 9.9963436928702016 * (var_x137 - var_x136 - var_x146) / (pow(var_x271, 3) * pow((0.33333333333333337 + var_x272), 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x251 = var_chaste_interface__membrane__V > -60.0;
            const double var_x275 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6);
            const double var_x276 = var_chaste_interface__calcium_dynamics__Ca_i < 0.00035;
            const double var_x277 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16);
            const double var_x278 = (var_x251) && (((var_x276) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x277)))) && (((var_chaste_interface__calcium_dynamics__Ca_i >= 0.00035) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x275))));
            
            partialF = ((var_x278) ? (0) : (-0.5));
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x114 = var_x95 * mParameters[10];
            const double var_x116 = 1 / var_x76;
            const double var_x117 = var_x116 * var_x78;
            const double var_x118 = var_x32 * var_x95;
            const double var_x119 = var_x116 * var_x77 * mParameters[5] * var_chaste_interface__sodium_dynamics__Na_i * mParameters[21] / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
            const double var_x120 = var_x58 * var_x62 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2);
            const double var_x279 = mParameters[12] * mParameters[3];
            
            partialF = var_x279 * (1.1846503119326294e-6 * var_x119 - 0.0018954404990922068 * var_x117 - 0.016878114612481093 * var_x114 - 0.016878114612481093 * var_x118 - 0.0056863214972766203 * var_x120);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL2Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x115 = var_x27 * var_x93;
            const double var_x121 = var_x26 * var_x36;
            const double var_x122 = var_x29 * var_x36;
            const double var_x123 = var_x36 * var_x50;
            const double var_x124 = var_x34 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
            const double var_x125 = var_x124 * var_x36;
            const double var_x126 = var_x36 * var_x64;
            const double var_x127 = 0.16028256395817389 * var_x126 - var_x43 * (2.6713760659695653 * var_x36 * var_x45 + 0.01602825639581739 * var_x36 * var_x46) - 13.356880329847826 * var_x36 * var_x69;
            const double var_x128 = var_x126 * var_x65;
            const double var_x279 = mParameters[12] * mParameters[3];
            const double var_x281 = 2.7188924024856265e-5 * var_x72;
            
            partialF = var_x279 * (4.357910453967955e-5 * var_x128 - 0.016878114612481093 * var_x115 - 0.016878114612481093 * var_x121 - 0.016878114612481093 * var_x122 - 0.00072631840899465921 * var_x123 - 0.0072631840899465916 * var_x125 - var_x127 * var_x281);
        }
        else
        {
