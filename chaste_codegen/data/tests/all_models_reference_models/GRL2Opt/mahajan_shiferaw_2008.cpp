...
// LCOV_EXCL_STOP
    ...
    double Cellmahajan_shiferaw_2008FromCellMLGRL2Opt::EvaluatePartialDerivative1(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x126 = 0.012999999999999999 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x127 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x128 = 0.00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x129 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x130 = 1.0 + 0.00054600000000000004 / pow(var_x126, 2) + 2.8200000000000001e-5 / pow(var_x127, 2) + 4.5000000000000001e-6 / pow(var_x128, 2) + 0.00016800000000000002 / pow(var_x129, 2);
            ...
            partialF = var_x132 * (-2539.0 + var_x116 + var_x118 - var_x121 - var_x125) + 0.001 * (0.0010920000000000001 / pow(var_x126, 3) + 5.6400000000000002e-5 / pow(var_x127, 3) + 9.0000000000000002e-6 / pow(var_x128, 3) + 0.00033600000000000004 / pow(var_x129, 3)) * (var_x136 - var_x134 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x133 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x130, 2);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellmahajan_shiferaw_2008FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
            ...
            const double var_x145 = _lt_0_row[14];
...
// LCOV_EXCL_STOP
    ...
    double Cellmahajan_shiferaw_2008FromCellMLGRL2Opt::EvaluatePartialDerivative12(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x304 = var_x297 * var_x302;
            const double var_x305 = var_x301 * var_x302;
...
// LCOV_EXCL_STOP
    ...
    double Cellmahajan_shiferaw_2008FromCellMLGRL2Opt::EvaluatePartialDerivative13(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -3.2750000000000003e-5 * var_x296 * var_x302 - 1.7975e-5 * var_x300 * var_x302;
        }
        else
        {
    ...
    double Cellmahajan_shiferaw_2008FromCellMLGRL2Opt::EvaluatePartialDerivative14(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x307 = 0.066666666666666666 * var_chaste_interface__cell__V;
            const double var_x308 = exp(0.20000000000000001 + var_x307);
            const double var_x309 = 1.0 + var_x308;
            const double var_x310 = 1 / var_x309;
            const double var_x311 = 1 / (0.5 + 9.0 * var_x310);
...
// LCOV_EXCL_STOP
    ...
    double Cellmahajan_shiferaw_2008FromCellMLGRL2Opt::EvaluatePartialDerivative15(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1 = 0.10000000000000001 * var_chaste_interface__cell__V;
            const double var_x316 = exp(6.0 + var_x1);
            const double var_x317 = 1.0 + var_x316;
            const double var_x318 = 1 / var_x317;
            const double var_x319 = 1 / (30.0 + 3000.0 * var_x318);
...
// LCOV_EXCL_STOP
    ...
    double Cellmahajan_shiferaw_2008FromCellMLGRL2Opt::EvaluatePartialDerivative16(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x322 = exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2));
            const double var_x323 = 1 / (1.5 + 3.5 * var_x322);
...
// LCOV_EXCL_STOP
    ...
    double Cellmahajan_shiferaw_2008FromCellMLGRL2Opt::EvaluatePartialDerivative17(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x3 = 1.0 + var_x2;
            const double var_x4 = 1 / var_x3;
            const double var_x324 = 1 / (20.0 + 20.0 * var_x4);
...
// LCOV_EXCL_STOP
    ...
    double Cellmahajan_shiferaw_2008FromCellMLGRL2Opt::EvaluatePartialDerivative19(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x135 = 16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted;
            const double var_x136 = var_x124 * var_x135;
            const double var_x343 = 1 / var_chaste_interface__Ca__Ca_NSR;
            const double var_x344 = var_x343 * var_chaste_interface__Irel__xir;
            const double var_x348 = var_x134 - var_x136 - var_chaste_interface__Irel__xir;
            
            partialF = -0.033333333333333333 - var_x344 + var_x343 * var_x348;
        }
        else
        {
    ...
    double Cellmahajan_shiferaw_2008FromCellMLGRL2Opt::EvaluatePartialDerivative20(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x353 = 0.000125 * var_x14;
            const double var_x355 = 8.6634442712402744e-10 * var_x109;
            
            partialF = (3.9062500000000001e-6 * var_x105 - 0.00056249999999999996 * var_x104 - 0.0089999999999999993 * var_x111 - var_x108 * var_x355 - var_x20 * var_x353 * var_x94) * mParameters[3];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellmahajan_shiferaw_2008FromCellMLGRL2Opt::EvaluatePartialDerivative22(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x365 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_submem;
            const double var_x366 = pow(var_x365, (-2));
            const double var_x367 = 1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem;
            const double var_x368 = pow(var_x367, (-2));
            const double var_x369 = 0.59999999999999998 + var_chaste_interface__Ca__Ca_submem;
            const double var_x370 = pow(var_x369, (-2));
            const double var_x371 = 1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem;
            const double var_x372 = pow(var_x371, (-2));
            const double var_x373 = 1 / (1.0 + 4.5 * var_x366 + 3.2307692307692308 * var_x368 + 28.199999999999999 * var_x370 + 3.4285714285714284 * var_x372);
            const double var_x374 = var_x373;
            const double var_x375 = 36400.0 * var_x100;
            const double var_x377 = 1.4439073785400458e-5 * var_x109;
            const double var_x378 = 0.0327 * var_chaste_interface__Ca__trops;
            const double var_x379 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
            
            partialF = var_x374 * (-14.789 + var_x378 + 4.0499999999999998 * var_x113 - 36.399999999999999 * var_x115 - 0.050000000000000003 * var_x112 + var_x114 * var_x377) + 0.0012574820180071425 * (9.0 / pow(var_x365, 3) + 56.399999999999999 / pow(var_x369, 3) + 0.97959183673469385 / pow(var_x371, 3) + 0.49704142011834318 / pow(var_x367, 3)) * (50.0 * var_chaste_interface__Irel__xir + 0.019599999999999999 * var_chaste_interface__Ca__trops + 12500.0 * var_chaste_interface__Ca__Ca_i_converted - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x375 * var_x71 - var_x379 * (70.0 - var_chaste_interface__Ca__trops) + 50.0 * var_x59 * var_x85) / pow((0.035460992907801421 + var_x370 + 0.15957446808510639 * var_x366 + 0.12158054711246201 * var_x372 + 0.11456628477905074 * var_x368), 2);
        }
        else
        {
    ...
    double Cellmahajan_shiferaw_2008FromCellMLGRL2Opt::EvaluatePartialDerivative23(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x351 = var_x139 - var_x137 - var_x138;
    ...
    double Cellmahajan_shiferaw_2008FromCellMLGRL2Opt::EvaluatePartialDerivative25(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.019599999999999999 - var_x379;
        }
        else
        {
