...
std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt_LookupTables> Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt_LookupTables::mpInstance;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x163 = var_x62 < -0.040000000000000001;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x211 = exp(8.408666666666667 + 0.33333333333333331 * var_chaste_interface__Membrane__Vm_converted);
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x227 = 1.2 * var_x224;
            const double var_x228 = 1 / (var_x227 + 0.032000000000000001 * var_x204 + 0.062 * var_x223);
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x276 = 127.37086290006985 * mParameters[17];
            
            partialF = (2771.3924296838059 * var_x114 - 13302683.662482269 * var_x117 - 4434227.8874940891 * var_x113 - var_x111 * var_x276 - var_x116 * var_x276) * mParameters[16];
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x277 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
            const double var_x278 = pow(var_x277, (-2));
            const double var_x279 = 0.015073086844368014 / (1.0 + 3.0 * var_x278);
            
            partialF = var_x279 * (-0.00044443999999999999 + var_x132 * (var_x139 - var_x138)) + 0.010048724562912011 * (var_x125 + var_x126 - var_x124 - var_x133) / (pow(var_x277, 3) * pow((0.33333333333333337 + var_x278), 2));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x282 = pow(var_chaste_interface__calcium_dynamics__Cai, 16);
            const double var_x283 = (var_x281) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x282));
            const double var_x284 = pow(var_chaste_interface__calcium_dynamics__Cai, 6);
            const double var_x285 = (var_chaste_interface__calcium_dynamics__Cai > 0.00035) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x284));
            const double var_x286 = (var_x229) && (var_x281) && (var_x283) && (var_x285);
            const double var_x287 = (var_x229) && (var_x283) && (var_x285);
            
            partialF = ((var_x286) ? (0) : ((var_x281) ? (-0.5) : ((var_x287) ? (0) : (-0.5))));
        }
        else
        {
