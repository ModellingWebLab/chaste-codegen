...
std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt_LookupTables> Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt_LookupTables::mpInstance;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x164) ? (-0.037999999999999999 * var_x161 - 1.8 * var_x160 - 206666.66666666669 * var_x159) : (-0.39339103068450043));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x164) ? (-0.003462857142857143 * var_x176 - 0.14285714285714285 * var_x170 * var_x178) : (-0.085714285714285715 * var_x184));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x220) ? (-var_x201 * var_x221) : (-var_x221));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.00090909090909090909 * var_x259;
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0005263157894736842 - var_x263;
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x277 = 127.37086290006985 * mParameters[17];
            
            partialF = (2771.3924296838059 * var_x115 - 13302683.662482269 * var_x118 - 4434227.8874940891 * var_x114 - var_x112 * var_x277 - var_x117 * var_x277) * mParameters[16];
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x280 * (-0.00044443999999999999 + var_x133 * (var_x140 - var_x139)) + 0.010048724562912011 * (var_x126 + var_x127 - var_x125 - var_x134) / (pow(var_x278, 3) * pow((0.33333333333333337 + var_x279), 2));
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x287) ? (0) : ((var_x282) ? (-0.5) : ((var_x288) ? (0) : (-0.5))));
        }
        else
        {
