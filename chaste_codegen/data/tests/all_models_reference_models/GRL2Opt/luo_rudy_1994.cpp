...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x0 * (-4.426e-5 + 9.2286828271246209e-7 * var_x103 + 2.6387196824222991e-7 * var_x104 + 3.7804821863291499e-5 * var_x62 + 0.0059063570093597579 * var_x106 + 0.10468673984798647 * var_x96 - 1.0 * var_x33 - 20.0 * var_x43 - 0.000183 * var_x3 - 0.014999999999999999 * var_x70 - 0.4389381125701739 * var_x55 - 6.9215121203434662e-7 * var_x108 - 0.048845293589318314 * var_x71 - 1.9790397618167244e-7 * var_x109 - 3.0602006688963209e-5 * var_x24 - 0.0012135347818116574 * var_x30 - 0.0059063570093597579 * var_x110 + var_x11 * var_x59 + var_x20 * var_x59 - var_x100 * var_x98 - var_x11 * var_x17 - var_x17 * var_x20 - var_x78 * var_x89 - var_x79 * var_x82 - var_x79 * var_x93 - var_x91 * var_chaste_interface__ionic_concentrations__Ki - var_x91 * var_chaste_interface__ionic_concentrations__Nai);
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x156 = 0.00092000000000000003 + var_chaste_interface__ionic_concentrations__Cai;
            const double var_x157 = 1 / var_x156;
            const double var_x158 = var_chaste_interface__ionic_concentrations__Cai / pow(var_x156, 2);
            
            partialF = 8.5932353608719255e-11 * var_x123 + 1.7462713310839333e-5 * var_x114 + 0.00040588235294117644 * var_x158 - 0.030369936192764058 * var_x115 - 0.00011935049112322121 * var_x118 - 6.0944687335561951e-7 * var_x113 - 1.7462713310839333e-5 * var_x112 - 0.00040588235294117644 * var_x157;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x160 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x161 = exp(-4.7130000000000001 + var_x160);
            const double var_x162 = 1.0 - var_x161;
            const double var_x163 = 0.32000000000000001 / var_x162;
            const double var_x164 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
            const double var_x165 = 47.130000000000003 + var_chaste_interface__membrane__V;
            
            partialF = -0.080000000000000002 * var_x164 - var_x163 * var_x165;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x166 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
            const double var_x167 = exp(0.34999999999999998 * var_chaste_interface__membrane__V);
            ...
            const double var_x170 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x171 = 1.0 + var_x170;
            
            partialF = ((var_x169) ? (-310000.0 * var_x167 - 0.13500000000000001 * var_x168 - 3.5600000000000001 * var_x166) : (-7.6923076923076916 / var_x171));
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x180 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x181 = 1.0 + var_x180;
            const double var_x182 = exp(-0.01052 * var_chaste_interface__membrane__V);
            const double var_x183 = var_x182 / var_x181;
            const double var_x184 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x186 = exp(-3.2000000000000002 + var_x160);
            ...
            partialF = ((var_x169) ? (-0.1212 * var_x183 - var_x179 * var_x184) : (-0.29999999999999999 * var_x189));
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x79 = var_x74 * var_x78;
            const double var_x107 = var_x72 * var_x79 * var_chaste_interface__membrane__V;
            const double var_x136 = var_x9 + var_x19 * var_x6;
            const double var_x139 = var_x33 * var_x63;
            const double var_x140 = var_x38 * var_x42 * pow(var_chaste_interface__ionic_concentrations__Nai, 2);
            const double var_x141 = var_x16 * var_x6;
            const double var_x144 = var_x63 * var_x64 * var_x69 / (var_x68 * pow((0.031622776601683791 + var_x64), 2));
            const double var_x146 = var_x58 * var_x6;
            const double var_x227 = 1.9339199950521953e-8 * var_x16;
            const double var_x233 = var_x227 * var_x56;
            const double var_x234 = 5.1470588235294113e-7 * var_x141;
            const double var_x235 = 1.9339199950521953e-8 * var_x146;
            const double var_x236 = var_x20 * var_x235 - var_x20 * var_x234;
            
            partialF = var_x236 - 5.594554271400994e-8 * var_x107 - 0.54665885146975302 * var_x140 - 1.139681818874567e-6 * var_x63 - 0.080828497792522477 * var_x139 - 6.4825765265103909e-6 * var_x144 - var_x136 * var_x233;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x99 = var_x23 * var_x28 * var_x46 * mParameters[5] / pow((var_x46 + 0.98039215686274506 * var_x53), 2);
            const double var_x107 = var_x72 * var_x79 * var_chaste_interface__membrane__V;
            const double var_x138 = var_x30 * var_x60;
            const double var_x141 = var_x16 * var_x6;
            const double var_x146 = var_x58 * var_x6;
            const double var_x149 = var_x21 * var_x3;
            const double var_x150 = var_x9 + var_x10 * var_x6;
            const double var_x151 = var_x21 * var_x55;
            const double var_x152 = var_x21 * var_x94;
            const double var_x153 = 6.4745439480613349 * var_x152 - var_x49 * (1.0501178736126389 * var_x21 * var_x50 + 1.6434541406371006 * var_x21 * var_x51) - 13.687910356755641 * var_x21 * var_x97;
            const double var_x154 = var_x152 * var_x95;
            const double var_x227 = 1.9339199950521953e-8 * var_x16;
            const double var_x233 = var_x227 * var_x56;
            const double var_x234 = 5.1470588235294113e-7 * var_x141;
            const double var_x235 = 1.9339199950521953e-8 * var_x146;
            const double var_x239 = 0.0012812882037032361 * var_x99;
            const double var_x240 = var_x11 * var_x235 - var_x11 * var_x234;
            
            partialF = var_x240 + 0.0084616719207093495 * var_x154 - 1.5996281101931733e-8 * var_x107 - 0.035478708262932285 * var_x151 - 9.808819343281279e-5 * var_x138 - 1.4791615096031613e-5 * var_x149 - var_x150 * var_x233 - var_x153 * var_x239;
        }
        else
        {
