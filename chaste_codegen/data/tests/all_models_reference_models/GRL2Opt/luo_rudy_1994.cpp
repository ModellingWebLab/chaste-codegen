...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_fast_sodium_current__E_Na = 26.614641953637257 * log(10) * log10(mParameters[2] / var_chaste_interface__ionic_concentrations__Nai); // mV
        ...
        const double var_calcium_background_current__i_Ca_b = 3.0159999999999999e-5 * var_chaste_interface__membrane__V - 0.00040134880066084979 * log(10) * log10(mParameters[0] / var_chaste_interface__ionic_concentrations__Cai); // uA_per_mm2
        const double var_fast_sodium_current__i_Na = 1.0 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-var_fast_sodium_current__E_Na + var_chaste_interface__membrane__V) * mParameters[4] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j; // uA_per_mm2
        const double var_non_specific_calcium_activated_current__Vns = -26.614641953637257 * log(10) * log10((mParameters[1] + mParameters[2]) / (var_chaste_interface__ionic_concentrations__Ki + var_chaste_interface__ionic_concentrations__Nai)) + var_chaste_interface__membrane__V; // mV
        ...
        const double var_time_dependent_potassium_current__i_K = 0.0012135347818116574 * sqrt(mParameters[1]) * pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 2) * (-26.614641953637257 * log(10) * log10((0.018329999999999999 * mParameters[2] + mParameters[1]) / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki)) + var_chaste_interface__membrane__V) / (1.0 + exp(-1.7526479750778814 + 0.031152647975077882 * var_chaste_interface__membrane__V)); // uA_per_mm2
        const double var_time_independent_potassium_current__E_K1 = 26.614641953637257 * log(10) * log10(mParameters[1] / var_chaste_interface__ionic_concentrations__Ki); // mV
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x8 = var_x6 * log10(var_x7 * (mParameters[1] + mParameters[2]));
            ...
            const double var_x19 = -0.75 * mParameters[2];
            ...
            const double var_x23 = var_x6 * log10(var_x22 * mParameters[1]);
            ...
            const double var_x29 = sqrt(mParameters[1]);
            ...
            const double var_x36 = pow(mParameters[2], 3);
            const double var_x37 = var_x35 * var_x36;
            const double var_x38 = var_x37 * var_chaste_interface__ionic_concentrations__Cai;
            const double var_x39 = mParameters[0] * exp(0.013150655966354929 * var_chaste_interface__membrane__V);
            ...
            const double var_x42 = 1 / ((669921.875 + var_x36) * (1.3799999999999999 + mParameters[0]));
            ...
            const double var_x55 = var_x29 * mParameters[5] / (var_x54 + 1.02 * var_x47);
            ...
            const double var_x63 = -var_x62 * log10(var_x61 * (0.018329999999999999 * mParameters[2] + mParameters[1])) + var_chaste_interface__membrane__V;
            ...
            const double var_x68 = exp(0.01485884101040119 * mParameters[2]);
            ...
            const double var_x71 = mParameters[1] / (1.5 + mParameters[1]);
            ...
            const double var_x89 = 1.0 * var_x88 - 0.34000000000000002 * mParameters[0];
            ...
            const double var_x101 = var_x24 * var_x29 * var_x47 * mParameters[5] / pow((var_x47 + 0.98039215686274506 * var_x54), 2);
            ...
            partialF = var_x0 * (-4.426e-5 + 9.2286828271246209e-7 * var_x105 + 2.6387196824222991e-7 * var_x106 + 3.7804821863291499e-5 * var_x64 + 0.0059063570093597579 * var_x108 + 0.10468673984798647 * var_x98 - 1.0 * var_x34 - 20.0 * var_x44 - 0.000183 * var_x3 - 0.014999999999999999 * var_x72 - 0.4389381125701739 * var_x56 - 6.9215121203434662e-7 * var_x110 - 0.048845293589318314 * var_x73 - 1.9790397618167244e-7 * var_x111 - 3.0602006688963209e-5 * var_x25 - 0.0012135347818116574 * var_x31 - 0.0059063570093597579 * var_x112 + var_x12 * var_x60 + var_x21 * var_x60 - var_x100 * var_x102 - var_x12 * var_x18 - var_x18 * var_x21 - var_x80 * var_x91 - var_x81 * var_x84 - var_x81 * var_x95 - var_x93 * var_chaste_interface__ionic_concentrations__Ki - var_x93 * var_chaste_interface__ionic_concentrations__Nai);
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x158 = 0.00092000000000000003 + var_chaste_interface__ionic_concentrations__Cai;
            const double var_x159 = 1 / var_x158;
            const double var_x160 = var_chaste_interface__ionic_concentrations__Cai / pow(var_x158, 2);
            
            partialF = 8.5932353608719255e-11 * var_x125 + 1.7462713310839333e-5 * var_x116 + 0.00040588235294117644 * var_x160 - 0.030369936192764058 * var_x117 - 0.00011935049112322121 * var_x120 - 6.0944687335561951e-7 * var_x115 - 1.7462713310839333e-5 * var_x114 - 0.00040588235294117644 * var_x159;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x162 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x163 = exp(-4.7130000000000001 + var_x162);
            const double var_x164 = 1.0 - var_x163;
            const double var_x165 = 0.32000000000000001 / var_x164;
            const double var_x166 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
            const double var_x167 = 47.130000000000003 + var_chaste_interface__membrane__V;
            
            partialF = -0.080000000000000002 * var_x166 - var_x165 * var_x167;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x168 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
            const double var_x169 = exp(0.34999999999999998 * var_chaste_interface__membrane__V);
            const double var_x170 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x171 = var_chaste_interface__membrane__V < -40.0;
            const double var_x172 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x173 = 1.0 + var_x172;
            
            partialF = ((var_x171) ? (-310000.0 * var_x169 - 0.13500000000000001 * var_x170 - 3.5600000000000001 * var_x168) : (-7.6923076923076916 / var_x173));
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x162 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x171 = var_chaste_interface__membrane__V < -40.0;
            const double var_x175 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
            ...
            const double var_x180 = -127140.0 * var_x178 - 3.4740000000000003e-5 * var_x179;
            ...
            const double var_x188 = exp(-3.2000000000000002 + var_x162);
            const double var_x189 = 1.0 + var_x188;
            const double var_x190 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V);
            const double var_x191 = var_x190 / var_x189;
            
            partialF = ((var_x171) ? (-0.1212 * var_x185 - var_x181 * var_x186) : (-0.29999999999999999 * var_x191));
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x193 = exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V);
            const double var_x194 = 1.0 - var_x193;
            const double var_x195 = 1 / var_x194;
            const double var_x196 = 0.035000000000000003 * var_x195;
            const double var_x197 = 1.0 + var_x193;
            const double var_x198 = 1 / var_x197;
            const double var_x199 = 1.0 - var_x198;
            const double var_x200 = var_x197 * var_x199;
            const double var_x202 = 10.0 + var_chaste_interface__membrane__V;
            const double var_x206 = var_x196 * var_x202;
            
            partialF = -var_x206 - var_x200 * var_x206;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x208 = 0.019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
            const double var_x209 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V);
            const double var_x210 = 1.0 + var_x209;
            const double var_x212 = exp(4.0767441860465121 + 0.11627906976744186 * var_chaste_interface__membrane__V);
            const double var_x213 = 1.0 + var_x212;
            const double var_x215 = -0.02 - var_x208;
            const double var_x216 = 1 / var_x213;
            const double var_x217 = 0.59999999999999998 / var_x210;
            const double var_x218 = var_x216 + var_x217;
            const double var_x220 = 1.0 - var_x216 - var_x217;
            
            partialF = var_x215 * var_x218 + var_x215 * var_x220;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x222 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V);
            const double var_x223 = 1.0 - var_x222;
            const double var_x224 = 7.1899999999999999e-5 / var_x223;
            const double var_x225 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V);
            const double var_x226 = -1.0 + var_x225;
            const double var_x227 = 0.00013100000000000001 / var_x226;
            const double var_x228 = 30.0 + var_chaste_interface__membrane__V;
            
            partialF = -var_x224 * var_x228 - var_x227 * var_x228;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x81 = var_x76 * var_x80;
            const double var_x109 = var_x74 * var_x81 * var_chaste_interface__membrane__V;
            const double var_x138 = var_x10 + var_x20 * var_x7;
            const double var_x141 = var_x34 * var_x65;
            const double var_x142 = var_x39 * var_x43 * pow(var_chaste_interface__ionic_concentrations__Nai, 2);
            const double var_x143 = var_x17 * var_x7;
            const double var_x146 = var_x65 * var_x66 * var_x71 / (var_x70 * pow((0.031622776601683791 + var_x66), 2));
            const double var_x148 = var_x59 * var_x7;
            const double var_x229 = 1.9339199950521953e-8 * var_x17;
            const double var_x235 = var_x229 * var_x57;
            const double var_x236 = 5.1470588235294113e-7 * var_x143;
            const double var_x237 = 1.9339199950521953e-8 * var_x148;
            const double var_x238 = var_x21 * var_x237 - var_x21 * var_x236;
            
            partialF = var_x238 - 5.594554271400994e-8 * var_x109 - 0.54665885146975302 * var_x142 - 1.139681818874567e-6 * var_x65 - 0.080828497792522477 * var_x141 - 6.4825765265103909e-6 * var_x146 - var_x138 * var_x235;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x101 = var_x24 * var_x29 * var_x47 * mParameters[5] / pow((var_x47 + 0.98039215686274506 * var_x54), 2);
            const double var_x109 = var_x74 * var_x81 * var_chaste_interface__membrane__V;
            const double var_x140 = var_x31 * var_x61;
            const double var_x143 = var_x17 * var_x7;
            const double var_x148 = var_x59 * var_x7;
            const double var_x151 = var_x22 * var_x3;
            const double var_x152 = var_x10 + var_x11 * var_x7;
            const double var_x153 = var_x22 * var_x56;
            const double var_x154 = var_x22 * var_x96;
            const double var_x155 = 6.4745439480613349 * var_x154 - var_x50 * (1.0501178736126389 * var_x22 * var_x51 + 1.6434541406371006 * var_x22 * var_x52) - 13.687910356755641 * var_x22 * var_x99;
            const double var_x156 = var_x154 * var_x97;
            const double var_x229 = 1.9339199950521953e-8 * var_x17;
            const double var_x235 = var_x229 * var_x57;
            const double var_x236 = 5.1470588235294113e-7 * var_x143;
            const double var_x237 = 1.9339199950521953e-8 * var_x148;
            const double var_x241 = 0.0012812882037032361 * var_x101;
            const double var_x242 = var_x12 * var_x237 - var_x12 * var_x236;
            
            partialF = var_x242 + 0.0084616719207093495 * var_x156 - 1.5996281101931733e-8 * var_x109 - 0.035478708262932285 * var_x153 - 9.808819343281279e-5 * var_x140 - 1.4791615096031613e-5 * var_x151 - var_x152 * var_x235 - var_x155 * var_x241;
        }
        else
        {
    ...
    std::vector<double> Cellluo_rudy_1994FromCellMLGRL2::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        ...
        const double var_fast_sodium_current__E_Na = var_membrane__R * var_membrane__T * log(10) * log10(mParameters[2] / var_chaste_interface__ionic_concentrations__Nai) / var_membrane__F; // mV
        ...
        const double var_time_independent_potassium_current__E_K1 = var_membrane__R * var_membrane__T * log(10) * log10(mParameters[1] / var_chaste_interface__ionic_concentrations__Ki) / var_membrane__F; // mV
        ...
        const double var_time_independent_potassium_current__i_K1_converted = 100.00000000000001 * (-var_time_independent_potassium_current__E_K1 + var_chaste_interface__membrane__V) * var_time_independent_potassium_current__g_K1 * var_time_independent_potassium_current_K1_gate__K1_infinity; // uA_per_cm2
