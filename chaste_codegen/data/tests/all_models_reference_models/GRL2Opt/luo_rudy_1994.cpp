...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellluo_rudy_1994FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x3 = -0.75 * mParameters[1];
            ...
            const double var_x31 = -0.34000000000000002 * mParameters[0];
            ...
            const double var_x58 = log(var_x57 * (mParameters[1] + mParameters[2]));
            ...
            const double var_x72 = log(var_x71 * mParameters[1]);
            ...
            const double var_x78 = sqrt(mParameters[1]);
            ...
            const double var_x91 = 1 / ((669921.875 + var_x85) * (1.3799999999999999 + mParameters[0]));
            ...
            const double var_x104 = var_x78 * mParameters[5] / (var_x103 + 1.02 * var_x96);
            ...
            const double var_x111 = -26.614641953637257 * log(var_x110 * (0.018329999999999999 * mParameters[2] + mParameters[1])) + var_chaste_interface__membrane__V;
            ...
            const double var_x116 = exp(0.01485884101040119 * mParameters[2]);
            ...
            const double var_x119 = mParameters[1] / (1.5 + mParameters[1]);
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellluo_rudy_1994FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            partialF = 1.7462713310839333e-5 * var_x151 + 0.00040588235294117644 * var_x202 - 0.030369936192764058 * var_x152 - 6.0944687335561951e-7 * var_x150 - 1.7462713310839333e-5 * var_x149 - 0.0015184968096382029 * var_x147 - 0.00040588235294117644 * var_x201;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellluo_rudy_1994FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            partialF = ((var_x209) ? (var_x214 + var_x215 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x214 + 3.1999999919207769e-7 * var_x204)) : (var_x215 - var_x208 * var_x213));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellluo_rudy_1994FromCellMLGRL2Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x219) ? (-310000.0 * var_x217 - 0.13500000000000001 * var_x218 - 3.5600000000000001 * var_x216) : (-7.6923076923076916 / var_x221));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellluo_rudy_1994FromCellMLGRL2Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x219) ? (-0.1212 * var_x233 - var_x229 * var_x234) : (-0.29999999999999999 * var_x239));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellluo_rudy_1994FromCellMLGRL2Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x243 * var_x258 - var_x242 * var_x258;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellluo_rudy_1994FromCellMLGRL2Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x268 * var_x271 + var_x268 * var_x273;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellluo_rudy_1994FromCellMLGRL2Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x282) ? (var_x291 + var_x293 - 740000.00029091549 * (30.000000675675675 + var_chaste_interface__membrane__V) * (var_x291 + 4.8581081061982445e-11 * var_x276)) : ((var_x287) ? (var_x293 + var_x294) : (var_x294 - var_x280 * var_x290)));
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellluo_rudy_1994FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            partialF = var_x303 - 0.54665885146975302 * var_x183 - 1.139681818874567e-6 * var_x113 - 0.080828497792522477 * var_x182 - 0.0030369936192764057 * var_x178 - 6.4825765265103909e-6 * var_x187 - var_x179 * var_x300;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellluo_rudy_1994FromCellMLGRL2Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x306 + 0.0084616719207093495 * var_x199 - 0.035478708262932285 * var_x196 - 0.0030369936192764057 * var_x193 - 9.808819343281279e-5 * var_x181 - 1.4791615096031613e-5 * var_x194 - var_x195 * var_x300 - var_x198 * var_x305;
        }
        else
        {
