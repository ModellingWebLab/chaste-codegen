...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return ((fabs(-10.0 + var_chaste_interface__membrane__V) < 1.4556040763835654e-6) ? (-1.9068413400624708e-7 / (-1.0 + exp(-1.0000000004755094e-7)) - 1.0465793309197835e-7 / (1.0 - exp(2.1542940330476766e-7)) + 343499999.83666253 * (-9.9999985443959236 + var_chaste_interface__membrane__V) * (1.0465793309197835e-10 / (1.0 - exp(2.1542940330476766e-7)) + 1.0465793309197835e-10 / (1.0 - exp(-2.1542940330476766e-7)) + 1.9068413400624708e-10 / (-1.0 + exp(1.0000000004755094e-7)) + 1.9068413400624708e-10 / (-1.0 + exp(-1.0000000004755094e-7)))) : (0.13100000000000001 * (-10.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-0.68699999999999994 + 0.068699999999999997 * var_chaste_interface__membrane__V)) + 0.071899999999999992 * (-10.0 + var_chaste_interface__membrane__V) / (1.0 - exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_fast_sodium_current_m_gate__m = 0.001 * (((var_chaste_interface__membrane__V > -47.130001000000007) && (var_chaste_interface__membrane__V < -47.129998999999998)) ? ((1.0 - var_chaste_interface__fast_sodium_current_m_gate__m) * (-0.00032000000146581442 / (1.0 - exp(1.0000000045806701e-7)) + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (0.00031999999919207767 / (1.0 - exp(-9.9999999747524276e-8)) + 0.00032000000146581442 / (1.0 - exp(1.0000000045806701e-7)))) - 80.0 * var_chaste_interface__fast_sodium_current_m_gate__m * _lt_0_row[15]) : ((var_chaste_interface__membrane__V >= -90.0) ? (-80.0 * var_chaste_interface__fast_sodium_current_m_gate__m * _lt_0_row[15] + 320.0 * (1.0 - var_chaste_interface__fast_sodium_current_m_gate__m) * (47.130000000000003 + var_chaste_interface__membrane__V) / (_lt_0_row[16])) : (0))); // 1 / millisecond
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellwinslow_model_1999FromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x143 = 1 / (1.0 - exp(-9.9999999747524276e-8));
            const double var_x144 = 1 / (1.0 - exp(1.0000000045806701e-7));
            const double var_x145 = _lt_0_row[15];
            const double var_x147 = (var_chaste_interface__membrane__V > -47.130001000000007) && (var_chaste_interface__membrane__V < -47.129998999999998);
            ...
            partialF = ((var_x147) ? (var_x155 + 3.200000014658144e-7 * var_x144 - 499.99999948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (0.00031999999919207767 * var_x143 + 0.00032000000146581442 * var_x144)) : ((var_x154) ? (var_x155 - var_x152 * var_x153) : (0)));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellwinslow_model_1999FromCellMLGRL2Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x210 = (-9.9999985443959236 + var_chaste_interface__membrane__V) * (1.0465793309197835e-10 * var_x206 + 1.0465793309197835e-10 * var_x207 + 1.9068413400624708e-10 * var_x208 + 1.9068413400624708e-10 * var_x209);
            const double var_x212 = -10.0 + var_chaste_interface__membrane__V;
            const double var_x213 = fabs(var_x212) < 1.4556040763835654e-6;
            ...
            partialF = ((var_x213) ? (1.9068413400624708e-10 * var_x209 + 1.0465793309197834e-10 * var_x206 - 343499.99983666249 * var_x210) : (-0.00013100000000000001 * var_x212 * var_x216 - 7.1899999999999999e-5 * var_x212 * var_x220));
        }
        else
        {
