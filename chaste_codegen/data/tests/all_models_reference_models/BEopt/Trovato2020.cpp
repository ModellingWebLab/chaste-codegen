...
// LCOV_EXCL_STOP
        ...
        const double var_x240 = _lt_0_row[40];
        ...
        const double var_x479 = _lt_0_row[1];
        ...
        const double var_x554 = 1 / (pow(var_x5, 9) * pow(var_x551, 2));
        const double var_x555 = var_x554 * (-8 + 0.40000000000000002 * var_x3);
        const double var_x556 = var_x347 - var_x261 * (var_x345 + var_x346);
        const double var_x557 = var_x550 * var_x556;
        const double var_x558 = 1 / var_x552;
        const double var_x559 = 1.0 + 0.0123 / var_chaste_interface__intracellular_ions__cajsr;
        const double var_x560 = 0.5 * var_x558 * var_x559;
        const double var_x561 = 15.0 * var_x553;
        const double var_x562 = var_x63 + var_x556 * var_x561;
        const double var_x563 = var_x559 * var_x562;
        const double var_x564 = pow(var_x552, (-2));
        const double var_x565 = var_x555 * var_x564;
        const double var_x566 = 1.8890099916800013e-5 * var_x565;
        const double var_x567 = var_x556 > 0;
        const double var_x568 = var_x559 * var_chaste_interface__ryr__Jrel1;
        const double var_x569 = var_x550 * var_x559;
        const double var_x570 = 0.0061500000000000001 * var_x558 / pow(var_chaste_interface__intracellular_ions__cajsr, 2);
        const double var_x571 = var_x554 * var_x9;
        const double var_x572 = var_x564 * var_x571;
        const double var_x573 = 1.1334059950080009e-8 * var_x572;
        const double var_x574 = 1.0 + 1 / pow(var_chaste_interface__intracellular_ions__cacsr, 8);
        const double var_x575 = 1 / var_x574;
        const double var_x576 = var_x552 * var_x575;
        const double var_x577 = 91.0 * var_x576;
        const double var_x578 = var_x45 * var_x575;
        const double var_x579 = 1.0 + 0.0123 / var_chaste_interface__intracellular_ions__cacsr;
        const double var_x580 = 0.16666666666666666 * var_x558 * var_x579;
        const double var_x581 = var_x15 + var_x45 * var_x577;
        const double var_x582 = var_x579 * var_x581;
        const double var_x583 = 6.2966999722666711e-6 * var_x565;
        const double var_x584 = var_x45 > 0;
        const double var_x585 = var_x579 * var_chaste_interface__ryr__Jrel2;
        const double var_x586 = 0.0020500000000000002 * var_x558 / pow(var_chaste_interface__intracellular_ions__cacsr, 2);
        const double var_x587 = var_x575 * var_x579;
        const double var_x588 = 3.7780199833600036e-9 * var_x572;
        ...
        rJacobian[10][10] = 1.0 - (mDt * (-0.75 + var_x480 * (var_x476 + 1.5258303269789357e-10 * var_x458 + 2.1674623181275951e-12 * var_x477 - 10.325106196546965 * var_x473 + var_x424 * var_x437 + var_x450 * var_x455 + var_x462 * var_x464 + var_x465 * var_x469 - var_x459 * var_x461 - var_x465 * var_x467 - var_x465 * var_x475 - 0.030099999999999998 * var_x470 / (_lt_0_row[4]) - var_x470 * var_x471 * mParameters[7] - 1.000004299990755 * var_x478 * mParameters[9] * var_chaste_interface__IK1__xk1 / (1.0 + exp(10.545454545454545 + 0.090909090909090912 * var_chaste_interface__membrane__v - 0.5 * mParameters[1])) - var_x470 * mParameters[13] * var_chaste_interface__Ito__a * var_chaste_interface__Ito__i1 * var_chaste_interface__Ito__i2 - 0.43033148291193518 * var_x478 * (var_x479 * var_chaste_interface__IKr__xrf + (1.0 - var_x479) * var_chaste_interface__IKr__xrs) * mParameters[11] / ((_lt_0_row[2]) * (_lt_0_row[3])))));
        ...
        rJacobian[14][15] = 0.0;
        rJacobian[14][16] = 0.0;
        rJacobian[15][0] = -(mDt * (((var_x567) ? (var_x560 * (-0.00056670299750400039 * var_x555 * var_x557 - 948.60627177700349 * var_x184 * var_x553 * (var_x256 - var_x252)) + var_x563 * var_x566) : (-var_x566 * var_x568))));
        rJacobian[15][1] = -(mDt * (((var_x567) ? (-474.30313588850174 * var_x184 * var_x569 * (var_x269 + var_x273)) : (0))));
        rJacobian[15][2] = -(mDt * (((var_x567) ? (-0.00151515 * var_x569 * var_x57) : (0))));
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = 0.0;
        rJacobian[15][5] = -(mDt * (((var_x567) ? (var_x560 * (0.0030303000000000001 * var_x553 * var_x59 * var_chaste_interface__intracellular_ions__cass + 120.0 * var_x552 * var_x556 / (pow(var_x549, 2) * pow(var_chaste_interface__intracellular_ions__cajsr, 9))) - var_x562 * var_x570) : (var_x570 * var_chaste_interface__ryr__Jrel1))));
        rJacobian[15][6] = 0.0;
        rJacobian[15][7] = -(mDt * (((var_x567) ? (37.5 * var_x569) : (0))));
        rJacobian[15][8] = -(mDt * (((var_x567) ? (var_x560 * (var_x561 * (var_x344 - var_x261 * (var_x337 + var_x338 + var_x342 - var_x341)) + 3.4002179850240029e-7 * var_x557 * var_x571) - var_x563 * var_x573) : (var_x568 * var_x573))));
        rJacobian[15][9] = 0.0;
        rJacobian[15][10] = 0.0;
        rJacobian[15][11] = 0.0;
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (((var_x567) ? (var_x560 * (-1 + 1.5 * var_x553)) : (-var_x560))));
        rJacobian[15][16] = 0.0;
        rJacobian[16][0] = -(mDt * (((var_x584) ? (var_x580 * (var_x35 * var_x577 - 0.0034379981848576026 * var_x555 * var_x578) + var_x582 * var_x583) : (-var_x583 * var_x585))));
        rJacobian[16][1] = 0.0;
        rJacobian[16][2] = 0.0;
        rJacobian[16][3] = -(mDt * (((var_x584) ? (-var_x581 * var_x586 + 121.33333333333333 * var_x45 * var_x579 / (pow(var_x574, 2) * pow(var_chaste_interface__intracellular_ions__cacsr, 9))) : (var_x586 * var_chaste_interface__ryr__Jrel2))));
        rJacobian[16][4] = -(mDt * (((var_x584) ? (15.166666666666666 * var_x43 * var_x587) : (0))));
        rJacobian[16][5] = 0.0;
        rJacobian[16][6] = -(mDt * (((var_x584) ? (0.0002831111111111111 * var_x587) : (0))));
        rJacobian[16][7] = -(mDt * (((var_x584) ? (0.31597222222222221 * var_x587) : (0))));
        rJacobian[16][8] = -(mDt * (((var_x584) ? (var_x580 * (var_x50 * var_x577 + 2.0627989109145618e-6 * var_x571 * var_x578) - var_x582 * var_x588) : (var_x585 * var_x588))));
        rJacobian[16][9] = 0.0;
        rJacobian[16][10] = 0.0;
        rJacobian[16][11] = 0.0;
        rJacobian[16][12] = 0.0;
        ...
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (((var_x584) ? (var_x580 * (-1 + 1.2133333333333334 * var_x576)) : (-var_x580))));
    }
