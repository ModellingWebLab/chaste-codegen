...
// LCOV_EXCL_STOP
        ...
        const double var_x46 = var_x22 * var_x41 / (_lt_0_row[3]);
        ...
        rJacobian[4][4] = 1.0 - (mDt * (-7.0 + var_x10 + var_x11 - 4.3596094751625959e-6 * var_x33 - 0.00031591373008424612 * ((var_x23 < 1.3356880329551402e-6) ? (var_x21 + (18716945.911788113 - 374338.90823576227 * var_chaste_interface__membrane__V) * (-var_x21 - var_x20 / (1.0 - exp(9.9999999997780743e-8)))) : (0.14973556329098189 * var_x19 * var_x22 / (1.0 - exp(3.7433890822745473 - var_x24)))) - 0.00063182746016849224 * var_x35 - 1.0549054718227806e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i + (0.00040000000000000002 * var_x28 - 0.00040000000000000002 * var_x26 - 7.1999999999999991e-9 * var_x29) * mParameters[3]));
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_f_gate__beta_f = 50.0 / (_lt_0_row[10]);
