...
std::shared_ptr<Cellnoble_model_1991FromCellMLBackwardEuler_LookupTables> Cellnoble_model_1991FromCellMLBackwardEuler_LookupTables::mpInstance;
    ...
    double Cellnoble_model_1991FromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_x40 = var_x30 * exp(1.8716945411372736) / (_lt_0_row[3]);
        ...
        rJacobian[4][4] = 1.0 - (mDt * (-7.0 + var_x10 + var_x11 - 4.3596094751625959e-6 * var_x26 - 0.00063182746016849224 * var_x28 - 1.0549054718227806e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i + (0.00040000000000000002 * var_x21 - 0.00040000000000000002 * var_x19 - 7.1999999999999991e-9 * var_x22) * mParameters[3] - 4.7303520325519803e-5 * var_x30 * exp(3.7433890822745473) / (1.0 - exp(3.7433890822745473 - var_x29))));
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_d_gate__alpha_d = 30.0 * (19.0 + var_chaste_interface__membrane__V) / (_lt_0_row[7]);
        const double var_L_type_Ca_channel_d_gate__beta_d = 12.0 * (19.0 + var_chaste_interface__membrane__V) / (_lt_0_row[8]);
        const double var_L_type_Ca_channel_f_gate__alpha_f = 6.25 * (34.0 + var_chaste_interface__membrane__V) / (_lt_0_row[10]);
        ...
        const double var_transient_outward_current_s_gate__alpha_s = 0.033000000000000002 * _lt_0_row[18];
        const double var_transient_outward_current_s_gate__beta_s = 33.0 / (_lt_0_row[19]);
