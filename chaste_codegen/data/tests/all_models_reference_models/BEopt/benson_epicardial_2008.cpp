...
// LCOV_EXCL_STOP
        ...
        const double var_x23 = pow(mParameters[3], 3);
        const double var_x24 = 1.5 * var_x23;
        const double var_x25 = -1004882.8125 - var_x24 - 775361.25000000012 * mParameters[1];
        const double var_x26 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x27 = (1.0 + 416.66666666666669 * var_chaste_interface__Ca__Ca_i) * mParameters[1];
        const double var_x28 = var_x26 * mParameters[1];
        const double var_x29 = var_x23 * (1.0 + 0.00053738391835633597 * var_x26);
        const double var_x30 = _lt_0_row[1];
        const double var_x31 = 1 / (1.0 + 0.27000000000000002 * var_x30);
        const double var_x32 = 1.0 + 6.9444444444444451e-9 / pow(var_chaste_interface__Ca__Ca_i, 2);
        const double var_x33 = 1 / var_x32;
        const double var_x34 = _lt_0_row[0];
        const double var_x35 = var_x24 * var_chaste_interface__Ca__Ca_i;
        const double var_x36 = var_x28 * var_x34 - var_x30 * var_x35;
        const double var_x37 = var_x31 * var_x33 * var_x36 * mParameters[9];
        const double var_x38 = var_x37 / pow((1.2936831875607387e-6 * var_x26 + 0.0018518248862973764 * var_x27 + 9.9514091350826051e-7 * var_x28 + 3.5825072886297377e-9 * var_x29 + 1.4927113702623908e-6 * var_x23 * var_chaste_interface__Ca__Ca_i + var_chaste_interface__Ca__Ca_i), 2);
        const double var_x39 = 6.0924326210094507e-17 * var_x38;
        const double var_x40 = 1 / (var_x28 + var_x35 + 1004882.8125 * var_chaste_interface__Ca__Ca_i + 0.0035999999999999999 * var_x29 + 1.3 * var_x26 + 1860.8670000000004 * var_x27);
        const double var_x41 = var_x31 * var_x40 * mParameters[9];
        const double var_x42 = var_x36 * var_x41 / (pow(var_x32, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
        const double var_x43 = var_x33 * var_x41;
        const double var_x44 = var_x23 * var_x30 * var_x43;
        const double var_x45 = 0.0023800000000000002 + var_chaste_interface__Ca__Ca_i;
        const double var_x46 = 1.0 + 0.00011900000000000002 / pow(var_x45, 2) + 3.5000000000000004e-5 * var_x2;
        const double var_x47 = 1 / var_x46;
        const double var_x48 = var_x47;
        const double var_x49 = -0.34100000000000003 * mParameters[1];
        const double var_x50 = pow(var_chaste_interface__Ca__Ca_ss, (-2));
        const double var_x51 = var_x3 * var_x50 / pow(var_x5, 2);
        const double var_x52 = var_x10 * var_x51;
        const double var_x53 = var_x8 / pow(var_x9, 2);
        const double var_x54 = var_x51 * var_x53;
        const double var_x55 = 5.6250000000000005e-5 * var_x52 - 5.6250000000000005e-5 * var_x54;
        const double var_x56 = var_x13 * var_x17;
        const double var_x57 = 1.2750000000000002e-8 * var_x52 - 1.2750000000000002e-8 * var_x54;
        const double var_x58 = 1 - var_x7;
        const double var_x59 = var_x10 * var_x58;
        const double var_x60 = var_x53 * (-1 + var_x7);
        const double var_x61 = 0.75 * var_x59 + 0.75 * var_x60;
        const double var_x62 = 0.00017000000000000001 * var_x59 + 0.00017000000000000001 * var_x60;
        const double var_x63 = pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x64 = var_x63 * mParameters[1];
        const double var_x65 = -3 * var_x64 - 3.9000000000000004 * var_x63 - 5.8037463182484285e-6 * var_x23 * var_x63;
        const double var_x66 = var_x34 * var_x43 * var_x64;
        const double var_x67 = exp(-1.1230765052339999 + var_x20);
        const double var_x68 = var_x49 + var_x67 * var_chaste_interface__Ca__Ca_ss;
        const double var_x69 = -1.0 + var_x67;
        const double var_x70 = (-15.0 + var_chaste_interface__cell__V) * mParameters[4] / var_x69;
        const double var_x71 = var_x68 * var_x70;
        const double var_x72 = exp(2.6000000000000001 + 2889.6009762000663 * var_x71);
        const double var_x73 = 1.0 + var_x72;
        const double var_x74 = 1 / var_x73;
        const double var_x75 = var_x74 * mParameters[0] * var_chaste_interface__Irel__ro;
        const double var_x76 = var_x75 * var_chaste_interface__Irel__ri;
        const double var_x77 = var_x76;
        const double var_x78 = 0.80000000000000004 + var_chaste_interface__Ca__Ca_jsr;
        const double var_x79 = pow(var_x78, (-2));
        const double var_x80 = 1 / (1.0 + 8.0 * var_x79);
        const double var_x81 = var_x80;
        const double var_x82 = -var_chaste_interface__Ca__Ca_ss + var_chaste_interface__Ca__Ca_jsr;
        const double var_x83 = mParameters[0] * var_chaste_interface__Irel__ri;
        const double var_x84 = var_x67 * var_x70;
        const double var_x85 = var_x72 * var_x82 * var_x83 * var_x84 * var_chaste_interface__Irel__ro / pow(var_x73, 2);
        const double var_x86 = var_x81 * var_x82;
        const double var_x87 = var_x74 * var_x83;
        const double var_x88 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x89 = var_x18 * var_x88;
        const double var_x90 = var_x13 * var_x88;
        const double var_x91 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss;
        const double var_x92 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x93 = 1.0 + 0.0097788000000000007 / pow(var_x91, 2) + 4.0890000000000003e-5 / pow(var_x92, 2);
        const double var_x94 = 1 / var_x93;
        const double var_x95 = 0.23999999999999996 * var_x76;
        const double var_x96 = pow(var_chaste_interface__ICaL__d, var_chaste_interface__ICaL__dp);
        const double var_x97 = var_x96 * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca * var_chaste_interface__ICaL__fca2;
        const double var_x98 = var_x84 * var_x97;
        const double var_x99 = var_x71 * var_x97;
        const double var_x100 = var_x71 * var_x96 * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2;
        const double var_x101 = var_x100 * var_chaste_interface__ICaL__fca2;
        const double var_x102 = 15.110483888602907 * var_x94;
        const double var_x103 = var_x100 * var_chaste_interface__ICaL__fca;
        const double var_x104 = 0.23999999999999996 * var_x82 * var_x94;
        const double var_x105 = 1 / var_chaste_interface__Cl__Cl_i;
        const double var_x106 = 0.0374358835078 * var_chaste_interface__cell__V;
        const double var_x107 = exp(var_x106);
        const double var_x108 = 8.8885199344722979e-8 * var_chaste_interface__cell__V / (1.0 - var_x107);
        const double var_x109 = log(100.0 * var_x105);
        const double var_x110 = 1 / var_chaste_interface__K__K_i;
        const double var_x111 = log(var_x110 * mParameters[2]);
        const double var_x112 = 26.712338705500134 * var_x111;
        const double var_x113 = var_x112 + 26.712338705500134 * var_x109;
        const double var_x114 = 0.00018900582374463672 / (87.825100000000006 + var_x113);
        const double var_x115 = 2.4504050574883893e-8 * var_x113 / pow((1 + 0.30415380916731244 * var_x109 + 0.30415380916731244 * var_x111), 2);
        const double var_x116 = var_x105 * var_x115 - var_x105 * var_x114;
        const double var_x117 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x118 = var_x109 + log(var_x117 * mParameters[3]);
        const double var_x119 = pow(var_x118, 4);
        const double var_x120 = 2.8839711417381356e-9 * pow(var_x118, 7) / pow((1 + 0.008558014922736952 * var_x119), 2);
        const double var_x121 = 20.048989239405216 * pow(var_x118, 3) / (59494197.640692554 + 509152.23122530844 * var_x119);
        const double var_x122 = var_x105 * var_x120 - var_x105 * var_x121;
        const double var_x123 = var_x110 * var_x115 - var_x110 * var_x114;
        const double var_x124 = var_x117 * var_x120 - var_x117 * var_x121;
        const double var_x125 = 1 / (1.0 + 333.33333333333331 * var_chaste_interface__Ca__Ca_ss);
        const double var_x126 = 10.0 * var_x11;
        const double var_x127 = 1 / (0.5 + var_x126 + var_x125);
        const double var_x128 = pow((0.0030000000000000001 + var_chaste_interface__Ca__Ca_ss), (-2));
        const double var_x129 = -var_x99;
        const double var_x130 = 1.0382056293271026e-6 / pow((3.4606854310903424e-6 + var_x129), 2);
        const double var_x131 = 0.00075000000000000002 * var_x54 - 0.00075000000000000002 * var_x52;
        const double var_x132 = 0.01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x125 + 0.29999999999999999 / (1.0 - 288960.09762000659 * var_x99)) / pow((0.050000000000000003 + var_x11 + 0.10000000000000001 * var_x125), 2);
        const double var_x133 = -10.0 * var_x59 - 10.0 * var_x60;
        const double var_x134 = exp(-4.375 - 361200.12202500831 * var_x99);
        const double var_x135 = 1.0 + var_x134;
        const double var_x136 = 1 / var_x135;
        const double var_x137 = 1 / (125.0 + 300.0 * var_x136);
        const double var_x138 = 6.9213708621806839e-7 / pow((6.9213708621806839e-7 + var_x129), 2);
        const double var_x139 = var_x137 * var_x138;
        const double var_x140 = 1204.0004067500277 * var_x134 * (-var_chaste_interface__ICaL__fca2 + 1 / (1.0 - 1444800.4881000333 * var_x99)) / (pow(var_x135, 2) * pow((0.41666666666666669 + var_x136), 2));
        const double var_x141 = 0.0025000000000000005 * var_x6;
        const double var_x142 = exp(3.3333333333333335 + 963200.32540002221 * var_x99);
        const double var_x143 = 1.0 + var_x142;
        const double var_x144 = 1 / var_x143;
        const double var_x145 = exp(-15.0 + 5000.0 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_x144);
        const double var_x146 = 1.0 + var_x145;
        const double var_x147 = 1 / var_x146;
        const double var_x148 = var_x142 / pow(var_x143, 2);
        const double var_x149 = var_x148 * var_x98;
        const double var_x150 = 350.0 - var_x126;
        const double var_x151 = var_x145 * var_x150 / pow(var_x146, 2);
        const double var_x152 = var_x147 * var_x150;
        const double var_x153 = exp(-16.0 + 80.0 * var_x144 + 40000.0 * var_chaste_interface__Ca__Ca_ss);
        const double var_x154 = 1.0 + var_x153;
        const double var_x155 = (-var_chaste_interface__Irel__ri + 1 / var_x154) / pow((0.29999999999999999 + var_x11 + 0.10000000000000001 * var_x152), 2);
        const double var_x156 = 0.01 * var_x155;
        const double var_x157 = 1 / (3.0 + var_x126 + var_x152);
        const double var_x158 = var_x153 * var_x157 / pow(var_x154, 2);
        const double var_x159 = var_x101 * var_x148;
        const double var_x160 = 77056026.032001764 * var_x158;
        const double var_x161 = 144480.04881000333 * var_x151 * var_x155;
        const double var_x162 = var_x103 * var_x148;
        const double var_x163 = pow(var_chaste_interface__ICaL__fca, (-2));
        const double var_x164 = pow((-1 + 0.066666666666666666 * var_chaste_interface__cell__V), (-2));
        const double var_x165 = pow(var_x69, 2);
        const double var_x166 = pow(var_x68, (-2));
        const double var_x167 = pow(var_chaste_interface__ICaL__d, (-2 * var_chaste_interface__ICaL__dp));
        const double var_x168 = pow(var_chaste_interface__ICaL__f, (-2));
        const double var_x169 = pow(var_chaste_interface__ICaL__f2, (-2));
        const double var_x170 = pow(var_chaste_interface__ICaL__fca2, (-2));
        const double var_x171 = pow(mParameters[4], (-2));
        const double var_x172 = var_x164 * var_x165 * var_x166 * var_x167 * var_x168 * var_x169 * var_x170 * var_x171;
        const double var_x173 = 1.0 + 2.1291277605263905e-11 * var_x163 * var_x172;
        const double var_x174 = 1 / var_x173;
        const double var_x175 = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999);
        const double var_x176 = 0.0028 + var_chaste_interface__Ca__Ca_ss;
        const double var_x177 = 1 / var_x176;
        const double var_x178 = pow((var_x177 * var_chaste_interface__Ca__Ca_ss), 1.8999999999999999);
        const double var_x179 = 1 / (var_x175 + 1644.6531773416521 * var_x178);
        const double var_x180 = var_x174 / pow((var_x178 + 0.00060803092942449902 * var_x175), 2);
        const double var_x181 = 1.4194185070175937e-11 * var_x175 * var_x179 / pow(var_x173, 2);
        const double var_x182 = var_x163 * var_x164 * var_x165 * var_x167 * var_x168 * var_x169 * var_x171 * var_x181;
        const double var_x183 = 1 / var_chaste_interface__Ca__Ca_i;
        const double var_x184 = pow(var_x183, 1.3999999999999999);
        const double var_x185 = 1.0 + 6.4818210260626455e-7 * var_x184;
        const double var_x186 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
        const double var_x187 = mParameters[8] * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2;
        const double var_x188 = var_x186 * var_x187 * (-6.1520742882368733e-5 - 3.6912445729421236e-5 / var_x185);
        const double var_x189 = sqrt(mParameters[2]);
        const double var_x190 = var_x110 * var_x189;
        const double var_x191 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 6.370892781261781 * var_x111);
        const double var_x192 = 1.0 + var_x191;
        const double var_x193 = 1 / var_x192;
        const double var_x194 = exp(-2.4444678999999998 + 13.738155796238718 * var_x111 - 0.51429999999999998 * var_chaste_interface__cell__V);
        const double var_x195 = 1.0 + var_x194;
        const double var_x196 = 1 / var_x195;
        const double var_x197 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * var_x111);
        const double var_x198 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 2.1455350448257708 * var_x111);
        const double var_x199 = var_x197 + 0.49124000000000001 * var_x198;
        const double var_x200 = var_x196 * var_x199;
        const double var_x201 = 1 / (var_x200 + 1.02 * var_x193);
        const double var_x202 = var_x193 * mParameters[6];
        const double var_x203 = var_x110 * var_x191 / pow(var_x192, 2);
        const double var_x204 = var_x189 * (-var_x112 + var_chaste_interface__cell__V);
        const double var_x205 = mParameters[2] / (var_x26 * (1.5 + mParameters[2]) * pow((0.01 + 1 / var_x63), 2) * (1.0 + _lt_0_row[4] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[3])) * exp(-var_x106)));
        const double var_x206 = 1.827729786302835e-16 * var_x38;
        
        
        rJacobian[0][0] = 1.0 - (mDt * (var_x48 * (-0.14705882352941174 + var_x19 - var_x1 - var_x16 + 8.544547622551213e-13 * var_x42 - 9.2281114323553099e-5 * var_x44 + var_x25 * var_x39 - var_x21 * var_x22 + 1.768721357868101e-6 * var_x2 * var_chaste_interface__Ca__Ca_i) + (0.00023800000000000004 / pow(var_x45, 3) + 7.0000000000000007e-5 / pow(var_x0, 3)) * (0.14705882352941174 * var_chaste_interface__Ca__Ca_ss + 2.3676470588235295e-5 * var_chaste_interface__Ca__Ca_nsr - 0.14705882352941174 * var_chaste_interface__Ca__Ca_i - var_x1 * var_chaste_interface__Ca__Ca_i - var_x16 * var_chaste_interface__Ca__Ca_i - var_x22 * (var_x49 + var_x21 * var_chaste_interface__Ca__Ca_i) + 6.1520742882368733e-5 * var_x37 * var_x40) / pow(var_x46, 2)));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = -(mDt * (2.3676470588235295e-5 * var_x47));
        rJacobian[0][3] = -(mDt * (var_x48 * (0.14705882352941174 - var_x19 * var_x57 - var_x55 * var_x56)));
        rJacobian[0][4] = 0.0;
        rJacobian[0][5] = 0.0;
        rJacobian[0][6] = 0.0;
        rJacobian[0][7] = -(mDt * (var_x48 * (-var_x19 * var_x62 - var_x56 * var_x61)));
        rJacobian[0][8] = 0.0;
        rJacobian[0][9] = 0.0;
        rJacobian[0][10] = 0.0;
        rJacobian[0][11] = 0.0;
        rJacobian[0][12] = -(mDt * (var_x48 * (0.0001845622286471062 * var_x66 + var_x39 * var_x65)));
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (var_x81 * (-0.0083333333333333332 - var_x77) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0.0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x77 * var_x82) / (pow(var_x78, 3) * pow((0.125 + var_x79), 2))));
        rJacobian[1][2] = -(mDt * (0.0083333333333333332 * var_x80));
        rJacobian[1][3] = -(mDt * (var_x81 * (var_x77 + 2889.6009762000663 * var_x85)));
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[1][7] = 0.0;
        rJacobian[1][8] = -(mDt * (-var_x75 * var_x86));
        rJacobian[1][9] = -(mDt * (-var_x86 * var_x87));
        rJacobian[1][10] = 0.0;
        rJacobian[1][11] = 0.0;
        rJacobian[1][12] = 0.0;
        rJacobian[2][0] = -(mDt * (-var_x89 + 0.0043750000000000004 * var_x15));
        rJacobian[2][1] = -(mDt * (0.00072463768115942019));
        rJacobian[2][2] = 1.0 - (mDt * (-0.0010163043478260869));
        rJacobian[2][3] = -(mDt * (var_x55 * var_x90 + var_x57 * var_x89));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = -(mDt * (var_x61 * var_x90 + var_x62 * var_x89));
        rJacobian[2][8] = 0.0;
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = 0.0;
        rJacobian[2][12] = 0.0;
        rJacobian[3][0] = -(mDt * (5.0 * var_x94));
        rJacobian[3][1] = -(mDt * (var_x94 * var_x95));
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (var_x94 * (-5.0 - var_x95 - 15.110483888602907 * var_x98 - 693.50423428801582 * var_x85) + (0.019557600000000001 / pow(var_x91, 3) + 8.1780000000000006e-5 / pow(var_x92, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 15.110483888602907 * var_x99 + var_x82 * var_x95) / pow(var_x93, 2)));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (-var_x101 * var_x102));
        rJacobian[3][6] = -(mDt * (-var_x102 * var_x103));
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = -(mDt * (var_x104 * var_x75));
        rJacobian[3][9] = -(mDt * (var_x104 * var_x87));
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = 0.0;
        rJacobian[3][12] = 0.0;
        rJacobian[4][0] = 0.0;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (var_x116 + var_x122 - 3.6975665728975948e-7 * var_x105 + var_x108 * var_chaste_interface__Ito2__AA));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = -(mDt * (var_x108 * (-100.0 * var_x107 + var_chaste_interface__Cl__Cl_i)));
        rJacobian[4][11] = -(mDt * (var_x123));
        rJacobian[4][12] = -(mDt * (var_x124));
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (var_x127 * (-0.0016500000000000002 * var_x128 + var_x130 * var_x98) + var_x132 * (var_x131 + 0.0030000000000000001 * var_x128)));
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (var_x127 * (-1 + var_x101 * var_x130)));
        rJacobian[5][6] = -(mDt * (var_x103 * var_x127 * var_x130));
        rJacobian[5][7] = -(mDt * (var_x132 * var_x133));
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = 0.0;
        ...
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = -(mDt * (var_x139 * var_x98 - var_x140 * var_x98));
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (var_x101 * var_x139 - var_x101 * var_x140));
        rJacobian[6][6] = 1.0 - (mDt * (var_x137 * (-1 + var_x103 * var_x138) - var_x103 * var_x140));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = -(mDt * (3.7500000000000005e-6 * var_x51 * var_x8 + 1.8750000000000003e-7 * var_x50 * pow(var_x3, 2) / pow(var_x5, 3)));
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-0.00068000000000000005 - var_x141 * var_x8 + var_x141 * var_x3 * var_x58));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        ...
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = -(mDt * (var_x156 * (var_x131 + var_x151 * (5000.0 - 14448004.881000333 * var_x149) - var_x131 * var_x147) - var_x158 * (40000.0 - 77056026.032001764 * var_x149)));
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = -(mDt * (var_x159 * var_x160 - var_x159 * var_x161));
        rJacobian[8][6] = -(mDt * (var_x160 * var_x162 - var_x161 * var_x162));
        rJacobian[8][7] = -(mDt * (var_x156 * (var_x133 - var_x133 * var_x147)));
        rJacobian[8][8] = 1.0 - (mDt * (-var_x157));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = -(mDt * (-2.3414435371998602e-7 * var_x180 * pow(var_chaste_interface__Ca__Ca_jsr, 2.7999999999999998) + 0.6333333333333333 * var_x174 * var_x179 * pow(var_chaste_interface__Ca__Ca_jsr, 0.89999999999999991)));
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = -(mDt * (var_x170 * var_x182 * var_x67 / pow(var_x68, 3) - 0.00020267697647483301 * var_x175 * var_x176 * var_x178 * var_x180 * var_x4 * (1.8999999999999999 * var_x177 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x176, 2))));
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = -(mDt * (var_x172 * var_x181 / pow(var_chaste_interface__ICaL__fca, 3)));
        rJacobian[9][6] = -(mDt * (var_x166 * var_x182 / pow(var_chaste_interface__ICaL__fca2, 3)));
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        ...
        rJacobian[10][1] = 0.0;
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = -(mDt * (0.1502 * var_x50 / pow((1.0 + 0.1502 * var_x4), 2)));
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = 0.0;
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        ...
        rJacobian[10][11] = 0.0;
        rJacobian[10][12] = 0.0;
        rJacobian[11][0] = -(mDt * (-3.3496381359330236e-11 * var_x183 * var_x184 * var_x187 * (-26.712338705500134 * log(var_x186 * (0.018329999999999999 * mParameters[3] + mParameters[2])) + var_chaste_interface__cell__V) / pow(var_x185, 2)));
        rJacobian[11][1] = 0.0;
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = -(mDt * (var_x116));
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x123 + 26.712338705500134 * var_x188 - 4.535681662754383e-6 * var_x110 / (_lt_0_row[11]) - 0.00072133461893788295 * var_x190 * var_x201 * var_x202 + 0.00017203830661668509 * var_x201 * var_x203 * var_x204 * mParameters[6] - 0.00070719080288027735 * var_x190 * mParameters[7] * var_chaste_interface__IKr__xr / (_lt_0_row[12]) - 2.595520834746433e-5 * var_x202 * var_x204 * (6.4983106368870169 * var_x203 - var_x196 * (1.6494869150646332 * var_x110 * var_x197 + 1.0539726354202117 * var_x110 * var_x198) - 13.738155796238718 * var_x110 * var_x194 * var_x199 / pow(var_x195, 2)) / pow((var_x193 + 0.98039215686274506 * var_x200), 2) - 0.0016433629212878199 * var_x110 * pow(var_chaste_interface__Ito__ydv, 3) * mParameters[10] * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv * _lt_0_row[13]));
        rJacobian[11][12] = -(mDt * (1.5226383863386261e-6 * var_x205 + 0.48963716847181743 * var_x188));
        rJacobian[12][0] = -(mDt * (0.00027684334297065928 * var_x44 - 2.563364286765364e-12 * var_x42 - var_x206 * var_x25));
        rJacobian[12][1] = 0.0;
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (var_x122));
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = 0.0;
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x124 - 0.00055368668594131857 * var_x66 - 2.283957579507939e-6 * var_x205 - var_x206 * var_x65 - 1.068185898837083e-5 * var_x117 * pow(var_chaste_interface__INal__mL, 3) * var_chaste_interface__INal__hL - 0.0016433629212878199 * var_x117 * pow(var_chaste_interface__INa__m, 3) * mParameters[5] * var_chaste_interface__INa__H * var_chaste_interface__INa__J));
    }
...
// LCOV_EXCL_STOP
        ...
        const double var_INa__am = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__cell__V) / (_lt_0_row[30]);
        const double var_INa__bh = _lt_0_row[26];
        const double var_INa__bj = _lt_0_row[28];
        const double var_INa__bm = 0.080000000000000002 * _lt_0_row[29];
        const double var_INal__amL = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__cell__V) / (_lt_0_row[30]);
        const double var_INal__bmL = 0.080000000000000002 * _lt_0_row[29];
