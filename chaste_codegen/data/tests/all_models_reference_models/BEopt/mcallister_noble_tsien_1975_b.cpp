...
class Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables(const Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables&);
    Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables& operator= (const Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables&);
    Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables()
    {
        ...
        Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables> Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables::mpInstance;


    Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler::Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler::~Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    double Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = 0.0085000000000000006 * _lt_0_row[5];
        const double var_fast_sodium_current_h_gate__beta_h = 2.5 / (_lt_0_row[6]);
        const double var_fast_sodium_current_m_gate__alpha_m = (47.0 + var_chaste_interface__membrane__V) / (_lt_0_row[8]);
        const double var_fast_sodium_current_m_gate__beta_m = 40.0 * _lt_0_row[7];
        const double var_pacemaker_potassium_current_s_gate__E_s = -52.0;
        const double var_pacemaker_potassium_current_s_gate__alpha_s = 0.001 * (-var_pacemaker_potassium_current_s_gate__E_s + var_chaste_interface__membrane__V) / (1.0 - exp(0.20000000000000001 * var_pacemaker_potassium_current_s_gate__E_s - 0.20000000000000001 * var_chaste_interface__membrane__V));
        const double var_pacemaker_potassium_current_s_gate__beta_s = 5.0000000000000002e-5 * exp(0.067000000000000004 * var_pacemaker_potassium_current_s_gate__E_s - 0.067000000000000004 * var_chaste_interface__membrane__V);
        const double var_plateau_potassium_current1_x1_gate__alpha_x1 = 0.00050000000000000001 * _lt_0_row[12] / (_lt_0_row[11]);
        const double var_plateau_potassium_current1_x1_gate__beta_x1 = 0.0012999999999999999 * _lt_0_row[14] / (_lt_0_row[13]);
        const double var_plateau_potassium_current2_x2_gate__alpha_x2 = 0.000127 / (_lt_0_row[15]);
        const double var_plateau_potassium_current2_x2_gate__beta_x2 = 0.00029999999999999997 * _lt_0_row[14] / (_lt_0_row[13]);
        const double var_secondary_inward_current_d_gate__alpha_d = 0.002 * (40.0 + var_chaste_interface__membrane__V) / (_lt_0_row[17]);
        const double var_secondary_inward_current_d_gate__beta_d = 0.02 * _lt_0_row[16];
        const double var_secondary_inward_current_f_gate__alpha_f = 0.00098700000000000003 * _lt_0_row[18];
        const double var_secondary_inward_current_f_gate__beta_f = 0.02 / (_lt_0_row[19]);
        const double var_transient_chloride_current_q_gate__alpha_q = 0.0080000000000000002 * var_chaste_interface__membrane__V / (_lt_0_row[21]);
        const double var_transient_chloride_current_q_gate__beta_q = 0.080000000000000002 * _lt_0_row[20];
        const double var_transient_chloride_current_r_gate__alpha_r = 3.3000000000000003e-5 * _lt_0_row[22];
        const double var_transient_chloride_current_r_gate__beta_r = 0.033000000000000002 / (_lt_0_row[23]);
        ...
        rY[5] = (var_chaste_interface__pacemaker_potassium_current_s_gate__s + ((var_pacemaker_potassium_current_s_gate__alpha_s) * mDt)) / (1.0 - ((-var_pacemaker_potassium_current_s_gate__alpha_s - var_pacemaker_potassium_current_s_gate__beta_s) * mDt));
        rY[6] = (var_chaste_interface__plateau_potassium_current1_x1_gate__x1 + ((var_plateau_potassium_current1_x1_gate__alpha_x1) * mDt)) / (1.0 - ((-var_plateau_potassium_current1_x1_gate__alpha_x1 - var_plateau_potassium_current1_x1_gate__beta_x1) * mDt));
        rY[7] = (var_chaste_interface__plateau_potassium_current2_x2_gate__x2 + ((var_plateau_potassium_current2_x2_gate__alpha_x2) * mDt)) / (1.0 - ((-var_plateau_potassium_current2_x2_gate__alpha_x2 - var_plateau_potassium_current2_x2_gate__beta_x2) * mDt));
        rY[3] = (var_chaste_interface__secondary_inward_current_d_gate__d + ((var_secondary_inward_current_d_gate__alpha_d) * mDt)) / (1.0 - ((-var_secondary_inward_current_d_gate__alpha_d - var_secondary_inward_current_d_gate__beta_d) * mDt));
        rY[4] = (var_chaste_interface__secondary_inward_current_f_gate__f + ((var_secondary_inward_current_f_gate__alpha_f) * mDt)) / (1.0 - ((-var_secondary_inward_current_f_gate__alpha_f - var_secondary_inward_current_f_gate__beta_f) * mDt));
        rY[8] = (var_chaste_interface__transient_chloride_current_q_gate__q + ((var_transient_chloride_current_q_gate__alpha_q) * mDt)) / (1.0 - ((-var_transient_chloride_current_q_gate__alpha_q - var_transient_chloride_current_q_gate__beta_q) * mDt));
        rY[9] = (var_chaste_interface__transient_chloride_current_r_gate__r + ((var_transient_chloride_current_r_gate__alpha_r) * mDt)) / (1.0 - ((-var_transient_chloride_current_r_gate__alpha_r - var_transient_chloride_current_r_gate__beta_r) * mDt));
        
    }

    std::vector<double> Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellmcallister_noble_tsien_1975_bFromCellMLBackwardEuler)
