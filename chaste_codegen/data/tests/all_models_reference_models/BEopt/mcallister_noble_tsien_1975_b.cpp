...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = 0.0085000000000000006 * _lt_0_row[6];
        const double var_fast_sodium_current_h_gate__beta_h = 2.5 / (_lt_0_row[7]);
        const double var_fast_sodium_current_m_gate__alpha_m = _lt_0_row[8];
        const double var_fast_sodium_current_m_gate__beta_m = 40.0 * _lt_0_row[9];
        const double var_pacemaker_potassium_current_s_gate__E_s = -52.0;
        const double var_pacemaker_potassium_current_s_gate__alpha_s = _lt_0_row[10];
        ...
        const double var_plateau_potassium_current1_x1_gate__alpha_x1 = 0.00050000000000000001 * _lt_0_row[13] / (_lt_0_row[12]);
        const double var_plateau_potassium_current1_x1_gate__beta_x1 = 0.0012999999999999999 * _lt_0_row[15] / (_lt_0_row[14]);
        const double var_plateau_potassium_current2_x2_gate__alpha_x2 = 0.000127 / (_lt_0_row[16]);
        const double var_plateau_potassium_current2_x2_gate__beta_x2 = 0.00029999999999999997 * _lt_0_row[15] / (_lt_0_row[14]);
        const double var_secondary_inward_current_d_gate__alpha_d = _lt_0_row[17];
        const double var_secondary_inward_current_d_gate__beta_d = 0.02 * _lt_0_row[18];
        const double var_secondary_inward_current_f_gate__alpha_f = 0.00098700000000000003 * _lt_0_row[19];
        const double var_secondary_inward_current_f_gate__beta_f = 0.02 / (_lt_0_row[20]);
        const double var_transient_chloride_current_q_gate__alpha_q = _lt_0_row[21];
        const double var_transient_chloride_current_q_gate__beta_q = 0.080000000000000002 * _lt_0_row[22];
        const double var_transient_chloride_current_r_gate__alpha_r = 3.3000000000000003e-5 * _lt_0_row[23];
        const double var_transient_chloride_current_r_gate__beta_r = 0.033000000000000002 / (_lt_0_row[24]);
