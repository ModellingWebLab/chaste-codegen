...
class Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables()
    {
...
protected:
    Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables(const Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables&);
    Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables& operator= (const Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables&);
    Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables()
    {
        ...
        Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables> Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables::mpInstance;

    double Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt::Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt>::Instance();
        Init();
    ...
    Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt::~Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt()
    {
    }

    AbstractLookupTableCollection* Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt::GetLookupTableCollection()
    {
        return Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables::Instance();
    }
    
    double Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[6], double rResidual[6])
    {
...
// LCOV_EXCL_STOP
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -86.2
...
// LCOV_EXCL_STOP
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        CardiacNewtonSolver<6,Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt>* _p_solver = CardiacNewtonSolver<6,Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt>::Instance();
    ...
    std::vector<double> Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2004_endoFromCellMLBackwardEulerOpt>::Initialise(void)
{
