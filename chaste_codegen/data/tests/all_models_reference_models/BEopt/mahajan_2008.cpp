...
class Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables()
    {
...
protected:
    Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables(const Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables&);
    Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables& operator= (const Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables&);
    Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables()
    {
        ...
        Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables> Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellmahajan_2008FromCellMLBackwardEulerOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellmahajan_2008FromCellMLBackwardEulerOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellmahajan_2008FromCellMLBackwardEulerOpt::Cellmahajan_2008FromCellMLBackwardEulerOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmahajan_2008FromCellMLBackwardEulerOpt>::Instance();
        Init();
    ...
    Cellmahajan_2008FromCellMLBackwardEulerOpt::~Cellmahajan_2008FromCellMLBackwardEulerOpt()
    {
    }

    AbstractLookupTableCollection* Cellmahajan_2008FromCellMLBackwardEulerOpt::GetLookupTableCollection()
    {
        return Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables::Instance();
    }
    
    double Cellmahajan_2008FromCellMLBackwardEulerOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellmahajan_2008FromCellMLBackwardEulerOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellmahajan_2008FromCellMLBackwardEulerOpt::ComputeResidual(double var_chaste_interface__Environment__time, const double rCurrentGuess[15], double rResidual[15])
    {
...
// LCOV_EXCL_STOP
    ...
    void Cellmahajan_2008FromCellMLBackwardEulerOpt::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[15], double rJacobian[15][15])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: mV; Initial value: -87.169816169406
...
// LCOV_EXCL_STOP
        ...
        const double var_x14 = (var_chaste_interface__Irel__Ca_JSR > 50.0) && (var_chaste_interface__Irel__Ca_JSR < 90.0);
        const double var_x15 = var_chaste_interface__Irel__Ca_JSR >= 90.0;
        const double var_x16 = ((var_x14) ? (-0.55555555555555558 + 0.011111111111111112 * var_chaste_interface__Irel__Ca_JSR) : ((var_x15) ? (-10.855555555555556 + 0.12555555555555556 * var_chaste_interface__Irel__Ca_JSR) : (0)));
        const double var_x17 = _lt_0_row[27];
        const double var_x18 = 26841.799999999999 * var_x17 / (1.0 + var_x17);
        const double var_x19 = 0.075353936071760372 * var_chaste_interface__cell__V;
        const double var_x20 = exp(var_x19);
        const double var_x21 = 0.00010420416882000001 * var_x20;
        const double var_x22 = fabs(var_x19) < 0.001;
        const double var_x23 = var_chaste_interface__cell__V / (-1.0 + var_x20);
        const double var_x24 = ((var_x22) ? (-0.063960518821716009 + var_x21 * var_chaste_interface__Ca__Ca_submem) : (0.0078521942756732046 * var_x23 * (-0.61380000000000001 + 0.001 * var_x20 * var_chaste_interface__Ca__Ca_submem)));
        const double var_x25 = fabs(var_x24);
        const double var_x26 = 1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca;
        const double var_x27 = var_x25 * var_x26;
        const double var_x28 = var_x18 * var_x27;
        const double var_x29 = ((var_x22) ? (var_x21) : (7.8521942756732062e-6 * var_x20 * var_x23));
        const double var_x30 = var_x29 * Signum(var_x24);
        const double var_x31 = 0.011111111111111112 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x32 = ((var_x14) ? (var_x31 * (-50.0 + var_chaste_interface__Irel__Ca_JSR)) : ((var_x15) ? (var_x31 * (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR)) : (0)));
        const double var_x33 = var_x26 * var_x30 * var_x32;
        const double var_x34 = var_x25 * var_x32;
        const double var_x35 = -9000.0 * var_x25 - var_x18 * var_x34;
        const double var_x36 = ((var_x14) ? (var_x31) : ((var_x15) ? (0.12555555555555556 * var_chaste_interface__Ca__Ca_NSR) : (0)));
        const double var_x37 = 0.012999999999999999 + var_chaste_interface__Ca__Ca_i_converted;
        ...
        const double var_x40 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x41 = 1.0 + 0.00054600000000000004 / pow(var_x37, 2) + 2.8200000000000001e-5 / pow(var_x38, 2) + 4.5000000000000001e-6 / pow(var_x39, 2) + 0.00016800000000000002 / pow(var_x40, 2);
        ...
        const double var_x73 = var_x24 * mParameters[3];
        ...
        const double var_x92 = _lt_0_row[9];
        ...
        const double var_x120 = _lt_0_row[25];
        const double var_x121 = 2.5807899999999999 * var_x120 / (1.0 + var_x120);
        const double var_x122 = var_x121 * var_x27;
        const double var_x123 = var_x118 * var_chaste_interface__Irel__xir;
        const double var_x124 = -var_x121 * var_x34;
        const double var_x125 = _lt_0_row[2];
        ...
        rJacobian[0][14] = 0.0;
        rJacobian[1][0] = -(mDt * (var_x16 * var_x28));
        rJacobian[1][1] = 1.0 - (mDt * (-2.0));
        rJacobian[1][2] = 0.0;
        rJacobian[1][3] = -(mDt * (2.0 + var_x18 * var_x33 + var_x30 * (9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca)));
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        ...
        rJacobian[8][14] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = -(mDt * (var_x84 + (0.00063442013684210537 * var_x80 * var_x87 - 2.1032463466666669e-8 * var_x115 * var_x83) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x26 * var_x83));
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = 0.0;
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = 0.0;
        ...
        rJacobian[12][13] = 0.0;
        rJacobian[12][14] = 0.0;
        rJacobian[13][0] = -(mDt * (var_x122 * var_x16 + (var_x118 * var_x7 - var_x119 / var_x0) * var_chaste_interface__Irel__xir));
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = -(mDt * (var_x123 * var_x13));
        rJacobian[13][3] = -(mDt * (var_x121 * var_x33));
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        ...
        rJacobian[13][13] = 1.0 - (mDt * (-0.033333333333333333 - var_x123 + var_x118 * var_x119));
        rJacobian[13][14] = 0.0;
        rJacobian[14][0] = 0.0;
        rJacobian[14][1] = 0.0;
        rJacobian[14][2] = 0.0;
    ...
    void Cellmahajan_2008FromCellMLBackwardEulerOpt::UpdateTransmembranePotential(double var_chaste_interface__Environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    void Cellmahajan_2008FromCellMLBackwardEulerOpt::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        const double var_IKr__xkrinf = _lt_0_row[14];
        ...
        const double var_IKs__tauxs1 = _lt_0_row[16];
        ...
        const double var_INa__ah = _lt_0_row[18];
        const double var_INa__aj = _lt_0_row[20];
        const double var_INa__am = _lt_0_row[22];
        const double var_INa__bh = _lt_0_row[19];
        const double var_INa__bj = _lt_0_row[21];
        const double var_INa__bm = 0.080000000000000002 * _lt_0_row[23];
        ...
        CardiacNewtonSolver<15,Cellmahajan_2008FromCellMLBackwardEulerOpt>* _p_solver = CardiacNewtonSolver<15,Cellmahajan_2008FromCellMLBackwardEulerOpt>::Instance();
    ...
    std::vector<double> Cellmahajan_2008FromCellMLBackwardEulerOpt::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Ca__Ca_i_converted = rY[1];
...
template<>
void OdeSystemInformation<Cellmahajan_2008FromCellMLBackwardEulerOpt>::Initialise(void)
{
