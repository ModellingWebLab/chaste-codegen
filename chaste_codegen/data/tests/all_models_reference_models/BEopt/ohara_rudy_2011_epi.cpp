...
class Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables(const Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables&);
    Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables& operator= (const Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables&);
    Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables()
    {
        ...
        Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables> Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellohara_rudy_2011_epiFromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_2011_epiFromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellohara_rudy_2011_epiFromCellMLBackwardEuler::Cellohara_rudy_2011_epiFromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_2011_epiFromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Cellohara_rudy_2011_epiFromCellMLBackwardEuler::~Cellohara_rudy_2011_epiFromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Cellohara_rudy_2011_epiFromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    double Cellohara_rudy_2011_epiFromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellohara_rudy_2011_epiFromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
    ...
    void Cellohara_rudy_2011_epiFromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rResidual[12])
    {
...
// LCOV_EXCL_STOP
    ...
    void Cellohara_rudy_2011_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -87.0
...
// LCOV_EXCL_STOP
        ...
        const double var_x23 = 1.0 + 0.00015470000000000002 / pow(var_x20, 2) + 3.5000000000000004e-5 * var_x22;
        ...
        const double var_x33 = mParameters[10] / var_x21;
        const double var_x34 = var_chaste_interface__membrane__v / (mParameters[6] * mParameters[19]);
        const double var_x35 = var_x34 * mParameters[5];
        const double var_x36 = exp(0.52239999999999998 * var_x35);
        const double var_x37 = 1 / var_x36;
        const double var_x38 = 1 / (1.0 + 0.011348161597821153 * (1.0 + var_x37) * mParameters[4]);
        const double var_x39 = var_x37 * var_x38;
        const double var_x40 = var_x39 * mParameters[4];
        const double var_x41 = 56.740807989105761 * var_x40;
        const double var_x42 = var_x41 + 60000.0 * var_x38;
        const double var_x43 = 1 / (13.5 + 0.066666666666666666 * (1.0 + 0.20000000000000001 * mParameters[4]) * mParameters[4]);
        const double var_x44 = var_x43 * mParameters[2];
        const double var_x45 = 1500000.0 * var_x44;
        const double var_x46 = pow(mParameters[4], 3);
        const double var_x47 = var_x43 * var_x46;
        const double var_x48 = var_x39 * var_x47;
        const double var_x49 = var_x45 + 9.0785292782569211 * var_x48;
        const double var_x50 = var_x42 * var_x49;
        const double var_x51 = 0.00036716666666666668 * var_x50;
        const double var_x52 = 1.0 + 0.066666666666666666 * (1.0 + 0.20000000000000001 * var_chaste_interface__intracellular_ions__nai) * var_chaste_interface__intracellular_ions__nai;
        const double var_x53 = 1 / var_x52;
        const double var_x54 = 1500000.0 * var_x53;
        const double var_x55 = var_x54 * var_chaste_interface__intracellular_ions__cai;
        const double var_x56 = pow(var_chaste_interface__intracellular_ions__nai, 3);
        const double var_x57 = 0.011348161597821153 + 0.011348161597821153 * var_x36;
        const double var_x58 = 1.0 + var_x57 * var_chaste_interface__intracellular_ions__nai;
        const double var_x59 = 1 / var_x58;
        const double var_x60 = var_x36 * var_x59;
        const double var_x61 = var_x53 * var_x60;
        const double var_x62 = var_x56 * var_x61;
        const double var_x63 = var_x55 + 9.0785292782569211 * var_x62;
        const double var_x64 = 1 / exp(0.16700000000000001 * var_x35);
        const double var_x65 = var_x59 * var_x64;
        const double var_x66 = 56.740807989105761 * var_x60;
        const double var_x67 = var_x66 * var_chaste_interface__intracellular_ions__nai;
        const double var_x68 = var_x67 + 60000.0 * var_x65;
        const double var_x69 = var_x63 * var_x68;
        const double var_x70 = var_x49 * var_x68;
        const double var_x71 = var_x53 * var_x70;
        const double var_x72 = var_x42 * var_x44;
        const double var_x73 = 0.11015000000000001 * var_x72;
        const double var_x74 = 5000.0 + var_x68;
        const double var_x75 = var_x48 * var_x74;
        const double var_x76 = 5000.0 + var_x42;
        const double var_x77 = var_x62 * var_x76;
        const double var_x78 = var_x48 * var_x76;
        const double var_x79 = var_x53 * var_x78;
        const double var_x80 = var_x79 * var_chaste_interface__intracellular_ions__cai;
        const double var_x81 = var_x44 * var_x74;
        const double var_x82 = var_x62 * var_x81;
        const double var_x83 = pow((var_x51 + var_x80 + var_x82 + 0.0033333333333333331 * var_x75 + 0.0033333333333333331 * var_x77 + 0.00036716666666666668 * var_x69 + var_x63 * var_x73 + 0.11015000000000001 * var_x71 * var_chaste_interface__intracellular_ions__cai), (-2));
        const double var_x84 = 283704.03994552878 * var_x60;
        const double var_x85 = 300000000.0 * var_x65 + var_x84 * var_chaste_interface__intracellular_ions__nai;
        const double var_x86 = 2250000000000.0 * var_x72;
        const double var_x87 = var_x53 * var_x86;
        const double var_x88 = 13617793.917385383 * var_x79;
        const double var_x89 = var_x83 * (-var_x87 - var_x88 - var_x54 * var_x70 - var_x54 * var_x85);
        const double var_x90 = 13617793.917385383 * var_x82 + var_x55 * var_x70;
        const double var_x91 = 5.3924544444444452e-11 * var_x90;
        const double var_x92 = 5000.0 * var_x69 + 45392.646391284608 * var_x77;
        const double var_x93 = var_x42 * var_x45;
        const double var_x94 = 13617793.917385383 * var_x80 + var_x63 * var_x93;
        const double var_x95 = 5000.0 * var_x50;
        const double var_x96 = var_x95 + 45392.646391284608 * var_x75;
        const double var_x97 = 1 / (var_x90 + var_x92 + var_x94 + var_x96);
        const double var_x98 = var_x71 * var_x97;
        const double var_x99 = var_x67 * var_x97;
        const double var_x100 = 4500000000000.0 * var_x44;
        const double var_x101 = var_x53 * var_x97;
        const double var_x102 = var_x101 * var_x85;
        const double var_x103 = 1.6177363333333335e-8 * var_x44;
        const double var_x104 = var_x89 * var_x92;
        const double var_x105 = 3.0597222222222222e-13 * var_x89;
        const double var_x106 = var_x60 * var_x94 * var_chaste_interface__intracellular_ions__nai;
        const double var_x107 = var_x40 * var_x90;
        const double var_x108 = 1.4686666666666667e-13 * var_x62 * var_x96;
        const double var_x109 = 40853381.752156146 * var_x48;
        const double var_x110 = 85111211.983658642 * var_x40;
        const double var_x111 = 1.4686666666666667e-13 * var_x48;
        const double var_x112 = 15000000000.0 * var_x98 + var_x105 * var_x106 + var_x108 * var_x89 + var_x89 * var_x91 + var_x99 * (var_x87 + var_x88) - var_x100 * var_x102 - var_x102 * var_x109 - var_x103 * var_x104 - var_x104 * var_x111 - var_x105 * var_x107 - var_x110 * var_x98;
        const double var_x113 = 1.0 + 2.2499999999999996e-8 / pow(var_chaste_interface__intracellular_ions__cai, 2);
        const double var_x114 = mParameters[16] / var_x113;
        const double var_x115 = 1.7600000000000002 * var_x114;
        const double var_x116 = 10000.0 * var_x97;
        const double var_x117 = 3000000.0 * var_x44;
        const double var_x118 = var_x92 * var_x97;
        const double var_x119 = var_x94 * var_x97;
        const double var_x120 = var_x41 * var_x97;
        const double var_x121 = var_x96 * var_x97;
        const double var_x122 = 27.235587834770765 * var_x121;
        const double var_x123 = 27.235587834770765 * var_x48;
        const double var_x124 = var_x116 * var_x90 + var_x119 * var_x67 + var_x122 * var_x62 - var_x117 * var_x118 - var_x118 * var_x123 - var_x120 * var_x90;
        const double var_x125 = var_x124 * mParameters[16] / (pow(var_x113, 2) * pow(var_chaste_interface__intracellular_ions__cai, 3));
        const double var_x126 = exp(2.0 * var_x35);
        const double var_x127 = var_x34 * pow(mParameters[5], 2);
        const double var_x128 = var_x127 / (-1.0 + var_x126);
        const double var_x129 = var_x126 * var_x128;
        const double var_x130 = 4.0 * mParameters[8];
        const double var_x131 = 1 / mParameters[5];
        const double var_x132 = 2.9679144385026732 * var_x131;
        const double var_x133 = -0.34100000000000003 * mParameters[2];
        const double var_x134 = 0.015640625000000002 * var_x27;
        const double var_x135 = 0.0056875000000000007 * var_x30;
        const double var_x136 = var_x13 * var_x8;
        const double var_x137 = var_x136 * var_chaste_interface__intracellular_ions__cai;
        const double var_x138 = var_x137 * var_x18;
        const double var_x139 = var_x11 * var_x137;
        const double var_x140 = pow(var_x58, (-2));
        const double var_x141 = -0.011348161597821153 - 0.011348161597821153 * var_x36;
        const double var_x142 = var_x141 * var_x64;
        const double var_x143 = var_x140 * var_x142;
        const double var_x144 = var_x141 * var_x36;
        const double var_x145 = 56.740807989105761 * var_x144;
        const double var_x146 = var_x140 * var_chaste_interface__intracellular_ions__nai;
        const double var_x147 = var_x145 * var_x146;
        const double var_x148 = var_x147 + var_x66 + 60000.0 * var_x143;
        const double var_x149 = var_x148 * var_x49 * var_x55;
        const double var_x150 = (-0.066666666666666666 - 0.026666666666666668 * var_chaste_interface__intracellular_ions__nai) / pow(var_x52, 2);
        const double var_x151 = var_x150 * var_chaste_interface__intracellular_ions__cai;
        const double var_x152 = 1500000.0 * var_x151;
        const double var_x153 = var_x152 * var_x70;
        const double var_x154 = pow(var_chaste_interface__intracellular_ions__nai, 2);
        const double var_x155 = var_x154 * var_x61;
        const double var_x156 = 40853381.752156146 * var_x155 * var_x81;
        const double var_x157 = 13617793.917385383 * var_x44;
        const double var_x158 = var_x148 * var_x157 * var_x62;
        const double var_x159 = var_x150 * var_x60;
        const double var_x160 = var_x159 * var_x56;
        const double var_x161 = 13617793.917385383 * var_x81;
        const double var_x162 = var_x160 * var_x161;
        const double var_x163 = var_x140 * var_x144;
        const double var_x164 = var_x163 * var_x53;
        const double var_x165 = var_x164 * var_x56;
        const double var_x166 = var_x161 * var_x165;
        const double var_x167 = var_x149 + var_x153 + var_x156 + var_x158 + var_x162 + var_x166;
        const double var_x168 = 283704.03994552878 * var_x144;
        const double var_x169 = var_x63 * (var_x84 + 300000000.0 * var_x143 + var_x146 * var_x168);
        const double var_x170 = 9.0785292782569211 * var_x56;
        const double var_x171 = var_x152 + 27.235587834770765 * var_x155 + var_x159 * var_x170 + var_x164 * var_x170;
        const double var_x172 = var_x171 * var_x85;
        const double var_x173 = var_x171 * var_x93;
        const double var_x174 = 136177.93917385384 * var_x76;
        const double var_x175 = var_x155 * var_x174;
        const double var_x176 = 45392.646391284608 * var_x48;
        const double var_x177 = 45392.646391284608 * var_x76;
        const double var_x178 = var_x160 * var_x177;
        const double var_x179 = var_x165 * var_x177;
        const double var_x180 = 13617793.917385383 * var_x78;
        const double var_x181 = var_x151 * var_x180;
        const double var_x182 = var_x83 * (-var_x149 - var_x153 - var_x156 - var_x158 - var_x162 - var_x166 - var_x169 - var_x172 - var_x173 - var_x175 - var_x178 - var_x179 - var_x181 - var_x148 * var_x176);
        const double var_x183 = var_x97 * (var_x169 + var_x172 + var_x175 + var_x178 + var_x179);
        const double var_x184 = var_x182 * var_x92;
        const double var_x185 = 3.0597222222222222e-13 * var_x182;
        const double var_x186 = var_x101 * var_x56;
        const double var_x187 = 1236295.4078425223 * var_x38 * var_x47;
        const double var_x188 = var_x106 * var_x185 + var_x108 * var_x182 + var_x116 * var_x167 + var_x119 * var_x147 + var_x119 * var_x66 + var_x122 * var_x160 + var_x182 * var_x91 + var_x99 * (var_x173 + var_x181) - var_x103 * var_x184 - var_x107 * var_x185 - var_x111 * var_x184 - var_x117 * var_x183 - var_x120 * var_x167 - var_x123 * var_x183 + 81.706763504312292 * var_x121 * var_x155 + 27.235587834770765 * var_x163 * var_x186 * var_x96 + var_x148 * var_x186 * var_x187 * var_x59;
        const double var_x189 = 0.14999999999999999 * var_x14;
        const double var_x190 = 0.80000000000000004 + var_chaste_interface__intracellular_ions__cajsr;
        const double var_x191 = pow(var_x190, (-2));
        const double var_x192 = 1 / (1.0 + 8.0 * var_x191);
        const double var_x193 = var_x192 * mParameters[0];
        const double var_x194 = var_x193;
        const double var_x195 = 0.01 * var_x192;
        const double var_x196 = (var_x28 * var_chaste_interface__ryr__Jrelp + var_x29 * var_chaste_interface__ryr__Jrelnp) * mParameters[0];
        const double var_x197 = 1.1250000000000001e-5 * var_x136;
        const double var_x198 = 0.035999999999999997 * var_x14;
        const double var_x199 = 1.0 - var_chaste_interface__ICaL__nca;
        const double var_x200 = 0.40000000000000002 * var_chaste_interface__ICaL__fs;
        const double var_x201 = 0.59999999999999998 * var_chaste_interface__ICaL__ffp;
        const double var_x202 = _lt_0_row[39];
        const double var_x203 = 0.29999999999999999 + var_x202;
        const double var_x204 = (0.69999999999999996 - var_x202) * var_chaste_interface__ICaL__fcas;
        const double var_x205 = (var_x204 + var_x203 * var_chaste_interface__ICaL__fcafp) * var_chaste_interface__ICaL__jca;
        const double var_x206 = var_x199 * (var_x200 + var_x201) + var_x205 * var_chaste_interface__ICaL__nca;
        const double var_x207 = var_x128 * (var_x133 + var_x126 * var_chaste_interface__intracellular_ions__cass);
        const double var_x208 = mParameters[7] * var_chaste_interface__ICaL__d;
        const double var_x209 = var_x14 * var_x208;
        const double var_x210 = var_x207 * var_x209;
        const double var_x211 = 0.79200000000000004 * var_x206 * var_x210;
        const double var_x212 = 0.59999999999999998 * var_chaste_interface__ICaL__ff;
        const double var_x213 = (var_x204 + var_x203 * var_chaste_interface__ICaL__fcaf) * var_chaste_interface__ICaL__jca;
        const double var_x214 = var_x199 * (var_x200 + var_x212) + var_x213 * var_chaste_interface__ICaL__nca;
        const double var_x215 = 0.71999999999999997 * var_x210 * var_x214;
        const double var_x216 = 100.90909090909091 * var_x131;
        const double var_x217 = 0.0086999999999999994 + var_chaste_interface__intracellular_ions__cass;
        const double var_x218 = 0.00087000000000000001 + var_chaste_interface__intracellular_ions__cass;
        const double var_x219 = 1.0 + 0.0097788000000000007 / pow(var_x217, 2) + 4.0890000000000003e-5 / pow(var_x218, 2);
        const double var_x220 = 1 / var_x219;
        const double var_x221 = var_x220;
        const double var_x222 = -var_x200;
        const double var_x223 = var_x213 + var_x222 - var_x212;
        const double var_x224 = var_x208 * var_x29;
        const double var_x225 = 4.7999999999999998 * var_x224;
        const double var_x226 = var_x207 * var_x225;
        const double var_x227 = var_x223 * var_x226;
        const double var_x228 = var_x205 + var_x222 - var_x201;
        const double var_x229 = var_x208 * var_x26;
        const double var_x230 = 5.2800000000000002 * var_x229;
        const double var_x231 = var_x207 * var_x230;
        const double var_x232 = var_x228 * var_x231;
        const double var_x233 = 2.7e-6 * var_x136;
        const double var_x234 = 1.0 + 0.066666666666666666 * (1.0 + 0.20000000000000001 * var_chaste_interface__intracellular_ions__nass) * var_chaste_interface__intracellular_ions__nass;
        const double var_x235 = 1 / var_x234;
        const double var_x236 = 1500000.0 * var_x235;
        const double var_x237 = var_x236 * var_chaste_interface__intracellular_ions__cass;
        const double var_x238 = pow(var_chaste_interface__intracellular_ions__nass, 3);
        const double var_x239 = 1.0 + var_x57 * var_chaste_interface__intracellular_ions__nass;
        const double var_x240 = 1 / var_x239;
        const double var_x241 = var_x240 * var_x36;
        const double var_x242 = var_x235 * var_x241;
        const double var_x243 = var_x238 * var_x242;
        const double var_x244 = var_x237 + 9.0785292782569211 * var_x243;
        const double var_x245 = var_x240 * var_x64;
        const double var_x246 = 56.740807989105761 * var_x241;
        const double var_x247 = var_x246 * var_chaste_interface__intracellular_ions__nass;
        const double var_x248 = var_x247 + 60000.0 * var_x245;
        const double var_x249 = var_x244 * var_x248;
        const double var_x250 = var_x248 * var_x49;
        const double var_x251 = var_x235 * var_x250;
        const double var_x252 = 5000.0 + var_x248;
        const double var_x253 = var_x243 * var_x76;
        const double var_x254 = var_x235 * var_x78;
        const double var_x255 = var_x254 * var_chaste_interface__intracellular_ions__cass;
        const double var_x256 = var_x252 * var_x44;
        const double var_x257 = var_x243 * var_x256;
        const double var_x258 = pow((var_x255 + var_x257 + var_x51 + 0.0033333333333333331 * var_x253 + 0.00036716666666666668 * var_x249 + var_x244 * var_x73 + 0.0033333333333333331 * var_x252 * var_x48 + 0.11015000000000001 * var_x251 * var_chaste_interface__intracellular_ions__cass), (-2));
        const double var_x259 = 283704.03994552878 * var_x241;
        const double var_x260 = 300000000.0 * var_x245 + var_x259 * var_chaste_interface__intracellular_ions__nass;
        const double var_x261 = var_x235 * var_x86;
        const double var_x262 = 13617793.917385383 * var_x254;
        const double var_x263 = var_x258 * (-var_x261 - var_x262 - var_x236 * var_x250 - var_x236 * var_x260);
        const double var_x264 = 13617793.917385383 * var_x257 + var_x237 * var_x250;
        const double var_x265 = 5.3924544444444452e-11 * var_x264;
        const double var_x266 = 5000.0 * var_x249 + 45392.646391284608 * var_x253;
        const double var_x267 = 13617793.917385383 * var_x255 + var_x244 * var_x93;
        const double var_x268 = var_x95 + var_x176 * var_x252;
        const double var_x269 = 1 / (var_x264 + var_x266 + var_x267 + var_x268);
        const double var_x270 = var_x251 * var_x269;
        const double var_x271 = var_x247 * var_x269;
        const double var_x272 = var_x235 * var_x269;
        const double var_x273 = var_x260 * var_x272;
        const double var_x274 = var_x103 * var_x266;
        const double var_x275 = 3.0597222222222222e-13 * var_x263;
        const double var_x276 = var_x241 * var_x267 * var_chaste_interface__intracellular_ions__nass;
        const double var_x277 = var_x264 * var_x40;
        const double var_x278 = 1.4686666666666667e-13 * var_x243 * var_x268;
        const double var_x279 = var_x111 * var_x266;
        const double var_x280 = 15000000000.0 * var_x270 + var_x263 * var_x265 + var_x263 * var_x278 + var_x271 * (var_x261 + var_x262) + var_x275 * var_x276 - var_x100 * var_x273 - var_x109 * var_x273 - var_x110 * var_x270 - var_x263 * var_x274 - var_x263 * var_x279 - var_x275 * var_x277;
        const double var_x281 = 1.0 + 2.2499999999999996e-8 * var_x7;
        const double var_x282 = mParameters[16] / var_x281;
        const double var_x283 = 0.44000000000000006 * var_x282;
        const double var_x284 = 10000.0 * var_x269;
        const double var_x285 = var_x117 * var_x269;
        const double var_x286 = var_x267 * var_x269;
        const double var_x287 = var_x269 * var_x41;
        const double var_x288 = var_x268 * var_x269;
        const double var_x289 = 27.235587834770765 * var_x288;
        const double var_x290 = var_x123 * var_x269;
        const double var_x291 = var_x243 * var_x289 + var_x247 * var_x286 + var_x264 * var_x284 - var_x264 * var_x287 - var_x266 * var_x285 - var_x266 * var_x290;
        const double var_x292 = var_x291 * mParameters[16] / (pow(var_x281, 2) * pow(var_chaste_interface__intracellular_ions__cass, 3));
        const double var_x293 = var_x129 * var_x214 * var_x225;
        const double var_x294 = var_x129 * var_x206 * var_x230;
        const double var_x295 = var_x136 * var_x208;
        const double var_x296 = var_x207 * var_x295;
        const double var_x297 = 5.3999999999999998e-5 * var_x214 * var_x296;
        const double var_x298 = 5.9400000000000007e-5 * var_x206 * var_x296;
        const double var_x299 = var_x214 * var_x226;
        const double var_x300 = var_x206 * var_x231;
        const double var_x301 = pow(var_x239, (-2));
        const double var_x302 = var_x142 * var_x301;
        const double var_x303 = var_x301 * var_chaste_interface__intracellular_ions__nass;
        const double var_x304 = var_x145 * var_x303;
        const double var_x305 = var_x246 + var_x304 + 60000.0 * var_x302;
        const double var_x306 = var_x237 * var_x305 * var_x49;
        const double var_x307 = (-0.066666666666666666 - 0.026666666666666668 * var_chaste_interface__intracellular_ions__nass) / pow(var_x234, 2);
        const double var_x308 = var_x307 * var_chaste_interface__intracellular_ions__cass;
        const double var_x309 = 1500000.0 * var_x308;
        const double var_x310 = var_x250 * var_x309;
        const double var_x311 = var_x242 * pow(var_chaste_interface__intracellular_ions__nass, 2);
        const double var_x312 = 40853381.752156146 * var_x256 * var_x311;
        const double var_x313 = var_x157 * var_x243 * var_x305;
        const double var_x314 = var_x241 * var_x307;
        const double var_x315 = var_x238 * var_x314;
        const double var_x316 = 13617793.917385383 * var_x256;
        const double var_x317 = var_x315 * var_x316;
        const double var_x318 = var_x144 * var_x301;
        const double var_x319 = var_x235 * var_x318;
        const double var_x320 = var_x238 * var_x316 * var_x319;
        const double var_x321 = var_x306 + var_x310 + var_x312 + var_x313 + var_x317 + var_x320;
        const double var_x322 = var_x244 * (var_x259 + 300000000.0 * var_x302 + var_x168 * var_x303);
        const double var_x323 = 9.0785292782569211 * var_x238;
        const double var_x324 = var_x309 + 27.235587834770765 * var_x311 + var_x314 * var_x323 + var_x319 * var_x323;
        const double var_x325 = var_x260 * var_x324;
        const double var_x326 = var_x324 * var_x93;
        const double var_x327 = var_x174 * var_x311;
        const double var_x328 = var_x177 * var_x238;
        const double var_x329 = var_x314 * var_x328;
        const double var_x330 = var_x319 * var_x328;
        const double var_x331 = var_x180 * var_x308;
        const double var_x332 = var_x258 * (-var_x306 - var_x310 - var_x312 - var_x313 - var_x317 - var_x320 - var_x322 - var_x325 - var_x326 - var_x327 - var_x329 - var_x330 - var_x331 - var_x176 * var_x305);
        const double var_x333 = var_x322 + var_x325 + var_x327 + var_x329 + var_x330;
        const double var_x334 = 3.0597222222222222e-13 * var_x332;
        const double var_x335 = var_x238 * var_x272;
        const double var_x336 = var_x246 * var_x286 + var_x265 * var_x332 + var_x271 * (var_x326 + var_x331) + var_x276 * var_x334 + var_x278 * var_x332 + var_x284 * var_x321 + var_x286 * var_x304 + var_x289 * var_x315 - var_x274 * var_x332 - var_x277 * var_x334 - var_x279 * var_x332 - var_x285 * var_x333 - var_x287 * var_x321 - var_x290 * var_x333 + 81.706763504312292 * var_x288 * var_x311 + 27.235587834770765 * var_x268 * var_x318 * var_x335 + var_x187 * var_x240 * var_x305 * var_x335;
        const double var_x337 = 0.23999999999999996 * var_x26;
        const double var_x338 = _lt_0_row[2];
        const double var_x339 = 1.0 - var_x338;
        const double var_x340 = (var_x338 * var_chaste_interface__Ito__iFp + var_x339 * var_chaste_interface__Ito__iSp) * var_chaste_interface__Ito__ap;
        const double var_x341 = 0.59999999999999998 * var_x14;
        const double var_x342 = (var_x338 * var_chaste_interface__Ito__iF + var_x339 * var_chaste_interface__Ito__iS) * var_chaste_interface__Ito__a;
        const double var_x343 = 1 / var_chaste_interface__intracellular_ions__ki;
        const double var_x344 = var_x131 * mParameters[6] * mParameters[19];
        const double var_x345 = 5.9358288770053464 * var_x131;
        const double var_x346 = var_x345 * (-var_x344 * log(var_x343 * mParameters[3]) + var_chaste_interface__membrane__v) * mParameters[18];
        const double var_x347 = 1 / var_chaste_interface__intracellular_ions__cai;
        const double var_x348 = pow(var_x347, 1.3999999999999999);
        const double var_x349 = 1.0 + 6.4818210260626455e-7 * var_x348;
        const double var_x350 = 1 / (0.018329999999999999 * var_chaste_interface__intracellular_ions__nai + var_chaste_interface__intracellular_ions__ki);
        const double var_x351 = mParameters[15] * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2;
        const double var_x352 = 4.5000000000000003e-5 * var_x136;
        const double var_x353 = exp(0.38500000000000001 * var_x35);
        const double var_x354 = 1 / (-1.0 + pow((1.0 + 0.035997120230381568 * mParameters[4] / var_x353), 3) + 7.7937924625297832 * pow((0.35820000000000002 + mParameters[3]), 2));
        const double var_x355 = var_x354 * pow(mParameters[3], 2);
        const double var_x356 = pow((0.5 + var_chaste_interface__intracellular_ions__ki), 2);
        const double var_x357 = exp(-0.051666666666666666 * var_x35);
        const double var_x358 = 1 / var_x357;
        const double var_x359 = 1.0 + 0.11021712774165104 * var_x358 * var_chaste_interface__intracellular_ions__nai;
        const double var_x360 = pow(var_x359, 3);
        const double var_x361 = pow((-0.25 + var_x356 + 0.25 * var_x360), (-2));
        const double var_x362 = var_x361 * (-4.0 - 8.0 * var_chaste_interface__intracellular_ions__ki);
        const double var_x363 = pow(var_x357, (-3));
        const double var_x364 = var_x363 * var_x56;
        const double var_x365 = var_x362 * var_x364;
        const double var_x366 = var_x355 * var_x365;
        const double var_x367 = var_x354 * var_x46 / pow(var_x353, 3);
        const double var_x368 = 0.09330879953375748 * var_x365 * var_x367;
        const double var_x369 = pow((1 + 0.0028096208831939005 * var_chaste_interface__intracellular_ions__nai + 0.0021553256090254577 * var_chaste_interface__intracellular_ions__ki), (-2));
        const double var_x370 = 1 / (-1.0 + var_x360 + 4.0 * var_x356);
        const double var_x371 = var_x363 * var_x370;
        const double var_x372 = var_x371 * var_x56;
        const double var_x373 = var_x369 * var_x372;
        const double var_x374 = var_x367 * var_x373;
        const double var_x375 = 1.8288767722361083e-15 * var_x374;
        const double var_x376 = 1 / (1.5889281507656066 + 0.0034246575342465752 * var_chaste_interface__intracellular_ions__ki + 0.004464285714285714 * var_chaste_interface__intracellular_ions__nai);
        const double var_x377 = var_x367 * var_x376;
        const double var_x378 = 8.4266669949965062e-14 * var_x365 * var_x377;
        const double var_x379 = var_x370 * var_chaste_interface__intracellular_ions__ki;
        const double var_x380 = var_x376 * var_x379;
        const double var_x381 = 3.3937789869608994e-10 * var_x367;
        const double var_x382 = pow(var_chaste_interface__intracellular_ions__ki, 2);
        const double var_x383 = var_x370 * var_x382;
        const double var_x384 = var_x369 * var_x383;
        const double var_x385 = var_x367 * var_x384;
        const double var_x386 = var_x362 * var_x382;
        const double var_x387 = var_x377 * var_x386;
        const double var_x388 = 1.0605559334252811e-11 * var_x387 - 2.3017714043409702e-13 * var_x385 + var_x380 * var_x381;
        const double var_x389 = var_x368 + var_x378 + var_x388 - var_x375 + 751444.4931407267 * var_x366;
        const double var_x390 = var_x355 * var_x372;
        const double var_x391 = var_x376 * var_x383;
        const double var_x392 = var_x355 * var_x383;
        const double var_x393 = var_x367 * var_x383;
        const double var_x394 = 2.6817254812739919 * var_x393 + 1648931648.7518551 * var_x392;
        const double var_x395 = 6585420658.1002293 * var_x355 + 9.6722701128385645e-12 * var_x377 + 10.71014095526842 * var_x367;
        const double var_x396 = var_x367 * var_x372;
        const double var_x397 = var_x372 * var_x376;
        const double var_x398 = var_x367 * var_x397;
        const double var_x399 = 1.348266719199441e-12 * var_x398 + 1.4929407925401197 * var_x396;
        const double var_x400 = 6.3450816326903207e-5 * var_x391 + 5.041496472709802e-7 * var_x397 + 558246.7943749798 * var_x372;
        const double var_x401 = 1 / (var_x394 + var_x395 + var_x399 + var_x400 + 24953131.661984976 * var_x390 + var_x381 * var_x391);
        const double var_x402 = 32.832000000000001 * var_x401;
        const double var_x403 = var_x394 + 12930019.771733347 * var_x390;
        const double var_x404 = var_x369 * var_x401;
        const double var_x405 = var_x403 * var_x404;
        const double var_x406 = 8.6068818956382799e-8 * var_x384;
        const double var_x407 = 0.00012690163265380641 * var_x380;
        const double var_x408 = 6.8386140998302939e-10 * var_x373;
        const double var_x409 = var_x367 * var_x369;
        const double var_x410 = var_x362 * var_x376;
        const double var_x411 = 3.9656760204314505e-6 * var_x382 * var_x410;
        const double var_x412 = 34890.424648436237 * var_x365;
        const double var_x413 = 3297863297.5037103 * var_x355 * var_x379;
        const double var_x414 = 3.1509352954436263e-8 * var_x364 * var_x410;
        const double var_x415 = 5.3634509625479838 * var_x367 * var_x379;
        const double var_x416 = 103058228.04699095 * var_x355 * var_x386;
        const double var_x417 = 0.16760784257962449 * var_x367 * var_x386;
        const double var_x418 = var_x375 + var_x406 + var_x408 - var_x368 - var_x378 - var_x407 - var_x411 - var_x412 - var_x413 - var_x414 - var_x415 - var_x416 - var_x417 + 4.6035428086819405e-13 * var_x385 + 1.3120097004743531e-14 * var_x409 - 2.1211118668505621e-11 * var_x387 - 1559570.728874061 * var_x366 - 6.7875579739217989e-10 * var_x367 * var_x380;
        const double var_x419 = var_x367 * var_x391;
        const double var_x420 = pow((var_x355 + 0.25039124064514068 * var_x392 + 7.6555420442407695e-17 * var_x397 + 8.4770104046173956e-5 * var_x372 + 2.0473509426327076e-22 * var_x398 + 0.0037891477184972245 * var_x390 + 9.6350437764149725e-15 * var_x391 + 4.0722159152815902e-10 * var_x393 + 1.4687399051632995e-21 * var_x377 + 1.6263412029867345e-9 * var_x367 + 5.1534733514501733e-20 * var_x419 + 2.2670393738686469e-10 * var_x396), (-2));
        const double var_x421 = 1.6968894934804497e-10 * var_x419;
        const double var_x422 = var_x420 * (var_x399 + var_x421 + 12023111.890251627 * var_x390);
        const double var_x423 = 7.5705999179751327e-19 * var_x422;
        const double var_x424 = var_x413 + var_x415 + var_x416 + var_x417 + 808126.23573333421 * var_x366;
        const double var_x425 = var_x376 * var_x401;
        const double var_x426 = 3.1162180602924665e-9 * var_x425;
        const double var_x427 = var_x388 + var_x407 + var_x411 + var_x412 + var_x414 - var_x406 - var_x408;
        const double var_x428 = var_x355 * var_x401;
        const double var_x429 = 79922.22418625791 * var_x428;
        const double var_x430 = var_x418 * var_x420;
        const double var_x431 = var_x376 * var_x403;
        const double var_x432 = 7.1855629238678031e-29 * var_x431;
        const double var_x433 = var_x355 * (var_x400 + var_x421);
        const double var_x434 = 1.842894687709778e-15 * var_x433;
        const double var_x435 = var_x395 * var_x401;
        const double var_x436 = var_x365 * var_x435;
        const double var_x437 = var_x372 * var_x395;
        const double var_x438 = 1.0553042661857941e-19 * var_x437;
        const double var_x439 = var_x396 * var_x404;
        const double var_x440 = var_x343 * var_x344;
        const double var_x441 = var_x344 * var_x350 * var_x351 * (-1.3999999999999999 - 0.83999999999999997 / var_x349);
        const double var_x442 = var_x440 * sqrt(mParameters[3]);
        const double var_x443 = _lt_0_row[1];
        const double var_x444 = var_x154 * var_x371;
        const double var_x445 = var_x355 * var_x444;
        const double var_x446 = 4.4788223776203591 * var_x367 * var_x444;
        const double var_x447 = var_x361 * pow(var_x359, 2);
        const double var_x448 = var_x447 * var_x56 / pow(var_x357, 4);
        const double var_x449 = var_x355 * var_x448;
        const double var_x450 = 4.0448001575983228e-12 * var_x377 * var_x444;
        const double var_x451 = 2.3840715066649271e-15 * var_x374;
        const double var_x452 = 0.030852683632896775 * var_x367 * var_x448;
        const double var_x453 = 2.786289097871654e-14 * var_x377 * var_x448;
        const double var_x454 = var_x358 * var_x382 * var_x447;
        const double var_x455 = var_x377 * var_x454;
        const double var_x456 = -3.0005234378016216e-13 * var_x385 - 3.5067428637450051e-12 * var_x455;
        const double var_x457 = var_x446 + var_x450 + var_x456 - var_x451 - var_x452 - var_x453 + 36069335.67075488 * var_x445 - 248466.16107375509 * var_x449;
        const double var_x458 = 1.1219685328242758e-7 * var_x384;
        const double var_x459 = 1674740.3831249396 * var_x444;
        const double var_x460 = 8.9146219515644901e-10 * var_x373;
        const double var_x461 = 11536.567171311443 * var_x448;
        const double var_x462 = 1.5124489418129408e-6 * var_x376 * var_x444;
        const double var_x463 = 1.3112562615776865e-6 * var_x376 * var_x454;
        const double var_x464 = 1.0418611138907615e-8 * var_x376 * var_x448;
        const double var_x465 = 34076345.656450219 * var_x355 * var_x454;
        const double var_x466 = 0.055419764988303033 * var_x367 * var_x454;
        const double var_x467 = var_x451 + var_x452 + var_x453 + var_x458 + var_x460 + var_x461 + var_x463 + var_x464 + var_x465 + var_x466 - var_x446 - var_x450 - var_x459 - var_x462 + 6.0010468756032432e-13 * var_x385 + 7.0134857274900101e-12 * var_x455 + 1.7102983595469244e-14 * var_x409 + 515674.21873935661 * var_x449 - 74859394.985954925 * var_x445;
        const double var_x468 = -var_x465 - var_x466 + 38790059.315200046 * var_x445 - 267208.05766560155 * var_x449;
        const double var_x469 = var_x456 + var_x459 + var_x462 - var_x458 - var_x460 - var_x461 - var_x463 - var_x464;
        const double var_x470 = var_x420 * var_x467;
        const double var_x471 = var_x435 * var_x444;
        const double var_x472 = var_x435 * var_x448;
        const double var_x473 = exp(var_x35);
        const double var_x474 = 0.75 * var_x473;
        const double var_x475 = var_x127 / (-1.0 + var_x473);
        const double var_x476 = var_x475 * (-0.75 * mParameters[3] + var_x474 * var_chaste_interface__intracellular_ions__kss);
        const double var_x477 = var_x209 * var_x476;
        const double var_x478 = 201.81818181818181 * var_x131;
        const double var_x479 = var_x228 * var_x229;
        const double var_x480 = var_x223 * var_x224;
        const double var_x481 = var_x295 * var_x476;
        const double var_x482 = var_x473 * var_x475;
        const double var_x483 = var_x206 * var_x229 * var_x482;
        const double var_x484 = var_x214 * var_x224 * var_x482;
        const double var_x485 = 0.089999999999999997 * var_x14;
        const double var_x486 = 1 / var_chaste_interface__intracellular_ions__nai;
        const double var_x487 = -var_x344 * log(var_x486 * mParameters[4]) + var_chaste_interface__membrane__v;
        const double var_x488 = mParameters[13] * var_chaste_interface__INaL__mL;
        const double var_x489 = var_x487 * var_x488;
        const double var_x490 = 0.98999999999999999 * var_chaste_interface__INa__hf;
        const double var_x491 = (var_x490 + 0.010000000000000009 * var_chaste_interface__INa__hs) * var_chaste_interface__INa__j;
        const double var_x492 = (var_x490 + 0.010000000000000009 * var_chaste_interface__INa__hsp) * var_chaste_interface__INa__jp;
        const double var_x493 = pow(var_chaste_interface__INa__m, 3) * mParameters[11];
        const double var_x494 = var_x487 * var_x493;
        const double var_x495 = 2.6400000000000006 * var_x114;
        const double var_x496 = 6.7499999999999997e-6 * var_x136;
        const double var_x497 = 49.248000000000005 * var_x401;
        const double var_x498 = 4.6743270904386998e-9 * var_x425;
        const double var_x499 = 1.1355899876962699e-18 * var_x422;
        const double var_x500 = 1.0778344385801704e-28 * var_x431;
        const double var_x501 = 119883.33627938687 * var_x428;
        const double var_x502 = 2.7643420315646669e-15 * var_x433;
        const double var_x503 = 1.5829563992786911e-19 * var_x437;
        const double var_x504 = exp(var_x35);
        const double var_x505 = var_x344 * var_x486;
        const double var_x506 = var_x475 * (-0.75 * mParameters[4] + var_x474 * var_chaste_interface__intracellular_ions__nass);
        const double var_x507 = var_x209 * var_x506;
        const double var_x508 = 0.66000000000000014 * var_x282;
        const double var_x509 = var_x295 * var_x506;
        const double var_x510 = var_x215 - var_x211;
        const double var_x511 = pow(var_chaste_interface__intracellular_ions__cajsr, (-8));
        const double var_x512 = 1 / (1.0 + 25.62890625 * var_x511);
        const double var_x513 = 2375.0 * var_x512;
        const double var_x514 = 1 / var_chaste_interface__intracellular_ions__cajsr;
        const double var_x515 = 1 / (1.0 + 0.0123 * var_x514);
        const double var_x516 = 4.75 * var_x515 < 0.001;
        const double var_x517 = var_x510 * var_x512;
        const double var_x518 = 0.0025894736842105265 * var_x514;
        const double var_x519 = 0.21052631578947367 + var_x518;
        const double var_x520 = 2.375 * var_x519;
        const double var_x521 = var_x227 + var_x232;
        const double var_x522 = var_x512 * var_x520;
        const double var_x523 = var_x299 + var_x300;
        const double var_x524 = var_x523 / (pow((0.039018442310623382 + var_x511), 2) * pow(var_chaste_interface__intracellular_ions__cajsr, 9));
        const double var_x525 = pow(var_chaste_interface__intracellular_ions__cajsr, (-2));
        const double var_x526 = var_x512 * var_x523;
        const double var_x527 = var_x293 + var_x294 + var_x298 - var_x297;
        const double var_x528 = 2968.75 * var_x512;
        const double var_x529 = 5.9375 * var_x515 < 0.001;
        const double var_x530 = 0.0020715789473684213 * var_x514;
        const double var_x531 = 0.16842105263157894 + var_x530;
        const double var_x532 = 2.96875 * var_x531;
        const double var_x533 = var_x512 * var_x532;
        ...
        rJacobian[1][10] = 0.0;
        rJacobian[1][11] = 0.0;
        rJacobian[2][0] = -(mDt * (var_x25 * (0.00019044761029411765 * var_x16 - 6.9253676470588241e-5 * var_x19) * mParameters[1]));
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (var_x25 * (-0.14705882352941174 + var_x132 * (-var_x33 + 7.9199999999999995e-8 * var_x125 + var_x112 * var_x115 - var_x129 * var_x130 + var_x22 * mParameters[10] * var_chaste_interface__intracellular_ions__cai) + (0.0012696507352941177 * var_x31 + 0.00046169117647058827 * var_x32 - 0.0012696507352941177 * var_x27 - 0.00046169117647058827 * var_x30) * mParameters[1]) + (0.00030940000000000004 / pow(var_x20, 3) + 7.0000000000000007e-5 / pow(var_x21, 3)) * (0.14705882352941174 * var_chaste_interface__intracellular_ions__cass - 0.14705882352941174 * var_chaste_interface__intracellular_ions__cai + var_x132 * (var_x115 * var_x124 - var_x33 * var_chaste_interface__intracellular_ions__cai - var_x128 * var_x130 * (var_x133 + var_x126 * var_chaste_interface__intracellular_ions__cai)) - 0.081176470588235281 * (-0.00026249999999999998 * var_chaste_interface__intracellular_ions__cansr + var_x134 * var_chaste_interface__intracellular_ions__cai + var_x135 * var_chaste_interface__intracellular_ions__cai) * mParameters[1]) / pow(var_x23, 2)));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = -(mDt * (2.1308823529411761e-5 * var_x24 * mParameters[1]));
        rJacobian[2][5] = -(mDt * (var_x25 * (0.14705882352941174 + (5.1940257352941184e-9 * var_x138 - 1.4283570772058824e-8 * var_x139) * mParameters[1])));
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = 0.0;
        rJacobian[2][8] = -(mDt * (5.223529411764706 * var_x114 * var_x131 * var_x188 * var_x24));
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = 0.0;
        rJacobian[3][0] = -(mDt * (var_x194 * (var_x189 * var_chaste_interface__ryr__Jrelp - var_x189 * var_chaste_interface__ryr__Jrelnp)));
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (-var_x195 + 0.25 * (-var_x196 + 0.01 * var_chaste_interface__intracellular_ions__cansr - 0.01 * var_chaste_interface__intracellular_ions__cajsr) / (pow(var_x190, 3) * pow((0.125 + var_x191), 2))));
        rJacobian[3][4] = -(mDt * (var_x195));
        rJacobian[3][5] = -(mDt * (var_x194 * (var_x197 * var_chaste_interface__ryr__Jrelnp - var_x197 * var_chaste_interface__ryr__Jrelp)));
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = 0.0;
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = -(mDt * (var_x194 * (-1.0 + var_x28)));
        rJacobian[3][11] = -(mDt * (-var_x193 * var_x28));
        rJacobian[4][0] = -(mDt * ((0.00085312500000000004 * var_x19 - 0.0023460937500000001 * var_x16) * mParameters[1]));
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = -(mDt * ((var_x134 + var_x135 - 0.015640625000000002 * var_x31 - 0.0056875000000000007 * var_x32) * mParameters[1]));
        ...
        rJacobian[4][5] = -(mDt * ((1.7595703125000003e-7 * var_x139 - 6.3984375000000009e-8 * var_x138) * mParameters[1]));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = 0.0;
        rJacobian[4][11] = 0.0;
        rJacobian[5][0] = -(mDt * (var_x221 * (var_x216 * (var_x211 - var_x215) + (var_x198 * var_chaste_interface__ryr__Jrelnp - var_x198 * var_chaste_interface__ryr__Jrelp) * mParameters[0])));
        rJacobian[5][1] = -(mDt * (var_x216 * var_x220 * (-var_x227 - var_x232)));
        rJacobian[5][2] = -(mDt * (5.0 * var_x220));
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (var_x221 * (-5.0 + var_x216 * (var_x297 - var_x293 - var_x294 - var_x298 + 1.9799999999999999e-8 * var_x292 + var_x280 * var_x283) + (var_x233 * var_chaste_interface__ryr__Jrelp - var_x233 * var_chaste_interface__ryr__Jrelnp) * mParameters[0]) + (0.019557600000000001 / pow(var_x217, 3) + 8.1780000000000006e-5 / pow(var_x218, 3)) * (5.0 * var_chaste_interface__intracellular_ions__cai + 0.23999999999999996 * var_x196 - 5.0 * var_chaste_interface__intracellular_ions__cass + var_x216 * (-var_x299 - var_x300 + var_x283 * var_x291)) / pow(var_x219, 2)));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = -(mDt * (44.400000000000006 * var_x131 * var_x220 * var_x282 * var_x336));
        rJacobian[5][10] = -(mDt * (var_x221 * (0.23999999999999996 - var_x337) * mParameters[0]));
        rJacobian[5][11] = -(mDt * (var_x220 * var_x337 * mParameters[0]));
        rJacobian[6][0] = -(mDt * (var_x346 * (var_x340 * var_x341 - var_x341 * var_x342)));
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = -(mDt * (-4.524657697636969e-6 * var_x131 * var_x347 * var_x348 * var_x351 * (-var_x344 * log(var_x350 * (0.018329999999999999 * mParameters[4] + mParameters[3])) + var_chaste_interface__membrane__v) / pow(var_x349, 2)));
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (var_x346 * (var_x342 * var_x352 - var_x340 * var_x352)));
        rJacobian[6][6] = 1.0 - (mDt * (-0.014705882352941176 + var_x345 * (var_x441 + (6.0045682186055913e-14 * var_x439 + 4.2270410939725255e-12 * var_x405 - 0.28603867298173646 * var_x436 + var_x389 * var_x402 + var_x418 * var_x423 + var_x427 * var_x429 + var_x430 * var_x434 - var_x424 * var_x426 - var_x430 * var_x432 - var_x430 * var_x438) * mParameters[17] + var_x440 * (-4.0 * var_x26 * var_x340 - 4.0 * var_x29 * var_x342) * mParameters[18] - 0.59999999999999998 * var_x440 * mParameters[9] / (_lt_0_row[3]) - 1.2 * var_x442 * mParameters[12] * var_chaste_interface__IK1__xk1 / (1.0 + exp(11.145054250500367 + 0.10534077741493732 * var_chaste_interface__membrane__v - 0.27388602127883704 * mParameters[3])) - 0.55943092778551573 * var_x442 * (var_x443 * var_chaste_interface__IKr__xrf + (1.0 - var_x443) * var_chaste_interface__IKr__xrs) * mParameters[14] / ((_lt_0_row[4]) * (_lt_0_row[5])))));
        rJacobian[6][7] = -(mDt * (0.014705882352941176));
        rJacobian[6][8] = -(mDt * (var_x345 * (0.018329999999999999 * var_x441 + (0.094579082877241191 * var_x472 + 7.8273835706822894e-14 * var_x439 + 5.5102499974998986e-12 * var_x405 - 13.72985630312335 * var_x471 + var_x402 * var_x457 + var_x423 * var_x467 + var_x429 * var_x469 + var_x434 * var_x470 - var_x426 * var_x468 - var_x432 * var_x470 - var_x438 * var_x470) * mParameters[17])));
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = 0.0;
        rJacobian[7][0] = -(mDt * (-var_x478 * (6.4331999999999993e-5 * var_x214 * var_x477 - 7.0765200000000005e-5 * var_x206 * var_x477)));
        rJacobian[7][1] = -(mDt * (-var_x478 * (0.00047176800000000001 * var_x476 * var_x479 + 0.00042888000000000003 * var_x476 * var_x480)));
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = -(mDt * (-var_x478 * (5.307390000000001e-9 * var_x206 * var_x481 - 4.8249000000000006e-9 * var_x214 * var_x481)));
        rJacobian[7][6] = -(mDt * (0.5));
        rJacobian[7][7] = 1.0 - (mDt * (-0.5 - var_x478 * (0.00035382600000000001 * var_x483 + 0.00032165999999999998 * var_x484)));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[8][0] = -(mDt * (var_x345 * (var_x489 * (var_x485 * var_chaste_interface__INaL__hLp - var_x485 * var_chaste_interface__INaL__hL) - var_x494 * (var_x189 * var_x491 - var_x189 * var_x492))));
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = -(mDt * (var_x345 * (-1.1879999999999999e-7 * var_x125 - var_x112 * var_x495)));
        rJacobian[8][3] = 0.0;
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = -(mDt * (var_x345 * (var_x489 * (var_x496 * var_chaste_interface__INaL__hL - var_x496 * var_chaste_interface__INaL__hLp) - var_x494 * (var_x197 * var_x492 - var_x197 * var_x491))));
        rJacobian[8][6] = -(mDt * (var_x345 * (0.4290580094726047 * var_x436 - 9.0068523279083876e-14 * var_x439 - 6.3405616409587878e-12 * var_x405 + var_x424 * var_x498 + var_x430 * var_x500 + var_x430 * var_x503 - var_x389 * var_x497 - var_x418 * var_x499 - var_x427 * var_x501 - var_x430 * var_x502) * mParameters[17]));
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (-0.014705882352941176 + var_x345 * ((20.594784454685026 * var_x471 - 0.14186862431586178 * var_x472 - 8.2653749962498475e-12 * var_x405 - 1.1741075356023433e-13 * var_x439 + var_x468 * var_x498 + var_x470 * var_x500 + var_x470 * var_x503 - var_x457 * var_x497 - var_x467 * var_x499 - var_x469 * var_x501 - var_x470 * var_x502) * mParameters[17] - var_x188 * var_x495 + var_x488 * var_x505 * (-0.59999999999999998 * var_x26 * var_chaste_interface__INaL__hLp - 0.59999999999999998 * var_x29 * var_chaste_interface__INaL__hL) - var_x493 * var_x505 * (var_x28 * var_x492 + var_x29 * var_x491) - 3.75e-10 * var_x127 * var_x504 / (-1.0 + var_x504))));
        rJacobian[8][9] = -(mDt * (0.014705882352941176));
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[9][0] = -(mDt * (var_x478 * (0.0002475 * var_x206 * var_x507 - 0.00022499999999999999 * var_x214 * var_x507)));
        rJacobian[9][1] = -(mDt * (var_x478 * (-0.0016500000000000002 * var_x479 * var_x506 - 0.0015 * var_x480 * var_x506)));
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = 0.0;
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = -(mDt * (var_x478 * (-2.9699999999999998e-8 * var_x292 - var_x280 * var_x508 + 1.6875000000000001e-8 * var_x214 * var_x509 - 1.8562500000000002e-8 * var_x206 * var_x509)));
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = -(mDt * (0.5));
        rJacobian[9][9] = 1.0 - (mDt * (-0.5 + var_x478 * (-0.0011249999999999999 * var_x484 - 0.0012375000000000001 * var_x483 - var_x336 * var_x508)));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = 0.0;
        rJacobian[10][0] = -(mDt * (((var_x516) ? (-var_x510 * var_x513) : (-var_x517 * var_x520))));
        rJacobian[10][1] = -(mDt * (((var_x516) ? (-var_x513 * var_x521) : (-var_x521 * var_x522))));
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = -(mDt * (((var_x516) ? (-741.35040390184417 * var_x524) : (-0.0025894736842105265 * var_x525 * (-var_chaste_interface__ryr__Jrelnp - 2.375 * var_x526) - 0.74135040390184426 * var_x519 * var_x524))));
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = -(mDt * (((var_x516) ? (-var_x513 * var_x527) : (-var_x522 * var_x527))));
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (((var_x516) ? (-1000.0) : (-0.21052631578947367 - var_x518))));
        rJacobian[10][11] = 0.0;
        rJacobian[11][0] = -(mDt * (((var_x529) ? (-var_x510 * var_x528) : (-var_x517 * var_x532))));
        rJacobian[11][1] = -(mDt * (((var_x529) ? (-var_x521 * var_x528) : (-var_x521 * var_x533))));
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = -(mDt * (((var_x529) ? (-926.68800487730527 * var_x524) : (-0.0020715789473684213 * var_x525 * (-var_chaste_interface__ryr__Jrelp - 2.96875 * var_x526) - 0.92668800487730529 * var_x524 * var_x531))));
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = -(mDt * (((var_x529) ? (-var_x527 * var_x528) : (-var_x527 * var_x533))));
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (((var_x529) ? (-1000.0) : (-0.16842105263157894 - var_x530))));
    }

    void Cellohara_rudy_2011_epiFromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    void Cellohara_rudy_2011_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        CardiacNewtonSolver<12,Cellohara_rudy_2011_epiFromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<12,Cellohara_rudy_2011_epiFromCellMLBackwardEuler>::Instance();
    ...
    std::vector<double> Cellohara_rudy_2011_epiFromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellohara_rudy_2011_epiFromCellMLBackwardEuler>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellohara_rudy_2011_epiFromCellMLBackwardEuler)
