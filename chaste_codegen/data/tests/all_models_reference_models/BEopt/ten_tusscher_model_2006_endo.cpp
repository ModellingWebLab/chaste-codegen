...
class Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables(const Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables&);
    Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables& operator= (const Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables&);
    Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables()
    {
        ...
        Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables> Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler::Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler::~Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    
    void Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler::VerifyStateVariables()
    {
    ...
    double Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[7], double rResidual[7])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -86.709
...
// LCOV_EXCL_STOP
    ...
    void Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -86.709
...
// LCOV_EXCL_STOP
    ...
    void Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    void Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        CardiacNewtonSolver<7,Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<7,Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler>::Instance();
    ...
    std::vector<double> Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2006_endoFromCellMLBackwardEuler>::Initialise(void)
{
