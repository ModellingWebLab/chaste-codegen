...
class CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables()
    {
...
protected:
    CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables(const CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables&);
    CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables& operator= (const CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables&);
    CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables()
    {
        ...
        CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables> CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> CellFaberRudy2000FromCellMLBackwardEulerOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellFaberRudy2000FromCellMLBackwardEulerOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    CellFaberRudy2000FromCellMLBackwardEulerOpt::CellFaberRudy2000FromCellMLBackwardEulerOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<CellFaberRudy2000FromCellMLBackwardEulerOpt>::Instance();
        Init();
    ...
    CellFaberRudy2000FromCellMLBackwardEulerOpt::~CellFaberRudy2000FromCellMLBackwardEulerOpt()
    {
    }

    AbstractLookupTableCollection* CellFaberRudy2000FromCellMLBackwardEulerOpt::GetLookupTableCollection()
    {
        return CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables::Instance();
    }
    
    double CellFaberRudy2000FromCellMLBackwardEulerOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellFaberRudy2000FromCellMLBackwardEulerOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void CellFaberRudy2000FromCellMLBackwardEulerOpt::ComputeResidual(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rResidual[12])
    {
...
// LCOV_EXCL_STOP
    ...
    void CellFaberRudy2000FromCellMLBackwardEulerOpt::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -90.0
...
// LCOV_EXCL_STOP
        ...
        const double var_x8 = _lt_0_row[6];
        ...
        const double var_x15 = _lt_0_row[4];
        ...
        const double var_x32 = _lt_0_row[7] * mParameters[0] * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr;
        const double var_x33 = pow(var_chaste_interface__transient_outward_current_zdv_gate__zdv, 3) * mParameters[2] * var_chaste_interface__transient_outward_current_ydv_gate__ydv * _lt_0_row[8];
        ...
        const double var_x52 = _lt_0_row[0];
        ...
        const double var_x59 = -var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR;
        ...
        const double var_x63 = 60000.0 * var_x59 * var_x61 * var_x62;
        ...
        const double var_x71 = 60000.0 * var_x58 * var_x61 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x72 = var_x62 * var_x71;
        const double var_x73 = 4000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2;
        const double var_x74 = 4000.0 - var_x73;
        const double var_x75 = var_chaste_interface__calcium_dynamics__OVRLDtrack2 > 0;
        const double var_x76 = ((var_x65) ? (var_x72) : ((var_x75) ? (var_x74 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x77 = ((var_x65) ? (var_x64 * var_chaste_interface__calcium_dynamics__APtrack2) : ((var_x75) ? (var_x59 * var_x73 * (1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2)) : (0)));
        const double var_x78 = ((var_x65) ? (-var_x72) : ((var_x75) ? ((-4000.0 + var_x73) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x79 = ((var_x65) ? (var_x59 * var_x71 - 60000.0 * var_x58 * var_x59 * var_x62 * var_chaste_interface__calcium_dynamics__APtrack2 / pow(var_x60, 2)) : (0));
        const double var_x80 = ((var_x65) ? (0) : ((var_x75) ? (var_x59 * var_x74 + (4000.0 * var_chaste_interface__calcium_dynamics__Cai - 4000.0 * var_chaste_interface__calcium_dynamics__Ca_JSR) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x81 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x82 = 1 / var_x81;
        const double var_x83 = var_chaste_interface__calcium_dynamics__Cai / pow(var_x81, 2);
        const double var_x84 = 0.0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x85 = pow(var_x49, (-2));
        const double var_x86 = 1.0 + 0.00011900000000000002 / pow(var_x84, 2) + 3.5000000000000004e-5 * var_x85;
        const double var_x87 = 1 / var_x86;
        const double var_x88 = 7.0588235294117632e-6 * var_x87;
        const double var_x89 = 0.71029411764705874 * var_x82;
        const double var_x90 = var_x14 * pow(var_x15, 2) / pow(var_x16, 2);
        const double var_x91 = var_x44 / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x92 = var_x50 + 0.040282206767891383 * var_x34 + 0.6678084676374566 * var_x34 * var_x51 - 1.1499999999999999 * var_x85 * var_chaste_interface__calcium_dynamics__Cai - 0.0046811535814444347 * var_x54 * var_x91 + var_x52 * var_x53 * var_x55;
        const double var_x93 = 1 / M_PI;
        const double var_x94 = 0.090316078310111333 * var_x93;
        const double var_x95 = var_x12 * var_x4;
        const double var_x96 = var_x17 * var_x95;
        const double var_x97 = var_x90 * var_x95;
        const double var_x98 = 9.0316078310111333e-5 * var_x93;
        ...
        const double var_x101 = var_x43 * var_x91;
        const double var_x102 = 0.00018063215662022267 * var_x93;
        const double var_x103 = var_x19 * var_x2 / pow(var_x20, 2);
        const double var_x104 = var_x39 * (-0.433 - 0.25979999999999998 * var_x37) * (0.14451785951707913 * var_chaste_interface__ionic_concentrations__Ki + 0.0026490123649480601 * var_chaste_interface__ionic_concentrations__Nai) / pow(var_x38, 2);
        const double var_x105 = var_x12 * var_x46;
        const double var_x106 = var_x7 / (var_x11 * pow((0.01 + var_x5), 2));
        
        
        rJacobian[0][0] = 1.0 - (mDt * ((((var_x56 + 0.00025000000000000001 * var_x18 + 0.0070160275741043606 * var_chaste_interface__membrane__V - 0.10684935482199306 * var_x1 - 7.3656881518639831e-7 * var_x3 + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 0.5 * var_x33 * var_x9 + 16.0 * var_x31 * (-26.712338705498265 * var_x1 + var_chaste_interface__membrane__V) + 1.6875 * var_x7 / (1.0 + 100.0 * var_x5) + 0.0055199999999999997 * var_x8 * var_x9 + 0.433 * var_x40 * (1.0 + 0.59999999999999998 * var_x37) + 0.0024381008236689767 * var_x42 * var_x46 + 0.00069711623550831479 * var_x46 * var_x47 + 698.34626081908675 * var_x30 * var_x9 + 0.023862446088641735 * var_x32 * var_x9) / mParameters[3] < -150000.0) ? (-100.5) : (-0.5))));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = 0.0;
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = 0.0;
        ...
        rJacobian[2][11] = 0.0;
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = -(mDt * (-var_x66 * var_x70));
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (var_x70 * (-5.5555555555555554 - var_x76) + 0.00025000000000000001 * (-var_x77 + 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR) / (pow(var_x67, 3) * pow((0.125 + var_x68), 2))));
        rJacobian[3][4] = -(mDt * (0.0055555555555555558 * var_x69));
        rJacobian[3][5] = -(mDt * (-var_x70 * var_x78));
        rJacobian[3][6] = -(mDt * (-var_x70 * var_x79));
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = -(mDt * (-var_x70 * var_x80));
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = 0.0;
        rJacobian[4][0] = 0.0;
        ...
        rJacobian[4][5] = -(mDt * (0.0087500000000000008 * var_x82 - 0.0087500000000000008 * var_x83));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        ...
        rJacobian[4][11] = 0.0;
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = -(mDt * (var_x66 * var_x88));
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (var_x76 * var_x88));
        rJacobian[5][4] = -(mDt * (4.7352941176470584e-5 * var_x87));
        rJacobian[5][5] = 1.0 - (mDt * (0.001 * var_x87 * (-var_x89 + 0.71029411764705874 * var_x83 + 0.0070588235294117632 * var_x78 - var_x94 * (var_x92 + 1149.9839999999999 * var_x17 + 0.11499840000000001 * var_x90)) + 0.001 * (0.00023800000000000004 / pow(var_x84, 3) + 7.0000000000000007e-5 / pow(var_x49, 3)) * (0.047352941176470584 * var_chaste_interface__calcium_dynamics__Ca_NSR + 0.0070588235294117632 * var_x77 - var_x89 * var_chaste_interface__calcium_dynamics__Cai - var_x94 * (var_x56 + 0.003016 * var_chaste_interface__membrane__V - 0.00050000000000000001 * var_x18)) / pow(var_x86, 2)));
        rJacobian[5][6] = -(mDt * (var_x79 * var_x88));
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = -(mDt * (var_x80 * var_x88));
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = -(mDt * (-var_x87 * var_x98 * (2.7000000000000001e-7 * var_x97 - 0.0027000000000000001 * var_x96)));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (((var_x99) ? (-var_x98 * (var_x92 + 574.99199999999996 * var_x17 + 0.057499200000000007 * var_x90)) : (0))));
        rJacobian[6][6] = 1.0 - (mDt * ((((var_x99) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-0.5))));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = -(mDt * (((var_x99) ? (-var_x98 * (1.35e-7 * var_x97 - 0.0013500000000000001 * var_x96)) : (0))));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        ...
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * ((((var_x100) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50.0) : (-0.5))));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[9][0] = 0.0;
        ...
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        rJacobian[9][9] = 1.0 - (mDt * ((((var_x100) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50.0) : (-0.01))));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = 0.0;
        rJacobian[10][0] = 0.0;
        rJacobian[10][1] = 0.0;
        ...
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = -(mDt * (var_x102 * (4.1826974130498884e-7 * var_x101 * var_x47 - 2.3575679435995052e-7 * var_x34 * var_x35 * var_x40 / pow(var_x36, 2))));
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (var_x102 * (184.83763041301756 * var_x104 - 0.00052283717663123607 * var_x105 - 7.3656881518639831e-7 * var_x2 - 18654.461852717679 * var_x2 * var_x30 - 0.63742174226149029 * var_x2 * var_x32 - 0.14745210965435041 * var_x2 * var_x8 - 13.356169352749133 * var_x2 * var_x33 + 4449.089151873166 * var_x103 * var_x29 * var_x9 - 0.00067122862439358594 * var_x21 * var_x9 * (6498.310636886562 * var_x103 - 1000.0 * var_x24 * (1.053972635420138 * var_x2 * var_x25 + 1.6494869150645177 * var_x2 * var_x26) - 13738.155796237757 * var_x2 * var_x22 * var_x27 / pow(var_x23, 2)) / pow((var_x21 + 0.98039215686274506 * var_x28), 2))));
        rJacobian[10][11] = -(mDt * (var_x102 * (3.3880737654706117 * var_x104 + 0.067500000000000004 * var_x106)));
        rJacobian[11][0] = 0.0;
        rJacobian[11][1] = 0.0;
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = -(mDt * (var_x102 * (0.1724976 * var_x90 + 1724.9760000000001 * var_x17 + 1.4628604942013857e-6 * var_x101 * var_x42)));
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x102 * (4.0500000000000004e-7 * var_x97 - 0.0040499999999999998 * var_x96 - 0.10684935482199306 * var_x0 - 0.0018285756177517324 * var_x105 - 0.10125000000000001 * var_x106 - 427.39741928797224 * var_x0 * var_x31)));
    }

    void CellFaberRudy2000FromCellMLBackwardEulerOpt::UpdateTransmembranePotential(double var_chaste_interface__environment__time_converted)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    void CellFaberRudy2000FromCellMLBackwardEulerOpt::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        CardiacNewtonSolver<12,CellFaberRudy2000FromCellMLBackwardEulerOpt>* _p_solver = CardiacNewtonSolver<12,CellFaberRudy2000FromCellMLBackwardEulerOpt>::Instance();
    ...
    std::vector<double> CellFaberRudy2000FromCellMLBackwardEulerOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<CellFaberRudy2000FromCellMLBackwardEulerOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellFaberRudy2000FromCellMLBackwardEulerOpt)
