...
class Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables(const Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables&);
    Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables& operator= (const Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables&);
    Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables()
    {
        ...
        Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables> Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    double Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::~Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    double Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[8], double rResidual[8])
    {
...
// LCOV_EXCL_STOP
    ...
    void Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[8], double rJacobian[8][8])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -81.18
...
// LCOV_EXCL_STOP
    ...
    void Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    void Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        CardiacNewtonSolver<8,Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<8,Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler>::Instance();
    ...
    std::vector<double> Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellcourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler)
