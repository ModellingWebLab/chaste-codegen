...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = 480.0 * exp(0.14285714285714285 * var_chaste_interface__membrane__Vm);
            ...
            {
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = 0.27000000000000002 * exp(-0.16949152542372881 * var_chaste_interface__membrane__Vm);
            ...
            {
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = exp(-0.0025000000000000001 * var_chaste_interface__membrane__Vm);
            ...
            {
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = exp(-0.125 * var_chaste_interface__membrane__Vm);
            ...
            {
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = exp(0.00125 * var_chaste_interface__membrane__Vm);
            ...
            {
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = 1300.0 * exp(0.050000000000000003 * var_chaste_interface__membrane__Vm);
            ...
            {
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = 26.0 * exp(0.058823529411764705 * var_chaste_interface__membrane__Vm);
            ...
            {
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = 0.25 * exp(-0.02 * var_chaste_interface__membrane__Vm);
