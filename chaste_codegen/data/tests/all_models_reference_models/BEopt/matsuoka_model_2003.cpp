...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            _lookup_table_0 = new double[_table_size_0][49];
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 480.0 * exp(0.14285714285714285 * var_chaste_interface__membrane__Vm);
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 0.27000000000000002 * exp(-0.16949152542372881 * var_chaste_interface__membrane__Vm);
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return exp(-0.0025000000000000001 * var_chaste_interface__membrane__Vm);
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return exp(-0.125 * var_chaste_interface__membrane__Vm);
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return exp(0.00125 * var_chaste_interface__membrane__Vm);
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1300.0 * exp(0.050000000000000003 * var_chaste_interface__membrane__Vm);
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 26.0 * exp(0.058823529411764705 * var_chaste_interface__membrane__Vm);
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 0.25 * exp(-0.02 * var_chaste_interface__membrane__Vm);
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
...
private:
    ...
    double _lookup_table_0_row[49];

    // Lookup tables
    double (*_lookup_table_0)[49];
    int _lookup_table_0_num_misshit_piecewise[49] = {0};
...
// LCOV_EXCL_STOP
        ...
        const double var_x75 = 1 / (_lt_0_row[41] + 2.2000000000000002 * exp(var_x74));
        const double var_x76 = var_x75;
        const double var_x77 = 1.5 * exp(-var_x74) + _lt_0_row[42];
        ...
        const double var_x120 = _lt_0_row[5];
        ...
        const double var_x132 = _lt_0_row[6] / (1.0 + 669921.875 * (1.0 + 0.7246376811594204 * mParameters[5]) / var_x131);
        ...
        const double var_x232 = _lt_0_row[43];
        const double var_x233 = _lt_0_row[44];
        const double var_x234 = 1 / (5.0 * var_x232 + 0.0001027 * var_x233);
        const double var_x235 = -var_x234;
        const double var_x236 = _lt_0_row[45];
        const double var_x237 = _lt_0_row[46] + 0.040000000000000001 * var_x236;
        const double var_x238 = 1.25 / var_x232;
        const double var_x239 = 1 / (_lt_0_row[47] + 0.02 * var_x236);
        const double var_x240 = var_x239;
        const double var_x241 = _lt_0_row[48] + 0.1027 * var_x233;
        ...
        rJacobian[18][13] = 0.0;
        rJacobian[18][14] = 0.0;
        rJacobian[18][15] = -(mDt * (var_x62 * (3.7000000000000002 - 3.7000000000000002 * var_chaste_interface__slow_time_dependent_potassium_current_y2_gate__y2)));
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_ultra_slow_gate__alpha_y = 1 / (_lt_0_row[8]);
        const double var_L_type_Ca_channel_ultra_slow_gate__beta_y = 1 / (_lt_0_row[9]);
        const double var_T_type_Ca_channel_y1_gate__alpha_y1 = 1 / (_lt_0_row[14]);
        const double var_T_type_Ca_channel_y1_gate__beta_y1 = 1 / (_lt_0_row[15]);
        const double var_T_type_Ca_channel_y2_gate__alpha_y2 = 1 / (_lt_0_row[16]);
        const double var_T_type_Ca_channel_y2_gate__beta_y2 = 1 / (_lt_0_row[17]);
        const double var_rapid_time_dependent_potassium_current_y1_gate__alpha_y1 = 1 / (_lt_0_row[19]);
        const double var_rapid_time_dependent_potassium_current_y1_gate__beta_y1 = _lt_0_row[18];
        const double var_rapid_time_dependent_potassium_current_y2_gate__alpha_y2 = 1 / (_lt_0_row[21]);
        const double var_rapid_time_dependent_potassium_current_y2_gate__beta_y2 = _lt_0_row[20];
        const double var_rapid_time_dependent_potassium_current_y3_gate__alpha_y3 = 1 / (_lt_0_row[22]);
        const double var_rapid_time_dependent_potassium_current_y3_gate__beta_y3 = 1 / (_lt_0_row[23]);
        const double var_slow_time_dependent_potassium_current_y1_gate__alpha_y1 = 1 / (_lt_0_row[24]);
        const double var_slow_time_dependent_potassium_current_y1_gate__beta_y1 = 1 / (_lt_0_row[25]);
        const double var_sodium_current_ultra_slow_gate__alpha_y = 1 / (_lt_0_row[28]);
        const double var_sodium_current_ultra_slow_gate__beta_y = 1 / (_lt_0_row[29]);
        const double var_transient_outward_current_y1_gate__alpha_y1 = 1 / (_lt_0_row[35]);
        const double var_transient_outward_current_y1_gate__beta_y1 = 1 / (_lt_0_row[36]);
        const double var_transient_outward_current_y2_gate__alpha_y2 = 0.0038 * _lt_0_row[38] / (_lt_0_row[37]);
        const double var_transient_outward_current_y2_gate__beta_y2 = 0.0038 * _lt_0_row[40] / (_lt_0_row[39]);
