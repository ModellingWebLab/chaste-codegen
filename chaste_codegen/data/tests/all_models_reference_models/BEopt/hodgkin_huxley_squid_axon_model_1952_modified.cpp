...
// LCOV_EXCL_STOP
        ...
        const double var_potassium_channel_n_gate__alpha_n = -0.01 * (65.0 + var_chaste_interface__membrane__V) / (_lt_0_row[1]);
        const double var_potassium_channel_n_gate__beta_n = 0.125 * _lt_0_row[0];
        const double var_sodium_channel_h_gate__alpha_h = 0.070000000000000007 * _lt_0_row[2];
        const double var_sodium_channel_h_gate__beta_h = 1 / (_lt_0_row[3]);
        const double var_sodium_channel_m_gate__alpha_m = -0.10000000000000001 * (50.0 + var_chaste_interface__membrane__V) / (_lt_0_row[5]);
        const double var_sodium_channel_m_gate__beta_m = 4.0 * _lt_0_row[4];
