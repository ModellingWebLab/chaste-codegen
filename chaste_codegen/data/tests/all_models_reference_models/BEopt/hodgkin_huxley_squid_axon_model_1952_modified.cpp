...
// LCOV_EXCL_STOP
        ...
        const double var_potassium_channel_n_gate__alpha_n = _lt_0_row[0];
        const double var_potassium_channel_n_gate__beta_n = 0.125 * _lt_0_row[1];
        ...
        const double var_sodium_channel_m_gate__beta_m = 4.0 * _lt_0_row[5];
