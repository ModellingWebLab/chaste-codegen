...
// LCOV_EXCL_STOP
        ...
        const double var_sodium_channel_h_gate__beta_h = _lt_0_row[3];
        const double var_sodium_channel_m_gate__alpha_m = -0.10000000000000001 * _lt_0_row[5] * (50.0 + var_chaste_interface__membrane__V);
