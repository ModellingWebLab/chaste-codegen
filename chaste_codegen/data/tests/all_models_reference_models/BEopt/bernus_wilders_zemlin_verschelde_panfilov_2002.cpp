...
class Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables(const Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables&);
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables& operator= (const Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables&);
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables()
    {
        ...
        Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.14710000000000001 + 0.63503954329583223 * exp(-0.89850709360569092 * pow((-1 + 0.044722719141323794 * var_chaste_interface__membrane__V), 2)) / sqrt(M_PI) - 0.25101580310038191 * exp(-0.088183122039937209 * pow((-1 + 0.15948963317384371 * var_chaste_interface__membrane__V), 2)) / sqrt(M_PI);
                };
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-0.89850709360569092 * pow((-1 + 0.044722719141323794 * var_chaste_interface__membrane__V), 2));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(0.012999999999999999 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-0.024 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1.0 + 0.10000000000000001 * exp(-0.024 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-0.036999999999999998 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.1245 * exp(-0.0037000000000000002 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1.0 + exp(3.9880601600000003 - 0.094299999999999995 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(0.70203392000000009 - 0.0166 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.00057499999999999999 + (0.010999999999999999 + 0.069000000000000006 * exp(-108.07499999999999 - 11.0 * var_chaste_interface__membrane__V)) / (1.0 + exp(-2.7313499999999999 - 0.27800000000000002 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1.0 + exp(-1.0056535947712419 + 0.16339869281045752 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.98799999999999999 / (1.0 + exp(-0.86099999999999999 - 0.062 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 222.0 + 240.0 * exp(-4.1682692307692308 * pow((1 + 0.039215686274509803 * var_chaste_interface__membrane__V), 2)) + 182.0 * tanh(0.154 + 0.011599999999999999 * var_chaste_interface__membrane__V) - 40.0 * tanh(160.0 + 2.0 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return -0.5 * tanh(7.7400000000000002 + 0.12 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.25 + 2.2400000000000002 * (1.0 - tanh(7.7400000000000002 + 0.12 * var_chaste_interface__membrane__V)) / (1.0 - tanh(6.4680000000000009 + 0.070000000000000007 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1.0 + exp(-5.9326369200000002 - 0.17319999999999999 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 5.6119999999999998e-5 * var_chaste_interface__membrane__V + 0.072099999999999997 * exp(-5.9257863000000004 - 0.17299999999999999 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1.0 + exp(-5.4573693999999993 - 0.16039999999999999 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.0001215 * var_chaste_interface__membrane__V + 0.076700000000000004 * exp(-5.6479010000000002e-8 - 1.6600000000000001e-9 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
private:
    ...
    static std::shared_ptr<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler::Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler::~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);

        const double var_calcium_current__E_Ca = 13.306520728999949 * log(mParameters[3] / mParameters[0]); // millivolt
        const double var_delayed_rectifier_potassium_current__E_K = 26.613041457999898 * log(mParameters[4] / mParameters[1]); // millivolt
        ...
        const double var_sodium_current__i_Na_converted = pow(var_chaste_interface__sodium_current_m_gate__m, 3) * pow(var_chaste_interface__sodium_current_v_gate__v, 2) * (-var_sodium_current__E_Na + var_chaste_interface__membrane__V) * HeartConfig::Instance()->GetCapacitance() * mParameters[8]; // uA_per_cm2
        const double var_sodium_potassium_pump__i_NaK = 1.3 * mParameters[4] / ((1.0 + 31.622776601683793 * pow((1 / mParameters[2]), 1.5)) * (1.5 + mParameters[4]) * (1.0 + _lt_0_row[6] + 0.036499999999999998 * (-0.14280000000000001 + 0.14280000000000001 * exp(0.01485884101040119 * mParameters[5])) * _lt_0_row[5])); // picoA_per_picoF
        const double var_transient_outward_current__i_to = 0.21063999999999999 * (-26.613041457999898 * log((mParameters[4] + 0.042999999999999997 * mParameters[5]) / (mParameters[1] + 0.042999999999999997 * mParameters[2])) + var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_to_gate__to * _lt_0_row[9] / ((_lt_0_row[7]) * (_lt_0_row[8])); // picoA_per_picoF
    ...
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
...
// LCOV_EXCL_STOP
        ...
        const double var_delayed_rectifier_potassium_current__E_K = 26.613041457999898 * log(mParameters[4] / mParameters[1]); // millivolt
        const double var_sodium_current__E_Na = 26.613041457999898 * log(mParameters[5] / mParameters[2]); // millivolt
        const double d_dt_chaste_interface_var_membrane__V = (0.001 * var_sodium_current__E_Na + 0.00084999999999999995 * var_calcium_current__E_Ca - 0.0018500000000000001 * var_chaste_interface__membrane__V - GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() - 0.019 * pow(var_chaste_interface__delayed_rectifier_potassium_current_X_gate__X, 2) * (-var_delayed_rectifier_potassium_current__E_K + var_chaste_interface__membrane__V) - pow(var_chaste_interface__sodium_current_m_gate__m, 3) * pow(var_chaste_interface__sodium_current_v_gate__v, 2) * (-var_sodium_current__E_Na + var_chaste_interface__membrane__V) * mParameters[8] - 1000.0 * (pow(mParameters[2], 3) * mParameters[3] * _lt_0_row[2] - pow(mParameters[5], 3) * mParameters[0] * _lt_0_row[3]) / ((_lt_0_row[4]) * (669921.875 + pow(mParameters[5], 3)) * (1.3799999999999999 + mParameters[3])) - 0.10000000000000001 * (-var_delayed_rectifier_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[9] / ((1.0 + exp(-12.0 + 0.059999999999999998 * var_chaste_interface__membrane__V - 0.059999999999999998 * var_delayed_rectifier_potassium_current__E_K)) * (0.10000000000000001 / (1.0 + exp(-12.0 + 0.059999999999999998 * var_chaste_interface__membrane__V - 0.059999999999999998 * var_delayed_rectifier_potassium_current__E_K)) + (3.0 * exp(0.02 + 0.00020000000000000001 * var_chaste_interface__membrane__V - 0.00020000000000000001 * var_delayed_rectifier_potassium_current__E_K) + exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__V - 0.10000000000000001 * var_delayed_rectifier_potassium_current__E_K)) / (1.0 + exp(0.5 * var_delayed_rectifier_potassium_current__E_K - 0.5 * var_chaste_interface__membrane__V)))) - 1.3 * mParameters[4] / ((1.0 + 31.622776601683793 * pow((1 / mParameters[2]), 1.5)) * (1.5 + mParameters[4]) * (1.0 + _lt_0_row[6] + 0.036499999999999998 * (-0.14280000000000001 + 0.14280000000000001 * exp(0.01485884101040119 * mParameters[5])) * _lt_0_row[5])) - 0.21063999999999999 * (-26.613041457999898 * log((mParameters[4] + 0.042999999999999997 * mParameters[5]) / (mParameters[1] + 0.042999999999999997 * mParameters[2])) + var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_to_gate__to * _lt_0_row[9] / ((_lt_0_row[7]) * (_lt_0_row[8])) - 0.63503954329583223 * (-var_calcium_current__E_Ca + var_chaste_interface__membrane__V) * mParameters[6] * var_chaste_interface__calcium_current_f_gate__f * _lt_0_row[1] / (sqrt(M_PI) * (1.0 + 1666.6666666666667 * mParameters[0]) * (_lt_0_row[0]))) / mParameters[7]; // millivolt / millisecond
        
        rY[0] += mDt*d_dt_chaste_interface_var_membrane__V;
    }
    
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        const double var_calcium_current_f_gate__alpha_f = 0.0068700000000000002 / (_lt_0_row[11]);
        const double var_calcium_current_f_gate__beta_f = _lt_0_row[10];
        ...
        const double var_transient_outward_current_to_gate__beta_to = (_lt_0_row[21]) / (_lt_0_row[20]);
        
        
        rY[5] = (var_chaste_interface__delayed_rectifier_potassium_current_X_gate__X + ((var_delayed_rectifier_potassium_current_X_gate__X_infinity / var_delayed_rectifier_potassium_current_X_gate__tau_X) * mDt)) / (1.0 - ((-1 / var_delayed_rectifier_potassium_current_X_gate__tau_X) * mDt));
        rY[3] = (var_chaste_interface__calcium_current_f_gate__f + ((var_calcium_current_f_gate__alpha_f) * mDt)) / (1.0 - ((-var_calcium_current_f_gate__alpha_f - var_calcium_current_f_gate__beta_f) * mDt));
        rY[1] = (var_chaste_interface__sodium_current_m_gate__m + ((var_sodium_current_m_gate__alpha_m) * mDt)) / (1.0 - ((-var_sodium_current_m_gate__alpha_m - var_sodium_current_m_gate__beta_m) * mDt));
        rY[2] = (var_chaste_interface__sodium_current_v_gate__v + ((var_sodium_current_v_gate__v_infinity / var_sodium_current_v_gate__tau_v) * mDt)) / (1.0 - ((-1 / var_sodium_current_v_gate__tau_v) * mDt));
        rY[4] = (var_chaste_interface__transient_outward_current_to_gate__to + ((var_transient_outward_current_to_gate__alpha_to) * mDt)) / (1.0 - ((-var_transient_outward_current_to_gate__alpha_to - var_transient_outward_current_to_gate__beta_to) * mDt));
        
    }

    std::vector<double> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLBackwardEuler)
