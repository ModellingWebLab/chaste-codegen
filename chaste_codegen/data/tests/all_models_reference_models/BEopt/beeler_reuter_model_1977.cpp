...
// LCOV_EXCL_STOP
        ...
        const double var_slow_inward_current_d_gate__alpha_d = 0.095000000000000001 * _lt_0_row[4] / (_lt_0_row[3]);
        const double var_slow_inward_current_d_gate__beta_d = 0.070000000000000007 * _lt_0_row[6] / (_lt_0_row[5]);
        const double var_slow_inward_current_f_gate__alpha_f = 0.012 * _lt_0_row[8] / (_lt_0_row[7]);
        const double var_slow_inward_current_f_gate__beta_f = 0.0064999999999999997 * _lt_0_row[10] / (_lt_0_row[9]);
        ...
        const double var_sodium_current_m_gate__alpha_m = -(47.0 + var_chaste_interface__membrane__V) / (_lt_0_row[12]);
        const double var_sodium_current_m_gate__beta_m = 40.0 * _lt_0_row[11];
        const double var_time_dependent_outward_current_x1_gate__alpha_x1 = 0.00050000000000000001 * _lt_0_row[14] / (_lt_0_row[13]);
        const double var_time_dependent_outward_current_x1_gate__beta_x1 = 0.0012999999999999999 * _lt_0_row[16] / (_lt_0_row[15]);
