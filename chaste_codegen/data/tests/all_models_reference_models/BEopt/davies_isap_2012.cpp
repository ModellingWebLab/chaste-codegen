...
class Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables(const Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables&);
    Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables& operator= (const Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables&);
    Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables()
    {
        ...
        Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables> Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Celldavies_isap_2012FromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    double Celldavies_isap_2012FromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celldavies_isap_2012FromCellMLBackwardEuler::Celldavies_isap_2012FromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celldavies_isap_2012FromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Celldavies_isap_2012FromCellMLBackwardEuler::~Celldavies_isap_2012FromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Celldavies_isap_2012FromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    double Celldavies_isap_2012FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celldavies_isap_2012FromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Celldavies_isap_2012FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__Environment__time, const double rCurrentGuess[13], double rResidual[13])
    {
...
// LCOV_EXCL_STOP
    ...
    void Celldavies_isap_2012FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: mV; Initial value: -93.2932771154856
...
// LCOV_EXCL_STOP
        ...
        const double var_x1 = 3.0760371441184366e-5 * mParameters[8];
        const double var_x2 = var_x1 / var_x0;
        ...
        const double var_x17 = pow(var_x0, (-2));
        const double var_x18 = 0.00035514705882352943 * var_chaste_interface__Ca__Ca_i;
        const double var_x19 = var_x14 / pow(var_x12, 2);
        ...
        const double var_x23 = 0.11110649918090373 * mParameters[6] * var_chaste_interface__cell__V / (-1.0 + var_x22);
        const double var_x24 = pow(mParameters[3], 3);
        const double var_x25 = 1.5 * var_x24;
        const double var_x26 = -1004882.8125 - var_x25 - 775361.25000000012 * mParameters[0];
        const double var_x27 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x28 = (1.0 + 416.66666666666669 * var_chaste_interface__Ca__Ca_i) * mParameters[0];
        const double var_x29 = var_x27 * mParameters[0];
        const double var_x30 = var_x24 * (1.0 + 0.00053738391835633597 * var_x27);
        const double var_x31 = _lt_0_row[1];
        const double var_x32 = 1 / (1.0 + 0.27000000000000002 * var_x31);
        const double var_x33 = 1.0 + 6.9444444444444451e-9 / pow(var_chaste_interface__Ca__Ca_i, 2);
        const double var_x34 = 1 / var_x33;
        const double var_x35 = _lt_0_row[0];
        const double var_x36 = var_x25 * var_chaste_interface__Ca__Ca_i;
        const double var_x37 = var_x29 * var_x35 - var_x31 * var_x36;
        const double var_x38 = var_x32 * var_x34 * var_x37 * mParameters[15];
        const double var_x39 = var_x38 / pow((1.2936831875607387e-6 * var_x27 + 0.0018518248862973764 * var_x28 + 9.9514091350826051e-7 * var_x29 + 3.5825072886297377e-9 * var_x30 + 1.4927113702623908e-6 * var_x24 * var_chaste_interface__Ca__Ca_i + var_chaste_interface__Ca__Ca_i), 2);
        const double var_x40 = 6.0924326210094507e-17 * var_x39;
        const double var_x41 = 1 / (var_x29 + var_x36 + 1004882.8125 * var_chaste_interface__Ca__Ca_i + 0.0035999999999999999 * var_x30 + 1.3 * var_x27 + 1860.8670000000004 * var_x28);
        const double var_x42 = var_x32 * var_x41 * mParameters[15];
        const double var_x43 = var_x37 * var_x42 / (pow(var_x33, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
        const double var_x44 = var_x34 * var_x42;
        const double var_x45 = var_x24 * var_x31 * var_x44;
        const double var_x46 = 0.0023800000000000002 + var_chaste_interface__Ca__Ca_i;
        const double var_x47 = 1.0 + 0.00011900000000000002 / pow(var_x46, 2) + 3.5000000000000004e-5 * var_x17;
        ...
        const double var_x52 = var_x3 * var_x51 / pow(var_x5, 2);
        const double var_x53 = var_x10 * var_x52;
        const double var_x54 = var_x8 / pow(var_x9, 2);
        const double var_x55 = var_x52 * var_x54;
        const double var_x56 = 5.6250000000000005e-5 * var_x53 - 5.6250000000000005e-5 * var_x55;
        const double var_x57 = var_x13 * var_x18;
        const double var_x58 = 1.2750000000000002e-8 * var_x53 - 1.2750000000000002e-8 * var_x55;
        const double var_x59 = 1 - var_x7;
        const double var_x60 = var_x10 * var_x59;
        const double var_x61 = var_x54 * (-1 + var_x7);
        const double var_x62 = 0.75 * var_x60 + 0.75 * var_x61;
        ...
        const double var_x66 = -3 * var_x65 - 3.9000000000000004 * var_x64 - 5.8037463182484285e-6 * var_x24 * var_x64;
        const double var_x67 = var_x35 * var_x44 * var_x65;
        const double var_x68 = exp(-1.1230765052339999 + var_x21);
        const double var_x69 = var_x50 + var_x68 * var_chaste_interface__Ca__Ca_ss;
        const double var_x70 = -1.0 + var_x68;
        const double var_x71 = (-15.0 + var_chaste_interface__cell__V) * mParameters[4] / var_x70;
        ...
        const double var_x76 = var_x75 * var_chaste_interface__Irel__ro;
        const double var_x77 = var_x76 * var_chaste_interface__Irel__ri;
        const double var_x78 = 3000.0 * var_x77;
        ...
        const double var_x84 = var_x83 * var_chaste_interface__Irel__ri;
        const double var_x85 = var_x68 * var_x71;
        const double var_x86 = var_x73 * var_x84 * var_x85 * var_chaste_interface__Irel__ro / pow(var_x74, 2);
        const double var_x87 = var_x76 * var_x83;
        const double var_x88 = 3000.0 * var_x81;
        const double var_x89 = var_x75 * var_x84;
        const double var_x90 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x91 = var_x19 * var_x90;
        const double var_x92 = var_x13 * var_x90;
        const double var_x93 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss;
        const double var_x94 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x95 = 1.0 + 0.0097788000000000007 / pow(var_x93, 2) + 4.0890000000000003e-5 / pow(var_x94, 2);
        const double var_x96 = 1 / var_x95;
        const double var_x97 = 719.99999999999989 * var_x77;
        const double var_x98 = pow(var_chaste_interface__ICaL__d, var_chaste_interface__ICaL__dp);
        const double var_x99 = var_x98 * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca * var_chaste_interface__ICaL__fca2;
        const double var_x100 = var_x85 * var_x99;
        const double var_x101 = var_x72 * var_x99;
        const double var_x102 = var_x72 * var_x98 * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2;
        const double var_x103 = var_x102 * var_chaste_interface__ICaL__fca2;
        const double var_x104 = 15.110483888602907 * var_x96;
        const double var_x105 = var_x102 * var_chaste_interface__ICaL__fca;
        const double var_x106 = 719.99999999999989 * var_x96;
        const double var_x107 = 1 / var_chaste_interface__Cl__Cl_i;
        const double var_x108 = 0.0374358835078 * var_chaste_interface__cell__V;
        const double var_x109 = exp(var_x108);
        const double var_x110 = 0.22221299836180747 * mParameters[17] * var_chaste_interface__cell__V / (1.0 - var_x109);
        const double var_x111 = log(var_x107 * mParameters[1]);
        const double var_x112 = 1 / var_chaste_interface__K__K_i;
        const double var_x113 = log(var_x112 * mParameters[2]);
        const double var_x114 = 26.712338705500134 * var_x113;
        const double var_x115 = var_x114 + 26.712338705500134 * var_x111;
        const double var_x116 = 0.00018900582374463672 / (87.825100000000006 + var_x115);
        const double var_x117 = 2.4504050574883893e-8 * var_x115 / pow((1 + 0.30415380916731244 * var_x111 + 0.30415380916731244 * var_x113), 2);
        const double var_x118 = var_x107 * var_x117 - var_x107 * var_x116;
        const double var_x119 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x120 = var_x111 + log(var_x119 * mParameters[3]);
        const double var_x121 = pow(var_x120, 4);
        const double var_x122 = 2.8839711417381356e-9 * pow(var_x120, 7) / pow((1 + 0.008558014922736952 * var_x121), 2);
        const double var_x123 = 20.048989239405216 * pow(var_x120, 3) / (59494197.640692554 + 509152.23122530844 * var_x121);
        const double var_x124 = var_x107 * var_x122 - var_x107 * var_x123;
        const double var_x125 = var_x112 * var_x117 - var_x112 * var_x116;
        const double var_x126 = var_x119 * var_x122 - var_x119 * var_x123;
        const double var_x127 = 1 / (1.0 + 333.33333333333331 * var_chaste_interface__Ca__Ca_ss);
        const double var_x128 = 10.0 * var_x11;
        const double var_x129 = 1 / (0.5 + var_x128 + var_x127);
        const double var_x130 = pow((0.0030000000000000001 + var_chaste_interface__Ca__Ca_ss), (-2));
        const double var_x131 = -var_x101;
        const double var_x132 = 1.0382056293271026e-6 / pow((3.4606854310903424e-6 + var_x131), 2);
        const double var_x133 = 0.00075000000000000002 * var_x55 - 0.00075000000000000002 * var_x53;
        const double var_x134 = 0.01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x127 + 0.29999999999999999 / (1.0 - 288960.09762000659 * var_x101)) / pow((0.050000000000000003 + var_x11 + 0.10000000000000001 * var_x127), 2);
        const double var_x135 = -10.0 * var_x60 - 10.0 * var_x61;
        const double var_x136 = exp(-4.375 - 361200.12202500831 * var_x101);
        const double var_x137 = 1.0 + var_x136;
        const double var_x138 = 1 / var_x137;
        const double var_x139 = 1 / (125.0 + 300.0 * var_x138);
        const double var_x140 = 6.9213708621806839e-7 / pow((6.9213708621806839e-7 + var_x131), 2);
        const double var_x141 = var_x139 * var_x140;
        const double var_x142 = 1204.0004067500277 * var_x136 * (-var_chaste_interface__ICaL__fca2 + 1 / (1.0 - 1444800.4881000333 * var_x101)) / (pow(var_x137, 2) * pow((0.41666666666666669 + var_x138), 2));
        const double var_x143 = 0.0025000000000000005 * var_x6;
        const double var_x144 = exp(3.3333333333333335 + 963200.32540002221 * var_x101);
        const double var_x145 = 1.0 + var_x144;
        const double var_x146 = 1 / var_x145;
        const double var_x147 = exp(-15.0 + 5000.0 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_x146);
        const double var_x148 = 1.0 + var_x147;
        const double var_x149 = 1 / var_x148;
        const double var_x150 = var_x144 / pow(var_x145, 2);
        const double var_x151 = var_x100 * var_x150;
        const double var_x152 = 350.0 - var_x128;
        const double var_x153 = var_x147 * var_x152 / pow(var_x148, 2);
        const double var_x154 = var_x149 * var_x152;
        const double var_x155 = exp(-16.0 + 80.0 * var_x146 + 40000.0 * var_chaste_interface__Ca__Ca_ss);
        const double var_x156 = 1.0 + var_x155;
        const double var_x157 = (-var_chaste_interface__Irel__ri + 1 / var_x156) / pow((0.29999999999999999 + var_x11 + 0.10000000000000001 * var_x154), 2);
        const double var_x158 = 0.01 * var_x157;
        const double var_x159 = 1 / (3.0 + var_x128 + var_x154);
        const double var_x160 = var_x155 * var_x159 / pow(var_x156, 2);
        const double var_x161 = var_x103 * var_x150;
        const double var_x162 = 77056026.032001764 * var_x160;
        const double var_x163 = 144480.04881000333 * var_x153 * var_x157;
        const double var_x164 = var_x105 * var_x150;
        const double var_x165 = pow(var_chaste_interface__ICaL__fca, (-2));
        const double var_x166 = pow((-1 + 0.066666666666666666 * var_chaste_interface__cell__V), (-2));
        const double var_x167 = pow(var_x70, 2);
        const double var_x168 = pow(var_x69, (-2));
        const double var_x169 = pow(var_chaste_interface__ICaL__d, (-2 * var_chaste_interface__ICaL__dp));
        const double var_x170 = pow(var_chaste_interface__ICaL__f, (-2));
        const double var_x171 = pow(var_chaste_interface__ICaL__f2, (-2));
        const double var_x172 = pow(var_chaste_interface__ICaL__fca2, (-2));
        const double var_x173 = pow(mParameters[4], (-2));
        const double var_x174 = var_x166 * var_x167 * var_x168 * var_x169 * var_x170 * var_x171 * var_x172 * var_x173;
        const double var_x175 = 1.0 + 2.1291277605263905e-11 * var_x165 * var_x174;
        const double var_x176 = 1 / var_x175;
        const double var_x177 = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999);
        const double var_x178 = 0.0028 + var_chaste_interface__Ca__Ca_ss;
        const double var_x179 = 1 / var_x178;
        const double var_x180 = pow((var_x179 * var_chaste_interface__Ca__Ca_ss), 1.8999999999999999);
        const double var_x181 = 1 / (var_x177 + 1644.6531773416521 * var_x180);
        const double var_x182 = var_x176 / pow((var_x180 + 0.00060803092942449902 * var_x177), 2);
        const double var_x183 = 1.4194185070175937e-11 * var_x177 * var_x181 / pow(var_x175, 2);
        const double var_x184 = var_x165 * var_x166 * var_x167 * var_x169 * var_x170 * var_x171 * var_x173 * var_x183;
        const double var_x185 = 1 / var_chaste_interface__Ca__Ca_i;
        const double var_x186 = pow(var_x185, 1.3999999999999999);
        const double var_x187 = 1.0 + 6.4818210260626455e-7 * var_x186;
        const double var_x188 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
        const double var_x189 = mParameters[14] * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2;
        const double var_x190 = 26.712338705500134 * var_x112;
        const double var_x191 = var_x190 * pow(var_chaste_interface__Ito__ydv, 3) * mParameters[18] * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv;
        const double var_x192 = sqrt(mParameters[2]);
        const double var_x193 = var_x112 * var_x192;
        const double var_x194 = var_x188 * var_x189 * (1.0 + 0.59999999999999998 / var_x187);
        const double var_x195 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 6.370892781261781 * var_x113);
        const double var_x196 = 1.0 + var_x195;
        const double var_x197 = 1 / var_x196;
        const double var_x198 = exp(-2.4444678999999998 + 13.738155796238718 * var_x113 - 0.51429999999999998 * var_chaste_interface__cell__V);
        const double var_x199 = 1.0 + var_x198;
        const double var_x200 = 1 / var_x199;
        const double var_x201 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * var_x113);
        const double var_x202 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 2.1455350448257708 * var_x113);
        const double var_x203 = var_x201 + 0.49124000000000001 * var_x202;
        const double var_x204 = var_x200 * var_x203;
        const double var_x205 = 1 / (var_x204 + 1.02 * var_x197);
        const double var_x206 = var_x197 * mParameters[10];
        const double var_x207 = var_x112 * var_x195 / pow(var_x196, 2);
        const double var_x208 = var_x192 * (-var_x114 + var_chaste_interface__cell__V);
        const double var_x209 = 26.712338705500134 * var_x194 + var_x190 * mParameters[12] / (_lt_0_row[11]) + 13.623292739805068 * var_x193 * var_x205 * var_x206 + 13.356169352750067 * var_x193 * mParameters[13] * var_chaste_interface__IKr__xr / (_lt_0_row[12]) + 0.49019607843137253 * var_x206 * var_x208 * (6.4983106368870169 * var_x207 - var_x200 * (1.6494869150646332 * var_x112 * var_x201 + 1.0539726354202117 * var_x112 * var_x202) - 13.738155796238718 * var_x112 * var_x198 * var_x203 / pow(var_x199, 2)) / pow((var_x197 + 0.98039215686274506 * var_x204), 2) - 3.2491553184435085 * var_x205 * var_x207 * var_x208 * mParameters[10];
        const double var_x210 = mParameters[2] * mParameters[16] / (var_x27 * (1.5 + mParameters[2]) * pow((0.01 + 1 / var_x64), 2) * (1.0 + _lt_0_row[4] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[3])) * exp(-var_x108)));
        const double var_x211 = 1.827729786302835e-16 * var_x39;
        const double var_x212 = 0.0016433629212878199 * var_x119;
        
        
        rJacobian[0][0] = 1.0 - (mDt * (var_x49 * (-0.14705882352941174 + var_x20 - var_x16 - var_x2 + 8.544547622551213e-13 * var_x43 - 9.2281114323553099e-5 * var_x45 + var_x26 * var_x40 - var_x22 * var_x23 + var_x1 * var_x17 * var_chaste_interface__Ca__Ca_i) + (0.00023800000000000004 / pow(var_x46, 3) + 7.0000000000000007e-5 / pow(var_x0, 3)) * (0.14705882352941174 * var_chaste_interface__Ca__Ca_ss + 2.3676470588235295e-5 * var_chaste_interface__Ca__Ca_nsr - 0.14705882352941174 * var_chaste_interface__Ca__Ca_i - var_x16 * var_chaste_interface__Ca__Ca_i - var_x2 * var_chaste_interface__Ca__Ca_i - var_x23 * (var_x50 + var_x22 * var_chaste_interface__Ca__Ca_i) + 6.1520742882368733e-5 * var_x38 * var_x41) / pow(var_x47, 2)));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = -(mDt * (2.3676470588235295e-5 * var_x48));
        rJacobian[0][3] = -(mDt * (var_x49 * (0.14705882352941174 - var_x20 * var_x58 - var_x56 * var_x57)));
        rJacobian[0][4] = 0.0;
        rJacobian[0][5] = 0.0;
        rJacobian[0][6] = 0.0;
        rJacobian[0][7] = -(mDt * (var_x49 * (-var_x20 * var_x63 - var_x57 * var_x62)));
        rJacobian[0][8] = 0.0;
        rJacobian[0][9] = 0.0;
        rJacobian[0][10] = 0.0;
        rJacobian[0][11] = 0.0;
        rJacobian[0][12] = -(mDt * (var_x49 * (0.0001845622286471062 * var_x67 + var_x40 * var_x66)));
        rJacobian[1][0] = 0.0;
        ...
        rJacobian[1][3] = -(mDt * (var_x82 * (var_x78 + 8668802.9286001995 * var_x86)));
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[1][7] = 0.0;
        rJacobian[1][8] = -(mDt * (-var_x87 * var_x88));
        rJacobian[1][9] = -(mDt * (-var_x88 * var_x89));
        rJacobian[1][10] = 0.0;
        rJacobian[1][11] = 0.0;
        rJacobian[1][12] = 0.0;
        rJacobian[2][0] = -(mDt * (-var_x91 + 0.0043750000000000004 * var_x15));
        rJacobian[2][1] = -(mDt * (0.00072463768115942019));
        rJacobian[2][2] = 1.0 - (mDt * (-0.0010163043478260869));
        rJacobian[2][3] = -(mDt * (var_x56 * var_x92 + var_x58 * var_x91));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = -(mDt * (var_x62 * var_x92 + var_x63 * var_x91));
        rJacobian[2][8] = 0.0;
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = 0.0;
        rJacobian[2][12] = 0.0;
        rJacobian[3][0] = -(mDt * (5.0 * var_x96));
        rJacobian[3][1] = -(mDt * (var_x96 * var_x97));
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (var_x96 * (-5.0 - var_x97 - 15.110483888602907 * var_x100 - 2080512.7028640476 * var_x86) + (0.019557600000000001 / pow(var_x93, 3) + 8.1780000000000006e-5 / pow(var_x94, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 15.110483888602907 * var_x101 + var_x83 * var_x97) / pow(var_x95, 2)));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (-var_x103 * var_x104));
        rJacobian[3][6] = -(mDt * (-var_x104 * var_x105));
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = -(mDt * (var_x106 * var_x87));
        rJacobian[3][9] = -(mDt * (var_x106 * var_x89));
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = 0.0;
        rJacobian[3][12] = 0.0;
        rJacobian[4][0] = 0.0;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (var_x118 + var_x124 + var_x110 * var_chaste_interface__Ito2__AA - 0.0016433629212878199 * var_x107 * mParameters[7]));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = -(mDt * (var_x110 * (-var_x109 * mParameters[1] + var_chaste_interface__Cl__Cl_i)));
        rJacobian[4][11] = -(mDt * (var_x125));
        rJacobian[4][12] = -(mDt * (var_x126));
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (var_x129 * (-0.0016500000000000002 * var_x130 + var_x100 * var_x132) + var_x134 * (var_x133 + 0.0030000000000000001 * var_x130)));
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (var_x129 * (-1 + var_x103 * var_x132)));
        rJacobian[5][6] = -(mDt * (var_x105 * var_x129 * var_x132));
        rJacobian[5][7] = -(mDt * (var_x134 * var_x135));
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = 0.0;
        ...
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = -(mDt * (var_x100 * var_x141 - var_x100 * var_x142));
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (var_x103 * var_x141 - var_x103 * var_x142));
        rJacobian[6][6] = 1.0 - (mDt * (var_x139 * (-1 + var_x105 * var_x140) - var_x105 * var_x142));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = -(mDt * (3.7500000000000005e-6 * var_x52 * var_x8 + 1.8750000000000003e-7 * var_x51 * pow(var_x3, 2) / pow(var_x5, 3)));
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-0.00068000000000000005 - var_x143 * var_x8 + var_x143 * var_x3 * var_x59));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        ...
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = -(mDt * (var_x158 * (var_x133 + var_x153 * (5000.0 - 14448004.881000333 * var_x151) - var_x133 * var_x149) - var_x160 * (40000.0 - 77056026.032001764 * var_x151)));
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = -(mDt * (var_x161 * var_x162 - var_x161 * var_x163));
        rJacobian[8][6] = -(mDt * (var_x162 * var_x164 - var_x163 * var_x164));
        rJacobian[8][7] = -(mDt * (var_x158 * (var_x135 - var_x135 * var_x149)));
        rJacobian[8][8] = 1.0 - (mDt * (-var_x159));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = -(mDt * (-2.3414435371998602e-7 * var_x182 * pow(var_chaste_interface__Ca__Ca_jsr, 2.7999999999999998) + 0.6333333333333333 * var_x176 * var_x181 * pow(var_chaste_interface__Ca__Ca_jsr, 0.89999999999999991)));
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = -(mDt * (var_x172 * var_x184 * var_x68 / pow(var_x69, 3) - 0.00020267697647483301 * var_x177 * var_x178 * var_x180 * var_x182 * var_x4 * (1.8999999999999999 * var_x179 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x178, 2))));
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = -(mDt * (var_x174 * var_x183 / pow(var_chaste_interface__ICaL__fca, 3)));
        rJacobian[9][6] = -(mDt * (var_x168 * var_x184 / pow(var_chaste_interface__ICaL__fca2, 3)));
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        ...
        rJacobian[10][1] = 0.0;
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = -(mDt * (0.1502 * var_x51 / pow((1.0 + 0.1502 * var_x4), 2)));
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = 0.0;
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        ...
        rJacobian[10][11] = 0.0;
        rJacobian[10][12] = 0.0;
        rJacobian[11][0] = -(mDt * (-3.3496381359330236e-11 * var_x185 * var_x186 * var_x189 * (-26.712338705500134 * log(var_x188 * (0.018329999999999999 * mParameters[3] + mParameters[2])) + var_chaste_interface__cell__V) / pow(var_x187, 2)));
        rJacobian[11][1] = 0.0;
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = -(mDt * (var_x118));
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x125 - 6.1520742882368733e-5 * ((var_chaste_interface__cell__V <= 0) ? (var_x209 + var_x191 * exp(var_chaste_interface__cell__V / mParameters[19])) : (var_x191 + var_x209))));
        rJacobian[11][12] = -(mDt * (2.460829715294749e-6 * var_x210 - 3.0122842347205738e-5 * var_x194));
        rJacobian[12][0] = -(mDt * (0.00027684334297065928 * var_x45 - 2.563364286765364e-12 * var_x43 - var_x211 * var_x26));
        rJacobian[12][1] = 0.0;
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (var_x124));
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = 0.0;
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x126 - 3.6912445729421236e-6 * var_x210 - 0.00055368668594131857 * var_x67 - var_x211 * var_x66 - var_x212 * pow(var_chaste_interface__INal__mL, 3) * mParameters[11] * var_chaste_interface__INal__hL - var_x212 * pow(var_chaste_interface__INa__m, 3) * mParameters[9] * var_chaste_interface__INa__H * var_chaste_interface__INa__J));
    }

    void Celldavies_isap_2012FromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__Environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    void Celldavies_isap_2012FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        const double var_ICaL__dpss = 9.0 + _lt_0_row[13];
        ...
        const double var_INa__am = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__cell__V) / (_lt_0_row[29]);
        ...
        const double var_INal__amL = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__cell__V) / (_lt_0_row[29]);
        ...
        const double var_Ito__ay = 25.0 * _lt_0_row[32] / (_lt_0_row[31]);
        const double var_Ito__ay2 = 0.029999999999999999 / (_lt_0_row[35]);
        const double var_Ito__ay3 = 0.0022499999999999998 / (_lt_0_row[35]);
        const double var_Ito__by = 25.0 * _lt_0_row[34] / (_lt_0_row[33]);
        const double var_Ito__by2 = 0.20000000000000001 * _lt_0_row[37] / (_lt_0_row[36]);
        const double var_Ito__by3 = 0.10000000000000001 * _lt_0_row[37] / (_lt_0_row[36]);
        ...
        CardiacNewtonSolver<13,Celldavies_isap_2012FromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<13,Celldavies_isap_2012FromCellMLBackwardEuler>::Instance();
    ...
    std::vector<double> Celldavies_isap_2012FromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celldavies_isap_2012FromCellMLBackwardEuler>::Initialise(void)
{
