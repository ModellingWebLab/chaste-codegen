...
// LCOV_EXCL_STOP
        ...
        const double var_x136 = -26.712338705500134 * var_x135 * mParameters[7];
        const double var_x137 = var_x6 < 2.671233870550013e-6;
        const double var_x138 = 0.0374358835078 * var_chaste_interface__cell__V;
        const double var_x139 = exp(var_x138);
        const double var_x140 = var_x10 * mParameters[17] / (1.0 - var_x139);
        const double var_x141 = log(var_x135 * mParameters[1]);
        const double var_x142 = 1 / var_chaste_interface__K__K_i;
        const double var_x143 = log(var_x142 * mParameters[2]);
        const double var_x144 = 26.712338705500134 * var_x143;
        const double var_x145 = var_x144 + 26.712338705500134 * var_x141;
        const double var_x146 = 0.00018900582374463672 / (87.825100000000006 + var_x145);
        const double var_x147 = 2.4504050574883893e-8 * var_x145 / pow((1 + 0.30415380916731244 * var_x141 + 0.30415380916731244 * var_x143), 2);
        const double var_x148 = var_x135 * var_x147 - var_x135 * var_x146;
        const double var_x149 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x150 = var_x141 + log(var_x149 * mParameters[3]);
        const double var_x151 = pow(var_x150, 4);
        const double var_x152 = 2.8839711417381356e-9 * pow(var_x150, 7) / pow((1 + 0.008558014922736952 * var_x151), 2);
        const double var_x153 = 20.048989239405216 * pow(var_x150, 3) / (59494197.640692554 + 509152.23122530844 * var_x151);
        const double var_x154 = var_x135 * var_x152 - var_x135 * var_x153;
        const double var_x155 = var_x134 * (-var_x3 * mParameters[1] + var_chaste_interface__Cl__Cl_i);
        const double var_x156 = var_x142 * var_x147 - var_x142 * var_x146;
        const double var_x157 = var_x149 * var_x152 - var_x149 * var_x153;
        const double var_x158 = 1 / (1.0 + 333.33333333333331 * var_chaste_interface__Ca__Ca_ss);
        const double var_x159 = 10.0 * var_x23;
        const double var_x160 = 1 / (0.5 + var_x159 + var_x158);
        const double var_x161 = pow((0.0030000000000000001 + var_chaste_interface__Ca__Ca_ss), (-2));
        const double var_x162 = -var_x126;
        const double var_x163 = 0.014999999999999999 / pow((0.050000000000000003 + var_x162), 2);
        const double var_x164 = 0.00075000000000000002 * var_x65 - 0.00075000000000000002 * var_x63;
        const double var_x165 = 0.01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x158 + 0.29999999999999999 / (1.0 - 20.0 * var_x126)) / pow((0.050000000000000003 + var_x23 + 0.10000000000000001 * var_x158), 2);
        const double var_x166 = -10.0 * var_x70 - 10.0 * var_x71;
        const double var_x167 = exp(-4.375 - 25.0 * var_x126);
        const double var_x168 = 1.0 + var_x167;
        const double var_x169 = 1 / var_x168;
        const double var_x170 = 1 / (125.0 + 300.0 * var_x169);
        const double var_x171 = 0.01 / pow((0.01 + var_x162), 2);
        const double var_x172 = var_x170 * var_x171;
        const double var_x173 = 0.083333333333333329 * var_x167 * (-var_chaste_interface__ICaL__fca2 + 1 / (1.0 - 100.0 * var_x126)) / (pow(var_x168, 2) * pow((0.41666666666666669 + var_x169), 2));
        const double var_x174 = 0.0025000000000000005 * var_x18;
        const double var_x175 = exp(3.3333333333333335 + 66.666666666666671 * var_x126);
        const double var_x176 = 1.0 + var_x175;
        const double var_x177 = 1 / var_x176;
        const double var_x178 = exp(-15.0 + 5000.0 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_x177);
        const double var_x179 = 1.0 + var_x178;
        const double var_x180 = 1 / var_x179;
        const double var_x181 = var_x175 / pow(var_x176, 2);
        const double var_x182 = var_x125 * var_x181;
        const double var_x183 = 350.0 - var_x159;
        const double var_x184 = var_x178 * var_x183 / pow(var_x179, 2);
        const double var_x185 = var_x180 * var_x183;
        const double var_x186 = exp(-16.0 + 80.0 * var_x177 + 40000.0 * var_chaste_interface__Ca__Ca_ss);
        const double var_x187 = 1.0 + var_x186;
        const double var_x188 = (-var_chaste_interface__Irel__ri + 1 / var_x187) / pow((0.29999999999999999 + var_x23 + 0.10000000000000001 * var_x185), 2);
        const double var_x189 = 0.01 * var_x188;
        const double var_x190 = 1 / (3.0 + var_x159 + var_x185);
        const double var_x191 = var_x186 * var_x190 / pow(var_x187, 2);
        const double var_x192 = var_x128 * var_x181;
        const double var_x193 = 5333.333333333333 * var_x191;
        const double var_x194 = 10.0 * var_x184 * var_x188;
        const double var_x195 = var_x130 * var_x181;
        const double var_x196 = var_x85 * mParameters[4];
        const double var_x197 = var_x88 - 5.1546799999759483e-8 * var_x196 * var_x84;
        const double var_x198 = pow(var_x93, 2) / (pow((-1 + 0.066666666666666666 * var_chaste_interface__cell__V), 2) * pow(mParameters[4], 2));
        const double var_x199 = ((var_x90) ? (7.1354903911398109e-12 / pow(var_x197, 2)) : (2.1291277605263905e-11 * var_x198 / pow(var_x92, 2)));
        const double var_x200 = pow(var_chaste_interface__ICaL__d, (-2 * var_chaste_interface__ICaL__dp));
        const double var_x201 = pow(var_chaste_interface__ICaL__f, (-2));
        const double var_x202 = pow(var_chaste_interface__ICaL__f2, (-2));
        const double var_x203 = pow(var_chaste_interface__ICaL__fca, (-2));
        const double var_x204 = pow(var_chaste_interface__ICaL__fca2, (-2));
        const double var_x205 = var_x200 * var_x201 * var_x202 * var_x203 * var_x204;
        const double var_x206 = 1.0 + var_x199 * var_x205;
        const double var_x207 = 1 / var_x206;
        const double var_x208 = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999);
        const double var_x209 = 0.0028 + var_chaste_interface__Ca__Ca_ss;
        const double var_x210 = 1 / var_x209;
        const double var_x211 = pow((var_x210 * var_chaste_interface__Ca__Ca_ss), 1.8999999999999999);
        const double var_x212 = 1 / (var_x208 + 1644.6531773416521 * var_x211);
        const double var_x213 = var_x207 / pow((var_x211 + 0.00060803092942449902 * var_x208), 2);
        const double var_x214 = var_x208 * var_x212 / pow(var_x206, 2);
        const double var_x215 = 0.66666666666666663 * var_x199 * var_x200 * var_x201 * var_x202 * var_x214;
        const double var_x216 = 1 / var_chaste_interface__Ca__Ca_i;
        const double var_x217 = pow(var_x216, 1.3999999999999999);
        const double var_x218 = 1.0 + 6.4818210260626455e-7 * var_x217;
        const double var_x219 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
        const double var_x220 = mParameters[14] * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2;
        const double var_x221 = 26.712338705500134 * var_x142;
        const double var_x222 = var_x221 * pow(var_chaste_interface__Ito__ydv, 3) * mParameters[18] * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv;
        const double var_x223 = sqrt(mParameters[2]);
        const double var_x224 = var_x142 * var_x223;
        const double var_x225 = var_x219 * var_x220 * (1.0 + 0.59999999999999998 / var_x218);
        const double var_x226 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 6.370892781261781 * var_x143);
        const double var_x227 = 1.0 + var_x226;
        const double var_x228 = 1 / var_x227;
        const double var_x229 = exp(-2.4444678999999998 + 13.738155796238718 * var_x143 - 0.51429999999999998 * var_chaste_interface__cell__V);
        const double var_x230 = 1.0 + var_x229;
        const double var_x231 = 1 / var_x230;
        const double var_x232 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * var_x143);
        const double var_x233 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 2.1455350448257708 * var_x143);
        const double var_x234 = var_x232 + 0.49124000000000001 * var_x233;
        const double var_x235 = var_x231 * var_x234;
        const double var_x236 = 1 / (var_x235 + 1.02 * var_x228);
        const double var_x237 = var_x228 * mParameters[10];
        const double var_x238 = var_x142 * var_x226 / pow(var_x227, 2);
        const double var_x239 = var_x223 * (-var_x144 + var_chaste_interface__cell__V);
        const double var_x240 = 26.712338705500134 * var_x225 + var_x221 * mParameters[12] / (_lt_0_row[11]) + 13.623292739805068 * var_x224 * var_x236 * var_x237 + 13.356169352750067 * var_x224 * mParameters[13] * var_chaste_interface__IKr__xr / (_lt_0_row[12]) + 0.49019607843137253 * var_x237 * var_x239 * (6.4983106368870169 * var_x238 - var_x231 * (1.6494869150646332 * var_x142 * var_x232 + 1.0539726354202117 * var_x142 * var_x233) - 13.738155796238718 * var_x142 * var_x229 * var_x234 / pow(var_x230, 2)) / pow((var_x228 + 0.98039215686274506 * var_x235), 2) - 3.2491553184435085 * var_x236 * var_x238 * var_x239 * mParameters[10];
        const double var_x241 = mParameters[2] * mParameters[16] / (var_x36 * (1.5 + mParameters[2]) * pow((0.01 + 1 / var_x74), 2) * (1.0 + _lt_0_row[4] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[3])) * exp(-var_x138)));
        const double var_x242 = 1.827729786302835e-16 * var_x48;
        const double var_x243 = 0.0016433629212878199 * var_x149;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (var_x148 + var_x154 + 6.1520742882368733e-5 * ((var_x137) ? (var_x136 + (-var_x134 + (0.5 + 187179.41753900002 * var_chaste_interface__cell__V) * (var_x133 + var_x134)) * var_chaste_interface__Ito2__AA) : (var_x136 + var_x140 * var_chaste_interface__Ito2__AA))));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = -(mDt * (6.1520742882368733e-5 * ((var_x137) ? (-var_x155 + 187179.41753900002 * (2.671233870550013e-6 + var_chaste_interface__cell__V) * (var_x155 + var_x133 * (-var_x0 * mParameters[1] + var_chaste_interface__Cl__Cl_i))) : (var_x140 * (-var_x139 * mParameters[1] + var_chaste_interface__Cl__Cl_i)))));
        rJacobian[4][11] = -(mDt * (var_x156));
        rJacobian[4][12] = -(mDt * (var_x157));
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (var_x160 * (-0.0016500000000000002 * var_x161 + var_x125 * var_x163) + var_x165 * (var_x164 + 0.0030000000000000001 * var_x161)));
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (var_x160 * (-1 + var_x128 * var_x163)));
        rJacobian[5][6] = -(mDt * (var_x130 * var_x160 * var_x163));
        rJacobian[5][7] = -(mDt * (var_x165 * var_x166));
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = 0.0;
        ...
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = -(mDt * (var_x125 * var_x172 - var_x125 * var_x173));
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (var_x128 * var_x172 - var_x128 * var_x173));
        rJacobian[6][6] = 1.0 - (mDt * (var_x170 * (-1 + var_x130 * var_x171) - var_x130 * var_x173));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-0.00068000000000000005 - var_x174 * var_x20 + var_x15 * var_x174 * var_x69));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        ...
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = -(mDt * (var_x189 * (var_x164 + var_x184 * (5000.0 - 1000.0 * var_x182) - var_x164 * var_x180) - var_x191 * (40000.0 - 5333.333333333333 * var_x182)));
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = -(mDt * (var_x192 * var_x193 - var_x192 * var_x194));
        rJacobian[8][6] = -(mDt * (var_x193 * var_x195 - var_x194 * var_x195));
        rJacobian[8][7] = -(mDt * (var_x189 * (var_x166 - var_x166 * var_x180)));
        rJacobian[8][8] = 1.0 - (mDt * (-var_x190));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = -(mDt * (-2.3414435371998602e-7 * var_x213 * pow(var_chaste_interface__Ca__Ca_jsr, 2.7999999999999998) + 0.6333333333333333 * var_x207 * var_x212 * pow(var_chaste_interface__Ca__Ca_jsr, 0.89999999999999991)));
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = -(mDt * (-0.33333333333333331 * var_x205 * var_x214 * ((var_x90) ? (7.1354903911398109e-12 * (-2 * var_x108 * var_x78 + 1.0309359999951897e-7 * var_x196 * var_x83) / pow(var_x197, 3)) : (-4.258255521052781e-11 * var_x198 * var_x91 / pow(var_x92, 3))) - 0.00020267697647483301 * var_x16 * var_x208 * var_x209 * var_x211 * var_x213 * (1.8999999999999999 * var_x210 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x209, 2))));
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = -(mDt * (var_x204 * var_x215 / pow(var_chaste_interface__ICaL__fca, 3)));
        rJacobian[9][6] = -(mDt * (var_x203 * var_x215 / pow(var_chaste_interface__ICaL__fca2, 3)));
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        ...
        rJacobian[10][11] = 0.0;
        rJacobian[10][12] = 0.0;
        rJacobian[11][0] = -(mDt * (-3.3496381359330236e-11 * var_x216 * var_x217 * var_x220 * (-26.712338705500134 * log(var_x219 * (0.018329999999999999 * mParameters[3] + mParameters[2])) + var_chaste_interface__cell__V) / pow(var_x218, 2)));
        rJacobian[11][1] = 0.0;
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = -(mDt * (var_x148));
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x156 - 6.1520742882368733e-5 * ((var_chaste_interface__cell__V <= 0) ? (var_x240 + var_x222 * exp(var_chaste_interface__cell__V / mParameters[19])) : (var_x222 + var_x240))));
        rJacobian[11][12] = -(mDt * (2.460829715294749e-6 * var_x241 - 3.0122842347205738e-5 * var_x225));
        rJacobian[12][0] = -(mDt * (0.00027684334297065928 * var_x54 - 2.563364286765364e-12 * var_x52 - var_x242 * var_x35));
        rJacobian[12][1] = 0.0;
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x157 - 3.6912445729421236e-6 * var_x241 - 0.00055368668594131857 * var_x77 - var_x242 * var_x76 - var_x243 * pow(var_chaste_interface__INal__mL, 3) * mParameters[11] * var_chaste_interface__INal__hL - var_x243 * pow(var_chaste_interface__INa__m, 3) * mParameters[9] * var_chaste_interface__INa__H * var_chaste_interface__INa__J));
    }
...
// LCOV_EXCL_STOP
        ...
        const double var_INa__am = _lt_0_row[28];
        ...
        const double var_INal__amL = _lt_0_row[28];
