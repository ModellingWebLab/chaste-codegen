#ifndef CELLNYGREN_ATRIAL_MODEL_1998FROMCELLMLBACKWARDEULEROPT_HPP_
#define CELLNYGREN_ATRIAL_MODEL_1998FROMCELLMLBACKWARDEULEROPT_HPP_
...
class Cellnygren_atrial_model_1998FromCellMLBackwardEulerOpt : public AbstractBackwardEulerCardiacCell<16>
{
...
public:
    ...
    Cellnygren_atrial_model_1998FromCellMLBackwardEulerOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellnygren_atrial_model_1998FromCellMLBackwardEulerOpt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellnygren_atrial_model_1998FromCellMLBackwardEulerOpt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellnygren_atrial_model_1998FromCellMLBackwardEulerOpt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellnygren_atrial_model_1998FromCellMLBackwardEulerOpt(p_solver, p_stimulus);
        }
...
#endif // CELLNYGREN_ATRIAL_MODEL_1998FROMCELLMLBACKWARDEULEROPT_HPP_