...
class Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables(const Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables&);
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables& operator= (const Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables&);
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables()
    {
        ...
        Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables> Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    double Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler::Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler::~Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    double Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rResidual[32])
    {
...
// LCOV_EXCL_STOP
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rJacobian[32][32])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -82.4202
...
// LCOV_EXCL_STOP
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        CardiacNewtonSolver<32,Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<32,Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler>::Instance();
    ...
    std::vector<double> Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLBackwardEuler>::Initialise(void)
{
