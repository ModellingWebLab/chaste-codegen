...
class Celliribe_model_2006FromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celliribe_model_2006FromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celliribe_model_2006FromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane_potential__V)
    {
        ...
        const double* const _lt_0_row = Celliribe_model_2006FromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celliribe_model_2006FromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Celliribe_model_2006FromCellMLBackwardEuler_LookupTables(const Celliribe_model_2006FromCellMLBackwardEuler_LookupTables&);
    Celliribe_model_2006FromCellMLBackwardEuler_LookupTables& operator= (const Celliribe_model_2006FromCellMLBackwardEuler_LookupTables&);
    Celliribe_model_2006FromCellMLBackwardEuler_LookupTables()
    {
        ...
        Celliribe_model_2006FromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                const double var_chaste_interface__membrane_potential__V = mTableMins[0] + i*mTableSteps[0];
                double val = 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane_potential__V);
...
private:
    ...
    static std::shared_ptr<Celliribe_model_2006FromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Celliribe_model_2006FromCellMLBackwardEuler_LookupTables> Celliribe_model_2006FromCellMLBackwardEuler_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Celliribe_model_2006FromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    double Celliribe_model_2006FromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celliribe_model_2006FromCellMLBackwardEuler::Celliribe_model_2006FromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celliribe_model_2006FromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Celliribe_model_2006FromCellMLBackwardEuler::~Celliribe_model_2006FromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Celliribe_model_2006FromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Celliribe_model_2006FromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    double Celliribe_model_2006FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celliribe_model_2006FromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane_potential__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliribe_model_2006FromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane_potential__V);
    ...
    void Celliribe_model_2006FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[15], double rResidual[15])
    {
...
// LCOV_EXCL_STOP
    ...
    void Celliribe_model_2006FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[15], double rJacobian[15][15])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane_potential__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -92.849333
...
// LCOV_EXCL_STOP
        ...
        const double var_x114 = mParameters[5] / ((1.0 + mParameters[5]) * (1.0 + 0.035299999999999998 * exp(var_x23) + _lt_0_row[21]));
    ...
    void Celliribe_model_2006FromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time_converted)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane_potential__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    void Celliribe_model_2006FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane_potential__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_f_gate__beta_f = 50.0 * var_L_type_Ca_channel_f_gate__speed_f / (_lt_0_row[11]);
        ...
        const double var_time_dependent_rectifier_potassium_current_x_gate__alpha_x = 0.5 * _lt_0_row[15] / (_lt_0_row[14]);
        const double var_time_dependent_rectifier_potassium_current_x_gate__beta_x = 1.3 * _lt_0_row[17] / (_lt_0_row[16]);
        ...
        CardiacNewtonSolver<15,Celliribe_model_2006FromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<15,Celliribe_model_2006FromCellMLBackwardEuler>::Instance();
    ...
    std::vector<double> Celliribe_model_2006FromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celliribe_model_2006FromCellMLBackwardEuler>::Initialise(void)
{
