...
// LCOV_EXCL_STOP
        ...
        const double var_x31 = 0.001 * var_chaste_interface__Membrane__Vm_converted;
        const double var_x32 = 116045061550.51096 * var_x30 * (var_x31 + 4.3086710741444596e-12 * mParameters[12]);
        const double var_x33 = 0.001 * fabs(var_chaste_interface__Membrane__Vm_converted) < 4.3086710741444596e-12 * fabs(mParameters[12]);
        const double var_x34 = var_x30 * var_chaste_interface__Membrane__Vm_converted;
        const double var_x35 = exp(23.209012310102192 * var_x34);
        const double var_x36 = 1 / (-1.0 + var_x35);
        const double var_x37 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x38 = 1 / var_x37;
        const double var_x39 = 1 / var_chaste_interface__calcium_dynamics__Cai;
        const double var_x40 = exp(-7.5429290007832126 * var_x34);
        const double var_x41 = pow(mParameters[3], 3);
        const double var_x42 = var_x40 * var_x41;
        const double var_x43 = 1 / ((1.0 + 0.10000000000000001 * var_x40) * (669921.875 + var_x41) * (1.3799999999999999 + mParameters[1]));
        const double var_x44 = var_x42 * var_x43;
        const double var_x45 = mParameters[1] * exp(4.0615771542678836 * var_x34);
        ...
        const double var_x52 = 4478658.9572358271 * var_x23 * var_x34 * var_x36 * (var_x46 + var_x35 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x53 = var_x52 * var_chaste_interface__i_CaL_fCa_gate__fCa;
        const double var_x54 = var_x19 * mParameters[11];
        const double var_x55 = 588878.90051341965 * var_x54;
        const double var_x56 = var_x24 * var_chaste_interface__i_CaL_f1_gate__f1;
        const double var_x57 = var_x49 * var_x56;
        const double var_x58 = var_x43 * var_x45 * pow(var_chaste_interface__sodium_dynamics__Nai, 2);
        const double var_x59 = var_chaste_interface__calcium_dynamics__Cai <= 0.00035;
        const double var_x60 = var_x31 > -0.059999999999999998;
        ...
        const double var_x78 = mParameters[12] / var_chaste_interface__sodium_dynamics__Nai;
        const double var_x79 = mParameters[2] / ((1.0 + mParameters[2]) * (1.0 + 0.035299999999999998 * exp(-11.604506155051096 * var_x34) + 0.1245 * exp(-1.1604506155051095 * var_x34)));
        ...
        rJacobian[1][1] = 1.0 - (mDt * (var_x20 * (-0.00044443999999999999 - var_x15 + (-588878900.51341963 * ((var_x33) ? (-var_x29 + var_x32 * (var_x29 + var_x21 * var_x22 * var_x26)) : (4478658.9572358271 * var_x23 * var_x34 * var_x35 * var_x36 * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_fCa_gate__fCa)) - 242912546.46178558 * var_x38 - 16488611193008.854 * var_x44 + 242912546.46178558 * var_chaste_interface__calcium_dynamics__Cai / pow(var_x37, 2) - 17574.25418203068 * var_x39 * mParameters[12]) * mParameters[11]) + 4.9999999999999998e-7 * (var_x12 + var_x14 - var_x10 - var_x11 - 588878900.51341963 * (0.00069264000000000001 * var_chaste_interface__Membrane__Vm_converted + 0.41249999999999998 * var_x38 * var_chaste_interface__calcium_dynamics__Cai - 9800.0 * var_x43 * (var_x45 * pow(var_chaste_interface__sodium_dynamics__Nai, 3) - 2.8571431999999999 * var_x42 * var_chaste_interface__calcium_dynamics__Cai) - 2.9843579327954189e-5 * mParameters[12] * log(var_x39 * mParameters[1]) + ((var_x33) ? (-var_x51 + var_x32 * (var_x51 + var_x48 * var_chaste_interface__i_CaL_f1_gate__f1)) : (var_x53 * var_chaste_interface__i_CaL_f1_gate__f1))) * mParameters[11]) / (pow(var_x17, 3) * pow(var_x18, 2))));
        rJacobian[1][2] = -(mDt * (var_x20 * (0.33833519999999995 + var_x16) * var_chaste_interface__i_CaL_d_gate__d));
        rJacobian[1][3] = -(mDt * (-var_x55 * ((var_x33) ? (-var_x50 + var_x32 * (var_x48 + var_x50)) : (var_x53))));
        rJacobian[1][4] = -(mDt * (-var_x55 * ((var_x33) ? (-var_x57 + var_x32 * (var_x57 + var_x47 * var_x56)) : (var_x52 * var_chaste_interface__i_CaL_f1_gate__f1))));
        rJacobian[1][5] = -(mDt * (17313039675.094536 * var_x54 * var_x58));
        rJacobian[2][0] = 0.0;
        ...
        rJacobian[4][5] = 0.0;
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = -(mDt * (49465833579.026566 * var_x44 * mParameters[11]));
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * ((-51939119025.283607 * var_x58 - 91.342277453381911 * var_x78 - 6506254.4429941392 * var_x79 / (40.0 + var_chaste_interface__sodium_dynamics__Nai) + 4066.4090268713371 * var_x79 * var_chaste_interface__sodium_dynamics__Nai / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Nai), 2) - 101.49141939264658 * var_x78 * pow(var_chaste_interface__i_Na_m_gate__m, 3) * mParameters[5] * var_chaste_interface__i_Na_h_gate__h * var_chaste_interface__i_Na_j_gate__j) * mParameters[11]));
    }
