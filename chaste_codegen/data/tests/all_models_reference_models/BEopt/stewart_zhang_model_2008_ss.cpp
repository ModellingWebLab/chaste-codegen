...
class Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables(const Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables&);
    Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables& operator= (const Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables&);
    Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables()
    {
        ...
        Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables> Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler_LookupTables::Instance();
    }
...
// LCOV_EXCL_STOP
        ...
        const double var_x41 = mParameters[15] / ((1.0 + 0.10000000000000001 * var_x38) * (669921.875 + var_x39) * (1.3799999999999999 + mParameters[4]));
        const double var_x42 = var_x40 * var_x41;
        const double var_x43 = mParameters[4] * _lt_0_row[4];
        ...
        const double var_x48 = -5615083.1234197523 + 374338.90822798351 * var_chaste_interface__membrane__V;
        const double var_x49 = exp(9.9999999999858739e-8);
        const double var_x50 = 1 / (-1.0 + var_x49);
        const double var_x51 = -mParameters[4];
        const double var_x52 = 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x53 = mParameters[7] * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x54 = 0.019297068299972742 * var_x53;
        const double var_x55 = var_x50 * var_x54 * (var_x51 + var_x49 * var_x52);
        const double var_x56 = exp(-9.9999999999858739e-8);
        const double var_x57 = 1 / (-1.0 + var_x56);
        const double var_x58 = var_x54 * var_x57 * (var_x51 + var_x52 * var_x56);
        const double var_x59 = -15.0 + var_chaste_interface__membrane__V;
        const double var_x60 = fabs(var_x59) < 1.3356880329828957e-6;
        const double var_x61 = _lt_0_row[0];
        const double var_x62 = var_x53 * var_x59 / (-1.0 + var_x61);
        const double var_x63 = 14447.286958825251 * var_x62 * (var_x51 + var_x52 * var_x61);
        const double var_x64 = 0.094772024954610332 * mParameters[8];
        const double var_x65 = 3.0010972933430868 * var_x7;
        const double var_x66 = var_x11 * var_x65;
        const double var_x67 = var_x47;
        const double var_x68 = 0.0048242670749931854 * var_x53 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x69 = var_x56 * var_x57 * var_x68;
        const double var_x70 = var_x58 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x71 = -0.11249999999999999 + 0.067500000000000004 * var_x5;
        const double var_x72 = 1 / var_chaste_interface__potassium_dynamics__K_i;
        const double var_x73 = 0.016878114612481093 * var_x72;
        const double var_x74 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * mParameters[14] / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i);
        const double var_x75 = mParameters[8] * mParameters[3];
        const double var_x76 = mParameters[5] / ((1.0 + mParameters[5]) * (_lt_0_row[7]));
        ...
        const double var_x79 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        ...
        rJacobian[2][2] = 1.0 - (mDt * (var_x33 * (-0.0038 - var_x34 - 8.3363813703974642e-9 * var_x26 + (-3.9109255631269199e-5 * var_x36 - 0.0015795337492435057 * var_x42 - 2.4979609626472019e-6 * var_x37 + 3.9109255631269199e-5 * var_chaste_interface__calcium_dynamics__Ca_i / pow(var_x35, 2)) * mParameters[8]) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 0.066691050963179718 * var_x25 - 0.0038 * var_chaste_interface__calcium_dynamics__Ca_i - 0.066691050963179718 * var_x24 - 0.00031590674984870116 * (0.00059199999999999997 * var_chaste_interface__membrane__V - 0.0079072731552699126 * log(var_x37 * mParameters[4]) + 0.12379999999999999 * var_x36 * var_chaste_interface__calcium_dynamics__Ca_i - 2.0 * var_x41 * (var_x43 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) - 2.5 * var_x40 * var_chaste_interface__calcium_dynamics__Ca_i)) * mParameters[8]) / (pow(var_x31, 3) * pow(var_x32, 2))));
        rJacobian[2][3] = -(mDt * (0.0038 * var_x33));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = -(mDt * (0.0018954404990922068 * var_x33 * var_x44 * mParameters[8]));
        rJacobian[3][0] = -(mDt * (-var_x47 * var_x64 * ((var_x60) ? (-var_x58 + var_x48 * (var_x55 + var_x58)) : (var_x63))));
        rJacobian[3][1] = -(mDt * (var_x67 * (var_x66 + 0.64023408924652514 * var_x16 - 4.2682272616435011 * var_x18)));
        rJacobian[3][2] = -(mDt * (1.1399999999999999 * var_x47));
        rJacobian[3][3] = 1.0 - (mDt * (var_x67 * (-1.1399999999999999 - var_x66 + 6.0021945866861737 * var_x30 - 6.4023408924652525 * var_x27 - var_x64 * ((var_x60) ? (-var_x69 + var_x48 * (var_x69 + var_x49 * var_x50 * var_x68)) : (3611.8217397063127 * var_x61 * var_x62 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass))) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x14 * var_x66 - var_x64 * ((var_x60) ? (-var_x70 + 374338.90822798351 * (-14.999998664311967 + var_chaste_interface__membrane__V) * (var_x70 + var_x55 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass)) : (var_x63 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass))) / (pow(var_x45, 3) * pow(var_x46, 2))));
        rJacobian[3][4] = -(mDt * (var_x29 * var_x47 * var_x65));
        rJacobian[3][5] = 0.0;
        rJacobian[3][6] = 0.0;
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = -(mDt * (0.059999999999999998 * var_x13 * var_x28));
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = -(mDt * (var_x71 * var_chaste_interface__calcium_dynamics__R_prime));
        rJacobian[4][4] = 1.0 - (mDt * (-0.0050000000000000001 + var_x71 * var_chaste_interface__calcium_dynamics__Ca_ss));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        ...
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (var_x75 * (-0.016878114612481093 * var_x74 - 0.00024642047334222399 * var_x72 / (_lt_0_row[3]) - 0.00038313320170332084 * var_x72 / (_lt_0_row[8]) - 0.00039553186469764944 * var_x72 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - var_x73 * mParameters[12] / (_lt_0_row[2]) - var_x73 * mParameters[16] * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 0.0072631840899465916 * var_x72 * sqrt(mParameters[5]) * mParameters[13] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2)));
        rJacobian[5][6] = -(mDt * (var_x75 * (0.0034421199463514477 * var_x77 - 2.151324966469655e-6 * var_x78 - 0.00050634343837443281 * var_x74)));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (var_x75 * (3.2269874497044823e-6 * var_x78 - 4.8946532376195178e-6 * var_x79 - 0.0056863214972766203 * var_x44 - 0.0051631799195271718 * var_x77 - 0.00024583649057663214 * var_x79 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 0.016878114612481093 * var_x79 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * mParameters[9] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j)));
    }
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_current_d_gate__d_inf = _lt_0_row[9];
        ...
        const double var_L_type_Ca_current_f2_gate__f2_inf = 0.33000000000000002 + _lt_0_row[11];
        const double var_L_type_Ca_current_f2_gate__tau_f2 = _lt_0_row[12];
        const double var_L_type_Ca_current_f_gate__f_inf = _lt_0_row[13];
        const double var_L_type_Ca_current_f_gate__tau_f = _lt_0_row[14];
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40.0) ? (0.057000000000000002 * exp(-11.764705882352942 + 0.14705882352941177 * mParameters[11] - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0));
        ...
        const double var_fast_sodium_current_h_gate__h_inf = 0.01 * mParameters[10] + (1.0 - 0.01 * mParameters[10]) / pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * mParameters[11])), 2);
        ...
        const double var_fast_sodium_current_j_gate__j_inf = 0.01 * mParameters[10] + (1.0 - 0.01 * mParameters[10]) / pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * mParameters[11])), 2);
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = 1 / (_lt_0_row[17]);
        const double var_fast_sodium_current_m_gate__beta_m = _lt_0_row[16];
        const double var_fast_sodium_current_m_gate__m_inf = _lt_0_row[15];
        ...
        const double var_hyperpolarization_activated_current_y_gate__y_inf = _lt_0_row[18];
        const double var_rapid_time_dependent_potassium_current_Xr1_gate__alpha_xr1 = 450.0 / (_lt_0_row[22]);
        const double var_rapid_time_dependent_potassium_current_Xr1_gate__beta_xr1 = 6.0 / (_lt_0_row[21]);
        ...
        const double var_rapid_time_dependent_potassium_current_Xr1_gate__xr1_inf = _lt_0_row[20];
        const double var_rapid_time_dependent_potassium_current_Xr2_gate__alpha_xr2 = 3.0 / (_lt_0_row[25]);
        const double var_rapid_time_dependent_potassium_current_Xr2_gate__beta_xr2 = 1.1200000000000001 / (_lt_0_row[24]);
        ...
        const double var_rapid_time_dependent_potassium_current_Xr2_gate__xr2_inf = _lt_0_row[23];
        ...
        const double var_slow_time_dependent_potassium_current_Xs_gate__xs_inf = _lt_0_row[26];
        const double var_transient_outward_current_r_gate__r_inf = _lt_0_row[28];
        const double var_transient_outward_current_r_gate__tau_r = _lt_0_row[29];
        const double var_transient_outward_current_s_gate__s_inf = _lt_0_row[30];
        const double var_transient_outward_current_s_gate__tau_s = _lt_0_row[31];
