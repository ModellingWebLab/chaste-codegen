...
class Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables(const Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables&);
    Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables& operator= (const Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables&);
    Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables()
    {
        ...
        Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables> Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellluo_rudy_1991FromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    double Cellluo_rudy_1991FromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellluo_rudy_1991FromCellMLBackwardEuler::Cellluo_rudy_1991FromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellluo_rudy_1991FromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Cellluo_rudy_1991FromCellMLBackwardEuler::~Cellluo_rudy_1991FromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Cellluo_rudy_1991FromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    
    void Cellluo_rudy_1991FromCellMLBackwardEuler::VerifyStateVariables()
    {
    ...
    double Cellluo_rudy_1991FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellluo_rudy_1991FromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellluo_rudy_1991FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[1], double rResidual[1])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -83.853
        ...
        rResidual[0] = rCurrentGuess[0] - rY[1] - mDt*d_dt_chaste_interface_var_intracellular_calcium_concentration__Cai;
    }

    void Cellluo_rudy_1991FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[1], double rJacobian[1][1])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__slow_inward_current_d_gate__d = rY[5];
        // Units: dimensionless; Initial value: 0.00316354
        ...
        rJacobian[0][0] = 1.0 - (mDt * (-0.070000000000000007 - 0.00130287 * mParameters[4] * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f / var_chaste_interface__intracellular_calcium_concentration__Cai));
    }

    void Cellluo_rudy_1991FromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40.0) ? (0.13500000000000001 * exp(-11.764705882352942 + 0.14705882352941177 * mParameters[9] - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0));
        const double var_fast_sodium_current_h_gate__beta_h = ((var_chaste_interface__membrane__V < -40.0) ? (310000.0 * exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * mParameters[9]) + 3.5600000000000001 * exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * mParameters[9])) : (7.6923076923076916 / (1.0 + exp(-0.96036036036036043 + 0.0900900900900901 * mParameters[9] - 0.0900900900900901 * var_chaste_interface__membrane__V))));
        const double var_fast_sodium_current_h_gate__h_inf = 0.01 * mParameters[8] + (1.0 - 0.01 * mParameters[8]) * var_fast_sodium_current_h_gate__alpha_h / (var_fast_sodium_current_h_gate__alpha_h + var_fast_sodium_current_h_gate__beta_h);
        ...
        const double var_fast_sodium_current_j_gate__j_inf = 0.01 * mParameters[8] + (1.0 - 0.01 * mParameters[8]) * var_fast_sodium_current_j_gate__alpha_j / (var_fast_sodium_current_j_gate__alpha_j + var_fast_sodium_current_j_gate__beta_j);
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__V) / (_lt_0_row[3]);
        const double var_fast_sodium_current_m_gate__beta_m = 0.080000000000000002 * _lt_0_row[2];
        ...
        const double var_time_dependent_potassium_current_X_gate__alpha_X = 0.00050000000000000001 * _lt_0_row[13] / (_lt_0_row[12]);
        const double var_time_dependent_potassium_current_X_gate__beta_X = 0.0012999999999999999 * _lt_0_row[15] / (_lt_0_row[14]);
        ...
        CardiacNewtonSolver<1,Cellluo_rudy_1991FromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<1,Cellluo_rudy_1991FromCellMLBackwardEuler>::Instance();
        _p_solver->Solve(*this, var_chaste_interface__environment__time, _guess);
        rY[1] = _guess[0];
    }

    std::vector<double> Cellluo_rudy_1991FromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellluo_rudy_1991FromCellMLBackwardEuler>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellluo_rudy_1991FromCellMLBackwardEuler)
