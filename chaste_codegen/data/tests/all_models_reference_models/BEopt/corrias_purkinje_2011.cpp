...
class Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__Vm)
    {
        ...
        const double* const _lt_0_row = Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables(const Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables&);
    Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables& operator= (const Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables&);
    Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables()
    {
        ...
        Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables> Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellcorrias_purkinje_2011FromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    double Cellcorrias_purkinje_2011FromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellcorrias_purkinje_2011FromCellMLBackwardEuler::Cellcorrias_purkinje_2011FromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellcorrias_purkinje_2011FromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Cellcorrias_purkinje_2011FromCellMLBackwardEuler::~Cellcorrias_purkinje_2011FromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Cellcorrias_purkinje_2011FromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    double Cellcorrias_purkinje_2011FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__Vm);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellcorrias_purkinje_2011FromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
    ...
    void Cellcorrias_purkinje_2011FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__Time__time, const double rCurrentGuess[6], double rResidual[6])
    {
...
// LCOV_EXCL_STOP
    ...
    void Cellcorrias_purkinje_2011FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__Time__time, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: voltage_units; Initial value: -88.744
...
// LCOV_EXCL_STOP
        ...
        const double var_x55 = 1 / ((1.0 + 2.536253862184366 * pow((1 / mParameters[5]), 1.45)) * (_lt_0_row[5]) * (_lt_0_row[6]) * pow((0.031269543464665414 + var_x54), 2) * pow(var_chaste_interface__membrane__Na_i, 2));
        ...
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (-2.6087192562388331e-7 * var_x52 - 7.8261577687164992e-5 * var_x52 / (_lt_0_row[3]) - 4.9229056822851045e-6 * var_x52 * var_chaste_interface__y_gate_f_k__y_gate_f_k - var_x53 * mParameters[13] * var_chaste_interface__x_ks__x_ks * var_chaste_interface__y_ks__y_ks - var_x53 * mParameters[15] * var_chaste_interface__x_to_fast__x_to_fast * var_chaste_interface__y_to_fast__y_to_fast - 6.7688101937298463e-6 * var_x52 * pow(mParameters[5], 0.80000000000000004) * mParameters[11] / (_lt_0_row[2]) - 4.8309615856274683e-6 * var_x52 * mParameters[5] * mParameters[12] * var_chaste_interface__y_kr__y_kr / (_lt_0_row[4])));
    ...
    void Cellcorrias_purkinje_2011FromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__Time__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    void Cellcorrias_purkinje_2011FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__Time__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        const double var_y_Ltype__y_inf_Ltype = _lt_0_row[14];
        const double var_y_Ttype__tau_y_Ttype = 1.4227099999999999 * _lt_0_row[17];
        const double var_y_Ttype__y_inf_Ttype = _lt_0_row[16];
        ...
        const double var_y_gate_f_k__y_inf_f_gate = _lt_0_row[18];
        ...
        const double var_y_na_late__tau_y_na_late = _lt_0_row[23];
        const double var_y_na_late__y_inf_na_late = 0.10000000000000001 + _lt_0_row[22];
        ...
        CardiacNewtonSolver<6,Cellcorrias_purkinje_2011FromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<6,Cellcorrias_purkinje_2011FromCellMLBackwardEuler>::Instance();
    ...
    std::vector<double> Cellcorrias_purkinje_2011FromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__Time__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellcorrias_purkinje_2011FromCellMLBackwardEuler>::Initialise(void)
{
