...
class Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables(const Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables&);
    Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables& operator= (const Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables&);
    Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables()
    {
        ...
        Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables> Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables::mpInstance;


    Cellnoble_model_1962FromCellMLBackwardEuler::Cellnoble_model_1962FromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnoble_model_1962FromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Cellnoble_model_1962FromCellMLBackwardEuler::~Cellnoble_model_1962FromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Cellnoble_model_1962FromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    double Cellnoble_model_1962FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellnoble_model_1962FromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellnoble_model_1962FromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_membrane__V = (-(60.0 + var_chaste_interface__membrane__V) * mParameters[6] - (100.0 + var_chaste_interface__membrane__V) * (pow(var_chaste_interface__potassium_channel_n_gate__n, 4) * mParameters[1] + mParameters[5] * _lt_0_row[0] + mParameters[1] * _lt_0_row[1]) - (0.14000000000000001 + pow(var_chaste_interface__sodium_channel_m_gate__m, 3) * mParameters[2] * var_chaste_interface__sodium_channel_h_gate__h) * (-40.0 + var_chaste_interface__membrane__V)) / mParameters[0]; // millivolt / millisecond
        
        rY[0] += mDt*d_dt_chaste_interface_var_membrane__V;
    }
    
    void Cellnoble_model_1962FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        const double var_potassium_channel_n_gate__alpha_n = 0.0001 * (-50.0 - var_chaste_interface__membrane__V) / (_lt_0_row[3]);
        const double var_potassium_channel_n_gate__beta_n = 0.002 * _lt_0_row[2];
        const double var_sodium_channel_h_gate__alpha_h = 0.17000000000000001 * exp(-4.5 + 0.050000000000000003 * mParameters[4] - 0.050000000000000003 * var_chaste_interface__membrane__V);
        const double var_sodium_channel_h_gate__beta_h = 1 / (1.0 + exp(-4.2000000000000002 + 0.10000000000000001 * mParameters[4] - 0.10000000000000001 * var_chaste_interface__membrane__V));
        const double var_sodium_channel_h_gate__h_inf = 0.01 * mParameters[3] + (1.0 - 0.01 * mParameters[3]) * var_sodium_channel_h_gate__alpha_h / (var_sodium_channel_h_gate__alpha_h + var_sodium_channel_h_gate__beta_h);
        const double var_sodium_channel_h_gate__tau_h = 1 / (var_sodium_channel_h_gate__alpha_h + var_sodium_channel_h_gate__beta_h);
        const double var_sodium_channel_m_gate__alpha_m = 0.10000000000000001 * (-48.0 - var_chaste_interface__membrane__V) / (_lt_0_row[4]);
        const double var_sodium_channel_m_gate__beta_m = 0.12 * (8.0 + var_chaste_interface__membrane__V) / (_lt_0_row[5]);
        
        
        rY[2] = (var_chaste_interface__sodium_channel_h_gate__h + ((var_sodium_channel_h_gate__h_inf / var_sodium_channel_h_gate__tau_h) * mDt)) / (1.0 - ((-1 / var_sodium_channel_h_gate__tau_h) * mDt));
    ...
    std::vector<double> Cellnoble_model_1962FromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellnoble_model_1962FromCellMLBackwardEuler>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellnoble_model_1962FromCellMLBackwardEuler)
