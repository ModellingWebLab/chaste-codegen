...
// LCOV_EXCL_STOP
        ...
        const double var_potassium_channel_n_gate__alpha_n = _lt_0_row[2];
        const double var_potassium_channel_n_gate__beta_n = 0.002 * _lt_0_row[3];
        ...
        const double var_sodium_channel_m_gate__alpha_m = _lt_0_row[4];
        const double var_sodium_channel_m_gate__beta_m = _lt_0_row[5];
