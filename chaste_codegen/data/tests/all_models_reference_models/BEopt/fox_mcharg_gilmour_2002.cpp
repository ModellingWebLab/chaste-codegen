...
class Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables(const Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables&);
    Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables& operator= (const Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables&);
    Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables()
    {
        ...
        Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables> Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler::Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler::~Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    double Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
        ...
        const double var_L_type_Ca_current__i_Ca_max = ((fabs(var_chaste_interface__membrane__V) < 1.3354093264248704e-6) ? (374417.03461708582 * (1.3354093264248704e-6 + var_chaste_interface__membrane__V) * (1.9299999999999998e-5 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(9.9999999999999995e-8)) * mParameters[8] / (-1.0 + exp(9.9999999999999995e-8)) + 1.9299999999999998e-5 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(-9.9999999999999995e-8)) * mParameters[8] / (-1.0 + exp(-9.9999999999999995e-8))) - 1.9299999999999998e-5 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * exp(-9.9999999999999995e-8)) * mParameters[8] / (-1.0 + exp(-9.9999999999999995e-8))) : (14.452497536219512 * (-0.34100000000000003 * mParameters[5] + var_calcium_dynamics__Ca_i * _lt_0_row[0]) * mParameters[8] * var_chaste_interface__membrane__V / (_lt_0_row[1]))); // microA_per_microF
    ...
    void Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[3], double rResidual[3])
    {
...
// LCOV_EXCL_STOP
    ...
    void Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[3], double rJacobian[3][3])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -94.7
...
// LCOV_EXCL_STOP
        ...
        const double var_x1 = pow(var_chaste_interface__calcium_dynamics__Ca_i_converted, 3);
        const double var_x2 = pow(var_chaste_interface__calcium_dynamics__Ca_i_converted, 2);
        const double var_x3 = 1 + 0.0016666666666666668 * var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x4 = pow(var_x3, (-2));
        const double var_x5 = 12.92 / (1.0 + 16.666666666666668 * var_x4);
        const double var_x6 = 1000.0 * var_chaste_interface__calcium_dynamics__Ca_i_converted;
        const double var_x7 = -var_x6;
        const double var_x8 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-3));
        const double var_x9 = 1 / (1.0 + 8000000000.0 * var_x8);
        const double var_x10 = var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x11 = var_x10 * mParameters[1] / (_lt_0_row[15]);
        const double var_x12 = var_x11 * (var_x7 + var_x9 * var_chaste_interface__calcium_dynamics__Ca_SR);
        const double var_x13 = var_x11 * var_chaste_interface__L_type_Ca_current_f_Ca_gate__f_Ca;
        const double var_x14 = var_x13 * (var_x9 + 3.75e-10 * var_x8 / pow((1.2500000000000001e-10 + var_x8), 2));
        const double var_x15 = 1.0 + 1.024e-7 / var_x2;
        const double var_x16 = mParameters[2] / var_x15;
        const double var_x17 = (var_x7 + var_chaste_interface__calcium_dynamics__Ca_SR) * mParameters[0];
        const double var_x18 = var_x12 * var_chaste_interface__L_type_Ca_current_f_Ca_gate__f_Ca;
        const double var_x19 = 1000.0 * mParameters[0];
        const double var_x20 = 2.0480000000000001e-7 * mParameters[2] / (var_x1 * pow(var_x15, 2));
        const double var_x21 = 1000.0 * var_x13;
        const double var_x22 = exp(9.9999999999999995e-8);
        const double var_x23 = 1 / (-1.0 + var_x22);
        const double var_x24 = -0.34100000000000003 * mParameters[5];
        const double var_x25 = 1.9299999999999998e-5 * mParameters[8];
        const double var_x26 = exp(-9.9999999999999995e-8);
        const double var_x27 = 1 / (-1.0 + var_x26);
        const double var_x28 = var_x25 * var_x27 * (var_x24 + var_x26 * var_x6);
        const double var_x29 = fabs(var_chaste_interface__membrane__V) < 1.3354093264248704e-6;
        const double var_x30 = _lt_0_row[0];
        const double var_x31 = mParameters[8] * var_chaste_interface__membrane__V / (-1.0 + var_x30);
        const double var_x32 = 0.03075923579139864 * var_x10;
        const double var_x33 = var_x32 * ((var_x29) ? (-var_x28 + 374417.03461708582 * (1.3354093264248704e-6 + var_chaste_interface__membrane__V) * (var_x28 + var_x23 * var_x25 * (var_x24 + var_x22 * var_x6))) : (14.452497536219512 * var_x31 * (var_x24 + var_x30 * var_x6)));
        const double var_x34 = 0.002 + var_chaste_interface__calcium_dynamics__Ca_i_converted;
        const double var_x35 = 1.0 + 2.0000000000000002e-5 / pow(var_x34, 2);
        const double var_x36 = 0.001 / var_x35;
        const double var_x37 = 1 / var_chaste_interface__calcium_dynamics__Ca_i_converted;
        const double var_x38 = 1.537961789569932 / (0.050000000000000003 + var_x6);
        const double var_x39 = 0.019299999999999998 * mParameters[8];
        const double var_x40 = var_x26 * var_x27 * var_x39;
        const double var_x41 = _lt_0_row[7];
        const double var_x42 = pow(mParameters[7], 3);
        const double var_x43 = var_x41 * var_x42;
        const double var_x44 = mParameters[16] / ((1.0 + 0.20000000000000001 * var_x41) * (1380.0 + mParameters[5]) * (669921.875 + var_x42));
        
        
        rJacobian[0][0] = 1.0 - (mDt * (-var_x0));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = -(mDt * (-1.7495999999999999e-11 * var_x0 * var_x2 / pow((5.8319999999999994e-12 + var_x1), 2)));
        rJacobian[1][0] = -(mDt * (-var_x12 * var_x5));
        rJacobian[1][1] = 1.0 - (mDt * (var_x5 * (-var_x14 - mParameters[0]) + 0.0025839999999999999 * (var_x16 - var_x17 - var_x18) / (pow(var_x3, 3) * pow((0.059999999999999998 + var_x4), 2))));
        rJacobian[1][2] = -(mDt * (var_x5 * (var_x19 + var_x20 + var_x21)));
        rJacobian[2][0] = -(mDt * (var_x36 * (var_x12 - var_x33)));
        rJacobian[2][1] = -(mDt * (var_x36 * (var_x14 + mParameters[0])));
        rJacobian[2][2] = 1.0 - (mDt * (var_x36 * (-var_x19 - var_x20 - var_x21 - var_x38 - 0.00015781464648291512 * var_x37 + 0.001537961789569932 * var_chaste_interface__calcium_dynamics__Ca_i_converted / pow((5.0000000000000002e-5 + var_chaste_interface__calcium_dynamics__Ca_i_converted), 2) - 61.518471582797282 * var_x43 * var_x44 - var_x32 * ((var_x29) ? (-var_x40 + (0.5 + 374417.03461708582 * var_chaste_interface__membrane__V) * (var_x40 + var_x22 * var_x23 * var_x39)) : (14452.497536219513 * var_x30 * var_x31)) * var_chaste_interface__L_type_Ca_current_f_Ca_gate__f_Ca) + 4.0000000000000001e-8 * (var_x17 + var_x18 - var_x16 + 0.00015781464648291512 * log(0.001 * var_x37 * mParameters[5]) - 1.1817698391055359e-5 * var_chaste_interface__membrane__V - var_x33 * var_chaste_interface__L_type_Ca_current_f_Ca_gate__f_Ca - var_x38 * var_chaste_interface__calcium_dynamics__Ca_i_converted + 0.061518471582797281 * var_x44 * (-var_x43 * var_x6 + pow(mParameters[4], 3) * mParameters[5] * _lt_0_row[6])) / (pow(var_x34, 3) * pow(var_x35, 2))));
    }

    void Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_current_d_gate__d_infinity = _lt_0_row[11];
        ...
        const double var_L_type_Ca_current_f_gate__f_infinity = _lt_0_row[13];
        const double var_L_type_Ca_current_f_gate__tau_f = _lt_0_row[14];
        const double var_fast_sodium_current_h_gate__alpha_h = 0.13500000000000001 * exp(-11.764705882352942 + 0.14705882352941177 * mParameters[12] - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_fast_sodium_current_h_gate__beta_h = 7.5 / (1.0 + exp(-1.1000000000000001 + 0.10000000000000001 * mParameters[12] - 0.10000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_fast_sodium_current_j_gate__alpha_j = 0.17499999999999999 * exp(-4.3478260869565215 + 0.043478260869565216 * mParameters[12] - 0.043478260869565216 * var_chaste_interface__membrane__V) / (1.0 + exp(11.85 + 0.14999999999999999 * var_chaste_interface__membrane__V - 0.14999999999999999 * mParameters[12]));
        const double var_fast_sodium_current_j_gate__beta_j = 0.29999999999999999 / (1.0 + exp(-3.2000000000000002 + 0.10000000000000001 * mParameters[12] - 0.10000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr_inf = _lt_0_row[18];
        const double var_rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__tau_X_kr = _lt_0_row[19];
        const double var_slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks_infinity = _lt_0_row[20];
        ...
        const double var_transient_outward_potassium_current_X_to_gate__alpha_X_to = 0.045159999999999999 * _lt_0_row[22];
        const double var_transient_outward_potassium_current_X_to_gate__beta_X_to = 0.098900000000000002 * _lt_0_row[23];
        const double var_transient_outward_potassium_current_Y_to_gate__alpha_Y_to = 0.0054149999999999997 * _lt_0_row[25] / (_lt_0_row[24]);
        const double var_transient_outward_potassium_current_Y_to_gate__beta_Y_to = 0.0054149999999999997 * _lt_0_row[27] / (_lt_0_row[26]);
        ...
        CardiacNewtonSolver<3,Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<3,Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler>::Instance();
    ...
    std::vector<double> Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellfox_mcharg_gilmour_2002FromCellMLBackwardEuler)
