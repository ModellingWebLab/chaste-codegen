...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = 1.0 + exp(-0.125 * var_chaste_interface__cell__V);
            ...
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = 1.0 + exp(-3.5335689045936394 - 0.088339222614840993 * var_chaste_interface__cell__V);
            ...
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = 4954.0 * exp(0.064102564102564111 * var_chaste_interface__cell__V);
            ...
            {
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = 0.33333333333333331 / (1.0 + exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V));
...
// LCOV_EXCL_STOP
        ...
        const double var_x19 = var_x18 / (1.0 + var_x18);
        const double var_x20 = 26841.799999999999 * var_x19;
        const double var_x21 = var_chaste_interface__cell__V / (mParameters[9] * mParameters[20]);
        const double var_x22 = var_x21 * mParameters[8];
        const double var_x23 = exp(2.0 * var_x22);
        const double var_x24 = var_x21 * pow(mParameters[8], 2) * mParameters[10] / (-1.0 + var_x23);
        const double var_x25 = var_x24 * (-0.34100000000000003 * mParameters[5] + 0.001 * var_x23 * var_chaste_interface__Ca__Ca_submem);
        const double var_x26 = fabs(4.0 * var_x25);
        const double var_x27 = 1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca;
        const double var_x28 = var_x26 * var_x27;
        const double var_x29 = var_x20 * var_x28 * mParameters[1];
        const double var_x30 = Signum(var_x25);
        const double var_x31 = var_x23 * var_x24;
        const double var_x32 = 0.011111111111111112 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x33 = ((var_x15) ? (var_x32 * (-50.0 + var_chaste_interface__Irel__Ca_JSR)) : ((var_x16) ? (var_x32 * (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR)) : (0)));
        const double var_x34 = var_x27 * var_x31;
        const double var_x35 = var_x30 * var_x33 * var_x34;
        const double var_x36 = var_x26 * var_x33;
        const double var_x37 = (-9000.0 * var_x26 - var_x20 * var_x36) * mParameters[1];
        const double var_x38 = ((var_x15) ? (var_x32) : ((var_x16) ? (0.12555555555555556 * var_chaste_interface__Ca__Ca_NSR) : (0)));
        const double var_x39 = 0.012999999999999999 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x40 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x41 = 0.00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x42 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x43 = 1.0 + 0.00054600000000000004 / pow(var_x39, 2) + 2.8200000000000001e-5 / pow(var_x40, 2) + 4.5000000000000001e-6 / pow(var_x41, 2) + 0.00016800000000000002 / pow(var_x42, 2);
        const double var_x44 = 1 / var_x43;
        const double var_x45 = 0.001 * var_x44;
        const double var_x46 = 32.699999999999996 * var_chaste_interface__Ca__tropi;
        const double var_x47 = 32.699999999999996 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x48 = var_x10 * var_x9;
        const double var_x49 = var_x2 * var_x4;
        const double var_x50 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_submem;
        const double var_x51 = pow(var_x50, (-2));
        const double var_x52 = 1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem;
        const double var_x53 = pow(var_x52, (-2));
        const double var_x54 = 0.59999999999999998 + var_chaste_interface__Ca__Ca_submem;
        const double var_x55 = pow(var_x54, (-2));
        const double var_x56 = 1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem;
        const double var_x57 = pow(var_x56, (-2));
        const double var_x58 = 1 / (1.0 + 4.5 * var_x51 + 3.2307692307692308 * var_x53 + 28.199999999999999 * var_x55 + 3.4285714285714284 * var_x57);
        const double var_x59 = 0.0327 * var_chaste_interface__Ca__trops;
        const double var_x60 = pow(mParameters[7], 3);
        const double var_x61 = 0.001 * var_x60;
        const double var_x62 = -669.921875 - var_x61 - 516.90750000000014 * mParameters[5];
        const double var_x63 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x64 = (1.0 + 0.27777777777777779 * var_chaste_interface__Ca__Ca_submem) * mParameters[5];
        const double var_x65 = 0.00053738391835633597 * var_x63;
        const double var_x66 = var_x60 * (1.0 + var_x65);
        const double var_x67 = exp(-0.65000000000000002 * var_x22);
        const double var_x68 = 1 / (1.0 + 0.20000000000000001 * var_x67);
        const double var_x69 = 1.0 + 0.026999999999999996 / pow(var_chaste_interface__Ca__Ca_submem, 3);
        const double var_x70 = 1 / var_x69;
        const double var_x71 = exp(0.34999999999999998 * var_x22);
        const double var_x72 = var_x63 * mParameters[5];
        const double var_x73 = var_x61 * var_chaste_interface__Ca__Ca_submem;
        const double var_x74 = var_x71 * var_x72 - var_x67 * var_x73;
        const double var_x75 = var_x68 * var_x70 * var_x74 * mParameters[19];
        const double var_x76 = var_x75 / pow((var_x64 + 0.00069859909386323679 * var_x63 + 1.9345821060828095e-6 * var_x66 + 0.36000524218012353 * var_chaste_interface__Ca__Ca_submem + var_x65 * mParameters[5] + 5.37383918356336e-7 * var_x60 * var_chaste_interface__Ca__Ca_submem), 2);
        const double var_x77 = 1.4439073785400458e-5 * var_x76;
        const double var_x78 = 1 / (var_x72 + var_x73 + 669.921875 * var_chaste_interface__Ca__Ca_submem + 0.0035999999999999999 * var_x66 + 1.3 * var_x63 + 1860.8670000000004 * var_x64);
        const double var_x79 = var_x68 * var_x78 * mParameters[19];
        const double var_x80 = var_x74 * var_x79 / (pow(var_x69, 2) * pow(var_chaste_interface__Ca__Ca_submem, 4));
        const double var_x81 = var_x70 * var_x79;
        const double var_x82 = var_x60 * var_x67 * var_x81;
        const double var_x83 = var_x58;
        const double var_x84 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
        const double var_x85 = 36400.0 * var_x25;
        const double var_x86 = var_x58 * var_x85;
        const double var_x87 = pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x88 = var_x87 * mParameters[5];
        const double var_x89 = -3 * var_x88 - 3.9000000000000004 * var_x87 - 5.8037463182484285e-6 * var_x60 * var_x87;
        const double var_x90 = var_x71 * var_x81 * var_x88;
        const double var_x91 = pow(var_chaste_interface__Ca__Ca_dyad, 4);
        const double var_x92 = 1 / var_x91;
        const double var_x93 = pow(var_chaste_interface__Ca__Ca_dyad, 3);
        const double var_x94 = 1 / var_x93;
        const double var_x95 = var_x92 / pow((0.037037037037037035 + var_x94), 2);
        const double var_x96 = 0.002685333333333333 * var_x95 * var_chaste_interface__ICaL__c1;
        const double var_x97 = 1 / (_lt_0_row[23]);
        const double var_x98 = var_x97;
        const double var_x99 = 1 / (1.0 + 27.0 * var_x94);
        const double var_x100 = _lt_0_row[24];
        const double var_x101 = 1 / var_x100;
        const double var_x102 = 1.0 + 0.00072525373756441506 * var_x91;
        const double var_x103 = 1 / var_x102;
        const double var_x104 = _lt_0_row[2];
        const double var_x105 = _lt_0_row[25];
        const double var_x106 = 78.032899999999998 * var_x103;
        const double var_x107 = var_x104 * (9.9000000000000004 + var_x105 - var_x106);
        const double var_x108 = 0.22637460951196098 * var_x93 / pow(var_x102, 2);
        const double var_x109 = 0.00016422697956757767 * (var_x108 - var_x104 * var_x108) / pow((0.0012815107473898831 + var_x103 + 0.012815107473898831 * var_x107), 2);
        const double var_x110 = var_x101 * var_x109 * var_x99;
        const double var_x111 = 1 / (0.10000000000000001 + var_x106 + var_x107);
        const double var_x112 = 0.1111111111111111 * var_x101 * var_x111 * var_x95;
        const double var_x113 = var_x101;
        const double var_x114 = 1.0 - var_x113;
        const double var_x115 = var_x109 * var_x114 * var_chaste_interface__ICaL__xi2ca;
        const double var_x116 = -var_x98;
        const double var_x117 = 1.0 + var_x116;
        const double var_x118 = 1 / (450.0 + var_x104 * (-440.0 + var_x105));
        const double var_x119 = var_x113 * var_x118;
        const double var_x120 = var_x111 * var_x113 * var_x99;
        const double var_x121 = var_x114 * var_x118;
        const double var_x122 = var_x111 * var_x114;
        const double var_x123 = _lt_0_row[26];
        const double var_x124 = 0.33333333333333331 - var_x123;
        const double var_x125 = var_x100 * var_x114 * var_x124 * var_x97 / var_x117;
        const double var_x126 = 1.8437500000000002 * var_x125;
        const double var_x127 = 41.377027474346242 + 1117.1797418073486 * var_x94;
        const double var_x128 = -0.018268800000000002 * var_x99;
        const double var_x129 = 233.2480818414322 * var_x125;
        const double var_x130 = 1 / var_chaste_interface__Ca__Ca_NSR;
        const double var_x131 = var_x48 - var_x49 - var_chaste_interface__Irel__xir;
        const double var_x132 = _lt_0_row[17];
        const double var_x133 = var_x132 / (1.0 + var_x132);
        const double var_x134 = 2.5807899999999999 * var_x133;
        const double var_x135 = var_x134 * var_x28;
        const double var_x136 = var_x130 * var_chaste_interface__Irel__xir;
        const double var_x137 = -var_x134 * var_x36;
        const double var_x138 = 8.6634442712402744e-10 * var_x76;
        const double var_x139 = mParameters[6] / ((1.5 + mParameters[6]) * (1.0 + 0.1245 * exp(-0.10000000000000001 * var_x22) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[7])) * exp(-var_x22)));
        ...
        rJacobian[0][14] = 0.0;
        rJacobian[1][0] = -(mDt * (var_x17 * var_x29));
        rJacobian[1][1] = 1.0 - (mDt * (-2.0));
        rJacobian[1][2] = 0.0;
        rJacobian[1][3] = -(mDt * (2.0 + (107.3672 * var_x19 * var_x35 + 0.0040000000000000001 * var_x30 * var_x31 * (9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca)) * mParameters[1]));
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = -(mDt * (var_x37));
        rJacobian[1][7] = -(mDt * (var_x37));
        rJacobian[1][8] = -(mDt * (var_x37));
        rJacobian[1][9] = -(mDt * (var_x37));
        rJacobian[1][10] = -(mDt * (var_x37));
        rJacobian[1][11] = -(mDt * (var_x37));
        rJacobian[1][12] = -(mDt * (var_x29 * var_x38));
        rJacobian[1][13] = 0.0;
        rJacobian[1][14] = 0.0;
        rJacobian[2][0] = -(mDt * (var_x45 * (var_x3 + var_x5 - var_x6)));
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (var_x45 * (-2539.0 + var_x13 + var_x46 - var_x11 - var_x12) + 0.001 * (0.0010920000000000001 / pow(var_x39, 3) + 5.6400000000000002e-5 / pow(var_x40, 3) + 9.0000000000000002e-6 / pow(var_x41, 3) + 0.00033600000000000004 / pow(var_x42, 3)) * (var_x49 - var_x48 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x47 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x43, 2)));
        rJacobian[2][3] = -(mDt * (0.00025000000000000001 * var_x44));
        rJacobian[2][4] = -(mDt * (var_x45 * (0.019599999999999999 + var_x47)));
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = 0.0;
        rJacobian[2][8] = 0.0;
        ...
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = -(mDt * (12500.0 * var_x58));
        rJacobian[3][3] = 1.0 - (mDt * (var_x83 * (-14.789 + var_x59 + 4.0499999999999998 * var_x80 - 36.399999999999999 * var_x34 - 0.050000000000000003 * var_x82 + var_x62 * var_x77) + 0.0012574820180071425 * (9.0 / pow(var_x50, 3) + 56.399999999999999 / pow(var_x54, 3) + 0.97959183673469385 / pow(var_x56, 3) + 0.49704142011834318 / pow(var_x52, 3)) * (50.0 * var_chaste_interface__Irel__xir + 0.019599999999999999 * var_chaste_interface__Ca__trops + 12500.0 * var_chaste_interface__Ca__Ca_i_converted - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x27 * var_x85 - var_x84 * (70.0 - var_chaste_interface__Ca__trops) + 50.0 * var_x75 * var_x78) / pow((0.035460992907801421 + var_x55 + 0.15957446808510639 * var_x51 + 0.12158054711246201 * var_x57 + 0.11456628477905074 * var_x53), 2)));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (var_x83 * (0.019599999999999999 + var_x84)));
        rJacobian[3][6] = -(mDt * (var_x86));
        rJacobian[3][7] = -(mDt * (var_x86));
        rJacobian[3][8] = -(mDt * (var_x86));
        rJacobian[3][9] = -(mDt * (var_x86));
        rJacobian[3][10] = -(mDt * (var_x86));
        rJacobian[3][11] = -(mDt * (var_x86));
        rJacobian[3][12] = 0.0;
        rJacobian[3][13] = -(mDt * (50.0 * var_x58));
        rJacobian[3][14] = -(mDt * (var_x83 * (150.0 * var_x90 + var_x77 * var_x89)));
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = -(mDt * (2289.0 - var_x46));
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-0.019599999999999999 - var_x47));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        ...
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (2.2890000000000001 - var_x59));
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (-0.019599999999999999 - var_x84));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        ...
        rJacobian[5][14] = 0.0;
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = -(mDt * (-var_x96));
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-4.3041299999999998 + var_x98 - 0.024167999999999999 * var_x99));
        rJacobian[6][7] = -(mDt * (-3.0 + var_x98));
        ...
        rJacobian[6][14] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = -(mDt * (var_x115 + (-var_x110 - var_x112) * var_chaste_interface__ICaL__c2));
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = -(mDt * (var_x117));
        rJacobian[7][7] = 1.0 - (mDt * (var_x116 - var_x119 - var_x120));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = -(mDt * (var_x121));
        rJacobian[7][11] = -(mDt * (var_x122));
        rJacobian[7][12] = 0.0;
        rJacobian[7][13] = 0.0;
        rJacobian[7][14] = 0.0;
        rJacobian[8][0] = 0.0;
        ...
        rJacobian[8][8] = 1.0 - (mDt * (-0.33762909604519775 + var_x123));
        rJacobian[8][9] = -(mDt * (-0.0019499999999999999));
        rJacobian[8][10] = -(mDt * (-0.0019499999999999999 + var_x126));
        rJacobian[8][11] = -(mDt * (-0.0019499999999999999));
        rJacobian[8][12] = 0.0;
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = -(mDt * (var_x96 + (0.00063442013684210537 * var_x92 * var_x99 - 2.1032463466666669e-8 * var_x127 * var_x95) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x27 * var_x95));
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = 0.0;
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = 0.0;
        rJacobian[9][6] = -(mDt * (0.0058991999999999968 * var_x99));
        rJacobian[9][7] = -(mDt * (var_x128));
        rJacobian[9][8] = -(mDt * (var_x128));
        rJacobian[9][9] = 1.0 - (mDt * (-0.33343694833333332 + var_x123 + var_x128 - 1.8929217120000003e-7 * var_x127 * var_x99));
        rJacobian[9][10] = -(mDt * (var_x128));
        rJacobian[9][11] = -(mDt * (var_x128 + var_x129));
        rJacobian[9][12] = 0.0;
        rJacobian[9][13] = 0.0;
        rJacobian[9][14] = 0.0;
        rJacobian[10][0] = 0.0;
        ...
        rJacobian[10][5] = 0.0;
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = -(mDt * (var_x119));
        rJacobian[10][8] = -(mDt * (var_x124));
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-var_x121 - var_x126));
        rJacobian[10][11] = 0.0;
        rJacobian[10][12] = 0.0;
        rJacobian[10][13] = 0.0;
        rJacobian[10][14] = 0.0;
        rJacobian[11][0] = 0.0;
        rJacobian[11][1] = -(mDt * (-var_x115 + var_x110 * var_chaste_interface__ICaL__c2 + var_x112 * var_chaste_interface__ICaL__c2));
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = -(mDt * (var_x120));
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = -(mDt * (var_x124));
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (-var_x122 - var_x129));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = 0.0;
        ...
        rJacobian[12][13] = 0.0;
        rJacobian[12][14] = 0.0;
        rJacobian[13][0] = -(mDt * (var_x135 * var_x17 + (var_x130 * var_x7 - var_x131 / var_x0) * var_chaste_interface__Irel__xir));
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = -(mDt * (var_x136 * var_x14));
        rJacobian[13][3] = -(mDt * (0.01032316 * var_x133 * var_x35));
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = -(mDt * (var_x137));
        rJacobian[13][7] = -(mDt * (var_x137));
        rJacobian[13][8] = -(mDt * (var_x137));
        rJacobian[13][9] = -(mDt * (var_x137));
        rJacobian[13][10] = -(mDt * (var_x137));
        rJacobian[13][11] = -(mDt * (var_x137));
        rJacobian[13][12] = -(mDt * (var_x135 * var_x38));
        rJacobian[13][13] = 1.0 - (mDt * (-0.033333333333333333 - var_x136 + var_x130 * var_x131));
        rJacobian[13][14] = 0.0;
        rJacobian[14][0] = 0.0;
        rJacobian[14][1] = 0.0;
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = -(mDt * ((3.0000000000000001e-6 * var_x82 - 0.00024299999999999997 * var_x80 - var_x138 * var_x62) * mParameters[3]));
        rJacobian[14][4] = 0.0;
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = 0.0;
        rJacobian[14][7] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * ((-0.0089999999999999993 * var_x90 - var_x138 * var_x89 - 0.00056249999999999996 * var_x139 / (12.0 + var_chaste_interface__Na__Na_i) + 3.9062500000000001e-6 * var_x139 * var_chaste_interface__Na__Na_i / pow((1 + 0.083333333333333329 * var_chaste_interface__Na__Na_i), 2) - 0.000125 * pow(var_chaste_interface__INa__xm, 3) * mParameters[9] * mParameters[20] * mParameters[11] * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj / (mParameters[8] * var_chaste_interface__Na__Na_i)) * mParameters[3]));
    }
...
// LCOV_EXCL_STOP
        ...
        const double var_IKr__xkrv1 = 0.0013799999999999999 * (7.0 + var_chaste_interface__cell__V) / (1.0 - exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V));
        const double var_IKr__xkrv2 = 0.00060999999999999997 * (10.0 + var_chaste_interface__cell__V) / (-1.0 + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V));
        const double var_IKr__taukr = 1 / (var_IKr__xkrv1 + var_IKr__xkrv2);
        const double var_IKs__tauxs1 = _lt_0_row[9];
        ...
        const double var_INa__am = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__cell__V) / (_lt_0_row[15]);
        ...
        const double var_INa__bm = 0.080000000000000002 * _lt_0_row[14];
