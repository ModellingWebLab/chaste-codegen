...
class Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables()
    {
...
protected:
    Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables(const Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables&);
    Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables& operator= (const Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables&);
    Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables()
    {
        ...
        Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables> mpInstance;
...
std::shared_ptr<Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables> Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    double Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler::Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler::~Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler()
    {
    }

    AbstractLookupTableCollection* Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler::GetLookupTableCollection()
    {
        return Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables::Instance();
    }
    
    double Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rResidual[12])
    {
...
// LCOV_EXCL_STOP
    ...
    void Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -83.53
...
// LCOV_EXCL_STOP
        ...
        const double var_x1 = mParameters[0] * _lt_0_row[0];
        const double var_x2 = _lt_0_row[1];
        ...
        const double var_x41 = var_x39 * var_x40 * mParameters[1] / ((1.5 + mParameters[1]) * pow((0.031622776601683791 + var_x40), 2) * (1.0 + _lt_0_row[4] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[2])) * _lt_0_row[3]));
    ...
    void Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        const double var_transient_outward_K_current__i_to = 0.19824 * pow(var_chaste_interface__transient_outward_K_current_oa_gate__oa, 3) * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_K_current_oi_gate__oi; // picoA_per_picoF
        const double var_ultrarapid_delayed_rectifier_K_current__i_Kur_d = pow(var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ua_gate__ua, 3) * (_lt_0_row[7]) * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ui_gate__ui; // picoA_per_picoF
        const double d_dt_chaste_interface_var_membrane__V = (-var_Ca_activated_Cl_current__i_Cl_Ca - var_Ca_pump_current__i_p_Ca - var_Na_Ca_exchanger_current__i_NaCa - var_background_currents__i_B_Ca - var_background_currents__i_B_Na - var_fast_sodium_current__i_Na - var_rapid_delayed_rectifier_K_current__i_Kr - var_sarcolemmal_Ca_current__i_Ca - var_slow_delayed_rectifier_K_current__i_Ks - var_sodium_potassium_pump__i_NaK - var_time_independent_potassium_current__i_K1 - var_transient_outward_K_current__i_to - var_ultrarapid_delayed_rectifier_K_current__i_Kur_d - GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance()) / mParameters[3]; // millivolt / millisecond
        
        rY[0] += mDt*d_dt_chaste_interface_var_membrane__V;
    }
    
    void Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        const double var_Ca_release_current_from_JSR_w_gate__tau_w = (_lt_0_row[9]) / ((_lt_0_row[10]) * (-7.9000000000000004 + var_chaste_interface__membrane__V));
        const double var_Ca_release_current_from_JSR_w_gate__w_infinity = 1.0 + _lt_0_row[8];
        const double var_fast_sodium_current_h_gate__alpha_h = _lt_0_row[11];
        const double var_fast_sodium_current_h_gate__beta_h = _lt_0_row[12];
        const double var_fast_sodium_current_j_gate__alpha_j = _lt_0_row[13];
        const double var_fast_sodium_current_j_gate__beta_j = _lt_0_row[14];
        const double var_fast_sodium_current_m_gate__alpha_m = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__V) / (_lt_0_row[16]);
        const double var_fast_sodium_current_m_gate__beta_m = 0.080000000000000002 * _lt_0_row[15];
        ...
        const double var_rapid_delayed_rectifier_K_current_xr_gate__xr_infinity = 1 / (_lt_0_row[17]);
        const double var_sarcolemmal_Ca_current_d_gate__d_infinity = 1 / (_lt_0_row[19]);
        const double var_sarcolemmal_Ca_current_d_gate__tau_d = 28.571428571428569 * (_lt_0_row[20]) / ((_lt_0_row[21]) * (10.0 + var_chaste_interface__membrane__V));
        const double var_sarcolemmal_Ca_current_f_gate__f_infinity = 1 / (_lt_0_row[22]);
        ...
        const double var_slow_delayed_rectifier_K_current_xs_gate__xs_infinity = _lt_0_row[24];
        ...
        const double var_transient_outward_K_current_oa_gate__oa_infinity = _lt_0_row[26];
        ...
        const double var_transient_outward_K_current_oi_gate__oi_infinity = 1 / (_lt_0_row[28]);
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ua_gate__ua_infinity = _lt_0_row[30];
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__ui_infinity = 1 / (_lt_0_row[32]);
        ...
        CardiacNewtonSolver<12,Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<12,Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler>::Instance();
    ...
    std::vector<double> Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellramirez_nattel_courtemanche_2000FromCellMLBackwardEuler)
