...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = _lt_0_row[15];
        const double var_fast_sodium_current_m_gate__beta_m = 8000.0 * _lt_0_row[16];
        const double var_hyperpolarising_activated_current_y_gate__alpha_y = _lt_0_row[17];
        const double var_hyperpolarising_activated_current_y_gate__beta_y = _lt_0_row[18];
