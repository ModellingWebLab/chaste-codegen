...
// LCOV_EXCL_STOP
        ...
        const double var_x70 = _lt_0_row[3];
        ...
        const double var_x85 = mParameters[14] * _lt_0_row[4];
        ...
        const double var_x168 = mParameters[5] / (var_x75 * (1.5 + mParameters[5]) * pow((0.01 + 1 / var_x91), 2) * (1.0 + _lt_0_row[7] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[6])) * exp(-var_x127)));
        ...
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * ((var_x146 - 2.4362214181418025e-8 * var_x94 - 4.5192480335411901e-10 * var_x139 - 2.5123533374587338e-10 * var_x168 - var_x169 * var_x93 - 6.7562758101440786e-9 * var_x139 * pow(var_chaste_interface__i_Na_L_m_L_gate__m_L, 3) * var_chaste_interface__i_Na_L_h_L_gate__h_L - 1.8076992134164759e-7 * var_x139 * pow(var_chaste_interface__i_Na_m_gate__m, 3) * (0.20000000000000001 * var_chaste_interface__i_Na_j_gate__j + 0.80000000000000004 * var_chaste_interface__i_Na_h_gate__h) * mParameters[8]) * mParameters[3]));
        rJacobian[10][11] = 0.0;
        rJacobian[10][12] = 0.0;
        rJacobian[11][0] = 0.0;
...
// LCOV_EXCL_STOP
        ...
        const double var_i_Ks_xs1_gate__tau_xs1 = 1 / (_lt_0_row[23]);
        const double var_i_Ks_xs1_gate__xs1_infinity = _lt_0_row[22];
        const double var_i_Ks_xs2_gate__tau_xs2 = 2.0 / (_lt_0_row[23]);
