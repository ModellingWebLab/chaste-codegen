...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellespinosa_model_1998_normalFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_reversal_potentials__E_K = var_membrane__R * var_membrane__T * log(10) * log10(var_chaste_interface__extracellular_potassium_concentration__K_o / var_chaste_interface__intracellular_potassium_concentration__K_i) / var_membrane__F; // millivolt
        ...
        const double var_reversal_potentials__E_mh = var_membrane__R * var_membrane__T * log(10) * log10((0.12 * var_chaste_interface__extracellular_potassium_concentration__K_o + var_extracellular_sodium_concentration__Na_o) / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i)) / var_membrane__F; // millivolt
    ...
    void Cellespinosa_model_1998_normalFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x7 = var_x4 * log10(var_x6);
        ...
        const double var_x13 = 0.12 * var_x12;
        const double var_x14 = -0.037433890822745473 * var_chaste_interface__membrane__V;
        const double var_x15 = exp(var_x14);
        const double var_x16 = var_x15 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x17 = var_x16 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x18 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        ...
        const double var_x22 = 0.046792363528431836 * var_x21;
        const double var_x23 = exp(-var_x19);
        const double var_x24 = 61293.487778019742 * var_x23;
        const double var_x25 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x26 = 1.0 + 0.012500000000000001 * var_x18;
        const double var_x27 = 1 / (var_x26 + 16373.795625000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x28 = var_x25 * var_x27;
        const double var_x29 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x30 = 1 / (var_x26 + 16373.795625000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x31 = var_x29 * var_x30;
        const double var_x32 = var_x31 * (var_x22 + var_x24 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x33 = exp(1.8716945411372736 + var_x14);
        ...
        const double var_x40 = var_x33 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x41 = -var_x40 + var_x39 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x42 = 6.7381003480941849e-6 * var_x41;
        const double var_x43 = -148.5 * var_x33 + var_x39 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x44 = 2.2460334493647284e-5 * var_x43;
        const double var_x45 = exp(3.7433890822745473 - 0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x46 = 1.0 - var_x45;
        const double var_x47 = 1 / var_x46;
        const double var_x48 = exp(3.7433890822745473);
        const double var_x49 = -2.5 * var_x45 + var_x48 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x50 = var_x47 * var_x49;
        const double var_x51 = 0.0089841337974589132 * var_x50;
        const double var_x52 = -26.713760659695652 * var_x7 + var_chaste_interface__membrane__V;
        const double var_x53 = var_x11 * var_x52 * var_x8 / pow(var_x9, 2);
        const double var_x54 = var_x53 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x55 = -50.0 + var_chaste_interface__membrane__V;
        const double var_x56 = var_x38 * var_x55;
        const double var_x57 = var_x33 * var_x56;
        const double var_x58 = var_x37 * var_x55;
        const double var_x59 = var_x47 * var_x58;
        const double var_x60 = var_x45 * var_x59;
        const double var_x61 = var_x40 * var_x56;
        const double var_x62 = var_x33 * var_x58 / pow(var_x34, 2);
        const double var_x63 = var_x41 * var_x62;
        const double var_x64 = var_x43 * var_x62;
        const double var_x65 = var_x45 * var_x49 * var_x58 / pow(var_x46, 2);
        const double var_x66 = 1 / NV_Ith_S(mParameters, 0);
        const double var_x67 = 0.001 * var_x66;
        const double var_x68 = 1 / var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x69 = 6.1073194200199382e-5 + 7.6341492750249225e-7 * var_x18;
        const double var_x70 = 2.5 * var_x21;
        const double var_x71 = 3274759.125 * var_x23;
        const double var_x72 = var_x70 - var_x71 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x73 = var_x29 * var_x72 / pow((var_x69 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x74 = var_x30 * var_x72 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x75 = var_x23 * var_x31;
        const double var_x76 = var_x48 * var_x59;
        const double var_x77 = 1 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x78 = 148.5 + 0.12 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x79 = -26.713760659695652 * var_x4 * log10(var_x77 * var_x78) + var_chaste_interface__membrane__V;
        const double var_x80 = var_x79 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x81 = var_x2 * var_x79;
        const double var_x82 = var_x36 * var_x55;
        const double var_x83 = var_x35 * var_x82;
        const double var_x84 = var_x55 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x85 = var_x84 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds;
        const double var_x86 = var_x35 * var_x85;
        const double var_x87 = var_x84 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x88 = var_x35 * var_x87;
        const double var_x89 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x90 = 1.0 + var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x91 = 1 / var_x90;
        const double var_x92 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x93 = var_x91 * var_x92;
        const double var_x94 = 0.69999999999999996 * var_x93;
        const double var_x95 = var_x3 * var_x77;
        const double var_x96 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x97 = var_x20 * var_x96;
        const double var_x98 = var_x31 * var_x97;
        const double var_x99 = var_x73 * var_x96;
        const double var_x100 = var_x70 - var_x71 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x101 = var_x100 * var_x25 / pow((var_x69 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2);
        const double var_x102 = var_chaste_interface__extracellular_potassium_concentration__K_o * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x103 = var_x102 * var_x91 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x104 = var_x39 * var_x56;
        const double var_x105 = 1 / var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x106 = 3.2056512791634777 * var_x12;
        const double var_x107 = 0.010714285714285714 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x108 = 26.713760659695652 * var_x1;
        const double var_x109 = var_x3 / var_x78;
        const double var_x110 = 0.20039999999999999 * var_x53;
        const double var_x111 = var_x102 * var_x92 / pow(var_x90, 2);
        const double var_x112 = var_x10 * var_x52 * var_chaste_interface__extracellular_potassium_concentration__K_o / pow((1 + 0.10000000000000001 * var_chaste_interface__extracellular_potassium_concentration__K_o), 2);
        ...
        const double var_x127 = 0.001 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        ...
        const double var_x145 = 0.01 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x162 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        ...
        const double var_x166 = exp(2.0 - 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x167 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        ...
        const double var_x170 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x168, 2);
        ...
        const double var_x173 = 2 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        ...
        const double var_x179 = 0.5 * var_x174 * var_x178;
        const double var_x180 = var_x179 * (-2 * var_x170 + 2 * var_x169 + var_x172 * var_x173 * (var_x170 - var_x169));
        const double var_x181 = var_x180 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x182 = 0.5 * pow(var_x178, 2);
        const double var_x183 = -var_x174 * var_x182;
        const double var_x184 = var_x179 * (2 * var_x177 - var_x173 * var_x176 / pow(var_x171, 2));
        const double var_x185 = var_x184 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x186 = 1.419105609765594e-8 * var_x43;
        const double var_x187 = 0.0013268376663538336 * var_x93;
        ...
        const double var_x190 = 9.2878636644768344e-5 * var_x12;
        const double var_x191 = 5.2152131158885572e-9 * var_x41;
        const double var_x192 = 0.001083584094188964 * var_x93;
        ...
        const double var_x196 = 0.00015510732319676314 * var_x53;
        ...
        const double var_x199 = 7.5819295220219067e-5 * var_x12;
        const double var_x200 = 4.2573168292967824e-9 * var_x41;
        const double var_x201 = 0.00088455844423588909 * var_x93;
        const double var_x202 = 6.769579930376702e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x203 = 0.0020254185058997385 * var_x12;
        const double var_x204 = 26.713760659695652 * var_x198;
        const double var_x205 = 0.00012661822301776582 * var_x53;
        const double var_x206 = 2.8382112195311879e-5 * var_x50;
        const double var_x207 = -var_x126;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * (0.0043499999999999997 + var_x1 + 0.59999999999999998 * var_x3 + 2.5223331278326097e-7 * var_x61 + 0.00040107740167227293 * var_x17 + 0.00012485548982771419 * var_x57 + 0.0016815554185550731 * var_x60 + 0.0001998 * var_x32 - 2.5223331278326097e-7 * var_x63 - 8.4077770927753658e-7 * var_x64 - 0.00067262216742202926 * var_x65 - 0.0075017517208781923 * var_x54 + var_x13 * var_chaste_interface__extracellular_potassium_concentration__K_o + var_x37 * var_x51 + var_x38 * var_x42 + var_x38 * var_x44 + 2.0000000000000002e-7 * var_x28 * (var_x22 + var_x24 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds)));
        IJth(rJacobian, 1, 0) = -7.8978432521061529e-8 + 1.2623912654166476e-7 * var_x32;
        IJth(rJacobian, 2, 0) = (0.001 - var_x127) * ((var_x129) ? (0) : (var_x132 - 0.29999999999999999 * var_x128 * var_x130 / pow(var_x131, 2))) - var_x127 * ((var_x129) ? (0) : (var_x135 - 0.0356 * var_x128 * var_x133 / pow(var_x134, 2)));
        IJth(rJacobian, 3, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x137) ? (0) : (var_x141 - 20.0 * var_x136 * var_x139 / pow(var_x140, 2))) + 0.44800000000000001 * var_x142 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 4, 0) = -0.125 * var_x143 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x144 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x144), 2);
        IJth(rJacobian, 5, 0) = (0.01 - var_x145) * ((var_x147) ? (0) : (var_x150 - 10.0 * var_x146 * var_x148 / pow(var_x149, 2))) - var_x145 * ((var_x147) ? (0) : (var_x153 - 1.6000000000000001 * var_x146 * var_x151 / pow(var_x152, 2)));
        IJth(rJacobian, 6, 0) = (0.002 - 0.002 * var_chaste_interface__L_type_Ca_channel_f_gate__f) * ((var_x155) ? (0) : (var_x159 - 1.1363636363636365 * var_x154 * var_x157 / pow(var_x158, 2))) - 0.0043636363636363638 * var_x160 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x161, 2);
        IJth(rJacobian, 9, 0) = -0.067226890756302518 * var_x163 * (8.5800000000000009e-6 - 8.5800000000000009e-6 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0012257142857142857 * var_x164 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x165, 2);
        IJth(rJacobian, 10, 0) = 0.033300000000000003 * var_x166 / pow((1.0 + var_x166), 2);
        IJth(rJacobian, 13, 0) = -6.3182746016849228e-8 + 5.3122644461910889e-10 * var_x64 - 7.8887127025937665e-8 * var_x57 - 3.7871737962499423e-7 * var_x32 - 0.00037909647610109533 * var_x3 - var_x186 * var_x38;
        IJth(rJacobian, 14, 0) = 3.0959545548256117e-6 + var_x189 + 3.1042935213622369e-7 * var_x17 + 1.9522571839752248e-10 * var_x61 - 5.8062706023559271e-6 * var_x54 - 1.9522571839752248e-10 * var_x63 + var_x190 * var_chaste_interface__extracellular_potassium_concentration__K_o + var_x191 * var_x38;
        IJth(rJacobian, 15, 0) = -2.5273098406739689e-6 + var_x198 + 4.7398127366170842e-6 * var_x54 + 1.5936793338573265e-10 * var_x63 - 2.5341171602957037e-7 * var_x17 - 1.5936793338573265e-10 * var_x61 - var_x199 * var_chaste_interface__extracellular_potassium_concentration__K_o - var_x200 * var_x38;
        IJth(rJacobian, 16, 0) = 2.1249057784764355e-6 * var_x65 - 5.312264446191088e-6 * var_x60 - var_x206 * var_x37;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * (0.0033392200824619565 * var_x68 + 0.0089841337974589132 * var_x76 - 1.2202424201199837e-8 * var_x73 - 1.3786199999999999e-6 * var_x74 - 654.29687317500009 * var_x75));
        IJth(rJacobian, 1, 1) = -7.0 + var_x113 + var_x114 + 0.00040000000000000002 * var_x118 - 0.00040000000000000002 * var_x116 - 1.0549054718227806e-6 * var_x68 - 0.41340273157434632 * var_x75 - 7.7098266909426358e-12 * var_x73 - 8.7104997313748673e-10 * var_x74 - 7.1999999999999991e-9 * var_x119;
        ...
        IJth(rJacobian, 11, 1) = -var_x181 + var_x167 * var_x180;
        IJth(rJacobian, 12, 1) = var_x181;
        IJth(rJacobian, 13, 1) = 2.3129480072827907e-11 * var_x73 + 1.240208194723039 * var_x75 + 2.6131499194124605e-9 * var_x74;
        IJth(rJacobian, 16, 1) = -2.8382112195311879e-5 * var_x76;
        IJth(rJacobian, 17, 1) = 0.019599999999999999 * var_x116 + 3.5279999999999993e-7 * var_x119 - 0.019599999999999999 * var_x118;
        IJth(rJacobian, 19, 1) = 2.0 - var_x113;
        IJth(rJacobian, 20, 1) = 5.0 - var_x114;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * (0.010714285714285714 * var_chaste_interface__intracellular_potassium_concentration__K_i - 0.010714285714285714 * var_x16));
        IJth(rJacobian, 2, 2) = -0.001 * ((var_x129) ? (2.5) : (var_x128 * var_x132)) - 0.001 * ((var_x129) ? (2.5) : (var_x128 * var_x135));
        IJth(rJacobian, 14, 2) = 8.2927354147114596e-6 * var_chaste_interface__intracellular_potassium_concentration__K_i - 8.2927354147114596e-6 * var_x16;
        IJth(rJacobian, 15, 2) = 6.769579930376702e-6 * var_x16 - 6.769579930376702e-6 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0018 * var_x66 * var_x80);
        IJth(rJacobian, 3, 3) = -8.0 * var_x142 - 0.001 * ((var_x137) ? (2000.0) : (var_x136 * var_x141));
        IJth(rJacobian, 13, 3) = -0.0011372894283032859 * var_x80;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00059999999999999995 * var_x66 * var_x81);
        IJth(rJacobian, 4, 4) = -2.0 / (1.0 + 320.0 * var_x144) - 0.02 * var_x143;
        IJth(rJacobian, 13, 4) = -0.00037909647610109533 * var_x81;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * (var_x42 * var_x83 + var_x44 * var_x83 + var_x51 * var_x82));
        IJth(rJacobian, 5, 5) = -0.01 * ((var_x147) ? (120.0) : (var_x146 * var_x150)) - 0.01 * ((var_x147) ? (120.0) : (var_x146 * var_x153));
        IJth(rJacobian, 13, 5) = -var_x186 * var_x83;
        IJth(rJacobian, 14, 5) = var_x191 * var_x83;
        IJth(rJacobian, 15, 5) = -var_x200 * var_x83;
        IJth(rJacobian, 16, 5) = -var_x206 * var_x82;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * (var_x42 * var_x86 + var_x44 * var_x86 + var_x51 * var_x85));
        IJth(rJacobian, 6, 6) = -0.002 * ((var_x155) ? (25.0) : (var_x154 * var_x159)) - 0.024 / var_x161;
        IJth(rJacobian, 13, 6) = -var_x186 * var_x86;
        IJth(rJacobian, 14, 6) = var_x191 * var_x86;
        IJth(rJacobian, 15, 6) = -var_x200 * var_x86;
        IJth(rJacobian, 16, 6) = -var_x206 * var_x85;
        IJth(rJacobian, 7, 7) = -0.001;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * (var_x42 * var_x88 + var_x44 * var_x88 + var_x51 * var_x87));
        IJth(rJacobian, 8, 8) = -0.02;
        IJth(rJacobian, 13, 8) = -var_x186 * var_x88;
        IJth(rJacobian, 14, 8) = var_x191 * var_x88;
        IJth(rJacobian, 15, 8) = -var_x200 * var_x88;
        IJth(rJacobian, 16, 8) = -var_x206 * var_x87;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * (0.068000000000000005 * var_chaste_interface__membrane__V - 1.8165357248593041 * var_x7) * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 9, 9) = -8.5800000000000009e-6 * var_x163 - 0.0085800000000000008 / var_x165;
        IJth(rJacobian, 14, 9) = (5.2631227432035395e-5 * var_chaste_interface__membrane__V - 0.0014059780128454016 * var_x7) * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 15, 9) = (0.0011477371533431852 * var_x7 - 4.2964267291457472e-5 * var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x0 * var_x52 * var_x67);
        IJth(rJacobian, 10, 10) = -0.33300000000000002;
        IJth(rJacobian, 14, 10) = var_x188 * var_x52;
        IJth(rJacobian, 15, 10) = var_x197 * var_x52;
        IJth(rJacobian, 1, 11) = (0.10204081632653063 * var_x122 - 0.10204081632653063 * var_x124) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 11, 11) = var_x183 + var_x174 * (-0.059999999999999998 - var_x182);
        IJth(rJacobian, 12, 11) = var_x174 * (0.059999999999999998 + var_x182);
        IJth(rJacobian, 18, 11) = (0.5 * var_x124 - 0.5 * var_x122) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 11, 12) = var_x183;
        IJth(rJacobian, 12, 12) = -0.001 * var_x174;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * (16.02825639581739 * var_x95 + 2.2460334493647284e-5 * var_x104 + 0.0014985 * var_x98 + 0.0026713760659695649 * var_x89 - 2.794653836074089e-14 * var_x99 - 0.00043749999999999995 * var_x103 + var_x94 * var_chaste_interface__extracellular_potassium_concentration__K_o + 1.5e-6 * var_x28 * var_x97 - 2.7974512873614505e-17 * var_x101 * var_x96));
        IJth(rJacobian, 1, 13) = 9.4679344906248566e-7 * var_x98 - 1.7657390352968255e-17 * var_x99;
        IJth(rJacobian, 13, 13) = 8.2927354147114598e-7 * var_x103 + 5.2972171058904767e-17 * var_x99 - 2.8403803471874568e-6 * var_x98 - 0.010127092529498692 * var_x95 - 1.6878487549164488e-6 * var_x89 - 1.419105609765594e-8 * var_x104 - var_x187 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        IJth(rJacobian, 14, 13) = 6.7724005886810246e-7 * var_x103 - var_x192 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        IJth(rJacobian, 15, 13) = -5.5284902764743069e-7 * var_x103 + var_x201 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * (var_x110 - var_x106 - 0.69999999999999996 * var_x111 - 6.7381003480941849e-6 * var_x57 - 0.0011999999999999999 * var_x112 - 0.10685504263878261 * var_x105 - 1.9233907674980866 * var_x109 + var_x13 * var_x52 + var_x94 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x105 * var_x108 - var_x107 * var_x15));
        IJth(rJacobian, 13, 14) = 0.0013268376663538336 * var_x111 + 0.001215251103539843 * var_x109 - var_x187 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        IJth(rJacobian, 14, 14) = -0.00069999999999999999 + var_x196 - var_x194 + 0.001083584094188964 * var_x111 - 8.2704588990905987e-5 * var_x105 - 9.2878636644768348e-7 * var_x112 - 5.2152131158885572e-9 * var_x57 + var_x190 * var_x52 - var_x105 * var_x195 - var_x15 * var_x193 - var_x192 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        IJth(rJacobian, 15, 14) = var_x203 - var_x205 + 4.2573168292967824e-9 * var_x57 + 7.5819295220219063e-7 * var_x112 + 6.7513950196657958e-5 * var_x105 - 0.00088455844423588909 * var_x111 + var_x15 * var_x202 + var_x201 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x105 * var_x204 - var_x199 * var_x52;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * (var_x107 + 6.7381003480941849e-6 * var_x104 + 0.10685504263878261 * var_x5 + 1.9233907674980866 * var_x95 + var_x106 * var_x6 + var_x108 * var_x5 - var_x110 * var_x6));
        IJth(rJacobian, 13, 15) = -0.001215251103539843 * var_x95;
        IJth(rJacobian, 14, 15) = var_x193 + 8.2704588990905987e-5 * var_x5 + 5.2152131158885572e-9 * var_x104 + var_x194 * var_x6 + var_x195 * var_x5 - var_x196 * var_x6;
        IJth(rJacobian, 15, 15) = -var_x202 - 4.2573168292967824e-9 * var_x104 - 6.7513950196657958e-5 * var_x5 + var_x204 * var_x5 + var_x205 * var_x6 - var_x203 * var_x6;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * (-1.2214638840039876e-11 * var_x101 - 0.65495182500000004 * var_x23 * var_x28 - 1.38e-9 * var_x100 * var_x27 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2)));
        IJth(rJacobian, 1, 16) = 0.001;
        IJth(rJacobian, 8, 16) = -0.02 / var_x162 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x162, 2);
        IJth(rJacobian, 11, 16) = -var_x185 + var_x167 * var_x184;
        IJth(rJacobian, 12, 16) = var_x185;
        IJth(rJacobian, 16, 16) = -0.01;
        IJth(rJacobian, 1, 17) = 9.5999999999999999e-8 * var_x118 + 7.1999999999999991e-9 * var_x116 - 1.7279999999999999e-12 * var_x119;
        IJth(rJacobian, 17, 17) = -0.050000000000000003 + 8.4671999999999982e-11 * var_x119 - 3.5279999999999993e-7 * var_x116 - 4.7039999999999993e-6 * var_x118;
        IJth(rJacobian, 18, 17) = 0.0050000000000000001;
        IJth(rJacobian, 1, 18) = 1.0204081632653063e-5 + 0.051020408163265314 * var_x125;
        IJth(rJacobian, 17, 18) = 0.050000000000000003;
        IJth(rJacobian, 18, 18) = -0.0050499999999999998 - 0.25 * var_x125;
        IJth(rJacobian, 1, 19) = 0.050000000000000003 + var_x126;
        IJth(rJacobian, 19, 19) = -0.050000000000000003 + var_x207;
        IJth(rJacobian, 1, 20) = 0.20000000000000001 + var_x126;
