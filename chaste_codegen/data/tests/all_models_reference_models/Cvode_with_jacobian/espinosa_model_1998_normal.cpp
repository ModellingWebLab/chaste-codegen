...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellespinosa_model_1998_normalFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x77 = 148.5 + var_x4;
        ...
        const double var_x105 = 3.2056512791634777 * var_x12;
        ...
        const double var_x109 = var_x3 / var_x77;
        const double var_x110 = 0.20039999999999999 * var_x52;
        ...
        const double var_x186 = 1.419105609765594e-8 * var_x42;
        ...
        const double var_x190 = var_x12 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x191 = 5.2152131158885572e-9 * var_x40;
        ...
        IJth(rJacobian, 13, 0) = -6.3182746016849228e-8 + 5.3122644461910889e-10 * var_x63 - 7.8887127025937665e-8 * var_x56 - 3.7871737962499423e-7 * var_x31 - 0.00037909647610109533 * var_x3 - var_x186 * var_x37;
        IJth(rJacobian, 14, 0) = 3.0959545548256117e-6 + var_x189 + 3.1042935213622369e-7 * var_x16 + 9.2878636644768344e-5 * var_x190 + 1.9522571839752248e-10 * var_x60 - 5.8062706023559271e-6 * var_x53 - 1.9522571839752248e-10 * var_x62 + var_x191 * var_x37;
        IJth(rJacobian, 15, 0) = -2.5273098406739689e-6 + var_x198 + 4.7398127366170842e-6 * var_x53 + 1.5936793338573265e-10 * var_x62 - 2.5341171602957037e-7 * var_x16 - 7.5819295220219067e-5 * var_x190 - 1.5936793338573265e-10 * var_x60 - var_x199 * var_x37;
        ...
        IJth(rJacobian, 1, 1) = -7.0 + var_x113 + var_x114 + 0.00040000000000000002 * var_x118 - 0.00040000000000000002 * var_x116 - 1.0549054718227806e-6 * var_x67 - 0.41340273157434632 * var_x74 - 7.7098266909426358e-12 * var_x72 - 8.7104997313748673e-10 * var_x73 - 7.1999999999999991e-9 * var_x119;
        ...
        IJth(rJacobian, 13, 5) = -var_x186 * var_x82;
        IJth(rJacobian, 14, 5) = var_x191 * var_x82;
        ...
        IJth(rJacobian, 13, 6) = -var_x186 * var_x85;
        IJth(rJacobian, 14, 6) = var_x191 * var_x85;
        ...
        IJth(rJacobian, 13, 8) = -var_x186 * var_x87;
        IJth(rJacobian, 14, 8) = var_x191 * var_x87;
        IJth(rJacobian, 15, 8) = -var_x199 * var_x87;
        IJth(rJacobian, 16, 8) = -var_x205 * var_x86;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x66 * (0.068000000000000005 * var_chaste_interface__membrane__V - 1.8165357248593041 * var_x7) * var_chaste_interface__transient_outward_current_r_gate__r);
        ...
        IJth(rJacobian, 14, 10) = var_x188 * var_x51;
        IJth(rJacobian, 15, 10) = var_x197 * var_x51;
        ...
        IJth(rJacobian, 13, 13) = 8.2927354147114598e-7 * var_x102 + 5.2972171058904767e-17 * var_x98 - 2.8403803471874568e-6 * var_x97 - 0.010127092529498692 * var_x94 - 1.6878487549164488e-6 * var_x88 - 1.419105609765594e-8 * var_x103 - var_x187 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        IJth(rJacobian, 14, 13) = 6.7724005886810246e-7 * var_x102 - var_x192 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        ...
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x66 * (var_x110 - var_x105 + 0.12 * var_x107 - 0.69999999999999996 * var_x111 - 6.7381003480941849e-6 * var_x56 - 0.0011999999999999999 * var_x112 - 0.10685504263878261 * var_x104 - 1.9233907674980866 * var_x109 + var_x93 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x104 * var_x108 - var_x106 * var_x14));
        IJth(rJacobian, 13, 14) = 0.001215251103539843 * var_x109 + 0.0013268376663538336 * var_x111 - var_x187 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        IJth(rJacobian, 14, 14) = -0.00069999999999999999 + var_x196 - var_x194 + 0.001083584094188964 * var_x111 + 9.2878636644768344e-5 * var_x107 - 8.2704588990905987e-5 * var_x104 - 9.2878636644768348e-7 * var_x112 - 5.2152131158885572e-9 * var_x56 - var_x104 * var_x195 - var_x14 * var_x193 - var_x192 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        IJth(rJacobian, 15, 14) = var_x202 - var_x204 + 4.2573168292967824e-9 * var_x56 + 7.5819295220219063e-7 * var_x112 + 6.7513950196657958e-5 * var_x104 - 0.00088455844423588909 * var_x111 - 7.5819295220219067e-5 * var_x107 + var_x14 * var_x201 + var_x200 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x104 * var_x203;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x66 * (var_x106 + 6.7381003480941849e-6 * var_x103 + 0.10685504263878261 * var_x5 + 1.9233907674980866 * var_x94 + var_x105 * var_x6 + var_x108 * var_x5 - var_x110 * var_x6));
        IJth(rJacobian, 13, 15) = -0.001215251103539843 * var_x94;
        IJth(rJacobian, 14, 15) = var_x193 + 8.2704588990905987e-5 * var_x5 + 5.2152131158885572e-9 * var_x103 + var_x194 * var_x6 + var_x195 * var_x5 - var_x196 * var_x6;
        IJth(rJacobian, 15, 15) = -var_x201 - 4.2573168292967824e-9 * var_x103 - 6.7513950196657958e-5 * var_x5 + var_x203 * var_x5 + var_x204 * var_x6 - var_x202 * var_x6;
