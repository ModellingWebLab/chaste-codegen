...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellespinosa_model_1998_normalFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel__i_Ca_L_K_ds = ((fabs(-50.0 + var_chaste_interface__membrane__V) < 2.6713760661323249e-6) ? (187169.45410232362 * (-49.999997328623934 + var_chaste_interface__membrane__V) * (3.0000000001827821e-10 * (var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372736) - var_chaste_interface__extracellular_potassium_concentration__K_o * exp(1.0000000000609274e-7)) * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.0000000000609274e-7)) + 3.0000000001827821e-10 * (var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372736) - var_chaste_interface__extracellular_potassium_concentration__K_o * exp(-1.0000000000609274e-7)) * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(-1.0000000000609274e-7))) - 3.0000000001827821e-10 * (var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372736) - var_chaste_interface__extracellular_potassium_concentration__K_o * exp(1.0000000000609274e-7)) * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.0000000000609274e-7))) : (0.00011230167246823642 * (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372736) - var_chaste_interface__extracellular_potassium_concentration__K_o * exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V)) * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V)))); // nanoA
    ...
    void Cellespinosa_model_1998_normalFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_L_type_Ca_channel__i_Ca_L_Na_cyt = (1.0 - var_L_type_Ca_channel__FrICa) * (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(50.0 * var_membrane__F / (var_membrane__R * var_membrane__T)) - NV_Ith_S(mParameters, 8) * exp((50.0 - var_chaste_interface__membrane__V) * var_membrane__F / (var_membrane__R * var_membrane__T))) * var_L_type_Ca_channel__P_CaNa * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2_gate__f2 * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_membrane__F / ((1.0 - exp((50.0 - var_chaste_interface__membrane__V) * var_membrane__F / (var_membrane__R * var_membrane__T))) * var_membrane__R * var_membrane__T); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_Na_ds = ((fabs(-50.0 + var_chaste_interface__membrane__V) < 2.6713760661323249e-6) ? (187169.45410232362 * (-49.999997328623934 + var_chaste_interface__membrane__V) * (1.0000000000609275e-9 * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736) - NV_Ith_S(mParameters, 8) * exp(1.0000000000609274e-7)) * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.0000000000609274e-7)) + 1.0000000000609275e-9 * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736) - NV_Ith_S(mParameters, 8) * exp(-1.0000000000609274e-7)) * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(-1.0000000000609274e-7))) - 1.0000000000609275e-9 * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736) - NV_Ith_S(mParameters, 8) * exp(1.0000000000609274e-7)) * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.0000000000609274e-7))) : (0.00037433890822745472 * (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736) - NV_Ith_S(mParameters, 8) * exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V)) * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V)))); // nanoA
        const double var_L_type_Ca_channel_d_gate__alpha_d = ((fabs(4.0 + var_chaste_interface__membrane__V) < 2.9999999995311555e-7) ? (-8.9999999985934664e-6 / (1.0 - exp(9.9999999984371854e-8)) + 1666666.6669271358 * (4.0000003 + var_chaste_interface__membrane__V) * (8.9999999985934664e-6 / (1.0 - exp(9.9999999984371854e-8)) + 8.9999999985934664e-6 / (1.0 - exp(-9.9999999984371854e-8)))) : (30.0 * (4.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-1.3333333333333333 - 0.33333333333333331 * var_chaste_interface__membrane__V)))); // per_second
        const double var_L_type_Ca_channel_d_gate__beta_d = ((fabs(4.0 + var_chaste_interface__membrane__V) < 7.4999999988278887e-7) ? (8.9999999985934664e-6 / (-1.0 + exp(9.9999999984371854e-8)) - 666666.66677085438 * (3.9999992500000001 + var_chaste_interface__membrane__V) * (-8.9999999985934664e-6 / (-1.0 + exp(9.9999999984371854e-8)) - 8.9999999985934664e-6 / (-1.0 + exp(-9.9999999984371854e-8)))) : (12.0 * (4.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(0.53333333333333333 + 0.13333333333333333 * var_chaste_interface__membrane__V)))); // per_second
        ...
        const double var_L_type_Ca_channel_f_gate__alpha_f = ((fabs(24.0 + var_chaste_interface__membrane__V) < 5.4999999932192623e-7) ? (3.4374999957620389e-6 / (-1.0 + exp(9.999999987671386e-8)) - 909090.91021169221 * (23.999999450000001 + var_chaste_interface__membrane__V) * (-3.4374999957620389e-6 / (-1.0 + exp(9.999999987671386e-8)) - 3.4374999957620389e-6 / (-1.0 + exp(-9.999999987671386e-8)))) : (6.25 * (24.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(4.3636363636363633 + 0.18181818181818182 * var_chaste_interface__membrane__V)))); // per_second
        ...
        const double var_time_dependent_potassium_current__I_K = 0.0071428571428571426 * (-var_chaste_interface__extracellular_potassium_concentration__K_o * exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + var_chaste_interface__intracellular_potassium_concentration__K_i) * NV_Ith_S(mParameters, 11); // nanoA
        const double var_time_dependent_potassium_current_x_gate__alpha_x = ((fabs(-18.0 + var_chaste_interface__membrane__V) < 4.9999999873762135e-7) ? (-7.4999999810643203e-7 / (1.0 - exp(9.9999999747524276e-8)) + 1000000.0025247573 * (-17.999999500000001 + var_chaste_interface__membrane__V) * (7.4999999810643203e-7 / (1.0 - exp(9.9999999747524276e-8)) + 7.4999999810643203e-7 / (1.0 - exp(-9.9999999747524276e-8)))) : (1.5 * (-18.0 + var_chaste_interface__membrane__V) / (1.0 - exp(3.6000000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V)))); // per_second
        const double var_time_dependent_potassium_current_x_gate__beta_x = ((fabs(-18.0 + var_chaste_interface__membrane__V) < 1.4999999997655777e-6) ? (8.0099999987481852e-7 / (-1.0 + exp(9.9999999984371854e-8)) - 333333.33338542719 * (-18.0000015 + var_chaste_interface__membrane__V) * (-8.0099999987481852e-7 / (-1.0 + exp(9.9999999984371854e-8)) - 8.0099999987481852e-7 / (-1.0 + exp(-9.9999999984371854e-8)))) : (0.53400000000000003 * (-18.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-1.2 + 0.066666666666666666 * var_chaste_interface__membrane__V)))); // per_second
        const double var_time_dependent_potassium_current__i_K = var_time_dependent_potassium_current__I_K * var_chaste_interface__time_dependent_potassium_current_x_gate__x; // nanoA
    ...
    void Cellespinosa_model_1998_normalFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x43 = exp(1.0000000000609274e-7);
        const double var_x44 = 1 / (1.0 - var_x43);
        const double var_x45 = exp(3.7433890822745473);
        const double var_x46 = var_x45 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x47 = var_x44 * (var_x46 - var_x43 * NV_Ith_S(mParameters, 7));
        ...
        const double var_x51 = 0.074867781645490947 * var_x50;
        const double var_x52 = exp(-1.0000000000609274e-7);
        const double var_x53 = 1 / (1.0 - var_x52);
        const double var_x54 = var_x53 * (var_x46 - var_x52 * NV_Ith_S(mParameters, 7));
        const double var_x55 = -50.0 + var_chaste_interface__membrane__V;
        const double var_x56 = fabs(var_x55);
        const double var_x57 = var_x56 < 1.3356880330661625e-6;
        const double var_x58 = exp(3.7433890822745473 - 0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x59 = 1.0 - var_x58;
        const double var_x60 = 1 / var_x59;
        const double var_x61 = var_x50 * var_x60;
        const double var_x62 = var_x58 * NV_Ith_S(mParameters, 7);
        const double var_x63 = var_x46 - var_x62;
        const double var_x64 = 0.14973556329098189 * var_x63;
        const double var_x65 = var_x55 * var_x61;
        const double var_x66 = var_x50 * var_x55;
        const double var_x67 = ((var_x57) ? (var_x47 * var_x51 + var_x51 * var_x54) : (var_x61 * var_x64 + 0.011210369457033822 * var_x62 * var_x65 - 0.011210369457033822 * var_x58 * var_x63 * var_x66 / pow(var_x59, 2)));
        const double var_x68 = exp(1.8716945411372736);
        const double var_x69 = var_x68 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x70 = var_x44 * (var_x69 - var_x43 * var_chaste_interface__extracellular_potassium_concentration__K_o);
        const double var_x71 = 5.6150836234118209e-5 * var_x50;
        const double var_x72 = var_x53 * (var_x69 - var_x52 * var_chaste_interface__extracellular_potassium_concentration__K_o);
        const double var_x73 = var_x56 < 2.6713760661323249e-6;
        const double var_x74 = exp(1.8716945411372736 + var_x29);
        const double var_x75 = 1.0 - var_x74;
        const double var_x76 = 1 / var_x75;
        const double var_x77 = var_x50 * var_x76;
        const double var_x78 = var_x74 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x79 = var_x69 - var_x78;
        const double var_x80 = 0.00011230167246823642 * var_x79;
        const double var_x81 = var_x55 * var_x77;
        const double var_x82 = var_x66 * var_x74 / pow(var_x75, 2);
        const double var_x83 = ((var_x73) ? (var_x70 * var_x71 + var_x71 * var_x72) : (var_x77 * var_x80 + 4.203888546387683e-6 * var_x78 * var_x81 - 4.203888546387683e-6 * var_x79 * var_x82));
        const double var_x84 = var_x68 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x85 = var_x44 * (var_x84 - var_x43 * NV_Ith_S(mParameters, 8));
        const double var_x86 = var_x85 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x87 = 0.00018716945411372736 * var_x49;
        const double var_x88 = var_x53 * (var_x84 - var_x52 * NV_Ith_S(mParameters, 8));
        const double var_x89 = var_x88 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x90 = var_x74 * NV_Ith_S(mParameters, 8);
        const double var_x91 = var_x84 - var_x90;
        const double var_x92 = 0.00037433890822745472 * var_x91;
        const double var_x93 = ((var_x73) ? (var_x86 * var_x87 + var_x87 * var_x89) : (var_x77 * var_x92 + 1.4012961821292276e-5 * var_x81 * var_x90 - 1.4012961821292276e-5 * var_x82 * var_x91));
        const double var_x94 = 1 / NV_Ith_S(mParameters, 10);
        const double var_x95 = 0.001 * var_x94;
        const double var_x96 = 1 / var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x97 = var_x20 - var_x34;
        const double var_x98 = var_x37 * var_x97 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x99 = var_x14 * NV_Ith_S(mParameters, 16);
        const double var_x100 = var_x35 * var_x97 / pow(var_x36, 2);
        const double var_x101 = var_x100 * var_x99;
        const double var_x102 = var_x16 * var_x38;
        const double var_x103 = -18716944.910232361 + 374338.90820464725 * var_chaste_interface__membrane__V;
        const double var_x104 = var_x44 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x105 = 2.0000000001218549e-7 * var_x49;
        const double var_x106 = var_x105 * var_x45;
        const double var_x107 = var_x104 * var_x106;
        const double var_x108 = var_x53 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x109 = ((var_x57) ? (-var_x107 + var_x103 * (var_x107 + var_x106 * var_x108)) : (0.14973556329098189 * var_x45 * var_x65));
        const double var_x110 = (0.0071428571428571426 * var_chaste_interface__intracellular_potassium_concentration__K_i - 0.0071428571428571426 * var_x31) * NV_Ith_S(mParameters, 11);
        const double var_x111 = 1 / (var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i);
        const double var_x112 = NV_Ith_S(mParameters, 8) + 0.12 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x113 = -26.713760659695652 * log(var_x111 * var_x112) + var_chaste_interface__membrane__V;
        const double var_x114 = var_x113 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * NV_Ith_S(mParameters, 12) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x115 = var_x0 * var_x113;
        const double var_x116 = -9358472.2051161807 + 187169.45410232362 * var_chaste_interface__membrane__V;
        const double var_x117 = 1.0000000000609275e-9 * var_x49;
        const double var_x118 = var_x117 * var_x85;
        const double var_x119 = var_x49 * var_x55;
        const double var_x120 = var_x119 * var_x76;
        const double var_x121 = ((var_x73) ? (-var_x118 + var_x116 * (var_x118 + var_x117 * var_x88)) : (var_x120 * var_x92));
        const double var_x122 = 3.0000000001827821e-10 * var_x49;
        const double var_x123 = var_x122 * var_x70;
        const double var_x124 = ((var_x73) ? (-var_x123 + var_x116 * (var_x123 + var_x122 * var_x72)) : (var_x120 * var_x80));
        const double var_x125 = var_x105 * var_x47;
        const double var_x126 = var_x60 * var_x64;
        const double var_x127 = ((var_x57) ? (-var_x125 + var_x103 * (var_x125 + var_x105 * var_x54)) : (var_x119 * var_x126));
        const double var_x128 = var_x48 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x129 = 1.0000000000609275e-9 * var_x128;
        const double var_x130 = var_x129 * var_x85;
        const double var_x131 = var_x128 * var_x55;
        const double var_x132 = var_x131 * var_x76;
        const double var_x133 = ((var_x73) ? (-var_x130 + var_x116 * (var_x130 + var_x129 * var_x88)) : (var_x132 * var_x92));
        const double var_x134 = 3.0000000001827821e-10 * var_x128;
        const double var_x135 = var_x134 * var_x70;
        const double var_x136 = ((var_x73) ? (-var_x135 + var_x116 * (var_x135 + var_x134 * var_x72)) : (var_x132 * var_x80));
        const double var_x137 = 2.0000000001218549e-7 * var_x128;
        const double var_x138 = var_x137 * var_x47;
        const double var_x139 = ((var_x57) ? (-var_x138 + var_x103 * (var_x138 + var_x137 * var_x54)) : (var_x126 * var_x131));
        const double var_x140 = NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x141 = 1.0000000000609275e-9 * var_x140;
        const double var_x142 = var_x141 * var_x86;
        const double var_x143 = var_x140 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x144 = var_x143 * var_x55;
        const double var_x145 = var_x144 * var_x76;
        const double var_x146 = ((var_x73) ? (-var_x142 + var_x116 * (var_x142 + var_x141 * var_x89)) : (var_x145 * var_x92));
        const double var_x147 = 3.0000000001827821e-10 * var_x143;
        const double var_x148 = var_x147 * var_x70;
        const double var_x149 = ((var_x73) ? (-var_x148 + var_x116 * (var_x148 + var_x147 * var_x72)) : (var_x145 * var_x80));
        const double var_x150 = 2.0000000001218549e-7 * var_x143;
        const double var_x151 = var_x150 * var_x47;
        const double var_x152 = ((var_x57) ? (-var_x151 + var_x103 * (var_x151 + var_x150 * var_x54)) : (var_x126 * var_x144));
        const double var_x153 = var_x3 * (0.84999999999999998 * var_chaste_interface__membrane__V - 22.706696560741303 * var_x7);
        const double var_x154 = var_x40 * NV_Ith_S(mParameters, 17);
        const double var_x155 = var_x154 * var_x2;
        const double var_x156 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x157 = 1.0 + var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x158 = 1 / var_x157;
        const double var_x159 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x160 = var_x158 * var_x159;
        const double var_x161 = 0.69999999999999996 * var_x160;
        const double var_x162 = var_x1 * var_x111;
        const double var_x163 = var_chaste_interface__extracellular_potassium_concentration__K_o * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x164 = var_x158 * var_x163 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x165 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0) * NV_Ith_S(mParameters, 7);
        const double var_x166 = var_x165 * var_x18;
        const double var_x167 = var_x166 * var_x38;
        const double var_x168 = var_x20 - var_x17;
        const double var_x169 = var_x168 * var_x22 / pow(var_x25, 2);
        const double var_x170 = var_x165 * NV_Ith_S(mParameters, 16);
        const double var_x171 = var_x100 * var_x170;
        const double var_x172 = var_x117 * var_x68;
        const double var_x173 = var_x104 * var_x172;
        const double var_x174 = var_x68 * var_x81;
        const double var_x175 = ((var_x73) ? (-var_x173 + var_x116 * (var_x173 + var_x108 * var_x172)) : (0.00037433890822745472 * var_x174));
        const double var_x176 = 1 / var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x177 = 26.713760659695652 * var_x12;
        const double var_x178 = 0.0071428571428571426 * var_x32;
        const double var_x179 = var_x12 * var_x40;
        const double var_x180 = var_x159 * var_x163 / pow(var_x157, 2);
        const double var_x181 = 26.713760659695652 * var_x4;
        const double var_x182 = var_x1 / var_x112;
        const double var_x183 = 1.6699999999999999 * var_x41;
        const double var_x184 = var_x10 * var_x40 * var_chaste_interface__extracellular_potassium_concentration__K_o * NV_Ith_S(mParameters, 15) / pow((1 + 0.10000000000000001 * var_chaste_interface__extracellular_potassium_concentration__K_o), 2);
        const double var_x185 = var_x104 * var_x122;
        const double var_x186 = var_x185 * var_x43;
        const double var_x187 = var_x108 * var_x122;
        const double var_x188 = ((var_x73) ? (var_x186 + var_x116 * (-var_x186 - var_x187 * var_x52)) : (-0.00011230167246823642 * var_x74 * var_x81));
        const double var_x189 = var_x185 * var_x68;
        const double var_x190 = ((var_x73) ? (-var_x189 + var_x116 * (var_x189 + var_x187 * var_x68)) : (0.00011230167246823642 * var_x174));
        const double var_x191 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod;
        const double var_x192 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Trop;
        const double var_x193 = 0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_up + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x194 = 1 / var_x193;
        const double var_x195 = pow(var_x193, (-2));
        const double var_x196 = var_x195 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x197 = var_x195 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
        const double var_x198 = 0.00040816326530612252 * NV_Ith_S(mParameters, 1);
        const double var_x199 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
        const double var_x200 = pow(var_x199, (-2));
        const double var_x201 = var_x200 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x202 = pow(var_chaste_interface__calcium_release__ActFrac, 2);
        const double var_x203 = var_x202 / pow(var_x199, 3);
        const double var_x204 = var_x200 * var_x202 * NV_Ith_S(mParameters, 1);
        const double var_x205 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x206 = 0.001 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x207 = 1 / (1.0 - exp(9.9999999747524276e-8));
        const double var_x208 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x209 = -18.0 + var_chaste_interface__membrane__V;
        const double var_x210 = fabs(var_x209);
        const double var_x211 = var_x210 < 4.9999999873762135e-7;
        const double var_x212 = exp(3.6000000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x213 = 1.0 - var_x212;
        const double var_x214 = 1.5 / var_x213;
        const double var_x215 = exp(9.9999999984371854e-8);
        const double var_x216 = 1 / (-1.0 + var_x215);
        const double var_x217 = exp(-9.9999999984371854e-8);
        const double var_x218 = 1 / (-1.0 + var_x217);
        const double var_x219 = var_x210 < 1.4999999997655777e-6;
        const double var_x220 = exp(-1.2 + 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x221 = -1.0 + var_x220;
        const double var_x222 = 0.53400000000000003 / var_x221;
        const double var_x223 = 8.0099999987481852e-7 * var_x216;
        const double var_x224 = 7.4999999810643203e-7 * var_x207;
        const double var_x225 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x226 = 1 / (1.0 - exp(1.0000000045806701e-7));
        ...
        const double var_x234 = 0.00020000000091613401 * var_x226;
        const double var_x235 = exp(-7.5 + var_x229 + 0.10000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x236 = 1 / (1.0 + 320.0 * var_x235);
        const double var_x237 = 2.0 * var_x236;
        const double var_x238 = exp(-9.375 + 0.125 * NV_Ith_S(mParameters, 14) - 0.125 * var_chaste_interface__membrane__V);
        const double var_x239 = 0.02 * var_x238;
        const double var_x240 = 2.5 * var_x238;
        const double var_x241 = 20.0 * var_x238;
        const double var_x242 = 0.01 * NV_Ith_S(mParameters, 13);
        const double var_x243 = 1.0 - var_x242;
        const double var_x244 = var_x243 / (var_x241 + 2000.0 * var_x236);
        const double var_x245 = var_x235 / pow((0.0031250000000000002 + var_x235), 2);
        const double var_x246 = 0.01 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x247 = 1 / (1.0 - var_x215);
        const double var_x248 = 1 / (1.0 - var_x217);
        const double var_x249 = 4.0 + var_chaste_interface__membrane__V;
        const double var_x250 = fabs(var_x249);
        const double var_x251 = var_x250 < 2.9999999995311555e-7;
        const double var_x252 = exp(-1.3333333333333333 - 0.33333333333333331 * var_chaste_interface__membrane__V);
        const double var_x253 = 1.0 - var_x252;
        const double var_x254 = 30.0 / var_x253;
        const double var_x255 = var_x250 < 7.4999999988278887e-7;
        const double var_x256 = exp(0.53333333333333333 + 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x257 = -1.0 + var_x256;
        const double var_x258 = 12.0 / var_x257;
        const double var_x259 = 8.9999999985934664e-6 * var_x216;
        const double var_x260 = 8.9999999985934664e-6 * var_x247;
        const double var_x261 = 1 / (-1.0 + exp(9.999999987671386e-8));
        const double var_x262 = 1 / (-1.0 + exp(-9.999999987671386e-8));
        const double var_x263 = 24.0 + var_chaste_interface__membrane__V;
        const double var_x264 = fabs(var_x263) < 5.4999999932192623e-7;
        const double var_x265 = 0.18181818181818182 * var_chaste_interface__membrane__V;
        const double var_x266 = exp(4.3636363636363633 + var_x265);
        const double var_x267 = -1.0 + var_x266;
        const double var_x268 = 6.25 / var_x267;
        const double var_x269 = exp(-6.1818181818181817 - var_x265);
        const double var_x270 = 1.0 + var_x269;
        const double var_x271 = 3.4374999957620389e-6 * var_x261;
        const double var_x272 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x273 = exp(-0.067226890756302518 * var_chaste_interface__membrane__V);
        const double var_x274 = exp(-1.4285714285714286 - 0.14285714285714285 * var_chaste_interface__membrane__V);
        const double var_x275 = 1.0 + var_x274;
        const double var_x276 = exp(2.0 - 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x277 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x278 = NV_Ith_S(mParameters, 2) + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x281 = NV_Ith_S(mParameters, 3) + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        ...
        const double var_x296 = 0.00063182746016849224 * NV_Ith_S(mParameters, 6);
        const double var_x297 = 0.0013268376663538336 * var_x160;
        const double var_x298 = 0.11609829580596043 + 0.65789034290044246 * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x299 = 0.001 * var_x3;
        const double var_x300 = 0.001 * NV_Ith_S(mParameters, 6);
        const double var_x301 = 0.00077398863870640285 * NV_Ith_S(mParameters, 6);
        const double var_x302 = 0.001083584094188964 * var_x160;
        const double var_x303 = 5.5284902764743067e-6 * var_x32;
        const double var_x304 = 0.020676147247726494 * var_x12;
        const double var_x305 = 0.026713760659695648 * var_x298 * var_x3;
        const double var_x306 = 0.0012925610266396929 * var_x41;
        const double var_x307 = 0.00088455844423588909 * var_x160;
        const double var_x308 = 0.016878487549164489 * var_x12;
        const double var_x309 = 4.5130532869178019e-6 * var_x32;
        const double var_x310 = 0.016878487549164489 * var_x4;
        const double var_x311 = 0.001055151858481382 * var_x41;
        const double var_x312 = 0.002 * NV_Ith_S(mParameters, 1);
        const double var_x313 = -var_x205;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 * (0.0043499999999999997 + var_x1 + var_x13 + var_x4 + var_x67 + var_x83 + var_x93 + 0.00026738493444818193 * var_x33 + 0.999 * var_x39 - 0.062514597673984929 * var_x42 + var_x28 * (var_x21 + 0.018716945411372737 * var_x17)));
        IJth(rJacobian, 1, 0) = -7.8978432521061529e-8 + 0.00063119563270832375 * var_x39;
        IJth(rJacobian, 2, 0) = (0.001 - var_x206) * ((var_x211) ? (0.75 * var_x207 + 0.75 * var_x208) : (var_x214 - 0.29999999999999999 * var_x209 * var_x212 / pow(var_x213, 2))) - var_x206 * ((var_x219) ? (0.26700000000000002 * var_x216 + 0.26700000000000002 * var_x218) : (var_x222 - 0.0356 * var_x209 * var_x220 / pow(var_x221, 2)));
        IJth(rJacobian, 3, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x228) ? (99.999999644728632 * var_x225 + 100.00000035527137 * var_x226) : (var_x232 - 20.0 * var_x227 * var_x230 / pow(var_x231, 2))) + 0.44800000000000001 * var_x233 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 4, 0) = (var_x237 + var_x239) * (-var_x240 * var_x244 + 5.0000000000000004e-6 * var_x238 * var_x243 * (var_x240 - 0.625 * var_x245) / pow((var_x236 + 0.01 * var_x238), 2)) + (0.00062500000000000001 * var_x245 - 0.0025000000000000001 * var_x238) * (var_x242 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x241 * var_x244);
        IJth(rJacobian, 5, 0) = (0.01 - var_x246) * ((var_x251) ? (15.0 * var_x247 + 15.0 * var_x248) : (var_x254 - 10.0 * var_x249 * var_x252 / pow(var_x253, 2))) - var_x246 * ((var_x255) ? (6.0 * var_x216 + 6.0 * var_x218) : (var_x258 - 1.6000000000000001 * var_x249 * var_x256 / pow(var_x257, 2)));
        IJth(rJacobian, 6, 0) = (0.002 - 0.002 * var_chaste_interface__L_type_Ca_channel_f_gate__f) * ((var_x264) ? (3.125 * var_x261 + 3.125 * var_x262) : (var_x268 - 1.1363636363636365 * var_x263 * var_x266 / pow(var_x267, 2))) - 0.0043636363636363638 * var_x269 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x270, 2);
        IJth(rJacobian, 9, 0) = -0.067226890756302518 * var_x273 * (8.5800000000000009e-6 - 8.5800000000000009e-6 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0012257142857142857 * var_x274 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x275, 2);
        IJth(rJacobian, 10, 0) = 0.033300000000000003 * var_x276 / pow((1.0 + var_x276), 2);
        IJth(rJacobian, 13, 0) = (-6.3182746016849228e-8 - 0.0018935868981249711 * var_x39 - 0.00063182746016849224 * var_x1 - 0.00063182746016849224 * var_x93) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 14, 0) = (3.0959545548256117e-6 + 0.00077398863870640285 * var_x13 + 0.00077398863870640285 * var_x83 + 2.069529014241491e-7 * var_x33 - 4.8385588352966063e-5 * var_x42 + var_x298 * var_x299) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 15, 0) = (-2.5273098406739689e-6 + 3.9498439471809035e-5 * var_x42 - 0.00063182746016849224 * var_x13 - 0.00063182746016849224 * var_x4 - 0.00063182746016849224 * var_x83 - 1.6894114401971358e-7 * var_x33) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 16, 0) = -0.003159137300842461 * var_x67;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 * (var_x109 + 0.0033392200824619565 * var_x96 - 0.0049950000000000003 * var_x101 - 0.0068931000000000001 * var_x98 - 0.999 * var_x102));
        IJth(rJacobian, 1, 1) = -7.0 + var_x191 + var_x192 - 0.00063119563270832375 * var_x102 - 1.0549054718227806e-6 * var_x96 - 4.3552498656874335e-6 * var_x98 - 3.1559781635416187e-6 * var_x101 + (0.00040000000000000002 * var_x196 - 0.00040000000000000002 * var_x194 - 7.1999999999999991e-9 * var_x197) * NV_Ith_S(mParameters, 4);
        ...
        IJth(rJacobian, 11, 1) = -var_x291 + var_x277 * var_x290;
        IJth(rJacobian, 12, 1) = var_x291;
        IJth(rJacobian, 13, 1) = (9.4679344906248553e-6 * var_x101 + 0.0018935868981249711 * var_x102 + 1.3065749597062301e-5 * var_x98) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 16, 1) = -0.003159137300842461 * var_x109;
        IJth(rJacobian, 17, 1) = (3.5279999999999993e-7 * var_x197 + 0.019599999999999999 * var_x194 - 0.019599999999999999 * var_x196) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 19, 1) = 2.0 - var_x191;
        IJth(rJacobian, 20, 1) = 5.0 - var_x192;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x110 * var_x95);
        IJth(rJacobian, 2, 2) = -0.001 * ((var_x219) ? (var_x223 - 333333.33338542719 * (-18.0000015 + var_chaste_interface__membrane__V) * (-var_x223 - 8.0099999987481852e-7 * var_x218)) : (var_x209 * var_x222)) - 0.001 * ((var_x211) ? (-var_x224 + 1000000.0025247573 * (-17.999999500000001 + var_chaste_interface__membrane__V) * (var_x224 + 7.4999999810643203e-7 * var_x208)) : (var_x209 * var_x214));
        IJth(rJacobian, 14, 2) = var_x300 * (0.0055284902764743066 * var_chaste_interface__intracellular_potassium_concentration__K_i - 0.0055284902764743066 * var_x31) * NV_Ith_S(mParameters, 11);
        IJth(rJacobian, 15, 2) = -var_x110 * var_x296;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0030000000000000001 * var_x114 * var_x94);
        IJth(rJacobian, 3, 3) = -8.0 * var_x233 - 0.001 * ((var_x228) ? (-var_x234 + 499999.99948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (var_x234 + 0.00019999999949504854 * var_x225)) : (var_x227 * var_x232));
        IJth(rJacobian, 13, 3) = -0.0018954823805054767 * var_x114 * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x115 * var_x95);
        IJth(rJacobian, 4, 4) = -var_x237 - var_x239;
        IJth(rJacobian, 13, 4) = -var_x115 * var_x296;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 * (var_x121 + var_x124 + var_x127));
        IJth(rJacobian, 5, 5) = -0.01 * ((var_x255) ? (var_x259 - 666666.66677085438 * (3.9999992500000001 + var_chaste_interface__membrane__V) * (-var_x259 - 8.9999999985934664e-6 * var_x218)) : (var_x249 * var_x258)) - 0.01 * ((var_x251) ? (-var_x260 + 1666666.6669271358 * (4.0000003 + var_chaste_interface__membrane__V) * (var_x260 + 8.9999999985934664e-6 * var_x248)) : (var_x249 * var_x254));
        IJth(rJacobian, 13, 5) = -var_x121 * var_x296;
        IJth(rJacobian, 14, 5) = var_x124 * var_x301;
        IJth(rJacobian, 15, 5) = -var_x124 * var_x296;
        IJth(rJacobian, 16, 5) = -0.003159137300842461 * var_x127;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 * (var_x133 + var_x136 + var_x139));
        IJth(rJacobian, 6, 6) = -0.002 * ((var_x264) ? (var_x271 - 909090.91021169221 * (23.999999450000001 + var_chaste_interface__membrane__V) * (-var_x271 - 3.4374999957620389e-6 * var_x262)) : (var_x263 * var_x268)) - 0.024 / var_x270;
        IJth(rJacobian, 13, 6) = -var_x133 * var_x296;
        IJth(rJacobian, 14, 6) = var_x136 * var_x301;
        IJth(rJacobian, 15, 6) = -var_x136 * var_x296;
        IJth(rJacobian, 16, 6) = -0.003159137300842461 * var_x139;
        IJth(rJacobian, 7, 7) = -0.001;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 * (var_x146 + var_x149 + var_x152));
        IJth(rJacobian, 8, 8) = -0.02;
        IJth(rJacobian, 13, 8) = -var_x146 * var_x296;
        IJth(rJacobian, 14, 8) = var_x149 * var_x301;
        IJth(rJacobian, 15, 8) = -var_x149 * var_x296;
        IJth(rJacobian, 16, 8) = -0.003159137300842461 * var_x152;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x153 * var_x95);
        IJth(rJacobian, 9, 9) = -8.5800000000000009e-6 * var_x273 - 0.0085800000000000008 / var_x275;
        IJth(rJacobian, 14, 9) = var_x299 * (0.65789034290044246 * var_chaste_interface__membrane__V - 17.574725160567521 * var_x7) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 15, 9) = -var_x153 * var_x296;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x155 * var_x95);
        IJth(rJacobian, 10, 10) = -0.33300000000000002;
        IJth(rJacobian, 14, 10) = var_x154 * var_x298 * var_x300;
        IJth(rJacobian, 15, 10) = -var_x155 * var_x296;
        IJth(rJacobian, 1, 11) = (var_x198 * var_x201 - var_x198 * var_x203) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 11, 11) = var_x293 + var_x284 * (-0.059999999999999998 - var_x292);
        IJth(rJacobian, 12, 11) = var_x284 * (0.059999999999999998 + var_x292);
        IJth(rJacobian, 18, 11) = (var_x203 * var_x312 - var_x201 * var_x312) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 11, 12) = var_x293;
        IJth(rJacobian, 12, 12) = -0.001 * var_x284;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 * (var_x175 + 26.713760659695652 * var_x162 + 0.0026713760659695649 * var_x156 + 2.9969999999999999 * var_x167 - 0.00043749999999999995 * var_x164 - 0.014985 * var_x171 + var_x161 * var_chaste_interface__extracellular_potassium_concentration__K_o + 0.0030000000000000001 * var_x166 * var_x27 - 1.5e-5 * var_x169 * var_x170));
        IJth(rJacobian, 1, 13) = 0.0018935868981249711 * var_x167 - 9.4679344906248553e-6 * var_x171;
        IJth(rJacobian, 13, 13) = (8.2927354147114598e-7 * var_x164 + 2.8403803471874569e-5 * var_x171 - 0.016878487549164489 * var_x162 - 0.00063182746016849224 * var_x175 - 0.0056807606943749134 * var_x167 - 1.6878487549164488e-6 * var_x156 - var_x297 * var_chaste_interface__extracellular_potassium_concentration__K_o) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 14, 13) = (6.7724005886810246e-7 * var_x164 - var_x302 * var_chaste_interface__extracellular_potassium_concentration__K_o) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 15, 13) = (-5.5284902764743069e-7 * var_x164 + var_x307 * var_chaste_interface__extracellular_potassium_concentration__K_o) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 * (var_x179 + var_x183 + var_x188 - var_x177 - 0.69999999999999996 * var_x180 - 0.10685504263878261 * var_x176 - 0.01 * var_x184 - 3.2056512791634777 * var_x182 + var_x161 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x176 * var_x181 - var_x178 * var_x30));
        IJth(rJacobian, 13, 14) = (0.0020254185058997385 * var_x182 + 0.0013268376663538336 * var_x180 - var_x297 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 14, 14) = (-0.00069999999999999999 + var_x306 - var_x304 + 0.00077398863870640285 * var_x179 + 0.00077398863870640285 * var_x188 + 0.001083584094188964 * var_x180 - 8.2704588990905987e-5 * var_x176 - 7.7398863870640281e-6 * var_x184 - var_x176 * var_x305 - var_x30 * var_x303 - var_x302 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 15, 14) = (var_x308 - var_x311 + 6.7513950196657958e-5 * var_x176 + 6.3182746016849225e-6 * var_x184 - 0.00088455844423588909 * var_x180 - 0.00063182746016849224 * var_x179 - 0.00063182746016849224 * var_x188 + var_x176 * var_x310 + var_x30 * var_x309 + var_x307 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 * (var_x178 + var_x190 + 0.10685504263878261 * var_x5 + 3.2056512791634777 * var_x162 + var_x177 * var_x6 + var_x181 * var_x5 - var_x183 * var_x6));
        IJth(rJacobian, 13, 15) = -0.0020254185058997385 * var_x162 * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 14, 15) = (var_x303 + 8.2704588990905987e-5 * var_x5 + 0.00077398863870640285 * var_x190 + var_x304 * var_x6 + var_x305 * var_x5 - var_x306 * var_x6) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 15, 15) = (-var_x309 - 6.7513950196657958e-5 * var_x5 - 0.00063182746016849224 * var_x190 + var_x311 * var_x6 - var_x308 * var_x6 - var_x310 * var_x5) * NV_Ith_S(mParameters, 6);
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 * (-var_x16 * var_x28 - 5.0000000000000004e-6 * var_x169 * var_x99 - 6.9e-6 * var_x168 * var_x26 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2)));
        IJth(rJacobian, 1, 16) = 0.001;
        IJth(rJacobian, 8, 16) = -0.02 / var_x272 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x272, 2);
        IJth(rJacobian, 11, 16) = -var_x295 + var_x277 * var_x294;
        IJth(rJacobian, 12, 16) = var_x295;
        IJth(rJacobian, 16, 16) = -0.01;
        IJth(rJacobian, 1, 17) = (9.5999999999999999e-8 * var_x196 + 7.1999999999999991e-9 * var_x194 - 1.7279999999999999e-12 * var_x197) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 17, 17) = -0.050000000000000003 + (8.4671999999999982e-11 * var_x197 - 4.7039999999999993e-6 * var_x196 - 3.5279999999999993e-7 * var_x194) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 18, 17) = 0.0050000000000000001;
        IJth(rJacobian, 1, 18) = 0.00020408163265306126 * var_x204 + 0.00020408163265306126 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 17, 18) = 0.050000000000000003;
        IJth(rJacobian, 18, 18) = -0.0050000000000000001 - 0.001 * var_x204 - 0.001 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 1, 19) = 0.050000000000000003 + var_x205;
        IJth(rJacobian, 19, 19) = -0.050000000000000003 + var_x313;
        IJth(rJacobian, 1, 20) = 0.20000000000000001 + var_x205;
        IJth(rJacobian, 20, 20) = -0.20000000000000001 + var_x313;
    }
