...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellespinosa_model_1998_normalFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x178 = 1.0 - var_x175;
        const double var_x179 = var_x177 * var_x178;
        const double var_x180 = var_x175 + var_x179 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x181 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x173, 2);
        const double var_x182 = 2 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x183 = var_x180 * (-2 * var_x181 + 2 * var_x174 + var_x177 * var_x182 * (var_x181 - var_x174));
        ...
        const double var_x189 = pow(var_x180, 2);
        const double var_x190 = 2.5 * var_x189;
        const double var_x191 = 0.5 * var_x189;
        const double var_x192 = var_x180 * (2 * var_x179 - var_x178 * var_x182 / pow(var_x176, 2));
        ...
        const double var_x219 = -var_x125;
        ...
        IJth(rJacobian, 2, 0) = ((var_x127) ? (0) : (var_x128 * var_x131 - var_x134 * var_chaste_interface__time_dependent_potassium_current_x_gate__x + 3.5599999999999998e-5 * var_x126 * var_x132 * var_chaste_interface__time_dependent_potassium_current_x_gate__x / pow(var_x133, 2) - 0.00030000000000000003 * var_x126 * var_x128 * var_x129 / pow(var_x130, 2)));
        ...
        IJth(rJacobian, 11, 1) = ((var_x186) ? (-var_x185 + var_x172 * var_x184) : (-var_x188 + var_x172 * var_x187));
        ...
        IJth(rJacobian, 4, 4) = -0.02 * var_x145 - 2.0 / (1.0 + 320.0 * var_x146);
        ...
        IJth(rJacobian, 9, 9) = -0.0085800000000000008 / var_x170 - 8.5800000000000009e-6 * var_x168;
        ...
        IJth(rJacobian, 11, 16) = ((var_x186) ? (-var_x194 + var_x172 * var_x193) : (-var_x196 + var_x172 * var_x195));
        ...
        IJth(rJacobian, 19, 19) = -0.050000000000000003 + var_x219;
        IJth(rJacobian, 1, 20) = 0.20000000000000001 + var_x125;
        IJth(rJacobian, 20, 20) = -0.20000000000000001 + var_x219;
    }
