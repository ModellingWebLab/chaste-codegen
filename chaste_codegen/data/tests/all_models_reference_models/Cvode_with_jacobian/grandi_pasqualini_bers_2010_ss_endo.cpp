...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x179 = var_x17 * var_x178;
        const double var_x180 = 7.236374999999999e-11 * var_x22;
        const double var_x181 = -0.5 + 187179.41753901311 * var_chaste_interface__membrane_potential__V_m;
        const double var_x182 = ((var_x25) ? (var_x179 - var_x181 * (-var_x179 - var_x180 * var_x21)) : (var_x32 * var_chaste_interface__membrane_potential__V_m));
        ...
        const double var_x186 = var_x183 * var_x22;
        const double var_x187 = -0.5 + 374358.83507802623 * var_chaste_interface__membrane_potential__V_m;
        const double var_x188 = ((var_x50) ? (var_x185 - var_x187 * (-var_x185 - var_x186 * var_x48)) : (var_x56 * var_chaste_interface__membrane_potential__V_m));
        const double var_x189 = var_x178 * var_x63;
        const double var_x190 = ((var_x25) ? (var_x189 - var_x181 * (-var_x189 - var_x180 * var_x64)) : (var_x66 * var_chaste_interface__membrane_potential__V_m));
        const double var_x191 = var_x184 * var_x73;
        const double var_x192 = ((var_x50) ? (var_x191 - var_x187 * (-var_x191 - var_x186 * var_x74)) : (var_x76 * var_chaste_interface__membrane_potential__V_m));
        const double var_x193 = 1.3025475e-9 * var_x80;
        const double var_x194 = ((var_x25) ? (var_x193 - var_x181 * (-var_x193 - 1.3025475e-9 * var_x81)) : (var_x83 * var_chaste_interface__membrane_potential__V_m));
        ...
        const double var_x230 = 9.7691062499999988e-10 * var_x202;
        ...
        IJth(rJacobian, 11, 0) = (-var_chaste_interface__I_Ca__d + 1 / var_x358) * ((var_x366) ? (4.4099999986215979e-16 * (-39682539694942.977 * var_x360 - 39682539694942.977 * var_x363) / pow((-var_x360 + 0.017500000000000002 * var_x364), 2)) : (var_x369 - var_x368 * var_x370 - var_x358 * var_x370 / pow(var_x367, 2))) + 0.16666666666666666 * var_x357 * var_x371 / pow(var_x358, 2);
