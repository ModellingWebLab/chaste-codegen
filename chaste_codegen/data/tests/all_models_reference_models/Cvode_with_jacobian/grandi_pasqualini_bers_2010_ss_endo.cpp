...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_parameters__pCa = 0.00054000000000000001 * NV_Ith_S(mParameters, 7); // cm_per_sec
        const double var_I_Ca__ibarca_j = 4.0 * (-0.34100000000000003 * NV_Ith_S(mParameters, 4) + 0.34100000000000003 * var_chaste_interface__Ca_Concentrations__Ca_j * exp(2.0 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * var_parameters__Frdy * var_parameters__pCa / (-1.0 + exp(2.0 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // uA_per_uF
        ...
        const double var_I_Ca__ibarca_sl = 4.0 * (-0.34100000000000003 * NV_Ith_S(mParameters, 4) + 0.34100000000000003 * var_chaste_interface__Ca_Concentrations__Ca_sl * exp(2.0 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * var_parameters__Frdy * var_parameters__pCa / (-1.0 + exp(2.0 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // uA_per_uF
    ...
    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x15 = var_x14 * var_chaste_interface__I_Na__j * NV_Ith_S(mParameters, 8);
        const double var_x16 = var_x15 * var_chaste_interface__I_Na__h;
        const double var_x17 = sqrt(NV_Ith_S(mParameters, 5));
        const double var_x18 = var_x17 * NV_Ith_S(mParameters, 13) * var_chaste_interface__I_Kr__x_kr;
        ...
        const double var_x33 = var_x17 * NV_Ith_S(mParameters, 12) / (var_x32 + 1.02 * var_x25);
        ...
        const double var_x37 = var_x36 * NV_Ith_S(mParameters, 4);
        ...
        const double var_x40 = pow(NV_Ith_S(mParameters, 6), 3);
        ...
        const double var_x44 = NV_Ith_S(mParameters, 16) / var_x43;
        ...
        const double var_x64 = -0.75 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x76 = var_x75 * NV_Ith_S(mParameters, 4);
        ...
        const double var_x89 = -0.75 * NV_Ith_S(mParameters, 5) + var_x65 * var_chaste_interface__K_Concentration__K_i;
        ...
        const double var_x97 = exp(0.01485884101040119 * NV_Ith_S(mParameters, 6));
        ...
        const double var_x100 = NV_Ith_S(mParameters, 17) * NV_Ith_S(mParameters, 5) / (1.5 + NV_Ith_S(mParameters, 5));
        ...
        const double var_x107 = NV_Ith_S(mParameters, 7) / var_x106;
        ...
        const double var_x111 = -0.34100000000000003 * NV_Ith_S(mParameters, 4);
        ...
        const double var_x118 = 0.42189361069797565 * var_x117 * var_x25 * NV_Ith_S(mParameters, 12) / pow((var_x25 + 0.98039215686274506 * var_x32), 2);
        const double var_x119 = var_x77 - var_x79;
        const double var_x120 = var_x39 * NV_Ith_S(mParameters, 16) / pow(var_x43, 2);
        ...
        const double var_x141 = var_x140 * NV_Ith_S(mParameters, 7) / pow(var_x106, 2);
        ...
        const double var_x149 = -26.712338705498265 * log(var_x148 * NV_Ith_S(mParameters, 6)) + var_chaste_interface__membrane_potential__V_m;
        const double var_x150 = var_chaste_interface__I_Na__h * NV_Ith_S(mParameters, 8);
        const double var_x151 = var_x150 * pow(var_chaste_interface__I_Na__m, 2) * var_chaste_interface__I_Na__j;
        const double var_x152 = var_x149 * var_x151;
        const double var_x153 = 1 / var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x154 = -26.712338705498265 * log(var_x153 * NV_Ith_S(mParameters, 6)) + var_chaste_interface__membrane_potential__V_m;
        const double var_x155 = var_x151 * var_x154;
        const double var_x156 = 0.11 * var_x149;
        const double var_x157 = 0.89000000000000001 * var_x154;
        const double var_x158 = var_x14 * var_x150;
        const double var_x159 = 1 / (0.018329999999999999 * var_chaste_interface__Na_Concentrations__Na_i + var_chaste_interface__K_Concentration__K_i);
        const double var_x160 = (-26.712338705498265 * log(var_x159 * (0.018329999999999999 * NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 5))) + var_chaste_interface__membrane_potential__V_m) * var_chaste_interface__I_Ks__x_ks;
        const double var_x161 = (1.0042770859719128 * var_x10 - 0.037595999999999997 * var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 15);
        const double var_x162 = (0.037504123542519557 * var_x10 - 0.0014039999999999999 * var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 11);
        const double var_x163 = var_x60 * var_chaste_interface__membrane_potential__V_m;
        const double var_x164 = var_x163 * var_x61;
        const double var_x165 = var_x69 * var_x73;
        const double var_x166 = var_x89 * var_x92;
        const double var_x167 = var_x124 * var_chaste_interface__membrane_potential__V_m;
        const double var_x168 = var_x114 * var_x69;
        const double var_x169 = var_x167 * var_x61;
        const double var_x170 = var_x59 * var_chaste_interface__membrane_potential__V_m;
        const double var_x171 = var_x170 * var_x62;
        const double var_x172 = var_x170 * var_chaste_interface__I_Ca__d;
        const double var_x173 = var_x107 * var_chaste_interface__membrane_potential__V_m;
        const double var_x174 = var_x173 * var_chaste_interface__I_Ca__d;
        const double var_x175 = var_x123 * var_x173;
        const double var_x176 = var_x90 * var_chaste_interface__membrane_potential__V_m;
        const double var_x177 = var_x108 * var_x173;
        ...
        const double var_x184 = 3 * NV_Ith_S(mParameters, 4);
        ...
        const double var_x190 = 2.4510059584016866e-13 * var_x189;
        const double var_x191 = var_x35 * NV_Ith_S(mParameters, 4);
        ...
        const double var_x200 = 1.9830866390704552e-12 * var_x199;
        ...
        const double var_x203 = var_x159 * var_x7;
        const double var_x204 = var_x159 * var_x8;
        const double var_x205 = var_x9 * var_x93;
        ...
        const double var_x210 = 61.507432902288166 + var_chaste_interface__membrane_potential__V_m;
        ...
        const double var_x239 = NV_Ith_S(mParameters, 2) / (1.0 + var_x236 + var_x238);
        const double var_x240 = var_x234 * var_x239;
        const double var_x241 = (var_x238 - var_x236) * NV_Ith_S(mParameters, 2) / pow((3.5530476870814998e-7 + var_x237 + 1.3765399305573384e-7 * var_x235), 2);
        ...
        const double var_x253 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x259 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 10) - 0.14705882352941177 * var_chaste_interface__membrane_potential__V_m);
        const double var_x260 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 10) - 0.0900900900900901 * var_chaste_interface__membrane_potential__V_m);
        const double var_x261 = 1.0 + var_x260;
        const double var_x262 = exp(0.34849999999999998 * var_chaste_interface__membrane_potential__V_m - 0.34849999999999998 * NV_Ith_S(mParameters, 10));
        const double var_x263 = exp(0.079000000000000001 * var_chaste_interface__membrane_potential__V_m - 0.079000000000000001 * NV_Ith_S(mParameters, 10));
        const double var_x264 = 0.01 * NV_Ith_S(mParameters, 9);
        const double var_x265 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * NV_Ith_S(mParameters, 10));
        const double var_x266 = 1.0 + var_x265;
        const double var_x267 = 1.0 - var_x264;
        const double var_x268 = var_x264 + var_x267 / pow(var_x266, 2);
        ...
        const double var_x271 = 0.26917900403768508 * var_x265 * var_x267 / pow(var_x266, 3);
        const double var_x272 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane_potential__V_m - 0.311 * NV_Ith_S(mParameters, 10));
        const double var_x273 = 1.0 + var_x272;
        const double var_x274 = 1 / var_x273;
        const double var_x275 = exp(0.24440000000000001 * var_chaste_interface__membrane_potential__V_m - 0.24440000000000001 * NV_Ith_S(mParameters, 10));
        const double var_x276 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 10) - 0.043909999999999998 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x280 = exp(-3.2000000000000002 + 0.10000000000000001 * NV_Ith_S(mParameters, 10) - 0.10000000000000001 * var_chaste_interface__membrane_potential__V_m);
        const double var_x281 = 1.0 + var_x280;
        const double var_x282 = exp(0.057000000000000002 * var_chaste_interface__membrane_potential__V_m - 0.057000000000000002 * NV_Ith_S(mParameters, 10));
        const double var_x283 = var_x282 / var_x281;
        const double var_x284 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 10) - 0.13780000000000001 * var_chaste_interface__membrane_potential__V_m);
        const double var_x285 = 1.0 + var_x284;
        const double var_x286 = exp(0.01052 * NV_Ith_S(mParameters, 10) - 0.01052 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x302 = 0.20000000000000001 * var_chaste_interface__membrane_potential__V_m;
        const double var_x303 = exp(-2.0 - var_x302);
        const double var_x304 = 1.0 + var_x303;
        const double var_x305 = 1 / (230.0 * var_x293 + 3300.0 * var_x301);
        const double var_x306 = exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_x314 = exp(1.4615384615384615 - 0.076923076923076927 * var_chaste_interface__membrane_potential__V_m);
        const double var_x315 = 1.0 + var_x314;
        const double var_x316 = 0.076923076923076927 * var_x314 / pow(var_x315, 2);
        const double var_x317 = 1 / var_x315;
        ...
        const double var_x322 = exp(3.8999999999999999 + var_x302);
        const double var_x323 = 1.0 + var_x322;
        const double var_x324 = 0.20000000000000001 * var_x322 / pow(var_x323, 2);
        ...
        const double var_x335 = -var_chaste_interface__I_Ca__d + var_x334;
        ...
        const double var_x340 = 0.0058333333333333336 * var_x330;
        ...
        const double var_x343 = exp(2.5 - var_x290);
        const double var_x344 = 1.0 + var_x343;
        const double var_x345 = exp(3.8888888888888888 + var_x294);
        ...
        const double var_x357 = var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x358 = var_x347 * var_x348 / pow(var_x349, 2);
        const double var_x359 = 2.3772197685794643 * var_x358;
        const double var_x360 = 0.21130842387373014 * var_x358 * var_x45 / pow((1 - 0.93333333333333335 * var_x350), 2);
        const double var_x361 = var_x360 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x362 = 20.0 * var_x354;
        const double var_x363 = var_x357 * var_x362;
        const double var_x364 = var_x359 * var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x365 = 7.5 - var_x351;
        const double var_x366 = 1.0 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        ...
        const double var_x383 = 18.571428571428569 * NV_Ith_S(mParameters, 0);
        const double var_x384 = var_chaste_interface__SR_Fluxes__Ry_Ro * NV_Ith_S(mParameters, 1);
        const double var_x385 = var_x384;
        const double var_x386 = var_x232 * NV_Ith_S(mParameters, 3);
        const double var_x387 = var_x386 * NV_Ith_S(mParameters, 18);
        const double var_x388 = 1830221710.9367213 * var_x387;
        const double var_x389 = var_x15 * var_x387;
        const double var_x390 = 201324388.20303935 * var_x149;
        const double var_x391 = var_x158 * var_x387;
        const double var_x392 = 20080.192774192485 * var_x387 * var_x72;
        const double var_x393 = var_x392 * var_x69;
        const double var_x394 = 3.2338732908121872 * var_x232;
        const double var_x395 = 7.3530178752050587e-13 * var_x189;
        const double var_x396 = var_x232 * NV_Ith_S(mParameters, 18);
        const double var_x397 = 49324475.109744638 * var_x387;
        const double var_x398 = 43898782.847672731 * var_x154;
        const double var_x399 = 60.129021696054153 * var_x387 * var_x66;
        ...
        const double var_x403 = 2891547759.4837179 * var_x113 * var_x396;
        const double var_x404 = var_x403 * var_x69;
        const double var_x405 = 1205.9369202226344 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x410 = 8658579.1242317986 * var_x122 * var_x396;
        const double var_x411 = 3.9661732781409103e-12 * var_x199;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.010148299999999999 + var_x131 + var_x133 + var_x142 + var_x143 - var_x115 - var_x126 - var_x135 - var_x139 - var_x145 - var_x147 - var_x68 - var_x74 - var_x16 - 0.002 * var_x2 - 0.11 * var_x102 - 0.11 * var_x55 - 0.89000000000000001 * var_x104 - 0.89000000000000001 * var_x8 - 0.89000000000000001 * var_x88 - 0.006029375 / var_x4 - 0.0077830699248061953 * var_x121 - 0.037595999999999997 * var_x12 - 0.0014039999999999999 * var_x13 - 0.048783124999999997 / var_x6 - 0.00038500000000000003 * var_x7 - 0.4389381125701739 * var_x34 - 0.00096195246261649608 * var_x128 - var_x118 * (0.24326999999999999 * var_x93 - 0.51429999999999998 * var_x116 - var_x28 * (0.061749999999999999 * var_x30 + 0.039456396800000001 * var_x29)) - var_x18 * var_x22 - var_x90 * var_x92 + 0.10468673984798647 * var_x93 * var_x94 - 6.1608909430225857e-6 * var_x137 * var_chaste_interface__K_Concentration__K_i - 0.00033444816053511704 * var_x0 * var_x11 / pow(var_x1, 2) + 0.017930478454663966 * var_x11 * var_x18 * var_x19 / pow(var_x20, 2) + 8.2145212573634477e-6 * var_x108 * var_x130 * var_x89 * var_x91);
        IJth(rJacobian, 2, 0) = 59.906641489902128 * (-var_chaste_interface__I_Na__m + 1 / pow(var_x254, 2)) * (-var_x255 * (-0.3792264410025028 - 0.0082818615637148471 * var_chaste_interface__membrane_potential__V_m) - var_x256 * (0.0036911829173615863 - 0.00076532923851577563 * var_chaste_interface__membrane_potential__V_m)) / pow((var_x252 + 0.5020897832817337 * var_x251), 2) + 0.22148394241417499 * var_x253 * var_x257 / pow(var_x254, 3);
        IJth(rJacobian, 3, 0) = (var_x268 - var_chaste_interface__I_Na__h) * (((var_x258) ? (0) : (-0.008382352941176471 * var_x259)) + ((var_x258) ? (0.53361053361053368 * var_x260 / pow(var_x261, 2)) : (108035.0 * var_x262 + 0.21330000000000002 * var_x263))) - var_x271 * (var_x269 + var_x270);
        IJth(rJacobian, 4, 0) = (var_x268 - var_chaste_interface__I_Na__j) * (((var_x258) ? (0) : (var_x278 + var_x274 * var_x279 * (3.0508668000000001e-7 * var_x276 - 6214.6032000000005 * var_x275) - 0.311 * var_x272 * var_x277 * var_x279 / pow(var_x273, 2))) + ((var_x258) ? (0.034200000000000001 * var_x283 + 0.059999999999999998 * var_x280 * var_x282 / pow(var_x281, 2)) : (-0.00025500480000000003 * var_x287 + 0.0033402720000000005 * var_x284 * var_x286 / pow(var_x285, 2)))) - var_x271 * (var_x288 + var_x289);
        IJth(rJacobian, 5, 0) = 9.1827364554637282e-8 * (-var_chaste_interface__I_Kr__x_kr + 1 / var_x304) * (11.5 * var_x291 / pow(var_x292, 2) + 366.66666666666669 * var_x295 * var_x300 / pow(var_x296, 2) - 366.66666666666669 * var_x297 * var_x298 / pow(var_x299, 2)) / pow((var_x301 + 0.069696969696969702 * var_x293), 2) + 0.20000000000000001 * var_x303 * var_x305 / pow(var_x304, 2);
        IJth(rJacobian, 6, 0) = -7.1529673512819408e-5 * var_x308 * (-var_chaste_interface__I_Ks__x_ks + 1 / var_x307) + 0.070175438596491224 * var_x306 * (0.00100999899000101 + var_x309) / pow(var_x307, 2);
        IJth(rJacobian, 7, 0) = var_x313 * var_x316 + 0.0074074074074074077 * var_x310 * (var_x317 - var_chaste_interface__I_to__x_to_s) / (pow(var_x311, 2) * pow((0.055555555555555552 + var_x312), 2));
        IJth(rJacobian, 8, 0) = -var_x321 * var_x324 + 0.000125 * var_x318 * (var_x325 - var_chaste_interface__I_to__y_to_s) / (pow(var_x319, 2) * pow((0.037499999999999999 + var_x320), 2));
        IJth(rJacobian, 9, 0) = var_x316 * var_x327 - 0.11764705882352941 * var_x326 * (-0.035999999999999997 - 0.00080000000000000004 * var_chaste_interface__membrane_potential__V_m) * (var_x317 - var_chaste_interface__I_to__x_to_f) / pow((0.058823529411764705 + var_x326), 2);
        IJth(rJacobian, 10, 0) = -var_x324 * var_x329 - 0.011764705882352941 * var_x328 * (-0.36363636363636365 - 0.0090909090909090905 * var_chaste_interface__membrane_potential__V_m) * (var_x325 - var_chaste_interface__I_to__y_to_f) / pow((0.082352941176470587 + var_x328), 2);
        IJth(rJacobian, 11, 0) = var_x336 * var_x337 - var_x336 * var_x341 + var_x334 * var_x339 * var_x340 - var_x333 * var_x335 * var_x341 / pow(var_x331, 2);
        IJth(rJacobian, 12, 0) = (0.02 + var_x342) * (0.029999999999999999 * var_x343 / pow(var_x344, 2) - 0.1111111111111111 * var_x345 / pow(var_x346, 2)) + var_x342 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__membrane_potential__V_m) * (-var_chaste_interface__I_Ca__f + 1 / var_x346 + 0.59999999999999998 / var_x344);
        IJth(rJacobian, 33, 0) = -var_x388 * (6.567e-5 + var_x139 + var_x74 - var_x131 + 0.11 * var_x16 + 0.33000000000000002 * var_x102 + 0.33000000000000002 * var_x55 + 0.0028858573878494881 * var_x128);
        IJth(rJacobian, 34, 0) = -var_x397 * (0.00053133 + var_x135 + var_x68 - var_x133 + 0.89000000000000001 * var_x16 + 2.6699999999999999 * var_x104 + 2.6699999999999999 * var_x88 + 0.023349209774418588 * var_x121);
        IJth(rJacobian, 37, 0) = -var_x402 * (6.0643000000000002e-5 + var_x115 + var_x147 - var_x143 - 0.22 * var_x55 - 0.0019239049252329922 * var_x128);
        IJth(rJacobian, 38, 0) = -var_x409 * (0.00049065700000000003 + var_x126 + var_x145 - var_x142 - 1.78 * var_x88 - 0.015566139849612391 * var_x121);
        IJth(rJacobian, 1, 1) = -7.0788000000000011 + var_x225 + var_x226 + var_x227 + var_x228 + var_x229 + var_x230 + var_x231 - var_x233 + 3.4188518090540365e-8 * var_x242 - 270818.42237280885 * var_x240;
        IJth(rJacobian, 20, 1) = 2.2890000000000006 - var_x227;
        IJth(rJacobian, 21, 1) = 0.33180000000000004 - var_x228 - var_x229;
        IJth(rJacobian, 23, 1) = 0.81600000000000006 - var_x225;
        IJth(rJacobian, 24, 1) = 1.9320000000000004 - var_x230 - var_x231;
        IJth(rJacobian, 26, 1) = 1.71 - var_x226;
        IJth(rJacobian, 32, 1) = 5029484.9869235931 * var_x240 - 6.3492962168146398e-7 * var_x242;
        IJth(rJacobian, 38, 1) = 15.582629387269481 * var_x232;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.33000000000000002 * var_x152 - 2.6699999999999999 * var_x155);
        IJth(rJacobian, 2, 2) = -var_x257;
        IJth(rJacobian, 33, 2) = -603973164.60911798 * var_x152 * var_x387;
        IJth(rJacobian, 34, 2) = -131696348.54301819 * var_x155 * var_x387;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x15 * var_x156 - var_x15 * var_x157);
        IJth(rJacobian, 3, 3) = -var_x269 - var_x270;
        IJth(rJacobian, 33, 3) = -var_x389 * var_x390;
        IJth(rJacobian, 34, 3) = -var_x389 * var_x398;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x156 * var_x158 - var_x157 * var_x158);
        IJth(rJacobian, 4, 4) = -var_x288 - var_x289;
        IJth(rJacobian, 33, 4) = -var_x390 * var_x391;
        IJth(rJacobian, 34, 4) = -var_x391 * var_x398;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x117 * var_x22 * NV_Ith_S(mParameters, 13));
        IJth(rJacobian, 5, 5) = -var_x305;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00077000000000000007 * var_x160 - 1.78 * var_x160 * NV_Ith_S(mParameters, 14));
        IJth(rJacobian, 6, 6) = -0.00100999899000101 - var_x309;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x161 * var_chaste_interface__I_to__y_to_s);
        IJth(rJacobian, 7, 7) = -var_x313;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x161 * var_chaste_interface__I_to__x_to_s);
        IJth(rJacobian, 8, 8) = -var_x321;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x162 * var_chaste_interface__I_to__y_to_f);
        IJth(rJacobian, 9, 9) = -var_x327;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x162 * var_chaste_interface__I_to__x_to_f);
        IJth(rJacobian, 10, 10) = -var_x329;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x123 * var_x169 - var_x163 * var_x165 - var_x163 * var_x166 - var_x164 * var_x67 - var_x167 * var_x168);
        IJth(rJacobian, 11, 11) = -var_x337 * var_x339;
        IJth(rJacobian, 33, 11) = -var_x163 * var_x393;
        IJth(rJacobian, 34, 11) = -var_x164 * var_x399;
        IJth(rJacobian, 37, 11) = -var_x167 * var_x404;
        IJth(rJacobian, 38, 11) = -var_x169 * var_x410;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x165 * var_x172 - var_x166 * var_x172 - var_x168 * var_x174 - var_x171 * var_x67 - var_x175 * var_x62);
        IJth(rJacobian, 12, 12) = -0.02 - var_x342;
        IJth(rJacobian, 33, 12) = -var_x172 * var_x393;
        IJth(rJacobian, 34, 12) = -var_x171 * var_x399;
        IJth(rJacobian, 37, 12) = -var_x174 * var_x404;
        IJth(rJacobian, 38, 12) = -var_x173 * var_x410 * var_x62;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (0.00019748616671718712 * var_x176 + var_x114 * var_x177 + var_x136 * var_x73);
        IJth(rJacobian, 13, 13) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_Concentrations__Ca_j;
        IJth(rJacobian, 33, 13) = var_x136 * var_x392;
        IJth(rJacobian, 37, 13) = var_x177 * var_x403;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (2.1942907413020785e-5 * var_x176 + var_x108 * var_x175 + var_x136 * var_x67);
        IJth(rJacobian, 14, 14) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        IJth(rJacobian, 34, 14) = var_x136 * var_x399;
        IJth(rJacobian, 38, 14) = var_x177 * var_x410;
        IJth(rJacobian, 15, 15) = -0.0050000000000000001 + var_x353 + var_x356;
        IJth(rJacobian, 16, 15) = var_x355;
        IJth(rJacobian, 17, 15) = var_x356;
        IJth(rJacobian, 15, 16) = 0.055;
        IJth(rJacobian, 16, 16) = -0.059999999999999998 + var_x353;
        IJth(rJacobian, 17, 16) = var_x356 + var_x365 * var_chaste_interface__Ca_Concentrations__Ca_j;
        ...
        IJth(rJacobian, 17, 17) = -0.065000000000000002 + var_x356;
        IJth(rJacobian, 18, 18) = -0.001 - var_x367;
        IJth(rJacobian, 33, 18) = (0.001 + var_x367) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 19, 19) = -0.001 - var_x369;
        IJth(rJacobian, 34, 19) = (0.001 + var_x369) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 1, 20) = 0.019599999999999999 + var_x243;
        IJth(rJacobian, 20, 20) = -0.019599999999999999 - var_x243;
        IJth(rJacobian, 1, 21) = 0.003032 + var_x244;
        IJth(rJacobian, 21, 21) = -3.1999999999999999e-5 + var_x371;
        IJth(rJacobian, 22, 21) = -0.0030000000000000001;
        IJth(rJacobian, 1, 22) = 0.0063300000000000006 + var_x244;
        IJth(rJacobian, 21, 22) = var_x371;
        IJth(rJacobian, 22, 22) = -0.0063300000000000006;
        IJth(rJacobian, 1, 23) = 0.23799999999999999 + var_x245;
        IJth(rJacobian, 23, 23) = -0.23799999999999999 - var_x245;
        IJth(rJacobian, 1, 24) = 0.016159999999999997 + var_x246;
        IJth(rJacobian, 24, 24) = -0.00046000000000000001 + var_x372;
        IJth(rJacobian, 25, 24) = -0.015699999999999999;
        IJth(rJacobian, 1, 25) = 0.015757 + var_x246;
        IJth(rJacobian, 24, 25) = var_x372;
        IJth(rJacobian, 25, 25) = -0.015757;
        IJth(rJacobian, 1, 26) = 0.059999999999999998 + var_x247;
        IJth(rJacobian, 26, 26) = -0.059999999999999998 - var_x247;
        IJth(rJacobian, 27, 27) = -1.3 + var_x374;
        IJth(rJacobian, 37, 27) = 1.3 + var_x373;
        IJth(rJacobian, 28, 28) = -1.3 + var_x377;
        IJth(rJacobian, 38, 28) = 1.3 + var_x376;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x374;
        IJth(rJacobian, 37, 29) = 0.029999999999999999 + var_x373;
        IJth(rJacobian, 30, 30) = -0.029999999999999999 + var_x377;
        IJth(rJacobian, 38, 30) = 0.029999999999999999 + var_x376;
        IJth(rJacobian, 31, 31) = -65.0 - var_x381;
        IJth(rJacobian, 32, 31) = 65.0 + var_x381;
        IJth(rJacobian, 1, 32) = 0.037279237232671424 * var_x249 + 4.7061860318210743e-15 * var_x250;
        IJth(rJacobian, 15, 32) = -var_x361 + var_x357 * var_x359;
        IJth(rJacobian, 16, 32) = var_x361 + var_x364;
        IJth(rJacobian, 17, 32) = -var_x364 + var_x360 * var_x366;
        IJth(rJacobian, 31, 32) = 260.0 - var_x382;
        IJth(rJacobian, 32, 32) = -260.0 + var_x382 - var_x383 - var_x385 - 0.69232869146389786 * var_x249 - 8.7400597733819945e-14 * var_x250;
        IJth(rJacobian, 37, 32) = var_x405 + var_x406;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x178 - var_x179 - var_x180 - 0.33000000000000002 * var_x192 - 3.0052592036063111e-5 * var_x182 - var_x186 * var_x190);
        IJth(rJacobian, 18, 33) = 0.0007561 - var_x368;
        IJth(rJacobian, 33, 33) = (-0.0007561 + var_x368 - var_x394 - 1830221710.9367213 * var_x396 * (var_x178 + var_x179 + var_x180 + 9.0157776108189337e-5 * var_x182 + 0.98999999999999999 * var_x192 + var_x186 * var_x395)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 34, 33) = 0.087152885187388451 * var_x386;
        IJth(rJacobian, 37, 33) = -var_x402 * (-0.66000000000000003 * var_x192 - var_x186 * var_x407);
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x193 - var_x194 - var_x195 - 2.6699999999999999 * var_x202 - 0.00024315279010996517 * var_x201 - var_x197 * var_x200);
        IJth(rJacobian, 19, 34) = 0.000165 - var_x370;
        IJth(rJacobian, 33, 34) = var_x394 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 34, 34) = (-0.000165 + var_x370 - 7.8853682331945256 * var_x232 - 49324475.109744638 * var_x396 * (var_x193 + var_x194 + var_x195 + 8.0099999999999998 * var_x202 + 0.00072945837032989554 * var_x201 + var_x197 * var_x400)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 35, 34) = var_x401;
        IJth(rJacobian, 38, 34) = -var_x409 * (-5.3399999999999999 * var_x202 - var_x197 * var_x411);
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00018851030986163651 * var_x203 - 0.43577707993988701 * var_x204);
        IJth(rJacobian, 34, 35) = 7.7982153480071377 * var_x386;
        IJth(rJacobian, 35, 35) = -var_x401;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (-23.773981447893455 * var_x204 - 0.00016457180559765593 * var_x137 - 0.010284250401616832 * var_x203 - var_x118 * (6.4983106368865622 * var_x205 - var_x28 * (1.053972635420138 * var_x29 * var_x9 + 1.6494869150645177 * var_x30 * var_x9) - 13.738155796237757 * var_x116 * var_x9) + 2.7964276527937963 * var_x205 * var_x94 - 1.0042770859719128 * var_x12 * var_x9 - 11.72506353372661 * var_x34 * var_x9 - 0.037504123542519557 * var_x13 * var_x9 - 0.053424677410996532 * var_x2 * var_x9 - 11.495160327182951 * var_x18 * var_x21 * var_x9);
        IJth(rJacobian, 0, 37) = mSetVoltageDerivativeToZero ? 0.0 : (var_x208 - var_x206 - var_x209 - var_x216 + 0.11 * var_x212 - 4.9499999999999988e-9 * var_x215 - var_x190 * var_x214 - 0.00060293750000000007 * var_x210 * var_x46 / pow(var_x4, 2));
        IJth(rJacobian, 13, 37) = 1.7 - 1.7 * var_chaste_interface__I_Ca__f_Ca_Bj;
        IJth(rJacobian, 15, 37) = -var_x363 + var_x352 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        IJth(rJacobian, 16, 37) = var_x363 + var_x352 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        IJth(rJacobian, 17, 37) = var_x365 * var_chaste_interface__SR_Fluxes__Ry_Ro + var_x362 * var_x366 * var_chaste_interface__Ca_Concentrations__Ca_j;
        IJth(rJacobian, 27, 37) = 55.473098330241186 - var_x375;
        IJth(rJacobian, 29, 37) = 19.897959183673468 - var_x379;
        IJth(rJacobian, 32, 37) = var_x383 + var_x385;
        IJth(rJacobian, 33, 37) = -var_x388 * (1.4849999999999997e-8 * var_x215 - 0.33000000000000002 * var_x212 + var_x214 * var_x395);
        IJth(rJacobian, 37, 37) = -75.37105751391465 + var_x375 + var_x379 - var_x405 - var_x406 - var_x408 - var_x402 * (var_x206 + var_x209 + var_x216 - var_x208 + 0.22 * var_x212 - 9.8999999999999977e-9 * var_x215 - var_x214 * var_x407);
        IJth(rJacobian, 38, 37) = 3.9220939916716238 * var_x232;
        IJth(rJacobian, 0, 38) = mSetVoltageDerivativeToZero ? 0.0 : (var_x219 - var_x217 - var_x220 - var_x224 + 0.89000000000000001 * var_x221 - 4.0049999999999991e-8 * var_x223 - var_x200 * var_x222 - 0.0048783125000000007 * var_x210 * var_x80 / pow(var_x6, 2));
        IJth(rJacobian, 1, 38) = var_x233;
        IJth(rJacobian, 14, 38) = 1.7 - 1.7 * var_chaste_interface__I_Ca__f_Ca_Bsl;
        IJth(rJacobian, 28, 38) = 121.55000000000001 - var_x378;
        IJth(rJacobian, 30, 38) = 43.550000000000004 - var_x380;
        IJth(rJacobian, 34, 38) = -var_x397 * (1.2014999999999997e-7 * var_x223 - 2.6699999999999999 * var_x221 + var_x222 * var_x400);
        IJth(rJacobian, 37, 38) = var_x408;
        IJth(rJacobian, 38, 38) = -165.10000000000002 + var_x378 + var_x380 - 19.504723378941105 * var_x232 - var_x409 * (var_x217 + var_x220 + var_x224 - var_x219 + 1.78 * var_x221 - 8.0099999999999983e-8 * var_x223 - var_x222 * var_x411);
    }
