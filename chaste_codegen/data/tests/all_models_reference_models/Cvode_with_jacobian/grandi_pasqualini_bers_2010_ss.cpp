...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x286 = var_chaste_interface__membrane_potential__V_m >= -40.0;
        const double var_x287 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 14) - 0.14705882352941177 * var_chaste_interface__membrane_potential__V_m);
        const double var_x288 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 14) - 0.0900900900900901 * var_chaste_interface__membrane_potential__V_m);
        const double var_x289 = 1.0 + var_x288;
        const double var_x290 = exp(0.34849999999999998 * var_chaste_interface__membrane_potential__V_m - 0.34849999999999998 * NV_Ith_S(mParameters, 14));
        const double var_x291 = exp(0.079000000000000001 * var_chaste_interface__membrane_potential__V_m - 0.079000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x292 = 0.01 * NV_Ith_S(mParameters, 13);
        const double var_x293 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * NV_Ith_S(mParameters, 14));
        const double var_x294 = 1.0 + var_x293;
        const double var_x295 = 1.0 - var_x292;
        const double var_x296 = var_x292 + var_x295 / pow(var_x294, 2);
        const double var_x297 = ((var_x286) ? (0) : (0.057000000000000002 * var_x287));
        const double var_x298 = ((var_x286) ? (5.9230769230769234 / var_x289) : (310000.0 * var_x290 + 2.7000000000000002 * var_x291));
        const double var_x299 = 0.26917900403768508 * var_x293 * var_x295 / pow(var_x294, 3);
        const double var_x300 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane_potential__V_m - 0.311 * NV_Ith_S(mParameters, 14));
        const double var_x301 = 1.0 + var_x300;
        const double var_x302 = 1 / var_x301;
        const double var_x303 = exp(0.24440000000000001 * var_chaste_interface__membrane_potential__V_m - 0.24440000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x304 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 14) - 0.043909999999999998 * var_chaste_interface__membrane_potential__V_m);
        const double var_x305 = -25428.0 * var_x303 - 6.9480000000000002e-6 * var_x304;
        const double var_x306 = var_x302 * var_x305;
        const double var_x307 = 37.780000000000001 + var_chaste_interface__membrane_potential__V_m;
        const double var_x308 = exp(-3.2000000000000002 - var_x68 + 0.10000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x309 = 1.0 + var_x308;
        const double var_x310 = exp(0.057000000000000002 * var_chaste_interface__membrane_potential__V_m - 0.057000000000000002 * NV_Ith_S(mParameters, 14));
        const double var_x311 = var_x310 / var_x309;
        const double var_x312 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 14) - 0.13780000000000001 * var_chaste_interface__membrane_potential__V_m);
        const double var_x313 = 1.0 + var_x312;
        const double var_x314 = exp(0.01052 * NV_Ith_S(mParameters, 14) - 0.01052 * var_chaste_interface__membrane_potential__V_m);
        const double var_x315 = var_x314 / var_x313;
        const double var_x316 = ((var_x286) ? (0) : (var_x306 * var_x307));
        const double var_x317 = ((var_x286) ? (0.59999999999999998 * var_x311) : (0.024240000000000001 * var_x315));
        const double var_x318 = 0.050000000000000003 * var_chaste_interface__membrane_potential__V_m;
        const double var_x319 = exp(2.0 + var_x318);
        const double var_x320 = 1.0 + var_x319;
        const double var_x321 = 1 / var_x320;
        const double var_x322 = 0.1111111111111111 * var_chaste_interface__membrane_potential__V_m;
        const double var_x323 = exp(1.2222222222222223 + var_x322);
        const double var_x324 = 1.0 + var_x323;
        const double var_x325 = 1 / var_x324;
        const double var_x326 = exp(-2.4444444444444446 - var_x322);
        const double var_x327 = 1.0 + var_x326;
        const double var_x328 = 1 / var_x327;
        const double var_x329 = var_x325 * var_x328;
        const double var_x330 = 0.20000000000000001 * var_chaste_interface__membrane_potential__V_m;
        const double var_x331 = exp(-2.0 - var_x330);
        const double var_x332 = 1.0 + var_x331;
        const double var_x333 = 1 / (230.0 * var_x321 + 3300.0 * var_x329);
        const double var_x334 = exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__membrane_potential__V_m);
        const double var_x335 = 1.0 + var_x334;
        const double var_x336 = exp(-0.17252124645892353 - 0.070821529745042494 * var_chaste_interface__membrane_potential__V_m);
        const double var_x337 = 0.00100999899000101 * var_x336;
        const double var_x338 = exp(0.20000000000000001 + 0.066666666666666666 * var_chaste_interface__membrane_potential__V_m);
        const double var_x339 = 1.0 + var_x338;
        const double var_x340 = 1 / var_x339;
        const double var_x341 = 1 / (0.5 + 9.0 * var_x340);
        const double var_x342 = exp(1.4615384615384615 - 0.076923076923076927 * var_chaste_interface__membrane_potential__V_m);
        const double var_x343 = 1.0 + var_x342;
        const double var_x344 = 0.076923076923076927 * var_x342 / pow(var_x343, 2);
        const double var_x345 = 1 / var_x343;
        const double var_x346 = exp(6.0 + 0.10000000000000001 * var_chaste_interface__membrane_potential__V_m);
        const double var_x347 = 1.0 + var_x346;
        const double var_x348 = 1 / var_x347;
        const double var_x349 = 1 / (30.0 + 800.0 * var_x348);
        const double var_x350 = exp(3.8999999999999999 + var_x330);
        const double var_x351 = 1.0 + var_x350;
        const double var_x352 = 0.20000000000000001 * var_x350 / pow(var_x351, 2);
        const double var_x353 = 1 / var_x351;
        const double var_x354 = exp(-0.81000000000000005 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane_potential__V_m), 2));
        const double var_x355 = 1 / (0.5 + 8.5 * var_x354);
        const double var_x356 = exp(-7.2727272727272725 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane_potential__V_m), 2));
        const double var_x357 = 1 / (7.0 + 85.0 * var_x356);
        const double var_x358 = exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane_potential__V_m);
        const double var_x359 = 1.0 - var_x358;
        const double var_x360 = 1 / var_x359;
        const double var_x361 = 1.0 + var_x358;
        const double var_x362 = 1 / var_x361;
        const double var_x363 = -var_chaste_interface__I_Ca__d + var_x362;
        const double var_x364 = var_x360 * var_x363;
        const double var_x365 = 0.035000000000000003 * var_x361;
        const double var_x366 = 5.0 + var_chaste_interface__membrane_potential__V_m;
        const double var_x367 = var_x360 * var_x366;
        const double var_x368 = 0.0058333333333333336 * var_x358;
        const double var_x369 = var_x366 * var_x368;
        const double var_x370 = 0.019699999999999999 * exp(-0.23877882250000002 * pow((1 + 0.068965517241379309 * var_chaste_interface__membrane_potential__V_m), 2));
        const double var_x371 = exp(2.5 - var_x318);
        const double var_x372 = 1.0 + var_x371;
        const double var_x373 = exp(3.8888888888888888 + var_x322);
        const double var_x374 = 1.0 + var_x373;
        const double var_x375 = 1 / var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x376 = pow(var_x375, 2.5);
        const double var_x377 = 1.0 + 0.13584112963311223 * var_x376;
        const double var_x378 = 1 / var_x377;
        const double var_x379 = 7.0 * var_x378;
        const double var_x380 = -7.5 + var_x379;
        const double var_x381 = var_x380 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x382 = 1 / (15.0 - 14.0 * var_x378);
        const double var_x383 = 10.0 * var_x382 * var_x56;
        const double var_x384 = -var_x383;
        const double var_x385 = var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x386 = var_x375 * var_x376 / pow(var_x377, 2);
        const double var_x387 = 2.3772197685794643 * var_x386;
        const double var_x388 = 0.21130842387373014 * var_x386 * var_x56 / pow((1 - 0.93333333333333335 * var_x378), 2);
        const double var_x389 = var_x388 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x390 = 20.0 * var_x382;
        const double var_x391 = var_x385 * var_x390;
        const double var_x392 = var_x387 * var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x393 = 7.5 - var_x379;
        const double var_x394 = 1.0 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x395 = 0.0001 * var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x396 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bj;
        const double var_x397 = 0.0001 * var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x398 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bsl;
        const double var_x399 = -var_x272;
        const double var_x400 = -var_x274;
        const double var_x401 = 100.0 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x402 = -var_x401;
        const double var_x403 = 100.0 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_j;
        const double var_x404 = 100.0 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x405 = -var_x404;
        const double var_x406 = 100.0 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_sl;
        const double var_x407 = 100.0 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_j;
        const double var_x408 = 100.0 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_sl;
        const double var_x409 = 100.0 * var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x410 = 100.0 * var_chaste_interface__SR_Ca_Concentrations__Csqn_b;
        const double var_x411 = 18.571428571428569 * NV_Ith_S(mParameters, 0);
        const double var_x412 = var_chaste_interface__SR_Fluxes__Ry_Ro * NV_Ith_S(mParameters, 1);
        const double var_x413 = var_x412;
        const double var_x414 = var_x259 * NV_Ith_S(mParameters, 3);
        const double var_x415 = var_x10 * NV_Ith_S(mParameters, 22);
        const double var_x416 = var_x414 * var_x415;
        const double var_x417 = 176588941779729.56 * var_x416;
        const double var_x418 = var_x17 * var_x416;
        const double var_x419 = 19424783595770.25 * var_x171;
        const double var_x420 = var_x180 * var_x416;
        const double var_x421 = var_x41 * NV_Ith_S(mParameters, 22);
        const double var_x422 = var_x414 * var_x421;
        const double var_x423 = var_x103 * var_x422;
        const double var_x424 = var_x105 * var_x423;
        const double var_x425 = 536388.91065592843 * var_x121;
        const double var_x426 = var_x119 * var_x425;
        const double var_x427 = var_x194 * var_x423;
        const double var_x428 = 3.2338732908121872 * var_x259;
        const double var_x429 = 7.3530178752050587e-13 * var_x210;
        const double var_x430 = var_x259 * var_x415;
        const double var_x431 = 4759071980963.7119 * var_x416;
        const double var_x432 = 4235574063057.7031 * var_x176;
        const double var_x433 = 1606.1867935752523 * var_x145;
        const double var_x434 = 5.9492599172113663e-12 * var_x222;
        const double var_x435 = 0.23994508763098885 * var_x414;
        const double var_x436 = 88294470889864.781 * var_x430;
        const double var_x437 = var_x259 * var_x421;
        const double var_x438 = 77240003134.453705 * var_x142 * var_x437;
        const double var_x439 = 1205.9369202226344 * NV_Ith_S(mParameters, 0);
        const double var_x440 = 64.935064935064929 * var_x412;
        const double var_x441 = 4.9020119168033731e-13 * var_x210;
        const double var_x442 = 145.53224458892851 * var_x259;
        const double var_x443 = 2379535990481.856 * var_x430;
        const double var_x444 = 231290898.27483633 * var_x437;
        const double var_x445 = var_x160 * var_x444;
        const double var_x446 = 3.9661732781409103e-12 * var_x222;
        ...
        IJth(rJacobian, 3, 0) = (var_x296 - var_chaste_interface__I_Na__h) * (((var_x286) ? (0) : (-0.008382352941176471 * var_x287)) + ((var_x286) ? (0.53361053361053368 * var_x288 / pow(var_x289, 2)) : (108035.0 * var_x290 + 0.21330000000000002 * var_x291))) - var_x299 * (var_x297 + var_x298);
        IJth(rJacobian, 4, 0) = (var_x296 - var_chaste_interface__I_Na__j) * (((var_x286) ? (0) : (var_x306 + var_x302 * var_x307 * (3.0508668000000001e-7 * var_x304 - 6214.6032000000005 * var_x303) - 0.311 * var_x300 * var_x305 * var_x307 / pow(var_x301, 2))) + ((var_x286) ? (0.034200000000000001 * var_x311 + 0.059999999999999998 * var_x308 * var_x310 / pow(var_x309, 2)) : (-0.00025500480000000003 * var_x315 + 0.0033402720000000005 * var_x312 * var_x314 / pow(var_x313, 2)))) - var_x299 * (var_x316 + var_x317);
        IJth(rJacobian, 5, 0) = 9.1827364554637282e-8 * (-var_chaste_interface__I_Kr__x_kr + 1 / var_x332) * (11.5 * var_x319 / pow(var_x320, 2) + 366.66666666666669 * var_x323 * var_x328 / pow(var_x324, 2) - 366.66666666666669 * var_x325 * var_x326 / pow(var_x327, 2)) / pow((var_x329 + 0.069696969696969702 * var_x321), 2) + 0.20000000000000001 * var_x331 * var_x333 / pow(var_x332, 2);
        IJth(rJacobian, 6, 0) = -7.1529673512819408e-5 * var_x336 * (-var_chaste_interface__I_Ks__x_ks + 1 / var_x335) + 0.070175438596491224 * var_x334 * (0.00100999899000101 + var_x337) / pow(var_x335, 2);
        IJth(rJacobian, 7, 0) = var_x341 * var_x344 + 0.0074074074074074077 * var_x338 * (var_x345 - var_chaste_interface__I_to__x_to_s) / (pow(var_x339, 2) * pow((0.055555555555555552 + var_x340), 2));
        IJth(rJacobian, 8, 0) = -var_x349 * var_x352 + 0.000125 * var_x346 * (var_x353 - var_chaste_interface__I_to__y_to_s) / (pow(var_x347, 2) * pow((0.037499999999999999 + var_x348), 2));
        IJth(rJacobian, 9, 0) = var_x344 * var_x355 - 0.11764705882352941 * var_x354 * (-0.035999999999999997 - 0.00080000000000000004 * var_chaste_interface__membrane_potential__V_m) * (var_x345 - var_chaste_interface__I_to__x_to_f) / pow((0.058823529411764705 + var_x354), 2);
        IJth(rJacobian, 10, 0) = -var_x352 * var_x357 - 0.011764705882352941 * var_x356 * (-0.36363636363636365 - 0.0090909090909090905 * var_chaste_interface__membrane_potential__V_m) * (var_x353 - var_chaste_interface__I_to__y_to_f) / pow((0.082352941176470587 + var_x356), 2);
        IJth(rJacobian, 11, 0) = var_x364 * var_x365 - var_x364 * var_x369 + var_x362 * var_x367 * var_x368 - var_x361 * var_x363 * var_x369 / pow(var_x359, 2);
        IJth(rJacobian, 12, 0) = (0.02 + var_x370) * (0.029999999999999999 * var_x371 / pow(var_x372, 2) - 0.1111111111111111 * var_x373 / pow(var_x374, 2)) + var_x370 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__membrane_potential__V_m) * (-var_chaste_interface__I_Ca__f + 1 / var_x374 + 0.59999999999999998 / var_x372);
        IJth(rJacobian, 33, 0) = -var_x417 * (6.567e-5 + var_x123 + var_x159 + var_x212 - var_x153 + 0.33000000000000002 * var_x66 + 0.33000000000000002 * var_x75 + 0.077088000000000004 * var_x137);
        IJth(rJacobian, 34, 0) = -var_x431 * (0.00053133 + var_x113 + var_x155 + var_x224 - var_x150 + 2.6699999999999999 * var_x89 + 2.6699999999999999 * var_x91 + 0.62371200000000004 * var_x140);
        IJth(rJacobian, 37, 0) = -var_x436 * (6.0643000000000002e-5 + var_x144 + var_x168 - var_x165 - 0.22 * var_x66 - 0.051392 * var_x137);
        IJth(rJacobian, 38, 0) = -var_x443 * (0.00049065700000000003 + var_x133 + var_x166 - var_x164 - 1.78 * var_x89 - 0.41580800000000001 * var_x140);
        ...
        IJth(rJacobian, 33, 2) = -58274350787310.75 * var_x174 * var_x416;
        IJth(rJacobian, 34, 2) = -12706722189173.109 * var_x177 * var_x416;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x178 - var_x17 * var_x179);
        IJth(rJacobian, 3, 3) = -var_x297 - var_x298;
        IJth(rJacobian, 33, 3) = -var_x418 * var_x419;
        IJth(rJacobian, 34, 3) = -var_x418 * var_x432;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x178 * var_x180 - var_x179 * var_x180);
        IJth(rJacobian, 4, 4) = -var_x316 - var_x317;
        IJth(rJacobian, 33, 4) = -var_x419 * var_x420;
        IJth(rJacobian, 34, 4) = -var_x420 * var_x432;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x23 * var_x96 * NV_Ith_S(mParameters, 17));
        IJth(rJacobian, 5, 5) = -var_x333;
        ...
        IJth(rJacobian, 11, 11) = -var_x365 * var_x367;
        IJth(rJacobian, 33, 11) = -var_x424 * var_x426;
        IJth(rJacobian, 34, 11) = -var_x424 * var_x433;
        IJth(rJacobian, 37, 11) = -var_x193 * var_x438;
        IJth(rJacobian, 38, 11) = -var_x188 * var_x445;
        ...
        IJth(rJacobian, 12, 12) = -0.02 - var_x370;
        IJth(rJacobian, 33, 12) = -var_x426 * var_x427;
        IJth(rJacobian, 34, 12) = -var_x427 * var_x433;
        IJth(rJacobian, 37, 12) = -var_x198 * var_x438;
        IJth(rJacobian, 38, 12) = -var_x197 * var_x445;
        ...
        IJth(rJacobian, 33, 13) = var_x107 * var_x422 * var_x425;
        IJth(rJacobian, 37, 13) = var_x127 * var_x438;
        ...
        IJth(rJacobian, 34, 14) = 1606.1867935752523 * var_x108 * var_x422;
        IJth(rJacobian, 38, 14) = var_x127 * var_x131 * var_x444;
        IJth(rJacobian, 15, 15) = -0.0050000000000000001 + var_x381 + var_x384;
        IJth(rJacobian, 16, 15) = var_x383;
        IJth(rJacobian, 17, 15) = var_x384;
        IJth(rJacobian, 15, 16) = 0.055;
        IJth(rJacobian, 16, 16) = -0.059999999999999998 + var_x381;
        IJth(rJacobian, 17, 16) = var_x384 + var_x393 * var_chaste_interface__Ca_Concentrations__Ca_j;
        ...
        IJth(rJacobian, 17, 17) = -0.065000000000000002 + var_x384;
        IJth(rJacobian, 18, 18) = -0.001 - var_x395;
        IJth(rJacobian, 33, 18) = (0.001 + var_x395) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 19, 19) = -0.001 - var_x397;
        IJth(rJacobian, 34, 19) = (0.001 + var_x397) * NV_Ith_S(mParameters, 3);
        ...
        IJth(rJacobian, 24, 24) = -0.00046000000000000001 + var_x400;
        ...
        IJth(rJacobian, 27, 27) = -1.3 + var_x402;
        IJth(rJacobian, 37, 27) = 1.3 + var_x401;
        IJth(rJacobian, 28, 28) = -1.3 + var_x405;
        IJth(rJacobian, 38, 28) = 1.3 + var_x404;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x402;
        IJth(rJacobian, 37, 29) = 0.029999999999999999 + var_x401;
        IJth(rJacobian, 30, 30) = -0.029999999999999999 + var_x405;
        IJth(rJacobian, 38, 30) = 0.029999999999999999 + var_x404;
        IJth(rJacobian, 31, 31) = -65.0 - var_x409;
        IJth(rJacobian, 32, 31) = 65.0 + var_x409;
        IJth(rJacobian, 1, 32) = 0.037279237232671424 * var_x277 + 4.7061860318210743e-15 * var_x278;
        IJth(rJacobian, 15, 32) = -var_x389 + var_x385 * var_x387;
        IJth(rJacobian, 16, 32) = var_x389 + var_x392;
        IJth(rJacobian, 17, 32) = -var_x392 + var_x388 * var_x394;
        IJth(rJacobian, 31, 32) = 260.0 - var_x410;
        IJth(rJacobian, 32, 32) = -260.0 + var_x410 - var_x411 - var_x413 - 0.69232869146389786 * var_x277 - 8.7400597733819945e-14 * var_x278;
        IJth(rJacobian, 37, 32) = var_x439 + var_x440;
        ...
        IJth(rJacobian, 18, 33) = 0.0007561 - var_x396;
        IJth(rJacobian, 33, 33) = (-0.0007561 + var_x396 - var_x428 - 176588941779729.56 * var_x430 * (var_x202 + var_x213 + var_x216 + 9.0157776108189337e-5 * var_x204 + 0.98999999999999999 * var_x215 + var_x208 * var_x429)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 34, 33) = 0.087152885187388451 * var_x414;
        IJth(rJacobian, 37, 33) = -var_x436 * (-0.66000000000000003 * var_x215 - var_x208 * var_x441);
        ...
        IJth(rJacobian, 19, 34) = 0.000165 - var_x398;
        IJth(rJacobian, 33, 34) = var_x428 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 34, 34) = (-0.000165 + var_x398 - 7.8853682331945256 * var_x259 - 4759071980963.7119 * var_x430 * (var_x218 + var_x225 + var_x227 + 8.0099999999999998 * var_x226 + 0.00072945837032989554 * var_x219 + var_x221 * var_x434)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 35, 34) = var_x435;
        IJth(rJacobian, 38, 34) = -var_x443 * (-5.3399999999999999 * var_x226 - var_x221 * var_x446);
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (-6.4154999999999998e-5 * var_x228 * var_x7);
        IJth(rJacobian, 34, 35) = 7.7982153480071377 * var_x414;
        IJth(rJacobian, 35, 35) = -var_x435;
        ...
        IJth(rJacobian, 15, 37) = -var_x391 + var_x380 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        IJth(rJacobian, 16, 37) = var_x391 + var_x380 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        IJth(rJacobian, 17, 37) = var_x393 * var_chaste_interface__SR_Fluxes__Ry_Ro + var_x390 * var_x394 * var_chaste_interface__Ca_Concentrations__Ca_j;
        IJth(rJacobian, 27, 37) = 55.473098330241186 - var_x403;
        IJth(rJacobian, 29, 37) = 19.897959183673468 - var_x407;
        IJth(rJacobian, 32, 37) = var_x411 + var_x413;
        IJth(rJacobian, 33, 37) = -var_x417 * (1.4849999999999997e-8 * var_x241 - 0.33000000000000002 * var_x238 + var_x240 * var_x429);
        IJth(rJacobian, 37, 37) = -75.37105751391465 + var_x403 + var_x407 - var_x439 - var_x440 - var_x442 - var_x436 * (var_x235 + var_x236 + var_x242 - var_x233 + 0.22 * var_x238 - 9.8999999999999977e-9 * var_x241 - var_x240 * var_x441);
        ...
        IJth(rJacobian, 28, 38) = 121.55000000000001 - var_x406;
        IJth(rJacobian, 30, 38) = 43.550000000000004 - var_x408;
        IJth(rJacobian, 34, 38) = -var_x431 * (1.2014999999999997e-7 * var_x250 - 2.6699999999999999 * var_x248 + var_x249 * var_x434);
        IJth(rJacobian, 37, 38) = var_x442;
        IJth(rJacobian, 38, 38) = -165.10000000000002 + var_x406 + var_x408 - 19.504723378941105 * var_x259 - var_x443 * (var_x246 + var_x247 + var_x251 - var_x245 + 1.78 * var_x248 - 8.0099999999999983e-8 * var_x250 - var_x249 * var_x446);
    }
