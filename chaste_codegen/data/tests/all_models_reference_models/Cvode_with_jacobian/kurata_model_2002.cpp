...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellkurata_model_2002FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x110 = (0.72286170354868073 * var_x109 - 027046577588354045 * var_chaste_interface__membrane__V) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy;
        const double var_x111 = (1.0842925553230209 * var_x109 - 040569866382531065 * var_chaste_interface__membrane__V) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy;
        ...
        const double var_x121 = 0.56099999999999994 - 014999999999999999 * var_chaste_interface__membrane__V;
        ...
        const double var_x183 = 00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        ...
        const double var_x196 = exp(-2.1886792452830188 - 094339622641509441 * var_chaste_interface__membrane__V);
        ...
        const double var_x203 = 094339622641509441 * var_x196 / pow(var_x197, 2);
        ...
        const double var_x208 = exp(1.672514619883041 + 058479532163742687 * var_chaste_interface__membrane__V);
        ...
        const double var_x223 = 0015555555555555557 * var_x216 / pow(var_x217, 2);
        ...
        const double var_x231 = exp(1.2866666666666666 - 066666666666666666 * var_chaste_interface__membrane__V);
        ...
        const double var_x237 = exp(4.7407407407407405 + 07407407407407407 * var_chaste_interface__membrane__V);
        ...
        const double var_x261 = var_x257 + 1.0 * var_x253 + 00022900000000000001 * var_x260;
        const double var_x262 = 1 / var_x261;
        const double var_x263 = var_x258 / pow(var_x259, 2);
        const double var_x264 = (9.5 * var_x252 + 071428571428571425 * var_x249) / pow((var_x252 + 0.52631578947368418 * var_x249), 2);
        const double var_x265 = (-10 * var_x254 - 238.46153846153845 * var_x255) / pow((var_x255 + 0.22580645161290322 * var_x254), 2);
        ...
        const double var_x278 = 00014764809009680174 * NV_Ith_S(mParameters, 0);
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0 : (-0054000000000000003 + var_x4 - 0.375 * var_x0 - 014999999999999999 * var_x79 - 0.17999999999999999 * var_x80 - 025899999999999999 * var_x1 - 0.57999999999999996 * var_x83 - 02 * var_chaste_interface__AP_sensitive_currents_r_gate__r - 0.45800000000000002 * var_x81 - 0.10017396017979863 * var_x99 - 00044373633078820127 * var_x2 - var_x66 * var_x78 - var_x89 * var_x91);
        IJth(rJacobian, 1, 0) = (-var_chaste_interface__L_type_calcium_channel_current_d_gate__d + 1.0 / var_x161) * (var_x165 - var_x168 - var_x171 - 0045719999999999997 * var_x163 * var_x172 / pow(var_x164, 2) - 017658069883527455 * var_x169 * var_chaste_interface__membrane__V / pow(var_x170, 2) - 011356 * var_x166 * var_x173 / pow(var_x167, 2)) + 0.16666666666666666 * var_x160 * (var_x174 - var_x175 - var_x176) / pow(var_x161, 2);
        IJth(rJacobian, 2, 0) = -0.20000000000000001 * var_x178 * var_x181 / pow(var_x179, 2) - 0038895371450797353 * var_x180 * (-0.33642151027379535 - 010351431085347548 * var_chaste_interface__membrane__V) * (-var_chaste_interface__L_type_calcium_channel_current_f_gate__f + 1.0 / var_x179) / pow((0.17230649552703226 + var_x180), 2);
        IJth(rJacobian, 4, 0) = (-var_chaste_interface__T_type_calcium_channel_current_d_gate__d + 1.0 / var_x185) * (0356 * var_x186 - 0356 * var_x187) + 0.16666666666666666 * var_x184 * (var_x188 + var_x189) / pow(var_x185, 2);
        IJth(rJacobian, 5, 0) = (-var_chaste_interface__T_type_calcium_channel_current_f_gate__f + 1.0 / var_x191) * (00097529258777633281 * var_x192 - 00018367346938775509 * var_x193) - 0.17857142857142858 * var_x190 * (var_x194 + var_x195) / pow(var_x191, 2);
        IJth(rJacobian, 6, 0) = var_x203 * (var_x201 + var_x202) + (var_x198 - var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS) * (00029184075413518645 * var_x199 - 8.2031958007575546e-6 * var_x200);
        IJth(rJacobian, 7, 0) = var_x203 * (var_x206 + var_x207) + (var_x198 - var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF) * (0027637030984589985 * var_x204 - 5.0400434999854427e-5 * var_x205);
        IJth(rJacobian, 8, 0) = (-var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy + 1.0 / var_x209) * (0061795265502981441 * var_x210 - 0018299935950224174 * var_x211) - 058479532163742687 * var_x208 * (var_x212 + var_x213) / pow(var_x209, 2);
        IJth(rJacobian, 9, 0) = var_x220 * (var_x221 * var_x223 + 71.428571428571431 * var_x218 * (var_x222 - var_x223) / pow((var_x218 + 071428571428571425 * var_x214), 2)) + (var_x223 - var_x222) * (-var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n + var_x219 * var_x221);
        IJth(rJacobian, 10, 0) = -076923076923076927 * var_x225 * var_x230 / pow(var_x226, 2) - 078713879440468384 * (-var_chaste_interface__AP_sensitive_currents_q_gate__q + 1.0 / var_x226) * (045599999999999995 * var_x228 - 0065000000000000006 * var_x227) / (pow((0.15497928494706154 + var_x229), 2) * pow((var_x228 + 0.11403508771929825 * var_x227), 2));
        IJth(rJacobian, 11, 0) = 066666666666666666 * var_x231 * var_x236 / pow(var_x232, 2) - 064554184748538135 * (-var_chaste_interface__AP_sensitive_currents_r_gate__r + 1.0 / var_x232) * (04428 * var_x234 - 093329999999999996 * var_x233) / (pow((0.19114817190506736 + var_x235), 2) * pow((var_x233 + 0.35583413693346194 * var_x234), 2));
        IJth(rJacobian, 12, 0) = (-var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + 1.0 / var_x238) * (0725586626489447 * var_x239 - 030801634395873377 * var_x240) - 07407407407407407 * var_x237 * (var_x241 + var_x242) / pow(var_x238, 2);
        IJth(rJacobian, 13, 0) = (-var_chaste_interface__sustained_inward_current_qa_gate__qa + 1.0 / var_x245) * (00390625 * (-2.0 * var_x247 - 0.29999999999999999 * var_x246) / pow((var_x247 + 0.9375 * var_x246), 2) + 24.999999999999996 * (013636363636363636 * var_x248 + 00028571428571428574 * var_x249) / pow((var_x249 + 0.74999999999999989 * var_x248), 2)) + 0.20000000000000001 * var_x244 * (var_x250 + var_x251) / pow(var_x245, 2);
        IJth(rJacobian, 14, 0) = (-var_chaste_interface__sustained_inward_current_qi_gate__qi + var_x257 * var_x262) * (6.8872180451127816e-6 * var_x263 + 1.6662153999958345e-5 * var_x264 + 1.5647860546266811e-8 * var_x265) + (var_x262 * var_x266 + var_x257 * (-var_x266 - 4.5800000000000002e-5 * var_x263 - 00011080332409972299 * var_x264) / pow(var_x261, 2)) * (var_x267 + var_x268 + var_x269);
        ...
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (var_x102);
        IJth(rJacobian, 1, 1) = var_x175 + var_x176 - var_x174;
        IJth(rJacobian, 18, 1) = var_x102 * var_x278;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (var_x103);
        IJth(rJacobian, 2, 2) = -var_x181;
        IJth(rJacobian, 18, 2) = var_x103 * var_x278;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (var_x104);
        IJth(rJacobian, 3, 3) = -021000000000000001 - var_x182;
        IJth(rJacobian, 18, 3) = var_x104 * var_x278;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (var_x106);
        IJth(rJacobian, 4, 4) = -var_x188 - var_x189;
        IJth(rJacobian, 18, 4) = var_x106 * var_x278;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (var_x107);
        IJth(rJacobian, 5, 5) = -var_x194 - var_x195;
        IJth(rJacobian, 18, 5) = var_x107 * var_x278;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (var_x110);
        IJth(rJacobian, 6, 6) = -var_x201 - var_x202;
        IJth(rJacobian, 20, 6) = var_x110 * var_x282;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (var_x111);
        IJth(rJacobian, 7, 7) = -var_x206 - var_x207;
        IJth(rJacobian, 20, 7) = var_x111 * var_x282;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (var_x113);
        IJth(rJacobian, 8, 8) = -var_x212 - var_x213;
        IJth(rJacobian, 20, 8) = var_x113 * var_x282;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0 : (-051799999999999999 * var_x115);
        IJth(rJacobian, 9, 9) = -var_x215 - var_x219;
        IJth(rJacobian, 20, 9) = -3.3168891609907947e-7 * var_x115 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0 : (var_x117);
        IJth(rJacobian, 10, 10) = -var_x230;
        IJth(rJacobian, 20, 10) = var_x117 * var_x282;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0 : (var_x118 + 0.53453099652795766 * var_x109 - 02 * var_chaste_interface__membrane__V);
        ...
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0 : (-0.28747499999999998 * var_x119 - 0.46252500000000002 * var_x120);
        ...
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0 : (var_x122);
        IJth(rJacobian, 13, 13) = -var_x250 - var_x251;
        IJth(rJacobian, 19, 13) = var_x122 * var_x282;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0 : (var_x123);
        ...
        IJth(rJacobian, 16, 16) = -0017241196262903437;
        IJth(rJacobian, 17, 16) = 016666666666666666;
        IJth(rJacobian, 16, 17) = 0017241196262903437;
        ...
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0 : (-var_x132 * var_x78 - var_x136 * var_x91);
        IJth(rJacobian, 3, 18) = 021000000000000001 / var_x183 - 60 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa - 00035 * (021000000000000001 + var_x182) / pow(var_x183, 2);
        ...
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0 : (-1.8440677943018704 * var_x152 - 0.14432336906254858 * var_x92 - 0.12643083428112081 * var_x153 - 2.6773043380529855 * var_x154 - 3.8416074556718653 * var_x150 - var_x149 * var_x78 - var_x151 * var_x91);
        ...
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0 : (-0021962113249247841 + 26.726549826397882 * var_x157 - 15.367231619182254 * var_x152 - 6.1808487292273409 * var_x155 - 0.53453099652795766 * var_x156 - 4.8107789687516185 * var_x158);
        IJth(rJacobian, 20, 20) = (-1.406291416773793e-8 + 0001711370722584161 * var_x157 - 3.4227414451683221e-6 * var_x156 - 9.8400393807144087e-5 * var_x152 - 3.0804673006514896e-5 * var_x158 - 3.9577587173161957e-5 * var_x155) * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 15, 21) = var_x271;
        IJth(rJacobian, 21, 21) = -6.4435000000000002;
        IJth(rJacobian, 25, 21) = var_x283;
        IJth(rJacobian, 15, 22) = 024390000000000002 + 10.246499999999999 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        IJth(rJacobian, 22, 22) = -0.54200000000000004 + var_x283;
        IJth(rJacobian, 18, 23) = 024390000000000002 + 10.246499999999999 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        ...
        IJth(rJacobian, 15, 24) = 013826 + 2.7527999999999997 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        IJth(rJacobian, 24, 24) = -0.44600000000000001 - 88.799999999999997 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        IJth(rJacobian, 15, 25) = 00046562000000000003 + var_x271;
        IJth(rJacobian, 21, 25) = -5.6925000000000008;
        IJth(rJacobian, 25, 25) = -0075100000000000002 + var_x283;
