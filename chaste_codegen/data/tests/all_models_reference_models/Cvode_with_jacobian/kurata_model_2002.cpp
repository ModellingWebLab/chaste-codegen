...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellkurata_model_2002FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-0.14432336906254858 * var_x92 - 0.12643083428112081 * var_x153 - 2.6773043380529855 * var_x154 - 1.8440677943018704 * var_x152 - 3.8416074556718653 * var_x150 - var_x149 * var_x78 - var_x151 * var_x91);
        ...
        IJth(rJacobian, 20, 19) = (3.4286956523403795e-5 * var_x154 + 1.6191392426334868e-6 * var_x153 - 1.1808047256857291e-5 * var_x152) * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0021962113249247841 + 26.726549826397882 * var_x157 - 6.1808487292273409 * var_x155 - 15.367231619182254 * var_x152 - 0.53453099652795766 * var_x156 - 4.8107789687516185 * var_x158);
        IJth(rJacobian, 20, 20) = (-1.406291416773793e-8 + 0.0001711370722584161 * var_x157 - 3.4227414451683221e-6 * var_x156 - 3.0804673006514896e-5 * var_x158 - 3.9577587173161957e-5 * var_x155 - 9.8400393807144087e-5 * var_x152) * NV_Ith_S(mParameters, 0);
