...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_model_2004_apexFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x14 = var_x13 * pow(var_chaste_interface__sodium_concentration__Nai, 3.0);
        ...
        const double var_x36 = pow(var_chaste_interface__calcium_concentration__Cai, 2.0);
        const double var_x37 = 0.25 + var_x36;
        const double var_x38 = pow(var_chaste_interface__calcium_concentration__Cai, 3.0) / pow(var_x37, 2);
        const double var_x39 = var_x10 * var_x12;
        const double var_x40 = 1 / var_x37;
        const double var_x41 = var_x40 * pow(var_chaste_interface__calcium_concentration__Cai, 1.0);
        ...
        const double var_x44 = var_x12 * var_x13 * pow(var_chaste_interface__sodium_concentration__Nai, 2.0);
        ...
        const double var_x56 = var_x17 * pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 2.0) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x57 = var_x17 * pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 1.0);
        ...
        const double var_x62 = pow(var_x61, (-2.0));
        const double var_x63 = pow((1.0 + 11.899999999999999 * var_x62), (-1.0));
        ...
        const double var_x69 = pow(var_x68, (-2.0));
        const double var_x70 = pow((1.0 + 11.899999999999999 * var_x69), (-1.0));
        ...
        const double var_x82 = pow(var_x81, (-2.0));
        const double var_x83 = pow((1.0 + 18.75 * var_x82), (-1.0));
        ...
        const double var_x87 = -1 + 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x88 = exp(-0.038580246913580245 * pow(var_x87, 2.0));
        ...
        const double var_x96 = 1 + 0.068965517241379309 * var_chaste_interface__membrane__V;
        const double var_x97 = exp(-2.1025 * pow(var_x96, 2.0));
        const double var_x98 = var_x97 * pow(var_x96, 1.0);
        const double var_x99 = 0.0037699999999999999 * var_x98;
        const double var_x100 = var_x99 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x101 = 1 + 0.050000000000000003 * var_chaste_interface__membrane__V;
        const double var_x102 = exp(-1.0 * pow(var_x101, 2.0));
        const double var_x103 = 1 + 0.025000000000000001 * var_chaste_interface__membrane__V;
        const double var_x104 = exp(-160.0 * pow(var_x103, 2.0));
        const double var_x105 = exp(1.2 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x106 = 1.0 + 0.12 * var_x105;
        const double var_x107 = var_x105 / var_x106;
        const double var_x108 = var_x107 * (0.074999999999999997 * var_x102 * pow(var_x101, 1.0) - 5.5999999999999996 * var_x104 * pow(var_x103, 1.0));
        const double var_x109 = var_x108 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x110 = 0.40000000000000002 * var_x109;
        const double var_x111 = 1.0 + 0.69999999999999996 * var_x104 - 0.75 * var_x102;
        const double var_x112 = var_x107 * var_x111;
        const double var_x113 = 4.0000000000000003e-5 * var_x112;
        const double var_x114 = var_x113 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x115 = var_x112 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x116 = 0.040000000000000001 * var_x115;
        const double var_x117 = 0.00040000000000000002 * var_x108;
        const double var_x118 = var_x117 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x119 = var_x111 * pow(var_x105, 2) / pow(var_x106, 2);
        const double var_x120 = 4.7999999999999998e-6 * var_x119;
        const double var_x121 = var_x120 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x122 = var_x119 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x123 = 0.0048000000000000004 * var_x122;
        const double var_x124 = 1 / (20.0 + var_chaste_interface__calcium_concentration__Cass);
        const double var_x125 = 0.23324 * var_x124;
        const double var_x126 = var_x125 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x127 = var_chaste_interface__calcium_concentration__Cass / pow((1 + 0.050000000000000003 * var_chaste_interface__calcium_concentration__Cass), 2);
        const double var_x128 = 0.00058310000000000002 * var_x127;
        const double var_x129 = var_x128 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x130 = 0.013000000000000001 * var_x97;
        const double var_x131 = 0.20000000000000001 * var_x94;
        const double var_x132 = var_x125 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x133 = -var_x132;
        const double var_x134 = 0.40000000000000002 * var_x112;
        const double var_x135 = 0.00040000000000000002 * var_x112;
        const double var_x136 = 0.0076923076923076927 * var_x94 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x137 = 1.0 - var_chaste_interface__L_type_calcium_current__C3 - var_chaste_interface__L_type_calcium_current__C4 - var_chaste_interface__L_type_calcium_current__I1 - var_chaste_interface__L_type_calcium_current__I2 - var_chaste_interface__L_type_calcium_current__I3 - var_chaste_interface__L_type_calcium_current__O - 2 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x138 = 0.0144 * var_x119 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x139 = 1.2000000000000002 * var_x108 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x140 = 0.12000000000000001 * var_x112 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x141 = -1.6000000000000001 * var_x112;
        const double var_x142 = 0.10000000000000001 * var_x94;
        const double var_x143 = 0.011538461538461539 * var_x94 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x144 = 0.0096000000000000009 * var_x119 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x145 = 0.80000000000000004 * var_x108 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x146 = 0.080000000000000002 * var_x112 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x147 = 0.80000000000000004 * var_x112;
        const double var_x148 = 0.15000000000000002 * var_x94;
        const double var_x149 = 7.6923076923076936e-6 * var_x94 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x150 = 3.0769230769230774e-5 * var_x94 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x151 = var_x94 * var_chaste_interface__L_type_calcium_current__I1;
        const double var_x152 = var_x98 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x153 = 0.0075399999999999998 * var_x152;
        const double var_x154 = var_x124 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x155 = 0.87931480000000006 * var_x152 * var_x154;
        const double var_x156 = 1.1195520000000001e-5 * var_x122 * var_x154;
        const double var_x157 = 0.00093296000000000004 * var_x154;
        const double var_x158 = var_x109 * var_x157;
        const double var_x159 = 9.3296000000000009e-5 * var_x115 * var_x154;
        const double var_x160 = 13.0 - 13.0 * var_x97;
        const double var_x161 = var_x160 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x162 = var_x125 * var_x161;
        const double var_x163 = var_x128 * var_x161;
        const double var_x164 = 0.00093296000000000004 * var_x115 * var_x124;
        const double var_x165 = 2.3324000000000003e-6 * var_x115 * var_x127;
        const double var_x166 = 0.026000000000000002 * var_x97;
        const double var_x167 = var_x132 * var_x160;
        const double var_x168 = var_x112 * var_x157;
        const double var_x169 = 0.00040000000000000002 * var_x94;
        const double var_x170 = 0.0001 * var_x94;
        const double var_x171 = var_x99 * var_chaste_interface__L_type_calcium_current__I1;
        const double var_x172 = var_x94 * (-0.026000000000000002 + 0.026000000000000002 * var_x97);
        const double var_x173 = var_x113 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x174 = var_x117 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x175 = var_x120 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x176 = var_x125 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x177 = var_x128 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x178 = 0.013000000000000001 - var_x130;
        const double var_x179 = -var_x135;
        const double var_x180 = -0.04926108374384236 * var_chaste_interface__membrane__V;
        const double var_x181 = exp(0.36945812807881773 + var_x180);
        const double var_x182 = 0.01083743842364532 * var_x181 * var_chaste_interface__fast_sodium_current__O_Na;
        const double var_x183 = exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__membrane__V);
        const double var_x184 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__membrane__V);
        const double var_x185 = (0.0085583333333333327 * var_x183 + 0.0016666666666666668 * var_x184) / pow((var_x184 + 0.4108 * var_x183), 2);
        const double var_x186 = 60.832000000000001 * var_x185 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x187 = exp(-0.42168674698795178 - 0.060240963855421679 * var_chaste_interface__membrane__V);
        const double var_x188 = var_x187 / pow((1 + 0.47846713846216332 * var_x187), 2);
        const double var_x189 = 0.073163809141391992 * var_x188 * var_chaste_interface__fast_sodium_current__O_Na;
        const double var_x190 = 2.0000000000000002e-5 * var_chaste_interface__membrane__V;
        const double var_x191 = 0.008539999999999999 + var_x190;
        const double var_x192 = 1 / var_x191;
        const double var_x193 = 1 / (0.39395599999999997 + 0.188495 * var_x187);
        const double var_x194 = 1 / (0.25 * var_x184 + 0.1027 * var_x183);
        const double var_x195 = -0.12987012987012986 * var_chaste_interface__membrane__V;
        const double var_x196 = exp(-0.90909090909090906 + var_x195);
        const double var_x197 = 1 / var_x181;
        const double var_x198 = var_x193 * var_x194 * var_x196 * var_x197;
        const double var_x199 = var_x192 * var_x198;
        const double var_x200 = 9.7514961527500711e-7 * var_x199 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x201 = 3.317429681310359e-6 * var_x198 * var_chaste_interface__fast_sodium_current__IF_Na / pow((1 + 0.0023419203747072604 * var_chaste_interface__membrane__V), 2);
        const double var_x202 = var_x188 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x203 = var_x192 * var_x196 * var_x197;
        const double var_x204 = 8.8508255294954831e-7 * var_x194 * var_x202 * var_x203;
        const double var_x205 = 0.00019355636363636362 * var_x185 * var_x193 * var_x203 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x206 = 1.0 * var_x193;
        const double var_x207 = 0.22 * var_x181;
        const double var_x208 = 3.802 * var_x194;
        const double var_x209 = 1.2097272727272726e-5 * var_x199;
        const double var_x210 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x211 = -var_x210;
        const double var_x212 = exp(0.12315270935960591 + var_x180);
        const double var_x213 = 0.009852216748768473 * var_x212;
        const double var_x214 = var_x213 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x215 = 9.0909090909090901e-8 * var_x196;
        const double var_x216 = var_x215 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x217 = exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x218 = 71.871455576559541 * (0.0068466666666666667 * var_x217 + 0.0015333333333333334 * var_x184) / pow((var_x184 + 0.44652173913043475 * var_x217), 2);
        const double var_x219 = var_x218 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x220 = 0.20000000000000001 * var_x212;
        const double var_x221 = -var_x220;
        const double var_x222 = -0.008539999999999999 - var_x190;
        const double var_x223 = 3.802 / (0.1027 * var_x217 + 0.23000000000000001 * var_x184);
        const double var_x224 = 6.9999999999999997e-7 * var_x196;
        const double var_x225 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x226 = -var_x225;
        const double var_x227 = exp(-0.12315270935960591 + var_x180);
        const double var_x228 = 0.0094433497536945809 * var_x227;
        const double var_x229 = var_x215 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x230 = exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x231 = 95.049999999999997 * (0.0013333333333333335 * var_x184 + 0.0060411764705882356 * var_x230) / pow((var_x184 + 0.51349999999999996 * var_x230), 2);
        const double var_x232 = 3.802 / (0.20000000000000001 * var_x184 + 0.1027 * var_x230);
        const double var_x233 = -var_x232;
        const double var_x234 = 0.19170000000000001 * var_x227;
        const double var_x235 = -var_x223 - var_x234;
        const double var_x236 = var_x222 + var_x233;
        const double var_x237 = var_x215 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x238 = 1.818181818181818e-9 * var_x196 * var_chaste_interface__fast_sodium_current__I2_Na;
        const double var_x239 = 7.3163809141391995e-5 * var_x202;
        const double var_x240 = 7.7014535938307356e-7 * var_x188 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x241 = -var_x224;
        const double var_x242 = 1.0526315789473684e-5 * var_x193;
        const double var_x243 = 1.4e-8 * var_x196;
        const double var_x244 = 0.001 * var_x193;
        const double var_x245 = var_x213 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x246 = var_x218 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x247 = var_x228 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x248 = var_x231 * var_chaste_interface__fast_sodium_current__IC_Na3;
        const double var_x249 = 0.025019562392723654 * var_x8;
        const double var_x250 = 0.25271120029236765 * var_x2 - 0.0098429554532475649 * var_chaste_interface__membrane__V;
        const double var_x251 = 0.078972250091364882 * var_x2 - 0.003075923579139864 * var_chaste_interface__membrane__V;
        const double var_x252 = exp(1.0731000000000002 + 0.035770000000000003 * var_chaste_interface__membrane__V);
        const double var_x253 = exp(-1.8711 - 0.062370000000000002 * var_chaste_interface__membrane__V);
        const double var_x254 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x255 = exp(4.7857142857142856 + var_x254);
        const double var_x256 = 1.0 + 0.051334999999999999 * var_x255;
        const double var_x257 = var_x255 / var_x256;
        const double var_x258 = 1.0 - var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x259 = -var_x254;
        const double var_x260 = exp(-4.7857142857142856 + var_x259);
        const double var_x261 = 1.0 + 0.0067083000000000004 * var_x260;
        const double var_x262 = exp(-1.9285714285714286 + var_x259);
        const double var_x263 = var_x262 / var_x261;
        const double var_x264 = exp(-2.9220779220779218 + var_x195);
        const double var_x265 = 1.0 + var_x264;
        const double var_x266 = 1.0 / var_x265;
        const double var_x267 = exp(-0.062899999999999998 * var_chaste_interface__membrane__V);
        const double var_x268 = 0.0073216139155926159 * var_x267 / pow((1 + 0.23955296404275997 * var_x267), 2);
        const double var_x269 = 1 / (2.0579999999999998 + 0.49299999999999999 * var_x267);
        const double var_x270 = 0.12987012987012986 * var_x264 / pow(var_x265, 2);
        const double var_x271 = var_x269 * var_x270;
        const double var_x272 = -var_x269;
        const double var_x273 = exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V);
        const double var_x274 = 1.0 + var_x273;
        const double var_x275 = 1 / var_x274;
        const double var_x276 = 1 / (270.0 + 1050.0 * var_x275);
        const double var_x277 = var_x273 / pow(var_x274, 2);
        const double var_x278 = 0.17543859649122806 * var_x277;
        const double var_x279 = 1.0 * var_x275;
        const double var_x280 = 1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        const double var_x281 = exp(-3.3919999999999999 - 0.128 * var_chaste_interface__membrane__V);
        const double var_x282 = 1.0 - var_x281;
        const double var_x283 = 4.8133299999999997e-6 / var_x282;
        const double var_x284 = exp(-1.0069999999999999 - 0.037999999999999999 * var_chaste_interface__membrane__V);
        const double var_x285 = 26.5 + var_chaste_interface__membrane__V;
        const double var_x286 = 1 / (1200.0 - 170.0 * var_x275);
        const double var_x287 = exp(-0.086199999999999999 * var_chaste_interface__membrane__V);
        const double var_x288 = 1 / (13.17 + 39.299999999999997 * var_x287);
        const double var_x289 = exp(0.038198000000000003 * var_chaste_interface__membrane__V);
        const double var_x290 = 0.00052457313400000008 * var_x289 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2;
        const double var_x291 = exp(-0.041779999999999998 * var_chaste_interface__membrane__V);
        const double var_x292 = 2.8786419999999997e-6 * var_x291 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x293 = exp(0.11695499999999999 + 0.023390999999999999 * var_chaste_interface__membrane__V);
        const double var_x294 = 0.0021243940109999999 * var_x293 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x295 = exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x296 = 0.00021232196 * var_x295 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K;
        const double var_x297 = 6.8899999999999994e-5 * var_x291;
        const double var_x298 = 0.090820999999999999 * var_x293;
        const double var_x299 = 0.013733 * var_x289;
        const double var_x300 = 0.0064970000000000002 * var_x295;
        const double var_x301 = exp(0.01176 * var_chaste_interface__membrane__V);
        const double var_x302 = exp(-0.063100000000000003 * var_chaste_interface__membrane__V);
        const double var_x303 = -0.022348 * var_x301;
        ...
        IJth(rJacobian, 5, 0) = -0.00247 * var_x88 * var_chaste_interface__L_type_calcium_current__O - 0.015432098765432098 * var_x89 * pow(var_x87, 1.0) * var_chaste_interface__L_type_calcium_current__O;
        IJth(rJacobian, 11, 0) = var_x110 + var_x114 + var_x116 + var_x118 + var_x95 - var_x100 - var_x121 - var_x123;
        IJth(rJacobian, 12, 0) = var_x138 - var_x136 - var_x139 - var_x140 + 1.6000000000000001 * var_x108 * var_x137 + 0.16 * var_x112 * var_x137 + 0.0038461538461538464 * var_x94 * var_chaste_interface__L_type_calcium_current__C2 - 0.019200000000000002 * var_x119 * var_x137;
        IJth(rJacobian, 13, 0) = var_x136 + var_x139 + var_x140 + var_x144 - var_x138 - var_x143 - var_x145 - var_x146;
        IJth(rJacobian, 14, 0) = var_x123 + var_x143 + var_x145 + var_x146 + var_x156 - var_x110 - var_x116 - var_x144 - var_x149 - var_x150 - var_x153 - var_x155 - var_x158 - var_x159 - var_x95 - 7.6923076923076936e-8 * var_x151;
        IJth(rJacobian, 15, 0) = var_x158 + var_x159 + var_x173 + var_x174 - var_x156 - var_x171 - var_x175 - 0.0075400000000000007 * var_x151 * var_x98 - 0.076923076923076927 * var_x172 * var_chaste_interface__L_type_calcium_current__I1;
        IJth(rJacobian, 16, 0) = var_x100 + var_x121 + var_x150 + var_x153 - var_x114 - var_x118;
        IJth(rJacobian, 17, 0) = var_x149 + var_x155 + var_x171 + var_x175 - var_x173 - var_x174;
        ...
        IJth(rJacobian, 19, 0) = var_x182 + var_x186 + var_x204 + var_x205 - var_x189 - var_x200 - var_x201;
        IJth(rJacobian, 20, 0) = var_x211 + var_x214 + var_x219 - var_x182 - var_x186 - var_x216;
        IJth(rJacobian, 21, 0) = var_x226 - var_x214 - var_x219 - var_x229 + var_x228 * var_chaste_interface__fast_sodium_current__C_Na2 + var_x231 * (1.0 - var_chaste_interface__fast_sodium_current__C_Na1 - var_chaste_interface__fast_sodium_current__C_Na2 - var_chaste_interface__fast_sodium_current__I1_Na - var_chaste_interface__fast_sodium_current__I2_Na - var_chaste_interface__fast_sodium_current__IC_Na2 - var_chaste_interface__fast_sodium_current__IC_Na3 - var_chaste_interface__fast_sodium_current__IF_Na - var_chaste_interface__fast_sodium_current__O_Na);
        IJth(rJacobian, 22, 0) = var_x237 + var_x239 - var_x238 - var_x240;
        IJth(rJacobian, 23, 0) = var_x238 + var_x240;
        IJth(rJacobian, 24, 0) = var_x189 + var_x200 + var_x201 + var_x210 + var_x216 + var_x245 + var_x246 - var_x204 - var_x205 - var_x237 - var_x239;
        IJth(rJacobian, 25, 0) = var_x225 + var_x229 + var_x247 + var_x248 - var_x245 - var_x246;
        IJth(rJacobian, 26, 0) = 2.0000000000000002e-5 + var_x211 + var_x226 - var_x247 - var_x248 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I1_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I2_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na2 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na3 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IF_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__O_Na + var_x215 * var_chaste_interface__fast_sodium_current__IC_Na3;
        IJth(rJacobian, 27, 0) = 0.084735007814913818 * var_x33 + 0.0015588209597120041 * var_x18 - 0.0047984407834581883 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K - 0.017397555353928618 * var_x5 - 0.00035373121160108434 * var_x0 - 0.0098429554532475649 * var_x7 - 0.003075923579139864 * var_x6 - var_x249 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        IJth(rJacobian, 28, 0) = 0.035770000000000003 * var_x252 * (0.18064 - 0.18064 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f) + 0.024673572000000001 * var_x253 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f;
        IJth(rJacobian, 29, 0) = -0.00013571428571428572 * var_x257 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 2.1714285714285715e-5 * var_x258 * var_x263 + 6.9668928571428572e-6 * pow(var_x255, 2) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f / pow(var_x256, 2) + 1.4566594285714287e-7 * var_x258 * var_x260 * var_x262 / pow(var_x261, 2);
        IJth(rJacobian, 30, 0) = var_x271 + var_x268 * (var_x266 - var_chaste_interface__slow_transient_outward_potassium_current__ato_s);
        IJth(rJacobian, 31, 0) = -var_x276 * var_x278 + 0.00016708437761069341 * var_x277 * (var_x279 - var_chaste_interface__slow_transient_outward_potassium_current__ito_s) / pow((0.25714285714285712 + var_x275), 2);
        IJth(rJacobian, 32, 0) = var_x280 * var_x283 + 3.6226653999999999e-6 * var_x284 * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs - 6.1610624e-7 * var_x280 * var_x281 * var_x285 / pow(var_x282, 2);
        IJth(rJacobian, 33, 0) = var_x271 + var_x268 * (var_x266 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur);
        IJth(rJacobian, 34, 0) = -var_x278 * var_x286 - 2.0711500974658867e-5 * var_x277 * (var_x279 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur) / pow((1 - 0.14166666666666666 * var_x275), 2);
        IJth(rJacobian, 35, 0) = var_x270 * var_x288 + 0.0021933842239185751 * var_x287 * (var_x266 - var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss) / pow((0.33511450381679392 + var_x287), 2);
        IJth(rJacobian, 37, 0) = var_x290 + var_x292 - var_x294 - var_x296;
        IJth(rJacobian, 38, 0) = 0.01176 * var_x301 * (0.022348 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K) + 0.0029658262000000005 * var_x302 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1;
        IJth(rJacobian, 39, 0) = -var_x290 - var_x292;
        IJth(rJacobian, 40, 0) = var_x294 + var_x296;
        ...
        IJth(rJacobian, 2, 2) = var_x70 * (-2175.0841750841751 + (-var_x72 - var_x73) * var_chaste_interface__calcium_fluxes__P_RyR) + 0.16806722689075632 * pow(var_x68, (-3.0)) * pow((0.084033613445378158 + var_x69), (-2.0)) * (363.63636363636363 * var_x75 + 2175.0841750841751 * var_chaste_interface__calcium_concentration__Cai - 2175.0841750841751 * var_chaste_interface__calcium_concentration__Cass - var_x71 * (-63.0 + var_chaste_interface__membrane__V));
        ...
        IJth(rJacobian, 11, 2) = var_x129 - var_x126;
        IJth(rJacobian, 14, 2) = var_x163 + var_x165 - var_x162 - var_x164;
        IJth(rJacobian, 15, 2) = var_x126 + var_x164 - var_x129 - var_x165;
        IJth(rJacobian, 16, 2) = var_x177 - var_x176;
        IJth(rJacobian, 17, 2) = var_x162 + var_x176 - var_x163 - var_x177;
        IJth(rJacobian, 2, 3) = var_x76 * (var_x72 + var_x73);
        IJth(rJacobian, 3, 3) = var_x83 * (-0.050000000000000003 + (-var_x79 - var_x80) * var_chaste_interface__calcium_fluxes__P_RyR) + 0.00013333333333333334 * pow(var_x81, (-3.0)) * pow((0.053333333333333337 + var_x82), (-2.0)) * (0.050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 4.5 * var_x75 - 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR);
        ...
        IJth(rJacobian, 11, 11) = -0.013000000000000001 + var_x130 + var_x133 - var_x131;
        IJth(rJacobian, 12, 11) = var_x141;
        IJth(rJacobian, 14, 11) = var_x131;
        IJth(rJacobian, 15, 11) = var_x132;
        IJth(rJacobian, 16, 11) = var_x178;
        IJth(rJacobian, 12, 12) = -0.050000000000000003 * var_x94 - 4.4000000000000004 * var_x112;
        IJth(rJacobian, 13, 12) = 1.2000000000000002 * var_x112;
        IJth(rJacobian, 12, 13) = var_x141 + var_x142;
        IJth(rJacobian, 13, 13) = -var_x142 - var_x147;
        IJth(rJacobian, 14, 13) = var_x147;
        IJth(rJacobian, 11, 14) = var_x134;
        IJth(rJacobian, 12, 14) = var_x141;
        IJth(rJacobian, 13, 14) = var_x148;
        IJth(rJacobian, 14, 14) = -0.026000000000000002 + var_x166 - var_x134 - var_x148 - var_x167 - var_x168;
        IJth(rJacobian, 15, 14) = var_x168;
        IJth(rJacobian, 16, 14) = 0.026000000000000002 - var_x166;
        IJth(rJacobian, 17, 14) = var_x167;
        IJth(rJacobian, 11, 15) = 0.00050000000000000001;
        IJth(rJacobian, 12, 15) = var_x141;
        IJth(rJacobian, 14, 15) = 1.0000000000000002e-6 * var_x94;
        IJth(rJacobian, 15, 15) = -0.0135 + var_x130 + var_x172;
        IJth(rJacobian, 17, 15) = var_x178;
        IJth(rJacobian, 11, 16) = var_x135;
        IJth(rJacobian, 12, 16) = var_x141;
        IJth(rJacobian, 14, 16) = var_x169;
        IJth(rJacobian, 16, 16) = var_x133 + var_x179 - var_x169;
        IJth(rJacobian, 17, 16) = var_x132;
        IJth(rJacobian, 12, 17) = var_x141;
        IJth(rJacobian, 14, 17) = var_x170;
        IJth(rJacobian, 15, 17) = var_x135;
        IJth(rJacobian, 16, 17) = 0.00050000000000000001;
        IJth(rJacobian, 17, 17) = -0.00050000000000000001 + var_x179 - var_x170;
        ...
        IJth(rJacobian, 19, 19) = -var_x206 - var_x207;
        IJth(rJacobian, 20, 19) = var_x207;
        IJth(rJacobian, 21, 19) = var_x233;
        IJth(rJacobian, 24, 19) = var_x206;
        IJth(rJacobian, 26, 19) = var_x222;
        IJth(rJacobian, 19, 20) = var_x208;
        IJth(rJacobian, 20, 20) = var_x221 + var_x222 - var_x208;
        IJth(rJacobian, 21, 20) = var_x220 + var_x233;
        IJth(rJacobian, 24, 20) = var_x191;
        IJth(rJacobian, 26, 20) = var_x222;
        IJth(rJacobian, 20, 21) = var_x223;
        IJth(rJacobian, 21, 21) = var_x235 + var_x236;
        IJth(rJacobian, 25, 21) = var_x191;
        IJth(rJacobian, 26, 21) = var_x222;
        IJth(rJacobian, 21, 22) = var_x233;
        IJth(rJacobian, 22, 22) = var_x241 - var_x242;
        IJth(rJacobian, 23, 22) = var_x242;
        IJth(rJacobian, 24, 22) = var_x224;
        IJth(rJacobian, 26, 22) = var_x222;
        IJth(rJacobian, 21, 23) = var_x233;
        IJth(rJacobian, 22, 23) = var_x243;
        IJth(rJacobian, 23, 23) = -var_x243;
        IJth(rJacobian, 26, 23) = var_x222;
        IJth(rJacobian, 19, 24) = var_x209;
        IJth(rJacobian, 20, 24) = var_x224;
        IJth(rJacobian, 21, 24) = var_x233;
        IJth(rJacobian, 22, 24) = var_x244;
        IJth(rJacobian, 24, 24) = var_x221 + var_x241 - var_x209 - var_x244;
        IJth(rJacobian, 25, 24) = var_x220;
        IJth(rJacobian, 26, 24) = var_x222;
        IJth(rJacobian, 21, 25) = var_x224 + var_x233;
        IJth(rJacobian, 24, 25) = var_x223;
        IJth(rJacobian, 25, 25) = var_x235 + var_x241;
        IJth(rJacobian, 26, 25) = var_x222 + var_x234;
        IJth(rJacobian, 21, 26) = var_x233;
        IJth(rJacobian, 25, 26) = var_x232;
        IJth(rJacobian, 26, 26) = var_x236 + var_x241;
        ...
        IJth(rJacobian, 28, 28) = -0.18064 * var_x252 - 0.39560000000000001 * var_x253;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x9);
        IJth(rJacobian, 27, 29) = -var_x17 * var_x249;
        IJth(rJacobian, 29, 29) = -0.00015200000000000001 * var_x263 - 0.00095 * var_x257;
        IJth(rJacobian, 30, 30) = var_x272;
        IJth(rJacobian, 31, 31) = -var_x276;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0115 * var_x57);
        IJth(rJacobian, 27, 32) = -0.00070746242320216869 * var_x57;
        IJth(rJacobian, 32, 32) = -9.5333299999999997e-5 * var_x284 - var_x283 * var_x285;
        ...
        IJth(rJacobian, 27, 33) = var_x250 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur;
        IJth(rJacobian, 33, 33) = var_x272;
        ...
        IJth(rJacobian, 27, 34) = var_x250 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur;
        IJth(rJacobian, 34, 34) = -var_x286;
        ...
        IJth(rJacobian, 27, 35) = var_x251 * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss;
        IJth(rJacobian, 35, 35) = -var_x288;
        ...
        IJth(rJacobian, 27, 36) = var_x251 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss;
        ...
        IJth(rJacobian, 37, 37) = -var_x297 - var_x298;
        IJth(rJacobian, 38, 37) = var_x303;
        IJth(rJacobian, 39, 37) = var_x297;
        IJth(rJacobian, 40, 37) = var_x298;
        IJth(rJacobian, 38, 38) = -0.023761000000000001 + var_x303 - 0.047002000000000002 * var_x302;
        IJth(rJacobian, 39, 38) = 0.023761000000000001;
        IJth(rJacobian, 37, 39) = var_x299;
        IJth(rJacobian, 38, 39) = 0.036777999999999998 + var_x303;
        IJth(rJacobian, 39, 39) = -0.036777999999999998 - var_x299;
        IJth(rJacobian, 37, 40) = var_x300;
        IJth(rJacobian, 38, 40) = var_x303;
        IJth(rJacobian, 40, 40) = -var_x300;
    }
