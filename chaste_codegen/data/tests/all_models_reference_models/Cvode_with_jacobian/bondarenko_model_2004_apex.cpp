...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_model_2004_apexFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x42 = (7.1123755334281649e-6 * var_chaste_interface__sodium_concentration__Nai + 7.9026394815868502e-7 * var_chaste_interface__potassium_concentration__Ki) / pow((0.11111111111111112 * var_chaste_interface__potassium_concentration__Ki + var_chaste_interface__sodium_concentration__Nai), 2);
        const double var_x43 = var_x42 * var_chaste_interface__fast_sodium_current__O_Na;
        const double var_x44 = var_x12 * var_x13 * pow(var_chaste_interface__sodium_concentration__Nai, 2);
        const double var_x45 = (2.4715768660405338e-6 * var_chaste_interface__sodium_concentration__Nai + 0.00012110726643598615 * var_chaste_interface__potassium_concentration__Ki) * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K / pow((0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai + var_chaste_interface__potassium_concentration__Ki), 2);
        const double var_x46 = var_x27 * var_x28 / (var_x32 * pow((3.2860264730588296e-7 + var_x28), 2));
        const double var_x47 = log(126540.0 / (0.10000000000000001 * var_chaste_interface__potassium_concentration__Ki + 0.90000000000000002 * var_chaste_interface__sodium_concentration__Nai));
        const double var_x48 = var_x0 * var_x1;
        const double var_x49 = var_x1 * var_x5;
        const double var_x50 = var_x1 * var_x7;
        const double var_x51 = var_x1 * var_x6;
        const double var_x52 = var_x1 * var_x8 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x53 = var_x1 * var_x18;
        const double var_x54 = var_x17 * pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 2) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x55 = var_x17 * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        const double var_x56 = 4.1078913989637309 * var_x2 - 0.16 * var_chaste_interface__membrane__V;
        const double var_x57 = 1.2837160621761659 * var_x2 - 0.050000000000000003 * var_chaste_interface__membrane__V;
        const double var_x58 = log(8092.0 / (0.97999999999999998 * var_chaste_interface__potassium_concentration__Ki + 0.02 * var_chaste_interface__sodium_concentration__Nai));
        ...
        const double var_x61 = 1 / (1.0 + 11.899999999999999 * var_x60);
        ...
        const double var_x68 = 1 / (1.0 + 11.899999999999999 * var_x67);
        const double var_x69 = 92.541511836848613 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x70 = 363.63636363636363 * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x71 = 363.63636363636363 * var_chaste_interface__ryanodine_receptors__P_O2;
        const double var_x72 = var_chaste_interface__ryanodine_receptors__P_O1 + var_chaste_interface__ryanodine_receptors__P_O2;
        const double var_x73 = var_x72 * (-var_chaste_interface__calcium_concentration__Cass + var_chaste_interface__calcium_concentration__CaJSR) * var_chaste_interface__calcium_fluxes__P_RyR;
        const double var_x74 = var_x68 * var_chaste_interface__calcium_fluxes__P_RyR;
        const double var_x75 = 363.63636363636363 * var_chaste_interface__calcium_concentration__CaJSR - 363.63636363636363 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x76 = var_x74 * var_x75;
        const double var_x77 = 4.5 * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x78 = 4.5 * var_chaste_interface__ryanodine_receptors__P_O2;
        const double var_x79 = 1 + 0.00125 * var_chaste_interface__calcium_concentration__CaJSR;
        const double var_x80 = pow(var_x79, (-2));
        const double var_x81 = 1 / (1.0 + 18.75 * var_x80);
        const double var_x82 = var_x81 * var_chaste_interface__calcium_fluxes__P_RyR;
        const double var_x83 = 4.5 * var_chaste_interface__calcium_concentration__Cass - 4.5 * var_chaste_interface__calcium_concentration__CaJSR;
        const double var_x84 = var_x82 * var_x83;
        const double var_x85 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x86 = exp(-0.038580246913580245 * pow((-1 + var_x85), 2));
        const double var_x87 = var_x86 * (0.15561 - 0.00247 * var_chaste_interface__membrane__V);
        const double var_x88 = pow(var_chaste_interface__calcium_concentration__Cass, 3.0);
        const double var_x89 = 0.012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2.0) * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x90 = 0.0040499999999999998 * var_x88;
        const double var_x91 = -0.0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4.0);
        const double var_x92 = exp(-0.92307692307692313 - 0.076923076923076927 * var_chaste_interface__membrane__V);
        const double var_x93 = 0.015384615384615385 * var_x92 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x94 = -0.28999999999999998 - 0.02 * var_chaste_interface__membrane__V;
        const double var_x95 = exp(-2.1025 * pow((1 + 0.068965517241379309 * var_chaste_interface__membrane__V), 2));
        const double var_x96 = 0.013000000000000001 * var_x95;
        const double var_x97 = var_x94 * var_x96;
        const double var_x98 = var_x97 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x99 = 0.69999999999999996 * exp(-160.0 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_x100 = 0.75 * exp(-1.0 * pow((1 + 0.050000000000000003 * var_chaste_interface__membrane__V), 2));
        const double var_x101 = exp(1.2 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x102 = 1.0 + 0.12 * var_x101;
        const double var_x103 = var_x101 / var_x102;
        const double var_x104 = var_x103 * (var_x99 * (-8.0 - var_x85) - var_x100 * (-0.10000000000000001 - 0.0050000000000000001 * var_chaste_interface__membrane__V));
        const double var_x105 = var_x104 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x106 = 0.40000000000000002 * var_x105;
        const double var_x107 = 1.0 + var_x99 - var_x100;
        const double var_x108 = var_x103 * var_x107;
        const double var_x109 = 4.0000000000000003e-5 * var_x108;
        const double var_x110 = var_x109 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x111 = var_x108 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x112 = 0.040000000000000001 * var_x111;
        const double var_x113 = 0.00040000000000000002 * var_x104;
        const double var_x114 = var_x113 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x115 = var_x107 * pow(var_x101, 2) / pow(var_x102, 2);
        const double var_x116 = 4.7999999999999998e-6 * var_x115;
        const double var_x117 = var_x116 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x118 = var_x115 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x119 = 0.0048000000000000004 * var_x118;
        const double var_x120 = 1 / (20.0 + var_chaste_interface__calcium_concentration__Cass);
        const double var_x121 = 0.23324 * var_x120;
        const double var_x122 = var_x121 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x123 = var_chaste_interface__calcium_concentration__Cass / pow((1 + 0.050000000000000003 * var_chaste_interface__calcium_concentration__Cass), 2);
        const double var_x124 = 0.00058310000000000002 * var_x123;
        const double var_x125 = var_x124 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x126 = 0.20000000000000001 * var_x92;
        const double var_x127 = var_x121 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x128 = -var_x127;
        const double var_x129 = 0.40000000000000002 * var_x108;
        const double var_x130 = 0.00040000000000000002 * var_x108;
        const double var_x131 = 0.0076923076923076927 * var_x92 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x132 = 1.0 - var_chaste_interface__L_type_calcium_current__C3 - var_chaste_interface__L_type_calcium_current__C4 - var_chaste_interface__L_type_calcium_current__I1 - var_chaste_interface__L_type_calcium_current__I2 - var_chaste_interface__L_type_calcium_current__I3 - var_chaste_interface__L_type_calcium_current__O - 2 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x133 = 0.0144 * var_x115 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x134 = 1.2000000000000002 * var_x104 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x135 = 0.12000000000000001 * var_x108 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x136 = -1.6000000000000001 * var_x108;
        const double var_x137 = 0.10000000000000001 * var_x92;
        const double var_x138 = 0.011538461538461539 * var_x92 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x139 = 0.0096000000000000009 * var_x115 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x140 = 0.80000000000000004 * var_x104 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x141 = 0.080000000000000002 * var_x108 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x142 = 0.80000000000000004 * var_x108;
        const double var_x143 = 0.15000000000000002 * var_x92;
        const double var_x144 = 7.6923076923076936e-6 * var_x92 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x145 = 3.0769230769230774e-5 * var_x92 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x146 = var_x92 * var_chaste_interface__L_type_calcium_current__I1;
        const double var_x147 = 0.026000000000000002 * var_x95;
        const double var_x148 = var_x94 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x149 = var_x147 * var_x148;
        const double var_x150 = var_x120 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x151 = 3.0321199999999999 * var_x148 * var_x150 * var_x95;
        const double var_x152 = 1.1195520000000001e-5 * var_x118 * var_x150;
        const double var_x153 = 0.00093296000000000004 * var_x150;
        const double var_x154 = var_x105 * var_x153;
        const double var_x155 = 9.3296000000000009e-5 * var_x111 * var_x150;
        const double var_x156 = 13.0 - 13.0 * var_x95;
        const double var_x157 = var_x156 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x158 = var_x121 * var_x157;
        const double var_x159 = var_x124 * var_x157;
        const double var_x160 = 0.00093296000000000004 * var_x111 * var_x120;
        const double var_x161 = 2.3324000000000003e-6 * var_x111 * var_x123;
        const double var_x162 = var_x127 * var_x156;
        const double var_x163 = var_x108 * var_x153;
        const double var_x164 = 0.00040000000000000002 * var_x92;
        const double var_x165 = 0.0001 * var_x92;
        const double var_x166 = var_x97 * var_chaste_interface__L_type_calcium_current__I1;
        const double var_x167 = 0.026000000000000002 * var_x95;
        const double var_x168 = var_x92 * (-0.026000000000000002 + var_x167);
        const double var_x169 = var_x109 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x170 = var_x113 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x171 = var_x116 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x172 = var_x121 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x173 = var_x124 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x174 = 0.013000000000000001 - var_x96;
        const double var_x175 = -var_x130;
        const double var_x176 = -0.04926108374384236 * var_chaste_interface__membrane__V;
        const double var_x177 = exp(0.36945812807881773 + var_x176);
        const double var_x178 = 0.01083743842364532 * var_x177 * var_chaste_interface__fast_sodium_current__O_Na;
        const double var_x179 = exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__membrane__V);
        const double var_x180 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__membrane__V);
        const double var_x181 = (0.0085583333333333327 * var_x179 + 0.0016666666666666668 * var_x180) / pow((var_x180 + 0.4108 * var_x179), 2);
        const double var_x182 = 60.832000000000001 * var_x181 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x183 = exp(-0.42168674698795178 - 0.060240963855421679 * var_chaste_interface__membrane__V);
        const double var_x184 = var_x183 / pow((1 + 0.47846713846216332 * var_x183), 2);
        const double var_x185 = 0.073163809141391992 * var_x184 * var_chaste_interface__fast_sodium_current__O_Na;
        const double var_x186 = 2.0000000000000002e-5 * var_chaste_interface__membrane__V;
        const double var_x187 = 0.008539999999999999 + var_x186;
        const double var_x188 = 1 / var_x187;
        const double var_x189 = 1 / (0.39395599999999997 + 0.188495 * var_x183);
        const double var_x190 = 1 / (0.25 * var_x180 + 0.1027 * var_x179);
        const double var_x191 = -0.12987012987012986 * var_chaste_interface__membrane__V;
        const double var_x192 = exp(-0.90909090909090906 + var_x191);
        const double var_x193 = 1 / var_x177;
        const double var_x194 = var_x189 * var_x190 * var_x192 * var_x193;
        const double var_x195 = var_x188 * var_x194;
        const double var_x196 = 9.7514961527500711e-7 * var_x195 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x197 = 3.317429681310359e-6 * var_x194 * var_chaste_interface__fast_sodium_current__IF_Na / pow((1 + 0.0023419203747072604 * var_chaste_interface__membrane__V), 2);
        const double var_x198 = var_x184 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x199 = var_x188 * var_x192 * var_x193;
        const double var_x200 = 8.8508255294954831e-7 * var_x190 * var_x198 * var_x199;
        const double var_x201 = 0.00019355636363636362 * var_x181 * var_x189 * var_x199 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x202 = var_x189;
        const double var_x203 = 0.22 * var_x177;
        const double var_x204 = 3.802 * var_x190;
        const double var_x205 = 1.2097272727272726e-5 * var_x195;
        const double var_x206 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x207 = -var_x206;
        const double var_x208 = exp(0.12315270935960591 + var_x176);
        const double var_x209 = 0.009852216748768473 * var_x208;
        const double var_x210 = var_x209 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x211 = 9.0909090909090901e-8 * var_x192;
        const double var_x212 = var_x211 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x213 = exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x214 = 71.871455576559541 * (0.0068466666666666667 * var_x213 + 0.0015333333333333334 * var_x180) / pow((var_x180 + 0.44652173913043475 * var_x213), 2);
        const double var_x215 = var_x214 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x216 = 0.20000000000000001 * var_x208;
        const double var_x217 = -var_x216;
        const double var_x218 = -0.008539999999999999 - var_x186;
        const double var_x219 = 3.802 / (0.1027 * var_x213 + 0.23000000000000001 * var_x180);
        const double var_x220 = 6.9999999999999997e-7 * var_x192;
        const double var_x221 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x222 = -var_x221;
        const double var_x223 = exp(-0.12315270935960591 + var_x176);
        const double var_x224 = 0.0094433497536945809 * var_x223;
        const double var_x225 = var_x211 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x226 = exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x227 = 95.049999999999997 * (0.0013333333333333335 * var_x180 + 0.0060411764705882356 * var_x226) / pow((var_x180 + 0.51349999999999996 * var_x226), 2);
        const double var_x228 = 3.802 / (0.20000000000000001 * var_x180 + 0.1027 * var_x226);
        const double var_x229 = -var_x228;
        const double var_x230 = 0.19170000000000001 * var_x223;
        const double var_x231 = -var_x219 - var_x230;
        const double var_x232 = var_x218 + var_x229;
        const double var_x233 = var_x211 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x234 = 1.818181818181818e-9 * var_x192 * var_chaste_interface__fast_sodium_current__I2_Na;
        const double var_x235 = 7.3163809141391995e-5 * var_x198;
        const double var_x236 = 7.7014535938307356e-7 * var_x184 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x237 = -var_x220;
        const double var_x238 = 1.0526315789473684e-5 * var_x189;
        const double var_x239 = 1.4e-8 * var_x192;
        const double var_x240 = 0.001 * var_x189;
        const double var_x241 = var_x209 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x242 = var_x214 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x243 = var_x224 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x244 = var_x227 * var_chaste_interface__fast_sodium_current__IC_Na3;
        const double var_x245 = 0.025019562392723654 * var_x8;
        const double var_x246 = 0.25271120029236765 * var_x2 - 0.0098429554532475649 * var_chaste_interface__membrane__V;
        const double var_x247 = 0.078972250091364882 * var_x2 - 0.003075923579139864 * var_chaste_interface__membrane__V;
        const double var_x248 = exp(1.0731000000000002 + 0.035770000000000003 * var_chaste_interface__membrane__V);
        const double var_x249 = exp(-1.8711 - 0.062370000000000002 * var_chaste_interface__membrane__V);
        const double var_x250 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x251 = exp(4.7857142857142856 + var_x250);
        const double var_x252 = 1.0 + 0.051334999999999999 * var_x251;
        const double var_x253 = var_x251 / var_x252;
        const double var_x254 = 1.0 - var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x255 = -var_x250;
        const double var_x256 = exp(-4.7857142857142856 + var_x255);
        const double var_x257 = 1.0 + 0.0067083000000000004 * var_x256;
        const double var_x258 = exp(-1.9285714285714286 + var_x255);
        const double var_x259 = var_x258 / var_x257;
        const double var_x260 = exp(-2.9220779220779218 + var_x191);
        ...
        const double var_x264 = 0.0073216139155926159 * var_x263 / pow((1 + 0.23955296404275997 * var_x263), 2);
        const double var_x265 = 1 / (2.0579999999999998 + 0.49299999999999999 * var_x263);
        const double var_x266 = 0.12987012987012986 * var_x260 / pow(var_x261, 2);
        const double var_x267 = var_x265 * var_x266;
        const double var_x268 = -var_x265;
        const double var_x269 = exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V);
        const double var_x270 = 1.0 + var_x269;
        const double var_x271 = 1 / var_x270;
        const double var_x272 = 1 / (270.0 + 1050.0 * var_x271);
        const double var_x273 = var_x269 / pow(var_x270, 2);
        const double var_x274 = 0.17543859649122806 * var_x273;
        const double var_x275 = var_x271;
        ...
        const double var_x282 = 1 / (1200.0 - 170.0 * var_x271);
        ...
        IJth(rJacobian, 1, 0) = var_x61 * (-1.12886395354433e-5 + 1.6591891954566281e-18 * var_x16 + 4.2005900246296372e-21 * var_x26);
        IJth(rJacobian, 2, 0) = -var_x68 * var_x69;
        IJth(rJacobian, 5, 0) = -0.00247 * var_x86 * var_chaste_interface__L_type_calcium_current__O + var_x87 * (0.015432098765432098 - 0.0030864197530864196 * var_chaste_interface__membrane__V) * var_chaste_interface__L_type_calcium_current__O;
        IJth(rJacobian, 11, 0) = var_x106 + var_x110 + var_x112 + var_x114 + var_x93 + var_x98 - var_x117 - var_x119;
        IJth(rJacobian, 12, 0) = var_x133 - var_x131 - var_x134 - var_x135 + 1.6000000000000001 * var_x104 * var_x132 + 0.16 * var_x108 * var_x132 + 0.0038461538461538464 * var_x92 * var_chaste_interface__L_type_calcium_current__C2 - 0.019200000000000002 * var_x115 * var_x132;
        IJth(rJacobian, 13, 0) = var_x131 + var_x134 + var_x135 + var_x139 - var_x133 - var_x138 - var_x140 - var_x141;
        IJth(rJacobian, 14, 0) = var_x119 + var_x138 + var_x140 + var_x141 + var_x149 + var_x151 + var_x152 - var_x106 - var_x112 - var_x139 - var_x144 - var_x145 - var_x154 - var_x155 - var_x93 - 7.6923076923076936e-8 * var_x146;
        IJth(rJacobian, 15, 0) = var_x154 + var_x155 + var_x166 + var_x169 + var_x170 - var_x152 - var_x171 - 0.076923076923076927 * var_x168 * var_chaste_interface__L_type_calcium_current__I1 + var_x146 * var_x167 * var_x94;
        IJth(rJacobian, 16, 0) = var_x117 + var_x145 - var_x110 - var_x114 - var_x149 - var_x98;
        IJth(rJacobian, 17, 0) = var_x144 + var_x171 - var_x151 - var_x166 - var_x169 - var_x170;
        ...
        IJth(rJacobian, 19, 0) = var_x178 + var_x182 + var_x200 + var_x201 - var_x185 - var_x196 - var_x197;
        IJth(rJacobian, 20, 0) = var_x207 + var_x210 + var_x215 - var_x178 - var_x182 - var_x212;
        IJth(rJacobian, 21, 0) = var_x222 - var_x210 - var_x215 - var_x225 + var_x224 * var_chaste_interface__fast_sodium_current__C_Na2 + var_x227 * (1.0 - var_chaste_interface__fast_sodium_current__C_Na1 - var_chaste_interface__fast_sodium_current__C_Na2 - var_chaste_interface__fast_sodium_current__I1_Na - var_chaste_interface__fast_sodium_current__I2_Na - var_chaste_interface__fast_sodium_current__IC_Na2 - var_chaste_interface__fast_sodium_current__IC_Na3 - var_chaste_interface__fast_sodium_current__IF_Na - var_chaste_interface__fast_sodium_current__O_Na);
        IJth(rJacobian, 22, 0) = var_x233 + var_x235 - var_x234 - var_x236;
        IJth(rJacobian, 23, 0) = var_x234 + var_x236;
        IJth(rJacobian, 24, 0) = var_x185 + var_x196 + var_x197 + var_x206 + var_x212 + var_x241 + var_x242 - var_x200 - var_x201 - var_x233 - var_x235;
        IJth(rJacobian, 25, 0) = var_x221 + var_x225 + var_x243 + var_x244 - var_x241 - var_x242;
        IJth(rJacobian, 26, 0) = 2.0000000000000002e-5 + var_x207 + var_x222 - var_x243 - var_x244 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I1_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I2_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na2 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na3 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IF_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__O_Na + var_x211 * var_chaste_interface__fast_sodium_current__IC_Na3;
        IJth(rJacobian, 27, 0) = 0.084735007814913818 * var_x33 + 0.0015588209597120041 * var_x18 - 0.0047984407834581883 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K - 0.017397555353928618 * var_x5 - 0.00035373121160108434 * var_x0 - 0.0098429554532475649 * var_x7 - 0.003075923579139864 * var_x6 - var_x245 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        IJth(rJacobian, 28, 0) = 0.035770000000000003 * var_x248 * (0.18064 - 0.18064 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f) + 0.024673572000000001 * var_x249 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f;
        IJth(rJacobian, 29, 0) = -0.00013571428571428572 * var_x253 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 2.1714285714285715e-5 * var_x254 * var_x259 + 6.9668928571428572e-6 * pow(var_x251, 2) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f / pow(var_x252, 2) + 1.4566594285714287e-7 * var_x254 * var_x256 * var_x258 / pow(var_x257, 2);
        IJth(rJacobian, 30, 0) = var_x267 + var_x264 * (var_x262 - var_chaste_interface__slow_transient_outward_potassium_current__ato_s);
        IJth(rJacobian, 31, 0) = -var_x272 * var_x274 + 0.00016708437761069341 * var_x273 * (var_x275 - var_chaste_interface__slow_transient_outward_potassium_current__ito_s) / pow((0.25714285714285712 + var_x271), 2);
        ...
        IJth(rJacobian, 33, 0) = var_x267 + var_x264 * (var_x262 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur);
        IJth(rJacobian, 34, 0) = -var_x274 * var_x282 - 2.0711500974658867e-5 * var_x273 * (var_x275 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur) / pow((1 - 0.14166666666666666 * var_x271), 2);
        IJth(rJacobian, 35, 0) = var_x266 * var_x284 + 0.0021933842239185751 * var_x283 * (var_x262 - var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss) / pow((0.33511450381679392 + var_x283), 2);
        ...
        IJth(rJacobian, 1, 1) = var_x61 * (-2.7458174 + var_x62 + var_x63 + 0.96151847158279735 * var_x38 - 0.0045528151523329874 * var_x39 - 0.96151847158279735 * var_x41 - 0.00014491407891765456 * var_x35) + 0.16806722689075632 * (0.125 * var_chaste_interface__calcium_concentration__Cass + 0.019599999999999999 * var_chaste_interface__calcium_buffering__LTRPN_Ca + 3.1999999999999999e-5 * var_chaste_interface__calcium_buffering__HTRPN_Ca + 1.7399999999999999e-5 * var_chaste_interface__calcium_concentration__CaNSR + 0.00014491407891765456 * log(1800.0 * var_x35) - 0.1250174 * var_chaste_interface__calcium_concentration__Cai - 1.12886395354433e-5 * var_chaste_interface__membrane__V - var_x64 * (70.0 - var_chaste_interface__calcium_buffering__LTRPN_Ca) - var_x65 * (140.0 - var_chaste_interface__calcium_buffering__HTRPN_Ca) + 1.6591891954566281e-18 * var_x12 * var_x25 - 0.48075923579139868 * var_x36 * var_x40) / (pow(var_x59, 3) * pow((0.084033613445378158 + var_x60), 2));
        ...
        IJth(rJacobian, 2, 2) = var_x68 * (-2175.0841750841751 + (-var_x70 - var_x71) * var_chaste_interface__calcium_fluxes__P_RyR) + 0.16806722689075632 * (363.63636363636363 * var_x73 + 2175.0841750841751 * var_chaste_interface__calcium_concentration__Cai - 2175.0841750841751 * var_chaste_interface__calcium_concentration__Cass - var_x69 * (-63.0 + var_chaste_interface__membrane__V)) / (pow(var_x66, 3) * pow((0.084033613445378158 + var_x67), 2));
        IJth(rJacobian, 3, 2) = var_x82 * (var_x77 + var_x78);
        IJth(rJacobian, 8, 2) = -var_x89 + 0.024299999999999999 * var_x88 * (1.0 - var_chaste_interface__ryanodine_receptors__P_C2 - var_chaste_interface__ryanodine_receptors__P_O1 - var_chaste_interface__ryanodine_receptors__P_O2);
        IJth(rJacobian, 9, 2) = var_x89;
        IJth(rJacobian, 11, 2) = var_x125 - var_x122;
        IJth(rJacobian, 14, 2) = var_x159 + var_x161 - var_x158 - var_x160;
        IJth(rJacobian, 15, 2) = var_x122 + var_x160 - var_x125 - var_x161;
        IJth(rJacobian, 16, 2) = var_x173 - var_x172;
        IJth(rJacobian, 17, 2) = var_x158 + var_x172 - var_x159 - var_x173;
        IJth(rJacobian, 2, 3) = var_x74 * (var_x70 + var_x71);
        IJth(rJacobian, 3, 3) = var_x81 * (-0.050000000000000003 + (-var_x77 - var_x78) * var_chaste_interface__calcium_fluxes__P_RyR) + 0.00013333333333333334 * (0.050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 4.5 * var_x73 - 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR) / (pow(var_x79, 3) * pow((0.053333333333333337 + var_x80), 2));
        IJth(rJacobian, 4, 3) = 0.0028598665395614866;
        IJth(rJacobian, 1, 4) = 1.7399999999999999e-5 * var_x61;
        IJth(rJacobian, 3, 4) = 0.050000000000000003 * var_x81;
        IJth(rJacobian, 4, 4) = -0.0030741734985700662;
        IJth(rJacobian, 2, 5) = var_x68 * var_x72 * var_x75;
        IJth(rJacobian, 3, 5) = var_x72 * var_x81 * var_x83;
        ...
        IJth(rJacobian, 2, 8) = var_x76;
        IJth(rJacobian, 3, 8) = var_x84;
        IJth(rJacobian, 8, 8) = -0.080249999999999988 + var_x91 - var_x90;
        IJth(rJacobian, 9, 8) = var_x90;
        IJth(rJacobian, 10, 8) = 0.0089999999999999993;
        IJth(rJacobian, 2, 9) = var_x76;
        IJth(rJacobian, 3, 9) = var_x84;
        IJth(rJacobian, 8, 9) = 0.96499999999999997 + var_x91;
        IJth(rJacobian, 9, 9) = -0.96499999999999997;
        IJth(rJacobian, 8, 10) = 0.00080000000000000004 + var_x91;
        ...
        IJth(rJacobian, 2, 11) = var_x68 * (5830.115245721463 - 92.541511836848613 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 5, 11) = var_x87;
        IJth(rJacobian, 11, 11) = -0.013000000000000001 + var_x128 + var_x96 - var_x126;
        IJth(rJacobian, 12, 11) = var_x136;
        IJth(rJacobian, 14, 11) = var_x126;
        IJth(rJacobian, 15, 11) = var_x127;
        IJth(rJacobian, 16, 11) = var_x174;
        IJth(rJacobian, 12, 12) = -0.050000000000000003 * var_x92 - 4.4000000000000004 * var_x108;
        IJth(rJacobian, 13, 12) = 1.2000000000000002 * var_x108;
        IJth(rJacobian, 12, 13) = var_x136 + var_x137;
        IJth(rJacobian, 13, 13) = -var_x137 - var_x142;
        IJth(rJacobian, 14, 13) = var_x142;
        IJth(rJacobian, 11, 14) = var_x129;
        IJth(rJacobian, 12, 14) = var_x136;
        IJth(rJacobian, 13, 14) = var_x143;
        IJth(rJacobian, 14, 14) = -0.026000000000000002 + var_x147 - var_x129 - var_x143 - var_x162 - var_x163;
        IJth(rJacobian, 15, 14) = var_x163;
        IJth(rJacobian, 16, 14) = 0.026000000000000002 - var_x147;
        IJth(rJacobian, 17, 14) = var_x162;
        IJth(rJacobian, 11, 15) = 0.00050000000000000001;
        IJth(rJacobian, 12, 15) = var_x136;
        IJth(rJacobian, 14, 15) = 1.0000000000000002e-6 * var_x92;
        IJth(rJacobian, 15, 15) = -0.0135 + var_x168 + var_x96;
        IJth(rJacobian, 17, 15) = var_x174;
        IJth(rJacobian, 11, 16) = var_x130;
        IJth(rJacobian, 12, 16) = var_x136;
        IJth(rJacobian, 14, 16) = var_x164;
        IJth(rJacobian, 16, 16) = var_x128 + var_x175 - var_x164;
        IJth(rJacobian, 17, 16) = var_x127;
        IJth(rJacobian, 12, 17) = var_x136;
        IJth(rJacobian, 14, 17) = var_x165;
        IJth(rJacobian, 15, 17) = var_x130;
        IJth(rJacobian, 16, 17) = 0.00050000000000000001;
        IJth(rJacobian, 17, 17) = -0.00050000000000000001 + var_x175 - var_x165;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-3.3946082173859908e-7 * var_x46 - 46927524.368911915 * var_x43 - 1.4564116150719218e-13 * var_x44 - 337.4638772428587 * var_x45 - 9385.5048737823836 * var_x42);
        IJth(rJacobian, 1, 18) = 8.9596216554657907e-15 * var_x44 * var_x61;
        IJth(rJacobian, 18, 18) = -6.2649332746797061e-8 * var_x46 - 577.38191486798689 * var_x42 - 2886909.5743399346 * var_x43 - 2.6878864966397372e-14 * var_x44;
        IJth(rJacobian, 27, 18) = 4.1766221831198043e-8 * var_x46 - 20.760261942385391 * var_x45;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (333.76617616580313 * var_x47 - 13.0 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 18, 19) = 20.532785023754869 * var_x47 - 0.79974013057636462 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 19, 19) = -var_x202 - var_x203;
        IJth(rJacobian, 20, 19) = var_x203;
        IJth(rJacobian, 21, 19) = var_x229;
        IJth(rJacobian, 24, 19) = var_x202;
        IJth(rJacobian, 26, 19) = var_x218;
        IJth(rJacobian, 19, 20) = var_x204;
        IJth(rJacobian, 20, 20) = var_x217 + var_x218 - var_x204;
        IJth(rJacobian, 21, 20) = var_x216 + var_x229;
        IJth(rJacobian, 24, 20) = var_x187;
        IJth(rJacobian, 26, 20) = var_x218;
        IJth(rJacobian, 20, 21) = var_x219;
        IJth(rJacobian, 21, 21) = var_x231 + var_x232;
        IJth(rJacobian, 25, 21) = var_x187;
        IJth(rJacobian, 26, 21) = var_x218;
        IJth(rJacobian, 21, 22) = var_x229;
        IJth(rJacobian, 22, 22) = var_x237 - var_x238;
        IJth(rJacobian, 23, 22) = var_x238;
        IJth(rJacobian, 24, 22) = var_x220;
        IJth(rJacobian, 26, 22) = var_x218;
        IJth(rJacobian, 21, 23) = var_x229;
        IJth(rJacobian, 22, 23) = var_x239;
        IJth(rJacobian, 23, 23) = -var_x239;
        IJth(rJacobian, 26, 23) = var_x218;
        IJth(rJacobian, 19, 24) = var_x205;
        IJth(rJacobian, 20, 24) = var_x220;
        IJth(rJacobian, 21, 24) = var_x229;
        IJth(rJacobian, 22, 24) = var_x240;
        IJth(rJacobian, 24, 24) = var_x217 + var_x237 - var_x205 - var_x240;
        IJth(rJacobian, 25, 24) = var_x216;
        IJth(rJacobian, 26, 24) = var_x218;
        IJth(rJacobian, 21, 25) = var_x220 + var_x229;
        IJth(rJacobian, 24, 25) = var_x219;
        IJth(rJacobian, 25, 25) = var_x231 + var_x237;
        IJth(rJacobian, 26, 25) = var_x218 + var_x230;
        IJth(rJacobian, 21, 26) = var_x229;
        IJth(rJacobian, 25, 26) = var_x228;
        IJth(rJacobian, 26, 26) = var_x232 + var_x237;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (0.65056346575383339 * var_x53 - 4.1078913989637309 * var_x50 - 1042.8338748647093 * var_x42 - 0.14762734715025908 * var_x48 - 7.2607529660026051 * var_x49 - 16535.729984900074 * var_x45 - 5214169.3743235469 * var_x43 - 1.2837160621761659 * var_x51 - 10.441746449740933 * var_x52);
        IJth(rJacobian, 18, 27) = -64.153546096442994 * var_x42 - 320767.730482215 * var_x43;
        IJth(rJacobian, 27, 27) = 0.040021670080783313 * var_x53 - 0.0090818087605069615 * var_x48 - 1017.2528351768841 * var_x45 - 0.078972250091364882 * var_x51 - 0.642360282243162 * var_x52 - 0.25271120029236765 * var_x50 - 0.44667042500874232 * var_x49;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-1.2201 * var_x54);
        IJth(rJacobian, 27, 28) = -0.075058687178170963 * var_x54;
        IJth(rJacobian, 28, 28) = -0.18064 * var_x248 - 0.39560000000000001 * var_x249;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x9);
        IJth(rJacobian, 27, 29) = -var_x17 * var_x245;
        IJth(rJacobian, 29, 29) = -0.00015200000000000001 * var_x259 - 0.00095 * var_x253;
        IJth(rJacobian, 30, 30) = var_x268;
        IJth(rJacobian, 31, 31) = -var_x272;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0115 * var_x55);
        IJth(rJacobian, 27, 32) = -0.00070746242320216869 * var_x55;
        IJth(rJacobian, 32, 32) = -9.5333299999999997e-5 * var_x280 - var_x279 * var_x281;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (var_x56 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur);
        IJth(rJacobian, 27, 33) = var_x246 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur;
        IJth(rJacobian, 33, 33) = var_x268;
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (var_x56 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur);
        IJth(rJacobian, 27, 34) = var_x246 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur;
        IJth(rJacobian, 34, 34) = -var_x282;
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (var_x57 * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss);
        IJth(rJacobian, 27, 35) = var_x247 * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss;
        IJth(rJacobian, 35, 35) = -var_x284;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (var_x57 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss);
        IJth(rJacobian, 27, 36) = var_x247 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss;
