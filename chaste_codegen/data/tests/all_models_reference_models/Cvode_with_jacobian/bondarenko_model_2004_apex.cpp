...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_model_2004_apexFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x49 = log(140600 / var_x42);
        ...
        const double var_x59 = 1.2837160621761659 * var_x2 - 050000000000000003 * var_chaste_interface__membrane__V;
        ...
        const double var_x88 = exp(-038580246913580245 * pow((-1 + var_x87), 2));
        const double var_x89 = var_x88 * (0.15561 - 00247 * var_chaste_interface__membrane__V);
        const double var_x90 = pow(var_chaste_interface__calcium_concentration__Cass, 3.0);
        const double var_x91 = 012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2.0) * var_chaste_interface__ryanodine_receptors__P_O1;
        ...
        const double var_x95 = 015384615384615385 * var_x94 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x96 = -0.28999999999999998 - 02 * var_chaste_interface__membrane__V;
        ...
        const double var_x106 = var_x105 * (var_x101 * (-8.0 - var_x87) - var_x102 * (-0.10000000000000001 - 0050000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_x114 = 040000000000000001 * var_x113;
        const double var_x115 = 00040000000000000002 * var_x106;
        ...
        const double var_x121 = 0048000000000000004 * var_x120;
        ...
        const double var_x125 = var_chaste_interface__calcium_concentration__Cass / pow((1 + 050000000000000003 * var_chaste_interface__calcium_concentration__Cass), 2);
        const double var_x126 = 00058310000000000002 * var_x125;
        ...
        const double var_x133 = 0076923076923076927 * var_x94 * var_chaste_interface__L_type_calcium_current__C3;
        ...
        const double var_x135 = 0144 * var_x117 * var_chaste_interface__L_type_calcium_current__C2;
        ...
        const double var_x140 = 011538461538461539 * var_x94 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x141 = 0096000000000000009 * var_x117 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x142 = 0.80000000000000004 * var_x106 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x143 = 080000000000000002 * var_x110 * var_chaste_interface__L_type_calcium_current__C3;
        ...
        const double var_x162 = 00093296000000000004 * var_x113 * var_x122;
        ...
        const double var_x176 = 013000000000000001 - var_x98;
        ...
        const double var_x180 = 01083743842364532 * var_x179 * var_chaste_interface__fast_sodium_current__O_Na;
        ...
        const double var_x183 = (0085583333333333327 * var_x181 + 0016666666666666668 * var_x182) / pow((var_x182 + 0.4108 * var_x181), 2);
        ...
        const double var_x187 = 073163809141391992 * var_x186 * var_chaste_interface__fast_sodium_current__O_Na;
        ...
        const double var_x199 = 3.317429681310359e-6 * var_x196 * var_chaste_interface__fast_sodium_current__IF_Na / pow((1 + 0023419203747072604 * var_chaste_interface__membrane__V), 2);
        ...
        const double var_x203 = 00019355636363636362 * var_x183 * var_x191 * var_x201 * var_chaste_interface__fast_sodium_current__IF_Na;
        ...
        const double var_x211 = 009852216748768473 * var_x210;
        ...
        const double var_x216 = 71.871455576559541 * (0068466666666666667 * var_x215 + 0015333333333333334 * var_x182) / pow((var_x182 + 0.44652173913043475 * var_x215), 2);
        ...
        const double var_x226 = 0094433497536945809 * var_x225;
        ...
        const double var_x229 = 95.049999999999997 * (0013333333333333335 * var_x182 + 0060411764705882356 * var_x228) / pow((var_x182 + 0.51349999999999996 * var_x228), 2);
        ...
        const double var_x247 = 025019562392723654 * var_x8;
        const double var_x248 = 0.25271120029236765 * var_x2 - 0098429554532475649 * var_chaste_interface__membrane__V;
        const double var_x249 = 078972250091364882 * var_x2 - 003075923579139864 * var_chaste_interface__membrane__V;
        ...
        const double var_x266 = 0073216139155926159 * var_x265 / pow((1 + 0.23955296404275997 * var_x265), 2);
        ...
        const double var_x288 = 00052457313400000008 * var_x287 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2;
        ...
        const double var_x292 = 0021243940109999999 * var_x291 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x293 = exp(-0.16339999999999999 - 032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x294 = 00021232196 * var_x293 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K;
        ...
        IJth(rJacobian, 5, 0) = -00247 * var_x88 * var_chaste_interface__L_type_calcium_current__O + var_x89 * (015432098765432098 - 0030864197530864196 * var_chaste_interface__membrane__V) * var_chaste_interface__L_type_calcium_current__O;
        IJth(rJacobian, 11, 0) = var_x100 + var_x108 + var_x112 + var_x114 + var_x116 + var_x95 - var_x119 - var_x121;
        IJth(rJacobian, 12, 0) = var_x135 - var_x133 - var_x136 - var_x137 + 1.6000000000000001 * var_x106 * var_x134 + 0.16 * var_x110 * var_x134 + 0038461538461538464 * var_x94 * var_chaste_interface__L_type_calcium_current__C2 - 019200000000000002 * var_x117 * var_x134;
        ...
        IJth(rJacobian, 15, 0) = var_x156 + var_x157 + var_x168 + var_x171 + var_x172 - var_x154 - var_x173 - 076923076923076927 * var_x170 * var_chaste_interface__L_type_calcium_current__I1 + var_x148 * var_x169 * var_x96;
        ...
        IJth(rJacobian, 18, 0) = -00015994802611527293 - 0.12710251172237072 * var_x33 - 4.9775675863698838e-18 * var_x16 - 0.79974013057636462 * var_chaste_interface__fast_sodium_current__O_Na - 1.2601770073888912e-20 * var_x26;
        ...
        IJth(rJacobian, 27, 0) = 084735007814913818 * var_x33 + 0015588209597120041 * var_x18 - 0047984407834581883 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K - 017397555353928618 * var_x5 - 00035373121160108434 * var_x0 - 0098429554532475649 * var_x7 - 003075923579139864 * var_x6 - var_x247 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        IJth(rJacobian, 28, 0) = 035770000000000003 * var_x250 * (0.18064 - 0.18064 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f) + 024673572000000001 * var_x251 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f;
        IJth(rJacobian, 29, 0) = -00013571428571428572 * var_x255 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 2.1714285714285715e-5 * var_x256 * var_x261 + 6.9668928571428572e-6 * pow(var_x253, 2) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f / pow(var_x254, 2) + 1.4566594285714287e-7 * var_x256 * var_x258 * var_x260 / pow(var_x259, 2);
        IJth(rJacobian, 30, 0) = var_x269 + var_x266 * (var_x264 - var_chaste_interface__slow_transient_outward_potassium_current__ato_s);
        IJth(rJacobian, 31, 0) = -var_x274 * var_x276 + 00016708437761069341 * var_x275 * (var_x277 - var_chaste_interface__slow_transient_outward_potassium_current__ito_s) / pow((0.25714285714285712 + var_x273), 2);
        ...
        IJth(rJacobian, 35, 0) = var_x268 * var_x286 + 0021933842239185751 * var_x285 * (var_x264 - var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss) / pow((0.33511450381679392 + var_x285), 2);
        IJth(rJacobian, 37, 0) = var_x288 + var_x290 - var_x292 - var_x294;
        IJth(rJacobian, 38, 0) = 01176 * var_x299 * (022348 - 022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - 022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - 022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K - 022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K) + 0029658262000000005 * var_x300 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1;
        IJth(rJacobian, 39, 0) = -var_x288 - var_x290;
        IJth(rJacobian, 40, 0) = var_x292 + var_x294;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (2.0 * var_x38 + 074007286514025064 * var_x39 - 2.0 * var_x41 - 0047112379481865285 * var_x35 - var_x21 * var_x24 * var_x34 + 02 * var_x22 * var_x34 / pow((1 + 0.10000000000000001 * var_chaste_interface__calcium_concentration__Cai), 2));
        ...
        IJth(rJacobian, 4, 1) = 0002143069590085796 + 11.084842707340323 * var_x41 - 11.084842707340323 * var_x38;
        IJth(rJacobian, 6, 1) = 2.2890000000000001 - var_x64;
        IJth(rJacobian, 7, 1) = 0.33180000000000004 - var_x65;
        IJth(rJacobian, 18, 1) = 013658445456998961 * var_x39;
        ...
        IJth(rJacobian, 8, 2) = -var_x91 + 024299999999999999 * var_x90 * (1.0 - var_chaste_interface__ryanodine_receptors__P_C2 - var_chaste_interface__ryanodine_receptors__P_O1 - var_chaste_interface__ryanodine_receptors__P_O2);
        ...
        IJth(rJacobian, 3, 3) = var_x83 * (-050000000000000003 + (-var_x79 - var_x80) * var_chaste_interface__calcium_fluxes__P_RyR) + 00013333333333333334 * (050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 4.5 * var_x75 - 050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR) / (pow(var_x81, 3) * pow((053333333333333337 + var_x82), 2));
        IJth(rJacobian, 4, 3) = 0028598665395614866;
        IJth(rJacobian, 1, 4) = 1.7399999999999999e-5 * var_x63;
        IJth(rJacobian, 3, 4) = 050000000000000003 * var_x83;
        IJth(rJacobian, 4, 4) = -0030741734985700662;
        IJth(rJacobian, 2, 5) = var_x70 * var_x74 * var_x77;
        IJth(rJacobian, 3, 5) = var_x74 * var_x83 * var_x85;
        IJth(rJacobian, 5, 5) = -040000000000000001;
        IJth(rJacobian, 1, 6) = var_x63 * (019599999999999999 + var_x66);
        IJth(rJacobian, 6, 6) = -019599999999999999 - var_x66;
        ...
        IJth(rJacobian, 8, 8) = -080249999999999988 + var_x93 - var_x92;
        IJth(rJacobian, 9, 8) = var_x92;
        IJth(rJacobian, 10, 8) = 0089999999999999993;
        ...
        IJth(rJacobian, 8, 10) = 00080000000000000004 + var_x93;
        IJth(rJacobian, 10, 10) = -00080000000000000004;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0 : (10.8927 - 0.1729 * var_chaste_interface__membrane__V);
        ...
        IJth(rJacobian, 11, 11) = -013000000000000001 + var_x130 + var_x98 - var_x128;
        IJth(rJacobian, 12, 11) = var_x138;
        IJth(rJacobian, 14, 11) = var_x128;
        IJth(rJacobian, 15, 11) = var_x129;
        IJth(rJacobian, 16, 11) = var_x176;
        IJth(rJacobian, 12, 12) = -050000000000000003 * var_x94 - 4.4000000000000004 * var_x110;
        ...
        IJth(rJacobian, 14, 14) = -026000000000000002 + var_x149 - var_x131 - var_x145 - var_x164 - var_x165;
        IJth(rJacobian, 15, 14) = var_x165;
        IJth(rJacobian, 16, 14) = 026000000000000002 - var_x149;
        IJth(rJacobian, 17, 14) = var_x164;
        IJth(rJacobian, 11, 15) = 00050000000000000001;
        IJth(rJacobian, 12, 15) = var_x138;
        IJth(rJacobian, 14, 15) = 1.0000000000000002e-6 * var_x94;
        IJth(rJacobian, 15, 15) = -0135 + var_x170 + var_x98;
        ...
        IJth(rJacobian, 16, 17) = 00050000000000000001;
        IJth(rJacobian, 17, 17) = -00050000000000000001 + var_x177 - var_x167;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0 : (-3.3946082173859908e-7 * var_x48 - 9385.5048737823836 * var_x43 - 1.4564116150719218e-13 * var_x44 - 337.46387724285864 * var_x46 - 46927524.368911915 * var_x47);
        ...
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0 : (333.76617616580313 * var_x49 - 13.0 * var_chaste_interface__membrane__V);
        ...
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0 : (0.65056346575383339 * var_x55 - 4.1078913989637309 * var_x52 - 1042.8338748647093 * var_x43 - 0.14762734715025908 * var_x50 - 7.2607529660026051 * var_x51 - 16535.729984900074 * var_x46 - 5214169.374323546 * var_x47 - 1.2837160621761659 * var_x53 - 10.441746449740933 * var_x54);
        IJth(rJacobian, 18, 27) = -64.153546096442994 * var_x43 - 320767.73048221495 * var_x47;
        IJth(rJacobian, 27, 27) = 040021670080783313 * var_x55 - 0090818087605069615 * var_x50 - 078972250091364882 * var_x53 - 0.642360282243162 * var_x54 - 0.25271120029236765 * var_x52 - 0.44667042500874232 * var_x51 - 1017.2528351768841 * var_x46;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0 : (-1.2201 * var_x56);
        IJth(rJacobian, 27, 28) = -075058687178170963 * var_x56;
        IJth(rJacobian, 28, 28) = -0.18064 * var_x250 - 0.39560000000000001 * var_x251;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0 : (-var_x17 * var_x9);
        IJth(rJacobian, 27, 29) = -var_x17 * var_x247;
        IJth(rJacobian, 29, 29) = -00015200000000000001 * var_x261 - 00095 * var_x255;
        IJth(rJacobian, 30, 30) = var_x270;
        IJth(rJacobian, 31, 31) = -var_x274;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0 : (-0115 * var_x57);
        IJth(rJacobian, 27, 32) = -00070746242320216869 * var_x57;
        IJth(rJacobian, 32, 32) = -9.5333299999999997e-5 * var_x282 - var_x281 * var_x283;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0 : (var_x58 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur);
        ...
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0 : (var_x58 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur);
        ...
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0 : (var_x59 * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss);
        ...
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0 : (var_x59 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss);
        IJth(rJacobian, 27, 36) = var_x249 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss;
        IJth(rJacobian, 0, 37) = mSetVoltageDerivativeToZero ? 0 : (2.0025970569948188 * var_x60 - 078 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 27, 37) = 0.12319671014252923 * var_x60 - 0047984407834581883 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 38, 38) = -023761000000000001 + var_x301 - 047002000000000002 * var_x300;
        IJth(rJacobian, 39, 38) = 023761000000000001;
        IJth(rJacobian, 37, 39) = var_x297;
        IJth(rJacobian, 38, 39) = 036777999999999998 + var_x301;
        IJth(rJacobian, 39, 39) = -036777999999999998 - var_x297;
