...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_Purkinje_model_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x4 = log(var_x3 * NV_Ith_S(mParameters, 5));
        ...
        const double var_x10 = sqrt(NV_Ith_S(mParameters, 5));
        ...
        const double var_x19 = var_x10 * NV_Ith_S(mParameters, 11) / (var_x18 + 1.02 * var_x11);
        ...
        const double var_x23 = var_x10 * var_x11 * NV_Ith_S(mParameters, 11) / pow((var_x11 + 0.98039215686274506 * var_x18), 2);
        ...
        const double var_x31 = -0.34100000000000003 * NV_Ith_S(mParameters, 4);
        ...
        const double var_x35 = (-0.20000000000000001 * var_chaste_interface__i_to_1_i2_gate__i2 - 0.80000000000000004 * var_chaste_interface__i_to_1_i_gate__i) * NV_Ith_S(mParameters, 15);
        ...
        const double var_x38 = pow(var_chaste_interface__i_Na_m_gate__m, 3) * NV_Ith_S(mParameters, 8);
        ...
        const double var_x53 = NV_Ith_S(mParameters, 13) * var_chaste_interface__i_Ks_xs2_gate__xs2;
        const double var_x54 = var_x52 * var_x53;
        const double var_x55 = var_x54 * var_chaste_interface__i_Ks_xs1_gate__xs1;
        const double var_x56 = exp(-0.024333324280071702 * var_chaste_interface__membrane__V);
        const double var_x57 = pow(NV_Ith_S(mParameters, 6), 3);
        ...
        const double var_x61 = NV_Ith_S(mParameters, 14) * exp(0.013102559227730915 * var_chaste_interface__membrane__V);
        ...
        const double var_x70 = (1.0 + 416.66666666666669 * var_chaste_interface__Ca_i__Ca_i) * NV_Ith_S(mParameters, 4);
        ...
        const double var_x81 = var_x10 * NV_Ith_S(mParameters, 12) / var_x80;
        ...
        const double var_x89 = exp(0.01485884101040119 * NV_Ith_S(mParameters, 6));
        ...
        const double var_x92 = NV_Ith_S(mParameters, 5) / (1.5 + NV_Ith_S(mParameters, 5));
        ...
        const double var_x97 = var_x10 * var_x6 * var_x79 * NV_Ith_S(mParameters, 12) * var_chaste_interface__i_Kr_xr_gate__xr / pow(var_x80, 2);
        ...
        const double var_x102 = NV_Ith_S(mParameters, 7) / var_x101;
        ...
        const double var_x109 = var_x108 * NV_Ith_S(mParameters, 7);
        ...
        const double var_x122 = -1004882.8125 - var_x67 - 775361.25000000012 * NV_Ith_S(mParameters, 4);
        ...
        const double var_x125 = 9.9030543773805519e-13 * var_x124;
        ...
        const double var_x128 = -26.712338705498265 * log(var_x127 * (0.018329999999999999 * NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 5))) + var_chaste_interface__membrane__V;
        const double var_x129 = var_x128 * var_chaste_interface__i_Ks_xs1_gate__xs1;
        const double var_x130 = var_x129 * var_x48 * var_x49 * var_x53 / pow(var_x50, 2);
        const double var_x131 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x132 = log(var_x131 * NV_Ith_S(mParameters, 6));
        const double var_x133 = -26.712338705498265 * var_x132 + var_chaste_interface__membrane__V;
        const double var_x134 = var_x37 * pow(var_chaste_interface__i_Na_m_gate__m, 2) * NV_Ith_S(mParameters, 8);
        const double var_x135 = var_x133 * var_x38;
        const double var_x136 = var_x133 * pow(var_chaste_interface__i_Na_L_m_L_gate__m_L, 2) * var_chaste_interface__i_Na_L_h_L_gate__h_L;
        const double var_x137 = var_x103 * var_x110 * var_chaste_interface__i_Ca_L_f2_gate__f2 * var_chaste_interface__i_Ca_L_f_gate__f;
        const double var_x138 = var_x105 * var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2;
        const double var_x139 = var_x103 * var_x110 * var_chaste_interface__i_Ca_L_d_gate__d;
        ...
        const double var_x143 = 6.5 - 0.13 * var_chaste_interface__membrane__V;
        const double var_x144 = NV_Ith_S(mParameters, 15) * var_chaste_interface__i_to_1_a_gate__a;
        const double var_x145 = var_x129 * NV_Ith_S(mParameters, 13);
        const double var_x146 = var_x43 * var_chaste_interface__membrane__V;
        ...
        const double var_x150 = var_x127 * var_x55;
        const double var_x151 = var_x86 * NV_Ith_S(mParameters, 4);
        ...
        const double var_x185 = (1.0 + 0.75 * var_x182) * NV_Ith_S(mParameters, 2);
        ...
        const double var_x193 = 0.005411764705882352 * NV_Ith_S(mParameters, 0);
        const double var_x194 = 1 - var_x177;
        const double var_x195 = var_x180 * var_x194;
        const double var_x196 = var_x181 / pow(var_x179, 2);
        const double var_x197 = var_x196 * (-1.0 + var_x177);
        const double var_x198 = 0.75 * var_x195 + 0.75 * var_x197;
        const double var_x199 = var_x184 * NV_Ith_S(mParameters, 2);
        const double var_x200 = var_x188 * var_x199;
        const double var_x201 = 0.00017000000000000001 * var_x195 + 0.00017000000000000001 * var_x197;
        const double var_x202 = pow(var_chaste_interface__Ca_r__Ca_r, (-2));
        const double var_x203 = var_x173 * var_x202 / pow(var_x175, 2);
        const double var_x204 = var_x180 * var_x203;
        const double var_x205 = var_x196 * var_x203;
        const double var_x206 = 0.0056249999999999998 * var_x204 - 0.0056249999999999998 * var_x205;
        const double var_x207 = 1.2750000000000001e-6 * var_x204 - 1.2750000000000001e-6 * var_x205;
        ...
        const double var_x217 = var_x209 + var_x216;
        const double var_x218 = 1 / var_x217;
        const double var_x219 = var_x216 * var_x218;
        const double var_x220 = 0.0072727272727272727 * var_x208;
        const double var_x221 = 0.032000000000000001 * var_x210 * var_x212 / pow(var_x213, 2);
        const double var_x222 = var_x215 - var_x220 - var_x221;
        const double var_x223 = var_x210 * var_x214;
        const double var_x224 = var_x217 * (var_x215 * var_x218 - var_x218 * var_x221 + 3.125 * var_x223 * (var_x220 + var_x221 - var_x215) / pow((var_x223 + 0.25 * var_x208), 2));
        const double var_x225 = -var_x209 - var_x216;
        const double var_x226 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 10) - 0.14705882352941177 * var_chaste_interface__membrane__V);
        ...
        const double var_x230 = exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * NV_Ith_S(mParameters, 10));
        const double var_x231 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 10));
        const double var_x232 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 10) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        ...
        const double var_x236 = ((var_x227) ? (-0.019852941176470591 * var_x226) : (0));
        const double var_x237 = var_x228 + var_x234;
        const double var_x238 = 0.01 * NV_Ith_S(mParameters, 9);
        const double var_x239 = 1.0 - var_x238;
        const double var_x240 = var_x239 / var_x237;
        const double var_x241 = ((var_x227) ? (0.28123999999999999 * var_x231 + 108500.0 * var_x230) : (0.693000693000693 * var_x232 / pow(var_x233, 2)));
        const double var_x242 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 10) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x243 = 1.0 + var_x242;
        const double var_x244 = exp(0.01052 * NV_Ith_S(mParameters, 10) - 0.01052 * var_chaste_interface__membrane__V);
        const double var_x245 = var_x244 / var_x243;
        const double var_x246 = exp(-3.2000000000000002 + var_x211 + 0.10000000000000001 * NV_Ith_S(mParameters, 10));
        const double var_x247 = 1.0 + var_x246;
        const double var_x248 = exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 10) - 2.5349999999999999e-7 * var_chaste_interface__membrane__V);
        ...
        const double var_x253 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 10));
        const double var_x254 = 1.0 + var_x253;
        const double var_x255 = 1 / var_x254;
        const double var_x256 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 10));
        const double var_x257 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 10) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        ...
        const double var_x262 = ((var_x227) ? (var_x259 + var_x252 * var_x255 * (1.5254334000000001e-6 * var_x257 - 31073.016 * var_x256) - 0.311 * var_x252 * var_x253 * var_x258 / pow(var_x254, 2)) : (0));
        const double var_x263 = var_x250 + var_x260;
        const double var_x264 = var_x239 / var_x263;
        const double var_x265 = ((var_x227) ? (-0.001275024 * var_x245 + 0.016701360000000002 * var_x242 * var_x244 / pow(var_x243, 2)) : (-7.6049999999999996e-8 * var_x249 + 0.029999999999999999 * var_x246 * var_x248 / pow(var_x247, 2)));
        const double var_x266 = 0.16393442622950821 * var_chaste_interface__membrane__V;
        const double var_x267 = exp(11.311475409836067 + var_x266);
        ...
        const double var_x277 = exp(0.59347181008902072 - 0.14836795252225518 * var_chaste_interface__membrane__V);
        ...
        const double var_x289 = var_x104 * var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca;
        const double var_x290 = 5.257293604712606 * var_x113;
        ...
        const double var_x297 = var_x293 * var_x296;
        const double var_x298 = var_x112 * var_x137;
        const double var_x299 = 0.0042724511494939511 * var_x297;
        const double var_x300 = var_x112 * var_x139;
        ...
        const double var_x304 = -10.0 * var_x195 - 10.0 * var_x197;
        const double var_x305 = 0.01 * (0.14999999999999999 - var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca + 0.55000000000000004 * var_x291 + 0.29999999999999999 / (1.0 - 70.217303721666525 * var_x294)) / pow((0.050000000000000003 + var_x182 + 0.10000000000000001 * var_x291), 2);
        const double var_x306 = pow((0.0030000000000000001 + var_chaste_interface__Ca_r__Ca_r), (-2));
        const double var_x307 = var_x112 * var_x164;
        const double var_x308 = 0.074999999999999997 * var_x205 - 0.074999999999999997 * var_x204;
        const double var_x309 = 26.286468023563032 * var_x113;
        ...
        const double var_x316 = 6.5716170058907579 * var_x113;
        ...
        const double var_x318 = 0.0028483007663293006 * var_x315;
        const double var_x319 = 0.29257209884027718 * var_x317;
        const double var_x320 = var_x300 * var_x318;
        const double var_x321 = var_x300 * var_x319;
        const double var_x322 = exp(-5.4098360655737707 - var_x266);
        ...
        const double var_x329 = exp(9.0909090909090917 + 0.15151515151515152 * var_chaste_interface__membrane__V);
        ...
        const double var_x346 = 1.25 * pow(var_x336, 2) / pow(var_x337, 2);
        const double var_x347 = 1.25 * var_x342;
        const double var_x348 = 1.25 * var_x338;
        const double var_x349 = 1.25 * pow(var_x340, 2) / pow(var_x341, 2);
        ...
        const double var_x354 = 0.066666666666666666 * var_chaste_interface__membrane__V;
        const double var_x355 = exp(1.6666666666666667 + var_x354);
        const double var_x356 = 1.0 + var_x355;
        const double var_x357 = 1 / var_x356;
        const double var_x358 = exp(-2.6666666666666665 + var_x354);
        const double var_x359 = 1.0 + var_x358;
        const double var_x360 = var_x358 / var_x359;
        const double var_x361 = 0.002 * var_x355 / pow(var_x356, 2);
        const double var_x362 = 0.029999999999999999 * var_x357;
        const double var_x363 = 1 / (var_x362 + 0.10000000000000001 * var_x360);
        ...
        const double var_x368 = exp(1.7333333333333334 + var_x354);
        const double var_x369 = 1.0 + var_x368;
        const double var_x370 = 1 / var_x369;
        const double var_x371 = exp(-0.66666666666666663 + var_x354);
        const double var_x372 = 1.0 + var_x371;
        const double var_x373 = var_x371 / var_x372;
        const double var_x374 = 0.00029466666666666671 * var_x368 / pow(var_x369, 2);
        const double var_x375 = 0.0044200000000000003 * var_x370;
        const double var_x376 = 1 / (var_x375 + 0.050000000000000003 * var_x373);
        const double var_x377 = exp(-0.0069387755102040824 - 0.081632653061224483 * var_chaste_interface__membrane__V);
        ...
        const double var_x383 = exp(0.65693430656934315 - 0.072992700729927015 * var_chaste_interface__membrane__V);
        ...
        const double var_x395 = var_x390 * var_x394 / pow(var_x391, 2);
        const double var_x396 = 44.600000000000001 + var_chaste_interface__membrane__V;
        const double var_x397 = var_x386 * var_x396 / pow(var_x387, 2);
        const double var_x398 = var_x389 * var_x396;
        const double var_x399 = var_x393 * var_x394;
        const double var_x400 = 0.072992700729927015 * var_x383 / pow(var_x384, 2);
        ...
        const double var_x406 = var_x133 * NV_Ith_S(mParameters, 3);
        const double var_x407 = var_x135 * NV_Ith_S(mParameters, 3);
        ...
        const double var_x415 = 1.9554743855840427e-10 * var_x45;
        ...
        const double var_x428 = var_x6 * NV_Ith_S(mParameters, 3);
        const double var_x429 = var_x144 * NV_Ith_S(mParameters, 3);
        const double var_x430 = var_x127 * var_x426;
        const double var_x431 = 0.0025000000000000005 * var_x176;
        const double var_x432 = 0.5 * var_chaste_interface__Ca_i__Ca_i;
        const double var_x433 = var_x189 * var_x432;
        const double var_x434 = var_x199 * var_x432;
        ...
        const double var_x440 = 0.052572936047126068 * var_x110;
        ...
        const double var_x444 = var_x443 * NV_Ith_S(mParameters, 1) * var_chaste_interface__q_rel_ri_gate__ri;
        const double var_x445 = var_x441 * var_x444 * var_chaste_interface__q_rel_ro_gate__ro / pow(var_x442, 2);
        const double var_x446 = var_x445 * (var_x439 + var_x115 * var_x440 - var_x109 * var_x440);
        const double var_x447 = 1 / var_x442;
        const double var_x448 = var_x447 * NV_Ith_S(mParameters, 1) * var_chaste_interface__q_rel_ro_gate__ro;
        ...
        const double var_x452 = var_x443 * var_x448;
        const double var_x453 = var_x444 * var_x447;
        const double var_x454 = 3.0240948858532382e-8 * var_x113;
        ...
        const double var_x463 = 4.0390323434238405e-7 * var_x461;
        const double var_x464 = var_x300 * var_x463;
        const double var_x465 = 0.23999999999999996 * var_x449;
        const double var_x466 = 0.23999999999999996 * var_x461;
        ...
        const double var_x470 = exp(-16.0 + 80.0 * var_x469 + 40000.0 * var_chaste_interface__Ca_r__Ca_r);
        ...
        const double var_x478 = var_x470 * var_x477 / pow(var_x471, 2);
        const double var_x479 = 17.524312015708688 * var_x113;
        const double var_x480 = var_x467 / pow(var_x468, 2);
        const double var_x481 = var_x480 * (234.05767907222176 * var_x289 + var_x115 * var_x479 - var_x109 * var_x479);
        const double var_x482 = (-var_chaste_interface__q_rel_ri_gate__ri + 1 / var_x471) / pow((0.29999999999999999 + var_x182 + 0.10000000000000001 * var_x476), 2);
        const double var_x483 = var_x472 * var_x475 / pow(var_x473, 2);
        const double var_x484 = var_x482 * var_x483;
        const double var_x485 = var_x298 * var_x480;
        const double var_x486 = 18724.61432577774 * var_x478;
        const double var_x487 = 35.108651860833263 * var_x484;
        const double var_x488 = var_x480 * var_x486;
        const double var_x489 = var_x300 * var_x488;
        const double var_x490 = var_x480 * var_x487;
        const double var_x491 = var_x300 * var_x490;
        const double var_x492 = 0.01 * var_x482;
        const double var_x493 = var_x307 * var_x480;
        const double var_x494 = pow(var_chaste_interface__i_Ca_L_d_gate__d, 2);
        const double var_x495 = pow(NV_Ith_S(mParameters, 7), 2);
        const double var_x496 = pow(var_chaste_interface__i_Ca_L_f2_gate__f2, 2);
        const double var_x497 = pow(var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2, 2);
        const double var_x498 = pow(var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca, 2);
        const double var_x499 = pow(var_chaste_interface__i_Ca_L_f_gate__f, 2);
        const double var_x500 = pow(var_x100, 2);
        const double var_x501 = var_x106 * var_x500;
        const double var_x502 = var_x495 * var_x496 * var_x497 * var_x498 * var_x499 * var_x501;
        const double var_x503 = var_x494 * var_x502;
        const double var_x504 = -1 + var_x354;
        const double var_x505 = pow(var_x504, 2);
        const double var_x506 = var_x494 * var_x495 * var_x496 * var_x497 * var_x498 * var_x499 * var_x505;
        const double var_x507 = var_x501 * var_x506;
        const double var_x508 = 1 / (1.0 + 2773.3892298416795 * var_x507);
        const double var_x509 = pow(var_chaste_interface__Ca_JSR__Ca_JSR, 1.8999999999999999);
        const double var_x510 = 0.0028 + var_chaste_interface__Ca_r__Ca_r;
        const double var_x511 = 1 / var_x510;
        const double var_x512 = pow((var_x511 * var_chaste_interface__Ca_r__Ca_r), 1.8999999999999999);
        const double var_x513 = 1 / (var_x509 + 1644.6531773416521 * var_x512);
        const double var_x514 = var_x509 * var_x513;
        const double var_x515 = var_x508 * var_x514;
        const double var_x516 = 415.29710452059015 * var_x506;
        const double var_x517 = var_x500 * var_x98 / pow(var_x101, 3);
        const double var_x518 = var_x107 * var_x99;
        const double var_x519 = var_x514 / pow((0.00036056965579875914 + var_x507), 2);
        const double var_x520 = 138.43236817353005 * var_x506 * var_x515;
        const double var_x521 = 1848.9261532277862 * var_x515;
        const double var_x522 = var_x505 * var_x521;
        const double var_x523 = pow(var_chaste_interface__i_Ca_L_f_gate__f, 4);
        const double var_x524 = pow(var_x504, 4);
        const double var_x525 = pow(var_x101, (-4));
        const double var_x526 = pow(var_x100, 4);
        const double var_x527 = pow(NV_Ith_S(mParameters, 7), 4);
        const double var_x528 = pow(var_chaste_interface__i_Ca_L_f2_gate__f2, 4);
        const double var_x529 = pow(var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2, 4);
        const double var_x530 = pow(var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca, 4);
        const double var_x531 = 0.66666666666666663 * var_x519 * var_x524 * var_x525 * var_x526 * var_x527 * var_x528 * var_x529 * var_x530;
        const double var_x532 = var_x494 * var_x495 * var_x497 * var_x498 * var_x501 * var_x522;
        const double var_x533 = pow(var_chaste_interface__i_Ca_L_d_gate__d, 4);
        const double var_x534 = 0.66666666666666663 * var_x519 * var_x523 * var_x524 * var_x525 * var_x526 * var_x527 * var_x529 * var_x533;
        const double var_x535 = var_x494 * var_x495 * var_x496 * var_x499 * var_x501 * var_x522;
        const double var_x536 = 0.66666666666666663 * var_x519 * var_x523 * var_x524 * var_x525 * var_x527 * var_x528 * var_x530 * var_x533;
        const double var_x537 = var_x507 * var_x508;
        const double var_x538 = var_x537 / pow((var_x512 + 0.00060803092942449902 * var_x509), 2);
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.011725000000000001 + var_x36 + var_x55 + var_x85 - var_x39 - var_x74 + 0.021094680534898786 * var_x97 + 0.10817476552906598 * var_x76 + 0.00021581774391079108 * var_x78 - 0.61875000000000002 * var_x93 - 0.0027599999999999999 * var_x2 - 0.0010817476552906597 * var_x94 - 0.00021581774391079108 * var_x83 - 0.0028824983370007683 * var_x34 - 0.0065699975556193606 * var_x96 - 0.00046153846153846147 * var_x47 + var_x109 * var_x114 + var_x6 * (0.10468673984798647 * var_x20 - var_x22 * var_x24) - var_x104 * var_x105 - var_x114 * var_x115 - var_x26 * var_chaste_interface__i_Na_L_h_L_gate__h_L - var_x44 * var_x46 - var_x82 * var_chaste_interface__i_Kr_xr_gate__xr - 0.13 * var_chaste_interface__i_Ca_T_b_gate__b * var_chaste_interface__i_Ca_T_g_gate__g);
        IJth(rJacobian, 1, 0) = -var_x171 * (var_x165 + 7.3024973629237739e-13 * var_x83 - 7.3024973629237739e-13 * var_x78 - 6.767281717060562e-9 * var_x74 - 4.446102433927548e-11 * var_x96);
        IJth(rJacobian, 2, 0) = var_x224 + var_x222 * (var_x219 - var_chaste_interface__i_Na_m_gate__m);
        IJth(rJacobian, 3, 0) = (var_x229 + var_x235) * (var_x236 * var_x240 + var_x228 * var_x239 * (-var_x236 - var_x241) / pow(var_x237, 2)) + (var_x236 + var_x241) * (var_x238 - var_chaste_interface__i_Na_h_gate__h + var_x228 * var_x240);
        IJth(rJacobian, 4, 0) = (var_x251 + var_x261) * (var_x262 * var_x264 + var_x239 * var_x260 * (-var_x262 - var_x265) / pow(var_x263, 2)) + (var_x262 + var_x265) * (var_x238 - var_chaste_interface__i_Na_j_gate__j + var_x260 * var_x264);
        IJth(rJacobian, 5, 0) = var_x224 + var_x222 * (var_x219 - var_chaste_interface__i_Na_L_m_L_gate__m_L);
        IJth(rJacobian, 6, 0) = -0.16393442622950821 * var_x267 * var_x272 / pow(var_x268, 2) - 0.00068027210884353737 * var_x269 * (-var_chaste_interface__i_Na_L_h_L_gate__h_L + 1 / var_x268) / (pow(var_x270, 2) * pow((1 + 0.7142857142857143 * var_x271), 2));
        IJth(rJacobian, 7, 0) = 1.5624999999999998 * (-var_chaste_interface__i_Ca_L_d_gate__d + 1 / var_x278) * (-0.041599999999999998 * var_x276 + 0.10560000000000001 * var_x273 * var_x275 / pow(var_x274, 2)) / pow((0.73749999999999993 + var_x276), 2) + 0.14836795252225518 * var_x277 * var_x279 / pow(var_x278, 2);
        IJth(rJacobian, 8, 0) = -var_x285 * var_x286 + 0.0625 * (0.025000000000000001 - 0.01 * var_chaste_interface__membrane__V) * (var_x284 - var_chaste_interface__i_Ca_L_f_gate__f) / pow((1 + 0.0078125 * var_x280), 2);
        IJth(rJacobian, 9, 0) = -var_x286 * var_x288 + 0.0006925207756232687 * (2.6040000000000005 - 0.14000000000000001 * var_chaste_interface__membrane__V) * (var_x284 - var_chaste_interface__i_Ca_L_f2_gate__f2) / pow((1 + 0.63729473684210547 * var_x287), 2);
        IJth(rJacobian, 10, 0) = 6.0846129416040608e-5 * var_x297 * (70.217303721666525 * var_x289 + var_x115 * var_x290 - var_x109 * var_x290);
        IJth(rJacobian, 11, 0) = 8.1128172554720803e-6 * var_x315 * (351.0865186083326 * var_x289 + var_x115 * var_x309 - var_x109 * var_x309) + 0.0033333333333333335 * var_x317 * (-87.771629652083149 * var_x289 + var_x109 * var_x316 - var_x115 * var_x316);
        IJth(rJacobian, 12, 0) = (-var_chaste_interface__i_Ca_T_b_gate__b + 1 / var_x323) * (0.0356 * var_x325 - 0.0356 * var_x326) + 0.16393442622950821 * var_x322 * (var_x327 + var_x328) / pow(var_x323, 2);
        IJth(rJacobian, 13, 0) = (-var_chaste_interface__i_Ca_T_g_gate__g + 1 / var_x330) * (0.00097402597402597392 * var_x331 - 0.0001800720288115246 * var_x332) - 0.15151515151515152 * var_x329 * (var_x333 + var_x334) / pow(var_x330, 2);
        IJth(rJacobian, 14, 0) = var_x344 * (var_x345 * var_x347 - var_x345 * var_x349 + 0.040000000000000001 * var_x342 * (var_x348 + var_x349 - var_x346 - var_x347) / pow((var_x338 + var_x342), 2)) + (-var_chaste_interface__i_to_1_a_gate__a + var_x343 * var_x345) * (var_x346 + var_x347 - var_x348 - var_x349);
        IJth(rJacobian, 15, 0) = var_x353 * (-var_x361 * var_x363 + 2.9999999999999996 * var_x357 * (var_x361 - 0.0066666666666666671 * var_x360 + 0.0066666666666666671 * pow(var_x358, 2) / pow(var_x359, 2)) / pow((var_x360 + 0.29999999999999999 * var_x357), 2)) + 0.013888888888888888 * var_x350 * (-var_chaste_interface__i_to_1_i_gate__i + var_x362 * var_x363) / (pow(var_x351, 2) * pow((1 + 0.83333333333333337 * var_x352), 2));
        IJth(rJacobian, 16, 0) = var_x367 * (-var_x374 * var_x376 + 1.768 * var_x370 * (var_x374 - 0.0033333333333333335 * var_x373 + 0.0033333333333333335 * pow(var_x371, 2) / pow(var_x372, 2)) / pow((var_x373 + 0.088400000000000006 * var_x370), 2)) + 0.0033333333333333335 * var_x364 * (-var_chaste_interface__i_to_1_i2_gate__i2 + var_x375 * var_x376) / (pow(var_x365, 2) * pow((0.71666666666666667 + var_x366), 2));
        IJth(rJacobian, 17, 0) = 0.081632653061224483 * var_x377 * var_x382 / pow(var_x378, 2) + 0.00022222222222222223 * var_x379 * (-var_chaste_interface__i_Kr_xr_gate__xr + 1 / var_x378) / (pow(var_x380, 2) * pow((0.1111111111111111 + var_x381), 2));
        IJth(rJacobian, 18, 0) = var_x400 * (var_x398 + var_x399) + (var_x385 - var_chaste_interface__i_Ks_xs1_gate__xs1) * (var_x389 + var_x393 - 4.6080000000000006e-5 * var_x395 - 0.00075871700000000012 * var_x397);
        IJth(rJacobian, 19, 0) = var_x400 * (var_x403 + var_x404) + (var_x385 - var_chaste_interface__i_Ks_xs2_gate__xs2) * (var_x401 + var_x402 - 2.3040000000000003e-5 * var_x395 - 0.00037935850000000006 * var_x397);
        IJth(rJacobian, 21, 0) = (-1.6918204292651404e-11 - 2.5292715417513851e-10 * var_x147 - 2.0301845151181685e-8 * var_x74 - 1.2561766687293667e-8 * var_x93 - 6.767281717060562e-9 * var_x39 - 1.3338307301782643e-10 * var_x96) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 0) = (-1.5226383863386264e-12 + 7.3204911301216128e-10 * var_x76 - 7.3204911301216118e-12 * var_x94 - var_x415 * var_x44) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 0) = (-6.0905535453545056e-11 + var_x423 + var_x426 + var_x427 + 1.4275364591105386e-10 * var_x97 + 8.3745111248624455e-9 * var_x93 - 3.1233607924894898e-12 * var_x47 - 1.8677697539087149e-11 * var_x2 - 2.9121743765854985e-9 * var_x161 + var_x6 * (7.0844466059195419e-10 * var_x20 - var_x22 * var_x421)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 26, 0) = var_x438 * var_x446;
        IJth(rJacobian, 27, 0) = var_x462 * (-0.23999999999999996 * var_x446 - 4.0390323434238405e-7 * var_x289 + var_x109 * var_x454 - var_x115 * var_x454);
        IJth(rJacobian, 28, 0) = 80.0 * var_x478 * var_x481 - 0.14999999999999999 * var_x481 * var_x484;
        IJth(rJacobian, 29, 0) = var_x518 * var_x520 - var_x517 * var_x520 + var_x503 * var_x515 * (-123.26174354851909 + 8.2174495699012731 * var_chaste_interface__membrane__V) + 0.00012018988526625304 * var_x507 * var_x519 * (var_x516 * var_x517 - var_x503 * (-369.78523064555725 + 24.652348709703816 * var_chaste_interface__membrane__V) - var_x516 * var_x518);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.057500000000000002 * var_x119 - 0.057500000000000002 * var_x117 - 5.4447296618926212e-7 * var_x130 - 0.0028824983370007683 * var_x120 - 1.388888888888889e-8 * var_x126 + var_x121 * var_x67 - var_x122 * var_x125);
        IJth(rJacobian, 1, 1) = -var_x171 * (0.14705882352941174 + var_x172 + var_x187 - var_x190 + 1.0150922575590843e-8 * var_x191 + 9.753339147721386e-12 * var_x120 - 1.9455934936549115e-10 * var_x119 - 9.3990023848063356e-17 * var_x126 - var_x122 * var_x192) - (-var_x166 - var_x168 + 0.28000000000000003 * var_chaste_interface__Ca_i__Ca_i / pow(var_x116, 3) + 0.20000000000000001 * var_chaste_interface__Ca_i__Ca_i / pow(var_x167, 3)) * (0.14705882352941174 * var_chaste_interface__Ca_i__Ca_i - 0.14705882352941174 * var_chaste_interface__Ca_r__Ca_r + var_x165 * var_chaste_interface__membrane__V + var_x172 * var_chaste_interface__Ca_i__Ca_i + var_x187 * var_chaste_interface__Ca_i__Ca_i - var_x193 * var_chaste_interface__Ca_NSR__Ca_NSR - 6.767281717060562e-9 * var_x73 * var_x95) / pow(var_x169, 2);
        IJth(rJacobian, 21, 1) = (3.045276772677253e-8 * var_x191 - 2.8197007154419011e-16 * var_x126 - var_x122 * var_x405) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 1) = -3.6846019495263273e-15 * var_x130 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 25, 1) = -var_x433 + 0.5 * var_x186;
        IJth(rJacobian, 27, 1) = 5.0 * var_x461;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x133 * var_x134);
        IJth(rJacobian, 2, 2) = var_x225;
        IJth(rJacobian, 21, 2) = -2.0301845151181685e-8 * var_x134 * var_x406;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.80000000000000004 * var_x135);
        IJth(rJacobian, 3, 3) = -var_x229 - var_x235;
        IJth(rJacobian, 21, 3) = -5.4138253736484496e-9 * var_x407;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.20000000000000001 * var_x135);
        IJth(rJacobian, 4, 4) = -var_x251 - var_x261;
        IJth(rJacobian, 21, 4) = -1.3534563434121124e-9 * var_x407;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-0.112125 * var_x136);
        IJth(rJacobian, 5, 5) = var_x225;
        IJth(rJacobian, 21, 5) = -7.5878146252541542e-10 * var_x136 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x133 * var_x26);
        IJth(rJacobian, 6, 6) = -var_x272;
        IJth(rJacobian, 21, 6) = -2.5292715417513851e-10 * var_x25 * var_x406;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x137 * var_x138);
        IJth(rJacobian, 7, 7) = -var_x279;
        IJth(rJacobian, 10, 7) = var_x298 * var_x299;
        IJth(rJacobian, 11, 7) = var_x298 * var_x318 - var_x298 * var_x319;
        IJth(rJacobian, 27, 7) = -var_x298 * var_x463;
        IJth(rJacobian, 28, 7) = var_x485 * var_x486 - var_x485 * var_x487;
        IJth(rJacobian, 29, 7) = var_x502 * var_x522 * var_chaste_interface__i_Ca_L_d_gate__d - var_x523 * var_x531 * pow(var_chaste_interface__i_Ca_L_d_gate__d, 3);
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x140 * var_chaste_interface__i_Ca_L_f2_gate__f2);
        IJth(rJacobian, 8, 8) = -var_x285;
        IJth(rJacobian, 10, 8) = var_x301 * var_chaste_interface__i_Ca_L_f2_gate__f2;
        IJth(rJacobian, 11, 8) = var_x320 * var_chaste_interface__i_Ca_L_f2_gate__f2 - var_x321 * var_chaste_interface__i_Ca_L_f2_gate__f2;
        IJth(rJacobian, 27, 8) = -var_x464 * var_chaste_interface__i_Ca_L_f2_gate__f2;
        IJth(rJacobian, 28, 8) = var_x489 * var_chaste_interface__i_Ca_L_f2_gate__f2 - var_x491 * var_chaste_interface__i_Ca_L_f2_gate__f2;
        IJth(rJacobian, 29, 8) = var_x496 * var_x532 * var_chaste_interface__i_Ca_L_f_gate__f - var_x531 * var_x533 * pow(var_chaste_interface__i_Ca_L_f_gate__f, 3);
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x140 * var_chaste_interface__i_Ca_L_f_gate__f);
        IJth(rJacobian, 9, 9) = -var_x288;
        IJth(rJacobian, 10, 9) = var_x301 * var_chaste_interface__i_Ca_L_f_gate__f;
        IJth(rJacobian, 11, 9) = var_x320 * var_chaste_interface__i_Ca_L_f_gate__f - var_x321 * var_chaste_interface__i_Ca_L_f_gate__f;
        IJth(rJacobian, 27, 9) = -var_x464 * var_chaste_interface__i_Ca_L_f_gate__f;
        IJth(rJacobian, 28, 9) = var_x489 * var_chaste_interface__i_Ca_L_f_gate__f - var_x491 * var_chaste_interface__i_Ca_L_f_gate__f;
        IJth(rJacobian, 29, 9) = var_x499 * var_x532 * var_chaste_interface__i_Ca_L_f2_gate__f2 - var_x530 * var_x534 * pow(var_chaste_interface__i_Ca_L_f2_gate__f2, 3);
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-3.510865186083326 * var_x141);
        IJth(rJacobian, 10, 10) = var_x293 * (-1 + var_x141 * var_x302);
        IJth(rJacobian, 11, 10) = var_x141 * var_x318 - var_x141 * var_x319;
        IJth(rJacobian, 27, 10) = -var_x141 * var_x463;
        IJth(rJacobian, 28, 10) = var_x141 * var_x488 - var_x141 * var_x490;
        IJth(rJacobian, 29, 10) = var_x497 * var_x535 * var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca - var_x528 * var_x534 * pow(var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca, 3);
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x105 * var_x142);
        IJth(rJacobian, 10, 11) = var_x299 * var_x303;
        IJth(rJacobian, 11, 11) = var_x313 * (-1 + 0.0028483007663293006 * var_x303 * var_x314) - var_x303 * var_x319;
        IJth(rJacobian, 27, 11) = -var_x303 * var_x463;
        IJth(rJacobian, 28, 11) = var_x303 * var_x488 - var_x303 * var_x490;
        IJth(rJacobian, 29, 11) = var_x498 * var_x535 * var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2 - var_x526 * var_x536 * pow(var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2, 3);
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x143 * var_chaste_interface__i_Ca_T_g_gate__g);
        IJth(rJacobian, 12, 12) = -var_x327 - var_x328;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x143 * var_chaste_interface__i_Ca_T_b_gate__b);
        IJth(rJacobian, 13, 13) = -var_x333 - var_x334;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x35 * var_x6);
        IJth(rJacobian, 14, 14) = -var_x339 - var_x343;
        IJth(rJacobian, 23, 14) = var_x422 * var_x428 * NV_Ith_S(mParameters, 15);
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (var_x144 * (21.369870964398611 * var_x4 - 0.80000000000000004 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 15, 15) = -var_x353;
        IJth(rJacobian, 23, 15) = var_x429 * (1.4461593707331807e-7 * var_x4 - 5.4138253736484496e-9 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x144 * (5.3424677410996528 * var_x4 - 0.20000000000000001 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 16, 16) = -var_x367;
        IJth(rJacobian, 23, 16) = var_x429 * (3.6153984268329518e-8 * var_x4 - 1.3534563434121124e-9 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x6 * var_x82);
        IJth(rJacobian, 17, 17) = -var_x382;
        IJth(rJacobian, 23, 17) = -2.9121743765854985e-9 * var_x428 * var_x81;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x128 * var_x54);
        IJth(rJacobian, 18, 18) = -var_x398 - var_x399;
        IJth(rJacobian, 23, 18) = var_x128 * var_x425 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x145 * var_x52);
        IJth(rJacobian, 19, 19) = -var_x403 - var_x404;
        IJth(rJacobian, 23, 19) = var_x145 * var_x424 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x146 * var_x46);
        IJth(rJacobian, 20, 20) = -1.0;
        IJth(rJacobian, 22, 20) = -var_x146 * var_x415 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (0.48963716847178318 * var_x150 - 1.2000000000000002 * var_x154 - 0.066780846763745655 * var_x131 - 0.012375000000000001 * var_x153 - 26.712338705498265 * var_x149 - 0.99837365911799758 * var_x148 - var_x125 * var_x152);
        IJth(rJacobian, 1, 21) = -var_x171 * (-8.1207380604726744e-9 * var_x154 - var_x152 * var_x192);
        IJth(rJacobian, 21, 21) = (var_x413 - 2.5123533374587338e-10 * var_x153 - 2.4362214181418025e-8 * var_x154 - 4.5192480335411901e-10 * var_x131 - 6.7562758101440786e-9 * var_x148 - 1.8076992134164759e-7 * var_x149 - var_x152 * var_x405) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 21) = var_x413 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 21) = (1.6749022249724892e-10 * var_x153 + 0.48963716847178318 * var_x430) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (0.0060102762087371094 * var_x155 - 0.028896009762002683 * var_x75);
        IJth(rJacobian, 21, 22) = var_x414 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 22) = (var_x414 + var_x419 + 4.0673232301870709e-11 * var_x155 - 1.9554743855840427e-10 * var_x75) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 22) = var_x419 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (26.712338705498265 * var_x150 - 0.13356169352749131 * var_x3 - 11.495160327182951 * var_x162 - 0.073726054827175203 * var_x160 + var_x159 * var_x36 + var_x159 * (-0.0040000000000000001 + var_x85) + var_x6 * (2.7964276527937963 * var_x158 - var_x157 * var_x24));
        IJth(rJacobian, 22, 23) = var_x420 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 23) = (var_x420 + 26.712338705498265 * var_x430 - 9.0384960670823802e-10 * var_x3 - 4.9892498290294737e-10 * var_x160 - 7.7790988316825085e-8 * var_x162 + var_x159 * var_x423 + var_x159 * (-2.7069126868242249e-11 + var_x427) + var_x6 * (1.892421372783404e-8 * var_x158 - var_x157 * var_x421)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 1, 24) = -var_x171 * (var_x190 * var_x201 + var_x198 * var_x200);
        IJth(rJacobian, 10, 24) = var_x304 * var_x305;
        IJth(rJacobian, 24, 24) = -0.00068000000000000005 - var_x181 * var_x431 + var_x173 * var_x194 * var_x431;
        IJth(rJacobian, 25, 24) = var_x198 * var_x434 + var_x201 * var_x433;
        IJth(rJacobian, 28, 24) = var_x492 * (var_x304 - var_x304 * var_x474);
        IJth(rJacobian, 1, 25) = var_x170 * var_x193;
        IJth(rJacobian, 25, 25) = -0.00072463768115942019 - 0.066666666666666666 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 26, 25) = 0.0083333333333333332 * var_x437;
        IJth(rJacobian, 25, 26) = 0.00072463768115942019;
        IJth(rJacobian, 26, 26) = var_x437 * (-0.0083333333333333332 - var_x450) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca_NSR__Ca_NSR - 0.0083333333333333332 * var_chaste_interface__Ca_JSR__Ca_JSR - var_x443 * var_x450) / (pow(var_x435, 3) * pow((0.125 + var_x436), 2));
        IJth(rJacobian, 27, 26) = var_x461 * var_x465;
        IJth(rJacobian, 29, 26) = -0.00064937342883524983 * var_x538 * pow(var_chaste_interface__Ca_JSR__Ca_JSR, 2.7999999999999998) + 1756.479845566397 * var_x513 * var_x537 * pow(var_chaste_interface__Ca_JSR__Ca_JSR, 0.89999999999999991);
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x138 * var_x164);
        IJth(rJacobian, 1, 27) = -var_x171 * (-0.14705882352941174 + var_x190 * var_x207 + var_x200 * var_x206);
        IJth(rJacobian, 10, 27) = var_x293 * (-0.0016500000000000002 * var_x306 + var_x302 * var_x307) + var_x305 * (var_x308 + 0.0030000000000000001 * var_x306);
        IJth(rJacobian, 11, 27) = var_x307 * var_x318 - var_x307 * var_x319;
        IJth(rJacobian, 20, 27) = 0.1502 * var_x202 / pow((1.0 + 0.1502 * var_x174), 2);
        IJth(rJacobian, 24, 27) = 0.00037500000000000001 * var_x181 * var_x203 + 1.8750000000000002e-5 * var_x202 * pow(var_x173, 2) / pow(var_x175, 3);
        IJth(rJacobian, 25, 27) = var_x206 * var_x434 + var_x207 * var_x433;
        IJth(rJacobian, 26, 27) = var_x437 * (var_x450 + 0.70217303721666524 * var_x451);
        IJth(rJacobian, 27, 27) = var_x462 * (-5.0 - var_x465 - 0.16852152893199965 * var_x451 - 4.0390323434238405e-7 * var_x307) + 0.19788249895518037 * (-var_x460 - 2.2480000000000002 * var_x456 + 4.4960000000000004 * var_chaste_interface__Ca_r__Ca_r / pow(var_x455, 3) + 0.188 * var_chaste_interface__Ca_r__Ca_r / pow(var_x458, 3)) * (5.0 * var_chaste_interface__Ca_i__Ca_i - 5.0 * var_chaste_interface__Ca_r__Ca_r - 4.0390323434238405e-7 * var_x294 + var_x443 * var_x465) / pow((0.44483985765124551 + var_x457 + 0.041814946619217079 * var_x459 * var_chaste_interface__Ca_r__Ca_r), 2);
        IJth(rJacobian, 28, 27) = var_x492 * (var_x308 + var_x483 * (5000.0 - 3510.8651860833261 * var_x493) - var_x308 * var_x474) - var_x478 * (40000.0 - 18724.61432577774 * var_x493);
        IJth(rJacobian, 29, 27) = var_x108 * var_x506 * var_x521 - var_x529 * var_x536 * var_x98 * pow(var_x100, 3) - 0.56210214369217726 * var_x174 * var_x509 * var_x510 * var_x512 * var_x538 * (1.8999999999999999 * var_x511 - 1.8999999999999999 * var_chaste_interface__Ca_r__Ca_r / pow(var_x510, 2));
        IJth(rJacobian, 26, 28) = -var_x438 * var_x452;
        IJth(rJacobian, 27, 28) = var_x452 * var_x466;
        IJth(rJacobian, 28, 28) = -var_x477;
        IJth(rJacobian, 26, 29) = -var_x438 * var_x453;
        IJth(rJacobian, 27, 29) = var_x453 * var_x466;
