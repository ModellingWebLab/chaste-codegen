...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_Purkinje_model_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x131 = ((var_x120) ? (1.7554325942090168 * var_x115 + 1.7554325918743094 * var_x118) : (var_x126 - var_x128 * var_x130 + var_x124 * var_x128 * var_chaste_interface__Ca_r__Ca_r)) * NV_Ith_S(mParameters, 7);
        ...
        const double var_x159 = ((var_x120) ? (var_x157 - 374358.83507888648 * var_x158) : (var_x119 * var_x126)) * NV_Ith_S(mParameters, 7);
        ...
        const double var_x169 = var_x149 * NV_Ith_S(mParameters, 13);
        const double var_x170 = 3.8593999999999993e-9 * var_x45;
        const double var_x171 = var_x170 * var_x46;
        const double var_x172 = 3.8593999999999993e-9 * var_x47;
        const double var_x173 = ((var_x49) ? (var_x171 - 187179.41753901311 * (-2.6712338705498262e-6 + var_chaste_interface__membrane__V) * (-var_x171 - var_x172 * var_x48)) : (var_x56 * var_chaste_interface__membrane__V));
        ...
        const double var_x177 = var_x147 * var_x75;
        const double var_x178 = var_x101 * NV_Ith_S(mParameters, 4);
        ...
        const double var_x194 = ((var_x120) ? (var_x192 + var_x193 * (5615383.0261832969 - 374358.83507888648 * var_chaste_interface__membrane__V)) : (var_x125 * var_x127)) * NV_Ith_S(mParameters, 7);
        ...
        const double var_x254 = ((var_x245) ? (0.15999999943156581 * var_x243 + 0.16000000056843419 * var_x241) : (var_x249 - 0.032000000000000001 * var_x244 * var_x247 / pow(var_x248, 2)));
        ...
        const double var_x422 = var_x414 * var_x418 / pow(var_x419, 2);
        const double var_x423 = var_x421 - 4.6080000000000006e-5 * var_x422;
        ...
        const double var_x432 = 0.072992700729927015 * var_x402 / pow(var_x403, 2);
        const double var_x433 = 3.8050000000000003e-5 * var_x409;
        const double var_x434 = var_x433 - 0.00037935850000000006 * var_x412;
        const double var_x435 = 0.00018000000000000001 * var_x420;
        const double var_x436 = var_x435 - 2.3040000000000003e-5 * var_x422;
        ...
        const double var_x441 = var_x153 * NV_Ith_S(mParameters, 3);
        const double var_x442 = var_x155 * NV_Ith_S(mParameters, 3);
        ...
        const double var_x463 = var_x26 * NV_Ith_S(mParameters, 3);
        const double var_x464 = var_x168 * NV_Ith_S(mParameters, 3);
        const double var_x465 = var_x147 * var_x461;
        const double var_x466 = 0.0025000000000000005 * var_x206;
        const double var_x467 = 0.5 * var_chaste_interface__Ca_i__Ca_i;
        const double var_x468 = var_x219 * var_x467;
        const double var_x469 = var_x230 * var_x467;
        ...
        const double var_x476 = var_x475 * NV_Ith_S(mParameters, 1) * var_chaste_interface__q_rel_ri_gate__ri;
        const double var_x477 = var_x473 * var_x476 * var_chaste_interface__q_rel_ro_gate__ro / pow(var_x474, 2);
        const double var_x478 = var_x131 * var_x477;
        const double var_x479 = 1 / var_x474;
        const double var_x480 = var_x479 * NV_Ith_S(mParameters, 1) * var_chaste_interface__q_rel_ro_gate__ro;
        ...
        const double var_x484 = var_x475 * var_x480;
        const double var_x485 = var_x472;
        const double var_x486 = var_x476 * var_x479;
        ...
        const double var_x495 = 1.1504378919002956e-7 * var_x493;
        const double var_x496 = 0.23999999999999996 * var_x481;
        const double var_x497 = 0.23999999999999996 * var_x493;
        ...
        const double var_x502 = exp(-16.0 + 80.0 * var_x501 + 40000.0 * var_chaste_interface__Ca_r__Ca_r);
        ...
        const double var_x510 = var_x502 * var_x509 / pow(var_x503, 2);
        const double var_x511 = 5333.333333333333 * var_x510;
        const double var_x512 = var_x500 * var_x511;
        const double var_x513 = (-var_chaste_interface__q_rel_ri_gate__ri + 1 / var_x503) / pow((0.29999999999999999 + var_x212 + 0.10000000000000001 * var_x508), 2);
        const double var_x514 = var_x504 * var_x507 / pow(var_x505, 2);
        const double var_x515 = 10.0 * var_x513 * var_x514;
        const double var_x516 = var_x500 * var_x515;
        const double var_x517 = var_x161 * var_x500;
        const double var_x518 = 0.01 * var_x513;
        const double var_x519 = var_x195 * var_x500;
        const double var_x520 = -var_x158 + 1.2525872391612789e-11 * var_x118;
        const double var_x521 = 140144537401.62091 * var_x520;
        const double var_x522 = pow(var_x122, 2);
        const double var_x523 = var_x129 * var_x522;
        const double var_x524 = -1 + var_x373;
        const double var_x525 = pow(var_x524, 2);
        const double var_x526 = var_x121 * var_x525;
        const double var_x527 = 415.29710452059015 * var_x526;
        const double var_x528 = 0.33333333333333331 * ((var_x120) ? (var_x521 * (9.3783419937418982e-6 * var_x118 + 9.3783420062149971e-6 * var_x115)) : (var_x523 * (-369.78523064555725 + 24.652348709703816 * var_chaste_interface__membrane__V) + var_x130 * var_x527 * var_chaste_interface__Ca_r__Ca_r - var_x522 * var_x527 / pow(var_x123, 3)));
        const double var_x529 = pow(NV_Ith_S(mParameters, 7), 2);
        const double var_x530 = pow(var_chaste_interface__i_Ca_L_d_gate__d, 2);
        const double var_x531 = pow(var_chaste_interface__i_Ca_L_f2_gate__f2, 2);
        const double var_x532 = pow(var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2, 2);
        const double var_x533 = pow(var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca, 2);
        const double var_x534 = pow(var_chaste_interface__i_Ca_L_f_gate__f, 2);
        const double var_x535 = var_x529 * var_x530 * var_x531 * var_x532 * var_x533 * var_x534;
        const double var_x536 = ((var_x120) ? (140144537401.62091 * pow(var_x520, 2)) : (2773.3892298416795 * var_x523 * var_x525));
        const double var_x537 = var_x535 * var_x536;
        const double var_x538 = 1.0 + var_x537;
        const double var_x539 = 1 / var_x538;
        const double var_x540 = pow(var_chaste_interface__Ca_JSR__Ca_JSR, 1.8999999999999999);
        const double var_x541 = 0.0028 + var_chaste_interface__Ca_r__Ca_r;
        const double var_x542 = 1 / var_x541;
        const double var_x543 = pow((var_x542 * var_chaste_interface__Ca_r__Ca_r), 1.8999999999999999);
        const double var_x544 = 1 / (var_x540 + 1644.6531773416521 * var_x543);
        const double var_x545 = var_x540 * var_x544;
        const double var_x546 = var_x539 * var_x545;
        const double var_x547 = var_x535 * var_x546;
        const double var_x548 = pow(var_chaste_interface__i_Ca_L_d_gate__d, 4);
        const double var_x549 = pow(var_x538, (-2));
        const double var_x550 = pow(NV_Ith_S(mParameters, 7), 4);
        const double var_x551 = pow(var_chaste_interface__i_Ca_L_f2_gate__f2, 4);
        const double var_x552 = pow(var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2, 4);
        const double var_x553 = pow(var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca, 4);
        const double var_x554 = pow(var_chaste_interface__i_Ca_L_f_gate__f, 4);
        const double var_x555 = var_x545 * var_x549 * var_x550 * var_x551 * var_x552 * var_x553 * var_x554;
        const double var_x556 = var_x536 * var_x548 * var_x555;
        const double var_x557 = 0.66666666666666663 * var_x529 * var_x531 * var_x532 * var_x533 * var_x536 * var_x546;
        const double var_x558 = 0.66666666666666663 * ((var_x120) ? (1.9640491363514324e+22 * pow(var_x520, 4)) : (7691687.8202018235 * pow(var_x122, 4) * pow(var_x524, 4) / pow(var_x123, 4)));
        const double var_x559 = var_x545 * var_x548 * var_x549 * var_x550 * var_x552 * var_x553 * var_x558;
        const double var_x560 = 0.66666666666666663 * var_x529 * var_x530 * var_x532 * var_x534 * var_x536 * var_x546;
        const double var_x561 = var_x545 * var_x548 * var_x549 * var_x550 * var_x551 * var_x554 * var_x558;
        const double var_x562 = var_x537 * var_x539;
        const double var_x563 = var_x562 / pow((var_x543 + 0.00060803092942449902 * var_x540), 2);
        const double var_x564 = 0.33333333333333331 * ((var_x120) ? (var_x521 * (2.5051744783225578e-11 * var_x191 + 2 * var_x193 * (15.000001335616934 - var_chaste_interface__membrane__V))) : (5546.778459683359 * var_x130 * var_x526));
        ...
        IJth(rJacobian, 1, 0) = -var_x201 * (3.383640858530281e-9 * var_x19 - 6.767281717060562e-9 * var_x94 - 4.446102433927548e-11 * var_x110);
        ...
        IJth(rJacobian, 10, 0) = var_x134 * var_x329;
        IJth(rJacobian, 11, 0) = var_x134 * var_x339 - var_x134 * var_x340;
        ...
        IJth(rJacobian, 18, 0) = var_x431 * var_x432 + (var_x404 - var_chaste_interface__i_Ks_xs1_gate__xs1) * ((var_x415) ? (var_x413 + 0.00018000000000000001 * var_x405 + 0.00018000000000000001 * var_x406) : ((var_x424) ? (var_x423 + 3.8049986522476652e-5 * var_x416 + 3.8050013477523354e-5 * var_x417) : (var_x413 + var_x423)));
        IJth(rJacobian, 19, 0) = var_x432 * var_x439 + (var_x404 - var_chaste_interface__i_Ks_xs2_gate__xs2) * ((var_x415) ? (var_x434 + 9.0000000000000006e-5 * var_x405 + 9.0000000000000006e-5 * var_x406) : ((var_x424) ? (var_x436 + 1.9024993261238326e-5 * var_x416 + 1.9025006738761677e-5 * var_x417) : (var_x434 + var_x436)));
        IJth(rJacobian, 21, 0) = (-1.6918204292651404e-11 - 2.5292715417513851e-10 * var_x174 - 2.0301845151181685e-8 * var_x94 - 1.2561766687293667e-8 * var_x108 - 6.767281717060562e-9 * var_x66 - 1.3338307301782643e-10 * var_x110) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 0) = (-1.5226383863386264e-12 - var_x450 * var_x58) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 0) = (-6.0905535453545056e-11 + var_x458 + var_x461 + var_x462 + 1.4275364591105386e-10 * var_x111 + 8.3745111248624455e-9 * var_x108 - 3.1233607924894898e-12 * var_x67 - 1.8677697539087149e-11 * var_x22 - 2.9121743765854985e-9 * var_x189 + var_x26 * (7.0844466059195419e-10 * var_x40 - var_x42 * var_x456)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 26, 0) = 0.20000000000000001 * var_x472 * var_x478;
        IJth(rJacobian, 27, 0) = var_x494 * (-0.047999999999999994 * var_x478 - 1.1504378919002956e-7 * var_x134);
        IJth(rJacobian, 28, 0) = var_x134 * var_x512 - var_x134 * var_x516;
        IJth(rJacobian, 29, 0) = var_x528 * var_x547 - var_x528 * var_x556;
        ...
        IJth(rJacobian, 21, 6) = -2.5292715417513851e-10 * var_x441 * var_x60;
        ...
        IJth(rJacobian, 27, 7) = -var_x161 * var_x495;
        IJth(rJacobian, 28, 7) = var_x511 * var_x517 - var_x515 * var_x517;
        IJth(rJacobian, 29, 7) = var_x534 * var_x557 * var_chaste_interface__i_Ca_L_d_gate__d - var_x555 * var_x558 * pow(var_chaste_interface__i_Ca_L_d_gate__d, 3);
        ...
        IJth(rJacobian, 27, 8) = -var_x162 * var_x495;
        IJth(rJacobian, 28, 8) = var_x162 * var_x512 - var_x162 * var_x516;
        IJth(rJacobian, 29, 8) = var_x530 * var_x557 * var_chaste_interface__i_Ca_L_f_gate__f - var_x551 * var_x559 * pow(var_chaste_interface__i_Ca_L_f_gate__f, 3);
        ...
        IJth(rJacobian, 27, 9) = -var_x164 * var_x495;
        IJth(rJacobian, 28, 9) = var_x164 * var_x512 - var_x164 * var_x516;
        IJth(rJacobian, 29, 9) = var_x533 * var_x560 * var_chaste_interface__i_Ca_L_f2_gate__f2 - var_x554 * var_x559 * pow(var_chaste_interface__i_Ca_L_f2_gate__f2, 3);
        ...
        IJth(rJacobian, 27, 10) = -var_x165 * var_x495;
        IJth(rJacobian, 28, 10) = var_x165 * var_x512 - var_x165 * var_x516;
        IJth(rJacobian, 29, 10) = var_x531 * var_x560 * var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca - var_x552 * var_x561 * pow(var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca, 3);
        ...
        IJth(rJacobian, 27, 11) = -var_x166 * var_x495;
        IJth(rJacobian, 28, 11) = var_x166 * var_x512 - var_x166 * var_x516;
        IJth(rJacobian, 29, 11) = -var_x553 * var_x561 * pow(var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2, 3) + 0.66666666666666663 * var_x529 * var_x530 * var_x531 * var_x533 * var_x534 * var_x536 * var_x546 * var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2;
        ...
        IJth(rJacobian, 23, 14) = var_x457 * var_x463 * NV_Ith_S(mParameters, 15);
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (var_x168 * (21.369870964398611 * var_x24 - 0.80000000000000004 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 15, 15) = -var_x372;
        IJth(rJacobian, 23, 15) = var_x464 * (1.4461593707331807e-7 * var_x24 - 5.4138253736484496e-9 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x168 * (5.3424677410996528 * var_x24 - 0.20000000000000001 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 16, 16) = -var_x386;
        IJth(rJacobian, 23, 16) = var_x464 * (3.6153984268329518e-8 * var_x24 - 1.3534563434121124e-9 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x26 * var_x98);
        IJth(rJacobian, 17, 17) = -var_x401;
        IJth(rJacobian, 23, 17) = -2.9121743765854985e-9 * var_x463 * var_x97;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x148 * var_x74);
        IJth(rJacobian, 18, 18) = -var_x431;
        IJth(rJacobian, 23, 18) = var_x148 * var_x460 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x169 * var_x72);
        IJth(rJacobian, 19, 19) = -var_x439;
        IJth(rJacobian, 23, 19) = var_x169 * var_x459 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-20.0 * var_x173);
        IJth(rJacobian, 20, 20) = -1.0;
        IJth(rJacobian, 22, 20) = -1.3534563434121123e-7 * var_x173 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (0.48963716847178318 * var_x177 - 1.2000000000000002 * var_x181 - 0.066780846763745655 * var_x151 - 0.012375000000000001 * var_x180 - 26.712338705498265 * var_x176 - 0.99837365911799758 * var_x175 - var_x145 * var_x179);
        IJth(rJacobian, 1, 21) = -var_x201 * (-8.1207380604726744e-9 * var_x181 - var_x179 * var_x222);
        IJth(rJacobian, 21, 21) = (var_x448 - 2.5123533374587338e-10 * var_x180 - 2.4362214181418025e-8 * var_x181 - 4.5192480335411901e-10 * var_x151 - 6.7562758101440786e-9 * var_x175 - 1.8076992134164759e-7 * var_x176 - var_x179 * var_x440) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 21) = var_x448 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 21) = (1.6749022249724892e-10 * var_x180 + 0.48963716847178318 * var_x465) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (0.0060102762087371094 * var_x182 - var_x183 * var_x59);
        IJth(rJacobian, 21, 22) = var_x449 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 22) = (var_x449 + var_x454 + 4.0673232301870709e-11 * var_x182 - var_x183 * var_x450) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 22) = var_x454 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (26.712338705498265 * var_x177 - 0.13356169352749131 * var_x23 - 11.495160327182951 * var_x190 - 0.073726054827175203 * var_x188 + var_x187 * var_x63 + var_x187 * (-0.0040000000000000001 + var_x100) + var_x26 * (2.7964276527937963 * var_x186 - var_x185 * var_x44));
        IJth(rJacobian, 22, 23) = var_x455 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 23) = (var_x455 + 26.712338705498265 * var_x465 - 9.0384960670823802e-10 * var_x23 - 4.9892498290294737e-10 * var_x188 - 7.7790988316825085e-8 * var_x190 + var_x187 * var_x458 + var_x187 * (-2.7069126868242249e-11 + var_x462) + var_x26 * (1.892421372783404e-8 * var_x186 - var_x185 * var_x456)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 1, 24) = -var_x201 * (var_x220 * var_x232 + var_x229 * var_x231);
        IJth(rJacobian, 10, 24) = var_x330 * var_x331;
        IJth(rJacobian, 24, 24) = -0.00068000000000000005 - var_x211 * var_x466 + var_x203 * var_x225 * var_x466;
        IJth(rJacobian, 25, 24) = var_x229 * var_x469 + var_x232 * var_x468;
        IJth(rJacobian, 28, 24) = var_x518 * (var_x330 - var_x330 * var_x506);
        ...
        IJth(rJacobian, 26, 25) = 0.0083333333333333332 * var_x472;
        IJth(rJacobian, 25, 26) = 0.00072463768115942019;
        IJth(rJacobian, 26, 26) = var_x472 * (-0.0083333333333333332 - var_x482) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca_NSR__Ca_NSR - 0.0083333333333333332 * var_chaste_interface__Ca_JSR__Ca_JSR - var_x475 * var_x482) / (pow(var_x470, 3) * pow((0.125 + var_x471), 2));
        IJth(rJacobian, 27, 26) = var_x493 * var_x496;
        IJth(rJacobian, 29, 26) = -2.3414435371998602e-7 * var_x563 * pow(var_chaste_interface__Ca_JSR__Ca_JSR, 2.7999999999999998) + 0.6333333333333333 * var_x544 * var_x562 * pow(var_chaste_interface__Ca_JSR__Ca_JSR, 0.89999999999999991);
        ...
        IJth(rJacobian, 25, 27) = var_x237 * var_x469 + var_x238 * var_x468;
        IJth(rJacobian, 26, 27) = var_x472 * (var_x482 + 0.20000000000000001 * var_x483);
        IJth(rJacobian, 27, 27) = var_x494 * (-5.0 - var_x496 - 0.047999999999999994 * var_x483 - 1.1504378919002956e-7 * var_x195) + 0.19788249895518037 * (-var_x492 - 2.2480000000000002 * var_x488 + 4.4960000000000004 * var_chaste_interface__Ca_r__Ca_r / pow(var_x487, 3) + 0.188 * var_chaste_interface__Ca_r__Ca_r / pow(var_x490, 3)) * (5.0 * var_chaste_interface__Ca_i__Ca_i - 5.0 * var_chaste_interface__Ca_r__Ca_r - 1.1504378919002956e-7 * var_x326 + var_x475 * var_x496) / pow((0.44483985765124551 + var_x489 + 0.041814946619217079 * var_x491 * var_chaste_interface__Ca_r__Ca_r), 2);
        IJth(rJacobian, 28, 27) = var_x518 * (var_x333 + var_x514 * (5000.0 - 1000.0 * var_x519) - var_x333 * var_x506) - var_x510 * (40000.0 - 5333.333333333333 * var_x519);
        IJth(rJacobian, 29, 27) = var_x547 * var_x564 - var_x556 * var_x564 - 0.00020267697647483301 * var_x204 * var_x540 * var_x541 * var_x543 * var_x563 * (1.8999999999999999 * var_x542 - 1.8999999999999999 * var_chaste_interface__Ca_r__Ca_r / pow(var_x541, 2));
        IJth(rJacobian, 26, 28) = -var_x484 * var_x485;
        IJth(rJacobian, 27, 28) = var_x484 * var_x497;
        IJth(rJacobian, 28, 28) = -var_x509;
        IJth(rJacobian, 26, 29) = -var_x485 * var_x486;
        IJth(rJacobian, 27, 29) = var_x486 * var_x497;
