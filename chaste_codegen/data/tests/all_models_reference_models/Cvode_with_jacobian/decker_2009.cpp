...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldecker_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x3 = 1806.0006101251679 * NV_Ith_S(mParameters, 9);
        ...
        const double var_x13 = NV_Ith_S(mParameters, 9) / var_x12;
        ...
        const double var_x17 = ((var_x7) ? (var_x1 * var_x3 * (var_x2 + var_x0 * var_chaste_interface__Na__Na_i) + var_x3 * var_x5 * (var_x2 + var_x4 * var_chaste_interface__Na__Na_i)) : (var_x11 * var_x14 + 135.21845691133248 * var_x10 * var_x13 * var_chaste_interface__membrane__Vm - var_x11 * var_x16 * NV_Ith_S(mParameters, 9) / pow(var_x12, 2)));
        const double var_x18 = 7224.0024405006716 * NV_Ith_S(mParameters, 7);
        const double var_x19 = -0.34100000000000003 * NV_Ith_S(mParameters, 3);
        ...
        const double var_x28 = (var_x19 + var_x20 * var_x24) * NV_Ith_S(mParameters, 7);
        const double var_x29 = var_x27 * var_x28;
        const double var_x30 = var_x24 * var_chaste_interface__membrane__Vm;
        const double var_x31 = var_x30 * NV_Ith_S(mParameters, 7);
        ...
        const double var_x36 = 7224.0024405006716 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x41 = var_x27 * NV_Ith_S(mParameters, 6);
        const double var_x42 = var_x40 * var_x41;
        const double var_x43 = ((var_x23) ? (var_x36 * var_x38 + var_x36 * var_x39) : (var_x42 - var_x33 * var_x40 * NV_Ith_S(mParameters, 6) + var_x30 * var_x32 * var_chaste_interface__Ca__Ca_ss_CaL * NV_Ith_S(mParameters, 6)));
        ...
        const double var_x46 = NV_Ith_S(mParameters, 14) / var_x45;
        const double var_x47 = 1 / (1.0 - var_x0);
        const double var_x48 = -100.0 * var_x0 + var_chaste_interface__Cl__Cl_i;
        const double var_x49 = 1806.0006101251679 * NV_Ith_S(mParameters, 19);
        ...
        const double var_x54 = NV_Ith_S(mParameters, 19) / var_x53;
        const double var_x55 = 3612.0012202503358 * var_x54;
        const double var_x56 = var_x52 * var_x55;
        const double var_x57 = ((var_x7) ? (var_x47 * var_x48 * var_x49 + var_x49 * var_x50 * var_x51) : (var_x56 - 13521.845691133247 * var_x15 * var_x54 + var_x16 * var_x52 * NV_Ith_S(mParameters, 19) / pow(var_x53, 2)));
        ...
        const double var_x67 = (-1.0 - 0.59999999999999998 * var_x66) * NV_Ith_S(mParameters, 16);
        const double var_x68 = var_x62 * var_x67;
        const double var_x69 = pow(var_chaste_interface__INaL_mL_gate__mL, 3) * NV_Ith_S(mParameters, 13);
        ...
        const double var_x72 = var_x71 * NV_Ith_S(mParameters, 11) * var_chaste_interface__INa_j_gate__j;
        ...
        const double var_x76 = sqrt(NV_Ith_S(mParameters, 4));
        const double var_x77 = var_x76 * NV_Ith_S(mParameters, 15) / var_x75;
        const double var_x78 = 0.43033148291193518 * var_x77;
        const double var_x79 = 1 / var_chaste_interface__K__K_i;
        const double var_x80 = log(var_x79 * NV_Ith_S(mParameters, 4));
        const double var_x81 = 26.712338705498265 * var_x80;
        const double var_x82 = -var_x81 + var_chaste_interface__membrane__Vm;
        const double var_x83 = var_x44 * var_x82 * NV_Ith_S(mParameters, 14) / pow(var_x45, 2);
        ...
        const double var_x94 = var_x76 * NV_Ith_S(mParameters, 12) / (var_x93 + 1.02 * var_x86);
        ...
        const double var_x98 = var_x96 * var_x97 * NV_Ith_S(mParameters, 20) * var_chaste_interface__Ito1_i1s_gate__i1s;
        ...
        const double var_x102 = var_x101 * NV_Ith_S(mParameters, 3);
        ...
        const double var_x109 = NV_Ith_S(mParameters, 17) / var_x108;
        ...
        const double var_x116 = 1860.8670000000004 * NV_Ith_S(mParameters, 3);
        ...
        const double var_x122 = var_x121 * NV_Ith_S(mParameters, 3);
        ...
        const double var_x138 = var_x137 * var_x74 * NV_Ith_S(mParameters, 15) * var_chaste_interface__IKr_xr_gate__xr / pow(var_x75, 2);
        ...
        const double var_x141 = var_x137 * var_x86 * NV_Ith_S(mParameters, 12) / pow((var_x86 + 0.98039215686274506 * var_x93), 2);
        const double var_x142 = 0.42189361069797565 * var_x141;
        const double var_x143 = var_x103 - var_x107;
        const double var_x144 = var_x104 * NV_Ith_S(mParameters, 17) / pow(var_x108, 2);
        ...
        const double var_x149 = 1 / (1.5 + NV_Ith_S(mParameters, 4));
        ...
        const double var_x154 = var_x121 * var_x149 * var_x151 * var_x152 * NV_Ith_S(mParameters, 18) * NV_Ith_S(mParameters, 4) / pow(var_x153, 2);
        const double var_x155 = 0.5 - 374358.83507802623 * var_chaste_interface__membrane__Vm;
        const double var_x156 = 0.019296999999999998 * NV_Ith_S(mParameters, 7);
        ...
        const double var_x162 = NV_Ith_S(mParameters, 10) / var_x161;
        const double var_x163 = pow(var_x161, (-2));
        const double var_x164 = var_x163 * var_chaste_interface__Ca__Ca_i * NV_Ith_S(mParameters, 10);
        const double var_x165 = var_x104 * var_x105;
        const double var_x166 = var_x132 * var_x165;
        ...
        const double var_x169 = -669921.875 - var_x105 - 516907.50000000012 * NV_Ith_S(mParameters, 3);
        const double var_x170 = 0.0027777373294460648 * NV_Ith_S(mParameters, 3);
        ...
        const double var_x173 = 1.7825497879284993e-12 * var_x172;
        const double var_x174 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
        const double var_x175 = -26.712338705498265 * log(var_x174 * (0.018329999999999999 * NV_Ith_S(mParameters, 5) + NV_Ith_S(mParameters, 4))) + var_chaste_interface__membrane__Vm;
        const double var_x176 = var_x175 * var_x62 * var_x63 * var_x64 * NV_Ith_S(mParameters, 16) / pow(var_x65, 2);
        const double var_x177 = -var_x175 * var_x67;
        const double var_x178 = 0.019296999999999998 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x184 = log(var_x183 * NV_Ith_S(mParameters, 5));
        const double var_x185 = -26.712338705498265 * var_x184 + var_chaste_interface__membrane__Vm;
        const double var_x186 = var_x185 * NV_Ith_S(mParameters, 11) * var_chaste_interface__INa_h_gate__h;
        const double var_x187 = var_x186 * pow(var_chaste_interface__INa_m_gate__m, 2) * var_chaste_interface__INa_j_gate__j;
        const double var_x188 = var_x185 * var_x72;
        const double var_x189 = var_x186 * var_x71;
        const double var_x190 = var_x185 * pow(var_chaste_interface__INaL_mL_gate__mL, 2) * NV_Ith_S(mParameters, 13) * var_chaste_interface__INaL_hL_gate__hL;
        const double var_x191 = var_x185 * var_x69;
        const double var_x192 = var_x82 * var_x97 * NV_Ith_S(mParameters, 20) * var_chaste_interface__Ito1_i1f_gate__i1f;
        const double var_x193 = var_x192 * pow(var_chaste_interface__Ito1_a_gate__a, 2) * var_chaste_interface__Ito1_i1s_gate__i1s;
        const double var_x194 = var_x82 * var_x98;
        const double var_x195 = var_x192 * var_x96;
        const double var_x196 = 0.0096484999999999991 * NV_Ith_S(mParameters, 19);
        const double var_x197 = var_x196 * var_x47;
        const double var_x198 = var_x197 * var_x48;
        const double var_x199 = var_x196 * var_x50;
        const double var_x200 = ((var_x7) ? (var_x198 - 187179.41753901311 * (-2.6712338705498262e-6 + var_chaste_interface__membrane__Vm) * (-var_x198 - var_x199 * var_x51)) : (var_x56 * var_chaste_interface__membrane__Vm));
        const double var_x201 = var_x200 * var_chaste_interface__Irel__Irel * var_chaste_interface__Ito2_i2f_gate__i2f / pow((0.16000000000000003 + var_x58), 2);
        ...
        const double var_x206 = 8.9127489396424967e-13 * var_x205;
        ...
        const double var_x210 = 0.0096484999999999991 * NV_Ith_S(mParameters, 9);
        ...
        const double var_x213 = var_x174 * var_x68;
        const double var_x214 = var_x183 * var_x70;
        const double var_x215 = var_x183 * var_x73;
        const double var_x216 = var_x149 * NV_Ith_S(mParameters, 18) * NV_Ith_S(mParameters, 4) / var_x153;
        ...
        const double var_x220 = 3 * NV_Ith_S(mParameters, 3);
        ...
        const double var_x223 = var_x100 * NV_Ith_S(mParameters, 3);
        ...
        const double var_x229 = var_x228 * NV_Ith_S(mParameters, 8);
        const double var_x230 = ((var_x7) ? (var_x197 + var_x209 * (-var_x197 - var_x199)) : (var_x55 * var_chaste_interface__membrane__Vm));
        ...
        const double var_x254 = (1.0 + 0.75 * var_x251) * NV_Ith_S(mParameters, 2);
        ...
        const double var_x262 = 0.0054277286135693209 * NV_Ith_S(mParameters, 0);
        const double var_x263 = var_x119 * var_x143;
        const double var_x264 = var_x110 * var_x243 / pow(var_x244, 2);
        const double var_x265 = var_x249 * var_x264;
        const double var_x266 = var_x250 / pow(var_x248, 2);
        const double var_x267 = var_x264 * var_x266;
        const double var_x268 = var_x253 * var_chaste_interface__Ca__Ca_i * NV_Ith_S(mParameters, 2);
        const double var_x269 = var_x268 * (5.6250000000000005e-5 * var_x265 - 5.6250000000000005e-5 * var_x267);
        const double var_x270 = 1.2750000000000002e-8 * var_x265 - 1.2750000000000002e-8 * var_x267;
        const double var_x271 = 2.7496819793936459e-17 * var_x205;
        const double var_x272 = 1 - var_x246;
        const double var_x273 = var_x249 * var_x272;
        const double var_x274 = var_x266 * (-1.0 + var_x246);
        const double var_x275 = var_x268 * (0.75 * var_x273 + 0.75 * var_x274);
        const double var_x276 = 0.00017000000000000001 * var_x273 + 0.00017000000000000001 * var_x274;
        const double var_x277 = exp(-0.0020762336738124813 * var_chaste_interface__membrane__Vm);
        const double var_x278 = 0.00017437520952861502 * var_x277;
        const double var_x279 = exp(0.0011184831685939309 * var_chaste_interface__membrane__Vm);
        const double var_x280 = 6.6503210598028962e-5 * var_x279 * var_chaste_interface__IKs__C1;
        const double var_x281 = 0.059458391923439997 * var_x279;
        const double var_x282 = 0.083986312199829993 * var_x277;
        const double var_x283 = 4.9877407948521721e-5 * var_x279;
        const double var_x284 = -var_x283;
        const double var_x285 = exp(0.0091586713426216482 * var_chaste_interface__membrane__Vm);
        const double var_x286 = 0.00013372265716153579 * var_x285;
        const double var_x287 = var_x278 - var_x286;
        const double var_x288 = 0.00034875041905723004 * var_x277;
        const double var_x289 = exp(-0.015957214534570986 * var_chaste_interface__membrane__Vm);
        const double var_x290 = 4.9743853916628211e-5 * var_x289;
        ...
        const double var_x297 = 3.3251605299014481e-5 * var_x279;
        const double var_x298 = -var_x297;
        const double var_x299 = 0.00026744531432307158 * var_x285;
        const double var_x300 = var_x288 - var_x299;
        const double var_x301 = 0.00052312562858584509 * var_x277;
        ...
        const double var_x307 = 1.662580264950724e-5 * var_x279;
        const double var_x308 = -var_x307;
        const double var_x309 = 0.00040116797148460735 * var_x285;
        const double var_x310 = var_x301 - var_x309;
        const double var_x311 = 0.00069750083811446009 * var_x277;
        ...
        const double var_x329 = 0.00018735227328422869 * var_x328;
        ...
        const double var_x340 = var_x338 / pow(var_x339, 2);
        ...
        const double var_x343 = -0.0038918839011179407 * var_x341 / pow(var_x342, 2);
        const double var_x344 = var_x343 + 0.0030285935177480471 * var_x340;
        ...
        const double var_x348 = var_x334 / pow(var_x335, 2);
        const double var_x349 = 0.26666666666666666 * var_x347 * var_x348;
        const double var_x350 = -var_x349 + var_x344 * (-0.80000000000000004 + var_x337);
        ...
        const double var_x358 = 0.10582010582010583 * var_x351 * var_x357 / pow(var_x352, 2);
        const double var_x359 = 1 / var_x352;
        const double var_x360 = 1.5624999999999998 * (-0.041599999999999998 * var_x356 + 0.10560000000000001 * var_x353 * var_x355 / pow(var_x354, 2)) / pow((0.73749999999999993 + var_x356), 2);
        ...
        const double var_x364 = var_x344 * var_x363;
        ...
        const double var_x379 = 1 / (pow(var_x370, 2) * pow(var_chaste_interface__Ca__Ca_ss_CaL, 5));
        const double var_x380 = 9.7200000000000016e-10 * var_x379;
        const double var_x381 = var_x380 * var_chaste_interface__ICaL__C;
        const double var_x382 = var_x358 - var_x367;
        const double var_x383 = -var_x377;
        const double var_x384 = var_x380 * var_chaste_interface__ICaL__O;
        const double var_x385 = 0.99990000999900008 * var_x336;
        const double var_x386 = -0.99990000999900008 + var_x385;
        const double var_x387 = 1 / (25.0 - 17.5 * var_x371);
        const double var_x388 = var_x343 + 0.092532617747756077 * var_x340 * var_x387;
        const double var_x389 = var_x345 + var_x346 * var_x387;
        const double var_x390 = 0.33330000333300003 * var_x348 * var_x389;
        const double var_x391 = -var_x390 + var_x386 * var_x388;
        const double var_x392 = 9.9990000999900015e-5 + var_x385;
        const double var_x393 = var_x388 * var_x392;
        ...
        const double var_x399 = 9.0720000000000001e-12 * var_x346 * var_x379 / pow((1 - 0.69999999999999996 * var_x371), 2);
        const double var_x400 = var_x392 * var_x399;
        const double var_x401 = var_x386 * var_x399;
        const double var_x402 = 1.0 + var_x35 - var_chaste_interface__ICaL__C - var_chaste_interface__ICaL__CI - var_chaste_interface__ICaL__CI_star - var_chaste_interface__ICaL__C_star - var_chaste_interface__ICaL__OI;
        ...
        const double var_x408 = 7.9999999999999996e-7 * var_x348 * var_x407;
        const double var_x409 = var_x363 * var_x405 * var_x406;
        const double var_x410 = var_x348 * var_x371;
        const double var_x411 = 9.9990000999900006e-7 * var_x409 * var_x410;
        const double var_x412 = var_x363 * var_x395 * var_x410;
        const double var_x413 = 1.2499999999999999e-6 * var_x406 * var_x412 / pow((1 - var_x336), 2);
        const double var_x414 = 1.0001e-6 * var_x405 * var_x412 / pow((0.0001 + var_x336), 2);
        const double var_x415 = var_x349 + var_x408 + var_x413 - var_x411 - var_x414 + var_x344 * (-0.20000000000000001 + var_x373);
        const double var_x416 = var_x344 * var_x374;
        const double var_x417 = 3.0000000000000001e-6 * var_x363 * var_x407;
        const double var_x418 = -var_x378 - var_x417;
        const double var_x419 = 9.7200000000000002e-16 * var_x379 * var_x395 * var_x409;
        const double var_x420 = var_x419 * var_chaste_interface__ICaL__CI;
        const double var_x421 = -9.9990000999900015e-5 + var_x394;
        const double var_x422 = var_x395 * var_chaste_interface__ICaL__C_star;
        ...
        const double var_x431 = ((var_x426) ? (0.15999999943156581 * var_x423 + 0.16000000056843419 * var_x424) : (var_x430 - 0.032000000000000001 * var_x425 * var_x428 / pow(var_x429, 2)));
        ...
        const double var_x458 = exp(14.918032786885247 + 0.16393442622950821 * var_chaste_interface__membrane__Vm);
        const double var_x459 = exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x467 = var_x465 - 8.1600000000000005e-5 * var_x463 * var_x466 / pow(var_x464, 2);
        ...
        const double var_x475 = var_x474 - 4.566e-5 * var_x468 * var_x472 / pow(var_x473, 2);
        ...
        const double var_x482 = exp(-1.3230057479321462 - 0.14019346698443852 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x494 = var_x492 / pow(var_x493, 2);
        const double var_x495 = 0.0050000000000000001 * var_x494;
        ...
        const double var_x498 = var_x496 / pow(var_x497, 2);
        const double var_x499 = 0.011343308638950427 * var_x498;
        ...
        const double var_x509 = pow(var_x507, 8.0);
        const double var_x510 = 1.0 + var_x509;
        const double var_x511 = 1 / var_x510;
        const double var_x512 = var_x508 * var_x511 * NV_Ith_S(mParameters, 1);
        const double var_x513 = var_x506 * var_x512;
        const double var_x514 = -var_x181 * var_x512;
        ...
        const double var_x523 = var_x181 * var_x506 * NV_Ith_S(mParameters, 1);
        const double var_x524 = var_x511 * var_x523;
        const double var_x525 = var_x522 - var_x519 * var_x524;
        const double var_x526 = var_x508 * var_x525 / pow((1 + var_x518), 2);
        const double var_x527 = var_x515 * var_x516 / pow(var_x517, 2);
        const double var_x528 = var_x264 * var_x527;
        const double var_x529 = var_x521 * var_x524;
        const double var_x530 = var_x527 * (-1 + var_x246);
        ...
        const double var_x548 = -var_x545 * var_x547;
        const double var_x549 = 3.299618375272375e-16 * var_x172;
        const double var_x550 = 8.2490459381809375e-17 * var_x205;
        ...
        const double var_x564 = 0.0020917052580005369 - 0.0020917052580005369 * var_x59;
        const double var_x565 = var_x564 * var_chaste_interface__Ito2_i2f_gate__i2f;
        const double var_x566 = (-6.1702220000015831e-5 - 3.7021332000009499e-5 * var_x66) * NV_Ith_S(mParameters, 16);
        const double var_x567 = var_x566 * var_x62;
        const double var_x568 = 2.6552407831565281e-5 * var_x77;
        const double var_x569 = 2.6031772383887529e-5 * var_x141;
        const double var_x570 = -var_x175 * var_x566;
        const double var_x571 = var_x174 * var_x567;
        const double var_x572 = 0.0025000000000000005 * var_x245;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x68 - var_x17 - var_x34 - var_x70 - var_x73 - var_x99 - NV_Ith_S(mParameters, 8) + 0.10468673984798647 * var_x136 + 0.027943602786489299 * var_x138 - var_x46 - 0.40000000000000002 * var_x120 - 0.80000000000000004 * var_x133 - 0.0021299433038121651 * var_x154 - 0.16722408026755853 * var_x83 - 0.4389381125701739 * var_x95 - 0.0034980089549690768 * var_x145 - 0.0069960179099381537 * var_x147 - 0.0018181818181818182 * var_x148 + var_x35 * var_x43 + var_x57 * var_x61 - var_x140 * var_x142 - var_x78 * var_chaste_interface__IKr_xr_gate__xr);
        IJth(rJacobian, 1, 0) = var_x241 * (1.2340444000003168e-5 * var_x120 + 4.9361776000012672e-5 * var_x133 + 1.0791745905076373e-7 * var_x145 + 4.3166983620305491e-7 * var_x147 - 3.0851110000007915e-5 * var_x34);
        IJth(rJacobian, 2, 0) = -var_x280 - var_x278 * var_chaste_interface__IKs__C2;
        IJth(rJacobian, 3, 0) = var_x280 + (var_x284 + var_x287) * var_chaste_interface__IKs__C2 - var_x288 * var_chaste_interface__IKs__C3 - var_x290 * var_chaste_interface__IKs__C6;
        IJth(rJacobian, 4, 0) = var_x283 * var_chaste_interface__IKs__C2 + (var_x298 + var_x300) * var_chaste_interface__IKs__C3 - var_x290 * var_chaste_interface__IKs__C7 - var_x301 * var_chaste_interface__IKs__C4;
        IJth(rJacobian, 5, 0) = var_x297 * var_chaste_interface__IKs__C3 + (var_x308 + var_x310) * var_chaste_interface__IKs__C4 - var_x290 * var_chaste_interface__IKs__C8 - var_x311 * var_chaste_interface__IKs__C5;
        IJth(rJacobian, 6, 0) = var_x307 * var_chaste_interface__IKs__C4 + (var_x311 - var_x317) * var_chaste_interface__IKs__C5 - var_x290 * var_chaste_interface__IKs__C9;
        IJth(rJacobian, 7, 0) = var_x286 * var_chaste_interface__IKs__C2 + (var_x284 + var_x290) * var_chaste_interface__IKs__C6 - var_x278 * var_chaste_interface__IKs__C7;
        IJth(rJacobian, 8, 0) = var_x283 * var_chaste_interface__IKs__C6 + var_x299 * var_chaste_interface__IKs__C3 + (var_x287 + var_x290 + var_x298) * var_chaste_interface__IKs__C7 - var_x288 * var_chaste_interface__IKs__C8 - var_x320 * var_chaste_interface__IKs__C10;
        IJth(rJacobian, 9, 0) = var_x297 * var_chaste_interface__IKs__C7 + var_x309 * var_chaste_interface__IKs__C4 + (var_x290 + var_x300 + var_x308) * var_chaste_interface__IKs__C8 - var_x301 * var_chaste_interface__IKs__C9 - var_x320 * var_chaste_interface__IKs__C11;
        IJth(rJacobian, 10, 0) = var_x307 * var_chaste_interface__IKs__C8 + var_x317 * var_chaste_interface__IKs__C5 + (var_x290 + var_x310) * var_chaste_interface__IKs__C9 - var_x320 * var_chaste_interface__IKs__C12;
        IJth(rJacobian, 11, 0) = var_x286 * var_chaste_interface__IKs__C7 + (var_x298 + var_x320) * var_chaste_interface__IKs__C10 - var_x278 * var_chaste_interface__IKs__C11;
        IJth(rJacobian, 12, 0) = var_x297 * var_chaste_interface__IKs__C10 + var_x299 * var_chaste_interface__IKs__C8 + (var_x287 + var_x308 + var_x320) * var_chaste_interface__IKs__C11 - var_x288 * var_chaste_interface__IKs__C12 - var_x323 * var_chaste_interface__IKs__C13;
        IJth(rJacobian, 13, 0) = var_x307 * var_chaste_interface__IKs__C11 + var_x309 * var_chaste_interface__IKs__C9 + (var_x300 + var_x320) * var_chaste_interface__IKs__C12 - var_x323 * var_chaste_interface__IKs__C14;
        IJth(rJacobian, 14, 0) = var_x286 * var_chaste_interface__IKs__C11 + (var_x308 + var_x323) * var_chaste_interface__IKs__C13 - var_x278 * var_chaste_interface__IKs__C14;
        IJth(rJacobian, 15, 0) = -var_x326 + var_x299 * var_chaste_interface__IKs__C12 + var_x307 * var_chaste_interface__IKs__C13 + (var_x287 + var_x323) * var_chaste_interface__IKs__C14;
        IJth(rJacobian, 16, 0) = var_x326 + var_x286 * var_chaste_interface__IKs__C14 - var_x329 * var_chaste_interface__IKs__O1;
        IJth(rJacobian, 17, 0) = (var_x329 - 0.0061916096628293225 * var_x331) * var_chaste_interface__IKs__O1 - 0.00300137636070284 * var_x332 * (0.79405459958640001 - 0.79405459958640001 * var_chaste_interface__IKs__C1 - 0.79405459958640001 * var_chaste_interface__IKs__C10 - 0.79405459958640001 * var_chaste_interface__IKs__C11 - 0.79405459958640001 * var_chaste_interface__IKs__C12 - 0.79405459958640001 * var_chaste_interface__IKs__C13 - 0.79405459958640001 * var_chaste_interface__IKs__C14 - 0.79405459958640001 * var_chaste_interface__IKs__C15 - 0.79405459958640001 * var_chaste_interface__IKs__C2 - 0.79405459958640001 * var_chaste_interface__IKs__C3 - 0.79405459958640001 * var_chaste_interface__IKs__C4 - 0.79405459958640001 * var_chaste_interface__IKs__C5 - 0.79405459958640001 * var_chaste_interface__IKs__C6 - 0.79405459958640001 * var_chaste_interface__IKs__C7 - 0.79405459958640001 * var_chaste_interface__IKs__C8 - 0.79405459958640001 * var_chaste_interface__IKs__C9 - 0.79405459958640001 * var_chaste_interface__IKs__O1);
        IJth(rJacobian, 18, 0) = var_x364 * var_chaste_interface__ICaL__CI + var_x367 * var_chaste_interface__ICaL__O + (var_x350 + var_x362) * var_chaste_interface__ICaL__C - var_x349 * var_chaste_interface__ICaL__CI - var_x358 * var_chaste_interface__ICaL__O;
        IJth(rJacobian, 19, 0) = var_x358 * var_chaste_interface__ICaL__C + var_x361 * var_chaste_interface__ICaL__C + var_x364 * var_chaste_interface__ICaL__OI + (var_x350 + var_x382) * var_chaste_interface__ICaL__O - var_x349 * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 20, 0) = var_x367 * var_chaste_interface__ICaL__O_star + var_x393 * var_chaste_interface__ICaL__CI_star + (var_x362 + var_x391) * var_chaste_interface__ICaL__C_star - var_x358 * var_chaste_interface__ICaL__O_star - var_x390 * var_chaste_interface__ICaL__CI_star;
        IJth(rJacobian, 21, 0) = var_x358 * var_chaste_interface__ICaL__C_star + var_x361 * var_chaste_interface__ICaL__C_star + var_x393 * var_x402 + (var_x382 + var_x391) * var_chaste_interface__ICaL__O_star - var_x390 * var_x402;
        IJth(rJacobian, 22, 0) = var_x349 * var_chaste_interface__ICaL__C + var_x367 * var_chaste_interface__ICaL__OI + var_x416 * var_chaste_interface__ICaL__C + (var_x362 + var_x415) * var_chaste_interface__ICaL__CI - var_x358 * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 23, 0) = var_x349 * var_chaste_interface__ICaL__O + var_x358 * var_chaste_interface__ICaL__CI + var_x361 * var_chaste_interface__ICaL__CI + var_x416 * var_chaste_interface__ICaL__O + (var_x382 + var_x415) * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 24, 0) = var_x367 * var_x402 + var_x388 * var_x422 + var_x390 * var_chaste_interface__ICaL__C_star + var_x411 * var_chaste_interface__ICaL__CI + var_x414 * var_chaste_interface__ICaL__CI + (var_x362 + var_x390 + var_x388 * var_x421) * var_chaste_interface__ICaL__CI_star - var_x358 * var_x402 - var_x408 * var_chaste_interface__ICaL__CI - var_x413 * var_chaste_interface__ICaL__CI;
        IJth(rJacobian, 25, 0) = var_x431 * (1.0 - var_chaste_interface__INa_m_gate__m) + var_x433 * var_chaste_interface__INa_m_gate__m;
        IJth(rJacobian, 26, 0) = (1.0 - var_chaste_interface__INa_h_gate__h) * ((var_x436) ? (0) : (-0.019852941176470591 * var_x437)) - ((var_x436) ? (0.693000693000693 * var_x438 / pow(var_x439, 2)) : (0.28123999999999999 * var_x440 + 108500.0 * var_x441)) * var_chaste_interface__INa_h_gate__h;
        IJth(rJacobian, 27, 0) = (1.0 - var_chaste_interface__INa_j_gate__j) * ((var_x436) ? (0) : (var_x448 + var_x444 * var_x449 * (3.0508668000000001e-6 * var_x446 - 31073.016 * var_x445) - 0.311 * var_x442 * var_x447 * var_x449 / pow(var_x443, 2))) - ((var_x436) ? (-7.6049999999999996e-8 * var_x453 + 0.029999999999999999 * var_x450 * var_x452 / pow(var_x451, 2)) : (-0.001275024 * var_x457 + 0.016701360000000002 * var_x454 * var_x456 / pow(var_x455, 2))) * var_chaste_interface__INa_j_gate__j;
        IJth(rJacobian, 28, 0) = var_x431 * (1.0 - var_chaste_interface__INaL_mL_gate__mL) + var_x433 * var_chaste_interface__INaL_mL_gate__mL;
        IJth(rJacobian, 29, 0) = -0.00027322404371584699 * var_x458 / pow((1.0 + var_x458), 2);
        IJth(rJacobian, 30, 0) = (-var_chaste_interface__IKr_xr_gate__xr + 1 / var_x460) * ((var_x469) ? (var_x467 + 0.00014999999999999999 * var_x461 + 0.00014999999999999999 * var_x462) : ((var_x476) ? (var_x475 + 0.00029999999995470287 * var_x470 + 0.00030000000004529707 * var_x471) : (var_x467 + var_x475))) + 0.23529411764705882 * var_x459 * var_x481 / pow(var_x460, 2);
        IJth(rJacobian, 31, 0) = (-var_chaste_interface__Ito1_a_gate__a + 1 / var_x483) * (0.028153807491391791 * var_x485 / pow(var_x486, 2) - 0.11912298256720238 * var_x487 / pow(var_x488, 2)) + 0.14019346698443852 * var_x482 * (var_x489 + var_x490) / pow(var_x483, 2);
        IJth(rJacobian, 32, 0) = -var_x495 * (1.0 - var_chaste_interface__Ito1_i1f_gate__i1f) - var_x499 * var_chaste_interface__Ito1_i1f_gate__i1f;
        IJth(rJacobian, 33, 0) = -var_x499 * var_chaste_interface__Ito1_i1s_gate__i1s - 0.00080000000000000004 * var_x504 * (1.0 - var_chaste_interface__Ito1_i1s_gate__i1s) / pow(var_x505, 2);
        IJth(rJacobian, 34, 0) = -0.00062500000000000001 * var_x494 / (var_x501 + 0.20000000000000001 * var_x502) + 0.078125 * var_x500 * (var_x495 - 0.022222222222222223 * var_x498) / pow((var_x502 + 0.125 * var_x500), 2);
        IJth(rJacobian, 35, 0) = -var_x43 * var_x513;
        IJth(rJacobian, 38, 0) = -var_x539 * (-0.0004183410516001074 * var_x120 - 3.6584018618208908e-6 * var_x145);
        IJth(rJacobian, 39, 0) = -var_x43 * var_x541 * var_x546;
        IJth(rJacobian, 40, 0) = -3.2375237715229119e-7 * var_x145 - 1.2950095086091648e-6 * var_x147 - 6.1702220000015831e-5 * var_x17 - 6.1702220000015831e-5 * var_x70 - 6.1702220000015831e-5 * var_x73 - 3.7021332000009505e-5 * var_x120 - 0.00014808532800003802 * var_x133 - 3.9426669095813636e-7 * var_x154;
        IJth(rJacobian, 41, 0) = -0.0012550231548003222 * var_x120 - 1.0975205585462671e-5 * var_x145;
        IJth(rJacobian, 42, 0) = 6.1702220000015831e-5 * NV_Ith_S(mParameters, 8);
        IJth(rJacobian, 43, 0) = var_x565 * var_x57;
        IJth(rJacobian, 44, 0) = var_x567 + 2.6284446063875757e-7 * var_x154 + 1.7241823267250181e-6 * var_x138 + 6.4594042531848857e-6 * var_x136 - 1.0318096989969203e-5 * var_x83 - 6.1702220000015831e-5 * var_x46 - 6.1702220000015831e-5 * var_x99 - 2.7083455988196588e-5 * var_x95 - 1.1218585454548334e-7 * var_x148 - var_x140 * var_x569 - var_x568 * var_chaste_interface__IKr_xr_gate__xr;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x164 - var_x160 - var_x162 + 0.80000000000000004 * var_x166 - 2.5000000000000002e-8 * var_x168 - 5.4447296618926212e-7 * var_x176 - var_x169 * var_x173);
        IJth(rJacobian, 1, 1) = var_x241 * (-0.14749262536873156 + var_x258 - var_x242 - var_x256 + 1.5425555000003961e-12 * var_x168 + 3.0851110000007915e-5 * var_x164 - 3.0851110000007915e-5 * var_x160 + var_x169 * var_x259 - var_x165 * var_x260) + (0.00023800000000000004 / pow(var_x238, 3) + 7.0000000000000007e-5 / pow(var_x161, 3)) * (0.14749262536873156 * var_chaste_interface__Ca__Ca_ss_sr + 1.2340444000003168e-5 * var_x263 - 0.14749262536873156 * var_chaste_interface__Ca__Ca_i - 3.0851110000007915e-5 * ((var_x23) ? (var_x261 - var_x180 * (-var_x261 - var_x156 * var_x22)) : (var_x29 * var_chaste_interface__membrane__Vm)) + var_x146 * var_x260 + var_x262 * var_chaste_interface__Ca__Ca_NSR - var_x242 * var_chaste_interface__Ca__Ca_i - var_x256 * var_chaste_interface__Ca__Ca_i) / pow(var_x239, 2);
        IJth(rJacobian, 37, 1) = var_x255 - var_x257;
        IJth(rJacobian, 38, 1) = 5.0 * var_x538;
        IJth(rJacobian, 40, 1) = 0.00014808532800003802 * var_x166 - 4.6276665000011881e-12 * var_x168 - var_x169 * var_x549;
        IJth(rJacobian, 44, 1) = -3.3595190743871034e-11 * var_x176;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 2, 2) = -var_x281;
        IJth(rJacobian, 3, 2) = var_x281;
        IJth(rJacobian, 17, 2) = var_x333;
        IJth(rJacobian, 44, 2) = var_x570;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 2, 3) = var_x282;
        IJth(rJacobian, 3, 3) = var_x292 + var_x294;
        IJth(rJacobian, 4, 3) = var_x291;
        IJth(rJacobian, 7, 3) = var_x293;
        IJth(rJacobian, 17, 3) = var_x333;
        IJth(rJacobian, 44, 3) = var_x570;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 3, 4) = var_x295;
        IJth(rJacobian, 4, 4) = var_x303 + var_x305;
        IJth(rJacobian, 5, 4) = var_x302;
        IJth(rJacobian, 8, 4) = var_x304;
        IJth(rJacobian, 17, 4) = var_x333;
        IJth(rJacobian, 44, 4) = var_x570;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 4, 5) = var_x306;
        IJth(rJacobian, 5, 5) = var_x313 + var_x315;
        IJth(rJacobian, 6, 5) = var_x312;
        IJth(rJacobian, 9, 5) = var_x314;
        IJth(rJacobian, 17, 5) = var_x333;
        IJth(rJacobian, 44, 5) = var_x570;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 5, 6) = var_x316;
        IJth(rJacobian, 6, 6) = -var_x316 - var_x318;
        IJth(rJacobian, 10, 6) = var_x318;
        IJth(rJacobian, 17, 6) = var_x333;
        IJth(rJacobian, 44, 6) = var_x570;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 3, 7) = var_x296;
        IJth(rJacobian, 7, 7) = var_x292 + var_x319;
        IJth(rJacobian, 8, 7) = var_x291;
        IJth(rJacobian, 17, 7) = var_x333;
        IJth(rJacobian, 44, 7) = var_x570;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 4, 8) = var_x296;
        IJth(rJacobian, 7, 8) = var_x282;
        IJth(rJacobian, 8, 8) = var_x294 + var_x303 + var_x319;
        IJth(rJacobian, 9, 8) = var_x302;
        IJth(rJacobian, 11, 8) = var_x293;
        IJth(rJacobian, 17, 8) = var_x333;
        IJth(rJacobian, 44, 8) = var_x570;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 5, 9) = var_x296;
        IJth(rJacobian, 8, 9) = var_x295;
        IJth(rJacobian, 9, 9) = var_x305 + var_x313 + var_x319;
        IJth(rJacobian, 10, 9) = var_x312;
        IJth(rJacobian, 12, 9) = var_x304;
        IJth(rJacobian, 17, 9) = var_x333;
        IJth(rJacobian, 44, 9) = var_x570;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 6, 10) = var_x296;
        IJth(rJacobian, 9, 10) = var_x306;
        IJth(rJacobian, 10, 10) = var_x315 + var_x319;
        IJth(rJacobian, 13, 10) = var_x314;
        IJth(rJacobian, 17, 10) = var_x333;
        IJth(rJacobian, 44, 10) = var_x570;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 8, 11) = var_x321;
        IJth(rJacobian, 11, 11) = var_x303 + var_x322;
        IJth(rJacobian, 12, 11) = var_x302;
        IJth(rJacobian, 17, 11) = var_x333;
        IJth(rJacobian, 44, 11) = var_x570;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 9, 12) = var_x321;
        IJth(rJacobian, 11, 12) = var_x282;
        IJth(rJacobian, 12, 12) = var_x294 + var_x313 + var_x322;
        IJth(rJacobian, 13, 12) = var_x312;
        IJth(rJacobian, 14, 12) = var_x293;
        IJth(rJacobian, 17, 12) = var_x333;
        IJth(rJacobian, 44, 12) = var_x570;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 10, 13) = var_x321;
        IJth(rJacobian, 12, 13) = var_x295;
        IJth(rJacobian, 13, 13) = var_x305 + var_x322;
        IJth(rJacobian, 15, 13) = var_x304;
        IJth(rJacobian, 17, 13) = var_x333;
        IJth(rJacobian, 44, 13) = var_x570;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 12, 14) = var_x324;
        IJth(rJacobian, 14, 14) = var_x313 + var_x325;
        IJth(rJacobian, 15, 14) = var_x312;
        IJth(rJacobian, 17, 14) = var_x333;
        IJth(rJacobian, 44, 14) = var_x570;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 13, 15) = var_x324;
        IJth(rJacobian, 14, 15) = var_x282;
        IJth(rJacobian, 15, 15) = var_x294 + var_x325;
        IJth(rJacobian, 16, 15) = var_x293;
        IJth(rJacobian, 17, 15) = var_x333;
        IJth(rJacobian, 44, 15) = var_x570;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177);
        IJth(rJacobian, 15, 16) = var_x327;
        IJth(rJacobian, 16, 16) = -0.089538306411019994 - var_x327;
        IJth(rJacobian, 17, 16) = 0.089538306411019994 + var_x333;
        IJth(rJacobian, 44, 16) = var_x570;
        IJth(rJacobian, 16, 17) = var_x330;
        IJth(rJacobian, 17, 17) = var_x333 - var_x330 - 0.58638228663014003 * var_x331;
        IJth(rJacobian, 18, 18) = var_x369 + var_x376;
        IJth(rJacobian, 19, 18) = var_x368;
        IJth(rJacobian, 20, 18) = var_x372;
        IJth(rJacobian, 21, 18) = var_x403;
        IJth(rJacobian, 22, 18) = var_x375;
        IJth(rJacobian, 23, 18) = -9.9999999999999995e-7;
        IJth(rJacobian, 24, 18) = var_x383;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x182);
        IJth(rJacobian, 18, 19) = var_x377;
        IJth(rJacobian, 19, 19) = var_x376 + var_x383;
        IJth(rJacobian, 21, 19) = var_x372 + var_x403;
        IJth(rJacobian, 23, 19) = -9.9999999999999995e-7 + var_x375;
        IJth(rJacobian, 24, 19) = var_x383;
        IJth(rJacobian, 35, 19) = var_x514;
        IJth(rJacobian, 39, 19) = var_x548;
        IJth(rJacobian, 18, 20) = 1.0;
        IJth(rJacobian, 20, 20) = var_x369 + var_x397;
        IJth(rJacobian, 21, 20) = var_x368 + var_x403;
        IJth(rJacobian, 23, 20) = -9.9999999999999995e-7;
        IJth(rJacobian, 24, 20) = var_x383 + var_x396;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (var_x182);
        IJth(rJacobian, 19, 21) = 1.0;
        IJth(rJacobian, 20, 21) = var_x377;
        IJth(rJacobian, 21, 21) = var_x397 + var_x404;
        IJth(rJacobian, 23, 21) = -9.9999999999999995e-7;
        IJth(rJacobian, 24, 21) = var_x383;
        IJth(rJacobian, 35, 21) = var_x514;
        IJth(rJacobian, 39, 21) = var_x548;
        IJth(rJacobian, 18, 22) = var_x378;
        IJth(rJacobian, 21, 22) = var_x403;
        IJth(rJacobian, 22, 22) = var_x369 + var_x418;
        IJth(rJacobian, 23, 22) = -9.9999999999999995e-7 + var_x368;
        IJth(rJacobian, 24, 22) = var_x383 + var_x417;
        IJth(rJacobian, 19, 23) = var_x378;
        IJth(rJacobian, 21, 23) = var_x403;
        IJth(rJacobian, 22, 23) = var_x377;
        IJth(rJacobian, 23, 23) = -9.9999999999999995e-7 + var_x383 + var_x418;
        IJth(rJacobian, 24, 23) = var_x383;
        IJth(rJacobian, 20, 24) = var_x398;
        IJth(rJacobian, 21, 24) = var_x403;
        IJth(rJacobian, 22, 24) = 9.9999999999999995e-7;
        IJth(rJacobian, 23, 24) = -9.9999999999999995e-7;
        IJth(rJacobian, 24, 24) = -9.9999999999999995e-7 + var_x369 + var_x404;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x187);
        IJth(rJacobian, 25, 25) = var_x435;
        IJth(rJacobian, 40, 25) = -0.00018510666000004749 * var_x187;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x188);
        IJth(rJacobian, 26, 26) = -((var_x436) ? (0) : (0.13500000000000001 * var_x437)) - ((var_x436) ? (7.6923076923076916 / var_x439) : (310000.0 * var_x441 + 3.5600000000000001 * var_x440));
        IJth(rJacobian, 40, 26) = -6.1702220000015831e-5 * var_x188;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x189);
        IJth(rJacobian, 27, 27) = -((var_x436) ? (0) : (var_x448 * var_x449)) - ((var_x436) ? (0.29999999999999999 * var_x453) : (0.1212 * var_x457));
        IJth(rJacobian, 40, 27) = -6.1702220000015831e-5 * var_x189;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x190);
        IJth(rJacobian, 28, 28) = var_x435;
        IJth(rJacobian, 40, 28) = -0.00018510666000004749 * var_x190;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x191);
        IJth(rJacobian, 29, 29) = -0.0016666666666666668;
        IJth(rJacobian, 40, 29) = -6.1702220000015831e-5 * var_x191;
        IJth(rJacobian, 0, 30) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x78 * var_x82);
        IJth(rJacobian, 30, 30) = -var_x481;
        IJth(rJacobian, 44, 30) = -var_x568 * var_x82;
        IJth(rJacobian, 0, 31) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x193);
        IJth(rJacobian, 31, 31) = -var_x489 - var_x490;
        IJth(rJacobian, 44, 31) = -0.00018510666000004749 * var_x193;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x194);
        IJth(rJacobian, 32, 32) = var_x503 - var_x501;
        IJth(rJacobian, 44, 32) = -6.1702220000015831e-5 * var_x194;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x195);
        IJth(rJacobian, 33, 33) = var_x503 - 0.0040000000000000001 / var_x505;
        IJth(rJacobian, 44, 33) = -6.1702220000015831e-5 * var_x195;
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (var_x200 * var_x60);
        IJth(rJacobian, 34, 34) = -0.125;
        IJth(rJacobian, 43, 34) = var_x200 * var_x564;
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (-0.32000000000000006 * var_x201);
        IJth(rJacobian, 35, 35) = -var_x521;
        IJth(rJacobian, 36, 35) = -var_x533;
        IJth(rJacobian, 38, 35) = 0.23999999999999996 * var_x538;
        IJth(rJacobian, 43, 35) = 0.00066934568256017191 * var_x201;
        IJth(rJacobian, 35, 36) = -0.0123 * var_x520 * var_x525 / pow(var_chaste_interface__Ca__Ca_JSR, 2) - 8.0 * var_x507 * var_x508 * var_x509 * var_x523 / pow(var_x510, 2);
        IJth(rJacobian, 36, 36) = -var_x534 + 0.25 * (var_x522 + 0.040000000000000001 * var_chaste_interface__Ca__Ca_NSR - 0.040000000000000001 * var_chaste_interface__Ca__Ca_JSR) / (pow(var_x531, 3) * pow((0.125 + var_x532), 2));
        IJth(rJacobian, 37, 36) = 0.0034782608695652171;
        IJth(rJacobian, 1, 37) = var_x240 * var_x262;
        IJth(rJacobian, 36, 37) = var_x534;
        IJth(rJacobian, 37, 37) = -0.0034782608695652171 - 0.066666666666666666 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 38) = mSetVoltageDerivativeToZero ? 0.0 : (0.40000000000000002 * var_x202 - 1.2500000000000001e-8 * var_x204 - var_x169 * var_x206);
        IJth(rJacobian, 1, 38) = var_x241 * (0.14749262536873156 + 3.8563887500009902e-13 * var_x204 - 1.2340444000003168e-5 * var_x202 - 0.081415929203539822 * var_x269 + var_x169 * var_x271 - var_x258 * var_x270);
        IJth(rJacobian, 35, 38) = -4.6767910530856466e-10 * var_x526 * var_x528 - 1.0552009813524491e-8 * var_x528 * var_x529;
        IJth(rJacobian, 37, 38) = var_x269 + var_x257 * var_x270;
        IJth(rJacobian, 38, 38) = -var_x539 * (5.5 + 0.0004183410516001074 * var_x202 - 1.3073157862503357e-11 * var_x204 - var_x169 * var_x540) - (0.019557600000000001 / pow(var_x535, 3) + 8.1780000000000006e-5 / pow(var_x536, 3)) * (5.5 * var_chaste_interface__Ca__Ca_ss_sr - 0.5 * var_chaste_interface__Ca__Ca_ss_CaL - 0.23999999999999996 * var_chaste_interface__Irel__Irel - 5.0 * var_chaste_interface__Ca__Ca_i - 0.0004183410516001074 * var_x263) / pow(var_x537, 2);
        IJth(rJacobian, 39, 38) = 5.0 * var_x545;
        IJth(rJacobian, 40, 38) = 3.7021332000009505e-5 * var_x202 - 1.156916625000297e-12 * var_x204 - var_x169 * var_x550;
        IJth(rJacobian, 41, 38) = 0.0012550231548003222 * var_x202 - 3.9219473587510072e-11 * var_x204 - var_x169 * var_x558;
        IJth(rJacobian, 45, 38) = 3.7500000000000005e-6 * var_x250 * var_x264 + 1.8750000000000003e-7 * var_x110 * pow(var_x243, 2) / pow(var_x244, 3);
        IJth(rJacobian, 0, 39) = mSetVoltageDerivativeToZero ? 0.0 : (var_x208 * var_x35);
        IJth(rJacobian, 18, 39) = -var_x381;
        IJth(rJacobian, 19, 39) = -var_x384;
        IJth(rJacobian, 20, 39) = var_x381 + var_x400 * var_chaste_interface__ICaL__CI_star + var_x401 * var_chaste_interface__ICaL__C_star;
        IJth(rJacobian, 21, 39) = var_x384 + var_x400 * var_x402 + var_x401 * var_chaste_interface__ICaL__O_star;
        IJth(rJacobian, 22, 39) = -var_x420;
        IJth(rJacobian, 23, 39) = -var_x419 * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 24, 39) = var_x420 + var_x399 * var_x422 + var_x399 * var_x421 * var_chaste_interface__ICaL__CI_star;
        IJth(rJacobian, 35, 39) = -var_x208 * var_x513;
        IJth(rJacobian, 38, 39) = 0.5 * var_x538;
        IJth(rJacobian, 39, 39) = -var_x546 * (5.0 + var_x208 * var_x541) - (0.019557600000000001 / pow(var_x542, 3) + 8.1780000000000006e-5 / pow(var_x543, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_CaL - 5.0 * var_chaste_interface__Ca__Ca_ss_sr + var_x506 * var_x547) / pow(var_x544, 2);
        IJth(rJacobian, 0, 40) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x212 + 0.065648961871082934 * var_x217 + 0.48963716847178318 * var_x213 - 2.4000000000000004 * var_x224 - 0.17068730086481565 * var_x219 - 26.712338705498265 * var_x214 - 26.712338705498265 * var_x215 - var_x173 * var_x222);
        IJth(rJacobian, 1, 40) = var_x241 * (0.00014808532800003802 * var_x224 + var_x222 * var_x259);
        IJth(rJacobian, 40, 40) = -0.14749262536873156 + var_x556 + 1.2152060064426631e-5 * var_x217 - 0.0016482105995215921 * var_x214 - 0.0016482105995215921 * var_x215 - 3.1595356167509241e-5 * var_x219 - 0.00044425598400011404 * var_x224 - 6.1702220000015831e-5 * var_x212 - var_x222 * var_x549;
        IJth(rJacobian, 41, 40) = 5.0;
        IJth(rJacobian, 42, 40) = var_x556;
        IJth(rJacobian, 44, 40) = 2.1063570778339494e-5 * var_x219 + 0.48963716847178318 * var_x571 - 8.1013733762844218e-6 * var_x217;
        IJth(rJacobian, 0, 41) = mSetVoltageDerivativeToZero ? 0.0 : (-1.2000000000000002 * var_x227 - var_x206 * var_x226);
        IJth(rJacobian, 1, 41) = var_x241 * (3.7021332000009505e-5 * var_x227 + var_x226 * var_x271);
        IJth(rJacobian, 38, 41) = -var_x539 * (-0.0012550231548003222 * var_x227 - var_x226 * var_x540);
        IJth(rJacobian, 40, 41) = 0.14749262536873156 - 0.00011106399600002851 * var_x227 - var_x226 * var_x550;
        IJth(rJacobian, 41, 41) = -5.0 - 0.0037650694644009667 * var_x227 - var_x226 * var_x558;
        IJth(rJacobian, 0, 42) = mSetVoltageDerivativeToZero ? 0.0 : (26.712338705498265 * var_x229 + var_x230 * var_x61);
        IJth(rJacobian, 40, 42) = var_x557;
        IJth(rJacobian, 42, 42) = -0.14749262536873156 + var_x557 + var_x562 - 0.0016482105995215921 * var_x229;
        IJth(rJacobian, 43, 42) = 5.0 + var_x230 * var_x565;
        IJth(rJacobian, 44, 42) = var_x562;
        IJth(rJacobian, 42, 43) = 0.14749262536873156;
        IJth(rJacobian, 43, 43) = -5.0;
        IJth(rJacobian, 0, 44) = mSetVoltageDerivativeToZero ? 0.0 : (2.7964276527937963 * var_x237 + 26.712338705498265 * var_x213 - 11.72506353372661 * var_x232 - 11.495160327182951 * var_x233 - 26.712338705498265 * var_x231 - 26.712338705498265 * var_x236 - var_x142 * var_x235);
        IJth(rJacobian, 42, 44) = var_x563;
        IJth(rJacobian, 44, 44) = var_x563 + 0.00017254579424681073 * var_x237 + 26.712338705498265 * var_x571 - 0.00070927691144329649 * var_x233 - 0.0016482105995215921 * var_x231 - 0.0016482105995215921 * var_x236 - 0.00072346244967216237 * var_x232 - var_x235 * var_x569;
        IJth(rJacobian, 1, 45) = var_x241 * (-0.081415929203539822 * var_x275 - var_x258 * var_x276);
        IJth(rJacobian, 35, 45) = 6.2357214041141957e-6 * var_x526 * var_x530 + 0.00014069346418032653 * var_x529 * var_x530;
        IJth(rJacobian, 37, 45) = var_x275 + var_x257 * var_x276;
        IJth(rJacobian, 45, 45) = -0.00068000000000000005 - var_x250 * var_x572 + var_x243 * var_x272 * var_x572;
    }
