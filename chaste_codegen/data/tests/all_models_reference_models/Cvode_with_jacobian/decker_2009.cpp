...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldecker_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x10 = pow(var_chaste_interface__INaL_mL_gate__mL, 3.0);
        ...
        const double var_x54 = exp(-3.4441726741524206 - var_x12);
        const double var_x55 = 1.0 + var_x54;
        const double var_x56 = var_x53 * var_x54 / pow(var_x55, 2);
        const double var_x57 = 26.711785007306684 * var_x20;
        const double var_x58 = -var_x57 + var_chaste_interface__membrane__Vm;
        const double var_x59 = var_x0 * var_x58 / pow(var_x1, 2);
        const double var_x60 = var_x33 * var_chaste_interface__membrane__Vm;
        const double var_x61 = var_x60 / pow(var_x34, 2);
        const double var_x62 = var_x37 * var_x61;
        const double var_x63 = var_x13 * var_chaste_interface__membrane__Vm;
        const double var_x64 = var_x17 * var_x63 / pow(var_x14, 2);
        const double var_x65 = var_x39 * var_x58 * var_chaste_interface__IKr_xr_gate__xr / pow(var_x40, 2);
        const double var_x66 = var_x21 / pow(var_x22, 2);
        const double var_x67 = var_x31 * var_x58;
        ...
        const double var_x80 = 1 / (13227.9606 + 4344355.375 * var_chaste_interface__Ca__Ca_i + 8.4084932990912282 * var_x73);
        ...
        const double var_x90 = 1 / (13227.9606 + 4344355.375 * var_chaste_interface__Ca__Ca_ss_sr + 8.4084932990912282 * var_x83);
        const double var_x91 = var_x89 * var_x90;
        const double var_x92 = var_x91 * (0.016374794866024663 * var_x84 + 67491.109242862804 * var_x85);
        const double var_x93 = pow(var_chaste_interface__Ito1_a_gate__a, 3.0);
        const double var_x94 = exp(0.0018181818181818182 * var_chaste_interface__membrane__Vm);
        const double var_x95 = var_x93 * var_x94 * var_chaste_interface__Ito1_i1s_gate__i1s;
        const double var_x96 = 0.4975 * var_x95;
        const double var_x97 = var_x35 * var_x60;
        const double var_x98 = var_x97 * var_chaste_interface__Ca__Ca_i;
        const double var_x99 = var_x15 * var_x16 * var_chaste_interface__membrane__Vm;
        const double var_x100 = var_x24 * var_x29 / pow(var_x25, 2);
        const double var_x101 = 0.24326999999999999 * var_x66 - 0.51429999999999998 * var_x100 - var_x26 * (0.061749999999999999 * var_x28 + 0.039456396800000001 * var_x27);
        const double var_x102 = var_x23 * var_x58 / pow((var_x23 + 0.98039215686274506 * var_x30), 2);
        const double var_x103 = 0.49019607843137253 * var_x102;
        const double var_x104 = 1.0 - var_x13;
        const double var_x105 = 1 / var_x104;
        const double var_x106 = pow(var_chaste_interface__Irel__Irel, 2.0);
        const double var_x107 = 1.0 - 1.0 / (1.0 + 6.2499999999999991 * var_x106);
        const double var_x108 = -100.0 * var_x13 + var_chaste_interface__Cl__Cl_i;
        const double var_x109 = var_x105 * var_x107 * var_x108;
        const double var_x110 = 0.0032509358688027189 * var_x109;
        const double var_x111 = var_x107 * var_chaste_interface__Ito2_i2f_gate__i2f;
        const double var_x112 = var_x105 * var_x111;
        const double var_x113 = var_x112 * var_x63;
        const double var_x114 = var_x46 * var_x47 * var_x61;
        const double var_x115 = 0.16824385730132127 * var_x114;
        const double var_x116 = var_x46 * var_x97;
        const double var_x117 = var_x116 * var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x118 = 0.16824385730132127 * var_x117;
        const double var_x119 = var_x58 * var_chaste_interface__Ito1_i1f_gate__i1f;
        const double var_x120 = var_x119 * var_x95;
        const double var_x121 = 6.4800000000000004 * var_x75 - 9878400.0 * var_x76;
        const double var_x122 = var_x121 * var_x81;
        const double var_x123 = var_x69 / pow(var_x70, 2);
        const double var_x124 = 0.0087452036595870152 * var_x123;
        const double var_x125 = 1.6200000000000001 * var_x84 - 2469600.0 * var_x85;
        const double var_x126 = var_x125 * var_x91;
        const double var_x127 = var_x108 * var_x111 * var_x63 / pow(var_x104, 2);
        ...
        const double var_x134 = var_x121 * var_x79 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x73 + var_chaste_interface__Ca__Ca_i), 2);
        ...
        const double var_x150 = var_x119 * var_x94;
        const double var_x151 = var_x150 * pow(var_chaste_interface__Ito1_a_gate__a, 2.0) * var_chaste_interface__Ito1_i1s_gate__i1s;
        const double var_x152 = var_x150 * var_x93;
        const double var_x153 = var_x105 * var_x108 * pow(var_chaste_interface__Irel__Irel, 1.0) * var_chaste_interface__Ito2_i2f_gate__i2f * var_chaste_interface__membrane__Vm / pow((0.16000000000000003 + var_x106), 2);
        const double var_x154 = var_x131 * var_x91;
        const double var_x155 = var_x125 * var_x89 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x83 + var_chaste_interface__Ca__Ca_ss_sr), 2);
        const double var_x156 = var_x125 * var_x86 * var_x87 * var_x90 / pow(var_x88, 2);
        const double var_x157 = 2.2470468725164396 * var_x116;
        const double var_x158 = var_x15 * var_x63;
        const double var_x159 = var_x10 * var_x143 * var_chaste_interface__INaL_hL_gate__hL;
        ...
        const double var_x166 = var_x143 * var_x51 * var_x53 * (3.0 * var_x52 - 0.4437869822485207 * var_chaste_interface__Na__Na_i / pow((1 + 0.38461538461538458 * var_chaste_interface__Na__Na_i), 2)) / var_x55;
        const double var_x167 = var_x71 * var_x74;
        ...
        const double var_x174 = var_x112 * var_chaste_interface__membrane__Vm;
        ...
        const double var_x178 = var_x19 * var_x66;
        const double var_x179 = 6.4981759387274964 * var_x178 - var_x26 * (1.0539507884845836 * var_x19 * var_x27 + 1.6494527242011876 * var_x19 * var_x28) - 13.737871029257827 * var_x100 * var_x19;
        const double var_x180 = var_x178 * var_x67;
        const double var_x181 = var_x19 * var_x95 * var_chaste_interface__Ito1_i1f_gate__i1f;
        const double var_x182 = 8.8930116629204303e-8 * var_x38;
        const double var_x183 = 6.1700941025231664e-5 * var_x71;
        ...
        const double var_x189 = 1.7739020544754105e-6 * var_x129;
        ...
        const double var_x210 = var_x196 * var_x209;
        const double var_x211 = var_x197 / pow(var_x195, 2);
        ...
        const double var_x216 = 1 - var_x193;
        const double var_x217 = var_x196 * var_x216;
        ...
        const double var_x221 = exp(0.0011184950759309986 * var_chaste_interface__membrane__Vm);
        const double var_x222 = 6.6501243234553463e-5 * var_x221 * var_chaste_interface__IKs__C1;
        const double var_x223 = exp(-0.0020762745726213851 * var_chaste_interface__membrane__Vm);
        const double var_x224 = 0.00017437799625617966 * var_x223;
        const double var_x225 = 0.059456000000000002 * var_x221;
        const double var_x226 = 0.083986000000000005 * var_x223;
        const double var_x227 = 4.9875932425915097e-5 * var_x221;
        ...
        const double var_x231 = var_x224 - var_x230;
        const double var_x232 = exp(-0.01595737611258119 * var_chaste_interface__membrane__Vm);
        const double var_x233 = 4.9743928555749341e-5 * var_x232;
        const double var_x234 = 0.00034875599251235932 * var_x223;
        const double var_x235 = 0.044592 * var_x221;
        const double var_x236 = -var_x235;
        const double var_x237 = 0.014600999999999999 * var_x229;
        const double var_x238 = -var_x226 - var_x237;
        const double var_x239 = 0.16797200000000001 * var_x223;
        const double var_x240 = 0.0031172999999999999 * var_x232;
        const double var_x241 = 3.3250621617276731e-5 * var_x221;
        const double var_x242 = -var_x241;
        const double var_x243 = 0.00026745757717223961 * var_x229;
        const double var_x244 = var_x234 - var_x243;
        const double var_x245 = 0.0005231339887685389 * var_x223;
        const double var_x246 = 0.029728000000000001 * var_x221;
        const double var_x247 = -var_x246;
        const double var_x248 = 0.029201999999999999 * var_x229;
        const double var_x249 = -var_x239 - var_x248;
        const double var_x250 = 0.25195800000000002 * var_x223;
        const double var_x251 = 1.6625310808638366e-5 * var_x221;
        ...
        const double var_x255 = 0.00069751198502471864 * var_x223;
        const double var_x256 = 0.014864 * var_x221;
        const double var_x257 = -var_x256;
        const double var_x258 = 0.043802999999999995 * var_x229;
        const double var_x259 = -var_x250 - var_x258;
        const double var_x260 = 0.33594400000000002 * var_x223;
        ...
        const double var_x264 = 9.9487857111498683e-5 * var_x232;
        const double var_x265 = 0.0062345999999999999 * var_x232;
        const double var_x266 = -var_x265;
        const double var_x267 = 0.00014923178566724802 * var_x232;
        const double var_x268 = 0.0093518999999999998 * var_x232;
        const double var_x269 = -var_x268;
        const double var_x270 = 0.00019897571422299737 * var_x232 * var_chaste_interface__IKs__C15;
        const double var_x271 = 0.0124692 * var_x232;
        ...
        const double var_x275 = exp(0.0105593841790373 * var_chaste_interface__membrane__Vm);
        const double var_x276 = 0.0061918116949038924 * var_x275;
        ...
        const double var_x469 = var_x466 * (-1 + var_x193);
        ...
        const double var_x477 = 0.0020916619007553534 * var_x71;
        ...
        const double var_x485 = 0.023500311662270543 * var_x48;
        ...
        const double var_x493 = 4.0105611666400582e-7 * var_x10;
        const double var_x494 = 0.00055993603980397731 * var_x44;
        const double var_x495 = log(100.0 * var_x173);
        const double var_x496 = var_x144 + var_x495;
        const double var_x497 = pow(var_x496, 4.0);
        const double var_x498 = 7.2087469970547496e-9 * pow(var_x496, 7.0) / pow((1 + 0.0085573053764671191 * var_x497), 2);
        const double var_x499 = 50.118419258935766 * pow(var_x496, 3.0) / (59494197.640692554 + 509110.01733929582 * var_x497);
        const double var_x500 = var_x143 * var_x498 - var_x143 * var_x499;
        const double var_x501 = var_x173 * var_x498 - var_x173 * var_x499;
        const double var_x502 = var_x57 + 26.711785007306684 * var_x495;
        const double var_x503 = 0.00047279859462932828 / (87.825100000000006 + var_x502);
        const double var_x504 = 6.1296950776416711e-8 * var_x502 / pow((1 + 0.30414750461208334 * var_x20 + 0.30414750461208334 * var_x495), 2);
        const double var_x505 = var_x173 * var_x504 - var_x173 * var_x503;
        const double var_x506 = var_x19 * var_x504 - var_x19 * var_x503;
        const double var_x507 = 6.799858698573652e-6 * var_x109;
        const double var_x508 = -5.0964977286841363e-6 - 3.0578986372104813e-6 * var_x6;
        const double var_x509 = var_x508 * var_x8;
        const double var_x510 = 8.5481717715176459e-7 * var_x41;
        const double var_x511 = 3.0696218160052752e-5 * var_x95;
        const double var_x512 = 3.0245559326093954e-5 * var_x102;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00022499999999999999 + var_x115 + var_x9 - var_x118 - var_x50 + 0.012170417918209005 * var_x113 + 0.00021583116499495196 * var_x62 + 4.3272597042520909e-7 * var_x64 + 0.00089962337662337659 * var_x65 + 0.12163499999999999 * var_x68 - 0.0027599999999999999 * var_x2 - 0.00012170417918209004 * var_x127 - 1.1558883089076335e-5 * var_x18 - 0.00021583116499495196 * var_x98 - 4.3272597042520909e-7 * var_x99 - 0.00090454545454545453 * var_x120 - 0.51000000000000001 * var_x32 - 0.041017557367032609 * var_x56 - 0.0028826178386108462 * var_x38 - 0.00046153846153846147 * var_x59 - var_x101 * var_x103 - var_x11 * var_chaste_interface__INaL_hL_gate__hL - var_x110 * var_chaste_interface__Ito2_i2f_gate__i2f - var_x122 * var_x124 - var_x124 * var_x126 - var_x42 * var_chaste_interface__IKr_xr_gate__xr - var_x45 * var_chaste_interface__INa_h_gate__h - var_x72 * var_x82 - var_x72 * var_x92 - var_x96 * var_chaste_interface__Ito1_i1f_gate__i1f);
        IJth(rJacobian, 1, 0) = var_x188 * (-var_x182 + 6.6584929913802883e-9 * var_x62 + 5.3958729525381867e-7 * var_x184 - 6.6584929913802883e-9 * var_x98 + var_x183 * var_x82);
        IJth(rJacobian, 2, 0) = -var_x222 - var_x224 * var_chaste_interface__IKs__C2;
        IJth(rJacobian, 3, 0) = var_x222 + (var_x228 + var_x231) * var_chaste_interface__IKs__C2 - var_x233 * var_chaste_interface__IKs__C6 - var_x234 * var_chaste_interface__IKs__C3;
        IJth(rJacobian, 4, 0) = var_x227 * var_chaste_interface__IKs__C2 + (var_x242 + var_x244) * var_chaste_interface__IKs__C3 - var_x233 * var_chaste_interface__IKs__C7 - var_x245 * var_chaste_interface__IKs__C4;
        IJth(rJacobian, 5, 0) = var_x241 * var_chaste_interface__IKs__C3 + (var_x252 + var_x254) * var_chaste_interface__IKs__C4 - var_x233 * var_chaste_interface__IKs__C8 - var_x255 * var_chaste_interface__IKs__C5;
        IJth(rJacobian, 6, 0) = var_x251 * var_chaste_interface__IKs__C4 + (var_x255 - var_x261) * var_chaste_interface__IKs__C5 - var_x233 * var_chaste_interface__IKs__C9;
        IJth(rJacobian, 7, 0) = var_x230 * var_chaste_interface__IKs__C2 + (var_x228 + var_x233) * var_chaste_interface__IKs__C6 - var_x224 * var_chaste_interface__IKs__C7;
        IJth(rJacobian, 8, 0) = var_x227 * var_chaste_interface__IKs__C6 + var_x243 * var_chaste_interface__IKs__C3 + (var_x231 + var_x233 + var_x242) * var_chaste_interface__IKs__C7 - var_x234 * var_chaste_interface__IKs__C8 - var_x264 * var_chaste_interface__IKs__C10;
        IJth(rJacobian, 9, 0) = var_x241 * var_chaste_interface__IKs__C7 + var_x253 * var_chaste_interface__IKs__C4 + (var_x233 + var_x244 + var_x252) * var_chaste_interface__IKs__C8 - var_x245 * var_chaste_interface__IKs__C9 - var_x264 * var_chaste_interface__IKs__C11;
        IJth(rJacobian, 10, 0) = var_x251 * var_chaste_interface__IKs__C8 + var_x261 * var_chaste_interface__IKs__C5 + (var_x233 + var_x254) * var_chaste_interface__IKs__C9 - var_x264 * var_chaste_interface__IKs__C12;
        IJth(rJacobian, 11, 0) = var_x230 * var_chaste_interface__IKs__C7 + (var_x242 + var_x264) * var_chaste_interface__IKs__C10 - var_x224 * var_chaste_interface__IKs__C11;
        IJth(rJacobian, 12, 0) = var_x241 * var_chaste_interface__IKs__C10 + var_x243 * var_chaste_interface__IKs__C8 + (var_x231 + var_x252 + var_x264) * var_chaste_interface__IKs__C11 - var_x234 * var_chaste_interface__IKs__C12 - var_x267 * var_chaste_interface__IKs__C13;
        ...
        IJth(rJacobian, 14, 0) = var_x230 * var_chaste_interface__IKs__C11 + (var_x252 + var_x267) * var_chaste_interface__IKs__C13 - var_x224 * var_chaste_interface__IKs__C14;
        ...
        IJth(rJacobian, 31, 0) = -0.00027322404371584699 * var_x409 / pow((1.0 + var_x409), 2);
        ...
        IJth(rJacobian, 37, 0) = var_x459 * (-var_x456 + var_x115 * var_x455 - var_x118 * var_x455);
        IJth(rJacobian, 40, 0) = var_x483 * (1.8292009309104452e-5 * var_x478 + var_x477 * var_x92);
        IJth(rJacobian, 41, 0) = var_x491 * (-var_x486 + 0.0017595463317664707 * var_x114 - 0.0017595463317664707 * var_x117);
        IJth(rJacobian, 42, 0) = 2.6699599581291967e-11 * var_x64 - 7.1319396379664657e-10 * var_x18 - 1.6187618857614559e-6 * var_x184 - 2.6699599581291967e-11 * var_x99 - 7.5924656643070068e-6 * var_x56 - var_x493 * var_chaste_interface__INaL_hL_gate__hL - var_x494 * var_chaste_interface__INa_h_gate__h - 0.00018510282307569501 * var_x71 * var_x82;
        IJth(rJacobian, 43, 0) = -5.4876027927313356e-5 * var_x478 - 0.0062749857022660607 * var_x71 * var_x92;
        IJth(rJacobian, 44, 0) = 1.3882711730677125e-8;
        IJth(rJacobian, 45, 0) = 2.5456399475788057e-7 * var_x127 - 2.5456399475788059e-5 * var_x113 + var_x507 * var_chaste_interface__Ito2_i2f_gate__i2f;
        IJth(rJacobian, 46, 0) = var_x509 + 5.5507608905958737e-8 * var_x65 + 7.5049939616040537e-6 * var_x68 + 5.0616437762046715e-6 * var_x56 - 2.8477357396260765e-8 * var_x59 - 3.1467479922868152e-5 * var_x32 - 1.7029459722963939e-7 * var_x2 - 5.5811305745550463e-8 * var_x120 - var_x101 * var_x512 - var_x510 * var_chaste_interface__IKr_xr_gate__xr - var_x511 * var_chaste_interface__Ito1_i1f_gate__i1f;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.057500000000000002 * var_x130 + 9878400.0 * var_x132 - 0.057500000000000002 * var_x129 - 0.0028826178386108462 * var_x97 - 4.4973467007233054e-8 * var_x137 + var_x133 * var_x134 - var_x138 * var_x139);
        IJth(rJacobian, 1, 1) = var_x188 * (-0.014749262536873154 + var_x206 - var_x189 - var_x203 + 1.9281544070384897e-12 * var_x207 + 1.7739020544754105e-6 * var_x130 - 609.50657582364852 * var_x132 - 1.4202553819674954e-11 * var_x164 - 8.8930116629204303e-8 * var_x97) + 1.0 * (0.00023800000000000004 * pow(var_x185, (-3.0)) + 7.0000000000000007e-5 * pow(var_x128, (-3.0))) * (2.3746312684365782e-5 * var_chaste_interface__Ca__Ca_NSR + 0.014749262536873154 * var_chaste_interface__Ca__Ca_ss_sr - 0.014749262536873154 * var_chaste_interface__Ca__Ca_i + var_x122 * var_x183 - var_x182 * var_chaste_interface__membrane__Vm - var_x189 * var_chaste_interface__Ca__Ca_i - var_x203 * var_chaste_interface__Ca__Ca_i) / pow(var_x186, 2);
        IJth(rJacobian, 39, 1) = -var_x475 + 0.0043750000000000004 * var_x202;
        IJth(rJacobian, 40, 1) = 5.0 * var_x482;
        IJth(rJacobian, 42, 1) = 4.2607661459024858e-11 * var_x164 + 1828.5197274709456 * var_x132 - 5.784463221115469e-12 * var_x207;
        ...
        IJth(rJacobian, 42, 27) = -0.001679808119411932 * var_x147;
        ...
        IJth(rJacobian, 42, 29) = -0.00055993603980397731 * var_x148;
        ...
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x42 * var_x58);
        ...
        IJth(rJacobian, 46, 33) = -9.2088654480158264e-5 * var_x151;
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x58 * var_x96);
        ...
        IJth(rJacobian, 46, 35) = -3.0696218160052752e-5 * var_x152;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x110 * var_chaste_interface__membrane__Vm);
        ...
        IJth(rJacobian, 1, 40) = var_x188 * (0.014749262536873154 - var_x206 * var_x215 - var_x213 * var_x214);
        IJth(rJacobian, 37, 40) = -4.6767910530856466e-10 * var_x465 * var_x467 - 2.667471823152336e-9 * var_x467 * var_x468;
        IJth(rJacobian, 39, 40) = var_x213 * var_x476 + var_x215 * var_x475;
        IJth(rJacobian, 40, 40) = var_x483 * (-5.5 + 6.53644343986048e-11 * var_x484 - 4.8146657448698097e-10 * var_x170 - 5165.5682301054212 * var_x154) + 1.0 * (0.019557600000000001 * pow(var_x479, (-3.0)) + 8.1780000000000006e-5 * pow(var_x480, (-3.0))) * (0.5 * var_chaste_interface__Ca__Ca_ss_CaL + 0.23999999999999996 * var_chaste_interface__Irel__Irel + 5.0 * var_chaste_interface__Ca__Ca_i - 5.5 * var_chaste_interface__Ca__Ca_ss_sr + var_x126 * var_x477) / pow(var_x481, 2);
        IJth(rJacobian, 41, 40) = 5.0 * var_x490;
        IJth(rJacobian, 43, 40) = 15496.704690316265 * var_x154 + 1.4443997234609428e-9 * var_x170 - 1.960933031958144e-10 * var_x484;
        IJth(rJacobian, 47, 40) = 3.7500000000000005e-6 * var_x197 * var_x209 + 1.8750000000000003e-7 * var_x208 * pow(var_x190, 2) / pow(var_x191, 3);
        ...
        IJth(rJacobian, 41, 41) = var_x491 * (-5.0 - 0.023500311662270543 * var_x116) + 1.0 * (0.019557600000000001 * pow(var_x487, (-3.0)) + 8.1780000000000006e-5 * pow(var_x488, (-3.0))) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x486 * var_chaste_interface__membrane__Vm) / pow(var_x489, 2);
        IJth(rJacobian, 0, 42) = mSetVoltageDerivativeToZero ? 0.0 : (1.3365608910938003e-12 * var_x165 + 3.900466760223035 * var_x161 - 242.40944894130814 * var_x162 - 1.0956521739130434 * var_x166 - 19.440000000000001 * var_x168 - 1.1558883089076335e-5 * var_x158 - 0.17362660254749343 * var_x159);
        IJth(rJacobian, 1, 42) = var_x188 * (0.0011994662935305037 * var_x168 - 8.2467064718009662e-17 * var_x165);
        IJth(rJacobian, 42, 42) = -0.14749262536873156 + var_x500 + 2.4740119415402899e-16 * var_x165 - 0.00020280831050032669 * var_x166 - 7.1319396379664657e-10 * var_x158 - 1.0712924764194231e-5 * var_x159 - 0.0035983988805915112 * var_x168 - 0.014956891113086561 * var_x162;
        IJth(rJacobian, 43, 42) = 5.0;
        IJth(rJacobian, 44, 42) = var_x500;
        IJth(rJacobian, 46, 42) = 0.00013520554033355113 * var_x166 + 3.900466760223035 * var_x514;
        IJth(rJacobian, 0, 43) = mSetVoltageDerivativeToZero ? 0.0 : (1.3365608910938003e-12 * var_x171 - 4.8600000000000003 * var_x172);
        IJth(rJacobian, 40, 43) = var_x483 * (0.010165476837671019 * var_x172 - 2.7956334939405277e-15 * var_x171);
        ...
        IJth(rJacobian, 44, 44) = -0.14749262536873156 + var_x501 + var_x505 - 3.7083201106826184e-7 * var_x173;
        ...
        IJth(rJacobian, 0, 46) = mSetVoltageDerivativeToZero ? 0.0 : (212.7914217252065 * var_x161 + 3.2490879693637482 * var_x180 - 13.289113041135074 * var_x181 - 0.073724526620166445 * var_x175 - 0.37007041184822825 * var_x176 - 13.623010353726409 * var_x177 - var_x103 * var_x179);
        IJth(rJacobian, 44, 46) = var_x506;
        IJth(rJacobian, 46, 46) = var_x506 + 212.7914217252065 * var_x514 + 0.00020047178518350236 * var_x180 - 4.5488726691040119e-6 * var_x175 - 2.2833692656630728e-5 * var_x176 - 0.00081995078002871237 * var_x181 - 0.0008405525584213936 * var_x177 - var_x179 * var_x512;
        IJth(rJacobian, 1, 47) = var_x188 * (-var_x206 * var_x220 - var_x214 * var_x219);
        IJth(rJacobian, 37, 47) = 3.5566290975364474e-5 * var_x468 * var_x469 + 6.2357214041141957e-6 * var_x465 * var_x469;
