...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldecker_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x198 = var_x196 * var_x50;
        const double var_x199 = var_x198 * var_x51;
        const double var_x200 = ((var_x7) ? (-var_x199 + 187179.41753901311 * (2.6712338705498262e-6 + var_chaste_interface__membrane__Vm) * (var_x199 + var_x197 * var_x48)) : (var_x56 * var_chaste_interface__membrane__Vm));
        ...
        const double var_x230 = ((var_x7) ? (-var_x198 + var_x209 * (var_x197 + var_x198)) : (var_x55 * var_chaste_interface__membrane__Vm));
        ...
        const double var_x431 = ((var_x426) ? (0.16 * var_x423 + 0.16 * var_x424) : (var_x430 - 0.032000000000000001 * var_x425 * var_x428 / pow(var_x429, 2)));
        ...
        IJth(rJacobian, 30, 0) = (-var_chaste_interface__IKr_xr_gate__xr + 1 / var_x460) * ((var_x469) ? (var_x467 + 0.00014999999999999999 * var_x461 + 0.00014999999999999999 * var_x462) : ((var_x476) ? (var_x475 + 0.00029999999999999997 * var_x470 + 0.00029999999999999997 * var_x471) : (var_x467 + var_x475))) + 0.23529411764705882 * var_x459 * var_x481 / pow(var_x460, 2);
