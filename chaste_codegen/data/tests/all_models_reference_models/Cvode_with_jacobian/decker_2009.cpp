...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldecker_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x425 = 1.0 - var_chaste_interface__INaL_mL_gate__mL;
        const double var_x426 = exp(14.918032786885247 + 0.16393442622950821 * var_chaste_interface__membrane__Vm);
        const double var_x427 = exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x439 = exp(-1.3230057479321462 - 0.14019346698443852 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x451 = var_x449 / pow(var_x450, 2);
        const double var_x452 = 0.0050000000000000001 * var_x451;
        ...
        const double var_x456 = 0.011343308638950427 * var_x455;
        ...
        const double var_x469 = pow(var_x468, 8.0);
        const double var_x470 = 1.0 + var_x469;
        const double var_x471 = NV_Ith_S(mParameters, 1) / var_x470;
        const double var_x472 = var_x467 * var_x471;
        const double var_x473 = var_x472 * var_x54;
        const double var_x474 = 1 / var_x467;
        const double var_x475 = 1.0 + 0.0123 * var_x468;
        const double var_x476 = var_x474 * var_x475;
        const double var_x477 = var_x471 * var_x475;
        const double var_x478 = -var_x158 * var_x477;
        const double var_x479 = -var_chaste_interface__Irel__Irel;
        const double var_x480 = var_x479 - var_x473 * var_chaste_interface__membrane__Vm;
        const double var_x481 = var_x110 * var_x21 * var_chaste_interface__membrane__Vm;
        const double var_x482 = var_x475 * var_x480 / pow((1 + var_x466), 2);
        const double var_x483 = var_x463 * var_x464 / pow(var_x465, 2);
        const double var_x484 = var_x234 * var_x483;
        const double var_x485 = var_x471 * var_x476 * var_x481;
        const double var_x486 = var_x483 * (-1 + var_x217);
        ...
        const double var_x504 = -var_x497 * var_x502 * var_x52 * var_chaste_interface__membrane__Vm;
        const double var_x505 = 3.299618375272375e-16 * var_x152;
        const double var_x506 = 8.2490459381809375e-17 * var_x177;
        ...
        const double var_x520 = 7.555241944301982 * var_x108;
        const double var_x521 = (-6.1702220000015831e-5 - 3.7021332000009499e-5 * var_x7) * NV_Ith_S(mParameters, 16);
        const double var_x522 = var_x3 * var_x521;
        const double var_x523 = 2.6552407831565281e-5 * var_x32;
        const double var_x524 = 2.6031772383887529e-5 * var_x126;
        const double var_x525 = -var_x155 * var_x521;
        ...
        IJth(rJacobian, 26, 0) = (1.0 - var_chaste_interface__INa_h_gate__h) * ((var_x403) ? (0) : (-0.019852941176470591 * var_x404)) - ((var_x403) ? (0.693000693000693 * var_x405 / pow(var_x406, 2)) : (0.28123999999999999 * var_x407 + 108500.0 * var_x408)) * var_chaste_interface__INa_h_gate__h;
        IJth(rJacobian, 27, 0) = (1.0 - var_chaste_interface__INa_j_gate__j) * ((var_x403) ? (0) : (var_x415 + var_x411 * var_x416 * (3.0508668000000001e-6 * var_x413 - 31073.016 * var_x412) - 0.311 * var_x409 * var_x414 * var_x416 / pow(var_x410, 2))) - ((var_x403) ? (-7.6049999999999996e-8 * var_x420 + 0.029999999999999999 * var_x417 * var_x419 / pow(var_x418, 2)) : (-0.001275024 * var_x424 + 0.016701360000000002 * var_x421 * var_x423 / pow(var_x422, 2))) * var_chaste_interface__INa_j_gate__j;
        IJth(rJacobian, 28, 0) = var_x397 * var_x425 + var_x399 * var_chaste_interface__INaL_mL_gate__mL - var_x401 * var_x425;
        IJth(rJacobian, 29, 0) = -0.00027322404371584699 * var_x426 / pow((1.0 + var_x426), 2);
        IJth(rJacobian, 30, 0) = (-var_chaste_interface__IKr_xr_gate__xr + 1 / var_x428) * (var_x431 + var_x434 - 8.1600000000000005e-5 * var_x432 * var_x435 / pow(var_x433, 2) - 4.566e-5 * var_x429 * var_x436 / pow(var_x430, 2)) + 0.23529411764705882 * var_x427 * (var_x437 + var_x438) / pow(var_x428, 2);
        IJth(rJacobian, 31, 0) = (-var_chaste_interface__Ito1_a_gate__a + 1 / var_x440) * (0.028153807491391791 * var_x442 / pow(var_x443, 2) - 0.11912298256720238 * var_x444 / pow(var_x445, 2)) + 0.14019346698443852 * var_x439 * (var_x446 + var_x447) / pow(var_x440, 2);
        IJth(rJacobian, 32, 0) = -var_x452 * (1.0 - var_chaste_interface__Ito1_i1f_gate__i1f) - var_x456 * var_chaste_interface__Ito1_i1f_gate__i1f;
        IJth(rJacobian, 33, 0) = -var_x456 * var_chaste_interface__Ito1_i1s_gate__i1s - 0.00080000000000000004 * var_x461 * (1.0 - var_chaste_interface__Ito1_i1s_gate__i1s) / pow(var_x462, 2);
        IJth(rJacobian, 34, 0) = -0.00062500000000000001 * var_x451 / (var_x458 + 0.20000000000000001 * var_x459) + 0.078125 * var_x457 * (var_x452 - 0.022222222222222223 * var_x455) / pow((var_x459 + 0.125 * var_x457), 2);
        IJth(rJacobian, 35, 0) = var_x476 * (-var_x473 + var_x112 * var_x472 - var_x123 * var_x472);
        IJth(rJacobian, 38, 0) = -var_x495 * (-0.0004183410516001074 * var_x86 - 3.6584018618208908e-6 * var_x130);
        IJth(rJacobian, 39, 0) = -var_x503 * (var_x498 + 11.313486292006127 * var_x122 * var_x179 - 11.313486292006127 * var_x111 * var_x62);
        ...
        IJth(rJacobian, 43, 0) = -28.283715730015317 * var_x118 + var_x520 * var_chaste_interface__Ito2_i2f_gate__i2f + 0.28283715730015319 * var_x134 * var_x59;
        IJth(rJacobian, 44, 0) = var_x522 + 2.6284446063875757e-7 * var_x140 + 1.7241823267250181e-6 * var_x120 + 6.4594042531848857e-6 * var_x115 - 1.0318096989969203e-5 * var_x38 - 6.1702220000015831e-5 * var_x2 - 6.1702220000015831e-5 * var_x58 - 2.7083455988196588e-5 * var_x50 - 1.1218585454548334e-7 * var_x133 - var_x125 * var_x524 - var_x523 * var_chaste_interface__IKr_xr_gate__xr;
        ...
        IJth(rJacobian, 38, 1) = 5.0 * var_x494;
        IJth(rJacobian, 40, 1) = 0.00014808532800003802 * var_x146 - 4.6276665000011881e-12 * var_x148 - var_x149 * var_x505;
        ...
        IJth(rJacobian, 35, 19) = var_x478;
        IJth(rJacobian, 39, 19) = var_x504;
        ...
        IJth(rJacobian, 35, 21) = var_x478;
        IJth(rJacobian, 39, 21) = var_x504;
        ...
        IJth(rJacobian, 26, 26) = -((var_x403) ? (0) : (0.13500000000000001 * var_x404)) - ((var_x403) ? (7.6923076923076916 / var_x406) : (310000.0 * var_x408 + 3.5600000000000001 * var_x407));
        IJth(rJacobian, 40, 26) = -6.1702220000015831e-5 * var_x165;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x166);
        IJth(rJacobian, 27, 27) = -((var_x403) ? (0) : (var_x415 * var_x416)) - ((var_x403) ? (0.29999999999999999 * var_x420) : (0.1212 * var_x424));
        ...
        IJth(rJacobian, 43, 34) = var_x520 * var_chaste_interface__membrane__Vm;
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (-1155.8403904801075 * var_x173);
        IJth(rJacobian, 35, 35) = -var_x476;
        IJth(rJacobian, 36, 35) = -var_x489;
        IJth(rJacobian, 38, 35) = 0.23999999999999996 * var_x494;
        IJth(rJacobian, 43, 35) = 2.4176774221766348 * var_x173;
        IJth(rJacobian, 35, 36) = -0.0123 * var_x474 * var_x480 / pow(var_chaste_interface__Ca__Ca_JSR, 2) - 115584.03904801075 * var_x468 * var_x469 * var_x475 * var_x481 * NV_Ith_S(mParameters, 1) / pow(var_x470, 2);
        IJth(rJacobian, 36, 36) = -var_x490 + 0.25 * (var_x479 + 0.040000000000000001 * var_chaste_interface__Ca__Ca_NSR - 0.040000000000000001 * var_chaste_interface__Ca__Ca_JSR) / (pow(var_x487, 3) * pow((0.125 + var_x488), 2));
        IJth(rJacobian, 37, 36) = 0.0034782608695652171;
        IJth(rJacobian, 1, 37) = var_x211 * var_x232;
        IJth(rJacobian, 36, 37) = var_x490;
        ...
        IJth(rJacobian, 35, 38) = -4.6767910530856466e-10 * var_x482 * var_x484 - 0.00015245548929017591 * var_x484 * var_x485;
        IJth(rJacobian, 37, 38) = var_x239 + var_x228 * var_x240;
        IJth(rJacobian, 38, 38) = -var_x495 * (5.5 + 0.0004183410516001074 * var_x174 - 1.3073157862503357e-11 * var_x176 - var_x149 * var_x496) - (0.019557600000000001 / pow(var_x491, 3) + 8.1780000000000006e-5 / pow(var_x492, 3)) * (5.5 * var_chaste_interface__Ca__Ca_ss_sr - 0.5 * var_chaste_interface__Ca__Ca_ss_CaL - 0.23999999999999996 * var_chaste_interface__Irel__Irel - 5.0 * var_chaste_interface__Ca__Ca_i - 0.0004183410516001074 * var_x233) / pow(var_x493, 2);
        IJth(rJacobian, 39, 38) = 5.0 * var_x502;
        IJth(rJacobian, 40, 38) = 3.7021332000009505e-5 * var_x174 - 1.156916625000297e-12 * var_x176 - var_x149 * var_x506;
        IJth(rJacobian, 41, 38) = 0.0012550231548003222 * var_x174 - 3.9219473587510072e-11 * var_x176 - var_x149 * var_x514;
        ...
        IJth(rJacobian, 35, 39) = -var_x180 * var_x477;
        IJth(rJacobian, 38, 39) = 0.5 * var_x494;
        IJth(rJacobian, 39, 39) = -var_x503 * (5.0 + var_x179 * var_x497) - (0.019557600000000001 / pow(var_x499, 3) + 8.1780000000000006e-5 / pow(var_x500, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_CaL - 5.0 * var_chaste_interface__Ca__Ca_ss_sr + var_x498 * var_chaste_interface__membrane__Vm) / pow(var_x501, 2);
        ...
        IJth(rJacobian, 40, 40) = -0.14749262536873156 + var_x512 + 1.2152060064426631e-5 * var_x186 - 0.0016482105995215921 * var_x182 - 0.0016482105995215921 * var_x184 - 3.1595356167509241e-5 * var_x188 - 0.00044425598400011404 * var_x193 - 0.22286849393221186 * var_x183 - var_x191 * var_x505;
        IJth(rJacobian, 41, 40) = 5.0;
        IJth(rJacobian, 42, 40) = var_x512;
        IJth(rJacobian, 44, 40) = 2.1063570778339494e-5 * var_x188 + 0.48963716847178318 * var_x526 - 8.1013733762844218e-6 * var_x186;
        ...
        IJth(rJacobian, 38, 41) = -var_x495 * (-0.0012550231548003222 * var_x196 - var_x195 * var_x496);
        IJth(rJacobian, 40, 41) = 0.14749262536873156 - 0.00011106399600002851 * var_x196 - var_x195 * var_x506;
        IJth(rJacobian, 41, 41) = -5.0 - 0.0037650694644009667 * var_x196 - var_x195 * var_x514;
        IJth(rJacobian, 0, 42) = mSetVoltageDerivativeToZero ? 0.0 : (26.712338705498265 * var_x198 - 3612.0012202503358 * var_x199);
        IJth(rJacobian, 40, 42) = var_x513;
        IJth(rJacobian, 42, 42) = -0.14749262536873156 + var_x513 + var_x518 - 0.0016482105995215921 * var_x198;
        IJth(rJacobian, 43, 42) = 5.0 + 7.555241944301982 * var_x199;
        IJth(rJacobian, 44, 42) = var_x518;
        ...
        IJth(rJacobian, 42, 44) = var_x519;
        IJth(rJacobian, 44, 44) = var_x519 + 0.00017254579424681073 * var_x206 + 26.712338705498265 * var_x526 - 0.00070927691144329649 * var_x202 - 0.0016482105995215921 * var_x200 - 0.0016482105995215921 * var_x205 - 0.00072346244967216237 * var_x201 - var_x204 * var_x524;
        IJth(rJacobian, 1, 45) = var_x212 * (-0.081415929203539822 * var_x245 - var_x229 * var_x246);
        IJth(rJacobian, 35, 45) = 6.2357214041141957e-6 * var_x482 * var_x486 + 2.0327398572023454 * var_x485 * var_x486;
        IJth(rJacobian, 37, 45) = var_x245 + var_x228 * var_x246;
        IJth(rJacobian, 45, 45) = -0.00068000000000000005 - var_x221 * var_x527 + var_x214 * var_x242 * var_x527;
    }
