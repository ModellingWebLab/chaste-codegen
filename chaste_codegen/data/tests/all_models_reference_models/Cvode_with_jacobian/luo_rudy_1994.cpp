...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellluo_rudy_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x131 = 1.0 * var_x128;
        const double var_x132 = var_x129 * var_x32;
        const double var_x133 = var_x79 * var_chaste_interface__membrane__V;
        const double var_x134 = var_x133 * var_x76;
        const double var_x135 = var_x121 * var_x78;
        const double var_x136 = var_x135 * var_x76;
        const double var_x137 = var_x30 * var_x63 * var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        const double var_x138 = var_x10 + var_x20 * var_x7;
        const double var_x139 = var_x18 * var_x57;
        ...
        const double var_x144 = var_x143 * var_x58;
        const double var_x145 = 4.7759072889811619e-6 * var_x144;
        const double var_x146 = var_x65 * var_x66 * var_x71 / (var_x70 * pow((0.031622776601683791 + var_x66), 2));
        const double var_x147 = 0.00016947874999999999 * var_x143;
        const double var_x148 = var_x59 * var_x7;
        const double var_x149 = 6.3678763853082156e-6 * var_x148;
        const double var_x150 = var_x12 * var_x149 + var_x149 * var_x21 - var_x12 * var_x147 - var_x147 * var_x21;
        ...
        const double var_x157 = 0.00011935049112322121 * var_x90;
        ...
        const double var_x161 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x190 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x199 = var_x198 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x200 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x201 = 0.005608974358974359 * var_x191 * var_x200;
        const double var_x202 = var_x201 / pow(var_x192, 2);
        const double var_x203 = var_x193 * var_x201 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x204 = var_x194 * var_x200;
        const double var_x205 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        const double var_x209 = 0.029999999999999999 * var_x207 / pow(var_x208, 2);
        ...
        const double var_x212 = 0.11627906976744186 * var_x210 / pow(var_x211, 2);
        ...
        const double var_x217 = var_x206 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V);
        const double var_x218 = 1.0 - var_x214 - var_x215;
        const double var_x219 = 1.0 - var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        ...
        const double var_x228 = 7.2663761489674998e-10 * var_x59;
        const double var_x229 = 5.4497821117256254e-10 * var_x92;
        const double var_x230 = 7.4594056952013249e-8 * var_x94;
        const double var_x231 = 1.0025441254350579e-16 * var_x118;
        const double var_x232 = 0.0030369936192764057 * var_x127;
        ...
        const double var_x237 = 1.4504399962891466e-8 * var_x144;
        const double var_x238 = 2.1328374802575643e-8 * var_x83;
        const double var_x239 = 0.0012812882037032361 * var_x101;
        const double var_x240 = var_x12 * var_x235 - var_x12 * var_x234;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-4.426e-5 + 9.2286828271246209e-7 * var_x105 + 2.6387196824222991e-7 * var_x106 + 3.7804821863291499e-5 * var_x64 + 0.0059063570093597579 * var_x108 + 0.10468673984798647 * var_x98 - 1.0 * var_x34 - 20.0 * var_x44 - 0.000183 * var_x3 - 0.014999999999999999 * var_x72 - 0.4389381125701739 * var_x56 - 6.9215121203434662e-7 * var_x110 - 0.048845293589318314 * var_x73 - 1.9790397618167244e-7 * var_x111 - 3.0602006688963209e-5 * var_x25 - 0.0012135347818116574 * var_x31 - 0.0059063570093597579 * var_x112 + var_x12 * var_x60 + var_x21 * var_x60 - var_x100 * var_x102 - var_x12 * var_x18 - var_x18 * var_x21 - var_x80 * var_x91 - var_x81 * var_x84 - var_x81 * var_x95 - var_x93 * var_chaste_interface__ionic_concentrations__Ki - var_x93 * var_chaste_interface__ionic_concentrations__Nai));
        IJth(rJacobian, 1, 0) = -4.5797863778688198e-8 + 0.030369936192764058 * var_x44 + 7.4171422481221223e-5 * var_x73 + 8.9687842752970284e-6 * var_x108 - 8.9687842752970284e-6 * var_x112 - var_x157 * var_x80;
        IJth(rJacobian, 2, 0) = var_x161 * var_x165 + 0.0072727272727272727 * var_x166 * var_chaste_interface__fast_sodium_current_m_gate__m - 0.032000000000000001 * var_x161 * var_x163 * var_x167 / pow(var_x164, 2);
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) * ((var_x169) ? (-0.019852941176470591 * var_x168) : (0)) - ((var_x169) ? (0.28123999999999999 * var_x170 + 108500.0 * var_x171) : (0.693000693000693 * var_x172 / pow(var_x173, 2))) * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__fast_sodium_current_j_gate__j) * ((var_x169) ? (var_x180 + var_x176 * var_x181 * (1.5254334000000001e-6 * var_x178 - 31073.016 * var_x177) - 0.311 * var_x174 * var_x179 * var_x181 / pow(var_x175, 2)) : (0)) - ((var_x169) ? (-0.001275024 * var_x185 + 0.016701360000000002 * var_x182 * var_x184 / pow(var_x183, 2)) : (-7.6049999999999996e-8 * var_x189 + 0.029999999999999999 * var_x186 * var_x188 / pow(var_x187, 2))) * var_chaste_interface__fast_sodium_current_j_gate__j;
        IJth(rJacobian, 5, 0) = var_x190 * var_x194 + var_x196 * var_x203 + var_x197 * var_x203 + var_x199 * var_x202 - var_x190 * var_x202 - var_x194 * var_x199;
        IJth(rJacobian, 6, 0) = var_x205 * var_x216 * var_x217 + var_x205 * (0.02 + var_x206) * (var_x209 - var_x212) + var_x213 * (var_x212 - var_x209) * var_chaste_interface__L_type_Ca_channel_f_gate__f - var_x217 * var_x218 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 7, 0) = var_x219 * var_x222 - var_x225 * var_chaste_interface__time_dependent_potassium_current_X_gate__X + 8.9997000000000013e-6 * var_x223 * var_x226 * var_chaste_interface__time_dependent_potassium_current_X_gate__X / pow(var_x224, 2) - 1.0641199999999999e-5 * var_x219 * var_x220 * var_x226 / pow(var_x221, 2);
        IJth(rJacobian, 8, 0) = -4.2821610031797325e-8 + 2.8027450860303217e-9 * var_x105 - 2.1020588145227411e-9 * var_x110 - 0.00013666471286743825 * var_x72 - 0.18221961715658433 * var_x44 - 0.0030369936192764057 * var_x34 - 0.00044502853488732734 * var_x73 + var_x21 * var_x228 - var_x21 * var_x227 - var_x229 * var_chaste_interface__ionic_concentrations__Nai - var_x230 * var_x81;
        IJth(rJacobian, 9, 0) = 9.110980857829217e-5 * var_x72 + 1.1481300277669745e-7 * var_x64 + 0.00031793296094118393 * var_x98 + 8.0137748385755867e-10 * var_x106 - 5.5576983232758224e-7 * var_x3 - 9.2938099051435146e-8 * var_x25 - 0.0013330522471328469 * var_x56 - 3.6854973891319883e-6 * var_x31 - 6.0103311289316898e-10 * var_x111 + var_x12 * var_x228 - var_x100 * var_x239 - var_x12 * var_x227 - var_x229 * var_chaste_interface__ionic_concentrations__Ki - var_x238 * var_x81;
        ...
        IJth(rJacobian, 1, 1) = 8.5932353608719255e-11 * var_x125 + 1.7462713310839333e-5 * var_x116 + 0.00040588235294117644 * var_x160 - 0.030369936192764058 * var_x117 - 0.00011935049112322121 * var_x120 - 6.0944687335561951e-7 * var_x115 - 1.7462713310839333e-5 * var_x114 - 0.00040588235294117644 * var_x159;
        IJth(rJacobian, 8, 1) = 0.18221961715658433 * var_x117 + 5.3707721005449532e-14 * var_x126 - var_x21 * var_x231;
        IJth(rJacobian, 9, 1) = 1.5356429857854459e-14 * var_x124 - var_x12 * var_x231;
        IJth(rJacobian, 11, 1) = 0.0050000000000000001 * var_x159 - 0.0050000000000000001 * var_x160;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x128 * var_x130);
        IJth(rJacobian, 2, 2) = -0.080000000000000002 * var_x166 - var_x165 * var_x167;
        IJth(rJacobian, 8, 2) = -0.0091109808578292168 * var_x127 * var_x130;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x131 * var_x33);
        IJth(rJacobian, 3, 3) = -((var_x169) ? (0.13500000000000001 * var_x168) : (0)) - ((var_x169) ? (310000.0 * var_x171 + 3.5600000000000001 * var_x170) : (7.6923076923076916 / var_x173));
        IJth(rJacobian, 8, 3) = -var_x232 * var_x33;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x131 * var_x132);
        IJth(rJacobian, 4, 4) = -((var_x169) ? (0.1212 * var_x185) : (0.29999999999999999 * var_x189)) - ((var_x169) ? (var_x180 * var_x181) : (0));
        IJth(rJacobian, 8, 4) = -var_x132 * var_x232;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-var_x133 * var_x91 - var_x134 * var_x84 - var_x134 * var_x95));
        IJth(rJacobian, 1, 5) = -var_x133 * var_x157;
        IJth(rJacobian, 5, 5) = -var_x204 - var_x198 * var_x204;
        IJth(rJacobian, 8, 5) = -var_x134 * var_x230;
        IJth(rJacobian, 9, 5) = -var_x134 * var_x238;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-var_x135 * var_x91 - var_x136 * var_x84 - var_x136 * var_x95));
        IJth(rJacobian, 1, 6) = -var_x135 * var_x157;
        IJth(rJacobian, 6, 6) = var_x213 * var_x216 + var_x213 * var_x218;
        IJth(rJacobian, 8, 6) = -var_x136 * var_x230;
        IJth(rJacobian, 9, 6) = -var_x136 * var_x238;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0024270695636233147 * var_x0 * var_x137);
        IJth(rJacobian, 7, 7) = -var_x222 * var_x226 - var_x225 * var_x226;
        IJth(rJacobian, 9, 7) = -7.3709947782639767e-6 * var_x137;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (var_x150 - 60.0 * var_x142 - 1.8421356686070195e-5 * var_x109 - 0.000592018558817993 * var_x140 - 0.00071151247353788531 * var_x146 - 0.0003752664515462853 * var_x65 - 26.614641953637257 * var_x141 - var_x138 * var_x139 - var_x145 * var_chaste_interface__ionic_concentrations__Ki));
        IJth(rJacobian, 1, 8) = 0.091109808578292165 * var_x142;
        IJth(rJacobian, 8, 8) = var_x236 - 5.594554271400994e-8 * var_x109 - 0.54665885146975302 * var_x142 - 1.139681818874567e-6 * var_x65 - 0.080828497792522477 * var_x141 - 6.4825765265103909e-6 * var_x146 - var_x138 * var_x233;
        IJth(rJacobian, 9, 8) = var_x240 + 4.3217176843402606e-6 * var_x146 - 1.7979565856234583e-6 * var_x140 - var_x237 * var_chaste_interface__ionic_concentrations__Ki;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (var_x150 + 2.78620009834773 * var_x156 - 0.032297793716202568 * var_x140 - 0.0048704794775156178 * var_x151 - 5.2671434672763675e-6 * var_x109 - 11.682180705860503 * var_x153 - var_x102 * var_x155 - var_x139 * var_x152 - var_x145 * var_chaste_interface__ionic_concentrations__Nai));
        IJth(rJacobian, 8, 9) = var_x236 - var_x237 * var_chaste_interface__ionic_concentrations__Nai;
        IJth(rJacobian, 9, 9) = var_x240 + 0.0084616719207093495 * var_x156 - 1.5996281101931733e-8 * var_x109 - 0.035478708262932285 * var_x153 - 9.808819343281279e-5 * var_x140 - 1.4791615096031613e-5 * var_x151 - var_x152 * var_x233 - var_x155 * var_x239;
