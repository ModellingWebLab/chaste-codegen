...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellluo_rudy_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x59 = -0.34000000000000002 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x82 = pow(NV_Ith_S(mParameters, 2), 3);
        const double var_x83 = var_x81 * var_x82;
        const double var_x84 = var_x83 * var_chaste_interface__ionic_concentrations__Cai;
        const double var_x85 = NV_Ith_S(mParameters, 0) * exp(0.013150655966354929 * var_chaste_interface__membrane__V);
        ...
        const double var_x88 = 1 / ((669921.875 + var_x82) * (1.3799999999999999 + NV_Ith_S(mParameters, 0)));
        ...
        const double var_x101 = var_x28 * NV_Ith_S(mParameters, 5) / (var_x100 + 1.02 * var_x93);
        ...
        const double var_x108 = -26.614641953637257 * log(var_x107 * (0.018329999999999999 * NV_Ith_S(mParameters, 2) + NV_Ith_S(mParameters, 1))) + var_chaste_interface__membrane__V;
        ...
        const double var_x113 = exp(0.01485884101040119 * NV_Ith_S(mParameters, 2));
        ...
        const double var_x116 = NV_Ith_S(mParameters, 1) / (1.5 + NV_Ith_S(mParameters, 1));
        ...
        const double var_x126 = var_x23 * var_x28 * var_x93 * NV_Ith_S(mParameters, 5) / pow((var_x93 + 0.98039215686274506 * var_x100), 2);
        ...
        const double var_x135 = 6.5370375000000006e-11 * var_x76;
        const double var_x136 = -0.5 + 187866.5138050704 * var_chaste_interface__membrane__V;
        const double var_x137 = ((var_x42) ? (var_x135 - var_x136 * (-var_x135 - 6.5370375000000006e-11 * var_x77)) : (var_x79 * var_chaste_interface__membrane__V));
        const double var_x138 = var_x137 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        const double var_x140 = 7.1999999999999988e-7 * var_x139;
        const double var_x141 = 1.8691085000000002e-11 * var_x37;
        const double var_x142 = ((var_x42) ? (var_x141 - var_x136 * (-var_x141 - 1.8691085000000002e-11 * var_x40)) : (var_x47 * var_chaste_interface__membrane__V));
        const double var_x143 = var_x140 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        const double var_x146 = var_x103 * var_x15 / (pow(var_x12, 2) * pow(var_chaste_interface__ionic_concentrations__Cai, 4));
        const double var_x147 = 3.301107118143778e-14 * var_x146;
        const double var_x148 = -26.614641953637257 * log(var_x110 * NV_Ith_S(mParameters, 2)) + var_chaste_interface__membrane__V;
        const double var_x149 = var_x0 * var_x148;
        const double var_x150 = NV_Ith_S(mParameters, 4) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x151 = var_x150 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x152 = var_x150 * var_x31;
        const double var_x153 = var_x54 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x154 = var_x108 * var_x29 * var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        ...
        const double var_x161 = var_x103 * var_x17;
        ...
        const double var_x166 = var_x104 * var_x165;
        const double var_x167 = 4.7759072889811619e-6 * var_x166;
        const double var_x168 = var_x110 * var_x111 * var_x116 / (var_x115 * pow((0.031622776601683791 + var_x111), 2));
        const double var_x169 = 0.00016947874999999999 * var_x165;
        const double var_x170 = var_x105 * var_x6;
        const double var_x171 = 6.3678763853082156e-6 * var_x170;
        const double var_x172 = var_x11 * var_x171 + var_x171 * var_x20 - var_x11 * var_x169 - var_x169 * var_x20;
        ...
        const double var_x187 = 0.0015184968096382029 * var_x145;
        const double var_x188 = var_x53 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x236 = 0.005608974358974359 * var_x221 * var_x231;
        const double var_x237 = ((var_x232) ? (4.7698560017679535e-16 * (-36688738598216.805 * var_x226 - 36688738598216.805 * var_x229) / pow((-var_x226 + 0.017500000000000002 * var_x230), 2)) : (var_x235 - var_x234 * var_x236 - var_x222 * var_x236 / pow(var_x233, 2)));
        const double var_x238 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x239 = ((var_x232) ? (1 / (-var_x227 + 801282.05113355326 * var_x230)) : (var_x231 * var_x235));
        const double var_x240 = 0.16025641025641024 * var_x221 * var_x239 / pow(var_x222, 2);
        const double var_x241 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        const double var_x245 = 0.029999999999999999 * var_x243 / pow(var_x244, 2);
        ...
        const double var_x248 = 0.11627906976744186 * var_x246 / pow(var_x247, 2);
        ...
        const double var_x253 = var_x242 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V);
        ...
        const double var_x274 = 7.2663761489674998e-10 * var_x105;
        const double var_x275 = 5.4497821117256254e-10 * var_x119;
        const double var_x276 = 1.0025441254350579e-16 * var_x146;
        const double var_x277 = 0.0030369936192764057 * var_x148;
        const double var_x278 = 0.0030369936192764057 * var_x188;
        ...
        const double var_x283 = 1.4504399962891466e-8 * var_x166;
        const double var_x284 = 0.0012812882037032361 * var_x126;
        const double var_x285 = var_x11 * var_x281 - var_x11 * var_x280;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-4.426e-5 - var_x33 + 0.10468673984798647 * var_x123 + 3.7804821863291499e-5 * var_x109 - 20.0 * var_x90 - 0.000183 * var_x3 - 0.014999999999999999 * var_x117 - 0.048845293589318314 * var_x118 - 3.0602006688963209e-5 * var_x24 - 0.0012135347818116574 * var_x30 - 0.4389381125701739 * var_x102 + var_x106 * var_x11 + var_x106 * var_x20 - var_x11 * var_x17 - var_x120 * var_chaste_interface__ionic_concentrations__Ki - var_x120 * var_chaste_interface__ionic_concentrations__Nai - var_x125 * var_x127 - var_x17 * var_x20 - var_x51 * var_x56 - var_x56 * var_x74 - var_x56 * var_x80));
        IJth(rJacobian, 1, 0) = -4.5797863778688198e-8 + 0.030369936192764058 * var_x90 + 7.4171422481221223e-5 * var_x118 - var_x182 * var_x74;
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x192) ? (0.15999999943156581 * var_x189 + 0.16000000056843419 * var_x190) : (var_x196 - 0.032000000000000001 * var_x191 * var_x194 / pow(var_x195, 2))) + 0.0072727272727272727 * var_x197 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) * ((var_x200) ? (-0.019852941176470591 * var_x199) : (0)) - ((var_x200) ? (0.28123999999999999 * var_x201 + 108500.0 * var_x202) : (0.693000693000693 * var_x203 / pow(var_x204, 2))) * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__fast_sodium_current_j_gate__j) * ((var_x200) ? (var_x211 + var_x207 * var_x212 * (1.5254334000000001e-6 * var_x209 - 31073.016 * var_x208) - 0.311 * var_x205 * var_x210 * var_x212 / pow(var_x206, 2)) : (0)) - ((var_x200) ? (-0.001275024 * var_x216 + 0.016701360000000002 * var_x213 * var_x215 / pow(var_x214, 2)) : (-7.6049999999999996e-8 * var_x220 + 0.029999999999999999 * var_x217 * var_x219 / pow(var_x218, 2))) * var_chaste_interface__fast_sodium_current_j_gate__j;
        IJth(rJacobian, 5, 0) = var_x238 * var_x240 + var_x240 * var_chaste_interface__L_type_Ca_channel_d_gate__d + var_x223 * var_x237 * var_x238 + var_x224 * var_x237 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        IJth(rJacobian, 6, 0) = var_x241 * var_x252 * var_x253 + var_x241 * (0.02 + var_x242) * (var_x245 - var_x248) + var_x249 * (var_x248 - var_x245) * var_chaste_interface__L_type_Ca_channel_f_gate__f - var_x253 * var_x254 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 7, 0) = (1.0 - var_chaste_interface__time_dependent_potassium_current_X_gate__X) * ((var_x259) ? (3.595e-5 * var_x255 + 3.595e-5 * var_x256) : (var_x262 - 1.0641199999999999e-5 * var_x257 * var_x260 / pow(var_x261, 2))) - ((var_x265) ? (6.5500000000000006e-5 * var_x263 + 6.5500000000000006e-5 * var_x264) : (var_x268 - 8.9997000000000013e-6 * var_x257 * var_x266 / pow(var_x267, 2))) * var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        IJth(rJacobian, 8, 0) = -4.2821610031797325e-8 - 0.00013666471286743825 * var_x117 - 0.18221961715658433 * var_x90 - 0.0030369936192764057 * var_x33 - 0.00044502853488732734 * var_x118 + var_x20 * var_x274 - var_x20 * var_x271 - var_x273 * var_x80 - var_x275 * var_chaste_interface__ionic_concentrations__Nai;
        IJth(rJacobian, 9, 0) = 9.110980857829217e-5 * var_x117 + 1.1481300277669745e-7 * var_x109 + 0.00031793296094118393 * var_x123 - 5.5576983232758224e-7 * var_x3 - 9.2938099051435146e-8 * var_x24 - 0.0013330522471328469 * var_x102 - 3.6854973891319883e-6 * var_x30 + var_x11 * var_x274 - var_x11 * var_x271 - var_x125 * var_x284 - var_x273 * var_x51 - var_x275 * var_chaste_interface__ionic_concentrations__Ki;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (20.0 * var_x134 + 0.0115 * var_x131 - 0.0115 * var_x129 - 0.00040134880066084979 * var_x130 + var_x138 * var_x140 + var_x142 * var_x143 + var_x143 * var_x145 - var_x11 * var_x147 - var_x133 * var_x56 - var_x147 * var_x20));
        IJth(rJacobian, 1, 1) = 1.7462713310839333e-5 * var_x131 + 0.00040588235294117644 * var_x185 - 0.030369936192764058 * var_x134 - 6.0944687335561951e-7 * var_x130 - 1.7462713310839333e-5 * var_x129 - 0.00040588235294117644 * var_x184 - var_x133 * var_x182 + 1.0933177029395058e-9 * var_x145 * var_x186;
        IJth(rJacobian, 8, 1) = 0.18221961715658433 * var_x134 - var_x20 * var_x276 + 2.1866354058790117e-9 * var_x138 * var_x139;
        IJth(rJacobian, 9, 1) = -var_x11 * var_x276 + 2.1866354058790117e-9 * var_x142 * var_x186;
        IJth(rJacobian, 11, 1) = 0.0050000000000000001 * var_x184 - 0.0050000000000000001 * var_x185;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x149 * var_x151);
        IJth(rJacobian, 2, 2) = -((var_x192) ? (-var_x198 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x198 + 3.1999999919207769e-7 * var_x189)) : (var_x191 * var_x196)) - 0.080000000000000002 * var_x197;
        IJth(rJacobian, 8, 2) = -0.0091109808578292168 * var_x148 * var_x151;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x149 * var_x32);
        IJth(rJacobian, 3, 3) = -((var_x200) ? (0.13500000000000001 * var_x199) : (0)) - ((var_x200) ? (310000.0 * var_x202 + 3.5600000000000001 * var_x201) : (7.6923076923076916 / var_x204));
        IJth(rJacobian, 8, 3) = -var_x277 * var_x32;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x149 * var_x152);
        IJth(rJacobian, 4, 4) = -((var_x200) ? (0.1212 * var_x216) : (0.29999999999999999 * var_x220)) - ((var_x200) ? (var_x211 * var_x212) : (0));
        IJth(rJacobian, 8, 4) = -var_x152 * var_x277;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-var_x138 * var_x54 - var_x142 * var_x55 - var_x145 * var_x55));
        IJth(rJacobian, 1, 5) = -var_x181 * var_x187;
        IJth(rJacobian, 5, 5) = var_x224 * var_x239 - var_x223 * var_x239;
        IJth(rJacobian, 8, 5) = -0.0030369936192764057 * var_x138 * var_x53;
        IJth(rJacobian, 9, 5) = -var_x142 * var_x272;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-var_x137 * var_x153 - var_x142 * var_x153 - var_x145 * var_x153));
        IJth(rJacobian, 1, 6) = -var_x187 * var_x188;
        IJth(rJacobian, 6, 6) = var_x249 * var_x252 + var_x249 * var_x254;
        IJth(rJacobian, 8, 6) = -var_x137 * var_x278;
        IJth(rJacobian, 9, 6) = -var_x142 * var_x278;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0024270695636233147 * var_x0 * var_x154);
        IJth(rJacobian, 7, 7) = -((var_x265) ? (var_x269 - 343500.00025585521 * (29.999998544395925 + var_chaste_interface__membrane__V) * (-var_x269 - 1.9068413377354434e-10 * var_x264)) : (var_x257 * var_x268)) - ((var_x259) ? (-var_x270 + 740000.00029091549 * (30.000000675675675 + var_chaste_interface__membrane__V) * (var_x270 + 4.8581081061982445e-11 * var_x256)) : (var_x257 * var_x262));
        IJth(rJacobian, 9, 7) = -7.3709947782639767e-6 * var_x154;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (var_x172 - 60.0 * var_x164 - 0.000592018558817993 * var_x162 - 0.00071151247353788531 * var_x168 - 0.0003752664515462853 * var_x110 - 26.614641953637257 * var_x163 - var_x159 * var_x56 - var_x160 * var_x161 - var_x167 * var_chaste_interface__ionic_concentrations__Ki));
        IJth(rJacobian, 1, 8) = 0.091109808578292165 * var_x164;
        IJth(rJacobian, 8, 8) = var_x282 - 0.54665885146975302 * var_x164 - 1.139681818874567e-6 * var_x110 - 0.080828497792522477 * var_x163 - 6.4825765265103909e-6 * var_x168 - var_x159 * var_x273 - var_x160 * var_x279;
        IJth(rJacobian, 9, 8) = var_x285 + 4.3217176843402606e-6 * var_x168 - 1.7979565856234583e-6 * var_x162 - var_x283 * var_chaste_interface__ionic_concentrations__Ki;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (var_x172 + 2.78620009834773 * var_x180 - 11.682180705860503 * var_x177 - 0.032297793716202568 * var_x162 - 0.0048704794775156178 * var_x173 - var_x127 * var_x179 - var_x161 * var_x176 - var_x167 * var_chaste_interface__ionic_concentrations__Nai - var_x175 * var_x56));
        IJth(rJacobian, 8, 9) = var_x282 - var_x283 * var_chaste_interface__ionic_concentrations__Nai;
        IJth(rJacobian, 9, 9) = var_x285 + 0.0084616719207093495 * var_x180 - 0.035478708262932285 * var_x177 - 9.808819343281279e-5 * var_x162 - 1.4791615096031613e-5 * var_x173 - var_x175 * var_x273 - var_x176 * var_x279 - var_x179 * var_x284;
