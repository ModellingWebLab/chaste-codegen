...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellluo_rudy_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x129 = 1.0 * var_x126;
        const double var_x130 = var_x127 * var_x31;
        const double var_x131 = var_x77 * var_chaste_interface__membrane__V;
        const double var_x132 = var_x131 * var_x74;
        const double var_x133 = var_x119 * var_x76;
        const double var_x134 = var_x133 * var_x74;
        const double var_x135 = var_x29 * var_x61 * var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        const double var_x136 = var_x9 + var_x19 * var_x6;
        const double var_x137 = var_x17 * var_x56;
        ...
        const double var_x143 = 4.7759072889811619e-6 * var_x142;
        const double var_x144 = var_x63 * var_x64 * var_x69 / (var_x68 * pow((0.031622776601683791 + var_x64), 2));
        const double var_x145 = 0.00016947874999999999 * var_x141;
        const double var_x146 = var_x58 * var_x6;
        const double var_x147 = 6.3678763853082156e-6 * var_x146;
        const double var_x148 = var_x11 * var_x147 + var_x147 * var_x20 - var_x11 * var_x145 - var_x145 * var_x20;
        ...
        const double var_x155 = 0.00011935049112322121 * var_x88;
        ...
        const double var_x159 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x188 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x197 = var_x196 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x198 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x199 = 0.005608974358974359 * var_x189 * var_x198;
        const double var_x200 = var_x199 / pow(var_x190, 2);
        const double var_x201 = var_x191 * var_x199 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x202 = var_x192 * var_x198;
        const double var_x203 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        const double var_x207 = 0.029999999999999999 * var_x205 / pow(var_x206, 2);
        ...
        const double var_x210 = 0.11627906976744186 * var_x208 / pow(var_x209, 2);
        ...
        const double var_x215 = var_x204 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V);
        ...
        const double var_x226 = 7.2663761489674998e-10 * var_x58;
        const double var_x227 = 5.4497821117256254e-10 * var_x90;
        const double var_x228 = 7.4594056952013249e-8 * var_x92;
        const double var_x229 = 1.0025441254350579e-16 * var_x116;
        const double var_x230 = 0.0030369936192764057 * var_x125;
        ...
        const double var_x235 = 1.4504399962891466e-8 * var_x142;
        const double var_x236 = 2.1328374802575643e-8 * var_x81;
        const double var_x237 = 0.0012812882037032361 * var_x99;
        const double var_x238 = var_x11 * var_x233 - var_x11 * var_x232;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-4.426e-5 + 9.2286828271246209e-7 * var_x103 + 2.6387196824222991e-7 * var_x104 + 3.7804821863291499e-5 * var_x62 + 0.0059063570093597579 * var_x106 + 0.10468673984798647 * var_x96 - 1.0 * var_x33 - 20.0 * var_x43 - 0.000183 * var_x3 - 0.014999999999999999 * var_x70 - 0.4389381125701739 * var_x55 - 6.9215121203434662e-7 * var_x108 - 0.048845293589318314 * var_x71 - 1.9790397618167244e-7 * var_x109 - 3.0602006688963209e-5 * var_x24 - 0.0012135347818116574 * var_x30 - 0.0059063570093597579 * var_x110 + var_x11 * var_x59 + var_x20 * var_x59 - var_x100 * var_x98 - var_x11 * var_x17 - var_x17 * var_x20 - var_x78 * var_x89 - var_x79 * var_x82 - var_x79 * var_x93 - var_x91 * var_chaste_interface__ionic_concentrations__Ki - var_x91 * var_chaste_interface__ionic_concentrations__Nai));
        IJth(rJacobian, 1, 0) = -4.5797863778688198e-8 + 0.030369936192764058 * var_x43 + 7.4171422481221223e-5 * var_x71 + 8.9687842752970284e-6 * var_x106 - 8.9687842752970284e-6 * var_x110 - var_x155 * var_x78;
        IJth(rJacobian, 2, 0) = var_x159 * var_x163 + 0.0072727272727272727 * var_x164 * var_chaste_interface__fast_sodium_current_m_gate__m - 0.032000000000000001 * var_x159 * var_x161 * var_x165 / pow(var_x162, 2);
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) * ((var_x167) ? (-0.019852941176470591 * var_x166) : (0)) - ((var_x167) ? (0.28123999999999999 * var_x168 + 108500.0 * var_x169) : (0.693000693000693 * var_x170 / pow(var_x171, 2))) * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__fast_sodium_current_j_gate__j) * ((var_x167) ? (var_x178 + var_x174 * var_x179 * (1.5254334000000001e-6 * var_x176 - 31073.016 * var_x175) - 0.311 * var_x172 * var_x177 * var_x179 / pow(var_x173, 2)) : (0)) - ((var_x167) ? (-0.001275024 * var_x183 + 0.016701360000000002 * var_x180 * var_x182 / pow(var_x181, 2)) : (-7.6049999999999996e-8 * var_x187 + 0.029999999999999999 * var_x184 * var_x186 / pow(var_x185, 2))) * var_chaste_interface__fast_sodium_current_j_gate__j;
        IJth(rJacobian, 5, 0) = var_x188 * var_x192 + var_x194 * var_x201 + var_x195 * var_x201 + var_x197 * var_x200 - var_x188 * var_x200 - var_x192 * var_x197;
        IJth(rJacobian, 6, 0) = var_x203 * var_x214 * var_x215 + var_x203 * (0.02 + var_x204) * (var_x207 - var_x210) + var_x211 * (var_x210 - var_x207) * var_chaste_interface__L_type_Ca_channel_f_gate__f - var_x215 * var_x216 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 7, 0) = var_x217 * var_x220 - var_x223 * var_chaste_interface__time_dependent_potassium_current_X_gate__X + 8.9997000000000013e-6 * var_x221 * var_x224 * var_chaste_interface__time_dependent_potassium_current_X_gate__X / pow(var_x222, 2) - 1.0641199999999999e-5 * var_x217 * var_x218 * var_x224 / pow(var_x219, 2);
        IJth(rJacobian, 8, 0) = -4.2821610031797325e-8 + 2.8027450860303217e-9 * var_x103 - 2.1020588145227411e-9 * var_x108 - 0.00013666471286743825 * var_x70 - 0.18221961715658433 * var_x43 - 0.0030369936192764057 * var_x33 - 0.00044502853488732734 * var_x71 + var_x20 * var_x226 - var_x20 * var_x225 - var_x227 * var_chaste_interface__ionic_concentrations__Nai - var_x228 * var_x79;
        IJth(rJacobian, 9, 0) = 9.110980857829217e-5 * var_x70 + 1.1481300277669745e-7 * var_x62 + 0.00031793296094118393 * var_x96 + 8.0137748385755867e-10 * var_x104 - 5.5576983232758224e-7 * var_x3 - 9.2938099051435146e-8 * var_x24 - 0.0013330522471328469 * var_x55 - 3.6854973891319883e-6 * var_x30 - 6.0103311289316898e-10 * var_x109 + var_x11 * var_x226 - var_x11 * var_x225 - var_x227 * var_chaste_interface__ionic_concentrations__Ki - var_x236 * var_x79 - var_x237 * var_x98;
        ...
        IJth(rJacobian, 1, 1) = 8.5932353608719255e-11 * var_x123 + 1.7462713310839333e-5 * var_x114 + 0.00040588235294117644 * var_x158 - 0.030369936192764058 * var_x115 - 0.00011935049112322121 * var_x118 - 6.0944687335561951e-7 * var_x113 - 1.7462713310839333e-5 * var_x112 - 0.00040588235294117644 * var_x157;
        IJth(rJacobian, 8, 1) = 0.18221961715658433 * var_x115 + 5.3707721005449532e-14 * var_x124 - var_x20 * var_x229;
        IJth(rJacobian, 9, 1) = 1.5356429857854459e-14 * var_x122 - var_x11 * var_x229;
        IJth(rJacobian, 11, 1) = 0.0050000000000000001 * var_x157 - 0.0050000000000000001 * var_x158;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x126 * var_x128);
        IJth(rJacobian, 2, 2) = -0.080000000000000002 * var_x164 - var_x163 * var_x165;
        IJth(rJacobian, 8, 2) = -0.0091109808578292168 * var_x125 * var_x128;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x129 * var_x32);
        IJth(rJacobian, 3, 3) = -((var_x167) ? (0.13500000000000001 * var_x166) : (0)) - ((var_x167) ? (310000.0 * var_x169 + 3.5600000000000001 * var_x168) : (7.6923076923076916 / var_x171));
        IJth(rJacobian, 8, 3) = -var_x230 * var_x32;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x129 * var_x130);
        IJth(rJacobian, 4, 4) = -((var_x167) ? (0.1212 * var_x183) : (0.29999999999999999 * var_x187)) - ((var_x167) ? (var_x178 * var_x179) : (0));
        IJth(rJacobian, 8, 4) = -var_x130 * var_x230;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-var_x131 * var_x89 - var_x132 * var_x82 - var_x132 * var_x93));
        IJth(rJacobian, 1, 5) = -var_x131 * var_x155;
        IJth(rJacobian, 5, 5) = -var_x202 - var_x196 * var_x202;
        IJth(rJacobian, 8, 5) = -var_x132 * var_x228;
        IJth(rJacobian, 9, 5) = -var_x132 * var_x236;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-var_x133 * var_x89 - var_x134 * var_x82 - var_x134 * var_x93));
        IJth(rJacobian, 1, 6) = -var_x133 * var_x155;
        IJth(rJacobian, 6, 6) = var_x211 * var_x214 + var_x211 * var_x216;
        IJth(rJacobian, 8, 6) = -var_x134 * var_x228;
        IJth(rJacobian, 9, 6) = -var_x134 * var_x236;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0024270695636233147 * var_x0 * var_x135);
        IJth(rJacobian, 7, 7) = -var_x220 * var_x224 - var_x223 * var_x224;
        IJth(rJacobian, 9, 7) = -7.3709947782639767e-6 * var_x135;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (var_x148 - 60.0 * var_x140 - 1.8421356686070195e-5 * var_x107 - 0.000592018558817993 * var_x138 - 0.00071151247353788531 * var_x144 - 0.0003752664515462853 * var_x63 - 26.614641953637257 * var_x139 - var_x136 * var_x137 - var_x143 * var_chaste_interface__ionic_concentrations__Ki));
        IJth(rJacobian, 1, 8) = 0.091109808578292165 * var_x140;
        IJth(rJacobian, 8, 8) = var_x234 - 5.594554271400994e-8 * var_x107 - 0.54665885146975302 * var_x140 - 1.139681818874567e-6 * var_x63 - 0.080828497792522477 * var_x139 - 6.4825765265103909e-6 * var_x144 - var_x136 * var_x231;
        IJth(rJacobian, 9, 8) = var_x238 + 4.3217176843402606e-6 * var_x144 - 1.7979565856234583e-6 * var_x138 - var_x235 * var_chaste_interface__ionic_concentrations__Ki;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (var_x148 + 2.78620009834773 * var_x154 - 0.032297793716202568 * var_x138 - 0.0048704794775156178 * var_x149 - 5.2671434672763675e-6 * var_x107 - 11.682180705860503 * var_x151 - var_x100 * var_x153 - var_x137 * var_x150 - var_x143 * var_chaste_interface__ionic_concentrations__Nai));
        IJth(rJacobian, 8, 9) = var_x234 - var_x235 * var_chaste_interface__ionic_concentrations__Nai;
        IJth(rJacobian, 9, 9) = var_x238 + 0.0084616719207093495 * var_x154 - 1.5996281101931733e-8 * var_x107 - 0.035478708262932285 * var_x151 - 9.808819343281279e-5 * var_x138 - 1.4791615096031613e-5 * var_x149 - var_x150 * var_x231 - var_x153 * var_x237;
