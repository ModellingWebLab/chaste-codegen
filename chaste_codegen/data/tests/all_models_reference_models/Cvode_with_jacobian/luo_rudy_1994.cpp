...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 2) = 140; // (var_ionic_concentrations__Nao) [mM]
        NV_Ith_S(this->mParameters, 3) = 01; // (var_membrane__Cm) [uF_per_mm2]
        NV_Ith_S(this->mParameters, 4) = 0.16; // (var_fast_sodium_current__g_Na) [mS_per_mm2]
        NV_Ith_S(this->mParameters, 5) = 0074999999999999997; // (var_time_independent_potassium_current__g_K1_max) [mS_per_mm2]
    }
    ...
    double Cellluo_rudy_1994FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_sodium_potassium_pump__sigma = -0.14285714285714285 + 0.14285714285714285 * exp(01485884101040119 * NV_Ith_S(mParameters, 2)); // dimensionless
    ...
    void Cellluo_rudy_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x38 = NV_Ith_S(mParameters, 0) * exp(013150655966354929 * var_chaste_interface__membrane__V);
        ...
        const double var_x61 = -26.614641953637257 * log(var_x60 * (018329999999999999 * NV_Ith_S(mParameters, 2) + NV_Ith_S(mParameters, 1))) + var_chaste_interface__membrane__V;
        ...
        const double var_x66 = exp(01485884101040119 * NV_Ith_S(mParameters, 2));
        ...
        const double var_x144 = 00016947874999999999 * var_x140;
        ...
        const double var_x154 = 00011935049112322121 * var_x88;
        ...
        const double var_x198 = 005608974358974359 * var_x188 * var_x197;
        ...
        const double var_x206 = 029999999999999999 * var_x204 / pow(var_x205, 2);
        ...
        const double var_x214 = var_x203 * (-022713800000000003 - 0022713799999999999 * var_chaste_interface__membrane__V);
        ...
        const double var_x229 = 0030369936192764057 * var_x125;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0 : (var_x0 * (-4.426e-5 - var_x33 + 9.2286828271246209e-7 * var_x103 + 0.10468673984798647 * var_x96 + 2.6387196824222991e-7 * var_x104 + 3.7804821863291499e-5 * var_x62 + 0059063570093597579 * var_x106 - 20 * var_x43 - 000183 * var_x3 - 014999999999999999 * var_x70 - 6.9215121203434662e-7 * var_x108 - 048845293589318314 * var_x71 - 1.9790397618167244e-7 * var_x109 - 3.0602006688963209e-5 * var_x24 - 0012135347818116574 * var_x30 - 0059063570093597579 * var_x110 - 0.4389381125701739 * var_x55 + var_x11 * var_x59 + var_x20 * var_x59 - var_x100 * var_x98 - var_x11 * var_x17 - var_x17 * var_x20 - var_x78 * var_x89 - var_x79 * var_x82 - var_x79 * var_x93 - var_x91 * var_chaste_interface__ionic_concentrations__Ki - var_x91 * var_chaste_interface__ionic_concentrations__Nai));
        IJth(rJacobian, 1, 0) = -4.5797863778688198e-8 + 030369936192764058 * var_x43 + 7.4171422481221223e-5 * var_x71 + 8.9687842752970284e-6 * var_x106 - 8.9687842752970284e-6 * var_x110 - var_x154 * var_x78;
        IJth(rJacobian, 2, 0) = var_x158 * var_x162 + 0072727272727272727 * var_x163 * var_chaste_interface__fast_sodium_current_m_gate__m - 032000000000000001 * var_x158 * var_x160 * var_x164 / pow(var_x161, 2);
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) * ((var_x166) ? (-019852941176470591 * var_x165) : (0)) - ((var_x166) ? (0.28123999999999999 * var_x167 + 108500 * var_x168) : (0.693000693000693 * var_x169 / pow(var_x170, 2))) * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__fast_sodium_current_j_gate__j) * ((var_x166) ? (var_x177 + var_x173 * var_x178 * (1.5254334000000001e-6 * var_x175 - 31073.016 * var_x174) - 0.311 * var_x171 * var_x176 * var_x178 / pow(var_x172, 2)) : (0)) - ((var_x166) ? (-001275024 * var_x182 + 016701360000000002 * var_x179 * var_x181 / pow(var_x180, 2)) : (-7.6049999999999996e-8 * var_x186 + 029999999999999999 * var_x183 * var_x185 / pow(var_x184, 2))) * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        IJth(rJacobian, 6, 0) = var_x202 * var_x213 * var_x214 + var_x202 * (02 + var_x203) * (var_x206 - var_x209) + var_x210 * (var_x209 - var_x206) * var_chaste_interface__L_type_Ca_channel_f_gate__f - var_x214 * var_x215 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        IJth(rJacobian, 8, 0) = -4.2821610031797325e-8 + 2.8027450860303217e-9 * var_x103 - 2.1020588145227411e-9 * var_x108 - 00013666471286743825 * var_x70 - 0.18221961715658433 * var_x43 - 0030369936192764057 * var_x33 - 00044502853488732734 * var_x71 + var_x20 * var_x225 - var_x20 * var_x224 - var_x226 * var_chaste_interface__ionic_concentrations__Nai - var_x227 * var_x79;
        IJth(rJacobian, 9, 0) = 9.110980857829217e-5 * var_x70 + 1.1481300277669745e-7 * var_x62 + 00031793296094118393 * var_x96 + 8.0137748385755867e-10 * var_x104 - 5.5576983232758224e-7 * var_x3 - 9.2938099051435146e-8 * var_x24 - 0013330522471328469 * var_x55 - 3.6854973891319883e-6 * var_x30 - 6.0103311289316898e-10 * var_x109 + var_x11 * var_x225 - var_x11 * var_x224 - var_x226 * var_chaste_interface__ionic_concentrations__Ki - var_x235 * var_x79 - var_x236 * var_x98;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (var_x0 * (20 * var_x115 + 0115 * var_x114 + 5.0564577285853121e-12 * var_x122 + 5.659040773960763e-8 * var_x123 + 1.7684502418627385e-11 * var_x124 - 0115 * var_x112 - 078597788527232842 * var_x118 - 00040134880066084979 * var_x113 - var_x11 * var_x117 - var_x117 * var_x20));
        IJth(rJacobian, 1, 1) = 8.5932353608719255e-11 * var_x123 + 1.7462713310839333e-5 * var_x114 + 00040588235294117644 * var_x157 - 030369936192764058 * var_x115 - 00011935049112322121 * var_x118 - 6.0944687335561951e-7 * var_x113 - 1.7462713310839333e-5 * var_x112 - 00040588235294117644 * var_x156;
        ...
        IJth(rJacobian, 11, 1) = 0050000000000000001 * var_x156 - 0050000000000000001 * var_x157;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (-3 * var_x126 * var_x128);
        IJth(rJacobian, 2, 2) = -080000000000000002 * var_x163 - var_x162 * var_x164;
        IJth(rJacobian, 8, 2) = -0091109808578292168 * var_x125 * var_x128;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (-var_x126 * var_x32);
        IJth(rJacobian, 3, 3) = -((var_x166) ? (0.13500000000000001 * var_x165) : (0)) - ((var_x166) ? (310000 * var_x168 + 3.5600000000000001 * var_x167) : (7.6923076923076916 / var_x170));
        IJth(rJacobian, 8, 3) = -var_x229 * var_x32;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (-var_x126 * var_x129);
        ...
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (var_x0 * (-var_x130 * var_x89 - var_x131 * var_x82 - var_x131 * var_x93));
        ...
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (var_x0 * (-var_x132 * var_x89 - var_x133 * var_x82 - var_x133 * var_x93));
        ...
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (-0024270695636233147 * var_x0 * var_x134);
        IJth(rJacobian, 7, 7) = -var_x219 * var_x223 - var_x222 * var_x223;
        IJth(rJacobian, 9, 7) = -7.3709947782639767e-6 * var_x134;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (var_x0 * (var_x147 - 60 * var_x139 - 1.8421356686070195e-5 * var_x107 - 000592018558817993 * var_x137 - 00071151247353788531 * var_x143 - 0003752664515462853 * var_x63 - 26.614641953637257 * var_x138 - var_x135 * var_x136 - var_x142 * var_chaste_interface__ionic_concentrations__Ki));
        IJth(rJacobian, 1, 8) = 091109808578292165 * var_x139;
        IJth(rJacobian, 8, 8) = var_x233 - 5.594554271400994e-8 * var_x107 - 0.54665885146975302 * var_x139 - 1.139681818874567e-6 * var_x63 - 080828497792522477 * var_x138 - 6.4825765265103909e-6 * var_x143 - var_x135 * var_x230;
        ...
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0 : (var_x0 * (var_x147 + 2.78620009834773 * var_x153 - 11.682180705860503 * var_x150 - 032297793716202568 * var_x137 - 0048704794775156178 * var_x148 - 5.2671434672763675e-6 * var_x107 - var_x100 * var_x152 - var_x136 * var_x149 - var_x142 * var_chaste_interface__ionic_concentrations__Nai));
        IJth(rJacobian, 8, 9) = var_x233 - var_x234 * var_chaste_interface__ionic_concentrations__Nai;
        IJth(rJacobian, 9, 9) = var_x237 + 0084616719207093495 * var_x153 - 1.5996281101931733e-8 * var_x107 - 035478708262932285 * var_x150 - 9.808819343281279e-5 * var_x137 - 1.4791615096031613e-5 * var_x148 - var_x149 * var_x230 - var_x152 * var_x236;
        IJth(rJacobian, 10, 10) = -063888888888888898;
        IJth(rJacobian, 11, 10) = 0055555555555555558;
        IJth(rJacobian, 1, 11) = 2.7058823529411762e-5;
        IJth(rJacobian, 10, 11) = 063888888888888898;
        IJth(rJacobian, 11, 11) = -0058888888888888888;
    }
