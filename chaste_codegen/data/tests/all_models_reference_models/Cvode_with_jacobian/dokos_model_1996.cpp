...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldokos_model_1996FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x257 = exp(-8.4299999999999997 - 0.14999999999999999 * var_chaste_interface__membrane__E);
        const double var_x258 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x259 = exp(-3.0869999999999997 - 0.089999999999999997 * var_chaste_interface__membrane__E);
        const double var_x260 = 1.0 - var_x259;
        const double var_x261 = 0.20000000000000001 / var_x260;
        const double var_x262 = 34.299999999999997 + var_chaste_interface__membrane__E;
        const double var_x263 = exp(-13.076000000000002 - 0.14000000000000001 * var_chaste_interface__membrane__E);
        const double var_x264 = exp(-2.7239999999999998 - 0.059999999999999998 * var_chaste_interface__membrane__E);
        const double var_x265 = exp(0.039800000000000002 * var_chaste_interface__membrane__E);
        const double var_x266 = exp(-0.050999999999999997 * var_chaste_interface__membrane__E);
        const double var_x267 = exp(-3.3918918918918921 - 0.13513513513513511 * var_chaste_interface__membrane__E);
        const double var_x268 = 1.0 + var_x267;
        const double var_x269 = 1.0 - var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        const double var_x270 = exp(9.0948000000000011 + 0.066000000000000003 * var_chaste_interface__membrane__E);
        const double var_x271 = -1.0 + var_x270;
        const double var_x272 = 0.00035999999999999997 / var_x271;
        const double var_x273 = exp(-16.023 - 0.20999999999999999 * var_chaste_interface__membrane__E);
        const double var_x274 = 1.0 - var_x273;
        const double var_x275 = 0.0001 / var_x274;
        const double var_x276 = 76.299999999999997 + var_chaste_interface__membrane__E;
        const double var_x277 = 137.80000000000001 + var_chaste_interface__membrane__E;
        const double var_x278 = 0.082914149192289482 * var_x74;
        const double var_x279 = 3.5527883787404114e-5 * var_x90;
        const double var_x280 = 0.011766915164383442 * var_x76;
        const double var_x281 = 0.1384342960515699 * var_x100;
        const double var_x282 = 0.77732014867771382 + 0.010364268649036185 * var_chaste_interface__membrane__E - 0.1384342960515699 * var_x131;
        const double var_x283 = var_x133 * var_x282;
        const double var_x284 = 0.066072212637605682 + 0.00088096283516807576 * var_chaste_interface__membrane__E - 0.011766915164383442 * var_x131;
        const double var_x285 = 0.39999999999999997 * var_chaste_interface__ion_concentrations__Carel;
        const double var_x286 = 0.049748489515373688 * var_x74;
        const double var_x287 = 2.131673027244247e-5 * var_x90;
        const double var_x288 = 0.0028107896576186134 * var_x103;
        const double var_x289 = 0.0001450997610865066 * var_x110;
        const double var_x290 = var_x289 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        const double var_x291 = 0.11074743684125593 * var_x80;
        const double var_x292 = 0.0028107896576186134 * var_x182;
        const double var_x293 = 0.11074743684125593 * var_x98;
        const double var_x294 = var_x214 * var_x217;
        const double var_x295 = 0.24874244757686842 * var_x74;
        const double var_x296 = 0.00010658365136221236 * var_x90;
        const double var_x297 = 0.014053948288093067 * var_x103;
        const double var_x298 = 0.00072549880543253294 * var_x110;
        const double var_x299 = var_x298 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        const double var_x300 = 0.5537371842062796 * var_x80;
        const double var_x301 = 0.014053948288093067 * var_x182;
        const double var_x302 = 0.5537371842062796 * var_x98;
        const double var_x303 = 0.0018738597717457423 * var_x103;
        const double var_x304 = 0.0041457074596144743 * var_x110;
        const double var_x305 = 0.0018738597717457423 * var_x182;
        const double var_x306 = 2.9019952217301315e-7 * var_x203;
        const double var_x307 = var_x304 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        const double var_x308 = var_x217 * var_x219;
        const double var_x309 = 0.0093692988587287113 * var_x103;
        const double var_x310 = 0.020728537298072371 * var_x110;
        const double var_x311 = 0.0093692988587287113 * var_x182;
        const double var_x312 = 1.4509976108650656e-6 * var_x203;
        const double var_x313 = var_x310 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        ...
        IJth(rJacobian, 7, 0) = var_x258 * var_x261 + 1.2 * var_x257 * var_chaste_interface__fast_sodium_current_m_gate__m - 0.017999999999999999 * var_x258 * var_x259 * var_x262 / pow(var_x260, 2);
        IJth(rJacobian, 8, 0) = -0.14000000000000001 * var_x263 * (0.032399999999999998 - 0.032399999999999998 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.010128571428571428 * var_x264 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.23809523809523808 + var_x264), 2);
        IJth(rJacobian, 9, 0) = (0.67660000000000009 * var_x265 - 0.010761 * var_x266) * (0.001 / var_x268 - 0.001 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x) + 0.00013513513513513514 * var_x267 * (17.0 * var_x265 + 0.21099999999999999 * var_x266) / pow(var_x268, 2);
        IJth(rJacobian, 10, 0) = var_x269 * var_x272 - var_x275 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y + 2.0999999999999999e-5 * var_x273 * var_x276 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow(var_x274, 2) - 2.376e-5 * var_x269 * var_x270 * var_x277 / pow(var_x271, 2);
        IJth(rJacobian, 11, 0) = 0.010364268649036185 * var_x100 + 0.00088096283516807576 * var_x76 - var_x278 * var_x66 - var_x279 * var_x88;
        IJth(rJacobian, 14, 0) = -9.949697903074737e-7 - 0.0041457074596144743 * var_x80 - 0.0041457074596144743 * var_x98 - 5.4316486149187404e-6 * var_x111 - var_x108 * var_x288 - var_x286 * var_x66 - var_x287 * var_x88;
        IJth(rJacobian, 15, 0) = 4.9748489515373691e-6 + 2.71582430745937e-5 * var_x111 + 0.020728537298072371 * var_x80 + 0.020728537298072371 * var_x98 + var_x108 * var_x297 + var_x295 * var_x66 + var_x296 * var_x88;
        IJth(rJacobian, 16, 0) = -0.0001551899604262497 * var_x102 - 0.0041457074596144743 * var_x96 - 1.0863297229837478e-8 * var_x78 + var_x108 * var_x303;
        IJth(rJacobian, 17, 0) = 5.4316486149187388e-8 * var_x78 + 0.020728537298072371 * var_x96 + 0.00077594980213124853 * var_x102 - var_x108 * var_x309;
        ...
        IJth(rJacobian, 11, 1) = var_x125 * var_x280 + var_x125 * var_x281 - var_x124 * var_x278 - var_x129 * var_x279;
        IJth(rJacobian, 12, 1) = 0.0062777855817019177 * var_x225 - 0.0062777855817019177 * var_x224;
        IJth(rJacobian, 13, 1) = var_x231 * var_x285 - var_x229 * var_x285;
        IJth(rJacobian, 14, 1) = -var_x124 * var_x286 - var_x129 * var_x287;
        IJth(rJacobian, 15, 1) = var_x124 * var_x295 + var_x129 * var_x296;
        ...
        IJth(rJacobian, 11, 2) = var_x282 * var_x99;
        ...
        IJth(rJacobian, 11, 3) = var_x283 * var_chaste_interface__L_type_calcium_current_f2_gate__fL2;
        ...
        IJth(rJacobian, 11, 4) = var_x283 * var_chaste_interface__L_type_calcium_current_f_gate__fL;
        ...
        IJth(rJacobian, 11, 5) = var_x284 * var_chaste_interface__T_type_calcium_current_f_gate__fT;
        ...
        IJth(rJacobian, 11, 6) = var_x284 * var_chaste_interface__T_type_calcium_current_d_gate__dT;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0030000000000000001 * var_x112 * var_x138);
        IJth(rJacobian, 7, 7) = -8.0 * var_x257 - var_x261 * var_x262;
        ...
        IJth(rJacobian, 8, 8) = -0.032399999999999998 * var_x263 - 0.70899999999999996 / (1.0 + 4.2000000000000002 * var_x264);
        ...
        IJth(rJacobian, 9, 9) = -0.00021100000000000001 * var_x266 - 0.017000000000000001 * var_x265;
        IJth(rJacobian, 14, 9) = -var_x142 * var_x289;
        IJth(rJacobian, 15, 9) = var_x142 * var_x298;
        IJth(rJacobian, 16, 9) = -var_x140 * var_x304;
        IJth(rJacobian, 17, 9) = var_x140 * var_x310;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x113 * (var_x146 + var_x147));
        IJth(rJacobian, 10, 10) = -var_x272 * var_x277 - var_x275 * var_x276;
        ...
        IJth(rJacobian, 11, 11) = -0.01 - var_x160 * var_x278 - var_x164 * var_x279 - var_x165 * var_x280 - var_x165 * var_x281;
        IJth(rJacobian, 14, 11) = -var_x160 * var_x286 - var_x164 * var_x287;
        IJth(rJacobian, 15, 11) = var_x160 * var_x295 + var_x164 * var_x296;
        ...
        IJth(rJacobian, 11, 14) = -var_x178 * var_x278 - var_x180 * var_x279;
        IJth(rJacobian, 14, 14) = -var_x290 + 1.7567435360116334e-6 * var_x186 - 2.6579384841901423e-5 * var_x136 - var_x136 * var_x291 - var_x136 * var_x293 - var_x178 * var_x286 - var_x180 * var_x287 - var_x292 * var_chaste_interface__ion_concentrations__Ko;
        IJth(rJacobian, 15, 14) = var_x299 + 0.0001328969242095071 * var_x136 - 8.7837176800581675e-6 * var_x186 + var_x136 * var_x300 + var_x136 * var_x302 + var_x178 * var_x295 + var_x180 * var_x296 + var_x301 * var_chaste_interface__ion_concentrations__Ko;
        IJth(rJacobian, 16, 14) = -1.171162357341089e-6 * var_x186 + var_x305 * var_chaste_interface__ion_concentrations__Ko;
        IJth(rJacobian, 17, 14) = 5.8558117867054447e-6 * var_x186 - var_x311 * var_chaste_interface__ion_concentrations__Ko;
        ...
        IJth(rJacobian, 11, 15) = -var_x201 * var_x278 - var_x202 * var_x279;
        IJth(rJacobian, 14, 15) = 2.6579384841901423e-5 * var_x187 + var_x187 * var_x291 + var_x187 * var_x293 + var_x290 * var_x77 - var_x201 * var_x286 - var_x202 * var_x287;
        IJth(rJacobian, 15, 15) = -0.01 - 0.0001328969242095071 * var_x187 + var_x201 * var_x295 + var_x202 * var_x296 - var_x187 * var_x300 - var_x187 * var_x302 - var_x299 * var_x77;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x113 * (var_x204 + var_x205 + 26.713760659695652 * var_x206));
        IJth(rJacobian, 16, 16) = -var_x306 - var_x307 - 0.11074743684125593 * var_x206;
        IJth(rJacobian, 17, 16) = var_x312 + var_x313 + 0.5537371842062796 * var_x206;
        ...
        IJth(rJacobian, 14, 17) = 1.4895857201494236e-6 * var_x294 - 8.5608859041038889e-5 * var_x210 - 0.0075866446510944882 * var_x215 + var_x216 * var_x288 - var_x292 * var_chaste_interface__ion_concentrations__Nai;
        IJth(rJacobian, 15, 17) = 0.00042804429520519442 * var_x210 + 0.037933223255472437 * var_x215 - 7.4479286007471168e-6 * var_x294 + var_x301 * var_chaste_interface__ion_concentrations__Nai - var_x216 * var_x297;
        IJth(rJacobian, 16, 17) = 0.11074743684125593 * var_x212 + 1.4895857201494236e-6 * var_x308 - 0.0024459674011725395 * var_x209 - 1.1898180409093538e-7 * var_x207 - 0.0075866446510944882 * var_x213 + var_x305 * var_chaste_interface__ion_concentrations__Nai + var_x306 * var_x77 + var_x307 * var_x77 - var_x216 * var_x303;
        IJth(rJacobian, 17, 17) = -0.01 + 0.037933223255472437 * var_x213 + 5.9490902045467693e-7 * var_x207 + 0.012229837005862698 * var_x209 - 7.4479286007471168e-6 * var_x308 - 0.5537371842062796 * var_x212 + var_x216 * var_x309 - var_x311 * var_chaste_interface__ion_concentrations__Nai - var_x312 * var_x77 - var_x313 * var_x77;
    }
