...
#include "MathsCustomFunctions.hpp"
    ...
    double Celldokos_model_1996FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_reversal_potentials__E_Ca = 0.5 * var_constants__R * var_constants__T * log(10) * log10(var_chaste_interface__ion_concentrations__Cao / var_chaste_interface__ion_concentrations__Cai) / var_constants__F; // millivolt
        ...
        const double var_reversal_potentials__E_K = var_constants__R * var_constants__T * log(10) * log10(var_chaste_interface__ion_concentrations__Ko / var_chaste_interface__ion_concentrations__Ki) / var_constants__F; // millivolt
        ...
        const double var_reversal_potentials__E_Na = var_constants__R * var_constants__T * log(10) * log10(var_chaste_interface__ion_concentrations__Nao / var_chaste_interface__ion_concentrations__Nai) / var_constants__F; // millivolt
    ...
    void Celldokos_model_1996FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x127 = log(10);
        const double var_x128 = var_x127 * log10(var_x121 * var_chaste_interface__ion_concentrations__Cao);
        const double var_x129 = var_x109 * (30.0 + 0.40000000000000002 * var_chaste_interface__membrane__E - 5.3427521319391307 * var_x128);
        const double var_x130 = var_x129 * var_chaste_interface__L_type_calcium_current_f2_gate__fL2;
        const double var_x131 = var_x109 * (6.3750000000000009 + 0.085000000000000006 * var_chaste_interface__membrane__E - 1.1353348280370652 * var_x128);
        const double var_x132 = 1 / var_chaste_interface__ion_concentrations__Nai;
        const double var_x133 = 26.713760659695652 * var_x127;
        const double var_x134 = -var_x133 * log10(var_x132 * var_chaste_interface__ion_concentrations__Nao) + var_chaste_interface__membrane__E;
        const double var_x135 = var_x134 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x136 = var_x0 * var_x134;
        const double var_x137 = -var_x79 * var_chaste_interface__ion_concentrations__Ko + var_chaste_interface__ion_concentrations__Ki;
        const double var_x138 = 0.00025999999999999998 * var_x99;
        const double var_x139 = -var_x100 + var_chaste_interface__ion_concentrations__Nai;
        const double var_x140 = 9.0999999999999993e-6 * var_x99;
        const double var_x141 = var_x134 * var_x85;
        const double var_x142 = 1 / var_chaste_interface__ion_concentrations__Ki;
        const double var_x143 = -var_x133 * log10(var_x142 * var_chaste_interface__ion_concentrations__Ko) + var_chaste_interface__membrane__E;
        const double var_x144 = var_x143 * var_x85;
        const double var_x145 = 0.27300027300027302 * var_x45;
        const double var_x146 = var_x145 * var_x50;
        const double var_x147 = pow(var_x49, (-2));
        const double var_x148 = var_x147 * (-0.27300027300027302 - var_x145);
        const double var_x149 = var_x34 * var_x48;
        const double var_x150 = var_x148 * var_x149;
        const double var_x151 = var_x148 * var_x46;
        const double var_x152 = var_x146 + var_x150 + var_x151;
        const double var_x153 = var_x34 * var_x36;
        const double var_x154 = var_x152 * var_x153;
        const double var_x155 = var_x146 * var_x58;
        const double var_x156 = var_x151 * var_x58;
        const double var_x157 = var_x146 * var_x75 + var_x151 * var_x75 - var_x29 * (var_x154 + var_x155 + var_x156);
        const double var_x158 = var_x13 * var_x26;
        const double var_x159 = var_x30 * var_x36;
        const double var_x160 = var_x29 * var_x57;
        const double var_x161 = -var_x154 - var_x155 - var_x156 - var_x146 * var_x73 - var_x150 * var_x159 - var_x150 * var_x160 - var_x151 * var_x73 - var_x152 * var_x158;
        const double var_x162 = 1 / var_chaste_interface__ion_concentrations__Cao;
        const double var_x163 = var_x25 * var_x31;
        const double var_x164 = 0.0022103313761954162 * var_chaste_interface__ion_concentrations__Nai;
        const double var_x165 = 0.0001253970145345357 * var_x2;
        const double var_x166 = var_x12 * (var_x164 + var_x165);
        const double var_x167 = var_x17 * (-0.0025297242600556538 - var_x164 - var_x165 - 1.8271247633873431 * var_chaste_interface__ion_concentrations__Cai);
        const double var_x168 = var_x113 * var_x167;
        const double var_x169 = var_x166 + var_x168 + var_x115 * var_x167;
        const double var_x170 = var_x169 * var_x27;
        const double var_x171 = 0.0014304645462223146 * var_chaste_interface__ion_concentrations__Nai / pow((1 + var_x16), 2);
        const double var_x172 = var_x171 * var_x31;
        const double var_x173 = var_x168 * var_x38;
        const double var_x174 = var_x25 - var_x171;
        const double var_x175 = var_x51 * (var_x163 + var_x170 + var_x173 - var_x172) - var_x168 * var_x59 - 13.188418985520435 * var_x174 * var_x40 * var_x93;
        const double var_x176 = var_x140 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        const double var_x177 = 6.6784401649239129 * var_x1;
        const double var_x178 = var_x172 - var_x163 - var_x170 - var_x173 + var_x171 * var_x71 - var_x123 * var_x167 - var_x124 * var_x167 - var_x166 * var_x89 - var_x168 * var_x74 - var_x169 * var_x88 - var_x25 * var_x71 - var_x11 * var_x174 * var_x51 - var_x166 * var_x37 * var_x51 - var_x174 * var_x29 * var_x53;
        const double var_x179 = 1.0 - 0.035938096628557313 * pow((-1 + 0.025000000000000001 * var_chaste_interface__membrane__E), 2);
        const double var_x180 = var_x102 * var_x105 * var_x179;
        const double var_x181 = 0.22600000000000001 * var_x180;
        const double var_x182 = 0.21638146134353475 * var_x86;
        const double var_x183 = var_x106 * var_x179 / pow((1 + 0.025000000000000001 * var_chaste_interface__ion_concentrations__Nai), 2);
        const double var_x184 = 1 / var_chaste_interface__ion_concentrations__Nao;
        const double var_x185 = var_x35 * var_x55;
        const double var_x186 = 2.1882814900271261e-6 * var_chaste_interface__ion_concentrations__Nao;
        const double var_x187 = 7.0392928051483781e-7 * var_x47;
        const double var_x188 = var_x52 * (var_x186 + var_x187);
        const double var_x189 = var_x147 * (-0.00061425061425061424 - var_x186 - var_x187);
        const double var_x190 = var_x149 * var_x189;
        const double var_x191 = var_x189 * var_x46;
        const double var_x192 = var_x188 + var_x190 + var_x191;
        const double var_x193 = var_x153 * var_x192;
        const double var_x194 = 0.045990609913211578 * var_chaste_interface__ion_concentrations__Nao / pow((1 + 0.2144542140253056 * var_chaste_interface__ion_concentrations__Nao), 2);
        const double var_x195 = var_x194 * var_x55;
        const double var_x196 = var_x191 * var_x58;
        const double var_x197 = var_x35 - var_x194;
        const double var_x198 = var_x191 * var_x75 - var_x29 * (var_x185 + var_x193 + var_x196 - var_x195) + 13.188418985520435 * var_x197 * var_x20 * var_x52 * var_x61;
        const double var_x199 = var_x195 - var_x185 - var_x193 - var_x196 + var_x194 * var_x69 - var_x158 * var_x192 - var_x159 * var_x188 - var_x159 * var_x190 - var_x160 * var_x188 - var_x160 * var_x190 - var_x191 * var_x73 - var_x35 * var_x69 - var_x13 * var_x197 * var_x51 - var_x197 * var_x29 * var_x34;
        const double var_x200 = pow(var_chaste_interface__ion_concentrations__Ko, 0.40999999999999998);
        const double var_x201 = 6.9999999999999994e-5 * var_x200;
        const double var_x202 = var_x138 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        const double var_x203 = var_x142 * var_x86;
        const double var_x204 = var_x137 * pow(var_chaste_interface__ion_concentrations__Ko, (-0.59000000000000008));
        const double var_x205 = pow(var_chaste_interface__ion_concentrations__Ko, (-0.41000000000000003)) * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        const double var_x206 = var_x139 * var_x205;
        const double var_x207 = var_x137 * var_x205;
        const double var_x208 = var_x84 * pow(var_chaste_interface__ion_concentrations__Ko, 0.83000000000000007) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        const double var_x209 = var_x143 * var_x208;
        const double var_x210 = var_x134 * var_x208;
        const double var_x211 = pow(var_chaste_interface__ion_concentrations__Ko, 2.6600000000000001) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow((1 + 0.014012250051496243 * var_x83), 2);
        const double var_x212 = var_x143 * var_x211;
        const double var_x213 = var_x134 * var_x211;
        const double var_x214 = var_x179 * var_chaste_interface__ion_concentrations__Ko * var_chaste_interface__ion_concentrations__Nai / pow(var_x104, 2);
        const double var_x215 = 0.016582829838457897 * var_x76;
        const double var_x216 = 7.1055767574808238e-6 * var_x97;
        const double var_x217 = 2.4999999999999999e-7 + var_x18;
        const double var_x218 = pow(var_chaste_interface__ion_concentrations__Cai, 3);
        const double var_x219 = var_x218 / pow(var_x217, 2);
        const double var_x220 = var_chaste_interface__ion_concentrations__Cai / var_x217;
        const double var_x221 = 0.0023999999999999998 * var_chaste_interface__ion_concentrations__Carel;
        const double var_x222 = 9.9999999999999995e-7 + var_x18;
        const double var_x223 = 1 / var_x222;
        const double var_x224 = var_x223 * var_chaste_interface__ion_concentrations__Cai;
        const double var_x225 = 0.0023533830328766885 * var_x78;
        const double var_x226 = var_x218 / pow(var_x222, 2);
        const double var_x227 = 0.011074743684125593 * var_x82;
        const double var_x228 = -0.062185611894217112 + 0.011074743684125593 * var_x128 - 0.00082914149192289482 * var_chaste_interface__membrane__E;
        const double var_x229 = var_x228 * var_chaste_interface__L_type_calcium_current_f2_gate__fL2;
        const double var_x230 = -0.013214442527521138 + 0.0023533830328766885 * var_x128 - 0.00017619256703361517 * var_chaste_interface__membrane__E;
        const double var_x231 = var_x18 * var_x223;
        const double var_x232 = 0.15151515151515152 * var_chaste_interface__membrane__E;
        const double var_x233 = exp(-1.0 - var_x232);
        const double var_x234 = exp(4.166666666666667 + 0.16666666666666666 * var_chaste_interface__membrane__E);
        const double var_x235 = 1.0 + var_x234;
        const double var_x236 = exp(4.6419753086419755 + 0.1234567901234568 * var_chaste_interface__membrane__E);
        const double var_x237 = 1.0 + var_x236;
        const double var_x238 = 0.031 + 1 / var_x237;
        const double var_x239 = 1 / var_x238;
        const double var_x240 = exp(-3.7704918032786887 - 0.16393442622950821 * var_chaste_interface__membrane__E);
        const double var_x241 = 1.0 + var_x240;
        const double var_x242 = exp(3.0 + 0.029999999999999999 * var_chaste_interface__membrane__E);
        const double var_x243 = 1.0 + var_x242;
        const double var_x244 = 1 / var_x243;
        const double var_x245 = 1 / (0.00059999999999999995 + 0.0054000000000000003 * var_x244);
        const double var_x246 = exp(11.363636363636365 + var_x232);
        const double var_x247 = 1.0 + var_x246;
        const double var_x248 = exp(5.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__E);
        const double var_x249 = 1.0 + var_x248;
        const double var_x250 = 1 / var_x249;
        const double var_x251 = 1 / (0.001 + 0.040000000000000001 * var_x250);
        const double var_x252 = exp(-8.4299999999999997 - 0.14999999999999999 * var_chaste_interface__membrane__E);
        const double var_x253 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x254 = exp(-3.0869999999999997 - 0.089999999999999997 * var_chaste_interface__membrane__E);
        const double var_x255 = 1.0 - var_x254;
        const double var_x256 = 0.20000000000000001 / var_x255;
        const double var_x257 = 34.299999999999997 + var_chaste_interface__membrane__E;
        const double var_x258 = exp(-13.076000000000002 - 0.14000000000000001 * var_chaste_interface__membrane__E);
        const double var_x259 = exp(-2.7239999999999998 - 0.059999999999999998 * var_chaste_interface__membrane__E);
        ...
        const double var_x262 = exp(-3.3918918918918921 - 0.13513513513513511 * var_chaste_interface__membrane__E);
        const double var_x263 = 1.0 + var_x262;
        const double var_x264 = 1.0 - var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        const double var_x265 = exp(9.0948000000000011 + 0.066000000000000003 * var_chaste_interface__membrane__E);
        const double var_x266 = -1.0 + var_x265;
        const double var_x267 = 0.00035999999999999997 / var_x266;
        const double var_x268 = exp(-16.023 - 0.20999999999999999 * var_chaste_interface__membrane__E);
        const double var_x269 = 1.0 - var_x268;
        const double var_x270 = 0.0001 / var_x269;
        const double var_x271 = 76.299999999999997 + var_chaste_interface__membrane__E;
        const double var_x272 = 137.80000000000001 + var_chaste_interface__membrane__E;
        const double var_x273 = 0.082914149192289482 * var_x76;
        const double var_x274 = 3.5527883787404114e-5 * var_x97;
        const double var_x275 = 0.011766915164383442 * var_x78;
        const double var_x276 = 0.055373718420627965 * var_x82;
        const double var_x277 = 0.31092805947108554 + 0.0041457074596144743 * var_chaste_interface__membrane__E - 0.055373718420627965 * var_x128;
        const double var_x278 = var_x277 * var_chaste_interface__L_type_calcium_current_f2_gate__fL2;
        const double var_x279 = 0.066072212637605682 + 0.00088096283516807576 * var_chaste_interface__membrane__E - 0.011766915164383442 * var_x128;
        const double var_x280 = 0.39999999999999997 * var_chaste_interface__ion_concentrations__Carel;
        const double var_x281 = 0.049748489515373688 * var_x76;
        const double var_x282 = 2.131673027244247e-5 * var_x97;
        const double var_x283 = 0.0028107896576186134 * var_x102;
        const double var_x284 = 3.7725937882491711e-8 * var_x99;
        const double var_x285 = var_x284 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        const double var_x286 = 0.027686859210313983 * var_x1;
        const double var_x287 = 0.0028107896576186134 * var_x180;
        const double var_x288 = 0.00089705423841417295 * var_x86;
        const double var_x289 = 0.24874244757686842 * var_x76;
        const double var_x290 = 0.00010658365136221236 * var_x97;
        const double var_x291 = 0.014053948288093067 * var_x102;
        const double var_x292 = 1.8862968941245856e-7 * var_x99;
        const double var_x293 = var_x292 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        const double var_x294 = 0.1384342960515699 * var_x1;
        const double var_x295 = 0.0044852711920708643 * var_x86;
        const double var_x296 = 0.014053948288093067 * var_x180;
        const double var_x297 = 0.0018738597717457423 * var_x102;
        const double var_x298 = 1.0778839394997632e-6 * var_x99;
        const double var_x299 = 0.0018738597717457423 * var_x180;
        const double var_x300 = 2.9019952217301315e-7 * var_x200;
        const double var_x301 = var_x298 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        const double var_x302 = 0.0093692988587287113 * var_x102;
        const double var_x303 = 5.3894196974988154e-6 * var_x99;
        const double var_x304 = 0.0093692988587287113 * var_x180;
        const double var_x305 = 1.4509976108650656e-6 * var_x200;
        const double var_x306 = var_x303 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        ...
        IJth(rJacobian, 1, 0) = -0.00017619256703361517 * var_x78 - 0.00082914149192289482 * var_x82 + var_x215 * var_x68 + var_x216 * var_x95;
        IJth(rJacobian, 2, 0) = 0.07575757575757576 * var_x233 / pow((1.0 + var_x233), 2);
        IJth(rJacobian, 3, 0) = -0.00016666666666666666 * var_x234 * var_x239 / pow(var_x235, 2) + 0.00012345679012345679 * var_x236 * (1 / var_x235 - var_chaste_interface__L_type_calcium_current_f_gate__fL) / (pow(var_x237, 2) * pow(var_x238, 2));
        IJth(rJacobian, 5, 0) = 0.0001639344262295082 * var_x240 * var_x245 / pow(var_x241, 2) + 0.0055555555555555549 * var_x242 * (1 / var_x241 - var_chaste_interface__T_type_calcium_current_d_gate__dT) / (pow(var_x243, 2) * pow((0.11111111111111109 + var_x244), 2));
        IJth(rJacobian, 6, 0) = -0.00015151515151515152 * var_x246 * var_x251 / pow(var_x247, 2) + 0.002 * var_x248 * (1 / var_x247 - var_chaste_interface__T_type_calcium_current_f_gate__fT) / (pow(var_x249, 2) * pow((0.025000000000000001 + var_x250), 2));
        IJth(rJacobian, 7, 0) = var_x253 * var_x256 + 1.2 * var_x252 * var_chaste_interface__fast_sodium_current_m_gate__m - 0.017999999999999999 * var_x253 * var_x254 * var_x257 / pow(var_x255, 2);
        IJth(rJacobian, 8, 0) = -0.14000000000000001 * var_x258 * (0.032399999999999998 - 0.032399999999999998 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.010128571428571428 * var_x259 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.23809523809523808 + var_x259), 2);
        IJth(rJacobian, 9, 0) = (0.67660000000000009 * var_x260 - 0.010761 * var_x261) * (0.001 / var_x263 - 0.001 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x) + 0.00013513513513513514 * var_x262 * (17.0 * var_x260 + 0.21099999999999999 * var_x261) / pow(var_x263, 2);
        IJth(rJacobian, 10, 0) = var_x264 * var_x267 - var_x270 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y + 2.0999999999999999e-5 * var_x268 * var_x271 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow(var_x269, 2) - 2.376e-5 * var_x264 * var_x265 * var_x272 / pow(var_x266, 2);
        IJth(rJacobian, 11, 0) = 0.0041457074596144743 * var_x82 + 0.00088096283516807576 * var_x78 - var_x273 * var_x68 - var_x274 * var_x95;
        IJth(rJacobian, 14, 0) = -9.949697903074737e-7 - 1.4122286398788724e-9 * var_x101 - 0.0010364268649036186 * var_x1 - 3.3580230422877238e-5 * var_x86 - var_x107 * var_x283 - var_x281 * var_x68 - var_x282 * var_x95;
        IJth(rJacobian, 15, 0) = 4.9748489515373691e-6 + 7.0611431993943612e-9 * var_x101 + 0.00016790115211438617 * var_x86 + 0.0051821343245180927 * var_x1 + var_x107 * var_x291 + var_x289 * var_x68 + var_x290 * var_x95;
        IJth(rJacobian, 16, 0) = -4.0349389710824922e-8 * var_x87 - 1.0863297229837478e-8 * var_x80 - 5.5967050704795398e-5 * var_x86 + var_x107 * var_x297;
        IJth(rJacobian, 17, 0) = 5.4316486149187388e-8 * var_x80 + 0.00027983525352397697 * var_x86 + 2.017469485541246e-7 * var_x87 - var_x107 * var_x302;
        ...
        IJth(rJacobian, 1, 1) = 8.7888998143826851e-5 * var_x219 - 8.7888998143826851e-5 * var_x220 + var_x120 * var_x215 + var_x125 * var_x216 + var_x221 * var_x224 - var_x121 * var_x225 - var_x121 * var_x227 - var_x221 * var_x226;
        IJth(rJacobian, 4, 1) = -40.0 * var_chaste_interface__L_type_calcium_current_f2_gate__fL2;
        IJth(rJacobian, 11, 1) = var_x121 * var_x275 + var_x121 * var_x276 - var_x120 * var_x273 - var_x125 * var_x274;
        IJth(rJacobian, 12, 1) = 0.0062777855817019177 * var_x220 - 0.0062777855817019177 * var_x219;
        IJth(rJacobian, 13, 1) = var_x226 * var_x280 - var_x224 * var_x280;
        IJth(rJacobian, 14, 1) = -var_x120 * var_x281 - var_x125 * var_x282;
        IJth(rJacobian, 15, 1) = var_x120 * var_x289 + var_x125 * var_x290;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x130 * var_chaste_interface__L_type_calcium_current_f_gate__fL);
        IJth(rJacobian, 1, 2) = var_x229 * var_chaste_interface__L_type_calcium_current_f_gate__fL;
        IJth(rJacobian, 2, 2) = -0.5;
        IJth(rJacobian, 11, 2) = var_x278 * var_chaste_interface__L_type_calcium_current_f_gate__fL;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x130 * var_chaste_interface__L_type_calcium_current_d_gate__dL);
        IJth(rJacobian, 1, 3) = var_x229 * var_chaste_interface__L_type_calcium_current_d_gate__dL;
        IJth(rJacobian, 3, 3) = -0.001 * var_x239;
        IJth(rJacobian, 11, 3) = var_x278 * var_chaste_interface__L_type_calcium_current_d_gate__dL;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x129 * var_x81);
        IJth(rJacobian, 1, 4) = var_x228 * var_x81;
        IJth(rJacobian, 4, 4) = -0.0030000000000000001 - 40.0 * var_chaste_interface__ion_concentrations__Cai;
        IJth(rJacobian, 11, 4) = var_x277 * var_x81;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x131 * var_chaste_interface__T_type_calcium_current_f_gate__fT);
        IJth(rJacobian, 1, 5) = var_x230 * var_chaste_interface__T_type_calcium_current_f_gate__fT;
        IJth(rJacobian, 5, 5) = -0.001 * var_x245;
        IJth(rJacobian, 11, 5) = var_x279 * var_chaste_interface__T_type_calcium_current_f_gate__fT;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x131 * var_chaste_interface__T_type_calcium_current_d_gate__dT);
        IJth(rJacobian, 1, 6) = var_x230 * var_chaste_interface__T_type_calcium_current_d_gate__dT;
        IJth(rJacobian, 6, 6) = -0.001 * var_x251;
        IJth(rJacobian, 11, 6) = var_x279 * var_chaste_interface__T_type_calcium_current_d_gate__dT;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00075000000000000002 * var_x108 * var_x135);
        IJth(rJacobian, 7, 7) = -8.0 * var_x252 - var_x256 * var_x257;
        IJth(rJacobian, 14, 7) = -0.0031092805947108555 * var_x135;
        IJth(rJacobian, 15, 7) = 0.015546402973554276 * var_x135;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00025000000000000001 * var_x108 * var_x136);
        IJth(rJacobian, 8, 8) = -0.032399999999999998 * var_x258 - 0.70899999999999996 / (1.0 + 4.2000000000000002 * var_x259);
        IJth(rJacobian, 14, 8) = -0.0010364268649036186 * var_x136;
        IJth(rJacobian, 15, 8) = 0.0051821343245180927 * var_x136;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x109 * (var_x137 * var_x138 + var_x139 * var_x140));
        IJth(rJacobian, 9, 9) = -0.00021100000000000001 * var_x261 - 0.017000000000000001 * var_x260;
        IJth(rJacobian, 14, 9) = -var_x139 * var_x284;
        IJth(rJacobian, 15, 9) = var_x139 * var_x292;
        IJth(rJacobian, 16, 9) = -var_x137 * var_x298;
        IJth(rJacobian, 17, 9) = var_x137 * var_x303;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x109 * (0.0080999999999999996 * var_x141 + 0.0135 * var_x144));
        IJth(rJacobian, 10, 10) = -var_x267 * var_x272 - var_x270 * var_x271;
        IJth(rJacobian, 14, 10) = -3.3580230422877238e-5 * var_x141;
        IJth(rJacobian, 15, 10) = 0.00016790115211438617 * var_x141;
        IJth(rJacobian, 16, 10) = -5.5967050704795398e-5 * var_x144;
        IJth(rJacobian, 17, 10) = 0.00027983525352397697 * var_x144;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x109 * (var_x157 * var_x77 + var_x161 * var_x98 - var_x122 * var_x162 - var_x126 * var_x162));
        IJth(rJacobian, 1, 11) = var_x157 * var_x215 + var_x161 * var_x216 + var_x162 * var_x225 + var_x162 * var_x227;
        IJth(rJacobian, 11, 11) = -0.01 - var_x157 * var_x273 - var_x161 * var_x274 - var_x162 * var_x275 - var_x162 * var_x276;
        IJth(rJacobian, 14, 11) = -var_x157 * var_x281 - var_x161 * var_x282;
        IJth(rJacobian, 15, 11) = var_x157 * var_x289 + var_x161 * var_x290;
        IJth(rJacobian, 12, 12) = -0.0010714285714285713;
        IJth(rJacobian, 13, 12) = 0.0025000000000000001;
        IJth(rJacobian, 1, 13) = 0.0011999999999999999 * var_x231;
        IJth(rJacobian, 13, 13) = -0.19999999999999998 * var_x231;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x109 * (var_x176 + 0.0064113025583269565 * var_x132 - 0.00014124999999999999 * var_x183 + var_x132 * var_x177 + var_x132 * var_x182 + var_x175 * var_x77 + var_x178 * var_x98 + var_x181 * var_chaste_interface__ion_concentrations__Ko));
        IJth(rJacobian, 1, 14) = var_x175 * var_x215 + var_x178 * var_x216;
        IJth(rJacobian, 11, 14) = -var_x175 * var_x273 - var_x178 * var_x274;
        IJth(rJacobian, 14, 14) = -var_x285 + 1.7567435360116334e-6 * var_x183 - 2.6579384841901423e-5 * var_x132 - var_x132 * var_x286 - var_x132 * var_x288 - var_x175 * var_x281 - var_x178 * var_x282 - var_x287 * var_chaste_interface__ion_concentrations__Ko;
        IJth(rJacobian, 15, 14) = var_x293 + 0.0001328969242095071 * var_x132 - 8.7837176800581675e-6 * var_x183 + var_x132 * var_x294 + var_x132 * var_x295 + var_x175 * var_x289 + var_x178 * var_x290 + var_x296 * var_chaste_interface__ion_concentrations__Ko;
        IJth(rJacobian, 16, 14) = -1.171162357341089e-6 * var_x183 + var_x299 * var_chaste_interface__ion_concentrations__Ko;
        IJth(rJacobian, 17, 14) = 5.8558117867054447e-6 * var_x183 - var_x304 * var_chaste_interface__ion_concentrations__Ko;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x109 * (-0.0064113025583269565 * var_x184 + var_x198 * var_x77 + var_x199 * var_x98 - var_x176 * var_x79 - var_x177 * var_x184 - var_x182 * var_x184));
        IJth(rJacobian, 1, 15) = var_x198 * var_x215 + var_x199 * var_x216;
        IJth(rJacobian, 11, 15) = -var_x198 * var_x273 - var_x199 * var_x274;
        IJth(rJacobian, 14, 15) = 2.6579384841901423e-5 * var_x184 + var_x184 * var_x286 + var_x184 * var_x288 + var_x285 * var_x79 - var_x198 * var_x281 - var_x199 * var_x282;
        IJth(rJacobian, 15, 15) = -0.01 - 0.0001328969242095071 * var_x184 + var_x198 * var_x289 + var_x199 * var_x290 - var_x184 * var_x294 - var_x184 * var_x295 - var_x293 * var_x79;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x109 * (var_x201 + var_x202 + 0.36063576890589127 * var_x203));
        IJth(rJacobian, 16, 16) = -var_x300 - var_x301 - 0.001495090397356955 * var_x203;
        IJth(rJacobian, 17, 16) = var_x305 + var_x306 + 0.0074754519867847747 * var_x203;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x109 * (5.3689999999999998e-6 * var_x206 + 0.00015339999999999999 * var_x207 + 0.024705000000000001 * var_x209 + 0.014822999999999999 * var_x210 + 2.8699999999999996e-5 * var_x204 - 0.36063576890589127 * var_x208 - 4.8506575579472438e-6 * var_x212 - 2.9103945347683461e-6 * var_x213 + var_x181 * var_chaste_interface__ion_concentrations__Nai - var_x103 * var_x214 - var_x201 * var_x79 - var_x202 * var_x79));
        IJth(rJacobian, 14, 17) = 1.206564433321033e-8 * var_x213 - 6.1451821673865346e-5 * var_x210 - 2.2258303350670109e-8 * var_x206 + var_x214 * var_x283 - var_x287 * var_chaste_interface__ion_concentrations__Nai;
        IJth(rJacobian, 15, 17) = 1.1129151675335054e-7 * var_x206 + 0.00030725910836932674 * var_x210 - 6.0328221666051643e-8 * var_x213 + var_x296 * var_chaste_interface__ion_concentrations__Nai - var_x214 * var_x291;
        IJth(rJacobian, 16, 17) = 2.0109407222017218e-8 * var_x212 + 0.001495090397356955 * var_x208 - 6.3595152430486023e-7 * var_x207 - 0.00010241970278977559 * var_x209 - 1.1898180409093538e-7 * var_x204 + var_x299 * var_chaste_interface__ion_concentrations__Nai + var_x300 * var_x79 + var_x301 * var_x79 - var_x214 * var_x297;
        IJth(rJacobian, 17, 17) = -0.01 + 3.179757621524301e-6 * var_x207 + 0.00051209851394887792 * var_x209 + 5.9490902045467693e-7 * var_x204 - 1.0054703611008607e-7 * var_x212 - 0.0074754519867847747 * var_x208 + var_x214 * var_x302 - var_x304 * var_chaste_interface__ion_concentrations__Nai - var_x305 * var_x79 - var_x306 * var_x79;
    }
