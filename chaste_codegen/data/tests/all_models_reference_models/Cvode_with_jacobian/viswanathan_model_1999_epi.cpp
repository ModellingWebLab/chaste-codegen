...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellviswanathan_model_1999_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x155 = 9.0316078310111333e-5 * var_x154;
        const double var_x156 = var_x155 * (0.003016 + var_x11 + var_x153 + var_x71 + var_x89 - var_x83);
        const double var_x157 = 0.00062 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x158 = 1 / var_x157;
        const double var_x159 = -0.00018000000000000001 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x160 = var_x158 * var_x159 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x161 = 1.0 - var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x162 = 423.5294117647058 * var_x161;
        const double var_x163 = var_x160 * var_x162;
        const double var_x164 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x165 = 1 / var_x164;
        const double var_x166 = 0.40588235294117642 * var_x165;
        const double var_x167 = var_chaste_interface__calcium_dynamics__Cai / pow(var_x164, 2);
        const double var_x168 = var_x101 + var_x112 + var_x117 - var_x103 - var_x111 + 0.040282206767891383 * var_x12 + 0.6678084676374566 * var_x105;
        const double var_x169 = 0.090316078310111333 * var_x154;
        const double var_x170 = -var_x166 + 0.40588235294117642 * var_x167 - var_x168 * var_x169;
        const double var_x171 = 0.001 * var_x152;
        const double var_x172 = -var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x173 = 0.027058823529411764 * var_chaste_interface__calcium_dynamics__Ca_NSR - var_x166 * var_chaste_interface__calcium_dynamics__Cai - var_x169 * (0.003016 * var_chaste_interface__membrane__V - 0.040282206767891383 * var_x128 + var_x101 * var_chaste_interface__calcium_dynamics__Cai + var_x129 * var_x153 + var_x71 * var_chaste_interface__membrane__V - var_x10 * var_x114);
        const double var_x174 = 0.001 * (0.00023800000000000004 / pow(var_x150, 3) + 7.0000000000000007e-5 / pow(var_x99, 3)) / pow(var_x151, 2);
        const double var_x175 = var_chaste_interface__calcium_dynamics__Cainfluxtrack > 0.00018000000000000001;
        const double var_x176 = 28.235294117647054 * var_chaste_interface__calcium_dynamics__OVRLDtrack2;
        const double var_x177 = var_x172 * (1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2);
        const double var_x178 = var_chaste_interface__calcium_dynamics__OVRLDtrack2 > 0.0;
        const double var_x179 = 0.00070463905573898956 * var_x154 * var_x69;
        const double var_x180 = var_x124 * var_x179;
        const double var_x181 = var_x126 * var_x179;
        const double var_x182 = 9.0316078310111336e-6 * var_x130 * var_x154;
        const double var_x183 = 4.5158039155055668e-6 * var_x129 * var_x154 * var_x40;
        const double var_x184 = var_x160 * var_x161;
        const double var_x185 = 28.235294117647054 - var_x176;
        const double var_x186 = var_x158 * var_x172;
        const double var_x187 = var_x162 * var_x186;
        const double var_x188 = var_x160 * var_x172;
        const double var_x189 = var_x159 * var_x172 * var_chaste_interface__calcium_dynamics__APtrack2 / pow(var_x157, 2);
        const double var_x190 = var_x141 * var_x155;
        const double var_x191 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x192 = -0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x193 = exp(-4.7130000000000001 + var_x192);
        const double var_x194 = 1.0 - var_x193;
        const double var_x195 = 0.32000000000000001 / var_x194;
        const double var_x196 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
        const double var_x197 = 0.0072727272727272727 * var_x196 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x198 = 47.130000000000003 + var_chaste_interface__membrane__V;
        const double var_x199 = fabs(var_x198) >= 1.0000000000000001e-5;
        const double var_x200 = -0.080000000000000002 * var_x196;
        ...
        const double var_x204 = var_chaste_interface__membrane__V < -40.0;
        ...
        const double var_x207 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x208 = 1.0 + var_x207;
        const double var_x209 = exp(-0.01052 * var_chaste_interface__membrane__V);
        const double var_x210 = var_x209 / var_x208;
        const double var_x211 = 1.0 - var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x216 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
        ...
        const double var_x221 = exp(-3.2000000000000002 + var_x192);
        ...
        const double var_x228 = 1.0 + var_x226;
        const double var_x229 = 0.035000000000000003 / pow(var_x228, 2);
        const double var_x230 = var_x226 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x231 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x232 = fabs(var_x231) < 1.0000000000000001e-5;
        const double var_x233 = 1.0 - var_x226;
        const double var_x234 = 1 / var_x233;
        const double var_x235 = 0.035000000000000003 * var_x234;
        const double var_x236 = 1 / var_x228;
        const double var_x237 = 1.0 - 1.0 * var_x236;
        const double var_x238 = var_x228 * var_x237;
        const double var_x239 = 0.005608974358974359 * var_x231;
        const double var_x240 = var_x239 / pow(var_x233, 2);
        const double var_x241 = var_x230 * var_x234 * var_x239;
        const double var_x242 = var_x231 * var_x235;
        const double var_x243 = exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_x244 = 19.699999999999999 * var_x243;
        const double var_x245 = 0.001 - 0.001 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x246 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V);
        const double var_x247 = 1.0 + var_x246;
        const double var_x248 = 0.029999999999999999 * var_x246 / pow(var_x247, 2);
        const double var_x249 = exp(4.0 + 0.125 * var_chaste_interface__membrane__V);
        const double var_x250 = 1.0 + var_x249;
        const double var_x251 = 0.125 * var_x249 / pow(var_x250, 2);
        const double var_x252 = 0.019699999999999999 * var_x243;
        const double var_x253 = -0.02 - var_x252;
        const double var_x254 = 1.0 / var_x250;
        const double var_x255 = 0.59999999999999998 / var_x247;
        const double var_x256 = var_x254 + var_x255;
        const double var_x257 = -0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V;
        const double var_x258 = 1.0 - var_x254 - var_x255;
        const double var_x259 = exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__membrane__V);
        const double var_x260 = 1.0 + var_x259;
        const double var_x261 = exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__membrane__V);
        const double var_x262 = 1.0 + var_x261;
        const double var_x263 = 1 / var_x262;
        const double var_x264 = 1 / (0.0037000000000000002 + 0.0061000000000000004 * var_x263);
        const double var_x265 = exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__membrane__V);
        const double var_x266 = 1.0 + var_x265;
        const double var_x267 = 1 / (0.012 - 0.00087500000000000002 * var_chaste_interface__membrane__V);
        const double var_x268 = var_x265 / pow(var_x266, 2);
        const double var_x269 = var_chaste_interface__membrane__V <= 0.0;
        const double var_x270 = exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x271 = 1.0 + var_x270;
        const double var_x272 = exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__membrane__V);
        const double var_x273 = -1.0 + var_x272;
        const double var_x274 = 1 / var_x273;
        const double var_x275 = 0.60999999999999999 * var_x274;
        const double var_x276 = exp(-1.7465999999999999 - 0.123 * var_chaste_interface__membrane__V);
        const double var_x277 = 1.0 - var_x276;
        const double var_x278 = 1 / var_x277;
        const double var_x279 = 1.3799999999999999 * var_x278;
        const double var_x280 = 14.199999999999999 + var_chaste_interface__membrane__V;
        const double var_x281 = 38.899999999999999 + var_chaste_interface__membrane__V;
        const double var_x282 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V);
        const double var_x283 = 1.0 + var_x282;
        const double var_x284 = 0.001 / var_x283;
        const double var_x285 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V);
        const double var_x286 = -1.0 + var_x285;
        const double var_x287 = 1 / var_x286;
        const double var_x288 = 0.13100000000000001 * var_x287;
        const double var_x289 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V);
        const double var_x290 = 1.0 - var_x289;
        const double var_x291 = 1 / var_x290;
        const double var_x292 = 0.071899999999999992 * var_x291;
        const double var_x293 = 30.0 + var_chaste_interface__membrane__V;
        const double var_x294 = var_x285 * var_x293 / pow(var_x286, 2);
        const double var_x295 = var_x289 * var_x293 / pow(var_x290, 2);
        const double var_x296 = 5.988023952095809e-5 * var_x282 / pow(var_x283, 2);
        const double var_x297 = var_x291 * var_x293;
        const double var_x298 = var_x287 * var_x293;
        const double var_x299 = 0.032750000000000001 * var_x287;
        const double var_x300 = 0.017974999999999998 * var_x291;
        const double var_x301 = 0.040000000000000001 * var_chaste_interface__membrane__V;
        const double var_x302 = exp(-1.6000000000000001 + var_x301);
        const double var_x303 = 1.0 + var_x302;
        const double var_x304 = var_x302 / var_x303;
        const double var_x305 = exp(-3.6000000000000001 - var_x301);
        const double var_x306 = 1.0 + var_x305;
        const double var_x307 = var_x305 / var_x306;
        const double var_x308 = 10000.0 * var_x304 + 10000.0 * var_x307;
        const double var_x309 = 1 / var_x308;
        const double var_x310 = 10.0 * var_x304;
        const double var_x311 = 400.0 * var_x304;
        const double var_x312 = 400.0 * pow(var_x305, 2) / pow(var_x306, 2);
        const double var_x313 = pow(var_x302, 2) / pow(var_x303, 2);
        const double var_x314 = 400.0 * var_x313;
        const double var_x315 = 400.0 * var_x307;
        const double var_x316 = 0.40000000000000002 * var_x309;
        const double var_x317 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x318 = exp(12.0 + var_x317);
        const double var_x319 = 1.0 + var_x318;
        const double var_x320 = 1 / var_x319;
        const double var_x321 = exp(5.0 + var_x317);
        const double var_x322 = 1.0 + var_x321;
        const double var_x323 = var_x321 / var_x322;
        const double var_x324 = 15.0 * var_x320 + 100.0 * var_x323;
        const double var_x325 = var_x318 / pow(var_x319, 2);
        const double var_x326 = 3.0 * var_x325;
        const double var_x327 = 20.0 * pow(var_x321, 2) / pow(var_x322, 2);
        const double var_x328 = 20.0 * var_x323;
        const double var_x329 = 1 / var_x324;
        const double var_x330 = 0.014999999999999999 * var_x320;
        const double var_x331 = 0.80000000000000004 + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x332 = pow(var_x331, (-2));
        const double var_x333 = 1 / (1.0 + 8.0 * var_x332);
        const double var_x334 = 4000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2;
        const double var_x335 = 0.001 * var_x333;
        const double var_x336 = 60000.0 * var_x161;
        const double var_x337 = 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x338 = 0.00025000000000000001 / (pow(var_x331, 3) * pow((0.125 + var_x332), 2));
        const double var_x339 = -4000.0 + var_x334;
        const double var_x340 = 0.0055555555555555558 * var_x333;
        const double var_x341 = var_x186 * var_x336;
        const double var_x342 = var_x75 * var_x77;
        const double var_x343 = var_x75 * var_x79;
        const double var_x344 = (var_chaste_interface__calcium_dynamics__APtrack > 0.17999999999999999) && (var_chaste_interface__calcium_dynamics__APtrack < 0.20000000000000001);
        const double var_x345 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
        const double var_x346 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        const double var_x347 = 0.00018063215662022267 * var_x154;
        const double var_x348 = 0.0028901145059235626 * var_x120 * var_x154 * var_x91;
        const double var_x349 = var_x125 * var_x154;
        const double var_x350 = 4.4039940983686847e-7 * var_x77;
        const double var_x351 = var_x127 * var_x154;
        const double var_x352 = 0.00067122862439358594 * var_x59;
        const double var_x353 = 1.2592160903483795e-7 * var_x79;
        ...
        IJth(rJacobian, 1, 0) = -var_x152 * var_x156;
        IJth(rJacobian, 2, 0) = ((var_x199) ? (var_x197 + var_x191 * var_x195 - 0.032000000000000001 * var_x191 * var_x193 * var_x198 / pow(var_x194, 2)) : (var_x197));
        IJth(rJacobian, 3, 0) = ((var_x204) ? ((-0.28123999999999999 * var_x201 - 108500.0 * var_x202) * var_chaste_interface__fast_sodium_current_h_gate__h - 0.14705882352941177 * var_x203 * (0.13500000000000001 - 0.13500000000000001 * var_chaste_interface__fast_sodium_current_h_gate__h)) : (-0.69300069300069311 * var_x205 * var_chaste_interface__fast_sodium_current_h_gate__h / pow(var_x206, 2)));
        IJth(rJacobian, 4, 0) = ((var_x204) ? (var_x215 * var_x218 + 0.001275024 * var_x210 * var_chaste_interface__fast_sodium_current_j_gate__j + var_x211 * var_x220 * (1.5254334000000001e-6 * var_x213 - 31073.016 * var_x212) - 0.016701360000000002 * var_x207 * var_x209 * var_chaste_interface__fast_sodium_current_j_gate__j / pow(var_x208, 2) - 0.311 * var_x215 * var_x216 * var_x219 / pow(var_x217, 2)) : (7.6049999999999996e-8 * var_x224 * var_chaste_interface__fast_sodium_current_j_gate__j - 0.030000000000000002 * var_x221 * var_x223 * var_chaste_interface__fast_sodium_current_j_gate__j / pow(var_x222, 2)));
        IJth(rJacobian, 5, 0) = ((var_x232) ? (var_x227 * var_x229 + var_x229 * var_x230) : (var_x225 * var_x235 + var_x236 * var_x241 + var_x237 * var_x241 - var_x227 * var_x240 + var_x230 * var_x238 * var_x240 - var_x235 * var_x238 * var_chaste_interface__L_type_Ca_channel_d_gate__d));
        IJth(rJacobian, 6, 0) = var_x245 * (20.0 + var_x244) * (var_x248 - var_x251) + var_x253 * (var_x251 - var_x248) * var_chaste_interface__L_type_Ca_channel_f_gate__f + var_x244 * var_x245 * var_x256 * var_x257 - var_x252 * var_x257 * var_x258 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 7, 0) = 9.2592592592592588e-5 * var_x259 * var_x264 / pow(var_x260, 2) + 0.036429872495446262 * var_x261 * (-var_chaste_interface__T_type_Ca_channel_b_gate__b + 1.0 / var_x260) / (pow(var_x262, 2) * pow((0.60655737704918034 + var_x263), 2));
        IJth(rJacobian, 8, 0) = ((var_x269) ? (0.006076388888888889 * (-var_chaste_interface__T_type_Ca_channel_g_gate__g + 1.0 / var_x266) / pow((1 - 0.072916666666666671 * var_chaste_interface__membrane__V), 2) - 0.0001785714285714286 * var_x267 * var_x268) : (-0.014880952380952382 * var_x268));
        IJth(rJacobian, 9, 0) = (0.001 / var_x271 - 0.001 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr) * (var_x275 + var_x279 - 0.16973999999999997 * var_x276 * var_x280 / pow(var_x277, 2) - 0.088449999999999987 * var_x272 * var_x281 / pow(var_x273, 2)) + 0.00013333333333333334 * var_x270 * (var_x275 * var_x281 + var_x279 * var_x280) / pow(var_x271, 2);
        IJth(rJacobian, 10, 0) = var_x296 * (var_x288 * var_x293 + var_x292 * var_x293) + (var_x284 - 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1) * (var_x288 + var_x292 - 0.0089997000000000011 * var_x294 - 0.0106412 * var_x295);
        IJth(rJacobian, 11, 0) = var_x296 * (var_x293 * var_x299 + var_x293 * var_x300) + (var_x284 - 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2) * (var_x299 + var_x300 - 0.0022499250000000003 * var_x294 - 0.0026603 * var_x295);
        IJth(rJacobian, 12, 0) = var_x308 * (var_x304 * var_x316 - var_x313 * var_x316 + 9.9999999999999995e-8 * var_x304 * (var_x314 + var_x315 - var_x311 - var_x312) / pow((var_x304 + var_x307), 2)) + (-0.001 * var_chaste_interface__transient_outward_current_zdv_gate__zdv + var_x309 * var_x310) * (var_x311 + var_x312 - var_x314 - var_x315);
        IJth(rJacobian, 13, 0) = var_x324 * (-0.0030000000000000001 * var_x325 * var_x329 + 1.5e-6 * var_x320 * (var_x326 + var_x327 - var_x328) / pow((var_x323 + 0.14999999999999999 * var_x320), 2)) + (-0.001 * var_chaste_interface__transient_outward_current_ydv_gate__ydv + var_x329 * var_x330) * (var_x328 - var_x326 - var_x327);
        IJth(rJacobian, 19, 0) = ((var_x345) ? (-var_x156) : (0));
        IJth(rJacobian, 23, 0) = var_x347 * (-0.0040000000000000001 + var_x93 + 9.1272458415149417e-5 * var_x85 - 4.5 * var_x51 - 0.0024381008236689767 * var_x342 - 0.0060000000000000001 * var_x6 * var_x9);
        IJth(rJacobian, 24, 0) = var_x347 * (-2.7574104360798206e-8 + var_x18 + 3.0 * var_x51 + 2.6097162183887167e-5 * var_x86 + 0.0010652877718143633 * var_x52 + 166.55558320535218 * var_x55 - 0.0055199999999999997 * var_x21 - 0.00069711623550831479 * var_x343 - 1.9572871637915374e-5 * var_x88 - 698.34626081908675 * var_x35 - 0.023862446088641735 * var_x144 - 0.00092307692307692295 * var_x43 - var_x352 * var_x58);
        ...
        IJth(rJacobian, 1, 1) = ((var_x175) ? (var_x171 * (var_x170 - var_x163) + var_x174 * (var_x173 + var_x163 * var_x172)) : ((var_x178) ? (var_x171 * (var_x170 + (-28.235294117647054 + var_x176) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) + var_x174 * (var_x173 + var_x176 * var_x177)) : (var_x170 * var_x171 + var_x173 * var_x174)));
        IJth(rJacobian, 14, 1) = ((var_x175) ? (60.0 * var_x184 * var_x333) : ((var_x178) ? (var_x335 * (4000.0 - var_x334) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        IJth(rJacobian, 15, 1) = 0.0050000000000000001 * var_x165 - 0.0050000000000000001 * var_x167;
        IJth(rJacobian, 19, 1) = ((var_x345) ? (-var_x155 * var_x168) : (0));
        IJth(rJacobian, 23, 1) = var_x347 * (1.4628604942013857e-6 * var_x109 + 2.6087319475749228e-6 * var_x116 + 4.1400000000000003e-5 * var_x115 + 13799.808000000001 * var_x113);
        IJth(rJacobian, 24, 1) = var_x347 * (var_x98 + 4.1826974130498884e-7 * var_x110);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-48.0 * var_x122);
        IJth(rJacobian, 2, 2) = ((var_x199) ? (var_x200 - var_x195 * var_x198) : (-3.2000000000000002 + var_x200));
        IJth(rJacobian, 23, 2) = -0.0086703435177706879 * var_x122 * var_x154;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x123 * var_chaste_interface__fast_sodium_current_j_gate__j);
        IJth(rJacobian, 3, 3) = ((var_x204) ? (-0.13500000000000001 * var_x203 - 310000.0 * var_x202 - 3.5600000000000001 * var_x201) : (-7.6923076923076934 / var_x206));
        IJth(rJacobian, 23, 3) = -var_x348 * var_chaste_interface__fast_sodium_current_j_gate__j;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x123 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 4, 4) = ((var_x204) ? (-0.1212 * var_x210 - var_x214 * var_x220) : (-0.29999999999999999 * var_x224));
        IJth(rJacobian, 23, 4) = -var_x348 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x124 * var_x70 - var_x125 * var_x78 - var_x125 * var_x80);
        IJth(rJacobian, 1, 5) = -var_x152 * var_x180;
        IJth(rJacobian, 5, 5) = ((var_x232) ? (-0.21840000000000004) : (-var_x242 - var_x238 * var_x242));
        IJth(rJacobian, 19, 5) = ((var_x345) ? (-var_x180) : (0));
        IJth(rJacobian, 23, 5) = -var_x349 * var_x350;
        IJth(rJacobian, 24, 5) = -var_x349 * var_x353;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * var_x70 - var_x127 * var_x78 - var_x127 * var_x80);
        IJth(rJacobian, 1, 6) = -var_x152 * var_x181;
        IJth(rJacobian, 6, 6) = var_x253 * var_x256 + var_x253 * var_x258;
        IJth(rJacobian, 19, 6) = ((var_x345) ? (-var_x181) : (0));
        IJth(rJacobian, 23, 6) = -var_x350 * var_x351;
        IJth(rJacobian, 24, 6) = -var_x351 * var_x353;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.10000000000000001 * var_x130);
        IJth(rJacobian, 1, 7) = -var_x152 * var_x182;
        IJth(rJacobian, 7, 7) = -0.001 * var_x264;
        IJth(rJacobian, 19, 7) = ((var_x345) ? (-var_x182) : (0));
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x129 * var_x41);
        IJth(rJacobian, 1, 8) = -var_x152 * var_x183;
        IJth(rJacobian, 8, 8) = ((var_x269) ? (-0.001 * var_x267) : (-0.083333333333333329));
        IJth(rJacobian, 19, 8) = ((var_x345) ? (-var_x183) : (0));
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x39 * var_x42);
        IJth(rJacobian, 9, 9) = -0.00060999999999999997 * var_x274 * var_x281 - 0.0013799999999999999 * var_x278 * var_x280;
        IJth(rJacobian, 24, 9) = -4.3103250992251538e-6 * var_x154 * var_x38 * var_x42;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x131);
        IJth(rJacobian, 10, 10) = -7.1899999999999999e-5 * var_x297 - 0.00013100000000000001 * var_x298;
        IJth(rJacobian, 24, 10) = var_x131 * var_x347;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x132);
        IJth(rJacobian, 11, 11) = -1.7975e-5 * var_x297 - 3.2750000000000003e-5 * var_x298;
        IJth(rJacobian, 24, 11) = var_x132 * var_x347;
        IJth(rJacobian, 12, 12) = -var_x310 - 10.0 * var_x307;
        IJth(rJacobian, 13, 13) = -var_x330 - 0.10000000000000001 * var_x323;
        IJth(rJacobian, 1, 14) = ((var_x175) ? (0.42352941176470582 * var_x152 * var_x184) : ((var_x178) ? (var_x171 * var_x185 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        IJth(rJacobian, 14, 14) = ((var_x175) ? (var_x335 * (-5.5555555555555554 - var_x160 * var_x336) + var_x338 * (var_x337 - var_x188 * var_x336)) : ((var_x178) ? (var_x335 * (-5.5555555555555554 + var_x339 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) + var_x338 * (var_x337 - var_x177 * var_x334)) : (-var_x340 + var_x337 * var_x338)));
        IJth(rJacobian, 15, 14) = 0.00048309178743961351;
        IJth(rJacobian, 1, 15) = 2.7058823529411762e-5 * var_x152;
        IJth(rJacobian, 14, 15) = var_x340;
        IJth(rJacobian, 15, 15) = -0.00081642512077294684;
        IJth(rJacobian, 16, 16) = ((7.0160275741043607 * var_chaste_interface__membrane__V - 106.84935482199306 * var_x119 - 40.282206767891381 * var_x128 - 0.00073656881518639836 * var_x23 + 2.0 * var_x114 * var_x9 + 50.0 * var_x104 * var_x129 + 698346.2608190868 * var_x35 * var_x42 + 7801.9226357407251 * var_x69 * var_x81 + 2.4381008236689765 * var_x342 * var_chaste_interface__membrane__V + 0.6971162355083147 * var_x343 * var_chaste_interface__membrane__V + 1150.0 * var_x100 * var_chaste_interface__calcium_dynamics__Cai + 5.5199999999999996 * var_x21 * var_x42 + 1500.0 * var_x136 * var_x45 + 23.862446088641736 * var_x144 * var_x42 + 1000.0 * var_x97 * (0.433 + var_x15) + 1000.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 16000.0 * var_x121 * var_x91 < -150000.0) ? (-100.5) : (-0.5));
        IJth(rJacobian, 1, 17) = ((var_x175) ? (var_x171 * (-423.5294117647058 * var_x188 + var_x159 * var_x187)) : (0));
        IJth(rJacobian, 14, 17) = ((var_x175) ? (var_x335 * (60000.0 * var_x188 - var_x159 * var_x341)) : (0));
        IJth(rJacobian, 17, 17) = ((var_x344) ? (-100.5) : (-0.5));
        IJth(rJacobian, 18, 18) = ((var_x344) ? (-100.5) : (-0.01));
        IJth(rJacobian, 1, 19) = ((var_x175) ? (var_x171 * (var_x187 * var_chaste_interface__calcium_dynamics__APtrack2 - var_x162 * var_x189)) : (0));
        IJth(rJacobian, 14, 19) = ((var_x175) ? (var_x335 * (var_x189 * var_x336 - var_x341 * var_chaste_interface__calcium_dynamics__APtrack2)) : (0));
        IJth(rJacobian, 19, 19) = (((var_x345) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 1, 21) = ((var_x175) ? (0) : ((var_x178) ? (var_x171 * (var_x172 * var_x185 + (28.235294117647054 * var_chaste_interface__calcium_dynamics__Cai - 28.235294117647054 * var_chaste_interface__calcium_dynamics__Ca_JSR) * var_chaste_interface__calcium_dynamics__OVRLDtrack2)) : (0)));
        IJth(rJacobian, 14, 21) = ((var_x175) ? (0) : ((var_x178) ? (var_x335 * (var_x172 * var_x339 + (4000.0 * var_chaste_interface__calcium_dynamics__Ca_JSR - 4000.0 * var_chaste_interface__calcium_dynamics__Cai) * var_chaste_interface__calcium_dynamics__OVRLDtrack2)) : (0)));
        IJth(rJacobian, 21, 21) = (((var_x346) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50.0) : (-0.5));
        IJth(rJacobian, 22, 22) = (((var_x346) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50.0) : (-0.01));
        ...
        IJth(rJacobian, 1, 23) = -var_x152 * var_x190;
        IJth(rJacobian, 19, 23) = ((var_x345) ? (-var_x190) : (0));
        IJth(rJacobian, 23, 23) = var_x347 * (var_x135 + 6.124934136868245e-12 * var_x139 - 0.032399999999999998 * var_x140 - 0.10684935482199306 * var_x118 - 0.0018285756177517324 * var_x87 - 0.089999999999999997 * var_x137);
        IJth(rJacobian, 24, 23) = var_x347 * (var_x134 + 0.059999999999999998 * var_x137);
        ...
        IJth(rJacobian, 24, 24) = var_x347 * (var_x149 + 4449.089151873166 * var_x148 - 18654.461852717679 * var_x143 - 0.63742174226149029 * var_x145 - 0.14745210965435041 * var_x142 - 7.3656881518639831e-7 * var_x22 - var_x147 * var_x352);
    }
