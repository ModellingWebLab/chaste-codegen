...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellmahajan_shiferaw_2008FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_ICaL__rxa = 4.0 * (-0.34100000000000003 * NV_Ith_S(mParameters, 5) + var_Ca__csm * exp(2.0 * var_Environment__FonRT * var_chaste_interface__cell__V)) * NV_Ith_S(mParameters, 8) * var_Environment__FonRT * NV_Ith_S(mParameters, 10) * var_chaste_interface__cell__V / (-1.0 + exp(2.0 * var_Environment__FonRT * var_chaste_interface__cell__V)); // mA_per_cm2
    ...
    void Cellmahajan_shiferaw_2008FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_IKr__xkrv1 = 0.0013799999999999999 * (7.0 + var_chaste_interface__cell__V) / (1.0 - exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V)); // per_ms
        const double var_IKr__xkrv2 = 0.00060999999999999997 * (10.0 + var_chaste_interface__cell__V) / (-1.0 + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_IKs__tauxs1 = 1 / (0.00013100000000000001 * (30.0 + var_chaste_interface__cell__V) / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V)) + 7.1899999999999999e-5 * (30.0 + var_chaste_interface__cell__V) / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V))); // ms
    ...
    void Cellmahajan_shiferaw_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        double var_chaste_interface__Ca__trops = NV_Ith_S(rY, 25);
        // Units: uM; Initial value: 19.864701949854
        const double var_x0 = -var_chaste_interface__Ito__ytos;
        const double var_x1 = 0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x2 = exp(3.3500000000000001 + var_x1);
        const double var_x3 = 1.0 + var_x2;
        const double var_x4 = 1 / var_x3;
        const double var_x5 = (var_x0 - 0.5 * var_x4) * NV_Ith_S(mParameters, 18);
        const double var_x6 = NV_Ith_S(mParameters, 14) * var_chaste_interface__Ito__ytof;
        const double var_x7 = pow(var_chaste_interface__Ca__Ca_i_converted, 3);
        const double var_x8 = 1.0 + 1.2500000000000001e-10 / var_x7;
        const double var_x9 = -1.0 - 0.80000000000000004 / var_x8;
        const double var_x10 = var_x9 * NV_Ith_S(mParameters, 17) * var_chaste_interface__IKs__xs2;
        const double var_x11 = var_x10 * var_chaste_interface__IKs__xs1;
        const double var_x12 = pow(var_chaste_interface__INa__xm, 3);
        const double var_x13 = var_x12 * NV_Ith_S(mParameters, 11) * var_chaste_interface__INa__xj;
        const double var_x14 = var_x13 * var_chaste_interface__INa__xh;
        const double var_x15 = sqrt(NV_Ith_S(mParameters, 6));
        const double var_x16 = var_x15 * NV_Ith_S(mParameters, 16) * var_chaste_interface__IKr__xr;
        const double var_x17 = exp(1.4732142857142858 + 0.044642857142857144 * var_chaste_interface__cell__V);
        const double var_x18 = 1.0 + var_x17;
        const double var_x19 = 0.43033148291193518 / var_x18;
        const double var_x20 = NV_Ith_S(mParameters, 9) * NV_Ith_S(mParameters, 20) / NV_Ith_S(mParameters, 8);
        const double var_x21 = var_x20 * log(NV_Ith_S(mParameters, 6) / NV_Ith_S(mParameters, 4));
        const double var_x22 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 0.23849999999999999 * var_x21);
        const double var_x23 = 1.0 + var_x22;
        const double var_x24 = 1 / var_x23;
        const double var_x25 = exp(-2.4444678999999998 + 0.51429999999999998 * var_x21 - 0.51429999999999998 * var_chaste_interface__cell__V);
        const double var_x26 = 1.0 + var_x25;
        const double var_x27 = 1 / var_x26;
        const double var_x28 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 0.061749999999999999 * var_x21);
        const double var_x29 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 0.080320000000000003 * var_x21);
        const double var_x30 = var_x28 + 0.49124000000000001 * var_x29;
        const double var_x31 = var_x27 * var_x30;
        const double var_x32 = var_x15 * NV_Ith_S(mParameters, 15) / (var_x31 + 1.02 * var_x24);
        const double var_x33 = var_x21;
        const double var_x34 = -var_x33 + var_chaste_interface__cell__V;
        const double var_x35 = NV_Ith_S(mParameters, 18) * var_chaste_interface__Ito__xtos;
        const double var_x36 = var_x2 / pow(var_x3, 2);
        const double var_x37 = 0.34999999999999998 * var_chaste_interface__cell__V;
        const double var_x38 = 1 / (NV_Ith_S(mParameters, 9) * NV_Ith_S(mParameters, 20));
        const double var_x39 = var_x38 * NV_Ith_S(mParameters, 8);
        const double var_x40 = exp(var_x37 * var_x39);
        const double var_x41 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x42 = var_x41 * NV_Ith_S(mParameters, 5);
        const double var_x43 = var_x40 * var_x42;
        const double var_x44 = pow(NV_Ith_S(mParameters, 7), 3);
        const double var_x45 = var_x44 * var_chaste_interface__Ca__Ca_submem;
        const double var_x46 = var_x39 * var_chaste_interface__cell__V;
        const double var_x47 = exp(-0.65000000000000002 * var_x46);
        const double var_x48 = var_x39 * var_x47;
        const double var_x49 = var_x44 * (1.0 + 0.00053738391835633597 * var_x41);
        const double var_x50 = 0.001 * var_x44;
        const double var_x51 = var_x50 * var_chaste_interface__Ca__Ca_submem;
        const double var_x52 = (1.0 + 0.27777777777777779 * var_chaste_interface__Ca__Ca_submem) * NV_Ith_S(mParameters, 5);
        const double var_x53 = 1 / (var_x42 + var_x51 + 669.921875 * var_chaste_interface__Ca__Ca_submem + 0.0035999999999999999 * var_x49 + 1.3 * var_x41 + 1860.8670000000004 * var_x52);
        const double var_x54 = 1.0 + 0.20000000000000001 * var_x47;
        const double var_x55 = 1 / var_x54;
        const double var_x56 = 1.0 + 0.026999999999999996 / pow(var_chaste_interface__Ca__Ca_submem, 3);
        const double var_x57 = 1 / var_x56;
        const double var_x58 = var_x55 * var_x57 * NV_Ith_S(mParameters, 19);
        const double var_x59 = var_x53 * var_x58;
        const double var_x60 = var_x59 * (0.34999999999999998 * var_x39 * var_x43 + 0.00064999999999999997 * var_x45 * var_x48);
        const double var_x61 = var_x22 / pow(var_x23, 2);
        const double var_x62 = 1 / (1.5 + NV_Ith_S(mParameters, 6));
        const double var_x63 = 1 / (12.0 + var_chaste_interface__Na__Na_i);
        const double var_x64 = 0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x65 = exp(-var_x39 * var_x64);
        const double var_x66 = exp(0.01485884101040119 * NV_Ith_S(mParameters, 7));
        const double var_x67 = exp(-var_x46);
        const double var_x68 = 1.0 + 0.1245 * var_x65 + 0.036499999999999998 * var_x67 * (-0.14285714285714285 + 0.14285714285714285 * var_x66);
        const double var_x69 = var_x62 * var_x63 * (0.012450000000000001 * var_x39 * var_x65 + var_x39 * var_x67 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x66)) * NV_Ith_S(mParameters, 6) * var_chaste_interface__Na__Na_i / pow(var_x68, 2);
        const double var_x70 = var_x15 * var_x34;
        const double var_x71 = 1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca;
        const double var_x72 = exp(2.0 * var_x46);
        const double var_x73 = var_x72 * var_chaste_interface__Ca__Ca_submem;
        const double var_x74 = 0.001 * var_x73 - 0.34100000000000003 * NV_Ith_S(mParameters, 5);
        const double var_x75 = -1.0 + var_x72;
        const double var_x76 = NV_Ith_S(mParameters, 10) / var_x75;
        const double var_x77 = var_x38 * var_x76 * pow(NV_Ith_S(mParameters, 8), 2);
        const double var_x78 = var_x74 * var_x77;
        const double var_x79 = var_x71 * var_x78;
        const double var_x80 = var_x72 * var_chaste_interface__cell__V;
        const double var_x81 = var_x71 * var_x80;
        const double var_x82 = pow(NV_Ith_S(mParameters, 8), 3) / (pow(NV_Ith_S(mParameters, 9), 2) * pow(NV_Ith_S(mParameters, 20), 2));
        const double var_x83 = var_x74 * var_x82 * NV_Ith_S(mParameters, 10) / pow(var_x75, 2);
        const double var_x84 = var_x81 * var_x83;
        const double var_x85 = var_x43 - var_x47 * var_x51;
        const double var_x86 = var_x53 * var_x85 * NV_Ith_S(mParameters, 19);
        const double var_x87 = var_x48 * var_x57 * var_x86 / pow(var_x54, 2);
        const double var_x88 = var_x73 * var_x76 * var_x82 * var_chaste_interface__cell__V;
        const double var_x89 = var_x71 * var_x88;
        const double var_x90 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + NV_Ith_S(mParameters, 4));
        const double var_x91 = var_x20;
        const double var_x92 = -var_x91 * log(var_x90 * (0.018329999999999999 * NV_Ith_S(mParameters, 7) + NV_Ith_S(mParameters, 6))) + var_chaste_interface__cell__V;
        const double var_x93 = var_x92 * NV_Ith_S(mParameters, 17) * var_chaste_interface__IKs__xs1;
        const double var_x94 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x95 = -var_x91 * log(var_x94 * NV_Ith_S(mParameters, 7)) + var_chaste_interface__cell__V;
        const double var_x96 = var_x95 * NV_Ith_S(mParameters, 11) * var_chaste_interface__INa__xh;
        const double var_x97 = var_x96 * pow(var_chaste_interface__INa__xm, 2) * var_chaste_interface__INa__xj;
        const double var_x98 = var_x13 * var_x95;
        const double var_x99 = var_x12 * var_x96;
        const double var_x100 = var_x78 * var_chaste_interface__cell__V;
        const double var_x101 = 11648.0 * var_x100;
        const double var_x102 = var_x33 - var_chaste_interface__cell__V;
        const double var_x103 = var_x62 * NV_Ith_S(mParameters, 6) / var_x68;
        const double var_x104 = var_x103 * var_x63;
        const double var_x105 = var_x103 * var_chaste_interface__Na__Na_i / pow((1 + 0.083333333333333329 * var_chaste_interface__Na__Na_i), 2);
        const double var_x106 = pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x107 = var_x106 * NV_Ith_S(mParameters, 5);
        const double var_x108 = -3 * var_x107 - 3.9000000000000004 * var_x106 - 5.8037463182484285e-6 * var_x106 * var_x44;
        const double var_x109 = var_x58 * var_x85 / pow((var_x52 + 0.00053738391835633597 * var_x42 + 0.00069859909386323679 * var_x41 + 1.9345821060828095e-6 * var_x49 + 5.37383918356336e-7 * var_x45 + 0.36000524218012353 * var_chaste_interface__Ca__Ca_submem), 2);
        const double var_x110 = 2.3102518056640731e-6 * var_x109;
        const double var_x111 = var_x107 * var_x40 * var_x59;
        const double var_x112 = var_x44 * var_x47 * var_x59;
        const double var_x113 = var_x55 * var_x86 / (pow(var_x56, 2) * pow(var_chaste_interface__Ca__Ca_submem, 4));
        const double var_x114 = -669.921875 - var_x50 - 516.90750000000014 * NV_Ith_S(mParameters, 5);
        const double var_x115 = var_x77 * var_x81;
        const double var_x116 = 32.699999999999996 * var_chaste_interface__Ca__tropi;
        const double var_x117 = pow(var_chaste_interface__Ca__Ca_i_converted, 2);
        const double var_x118 = 2.0 * var_x7 * NV_Ith_S(mParameters, 2) / pow((2.4999999999999999e-7 + var_x117), 2);
        const double var_x119 = 1000000.0 * var_x117;
        const double var_x120 = NV_Ith_S(mParameters, 2) / (0.25 + var_x119);
        const double var_x121 = 2000000.0 * var_x120 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x122 = pow(var_chaste_interface__Ca__Ca_NSR, 2);
        const double var_x123 = NV_Ith_S(mParameters, 0) / (2500.0 + var_x122);
        const double var_x124 = var_x122 * var_x123;
        const double var_x125 = 1000.0 * var_x124;
        const double var_x126 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x127 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x128 = 0.013000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x129 = 0.00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x130 = 1.0 + 0.00016800000000000002 / pow(var_x126, 2) + 2.8200000000000001e-5 / pow(var_x127, 2) + 0.00054600000000000004 / pow(var_x128, 2) + 4.5000000000000001e-6 / pow(var_x129, 2);
        const double var_x131 = 1 / var_x130;
        const double var_x132 = 0.001 * var_x131;
        const double var_x133 = 32.699999999999996 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x134 = var_x119 * var_x120;
        const double var_x135 = 16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x136 = var_x124 * var_x135;
        const double var_x137 = 16.667000000000002 * var_x124;
        const double var_x138 = 2 * var_x123 * var_x135 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x139 = 3.2000000000000001e-7 * var_x135 * pow(var_chaste_interface__Ca__Ca_NSR, 3) * NV_Ith_S(mParameters, 0) / pow((1 + 0.00040000000000000002 * var_x122), 2);
        const double var_x140 = 1.0 - var_chaste_interface__INa__xm;
        const double var_x141 = -var_x64;
        const double var_x142 = exp(-4.7130000000000001 + var_x141);
        const double var_x143 = 1.0 - var_x142;
        const double var_x144 = 0.32000000000000001 / var_x143;
        const double var_x145 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x146 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x147 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 13) - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x148 = var_chaste_interface__cell__V < -40.0;
        const double var_x149 = ((var_x148) ? (0.13500000000000001 * var_x147) : (0));
        const double var_x150 = var_x149;
        const double var_x151 = exp(var_x37 - 0.34999999999999998 * NV_Ith_S(mParameters, 13));
        const double var_x152 = exp(0.079000000000000001 * var_chaste_interface__cell__V - 0.079000000000000001 * NV_Ith_S(mParameters, 13));
        const double var_x153 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 13) - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x154 = 1.0 + var_x153;
        const double var_x155 = ((var_x148) ? (310000.0 * var_x151 + 3.5600000000000001 * var_x152) : (7.6923076923076916 / var_x154));
        const double var_x156 = var_x155;
        const double var_x157 = ((var_x148) ? (-0.019852941176470591 * var_x147) : (0));
        const double var_x158 = var_x149 + var_x155;
        const double var_x159 = 0.01 * NV_Ith_S(mParameters, 12);
        const double var_x160 = 1.0 - var_x159;
        const double var_x161 = var_x160 / var_x158;
        const double var_x162 = ((var_x148) ? (0.28123999999999999 * var_x152 + 108500.0 * var_x151) : (0.693000693000693 * var_x153 / pow(var_x154, 2)));
        const double var_x163 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x164 = 1.0 + var_x163;
        const double var_x165 = exp(0.01052 * NV_Ith_S(mParameters, 13) - 0.01052 * var_chaste_interface__cell__V);
        const double var_x166 = var_x165 / var_x164;
        const double var_x167 = exp(-3.2000000000000002 + var_x141);
        const double var_x168 = 1.0 + var_x167;
        const double var_x169 = exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 13) - 2.5349999999999999e-7 * var_chaste_interface__cell__V);
        const double var_x170 = var_x169 / var_x168;
        const double var_x171 = ((var_x148) ? (0.1212 * var_x166) : (0.29999999999999999 * var_x170));
        const double var_x172 = var_x171;
        const double var_x173 = 37.780000000000001 + var_chaste_interface__cell__V;
        const double var_x174 = exp(0.24440000000000001 * var_chaste_interface__cell__V - 0.24440000000000001 * NV_Ith_S(mParameters, 13));
        const double var_x175 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 13) - 0.043909999999999998 * var_chaste_interface__cell__V);
        ...
        const double var_x181 = ((var_x148) ? (var_x173 * var_x180) : (0));
        const double var_x182 = var_x181;
        const double var_x183 = ((var_x148) ? (var_x180 + var_x173 * var_x179 * (1.5254334000000001e-6 * var_x175 - 31073.016 * var_x174) - 0.311 * var_x173 * var_x176 * var_x177 / pow(var_x178, 2)) : (0));
        const double var_x184 = var_x171 + var_x181;
        const double var_x185 = var_x160 / var_x184;
        const double var_x186 = ((var_x148) ? (-0.001275024 * var_x166 + 0.016701360000000002 * var_x163 * var_x165 / pow(var_x164, 2)) : (-7.6049999999999996e-8 * var_x170 + 0.029999999999999999 * var_x167 * var_x169 / pow(var_x168, 2)));
        const double var_x187 = exp(-0.125 * var_chaste_interface__cell__V);
        const double var_x188 = 1.0 + var_x187;
        const double var_x189 = var_x187 / pow(var_x188, 2);
        const double var_x190 = 0.125 * var_x189;
        const double var_x191 = var_x190 * var_chaste_interface__ICaL__c1;
        const double var_x192 = 1 / var_x188;
        const double var_x193 = var_x192;
        const double var_x194 = pow(var_chaste_interface__Ca__Ca_dyad, 3);
        const double var_x195 = 1 / var_x194;
        const double var_x196 = 1 / (1.0 + 27.0 * var_x195);
        const double var_x197 = pow(var_chaste_interface__Ca__Ca_dyad, 4);
        const double var_x198 = 1 / var_x197;
        const double var_x199 = var_x198 / pow((0.037037037037037035 + var_x195), 2);
        const double var_x200 = 0.002685333333333333 * var_x199 * var_chaste_interface__ICaL__c1;
        const double var_x201 = exp(-10.0 - 0.25 * var_chaste_interface__cell__V);
        const double var_x202 = 1.0 + var_x201;
        const double var_x203 = 1.0 - 1 / var_x202;
        const double var_x204 = exp(0.064102564102564111 * var_chaste_interface__cell__V);
        const double var_x205 = 4954.0 * var_x204;
        const double var_x206 = -440.0 + var_x205;
        const double var_x207 = var_x203 * var_x206;
        const double var_x208 = 1 / (450.0 + var_x207);
        const double var_x209 = exp(-3.5335689045936394 - 0.088339222614840993 * var_chaste_interface__cell__V);
        const double var_x210 = 1.0 + var_x209;
        const double var_x211 = 0.088339222614840993 * var_x209 / pow(var_x210, 2);
        const double var_x212 = var_x208 * var_x211;
        const double var_x213 = 1 / var_x210;
        const double var_x214 = -317.5641025641026 * var_x203 * var_x204;
        const double var_x215 = 0.25 * var_x201 / pow(var_x202, 2);
        const double var_x216 = 4.9382716049382717e-6 * (var_x214 + var_x206 * var_x215) / pow((1 + 0.0022222222222222222 * var_x207), 2);
        const double var_x217 = var_x213 * var_x216;
        const double var_x218 = 1.0 + 0.00072525373756441506 * var_x197;
        const double var_x219 = 1 / var_x218;
        const double var_x220 = 78.032899999999998 * var_x219;
        const double var_x221 = 9.9000000000000004 + var_x205 - var_x220;
        const double var_x222 = var_x203 * var_x221;
        const double var_x223 = 1 / (0.10000000000000001 + var_x220 + var_x222);
        const double var_x224 = var_x196 * var_x223;
        const double var_x225 = var_x211 * var_x224;
        const double var_x226 = 0.00016422697956757767 / pow((0.0012815107473898831 + var_x219 + 0.012815107473898831 * var_x222), 2);
        const double var_x227 = var_x226 * (var_x214 + var_x215 * var_x221);
        const double var_x228 = var_x196 * var_x213;
        const double var_x229 = var_x227 * var_x228;
        const double var_x230 = var_x213;
        const double var_x231 = 1.0 - var_x230;
        const double var_x232 = var_x216 * var_x231;
        const double var_x233 = var_x227 * var_x231;
        const double var_x234 = var_x211 * var_x223;
        const double var_x235 = -var_x193;
        const double var_x236 = 1.0 + var_x235;
        const double var_x237 = var_x208 * var_x230;
        const double var_x238 = var_x224 * var_x230;
        const double var_x239 = var_x223 * var_x231;
        const double var_x240 = var_x208 * var_x231;
        const double var_x241 = 0.22637460951196098 * var_x194 / pow(var_x218, 2);
        const double var_x242 = var_x226 * (var_x241 - var_x203 * var_x241);
        const double var_x243 = var_x228 * var_x242;
        const double var_x244 = 0.1111111111111111 * var_x199 * var_x213 * var_x223;
        const double var_x245 = var_x231 * var_chaste_interface__ICaL__xi2ca;
        const double var_x246 = var_x242 * var_x245;
        const double var_x247 = exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V);
        const double var_x248 = 1.0 + var_x247;
        const double var_x249 = var_x247 / pow(var_x248, 2);
        const double var_x250 = 0.1111111111111111 * var_x249;
        const double var_x251 = var_x250 * var_chaste_interface__ICaL__xi1ca;
        const double var_x252 = 0.33333333333333331 / var_x248;
        const double var_x253 = 0.33333333333333331 - var_x252;
        const double var_x254 = 1 / var_x236;
        const double var_x255 = var_x192 * var_x254;
        const double var_x256 = var_x209 * var_x253 * var_x255;
        const double var_x257 = 20.604954226274931 * var_x256;
        const double var_x258 = var_x213 * var_x257;
        const double var_x259 = var_x189 * var_x254;
        const double var_x260 = var_x210 * var_x253;
        const double var_x261 = 29.156010230179024 * var_x245 * var_x260;
        const double var_x262 = var_x187 / (pow(var_x188, 3) * pow(var_x236, 2));
        const double var_x263 = -0.018268800000000002 * var_x196;
        const double var_x264 = 41.377027474346242 + 1117.1797418073486 * var_x195;
        const double var_x265 = var_x231 * var_x260;
        const double var_x266 = var_x255 * var_x265;
        const double var_x267 = 233.2480818414322 * var_x266;
        const double var_x268 = var_x250 * var_chaste_interface__ICaL__xi1ba;
        const double var_x269 = 0.16287544169611309 * var_x256;
        const double var_x270 = var_x213 * var_x269;
        const double var_x271 = var_x231 * var_x269;
        const double var_x272 = 0.23046875000000003 * var_x265;
        const double var_x273 = var_x259 * var_x272;
        const double var_x274 = var_x262 * var_x272;
        const double var_x275 = var_x210 * var_x231 * var_x249 * var_x255;
        const double var_x276 = 0.20486111111111113 * var_x275;
        const double var_x277 = 1.8437500000000002 * var_x266;
        const double var_x278 = 29.156010230179024 * var_x265;
        const double var_x279 = exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x280 = 1.0 + var_x279;
        const double var_x281 = exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V);
        const double var_x282 = -1.0 + var_x281;
        const double var_x283 = 0.00060999999999999997 / var_x282;
        const double var_x284 = exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V);
        const double var_x285 = 1.0 - var_x284;
        const double var_x286 = 0.0013799999999999999 / var_x285;
        const double var_x287 = 7.0 + var_chaste_interface__cell__V;
        const double var_x288 = 10.0 + var_chaste_interface__cell__V;
        const double var_x289 = var_x283 * var_x288;
        const double var_x290 = var_x286 * var_x287;
        const double var_x291 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        const double var_x292 = 1.0 + var_x291;
        const double var_x293 = 1 / var_x292;
        const double var_x294 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V);
        const double var_x295 = -1.0 + var_x294;
        const double var_x296 = 1 / var_x295;
        const double var_x297 = 0.00013100000000000001 * var_x296;
        const double var_x298 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V);
        const double var_x299 = 1.0 - var_x298;
        const double var_x300 = 1 / var_x299;
        const double var_x301 = 7.1899999999999999e-5 * var_x300;
        const double var_x302 = 30.0 + var_chaste_interface__cell__V;
        const double var_x303 = var_x294 * var_x302 / pow(var_x295, 2);
        const double var_x304 = var_x298 * var_x302 / pow(var_x299, 2);
        const double var_x305 = var_x297 * var_x302;
        const double var_x306 = var_x301 * var_x302;
        const double var_x307 = 0.059880239520958084 * var_x291 / pow(var_x292, 2);
        const double var_x308 = 3.2750000000000003e-5 * var_x296;
        const double var_x309 = 1.7975e-5 * var_x300;
        const double var_x310 = var_x302 * var_x308;
        const double var_x311 = var_x302 * var_x309;
        const double var_x312 = 0.066666666666666666 * var_chaste_interface__cell__V;
        const double var_x313 = exp(0.20000000000000001 + var_x312);
        const double var_x314 = 1.0 + var_x313;
        const double var_x315 = 1 / var_x314;
        const double var_x316 = 1 / (0.5 + 9.0 * var_x315);
        const double var_x317 = exp(-0.20000000000000001 - var_x312);
        const double var_x318 = 1.0 + var_x317;
        const double var_x319 = 0.066666666666666666 * var_x317 / pow(var_x318, 2);
        const double var_x320 = 1 / var_x318;
        const double var_x321 = exp(6.0 + var_x1);
        const double var_x322 = 1.0 + var_x321;
        const double var_x323 = 1 / var_x322;
        const double var_x324 = 1 / (30.0 + 3000.0 * var_x323);
        const double var_x325 = 0.10000000000000001 * var_x36;
        const double var_x326 = var_x4;
        const double var_x327 = exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2));
        const double var_x328 = 1 / (1.5 + 3.5 * var_x327);
        const double var_x329 = 1 / (20.0 + 20.0 * var_x4);
        const double var_x330 = exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x331 = 1.0 + var_x330;
        const double var_x332 = 4.0 * var_x78;
        const double var_x333 = fabs(var_x332 * var_chaste_interface__cell__V);
        const double var_x334 = (var_chaste_interface__Irel__Ca_JSR > 50.0) && (var_chaste_interface__Irel__Ca_JSR < 90.0);
        const double var_x335 = var_chaste_interface__Irel__Ca_JSR >= 90.0;
        const double var_x336 = ((var_x334) ? (-50.0 + var_chaste_interface__Irel__Ca_JSR) : ((var_x335) ? (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR) : (0)));
        const double var_x337 = var_x333 * var_x336;
        const double var_x338 = var_x337 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x339 = var_x338 * var_x71;
        const double var_x340 = 0.0014337722222222222 * var_x339;
        const double var_x341 = var_x330 / var_x331;
        const double var_x342 = 0.028675444444444444 * var_x341;
        const double var_x343 = var_x342 * var_x71;
        const double var_x344 = var_x343 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x345 = Signum(var_x100);
        const double var_x346 = var_x345 * (var_x332 + 0.0080000000000000002 * var_x88 - 8.0 * var_x80 * var_x83);
        const double var_x347 = var_x336 * var_x346;
        const double var_x348 = var_x121 + var_x125 - var_x118;
        const double var_x349 = 1 / var_chaste_interface__Ca__Ca_NSR;
        const double var_x350 = var_x349 * var_chaste_interface__Irel__xir;
        const double var_x351 = -var_x338 * var_x342;
        const double var_x352 = var_x333 * ((var_x334) ? (1.0) : ((var_x335) ? (11.300000000000001) : (0)));
        const double var_x353 = var_x134 - var_x136 - var_chaste_interface__Irel__xir;
        const double var_x354 = var_x336 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x355 = var_x139 - var_x137 - var_x138;
        const double var_x356 = 0.000125 * var_x14;
        const double var_x357 = 0.000125 * NV_Ith_S(mParameters, 3);
        const double var_x358 = 8.6634442712402744e-10 * var_x109;
        const double var_x359 = 9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca;
        const double var_x360 = exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V);
        const double var_x361 = 1.0 + var_x360;
        const double var_x362 = var_x360 / var_x361;
        const double var_x363 = var_x338 * var_x362;
        const double var_x364 = var_x362 * var_x71;
        const double var_x365 = 298.24222222222221 * var_x364;
        const double var_x366 = (-9000.0 * var_x333 - 298.24222222222221 * var_x363) * NV_Ith_S(mParameters, 1);
        const double var_x367 = var_x365 * NV_Ith_S(mParameters, 1);
        const double var_x368 = var_x345 * var_x77 * var_x80;
        const double var_x369 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_submem;
        const double var_x370 = pow(var_x369, (-2));
        const double var_x371 = 1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem;
        const double var_x372 = pow(var_x371, (-2));
        const double var_x373 = 0.59999999999999998 + var_chaste_interface__Ca__Ca_submem;
        const double var_x374 = pow(var_x373, (-2));
        const double var_x375 = 1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem;
        const double var_x376 = pow(var_x375, (-2));
        const double var_x377 = 1 / (1.0 + 4.5 * var_x370 + 3.2307692307692308 * var_x372 + 28.199999999999999 * var_x374 + 3.4285714285714284 * var_x376);
        const double var_x378 = var_x377;
        const double var_x379 = 36400.0 * var_x100;
        const double var_x380 = var_x377 * var_x379;
        const double var_x381 = 1.4439073785400458e-5 * var_x109;
        const double var_x382 = 0.0327 * var_chaste_interface__Ca__trops;
        const double var_x383 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x11 - var_x14 + 23296.0 * var_x84 - 8.0 * var_x60 - 1.5 * var_x69 - 11648.0 * var_x79 - 1.04 * var_x87 - 23.295999999999999 * var_x89 + var_x5 * var_chaste_interface__Ito__xtos - var_x16 * var_x19 - var_x6 * var_chaste_interface__Ito__xtof - 0.4389381125701739 * var_x24 * var_x32 + 0.10468673984798647 * var_x32 * var_x34 * var_x61 + 0.050000000000000003 * var_x34 * var_x35 * var_x36 + 0.019211226915711394 * var_x16 * var_x17 * var_x34 / pow(var_x18, 2) - 0.42189361069797565 * var_x24 * var_x70 * (0.24326999999999999 * var_x61 - var_x27 * (0.061749999999999999 * var_x28 + 0.039456396800000001 * var_x29) - 0.51429999999999998 * var_x25 * var_x30 / pow(var_x26, 2)) * NV_Ith_S(mParameters, 15) / pow((var_x24 + 0.98039215686274506 * var_x31), 2));
        IJth(rJacobian, 2, 0) = var_x140 * var_x144 + 0.0072727272727272727 * var_x145 * var_chaste_interface__INa__xm - 0.032000000000000001 * var_x140 * var_x142 * var_x146 / pow(var_x143, 2);
        IJth(rJacobian, 3, 0) = (var_x150 + var_x156) * (var_x157 * var_x161 + var_x149 * var_x160 * (-var_x157 - var_x162) / pow(var_x158, 2)) + (var_x157 + var_x162) * (var_x159 - var_chaste_interface__INa__xh + var_x149 * var_x161);
        IJth(rJacobian, 4, 0) = (var_x172 + var_x182) * (var_x183 * var_x185 + var_x160 * var_x181 * (-var_x183 - var_x186) / pow(var_x184, 2)) + (var_x183 + var_x186) * (var_x159 - var_chaste_interface__INa__xj + var_x181 * var_x185);
        IJth(rJacobian, 5, 0) = var_x191 + var_x190 * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 6, 0) = -var_x191 + var_x232 * var_chaste_interface__ICaL__xi2ba + var_x233 * var_chaste_interface__ICaL__xi2ca + (-var_x190 - var_x212 - var_x217 - var_x225 - var_x229) * var_chaste_interface__ICaL__c2 - var_x212 * var_chaste_interface__ICaL__xi2ba - var_x234 * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 7, 0) = var_x251 + var_x259 * var_x261 + var_x261 * var_x262 - var_x245 * var_x257 - var_x258 * var_chaste_interface__ICaL__xi2ca - 25.91645353793691 * var_x210 * var_x245 * var_x249 * var_x255;
        IJth(rJacobian, 8, 0) = var_x268 + var_x273 * var_chaste_interface__ICaL__xi2ba + var_x274 * var_chaste_interface__ICaL__xi2ba - var_x270 * var_chaste_interface__ICaL__xi2ba - var_x271 * var_chaste_interface__ICaL__xi2ba - var_x276 * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 9, 0) = -var_x251 + var_x225 * var_chaste_interface__ICaL__c2 + var_x229 * var_chaste_interface__ICaL__c2 + (var_x234 + var_x258 - var_x233 + 25.91645353793691 * var_x275 + var_x231 * var_x257 - var_x259 * var_x278 - var_x262 * var_x278) * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 10, 0) = -var_x268 + var_x212 * var_chaste_interface__ICaL__c2 + var_x217 * var_chaste_interface__ICaL__c2 + (var_x212 + var_x270 + var_x271 + var_x276 - var_x232 - var_x273 - var_x274) * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 11, 0) = (-var_chaste_interface__IKr__xr + 1 / var_x280) * (var_x283 + var_x286 - 0.00016973999999999998 * var_x284 * var_x287 / pow(var_x285, 2) - 8.8449999999999995e-5 * var_x281 * var_x288 / pow(var_x282, 2)) + 0.13333333333333333 * var_x279 * (var_x289 + var_x290) / pow(var_x280, 2);
        IJth(rJacobian, 12, 0) = var_x307 * (var_x305 + var_x306) + (var_x293 - var_chaste_interface__IKs__xs1) * (var_x297 + var_x301 - 8.9997000000000013e-6 * var_x303 - 1.0641199999999999e-5 * var_x304);
        IJth(rJacobian, 13, 0) = var_x307 * (var_x310 + var_x311) + (var_x293 - var_chaste_interface__IKs__xs2) * (var_x308 + var_x309 - 2.2499250000000003e-6 * var_x303 - 2.6602999999999998e-6 * var_x304);
        IJth(rJacobian, 14, 0) = var_x316 * var_x319 + 0.0074074074074074077 * var_x313 * (var_x320 - var_chaste_interface__Ito__xtos) / (pow(var_x314, 2) * pow((0.055555555555555552 + var_x315), 2));
        IJth(rJacobian, 15, 0) = -var_x324 * var_x325 + 3.3333333333333335e-5 * var_x321 * (var_x0 + var_x326) / (pow(var_x322, 2) * pow((0.01 + var_x323), 2));
        IJth(rJacobian, 16, 0) = var_x319 * var_x328 + 0.00063492063492063492 * var_x327 * (var_x320 - var_chaste_interface__Ito__xtof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x327), 2);
        IJth(rJacobian, 17, 0) = -var_x325 * var_x329 + 0.0050000000000000001 * var_x36 * (var_x326 - var_chaste_interface__Ito__ytof) / pow((1 + var_x4), 2);
        IJth(rJacobian, 19, 0) = var_x344 * var_x347 - var_x340 * var_x341 + var_x340 * pow(var_x330, 2) / pow(var_x331, 2);
        IJth(rJacobian, 20, 0) = (-var_x356 - 0.00039000000000000005 * var_x87 - 0.00056249999999999996 * var_x69 - 0.0030000000000000001 * var_x60) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 0) = (var_x346 * var_x359 - 106.65141866666666 * var_x363 * var_x71 + var_x347 * var_x365 * var_chaste_interface__Ca__Ca_NSR + 106.65141866666666 * var_x339 * pow(var_x360, 2) / pow(var_x361, 2)) * NV_Ith_S(mParameters, 1);
        IJth(rJacobian, 22, 0) = var_x378 * (50.0 * var_x60 + 72800.0 * var_x84 + 6.5000000000000009 * var_x87 - 36400.0 * var_x79 - 72.799999999999997 * var_x89);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0000000000000005e-10 * var_x93 * var_chaste_interface__IKs__xs2 / (pow(var_x8, 2) * pow(var_chaste_interface__Ca__Ca_i_converted, 4)));
        IJth(rJacobian, 1, 1) = var_x132 * (-2539.0 + var_x116 + var_x118 - var_x121 - var_x125) + 0.001 * (0.00033600000000000004 / pow(var_x126, 3) + 5.6400000000000002e-5 / pow(var_x127, 3) + 0.0010920000000000001 / pow(var_x128, 3) + 9.0000000000000002e-6 / pow(var_x129, 3)) * (var_x136 - var_x134 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x133 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x130, 2);
        IJth(rJacobian, 19, 1) = var_x348 * var_x350;
        IJth(rJacobian, 22, 1) = 12500.0 * var_x377;
        IJth(rJacobian, 23, 1) = var_x348;
        IJth(rJacobian, 24, 1) = 2289.0 - var_x116;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x97);
        IJth(rJacobian, 2, 2) = -0.080000000000000002 * var_x145 - var_x144 * var_x146;
        IJth(rJacobian, 20, 2) = -0.00037500000000000001 * var_x97 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x98);
        IJth(rJacobian, 3, 3) = -var_x150 - var_x156;
        IJth(rJacobian, 20, 3) = -var_x357 * var_x98;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x99);
        IJth(rJacobian, 4, 4) = -var_x172 - var_x182;
        IJth(rJacobian, 20, 4) = -var_x357 * var_x99;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x101);
        IJth(rJacobian, 5, 5) = -4.3041299999999998 + var_x193 - 0.024167999999999999 * var_x196;
        IJth(rJacobian, 6, 5) = var_x236;
        IJth(rJacobian, 7, 5) = 0.0058991999999999968 * var_x196;
        IJth(rJacobian, 8, 5) = 0.0021800000000000001;
        IJth(rJacobian, 19, 5) = var_x351;
        IJth(rJacobian, 21, 5) = var_x366;
        IJth(rJacobian, 22, 5) = var_x380;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x101);
        IJth(rJacobian, 5, 6) = -3.0 + var_x193;
        IJth(rJacobian, 6, 6) = var_x235 - var_x237 - var_x238;
        IJth(rJacobian, 7, 6) = var_x263;
        IJth(rJacobian, 8, 6) = -0.0019499999999999999;
        IJth(rJacobian, 9, 6) = var_x238;
        IJth(rJacobian, 10, 6) = var_x237;
        IJth(rJacobian, 19, 6) = var_x351;
        IJth(rJacobian, 21, 6) = var_x366;
        IJth(rJacobian, 22, 6) = var_x380;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x101);
        IJth(rJacobian, 5, 7) = -2.999896385;
        IJth(rJacobian, 7, 7) = -0.33343694833333332 + var_x252 + var_x263 - 1.8929217120000003e-7 * var_x196 * var_x264;
        IJth(rJacobian, 8, 7) = -0.0019499999999999999;
        IJth(rJacobian, 9, 7) = var_x253;
        IJth(rJacobian, 19, 7) = var_x351;
        IJth(rJacobian, 21, 7) = var_x366;
        IJth(rJacobian, 22, 7) = var_x380;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x101);
        IJth(rJacobian, 5, 8) = -2.99776;
        IJth(rJacobian, 7, 8) = var_x263;
        IJth(rJacobian, 8, 8) = -0.33762909604519775 + var_x252;
        IJth(rJacobian, 10, 8) = var_x253;
        IJth(rJacobian, 19, 8) = var_x351;
        IJth(rJacobian, 21, 8) = var_x366;
        IJth(rJacobian, 22, 8) = var_x380;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x101);
        IJth(rJacobian, 5, 9) = -3.0;
        IJth(rJacobian, 6, 9) = var_x239;
        IJth(rJacobian, 7, 9) = var_x263 + var_x267;
        IJth(rJacobian, 8, 9) = -0.0019499999999999999;
        IJth(rJacobian, 9, 9) = -var_x239 - var_x267;
        IJth(rJacobian, 19, 9) = var_x351;
        IJth(rJacobian, 21, 9) = var_x366;
        IJth(rJacobian, 22, 9) = var_x380;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x101);
        IJth(rJacobian, 5, 10) = -3.0;
        IJth(rJacobian, 6, 10) = var_x240;
        IJth(rJacobian, 7, 10) = var_x263;
        IJth(rJacobian, 8, 10) = -0.0019499999999999999 + var_x277;
        IJth(rJacobian, 10, 10) = -var_x240 - var_x277;
        IJth(rJacobian, 19, 10) = var_x351;
        IJth(rJacobian, 21, 10) = var_x366;
        IJth(rJacobian, 22, 10) = var_x380;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x19 * var_x70 * NV_Ith_S(mParameters, 16));
        IJth(rJacobian, 11, 11) = -var_x289 - var_x290;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x10 * var_x92);
        IJth(rJacobian, 12, 12) = -var_x305 - var_x306;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x9 * var_x93);
        IJth(rJacobian, 13, 13) = -var_x310 - var_x311;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x34 * var_x5);
        IJth(rJacobian, 14, 14) = -var_x316;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (var_x102 * var_x35);
        IJth(rJacobian, 15, 15) = -var_x324;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x102 * var_x6);
        IJth(rJacobian, 16, 16) = -var_x328;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x102 * NV_Ith_S(mParameters, 14) * var_chaste_interface__Ito__xtof);
        IJth(rJacobian, 17, 17) = -var_x329;
        IJth(rJacobian, 18, 18) = -0.01;
        IJth(rJacobian, 19, 18) = var_x344 * var_x352;
        IJth(rJacobian, 21, 18) = var_x352 * var_x367 * var_chaste_interface__Ca__Ca_NSR;
        IJth(rJacobian, 19, 19) = -0.033333333333333333 - var_x350 + var_x349 * var_x353;
        IJth(rJacobian, 22, 19) = 50.0 * var_x377;
        IJth(rJacobian, 23, 19) = -1;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (0.010416666666666666 * var_x105 - 1.5 * var_x104 - 24.0 * var_x111 - var_x108 * var_x110 - var_x14 * var_x91 * var_x94 + 0.018329999999999999 * var_x11 * var_x20 * var_x90);
        IJth(rJacobian, 20, 20) = (3.9062500000000001e-6 * var_x105 - 0.00056249999999999996 * var_x104 - 0.0089999999999999993 * var_x111 - var_x108 * var_x358 - var_x20 * var_x356 * var_x94) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 20) = var_x378 * (150.0 * var_x111 + var_x108 * var_x381);
        IJth(rJacobian, 5, 21) = -var_x200;
        IJth(rJacobian, 6, 21) = var_x246 + (-var_x243 - var_x244) * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 7, 21) = var_x200 + (0.00063442013684210537 * var_x196 * var_x198 - 2.1032463466666669e-8 * var_x199 * var_x264) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x199 * var_x71;
        IJth(rJacobian, 9, 21) = -var_x246 + var_x243 * var_chaste_interface__ICaL__c2 + var_x244 * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 21, 21) = -2.0;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (0.0080000000000000002 * var_x112 - 0.64799999999999991 * var_x113 - 11.648 * var_x115 - var_x110 * var_x114);
        IJth(rJacobian, 1, 22) = 0.00025000000000000001 * var_x131;
        IJth(rJacobian, 19, 22) = 0.00011470177777777777 * var_x115 * var_x341 * var_x345 * var_x354;
        IJth(rJacobian, 20, 22) = (3.0000000000000001e-6 * var_x112 - 0.00024299999999999997 * var_x113 - var_x114 * var_x358) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 22) = 2.0 + (0.0040000000000000001 * var_x359 * var_x368 + 1.192968888888889 * var_x354 * var_x364 * var_x368) * NV_Ith_S(mParameters, 1);
        IJth(rJacobian, 22, 22) = var_x378 * (-14.789 + var_x382 + 4.0499999999999998 * var_x113 - 36.399999999999999 * var_x115 - 0.050000000000000003 * var_x112 + var_x114 * var_x381) + 0.0012574820180071425 * (9.0 / pow(var_x369, 3) + 56.399999999999999 / pow(var_x373, 3) + 0.97959183673469385 / pow(var_x375, 3) + 0.49704142011834318 / pow(var_x371, 3)) * (50.0 * var_chaste_interface__Irel__xir + 0.019599999999999999 * var_chaste_interface__Ca__trops + 12500.0 * var_chaste_interface__Ca__Ca_i_converted - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x379 * var_x71 - var_x383 * (70.0 - var_chaste_interface__Ca__trops) + 50.0 * var_x59 * var_x85) / pow((0.035460992907801421 + var_x374 + 0.15957446808510639 * var_x370 + 0.12158054711246201 * var_x376 + 0.11456628477905074 * var_x372), 2);
        IJth(rJacobian, 25, 22) = 2.2890000000000001 - var_x382;
        IJth(rJacobian, 1, 23) = var_x132 * (var_x137 + var_x138 - var_x139);
        IJth(rJacobian, 18, 23) = 0.01;
        IJth(rJacobian, 19, 23) = var_x337 * var_x343 + (var_x349 * var_x355 - var_x353 / var_x122) * var_chaste_interface__Irel__xir;
        IJth(rJacobian, 21, 23) = var_x337 * var_x367;
        IJth(rJacobian, 23, 23) = var_x355;
        IJth(rJacobian, 1, 24) = var_x132 * (0.019599999999999999 + var_x133);
        IJth(rJacobian, 24, 24) = -0.019599999999999999 - var_x133;
        IJth(rJacobian, 22, 25) = var_x378 * (0.019599999999999999 + var_x383);
        IJth(rJacobian, 25, 25) = -0.019599999999999999 - var_x383;
    }
