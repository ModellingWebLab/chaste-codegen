...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellohara_rudy_2011_epiFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_INab__INab = (-NV_Ith_S(mParameters, 4) + var_chaste_interface__intracellular_ions__nai * exp(var_membrane__vfrt)) * var_INab__PNab * var_membrane__vffrt / (-1.0 + exp(var_membrane__vfrt)); // microA_per_microF
    ...
    void Cellohara_rudy_2011_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x978 = 0.16431153466973381 * var_x971 / pow(var_x972, 2);
        ...
        const double var_x988 = exp(14.640157739073281 + var_x970);
        ...
        const double var_x1092 = 1.0 + 0.002 * var_x377;
        const double var_x1093 = pow((1 / var_chaste_interface__ICaL__jca + 0.001 * pow(var_x1092, 4)), (-2));
        ...
        const double var_x1098 = exp(-1.2280159080866107 - 0.14729709824716453 * var_chaste_interface__membrane__v);
        const double var_x1099 = 1.0 + var_x1098;
        const double var_x1100 = 0.14729709824716453 * var_x1098 / pow(var_x1099, 2);
        const double var_x1101 = 1 / var_x1099;
        ...
        const double var_x1110 = exp(-1.2987012987012987 - 0.11195700850873264 * var_chaste_interface__membrane__v);
        const double var_x1111 = 1.0 + var_x1110;
        const double var_x1112 = 0.11195700850873264 * var_x1110 / pow(var_x1111, 2);
        const double var_x1113 = 1 / var_x1111;
        ...
        const double var_x1118 = 1 / (3.8115000000000001 + 1.5691999999999999 * NV_Ith_S(mParameters, 3));
        const double var_x1119 = exp(var_x1118 * (-144.59 - var_chaste_interface__membrane__v - 2.5537999999999998 * NV_Ith_S(mParameters, 3)));
        const double var_x1120 = 1.0 + var_x1119;
        ...
        const double var_x1127 = var_x1126 * (var_x493 + var_x495 + var_x502 + var_x503 + var_x506 + var_x508 - var_x498 - var_x500);
        ...
        const double var_x1132 = 2.375 * var_x1131;
        const double var_x1133 = var_x608 - var_x607;
        const double var_x1134 = var_x1126 * var_x1132;
        const double var_x1135 = var_x796 + var_x797 + var_x799 - var_x798;
        const double var_x1136 = var_x948 + var_x949;
        const double var_x1137 = var_x1126 * var_x1136;
        const double var_x1138 = pow(var_chaste_interface__intracellular_ions__cajsr, (-2));
        const double var_x1139 = var_x1136 / (pow((0.039018442310623382 + var_x1125), 2) * pow(var_chaste_interface__intracellular_ions__cajsr, 9));
        const double var_x1140 = var_x821 + var_x822;
        const double var_x1141 = var_x1126 * var_x504;
        const double var_x1142 = var_x1131 * var_x1141;
        const double var_x1143 = 11.4 * var_x1142;
        const double var_x1144 = var_x834 + var_x835;
        const double var_x1145 = var_x845 + var_x846;
        const double var_x1146 = var_x854 + var_x855;
        const double var_x1147 = 12.540000000000001 * var_x1142;
        const double var_x1148 = var_x866 + var_x867;
        ...
        const double var_x1151 = 2.96875 * var_x1150;
        const double var_x1152 = var_x1126 * var_x1151;
        const double var_x1153 = var_x1141 * var_x1150;
        const double var_x1154 = 14.25 * var_x1153;
        const double var_x1155 = 15.675000000000001 * var_x1153;
        ...
        IJth(rJacobian, 11, 0) = (var_x973 - var_chaste_interface__INa__hf) * (0.30335471139615194 * var_x974 - 2.2784407319013524e-6 * var_x975) - var_x978 * (var_x976 + var_x977);
        IJth(rJacobian, 12, 0) = (var_x973 - var_chaste_interface__INa__hs) * (0.0059001058948111541 * var_x979 - 0.00034916221033868096 * var_x980) - var_x978 * (var_x981 + var_x982);
        IJth(rJacobian, 13, 0) = -var_x978 * var_x986 - 2.5847740332669882 * var_x987 * (var_x973 - var_chaste_interface__INa__j);
        IJth(rJacobian, 14, 0) = (-var_chaste_interface__INa__hsp + 1 / var_x989) * (0.0019667019649370517 * var_x979 - 0.00011638740344622698 * var_x980) - 0.16431153466973381 * var_x988 * (var_x990 + var_x991) / pow(var_x989, 2);
        IJth(rJacobian, 15, 0) = -var_x978 * var_x992 - 1.7703931734705398 * var_x987 * (var_x973 - var_chaste_interface__INa__jp);
        ...
        IJth(rJacobian, 31, 0) = -var_x1073 * var_x1090 - 403.12421264802225 * var_x1075 * (var_x1074 - var_chaste_interface__ICaL__ffp);
        IJth(rJacobian, 32, 0) = -var_x1073 * var_x1091 - 5.1020408163265305 * var_x1085 * (var_x1074 - var_chaste_interface__ICaL__fcafp);
        IJth(rJacobian, 34, 0) = var_x1097 * var_x1100 - 0.044502978385908498 * (var_x1101 - var_chaste_interface__IKr__xrf) * (2.0230618253189406e-6 * var_x1094 - 0.094391315585422589 * var_x1095) / (pow((1 + 0.077041602465331274 * var_x1096), 2) * pow((var_x1095 + 0.00011289704271631982 * var_x1094), 2));
        IJth(rJacobian, 35, 0) = var_x1100 * var_x1105 - 65.425385409990326 * (var_x1101 - var_chaste_interface__IKr__xrs) * (4.348496530454896e-7 * var_x1102 - 0.0090129163834126447 * var_x1103) / (pow((1 + 0.53619302949061665 * var_x1104), 2) * pow((var_x1103 + 0.00017016141197767387 * var_x1102), 2));
        IJth(rJacobian, 36, 0) = var_x1109 * var_x1112 - 0.89683381486126834 * (var_x1113 - var_chaste_interface__IKs__xs1) * (5.617391304347826e-6 * var_x1106 - 1.3067415730337078e-5 * var_x1107) / (pow((1 + 0.001223540927444023 * var_x1108), 2) * pow((var_x1106 + 0.18003095975232197 * var_x1107), 2));
        IJth(rJacobian, 37, 0) = var_x1112 * (var_x1116 + var_x1117) + (var_x1113 - var_chaste_interface__IKs__xs2) * (0.00050000000000000001 * var_x1114 - 0.00062258064516129035 * var_x1115);
        IJth(rJacobian, 38, 0) = (-var_chaste_interface__IK1__xk1 + 1 / var_x1120) * (0.00011803412744333594 * var_x1121 - 0.00040193055283135957 * var_x1122) + var_x1118 * var_x1119 * (var_x1123 + var_x1124) / pow(var_x1120, 2);
        IJth(rJacobian, 39, 0) = -var_x1127 * var_x1132;
        IJth(rJacobian, 40, 0) = -var_x1127 * var_x1151;
        ...
        IJth(rJacobian, 39, 2) = -var_x1133 * var_x1134;
        IJth(rJacobian, 40, 2) = -var_x1133 * var_x1152;
        ...
        IJth(rJacobian, 33, 7) = 7.9999999999999996e-6 * var_x1093 * var_x277 * pow(var_x1092, 3);
        IJth(rJacobian, 39, 7) = -var_x1134 * var_x1135;
        IJth(rJacobian, 40, 7) = -var_x1135 * var_x1152;
        ...
        IJth(rJacobian, 39, 9) = (-var_chaste_interface__ryr__Jrelnp - 2.375 * var_x1137) * ((var_x1130) ? (0) : (-0.0025894736842105265 * var_x1138)) - 0.74135040390184426 * var_x1131 * var_x1139;
        IJth(rJacobian, 40, 9) = (-var_chaste_interface__ryr__Jrelp - 2.96875 * var_x1137) * ((var_x1149) ? (0) : (-0.0020715789473684213 * var_x1138)) - 0.92668800487730529 * var_x1139 * var_x1150;
        ...
        IJth(rJacobian, 12, 12) = -var_x981 - var_x982;
        ...
        IJth(rJacobian, 39, 25) = -var_x1134 * var_x1140;
        IJth(rJacobian, 40, 25) = -var_x1140 * var_x1152;
        ...
        IJth(rJacobian, 39, 26) = -var_x1143 * var_x825;
        IJth(rJacobian, 40, 26) = -var_x1154 * var_x825;
        ...
        IJth(rJacobian, 39, 27) = -var_x1134 * var_x1144;
        IJth(rJacobian, 40, 27) = -var_x1144 * var_x1152;
        ...
        IJth(rJacobian, 39, 28) = -var_x1143 * var_x837;
        IJth(rJacobian, 40, 28) = -var_x1154 * var_x837;
        ...
        IJth(rJacobian, 39, 29) = -var_x1134 * var_x1145;
        IJth(rJacobian, 40, 29) = -var_x1145 * var_x1152;
        ...
        IJth(rJacobian, 33, 30) = -var_chaste_interface__ICaL__nca + 1.0 * var_x1093 / pow(var_chaste_interface__ICaL__jca, 2);
        IJth(rJacobian, 39, 30) = -var_x1134 * var_x1146;
        IJth(rJacobian, 40, 30) = -var_x1146 * var_x1152;
        ...
        IJth(rJacobian, 31, 31) = -var_x1090;
        IJth(rJacobian, 39, 31) = -var_x1147 * var_x857;
        IJth(rJacobian, 40, 31) = -var_x1155 * var_x857;
        ...
        IJth(rJacobian, 32, 32) = -var_x1091;
        IJth(rJacobian, 39, 32) = -var_x1147 * var_x858;
        IJth(rJacobian, 40, 32) = -var_x1155 * var_x858;
        ...
        IJth(rJacobian, 38, 38) = -var_x1123 - var_x1124;
