...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldavies_isap_2012FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x102 = NV_Ith_S(mParameters, 4) / (-1.0 + var_x100);
        const double var_x103 = var_x102 * (var_x3 + var_x100 * var_x101);
        const double var_x104 = exp(1.0000000006626268e-7);
        const double var_x105 = NV_Ith_S(mParameters, 4) / (-1.0 + var_x104);
        ...
        const double var_x112 = NV_Ith_S(mParameters, 4) / var_x111;
        ...
        const double var_x118 = ((var_x108) ? (7224.0024356962413 * var_x103 + 7224.0024453040905 * var_x106) : (var_x114 + var_x112 * var_x116 * var_chaste_interface__Ca__Ca_ss - var_x110 * var_x116 * NV_Ith_S(mParameters, 4) / var_x117));
        ...
        const double var_x122 = var_x72 * var_x74 * NV_Ith_S(mParameters, 18) * var_chaste_interface__Ito__ydv2;
        ...
        const double var_x125 = var_x124 * var_x53 * NV_Ith_S(mParameters, 13) * var_chaste_interface__IKr__xr / pow((0.40000000000000002 + var_x53), 2);
        ...
        const double var_x132 = exp(0.01485884101040119 * NV_Ith_S(mParameters, 3));
        ...
        const double var_x135 = NV_Ith_S(mParameters, 2) * NV_Ith_S(mParameters, 16) / (1.5 + NV_Ith_S(mParameters, 2));
        ...
        const double var_x139 = var_x124 * var_x61 * NV_Ith_S(mParameters, 10) / pow((var_x61 + 0.98039215686274506 * var_x68), 2);
        ...
        const double var_x143 = 0.0048242500000000004 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x147 = NV_Ith_S(mParameters, 8) / var_x146;
        const double var_x148 = pow(var_x146, (-2));
        const double var_x149 = var_x148 * var_chaste_interface__Ca__Ca_i * NV_Ith_S(mParameters, 8);
        const double var_x150 = var_x85 * var_x98;
        const double var_x151 = -1004882.8125 - var_x92 - 775361.25000000012 * NV_Ith_S(mParameters, 0);
        const double var_x152 = var_x141 * var_x89 * NV_Ith_S(mParameters, 15);
        ...
        const double var_x154 = 9.9030543773805519e-13 * var_x153;
        ...
        const double var_x157 = -26.712338705500134 * log(var_x156 * (0.018329999999999999 * NV_Ith_S(mParameters, 3) + NV_Ith_S(mParameters, 2))) + var_chaste_interface__cell__V;
        const double var_x158 = var_x157 * var_chaste_interface__IKs__xs1;
        const double var_x159 = var_x158 * var_x41 * var_x42 * var_x46 / pow(var_x43, 2);
        const double var_x160 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x161 = log(var_x160 * NV_Ith_S(mParameters, 3));
        const double var_x162 = -26.712338705500134 * var_x161 + var_chaste_interface__cell__V;
        const double var_x163 = var_x162 * var_x50;
        const double var_x164 = var_x162 * NV_Ith_S(mParameters, 9) * var_chaste_interface__INa__H;
        const double var_x165 = var_x164 * pow(var_chaste_interface__INa__m, 2) * var_chaste_interface__INa__J;
        const double var_x166 = var_x164 * var_x49;
        ...
        const double var_x180 = var_x178 * var_chaste_interface__ICaL__fca2;
        const double var_x181 = var_x158 * NV_Ith_S(mParameters, 14);
        const double var_x182 = var_x72 * var_x78 * pow(var_chaste_interface__Ito__ydv, 2) * NV_Ith_S(mParameters, 18) * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv;
        const double var_x183 = var_x72 * var_x79;
        const double var_x184 = var_x122 * var_x78;
        const double var_x185 = 0.0096485000000000008 * NV_Ith_S(mParameters, 17);
        const double var_x186 = var_x185 * var_x23;
        const double var_x187 = var_x186 * var_x24;
        const double var_x188 = var_x185 * var_x26;
        const double var_x189 = ((var_x28) ? (var_x187 - 187179.41753899999 * (-2.6712338705500134e-6 + var_chaste_interface__cell__V) * (-var_x187 - var_x188 * var_x27)) : (var_x36 * var_chaste_interface__cell__V));
        const double var_x190 = var_x162 * pow(var_chaste_interface__INal__mL, 2) * NV_Ith_S(mParameters, 11) * var_chaste_interface__INal__hL;
        const double var_x191 = var_x162 * var_x39;
        const double var_x192 = var_x160 * var_x40;
        const double var_x193 = var_x156 * var_x48;
        const double var_x194 = var_x160 * var_x51;
        const double var_x195 = var_x129 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x208 = var_x207 * NV_Ith_S(mParameters, 7);
        ...
        const double var_x266 = ((var_x261) ? (0.15999999943156581 * var_x258 + 0.16000000056843419 * var_x259) : (var_x265 - 0.032000000000000001 * var_x260 * var_x263 / pow(var_x264, 2)));
        const double var_x267 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x268 = 0.0072727272727272727 * var_x267;
        ...
        const double var_x291 = exp(0.59347181008902072 - 0.14836795252225518 * var_chaste_interface__cell__V);
        const double var_x292 = 1.0 + var_x291;
        const double var_x293 = 1 / (0.58999999999999997 + 0.80000000000000004 * var_x290);
        const double var_x294 = exp(-19.117647058823529 - 0.29411764705882354 * var_chaste_interface__cell__V);
        const double var_x295 = 1 / NV_Ith_S(mParameters, 5);
        const double var_x296 = exp(2.4457142857142857 + 0.14285714285714285 * var_chaste_interface__cell__V);
        ...
        const double var_x300 = var_x296 / pow(var_x297, 2);
        ...
        const double var_x306 = var_x303 * var_x305;
        const double var_x307 = -10.0 * var_x240 - 10.0 * var_x242;
        const double var_x308 = 0.01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x301 + 0.29999999999999999 / (1.0 - 20.0 * var_x172)) / pow((0.050000000000000003 + var_x227 + 0.10000000000000001 * var_x301), 2);
        const double var_x309 = pow((0.0030000000000000001 + var_chaste_interface__Ca__Ca_ss), (-2));
        const double var_x310 = 0.00075000000000000002 * var_x249 - 0.00075000000000000002 * var_x248;
        ...
        const double var_x319 = exp(-2.1819999999999999 - 0.18190000000000001 * var_chaste_interface__cell__V);
        ...
        const double var_x326 = exp(0.4251012145748988 - 0.04048582995951417 * var_chaste_interface__cell__V);
        ...
        const double var_x335 = var_x333 - 0.00075871700000000012 * var_x331 * var_x334 / pow(var_x332, 2);
        ...
        const double var_x343 = var_x342 - 4.6080000000000006e-5 * var_x336 * var_x340 / pow(var_x341, 2);
        const double var_x344 = fabs(var_x334) < 1.0030088759549471e-8;
        const double var_x345 = ((var_x337) ? (var_x335 + 0.00018000000000000001 * var_x329 + 0.00018000000000000001 * var_x330) : ((var_x344) ? (var_x343 + 3.8049986522476652e-5 * var_x338 + 3.8050013477523354e-5 * var_x339) : (var_x335 + var_x343)));
        ...
        const double var_x351 = var_x326 * var_x350 / pow(var_x327, 2);
        ...
        const double var_x356 = 1.0 - var_chaste_interface__Ito__ydv;
        ...
        const double var_x360 = var_chaste_interface__Ito__ydv;
        const double var_x361 = 0.040000000000000001 * var_chaste_interface__Ito__ydv2;
        ...
        const double var_x365 = pow(var_x363, 2) / pow(var_x364, 2);
        const double var_x366 = var_x363 / var_x364;
        const double var_x367 = exp(12.0 + var_x362);
        const double var_x368 = 1.0 + var_x367;
        const double var_x369 = var_x367 / pow(var_x368, 2);
        const double var_x370 = 1 / var_x368;
        const double var_x371 = 0.02 * var_chaste_interface__Ito__zdv;
        const double var_x372 = exp(14.918032786885247 + 0.16393442622950821 * var_chaste_interface__cell__V);
        const double var_x373 = 0.0025000000000000005 * var_x222;
        const double var_x374 = -var_x168 + 5.1546800034037841e-8 * var_x106;
        const double var_x375 = 7.1354903911398109e-12 / pow(var_x374, 3);
        const double var_x376 = -1 + 0.066666666666666666 * var_chaste_interface__cell__V;
        const double var_x377 = pow(var_x110, (-2));
        const double var_x378 = pow(NV_Ith_S(mParameters, 4), (-2));
        const double var_x379 = var_x117 * var_x377 * var_x378;
        const double var_x380 = pow(var_x376, (-2));
        const double var_x381 = var_x109 * var_x378 * var_x380;
        const double var_x382 = 3.1882311526515621e-12 * var_x381;
        const double var_x383 = var_x117 / pow(var_x110, 3);
        const double var_x384 = pow(var_chaste_interface__ICaL__d, (-2 * var_chaste_interface__ICaL__dp));
        const double var_x385 = pow(var_chaste_interface__ICaL__f, (-2));
        const double var_x386 = pow(var_chaste_interface__ICaL__f2, (-2));
        const double var_x387 = pow(var_chaste_interface__ICaL__fca, (-2));
        const double var_x388 = pow(var_chaste_interface__ICaL__fca2, (-2));
        const double var_x389 = var_x384 * var_x385 * var_x386 * var_x387 * var_x388;
        const double var_x390 = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999);
        const double var_x391 = 0.0028 + var_chaste_interface__Ca__Ca_ss;
        const double var_x392 = 1 / var_x391;
        const double var_x393 = pow((var_x392 * var_chaste_interface__Ca__Ca_ss), 1.8999999999999999);
        const double var_x394 = 1 / (var_x390 + 1644.6531773416521 * var_x393);
        const double var_x395 = ((var_x108) ? (7.1354903911398109e-12 / pow(var_x374, 2)) : (2.1291277605263905e-11 * var_x379 * var_x380));
        const double var_x396 = var_x389 * var_x395;
        const double var_x397 = 1.0 + var_x396;
        const double var_x398 = var_x390 * var_x394 / pow(var_x397, 2);
        const double var_x399 = 0.33333333333333331 * var_x389 * var_x398;
        const double var_x400 = 0.66666666666666663 * var_x398;
        const double var_x401 = var_x396 * var_x400;
        const double var_x402 = var_x384 * var_x386 * var_x388 * var_x395 * var_x400;
        const double var_x403 = var_x384 * var_x385 * var_x387 * var_x395 * var_x400;
        const double var_x404 = 1 / var_x397;
        const double var_x405 = var_x404 / pow((var_x393 + 0.00060803092942449902 * var_x390), 2);
        const double var_x406 = exp(3.3333333333333335 + 66.666666666666671 * var_x172);
        const double var_x407 = 1.0 + var_x406;
        const double var_x408 = var_x406 / pow(var_x407, 2);
        const double var_x409 = 1 / var_x407;
        const double var_x410 = exp(-16.0 + 80.0 * var_x409 + 40000.0 * var_chaste_interface__Ca__Ca_ss);
        ...
        const double var_x418 = var_x410 * var_x417 / pow(var_x411, 2);
        const double var_x419 = 5333.333333333333 * var_x418;
        const double var_x420 = var_x408 * var_x419;
        const double var_x421 = (-var_chaste_interface__Irel__ri + 1 / var_x411) / pow((0.29999999999999999 + var_x227 + 0.10000000000000001 * var_x416), 2);
        const double var_x422 = var_x412 * var_x415 / pow(var_x413, 2);
        const double var_x423 = 10.0 * var_x421 * var_x422;
        const double var_x424 = var_x408 * var_x423;
        const double var_x425 = var_x171 * var_x408;
        const double var_x426 = 0.01 * var_x421;
        const double var_x427 = var_x213 * var_x408;
        const double var_x428 = 1.827729786302835e-16 * var_x153;
        const double var_x429 = log(var_x207 * NV_Ith_S(mParameters, 1));
        ...
        const double var_x439 = 3.0760371441184366e-5 * var_x55;
        ...
        const double var_x455 = var_x118 * var_x454;
        const double var_x456 = 1 / var_x451;
        const double var_x457 = var_x456 * var_chaste_interface__Irel__ri;
        const double var_x458 = var_x452 * var_x457;
        const double var_x459 = 3000.0 * var_x449;
        const double var_x460 = var_x453 * var_x456;
        ...
        const double var_x465 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x466 = var_x234 * var_x465;
        const double var_x467 = var_x229 * var_x465;
        ...
        const double var_x473 = 0.0010458526290002684 * var_x471;
        const double var_x474 = 719.99999999999989 * var_x471;
        const double var_x475 = 719.99999999999989 * var_x461;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x48 - var_x121 - var_x123 - var_x19 - var_x22 - var_x38 - var_x40 - var_x51 - var_x80 - NV_Ith_S(mParameters, 7) + 0.02 * var_x125 + 0.12163499999999999 * var_x128 - var_x136 - var_x99 - 0.51000000000000001 * var_x70 - 0.0065699975556189009 * var_x142 - 0.16722408026755853 * var_x73 - var_x138 * var_x140 - var_x56 * var_chaste_interface__IKr__xr);
        IJth(rJacobian, 1, 0) = var_x217 * (6.1520742882368733e-5 * var_x99 + 4.0419113035702141e-7 * var_x142 - 3.0760371441184366e-5 * var_x19);
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__INa__H) * ((var_x252) ? (0) : (-0.019852941176470591 * var_x253)) - ((var_x252) ? (0.693000693000693 * var_x254 / pow(var_x255, 2)) : (0.28123999999999999 * var_x256 + 108500.0 * var_x257)) * var_chaste_interface__INa__H;
        IJth(rJacobian, 3, 0) = var_x266 * (1.0 - var_chaste_interface__INa__m) + var_x268 * var_chaste_interface__INa__m;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__INa__J) * ((var_x252) ? (0) : (var_x277 + var_x276 * var_x278 * (1.5254334000000001e-6 * var_x272 - 31073.016 * var_x271) - 0.311 * var_x273 * var_x274 * var_x278 / pow(var_x275, 2))) - ((var_x252) ? (-7.6049999999999996e-8 * var_x282 + 0.029999999999999999 * var_x279 * var_x281 / pow(var_x280, 2)) : (-0.001275024 * var_x286 + 0.016701360000000002 * var_x283 * var_x285 / pow(var_x284, 2))) * var_chaste_interface__INa__J;
        IJth(rJacobian, 5, 0) = 1.5624999999999998 * (-var_chaste_interface__ICaL__d + 1 / var_x292) * (-0.041599999999999998 * var_x290 + 0.10560000000000001 * var_x287 * var_x289 / pow(var_x288, 2)) / pow((0.73749999999999993 + var_x290), 2) + 0.14836795252225518 * var_x291 * var_x293 / pow(var_x292, 2);
        IJth(rJacobian, 6, 0) = -2.3529411764705883 * var_x294 * var_x295 / pow((1.0 + var_x294), 2);
        IJth(rJacobian, 7, 0) = -0.099999999999999992 * var_x300 * (0.052900000000000003 + var_x299) + var_x299 * (0.039250169999999994 - 0.0040499999999999998 * var_chaste_interface__cell__V) * (0.29999999999999999 - var_chaste_interface__ICaL__f + 0.69999999999999996 * var_x298);
        IJth(rJacobian, 8, 0) = var_x121 * var_x306;
        IJth(rJacobian, 9, 0) = var_x121 * var_x316 - var_x121 * var_x317;
        IJth(rJacobian, 10, 0) = -0.11 * var_x300 * (0.0054000000000000003 + var_x318) + var_x318 * (0.12930244120000001 - 0.0069619999999999994 * var_chaste_interface__cell__V) * (0.23000000000000001 - var_chaste_interface__ICaL__f2 + 0.77000000000000002 * var_x298);
        IJth(rJacobian, 11, 0) = 0.18190000000000001 * var_x319 * var_x325 / pow(var_x320, 2) - 0.00054083288263926451 * (-var_chaste_interface__IKr__xr + 1 / var_x320) * (0.012800000000000001 * var_x321 - 0.1691 * var_x322) / (pow(var_x323, 2) * pow((1 + 0.023255813953488372 * var_x324), 2));
        IJth(rJacobian, 12, 0) = 0.04048582995951417 * var_x351 + var_x345 * (-var_chaste_interface__IKs__xs1 + var_x328);
        IJth(rJacobian, 13, 0) = 0.020242914979757085 * var_x351 + var_x345 * (0.5 * var_x328 - 0.5 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 14, 0) = var_x355 * var_x356 + var_x359 * var_x360 - var_x356 * pow(var_x353, 2) / pow(var_x354, 2) - var_x360 * pow(var_x357, 2) / pow(var_x358, 2);
        IJth(rJacobian, 15, 0) = var_x361 * var_x365 - var_x361 * var_x366 - 0.0060000000000000001 * var_x369 * (1.0 - var_chaste_interface__Ito__ydv2);
        IJth(rJacobian, 16, 0) = var_x365 * var_x371 - var_x366 * var_x371 - 0.00044999999999999999 * var_x369 * (1.0 - var_chaste_interface__Ito__zdv);
        IJth(rJacobian, 18, 0) = var_x266 * (1.0 - var_chaste_interface__INal__mL) + var_x268 * var_chaste_interface__INal__mL;
        IJth(rJacobian, 19, 0) = -0.00027322404371584699 * var_x372 / pow((1.0 + var_x372), 2);
        IJth(rJacobian, 21, 0) = -var_x399 * ((var_x108) ? (var_x375 * (-0.038593999974243801 * var_x103 - 0.038594000025573422 * var_x106)) : (-2.8388370140351874e-12 * var_x379 / pow(var_x376, 3) + var_x111 * var_x377 * var_x382 - var_x382 * var_x383 * var_chaste_interface__Ca__Ca_ss));
        IJth(rJacobian, 22, 0) = var_x121 * var_x420 - var_x121 * var_x424;
        IJth(rJacobian, 23, 0) = -1.2125733910710643e-6 * var_x142 - 0.0001845622286471062 * var_x136 - 0.0001845622286471062 * var_x99 - 6.1520742882368733e-5 * var_x40 - 6.1520742882368733e-5 * var_x51;
        IJth(rJacobian, 24, 0) = var_x438 + 1.2304148576473747e-6 * var_x125 + 0.00012304148576473747 * var_x136 + 7.4830755604969202e-6 * var_x128 - 3.137557887000805e-5 * var_x70 - 6.1520742882368733e-5 * var_x123 - 6.1520742882368733e-5 * var_x22 - 6.1520742882368733e-5 * var_x80 - 1.0287749645881058e-5 * var_x73 - var_x138 * var_x440 - var_x439 * var_chaste_interface__IKr__xr;
        IJth(rJacobian, 25, 0) = 6.1520742882368733e-5 * var_x38 + 6.1520742882368733e-5 * NV_Ith_S(mParameters, 7);
        IJth(rJacobian, 26, 0) = 600.0 * var_x449 * var_x455;
        IJth(rJacobian, 28, 0) = var_x472 * (-0.0010458526290002684 * var_x121 - 143.99999999999997 * var_x455);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x149 - var_x145 - var_x147 - 1.388888888888889e-8 * var_x155 - 5.4447296618926212e-7 * var_x159 + var_x150 * var_x92 - var_x151 * var_x154);
        ...
        IJth(rJacobian, 23, 1) = 0.00027684334297065928 * var_x237 - 2.563364286765364e-12 * var_x155 - var_x151 * var_x428;
        IJth(rJacobian, 24, 1) = -3.3496381359330236e-11 * var_x159;
        IJth(rJacobian, 27, 1) = -var_x466 + 0.0043750000000000004 * var_x231;
        IJth(rJacobian, 28, 1) = 5.0 * var_x471;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x163);
        IJth(rJacobian, 2, 2) = -((var_x252) ? (0) : (0.13500000000000001 * var_x253)) - ((var_x252) ? (7.6923076923076916 / var_x255) : (310000.0 * var_x257 + 3.5600000000000001 * var_x256));
        IJth(rJacobian, 23, 2) = -6.1520742882368733e-5 * var_x163;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x165);
        IJth(rJacobian, 3, 3) = var_x270;
        IJth(rJacobian, 23, 3) = -0.0001845622286471062 * var_x165;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x166);
        IJth(rJacobian, 4, 4) = -((var_x252) ? (0) : (var_x277 * var_x278)) - ((var_x252) ? (0.29999999999999999 * var_x282) : (0.1212 * var_x286));
        IJth(rJacobian, 23, 4) = -6.1520742882368733e-5 * var_x166;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x174);
        IJth(rJacobian, 5, 5) = -var_x293;
        IJth(rJacobian, 8, 5) = var_x174 * var_x306;
        IJth(rJacobian, 9, 5) = var_x174 * var_x316 - var_x174 * var_x317;
        IJth(rJacobian, 21, 5) = var_x173 * var_x401;
        IJth(rJacobian, 22, 5) = var_x174 * var_x420 - var_x174 * var_x424;
        IJth(rJacobian, 28, 5) = -var_x174 * var_x473;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x176);
        IJth(rJacobian, 6, 6) = -var_x295;
        IJth(rJacobian, 8, 6) = var_x176 * var_x306;
        IJth(rJacobian, 9, 6) = var_x176 * var_x316 - var_x176 * var_x317;
        IJth(rJacobian, 21, 6) = var_x175 * var_x401;
        IJth(rJacobian, 22, 6) = var_x176 * var_x420 - var_x176 * var_x424;
        IJth(rJacobian, 28, 6) = -var_x176 * var_x473;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x171);
        IJth(rJacobian, 7, 7) = -0.052900000000000003 - var_x299;
        IJth(rJacobian, 8, 7) = var_x171 * var_x306;
        IJth(rJacobian, 9, 7) = var_x171 * var_x316 - var_x171 * var_x317;
        IJth(rJacobian, 21, 7) = var_x387 * var_x402 / pow(var_chaste_interface__ICaL__f, 3);
        IJth(rJacobian, 22, 7) = var_x419 * var_x425 - var_x423 * var_x425;
        IJth(rJacobian, 28, 7) = -var_x171 * var_x473;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x177);
        IJth(rJacobian, 8, 8) = var_x303 * (-1 + var_x177 * var_x305);
        IJth(rJacobian, 9, 8) = var_x177 * var_x316 - var_x177 * var_x317;
        IJth(rJacobian, 21, 8) = var_x385 * var_x402 / pow(var_chaste_interface__ICaL__fca, 3);
        IJth(rJacobian, 22, 8) = var_x177 * var_x420 - var_x177 * var_x424;
        IJth(rJacobian, 28, 8) = -var_x177 * var_x473;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x179);
        IJth(rJacobian, 8, 9) = var_x179 * var_x306;
        IJth(rJacobian, 9, 9) = var_x314 * (-1 + var_x179 * var_x315) - var_x179 * var_x317;
        IJth(rJacobian, 21, 9) = var_x386 * var_x403 / pow(var_chaste_interface__ICaL__fca2, 3);
        IJth(rJacobian, 22, 9) = var_x179 * var_x420 - var_x179 * var_x424;
        IJth(rJacobian, 28, 9) = -var_x179 * var_x473;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x180);
        IJth(rJacobian, 8, 10) = var_x180 * var_x306;
        IJth(rJacobian, 9, 10) = var_x180 * var_x316 - var_x180 * var_x317;
        IJth(rJacobian, 10, 10) = -0.0054000000000000003 - var_x318;
        IJth(rJacobian, 21, 10) = var_x388 * var_x403 / pow(var_chaste_interface__ICaL__f2, 3);
        IJth(rJacobian, 22, 10) = var_x180 * var_x420 - var_x180 * var_x424;
        IJth(rJacobian, 28, 10) = -var_x180 * var_x473;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x56 * var_x72);
        IJth(rJacobian, 11, 11) = -var_x325;
        IJth(rJacobian, 24, 11) = -var_x439 * var_x72;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x157 * var_x47);
        IJth(rJacobian, 12, 12) = -var_x350;
        IJth(rJacobian, 24, 12) = var_x157 * var_x437;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x181 * var_x45);
        IJth(rJacobian, 13, 13) = -0.5 * var_x350;
        IJth(rJacobian, 24, 13) = var_x181 * var_x436;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x182);
        IJth(rJacobian, 14, 14) = -25.0 * var_x355 - 25.0 * var_x359;
        IJth(rJacobian, 24, 14) = -0.0001845622286471062 * var_x182;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x183);
        IJth(rJacobian, 15, 15) = -0.029999999999999999 * var_x370 - 0.20000000000000001 * var_x366;
        IJth(rJacobian, 24, 15) = -6.1520742882368733e-5 * var_x183;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x184);
        IJth(rJacobian, 16, 16) = -0.10000000000000001 * var_x366 - 0.0022499999999999998 * var_x370;
        IJth(rJacobian, 24, 16) = -6.1520742882368733e-5 * var_x184;
        ...
        IJth(rJacobian, 8, 20) = var_x307 * var_x308;
        IJth(rJacobian, 20, 20) = -0.00068000000000000005 - var_x224 * var_x373 + var_x219 * var_x239 * var_x373;
        IJth(rJacobian, 22, 20) = var_x426 * (var_x307 - var_x307 * var_x414);
        IJth(rJacobian, 27, 20) = var_x243 * var_x467 + var_x245 * var_x466;
        IJth(rJacobian, 21, 21) = -0.33333333333333331;
        IJth(rJacobian, 26, 21) = -var_x458 * var_x459;
        IJth(rJacobian, 28, 21) = var_x458 * var_x474;
        IJth(rJacobian, 22, 22) = -var_x417;
        IJth(rJacobian, 26, 22) = -var_x459 * var_x460;
        IJth(rJacobian, 28, 22) = var_x460 * var_x474;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (0.48963716847181743 * var_x193 - 3.0 * var_x198 - 26.712338705500134 * var_x192 - 26.712338705500134 * var_x194 - 0.02 * var_x197 - var_x154 * var_x196);
        IJth(rJacobian, 1, 23) = var_x217 * (0.0001845622286471062 * var_x198 + var_x196 * var_x236);
        IJth(rJacobian, 23, 23) = var_x434 - 0.0016433629212878199 * var_x192 - 0.0016433629212878199 * var_x194 - 3.6912445729421236e-6 * var_x197 - 0.00055368668594131857 * var_x198 - var_x196 * var_x428;
        IJth(rJacobian, 24, 23) = 0.48963716847181743 * var_x441 + 2.460829715294749e-6 * var_x197;
        IJth(rJacobian, 25, 23) = var_x434;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (26.712338705500134 * var_x193 + 3.2491553184435085 * var_x205 - 13.356169352750067 * var_x200 - 26.712338705500134 * var_x199 - 26.712338705500134 * var_x202 - 13.623292739805068 * var_x201 - var_x140 * var_x204);
        IJth(rJacobian, 24, 24) = var_x445 + 0.00019989044893084398 * var_x205 + 26.712338705500134 * var_x441 - 0.00082168146064390995 * var_x200 - 0.0016433629212878199 * var_x199 - 0.0016433629212878199 * var_x202 - 0.0008381150898567882 * var_x201 - var_x204 * var_x440;
        IJth(rJacobian, 25, 24) = var_x445;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x206 + 26.712338705500134 * var_x208);
        IJth(rJacobian, 23, 25) = var_x435;
        IJth(rJacobian, 24, 25) = var_x446;
        IJth(rJacobian, 25, 25) = var_x435 + var_x446 + 6.1520742882368733e-5 * var_x206 - 0.0016433629212878199 * var_x208;
        IJth(rJacobian, 21, 26) = -2.3414435371998602e-7 * var_x405 * pow(var_chaste_interface__Ca__Ca_jsr, 2.7999999999999998) + 0.6333333333333333 * var_x394 * var_x404 * pow(var_chaste_interface__Ca__Ca_jsr, 0.89999999999999991);
        IJth(rJacobian, 26, 26) = var_x463 * (-0.0083333333333333332 - var_x462) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0.0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x452 * var_x462) / (pow(var_x447, 3) * pow((0.125 + var_x448), 2));
        IJth(rJacobian, 27, 26) = 0.00072463768115942019;
        IJth(rJacobian, 28, 26) = var_x471 * var_x475;
        IJth(rJacobian, 1, 27) = 2.3676470588235295e-5 * var_x216;
        IJth(rJacobian, 26, 27) = 0.0083333333333333332 * var_x449;
        ...
        IJth(rJacobian, 8, 28) = var_x303 * (-0.0016500000000000002 * var_x309 + var_x213 * var_x305) + var_x308 * (var_x310 + 0.0030000000000000001 * var_x309);
        IJth(rJacobian, 9, 28) = var_x213 * var_x316 - var_x213 * var_x317;
        ...
        IJth(rJacobian, 21, 28) = -var_x399 * ((var_x108) ? (var_x375 * (-1.0309360006807568e-7 * var_x209 - 2 * var_x211 * (15.000001335616936 - var_chaste_interface__cell__V))) : (-4.258255521052781e-11 * var_x381 * var_x383)) - 0.00020267697647483301 * var_x220 * var_x390 * var_x391 * var_x393 * var_x405 * (1.8999999999999999 * var_x392 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x391, 2));
        IJth(rJacobian, 22, 28) = var_x426 * (var_x310 + var_x422 * (5000.0 - 1000.0 * var_x427) - var_x310 * var_x414) - var_x418 * (40000.0 - 5333.333333333333 * var_x427);
        IJth(rJacobian, 26, 28) = var_x463 * (var_x462 + 600.0 * var_x464);
        IJth(rJacobian, 27, 28) = var_x250 * var_x467 + var_x251 * var_x466;
        IJth(rJacobian, 28, 28) = var_x472 * (-5.0 - var_x475 - 0.0010458526290002684 * var_x213 - 143.99999999999997 * var_x464) + (0.019557600000000001 / pow(var_x468, 3) + 8.1780000000000006e-5 / pow(var_x469, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0.0010458526290002684 * var_x172 + var_x452 * var_x475) / pow(var_x470, 2);
    }
