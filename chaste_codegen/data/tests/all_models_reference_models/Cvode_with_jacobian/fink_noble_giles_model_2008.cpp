...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellfink_noble_giles_model_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x58 = 26.713760659695652 * var_x4;
        const double var_x59 = (-var_x58 * log10(9.5999999999999996 * var_x57) + var_chaste_interface__cell__V) * var_chaste_interface__iKs_Xs_gate__Xs;
        const double var_x60 = 5.3427521319391307 * var_x6 - 0.20000000000000001 * var_chaste_interface__cell__V;
        const double var_x61 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x62 = -var_x58 * log10(140.0 * var_x61) + var_chaste_interface__cell__V;
        const double var_x63 = var_x62 * var_chaste_interface__iNa_h_gate__h;
        const double var_x64 = var_x63 * pow(var_chaste_interface__iNa_m_gate__m, 2) * var_chaste_interface__iNa_j_gate__j;
        const double var_x65 = var_x32 * var_x63;
        const double var_x66 = var_x45 * var_x50 * var_chaste_interface__iCaL_f2_gate__f2 * var_chaste_interface__iCaL_fCass_gate__fCass;
        const double var_x67 = var_x49 * var_x66;
        const double var_x68 = var_x45 * var_x50 * var_chaste_interface__iCaL_d_gate__d * var_chaste_interface__iCaL_f_gate__f;
        ...
        const double var_x90 = 0.0112 * var_x89;
        const double var_x91 = var_x90 * var_chaste_interface__iKr_Markov__Cr1;
        const double var_x92 = exp(-2.0190000000000001 - 0.060299999999999999 * var_chaste_interface__cell__V);
        const double var_x93 = 0.060299999999999999 * var_x92;
        const double var_x94 = var_x93 * var_chaste_interface__iKr_Markov__Cr2;
        ...
        const double var_x102 = 0.036499999999999998 * var_x101;
        const double var_x103 = var_x102 * var_chaste_interface__iKr_Markov__Cr3;
        const double var_x104 = exp(-8.3940000000000019 - 0.039899999999999998 * var_chaste_interface__cell__V);
        const double var_x105 = 0.039899999999999998 * var_x104;
        ...
        const double var_x110 = 0.0223 * var_x109;
        const double var_x111 = var_x105 - var_x110;
        const double var_x112 = exp(-3.1820000000000022 - 0.031199999999999999 * var_chaste_interface__cell__V);
        const double var_x113 = 0.031199999999999999 * var_x112;
        const double var_x114 = var_x113 * var_chaste_interface__iKr_Markov__Ir5;
        ...
        const double var_x119 = var_x90 * var_chaste_interface__iKr_Markov_Sotalol_block__BCr1;
        const double var_x120 = var_x93 * var_chaste_interface__iKr_Markov_Sotalol_block__BCr2;
        const double var_x121 = var_x102 * var_chaste_interface__iKr_Markov_Sotalol_block__BCr3;
        const double var_x122 = var_x113 * var_chaste_interface__iKr_Markov_Sotalol_block__BIr5;
        ...
        const double var_x131 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__cell__V);
        ...
        const double var_x154 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__cell__V);
        const double var_x155 = 1.0 + var_x154;
        const double var_x156 = pow(var_x155, (-2)) - var_chaste_interface__iNa_m_gate__m;
        const double var_x157 = exp(-12.0 - var_x134);
        const double var_x158 = 1.0 + var_x157;
        const double var_x159 = var_x153 * var_x158;
        const double var_x160 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V);
        ...
        const double var_x171 = 0.26917900403768508 * var_x160 / pow(var_x161, 3);
        ...
        const double var_x200 = exp(0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__cell__V);
        ...
        const double var_x213 = 0.14285714285714285 * var_chaste_interface__cell__V;
        const double var_x214 = exp(2.8571428571428572 + var_x213);
        const double var_x215 = 1.0 + var_x214;
        const double var_x216 = var_x204 / pow(var_x205, 2);
        ...
        const double var_x223 = exp(5.0 + var_x213);
        ...
        const double var_x230 = var_chaste_interface__Ca__Ca_ss / pow((0.0025000000000000005 + var_x227), 2);
        ...
        const double var_x264 = var_x261 * var_x262;
        const double var_x265 = var_x264 * var_x66;
        const double var_x266 = var_x264 * var_x68;
        ...
        const double var_x269 = 0.00079924407711721393 * var_x33;
        ...
        const double var_x272 = 0.00038819663608706523 * var_x6 - 1.4531710493040254e-5 * var_chaste_interface__cell__V;
        ...
        IJth(rJacobian, 1, 0) = -var_x91 - var_x94;
        IJth(rJacobian, 2, 0) = var_x91 + var_x94;
        IJth(rJacobian, 3, 0) = -var_x103 - var_x105 * var_chaste_interface__iKr_Markov__Or4;
        IJth(rJacobian, 4, 0) = var_x103 - var_x114 + var_x111 * var_chaste_interface__iKr_Markov__Or4;
        IJth(rJacobian, 5, 0) = var_x114 + var_x110 * var_chaste_interface__iKr_Markov__Or4;
        IJth(rJacobian, 6, 0) = -var_x119 - var_x120;
        IJth(rJacobian, 7, 0) = var_x119 + var_x120;
        IJth(rJacobian, 8, 0) = -var_x121 - var_x105 * var_chaste_interface__iKr_Markov_Sotalol_block__BOr4;
        IJth(rJacobian, 9, 0) = var_x121 - var_x122 + var_x111 * var_chaste_interface__iKr_Markov_Sotalol_block__BOr4;
        IJth(rJacobian, 10, 0) = var_x122 + var_x110 * var_chaste_interface__iKr_Markov_Sotalol_block__BOr4;
        IJth(rJacobian, 11, 0) = 5.1020408163265302e-7 * (1 / var_x132 - var_chaste_interface__iKs_Xs_gate__Xs) * (93.333333333333329 * var_x126 * var_x127 / pow(var_x128, 2) - 116.66666666666667 * var_x124 * var_x129 / pow(var_x125, (3 / 2))) / pow((0.057142857142857141 + var_x130), 2) + 0.071428571428571425 * var_x131 * var_x133 / pow(var_x132, 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (1 / var_x140 - var_chaste_interface__ito_s_gate__s) * (-var_x141 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__cell__V) + 1.0 * var_x135 / pow(var_x136, 2)) / pow((0.035294117647058823 + var_x138 + 0.058823529411764705 * var_x137), 2) - 0.20000000000000001 * var_x139 * var_x142 / pow(var_x140, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x143 * var_x146 / pow(var_x144, 2) - 0.10526315789473684 * var_x145 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__cell__V) * (1 / var_x144 - var_chaste_interface__ito_r_gate__r) / pow((0.084210526315789472 + var_x145), 2);
        IJth(rJacobian, 14, 0) = 0.22148394241417499 * var_x154 * var_x159 / pow(var_x155, 3) - 0.20000000000000001 * var_x153 * var_x156 * var_x157 + 99.999999999999986 * var_x156 * var_x158 * (0.02 * var_x147 / pow(var_x148, 2) + 0.00050000000000000001 * var_x150 / pow(var_x151, 2)) / pow((var_x149 + var_x152), 2);
        IJth(rJacobian, 15, 0) = (var_x162 - var_chaste_interface__iNa_h_gate__h) * (((var_x164) ? (-0.008382352941176471 * var_x163) : (0)) + ((var_x164) ? (108035.0 * var_x165 + 0.21330000000000002 * var_x166) : (0.53361053361053368 * var_x167 / pow(var_x168, 2)))) - var_x171 * (var_x169 + var_x170);
        IJth(rJacobian, 16, 0) = (var_x162 - var_chaste_interface__iNa_j_gate__j) * (((var_x164) ? (-0.00025500480000000003 * var_x175 + 0.0033402720000000005 * var_x172 * var_x174 / pow(var_x173, 2)) : (0.034200000000000001 * var_x179 + 0.059999999999999998 * var_x176 * var_x178 / pow(var_x177, 2))) + ((var_x164) ? (var_x186 + var_x182 * var_x187 * (3.0508668000000001e-7 * var_x184 - 6214.6032000000005 * var_x183) - 0.311 * var_x180 * var_x185 * var_x187 / pow(var_x181, 2)) : (0))) - var_x171 * (var_x188 + var_x189);
        IJth(rJacobian, 17, 0) = 0.51020408163265307 * (1 / var_x201 - var_chaste_interface__iCaL_d_gate__d) * (-0.050000000000000003 * var_x190 / pow(var_x191, 2) + 0.27999999999999997 * var_x193 * var_x198 / pow(var_x194, 2) - 0.15076923076923074 * var_x195 * var_x196 / pow(var_x197, 2)) / pow((var_x199 + 0.7142857142857143 * var_x192), 2) + 0.13333333333333333 * var_x200 * var_x202 / pow(var_x201, 2);
        IJth(rJacobian, 18, 0) = 1.3163239596670111e-5 * (1 / var_x215 - var_chaste_interface__iCaL_f_gate__f) * (4.5 * var_x216 - var_x217 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__cell__V) - 5.0 * var_x208 / pow(var_x209, 2)) / pow((0.018140589569160998 + var_x212 + 0.16326530612244897 * var_x206 + 0.18140589569160998 * var_x210), 2) - 0.14285714285714285 * var_x214 * var_x218 / pow(var_x215, 2);
        IJth(rJacobian, 19, 0) = 1.2664479933131545e-5 * (0.25 - var_chaste_interface__iCaL_f2_gate__f2 + 0.75 / var_x224) * (4.0 * var_x216 - var_x225 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__cell__V) - 1.55 * var_x219 / pow(var_x220, 2)) / pow((var_x222 + 0.055160142348754451 * var_x221 + 0.14234875444839859 * var_x206), 2) - 0.10714285714285714 * var_x223 * var_x226 / pow(var_x224, 2);
        IJth(rJacobian, 21, 0) = var_x233 * (-1.7205545223759661e-8 + 3.0642541604521007e-12 * var_x36 + 1.2593500345045236e-9 * var_x31);
        IJth(rJacobian, 23, 0) = var_x261 * (-var_x263 + 0.00023577038909270109 * var_x52 - 5.8942597273175273e-5 * var_x53);
        IJth(rJacobian, 25, 0) = -2.1070980214908366e-8 - 9.1927624813563017e-12 * var_x36 - 3.7780501035135707e-9 * var_x31 - 0.00023854029832302029 * var_x42 - var_x269 * var_chaste_interface__iNa_h_gate__h;
        IJth(rJacobian, 26, 0) = var_x271 + 0.00015902686554868019 * var_x42 - 1.7438052591648303e-6 * var_chaste_interface__iKr_Markov__Or4 - 1.4531710493040254e-5 * var_x24 - 1.1822202600107163e-7 * var_x37 - 7.0696771548640841e-7 * var_x3 - 2.8482152566358896e-6 * var_x0 + var_x7 * (2.3119525668406228e-8 * var_x10 - 3.4651837760272254e-7 * var_x18 - var_x21 * var_x270);
        IJth(rJacobian, 1, 1) = var_x96;
        IJth(rJacobian, 2, 1) = var_x95;
        IJth(rJacobian, 1, 2) = var_x97;
        IJth(rJacobian, 2, 2) = var_x99;
        IJth(rJacobian, 3, 2) = var_x98;
        IJth(rJacobian, 2, 3) = var_x100;
        IJth(rJacobian, 3, 3) = var_x107;
        IJth(rJacobian, 4, 3) = var_x106;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (0.64113025583269556 * var_x6 - 0.024 * var_chaste_interface__cell__V);
        IJth(rJacobian, 3, 4) = var_x108;
        IJth(rJacobian, 4, 4) = var_x116;
        IJth(rJacobian, 5, 4) = var_x115;
        IJth(rJacobian, 26, 4) = 4.6583596330447822e-5 * var_x6 - 1.7438052591648303e-6 * var_chaste_interface__cell__V;
        IJth(rJacobian, 4, 5) = var_x117;
        IJth(rJacobian, 5, 5) = var_x118;
        IJth(rJacobian, 6, 6) = var_x96;
        IJth(rJacobian, 7, 6) = var_x95;
        IJth(rJacobian, 6, 7) = var_x97;
        IJth(rJacobian, 7, 7) = var_x99;
        IJth(rJacobian, 8, 7) = var_x98;
        IJth(rJacobian, 7, 8) = var_x100;
        IJth(rJacobian, 8, 8) = var_x107;
        IJth(rJacobian, 9, 8) = var_x106;
        IJth(rJacobian, 4, 9) = 0.00125;
        IJth(rJacobian, 8, 9) = var_x108;
        IJth(rJacobian, 9, 9) = -0.00125 + var_x116;
        IJth(rJacobian, 10, 9) = var_x115;
        IJth(rJacobian, 9, 10) = var_x117;
        IJth(rJacobian, 10, 10) = var_x118;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-0.078399999999999997 * var_x59);
        IJth(rJacobian, 11, 11) = -var_x133;
        IJth(rJacobian, 26, 11) = -5.6964305132717792e-6 * var_x59;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x60 * var_chaste_interface__ito_r_gate__r);
        IJth(rJacobian, 12, 12) = -var_x142;
        IJth(rJacobian, 26, 12) = var_x272 * var_chaste_interface__ito_r_gate__r;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x60 * var_chaste_interface__ito_s_gate__s);
        IJth(rJacobian, 13, 13) = -var_x146;
        IJth(rJacobian, 26, 13) = var_x272 * var_chaste_interface__ito_s_gate__s;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-33.0 * var_x64);
        IJth(rJacobian, 14, 14) = -var_x159;
        IJth(rJacobian, 25, 14) = -0.0023977322313516419 * var_x64;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x34 * var_x62);
        IJth(rJacobian, 15, 15) = -var_x169 - var_x170;
        IJth(rJacobian, 25, 15) = -var_x269 * var_x62;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-11.0 * var_x65);
        IJth(rJacobian, 16, 16) = -var_x188 - var_x189;
        IJth(rJacobian, 25, 16) = -0.00079924407711721393 * var_x65;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * var_chaste_interface__iCaL_f_gate__f);
        IJth(rJacobian, 17, 17) = -var_x202;
        IJth(rJacobian, 23, 17) = -var_x265 * var_chaste_interface__iCaL_f_gate__f;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * var_chaste_interface__iCaL_d_gate__d);
        IJth(rJacobian, 18, 18) = -var_x218;
        IJth(rJacobian, 23, 18) = -var_x265 * var_chaste_interface__iCaL_d_gate__d;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x69 * var_chaste_interface__iCaL_fCass_gate__fCass);
        IJth(rJacobian, 19, 19) = -var_x226;
        IJth(rJacobian, 23, 19) = -var_x266 * var_chaste_interface__iCaL_fCass_gate__fCass;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x69 * var_chaste_interface__iCaL_f2_gate__f2);
        IJth(rJacobian, 20, 20) = -var_x229;
        IJth(rJacobian, 23, 20) = -var_x266 * var_chaste_interface__iCaL_f2_gate__f2;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (0.061899999999999997 * var_x73 + 118.90054155481036 * var_x74 - 0.061899999999999997 * var_x71 - 0.0063258185242159298 * var_x72);
        IJth(rJacobian, 21, 21) = var_x233 * (-0.0038240087783467445 - var_x234 + 2.2487821987979791e-6 * var_x73 - 0.0086391412367010315 * var_x74 - 5.3144431236283834e-11 * var_x236 - 2.298124085635426e-7 * var_x72) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__Ca__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__Ca__Ca_SR - 0.0038240087783467445 * var_chaste_interface__Ca__Ca_i - 1.7205545223759661e-8 * var_chaste_interface__cell__V - 0.00042515544989027063 * var_x237 - var_x234 * var_chaste_interface__Ca__Ca_i + 1.2593500345045236e-9 * var_x27 * var_x35 + 2.298124085635426e-7 * var_x4 * log10(2.0 * var_x72)) / (pow(var_x231, 3) * pow(var_x232, 2));
        IJth(rJacobian, 22, 21) = var_x240 * (0.00036000000000000002 + 7.96875e-10 * var_x236);
        IJth(rJacobian, 23, 21) = 1.1399999999999999 * var_x261;
        IJth(rJacobian, 25, 21) = 0.025917423710103096 * var_x74;
        IJth(rJacobian, 21, 22) = 2.40087783467447e-5 * var_x233;
        ...
        IJth(rJacobian, 23, 22) = var_x261 * (var_x267 + 0.1959116313094367 * var_x252 - 1.3060775420629114 * var_x255);
        IJth(rJacobian, 24, 22) = 0.059999999999999998 * var_x253 * var_chaste_interface__Ca__Ca_ss;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.072236434794126253 * var_x75);
        IJth(rJacobian, 20, 23) = -0.0020000000000000005 * var_x229 * var_x230 + 6.2500000000000001e-5 * var_x230 * (0.59999999999999998 - var_chaste_interface__iCaL_fCass_gate__fCass + 0.40000000000000002 * var_x228) / pow((0.025000000000000001 + var_x228), 2);
        IJth(rJacobian, 21, 23) = 0.0038 * var_x233;
        IJth(rJacobian, 22, 23) = var_x240 * (var_x248 + 0.097919999999999993 * var_x256 - 0.091799999999999993 * var_x257);
        IJth(rJacobian, 23, 23) = var_x261 * (-1.1399999999999999 - var_x267 + 1.8366715435259691 * var_x257 - 0.00078728921810821686 * var_x75 - 1.9591163130943672 * var_x256) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__Ca__Ca_i - 1.1399999999999999 * var_chaste_interface__Ca__Ca_ss + var_x250 * var_x267 - var_x263 * var_x50) / (pow(var_x259, 3) * pow(var_x260, 2));
        IJth(rJacobian, 24, 23) = var_x268 * var_chaste_interface__Irel__R_prime;
        IJth(rJacobian, 22, 24) = -0.045899999999999996 * var_x240 * var_x258;
        IJth(rJacobian, 23, 24) = 0.91833577176298453 * var_x258 * var_x261;
        IJth(rJacobian, 24, 24) = -0.0050000000000000001 + var_x268 * var_chaste_interface__Ca__Ca_ss;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (0.00068396484375 * var_x79 - 0.00010399464275930935 * var_x80 - 293.85136725665217 * var_x81 - 0.031415382535802082 * var_x76 - 1.0943437499999999 * var_x78 - 0.0077469905913117388 * var_x61);
        IJth(rJacobian, 21, 25) = 7.5561002070271413e-9 * var_x233 * var_x80;
        IJth(rJacobian, 25, 25) = 1.4908768645188767e-7 * var_x79 - 5.6288512232624455e-7 * var_x61 - 2.2668300621081427e-8 * var_x80 - 0.021350814984788587 * var_x81 - 0.00023854029832302029 * var_x78;
        IJth(rJacobian, 26, 25) = 0.00015902686554868019 * var_x78 - 9.9391790967925116e-8 * var_x79 - 2.282596220191943e-6 * var_x76;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (-1.0471794178600695 * var_x76 - 0.64113025583269556 * var_x86 - 5.3427521319391307 * var_x88 - 0.25992489121883872 * var_x87 + var_x56 * var_x85 + var_x7 * (0.009050972624097476 * var_x82 - 0.13565712352459006 * var_x84 - var_x23 * var_x83));
        IJth(rJacobian, 26, 26) = -4.6583596330447822e-5 * var_x86 - 7.6086540673064781e-5 * var_x76 - 1.8885766345635723e-5 * var_x87 - 0.00038819663608706523 * var_x88 + var_x271 * var_x85 + var_x7 * (6.576305692690868e-7 * var_x82 - 9.8566502268897146e-6 * var_x84 - var_x270 * var_x83);
    }
