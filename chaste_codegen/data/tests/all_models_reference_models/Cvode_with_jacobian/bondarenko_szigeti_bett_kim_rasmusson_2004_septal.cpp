...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x309 = 1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        const double var_x310 = exp(-3.3919999999999999 - 0.128 * var_chaste_interface__membrane__V);
        const double var_x311 = 1.0 - var_x310;
        const double var_x312 = 4.8133299999999997e-6 / var_x311;
        const double var_x313 = exp(-1.0069999999999999 - 0.037999999999999999 * var_chaste_interface__membrane__V);
        const double var_x314 = 26.5 + var_chaste_interface__membrane__V;
        const double var_x315 = 1 / (1200.0 - 170.0 * var_x304);
        const double var_x316 = exp(-0.086199999999999999 * var_chaste_interface__membrane__V);
        const double var_x317 = 1 / (13.17 + 39.299999999999997 * var_x316);
        ...
        IJth(rJacobian, 32, 0) = var_x309 * var_x312 + 3.6226653999999999e-6 * var_x313 * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs - 6.1610624e-7 * var_x309 * var_x310 * var_x314 / pow(var_x311, 2);
        ...
        IJth(rJacobian, 34, 0) = -var_x307 * var_x315 - 2.0711500974658867e-5 * var_x306 * (var_x308 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur) / pow((1 - 0.14166666666666666 * var_x304), 2);
        IJth(rJacobian, 35, 0) = var_x299 * var_x317 + 0.0021933842239185751 * var_x316 * (var_x295 - var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss) / pow((0.33511450381679392 + var_x316), 2);
        IJth(rJacobian, 37, 0) = var_x319 + var_x321 - var_x323 - var_x325;
        IJth(rJacobian, 38, 0) = 0.01176 * var_x330 * (0.022348 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K) + 0.0029658262000000005 * var_x331 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1;
        IJth(rJacobian, 39, 0) = -var_x319 - var_x321;
        IJth(rJacobian, 40, 0) = var_x323 + var_x325;
        ...
        IJth(rJacobian, 32, 32) = -9.5333299999999997e-5 * var_x313 - var_x312 * var_x314;
        ...
        IJth(rJacobian, 37, 37) = -var_x326 - var_x327;
        IJth(rJacobian, 38, 37) = var_x332;
        IJth(rJacobian, 39, 37) = var_x326;
        IJth(rJacobian, 40, 37) = var_x327;
        IJth(rJacobian, 38, 38) = -0.023761000000000001 + var_x332 - 0.047002000000000002 * var_x331;
        IJth(rJacobian, 39, 38) = 0.023761000000000001;
        IJth(rJacobian, 37, 39) = var_x328;
        IJth(rJacobian, 38, 39) = 0.036777999999999998 + var_x332;
        IJth(rJacobian, 39, 39) = -0.036777999999999998 - var_x328;
        IJth(rJacobian, 37, 40) = var_x329;
        IJth(rJacobian, 38, 40) = var_x332;
        IJth(rJacobian, 40, 40) = -var_x329;
    }
