...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellramirez_nattel_courtemanche_2000FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x91) ? (0.15999999943156581 * var_x88 + 0.16000000056843419 * var_x89) : (var_x95 - 0.032000000000000001 * var_x90 * var_x93 / pow(var_x94, 2))) + 0.0072727272727272727 * var_x96 * var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        IJth(rJacobian, 9, 0) = (1 / var_x151 - var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr) * (((var_x155) ? (0.02 * var_x152 + 0.02 * var_x153) : (var_x158 - 0.0014285714285714286 * var_x154 * var_x156 / pow(var_x157, 2))) + ((var_x162) ? (0.014 * var_x159 + 0.014 * var_x160) : (var_x165 - 0.0013333333333333333 * var_x161 * var_x163 / pow(var_x164, 2)))) + 0.1859773107680863 * var_x150 * (var_x167 + var_x169) / pow(var_x151, 2);
        IJth(rJacobian, 10, 0) = (pow(var_x171, (-0.5)) - var_chaste_interface__slow_delayed_rectifier_K_current_xs_gate__xs) * (((var_x176) ? (5.0000000000000004e-6 * var_x172 + 5.0000000000000004e-6 * var_x173) : (var_x179 - 8.6956521739130438e-8 * var_x174 * var_x177 / pow(var_x178, 2))) + ((var_x182) ? (0.00011500000061903345 * var_x180 + 0.00011499999938096656 * var_x181) : (var_x185 - 6.9696969696969699e-5 * var_x174 * var_x183 / pow(var_x184, 2)))) + 0.041666666666666664 * var_x170 * pow(var_x171, (-1.5)) * (var_x187 + var_x189);
        IJth(rJacobian, 11, 0) = (1 / var_x191 - var_chaste_interface__sarcolemmal_Ca_current_d_gate__d) * ((var_x199) ? (4.7698560017679535e-16 * (-36688738598216.805 * var_x193 - 36688738598216.805 * var_x196) / pow((-var_x193 + 0.017500000000000002 * var_x197), 2)) : (var_x204 - var_x202 * var_x205 - var_x203 * var_x205 / pow(var_x201, 2))) + 0.16666666666666666 * var_x190 * var_x206 / pow(var_x191, 2);
        ...
        IJth(rJacobian, 2, 2) = -((var_x91) ? (-var_x97 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x97 + 3.1999999919207769e-7 * var_x88)) : (var_x90 * var_x95)) - 0.080000000000000002 * var_x96;
