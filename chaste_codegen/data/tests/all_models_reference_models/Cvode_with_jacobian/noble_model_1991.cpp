...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1991FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x105 = exp(-1.2 - 0.059999999999999998 * var_chaste_interface__membrane__V);
        ...
        const double var_x110 = exp(4.1300000000000008 + 0.082600000000000007 * var_chaste_interface__membrane__V);
        ...
        const double var_x148 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
        ...
        IJth(rJacobian, 1, 1) = -7.0 + var_x88 + var_x89 - 1.0549054718227806e-6 * var_x61 - 4.3596094751625959e-6 * var_x62 - 0.00063182746016849224 * var_x63 - 4.7303520325519803e-5 * var_x64 + (0.00040000000000000002 * var_x93 - 0.00040000000000000002 * var_x91 - 7.1999999999999991e-9 * var_x94) * NV_Ith_S(mParameters, 3);
