...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1998FromCellMLCvode::VerifyStateVariables()
    {
    ...
    void Cellnoble_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x40 = exp(1.0000000000609274e-7);
        const double var_x41 = 1 / (1.0 - var_x40);
        const double var_x42 = exp(3.7433890822745473);
        const double var_x43 = var_x42 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x44 = var_x41 * (var_x43 - var_x40 * NV_Ith_S(mParameters, 6));
        ...
        const double var_x48 = 0.074867781645490947 * var_x47;
        const double var_x49 = exp(-1.0000000000609274e-7);
        const double var_x50 = 1 / (1.0 - var_x49);
        const double var_x51 = var_x50 * (var_x43 - var_x49 * NV_Ith_S(mParameters, 6));
        const double var_x52 = -50.0 + var_chaste_interface__membrane__V;
        const double var_x53 = fabs(var_x52);
        const double var_x54 = var_x53 < 1.3356880330661625e-6;
        const double var_x55 = exp(3.7433890822745473 - 0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x56 = 1.0 - var_x55;
        const double var_x57 = 1 / var_x56;
        const double var_x58 = var_x47 * var_x57;
        const double var_x59 = var_x55 * NV_Ith_S(mParameters, 6);
        const double var_x60 = var_x43 - var_x59;
        const double var_x61 = 0.14973556329098189 * var_x60;
        const double var_x62 = var_x52 * var_x58;
        const double var_x63 = var_x47 * var_x52;
        const double var_x64 = ((var_x54) ? (var_x44 * var_x48 + var_x48 * var_x51) : (var_x58 * var_x61 + 0.011210369457033822 * var_x59 * var_x62 - 0.011210369457033822 * var_x55 * var_x60 * var_x63 / pow(var_x56, 2)));
        const double var_x65 = exp(1.8716945411372736);
        const double var_x66 = var_x65 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        ...
        const double var_x72 = var_x53 < 2.6713760661323249e-6;
        ...
        const double var_x76 = var_x47 * var_x75;
        const double var_x77 = var_x73 * NV_Ith_S(mParameters, 8);
        const double var_x78 = var_x66 - var_x77;
        const double var_x79 = 0.00037433890822745472 * var_x78;
        const double var_x80 = var_x52 * var_x76;
        const double var_x81 = var_x63 * var_x73 / pow(var_x74, 2);
        const double var_x82 = ((var_x72) ? (var_x68 * var_x69 + var_x69 * var_x71) : (var_x76 * var_x79 + 1.4012961821292276e-5 * var_x77 * var_x80 - 1.4012961821292276e-5 * var_x78 * var_x81));
        const double var_x83 = var_x65 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x84 = var_x41 * (var_x83 - var_x40 * NV_Ith_S(mParameters, 7));
        const double var_x85 = 3.743389082274547e-5 * var_x47;
        const double var_x86 = var_x50 * (var_x83 - var_x49 * NV_Ith_S(mParameters, 7));
        const double var_x87 = var_x73 * NV_Ith_S(mParameters, 7);
        const double var_x88 = var_x83 - var_x87;
        const double var_x89 = 7.4867781645490941e-5 * var_x88;
        const double var_x90 = ((var_x72) ? (var_x84 * var_x85 + var_x85 * var_x86) : (var_x76 * var_x89 + 2.8025923642584555e-6 * var_x80 * var_x87 - 2.8025923642584555e-6 * var_x81 * var_x88));
        const double var_x91 = 1 / NV_Ith_S(mParameters, 10);
        const double var_x92 = 0.001 * var_x91;
        const double var_x93 = 1 / var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x94 = (var_x20 - var_x24) * NV_Ith_S(mParameters, 18) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x95 = var_x17 * var_x25;
        const double var_x96 = -18716944.910232361 + 374338.90820464725 * var_chaste_interface__membrane__V;
        const double var_x97 = var_x41 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x98 = 2.0000000001218549e-7 * var_x46;
        const double var_x99 = var_x42 * var_x98;
        const double var_x100 = var_x97 * var_x99;
        const double var_x101 = var_x50 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x102 = ((var_x54) ? (-var_x100 + var_x96 * (var_x100 + var_x101 * var_x99)) : (0.14973556329098189 * var_x42 * var_x62));
        const double var_x103 = var_x36 * var_x7;
        const double var_x104 = var_x103 * var_x92;
        const double var_x105 = 1 / (0.029999999999999999 * var_chaste_interface__intracellular_sodium_concentration__Na_i + var_chaste_interface__intracellular_potassium_concentration__K_i);
        const double var_x106 = (-26.713760659695652 * log(var_x105 * (0.029999999999999999 * NV_Ith_S(mParameters, 8) + NV_Ith_S(mParameters, 7))) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 17) * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs;
        const double var_x107 = 1 / (var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i);
        const double var_x108 = -26.713760659695652 * log(var_x107 * (NV_Ith_S(mParameters, 8) + 0.12 * NV_Ith_S(mParameters, 7))) + var_chaste_interface__membrane__V;
        const double var_x109 = var_x108 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * NV_Ith_S(mParameters, 11) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x110 = var_x10 * var_x108;
        const double var_x111 = -9358472.2051161807 + 187169.45410232362 * var_chaste_interface__membrane__V;
        const double var_x112 = 1.0000000000609275e-9 * var_x46;
        const double var_x113 = var_x112 * var_x67;
        const double var_x114 = var_x46 * var_x52;
        const double var_x115 = var_x114 * var_x75;
        const double var_x116 = ((var_x72) ? (-var_x113 + var_x111 * (var_x113 + var_x112 * var_x70)) : (var_x115 * var_x79));
        const double var_x117 = 2.0000000001218549e-10 * var_x46;
        const double var_x118 = var_x117 * var_x84;
        const double var_x119 = ((var_x72) ? (-var_x118 + var_x111 * (var_x118 + var_x117 * var_x86)) : (var_x115 * var_x89));
        const double var_x120 = var_x44 * var_x98;
        const double var_x121 = var_x57 * var_x61;
        const double var_x122 = ((var_x54) ? (-var_x120 + var_x96 * (var_x120 + var_x51 * var_x98)) : (var_x114 * var_x121));
        const double var_x123 = var_x45 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x124 = 1.0000000000609275e-9 * var_x123;
        const double var_x125 = var_x124 * var_x67;
        const double var_x126 = var_x123 * var_x52;
        const double var_x127 = var_x126 * var_x75;
        const double var_x128 = ((var_x72) ? (-var_x125 + var_x111 * (var_x125 + var_x124 * var_x70)) : (var_x127 * var_x79));
        const double var_x129 = 2.0000000001218549e-10 * var_x123;
        const double var_x130 = var_x129 * var_x84;
        const double var_x131 = ((var_x72) ? (-var_x130 + var_x111 * (var_x130 + var_x129 * var_x86)) : (var_x127 * var_x89));
        const double var_x132 = 2.0000000001218549e-7 * var_x123;
        const double var_x133 = var_x132 * var_x44;
        const double var_x134 = ((var_x54) ? (-var_x133 + var_x96 * (var_x133 + var_x132 * var_x51)) : (var_x121 * var_x126));
        const double var_x135 = NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x136 = 1.0000000000609275e-9 * var_x135;
        const double var_x137 = var_x136 * var_x68;
        const double var_x138 = var_x135 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x139 = var_x138 * var_x52;
        const double var_x140 = var_x139 * var_x75;
        const double var_x141 = ((var_x72) ? (-var_x137 + var_x111 * (var_x137 + var_x136 * var_x71)) : (var_x140 * var_x79));
        const double var_x142 = 2.0000000001218549e-10 * var_x138;
        const double var_x143 = var_x142 * var_x84;
        const double var_x144 = ((var_x72) ? (-var_x143 + var_x111 * (var_x143 + var_x142 * var_x86)) : (var_x140 * var_x89));
        const double var_x145 = 2.0000000001218549e-7 * var_x138;
        const double var_x146 = var_x145 * var_x44;
        const double var_x147 = ((var_x54) ? (-var_x146 + var_x96 * (var_x146 + var_x145 * var_x51)) : (var_x121 * var_x139));
        const double var_x148 = var_x35 + var_chaste_interface__membrane__V;
        const double var_x149 = var_x148 * var_x92;
        const double var_x150 = NV_Ith_S(mParameters, 19) * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x151 = var_x14 * var_x3;
        const double var_x152 = NV_Ith_S(mParameters, 7) / (1.0 + NV_Ith_S(mParameters, 7));
        const double var_x153 = var_x152 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x154 = var_x105 * var_x4;
        const double var_x155 = var_x107 * var_x11;
        const double var_x156 = var_x152 * var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x157 = var_x19 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x158 = var_x157 * var_x22;
        const double var_x159 = var_x157 * var_x25;
        const double var_x160 = var_x112 * var_x65;
        const double var_x161 = var_x160 * var_x97;
        const double var_x162 = var_x65 * var_x80;
        const double var_x163 = ((var_x72) ? (-var_x161 + var_x111 * (var_x161 + var_x101 * var_x160)) : (0.00037433890822745472 * var_x162));
        const double var_x164 = var_x27 * var_x9;
        const double var_x165 = var_x13 * var_x27;
        const double var_x166 = var_x28 * var_x33;
        const double var_x167 = var_x28 * var_x38;
        const double var_x168 = var_x117 * var_x65;
        const double var_x169 = var_x168 * var_x97;
        const double var_x170 = ((var_x72) ? (-var_x169 + var_x111 * (var_x169 + var_x101 * var_x168)) : (7.4867781645490941e-5 * var_x162));
        const double var_x171 = (var_x20 - var_x18) * NV_Ith_S(mParameters, 18) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2);
        const double var_x172 = var_x17 * var_x22;
        const double var_x173 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod;
        const double var_x174 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Trop;
        const double var_x175 = 0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_up + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x176 = 1 / var_x175;
        const double var_x177 = pow(var_x175, (-2));
        const double var_x178 = var_x177 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x179 = var_x177 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
        const double var_x180 = 0.00040816326530612252 * NV_Ith_S(mParameters, 1);
        const double var_x181 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
        const double var_x182 = pow(var_x181, (-2));
        const double var_x183 = var_x182 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x184 = pow(var_chaste_interface__calcium_release__ActFrac, 2);
        const double var_x185 = var_x184 / pow(var_x181, 3);
        const double var_x186 = var_x182 * var_x184 * NV_Ith_S(mParameters, 1);
        const double var_x187 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x188 = exp(1.3333333333333333 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x189 = -0.1111111111111111 * var_chaste_interface__membrane__V;
        const double var_x190 = exp(0.55555555555555558 + var_x189);
        const double var_x191 = 1.0 + var_x190;
        const double var_x192 = 0.0055555555555555558 * var_x190 / pow(var_x191, 2);
        const double var_x193 = -0.050000000000000003 / var_x191;
        const double var_x194 = 1.0 + 0.033333333333333333 * var_chaste_interface__membrane__V;
        const double var_x195 = exp(-pow(var_x194, 3));
        const double var_x196 = exp(-0.022222222222222223 * var_chaste_interface__membrane__V);
        const double var_x197 = exp(4.4444444444444446 + var_x189);
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x200 = 1 / (1.0 - exp(1.0000000045806701e-7));
        const double var_x201 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x202 = fabs(var_x201) < 1.0000000010279564e-6;
        const double var_x203 = -0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x204 = exp(-4.1000000000000005 + var_x203);
        const double var_x205 = 1.0 - var_x204;
        const double var_x206 = 200.0 / var_x205;
        const double var_x207 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x208 = 0.00020000000091613401 * var_x200;
        const double var_x209 = exp(-7.5 + var_x203 + 0.10000000000000001 * NV_Ith_S(mParameters, 13));
        const double var_x210 = 1 / (1.0 + 320.0 * var_x209);
        const double var_x211 = 2.0 * var_x210;
        const double var_x212 = exp(-9.375 + var_x0 + 0.125 * NV_Ith_S(mParameters, 13));
        const double var_x213 = 0.02 * var_x212;
        const double var_x214 = 2.5 * var_x212;
        const double var_x215 = 20.0 * var_x212;
        const double var_x216 = 0.01 * NV_Ith_S(mParameters, 12);
        const double var_x217 = 1.0 - var_x216;
        const double var_x218 = var_x217 / (var_x215 + 2000.0 * var_x210);
        const double var_x219 = var_x209 / pow((0.0031250000000000002 + var_x209), 2);
        const double var_x220 = 0.0030000000000000001 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x221 = 1 / (1.0 - exp(1.0000000028043132e-7));
        const double var_x222 = 1 / (1.0 - exp(-1.0000000028043132e-7));
        const double var_x223 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x224 = fabs(var_x223);
        const double var_x225 = var_x224 < 4.0000000112172529e-7;
        ...
        const double var_x230 = 30.0 / var_x229;
        const double var_x231 = 1 / (-1.0 + exp(1.0000000010279564e-7));
        const double var_x232 = 1 / (-1.0 + exp(-1.0000000010279564e-7));
        const double var_x233 = var_x224 < 1.0000000010279564e-6;
        const double var_x234 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x235 = -1.0 + var_x234;
        const double var_x236 = 12.0 / var_x235;
        const double var_x237 = 1.2000000012335477e-5 * var_x231;
        const double var_x238 = 1.2000000033651759e-5 * var_x221;
        const double var_x239 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x240 = exp(8.5 + var_x226);
        const double var_x241 = -1.0 + var_x240;
        const double var_x242 = 0.0018749999999999999 / var_x241;
        const double var_x243 = exp(-8.5 + var_x227);
        const double var_x244 = 1.0 + var_x243;
        const double var_x245 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x246 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x247 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x248 = exp(-1.25 + var_x0);
        const double var_x249 = 1.0 + var_x248;
        const double var_x250 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x251 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x252 = NV_Ith_S(mParameters, 2) + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x253 = 1 / var_x252;
        const double var_x254 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x252, 2);
        const double var_x255 = NV_Ith_S(mParameters, 3) + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x256 = 1 / var_x255;
        const double var_x257 = 2 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x258 = ((var_chaste_interface__membrane__V < -50.0) ? (5.0) : (1.0));
        const double var_x259 = var_x253 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x260 = 1.0 - var_x259;
        const double var_x261 = var_x256 * var_x260;
        const double var_x262 = var_x259 + var_x261 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x263 = 0.5 * var_x258 * var_x262;
        const double var_x264 = var_x263 * (-2 * var_x254 + 2 * var_x253 + var_x256 * var_x257 * (var_x254 - var_x253));
        const double var_x265 = var_x264 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x266 = 0.5 * pow(var_x262, 2);
        const double var_x267 = -var_x258 * var_x266;
        const double var_x268 = var_x263 * (2 * var_x261 - var_x257 * var_x260 / pow(var_x255, 2));
        const double var_x269 = var_x268 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x270 = 0.00063182746016849224 * NV_Ith_S(mParameters, 5);
        const double var_x271 = var_x103 * var_x270;
        const double var_x272 = var_x148 * var_x270;
        const double var_x273 = 0.002 * NV_Ith_S(mParameters, 1);
        const double var_x274 = -var_x187;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x92 * (0.00084999999999999995 + var_x11 + var_x34 + var_x4 + var_x64 + var_x82 + var_x90 + var_x13 + var_x9 + 0.00050000000000000001 * var_x15 + 0.001 * var_x23 + 0.0040000000000000001 * var_x3 + 0.999 * var_x26 - 0.046792363528431836 * var_x39 - 0.044642857142857144 * var_x37));
        IJth(rJacobian, 1, 0) = -7.8978432521061529e-8 + 0.00063119563270832375 * var_x26 + 6.3182746016849223e-7 * var_x23;
        IJth(rJacobian, 2, 0) = var_x192 * (1.0 - var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1) + 3.3333333333333333e-6 * var_x188 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1;
        IJth(rJacobian, 3, 0) = var_x192 * (1.0 - var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2) + 4.0000000000000003e-5 * var_x195 * pow(var_x194, 2) * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2;
        IJth(rJacobian, 4, 0) = 2.2222222222222223e-5 * var_x196 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs + 0.0015555555555555555 * var_x197 * (1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs) / pow(var_x198, 2);
        IJth(rJacobian, 5, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x202) ? (99.999999644728632 * var_x199 + 100.00000035527137 * var_x200) : (var_x206 - 20.0 * var_x201 * var_x204 / pow(var_x205, 2))) + 0.44800000000000001 * var_x207 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 6, 0) = (var_x211 + var_x213) * (-var_x214 * var_x218 + 5.0000000000000004e-6 * var_x212 * var_x217 * (var_x214 - 0.625 * var_x219) / pow((var_x210 + 0.01 * var_x212), 2)) + (0.00062500000000000001 * var_x219 - 0.0025000000000000001 * var_x212) * (var_x216 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x215 * var_x218);
        IJth(rJacobian, 7, 0) = (0.0030000000000000001 - var_x220) * ((var_x225) ? (15.0 * var_x221 + 15.0 * var_x222) : (var_x230 - 7.5 * var_x223 * var_x228 / pow(var_x229, 2))) - var_x220 * ((var_x233) ? (6.0 * var_x231 + 6.0 * var_x232) : (var_x236 - 1.2 * var_x223 * var_x234 / pow(var_x235, 2)));
        IJth(rJacobian, 8, 0) = var_x239 * var_x242 - 0.00089999999999999998 * var_x243 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x244, 2) - 0.00046874999999999998 * var_x239 * var_x240 * var_x245 / pow(var_x241, 2);
        IJth(rJacobian, 11, 0) = -0.058823529411764705 * var_x247 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x248 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x249, 2);
        IJth(rJacobian, 12, 0) = 0.066600000000000006 * var_x250 / pow((1.0 + var_x250), 2);
        IJth(rJacobian, 15, 0) = (-3.7909647610109532e-7 - 0.0018935868981249711 * var_x26 - 0.00063182746016849224 * var_x11 - 0.00063182746016849224 * var_x82 - 3.1591373008424611e-7 * var_x15 - 2.5273098406739689e-6 * var_x3) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 16, 0) = (2.8206583043236264e-5 * var_x37 + 2.9564700203449875e-5 * var_x39 - 0.00063182746016849224 * var_x13 - 0.00063182746016849224 * var_x34 - 0.00063182746016849224 * var_x4 - 0.00063182746016849224 * var_x9 - 0.00063182746016849224 * var_x90) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 17, 0) = -0.003159137300842461 * var_x64;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x92 * (var_x102 + 0.0033392200824619565 * var_x93 - 0.0068931000000000001 * var_x94 - 0.999 * var_x95));
        IJth(rJacobian, 1, 1) = -7.0 + var_x173 + var_x174 - 0.00063119563270832375 * var_x95 - 1.0549054718227806e-6 * var_x93 - 4.3552498656874335e-6 * var_x94 + (0.00040000000000000002 * var_x178 - 0.00040000000000000002 * var_x176 - 7.1999999999999991e-9 * var_x179) * NV_Ith_S(mParameters, 4);
        ...
        IJth(rJacobian, 13, 1) = -var_x265 + var_x251 * var_x264;
        IJth(rJacobian, 14, 1) = var_x265;
        IJth(rJacobian, 15, 1) = (0.0018935868981249711 * var_x95 + 1.3065749597062301e-5 * var_x94) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 17, 1) = -0.003159137300842461 * var_x102;
        IJth(rJacobian, 18, 1) = (3.5279999999999993e-7 * var_x179 + 0.019599999999999999 * var_x176 - 0.019599999999999999 * var_x178) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 20, 1) = 2.0 - var_x173;
        IJth(rJacobian, 21, 1) = 5.0 - var_x174;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x104 * NV_Ith_S(mParameters, 15));
        IJth(rJacobian, 2, 2) = var_x193 - 5.0000000000000002e-5 * var_x188;
        IJth(rJacobian, 16, 2) = -var_x271 * NV_Ith_S(mParameters, 15);
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x104 * NV_Ith_S(mParameters, 16));
        IJth(rJacobian, 3, 3) = var_x193 - 0.00040000000000000002 * var_x195;
        IJth(rJacobian, 16, 3) = -var_x271 * NV_Ith_S(mParameters, 16);
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.002 * var_x106 * var_x91);
        IJth(rJacobian, 4, 4) = -0.001 * var_x196 - 0.014 / var_x198;
        IJth(rJacobian, 16, 4) = -0.0012636549203369845 * var_x106 * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0030000000000000001 * var_x109 * var_x91);
        IJth(rJacobian, 5, 5) = -8.0 * var_x207 - 0.001 * ((var_x202) ? (-var_x208 + 499999.99948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (var_x208 + 0.00019999999949504854 * var_x199)) : (var_x201 * var_x206));
        IJth(rJacobian, 15, 5) = -0.0018954823805054767 * var_x109 * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x110 * var_x92);
        IJth(rJacobian, 6, 6) = -var_x211 - var_x213;
        IJth(rJacobian, 15, 6) = -var_x110 * var_x270;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x92 * (var_x116 + var_x119 + var_x122));
        IJth(rJacobian, 7, 7) = -0.0030000000000000001 * ((var_x233) ? (var_x237 - 499999.99948602181 * (18.999998999999999 + var_chaste_interface__membrane__V) * (-var_x237 - 1.2000000012335477e-5 * var_x232)) : (var_x223 * var_x236)) - 0.0030000000000000001 * ((var_x225) ? (-var_x238 + 1249999.9964946085 * (19.000000400000001 + var_chaste_interface__membrane__V) * (var_x238 + 1.2000000033651759e-5 * var_x222)) : (var_x223 * var_x230));
        IJth(rJacobian, 15, 7) = -var_x116 * var_x270;
        IJth(rJacobian, 16, 7) = -var_x119 * var_x270;
        IJth(rJacobian, 17, 7) = -0.003159137300842461 * var_x122;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x92 * (var_x128 + var_x131 + var_x134));
        IJth(rJacobian, 8, 8) = -0.0035999999999999999 / var_x244 - var_x242 * var_x245;
        IJth(rJacobian, 15, 8) = -var_x128 * var_x270;
        IJth(rJacobian, 16, 8) = -var_x131 * var_x270;
        IJth(rJacobian, 17, 8) = -0.003159137300842461 * var_x134;
        IJth(rJacobian, 9, 9) = -0.001;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x92 * (var_x141 + var_x144 + var_x147));
        IJth(rJacobian, 10, 10) = -0.02;
        IJth(rJacobian, 15, 10) = -var_x141 * var_x270;
        IJth(rJacobian, 16, 10) = -var_x144 * var_x270;
        IJth(rJacobian, 17, 10) = -0.003159137300842461 * var_x147;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x12 * var_x149);
        IJth(rJacobian, 11, 11) = -0.033000000000000002 / var_x249 - 3.3000000000000003e-5 * var_x247;
        IJth(rJacobian, 16, 11) = -var_x12 * var_x272;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x149 * var_x150);
        IJth(rJacobian, 12, 12) = -0.33300000000000002;
        IJth(rJacobian, 16, 12) = -var_x150 * var_x272;
        IJth(rJacobian, 1, 13) = (var_x180 * var_x183 - var_x180 * var_x185) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 13, 13) = var_x267 + var_x258 * (-0.059999999999999998 - var_x266);
        IJth(rJacobian, 14, 13) = var_x258 * (0.059999999999999998 + var_x266);
        IJth(rJacobian, 19, 13) = (var_x185 * var_x273 - var_x183 * var_x273) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 13, 14) = var_x267;
        IJth(rJacobian, 14, 14) = -0.001 * var_x258;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x92 * (var_x163 + 0.69999999999999996 * var_x153 + 0.0030000000000000001 * var_x158 + 26.713760659695652 * var_x155 + 0.80141281979086942 * var_x154 + 0.10685504263878261 * var_x151 + 0.016028256395817387 * var_x14 + 2.9969999999999999 * var_x159 - 0.00043749999999999995 * var_x156));
        IJth(rJacobian, 1, 15) = 0.0018935868981249711 * var_x159 + 1.8954823805054768e-6 * var_x158;
        IJth(rJacobian, 15, 15) = (8.2927354147114598e-7 * var_x156 - 0.00063182746016849224 * var_x163 - 1.0127092529498693e-5 * var_x14 - 0.0013268376663538336 * var_x153 - 0.016878487549164489 * var_x155 - 6.7513950196657958e-5 * var_x151 - 0.0056807606943749134 * var_x159) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 16, 15) = (0.00088455844423588909 * var_x153 - 5.5284902764743069e-7 * var_x156 - 0.00050635462647493463 * var_x154) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x92 * (var_x170 + 26.713760659695652 * var_x154 + 26.713760659695652 * var_x164 + 26.713760659695652 * var_x165 + 26.713760659695652 * var_x166 + 3.2056512791634777 * var_x155 - 1.25 * var_x167));
        IJth(rJacobian, 15, 16) = -0.0020254185058997385 * var_x155 * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 16, 16) = (0.00078978432521061525 * var_x167 - 0.00063182746016849224 * var_x170 - 0.016878487549164489 * var_x154 - 0.016878487549164489 * var_x164 - 0.016878487549164489 * var_x165 - 0.016878487549164489 * var_x166) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x92 * (-0.001 * var_x172 - 6.9e-6 * var_x171));
        IJth(rJacobian, 1, 17) = 0.001 - 4.3596094751625962e-9 * var_x171 - 6.3182746016849223e-7 * var_x172;
        IJth(rJacobian, 10, 17) = -0.02 / var_x246 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x246, 2);
        IJth(rJacobian, 13, 17) = -var_x269 + var_x251 * var_x268;
        IJth(rJacobian, 14, 17) = var_x269;
        IJth(rJacobian, 17, 17) = -0.01;
        IJth(rJacobian, 1, 18) = (9.5999999999999999e-8 * var_x178 + 7.1999999999999991e-9 * var_x176 - 1.7279999999999999e-12 * var_x179) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 18, 18) = -0.050000000000000003 + (8.4671999999999982e-11 * var_x179 - 4.7039999999999993e-6 * var_x178 - 3.5279999999999993e-7 * var_x176) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 19, 18) = 0.0050000000000000001;
        IJth(rJacobian, 1, 19) = 0.00020408163265306126 * var_x186 + 0.00020408163265306126 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 18, 19) = 0.050000000000000003;
        IJth(rJacobian, 19, 19) = -0.0050000000000000001 - 0.001 * var_x186 - 0.001 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 1, 20) = 0.050000000000000003 + var_x187;
        IJth(rJacobian, 20, 20) = -0.050000000000000003 + var_x274;
        IJth(rJacobian, 1, 21) = 0.20000000000000001 + var_x187;
        IJth(rJacobian, 21, 21) = -0.20000000000000001 + var_x274;
    }
