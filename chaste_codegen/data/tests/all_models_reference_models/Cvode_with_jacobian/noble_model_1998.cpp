...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x5 = log(10);
        const double var_x6 = 1 / var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x7 = var_x5 * log10(4.0 * var_x6);
        const double var_x8 = exp(-0.46792363528431841 + 0.046792363528431836 * var_chaste_interface__membrane__V - 1.25 * var_x7);
        const double var_x9 = 1.0 + var_x8;
        const double var_x10 = 1 / var_x9;
        const double var_x11 = exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V);
        const double var_x12 = 1.0 + var_x11;
        const double var_x13 = 1 / var_x12;
        const double var_x14 = 0.0012999999999999999 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2 + 0.0020999999999999999 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1;
        const double var_x15 = var_x13 * var_x14;
        const double var_x16 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3);
        const double var_x17 = var_x16 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x19 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x20 = 0.018716945411372737 * var_chaste_interface__membrane__V;
        const double var_x21 = exp(var_x20);
        const double var_x22 = var_x21 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        const double var_x23 = 0.037433890822745473 * var_x22;
        const double var_x24 = exp(-var_x20);
        const double var_x25 = 51359.298208806787 * var_x24;
        const double var_x26 = var_x19 * (var_x23 + var_x25 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x27 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x28 = var_x27 * (var_x23 + var_x25 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x29 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x30 = 26.713760659695652 * var_x5;
        const double var_x31 = var_x1 * (-var_x30 * log10(140.0 * var_x29) + var_chaste_interface__membrane__V) / pow(var_x2, 2);
        const double var_x32 = -26.713760659695652 * var_x7 + var_chaste_interface__membrane__V;
        const double var_x33 = var_x32 * var_x8 / pow(var_x9, 2);
        const double var_x34 = var_x11 * var_x14 * var_x32 / pow(var_x12, 2);
        ...
        const double var_x38 = var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        const double var_x42 = -140.0 * var_x35 + var_x41 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x43 = 3.7433890822745477e-5 * var_x42;
        ...
        const double var_x48 = -2.0 * var_x44 + var_x47 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x49 = var_x46 * var_x48;
        const double var_x50 = 0.014973556329098189 * var_x49;
        const double var_x51 = -4.0 * var_x35 + var_x41 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x52 = 7.4867781645490951e-6 * var_x51;
        const double var_x53 = -50.0 + var_chaste_interface__membrane__V;
        const double var_x54 = var_x39 * var_x53;
        const double var_x55 = var_x46 * var_x54;
        const double var_x56 = var_x44 * var_x55;
        const double var_x57 = var_x40 * var_x53;
        const double var_x58 = var_x35 * var_x57;
        const double var_x59 = var_x44 * var_x48 * var_x54 / pow(var_x45, 2);
        const double var_x60 = var_x35 * var_x54 / pow(var_x36, 2);
        const double var_x61 = var_x51 * var_x60;
        const double var_x62 = var_x42 * var_x60;
        const double var_x63 = 1 / NV_Ith_S(mParameters, 0);
        const double var_x64 = 0.001 * var_x63;
        const double var_x65 = 1 / var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x66 = var_x19 * var_x24;
        const double var_x67 = 2.0 * var_x22;
        const double var_x68 = 2744000.0 * var_x24;
        const double var_x69 = (var_x67 - var_x68 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x70 = var_x47 * var_x55;
        const double var_x71 = var_x13 * var_x32;
        const double var_x72 = var_x63 * var_x71;
        const double var_x73 = 1 / (0.029999999999999999 * var_chaste_interface__intracellular_sodium_concentration__Na_i + var_chaste_interface__intracellular_potassium_concentration__K_i);
        const double var_x74 = (-var_x30 * log10(8.1999999999999993 * var_x73) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs;
        const double var_x75 = 1 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x76 = -var_x30 * log10(140.47999999999999 * var_x75) + var_chaste_interface__membrane__V;
        const double var_x77 = var_x76 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x78 = var_x16 * var_x76;
        const double var_x79 = var_x38 * var_x53;
        const double var_x80 = var_x37 * var_x79;
        const double var_x81 = var_x53 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x82 = var_x81 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds;
        const double var_x83 = var_x37 * var_x82;
        const double var_x84 = var_x81 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x85 = var_x37 * var_x84;
        const double var_x86 = var_x64 * (0.0050000000000000001 * var_chaste_interface__membrane__V - 0.13356880329847826 * var_x7);
        const double var_x87 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x88 = var_x4 * var_x73;
        const double var_x89 = var_x29 * var_x3;
        const double var_x90 = var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x91 = var_x21 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x92 = var_x27 * var_x91;
        const double var_x93 = var_x17 * var_x75;
        const double var_x94 = var_x19 * var_x91;
        const double var_x95 = var_x41 * var_x57;
        const double var_x96 = var_x10 * var_x6;
        const double var_x97 = var_x15 * var_x6;
        const double var_x98 = var_x18 * var_x6;
        const double var_x99 = var_x33 * var_x6;
        const double var_x100 = (var_x67 - var_x68 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2);
        const double var_x101 = var_x24 * var_x27;
        const double var_x102 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod;
        const double var_x103 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Trop;
        const double var_x104 = 0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_up + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x105 = 1 / var_x104;
        const double var_x106 = pow(var_x104, (-2));
        const double var_x107 = var_x106 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x108 = var_x106 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
        const double var_x109 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
        const double var_x110 = pow(var_x109, (-2));
        const double var_x111 = var_x110 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x112 = pow(var_chaste_interface__calcium_release__ActFrac, 2);
        const double var_x113 = var_x112 / pow(var_x109, 3);
        const double var_x114 = var_x110 * var_x112;
        const double var_x115 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x116 = exp(1.3333333333333333 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x117 = -0.1111111111111111 * var_chaste_interface__membrane__V;
        const double var_x118 = exp(0.55555555555555558 + var_x117);
        const double var_x119 = 1.0 + var_x118;
        const double var_x120 = 0.0055555555555555558 * var_x118 / pow(var_x119, 2);
        const double var_x121 = -0.050000000000000003 / var_x119;
        const double var_x122 = 1.0 + 0.033333333333333333 * var_chaste_interface__membrane__V;
        const double var_x123 = exp(-pow(var_x122, 3));
        const double var_x124 = exp(-0.022222222222222223 * var_chaste_interface__membrane__V);
        const double var_x125 = exp(4.4444444444444446 + var_x117);
        ...
        const double var_x132 = 200.0 / var_x131;
        const double var_x133 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x134 = exp(-9.375 + var_x0);
        const double var_x135 = exp(-7.5 + var_x129);
        const double var_x136 = 0.0030000000000000001 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x137 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x138 = fabs(var_x137) < 0.0001;
        const double var_x139 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x140 = -var_x139;
        const double var_x141 = exp(-4.75 + var_x140);
        const double var_x142 = 1.0 - var_x141;
        const double var_x143 = 30.0 / var_x142;
        const double var_x144 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x145 = -1.0 + var_x144;
        const double var_x146 = 12.0 / var_x145;
        const double var_x147 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x148 = fabs(var_x147) < 0.0001;
        const double var_x149 = exp(8.5 + var_x139);
        const double var_x150 = -1.0 + var_x149;
        const double var_x151 = 6.25 / var_x150;
        const double var_x152 = exp(-8.5 + var_x140);
        const double var_x153 = 1.0 + var_x152;
        const double var_x154 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        ...
        const double var_x158 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x159 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        ...
        const double var_x162 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x160, 2);
        ...
        const double var_x165 = 2 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        ...
        const double var_x171 = 0.5 * var_x166 * var_x170;
        const double var_x172 = var_x171 * (-2 * var_x162 + 2 * var_x161 + var_x164 * var_x165 * (var_x162 - var_x161));
        ...
        const double var_x176 = var_x171 * (2 * var_x169 - var_x165 * var_x168 / pow(var_x163, 2));
        const double var_x177 = var_x176 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x178 = 2.3651760162759904e-8 * var_x42;
        const double var_x179 = 4.7303520325519805e-9 * var_x51;
        const double var_x180 = 8.4392437745822447e-5 * var_x7 - 3.1591373008424612e-6 * var_chaste_interface__membrane__V;
        const double var_x181 = 4.7303520325519803e-5 * var_x49;
        const double var_x182 = -var_x115;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * (0.00084999999999999995 + var_x15 + 2.5 * var_x17 + 0.00050000000000000001 * var_x31 + 0.0040000000000000001 * var_x3 + 0.0025999999999999999 * var_x4 + 0.0050000000000000001 * var_x18 + 0.00049950000000000005 * var_x26 + 4.9999999999999998e-7 * var_x28 + 0.14285714285714285 * var_x10 + 0.0022420738914067642 * var_x56 + 0.00019730250244379526 * var_x58 - 0.044642857142857144 * var_x34 - 0.0011210369457033821 * var_x59 - 2.8025923642584553e-7 * var_x61 - 1.4012961821292277e-6 * var_x62 - 0.0066846233612045487 * var_x33 + var_x39 * var_x50 + var_x40 * var_x43 + var_x40 * var_x52));
        IJth(rJacobian, 1, 0) = -7.8978432521061529e-8 + 3.1559781635416185e-7 * var_x26 + 3.1591373008424614e-10 * var_x28;
        IJth(rJacobian, 2, 0) = var_x120 * (1.0 - var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1) + 3.3333333333333333e-6 * var_x116 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1;
        IJth(rJacobian, 3, 0) = var_x120 * (1.0 - var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2) + 4.0000000000000003e-5 * var_x123 * pow(var_x122, 2) * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2;
        IJth(rJacobian, 4, 0) = 2.2222222222222223e-5 * var_x124 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs + 0.0015555555555555555 * var_x125 * (1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs) / pow(var_x126, 2);
        IJth(rJacobian, 5, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x128) ? (0) : (var_x132 - 20.0 * var_x127 * var_x130 / pow(var_x131, 2))) + 0.44800000000000001 * var_x133 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 6, 0) = -0.125 * var_x134 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x135 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x135), 2);
        IJth(rJacobian, 7, 0) = (0.0030000000000000001 - var_x136) * ((var_x138) ? (0) : (var_x143 - 7.5 * var_x137 * var_x141 / pow(var_x142, 2))) - var_x136 * ((var_x138) ? (0) : (var_x146 - 1.2 * var_x137 * var_x144 / pow(var_x145, 2)));
        IJth(rJacobian, 8, 0) = (0.00029999999999999997 - 0.00029999999999999997 * var_chaste_interface__L_type_Ca_channel_f_gate__f) * ((var_x148) ? (0) : (var_x151 - 1.5625 * var_x147 * var_x149 / pow(var_x150, 2))) - 0.00089999999999999998 * var_x152 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x153, 2);
        IJth(rJacobian, 11, 0) = -0.058823529411764705 * var_x155 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x156 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x157, 2);
        IJth(rJacobian, 12, 0) = 0.066600000000000006 * var_x158 / pow((1.0 + var_x158), 2);
        IJth(rJacobian, 15, 0) = -3.7909647610109532e-7 + 8.8537740769851485e-10 * var_x62 - 9.4679344906248566e-7 * var_x26 - 0.0015795686504212305 * var_x17 - 1.2395283707779208e-7 * var_x58 - 3.1591373008424611e-7 * var_x31 - 2.5273098406739689e-6 * var_x3 - var_x178 * var_x40;
        IJth(rJacobian, 16, 0) = 4.2235286004928392e-6 * var_x33 + 1.7707548153970298e-10 * var_x61 + 2.8206583043236264e-5 * var_x34 - 9.0261065738356038e-5 * var_x10 - 7.0830192615881192e-10 * var_x58 - 3.1591373008424612e-6 * var_x18 - 1.6427513964380798e-6 * var_x4 - 0.00063182746016849224 * var_x15 - var_x179 * var_x40;
        IJth(rJacobian, 17, 0) = 3.5415096307940594e-6 * var_x59 - 7.0830192615881188e-6 * var_x56 - var_x181 * var_x39;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * (0.014973556329098189 * var_x70 + 0.0033392200824619565 * var_x65 - 1370.6279999999999 * var_x66 - 3.4465500000000001e-6 * var_x69));
        IJth(rJacobian, 1, 1) = -7.0 + var_x102 + var_x103 + 0.00040000000000000002 * var_x107 - 0.00040000000000000002 * var_x105 - 1.0549054718227806e-6 * var_x65 - 0.86600040807582024 * var_x66 - 2.1776249328437171e-9 * var_x69 - 7.1999999999999991e-9 * var_x108;
        ...
        IJth(rJacobian, 13, 1) = -var_x173 + var_x159 * var_x172;
        IJth(rJacobian, 14, 1) = var_x173;
        IJth(rJacobian, 15, 1) = 2.5980012242274606 * var_x66 + 6.5328747985311509e-9 * var_x69;
        IJth(rJacobian, 17, 1) = -4.7303520325519803e-5 * var_x70;
        IJth(rJacobian, 18, 1) = 0.019599999999999999 * var_x105 + 3.5279999999999993e-7 * var_x108 - 0.019599999999999999 * var_x107;
        IJth(rJacobian, 20, 1) = 2.0 - var_x102;
        IJth(rJacobian, 21, 1) = 5.0 - var_x103;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-2.0999999999999998e-6 * var_x72);
        IJth(rJacobian, 2, 2) = var_x121 - 5.0000000000000002e-5 * var_x116;
        IJth(rJacobian, 16, 2) = -1.3268376663538336e-6 * var_x71;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-1.2999999999999998e-6 * var_x72);
        IJth(rJacobian, 3, 3) = var_x121 - 0.00040000000000000002 * var_x123;
        IJth(rJacobian, 16, 3) = -8.2137569821903989e-7 * var_x71;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-5.1999999999999993e-6 * var_x63 * var_x74);
        IJth(rJacobian, 4, 4) = -0.001 * var_x124 - 0.014 / var_x126;
        IJth(rJacobian, 16, 4) = -3.2855027928761595e-6 * var_x74;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0074999999999999997 * var_x63 * var_x77);
        IJth(rJacobian, 5, 5) = -8.0 * var_x133 - 0.001 * ((var_x128) ? (2000.0) : (var_x127 * var_x132));
        IJth(rJacobian, 15, 5) = -0.0047387059512636921 * var_x77;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0025000000000000001 * var_x63 * var_x78);
        IJth(rJacobian, 6, 6) = -2.0 / (1.0 + 320.0 * var_x135) - 0.02 * var_x134;
        IJth(rJacobian, 15, 6) = -0.0015795686504212305 * var_x78;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * (var_x43 * var_x80 + var_x50 * var_x79 + var_x52 * var_x80));
        IJth(rJacobian, 7, 7) = -0.0030000000000000001 * ((var_x138) ? (120.0) : (var_x137 * var_x143)) - 0.0030000000000000001 * ((var_x138) ? (120.0) : (var_x137 * var_x146));
        IJth(rJacobian, 15, 7) = -var_x178 * var_x80;
        IJth(rJacobian, 16, 7) = -var_x179 * var_x80;
        IJth(rJacobian, 17, 7) = -var_x181 * var_x79;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * (var_x43 * var_x83 + var_x50 * var_x82 + var_x52 * var_x83));
        IJth(rJacobian, 8, 8) = -0.00029999999999999997 * ((var_x148) ? (25.0) : (var_x147 * var_x151)) - 0.0035999999999999999 / var_x153;
        IJth(rJacobian, 15, 8) = -var_x178 * var_x83;
        IJth(rJacobian, 16, 8) = -var_x179 * var_x83;
        IJth(rJacobian, 17, 8) = -var_x181 * var_x82;
        IJth(rJacobian, 9, 9) = -0.001;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * (var_x43 * var_x85 + var_x50 * var_x84 + var_x52 * var_x85));
        IJth(rJacobian, 10, 10) = -0.02;
        IJth(rJacobian, 15, 10) = -var_x178 * var_x85;
        IJth(rJacobian, 16, 10) = -var_x179 * var_x85;
        IJth(rJacobian, 17, 10) = -var_x181 * var_x84;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x86 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 11, 11) = -0.033000000000000002 / var_x157 - 3.3000000000000003e-5 * var_x155;
        IJth(rJacobian, 16, 11) = var_x180 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        IJth(rJacobian, 16, 12) = var_x180 * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 13) = (0.10204081632653063 * var_x111 - 0.10204081632653063 * var_x113) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 13, 13) = var_x175 + var_x166 * (-0.059999999999999998 - var_x174);
        IJth(rJacobian, 14, 13) = var_x166 * (0.059999999999999998 + var_x174);
        IJth(rJacobian, 19, 13) = (0.5 * var_x113 - 0.5 * var_x111) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 13, 14) = var_x175;
        IJth(rJacobian, 14, 14) = -0.001 * var_x166;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * (3.7433890822745477e-5 * var_x95 + 3.0000000000000001e-6 * var_x92 + 66.784401649239129 * var_x93 + 0.0020836733314562603 * var_x88 + 0.55999999999999994 * var_x87 + 0.10685504263878261 * var_x89 + 0.016028256395817387 * var_x29 + 0.0029970000000000001 * var_x94 - 0.00035 * var_x90));
        IJth(rJacobian, 1, 15) = 1.8935868981249713e-6 * var_x94 + 1.8954823805054768e-9 * var_x92;
        IJth(rJacobian, 15, 15) = 6.634188331769168e-7 * var_x90 - 6.7513950196657958e-5 * var_x89 - 0.0010614701330830668 * var_x87 - 1.0127092529498693e-5 * var_x29 - 5.6807606943749135e-6 * var_x94 - 0.042196218872911223 * var_x93 - 2.3651760162759904e-8 * var_x95;
        IJth(rJacobian, 16, 15) = 0.00070764675538871125 * var_x87 - 1.31652202883483e-6 * var_x88 - 4.4227922211794452e-7 * var_x90;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * (26.713760659695652 * var_x97 + 0.06945577771520868 * var_x88 + 8.0141281979086951 * var_x93 + 0.13356880329847826 * var_x98 + 7.4867781645490951e-6 * var_x95 + 3.8162515228136642 * var_x96 - 0.17857142857142858 * var_x99));
        IJth(rJacobian, 15, 16) = -0.0050635462647493461 * var_x93;
        IJth(rJacobian, 16, 16) = 0.00011282633217294504 * var_x99 - 4.388406762782767e-5 * var_x88 - 8.4392437745822447e-5 * var_x98 - 0.016878487549164489 * var_x97 - 0.0024112125070234981 * var_x96 - 4.7303520325519805e-9 * var_x95;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * (-3.4500000000000003e-9 * var_x100 - 1.3720000000000001 * var_x101));
        IJth(rJacobian, 1, 17) = 0.001 - 0.00086686727535117134 * var_x101 - 2.1798047375812983e-12 * var_x100;
        IJth(rJacobian, 10, 17) = -0.02 / var_x154 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x154, 2);
        IJth(rJacobian, 13, 17) = -var_x177 + var_x159 * var_x176;
        IJth(rJacobian, 14, 17) = var_x177;
        IJth(rJacobian, 17, 17) = -0.01;
        IJth(rJacobian, 1, 18) = 9.5999999999999999e-8 * var_x107 + 7.1999999999999991e-9 * var_x105 - 1.7279999999999999e-12 * var_x108;
        IJth(rJacobian, 18, 18) = -0.050000000000000003 + 8.4671999999999982e-11 * var_x108 - 3.5279999999999993e-7 * var_x105 - 4.7039999999999993e-6 * var_x107;
        IJth(rJacobian, 19, 18) = 0.0050000000000000001;
        IJth(rJacobian, 1, 19) = 1.0204081632653063e-5 + 0.051020408163265314 * var_x114;
        IJth(rJacobian, 18, 19) = 0.050000000000000003;
        IJth(rJacobian, 19, 19) = -0.0050499999999999998 - 0.25 * var_x114;
        IJth(rJacobian, 1, 20) = 0.050000000000000003 + var_x115;
        IJth(rJacobian, 20, 20) = -0.050000000000000003 + var_x182;
        IJth(rJacobian, 1, 21) = 0.20000000000000001 + var_x115;
        IJth(rJacobian, 21, 21) = -0.20000000000000001 + var_x182;
    }
