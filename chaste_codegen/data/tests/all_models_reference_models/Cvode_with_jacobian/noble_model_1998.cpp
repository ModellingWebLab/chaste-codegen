...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x212 = exp(-7.5 + var_x206 + 0.10000000000000001 * NV_Ith_S(mParameters, 13));
        const double var_x213 = 1 / (1.0 + 320.0 * var_x212);
        const double var_x214 = 2.0 * var_x213;
        const double var_x215 = exp(-9.375 + var_x0 + 0.125 * NV_Ith_S(mParameters, 13));
        const double var_x216 = 0.02 * var_x215;
        const double var_x217 = 2.5 * var_x215;
        const double var_x218 = 20.0 * var_x215;
        const double var_x219 = 0.01 * NV_Ith_S(mParameters, 12);
        const double var_x220 = 1.0 - var_x219;
        const double var_x221 = var_x220 / (var_x218 + 2000.0 * var_x213);
        const double var_x222 = var_x212 / pow((0.0031250000000000002 + var_x212), 2);
        const double var_x223 = 0.0030000000000000001 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x254 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        ...
        const double var_x258 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x259 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x260 = NV_Ith_S(mParameters, 2) + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x261 = 1 / var_x260;
        const double var_x262 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x260, 2);
        const double var_x263 = NV_Ith_S(mParameters, 3) + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x264 = 1 / var_x263;
        const double var_x265 = 2 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        ...
        const double var_x271 = 0.5 * var_x266 * var_x270;
        const double var_x272 = var_x271 * (-2 * var_x262 + 2 * var_x261 + var_x264 * var_x265 * (var_x262 - var_x261));
        ...
        const double var_x276 = var_x271 * (2 * var_x269 - var_x265 * var_x268 / pow(var_x263, 2));
        const double var_x277 = var_x276 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x278 = 0.00063182746016849224 * NV_Ith_S(mParameters, 5);
        const double var_x279 = var_x105 * var_x278;
        const double var_x280 = var_x150 * var_x278;
        const double var_x281 = 0.002 * NV_Ith_S(mParameters, 1);
        ...
        IJth(rJacobian, 5, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x205) ? (100.0 * var_x202 + 100.0 * var_x203) : (var_x209 - 20.0 * var_x204 * var_x207 / pow(var_x208, 2))) + 0.44800000000000001 * var_x210 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 6, 0) = (var_x214 + var_x216) * (-var_x217 * var_x221 + 5.0000000000000004e-6 * var_x215 * var_x220 * (var_x217 - 0.625 * var_x222) / pow((var_x213 + 0.01 * var_x215), 2)) + (0.00062500000000000001 * var_x222 - 0.0025000000000000001 * var_x215) * (var_x219 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x218 * var_x221);
        IJth(rJacobian, 7, 0) = (0.0030000000000000001 - var_x223) * ((var_x230) ? (15.0 * var_x225 + 15.0 * var_x227) : (var_x235 - 7.5 * var_x228 * var_x233 / pow(var_x234, 2))) - var_x223 * ((var_x238) ? (5.9999999999167333 * var_x236 + 6.0000000000832667 * var_x237) : (var_x241 - 1.2 * var_x228 * var_x239 / pow(var_x240, 2)));
        IJth(rJacobian, 8, 0) = (0.00029999999999999997 - 0.00029999999999999997 * var_chaste_interface__L_type_Ca_channel_f_gate__f) * ((var_x247) ? (3.125 * var_x244 + 3.125 * var_x245) : (var_x250 - 1.5625 * var_x246 * var_x248 / pow(var_x249, 2))) - 0.00089999999999999998 * var_x251 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x252, 2);
        IJth(rJacobian, 11, 0) = -0.058823529411764705 * var_x255 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x256 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x257, 2);
        IJth(rJacobian, 12, 0) = 0.066600000000000006 * var_x258 / pow((1.0 + var_x258), 2);
        ...
        IJth(rJacobian, 1, 1) = -7.0 + var_x176 + var_x177 - 0.00063119563270832375 * var_x99 - 1.0549054718227806e-6 * var_x97 - 4.3552498656874335e-6 * var_x98 + (0.00040000000000000002 * var_x181 - 0.00040000000000000002 * var_x179 - 7.1999999999999991e-9 * var_x182) * NV_Ith_S(mParameters, 4);
        ...
        IJth(rJacobian, 13, 1) = -var_x273 + var_x259 * var_x272;
        IJth(rJacobian, 14, 1) = var_x273;
        ...
        IJth(rJacobian, 16, 2) = -var_x279 * NV_Ith_S(mParameters, 15);
        ...
        IJth(rJacobian, 16, 3) = -var_x279 * NV_Ith_S(mParameters, 16);
        ...
        IJth(rJacobian, 5, 5) = -8.0 * var_x210 - 0.001 * ((var_x205) ? (var_x211 - 499999.99998562218 * (40.999999000000003 + var_chaste_interface__membrane__V) * (-var_x211 - 0.00020000000000575113 * var_x202)) : (var_x204 * var_x209));
        ...
        IJth(rJacobian, 15, 6) = -var_x112 * var_x278;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x96 * (var_x118 + var_x121 + var_x124));
        IJth(rJacobian, 7, 7) = -0.0030000000000000001 * ((var_x230) ? (var_x242 - 1249999.9999640554 * (18.999999599999999 + var_chaste_interface__membrane__V) * (-var_x242 - 1.2000000000345068e-5 * var_x225)) : (var_x228 * var_x235)) - 0.0030000000000000001 * ((var_x238) ? (-var_x243 + 500000.00000643887 * (19.000001000000001 + var_chaste_interface__membrane__V) * (var_x243 + 1.2000000000012001e-5 * var_x237)) : (var_x228 * var_x241));
        IJth(rJacobian, 15, 7) = -var_x118 * var_x278;
        IJth(rJacobian, 16, 7) = -var_x121 * var_x278;
        ...
        IJth(rJacobian, 8, 8) = -0.00029999999999999997 * ((var_x247) ? (-var_x253 + 1249999.9999640554 * (34.000000399999998 + var_chaste_interface__membrane__V) * (var_x253 + 2.5000000000718892e-6 * var_x244)) : (var_x246 * var_x250)) - 0.0035999999999999999 / var_x252;
        IJth(rJacobian, 15, 8) = -var_x130 * var_x278;
        IJth(rJacobian, 16, 8) = -var_x133 * var_x278;
        ...
        IJth(rJacobian, 15, 10) = -var_x143 * var_x278;
        IJth(rJacobian, 16, 10) = -var_x146 * var_x278;
        IJth(rJacobian, 17, 10) = -0.003159137300842461 * var_x149;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x12 * var_x151);
        IJth(rJacobian, 11, 11) = -0.033000000000000002 / var_x257 - 3.3000000000000003e-5 * var_x255;
        IJth(rJacobian, 16, 11) = -var_x12 * var_x280;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x151 * var_x152);
        IJth(rJacobian, 12, 12) = -0.33300000000000002;
        IJth(rJacobian, 16, 12) = -var_x152 * var_x280;
        ...
        IJth(rJacobian, 13, 13) = var_x275 + var_x266 * (-0.059999999999999998 - var_x274);
        IJth(rJacobian, 14, 13) = var_x266 * (0.059999999999999998 + var_x274);
        IJth(rJacobian, 19, 13) = (var_x188 * var_x281 - var_x186 * var_x281) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 13, 14) = var_x275;
        IJth(rJacobian, 14, 14) = -0.001 * var_x266;
        ...
        IJth(rJacobian, 10, 17) = -0.02 / var_x254 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x254, 2);
        IJth(rJacobian, 13, 17) = -var_x277 + var_x259 * var_x276;
        IJth(rJacobian, 14, 17) = var_x277;
        ...
        IJth(rJacobian, 20, 20) = -0.050000000000000003 + var_x282;
        IJth(rJacobian, 1, 21) = 0.20000000000000001 + var_x190;
        IJth(rJacobian, 21, 21) = -0.20000000000000001 + var_x282;
    }
