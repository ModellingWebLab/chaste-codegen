...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmahajan_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x16 = (-0.055 * var_x15 - 0.11 * var_chaste_interface__Ito__ytos) * NV_Ith_S(mParameters, 2);
        ...
        const double var_x27 = (-16.0 + 16.0 * var_chaste_interface__ICaL__c1 + 16.0 * var_chaste_interface__ICaL__c2 + 16.0 * var_chaste_interface__ICaL__xi1ba + 16.0 * var_chaste_interface__ICaL__xi1ca + 16.0 * var_chaste_interface__ICaL__xi2ba + 16.0 * var_chaste_interface__ICaL__xi2ca) * NV_Ith_S(mParameters, 3);
        ...
        const double var_x34 = var_x33 * NV_Ith_S(mParameters, 4) * var_chaste_interface__INa__xj;
        ...
        const double var_x57 = NV_Ith_S(mParameters, 0) * NV_Ith_S(mParameters, 5) * var_chaste_interface__IKr__xr;
        ...
        const double var_x61 = NV_Ith_S(mParameters, 2) * var_chaste_interface__Ito__xtos;
        ...
        const double var_x66 = 140.0 + 0.018329999999999999 * var_chaste_interface__Na__Na_i;
        const double var_x67 = 26.541413816729872 * var_x0;
        const double var_x68 = -var_x67 * log10(7.8928799999999999 / var_x66) + var_chaste_interface__cell__V;
        const double var_x69 = var_x68 * NV_Ith_S(mParameters, 1) * var_chaste_interface__IKs__xs1;
        const double var_x70 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x71 = -var_x67 * log10(136.0 * var_x70) + var_chaste_interface__cell__V;
        const double var_x72 = var_x71 * NV_Ith_S(mParameters, 4) * var_chaste_interface__INa__xh;
        const double var_x73 = var_x72 * pow(var_chaste_interface__INa__xm, 2) * var_chaste_interface__INa__xj;
        const double var_x74 = var_x34 * var_x71;
        const double var_x75 = var_x33 * var_x72;
        ...
        const double var_x78 = var_x77 * NV_Ith_S(mParameters, 3);
        const double var_x79 = 16.0 * var_x78;
        const double var_x80 = -0.040000000000000001 * var_chaste_interface__cell__V - 1.5009002576947859 * var_x0;
        ...
        const double var_x146 = var_x144 / pow(var_x145, 2);
        const double var_x147 = 0.125 * var_x146;
        const double var_x148 = var_x147 * var_chaste_interface__ICaL__c1;
        ...
        const double var_x156 = var_x155 / pow((0.037037037037037035 + var_x152), 2);
        const double var_x157 = 0.002685333333333333 * var_x156 * var_chaste_interface__ICaL__c1;
        ...
        const double var_x168 = 0.088339222614840993 * var_x166 / pow(var_x167, 2);
        const double var_x169 = var_x165 * var_x168;
        const double var_x170 = 1 / var_x167;
        const double var_x171 = -317.5641025641026 * var_x160 * var_x161;
        const double var_x172 = 0.25 * var_x158 / pow(var_x159, 2);
        const double var_x173 = 4.9382716049382717e-6 * (var_x171 + var_x163 * var_x172) / pow((1 + 0.0022222222222222222 * var_x164), 2);
        ...
        const double var_x183 = 0.00016422697956757767 / pow((0.0012815107473898831 + var_x176 + 0.012815107473898831 * var_x179), 2);
        const double var_x184 = var_x183 * (var_x171 + var_x172 * var_x178);
        const double var_x185 = var_x153 * var_x170;
        const double var_x186 = var_x184 * var_x185;
        const double var_x187 = 1.0 - var_x170;
        const double var_x188 = var_x173 * var_x187;
        const double var_x189 = var_x184 * var_x187;
        const double var_x190 = var_x168 * var_x180;
        ...
        const double var_x197 = 0.22637460951196098 * var_x151 / pow(var_x175, 2);
        const double var_x198 = var_x183 * (var_x197 - var_x160 * var_x197);
        const double var_x199 = var_x185 * var_x198;
        const double var_x200 = 0.1111111111111111 * var_x156 * var_x170 * var_x180;
        const double var_x201 = var_x187 * var_chaste_interface__ICaL__xi2ca;
        ...
        const double var_x206 = 0.1111111111111111 * var_x205;
        const double var_x207 = var_x206 * var_chaste_interface__ICaL__xi1ca;
        ...
        const double var_x212 = var_x166 * var_x209 * var_x211;
        const double var_x213 = 20.604954226274931 * var_x212;
        const double var_x214 = var_x170 * var_x213;
        const double var_x215 = var_x146 * var_x210;
        const double var_x216 = var_x167 * var_x209;
        const double var_x217 = 29.156010230179024 * var_x201 * var_x216;
        const double var_x218 = var_x144 / (pow(var_x145, 3) * pow(var_x192, 2));
        ...
        const double var_x225 = var_x206 * var_chaste_interface__ICaL__xi1ba;
        const double var_x226 = 0.16287544169611309 * var_x212;
        const double var_x227 = var_x170 * var_x226;
        const double var_x228 = var_x187 * var_x226;
        const double var_x229 = 0.23046875000000003 * var_x221;
        const double var_x230 = var_x215 * var_x229;
        const double var_x231 = var_x218 * var_x229;
        const double var_x232 = var_x167 * var_x187 * var_x205 * var_x211;
        const double var_x233 = 0.20486111111111113 * var_x232;
        const double var_x234 = 1.8437500000000002 * var_x222;
        const double var_x235 = 29.156010230179024 * var_x221;
        ...
        const double var_x250 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        ...
        const double var_x261 = ((var_x254) ? (0) : (var_x257 + var_x260 - 8.9997000000000013e-6 * var_x253 * var_x255 / pow(var_x256, 2) - 1.0641199999999999e-5 * var_x253 * var_x258 / pow(var_x259, 2)));
        const double var_x262 = ((var_x254) ? (0.0023926521499665608) : (var_x253 * var_x257 + var_x253 * var_x260));
        const double var_x263 = var_x250 * var_x262 / pow(var_x251, 2);
        ...
        const double var_x269 = exp(-0.20000000000000001 - var_x264);
        const double var_x270 = 1.0 + var_x269;
        const double var_x271 = 0.066666666666666666 * var_x269 / pow(var_x270, 2);
        const double var_x272 = 1 / var_x270;
        ...
        const double var_x277 = 0.10000000000000001 * var_x62;
        ...
        const double var_x283 = fabs(var_x77);
        ...
        const double var_x289 = var_x224 * var_x288;
        ...
        const double var_x293 = var_x224 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x294 = var_x292 * var_x293;
        const double var_x295 = Signum(var_x77);
        const double var_x296 = var_x286 * var_x295;
        const double var_x297 = var_x294 * var_x296;
        const double var_x298 = var_x100 + var_x98 - var_x94;
        ...
        const double var_x324 = (-50.0 + 50.0 * var_chaste_interface__ICaL__c1 + 50.0 * var_chaste_interface__ICaL__c2 + 50.0 * var_chaste_interface__ICaL__xi1ba + 50.0 * var_chaste_interface__ICaL__xi1ca + 50.0 * var_chaste_interface__ICaL__xi2ba + 50.0 * var_chaste_interface__ICaL__xi2ca) * NV_Ith_S(mParameters, 3);
        const double var_x325 = 50.0 * var_x323;
        const double var_x326 = var_x325 * var_x78;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x32 - var_x35 - 6.7199999999999998 * var_x50 - 1.173913043478261 * var_x56 - 0.032914599276144929 * var_x65 + var_x16 * var_chaste_interface__Ito__xtos + var_x26 * var_x27 - var_x57 * var_x60 - 0.040000000000000001 * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof - 0.30599999999999999 * var_x11 * var_x3 + 0.07298099999999999 * var_x11 * var_x36 * var_x37 + 0.0054999999999999997 * var_x36 * var_x61 * var_x62 + 0.044642857142857144 * var_x36 * var_x57 * var_x58 / pow(var_x59, 2) - 0.29411764705882354 * var_x3 * var_x36 * (0.24326999999999999 * var_x37 - var_x6 * (0.061749999999999999 * var_x8 + 0.039456396800000001 * var_x7) - 0.51429999999999998 * var_x4 * var_x9 / pow(var_x5, 2)) / pow((var_x3 + 0.98039215686274506 * var_x10), 2));
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__INa__xm) * ((var_x120) ? (var_x118 - 0.032000000000000001 * var_x116 * var_x119 / pow(var_x117, 2)) : (0)) + 0.0072727272727272727 * var_x121 * var_chaste_interface__INa__xm;
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__INa__xh) * ((var_x123) ? (-0.019852941176470591 * var_x122) : (0)) - ((var_x123) ? (0.28123999999999999 * var_x124 + 108500.0 * var_x125) : (0.693000693000693 * var_x126 / pow(var_x127, 2))) * var_chaste_interface__INa__xh;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__INa__xj) * ((var_x123) ? (var_x134 + var_x130 * var_x135 * (1.5254334000000001e-6 * var_x132 - 31073.016 * var_x131) - 0.311 * var_x128 * var_x133 * var_x135 / pow(var_x129, 2)) : (0)) - ((var_x123) ? (-0.001275024 * var_x139 + 0.016701360000000002 * var_x136 * var_x138 / pow(var_x137, 2)) : (-7.6049999999999996e-8 * var_x143 + 0.029999999999999999 * var_x140 * var_x142 / pow(var_x141, 2))) * var_chaste_interface__INa__xj;
        IJth(rJacobian, 5, 0) = var_x148 + var_x147 * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 6, 0) = -var_x148 + var_x188 * var_chaste_interface__ICaL__xi2ba + var_x189 * var_chaste_interface__ICaL__xi2ca + (-var_x147 - var_x169 - var_x174 - var_x182 - var_x186) * var_chaste_interface__ICaL__c2 - var_x169 * var_chaste_interface__ICaL__xi2ba - var_x190 * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 7, 0) = var_x207 + var_x215 * var_x217 + var_x217 * var_x218 - var_x201 * var_x213 - var_x214 * var_chaste_interface__ICaL__xi2ca - 25.91645353793691 * var_x167 * var_x201 * var_x205 * var_x211;
        IJth(rJacobian, 8, 0) = var_x225 + var_x230 * var_chaste_interface__ICaL__xi2ba + var_x231 * var_chaste_interface__ICaL__xi2ba - var_x227 * var_chaste_interface__ICaL__xi2ba - var_x228 * var_chaste_interface__ICaL__xi2ba - var_x233 * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 9, 0) = -var_x207 + var_x182 * var_chaste_interface__ICaL__c2 + var_x186 * var_chaste_interface__ICaL__c2 + (var_x190 + var_x214 - var_x189 + 25.91645353793691 * var_x232 + var_x187 * var_x213 - var_x215 * var_x235 - var_x218 * var_x235) * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 10, 0) = -var_x225 + var_x169 * var_chaste_interface__ICaL__c2 + var_x174 * var_chaste_interface__ICaL__c2 + (var_x169 + var_x227 + var_x228 + var_x233 - var_x188 - var_x230 - var_x231) * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 11, 0) = (1 / var_x237 - var_chaste_interface__IKr__xr) * (((var_x242) ? (var_x240 - 8.8449999999999995e-5 * var_x238 * var_x241 / pow(var_x239, 2)) : (0)) + ((var_x247) ? (var_x245 - 0.00016973999999999998 * var_x243 * var_x246 / pow(var_x244, 2)) : (0))) + 0.13333333333333333 * var_x236 * (var_x248 + var_x249) / pow(var_x237, 2);
        IJth(rJacobian, 12, 0) = 0.059880239520958084 * var_x263 + var_x261 * (var_x252 - var_chaste_interface__IKs__xs1);
        IJth(rJacobian, 13, 0) = 0.014970059880239521 * var_x263 + var_x261 * (0.25 * var_x252 - 0.25 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 14, 0) = var_x268 * var_x271 + 0.0074074074074074077 * var_x265 * (var_x272 - var_chaste_interface__Ito__xtos) / (pow(var_x266, 2) * pow((0.055555555555555552 + var_x267), 2));
        IJth(rJacobian, 15, 0) = -var_x276 * var_x277 + 3.3333333333333335e-5 * var_x273 * (var_x15 - var_chaste_interface__Ito__ytos) / (pow(var_x274, 2) * pow((0.01 + var_x275), 2));
        IJth(rJacobian, 16, 0) = var_x271 * var_x279 + 0.00063492063492063492 * var_x278 * (var_x272 - var_chaste_interface__Ito__xtof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x278), 2);
        IJth(rJacobian, 17, 0) = -var_x277 * var_x280 + 0.0050000000000000001 * var_x62 * (var_x15 - var_chaste_interface__Ito__ytof) / pow((1 + var_x15), 2);
        IJth(rJacobian, 19, 0) = var_x26 * var_x297 + var_x290 * pow(var_x281, 2) / pow(var_x282, 2) - var_x281 * var_x290 * var_x291;
        IJth(rJacobian, 20, 0) = -0.000125 * var_x35 - 1.2342974728554348e-5 * var_x65 - 0.0025200000000000001 * var_x50 - 0.00044021739130434783 * var_x56;
        IJth(rJacobian, 21, 0) = var_x26 * var_x306 + var_x26 * var_x313 + var_x309 * pow(var_x307, 2) / pow(var_x308, 2) - var_x307 * var_x309 * var_x310;
        IJth(rJacobian, 22, 0) = var_x323 * (42.0 * var_x50 + 0.20571624547590581 * var_x65 + var_x26 * var_x324);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-4.1580000000000007e-11 * var_x69 * var_chaste_interface__IKs__xs2 / (pow(var_x29, 2) * pow(var_chaste_interface__Ca__Ca_i_converted, 4)));
        IJth(rJacobian, 1, 1) = var_x107 * (-2539.0 + var_x92 + var_x94 - var_x100 - var_x98) + 0.001 * (0.00033600000000000004 / pow(var_x101, 3) + 5.6400000000000002e-5 / pow(var_x102, 3) + 0.0010920000000000001 / pow(var_x103, 3) + 9.0000000000000002e-6 / pow(var_x104, 3)) * (var_x111 - var_x109 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x108 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x105, 2);
        IJth(rJacobian, 19, 1) = var_x298 * var_x300;
        IJth(rJacobian, 22, 1) = 12500.0 * var_x323;
        IJth(rJacobian, 23, 1) = var_x298;
        IJth(rJacobian, 24, 1) = 2289.0 - var_x92;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x73);
        IJth(rJacobian, 2, 2) = -((var_x120) ? (var_x118 * var_x119) : (3.2000000000000002)) - 0.080000000000000002 * var_x121;
        IJth(rJacobian, 20, 2) = -0.00037500000000000001 * var_x73;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x74);
        IJth(rJacobian, 3, 3) = -((var_x123) ? (0.13500000000000001 * var_x122) : (0)) - ((var_x123) ? (310000.0 * var_x125 + 3.5600000000000001 * var_x124) : (7.6923076923076916 / var_x127));
        IJth(rJacobian, 20, 3) = -0.000125 * var_x74;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x75);
        IJth(rJacobian, 4, 4) = -((var_x123) ? (0.1212 * var_x139) : (0.29999999999999999 * var_x143)) - ((var_x123) ? (var_x134 * var_x135) : (0));
        IJth(rJacobian, 20, 4) = -0.000125 * var_x75;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79);
        IJth(rJacobian, 5, 5) = -4.3041299999999998 + var_x150 - 0.024167999999999999 * var_x153;
        IJth(rJacobian, 6, 5) = var_x192;
        IJth(rJacobian, 7, 5) = 0.0058991999999999968 * var_x153;
        ...
        IJth(rJacobian, 5, 6) = -3.0 + var_x150;
        IJth(rJacobian, 6, 6) = var_x191 - var_x193 - var_x194;
        IJth(rJacobian, 7, 6) = var_x219;
        IJth(rJacobian, 8, 6) = -0.0019499999999999999;
        IJth(rJacobian, 9, 6) = var_x194;
        IJth(rJacobian, 10, 6) = var_x193;
        IJth(rJacobian, 19, 6) = var_x301;
        IJth(rJacobian, 21, 6) = var_x314;
        IJth(rJacobian, 22, 6) = var_x326;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79);
        IJth(rJacobian, 5, 7) = -2.999896385;
        IJth(rJacobian, 7, 7) = -0.33343694833333332 + var_x208 + var_x219 - 1.8929217120000003e-7 * var_x153 * var_x220;
        IJth(rJacobian, 8, 7) = -0.0019499999999999999;
        IJth(rJacobian, 9, 7) = var_x209;
        IJth(rJacobian, 19, 7) = var_x301;
        IJth(rJacobian, 21, 7) = var_x314;
        IJth(rJacobian, 22, 7) = var_x326;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79);
        IJth(rJacobian, 5, 8) = -2.99776;
        IJth(rJacobian, 7, 8) = var_x219;
        IJth(rJacobian, 8, 8) = -0.33762909604519775 + var_x208;
        IJth(rJacobian, 10, 8) = var_x209;
        IJth(rJacobian, 19, 8) = var_x301;
        IJth(rJacobian, 21, 8) = var_x314;
        IJth(rJacobian, 22, 8) = var_x326;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79);
        IJth(rJacobian, 5, 9) = -3.0;
        IJth(rJacobian, 6, 9) = var_x195;
        IJth(rJacobian, 7, 9) = var_x219 + var_x223;
        IJth(rJacobian, 8, 9) = -0.0019499999999999999;
        IJth(rJacobian, 9, 9) = -var_x195 - var_x223;
        IJth(rJacobian, 19, 9) = var_x301;
        IJth(rJacobian, 21, 9) = var_x314;
        IJth(rJacobian, 22, 9) = var_x326;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79);
        IJth(rJacobian, 5, 10) = -3.0;
        IJth(rJacobian, 6, 10) = var_x196;
        IJth(rJacobian, 7, 10) = var_x219;
        IJth(rJacobian, 8, 10) = -0.0019499999999999999 + var_x234;
        IJth(rJacobian, 10, 10) = -var_x196 - var_x234;
        IJth(rJacobian, 19, 10) = var_x301;
        IJth(rJacobian, 21, 10) = var_x314;
        IJth(rJacobian, 22, 10) = var_x326;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x36 * var_x60 * NV_Ith_S(mParameters, 0) * NV_Ith_S(mParameters, 5));
        IJth(rJacobian, 11, 11) = -var_x248 - var_x249;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x31 * var_x68);
        IJth(rJacobian, 12, 12) = -var_x262;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x30 * var_x69);
        IJth(rJacobian, 13, 13) = -0.25 * var_x262;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x16 * var_x36);
        IJth(rJacobian, 14, 14) = -var_x268;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (var_x61 * (-0.11 * var_chaste_interface__cell__V - 4.1274757086606613 * var_x0));
        IJth(rJacobian, 15, 15) = -var_x276;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x80 * var_chaste_interface__Ito__ytof);
        IJth(rJacobian, 16, 16) = -var_x279;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x80 * var_chaste_interface__Ito__xtof);
        ...
        IJth(rJacobian, 22, 19) = var_x325;
        IJth(rJacobian, 23, 19) = -1;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (1.0436203813975009e-6 * var_x86 + 0.008152173913043478 * var_x83 - 1.173913043478261 * var_x82 - 26.541413816729872 * var_x87 - 36.287999999999997 * var_x88 + 2.4821638533707068e-5 * var_x32 * var_x66 / pow((1 + 0.00013092857142857142 * var_chaste_interface__Na__Na_i), 2));
        IJth(rJacobian, 20, 20) = 3.0570652173913045e-6 * var_x83 + 3.9135764302406278e-10 * var_x86 - 0.0033176767270912339 * var_x87 - 0.013608 * var_x88 - 0.00044021739130434783 * var_x82;
        IJth(rJacobian, 22, 20) = var_x323 * (226.80000000000001 * var_x88 - 6.52262738373438e-6 * var_x86);
        IJth(rJacobian, 5, 21) = -var_x157;
        IJth(rJacobian, 6, 21) = var_x202 + (-var_x199 - var_x200) * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 7, 21) = var_x157 + (0.00063442013684210537 * var_x153 * var_x155 - 2.1032463466666669e-8 * var_x156 * var_x220) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x156 * var_x224;
        IJth(rJacobian, 9, 21) = -var_x202 + var_x199 * var_chaste_interface__ICaL__c2 + var_x200 * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 21, 21) = -2.0;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (16903.864320000001 * var_x90 + 0.00017972853783688092 * var_x85 - 0.54431999999999992 * var_x91 + var_x27 * var_x89);
        IJth(rJacobian, 1, 22) = 0.00025000000000000001 * var_x106;
        IJth(rJacobian, 19, 22) = var_x297 * var_x89;
        IJth(rJacobian, 20, 22) = 6.3389491199999997 * var_x90 + 6.7398201688830334e-8 * var_x85 - 0.00020411999999999996 * var_x91;
        IJth(rJacobian, 21, 22) = 2.0 + var_x306 * var_x89 + var_x313 * var_x89;
        IJth(rJacobian, 22, 22) = var_x323 * (-14.789 + var_x327 + 3.4019999999999997 * var_x91 - 0.0011233033614805057 * var_x85 - 105649.152 * var_x90 + var_x324 * var_x89) + 0.0012574820180071425 * (9.0 / pow(var_x315, 3) + 56.399999999999999 / pow(var_x319, 3) + 0.97959183673469385 / pow(var_x321, 3) + 0.49704142011834318 / pow(var_x317, 3)) * (50.0 * var_chaste_interface__Irel__xir + 0.019599999999999999 * var_chaste_interface__Ca__trops + 12500.0 * var_chaste_interface__Ca__Ca_i_converted - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x328 * (70.0 - var_chaste_interface__Ca__trops) + 42.0 * var_x49 * var_x63 - 50.0 * var_x224 * var_x78) / pow((0.035460992907801421 + var_x320 + 0.15957446808510639 * var_x316 + 0.12158054711246201 * var_x322 + 0.11456628477905074 * var_x318), 2);
        IJth(rJacobian, 25, 22) = 2.2890000000000001 - var_x327;
        IJth(rJacobian, 1, 23) = var_x107 * (var_x112 + var_x113 - var_x114);
        IJth(rJacobian, 18, 23) = 0.01;
        IJth(rJacobian, 19, 23) = var_x292 * var_x305 + (var_x299 * var_x304 - 1.0 * var_x303 / var_x95) * var_chaste_interface__Irel__xir;
        IJth(rJacobian, 21, 23) = var_x305 * var_x311;
        IJth(rJacobian, 23, 23) = var_x304;
        IJth(rJacobian, 1, 24) = var_x107 * (0.019599999999999999 + var_x108);
        IJth(rJacobian, 24, 24) = -0.019599999999999999 - var_x108;
        IJth(rJacobian, 22, 25) = var_x323 * (0.019599999999999999 + var_x328);
