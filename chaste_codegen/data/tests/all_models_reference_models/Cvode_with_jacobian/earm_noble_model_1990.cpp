...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellearm_noble_model_1990FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x146 = 1.5752072268398093e-8 * var_x41;
        const double var_x147 = 3.1504144536796189e-9 * var_x32;
        ...
        IJth(rJacobian, 10, 0) = -1.009913012333318e-7 + 5.8966135352721086e-10 * var_x50 - 8.2552589493809517e-8 * var_x45 - 2.5247825308332947e-7 * var_x19 - var_x145 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x146 * var_x30;
        IJth(rJacobian, 11, 0) = -1.4307101008055338e-6 + 1.1793227070544217e-10 * var_x51 + 3.0604026121459156e-7 * var_x9 - 4.7172908282176869e-10 * var_x45 - 4.0877431451586679e-6 * var_x5 - 8.4159417694443166e-6 * var_x8 - var_x147 * var_x30;
        ...
        IJth(rJacobian, 10, 1) = 9.2011025176140482e-10 * var_x56 + 0.69280032646065615 * var_x57 + 1.7420999462749735e-9 * var_x55 - var_x146 * var_x62;
