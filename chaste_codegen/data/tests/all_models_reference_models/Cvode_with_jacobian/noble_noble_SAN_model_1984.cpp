...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 9, 1) = 4.2956369448205359e-8 * var_x74 + 4.2956369448205366e-12 * var_x76 + 2.9639894919261698e-10 * var_x73;
        ...
        IJth(rJacobian, 9, 9) = var_x175 + 6.7119327262820874e-7 * var_x99 + 1.2886910834461608e-11 * var_x102 - 1.2886910834461608e-7 * var_x103 - 0.00019125436204147007 * var_x100 - 0.00019125436204147007 * var_x104 - 1.3387805342902908e-5 * var_x80 - var_x173 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        ...
        IJth(rJacobian, 14, 13) = var_x197 + var_x198 - var_x200 + 7.1593949080342266e-8 * var_x119 - 0.00071593949080342272 * var_x115 - 7.1593949080342271e-6 * var_x112 - 7.1593949080342271e-6 * var_x113 + var_x169 * var_x194 + var_x176 * var_x78 + var_x196 * var_chaste_interface__intracellular_sodium_concentration__Nai + var_x199 * var_x30;
        ...
        IJth(rJacobian, 14, 14) = var_x175 - var_x199 + var_x16 * var_x200 - var_x16 * var_x197 - var_x16 * var_x198;
    }
