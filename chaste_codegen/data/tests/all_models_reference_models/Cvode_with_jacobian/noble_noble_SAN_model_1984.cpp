...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x237 = 0.001 * var_chaste_interface__second_inward_current_d_gate__d;
        ...
        const double var_x266 = 3.5355036582885069e-9 * var_x183;
        const double var_x267 = 0.002 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x268 = 0.19999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        ...
        const double var_x283 = 0.00071593949080342272 * var_x162;
        ...
        IJth(rJacobian, 2, 0) = -0.067000000000000004 * var_x195 * (0.0001 - 0.0001 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y) - 0.002 * ((var_x201) ? (0.5 * var_x197 + 0.5 * var_x199) : (var_x204 - 0.20000000000000001 * var_x200 * var_x202 / pow(var_x203, 2))) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        IJth(rJacobian, 3, 0) = (0.001 - var_x206) * ((var_x213) ? (0.25 * var_x208 + 0.25 * var_x210) : (var_x216 - 0.10000000000000001 * var_x211 * var_x214 / pow(var_x215, 2))) - var_x206 * ((var_x219) ? (0.088999999999999996 * var_x217 + 0.088999999999999996 * var_x218) : (var_x222 - 0.011866666666666666 * var_x211 * var_x220 / pow(var_x221, 2)));
        IJth(rJacobian, 4, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x228) ? (100.0 * var_x225 + 100.0 * var_x226) : (var_x232 - 20.0 * var_x227 * var_x230 / pow(var_x231, 2))) + 0.44800000000000001 * var_x233 * var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        IJth(rJacobian, 6, 0) = (0.001 - var_x237) * ((var_x240) ? (15.0 * var_x208 + 15.0 * var_x210) : (var_x245 - 7.5 * var_x238 * var_x243 / pow(var_x244, 2))) - var_x237 * ((var_x248) ? (5.9999999999167333 * var_x246 + 6.0000000000832667 * var_x247) : (var_x251 - 1.2 * var_x238 * var_x249 / pow(var_x250, 2)));
        IJth(rJacobian, 7, 0) = (0.001 - 0.001 * var_chaste_interface__second_inward_current_f_gate__f) * ((var_x257) ? (3.125 * var_x254 + 3.125 * var_x255) : (var_x260 - 1.5625 * var_x256 * var_x258 / pow(var_x259, 2))) - 0.012500000000000001 * var_x261 * var_chaste_interface__second_inward_current_f_gate__f / pow(var_x262, 2);
        ...
        IJth(rJacobian, 12, 0) = (0.001 - 0.001 * var_chaste_interface__intracellular_calcium_concentration__p) * ((var_x271) ? (0.3125 * var_x254 + 0.3125 * var_x255) : (var_x274 - 0.15625 * var_x270 * var_x272 / pow(var_x273, 2))) - 0.00125 * var_x275 * var_chaste_interface__intracellular_calcium_concentration__p / pow(var_x276, 2);
        ...
        IJth(rJacobian, 9, 1) = 4.2956369448205359e-8 * var_x106 + 4.2956369448205366e-12 * var_x108 + 2.9639894919261698e-10 * var_x105;
        ...
        IJth(rJacobian, 11, 1) = var_x193 * var_x268 - var_x192 * var_x268;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x97 * (-var_x110 - var_x113));
        IJth(rJacobian, 2, 2) = -0.0001 * var_x195 - 0.002 * ((var_x201) ? (var_x205 - 999999.99997124437 * (51.999999500000001 + var_chaste_interface__membrane__V) * (-var_x205 - 5.0000000001437783e-7 * var_x197)) : (var_x200 * var_x204));
        ...
        IJth(rJacobian, 4, 4) = -8.0 * var_x233 - 0.001 * ((var_x228) ? (var_x234 - 499999.99998562218 * (40.999999000000003 + var_chaste_interface__membrane__V) * (-var_x234 - 0.00020000000000575113 * var_x225)) : (var_x227 * var_x232));
        ...
        IJth(rJacobian, 7, 7) = -0.001 * ((var_x257) ? (-var_x263 + 1249999.9999640554 * (34.000000399999998 + var_chaste_interface__membrane__V) * (var_x263 + 2.5000000000718892e-6 * var_x254)) : (var_x256 * var_x260)) - 0.050000000000000003 / var_x262;
        ...
        IJth(rJacobian, 9, 9) = var_x264 + 6.7119327262820874e-7 * var_x165 + 1.2886910834461608e-11 * var_x168 - 1.2886910834461608e-7 * var_x169 - 0.00019125436204147007 * var_x166 - 0.00019125436204147007 * var_x170 - 1.3387805342902908e-5 * var_x111 - var_x265 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 13, 9) = 4.0291521463255683e-6 * var_x165 - var_x278 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 14, 9) = -4.4746218175213919e-7 * var_x165 + var_x283 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 1, 10) = 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 10, 10) = -var_x267 - 0.79999999999999993 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 11, 10) = var_x269;
        IJth(rJacobian, 1, 11) = 0.002 * var_x194;
        IJth(rJacobian, 10, 11) = var_x267;
        IJth(rJacobian, 11, 11) = -var_x269 - 0.099999999999999992 * var_x194;
        ...
        IJth(rJacobian, 12, 12) = -0.001 * ((var_x271) ? (-var_x277 + 1249999.9999640554 * (64.000000400000005 + var_chaste_interface__membrane__V) * (var_x277 + 2.5000000000718892e-7 * var_x254)) : (var_x270 * var_x274)) - 0.0050000000000000001 / var_x276;
        ...
        IJth(rJacobian, 9, 13) = 2.2950523444976409e-5 * var_x182 + 0.0010739092362051341 * var_x181 - 7.1593949080342271e-6 * var_x180 + var_x112 * var_x266 - var_x265 * var_chaste_interface__intracellular_sodium_concentration__Nai;
        IJth(rJacobian, 13, 13) = -0.001 + var_x282 - var_x279 - var_x280 + 6.4466434341209093e-5 * var_x172 + 6.4466434341209093e-5 * var_x178 + 6.4466434341209093e-5 * var_x179 + 0.0064466434341209095 * var_x181 - 6.4466434341209093e-7 * var_x185 - var_x278 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x281 * var_x88 - 3.1835276217881036e-8 * var_x109 * var_x183;
        IJth(rJacobian, 14, 13) = var_x284 + var_x285 - var_x287 + 7.1593949080342266e-8 * var_x185 - 0.00071593949080342272 * var_x181 - 7.1593949080342271e-6 * var_x172 - 7.1593949080342271e-6 * var_x178 - 7.1593949080342271e-6 * var_x179 + var_x109 * var_x266 + var_x283 * var_chaste_interface__intracellular_sodium_concentration__Nai + var_x286 * var_x88;
        ...
        IJth(rJacobian, 13, 14) = var_x281 + 6.4466434341209093e-5 * var_x157 + var_x279 * var_x75 + var_x280 * var_x75 - var_x282 * var_x75;
        IJth(rJacobian, 14, 14) = var_x264 - var_x286 + var_x287 * var_x75 - var_x284 * var_x75 - var_x285 * var_x75;
    }
