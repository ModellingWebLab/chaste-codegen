...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x72 = 26.713760659695652 * var_x3;
        const double var_x73 = -var_x72 * log10(140.0 * var_x71) + var_chaste_interface__membrane__V;
        const double var_x74 = 6.0 * var_x73;
        const double var_x75 = var_x12 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x76 = 6.0 * var_x29;
        ...
        const double var_x78 = 140.0 + 0.12 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x79 = -var_x72 * log10(var_x77 * var_x78) + var_chaste_interface__membrane__V;
        ...
        const double var_x81 = var_x0 * var_x79;
        const double var_x82 = var_x33 * var_x52;
        const double var_x83 = var_x45 * var_x47;
        const double var_x84 = var_x52 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x85 = var_x84 * var_chaste_interface__second_inward_current_f2_gate__f2;
        const double var_x86 = var_x84 * var_chaste_interface__second_inward_current_f_gate__f;
        ...
        const double var_x91 = 50.0 * var_x90;
        ...
        const double var_x98 = 160.28256395817391 * var_x13;
        ...
        const double var_x102 = 20.035320494771739 * var_x10;
        const double var_x103 = 0.14285714285714285 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x104 = var_x1 / var_x78;
        ...
        const double var_x108 = 0.0029629629629629628 * var_x107;
        const double var_x109 = var_x73 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x110 = var_x29 * var_x31;
        const double var_x111 = 1.5 * var_x110;
        const double var_x112 = 4.0200601101640967e-6 * var_x40;
        ...
        const double var_x144 = 0.001 * var_chaste_interface__second_inward_current_d_gate__d;
        ...
        const double var_x162 = -4.2956369448205359e-5 * var_x14;
        const double var_x163 = 2.0100300550820484e-8 * var_x44;
        const double var_x164 = 7.5243245632378463e-10 * var_x59;
        const double var_x165 = 4.2956369448205359e-5 * var_x73;
        const double var_x166 = var_x163 * var_x47;
        ...
        const double var_x170 = 2.1213021949731043e-8 * var_x107;
        const double var_x171 = 0.002 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x172 = 0.19999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x173 = 0.0050000000000000001 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x174 = 1.0 - var_chaste_interface__intracellular_calcium_concentration__p;
        ...
        const double var_x184 = var_x182 * var_x50;
        ...
        const double var_x190 = 5.3695461810256699e-6 * var_x10;
        const double var_x191 = 4.2956369448205359e-5 * var_x29;
        const double var_x192 = var_x163 * var_x50;
        const double var_x193 = 0.00071593949080342272 * var_x90;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * (-0.080000000000000002 + 0.084077770927753662 * var_x58 + 0.056150836234118207 * var_x32 - 12.0 * var_x14 - 1.25 * var_x1 - 0.002 * var_x24 - 0.16815554185550732 * var_x55 - 0.00010509721365969207 * var_x62 - 0.01471360991235689 * var_x57 - 0.0053476986889636384 * var_x28 + var_x48 * var_x60 + var_x60 * var_x61 - var_x11 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x34 * var_x41 - var_x34 * var_x51 - var_x45 * var_x48));
        IJth(rJacobian, 1, 0) = -3.5796974540171133e-8 + 3.0097298252951385e-7 * var_x58 + 1.4318789816068453e-8 * var_x24 - 6.019459650590277e-7 * var_x55 - var_x112 * var_x34;
        IJth(rJacobian, 2, 0) = -0.067000000000000004 * var_x120 * (0.0001 - 0.0001 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y) - 0.002 * ((var_x122) ? (0) : (var_x125 - 0.20000000000000001 * var_x121 * var_x123 / pow(var_x124, 2))) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        IJth(rJacobian, 3, 0) = (0.001 - var_x126) * ((var_x128) ? (0) : (var_x131 - 0.10000000000000001 * var_x127 * var_x129 / pow(var_x130, 2))) - var_x126 * ((var_x128) ? (0) : (var_x134 - 0.011866666666666666 * var_x127 * var_x132 / pow(var_x133, 2)));
        IJth(rJacobian, 4, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x136) ? (0) : (var_x140 - 20.0 * var_x135 * var_x138 / pow(var_x139, 2))) + 0.44800000000000001 * var_x141 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 5, 0) = -0.125 * var_x142 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x143 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x143), 2);
        IJth(rJacobian, 6, 0) = (0.001 - var_x144) * ((var_x146) ? (0) : (var_x151 - 7.5 * var_x145 * var_x149 / pow(var_x150, 2))) - var_x144 * ((var_x146) ? (0) : (var_x154 - 1.2 * var_x145 * var_x152 / pow(var_x153, 2)));
        IJth(rJacobian, 7, 0) = (0.001 - 0.001 * var_chaste_interface__second_inward_current_f_gate__f) * ((var_x156) ? (0) : (var_x159 - 1.5625 * var_x155 * var_x157 / pow(var_x158, 2))) - 0.012500000000000001 * var_x160 * var_chaste_interface__second_inward_current_f_gate__f / pow(var_x161, 2);
        IJth(rJacobian, 9, 0) = -5.0115764356239594e-7 + var_x162 - 4.2956369448205359e-8 * var_x24 - 8.9492436350427826e-6 * var_x1 - 1.0534054388532985e-7 * var_x57 + var_x164 * var_x48 - var_x163 * var_x48;
        IJth(rJacobian, 12, 0) = var_x174 * var_x177 - 0.00125 * var_x178 * var_chaste_interface__intracellular_calcium_concentration__p / pow(var_x179, 2) - 0.00015625 * var_x174 * var_x175 * var_x180 / pow(var_x176, 2);
        IJth(rJacobian, 13, 0) = 6.7752426238365633e-9 * var_x62 + 3.4474706640864439e-7 * var_x28 + 0.00038679860604725458 * var_x14 - 3.6198441972907658e-6 * var_x32 + var_x181 * var_chaste_interface__extracellular_potassium_concentration__Kc + var_x182 * var_x61 - 6.7752426238365633e-9 * var_x59 * var_x61;
        IJth(rJacobian, 14, 0) = var_x162 + 4.0200601101640964e-7 * var_x32 - 3.8286286763467583e-8 * var_x28 - 7.5243245632378463e-10 * var_x62 + var_x164 * var_x61 - var_x163 * var_x61 - var_x190 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * (5488.0 * var_x66 + 1.38e-5 * var_x68 + 7.288629737609329e-6 * var_x69 - 1.1230167246823641 * var_x70 - 0.13356880329847826 * var_x65));
        IJth(rJacobian, 1, 1) = -0.19999999999999998 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 9.8799649730872331e-11 * var_x68 - 4.7813590510367518e-7 * var_x65 - 4.0200601101640967e-6 * var_x70 - 0.039290759255291838 * var_x66 - 5.2182178629987073e-11 * var_x69 + var_x113 * var_x117 - var_x113 * var_x118;
        IJth(rJacobian, 8, 1) = -20.0 * var_chaste_interface__second_inward_current_f2_gate__f2;
        IJth(rJacobian, 9, 1) = 1.5654653588996123e-10 * var_x69 + 2.9639894919261698e-10 * var_x68 + 0.11787227776587551 * var_x66;
        ...
        IJth(rJacobian, 11, 1) = var_x118 * var_x172 - var_x117 * var_x172;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * (-var_x74 * var_x75 - var_x75 * var_x76));
        IJth(rJacobian, 2, 2) = -0.0001 * var_x120 - 0.002 * ((var_x122) ? (2.5) : (var_x121 * var_x125));
        IJth(rJacobian, 9, 2) = -var_x165 * var_x75;
        IJth(rJacobian, 13, 2) = var_x183 * var_x75;
        IJth(rJacobian, 14, 2) = -var_x191 * var_x75;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * (0.14285714285714285 * var_x27 - 0.14285714285714285 * var_chaste_interface__intracellular_potassium_concentration__Ki));
        IJth(rJacobian, 3, 3) = -0.001 * ((var_x128) ? (2.5) : (var_x127 * var_x131)) - 0.001 * ((var_x128) ? (2.5) : (var_x127 * var_x134));
        IJth(rJacobian, 13, 3) = 9.2094906201727277e-6 * var_chaste_interface__intracellular_potassium_concentration__Ki - 9.2094906201727277e-6 * var_x27;
        IJth(rJacobian, 14, 3) = 1.0227707011477466e-6 * var_x27 - 1.0227707011477466e-6 * var_chaste_interface__intracellular_potassium_concentration__Ki;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0037499999999999999 * var_x63 * var_x80);
        IJth(rJacobian, 4, 4) = -8.0 * var_x141 - 0.001 * ((var_x136) ? (2000.0) : (var_x135 * var_x140));
        IJth(rJacobian, 9, 4) = -2.6847730905128351e-5 * var_x80;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00125 * var_x63 * var_x81);
        IJth(rJacobian, 5, 5) = -2.0 / (1.0 + 320.0 * var_x143) - 0.02 * var_x142;
        IJth(rJacobian, 9, 5) = -8.9492436350427826e-6 * var_x81;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * (-var_x41 * var_x82 - var_x51 * var_x82 - var_x82 * var_x83));
        IJth(rJacobian, 1, 6) = -var_x112 * var_x82;
        IJth(rJacobian, 6, 6) = -0.001 * ((var_x146) ? (120.0) : (var_x145 * var_x151)) - 0.001 * ((var_x146) ? (120.0) : (var_x145 * var_x154));
        IJth(rJacobian, 9, 6) = -var_x166 * var_x82;
        IJth(rJacobian, 13, 6) = var_x184 * var_x82;
        IJth(rJacobian, 14, 6) = -var_x192 * var_x82;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * (-var_x41 * var_x85 - var_x51 * var_x85 - var_x83 * var_x85));
        IJth(rJacobian, 1, 7) = -var_x112 * var_x85;
        IJth(rJacobian, 7, 7) = -0.001 * ((var_x156) ? (25.0) : (var_x155 * var_x159)) - 0.050000000000000003 / var_x161;
        IJth(rJacobian, 9, 7) = -var_x166 * var_x85;
        IJth(rJacobian, 13, 7) = var_x184 * var_x85;
        IJth(rJacobian, 14, 7) = -var_x192 * var_x85;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * (-var_x41 * var_x86 - var_x51 * var_x86 - var_x83 * var_x86));
        IJth(rJacobian, 1, 8) = -var_x112 * var_x86;
        IJth(rJacobian, 8, 8) = -0.01 - 20.0 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 9, 8) = -var_x166 * var_x86;
        IJth(rJacobian, 13, 8) = var_x184 * var_x86;
        IJth(rJacobian, 14, 8) = -var_x192 * var_x86;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * (var_x101 + 0.03125 * var_x94 + 1.5937237035588913e-11 * var_x96 - 0.012 * var_x97 - 33.392200824619565 * var_x92 - 1.8699632461786957 * var_x71 - var_x91 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x98 * var_x99));
        IJth(rJacobian, 1, 9) = 8.5912738896410719e-8 * var_x97 - 1.1410097368072975e-16 * var_x96;
        IJth(rJacobian, 9, 9) = var_x169 + 6.7119327262820874e-7 * var_x94 + 3.4230292104218926e-16 * var_x96 - 2.5773821668923216e-7 * var_x97 - 1.3387805342902908e-5 * var_x71 - 0.0002390679525518376 * var_x92 - var_x167 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x168 * var_x99;
        IJth(rJacobian, 13, 9) = 4.0291521463255683e-6 * var_x94 - var_x185 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 14, 9) = -4.4746218175213919e-7 * var_x94 + var_x193 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 1, 10) = 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 10, 10) = -var_x171 - 0.79999999999999993 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 11, 10) = var_x173;
        IJth(rJacobian, 1, 11) = 0.002 * var_x119;
        IJth(rJacobian, 10, 11) = var_x171;
        IJth(rJacobian, 11, 11) = -var_x173 - 0.099999999999999992 * var_x119;
        ...
        IJth(rJacobian, 12, 12) = -0.0050000000000000001 / var_x179 - var_x177 * var_x180;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * (var_x102 + var_x98 - var_x111 + 50.0 * var_x105 + 4.0070640989543476 * var_x104 + 0.0074999999999999997 * var_x106 + var_x103 * var_x26 + var_x108 * var_x109 + var_x108 * var_x30 + var_x45 * var_x56 - var_x11 * var_x29 - var_x13 * var_x74 - var_x13 * var_x76 - var_x91 * var_chaste_interface__intracellular_sodium_concentration__Nai));
        IJth(rJacobian, 9, 13) = 0.0010739092362051341 * var_x105 + 2.8688154306220512e-5 * var_x104 + var_x109 * var_x170 - var_x13 * var_x165 - var_x167 * var_chaste_interface__intracellular_sodium_concentration__Nai;
        IJth(rJacobian, 13, 13) = -0.001 + var_x189 - var_x187 - var_x188 + 0.0064466434341209095 * var_x105 - 4.8349825755906825e-7 * var_x106 + var_x13 * var_x183 + var_x181 * var_x29 - var_x182 * var_x56 - var_x185 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x186 * var_x26 - 1.9101165730728621e-7 * var_x107 * var_x30;
        IJth(rJacobian, 14, 13) = var_x168 + var_x195 - var_x196 + 5.3695461810256699e-8 * var_x106 - 0.00071593949080342272 * var_x105 + var_x163 * var_x56 + var_x170 * var_x30 + var_x193 * var_chaste_interface__intracellular_sodium_concentration__Nai + var_x194 * var_x26 - var_x13 * var_x191 - var_x190 * var_x29;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * (var_x101 - var_x103 - 4.0070640989543476 * var_x92 + var_x111 * var_x4 - var_x102 * var_x4 - var_x4 * var_x98));
        IJth(rJacobian, 9, 14) = -2.8688154306220512e-5 * var_x92;
        IJth(rJacobian, 13, 14) = var_x186 + var_x100 * var_x182 + var_x187 * var_x4 + var_x188 * var_x4 - var_x189 * var_x4;
        IJth(rJacobian, 14, 14) = var_x169 - var_x194 + var_x196 * var_x4 - var_x168 * var_x4 - var_x195 * var_x4;
    }
