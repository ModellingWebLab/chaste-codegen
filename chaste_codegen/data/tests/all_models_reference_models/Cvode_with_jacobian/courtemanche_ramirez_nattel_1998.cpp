...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellcourtemanche_ramirez_nattel_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 9, 0) = (1 / var_x193 - var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr) * (((var_x199) ? (0.00014999999999999999 * var_x194 + 0.00014999999999999999 * var_x197) : (var_x203 - 5.9999999999999995e-5 * var_x198 * var_x201 / pow(var_x202, 2))) + ((var_x207) ? (3.6949000016012502e-5 * var_x204 + 3.6948999983987501e-5 * var_x205) : (var_x210 - 1.4422780412592461e-5 * var_x206 * var_x208 / pow(var_x209, 2)))) + 0.15384615384615385 * var_x192 * (var_x212 + var_x214) / pow(var_x193, 2);
        IJth(rJacobian, 10, 0) = (pow(var_x216, (-0.5)) - var_chaste_interface__slow_delayed_rectifier_K_current_xs_gate__xs) * (2.0 * ((var_x221) ? (1.7499999999999998e-5 * var_x217 + 1.7499999999999998e-5 * var_x218) : (var_x224 - 3.8888888888888887e-6 * var_x219 * var_x222 / pow(var_x223, 2))) + 2.0 * ((var_x227) ? (1.9999999979101686e-5 * var_x225 + 2.0000000020898317e-5 * var_x226) : (var_x231 - 2.3529411764705885e-6 * var_x219 * var_x229 / pow(var_x230, 2)))) + 0.03937007874015748 * var_x215 * pow(var_x216, (-1.5)) * (var_x233 + var_x235);
        IJth(rJacobian, 11, 0) = (1 / var_x237 - var_chaste_interface__L_type_Ca_channel_d_gate__d) * ((var_x245) ? (4.7698560017679535e-16 * (-36688738598216.805 * var_x239 - 36688738598216.805 * var_x242) / pow((-var_x239 + 0.017500000000000002 * var_x243), 2)) : (var_x250 - var_x248 * var_x251 - var_x249 * var_x251 / pow(var_x247, 2))) + 0.125 * var_x236 * var_x252 / pow(var_x237, 2);
        ...
        IJth(rJacobian, 16, 0) = (1.0 - 1 / var_x285 - var_chaste_interface__Ca_release_current_from_JSR_w_gate__w) * ((var_x292) ? (6.9444444340499934e-15 * (-12000000007303.471 * var_x287 - 11999999985987.188 * var_x288) / pow((-var_x287 + 0.083333333259318465 * var_x290), 2)) : (var_x297 - 0.01 * var_x295 * var_x298 - 0.033333333333333333 * var_x296 * var_x298 / pow(var_x294, 2))) - 0.058823529411764705 * var_x284 * var_x299 / pow(var_x285, 2);
