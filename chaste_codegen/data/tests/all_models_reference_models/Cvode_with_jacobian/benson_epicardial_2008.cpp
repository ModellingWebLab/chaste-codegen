...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbenson_epicardial_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x60 = exp(0.0033333333333333335 * var_chaste_interface__cell__V);
        ...
        const double var_x211 = var_chaste_interface__cell__V >= -40.0;
        const double var_x212 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x213 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x214 = 1.0 + var_x213;
        const double var_x215 = exp(0.079000000000000001 * var_chaste_interface__cell__V);
        const double var_x216 = exp(0.34999999999999998 * var_chaste_interface__cell__V);
        ...
        const double var_x222 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        ...
        const double var_x227 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
        const double var_x228 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x229 = -127140.0 * var_x227 - 3.4740000000000003e-5 * var_x228;
        const double var_x230 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V);
        const double var_x231 = 1.0 + var_x230;
        const double var_x232 = 1 / var_x231;
        const double var_x233 = var_x229 * var_x232;
        const double var_x234 = 37.780000000000001 + var_chaste_interface__cell__V;
        const double var_x235 = exp(-3.2000000000000002 + var_x218);
        const double var_x236 = 1.0 + var_x235;
        const double var_x237 = exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V);
        ...
        const double var_x243 = exp(1.7160000000000002 + 0.13200000000000001 * var_chaste_interface__cell__V);
        const double var_x244 = 1.0 + var_x243;
        const double var_x245 = exp(0.67599999999999993 + 0.051999999999999998 * var_chaste_interface__cell__V);
        const double var_x246 = var_x245 / var_x244;
        const double var_x247 = exp(0.59347181008902072 - 0.14836795252225518 * var_chaste_interface__cell__V);
        const double var_x248 = 1.0 + var_x247;
        const double var_x249 = 1 / (0.58999999999999997 + 0.80000000000000004 * var_x246);
        const double var_x250 = exp(-19.117647058823529 - 0.29411764705882354 * var_chaste_interface__cell__V);
        const double var_x251 = exp(2.4457142857142857 + 0.14285714285714285 * var_chaste_interface__cell__V);
        const double var_x252 = 1.0 + var_x251;
        const double var_x253 = 1 / var_x252;
        const double var_x254 = 0.24110000000000001 * exp(-0.19019454876899997 * pow((-1 + 0.10318426646304972 * var_chaste_interface__cell__V), 2));
        const double var_x255 = var_x251 / pow(var_x252, 2);
        const double var_x256 = var_x110 * var_chaste_interface__ICaL__fca;
        const double var_x257 = 21634.953105810167 * var_x118;
        const double var_x258 = 1 / (1.0 + 333.33333333333331 * var_chaste_interface__Ca__Ca_ss);
        const double var_x259 = 10.0 * var_x187;
        const double var_x260 = 1 / (0.5 + var_x259 + var_x258);
        const double var_x261 = var_x148 * var_chaste_interface__ICaL__fca;
        const double var_x262 = -var_x261;
        const double var_x263 = pow((3.4606854310903424e-6 + var_x262), (-2));
        const double var_x264 = var_x260 * var_x263;
        const double var_x265 = 1.0382056293271026e-6 * var_x264;
        const double var_x266 = var_x144 * var_x261;
        const double var_x267 = var_x145 * var_x261;
        const double var_x268 = var_x146 * var_chaste_interface__ICaL__fca;
        const double var_x269 = var_x268 * var_chaste_interface__ICaL__fca2;
        const double var_x270 = 1.0382056293271026e-6 * var_x263;
        const double var_x271 = var_x268 * var_chaste_interface__ICaL__f;
        const double var_x272 = var_x109 * var_x117;
        const double var_x273 = -10.0 * var_x199 - 10.0 * var_x201;
        const double var_x274 = 0.01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x258 + 0.29999999999999999 / (1.0 - 288960.09762000659 * var_x261)) / pow((0.050000000000000003 + var_x187 + 0.10000000000000001 * var_x258), 2);
        const double var_x275 = pow((0.0030000000000000001 + var_chaste_interface__Ca__Ca_ss), (-2));
        const double var_x276 = var_x117 * var_x172;
        const double var_x277 = 0.00075000000000000002 * var_x208 - 0.00075000000000000002 * var_x207;
        const double var_x278 = 108174.76552905084 * var_x118;
        const double var_x279 = exp(-4.375 - 361200.12202500831 * var_x261);
        const double var_x280 = 1.0 + var_x279;
        const double var_x281 = 1 / var_x280;
        const double var_x282 = 1 / (125.0 + 300.0 * var_x281);
        const double var_x283 = pow((6.9213708621806839e-7 + var_x262), (-2));
        const double var_x284 = var_x282 * var_x283;
        const double var_x285 = 27043.69138226271 * var_x118;
        const double var_x286 = var_x279 * (-var_chaste_interface__ICaL__fca2 + 1 / (1.0 - 1444800.4881000333 * var_x261)) / (pow(var_x280, 2) * pow((0.41666666666666669 + var_x281), 2));
        const double var_x287 = 6.9213708621806839e-7 * var_x284;
        const double var_x288 = 1204.0004067500277 * var_x286;
        const double var_x289 = 0.042299999999999997 * exp(-1.20074125971556 * pow((-1 + 0.053842757610673787 * var_chaste_interface__cell__V), 2));
        const double var_x290 = exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__cell__V);
        const double var_x291 = 1.0 + var_x290;
        const double var_x292 = exp(5.8385137599999997 + 0.1522 * var_chaste_interface__cell__V);
        const double var_x293 = -1.0 + var_x292;
        const double var_x294 = 0.00029999999999999997 / var_x293;
        const double var_x295 = exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__cell__V);
        const double var_x296 = 1.0 - var_x295;
        const double var_x297 = 0.00059999999999999995 / var_x296;
        const double var_x298 = -1.7383999999999999 + var_chaste_interface__cell__V;
        const double var_x299 = 38.360799999999998 + var_chaste_interface__cell__V;
        const double var_x300 = var_x294 * var_x299;
        const double var_x301 = var_x297 * var_x298;
        const double var_x302 = exp(0.4251012145748988 - 0.04048582995951417 * var_chaste_interface__cell__V);
        const double var_x303 = 1.0 + var_x302;
        const double var_x304 = 1 / var_x303;
        const double var_x305 = exp(-444.66200000000003 - 9.9700000000000006 * var_chaste_interface__cell__V);
        const double var_x306 = 1.0 - var_x305;
        const double var_x307 = 1 / var_x306;
        const double var_x308 = 7.6100000000000007e-5 * var_x307;
        const double var_x309 = exp(-0.070400000000000004 + 0.128 * var_chaste_interface__cell__V);
        const double var_x310 = -1.0 + var_x309;
        const double var_x311 = 1 / var_x310;
        const double var_x312 = 0.00036000000000000002 * var_x311;
        const double var_x313 = -0.55000000000000004 + var_chaste_interface__cell__V;
        const double var_x314 = 44.600000000000001 + var_chaste_interface__cell__V;
        const double var_x315 = var_x308 + var_x312 - 4.6080000000000006e-5 * var_x309 * var_x313 / pow(var_x310, 2) - 0.00075871700000000012 * var_x305 * var_x314 / pow(var_x306, 2);
        const double var_x316 = var_x308 * var_x314;
        const double var_x317 = var_x312 * var_x313;
        const double var_x318 = var_x302 * (var_x316 + var_x317) / pow(var_x303, 2);
        const double var_x319 = 0.040000000000000001 * var_chaste_interface__cell__V;
        const double var_x320 = exp(-1.6000000000000001 + var_x319);
        const double var_x321 = 1.0 + var_x320;
        const double var_x322 = var_x320 / var_x321;
        const double var_x323 = 1.0 - var_chaste_interface__Ito__ydv;
        const double var_x324 = exp(-3.6000000000000001 - var_x319);
        const double var_x325 = 1.0 + var_x324;
        const double var_x326 = var_x324 / var_x325;
        const double var_x327 = var_chaste_interface__Ito__ydv;
        const double var_x328 = 0.040000000000000001 * var_chaste_interface__Ito__ydv2;
        const double var_x329 = 0.20000000000000001 * var_chaste_interface__cell__V;
        const double var_x330 = exp(5.0 + var_x329);
        const double var_x331 = 1.0 + var_x330;
        const double var_x332 = pow(var_x330, 2) / pow(var_x331, 2);
        const double var_x333 = var_x330 / var_x331;
        const double var_x334 = exp(12.0 + var_x329);
        const double var_x335 = 1.0 + var_x334;
        const double var_x336 = 0.02 * var_chaste_interface__Ito__zdv;
        const double var_x337 = exp(12.6 + var_x329);
        const double var_x338 = 1.0 + var_x337;
        const double var_x339 = 1.0 - var_chaste_interface__INal__mL;
        const double var_x340 = exp(14.918032786885247 + 0.16393442622950821 * var_chaste_interface__cell__V);
        const double var_x341 = 0.0025000000000000005 * var_x182;
        const double var_x342 = -1 + 0.066666666666666666 * var_chaste_interface__cell__V;
        const double var_x343 = pow(var_x106, (-2));
        const double var_x344 = pow(var_chaste_interface__ICaL__d, (-2 * var_chaste_interface__ICaL__dp));
        const double var_x345 = pow(var_chaste_interface__ICaL__f, (-2));
        const double var_x346 = pow(var_chaste_interface__ICaL__f2, (-2));
        const double var_x347 = pow(var_chaste_interface__ICaL__fca, (-2));
        const double var_x348 = pow(var_chaste_interface__ICaL__fca2, (-2));
        const double var_x349 = pow(NV_Ith_S(mParameters, 4), (-2));
        const double var_x350 = var_x113 * var_x343 * var_x344 * var_x345 * var_x346 * var_x347 * var_x348 * var_x349;
        const double var_x351 = pow(var_x342, (-2));
        const double var_x352 = var_x343 * var_x344 * var_x346 * var_x347 * var_x348 * var_x349 * var_x351;
        const double var_x353 = 3.1882311526515621e-12 * var_x345;
        const double var_x354 = var_x113 * var_x344 * var_x346 * var_x348 * var_x349 * var_x351;
        const double var_x355 = var_x347 * var_x354 / pow(var_x106, 3);
        const double var_x356 = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999);
        const double var_x357 = 0.0028 + var_chaste_interface__Ca__Ca_ss;
        const double var_x358 = 1 / var_x357;
        const double var_x359 = pow((var_x358 * var_chaste_interface__Ca__Ca_ss), 1.8999999999999999);
        const double var_x360 = 1 / (var_x356 + 1644.6531773416521 * var_x359);
        const double var_x361 = var_x350 * var_x351;
        const double var_x362 = 1.0 + 2.1291277605263905e-11 * var_x361;
        const double var_x363 = var_x356 * var_x360 / pow(var_x362, 2);
        const double var_x364 = 1.4194185070175937e-11 * var_x363;
        const double var_x365 = var_x361 * var_x364;
        const double var_x366 = var_x113 * var_x364;
        const double var_x367 = var_x343 * var_x345;
        const double var_x368 = var_x344 * var_x347 * var_x349 * var_x351 * var_x366 * var_x367;
        const double var_x369 = 1 / var_x362;
        const double var_x370 = var_x369 / pow((var_x359 + 0.00060803092942449902 * var_x356), 2);
        const double var_x371 = exp(3.3333333333333335 + 963200.32540002221 * var_x261);
        const double var_x372 = 1.0 + var_x371;
        const double var_x373 = 1 / var_x372;
        const double var_x374 = exp(-16.0 + 80.0 * var_x373 + 40000.0 * var_chaste_interface__Ca__Ca_ss);
        const double var_x375 = 1.0 + var_x374;
        const double var_x376 = exp(-15.0 + 5000.0 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_x373);
        const double var_x377 = 1.0 + var_x376;
        const double var_x378 = 1 / var_x377;
        const double var_x379 = 350.0 - var_x259;
        const double var_x380 = var_x378 * var_x379;
        const double var_x381 = 1 / (3.0 + var_x259 + var_x380);
        const double var_x382 = var_x374 * var_x381 / pow(var_x375, 2);
        const double var_x383 = 72116.51035270057 * var_x118;
        const double var_x384 = var_x371 / pow(var_x372, 2);
        const double var_x385 = var_x384 * (963200.32540002221 * var_x256 + var_x120 * var_x383 - var_x114 * var_x383);
        const double var_x386 = (-var_chaste_interface__Irel__ri + 1 / var_x375) / pow((0.29999999999999999 + var_x187 + 0.10000000000000001 * var_x380), 2);
        const double var_x387 = var_x376 * var_x379 / pow(var_x377, 2);
        const double var_x388 = var_x386 * var_x387;
        const double var_x389 = 77056026.032001764 * var_x382;
        const double var_x390 = var_x384 * var_x389;
        const double var_x391 = 144480.04881000333 * var_x388;
        const double var_x392 = var_x384 * var_x391;
        const double var_x393 = var_x269 * var_x384;
        const double var_x394 = 0.01 * var_x386;
        const double var_x395 = var_x276 * var_x384;
        const double var_x396 = 3.998848287353967e-7 * var_x3;
        const double var_x397 = 1.827729786302835e-16 * var_x129;
        const double var_x398 = log(100.0 * var_x170);
        const double var_x399 = var_x137 + var_x398;
        const double var_x400 = pow(var_x399, 4);
        const double var_x401 = 2.8839711417381356e-9 * pow(var_x399, 7) / pow((1 + 0.008558014922736952 * var_x400), 2);
        const double var_x402 = 20.048989239405216 * pow(var_x399, 3) / (59494197.640692554 + 509152.23122530844 * var_x400);
        const double var_x403 = var_x136 * var_x401 - var_x136 * var_x402;
        const double var_x404 = var_x170 * var_x401 - var_x170 * var_x402;
        const double var_x405 = -6.1520742882368733e-5 - 3.6912445729421236e-5 * var_x28;
        const double var_x406 = var_x30 * var_x405;
        const double var_x407 = var_x406 * var_chaste_interface__IKs__xs1;
        const double var_x408 = 2.6474312514413617e-5 * var_x44;
        const double var_x409 = 2.595520834746433e-5 * var_x98;
        const double var_x410 = var_x132 * var_x407;
        const double var_x411 = var_x22 + 26.712338705500134 * var_x398;
        const double var_x412 = 0.00018900582374463672 / (87.825100000000006 + var_x411);
        const double var_x413 = 2.4504050574883893e-8 * var_x411 / pow((1 + 0.30415380916731244 * var_x21 + 0.30415380916731244 * var_x398), 2);
        const double var_x414 = var_x20 * var_x413 - var_x20 * var_x412;
        const double var_x415 = var_x170 * var_x413 - var_x170 * var_x412;
        const double var_x416 = 8.8885199344722979e-8 * var_x18;
        const double var_x417 = -var_chaste_interface__Ca__Ca_ss + var_chaste_interface__Ca__Ca_jsr;
        const double var_x418 = 0.80000000000000004 + var_chaste_interface__Ca__Ca_jsr;
        const double var_x419 = pow(var_x418, (-2));
        const double var_x420 = 1 / (1.0 + 8.0 * var_x419);
        const double var_x421 = var_x420;
        const double var_x422 = var_x417 * var_x421;
        const double var_x423 = 2889.6009762000663 * var_x109;
        const double var_x424 = 216.34953105810169 * var_x115;
        const double var_x425 = exp(2.6000000000000001 + var_x115 * var_x423);
        const double var_x426 = 1.0 + var_x425;
        const double var_x427 = NV_Ith_S(mParameters, 0) * var_chaste_interface__Irel__ro;
        const double var_x428 = var_x425 * var_x427 * var_chaste_interface__Irel__ri / pow(var_x426, 2);
        const double var_x429 = var_x428 * (var_x423 + var_x120 * var_x424 - var_x114 * var_x424);
        const double var_x430 = 1 / var_x426;
        const double var_x431 = var_x430 * NV_Ith_S(mParameters, 0) * var_chaste_interface__Irel__ri;
        const double var_x432 = var_x427 * var_x430;
        const double var_x433 = var_x431 * var_chaste_interface__Irel__ro;
        const double var_x434 = var_x433;
        const double var_x435 = var_x115 * var_x171 * var_x417 * var_x428;
        const double var_x436 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x437 = var_x194 * var_x436;
        const double var_x438 = var_x189 * var_x436;
        const double var_x439 = 0.23999999999999996 * var_x417;
        const double var_x440 = 1.1313486292004544 * var_x118;
        const double var_x441 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss;
        const double var_x442 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x443 = 1.0 + 0.0097788000000000007 / pow(var_x441, 2) + 4.0890000000000003e-5 / pow(var_x442, 2);
        const double var_x444 = 1 / var_x443;
        const double var_x445 = var_x444;
        const double var_x446 = 15.110483888602907 * var_x444;
        const double var_x447 = var_x439 * var_x444;
        const double var_x448 = 0.23999999999999996 * var_x433;
        ...
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__INa__H) * ((var_x211) ? (0) : (-0.019852941176470591 * var_x212)) - ((var_x211) ? (0.693000693000693 * var_x213 / pow(var_x214, 2)) : (0.28123999999999999 * var_x215 + 108500.0 * var_x216)) * var_chaste_interface__INa__H;
        IJth(rJacobian, 3, 0) = var_x217 * var_x221 + var_x223 * var_chaste_interface__INa__m - var_x217 * var_x225;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__INa__J) * ((var_x211) ? (0) : (var_x233 + var_x232 * var_x234 * (1.5254334000000001e-6 * var_x228 - 31073.016 * var_x227) - 0.311 * var_x229 * var_x230 * var_x234 / pow(var_x231, 2))) - ((var_x211) ? (-7.6049999999999996e-8 * var_x238 + 0.029999999999999999 * var_x235 * var_x237 / pow(var_x236, 2)) : (-0.001275024 * var_x242 + 0.016701360000000002 * var_x239 * var_x241 / pow(var_x240, 2))) * var_chaste_interface__INa__J;
        IJth(rJacobian, 5, 0) = 1.5624999999999998 * (-var_chaste_interface__ICaL__d + 1 / var_x248) * (-0.041599999999999998 * var_x246 + 0.10560000000000001 * var_x243 * var_x245 / pow(var_x244, 2)) / pow((0.73749999999999993 + var_x246), 2) + 0.14836795252225518 * var_x247 * var_x249 / pow(var_x248, 2);
        IJth(rJacobian, 6, 0) = -0.23529411764705882 * var_x250 / pow((1.0 + var_x250), 2);
        IJth(rJacobian, 7, 0) = -0.099999999999999992 * var_x255 * (0.052900000000000003 + var_x254) + var_x254 * (0.039250169999999994 - 0.0040499999999999998 * var_chaste_interface__cell__V) * (0.29999999999999999 - var_chaste_interface__ICaL__f + 0.69999999999999996 * var_x253);
        IJth(rJacobian, 8, 0) = 3.5929030958882842e-12 * var_x264 * (288960.09762000659 * var_x256 + var_x120 * var_x257 - var_x114 * var_x257);
        IJth(rJacobian, 9, 0) = 4.7905374611843792e-13 * var_x284 * (1444800.4881000333 * var_x256 + var_x120 * var_x278 - var_x114 * var_x278) + 0.0033333333333333335 * var_x286 * (-361200.12202500831 * var_x256 + var_x114 * var_x285 - var_x120 * var_x285);
        IJth(rJacobian, 10, 0) = -0.11 * var_x255 * (0.0054000000000000003 + var_x289) + var_x289 * (0.12930244120000001 - 0.0069619999999999994 * var_chaste_interface__cell__V) * (0.23000000000000001 - var_chaste_interface__ICaL__f2 + 0.77000000000000002 * var_x253);
        IJth(rJacobian, 11, 0) = (-var_chaste_interface__IKr__xr + 1 / var_x291) * (var_x294 + var_x297 - 8.1600000000000005e-5 * var_x295 * var_x298 / pow(var_x296, 2) - 4.566e-5 * var_x292 * var_x299 / pow(var_x293, 2)) + 0.23529411764705882 * var_x290 * (var_x300 + var_x301) / pow(var_x291, 2);
        IJth(rJacobian, 12, 0) = 0.04048582995951417 * var_x318 + var_x315 * (-var_chaste_interface__IKs__xs1 + var_x304);
        IJth(rJacobian, 13, 0) = 0.020242914979757085 * var_x318 + var_x315 * (0.5 * var_x304 - 0.5 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 14, 0) = var_x322 * var_x323 + var_x326 * var_x327 - var_x323 * pow(var_x320, 2) / pow(var_x321, 2) - var_x327 * pow(var_x324, 2) / pow(var_x325, 2);
        IJth(rJacobian, 15, 0) = var_x328 * var_x332 - var_x328 * var_x333 - 0.0060000000000000001 * var_x334 * (1.0 - var_chaste_interface__Ito__ydv2) / pow(var_x335, 2);
        IJth(rJacobian, 16, 0) = var_x332 * var_x336 - var_x333 * var_x336 - 0.00077999999999999999 * var_x337 * (1.0 - var_chaste_interface__Ito__zdv) / pow(var_x338, 2);
        IJth(rJacobian, 18, 0) = var_x221 * var_x339 + var_x223 * var_chaste_interface__INal__mL - var_x225 * var_x339;
        IJth(rJacobian, 19, 0) = -0.00027322404371584699 * var_x340 / pow((1.0 + var_x340), 2);
        IJth(rJacobian, 21, 0) = 0.33333333333333331 * var_x363 * (2.8388370140351874e-12 * var_x350 / pow(var_x342, 3) + var_x105 * var_x353 * var_x355 - var_x104 * var_x107 * var_x352 * var_x353);
        IJth(rJacobian, 22, 0) = 80.0 * var_x382 * var_x385 - 0.14999999999999999 * var_x385 * var_x388;
        IJth(rJacobian, 23, 0) = -1.2125733910710643e-6 * var_x101 - 0.0001845622286471062 * var_x81 - 6.1520742882368733e-5 * var_x35 - 0.00011419787897539696 * var_x89 - var_x396 * var_chaste_interface__INal__hL;
        IJth(rJacobian, 24, 0) = var_x407 + 7.6131919316931303e-5 * var_x89 + 6.4404060053814002e-6 * var_x93 + 1.7191112022346505e-6 * var_x95 - 2.7003798764701889e-5 * var_x58 - 2.0506914294122911e-7 * var_x102 - 1.6979725035533768e-7 * var_x2 - 6.1520742882368733e-5 * var_x62 - 2.8394189022631718e-8 * var_x24 - var_x408 * var_chaste_interface__IKr__xr - var_x409 * var_x97;
        IJth(rJacobian, 25, 0) = 1.3842167148532964e-8 + 3.3274959682366304e-9 * var_x90 - 3.3274959682366302e-7 * var_x40 + var_x416 * var_chaste_interface__Ito2__AA;
        IJth(rJacobian, 26, 0) = var_x422 * var_x429;
        IJth(rJacobian, 28, 0) = var_x445 * (-15.110483888602907 * var_x256 + var_x114 * var_x440 - var_x120 * var_x440 - var_x429 * var_x439);
        ...
        IJth(rJacobian, 23, 1) = 0.00027684334297065928 * var_x197 - 2.563364286765364e-12 * var_x131 - var_x127 * var_x397;
        IJth(rJacobian, 24, 1) = -3.3496381359330236e-11 * var_x135;
        IJth(rJacobian, 27, 1) = -var_x437 + 0.0043750000000000004 * var_x191;
        IJth(rJacobian, 28, 1) = 5.0 * var_x444;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x139);
        IJth(rJacobian, 2, 2) = -((var_x211) ? (0) : (0.13500000000000001 * var_x212)) - ((var_x211) ? (7.6923076923076916 / var_x214) : (310000.0 * var_x216 + 3.5600000000000001 * var_x215));
        ...
        IJth(rJacobian, 4, 4) = -((var_x211) ? (0) : (var_x233 * var_x234)) - ((var_x211) ? (0.29999999999999999 * var_x238) : (0.1212 * var_x242));
        IJth(rJacobian, 23, 4) = -6.1520742882368733e-5 * var_x142;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x143 * var_x144);
        IJth(rJacobian, 5, 5) = -var_x249;
        IJth(rJacobian, 8, 5) = var_x265 * var_x266;
        IJth(rJacobian, 9, 5) = var_x266 * var_x287 - var_x266 * var_x288;
        IJth(rJacobian, 21, 5) = var_x144 * var_x365;
        IJth(rJacobian, 22, 5) = var_x266 * var_x390 - var_x266 * var_x392;
        IJth(rJacobian, 28, 5) = -var_x266 * var_x446;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x143 * var_x145);
        IJth(rJacobian, 6, 6) = -0.10000000000000001;
        IJth(rJacobian, 8, 6) = var_x265 * var_x267;
        IJth(rJacobian, 9, 6) = var_x267 * var_x287 - var_x267 * var_x288;
        IJth(rJacobian, 21, 6) = var_x145 * var_x365;
        IJth(rJacobian, 22, 6) = var_x267 * var_x390 - var_x267 * var_x392;
        IJth(rJacobian, 28, 6) = -var_x267 * var_x446;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x147 * var_chaste_interface__ICaL__fca2);
        IJth(rJacobian, 7, 7) = -0.052900000000000003 - var_x254;
        IJth(rJacobian, 8, 7) = var_x265 * var_x269;
        IJth(rJacobian, 9, 7) = var_x269 * var_x287 - var_x269 * var_x288;
        IJth(rJacobian, 21, 7) = var_x352 * var_x366 / pow(var_chaste_interface__ICaL__f, 3);
        IJth(rJacobian, 22, 7) = var_x389 * var_x393 - var_x391 * var_x393;
        IJth(rJacobian, 28, 7) = -var_x269 * var_x446;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-14448.004881000332 * var_x148);
        IJth(rJacobian, 8, 8) = var_x260 * (-1 + var_x148 * var_x270);
        IJth(rJacobian, 9, 8) = var_x148 * var_x287 - var_x148 * var_x288;
        IJth(rJacobian, 21, 8) = var_x354 * var_x364 * var_x367 / pow(var_chaste_interface__ICaL__fca, 3);
        IJth(rJacobian, 22, 8) = var_x148 * var_x390 - var_x148 * var_x392;
        IJth(rJacobian, 28, 8) = -var_x148 * var_x446;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x147 * var_chaste_interface__ICaL__f);
        IJth(rJacobian, 8, 9) = var_x265 * var_x271;
        IJth(rJacobian, 9, 9) = var_x282 * (-1 + 6.9213708621806839e-7 * var_x271 * var_x283) - var_x271 * var_x288;
        IJth(rJacobian, 21, 9) = var_x346 * var_x368 / pow(var_chaste_interface__ICaL__fca2, 3);
        IJth(rJacobian, 22, 9) = var_x271 * var_x390 - var_x271 * var_x392;
        IJth(rJacobian, 28, 9) = -var_x271 * var_x446;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x109 * var_x149);
        IJth(rJacobian, 8, 10) = var_x265 * var_x272;
        IJth(rJacobian, 9, 10) = var_x272 * var_x287 - var_x272 * var_x288;
        IJth(rJacobian, 10, 10) = -0.0054000000000000003 - var_x289;
        IJth(rJacobian, 21, 10) = var_x348 * var_x368 / pow(var_chaste_interface__ICaL__f2, 3);
        IJth(rJacobian, 22, 10) = var_x272 * var_x390 - var_x272 * var_x392;
        IJth(rJacobian, 28, 10) = -var_x272 * var_x446;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x23 * var_x45);
        IJth(rJacobian, 11, 11) = -var_x300 - var_x301;
        IJth(rJacobian, 24, 11) = -var_x23 * var_x408;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x133 * var_x31);
        IJth(rJacobian, 12, 12) = -var_x316 - var_x317;
        IJth(rJacobian, 24, 12) = var_x133 * var_x406;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x150 * var_x29);
        IJth(rJacobian, 13, 13) = -3.8050000000000003e-5 * var_x307 * var_x314 - 0.00018000000000000001 * var_x311 * var_x313;
        IJth(rJacobian, 24, 13) = var_x150 * var_x405;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x152);
        IJth(rJacobian, 14, 14) = -25.0 * var_x322 - 25.0 * var_x326;
        IJth(rJacobian, 24, 14) = -0.0001845622286471062 * var_x152;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x153);
        IJth(rJacobian, 15, 15) = -0.029999999999999999 / var_x335 - 0.20000000000000001 * var_x333;
        IJth(rJacobian, 24, 15) = -6.1520742882368733e-5 * var_x153;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x154);
        IJth(rJacobian, 16, 16) = -0.10000000000000001 * var_x333 - 0.0038999999999999998 / var_x338;
        ...
        IJth(rJacobian, 25, 17) = var_x416 * var_chaste_interface__cell__V;
        ...
        IJth(rJacobian, 23, 19) = -var_x138 * var_x396;
        IJth(rJacobian, 1, 20) = var_x177 * (-var_x195 * var_x204 - var_x202 * var_x203);
        IJth(rJacobian, 8, 20) = var_x273 * var_x274;
        IJth(rJacobian, 20, 20) = -0.00068000000000000005 - var_x184 * var_x341 + var_x179 * var_x198 * var_x341;
        IJth(rJacobian, 22, 20) = var_x394 * (var_x273 - var_x273 * var_x378);
        IJth(rJacobian, 27, 20) = var_x202 * var_x438 + var_x204 * var_x437;
        IJth(rJacobian, 21, 21) = -0.33333333333333331;
        IJth(rJacobian, 26, 21) = -var_x422 * var_x431;
        IJth(rJacobian, 28, 21) = var_x431 * var_x447;
        IJth(rJacobian, 22, 22) = -var_x381;
        IJth(rJacobian, 26, 22) = -var_x422 * var_x432;
        IJth(rJacobian, 28, 22) = var_x432 * var_x447;
        ...
        IJth(rJacobian, 23, 23) = var_x403 - 0.0016433629212878199 * var_x158 - 1.068185898837083e-5 * var_x156 - 0.00055368668594131857 * var_x162 - 2.283957579507939e-6 * var_x159 - var_x161 * var_x397;
        IJth(rJacobian, 24, 23) = 1.5226383863386261e-6 * var_x159 + 0.48963716847181743 * var_x410;
        IJth(rJacobian, 25, 23) = var_x403;
        ...
        IJth(rJacobian, 24, 24) = var_x414 + 26.712338705500134 * var_x410 + 0.00017203830661668509 * var_x169 - 0.00070719080288027735 * var_x165 - 4.535681662754383e-6 * var_x163 - 0.0016433629212878199 * var_x166 - 0.00072133461893788295 * var_x164 - var_x168 * var_x409;
        IJth(rJacobian, 25, 24) = var_x414;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (0.00601027620873753 * var_x170 - 0.001444800488100033 * var_x39);
        IJth(rJacobian, 23, 25) = var_x404;
        IJth(rJacobian, 24, 25) = var_x415;
        IJth(rJacobian, 25, 25) = var_x404 + var_x415 + 8.8885199344722979e-8 * var_x39 - 3.6975665728975948e-7 * var_x170;
        IJth(rJacobian, 21, 26) = -2.3414435371998602e-7 * var_x370 * pow(var_chaste_interface__Ca__Ca_jsr, 2.7999999999999998) + 0.6333333333333333 * var_x360 * var_x369 * pow(var_chaste_interface__Ca__Ca_jsr, 0.89999999999999991);
        IJth(rJacobian, 26, 26) = var_x421 * (-0.0083333333333333332 - var_x434) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0.0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x417 * var_x434) / (pow(var_x418, 3) * pow((0.125 + var_x419), 2));
        IJth(rJacobian, 27, 26) = 0.00072463768115942019;
        IJth(rJacobian, 28, 26) = var_x444 * var_x448;
        IJth(rJacobian, 1, 27) = 2.3676470588235295e-5 * var_x176;
        IJth(rJacobian, 26, 27) = 0.0083333333333333332 * var_x420;
        ...
        IJth(rJacobian, 8, 28) = var_x260 * (-0.0016500000000000002 * var_x275 + var_x270 * var_x276) + var_x274 * (var_x277 + 0.0030000000000000001 * var_x275);
        IJth(rJacobian, 9, 28) = var_x276 * var_x287 - var_x276 * var_x288;
        ...
        IJth(rJacobian, 21, 28) = var_x104 * var_x345 * var_x355 * var_x364 - 0.00020267697647483301 * var_x180 * var_x356 * var_x357 * var_x359 * var_x370 * (1.8999999999999999 * var_x358 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x357, 2));
        IJth(rJacobian, 22, 28) = var_x394 * (var_x277 + var_x387 * (5000.0 - 14448004.881000333 * var_x395) - var_x277 * var_x378) - var_x382 * (40000.0 - 77056026.032001764 * var_x395);
        IJth(rJacobian, 26, 28) = var_x421 * (var_x434 + 2889.6009762000663 * var_x435);
        IJth(rJacobian, 27, 28) = var_x209 * var_x438 + var_x210 * var_x437;
        IJth(rJacobian, 28, 28) = var_x445 * (-5.0 - var_x448 - 15.110483888602907 * var_x276 - 693.50423428801582 * var_x435) + (0.019557600000000001 / pow(var_x441, 3) + 8.1780000000000006e-5 / pow(var_x442, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 15.110483888602907 * var_x261 + var_x417 * var_x448) / pow(var_x443, 2);
    }
