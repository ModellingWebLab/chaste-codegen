...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliyer_model_2007FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x27 = var_x26 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai, 3.0);
        ...
        const double var_x68 = var_x24 * var_x26 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai, 2.0);
        ...
        IJth(rJacobian, 5, 5) = var_x135 * (-1.7400382808421786 - var_x130 - var_x131) + 0.33333333333333331 * pow(var_x132, (-3.0)) * (1.7400382808421786 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaNSR - 1.8 * var_x126 - 1.7400382808421786 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR) / pow((0.16666666666666666 + var_x133), 2);
