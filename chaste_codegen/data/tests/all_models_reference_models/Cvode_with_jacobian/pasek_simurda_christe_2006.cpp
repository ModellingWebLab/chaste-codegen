...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellpasek_simurda_christe_2006FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_membrane_permeabilities__gCas = (1.0 - var_membrane_permeabilities__fCat) * (var_model_parameters__Sms + var_model_parameters__Smt) * var_membrane_permeabilities__gCa; // cm3_per_second
        const double var_i_Cas__i_Cas = 4.0 * pow(var_model_parameters__F, 2) * (-0.34100000000000003 * var_model_parameters__Cae + var_chaste_interface__ion_concentrations__Cass * exp(2.0 * var_chaste_interface__Vms__Vms * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T))) * ((0.10000000000000001 - 0.10000000000000001 * var_chaste_interface__i_Cas__Ccast) * var_chaste_interface__i_Cas__C2 + (0.90000000000000002 + 0.10000000000000001 * var_chaste_interface__i_Cas__Ccast) * var_chaste_interface__i_Cas__C1) * var_chaste_interface__Vms__Vms * var_chaste_interface__i_Cas__Co * var_membrane_permeabilities__gCas / ((-1.0 + exp(2.0 * var_chaste_interface__Vms__Vms * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T))) * var_model_parameters__R * var_model_parameters__T); // microA
    ...
    void Cellpasek_simurda_christe_2006FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_i_Nas_h_gate__beta_h = 18.77 * (64.400000000000006 + var_chaste_interface__Vms__Vms) / (1.0 - exp(-14.168000000000001 - 0.22 * var_chaste_interface__Vms__Vms)); // per_second
        ...
        const double var_i_Nas_m_gate__alpha_m = 117.26000000000001 * (59.299999999999997 + var_chaste_interface__Vms__Vms) / (1.0 - exp(-32.615000000000002 - 0.55000000000000004 * var_chaste_interface__Vms__Vms)); // per_second
    ...
    void Cellpasek_simurda_christe_2006FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        double var_chaste_interface__Vmt__Vmt = NV_Ith_S(rY, 40);
        // Units: millivolt; Initial value: -79.709536
        const double var_x0 = var_chaste_interface__i_Ksts_rsts_gate__rsts * var_chaste_interface__i_Ksts_ssts_gate__ssts;
        const double var_x1 = 1 / var_chaste_interface__ion_concentrations__Ki;
        const double var_x2 = log(5.4000000000000004 * var_x1);
        const double var_x3 = (1.0 + exp(-35.49354838709678)) * exp(-0.10984612576230394 + 0.063494870382834648 * var_chaste_interface__Vms__Vms - 1.613 * var_x2);
        const double var_x4 = 1.0 + var_x3;
        const double var_x5 = NV_Ith_S(mParameters, 1) / var_x4;
        const double var_x6 = (-0.88702724637681152 * var_chaste_interface__i_Ktos_ss_gate__ss - 0.11413217391304346 * var_chaste_interface__i_Ktos_sss_gate__sss) * NV_Ith_S(mParameters, 3);
        ...
        const double var_x14 = NV_Ith_S(mParameters, 2) / (1.0 + 0.00012 * var_x11 + 274.40000000000003 * var_chaste_interface__ion_concentrations__Cai);
        const double var_x15 = var_x14 * (51312.800000000003 * var_x10 + 0.022440000000000002 * var_x13);
        const double var_x16 = pow(var_chaste_interface__i_Nas_m_gate__m, 3) * NV_Ith_S(mParameters, 0);
        ...
        const double var_x26 = exp(0.078728915539782576 * var_chaste_interface__Vms__Vms);
        ...
        const double var_x37 = -25.403626943005182 * var_x2 + var_chaste_interface__Vms__Vms;
        const double var_x38 = var_x3 * (-1.73 + var_x37) * NV_Ith_S(mParameters, 1) / pow(var_x4, 2);
        ...
        const double var_x50 = var_x49 * NV_Ith_S(mParameters, 2) / pow((0.0036443148688046646 + 4.3731778425655972e-7 * var_x11 + var_chaste_interface__ion_concentrations__Cai), 2);
        ...
        const double var_x53 = -25.403626943005182 * log(140.648 * var_x52) + var_chaste_interface__Vms__Vms;
        const double var_x54 = var_x53 * pow(var_chaste_interface__i_Nas_m_gate__m, 2) * var_chaste_interface__i_Nas_h_gate__h * NV_Ith_S(mParameters, 0);
        const double var_x55 = 0.94385392673546364 * var_x42;
        const double var_x56 = var_x39 * var_x55;
        const double var_x57 = 0.10000000000000001 * var_chaste_interface__i_Cas__C1 - 0.10000000000000001 * var_chaste_interface__i_Cas__C2;
        const double var_x58 = var_chaste_interface__i_Ktos_rs_gate__rs * NV_Ith_S(mParameters, 3);
        const double var_x59 = 0.97108125253435462 * var_x2 - 0.038226086956521743 * var_chaste_interface__Vms__Vms;
        const double var_x60 = log(140.0 * var_x18);
        const double var_x61 = var_x18 * var_chaste_interface__i_Kfs_qs_gate__qs;
        ...
        const double var_x68 = var_x1 * var_chaste_interface__i_Kfs_qs_gate__qs;
        const double var_x69 = var_x1 * var_x5;
        const double var_x70 = var_x0 * var_x1;
        const double var_x71 = 25.403626943005182 * var_x1;
        const double var_x72 = var_x1 * var_x38;
        ...
        const double var_x89 = NV_Ith_S(mParameters, 2) / var_x88;
        ...
        const double var_x98 = var_x97 * NV_Ith_S(mParameters, 2) / pow(var_x88, 2);
        ...
        const double var_x110 = exp(-4.3919999999999995 - 0.071999999999999995 * var_chaste_interface__Vms__Vms);
        const double var_x111 = 1.0 - var_chaste_interface__i_Nas_m_gate__m;
        ...
        const double var_x127 = 1.0 - var_chaste_interface__i_Nat_m_gate__m;
        ...
        const double var_x137 = exp(-3.0600000000000001 + var_x136);
        ...
        const double var_x150 = exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__Vms__Vms);
        const double var_x151 = 1.0 + var_x150;
        const double var_x152 = 1 / var_x151;
        const double var_x153 = 0.00059999999999999995 * var_x146 / pow(var_x147, 2);
        ...
        const double var_x157 = 0.00018518518518518518 * var_x150 / pow(var_x151, 2);
        ...
        const double var_x164 = -0.0011111111111111113 / pow((0.01 + var_chaste_interface__ion_concentrations__Cass), 2);
        ...
        const double var_x171 = exp(-3.0600000000000001 + var_x170);
        ...
        const double var_x184 = exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__Vmt__Vmt);
        const double var_x185 = 1.0 + var_x184;
        const double var_x186 = 1 / var_x185;
        const double var_x187 = 0.00059999999999999995 * var_x174 / pow(var_x175, 2);
        const double var_x188 = 0.00018518518518518518 * var_x184 / pow(var_x185, 2);
        ...
        const double var_x195 = exp(-0.92819614711033271 - 0.087565674255691769 * var_chaste_interface__Vms__Vms);
        ...
        const double var_x202 = exp(6.5803808776746413 + 0.14526227103034528 * var_chaste_interface__Vms__Vms);
        const double var_x203 = 1.0 + var_x202;
        const double var_x204 = 0.00014526227103034528 * var_x202 / pow(var_x203, 2);
        const double var_x205 = 1 / var_x203;
        ...
        const double var_x210 = exp(-0.92819614711033271 - 0.087565674255691769 * var_chaste_interface__Vmt__Vmt);
        ...
        const double var_x215 = exp(6.5803808776746413 + 0.14526227103034528 * var_chaste_interface__Vmt__Vmt);
        const double var_x216 = 1.0 + var_x215;
        const double var_x217 = 0.00014526227103034528 * var_x215 / pow(var_x216, 2);
        ...
        const double var_x221 = exp(-0.97292724196277491 - 0.084602368866328256 * var_chaste_interface__Vms__Vms);
        const double var_x222 = 1.0 + var_x221;
        const double var_x223 = exp(8.4951456310679614 + 0.097087378640776698 * var_chaste_interface__Vms__Vms);
        const double var_x224 = exp(-0.97292724196277491 - 0.084602368866328256 * var_chaste_interface__Vmt__Vmt);
        const double var_x225 = 1.0 + var_x224;
        const double var_x226 = exp(8.4951456310679614 + 0.097087378640776698 * var_chaste_interface__Vmt__Vmt);
        const double var_x227 = exp(13.225190839694655 + 0.095419847328244267 * var_chaste_interface__Vms__Vms);
        ...
        const double var_x233 = exp(13.225190839694655 + 0.095419847328244267 * var_chaste_interface__Vmt__Vmt);
        ...
        const double var_x237 = 48600000000.0 * var_x236 * var_chaste_interface__JCaSRrel__F1;
        const double var_x238 = 4050000.0 * var_x236;
        const double var_x239 = pow(var_chaste_interface__ion_concentrations__Cass, 2) * var_chaste_interface__JCaSRrel__F2;
        ...
        const double var_x244 = var_x243 * (8.0254777070063705e-8 * var_chaste_interface__ion_concentrations__Cass - 8.0254777070063705e-8 * var_chaste_interface__CaSRrel__CaSRrel);
        ...
        const double var_x248 = 6.1184181391435268e-5 * var_x16;
        const double var_x249 = 0.00033790354722997213 * var_x89;
        const double var_x250 = 3.3790354722997215e-8 * var_x98;
        const double var_x251 = var_chaste_interface__ion_concentrations__Nat + 0.12 * var_chaste_interface__ion_concentrations__Kt;
        const double var_x252 = -25.403626943005182 * log(var_x251 * var_x52) + var_chaste_interface__Vmt__Vmt;
        const double var_x253 = var_x252 * pow(var_chaste_interface__i_Nat_m_gate__m, 2) * var_chaste_interface__i_Nat_h_gate__h * NV_Ith_S(mParameters, 0);
        const double var_x254 = pow(var_chaste_interface__i_Nat_m_gate__m, 3) * NV_Ith_S(mParameters, 0);
        const double var_x255 = 7.7870776316372187e-5 * var_x254;
        ...
        const double var_x279 = log(var_x1 * var_chaste_interface__ion_concentrations__Kt);
        const double var_x280 = -25.403626943005182 * var_x279 + var_chaste_interface__Vmt__Vmt;
        const double var_x281 = (-6.8993507816305752e-5 * var_chaste_interface__i_Ktot_st_gate__st - 8.8772685000664288e-6 * var_chaste_interface__i_Ktot_sst_gate__sst) * NV_Ith_S(mParameters, 3);
        const double var_x282 = var_chaste_interface__i_Ktot_rt_gate__rt * NV_Ith_S(mParameters, 3);
        const double var_x283 = 5.9346004539099664e-5 * var_x2 - 2.3361232894911652e-6 * var_chaste_interface__Vms__Vms;
        const double var_x284 = 0.0001879290143738156 * var_x279 - 7.3977237500553573e-6 * var_chaste_interface__Vmt__Vmt;
        const double var_x285 = log(var_x18 * var_chaste_interface__ion_concentrations__Nat);
        const double var_x286 = 5.7367804387796348e-6 * var_chaste_interface__i_Kft_qt_gate__qt;
        ...
        const double var_x294 = NV_Ith_S(mParameters, 1) / var_x293;
        ...
        const double var_x297 = (-1.73 + var_x280) * NV_Ith_S(mParameters, 1) / pow(var_x293, 2);
        const double var_x298 = var_x292 * var_x297;
        const double var_x299 = var_x1 * var_x298;
        ...
        const double var_x303 = 0.005990108337258597 * var_x89;
        const double var_x304 = 5.9901083372585972e-7 * var_x98;
        const double var_x305 = 0.0013804364892447795 * var_x254;
        ...
        const double var_x320 = 0.0034215944552296509 * var_x319;
        const double var_x321 = var_x312 * var_chaste_interface__i_Cat__Co;
        const double var_x322 = var_x321 * var_chaste_interface__Vmt__Vmt;
        const double var_x323 = var_x320 * var_x322;
        const double var_x324 = 0.10000000000000001 * var_chaste_interface__i_Cat__C1 - 0.10000000000000001 * var_chaste_interface__i_Cat__C2;
        const double var_x325 = 5.9901083372585972e-7 * var_x98;
        const double var_x326 = 0.005990108337258597 * var_x89;
        ...
        const double var_x333 = var_x280 * NV_Ith_S(mParameters, 3);
        const double var_x334 = 0.00013114146647825407 * var_chaste_interface__Vmt__Vmt - 0.0033314688911721853 * var_x279;
        const double var_x335 = 0.00010169747141472988 * var_chaste_interface__i_Kft_qt_gate__qt;
        ...
        const double var_x346 = 0.22496000326337479 * var_x344;
        const double var_x347 = var_x346 * var_x39 * var_x42;
        const double var_x348 = var_x317 * var_x319;
        const double var_x349 = 1.5055015603010464 * var_x344;
        const double var_x350 = var_x319 * var_x322;
        const double var_x351 = var_x349 * var_x350;
        const double var_x352 = var_x345 * (84000.000000000015 * var_chaste_interface__CaSRrel__CaSRrel - 84000.000000000015 * var_chaste_interface__ion_concentrations__Cass);
        ...
        const double var_x356 = 1.4451136363636365 * var_x89;
        const double var_x357 = 0.00014451136363636364 * var_x98;
        const double var_x358 = 0.99909090909090914 * var_x254;
        const double var_x359 = 4.9527579739449195 * var_x350;
        ...
        const double var_x361 = 2.4111506099858695 * var_x279 - 0.094913636363636381 * var_chaste_interface__Vmt__Vmt;
        const double var_x362 = 0.073603544936410747 * var_chaste_interface__i_Kft_qt_gate__qt;
        const double var_x363 = 0.00043353409090909098 * var_x98;
        const double var_x364 = 4.3353409090909096 * var_x89;
        const double var_x365 = 0.29441417974564299 * var_chaste_interface__i_Kft_qt_gate__qt;
        const double var_x366 = 25.380532736693361 * var_x294;
        const double var_x367 = 2.4111506099858695 * var_x288;
        const double var_x368 = var_x282 * var_x360;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-1128.3437216687673 + var_x7 + 0.063568487623858222 * var_x38 + 0.074308596079848452 * var_x41 - 0.038226086956521743 * var_x0 - 0.43231884057971004 * var_x15 - 0.074308596079848452 * var_x43 - 1.0011594202898551 * var_x5 - 0.73009451795841218 * var_x25 - 0.014516811594202898 * var_chaste_interface__i_Kfs_qs_gate__qs - var_x17 * var_chaste_interface__i_Nas_h_gate__h - var_x36 * var_chaste_interface__i_Cas__Co);
        IJth(rJacobian, 1, 0) = var_x76 * (-1.9823674770825031e-5 + 0.026420441964483409 * var_x15);
        IJth(rJacobian, 2, 0) = var_x111 * var_x114 + 0.27359999999999995 * var_x110 * var_chaste_interface__i_Nas_m_gate__m - 0.064493000000000009 * var_x111 * var_x112 * var_x115 / pow(var_x113, 2);
        IJth(rJacobian, 3, 0) = -var_x118 * var_chaste_interface__i_Nas_h_gate__h - 0.023093279999999997 * var_x119 * (1.0 - var_chaste_interface__i_Nas_h_gate__h) / pow(var_x120, 2) + 0.0041294000000000001 * var_x116 * var_x121 * var_chaste_interface__i_Nas_h_gate__h / pow(var_x117, 2);
        IJth(rJacobian, 6, 0) = 107.49798441279225 * (-var_chaste_interface__i_Cas__Co + 1 / var_x138) * (-var_x139 * (0.072000000000000008 - 0.0040000000000000001 * var_chaste_interface__Vms__Vms) - var_x140 * (-0.063 - 0.0089999999999999993 * var_chaste_interface__Vms__Vms)) / pow((0.081967213114754092 + var_x135 + 0.34426229508196715 * var_x134), 2) + 0.00020000000000000001 * var_x137 * var_x141 / pow(var_x138, 2);
        IJth(rJacobian, 7, 0) = -var_x156 * var_x157 + 0.090702947845805001 * (var_x152 - var_chaste_interface__i_Cas__C1) * (var_x153 - var_x154 * (-0.625 - 0.013888888888888888 * var_chaste_interface__Vms__Vms) - 0.0016000000000000001 * var_x143 / pow(var_x144, 2)) / pow((var_x149 + 0.38095238095238099 * var_x145 + 0.14285714285714285 * var_x148), 2);
        IJth(rJacobian, 8, 0) = -var_x157 * var_x163 + 0.15625 * (var_x152 - var_chaste_interface__i_Cas__C2) * (var_x153 - var_x162 * (-0.65277777777777779 - 0.013888888888888888 * var_chaste_interface__Vms__Vms) - 0.016 * var_x158 / pow(var_x159, 2)) / pow((var_x160 + 0.51249999999999996 * var_x161 + 0.1875 * var_x148), 2);
        IJth(rJacobian, 14, 0) = (0.001 / var_x196 - 0.001 * var_chaste_interface__i_Ktos_rs_gate__rs) * (1.6153732000000001 * var_x197 - 9.8900000000000006 * var_x198) + 8.7565674255691772e-5 * var_x195 * (45.159999999999997 * var_x197 + 98.900000000000006 * var_x198) / pow(var_x196, 2);
        IJth(rJacobian, 15, 0) = -var_x201 * var_x204 - 0.0028571428571428571 * var_x200 * (-0.62097840000000015 - 0.0088711200000000014 * var_chaste_interface__Vms__Vms) * (var_x205 - var_chaste_interface__i_Ktos_ss_gate__ss) / pow((0.10000000000000002 + var_x200), 2);
        IJth(rJacobian, 16, 0) = -var_x204 * var_x207 - 0.00027027027027027027 * var_x206 * (-0.15524460000000004 - 0.0022177800000000004 * var_chaste_interface__Vms__Vms) * (var_x205 - var_chaste_interface__i_Ktos_sss_gate__sss) / pow((0.00945945945945946 + var_x206), 2);
        IJth(rJacobian, 20, 0) = (0.001 / var_x222 - 0.001 * var_chaste_interface__i_Ksts_rsts_gate__rsts) * (0.16153732000000001 * var_x197 - 0.9890000000000001 * var_x198) + 8.4602368866328257e-5 * var_x221 * (9.8900000000000006 * var_x198 + 4.516 * var_x197) / pow(var_x222, 2);
        IJth(rJacobian, 21, 0) = -4.6232085067036518e-5 * var_x223 / pow((1.0 + var_x223), 2);
        IJth(rJacobian, 24, 0) = (0.001 / var_x228 - 0.001 * var_chaste_interface__i_Kfs_qs_gate__qs) * (0.0041892844554106447 * var_x229 - 0.039626497533474282 * var_x230) - 9.5419847328244274e-5 * var_x227 * (0.56230000000000002 * var_x230 + 0.11885 * var_x229) / pow(var_x228, 2);
        IJth(rJacobian, 32, 0) = -4.9039121385235371e-8 - 0.00013385551146308076 * var_x25 - 7.9261325893450232e-5 * var_x15 - var_x248 * var_chaste_interface__i_Nas_h_gate__h;
        IJth(rJacobian, 33, 0) = -8.4434170320180672e-8 + var_x278 + 3.8848816669290266e-6 * var_x38 + 8.9237007642053832e-5 * var_x25 - 8.8717063017581157e-7 * var_chaste_interface__i_Kfs_qs_gate__qs - 6.1184181391435268e-5 * var_x5 - 2.3361232894911652e-6 * var_x0;
        IJth(rJacobian, 37, 0) = var_x345 * (-var_x341 + 17.710857096751447 * var_x41 - 17.710857096751447 * var_x43);
        IJth(rJacobian, 40, 0) = 884.72183333278349;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.85098550724637667 * var_x47 + 1186282.8985507244 * var_x48 + 0.0015755059787890306 * var_x50 - 0.0082403180572200932 * var_x44 - 0.85098550724637667 * var_x46);
        IJth(rJacobian, 1, 1) = var_x76 * (-5920.0000000000009 - var_x77 + 3.5444788081288787e-5 * var_x84 + 0.059098357025818171 * var_x47 + 2800.0000000000005 * var_chaste_interface__ion_concentrations__BTRH + 2800.0000000000005 * var_chaste_interface__ion_concentrations__BTRL - 0.00057226504376988959 * var_x44 - 9.6284409491557608e-5 * var_x50 - 16250.626147884037 * var_x81 - 72497.692750542483 * var_x48 - var_x86 * var_x99 - var_x90 * var_x93) + 2.3800000000000004e-7 * (2.8000000000000003 * var_chaste_interface__ion_concentrations__BTRL + 320.0 * var_chaste_interface__ion_concentrations__Cass + 0.00032046842451113823 * log(var_x44 * var_chaste_interface__ion_concentrations__Cat) + 0.00025179661925875141 * log(1.2 * var_x44) + 0.0098000000000000014 * var_chaste_interface__ion_concentrations__BTRH - 320.0 * var_chaste_interface__ion_concentrations__Cai - 1.9823674770825031e-5 * var_chaste_interface__Vms__Vms - 2.523013152650459e-5 * var_chaste_interface__Vmt__Vmt + var_x90 * var_x97 - var_x100 * (1.0 - var_chaste_interface__ion_concentrations__BTRH) - var_x100 * (1.0 - var_chaste_interface__ion_concentrations__BTRL) - var_x77 * var_chaste_interface__ion_concentrations__Cai + 0.026420441964483409 * var_x14 * var_x49 - var_x79 * var_x82) / (pow(var_x73, 3) * pow(var_x74, 2));
        IJth(rJacobian, 30, 1) = 301.79734274641783 * var_x81 - 6.5826035008107732e-7 * var_x84;
        IJth(rJacobian, 32, 1) = 2.8885322847467282e-7 * var_x50 + 217.49307825162742 * var_x48 + var_x249 * var_x93 + var_x250 * var_x86;
        IJth(rJacobian, 34, 1) = -var_x303 * var_x93 - var_x304 * var_x86;
        IJth(rJacobian, 35, 1) = 0.00058668550792903128 * var_x46 + 5.6810311617883583e-6 * var_x44 - 0.00058668550792903128 * var_x47 + var_x308 * var_x93 + var_x309 * var_x86;
        IJth(rJacobian, 37, 1) = 2496.0 * var_x344;
        ...
        IJth(rJacobian, 40, 1) = 0.84922727272727283 * var_x47 - 0.0082232926066886491 * var_x44 - 0.84922727272727283 * var_x46 + var_x356 * var_x93 + var_x357 * var_x86;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0034782608695649 * var_x54);
        IJth(rJacobian, 2, 2) = -3.7999999999999998 * var_x110 - var_x114 * var_x115;
        IJth(rJacobian, 32, 2) = -0.00018355254417430582 * var_x54;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x53);
        IJth(rJacobian, 3, 3) = -0.28439999999999999 / var_x120 - var_x118 * var_x121;
        IJth(rJacobian, 32, 3) = -var_x248 * var_x53;
        IJth(rJacobian, 4, 4) = -3.7999999999999998 * var_x122 - var_x123 * var_x126;
        IJth(rJacobian, 32, 4) = -0.00023361232894911655 * var_x253;
        IJth(rJacobian, 34, 4) = 0.0041413094677343384 * var_x253;
        IJth(rJacobian, 40, 4) = -2.9972727272727275 * var_x253;
        IJth(rJacobian, 5, 5) = -0.28439999999999999 / var_x129 - var_x130 * var_x133;
        IJth(rJacobian, 32, 5) = -var_x252 * var_x255;
        IJth(rJacobian, 34, 5) = var_x252 * var_x305;
        IJth(rJacobian, 40, 5) = -var_x252 * var_x358;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x36 * var_chaste_interface__Vms__Vms);
        IJth(rJacobian, 6, 6) = -0.001 * var_x141;
        IJth(rJacobian, 37, 6) = -var_x346 * var_x35 * var_chaste_interface__Vms__Vms;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x33 * var_x56);
        IJth(rJacobian, 7, 7) = -0.001 * var_x156;
        IJth(rJacobian, 37, 7) = -var_x33 * var_x347;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x32 * var_x56);
        IJth(rJacobian, 8, 8) = -0.001 * var_x163;
        IJth(rJacobian, 37, 8) = -var_x32 * var_x347;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x56 * var_x57);
        IJth(rJacobian, 9, 9) = -0.11111111111111112;
        IJth(rJacobian, 37, 9) = -var_x347 * var_x57;
        IJth(rJacobian, 10, 10) = -0.001 * var_x169;
        IJth(rJacobian, 35, 10) = var_x317 * var_x320;
        IJth(rJacobian, 37, 10) = -var_x348 * var_x349;
        IJth(rJacobian, 40, 10) = -4.9527579739449195 * var_x348;
        IJth(rJacobian, 11, 11) = -0.001 * var_x183;
        IJth(rJacobian, 35, 11) = var_x315 * var_x323;
        IJth(rJacobian, 37, 11) = -var_x315 * var_x351;
        IJth(rJacobian, 40, 11) = -var_x315 * var_x359;
        IJth(rJacobian, 12, 12) = -0.001 * var_x194;
        IJth(rJacobian, 35, 12) = var_x314 * var_x323;
        IJth(rJacobian, 37, 12) = -var_x314 * var_x351;
        IJth(rJacobian, 40, 12) = -var_x314 * var_x359;
        IJth(rJacobian, 13, 13) = -0.11111111111111112;
        IJth(rJacobian, 35, 13) = var_x323 * var_x324;
        IJth(rJacobian, 37, 13) = -var_x324 * var_x351;
        IJth(rJacobian, 40, 13) = -var_x324 * var_x359;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x37 * var_x6);
        IJth(rJacobian, 14, 14) = -0.045159999999999999 * var_x197 - 0.098900000000000002 * var_x198;
        IJth(rJacobian, 33, 14) = var_x277 * var_x37 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (var_x58 * (22.533709255237664 * var_x2 - 0.88702724637681152 * var_chaste_interface__Vms__Vms));
        IJth(rJacobian, 15, 15) = -0.001 * var_x201;
        IJth(rJacobian, 33, 15) = var_x58 * (0.0013771099053287268 * var_x2 - 5.4209184712811651e-5 * var_chaste_interface__Vms__Vms);
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x58 * (2.8993711682811441 * var_x2 - 0.11413217391304346 * var_chaste_interface__Vms__Vms));
        IJth(rJacobian, 16, 16) = -0.001 * var_x207;
        IJth(rJacobian, 33, 16) = var_x58 * (0.00017719021355245469 * var_x2 - 6.9749966786236214e-6 * var_chaste_interface__Vms__Vms);
        IJth(rJacobian, 17, 17) = -0.045159999999999999 * var_x208 - 0.098900000000000002 * var_x209;
        IJth(rJacobian, 33, 17) = var_x280 * var_x281;
        IJth(rJacobian, 36, 17) = var_x332 * var_x333;
        IJth(rJacobian, 40, 17) = var_x333 * var_x360;
        IJth(rJacobian, 18, 18) = -0.001 * var_x214;
        IJth(rJacobian, 33, 18) = var_x282 * (0.0017526853340547434 * var_x279 - 6.8993507816305752e-5 * var_chaste_interface__Vmt__Vmt);
        IJth(rJacobian, 36, 18) = var_x282 * (0.0012230667294708746 * var_chaste_interface__Vmt__Vmt - 0.031070330921879542 * var_x279);
        IJth(rJacobian, 40, 18) = var_x282 * (22.487152004710317 * var_x279 - 0.88519454545454557 * var_chaste_interface__Vmt__Vmt);
        IJth(rJacobian, 19, 19) = -0.001 * var_x220;
        IJth(rJacobian, 33, 19) = var_x282 * (0.00022551481724857874 * var_x279 - 8.8772685000664288e-6 * var_chaste_interface__Vmt__Vmt);
        IJth(rJacobian, 36, 19) = var_x282 * (0.00015736975977390487 * var_chaste_interface__Vmt__Vmt - 0.0039977626694066223 * var_x279);
        IJth(rJacobian, 40, 19) = var_x282 * (2.8933807319830431 * var_x279 - 0.11389636363636366 * var_chaste_interface__Vmt__Vmt);
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (var_x59 * var_chaste_interface__i_Ksts_ssts_gate__ssts);
        IJth(rJacobian, 20, 20) = -0.0098900000000000012 * var_x198 - 0.004516 * var_x197;
        IJth(rJacobian, 33, 20) = var_x283 * var_chaste_interface__i_Ksts_ssts_gate__ssts;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (var_x59 * var_chaste_interface__i_Ksts_rsts_gate__rsts);
        IJth(rJacobian, 21, 21) = -0.00047619047619047619;
        IJth(rJacobian, 33, 21) = var_x283 * var_chaste_interface__i_Ksts_rsts_gate__rsts;
        IJth(rJacobian, 22, 22) = -0.0098900000000000012 * var_x209 - 0.004516 * var_x208;
        IJth(rJacobian, 33, 22) = var_x284 * var_chaste_interface__i_Kstt_sstt_gate__sstt;
        IJth(rJacobian, 36, 22) = var_x334 * var_chaste_interface__i_Kstt_sstt_gate__sstt;
        IJth(rJacobian, 40, 22) = var_x361 * var_chaste_interface__i_Kstt_sstt_gate__sstt;
        IJth(rJacobian, 23, 23) = -0.00047619047619047619;
        IJth(rJacobian, 33, 23) = var_x284 * var_chaste_interface__i_Kstt_rstt_gate__rstt;
        IJth(rJacobian, 36, 23) = var_x334 * var_chaste_interface__i_Kstt_rstt_gate__rstt;
        IJth(rJacobian, 40, 23) = var_x361 * var_chaste_interface__i_Kstt_rstt_gate__rstt;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (0.073755933228204548 * var_x60 + 0.29502373291281819 * var_x2 - 0.014516811594202898 * var_chaste_interface__Vms__Vms);
        IJth(rJacobian, 24, 24) = -0.00056230000000000006 * var_x230 - 0.00011885 * var_x229;
        IJth(rJacobian, 33, 24) = 4.5074703447554268e-6 * var_x60 + 1.8029881379021707e-5 * var_x2 - 8.8717063017581157e-7 * var_chaste_interface__Vms__Vms;
        IJth(rJacobian, 25, 25) = -0.00056230000000000006 * var_x231 - 0.00011885 * var_x232;
        IJth(rJacobian, 33, 25) = 5.7367804387796348e-6 * var_x285 + 2.2947121755118539e-5 * var_x279 - 1.1291262565873969e-6 * var_chaste_interface__Vmt__Vmt;
        IJth(rJacobian, 36, 25) = 2.0016329094049303e-5 * var_chaste_interface__Vmt__Vmt - 0.00010169747141472988 * var_x285 - 0.00040678988565891953 * var_x279;
        IJth(rJacobian, 40, 25) = 0.073603544936410747 * var_x285 + 0.29441417974564299 * var_x279 - 0.014486818181818184 * var_chaste_interface__Vmt__Vmt;
        IJth(rJacobian, 26, 26) = -var_x235;
        IJth(rJacobian, 27, 26) = var_x235;
        IJth(rJacobian, 26, 27) = 0.57599999999999996;
        IJth(rJacobian, 27, 27) = -0.59399999999999997 - var_x238;
        IJth(rJacobian, 28, 27) = var_x238;
        IJth(rJacobian, 29, 27) = 0.017999999999999999;
        IJth(rJacobian, 31, 27) = var_x244;
        IJth(rJacobian, 37, 27) = var_x352;
        IJth(rJacobian, 27, 28) = 1.9299999999999999;
        IJth(rJacobian, 28, 28) = -1.9299999999999999;
        IJth(rJacobian, 31, 28) = var_x244;
        IJth(rJacobian, 37, 28) = var_x352;
        IJth(rJacobian, 27, 29) = 0.00080000000000000004;
        IJth(rJacobian, 29, 29) = -0.00080000000000000004;
        IJth(rJacobian, 1, 30) = var_x76 * (0.2735562310030395 * var_x79 + 2.651834266564234e-10 * var_x83);
        IJth(rJacobian, 30, 30) = -0.0032224800206238726 - 4.9248350664764347e-12 * var_x83 - 0.0050803300043421621 * var_x79;
        IJth(rJacobian, 31, 30) = 0.029002320185614851 * var_x242;
        IJth(rJacobian, 30, 31) = 0.0032224800206238726;
        IJth(rJacobian, 31, 31) = var_x243 * (-1.2930970783395158e-9 - var_x245 - var_x246) + 3738095.2380952374 * (1.2930970783395158e-9 * var_chaste_interface__CaSRup__CaSRup - 1.2930970783395158e-9 * var_chaste_interface__CaSRrel__CaSRrel - 8.0254777070063705e-8 * var_x247) / (pow(var_x240, 3) * pow((0.083333333333333329 + var_x241), 2));
        IJth(rJacobian, 37, 31) = var_x345 * (var_x353 + var_x354);
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (2.0669903511809441e-9 * var_x63 - 1.5563478260869561 * var_x64 - 0.073755933228204548 * var_x61 - 0.034631423759269329 * var_x66 - 0.020384613959450324 * var_x18 - 3577.111895407073 * var_x67);
        IJth(rJacobian, 1, 32) = var_x76 * (0.095113591072140277 * var_x64 - 1.2632065385189774e-10 * var_x63 + var_x101 * var_x103 - var_x102 * var_x104);
        IJth(rJacobian, 32, 32) = 3.7896196155569321e-13 * var_x63 - 2.8312989665528797e-6 * var_x18 - 1.1674841756133797e-5 * var_x267 - 6.34932440385169e-6 * var_x66 - 0.21860920312040039 * var_x67 - 0.0019782001513033221 * var_x257 - 0.00028534077321642082 * var_x64 + var_x102 * var_x258 - var_x103 * var_x259;
        IJth(rJacobian, 33, 32) = 4.2328829359011272e-6 * var_x66 + 7.7832278374225309e-6 * var_x267 - 4.5074703447554268e-6 * var_x61 - var_x18 * var_x286;
        IJth(rJacobian, 34, 32) = 0.03506809359128616 * var_x257 + 2.8107077013415861e-5 * var_x18 + 0.00020696310385873547 * var_x267 + var_x103 * var_x306 - var_x102 * var_x307;
        IJth(rJacobian, 35, 32) = var_x102 * var_x325 - var_x103 * var_x326;
        IJth(rJacobian, 36, 32) = -0.00013797540257249032 * var_x267 + var_x18 * var_x335;
        IJth(rJacobian, 40, 32) = -0.020342496988459729 * var_x18 - 25.380532736693361 * var_x257 - 0.049929848805919934 * var_x267 + var_x102 * var_x363 - var_x103 * var_x364 - var_x18 * var_x362;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (1.614870144927536 * var_x72 - 25.433080423518806 * var_x69 - 0.97108125253435462 * var_x70 - 0.29502373291281819 * var_x68 - 429.25342744884875 * var_x67 - 0.035097650984455955 * var_x1 + var_x7 * var_x71);
        IJth(rJacobian, 32, 33) = -0.026233104374448046 * var_x67 - 0.00023738401815639866 * var_x257;
        IJth(rJacobian, 33, 33) = 9.8690084584385102e-5 * var_x72 + 0.00012560556219830832 * var_x299 - 1.8029881379021707e-5 * var_x68 - 0.0015543001188811814 * var_x69 - 5.9346004539099664e-5 * var_x70 - 4.8748503728546144e-6 * var_x1 + var_x278 * var_x71 + var_x296 * var_x71 - var_x1 * var_x287 - var_x1 * var_x289 - var_x1 * var_x295;
        IJth(rJacobian, 34, 33) = 0.0042081712309543391 * var_x257;
        IJth(rJacobian, 36, 33) = 4.8393969155974903e-5 * var_x1 - 0.0022266440571518291 * var_x299 + var_x1 * var_x336 + var_x1 * var_x337 + var_x1 * var_x338 + var_x339 * var_x71;
        IJth(rJacobian, 40, 33) = 1.6115336363636366 * var_x299 - 0.035025135176636836 * var_x1 - 3.045663928403203 * var_x257 + var_x368 * var_x71 - var_x1 * var_x365 - var_x1 * var_x366 - var_x1 * var_x367;
        IJth(rJacobian, 1, 34) = var_x76 * (-var_x101 * var_x106 - var_x104 * var_x105);
        IJth(rJacobian, 32, 34) = 0.0019782001513033221 * var_x269 + 1.9069508687567183e-8 * var_x271 + 1.5855274212696129e-6 * var_x268 + var_x105 * var_x258 + var_x106 * var_x259;
        IJth(rJacobian, 33, 34) = -1.2713005791711456e-8 * var_x271 + var_x268 * var_x286;
        IJth(rJacobian, 34, 34) = -0.0066666666666666671 - 0.03506809359128616 * var_x269 - 2.8107077013415861e-5 * var_x268 - 3.3805038127960006e-7 * var_x271 - var_x105 * var_x307 - var_x106 * var_x306;
        IJth(rJacobian, 35, 34) = var_x105 * var_x325 + var_x106 * var_x326;
        IJth(rJacobian, 36, 34) = 2.2536692085306669e-7 * var_x271 - var_x268 * var_x335;
        IJth(rJacobian, 40, 34) = 0.020342496988459729 * var_x268 + 25.380532736693361 * var_x269 + 8.1554654483703505e-5 * var_x271 + var_x105 * var_x363 + var_x106 * var_x364 + var_x268 * var_x362;
        IJth(rJacobian, 1, 35) = var_x76 * (0.00032046842451113823 * var_x107 + var_x108 * var_x90 - var_x11 * var_x99);
        IJth(rJacobian, 32, 35) = var_x11 * var_x250 - var_x108 * var_x249;
        IJth(rJacobian, 34, 35) = var_x108 * var_x303 - var_x11 * var_x304;
        IJth(rJacobian, 35, 35) = -0.002 - 5.6810311617883583e-6 * var_x107 - 0.0011667637092333111 * var_x327 + var_x11 * var_x309 - var_x108 * var_x308;
        IJth(rJacobian, 37, 35) = 0.51337603206265692 * var_x327 * var_x344;
        IJth(rJacobian, 40, 35) = 0.0082232926066886491 * var_x107 + 1.6888904691152178 * var_x327 + var_x11 * var_x357 - var_x108 * var_x356;
        IJth(rJacobian, 32, 36) = 0.0001093899000634752 * var_x274 + 0.00023738401815639866 * var_x269 - 0.00024612727514281918 * var_x273;
        IJth(rJacobian, 33, 36) = 2.7299162087985846e-6 * var_x300 + 0.00016408485009521278 * var_x273 - 7.2926600042316791e-5 * var_x274 - 7.7870776316372187e-5 * var_x301 + var_x287 * var_x300 + var_x289 * var_x300 + var_x295 * var_x300 - var_x296 * var_x302;
        IJth(rJacobian, 34, 36) = 0.004363165332077249 * var_x273 - 0.0019391845920343328 * var_x274 - 0.0042081712309543391 * var_x269;
        IJth(rJacobian, 36, 36) = -0.0066666666666666671 + 0.0013804364892447795 * var_x301 + 0.0012927897280228886 * var_x274 - 4.8393969155974903e-5 * var_x300 - 0.0029087768880514992 * var_x273 - var_x300 * var_x336 - var_x300 * var_x337 - var_x300 * var_x338 - var_x302 * var_x339;
        IJth(rJacobian, 40, 36) = 0.035025135176636836 * var_x300 + 3.045663928403203 * var_x269 + 0.46782828282828282 * var_x274 - 0.99909090909090914 * var_x301 - 1.0526136363636363 * var_x273 + var_x300 * var_x365 + var_x300 * var_x366 + var_x300 * var_x367 - var_x302 * var_x368;
        IJth(rJacobian, 0, 37) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x40 * var_x55 * var_chaste_interface__i_Cas__Co);
        IJth(rJacobian, 1, 37) = 0.32000000000000001 * var_x75;
        IJth(rJacobian, 9, 37) = var_x164;
        IJth(rJacobian, 13, 37) = var_x164;
        IJth(rJacobian, 26, 37) = -var_x237;
        IJth(rJacobian, 27, 37) = var_x237 - 12150000.0 * var_x239;
        IJth(rJacobian, 28, 37) = 12150000.0 * var_x239;
        IJth(rJacobian, 31, 37) = var_x243 * (var_x245 + var_x246);
        IJth(rJacobian, 35, 37) = 0.0034215944552296509 * var_x328;
        IJth(rJacobian, 37, 37) = var_x345 * (-2496000.0 - var_x353 - var_x354 - 1505.5015603010465 * var_x328 - var_x340 * var_x40 * var_x42) + 2.3800000000000004e-7 * (84000.000000000015 * var_x247 + 2496000.0 * var_chaste_interface__ion_concentrations__Cai - 2496000.0 * var_chaste_interface__ion_concentrations__Cass - var_x341 * var_chaste_interface__Vms__Vms - 1505.5015603010465 * var_x319 * var_x327) / (pow(var_x342, 3) * pow(var_x343, 2));
        IJth(rJacobian, 40, 37) = -4.9527579739449195 * var_x328;
        IJth(rJacobian, 1, 38) = var_x76 * (0.0098000000000000014 + var_x100);
        IJth(rJacobian, 38, 38) = -7.0000000000000007e-5 - 20.0 * var_chaste_interface__ion_concentrations__Cai;
        IJth(rJacobian, 1, 39) = var_x76 * (2.8000000000000003 + var_x100);
        ...
        IJth(rJacobian, 1, 40) = var_x76 * (-2.523013152650459e-5 + var_x109 * var_x90);
        IJth(rJacobian, 4, 40) = var_x126 * var_x127 + 0.27359999999999995 * var_x122 * var_chaste_interface__i_Nat_m_gate__m - 0.064493000000000009 * var_x123 * var_x124 * var_x127 / pow(var_x125, 2);
        IJth(rJacobian, 5, 40) = -var_x133 * var_chaste_interface__i_Nat_h_gate__h - 0.023093279999999997 * var_x128 * (1.0 - var_chaste_interface__i_Nat_h_gate__h) / pow(var_x129, 2) + 0.0041294000000000001 * var_x130 * var_x131 * var_chaste_interface__i_Nat_h_gate__h / pow(var_x132, 2);
        IJth(rJacobian, 10, 40) = 107.49798441279225 * (-var_chaste_interface__i_Cat__Co + 1 / var_x172) * (-var_x166 * (0.072000000000000008 - 0.0040000000000000001 * var_chaste_interface__Vmt__Vmt) - var_x168 * (-0.063 - 0.0089999999999999993 * var_chaste_interface__Vmt__Vmt)) / pow((0.081967213114754092 + var_x167 + 0.34426229508196715 * var_x165), 2) + 0.00020000000000000001 * var_x169 * var_x171 / pow(var_x172, 2);
        IJth(rJacobian, 11, 40) = -var_x183 * var_x188 + 0.090702947845805001 * (var_x186 - var_chaste_interface__i_Cat__C1) * (var_x187 - var_x182 * (-0.625 - 0.013888888888888888 * var_chaste_interface__Vmt__Vmt) - 0.0016000000000000001 * var_x178 / pow(var_x179, 2)) / pow((var_x181 + 0.38095238095238099 * var_x180 + 0.14285714285714285 * var_x176), 2);
        IJth(rJacobian, 12, 40) = -var_x188 * var_x194 + 0.15625 * (var_x186 - var_chaste_interface__i_Cat__C2) * (var_x187 - var_x193 * (-0.65277777777777779 - 0.013888888888888888 * var_chaste_interface__Vmt__Vmt) - 0.016 * var_x189 / pow(var_x190, 2)) / pow((var_x191 + 0.51249999999999996 * var_x192 + 0.1875 * var_x176), 2);
        IJth(rJacobian, 17, 40) = (0.001 / var_x211 - 0.001 * var_chaste_interface__i_Ktot_rt_gate__rt) * (1.6153732000000001 * var_x208 - 9.8900000000000006 * var_x209) + 8.7565674255691772e-5 * var_x210 * (45.159999999999997 * var_x208 + 98.900000000000006 * var_x209) / pow(var_x211, 2);
        IJth(rJacobian, 18, 40) = -var_x214 * var_x217 - 0.0028571428571428571 * var_x213 * (-0.62097840000000015 - 0.0088711200000000014 * var_chaste_interface__Vmt__Vmt) * (var_x218 - var_chaste_interface__i_Ktot_st_gate__st) / pow((0.10000000000000002 + var_x213), 2);
        IJth(rJacobian, 19, 40) = -var_x217 * var_x220 - 0.00027027027027027027 * var_x219 * (-0.15524460000000004 - 0.0022177800000000004 * var_chaste_interface__Vmt__Vmt) * (var_x218 - var_chaste_interface__i_Ktot_sst_gate__sst) / pow((0.00945945945945946 + var_x219), 2);
        IJth(rJacobian, 22, 40) = (0.001 / var_x225 - 0.001 * var_chaste_interface__i_Kstt_rstt_gate__rstt) * (0.16153732000000001 * var_x208 - 0.9890000000000001 * var_x209) + 8.4602368866328257e-5 * var_x224 * (9.8900000000000006 * var_x209 + 4.516 * var_x208) / pow(var_x225, 2);
        IJth(rJacobian, 23, 40) = -4.6232085067036518e-5 * var_x226 / pow((1.0 + var_x226), 2);
        IJth(rJacobian, 25, 40) = (0.001 / var_x234 - 0.001 * var_chaste_interface__i_Kft_qt_gate__qt) * (0.0041892844554106447 * var_x232 - 0.039626497533474282 * var_x231) - 9.5419847328244274e-5 * var_x233 * (0.56230000000000002 * var_x231 + 0.11885 * var_x232) / pow(var_x234, 2);
        IJth(rJacobian, 32, 40) = -6.2413427217572302e-8 - 0.00024612727514281918 * var_x276 - 0.00033790354722997213 * var_x275 - var_x255 * var_chaste_interface__i_Nat_h_gate__h;
        IJth(rJacobian, 33, 40) = -1.0746167131659361e-7 + var_x296 + 4.9443948488187619e-6 * var_x298 + 0.00016408485009521278 * var_x276 - 1.1291262565873969e-6 * var_chaste_interface__i_Kft_qt_gate__qt - 7.7870776316372187e-5 * var_x294 - 7.3977237500553573e-6 * var_x288;
        IJth(rJacobian, 34, 40) = 1.1064198461296908e-6 + 0.005990108337258597 * var_x275 + 0.004363165332077249 * var_x276 + var_x305 * var_chaste_interface__i_Nat_h_gate__h;
        IJth(rJacobian, 35, 40) = 4.4726142251530855e-7 + 0.00026937842087716355 * var_x330 - 0.0019967027790861987 * var_x275 - 0.00026937842087716355 * var_x331 + var_x320 * var_x329;
        IJth(rJacobian, 36, 40) = 1.9050023551577956e-6 + var_x339 + 0.0013804364892447795 * var_x294 + 0.00013114146647825407 * var_x288 + 2.0016329094049303e-5 * var_chaste_interface__i_Kft_qt_gate__qt - 8.7650635956332588e-5 * var_x298 - 0.0029087768880514992 * var_x276;
        IJth(rJacobian, 37, 40) = var_x345 * (118.52650518595198 * var_x331 - 118.52650518595198 * var_x330 - 1505.5015603010465 * var_x355);
        IJth(rJacobian, 40, 40) = -884.72466026051075 + var_x368 + 0.38992526421969426 * var_x331 + 0.063437147773395708 * var_x298 - 0.38992526421969426 * var_x330 - 1.4451136363636365 * var_x275 - 0.014486818181818184 * var_chaste_interface__i_Kft_qt_gate__qt - 4.9527579739449195 * var_x355 - 0.094913636363636381 * var_x288 - 0.99909090909090914 * var_x294 - 1.0526136363636363 * var_x276 - var_x358 * var_chaste_interface__i_Nat_h_gate__h;
    }
