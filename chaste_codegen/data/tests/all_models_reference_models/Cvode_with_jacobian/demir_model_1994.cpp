...
#include "MathsCustomFunctions.hpp"
    ...
    double Celldemir_model_1994FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel__g_Ca_L = 021149999999999999; // microS
        const double var_T_type_Ca_channel__E_Ca_T = 45.0; // millivolt
        const double var_T_type_Ca_channel__g_Ca_T = 02521; // microS
        const double var_calcium_pump_current__i_Ca_P_max = 02869; // nanoA
        const double var_cleft_space_equations__K_b = 5.4000000000000004; // millimolar
        const double var_delayed_rectifying_potassium_current__g_K = 0069300000000000004 * pow(var_cleft_space_equations__K_b, 0.58999999999999997); // microS
        const double var_hyperpolarisation_activated_current__g_f_K = 0128821; // microS
        const double var_hyperpolarisation_activated_current__g_f_Na = 0067478; // microS
        const double var_calcium_pump_current__i_Ca_P = var_calcium_pump_current__i_Ca_P_max * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i / (00040000000000000002 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i); // nanoA
        ...
        const double var_linear_background_current__g_B_Na = 00016000000000000001; // microS
    ...
    void Celldemir_model_1994FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_SR_Ca_uptake_and_release__alpha_up = 080000000000000002; // nanoA
        const double var_SR_Ca_uptake_and_release__beta_up = 071999999999999995; // nanoA
        ...
        const double var_SR_Ca_uptake_and_release__k_rel = 0040000000000000001; // millimolar
        ...
        const double d_dt_chaste_interface_var_SR_Ca_uptake_and_release__Ca_Calse = 001 * var_SR_Ca_uptake_and_release__Ca_Calse_orig_deriv; // 1 / millisecond
        const double var_T_type_Ca_channel__E_Ca_T = 45.0; // millivolt
        const double var_T_type_Ca_channel__g_Ca_T = 02521; // microS
        const double var_calcium_pump_current__i_Ca_P_max = 02869; // nanoA
        ...
        const double var_cleft_space_equations__tau_p = 01; // second
        const double var_delayed_rectifying_potassium_current__g_K = 0069300000000000004 * pow(var_cleft_space_equations__K_b, 0.58999999999999997); // microS
        const double var_hyperpolarisation_activated_current__g_f_K = 0128821; // microS
        const double var_hyperpolarisation_activated_current__g_f_Na = 0067478; // microS
        ...
        const double d_dt_chaste_interface_var_SR_Ca_uptake_and_release__F3 = 001 * var_SR_Ca_uptake_and_release__F3_orig_deriv; // 1 / millisecond
        const double var_calcium_pump_current__i_Ca_P = var_calcium_pump_current__i_Ca_P_max * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i / (00040000000000000002 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i); // nanoA
        ...
        const double var_SR_Ca_uptake_and_release__V_rel = 0012960000000000001 * var_intracellular_concentrations_and_buffer_equations__V_i; // microLitre
        const double var_SR_Ca_uptake_and_release__V_up = 01166 * var_intracellular_concentrations_and_buffer_equations__V_i; // microLitre
        ...
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Ca_Calmod = 001 * var_intracellular_concentrations_and_buffer_equations__Ca_Calmod_orig_deriv; // 1 / millisecond
        const double var_intracellular_concentrations_and_buffer_equations__F_C = 089999999999999997 * var_intracellular_concentrations_and_buffer_equations__phi_C; // millimolar_per_second
        ...
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Ca_Trop = 001 * var_intracellular_concentrations_and_buffer_equations__Ca_Trop_orig_deriv; // 1 / millisecond
        const double var_intracellular_concentrations_and_buffer_equations__F_TC = 031 * var_intracellular_concentrations_and_buffer_equations__phi_TC; // millimolar_per_second
        ...
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop = 001 * var_intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop_orig_deriv; // 1 / millisecond
        const double var_intracellular_concentrations_and_buffer_equations__F_TMgC = 062 * var_intracellular_concentrations_and_buffer_equations__phi_TMgC; // millimolar_per_second
        ...
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop = 001 * var_intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop_orig_deriv; // 1 / millisecond
        const double var_linear_background_current__g_B_Ca = 3.6399999999999997e-5; // microS
        const double var_linear_background_current__g_B_K = 6.9400000000000006e-5; // microS
        const double var_linear_background_current__g_B_Na = 00016000000000000001; // microS
        const double var_membrane__F = 96485.341499999995; // coulomb_per_mole
        ...
        const double d_dt_chaste_interface_var_SR_Ca_uptake_and_release__Ca_rel = 001 * var_SR_Ca_uptake_and_release__Ca_rel_orig_deriv; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_SR_Ca_uptake_and_release__Ca_up = 001 * var_SR_Ca_uptake_and_release__Ca_up_orig_deriv; // millimolar / millisecond
        const double var_membrane__R = 8314.4719999999998; // joule_per_kilomole_kelvin
        const double var_membrane__T = 310; // kelvin
        ...
        const double var_L_type_Ca_channel_f_gate__beta_f_L = 30 / (1.0 + exp(-7.0 - 0.25 * var_chaste_interface__membrane__V)); // per_second
        ...
        const double var_SR_Ca_uptake_and_release__r_act = 240 * exp(-3.2000000000000002 + 080000000000000002 * var_chaste_interface__membrane__V) + 240 * pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i, 4) / pow((var_SR_Ca_uptake_and_release__k_rel + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i), 4); // per_second
        ...
        const double d_dt_chaste_interface_var_SR_Ca_uptake_and_release__F1 = 001 * var_SR_Ca_uptake_and_release__F1_orig_deriv; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_SR_Ca_uptake_and_release__F2 = 001 * var_SR_Ca_uptake_and_release__F2_orig_deriv; // 1 / millisecond
        const double var_T_type_Ca_channel__i_Ca_T = (-var_T_type_Ca_channel__E_Ca_T + var_chaste_interface__membrane__V) * var_T_type_Ca_channel__g_Ca_T * var_chaste_interface__T_type_Ca_channel_d_gate__d_T * var_chaste_interface__T_type_Ca_channel_f_gate__f_T; // nanoA
        ...
        const double var_T_type_Ca_channel_f_gate__alpha_f_T = 15.300000000000001 * exp(-0.74069627851140463 - 012004801920768308 * var_chaste_interface__membrane__V); // per_second
        const double var_T_type_Ca_channel_f_gate__beta_f_T = 15.0 * exp(4.0117035110533159 + 065019505851755519 * var_chaste_interface__membrane__V); // per_second
        ...
        const double var_delayed_rectifying_potassium_current_P_a_gate__tau_P_a = 1.0 / (17.0 * exp(039800000000000002 * var_chaste_interface__membrane__V) + 2.1099999999999999 * exp(-050999999999999997 * var_chaste_interface__membrane__V)); // second
        ...
        const double d_dt_chaste_interface_var_delayed_rectifying_potassium_current_P_a_gate__P_a = 001 * var_delayed_rectifying_potassium_current_P_a_gate__P_a_orig_deriv; // 1 / millisecond
        const double var_delayed_rectifying_potassium_current_P_i_gate__alpha_P_i = 100 * exp(-0183 * var_chaste_interface__membrane__V); // per_second
        const double var_delayed_rectifying_potassium_current_P_i_gate__beta_P_i = 656.0 * exp(0094199999999999996 * var_chaste_interface__membrane__V); // per_second
        ...
        const double d_dt_chaste_interface_var_delayed_rectifying_potassium_current_P_i_gate__P_i = 001 * var_delayed_rectifying_potassium_current_P_i_gate__P_i_orig_deriv; // 1 / millisecond
        const double var_hyperpolarisation_activated_current__i_f_K = pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2) * (85.0 + var_chaste_interface__membrane__V) * var_hyperpolarisation_activated_current__g_f_K; // nanoA
        const double var_hyperpolarisation_activated_current__i_f_Na = pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2) * (-75.0 + var_chaste_interface__membrane__V) * var_hyperpolarisation_activated_current__g_f_Na; // nanoA
        const double var_hyperpolarisation_activated_current_y_gate__tau_y = 1.0 / (1.6483000000000001 * exp(-2.2219482120838472 - 041101520756267988 * var_chaste_interface__membrane__V) + 14.01055 / (0.69999999999999996 + exp(-10.909090909090908 - 0.18181818181818182 * var_chaste_interface__membrane__V))); // second
        ...
        const double d_dt_chaste_interface_var_cleft_space_equations__Ca_c = 001 * var_cleft_space_equations__Ca_c_orig_deriv; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Ca_i = 001 * var_intracellular_concentrations_and_buffer_equations__Ca_i_orig_deriv; // millimolar / millisecond
        const double var_sodium_current__P_Na = 0034399999999999999; // mul_per_second
        ...
        const double d_dt_chaste_interface_var_cleft_space_equations__K_c = 001 * var_cleft_space_equations__K_c_orig_deriv; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_cleft_space_equations__Na_c = 001 * var_cleft_space_equations__Na_c_orig_deriv; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__K_i = 001 * var_intracellular_concentrations_and_buffer_equations__K_i_orig_deriv; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Na_i = 001 * var_intracellular_concentrations_and_buffer_equations__Na_i_orig_deriv; // millimolar / millisecond
    ...
    void Celldemir_model_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x61 = 012424666784589715 * var_x60;
        const double var_x62 = 001 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        const double var_x63 = var_x20 * var_x48;
        const double var_x64 = 001 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L;
        const double var_x65 = 001 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T;
        const double var_x66 = var_x48 * (1.13445 - 02521 * var_chaste_interface__membrane__V);
        const double var_x67 = 001 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T;
        ...
        const double var_x70 = 0.50070344964891056 * var_x69 - 018743278268729353 * var_chaste_interface__membrane__V;
        const double var_x71 = 001 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        ...
        const double var_x92 = 0043093582521187886 * var_x91;
        const double var_x93 = var_x38 / pow(var_x36, 3);
        const double var_x94 = var_x37 * var_chaste_interface__cleft_space_equations__K_c;
        const double var_x95 = 0031274360147155781 - 6.7401638248180558e-5 * var_chaste_interface__membrane__V;
        ...
        const double var_x101 = 0036153091494396427 - 8.0340203320880944e-5 * var_chaste_interface__membrane__V;
        ...
        const double var_x109 = 0031868386878572373 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel;
        ...
        const double var_x121 = (var_x116 + var_x120 + 3703.370786516854 * var_x112) / pow((var_x112 - 025000000000000001 * var_x119), 2);
        ...
        const double var_x126 = 165.0 * var_x124 + 12360 * var_x125;
        const double var_x127 = 1 / var_x126;
        const double var_x128 = 13.095238095238095 * var_x124;
        const double var_x129 = var_x124 / pow((0031250000000000002 + var_x124), 2);
        const double var_x130 = 3.0654761904761907 * var_x129;
        const double var_x131 = -013095238095238096 * var_x124 * var_x127 + 1.0800578125490936e-9 * var_x124 * (var_x128 - var_x130) / pow((var_x125 + 013349514563106795 * var_x124), 2);
        ...
        const double var_x161 = 033333333333333333 * var_chaste_interface__membrane__V;
        ...
        const double var_x166 = exp(4.0117035110533159 + 065019505851755519 * var_chaste_interface__membrane__V);
        const double var_x167 = exp(-0.74069627851140463 - 012004801920768308 * var_chaste_interface__membrane__V);
        ...
        const double var_x170 = exp(039800000000000002 * var_chaste_interface__membrane__V);
        const double var_x171 = exp(-050999999999999997 * var_chaste_interface__membrane__V);
        const double var_x172 = exp(-0183 * var_chaste_interface__membrane__V);
        const double var_x173 = exp(0094199999999999996 * var_chaste_interface__membrane__V);
        ...
        const double var_x176 = exp(-2.2219482120838472 - 041101520756267988 * var_chaste_interface__membrane__V);
        ...
        const double var_x180 = 079190817585730572 * var_x28;
        ...
        const double var_x185 = 079190817585730572 * var_x43;
        const double var_x186 = var_x27 * var_x42;
        const double var_x187 = 8.2399377586133985e-5 * var_x91;
        const double var_x188 = 0031913222489694526 * var_x69 - 00011946360864812104 * var_chaste_interface__membrane__V;
        const double var_x189 = 0031913222489694526 * var_x19;
        ...
        const double var_x199 = 00028173316601141397 * var_x91;
        const double var_x200 = -010693071667961351 + 00023045413077502912 * var_chaste_interface__membrane__V;
        const double var_x201 = 2.7196856284372236e-7 * var_x12;
        const double var_x202 = 2.7196856284372237e-11 * var_x56;
        const double var_x203 = -012361167312422308 + 00027469260694271792 * var_chaste_interface__membrane__V;
        const double var_x204 = 00040846013251011971 * var_chaste_interface__membrane__V - 010911506218902908 * var_x69;
        const double var_x205 = 010911506218902908 * var_x19;
        const double var_x206 = 00018782211067427598 * var_x91;
        const double var_x207 = 2.4589804690256458 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel;
        const double var_x208 = exp(-3.2000000000000002 + 080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x209 = 019200000000000002 * var_x208 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        const double var_x210 = 0040000000000000001 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        ...
        IJth(rJacobian, 3, 0) = var_x126 * var_x131 + (var_x130 - var_x128) * (var_x133 - 001 * var_chaste_interface__sodium_current_h_gate__h1);
        IJth(rJacobian, 4, 0) = var_x131 * (8.25 * var_x124 + 618.0 * var_x125) + (var_x133 - 001 * var_chaste_interface__sodium_current_h_gate__h2) * (0.15327380952380953 * var_x129 - 0.65476190476190477 * var_x124);
        IJth(rJacobian, 5, 0) = (-var_x64 + 001 * var_x4) * (var_x137 - var_x141 - var_x145 - 11.356 * var_x138 * var_x146 / pow(var_x139, 2) - 17.659200000000002 * var_x142 * var_chaste_interface__membrane__V / pow(var_x143, 2) - 4.5720000000000001 * var_x134 * var_x147 / pow(var_x135, 2)) + 00016666666666666666 * var_x21 * (var_x137 * var_x147 - var_x141 * var_x146 - var_x145 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 6, 0) = (-var_x62 + 001 / var_x149) * (var_x154 + 7.5 * var_x155 / pow(var_x156, 2) - 0.9375 * var_x151 * var_x157 / pow(var_x152, 2)) - 00020000000000000001 * var_x148 * (30 * var_x158 + var_x154 * var_x157) / pow(var_x149, 2);
        IJth(rJacobian, 7, 0) = (-var_x67 + 001 / var_x160) * (35.600000000000001 * var_x162 - 35.600000000000001 * var_x163) + 00016666666666666666 * var_x159 * (1068.0 * var_x162 + 1068.0 * var_x163) / pow(var_x160, 2);
        IJth(rJacobian, 8, 0) = (-var_x65 + 001 / var_x165) * (0.97529258777633288 * var_x166 - 0.18367346938775511 * var_x167) - 0001785714285714286 * var_x164 * (15.0 * var_x166 + 15.300000000000001 * var_x167) / pow(var_x165, 2);
        IJth(rJacobian, 9, 0) = (-var_x71 + 001 / var_x169) * (0.67660000000000009 * var_x170 - 0.10760999999999998 * var_x171) + 00013513513513513514 * var_x168 * (17.0 * var_x170 + 2.1099999999999999 * var_x171) / pow(var_x169, 2);
        IJth(rJacobian, 10, 0) = -0183 * var_x172 * (0.10000000000000001 - 0.10000000000000001 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i) - 00617952 * var_x173 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        IJth(rJacobian, 11, 0) = (001 / var_x175 - 001 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y) * (-067747636662556524 * var_x176 + 2.5473727272727271 * var_x177 / pow(var_x178, 2)) - 00011111111111111112 * var_x174 * (1.6483000000000001 * var_x176 + 14.01055 * var_x179) / pow(var_x175, 2);
        IJth(rJacobian, 12, 0) = -1.0197883801143159e-6 + 0029644204196681901 * var_x47 - 0029644204196681901 * var_x44 - 2.3863048094674991e-7 * var_x18 - 4.3008300195846133e-5 * var_x0 - 4.5777431992296659e-7 * var_x41 - var_x180 * var_x33;
        IJth(rJacobian, 13, 0) = -4.4233320987458456e-7 + 3.0518287994864439e-7 * var_x41 - 8.2106349321691435e-5 * var_x0 - 00011946360864812104 * var_x19;
        IJth(rJacobian, 18, 0) = 3.486776446714389e-6 + 010135702170189033 * var_x44 + 1.5651842556189666e-6 * var_x41 + 8.1590568853116704e-7 * var_x18 + 00014705043816962094 * var_x0 - 010135702170189033 * var_x47 + var_x192 * var_x33;
        IJth(rJacobian, 19, 0) = 3.9662082081376168e-7 + 00023045413077502912 * var_x5 + 00027469260694271792 * var_x6 + 2.1893142423627767e-5 * var_x4 - 2.7196856284372236e-7 * var_x18 + var_x200 * var_x22;
        IJth(rJacobian, 20, 0) = 1.5123892837623664e-6 + 00028073126790137144 * var_x0 + 00040846013251011971 * var_x19 - 1.0434561704126445e-6 * var_x41;
        IJth(rJacobian, 24, 0) = -var_x209;
        IJth(rJacobian, 25, 0) = var_x209;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (var_x49 * (02869 * var_x53 - 02869 * var_x51 - 00048619044400646078 * var_x52 + var_x54 * var_x55 + var_x57 * var_x7));
        IJth(rJacobian, 1, 1) = -21.173500000000001 + 0031868386878572373 * var_x98 + 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop + 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop + 11.609999999999999 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Calmod + 9.1430401954624137e-5 * var_x53 + 1.5655000000000001 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Trop - 00025494709502857897 * var_x97 - 1.5494105166262771e-6 * var_x52 - 9.1430401954624137e-5 * var_x51 - var_x100 * var_x7 - var_x55 * var_x99;
        ...
        IJth(rJacobian, 19, 1) = 00031261130080073693 * var_x51 + 5.2976168399354324e-6 * var_x52 - 00031261130080073693 * var_x53 + var_x201 * var_x55 + var_x202 * var_x7;
        IJth(rJacobian, 21, 1) = 021865102489586532 * var_x97 - 0.27331378111983168 * var_x98;
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (-037274000353769147 * var_x58 * var_x59 * var_chaste_interface__membrane__V * var_chaste_interface__sodium_current_h_gate__h1);
        ...
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (-var_x58 * var_x61);
        ...
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (-var_x28 * var_x48 * var_x61 * var_chaste_interface__sodium_current_h_gate__h1);
        IJth(rJacobian, 4, 4) = -0082500000000000004 * var_x124 - 0.61799999999999999 * var_x125;
        ...
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (var_x62 * var_x63);
        IJth(rJacobian, 1, 5) = var_x95 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        IJth(rJacobian, 5, 5) = 028390000000000002 * var_x140 * var_x146 + 084900000000000003 * var_x144 * var_chaste_interface__membrane__V - 011429999999999999 * var_x136 * var_x147;
        IJth(rJacobian, 19, 5) = var_x200 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (var_x63 * var_x64);
        IJth(rJacobian, 1, 6) = var_x95 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L;
        IJth(rJacobian, 6, 6) = -029999999999999999 * var_x158 - 0037499999999999999 * var_x153 * var_x157;
        IJth(rJacobian, 19, 6) = var_x200 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (var_x65 * var_x66);
        ...
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (var_x66 * var_x67);
        IJth(rJacobian, 1, 8) = var_x101 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T;
        IJth(rJacobian, 8, 8) = -014999999999999999 * var_x166 - 015300000000000001 * var_x167;
        IJth(rJacobian, 19, 8) = var_x203 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0 : (var_x49 * var_x70 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i);
        IJth(rJacobian, 9, 9) = -017000000000000001 * var_x170 - 0021099999999999999 * var_x171;
        ...
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0 : (var_x48 * var_x70 * var_x71);
        ...
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0 : (var_x49 * (-025764200000000001 * var_x72 - 0134956 * var_x73));
        IJth(rJacobian, 11, 11) = -0016483000000000001 * var_x176 - 01401055 * var_x179;
        IJth(rJacobian, 12, 11) = -8.6016600391692266e-5 * var_x73;
        IJth(rJacobian, 13, 11) = -00016421269864338287 * var_x72;
        IJth(rJacobian, 18, 11) = 00029410087633924189 * var_x73;
        IJth(rJacobian, 20, 11) = 00056146253580274287 * var_x72;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0 : (var_x49 * (0011838896297029639 * var_x81 - 0042742017055513041 * var_x24 - 0064640373781781829 * var_x82 + var_x75 * var_x76 - var_x25 * var_x83 - var_x77 * var_x78));
        IJth(rJacobian, 1, 12) = var_x102 * var_x78 - var_x103 * var_x75;
        IJth(rJacobian, 12, 12) = 2.2637191644542304e-5 * var_x81 - 00012359906637920097 * var_x82 - 2.7242382709912566e-5 * var_x24 + var_x183 * var_x75 - var_x184 * var_x78 - var_x185 * var_x25;
        IJth(rJacobian, 13, 12) = 8.2399377586133985e-5 * var_x82 - 1.5091461096361535e-5 * var_x81;
        IJth(rJacobian, 18, 12) = 00042259974901712096 * var_x82 + 9.3144911471392233e-5 * var_x24 - 7.739922143170714e-5 * var_x81 + var_x196 * var_x78 + var_x198 * var_x25 - var_x197 * var_x75;
        IJth(rJacobian, 19, 12) = var_x194 * var_x75 - var_x193 * var_x78;
        IJth(rJacobian, 20, 12) = 5.1599480954471424e-5 * var_x81 - 00028173316601141397 * var_x82;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0 : (var_x49 * (-0018539349897828783 * var_x68 - var_x68 * var_x84));
        ...
        IJth(rJacobian, 1, 14) = 027629999999999998 + 11.609999999999999 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        IJth(rJacobian, 14, 14) = -0.307 + var_x191;
        IJth(rJacobian, 1, 15) = 0078120000000000004 + 1.5655000000000001 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        IJth(rJacobian, 15, 15) = -0.252 - 50.5 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        IJth(rJacobian, 1, 16) = 00026350000000000001 + var_x104;
        IJth(rJacobian, 16, 16) = -0042500000000000003 + var_x191;
        ...
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0 : (var_x49 * (var_x83 + 0042742017055513041 * var_x85 + var_x76 * var_x86 + var_x77 * var_x87 - var_x27 * var_x34 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 1, 18) = -var_x102 * var_x87 - var_x103 * var_x86;
        IJth(rJacobian, 12, 18) = var_x185 + 2.7242382709912566e-5 * var_x85 - 079190817585730572 * var_x186 + var_x183 * var_x86 + var_x184 * var_x87;
        ...
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0 : (var_x49 * (00048619044400646078 * var_x88 + var_x57 * var_x9 - var_x54 * var_x89));
        ...
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0 : (var_x49 * (0018539349897828783 * var_x90 + var_x84 * var_x90 + var_x92 * var_x93 - var_x92 * var_x94));
        ...
        IJth(rJacobian, 21, 21) = -015581177937052042 - 4.0251665946738841e-8 * var_x97 - 5.5905091592692838e-7 * var_x98;
        IJth(rJacobian, 22, 21) = 0.14018251137810708;
        IJth(rJacobian, 1, 22) = 0015934193439286187 * var_x108;
        IJth(rJacobian, 21, 22) = 015581177937052042;
        ...
        IJth(rJacobian, 25, 25) = -040000000000000001 + var_x218;
        IJth(rJacobian, 26, 25) = 040000000000000001 + var_x217;
        IJth(rJacobian, 24, 26) = 00096000000000000002;
        IJth(rJacobian, 26, 26) = -00096000000000000002;
    }
