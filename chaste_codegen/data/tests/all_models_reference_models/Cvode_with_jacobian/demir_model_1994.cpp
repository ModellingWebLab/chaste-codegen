...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldemir_model_1994FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_membrane__R = 8314.4719999999998; // joule_per_kilomole_kelvin
        const double var_membrane__T = 310.0; // kelvin
        const double var_L_type_Ca_channel_d_gate__alpha_d_L = -28.390000000000001 * (35.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)) + ((fabs(var_chaste_interface__membrane__V) < 4.8076923076923074e-7) ? (4.0817307692307694e-5 / (-1.0 + exp(9.9999999999999995e-8)) + 1040000.0 * (4.8076923076923074e-7 + var_chaste_interface__membrane__V) * (-4.0817307692307694e-5 / (-1.0 + exp(9.9999999999999995e-8)) - 4.0817307692307694e-5 / (-1.0 + exp(-9.9999999999999995e-8)))) : (-84.900000000000006 * var_chaste_interface__membrane__V / (-1.0 + exp(-0.20799999999999999 * var_chaste_interface__membrane__V)))); // per_second
        const double var_L_type_Ca_channel_d_gate__beta_d_L = ((fabs(-5.0 + var_chaste_interface__membrane__V) < 2.4999999981289989e-7) ? (2.8575000029373855e-6 / (-1.0 + exp(1.0000000010279565e-7)) - 2000000.0014968009 * (-5.0000002500000003 + var_chaste_interface__membrane__V) * (-2.8574999927855059e-6 / (-1.0 + exp(-9.9999999747524276e-8)) - 2.8575000029373855e-6 / (-1.0 + exp(1.0000000010279565e-7)))) : (11.43 * (-5.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V)))); // per_second
        const double var_L_type_Ca_channel_d_gate__d_L_infinity = 1 / (1.0 + exp(-2.3500000000000001 - 0.16666666666666666 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_L_type_Ca_channel__i_Ca_L = (-var_L_type_Ca_channel__E_Ca_L + var_chaste_interface__membrane__V) * (0.095000000000000001 * var_L_type_Ca_channel_d_gate__d_L_infinity + var_chaste_interface__L_type_Ca_channel_d_gate__d_L * var_chaste_interface__L_type_Ca_channel_f_gate__f_L) * NV_Ith_S(mParameters, 0); // nanoA
        ...
        const double var_sodium_current_m_gate__alpha_m = ((fabs(51.899999999999999 + var_chaste_interface__membrane__V) < 8.8999999903194293e-7) ? (0.00073335999627488491 / (-1.0 + exp(9.999999949204822e-8)) + 561797.75342005875 * (51.900000889999994 + var_chaste_interface__membrane__V) * (-0.00073335999627488491 / (-1.0 + exp(9.999999949204822e-8)) - 0.00073336000212975705 / (-1.0 + exp(-1.0000000029041085e-7)))) : (-824.0 * (51.899999999999999 + var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)))); // per_second
    ...
    void Celldemir_model_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x73 = 0.5 - 187169.45411372735 * var_chaste_interface__membrane__V;
        ...
        const double var_x76 = 0.02894560245 * var_x75;
        const double var_x77 = var_x4 * var_x5 * var_x76;
        const double var_x78 = var_x25 * var_chaste_interface__membrane__V;
        const double var_x79 = ((var_x18) ? (var_x77 + var_x73 * (-var_x77 - var_x13 * var_x14 * var_x76)) : (10835.465219118938 * var_x21 * var_x75 * var_x78));
        ...
        const double var_x82 = var_x8 * var_x81;
        const double var_x83 = var_x13 * var_x80;
        ...
        const double var_x86 = ((var_x18) ? (var_x82 + var_x73 * (-var_x82 - var_x15 * var_x83)) : (var_x84 * var_x85));
        const double var_x87 = var_x6 * var_x74;
        const double var_x88 = var_x5 * var_x81 * var_x87;
        const double var_x89 = ((var_x18) ? (var_x88 + var_x73 * (-var_x88 - var_x14 * var_x83 * var_x87)) : (var_x78 * var_x85 * var_x87));
        ...
        const double var_x105 = var_x1 * var_x104;
        const double var_x106 = var_x103 * var_x12 * var_x15;
        ...
        const double var_x109 = ((var_x18) ? (var_x105 + var_x73 * (-var_x105 - var_x1 * var_x106)) : (var_x1 * var_x108));
        ...
        const double var_x121 = var_x120 * var_x9;
        const double var_x122 = ((var_x18) ? (var_x121 - var_x104 + var_x73 * (var_x104 + var_x106 - var_x121 - var_x120 * var_x16)) : (-var_x108 + var_x107 * var_x22));
        ...
        const double var_x151 = 1 / (-1.0 + exp(9.999999949204822e-8));
        const double var_x152 = 0.00073335999627488491 * var_x151;
        const double var_x153 = 1 / (-1.0 + exp(-1.0000000029041085e-7));
        const double var_x154 = 51.899999999999999 + var_chaste_interface__membrane__V;
        const double var_x155 = fabs(var_x154) < 8.8999999903194293e-7;
        const double var_x156 = -1.0 + var_x150;
        const double var_x157 = 824.0 / var_x156;
        const double var_x158 = ((var_x155) ? (var_x152 + 561797.75342005875 * (51.900000889999994 + var_chaste_interface__membrane__V) * (-var_x152 - 0.00073336000212975705 * var_x153)) : (-var_x154 * var_x157));
        const double var_x159 = 1 / (var_x158 + 32960.0 * var_x150);
        const double var_x160 = ((var_x155) ? (-411.99999835537301 * var_x151 - 412.00000164462699 * var_x153) : (-var_x157 - 92.584269662921344 * var_x150 * var_x154 / pow(var_x156, 2)));
        ...
        const double var_x174 = 1 / (-1.0 + exp(-9.9999999747524276e-8));
        const double var_x175 = 1 / (-1.0 + exp(1.0000000010279565e-7));
        const double var_x176 = -5.0 + var_chaste_interface__membrane__V;
        const double var_x177 = fabs(var_x176) < 2.4999999981289989e-7;
        ...
        const double var_x181 = 1 / (-1.0 + exp(9.9999999999999995e-8));
        const double var_x182 = 1 / (-1.0 + exp(-9.9999999999999995e-8));
        const double var_x183 = exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V);
        const double var_x184 = -1.0 + var_x183;
        const double var_x185 = 28.390000000000001 / var_x184;
        const double var_x186 = 35.0 + var_chaste_interface__membrane__V;
        const double var_x187 = -var_x185 - 11.356 * var_x183 * var_x186 / pow(var_x184, 2);
        const double var_x188 = var_x17 < 4.8076923076923074e-7;
        const double var_x189 = exp(-0.20799999999999999 * var_chaste_interface__membrane__V);
        const double var_x190 = -1.0 + var_x189;
        const double var_x191 = 84.900000000000006 / var_x190;
        const double var_x192 = 2.8575000029373855e-6 * var_x175;
        const double var_x193 = ((var_x177) ? (var_x192 - 2000000.0014968009 * (-5.0000002500000003 + var_chaste_interface__membrane__V) * (-var_x192 - 2.8574999927855059e-6 * var_x174)) : (var_x176 * var_x180));
        const double var_x194 = 4.0817307692307694e-5 * var_x181;
        const double var_x195 = -var_x185 * var_x186;
        const double var_x196 = ((var_x188) ? (var_x194 + var_x195 + 1040000.0 * (4.8076923076923074e-7 + var_chaste_interface__membrane__V) * (-var_x194 - 4.0817307692307694e-5 * var_x182)) : (var_x195 - var_x191 * var_chaste_interface__membrane__V));
        const double var_x197 = exp(6.0 + 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x200 = exp(7.0 + var_x199);
        const double var_x201 = -1.0 + var_x200;
        const double var_x202 = 1 / var_x201;
        const double var_x203 = 3.75 * var_x202;
        const double var_x204 = exp(-7.0 - var_x199);
        const double var_x205 = 1.0 + var_x204;
        const double var_x206 = 28.0 + var_chaste_interface__membrane__V;
        const double var_x207 = 1 / var_x205;
        const double var_x208 = exp(-4.3833333333333337 + var_x30);
        const double var_x209 = 1.0 + var_x208;
        const double var_x210 = 0.033333333333333333 * var_chaste_interface__membrane__V;
        const double var_x211 = exp(0.87666666666666671 + var_x210);
        const double var_x212 = exp(-0.87666666666666671 - var_x210);
        const double var_x213 = exp(11.017857142857144 + 0.17857142857142858 * var_chaste_interface__membrane__V);
        const double var_x214 = 1.0 + var_x213;
        const double var_x215 = exp(4.0117035110533159 + 0.065019505851755519 * var_chaste_interface__membrane__V);
        const double var_x216 = exp(-0.74069627851140463 - 0.012004801920768308 * var_chaste_interface__membrane__V);
        const double var_x217 = exp(0.039800000000000002 * var_chaste_interface__membrane__V);
        const double var_x218 = exp(-0.050999999999999997 * var_chaste_interface__membrane__V);
        const double var_x219 = exp(-0.68918918918918914 - 0.13513513513513511 * var_chaste_interface__membrane__V);
        const double var_x220 = 1.0 + var_x219;
        const double var_x221 = exp(-0.0183 * var_chaste_interface__membrane__V);
        const double var_x222 = exp(0.0094199999999999996 * var_chaste_interface__membrane__V);
        const double var_x223 = exp(8.0222222222222221 + 0.1111111111111111 * var_chaste_interface__membrane__V);
        const double var_x224 = 1.0 + var_x223;
        const double var_x225 = exp(-2.2219482120838472 - 0.041101520756267988 * var_chaste_interface__membrane__V);
        const double var_x226 = exp(-10.909090909090908 - 0.18181818181818182 * var_chaste_interface__membrane__V);
        const double var_x227 = 0.69999999999999996 + var_x226;
        const double var_x228 = 1 / var_x227;
        const double var_x229 = 2.3863048094674991e-7 * var_x44;
        const double var_x230 = 2.3863048094674993e-11 * var_x71;
        const double var_x231 = 0.012747354751428948 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        const double var_x232 = 7.158914428402498e-11 * var_x71;
        const double var_x233 = 7.1589144284024978e-7 * var_x44;
        const double var_x234 = 8.2399377586133985e-5 * var_x129;
        const double var_x235 = (0.46050826103455306 * var_x97 - 0.01723861596653983 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2);
        const double var_x236 = 0.46050826103455306 * var_x52;
        const double var_x237 = 5.493291839075599e-5 * var_x129;
        const double var_x238 = -129.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x239 = 8.1590568853116704e-7 * var_x44;
        const double var_x240 = 8.159056885311671e-11 * var_x71;
        const double var_x241 = 0.043584705583929857 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        const double var_x242 = 2.447717065593501e-6 * var_x44;
        const double var_x243 = 2.4477170655935014e-10 * var_x71;
        const double var_x244 = 0.00028173316601141397 * var_x129;
        const double var_x245 = (-0.50558258477358631 + 0.010896176395982464 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 0);
        const double var_x246 = 2.7196856284372237e-11 * var_x71;
        const double var_x247 = 2.7196856284372236e-7 * var_x44;
        const double var_x248 = -0.012361167312422308 + 0.00027469260694271792 * var_chaste_interface__membrane__V;
        const double var_x249 = (0.058940856062066331 * var_chaste_interface__membrane__V - 1.5745319219196114 * var_x97) * NV_Ith_S(mParameters, 2);
        const double var_x250 = 1.5745319219196114 * var_x52;
        const double var_x251 = 0.00018782211067427598 * var_x129;
        const double var_x252 = 2.4589804690256458 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel;
        const double var_x253 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x254 = 0.019200000000000002 * var_x253 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        const double var_x255 = 0.0040000000000000001 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x256 = pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i, 4);
        const double var_x257 = 0.95999999999999996 * var_x256 / pow(var_x255, 5);
        const double var_x258 = pow(var_x255, (-4));
        const double var_x259 = 0.95999999999999996 * var_x258 * pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i, 3);
        const double var_x260 = var_x257 - var_x259;
        const double var_x261 = 0.23999999999999999 * var_x253;
        const double var_x262 = 0.23999999999999999 * var_x256 * var_x258;
        const double var_x263 = -var_x262;
        const double var_x264 = var_x259 - var_x257;
        ...
        IJth(rJacobian, 5, 0) = (-var_x92 + 0.001 * var_x33) * (((var_x177) ? (5.7149999898481205 * var_x174 + 5.7150000101518792 * var_x175) : (var_x180 - 4.5720000000000001 * var_x176 * var_x178 / pow(var_x179, 2))) + ((var_x188) ? (var_x187 - 42.450000000000003 * var_x181 - 42.450000000000003 * var_x182) : (var_x187 - var_x191 - 17.659200000000002 * var_x189 * var_chaste_interface__membrane__V / pow(var_x190, 2)))) + 0.00016666666666666666 * var_x54 * (var_x193 + var_x196);
        IJth(rJacobian, 6, 0) = (-var_x90 + 0.001 / var_x198) * (var_x203 + 7.5 * var_x204 / pow(var_x205, 2) - 0.9375 * var_x200 * var_x206 / pow(var_x201, 2)) - 0.00020000000000000001 * var_x197 * (30.0 * var_x207 + var_x203 * var_x206) / pow(var_x198, 2);
        IJth(rJacobian, 7, 0) = (-var_x95 + 0.001 / var_x209) * (35.600000000000001 * var_x211 - 35.600000000000001 * var_x212) + 0.00016666666666666666 * var_x208 * (1068.0 * var_x211 + 1068.0 * var_x212) / pow(var_x209, 2);
        IJth(rJacobian, 8, 0) = (-var_x93 + 0.001 / var_x214) * (0.97529258777633288 * var_x215 - 0.18367346938775511 * var_x216) - 0.00017857142857142857 * var_x213 * (15.0 * var_x215 + 15.300000000000001 * var_x216) / pow(var_x214, 2);
        IJth(rJacobian, 9, 0) = (-var_x99 + 0.001 / var_x220) * (0.67660000000000009 * var_x217 - 0.10760999999999998 * var_x218) + 0.00013513513513513514 * var_x219 * (17.0 * var_x217 + 2.1099999999999999 * var_x218) / pow(var_x220, 2);
        IJth(rJacobian, 10, 0) = -0.0183 * var_x221 * (0.10000000000000001 - 0.10000000000000001 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i) - 0.00617952 * var_x222 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        IJth(rJacobian, 11, 0) = (0.001 / var_x224 - 0.001 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y) * (-0.067747636662556524 * var_x225 + 2.5473727272727271 * var_x226 / pow(var_x227, 2)) - 0.00011111111111111112 * var_x223 * (1.6483000000000001 * var_x225 + 14.01055 * var_x228) / pow(var_x224, 2);
        ...
        IJth(rJacobian, 19, 0) = 3.9662082081376168e-7 + 0.00027469260694271792 * var_x38 - 2.7196856284372236e-7 * var_x50 + var_x245 * var_x55 + (0.010896176395982464 * var_x34 + 0.0010351367576183343 * var_x33) * NV_Ith_S(mParameters, 0);
        ...
        IJth(rJacobian, 24, 0) = -var_x254;
        IJth(rJacobian, 25, 0) = var_x254;
        ...
        IJth(rJacobian, 12, 1) = var_x229 * var_x70 + var_x230 * var_x39;
        ...
        IJth(rJacobian, 18, 1) = -var_x239 * var_x70 - var_x240 * var_x39;
        IJth(rJacobian, 19, 1) = 5.2976168399354324e-6 * var_x67 + 0.00031261130080073693 * var_x66 - 0.00031261130080073693 * var_x68 + var_x246 * var_x39 + var_x247 * var_x70;
        IJth(rJacobian, 21, 1) = 0.021865102489586532 * var_x135 - 0.27331378111983162 * var_x136;
        IJth(rJacobian, 24, 1) = var_x260 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        IJth(rJacobian, 25, 1) = var_x260 * var_chaste_interface__SR_Ca_uptake_and_release__F2 + var_x264 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        IJth(rJacobian, 26, 1) = var_x264 * var_chaste_interface__SR_Ca_uptake_and_release__F2;
        ...
        IJth(rJacobian, 5, 5) = -0.001 * var_x193 - 0.001 * var_x196;
        IJth(rJacobian, 19, 5) = var_x245 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        ...
        IJth(rJacobian, 6, 6) = -0.029999999999999999 * var_x207 - 0.0037499999999999999 * var_x202 * var_x206;
        IJth(rJacobian, 19, 6) = var_x245 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L;
        ...
        IJth(rJacobian, 7, 7) = -1.0680000000000001 * var_x211 - 1.0680000000000001 * var_x212;
        IJth(rJacobian, 19, 7) = var_x248 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T;
        ...
        IJth(rJacobian, 8, 8) = -0.015300000000000001 * var_x216 - 0.014999999999999999 * var_x215;
        IJth(rJacobian, 19, 8) = var_x248 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x51 * var_x64 * var_x98);
        IJth(rJacobian, 9, 9) = -0.0021099999999999999 * var_x218 - 0.017000000000000001 * var_x217;
        IJth(rJacobian, 13, 9) = var_x235 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        IJth(rJacobian, 20, 9) = var_x249 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x63 * var_x98 * var_x99 * NV_Ith_S(mParameters, 2));
        IJth(rJacobian, 10, 10) = -0.65600000000000003 * var_x222 - 0.10000000000000001 * var_x221;
        IJth(rJacobian, 13, 10) = var_x235 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        IJth(rJacobian, 20, 10) = var_x249 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * (-var_x100 * var_x101 - var_x100 * var_x102));
        IJth(rJacobian, 11, 11) = -0.0016483000000000001 * var_x225 - 0.01401055 * var_x228;
        IJth(rJacobian, 12, 11) = -var_x102 * var_x231;
        IJth(rJacobian, 13, 11) = -var_x101 * var_x231;
        IJth(rJacobian, 18, 11) = var_x102 * var_x241;
        IJth(rJacobian, 20, 11) = var_x101 * var_x241;
        ...
        IJth(rJacobian, 12, 12) = 2.2637191644542304e-5 * var_x117 - 0.00012359906637920097 * var_x118 - 2.7242382709912566e-5 * var_x0 - 0.0063736773757144738 * var_x109 + var_x111 * var_x232 - var_x114 * var_x233;
        IJth(rJacobian, 13, 12) = 8.2399377586133985e-5 * var_x118 - 1.5091461096361535e-5 * var_x117;
        IJth(rJacobian, 18, 12) = 9.3144911471392233e-5 * var_x0 + 0.00042259974901712096 * var_x118 + 0.021792352791964929 * var_x109 - 7.739922143170714e-5 * var_x117 + var_x114 * var_x242 - var_x111 * var_x243;
        IJth(rJacobian, 19, 12) = var_x111 * var_x240 - var_x114 * var_x239;
        ...
        IJth(rJacobian, 13, 13) = -1.1816383500424576e-5 * var_x96 - var_x236 * var_x96;
        IJth(rJacobian, 20, 13) = 4.040160535071638e-5 * var_x96 + var_x250 * var_x96;
        ...
        IJth(rJacobian, 14, 14) = -0.307 + var_x238;
        ...
        IJth(rJacobian, 16, 16) = -0.0042500000000000003 + var_x238;
        IJth(rJacobian, 17, 16) = -3.2250000000000001;
        IJth(rJacobian, 1, 17) = var_x142;
        IJth(rJacobian, 16, 17) = var_x238;
        ...
        IJth(rJacobian, 12, 18) = 2.7242382709912566e-5 * var_x123 - 0.0063736773757144738 * var_x122 + var_x124 * var_x232 + var_x125 * var_x233;
        IJth(rJacobian, 18, 18) = -0.099999999999999992 + 0.021792352791964929 * var_x122 - 9.3144911471392233e-5 * var_x123 - var_x124 * var_x243 - var_x125 * var_x242;
        IJth(rJacobian, 19, 18) = var_x124 * var_x240 + var_x125 * var_x239;
        ...
        IJth(rJacobian, 12, 19) = var_x230 * var_x41 - var_x127 * var_x229;
        IJth(rJacobian, 18, 19) = var_x127 * var_x239 - var_x240 * var_x41;
        IJth(rJacobian, 19, 19) = -0.099999999999999992 - 5.2976168399354324e-6 * var_x126 + var_x246 * var_x41 - var_x127 * var_x247;
        ...
        IJth(rJacobian, 12, 20) = var_x131 * var_x234 - var_x132 * var_x234;
        IJth(rJacobian, 13, 20) = 1.1816383500424576e-5 * var_x128 + var_x128 * var_x236 + var_x132 * var_x237 - var_x131 * var_x237;
        IJth(rJacobian, 18, 20) = var_x132 * var_x244 - var_x131 * var_x244;
        IJth(rJacobian, 20, 20) = -0.099999999999999992 - 4.040160535071638e-5 * var_x128 + var_x131 * var_x251 - var_x128 * var_x250 - var_x132 * var_x251;
        ...
        IJth(rJacobian, 24, 24) = var_x263 - var_x261;
        IJth(rJacobian, 25, 24) = var_x261 + var_x262;
        IJth(rJacobian, 1, 25) = var_x147 * var_x148 - var_x147 * var_x149;
        IJth(rJacobian, 22, 25) = var_x149 * var_x252 - var_x148 * var_x252;
        IJth(rJacobian, 25, 25) = -0.040000000000000001 + var_x263;
        IJth(rJacobian, 26, 25) = 0.040000000000000001 + var_x262;
