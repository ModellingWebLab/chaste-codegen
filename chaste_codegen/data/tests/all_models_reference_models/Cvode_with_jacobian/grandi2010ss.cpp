...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellgrandi2010ssFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__cell__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x19 = NV_Ith_S(mParameters, 2) * var_chaste_interface__cell__sxkr;
        ...
        const double var_x36 = var_x35 * NV_Ith_S(mParameters, 1) * var_chaste_interface__cell__sj;
        ...
        const double var_x75 = NV_Ith_S(mParameters, 0) * var_chaste_interface__cell__sf;
        ...
        const double var_x127 = 26.712338705498265 * var_x7;
        const double var_x128 = -var_x127 * log10(140.0 * var_x126) + var_chaste_interface__cell__sVm;
        const double var_x129 = NV_Ith_S(mParameters, 1) * var_chaste_interface__cell__sh;
        const double var_x130 = var_x129 * pow(var_chaste_interface__cell__sm, 2) * var_chaste_interface__cell__sj;
        const double var_x131 = var_x128 * var_x130;
        const double var_x132 = 1 / var_chaste_interface__cell__sNasl;
        const double var_x133 = -var_x127 * log10(140.0 * var_x132) + var_chaste_interface__cell__sVm;
        const double var_x134 = var_x130 * var_x133;
        const double var_x135 = 0.11 * var_x128;
        const double var_x136 = 0.89000000000000001 * var_x133;
        const double var_x137 = var_x129 * var_x35;
        const double var_x138 = var_x75 * var_chaste_interface__cell__sVm;
        const double var_x139 = var_x138 * var_x74;
        const double var_x140 = var_x71 * var_x81;
        const double var_x141 = var_x83 * var_x86;
        const double var_x142 = var_x138 * var_x90;
        const double var_x143 = var_x83 * var_x95;
        const double var_x144 = var_x71 * var_x99;
        const double var_x145 = var_x101 * var_x104;
        const double var_x146 = NV_Ith_S(mParameters, 0) * var_chaste_interface__cell__sVm * var_chaste_interface__cell__sd;
        const double var_x147 = var_x146 * var_x74;
        const double var_x148 = var_x146 * var_x90;
        const double var_x149 = var_x91 * var_chaste_interface__cell__sVm;
        const double var_x150 = var_x102 * var_chaste_interface__cell__sVm;
        const double var_x151 = -0.5612231585432097 * var_x7 - 0.015599999999999999 * var_chaste_interface__cell__sVm;
        const double var_x152 = -4.1156364959835381 * var_x7 - 0.1144 * var_chaste_interface__cell__sVm;
        const double var_x153 = 120.0 + 0.018329999999999999 * var_chaste_interface__cell__sNai;
        ...
        const double var_x177 = var_x127 + var_chaste_interface__cell__sVm;
        ...
        const double var_x192 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__cell__sVm);
        ...
        const double var_x197 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__sVm);
        ...
        const double var_x208 = 0.26917900403768508 * var_x197 / pow(var_x198, 3);
        ...
        const double var_x232 = var_x231 - var_chaste_interface__cell__sd;
        ...
        const double var_x237 = 0.0058333333333333336 * var_x227;
        ...
        const double var_x250 = exp(1.4615384615384615 - 0.076923076923076927 * var_chaste_interface__cell__sVm);
        const double var_x251 = 1.0 + var_x250;
        const double var_x252 = 0.076923076923076927 * var_x250 / pow(var_x251, 2);
        ...
        const double var_x258 = 0.20000000000000001 * var_chaste_interface__cell__sVm;
        const double var_x259 = exp(3.8999999999999999 + var_x258);
        const double var_x260 = 1.0 + var_x259;
        const double var_x261 = 0.20000000000000001 * var_x259 / pow(var_x260, 2);
        const double var_x262 = 1 / var_x260;
        ...
        const double var_x277 = exp(-2.0 - var_x258);
        const double var_x278 = 1.0 + var_x277;
        const double var_x279 = 1 / (230.0 * var_x269 + 3300.0 * var_x276);
        const double var_x280 = exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__cell__sVm);
        ...
        const double var_x294 = var_chaste_interface__cell__sCaj * var_chaste_interface__cell__sRyRr;
        const double var_x295 = var_x284 * var_x285 / pow(var_x286, 2);
        const double var_x296 = 2.3772197685794643 * var_x295;
        const double var_x297 = 0.21130842387373014 * var_x295 * var_x45 / pow((1 - 0.93333333333333335 * var_x287), 2);
        const double var_x298 = var_x297 * var_chaste_interface__cell__sRyRr;
        const double var_x299 = 20.0 * var_x291;
        const double var_x300 = var_x294 * var_x299;
        const double var_x301 = var_x296 * var_chaste_interface__cell__sCaj * var_chaste_interface__cell__sRyRo;
        const double var_x302 = 7.5 - var_x288;
        const double var_x303 = 1.0 - var_chaste_interface__cell__sRyRi - var_chaste_interface__cell__sRyRo - var_chaste_interface__cell__sRyRr;
        ...
        const double var_x347 = var_x345 * var_x36;
        const double var_x348 = 0.027802898010839731 * var_x128;
        const double var_x349 = var_x137 * var_x345;
        const double var_x350 = var_x139 * var_x345;
        const double var_x351 = 2.7730746221159819e-6 * var_x107;
        const double var_x352 = var_x147 * var_x345;
        const double var_x353 = var_x105 * var_x345;
        const double var_x354 = 3.2338348512952546 * var_x345;
        const double var_x355 = 0.0068117100126557344 * var_x345;
        const double var_x356 = 0.0060624219112636038 * var_x133;
        const double var_x357 = 8.3038178962250779e-9 * var_x80;
        const double var_x358 = var_x357 * var_x71;
        const double var_x359 = 0.23994917636495411 * var_x345;
        const double var_x360 = 0.1263768091401806 * var_x345;
        const double var_x361 = var_x142 * var_x345;
        const double var_x362 = 0.19966137279235072 * var_x116;
        const double var_x363 = var_x148 * var_x345;
        const double var_x364 = var_x149 * var_x345;
        ...
        const double var_x368 = 0.00059787488852820563 * var_x98;
        const double var_x369 = var_x368 * var_x71;
        const double var_x370 = 0.54535393106272634 * var_x345;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.010148299999999999 + var_x111 + var_x112 + var_x115 + var_x117 - var_x100 - var_x119 - var_x121 - var_x123 - var_x125 - var_x82 - var_x87 - var_x96 - 1.0 * var_x37 - 0.002 / var_x1 - 0.0035000000000000001 * var_x2 - 0.495 * var_x54 - 0.15495652173913044 * var_x31 - 1.2537391304347827 * var_x33 - 0.006029375 / var_x4 - 4.0049999999999999 * var_x64 - 0.0043287860817742326 * var_x68 - 0.035023814661627878 * var_x70 - 0.048783124999999997 / var_x6 - var_x102 * var_x104 - var_x19 * var_x22 - 0.1144 * var_chaste_interface__cell__sxtof * var_chaste_interface__cell__sytof - 0.015599999999999999 * var_chaste_interface__cell__sxtos * var_chaste_interface__cell__sytos - 0.35699999999999998 * var_x10 * var_x18 - 0.00073930691316271028 * var_x105 * var_x106 + 0.085144499999999998 * var_x18 * var_x23 * var_x34 - 0.00033444816053511704 * var_x0 * var_x23 / pow(var_x1, 2) + 8.2145212573634477e-6 * var_x101 * var_x106 * var_x109 * var_chaste_interface__cell__sVm + 0.0014583333333333334 * var_x19 * var_x20 * var_x23 / pow(var_x21, 2) - 0.34313725490196073 * var_x10 * var_x23 * (0.24326999999999999 * var_x34 - var_x13 * (0.061749999999999999 * var_x15 + 0.039456396800000001 * var_x14) - 0.51429999999999998 * var_x11 * var_x16 / pow(var_x12, 2)) / pow((var_x10 + 0.98039215686274506 * var_x17), 2));
        IJth(rJacobian, 1, 0) = 59.906641489902128 * (pow(var_x193, (-2)) - var_chaste_interface__cell__sm) * (-var_x194 * (-0.3792264410025028 - 0.0082818615637148471 * var_chaste_interface__cell__sVm) - var_x195 * (0.0036911829173615863 - 0.00076532923851577563 * var_chaste_interface__cell__sVm)) / pow((var_x191 + 0.5020897832817337 * var_x190), 2) + 0.22148394241417499 * var_x192 * var_x196 / pow(var_x193, 3);
        IJth(rJacobian, 2, 0) = (var_x199 - var_chaste_interface__cell__sh) * (((var_x200) ? (0) : (-0.008382352941176471 * var_x201)) + ((var_x200) ? (0.53361053361053368 * var_x202 / pow(var_x203, 2)) : (108035.0 * var_x204 + 0.21330000000000002 * var_x205))) - var_x208 * (var_x206 + var_x207);
        IJth(rJacobian, 3, 0) = (var_x199 - var_chaste_interface__cell__sj) * (((var_x200) ? (0) : (var_x215 + var_x211 * var_x216 * (3.0508668000000001e-7 * var_x213 - 6214.6032000000005 * var_x212) - 0.311 * var_x209 * var_x214 * var_x216 / pow(var_x210, 2))) + ((var_x200) ? (0.034200000000000001 * var_x220 + 0.059999999999999998 * var_x217 * var_x219 / pow(var_x218, 2)) : (-0.00025500480000000003 * var_x224 + 0.0033402720000000005 * var_x221 * var_x223 / pow(var_x222, 2)))) - var_x208 * (var_x225 + var_x226);
        IJth(rJacobian, 4, 0) = var_x233 * var_x234 - var_x233 * var_x238 + var_x231 * var_x236 * var_x237 - var_x230 * var_x232 * var_x238 / pow(var_x228, 2);
        IJth(rJacobian, 5, 0) = (0.02 + var_x239) * (0.029999999999999999 * var_x241 / pow(var_x242, 2) - 0.1111111111111111 * var_x244 / pow(var_x245, 2)) + var_x239 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__cell__sVm) * (1 / var_x245 - var_chaste_interface__cell__sf + 0.59999999999999998 / var_x242);
        IJth(rJacobian, 8, 0) = var_x249 * var_x252 + 0.0074074074074074077 * var_x246 * (var_x253 - var_chaste_interface__cell__sxtos) / (pow(var_x247, 2) * pow((0.055555555555555552 + var_x248), 2));
        IJth(rJacobian, 9, 0) = -var_x257 * var_x261 + 0.000125 * var_x254 * (var_x262 - var_chaste_interface__cell__sytos) / (pow(var_x255, 2) * pow((0.037499999999999999 + var_x256), 2));
        IJth(rJacobian, 10, 0) = var_x252 * var_x264 - 0.11764705882352941 * var_x263 * (-0.035999999999999997 - 0.00080000000000000004 * var_chaste_interface__cell__sVm) * (var_x253 - var_chaste_interface__cell__sxtof) / pow((0.058823529411764705 + var_x263), 2);
        IJth(rJacobian, 11, 0) = -var_x261 * var_x266 - 0.011764705882352941 * var_x265 * (-0.36363636363636365 - 0.0090909090909090905 * var_chaste_interface__cell__sVm) * (var_x262 - var_chaste_interface__cell__sytof) / pow((0.082352941176470587 + var_x265), 2);
        IJth(rJacobian, 12, 0) = 9.1827364554637282e-8 * (1 / var_x278 - var_chaste_interface__cell__sxkr) * (11.5 * var_x267 / pow(var_x268, 2) + 366.66666666666669 * var_x270 * var_x275 / pow(var_x271, 2) - 366.66666666666669 * var_x272 * var_x273 / pow(var_x274, 2)) / pow((var_x276 + 0.069696969696969702 * var_x269), 2) + 0.20000000000000001 * var_x277 * var_x279 / pow(var_x278, 2);
        IJth(rJacobian, 13, 0) = -7.1529673512819408e-5 * var_x282 * (1 / var_x281 - var_chaste_interface__cell__sxks) + 0.070175438596491224 * var_x280 * (0.00100999899000101 + var_x283) / pow(var_x281, 2);
        IJth(rJacobian, 32, 0) = -var_x346 * (6.567e-5 + var_x125 + var_x87 - var_x111 + 0.11 * var_x37 + 1.4850000000000001 * var_x54 + 0.012986358245322698 * var_x68 + 0.46486956521739131 * var_x31);
        IJth(rJacobian, 33, 0) = -var_x355 * (0.00053133 + var_x119 + var_x82 - var_x112 + 0.89000000000000001 * var_x37 + 12.015000000000001 * var_x64 + 0.10507144398488363 * var_x70 + 3.7612173913043478 * var_x33);
        IJth(rJacobian, 35, 0) = -var_x360 * (6.0643000000000002e-5 + var_x123 + var_x96 - var_x117 - 0.98999999999999999 * var_x54 - 0.0086575721635484652 * var_x68);
        IJth(rJacobian, 36, 0) = -var_x367 * (0.00049065700000000003 + var_x100 + var_x121 - var_x115 - 0.070047629323255756 * var_x70 - 8.0099999999999998 * var_x64);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-0.33000000000000002 * var_x131 - 2.6699999999999999 * var_x134);
        IJth(rJacobian, 1, 1) = -var_x196;
        IJth(rJacobian, 32, 1) = -0.083408694032519187 * var_x131 * var_x345;
        IJth(rJacobian, 33, 1) = -0.01818726573379081 * var_x134 * var_x345;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x135 * var_x36 - var_x136 * var_x36);
        IJth(rJacobian, 2, 2) = -var_x206 - var_x207;
        IJth(rJacobian, 32, 2) = -var_x347 * var_x348;
        IJth(rJacobian, 33, 2) = -var_x347 * var_x356;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x135 * var_x137 - var_x136 * var_x137);
        IJth(rJacobian, 3, 3) = -var_x225 - var_x226;
        IJth(rJacobian, 32, 3) = -var_x348 * var_x349;
        IJth(rJacobian, 33, 3) = -var_x349 * var_x356;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x139 * var_x140 - var_x139 * var_x141 - var_x139 * var_x145 - var_x142 * var_x143 - var_x142 * var_x144);
        IJth(rJacobian, 4, 4) = -var_x234 * var_x236;
        IJth(rJacobian, 32, 4) = -var_x350 * var_x351;
        IJth(rJacobian, 33, 4) = -var_x350 * var_x358;
        IJth(rJacobian, 35, 4) = -var_x361 * var_x362;
        IJth(rJacobian, 36, 4) = -var_x361 * var_x369;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x140 * var_x147 - var_x141 * var_x147 - var_x143 * var_x148 - var_x144 * var_x148 - var_x145 * var_x147);
        IJth(rJacobian, 5, 5) = -0.02 - var_x239;
        IJth(rJacobian, 32, 5) = -var_x351 * var_x352;
        IJth(rJacobian, 33, 5) = -var_x352 * var_x358;
        IJth(rJacobian, 35, 5) = -var_x362 * var_x363;
        IJth(rJacobian, 36, 5) = -var_x363 * var_x369;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (0.00019748616671718712 * var_x150 + var_x105 * var_x86 + var_x149 * var_x95);
        IJth(rJacobian, 6, 6) = -0.011900000000000001 - 1.7 * var_chaste_interface__cell__sCaj;
        IJth(rJacobian, 32, 6) = 2.7730746221159819e-6 * var_x353 * var_x85;
        IJth(rJacobian, 35, 6) = 0.19966137279235072 * var_x364 * var_x94;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (2.1942907413020785e-5 * var_x150 + var_x105 * var_x81 + var_x149 * var_x99);
        IJth(rJacobian, 7, 7) = -0.011900000000000001 - 1.7 * var_chaste_interface__cell__sCasl;
        IJth(rJacobian, 33, 7) = var_x353 * var_x357;
        IJth(rJacobian, 36, 7) = var_x364 * var_x368;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x151 * var_chaste_interface__cell__sytos);
        IJth(rJacobian, 8, 8) = -var_x249;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x151 * var_chaste_interface__cell__sxtos);
        IJth(rJacobian, 9, 9) = -var_x257;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x152 * var_chaste_interface__cell__sytof);
        IJth(rJacobian, 10, 10) = -var_x264;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x152 * var_chaste_interface__cell__sxtof);
        IJth(rJacobian, 11, 11) = -var_x266;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x22 * var_x23 * NV_Ith_S(mParameters, 2));
        IJth(rJacobian, 12, 12) = -var_x279;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0070000000000000001 * (-var_x127 * log10(7.9662000000000006 / var_x153) + var_chaste_interface__cell__sVm) * var_chaste_interface__cell__sxks);
        IJth(rJacobian, 13, 13) = -0.00100999899000101 - var_x283;
        IJth(rJacobian, 14, 14) = -0.0050000000000000001 + var_x290 + var_x293;
        IJth(rJacobian, 15, 14) = var_x292;
        IJth(rJacobian, 16, 14) = var_x293;
        IJth(rJacobian, 14, 15) = 0.055;
        IJth(rJacobian, 15, 15) = -0.059999999999999998 + var_x290;
        IJth(rJacobian, 16, 15) = var_x293 + var_x302 * var_chaste_interface__cell__sCaj;
        ...
        IJth(rJacobian, 16, 16) = -0.065000000000000002 + var_x293;
        IJth(rJacobian, 17, 17) = -0.001 - var_x304;
        IJth(rJacobian, 32, 17) = 0.001 + var_x304;
        IJth(rJacobian, 18, 18) = -0.001 - var_x306;
        IJth(rJacobian, 33, 18) = 0.001 + var_x306;
        IJth(rJacobian, 19, 19) = -0.019599999999999999 - var_x308;
        IJth(rJacobian, 37, 19) = 0.019599999999999999 + var_x308;
        IJth(rJacobian, 20, 20) = -3.1999999999999999e-5 + var_x311;
        IJth(rJacobian, 21, 20) = -0.0030000000000000001;
        IJth(rJacobian, 37, 20) = 0.003032 + var_x310;
        IJth(rJacobian, 20, 21) = var_x311;
        IJth(rJacobian, 21, 21) = -0.0063300000000000006;
        IJth(rJacobian, 37, 21) = 0.0063300000000000006 + var_x310;
        IJth(rJacobian, 22, 22) = -0.23799999999999999 - var_x314;
        IJth(rJacobian, 37, 22) = 0.23799999999999999 + var_x314;
        IJth(rJacobian, 23, 23) = -0.00046000000000000001 + var_x317;
        IJth(rJacobian, 24, 23) = -0.015699999999999999;
        IJth(rJacobian, 37, 23) = 0.016159999999999997 + var_x316;
        IJth(rJacobian, 23, 24) = var_x317;
        IJth(rJacobian, 24, 24) = -0.015757;
        IJth(rJacobian, 37, 24) = 0.015757 + var_x316;
        IJth(rJacobian, 25, 25) = -0.059999999999999998 - var_x320;
        IJth(rJacobian, 37, 25) = 0.059999999999999998 + var_x320;
        IJth(rJacobian, 26, 26) = -1.3 + var_x323;
        IJth(rJacobian, 35, 26) = 1.3 + var_x322;
        IJth(rJacobian, 27, 27) = -1.3 + var_x326;
        IJth(rJacobian, 36, 27) = 1.3 + var_x325;
        IJth(rJacobian, 28, 28) = -0.029999999999999999 + var_x323;
        IJth(rJacobian, 35, 28) = 0.029999999999999999 + var_x322;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x326;
        IJth(rJacobian, 36, 29) = 0.029999999999999999 + var_x325;
        IJth(rJacobian, 30, 30) = -65.0 - var_x330;
        IJth(rJacobian, 31, 30) = 65.0 + var_x330;
        IJth(rJacobian, 14, 31) = -var_x298 + var_x294 * var_x296;
        IJth(rJacobian, 15, 31) = var_x298 + var_x301;
        IJth(rJacobian, 16, 31) = -var_x301 + var_x297 * var_x303;
        IJth(rJacobian, 30, 31) = 260.0 - var_x331;
        IJth(rJacobian, 31, 31) = -260.00009932 + var_x331 - var_x332 - 4.6421953480341129e-16 * var_x341 - 0.0036772346118413473 * var_x339;
        IJth(rJacobian, 35, 31) = 0.0064493506493506492 + var_x365;
        IJth(rJacobian, 37, 31) = 2.4996436489414456e-17 * var_x341 + 0.00019800494063761101 * var_x339;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x154 - var_x162 - var_x163 + 1.6579932586131617e-12 * var_x160 - 4.2334955737758471e-5 * var_x156 - 2.673 * var_x161);
        IJth(rJacobian, 17, 32) = 0.0007561 - var_x305;
        IJth(rJacobian, 32, 32) = -0.0007561 + var_x305 - var_x354 - var_x346 * (var_x154 + var_x162 + var_x163 + 8.0190000000000001 * var_x161 + 0.0001270048672132754 * var_x156 - 4.973979775839485e-12 * var_x160);
        IJth(rJacobian, 33, 32) = 0.087151849242407126 * var_x345;
        IJth(rJacobian, 35, 32) = -var_x360 * (3.3159865172263233e-12 * var_x160 - 5.3460000000000001 * var_x161);
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x164 - var_x170 - var_x172 + 1.3414672728779216e-11 * var_x169 - 21.626999999999999 * var_x171 - 0.00034252827824186399 * var_x165);
        IJth(rJacobian, 18, 33) = 0.000165 - var_x307;
        IJth(rJacobian, 32, 33) = var_x354;
        IJth(rJacobian, 33, 33) = -0.000165 + var_x307 - 7.8855000811034159 * var_x345 - var_x355 * (var_x164 + var_x170 + var_x172 + 0.001027584834725592 * var_x165 + 64.881 * var_x171 - 4.0244018186337653e-11 * var_x169);
        IJth(rJacobian, 34, 33) = var_x359;
        IJth(rJacobian, 36, 33) = -var_x367 * (2.6829345457558432e-11 * var_x169 - 43.253999999999998 * var_x171);
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (-1.1900903400355841e-7 * var_x153 * var_x2 / pow((1 + 0.00015275 * var_chaste_interface__cell__sNai), 2));
        IJth(rJacobian, 33, 34) = 7.7983482318610085 * var_x345;
        IJth(rJacobian, 34, 34) = -var_x359;
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (var_x175 - var_x173 - var_x176 - var_x181 + 1358280.0 * var_x178 - 6.5741102771804265e-14 * var_x179 - 2.2274999999999996e-8 * var_x180 - 0.00060293750000000007 * var_x177 * var_x46 / pow(var_x4, 2));
        IJth(rJacobian, 6, 35) = 1.7 - 1.7 * var_chaste_interface__cell__sfcaBj;
        IJth(rJacobian, 14, 35) = -var_x300 + var_x289 * var_chaste_interface__cell__sRyRr;
        IJth(rJacobian, 15, 35) = var_x300 + var_x289 * var_chaste_interface__cell__sRyRo;
        IJth(rJacobian, 16, 35) = var_x302 * var_chaste_interface__cell__sRyRo + var_x299 * var_x303 * var_chaste_interface__cell__sCaj;
        IJth(rJacobian, 26, 35) = 55.473098330241186 - var_x324;
        IJth(rJacobian, 28, 35) = 19.897959183673468 - var_x328;
        IJth(rJacobian, 31, 35) = 9.9320000000000005e-5 + var_x332;
        IJth(rJacobian, 32, 35) = -var_x346 * (1.9722330831541279e-13 * var_x179 + 6.6824999999999991e-8 * var_x180 - 4074840.0 * var_x178);
        IJth(rJacobian, 35, 35) = -75.377506864564012 + var_x324 + var_x328 - var_x365 - var_x366 - var_x360 * (var_x173 + var_x176 + var_x181 - var_x175 + 2716560.0 * var_x178 - 1.3148220554360853e-13 * var_x179 - 4.4549999999999992e-8 * var_x180);
        IJth(rJacobian, 36, 35) = 3.9220965724111685 * var_x345;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (var_x184 - var_x182 - var_x185 - var_x189 + 10989720.0 * var_x186 - 5.3190528606277995e-13 * var_x187 - 1.8022499999999996e-7 * var_x188 - 0.0048783125000000007 * var_x177 * var_x56 / pow(var_x6, 2));
        IJth(rJacobian, 7, 36) = 1.7 - 1.7 * var_chaste_interface__cell__sfcaBsl;
        IJth(rJacobian, 27, 36) = 121.55000000000001 - var_x327;
        IJth(rJacobian, 29, 36) = 43.550000000000004 - var_x329;
        IJth(rJacobian, 33, 36) = -var_x355 * (5.4067499999999991e-7 * var_x188 + 1.5957158581883399e-12 * var_x187 - 32969160.0 * var_x186);
        IJth(rJacobian, 35, 36) = var_x366;
        IJth(rJacobian, 36, 36) = -165.10000000000002 + var_x327 + var_x329 - 21.646099331949777 * var_x345 - var_x367 * (var_x182 + var_x185 + var_x189 - var_x184 + 21979440.0 * var_x186 - 1.0638105721255599e-12 * var_x187 - 3.6044999999999992e-7 * var_x188);
        IJth(rJacobian, 37, 36) = var_x370;
        IJth(rJacobian, 19, 37) = 2.2890000000000006 - var_x309;
        IJth(rJacobian, 20, 37) = 0.33180000000000004 - var_x312 - var_x313;
        IJth(rJacobian, 22, 37) = 0.81600000000000006 - var_x315;
        IJth(rJacobian, 23, 37) = 1.9320000000000004 - var_x318 - var_x319;
        IJth(rJacobian, 25, 37) = 1.71 - var_x321;
        IJth(rJacobian, 31, 37) = 26713.606559545973 * var_x343 - 3.3723651925989277e-9 * var_x344;
        IJth(rJacobian, 36, 37) = 17.724002759538607 * var_x345;
        IJth(rJacobian, 37, 37) = -7.0788000000000011 + var_x309 + var_x312 + var_x313 + var_x315 + var_x318 + var_x319 + var_x321 - var_x370 + 1.8158889498609611e-10 * var_x344 - 1438.4249685909372 * var_x343;
    }
