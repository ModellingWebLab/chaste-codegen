...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellgrandi2010ssFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__cell__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x126 = -26.712338705498265 * log(140 * var_x125) + var_chaste_interface__cell__sVm;
        ...
        const double var_x131 = -26.712338705498265 * log(140 * var_x130) + var_chaste_interface__cell__sVm;
        ...
        const double var_x149 = -1.2922640787046284 - 015599999999999999 * var_chaste_interface__cell__sVm;
        ...
        const double var_x234 = 0058333333333333336 * var_x224;
        ...
        const double var_x247 = exp(1.4615384615384615 - 076923076923076927 * var_chaste_interface__cell__sVm);
        const double var_x248 = 1.0 + var_x247;
        const double var_x249 = 076923076923076927 * var_x247 / pow(var_x248, 2);
        ...
        const double var_x277 = exp(-0.26666666666666666 - 070175438596491224 * var_chaste_interface__cell__sVm);
        ...
        const double var_x296 = 20 * var_x288;
        ...
        const double var_x345 = 027802898010839731 * var_x126;
        ...
        const double var_x353 = 0060624219112636038 * var_x131;
        ...
        IJth(rJacobian, 5, 0) = (02 + var_x236) * (029999999999999999 * var_x238 / pow(var_x239, 2) - 0.1111111111111111 * var_x241 / pow(var_x242, 2)) + var_x236 * (-032935010000000001 - 0022713799999999999 * var_chaste_interface__cell__sVm) * (-var_chaste_interface__cell__sf + 1.0 / var_x242 + 0.59999999999999998 / var_x239);
        IJth(rJacobian, 8, 0) = var_x246 * var_x249 + 0074074074074074077 * var_x243 * (var_x250 - var_chaste_interface__cell__sxtos) / (pow(var_x244, 2) * pow((055555555555555552 + var_x245), 2));
        IJth(rJacobian, 9, 0) = -var_x254 * var_x258 + 000125 * var_x251 * (var_x259 - var_chaste_interface__cell__sytos) / (pow(var_x252, 2) * pow((037499999999999999 + var_x253), 2));
        IJth(rJacobian, 10, 0) = var_x249 * var_x261 - 0.11764705882352941 * var_x260 * (-035999999999999997 - 00080000000000000004 * var_chaste_interface__cell__sVm) * (var_x250 - var_chaste_interface__cell__sxtof) / pow((058823529411764705 + var_x260), 2);
        IJth(rJacobian, 11, 0) = -var_x258 * var_x263 - 011764705882352941 * var_x262 * (-0.36363636363636365 - 0090909090909090905 * var_chaste_interface__cell__sVm) * (var_x259 - var_chaste_interface__cell__sytof) / pow((082352941176470587 + var_x262), 2);
        IJth(rJacobian, 12, 0) = 9.1827364554637282e-8 * (-var_chaste_interface__cell__sxkr + 1.0 / var_x275) * (11.5 * var_x264 / pow(var_x265, 2) + 366.66666666666669 * var_x267 * var_x272 / pow(var_x268, 2) - 366.66666666666669 * var_x269 * var_x270 / pow(var_x271, 2)) / pow((var_x273 + 069696969696969702 * var_x266), 2) + 0.20000000000000001 * var_x274 * var_x276 / pow(var_x275, 2);
        IJth(rJacobian, 13, 0) = -7.1529673512819408e-5 * var_x279 * (-var_chaste_interface__cell__sxks + 1.0 / var_x278) + 070175438596491224 * var_x277 * (00100999899000101 + var_x280) / pow(var_x278, 2);
        IJth(rJacobian, 32, 0) = -var_x343 * (6.567e-5 + var_x124 + var_x86 - var_x110 + 0.11 * var_x36 + 1.4850000000000001 * var_x53 + 012986358245322698 * var_x67 + 0.46486956521739131 * var_x30);
        IJth(rJacobian, 33, 0) = -var_x352 * (00053133 + var_x118 + var_x81 - var_x111 + 0.89000000000000001 * var_x36 + 12.015000000000001 * var_x63 + 0.10507144398488363 * var_x69 + 3.7612173913043478 * var_x32);
        IJth(rJacobian, 35, 0) = -var_x357 * (6.0643000000000002e-5 + var_x122 + var_x95 - var_x116 - 0.98999999999999999 * var_x53 - 0086575721635484652 * var_x67);
        IJth(rJacobian, 36, 0) = -var_x364 * (00049065700000000003 + var_x120 + var_x99 - var_x114 - 070047629323255756 * var_x69 - 8.0099999999999998 * var_x63);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (-0.33000000000000002 * var_x129 - 2.6699999999999999 * var_x132);
        IJth(rJacobian, 1, 1) = -var_x193;
        IJth(rJacobian, 32, 1) = -083408694032519187 * var_x129 * var_x342;
        IJth(rJacobian, 33, 1) = -01818726573379081 * var_x132 * var_x342;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (-var_x133 * var_x35 - var_x134 * var_x35);
        IJth(rJacobian, 2, 2) = -var_x203 - var_x204;
        IJth(rJacobian, 32, 2) = -var_x344 * var_x345;
        IJth(rJacobian, 33, 2) = -var_x344 * var_x353;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (-var_x133 * var_x135 - var_x134 * var_x135);
        IJth(rJacobian, 3, 3) = -var_x222 - var_x223;
        IJth(rJacobian, 32, 3) = -var_x345 * var_x346;
        IJth(rJacobian, 33, 3) = -var_x346 * var_x353;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (-var_x137 * var_x138 - var_x137 * var_x139 - var_x137 * var_x143 - var_x140 * var_x141 - var_x140 * var_x142);
        ...
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (-var_x138 * var_x145 - var_x139 * var_x145 - var_x141 * var_x146 - var_x142 * var_x146 - var_x143 * var_x145);
        IJth(rJacobian, 5, 5) = -02 - var_x236;
        ...
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (00019748616671718712 * var_x148 + var_x104 * var_x85 + var_x147 * var_x94);
        IJth(rJacobian, 6, 6) = -011900000000000001 - 1.7 * var_chaste_interface__cell__sCaj;
        IJth(rJacobian, 32, 6) = 2.7730746221159819e-6 * var_x350 * var_x84;
        IJth(rJacobian, 35, 6) = 0.19966137279235072 * var_x361 * var_x93;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (2.1942907413020785e-5 * var_x148 + var_x104 * var_x80 + var_x147 * var_x98);
        IJth(rJacobian, 7, 7) = -011900000000000001 - 1.7 * var_chaste_interface__cell__sCasl;
        IJth(rJacobian, 33, 7) = var_x350 * var_x354;
        IJth(rJacobian, 36, 7) = var_x361 * var_x365;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (var_x149 * var_chaste_interface__cell__sytos);
        IJth(rJacobian, 8, 8) = -var_x246;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0 : (var_x149 * var_chaste_interface__cell__sxtos);
        IJth(rJacobian, 9, 9) = -var_x254;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0 : (var_x150 * var_chaste_interface__cell__sytof);
        IJth(rJacobian, 10, 10) = -var_x261;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0 : (var_x150 * var_chaste_interface__cell__sxtof);
        IJth(rJacobian, 11, 11) = -var_x263;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0 : (-var_x21 * var_x22 * NV_Ith_S(mParameters, 2));
        IJth(rJacobian, 12, 12) = -var_x276;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0 : (-0070000000000000001 * (-26.712338705498265 * log(7.9662000000000006 / (120 + 018329999999999999 * var_chaste_interface__cell__sNai)) + var_chaste_interface__cell__sVm) * var_chaste_interface__cell__sxks);
        IJth(rJacobian, 13, 13) = -00100999899000101 - var_x280;
        IJth(rJacobian, 14, 14) = -0050000000000000001 + var_x287 + var_x290;
        IJth(rJacobian, 15, 14) = var_x289;
        IJth(rJacobian, 16, 14) = var_x290;
        IJth(rJacobian, 14, 15) = 055;
        IJth(rJacobian, 15, 15) = -059999999999999998 + var_x287;
        ...
        IJth(rJacobian, 14, 16) = -0050000000000000001;
        IJth(rJacobian, 15, 16) = 0050000000000000001;
        IJth(rJacobian, 16, 16) = -065000000000000002 + var_x290;
        IJth(rJacobian, 17, 17) = -001 - var_x301;
        IJth(rJacobian, 32, 17) = 001 + var_x301;
        IJth(rJacobian, 18, 18) = -001 - var_x303;
        IJth(rJacobian, 33, 18) = 001 + var_x303;
        IJth(rJacobian, 19, 19) = -019599999999999999 - var_x305;
        IJth(rJacobian, 37, 19) = 019599999999999999 + var_x305;
        IJth(rJacobian, 20, 20) = -3.1999999999999999e-5 + var_x308;
        IJth(rJacobian, 21, 20) = -0030000000000000001;
        IJth(rJacobian, 37, 20) = 003032 + var_x307;
        IJth(rJacobian, 20, 21) = var_x308;
        IJth(rJacobian, 21, 21) = -0063300000000000006;
        IJth(rJacobian, 37, 21) = 0063300000000000006 + var_x307;
        IJth(rJacobian, 22, 22) = -0.23799999999999999 - var_x311;
        IJth(rJacobian, 37, 22) = 0.23799999999999999 + var_x311;
        IJth(rJacobian, 23, 23) = -00046000000000000001 + var_x314;
        IJth(rJacobian, 24, 23) = -015699999999999999;
        IJth(rJacobian, 37, 23) = 016159999999999997 + var_x313;
        IJth(rJacobian, 23, 24) = var_x314;
        IJth(rJacobian, 24, 24) = -015757;
        IJth(rJacobian, 37, 24) = 015757 + var_x313;
        IJth(rJacobian, 25, 25) = -059999999999999998 - var_x317;
        IJth(rJacobian, 37, 25) = 059999999999999998 + var_x317;
        ...
        IJth(rJacobian, 28, 28) = -029999999999999999 + var_x320;
        IJth(rJacobian, 35, 28) = 029999999999999999 + var_x319;
        IJth(rJacobian, 29, 29) = -029999999999999999 + var_x323;
        IJth(rJacobian, 36, 29) = 029999999999999999 + var_x322;
        ...
        IJth(rJacobian, 30, 31) = 260 - var_x328;
        IJth(rJacobian, 31, 31) = -2600009932 + var_x328 - var_x329 - 4.6421953480341129e-16 * var_x338 - 0036772346118413473 * var_x336;
        IJth(rJacobian, 35, 31) = 0064493506493506492 + var_x362;
        IJth(rJacobian, 37, 31) = 2.4996436489414456e-17 * var_x338 + 00019800494063761101 * var_x336;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0 : (-var_x151 - var_x159 - var_x160 + 1.6579932586131617e-12 * var_x157 - 4.2334955737758471e-5 * var_x153 - 2.673 * var_x158);
        IJth(rJacobian, 17, 32) = 0007561 - var_x302;
        IJth(rJacobian, 32, 32) = -0007561 + var_x302 - var_x351 - var_x343 * (var_x151 + var_x159 + var_x160 + 8.0190000000000001 * var_x158 + 0001270048672132754 * var_x153 - 4.973979775839485e-12 * var_x157);
        IJth(rJacobian, 33, 32) = 087151849242407126 * var_x342;
        IJth(rJacobian, 35, 32) = -var_x357 * (3.3159865172263233e-12 * var_x157 - 5.3460000000000001 * var_x158);
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0 : (-var_x161 - var_x167 - var_x169 + 1.3414672728779216e-11 * var_x166 - 21.626999999999999 * var_x168 - 00034252827824186399 * var_x162);
        IJth(rJacobian, 18, 33) = 000165 - var_x304;
        IJth(rJacobian, 32, 33) = var_x351;
        IJth(rJacobian, 33, 33) = -000165 + var_x304 - 7.8855000811034159 * var_x342 - var_x352 * (var_x161 + var_x167 + var_x169 + 001027584834725592 * var_x162 + 64.881 * var_x168 - 4.0244018186337653e-11 * var_x166);
        IJth(rJacobian, 34, 33) = var_x356;
        IJth(rJacobian, 36, 33) = -var_x364 * (2.6829345457558432e-11 * var_x166 - 43.253999999999998 * var_x168);
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0 : (-9.4804976667914707e-7 * var_x2 * (15.063643895458311 + 002300971605031257 * var_chaste_interface__cell__sNai) / pow((1 + 00015275 * var_chaste_interface__cell__sNai), 2));
        IJth(rJacobian, 33, 34) = 7.7983482318610085 * var_x342;
        IJth(rJacobian, 34, 34) = -var_x356;
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0 : (var_x172 - var_x170 - var_x173 - var_x178 + 1358280 * var_x175 - 6.5741102771804265e-14 * var_x176 - 2.2274999999999996e-8 * var_x177 - 00060293750000000007 * var_x174 * var_x45 / pow(var_x4, 2));
        ...
        IJth(rJacobian, 32, 35) = -var_x343 * (1.9722330831541279e-13 * var_x176 + 6.6824999999999991e-8 * var_x177 - 4074840 * var_x175);
        IJth(rJacobian, 35, 35) = -75.377506864564012 + var_x321 + var_x325 - var_x362 - var_x363 - var_x357 * (var_x170 + var_x173 + var_x178 - var_x172 + 2716560 * var_x175 - 1.3148220554360853e-13 * var_x176 - 4.4549999999999992e-8 * var_x177);
        IJth(rJacobian, 36, 35) = 3.9220965724111685 * var_x342;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0 : (var_x181 - var_x179 - var_x182 - var_x186 + 10989720 * var_x183 - 5.3190528606277995e-13 * var_x184 - 1.8022499999999996e-7 * var_x185 - 0048783125000000007 * var_x174 * var_x55 / pow(var_x6, 2));
        ...
        IJth(rJacobian, 33, 36) = -var_x352 * (5.4067499999999991e-7 * var_x185 + 1.5957158581883399e-12 * var_x184 - 32969160 * var_x183);
        IJth(rJacobian, 35, 36) = var_x363;
        IJth(rJacobian, 36, 36) = -165.10000000000002 + var_x324 + var_x326 - 21.646099331949777 * var_x342 - var_x364 * (var_x179 + var_x182 + var_x186 - var_x181 + 21979440 * var_x183 - 1.0638105721255599e-12 * var_x184 - 3.6044999999999992e-7 * var_x185);
