...
#include "MathsCustomFunctions.hpp"
    ...
    void Celljafri_rice_winslow_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x26 = pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 2.0);
        ...
        const double var_x42 = 1 / var_chaste_interface__calcium_subsystem__Cai;
        const double var_x43 = pow(var_x42, 3.0);
        const double var_x44 = 1.0 + 1.7279999999999996e-9 * var_x43;
        const double var_x45 = 1 / var_x44;
        const double var_x46 = -1.0 + var_x38;
        const double var_x47 = 1 / var_x46;
        const double var_x48 = var_x45 * var_x47;
        const double var_x49 = 0.00063678763853082152 * var_x48;
        const double var_x50 = var_x39 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x51 = var_x50 - 0.75 * var_chaste_interface__ionic_concentrations__Ko;
        const double var_x52 = -26.614641953637257 * var_x12 + var_chaste_interface__membrane__V;
        const double var_x53 = var_x0 * var_x52 / pow(var_x1, 2);
        const double var_x54 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0);
        ...
        const double var_x66 = var_x13 / pow(var_x14, 2);
        const double var_x67 = var_x23 * var_x66;
        ...
        const double var_x71 = -26.614641953637257 * log(var_x69 * var_x70) + var_chaste_interface__membrane__V;
        const double var_x72 = var_x26 * var_x71;
        const double var_x73 = var_x10 * var_x27 * var_x72 / pow(var_x28, 2);
        const double var_x74 = -26.614641953637257 * var_x37 + var_chaste_interface__membrane__V;
        const double var_x75 = var_x38 * var_x74;
        const double var_x76 = var_x45 * var_x75 / pow(var_x46, 2);
        const double var_x77 = 2.3926214736989757e-5 * var_x76;
        const double var_x78 = var_x16 * var_x21 / pow(var_x17, 2);
        const double var_x79 = 0.24326999999999999 * var_x66 - 0.51429999999999998 * var_x78 - var_x18 * (0.061749999999999999 * var_x20 + 0.039456396800000001 * var_x19);
        const double var_x80 = var_x15 * var_x65 / pow((var_x15 + 0.98039215686274506 * var_x22), 2);
        ...
        const double var_x87 = exp(-var_x34);
        ...
        const double var_x91 = var_x84 * var_x90 * (0.00046778761937462537 * var_x85 + 0.037573302761014088 * var_x87 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x86)) / pow(var_x88, 2);
        const double var_x92 = var_x58 * var_chaste_interface__L_type_Ca_channel_y_gate__y;
        const double var_x93 = var_x63 * var_chaste_interface__membrane__V;
        const double var_x94 = 1 / (1.0 - 107.25680748803607 * var_x93);
        const double var_x95 = exp(var_x34);
        ...
        const double var_x102 = var_x48 * var_x75;
        const double var_x103 = 1.7944661052742317e-5 * var_x102;
        const double var_x104 = var_x59 * var_chaste_interface__membrane__V;
        const double var_x105 = var_x104 * var_x61;
        const double var_x106 = var_x105 * var_x92;
        const double var_x107 = var_x104 * var_x62 / pow(var_x60, 2);
        const double var_x108 = var_x107 * var_x92;
        const double var_x109 = var_x92 * var_x94 * var_chaste_interface__membrane__V;
        const double var_x110 = var_x109 * var_x95 * var_x99 / pow(var_x96, 2);
        const double var_x111 = var_x109 * var_x97;
        const double var_x112 = var_x111 * var_x98;
        const double var_x113 = var_x92 * var_x97 * var_x99 * (0.0080599850018555647 * var_x105 + 107.25680748803607 * var_x63 - 8.0599850018555639 * var_x107) * var_chaste_interface__membrane__V / pow((0.0093234175379641477 - var_x93), 2);
        const double var_x114 = -26.614641953637257 * log(140.0 * var_x82) + var_chaste_interface__membrane__V;
        const double var_x115 = var_x114 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x116 = var_x115 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x117 = var_x115 * var_x54;
        const double var_x118 = var_x101 * var_chaste_interface__membrane__V;
        const double var_x119 = -var_x118 * var_chaste_interface__L_type_Ca_channel_y_gate__y - var_x57 * var_x93;
        const double var_x120 = var_x58 * var_x93;
        const double var_x121 = var_x30 * var_x71 * pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 1.0);
        const double var_x122 = 0.00050000000000000001 + var_chaste_interface__calcium_subsystem__Cai;
        const double var_x123 = 1 / var_x122;
        const double var_x124 = var_chaste_interface__calcium_subsystem__Cai / pow(var_x122, 2);
        const double var_x125 = var_x3 * var_x5;
        const double var_x126 = var_x42 * var_x43 * var_x47 * var_x74 / pow(var_x44, 2);
        const double var_x127 = 3.301107118143778e-12 * var_x126;
        const double var_x128 = var_x5 * var_x7 * pow(var_chaste_interface__ionic_concentrations__Nai, 2.0);
        const double var_x129 = var_x55 * var_x82 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x130 = var_x39 + var_x35 * var_x40;
        const double var_x131 = var_x49 * var_x74;
        const double var_x132 = var_x31 * var_x69;
        const double var_x133 = 0.00047759072889811619 * var_x102;
        ...
        const double var_x137 = 0.016947874999999998 * var_x48;
        const double var_x138 = var_x35 * var_x41;
        const double var_x139 = var_x137 * var_x51;
        const double var_x140 = 0.00063678763853082152 * var_x76;
        const double var_x141 = var_x140 * var_x51;
        ...
        const double var_x144 = var_x39 + var_x35 * var_x50;
        ...
        const double var_x148 = 6.4745439480613349 * var_x66;
        ...
        const double var_x151 = var_x11 * var_x68;
        const double var_x152 = 0.00036387865058904091 * var_x111;
        ...
        const double var_x158 = var_x31 / var_x70;
        ...
        const double var_x162 = var_x155 * var_x52;
        const double var_x163 = var_x154 * var_x29 * var_x72;
        const double var_x164 = -0.75 - var_x160 * var_x50;
        const double var_x165 = var_x154 * var_x52 * var_x67;
        ...
        const double var_x263 = 3.5281248386597142e-5 * var_x123;
        ...
        const double var_x293 = 3.9072457120905308e-8 * var_x48;
        const double var_x294 = 0.00078539126843207548 * var_x55;
        const double var_x295 = 1.4680812610205159e-9 * var_x76;
        const double var_x296 = 1.101060945765387e-9 * var_x102;
        const double var_x297 = 2.0255161771477306e-16 * var_x126;
        const double var_x298 = var_x293 * var_x74;
        const double var_x299 = 1.0398994565217392e-6 * var_x48;
        const double var_x300 = 3.9072457120905308e-8 * var_x76;
        const double var_x301 = var_x138 * var_x300 - var_x138 * var_x299;
        const double var_x302 = 2.9304342840678981e-8 * var_x102;
        ...
        const double var_x306 = 8.4958190094815849e-8 * var_x53;
        const double var_x307 = var_x293 * var_x51;
        const double var_x308 = 2.9784363174171862e-6 * var_x31;
        const double var_x309 = 0.00015953260140026533 * var_x91;
        const double var_x310 = var_x295 * var_x51;
        const double var_x311 = 4.8175811365563749e-6 * var_x68;
        const double var_x312 = 9.2786178112684927e-8 * var_x73;
        const double var_x313 = 2.2327118354803037e-8 * var_x100;
        const double var_x314 = var_x313 * var_x92;
        const double var_x315 = 1.9415130354461213e-5 * var_x80;
        const double var_x316 = var_x315 * var_x79;
        const double var_x317 = var_x296 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x318 = 8.3890357772600914e-10 * var_x110;
        const double var_x319 = 1.9408096485119751e-12 * var_x113;
        const double var_x320 = 8.3890357772600914e-10 * var_x112;
        ...
        const double var_x324 = var_x321 * var_x58;
        const double var_x325 = 5.9568726348343725e-6 * var_x121;
        const double var_x326 = var_x297 * var_x51;
        ...
        const double var_x330 = var_x299 * var_x51;
        const double var_x331 = var_x330 * var_x35;
        const double var_x332 = var_x300 * var_x51;
        ...
        const double var_x342 = 2.2327118354803037e-8 * var_x111;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0074419999999999998 + 0.078515054885989852 * var_x68 + 1.3672122706851291e-5 * var_x110 + 0.0015121928745316601 * var_x73 + 3.6914731308498485 * var_x108 - 0.32920358442763042 * var_x25 - 0.048541391272466296 * var_x31 - 1.1248174225403713e-6 * var_x33 - 1.2999999999999998 * var_x91 - 0.0013846153846153843 * var_x53 - 1.3672122706851291e-5 * var_x112 - 0.0082799999999999992 * var_x2 - 3.163055727694504e-8 * var_x113 - 0.00046056327637115517 * var_x9 - 0.0036914731308498486 * var_x106 + var_x41 * var_x77 + var_x51 * var_x77 - var_x101 * var_x92 - var_x103 * var_chaste_interface__ionic_concentrations__Ki - var_x103 * var_chaste_interface__ionic_concentrations__Nai - var_x41 * var_x49 - var_x49 * var_x51 - var_x56 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x57 * var_x64 - var_x79 * var_x81);
        ...
        IJth(rJacobian, 19, 0) = var_x275 * (1.943239241472396 * var_x108 - 0.0019432392414723959 * var_x106 - var_x271 * var_x64);
        IJth(rJacobian, 28, 0) = -8.6515756913220823e-8 - 8.4778681833368931e-8 * var_x9 - 0.000239298902100398 * var_x91 - 2.0705198021331564e-10 * var_x33 + var_x295 * var_x41 - var_x293 * var_x41 - var_x294 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x296 * var_chaste_interface__ionic_concentrations__Nai;
        ...
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-38.399999999999999 * var_x116);
        IJth(rJacobian, 1, 1) = -0.080000000000000002 * var_x173 - var_x172 * var_x174;
        IJth(rJacobian, 28, 1) = -0.0023561738052962264 * var_x116;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x114 * var_x56);
        ...
        IJth(rJacobian, 28, 2) = -var_x114 * var_x294;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-12.800000000000001 * var_x117);
        IJth(rJacobian, 3, 3) = ((var_x178) ? (-0.1212 * var_x192 - var_x188 * var_x193) : (-0.29999999999999999 * var_x198));
        IJth(rJacobian, 28, 3) = -0.00078539126843207548 * var_x117;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x119);
        ...
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x119);
        ...
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-49.123617829520519 * var_x120 - var_x118 * var_x58);
        IJth(rJacobian, 16, 16) = -var_x244;
        IJth(rJacobian, 19, 16) = -25.859308321022734 * var_x120 * var_x274;
        IJth(rJacobian, 29, 16) = -var_x324;
        IJth(rJacobian, 30, 16) = var_x324;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-0.097082782544932592 * var_x121);
        IJth(rJacobian, 17, 17) = -var_x252 * var_x256 - var_x255 * var_x256;
        IJth(rJacobian, 29, 17) = -var_x325;
        IJth(rJacobian, 30, 17) = var_x325;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (1.1499999999999999 * var_x124 + 1263.7856303624499 * var_x125 - 1.1499999999999999 * var_x123 - 0.080269760132169965 * var_x42 - var_x127 * var_x41 - var_x127 * var_x51);
        IJth(rJacobian, 18, 18) = var_x260 * (-5.9200580000000009 + var_x261 + var_x262 - var_x263 + 0.0035999999999999999 * var_x266 + 3.5281248386597142e-5 * var_x124 - 0.0035999999999999999 * var_x268 - 0.077544234316921451 * var_x125 - 2.4626237783962268e-6 * var_x42) + 0.00023800000000000004 * pow(var_x257, (-3.0)) * (5.8e-5 * var_chaste_interface__calcium_subsystem__Ca_NSR + 6.6000000000000005e-5 * var_chaste_interface__calcium_subsystem__HTRPNCa + 0.040000000000000001 * var_chaste_interface__calcium_subsystem__LTRPNCa + 0.32000000000000001 * var_chaste_interface__calcium_subsystem__Ca_SS + 2.4626237783962268e-6 * log(1.8 * var_x42) - 0.32005800000000001 * var_chaste_interface__calcium_subsystem__Cai - 1.8505781762430779e-7 * var_chaste_interface__membrane__V - var_x263 * var_chaste_interface__calcium_subsystem__Cai - var_x269 * (0.14000000000000001 - var_chaste_interface__calcium_subsystem__HTRPNCa) - var_x270 * (0.070000000000000007 - var_chaste_interface__calcium_subsystem__LTRPNCa) + 2.8259560611122977e-8 * var_x32 * var_x5 - 0.0018 * var_x264 * var_x267) / pow(var_x258, 2);
        ...
        IJth(rJacobian, 19, 19) = var_x275 * (-5490.7343857240912 - var_x277 - var_x278) + 0.00023800000000000004 * pow(var_x272, (-3.0)) * (143.30816746739879 * var_x279 + 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Cai - 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Ca_SS - var_x120 * var_x271) / pow(var_x273, 2);
        ...
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (var_x142 - 340.66741700655689 * var_x129 - 0.03752664515462853 * var_x82 - 0.0024870416924042378 * var_x128 - 0.023680742352719723 * var_x132 - 0.061664414373283391 * var_x136 - var_x130 * var_x131 - var_x134 * var_chaste_interface__ionic_concentrations__Ki);
        IJth(rJacobian, 18, 28) = 1.5260162730006407e-7 * var_x128 * var_x259;
        IJth(rJacobian, 28, 28) = var_x301 - 0.020902907402832696 * var_x129 - 1.1350943583223629e-5 * var_x136 - 4.5780488190019227e-7 * var_x128 - 2.3025858935932891e-6 * var_x82 - var_x130 * var_x298;
        IJth(rJacobian, 29, 28) = var_x328 + var_x334 - var_x327 - var_x329;
        IJth(rJacobian, 30, 28) = var_x327 + var_x329 + var_x356 - var_x328;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (var_x142 + 2.0896500737607973 * var_x151 - 1.2919117486481027 * var_x132 - 8.7616355293953774 * var_x145 - var_x11 * var_x143 - var_x131 * var_x144 - var_x134 * var_chaste_interface__ionic_concentrations__Nai - var_x150 * var_x81 - var_x152 * var_x95);
