...
#include "MathsCustomFunctions.hpp"
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel__i_Ca_L_Ca_max = 4.0 * pow(var_membrane__F, 2) * (0.001 * exp(2.0 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) - 0.34100000000000003 * NV_Ith_S(mParameters, 4)) * NV_Ith_S(mParameters, 6) * var_chaste_interface__membrane__V / ((-1.0 + exp(2.0 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * var_membrane__R * var_membrane__T); // uA_per_mm2
    ...
    void Celljafri_rice_winslow_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x6 = var_chaste_interface__ionic_concentrations__Ko + NV_Ith_S(mParameters, 5);
        ...
        const double var_x20 = var_x19 - 0.75 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x40 = var_x39 * NV_Ith_S(mParameters, 9) * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x46 = var_x44 * var_x45 * NV_Ith_S(mParameters, 8);
        ...
        const double var_x57 = pow(NV_Ith_S(mParameters, 5), 3);
        const double var_x58 = var_x56 * var_x57;
        const double var_x59 = var_x58 * var_chaste_interface__calcium_subsystem__Cai;
        const double var_x60 = NV_Ith_S(mParameters, 4) * exp(0.013150655966354929 * var_chaste_interface__membrane__V);
        ...
        const double var_x63 = NV_Ith_S(mParameters, 12) / ((669921.875 + var_x57) * (1.3799999999999999 + NV_Ith_S(mParameters, 4)));
        ...
        const double var_x79 = 0.001 * var_x76 - 0.34100000000000003 * NV_Ith_S(mParameters, 4);
        const double var_x80 = var_x78 * var_x79 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x100 = 0.018329999999999999 * NV_Ith_S(mParameters, 5) + var_chaste_interface__ionic_concentrations__Ko;
        const double var_x101 = -26.614641953637257 * log(var_x100 * var_x99) + var_chaste_interface__membrane__V;
        const double var_x102 = var_x101 * var_x21 * NV_Ith_S(mParameters, 8);
        ...
        const double var_x106 = var_x76 * NV_Ith_S(mParameters, 6) * var_chaste_interface__membrane__V;
        ...
        const double var_x121 = var_x16 * var_x48 / (pow(var_x13, 2) * pow(var_chaste_interface__calcium_subsystem__Cai, 4));
        const double var_x122 = 3.301107118143778e-14 * var_x121;
        const double var_x123 = var_x58 * var_x64;
        const double var_x124 = -26.614641953637257 * log(var_x66 * NV_Ith_S(mParameters, 5)) + var_chaste_interface__membrane__V;
        const double var_x125 = var_x0 * var_x124;
        const double var_x126 = NV_Ith_S(mParameters, 9) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x127 = var_x126 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x128 = var_x126 * var_x39;
        const double var_x129 = 14555.146023561636 * var_x90;
        const double var_x130 = var_x111 * var_x94;
        const double var_x131 = var_x130 * var_x98;
        const double var_x132 = var_x0 * (-var_x129 * var_chaste_interface__L_type_Ca_channel_y_gate__y - var_x131 * var_chaste_interface__L_type_Ca_channel_y_gate__y);
        const double var_x133 = var_x102 * var_x44 * var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        const double var_x134 = var_x9 + var_x19 * var_x5;
        const double var_x135 = var_x18 * var_x48;
        const double var_x136 = var_x47 * var_x99;
        const double var_x137 = var_x41 * var_x66;
        const double var_x138 = 4.7759072889811619e-6 * var_x88;
        const double var_x139 = var_x138 * var_x5;
        ...
        const double var_x143 = 0.00016947874999999999 * var_x17;
        const double var_x144 = var_x11 * var_x5;
        const double var_x145 = var_x143 * var_x20;
        const double var_x146 = 6.3678763853082156e-6 * var_x50;
        const double var_x147 = var_x20 * var_x5;
        const double var_x148 = var_x144 * var_x146 + var_x146 * var_x147 - var_x143 * var_x144 - var_x145 * var_x5;
        const double var_x149 = 0.0022036923537611646 * var_x3;
        ...
        const double var_x158 = 3.6387865058904094e-6 * var_x114;
        ...
        const double var_x173 = var_x165 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x174 = var_x165 * var_x20;
        ...
        const double var_x184 = NV_Ith_S(mParameters, 2) / var_x183;
        const double var_x185 = var_x184 * var_chaste_interface__calcium_subsystem__Cai;
        const double var_x186 = var_x12 * NV_Ith_S(mParameters, 2) / pow(var_x183, 2);
        ...
        const double var_x197 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 11) - 0.14705882352941177 * var_chaste_interface__membrane__V);
        ...
        const double var_x201 = exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * NV_Ith_S(mParameters, 11));
        const double var_x202 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x203 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 11) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        ...
        const double var_x207 = ((var_x198) ? (-0.019852941176470591 * var_x197) : (0));
        const double var_x208 = var_x199 + var_x205;
        const double var_x209 = 0.01 * NV_Ith_S(mParameters, 10);
        const double var_x210 = 1.0 - var_x209;
        const double var_x211 = var_x210 / var_x208;
        const double var_x212 = ((var_x198) ? (0.28123999999999999 * var_x202 + 108500.0 * var_x201) : (0.693000693000693 * var_x203 / pow(var_x204, 2)));
        const double var_x213 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 11) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x214 = 1.0 + var_x213;
        const double var_x215 = exp(0.01052 * NV_Ith_S(mParameters, 11) - 0.01052 * var_chaste_interface__membrane__V);
        const double var_x216 = var_x215 / var_x214;
        const double var_x217 = exp(-3.2000000000000002 + var_x191 + 0.10000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x218 = 1.0 + var_x217;
        const double var_x219 = exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 11) - 2.5349999999999999e-7 * var_chaste_interface__membrane__V);
        ...
        const double var_x224 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 11));
        const double var_x225 = 1.0 + var_x224;
        const double var_x226 = 1 / var_x225;
        const double var_x227 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x228 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 11) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        ...
        const double var_x233 = ((var_x198) ? (var_x230 + var_x223 * var_x226 * (1.5254334000000001e-6 * var_x228 - 31073.016 * var_x227) - 0.311 * var_x223 * var_x224 * var_x229 / pow(var_x225, 2)) : (0));
        const double var_x234 = var_x221 + var_x231;
        const double var_x235 = var_x210 / var_x234;
        const double var_x236 = ((var_x198) ? (-0.001275024 * var_x216 + 0.016701360000000002 * var_x213 * var_x215 / pow(var_x214, 2)) : (-7.6049999999999996e-8 * var_x220 + 0.029999999999999999 * var_x217 * var_x219 / pow(var_x218, 2)));
        const double var_x237 = exp(1.2 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x238 = 0.16 * var_x237;
        const double var_x239 = var_x238 * var_chaste_interface__L_type_Ca_channel__C0;
        const double var_x240 = exp(-0.92307692307692313 - 0.076923076923076927 * var_chaste_interface__membrane__V);
        const double var_x241 = 0.0038461538461538464 * var_x240;
        ...
        const double var_x246 = 0.12000000000000001 * var_x237;
        const double var_x247 = 0.0076923076923076927 * var_x240;
        ...
        const double var_x252 = 0.375 * var_chaste_interface__L_type_Ca_channel__C1;
        const double var_x253 = 0.080000000000000002 * var_x237;
        const double var_x254 = -var_x253;
        const double var_x255 = 0.011538461538461539 * var_x240;
        ...
        const double var_x261 = 0.75 * var_chaste_interface__L_type_Ca_channel__C2;
        const double var_x262 = 0.040000000000000001 * var_x237;
        const double var_x263 = 0.015384615384615385 * var_x240 * var_chaste_interface__L_type_Ca_channel__C4;
        ...
        const double var_x267 = 1.5 * var_chaste_interface__L_type_Ca_channel__C3;
        const double var_x268 = 3.0 * var_chaste_interface__calcium_subsystem__Ca_SS;
        const double var_x269 = 3.0 * var_chaste_interface__L_type_Ca_channel__C4;
        const double var_x270 = 0.32000000000000001 * var_x237 * var_chaste_interface__L_type_Ca_channel__C_Ca0;
        const double var_x271 = 0.0019230769230769232 * var_x240;
        const double var_x272 = 3.2000000000000002 * var_x237;
        const double var_x273 = 0.025000000000000001 * var_x240;
        const double var_x274 = 0.24000000000000002 * var_x237;
        const double var_x275 = 2.4000000000000004 * var_x237;
        const double var_x276 = 0.0057692307692307696 * var_x240;
        const double var_x277 = 0.075000000000000011 * var_x240;
        const double var_x278 = var_x247 * var_chaste_interface__L_type_Ca_channel__C_Ca4;
        ...
        const double var_x283 = exp(3.5 - 0.16666666666666666 * var_chaste_interface__membrane__V);
        const double var_x284 = 1.0 + var_x283;
        const double var_x285 = exp(7.333333333333333 + 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x286 = 1.0 + var_x285;
        const double var_x287 = 1.0 - var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        ...
        const double var_x301 = -var_x300 * var_chaste_interface__L_type_Ca_channel_y_gate__y;
        ...
        const double var_x304 = (var_chaste_interface__calcium_subsystem__P_O1 + var_chaste_interface__calcium_subsystem__P_O2) * NV_Ith_S(mParameters, 1);
        ...
        const double var_x306 = var_x298 * NV_Ith_S(mParameters, 1);
        const double var_x307 = var_x306 * (79.615648592999321 * var_chaste_interface__calcium_subsystem__Ca_JSR - 79.615648592999321 * var_chaste_interface__calcium_subsystem__Ca_SS);
        const double var_x308 = pow(var_chaste_interface__calcium_subsystem__Ca_SS, 3.0);
        const double var_x309 = 48600000000.0 * var_x308 * var_chaste_interface__calcium_subsystem__P_C1;
        const double var_x310 = 121500000.0 * pow(var_chaste_interface__calcium_subsystem__Ca_SS, 2.0) * var_chaste_interface__calcium_subsystem__P_O1;
        ...
        const double var_x317 = var_x316 * (-var_chaste_interface__calcium_subsystem__Ca_JSR + var_chaste_interface__calcium_subsystem__Ca_SS) * NV_Ith_S(mParameters, 1);
        const double var_x318 = 12.345679012345679 * NV_Ith_S(mParameters, 0);
        const double var_x319 = 3.9072457120905308e-8 * var_x17;
        const double var_x320 = 1.4680812610205159e-9 * var_x50;
        const double var_x321 = 1.101060945765387e-9 * var_x88;
        const double var_x322 = 2.0255161771477306e-16 * var_x121;
        const double var_x323 = var_x124 * NV_Ith_S(mParameters, 3);
        const double var_x324 = 0.00613586928462559 * var_x323;
        ...
        const double var_x329 = 2.9304342840678981e-8 * var_x88;
        const double var_x330 = var_x329 * var_x5;
        const double var_x331 = 5.0804997676699878e-7 * var_x3;
        const double var_x332 = 2.0199501620781446e-5 * var_x36;
        const double var_x333 = 8.4958190094815849e-8 * var_x38;
        const double var_x334 = var_x11 * var_x319;
        const double var_x335 = 0.0026404577282067251 * var_x47;
        const double var_x336 = 0.00015953260140026533 * var_x75;
        const double var_x337 = var_x11 * var_x320;
        const double var_x338 = 4.8175811365563749e-6 * var_x55;
        const double var_x339 = var_x321 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x340 = 2.2327118354803037e-8 * var_x97;
        const double var_x341 = var_x340 * var_x95;
        const double var_x342 = 1.9415130354461213e-5 * var_x86;
        const double var_x343 = var_x342 * var_x85;
        const double var_x344 = 8.2257250099897967e-5 * var_x103;
        const double var_x345 = 8.3890357772600914e-10 * var_x113;
        const double var_x346 = 2.2107034902581714e-21 * var_x116;
        const double var_x347 = 8.3890357772600914e-10 * var_x115;
        const double var_x348 = var_x11 * var_x322 * NV_Ith_S(mParameters, 3);
        const double var_x349 = var_x130 * var_x340 * NV_Ith_S(mParameters, 3);
        const double var_x350 = var_x349 * var_chaste_interface__L_type_Ca_channel_y_gate__y;
        const double var_x351 = -var_x350;
        const double var_x352 = var_x349 * var_x81;
        const double var_x353 = 0.0052809154564134502 * var_x133 * NV_Ith_S(mParameters, 3);
        const double var_x354 = 0.0012881377627587346 * var_x136;
        const double var_x355 = 7.5672957221490862e-6 * var_x141;
        const double var_x356 = var_x330 * var_chaste_interface__ionic_concentrations__Ki;
        ...
        const double var_x381 = var_x357 - var_x358;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-7.4419999999999996e-5 - var_x41 + 1093.7698165481033 * var_x110 + 1.3672122706851292e-7 * var_x113 + 0.00078515054885989848 * var_x55 + 0.01340596519974876 * var_x103 - var_x65 - 8.2799999999999993e-5 * var_x3 - 0.012999999999999999 * var_x75 - 0.43033148291193518 * var_x47 - 14555.146023561636 * var_x83 - 0.0024422646794659158 * var_x105 - 1.0937698165481033 * var_x108 - 1.3672122706851292e-7 * var_x115 - 3.602918164827021e-19 * var_x116 - 0.0032920358442763043 * var_x36 - 1.3846153846153843e-5 * var_x38 + var_x11 * var_x51 + var_x20 * var_x51 - var_x11 * var_x18 - var_x18 * var_x20 - var_x85 * var_x87 - var_x89 * var_chaste_interface__ionic_concentrations__Ki - var_x89 * var_chaste_interface__ionic_concentrations__Nai - var_x95 * var_x98));
        IJth(rJacobian, 1, 0) = var_x178 * (-1.8505781762430779e-7 + 0.00613586928462559 * var_x65 + 1.4985416831660874e-5 * var_x105);
        IJth(rJacobian, 2, 0) = var_x190 * var_x194 + 0.0072727272727272727 * var_x195 * var_chaste_interface__fast_sodium_current_m_gate__m - 0.032000000000000001 * var_x190 * var_x192 * var_x196 / pow(var_x193, 2);
        IJth(rJacobian, 3, 0) = (var_x200 + var_x206) * (var_x207 * var_x211 + var_x199 * var_x210 * (-var_x207 - var_x212) / pow(var_x208, 2)) + (var_x207 + var_x212) * (var_x209 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x199 * var_x211);
        IJth(rJacobian, 4, 0) = (var_x222 + var_x232) * (var_x233 * var_x235 + var_x210 * var_x231 * (-var_x233 - var_x236) / pow(var_x234, 2)) + (var_x233 + var_x236) * (var_x209 - var_chaste_interface__fast_sodium_current_j_gate__j + var_x231 * var_x235);
        IJth(rJacobian, 7, 0) = -var_x239 - var_x241 * var_chaste_interface__L_type_Ca_channel__C1;
        IJth(rJacobian, 8, 0) = var_x239 + (var_x241 - var_x246) * var_chaste_interface__L_type_Ca_channel__C1 - var_x247 * var_chaste_interface__L_type_Ca_channel__C2;
        IJth(rJacobian, 9, 0) = var_x246 * var_chaste_interface__L_type_Ca_channel__C1 + (var_x247 + var_x254) * var_chaste_interface__L_type_Ca_channel__C2 - var_x255 * var_chaste_interface__L_type_Ca_channel__C3;
        IJth(rJacobian, 10, 0) = -var_x263 + var_x253 * var_chaste_interface__L_type_Ca_channel__C2 + (var_x255 - var_x262) * var_chaste_interface__L_type_Ca_channel__C3;
        IJth(rJacobian, 11, 0) = var_x263 + var_x262 * var_chaste_interface__L_type_Ca_channel__C3;
        IJth(rJacobian, 12, 0) = -var_x270 - var_x271 * var_chaste_interface__L_type_Ca_channel__C_Ca1;
        IJth(rJacobian, 13, 0) = var_x270 + (var_x271 - var_x274) * var_chaste_interface__L_type_Ca_channel__C_Ca1 - var_x241 * var_chaste_interface__L_type_Ca_channel__C_Ca2;
        IJth(rJacobian, 14, 0) = var_x274 * var_chaste_interface__L_type_Ca_channel__C_Ca1 + (var_x241 - var_x238) * var_chaste_interface__L_type_Ca_channel__C_Ca2 - var_x276 * var_chaste_interface__L_type_Ca_channel__C_Ca3;
        IJth(rJacobian, 15, 0) = -var_x278 + var_x238 * var_chaste_interface__L_type_Ca_channel__C_Ca2 + (var_x254 + var_x276) * var_chaste_interface__L_type_Ca_channel__C_Ca3;
        IJth(rJacobian, 16, 0) = var_x278 + var_x253 * var_chaste_interface__L_type_Ca_channel__C_Ca3;
        IJth(rJacobian, 17, 0) = var_x282 * (0.016666666666666666 * var_x283 / pow(var_x284, 2) - 0.13333333333333333 * var_x285 / pow(var_x286, 2)) + 0.00017543859649122806 * var_x279 * (-var_chaste_interface__L_type_Ca_channel_y_gate__y + 1 / var_x286 + 0.10000000000000001 / var_x284) / (pow(var_x280, 2) * pow((0.033333333333333333 + var_x281), 2));
        IJth(rJacobian, 18, 0) = var_x287 * var_x290 - var_x293 * var_chaste_interface__time_dependent_potassium_current_X_gate__X + 8.9997000000000013e-6 * var_x291 * var_x294 * var_chaste_interface__time_dependent_potassium_current_X_gate__X / pow(var_x292, 2) - 1.0641199999999999e-5 * var_x287 * var_x288 * var_x294 / pow(var_x289, 2);
        IJth(rJacobian, 19, 0) = var_x298 * (57577.45900658951 * var_x110 - 766201.72803030314 * var_x83 - 57.577459006589507 * var_x108);
        IJth(rJacobian, 28, 0) = (-8.6515756913220823e-8 - 0.000239298902100398 * var_x75 - 0.018407607853876771 * var_x65 - 4.495625049498262e-5 * var_x105 - 0.00613586928462559 * var_x41 + var_x20 * var_x320 - var_x20 * var_x319 - var_x321 * var_chaste_interface__ionic_concentrations__Nai) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 29, 0) = (var_x336 + var_x337 + var_x338 + var_x344 + var_x345 - var_x331 - var_x332 - var_x333 - var_x334 - var_x335 - var_x339 - var_x341 - var_x343 - var_x346 - var_x347) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 30, 0) = (var_x331 + var_x332 + var_x333 + var_x334 + var_x335 + var_x339 + var_x341 + var_x343 + var_x346 + var_x347 - var_x336 - var_x337 - var_x338 - var_x344 - var_x345) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (var_x123 + 0.0115 * var_x120 - 0.0115 * var_x118 - 0.00080269760132169958 * var_x119 - var_x11 * var_x122 - var_x122 * var_x20));
        IJth(rJacobian, 1, 1) = var_x178 * (-5.9200000000000008 + var_x179 + var_x180 - var_x181 - NV_Ith_S(mParameters, 0) - 2 * var_x185 + 2 * var_x186 + 3.5281248386597142e-5 * var_x120 - 2.4626237783962268e-6 * var_x119 - var_x187 * var_x58) + 0.00023800000000000004 * (6.6000000000000005e-5 * var_chaste_interface__calcium_subsystem__HTRPNCa + 0.040000000000000001 * var_chaste_interface__calcium_subsystem__LTRPNCa + 0.32000000000000001 * var_chaste_interface__calcium_subsystem__Ca_SS + 2.4626237783962268e-6 * log(var_x119 * NV_Ith_S(mParameters, 4)) - 0.32000000000000001 * var_chaste_interface__calcium_subsystem__Cai - 1.8505781762430779e-7 * var_chaste_interface__membrane__V + var_x104 * var_x187 + (-var_chaste_interface__calcium_subsystem__Cai + var_chaste_interface__calcium_subsystem__Ca_NSR) * NV_Ith_S(mParameters, 0) - var_x181 * var_chaste_interface__calcium_subsystem__Cai - var_x182 * var_x184 - var_x188 * (0.14000000000000001 - var_chaste_interface__calcium_subsystem__HTRPNCa) - var_x189 * (0.070000000000000007 - var_chaste_interface__calcium_subsystem__LTRPNCa)) / (pow(var_x175, 3) * pow(var_x176, 2));
        IJth(rJacobian, 19, 1) = 5490.7343857240912 * var_x297;
        IJth(rJacobian, 25, 1) = var_x318 + 24.691358024691358 * var_x185 - 24.691358024691358 * var_x186;
        IJth(rJacobian, 26, 1) = 2.8000000000000003 - var_x179;
        IJth(rJacobian, 27, 1) = 2.8000000000000003 - var_x180;
        IJth(rJacobian, 28, 1) = (0.018407607853876771 * var_x123 - var_x20 * var_x322) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 29, 1) = -var_x348;
        IJth(rJacobian, 30, 1) = var_x348;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x125 * var_x127);
        IJth(rJacobian, 2, 2) = -0.080000000000000002 * var_x195 - var_x194 * var_x196;
        IJth(rJacobian, 28, 2) = -0.018407607853876771 * var_x127 * var_x323;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x125 * var_x40);
        IJth(rJacobian, 3, 3) = -var_x200 - var_x206;
        IJth(rJacobian, 28, 3) = -var_x324 * var_x40;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x125 * var_x128);
        IJth(rJacobian, 4, 4) = -var_x222 - var_x232;
        IJth(rJacobian, 28, 4) = -var_x128 * var_x324;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x132);
        IJth(rJacobian, 5, 5) = -2.0;
        IJth(rJacobian, 11, 5) = 2.0;
        IJth(rJacobian, 19, 5) = var_x301;
        IJth(rJacobian, 29, 5) = var_x351;
        IJth(rJacobian, 30, 5) = var_x350;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x132);
        IJth(rJacobian, 19, 6) = var_x301;
        IJth(rJacobian, 29, 6) = var_x351;
        IJth(rJacobian, 30, 6) = var_x350;
        IJth(rJacobian, 7, 7) = var_x244 - var_x242;
        IJth(rJacobian, 8, 7) = var_x243;
        IJth(rJacobian, 7, 8) = var_x245;
        IJth(rJacobian, 8, 8) = var_x249 - var_x248 - var_x250;
        IJth(rJacobian, 9, 8) = var_x250;
        IJth(rJacobian, 13, 8) = var_x248;
        IJth(rJacobian, 8, 9) = var_x251;
        IJth(rJacobian, 9, 9) = var_x257 + var_x259 - var_x256;
        IJth(rJacobian, 10, 9) = var_x258;
        IJth(rJacobian, 14, 9) = var_x256;
        IJth(rJacobian, 9, 10) = var_x260;
        IJth(rJacobian, 10, 10) = -var_x260 - var_x264 - var_x265;
        IJth(rJacobian, 11, 10) = var_x265;
        IJth(rJacobian, 15, 10) = var_x264;
        IJth(rJacobian, 5, 11) = 0.29999999999999999;
        IJth(rJacobian, 10, 11) = var_x266;
        IJth(rJacobian, 11, 11) = -0.29999999999999999 - var_x266 - var_x268;
        IJth(rJacobian, 16, 11) = var_x268;
        IJth(rJacobian, 7, 12) = 0.01;
        IJth(rJacobian, 12, 12) = -0.01 + var_x242 - var_x272;
        IJth(rJacobian, 13, 12) = var_x272;
        IJth(rJacobian, 8, 13) = 0.0050000000000000001;
        IJth(rJacobian, 12, 13) = var_x273;
        IJth(rJacobian, 13, 13) = -0.0050000000000000001 - var_x273 - var_x275;
        IJth(rJacobian, 14, 13) = var_x275;
        IJth(rJacobian, 9, 14) = 0.0025000000000000001;
        IJth(rJacobian, 13, 14) = var_x245;
        IJth(rJacobian, 14, 14) = -0.0025000000000000001 + var_x244 + var_x249;
        IJth(rJacobian, 15, 14) = var_x243;
        IJth(rJacobian, 10, 15) = 0.00125;
        IJth(rJacobian, 14, 15) = var_x277;
        IJth(rJacobian, 15, 15) = -0.00125 + var_x259 - var_x277;
        IJth(rJacobian, 16, 15) = var_x258;
        IJth(rJacobian, 11, 16) = 0.00062500000000000001;
        IJth(rJacobian, 15, 16) = var_x251;
        IJth(rJacobian, 16, 16) = -0.00062500000000000001 + var_x257;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-var_x129 * var_x81 - var_x131 * var_x81));
        IJth(rJacobian, 17, 17) = -var_x282;
        IJth(rJacobian, 19, 17) = -var_x300 * var_x81;
        IJth(rJacobian, 29, 17) = -var_x352;
        IJth(rJacobian, 30, 17) = var_x352;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-0.86066296582387036 * var_x0 * var_x133);
        IJth(rJacobian, 18, 18) = -var_x290 * var_x294 - var_x293 * var_x294;
        IJth(rJacobian, 29, 18) = -var_x353;
        IJth(rJacobian, 30, 18) = var_x353;
        IJth(rJacobian, 1, 19) = 0.32000000000000001 * var_x177;
        IJth(rJacobian, 7, 19) = -0.1875 * var_chaste_interface__L_type_Ca_channel__C0;
        IJth(rJacobian, 8, 19) = -var_x252;
        IJth(rJacobian, 9, 19) = -var_x261;
        IJth(rJacobian, 10, 19) = -var_x267;
        IJth(rJacobian, 11, 19) = -var_x269;
        IJth(rJacobian, 12, 19) = 0.1875 * var_chaste_interface__L_type_Ca_channel__C_Ca0;
        IJth(rJacobian, 13, 19) = var_x252;
        IJth(rJacobian, 14, 19) = var_x261;
        IJth(rJacobian, 15, 19) = var_x267;
        IJth(rJacobian, 16, 19) = var_x269;
        IJth(rJacobian, 19, 19) = var_x298 * (-5490.7343857240912 + (-var_x302 - var_x303) * NV_Ith_S(mParameters, 1)) + 0.00023800000000000004 * (79.615648592999321 * var_x305 + 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Cai - 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Ca_SS - var_x299 * var_x82) / (pow(var_x295, 3) * pow(var_x296, 2));
        IJth(rJacobian, 20, 19) = var_x309 - var_x310;
        IJth(rJacobian, 21, 19) = var_x310;
        IJth(rJacobian, 22, 19) = -var_x309;
        IJth(rJacobian, 24, 19) = var_x304 * var_x316;
        IJth(rJacobian, 19, 20) = var_x307;
        IJth(rJacobian, 20, 20) = -0.16049999999999998 - var_x311;
        IJth(rJacobian, 21, 20) = var_x311;
        IJth(rJacobian, 22, 20) = 0.14249999999999999;
        IJth(rJacobian, 23, 20) = 0.017999999999999999;
        IJth(rJacobian, 24, 20) = var_x317;
        IJth(rJacobian, 19, 21) = var_x307;
        IJth(rJacobian, 20, 21) = 1.9299999999999999;
        IJth(rJacobian, 21, 21) = -1.9299999999999999;
        IJth(rJacobian, 24, 21) = var_x317;
        IJth(rJacobian, 20, 22) = var_x312;
        IJth(rJacobian, 22, 22) = -var_x312;
        IJth(rJacobian, 20, 23) = 0.00080000000000000004;
        IJth(rJacobian, 23, 23) = -0.00080000000000000004;
        IJth(rJacobian, 19, 24) = var_x306 * (var_x302 + var_x303);
        IJth(rJacobian, 24, 24) = var_x316 * (-0.029002320185614851 + (-var_chaste_interface__calcium_subsystem__P_O1 - var_chaste_interface__calcium_subsystem__P_O2) * NV_Ith_S(mParameters, 1)) + 0.16666666666666666 * (-var_x305 + 0.029002320185614851 * var_chaste_interface__calcium_subsystem__Ca_NSR - 0.029002320185614851 * var_chaste_interface__calcium_subsystem__Ca_JSR) / (pow(var_x313, 3) * pow((0.083333333333333329 + var_x314), 2));
        IJth(rJacobian, 25, 24) = 0.0016613674772994187;
        IJth(rJacobian, 1, 25) = var_x178 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 24, 25) = 0.029002320185614851 * var_x315;
        IJth(rJacobian, 25, 25) = -0.0016613674772994187 - var_x318;
        IJth(rJacobian, 1, 26) = var_x178 * (6.6000000000000005e-5 + var_x188);
        IJth(rJacobian, 26, 26) = -6.6000000000000005e-5 - var_x188;
        IJth(rJacobian, 1, 27) = var_x178 * (0.040000000000000001 + var_x189);
        IJth(rJacobian, 27, 27) = -0.040000000000000001 - var_x189;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (var_x148 - 3.0 * var_x142 - 0.20993565915531667 * var_x136 - 0.00061664414373283397 * var_x141 - 0.0003752664515462853 * var_x66 - 26.614641953637257 * var_x137 - var_x134 * var_x135 - var_x139 * var_chaste_interface__ionic_concentrations__Ki));
        IJth(rJacobian, 1, 28) = 0.018407607853876771 * var_x142 * var_x177;
        IJth(rJacobian, 28, 28) = (var_x328 - 0.16330396408463044 * var_x137 - 2.3025858935932891e-6 * var_x66 - 1.1350943583223629e-5 * var_x141 - 0.055222823561630309 * var_x142 - var_x134 * var_x325) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 29, 28) = (var_x355 + var_x359 - var_x354 - var_x356) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 30, 28) = (var_x354 + var_x356 + var_x381 - var_x355) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (var_x148 + 0.020896500737607973 * var_x157 - 0.087616355293953771 * var_x150 - 11.453118339078925 * var_x136 - var_x135 * var_x151 - var_x139 * var_chaste_interface__ionic_concentrations__Nai - var_x149 * var_x22 - var_x156 * var_x87 - var_x158 * var_x92));
        IJth(rJacobian, 28, 29) = (var_x328 - var_x330 * var_chaste_interface__ionic_concentrations__Nai) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 29, 29) = (var_x359 + var_x366 - var_x361 - var_x362 - var_x363 - var_x364 - var_x365 - var_x368) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 30, 29) = (var_x361 + var_x362 + var_x363 + var_x364 + var_x365 + var_x368 + var_x381 - var_x366) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 0, 30) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (var_x158 + 0.0057777777777777775 * var_x164 + 0.087616355293953771 * var_x161 + 11.453118339078925 * var_x169 - 0.012999999999999999 * var_x163 - 0.21516574145596759 * var_x170 - 0.020896500737607973 * var_x172 - 0.0016460179221381521 * var_x168 + var_x138 * var_x173 + var_x143 * var_x166 + var_x145 * var_x165 + var_x149 * var_x159 - var_x135 * var_x167 - var_x146 * var_x166 - var_x146 * var_x174 - var_x171 * var_x87));
        IJth(rJacobian, 28, 30) = (0.00010635506760017689 * var_x164 - 0.000239298902100398 * var_x163 + var_x173 * var_x329 + var_x174 * var_x326 - var_x174 * var_x327) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 29, 30) = (var_x367 + var_x369 + var_x370 + var_x371 + var_x372 + var_x376 - var_x373 - var_x374 - var_x375 - var_x377 - var_x378 - var_x379 - var_x380) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 30, 30) = (var_x373 + var_x374 + var_x375 + var_x377 + var_x378 + var_x379 + var_x380 - var_x367 - var_x369 - var_x370 - var_x371 - var_x372 - var_x376) * NV_Ith_S(mParameters, 3);
    }
