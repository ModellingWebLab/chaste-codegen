...
#include "MathsCustomFunctions.hpp"
    ...
    void Celljafri_rice_winslow_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x115 = -var_x71 * log10(140.0 * var_x83) + var_chaste_interface__membrane__V;
        const double var_x116 = var_x115 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x117 = var_x116 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x118 = var_x116 * var_x54;
        const double var_x119 = var_x102 * var_chaste_interface__membrane__V;
        const double var_x120 = -var_x119 * var_chaste_interface__L_type_Ca_channel_y_gate__y - var_x57 * var_x94;
        const double var_x121 = var_x58 * var_x94;
        const double var_x122 = var_x31 * var_x72 * var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        ...
        const double var_x128 = var_x47 * var_x75 / (pow(var_x44, 2) * pow(var_chaste_interface__calcium_subsystem__Cai, 4));
        const double var_x129 = 3.301107118143778e-12 * var_x128;
        ...
        const double var_x133 = var_x49 * var_x75;
        const double var_x134 = var_x32 * var_x69;
        const double var_x135 = 0.00047759072889811619 * var_x103;
        ...
        const double var_x139 = 0.016947874999999998 * var_x48;
        const double var_x140 = var_x36 * var_x42;
        const double var_x141 = var_x139 * var_x51;
        const double var_x142 = 0.00063678763853082152 * var_x77;
        const double var_x143 = var_x142 * var_x51;
        const double var_x144 = var_x140 * var_x142 + var_x143 * var_x36 - var_x139 * var_x140 - var_x141 * var_x36;
        const double var_x145 = 0.22036923537611644 * var_x2;
        ...
        const double var_x154 = 0.00036387865058904091 * var_x112;
        ...
        const double var_x163 = var_x162 * var_x42;
        ...
        const double var_x169 = var_x162 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x170 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x274 = -var_x272 * var_x273 * var_x94;
        ...
        const double var_x278 = var_x272 * (143.30816746739879 * var_chaste_interface__calcium_subsystem__Ca_JSR - 143.30816746739879 * var_chaste_interface__calcium_subsystem__Ca_SS);
        ...
        const double var_x289 = var_x286 * (1.8 * var_chaste_interface__calcium_subsystem__Ca_SS - 1.8 * var_chaste_interface__calcium_subsystem__Ca_JSR);
        const double var_x290 = 3.9072457120905308e-8 * var_x48;
        const double var_x291 = 0.00078539126843207548 * var_x55;
        const double var_x292 = 1.4680812610205159e-9 * var_x77;
        const double var_x293 = 1.101060945765387e-9 * var_x103;
        const double var_x294 = 2.0255161771477306e-16 * var_x128;
        ...
        const double var_x299 = 2.9304342840678981e-8 * var_x103;
        const double var_x300 = var_x299 * var_x36;
        const double var_x301 = 5.0804997676699878e-7 * var_x2;
        const double var_x302 = 2.0199501620781446e-5 * var_x26;
        const double var_x303 = 8.4958190094815849e-8 * var_x53;
        const double var_x304 = var_x290 * var_x51;
        const double var_x305 = 2.9784363174171862e-6 * var_x32;
        const double var_x306 = 0.00015953260140026533 * var_x92;
        const double var_x307 = var_x292 * var_x51;
        const double var_x308 = 4.8175811365563749e-6 * var_x68;
        const double var_x309 = 9.2786178112684927e-8 * var_x74;
        const double var_x310 = 2.2327118354803037e-8 * var_x101;
        const double var_x311 = var_x310 * var_x93;
        const double var_x312 = 1.9415130354461213e-5 * var_x81;
        const double var_x313 = var_x312 * var_x80;
        const double var_x314 = var_x293 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x315 = 8.3890357772600914e-10 * var_x111;
        const double var_x316 = 1.9408096485119751e-12 * var_x114;
        const double var_x317 = 8.3890357772600914e-10 * var_x113;
        const double var_x318 = var_x310 * var_chaste_interface__membrane__V;
        const double var_x319 = var_x318 * var_chaste_interface__L_type_Ca_channel_y_gate__y;
        const double var_x320 = -var_x319;
        const double var_x321 = var_x318 * var_x58;
        const double var_x322 = 5.9568726348343725e-6 * var_x122;
        const double var_x323 = var_x294 * var_x51;
        const double var_x324 = 1.4530193963918526e-6 * var_x134;
        const double var_x325 = 7.5672957221490862e-6 * var_x138;
        const double var_x326 = var_x300 * var_chaste_interface__ionic_concentrations__Ki;
        ...
        IJth(rJacobian, 1, 0) = var_x170 * var_x174 + 0.0072727272727272727 * var_x175 * var_chaste_interface__fast_sodium_current_m_gate__m - 0.032000000000000001 * var_x170 * var_x172 * var_x176 / pow(var_x173, 2);
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) * ((var_x178) ? (-0.019852941176470591 * var_x177) : (0)) - ((var_x178) ? (0.28123999999999999 * var_x179 + 108500.0 * var_x180) : (0.693000693000693 * var_x181 / pow(var_x182, 2))) * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__fast_sodium_current_j_gate__j) * ((var_x178) ? (var_x189 + var_x185 * var_x190 * (1.5254334000000001e-6 * var_x187 - 31073.016 * var_x186) - 0.311 * var_x183 * var_x188 * var_x190 / pow(var_x184, 2)) : (0)) - ((var_x178) ? (-0.001275024 * var_x194 + 0.016701360000000002 * var_x191 * var_x193 / pow(var_x192, 2)) : (-7.6049999999999996e-8 * var_x198 + 0.029999999999999999 * var_x195 * var_x197 / pow(var_x196, 2))) * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        IJth(rJacobian, 16, 0) = var_x244 * (0.016666666666666666 * var_x245 / pow(var_x246, 2) - 0.13333333333333333 * var_x247 / pow(var_x248, 2)) + 0.00017543859649122806 * var_x241 * (1 / var_x248 - var_chaste_interface__L_type_Ca_channel_y_gate__y + 0.10000000000000001 / var_x246) / (pow(var_x242, 2) * pow((0.033333333333333333 + var_x243), 2));
        ...
        IJth(rJacobian, 18, 0) = var_x259 * (-1.8505781762430779e-7 + 6.901732673777188e-11 * var_x34 + 2.8259560611122977e-8 * var_x9);
        IJth(rJacobian, 19, 0) = var_x272 * (1.943239241472396 * var_x109 - 0.0019432392414723959 * var_x107 - var_x273 * var_x64);
        IJth(rJacobian, 28, 0) = -8.6515756913220823e-8 - 8.4778681833368931e-8 * var_x9 - 0.000239298902100398 * var_x92 - 2.0705198021331564e-10 * var_x34 + var_x292 * var_x42 - var_x290 * var_x42 - var_x291 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x293 * var_chaste_interface__ionic_concentrations__Nai;
        IJth(rJacobian, 29, 0) = var_x306 + var_x307 + var_x308 + var_x309 + var_x315 - var_x301 - var_x302 - var_x303 - var_x304 - var_x305 - var_x311 - var_x313 - var_x314 - var_x316 - var_x317;
        IJth(rJacobian, 30, 0) = var_x301 + var_x302 + var_x303 + var_x304 + var_x305 + var_x311 + var_x313 + var_x314 + var_x316 + var_x317 - var_x306 - var_x307 - var_x308 - var_x309 - var_x315;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-38.399999999999999 * var_x117);
        IJth(rJacobian, 1, 1) = -0.080000000000000002 * var_x175 - var_x174 * var_x176;
        IJth(rJacobian, 28, 1) = -0.0023561738052962264 * var_x117;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x115 * var_x56);
        IJth(rJacobian, 2, 2) = -((var_x178) ? (0.13500000000000001 * var_x177) : (0)) - ((var_x178) ? (310000.0 * var_x180 + 3.5600000000000001 * var_x179) : (7.6923076923076916 / var_x182));
        IJth(rJacobian, 28, 2) = -var_x115 * var_x291;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-12.800000000000001 * var_x118);
        IJth(rJacobian, 3, 3) = -((var_x178) ? (0.1212 * var_x194) : (0.29999999999999999 * var_x198)) - ((var_x178) ? (var_x189 * var_x190) : (0));
        IJth(rJacobian, 28, 3) = -0.00078539126843207548 * var_x118;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x120);
        IJth(rJacobian, 4, 4) = -2.0;
        IJth(rJacobian, 10, 4) = 2.0;
        IJth(rJacobian, 19, 4) = var_x274;
        IJth(rJacobian, 29, 4) = var_x320;
        IJth(rJacobian, 30, 4) = var_x319;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x120);
        IJth(rJacobian, 19, 5) = var_x274;
        IJth(rJacobian, 29, 5) = var_x320;
        IJth(rJacobian, 30, 5) = var_x319;
        ...
        IJth(rJacobian, 19, 19) = var_x272 * (-5490.7343857240912 - var_x275 - var_x276) + 0.00023800000000000004 * (143.30816746739879 * var_x277 + 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Cai - 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Ca_SS - var_x121 * var_x273) / (pow(var_x270, 3) * pow(var_x271, 2));
        IJth(rJacobian, 20, 19) = var_x280 - var_x281;
        IJth(rJacobian, 21, 19) = var_x281;
        IJth(rJacobian, 22, 19) = -var_x280;
        IJth(rJacobian, 24, 19) = var_x286 * (var_x287 + var_x288);
        ...
        IJth(rJacobian, 19, 24) = var_x272 * (var_x275 + var_x276);
        IJth(rJacobian, 24, 24) = var_x286 * (-0.029002320185614851 - var_x287 - var_x288) + 0.16666666666666666 * (0.029002320185614851 * var_chaste_interface__calcium_subsystem__Ca_NSR - 1.8 * var_x277 - 0.029002320185614851 * var_chaste_interface__calcium_subsystem__Ca_JSR) / (pow(var_x284, 3) * pow((0.083333333333333329 + var_x285), 2));
        IJth(rJacobian, 25, 24) = 0.0016613674772994187;
        IJth(rJacobian, 18, 25) = 5.8e-5 * var_x259;
        IJth(rJacobian, 24, 25) = 0.029002320185614851 * var_x286;
        IJth(rJacobian, 25, 25) = -0.0023774168600154679;
        IJth(rJacobian, 18, 26) = var_x259 * (6.6000000000000005e-5 + var_x268);
        IJth(rJacobian, 26, 26) = -6.6000000000000005e-5 - var_x268;
        IJth(rJacobian, 18, 27) = var_x259 * (0.040000000000000001 + var_x269);
        IJth(rJacobian, 27, 27) = -0.040000000000000001 - var_x269;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (var_x144 - 340.66741700655689 * var_x131 - 0.03752664515462853 * var_x83 - 0.0024870416924042378 * var_x130 - 0.023680742352719723 * var_x134 - 0.061664414373283391 * var_x138 - var_x132 * var_x133 - var_x136 * var_chaste_interface__ionic_concentrations__Ki);
        IJth(rJacobian, 18, 28) = 1.5260162730006407e-7 * var_x130 * var_x259;
        IJth(rJacobian, 28, 28) = var_x298 - 0.020902907402832696 * var_x131 - 1.1350943583223629e-5 * var_x138 - 4.5780488190019227e-7 * var_x130 - 2.3025858935932891e-6 * var_x83 - var_x132 * var_x295;
        IJth(rJacobian, 29, 28) = var_x325 + var_x331 - var_x324 - var_x326;
        IJth(rJacobian, 30, 28) = var_x324 + var_x326 + var_x353 - var_x325;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (var_x144 + 2.0896500737607973 * var_x153 - 1.2919117486481027 * var_x134 - 8.7616355293953774 * var_x147 - var_x12 * var_x145 - var_x133 * var_x146 - var_x136 * var_chaste_interface__ionic_concentrations__Nai - var_x152 * var_x82 - var_x154 * var_x96);
        IJth(rJacobian, 28, 29) = var_x298 - var_x300 * var_chaste_interface__ionic_concentrations__Nai;
        ...
        IJth(rJacobian, 0, 30) = mSetVoltageDerivativeToZero ? 0.0 : (var_x154 + 1.2919117486481027 * var_x160 + 0.57777777777777772 * var_x161 + 8.7616355293953774 * var_x157 - 0.16460179221381521 * var_x164 - 0.024270695636233148 * var_x165 - 2.0896500737607973 * var_x167 - 1.2999999999999998 * var_x159 + var_x135 * var_x169 + var_x139 * var_x163 + var_x141 * var_x162 + var_x145 * var_x155 - var_x133 * var_x166 - var_x142 * var_x163 - var_x143 * var_x162 - var_x168 * var_x82);
        IJth(rJacobian, 28, 30) = 0.00010635506760017689 * var_x161 - 0.000239298902100398 * var_x159 + var_x163 * var_x296 + var_x169 * var_x299 - var_x163 * var_x297;
