...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhilgemann_noble_model_1987FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x42 = var_x38 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x49 = var_x1 * (var_x48 - var_x0 * NV_Ith_S(mParameters, 5));
        const double var_x50 = 3.743389082274547e-5 * var_x12;
        const double var_x51 = var_x15 * (var_x48 - var_x14 * NV_Ith_S(mParameters, 5));
        const double var_x52 = var_x38 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x56 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * NV_Ith_S(mParameters, 9);
        ...
        const double var_x60 = pow(NV_Ith_S(mParameters, 6), 3.0);
        ...
        const double var_x69 = NV_Ith_S(mParameters, 13) / var_x68;
        ...
        const double var_x73 = var_x72 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x77 = NV_Ith_S(mParameters, 12) / (10.0 + NV_Ith_S(mParameters, 5));
        const double var_x78 = var_x77 / var_x76;
        const double var_x79 = var_x78 * NV_Ith_S(mParameters, 5);
        const double var_x80 = var_x75 * var_x77 * (-26.713760659695652 * var_x74 + var_chaste_interface__membrane__V) / pow(var_x76, 2);
        const double var_x81 = var_x80 * NV_Ith_S(mParameters, 5);
        const double var_x82 = 1 / NV_Ith_S(mParameters, 8);
        ...
        const double var_x87 = var_x86 * NV_Ith_S(mParameters, 7);
        const double var_x88 = 1.0000000000609275e-9 * var_x87;
        const double var_x89 = var_x33 * var_x88;
        ...
        const double var_x93 = ((var_x37) ? (-var_x89 + var_x84 * (var_x89 + var_x36 * var_x88)) : (var_x44 * var_x92));
        const double var_x94 = 2.0000000001218549e-10 * var_x90;
        const double var_x95 = var_x49 * var_x94;
        const double var_x96 = ((var_x37) ? (-var_x95 + var_x84 * (var_x95 + var_x51 * var_x94)) : (var_x54 * var_x92));
        ...
        const double var_x112 = var_x109 * var_x67 * NV_Ith_S(mParameters, 13) / pow(var_x68, 2);
        const double var_x113 = 0.0001 * var_x112;
        ...
        const double var_x115 = -26.713760659695652 * log(var_x114 * (NV_Ith_S(mParameters, 6) + 0.12 * NV_Ith_S(mParameters, 5))) + var_chaste_interface__membrane__V;
        const double var_x116 = var_x115 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * NV_Ith_S(mParameters, 9) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x117 = var_x115 * var_x56;
        const double var_x118 = 1.0000000000609275e-9 * var_x11;
        const double var_x119 = var_x118 * var_x32;
        const double var_x120 = var_x11 * var_x17;
        const double var_x121 = var_x120 * var_x40;
        const double var_x122 = ((var_x37) ? (-var_x119 + var_x84 * (var_x119 + var_x118 * var_x35)) : (var_x121 * var_x44));
        const double var_x123 = 2.0000000001218549e-10 * var_x11;
        const double var_x124 = var_x123 * var_x49;
        const double var_x125 = ((var_x37) ? (-var_x124 + var_x84 * (var_x124 + var_x123 * var_x51)) : (var_x121 * var_x54));
        const double var_x126 = var_x4 * var_x99;
        const double var_x127 = ((var_x19) ? (-var_x126 + var_x97 * (var_x126 + var_x16 * var_x99)) : (var_x106 * var_x120));
        const double var_x128 = var_x9 * NV_Ith_S(mParameters, 7);
        const double var_x129 = 1.0000000000609275e-9 * var_x128;
        const double var_x130 = var_x129 * var_x33;
        const double var_x131 = var_x128 * var_chaste_interface__second_inward_calcium_current_d_gate__d;
        const double var_x132 = var_x131 * var_x17;
        const double var_x133 = var_x132 * var_x40;
        const double var_x134 = ((var_x37) ? (var_x130 + var_x84 * (-var_x130 - var_x129 * var_x36)) : (-var_x133 * var_x44));
        const double var_x135 = 2.0000000001218549e-10 * var_x131;
        const double var_x136 = var_x135 * var_x49;
        const double var_x137 = ((var_x37) ? (var_x136 + var_x84 * (-var_x136 - var_x135 * var_x51)) : (-var_x133 * var_x54));
        const double var_x138 = 2.0000000001218549e-7 * var_x131;
        const double var_x139 = var_x138 * var_x4;
        const double var_x140 = ((var_x19) ? (var_x139 + var_x97 * (-var_x139 - var_x138 * var_x16)) : (-var_x106 * var_x132));
        ...
        const double var_x146 = NV_Ith_S(mParameters, 5) / (1.0 + NV_Ith_S(mParameters, 5));
        ...
        const double var_x171 = 0.00040816326530612252 * NV_Ith_S(mParameters, 1);
        const double var_x172 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
        const double var_x173 = pow(var_x172, (-2));
        const double var_x174 = var_x173 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x175 = pow(var_chaste_interface__calcium_release__ActFrac, 2);
        const double var_x176 = var_x175 / pow(var_x172, 3);
        const double var_x177 = 3.944972704427023e-9 * var_x112;
        const double var_x178 = var_x173 * var_x175 * NV_Ith_S(mParameters, 1);
        ...
        const double var_x190 = exp(-7.5 + var_x184 + 0.10000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x191 = 1 / (1.0 + 320.0 * var_x190);
        const double var_x192 = 2.0 * var_x191;
        const double var_x193 = exp(-9.375 + 0.125 * NV_Ith_S(mParameters, 11) - 0.125 * var_chaste_interface__membrane__V);
        const double var_x194 = 0.02 * var_x193;
        const double var_x195 = 2.5 * var_x193;
        const double var_x196 = 20.0 * var_x193;
        const double var_x197 = 0.01 * NV_Ith_S(mParameters, 10);
        const double var_x198 = 1.0 - var_x197;
        const double var_x199 = var_x198 / (var_x196 + 2000.0 * var_x191);
        const double var_x200 = var_x190 / pow((0.0031250000000000002 + var_x190), 2);
        const double var_x201 = 0.001 * var_chaste_interface__second_inward_calcium_current_d_gate__d;
        ...
        const double var_x225 = 120.0 * var_x5;
        const double var_x226 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x227 = 0.012 / var_x224;
        const double var_x228 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x229 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x230 = NV_Ith_S(mParameters, 2) + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x233 = var_x232 / pow(var_x230, 3);
        const double var_x234 = pow(var_x230, (-2));
        const double var_x235 = var_x234 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x236 = var_x235 - var_x233;
        const double var_x237 = -0.59999999999999998 * var_x229;
        const double var_x238 = 0.5 * var_x231 * var_x234;
        const double var_x239 = 1.3149909014756744e-5 * NV_Ith_S(mParameters, 4);
        const double var_x240 = 8.0543192715385049e-10 * var_x112;
        const double var_x241 = 8.054319271538504e-6 * NV_Ith_S(mParameters, 4);
        const double var_x242 = 0.002 * NV_Ith_S(mParameters, 1);
        const double var_x243 = -var_x179;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83 * (-0.187 - var_x29 - var_x47 - var_x55 - var_x57 - var_x71 - var_x79 + 0.074867781645490947 * var_x81));
        IJth(rJacobian, 1, 0) = -3.2874772536891862e-8 + 1.3149909014756744e-5 * var_x71 - 6.5749545073783721e-6 * var_x29;
        ...
        IJth(rJacobian, 3, 0) = (var_x192 + var_x194) * (-var_x195 * var_x199 + 5.0000000000000004e-6 * var_x193 * var_x198 * (var_x195 - 0.625 * var_x200) / pow((var_x191 + 0.01 * var_x193), 2)) + (0.00062500000000000001 * var_x200 - 0.0025000000000000001 * var_x193) * (var_x197 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x196 * var_x199);
        IJth(rJacobian, 4, 0) = (0.001 - var_x201) * ((var_x206) ? (15.0 * var_x202 + 15.0 * var_x203) : (var_x211 - 7.5 * var_x204 * var_x209 / pow(var_x210, 2))) - var_x201 * ((var_x214) ? (6.0 * var_x212 + 6.0 * var_x213) : (var_x217 - 1.2 * var_x204 * var_x215 / pow(var_x216, 2)));
        IJth(rJacobian, 5, 0) = -var_x222 * var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca + 0.0030000000000000001 * var_x223 * (var_x10 + var_x225 * var_x8) / pow(var_x224, 2) + 0.0015625000000000001 * var_x220 * var_x226 * var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca / pow(var_x221, 2);
        IJth(rJacobian, 6, 0) = 0.048000000000000001 * var_x228 * var_x229;
        IJth(rJacobian, 8, 0) = (-1.5779890817708093e-7 - 3.9449727044270228e-5 * var_x71 - 1.3149909014756744e-5 * var_x47 - 1.3149909014756744e-5 * var_x57) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 9, 0) = (-4.0271596357692526e-8 - 8.054319271538504e-6 * var_x29 - 8.054319271538504e-6 * var_x71) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 10, 0) = (-2.2354845325086465e-6 + 9.8450451677488091e-7 * var_x81 - 1.3149909014756744e-5 * var_x55 - 1.3149909014756744e-5 * var_x79) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83 * (var_x111 - var_x107 - var_x93 - var_x96 + 0.0068999999999999999 * var_x110 - 0.066784401649239128 * var_x108 + var_x113 * var_x60));
        IJth(rJacobian, 1, 1) = -17.0 + var_x163 + var_x164 - 9.0734372201821531e-8 * var_x110 - 6.5749545073783721e-6 * var_x107 - 1.3149909014756744e-5 * var_x111 - 4.3910440264623234e-7 * var_x108 + (0.0030000000000000001 * var_x168 - 5.5199999999999998e-8 * var_x169 - 0.0030000000000000001 * var_x166) * NV_Ith_S(mParameters, 3) - var_x170 * var_x60;
        IJth(rJacobian, 5, 1) = var_x227 * (var_x86 + var_x225 * var_x7 - var_x225 * var_x85);
        IJth(rJacobian, 6, 1) = var_x228 * var_x236 + (var_x233 - var_x235) * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 7, 1) = var_x236 * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 8, 1) = (2.7220311660546459e-7 * var_x110 + 3.9449727044270228e-5 * var_x111 - 1.3149909014756744e-5 * var_x93 + var_x177 * var_x60) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 9, 1) = (8.054319271538504e-6 * var_x111 + 5.5574802973615678e-8 * var_x110 - 8.054319271538504e-6 * var_x107 - 5.3790289324163455e-7 * var_x108 + var_x240 * var_x60) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 10, 1) = -var_x239 * var_x96;
        IJth(rJacobian, 11, 1) = (2.7047999999999999e-6 * var_x169 + 0.14699999999999999 * var_x166 - 0.14699999999999999 * var_x168) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 13, 1) = 2.0 - var_x163;
        IJth(rJacobian, 14, 1) = 15.0 - var_x164;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0030000000000000001 * var_x116 * var_x82);
        IJth(rJacobian, 2, 2) = -8.0 * var_x188 - 0.001 * ((var_x183) ? (-var_x189 + 499999.99948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (var_x189 + 0.00019999999949504854 * var_x180)) : (var_x182 * var_x187));
        IJth(rJacobian, 8, 2) = -3.9449727044270228e-5 * var_x116 * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x117 * var_x83);
        IJth(rJacobian, 3, 3) = -var_x192 - var_x194;
        IJth(rJacobian, 8, 3) = -var_x117 * var_x239;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83 * (-var_x122 - var_x125 - var_x127));
        IJth(rJacobian, 1, 4) = -6.5749545073783721e-6 * var_x127;
        IJth(rJacobian, 4, 4) = -0.001 * ((var_x214) ? (var_x218 - 499999.99948602181 * (18.999998999999999 + var_chaste_interface__membrane__V) * (-var_x218 - 1.2000000012335477e-5 * var_x213)) : (var_x204 * var_x217)) - 0.001 * ((var_x206) ? (-var_x219 + 1249999.9964946085 * (19.000000400000001 + var_chaste_interface__membrane__V) * (var_x219 + 1.2000000033651759e-5 * var_x203)) : (var_x204 * var_x211));
        IJth(rJacobian, 8, 4) = -var_x122 * var_x239;
        IJth(rJacobian, 9, 4) = -var_x127 * var_x241;
        IJth(rJacobian, 10, 4) = -var_x125 * var_x239;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83 * (-var_x134 - var_x137 - var_x140));
        IJth(rJacobian, 1, 5) = -6.5749545073783721e-6 * var_x140;
        IJth(rJacobian, 5, 5) = var_x227 * (-1.0 - 119.0 * var_x8) - var_x222 * var_x226;
        IJth(rJacobian, 8, 5) = -var_x134 * var_x239;
        IJth(rJacobian, 9, 5) = -var_x140 * var_x241;
        IJth(rJacobian, 10, 5) = -var_x137 * var_x239;
        IJth(rJacobian, 1, 6) = (var_x171 * var_x174 - var_x171 * var_x176) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 6, 6) = -0.059999999999999998 + var_x237 - var_x232 * var_x234;
        IJth(rJacobian, 7, 6) = 0.059999999999999998 + var_x238;
        IJth(rJacobian, 12, 6) = (var_x176 * var_x242 - var_x174 * var_x242) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 6, 7) = var_x237 - var_x238;
        IJth(rJacobian, 7, 7) = -0.00059999999999999995;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83 * (-var_x144 + 0.00030000000000000003 * var_x151 + 0.0087500000000000008 * var_x148 - 3.0 * var_x153 - 14.0 * var_x147 - 26.713760659695652 * var_x149 - 0.32056512791634778 * var_x145));
        IJth(rJacobian, 1, 8) = 3.9449727044270228e-5 * var_x153 - var_x150 * var_x177;
        IJth(rJacobian, 8, 8) = (3.4518511163736454e-7 * var_x148 + 1.183491811328107e-8 * var_x151 - 0.00055229617861978322 * var_x147 - 4.215402265403831e-6 * var_x145 - 0.00035128352211698585 * var_x149 - 1.3149909014756744e-5 * var_x144 - 0.0001183491811328107 * var_x153) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 9, 8) = (2.4162957814615515e-9 * var_x151 - 2.4162957814615514e-5 * var_x153) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 10, 8) = (0.00036819745241318885 * var_x147 - 2.3012340775824301e-7 * var_x148) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83 * (-var_x155 - var_x157 + 0.066784401649239128 * var_x156 + var_x113 * var_x64));
        IJth(rJacobian, 1, 9) = 1.3149909014756744e-5 * var_x157 + 4.3910440264623234e-7 * var_x156 - 6.5749545073783721e-6 * var_x155 - var_x170 * var_x64;
        IJth(rJacobian, 8, 9) = (-3.9449727044270228e-5 * var_x157 + var_x177 * var_x64) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 9, 9) = (-4.9999999999999998e-7 + 5.3790289324163455e-7 * var_x156 - 8.054319271538504e-6 * var_x155 - 8.054319271538504e-6 * var_x157 + var_x240 * var_x64) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83 * (-var_x160 + 2.0 * var_x162 - 26.713760659695652 * var_x161 - 4.5413393121482608 * var_x72 - 3.2056512791634777 * var_x149));
        IJth(rJacobian, 8, 10) = -4.2154022654038303e-5 * var_x149 * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 10, 10) = (2.6299818029513489e-5 * var_x162 - 0.00035128352211698585 * var_x161 - 1.3149909014756744e-5 * var_x160 - 5.9718198759887604e-5 * var_x72) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 1, 11) = (5.5199999999999998e-8 * var_x166 + 7.1999999999999999e-7 * var_x168 - 1.3248e-11 * var_x169) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 11, 11) = -0.050000000000000003 + (6.4915199999999989e-10 * var_x169 - 2.7047999999999999e-6 * var_x166 - 3.5279999999999994e-5 * var_x168) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 12, 11) = 0.0050000000000000001;
        IJth(rJacobian, 1, 12) = 0.00020408163265306126 * var_x178 + 0.00020408163265306126 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 11, 12) = 0.050000000000000003;
        IJth(rJacobian, 12, 12) = -0.0050000000000000001 - 0.001 * var_x178 - 0.001 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 1, 13) = 0.050000000000000003 + var_x179;
        IJth(rJacobian, 13, 13) = -0.050000000000000003 + var_x243;
        IJth(rJacobian, 1, 14) = 0.20000000000000001 + var_x179;
        IJth(rJacobian, 14, 14) = -0.20000000000000001 + var_x243;
    }
