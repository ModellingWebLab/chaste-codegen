...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhilgemann_noble_model_1987FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x117 = 1.0 - var_chaste_interface__second_inward_calcium_current_d_gate__d;
        ...
        const double var_x128 = 120.0 * var_x23;
        const double var_x129 = 0.0030000000000000001 * var_x126 * (var_x28 + var_x128 * var_x26) / pow(var_x127, 2);
        ...
        const double var_x142 = var_x141 / pow(var_x139, 3);
        const double var_x143 = pow(var_x139, (-2));
        const double var_x144 = 1.0 * var_x143 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x145 = var_x144 - var_x142;
        const double var_x146 = -0.59999999999999998 * var_x138;
        const double var_x147 = 0.5 * var_x140 * var_x143;
        const double var_x148 = 0.00065749545073783716 * var_x6;
        const double var_x149 = 2.4612612919372021e-8 * var_x32;
        const double var_x150 = 6.0300901652461443e-6 * var_x42;
        const double var_x151 = 6.0300901652461443e-6 * var_x52;
        const double var_x152 = 4.922522583874404e-9 * var_x34;
        ...
        IJth(rJacobian, 4, 0) = ((var_x116) ? (0) : (var_x117 * var_x122 - var_x125 * var_chaste_interface__second_inward_calcium_current_d_gate__d + 0.0012000000000000001 * var_x115 * var_x123 * var_chaste_interface__second_inward_calcium_current_d_gate__d / pow(var_x124, 2) - 0.0074999999999999997 * var_x115 * var_x117 * var_x120 / pow(var_x121, 2)));
        ...
        IJth(rJacobian, 8, 0) = -1.5779890817708093e-7 + 9.2134586488626692e-10 * var_x51 - 1.2898842108407737e-7 * var_x46 - 3.9449727044270234e-7 * var_x19 - var_x148 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x149 * var_x30;
        IJth(rJacobian, 9, 0) = -4.0271596357692526e-8 + 4.5145947379427072e-7 * var_x50 - 4.5145947379427072e-7 * var_x53 - 8.0543192715385052e-8 * var_x19 - var_x150 * var_x29;
        IJth(rJacobian, 10, 0) = -2.2354845325086465e-6 + 1.8426917297725339e-10 * var_x49 + 4.7818790814779921e-7 * var_x8 - 7.3707669190901358e-10 * var_x46 - 6.3870986643104186e-6 * var_x5 - var_x152 * var_x30;
        ...
        IJth(rJacobian, 5, 1) = var_x135 * (var_x60 + var_x128 * var_x25 - var_x128 * var_x59);
        IJth(rJacobian, 6, 1) = var_x137 * var_x145 + (var_x142 - var_x144) * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 7, 1) = var_x145 * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 8, 1) = 1.0825005100947751 * var_x55 + 2.7220311660546458e-9 * var_x58 + 1.4376722683771949e-9 * var_x57 - var_x149 * var_x63;
        IJth(rJacobian, 9, 1) = 2.9352475479367729e-10 * var_x57 + 5.5574802973615687e-10 * var_x58 + 0.22101052081101658 * var_x55 - 5.3790289324163455e-7 * var_x54 - var_x150 * var_x62 - var_x151 * var_x39;
        IJth(rJacobian, 10, 1) = -var_x152 * var_x63;
        ...
        IJth(rJacobian, 4, 4) = ((var_x116) ? (-0.23999999999999999) : (-var_x115 * var_x122 - var_x115 * var_x125));
        ...
        IJth(rJacobian, 6, 6) = -0.059999999999999998 + var_x146 - var_x141 * var_x143;
        ...
        IJth(rJacobian, 9, 9) = -4.9999999999999998e-7 + 5.3790289324163455e-7 * var_x81 + 1.0696966282568414e-16 * var_x82 - 8.0543192715385052e-8 * var_x83 + var_x151 * var_x36;
