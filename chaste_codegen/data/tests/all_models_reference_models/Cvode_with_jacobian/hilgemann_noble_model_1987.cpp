...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhilgemann_noble_model_1987FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x55 = 1 / NV_Ith_S(mParameters, 0);
        ...
        const double var_x67 = 0.74867781645490938 * var_x53;
        ...
        const double var_x69 = -26.713760659695652 * var_x1 * log10(140.47999999999999 * var_x68) + var_chaste_interface__membrane__V;
        const double var_x70 = var_x69 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x71 = var_x69 * var_x7;
        const double var_x72 = var_x29 * var_x45;
        const double var_x73 = var_x23 * var_x72;
        const double var_x74 = var_x28 * var_x64;
        ...
        const double var_x99 = 0.10204081632653063 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        ...
        const double var_x116 = 0.001 * var_chaste_interface__second_inward_calcium_current_d_gate__d;
        ...
        const double var_x134 = 120.0 * var_x24;
        ...
        const double var_x147 = 2.4612612919372021e-8 * var_x35;
        const double var_x148 = 6.0300901652461443e-6 * var_x43;
        const double var_x149 = 6.0300901652461443e-6 * var_x53;
        const double var_x150 = 4.922522583874404e-9 * var_x33;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x56 * (-0.187 + 0.036364351084952742 * var_x9 + 7.0064809106461381e-5 * var_x50 + 0.056051847285169105 * var_x51 + 1.4012961821292276e-5 * var_x52 - 50.0 * var_x8 - 0.01 * var_x20 - 0.48571428571428571 * var_x6 - 0.0098651251221897624 * var_x47 - 0.056051847285169105 * var_x54 - var_x30 * var_x44 - var_x31 * var_x34 - var_x31 * var_x36));
        IJth(rJacobian, 1, 0) = -3.2874772536891862e-8 + 3.6853834595450679e-7 * var_x51 + 1.3149909014756745e-7 * var_x20 - 3.6853834595450679e-7 * var_x54 - var_x30 * var_x90;
        IJth(rJacobian, 2, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x108) ? (0) : (var_x112 - 20.0 * var_x107 * var_x110 / pow(var_x111, 2))) + 0.44800000000000001 * var_x113 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 3, 0) = -0.125 * var_x114 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x115 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x115), 2);
        IJth(rJacobian, 4, 0) = (0.001 - var_x116) * ((var_x118) ? (0) : (var_x123 - 7.5 * var_x117 * var_x121 / pow(var_x122, 2))) - var_x116 * ((var_x118) ? (0) : (var_x126 - 1.2 * var_x117 * var_x124 / pow(var_x125, 2)));
        IJth(rJacobian, 5, 0) = -0.001 * ((var_x128) ? (0) : (var_x131 - 1.5625 * var_x127 * var_x129 / pow(var_x130, 2))) * var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca + 0.0030000000000000001 * var_x132 * (var_x29 + var_x134 * var_x27) / pow(var_x133, 2);
        IJth(rJacobian, 6, 0) = 0.048000000000000001 * var_x136 * var_x137;
        IJth(rJacobian, 8, 0) = -1.5779890817708093e-7 + 9.2134586488626692e-10 * var_x50 - 0.00065749545073783716 * var_x8 - 3.9449727044270234e-7 * var_x20 - 1.2898842108407737e-7 * var_x47 - var_x147 * var_x31;
        IJth(rJacobian, 9, 0) = -4.0271596357692526e-8 + 4.5145947379427072e-7 * var_x51 - 4.5145947379427072e-7 * var_x54 - 8.0543192715385052e-8 * var_x20 - var_x148 * var_x30;
        IJth(rJacobian, 10, 0) = -2.2354845325086465e-6 + 4.7818790814779921e-7 * var_x9 + 1.8426917297725339e-10 * var_x52 - 6.3870986643104186e-6 * var_x6 - 7.3707669190901358e-10 * var_x47 - var_x150 * var_x31;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x56 * (3.6443148688046647e-5 * var_x59 + 27440.0 * var_x60 + 6.8999999999999997e-5 * var_x61 - 0.066784401649239128 * var_x57 - var_x34 * var_x66 - var_x36 * var_x66 - var_x40 * var_x67 - var_x44 * var_x65));
        IJth(rJacobian, 1, 1) = -17.0 + var_x91 + var_x92 + 0.0030000000000000001 * var_x96 - 5.5199999999999998e-8 * var_x97 - 4.7922408945906498e-10 * var_x59 - 0.0030000000000000001 * var_x94 - 0.36083350336492503 * var_x60 - 4.3910440264623234e-7 * var_x57 - 9.0734372201821535e-10 * var_x61 - var_x40 * var_x98 - var_x65 * var_x90;
        IJth(rJacobian, 5, 1) = var_x135 * (var_x63 + var_x134 * var_x26 - var_x134 * var_x62);
        IJth(rJacobian, 6, 1) = var_x136 * var_x144 + (var_x141 - var_x143) * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 7, 1) = var_x144 * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 8, 1) = 1.4376722683771949e-9 * var_x59 + 1.0825005100947751 * var_x60 + 2.7220311660546458e-9 * var_x61 - var_x147 * var_x66;
        IJth(rJacobian, 9, 1) = 5.5574802973615687e-10 * var_x61 + 0.22101052081101658 * var_x60 + 2.9352475479367729e-10 * var_x59 - 5.3790289324163455e-7 * var_x57 - var_x148 * var_x65 - var_x149 * var_x40;
        IJth(rJacobian, 10, 1) = -var_x150 * var_x66;
        IJth(rJacobian, 11, 1) = 2.7047999999999999e-6 * var_x97 + 0.14699999999999999 * var_x94 - 0.14699999999999999 * var_x96;
        IJth(rJacobian, 13, 1) = 2.0 - var_x91;
        IJth(rJacobian, 14, 1) = 15.0 - var_x92;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.14999999999999999 * var_x55 * var_x70);
        IJth(rJacobian, 2, 2) = -8.0 * var_x113 - 0.001 * ((var_x108) ? (2000.0) : (var_x107 * var_x112));
        IJth(rJacobian, 8, 2) = -0.0019724863522135117 * var_x70;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.050000000000000003 * var_x55 * var_x71);
        IJth(rJacobian, 3, 3) = -2.0 / (1.0 + 320.0 * var_x115) - 0.02 * var_x114;
        IJth(rJacobian, 8, 3) = -0.00065749545073783716 * var_x71;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x56 * (-var_x34 * var_x73 - var_x36 * var_x73 - var_x44 * var_x72));
        IJth(rJacobian, 1, 4) = -var_x72 * var_x90;
        IJth(rJacobian, 4, 4) = -0.001 * ((var_x118) ? (120.0) : (var_x117 * var_x123)) - 0.001 * ((var_x118) ? (120.0) : (var_x117 * var_x126));
        IJth(rJacobian, 8, 4) = -var_x147 * var_x73;
        IJth(rJacobian, 9, 4) = -var_x148 * var_x72;
        IJth(rJacobian, 10, 4) = -var_x150 * var_x73;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x56 * (var_x34 * var_x75 + var_x36 * var_x75 + var_x44 * var_x74));
        IJth(rJacobian, 1, 5) = var_x74 * var_x90;
        IJth(rJacobian, 5, 5) = -0.001 * ((var_x128) ? (25.0) : (var_x127 * var_x131)) + var_x135 * (-1.0 - 119.0 * var_x27);
        IJth(rJacobian, 8, 5) = var_x147 * var_x75;
        IJth(rJacobian, 9, 5) = var_x148 * var_x74;
        IJth(rJacobian, 10, 5) = var_x150 * var_x75;
        IJth(rJacobian, 1, 6) = var_x102 * var_x99 - var_x104 * var_x99;
        IJth(rJacobian, 6, 6) = -0.059999999999999998 + var_x145 - var_x140 * var_x142;
        IJth(rJacobian, 7, 6) = 0.059999999999999998 + var_x146;
        IJth(rJacobian, 12, 6) = var_x104 * var_x151 - var_x102 * var_x151;
        IJth(rJacobian, 6, 7) = var_x145 - var_x146;
        IJth(rJacobian, 7, 7) = -0.00059999999999999995;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x56 * (3.9843092588972283e-11 * var_x81 + 0.0070000000000000001 * var_x78 - 0.029999999999999999 * var_x83 - 0.0018716945411372736 * var_x84 - 1335.6880329847825 * var_x79 - 0.32056512791634778 * var_x76 - 11.199999999999999 * var_x77));
        IJth(rJacobian, 1, 8) = 3.9449727044270234e-7 * var_x83 - 5.2393304241151422e-16 * var_x81;
        IJth(rJacobian, 8, 8) = 1.5717991272345426e-15 * var_x81 + 2.7614808930989161e-7 * var_x78 - 1.1834918113281069e-6 * var_x83 - 0.017564176105849295 * var_x79 - 0.00044183694289582661 * var_x77 - 4.215402265403831e-6 * var_x76 - 2.4612612919372021e-8 * var_x84;
        IJth(rJacobian, 9, 8) = 3.2090898847705241e-16 * var_x81 - 2.4162957814615514e-7 * var_x83;
        IJth(rJacobian, 10, 8) = 0.00029455796193055103 * var_x77 - 1.840987262065944e-7 * var_x78;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x56 * (1.3281030862990761e-11 * var_x86 + 0.066784401649239128 * var_x85 - 0.01 * var_x87 + var_x37 * var_x67));
        IJth(rJacobian, 1, 9) = 1.3149909014756745e-7 * var_x87 + 4.3910440264623234e-7 * var_x85 - 1.7464434747050473e-16 * var_x86 + var_x37 * var_x98;
        IJth(rJacobian, 8, 9) = 5.2393304241151422e-16 * var_x86 - 3.9449727044270234e-7 * var_x87;
        IJth(rJacobian, 9, 9) = -4.9999999999999998e-7 + 5.3790289324163455e-7 * var_x85 + 1.0696966282568414e-16 * var_x86 - 8.0543192715385052e-8 * var_x87 + var_x149 * var_x37;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x56 * (0.97142857142857142 * var_x89 - 0.00037433890822745472 * var_x84 - 4.5413393121482608 * var_x2 - 12.975255177566458 * var_x88 - 160.28256395817388 * var_x79));
        IJth(rJacobian, 8, 10) = -0.002107701132701915 * var_x79;
        IJth(rJacobian, 10, 10) = 1.2774197328620837e-5 * var_x89 - 0.00017062342502825029 * var_x88 - 4.922522583874404e-9 * var_x84 - 5.9718198759887604e-5 * var_x2;
        IJth(rJacobian, 1, 11) = 5.5199999999999998e-8 * var_x94 + 7.1999999999999999e-7 * var_x96 - 1.3248e-11 * var_x97;
        IJth(rJacobian, 11, 11) = -0.050000000000000003 + 6.4915199999999989e-10 * var_x97 - 2.7047999999999999e-6 * var_x94 - 3.5279999999999994e-5 * var_x96;
        IJth(rJacobian, 12, 11) = 0.0050000000000000001;
        IJth(rJacobian, 1, 12) = 0.051020408163265314 * var_x105;
        IJth(rJacobian, 11, 12) = 0.050000000000000003;
        IJth(rJacobian, 12, 12) = -0.0050000000000000001 - 0.25 * var_x105;
        IJth(rJacobian, 1, 13) = 0.050000000000000003 + var_x106;
        IJth(rJacobian, 13, 13) = -0.050000000000000003 + var_x152;
        IJth(rJacobian, 1, 14) = 0.20000000000000001 + var_x106;
        IJth(rJacobian, 14, 14) = -0.20000000000000001 + var_x152;
    }
