...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x315 = 0.00052457313400000008 * var_x314 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2;
        const double var_x316 = exp(-0.041779999999999998 * var_chaste_interface__membrane__V);
        const double var_x317 = 2.8786419999999997e-6 * var_x316 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x318 = exp(0.11695499999999999 + 0.023390999999999999 * var_chaste_interface__membrane__V);
        const double var_x319 = 0.0021243940109999999 * var_x318 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x320 = exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x321 = 0.00021232196 * var_x320 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K;
        ...
        IJth(rJacobian, 32, 0) = (1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs) * ((var_x305) ? (2.4066649999999999e-6 * var_x302 + 2.4066649999999999e-6 * var_x303) : (var_x308 - 6.1610624e-7 * var_x304 * var_x306 / pow(var_x307, 2))) + 3.6226653999999999e-6 * var_x309 * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        ...
        IJth(rJacobian, 34, 0) = -var_x300 * var_x311 - 2.0711500974658867e-5 * var_x299 * (var_x301 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur) / pow((1 - 0.14166666666666666 * var_x297), 2);
        IJth(rJacobian, 35, 0) = var_x292 * var_x313 + 0.0021933842239185751 * var_x312 * (var_x288 - var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss) / pow((0.33511450381679392 + var_x312), 2);
        IJth(rJacobian, 37, 0) = var_x315 + var_x317 - var_x319 - var_x321;
        IJth(rJacobian, 38, 0) = 0.01176 * var_x326 * (0.022348 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K) + 0.0029658262000000005 * var_x327 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1;
        IJth(rJacobian, 39, 0) = -var_x315 - var_x317;
        IJth(rJacobian, 40, 0) = var_x319 + var_x321;
        ...
        IJth(rJacobian, 32, 32) = -((var_x305) ? (var_x310 - 640000.00000149151 * (26.499999218749998 + var_chaste_interface__membrane__V) * (-var_x310 - 3.7604140624912359e-12 * var_x302)) : (var_x304 * var_x308)) - 9.5333299999999997e-5 * var_x309;
        ...
        IJth(rJacobian, 37, 37) = -var_x322 - var_x323;
        IJth(rJacobian, 38, 37) = var_x328;
        IJth(rJacobian, 39, 37) = var_x322;
        IJth(rJacobian, 40, 37) = var_x323;
        IJth(rJacobian, 38, 38) = -0.023761000000000001 + var_x328 - 0.047002000000000002 * var_x327;
        IJth(rJacobian, 39, 38) = 0.023761000000000001;
        IJth(rJacobian, 37, 39) = var_x324;
        IJth(rJacobian, 38, 39) = 0.036777999999999998 + var_x328;
        IJth(rJacobian, 39, 39) = -0.036777999999999998 - var_x324;
        IJth(rJacobian, 37, 40) = var_x325;
        IJth(rJacobian, 38, 40) = var_x328;
        IJth(rJacobian, 40, 40) = -var_x325;
    }
