...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -82.4202
        double var_chaste_interface__calcium_concentration__Cai_converted = NV_Ith_S(rY, 1);
        ...
        const double var_x27 = NV_Ith_S(mParameters, 4) * exp(0.013632298072467722 * var_chaste_interface__membrane__V);
        ...
        const double var_x306 = exp(-1.0069999999999999 - 0.037999999999999999 * var_chaste_interface__membrane__V);
        ...
        const double var_x323 = exp(0.01176 * var_chaste_interface__membrane__V);
        const double var_x324 = exp(-0.063100000000000003 * var_chaste_interface__membrane__V);
