...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellli_mouse_2010FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -78.9452115785979
        double var_chaste_interface__calcium_concentration__Cai_converted = NV_Ith_S(rY, 1);
        ...
        const double var_x333 = var_x329 / pow(var_x330, 2);
        ...
        IJth(rJacobian, 31, 0) = (1.0 - var_chaste_interface__slow_delayed_rectifier_K_I__nKs) * ((var_x321) ? (2.4066649945278773e-6 * var_x318 + 2.4066650054721224e-6 * var_x319) : (var_x324 - 6.1610624e-7 * var_x320 * var_x322 / pow(var_x323, 2))) + 3.6226653999999999e-6 * var_x325 * var_chaste_interface__slow_delayed_rectifier_K_I__nKs;
        IJth(rJacobian, 32, 0) = 0.035770000000000003 * var_x327 * (0.18064 - 0.18064 * var_chaste_interface__fast_transient_outward_K_I__ato_f) + 0.024673572000000001 * var_x328 * var_chaste_interface__fast_transient_outward_K_I__ato_f;
        IJth(rJacobian, 33, 0) = -0.20000000000000001 * var_x332 * var_x333 + 0.018287887931822754 * var_x333 * (-var_chaste_interface__fast_transient_outward_K_I__ito_f + var_x331) / pow((0.88371646458550512 + var_x331), 2);
        IJth(rJacobian, 34, 0) = var_x292 + var_x289 * (var_x287 - var_chaste_interface__slow_transient_outward_K_I__ato_s);
        IJth(rJacobian, 35, 0) = -var_x299 * var_x337 + 0.00016708437761069341 * var_x334 * (var_x300 - var_chaste_interface__slow_transient_outward_K_I__ito_s) / (pow(var_x335, 2) * pow((0.25714285714285712 + var_x336), 2));
        ...
        IJth(rJacobian, 31, 31) = -((var_x321) ? (-var_x326 + 640000.00016065314 * (26.500000781250002 + var_chaste_interface__cell__V) * (var_x326 + 3.760414053005867e-12 * var_x318)) : (var_x320 * var_x324)) - 9.5333299999999997e-5 * var_x325;
        ...
        IJth(rJacobian, 32, 32) = -0.18064 * var_x327 - 0.39560000000000001 * var_x328;
        ...
        IJth(rJacobian, 33, 33) = -var_x332;
        IJth(rJacobian, 34, 34) = var_x293;
        IJth(rJacobian, 35, 35) = -var_x337;
    }
