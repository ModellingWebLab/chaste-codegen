...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellli_mouse_2010FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 31, 0) = (1.0 - var_chaste_interface__slow_delayed_rectifier_K_I__nKs) * ((var_x321) ? (2.4066649999999999e-6 * var_x318 + 2.4066649999999999e-6 * var_x319) : (var_x324 - 6.1610624e-7 * var_x320 * var_x322 / pow(var_x323, 2))) + 3.6226653999999999e-6 * var_x325 * var_chaste_interface__slow_delayed_rectifier_K_I__nKs;
        ...
        IJth(rJacobian, 31, 31) = -((var_x321) ? (var_x326 - 640000.00000149151 * (26.499999218749998 + var_chaste_interface__cell__V) * (-var_x326 - 3.7604140624912359e-12 * var_x318)) : (var_x320 * var_x324)) - 9.5333299999999997e-5 * var_x325;
