...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 2) = 02614; // (var_IKr__gkrmax) [mS_per_uF]
    }
    ...
    void Celllivshitz_rudy_2007FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x109 = -26.712338705498265 * log(140 * var_x108) + var_chaste_interface__cell__V;
        ...
        const double var_x210 = exp(-2500 + var_x161);
        ...
        const double var_x218 = 005608974358974359 * var_x205 * var_x216;
        const double var_x219 = 019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__cell__V), 2));
        const double var_x220 = exp(2.5 - 050000000000000003 * var_chaste_interface__cell__V);
        ...
        const double var_x236 = exp(089820359281437126 - 059880239520958084 * var_chaste_interface__cell__V);
        ...
        const double var_x252 = exp(-1.2962962962962963 - 092592592592592587 * var_chaste_interface__cell__V);
        ...
        const double var_x295 = 00023999003823076885 * var_x87;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0 : (-0070159999999999997 + var_x38 - var_x66 + 2.6097162183887167e-5 * var_x99 + 0.16655558320535219 * var_x69 + 7.9551252454080567e-6 * var_x50 + 040753166481039146 * var_x78 + 9.1272458415149417e-5 * var_x103 - 1.6875 * var_x57 - 0055199999999999997 * var_x2 - 6.8454343811362063e-5 * var_x105 - 1.684614757851118e-5 * var_x73 - 1.9572871637915374e-5 * var_x107 - 0.69834626081908679 * var_x18 - 00092307692307692295 * var_x63 + var_x101 * var_x102 - var_x101 * var_x106 - var_x4 * var_chaste_interface__ICaT__g - var_x61 * var_chaste_interface__IKr__xr - var_x71 * var_x72 - var_x75 * var_x77 - var_x81 * var_x88 - var_x91 * var_x94 - var_x91 * var_x96);
        IJth(rJacobian, 1, 0) = (var_x168 * var_x170 - var_x165 * (0.28123999999999999 * var_x166 + 108500 * var_x167) - 320.5128205128205 * var_x169 * var_x173 - 0.693000693000693 * var_x164 * var_x171 / pow(var_x172, 2)) * var_chaste_interface__INa__H - var_x170 * var_x175 - 0.14705882352941177 * var_x165 * var_x175;
        IJth(rJacobian, 2, 0) = var_x176 * var_x180 + 0072727272727272727 * var_x181 * var_chaste_interface__INa__m - 032000000000000001 * var_x176 * var_x178 * var_x182 / pow(var_x179, 2);
        IJth(rJacobian, 3, 0) = var_x197 * var_x201 + (7.6049999999999996e-8 * var_x187 + 001275024 * var_x192 + 5.0499999999999998 * var_x169 * var_x191 - 12.5 * var_x169 * var_x186 - 016701360000000002 * var_x165 * var_x188 * var_x190 / pow(var_x189, 2) - 029999999999999999 * var_x164 * var_x183 * var_x185 / pow(var_x184, 2)) * var_chaste_interface__INa__J + var_x193 * var_x202 * var_x203 * (1.5254334000000001e-6 * var_x195 - 31073.016 * var_x194) - var_x170 * var_x193 * var_x200 * var_x204 - 0.311 * var_x197 * var_x198 * var_x202 / pow(var_x199, 2);
        ...
        IJth(rJacobian, 5, 0) = (02 + var_x219) * (029999999999999999 * var_x220 / pow(var_x221, 2) - 0.125 * var_x222 / pow(var_x223, 2)) + var_x219 * (-022713800000000003 - 0022713799999999999 * var_chaste_interface__cell__V) * (-var_chaste_interface__ICaL__f + 1.0 / var_x223 + 0.59999999999999998 / var_x221);
        IJth(rJacobian, 6, 0) = (-var_chaste_interface__IKr__xr + 1.0 / var_x225) * (var_x228 + var_x231 - 00016973999999999998 * var_x229 * var_x232 / pow(var_x230, 2) - 8.8449999999999995e-5 * var_x226 * var_x233 / pow(var_x227, 2)) + 0.23529411764705882 * var_x224 * (var_x234 + var_x235) / pow(var_x225, 2);
        IJth(rJacobian, 7, 0) = 059880239520958084 * var_x251 + var_x248 * (-var_chaste_interface__IKs__xs1 + 1.0 * var_x238);
        IJth(rJacobian, 8, 0) = 014970059880239521 * var_x251 + var_x248 * (0.25 * var_x238 - 0.25 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 9, 0) = 092592592592592587 * var_x252 * var_x257 / pow(var_x253, 2) + 036429872495446269 * var_x254 * (-var_chaste_interface__ICaT__b + 1.0 / var_x253) / (pow(var_x255, 2) * pow((0.60655737704918045 + var_x256), 2));
        IJth(rJacobian, 10, 0) = 0069444444444444441 * (-var_chaste_interface__ICaT__g + 1.0 / var_x264) * (0.875 - 0.875 * var_x260 - 5000 * var_x265 + 416.66666666666669 * var_x261 * var_x265) / pow((var_x260 + 083333333333333329 * var_x262), 2) - 0.17857142857142858 * var_x263 * var_x266 / pow(var_x264, 2);
        IJth(rJacobian, 11, 0) = var_x272 * (-var_x278 + var_x102 * var_x280 - var_x106 * var_x280);
        IJth(rJacobian, 12, 0) = -2.4608297152947492e-7 + 5.615149446400099e-9 * var_x103 + 1.4682156444593685e-9 * var_x50 - 00031144876084199171 * var_x57 - 4.2113620848000749e-9 * var_x105 - 3.1091625412080743e-9 * var_x73 - 6.1520742882368733e-5 * var_x66 - var_x284 * var_x72 - var_x285 * var_x91;
        IJth(rJacobian, 13, 0) = var_x288 + 1.6055168046743987e-9 * var_x99 + 2.5071650767223771e-6 * var_x78 + 1.0246623209999443e-5 * var_x69 + 00020763250722799446 * var_x57 - 4.296278075471465e-5 * var_x18 - 3.3959450071067536e-7 * var_x2 - 1.2041376035057991e-9 * var_x107 - 5.6788378045263436e-8 * var_x63 - var_x289 * var_chaste_interface__IKr__xr - var_x290 * var_x75 - var_x291 * var_x91;
        ...
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (-var_x110);
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (-3 * var_x112);
        IJth(rJacobian, 2, 2) = -080000000000000002 * var_x181 - var_x180 * var_x182;
        IJth(rJacobian, 12, 2) = -0001845622286471062 * var_x112;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (-var_x113);
        ...
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (-var_x114 * var_x88 - var_x115 * var_x94 - var_x115 * var_x96);
        ...
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (-var_x117 * var_x88 - var_x118 * var_x94 - var_x118 * var_x96);
        IJth(rJacobian, 5, 5) = -02 - var_x219;
        ...
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (-var_x61 * var_x62);
        IJth(rJacobian, 6, 6) = -var_x234 - var_x235;
        IJth(rJacobian, 13, 6) = -var_x289 * var_x62;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (var_x120 * var_x37);
        IJth(rJacobian, 7, 7) = -var_x249 - var_x250;
        IJth(rJacobian, 13, 7) = var_x120 * var_x287;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (var_x121 * var_x36);
        ...
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0 : (-0.10000000000000001 * var_x123);
        IJth(rJacobian, 9, 9) = -var_x257;
        IJth(rJacobian, 14, 9) = -3.0760371441184367e-6 * var_x123;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0 : (-var_x122 * var_x4);
        IJth(rJacobian, 10, 10) = -var_x266;
        IJth(rJacobian, 14, 10) = -var_x122 * var_x293;
        IJth(rJacobian, 11, 11) = -0.21052631578947367 - var_x271;
        IJth(rJacobian, 14, 11) = 0070588235294117632;
        IJth(rJacobian, 15, 11) = -1;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0 : (3.459874159855314 * var_x128 + 1.35e-7 * var_x130 - 0013500000000000001 * var_x126 - 0.10684935482199306 * var_x108 - 0018285756177517324 * var_x104 - 033750000000000002 * var_x124 - 26.712338705498265 * var_x131);
        IJth(rJacobian, 12, 12) = 2.4915900867359339e-11 * var_x130 - 2.4915900867359336e-7 * var_x126 - 6.2289752168398339e-6 * var_x124 - 6.5734516851508199e-6 * var_x108 - 001643362921287705 * var_x131 - 1.1249533042067289e-7 * var_x104;
        ...
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0 : (188.75472776079184 * var_x128 + 4.4490891518731663 * var_x137 - 00052283717663123607 * var_x104 - 18.654461852717677 * var_x133 - 0.14745210965435041 * var_x132 - 24.384917454532911 * var_x136 - var_x135 * var_x77);
        IJth(rJacobian, 13, 13) = 188.75472776079184 * var_x292 + 000273711269773125 * var_x137 - 0015001782369281045 * var_x136 - 9.0713633255081308e-6 * var_x132 - 3.2165331512873877e-8 * var_x104 - 0011476363512500001 * var_x133 - var_x135 * var_x290;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0 : (5.3045278730988868e-7 * var_x153 + 0.16314293740996011 * var_x147 + 2.7046242939316993 * var_x152 - 00025000000000000001 * var_x148 - 1.1499999999999999 * var_x143 - 1.9748616671718705e-9 * var_x156 - 7.8019226357407252 * var_x158 - 2.5874999999999999 * var_x150 - 5.6466415076173488e-10 * var_x159 - 6.3195573349499865e-6 * var_x160 + var_x151 * var_x71);
        ...
        IJth(rJacobian, 14, 14) = 8.319524789019007e-5 * var_x152 + 1.5380185720592182e-8 * var_x148 + 5.0183373527362646e-6 * var_x147 - 0015981617647058825 * var_x298 - 00023999003823076885 * var_x158 - 3.5374427157362017e-5 * var_x143 - 1.9439193096692272e-10 * var_x160 - 7.9592461104064537e-5 * var_x150 - 00071029411764705886 * var_x297 - var_x151 * var_x294;
        IJth(rJacobian, 16, 14) = 0087500000000000008 * var_x297 + 0196875 * var_x298;
        ...
        IJth(rJacobian, 15, 15) = -0041666666666666666 - 044999999999999998 * var_x282;
        IJth(rJacobian, 16, 15) = 0003623188405797101 + 003913043478260869 * var_x282;
        IJth(rJacobian, 14, 16) = 4.7352941176470591e-5;
        IJth(rJacobian, 15, 16) = 0083333333333333332;
        IJth(rJacobian, 16, 16) = -0013079710144927536;
    }
