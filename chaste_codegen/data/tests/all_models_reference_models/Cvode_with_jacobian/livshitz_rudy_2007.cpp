...
#include "MathsCustomFunctions.hpp"
    ...
    void Celllivshitz_rudy_2007FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x144 = 6.5127374999999992e-9 * var_x66;
        const double var_x145 = -0.5 + 187179.41753901311 * var_chaste_interface__cell__V;
        const double var_x146 = ((var_x71) ? (var_x144 - var_x145 * (-var_x144 - 6.5127374999999992e-9 * var_x69)) : (var_x75 * var_chaste_interface__cell__V));
        const double var_x147 = var_x146 * var_chaste_interface__ICaL__f;
        const double var_x148 = 1.8621604999999999e-9 * var_x86;
        const double var_x149 = ((var_x71) ? (var_x148 - var_x145 * (-var_x148 - 1.8621604999999999e-9 * var_x87)) : (var_x89 * var_chaste_interface__cell__V));
        ...
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__INa__m) * ((var_x242) ? (0.15999999943156581 * var_x239 + 0.16000000056843419 * var_x240) : (var_x246 - 0.032000000000000001 * var_x241 * var_x244 / pow(var_x245, 2))) + 0.0072727272727272727 * var_x247 * var_chaste_interface__INa__m;
        ...
        IJth(rJacobian, 4, 0) = var_x302 * (0.16025641025641024 * var_x284 * var_x289 / pow(var_x285, 2) + 41.666666666666664 * var_x286 * var_x287 / pow(var_x288, 2)) + (-var_chaste_interface__ICaL__d + var_x286 * var_x289) * ((var_x297) ? (4.7698560017679535e-16 * (-36688738598216.805 * var_x291 - 36688738598216.805 * var_x294) / pow((-var_x291 + 0.017500000000000002 * var_x295), 2)) : (var_x300 - var_x299 * var_x301 - var_x285 * var_x301 / pow(var_x298, 2)));
        ...
        IJth(rJacobian, 6, 0) = (-var_chaste_interface__IKr__xr + 1 / var_x309) * ((var_x318) ? (var_x316 + 0.00030499999842881236 * var_x310 + 0.00030500000157118761 * var_x311) : ((var_x325) ? (var_x324 + 0.00068999999999999997 * var_x319 + 0.00068999999999999997 * var_x320) : (var_x316 + var_x324))) + 0.23529411764705882 * var_x308 * var_x330 / pow(var_x309, 2);
        ...
        IJth(rJacobian, 12, 0) = (-2.4608297152947492e-7 + 5.8728625778374736e-6 * var_x385 - 6.9092500915734985e-6 * var_x137 - 6.1520742882368733e-5 * var_x48 - 0.00041526501445598893 * var_x118 - var_x129 * var_x388 - var_x387 * var_x79) * NV_Ith_S(mParameters, 3);
        ...
        IJth(rJacobian, 2, 2) = -((var_x242) ? (-var_x248 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__cell__V) * (var_x248 + 3.1999999919207769e-7 * var_x239)) : (var_x241 * var_x246)) - 0.080000000000000002 * var_x247;
