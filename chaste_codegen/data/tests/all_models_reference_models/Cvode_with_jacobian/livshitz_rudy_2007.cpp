...
#include "MathsCustomFunctions.hpp"
    ...
    void Celllivshitz_rudy_2007FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x61 = NV_Ith_S(mParameters, 2) / var_x60;
        ...
        const double var_x66 = var_x65 * NV_Ith_S(mParameters, 1) * var_chaste_interface__INa__J;
        ...
        const double var_x79 = var_x59 * var_x63 * NV_Ith_S(mParameters, 2) * var_chaste_interface__IKr__xr / pow(var_x60, 2);
        const double var_x80 = 1 / (-67.26666666666668 + 555.55555555555566 * var_chaste_interface__Ca__Ca_T + 1111.1111111111113 * var_x30);
        const double var_x81 = var_x80 * NV_Ith_S(mParameters, 0) * var_chaste_interface__ICaL__f;
        ...
        const double var_x110 = 26.712338705498265 * var_x5;
        const double var_x111 = -var_x110 * log10(140.0 * var_x109) + var_chaste_interface__cell__V;
        const double var_x112 = var_x111 * var_x66;
        const double var_x113 = var_x111 * NV_Ith_S(mParameters, 1) * var_chaste_interface__INa__H;
        const double var_x114 = var_x113 * pow(var_chaste_interface__INa__m, 2) * var_chaste_interface__INa__J;
        const double var_x115 = var_x113 * var_x65;
        const double var_x116 = var_x81 * var_chaste_interface__cell__V;
        const double var_x117 = var_x116 * var_x91;
        const double var_x118 = NV_Ith_S(mParameters, 0) * var_chaste_interface__ICaL__d * var_chaste_interface__cell__V;
        ...
        const double var_x122 = -var_x110 * log10(7.0662000000000003 * var_x121) + var_chaste_interface__cell__V;
        const double var_x123 = var_x122 * var_chaste_interface__IKs__xs1;
        const double var_x124 = -13.356169352749133 * var_x5 * log10(1.8 * var_x33) + var_chaste_interface__cell__V;
        const double var_x125 = var_x124 * var_chaste_interface__ICaT__b * var_chaste_interface__ICaT__g;
        const double var_x126 = 1 / (var_x41 * var_x57 * pow((0.01 + var_x53), 2));
        const double var_x127 = var_x121 * var_x39;
        ...
        const double var_x152 = var_x123 * var_x147 * var_x34 * var_chaste_interface__IKs__xs2 / pow(var_x35, 2);
        ...
        const double var_x154 = var_x153 * var_x91;
        const double var_x155 = var_x154 * var_x94;
        const double var_x156 = var_x143 * var_x83 * var_x85;
        const double var_x157 = var_x101 * var_x156;
        const double var_x158 = var_x154 * var_x96;
        ...
        const double var_x201 = var_x164 * var_x192 * var_x200;
        ...
        const double var_x207 = exp(-2500.0 + var_x160);
        const double var_x208 = 1.0 + var_x207;
        const double var_x209 = 1 / var_x208;
        const double var_x210 = -var_chaste_interface__ICaL__d + var_x206 * var_x209;
        ...
        const double var_x217 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x218 = 1.0 + var_x217;
        const double var_x219 = exp(4.0 + 0.125 * var_chaste_interface__cell__V);
        const double var_x220 = 1.0 + var_x219;
        const double var_x221 = exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__cell__V);
        ...
        const double var_x233 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        ...
        const double var_x245 = var_x239 + var_x243 - 8.9997000000000013e-6 * var_x236 * var_x244 / pow(var_x237, 2) - 1.0641199999999999e-5 * var_x240 * var_x244 / pow(var_x241, 2);
        const double var_x246 = var_x239 * var_x244;
        const double var_x247 = var_x243 * var_x244;
        const double var_x248 = var_x233 * (var_x246 + var_x247) / pow(var_x234, 2);
        const double var_x249 = exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__cell__V);
        ...
        const double var_x260 = exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__cell__V);
        const double var_x261 = 1.0 + var_x260;
        const double var_x262 = var_x255 / pow(var_x256, 2);
        ...
        const double var_x269 = 0.21052631578947367 + var_x268;
        const double var_x270 = pow(var_x267, 9.0);
        const double var_x271 = 1.0 + 1.0 * var_x270;
        const double var_x272 = 1 / var_x271;
        const double var_x273 = var_x272 * var_x82;
        const double var_x274 = 4.6323915649710559 * var_x88;
        const double var_x275 = var_x273 * var_x274;
        const double var_x276 = var_x273 * var_chaste_interface__cell__V;
        const double var_x277 = 0.34683534197756777 * var_x276;
        const double var_x278 = var_x269 * var_x272 * var_x274;
        const double var_x279 = (-0.078875171467764058 + 0.0085733882030178329 * var_chaste_interface__Ca__Ca_JSR_T) / var_x265;
        const double var_x280 = (-0.5 - 5.4000000000000004 * var_x279) / pow((-1 + var_x264 + var_x265), 2);
        const double var_x281 = 4.6140557161776547e-8 * var_x71;
        const double var_x282 = 1.4999377389423053e-7 * var_x94;
        ...
        const double var_x286 = 5.6160497718581238e-5 * var_x61;
        const double var_x287 = 4.129448361660385e-5 * var_x77;
        const double var_x288 = 4.288710868383184e-8 * var_x96;
        const double var_x289 = var_x121 * var_x285;
        const double var_x290 = 1.5380185720592184e-6 * var_x3;
        const double var_x291 = 1.5380185720592182e-8 * var_x71;
        const double var_x292 = 0.00023999003823076885 * var_x88;
        const double var_x293 = 1.796847822848032e-5 * var_x101;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0070159999999999997 + var_x39 - var_x67 + 2.6097162183887167e-5 * var_x100 + 0.16655558320535219 * var_x70 + 7.9551252454080567e-6 * var_x51 + 0.040753166481039146 * var_x79 + 9.1272458415149417e-5 * var_x104 - 1.6875 * var_x58 - 0.0055199999999999997 * var_x2 - 6.8454343811362063e-5 * var_x106 - 1.684614757851118e-5 * var_x74 - 1.9572871637915374e-5 * var_x108 - 0.69834626081908679 * var_x19 - 0.00092307692307692295 * var_x64 + var_x102 * var_x103 - var_x102 * var_x107 - var_x4 * var_chaste_interface__ICaT__g - var_x62 * var_chaste_interface__IKr__xr - var_x72 * var_x73 - var_x76 * var_x78 - var_x82 * var_x89 - var_x92 * var_x95 - var_x92 * var_x97);
        ...
        IJth(rJacobian, 3, 0) = var_x192 * var_x199 + (7.6049999999999996e-8 * var_x186 + 0.001275024 * var_x191 + 5.0499999999999998 * var_x168 * var_x190 - 12.5 * var_x168 * var_x185 - 0.016701360000000002 * var_x164 * var_x187 * var_x189 / pow(var_x188, 2) - 0.029999999999999999 * var_x163 * var_x182 * var_x184 / pow(var_x183, 2)) * var_chaste_interface__INa__J + var_x195 * var_x201 * (1.5254334000000001e-6 * var_x197 - 31073.016 * var_x196) - 0.311 * var_x193 * var_x198 * var_x201 / pow(var_x194, 2) - var_x169 * var_x192 * var_x195 * var_x198 * var_x200;
        ...
        IJth(rJacobian, 5, 0) = (0.02 + var_x216) * (0.029999999999999999 * var_x217 / pow(var_x218, 2) - 0.125 * var_x219 / pow(var_x220, 2)) + var_x216 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__cell__V) * (1 / var_x220 - var_chaste_interface__ICaL__f + 0.59999999999999998 / var_x218);
        IJth(rJacobian, 6, 0) = (1 / var_x222 - var_chaste_interface__IKr__xr) * (var_x225 + var_x228 - 0.00016973999999999998 * var_x226 * var_x229 / pow(var_x227, 2) - 8.8449999999999995e-5 * var_x223 * var_x230 / pow(var_x224, 2)) + 0.23529411764705882 * var_x221 * (var_x231 + var_x232) / pow(var_x222, 2);
        IJth(rJacobian, 7, 0) = 0.059880239520958084 * var_x248 + var_x245 * (var_x235 - var_chaste_interface__IKs__xs1);
        IJth(rJacobian, 8, 0) = 0.014970059880239521 * var_x248 + var_x245 * (0.25 * var_x235 - 0.25 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 9, 0) = 0.092592592592592587 * var_x249 * var_x254 / pow(var_x250, 2) + 0.036429872495446269 * var_x251 * (1 / var_x250 - var_chaste_interface__ICaT__b) / (pow(var_x252, 2) * pow((0.60655737704918045 + var_x253), 2));
        IJth(rJacobian, 10, 0) = 0.0069444444444444441 * (1 / var_x261 - var_chaste_interface__ICaT__g) * (0.875 - 0.875 * var_x257 - 5000.0 * var_x262 + 416.66666666666669 * var_x258 * var_x262) / pow((var_x257 + 0.083333333333333329 * var_x259), 2) - 0.17857142857142858 * var_x260 * var_x263 / pow(var_x261, 2);
        IJth(rJacobian, 11, 0) = var_x269 * (-var_x275 + var_x103 * var_x277 - var_x107 * var_x277);
        IJth(rJacobian, 12, 0) = -2.4608297152947492e-7 + 5.615149446400099e-9 * var_x104 + 1.4682156444593685e-9 * var_x51 - 0.00031144876084199171 * var_x58 - 4.2113620848000749e-9 * var_x106 - 3.1091625412080743e-9 * var_x74 - 6.1520742882368733e-5 * var_x67 - var_x281 * var_x73 - var_x282 * var_x92;
        IJth(rJacobian, 13, 0) = var_x285 + 1.6055168046743987e-9 * var_x100 + 2.5071650767223771e-6 * var_x79 + 1.0246623209999443e-5 * var_x70 + 0.00020763250722799446 * var_x58 - 4.296278075471465e-5 * var_x19 - 3.3959450071067536e-7 * var_x2 - 1.2041376035057991e-9 * var_x108 - 5.6788378045263436e-8 * var_x64 - var_x286 * var_chaste_interface__IKr__xr - var_x287 * var_x76 - var_x288 * var_x92;
        IJth(rJacobian, 14, 0) = -9.277328026661204e-8 + 1.0363875137360248e-9 * var_x74 - 4.8940521481978945e-10 * var_x51 + var_x103 * var_x293 + var_x291 * var_x73 - var_x107 * var_x293 - var_x290 * var_chaste_interface__ICaT__g - var_x292 * var_x82;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x112);
        ...
        IJth(rJacobian, 12, 1) = -6.1520742882368733e-5 * var_x112;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x114);
        IJth(rJacobian, 2, 2) = -0.080000000000000002 * var_x180 - var_x179 * var_x181;
        IJth(rJacobian, 12, 2) = -0.0001845622286471062 * var_x114;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x115);
        IJth(rJacobian, 3, 3) = -0.1212 * var_x191 - 0.29999999999999999 * var_x186 - var_x199 * var_x200;
        IJth(rJacobian, 12, 3) = -6.1520742882368733e-5 * var_x115;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x116 * var_x89 - var_x117 * var_x95 - var_x117 * var_x97);
        IJth(rJacobian, 4, 4) = -var_x214;
        IJth(rJacobian, 11, 4) = -var_x116 * var_x278;
        IJth(rJacobian, 12, 4) = -var_x117 * var_x282;
        IJth(rJacobian, 13, 4) = -var_x117 * var_x288;
        IJth(rJacobian, 14, 4) = -var_x116 * var_x292;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x119 * var_x89 - var_x120 * var_x95 - var_x120 * var_x97);
        IJth(rJacobian, 5, 5) = -0.02 - var_x216;
        IJth(rJacobian, 11, 5) = -var_x119 * var_x278;
        IJth(rJacobian, 12, 5) = -var_x120 * var_x282;
        IJth(rJacobian, 13, 5) = -var_x120 * var_x288;
        IJth(rJacobian, 14, 5) = -var_x119 * var_x292;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x62 * var_x63);
        IJth(rJacobian, 6, 6) = -var_x231 - var_x232;
        IJth(rJacobian, 13, 6) = -var_x286 * var_x63;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x122 * var_x38);
        IJth(rJacobian, 7, 7) = -var_x246 - var_x247;
        IJth(rJacobian, 13, 7) = var_x122 * var_x284;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x123 * var_x37);
        IJth(rJacobian, 8, 8) = -3.2750000000000003e-5 * var_x238 * var_x244 - 1.7975e-5 * var_x242 * var_x244;
        IJth(rJacobian, 13, 8) = var_x123 * var_x283;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.10000000000000001 * var_x125);
        IJth(rJacobian, 9, 9) = -var_x254;
        IJth(rJacobian, 14, 9) = -3.0760371441184367e-6 * var_x125;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x124 * var_x4);
        IJth(rJacobian, 10, 10) = -var_x263;
        IJth(rJacobian, 14, 10) = -var_x124 * var_x290;
        IJth(rJacobian, 11, 11) = -0.21052631578947367 - var_x268;
        IJth(rJacobian, 14, 11) = 0.0070588235294117632;
        IJth(rJacobian, 15, 11) = -1;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (1.35e-7 * var_x131 + 0.48963716847178318 * var_x127 - 0.0013500000000000001 * var_x129 - 0.10684935482199306 * var_x109 - 0.0018285756177517324 * var_x105 - 0.033750000000000002 * var_x126 - 26.712338705498265 * var_x132);
        IJth(rJacobian, 12, 12) = 2.4915900867359339e-11 * var_x131 - 2.4915900867359336e-7 * var_x129 - 6.2289752168398339e-6 * var_x126 - 6.5734516851508199e-6 * var_x109 - 0.001643362921287705 * var_x132 - 1.1249533042067289e-7 * var_x105;
        IJth(rJacobian, 13, 12) = 4.1526501445598893e-6 * var_x126 + 0.48963716847178318 * var_x289;
        IJth(rJacobian, 14, 12) = 8.3053002891197791e-8 * var_x129 - 8.3053002891197795e-12 * var_x131;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (4.4490891518731663 * var_x138 + 26.712338705498265 * var_x127 - 0.00052283717663123607 * var_x105 - 18.654461852717677 * var_x134 - 0.14745210965435041 * var_x133 - 24.384917454532911 * var_x137 - var_x136 * var_x78);
        IJth(rJacobian, 13, 13) = 0.000273711269773125 * var_x138 + 26.712338705498265 * var_x289 - 0.0015001782369281045 * var_x137 - 9.0713633255081308e-6 * var_x133 - 3.2165331512873877e-8 * var_x105 - 0.0011476363512500001 * var_x134 - var_x136 * var_x287;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (5.3045278730988868e-7 * var_x152 + 0.090634965227755604 * var_x147 + 1.5025690521842774 * var_x151 - 0.00025000000000000001 * var_x148 - 1.1499999999999999 * var_x144 - 1.9748616671718705e-9 * var_x155 - 7.8019226357407252 * var_x157 - 2.5874999999999999 * var_x149 - 5.6466415076173488e-10 * var_x158 - 6.3195573349499865e-6 * var_x159 + var_x150 * var_x72);
        IJth(rJacobian, 11, 14) = var_x269 * (-3.7522371676265542e-6 * var_x159 * var_x272 - 4.6323915649710559 * var_x156 * var_x276);
        IJth(rJacobian, 12, 14) = -1.214949568543267e-13 * var_x155 - 4.6140557161776547e-8 * var_x148 + var_x150 * var_x281;
        IJth(rJacobian, 13, 14) = 3.2633849539327485e-11 * var_x152 - 3.4738558033903784e-14 * var_x158;
        IJth(rJacobian, 14, 14) = 2.7879651959645917e-6 * var_x147 + 4.6219582161216707e-5 * var_x151 + 1.5380185720592182e-8 * var_x148 - 0.0015981617647058825 * var_x295 - 0.00023999003823076885 * var_x157 - 3.5374427157362017e-5 * var_x144 - 1.9439193096692272e-10 * var_x159 - 7.9592461104064537e-5 * var_x149 - 0.00071029411764705886 * var_x294 - var_x150 * var_x291;
        IJth(rJacobian, 16, 14) = 0.0087500000000000008 * var_x294 + 0.0196875 * var_x295;
        IJth(rJacobian, 11, 15) = 8.8802252544942608e-5 * var_x280 * (-var_chaste_interface__Irel__Rel - var_x275 * var_chaste_interface__cell__V) + 1.4297504830157579 * var_x101 * var_x266 * var_x269 * var_x270 * var_x280 * var_x88 / pow(var_x271, 2);
        IJth(rJacobian, 15, 15) = -0.0041666666666666666 - 0.044999999999999998 * var_x279;
        IJth(rJacobian, 16, 15) = 0.0003623188405797101 + 0.003913043478260869 * var_x279;
