...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_model_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 8, 0) = 0.00017752529735487306 * var_x173 * var_x178 / pow(var_x174, 2) - 6.6907730760079843e-9 * (-var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + 1.0 / var_x174) * (1.1126388888888887 * var_x175 - 32.216666666666669 * var_x176) / (pow(var_x177, 2) * pow((var_x176 + 0.020721676151060523 * var_x175), 2));
        ...
        IJth(rJacobian, 12, 0) = 7.2463768115942027e-5 * var_x198 * var_x203 / pow(var_x199, 2) - 0.00036289737262302222 * (-var_chaste_interface__delayed_rectifier_K_current_z_gate__z + 1.0 / var_x199) * (0.013745074681572435 * var_x200 - 0.023901399527731383 * var_x201) / (pow(var_x202, 2) * pow((var_x201 + 0.18072289156626506 * var_x200), 2));
