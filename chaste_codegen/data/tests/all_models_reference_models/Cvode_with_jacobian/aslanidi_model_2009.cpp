...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_model_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x5 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0);
        ...
        const double var_x13 = 0.58999999999999997 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x14 = 1 / var_x13;
        const double var_x15 = pow((var_x14 * var_chaste_interface__cleft_space_ion_concentrations__K_c), 3.0);
        const double var_x16 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x17 = log(var_x16 * var_chaste_interface__cleft_space_ion_concentrations__K_c);
        const double var_x18 = exp(0.18895643383558949 + 0.052487898287663745 * var_chaste_interface__membrane__V - 1.393 * var_x17);
        const double var_x19 = 1.0 + var_x18;
        const double var_x20 = var_x15 / var_x19;
        const double var_x21 = 0.20320000000000002 * var_x20;
        const double var_x22 = var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T * var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T;
        const double var_x23 = pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3, 6.0);
        const double var_x24 = -0.080003199999999997 - 0.12000479999999999 * var_x23;
        const double var_x25 = 0.58999999999999997 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1, 3.0) + 0.40999999999999998 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2, 3.0);
        const double var_x26 = var_x24 * var_x25;
        const double var_x27 = var_x26 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x28 = 7.2000000000000002 - 0.14399999999999999 * var_chaste_interface__membrane__V;
        const double var_x29 = 0.083333333333333329 * var_x1 / pow(var_x2, 2);
        const double var_x30 = -26.53945091048535 * var_x17 + var_chaste_interface__membrane__V;
        const double var_x31 = var_x15 * var_x18 * var_x30 / pow(var_x19, 2);
        const double var_x32 = 0.36499999999999999 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.63500000000000001 * var_chaste_interface__sodium_current_h1_gate__h1;
        const double var_x33 = 0.037679754693225945 * var_chaste_interface__membrane__V;
        const double var_x34 = exp(var_x33);
        const double var_x35 = -1.0 + var_x34;
        const double var_x36 = 1 / var_x35;
        const double var_x37 = pow(var_chaste_interface__sodium_current_m_gate__m, 3.0);
        const double var_x38 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x39 = exp(var_x33 - 1.0 * log(140.0 * var_x38));
        const double var_x40 = -1.0 + var_x39;
        const double var_x41 = var_x36 * var_x37 * var_x40;
        const double var_x42 = var_x32 * var_x41;
        const double var_x43 = 0.53699594212115942 * var_x37;
        const double var_x44 = var_x32 * var_x36 * var_chaste_interface__membrane__V;
        const double var_x45 = var_x39 * var_x44;
        const double var_x46 = var_x32 * var_x34 * var_x40 * var_chaste_interface__membrane__V / pow(var_x35, 2);
        const double var_x47 = exp(-1.5 - 0.025000000000000001 * var_chaste_interface__membrane__V);
        const double var_x48 = 1.0 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x49 = 1 / var_x48;
        const double var_x50 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5);
        const double var_x51 = 1 / (36.4828726939094 + var_x50);
        const double var_x52 = var_x50 * var_x51 * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x53 = var_x47 * var_x49 * var_x52 / pow((1 + 0.66666666666666663 * var_x47), 2);
        const double var_x54 = var_x40 * var_x44 * pow(var_chaste_interface__sodium_current_m_gate__m, 2.0);
        const double var_x55 = var_x41 * var_chaste_interface__membrane__V;
        const double var_x56 = 4.5599999999999996 - 0.12 * var_chaste_interface__membrane__V;
        const double var_x57 = var_x30 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x58 = var_x24 * var_x57;
        const double var_x59 = 1.77 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1, 2.0);
        const double var_x60 = 1.23 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2, 2.0);
        const double var_x61 = var_x25 * var_x57 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3, 5.0);
        const double var_x62 = 1.8577615637339746 * var_x17 - 0.069999999999999993 * var_chaste_interface__membrane__V;
        const double var_x63 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0);
        const double var_x64 = (2.5 * var_x8 - 2744000.0 * var_x10) / pow((0.0012147716229348883 + 9.1107871720116623e-7 * var_x5 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x65 = var_x63 * var_x64;
        const double var_x66 = var_x6 * var_x63 * var_x7;
        const double var_x67 = 1 / (1.5 + var_x47);
        const double var_x68 = var_x49 * var_x67;
        const double var_x69 = var_x63 * var_x68 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow((1 + 0.027410122234342148 * var_x50), 2);
        const double var_x70 = var_x51 * var_x68;
        ...
        const double var_x72 = var_x37 * var_x45;
        const double var_x73 = var_x38 * var_x72;
        ...
        const double var_x78 = var_x6 * var_x9;
        const double var_x79 = 1.3269725455242676 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x80 = 5.392816425010623 * var_x20;
        const double var_x81 = 1.8577615637339746 * var_x12;
        const double var_x82 = 26.53945091048535 * var_x27;
        const double var_x83 = 0.28305760000000002 * var_x31;
        const double var_x84 = 1 / var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x85 = var_x50 * var_x70;
        const double var_x86 = var_x52 * var_x67 / pow(var_x48, 2);
        const double var_x87 = var_x13 * var_x30 * var_x84 * (3.0 * var_x14 - 3.0 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow(var_x13, 2));
        const double var_x88 = exp(-3.5035114021936398 - 0.078907914463820727 * var_chaste_interface__membrane__V);
        const double var_x89 = 1.0 - var_chaste_interface__sodium_current_m_gate__m;
        const double var_x90 = -1.0 + var_x88;
        const double var_x91 = 0.46000000000000002 / var_x90;
        const double var_x92 = 44.399999999999999 + var_chaste_interface__membrane__V;
        const double var_x93 = exp(-7.333333333333333 - 0.077519379844961239 * var_chaste_interface__membrane__V);
        const double var_x94 = 1 / (1.0 + 323.30000000000001 * var_x93);
        const double var_x95 = exp(-12.010771992818672 - 0.17953321364452424 * var_chaste_interface__membrane__V);
        const double var_x96 = 44.899999999999999 * var_x95;
        const double var_x97 = 1 / (var_x96 + 1491.0 * var_x94);
        const double var_x98 = 8.0610412926391373 * var_x95;
        const double var_x99 = -var_x97 * var_x98 + 2.019719479407183e-5 * var_x95 * (var_x98 - 0.35750508923240704 * var_x93 / pow((0.0030931023816888337 + var_x93), 2)) / pow((var_x94 + 0.030114017437961098 * var_x95), 2);
        const double var_x100 = exp(6.666666666666667 + 0.16666666666666666 * var_chaste_interface__membrane__V);
        const double var_x101 = 1.0 + var_x100;
        const double var_x102 = 1 / var_x101;
        const double var_x103 = 0.001 / (0.00014999999999999999 + 0.029999999999999999 * var_x102);
        const double var_x104 = var_x96 * var_x97;
        const double var_x105 = exp(30.0 + 0.5 * var_chaste_interface__membrane__V);
        const double var_x106 = 1.0 + var_x105;
        const double var_x107 = 1 / var_x106;
        const double var_x108 = 0.001 / (0.00044999999999999999 + 0.12 * var_x107);
        const double var_x109 = exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V);
        const double var_x110 = 1.0 + var_x109;
        const double var_x111 = 0.40000000000000002 * var_chaste_interface__membrane__V;
        const double var_x112 = exp(2.0 + var_x111);
        const double var_x113 = -1.0 + var_x112;
        const double var_x114 = 1 / var_x113;
        const double var_x115 = 4.4800000000000004 * var_x114;
        const double var_x116 = exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V);
        const double var_x117 = -1.0 + var_x116;
        const double var_x118 = 1 / var_x117;
        const double var_x119 = 50.0 * var_x118;
        const double var_x120 = exp(-18.0 - var_x111);
        const double var_x121 = -1.0 + var_x120;
        const double var_x122 = 1 / var_x121;
        const double var_x123 = 16.719999999999999 * var_x122;
        const double var_x124 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x125 = 45.0 + var_chaste_interface__membrane__V;
        const double var_x126 = 5.0 + var_chaste_interface__membrane__V;
        const double var_x127 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x128 = exp(-4.5 - var_x127);
        const double var_x129 = 1.0 + var_x128;
        const double var_x130 = 1 / var_x129;
        const double var_x131 = 18.0 + var_chaste_interface__membrane__V;
        const double var_x132 = exp(4.5 + var_x127);
        const double var_x133 = -1.0 + var_x132;
        const double var_x134 = 1 / var_x133;
        const double var_x135 = 8.4900000000000002 * var_x134;
        const double var_x136 = 67.921999999999997 * var_x130 + var_x131 * var_x135;
        const double var_x137 = 1 / var_x136;
        const double var_x138 = 0.008490000000000001 * var_x134;
        const double var_x139 = var_x137 * var_x138;
        const double var_x140 = var_x131 * var_x134;
        const double var_x141 = 16.980499999999999 * var_x128 / pow(var_x129, 2);
        const double var_x142 = var_x131 * var_x132 / pow(var_x133, 2);
        const double var_x143 = 2.1225000000000001 * var_x142;
        ...
        const double var_x151 = 9.6370000000000005 * var_x149 + 9.6370000000000005 * var_x150;
        const double var_x152 = 1 / var_x151;
        const double var_x153 = 0.11569027611044419 * var_x150;
        const double var_x154 = 0.62659297789336799 * var_x149;
        const double var_x155 = 0.0096370000000000015 * var_x150;
        ...
        const double var_x195 = 0.00031705239460620043 - 6.3410478921240086e-6 * var_chaste_interface__membrane__V;
        const double var_x196 = 0.00020079984991726025 - 5.2842065767700066e-6 * var_chaste_interface__membrane__V;
        const double var_x197 = 3333.3333333333335 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x198 = 1 / (1.3999999999999999 + var_x197 + 0.80000000000000004 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up);
        const double var_x199 = 0.25 + var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x200 = 1 / var_x199;
        const double var_x201 = pow((var_x200 * var_chaste_interface__Ca_handling_by_the_SR__F2), 2.0);
        const double var_x202 = 0.17614021922566689 * var_x201;
        const double var_x203 = (var_x197 - 0.32000000000000006 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up) / pow((0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x204 = 32.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x205 = var_x199 * (-var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_chaste_interface__Ca_handling_by_the_SR__Ca_rel) * (2.0 * var_x200 - 2.0 * var_chaste_interface__Ca_handling_by_the_SR__F2 / pow(var_x199, 2)) / var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x206 = 8.3570761485921043e-6 * var_x20;
        const double var_x207 = -3.290319067574035e-6 - 4.9354786013610522e-6 * var_x23;
        const double var_x208 = var_x207 * var_x25;
        const double var_x209 = var_x208 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x210 = var_x207 * var_x57;
        const double var_x211 = 7.6404797510100245e-5 * var_x17 - 2.8789140275661778e-6 * var_chaste_interface__membrane__V;
        const double var_x212 = 5.4574855364357316e-5 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x213 = 7.6404797510100245e-5 * var_x12;
        const double var_x214 = 0.00022179221220074814 * var_x20;
        const double var_x215 = 26.53945091048535 * var_x209;
        const double var_x216 = 1.1641407074988802e-5 * var_x31;
        const double var_x217 = -200.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x218 = 4.2119663788904208e-5 * var_x20;
        const double var_x219 = 1.6583208100573134e-5 + 2.4874812150859699e-5 * var_x23;
        const double var_x220 = var_x219 * var_x25;
        const double var_x221 = var_x220 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x222 = var_x219 * var_x57;
        const double var_x223 = 1.4509726698933535e-5 * var_chaste_interface__membrane__V - 0.00038508017945090519 * var_x17;
        const double var_x224 = 0.00027505727103636083 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x225 = 0.0011178327494917705 * var_x20;
        const double var_x226 = 0.00038508017945090519 * var_x12;
        const double var_x227 = 26.53945091048535 * var_x221;
        const double var_x228 = 5.8672691657943555e-5 * var_x31;
        const double var_x229 = 23.554751134632365 * var_x201;
        const double var_x230 = exp(-1.6000000000000001 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x231 = 0.019200000000000002 * var_x230 * var_chaste_interface__Ca_handling_by_the_SR__F1;
        const double var_x232 = 0.00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x233 = 1 / var_x232;
        const double var_x234 = pow((var_x233 * var_chaste_interface__intracellular_ion_concentrations__Ca_i), 4.0);
        const double var_x235 = 0.20380000000000001 * var_x234;
        const double var_x236 = var_x232 * var_x76 * (4.0 * var_x233 - 4.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x232, 2));
        const double var_x237 = var_x235 * var_x236 * var_chaste_interface__Ca_handling_by_the_SR__F1;
        const double var_x238 = 0.23999999999999999 * var_x230;
        const double var_x239 = 0.33960000000000001 * var_x234;
        const double var_x240 = var_x236 * var_x239 * var_chaste_interface__Ca_handling_by_the_SR__F2;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.028799999999999999 + var_x27 - var_x21 + 0.010665540932053272 * var_x31 - 0.14399999999999999 * var_x3 - 0.14399999999999999 * var_x4 - 0.022901333333333333 * var_x53 - 0.050000000000000003 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z - 0.00040000000000000002 * var_x11 - 0.069999999999999993 * var_x12 - 14.251577445054343 * var_x42 - 0.12 * var_x22 + var_x28 * var_x29 + var_x43 * var_x46 - var_x43 * var_x45);
        IJth(rJacobian, 1, 0) = -var_x89 * var_x91 + 1.4519056261343013 * var_x88 * var_chaste_interface__sodium_current_m_gate__m - 0.036297640653357534 * var_x88 * var_x89 * var_x92 / pow(var_x90, 2);
        IJth(rJacobian, 2, 0) = var_x103 * var_x99 + 0.0055555555555555558 * var_x100 * (var_x104 - var_chaste_interface__sodium_current_h1_gate__h1) / (pow(var_x101, 2) * pow((0.0050000000000000001 + var_x102), 2));
        IJth(rJacobian, 3, 0) = var_x108 * var_x99 + 0.0041666666666666666 * var_x105 * (var_x104 - var_chaste_interface__sodium_current_h2_gate__h2) / (pow(var_x106, 2) * pow((0.0037499999999999999 + var_x107), 2));
        IJth(rJacobian, 4, 0) = (0.001 / var_x110 - 0.001 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L) * (var_x115 - var_x119 - var_x123 - 10.399334442595674 * var_x116 * var_x124 / pow(var_x117, 2) - 6.6879999999999997 * var_x120 * var_x125 / pow(var_x121, 2) - 1.7920000000000003 * var_x112 * var_x126 / pow(var_x113, 2)) + 0.00015151515151515152 * var_x109 * (var_x115 * var_x126 - var_x119 * var_x124 - var_x123 * var_x125) / pow(var_x110, 2);
        IJth(rJacobian, 5, 0) = var_x136 * (var_x139 - 0.0021225000000000003 * var_x137 * var_x142 + 1.8402920895651027e-6 * var_x140 * (var_x143 - var_x135 - var_x141) / pow((var_x130 + 0.1249963193074409 * var_x140), 2)) + (-0.001 * var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L + var_x131 * var_x139) * (var_x135 + var_x141 - var_x143);
        IJth(rJacobian, 6, 0) = (0.001 / var_x145 - 0.001 * var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T) * (22.472433333333335 * var_x147 - 22.472433333333335 * var_x148) + 0.0001639344262295082 * var_x144 * (674.173 * var_x147 + 674.173 * var_x148) / pow(var_x145, 2);
        IJth(rJacobian, 7, 0) = var_x151 * (-0.00011569027611044419 * var_x150 * var_x152 + 0.00010376673238559718 * var_x150 * (var_x153 - var_x154) / pow((var_x149 + var_x150), 2)) + (var_x154 - var_x153) * (-0.001 * var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T + var_x152 * var_x155);
        ...
        IJth(rJacobian, 9, 0) = -var_x165 * var_x168 + 0.018294914013904134 * var_x170 * (var_x169 - var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1) / pow((0.037321624588364438 + var_x164), 2);
        ...
        IJth(rJacobian, 11, 0) = -2.1922574727480476e-5 * var_x178 * var_x179 / pow(var_x180, 2) + 0.00026666666666666668 * var_x175 * (0.39975990396158467 - var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3 + 0.60024009603841544 / var_x180) / (pow(var_x176, 2) * pow((0.066666666666666666 + var_x177), 2));
        ...
        IJth(rJacobian, 13, 0) = (0.001 / var_x188 - 0.001 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a) * (0.35473572188719404 * var_x189 - 0.099800399201596807 * var_x190) + 0.00013513513513513514 * var_x187 * (9.0 * var_x189 + 1.3 * var_x190) / pow(var_x188, 2);
        IJth(rJacobian, 14, 0) = (0.001 / var_x192 - 0.001 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i) * (6.1795265502981431 * var_x193 - 1.8299935950224173 * var_x194) - 5.3589706489177562e-5 * var_x191 * (100.0 * var_x194 + 656.0 * var_x193) / pow(var_x192, 2);
        IJth(rJacobian, 15, 0) = -1.6450937300378158e-8 - 0.00058612951745018135 * var_x42 - 2.2085216435981733e-5 * var_x72 - 2.8256129907129523e-6 * var_x53 - 4.9352811901134478e-8 * var_x11 + 2.2085216435981733e-5 * var_x37 * var_x46;
        IJth(rJacobian, 16, 0) = -1.7614021922566692e-8 + 3.5228043845133383e-8 * var_x11 - 6.3410478921240086e-6 * var_x3 - 6.3410478921240086e-6 * var_x4 - 5.2842065767700066e-6 * var_x22 + var_x195 * var_x29;
        IJth(rJacobian, 17, 0) = -1.151565611026471e-6 + var_x209 - var_x206 + 1.8837419938086349e-6 * var_x53 + 4.3864536286956306e-7 * var_x31 - 2.0563671625472697e-6 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z - 2.8789140275661778e-6 * var_x12;
        IJth(rJacobian, 22, 0) = 5.8038906795734136e-6 + var_x218 + var_x221 + 1.0364090499238238e-5 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z + 1.4509726698933535e-5 * var_x12 - 9.4940596487955185e-6 * var_x53 - 2.2107726288625975e-6 * var_x31;
        IJth(rJacobian, 26, 0) = -var_x231;
        IJth(rJacobian, 27, 0) = var_x231;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-42.754732335163027 * var_x54);
        IJth(rJacobian, 1, 1) = -18.400000000000002 * var_x88 + var_x91 * var_x92;
        IJth(rJacobian, 15, 1) = -0.0017583885523505443 * var_x54;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-9.0497516776095086 * var_x55);
        IJth(rJacobian, 2, 2) = -var_x103;
        IJth(rJacobian, 15, 2) = -0.0003721922435808652 * var_x55;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-5.2018257674448352 * var_x55);
        IJth(rJacobian, 3, 3) = -var_x108;
        IJth(rJacobian, 15, 3) = -0.0002139372738693162 * var_x55;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x28 * var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L);
        IJth(rJacobian, 4, 4) = 0.050000000000000003 * var_x118 * var_x124 + 0.016719999999999999 * var_x122 * var_x125 - 0.0044800000000000005 * var_x114 * var_x126;
        IJth(rJacobian, 16, 4) = var_x195 * var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x28 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L);
        IJth(rJacobian, 5, 5) = -0.067921999999999996 * var_x130 - var_x131 * var_x138;
        IJth(rJacobian, 16, 5) = var_x195 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x56 * var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T);
        IJth(rJacobian, 6, 6) = -0.67417300000000002 * var_x147 - 0.67417300000000002 * var_x148;
        IJth(rJacobian, 16, 6) = var_x196 * var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x56 * var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T);
        IJth(rJacobian, 7, 7) = -var_x155 - 0.0096370000000000015 * var_x149;
        IJth(rJacobian, 16, 7) = var_x196 * var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x26 * var_x30);
        IJth(rJacobian, 8, 8) = -0.001 * var_x161;
        IJth(rJacobian, 17, 8) = var_x208 * var_x30;
        IJth(rJacobian, 22, 8) = var_x220 * var_x30;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x58 * var_x59);
        IJth(rJacobian, 9, 9) = -0.001 * var_x165;
        IJth(rJacobian, 17, 9) = var_x210 * var_x59;
        IJth(rJacobian, 22, 9) = var_x222 * var_x59;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x58 * var_x60);
        IJth(rJacobian, 10, 10) = -0.001 * var_x174;
        IJth(rJacobian, 17, 10) = var_x210 * var_x60;
        IJth(rJacobian, 22, 10) = var_x222 * var_x60;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-0.72002879999999991 * var_x61);
        ...
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (1.3269725455242676 * var_x17 - 0.050000000000000003 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 12, 12) = -0.001 * var_x186;
        IJth(rJacobian, 17, 12) = 5.4574855364357316e-5 * var_x17 - 2.0563671625472697e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 22, 12) = 1.0364090499238238e-5 * var_chaste_interface__membrane__V - 0.00027505727103636083 * var_x17;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x62 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i);
        IJth(rJacobian, 13, 13) = -0.0090000000000000011 * var_x189 - 0.0013000000000000002 * var_x190;
        IJth(rJacobian, 17, 13) = var_x211 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i;
        IJth(rJacobian, 22, 13) = var_x223 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x62 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a);
        IJth(rJacobian, 14, 14) = -0.10000000000000001 * var_x194 - 0.65600000000000003 * var_x193;
        IJth(rJacobian, 17, 14) = var_x211 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a;
        IJth(rJacobian, 22, 14) = var_x223 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.0023228249436513899 * var_x69 + 1.3281030862990763e-12 * var_x65 - 3.0916799999999998 * var_x71 - 0.01061578036419414 * var_x38 - 0.0030000000000000001 * var_x66 - 14.251577445054343 * var_x73);
        IJth(rJacobian, 15, 15) = 1.638640545085862e-16 * var_x65 + 2.8659485630822583e-7 * var_x69 - 0.00038145775374624855 * var_x71 - 4.3659884291485854e-7 * var_x38 - 0.00058612951745018135 * var_x73 - 3.701460892585086e-7 * var_x66;
        IJth(rJacobian, 16, 15) = 2.6421032883850034e-7 * var_x66 - 1.1696618438750204e-16 * var_x65;
        IJth(rJacobian, 17, 15) = 0.00025430516916416572 * var_x71 - 1.9106323753881723e-7 * var_x69;
        IJth(rJacobian, 22, 15) = 9.6295871719563877e-7 * var_x69 - 0.0012816980525873951 * var_x71;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (0.19017999999999999 * var_x77 + 4.8590864917395538e-7 * var_x64 + 1097.6000000000001 * var_x78 - 0.19017999999999999 * var_x75 - 0.0053078901820970701 * var_x76);
        IJth(rJacobian, 15, 16) = 0.13542411585671302 * var_x78 + 5.9952395409541403e-11 * var_x64;
        IJth(rJacobian, 16, 16) = -47.271999999999998 - var_x202 + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 9.0 * var_chaste_interface__intracellular_Ca_buffering__O_C + 6.2720000000000002 * var_chaste_interface__intracellular_Ca_buffering__O_TC + 8.3745867230843319e-6 * var_x77 + 7.3978892074780085e-7 * var_x203 - 0.096665752311046002 * var_x78 - 2.3373323507508574e-7 * var_x76 - 8.2198768971977891 * var_x198 - 8.3745867230843319e-6 * var_x75 - 4.2794027994574083e-11 * var_x64;
        ...
        IJth(rJacobian, 23, 16) = var_x229;
        IJth(rJacobian, 24, 16) = 121.85879481761599 * var_x198 - 1.0967291533585437e-5 * var_x203;
        IJth(rJacobian, 26, 16) = -var_x237;
        IJth(rJacobian, 27, 16) = var_x237 - var_x240;
        IJth(rJacobian, 28, 16) = var_x240;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x16 * var_x82 + var_x16 * var_x83 - var_x16 * var_x79 - var_x16 * var_x80 - var_x16 * var_x81);
        IJth(rJacobian, 17, 17) = var_x16 * var_x215 + var_x16 * var_x216 - var_x16 * var_x212 - var_x16 * var_x213 - var_x16 * var_x214;
        IJth(rJacobian, 22, 17) = var_x16 * var_x224 + var_x16 * var_x225 + var_x16 * var_x226 + var_x16 * var_x227 - var_x16 * var_x228;
        IJth(rJacobian, 16, 18) = 0.021419999999999998 + 9.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        IJth(rJacobian, 18, 18) = -0.47600000000000003 + var_x217;
        ...
        IJth(rJacobian, 20, 20) = -0.0066 + var_x217;
        IJth(rJacobian, 21, 20) = -5.0;
        IJth(rJacobian, 16, 21) = var_x204;
        IJth(rJacobian, 20, 21) = var_x217;
        IJth(rJacobian, 21, 21) = -5.6660000000000004;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (2.0611199999999998 * var_x86 - 2.0611199999999998 * var_x85 + var_x79 * var_x84 + var_x80 * var_x84 + var_x81 * var_x84 - var_x21 * var_x87 - var_x82 * var_x84 - var_x83 * var_x84);
        IJth(rJacobian, 15, 22) = 0.00025430516916416572 * var_x86 - 0.00025430516916416572 * var_x85;
        IJth(rJacobian, 17, 22) = 0.00016953677944277714 * var_x85 - 0.00016953677944277714 * var_x86 + var_x212 * var_x84 + var_x213 * var_x84 + var_x214 * var_x84 - var_x206 * var_x87 - var_x215 * var_x84 - var_x216 * var_x84;
        IJth(rJacobian, 22, 22) = 0.00085446536839159674 * var_x86 - 0.00085446536839159674 * var_x85 + var_x218 * var_x87 + var_x228 * var_x84 - var_x224 * var_x84 - var_x225 * var_x84 - var_x226 * var_x84 - var_x227 * var_x84;
        IJth(rJacobian, 16, 23) = var_x202;
        IJth(rJacobian, 23, 23) = -14.98 - var_x229 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse;
        ...
        IJth(rJacobian, 16, 24) = 0.00078910818213098765 * var_x198 + 1.7754934097947219e-10 * var_x203;
        IJth(rJacobian, 23, 24) = 0.10000000000000001;
        IJth(rJacobian, 24, 24) = -0.011085915847820609 - 2.6321499680605046e-9 * var_x203 - 0.011698444302491135 * var_x198;
        ...
        IJth(rJacobian, 26, 26) = -var_x235 - var_x238;
        IJth(rJacobian, 27, 26) = var_x235 + var_x238;
        IJth(rJacobian, 16, 27) = var_x202 * var_x205;
        IJth(rJacobian, 23, 27) = -var_x205 * var_x229;
        IJth(rJacobian, 27, 27) = -0.033960000000000004 - var_x239;
        IJth(rJacobian, 28, 27) = 0.033960000000000004 + var_x239;
