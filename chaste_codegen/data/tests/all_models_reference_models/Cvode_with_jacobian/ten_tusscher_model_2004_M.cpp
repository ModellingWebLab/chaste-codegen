...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_MFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x243 = var_x242 * (-0.0082319999999999997 - var_x116);
        ...
        const double var_x249 = NV_Ith_S(mParameters, 12) * NV_Ith_S(mParameters, 3);
        const double var_x250 = 0.00063181349969740233 * var_x249;
        const double var_x251 = var_x250 * var_x7 * var_x81;
        const double var_x252 = 2.7188924024856265e-5 * var_x48;
        const double var_x253 = 0.00027188924024856262 * var_x249;
        const double var_x254 = var_x250 * var_x28;
        ...
        IJth(rJacobian, 11, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x233) * (-var_x234 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + var_x228 / pow(var_x229, 2)) / pow((0.035294117647058823 + var_x231 + 0.058823529411764705 * var_x230), 2) - 0.20000000000000001 * var_x232 * var_x235 / pow(var_x233, 2);
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x236 * var_x239 / pow(var_x237, 2) - 0.10526315789473684 * var_x238 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x237) / pow((0.084210526315789472 + var_x238), 2);
        IJth(rJacobian, 15, 0) = var_x249 * (-0.0018954404990922068 * var_x39 - 0.0018954404990922068 * var_x63 - 4.6119913257618111e-6 * var_x44 - 0.00063181349969740233 * var_x91 - 0.00063181349969740233 * NV_Ith_S(mParameters, 10));
        IJth(rJacobian, 16, 0) = var_x249 * (0.0012636269993948047 * var_x63 + 1.631335441491376e-6 * var_x42 - 0.00027188924024856262 * var_x98 - 2.7188924024856265e-5 * var_x26 - 0.00010565443138752546 * var_x29 - 0.00063181349969740233 * var_x2 - 0.00063181349969740233 * var_x3 - 0.00063181349969740233 * var_x5 - var_x252 * var_x46);
        ...
        IJth(rJacobian, 13, 1) = var_x242 * (var_x110 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 14, 1) = ((var_x248) ? (0) : ((var_x245) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5) / pow((1.8382656249999998e-21 + var_x246), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15) / pow((5.0709427749024951e-56 + var_x247), 2))));
        IJth(rJacobian, 15, 1) = 0.0047386012477305169 * var_x249 * var_x73;
        ...
        IJth(rJacobian, 16, 4) = -0.0012636269993948047 * var_x249 * var_x77;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x80);
        IJth(rJacobian, 5, 5) = -var_x166;
        IJth(rJacobian, 15, 5) = -0.0018954404990922068 * var_x249 * var_x80;
        ...
        IJth(rJacobian, 15, 6) = -var_x251 * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        IJth(rJacobian, 15, 7) = -var_x251 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        IJth(rJacobian, 13, 8) = var_x243 * var_chaste_interface__calcium_dynamics__g;
        ...
        IJth(rJacobian, 12, 12) = -var_x239;
        IJth(rJacobian, 16, 12) = -var_x254 * NV_Ith_S(mParameters, 22) * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 13) = var_x107 * (var_x124 * (var_x123 - var_x122) + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 13, 13) = var_x242 * (var_x108 + var_x124 * (var_x122 - var_x123)) + 9.9963436928702016 * (var_x112 - var_x111 - var_x119) / (pow(var_x240, 3) * pow((0.33333333333333337 + var_x241), 2));
        IJth(rJacobian, 1, 14) = var_x107 * var_x117 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 13, 14) = var_x243 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 14, 14) = ((var_x248) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 15, 15) = var_x249 * (1.1846503119326294e-6 * var_x93 - 0.0018954404990922068 * var_x90 - 0.016878114612481093 * var_x87 - 0.016878114612481093 * var_x92 - 0.0056863214972766203 * var_x94);
        IJth(rJacobian, 16, 15) = var_x249 * (0.0012636269993948047 * var_x90 - 0.00050634343837443281 * var_x88 - 7.8976687462175284e-7 * var_x93);
        ...
        IJth(rJacobian, 16, 16) = var_x249 * (4.357910453967955e-5 * var_x102 - 0.016878114612481093 * var_x88 - 0.016878114612481093 * var_x95 - 0.016878114612481093 * var_x96 - 0.00072631840899465921 * var_x97 - 0.0072631840899465916 * var_x99 - var_x101 * var_x252);
    }
