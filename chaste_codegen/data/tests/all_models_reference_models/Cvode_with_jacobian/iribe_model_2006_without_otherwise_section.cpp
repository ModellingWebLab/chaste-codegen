...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x13 = NV_Ith_S(mParameters, 6) / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x14 = var_x13 * (0.037433890822745473 * var_x10 + 51359.298208806787 * var_x12);
        const double var_x15 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * NV_Ith_S(mParameters, 3);
        ...
        const double var_x19 = NV_Ith_S(mParameters, 2) * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x;
        ...
        const double var_x26 = NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        const double var_x54 = 1 / NV_Ith_S(mParameters, 1);
        ...
        const double var_x58 = (2.0 * var_x10 - 2744000.0 * var_x12) * NV_Ith_S(mParameters, 6) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        ...
        const double var_x61 = -26.713760659695652 * var_x1 * log10(140.47999999999999 * var_x60) + var_chaste_interface__membrane_potential__V;
        const double var_x62 = var_x61 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * NV_Ith_S(mParameters, 3) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x63 = var_x15 * var_x61;
        const double var_x64 = var_x55 * (0.0050000000000000001 * var_chaste_interface__membrane_potential__V - 0.13356880329847826 * var_x3);
        const double var_x65 = var_x26 * var_x44;
        const double var_x66 = var_x37 * var_x65;
        const double var_x67 = var_x44 * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x79 = 4.7302475136018565e-5 * var_x33;
        ...
        const double var_x96 = var_x82 * var_x86;
        const double var_x97 = -var_chaste_interface__intracellular_calcium_concentration__Ca_i + var_chaste_interface__SR_calcium_concentration__Ca_SR;
        const double var_x98 = var_x89 * var_x97 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x99 = var_x92 * var_x98 / pow(var_x90, 2);
        const double var_x100 = 0.20407827359180689 * var_x91;
        const double var_x101 = var_x98 * var_chaste_interface__RyR__F_2;
        const double var_x102 = var_x92 * var_x97 * var_chaste_interface__RyR__F_SRCa_RyR / pow(var_x88, 3);
        ...
        const double var_x111 = 0.080480480480480482 * var_chaste_interface__troponin__Trpn_Ca;
        const double var_x112 = -var_x111;
        const double var_x113 = 0.16096096096096096 * var_chaste_interface__troponin__Trpn_Ca;
        ...
        const double var_x121 = exp(-7.5 + var_x116 + 0.10000000000000001 * NV_Ith_S(mParameters, 5));
        ...
        const double var_x125 = exp(-9.375 + var_x124 + 0.125 * NV_Ith_S(mParameters, 5));
        const double var_x126 = 0.02 * var_x125;
        const double var_x127 = 2.5 * var_x125;
        const double var_x128 = 20.0 * var_x125;
        const double var_x129 = 0.01 * NV_Ith_S(mParameters, 4);
        const double var_x130 = 1.0 - var_x129;
        const double var_x131 = var_x130 / (var_x128 + 2000.0 * var_x122);
        const double var_x132 = var_x121 / pow((0.0031250000000000002 + var_x121), 2);
        ...
        const double var_x137 = 1.0 - var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x;
        ...
        const double var_x145 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane_potential__V);
        const double var_x146 = 0.001 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x170 = 0.0054930810339465725 * var_x47;
        const double var_x171 = 0.00048339113098729838 * var_x49;
        const double var_x172 = 0.0027465405169732862 * var_x50;
        const double var_x173 = 6.8663512924332152e-7 * var_x52;
        const double var_x174 = 3.4331756462166079e-6 * var_x53;
        const double var_x175 = 61250.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x176 = 0.03668521300629056 * var_x59;
        const double var_x177 = var_x164 * var_x65;
        const double var_x178 = var_x166 * var_x66;
        const double var_x179 = var_x168 * var_x66;
        const double var_x180 = var_x164 * var_x67;
        const double var_x181 = var_x166 * var_x68;
        const double var_x182 = var_x168 * var_x68;
        ...
        const double var_x186 = var_x185 * (1.0 - var_chaste_interface__RyR__F_1 - var_chaste_interface__RyR__F_2);
        ...
        const double var_x192 = var_x75 * var_chaste_interface__RyR__F_1;
        const double var_x193 = 9.1713032515726407e-5 * var_x192;
        const double var_x194 = 1.8342606503145281e-5 * var_x192;
        ...
        const double var_x198 = 1.0 * var_x91;
        const double var_x199 = 2.3651237568009284e-7 * var_x42;
        const double var_x200 = 4.7302475136018567e-8 * var_x40;
        const double var_x201 = 8.4390573062405455e-5 * var_x3 - 3.1590674984870109e-6 * var_chaste_interface__membrane_potential__V;
        const double var_x202 = 64354088.928906165 * pow(var_chaste_interface__troponin__Trpn_Ca, 4.1071428571428568);
        const double var_x203 = var_x202 * var_chaste_interface__Force__N_0;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * (0.0014499999999999999 + 1.0 * var_x14 + 1.0 * var_x16 + 1.0880000000000001 * var_x25 + 0.0050000000000000001 * var_x7 + 0.0010695397377927277 * var_x20 + 0.022420738914067644 * var_x47 + 0.0019730250244379527 * var_x49 + 0.2857142857142857 * var_x6 - 0.011210369457033822 * var_x50 - 2.8025923642584555e-6 * var_x52 - 0.021390794755854554 * var_x21 - 1.4012961821292276e-5 * var_x53 + var_x27 * var_x34 + var_x38 * var_x41 + var_x38 * var_x43));
        IJth(rJacobian, 1, 0) = -7.8976687462175278e-8 + 0.00063181349969740222 * var_x14 + 3.5414313797747024e-6 * var_x50 - 7.0828627595494047e-6 * var_x47 - var_x27 * var_x79;
        IJth(rJacobian, 2, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x115) ? (0) : (var_x119 - 20.0 * var_x114 * var_x117 / pow(var_x118, 2))) + 0.44800000000000001 * var_x120 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 3, 0) = (var_x123 + var_x126) * (-var_x127 * var_x131 + 5.0000000000000004e-6 * var_x125 * var_x130 * (var_x127 - 0.625 * var_x132) / pow((var_x122 + 0.01 * var_x125), 2)) + (0.00062500000000000001 * var_x132 - 0.0025000000000000001 * var_x125) * (var_x129 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x128 * var_x131);
        IJth(rJacobian, 4, 0) = 7.7999999999999999e-5 * var_x136 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x + 4.1300000000000001e-5 * var_x137 * var_x141 - 2.8500000000000002e-5 * var_x137 * var_x138 * var_x140 / pow(var_x139, 2) - 5.2000000000000004e-5 * var_x133 * var_x135 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x / pow(var_x134, 2);
        IJth(rJacobian, 5, 0) = -0.058823529411764705 * var_x142 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x143 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x144, 2);
        IJth(rJacobian, 6, 0) = 0.066600000000000006 * var_x145 / pow((1.0 + var_x145), 2);
        IJth(rJacobian, 7, 0) = (0.001 - var_x146) * ((var_x148) ? (0) : (var_x153 - 22.5 * var_x147 * var_x151 / pow(var_x152, 2))) - var_x146 * ((var_x148) ? (0) : (-var_x156 - 3.6000000000000001 * var_x147 * var_x154 / pow(var_x155, 2)));
        IJth(rJacobian, 8, 0) = (0.001 - 0.001 * var_chaste_interface__L_type_Ca_channel_f_gate__f) * ((var_x158) ? (0) : (var_x161 - 0.78125 * var_x157 * var_x159 / pow(var_x160, 2))) - 0.0062500000000000003 * var_x162 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x163, 2);
        IJth(rJacobian, 11, 0) = (var_x165 + var_x167 + var_x169 + var_x170 + var_x171 - var_x172 - var_x173 - var_x174) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 12, 0) = (var_x172 + var_x173 + var_x174 - var_x165 - var_x167 - var_x169 - var_x170 - var_x171) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 16, 0) = -3.7908809981844127e-7 + 8.853578449436756e-9 * var_x53 - 0.00063181349969740222 * var_x16 - 0.0020622392630123207 * var_x25 - 1.2395009829211459e-6 * var_x49 - 0.0018954404990922066 * var_x14 - var_x199 * var_x38;
        IJth(rJacobian, 17, 0) = -3.7908809981844127e-7 + 1.3514992896005304e-5 * var_x21 + 0.0013748261753415473 * var_x25 + 1.7707156898873513e-9 * var_x52 - 0.00018051814277068634 * var_x6 - 6.7574964480026522e-7 * var_x20 - 3.1590674984870109e-6 * var_x7 - 7.0828627595494053e-9 * var_x49 - var_x200 * var_x38;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * (0.14973556329098189 * var_x59 + 0.0033392200824619565 * var_x56 - 2744000.0 * var_x57 - 0.0068999999999999999 * var_x58));
        IJth(rJacobian, 1, 1) = -5.8000000000000007 + var_x80 + var_x81 - var_x95 + 1.152e-10 * var_x85 - 4.7302475136018565e-5 * var_x59 - 1733.6962431696716 * var_x57 - 1.0548821632800683e-6 * var_x56 - 4.3595131479120748e-6 * var_x58 - 10138.888888888887 * var_x87;
        IJth(rJacobian, 11, 1) = (var_x176 - var_x175) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 12, 1) = (var_x175 - var_x176) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 13, 1) = 0.20000000000000001 - var_x80;
        IJth(rJacobian, 14, 1) = 5.6000000000000005 - var_x81;
        IJth(rJacobian, 15, 1) = var_x197 + 49681.373281158201 * var_x87 - 5.6448929115512146e-10 * var_x85;
        IJth(rJacobian, 16, 1) = 5201.0887295090151 * var_x57 + 1.3078539443736224e-5 * var_x58;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0030000000000000001 * var_x54 * var_x62);
        IJth(rJacobian, 2, 2) = -8.0 * var_x120 - 0.001 * ((var_x115) ? (2000.0) : (var_x114 * var_x119));
        IJth(rJacobian, 16, 2) = -0.0018954404990922066 * var_x62;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * var_x63);
        IJth(rJacobian, 3, 3) = -var_x123 - var_x126;
        IJth(rJacobian, 16, 3) = -0.00063181349969740222 * var_x63;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * (0.0071428571428571426 * var_chaste_interface__intracellular_potassium_concentration__K_i - 0.028571428571428571 * var_x18) * NV_Ith_S(mParameters, 2));
        IJth(rJacobian, 4, 4) = -0.00050000000000000001 * var_x141 - 0.0012999999999999999 * var_x136;
        IJth(rJacobian, 17, 4) = (1.8051814277068635e-5 * var_x18 - 4.5129535692671587e-6 * var_chaste_interface__intracellular_potassium_concentration__K_i) * NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 5, 5) = -0.033000000000000002 / var_x144 - 3.3000000000000003e-5 * var_x142;
        IJth(rJacobian, 17, 5) = var_x201 * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 6, 6) = -0.33300000000000002;
        IJth(rJacobian, 17, 6) = var_x201 * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * (var_x34 * var_x65 + var_x41 * var_x66 + var_x43 * var_x66));
        IJth(rJacobian, 1, 7) = -var_x65 * var_x79;
        IJth(rJacobian, 7, 7) = -0.001 * ((var_x148) ? (360.0) : (var_x147 * var_x153)) - 0.001 * ((var_x148) ? (360.0) : (-var_x147 * var_x156));
        IJth(rJacobian, 11, 7) = (var_x177 + var_x178 + var_x179) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 12, 7) = (-var_x177 - var_x178 - var_x179) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 16, 7) = -var_x199 * var_x66;
        IJth(rJacobian, 17, 7) = -var_x200 * var_x66;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * (var_x34 * var_x67 + var_x41 * var_x68 + var_x43 * var_x68));
        IJth(rJacobian, 1, 8) = -var_x67 * var_x79;
        IJth(rJacobian, 8, 8) = -0.001 * ((var_x158) ? (12.5) : (var_x157 * var_x161)) - 0.025000000000000001 / var_x163;
        IJth(rJacobian, 11, 8) = (var_x180 + var_x181 + var_x182) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 12, 8) = (-var_x180 - var_x181 - var_x182) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 16, 8) = -var_x199 * var_x68;
        IJth(rJacobian, 17, 8) = -var_x200 * var_x68;
        IJth(rJacobian, 1, 9) = -5069.4444444444434 * var_x96;
        IJth(rJacobian, 9, 9) = -0.00125;
        IJth(rJacobian, 11, 9) = 0.007693877551020409 * var_x186 * var_chaste_interface__CaMKII_factor__F_CaMK * log(var_x183);
        IJth(rJacobian, 15, 9) = 24840.686640579101 * var_x96;
        IJth(rJacobian, 1, 10) = -0.10203913679590344 * var_x99 + var_x94 * var_x97;
        IJth(rJacobian, 10, 10) = -0.02;
        IJth(rJacobian, 11, 10) = 0.0038469387755102045 * var_x184 * var_x186 / var_chaste_interface__RyR__F_SRCa_RyR;
        IJth(rJacobian, 15, 10) = 0.5 * var_x99 - var_x196 * var_x97;
        IJth(rJacobian, 11, 11) = -0.0018 + var_x188 + var_x189 + var_x190 + var_x191 - var_x187;
        IJth(rJacobian, 12, 11) = var_x187 - var_x189 - var_x190 - var_x191;
        IJth(rJacobian, 1, 12) = var_x100 * var_x101 - var_x100 * var_x102;
        IJth(rJacobian, 11, 12) = var_x188;
        IJth(rJacobian, 12, 12) = -0.45000000000000001 / var_x195;
        IJth(rJacobian, 15, 12) = var_x102 * var_x198 - var_x101 * var_x198;
        IJth(rJacobian, 1, 13) = 0.5 + var_x103;
        IJth(rJacobian, 9, 13) = 24.999999999999996;
        IJth(rJacobian, 13, 13) = -0.5 - var_x103;
        IJth(rJacobian, 1, 14) = 0.11951951951951952 + var_x104 + var_x105 + var_x106 - var_x107 - var_x108;
        IJth(rJacobian, 14, 14) = -0.11951951951951952 + var_x107 + var_x108 - var_x104 - var_x105 - var_x106;
        IJth(rJacobian, 18, 14) = -var_x203;
        IJth(rJacobian, 19, 14) = var_x203;
        IJth(rJacobian, 20, 14) = var_x202 * (1.0 - var_chaste_interface__Force__N_0 - var_chaste_interface__Force__P_0 - var_chaste_interface__Force__P_1 - var_chaste_interface__Force__P_2 - var_chaste_interface__Force__P_3);
        IJth(rJacobian, 1, 15) = var_x95 + 0.00029074955383700184 * var_x109 + 2.4671029149315891e-18 * var_x110;
        IJth(rJacobian, 10, 15) = 0.02;
        IJth(rJacobian, 12, 15) = -0.16200000000000001 * var_chaste_interface__RyR__F_2 / (pow(var_x195, 2) * var_x83);
        IJth(rJacobian, 15, 15) = -var_x197 - 0.001424696263447196 * var_x109 - 1.2089003260906828e-17 * var_x110;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * (6.0 * var_x73 + 1.0880000000000001 * var_x71 + 26.713760659695652 * var_x74 + 0.016028256395817387 * var_x69 + 0.00037433890822745472 * var_x75 - 0.0023105183800887683 * var_x72));
        IJth(rJacobian, 1, 16) = 0.0037908809981844131 * var_x73;
        IJth(rJacobian, 11, 16) = var_x193;
        IJth(rJacobian, 12, 16) = -var_x193;
        IJth(rJacobian, 16, 16) = 4.3794501115171722e-6 * var_x72 - 0.011372642994553239 * var_x73 - 1.0126868767488654e-5 * var_x69 - 2.3651237568009284e-7 * var_x75 - 0.0020622392630123207 * var_x71 - 0.016878114612481093 * var_x74;
        IJth(rJacobian, 17, 16) = 0.0013748261753415473 * var_x71 - 2.9196334076781144e-6 * var_x72;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * (0.13356880329847826 * var_x77 + 0.016028256395817387 * var_x2 + 7.4867781645490941e-5 * var_x75 + 3.2056512791634777 * var_x74 + 0.0071428571428571426 * var_x19 + 7.6325030456273284 * var_x76 - 0.5714285714285714 * var_x78));
        IJth(rJacobian, 11, 17) = var_x194;
        IJth(rJacobian, 12, 17) = -var_x194;
        IJth(rJacobian, 16, 17) = -0.0020253737534977308 * var_x74;
        IJth(rJacobian, 17, 17) = 0.00036103628554137268 * var_x78 - 4.5129535692671587e-6 * var_x19 - 0.0048223184607088833 * var_x76 - 1.0126868767488654e-5 * var_x2 - 8.4390573062405455e-5 * var_x77 - 4.7302475136018567e-8 * var_x75;
        IJth(rJacobian, 1, 18) = var_x111;
        IJth(rJacobian, 14, 18) = var_x112;
        IJth(rJacobian, 18, 18) = -0.040714285714285717 + var_x205;
        IJth(rJacobian, 19, 18) = var_x204;
        IJth(rJacobian, 20, 18) = var_x205;
        IJth(rJacobian, 1, 19) = var_x111;
        IJth(rJacobian, 14, 19) = var_x112;
        IJth(rJacobian, 18, 19) = -0.00071428571428571494;
        IJth(rJacobian, 19, 19) = -0.070000000000000007;
        IJth(rJacobian, 20, 19) = 0.029999999999999999 + var_x205;
        IJth(rJacobian, 18, 20) = -0.040714285714285717;
        IJth(rJacobian, 19, 20) = 0.040714285714285717;
        IJth(rJacobian, 20, 20) = -0.18071428571428572 + var_x205;
        IJth(rJacobian, 21, 20) = 0.10000000000000001;
        IJth(rJacobian, 1, 21) = var_x112;
        IJth(rJacobian, 14, 21) = var_x111;
        IJth(rJacobian, 18, 21) = -0.040714285714285717;
        IJth(rJacobian, 20, 21) = 0.081428571428571433 + var_x205;
        IJth(rJacobian, 21, 21) = -0.15142857142857144;
        IJth(rJacobian, 22, 21) = 0.070000000000000007;
        IJth(rJacobian, 1, 22) = -var_x113;
        IJth(rJacobian, 14, 22) = var_x113;
        IJth(rJacobian, 18, 22) = -0.040714285714285717;
        IJth(rJacobian, 20, 22) = var_x205;
