...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x57 = (2.0 * var_x9 - 2744000 * var_x11) * NV_Ith_S(mParameters, 6) / pow((0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        ...
        const double var_x63 = var_x54 * (0050000000000000001 * var_chaste_interface__membrane_potential__V - 0.13356880329847826 * var_x2);
        ...
        const double var_x110 = 080480480480480482 * var_chaste_interface__troponin__Trpn_Ca;
        ...
        const double var_x127 = 20 * var_x121;
        const double var_x128 = 01 * NV_Ith_S(mParameters, 4);
        const double var_x129 = 1.0 - var_x128;
        const double var_x130 = var_x129 / (var_x127 + 2000 * var_x124);
        const double var_x131 = var_x123 / pow((0031250000000000002 + var_x123), 2);
        ...
        const double var_x145 = 001 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x169 = 0054930810339465725 * var_x46;
        const double var_x170 = 00048339113098729838 * var_x48;
        const double var_x171 = 0027465405169732862 * var_x49;
        const double var_x172 = 3.4331756462166079e-6 * var_x52;
        const double var_x173 = 6.8663512924332162e-7 * var_x51;
        const double var_x174 = 61250 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x175 = 03668521300629056 * var_x58;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0 : (-var_x54 * (0014499999999999999 + var_x13 + var_x15 + 1.0880000000000001 * var_x24 + 0050000000000000001 * var_x6 + 022420738914067644 * var_x46 + 0010695397377927277 * var_x19 + 0019730250244379527 * var_x48 + 0.2857142857142857 * var_x5 - 011210369457033822 * var_x49 - 2.8025923642584555e-6 * var_x51 - 021390794755854554 * var_x20 - 1.4012961821292276e-5 * var_x52 + var_x26 * var_x33 + var_x37 * var_x40 + var_x37 * var_x42));
        IJth(rJacobian, 1, 0) = -7.8976687462175278e-8 + 00063181349969740222 * var_x13 + 3.5414313797747024e-6 * var_x49 - 7.0828627595494047e-6 * var_x46 - var_x26 * var_x78;
        IJth(rJacobian, 2, 0) = (001 - 001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x114) ? (0) : (var_x118 - 20 * var_x113 * var_x116 / pow(var_x117, 2))) + 0.44800000000000001 * var_x119 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 3, 0) = (var_x122 + var_x125) * (-var_x126 * var_x130 + 5.0000000000000004e-6 * var_x121 * var_x129 * (var_x126 - 0.625 * var_x131) / pow((var_x124 + 01 * var_x121), 2)) + (00062500000000000001 * var_x131 - 0025000000000000001 * var_x121) * (var_x128 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x127 * var_x130);
        ...
        IJth(rJacobian, 5, 0) = -058823529411764705 * var_x141 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0041250000000000002 * var_x142 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x143, 2);
        IJth(rJacobian, 6, 0) = 066600000000000006 * var_x144 / pow((1.0 + var_x144), 2);
        IJth(rJacobian, 7, 0) = (001 - var_x145) * ((var_x147) ? (0) : (var_x152 - 22.5 * var_x146 * var_x150 / pow(var_x151, 2))) - var_x145 * ((var_x147) ? (0) : (-var_x155 - 3.6000000000000001 * var_x146 * var_x153 / pow(var_x154, 2)));
        IJth(rJacobian, 8, 0) = (001 - 001 * var_chaste_interface__L_type_Ca_channel_f_gate__f) * ((var_x157) ? (0) : (var_x160 - 0.78125 * var_x156 * var_x158 / pow(var_x159, 2))) - 0062500000000000003 * var_x161 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x162, 2);
        ...
        IJth(rJacobian, 16, 0) = -3.7908809981844127e-7 + 8.853578449436756e-9 * var_x52 - 00063181349969740222 * var_x15 - 1.2395009829211459e-6 * var_x48 - 0020622392630123211 * var_x24 - 0018954404990922066 * var_x13 - var_x198 * var_x37;
        IJth(rJacobian, 17, 0) = -3.7908809981844127e-7 + 1.7707156898873513e-9 * var_x51 + 0013748261753415473 * var_x24 + 1.3514992896005304e-5 * var_x20 - 6.7574964480026522e-7 * var_x19 - 3.1590674984870109e-6 * var_x6 - 7.0828627595494053e-9 * var_x48 - 00018051814277068634 * var_x5 - var_x199 * var_x37;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (-var_x54 * (0.14973556329098189 * var_x58 + 0033392200824619565 * var_x55 - 2744000 * var_x56 - 0068999999999999999 * var_x57));
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (-0030000000000000001 * var_x53 * var_x61);
        IJth(rJacobian, 2, 2) = -001 * ((var_x114) ? (2000) : (var_x113 * var_x118)) - 8.0 * var_x119;
        IJth(rJacobian, 16, 2) = -0018954404990922066 * var_x61;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (-var_x54 * var_x62);
        IJth(rJacobian, 3, 3) = -var_x122 - var_x125;
        IJth(rJacobian, 16, 3) = -00063181349969740222 * var_x62;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (-var_x54 * (0071428571428571426 * var_chaste_interface__intracellular_potassium_concentration__K_i - 028571428571428571 * var_x17) * NV_Ith_S(mParameters, 2));
        IJth(rJacobian, 4, 4) = -00050000000000000001 * var_x140 - 0013000000000000002 * var_x135;
        ...
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (-var_x63 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 5, 5) = -033000000000000002 / var_x143 - 3.3000000000000003e-5 * var_x141;
        IJth(rJacobian, 17, 5) = var_x200 * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (-var_x63 * var_chaste_interface__transient_outward_current_s_gate__s);
        ...
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (-var_x54 * (var_x33 * var_x64 + var_x40 * var_x65 + var_x42 * var_x65));
        IJth(rJacobian, 1, 7) = -var_x64 * var_x78;
        IJth(rJacobian, 7, 7) = -001 * ((var_x147) ? (360) : (var_x146 * var_x152)) - 001 * ((var_x147) ? (360) : (-var_x146 * var_x155));
        ...
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (-var_x54 * (var_x33 * var_x66 + var_x40 * var_x67 + var_x42 * var_x67));
        IJth(rJacobian, 1, 8) = -var_x66 * var_x78;
        IJth(rJacobian, 8, 8) = -001 * ((var_x157) ? (12.5) : (var_x156 * var_x160)) - 025000000000000001 / var_x162;
        ...
        IJth(rJacobian, 9, 9) = -00125;
        IJth(rJacobian, 11, 9) = 007693877551020409 * var_x185 * var_chaste_interface__CaMKII_factor__F_CaMK * log(var_x182);
        ...
        IJth(rJacobian, 11, 10) = 0038469387755102045 * var_x183 * var_x185 / var_chaste_interface__RyR__F_SRCa_RyR;
        IJth(rJacobian, 15, 10) = 0.5 * var_x98 - var_x195 * var_x96;
        IJth(rJacobian, 11, 11) = -0018000000000000002 + var_x187 + var_x188 + var_x189 + var_x190 - var_x186;
        ...
        IJth(rJacobian, 1, 15) = var_x94 + 00029074955383700184 * var_x108 + 2.4671029149315891e-18 * var_x109;
        IJth(rJacobian, 10, 15) = 02;
        IJth(rJacobian, 12, 15) = -0.16200000000000001 * var_chaste_interface__RyR__F_2 / (pow(var_x194, 2) * var_x82);
        IJth(rJacobian, 15, 15) = -var_x196 - 001424696263447196 * var_x108 - 1.2089003260906828e-17 * var_x109;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0 : (-var_x54 * (6.0 * var_x72 + 1.0880000000000001 * var_x70 + 3752.7490974740449 * var_x73 + 016028256395817387 * var_x68 + 00037433890822745472 * var_x74 - 0023105183800887683 * var_x71));
        IJth(rJacobian, 1, 16) = 0037908809981844131 * var_x72;
        IJth(rJacobian, 11, 16) = var_x192;
        IJth(rJacobian, 12, 16) = -var_x192;
        IJth(rJacobian, 16, 16) = 4.3794501115171722e-6 * var_x71 - 011372642994553239 * var_x72 - 2.371037540761344 * var_x73 - 1.0126868767488654e-5 * var_x68 - 0020622392630123211 * var_x70 - 2.3651237568009284e-7 * var_x74;
        IJth(rJacobian, 17, 16) = 0013748261753415473 * var_x70 - 2.9196334076781144e-6 * var_x71;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0 : (-var_x54 * (0.13356880329847826 * var_x76 + 450.32989169688534 * var_x73 + 016028256395817387 * var_x1 + 7.4867781645490941e-5 * var_x74 + 0071428571428571426 * var_x18 + 7.6325030456273284 * var_x75 - 0.5714285714285714 * var_x77));
        IJth(rJacobian, 11, 17) = var_x193;
        IJth(rJacobian, 12, 17) = -var_x193;
        IJth(rJacobian, 16, 17) = -0.28452450489136122 * var_x73;
        IJth(rJacobian, 17, 17) = 00036103628554137268 * var_x77 - 1.0126868767488654e-5 * var_x1 - 4.5129535692671587e-6 * var_x18 - 0048223184607088833 * var_x75 - 8.4390573062405468e-5 * var_x76 - 4.7302475136018567e-8 * var_x74;
        IJth(rJacobian, 1, 18) = var_x110;
        IJth(rJacobian, 14, 18) = var_x111;
        IJth(rJacobian, 18, 18) = -040714285714285717 + var_x204;
        IJth(rJacobian, 19, 18) = var_x203;
        IJth(rJacobian, 20, 18) = var_x204;
        IJth(rJacobian, 1, 19) = var_x110;
        IJth(rJacobian, 14, 19) = var_x111;
        IJth(rJacobian, 18, 19) = -00071428571428571494;
        IJth(rJacobian, 19, 19) = -070000000000000007;
        IJth(rJacobian, 20, 19) = 029999999999999999 + var_x204;
        IJth(rJacobian, 18, 20) = -040714285714285717;
        IJth(rJacobian, 19, 20) = 040714285714285717;
        ...
        IJth(rJacobian, 18, 21) = -040714285714285717;
        IJth(rJacobian, 20, 21) = 081428571428571433 + var_x204;
        IJth(rJacobian, 21, 21) = -0.15142857142857144;
        IJth(rJacobian, 22, 21) = 070000000000000007;
        IJth(rJacobian, 1, 22) = -var_x112;
        IJth(rJacobian, 14, 22) = var_x112;
        IJth(rJacobian, 18, 22) = -040714285714285717;
