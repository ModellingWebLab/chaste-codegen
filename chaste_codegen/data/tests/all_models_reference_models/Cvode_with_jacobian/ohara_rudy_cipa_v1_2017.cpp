...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellohara_rudy_cipa_v1_2017FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x20 = -0.34100000000000003 * NV_Ith_S(mParameters, 9);
        const double var_x21 = var_x20 + var_x1 * var_chaste_interface__intracellular_ions__cai;
        const double var_x22 = 9.9999999999999995e-8 * NV_Ith_S(mParameters, 13);
        ...
        const double var_x30 = (var_x20 + var_x29) * NV_Ith_S(mParameters, 13);
        ...
        const double var_x34 = ((var_x24) ? (var_x2 * var_x21 * var_x22 - var_x22 * var_x23 * var_x5) : (-var_x30 * var_x33 + var_x27 * var_x28 * var_x30 + var_x29 * var_x32 * NV_Ith_S(mParameters, 13)));
        ...
        const double var_x57 = NV_Ith_S(mParameters, 11) / var_x56;
        const double var_x58 = 1.0 + 0.035997120230381568 * var_x57;
        const double var_x59 = pow(var_x58, 3);
        const double var_x60 = pow((0.35820000000000002 + NV_Ith_S(mParameters, 10)), 2);
        const double var_x61 = 1 / (-1.0 + var_x59 + 7.7937924625297832 * var_x60);
        const double var_x62 = pow(NV_Ith_S(mParameters, 10), 2);
        ...
        const double var_x76 = pow(NV_Ith_S(mParameters, 11), 3);
        ...
        const double var_x86 = pow(NV_Ith_S(mParameters, 11), 4);
        ...
        const double var_x167 = NV_Ith_S(mParameters, 14) / var_x166;
        ...
        const double var_x172 = log(var_x171 * NV_Ith_S(mParameters, 10));
        const double var_x173 = 26.712338705498265 * var_x172;
        const double var_x174 = (var_x170 + var_x173) * NV_Ith_S(mParameters, 24);
        ...
        const double var_x177 = NV_Ith_S(mParameters, 19) * var_chaste_interface__INaL__mL;
        ...
        const double var_x184 = pow(var_chaste_interface__INa__m, 3) * NV_Ith_S(mParameters, 17);
        const double var_x185 = var_x183 * var_x184;
        const double var_x186 = 1 / (13.5 + 0.066666666666666666 * (1.0 + 0.20000000000000001 * NV_Ith_S(mParameters, 11)) * NV_Ith_S(mParameters, 11));
        const double var_x187 = exp(0.019556505544476088 * var_chaste_interface__membrane__v);
        const double var_x188 = 1 / var_x187;
        const double var_x189 = 1.0 + 0.011348161597821153 * (1.0 + var_x188) * NV_Ith_S(mParameters, 11);
        ...
        const double var_x223 = var_x186 * NV_Ith_S(mParameters, 9);
        ...
        const double var_x246 = var_x188 * NV_Ith_S(mParameters, 11);
        ...
        const double var_x280 = var_x192 * pow(NV_Ith_S(mParameters, 11), 2);
        ...
        const double var_x329 = NV_Ith_S(mParameters, 22) / var_x328;
        ...
        const double var_x419 = NV_Ith_S(mParameters, 22) / var_x418;
        const double var_x420 = 0.80000000000000004 * var_x419;
        const double var_x421 = sqrt(NV_Ith_S(mParameters, 10));
        const double var_x422 = var_x421 * NV_Ith_S(mParameters, 20);
        ...
        const double var_x429 = NV_Ith_S(mParameters, 21) * var_chaste_interface__IKs__xs2;
        const double var_x430 = var_x428 * var_x429;
        const double var_x431 = var_x430 * var_chaste_interface__IKs__xs1;
        const double var_x432 = exp(11.145054250500367 + 0.10534077741493732 * var_chaste_interface__membrane__v - 0.27388602127883704 * NV_Ith_S(mParameters, 10));
        const double var_x433 = 1.0 + var_x432;
        const double var_x434 = var_x421 * NV_Ith_S(mParameters, 18) / var_x433;
        const double var_x435 = var_x434;
        const double var_x436 = -var_x173 + var_chaste_interface__membrane__v;
        const double var_x437 = var_x165 * var_x436 * NV_Ith_S(mParameters, 14) / pow(var_x166, 2);
        ...
        const double var_x457 = (var_x445 * (var_x446 + var_x447) + var_x456 * var_chaste_interface__ICaL__nca) * NV_Ith_S(mParameters, 12);
        const double var_x458 = var_x457 * var_chaste_interface__ICaL__d;
        const double var_x459 = var_x444 * var_x458;
        const double var_x460 = -0.75 * NV_Ith_S(mParameters, 10);
        ...
        const double var_x470 = -0.75 * NV_Ith_S(mParameters, 11);
        ...
        const double var_x483 = var_x482 * NV_Ith_S(mParameters, 12);
        ...
        const double var_x489 = var_x421 * var_x432 * var_x436 * NV_Ith_S(mParameters, 18) * var_chaste_interface__IK1__xk1 / pow(var_x433, 2);
        const double var_x490 = 2.671233870549826e-13 * var_x438;
        ...
        const double var_x493 = ((var_x24) ? (var_x490 - var_x491 * (-var_x490 + 2.671233870549826e-13 * var_x439)) : (var_x442 * var_x492));
        const double var_x494 = var_x493 * NV_Ith_S(mParameters, 12);
        ...
        const double var_x501 = 2.671233870549826e-13 * var_x2;
        const double var_x502 = var_x462 * var_x501;
        const double var_x503 = 2.671233870549826e-13 * var_x5;
        ...
        const double var_x506 = ((var_x8) ? (var_x502 - var_x504 * (-var_x502 + var_x463 * var_x503)) : (var_x464 * var_x505));
        const double var_x507 = var_x468 * var_x506;
        const double var_x508 = var_x500 * NV_Ith_S(mParameters, 12);
        const double var_x509 = var_x472 * var_x501;
        const double var_x510 = ((var_x8) ? (var_x509 - var_x504 * (-var_x509 + var_x473 * var_x503)) : (var_x474 * var_x505));
        ...
        const double var_x517 = var_x48 * NV_Ith_S(mParameters, 12);
        ...
        const double var_x521 = var_x4 * var_x503;
        const double var_x522 = var_x1 * var_x501;
        const double var_x523 = var_x522 * NV_Ith_S(mParameters, 13);
        const double var_x524 = var_x27 * var_x492;
        const double var_x525 = var_x25 * var_x524;
        const double var_x526 = ((var_x24) ? (var_x523 + var_x520 * (-var_x523 + var_x521 * NV_Ith_S(mParameters, 13))) : (var_x525 * NV_Ith_S(mParameters, 13)));
        const double var_x527 = 0.00050000000000000001 + var_chaste_interface__intracellular_ions__cai;
        const double var_x528 = NV_Ith_S(mParameters, 16) / var_x527;
        const double var_x529 = pow(var_x527, (-2));
        const double var_x530 = var_x529 * NV_Ith_S(mParameters, 16) * var_chaste_interface__intracellular_ions__cai;
        ...
        const double var_x548 = var_x547 * NV_Ith_S(mParameters, 22) / (pow(var_x418, 2) * pow(var_chaste_interface__intracellular_ions__cai, 3));
        ...
        const double var_x550 = -26.712338705498265 * log(var_x549 * (0.018329999999999999 * NV_Ith_S(mParameters, 11) + NV_Ith_S(mParameters, 10))) + var_chaste_interface__membrane__v;
        const double var_x551 = var_x550 * var_chaste_interface__IKs__xs1;
        const double var_x552 = var_x424 * var_x425 * var_x429 * var_x551 / pow(var_x426, 2);
        const double var_x553 = 1 / (pow(var_x46, 2) * pow(var_x47, 2));
        const double var_x554 = var_x553 * (-1 + var_x45);
        const double var_x555 = 0.14999999999999999 * var_x554;
        const double var_x556 = var_x40 * var_chaste_interface__Ito__a;
        const double var_x557 = var_x53 * var_chaste_interface__Ito__ap;
        const double var_x558 = var_x555 * var_x556 - var_x555 * var_x557;
        const double var_x559 = var_x555 * var_chaste_interface__INaL__hL - var_x555 * var_chaste_interface__INaL__hLp;
        const double var_x560 = 1 / var_chaste_interface__intracellular_ions__nai;
        const double var_x561 = log(var_x560 * NV_Ith_S(mParameters, 11));
        const double var_x562 = 26.712338705498265 * var_x561;
        const double var_x563 = var_x170 + var_x562;
        const double var_x564 = var_x177 * var_x563;
        const double var_x565 = var_x179 * var_chaste_interface__INa__j;
        const double var_x566 = -var_x562 + var_chaste_interface__membrane__v;
        const double var_x567 = var_x184 * var_x566;
        const double var_x568 = var_x567 * (var_x555 * var_x565 - var_x182 * var_x555);
        const double var_x569 = var_x554 * var_chaste_interface__ICaL__d;
        const double var_x570 = var_x481 * var_x569;
        const double var_x571 = var_x494 * var_x570;
        const double var_x572 = 0.16500000000000001 * var_x571;
        const double var_x573 = var_x570 * NV_Ith_S(mParameters, 12);
        const double var_x574 = var_x510 * var_x573;
        const double var_x575 = var_x506 * var_x573;
        const double var_x576 = var_x457 * var_x493;
        const double var_x577 = var_x576 * var_chaste_interface__ICaL__d;
        const double var_x578 = var_x555 * var_x577;
        const double var_x579 = var_x457 * var_x510;
        const double var_x580 = var_x569 * var_x579;
        const double var_x581 = var_x457 * var_x506;
        const double var_x582 = var_x569 * var_x581;
        const double var_x583 = 0.5 - 187179.41753901311 * var_chaste_interface__membrane__v;
        const double var_x584 = var_x522 * NV_Ith_S(mParameters, 15);
        const double var_x585 = ((var_x8) ? (var_x584 + var_x583 * (-var_x584 + var_x521 * NV_Ith_S(mParameters, 15))) : (var_x505 * var_x9 * NV_Ith_S(mParameters, 15)));
        ...
        const double var_x617 = var_x143 * var_x150;
        ...
        const double var_x620 = var_x143 * var_x159;
        const double var_x621 = var_x143 * var_x161;
        ...
        const double var_x668 = 26.712338705498265 * var_x560;
        const double var_x669 = var_x175 + var_x176;
        const double var_x670 = var_x177 * var_x669;
        const double var_x671 = var_x431 * var_x549;
        ...
        const double var_x712 = 2.0034254029123695e-13 * var_x1 * var_x2;
        const double var_x713 = ((var_x8) ? (var_x712 + var_x583 * (-var_x712 + 2.0034254029123695e-13 * var_x4 * var_x5)) : (0.028076912630851963 * var_x465));
        ...
        const double var_x740 = 26.712338705498265 * var_x171;
        const double var_x741 = (var_x52 + var_x55) * NV_Ith_S(mParameters, 24);
        ...
        const double var_x746 = 1.1250000000000001e-5 * var_x745;
        const double var_x747 = var_x557 * var_x746 - var_x556 * var_x746;
        ...
        const double var_x757 = var_x746 * var_chaste_interface__INaL__hLp - var_x746 * var_chaste_interface__INaL__hL;
        const double var_x758 = var_x567 * (var_x182 * var_x746 - var_x565 * var_x746);
        ...
        const double var_x760 = var_x759 * NV_Ith_S(mParameters, 22) / (pow(var_x328, 2) * pow(var_chaste_interface__intracellular_ions__cass, 3));
        const double var_x761 = ((var_x24) ? (var_x522 + var_x520 * (var_x521 - var_x522)) : (var_x525));
        const double var_x762 = var_x485 * var_x761;
        const double var_x763 = var_x577 * var_x746;
        const double var_x764 = var_x745 * var_chaste_interface__ICaL__d;
        const double var_x765 = var_x581 * var_x764;
        const double var_x766 = var_x579 * var_x764;
        const double var_x767 = var_x481 * var_x764;
        const double var_x768 = var_x767 * NV_Ith_S(mParameters, 12);
        const double var_x769 = var_x506 * var_x768;
        const double var_x770 = var_x510 * var_x768;
        const double var_x771 = var_x494 * var_x767;
        const double var_x772 = 1.2375000000000001e-5 * var_x771;
        const double var_x773 = var_x183 * var_x566 * pow(var_chaste_interface__INa__m, 2) * NV_Ith_S(mParameters, 17);
        const double var_x774 = 0.98999999999999999 * var_x48;
        const double var_x775 = var_x567 * (var_x774 * var_chaste_interface__INa__jp + (0.98999999999999999 - var_x774) * var_chaste_interface__INa__j);
        const double var_x776 = 0.010000000000000009 * var_x48;
        const double var_x777 = var_x567 * (0.010000000000000009 - var_x776) * var_chaste_interface__INa__j;
        const double var_x778 = var_x180 * var_x567;
        const double var_x779 = var_x567 * var_chaste_interface__INa__jp;
        const double var_x780 = var_x181 * var_x567;
        const double var_x781 = var_x669 * NV_Ith_S(mParameters, 19);
        const double var_x782 = var_x40 * var_x50;
        const double var_x783 = var_x38 * var_x51;
        const double var_x784 = var_x39 * var_x51;
        const double var_x785 = var_x49 * var_x53;
        const double var_x786 = var_x174 * var_x54;
        const double var_x787 = var_x482 * var_x494;
        const double var_x788 = 1.1000000000000001 * var_x787;
        const double var_x789 = var_x483 * var_x510;
        const double var_x790 = var_x483 * var_x506;
        const double var_x791 = (0.59999999999999998 - 0.59999999999999998 * var_chaste_interface__ICaL__nca) * var_chaste_interface__ICaL__d;
        const double var_x792 = var_x791 * NV_Ith_S(mParameters, 12);
        const double var_x793 = (0.40000000000000002 - 0.40000000000000002 * var_chaste_interface__ICaL__nca) * var_chaste_interface__ICaL__d;
        const double var_x794 = var_x793 * NV_Ith_S(mParameters, 12);
        const double var_x795 = var_x513 * var_x793;
        const double var_x796 = var_x48 * var_x794;
        const double var_x797 = var_x452 * var_x499;
        const double var_x798 = var_x797 * NV_Ith_S(mParameters, 12);
        const double var_x799 = var_x453 * var_x499;
        const double var_x800 = var_x799 * NV_Ith_S(mParameters, 12);
        const double var_x801 = var_x513 * var_x799;
        const double var_x802 = var_x517 * var_x799;
        const double var_x803 = var_x455 * var_x498;
        const double var_x804 = var_x803 * NV_Ith_S(mParameters, 12);
        const double var_x805 = var_x479 * var_x498;
        const double var_x806 = var_x513 * var_x805;
        const double var_x807 = var_x517 * var_x805;
        const double var_x808 = var_x48 * var_x792;
        const double var_x809 = var_x517 * var_x797;
        const double var_x810 = -var_x446;
        const double var_x811 = (var_x456 + var_x810 - var_x447) * var_chaste_interface__ICaL__d;
        const double var_x812 = var_x811 * NV_Ith_S(mParameters, 12);
        const double var_x813 = (var_x480 + var_x810 - var_x478) * var_chaste_interface__ICaL__d;
        const double var_x814 = var_x513 * var_x813;
        const double var_x815 = var_x517 * var_x813;
        const double var_x816 = var_x551 * NV_Ith_S(mParameters, 21);
        ...
        const double var_x831 = var_x21 * var_x501 * NV_Ith_S(mParameters, 13);
        const double var_x832 = 0.0043750000000000004 * var_x827;
        const double var_x833 = 0.01203125 * var_x824;
        const double var_x834 = var_x554 * var_chaste_interface__intracellular_ions__cai;
        const double var_x835 = var_x823 * var_x834;
        const double var_x836 = var_x826 * var_x834;
        const double var_x837 = var_x745 * var_chaste_interface__intracellular_ions__cai;
        const double var_x838 = var_x826 * var_x837;
        const double var_x839 = var_x823 * var_x837;
        ...
        const double var_x848 = 6.1520742882368733e-5 * var_x48;
        const double var_x849 = 0.00014764978291768497 * var_x419;
        const double var_x850 = -6.1520742882368733e-5 * var_chaste_interface__membrane__v;
        const double var_x851 = var_x850 + 0.001643362921287705 * var_x561;
        const double var_x852 = var_x177 * var_x851;
        ...
        const double var_x861 = var_x510 * var_x858;
        const double var_x862 = 2.8760947297507386e-6 * var_x510;
        ...
        const double var_x870 = (var_x850 + 0.001643362921287705 * var_x172) * NV_Ith_S(mParameters, 24);
        const double var_x871 = 2.6474312514413617e-5 * var_x422;
        ...
        const double var_x875 = 6.1520742882368733e-5 * var_x434;
        ...
        const double var_x881 = var_x54 * var_x870;
        ...
        const double var_x885 = var_x506 * var_x882;
        const double var_x886 = 8.2233300513033119e-7 * var_x506;
        ...
        const double var_x891 = var_x494 * var_x888;
        const double var_x892 = 0.0011504378919002954 * var_x512;
        ...
        const double var_x898 = 0.035999999999999997 * var_x554;
        const double var_x899 = 2.7e-6 * var_x745;
        const double var_x900 = (var_x49 * var_chaste_interface__ryr__Jrelp + var_x50 * var_chaste_interface__ryr__Jrelnp) * NV_Ith_S(mParameters, 7);
        ...
        const double var_x904 = var_chaste_interface__ICaL__nca;
        const double var_x905 = var_x892 * var_x896;
        const double var_x906 = 0.23999999999999996 * var_x48;
        ...
        const double var_x910 = var_x909 * NV_Ith_S(mParameters, 7);
        const double var_x911 = var_x910;
        const double var_x912 = 0.01 * var_x909;
        const double var_x913 = exp(-4.0087123898287915 - 0.10130685847431871 * var_chaste_interface__membrane__v);
        ...
        const double var_x917 = 0.19456427955133734 * var_x915 - 1.4361041141897564 * var_x916;
        const double var_x918 = 8.5519999999999996 * var_x916;
        const double var_x919 = 6.7649999999999997 * var_x915;
        const double var_x920 = var_x918 + var_x919;
        const double var_x921 = -var_x918 - var_x919;
        const double var_x922 = 0.16431153466973381 * var_chaste_interface__membrane__v;
        const double var_x923 = exp(13.621426224120933 + var_x922);
        const double var_x924 = 1.0 + var_x923;
        const double var_x925 = 1 / var_x924;
        ...
        const double var_x930 = 0.16431153466973381 * var_x923 / pow(var_x924, 2);
        ...
        const double var_x939 = (0.002579398623354667 * var_x936 - 0.0079375812743823146 * var_x935) / (pow((1 + 0.4906771344455349 * var_x937), 2) * pow((var_x935 + 0.069986893840104841 * var_x936), 2));
        const double var_x940 = exp(14.640157739073281 + var_x922);
        const double var_x941 = 1.0 + var_x940;
        ...
        const double var_x945 = exp(-8.1401975683890573 - 0.18996960486322187 * var_chaste_interface__membrane__v);
        const double var_x946 = 1.0 + var_x945;
        const double var_x947 = 0.13354700854700854 * var_chaste_interface__membrane__v;
        const double var_x948 = exp(11.700053418803417 + var_x947);
        const double var_x949 = exp(12.528044871794872 + var_x947);
        const double var_x950 = -0.067476383265856948 * var_chaste_interface__membrane__v;
        const double var_x951 = exp(0.96761133603238858 + var_x950);
        ...
        const double var_x958 = 0.026774900134466751 * var_x954 / pow(var_x955, 2) - 0.113288618703949 * var_x956 / pow(var_x957, 2);
        const double var_x959 = 3.3285782215882072 / var_x957;
        const double var_x960 = 0.78668405081082138 / var_x955;
        const double var_x961 = 0.067476383265856948 * var_x959 + 0.067476383265856948 * var_x960;
        ...
        const double var_x967 = exp(7.6939240063036234 + 0.17510068289266328 * var_chaste_interface__membrane__v);
        const double var_x968 = 1.0 + var_x967;
        const double var_x969 = 0.17510068289266328 * var_x967 / pow(var_x968, 2);
        const double var_x970 = 1 / var_x968;
        const double var_x971 = 0.31062867580131875 * (0.0039329999999999999 * var_x963 - 0.004824593128390597 * var_x964) / (pow((1 + 0.21920210434020165 * var_x965), 2) * pow((var_x963 + 0.20350877192982458 * var_x964), 2));
        ...
        const double var_x976 = 893.9509839578584 * (2.3979678238780695e-5 * var_x973 - 2.2032429756157938e-9 * var_x972) / (pow((1 + 0.042337002540220152 * var_x974), 2) * pow((var_x973 + 1.2570621468926554e-5 * var_x972), 2));
        const double var_x977 = exp(1.6423751686909582 + var_x950);
        const double var_x978 = 1.0 + var_x977;
        ...
        const double var_x991 = var_x970 - var_chaste_interface__Ito__iFp;
        const double var_x992 = var_x966 * var_x991;
        const double var_x993 = 5.4545970252809655e-5 * var_x983 * (4.6425255338904359 * var_x984 - 0.062932662051604776 * var_x985) / (pow(var_x986, 2) * pow((1 + 7.3855243722304278e-5 * var_x987), 2));
        const double var_x994 = 0.025000000000000001 * var_x980 * var_x988 / (pow(var_x981, 2) * pow(var_x982, 2));
        const double var_x995 = var_x975 * var_x989;
        const double var_x996 = var_x970 - var_chaste_interface__Ito__iSp;
        const double var_x997 = var_x975 * var_x996;
        const double var_x998 = exp(-0.93144208037825049 - 0.23640661938534277 * var_chaste_interface__membrane__v);
        const double var_x999 = 1.0 + var_x998;
        ...
        const double var_x1009 = exp(5.2976190476190466 + 0.27056277056277056 * var_chaste_interface__membrane__v);
        const double var_x1010 = 1.0 + var_x1009;
        const double var_x1011 = var_x1009 / pow(var_x1010, 2);
        const double var_x1012 = 0.27056277056277056 * var_x1011;
        const double var_x1013 = 1 / var_x1010;
        const double var_x1014 = (0.00044999999999999999 * var_x1006 - 0.00044999999999999999 * var_x1005) / (pow((1 + 0.14285714285714285 * var_x1007), 2) * pow((var_x1005 + var_x1006), 2));
        ...
        const double var_x1024 = (0.0057142857142857143 * var_x1020 - 0.0057142857142857143 * var_x1021) / (pow((1 + 0.14285714285714285 * var_x1022), 2) * pow((var_x1020 + var_x1021), 2));
        ...
        const double var_x1031 = 1.0 + 0.002 * var_x42;
        const double var_x1032 = pow((1 / var_chaste_interface__ICaL__jca + 0.001 * pow(var_x1031, 4)), (-2));
        ...
        const double var_x1035 = 0.0038608739999999998 * var_x1034 * var_chaste_interface__IKr__C1;
        const double var_x1036 = exp(2.9189610691546015) * exp(0.17249999999999999 * var_chaste_interface__membrane__v);
        const double var_x1037 = 0.0021407249999999996 * var_x1036 * var_chaste_interface__IKr__IC1;
        const double var_x1038 = exp(2.4217402245028676) * exp(-0.16880000000000001 * var_chaste_interface__membrane__v);
        const double var_x1039 = 9.2080400000000004e-7 * var_x1038 * var_chaste_interface__IKr__IC2;
        const double var_x1040 = exp(2.7162091828629111) * exp(1.5349999999999998e-8 * var_chaste_interface__membrane__v);
        const double var_x1041 = 1.207738e-11 * var_x1040 * var_chaste_interface__IKr__IC1;
        ...
        const double var_x1047 = 1.1492952999999999e-8 * var_x1046 * var_chaste_interface__IKr__C2;
        const double var_x1048 = var_x1033 * exp(-0.00065749999999999999 * var_chaste_interface__membrane__v);
        const double var_x1049 = 0.00021210949999999999 * var_x1048 * var_chaste_interface__IKr__IC2;
        const double var_x1050 = exp(2.7230751049583355) * exp(0.0085159999999999993 * var_chaste_interface__membrane__v);
        const double var_x1051 = 1.0338424e-5 * var_x1050 * var_chaste_interface__IKr__IC2;
        const double var_x1052 = exp(2.2555765142844972) * exp(-0.04641 * var_chaste_interface__membrane__v);
        const double var_x1053 = 8.6044139999999988e-7 * var_x1052 * var_chaste_interface__IKr__IO;
        ...
        const double var_x1059 = 1.2225840000000001e-6 * var_x1058 * var_chaste_interface__IKr__C1;
        const double var_x1060 = exp(2.4517433881989175) * exp(-0.0042259999999999997 * var_chaste_interface__membrane__v);
        const double var_x1061 = 2.1070835999999998e-8 * var_x1060 * var_chaste_interface__IKr__C2;
        ...
        const double var_x1065 = 4.0738319999999997e-5 * var_x1064 * var_chaste_interface__IKr__O;
        const double var_x1066 = exp(2.4477197176814647) * exp(7.7710000000000006e-9 * var_chaste_interface__membrane__v);
        const double var_x1067 = 4.2810439e-11 * var_x1066 * var_chaste_interface__IKr__C2;
        ...
        const double var_x1071 = 0.00069553200000000001 * var_x1070 * var_chaste_interface__IKr__O;
        ...
        const double var_x1075 = 0.0001988627 * var_x1074 * var_chaste_interface__IKr__IO;
        const double var_x1076 = 0.14899999999999999 * var_x1070;
        const double var_x1077 = pow(NV_Ith_S(mParameters, 0), NV_Ith_S(mParameters, 6));
        const double var_x1078 = var_x1077 * NV_Ith_S(mParameters, 1) * NV_Ith_S(mParameters, 3) / (var_x1077 + NV_Ith_S(mParameters, 5));
        const double var_x1079 = -var_x1078;
        const double var_x1080 = 0.0089779999999999999 * var_x1074;
        const double var_x1081 = var_x1070 * NV_Ith_S(mParameters, 3) / (var_x1072 * var_x1073);
        const double var_x1082 = 0.44507484963243482 * var_x1081 * var_chaste_interface__IKr__IObound;
        const double var_x1083 = 16.59612385832034 * var_x1081;
        const double var_x1084 = exp(0.14729709824716453 * NV_Ith_S(mParameters, 4) - 0.14729709824716453 * var_chaste_interface__membrane__v);
        const double var_x1085 = 1.0 + var_x1084;
        const double var_x1086 = var_x1084 * var_chaste_interface__IKr__Cbound * NV_Ith_S(mParameters, 2) / pow(var_x1085, 2);
        const double var_x1087 = 0.14729709824716453 * var_x1086;
        const double var_x1088 = -NV_Ith_S(mParameters, 2);
        const double var_x1089 = NV_Ith_S(mParameters, 2) / var_x1085;
        ...
        const double var_x1094 = exp(-1.2987012987012987 - 0.11195700850873264 * var_chaste_interface__membrane__v);
        const double var_x1095 = 1.0 + var_x1094;
        const double var_x1096 = 0.11195700850873264 * var_x1094 / pow(var_x1095, 2);
        const double var_x1097 = 1 / var_x1095;
        ...
        const double var_x1102 = 1 / (3.8115000000000001 + 1.5691999999999999 * NV_Ith_S(mParameters, 10));
        const double var_x1103 = exp(var_x1102 * (-144.59 + var_x170 - 2.5537999999999998 * NV_Ith_S(mParameters, 10)));
        ...
        const double var_x1111 = var_x458 * var_x50;
        const double var_x1112 = var_x494 * var_x50;
        const double var_x1113 = var_x1110 * (var_x486 + var_x515 + var_x1111 * var_x443 + var_x1112 * var_x500);
        ...
        const double var_x1119 = var_x578 - var_x572;
        const double var_x1120 = var_x1110 * var_x1118;
        const double var_x1121 = var_x762 + var_x772 - var_x763 + var_x1111 * var_x761;
        const double var_x1122 = var_x902 + var_x788 * var_chaste_interface__ICaL__d;
        const double var_x1123 = var_x1110 * var_x1122;
        const double var_x1124 = pow(var_chaste_interface__intracellular_ions__cajsr, (-2));
        const double var_x1125 = var_x1122 / (pow((0.039018442310623382 + var_x1109), 2) * pow(var_chaste_interface__intracellular_ions__cajsr, 9));
        const double var_x1126 = var_x788 + var_x901;
        const double var_x1127 = var_x1112 * var_x791;
        const double var_x1128 = var_x795 + var_x1112 * var_x793;
        const double var_x1129 = var_x1112 * var_x797;
        const double var_x1130 = var_x801 + var_x1112 * var_x799;
        const double var_x1131 = var_x806 + var_x1112 * var_x803;
        const double var_x1132 = var_x1110 * var_x512;
        const double var_x1133 = var_x1132 * var_x791;
        const double var_x1134 = 2.6125000000000003 * var_x1117;
        const double var_x1135 = var_x1132 * var_x797;
        const double var_x1136 = var_x814 + var_x1112 * var_x811;
        ...
        const double var_x1139 = 2.96875 * var_x1138;
        const double var_x1140 = var_x1110 * var_x1139;
        const double var_x1141 = 3.2656250000000004 * var_x1138;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x431 - var_x185 - var_x19 - var_x34 - var_x486 - var_x515 + 0.10534077741493732 * var_x489 - var_x167 - 0.054525627044711013 * var_x437 + var_x169 * var_x174 + var_x177 * (-var_x175 - var_x176) + var_x443 * var_x459 + var_x467 * var_x469 + var_x475 * var_x477 + var_x495 * var_x500 + var_x507 * var_x508 + var_x508 * var_x511 + (-var_x52 - var_x55) * NV_Ith_S(mParameters, 24) + (0.014753396606870788 * var_x155 + 2.5425659820598794 * var_x156 - 1.1377195280964303 * var_x164 - 0.00010162981240266993 * var_x163 + var_x127 * var_x129 + var_x147 * var_x150 + var_x147 * var_x161 - var_x109 * var_x117 - var_x142 * var_x146 - var_x147 * var_x159 - var_x151 * var_x153) * NV_Ith_S(mParameters, 23) - var_x326 * var_x330 - var_x417 * var_x420 - var_x423 * var_chaste_interface__IKr__O - var_x435 * var_chaste_interface__IK1__xk1 - var_x467 * var_x488 - var_x475 * var_x487 - var_x516 * var_x518 - var_x518 * var_x519);
        IJth(rJacobian, 1, 0) = var_x821 * (-3.0760371441184366e-5 * var_x34 + var_x417 * var_x817);
        IJth(rJacobian, 3, 0) = -6.1520742882368733e-5 * var_x185 - 6.1520742882368733e-5 * var_x19 + var_x177 * (-6.1520742882368733e-5 * var_x175 - var_x848 * var_chaste_interface__INaL__hLp) + (2.722919757878727e-6 * var_x155 + 0.0004692616441312896 * var_x156 - 1.8757024674024077e-8 * var_x163 - 0.0002099800516808111 * var_x164 + var_x127 * var_x842 + var_x147 * var_x844 + var_x147 * var_x847 - var_x109 * var_x841 - var_x142 * var_x843 - var_x147 * var_x846 - var_x151 * var_x845) * NV_Ith_S(mParameters, 23) - var_x417 * var_x849;
        IJth(rJacobian, 4, 0) = var_x475 * var_x859 + var_x508 * var_x861 - var_x326 * var_x857 - var_x475 * var_x860 - var_x518 * var_x862;
        IJth(rJacobian, 5, 0) = var_x874 + 6.480642882373194e-6 * var_x489 - 3.354457081917597e-6 * var_x437 - 6.1520742882368733e-5 * var_x167 + var_x169 * var_x870 + (-6.1520742882368733e-5 * var_x52 - var_x557 * var_x848) * NV_Ith_S(mParameters, 24) + (0.00013998670112054073 * var_x164 + 1.250468311601605e-8 * var_x163 - 0.0003128410960875264 * var_x156 - 1.8152798385858181e-6 * var_x155 + var_x109 * var_x863 + var_x142 * var_x864 + var_x147 * var_x868 + var_x151 * var_x866 - var_x127 * var_x865 - var_x147 * var_x867 - var_x147 * var_x869) * NV_Ith_S(mParameters, 23) - var_x871 * var_chaste_interface__IKr__O - var_x875 * var_chaste_interface__IK1__xk1;
        IJth(rJacobian, 6, 0) = var_x467 * var_x883 + var_x508 * var_x885 - var_x467 * var_x884 - var_x518 * var_x886;
        IJth(rJacobian, 7, 0) = var_x897 * (var_x326 * var_x887 + var_x443 * var_x889 + var_x500 * var_x891 - var_x443 * var_x890 - var_x514 * var_x892);
        IJth(rJacobian, 10, 0) = var_x917 * (-var_chaste_interface__INa__m + 1 / var_x914) + 0.10130685847431871 * var_x913 * var_x920 / pow(var_x914, 2);
        IJth(rJacobian, 11, 0) = (var_x925 - var_chaste_interface__INa__hf) * (0.30335471139615194 * var_x926 - 2.2784407319013524e-6 * var_x927) - var_x930 * (var_x928 + var_x929);
        IJth(rJacobian, 12, 0) = (var_x925 - var_chaste_interface__INa__hs) * (0.0059001058948111541 * var_x931 - 0.00034916221033868096 * var_x932) - var_x930 * (var_x933 + var_x934);
        IJth(rJacobian, 13, 0) = -var_x930 * var_x938 - 2.5847740332669882 * var_x939 * (var_x925 - var_chaste_interface__INa__j);
        IJth(rJacobian, 14, 0) = (-var_chaste_interface__INa__hsp + 1 / var_x941) * (0.0019667019649370517 * var_x931 - 0.00011638740344622698 * var_x932) - 0.16431153466973381 * var_x940 * (var_x942 + var_x943) / pow(var_x941, 2);
        IJth(rJacobian, 15, 0) = -var_x930 * var_x944 - 1.7703931734705398 * var_x939 * (var_x925 - var_chaste_interface__INa__jp);
        IJth(rJacobian, 16, 0) = var_x917 * (-var_chaste_interface__INaL__mL + 1 / var_x946) + 0.18996960486322187 * var_x920 * var_x945 / pow(var_x946, 2);
        IJth(rJacobian, 17, 0) = -0.00066773504273504275 * var_x948 / pow((1.0 + var_x948), 2);
        IJth(rJacobian, 18, 0) = -0.00022257834757834756 * var_x949 / pow((1.0 + var_x949), 2);
        IJth(rJacobian, 19, 0) = var_x958 * (-var_chaste_interface__Ito__a + 1 / var_x952) + var_x951 * var_x961 / pow(var_x952, 2);
        IJth(rJacobian, 20, 0) = -var_x966 * var_x969 - var_x971 * (var_x970 - var_chaste_interface__Ito__iF);
        IJth(rJacobian, 21, 0) = -var_x969 * var_x975 - var_x976 * (var_x970 - var_chaste_interface__Ito__iS);
        IJth(rJacobian, 22, 0) = var_x958 * (-var_chaste_interface__Ito__ap + 1 / var_x978) + var_x961 * var_x977 / pow(var_x978, 2);
        IJth(rJacobian, 23, 0) = -var_x969 * var_x990 - var_x992 * var_x993 - var_x992 * var_x994 - var_x971 * var_x989 * var_x991;
        IJth(rJacobian, 24, 0) = -var_x969 * var_x995 - var_x993 * var_x997 - var_x994 * var_x997 - var_x976 * var_x989 * var_x996;
        IJth(rJacobian, 25, 0) = 0.23640661938534277 * var_x1004 * var_x998 / pow(var_x999, 2) - (-var_chaste_interface__ICaL__d + 1 / var_x999) * (0.050000000000000003 * var_x1001 - 0.089999999999999997 * var_x1000) / (pow(var_x1002, 2) * pow(var_x1003, 2));
        IJth(rJacobian, 26, 0) = -var_x1008 * var_x1012 - 1007.8105316200556 * var_x1014 * (var_x1013 - var_chaste_interface__ICaL__ff);
        IJth(rJacobian, 27, 0) = -var_x1012 * var_x1018 - 816.32653061224505 * (var_x1013 - var_chaste_interface__ICaL__fs) * (8.7499999999999992e-6 * var_x1016 - 5.8333333333333331e-6 * var_x1015) / (pow((1 + 0.001 * var_x1017), 2) * pow((var_x1015 + var_x1016), 2));
        IJth(rJacobian, 28, 0) = -var_x1012 * var_x1023 - 12.755102040816325 * var_x1024 * (var_x1013 - var_chaste_interface__ICaL__fcaf);
        IJth(rJacobian, 29, 0) = -var_x1012 * var_x1028 - 6944.4444444444443 * (var_x1013 - var_chaste_interface__ICaL__fcas) * (4.0000000000000003e-5 * var_x1026 - 1.7142857142857142e-5 * var_x1025) / (pow((1 + 0.01 * var_x1027), 2) * pow((var_x1025 + var_x1026), 2));
        IJth(rJacobian, 30, 0) = -0.0036075036075036075 * var_x1011;
        IJth(rJacobian, 31, 0) = -var_x1012 * var_x1029 - 403.12421264802225 * var_x1014 * (var_x1013 - var_chaste_interface__ICaL__ffp);
        IJth(rJacobian, 32, 0) = -var_x1012 * var_x1030 - 5.1020408163265305 * var_x1024 * (var_x1013 - var_chaste_interface__ICaL__fcafp);
        IJth(rJacobian, 34, 0) = var_x1035 - var_x1037 - var_x1039 - var_x1041;
        IJth(rJacobian, 35, 0) = var_x1039 + var_x1041 + var_x1047 + var_x1049 - var_x1051 - var_x1053;
        IJth(rJacobian, 36, 0) = var_x1037 - var_x1035 - var_x1059 - var_x1061;
        IJth(rJacobian, 37, 0) = var_x1059 + var_x1061 - var_x1047 - var_x1049 - var_x1065 - var_x1067;
        IJth(rJacobian, 38, 0) = var_x1065 + var_x1067 - var_x1071 - var_x1075;
        IJth(rJacobian, 39, 0) = var_x1051 + var_x1053 + var_x1071 + var_x1075 + var_x1082;
        IJth(rJacobian, 40, 0) = var_x1087 - var_x1082;
        IJth(rJacobian, 41, 0) = var_x1087;
        IJth(rJacobian, 42, 0) = -0.29459419649432905 * var_x1086;
        IJth(rJacobian, 43, 0) = var_x1093 * var_x1096 - 0.89683381486126834 * (var_x1097 - var_chaste_interface__IKs__xs1) * (5.617391304347826e-6 * var_x1090 - 1.3067415730337078e-5 * var_x1091) / (pow((1 + 0.001223540927444023 * var_x1092), 2) * pow((var_x1090 + 0.18003095975232197 * var_x1091), 2));
        IJth(rJacobian, 44, 0) = var_x1096 * (var_x1100 + var_x1101) + (var_x1097 - var_chaste_interface__IKs__xs2) * (0.00050000000000000001 * var_x1098 - 0.00062258064516129035 * var_x1099);
        IJth(rJacobian, 45, 0) = (-var_chaste_interface__IK1__xk1 + 1 / var_x1104) * (0.00011803412744333594 * var_x1105 - 0.00040193055283135957 * var_x1106) + var_x1102 * var_x1103 * (var_x1107 + var_x1108) / pow(var_x1104, 2);
        IJth(rJacobian, 46, 0) = -var_x1113 * var_x1118;
        IJth(rJacobian, 47, 0) = -var_x1113 * var_x1139;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x530 - var_x526 - var_x528 - 5.4447296618926212e-7 * var_x552 - 3.5999999999999998e-8 * var_x548 - var_x420 * var_x546);
        IJth(rJacobian, 1, 1) = var_x821 * (-0.14705882352941174 - var_x830 + 2.2147467437652741e-12 * var_x548 + 3.0760371441184366e-5 * var_x530 - 3.0760371441184366e-5 * var_x526 + var_x546 * var_x817 + (0.00097665441176470586 * var_x828 + 0.00035514705882352943 * var_x829 - 0.00097665441176470586 * var_x824 - 0.00035514705882352943 * var_x827) * NV_Ith_S(mParameters, 8)) + (0.00023800000000000004 / pow(var_x818, 3) + 7.0000000000000007e-5 / pow(var_x527, 3)) * (0.14705882352941174 * var_chaste_interface__intracellular_ions__cass - 3.0760371441184366e-5 * ((var_x24) ? (var_x831 - var_x491 * (-var_x831 + var_x23 * var_x503 * NV_Ith_S(mParameters, 13))) : (var_x30 * var_x524)) - 0.14705882352941174 * var_chaste_interface__intracellular_ions__cai + var_x547 * var_x817 - var_x830 * var_chaste_interface__intracellular_ions__cai - 0.081176470588235281 * (-0.00026249999999999998 * var_chaste_interface__intracellular_ions__cansr + var_x832 * var_chaste_interface__intracellular_ions__cai + var_x833 * var_chaste_interface__intracellular_ions__cai) * NV_Ith_S(mParameters, 8)) / pow(var_x819, 2);
        IJth(rJacobian, 3, 1) = -6.644240231295822e-12 * var_x548 - var_x546 * var_x849;
        IJth(rJacobian, 5, 1) = -3.3496381359330236e-11 * var_x552;
        IJth(rJacobian, 7, 1) = 5.0 * var_x896;
        IJth(rJacobian, 8, 1) = (var_x832 + var_x833 - 0.0043750000000000004 * var_x829 - 0.01203125 * var_x828) * NV_Ith_S(mParameters, 8);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x572 - var_x568 - var_x578 + 0.00020625000000000003 * var_x574 + 5.8971000000000002e-5 * var_x575 - 0.0001875 * var_x580 - 5.3610000000000003e-5 * var_x582 + var_x174 * var_x558 + var_x559 * var_x564);
        IJth(rJacobian, 1, 2) = var_x821 * (0.00014649816176470588 * var_x835 - 5.3272058823529409e-5 * var_x836) * NV_Ith_S(mParameters, 8);
        IJth(rJacobian, 2, 2) = -0.00068000000000000005 - var_x46 * var_x840 + var_x41 * var_x840 * (1 - var_x45);
        IJth(rJacobian, 3, 2) = -6.1520742882368733e-5 * var_x568 + var_x559 * var_x852;
        IJth(rJacobian, 4, 2) = 4.3141420946261074e-7 * var_x574 - 3.9219473587510065e-7 * var_x580;
        IJth(rJacobian, 5, 2) = var_x558 * var_x870;
        IJth(rJacobian, 6, 2) = 1.2334995076954966e-7 * var_x575 - 1.1213631888140878e-7 * var_x582;
        IJth(rJacobian, 7, 2) = var_x897 * (0.00017256568378504431 * var_x571 + (var_x898 * var_chaste_interface__ryr__Jrelnp - var_x898 * var_chaste_interface__ryr__Jrelp) * NV_Ith_S(mParameters, 7) - 0.00015687789435004027 * var_x569 * var_x576);
        IJth(rJacobian, 8, 2) = (0.00065625000000000004 * var_x836 - 0.0018046875000000001 * var_x835) * NV_Ith_S(mParameters, 8);
        IJth(rJacobian, 9, 2) = var_x911 * (var_x555 * var_chaste_interface__ryr__Jrelp - var_x555 * var_chaste_interface__ryr__Jrelnp);
        IJth(rJacobian, 46, 2) = -var_x1119 * var_x1120;
        IJth(rJacobian, 47, 2) = -var_x1119 * var_x1140;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x585 + 0.48963716847178318 * var_x671 + (7.627697946179639 * var_x619 - 4.348546428156827e-14 * var_x623 - 0.052543934931800658 * var_x622 - 3.0612499986110548e-12 * var_x607 + var_x129 * var_x605 + var_x616 * var_x617 + var_x616 * var_x621 - var_x117 * var_x602 - var_x146 * var_x616 - var_x153 * var_x618 - var_x616 * var_x620) * NV_Ith_S(mParameters, 23) - var_x185 * var_x668 - var_x420 * var_x667 - var_x668 * var_x670);
        IJth(rJacobian, 1, 3) = var_x667 * var_x817 * var_x820;
        IJth(rJacobian, 3, 3) = -0.014705882352941176 - 6.1520742882368733e-5 * var_x585 + (0.0014077849323938687 * var_x619 - 9.6976257329016631e-6 * var_x622 - 5.6499112218960703e-16 * var_x607 - 8.025774201560372e-18 * var_x623 + var_x605 * var_x842 + var_x616 * var_x853 + var_x616 * var_x855 - var_x602 * var_x841 - var_x616 * var_x843 - var_x616 * var_x854 - var_x618 * var_x845) * NV_Ith_S(mParameters, 23) - var_x185 * var_x856 - var_x667 * var_x849 - var_x670 * var_x856;
        IJth(rJacobian, 4, 3) = 0.5;
        IJth(rJacobian, 5, 3) = 0.48963716847178318 * var_x879 + (6.4650838219344423e-6 * var_x622 + 3.7666074812640467e-16 * var_x607 + 5.3505161343735813e-18 * var_x623 - 0.0009385232882625792 * var_x619 + var_x602 * var_x863 + var_x616 * var_x864 + var_x616 * var_x877 + var_x618 * var_x866 - var_x605 * var_x865 - var_x616 * var_x876 - var_x616 * var_x878) * NV_Ith_S(mParameters, 23);
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x477 * var_x713 - var_x330 * var_x711 - var_x487 * var_x713);
        IJth(rJacobian, 3, 4) = 0.014705882352941176;
        IJth(rJacobian, 4, 4) = -0.5 + var_x713 * var_x859 - var_x711 * var_x857 - var_x713 * var_x860;
        IJth(rJacobian, 7, 4) = var_x711 * var_x887 * var_x896;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (26.712338705498265 * var_x671 - 11.495160327182951 * var_x742 + (0.15891037387874246 * var_x739 - 2.3483561633180696e-12 * var_x607 - 3.3358712325586619e-14 * var_x623 + var_x129 * var_x730 + var_x617 * var_x737 + var_x621 * var_x737 - var_x117 * var_x725 - var_x146 * var_x737 - var_x153 * var_x738 - var_x620 * var_x737) * NV_Ith_S(mParameters, 23) - var_x167 * var_x740 - var_x740 * var_x741 - var_x740 * var_x743);
        IJth(rJacobian, 3, 5) = (2.93288527582056e-5 * var_x739 - 4.3341784715915055e-16 * var_x607 - 6.1567582916079571e-18 * var_x623 + var_x730 * var_x842 + var_x737 * var_x853 + var_x737 * var_x855 - var_x725 * var_x841 - var_x737 * var_x843 - var_x737 * var_x854 - var_x738 * var_x845) * NV_Ith_S(mParameters, 23);
        IJth(rJacobian, 5, 5) = -0.014705882352941176 + 26.712338705498265 * var_x879 - 0.00070719080288022792 * var_x742 + (4.1045055277386378e-18 * var_x623 + 2.8894523143943372e-16 * var_x607 - 1.95525685054704e-5 * var_x739 + var_x725 * var_x863 + var_x737 * var_x864 + var_x737 * var_x877 + var_x738 * var_x866 - var_x730 * var_x865 - var_x737 * var_x876 - var_x737 * var_x878) * NV_Ith_S(mParameters, 23) - var_x167 * var_x880 - var_x741 * var_x880 - var_x743 * var_x880;
        IJth(rJacobian, 6, 5) = 0.5;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x469 * var_x713 - var_x488 * var_x713);
        IJth(rJacobian, 5, 6) = 0.014705882352941176;
        IJth(rJacobian, 6, 6) = -0.5 + var_x713 * var_x883 - var_x713 * var_x884;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x763 - var_x758 - var_x762 - var_x772 + 4.0207500000000006e-9 * var_x765 + 1.4062500000000001e-8 * var_x766 - 4.4228250000000006e-9 * var_x769 - 1.5468750000000001e-8 * var_x770 - 8.9999999999999995e-9 * var_x760 + var_x174 * var_x747 + var_x459 * var_x761 + var_x564 * var_x757 - var_x330 * var_x756);
        IJth(rJacobian, 1, 7) = var_x821 * (0.14705882352941174 + (3.9954044117647064e-9 * var_x838 - 1.0987362132352942e-8 * var_x839) * NV_Ith_S(mParameters, 8));
        IJth(rJacobian, 2, 7) = 3.7500000000000005e-6 * var_x46 * var_x744 + 1.8750000000000003e-7 * var_x327 * pow(var_x41, 2) / pow(var_x43, 3);
        IJth(rJacobian, 3, 7) = -6.1520742882368733e-5 * var_x758 + var_x757 * var_x852;
        IJth(rJacobian, 4, 7) = 2.9414605190632549e-11 * var_x766 - 5.6476041966014488e-11 * var_x760 - 3.2356065709695809e-11 * var_x770 - var_x756 * var_x857;
        IJth(rJacobian, 5, 7) = var_x747 * var_x870;
        IJth(rJacobian, 6, 7) = 8.4102239161056588e-12 * var_x765 - 9.251246307716226e-12 * var_x769;
        IJth(rJacobian, 7, 7) = var_x897 * (-5.0 + 1.882534732200483e-11 * var_x760 - 1.2942426283878324e-8 * var_x771 + var_x756 * var_x887 + var_x761 * var_x889 + (var_x899 * var_chaste_interface__ryr__Jrelp - var_x899 * var_chaste_interface__ryr__Jrelnp) * NV_Ith_S(mParameters, 7) - var_x761 * var_x890 + 1.1765842076253021e-8 * var_x577 * var_x745) + (0.019557600000000001 / pow(var_x893, 3) + 8.1780000000000006e-5 / pow(var_x894, 3)) * (5.0 * var_chaste_interface__intracellular_ions__cai + 0.23999999999999996 * var_x900 - 5.0 * var_chaste_interface__intracellular_ions__cass - 0.0010458526290002684 * var_x902 + var_x759 * var_x887 - var_x903 * var_chaste_interface__ICaL__d) / pow(var_x895, 2);
        IJth(rJacobian, 8, 7) = (1.3535156250000001e-7 * var_x839 - 4.9218750000000005e-8 * var_x838) * NV_Ith_S(mParameters, 8);
        IJth(rJacobian, 9, 7) = var_x911 * (var_x746 * var_chaste_interface__ryr__Jrelnp - var_x746 * var_chaste_interface__ryr__Jrelp);
        IJth(rJacobian, 33, 7) = 7.9999999999999996e-6 * var_x1032 * var_x327 * pow(var_x1031, 3);
        IJth(rJacobian, 46, 7) = -var_x1120 * var_x1121;
        IJth(rJacobian, 47, 7) = -var_x1121 * var_x1140;
        IJth(rJacobian, 1, 8) = 2.1308823529411761e-5 * var_x820 * NV_Ith_S(mParameters, 8);
        IJth(rJacobian, 8, 8) = -0.00086956521739130427 - 0.00026249999999999998 * NV_Ith_S(mParameters, 8);
        IJth(rJacobian, 9, 8) = var_x912;
        IJth(rJacobian, 8, 9) = 0.00086956521739130427;
        IJth(rJacobian, 9, 9) = -var_x912 + 0.25 * (-var_x900 + 0.01 * var_chaste_interface__intracellular_ions__cansr - 0.01 * var_chaste_interface__intracellular_ions__cajsr) / (pow(var_x907, 3) * pow((0.125 + var_x908), 2));
        IJth(rJacobian, 46, 9) = (-var_chaste_interface__ryr__Jrelnp - 2.375 * var_x1123) * ((var_x1116) ? (0) : (-0.0025894736842105265 * var_x1124)) - 0.74135040390184426 * var_x1117 * var_x1125;
        IJth(rJacobian, 47, 9) = (-var_chaste_interface__ryr__Jrelp - 2.96875 * var_x1123) * ((var_x1137) ? (0) : (-0.0020715789473684213 * var_x1124)) - 0.92668800487730529 * var_x1125 * var_x1138;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x773);
        IJth(rJacobian, 3, 10) = -0.0001845622286471062 * var_x773;
        IJth(rJacobian, 10, 10) = var_x921;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x775);
        IJth(rJacobian, 3, 11) = -6.1520742882368733e-5 * var_x775;
        IJth(rJacobian, 11, 11) = -var_x928 - var_x929;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x777);
        IJth(rJacobian, 3, 12) = -6.1520742882368733e-5 * var_x777;
        IJth(rJacobian, 12, 12) = -var_x933 - var_x934;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x778);
        IJth(rJacobian, 3, 13) = -6.1520742882368733e-5 * var_x778;
        IJth(rJacobian, 13, 13) = -var_x938;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x776 * var_x779);
        IJth(rJacobian, 3, 14) = -6.1520742882368787e-7 * var_x48 * var_x779;
        IJth(rJacobian, 14, 14) = -var_x942 - var_x943;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x49 * var_x780);
        IJth(rJacobian, 3, 15) = -var_x780 * var_x848;
        IJth(rJacobian, 15, 15) = -var_x944;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x563 * var_x781);
        IJth(rJacobian, 3, 16) = var_x781 * var_x851;
        IJth(rJacobian, 16, 16) = var_x921;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x50 * var_x564);
        IJth(rJacobian, 3, 17) = var_x50 * var_x852;
        IJth(rJacobian, 17, 17) = -0.0050000000000000001;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x49 * var_x564);
        IJth(rJacobian, 3, 18) = var_x49 * var_x852;
        IJth(rJacobian, 18, 18) = -0.0016666666666666668;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x174 * var_x782);
        IJth(rJacobian, 5, 19) = var_x782 * var_x870;
        IJth(rJacobian, 19, 19) = var_x962;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (var_x174 * var_x783);
        IJth(rJacobian, 5, 20) = var_x783 * var_x870;
        IJth(rJacobian, 20, 20) = -var_x966;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (var_x174 * var_x784);
        IJth(rJacobian, 5, 21) = var_x784 * var_x870;
        IJth(rJacobian, 21, 21) = -var_x975;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (var_x174 * var_x785);
        IJth(rJacobian, 5, 22) = var_x785 * var_x870;
        IJth(rJacobian, 22, 22) = var_x962;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (var_x37 * var_x786);
        IJth(rJacobian, 5, 23) = var_x37 * var_x881;
        IJth(rJacobian, 23, 23) = -var_x990;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (var_x39 * var_x786);
        IJth(rJacobian, 5, 24) = var_x39 * var_x881;
        IJth(rJacobian, 24, 24) = -var_x995;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x788 - 0.0013750000000000001 * var_x789 - 0.00039314000000000005 * var_x790 + var_x444 * var_x576 + var_x468 * var_x581 + var_x476 * var_x579);
        IJth(rJacobian, 4, 25) = -2.8760947297507386e-6 * var_x789 + var_x579 * var_x858;
        IJth(rJacobian, 6, 25) = -8.2233300513033119e-7 * var_x790 + var_x581 * var_x882;
        IJth(rJacobian, 7, 25) = var_x897 * (-var_x903 + var_x576 * var_x888);
        IJth(rJacobian, 25, 25) = -var_x1004;
        IJth(rJacobian, 46, 25) = -var_x1120 * var_x1126;
        IJth(rJacobian, 47, 25) = -var_x1126 * var_x1140;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (var_x495 * var_x791 + var_x507 * var_x792 + var_x511 * var_x792);
        IJth(rJacobian, 4, 26) = var_x792 * var_x861;
        IJth(rJacobian, 6, 26) = var_x792 * var_x885;
        IJth(rJacobian, 7, 26) = var_x791 * var_x891 * var_x897;
        IJth(rJacobian, 26, 26) = -var_x1008;
        IJth(rJacobian, 46, 26) = -var_x1120 * var_x1127;
        IJth(rJacobian, 47, 26) = -var_x1127 * var_x1140;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x795 + var_x495 * var_x793 + var_x507 * var_x794 + var_x511 * var_x794 - var_x516 * var_x796 - var_x519 * var_x796);
        IJth(rJacobian, 4, 27) = var_x794 * var_x861 - var_x796 * var_x862;
        IJth(rJacobian, 6, 27) = var_x794 * var_x885 - var_x796 * var_x886;
        IJth(rJacobian, 7, 27) = var_x897 * (var_x793 * var_x891 - var_x793 * var_x892);
        IJth(rJacobian, 27, 27) = -var_x1018;
        IJth(rJacobian, 46, 27) = -var_x1120 * var_x1128;
        IJth(rJacobian, 47, 27) = -var_x1128 * var_x1140;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (var_x495 * var_x797 + var_x507 * var_x798 + var_x511 * var_x798);
        IJth(rJacobian, 4, 28) = var_x798 * var_x861;
        IJth(rJacobian, 6, 28) = var_x798 * var_x885;
        IJth(rJacobian, 7, 28) = var_x452 * var_x891 * var_x896 * var_x904 * var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__jca;
        IJth(rJacobian, 28, 28) = -var_x1023;
        IJth(rJacobian, 46, 28) = -var_x1120 * var_x1129;
        IJth(rJacobian, 47, 28) = -var_x1129 * var_x1140;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x801 + var_x495 * var_x799 + var_x507 * var_x800 + var_x511 * var_x800 - var_x516 * var_x802 - var_x519 * var_x802);
        IJth(rJacobian, 4, 29) = var_x800 * var_x861 - var_x802 * var_x862;
        IJth(rJacobian, 6, 29) = var_x800 * var_x885 - var_x802 * var_x886;
        IJth(rJacobian, 7, 29) = var_x897 * (var_x799 * var_x891 - var_x799 * var_x892);
        IJth(rJacobian, 29, 29) = -var_x1028;
        IJth(rJacobian, 46, 29) = -var_x1120 * var_x1130;
        IJth(rJacobian, 47, 29) = -var_x1130 * var_x1140;
        IJth(rJacobian, 0, 30) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x806 + var_x495 * var_x803 + var_x507 * var_x804 + var_x511 * var_x804 - var_x516 * var_x807 - var_x519 * var_x807);
        IJth(rJacobian, 4, 30) = var_x804 * var_x861 - var_x807 * var_x862;
        IJth(rJacobian, 6, 30) = var_x804 * var_x885 - var_x807 * var_x886;
        IJth(rJacobian, 7, 30) = var_x897 * (var_x803 * var_x891 - var_x805 * var_x892);
        IJth(rJacobian, 30, 30) = -0.013333333333333334;
        IJth(rJacobian, 33, 30) = -var_x904 + 1.0 * var_x1032 / pow(var_chaste_interface__ICaL__jca, 2);
        IJth(rJacobian, 46, 30) = -var_x1120 * var_x1131;
        IJth(rJacobian, 47, 30) = -var_x1131 * var_x1140;
        IJth(rJacobian, 0, 31) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x513 * var_x791 - var_x516 * var_x808 - var_x519 * var_x808);
        IJth(rJacobian, 4, 31) = -var_x808 * var_x862;
        IJth(rJacobian, 6, 31) = -var_x808 * var_x886;
        IJth(rJacobian, 7, 31) = -var_x791 * var_x905;
        IJth(rJacobian, 31, 31) = -var_x1029;
        IJth(rJacobian, 46, 31) = -var_x1133 * var_x1134;
        IJth(rJacobian, 47, 31) = -var_x1133 * var_x1141;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x513 * var_x797 - var_x516 * var_x809 - var_x519 * var_x809);
        IJth(rJacobian, 4, 32) = -var_x809 * var_x862;
        IJth(rJacobian, 6, 32) = -var_x809 * var_x886;
        IJth(rJacobian, 7, 32) = -var_x797 * var_x905;
        IJth(rJacobian, 32, 32) = -var_x1030;
        IJth(rJacobian, 46, 32) = -var_x1134 * var_x1135;
        IJth(rJacobian, 47, 32) = -var_x1135 * var_x1141;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x814 + var_x495 * var_x811 + var_x507 * var_x812 + var_x511 * var_x812 - var_x516 * var_x815 - var_x519 * var_x815);
        IJth(rJacobian, 4, 33) = var_x812 * var_x861 - var_x815 * var_x862;
        IJth(rJacobian, 6, 33) = var_x812 * var_x885 - var_x815 * var_x886;
        IJth(rJacobian, 7, 33) = var_x897 * (var_x811 * var_x891 - var_x813 * var_x892);
        IJth(rJacobian, 33, 33) = -var_chaste_interface__ICaL__jca;
        IJth(rJacobian, 46, 33) = -var_x1120 * var_x1136;
        IJth(rJacobian, 47, 33) = -var_x1136 * var_x1140;
        IJth(rJacobian, 34, 34) = -var_x1042 - var_x1043;
        IJth(rJacobian, 35, 34) = var_x1042;
        IJth(rJacobian, 36, 34) = var_x1043;
        IJth(rJacobian, 34, 35) = var_x1044;
        IJth(rJacobian, 35, 35) = -var_x1044 - var_x1054 - var_x1055;
        IJth(rJacobian, 37, 35) = var_x1054;
        IJth(rJacobian, 39, 35) = var_x1055;
        IJth(rJacobian, 34, 36) = var_x1045;
        IJth(rJacobian, 36, 36) = -var_x1045 - var_x1062;
        IJth(rJacobian, 37, 36) = var_x1062;
        IJth(rJacobian, 35, 37) = var_x1056;
        IJth(rJacobian, 36, 37) = var_x1063;
        IJth(rJacobian, 37, 37) = -var_x1056 - var_x1063 - var_x1068;
        IJth(rJacobian, 38, 37) = var_x1068;
        IJth(rJacobian, 0, 38) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x423 * var_x436);
        IJth(rJacobian, 5, 38) = -var_x436 * var_x871;
        IJth(rJacobian, 37, 38) = var_x1069;
        IJth(rJacobian, 38, 38) = var_x1079 - var_x1069 - var_x1076;
        IJth(rJacobian, 39, 38) = var_x1076;
        IJth(rJacobian, 41, 38) = var_x1078;
        IJth(rJacobian, 35, 39) = var_x1057;
        IJth(rJacobian, 38, 39) = var_x1080;
        IJth(rJacobian, 39, 39) = var_x1079 - var_x1057 - var_x1080;
        IJth(rJacobian, 40, 39) = var_x1078;
        IJth(rJacobian, 39, 40) = var_x1083;
        IJth(rJacobian, 40, 40) = var_x1088 - var_x1083;
        IJth(rJacobian, 42, 40) = NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 38, 41) = NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 41, 41) = var_x1088 - NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 42, 41) = NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 40, 42) = var_x1089;
        IJth(rJacobian, 41, 42) = var_x1089;
        IJth(rJacobian, 42, 42) = -2 * var_x1089;
        IJth(rJacobian, 0, 43) = mSetVoltageDerivativeToZero ? 0.0 : (var_x430 * var_x550);
        IJth(rJacobian, 5, 43) = var_x550 * var_x873;
        IJth(rJacobian, 43, 43) = -var_x1093;
        IJth(rJacobian, 0, 44) = mSetVoltageDerivativeToZero ? 0.0 : (var_x428 * var_x816);
        IJth(rJacobian, 5, 44) = var_x816 * var_x872;
        IJth(rJacobian, 44, 44) = -var_x1100 - var_x1101;
        IJth(rJacobian, 0, 45) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x435 * var_x436);
        IJth(rJacobian, 5, 45) = -var_x436 * var_x875;
        IJth(rJacobian, 45, 45) = -var_x1107 - var_x1108;
        IJth(rJacobian, 7, 46) = var_x897 * (0.23999999999999996 - var_x906) * NV_Ith_S(mParameters, 7);
        IJth(rJacobian, 9, 46) = var_x444 * var_x911;
        IJth(rJacobian, 46, 46) = -var_x1117;
        IJth(rJacobian, 7, 47) = var_x896 * var_x906 * NV_Ith_S(mParameters, 7);
        IJth(rJacobian, 9, 47) = -var_x49 * var_x910;
        IJth(rJacobian, 47, 47) = -var_x1138;
    }
