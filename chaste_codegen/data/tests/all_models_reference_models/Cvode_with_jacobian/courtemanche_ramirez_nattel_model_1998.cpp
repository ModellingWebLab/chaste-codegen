...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellcourtemanche_ramirez_nattel_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x44 = (00046606814415738453 * var_x40 + 037435192301797954 * var_x42 * (-0052142857142857138 + 0052142857142857138 * var_x41)) * NV_Ith_S(mParameters, 0) / (pow(var_x43, 2) * (1.0 + 31.622776601683793 * var_x39));
        ...
        const double var_x49 = -26.712831923985377 * log(140 * var_x38) + var_chaste_interface__membrane__V;
        ...
        const double var_x85 = ((var_x76) ? (0) : (var_x81 - 032000000000000001 * var_x77 * var_x79 / pow(var_x80, 2)));
        const double var_x86 = 0072727272727272727 * var_x74;
        ...
        const double var_x98 = ((var_x89) ? (-019852941176470591 * var_x88) : (0));
        const double var_x99 = ((var_x89) ? (0.28123999999999999 * var_x92 + 108500 * var_x91) : (0.693000693000693 * var_x93 / pow(var_x94, 2)));
        ...
        const double var_x122 = ((var_x89) ? (-001275024 * var_x105 + 016701360000000002 * var_x102 * var_x104 / pow(var_x103, 2)) : (-7.6049999999999996e-8 * var_x109 + 029999999999999999 * var_x106 * var_x108 / pow(var_x107, 2)));
        ...
        const double var_x126 = exp(-1.1670467502850628 - 057012542759407071 * var_chaste_interface__membrane__V);
        ...
        const double var_x133 = 1.9500000000000002 * (016949152542372881 * var_x128 + 0.11764705882352941 * var_x129) / pow(var_x130, 2) - 018352941176470589 * var_x132 / pow((1 + 0.40000000000000002 * var_x132), 2);
        ...
        const double var_x146 = exp(-3.6189956331877728 + 036390101892285295 * var_chaste_interface__membrane__V);
        ...
        const double var_x167 = exp(1.5669291338582676 - 07874015748031496 * var_chaste_interface__membrane__V);
        ...
        const double var_x189 = 005608974358974359 * var_x182 * var_x183;
        ...
        const double var_x196 = var_x195 - 2.7189219554066812e-7 * var_x46 - 00011173862339878819 * var_x19;
        ...
        const double var_x260 = 30 * var_x259;
        const double var_x261 = 30 * var_x201;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0 : (var_x0 * (-var_x26 + 0063 * var_x30 + 0013130252232142858 * var_x47 - 0.12941175999999999 * var_x1 - 089999999999999997 * var_x4 - 0.12375 * var_x33 - 0018054375000000002 * NV_Ith_S(mParameters, 0) - 0.46904770956521741 * var_x44 - 00014738024843876965 * var_x19 - 3.5861851621648651e-7 * var_x46 - 0038461538461538464 * var_x48 - var_x11 * var_x12 - var_x36 * var_x37 - var_x6 * var_x7));
        ...
        IJth(rJacobian, 4, 0) = var_x133 * (1 / var_x127 - var_chaste_interface__transient_outward_K_current_oa_gate__oa) + 057012542759407071 * var_x126 * var_x136 / pow(var_x127, 2);
        IJth(rJacobian, 5, 0) = (1 / var_x139 - var_chaste_interface__transient_outward_K_current_oi_gate__oi) * (00031887818877678569 * var_x140 / pow((1 + 028121484814398197 * var_x140), 2) - 00079791438902835471 * var_x141 / pow((1 + 053966540744738258 * var_x141), 2)) - 0.18867924528301888 * var_x138 * (var_x142 + var_x143) / pow(var_x139, 2);
        ...
        IJth(rJacobian, 7, 0) = (1 / var_x147 - var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ui_gate__ui) * (0.1875 * var_x148 + 00024295432458697764 * var_x149 / pow((1 + 047619047619047616 * var_x149), 2)) - 036390101892285295 * var_x146 * (var_x150 + var_x151) / pow(var_x147, 2);
        ...
        IJth(rJacobian, 9, 0) = (pow(var_x168, (-0.5)) - var_chaste_interface__slow_delayed_rectifier_K_current_xs_gate__xs) * (2.0 * ((var_x170) ? (0) : (var_x173 - 3.8888888888888887e-6 * var_x169 * var_x171 / pow(var_x172, 2))) + 2.0 * ((var_x170) ? (0) : (var_x177 - 2.3529411764705885e-6 * var_x169 * var_x175 / pow(var_x176, 2)))) + 03937007874015748 * var_x167 * pow(var_x168, (-1.5)) * (var_x178 + var_x179);
        IJth(rJacobian, 10, 0) = (1 / var_x181 - var_chaste_interface__L_type_Ca_channel_d_gate__d) * ((var_x184) ? (-034998124100548214 * var_x182) : (var_x188 - var_x186 * var_x189 - var_x187 * var_x189 / pow(var_x185, 2))) + 0.125 * var_x180 * var_x190 / pow(var_x181, 2);
        IJth(rJacobian, 11, 0) = (0022222222222222222 + var_x191) * (-0.14492753623188406 * var_x194 + 0.14492753623188406 * pow(var_x192, 2) / pow(var_x193, 2)) + var_x191 * (-022713800000000003 - 0022713799999999999 * var_chaste_interface__membrane__V) * (var_x194 - var_chaste_interface__L_type_Ca_channel_f_gate__f);
        IJth(rJacobian, 13, 0) = -var_x196 * var_x208;
        IJth(rJacobian, 14, 0) = var_x196 * var_x225 + var_x196 * var_x227;
        IJth(rJacobian, 15, 0) = (1.0 - 1 / var_x232 - var_chaste_interface__Ca_release_current_from_JSR_w_gate__w) * ((var_x234) ? (0) : (var_x239 - 01 * var_x237 * var_x240 - 033333333333333333 * var_x238 * var_x240 / pow(var_x236, 2))) - 058823529411764705 * var_x231 * var_x241 / pow(var_x232, 2);
        ...
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (-23.399999999999999 * var_x51);
        IJth(rJacobian, 1, 1) = -var_x75 - var_x87;
        IJth(rJacobian, 16, 1) = -1.7743669281051352e-5 * var_x51 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (-var_x35 * var_x50);
        IJth(rJacobian, 2, 2) = -var_x100 - var_x101;
        IJth(rJacobian, 16, 2) = -var_x242 * var_x50 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (-var_x36 * var_x49);
        IJth(rJacobian, 3, 3) = -var_x124 - var_x125;
        IJth(rJacobian, 16, 3) = -var_x243 * var_x49 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (-0.49560000000000004 * var_x52 * var_chaste_interface__transient_outward_K_current_oi_gate__oi);
        IJth(rJacobian, 4, 4) = var_x137;
        IJth(rJacobian, 18, 4) = -3.7580181605508762e-7 * var_x52 * var_x7;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (-var_x28 * var_x6);
        IJth(rJacobian, 5, 5) = -var_x142 - var_x143;
        IJth(rJacobian, 18, 5) = -var_x255 * var_x29;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (-3 * var_x53 * var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ui_gate__ui);
        IJth(rJacobian, 6, 6) = var_x137;
        IJth(rJacobian, 18, 6) = -2.2748293950065834e-6 * var_x25 * var_x53;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (-var_x54);
        IJth(rJacobian, 7, 7) = -var_x150 - var_x151;
        IJth(rJacobian, 18, 7) = -7.5827646500219453e-7 * var_x54 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (-var_x11 * var_x28);
        IJth(rJacobian, 8, 8) = -var_x165 - var_x166;
        IJth(rJacobian, 18, 8) = -var_x256 * var_x29;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0 : (-0.25882351999999997 * var_x55);
        IJth(rJacobian, 9, 9) = -var_x178 - var_x179;
        IJth(rJacobian, 18, 9) = -1.9625978380502476e-7 * var_x55 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0 : (var_x57 * var_chaste_interface__L_type_Ca_channel_f_gate__f);
        ...
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0 : (var_x57 * var_chaste_interface__L_type_Ca_channel_d_gate__d);
        IJth(rJacobian, 11, 11) = -0022222222222222222 - var_x191;
        ...
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0 : (var_x31 * var_x56);
        ...
        IJth(rJacobian, 14, 13) = -4234674.4696415514 * var_x215 * var_x225 - 2026160333213164 * var_x215 * var_x226;
        IJth(rJacobian, 17, 13) = 0.42352941176470582 * var_x215 * var_x246;
        IJth(rJacobian, 19, 13) = -60 * var_x215 * var_x259;
        ...
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0 : (var_x0 * (-208.36008900708595 * var_x60 - 00079585334156935614 * var_x59 - 018016135580732888 * var_x58 - 022248886402668498 * var_x61));
        IJth(rJacobian, 13, 16) = 7.5423570794182034e-5 * var_x207 * var_x59;
        IJth(rJacobian, 14, 16) = -00028870266332701257 * var_x226 * var_x59 - 00060338856635345627 * var_x225 * var_x59;
        IJth(rJacobian, 16, 16) = -1.3661211601158392e-8 * var_x58 - 1.8104305755161864e-9 * var_x59 - 00015799455173983574 * var_x60 - 5.0612420794952582e-8 * var_x61;
        IJth(rJacobian, 17, 16) = 6.0347685850539541e-10 * var_x246 * var_x59;
        IJth(rJacobian, 18, 16) = 3.3741613863301722e-8 * var_x61;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0 : (var_x0 * (0.27500000000000002 * var_x67 + 404.41140171598391 * var_x68 - 0.27500000000000002 * var_x63 - 015106106453013732 * var_x65));
        IJth(rJacobian, 12, 17) = -000175 / pow((00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        IJth(rJacobian, 13, 17) = -var_x208 * var_x219;
        IJth(rJacobian, 14, 17) = var_x219 * var_x225 + var_x219 * var_x227;
        IJth(rJacobian, 16, 17) = 00091996694429933613 * var_x68;
        IJth(rJacobian, 17, 17) = var_x246 * (-var_x253 - var_x254 + 1.0426301393780176e-7 * var_x67 - 00030665564809977873 * var_x68 - 3.7341176470588232e-7 * var_x252 - 5.7273025005690459e-9 * var_x65) + (00023800000000000004 / pow(var_x244, 3) + 7.0000000000000007e-5 / pow(var_x62, 3)) * (2.7058823529411762e-5 * var_chaste_interface__intracellular_ion_concentrations__Ca_up + 1.1175497379729545e-10 * var_x197 - 00040588235294117644 / var_x251 + var_x198 * var_x254 - var_x203 * var_x248 - var_x247 * (-13.356415961992688 * log(1.8 * var_x64) + var_chaste_interface__membrane__V) - var_x253 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) / pow(var_x245, 2);
        IJth(rJacobian, 19, 17) = var_x259 * var_x261;
        IJth(rJacobian, 20, 17) = 4.6e-6 * var_x252;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0 : (var_x0 * (-3.4569545938671333 * var_x69 - 2.4041548731586837 * var_x70 - 0.78567153503275577 * var_x71 - 26.712831923985377 * var_x73 - 4.4129598338423843 * var_x72));
        ...
        IJth(rJacobian, 19, 19) = var_x259 * (-0055555555555555558 - var_x261) + 0.25 * (0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_rel - var_x198 * var_x261) / (pow(var_x257, 3) * pow((0.125 + var_x258), 2));
        IJth(rJacobian, 20, 19) = 00048309178743961351;
        IJth(rJacobian, 17, 20) = 2.7058823529411762e-5 * var_x246;
        IJth(rJacobian, 19, 20) = 0055555555555555558 * var_x259;
        IJth(rJacobian, 20, 20) = -00081642512077294684;
    }
