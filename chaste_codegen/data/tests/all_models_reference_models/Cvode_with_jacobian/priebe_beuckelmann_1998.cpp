...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpriebe_beuckelmann_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x253 = var_x252 * (-var_chaste_interface__Ionic_concentrations__Ca_JSR + var_chaste_interface__Ionic_concentrations__Cai);
        ...
        IJth(rJacobian, 14, 1) = ((var_x242) ? (-var_x123 * (var_x137 + var_x82)) : (0));
        ...
        IJth(rJacobian, 14, 5) = ((var_x242) ? (-var_x143) : (0));
        ...
        IJth(rJacobian, 14, 6) = ((var_x242) ? (-var_x144) : (0));
        ...
        IJth(rJacobian, 20, 12) = var_x145 * var_x253;
        ...
        IJth(rJacobian, 20, 14) = var_x148 * var_x253;
        ...
        IJth(rJacobian, 14, 18) = ((var_x242) ? (0.00018230432668935341 * var_x149) : (0));
        ...
        IJth(rJacobian, 20, 20) = var_x252 * (-0.0055555555555555558 - var_x131) + 0.25 * (0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_JSR - var_x131 * var_x139) / (pow(var_x249, 3) * pow((0.125 + var_x250), 2));
