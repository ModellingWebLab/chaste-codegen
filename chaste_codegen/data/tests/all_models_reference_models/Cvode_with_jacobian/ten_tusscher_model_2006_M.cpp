...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2006_MFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2006_MFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellten_tusscher_model_2006_MFromCellMLCvode::Cellten_tusscher_model_2006_MFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                19,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2006_MFromCellMLCvode>::Instance();
        Init();
    ...
    Cellten_tusscher_model_2006_MFromCellMLCvode::~Cellten_tusscher_model_2006_MFromCellMLCvode()
    {
    }

    

    void Cellten_tusscher_model_2006_MFromCellMLCvode::VerifyStateVariables()
    {
    ...
    double Cellten_tusscher_model_2006_MFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_current__temp = ((fabs(-15.0 + var_chaste_interface__membrane__V) < 1.3356880330661625e-6) ? (1.3356880330661625e-6 * (-NV_Ith_S(mParameters, 4) + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * exp(1.0000000000609274e-7)) / (-1.0 + exp(1.0000000000609274e-7)) - 374338.90820464725 * (-15.000001335688033 + var_chaste_interface__membrane__V) * (-1.3356880330661625e-6 * (-NV_Ith_S(mParameters, 4) + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * exp(1.0000000000609274e-7)) / (-1.0 + exp(1.0000000000609274e-7)) - 1.3356880330661625e-6 * (-NV_Ith_S(mParameters, 4) + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * exp(-1.0000000000609274e-7)) / (-1.0 + exp(-1.0000000000609274e-7)))) : ((-15.0 + var_chaste_interface__membrane__V) * (-NV_Ith_S(mParameters, 4) + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__membrane__V)) / (-1.0 + exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__membrane__V)))); // millivolt_millimoles
    ...
    void Cellten_tusscher_model_2006_MFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    void Cellten_tusscher_model_2006_MFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -85.423
        double var_chaste_interface__calcium_dynamics__Ca_i = NV_Ith_S(rY, 1);
        ...
        const double var_x7 = var_x6 * NV_Ith_S(mParameters, 12) * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x50 = exp(1.0000000000609274e-7);
        const double var_x51 = 1 / (-1.0 + var_x50);
        const double var_x52 = -NV_Ith_S(mParameters, 4);
        ...
        const double var_x55 = exp(-1.0000000000609274e-7);
        ...
        const double var_x59 = fabs(var_x58) < 1.3356880330661625e-6;
        ...
        const double var_x69 = var_x68 * NV_Ith_S(mParameters, 7) * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x70 = 14447.286958825251 * var_x69;
        const double var_x71 = exp(-0.037433890822745473 * var_chaste_interface__membrane__V);
        const double var_x72 = exp(-0.0037433890822745472 * var_chaste_interface__membrane__V);
        const double var_x73 = 1.0 + 0.035299999999999998 * var_x71 + 0.1245 * var_x72;
        const double var_x74 = 1 / (1.0 + NV_Ith_S(mParameters, 5));
        const double var_x75 = var_x74 * NV_Ith_S(mParameters, 5) * NV_Ith_S(mParameters, 20) / (40.0 + var_chaste_interface__sodium_dynamics__Na_i);
        const double var_x76 = var_x75 * (0.001321416346042915 * var_x71 + 0.00046605194074318115 * var_x72) * var_chaste_interface__sodium_dynamics__Na_i / pow(var_x73, 2);
        const double var_x77 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x78 = NV_Ith_S(mParameters, 10) / var_x77;
        const double var_x79 = 1 / var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x80 = var_x79 * NV_Ith_S(mParameters, 8);
        const double var_x81 = var_chaste_interface__calcium_dynamics__Ca_i * NV_Ith_S(mParameters, 10) / pow(var_x77, 2);
        const double var_x82 = var_x32 * var_x38;
        const double var_x83 = var_x47 * NV_Ith_S(mParameters, 17) * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        const double var_x85 = (-26.713760659695652 * log(var_x84 * (0.029999999999999999 * NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 5))) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 18) * var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs;
        const double var_x86 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        const double var_x87 = -26.713760659695652 * log(var_x86 * NV_Ith_S(mParameters, 6)) + var_chaste_interface__membrane__V;
        const double var_x88 = var_x87 * NV_Ith_S(mParameters, 12) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x89 = var_x88 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x90 = var_x7 * var_x87;
        const double var_x91 = var_x6 * var_x88;
        const double var_x92 = 1.3356880330661625e-6 * var_x54;
        const double var_x93 = ((var_x59) ? (var_x92 - 374338.90820464725 * (-15.000001335688033 + var_chaste_interface__membrane__V) * (-var_x92 - 1.3356880330661625e-6 * var_x57)) : (var_x58 * var_x64));
        const double var_x94 = var_x93 * NV_Ith_S(mParameters, 7) * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x95 = 14447.286958825251 * var_x94;
        const double var_x96 = var_x68 * var_x93 * NV_Ith_S(mParameters, 7);
        const double var_x97 = 14447.286958825251 * var_x96;
        const double var_x98 = var_x27 - var_chaste_interface__membrane__V;
        const double var_x99 = NV_Ith_S(mParameters, 21) * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x100 = 3.3392200826654062e-7 * var_x50 * var_x51;
        const double var_x101 = ((var_x59) ? (var_x100 + (5615084.1230697082 - 374338.90820464725 * var_chaste_interface__membrane__V) * (-var_x100 - 3.3392200826654062e-7 * var_x55 * var_x56)) : (0.25 * var_x66));
        const double var_x102 = var_x86 * NV_Ith_S(mParameters, 9);
        const double var_x103 = var_x3 * var_x84;
        const double var_x104 = 1 / var_x73;
        const double var_x105 = var_x104 * var_x75;
        const double var_x106 = var_x8 * var_x86;
        const double var_x107 = var_x104 * var_x74 * NV_Ith_S(mParameters, 5) * var_chaste_interface__sodium_dynamics__Na_i * NV_Ith_S(mParameters, 20) / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        const double var_x108 = var_x34 * var_x38 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2);
        const double var_x109 = var_x12 * var_x2;
        const double var_x110 = var_x12 * var_x5;
        const double var_x111 = var_x12 * var_x26;
        const double var_x112 = var_x10 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        const double var_x113 = var_x112 * var_x12;
        const double var_x114 = var_x12 * var_x40;
        const double var_x115 = 0.16028256395817389 * var_x114 - var_x19 * (2.6713760659695653 * var_x12 * var_x22 + 0.01602825639581739 * var_x12 * var_x20) - 13.356880329847826 * var_x12 * var_x45;
        const double var_x116 = var_x114 * var_x41;
        const double var_x117 = 0.001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x118 = 1.0 + 0.00020000000000000001 / pow(var_x117, 2);
        const double var_x119 = 1 / var_x118;
        const double var_x120 = var_x119;
        const double var_x121 = 0.066691050963179718 * NV_Ith_S(mParameters, 0);
        const double var_x122 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
        const double var_x123 = NV_Ith_S(mParameters, 2) / (pow(var_x122, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
        const double var_x124 = -var_chaste_interface__calcium_dynamics__Ca_i + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x125 = NV_Ith_S(mParameters, 2) / var_x122;
        ...
        const double var_x130 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x131 = exp(-3.7142857142857144 - var_x130);
        const double var_x132 = 1.0 + var_x131;
        const double var_x133 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + 1 / var_x132;
        const double var_x134 = exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__membrane__V);
        const double var_x135 = 0.00037037037037037035 + 0.00037037037037037035 * var_x134;
        const double var_x136 = var_x129 * var_x135;
        const double var_x137 = 0.050000000000000003 * var_chaste_interface__membrane__V;
        const double var_x138 = -var_x137;
        const double var_x139 = exp(-3.0 + var_x138);
        const double var_x140 = 1.0 + var_x139;
        const double var_x141 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x142 = 1.0 + var_x141;
        const double var_x143 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 + 1 / var_x142;
        const double var_x144 = exp(-3.0 + var_x137);
        const double var_x145 = 0.29761904761904762 + 0.29761904761904762 * var_x144;
        const double var_x146 = var_x140 * var_x145;
        const double var_x147 = -0.16666666666666666 * var_chaste_interface__membrane__V;
        const double var_x148 = exp(0.83333333333333337 + var_x147);
        const double var_x149 = 1.0 + var_x148;
        const double var_x150 = 1 / sqrt(var_x149);
        const double var_x151 = exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x152 = 1.0 + var_x151;
        const double var_x153 = 1 / var_x152;
        const double var_x154 = var_x150 * var_x153;
        const double var_x155 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        const double var_x156 = 1.0 + var_x155;
        const double var_x157 = 1 / (80.0 + 1400.0 * var_x154);
        const double var_x158 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x159 = exp(7.0 + var_x158);
        const double var_x160 = 1.0 + var_x159;
        const double var_x161 = 1 / var_x160;
        const double var_x162 = exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V);
        const double var_x163 = 1.0 + var_x162;
        const double var_x164 = 1 / var_x163;
        const double var_x165 = 1 / (0.10000000000000001 * var_x161 + 0.10000000000000001 * var_x164);
        const double var_x166 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x167 = 1.0 + var_x166;
        const double var_x168 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1 / pow(var_x167, 2);
        const double var_x169 = exp(-12.0 - var_x158);
        const double var_x170 = 1.0 + var_x169;
        const double var_x171 = var_x165 * var_x170;
        const double var_x172 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 14) - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x173 = var_chaste_interface__membrane__V < -40.0 + NV_Ith_S(mParameters, 14);
        const double var_x174 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 14));
        const double var_x175 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x176 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 14) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x177 = 1.0 + var_x176;
        const double var_x178 = 0.01 * NV_Ith_S(mParameters, 13);
        const double var_x179 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 14));
        ...
        const double var_x183 = ((var_x173) ? (0.057000000000000002 * var_x172) : (0));
        const double var_x184 = ((var_x173) ? (310000.0 * var_x174 + 2.7000000000000002 * var_x175) : (5.9230769230769234 / var_x177));
        const double var_x185 = 0.26917900403768508 * var_x179 * var_x181 / pow(var_x180, 3);
        const double var_x186 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 14) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x187 = 1.0 + var_x186;
        const double var_x188 = exp(0.01052 * NV_Ith_S(mParameters, 14) - 0.01052 * var_chaste_interface__membrane__V);
        const double var_x189 = var_x188 / var_x187;
        const double var_x190 = exp(-3.2000000000000002 - var_x21 + 0.10000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x191 = 1.0 + var_x190;
        const double var_x192 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * NV_Ith_S(mParameters, 14));
        const double var_x193 = var_x192 / var_x191;
        const double var_x194 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x195 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 14) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x196 = -25428.0 * var_x194 - 6.9480000000000002e-6 * var_x195;
        const double var_x197 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 14));
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = 1 / var_x198;
        const double var_x200 = var_x196 * var_x199;
        const double var_x201 = 37.780000000000001 + var_chaste_interface__membrane__V;
        const double var_x202 = ((var_x173) ? (0.024240000000000001 * var_x189) : (0.59999999999999998 * var_x193));
        const double var_x203 = ((var_x173) ? (var_x200 * var_x201) : (0));
        const double var_x204 = exp(2.5 + var_x138);
        const double var_x205 = 1.0 + var_x204;
        const double var_x206 = 1 / var_x205;
        const double var_x207 = exp(1.0 + var_x158);
        const double var_x208 = 1.0 + var_x207;
        const double var_x209 = 1 / var_x208;
        const double var_x210 = exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V);
        const double var_x211 = 1.0 + var_x210;
        const double var_x212 = 0.25 + 1.3999999999999999 / var_x211;
        const double var_x213 = var_x209 * var_x212;
        const double var_x214 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x215 = 1.0 + var_x214;
        const double var_x216 = 1 / (var_x206 + 1.3999999999999999 * var_x213);
        const double var_x217 = exp(3.0 + var_x126);
        const double var_x218 = 1.0 + var_x217;
        const double var_x219 = 1 / var_x218;
        const double var_x220 = exp(1.3 + var_x127);
        const double var_x221 = 1.0 + var_x220;
        const double var_x222 = 1 / var_x221;
        const double var_x223 = pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2);
        const double var_x224 = exp(-3.2400000000000002 * var_x223);
        const double var_x225 = exp(2.8571428571428572 + var_x130);
        const double var_x226 = 1.0 + var_x225;
        const double var_x227 = var_x217 / pow(var_x218, 2);
        const double var_x228 = 1102.5 * var_x224;
        const double var_x229 = 1 / (20.0 + var_x228 + 200.0 * var_x222 + 180.0 * var_x219);
        const double var_x230 = exp(2.5 + var_x127);
        const double var_x231 = 1.0 + var_x230;
        const double var_x232 = 1 / var_x231;
        const double var_x233 = exp(-3.0375000000000001 * var_x223);
        const double var_x234 = exp(5.0 + var_x130);
        const double var_x235 = 1.0 + var_x234;
        const double var_x236 = 562.0 * var_x233;
        const double var_x237 = 1 / (var_x236 + 80.0 * var_x219 + 31.0 * var_x232);
        const double var_x238 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2);
        const double var_x239 = 1 / (1.0 + 399.99999999999994 * var_x238);
        const double var_x240 = 1 / (2.0 + 80.0 * var_x239);
        const double var_x241 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x238), 2);
        const double var_x242 = exp(-4.0 + var_x158);
        const double var_x243 = 1.0 + var_x242;
        const double var_x244 = 1 / var_x243;
        const double var_x245 = exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2));
        const double var_x246 = exp(4.0 + var_x158);
        const double var_x247 = 1.0 + var_x246;
        const double var_x248 = 85.0 * var_x245;
        const double var_x249 = 1 / (3.0 + var_x248 + 5.0 * var_x244);
        const double var_x250 = exp(3.3333333333333335 + var_x147);
        const double var_x251 = 1.0 + var_x250;
        const double var_x252 = exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_x253 = 1 / (0.80000000000000004 + 9.5 * var_x252);
        const double var_x254 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x255 = pow(var_x254, (-2));
        const double var_x256 = 1 / (1.0 + 3.0 * var_x255);
        const double var_x257 = var_x256;
        const double var_x258 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
        const double var_x259 = 1 / (1.0 + 2.25 * var_x258);
        const double var_x260 = 1 / (2.5 - 1.5 * var_x259);
        const double var_x261 = var_x238 * var_x260;
        const double var_x262 = 0.14999999999999999 * var_x261;
        const double var_x263 = 1 / (0.059999999999999998 + var_x262);
        const double var_x264 = var_chaste_interface__calcium_dynamics__R_prime * NV_Ith_S(mParameters, 1);
        const double var_x265 = var_x263 * var_x264;
        const double var_x266 = var_x262 * var_x265;
        const double var_x267 = 1 / (pow((0.44444444444444442 + var_x258), 2) * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3));
        const double var_x268 = -var_chaste_interface__calcium_dynamics__Ca_ss + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x269 = var_x268 / pow((1 - 0.59999999999999998 * var_x259), 2);
        const double var_x270 = var_x238 * var_x265 * var_x267 * var_x269;
        const double var_x271 = var_x264 * var_x269 / pow((0.40000000000000002 + var_x261), 2);
        const double var_x272 = var_x260 * var_x267 * var_x271 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4);
        const double var_x273 = var_x271 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3);
        const double var_x274 = var_chaste_interface__calcium_dynamics__Ca_ss * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x275 = var_x263 * var_x268 * NV_Ith_S(mParameters, 1);
        const double var_x276 = var_x260 * var_x274 * var_x275;
        const double var_x277 = 0.00025000000000000001 + var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x278 = 1.0 + 0.0001 / pow(var_x277, 2);
        const double var_x279 = 1 / var_x278;
        const double var_x280 = 1369.1986401882032 * NV_Ith_S(mParameters, 11);
        const double var_x281 = var_x279 * var_x280;
        const double var_x282 = var_x281 * var_x94;
        const double var_x283 = var_x281 * var_x96;
        const double var_x284 = 3.0010972933430868 * var_x261;
        const double var_x285 = var_x265 * var_x284;
        const double var_x286 = var_x279;
        const double var_x287 = -0.11249999999999999 + 0.067500000000000004 * var_x259;
        const double var_x288 = NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 3);
        const double var_x289 = 0.00063181349969740233 * var_x288;
        const double var_x290 = 2.7188924024856265e-5 * var_x48;
        const double var_x291 = 0.00027188924024856262 * var_x288;
        const double var_x292 = var_x28 * var_x289;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x2 - var_x3 - var_x39 - var_x5 - var_x76 - var_x8 - NV_Ith_S(mParameters, 8) - NV_Ith_S(mParameters, 9) + 0.0025819888974716113 * var_x42 - 0.0024332029034784559 * var_x44 - 0.043033148291193521 * var_x26 - 0.16722408026755853 * var_x29 - var_x11 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x46 * var_x49 - var_x67 * var_x70);
        IJth(rJacobian, 1, 0) = var_x120 * (0.00063181349969740233 * var_x39 + 1.5373304419206038e-6 * var_x44 - 0.00031590674984870116 * NV_Ith_S(mParameters, 8)) * NV_Ith_S(mParameters, 11);
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x129 * var_x133 * var_x134 + 0.14285714285714285 * var_x131 * var_x136 / pow(var_x132, 2) - 0.10000000000000001 * var_x128 * var_x133 * var_x135;
        IJth(rJacobian, 3, 0) = 0.01488095238095238 * var_x140 * var_x143 * var_x144 - 0.041666666666666664 * var_x141 * var_x146 / pow(var_x142, 2) - 0.050000000000000003 * var_x139 * var_x143 * var_x145;
        IJth(rJacobian, 4, 0) = 5.1020408163265302e-7 * (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1 / var_x156) * (93.333333333333329 * var_x150 * var_x151 / pow(var_x152, 2) - 116.66666666666667 * var_x148 * var_x153 / pow(var_x149, (3 / 2))) / pow((0.057142857142857141 + var_x154), 2) + 0.071428571428571425 * var_x155 * var_x157 / pow(var_x156, 2);
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x166 * var_x171 / pow(var_x167, 3) - 0.20000000000000001 * var_x165 * var_x168 * var_x169 + 99.999999999999986 * var_x168 * var_x170 * (0.02 * var_x159 / pow(var_x160, 2) + 0.00050000000000000001 * var_x162 / pow(var_x163, 2)) / pow((var_x161 + var_x164), 2);
        IJth(rJacobian, 6, 0) = (var_x182 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x173) ? (-0.008382352941176471 * var_x172) : (0)) + ((var_x173) ? (108035.0 * var_x174 + 0.21330000000000002 * var_x175) : (0.53361053361053368 * var_x176 / pow(var_x177, 2)))) - var_x185 * (var_x183 + var_x184);
        IJth(rJacobian, 7, 0) = (var_x182 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x173) ? (-0.00025500480000000003 * var_x189 + 0.0033402720000000005 * var_x186 * var_x188 / pow(var_x187, 2)) : (0.034200000000000001 * var_x193 + 0.059999999999999998 * var_x190 * var_x192 / pow(var_x191, 2))) + ((var_x173) ? (var_x200 + var_x199 * var_x201 * (3.0508668000000001e-7 * var_x195 - 6214.6032000000005 * var_x194) - 0.311 * var_x196 * var_x197 * var_x201 / pow(var_x198, 2)) : (0))) - var_x185 * (var_x202 + var_x203);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x215) * (-0.050000000000000003 * var_x204 / pow(var_x205, 2) + 0.27999999999999997 * var_x207 * var_x212 / pow(var_x208, 2) - 0.15076923076923074 * var_x209 * var_x210 / pow(var_x211, 2)) / pow((var_x213 + 0.7142857142857143 * var_x206), 2) + 0.13333333333333333 * var_x214 * var_x216 / pow(var_x215, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x226) * (18.0 * var_x227 - var_x228 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x220 / pow(var_x221, 2)) / pow((0.018140589569160998 + var_x224 + 0.16326530612244897 * var_x219 + 0.18140589569160998 * var_x222), 2) - 0.14285714285714285 * var_x225 * var_x229 / pow(var_x226, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x235) * (8.0 * var_x227 - var_x236 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x230 / pow(var_x231, 2)) / pow((var_x233 + 0.055160142348754451 * var_x232 + 0.14234875444839859 * var_x219), 2) - 0.095714285714285724 * var_x234 * var_x237 / pow(var_x235, 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x247) * (-var_x248 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + var_x242 / pow(var_x243, 2)) / pow((0.035294117647058823 + var_x245 + 0.058823529411764705 * var_x244), 2) - 0.20000000000000001 * var_x246 * var_x249 / pow(var_x247, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x250 * var_x253 / pow(var_x251, 2) - 0.10526315789473684 * var_x252 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x251) / pow((0.084210526315789472 + var_x252), 2);
        IJth(rJacobian, 15, 0) = -var_x281 * var_x67 * var_x69;
        IJth(rJacobian, 17, 0) = var_x288 * (-0.0018954404990922068 * var_x39 - 0.0018954404990922068 * var_x76 - 4.6119913257618111e-6 * var_x44 - 0.00063181349969740233 * var_x8 - 0.00063181349969740233 * NV_Ith_S(mParameters, 9));
        IJth(rJacobian, 18, 0) = var_x288 * (0.0012636269993948047 * var_x76 + 1.631335441491376e-6 * var_x42 - 0.00027188924024856262 * var_x112 - 2.7188924024856265e-5 * var_x26 - 0.00010565443138752546 * var_x29 - 0.00063181349969740233 * var_x2 - 0.00063181349969740233 * var_x3 - 0.00063181349969740233 * var_x5 - var_x290 * var_x46);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x81 - var_x78 + 2.5 * var_x82 - 13.356880329847826 * var_x80);
        IJth(rJacobian, 1, 1) = var_x120 * (-0.0038 - var_x121 - 8.3363813703974642e-9 * var_x123 + (0.00031590674984870116 * var_x81 - 0.0042195286531202733 * var_x80 - 0.0015795337492435057 * var_x82 - 0.00031590674984870116 * var_x78) * NV_Ith_S(mParameters, 11)) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss - 0.0038 * var_chaste_interface__calcium_dynamics__Ca_i - 0.066691050963179718 * var_x125 + var_x121 * var_x124 - 0.00031590674984870116 * (var_x78 * var_chaste_interface__calcium_dynamics__Ca_i + (-13.356880329847826 * log(var_x79 * NV_Ith_S(mParameters, 4)) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 8) - 2.0 * var_x38 * var_x43) * NV_Ith_S(mParameters, 11)) / (pow(var_x117, 3) * pow(var_x118, 2));
        IJth(rJacobian, 14, 1) = var_x257 * (1.2499999999999999e-7 * var_x123 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 15, 1) = 1.1399999999999999 * var_x279;
        IJth(rJacobian, 17, 1) = 0.0047386012477305169 * var_x288 * var_x82;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x28);
        IJth(rJacobian, 2, 2) = -var_x136;
        IJth(rJacobian, 18, 2) = -var_x10 * var_x28 * var_x291;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.43033148291193518 * var_x83);
        IJth(rJacobian, 3, 3) = -var_x146;
        IJth(rJacobian, 18, 3) = -var_x291 * var_x83;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-2 * var_x85);
        IJth(rJacobian, 4, 4) = -var_x157;
        IJth(rJacobian, 18, 4) = -0.0012636269993948047 * var_x288 * var_x85;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x89);
        IJth(rJacobian, 5, 5) = -var_x171;
        IJth(rJacobian, 17, 5) = -0.0018954404990922068 * var_x288 * var_x89;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x90);
        IJth(rJacobian, 6, 6) = -var_x183 - var_x184;
        IJth(rJacobian, 17, 6) = -var_x289 * var_x90;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x91);
        IJth(rJacobian, 7, 7) = -var_x202 - var_x203;
        IJth(rJacobian, 17, 7) = -var_x289 * var_x91;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 8, 8) = -var_x216;
        IJth(rJacobian, 15, 8) = -var_x282 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 9, 9) = -var_x229;
        IJth(rJacobian, 15, 9) = -var_x282 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x97 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass);
        IJth(rJacobian, 10, 10) = -var_x237;
        IJth(rJacobian, 15, 10) = -var_x283 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x97 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 11, 11) = -var_x240;
        IJth(rJacobian, 15, 11) = -var_x283 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x4 * var_x98);
        IJth(rJacobian, 12, 12) = -var_x249;
        IJth(rJacobian, 18, 12) = -var_x292 * var_x4;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x98 * var_x99);
        IJth(rJacobian, 13, 13) = -var_x253;
        IJth(rJacobian, 18, 13) = -var_x292 * var_x99;
        IJth(rJacobian, 1, 14) = var_x119 * var_x121;
        IJth(rJacobian, 14, 14) = var_x257 * (-var_x266 - NV_Ith_S(mParameters, 0) + 0.21333333333333335 * var_x272 - 0.032000000000000001 * var_x270) + 0.66666666666666674 * (var_x125 - var_x124 * NV_Ith_S(mParameters, 0) - var_x266 * var_x268) / (pow(var_x254, 3) * pow((0.33333333333333337 + var_x255), 2));
        IJth(rJacobian, 15, 14) = var_x286 * (var_x285 + 0.64023408924652514 * var_x270 - 4.2682272616435011 * var_x272);
        IJth(rJacobian, 16, 14) = 0.059999999999999998 * var_x267 * var_x274;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x101 * var_x70);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x119;
        IJth(rJacobian, 11, 15) = -0.0030000000000000001 * var_x240 * var_x241 + 6.2500000000000001e-5 * var_x241 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x239) / pow((0.025000000000000001 + var_x239), 2);
        IJth(rJacobian, 14, 15) = var_x257 * (var_x266 + 0.32000000000000001 * var_x273 - 0.29999999999999999 * var_x276);
        IJth(rJacobian, 15, 15) = var_x286 * (-1.1399999999999999 - var_x285 + 6.0021945866861737 * var_x276 - 6.4023408924652525 * var_x273 - var_x101 * var_x280 * var_x69) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x268 * var_x285 - var_x280 * var_x68 * var_x94) / (pow(var_x277, 3) * pow(var_x278, 2));
        IJth(rJacobian, 16, 15) = var_x287 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -var_x256 * var_x262 * var_x275;
        IJth(rJacobian, 15, 16) = var_x275 * var_x279 * var_x284;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x287 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x105 - 3 * var_x108 + 0.00062500000000000001 * var_x107 - 26.713760659695652 * var_x102 - 26.713760659695652 * var_x106 - 0.80141281979086942 * var_x103);
        IJth(rJacobian, 1, 17) = 0.0018954404990922068 * var_x108 * var_x119 * NV_Ith_S(mParameters, 11);
        IJth(rJacobian, 17, 17) = var_x288 * (1.1846503119326294e-6 * var_x107 - 0.0018954404990922068 * var_x105 - 0.016878114612481093 * var_x102 - 0.016878114612481093 * var_x106 - 0.0056863214972766203 * var_x108);
        IJth(rJacobian, 18, 17) = var_x288 * (0.0012636269993948047 * var_x105 - 0.00050634343837443281 * var_x103 - 7.8976687462175284e-7 * var_x107);
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (0.068974633433048077 * var_x116 - 26.713760659695652 * var_x103 - 26.713760659695652 * var_x109 - 26.713760659695652 * var_x110 - 1.1495772238841346 * var_x111 - 11.495772238841345 * var_x113 - var_x115 * var_x49);
        IJth(rJacobian, 18, 18) = var_x288 * (4.357910453967955e-5 * var_x116 - 0.016878114612481093 * var_x103 - 0.016878114612481093 * var_x109 - 0.016878114612481093 * var_x110 - 0.00072631840899465921 * var_x111 - 0.0072631840899465916 * var_x113 - var_x115 * var_x290);
    }

    N_Vector Cellten_tusscher_model_2006_MFromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2006_MFromCellMLCvode>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellten_tusscher_model_2006_MFromCellMLCvode)
