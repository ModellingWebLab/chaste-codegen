...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_MFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x50 = exp(-0.037433890822745473 * var_chaste_interface__membrane__V);
        const double var_x51 = exp(-0.0037433890822745472 * var_chaste_interface__membrane__V);
        const double var_x52 = 1.0 + 0.035299999999999998 * var_x50 + 0.1245 * var_x51;
        const double var_x53 = 1 / (1.0 + NV_Ith_S(mParameters, 5));
        const double var_x54 = var_x53 * NV_Ith_S(mParameters, 5) * NV_Ith_S(mParameters, 20) / (40.0 + var_chaste_interface__sodium_dynamics__Na_i);
        const double var_x55 = var_x54 * (0.001321416346042915 * var_x50 + 0.00046605194074318115 * var_x51) * var_chaste_interface__sodium_dynamics__Na_i / pow(var_x52, 2);
        const double var_x56 = exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x57 = -1.0 + var_x56;
        const double var_x58 = 1 / var_x57;
        const double var_x59 = var_x58 * NV_Ith_S(mParameters, 7) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x60 = var_x56 * var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x61 = -NV_Ith_S(mParameters, 4) + 0.25 * var_x60;
        const double var_x62 = 14447.286958825251 * var_x61;
        const double var_x63 = -15.0 + var_chaste_interface__membrane__V;
        const double var_x64 = var_x63 * NV_Ith_S(mParameters, 7) * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f;
        ...
        const double var_x69 = NV_Ith_S(mParameters, 10) / var_x68;
        const double var_x70 = 1 / var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x71 = var_x70 * NV_Ith_S(mParameters, 8);
        const double var_x72 = var_chaste_interface__calcium_dynamics__Ca_i * NV_Ith_S(mParameters, 10) / pow(var_x68, 2);
        const double var_x73 = var_x32 * var_x38;
        const double var_x74 = var_x47 * NV_Ith_S(mParameters, 17) * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        const double var_x76 = (-26.713760659695652 * log(var_x75 * (0.029999999999999999 * NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 5))) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 18) * var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs;
        const double var_x77 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        const double var_x78 = -26.713760659695652 * log(var_x77 * NV_Ith_S(mParameters, 6)) + var_chaste_interface__membrane__V;
        const double var_x79 = var_x78 * NV_Ith_S(mParameters, 12) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x80 = var_x79 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x81 = var_x7 * var_x78;
        const double var_x82 = var_x6 * var_x79;
        const double var_x83 = var_x58 * var_x62;
        const double var_x84 = var_x63 * NV_Ith_S(mParameters, 7) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x85 = var_x83 * var_x84;
        const double var_x86 = var_x63 * NV_Ith_S(mParameters, 7) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x87 = var_x27 - var_chaste_interface__membrane__V;
        const double var_x88 = NV_Ith_S(mParameters, 21) * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x89 = var_x56 * var_x66;
        const double var_x90 = var_x77 * NV_Ith_S(mParameters, 9);
        const double var_x91 = var_x3 * var_x75;
        const double var_x92 = 1 / var_x52;
        const double var_x93 = var_x54 * var_x92;
        const double var_x94 = var_x77 * var_x8;
        const double var_x95 = var_x53 * var_x92 * NV_Ith_S(mParameters, 5) * var_chaste_interface__sodium_dynamics__Na_i * NV_Ith_S(mParameters, 20) / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        const double var_x96 = var_x34 * var_x38 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2);
        const double var_x97 = var_x12 * var_x2;
        const double var_x98 = var_x12 * var_x5;
        const double var_x99 = var_x12 * var_x26;
        const double var_x100 = var_x10 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        const double var_x101 = var_x100 * var_x12;
        const double var_x102 = var_x12 * var_x40;
        const double var_x103 = 0.16028256395817389 * var_x102 - var_x19 * (2.6713760659695653 * var_x12 * var_x22 + 0.01602825639581739 * var_x12 * var_x20) - 13.356880329847826 * var_x12 * var_x45;
        const double var_x104 = var_x102 * var_x41;
        const double var_x105 = 0.001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x106 = 1.0 + 0.00020000000000000001 / pow(var_x105, 2);
        const double var_x107 = 1 / var_x106;
        const double var_x108 = var_x107;
        const double var_x109 = 0.066691050963179718 * NV_Ith_S(mParameters, 0);
        const double var_x110 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
        const double var_x111 = NV_Ith_S(mParameters, 2) / (pow(var_x110, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
        const double var_x112 = -var_chaste_interface__calcium_dynamics__Ca_i + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x113 = NV_Ith_S(mParameters, 2) / var_x110;
        const double var_x114 = 0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x115 = -var_x114;
        const double var_x116 = exp(-4.5 + var_x115);
        const double var_x117 = 1.0 + var_x116;
        const double var_x118 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x119 = exp(-3.7142857142857144 - var_x118);
        const double var_x120 = 1.0 + var_x119;
        const double var_x121 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + 1 / var_x120;
        const double var_x122 = exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__membrane__V);
        const double var_x123 = 0.00037037037037037035 + 0.00037037037037037035 * var_x122;
        const double var_x124 = var_x117 * var_x123;
        const double var_x125 = 0.050000000000000003 * var_chaste_interface__membrane__V;
        const double var_x126 = -var_x125;
        const double var_x127 = exp(-3.0 + var_x126);
        const double var_x128 = 1.0 + var_x127;
        const double var_x129 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x130 = 1.0 + var_x129;
        const double var_x131 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 + 1 / var_x130;
        const double var_x132 = exp(-3.0 + var_x125);
        const double var_x133 = 0.29761904761904762 + 0.29761904761904762 * var_x132;
        const double var_x134 = var_x128 * var_x133;
        const double var_x135 = -0.16666666666666666 * var_chaste_interface__membrane__V;
        const double var_x136 = exp(0.83333333333333337 + var_x135);
        const double var_x137 = 1.0 + var_x136;
        const double var_x138 = 1 / sqrt(var_x137);
        const double var_x139 = exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x140 = 1.0 + var_x139;
        const double var_x141 = 1 / var_x140;
        const double var_x142 = var_x138 * var_x141;
        const double var_x143 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        const double var_x144 = 1.0 + var_x143;
        const double var_x145 = 1 / (80.0 + 1400.0 * var_x142);
        const double var_x146 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x147 = exp(7.0 + var_x146);
        const double var_x148 = 1.0 + var_x147;
        const double var_x149 = 1 / var_x148;
        const double var_x150 = exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V);
        ...
        const double var_x154 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x155 = 1.0 + var_x154;
        const double var_x156 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1 / pow(var_x155, 2);
        const double var_x157 = exp(-12.0 - var_x146);
        const double var_x158 = 1.0 + var_x157;
        const double var_x159 = var_x153 * var_x158;
        const double var_x160 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 14) - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x161 = var_chaste_interface__membrane__V < -40.0 + NV_Ith_S(mParameters, 14);
        const double var_x162 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 14));
        const double var_x163 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x164 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 14) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x165 = 1.0 + var_x164;
        const double var_x166 = 0.01 * NV_Ith_S(mParameters, 13);
        const double var_x167 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 14));
        const double var_x168 = 1.0 + var_x167;
        const double var_x169 = 1.0 - var_x166;
        const double var_x170 = var_x166 + var_x169 / pow(var_x168, 2);
        const double var_x171 = ((var_x161) ? (0.057000000000000002 * var_x160) : (0));
        const double var_x172 = ((var_x161) ? (310000.0 * var_x162 + 2.7000000000000002 * var_x163) : (5.9230769230769234 / var_x165));
        const double var_x173 = 0.26917900403768508 * var_x167 * var_x169 / pow(var_x168, 3);
        const double var_x174 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 14) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x175 = 1.0 + var_x174;
        const double var_x176 = exp(0.01052 * NV_Ith_S(mParameters, 14) - 0.01052 * var_chaste_interface__membrane__V);
        const double var_x177 = var_x176 / var_x175;
        const double var_x178 = exp(-3.2000000000000002 - var_x21 + 0.10000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x179 = 1.0 + var_x178;
        const double var_x180 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * NV_Ith_S(mParameters, 14));
        const double var_x181 = var_x180 / var_x179;
        const double var_x182 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x183 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 14) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x184 = -25428.0 * var_x182 - 6.9480000000000002e-6 * var_x183;
        const double var_x185 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 14));
        ...
        const double var_x190 = ((var_x161) ? (0.024240000000000001 * var_x177) : (0.59999999999999998 * var_x181));
        const double var_x191 = ((var_x161) ? (var_x188 * var_x189) : (0));
        const double var_x192 = exp(2.5 + var_x126);
        const double var_x193 = 1.0 + var_x192;
        const double var_x194 = 1 / var_x193;
        const double var_x195 = exp(1.0 + var_x146);
        const double var_x196 = 1.0 + var_x195;
        const double var_x197 = 1 / var_x196;
        const double var_x198 = exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V);
        ...
        const double var_x202 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x203 = 1.0 + var_x202;
        const double var_x204 = 1 / (var_x194 + 1.3999999999999999 * var_x201);
        const double var_x205 = exp(3.0 + var_x114);
        const double var_x206 = 1.0 + var_x205;
        const double var_x207 = 1 / var_x206;
        const double var_x208 = exp(1.3 + var_x115);
        const double var_x209 = 1.0 + var_x208;
        const double var_x210 = 1 / var_x209;
        const double var_x211 = pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2);
        const double var_x212 = exp(-3.2400000000000002 * var_x211);
        const double var_x213 = exp(2.8571428571428572 + var_x118);
        const double var_x214 = 1.0 + var_x213;
        const double var_x215 = var_x205 / pow(var_x206, 2);
        const double var_x216 = 1102.5 * var_x212;
        const double var_x217 = 1 / (20.0 + var_x216 + 200.0 * var_x210 + 180.0 * var_x207);
        const double var_x218 = exp(2.5 + var_x115);
        const double var_x219 = 1.0 + var_x218;
        const double var_x220 = 1 / var_x219;
        const double var_x221 = exp(-3.0375000000000001 * var_x211);
        const double var_x222 = exp(5.0 + var_x118);
        const double var_x223 = 1.0 + var_x222;
        const double var_x224 = 562.0 * var_x221;
        const double var_x225 = 1 / (var_x224 + 80.0 * var_x207 + 31.0 * var_x220);
        const double var_x226 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2);
        const double var_x227 = 1 / (1.0 + 399.99999999999994 * var_x226);
        const double var_x228 = 1 / (2.0 + 80.0 * var_x227);
        const double var_x229 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x226), 2);
        const double var_x230 = exp(-4.0 + var_x146);
        const double var_x231 = 1.0 + var_x230;
        const double var_x232 = 1 / var_x231;
        const double var_x233 = exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2));
        const double var_x234 = exp(4.0 + var_x146);
        const double var_x235 = 1.0 + var_x234;
        const double var_x236 = 85.0 * var_x233;
        const double var_x237 = 1 / (3.0 + var_x236 + 5.0 * var_x232);
        const double var_x238 = exp(3.3333333333333335 + var_x135);
        ...
        const double var_x249 = var_x226 * var_x248;
        const double var_x250 = 0.14999999999999999 * var_x249;
        const double var_x251 = 1 / (0.059999999999999998 + var_x250);
        const double var_x252 = var_chaste_interface__calcium_dynamics__R_prime * NV_Ith_S(mParameters, 1);
        ...
        const double var_x258 = var_x226 * var_x253 * var_x255 * var_x257;
        ...
        const double var_x263 = var_x251 * var_x256 * NV_Ith_S(mParameters, 1);
        const double var_x264 = var_x248 * var_x262 * var_x263;
        const double var_x265 = var_x61 * NV_Ith_S(mParameters, 11);
        ...
        const double var_x271 = var_x266 * var_x269 * var_x58;
        const double var_x272 = var_x271 * var_x84;
        ...
        const double var_x276 = NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 3);
        const double var_x277 = 0.00063181349969740233 * var_x276;
        const double var_x278 = 2.7188924024856265e-5 * var_x48;
        const double var_x279 = 0.00027188924024856262 * var_x276;
        const double var_x280 = var_x277 * var_x28;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x2 - var_x3 - var_x39 - var_x5 - var_x55 - var_x8 - NV_Ith_S(mParameters, 8) - NV_Ith_S(mParameters, 9) + 0.0025819888974716113 * var_x42 - 0.0024332029034784559 * var_x44 - 270.40908135076944 * var_x67 - 0.043033148291193521 * var_x26 - 0.16722408026755853 * var_x29 - var_x11 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x46 * var_x49 - var_x59 * var_x62 + 1081.6363254030778 * var_x61 * var_x65);
        IJth(rJacobian, 1, 0) = var_x108 * (0.00063181349969740233 * var_x39 + 1.5373304419206038e-6 * var_x44 - 0.00031590674984870116 * NV_Ith_S(mParameters, 8)) * NV_Ith_S(mParameters, 11);
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x117 * var_x121 * var_x122 + 0.14285714285714285 * var_x119 * var_x124 / pow(var_x120, 2) - 0.10000000000000001 * var_x116 * var_x121 * var_x123;
        IJth(rJacobian, 3, 0) = 0.01488095238095238 * var_x128 * var_x131 * var_x132 - 0.041666666666666664 * var_x129 * var_x134 / pow(var_x130, 2) - 0.050000000000000003 * var_x127 * var_x131 * var_x133;
        IJth(rJacobian, 4, 0) = 5.1020408163265302e-7 * (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1 / var_x144) * (93.333333333333329 * var_x138 * var_x139 / pow(var_x140, 2) - 116.66666666666667 * var_x136 * var_x141 / pow(var_x137, (3 / 2))) / pow((0.057142857142857141 + var_x142), 2) + 0.071428571428571425 * var_x143 * var_x145 / pow(var_x144, 2);
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x154 * var_x159 / pow(var_x155, 3) - 0.20000000000000001 * var_x153 * var_x156 * var_x157 + 99.999999999999986 * var_x156 * var_x158 * (0.02 * var_x147 / pow(var_x148, 2) + 0.00050000000000000001 * var_x150 / pow(var_x151, 2)) / pow((var_x149 + var_x152), 2);
        IJth(rJacobian, 6, 0) = (var_x170 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x161) ? (-0.008382352941176471 * var_x160) : (0)) + ((var_x161) ? (108035.0 * var_x162 + 0.21330000000000002 * var_x163) : (0.53361053361053368 * var_x164 / pow(var_x165, 2)))) - var_x173 * (var_x171 + var_x172);
        IJth(rJacobian, 7, 0) = (var_x170 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x161) ? (-0.00025500480000000003 * var_x177 + 0.0033402720000000005 * var_x174 * var_x176 / pow(var_x175, 2)) : (0.034200000000000001 * var_x181 + 0.059999999999999998 * var_x178 * var_x180 / pow(var_x179, 2))) + ((var_x161) ? (var_x188 + var_x187 * var_x189 * (3.0508668000000001e-7 * var_x183 - 6214.6032000000005 * var_x182) - 0.311 * var_x184 * var_x185 * var_x189 / pow(var_x186, 2)) : (0))) - var_x173 * (var_x190 + var_x191);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x203) * (-0.050000000000000003 * var_x192 / pow(var_x193, 2) + 0.27999999999999997 * var_x195 * var_x200 / pow(var_x196, 2) - 0.15076923076923074 * var_x197 * var_x198 / pow(var_x199, 2)) / pow((var_x201 + 0.7142857142857143 * var_x194), 2) + 0.13333333333333333 * var_x202 * var_x204 / pow(var_x203, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x214) * (18.0 * var_x215 - var_x216 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x208 / pow(var_x209, 2)) / pow((0.018140589569160998 + var_x212 + 0.16326530612244897 * var_x207 + 0.18140589569160998 * var_x210), 2) - 0.14285714285714285 * var_x213 * var_x217 / pow(var_x214, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x223) * (8.0 * var_x215 - var_x224 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x218 / pow(var_x219, 2)) / pow((var_x221 + 0.055160142348754451 * var_x220 + 0.14234875444839859 * var_x207), 2) - 0.095714285714285724 * var_x222 * var_x225 / pow(var_x223, 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x235) * (-var_x236 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + var_x230 / pow(var_x231, 2)) / pow((0.035294117647058823 + var_x233 + 0.058823529411764705 * var_x232), 2) - 0.20000000000000001 * var_x234 * var_x237 / pow(var_x235, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x238 * var_x241 / pow(var_x239, 2) - 0.10526315789473684 * var_x240 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x239) / pow((0.084210526315789472 + var_x240), 2);
        IJth(rJacobian, 15, 0) = var_x270 * (-var_x266 * var_x59 + 102.50886482291351 * var_x265 * var_x65 - 25.627216205728377 * var_x67 * NV_Ith_S(mParameters, 11));
        IJth(rJacobian, 17, 0) = var_x276 * (-0.0018954404990922068 * var_x39 - 0.0018954404990922068 * var_x55 - 4.6119913257618111e-6 * var_x44 - 0.00063181349969740233 * var_x8 - 0.00063181349969740233 * NV_Ith_S(mParameters, 9));
        IJth(rJacobian, 18, 0) = var_x276 * (0.0012636269993948047 * var_x55 + 1.631335441491376e-6 * var_x42 - 0.00027188924024856262 * var_x100 - 2.7188924024856265e-5 * var_x26 - 0.00010565443138752546 * var_x29 - 0.00063181349969740233 * var_x2 - 0.00063181349969740233 * var_x3 - 0.00063181349969740233 * var_x5 - var_x278 * var_x46);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x72 - var_x69 + 2.5 * var_x73 - 13.356880329847826 * var_x71);
        IJth(rJacobian, 1, 1) = var_x108 * (-0.0038 - var_x109 - 8.3363813703974642e-9 * var_x111 + (0.00031590674984870116 * var_x72 - 0.0042195286531202733 * var_x71 - 0.0015795337492435057 * var_x73 - 0.00031590674984870116 * var_x69) * NV_Ith_S(mParameters, 11)) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss - 0.0038 * var_chaste_interface__calcium_dynamics__Ca_i - 0.066691050963179718 * var_x113 + var_x109 * var_x112 - 0.00031590674984870116 * (var_x69 * var_chaste_interface__calcium_dynamics__Ca_i + (-13.356880329847826 * log(var_x70 * NV_Ith_S(mParameters, 4)) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 8) - 2.0 * var_x38 * var_x43) * NV_Ith_S(mParameters, 11)) / (pow(var_x105, 3) * pow(var_x106, 2));
        IJth(rJacobian, 14, 1) = var_x245 * (1.2499999999999999e-7 * var_x111 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 15, 1) = 1.1399999999999999 * var_x269;
        IJth(rJacobian, 17, 1) = 0.0047386012477305169 * var_x276 * var_x73;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x28);
        IJth(rJacobian, 2, 2) = -var_x124;
        IJth(rJacobian, 18, 2) = -var_x10 * var_x279 * var_x28;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.43033148291193518 * var_x74);
        IJth(rJacobian, 3, 3) = -var_x134;
        IJth(rJacobian, 18, 3) = -var_x279 * var_x74;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-2 * var_x76);
        IJth(rJacobian, 4, 4) = -var_x145;
        IJth(rJacobian, 18, 4) = -0.0012636269993948047 * var_x276 * var_x76;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x80);
        IJth(rJacobian, 5, 5) = -var_x159;
        IJth(rJacobian, 17, 5) = -0.0018954404990922068 * var_x276 * var_x80;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x81);
        IJth(rJacobian, 6, 6) = -var_x171 - var_x172;
        IJth(rJacobian, 17, 6) = -var_x277 * var_x81;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x82);
        IJth(rJacobian, 7, 7) = -var_x190 - var_x191;
        IJth(rJacobian, 17, 7) = -var_x277 * var_x82;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * var_x83);
        IJth(rJacobian, 8, 8) = -var_x204;
        IJth(rJacobian, 15, 8) = -var_x271 * var_x64;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x85 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 9, 9) = -var_x217;
        IJth(rJacobian, 15, 9) = -var_x272 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x85 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 10, 10) = -var_x225;
        IJth(rJacobian, 15, 10) = -var_x272 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x83 * var_x86);
        IJth(rJacobian, 11, 11) = -var_x228;
        IJth(rJacobian, 15, 11) = -var_x271 * var_x86;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x4 * var_x87);
        IJth(rJacobian, 12, 12) = -var_x237;
        IJth(rJacobian, 18, 12) = -var_x280 * var_x4;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x87 * var_x88);
        IJth(rJacobian, 13, 13) = -var_x241;
        IJth(rJacobian, 18, 13) = -var_x280 * var_x88;
        IJth(rJacobian, 1, 14) = var_x107 * var_x109;
        IJth(rJacobian, 14, 14) = var_x245 * (-var_x254 - NV_Ith_S(mParameters, 0) + 0.21333333333333335 * var_x260 - 0.032000000000000001 * var_x258) + 0.66666666666666674 * (var_x113 - var_x112 * NV_Ith_S(mParameters, 0) - var_x254 * var_x256) / (pow(var_x242, 3) * pow((0.33333333333333337 + var_x243), 2));
        IJth(rJacobian, 15, 14) = var_x270 * (var_x274 + 0.64023408924652514 * var_x258 - 4.2682272616435011 * var_x260);
        IJth(rJacobian, 16, 14) = 0.059999999999999998 * var_x255 * var_x262;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-3611.8217397063127 * var_x89);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x107;
        IJth(rJacobian, 11, 15) = -0.0030000000000000001 * var_x228 * var_x229 + 6.2500000000000001e-5 * var_x229 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x227) / pow((0.025000000000000001 + var_x227), 2);
        IJth(rJacobian, 14, 15) = var_x245 * (var_x254 + 0.32000000000000001 * var_x261 - 0.29999999999999999 * var_x264);
        IJth(rJacobian, 15, 15) = var_x270 * (-1.1399999999999999 - var_x274 + 6.0021945866861737 * var_x264 - 6.4023408924652525 * var_x261 - 342.29966004705079 * var_x89 * NV_Ith_S(mParameters, 11)) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x256 * var_x274 - var_x266 * var_x66) / (pow(var_x267, 3) * pow(var_x268, 2));
        IJth(rJacobian, 16, 15) = var_x275 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -var_x244 * var_x250 * var_x263;
        IJth(rJacobian, 15, 16) = var_x263 * var_x269 * var_x273;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x275 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x93 - 3 * var_x96 + 0.00062500000000000001 * var_x95 - 26.713760659695652 * var_x90 - 26.713760659695652 * var_x94 - 0.80141281979086942 * var_x91);
        IJth(rJacobian, 1, 17) = 0.0018954404990922068 * var_x107 * var_x96 * NV_Ith_S(mParameters, 11);
        IJth(rJacobian, 17, 17) = var_x276 * (1.1846503119326294e-6 * var_x95 - 0.0018954404990922068 * var_x93 - 0.016878114612481093 * var_x90 - 0.016878114612481093 * var_x94 - 0.0056863214972766203 * var_x96);
        IJth(rJacobian, 18, 17) = var_x276 * (0.0012636269993948047 * var_x93 - 0.00050634343837443281 * var_x91 - 7.8976687462175284e-7 * var_x95);
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (0.068974633433048077 * var_x104 - 26.713760659695652 * var_x91 - 26.713760659695652 * var_x97 - 26.713760659695652 * var_x98 - 1.1495772238841346 * var_x99 - 11.495772238841345 * var_x101 - var_x103 * var_x49);
        IJth(rJacobian, 18, 18) = var_x276 * (4.357910453967955e-5 * var_x104 - 0.016878114612481093 * var_x91 - 0.016878114612481093 * var_x97 - 0.016878114612481093 * var_x98 - 0.00072631840899465921 * var_x99 - 0.0072631840899465916 * var_x101 - var_x103 * var_x278);
    }
