...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_MFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x92 = 1.3356880329828957e-6 * var_x57;
        const double var_x93 = ((var_x59) ? (-var_x92 + 374338.90822798351 * (-14.999998664311967 + var_chaste_interface__membrane__V) * (var_x92 + 1.3356880329828957e-6 * var_x54)) : (var_x58 * var_x64));
        ...
        const double var_x100 = 3.3392200824572393e-7 * var_x55 * var_x56;
        const double var_x101 = ((var_x59) ? (-var_x100 + (-5615083.1234197523 + 374338.90822798351 * var_chaste_interface__membrane__V) * (var_x100 + 3.3392200824572393e-7 * var_x50 * var_x51)) : (0.25 * var_x66));
