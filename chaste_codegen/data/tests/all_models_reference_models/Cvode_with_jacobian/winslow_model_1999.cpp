...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellwinslow_model_1999FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 2, 0) = 0.001 * ((var_x148) ? (var_x147 + var_x143 * (159.99999943156581 * var_x144 + 160.00000056843419 * var_x145)) : ((var_x154) ? (var_x147 + var_x143 * var_x152 - 32.0 * var_x143 * var_x150 * var_x153 / pow(var_x151, 2)) : (0)));
        ...
        IJth(rJacobian, 6, 0) = (0.001 / var_x205 - 0.001 * var_chaste_interface__slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks) * ((var_x211) ? (0.035949999999999996 * var_x206 + 0.035949999999999996 * var_x207 + 0.065500000000000003 * var_x208 + 0.065500000000000003 * var_x209) : (var_x214 + var_x217 - 0.0089997000000000011 * var_x210 * var_x212 / pow(var_x213, 2) - 0.0106412 * var_x210 * var_x215 / pow(var_x216, 2))) + 7.3529411764705889e-5 * var_x204 * var_x218 / pow(var_x205, 2);
        ...
        IJth(rJacobian, 2, 2) = 0.001 * ((var_x148) ? (var_x155 + var_x156 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x155 + 0.00031999999919207767 * var_x144)) : ((var_x154) ? (var_x156 - var_x152 * var_x153) : (0)));
