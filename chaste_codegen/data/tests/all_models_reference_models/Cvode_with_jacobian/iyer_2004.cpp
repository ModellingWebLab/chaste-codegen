...
#include "MathsCustomFunctions.hpp"
    ...
    double Celliyer_2004FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_COMPUTE_ICa_ICaK__a1_K = -NV_Ith_S(mParameters, 4) + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki * exp(var_COMPUTE_ICa_ICaK__VF_over_RT); // mM
    ...
    void Celliyer_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        double var_chaste_interface__IKs__O2ks = NV_Ith_S(rY, 66);
        // Units: dimensionless; Initial value: 1.298547822e-05
        const double var_x0 = var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 * NV_Ith_S(mParameters, 8);
        const double var_x1 = sqrt(NV_Ith_S(mParameters, 4));
        const double var_x2 = var_x1 * NV_Ith_S(mParameters, 10);
        ...
        const double var_x8 = var_x1 * NV_Ith_S(mParameters, 9);
        ...
        const double var_x13 = var_x12 * NV_Ith_S(mParameters, 12);
        ...
        const double var_x16 = var_x15 - NV_Ith_S(mParameters, 4);
        ...
        const double var_x22 = pow(NV_Ith_S(mParameters, 5), 3);
        ...
        const double var_x25 = NV_Ith_S(mParameters, 3) * exp(0.013103020192811281 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        ...
        const double var_x28 = NV_Ith_S(mParameters, 13) / ((133.984375 + 0.00020000000000000001 * var_x22) * (1.3799999999999999 + NV_Ith_S(mParameters, 3)));
        ...
        const double var_x34 = 0.001 * var_x33 - 0.34100000000000003 * NV_Ith_S(mParameters, 3);
        ...
        const double var_x49 = var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14 * NV_Ith_S(mParameters, 12);
        ...
        const double var_x55 = exp(0.01485884101040119 * NV_Ith_S(mParameters, 5));
        ...
        const double var_x58 = NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 14) / (1.5 + NV_Ith_S(mParameters, 4));
        ...
        const double var_x69 = var_x34 * var_x65 * NV_Ith_S(mParameters, 6) / pow(var_x35, 2);
        ...
        const double var_x79 = (var_chaste_interface__IKs__O1ks + var_chaste_interface__IKs__O2ks) * NV_Ith_S(mParameters, 11);
        const double var_x80 = var_x78 * var_x79;
        const double var_x81 = (var_chaste_interface__INa__na6 + var_chaste_interface__INa__na7) * NV_Ith_S(mParameters, 7);
        const double var_x82 = var_x52 * var_x81;
        const double var_x83 = var_x14 * var_x47;
        ...
        const double var_x91 = var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa;
        const double var_x92 = var_x12 * var_x42;
        const double var_x93 = var_x45 * var_x92;
        const double var_x94 = var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open;
        const double var_x95 = 23.746433678756475 * var_x5;
        const double var_x96 = 0.88900000000000001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x97 = var_x13 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x98 = -var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x99 = 26.71139896373057 * log(var_x52 * NV_Ith_S(mParameters, 5));
        const double var_x100 = (var_x98 + var_x99) * NV_Ith_S(mParameters, 7);
        const double var_x101 = 26.71139896373057 * log(var_x78 * (0.018329999999999999 * NV_Ith_S(mParameters, 5) + NV_Ith_S(mParameters, 4)));
        const double var_x102 = (var_x101 + var_x98) * NV_Ith_S(mParameters, 11);
        ...
        const double var_x111 = NV_Ith_S(mParameters, 1) / (1.0 + 33855.471141425078 * var_x109 + 0.303951367781155 * var_x110);
        const double var_x112 = var_x108 * var_x111;
        const double var_x113 = 2.532389241378596 * var_x109 - 9.6656534954407287e-5 * var_x110;
        const double var_x114 = var_x113 * NV_Ith_S(mParameters, 1) / pow((2.9537323401073989e-5 + var_x109 + 8.9779098483507565e-6 * var_x110), 2);
        ...
        const double var_x118 = var_x97 * NV_Ith_S(mParameters, 2);
        const double var_x119 = 6.1518471582797284e-5 * NV_Ith_S(mParameters, 2);
        const double var_x120 = -var_x119 * (-var_x99 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * NV_Ith_S(mParameters, 7);
        const double var_x121 = 0.024669434545673906 * var_x14;
        const double var_x122 = 7.1159095070575419e-7 * var_x44;
        const double var_x123 = 7.1159095070575419e-7 * var_x16 * var_x92 * NV_Ith_S(mParameters, 2);
        const double var_x124 = -var_x119 * (-var_x101 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * NV_Ith_S(mParameters, 11);
        ...
        const double var_x133 = (var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR + var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O2_RyR) * NV_Ith_S(mParameters, 0);
        ...
        const double var_x135 = var_x130 * NV_Ith_S(mParameters, 0);
        const double var_x136 = var_x135 * (133.33333333333334 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR - 133.33333333333334 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS);
        const double var_x137 = var_x125 * var_x129;
        ...
        const double var_x142 = var_x141 * (-var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS) * NV_Ith_S(mParameters, 0);
        const double var_x143 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 3.0);
        const double var_x144 = 48600000000.0 * var_x143 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C1_RyR;
        const double var_x145 = 12150000000.0 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 4.0);
        const double var_x146 = 12150000.0 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 2.0) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR;
        ...
        const double var_x149 = 0.0057330000000000002 * var_x148;
        ...
        const double var_x151 = 0.095846399999999998 * var_x150;
        const double var_x152 = var_x151 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C0;
        const double var_x153 = 0.055397999999999996 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C0;
        ...
        const double var_x158 = 0.071884799999999999 * var_x150;
        const double var_x159 = 0.011466 * var_x148;
        const double var_x160 = 0.11079599999999999 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1;
        ...
        const double var_x165 = 0.047923199999999999 * var_x150;
        const double var_x166 = -var_x165;
        const double var_x167 = 0.017199000000000002 * var_x148;
        const double var_x168 = 0.22159199999999998 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2;
        ...
        const double var_x174 = 0.0239616 * var_x150;
        const double var_x175 = 0.022932000000000001 * var_x148 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C4;
        const double var_x176 = 0.44318399999999997 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        ...
        const double var_x180 = 0.88636799999999993 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C4;
        const double var_x181 = 0.88636799999999993 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x182 = 0.0028665000000000001 * var_x148;
        const double var_x183 = 0.1916928 * var_x150 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa0;
        const double var_x184 = 15.974399999999999 * var_x150;
        const double var_x185 = 0.0441 * var_x148;
        const double var_x186 = 0.1437696 * var_x150;
        const double var_x187 = 11.980799999999999 * var_x150;
        const double var_x188 = 0.0085995000000000012 * var_x148;
        const double var_x189 = 0.1323 * var_x148;
        const double var_x190 = var_x159 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa4;
        ...
        const double var_x194 = exp(3.6538461538461537 + 0.12820512820512822 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        ...
        const double var_x210 = 0.047274866891999993 * var_x200;
        const double var_x211 = 8.3392179730847992e-11 * var_x198;
        const double var_x212 = 2.7448243264023812e-6 * var_x202;
        const double var_x213 = 0.0075123241690000005 * var_x204;
        ...
        const double var_x218 = 6.2643871845094088e-10 * var_x198;
        const double var_x219 = 0.031516577927999993 * var_x200;
        const double var_x220 = 1.190172890246627e-6 * var_x202;
        const double var_x221 = 0.011268486253500002 * var_x204;
        ...
        const double var_x226 = 0.015758288963999997 * var_x200;
        const double var_x227 = 6.9834511318773689e-9 * var_x198;
        const double var_x228 = 6.466053749793811e-7 * var_x202;
        const double var_x229 = 0.015024648338000001 * var_x204;
        ...
        const double var_x234 = 6.2947815902170839e-9 * var_x198;
        const double var_x235 = 3.5441967137821161e-8 * var_x202;
        const double var_x236 = 0.11713400800552819 * var_x198;
        const double var_x237 = 9.5014602960251466e-5 * var_x202;
        const double var_x238 = 0.42695382052749886 * var_x200;
        const double var_x239 = 0.00198360904335657 * var_x204;
        const double var_x240 = 14.731181055359999 * var_x200;
        const double var_x241 = 0.042345268272074361 * var_x204;
        const double var_x242 = 0.10902718902100607 * var_x200;
        const double var_x243 = 0.0010000484785595239 * var_x204;
        const double var_x244 = 3.7617634137599998 * var_x200;
        const double var_x245 = 0.021348622729620501 * var_x204;
        const double var_x246 = 0.058010926130094308 * var_x200;
        const double var_x247 = 0.0010108205748447618 * var_x204;
        const double var_x248 = 2.0015500855706554 * var_x200;
        const double var_x249 = 0.021578581001175438 * var_x204;
        const double var_x250 = 0.2874951693560841 * var_x200;
        const double var_x251 = 0.016668393642939261 * var_x204;
        ...
        const double var_x255 = 0.00084304739027167303 * var_x254;
        const double var_x256 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x257 = 0.056565877361888978 * var_x256 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C0Kv14;
        const double var_x258 = 7.3600965821599997 * var_x256;
        const double var_x259 = 0.010817483399999999 * var_x254;
        const double var_x260 = 0.042424408021416733 * var_x256;
        const double var_x261 = 0.0016860947805433461 * var_x254;
        const double var_x262 = 5.5200724366199996 * var_x256;
        const double var_x263 = 0.021634966799999999 * var_x254;
        const double var_x264 = 0.028282938680944489 * var_x256;
        const double var_x265 = 0.0025291421708150191 * var_x254;
        const double var_x266 = 3.6800482910799999 * var_x256;
        const double var_x267 = 0.032452450199999996 * var_x254;
        const double var_x268 = 0.014141469340472244 * var_x256;
        const double var_x269 = 0.0033721895610866921 * var_x254 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
        const double var_x270 = 1.8400241455399999 * var_x256;
        const double var_x271 = 0.043269933599999998 * var_x254;
        const double var_x272 = 0.0016068735371190899 * var_x254;
        const double var_x273 = 0.057102035392881494 * var_x256 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI0Kv14;
        const double var_x274 = 7.4298590445392074 * var_x256;
        const double var_x275 = 0.020618446856331008 * var_x254;
        const double var_x276 = 0.049212749503964481 * var_x256;
        const double var_x277 = 5.0494790920257417e-5 * var_x254;
        const double var_x278 = 6.4033407827395079 * var_x256;
        const double var_x279 = 0.00064791916666788224 * var_x254;
        const double var_x280 = 0.015434242075859545 * var_x256;
        const double var_x281 = 4.7206750348744694e-5 * var_x254;
        const double var_x282 = 2.0082338973371909 * var_x256;
        const double var_x283 = 0.00060572898292340319 * var_x254;
        const double var_x284 = 0.04692272136005015 * var_x256;
        const double var_x285 = 5.7810813021376402e-5 * var_x254 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OIKv14;
        ...
        const double var_x289 = 767594485.71651864 * var_x288;
        ...
        const double var_x291 = 384756192.24456543 * var_x290 * var_chaste_interface__INa__na1;
        ...
        const double var_x298 = 288567144.18342406 * var_x290;
        const double var_x299 = 1535188971.4330373 * var_x288;
        ...
        const double var_x304 = 192378096.12228271 * var_x290;
        const double var_x305 = 2302783457.1495562 * var_x288;
        ...
        const double var_x310 = 96189048.061141357 * var_x290;
        const double var_x311 = 3070377942.8660746 * var_x288;
        ...
        const double var_x317 = 717453519.94201112 * var_x316;
        ...
        const double var_x319 = 934047731.6985184 * var_x318;
        ...
        const double var_x321 = 523324220.27000725 * var_x320;
        ...
        const double var_x323 = 585416244.0376184 * var_x322 * var_chaste_interface__INa__na7;
        ...
        const double var_x331 = 97009205.304776609 * var_x330;
        ...
        const double var_x333 = 23003541.30715951 * var_x332;
        ...
        const double var_x338 = 538822673.3061657 * var_x290 * var_chaste_interface__INa__na8;
        const double var_x339 = 548114892.2335701 * var_x288;
        const double var_x340 = 47690340841.071007 * var_x290;
        const double var_x341 = 6079249204.347868 * var_x288;
        const double var_x342 = 404117004.97962433 * var_x290;
        const double var_x343 = 1096229784.4671402 * var_x288;
        const double var_x344 = 35767755630.803253 * var_x290;
        const double var_x345 = 12158498408.695736 * var_x288;
        const double var_x346 = 269411336.65308285 * var_x290;
        const double var_x347 = 1644344676.7007101 * var_x288;
        const double var_x348 = 23845170420.535503 * var_x290;
        const double var_x349 = 18237747613.043602 * var_x288;
        const double var_x350 = 134705668.32654142 * var_x290;
        const double var_x351 = 2192459568.9342804 * var_x288;
        ...
        const double var_x355 = 256659070.76381233 * var_x354;
        ...
        const double var_x357 = 1225921583.3429821 * var_x356;
        ...
        const double var_x361 = 0.0030146436875758886 * var_x360 * var_chaste_interface__IKr__C1Herg;
        const double var_x362 = exp(-0.043060541639799998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x363 = 0.0090930200797394306 * var_x362 * var_chaste_interface__IKr__C2Herg;
        ...
        const double var_x375 = 1.7628212752661065e-7 * var_x374;
        ...
        const double var_x380 = 0.0032282621593045179 * var_x373;
        const double var_x381 = 0.0015600678590465679 * var_x372;
        ...
        const double var_x385 = 4.0853373267232939e-6 * var_x384 * var_chaste_interface__IKs__C1ks;
        ...
        const double var_x388 = 0.0010511927526268654 * var_x387;
        ...
        const double var_x391 = 0.00066466830499978399 * var_x390;
        const double var_x392 = exp(-0.014256681268810001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x393 = 5.4138036083884682e-5 * var_x392 * var_chaste_interface__IKs__O2ks;
        const double var_x394 = 0.00767254363063 * var_x390;
        const double var_x395 = 0.0037973799836799999 * var_x392;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0010768399999999999 - var_x30 + 15.012638396264883 * var_x50 + 0.00043304023078523341 * var_x68 + 0.30025276792529765 * var_x51 + 0.047170872694120618 * var_x32 - var_x59 - var_x9 - 0.88900000000000001 * var_x0 - 15.012638396264883 * var_x61 - 0.0030652842485403373 * var_x71 - 0.00043304023078523341 * var_x72 - 0.30025276792529765 * var_x62 - 0.0048668360716156199 * var_x64 + var_x43 * var_x70 + (-var_chaste_interface__IKs__O1ks - var_chaste_interface__IKs__O2ks) * NV_Ith_S(mParameters, 11) + (-var_chaste_interface__INa__na6 - var_chaste_interface__INa__na7) * NV_Ith_S(mParameters, 7) - var_x14 * var_x17 - var_x14 * var_x20 - var_x3 * var_chaste_interface__IKr__OHerg - var_x38 * var_x43 - var_x43 * var_x67 - var_x44 * var_x45);
        IJth(rJacobian, 1, 0) = var_x106 * (-2.3635396782110715e-9 + 6.1518471582797284e-5 * var_x30 + 2.9940031656981826e-7 * var_x64);
        IJth(rJacobian, 2, 0) = (-6.1518471582797284e-8 + 1.8471091371268651e-5 * var_x51 - 6.1518471582797284e-5 * var_x81 - 1.8471091371268651e-5 * var_x62 - 0.00018455541474839184 * var_x30 - 0.00018455541474839184 * var_x59 - 8.9820094970945477e-7 * var_x64 - var_x117 * var_x19) * NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 3, 0) = (0.00012303694316559457 * var_x59 + 2.6639973131769359e-8 * var_x68 + 2.9018799913690074e-6 * var_x32 + 0.0009235545685634326 * var_x50 - 5.4689921237106786e-5 * var_x0 - 3.0759235791398642e-5 * var_x87 - 6.1518471582797284e-5 * var_x79 - 6.1518471582797284e-5 * var_x9 - 2.6639973131769359e-8 * var_x72 - 1.8857160193702489e-7 * var_x71 - 0.0009235545685634326 * var_x61 - var_x121 * var_x16 - var_x122 * var_x16) * NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 4, 0) = var_x130 * (-var_x126 + 5016.5931039565676 * var_x43 * var_x69 - 5.0165931039565681 * var_x43 * var_x66);
        IJth(rJacobian, 13, 0) = -var_x152 - var_x149 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1;
        IJth(rJacobian, 14, 0) = var_x152 + (var_x149 - var_x158) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1 - var_x159 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2;
        IJth(rJacobian, 15, 0) = var_x158 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1 + (var_x159 + var_x166) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2 - var_x167 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        IJth(rJacobian, 16, 0) = -var_x175 + var_x165 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2 + (var_x167 - var_x174) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        IJth(rJacobian, 17, 0) = var_x175 + var_x174 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        IJth(rJacobian, 18, 0) = -var_x183 - var_x182 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa1;
        IJth(rJacobian, 19, 0) = var_x183 + (var_x182 - var_x186) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa1 - var_x149 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa2;
        IJth(rJacobian, 20, 0) = var_x186 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa1 + (var_x149 - var_x151) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa2 - var_x188 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa3;
        IJth(rJacobian, 21, 0) = -var_x190 + var_x151 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa2 + (var_x166 + var_x188) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa3;
        IJth(rJacobian, 22, 0) = var_x190 + var_x165 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa3;
        IJth(rJacobian, 24, 0) = (-0.00015735009791355945 * var_x191 + 0.00060721481483873177 * var_x192 / pow(var_x193, 2)) * (0.18000000000000005 - var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa + 0.81999999999999995 / var_x195) - 0.10512820512820513 * var_x194 * (var_x196 + var_x197) / pow(var_x195, 2);
        IJth(rJacobian, 25, 0) = (-var_x199 - var_x201) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 - var_x203 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 - var_x205 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43;
        IJth(rJacobian, 26, 0) = var_x201 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 + (var_x205 - var_x210 - var_x211) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 - var_x212 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 - var_x213 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43;
        IJth(rJacobian, 27, 0) = var_x210 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 + (var_x213 - var_x218 - var_x219) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 - var_x220 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43 - var_x221 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43;
        IJth(rJacobian, 28, 0) = var_x219 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 + (var_x221 - var_x226 - var_x227) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 - var_x228 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43 - var_x229 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43;
        IJth(rJacobian, 29, 0) = var_x226 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 + (var_x229 - var_x234) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - var_x235 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OIKv43;
        IJth(rJacobian, 30, 0) = var_x199 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 + (var_x203 - var_x238) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 - var_x239 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43;
        IJth(rJacobian, 31, 0) = var_x211 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 + var_x238 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 + (var_x212 + var_x239 - var_x242) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 - var_x243 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43;
        IJth(rJacobian, 32, 0) = var_x218 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 + var_x242 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 + (var_x220 + var_x243 - var_x246) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43 - var_x247 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43;
        IJth(rJacobian, 33, 0) = var_x227 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 + var_x246 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43 + (var_x228 + var_x247 - var_x250) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43 - var_x251 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OIKv43;
        IJth(rJacobian, 34, 0) = var_x234 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 + var_x250 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43 + (var_x235 + var_x251) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OIKv43;
        IJth(rJacobian, 35, 0) = -var_x257 - var_x255 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C1Kv14;
        IJth(rJacobian, 36, 0) = var_x257 + (var_x255 - var_x260) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C1Kv14 - var_x261 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C2Kv14;
        IJth(rJacobian, 37, 0) = var_x260 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C1Kv14 + (var_x261 - var_x264) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C2Kv14 - var_x265 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C3Kv14;
        IJth(rJacobian, 38, 0) = -var_x269 + var_x264 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C2Kv14 + (var_x265 - var_x268) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C3Kv14;
        IJth(rJacobian, 39, 0) = var_x269 + var_x268 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C3Kv14;
        IJth(rJacobian, 40, 0) = -var_x273 - var_x272 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI1Kv14;
        IJth(rJacobian, 41, 0) = var_x273 + (var_x272 - var_x276) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI1Kv14 - var_x277 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI2Kv14;
        IJth(rJacobian, 42, 0) = var_x276 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI1Kv14 + (var_x277 - var_x280) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI2Kv14 - var_x281 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI3Kv14;
        IJth(rJacobian, 43, 0) = -var_x285 + var_x280 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI2Kv14 + (var_x281 - var_x284) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI3Kv14;
        IJth(rJacobian, 44, 0) = var_x285 + var_x284 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI3Kv14;
        IJth(rJacobian, 45, 0) = -var_x291 - var_x289 * var_chaste_interface__INa__na2;
        IJth(rJacobian, 46, 0) = var_x291 + (var_x289 - var_x298) * var_chaste_interface__INa__na2 - var_x299 * var_chaste_interface__INa__na3;
        IJth(rJacobian, 47, 0) = var_x298 * var_chaste_interface__INa__na2 + (var_x299 - var_x304) * var_chaste_interface__INa__na3 - var_x305 * var_chaste_interface__INa__na4;
        IJth(rJacobian, 48, 0) = var_x304 * var_chaste_interface__INa__na3 + (var_x305 - var_x310) * var_chaste_interface__INa__na4 - var_x311 * var_chaste_interface__INa__na5;
        IJth(rJacobian, 49, 0) = -var_x323 + var_x310 * var_chaste_interface__INa__na4 + (var_x311 - var_x317 - var_x319) * var_chaste_interface__INa__na5 - var_x321 * var_chaste_interface__INa__na6;
        IJth(rJacobian, 50, 0) = var_x319 * var_chaste_interface__INa__na5 + var_x333 * var_chaste_interface__INa__na13 + (var_x321 - var_x331) * var_chaste_interface__INa__na6;
        IJth(rJacobian, 51, 0) = var_x323 + var_x317 * var_chaste_interface__INa__na5;
        IJth(rJacobian, 52, 0) = -var_x338 - var_x339 * var_chaste_interface__INa__na9;
        IJth(rJacobian, 53, 0) = var_x338 + (var_x339 - var_x342) * var_chaste_interface__INa__na9 - var_x343 * var_chaste_interface__INa__na10;
        IJth(rJacobian, 54, 0) = var_x342 * var_chaste_interface__INa__na9 + (var_x343 - var_x346) * var_chaste_interface__INa__na10 - var_x347 * var_chaste_interface__INa__na11;
        IJth(rJacobian, 55, 0) = var_x346 * var_chaste_interface__INa__na10 + (var_x347 - var_x350) * var_chaste_interface__INa__na11 - var_x351 * var_chaste_interface__INa__na12;
        IJth(rJacobian, 56, 0) = var_x350 * var_chaste_interface__INa__na11 + (var_x351 - var_x355) * var_chaste_interface__INa__na12 - var_x357 * var_chaste_interface__INa__na13;
        IJth(rJacobian, 57, 0) = var_x331 * var_chaste_interface__INa__na6 + var_x355 * var_chaste_interface__INa__na12 + (var_x357 - var_x333) * var_chaste_interface__INa__na13;
        IJth(rJacobian, 58, 0) = -var_x361 - var_x363;
        IJth(rJacobian, 59, 0) = var_x361 + var_x363;
        IJth(rJacobian, 60, 0) = (-var_x367 - var_x369) * var_chaste_interface__IKr__C3Herg - var_x371 * var_chaste_interface__IKr__OHerg - var_x375 * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 61, 0) = var_x369 * var_chaste_interface__IKr__C3Herg + (var_x371 - var_x380) * var_chaste_interface__IKr__OHerg - var_x381 * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 62, 0) = var_x367 * var_chaste_interface__IKr__C3Herg + var_x380 * var_chaste_interface__IKr__OHerg + (var_x375 + var_x381) * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 63, 0) = -var_x385;
        IJth(rJacobian, 64, 0) = var_x385 - var_x388 * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 65, 0) = -var_x393 + (var_x388 - var_x391) * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 66, 0) = var_x393 + var_x391 * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x77 + 0.050000000000000003 * var_x76 - 0.050000000000000003 * var_x74 - 0.0010262519481865284 * var_x75);
        IJth(rJacobian, 1, 1) = var_x106 * (-5.6374531835205994 - var_x107 + 2.8000000000000003 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa + 2.8000000000000003 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa + 3.5444788081288787e-5 * var_x115 + 1.5379617895699322e-6 * var_x76 - 6.1518471582797284e-5 * var_x77 - 3.1566725655651652e-8 * var_x75 - 3.0388670896543148 * var_x112) + 0.00023800000000000004 * (0.0028000000000000004 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa + 9.2400000000000013e-6 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa + 3.1566725655651652e-8 * log(var_x75 * NV_Ith_S(mParameters, 3)) + 0.037453183520599252 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS - 0.037453183520599252 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - 2.3635396782110715e-9 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V - var_x107 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - var_x111 * var_x113 - var_x116 * (1.0 - var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa) - var_x116 * (1.0 - var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa) + 6.1518471582797284e-5 * var_x29 * var_x63) / (pow(var_x103, 3) * pow(var_x104, 2));
        IJth(rJacobian, 2, 1) = 0.00018455541474839184 * var_x77 * NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 4, 1) = 806.49188514357058 * var_x129;
        IJth(rJacobian, 6, 1) = 37.392535998413095 * var_x112 - 0.00043613967810500107 * var_x115;
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x84 - 0.016770509831248424 * var_x85 - 0.4896199430051813 * var_x80 - 8.0201714740170313 * var_x83 - 26.71139896373057 * var_x82 - 0.026711398963730568 * var_x52);
        IJth(rJacobian, 1, 2) = 0.00018455541474839184 * var_x105 * var_x84;
        IJth(rJacobian, 2, 2) = (-0.0016432444380870197 * var_x82 - 0.00055366624424517559 * var_x84 - 3.0950883974480355e-6 * var_x85 - 1.6432444380870198e-6 * var_x52 - var_x117 * var_x47) * NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 3, 2) = (2.063392264965357e-6 * var_x85 - 3.0120670550135071e-5 * var_x80) * NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (1.26 * var_x90 - 23.746433678756475 * var_x86 - 401.00857370085151 * var_x83 - 13.355699481865285 * var_x88 - 26.71139896373057 * var_x80 - 26.71139896373057 * var_x89 - 0.01156711037185033 * var_x44 * var_x47);
        IJth(rJacobian, 3, 3) = (7.7513274194324582e-5 * var_x90 - 0.00082162221904350983 * var_x88 - 0.0016432444380870197 * var_x80 - 0.0016432444380870197 * var_x89 - 0.0014608443054593605 * var_x86 - var_x121 * var_x47 - var_x122 * var_x47) * NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 1, 4) = 0.037453183520599252 * var_x105;
        IJth(rJacobian, 4, 4) = var_x130 * (-806.49188514357058 + (-var_x131 - var_x132) * NV_Ith_S(mParameters, 0)) + 0.00023800000000000004 * (133.33333333333334 * var_x134 + 806.49188514357058 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - 806.49188514357058 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS - var_x126 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) / (pow(var_x127, 3) * pow(var_x128, 2));
        IJth(rJacobian, 5, 4) = var_x133 * var_x141;
        IJth(rJacobian, 9, 4) = -var_x144;
        IJth(rJacobian, 10, 4) = var_x146;
        IJth(rJacobian, 12, 4) = var_x144 - var_x146;
        IJth(rJacobian, 13, 4) = -var_x153;
        IJth(rJacobian, 14, 4) = -var_x160;
        IJth(rJacobian, 15, 4) = -var_x168;
        IJth(rJacobian, 16, 4) = -var_x176;
        IJth(rJacobian, 17, 4) = -var_x180;
        IJth(rJacobian, 18, 4) = var_x153;
        IJth(rJacobian, 19, 4) = var_x160;
        IJth(rJacobian, 20, 4) = var_x168;
        IJth(rJacobian, 21, 4) = var_x176;
        IJth(rJacobian, 22, 4) = var_x180;
        IJth(rJacobian, 4, 5) = var_x135 * (var_x131 + var_x132);
        IJth(rJacobian, 5, 5) = var_x141 * (-1.7400382808421786 + (-var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR - var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O2_RyR) * NV_Ith_S(mParameters, 0)) + 0.16666666666666666 * (-var_x134 + 1.7400382808421786 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaNSR - 1.7400382808421786 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR) / (pow(var_x138, 3) * pow((0.083333333333333329 + var_x139), 2));
        IJth(rJacobian, 6, 5) = 0.13257434520702313;
        IJth(rJacobian, 1, 6) = var_x106 * (9.6656534954407287e-5 * var_x111 + 2.651834266564234e-10 * var_x114);
        IJth(rJacobian, 5, 6) = 1.7400382808421786 * var_x140;
        IJth(rJacobian, 6, 6) = -0.13257434520702313 - 0.0011893356491532784 * var_x111 - 3.2630189260961816e-9 * var_x114;
        IJth(rJacobian, 1, 7) = var_x106 * (0.0028000000000000004 + var_x116);
        IJth(rJacobian, 7, 7) = -0.040000000000000001 - 40.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        IJth(rJacobian, 1, 8) = var_x106 * (9.2400000000000013e-6 + var_x116);
        IJth(rJacobian, 8, 8) = -6.6000000000000005e-5 - 20.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        IJth(rJacobian, 9, 9) = -var_x145;
        IJth(rJacobian, 12, 9) = var_x145;
        IJth(rJacobian, 4, 10) = var_x136;
        IJth(rJacobian, 5, 10) = var_x142;
        ...
        IJth(rJacobian, 4, 12) = var_x136;
        IJth(rJacobian, 5, 12) = var_x142;
        IJth(rJacobian, 9, 12) = 0.57599999999999996;
        IJth(rJacobian, 10, 12) = var_x147;
        IJth(rJacobian, 11, 12) = 0.10000000000000001;
        IJth(rJacobian, 12, 12) = -0.67599999999999993 - var_x147;
        IJth(rJacobian, 13, 13) = var_x156 - var_x154;
        IJth(rJacobian, 14, 13) = var_x155;
        IJth(rJacobian, 18, 13) = var_x154;
        IJth(rJacobian, 13, 14) = var_x157;
        IJth(rJacobian, 14, 14) = var_x163 - var_x161 - var_x162;
        IJth(rJacobian, 15, 14) = var_x161;
        IJth(rJacobian, 19, 14) = var_x162;
        IJth(rJacobian, 14, 15) = var_x164;
        IJth(rJacobian, 15, 15) = var_x170 + var_x172 - var_x169;
        IJth(rJacobian, 16, 15) = var_x171;
        IJth(rJacobian, 20, 15) = var_x169;
        IJth(rJacobian, 15, 16) = var_x173;
        IJth(rJacobian, 16, 16) = -var_x173 - var_x177 - var_x178;
        IJth(rJacobian, 17, 16) = var_x178;
        IJth(rJacobian, 21, 16) = var_x177;
        IJth(rJacobian, 16, 17) = var_x179;
        IJth(rJacobian, 17, 17) = -0.29999999999999999 - var_x179 - var_x181;
        IJth(rJacobian, 22, 17) = var_x181;
        IJth(rJacobian, 23, 17) = 0.29999999999999999;
        IJth(rJacobian, 13, 18) = 0.0025000000000000001;
        IJth(rJacobian, 18, 18) = -0.0025000000000000001 - var_x184;
        IJth(rJacobian, 19, 18) = var_x184;
        IJth(rJacobian, 14, 19) = 0.00125;
        IJth(rJacobian, 18, 19) = var_x185;
        IJth(rJacobian, 19, 19) = -0.00125 - var_x185 - var_x187;
        IJth(rJacobian, 20, 19) = var_x187;
        IJth(rJacobian, 15, 20) = 0.00062500000000000001;
        IJth(rJacobian, 19, 20) = var_x157;
        IJth(rJacobian, 20, 20) = -0.00062500000000000001 + var_x156 + var_x163;
        IJth(rJacobian, 21, 20) = var_x155;
        IJth(rJacobian, 16, 21) = 0.00031250000000000001;
        IJth(rJacobian, 20, 21) = var_x189;
        IJth(rJacobian, 21, 21) = -0.00031250000000000001 + var_x172 - var_x189;
        IJth(rJacobian, 22, 21) = var_x171;
        IJth(rJacobian, 17, 22) = 0.00015625;
        IJth(rJacobian, 21, 22) = var_x164;
        IJth(rJacobian, 22, 22) = -0.00015625 + var_x170;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x39 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa - var_x91 * var_x93);
        IJth(rJacobian, 3, 23) = -var_x123 * var_x91;
        IJth(rJacobian, 4, 23) = -var_x137 * var_x91;
        IJth(rJacobian, 17, 23) = 4.0;
        IJth(rJacobian, 23, 23) = -4.0;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x39 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open - var_x93 * var_x94);
        IJth(rJacobian, 3, 24) = -var_x123 * var_x94;
        IJth(rJacobian, 4, 24) = -var_x137 * var_x94;
        IJth(rJacobian, 24, 24) = -var_x196 - var_x197;
        IJth(rJacobian, 25, 25) = -var_x206 - var_x207;
        IJth(rJacobian, 26, 25) = var_x206;
        IJth(rJacobian, 30, 25) = var_x207;
        IJth(rJacobian, 25, 26) = var_x208;
        IJth(rJacobian, 26, 26) = -var_x208 - var_x214 - var_x215;
        IJth(rJacobian, 27, 26) = var_x214;
        IJth(rJacobian, 31, 26) = var_x215;
        IJth(rJacobian, 26, 27) = var_x216;
        IJth(rJacobian, 27, 27) = -var_x216 - var_x222 - var_x223;
        IJth(rJacobian, 28, 27) = var_x222;
        IJth(rJacobian, 32, 27) = var_x223;
        IJth(rJacobian, 27, 28) = var_x224;
        IJth(rJacobian, 28, 28) = -var_x224 - var_x230 - var_x231;
        IJth(rJacobian, 29, 28) = var_x230;
        IJth(rJacobian, 33, 28) = var_x231;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : ((var_x95 - var_x96) * NV_Ith_S(mParameters, 8));
        IJth(rJacobian, 3, 29) = -var_x119 * (var_x96 - var_x95) * NV_Ith_S(mParameters, 8);
        IJth(rJacobian, 28, 29) = var_x232;
        IJth(rJacobian, 29, 29) = -var_x232 - var_x236;
        IJth(rJacobian, 34, 29) = var_x236;
        IJth(rJacobian, 25, 30) = var_x209;
        IJth(rJacobian, 30, 30) = -var_x209 - var_x240;
        IJth(rJacobian, 31, 30) = var_x240;
        IJth(rJacobian, 26, 31) = var_x217;
        IJth(rJacobian, 30, 31) = var_x241;
        IJth(rJacobian, 31, 31) = -var_x217 - var_x241 - var_x244;
        IJth(rJacobian, 32, 31) = var_x244;
        IJth(rJacobian, 27, 32) = var_x225;
        IJth(rJacobian, 31, 32) = var_x245;
        IJth(rJacobian, 32, 32) = -var_x225 - var_x245 - var_x248;
        IJth(rJacobian, 33, 32) = var_x248;
        IJth(rJacobian, 28, 33) = var_x233;
        IJth(rJacobian, 32, 33) = var_x249;
        IJth(rJacobian, 33, 33) = -var_x233 - var_x249 - var_x252;
        IJth(rJacobian, 34, 33) = var_x252;
        IJth(rJacobian, 29, 34) = var_x237;
        IJth(rJacobian, 33, 34) = var_x253;
        IJth(rJacobian, 34, 34) = -var_x237 - var_x253;
        IJth(rJacobian, 35, 35) = -2.44936e-6 - var_x258;
        IJth(rJacobian, 36, 35) = var_x258;
        IJth(rJacobian, 40, 35) = 2.44936e-6;
        IJth(rJacobian, 35, 36) = var_x259;
        IJth(rJacobian, 36, 36) = -1.2850585364284256e-6 - var_x259 - var_x262;
        IJth(rJacobian, 37, 36) = var_x262;
        IJth(rJacobian, 41, 36) = 1.2850585364284256e-6;
        IJth(rJacobian, 36, 37) = var_x263;
        IJth(rJacobian, 37, 37) = -4.290998044504021e-5 - var_x263 - var_x266;
        IJth(rJacobian, 38, 37) = var_x266;
        IJth(rJacobian, 42, 37) = 4.290998044504021e-5;
        IJth(rJacobian, 37, 38) = var_x267;
        IJth(rJacobian, 38, 38) = -0.0022989390350036006 - var_x267 - var_x270;
        IJth(rJacobian, 39, 38) = var_x270;
        IJth(rJacobian, 43, 38) = 0.0022989390350036006;
        IJth(rJacobian, 0, 39) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x97 - var_x20 * var_x97);
        IJth(rJacobian, 2, 39) = -0.00049338869091347811 * var_x118 * var_x19;
        IJth(rJacobian, 3, 39) = -0.024669434545673906 * var_x118 * var_x16;
        IJth(rJacobian, 38, 39) = var_x271;
        IJth(rJacobian, 39, 39) = -0.1341004876120194 - var_x271;
        IJth(rJacobian, 44, 39) = 0.1341004876120194;
        IJth(rJacobian, 35, 40) = 0.00305767916;
        IJth(rJacobian, 40, 40) = -0.00305767916 - var_x274;
        IJth(rJacobian, 41, 40) = var_x274;
        IJth(rJacobian, 36, 41) = 0.0030289691634726814;
        IJth(rJacobian, 40, 41) = var_x275;
        IJth(rJacobian, 41, 41) = -0.0030289691634726814 - var_x275 - var_x278;
        IJth(rJacobian, 42, 41) = var_x278;
        IJth(rJacobian, 37, 42) = 0.0026111571690401588;
        IJth(rJacobian, 41, 42) = var_x279;
        IJth(rJacobian, 42, 42) = -0.0026111571690401588 - var_x279 - var_x282;
        IJth(rJacobian, 43, 42) = var_x282;
        IJth(rJacobian, 38, 43) = 0.0047848930796401661;
        IJth(rJacobian, 42, 43) = var_x283;
        IJth(rJacobian, 43, 43) = -0.0047848930796401661 - var_x283 - var_x286;
        IJth(rJacobian, 44, 43) = var_x286;
        IJth(rJacobian, 39, 44) = 0.0014420608358145942;
        IJth(rJacobian, 43, 44) = var_x287;
        IJth(rJacobian, 44, 44) = -0.0014420608358145942 - var_x287;
        IJth(rJacobian, 45, 45) = -var_x293 - var_x294;
        IJth(rJacobian, 46, 45) = var_x294;
        IJth(rJacobian, 52, 45) = var_x293;
        IJth(rJacobian, 45, 46) = var_x295;
        IJth(rJacobian, 46, 46) = -var_x295 - var_x300 - var_x301;
        IJth(rJacobian, 47, 46) = var_x301;
        IJth(rJacobian, 53, 46) = var_x300;
        IJth(rJacobian, 46, 47) = var_x302;
        IJth(rJacobian, 47, 47) = -var_x302 - var_x306 - var_x307;
        IJth(rJacobian, 48, 47) = var_x307;
        IJth(rJacobian, 54, 47) = var_x306;
        IJth(rJacobian, 47, 48) = var_x308;
        IJth(rJacobian, 48, 48) = -var_x308 - var_x312 - var_x313;
        IJth(rJacobian, 49, 48) = var_x313;
        IJth(rJacobian, 55, 48) = var_x312;
        IJth(rJacobian, 48, 49) = var_x314;
        IJth(rJacobian, 49, 49) = -var_x314 - var_x324 - var_x325 - var_x326;
        IJth(rJacobian, 50, 49) = var_x325;
        IJth(rJacobian, 51, 49) = var_x326;
        IJth(rJacobian, 56, 49) = var_x324;
        IJth(rJacobian, 0, 50) = mSetVoltageDerivativeToZero ? 0.0 : (var_x100);
        IJth(rJacobian, 2, 50) = var_x120;
        IJth(rJacobian, 49, 50) = var_x327;
        IJth(rJacobian, 50, 50) = -var_x327 - var_x334 - var_x335;
        IJth(rJacobian, 51, 50) = var_x334;
        IJth(rJacobian, 57, 50) = var_x335;
        IJth(rJacobian, 0, 51) = mSetVoltageDerivativeToZero ? 0.0 : (var_x100);
        IJth(rJacobian, 2, 51) = var_x120;
        IJth(rJacobian, 49, 51) = var_x328;
        IJth(rJacobian, 50, 51) = var_x336;
        IJth(rJacobian, 51, 51) = -var_x328 - var_x336;
        IJth(rJacobian, 45, 52) = var_x297;
        IJth(rJacobian, 52, 52) = -var_x297 - var_x340;
        IJth(rJacobian, 53, 52) = var_x340;
        IJth(rJacobian, 46, 53) = var_x303;
        IJth(rJacobian, 52, 53) = var_x341;
        IJth(rJacobian, 53, 53) = -var_x303 - var_x341 - var_x344;
        IJth(rJacobian, 54, 53) = var_x344;
        IJth(rJacobian, 47, 54) = var_x309;
        IJth(rJacobian, 53, 54) = var_x345;
        IJth(rJacobian, 54, 54) = -var_x309 - var_x345 - var_x348;
        IJth(rJacobian, 55, 54) = var_x348;
        IJth(rJacobian, 48, 55) = var_x315;
        IJth(rJacobian, 54, 55) = var_x349;
        IJth(rJacobian, 55, 55) = -var_x315 - var_x349 - var_x352;
        IJth(rJacobian, 56, 55) = var_x352;
        IJth(rJacobian, 49, 56) = var_x329;
        IJth(rJacobian, 55, 56) = var_x353;
        IJth(rJacobian, 56, 56) = -var_x329 - var_x353 - var_x358;
        IJth(rJacobian, 57, 56) = var_x358;
        IJth(rJacobian, 50, 57) = var_x337;
        IJth(rJacobian, 56, 57) = var_x359;
        IJth(rJacobian, 57, 57) = -var_x337 - var_x359;
        IJth(rJacobian, 58, 58) = -var_x364;
        IJth(rJacobian, 59, 58) = var_x364;
        IJth(rJacobian, 58, 59) = var_x365;
        IJth(rJacobian, 59, 59) = -0.13876486073161204 - var_x365;
        IJth(rJacobian, 60, 59) = 0.13876486073161204;
        IJth(rJacobian, 59, 60) = 0.78911443677844384;
        IJth(rJacobian, 60, 60) = -0.78911443677844384 - var_x376 - var_x377;
        IJth(rJacobian, 61, 60) = var_x376;
        IJth(rJacobian, 62, 60) = var_x377;
        IJth(rJacobian, 0, 61) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x3 * var_x31);
        IJth(rJacobian, 3, 61) = -3.0759235791398642e-5 * var_x2 * var_x31 * NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 60, 61) = var_x378;
        IJth(rJacobian, 61, 61) = -var_x378 - var_x382;
        IJth(rJacobian, 62, 61) = var_x382;
        IJth(rJacobian, 60, 62) = var_x379;
        IJth(rJacobian, 61, 62) = var_x383;
        IJth(rJacobian, 62, 62) = -var_x379 - var_x383;
        IJth(rJacobian, 63, 63) = -0.0079560079800399999;
        IJth(rJacobian, 64, 63) = 0.0079560079800399999;
        IJth(rJacobian, 63, 64) = var_x386;
        IJth(rJacobian, 64, 64) = -0.039667206760709998 - var_x386;
        IJth(rJacobian, 65, 64) = 0.039667206760709998;
        IJth(rJacobian, 0, 65) = mSetVoltageDerivativeToZero ? 0.0 : (var_x102);
        IJth(rJacobian, 3, 65) = var_x124;
        IJth(rJacobian, 64, 65) = var_x389;
        IJth(rJacobian, 65, 65) = -var_x389 - var_x394;
        IJth(rJacobian, 66, 65) = var_x394;
        IJth(rJacobian, 0, 66) = mSetVoltageDerivativeToZero ? 0.0 : (var_x102);
        IJth(rJacobian, 3, 66) = var_x124;
        IJth(rJacobian, 65, 66) = var_x395;
        IJth(rJacobian, 66, 66) = -var_x395;
    }
