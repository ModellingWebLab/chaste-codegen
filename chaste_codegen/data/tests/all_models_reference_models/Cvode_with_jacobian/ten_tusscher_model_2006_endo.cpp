...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2006_endoFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2006_endoFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellten_tusscher_model_2006_endoFromCellMLCvode::Cellten_tusscher_model_2006_endoFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                19,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2006_endoFromCellMLCvode>::Instance();
        Init();
    ...
    Cellten_tusscher_model_2006_endoFromCellMLCvode::~Cellten_tusscher_model_2006_endoFromCellMLCvode()
    {
    }

    

    void Cellten_tusscher_model_2006_endoFromCellMLCvode::VerifyStateVariables()
    {
    ...
    double Cellten_tusscher_model_2006_endoFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellten_tusscher_model_2006_endoFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    void Cellten_tusscher_model_2006_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -86.709
        double var_chaste_interface__calcium_dynamics__Ca_i = NV_Ith_S(rY, 1);
        ...
        const double var_x50 = 1 / (1.0 + NV_Ith_S(mParameters, 5));
        ...
        const double var_x55 = var_x50 * var_x51 * (0.001321416346042915 * var_x52 + 0.00046605194074318115 * var_x53) * NV_Ith_S(mParameters, 5) * var_chaste_interface__sodium_dynamics__Na_i * NV_Ith_S(mParameters, 20) / pow(var_x54, 2);
        ...
        const double var_x79 = var_x6 * var_x78 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2);
        const double var_x80 = var_x78 * NV_Ith_S(mParameters, 12);
        const double var_x81 = var_x8 * var_x80;
        const double var_x82 = var_x58 * var_x62;
        const double var_x83 = var_x63 * NV_Ith_S(mParameters, 7) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x84 = var_x82 * var_x83;
        const double var_x85 = var_x63 * NV_Ith_S(mParameters, 7) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x86 = (var_x27 - var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 21);
        const double var_x87 = var_x56 * var_x66;
        const double var_x88 = var_x77 * NV_Ith_S(mParameters, 9);
        const double var_x89 = var_x3 * var_x75;
        const double var_x90 = var_x50 * NV_Ith_S(mParameters, 5) * NV_Ith_S(mParameters, 20) / var_x54;
        ...
        const double var_x108 = 0.066691050963179718 * NV_Ith_S(mParameters, 0);
        const double var_x109 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
        const double var_x110 = NV_Ith_S(mParameters, 2) / (pow(var_x109, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
        const double var_x111 = -var_chaste_interface__calcium_dynamics__Ca_i + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x112 = NV_Ith_S(mParameters, 2) / var_x109;
        ...
        const double var_x117 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x118 = exp(-3.7142857142857144 - var_x117);
        const double var_x119 = 1.0 + var_x118;
        const double var_x120 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + 1 / var_x119;
        ...
        const double var_x128 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x129 = 1.0 + var_x128;
        const double var_x130 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 + 1 / var_x129;
        ...
        const double var_x142 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        ...
        const double var_x155 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1 / pow(var_x154, 2);
        const double var_x156 = exp(-12.0 - var_x145);
        const double var_x157 = 1.0 + var_x156;
        const double var_x158 = var_x152 * var_x157;
        const double var_x159 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 14) - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x160 = var_chaste_interface__membrane__V < -40.0 + NV_Ith_S(mParameters, 14);
        const double var_x161 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 14));
        const double var_x162 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x163 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 14) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x164 = 1.0 + var_x163;
        const double var_x165 = 0.01 * NV_Ith_S(mParameters, 13);
        const double var_x166 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 14));
        const double var_x167 = 1.0 + var_x166;
        const double var_x168 = 1.0 - var_x165;
        const double var_x169 = var_x165 + var_x168 / pow(var_x167, 2);
        const double var_x170 = ((var_x160) ? (0.057000000000000002 * var_x159) : (0));
        const double var_x171 = ((var_x160) ? (310000.0 * var_x161 + 2.7000000000000002 * var_x162) : (5.9230769230769234 / var_x164));
        const double var_x172 = 0.26917900403768508 * var_x166 * var_x168 / pow(var_x167, 3);
        const double var_x173 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 14) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x174 = 1.0 + var_x173;
        const double var_x175 = exp(0.01052 * NV_Ith_S(mParameters, 14) - 0.01052 * var_chaste_interface__membrane__V);
        const double var_x176 = var_x175 / var_x174;
        const double var_x177 = exp(-3.2000000000000002 - var_x21 + 0.10000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x178 = 1.0 + var_x177;
        const double var_x179 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * NV_Ith_S(mParameters, 14));
        const double var_x180 = var_x179 / var_x178;
        const double var_x181 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x182 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 14) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x183 = -25428.0 * var_x181 - 6.9480000000000002e-6 * var_x182;
        const double var_x184 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 14));
        ...
        const double var_x189 = ((var_x160) ? (0.024240000000000001 * var_x176) : (0.59999999999999998 * var_x180));
        const double var_x190 = ((var_x160) ? (var_x187 * var_x188) : (0));
        const double var_x191 = exp(2.5 + var_x125);
        const double var_x192 = 1.0 + var_x191;
        const double var_x193 = 1 / var_x192;
        const double var_x194 = exp(1.0 + var_x145);
        ...
        const double var_x201 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x202 = 1.0 + var_x201;
        const double var_x203 = 1 / (var_x193 + 1.3999999999999999 * var_x200);
        const double var_x204 = exp(3.0 + var_x113);
        const double var_x205 = 1.0 + var_x204;
        const double var_x206 = 1 / var_x205;
        const double var_x207 = exp(1.3 + var_x114);
        const double var_x208 = 1.0 + var_x207;
        const double var_x209 = 1 / var_x208;
        const double var_x210 = pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2);
        const double var_x211 = exp(-3.2400000000000002 * var_x210);
        const double var_x212 = exp(2.8571428571428572 + var_x117);
        const double var_x213 = 1.0 + var_x212;
        const double var_x214 = var_x204 / pow(var_x205, 2);
        const double var_x215 = 1102.5 * var_x211;
        const double var_x216 = 1 / (20.0 + var_x215 + 200.0 * var_x209 + 180.0 * var_x206);
        const double var_x217 = exp(2.5 + var_x114);
        const double var_x218 = 1.0 + var_x217;
        const double var_x219 = 1 / var_x218;
        const double var_x220 = exp(-3.0375000000000001 * var_x210);
        const double var_x221 = exp(5.0 + var_x117);
        const double var_x222 = 1.0 + var_x221;
        const double var_x223 = 562.0 * var_x220;
        const double var_x224 = 1 / (var_x223 + 80.0 * var_x206 + 31.0 * var_x219);
        const double var_x225 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2);
        const double var_x226 = 1 / (1.0 + 399.99999999999994 * var_x225);
        const double var_x227 = 1 / (2.0 + 80.0 * var_x226);
        const double var_x228 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x225), 2);
        const double var_x229 = exp(5.5999999999999996 + var_x145);
        const double var_x230 = 1.0 + var_x229;
        const double var_x231 = exp(-4.4889999999999999 * pow((1 + 0.014925373134328358 * var_chaste_interface__membrane__V), 2));
        const double var_x232 = 1 / (8.0 + 1000.0 * var_x231);
        const double var_x233 = exp(3.3333333333333335 + var_x134);
        const double var_x234 = 1.0 + var_x233;
        const double var_x235 = exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_x236 = 1 / (0.80000000000000004 + 9.5 * var_x235);
        const double var_x237 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x238 = pow(var_x237, (-2));
        const double var_x239 = 1 / (1.0 + 3.0 * var_x238);
        const double var_x240 = var_x239;
        const double var_x241 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
        const double var_x242 = 1 / (1.0 + 2.25 * var_x241);
        const double var_x243 = 1 / (2.5 - 1.5 * var_x242);
        const double var_x244 = var_x225 * var_x243;
        const double var_x245 = 0.14999999999999999 * var_x244;
        const double var_x246 = 1 / (0.059999999999999998 + var_x245);
        const double var_x247 = var_chaste_interface__calcium_dynamics__R_prime * NV_Ith_S(mParameters, 1);
        const double var_x248 = var_x246 * var_x247;
        const double var_x249 = var_x245 * var_x248;
        const double var_x250 = 1 / (pow((0.44444444444444442 + var_x241), 2) * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3));
        const double var_x251 = -var_chaste_interface__calcium_dynamics__Ca_ss + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x252 = var_x251 / pow((1 - 0.59999999999999998 * var_x242), 2);
        const double var_x253 = var_x225 * var_x248 * var_x250 * var_x252;
        const double var_x254 = var_x247 * var_x252 / pow((0.40000000000000002 + var_x244), 2);
        const double var_x255 = var_x243 * var_x250 * var_x254 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4);
        const double var_x256 = var_x254 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3);
        const double var_x257 = var_chaste_interface__calcium_dynamics__Ca_ss * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x258 = var_x246 * var_x251 * NV_Ith_S(mParameters, 1);
        const double var_x259 = var_x243 * var_x257 * var_x258;
        const double var_x260 = var_x61 * NV_Ith_S(mParameters, 11);
        const double var_x261 = 1369.1986401882032 * var_x260;
        const double var_x262 = 0.00025000000000000001 + var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x263 = 1.0 + 0.0001 / pow(var_x262, 2);
        const double var_x264 = 1 / var_x263;
        const double var_x265 = var_x264;
        const double var_x266 = var_x261 * var_x264 * var_x58;
        const double var_x267 = var_x266 * var_x83;
        const double var_x268 = 3.0010972933430868 * var_x244;
        const double var_x269 = var_x248 * var_x268;
        const double var_x270 = -0.11249999999999999 + 0.067500000000000004 * var_x242;
        const double var_x271 = NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 3);
        const double var_x272 = 0.00063181349969740233 * var_x271;
        const double var_x273 = var_x272 * var_x7 * var_x80;
        const double var_x274 = 2.7188924024856265e-5 * var_x48;
        const double var_x275 = 0.00027188924024856262 * var_x271;
        const double var_x276 = var_x272 * var_x28;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (0.0025819888974716113 * var_x42 - var_x2 - var_x3 - var_x39 - var_x5 - var_x55 - NV_Ith_S(mParameters, 8) - NV_Ith_S(mParameters, 9) - 0.0024332029034784559 * var_x44 - 270.40908135076944 * var_x67 - 0.043033148291193521 * var_x26 - 0.16722408026755853 * var_x29 - var_x11 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x46 * var_x49 - var_x59 * var_x62 - var_x6 * var_x8 + 1081.6363254030778 * var_x61 * var_x65);
        IJth(rJacobian, 1, 0) = var_x107 * (0.00063181349969740233 * var_x39 + 1.5373304419206038e-6 * var_x44 - 0.00031590674984870116 * NV_Ith_S(mParameters, 8)) * NV_Ith_S(mParameters, 11);
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x116 * var_x120 * var_x121 + 0.14285714285714285 * var_x118 * var_x123 / pow(var_x119, 2) - 0.10000000000000001 * var_x115 * var_x120 * var_x122;
        IJth(rJacobian, 3, 0) = 0.01488095238095238 * var_x127 * var_x130 * var_x131 - 0.041666666666666664 * var_x128 * var_x133 / pow(var_x129, 2) - 0.050000000000000003 * var_x126 * var_x130 * var_x132;
        IJth(rJacobian, 4, 0) = 5.1020408163265302e-7 * (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1 / var_x143) * (93.333333333333329 * var_x137 * var_x138 / pow(var_x139, 2) - 116.66666666666667 * var_x135 * var_x140 / pow(var_x136, (3 / 2))) / pow((0.057142857142857141 + var_x141), 2) + 0.071428571428571425 * var_x142 * var_x144 / pow(var_x143, 2);
        ...
        IJth(rJacobian, 6, 0) = (var_x169 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x160) ? (-0.008382352941176471 * var_x159) : (0)) + ((var_x160) ? (108035.0 * var_x161 + 0.21330000000000002 * var_x162) : (0.53361053361053368 * var_x163 / pow(var_x164, 2)))) - var_x172 * (var_x170 + var_x171);
        IJth(rJacobian, 7, 0) = (var_x169 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x160) ? (-0.00025500480000000003 * var_x176 + 0.0033402720000000005 * var_x173 * var_x175 / pow(var_x174, 2)) : (0.034200000000000001 * var_x180 + 0.059999999999999998 * var_x177 * var_x179 / pow(var_x178, 2))) + ((var_x160) ? (var_x187 + var_x186 * var_x188 * (3.0508668000000001e-7 * var_x182 - 6214.6032000000005 * var_x181) - 0.311 * var_x183 * var_x184 * var_x188 / pow(var_x185, 2)) : (0))) - var_x172 * (var_x189 + var_x190);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x202) * (-0.050000000000000003 * var_x191 / pow(var_x192, 2) + 0.27999999999999997 * var_x194 * var_x199 / pow(var_x195, 2) - 0.15076923076923074 * var_x196 * var_x197 / pow(var_x198, 2)) / pow((var_x200 + 0.7142857142857143 * var_x193), 2) + 0.13333333333333333 * var_x201 * var_x203 / pow(var_x202, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x213) * (18.0 * var_x214 - var_x215 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x207 / pow(var_x208, 2)) / pow((0.018140589569160998 + var_x211 + 0.16326530612244897 * var_x206 + 0.18140589569160998 * var_x209), 2) - 0.14285714285714285 * var_x212 * var_x216 / pow(var_x213, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x222) * (8.0 * var_x214 - var_x223 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x217 / pow(var_x218, 2)) / pow((var_x220 + 0.055160142348754451 * var_x219 + 0.14234875444839859 * var_x206), 2) - 0.095714285714285724 * var_x221 * var_x224 / pow(var_x222, 2);
        IJth(rJacobian, 12, 0) = -0.20000000000000001 * var_x229 * var_x232 / pow(var_x230, 2) - 0.001 * var_x231 * (-0.13400000000000001 - 0.002 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x230) / pow((0.0080000000000000002 + var_x231), 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x233 * var_x236 / pow(var_x234, 2) - 0.10526315789473684 * var_x235 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x234) / pow((0.084210526315789472 + var_x235), 2);
        IJth(rJacobian, 15, 0) = var_x265 * (-var_x261 * var_x59 + 102.50886482291351 * var_x260 * var_x65 - 25.627216205728377 * var_x67 * NV_Ith_S(mParameters, 11));
        IJth(rJacobian, 17, 0) = var_x271 * (-0.0018954404990922068 * var_x39 - 0.0018954404990922068 * var_x55 - 4.6119913257618111e-6 * var_x44 - 0.00063181349969740233 * var_x92 - 0.00063181349969740233 * NV_Ith_S(mParameters, 9));
        IJth(rJacobian, 18, 0) = var_x271 * (0.0012636269993948047 * var_x55 + 1.631335441491376e-6 * var_x42 - 0.00027188924024856262 * var_x99 - 2.7188924024856265e-5 * var_x26 - 0.00010565443138752546 * var_x29 - 0.00063181349969740233 * var_x2 - 0.00063181349969740233 * var_x3 - 0.00063181349969740233 * var_x5 - var_x274 * var_x46);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x72 + 2.5 * var_x73 - var_x69 - 13.356880329847826 * var_x71);
        IJth(rJacobian, 1, 1) = var_x107 * (-0.0038 - var_x108 - 8.3363813703974642e-9 * var_x110 + (0.00031590674984870116 * var_x72 - 0.0042195286531202733 * var_x71 - 0.0015795337492435057 * var_x73 - 0.00031590674984870116 * var_x69) * NV_Ith_S(mParameters, 11)) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss - 0.0038 * var_chaste_interface__calcium_dynamics__Ca_i - 0.066691050963179718 * var_x112 + var_x108 * var_x111 - 0.00031590674984870116 * (var_x69 * var_chaste_interface__calcium_dynamics__Ca_i + (-13.356880329847826 * log(var_x70 * NV_Ith_S(mParameters, 4)) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 8) - 2.0 * var_x38 * var_x43) * NV_Ith_S(mParameters, 11)) / (pow(var_x104, 3) * pow(var_x105, 2));
        IJth(rJacobian, 14, 1) = var_x240 * (1.2499999999999999e-7 * var_x110 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 15, 1) = 1.1399999999999999 * var_x264;
        IJth(rJacobian, 17, 1) = 0.0047386012477305169 * var_x271 * var_x73;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x28);
        IJth(rJacobian, 2, 2) = -var_x123;
        IJth(rJacobian, 18, 2) = -var_x10 * var_x275 * var_x28;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.43033148291193518 * var_x74);
        IJth(rJacobian, 3, 3) = -var_x133;
        IJth(rJacobian, 18, 3) = -var_x275 * var_x74;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-2.0 * var_x76);
        IJth(rJacobian, 4, 4) = -var_x144;
        IJth(rJacobian, 18, 4) = -0.0012636269993948047 * var_x271 * var_x76;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x79);
        IJth(rJacobian, 5, 5) = -var_x158;
        IJth(rJacobian, 17, 5) = -0.0018954404990922068 * var_x271 * var_x79;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x81 * var_chaste_interface__fast_sodium_current_j_gate__j);
        IJth(rJacobian, 6, 6) = -var_x170 - var_x171;
        IJth(rJacobian, 17, 6) = -var_x273 * var_chaste_interface__fast_sodium_current_j_gate__j;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x81 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 7, 7) = -var_x189 - var_x190;
        IJth(rJacobian, 17, 7) = -var_x273 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * var_x82);
        IJth(rJacobian, 8, 8) = -var_x203;
        IJth(rJacobian, 15, 8) = -var_x266 * var_x64;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x84 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 9, 9) = -var_x216;
        IJth(rJacobian, 15, 9) = -var_x267 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x84 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 10, 10) = -var_x224;
        IJth(rJacobian, 15, 10) = -var_x267 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x82 * var_x85);
        IJth(rJacobian, 11, 11) = -var_x227;
        IJth(rJacobian, 15, 11) = -var_x266 * var_x85;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 12, 12) = -var_x232;
        IJth(rJacobian, 18, 12) = -var_x276 * var_x4;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 13, 13) = -var_x236;
        IJth(rJacobian, 18, 13) = -var_x276 * NV_Ith_S(mParameters, 21) * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 14) = var_x106 * var_x108;
        IJth(rJacobian, 14, 14) = var_x240 * (-var_x249 - NV_Ith_S(mParameters, 0) + 0.21333333333333335 * var_x255 - 0.032000000000000001 * var_x253) + 0.66666666666666674 * (var_x112 - var_x111 * NV_Ith_S(mParameters, 0) - var_x249 * var_x251) / (pow(var_x237, 3) * pow((0.33333333333333337 + var_x238), 2));
        IJth(rJacobian, 15, 14) = var_x265 * (var_x269 + 0.64023408924652514 * var_x253 - 4.2682272616435011 * var_x255);
        IJth(rJacobian, 16, 14) = 0.059999999999999998 * var_x250 * var_x257;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-3611.8217397063127 * var_x87);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x106;
        IJth(rJacobian, 11, 15) = -0.0030000000000000001 * var_x227 * var_x228 + 6.2500000000000001e-5 * var_x228 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x226) / pow((0.025000000000000001 + var_x226), 2);
        IJth(rJacobian, 14, 15) = var_x240 * (var_x249 + 0.32000000000000001 * var_x256 - 0.29999999999999999 * var_x259);
        IJth(rJacobian, 15, 15) = var_x265 * (-1.1399999999999999 - var_x269 + 6.0021945866861737 * var_x259 - 6.4023408924652525 * var_x256 - 342.29966004705079 * var_x87 * NV_Ith_S(mParameters, 11)) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x251 * var_x269 - var_x261 * var_x66) / (pow(var_x262, 3) * pow(var_x263, 2));
        IJth(rJacobian, 16, 15) = var_x270 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -var_x239 * var_x245 * var_x258;
        IJth(rJacobian, 15, 16) = var_x258 * var_x264 * var_x268;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x270 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (0.00062500000000000001 * var_x94 - var_x91 - 3.0 * var_x95 - 26.713760659695652 * var_x88 - 26.713760659695652 * var_x93 - 0.80141281979086942 * var_x89);
        IJth(rJacobian, 1, 17) = 0.0018954404990922068 * var_x106 * var_x95 * NV_Ith_S(mParameters, 11);
        IJth(rJacobian, 17, 17) = var_x271 * (1.1846503119326294e-6 * var_x94 - 0.0018954404990922068 * var_x91 - 0.016878114612481093 * var_x88 - 0.016878114612481093 * var_x93 - 0.0056863214972766203 * var_x95);
        IJth(rJacobian, 18, 17) = var_x271 * (0.0012636269993948047 * var_x91 - 0.00050634343837443281 * var_x89 - 7.8976687462175284e-7 * var_x94);
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (0.068974633433048077 * var_x103 - 26.713760659695652 * var_x89 - 26.713760659695652 * var_x96 - 26.713760659695652 * var_x97 - 1.1495772238841346 * var_x98 - 11.495772238841345 * var_x100 - var_x102 * var_x49);
        IJth(rJacobian, 18, 18) = var_x271 * (4.357910453967955e-5 * var_x103 - 0.016878114612481093 * var_x89 - 0.016878114612481093 * var_x96 - 0.016878114612481093 * var_x97 - 0.00072631840899465921 * var_x98 - 0.0072631840899465916 * var_x100 - var_x102 * var_x274);
    }

    N_Vector Cellten_tusscher_model_2006_endoFromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2006_endoFromCellMLCvode>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellten_tusscher_model_2006_endoFromCellMLCvode)
