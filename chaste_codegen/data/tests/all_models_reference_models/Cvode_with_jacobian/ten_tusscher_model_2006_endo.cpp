...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x71 = 1 / (1.0 + NV_Ith_S(mParameters, 5));
        ...
        const double var_x76 = var_x71 * var_x72 * (0.001321416346042915 * var_x73 + 0.00046605194074318115 * var_x74) * NV_Ith_S(mParameters, 5) * var_chaste_interface__sodium_dynamics__Na_i * NV_Ith_S(mParameters, 20) / pow(var_x75, 2);
        ...
        const double var_x88 = var_x6 * var_x87 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2);
        const double var_x89 = var_x87 * NV_Ith_S(mParameters, 12);
        const double var_x90 = var_x8 * var_x89;
        const double var_x91 = 1.3356880330661625e-6 * var_x54;
        const double var_x92 = ((var_x59) ? (var_x91 - 374338.90820464725 * (-15.000001335688033 + var_chaste_interface__membrane__V) * (-var_x91 - 1.3356880330661625e-6 * var_x57)) : (var_x58 * var_x64));
        const double var_x93 = var_x92 * NV_Ith_S(mParameters, 7) * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x94 = 14447.286958825251 * var_x93;
        const double var_x95 = var_x68 * var_x92 * NV_Ith_S(mParameters, 7);
        const double var_x96 = 14447.286958825251 * var_x95;
        const double var_x97 = (var_x27 - var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 21);
        const double var_x98 = 3.3392200826654062e-7 * var_x50 * var_x51;
        const double var_x99 = ((var_x59) ? (var_x98 + (5615084.1230697082 - 374338.90820464725 * var_chaste_interface__membrane__V) * (-var_x98 - 3.3392200826654062e-7 * var_x55 * var_x56)) : (0.25 * var_x66));
        const double var_x100 = var_x86 * NV_Ith_S(mParameters, 9);
        const double var_x101 = var_x3 * var_x84;
        const double var_x102 = var_x71 * NV_Ith_S(mParameters, 5) * NV_Ith_S(mParameters, 20) / var_x75;
        ...
        const double var_x120 = 0.066691050963179718 * NV_Ith_S(mParameters, 0);
        const double var_x121 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
        const double var_x122 = NV_Ith_S(mParameters, 2) / (pow(var_x121, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
        const double var_x123 = -var_chaste_interface__calcium_dynamics__Ca_i + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x124 = NV_Ith_S(mParameters, 2) / var_x121;
        ...
        const double var_x129 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x130 = exp(-3.7142857142857144 - var_x129);
        const double var_x131 = 1.0 + var_x130;
        const double var_x132 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + 1 / var_x131;
        ...
        const double var_x140 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x141 = 1.0 + var_x140;
        const double var_x142 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 + 1 / var_x141;
        ...
        const double var_x154 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        ...
        const double var_x165 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x166 = 1.0 + var_x165;
        const double var_x167 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1 / pow(var_x166, 2);
        const double var_x168 = exp(-12.0 - var_x157);
        const double var_x169 = 1.0 + var_x168;
        const double var_x170 = var_x164 * var_x169;
        const double var_x171 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 14) - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x172 = var_chaste_interface__membrane__V < -40.0 + NV_Ith_S(mParameters, 14);
        const double var_x173 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 14));
        const double var_x174 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x175 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 14) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x176 = 1.0 + var_x175;
        const double var_x177 = 0.01 * NV_Ith_S(mParameters, 13);
        const double var_x178 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 14));
        const double var_x179 = 1.0 + var_x178;
        const double var_x180 = 1.0 - var_x177;
        const double var_x181 = var_x177 + var_x180 / pow(var_x179, 2);
        ...
        const double var_x184 = 0.26917900403768508 * var_x178 * var_x180 / pow(var_x179, 3);
        const double var_x185 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 14) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x186 = 1.0 + var_x185;
        const double var_x187 = exp(0.01052 * NV_Ith_S(mParameters, 14) - 0.01052 * var_chaste_interface__membrane__V);
        const double var_x188 = var_x187 / var_x186;
        const double var_x189 = exp(-3.2000000000000002 - var_x21 + 0.10000000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x190 = 1.0 + var_x189;
        const double var_x191 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * NV_Ith_S(mParameters, 14));
        const double var_x192 = var_x191 / var_x190;
        const double var_x193 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 14));
        const double var_x194 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 14) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x195 = -25428.0 * var_x193 - 6.9480000000000002e-6 * var_x194;
        const double var_x196 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 14));
        ...
        const double var_x213 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x224 = exp(2.8571428571428572 + var_x129);
        const double var_x225 = 1.0 + var_x224;
        const double var_x226 = var_x216 / pow(var_x217, 2);
        ...
        const double var_x233 = exp(5.0 + var_x129);
        ...
        const double var_x240 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x237), 2);
        const double var_x241 = exp(5.5999999999999996 + var_x157);
        ...
        const double var_x245 = exp(3.3333333333333335 + var_x146);
        ...
        const double var_x277 = var_x276 * var_x93;
        const double var_x278 = var_x276 * var_x95;
        ...
        const double var_x285 = var_x284 * var_x7 * var_x89;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (0.0025819888974716113 * var_x42 - var_x2 - var_x3 - var_x39 - var_x5 - var_x76 - NV_Ith_S(mParameters, 8) - NV_Ith_S(mParameters, 9) - 0.0024332029034784559 * var_x44 - 0.043033148291193521 * var_x26 - 0.16722408026755853 * var_x29 - var_x11 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x46 * var_x49 - var_x6 * var_x8 - var_x67 * var_x70);
        IJth(rJacobian, 1, 0) = var_x119 * (0.00063181349969740233 * var_x39 + 1.5373304419206038e-6 * var_x44 - 0.00031590674984870116 * NV_Ith_S(mParameters, 8)) * NV_Ith_S(mParameters, 11);
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x128 * var_x132 * var_x133 + 0.14285714285714285 * var_x130 * var_x135 / pow(var_x131, 2) - 0.10000000000000001 * var_x127 * var_x132 * var_x134;
        IJth(rJacobian, 3, 0) = 0.01488095238095238 * var_x139 * var_x142 * var_x143 - 0.041666666666666664 * var_x140 * var_x145 / pow(var_x141, 2) - 0.050000000000000003 * var_x138 * var_x142 * var_x144;
        IJth(rJacobian, 4, 0) = 5.1020408163265302e-7 * (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1 / var_x155) * (93.333333333333329 * var_x149 * var_x150 / pow(var_x151, 2) - 116.66666666666667 * var_x147 * var_x152 / pow(var_x148, (3 / 2))) / pow((0.057142857142857141 + var_x153), 2) + 0.071428571428571425 * var_x154 * var_x156 / pow(var_x155, 2);
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x165 * var_x170 / pow(var_x166, 3) - 0.20000000000000001 * var_x164 * var_x167 * var_x168 + 99.999999999999986 * var_x167 * var_x169 * (0.02 * var_x158 / pow(var_x159, 2) + 0.00050000000000000001 * var_x161 / pow(var_x162, 2)) / pow((var_x160 + var_x163), 2);
        IJth(rJacobian, 6, 0) = (var_x181 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x172) ? (-0.008382352941176471 * var_x171) : (0)) + ((var_x172) ? (108035.0 * var_x173 + 0.21330000000000002 * var_x174) : (0.53361053361053368 * var_x175 / pow(var_x176, 2)))) - var_x184 * (var_x182 + var_x183);
        IJth(rJacobian, 7, 0) = (var_x181 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x172) ? (-0.00025500480000000003 * var_x188 + 0.0033402720000000005 * var_x185 * var_x187 / pow(var_x186, 2)) : (0.034200000000000001 * var_x192 + 0.059999999999999998 * var_x189 * var_x191 / pow(var_x190, 2))) + ((var_x172) ? (var_x199 + var_x198 * var_x200 * (3.0508668000000001e-7 * var_x194 - 6214.6032000000005 * var_x193) - 0.311 * var_x195 * var_x196 * var_x200 / pow(var_x197, 2)) : (0))) - var_x184 * (var_x201 + var_x202);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x214) * (-0.050000000000000003 * var_x203 / pow(var_x204, 2) + 0.27999999999999997 * var_x206 * var_x211 / pow(var_x207, 2) - 0.15076923076923074 * var_x208 * var_x209 / pow(var_x210, 2)) / pow((var_x212 + 0.7142857142857143 * var_x205), 2) + 0.13333333333333333 * var_x213 * var_x215 / pow(var_x214, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x225) * (18.0 * var_x226 - var_x227 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x219 / pow(var_x220, 2)) / pow((0.018140589569160998 + var_x223 + 0.16326530612244897 * var_x218 + 0.18140589569160998 * var_x221), 2) - 0.14285714285714285 * var_x224 * var_x228 / pow(var_x225, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x234) * (8.0 * var_x226 - var_x235 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x229 / pow(var_x230, 2)) / pow((var_x232 + 0.055160142348754451 * var_x231 + 0.14234875444839859 * var_x218), 2) - 0.095714285714285724 * var_x233 * var_x236 / pow(var_x234, 2);
        IJth(rJacobian, 12, 0) = -0.20000000000000001 * var_x241 * var_x244 / pow(var_x242, 2) - 0.001 * var_x243 * (-0.13400000000000001 - 0.002 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x242) / pow((0.0080000000000000002 + var_x243), 2);
        ...
        IJth(rJacobian, 15, 0) = -var_x276 * var_x67 * var_x69;
        IJth(rJacobian, 17, 0) = var_x283 * (-0.0018954404990922068 * var_x39 - 0.0018954404990922068 * var_x76 - 4.6119913257618111e-6 * var_x44 - 0.00063181349969740233 * var_x104 - 0.00063181349969740233 * NV_Ith_S(mParameters, 9));
        IJth(rJacobian, 18, 0) = var_x283 * (0.0012636269993948047 * var_x76 + 1.631335441491376e-6 * var_x42 - 0.00027188924024856262 * var_x111 - 2.7188924024856265e-5 * var_x26 - 0.00010565443138752546 * var_x29 - 0.00063181349969740233 * var_x2 - 0.00063181349969740233 * var_x3 - 0.00063181349969740233 * var_x5 - var_x286 * var_x46);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x81 + 2.5 * var_x82 - var_x78 - 13.356880329847826 * var_x80);
        IJth(rJacobian, 1, 1) = var_x119 * (-0.0038 - var_x120 - 8.3363813703974642e-9 * var_x122 + (0.00031590674984870116 * var_x81 - 0.0042195286531202733 * var_x80 - 0.0015795337492435057 * var_x82 - 0.00031590674984870116 * var_x78) * NV_Ith_S(mParameters, 11)) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss - 0.0038 * var_chaste_interface__calcium_dynamics__Ca_i - 0.066691050963179718 * var_x124 + var_x120 * var_x123 - 0.00031590674984870116 * (var_x78 * var_chaste_interface__calcium_dynamics__Ca_i + (-13.356880329847826 * log(var_x79 * NV_Ith_S(mParameters, 4)) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 8) - 2.0 * var_x38 * var_x43) * NV_Ith_S(mParameters, 11)) / (pow(var_x116, 3) * pow(var_x117, 2));
        IJth(rJacobian, 14, 1) = var_x252 * (1.2499999999999999e-7 * var_x122 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 15, 1) = 1.1399999999999999 * var_x274;
        IJth(rJacobian, 17, 1) = 0.0047386012477305169 * var_x283 * var_x82;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x28);
        IJth(rJacobian, 2, 2) = -var_x135;
        ...
        IJth(rJacobian, 3, 3) = -var_x145;
        IJth(rJacobian, 18, 3) = -var_x287 * var_x83;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-2.0 * var_x85);
        IJth(rJacobian, 4, 4) = -var_x156;
        IJth(rJacobian, 18, 4) = -0.0012636269993948047 * var_x283 * var_x85;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x88);
        IJth(rJacobian, 5, 5) = -var_x170;
        IJth(rJacobian, 17, 5) = -0.0018954404990922068 * var_x283 * var_x88;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x90 * var_chaste_interface__fast_sodium_current_j_gate__j);
        IJth(rJacobian, 6, 6) = -var_x182 - var_x183;
        IJth(rJacobian, 17, 6) = -var_x285 * var_chaste_interface__fast_sodium_current_j_gate__j;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x90 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 7, 7) = -var_x201 - var_x202;
        IJth(rJacobian, 17, 7) = -var_x285 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x94 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 8, 8) = -var_x215;
        IJth(rJacobian, 15, 8) = -var_x277 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x94 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 9, 9) = -var_x228;
        IJth(rJacobian, 15, 9) = -var_x277 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x96 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass);
        IJth(rJacobian, 10, 10) = -var_x236;
        IJth(rJacobian, 15, 10) = -var_x278 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x96 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 11, 11) = -var_x239;
        IJth(rJacobian, 15, 11) = -var_x278 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x97 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 12, 12) = -var_x244;
        IJth(rJacobian, 18, 12) = -var_x288 * var_x4;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x97 * var_chaste_interface__transient_outward_current_s_gate__s);
        ...
        IJth(rJacobian, 1, 14) = var_x118 * var_x120;
        IJth(rJacobian, 14, 14) = var_x252 * (-var_x261 - NV_Ith_S(mParameters, 0) + 0.21333333333333335 * var_x267 - 0.032000000000000001 * var_x265) + 0.66666666666666674 * (var_x124 - var_x123 * NV_Ith_S(mParameters, 0) - var_x261 * var_x263) / (pow(var_x249, 3) * pow((0.33333333333333337 + var_x250), 2));
        ...
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x70 * var_x99);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x118;
        IJth(rJacobian, 11, 15) = -0.0030000000000000001 * var_x239 * var_x240 + 6.2500000000000001e-5 * var_x240 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x238) / pow((0.025000000000000001 + var_x238), 2);
        IJth(rJacobian, 14, 15) = var_x252 * (var_x261 + 0.32000000000000001 * var_x268 - 0.29999999999999999 * var_x271);
        IJth(rJacobian, 15, 15) = var_x281 * (-1.1399999999999999 - var_x280 + 6.0021945866861737 * var_x271 - 6.4023408924652525 * var_x268 - var_x275 * var_x69 * var_x99) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x263 * var_x280 - var_x275 * var_x68 * var_x93) / (pow(var_x272, 3) * pow(var_x273, 2));
        ...
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (0.00062500000000000001 * var_x106 - var_x103 - 3.0 * var_x107 - 26.713760659695652 * var_x100 - 26.713760659695652 * var_x105 - 0.80141281979086942 * var_x101);
        IJth(rJacobian, 1, 17) = 0.0018954404990922068 * var_x107 * var_x118 * NV_Ith_S(mParameters, 11);
        IJth(rJacobian, 17, 17) = var_x283 * (1.1846503119326294e-6 * var_x106 - 0.0018954404990922068 * var_x103 - 0.016878114612481093 * var_x100 - 0.016878114612481093 * var_x105 - 0.0056863214972766203 * var_x107);
        IJth(rJacobian, 18, 17) = var_x283 * (0.0012636269993948047 * var_x103 - 0.00050634343837443281 * var_x101 - 7.8976687462175284e-7 * var_x106);
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (0.068974633433048077 * var_x115 - 26.713760659695652 * var_x101 - 26.713760659695652 * var_x108 - 26.713760659695652 * var_x109 - 1.1495772238841346 * var_x110 - 11.495772238841345 * var_x112 - var_x114 * var_x49);
        IJth(rJacobian, 18, 18) = var_x283 * (4.357910453967955e-5 * var_x115 - 0.016878114612481093 * var_x101 - 0.016878114612481093 * var_x108 - 0.016878114612481093 * var_x109 - 0.00072631840899465921 * var_x110 - 0.0072631840899465916 * var_x112 - var_x114 * var_x286);
    }
