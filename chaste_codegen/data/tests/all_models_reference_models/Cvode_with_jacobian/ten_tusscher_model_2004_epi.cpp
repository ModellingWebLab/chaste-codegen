...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x199 = 0.01 * NV_Ith_S(mParameters, 14);
        const double var_x200 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 15));
        const double var_x201 = 1.0 + var_x200;
        const double var_x202 = 1.0 - var_x199;
        const double var_x203 = var_x199 + var_x202 / pow(var_x201, 2);
        ...
        const double var_x206 = 0.26917900403768508 * var_x200 * var_x202 / pow(var_x201, 3);
        ...
        const double var_x235 = exp(-0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x242 = exp(2.8571428571428572 + var_x154);
        ...
        const double var_x253 = 1 / NV_Ith_S(mParameters, 8);
        ...
        const double var_x269 = var_x268 * (-0.0082319999999999997 - var_x143);
        ...
        const double var_x277 = 0.00027188924024856262 * var_x274;
        const double var_x278 = var_x275 * var_x52;
        ...
        IJth(rJacobian, 6, 0) = (var_x203 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x194) ? (-0.008382352941176471 * var_x193) : (0)) + ((var_x194) ? (108035.0 * var_x195 + 0.21330000000000002 * var_x196) : (0.53361053361053368 * var_x197 / pow(var_x198, 2)))) - var_x206 * (var_x204 + var_x205);
        IJth(rJacobian, 7, 0) = (var_x203 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x194) ? (-0.00025500480000000003 * var_x210 + 0.0033402720000000005 * var_x207 * var_x209 / pow(var_x208, 2)) : (0.034200000000000001 * var_x214 + 0.059999999999999998 * var_x211 * var_x213 / pow(var_x212, 2))) + ((var_x194) ? (var_x221 + var_x220 * var_x222 * (3.0508668000000001e-7 * var_x216 - 6214.6032000000005 * var_x215) - 0.311 * var_x217 * var_x218 * var_x222 / pow(var_x219, 2)) : (0))) - var_x206 * (var_x223 + var_x224);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x236) * (-0.050000000000000003 * var_x225 / pow(var_x226, 2) + 0.27999999999999997 * var_x228 * var_x233 / pow(var_x229, 2) - 0.15076923076923074 * var_x230 * var_x231 / pow(var_x232, 2)) / pow((var_x234 + 0.7142857142857143 * var_x227), 2) + 0.13333333333333333 * var_x235 * var_x237 / pow(var_x236, 2);
        IJth(rJacobian, 9, 0) = 7.9012345679012348e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x243) * (-var_x244 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 16.5 * var_x238 / pow(var_x239, 2)) / pow((0.071111111111111111 + var_x241 + 0.14666666666666667 * var_x240), 2) - 0.14285714285714285 * var_x242 * var_x245 / pow(var_x243, 2);
        IJth(rJacobian, 11, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x259) * (-var_x260 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + var_x254 / pow(var_x255, 2)) / pow((0.035294117647058823 + var_x257 + 0.058823529411764705 * var_x256), 2) - 0.20000000000000001 * var_x258 * var_x261 / pow(var_x259, 2);
        ...
        IJth(rJacobian, 15, 0) = var_x274 * (-0.0018954404990922068 * var_x63 - 0.0018954404990922068 * var_x79 - 4.6119913257618111e-6 * var_x68 - 0.00063181349969740233 * var_x32 - 0.00063181349969740233 * NV_Ith_S(mParameters, 10));
        IJth(rJacobian, 16, 0) = var_x274 * (0.0012636269993948047 * var_x79 + 1.631335441491376e-6 * var_x66 - 0.00027188924024856262 * var_x124 - 2.7188924024856265e-5 * var_x50 - 0.00010565443138752546 * var_x53 - 0.00063181349969740233 * var_x26 - 0.00063181349969740233 * var_x27 - 0.00063181349969740233 * var_x29 - var_x276 * var_x70);
        ...
        IJth(rJacobian, 10, 1) = ((var_x252) ? (0) : (var_x253 * (-6.8203084950904297e-28 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 7) / pow((1.2447063003540035e-28 + var_x251), 2) - 171.23287671232876 * var_x249 / pow(var_x250, 2) - 684.93150684931504 * var_x247 / pow(var_x248, 2))));
        IJth(rJacobian, 13, 1) = var_x268 * (var_x135 + NV_Ith_S(mParameters, 0));
        ...
        IJth(rJacobian, 15, 5) = -0.0018954404990922068 * var_x274 * var_x98;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x99);
        IJth(rJacobian, 6, 6) = -var_x204 - var_x205;
        IJth(rJacobian, 15, 6) = -var_x275 * var_x99;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x100);
        IJth(rJacobian, 7, 7) = -var_x223 - var_x224;
        IJth(rJacobian, 15, 7) = -var_x100 * var_x275;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x105);
        IJth(rJacobian, 1, 8) = var_x132 * (var_x145 - var_x105 * var_x139);
        IJth(rJacobian, 8, 8) = -var_x237;
        ...
        IJth(rJacobian, 10, 10) = ((var_x252) ? (0) : (-var_x253));
        ...
        IJth(rJacobian, 16, 12) = -var_x113 * var_x278;
        IJth(rJacobian, 1, 13) = var_x132 * (var_x150 * (var_x149 - var_x148) + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 13, 13) = var_x268 * (var_x133 + var_x150 * (var_x148 - var_x149)) + 9.9963436928702016 * (var_x137 - var_x136 - var_x146) / (pow(var_x266, 3) * pow((0.33333333333333337 + var_x267), 2));
        ...
        IJth(rJacobian, 15, 15) = var_x274 * (1.1846503119326294e-6 * var_x119 - 0.0018954404990922068 * var_x117 - 0.016878114612481093 * var_x114 - 0.016878114612481093 * var_x118 - 0.0056863214972766203 * var_x120);
        IJth(rJacobian, 16, 15) = var_x274 * (0.0012636269993948047 * var_x117 - 0.00050634343837443281 * var_x115 - 7.8976687462175284e-7 * var_x119);
        ...
        IJth(rJacobian, 16, 16) = var_x274 * (4.357910453967955e-5 * var_x128 - 0.016878114612481093 * var_x115 - 0.016878114612481093 * var_x121 - 0.016878114612481093 * var_x122 - 0.00072631840899465921 * var_x123 - 0.0072631840899465916 * var_x125 - var_x127 * var_x276);
    }
