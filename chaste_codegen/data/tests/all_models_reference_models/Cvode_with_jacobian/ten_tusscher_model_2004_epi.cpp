...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x234 = var_x233 * (-0.0082319999999999997 - var_x110);
        ...
        const double var_x241 = (0.0031224512033090025 * var_x13 - 0.00011688549744401942 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2);
        const double var_x242 = 0.0031224512033090025 * var_x13 - 0.00011688549744401942 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 11, 0) = 0.00013840830449826991 * (1 / var_x224 - var_chaste_interface__transient_outward_current_s_gate__s) * (-var_x225 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + 1.0 * var_x219 / pow(var_x220, 2)) / pow((0.035294117647058823 + var_x222 + 0.058823529411764705 * var_x221), 2) - 0.20000000000000001 * var_x223 * var_x226 / pow(var_x224, 2);
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x227 * var_x230 / pow(var_x228, 2) - 0.10526315789473684 * var_x229 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (1 / var_x228 - var_chaste_interface__transient_outward_current_r_gate__r) / pow((0.084210526315789472 + var_x229), 2);
        ...
        IJth(rJacobian, 16, 0) = 0.00026864670518789814 * var_x49 + 3.79059668210955e-6 * var_x40 - 2.8537261917770623e-7 * var_x31 - 0.00011688549744401942 * var_x28 - 6.3176611368492499e-5 * var_x26 - 1.7065282626826835e-6 * var_x3 - 2.8636946873784758e-5 * var_x0 - 0.00011688549744401942 * var_x34 - var_x240 * var_x42;
        ...
        IJth(rJacobian, 13, 1) = var_x233 * (8.0000000000000007e-5 + var_x102);
        IJth(rJacobian, 14, 1) = ((var_x239) ? (0) : ((var_x236) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5) / pow((1.8382656249999998e-21 + var_x237), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15) / pow((5.0709427749024951e-56 + var_x238), 2))));
        ...
        IJth(rJacobian, 16, 2) = var_x241 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        IJth(rJacobian, 16, 3) = var_x241 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        IJth(rJacobian, 13, 8) = var_x234 * var_chaste_interface__calcium_dynamics__g;
        ...
        IJth(rJacobian, 16, 11) = var_x242 * var_x27;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x81 * var_x82);
        IJth(rJacobian, 12, 12) = -var_x230;
        IJth(rJacobian, 16, 12) = var_x242 * var_x82;
        IJth(rJacobian, 1, 13) = var_x98 * (8.0000000000000007e-5 + var_x118 * (var_x116 - var_x117));
        IJth(rJacobian, 13, 13) = var_x233 * (-8.0000000000000007e-5 + var_x118 * (var_x117 - var_x116)) + 9.9963436928702016 * (var_x105 + var_x106 - var_x104 - var_x113) / (pow(var_x231, 3) * pow((0.33333333333333337 + var_x232), 2));
        IJth(rJacobian, 1, 14) = var_x111 * var_x114;
        IJth(rJacobian, 13, 14) = var_x234 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 14, 14) = ((var_x239) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 16, 16) = 0.00010126109252331096 * var_x95 - 0.0031224512033090025 * var_x94 - 0.0016876848753885161 * var_x90 - 4.5587787568311439e-5 * var_x89 - 0.00076500054481070561 * var_x83 - 0.0031224512033090025 * var_x91 - var_x240 * var_x93;
    }
