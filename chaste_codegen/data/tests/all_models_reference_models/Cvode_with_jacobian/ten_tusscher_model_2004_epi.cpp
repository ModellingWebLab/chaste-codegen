...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x174 = 0.01 * NV_Ith_S(mParameters, 14);
        const double var_x175 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 15));
        ...
        const double var_x210 = exp(-0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x217 = exp(2.8571428571428572 + var_x129);
        ...
        const double var_x228 = 1 / NV_Ith_S(mParameters, 8);
        ...
        const double var_x244 = var_x243 * (-0.0082319999999999997 - var_x117);
        ...
        const double var_x253 = 0.00027188924024856262 * var_x250;
        const double var_x254 = var_x251 * var_x28;
        ...
        IJth(rJacobian, 9, 0) = 7.9012345679012348e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x218) * (-var_x219 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 16.5 * var_x213 / pow(var_x214, 2)) / pow((0.071111111111111111 + var_x216 + 0.14666666666666667 * var_x215), 2) - 0.14285714285714285 * var_x217 * var_x220 / pow(var_x218, 2);
        IJth(rJacobian, 11, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x234) * (-var_x235 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + var_x229 / pow(var_x230, 2)) / pow((0.035294117647058823 + var_x232 + 0.058823529411764705 * var_x231), 2) - 0.20000000000000001 * var_x233 * var_x236 / pow(var_x234, 2);
        ...
        IJth(rJacobian, 15, 0) = var_x250 * (-0.0018954404990922068 * var_x39 - 0.0018954404990922068 * var_x63 - 4.6119913257618111e-6 * var_x44 - 0.00063181349969740233 * var_x8 - 0.00063181349969740233 * NV_Ith_S(mParameters, 10));
        IJth(rJacobian, 16, 0) = var_x250 * (0.0012636269993948047 * var_x63 + 1.631335441491376e-6 * var_x42 - 0.00027188924024856262 * var_x99 - 2.7188924024856265e-5 * var_x26 - 0.00010565443138752546 * var_x29 - 0.00063181349969740233 * var_x2 - 0.00063181349969740233 * var_x3 - 0.00063181349969740233 * var_x5 - var_x252 * var_x46);
        ...
        IJth(rJacobian, 10, 1) = ((var_x227) ? (0) : (var_x228 * (-6.8203084950904297e-28 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 7) / pow((1.2447063003540035e-28 + var_x226), 2) - 171.23287671232876 * var_x224 / pow(var_x225, 2) - 684.93150684931504 * var_x222 / pow(var_x223, 2))));
        IJth(rJacobian, 13, 1) = var_x243 * (var_x111 + NV_Ith_S(mParameters, 0));
        ...
        IJth(rJacobian, 10, 10) = ((var_x227) ? (0) : (-var_x228));
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x4 * var_x87);
        IJth(rJacobian, 11, 11) = -var_x236;
        IJth(rJacobian, 16, 11) = -var_x254 * var_x4;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x87 * var_x88);
        IJth(rJacobian, 12, 12) = -var_x240;
        IJth(rJacobian, 16, 12) = -var_x254 * var_x88;
        IJth(rJacobian, 1, 13) = var_x108 * (var_x125 * (var_x124 - var_x123) + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 13, 13) = var_x243 * (var_x109 + var_x125 * (var_x123 - var_x124)) + 9.9963436928702016 * (var_x113 - var_x112 - var_x120) / (pow(var_x241, 3) * pow((0.33333333333333337 + var_x242), 2));
        ...
        IJth(rJacobian, 15, 15) = var_x250 * (1.1846503119326294e-6 * var_x94 - 0.0018954404990922068 * var_x92 - 0.016878114612481093 * var_x89 - 0.016878114612481093 * var_x93 - 0.0056863214972766203 * var_x95);
        IJth(rJacobian, 16, 15) = var_x250 * (0.0012636269993948047 * var_x92 - 0.00050634343837443281 * var_x90 - 7.8976687462175284e-7 * var_x94);
        ...
        IJth(rJacobian, 16, 16) = var_x250 * (4.357910453967955e-5 * var_x103 - 0.016878114612481093 * var_x90 - 0.016878114612481093 * var_x96 - 0.016878114612481093 * var_x97 - 0.00072631840899465921 * var_x98 - 0.0072631840899465916 * var_x100 - var_x102 * var_x252);
    }
