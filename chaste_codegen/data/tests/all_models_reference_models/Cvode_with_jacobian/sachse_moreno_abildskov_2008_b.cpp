...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellsachse_moreno_abildskov_2008_bFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x1 = 0.0096500000000000006 * NV_Ith_S(mParameters, 3);
        const double var_x2 = var_x1 * (-var_x0 * NV_Ith_S(mParameters, 1) + NV_Ith_S(mParameters, 0)) / (1.0 - var_x0);
        const double var_x3 = exp(-1.0000000000000001e-7);
        const double var_x4 = var_x1 * (-var_x3 * NV_Ith_S(mParameters, 1) + NV_Ith_S(mParameters, 0)) / (1.0 - var_x3);
        const double var_x5 = 1 / NV_Ith_S(mParameters, 6);
        const double var_x6 = 58062575.210589647 * var_x5;
        const double var_x7 = fabs(var_chaste_interface__membrane__Vm) < 8.6113989637305703e-9 * fabs(NV_Ith_S(mParameters, 6));
        ...
        const double var_x12 = var_x11 * var_chaste_interface__I_Shkr__OShkr * NV_Ith_S(mParameters, 3);
        const double var_x13 = var_x9 * NV_Ith_S(mParameters, 1);
        const double var_x14 = -var_x13 + NV_Ith_S(mParameters, 0);
        const double var_x15 = 1120607.7015643802 * var_x14;
        const double var_x16 = 13013073.790729566 * var_chaste_interface__membrane__Vm / pow(NV_Ith_S(mParameters, 6), 2);
        const double var_x17 = var_x5 * (-0.086113989637305696 * NV_Ith_S(mParameters, 6) * log(NV_Ith_S(mParameters, 1) / NV_Ith_S(mParameters, 0)) + var_chaste_interface__membrane__Vm);
        const double var_x18 = exp(14.631768953068592 * var_x17);
        const double var_x19 = 0.93999999999999995 + var_x18;
        const double var_x20 = sqrt(NV_Ith_S(mParameters, 1)) * NV_Ith_S(mParameters, 4);
        const double var_x21 = 0.001 / NV_Ith_S(mParameters, 2);
        const double var_x22 = exp(-17.767148014440433 * var_x8);
        const double var_x23 = var_x22 * var_x5;
        const double var_x24 = 0.03553429602888087 * var_x23;
        const double var_x25 = exp(14.864019253910952 * var_x8);
        const double var_x26 = var_x25 * var_x5;
        const double var_x27 = 1.783682310469314 * var_x26 * var_chaste_interface__I_Shkr__C0Shkr;
        const double var_x28 = 0.12 * var_x25;
        const double var_x29 = 0.002 * var_x22;
        const double var_x30 = 0.07106859205776174 * var_x23;
        const double var_x31 = 0.089999999999999997 * var_x25;
        const double var_x32 = 0.0040000000000000001 * var_x22;
        const double var_x33 = 0.89184115523465701 * var_x26;
        const double var_x34 = 0.059999999999999998 * var_x25;
        const double var_x35 = 0.0060000000000000001 * var_x22;
        const double var_x36 = 0.44592057761732851 * var_x26;
        const double var_x37 = 0.14213718411552348 * var_x23 * var_chaste_interface__I_Shkr__C4Shkr;
        const double var_x38 = 0.029999999999999999 * var_x25;
        const double var_x39 = 0.0080000000000000002 * var_x22;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x21 * (-((var_x7) ? (var_x6 * (var_x2 * var_chaste_interface__I_Shkr__OShkr + var_x4 * var_chaste_interface__I_Shkr__OShkr)) : (var_x12 * var_x13 * var_x16 + var_x12 * var_x15 * var_x5 - var_x14 * var_x16 * var_x9 * var_chaste_interface__I_Shkr__OShkr * NV_Ith_S(mParameters, 3) / pow(var_x10, 2))) - NV_Ith_S(mParameters, 5) - 0.031622776601683791 * var_x20 / var_x19 + 0.46269716089034085 * var_x17 * var_x18 * var_x20 / pow(var_x19, 2)));
        IJth(rJacobian, 1, 0) = -var_x27 - var_x24 * var_chaste_interface__I_Shkr__C1Shkr;
        IJth(rJacobian, 2, 0) = var_x27 + (var_x24 - 1.3377617328519855 * var_x26) * var_chaste_interface__I_Shkr__C1Shkr - var_x30 * var_chaste_interface__I_Shkr__C2Shkr;
        IJth(rJacobian, 3, 0) = (var_x30 - var_x33) * var_chaste_interface__I_Shkr__C2Shkr + 1.3377617328519855 * var_x26 * var_chaste_interface__I_Shkr__C1Shkr - 0.1066028880866426 * var_x23 * var_chaste_interface__I_Shkr__C3Shkr;
        IJth(rJacobian, 4, 0) = -var_x37 + var_x33 * var_chaste_interface__I_Shkr__C2Shkr + (-var_x36 + 0.1066028880866426 * var_x23) * var_chaste_interface__I_Shkr__C3Shkr;
        IJth(rJacobian, 5, 0) = var_x37 + var_x36 * var_chaste_interface__I_Shkr__C3Shkr;
        IJth(rJacobian, 1, 1) = -var_x28;
        IJth(rJacobian, 2, 1) = var_x28;
        IJth(rJacobian, 1, 2) = var_x29;
        IJth(rJacobian, 2, 2) = -var_x29 - var_x31;
        IJth(rJacobian, 3, 2) = var_x31;
        IJth(rJacobian, 2, 3) = var_x32;
        IJth(rJacobian, 3, 3) = -var_x32 - var_x34;
        IJth(rJacobian, 4, 3) = var_x34;
        IJth(rJacobian, 3, 4) = var_x35;
        IJth(rJacobian, 4, 4) = -var_x35 - var_x38;
        IJth(rJacobian, 5, 4) = var_x38;
        IJth(rJacobian, 4, 5) = var_x39;
        IJth(rJacobian, 5, 5) = -0.076999999999999999 - var_x39;
        IJth(rJacobian, 6, 5) = 0.076999999999999999;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x21 * ((var_x7) ? (-var_x2 + var_x6 * (var_x2 + var_x4) * (8.6113989637305703e-9 * NV_Ith_S(mParameters, 6) + var_chaste_interface__membrane__Vm)) : (var_x11 * var_x15 * var_x8 * NV_Ith_S(mParameters, 3))));
