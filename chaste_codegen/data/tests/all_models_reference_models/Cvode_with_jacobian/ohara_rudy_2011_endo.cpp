...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellohara_rudy_2011_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x975 = 0.16431153466973381 * var_x968 / pow(var_x969, 2);
        ...
        const double var_x984 = (0.002579398623354667 * var_x981 - 0.0079375812743823146 * var_x980) / (pow((1 + 0.4906771344455349 * var_x982), 2) * pow((var_x980 + 0.069986893840104841 * var_x981), 2));
        const double var_x985 = exp(14.640157739073281 + var_x967);
        ...
        const double var_x1076 = 1.0 + 0.002 * var_x385;
        const double var_x1077 = pow((1 / var_chaste_interface__ICaL__jca + 0.001 * pow(var_x1076, 4)), (-2));
        ...
        const double var_x1082 = exp(-1.2280159080866107 - 0.14729709824716453 * var_chaste_interface__membrane__v);
        const double var_x1083 = 1.0 + var_x1082;
        const double var_x1084 = 0.14729709824716453 * var_x1082 / pow(var_x1083, 2);
        const double var_x1085 = 1 / var_x1083;
        ...
        const double var_x1102 = 1 / (3.8115000000000001 + 1.5691999999999999 * NV_Ith_S(mParameters, 3));
        const double var_x1103 = exp(var_x1102 * (-144.59 - var_chaste_interface__membrane__v - 2.5537999999999998 * NV_Ith_S(mParameters, 3)));
        ...
        const double var_x1111 = var_x1110 * (var_x490 + var_x493 + var_x497 + var_x498 + var_x501 + var_x504 - var_x494 - var_x496);
        ...
        const double var_x1116 = 2.375 * var_x1115;
        const double var_x1117 = var_x602 - var_x601;
        const double var_x1118 = var_x1110 * var_x1116;
        const double var_x1119 = var_x789 + var_x791 + var_x793 - var_x792;
        const double var_x1120 = var_x945 + var_x946;
        const double var_x1121 = var_x1110 * var_x1120;
        const double var_x1122 = pow(var_chaste_interface__intracellular_ions__cajsr, (-2));
        const double var_x1123 = var_x1120 / (pow((0.039018442310623382 + var_x1109), 2) * pow(var_chaste_interface__intracellular_ions__cajsr, 9));
        const double var_x1124 = var_x818 + var_x819;
        const double var_x1125 = var_x1110 * var_x502;
        const double var_x1126 = var_x1115 * var_x1125;
        const double var_x1127 = 9.5 * var_x1126;
        const double var_x1128 = var_x832 + var_x833;
        const double var_x1129 = var_x844 + var_x845;
        const double var_x1130 = var_x854 + var_x855;
        const double var_x1131 = 10.450000000000001 * var_x1126;
        const double var_x1132 = var_x869 + var_x870;
        ...
        const double var_x1135 = 2.96875 * var_x1134;
        const double var_x1136 = var_x1110 * var_x1135;
        const double var_x1137 = var_x1125 * var_x1134;
        const double var_x1138 = 11.875 * var_x1137;
        const double var_x1139 = 13.062500000000002 * var_x1137;
        ...
        IJth(rJacobian, 11, 0) = (var_x970 - var_chaste_interface__INa__hf) * (0.30335471139615194 * var_x971 - 2.2784407319013524e-6 * var_x972) - var_x975 * (var_x973 + var_x974);
        IJth(rJacobian, 12, 0) = (var_x970 - var_chaste_interface__INa__hs) * (0.0059001058948111541 * var_x976 - 0.00034916221033868096 * var_x977) - var_x975 * (var_x978 + var_x979);
        IJth(rJacobian, 13, 0) = -var_x975 * var_x983 - 2.5847740332669882 * var_x984 * (var_x970 - var_chaste_interface__INa__j);
        IJth(rJacobian, 14, 0) = (-var_chaste_interface__INa__hsp + 1 / var_x986) * (0.0019667019649370517 * var_x976 - 0.00011638740344622698 * var_x977) - 0.16431153466973381 * var_x985 * (var_x987 + var_x988) / pow(var_x986, 2);
        IJth(rJacobian, 15, 0) = -var_x975 * var_x989 - 1.7703931734705398 * var_x984 * (var_x970 - var_chaste_interface__INa__jp);
        ...
        IJth(rJacobian, 31, 0) = -var_x1057 * var_x1074 - 403.12421264802225 * var_x1059 * (var_x1058 - var_chaste_interface__ICaL__ffp);
        IJth(rJacobian, 32, 0) = -var_x1057 * var_x1075 - 5.1020408163265305 * var_x1069 * (var_x1058 - var_chaste_interface__ICaL__fcafp);
        IJth(rJacobian, 34, 0) = var_x1081 * var_x1084 - 0.044502978385908498 * (var_x1085 - var_chaste_interface__IKr__xrf) * (2.0230618253189406e-6 * var_x1078 - 0.094391315585422589 * var_x1079) / (pow((1 + 0.077041602465331274 * var_x1080), 2) * pow((var_x1079 + 0.00011289704271631982 * var_x1078), 2));
        IJth(rJacobian, 35, 0) = var_x1084 * var_x1089 - 65.425385409990326 * (var_x1085 - var_chaste_interface__IKr__xrs) * (4.348496530454896e-7 * var_x1086 - 0.0090129163834126447 * var_x1087) / (pow((1 + 0.53619302949061665 * var_x1088), 2) * pow((var_x1087 + 0.00017016141197767387 * var_x1086), 2));
        IJth(rJacobian, 36, 0) = var_x1093 * var_x1096 - 0.89683381486126834 * (var_x1097 - var_chaste_interface__IKs__xs1) * (5.617391304347826e-6 * var_x1090 - 1.3067415730337078e-5 * var_x1091) / (pow((1 + 0.001223540927444023 * var_x1092), 2) * pow((var_x1090 + 0.18003095975232197 * var_x1091), 2));
        IJth(rJacobian, 37, 0) = var_x1096 * (var_x1100 + var_x1101) + (var_x1097 - var_chaste_interface__IKs__xs2) * (0.00050000000000000001 * var_x1098 - 0.00062258064516129035 * var_x1099);
        IJth(rJacobian, 38, 0) = (-var_chaste_interface__IK1__xk1 + 1 / var_x1104) * (0.00011803412744333594 * var_x1105 - 0.00040193055283135957 * var_x1106) + var_x1102 * var_x1103 * (var_x1107 + var_x1108) / pow(var_x1104, 2);
        IJth(rJacobian, 39, 0) = -var_x1111 * var_x1116;
        IJth(rJacobian, 40, 0) = -var_x1111 * var_x1135;
        ...
        IJth(rJacobian, 39, 2) = -var_x1117 * var_x1118;
        IJth(rJacobian, 40, 2) = -var_x1117 * var_x1136;
        ...
        IJth(rJacobian, 33, 7) = 7.9999999999999996e-6 * var_x1077 * var_x277 * pow(var_x1076, 3);
        IJth(rJacobian, 39, 7) = -var_x1118 * var_x1119;
        IJth(rJacobian, 40, 7) = -var_x1119 * var_x1136;
        ...
        IJth(rJacobian, 39, 9) = (-var_chaste_interface__ryr__Jrelnp - 2.375 * var_x1121) * ((var_x1114) ? (0) : (-0.0025894736842105265 * var_x1122)) - 0.74135040390184426 * var_x1115 * var_x1123;
        IJth(rJacobian, 40, 9) = (-var_chaste_interface__ryr__Jrelp - 2.96875 * var_x1121) * ((var_x1133) ? (0) : (-0.0020715789473684213 * var_x1122)) - 0.92668800487730529 * var_x1123 * var_x1134;
        ...
        IJth(rJacobian, 39, 25) = -var_x1118 * var_x1124;
        IJth(rJacobian, 40, 25) = -var_x1124 * var_x1136;
        ...
        IJth(rJacobian, 39, 26) = -var_x1127 * var_x822;
        IJth(rJacobian, 40, 26) = -var_x1138 * var_x822;
        ...
        IJth(rJacobian, 39, 27) = -var_x1118 * var_x1128;
        IJth(rJacobian, 40, 27) = -var_x1128 * var_x1136;
        ...
        IJth(rJacobian, 39, 28) = -var_x1127 * var_x835;
        IJth(rJacobian, 40, 28) = -var_x1138 * var_x835;
        ...
        IJth(rJacobian, 39, 29) = -var_x1118 * var_x1129;
        IJth(rJacobian, 40, 29) = -var_x1129 * var_x1136;
        ...
        IJth(rJacobian, 33, 30) = -var_chaste_interface__ICaL__nca + 1.0 * var_x1077 / pow(var_chaste_interface__ICaL__jca, 2);
        IJth(rJacobian, 39, 30) = -var_x1118 * var_x1130;
        IJth(rJacobian, 40, 30) = -var_x1130 * var_x1136;
        ...
        IJth(rJacobian, 31, 31) = -var_x1074;
        IJth(rJacobian, 39, 31) = -var_x1131 * var_x857;
        IJth(rJacobian, 40, 31) = -var_x1139 * var_x857;
        ...
        IJth(rJacobian, 32, 32) = -var_x1075;
        IJth(rJacobian, 39, 32) = -var_x1131 * var_x859;
        IJth(rJacobian, 40, 32) = -var_x1139 * var_x859;
