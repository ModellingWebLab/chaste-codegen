...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 0) = 050000000000000003; // (var_membrane__Cm) [nanoF]
    }
    ...
    double Cellnygren_atrial_model_1998FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel__E_Ca_app = 60; // millivolt
        const double var_L_type_Ca_channel__g_Ca_L = 6.75; // nanoS
        const double var_L_type_Ca_channel__k_Ca = 025000000000000001; // millimolar
        ...
        const double var_Na_Ca_ion_exchanger_current__k_NaCa = 037484200000000002; // picoA_per_millimolar_4
        const double var_background_currents__g_B_Ca = 078681000000000001; // nanoS
        const double var_background_currents__g_B_Na = 060599; // nanoS
        ...
        const double var_delayed_rectifier_K_currents_pi_gate__p_i = 1.0 / (1.0 + exp(2.2916666666666665 + 041666666666666664 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_sodium_current__P_Na = 0016000000000000001; // nanolitre_per_second
        ...
        const double var_sodium_potassium_pump__i_NaK = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5) * (150 + var_chaste_interface__membrane__V) * var_chaste_interface__cleft_space_ion_concentrations__K_c * var_sodium_potassium_pump__i_NaK_max / ((200 + var_chaste_interface__membrane__V) * (pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5) + pow(var_sodium_potassium_pump__k_NaK_Na, 1.5)) * (var_chaste_interface__cleft_space_ion_concentrations__K_c + var_sodium_potassium_pump__k_NaK_K)); // picoA
    ...
    void Cellnygren_atrial_model_1998FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_Ca_handling_by_the_SR__I_up_max = 2800; // picoA
        ...
        const double var_Ca_handling_by_the_SR__Vol_up = 0003969; // nanolitre
        const double var_Ca_handling_by_the_SR__alpha_rel = 200000; // picoA_per_millimolar
        const double var_Ca_handling_by_the_SR__k_cyca = 00029999999999999997; // millimolar
        const double var_Ca_handling_by_the_SR__k_rel_d = 0030000000000000001; // millimolar
        const double var_Ca_handling_by_the_SR__k_rel_i = 00029999999999999997; // millimolar
        ...
        const double var_cleft_space_ion_concentrations__Na_b = 130; // millimolar
        const double var_cleft_space_ion_concentrations__tau_Ca = 24.699999999999999; // second
        const double var_cleft_space_ion_concentrations__tau_K = 10; // second
        ...
        const double var_intracellular_ion_concentrations__Vol_i = 0058840000000000003; // nanolitre
        ...
        const double var_intracellular_ion_concentrations__Vol_d = 02 * var_intracellular_ion_concentrations__Vol_i; // nanolitre
        const double var_intracellular_ion_concentrations__phi_Na_en = -1.6799999999999999; // picoA
        const double var_intracellular_ion_concentrations__tau_di = 01; // second
        const double var_inward_rectifier__g_K1 = 3.0; // nanoS
        const double var_membrane__F = 96487.0; // coulomb_per_mole
        ...
        const double var_background_currents__E_Ca = 0.5 * var_membrane__R * var_membrane__T * log(var_chaste_interface__cleft_space_ion_concentrations__Ca_c / var_chaste_interface__intracellular_ion_concentrations__Ca_i) / var_membrane__F; // millivolt
        const double var_Ca_independent_transient_outward_K_current__i_t = (-var_Ca_independent_transient_outward_K_current__E_K + var_chaste_interface__membrane__V) * var_Ca_independent_transient_outward_K_current__g_t * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s; // picoA
        const double var_Ca_independent_transient_outward_K_current_r_gate__r_infinity = 1.0 / (1.0 + exp(090909090909090912 - 090909090909090912 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_Ca_independent_transient_outward_K_current_r_gate__tau_r = 0015 + 0035000000000000001 * exp(-0011111111111111111 * pow(var_chaste_interface__membrane__V, 2)); // second
        ...
        const double var_Ca_independent_transient_outward_K_current_s_gate__s_infinity = 1.0 / (1.0 + exp(3.5217391304347827 + 086956521739130432 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_Ca_independent_transient_outward_K_current_s_gate__tau_s = 01414 + 0.48120000000000002 * exp(-12.275731601256398 * pow((1 + 019065776930409912 * var_chaste_interface__membrane__V), 2)); // second
        ...
        const double d_dt_chaste_interface_var_Ca_independent_transient_outward_K_current_s_gate__s = 001 * var_Ca_independent_transient_outward_K_current_s_gate__s_orig_deriv; // 1 / millisecond
        const double var_L_type_Ca_channel__i_Ca_L = (-var_L_type_Ca_channel__E_Ca_app + var_chaste_interface__membrane__V) * ((1.0 - var_L_type_Ca_channel__f_Ca) * var_chaste_interface__L_type_Ca_channel_f_L2_gate__f_L_2 + var_L_type_Ca_channel__f_Ca * var_chaste_interface__L_type_Ca_channel_f_L1_gate__f_L_1) * var_L_type_Ca_channel__g_Ca_L * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L; // picoA
        ...
        const double var_L_type_Ca_channel_d_L_gate__tau_d_L = 002 + 0027000000000000001 * exp(-1.3611111111111112 * pow((1 + 028571428571428571 * var_chaste_interface__membrane__V), 2)); // second
        ...
        const double var_L_type_Ca_channel_f_L1_gate__tau_f_L1 = 01 + 0.161 * exp(-7.716049382716049 * pow((1 + 025000000000000001 * var_chaste_interface__membrane__V), 2)); // second
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_channel_f_L1_gate__f_L_1 = 001 * var_L_type_Ca_channel_f_L1_gate__f_L_1_orig_deriv; // 1 / millisecond
        const double var_L_type_Ca_channel_f_L2_gate__tau_f_L2 = 062600000000000003 + 1.3323 * exp(-7.9349335449315621 * pow((1 + 025000000000000001 * var_chaste_interface__membrane__V), 2)); // second
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_channel_f_L2_gate__f_L_2 = 001 * var_L_type_Ca_channel_f_L2_gate__f_L_2_orig_deriv; // 1 / millisecond
        const double var_Na_Ca_ion_exchanger_current__i_NaCa = (pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * var_chaste_interface__cleft_space_ion_concentrations__Ca_c * exp(var_Na_Ca_ion_exchanger_current__gamma * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) - pow(var_chaste_interface__cleft_space_ion_concentrations__Na_c, 3) * var_chaste_interface__intracellular_ion_concentrations__Ca_i * exp((-1.0 + var_Na_Ca_ion_exchanger_current__gamma) * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * var_Na_Ca_ion_exchanger_current__k_NaCa / (1.0 + (pow(var_chaste_interface__cleft_space_ion_concentrations__Na_c, 3) * var_chaste_interface__intracellular_ion_concentrations__Ca_i + pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * var_chaste_interface__cleft_space_ion_concentrations__Ca_c) * var_Na_Ca_ion_exchanger_current__d_NaCa); // picoA
        const double var_background_currents__i_B_Ca = (-var_background_currents__E_Ca + var_chaste_interface__membrane__V) * var_background_currents__g_B_Ca; // picoA
        const double var_delayed_rectifier_K_currents__i_Ks = (-var_Ca_independent_transient_outward_K_current__E_K + var_chaste_interface__membrane__V) * var_delayed_rectifier_K_currents__g_Ks * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n; // picoA
        const double var_delayed_rectifier_K_currents_n_gate__n_infinity = 1.0 / (1.0 + exp(1.5669291338582676 - 07874015748031496 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_delayed_rectifier_K_currents_n_gate__tau_n = 0.69999999999999996 + 0.40000000000000002 * exp(-pow((-1.0 + 050000000000000003 * var_chaste_interface__membrane__V), 2)); // second
        ...
        const double d_dt_chaste_interface_var_delayed_rectifier_K_currents_n_gate__n = 001 * var_delayed_rectifier_K_currents_n_gate__n_orig_deriv; // 1 / millisecond
        ...
        const double var_delayed_rectifier_K_currents_pa_gate__tau_p_a = 031179999999999999 + 0.21718000000000001 * exp(-0.82285842787521646 * pow((1 + 049658350548228189 * var_chaste_interface__membrane__V), 2)); // second
        ...
        const double d_dt_chaste_interface_var_delayed_rectifier_K_currents_pa_gate__p_a = 001 * var_delayed_rectifier_K_currents_pa_gate__p_a_orig_deriv; // 1 / millisecond
        const double var_delayed_rectifier_K_currents_pi_gate__p_i = 1.0 / (1.0 + exp(2.2916666666666665 + 041666666666666664 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_delayed_rectifier_K_currents__i_Kr = (-var_Ca_independent_transient_outward_K_current__E_K + var_chaste_interface__membrane__V) * var_delayed_rectifier_K_currents__g_Kr * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a * var_delayed_rectifier_K_currents_pi_gate__p_i; // picoA
        ...
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Ca_d = 001 * var_intracellular_ion_concentrations__Ca_d_orig_deriv; // millimolar / millisecond
        const double var_inward_rectifier__i_K1 = 1.0 * pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 0.44569999999999999) * (-var_Ca_independent_transient_outward_K_current__E_K + var_chaste_interface__membrane__V) * var_inward_rectifier__g_K1 / (1.0 + exp(1.5 * (3.6000000000000001 - var_Ca_independent_transient_outward_K_current__E_K + var_chaste_interface__membrane__V) * var_membrane__F / (var_membrane__R * var_membrane__T))); // picoA
        const double var_sarcolemmal_calcium_pump_current__i_CaP_max = 4.0; // picoA
        const double var_sarcolemmal_calcium_pump_current__k_CaP = 00020000000000000001; // millimolar
        const double var_sarcolemmal_calcium_pump_current__i_CaP = var_chaste_interface__intracellular_ion_concentrations__Ca_i * var_sarcolemmal_calcium_pump_current__i_CaP_max / (var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_sarcolemmal_calcium_pump_current__k_CaP); // picoA
        ...
        const double d_dt_chaste_interface_var_cleft_space_ion_concentrations__Ca_c = 001 * var_cleft_space_ion_concentrations__Ca_c_orig_deriv; // millimolar / millisecond
        ...
        const double var_sodium_current_h1_gate__tau_h1 = 00029999999999999997 + 029999999999999999 / (1.0 + exp(10.96875 + 0.3125 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_sodium_current_h2_gate__tau_h2 = 0030000000000000001 + 0.12 / (1.0 + exp(10.96875 + 0.3125 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_sodium_current_m_gate__tau_m = 2.4000000000000001e-5 + 4.1999999999999998e-5 * exp(-0.78827269000771605 * pow((1 + 039108330074305829 * var_chaste_interface__membrane__V), 2)); // second
        ...
        const double d_dt_chaste_interface_var_cleft_space_ion_concentrations__Na_c = 001 * var_cleft_space_ion_concentrations__Na_c_orig_deriv; // millimolar / millisecond
        ...
        const double var_sustained_outward_K_current_r_sus_gate__tau_r_sus = 00050000000000000001 + 0089999999999999993 / (1.0 + exp(0.41666666666666669 + 083333333333333329 * var_chaste_interface__membrane__V)); // second
        ...
        const double d_dt_chaste_interface_var_sustained_outward_K_current_r_sus_gate__r_sus = 001 * var_sustained_outward_K_current_r_sus_gate__r_sus_orig_deriv; // 1 / millisecond
        const double var_sustained_outward_K_current__i_sus = (-var_Ca_independent_transient_outward_K_current__E_K + var_chaste_interface__membrane__V) * var_sustained_outward_K_current__g_sus * var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus; // picoA
        ...
        const double var_sustained_outward_K_current_s_sus_gate__tau_s_sus = 0.29999999999999999 + 047 / (1.0 + exp(6.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)); // second
        ...
        const double d_dt_chaste_interface_var_sustained_outward_K_current_s_sus_gate__s_sus = 001 * var_sustained_outward_K_current_s_sus_gate__s_sus_orig_deriv; // 1 / millisecond
    ...
    void Cellnygren_atrial_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x69 = 037484200000000002 * var_x24;
        ...
        const double var_x139 = 00018867924528301889 * var_x137 / pow(var_x138, 2);
        ...
        const double var_x152 = 00014084507042253522 * var_x150 / pow(var_x151, 2);
        ...
        const double var_x156 = exp(090909090909090912 - 090909090909090912 * var_chaste_interface__membrane__V);
        ...
        const double var_x160 = exp(3.5217391304347827 + 086956521739130432 * var_chaste_interface__membrane__V);
        ...
        const double var_x177 = exp(1.5669291338582676 - 07874015748031496 * var_chaste_interface__membrane__V);
        ...
        const double var_x186 = 00037425551606170871 * var_x41;
        ...
        const double var_x194 = 00024950367737447247 * var_x41;
        const double var_x195 = 00034849397687453321 * var_x11 - 1.3210516441925016e-5 * var_chaste_interface__membrane__V;
        const double var_x196 = 00012778112485399551 * var_x11 - 4.843856028705839e-6 * var_chaste_interface__membrane__V;
        ...
        const double var_x205 = 0027518787945713876 * var_x41;
        ...
        const double var_x214 = -0026226760583233483 + 4.3711267638722472e-5 * var_chaste_interface__membrane__V;
        ...
        const double var_x218 = 9.7136150308272163e-5 * var_chaste_interface__membrane__V - 0025624557123127439 * var_x11;
        const double var_x219 = 3.5616588446366462e-5 * var_chaste_interface__membrane__V - 00093956709451467277 * var_x11;
        const double var_x220 = 00034166076164169918 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x221 = 00093956709451467277 * var_x17;
        const double var_x222 = 0025624557123127439 * var_x18;
        const double var_x223 = 00017083038082084959 * var_x9;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0 : (-var_x64 * (0.13928000000000001 + 0.5 * var_x9 + 1.0 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n + 3.0 * var_x16 + 2.75 * var_x17 + 7.5 * var_x18 + 037484200000000002 * var_x29 - 0017706325 * var_x61 - 020833333333333332 * var_x32 - 0.17058350483361479 * var_x34 + var_x38 * var_x42 + var_x50 * var_x55 + var_x56 * var_x57 + (6.75 * var_x4 + 6.75 * var_x5) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L - var_x56 * var_x62));
        IJth(rJacobian, 1, 0) = -6.9294442944473474e-8 + 6.6024752054987431e-8 * var_x29;
        IJth(rJacobian, 2, 0) = 00012180267965895249 * var_x129 * var_x132 / pow(var_x130, 2) - 23.80952380952381 * var_x131 * (-061656057098765427 - 0024112654320987653 * var_chaste_interface__membrane__V) * (-var_chaste_interface__sodium_current_m_gate__m + 1.0 / var_x130) / pow((0.57142857142857151 + var_x131), 2);
        IJth(rJacobian, 3, 0) = -var_x136 * var_x139 + 010416666666666666 * var_x141 * (var_x140 - var_chaste_interface__sodium_current_h1_gate__h1) / pow((01 + var_x135), 2);
        IJth(rJacobian, 4, 0) = -var_x139 * var_x142 + 0026041666666666665 * var_x141 * (var_x140 - var_chaste_interface__sodium_current_h2_gate__h2) / pow((025000000000000001 + var_x135), 2);
        IJth(rJacobian, 5, 0) = 00017241379310344829 * var_x143 * var_x146 / pow(var_x144, 2) - 0.37037037037037035 * var_x145 * (-077777777777777779 - 0022222222222222222 * var_chaste_interface__membrane__V) * (-var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L + 1.0 / var_x144) / pow((0.7407407407407407 + var_x145), 2);
        IJth(rJacobian, 6, 0) = -var_x149 * var_x152 - 0062111801242236021 * var_x148 * (-0.38580246913580246 - 0096450617283950612 * var_chaste_interface__membrane__V) * (var_x153 - var_chaste_interface__L_type_Ca_channel_f_L1_gate__f_L_1) / pow((062111801242236024 + var_x148), 2);
        IJth(rJacobian, 7, 0) = -var_x152 * var_x155 - 00075058170081813405 * var_x154 * (-0.39674667724657808 - 0099186669311644524 * var_chaste_interface__membrane__V) * (var_x153 - var_chaste_interface__L_type_Ca_channel_f_L2_gate__f_L_2) / pow((046986414471215196 + var_x154), 2);
        IJth(rJacobian, 8, 0) = 9.0909090909090917e-5 * var_x156 * var_x159 / pow(var_x157, 2) + 00063492063492063492 * var_x158 * (-var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + 1.0 / var_x157) * var_chaste_interface__membrane__V / pow((0.42857142857142855 + var_x158), 2);
        IJth(rJacobian, 9, 0) = -8.6956521739130441e-5 * var_x160 * var_x163 / pow(var_x161, 2) - 0020781379883624274 * var_x162 * (-0.46809272073427638 - 0089245513962683768 * var_chaste_interface__membrane__V) * (-var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s + 1.0 / var_x161) / pow((02938487115544472 + var_x162), 2);
        IJth(rJacobian, 10, 0) = 000125 * var_x164 * var_x169 / pow(var_x165, 2) + 0092592592592592605 * var_x166 * (-var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus + 1.0 / var_x165) / (pow(var_x167, 2) * pow((055555555555555559 + var_x168), 2));
        ...
        IJth(rJacobian, 12, 0) = 7.874015748031497e-5 * var_x177 * var_x180 / pow(var_x178, 2) - 00081632653061224504 * var_x179 * (0.10000000000000001 - var_x58) * (-var_chaste_interface__delayed_rectifier_K_currents_n_gate__n + 1.0 / var_x178) / pow((1 + 0.57142857142857151 * var_x179), 2);
        IJth(rJacobian, 13, 0) = 00016666666666666666 * var_x181 * var_x184 / pow(var_x182, 2) - 0046044755502348284 * var_x183 * (-081723584525982884 - 0040582584084490154 * var_chaste_interface__membrane__V) * (-var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a + 1.0 / var_x182) / pow((0.14356754765632193 + var_x183), 2);
        ...
        IJth(rJacobian, 16, 0) = (-00029723661994331287 * var_x4 - 00029723661994331287 * var_x5) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        ...
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (-var_x64 * (4.0 * var_x66 + 1.0378040372231492 * var_x67 - 4.0 * var_x68 - var_x19 * var_x72 - var_x69 * var_x70));
        ...
        IJth(rJacobian, 17, 1) = 200 - 200 * var_chaste_interface__intracellular_Ca_buffering__O_C;
        IJth(rJacobian, 18, 1) = 78.400000000000006 - 78.400000000000006 * var_chaste_interface__intracellular_Ca_buffering__O_TC;
        IJth(rJacobian, 19, 1) = 200 - 200 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC - 200 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg;
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (-01755636333960639 * var_x63 * var_x74);
        IJth(rJacobian, 2, 2) = -001 * var_x132;
        IJth(rJacobian, 14, 2) = -3.0923816874437303e-5 * var_x74;
        IJth(rJacobian, 21, 2) = 00022738100642968604 * var_x74;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (-0052669090018819175 * var_x76);
        IJth(rJacobian, 3, 3) = -001 * var_x136;
        IJth(rJacobian, 14, 3) = -9.2771450623311923e-6 * var_x75;
        IJth(rJacobian, 21, 3) = 6.8214301928905822e-5 * var_x75;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (-00058521211132021302 * var_x76);
        IJth(rJacobian, 4, 4) = -001 * var_x142;
        IJth(rJacobian, 14, 4) = -1.0307938958145769e-6 * var_x75;
        IJth(rJacobian, 21, 4) = 7.5793668809895352e-6 * var_x75;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (-var_x77 * var_x78);
        IJth(rJacobian, 5, 5) = -001 * var_x146;
        IJth(rJacobian, 16, 5) = var_x201 * var_x77;
        IJth(rJacobian, 22, 5) = var_x214 * var_x77;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (-var_x2 * var_x79);
        IJth(rJacobian, 6, 6) = -001 * var_x149;
        IJth(rJacobian, 16, 6) = var_x2 * var_x202;
        IJth(rJacobian, 22, 6) = var_x2 * var_x215;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (-var_x3 * var_x79);
        IJth(rJacobian, 7, 7) = -001 * var_x155;
        IJth(rJacobian, 16, 7) = var_x202 * var_x3;
        IJth(rJacobian, 22, 7) = var_x215 * var_x3;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (-var_x80 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s);
        IJth(rJacobian, 8, 8) = -001 * var_x159;
        ...
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0 : (-var_x80 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r);
        IJth(rJacobian, 9, 9) = -001 * var_x163;
        ...
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0 : (-var_x81 * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus);
        IJth(rJacobian, 10, 10) = -001 * var_x169;
        ...
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0 : (-var_x81 * var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus);
        IJth(rJacobian, 11, 11) = -001 * var_x176;
        ...
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0 : (-var_x64 * (var_x30 + 1.0 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 12, 12) = -001 * var_x180;
        IJth(rJacobian, 15, 12) = 4.6465863583271093e-5 * var_x11 - 1.7614021922566687e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 23, 12) = 1.2951486707769622e-5 * var_chaste_interface__membrane__V - 00034166076164169918 * var_x11;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0 : (-00050000000000000001 * var_x63 * var_x82);
        IJth(rJacobian, 13, 13) = -001 * var_x184;
        IJth(rJacobian, 15, 13) = -8.8070109612833433e-7 * var_x82;
        IJth(rJacobian, 23, 13) = 6.4757433538848112e-6 * var_x82;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0 : (-var_x64 * (106.23795 * var_x88 + 1.5986041573362213 * var_x51 - 079818144252441769 * var_x89 + var_x52 * var_x91 + var_x83 * var_x85 - var_x84 * var_x86));
        IJth(rJacobian, 1, 14) = var_x122 * var_x85 - var_x123 * var_x84;
        IJth(rJacobian, 14, 14) = 4.2177556280432989e-7 * var_x89 - 00056138327409256303 * var_x88 - 2.8157848672826448e-6 * var_x51 + var_x190 * var_x84 - var_x191 * var_x85 - var_x193 * var_x52;
        IJth(rJacobian, 15, 14) = 00037425551606170871 * var_x88 - 2.8118370853621991e-7 * var_x89;
        IJth(rJacobian, 21, 14) = 0041278181918570815 * var_x88 + 2.0704300494725328e-5 * var_x51 - 3.1012909029730135e-6 * var_x89 + var_x208 * var_x85 + var_x211 * var_x52 - var_x209 * var_x84;
        IJth(rJacobian, 22, 14) = var_x216 * var_x84 - var_x206 * var_x85;
        IJth(rJacobian, 23, 14) = 2.067527268648676e-6 * var_x89 - 0027518787945713876 * var_x88;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0 : (-var_x64 * (79.140125612776842 * var_x94 - 4.5 * var_x97 + var_x10 * var_x92 + var_x10 * var_x93 + var_x10 * var_x95 + var_x10 * var_x96));
        IJth(rJacobian, 15, 15) = 7.9263098651550091e-6 * var_x97 - 00013939759074981328 * var_x94 - var_x10 * var_x197 - var_x10 * var_x198 - var_x10 * var_x199 - var_x10 * var_x200;
        IJth(rJacobian, 23, 15) = 0010249822849250976 * var_x94 - 5.8281690184963299e-5 * var_x97 + var_x10 * var_x220 + var_x10 * var_x221 + var_x10 * var_x222 + var_x10 * var_x223;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0 : (-var_x79 * var_x99);
        IJth(rJacobian, 1, 16) = 002;
        ...
        IJth(rJacobian, 1, 17) = 021419999999999998 + 9.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        IJth(rJacobian, 17, 17) = -0.47600000000000003 + var_x203;
        IJth(rJacobian, 1, 18) = 031359999999999999 + 6.2720000000000002 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        IJth(rJacobian, 18, 18) = -0.39200000000000002 - 78.400000000000006 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        IJth(rJacobian, 1, 19) = 0010560000000000001 + var_x124;
        IJth(rJacobian, 19, 19) = -0066 + var_x203;
        IJth(rJacobian, 20, 19) = -5.0;
        IJth(rJacobian, 1, 20) = var_x124;
        IJth(rJacobian, 19, 20) = var_x203;
        IJth(rJacobian, 20, 20) = -5.6660000000000004;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0 : (-var_x64 * (-var_x91 - 1.5986041573362213 * var_x100 + var_x54 * var_x90 - var_x101 * var_x86 - var_x102 * var_x83));
        ...
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0 : (-var_x64 * (-1.0378040372231492 * var_x103 + var_x104 * var_x69 - var_x21 * var_x72));
        ...
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0 : (-var_x64 * (1.3371 * var_x108 + 4.5 * var_x109 - 79.140125612776842 * var_x106 + var_x110 * var_x42 - var_x107 * var_x92 - var_x107 * var_x93 - var_x107 * var_x95 - var_x107 * var_x96 - var_x111 * var_x42));
        IJth(rJacobian, 14, 23) = var_x111 * var_x186 - var_x110 * var_x186;
        IJth(rJacobian, 15, 23) = 00013939759074981328 * var_x106 - 7.9263098651550091e-6 * var_x109 - 2.3551708712663917e-6 * var_x108 + var_x107 * var_x197 + var_x107 * var_x198 + var_x107 * var_x199 + var_x107 * var_x200 + var_x110 * var_x194 - var_x111 * var_x194;
        IJth(rJacobian, 21, 23) = var_x110 * var_x205 - var_x111 * var_x205;
        IJth(rJacobian, 23, 23) = -0001 + 1.7317432876958762e-5 * var_x108 + 5.8281690184963299e-5 * var_x109 - 0010249822849250976 * var_x106 + var_x111 * var_x217 - var_x107 * var_x220 - var_x107 * var_x221 - var_x107 * var_x222 - var_x107 * var_x223 - var_x110 * var_x217;
        ...
        IJth(rJacobian, 25, 24) = 011111111111111112;
        IJth(rJacobian, 26, 24) = 0.47999999999999998 - 0.47999999999999998 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse;
        IJth(rJacobian, 1, 25) = 1.7754934097947219e-10 * var_x114 + 00078910818213098765 * var_x113;
        IJth(rJacobian, 24, 25) = 0.10000000000000001;
        IJth(rJacobian, 25, 25) = -011111111111111112 - 2.632149968060505e-9 * var_x114 - 011698444302491135 * var_x113;
        ...
        IJth(rJacobian, 27, 27) = -00081499999999999997 - var_x238 - var_x240;
        ...
        IJth(rJacobian, 27, 28) = -00081499999999999997;
        IJth(rJacobian, 28, 28) = -033960000000000004 - 0.33960000000000001 * var_x239;
    }
