...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnygren_atrial_model_1998FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_background_currents__E_Ca = 0.5 * var_membrane__R * var_membrane__T * log(10) * log10(var_chaste_interface__cleft_space_ion_concentrations__Ca_c / var_chaste_interface__intracellular_ion_concentrations__Ca_i) / var_membrane__F; // millivolt
        ...
        const double var_sodium_current__E_Na = var_membrane__R * var_membrane__T * log(10) * log10(var_chaste_interface__cleft_space_ion_concentrations__Na_c / var_chaste_interface__intracellular_ion_concentrations__Na_i) / var_membrane__F; // millivolt
    ...
    void Cellnygren_atrial_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x64 = 1 / NV_Ith_S(mParameters, 0);
        ...
        const double var_x70 = 0.037484200000000002 * var_x25;
        const double var_x71 = var_x20 * var_x28;
        const double var_x72 = (var_x27 - var_x29) / pow(var_x24, 2);
        const double var_x73 = 1.1245259999999999e-5 * var_x72;
        const double var_x74 = var_x47 * var_x56 * var_chaste_interface__membrane__V;
        const double var_x75 = var_x49 * var_x74 * pow(var_chaste_interface__sodium_current_m_gate__m, 2);
        const double var_x76 = var_x48 * var_x74;
        const double var_x77 = var_x64 * var_x76;
        const double var_x78 = var_x4 + var_x5;
        const double var_x79 = var_x65 * (-405.0 + 6.75 * var_chaste_interface__membrane__V);
        const double var_x80 = var_x79 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        const double var_x81 = var_x65 * (7.5 * var_chaste_interface__membrane__V - 197.8503140319421 * var_x12);
        const double var_x82 = var_x65 * (2.75 * var_chaste_interface__membrane__V - 72.545115145045443 * var_x12);
        const double var_x83 = var_x32 * var_x8;
        const double var_x84 = 0.11245260000000001 * var_x25;
        ...
        const double var_x87 = 3.3735780000000002e-5 * var_x72;
        ...
        const double var_x91 = var_x51 * var_chaste_interface__membrane__V;
        const double var_x92 = var_x54 * var_x91;
        const double var_x93 = 26.380041870925616 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x94 = 72.545115145045443 * var_x18;
        const double var_x95 = var_x11 * var_x17;
        const double var_x96 = 13.190020935462808 * var_x9;
        const double var_x97 = 197.8503140319421 * var_x19;
        ...
        const double var_x121 = 6.6024752054987431e-8 * var_x25;
        const double var_x122 = 1.9807425616496225e-11 * var_x72;
        const double var_x123 = 1.9807425616496227e-7 * var_x25;
        const double var_x124 = 5.9422276849488674e-11 * var_x72;
        const double var_x125 = 32.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x126 = -var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_chaste_interface__Ca_handling_by_the_SR__Ca_rel;
        const double var_x127 = 0.35228043845133372 * var_x126;
        const double var_x128 = var_x117 * var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x129 = var_x118 / pow(var_x116, 3);
        const double var_x130 = exp(-3.3032886723507917 - 0.12180267965895249 * var_chaste_interface__membrane__V);
        ...
        const double var_x138 = exp(12.0 + 0.18867924528301888 * var_chaste_interface__membrane__V);
        const double var_x139 = 1.0 + var_x138;
        const double var_x140 = 0.00018867924528301889 * var_x138 / pow(var_x139, 2);
        const double var_x141 = 1 / var_x139;
        const double var_x142 = var_x134 / pow(var_x135, 2);
        const double var_x143 = 1 / (0.0030000000000000001 + 0.12 * var_x136);
        const double var_x144 = exp(-1.5517241379310345 - 0.17241379310344829 * var_chaste_interface__membrane__V);
        ...
        const double var_x151 = exp(3.859154929577465 + 0.14084507042253522 * var_chaste_interface__membrane__V);
        const double var_x152 = 1.0 + var_x151;
        const double var_x153 = 0.00014084507042253522 * var_x151 / pow(var_x152, 2);
        const double var_x154 = 1 / var_x152;
        const double var_x155 = exp(-7.9349335449315621 * var_x148);
        const double var_x156 = 1 / (0.062600000000000003 + 1.3323 * var_x155);
        const double var_x157 = exp(0.090909090909090912 - 0.090909090909090912 * var_chaste_interface__membrane__V);
        ...
        const double var_x161 = exp(3.5217391304347827 + 0.086956521739130432 * var_chaste_interface__membrane__V);
        ...
        const double var_x165 = exp(-0.53749999999999998 - 0.125 * var_chaste_interface__membrane__V);
        ...
        const double var_x172 = exp(2.0 + var_x171);
        ...
        const double var_x178 = exp(1.5669291338582676 - 0.07874015748031496 * var_chaste_interface__membrane__V);
        ...
        const double var_x182 = exp(-2.5 - 0.16666666666666666 * var_chaste_interface__membrane__V);
        ...
        const double var_x186 = 0.00037425551606170871 * var_x42;
        const double var_x187 = 1.0307938958145768e-5 * var_x50;
        const double var_x188 = var_x58 * var_chaste_interface__membrane__V;
        const double var_x189 = var_x63 * var_chaste_interface__membrane__V;
        const double var_x190 = 1.7826683054846602e-10 * var_x72;
        const double var_x191 = 5.942227684948868e-7 * var_x25;
        const double var_x192 = var_x187 * var_chaste_interface__membrane__V;
        const double var_x193 = var_x192 * var_x54;
        const double var_x194 = 0.00024950367737447247 * var_x42;
        const double var_x195 = 0.00034849397687453315 * var_x12 - 1.3210516441925016e-5 * var_chaste_interface__membrane__V;
        const double var_x196 = 0.00012778112485399551 * var_x12 - 4.843856028705839e-6 * var_chaste_interface__membrane__V;
        const double var_x197 = 4.6465863583271093e-5 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x198 = 0.00034849397687453315 * var_x19;
        const double var_x199 = 0.00012778112485399551 * var_x18;
        const double var_x200 = 2.3232931791635546e-5 * var_x9;
        const double var_x201 = 0.017834197196598772 - 0.00029723661994331282 * var_chaste_interface__membrane__V;
        ...
        const double var_x204 = 7.5793668809895348e-5 * var_x50;
        const double var_x205 = 0.0027518787945713876 * var_x42;
        const double var_x206 = 1.4564283541541343e-6 * var_x25;
        const double var_x207 = 4.3692850624624026e-10 * var_x72;
        const double var_x208 = 4.369285062462403e-6 * var_x25;
        const double var_x209 = 1.3107855187387207e-9 * var_x72;
        const double var_x210 = var_x204 * var_chaste_interface__membrane__V;
        const double var_x211 = var_x210 * var_x54;
        const double var_x212 = 1.4564283541541343e-10 * var_x72;
        const double var_x213 = 4.8547611805137808e-7 * var_x25;
        ...
        const double var_x216 = 4.3692850624624026e-10 * var_x72;
        const double var_x217 = 0.0018345858630475916 * var_x42;
        const double var_x218 = 9.7136150308272163e-5 * var_chaste_interface__membrane__V - 0.0025624557123127439 * var_x12;
        const double var_x219 = 3.5616588446366462e-5 * var_chaste_interface__membrane__V - 0.00093956709451467277 * var_x12;
        const double var_x220 = 0.00034166076164169918 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x221 = 0.0025624557123127439 * var_x19;
        const double var_x222 = 0.00017083038082084959 * var_x9;
        const double var_x223 = 0.00093956709451467277 * var_x18;
        const double var_x224 = 23.501339000540224 * var_x119;
        const double var_x225 = 47.002678001080447 * var_x126;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * (0.13928000000000001 + 0.5 * var_x9 + 1.0 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n + 3.0 * var_x17 + 2.75 * var_x18 + 7.5 * var_x19 + 0.037484200000000002 * var_x30 - 0.0017706325 * var_x62 - 0.020833333333333332 * var_x33 - 0.17058350483361479 * var_x35 + var_x39 * var_x43 + var_x51 * var_x56 + var_x57 * var_x58 + (6.75 * var_x4 + 6.75 * var_x5) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L - var_x57 * var_x63));
        IJth(rJacobian, 1, 0) = -6.9294442944473474e-8 + 6.6024752054987431e-8 * var_x30;
        IJth(rJacobian, 2, 0) = 0.00012180267965895249 * var_x130 * var_x133 / pow(var_x131, 2) - 23.80952380952381 * var_x132 * (-0.061656057098765427 - 0.0024112654320987653 * var_chaste_interface__membrane__V) * (1 / var_x131 - var_chaste_interface__sodium_current_m_gate__m) / pow((0.57142857142857151 + var_x132), 2);
        IJth(rJacobian, 3, 0) = -var_x137 * var_x140 + 0.010416666666666666 * var_x142 * (var_x141 - var_chaste_interface__sodium_current_h1_gate__h1) / pow((0.01 + var_x136), 2);
        IJth(rJacobian, 4, 0) = -var_x140 * var_x143 + 0.0026041666666666665 * var_x142 * (var_x141 - var_chaste_interface__sodium_current_h2_gate__h2) / pow((0.025000000000000001 + var_x136), 2);
        IJth(rJacobian, 5, 0) = 0.00017241379310344829 * var_x144 * var_x147 / pow(var_x145, 2) - 0.37037037037037035 * var_x146 * (-0.077777777777777779 - 0.0022222222222222222 * var_chaste_interface__membrane__V) * (1 / var_x145 - var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L) / pow((0.7407407407407407 + var_x146), 2);
        IJth(rJacobian, 6, 0) = -var_x150 * var_x153 - 0.0062111801242236021 * var_x149 * (-0.38580246913580246 - 0.0096450617283950612 * var_chaste_interface__membrane__V) * (var_x154 - var_chaste_interface__L_type_Ca_channel_f_L1_gate__f_L_1) / pow((0.062111801242236024 + var_x149), 2);
        IJth(rJacobian, 7, 0) = -var_x153 * var_x156 - 0.00075058170081813405 * var_x155 * (-0.39674667724657808 - 0.0099186669311644524 * var_chaste_interface__membrane__V) * (var_x154 - var_chaste_interface__L_type_Ca_channel_f_L2_gate__f_L_2) / pow((0.046986414471215196 + var_x155), 2);
        IJth(rJacobian, 8, 0) = 9.0909090909090904e-5 * var_x157 * var_x160 / pow(var_x158, 2) + 0.00063492063492063492 * var_x159 * (1 / var_x158 - var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r) * var_chaste_interface__membrane__V / pow((0.42857142857142855 + var_x159), 2);
        IJth(rJacobian, 9, 0) = -8.6956521739130441e-5 * var_x161 * var_x164 / pow(var_x162, 2) - 0.0020781379883624274 * var_x163 * (-0.46809272073427638 - 0.0089245513962683768 * var_chaste_interface__membrane__V) * (1 / var_x162 - var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s) / pow((0.02938487115544472 + var_x163), 2);
        IJth(rJacobian, 10, 0) = 0.000125 * var_x165 * var_x170 / pow(var_x166, 2) + 0.0092592592592592605 * var_x167 * (1 / var_x166 - var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus) / (pow(var_x168, 2) * pow((0.055555555555555559 + var_x169), 2));
        IJth(rJacobian, 11, 0) = -4.0000000000000003e-5 * var_x172 * var_x177 / pow(var_x173, 2) + 5.2222222222222227e-5 * var_x174 * (0.59999999999999998 - var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus + 0.40000000000000002 / var_x173) / (pow(var_x175, 2) * pow((1 + 0.15666666666666668 * var_x176), 2));
        IJth(rJacobian, 12, 0) = 7.874015748031497e-5 * var_x178 * var_x181 / pow(var_x179, 2) - 0.00081632653061224504 * var_x180 * (0.10000000000000001 - var_x59) * (1 / var_x179 - var_chaste_interface__delayed_rectifier_K_currents_n_gate__n) / pow((1 + 0.57142857142857151 * var_x180), 2);
        IJth(rJacobian, 13, 0) = 0.00016666666666666666 * var_x182 * var_x185 / pow(var_x183, 2) - 0.0046044755502348284 * var_x184 * (-0.081723584525982884 - 0.0040582584084490154 * var_chaste_interface__membrane__V) * (1 / var_x183 - var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a) / pow((0.14356754765632193 + var_x184), 2);
        IJth(rJacobian, 14, 0) = -1.0673921144856187e-7 + 9.3563879015427174e-9 * var_x62 + 3.9074763446476996e-7 * var_x189 - 1.9807425616496227e-7 * var_x30 - 3.9074763446476996e-7 * var_x188 - var_x186 * var_x39 - var_x187 * var_x56;
        IJth(rJacobian, 15, 0) = 3.6695879005347264e-8 * var_x33 + 3.004661593767551e-7 * var_x35 - 1.3210516441925016e-5 * var_x19 - 4.843856028705839e-6 * var_x18 - 8.8070109612833433e-7 * var_x9 - 1.7614021922566687e-6 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n - 5.2842065767700058e-6 * var_x17 - 6.2375919343618122e-9 * var_x62 + var_x194 * var_x39;
        ...
        IJth(rJacobian, 21, 0) = 7.848471430041313e-7 + 2.8731443710644848e-6 * var_x188 + 1.4564283541541343e-6 * var_x30 - 2.8731443710644848e-6 * var_x189 - 6.879696986428469e-8 * var_x62 + var_x204 * var_x56 + var_x205 * var_x39;
        IJth(rJacobian, 22, 0) = 5.0951796282701077e-7 - 4.8547611805137808e-7 * var_x30 + (4.3711267638722472e-5 * var_x4 + 4.3711267638722472e-5 * var_x5) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        IJth(rJacobian, 23, 0) = 9.7136150308272163e-5 * var_x19 + 3.5616588446366462e-5 * var_x18 + 3.8854460123308864e-5 * var_x17 + 4.5864646576189789e-8 * var_x62 + 6.4757433538848112e-6 * var_x9 + 1.2951486707769622e-5 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n - 2.6982263974520048e-7 * var_x33 - 2.2093099954173167e-6 * var_x35 - var_x217 * var_x39;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * (4.0 * var_x67 + 1.0378040372231492 * var_x68 - 4.0 * var_x69 - var_x20 * var_x73 - var_x70 * var_x71));
        IJth(rJacobian, 1, 1) = -47.274000000000001 - var_x120 + 6.2720000000000002 * var_chaste_interface__intracellular_Ca_buffering__O_TC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 7.3978892074780085e-7 * var_x115 + 3.5228043845133373e-6 * var_x69 + 9.0 * var_chaste_interface__intracellular_Ca_buffering__O_C - 3.5228043845133373e-6 * var_x67 - 8.2198768971977874 * var_x114 - 9.1399515314883814e-7 * var_x68 - var_x121 * var_x71 - var_x122 * var_x20;
        IJth(rJacobian, 14, 1) = var_x123 * var_x71 + var_x124 * var_x20;
        ...
        IJth(rJacobian, 21, 1) = -var_x20 * var_x207 - var_x206 * var_x71;
        IJth(rJacobian, 22, 1) = 6.7205525966826332e-6 * var_x68 + 2.5902973415539245e-5 * var_x67 - 2.5902973415539245e-5 * var_x69 + var_x20 * var_x212 + var_x213 * var_x71;
        IJth(rJacobian, 24, 1) = var_x224;
        IJth(rJacobian, 25, 1) = 121.858794817616 * var_x114 - 1.0967291533585438e-5 * var_x115;
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.01755636333960639 * var_x64 * var_x75);
        IJth(rJacobian, 2, 2) = -0.001 * var_x133;
        IJth(rJacobian, 14, 2) = -3.0923816874437303e-5 * var_x75;
        IJth(rJacobian, 21, 2) = 0.00022738100642968604 * var_x75;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0052669090018819167 * var_x77);
        IJth(rJacobian, 3, 3) = -0.001 * var_x137;
        IJth(rJacobian, 14, 3) = -9.2771450623311923e-6 * var_x76;
        IJth(rJacobian, 21, 3) = 6.8214301928905822e-5 * var_x76;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00058521211132021302 * var_x77);
        IJth(rJacobian, 4, 4) = -0.001 * var_x143;
        IJth(rJacobian, 14, 4) = -1.0307938958145769e-6 * var_x76;
        IJth(rJacobian, 21, 4) = 7.5793668809895352e-6 * var_x76;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x78 * var_x79);
        IJth(rJacobian, 5, 5) = -0.001 * var_x147;
        IJth(rJacobian, 16, 5) = var_x201 * var_x78;
        IJth(rJacobian, 22, 5) = var_x214 * var_x78;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x2 * var_x80);
        IJth(rJacobian, 6, 6) = -0.001 * var_x150;
        IJth(rJacobian, 16, 6) = var_x2 * var_x202;
        IJth(rJacobian, 22, 6) = var_x2 * var_x215;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x3 * var_x80);
        IJth(rJacobian, 7, 7) = -0.001 * var_x156;
        IJth(rJacobian, 16, 7) = var_x202 * var_x3;
        IJth(rJacobian, 22, 7) = var_x215 * var_x3;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x81 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s);
        IJth(rJacobian, 8, 8) = -0.001 * var_x160;
        ...
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x81 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r);
        IJth(rJacobian, 9, 9) = -0.001 * var_x164;
        ...
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x82 * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus);
        ...
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x82 * var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus);
        IJth(rJacobian, 11, 11) = -0.001 * var_x177;
        ...
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * (var_x31 + 1.0 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 12, 12) = -0.001 * var_x181;
        IJth(rJacobian, 15, 12) = 4.6465863583271093e-5 * var_x12 - 1.7614021922566687e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 23, 12) = 1.2951486707769622e-5 * var_chaste_interface__membrane__V - 0.00034166076164169918 * var_x12;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00050000000000000001 * var_x64 * var_x83);
        IJth(rJacobian, 13, 13) = -0.001 * var_x185;
        IJth(rJacobian, 15, 13) = -8.8070109612833433e-7 * var_x83;
        IJth(rJacobian, 23, 13) = 6.4757433538848112e-6 * var_x83;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * (106.23795 * var_x89 + 1.5986041573362213 * var_x52 - 0.079818144252441769 * var_x90 + var_x53 * var_x92 + var_x84 * var_x86 - var_x85 * var_x87));
        IJth(rJacobian, 1, 14) = var_x123 * var_x86 - var_x124 * var_x85;
        IJth(rJacobian, 14, 14) = 4.2177556280432989e-7 * var_x90 - 0.00056138327409256303 * var_x89 - 2.8157848672826448e-6 * var_x52 + var_x190 * var_x85 - var_x191 * var_x86 - var_x193 * var_x53;
        IJth(rJacobian, 15, 14) = 0.00037425551606170871 * var_x89 - 2.8118370853621991e-7 * var_x90;
        IJth(rJacobian, 21, 14) = 0.0041278181918570807 * var_x89 + 2.0704300494725328e-5 * var_x52 - 3.1012909029730135e-6 * var_x90 + var_x208 * var_x86 + var_x211 * var_x53 - var_x209 * var_x85;
        IJth(rJacobian, 22, 14) = var_x216 * var_x85 - var_x206 * var_x86;
        IJth(rJacobian, 23, 14) = 2.0675272686486755e-6 * var_x90 - 0.0027518787945713876 * var_x89;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * (79.140125612776842 * var_x95 - 4.5 * var_x98 + var_x11 * var_x93 + var_x11 * var_x94 + var_x11 * var_x96 + var_x11 * var_x97));
        IJth(rJacobian, 15, 15) = 7.9263098651550091e-6 * var_x98 - 0.00013939759074981328 * var_x95 - var_x11 * var_x197 - var_x11 * var_x198 - var_x11 * var_x199 - var_x11 * var_x200;
        IJth(rJacobian, 23, 15) = 0.0010249822849250974 * var_x95 - 5.8281690184963299e-5 * var_x98 + var_x11 * var_x220 + var_x11 * var_x221 + var_x11 * var_x222 + var_x11 * var_x223;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x100 * var_x80);
        IJth(rJacobian, 1, 16) = 0.002;
        IJth(rJacobian, 16, 16) = -0.099999999999999992 + var_x100 * var_x202;
        IJth(rJacobian, 22, 16) = var_x100 * var_x215;
        ...
        IJth(rJacobian, 17, 17) = -0.47599999999999998 + var_x203;
        ...
        IJth(rJacobian, 1, 19) = 0.0010559999999999999 + var_x125;
        IJth(rJacobian, 19, 19) = -0.0066 + var_x203;
        IJth(rJacobian, 20, 19) = -5.0;
        IJth(rJacobian, 1, 20) = var_x125;
        IJth(rJacobian, 19, 20) = var_x203;
        IJth(rJacobian, 20, 20) = -5.6660000000000004;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * (-var_x92 - 1.5986041573362213 * var_x101 + var_x55 * var_x91 - var_x102 * var_x87 - var_x103 * var_x84));
        IJth(rJacobian, 1, 21) = -var_x102 * var_x124 - var_x103 * var_x123;
        IJth(rJacobian, 14, 21) = var_x193 + 2.8157848672826448e-6 * var_x101 + var_x102 * var_x190 + var_x103 * var_x191 - var_x192 * var_x55;
        IJth(rJacobian, 21, 21) = -6.993006993006993e-5 - var_x211 - 2.0704300494725328e-5 * var_x101 + var_x210 * var_x55 - var_x102 * var_x209 - var_x103 * var_x208;
        IJth(rJacobian, 22, 21) = var_x102 * var_x216 + var_x103 * var_x206;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * (-1.0378040372231492 * var_x104 + var_x105 * var_x70 - var_x22 * var_x73));
        IJth(rJacobian, 1, 22) = 9.1399515314883814e-7 * var_x104 + var_x105 * var_x121 - var_x122 * var_x22;
        IJth(rJacobian, 14, 22) = var_x124 * var_x22 - var_x105 * var_x123;
        IJth(rJacobian, 21, 22) = var_x105 * var_x206 - var_x207 * var_x22;
        IJth(rJacobian, 22, 22) = -4.048582995951417e-5 - 6.7205525966826332e-6 * var_x104 + var_x212 * var_x22 - var_x105 * var_x213;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * (1.3371 * var_x109 + 4.5 * var_x110 - 79.140125612776842 * var_x107 + var_x111 * var_x43 - var_x108 * var_x93 - var_x108 * var_x94 - var_x108 * var_x96 - var_x108 * var_x97 - var_x112 * var_x43));
        IJth(rJacobian, 14, 23) = var_x112 * var_x186 - var_x111 * var_x186;
        IJth(rJacobian, 15, 23) = 0.00013939759074981328 * var_x107 - 7.9263098651550091e-6 * var_x110 - 2.3551708712663917e-6 * var_x109 + var_x108 * var_x197 + var_x108 * var_x198 + var_x108 * var_x199 + var_x108 * var_x200 + var_x111 * var_x194 - var_x112 * var_x194;
        IJth(rJacobian, 21, 23) = var_x111 * var_x205 - var_x112 * var_x205;
        IJth(rJacobian, 23, 23) = -0.0001 + 1.7317432876958762e-5 * var_x109 + 5.8281690184963299e-5 * var_x110 - 0.0010249822849250974 * var_x107 + var_x112 * var_x217 - var_x108 * var_x220 - var_x108 * var_x221 - var_x108 * var_x222 - var_x108 * var_x223 - var_x111 * var_x217;
        IJth(rJacobian, 1, 24) = var_x120;
        ...
        IJth(rJacobian, 1, 25) = 0.00078910818213098765 * var_x114 + 1.7754934097947219e-10 * var_x115;
        IJth(rJacobian, 24, 25) = 0.099999999999999992;
        IJth(rJacobian, 25, 25) = -0.011111111111111112 - 2.632149968060505e-9 * var_x115 - 0.011698444302491135 * var_x114;
        ...
        IJth(rJacobian, 1, 28) = var_x127 * var_x128 - var_x127 * var_x129;
        IJth(rJacobian, 24, 28) = var_x129 * var_x225 - var_x128 * var_x225;
