...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellclancy_rudy_2002FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x144 = 9.0316078310111333e-5 * var_x143;
        ...
        const double var_x152 = var_x150 * var_x151 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x163 = var_x117 * var_x93;
        const double var_x164 = 0.00070463905573898956 * var_x143;
        const double var_x165 = var_x119 * var_x93;
        const double var_x166 = ((var_x154) ? (var_x153 - var_x152 * var_chaste_interface__calcium_dynamics__APtrack2) : (0));
        const double var_x167 = var_x160 * (0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x168 = var_x148 * var_chaste_interface__calcium_dynamics__APtrack2 * NV_Ith_S(mParameters, 0);
        const double var_x169 = ((var_x154) ? (var_x150 * var_x168 - var_x151 * var_x168 / pow(var_x149, 2)) : (0));
        const double var_x170 = ((var_x154) ? (0) : ((var_x155) ? (4000.0 - 8000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        ...
        const double var_x174 = 0.30923180592991917 * var_x173;
        ...
        const double var_x177 = (0.0085583333333333327 * var_x175 + 0.0016666666666666668 * var_x176) / pow((var_x176 + 0.4108 * var_x175), 2);
        const double var_x178 = 60.832000000000001 * var_x177;
        ...
        const double var_x185 = var_x183 / pow((1 + 0.0023809523809523807 * var_chaste_interface__membrane__V), 2);
        const double var_x186 = 0.96266383952581813 * var_x173 * var_x177 * var_x179 * var_x181 * var_x182;
        ...
        const double var_x192 = 0.009852216748768473 * var_x191;
        const double var_x193 = 4.926363636363636e-8 * var_x181;
        const double var_x194 = exp(-0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x195 = 71.871455576559541 * (0.0068466666666666667 * var_x194 + 0.0015333333333333334 * var_x176) / pow((var_x176 + 0.44652173913043475 * var_x194), 2);
        ...
        const double var_x203 = 0.0094433497536945809 * var_x202;
        const double var_x204 = var_x203 - var_x195;
        const double var_x205 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x206 = 95.049999999999983 * (0.0013333333333333335 * var_x176 + 0.0060411764705882356 * var_x205) / pow((var_x176 + 0.51349999999999996 * var_x205), 2);
        ...
        const double var_x212 = 0.0030923180592991916 * var_x173;
        const double var_x213 = 0.0084000000000000012 + var_x198;
        const double var_x214 = 0.09178 * var_x173;
        const double var_x215 = -var_x201;
        const double var_x216 = 3.2550716413675699e-6 * var_x173;
        const double var_x217 = 9.8527272727272722e-10 * var_x181 * var_chaste_interface__Na_channel_states__P_IM2;
        const double var_x218 = 9.6610526315789479e-5 * var_x173;
        const double var_x219 = 7.5866000000000003e-9 * var_x181;
        const double var_x220 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x226 = 0.005608974358974359 * var_x221 * var_x225;
        const double var_x227 = var_x226 / pow(var_x222, 2);
        ...
        const double var_x232 = var_x231 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x233 = var_x223 * var_x226 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x236 = 19.699999999999999 * var_x235;
        const double var_x237 = 0.001 - 0.001 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x238 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V);
        const double var_x239 = 1.0 + var_x238;
        const double var_x240 = 0.029999999999999999 * var_x238 / pow(var_x239, 2);
        const double var_x241 = exp(4.0 + 0.125 * var_chaste_interface__membrane__V);
        const double var_x242 = 1.0 + var_x241;
        const double var_x243 = 0.125 * var_x241 / pow(var_x242, 2);
        ...
        const double var_x249 = -0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V;
        ...
        const double var_x263 = var_x262 * pow(NV_Ith_S(mParameters, 2), (-0.29999999999999999));
        const double var_x264 = 0.00097032784950386709 * var_x263;
        ...
        const double var_x267 = var_x266 * var_chaste_interface__Kr_channel_states__P_C1;
        const double var_x268 = 0.0036333852149999998 * var_x267;
        const double var_x269 = exp(-0.58799999999999997 - 0.023519999999999999 * var_chaste_interface__membrane__V);
        const double var_x270 = var_x269 / NV_Ith_S(mParameters, 2);
        const double var_x271 = 0.04646376 * var_x270;
        const double var_x272 = 0.0029357000000000003 * var_x261;
        const double var_x273 = 1.0300720270741688 * var_x263;
        const double var_x274 = 0.065500000000000003 * var_x266;
        const double var_x275 = 1.9755 * var_x270;
        const double var_x276 = var_x261 * var_x269 * pow(NV_Ith_S(mParameters, 2), (-0.69999999999999996)) / var_x262;
        const double var_x277 = 0.00025922405137351976 * var_x276;
        ...
        const double var_x280 = var_x279 * var_chaste_interface__Kr_channel_states__P_C2;
        const double var_x281 = exp(-0.66565836 + var_x265);
        const double var_x282 = 0.0030786699149999998 * var_x281 * var_chaste_interface__Kr_channel_states__P_C3;
        const double var_x283 = 0.0023570000000000002 * var_x279;
        const double var_x284 = 0.055500000000000001 * var_x281;
        const double var_x285 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V);
        const double var_x286 = 1.0 + var_x285;
        const double var_x287 = 0.001 / var_x286;
        ...
        const double var_x291 = 0.13100000000000001 * var_x290;
        ...
        const double var_x295 = 0.071899999999999992 * var_x294;
        const double var_x296 = 30.0 + var_chaste_interface__membrane__V;
        const double var_x297 = var_x288 * var_x296 / pow(var_x289, 2);
        const double var_x298 = var_x292 * var_x296 / pow(var_x293, 2);
        const double var_x299 = 5.9880239520958083e-5 * var_x285 / pow(var_x286, 2);
        const double var_x300 = var_x290 * var_x296;
        const double var_x301 = var_x294 * var_x296;
        const double var_x302 = 0.032750000000000001 * var_x290;
        const double var_x303 = 0.017974999999999998 * var_x294;
        ...
        const double var_x311 = 10000.0 * var_x307 + 10000.0 * var_x310;
        const double var_x312 = 1 / var_x311;
        const double var_x313 = 10.0 * var_x307;
        const double var_x314 = 400.0 * var_x307;
        const double var_x315 = 400.0 * pow(var_x308, 2) / pow(var_x309, 2);
        const double var_x316 = pow(var_x305, 2) / pow(var_x306, 2);
        const double var_x317 = 400.0 * var_x316;
        const double var_x318 = 400.0 * var_x310;
        const double var_x319 = 0.40000000000000002 * var_x312;
        ...
        const double var_x327 = 15.0 * var_x323 + 100.0 * var_x326;
        const double var_x328 = var_x321 / pow(var_x322, 2);
        const double var_x329 = 3.0 * var_x328;
        const double var_x330 = 20.0 * pow(var_x324, 2) / pow(var_x325, 2);
        const double var_x331 = 20.0 * var_x326;
        const double var_x332 = 1 / var_x327;
        ...
        const double var_x338 = var_x337 * (-var_chaste_interface__calcium_dynamics__Ca_JSR + var_chaste_interface__calcium_dynamics__Cai);
        ...
        const double var_x341 = 0.70463905573898955 * var_x142;
        ...
        IJth(rJacobian, 2, 0) = var_x178 * var_chaste_interface__Na_channel_states__P_C1 + var_x186 * var_chaste_interface__Na_channel_states__P_IF + (-var_x174 + 0.01083743842364532 * var_x172) * var_chaste_interface__Na_channel_states__P_O_Na - 0.0028227905226106183 * var_x184 * var_chaste_interface__Na_channel_states__P_IF - 1.7053993755772005e-5 * var_x185 * var_chaste_interface__Na_channel_states__P_IF;
        IJth(rJacobian, 3, 0) = var_x195 * var_chaste_interface__Na_channel_states__P_C2 + (-2.0000000000000002e-5 + var_x192 - var_x178) * var_chaste_interface__Na_channel_states__P_C1 - var_x193 * var_chaste_interface__Na_channel_states__P_IF - 0.01083743842364532 * var_x172 * var_chaste_interface__Na_channel_states__P_O_Na;
        IJth(rJacobian, 4, 0) = var_x206 * var_chaste_interface__Na_channel_states__P_C3 + (-2.0000000000000002e-5 + var_x204) * var_chaste_interface__Na_channel_states__P_C2 - var_x192 * var_chaste_interface__Na_channel_states__P_C1 - var_x193 * var_chaste_interface__Na_channel_states__P_IC2;
        IJth(rJacobian, 5, 0) = (-2.0000000000000002e-5 + var_x210) * var_chaste_interface__Na_channel_states__P_C3 - var_x193 * var_chaste_interface__Na_channel_states__P_IC3 - var_x203 * var_chaste_interface__Na_channel_states__P_C2;
        IJth(rJacobian, 6, 0) = 2.0000000000000002e-5 * var_chaste_interface__Na_channel_states__P_C1 + var_x174 * var_chaste_interface__Na_channel_states__P_O_Na + var_x195 * var_chaste_interface__Na_channel_states__P_IC2 + (var_x192 + var_x193 - var_x186 - var_x212 + 0.0028227905226106183 * var_x184 + 1.7053993755772005e-5 * var_x185) * var_chaste_interface__Na_channel_states__P_IF - var_x193 * var_chaste_interface__Na_channel_states__P_IM1;
        IJth(rJacobian, 7, 0) = 2.0000000000000002e-5 * var_chaste_interface__Na_channel_states__P_C3 + (var_x193 + var_x210) * var_chaste_interface__Na_channel_states__P_IC3 - var_x203 * var_chaste_interface__Na_channel_states__P_IC2;
        IJth(rJacobian, 8, 0) = 2.0000000000000002e-5 * var_chaste_interface__Na_channel_states__P_C2 + var_x206 * var_chaste_interface__Na_channel_states__P_IC3 + (var_x193 + var_x204) * var_chaste_interface__Na_channel_states__P_IC2 - var_x192 * var_chaste_interface__Na_channel_states__P_IF;
        IJth(rJacobian, 9, 0) = -var_x217 + var_x212 * var_chaste_interface__Na_channel_states__P_IF + (var_x193 - var_x216) * var_chaste_interface__Na_channel_states__P_IM1;
        IJth(rJacobian, 10, 0) = var_x217 + var_x216 * var_chaste_interface__Na_channel_states__P_IM1;
        IJth(rJacobian, 11, 0) = var_x220 * var_x224 + var_x227 * var_x232 + var_x229 * var_x233 + var_x230 * var_x233 - var_x220 * var_x227 - var_x224 * var_x232;
        IJth(rJacobian, 12, 0) = var_x237 * (20.0 + var_x236) * (var_x240 - var_x243) + var_x245 * (var_x243 - var_x240) * var_chaste_interface__L_type_Ca_channel_f_gate__f + var_x236 * var_x237 * var_x248 * var_x249 - var_x244 * var_x249 * var_x250 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 13, 0) = 9.2592592592592588e-5 * var_x251 * var_x256 / pow(var_x252, 2) + 0.036429872495446262 * var_x253 * (-var_chaste_interface__T_type_Ca_channel_b_gate__b + 1 / var_x252) / (pow(var_x254, 2) * pow((0.60655737704918034 + var_x255), 2));
        IJth(rJacobian, 14, 0) = (0.001 / var_x258 - 0.001 * var_chaste_interface__T_type_Ca_channel_g_gate__g) * ((var_x259) ? (6.0763888888888884 / pow((1 - 0.072916666666666671 * var_chaste_interface__membrane__V), 2)) : (0)) - 0.00017857142857142857 * var_x257 * var_x260 / pow(var_x258, 2);
        IJth(rJacobian, 15, 0) = var_x268 + (-var_x264 + 6.3352406000000003e-5 * var_x261) * var_chaste_interface__Kr_channel_states__P_O - var_x271 * var_chaste_interface__Kr_channel_states__P_I;
        IJth(rJacobian, 16, 0) = -0.0072667704299999997 * var_x267 - var_x277 * var_chaste_interface__Kr_channel_states__P_I - 6.3352406000000003e-5 * var_x261 * var_chaste_interface__Kr_channel_states__P_O;
        IJth(rJacobian, 17, 0) = var_x282 + 8.6237916000000007e-5 * var_x280;
        IJth(rJacobian, 18, 0) = -var_x282 - 8.6237916000000007e-5 * var_x280;
        IJth(rJacobian, 19, 0) = var_x268 + var_x264 * var_chaste_interface__Kr_channel_states__P_O + (var_x271 + var_x277) * var_chaste_interface__Kr_channel_states__P_I;
        IJth(rJacobian, 20, 0) = var_x299 * (var_x291 * var_x296 + var_x295 * var_x296) + (var_x287 - var_x127) * (var_x291 + var_x295 - 0.0089997000000000011 * var_x297 - 0.0106412 * var_x298);
        IJth(rJacobian, 21, 0) = var_x299 * (var_x296 * var_x302 + var_x296 * var_x303) + (var_x287 - var_x125) * (var_x302 + var_x303 - 0.0022499250000000003 * var_x297 - 0.0026603 * var_x298);
        IJth(rJacobian, 22, 0) = var_x311 * (var_x307 * var_x319 - var_x316 * var_x319 + 9.9999999999999995e-8 * var_x307 * (var_x317 + var_x318 - var_x314 - var_x315) / pow((var_x307 + var_x310), 2)) + (-0.001 * var_chaste_interface__transient_outward_current_zdv_gate__zdv + var_x312 * var_x313) * (var_x314 + var_x315 - var_x317 - var_x318);
        IJth(rJacobian, 23, 0) = var_x327 * (-0.0030000000000000001 * var_x328 * var_x332 + 1.5e-6 * var_x323 * (var_x329 + var_x330 - var_x331) / pow((var_x326 + 0.14999999999999999 * var_x323), 2)) + (-0.001 * var_chaste_interface__transient_outward_current_ydv_gate__ydv + var_x332 * var_x333) * (var_x331 - var_x329 - var_x330);
        IJth(rJacobian, 29, 0) = 0.001 * ((var_x340) ? (-var_x159 * (var_x138 + var_x50 - var_x52 - var_x63)) : (0));
        ...
        IJth(rJacobian, 1, 1) = var_x160 * (-var_x147 - var_x157 + 0.71029411764705874 * var_x158 - var_x159 * (var_x113 + 2.0 * var_x100 + 0.00020000000000000001 * var_x102)) + 0.001 * (0.00023800000000000004 / pow(var_x139, 3) + 7.0000000000000007e-5 / pow(var_x110, 3)) * (0.047352941176470584 * var_chaste_interface__calcium_dynamics__Ca_NSR + var_x157 * var_x161 - var_x147 * var_chaste_interface__calcium_dynamics__Cai - var_x159 * (var_x162 + 0.003016 * var_chaste_interface__membrane__V - 2.0 * var_x137)) / pow(var_x140, 2);
        IJth(rJacobian, 24, 1) = var_x156 * var_x337;
        IJth(rJacobian, 25, 1) = 0.0087500000000000008 * var_x146 - 0.0087500000000000008 * var_x158;
        IJth(rJacobian, 29, 1) = 0.001 * ((var_x340) ? (-var_x159 * (var_x100 + var_x103 + var_x113)) : (0));
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x116 * var_x99 * NV_Ith_S(mParameters, 6));
        IJth(rJacobian, 2, 2) = -var_x187 - var_x188;
        IJth(rJacobian, 3, 2) = var_x188;
        IJth(rJacobian, 6, 2) = var_x187;
        IJth(rJacobian, 2, 3) = var_x189;
        IJth(rJacobian, 3, 3) = var_x197 + var_x199 - var_x189;
        IJth(rJacobian, 4, 3) = var_x196;
        IJth(rJacobian, 6, 3) = var_x213;
        IJth(rJacobian, 3, 4) = var_x200;
        IJth(rJacobian, 4, 4) = var_x199 + var_x208;
        IJth(rJacobian, 5, 4) = var_x207;
        IJth(rJacobian, 8, 4) = var_x213;
        IJth(rJacobian, 4, 5) = var_x209;
        IJth(rJacobian, 5, 5) = var_x199 + var_x211;
        IJth(rJacobian, 7, 5) = var_x213;
        IJth(rJacobian, 2, 6) = var_x190;
        IJth(rJacobian, 3, 6) = var_x201;
        IJth(rJacobian, 6, 6) = var_x197 + var_x215 - var_x190 - var_x214;
        IJth(rJacobian, 8, 6) = var_x196;
        IJth(rJacobian, 9, 6) = var_x214;
        IJth(rJacobian, 5, 7) = var_x201;
        IJth(rJacobian, 7, 7) = var_x211 + var_x215;
        IJth(rJacobian, 8, 7) = var_x209;
        IJth(rJacobian, 4, 8) = var_x201;
        IJth(rJacobian, 6, 8) = var_x200;
        IJth(rJacobian, 7, 8) = var_x207;
        IJth(rJacobian, 8, 8) = var_x208 + var_x215;
        IJth(rJacobian, 6, 9) = var_x201;
        IJth(rJacobian, 9, 9) = var_x215 - var_x218;
        IJth(rJacobian, 10, 9) = var_x218;
        IJth(rJacobian, 9, 10) = var_x219;
        ...
        IJth(rJacobian, 1, 11) = -var_x163 * var_x164;
        IJth(rJacobian, 11, 11) = -var_x234 - var_x231 * var_x234;
        IJth(rJacobian, 29, 11) = 0.001 * ((var_x340) ? (-var_x163 * var_x341) : (0));
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x99 * (var_x119 * var_x94 + var_x120 * var_x72 + var_x120 * var_x75));
        IJth(rJacobian, 1, 12) = -var_x164 * var_x165;
        IJth(rJacobian, 12, 12) = var_x245 * var_x248 + var_x245 * var_x250;
        IJth(rJacobian, 29, 12) = 0.001 * ((var_x340) ? (-var_x165 * var_x341) : (0));
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0001 * var_x123 * var_x98);
        IJth(rJacobian, 1, 13) = -9.0316078310111336e-6 * var_x123 * var_x143;
        IJth(rJacobian, 13, 13) = -0.001 * var_x256;
        IJth(rJacobian, 29, 13) = 0.001 * ((var_x340) ? (-0.0090316078310111337 * var_x123 * var_x142) : (0));
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-5.0000000000000002e-5 * var_x124 * var_x98);
        IJth(rJacobian, 1, 14) = -4.5158039155055668e-6 * var_x124 * var_x143;
        IJth(rJacobian, 14, 14) = -0.001 * var_x260;
        IJth(rJacobian, 29, 14) = 0.001 * ((var_x340) ? (-0.0045158039155055668 * var_x124 * var_x142) : (0));
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x7 * var_x99);
        IJth(rJacobian, 15, 15) = -var_x272 - var_x273;
        IJth(rJacobian, 16, 15) = var_x272;
        IJth(rJacobian, 19, 15) = var_x273;
        IJth(rJacobian, 15, 16) = var_x274;
        IJth(rJacobian, 16, 16) = -1.077 - 0.13100000000000001 * var_x266;
        IJth(rJacobian, 17, 16) = 1.077;
        IJth(rJacobian, 19, 16) = var_x274;
        IJth(rJacobian, 16, 17) = 2.1720000000000002;
        IJth(rJacobian, 17, 17) = -2.1720000000000002 - var_x283;
        IJth(rJacobian, 18, 17) = var_x283;
        IJth(rJacobian, 17, 18) = var_x284;
        IJth(rJacobian, 18, 18) = -var_x284;
        IJth(rJacobian, 15, 19) = var_x275;
        IJth(rJacobian, 16, 19) = var_x278;
        IJth(rJacobian, 19, 19) = -var_x275 - var_x278;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x125 * var_x126);
        IJth(rJacobian, 20, 20) = -0.00013100000000000001 * var_x300 - 7.1899999999999999e-5 * var_x301;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * var_x127);
        IJth(rJacobian, 21, 21) = -3.2750000000000003e-5 * var_x300 - 1.7975e-5 * var_x301;
        ...
        IJth(rJacobian, 22, 22) = -var_x313 - 10.0 * var_x310;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0011000000000000001 * var_x128 * var_x20);
        IJth(rJacobian, 23, 23) = -var_x333 - 0.10000000000000001 * var_x326;
        IJth(rJacobian, 1, 24) = 7.0588235294117632e-6 * var_x141 * var_x156;
        IJth(rJacobian, 24, 24) = var_x337 * (-5.5555555555555554 - var_x156) + 0.00025000000000000001 * (5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR - var_x156 * var_x161) / (pow(var_x334, 3) * pow((0.125 + var_x335), 2));
        IJth(rJacobian, 25, 24) = 0.00048309178743961351;
        IJth(rJacobian, 1, 25) = 4.7352941176470584e-5 * var_x141;
        IJth(rJacobian, 24, 25) = 0.0055555555555555558 * var_x336;
        IJth(rJacobian, 25, 25) = -0.001066425120772947;
        IJth(rJacobian, 26, 26) = 0.001 * ((var_x98 * (var_x137 + var_x162 + 0.0070159999999999997 * var_chaste_interface__membrane__V - 0.10684935482199306 * var_x115 + var_x11 * var_x22 + var_x11 * var_x3 + var_x11 * var_x37 + var_x11 * var_x5 + var_x11 * var_x8 + var_x116 * var_x6 + var_x129 * var_x60 + var_x73 * var_chaste_interface__membrane__V + var_x76 * var_chaste_interface__membrane__V + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 0.433 * var_x106 * (1.0 + 0.59999999999999998 * var_x15)) < -150000.0) ? (-100500.0) : (-500.0));
        IJth(rJacobian, 1, 27) = var_x166 * var_x167;
        IJth(rJacobian, 24, 27) = var_x166 * var_x338;
        IJth(rJacobian, 27, 27) = 0.001 * ((var_x339) ? (-100500.0) : (-500.0));
        IJth(rJacobian, 28, 28) = 0.001 * ((var_x339) ? (-100500.0) : (-10.0));
        IJth(rJacobian, 1, 29) = var_x167 * var_x169;
        IJth(rJacobian, 24, 29) = var_x169 * var_x338;
        IJth(rJacobian, 29, 29) = 0.001 * (((var_x340) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-500.0));
        ...
        IJth(rJacobian, 1, 31) = var_x167 * var_x170;
        IJth(rJacobian, 24, 31) = var_x170 * var_x338;
        IJth(rJacobian, 31, 31) = 0.001 * (((var_x342) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50000.0) : (-500.0));
        IJth(rJacobian, 32, 32) = 0.001 * (((var_x342) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50000.0) : (-10.0));
        ...
        IJth(rJacobian, 29, 33) = 0.001 * ((var_x340) ? (-var_x159 * (var_x135 - var_x133)) : (0));
