...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellclancy_rudy_2002FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x22 = 0.0012190504118344883 * NV_Ith_S(mParameters, 4);
        const double var_x23 = exp(9.9999999999999995e-8);
        const double var_x24 = 1 / (-1.0 + var_x23);
        const double var_x25 = -0.75 * NV_Ith_S(mParameters, 3);
        const double var_x26 = 0.75 * var_chaste_interface__ionic_concentrations__Nai;
        ...
        const double var_x38 = 0.0024381008236689767 * var_x35 * var_x37;
        ...
        const double var_x46 = 0.0003485581177541574 * NV_Ith_S(mParameters, 4);
        const double var_x47 = -0.75 * NV_Ith_S(mParameters, 2);
        const double var_x48 = 0.75 * var_chaste_interface__ionic_concentrations__Ki;
        ...
        const double var_x52 = 0.00069711623550831479 * var_x37 * var_x51;
        ...
        const double var_x122 = 6.5127374999999992e-9 * NV_Ith_S(mParameters, 4);
        const double var_x123 = var_x122 * var_x27;
        const double var_x124 = -var_x123 - var_x122 * var_x30;
        const double var_x125 = -0.5 + 187179.41753901311 * var_chaste_interface__membrane__V;
        const double var_x126 = var_x38 * var_chaste_interface__membrane__V;
        const double var_x127 = ((var_x32) ? (var_x123 - var_x124 * var_x125) : (var_x126));
        const double var_x128 = var_x127 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x129 = var_chaste_interface__L_type_Ca_channel_d_gate__d / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x130 = 0.00059999999999999995 * var_x129;
        const double var_x131 = 1.8621604999999999e-9 * NV_Ith_S(mParameters, 4);
        const double var_x132 = var_x131 * var_x49;
        const double var_x133 = -var_x132 - var_x131 * var_x50;
        const double var_x134 = var_x52 * var_chaste_interface__membrane__V;
        const double var_x135 = ((var_x32) ? (var_x132 - var_x125 * var_x133) : (var_x134));
        const double var_x136 = var_x130 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x137 = var_x101 * pow(var_x96, 2);
        const double var_x138 = var_x137 * var_x90;
        const double var_x139 = 0.0001 * var_x138;
        ...
        const double var_x141 = -26.712338705498265 * log(var_x140 * (0.018329999999999999 * NV_Ith_S(mParameters, 3) + NV_Ith_S(mParameters, 2))) + var_chaste_interface__membrane__V;
        const double var_x142 = var_x141 * var_x20 * NV_Ith_S(mParameters, 9);
        const double var_x143 = 1.042038e-5 * NV_Ith_S(mParameters, 4);
        const double var_x144 = var_x23 * var_x24;
        const double var_x145 = var_x143 * var_x144;
        const double var_x146 = var_x28 * var_x29;
        const double var_x147 = var_x145 + (0.5 - 374358.83507802623 * var_chaste_interface__membrane__V) * (-var_x145 - var_x143 * var_x146);
        const double var_x148 = var_x64 * var_x66;
        const double var_x149 = var_x143 * var_x56;
        const double var_x150 = var_x143 * var_x57;
        const double var_x151 = -0.5 + 374358.83507802623 * var_chaste_interface__membrane__V;
        const double var_x152 = var_x149 - var_x151 * (-var_x149 - var_x150);
        const double var_x153 = var_x65 * var_chaste_interface__membrane__V;
        const double var_x154 = ((var_x59) ? (var_x152) : (var_x153));
        const double var_x155 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x156 = 1.1499999999999999 / var_x155;
        const double var_x157 = pow(var_x155, (-2));
        const double var_x158 = var_x156 + 0.040282206767891383 * var_x15 + 0.6678084676374566 * var_x15 * var_x8 - 1.1499999999999999 * var_x157 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x159 = var_x158 + var_x45 * ((var_x59) ? (var_x147) : (var_x148)) - var_x136 * var_x154;
        const double var_x160 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x161 = log(var_x160 * NV_Ith_S(mParameters, 3));
        const double var_x162 = -26.712338705498265 * var_x161 + var_chaste_interface__membrane__V;
        const double var_x163 = var_x154 * var_x44;
        const double var_x164 = var_x43 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x165 = log(var_x15 * NV_Ith_S(mParameters, 1));
        const double var_x166 = -13.356169352749133 * var_x165 + var_chaste_interface__membrane__V;
        const double var_x167 = var_x166 * var_chaste_interface__T_type_Ca_channel_b_gate__b * var_chaste_interface__T_type_Ca_channel_g_gate__g;
        const double var_x168 = var_x166 * var_x7;
        const double var_x169 = 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        const double var_x170 = var_x119 * var_x141 * var_x19;
        const double var_x171 = 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
        const double var_x172 = var_x119 * var_x14;
        const double var_x173 = 187179.41753901311 * var_chaste_interface__membrane__V;
        const double var_x174 = 0.5 - var_x173;
        const double var_x175 = 4.8845531249999998e-9 * NV_Ith_S(mParameters, 4);
        const double var_x176 = var_x144 * var_x175;
        const double var_x177 = var_x103 * NV_Ith_S(mParameters, 2) / var_x107;
        const double var_x178 = var_x140 * var_x21;
        const double var_x179 = var_x108 * var_x93;
        const double var_x180 = var_x111 * var_x179;
        const double var_x181 = 3 * var_x180;
        const double var_x182 = var_x137 * var_x179;
        const double var_x183 = 0.00030000000000000003 * var_x182;
        const double var_x184 = 1.3966203749999998e-9 * NV_Ith_S(mParameters, 4);
        const double var_x185 = var_x144 * var_x184;
        ...
        const double var_x190 = 1.0 + 0.00011900000000000002 / pow(var_x189, 2) + 3.5000000000000004e-5 * var_x157;
        ...
        const double var_x212 = -0.040282206767891383 * var_x165 + var_x156 * var_chaste_interface__calcium_dynamics__Cai + var_x166 * var_x9;
        const double var_x213 = var_x42 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x214 = var_x154 * var_x194;
        const double var_x215 = var_x42 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x216 = ((var_x204) ? (var_x203 - var_x202 * var_chaste_interface__calcium_dynamics__APtrack2) : (0));
        const double var_x217 = var_x210 * (0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x218 = var_x198 * var_chaste_interface__calcium_dynamics__APtrack2 * NV_Ith_S(mParameters, 0);
        const double var_x219 = ((var_x204) ? (var_x200 * var_x218 - var_x201 * var_x218 / pow(var_x199, 2)) : (0));
        const double var_x220 = ((var_x204) ? (0) : ((var_x205) ? (4000.0 - 8000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x221 = -0.04926108374384236 * var_chaste_interface__membrane__V;
        const double var_x222 = exp(0.49261083743842365 + var_x221);
        const double var_x223 = exp(0.033692722371967652 * var_chaste_interface__membrane__V);
        const double var_x224 = 0.30923180592991917 * var_x223;
        const double var_x225 = exp(-0.083333333333333329 * var_chaste_interface__membrane__V);
        const double var_x226 = exp(-0.0066666666666666671 * var_chaste_interface__membrane__V);
        const double var_x227 = (0.0085583333333333327 * var_x225 + 0.0016666666666666668 * var_x226) / pow((var_x226 + 0.4108 * var_x225), 2);
        const double var_x228 = 60.832000000000001 * var_x227;
        const double var_x229 = 1 / (8.4000000000000004 + 0.02 * var_chaste_interface__membrane__V);
        const double var_x230 = 1 / (0.25 * var_x226 + 0.1027 * var_x225);
        const double var_x231 = exp(-0.12987012987012986 * var_chaste_interface__membrane__V);
        const double var_x232 = 1 / var_x222;
        const double var_x233 = var_x223 * var_x230 * var_x231 * var_x232;
        const double var_x234 = var_x229 * var_x233;
        const double var_x235 = var_x233 / pow((1 + 0.0023809523809523807 * var_chaste_interface__membrane__V), 2);
        const double var_x236 = 0.96266383952581813 * var_x223 * var_x227 * var_x229 * var_x231 * var_x232;
        const double var_x237 = 9.1780000000000008 * var_x223;
        const double var_x238 = 0.22 * var_x222;
        const double var_x239 = 3.802 * var_x230;
        const double var_x240 = 0.060166489970363633 * var_x234;
        const double var_x241 = exp(0.24630541871921183 + var_x221);
        const double var_x242 = 0.009852216748768473 * var_x241;
        const double var_x243 = 4.926363636363636e-8 * var_x231;
        const double var_x244 = exp(-0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x245 = 71.871455576559541 * (0.0068466666666666667 * var_x244 + 0.0015333333333333334 * var_x226) / pow((var_x226 + 0.44652173913043475 * var_x244), 2);
        const double var_x246 = 0.20000000000000001 * var_x241;
        const double var_x247 = -var_x246;
        const double var_x248 = 2.0000000000000002e-5 * var_chaste_interface__membrane__V;
        const double var_x249 = -0.0084000000000000012 - var_x248;
        const double var_x250 = 3.802 / (0.1027 * var_x244 + 0.23000000000000001 * var_x226);
        const double var_x251 = 3.7933e-7 * var_x231;
        const double var_x252 = exp(var_x221);
        const double var_x253 = 0.0094433497536945809 * var_x252;
        const double var_x254 = var_x253 - var_x245;
        const double var_x255 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x256 = 95.049999999999983 * (0.0013333333333333335 * var_x226 + 0.0060411764705882356 * var_x255) / pow((var_x226 + 0.51349999999999996 * var_x255), 2);
        const double var_x257 = 0.19169999999999998 * var_x252;
        const double var_x258 = -var_x250 - var_x257;
        const double var_x259 = 3.802 / (0.20000000000000001 * var_x226 + 0.1027 * var_x255);
        const double var_x260 = -var_x256;
        const double var_x261 = -var_x259;
        const double var_x262 = 0.0030923180592991916 * var_x223;
        const double var_x263 = 0.0084000000000000012 + var_x248;
        const double var_x264 = 0.09178 * var_x223;
        const double var_x265 = -var_x251;
        const double var_x266 = 3.2550716413675699e-6 * var_x223;
        const double var_x267 = 9.8527272727272722e-10 * var_x231 * var_chaste_interface__Na_channel_states__P_IM2;
        const double var_x268 = 9.6610526315789479e-5 * var_x223;
        const double var_x269 = 7.5866000000000003e-9 * var_x231;
        const double var_x270 = exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V);
        const double var_x271 = 1.0 + var_x270;
        const double var_x272 = 0.001 / var_x271;
        const double var_x273 = -0.001 + var_x272;
        const double var_x274 = exp(1.0000000001853256e-7);
        const double var_x275 = (1.0 - var_x274) / (1.0 + var_x274);
        const double var_x276 = 45787.545779060179 * var_x275;
        const double var_x277 = exp(-1.0000000001853256e-7);
        const double var_x278 = (1.0 - var_x277) / (1.0 + var_x277);
        const double var_x279 = (10.000000624 + var_chaste_interface__membrane__V) * (var_x276 + 45787.545779060179 * var_x278);
        const double var_x280 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x281 = fabs(var_x280) < 6.2400000011564316e-7;
        const double var_x282 = 1.0 - var_x270;
        const double var_x283 = 1 / var_x282;
        const double var_x284 = 35.0 * var_x271 * var_x283;
        const double var_x285 = 5.6089743589743595 * var_x270 * var_x280;
        const double var_x286 = ((var_x281) ? (1.5575040005772907e-12 * (-36688738598.216812 * var_x275 - 36688738598.216812 * var_x278) / pow((var_x279 - 0.057142857142857141 * var_x275), 2)) : (var_x284 - var_x283 * var_x285 - var_x271 * var_x285 / pow(var_x282, 2)));
        const double var_x287 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x288 = ((var_x281) ? (1 / (-var_x276 + 801282.05113355326 * var_x279)) : (var_x280 * var_x284));
        const double var_x289 = 0.00016025641025641026 * var_x270 * var_x288 / pow(var_x271, 2);
        const double var_x290 = exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_x291 = 19.699999999999999 * var_x290;
        const double var_x292 = 0.001 - 0.001 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x293 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V);
        const double var_x294 = 1.0 + var_x293;
        const double var_x295 = 0.029999999999999999 * var_x293 / pow(var_x294, 2);
        const double var_x296 = exp(4.0 + 0.125 * var_chaste_interface__membrane__V);
        const double var_x297 = 1.0 + var_x296;
        const double var_x298 = 0.125 * var_x296 / pow(var_x297, 2);
        const double var_x299 = 0.019699999999999999 * var_x290;
        const double var_x300 = -0.02 - var_x299;
        const double var_x301 = 1 / var_x297;
        const double var_x302 = 0.59999999999999998 / var_x294;
        const double var_x303 = var_x301 + var_x302;
        const double var_x304 = -0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V;
        const double var_x305 = 1.0 - var_x301 - var_x302;
        const double var_x306 = exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__membrane__V);
        const double var_x307 = 1.0 + var_x306;
        const double var_x308 = exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__membrane__V);
        const double var_x309 = 1.0 + var_x308;
        const double var_x310 = 1 / var_x309;
        const double var_x311 = 1 / (0.0037000000000000002 + 0.0061000000000000004 * var_x310);
        const double var_x312 = exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__membrane__V);
        const double var_x313 = 1.0 + var_x312;
        const double var_x314 = var_chaste_interface__membrane__V <= 0;
        const double var_x315 = ((var_x314) ? (1 / (0.012 - 0.00087500000000000002 * var_chaste_interface__membrane__V)) : (83.333333333333329));
        const double var_x316 = exp(-0.021579999999999998 * var_chaste_interface__membrane__V);
        const double var_x317 = exp(0.00094200000000000002 * var_chaste_interface__membrane__V);
        const double var_x318 = var_x317 * pow(NV_Ith_S(mParameters, 2), (-0.29999999999999999));
        const double var_x319 = 0.00097032784950386709 * var_x318;
        const double var_x320 = 0.055471529999999998 * var_chaste_interface__membrane__V;
        const double var_x321 = exp(-1.9969750799999999 + var_x320);
        const double var_x322 = var_x321 * var_chaste_interface__Kr_channel_states__P_C1;
        const double var_x323 = 0.0036333852149999998 * var_x322;
        const double var_x324 = exp(-0.58799999999999997 - 0.023519999999999999 * var_chaste_interface__membrane__V);
        const double var_x325 = var_x324 / NV_Ith_S(mParameters, 2);
        const double var_x326 = 0.04646376 * var_x325;
        const double var_x327 = 0.0029357000000000003 * var_x316;
        const double var_x328 = 1.0300720270741688 * var_x318;
        const double var_x329 = 0.065500000000000003 * var_x321;
        const double var_x330 = 1.9755 * var_x325;
        const double var_x331 = var_x316 * var_x324 * pow(NV_Ith_S(mParameters, 2), (-0.69999999999999996)) / var_x317;
        const double var_x332 = 0.00025922405137351976 * var_x331;
        const double var_x333 = 0.0056301648793171408 * var_x331;
        const double var_x334 = exp(-0.036588000000000002 * var_chaste_interface__membrane__V);
        const double var_x335 = var_x334 * var_chaste_interface__Kr_channel_states__P_C2;
        const double var_x336 = exp(-0.66565836 + var_x320);
        const double var_x337 = 0.0030786699149999998 * var_x336 * var_chaste_interface__Kr_channel_states__P_C3;
        const double var_x338 = 0.0023570000000000002 * var_x334;
        const double var_x339 = 0.055500000000000001 * var_x336;
        const double var_x340 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V);
        const double var_x341 = 1.0 + var_x340;
        const double var_x342 = 0.001 / var_x341;
        const double var_x343 = 1 / (-1.0 + exp(9.9999999925515227e-8));
        const double var_x344 = 1 / (-1.0 + exp(-9.9999999925515227e-8));
        const double var_x345 = 1 / (1.0 - exp(2.1542940304186685e-7));
        const double var_x346 = 1 / (1.0 - exp(-2.1542940304186685e-7));
        const double var_x347 = 30.0 + var_chaste_interface__membrane__V;
        const double var_x348 = fabs(var_x347) < 1.4556040746072085e-6;
        const double var_x349 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V);
        const double var_x350 = -1.0 + var_x349;
        const double var_x351 = 1 / var_x350;
        const double var_x352 = 0.13100000000000001 * var_x351;
        const double var_x353 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V);
        const double var_x354 = 1.0 - var_x353;
        const double var_x355 = 1 / var_x354;
        const double var_x356 = 0.071899999999999992 * var_x355;
        const double var_x357 = var_x347 * var_x349 / pow(var_x350, 2);
        const double var_x358 = var_x347 * var_x353 / pow(var_x354, 2);
        const double var_x359 = (30.000001455604075 + var_chaste_interface__membrane__V) * (1.9068413377354434e-10 * var_x343 + 1.9068413377354434e-10 * var_x344 + 1.0465793296425829e-10 * var_x345 + 1.0465793296425829e-10 * var_x346);
        const double var_x360 = ((var_x348) ? (343500000.2558552 * var_x359 - 1.9068413377354434e-7 * var_x344 - 1.0465793296425829e-7 * var_x345) : (var_x347 * var_x352 + var_x347 * var_x356));
        const double var_x361 = 5.9880239520958083e-5 * var_x340 / pow(var_x341, 2);
        const double var_x362 = 0.032750000000000001 * var_x351;
        const double var_x363 = 0.017974999999999998 * var_x355;
        const double var_x364 = ((var_x348) ? (85875000.063963801 * var_x359 - 4.7671033443386084e-8 * var_x344 - 2.6164483241064571e-8 * var_x345) : (var_x347 * var_x362 + var_x347 * var_x363));
        const double var_x365 = 0.040000000000000001 * var_chaste_interface__membrane__V;
        const double var_x366 = exp(-1.6000000000000001 + var_x365);
        const double var_x367 = 1.0 + var_x366;
        const double var_x368 = var_x366 / var_x367;
        const double var_x369 = exp(-3.6000000000000001 - var_x365);
        const double var_x370 = 1.0 + var_x369;
        const double var_x371 = var_x369 / var_x370;
        const double var_x372 = 10000.0 * var_x368 + 10000.0 * var_x371;
        const double var_x373 = 1 / var_x372;
        const double var_x374 = 10.0 * var_x368;
        const double var_x375 = 400.0 * var_x368;
        const double var_x376 = 400.0 * pow(var_x369, 2) / pow(var_x370, 2);
        const double var_x377 = pow(var_x366, 2) / pow(var_x367, 2);
        const double var_x378 = 400.0 * var_x377;
        const double var_x379 = 400.0 * var_x371;
        const double var_x380 = 0.40000000000000002 * var_x373;
        const double var_x381 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x382 = exp(12.0 + var_x381);
        const double var_x383 = 1.0 + var_x382;
        const double var_x384 = 1 / var_x383;
        const double var_x385 = exp(5.0 + var_x381);
        const double var_x386 = 1.0 + var_x385;
        const double var_x387 = var_x385 / var_x386;
        const double var_x388 = 15.0 * var_x384 + 100.0 * var_x387;
        const double var_x389 = var_x382 / pow(var_x383, 2);
        const double var_x390 = 3.0 * var_x389;
        const double var_x391 = 20.0 * pow(var_x385, 2) / pow(var_x386, 2);
        const double var_x392 = 20.0 * var_x387;
        const double var_x393 = 1 / var_x388;
        const double var_x394 = 0.014999999999999999 * var_x384;
        const double var_x395 = 0.80000000000000004 + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x396 = pow(var_x395, (-2));
        const double var_x397 = 1 / (1.0 + 8.0 * var_x396);
        const double var_x398 = 0.001 * var_x397;
        const double var_x399 = var_x398 * (-var_chaste_interface__calcium_dynamics__Ca_JSR + var_chaste_interface__calcium_dynamics__Cai);
        const double var_x400 = var_x213 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x401 = var_x187 + var_x212 + 0.0070159999999999997 * var_chaste_interface__membrane__V - 0.10684935482199306 * var_x161 + var_x11 * var_x14 + var_x110 * var_x177 + var_x14 * var_x3 + var_x14 * var_x5 + var_x14 * var_x74 + var_x14 * var_x89 + var_x162 * var_x6 + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 0.433 * var_x142 * (1.0 + 0.59999999999999998 * var_x18);
        const double var_x402 = var_x401 + var_x153 * var_x400;
        const double var_x403 = var_x119;
        const double var_x404 = -0.5 + var_x173;
        const double var_x405 = var_x45 * (var_x123 - var_x124 * var_x404) + var_x45 * (var_x132 - var_x133 * var_x404);
        const double var_x406 = (var_chaste_interface__calcium_dynamics__APtrack > 0.17999999999999999) && (var_chaste_interface__calcium_dynamics__APtrack < 0.20000000000000001);
        const double var_x407 = var_x100 + var_x188 - var_x102 - var_x113;
        const double var_x408 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
        const double var_x409 = (var_x408) && (var_x59);
        const double var_x410 = var_x121 + var_x139 + var_x158;
        const double var_x411 = var_x61 * var_x63 * var_chaste_interface__membrane__V;
        const double var_x412 = var_x152 * var_x209;
        const double var_x413 = 0.70463905573898955 * var_x192 * var_x411;
        const double var_x414 = (var_x408) && (((var_x408) || (var_x59)));
        const double var_x415 = var_chaste_interface__calcium_dynamics__APtrack2 > 0.01;
        const double var_x416 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x120 * (0.0070159999999999997 + var_x102 + var_x11 + var_x113 + var_x21 + var_x3 + var_x5 + var_x6 + var_x70 + var_x74 + var_x89 + var_x9 - var_x100 + var_x117 * (243.26999999999998 * var_x114 - 514.29999999999995 * var_x116 - var_x115 * (0.061749999999999999 * var_x82 + 0.039456396800000001 * var_x81)) + var_x45 * ((var_x32) ? (var_x22 * var_x27 + var_x22 * var_x30) : (var_x38 + 6.8454343811362063e-5 * var_x40 * var_chaste_interface__ionic_concentrations__Nai - 9.1272458415149417e-5 * var_x35 * var_x41)) + var_x45 * ((var_x32) ? (var_x46 * var_x49 + var_x46 * var_x50) : (var_x52 + 1.9572871637915374e-5 * var_x40 * var_chaste_interface__ionic_concentrations__Ki - 2.6097162183887167e-5 * var_x41 * var_x51)) + 0.011000000000000001 * var_x14 * var_x73 - 104.68673984798647 * var_x114 * var_x118 + 0.00092307692307692295 * var_x0 * var_x14 / pow(var_x1, 2) + var_x103 * var_x110 * (0.00046607674967214262 * var_x104 + 0.037435883507802616 * var_x106 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x105)) * NV_Ith_S(mParameters, 2) / pow(var_x107, 2)));
        IJth(rJacobian, 1, 0) = -var_x194 * (var_x188 + var_x70 + 0.063641001963264457 * var_x187 - 2.0 * var_x102 - 0.074871767015605231 * var_x112);
        IJth(rJacobian, 2, 0) = var_x228 * var_chaste_interface__Na_channel_states__P_C1 + var_x236 * var_chaste_interface__Na_channel_states__P_IF + (-var_x224 + 0.01083743842364532 * var_x222) * var_chaste_interface__Na_channel_states__P_O_Na - 0.0028227905226106183 * var_x234 * var_chaste_interface__Na_channel_states__P_IF - 1.7053993755772005e-5 * var_x235 * var_chaste_interface__Na_channel_states__P_IF;
        IJth(rJacobian, 3, 0) = var_x245 * var_chaste_interface__Na_channel_states__P_C2 + (-2.0000000000000002e-5 + var_x242 - var_x228) * var_chaste_interface__Na_channel_states__P_C1 - var_x243 * var_chaste_interface__Na_channel_states__P_IF - 0.01083743842364532 * var_x222 * var_chaste_interface__Na_channel_states__P_O_Na;
        IJth(rJacobian, 4, 0) = var_x256 * var_chaste_interface__Na_channel_states__P_C3 + (-2.0000000000000002e-5 + var_x254) * var_chaste_interface__Na_channel_states__P_C2 - var_x242 * var_chaste_interface__Na_channel_states__P_C1 - var_x243 * var_chaste_interface__Na_channel_states__P_IC2;
        IJth(rJacobian, 5, 0) = (-2.0000000000000002e-5 + var_x260) * var_chaste_interface__Na_channel_states__P_C3 - var_x243 * var_chaste_interface__Na_channel_states__P_IC3 - var_x253 * var_chaste_interface__Na_channel_states__P_C2;
        IJth(rJacobian, 6, 0) = 2.0000000000000002e-5 * var_chaste_interface__Na_channel_states__P_C1 + var_x224 * var_chaste_interface__Na_channel_states__P_O_Na + var_x245 * var_chaste_interface__Na_channel_states__P_IC2 + (var_x242 + var_x243 - var_x236 - var_x262 + 0.0028227905226106183 * var_x234 + 1.7053993755772005e-5 * var_x235) * var_chaste_interface__Na_channel_states__P_IF - var_x243 * var_chaste_interface__Na_channel_states__P_IM1;
        IJth(rJacobian, 7, 0) = 2.0000000000000002e-5 * var_chaste_interface__Na_channel_states__P_C3 + (var_x243 + var_x260) * var_chaste_interface__Na_channel_states__P_IC3 - var_x253 * var_chaste_interface__Na_channel_states__P_IC2;
        IJth(rJacobian, 8, 0) = 2.0000000000000002e-5 * var_chaste_interface__Na_channel_states__P_C2 + var_x256 * var_chaste_interface__Na_channel_states__P_IC3 + (var_x243 + var_x254) * var_chaste_interface__Na_channel_states__P_IC2 - var_x242 * var_chaste_interface__Na_channel_states__P_IF;
        IJth(rJacobian, 9, 0) = -var_x267 + var_x262 * var_chaste_interface__Na_channel_states__P_IF + (var_x243 - var_x266) * var_chaste_interface__Na_channel_states__P_IM1;
        IJth(rJacobian, 10, 0) = var_x267 + var_x266 * var_chaste_interface__Na_channel_states__P_IM1;
        IJth(rJacobian, 11, 0) = var_x287 * var_x289 + var_x289 * var_chaste_interface__L_type_Ca_channel_d_gate__d + var_x272 * var_x286 * var_x287 + var_x273 * var_x286 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        IJth(rJacobian, 12, 0) = var_x292 * (20.0 + var_x291) * (var_x295 - var_x298) + var_x300 * (var_x298 - var_x295) * var_chaste_interface__L_type_Ca_channel_f_gate__f + var_x291 * var_x292 * var_x303 * var_x304 - var_x299 * var_x304 * var_x305 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 13, 0) = 9.2592592592592588e-5 * var_x306 * var_x311 / pow(var_x307, 2) + 0.036429872495446262 * var_x308 * (-var_chaste_interface__T_type_Ca_channel_b_gate__b + 1 / var_x307) / (pow(var_x309, 2) * pow((0.60655737704918034 + var_x310), 2));
        IJth(rJacobian, 14, 0) = (0.001 / var_x313 - 0.001 * var_chaste_interface__T_type_Ca_channel_g_gate__g) * ((var_x314) ? (6.0763888888888884 / pow((1 - 0.072916666666666671 * var_chaste_interface__membrane__V), 2)) : (0)) - 0.00017857142857142857 * var_x312 * var_x315 / pow(var_x313, 2);
        IJth(rJacobian, 15, 0) = var_x323 + (-var_x319 + 6.3352406000000003e-5 * var_x316) * var_chaste_interface__Kr_channel_states__P_O - var_x326 * var_chaste_interface__Kr_channel_states__P_I;
        IJth(rJacobian, 16, 0) = -0.0072667704299999997 * var_x322 - var_x332 * var_chaste_interface__Kr_channel_states__P_I - 6.3352406000000003e-5 * var_x316 * var_chaste_interface__Kr_channel_states__P_O;
        IJth(rJacobian, 17, 0) = var_x337 + 8.6237916000000007e-5 * var_x335;
        IJth(rJacobian, 18, 0) = -var_x337 - 8.6237916000000007e-5 * var_x335;
        IJth(rJacobian, 19, 0) = var_x323 + var_x319 * var_chaste_interface__Kr_channel_states__P_O + (var_x326 + var_x332) * var_chaste_interface__Kr_channel_states__P_I;
        IJth(rJacobian, 20, 0) = var_x360 * var_x361 + (var_x342 - var_x171) * ((var_x348) ? (0.065500000000000003 * var_x343 + 0.065500000000000003 * var_x344 + 0.035949999999999996 * var_x345 + 0.035949999999999996 * var_x346) : (var_x352 + var_x356 - 0.0089997000000000011 * var_x357 - 0.0106412 * var_x358));
        IJth(rJacobian, 21, 0) = var_x361 * var_x364 + (var_x342 - var_x169) * ((var_x348) ? (0.016375000000000001 * var_x343 + 0.016375000000000001 * var_x344 + 0.008987499999999999 * var_x345 + 0.008987499999999999 * var_x346) : (var_x362 + var_x363 - 0.0022499250000000003 * var_x357 - 0.0026603 * var_x358));
        IJth(rJacobian, 22, 0) = var_x372 * (var_x368 * var_x380 - var_x377 * var_x380 + 9.9999999999999995e-8 * var_x368 * (var_x378 + var_x379 - var_x375 - var_x376) / pow((var_x368 + var_x371), 2)) + (-0.001 * var_chaste_interface__transient_outward_current_zdv_gate__zdv + var_x373 * var_x374) * (var_x375 + var_x376 - var_x378 - var_x379);
        IJth(rJacobian, 23, 0) = var_x388 * (-0.0030000000000000001 * var_x389 * var_x393 + 1.5e-6 * var_x384 * (var_x390 + var_x391 - var_x392) / pow((var_x387 + 0.14999999999999999 * var_x384), 2)) + (-0.001 * var_chaste_interface__transient_outward_current_ydv_gate__ydv + var_x393 * var_x394) * (var_x392 - var_x390 - var_x391);
        IJth(rJacobian, 29, 0) = 0.001 * ((var_x409) ? (-var_x209 * (var_x407 + var_x45 * var_x58)) : ((var_x408) ? (-var_x209 * (var_x407 + var_x400 * var_x65 + var_x400 * var_x68 - var_x400 * var_x69)) : (0)));
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x120 * (var_x159 - var_x121 - var_x139 - var_x128 * var_x130 - var_x135 * var_x136 + 2.3575679435995052e-7 * var_x142 * var_x15 * var_x16 / pow(var_x17, 2)));
        IJth(rJacobian, 1, 1) = var_x210 * (-var_x197 - var_x207 + 0.71029411764705874 * var_x208 - var_x209 * (var_x159 + 2.0 * var_x121 + 0.00020000000000000001 * var_x138)) + 0.001 * (0.00023800000000000004 / pow(var_x189, 3) + 7.0000000000000007e-5 / pow(var_x155, 3)) * (0.047352941176470584 * var_chaste_interface__calcium_dynamics__Ca_NSR + var_x207 * var_x211 - var_x197 * var_chaste_interface__calcium_dynamics__Cai - var_x209 * (var_x212 + 0.003016 * var_chaste_interface__membrane__V - 2.0 * var_x187 + var_x163 * var_chaste_interface__L_type_Ca_channel_d_gate__d)) / pow(var_x190, 2);
        IJth(rJacobian, 24, 1) = var_x206 * var_x398;
        IJth(rJacobian, 25, 1) = 0.0087500000000000008 * var_x196 - 0.0087500000000000008 * var_x208;
        IJth(rJacobian, 29, 1) = 0.001 * ((var_x409) ? (-var_x209 * (var_x410 + var_x147 * var_x45 - var_x136 * var_x152)) : ((var_x408) ? (-var_x209 * (var_x410 + var_x148 * var_x400 - 0.0046811535814444347 * var_x129 * var_x411 * var_chaste_interface__L_type_Ca_channel_f_gate__f)) : (0)));
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x120 * var_x162 * NV_Ith_S(mParameters, 6));
        IJth(rJacobian, 2, 2) = -var_x237 - var_x238;
        IJth(rJacobian, 3, 2) = var_x238;
        IJth(rJacobian, 6, 2) = var_x237;
        IJth(rJacobian, 2, 3) = var_x239;
        IJth(rJacobian, 3, 3) = var_x247 + var_x249 - var_x239;
        IJth(rJacobian, 4, 3) = var_x246;
        IJth(rJacobian, 6, 3) = var_x263;
        IJth(rJacobian, 3, 4) = var_x250;
        IJth(rJacobian, 4, 4) = var_x249 + var_x258;
        IJth(rJacobian, 5, 4) = var_x257;
        IJth(rJacobian, 8, 4) = var_x263;
        IJth(rJacobian, 4, 5) = var_x259;
        IJth(rJacobian, 5, 5) = var_x249 + var_x261;
        IJth(rJacobian, 7, 5) = var_x263;
        IJth(rJacobian, 2, 6) = var_x240;
        IJth(rJacobian, 3, 6) = var_x251;
        IJth(rJacobian, 6, 6) = var_x247 + var_x265 - var_x240 - var_x264;
        IJth(rJacobian, 8, 6) = var_x246;
        IJth(rJacobian, 9, 6) = var_x264;
        IJth(rJacobian, 5, 7) = var_x251;
        IJth(rJacobian, 7, 7) = var_x261 + var_x265;
        IJth(rJacobian, 8, 7) = var_x259;
        IJth(rJacobian, 4, 8) = var_x251;
        IJth(rJacobian, 6, 8) = var_x250;
        IJth(rJacobian, 7, 8) = var_x257;
        IJth(rJacobian, 8, 8) = var_x258 + var_x265;
        IJth(rJacobian, 6, 9) = var_x251;
        IJth(rJacobian, 9, 9) = var_x265 - var_x268;
        IJth(rJacobian, 10, 9) = var_x268;
        IJth(rJacobian, 9, 10) = var_x269;
        IJth(rJacobian, 10, 10) = -var_x269;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x120 * (var_x163 + var_x128 * var_x43 + var_x135 * var_x44));
        IJth(rJacobian, 1, 11) = -var_x213 * var_x214;
        IJth(rJacobian, 11, 11) = var_x273 * var_x288 - var_x272 * var_x288;
        IJth(rJacobian, 29, 11) = 0.001 * ((var_x409) ? (-var_x213 * var_x412) : ((var_x408) ? (-var_x213 * var_x413) : (0)));
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x120 * (var_x127 * var_x164 + var_x135 * var_x164 + var_x154 * var_x164));
        IJth(rJacobian, 1, 12) = -var_x214 * var_x215;
        IJth(rJacobian, 12, 12) = var_x300 * var_x303 + var_x300 * var_x305;
        IJth(rJacobian, 29, 12) = 0.001 * ((var_x409) ? (-var_x215 * var_x412) : ((var_x408) ? (-var_x215 * var_x413) : (0)));
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0001 * var_x119 * var_x167);
        IJth(rJacobian, 1, 13) = -9.0316078310111336e-6 * var_x167 * var_x193;
        IJth(rJacobian, 13, 13) = -0.001 * var_x311;
        IJth(rJacobian, 29, 13) = 0.001 * ((var_x414) ? (-0.0090316078310111337 * var_x167 * var_x192) : (0));
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-5.0000000000000002e-5 * var_x119 * var_x168);
        IJth(rJacobian, 1, 14) = -4.5158039155055668e-6 * var_x168 * var_x193;
        IJth(rJacobian, 14, 14) = -0.001 * var_x315;
        IJth(rJacobian, 29, 14) = 0.001 * ((var_x414) ? (-0.0045158039155055668 * var_x168 * var_x192) : (0));
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x10 * var_x120 * var_x14);
        IJth(rJacobian, 15, 15) = -var_x327 - var_x328;
        IJth(rJacobian, 16, 15) = var_x327;
        IJth(rJacobian, 19, 15) = var_x328;
        IJth(rJacobian, 15, 16) = var_x329;
        IJth(rJacobian, 16, 16) = -1.077 - 0.13100000000000001 * var_x321;
        IJth(rJacobian, 17, 16) = 1.077;
        IJth(rJacobian, 19, 16) = var_x329;
        IJth(rJacobian, 16, 17) = 2.1720000000000002;
        IJth(rJacobian, 17, 17) = -2.1720000000000002 - var_x338;
        IJth(rJacobian, 18, 17) = var_x338;
        IJth(rJacobian, 17, 18) = var_x339;
        IJth(rJacobian, 18, 18) = -var_x339;
        IJth(rJacobian, 15, 19) = var_x330;
        IJth(rJacobian, 16, 19) = var_x333;
        IJth(rJacobian, 19, 19) = -var_x330 - var_x333;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x169 * var_x170);
        IJth(rJacobian, 20, 20) = -0.001 * var_x360;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x170 * var_x171);
        IJth(rJacobian, 21, 21) = -0.001 * var_x364;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0033000000000000004 * var_x172 * var_x71 * pow(var_chaste_interface__transient_outward_current_zdv_gate__zdv, 2) * NV_Ith_S(mParameters, 11) * var_chaste_interface__transient_outward_current_ydv_gate__ydv);
        IJth(rJacobian, 22, 22) = -var_x374 - 10.0 * var_x371;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0011000000000000001 * var_x172 * var_x72);
        IJth(rJacobian, 23, 23) = -var_x394 - 0.10000000000000001 * var_x387;
        IJth(rJacobian, 1, 24) = 7.0588235294117632e-6 * var_x191 * var_x206;
        IJth(rJacobian, 24, 24) = var_x398 * (-5.5555555555555554 - var_x206) + 0.00025000000000000001 * (5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR - var_x206 * var_x211) / (pow(var_x395, 3) * pow((0.125 + var_x396), 2));
        IJth(rJacobian, 25, 24) = 0.00048309178743961351;
        IJth(rJacobian, 1, 25) = 4.7352941176470584e-5 * var_x191;
        IJth(rJacobian, 24, 25) = 0.0055555555555555558 * var_x397;
        IJth(rJacobian, 25, 25) = -0.001066425120772947;
        IJth(rJacobian, 26, 26) = 0.001 * (((((var_x59) || (var_x31 >= 2.6712338705498262e-6) || (var_x403 * (var_x402 + var_x405) < -150000.0))) && (((var_x32) || (var_x59) || (var_x403 * (var_x402 + var_x126 * var_x400 + var_x134 * var_x400) < -150000.0))) && (((var_x31 >= 1.3356169352749131e-6) || (var_x403 * (var_x401 + var_x405 + var_x45 * (var_x149 + var_x151 * (var_x149 + var_x150))) < -150000.0)))) ? (-100500.0) : (-500.0));
        IJth(rJacobian, 1, 27) = var_x216 * var_x217;
        IJth(rJacobian, 24, 27) = var_x216 * var_x399;
        IJth(rJacobian, 27, 27) = 0.001 * ((var_x406) ? (-100500.0) : (-500.0));
        IJth(rJacobian, 28, 28) = 0.001 * ((var_x406) ? (-100500.0) : (-10.0));
        IJth(rJacobian, 1, 29) = var_x217 * var_x219;
        IJth(rJacobian, 24, 29) = var_x219 * var_x399;
        IJth(rJacobian, 29, 29) = 0.001 * (((((var_x408) || (var_x415))) && (((var_x408) || (var_x415) || (var_x59)))) ? (0) : (-500.0));
        ...
        IJth(rJacobian, 1, 31) = var_x217 * var_x220;
        IJth(rJacobian, 24, 31) = var_x220 * var_x399;
        IJth(rJacobian, 31, 31) = 0.001 * (((var_x416) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50000.0) : (-500.0));
        IJth(rJacobian, 32, 32) = 0.001 * (((var_x416) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50000.0) : (-10.0));
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x120 * (var_x181 - var_x183 + 0.10684935482199306 * var_x160 + 0.48963716847178318 * var_x178 + var_x45 * ((var_x32) ? (var_x176 + var_x174 * (-var_x176 - var_x146 * var_x175)) : (0.0018285756177517324 * var_x40)) + 26.712338705498265 * var_x160 * var_x6 + 0.044999999999999998 * var_x177 / (var_x92 * pow((0.01 + var_x109), 2))));
        IJth(rJacobian, 1, 33) = -var_x194 * (0.00060000000000000006 * var_x182 - 6.0 * var_x180);
        IJth(rJacobian, 29, 33) = 0.001 * ((var_x414) ? (-var_x209 * (var_x183 - var_x181)) : (0));
