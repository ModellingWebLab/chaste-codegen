...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhund_rudy_2004_aFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x36 = NV_Ith_S(mParameters, 2) / var_x35;
        ...
        const double var_x77 = var_x76 * NV_Ith_S(mParameters, 1) * var_chaste_interface__INa__J;
        ...
        const double var_x88 = var_x34 * var_x53 * NV_Ith_S(mParameters, 2) * var_chaste_interface__IKr__xr / pow(var_x35, 2);
        ...
        const double var_x101 = var_x100 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x107 = var_x96 * var_x98 * NV_Ith_S(mParameters, 0) / var_x106;
        ...
        const double var_x123 = -26.712338705500134 * var_x12 * log10(7.9662000000000006 * var_x122) + var_chaste_interface__cell__V;
        const double var_x124 = var_x123 * var_chaste_interface__IKs__xs1;
        const double var_x125 = var_x124 * var_x27 * var_x28 * var_chaste_interface__IKs__xs2 / pow(var_x29, 2);
        const double var_x126 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x127 = var_x12 * log10(140.0 * var_x126);
        const double var_x128 = -26.712338705500134 * var_x127 + var_chaste_interface__cell__V;
        const double var_x129 = var_x128 * NV_Ith_S(mParameters, 1) * var_chaste_interface__INa__H;
        const double var_x130 = var_x129 * pow(var_chaste_interface__INa__m, 2) * var_chaste_interface__INa__J;
        const double var_x131 = var_x129 * var_x76;
        const double var_x132 = var_x105 * var_x108;
        const double var_x133 = var_chaste_interface__ICaL__dp / var_chaste_interface__ICaL__d;
        const double var_x134 = log(var_chaste_interface__ICaL__d);
        const double var_x135 = var_x102 * var_x108 * var_x95 * var_chaste_interface__ICaL__f2;
        const double var_x136 = var_x104 * var_x135;
        const double var_x137 = var_x103 * var_x108;
        const double var_x138 = var_x104 * var_x109;
        const double var_x139 = var_x80 * var_x90;
        const double var_x140 = var_x139 * pow(var_chaste_interface__Ito__ydv, 2) * var_chaste_interface__Ito__zdv;
        const double var_x141 = var_x139 * var_x79;
        const double var_x142 = var_x128 * pow(var_chaste_interface__INal__mL, 2) * var_chaste_interface__INal__hL;
        ...
        const double var_x145 = var_x122 * var_x33;
        ...
        const double var_x239 = var_x103 * var_chaste_interface__ICaL__fca;
        const double var_x240 = 5.2572936047118706 * var_x111;
        ...
        const double var_x249 = var_x133 * var_x244;
        const double var_x250 = var_x134 * var_x244;
        ...
        const double var_x255 = var_x102 * var_x110;
        ...
        const double var_x326 = pow(var_x98, (-2));
        ...
        const double var_x333 = var_x106 * var_x326 * var_x327 * var_x328 * var_x329 * var_x330 * var_x331 * var_x332;
        ...
        const double var_x337 = var_x106 * var_x327 * var_x328 * var_x330 * var_x332 * var_x334;
        const double var_x338 = var_x331 * var_x337 / pow(var_x98, 3);
        ...
        const double var_x349 = var_x106 * var_x347;
        ...
        const double var_x366 = 17.524312015706236 * var_x111;
        const double var_x367 = var_x354 / pow(var_x355, 2);
        const double var_x368 = var_x367 * (234.05767907220539 * var_x239 + var_x113 * var_x366 - var_x107 * var_x366);
        ...
        const double var_x380 = 0.00050754612877954204 * var_x77;
        ...
        const double var_x391 = 8.5232067604091287e-7 * var_x36;
        const double var_x392 = 1.1688941147650058e-5 * var_x81;
        ...
        const double var_x400 = 8.8885199344722979e-8 * var_x43;
        ...
        const double var_x406 = 0.052572936047118712 * var_x108;
        ...
        const double var_x412 = var_x411 * (var_x405 + var_x113 * var_x406 - var_x107 * var_x406);
        ...
        const double var_x427 = 0.0002749177168957104 * var_x111;
        ...
        IJth(rJacobian, 8, 0) = 6.0846129416049119e-5 * var_x247 * (70.217303721661608 * var_x239 + var_x113 * var_x240 - var_x107 * var_x240);
        IJth(rJacobian, 9, 0) = 0.0033333333333333335 * var_x269 * (-87.77162965207701 * var_x239 + var_x107 * var_x268 - var_x113 * var_x268) + var_x264 * var_x267 * (351.08651860830804 * var_x239 + var_x113 * var_x265 - var_x107 * var_x265);
        ...
        IJth(rJacobian, 21, 0) = 0.33333333333333331 * var_x346 * (4.8075954106507941e-5 * var_x333 / pow(var_x325, 3) + var_x336 * var_x338 * var_x97 - var_x335 * var_x336 * var_x96 * var_x99);
        IJth(rJacobian, 22, 0) = 80.0 * var_x365 * var_x368 - 0.14999999999999999 * var_x368 * var_x371;
        IJth(rJacobian, 23, 0) = -8.9372253111180233e-5 * var_x51 - 5.456580259819789e-6 * var_x94 - 0.00083053002891197785 * var_x75 - var_x379 * var_chaste_interface__INal__hL - var_x380 * var_chaste_interface__INa__H;
        IJth(rJacobian, 24, 0) = var_x390 + 5.5345498444215123e-8 * var_x88 + 5.9581502074120151e-5 * var_x51 + 7.4830755604969202e-6 * var_x62 - 1.6979725035533768e-7 * var_x2 - 3.137557887000805e-5 * var_x26 - 3.8963137158833531e-8 * var_x91 - 2.8394189022631718e-8 * var_x54 - var_x391 * var_chaste_interface__IKr__xr - var_x392 * var_chaste_interface__Ito__ydv2 - var_x393 * var_x85;
        IJth(rJacobian, 25, 0) = 1.3842167148532964e-8 + 3.3274959682366304e-9 * var_x89 - 3.3274959682366302e-7 * var_x59 + var_x400 * var_chaste_interface__Ito2__AA;
        IJth(rJacobian, 26, 0) = var_x404 * var_x412;
        IJth(rJacobian, 28, 0) = var_x426 * (-719.99999999999989 * var_x412 - 0.0036718475849305066 * var_x239 + var_x107 * var_x427 - var_x113 * var_x427);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (18522000.0 * var_x119 + 0.057500000000000002 * var_x117 + 6.9055124202402519e-7 * var_x120 - 0.057500000000000002 * var_x115 - 1.3556015675697155e-8 * var_x125 - 0.0028824983370005666 * var_x118 - 6.2499999999999997e-8 * var_x121);
        IJth(rJacobian, 1, 1) = var_x161 * (-0.14705882352941174 + var_x180 - var_x163 - var_x177 + 3.8450464301480458e-12 * var_x121 + 1.768721357868101e-6 * var_x117 - 4.2483225407660435e-11 * var_x120 - 1139.4871996672337 * var_x119 - 8.8666719524733664e-8 * var_x118) + (0.00023800000000000004 / pow(var_x159, 3) + 7.0000000000000007e-5 / pow(var_x114, 3)) * (0.14705882352941174 * var_chaste_interface__Ca__Ca_ss + 2.3676470588235295e-5 * var_chaste_interface__Ca__Ca_nsr - 0.14705882352941174 * var_chaste_interface__Ca__Ca_i - var_x162 * var_chaste_interface__cell__V - var_x163 * var_chaste_interface__Ca__Ca_i - var_x177 * var_chaste_interface__Ca__Ca_i + 0.00027684334297065928 * var_x74 * var_x92) / pow(var_x160, 2);
        IJth(rJacobian, 23, 1) = 1.274496762229813e-10 * var_x120 + 3418.461599001701 * var_x119 - 1.1535139290444137e-11 * var_x121;
        IJth(rJacobian, 24, 1) = -8.3397615489392458e-13 * var_x125;
        IJth(rJacobian, 27, 1) = -var_x421 + 0.0043750000000000004 * var_x176;
        IJth(rJacobian, 28, 1) = 5.0 * var_x426;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x128 * var_x78);
        ...
        IJth(rJacobian, 23, 2) = -var_x128 * var_x380;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-24.75 * var_x130);
        IJth(rJacobian, 3, 3) = var_x209;
        IJth(rJacobian, 23, 3) = -0.001522638386338626 * var_x130;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-8.25 * var_x131);
        IJth(rJacobian, 4, 4) = -((var_x194) ? (0) : (var_x216 * var_x217)) - ((var_x194) ? (0.29999999999999999 * var_x221) : (0.1212 * var_x225));
        IJth(rJacobian, 23, 4) = -0.00050754612877954204 * var_x131;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x132 * var_x133);
        IJth(rJacobian, 5, 5) = -var_x232;
        IJth(rJacobian, 8, 5) = var_x248 * var_x249;
        IJth(rJacobian, 9, 5) = var_x249 * var_x270 - var_x249 * var_x271;
        IJth(rJacobian, 21, 5) = var_x133 * var_x348;
        IJth(rJacobian, 22, 5) = var_x249 * var_x373 - var_x249 * var_x375;
        IJth(rJacobian, 28, 5) = -var_x249 * var_x428;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x132 * var_x134);
        ...
        IJth(rJacobian, 21, 6) = var_x134 * var_x348;
        IJth(rJacobian, 22, 6) = var_x250 * var_x373 - var_x250 * var_x375;
        IJth(rJacobian, 28, 6) = -var_x250 * var_x428;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x136 * var_chaste_interface__ICaL__fca2);
        ...
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-3.5108651860830804 * var_x137);
        IJth(rJacobian, 8, 8) = var_x243 * (-1 + var_x137 * var_x253);
        IJth(rJacobian, 9, 8) = var_x137 * var_x270 - var_x137 * var_x271;
        IJth(rJacobian, 21, 8) = var_x337 * var_x347 * var_x350 / pow(var_chaste_interface__ICaL__fca, 3);
        IJth(rJacobian, 22, 8) = var_x137 * var_x373 - var_x137 * var_x375;
        IJth(rJacobian, 28, 8) = -var_x137 * var_x428;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x136 * var_chaste_interface__ICaL__f);
        IJth(rJacobian, 8, 9) = var_x248 * var_x254;
        IJth(rJacobian, 9, 9) = var_x264 * (-1 + 351.08651860830804 * var_x100 * var_x108 * var_x267 * var_x95 * var_x98 * NV_Ith_S(mParameters, 0) * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca) - var_x254 * var_x271;
        ...
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x102 * var_x138);
        ...
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x37 * var_x53);
        IJth(rJacobian, 11, 11) = -var_x283 - var_x284;
        IJth(rJacobian, 24, 11) = -var_x391 * var_x53;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x123 * var_x32);
        IJth(rJacobian, 12, 12) = -var_x299 - var_x300;
        IJth(rJacobian, 24, 12) = var_x123 * var_x389;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x124 * var_x31);
        IJth(rJacobian, 13, 13) = -3.8050000000000003e-5 * var_x290 * var_x297 - 0.00018000000000000001 * var_x294 * var_x296;
        IJth(rJacobian, 24, 13) = var_x124 * var_x388;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-0.57000000000000006 * var_x140);
        IJth(rJacobian, 14, 14) = -25.0 * var_x305 - 25.0 * var_x309;
        IJth(rJacobian, 24, 14) = -3.5066823442950178e-5 * var_x140;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x53 * var_x82);
        IJth(rJacobian, 15, 15) = -0.029999999999999999 * var_x320 - 0.20000000000000001 * var_x316;
        IJth(rJacobian, 24, 15) = -var_x392 * var_x53;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-0.19 * var_x141);
        IJth(rJacobian, 16, 16) = -0.10000000000000001 * var_x316 - 0.0022499999999999998 * var_x320;
        IJth(rJacobian, 24, 16) = -1.1688941147650058e-5 * var_x141;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x44 * var_chaste_interface__cell__V);
        IJth(rJacobian, 17, 17) = -1.0;
        IJth(rJacobian, 25, 17) = var_x400 * var_chaste_interface__cell__V;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0195 * var_x142);
        IJth(rJacobian, 18, 18) = var_x209;
        IJth(rJacobian, 23, 18) = -1.1996544862061903e-6 * var_x142;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x128 * var_x4);
        IJth(rJacobian, 19, 19) = -0.0016666666666666668;
        IJth(rJacobian, 23, 19) = -var_x128 * var_x379;
        ...
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (2.6731217821876006e-12 * var_x146 + 0.48963716847181737 * var_x145 - 24.300000000000001 * var_x147 - 220.37679432037609 * var_x148 - 0.0096847826086956523 * var_x143 - 0.17363020158575085 * var_x144);
        IJth(rJacobian, 1, 23) = var_x161 * (0.0014949540520415602 * var_x147 - 1.6445243785522266e-16 * var_x146);
        IJth(rJacobian, 23, 23) = var_x386 + 4.9335731356566794e-16 * var_x146 - 1.7874450622236046e-6 * var_x143 - 1.068185898837083e-5 * var_x144 - 0.013557744100624516 * var_x148 - 0.0044848621561246801 * var_x147;
        IJth(rJacobian, 24, 23) = 0.48963716847181737 * var_x394 + 1.191630041482403e-6 * var_x143;
        IJth(rJacobian, 25, 23) = var_x386;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (3.2491553184435085 * var_x154 + 26.712338705500134 * var_x145 - 0.37007808289373995 * var_x151 - 0.073726054827180365 * var_x149 - 5.0753443540450256 * var_x155 - 13.623292739805068 * var_x150 - var_x153 * var_x87);
        IJth(rJacobian, 24, 24) = var_x398 + 0.00019989044893084398 * var_x154 + 26.712338705500134 * var_x394 - 4.535681662754383e-6 * var_x149 - 0.00031223895504468581 * var_x155 - 2.2767478584105716e-5 * var_x151 - 0.0008381150898567882 * var_x150 - var_x153 * var_x393;
        IJth(rJacobian, 25, 24) = var_x398;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (0.00601027620873753 * var_x156 - 0.001444800488100033 * var_x58);
        IJth(rJacobian, 23, 25) = var_x387;
        IJth(rJacobian, 24, 25) = var_x399;
        IJth(rJacobian, 25, 25) = var_x387 + var_x399 + 8.8885199344722979e-8 * var_x58 - 3.6975665728975948e-7 * var_x156;
        ...
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x138 * var_x158);
        ...
        IJth(rJacobian, 21, 28) = var_x329 * var_x338 * var_x347 * var_x96 - 0.00020267697647483301 * var_x165 * var_x339 * var_x340 * var_x342 * var_x353 * (1.8999999999999999 * var_x341 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x340, 2));
