...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellzhang_SAN_model_2000_0D_capableFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_reversal_and_equilibrium_potentials__E_Ca = 0.5 * var_membrane__R * var_membrane__T * log(10) * log10(var_ionic_concentrations__Ca_o / NV_Ith_S(mParameters, 0)) / var_membrane__F; // millivolt
        ...
        const double var_reversal_and_equilibrium_potentials__E_K = var_membrane__R * var_membrane__T * log(10) * log10(var_ionic_concentrations__K_o / var_ionic_concentrations__K_i) / var_membrane__F; // millivolt
        ...
        const double var_reversal_and_equilibrium_potentials__E_K_s = var_membrane__R * var_membrane__T * log(10) * log10((0.029999999999999999 * var_ionic_concentrations__Na_o + var_ionic_concentrations__K_o) / (0.029999999999999999 * var_ionic_concentrations__Na_i + var_ionic_concentrations__K_i)) / var_membrane__F; // millivolt
        const double var_reversal_and_equilibrium_potentials__E_Na = var_membrane__R * var_membrane__T * log(10) * log10(var_ionic_concentrations__Na_o / var_ionic_concentrations__Na_i) / var_membrane__F; // millivolt
    ...
    void Cellzhang_SAN_model_2000_0D_capableFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x5 = 0.018714999999999999 * var_chaste_interface__membrane__V;
        const double var_x6 = 13.441615999999998 - 0.28969 * var_chaste_interface__membrane__V;
        const double var_x7 = 9.6256349999999991 - 0.21390299999999998 * var_chaste_interface__membrane__V;
        const double var_x8 = log(10);
        const double var_x9 = -0.24524999999999997 * var_chaste_interface__membrane__V - 9.2272293212367593 * var_x8;
        const double var_x10 = exp(-5.5531135531135529 - 0.18315018315018314 * var_chaste_interface__membrane__V);
        const double var_x11 = 1 / (1.0 + var_x10);
        const double var_x12 = pow(var_x11, 0.33333333333333331);
        ...
        const double var_x21 = exp(10.328124999999998 + 0.15625 * var_chaste_interface__membrane__V);
        ...
        const double var_x25 = 0.00015625 * var_x21 / pow(var_x22, 2);
        ...
        const double var_x31 = exp(-3.7166666666666668 + var_x0);
        ...
        const double var_x36 = 5.7149999999999999 * var_x35;
        ...
        const double var_x40 = 14.195 * var_x39;
        ...
        const double var_x44 = 42.450000000000003 * var_x43;
        const double var_x45 = 35.0 + var_chaste_interface__membrane__V;
        const double var_x46 = -5.0 + var_chaste_interface__membrane__V;
        const double var_x47 = exp(9.0 + 0.20000000000000001 * var_chaste_interface__membrane__V);
        ...
        const double var_x53 = 3.125 * var_x52;
        ...
        const double var_x58 = exp(-5.4411764705882355 - 0.14705882352941177 * var_chaste_interface__membrane__V);
        ...
        const double var_x64 = exp(7.8888888888888893 + var_x63);
        ...
        const double var_x68 = exp(4.5320610687022898 + 0.076335877862595422 * var_chaste_interface__membrane__V);
        ...
        const double var_x74 = exp(0.5548223350253807 - 0.050761421319796954 * var_chaste_interface__membrane__V);
        ...
        const double var_x80 = exp(-1.3396226415094339 - 0.094339622641509441 * var_chaste_interface__membrane__V);
        ...
        const double var_x85 = 9.4339622641509443e-5 * var_x80 / pow(var_x81, 2);
        ...
        const double var_x88 = exp(1.8415841584158419 + 0.099009900990099015 * var_chaste_interface__membrane__V);
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0048327079999999998 - 0.054649999999999997 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.00173814 / var_x2 - 0.017225000000000001 * pow(var_chaste_interface__slow_delayed_rectifying_potassium_current_xs_gate__xs, 2) - 0.003322752 * var_chaste_interface__four_AP_sensitive_currents_r_gate__r + var_x3 * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_i_gate__P_i - 0.21390299999999998 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T * var_chaste_interface__T_type_Ca_channel_f_gate__f_T - 0.24524999999999997 * var_chaste_interface__four_AP_sensitive_currents_q_gate__q * var_chaste_interface__four_AP_sensitive_currents_r_gate__r - 0.28969 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L * var_chaste_interface__L_type_Ca_channel_f_gate__f_L - 0.0068989604918571314 * var_x4 / pow((1 + 0.66666666666666663 * var_x4), 2) - 0.00013614499999999998 * (19.164159999999999 * exp(var_x5) + 51353.959999999999 * NV_Ith_S(mParameters, 0) * exp(-var_x5)) / (1.1024 + 274.40000000000003 * NV_Ith_S(mParameters, 0)) + 0.001 * var_x1 * var_x6 / pow(var_x2, 2));
        IJth(rJacobian, 1, 0) = 6.105006105006105e-5 * var_x10 * var_x11 * var_x12 * var_x16 - 2.3112969460591231 * (var_x12 - var_chaste_interface__sodium_current_m_gate__m) * (0.27934182395599999 * var_x14 - 0.051635019999999997 * var_x13) / (pow((0.073139106771250198 + var_x15), 2) * pow((var_x14 + 0.75389027327741354 * var_x13), 2));
        IJth(rJacobian, 2, 0) = -var_x24 * var_x25 + 2799.1971566651023 * (var_x23 - var_chaste_interface__sodium_current_h_gate__h1) * (1.0463354999999999e-6 * var_x20 - 4.7524937544000007e-9 * var_x17 * var_x19 / pow(var_x18, 2)) / pow((1 + 0.0062188388823824657 * var_x20), 2);
        IJth(rJacobian, 3, 0) = -var_x25 * var_x30 + 79.081790816642851 * (var_x23 - var_chaste_interface__sodium_current_h_gate__h2) * (1.9813734000000003e-8 * var_x29 - 1.5306846118200001e-12 * var_x26 * var_x28 / pow(var_x27, 2)) / pow((1 + 8.959505061867266e-6 * var_x29), 2);
        IJth(rJacobian, 4, 0) = (0.001 / var_x32 - 0.001 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L) * (var_x36 - var_x40 - var_x44 - 5.6779999999999999 * var_x37 * var_x45 / pow(var_x38, 2) - 8.829600000000001 * var_x41 * var_chaste_interface__membrane__V / pow(var_x42, 2) - 2.286 * var_x33 * var_x46 / pow(var_x34, 2)) + 0.00016666666666666666 * var_x31 * (var_x36 * var_x46 - var_x40 * var_x45 - var_x44 * var_chaste_interface__membrane__V) / pow(var_x32, 2);
        IJth(rJacobian, 5, 0) = (0.001 / var_x48 - 0.001 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L) * (var_x53 + 6.25 * var_x54 / pow(var_x55, 2) - 0.78125 * var_x50 * var_x56 / pow(var_x51, 2)) - 0.00020000000000000001 * var_x47 * (25.0 * var_x57 + var_x53 * var_x56) / pow(var_x48, 2);
        IJth(rJacobian, 6, 0) = (0.001 / var_x59 - 0.001 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T) * (35.600000000000001 * var_x61 - 35.600000000000001 * var_x62) + 0.00014705882352941178 * var_x58 * (1068.0 * var_x61 + 1068.0 * var_x62) / pow(var_x59, 2);
        IJth(rJacobian, 7, 0) = (0.001 / var_x65 - 0.001 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T) * (0.97529258777633288 * var_x66 - 0.18367346938775511 * var_x67) - 0.00011111111111111112 * var_x64 * (15.0 * var_x66 + 15.300000000000001 * var_x67) / pow(var_x65, 2);
        IJth(rJacobian, 8, 0) = -7.6335877862595422e-5 * var_x68 * var_x73 / pow(var_x69, 2) - 0.02981616261141468 * (1 / var_x69 - var_chaste_interface__four_AP_sensitive_currents_q_gate__q) * (0.046403446000000001 * var_x70 - 0.19506105999999998 * var_x71) / (pow((0.1550383631713555 + var_x72), 2) * pow((var_x71 + 0.79258433231112346 * var_x70), 2));
        IJth(rJacobian, 9, 0) = 5.076142131979696e-5 * var_x74 * var_x79 / pow(var_x75, 2) - 0.047456665474470604 * (1 / var_x75 - var_chaste_interface__four_AP_sensitive_currents_r_gate__r) * (0.043910999999999999 * var_x77 - 0.09345444 * var_x76) / (pow((0.15195202857871906 + var_x78), 2) * pow((var_x76 + 0.35583413693346194 * var_x77), 2));
        IJth(rJacobian, 10, 0) = var_x85 * (0.95999999999999996 * var_x84 + 37.200000000000003 * var_x83) + (var_x82 - 0.001 * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_af_gate__P_af) * (2.3396226415094339 * var_x83 - 0.042666666666666665 * var_x84);
        IJth(rJacobian, 11, 0) = var_x85 * (4.2000000000000002 * var_x86 + 0.14999999999999999 * var_x87) + (var_x82 - 0.001 * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_as_gate__P_as) * (0.24705882352941178 * var_x86 - 0.0069444444444444441 * var_x87);
        IJth(rJacobian, 12, 0) = -0.049504950495049507 * var_x88 / pow((1.0 + var_x88), 2);
        IJth(rJacobian, 13, 0) = 2.2222222222222223e-5 * var_x89 * var_chaste_interface__slow_delayed_rectifying_potassium_current_xs_gate__xs + 0.0015555555555555555 * var_x90 * (1.0 - var_chaste_interface__slow_delayed_rectifying_potassium_current_xs_gate__xs) / pow(var_x91, 2);
        IJth(rJacobian, 14, 0) = -4.7058823529411767e-5 * var_x92 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.037551633496057078 * var_x93 * (0.001 - 0.001 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y);
        IJth(rJacobian, 1, 1) = -0.001 * var_x16;
        IJth(rJacobian, 2, 2) = -0.001 * var_x24;
        IJth(rJacobian, 3, 3) = -0.001 * var_x30;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x6 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L);
        IJth(rJacobian, 4, 4) = 0.014195000000000001 * var_x39 * var_x45 + 0.042450000000000002 * var_x43 * var_chaste_interface__membrane__V - 0.0057149999999999996 * var_x35 * var_x46;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x6 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L);
        IJth(rJacobian, 5, 5) = -0.025000000000000001 * var_x57 - 0.0031250000000000002 * var_x52 * var_x56;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x7 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T);
        IJth(rJacobian, 6, 6) = -1.0680000000000001 * var_x61 - 1.0680000000000001 * var_x62;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x7 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T);
        IJth(rJacobian, 7, 7) = -0.015300000000000001 * var_x67 - 0.014999999999999999 * var_x66;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x9 * var_chaste_interface__four_AP_sensitive_currents_r_gate__r);
        IJth(rJacobian, 8, 8) = -0.001 * var_x73;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.12501445333984951 * var_x8 - 0.003322752 * var_chaste_interface__membrane__V + var_x9 * var_chaste_interface__four_AP_sensitive_currents_q_gate__q);
        IJth(rJacobian, 9, 9) = -0.001 * var_x79;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : ((-0.89962946277658085 * var_x8 - 0.023911199999999997 * var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_i_gate__P_i);
        IJth(rJacobian, 10, 10) = -0.00095999999999999992 * var_x84 - 0.037200000000000004 * var_x83;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : ((-0.015940800000000001 * var_chaste_interface__membrane__V - 0.5997529751843873 * var_x8) * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_i_gate__P_i);
        IJth(rJacobian, 11, 11) = -0.00014999999999999999 * var_x87 - 0.0042000000000000006 * var_x86;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x3 * (37.623768893931747 * var_x8 + var_chaste_interface__membrane__V));
        IJth(rJacobian, 12, 12) = -0.5;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.034450000000000001 * (30.993565913953184 * var_x8 + var_chaste_interface__membrane__V) * var_chaste_interface__slow_delayed_rectifying_potassium_current_xs_gate__xs);
        IJth(rJacobian, 13, 13) = -0.001 * var_x89 - 0.014 / var_x91;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-0.12413052817541766 * var_x8 - 0.054649999999999997 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 14, 14) = -0.001 * var_x92 - 0.001 * var_x93;
    }
