...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmatsuoka_model_2003FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 7, 7) = -8.7499999999999999e-5 + var_x316 - 1 / var_x304;
        ...
        IJth(rJacobian, 8, 8) = -1 / (4000.0 * var_x322 + 0.014 * var_x321) - 1 / (8000.0 * var_x318 + 9000000000.0 * var_x320);
        ...
        IJth(rJacobian, 11, 11) = -0.001 + var_x353 - 1 / var_x339;
        ...
        IJth(rJacobian, 15, 15) = -1 / (58.0 * var_x329 + 250000.0 * var_x364) - 1 / (66.0 * var_x325 + 1800.0 * var_x365);
        ...
        IJth(rJacobian, 16, 16) = -1 / (1.5 * var_x368 + 40.0 * var_x369) - 1 / (0.019 * var_x366 + 0.81999999999999995 * var_x367);
        ...
        IJth(rJacobian, 17, 17) = -1 / (30.0 * var_x370 + 62000.0 * var_x371) - 1 / (1.2 * var_x373 + 0.00059999999999999995 * var_x372);
        ...
        IJth(rJacobian, 18, 18) = -1 / (7.0 * var_x375 + 8000.0 * var_x376) - var_x188 * var_x381;
        ...
        IJth(rJacobian, 19, 19) = -1 / (5.0 * var_x389 + 20.0 * var_x390) - 1 / (160.0 * var_x386 + 200.0 * var_x387) - 0.00040000000000000002 * var_x384;
        ...
        IJth(rJacobian, 20, 20) = -1 / (20.0 * var_x389 + 200.0 * var_x391) - 1 / (1600.0 * var_x386 + 2000.0 * var_x387) - 0.0001 * var_x384;
        ...
        IJth(rJacobian, 21, 21) = -1 / (2.0 * var_x394 + 0.34999999999999998 * var_x393) - 1 / (2.5 * var_x392 + 10.0 * var_x289);
        ...
        IJth(rJacobian, 22, 22) = -1 / (260.0 * var_x318 + 1450.0 * var_x303) - 1 / (85.0 * var_x395 + 370.0 * var_x396);
        ...
        IJth(rJacobian, 24, 24) = -1 / (11.0 * var_x397 + 0.20000000000000001 * var_x284) - 1 / (4.4000000000000004 * var_x399 + 0.20000000000000001 * var_x398);
        ...
        IJth(rJacobian, 26, 26) = -0.20379327210477693 - var_x46 - 1 / var_x409 - 0.6399652192815608 * var_x39;
        ...
        IJth(rJacobian, 28, 28) = -1.01 + 0.01 * var_x270 + 0.98999999999999999 * var_x276 - var_x277;
