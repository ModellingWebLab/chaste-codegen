...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellfox_mcharg_gilmour_2002FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x24 = 1.9300000000000002e-5 * NV_Ith_S(mParameters, 8);
        ...
        const double var_x31 = var_x10 * (var_x3 + var_x9 * NV_Ith_S(mParameters, 3));
        ...
        const double var_x77 = 0.019300000000000001 * NV_Ith_S(mParameters, 8);
        ...
        const double var_x90 = 5.5873500000000006e-9 * var_x32;
        const double var_x91 = var_x89 * var_x90;
        const double var_x92 = var_x4 * var_x91;
        ...
        const double var_x101 = var_x100 * var_x4;
        ...
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x133) ? (0.15999999943156581 * var_x130 + 0.16000000056843419 * var_x131) : (var_x137 - 0.032000000000000001 * var_x132 * var_x135 / pow(var_x136, 2))) + 0.0072727272727272727 * var_x138 * var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x79 - ((var_x35) ? (var_x81 + var_x0 * (-var_x81 - var_x31 * var_x80)) : (var_x46 * var_x79)) + 0.050000000000000003 * var_x84 + 1000.0 * var_x85 - 50.0 * var_x82 - 0.0051306426321243524 * var_x83);
        ...
        IJth(rJacobian, 2, 2) = -((var_x133) ? (-var_x139 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x139 + 3.1999999919207769e-7 * var_x130)) : (var_x132 * var_x137)) - 0.080000000000000002 * var_x138;
        ...
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x95 - ((var_x35) ? (var_x92 + var_x0 * (-var_x92 - var_x31 * var_x91)) : (var_x89 * var_x93)));
        IJth(rJacobian, 1, 9) = var_x111 * (var_x126 - var_x123);
        IJth(rJacobian, 9, 9) = -var_x206;
        IJth(rJacobian, 12, 9) = -var_x126 * var_x224;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x99 - ((var_x35) ? (var_x98 + var_x0 * (-var_x98 - var_x31 * var_x97)) : (var_x93 * var_x96)));
        ...
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x102 - ((var_x35) ? (var_x101 + var_x0 * (-var_x101 - var_x100 * var_x31)) : (var_x21 * var_x93)));
