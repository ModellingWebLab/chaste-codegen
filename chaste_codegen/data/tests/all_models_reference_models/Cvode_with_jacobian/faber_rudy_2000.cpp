...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellfaber_rudy_2000FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel__I_CaNa = ((fabs(var_chaste_interface__cell__V) < 2.6712338705498262e-6) ? (6.5127374999999992e-9 * (-0.75 * NV_Ith_S(mParameters, 7) + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(9.9999999999999995e-8)) / (-1.0 + exp(9.9999999999999995e-8)) - 187179.41753901311 * (-2.6712338705498262e-6 + var_chaste_interface__cell__V) * (-6.5127374999999992e-9 * (-0.75 * NV_Ith_S(mParameters, 7) + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(9.9999999999999995e-8)) / (-1.0 + exp(9.9999999999999995e-8)) - 6.5127374999999992e-9 * (-0.75 * NV_Ith_S(mParameters, 7) + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(-9.9999999999999995e-8)) / (-1.0 + exp(-9.9999999999999995e-8)))) : (0.0024381008236689767 * (-0.75 * NV_Ith_S(mParameters, 7) + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(0.037435883507802616 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(0.037435883507802616 * var_chaste_interface__cell__V)))); // microA_per_microF
        ...
        const double var_non_specific_calcium_activated_current__I_ns_K = ((fabs(var_chaste_interface__cell__V) < 2.6712338705498262e-6) ? (1.6884874999999999e-9 * (-0.75 * NV_Ith_S(mParameters, 6) + 0.75 * var_chaste_interface__ionic_concentrations__Ki * exp(9.9999999999999995e-8)) / (-1.0 + exp(9.9999999999999995e-8)) - 187179.41753901311 * (-2.6712338705498262e-6 + var_chaste_interface__cell__V) * (-1.6884874999999999e-9 * (-0.75 * NV_Ith_S(mParameters, 6) + 0.75 * var_chaste_interface__ionic_concentrations__Ki * exp(9.9999999999999995e-8)) / (-1.0 + exp(9.9999999999999995e-8)) - 1.6884874999999999e-9 * (-0.75 * NV_Ith_S(mParameters, 6) + 0.75 * var_chaste_interface__ionic_concentrations__Ki * exp(-9.9999999999999995e-8)) / (-1.0 + exp(-9.9999999999999995e-8)))) : (0.00063210021354380874 * (-0.75 * NV_Ith_S(mParameters, 6) + 0.75 * var_chaste_interface__ionic_concentrations__Ki * exp(0.037435883507802616 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(0.037435883507802616 * var_chaste_interface__cell__V)))); // microA_per_microF
        const double var_non_specific_calcium_activated_current__I_ns_Na = ((fabs(var_chaste_interface__cell__V) < 2.6712338705498262e-6) ? (1.6884874999999999e-9 * (-0.75 * NV_Ith_S(mParameters, 7) + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(9.9999999999999995e-8)) / (-1.0 + exp(9.9999999999999995e-8)) - 187179.41753901311 * (-2.6712338705498262e-6 + var_chaste_interface__cell__V) * (-1.6884874999999999e-9 * (-0.75 * NV_Ith_S(mParameters, 7) + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(9.9999999999999995e-8)) / (-1.0 + exp(9.9999999999999995e-8)) - 1.6884874999999999e-9 * (-0.75 * NV_Ith_S(mParameters, 7) + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(-9.9999999999999995e-8)) / (-1.0 + exp(-9.9999999999999995e-8)))) : (0.00063210021354380874 * (-0.75 * NV_Ith_S(mParameters, 7) + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(0.037435883507802616 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(0.037435883507802616 * var_chaste_interface__cell__V)))); // microA_per_microF
    ...
    void Cellfaber_rudy_2000FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_L_type_Ca_channel_d_gate__tau_d = ((fabs(10.0 + var_chaste_interface__cell__V) < 6.2400000011564316e-7) ? (801282.05113355326 * (10.000000624 + var_chaste_interface__cell__V) * (45787545.779060178 * (1.0 - exp(1.0000000001853256e-7)) / (1.0 + exp(1.0000000001853256e-7)) + 45787545.779060178 * (1.0 - exp(-1.0000000001853256e-7)) / (1.0 + exp(-1.0000000001853256e-7))) - 45787545.779060178 * (1.0 - exp(1.0000000001853256e-7)) / (1.0 + exp(1.0000000001853256e-7))) : (28.571428571428569 * (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__cell__V)) / ((1.0 + exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__cell__V)) * (10.0 + var_chaste_interface__cell__V)))); // ms
        ...
        const double var_rapid_delayed_rectifier_potassium_current__Rect = 1 / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__cell__V)); // dimensionless
        const double var_rapid_delayed_rectifier_potassium_current__g_Kr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 6)) * NV_Ith_S(mParameters, 13); // milliS_per_microF
        const double var_rapid_delayed_rectifier_potassium_current_xr_gate__tau_xr = 1 / (((fabs(38.899999999999999 + var_chaste_interface__cell__V) < 6.8965517030505907e-7) ? (4.2068965605324136e-10 / (-1.0 + exp(1.0000000020937704e-7)) - 725000.00221680664 * (38.899999310344825 + var_chaste_interface__cell__V) * (-4.2068965171893065e-10 / (-1.0 + exp(-9.9999999179090074e-8)) - 4.2068965605324136e-10 / (-1.0 + exp(1.0000000020937704e-7)))) : (0.00060999999999999997 * (38.899999999999999 + var_chaste_interface__cell__V) / (-1.0 + exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__cell__V)))) + ((fabs(14.199999999999999 + var_chaste_interface__cell__V) < 8.1300813015161566e-7) ? (-1.1219512196092296e-9 / (1.0 - exp(1.0000000000864873e-7)) + 614999.99994681031 * (14.200000813008129 + var_chaste_interface__cell__V) * (1.1219512196092296e-9 / (1.0 - exp(1.0000000000864873e-7)) + 1.1219512196092296e-9 / (1.0 - exp(-1.0000000000864873e-7)))) : (0.0013799999999999999 * (14.199999999999999 + var_chaste_interface__cell__V) / (1.0 - exp(-1.7465999999999999 - 0.123 * var_chaste_interface__cell__V))))); // ms
        ...
        const double var_slow_delayed_rectifier_potassium_current_xs2_gate__tau_xs2 = 4.0 * ((fabs(30.0 + var_chaste_interface__cell__V) < 1.4556040746072085e-6) ? (1 / (-1.9068413377354434e-10 / (-1.0 + exp(-9.9999999925515227e-8)) - 1.0465793296425829e-10 / (1.0 - exp(2.1542940304186685e-7)) + 343500.00025585521 * (30.000001455604075 + var_chaste_interface__cell__V) * (1.9068413377354434e-10 / (-1.0 + exp(9.9999999925515227e-8)) + 1.9068413377354434e-10 / (-1.0 + exp(-9.9999999925515227e-8)) + 1.0465793296425829e-10 / (1.0 - exp(2.1542940304186685e-7)) + 1.0465793296425829e-10 / (1.0 - exp(-2.1542940304186685e-7))))) : (1 / (0.00013100000000000001 * (30.0 + var_chaste_interface__cell__V) / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V)) + 7.1899999999999999e-5 * (30.0 + var_chaste_interface__cell__V) / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V))))); // ms
        const double var_slow_delayed_rectifier_potassium_current__i_Ks = (-var_slow_delayed_rectifier_potassium_current__E_Ks + var_chaste_interface__cell__V) * var_slow_delayed_rectifier_potassium_current__g_Ks * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2; // microA_per_microF
    ...
    void Cellfaber_rudy_2000FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x80 = var_x10 * var_x36;
        const double var_x81 = var_x14 * var_x37;
        const double var_x82 = 0.0024381008236689767 * var_x22 * var_x38;
        ...
        const double var_x87 = var_x86 * ((var_x17) ? (0.0012190504118344883 * var_x80 + 0.0012190504118344883 * var_x81) : (var_x82 + 6.8454343811362063e-5 * var_x26 * var_chaste_interface__ionic_concentrations__Nai - 9.1272458415149417e-5 * var_x28 * var_x38));
        const double var_x88 = var_x10 * var_x9;
        const double var_x89 = var_x13 * var_x14;
        const double var_x90 = 0.00069711623550831479 * var_x20 * var_x22;
        const double var_x91 = var_x86 * ((var_x17) ? (0.0003485581177541574 * var_x88 + 0.0003485581177541574 * var_x89) : (var_x90 + 1.9572871637915374e-5 * var_x26 * var_chaste_interface__ionic_concentrations__Ki - 2.6097162183887167e-5 * var_x20 * var_x28));
        ...
        const double var_x167 = 1.6884874999999999e-9 * var_x88;
        const double var_x168 = -var_x167 - 1.6884874999999999e-9 * var_x89;
        const double var_x169 = -0.5 + 187179.41753901311 * var_chaste_interface__cell__V;
        const double var_x170 = var_x24 * var_chaste_interface__cell__V;
        const double var_x171 = 5.1839999999999986e-9 / (pow(var_x30, 2) * pow(var_chaste_interface__calcium_dynamics__Cai, 4));
        const double var_x172 = var_x171 * ((var_x17) ? (var_x167 - var_x168 * var_x169) : (var_x170));
        const double var_x173 = 1.6884874999999999e-9 * var_x80;
        const double var_x174 = -var_x173 - 1.6884874999999999e-9 * var_x81;
        const double var_x175 = var_x39 * var_chaste_interface__cell__V;
        const double var_x176 = var_x171 * ((var_x17) ? (var_x173 - var_x169 * var_x174) : (var_x175));
        const double var_x177 = var_x150 * var_x70;
        const double var_x178 = 6.5127374999999992e-9 * var_x80;
        const double var_x179 = -var_x178 - 6.5127374999999992e-9 * var_x81;
        const double var_x180 = var_x82 * var_chaste_interface__cell__V;
        const double var_x181 = ((var_x17) ? (var_x178 - var_x169 * var_x179) : (var_x180));
        const double var_x182 = var_x181 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x183 = var_chaste_interface__L_type_Ca_channel_d_gate__d / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x184 = 0.00059999999999999995 * var_x183;
        const double var_x185 = var_x182 * var_x184;
        const double var_x186 = 1.8621604999999999e-9 * var_x88;
        const double var_x187 = -var_x186 - 1.8621604999999999e-9 * var_x89;
        const double var_x188 = var_x90 * var_chaste_interface__cell__V;
        const double var_x189 = ((var_x17) ? (var_x186 - var_x169 * var_x187) : (var_x188));
        const double var_x190 = var_x184 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x191 = var_x189 * var_x190;
        const double var_x192 = 0.019296999999999998 * NV_Ith_S(mParameters, 8);
        const double var_x193 = var_x192 * var_x95;
        const double var_x194 = var_x192 * var_x96;
        const double var_x195 = -0.5 + 374358.83507802623 * var_chaste_interface__cell__V;
        const double var_x196 = var_x193 - var_x195 * (-var_x193 - var_x194);
        const double var_x197 = var_x104 * var_chaste_interface__cell__V;
        const double var_x198 = ((var_x98) ? (var_x196) : (var_x197));
        const double var_x199 = var_x190 * var_x198;
        const double var_x200 = var_x10 * var_x7;
        const double var_x201 = var_x192 * var_x200;
        const double var_x202 = var_x12 * var_x14;
        const double var_x203 = var_x201 + (0.5 - 374358.83507802623 * var_chaste_interface__cell__V) * (-var_x201 - var_x192 * var_x202);
        const double var_x204 = var_x103 * var_x105;
        const double var_x205 = ((var_x98) ? (var_x203) : (var_x204));
        const double var_x206 = var_x205 * var_x86;
        const double var_x207 = var_x132 * pow(var_x76, 2);
        const double var_x208 = var_x207 * var_x70;
        const double var_x209 = 1 / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki);
        const double var_x210 = -26.712338705498265 * log(var_x209 * (0.018329999999999999 * NV_Ith_S(mParameters, 7) + NV_Ith_S(mParameters, 6))) + var_chaste_interface__cell__V;
        const double var_x211 = var_x210 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
        const double var_x212 = 5.4447296618926212e-7 * var_x211 * var_x56 * var_x57 * var_x61 / pow(var_x58, 2);
        const double var_x213 = log(var_x44 * NV_Ith_S(mParameters, 7));
        const double var_x214 = -26.712338705498265 * var_x213 + var_chaste_interface__cell__V;
        const double var_x215 = var_x214 * NV_Ith_S(mParameters, 9) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x216 = var_x215 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x217 = var_x214 * var_x65;
        const double var_x218 = var_x215 * var_x64;
        const double var_x219 = var_x198 * var_x85;
        const double var_x220 = var_x84 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x221 = log(var_x56 * NV_Ith_S(mParameters, 5));
        const double var_x222 = -13.356169352749133 * var_x221 + var_chaste_interface__cell__V;
        const double var_x223 = var_x222 * var_chaste_interface__T_type_Ca_channel_b_gate__b * var_chaste_interface__T_type_Ca_channel_g_gate__g;
        const double var_x224 = var_x154 * NV_Ith_S(mParameters, 13);
        const double var_x225 = var_x211 * NV_Ith_S(mParameters, 14);
        const double var_x226 = var_x54 * var_x67 * pow(var_chaste_interface__transient_outward_current_zdv_gate__zdv, 2) * NV_Ith_S(mParameters, 16) * var_chaste_interface__transient_outward_current_ydv_gate__ydv;
        const double var_x227 = var_x54 * var_x68;
        const double var_x228 = 0.10684935482199306 * var_x44;
        const double var_x229 = 187179.41753901311 * var_chaste_interface__cell__V;
        const double var_x230 = 0.5 - var_x229;
        const double var_x231 = 1.2663656249999999e-9 * var_x200;
        const double var_x232 = var_x32 * ((var_x17) ? (var_x231 + var_x230 * (-var_x231 - 1.2663656249999999e-9 * var_x202)) : (0.0004740751601578565 * var_x26));
        const double var_x233 = -var_x232;
        const double var_x234 = 4.8845531249999998e-9 * var_x200;
        const double var_x235 = var_x86 * ((var_x17) ? (var_x234 + var_x230 * (-var_x234 - 4.8845531249999998e-9 * var_x202)) : (0.0018285756177517324 * var_x26));
        const double var_x236 = var_x209 * var_x63;
        const double var_x237 = 2.4586089909663641e-6 * var_x44 * var_x45 * var_x49 * var_x54 / pow((8.0403875140176932e-6 + var_x45), 2);
        const double var_x238 = var_x138 * NV_Ith_S(mParameters, 6) / var_x142;
        const double var_x239 = var_x238 / (var_x72 * pow((0.01 + var_x135), 2));
        const double var_x240 = 26.712338705498265 * var_x44 * var_x66;
        const double var_x241 = var_x134 * var_x73;
        const double var_x242 = var_x150 * var_x241;
        const double var_x243 = var_x207 * var_x241;
        const double var_x244 = 5.1338399412861326e-7 * var_x4 * var_x52;
        const double var_x245 = 0.14745210965435041 * var_x2 * var_x52;
        const double var_x246 = 2.9172010853500545 * var_x50 * var_x52;
        const double var_x247 = 1.3966203749999998e-9 * var_x200;
        const double var_x248 = var_x86 * ((var_x17) ? (var_x247 + var_x230 * (-var_x247 - 1.3966203749999998e-9 * var_x202)) : (0.00052283717663123607 * var_x26));
        const double var_x249 = 11.72506353372661 * var_x130 * var_x52;
        const double var_x250 = 11.495160327182951 * var_x112 * var_x115 * var_x52;
        const double var_x251 = 26.712338705498265 * var_x52 * var_x69;
        const double var_x252 = var_x146 * var_x52;
        const double var_x253 = var_x155 * (6.4983106368865622 * var_x252 - var_x152 * (1.053972635420138 * var_x125 * var_x52 + 1.6494869150645177 * var_x126 * var_x52) - 13.738155796237757 * var_x153 * var_x52);
        const double var_x254 = 2.7964276527937963 * var_x147 * var_x252;
        const double var_x255 = var_x150 * var_x75;
        const double var_x256 = 0.003016 + var_x43 + 0.063641001963264457 * var_x255 - 2.0 * var_x133 - 0.074871767015605231 * var_x151;
        const double var_x257 = 1 / M_PI;
        const double var_x258 = 9.6614270660886194e-5 * var_x257;
        const double var_x259 = 0.055555555555555559 * var_x164;
        const double var_x260 = var_x83 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x261 = 1.1111111111111112 * var_x260;
        const double var_x262 = var_x261 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x263 = 0.0033511111111111111 + var_x259 + 0.070712224403627164 * var_x255 - 2.2222222222222223 * var_x133 - 0.083190852239561366 * var_x151 + var_x109 * var_x262;
        const double var_x264 = -var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x265 = 1.2777777777777777 * var_x158;
        const double var_x266 = var_x198 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x267 = exp(5.5555555555555554 + 0.0033511111111111111 * var_chaste_interface__cell__V - 0.044758007519879316 * var_x221 - 2.2222222222222223 * var_x255 + var_x222 * var_x259 + var_x261 * var_x266 + var_x265 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x268 = 1.0 + var_x267;
        const double var_x269 = exp(2.0);
        const double var_x270 = 1.0 + var_x269 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x271 = 1 / var_x270;
        const double var_x272 = 1.0 - var_x271;
        const double var_x273 = var_x271 * var_x272;
        const double var_x274 = var_x264 * var_x267 * var_x273 / pow(var_x268, 2);
        const double var_x275 = 1.0588235294117645 * var_x274;
        const double var_x276 = 0.0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x277 = 1.0 + 0.00011900000000000002 / pow(var_x276, 2) + 3.5000000000000004e-5 * var_x161;
        const double var_x278 = 1 / var_x277;
        const double var_x279 = var_x278;
        const double var_x280 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x281 = NV_Ith_S(mParameters, 3) / var_x280;
        const double var_x282 = 0.081176470588235281 * var_x281;
        const double var_x283 = var_x159 + var_x160 + var_x166 - var_x163 + 2.0 * var_x177 + 0.00020000000000000001 * var_x208;
        const double var_x284 = var_chaste_interface__calcium_dynamics__Cai * NV_Ith_S(mParameters, 3) / pow(var_x280, 2);
        const double var_x285 = 1 / var_x268;
        const double var_x286 = 1.0588235294117645 * var_x285;
        const double var_x287 = var_x273 * var_x286;
        const double var_x288 = var_x265 + 0.044758007519879316 * var_x56 + 2.2222222222222223 * var_x177 + 0.74200940848606289 * var_x165 + 0.00022222222222222223 * var_x208 - 1.2777777777777777 * var_x162 + var_x205 * var_x262 - 0.00066666666666666664 * var_x183 * var_x266;
        const double var_x289 = -0.040282206767891383 * var_x221 + var_x159 * var_chaste_interface__calcium_dynamics__Cai + var_x222 * var_x43;
        const double var_x290 = NV_Ith_S(mParameters, 3) * NV_Ith_S(mParameters, 0);
        const double var_x291 = 0.0054117647058823529 * var_x290;
        const double var_x292 = var_x258 * var_x83;
        const double var_x293 = 1.1764705882352939 * var_x274;
        const double var_x294 = var_x266 * var_x83;
        const double var_x295 = var_x258 * var_x260;
        const double var_x296 = var_x198 * var_x260;
        const double var_x297 = -9.6614270660886201e-6 * var_x223 * var_x257;
        const double var_x298 = var_x223 * var_x274;
        const double var_x299 = var_x222 * var_x41;
        const double var_x300 = -4.83071353304431e-6 * var_x257 * var_x299;
        const double var_x301 = var_x274 * var_x299;
        const double var_x302 = var_x264 * var_x269;
        const double var_x303 = var_x302 / pow(var_x270, 3);
        const double var_x304 = var_x272 * var_x302 / pow(var_x270, 2);
        const double var_x305 = -var_x258 * (0.00060000000000000006 * var_x243 - 6.0 * var_x242);
        const double var_x306 = 0.00066666666666666664 * var_x243 - 6.6666666666666661 * var_x242;
        const double var_x307 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x308 = 1 / (1.0 - exp(1.0000000045806701e-7));
        const double var_x309 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x310 = fabs(var_x309) < 1.0000000010279564e-6;
        const double var_x311 = -0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x312 = exp(-4.7130000000000001 + var_x311);
        const double var_x313 = 1.0 - var_x312;
        const double var_x314 = 0.32000000000000001 / var_x313;
        const double var_x315 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x316 = 3.2000000146581445e-7 * var_x308;
        const double var_x317 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 11) - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x318 = var_chaste_interface__cell__V < -40.0;
        const double var_x319 = ((var_x318) ? (0.13500000000000001 * var_x317) : (0));
        const double var_x320 = var_x319;
        const double var_x321 = exp(0.34999999999999998 * var_chaste_interface__cell__V - 0.34999999999999998 * NV_Ith_S(mParameters, 11));
        const double var_x322 = exp(0.079000000000000001 * var_chaste_interface__cell__V - 0.079000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x323 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 11) - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x324 = 1.0 + var_x323;
        const double var_x325 = ((var_x318) ? (310000.0 * var_x321 + 3.5600000000000001 * var_x322) : (7.6923076923076916 / var_x324));
        const double var_x326 = var_x325;
        const double var_x327 = ((var_x318) ? (-0.019852941176470591 * var_x317) : (0));
        const double var_x328 = var_x319 + var_x325;
        const double var_x329 = 0.01 * NV_Ith_S(mParameters, 10);
        const double var_x330 = 1.0 - var_x329;
        const double var_x331 = var_x330 / var_x328;
        const double var_x332 = ((var_x318) ? (0.28123999999999999 * var_x322 + 108500.0 * var_x321) : (0.693000693000693 * var_x323 / pow(var_x324, 2)));
        const double var_x333 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 11) - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x334 = 1.0 + var_x333;
        const double var_x335 = exp(0.01052 * NV_Ith_S(mParameters, 11) - 0.01052 * var_chaste_interface__cell__V);
        const double var_x336 = var_x335 / var_x334;
        const double var_x337 = exp(-3.2000000000000002 + var_x311 + 0.10000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x338 = 1.0 + var_x337;
        const double var_x339 = exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 11) - 2.5349999999999999e-7 * var_chaste_interface__cell__V);
        const double var_x340 = var_x339 / var_x338;
        const double var_x341 = ((var_x318) ? (0.1212 * var_x336) : (0.29999999999999999 * var_x340));
        const double var_x342 = var_x341;
        const double var_x343 = 37.780000000000001 + var_chaste_interface__cell__V;
        const double var_x344 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V - 0.311 * NV_Ith_S(mParameters, 11));
        const double var_x345 = 1.0 + var_x344;
        const double var_x346 = 1 / var_x345;
        const double var_x347 = exp(0.24440000000000001 * var_chaste_interface__cell__V - 0.24440000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x348 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 11) - 0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x349 = -127140.0 * var_x347 - 3.4740000000000003e-5 * var_x348;
        const double var_x350 = var_x346 * var_x349;
        const double var_x351 = ((var_x318) ? (var_x343 * var_x350) : (0));
        const double var_x352 = var_x351;
        const double var_x353 = ((var_x318) ? (var_x350 + var_x343 * var_x346 * (1.5254334000000001e-6 * var_x348 - 31073.016 * var_x347) - 0.311 * var_x343 * var_x344 * var_x349 / pow(var_x345, 2)) : (0));
        const double var_x354 = var_x341 + var_x351;
        const double var_x355 = var_x330 / var_x354;
        const double var_x356 = ((var_x318) ? (-0.001275024 * var_x336 + 0.016701360000000002 * var_x333 * var_x335 / pow(var_x334, 2)) : (-7.6049999999999996e-8 * var_x340 + 0.029999999999999999 * var_x337 * var_x339 / pow(var_x338, 2)));
        const double var_x357 = exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__cell__V);
        const double var_x358 = 1.0 + var_x357;
        const double var_x359 = 1 / var_x358;
        const double var_x360 = -1.0 + var_x359;
        const double var_x361 = exp(1.0000000001853256e-7);
        const double var_x362 = (1.0 - var_x361) / (1.0 + var_x361);
        const double var_x363 = 45787545.779060178 * var_x362;
        const double var_x364 = exp(-1.0000000001853256e-7);
        const double var_x365 = (1.0 - var_x364) / (1.0 + var_x364);
        const double var_x366 = (10.000000624 + var_chaste_interface__cell__V) * (var_x363 + 45787545.779060178 * var_x365);
        const double var_x367 = 10.0 + var_chaste_interface__cell__V;
        const double var_x368 = fabs(var_x367) < 6.2400000011564316e-7;
        const double var_x369 = 1.0 - var_x357;
        const double var_x370 = 1 / var_x369;
        const double var_x371 = 0.035000000000000003 * var_x358 * var_x370;
        const double var_x372 = 0.005608974358974359 * var_x357 * var_x367;
        const double var_x373 = ((var_x368) ? (4.7698560017679535e-16 * (-36688738598216.805 * var_x362 - 36688738598216.805 * var_x365) / pow((-var_x362 + 0.017500000000000002 * var_x366), 2)) : (var_x371 - var_x370 * var_x372 - var_x358 * var_x372 / pow(var_x369, 2)));
        const double var_x374 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x375 = ((var_x368) ? (1 / (-var_x363 + 801282.05113355326 * var_x366)) : (var_x367 * var_x371));
        const double var_x376 = 0.16025641025641024 * var_x357 * var_x375 / pow(var_x358, 2);
        const double var_x377 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x378 = 0.019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__cell__V), 2));
        const double var_x379 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x380 = 1.0 + var_x379;
        const double var_x381 = 0.029999999999999999 * var_x379 / pow(var_x380, 2);
        const double var_x382 = exp(4.0767441860465121 + 0.11627906976744186 * var_chaste_interface__cell__V);
        const double var_x383 = 1.0 + var_x382;
        const double var_x384 = 0.11627906976744186 * var_x382 / pow(var_x383, 2);
        const double var_x385 = -0.02 - var_x378;
        const double var_x386 = 1 / var_x383;
        const double var_x387 = 0.59999999999999998 / var_x380;
        const double var_x388 = var_x386 + var_x387;
        const double var_x389 = var_x378 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__cell__V);
        const double var_x390 = 1.0 - var_x386 - var_x387;
        const double var_x391 = exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__cell__V);
        const double var_x392 = 1.0 + var_x391;
        const double var_x393 = exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__cell__V);
        const double var_x394 = 1.0 + var_x393;
        const double var_x395 = 1 / var_x394;
        const double var_x396 = 1 / (3.7000000000000002 + 6.0999999999999996 * var_x395);
        const double var_x397 = exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__cell__V);
        const double var_x398 = 1.0 + var_x397;
        const double var_x399 = var_chaste_interface__cell__V <= 0;
        const double var_x400 = ((var_x399) ? (1 / (12.0 - 0.875 * var_chaste_interface__cell__V)) : (0.083333333333333329));
        const double var_x401 = exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x402 = 1.0 + var_x401;
        const double var_x403 = 1 / (-1.0 + exp(-9.9999999179090074e-8));
        const double var_x404 = 1 / (-1.0 + exp(1.0000000020937704e-7));
        const double var_x405 = exp(-1.7465999999999999 - 0.123 * var_chaste_interface__cell__V);
        const double var_x406 = 1.0 - var_x405;
        const double var_x407 = 0.0013799999999999999 / var_x406;
        const double var_x408 = 14.199999999999999 + var_chaste_interface__cell__V;
        const double var_x409 = var_x407 - 0.00016973999999999998 * var_x405 * var_x408 / pow(var_x406, 2);
        const double var_x410 = 38.899999999999999 + var_chaste_interface__cell__V;
        const double var_x411 = fabs(var_x410) < 6.8965517030505907e-7;
        const double var_x412 = 1 / (1.0 - exp(1.0000000000864873e-7));
        const double var_x413 = 1 / (1.0 - exp(-1.0000000000864873e-7));
        const double var_x414 = exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__cell__V);
        const double var_x415 = -1.0 + var_x414;
        const double var_x416 = 0.00060999999999999997 / var_x415;
        const double var_x417 = var_x416 - 8.8449999999999995e-5 * var_x410 * var_x414 / pow(var_x415, 2);
        const double var_x418 = fabs(var_x408) < 8.1300813015161566e-7;
        const double var_x419 = 4.2068965605324136e-10 * var_x404;
        const double var_x420 = var_x407 * var_x408;
        const double var_x421 = 1.1219512196092296e-9 * var_x412;
        const double var_x422 = var_x410 * var_x416;
        const double var_x423 = ((var_x411) ? (var_x419 + var_x420 - 725000.00221680664 * (38.899999310344825 + var_chaste_interface__cell__V) * (-var_x419 - 4.2068965171893065e-10 * var_x403)) : ((var_x418) ? (var_x422 - var_x421 + 614999.99994681031 * (14.200000813008129 + var_chaste_interface__cell__V) * (var_x421 + 1.1219512196092296e-9 * var_x413)) : (var_x420 + var_x422)));
        const double var_x424 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        const double var_x425 = 1.0 + var_x424;
        const double var_x426 = 1 / var_x425;
        const double var_x427 = 1 / (-1.0 + exp(9.9999999925515227e-8));
        const double var_x428 = 1 / (-1.0 + exp(-9.9999999925515227e-8));
        const double var_x429 = 1 / (1.0 - exp(2.1542940304186685e-7));
        const double var_x430 = 1 / (1.0 - exp(-2.1542940304186685e-7));
        const double var_x431 = 30.0 + var_chaste_interface__cell__V;
        const double var_x432 = fabs(var_x431) < 1.4556040746072085e-6;
        const double var_x433 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V);
        const double var_x434 = -1.0 + var_x433;
        const double var_x435 = 1 / var_x434;
        const double var_x436 = 0.00013100000000000001 * var_x435;
        const double var_x437 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V);
        const double var_x438 = 1.0 - var_x437;
        const double var_x439 = 1 / var_x438;
        const double var_x440 = 7.1899999999999999e-5 * var_x439;
        const double var_x441 = var_x431 * var_x433 / pow(var_x434, 2);
        const double var_x442 = var_x431 * var_x437 / pow(var_x438, 2);
        const double var_x443 = 1.9068413377354434e-10 * var_x428;
        const double var_x444 = 1.0465793296425829e-10 * var_x429;
        const double var_x445 = (30.000001455604075 + var_chaste_interface__cell__V) * (var_x443 + var_x444 + 1.9068413377354434e-10 * var_x427 + 1.0465793296425829e-10 * var_x430);
        const double var_x446 = ((var_x432) ? (-var_x443 - var_x444 + 343500.00025585521 * var_x445) : (var_x431 * var_x436 + var_x431 * var_x440));
        const double var_x447 = 0.059880239520958084 * var_x424 / pow(var_x425, 2);
        const double var_x448 = 3.2750000000000003e-5 * var_x435;
        const double var_x449 = 1.7975e-5 * var_x439;
        const double var_x450 = ((var_x432) ? (85875.000063963802 * var_x445 - 4.7671033443386086e-11 * var_x428 - 2.6164483241064574e-11 * var_x429) : (var_x431 * var_x448 + var_x431 * var_x449));
        const double var_x451 = 0.040000000000000001 * var_chaste_interface__cell__V;
        const double var_x452 = exp(-1.6000000000000001 + var_x451);
        const double var_x453 = 1.0 + var_x452;
        const double var_x454 = var_x452 / var_x453;
        const double var_x455 = 10.0 * var_x454;
        const double var_x456 = exp(-3.6000000000000001 - var_x451);
        const double var_x457 = 1.0 + var_x456;
        const double var_x458 = var_x456 / var_x457;
        const double var_x459 = 10.0 * var_x458;
        const double var_x460 = var_x455 + var_x459;
        const double var_x461 = 1 / var_x460;
        const double var_x462 = 0.40000000000000002 * var_x454;
        const double var_x463 = 0.40000000000000002 * pow(var_x456, 2) / pow(var_x457, 2);
        const double var_x464 = 0.40000000000000002 * pow(var_x452, 2) / pow(var_x453, 2);
        const double var_x465 = 0.40000000000000002 * var_x458;
        const double var_x466 = 0.20000000000000001 * var_chaste_interface__cell__V;
        const double var_x467 = exp(12.0 + var_x466);
        const double var_x468 = 1.0 + var_x467;
        const double var_x469 = 1 / var_x468;
        const double var_x470 = 0.014999999999999999 * var_x469;
        const double var_x471 = exp(5.0 + var_x466);
        const double var_x472 = 1.0 + var_x471;
        const double var_x473 = var_x471 / var_x472;
        const double var_x474 = 0.10000000000000001 * var_x473;
        const double var_x475 = var_x470 + var_x474;
        const double var_x476 = 1 / var_x475;
        const double var_x477 = 0.02 * var_x473;
        const double var_x478 = 0.02 * pow(var_x471, 2) / pow(var_x472, 2);
        const double var_x479 = 0.0030000000000000001 * var_x467 / pow(var_x468, 2);
        const double var_x480 = 0.80000000000000004 + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x481 = pow(var_x480, (-2));
        const double var_x482 = 1 / (1.0 + 8.0 * var_x481);
        const double var_x483 = 150.0 * var_x274;
        const double var_x484 = var_x482 * var_x483;
        const double var_x485 = 150.0 * var_x285;
        const double var_x486 = var_x273 * var_x485;
        const double var_x487 = var_x482;
        const double var_x488 = 166.66666666666666 * var_x274 * var_x482;
        const double var_x489 = var_x260 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x490 = 1.0 + var_x59;
        const double var_x491 = var_x490 * var_x61;
        const double var_x492 = var_x144 + var_x255 + var_x289 + 0.0070159999999999997 * var_chaste_interface__cell__V - 0.10684935482199306 * var_x213 + var_x117 * var_x54 + var_x131 * var_x54 + var_x137 * var_x238 + var_x211 * var_x491 + var_x214 * var_x66 + var_x3 * var_x54 + var_x5 * var_x54 + var_x51 * var_x54 + GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance();
        const double var_x493 = var_x492 + var_x197 * var_x489;
        const double var_x494 = -0.5 + var_x229;
        const double var_x495 = var_x32 * (var_x167 - var_x168 * var_x494) + var_x32 * (var_x173 - var_x174 * var_x494) + var_x86 * (var_x178 - var_x179 * var_x494) + var_x86 * (var_x186 - var_x187 * var_x494);
        const double var_x496 = (var_chaste_interface__calcium_dynamics__APtrack > 0.17999999999999999) && (var_chaste_interface__calcium_dynamics__APtrack < 0.20000000000000001);
        const double var_x497 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
        const double var_x498 = (var_x497) && (var_x98);
        const double var_x499 = var_x100 * var_x102 * var_chaste_interface__cell__V;
        const double var_x500 = var_x499 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x501 = 1.3958834540828686 * var_x257;
        const double var_x502 = (var_x497) && (((var_x497) || (var_x98)));
        const double var_x503 = var_chaste_interface__calcium_dynamics__APtrack2 > 0.01;
        const double var_x504 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        const double var_x505 = var_x136 * var_x143;
        const double var_x506 = var_x257 * NV_Ith_S(mParameters, 4);
        const double var_x507 = 0.00019322854132177239 * var_x506;
        const double var_x508 = 0.00057968562396531716 * var_x506;
        const double var_x509 = var_x507 * var_x83;
        const double var_x510 = var_x260 * var_x507;
        const double var_x511 = var_x491 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
        const double var_x512 = var_x209 * var_x511;
        ...
        IJth(rJacobian, 1, 0) = var_x279 * (-var_x258 * (var_x110 + var_x256) - var_x263 * var_x275);
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x310) ? (0.15999999943156581 * var_x307 + 0.16000000056843419 * var_x308) : (var_x314 - 0.032000000000000001 * var_x309 * var_x312 / pow(var_x313, 2))) + 0.0072727272727272727 * var_x315 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 3, 0) = (var_x320 + var_x326) * (var_x327 * var_x331 + var_x319 * var_x330 * (-var_x327 - var_x332) / pow(var_x328, 2)) + (var_x327 + var_x332) * (var_x329 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x319 * var_x331);
        IJth(rJacobian, 4, 0) = (var_x342 + var_x352) * (var_x353 * var_x355 + var_x330 * var_x351 * (-var_x353 - var_x356) / pow(var_x354, 2)) + (var_x353 + var_x356) * (var_x329 - var_chaste_interface__fast_sodium_current_j_gate__j + var_x351 * var_x355);
        IJth(rJacobian, 5, 0) = var_x374 * var_x376 + var_x376 * var_chaste_interface__L_type_Ca_channel_d_gate__d + var_x359 * var_x373 * var_x374 + var_x360 * var_x373 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        IJth(rJacobian, 6, 0) = var_x377 * var_x388 * var_x389 + var_x377 * (0.02 + var_x378) * (var_x381 - var_x384) + var_x385 * (var_x384 - var_x381) * var_chaste_interface__L_type_Ca_channel_f_gate__f - var_x389 * var_x390 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 7, 0) = 0.092592592592592587 * var_x391 * var_x396 / pow(var_x392, 2) + 0.036429872495446269 * var_x393 * (-var_chaste_interface__T_type_Ca_channel_b_gate__b + 1 / var_x392) / (pow(var_x394, 2) * pow((0.60655737704918045 + var_x395), 2));
        IJth(rJacobian, 8, 0) = (-var_chaste_interface__T_type_Ca_channel_g_gate__g + 1 / var_x398) * ((var_x399) ? (0.006076388888888889 / pow((1 - 0.072916666666666671 * var_chaste_interface__cell__V), 2)) : (0)) - 0.17857142857142858 * var_x397 * var_x400 / pow(var_x398, 2);
        IJth(rJacobian, 9, 0) = (-var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr + 1 / var_x402) * ((var_x411) ? (var_x409 + 0.00030499999842881236 * var_x403 + 0.00030500000157118761 * var_x404) : ((var_x418) ? (var_x417 + 0.00068999999999999997 * var_x412 + 0.00068999999999999997 * var_x413) : (var_x409 + var_x417))) + 0.13333333333333333 * var_x401 * var_x423 / pow(var_x402, 2);
        IJth(rJacobian, 10, 0) = var_x446 * var_x447 + (var_x426 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1) * ((var_x432) ? (6.5500000000000006e-5 * var_x427 + 6.5500000000000006e-5 * var_x428 + 3.595e-5 * var_x429 + 3.595e-5 * var_x430) : (var_x436 + var_x440 - 8.9997000000000013e-6 * var_x441 - 1.0641199999999999e-5 * var_x442));
        IJth(rJacobian, 11, 0) = var_x447 * var_x450 + (var_x426 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2) * ((var_x432) ? (1.6375000000000002e-5 * var_x427 + 1.6375000000000002e-5 * var_x428 + 8.9874999999999999e-6 * var_x429 + 8.9874999999999999e-6 * var_x430) : (var_x448 + var_x449 - 2.2499250000000003e-6 * var_x441 - 2.6602999999999998e-6 * var_x442));
        IJth(rJacobian, 12, 0) = var_x460 * (var_x461 * var_x462 - var_x461 * var_x464 + 0.10000000000000001 * var_x454 * (var_x464 + var_x465 - var_x462 - var_x463) / pow((var_x454 + var_x458), 2)) + (-var_chaste_interface__transient_outward_current_zdv_gate__zdv + var_x455 * var_x461) * (var_x462 + var_x463 - var_x464 - var_x465);
        IJth(rJacobian, 13, 0) = var_x475 * (-var_x476 * var_x479 + 1.4999999999999998 * var_x469 * (var_x478 + var_x479 - var_x477) / pow((var_x473 + 0.14999999999999999 * var_x469), 2)) + (-var_chaste_interface__transient_outward_current_ydv_gate__ydv + var_x470 * var_x476) * (var_x477 - var_x478 - var_x479);
        IJth(rJacobian, 14, 0) = var_x263 * var_x484;
        IJth(rJacobian, 19, 0) = ((var_x498) ? (-var_x258 * (var_x256 + var_x86 * var_x97)) : ((var_x497) ? (-var_x258 * (var_x256 + var_x104 * var_x489 + var_x107 * var_x489 - var_x108 * var_x489)) : (0)));
        IJth(rJacobian, 23, 0) = -var_x507 * (0.0040000000000000001 + var_x40 + var_x66 + var_x87 + 3.0 * var_x133 + 6.75 * var_x505 + 0.11230765052340785 * var_x151 - 0.095461502944896678 * var_x255);
        IJth(rJacobian, 24, 0) = -var_x507 * (var_x117 + var_x118 + var_x131 + var_x145 + var_x156 + var_x3 + var_x33 + var_x5 + var_x51 + var_x511 + var_x55 + var_x69 + var_x91 - var_x148 - var_x149 - 4.5 * var_x505);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x163 + var_x177 + var_x185 + var_x191 + var_x199 - var_x159 - var_x160 - var_x166 - var_x172 - var_x176 - var_x206 - var_x212 + 0.0001 * var_x208);
        IJth(rJacobian, 1, 1) = var_x279 * (-var_x282 - var_x287 + 0.081176470588235281 * var_x284 - var_x258 * (var_x206 + var_x283 - var_x199) - var_x275 * var_x288) + (0.00023800000000000004 / pow(var_x276, 3) + 7.0000000000000007e-5 / pow(var_x157, 3)) * (var_x264 * var_x287 + var_x291 * var_chaste_interface__calcium_dynamics__Ca_NSR - var_x258 * (var_x289 + 0.003016 * var_chaste_interface__cell__V - 2.0 * var_x255 + var_x219 * var_chaste_interface__L_type_Ca_channel_d_gate__d) - var_x282 * var_chaste_interface__calcium_dynamics__Cai) / pow(var_x277, 2);
        IJth(rJacobian, 14, 1) = var_x487 * (var_x486 + var_x288 * var_x483);
        IJth(rJacobian, 15, 1) = var_x281 - var_x284;
        IJth(rJacobian, 19, 1) = ((var_x498) ? (-var_x258 * (var_x283 + var_x203 * var_x86 - var_x190 * var_x196)) : ((var_x497) ? (-var_x258 * (var_x283 + var_x204 * var_x489 - 8.6688029286008046 * var_x183 * var_x500)) : (0)));
        IJth(rJacobian, 23, 1) = -var_x507 * (var_x176 - var_x185 - 3.0 * var_x177 - 0.00030000000000000003 * var_x208);
        IJth(rJacobian, 24, 1) = -var_x507 * (var_x172 + var_x212 - var_x191);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x216);
        IJth(rJacobian, 2, 2) = -((var_x310) ? (-var_x316 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__cell__V) * (var_x316 + 3.1999999919207769e-7 * var_x307)) : (var_x309 * var_x314)) - 0.080000000000000002 * var_x315;
        IJth(rJacobian, 23, 2) = -var_x216 * var_x508;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x217);
        IJth(rJacobian, 3, 3) = -var_x320 - var_x326;
        IJth(rJacobian, 23, 3) = -var_x217 * var_x507;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x218);
        IJth(rJacobian, 4, 4) = -var_x342 - var_x352;
        IJth(rJacobian, 23, 4) = -var_x218 * var_x507;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x219 - var_x182 * var_x84 - var_x189 * var_x85);
        IJth(rJacobian, 1, 5) = var_x279 * (-var_x266 * var_x292 - var_x293 * var_x294);
        IJth(rJacobian, 5, 5) = var_x360 * var_x375 - var_x359 * var_x375;
        IJth(rJacobian, 14, 5) = var_x294 * var_x488;
        IJth(rJacobian, 19, 5) = ((var_x498) ? (-var_x196 * var_x292 * var_chaste_interface__L_type_Ca_channel_f_gate__f) : ((var_x497) ? (-var_x500 * var_x501 * var_x83) : (0)));
        IJth(rJacobian, 23, 5) = -var_x182 * var_x509;
        IJth(rJacobian, 24, 5) = -var_x189 * var_x509 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x181 * var_x220 - var_x189 * var_x220 - var_x198 * var_x220);
        IJth(rJacobian, 1, 6) = var_x279 * (-var_x198 * var_x295 - var_x293 * var_x296);
        IJth(rJacobian, 6, 6) = var_x385 * var_x388 + var_x385 * var_x390;
        IJth(rJacobian, 14, 6) = var_x296 * var_x488;
        IJth(rJacobian, 19, 6) = ((var_x498) ? (-var_x196 * var_x295) : ((var_x497) ? (-var_x260 * var_x499 * var_x501) : (0)));
        IJth(rJacobian, 23, 6) = -var_x181 * var_x510;
        IJth(rJacobian, 24, 6) = -var_x189 * var_x510;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.10000000000000001 * var_x223);
        IJth(rJacobian, 1, 7) = var_x279 * (var_x297 - 0.1176470588235294 * var_x298);
        IJth(rJacobian, 7, 7) = -var_x396;
        IJth(rJacobian, 14, 7) = 16.666666666666668 * var_x298 * var_x482;
        IJth(rJacobian, 19, 7) = ((var_x502) ? (var_x297) : (0));
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x222 * var_x42);
        IJth(rJacobian, 1, 8) = var_x279 * (var_x300 - 0.058823529411764698 * var_x301);
        IJth(rJacobian, 8, 8) = -var_x400;
        IJth(rJacobian, 14, 8) = 8.3333333333333339 * var_x301 * var_x482;
        IJth(rJacobian, 19, 8) = ((var_x502) ? (var_x300) : (0));
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x116 * var_x224);
        IJth(rJacobian, 9, 9) = -var_x423;
        IJth(rJacobian, 24, 9) = -8.3152324727908455e-5 * var_x115 * var_x224 * var_x506;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x210 * var_x62);
        IJth(rJacobian, 10, 10) = -var_x446;
        IJth(rJacobian, 24, 10) = -var_x210 * var_x491 * var_x507;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x225 * var_x60);
        IJth(rJacobian, 11, 11) = -var_x450;
        IJth(rJacobian, 24, 11) = -var_x225 * var_x490 * var_x507;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x226);
        IJth(rJacobian, 12, 12) = -var_x455 - var_x459;
        IJth(rJacobian, 24, 12) = -var_x226 * var_x508;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x227);
        IJth(rJacobian, 13, 13) = -var_x470 - var_x474;
        IJth(rJacobian, 24, 13) = -var_x227 * var_x507;
        IJth(rJacobian, 1, 14) = var_x278 * var_x287;
        IJth(rJacobian, 14, 14) = var_x487 * (-0.0055555555555555558 - var_x486) + 0.25 * (0.0055555555555555558 * var_chaste_interface__calcium_dynamics__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__calcium_dynamics__Ca_JSR - var_x264 * var_x486) / (pow(var_x480, 3) * pow((0.125 + var_x481), 2));
        IJth(rJacobian, 15, 14) = 0.00048309178743961351;
        IJth(rJacobian, 1, 15) = var_x278 * var_x291;
        IJth(rJacobian, 14, 15) = 0.0055555555555555558 * var_x482;
        IJth(rJacobian, 15, 15) = -0.00048309178743961351 - 0.066666666666666666 * var_x290;
        IJth(rJacobian, 16, 16) = (((((var_x98) || (var_x16 >= 2.6712338705498262e-6) || (var_x493 + var_x495 < -150.0))) && (((var_x16 >= 1.3356169352749131e-6) || (var_x492 + var_x495 + var_x86 * (var_x193 + var_x195 * (var_x193 + var_x194)) < -150.0))) && (((var_x17) || (var_x98) || (var_x493 + var_x170 * var_x31 + var_x175 * var_x31 + var_x180 * var_x489 + var_x188 * var_x489 < -150.0)))) ? (-100.5) : (-0.5));
        IJth(rJacobian, 1, 17) = var_x279 * (var_x286 * var_x303 - var_x286 * var_x304);
        IJth(rJacobian, 14, 17) = var_x487 * (var_x304 * var_x485 - var_x303 * var_x485);
        IJth(rJacobian, 17, 17) = ((var_x496) ? (-100.5) : (-0.5));
        IJth(rJacobian, 18, 18) = ((var_x496) ? (-100.5) : (-0.01));
        IJth(rJacobian, 19, 19) = (((((var_x497) || (var_x503))) && (((var_x497) || (var_x503) || (var_x98)))) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 21, 21) = (((var_x504) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50.0) : (-0.5));
        IJth(rJacobian, 22, 22) = (((var_x504) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50.0) : (-0.01));
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (var_x233 - var_x228 - var_x235 - var_x237 - var_x240 - 3 * var_x242 + 0.00030000000000000003 * var_x243 + 0.48963716847178318 * var_x236 - 0.044999999999999998 * var_x239);
        IJth(rJacobian, 1, 23) = var_x279 * (var_x305 - var_x275 * var_x306);
        IJth(rJacobian, 14, 23) = var_x306 * var_x484;
        IJth(rJacobian, 19, 23) = ((var_x502) ? (var_x305) : (0));
        IJth(rJacobian, 23, 23) = -var_x507 * (var_x228 + var_x232 + var_x235 + var_x240 + 9.0 * var_x242 + 0.13500000000000001 * var_x239 - 0.00090000000000000008 * var_x243);
        IJth(rJacobian, 24, 23) = -var_x507 * (var_x237 + 0.48963716847178318 * var_x512 - 0.089999999999999997 * var_x239);
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (var_x233 + var_x254 - var_x244 - var_x245 - var_x246 - var_x248 - var_x249 - var_x250 - var_x251 - var_x253 + 26.712338705498265 * var_x236);
        IJth(rJacobian, 24, 24) = -var_x507 * (var_x232 + var_x244 + var_x245 + var_x246 + var_x248 + var_x249 + var_x250 + var_x251 + var_x253 - var_x254 + 26.712338705498265 * var_x512);
    }
