...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellcorrias_purkinje_2011FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Time__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 17, 0) = (-var_chaste_interface__y_kr__y_kr + 1 / var_x154) * (((var_x158) ? (3.049999996072031e-5 * var_x155 + 3.0500000039279689e-5 * var_x156) : (var_x161 - 8.8449999999999992e-6 * var_x157 * var_x159 / pow(var_x160, 2))) + ((var_x165) ? (0.00068999999999999997 * var_x162 + 0.00068999999999999997 * var_x163) : (var_x168 - 0.00016973999999999998 * var_x164 * var_x166 / pow(var_x167, 2)))) + 0.13333333333333333 * var_x153 * (var_x170 + var_x172) / pow(var_x154, 2);
