...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellcorrias_purkinje_2011FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Time__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x177 = var_x168 * var_x176 / pow(var_x169, 2);
        const double var_x178 = var_x172 * var_x176 / pow(var_x173, 2);
        const double var_x179 = var_x171 * var_x176;
        const double var_x180 = var_x175 * var_x176;
        const double var_x181 = 0.059880239520958084 * var_x165 / pow(var_x166, 2);
        ...
        const double var_x186 = exp(10.9 + var_x11);
        ...
        const double var_x191 = 1.8333333333333333e-5 * var_x189 - 6.6666666666666666e-6 * var_x190;
        const double var_x192 = 0.00016666666666666666 * var_x189;
        const double var_x193 = 0.00016666666666666666 * var_x190;
        const double var_x194 = -0.10000000000000001 * var_x186 * (var_x192 + var_x193) / pow(var_x187, 2);
        ...
        IJth(rJacobian, 18, 0) = var_x181 * (var_x179 + var_x180) + (var_x167 - var_chaste_interface__x_ks__x_ks) * (var_x171 + var_x175 - 8.9997000000000013e-6 * var_x177 - 1.0641199999999999e-5 * var_x178);
        IJth(rJacobian, 19, 0) = var_x181 * (var_x184 + var_x185) + (var_x167 - var_chaste_interface__y_ks__y_ks) * (var_x182 + var_x183 - 2.2499250000000003e-6 * var_x177 - 2.6602999999999998e-6 * var_x178);
        IJth(rJacobian, 20, 0) = var_x194 + var_x191 * (var_x188 - var_chaste_interface__y_gate_f_k__y_gate_f_k);
        IJth(rJacobian, 21, 0) = var_x194 + var_x191 * (var_x188 - var_chaste_interface__y_gate_f_na__y_gate_f_na);
