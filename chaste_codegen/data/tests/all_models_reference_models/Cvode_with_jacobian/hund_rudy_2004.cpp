...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhund_rudy_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x26 = var_x16 * NV_Ith_S(mParameters, 9) / var_x25;
        ...
        const double var_x49 = -var_x28 * NV_Ith_S(mParameters, 6) + var_chaste_interface__Cl__Cl_i;
        const double var_x50 = 1 / (1.0 - var_x31);
        const double var_x51 = -var_x31 * NV_Ith_S(mParameters, 6) + var_chaste_interface__Cl__Cl_i;
        ...
        const double var_x55 = var_x54 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x63 = pow(var_chaste_interface__INal__mL, 3) * NV_Ith_S(mParameters, 14);
        const double var_x64 = var_x63 * var_chaste_interface__INal__hL;
        const double var_x65 = 1 / var_chaste_interface__K__K_i;
        const double var_x66 = log(var_x65 * NV_Ith_S(mParameters, 7));
        ...
        const double var_x75 = NV_Ith_S(mParameters, 16) * var_chaste_interface__IKs__xs2;
        ...
        const double var_x79 = var_x78 * NV_Ith_S(mParameters, 10) * var_chaste_interface__INa__J;
        ...
        const double var_x83 = sqrt(NV_Ith_S(mParameters, 7));
        const double var_x84 = var_x83 * NV_Ith_S(mParameters, 15) / var_x82;
        ...
        const double var_x96 = var_x83 * NV_Ith_S(mParameters, 13) / (var_x95 + 1.02 * var_x88);
        ...
        const double var_x100 = var_x98 * var_x99 * NV_Ith_S(mParameters, 18) * var_chaste_interface__Ito__zdv;
        ...
        const double var_x116 = (1.0 + 416.66666666666669 * var_chaste_interface__Ca__Ca_i) * NV_Ith_S(mParameters, 5);
        ...
        const double var_x118 = var_x112 * var_x117 * NV_Ith_S(mParameters, 17);
        ...
        const double var_x124 = exp(0.01485884101040119 * NV_Ith_S(mParameters, 8));
        ...
        const double var_x127 = NV_Ith_S(mParameters, 7) / (1.5 + NV_Ith_S(mParameters, 7));
        ...
        const double var_x133 = var_x132 * var_x81 * NV_Ith_S(mParameters, 15) * var_chaste_interface__IKr__xr / pow(var_x82, 2);
        ...
        const double var_x136 = var_x132 * var_x88 * NV_Ith_S(mParameters, 13) / pow((var_x88 + 0.98039215686274506 * var_x95), 2);
        ...
        const double var_x148 = -1004882.8125 - var_x113 - 775361.25000000012 * NV_Ith_S(mParameters, 5);
        const double var_x149 = var_x110 * var_x138 * NV_Ith_S(mParameters, 17);
        ...
        const double var_x154 = -26.712338705500134 * log(var_x153 * (0.018329999999999999 * NV_Ith_S(mParameters, 8) + NV_Ith_S(mParameters, 7))) + var_chaste_interface__cell__V;
        ...
        const double var_x158 = log(var_x157 * NV_Ith_S(mParameters, 8));
        const double var_x159 = -26.712338705500134 * var_x158 + var_chaste_interface__cell__V;
        const double var_x160 = var_x159 * var_x79;
        const double var_x161 = var_x159 * NV_Ith_S(mParameters, 10) * var_chaste_interface__INa__H;
        ...
        const double var_x184 = var_x155 * NV_Ith_S(mParameters, 16);
        const double var_x185 = var_x68 * var_x99 * NV_Ith_S(mParameters, 18) * var_chaste_interface__Ito__ydv2;
        ...
        const double var_x190 = var_x189 * var_x49;
        const double var_x191 = 3.8594000000000001e-9 * var_x50;
        const double var_x192 = ((var_x52) ? (var_x190 - 187179.41753899999 * (-2.6712338705500134e-6 + var_chaste_interface__cell__V) * (-var_x190 - var_x191 * var_x51)) : (var_x60 * var_chaste_interface__cell__V));
        const double var_x193 = var_x159 * pow(var_chaste_interface__INal__mL, 2) * NV_Ith_S(mParameters, 14) * var_chaste_interface__INal__hL;
        const double var_x194 = var_x159 * var_x63;
        const double var_x195 = var_x157 * var_x64;
        const double var_x196 = var_x153 * var_x77;
        const double var_x197 = var_x157 * var_x80;
        const double var_x198 = var_x127 / (var_x103 * var_x126 * pow((0.01 + var_x122), 2));
        const double var_x199 = var_x121 * NV_Ith_S(mParameters, 5);
        ...
        const double var_x232 = (1.0 + 0.75 * var_x229) * NV_Ith_S(mParameters, 3);
        ...
        const double var_x240 = NV_Ith_S(mParameters, 3) * NV_Ith_S(mParameters, 0);
        ...
        const double var_x244 = var_x226 / pow(var_x227, 2);
        const double var_x245 = var_x244 * (-1 + var_x225);
        const double var_x246 = var_x231 * var_chaste_interface__Ca__Ca_i * NV_Ith_S(mParameters, 3);
        const double var_x247 = var_x246 * (0.75 * var_x243 + 0.75 * var_x245);
        ...
        const double var_x250 = var_x221 * var_x249 / pow(var_x223, 2);
        const double var_x251 = var_x228 * var_x250;
        const double var_x252 = var_x244 * var_x250;
        const double var_x253 = var_x246 * (5.6250000000000005e-5 * var_x251 - 5.6250000000000005e-5 * var_x252);
        ...
        const double var_x256 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 12) - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x257 = ((var_x255) ? (0) : (0.13500000000000001 * var_x256));
        const double var_x258 = var_x257;
        const double var_x259 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 12) - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x260 = 1.0 + var_x259;
        const double var_x261 = exp(0.34999999999999998 * var_chaste_interface__cell__V - 0.34999999999999998 * NV_Ith_S(mParameters, 12));
        const double var_x262 = exp(0.079000000000000001 * var_chaste_interface__cell__V - 0.079000000000000001 * NV_Ith_S(mParameters, 12));
        ...
        const double var_x265 = ((var_x255) ? (0) : (-0.019852941176470591 * var_x256));
        const double var_x266 = var_x257 + var_x263;
        const double var_x267 = 0.01 * NV_Ith_S(mParameters, 11);
        const double var_x268 = 1.0 - var_x267;
        const double var_x269 = var_x268 / var_x266;
        const double var_x270 = ((var_x255) ? (0.693000693000693 * var_x259 / pow(var_x260, 2)) : (0.28123999999999999 * var_x262 + 108500.0 * var_x261));
        ...
        const double var_x279 = ((var_x274) ? (0.15999999943156581 * var_x271 + 0.16000000056843419 * var_x272) : (var_x278 - 0.032000000000000001 * var_x273 * var_x276 / pow(var_x277, 2)));
        const double var_x280 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x281 = 0.0072727272727272727 * var_x280;
        ...
        const double var_x285 = exp(0.24440000000000001 * var_chaste_interface__cell__V - 0.24440000000000001 * NV_Ith_S(mParameters, 12));
        const double var_x286 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 12) - 0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x287 = -127140.0 * var_x285 - 3.4740000000000003e-5 * var_x286;
        const double var_x288 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V - 0.311 * NV_Ith_S(mParameters, 12));
        ...
        const double var_x294 = exp(-3.2000000000000002 + var_x275 + 0.10000000000000001 * NV_Ith_S(mParameters, 12));
        const double var_x295 = 1.0 + var_x294;
        const double var_x296 = exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 12) - 2.5349999999999999e-7 * var_chaste_interface__cell__V);
        const double var_x297 = var_x296 / var_x295;
        const double var_x298 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 12) - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x299 = 1.0 + var_x298;
        const double var_x300 = exp(0.01052 * NV_Ith_S(mParameters, 12) - 0.01052 * var_chaste_interface__cell__V);
        ...
        const double var_x304 = ((var_x255) ? (0) : (var_x291 + var_x284 * var_x290 * (1.5254334000000001e-6 * var_x286 - 31073.016 * var_x285) - 0.311 * var_x284 * var_x287 * var_x288 / pow(var_x289, 2)));
        const double var_x305 = var_x292 + var_x302;
        const double var_x306 = var_x268 / var_x305;
        const double var_x307 = ((var_x255) ? (-7.6049999999999996e-8 * var_x297 + 0.029999999999999999 * var_x294 * var_x296 / pow(var_x295, 2)) : (-0.001275024 * var_x301 + 0.016701360000000002 * var_x298 * var_x300 / pow(var_x299, 2)));
        ...
        const double var_x312 = exp(0.59347181008902072 - 0.14836795252225518 * var_chaste_interface__cell__V);
        const double var_x313 = 1.0 + var_x312;
        const double var_x314 = 1 / (0.58999999999999997 + 0.80000000000000004 * var_x311);
        const double var_x315 = exp(-19.117647058823529 - 0.29411764705882354 * var_chaste_interface__cell__V);
        const double var_x316 = exp(2.4457142857142857 + 0.14285714285714285 * var_chaste_interface__cell__V);
        ...
        const double var_x320 = var_x316 / pow(var_x317, 2);
        ...
        const double var_x327 = var_x323 * var_x326;
        const double var_x328 = -10.0 * var_x243 - 10.0 * var_x245;
        const double var_x329 = 0.01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x321 + 0.29999999999999999 / (1.0 - 20.0 * var_x324)) / pow((0.050000000000000003 + var_x229 + 0.10000000000000001 * var_x321), 2);
        const double var_x330 = pow((0.0030000000000000001 + var_chaste_interface__Ca__Ca_ss), (-2));
        const double var_x331 = 0.00075000000000000002 * var_x252 - 0.00075000000000000002 * var_x251;
        ...
        const double var_x340 = exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__cell__V);
        ...
        const double var_x348 = var_x346 - 8.1600000000000005e-5 * var_x344 * var_x347 / pow(var_x345, 2);
        ...
        const double var_x356 = var_x355 - 4.566e-5 * var_x349 * var_x353 / pow(var_x354, 2);
        ...
        const double var_x363 = exp(0.4251012145748988 - 0.04048582995951417 * var_chaste_interface__cell__V);
        ...
        const double var_x372 = var_x370 - 0.00075871700000000012 * var_x368 * var_x371 / pow(var_x369, 2);
        ...
        const double var_x380 = var_x379 - 4.6080000000000006e-5 * var_x373 * var_x377 / pow(var_x378, 2);
        const double var_x381 = fabs(var_x371) < 1.0030088759549471e-8;
        const double var_x382 = ((var_x374) ? (var_x372 + 0.00018000000000000001 * var_x366 + 0.00018000000000000001 * var_x367) : ((var_x381) ? (var_x380 + 3.8049986522476652e-5 * var_x375 + 3.8050013477523354e-5 * var_x376) : (var_x372 + var_x380)));
        ...
        const double var_x388 = var_x363 * var_x387 / pow(var_x364, 2);
        ...
        const double var_x393 = 1.0 - var_chaste_interface__Ito__ydv;
        ...
        const double var_x397 = var_chaste_interface__Ito__ydv;
        const double var_x398 = 0.040000000000000001 * var_chaste_interface__Ito__ydv2;
        ...
        const double var_x402 = pow(var_x400, 2) / pow(var_x401, 2);
        const double var_x403 = var_x400 / var_x401;
        const double var_x404 = exp(12.0 + var_x399);
        const double var_x405 = 1.0 + var_x404;
        const double var_x406 = var_x404 / pow(var_x405, 2);
        const double var_x407 = 1 / var_x405;
        const double var_x408 = 0.02 * var_chaste_interface__Ito__zdv;
        const double var_x409 = exp(14.918032786885247 + 0.16393442622950821 * var_chaste_interface__cell__V);
        const double var_x410 = 0.0025000000000000005 * var_x224;
        const double var_x411 = -var_x165 + 5.1546800034037841e-8 * var_x7;
        const double var_x412 = pow(var_chaste_interface__ICaL__d, (-2 * var_chaste_interface__ICaL__dp));
        const double var_x413 = pow(var_chaste_interface__ICaL__f2, (-2));
        const double var_x414 = pow(var_chaste_interface__ICaL__fca, (-2));
        const double var_x415 = pow(var_chaste_interface__ICaL__fca2, (-2));
        const double var_x416 = var_x412 * var_x413 * var_x414 * var_x415;
        const double var_x417 = pow(var_chaste_interface__ICaL__f, (-2));
        const double var_x418 = 7.1354903911398109e-12 * var_x417;
        const double var_x419 = var_x416 * var_x418 / pow(var_x411, 3);
        const double var_x420 = -1 + 0.066666666666666666 * var_chaste_interface__cell__V;
        const double var_x421 = pow(var_x16, (-2));
        const double var_x422 = pow(NV_Ith_S(mParameters, 9), (-2));
        const double var_x423 = var_x416 * var_x417;
        const double var_x424 = var_x421 * var_x422 * var_x423;
        const double var_x425 = pow(var_x420, (-2));
        const double var_x426 = var_x15 * var_x425;
        const double var_x427 = 3.1882311526515621e-12 * var_x426;
        const double var_x428 = var_x25 * var_x422 * var_x423 / pow(var_x16, 3);
        const double var_x429 = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999);
        const double var_x430 = var_chaste_interface__Ca__Ca_ss + NV_Ith_S(mParameters, 2);
        const double var_x431 = 1 / var_x430;
        const double var_x432 = pow((var_x431 * var_chaste_interface__Ca__Ca_ss), 1.8999999999999999);
        const double var_x433 = 1 / (var_x429 + 1644.6531773416521 * var_x432);
        const double var_x434 = pow(var_x411, (-2));
        const double var_x435 = var_x416 * var_x434;
        const double var_x436 = var_x25 * var_x421 * var_x422 * var_x425;
        const double var_x437 = var_x423 * var_x436;
        const double var_x438 = 1.0 + ((var_x13) ? (var_x418 * var_x435) : (2.1291277605263905e-11 * var_x437));
        const double var_x439 = 0.33333333333333331 * var_x429 * var_x433 / pow(var_x438, 2);
        const double var_x440 = 1.4270980782279622e-11 * var_x435;
        const double var_x441 = var_x417 * var_x440;
        const double var_x442 = 4.258255521052781e-11 * var_x437;
        const double var_x443 = pow(var_chaste_interface__ICaL__f, (-3));
        const double var_x444 = 4.258255521052781e-11 * var_x436;
        const double var_x445 = var_x412 * var_x413 * var_x417;
        const double var_x446 = 1.4270980782279622e-11 * var_x434 * var_x445;
        const double var_x447 = var_x415 / pow(var_chaste_interface__ICaL__fca, 3);
        const double var_x448 = var_x444 * var_x445;
        const double var_x449 = var_x414 / pow(var_chaste_interface__ICaL__fca2, 3);
        const double var_x450 = var_x412 * var_x414 * var_x415 * var_x417 / pow(var_chaste_interface__ICaL__f2, 3);
        const double var_x451 = 1 / var_x438;
        const double var_x452 = var_x451 / pow((var_x432 + 0.00060803092942449902 * var_x429), 2);
        ...
        const double var_x456 = var_x27 * var_x455;
        ...
        const double var_x468 = (-var_chaste_interface__Irel__ri + 1 / var_x459) / pow((0.29999999999999999 + var_x229 + 0.10000000000000001 * var_x464), 2);
        ...
        const double var_x474 = var_x215 * var_x455;
        const double var_x475 = 1.827729786302835e-16 * var_x150;
        const double var_x476 = 6.1520742882368733e-5 * NV_Ith_S(mParameters, 4);
        const double var_x477 = 0.0001845622286471062 * NV_Ith_S(mParameters, 4);
        const double var_x478 = log(var_x210 * NV_Ith_S(mParameters, 6));
        ...
        const double var_x500 = 216.34953105810169 * var_x22;
        ...
        const double var_x504 = NV_Ith_S(mParameters, 1) * var_chaste_interface__Irel__ri * var_chaste_interface__Irel__ro;
        const double var_x505 = var_x504 * ((var_x13) ? (-var_x497 * (1444.8004871392482 * var_x4 + 1444.8004890608181 * var_x7)) : (-var_x503 * (var_x499 + var_x21 * var_x500 - var_x26 * var_x500)));
        const double var_x506 = -var_chaste_interface__Ca__Ca_jsr + var_chaste_interface__Ca__Ca_ss;
        ...
        const double var_x515 = var_x513 * var_chaste_interface__Irel__ro;
        ...
        const double var_x525 = 0.0010458526290002684 * var_x523;
        const double var_x526 = var_x519 * var_x524;
        const double var_x527 = 0.23999999999999996 * var_x516;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00022499999999999999 + var_x77 - var_x101 - var_x27 - var_x44 - var_x62 - var_x64 - var_x80 + 0.10468673984798647 * var_x131 + 0.027943602786489299 * var_x133 - var_x120 - 0.61875000000000002 * var_x128 - 0.0027599999999999999 * var_x47 - 0.0065699975556189009 * var_x139 - 0.0033333333333333335 * var_x140 - 0.4389381125701739 * var_x97 - 0.00046153846153846147 * var_x69 - var_x135 * var_x137 - var_x85 * var_chaste_interface__IKr__xr);
        IJth(rJacobian, 1, 0) = var_x219 * (6.1520742882368733e-5 * var_x120 + 4.0419113035702141e-7 * var_x139 - 3.0760371441184366e-5 * var_x44);
        IJth(rJacobian, 2, 0) = (var_x258 + var_x264) * (var_x265 * var_x269 + var_x257 * var_x268 * (-var_x265 - var_x270) / pow(var_x266, 2)) + (var_x265 + var_x270) * (var_x267 - var_chaste_interface__INa__H + var_x257 * var_x269);
        IJth(rJacobian, 3, 0) = var_x279 * (1.0 - var_chaste_interface__INa__m) + var_x281 * var_chaste_interface__INa__m;
        IJth(rJacobian, 4, 0) = (var_x293 + var_x303) * (var_x304 * var_x306 + var_x268 * var_x292 * (-var_x304 - var_x307) / pow(var_x305, 2)) + (var_x304 + var_x307) * (var_x267 - var_chaste_interface__INa__J + var_x292 * var_x306);
        IJth(rJacobian, 5, 0) = 1.5624999999999998 * (-var_chaste_interface__ICaL__d + 1 / var_x313) * (-0.041599999999999998 * var_x311 + 0.10560000000000001 * var_x308 * var_x310 / pow(var_x309, 2)) / pow((0.73749999999999993 + var_x311), 2) + 0.14836795252225518 * var_x312 * var_x314 / pow(var_x313, 2);
        IJth(rJacobian, 6, 0) = -0.23529411764705882 * var_x315 / pow((1.0 + var_x315), 2);
        IJth(rJacobian, 7, 0) = -0.099999999999999992 * var_x320 * (0.052900000000000003 + var_x319) + var_x319 * (0.039250169999999994 - 0.0040499999999999998 * var_chaste_interface__cell__V) * (0.29999999999999999 - var_chaste_interface__ICaL__f + 0.69999999999999996 * var_x318);
        IJth(rJacobian, 8, 0) = var_x27 * var_x327;
        IJth(rJacobian, 9, 0) = var_x27 * var_x337 - var_x27 * var_x338;
        IJth(rJacobian, 10, 0) = -0.11 * var_x320 * (0.0054000000000000003 + var_x339) + var_x339 * (0.12930244120000001 - 0.0069619999999999994 * var_chaste_interface__cell__V) * (0.23000000000000001 - var_chaste_interface__ICaL__f2 + 0.77000000000000002 * var_x318);
        IJth(rJacobian, 11, 0) = (-var_chaste_interface__IKr__xr + 1 / var_x341) * ((var_x350) ? (var_x348 + 0.00014999999999999999 * var_x342 + 0.00014999999999999999 * var_x343) : ((var_x357) ? (var_x356 + 0.00029999999995470287 * var_x351 + 0.00030000000004529707 * var_x352) : (var_x348 + var_x356))) + 0.23529411764705882 * var_x340 * var_x362 / pow(var_x341, 2);
        IJth(rJacobian, 12, 0) = 0.04048582995951417 * var_x388 + var_x382 * (-var_chaste_interface__IKs__xs1 + var_x365);
        IJth(rJacobian, 13, 0) = 0.020242914979757085 * var_x388 + var_x382 * (0.5 * var_x365 - 0.5 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 14, 0) = var_x392 * var_x393 + var_x396 * var_x397 - var_x393 * pow(var_x390, 2) / pow(var_x391, 2) - var_x397 * pow(var_x394, 2) / pow(var_x395, 2);
        IJth(rJacobian, 15, 0) = var_x398 * var_x402 - var_x398 * var_x403 - 0.0060000000000000001 * var_x406 * (1.0 - var_chaste_interface__Ito__ydv2);
        IJth(rJacobian, 16, 0) = var_x402 * var_x408 - var_x403 * var_x408 - 0.00044999999999999999 * var_x406 * (1.0 - var_chaste_interface__Ito__zdv);
        IJth(rJacobian, 18, 0) = var_x279 * (1.0 - var_chaste_interface__INal__mL) + var_x281 * var_chaste_interface__INal__mL;
        IJth(rJacobian, 19, 0) = -0.00027322404371584699 * var_x409 / pow((1.0 + var_x409), 2);
        IJth(rJacobian, 21, 0) = -var_x439 * ((var_x13) ? (var_x419 * (-0.038593999974243801 * var_x4 - 0.038594000025573422 * var_x7)) : (var_x17 * var_x424 * var_x427 - var_x427 * var_x428 * var_chaste_interface__Ca__Ca_ss - 2.8388370140351874e-12 * var_x25 * var_x424 / pow(var_x420, 3)));
        IJth(rJacobian, 22, 0) = var_x456 * var_x467 - var_x456 * var_x470;
        IJth(rJacobian, 23, 0) = (-1.2125733910710643e-6 * var_x139 - 0.0001845622286471062 * var_x120 - 6.1520742882368733e-5 * var_x64 - 6.1520742882368733e-5 * var_x80 - 0.00011419787897539696 * var_x128) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 24, 0) = (var_x487 + 7.6131919316931303e-5 * var_x128 + 6.4404060053814002e-6 * var_x131 + 1.7191112022346505e-6 * var_x133 - 2.7003798764701889e-5 * var_x97 - 2.0506914294122911e-7 * var_x140 - 2.6474312514413617e-5 * var_x204 - 1.6979725035533768e-7 * var_x47 - 6.1520742882368733e-5 * var_x101 - 2.8394189022631718e-8 * var_x69 - var_x135 * var_x488) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 25, 0) = (1.3842167148532964e-8 + 6.1520742882368733e-5 * var_x62) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 26, 0) = var_x505 * var_x511;
        IJth(rJacobian, 28, 0) = var_x524 * (-0.0010458526290002684 * var_x27 + var_x505 * var_x519);
        ...
        IJth(rJacobian, 1, 1) = var_x219 * (-0.14705882352941174 + var_x236 - var_x220 - var_x234 + 8.544547622551213e-13 * var_x152 + 1.768721357868101e-6 * var_x146 - 9.2281114323553099e-5 * var_x238 - 3.0760371441184366e-5 * var_x142 + var_x148 * var_x237) + (0.00023800000000000004 / pow(var_x216, 3) + 7.0000000000000007e-5 / pow(var_x143, 3)) * (0.14705882352941174 * var_chaste_interface__Ca__Ca_ss - 3.0760371441184366e-5 * ((var_x35) ? (var_x239 - 374358.83507799997 * (-1.3356169352750067e-6 + var_chaste_interface__cell__V) * (-var_x239 - 3.8499135948000005e-9 * var_x33)) : (var_x42 * var_chaste_interface__cell__V)) - 0.14705882352941174 * var_chaste_interface__Ca__Ca_i + var_x241 * var_chaste_interface__Ca__Ca_nsr - var_x220 * var_chaste_interface__Ca__Ca_i - var_x234 * var_chaste_interface__Ca__Ca_i + 6.1520742882368733e-5 * var_x119 * var_x138) / pow(var_x217, 2);
        IJth(rJacobian, 23, 1) = (0.00027684334297065928 * var_x238 - 2.563364286765364e-12 * var_x152 - var_x148 * var_x475) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 24, 1) = -3.3496381359330236e-11 * var_x156 * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 27, 1) = var_x233 - var_x235;
        IJth(rJacobian, 28, 1) = 5.0 * var_x523;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x160);
        IJth(rJacobian, 2, 2) = -var_x258 - var_x264;
        IJth(rJacobian, 23, 2) = -var_x160 * var_x476;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x162);
        IJth(rJacobian, 3, 3) = var_x283;
        IJth(rJacobian, 23, 3) = -var_x162 * var_x477;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x163);
        IJth(rJacobian, 4, 4) = -var_x293 - var_x303;
        IJth(rJacobian, 23, 4) = -var_x163 * var_x476;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x172);
        IJth(rJacobian, 5, 5) = -var_x314;
        IJth(rJacobian, 8, 5) = var_x172 * var_x327;
        IJth(rJacobian, 9, 5) = var_x172 * var_x337 - var_x172 * var_x338;
        IJth(rJacobian, 21, 5) = -var_x439 * ((var_x13) ? (-var_x170 * var_x441) : (-var_x170 * var_x442));
        IJth(rJacobian, 22, 5) = var_x172 * var_x471 - var_x172 * var_x472;
        IJth(rJacobian, 28, 5) = -var_x172 * var_x525;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x174);
        IJth(rJacobian, 6, 6) = -0.10000000000000001;
        IJth(rJacobian, 8, 6) = var_x174 * var_x327;
        IJth(rJacobian, 9, 6) = var_x174 * var_x337 - var_x174 * var_x338;
        IJth(rJacobian, 21, 6) = -var_x439 * ((var_x13) ? (-var_x173 * var_x441) : (-var_x173 * var_x442));
        IJth(rJacobian, 22, 6) = var_x174 * var_x471 - var_x174 * var_x472;
        IJth(rJacobian, 28, 6) = -var_x174 * var_x525;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x177);
        IJth(rJacobian, 7, 7) = -0.052900000000000003 - var_x319;
        IJth(rJacobian, 8, 7) = var_x177 * var_x327;
        IJth(rJacobian, 9, 7) = var_x177 * var_x337 - var_x177 * var_x338;
        IJth(rJacobian, 21, 7) = -var_x439 * ((var_x13) ? (-var_x440 * var_x443) : (-var_x416 * var_x443 * var_x444));
        IJth(rJacobian, 22, 7) = var_x177 * var_x471 - var_x177 * var_x472;
        IJth(rJacobian, 28, 7) = -var_x177 * var_x525;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x178);
        IJth(rJacobian, 8, 8) = var_x323 * (-1 + var_x178 * var_x326);
        IJth(rJacobian, 9, 8) = var_x178 * var_x337 - var_x178 * var_x338;
        IJth(rJacobian, 21, 8) = -var_x439 * ((var_x13) ? (-var_x446 * var_x447) : (-var_x447 * var_x448));
        IJth(rJacobian, 22, 8) = var_x178 * var_x471 - var_x178 * var_x472;
        IJth(rJacobian, 28, 8) = -var_x178 * var_x525;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x182);
        IJth(rJacobian, 8, 9) = var_x182 * var_x327;
        IJth(rJacobian, 9, 9) = var_x335 * (-1 + var_x182 * var_x336) - var_x182 * var_x338;
        IJth(rJacobian, 21, 9) = -var_x439 * ((var_x13) ? (-var_x446 * var_x449) : (-var_x448 * var_x449));
        IJth(rJacobian, 22, 9) = var_x182 * var_x471 - var_x182 * var_x472;
        IJth(rJacobian, 28, 9) = -var_x182 * var_x525;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x183);
        IJth(rJacobian, 8, 10) = var_x183 * var_x327;
        IJth(rJacobian, 9, 10) = var_x183 * var_x337 - var_x183 * var_x338;
        IJth(rJacobian, 10, 10) = -0.0054000000000000003 - var_x339;
        IJth(rJacobian, 21, 10) = -var_x439 * ((var_x13) ? (-1.4270980782279622e-11 * var_x434 * var_x450) : (-var_x444 * var_x450));
        IJth(rJacobian, 22, 10) = var_x183 * var_x471 - var_x183 * var_x472;
        IJth(rJacobian, 28, 10) = -var_x183 * var_x525;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x68 * var_x85);
        IJth(rJacobian, 11, 11) = -var_x362;
        IJth(rJacobian, 24, 11) = -2.6474312514413617e-5 * var_x68 * var_x84 * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x154 * var_x76);
        IJth(rJacobian, 12, 12) = -var_x387;
        IJth(rJacobian, 24, 12) = var_x154 * var_x486 * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x184 * var_x74);
        IJth(rJacobian, 13, 13) = -0.5 * var_x387;
        IJth(rJacobian, 24, 13) = var_x184 * var_x485 * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x186);
        IJth(rJacobian, 14, 14) = -25.0 * var_x392 - 25.0 * var_x396;
        IJth(rJacobian, 24, 14) = -var_x186 * var_x477;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x187);
        IJth(rJacobian, 15, 15) = -0.029999999999999999 * var_x407 - 0.20000000000000001 * var_x403;
        IJth(rJacobian, 24, 15) = -var_x187 * var_x476;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x188);
        IJth(rJacobian, 16, 16) = -0.10000000000000001 * var_x403 - 0.0022499999999999998 * var_x407;
        IJth(rJacobian, 24, 16) = -var_x188 * var_x476;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x192);
        IJth(rJacobian, 17, 17) = -1.0;
        IJth(rJacobian, 25, 17) = var_x192 * var_x476;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x193);
        IJth(rJacobian, 18, 18) = var_x283;
        IJth(rJacobian, 23, 18) = -var_x193 * var_x477;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x194);
        IJth(rJacobian, 19, 19) = -0.0016666666666666668;
        IJth(rJacobian, 23, 19) = -var_x194 * var_x476;
        IJth(rJacobian, 1, 20) = var_x219 * (-0.081176470588235281 * var_x247 - var_x236 * var_x248);
        IJth(rJacobian, 8, 20) = var_x328 * var_x329;
        IJth(rJacobian, 20, 20) = -0.00068000000000000005 - var_x226 * var_x410 + var_x221 * var_x242 * var_x410;
        IJth(rJacobian, 22, 20) = var_x473 * (var_x328 - var_x328 * var_x462);
        IJth(rJacobian, 27, 20) = var_x247 + var_x235 * var_x248;
        IJth(rJacobian, 21, 21) = -0.33333333333333331;
        IJth(rJacobian, 26, 21) = var_x511 * var_x514;
        IJth(rJacobian, 28, 21) = var_x514 * var_x526;
        IJth(rJacobian, 22, 22) = -var_x465;
        IJth(rJacobian, 26, 22) = var_x511 * var_x515;
        IJth(rJacobian, 28, 22) = var_x515 * var_x526;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (0.48963716847181743 * var_x196 - 3.0 * var_x201 - 26.712338705500134 * var_x195 - 26.712338705500134 * var_x197 - 0.012375000000000001 * var_x198 - var_x151 * var_x200);
        IJth(rJacobian, 1, 23) = var_x219 * (0.0001845622286471062 * var_x201 + var_x200 * var_x237);
        IJth(rJacobian, 23, 23) = (var_x483 - 0.0016433629212878199 * var_x195 - 0.0016433629212878199 * var_x197 - 0.00055368668594131857 * var_x201 - 2.283957579507939e-6 * var_x198 - var_x200 * var_x475) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 24, 23) = (1.5226383863386261e-6 * var_x198 + 0.48963716847181743 * var_x489) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 25, 23) = var_x483 * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (26.712338705500134 * var_x196 + 2.7964276527939922 * var_x209 - 26.712338705500134 * var_x206 - 0.073726054827180365 * var_x202 - 11.725063533727431 * var_x203 - 11.495160327183756 * var_x205 - var_x137 * var_x208);
        IJth(rJacobian, 24, 24) = (var_x493 + 26.712338705500134 * var_x489 + 0.00017203830661668509 * var_x209 - 0.00070719080288027735 * var_x205 - 4.535681662754383e-6 * var_x202 - 0.0016433629212878199 * var_x206 - 0.00072133461893788295 * var_x203 - var_x208 * var_x488) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 25, 24) = var_x493 * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x211 + 0.00601027620873753 * var_x210);
        IJth(rJacobian, 23, 25) = var_x484 * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 24, 25) = var_x494 * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 25, 25) = (var_x484 + var_x494 + 6.1520742882368733e-5 * var_x211 - 3.6975665728975948e-7 * var_x210) * NV_Ith_S(mParameters, 4);
        IJth(rJacobian, 21, 26) = -2.3414435371998602e-7 * var_x452 * pow(var_chaste_interface__Ca__Ca_jsr, 2.7999999999999998) + 0.6333333333333333 * var_x433 * var_x451 * pow(var_chaste_interface__Ca__Ca_jsr, 0.89999999999999991);
        IJth(rJacobian, 26, 26) = var_x510 * (-0.0083333333333333332 - var_x516) + 0.25 * (-var_x517 + 0.0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0.0083333333333333332 * var_chaste_interface__Ca__Ca_jsr) / (pow(var_x507, 3) * pow((0.125 + var_x508), 2));
        IJth(rJacobian, 27, 26) = 0.00072463768115942019;
        IJth(rJacobian, 28, 26) = var_x523 * var_x527;
        IJth(rJacobian, 1, 27) = var_x218 * var_x241;
        IJth(rJacobian, 26, 27) = 0.0083333333333333332 * var_x509;
        IJth(rJacobian, 27, 27) = -0.00072463768115942019 - 0.066666666666666666 * var_x240;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x215);
        IJth(rJacobian, 1, 28) = var_x219 * (0.14705882352941174 - 0.081176470588235281 * var_x253 - var_x236 * var_x254);
        IJth(rJacobian, 8, 28) = var_x323 * (-0.0016500000000000002 * var_x330 + var_x215 * var_x326) + var_x329 * (var_x331 + 0.0030000000000000001 * var_x330);
        IJth(rJacobian, 9, 28) = var_x215 * var_x337 - var_x215 * var_x338;
        IJth(rJacobian, 17, 28) = 0.1502 * var_x249 / pow((1.0 + 0.1502 * var_x222), 2);
        IJth(rJacobian, 20, 28) = 3.7500000000000005e-6 * var_x226 * var_x250 + 1.8750000000000003e-7 * var_x249 * pow(var_x221, 2) / pow(var_x223, 3);
        IJth(rJacobian, 21, 28) = -var_x439 * ((var_x13) ? (var_x419 * (-1.0309360006807568e-7 * var_x212 - 2 * var_x214 * (15.000001335616936 - var_chaste_interface__cell__V))) : (-4.258255521052781e-11 * var_x426 * var_x428)) - 0.00020267697647483301 * var_x222 * var_x429 * var_x430 * var_x432 * var_x452 * (1.8999999999999999 * var_x431 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x430, 2));
        IJth(rJacobian, 22, 28) = var_x473 * (var_x331 + var_x469 * (5000.0 - 1000.0 * var_x474) - var_x331 * var_x462) - var_x466 * (40000.0 - 5333.333333333333 * var_x474);
        IJth(rJacobian, 26, 28) = var_x510 * (var_x516 + var_x506 * var_x518);
        IJth(rJacobian, 27, 28) = var_x253 + var_x235 * var_x254;
        IJth(rJacobian, 28, 28) = var_x524 * (-5.0 - var_x527 - 0.0010458526290002684 * var_x215 + var_x518 * var_x519) + (0.019557600000000001 / pow(var_x520, 3) + 8.1780000000000006e-5 / pow(var_x521, 3)) * (0.23999999999999996 * var_x517 + 5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0.0010458526290002684 * var_x324) / pow(var_x522, 2);
    }
