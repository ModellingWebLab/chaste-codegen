...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_SAN_model_1989FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x6 = NV_Ith_S(mParameters, 3) * var_chaste_interface__second_inward_current_f2_gate__f2;
        ...
        const double var_x39 = var_x35 * NV_Ith_S(mParameters, 1);
        ...
        const double var_x47 = var_x46 - var_x0 * NV_Ith_S(mParameters, 2);
        const double var_x48 = var_x1 * var_x47;
        const double var_x49 = var_x46 - var_x9 * NV_Ith_S(mParameters, 2);
        const double var_x50 = var_x35 * NV_Ith_S(mParameters, 2);
        ...
        const double var_x54 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * NV_Ith_S(mParameters, 6);
        ...
        const double var_x58 = pow(NV_Ith_S(mParameters, 2), 3.0);
        ...
        const double var_x69 = NV_Ith_S(mParameters, 1) / var_chaste_interface__intracellular_potassium_concentration__Ki;
        ...
        const double var_x73 = NV_Ith_S(mParameters, 9) / (10.0 + NV_Ith_S(mParameters, 1));
        const double var_x74 = var_x73 / var_x72;
        const double var_x75 = var_x74 * NV_Ith_S(mParameters, 1);
        const double var_x76 = pow(var_chaste_interface__hyperpolarising_activated_current_y_gate__y, 2);
        const double var_x77 = 1 / (45.0 + NV_Ith_S(mParameters, 1));
        const double var_x78 = var_x77 * NV_Ith_S(mParameters, 1);
        const double var_x79 = var_x76 * var_x78;
        const double var_x80 = var_x79 * NV_Ith_S(mParameters, 7);
        const double var_x81 = var_x79 * NV_Ith_S(mParameters, 8);
        const double var_x82 = NV_Ith_S(mParameters, 1) * exp(-0.037433890822745473 * var_chaste_interface__membrane__V);
        const double var_x83 = NV_Ith_S(mParameters, 5) * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x84 = var_x82 * var_x83;
        const double var_x85 = -26.713760659695652 * var_x70 + var_chaste_interface__membrane__V;
        const double var_x86 = var_x71 * var_x73 * var_x85 / pow(var_x72, 2);
        const double var_x87 = var_x86 * NV_Ith_S(mParameters, 1);
        const double var_x88 = 1 / NV_Ith_S(mParameters, 4);
        const double var_x89 = 0.001 * var_x88;
        const double var_x90 = -18716944.910232361 + 374338.90820464725 * var_chaste_interface__membrane__V;
        const double var_x91 = 2.0000000001218549e-7 * var_x7;
        const double var_x92 = var_x2 * var_x91 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x93 = var_x1 * var_x92;
        const double var_x94 = ((var_x15) ? (-var_x93 + var_x90 * (var_x93 + var_x10 * var_x92)) : (0.14973556329098189 * var_x2 * var_x24));
        const double var_x95 = 1 / var_chaste_interface__intracellular_calcium_concentration__Cai;
        const double var_x96 = var_x63 - var_x60;
        const double var_x97 = var_x66 * var_x96 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x98 = var_x57 * var_x58 * var_x67;
        const double var_x99 = var_x64 * var_x96 / pow(var_x65, 2);
        const double var_x100 = var_x58 * var_x99;
        const double var_x101 = var_x78 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        const double var_x102 = 2 * var_x101;
        const double var_x103 = var_x85 * NV_Ith_S(mParameters, 7);
        const double var_x104 = 1 / var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x105 = (-26.713760659695652 * log(var_x104 * NV_Ith_S(mParameters, 2)) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 8);
        const double var_x106 = 1 / (var_chaste_interface__intracellular_sodium_concentration__Nai + 0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki);
        const double var_x107 = -26.713760659695652 * log(var_x106 * (NV_Ith_S(mParameters, 2) + 0.12 * NV_Ith_S(mParameters, 1))) + var_chaste_interface__membrane__V;
        const double var_x108 = var_x107 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * NV_Ith_S(mParameters, 6) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x109 = var_x107 * var_x54;
        const double var_x110 = -9358472.2051161807 + 187169.45410232362 * var_chaste_interface__membrane__V;
        const double var_x111 = 1.0000000000609275e-9 * var_x7;
        const double var_x112 = var_x1 * var_x111;
        const double var_x113 = var_x112 * var_x28;
        const double var_x114 = var_x10 * var_x111;
        const double var_x115 = var_x13 * var_x7;
        const double var_x116 = var_x38 * var_x40;
        const double var_x117 = ((var_x34) ? (-var_x113 + var_x110 * (var_x113 + var_x114 * var_x31)) : (var_x115 * var_x116));
        const double var_x118 = var_x112 * var_x47;
        const double var_x119 = ((var_x34) ? (-var_x118 + var_x110 * (var_x118 + var_x114 * var_x49)) : (var_x115 * var_x52));
        const double var_x120 = var_x4 * var_x91;
        const double var_x121 = ((var_x15) ? (-var_x120 + var_x90 * (var_x120 + var_x11 * var_x91)) : (var_x115 * var_x22));
        const double var_x122 = var_x6 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x123 = 1.0000000000609275e-9 * var_x122;
        const double var_x124 = var_x123 * var_x29;
        const double var_x125 = var_x10 * var_x123;
        const double var_x126 = var_x122 * var_x13;
        const double var_x127 = ((var_x34) ? (-var_x124 + var_x110 * (var_x124 + var_x125 * var_x31)) : (var_x116 * var_x126));
        const double var_x128 = var_x123 * var_x48;
        const double var_x129 = ((var_x34) ? (-var_x128 + var_x110 * (var_x128 + var_x125 * var_x49)) : (var_x126 * var_x52));
        const double var_x130 = 2.0000000001218549e-7 * var_x122;
        const double var_x131 = var_x130 * var_x4;
        const double var_x132 = ((var_x15) ? (-var_x131 + var_x90 * (var_x131 + var_x11 * var_x130)) : (var_x126 * var_x22));
        const double var_x133 = NV_Ith_S(mParameters, 3) * var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x134 = 1.0000000000609275e-9 * var_x133;
        const double var_x135 = var_x134 * var_x30;
        const double var_x136 = var_x134 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x137 = var_x10 * var_x136;
        const double var_x138 = var_x13 * var_x133 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x139 = ((var_x34) ? (-var_x135 + var_x110 * (var_x135 + var_x137 * var_x31)) : (var_x116 * var_x138));
        const double var_x140 = var_x136 * var_x48;
        const double var_x141 = ((var_x34) ? (-var_x140 + var_x110 * (var_x140 + var_x137 * var_x49)) : (var_x138 * var_x52));
        const double var_x142 = 2.0000000001218549e-7 * var_x133;
        const double var_x143 = var_x142 * var_x5;
        const double var_x144 = ((var_x15) ? (-var_x143 + var_x90 * (var_x143 + var_x12 * var_x142)) : (var_x138 * var_x22));
        const double var_x145 = var_x26 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x146 = var_x112 * var_x145;
        const double var_x147 = ((var_x34) ? (-var_x146 + var_x110 * (var_x146 + var_x114 * var_x145)) : (var_x23 * var_x26 * var_x38));
        const double var_x148 = -var_x147;
        const double var_x149 = NV_Ith_S(mParameters, 1) / (1.0 + NV_Ith_S(mParameters, 1));
        const double var_x150 = var_x149 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Nai);
        const double var_x151 = var_x149 * var_chaste_interface__intracellular_sodium_concentration__Nai / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Nai), 2);
        const double var_x152 = var_x106 * var_x55;
        const double var_x153 = pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 2.0) * NV_Ith_S(mParameters, 0);
        const double var_x154 = var_x153 * var_x99;
        const double var_x155 = var_x104 * var_x81;
        const double var_x156 = var_x153 * var_x61 * var_x67;
        const double var_x157 = 26.713760659695652 * var_x69;
        const double var_x158 = var_x76 * var_x77 * NV_Ith_S(mParameters, 7);
        const double var_x159 = var_x69 * var_x86;
        const double var_x160 = 0.0040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x161 = pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 2.0);
        const double var_x162 = 3.9999999999999998e-6 + var_x161;
        const double var_x163 = 1 / var_x162;
        const double var_x164 = var_x163 * pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 1.0);
        const double var_x165 = pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 3.0) / pow(var_x162, 2);
        const double var_x166 = var_x161 * var_x163;
        const double var_x167 = exp(-0.0625 * var_chaste_interface__membrane__V);
        const double var_x168 = exp(0.052631578947368418 * var_chaste_interface__membrane__V);
        const double var_x169 = exp(0.035714285714285712 * var_chaste_interface__membrane__V);
        const double var_x170 = exp(-0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x171 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x172 = 1 / (1.0 - exp(1.0000000045806701e-7));
        const double var_x173 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x174 = fabs(var_x173) < 1.0000000010279564e-6;
        const double var_x175 = -0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x176 = exp(-4.1000000000000005 + var_x175);
        const double var_x177 = 1.0 - var_x176;
        const double var_x178 = 200.0 / var_x177;
        const double var_x179 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x180 = 0.00020000000091613401 * var_x172;
        const double var_x181 = exp(-9.375 - 0.125 * var_chaste_interface__membrane__V);
        const double var_x182 = exp(-7.5 + var_x175);
        const double var_x183 = 0.001 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x184 = 1 / (1.0 - exp(1.0000000028043132e-7));
        const double var_x185 = 1 / (1.0 - exp(-1.0000000028043132e-7));
        const double var_x186 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x187 = fabs(var_x186);
        const double var_x188 = var_x187 < 4.0000000112172529e-7;
        const double var_x189 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x190 = -var_x189;
        const double var_x191 = exp(-4.75 + var_x190);
        const double var_x192 = 1.0 - var_x191;
        const double var_x193 = 30.0 / var_x192;
        const double var_x194 = 1 / (-1.0 + exp(1.0000000010279564e-7));
        const double var_x195 = 1 / (-1.0 + exp(-1.0000000010279564e-7));
        const double var_x196 = var_x187 < 1.0000000010279564e-6;
        const double var_x197 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x198 = -1.0 + var_x197;
        const double var_x199 = 12.0 / var_x198;
        const double var_x200 = 1.2000000012335477e-5 * var_x194;
        const double var_x201 = 1.2000000033651759e-5 * var_x184;
        const double var_x202 = 1.0 - var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x203 = exp(8.5 + var_x189);
        const double var_x204 = -1.0 + var_x203;
        const double var_x205 = 0.0062500000000000003 / var_x204;
        const double var_x206 = exp(-8.5 + var_x190);
        const double var_x207 = 1.0 + var_x206;
        const double var_x208 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x209 = 0.0026182929949382316 * var_x101;
        const double var_x210 = -0.0013091464974691158 * var_x147;
        const double var_x211 = 0.002 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x212 = 0.19999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x213 = 0.0050000000000000001 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x214 = 1.0 - var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x215 = exp(16.0 + var_x189);
        const double var_x216 = -1.0 + var_x215;
        const double var_x217 = 0.00062500000000000001 / var_x216;
        const double var_x218 = exp(-16.0 + var_x190);
        const double var_x219 = 1.0 + var_x218;
        const double var_x220 = 64.0 + var_chaste_interface__membrane__V;
        const double var_x221 = 0.034972226201868815 * var_x69;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x89 * (-0.00080000000000000004 - var_x25 - var_x45 - var_x53 - var_x55 - var_x75 - var_x80 - var_x81 + 0.074867781645490947 * var_x87 - 2.0000000000000002e-5 * var_x68 - 0.00026738493444818193 * var_x84));
        IJth(rJacobian, 1, 0) = -6.5457324873455795e-8 + 2.6182929949382318e-8 * var_x68 - 0.00065457324873455789 * var_x25;
        IJth(rJacobian, 2, 0) = -0.0625 * var_x167 * (2.8e-5 - 2.8e-5 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y) - 0.0010263157894736842 * var_x168 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        IJth(rJacobian, 3, 0) = 0.035714285714285712 * var_x169 * (0.0021000000000000003 - 0.0021000000000000003 * var_chaste_interface__time_dependent_potassium_current_x_gate__x) + 3.9999999999999996e-5 * var_x170 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        IJth(rJacobian, 4, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x174) ? (99.999999644728632 * var_x171 + 100.00000035527137 * var_x172) : (var_x178 - 20.0 * var_x173 * var_x176 / pow(var_x177, 2))) + 0.44800000000000001 * var_x179 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 5, 0) = -0.125 * var_x181 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x182 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x182), 2);
        IJth(rJacobian, 6, 0) = (0.001 - var_x183) * ((var_x188) ? (15.0 * var_x184 + 15.0 * var_x185) : (var_x193 - 7.5 * var_x186 * var_x191 / pow(var_x192, 2))) - var_x183 * ((var_x196) ? (6.0 * var_x194 + 6.0 * var_x195) : (var_x199 - 1.2 * var_x186 * var_x197 / pow(var_x198, 2)));
        IJth(rJacobian, 7, 0) = var_x202 * var_x205 - 0.012500000000000001 * var_x206 * var_chaste_interface__second_inward_current_f_gate__f / pow(var_x207, 2) - 0.0015625000000000001 * var_x202 * var_x203 * var_x208 / pow(var_x204, 2);
        IJth(rJacobian, 9, 0) = -9.16402548228381e-7 - 0.0013091464974691158 * var_x53 - 0.0013091464974691158 * var_x55 - 0.0013091464974691158 * var_x81 - 7.8548789848146954e-8 * var_x68;
        IJth(rJacobian, 12, 0) = var_x214 * var_x217 - 0.00125 * var_x218 * var_chaste_interface__intracellular_calcium_concentration__p / pow(var_x219, 2) - 0.00015625 * var_x214 * var_x215 * var_x220 / pow(var_x216, 2);
        IJth(rJacobian, 13, 0) = 9.8012894114477019e-5 * var_x87 - 0.0013091464974691158 * var_x45 - 0.0013091464974691158 * var_x75 - 0.0013091464974691158 * var_x80 - 3.500460504088465e-7 * var_x84;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x89 * (-var_x94 + 2.0000000000000002e-5 * var_x98 + 1.3800000000000002e-7 * var_x97 + 2.0000000000000001e-9 * var_x100 - 0.0013356880329847825 * var_x95));
        IJth(rJacobian, 1, 1) = -0.19999999999999998 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 0.00065457324873455789 * var_x94 - 1.8066221665073799e-10 * var_x97 - 2.6182929949382318e-8 * var_x98 - 2.6182929949382317e-12 * var_x100 - 8.7430565504672044e-7 * var_x95 + var_x160 * var_x164 - var_x160 * var_x165;
        IJth(rJacobian, 8, 1) = -20.0 * var_chaste_interface__second_inward_current_f2_gate__f2;
        IJth(rJacobian, 9, 1) = 7.8548789848146954e-12 * var_x100 + 5.4198664995221396e-10 * var_x97 + 7.8548789848146954e-8 * var_x98;
        ...
        IJth(rJacobian, 11, 1) = var_x165 * var_x212 - var_x164 * var_x212;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x89 * (-var_x102 * var_x103 - var_x102 * var_x105));
        IJth(rJacobian, 2, 2) = -2.8e-5 * var_x167 - 0.0195 * var_x168;
        IJth(rJacobian, 9, 2) = -var_x105 * var_x209;
        IJth(rJacobian, 13, 2) = -var_x103 * var_x209;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (var_x89 * (0.0071428571428571426 * var_x82 - 0.0071428571428571426 * var_chaste_interface__intracellular_potassium_concentration__Ki) * NV_Ith_S(mParameters, 5));
        IJth(rJacobian, 3, 3) = -0.00095999999999999992 * var_x170 - 0.0021000000000000003 * var_x169;
        IJth(rJacobian, 13, 3) = (9.3510464104936842e-6 * var_x82 - 9.3510464104936842e-6 * var_chaste_interface__intracellular_potassium_concentration__Ki) * NV_Ith_S(mParameters, 5);
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0030000000000000001 * var_x108 * var_x88);
        IJth(rJacobian, 4, 4) = -8.0 * var_x179 - 0.001 * ((var_x174) ? (-var_x180 + 499999.99948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (var_x180 + 0.00019999999949504854 * var_x171)) : (var_x173 * var_x178));
        IJth(rJacobian, 9, 4) = -0.0039274394924073471 * var_x108;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x109 * var_x89);
        IJth(rJacobian, 5, 5) = -2.0 / (1.0 + 320.0 * var_x182) - 0.02 * var_x181;
        IJth(rJacobian, 9, 5) = -0.0013091464974691158 * var_x109;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x89 * (-var_x117 - var_x119 - var_x121));
        IJth(rJacobian, 1, 6) = -0.00065457324873455789 * var_x121;
        IJth(rJacobian, 6, 6) = -0.001 * ((var_x196) ? (var_x200 - 499999.99948602181 * (18.999998999999999 + var_chaste_interface__membrane__V) * (-var_x200 - 1.2000000012335477e-5 * var_x195)) : (var_x186 * var_x199)) - 0.001 * ((var_x188) ? (-var_x201 + 1249999.9964946085 * (19.000000400000001 + var_chaste_interface__membrane__V) * (var_x201 + 1.2000000033651759e-5 * var_x185)) : (var_x186 * var_x193));
        IJth(rJacobian, 9, 6) = -0.0013091464974691158 * var_x119;
        IJth(rJacobian, 13, 6) = -0.0013091464974691158 * var_x117;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x89 * (-var_x127 - var_x129 - var_x132));
        IJth(rJacobian, 1, 7) = -0.00065457324873455789 * var_x132;
        IJth(rJacobian, 7, 7) = -0.050000000000000003 / var_x207 - var_x205 * var_x208;
        IJth(rJacobian, 9, 7) = -0.0013091464974691158 * var_x129;
        IJth(rJacobian, 13, 7) = -0.0013091464974691158 * var_x127;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x89 * (-var_x139 - var_x141 - var_x144));
        IJth(rJacobian, 1, 8) = -0.00065457324873455789 * var_x144;
        IJth(rJacobian, 8, 8) = -0.01 - 20.0 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 9, 8) = -0.0013091464974691158 * var_x141;
        IJth(rJacobian, 13, 8) = -0.0013091464974691158 * var_x139;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x89 * (var_x148 + 0.00028125000000000003 * var_x151 + 6.0000000000000008e-9 * var_x154 - 0.45000000000000001 * var_x150 - 26.713760659695652 * var_x152 - 26.713760659695652 * var_x155 - 6.0000000000000008e-5 * var_x156 - 0.018699632461786953 * var_x104));
        IJth(rJacobian, 1, 9) = 7.8548789848146954e-8 * var_x156 - 7.8548789848146954e-12 * var_x154;
        IJth(rJacobian, 9, 9) = var_x210 + 2.3564636954444086e-11 * var_x154 + 1.1045923572395664e-6 * var_x151 - 0.0017673477715833062 * var_x150 - 0.034972226201868815 * var_x152 - 0.034972226201868815 * var_x155 - 2.3564636954444086e-7 * var_x156 - 2.4480558341308171e-5 * var_x104;
        IJth(rJacobian, 13, 9) = 0.0011782318477222041 * var_x150 - 7.3639490482637762e-7 * var_x151;
        IJth(rJacobian, 1, 10) = 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 10, 10) = -var_x211 - 0.79999999999999993 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 11, 10) = var_x213;
        IJth(rJacobian, 1, 11) = 0.002 * var_x166;
        IJth(rJacobian, 10, 11) = var_x211;
        IJth(rJacobian, 11, 11) = -var_x213 - 0.099999999999999992 * var_x166;
        ...
        IJth(rJacobian, 12, 12) = -0.0050000000000000001 / var_x219 - var_x217 * var_x220;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x89 * (var_x148 + 2.0 * var_x159 - 3.2056512791634777 * var_x152 - 0.0071428571428571426 * var_x83 - var_x157 * var_x158 - var_x157 * var_x74));
        IJth(rJacobian, 9, 13) = -0.0041966671442242578 * var_x152;
        IJth(rJacobian, 13, 13) = var_x210 + 0.0026182929949382316 * var_x159 - 9.3510464104936842e-6 * var_x83 - var_x158 * var_x221 - var_x221 * var_x74;
    }
