...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_SAN_model_1989FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x6 = pow(var_chaste_interface__hyperpolarising_activated_current_y_gate__y, 2.0);
        ...
        const double var_x57 = pow(var_chaste_interface__hyperpolarising_activated_current_y_gate__y, 1.0);
        const double var_x58 = 0.125 * var_x57;
        const double var_x59 = 1 / var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x60 = -26.713760659695652 * log(140.0 * var_x59) + var_chaste_interface__membrane__V;
        const double var_x61 = 1.0 * var_chaste_interface__intracellular_sodium_concentration__Nai + 0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki;
        const double var_x62 = -26.713760659695652 * log(140.36000000000001 / var_x61) + var_chaste_interface__membrane__V;
        const double var_x63 = var_x62 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x64 = var_x24 * var_x42;
        const double var_x65 = var_x36 * var_x38;
        const double var_x66 = var_x42 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x67 = var_x66 * var_chaste_interface__second_inward_current_f2_gate__f2;
        const double var_x68 = var_x66 * var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x69 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Nai);
        const double var_x70 = var_chaste_interface__intracellular_sodium_concentration__Nai / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Nai), 2);
        const double var_x71 = 1.669610041230978 * var_x6;
        const double var_x72 = pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 2.0);
        const double var_x73 = var_x54 * var_x72;
        const double var_x74 = var_x16 * var_x22 * var_x72;
        const double var_x75 = var_x10 * (0.0008549444286121402 * var_chaste_interface__intracellular_potassium_concentration__Ki + 0.0071245369051011684 * var_chaste_interface__intracellular_sodium_concentration__Nai) * var_chaste_interface__fast_sodium_current_h_gate__h / pow(var_x61, 2);
        const double var_x76 = var_x37 * var_x43;
        const double var_x77 = -var_x36 * var_x76;
        const double var_x78 = var_x1 * var_x5;
        const double var_x79 = var_x1 * var_x13;
        const double var_x80 = 1.1761547293737243e-5 * var_x31;
        const double var_x81 = 0.0040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x82 = pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 2.0);
        const double var_x83 = 3.9999999999999998e-6 + var_x82;
        const double var_x84 = 1 / var_x83;
        const double var_x85 = var_x84 * pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 1.0);
        const double var_x86 = pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 3.0) / pow(var_x83, 2);
        const double var_x87 = var_x82 * var_x84;
        const double var_x88 = exp(-0.0625 * var_chaste_interface__membrane__V);
        const double var_x89 = exp(0.052631578947368418 * var_chaste_interface__membrane__V);
        const double var_x90 = exp(-0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x91 = exp(0.035714285714285712 * var_chaste_interface__membrane__V);
        const double var_x92 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x93 = 0.44800000000000001 * var_x92 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x94 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x95 = fabs(var_x94) < 1.0000000000000001e-5;
        const double var_x96 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x97 = -0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x98 = exp(-4.1000000000000005 + var_x97);
        const double var_x99 = 1.0 - var_x98;
        const double var_x100 = 0.20000000000000001 / var_x99;
        const double var_x101 = -8.0 * var_x92;
        const double var_x102 = exp(-9.375 - 0.125 * var_chaste_interface__membrane__V);
        const double var_x103 = exp(-7.5 + var_x97);
        const double var_x104 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x105 = fabs(var_x104) < 0.0001;
        const double var_x106 = 1.0 - var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x107 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x108 = -var_x107;
        const double var_x109 = exp(-4.75 + var_x108);
        const double var_x110 = 1.0 - var_x109;
        const double var_x111 = 0.029999999999999999 / var_x110;
        const double var_x112 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x113 = -1.0 + var_x112;
        const double var_x114 = 0.012 / var_x113;
        const double var_x115 = exp(-8.5 + var_x108);
        const double var_x116 = 1.0 + var_x115;
        const double var_x117 = -0.012500000000000001 * var_x115 * var_chaste_interface__second_inward_current_f_gate__f / pow(var_x116, 2);
        const double var_x118 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x119 = fabs(var_x118) < 0.0001;
        const double var_x120 = 1.0 - var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x121 = exp(8.5 + var_x107);
        const double var_x122 = -1.0 + var_x121;
        const double var_x123 = 0.0062500000000000003 / var_x122;
        const double var_x124 = -0.050000000000000003 / var_x116;
        const double var_x125 = -4.9092993655091836e-6 * var_x6;
        const double var_x126 = 1.6364331218363949e-5 * var_x10;
        const double var_x127 = 5.8807736468686214e-8 * var_x35;
        const double var_x128 = 2.2014023865015868e-9 * var_x48;
        const double var_x129 = 9.8185987310183671e-6 * var_x57;
        const double var_x130 = var_x127 * var_x40;
        const double var_x131 = 0.00013114584825700806 * var_x6;
        const double var_x132 = -var_x127 * var_x76;
        const double var_x133 = 0.002 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x134 = 0.20000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x135 = 0.0050000000000000001 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x136 = 1.0 - var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x137 = exp(16.0 + var_x107);
        const double var_x138 = -1.0 + var_x137;
        const double var_x139 = 0.00062500000000000001 / var_x138;
        const double var_x140 = exp(-16.0 + var_x108);
        const double var_x141 = 1.0 + var_x140;
        const double var_x142 = 64.0 + var_chaste_interface__membrane__V;
        const double var_x143 = var_x127 * var_x38;
        ...
        IJth(rJacobian, 1, 0) = -6.5457324873455795e-8 + 8.8056095460063478e-7 * var_x47 + 2.6182929949382318e-8 * var_x23 - 1.7611219092012696e-6 * var_x45 - var_x25 * var_x80;
        IJth(rJacobian, 2, 0) = -0.0625 * var_x88 * (2.8e-5 - 2.8e-5 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y) - 0.0010263157894736842 * var_x89 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        IJth(rJacobian, 3, 0) = 3.9999999999999996e-5 * var_x90 * var_chaste_interface__time_dependent_potassium_current_x_gate__x + 0.035714285714285712 * var_x91 * (0.0021000000000000003 - 0.0021000000000000003 * var_chaste_interface__time_dependent_potassium_current_x_gate__x);
        IJth(rJacobian, 4, 0) = ((var_x95) ? (var_x93) : (var_x93 + var_x100 * var_x96 - 0.02 * var_x94 * var_x96 * var_x98 / pow(var_x99, 2)));
        IJth(rJacobian, 5, 0) = -0.125 * var_x102 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x103 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x103), 2);
        IJth(rJacobian, 6, 0) = ((var_x105) ? (0) : (var_x106 * var_x111 - var_x114 * var_chaste_interface__second_inward_current_d_gate__d + 0.0012000000000000001 * var_x104 * var_x112 * var_chaste_interface__second_inward_current_d_gate__d / pow(var_x113, 2) - 0.0074999999999999997 * var_x104 * var_x106 * var_x109 / pow(var_x110, 2)));
        IJth(rJacobian, 7, 0) = ((var_x119) ? (var_x117) : (var_x117 + var_x120 * var_x123 - 0.0015625000000000001 * var_x118 * var_x120 * var_x121 / pow(var_x122, 2)));
        IJth(rJacobian, 9, 0) = -9.16402548228381e-7 + var_x125 - 7.8548789848146954e-8 * var_x23 - 3.0819633411022218e-7 * var_x46 + var_x128 * var_x50 - var_x126 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x127 * var_x50;
        IJth(rJacobian, 12, 0) = var_x136 * var_x139 - 0.00125 * var_x140 * var_chaste_interface__intracellular_calcium_concentration__p / pow(var_x141, 2) - 0.00015625 * var_x136 * var_x137 * var_x142 / pow(var_x138, 2);
        IJth(rJacobian, 13, 0) = var_x125 + 1.6963770135197946e-7 * var_x13 - 2.2658304763888542e-6 * var_x5 - 8.4011052098123161e-7 * var_x9 - 6.6042071595047608e-9 * var_x46 + var_x128 * var_x39 - var_x127 * var_x39;
        ...
        IJth(rJacobian, 1, 1) = -0.20000000000000001 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 9.5418840923404938e-11 * var_x54 - 1.1761547293737243e-5 * var_x56 - 1.8066221665073799e-10 * var_x53 - 8.7430565504672044e-7 * var_x51 - 0.071845959781105084 * var_x55 + var_x81 * var_x85 - var_x81 * var_x86;
        ...
        IJth(rJacobian, 11, 1) = var_x134 * var_x86 - var_x134 * var_x85;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x12 * var_x58 - var_x58 * var_x60);
        IJth(rJacobian, 2, 2) = -0.0195 * var_x89 - 2.8e-5 * var_x88;
        IJth(rJacobian, 9, 2) = -var_x129 * var_x60;
        IJth(rJacobian, 13, 2) = -var_x12 * var_x129;
        ...
        IJth(rJacobian, 3, 3) = -0.0021000000000000003 * var_x91 - 0.00096000000000000002 * var_x90;
        ...
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.625 * var_x63);
        IJth(rJacobian, 4, 4) = ((var_x95) ? (-2.0 + var_x101) : (var_x101 - var_x100 * var_x94));
        IJth(rJacobian, 9, 4) = -4.9092993655091846e-5 * var_x63;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x62);
        IJth(rJacobian, 5, 5) = -0.02 * var_x102 - 2.0 / (1.0 + 320.0 * var_x103);
        IJth(rJacobian, 9, 5) = -var_x126 * var_x62;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x32 * var_x64 - var_x41 * var_x64 - var_x64 * var_x65);
        IJth(rJacobian, 1, 6) = -var_x64 * var_x80;
        IJth(rJacobian, 6, 6) = ((var_x105) ? (-0.23999999999999999) : (-var_x104 * var_x111 - var_x104 * var_x114));
        IJth(rJacobian, 9, 6) = -var_x130 * var_x64;
        IJth(rJacobian, 13, 6) = -var_x143 * var_x64;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x32 * var_x67 - var_x41 * var_x67 - var_x65 * var_x67);
        IJth(rJacobian, 1, 7) = -var_x67 * var_x80;
        IJth(rJacobian, 7, 7) = ((var_x119) ? (-0.025000000000000001 + var_x124) : (var_x124 - var_x118 * var_x123));
        IJth(rJacobian, 9, 7) = -var_x130 * var_x67;
        IJth(rJacobian, 13, 7) = -var_x143 * var_x67;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x32 * var_x68 - var_x41 * var_x68 - var_x65 * var_x68);
        IJth(rJacobian, 1, 8) = -var_x68 * var_x80;
        IJth(rJacobian, 8, 8) = -0.01 - 20.0 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 9, 8) = -var_x130 * var_x68;
        IJth(rJacobian, 13, 8) = -var_x143 * var_x68;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x77 + 2.6562061725981521e-12 * var_x73 + 0.0035156250000000001 * var_x70 - 0.002 * var_x74 - 5.625 * var_x69 - 0.31166054102978258 * var_x59 - 781.15488462393364 * var_x75 - var_x59 * var_x71);
        IJth(rJacobian, 1, 9) = 1.5709757969629391e-7 * var_x74 - 2.0864178044476298e-16 * var_x73;
        IJth(rJacobian, 9, 9) = var_x132 + 6.2592534133428895e-16 * var_x73 + 8.2844426792967482e-7 * var_x70 - 0.061358770871178837 * var_x75 - 0.0013255108286874798 * var_x69 - 2.4480558341308171e-5 * var_x59 - 4.7129273908888172e-7 * var_x74 - var_x131 * var_x59;
        IJth(rJacobian, 13, 9) = 0.00088367388579165321 * var_x69 - 5.5229617861978321e-7 * var_x70;
        IJth(rJacobian, 1, 10) = 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 10, 10) = -var_x133 - 0.79999999999999993 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 11, 10) = var_x135;
        IJth(rJacobian, 1, 11) = 0.002 * var_x87;
        IJth(rJacobian, 10, 11) = var_x133;
        IJth(rJacobian, 11, 11) = -var_x135 - 0.10000000000000001 * var_x87;
        ...
        IJth(rJacobian, 12, 12) = -0.0050000000000000001 / var_x141 - var_x139 * var_x142;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x77 + 0.057692307692307689 * var_x79 - 93.738586154872038 * var_x75 - 0.095238095238095247 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 0.77058924979891297 * var_x78 - var_x1 * var_x71);
        IJth(rJacobian, 9, 13) = -0.0073630525045414608 * var_x75;
        IJth(rJacobian, 13, 13) = var_x132 + 4.5316609527777084e-6 * var_x79 - 7.4808371283949473e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 6.0528853041696024e-5 * var_x78 - var_x1 * var_x131;
    }
