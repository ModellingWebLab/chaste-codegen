...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_SAN_model_1989FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x124 = -4.9092993655091836e-6 * var_x6;
        const double var_x125 = 1.6364331218363949e-5 * var_x10;
        const double var_x126 = 5.8807736468686214e-8 * var_x35;
        const double var_x127 = 2.2014023865015868e-9 * var_x48;
        const double var_x128 = 9.8185987310183671e-6 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        const double var_x129 = var_x126 * var_x40;
        ...
        const double var_x142 = var_x126 * var_x38;
        ...
        IJth(rJacobian, 9, 0) = -9.16402548228381e-7 + var_x124 - 7.8548789848146954e-8 * var_x23 - 3.0819633411022218e-7 * var_x46 + var_x127 * var_x50 - var_x125 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x126 * var_x50;
        ...
        IJth(rJacobian, 13, 0) = var_x124 + 1.6963770135197946e-7 * var_x13 - 2.2658304763888542e-6 * var_x5 - 8.4011052098123161e-7 * var_x9 - 6.6042071595047608e-9 * var_x46 + var_x127 * var_x39 - var_x126 * var_x39;
        ...
        IJth(rJacobian, 13, 2) = -var_x12 * var_x128;
        ...
        IJth(rJacobian, 9, 9) = var_x131 + 6.2592534133428895e-16 * var_x72 + 8.2844426792967482e-7 * var_x69 - 0.061358770871178837 * var_x74 - 0.0013255108286874798 * var_x68 - 2.4480558341308171e-5 * var_x58 - 4.7129273908888172e-7 * var_x73 - var_x130 * var_x58;
        ...
        IJth(rJacobian, 10, 10) = -var_x132 - 0.79999999999999993 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        ...
        IJth(rJacobian, 13, 13) = var_x131 + 4.5316609527777084e-6 * var_x78 - 7.4808371283949473e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 6.0528853041696024e-5 * var_x77 - var_x1 * var_x130;
    }
