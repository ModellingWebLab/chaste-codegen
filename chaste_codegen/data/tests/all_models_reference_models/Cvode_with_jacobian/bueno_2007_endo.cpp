...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbueno_2007_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: mV; Initial value: 0.0
        double var_chaste_interface__fast_inward_current_v_gate__v = NV_Ith_S(rY, 1);
        ...
        IJth(rJacobian, 1, 1) = -0.68936991589687036 * var_x5 - (1.0 - var_x5) / (75.0 - 65.0 * ((var_x0 < 0.024) ? (0) : (1.0)));
