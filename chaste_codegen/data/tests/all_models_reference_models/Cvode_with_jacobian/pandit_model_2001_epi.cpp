...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpandit_model_2001_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x116 = exp(-3.0600000000000001 + var_x115);
        ...
        const double var_x131 = 0.00059999999999999995 * var_x124 / pow(var_x125, 2);
        ...
        const double var_x135 = 0.00018518518518518518 * var_x128 / pow(var_x129, 2);
        ...
        const double var_x155 = exp(-0.97292724196277491 - 0.084602368866328256 * var_chaste_interface__membrane__V);
        const double var_x156 = 1.0 + var_x155;
        const double var_x157 = exp(8.4951456310679614 + 0.097087378640776698 * var_chaste_interface__membrane__V);
        const double var_x158 = exp(13.225190839694655 + 0.095419847328244267 * var_chaste_interface__membrane__V);
        ...
        const double var_x165 = 48600000000.0 * var_x162 * var_chaste_interface__SR_Ca_release_channel__P_C1;
        const double var_x166 = 12150000.0 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 2.0) * var_chaste_interface__SR_Ca_release_channel__P_O1;
        const double var_x167 = 0.00088581970078959317 * var_x31;
        ...
        const double var_x186 = 0.00019703470957323427 * var_x18 - 7.7509223819089404e-6 * var_chaste_interface__membrane__V;
        ...
        const double var_x192 = 870.15176483187713 - 13.386950228182727 * var_chaste_interface__membrane__V;
        const double var_x193 = var_x191 * var_x192;
        const double var_x194 = var_x190 * (84000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR - 84000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss);
        ...
        const double var_x202 = var_x201 * (1800.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 1800.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR);
        ...
        IJth(rJacobian, 4, 0) = 107.49798441279225 * (-var_chaste_interface__L_type_Ca_channel_d_gate__d + 1.0 / var_x117) * (-var_x118 * (0.072000000000000008 - 0.0040000000000000001 * var_chaste_interface__membrane__V) - var_x119 * (-0.063 - 0.0089999999999999993 * var_chaste_interface__membrane__V)) / pow((0.081967213114754092 + var_x114 + 0.34426229508196715 * var_x113), 2) + 0.00020000000000000001 * var_x116 * var_x120 / pow(var_x117, 2);
        IJth(rJacobian, 5, 0) = -var_x134 * var_x135 + 0.090702947845805001 * (var_x130 - var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11) * (var_x131 - var_x132 * (-0.625 - 0.013888888888888888 * var_chaste_interface__membrane__V) - 0.0016000000000000001 * var_x121 / pow(var_x122, 2)) / pow((0.016190476190476189 + var_x127 + 0.38095238095238099 * var_x123 + 0.14285714285714285 * var_x126), 2);
        IJth(rJacobian, 6, 0) = -var_x135 * var_x141 + 0.15625 * (var_x130 - var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12) * (var_x131 - var_x140 * (-0.65277777777777779 - 0.013888888888888888 * var_chaste_interface__membrane__V) - 0.016 * var_x136 / pow(var_x137, 2)) / pow((0.021249999999999998 + var_x138 + 0.51249999999999996 * var_x139 + 0.1875 * var_x126), 2);
        ...
        IJth(rJacobian, 9, 0) = -var_x148 * var_x151 - 0.0028571428571428576 * var_x147 * (-0.62222222222222223 - 0.0088888888888888889 * var_chaste_interface__membrane__V) * (var_x152 - var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s) / pow((0.10000000000000002 + var_x147), 2);
        IJth(rJacobian, 10, 0) = -var_x151 * var_x154 - 0.00027027027027027027 * var_x153 * (-0.15555555555555556 - 0.0022222222222222222 * var_chaste_interface__membrane__V) * (var_x152 - var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow) / pow((0.00945945945945946 + var_x153), 2);
        IJth(rJacobian, 11, 0) = (0.001 / var_x156 - 0.001 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss) * (0.16153732000000001 * var_x144 - 0.9890000000000001 * var_x145) + 8.4602368866328257e-5 * var_x155 * (9.8900000000000006 * var_x145 + 4.516 * var_x144) / pow(var_x156, 2);
        IJth(rJacobian, 12, 0) = -4.6232085067036518e-5 * var_x157 / pow((1.0 + var_x157), 2);
        IJth(rJacobian, 13, 0) = (0.001 / var_x159 - 0.001 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y) * (0.0041892844554106447 * var_x160 - 0.039626497533474282 * var_x161) - 9.5419847328244274e-5 * var_x158 * (0.56230000000000002 * var_x161 + 0.11885 * var_x160) / pow(var_x159, 2);
        IJth(rJacobian, 20, 0) = -8.8748061272857362e-8 - 3.2110964153622751e-7 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 3.3165089597562367e-8 * var_x14 - 0.00020797506018538275 * var_x40 - var_x167 * var_chaste_interface__sodium_current_h_gate__h;
        IJth(rJacobian, 21, 0) = var_x172 * (-1.7937848940989261e-5 + 1.1055029865854122e-5 * var_x14);
        IJth(rJacobian, 22, 0) = -1.528038983862048e-7 + var_x185 + 0.00013865004012358849 * var_x40 + 1.6862097911031213e-6 * var_x42 - 5.3149182047375591e-6 * var_x29 - 7.7509223819089404e-6 * var_x15 - 1.2844385661449098e-6 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 2.6574591023687795e-5 * var_x21 - 6.5133801528646552e-9 * var_x33;
        IJth(rJacobian, 23, 0) = var_x191 * (-13.386950228182727 * var_x4 - 13.386950228182727 * var_x6);
        ...
        IJth(rJacobian, 20, 2) = -var_x167 * var_x44;
        ...
        IJth(rJacobian, 22, 8) = var_x184 * var_x41;
        ...
        IJth(rJacobian, 10, 10) = -0.001 * var_x154;
        ...
        IJth(rJacobian, 22, 11) = var_x186 * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss;
        ...
        IJth(rJacobian, 22, 12) = var_x186 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss;
        ...
        IJth(rJacobian, 13, 13) = -0.00056230000000000006 * var_x161 - 0.00011885 * var_x160;
        ...
        IJth(rJacobian, 21, 20) = var_x172 * (3.9798107517074834e-5 * var_x58 - 5.2855989422289547e-14 * var_x57);
        ...
        IJth(rJacobian, 22, 22) = 4.286481532120841e-5 * var_x71 - 0.00067554757567966038 * var_x68 - 3.8843985601580465e-6 * var_x17 - 3.2651466157850246e-5 * var_x66 - 1.6557538619599519e-7 * var_x70 - 0.00019703470957323427 * var_x69 + var_x185 * var_x67;
        IJth(rJacobian, 7, 23) = -0.0011111111111111113 / pow((0.01 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss), 2);
        IJth(rJacobian, 14, 23) = var_x165 - var_x166;
        IJth(rJacobian, 15, 23) = var_x166;
        IJth(rJacobian, 16, 23) = -var_x165;
        IJth(rJacobian, 21, 23) = 0.037453183520599252 * var_x171;
        IJth(rJacobian, 23, 23) = var_x190 * (-29213.483146067414 - var_x195 - var_x196) + 2.3800000000000004e-7 * (29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 84000.0 * var_x197 - 29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 13.386950228182727 * var_x49 * (-65.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_channel_d_gate__d) / (pow(var_x187, 3) * pow(var_x188, 2));
        IJth(rJacobian, 24, 23) = var_x201 * (var_x203 + var_x204);
        IJth(rJacobian, 23, 24) = var_x190 * (var_x195 + var_x196);
        IJth(rJacobian, 24, 24) = var_x201 * (-1740.0382808421784 - var_x203 - var_x204) + 0.00016666666666666666 * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800.0 * var_x197 - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / (pow(var_x198, 3) * pow((0.083333333333333329 + var_x199), 2));
        IJth(rJacobian, 25, 24) = 0.19333758676024207;
        IJth(rJacobian, 21, 25) = var_x172 * (0.2735562310030395 * var_x178 + 2.651834266564234e-10 * var_x182);
        IJth(rJacobian, 24, 25) = 1.7400382808421784 * var_x200;
        IJth(rJacobian, 25, 25) = -0.19333758676024207 - 4.9248350664764349e-13 * var_x182 - 0.00050803300043421621 * var_x178;
    }
