...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 5) = 0; // (var_sodium_calcium_exchanger_current__K_NaCa) [picoA_per_picoF]
    }
    ...
    N_Vector Cellstewart_zhang_model_2008_ssFromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        ...
        NV_Ith_S(dqs, 5) = var_sodium_calcium_exchanger_current__K_NaCa_converted;
        return dqs;
    }
