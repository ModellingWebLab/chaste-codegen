...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 4) = 091800000000000007; // (var_rapid_time_dependent_potassium_current__g_Kr) [nanoS_per_picoF]
        NV_Ith_S(this->mParameters, 5) = 1000; // (var_sodium_calcium_exchanger_current__K_NaCa) [picoA_per_picoF]
    }
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40) ? (057000000000000002 * exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 3) - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0)); // per_millisecond
        const double var_fast_sodium_current_h_gate__beta_h = ((var_chaste_interface__membrane__V < -40) ? (310000 * exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 3)) + 2.7000000000000002 * exp(079000000000000001 * var_chaste_interface__membrane__V - 079000000000000001 * NV_Ith_S(mParameters, 3))) : (5.9230769230769234 / (1.0 + exp(-0.96036036036036043 + 0900900900900901 * NV_Ith_S(mParameters, 3) - 0900900900900901 * var_chaste_interface__membrane__V)))); // per_millisecond
        const double var_fast_sodium_current_h_gate__h_inf = 01 * NV_Ith_S(mParameters, 2) + 1.0 * (1.0 - 01 * NV_Ith_S(mParameters, 2)) / pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 3))), 2); // dimensionless
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x53 = log(140 * var_x52);
        ...
        const double var_x65 = 2.1862541723894919 * var_x13 - 081839999999999996 * var_chaste_interface__membrane__V;
        ...
        const double var_x110 = exp(3.6666666666666665 + 041666666666666664 * var_chaste_interface__membrane__V);
        ...
        const double var_x123 = exp(-0.35714285714285715 - 071428571428571425 * var_chaste_interface__membrane__V);
        ...
        const double var_x143 = exp(079000000000000001 * var_chaste_interface__membrane__V - 079000000000000001 * NV_Ith_S(mParameters, 3));
        const double var_x144 = exp(-0.96036036036036043 + 0900900900900901 * NV_Ith_S(mParameters, 3) - 0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x145 = 1.0 + var_x144;
        const double var_x146 = 01 * NV_Ith_S(mParameters, 2);
        ...
        const double var_x156 = exp(01052 * NV_Ith_S(mParameters, 3) - 01052 * var_chaste_interface__membrane__V);
        ...
        const double var_x160 = exp(057000000000000002 * var_chaste_interface__membrane__V - 057000000000000002 * NV_Ith_S(mParameters, 3));
        ...
        const double var_x163 = exp(043909999999999998 * NV_Ith_S(mParameters, 3) - 043909999999999998 * var_chaste_interface__membrane__V);
        ...
        const double var_x211 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0025000000000000005 + var_x208), 2);
        ...
        const double var_x257 = 00011688549744401942 * var_x27;
        const double var_x258 = (0031224512033090025 * var_x13 - 00011688549744401942 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 4);
        const double var_x259 = 00025554140647880875 * var_x13 - 9.5659091108185493e-6 * var_chaste_interface__membrane__V;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0 : (-00088199999999999997 + 1081.6363254030778 * var_x45 + 0065000000000000006 * var_x15 - 065000000000000002 * var_x3 - 081839999999999996 * var_x11 - 037999999999999999 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 022700000000000001 * var_x6 - 0146 * var_x9 - 0.23519999999999999 * var_x10 - 8.666220229942447e-8 * var_x22 - 0024414715719063545 * var_x23 - 270.40908135076944 * var_x46 - 2.1086672225679693e-10 * var_x30 - 2.2983750000000001 * var_x35 - 0013352941176470589 * var_x24 - 1.0 * var_x25 - var_x28 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x39 * var_x42);
        ...
        IJth(rJacobian, 4, 0) = 01488095238095238 * var_x109 * var_x112 * var_x113 - 041666666666666664 * var_x110 * var_x115 / pow(var_x111, 2) - 050000000000000003 * var_x108 * var_x112 * var_x114;
        IJth(rJacobian, 5, 0) = 5.1020408163265302e-7 * (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1.0 / var_x124) * (93.333333333333329 * var_x118 * var_x119 / pow(var_x120, 2) - 116.66666666666667 * var_x116 * var_x121 / pow(var_x117, (3 / 2))) / pow((057142857142857141 + var_x122), 2) + 071428571428571425 * var_x123 * var_x125 / pow(var_x124, 2);
        IJth(rJacobian, 6, 0) = 0.22148394241417499 * var_x134 * var_x139 / pow(var_x135, 3) - 0.20000000000000001 * var_x133 * var_x136 * var_x137 + 99.999999999999986 * var_x136 * var_x138 * (02 * var_x127 / pow(var_x128, 2) + 00050000000000000001 * var_x130 / pow(var_x131, 2)) / pow((var_x129 + var_x132), 2);
        IJth(rJacobian, 7, 0) = (var_x150 - var_chaste_interface__fast_sodium_current_h_gate__h) * (1.0 * ((var_x141) ? (-008382352941176471 * var_x140) : (0)) + 1.0 * ((var_x141) ? (108035.0 * var_x142 + 0.21330000000000002 * var_x143) : (0.53361053361053368 * var_x144 / pow(var_x145, 2)))) - var_x153 * (var_x151 + var_x152);
        IJth(rJacobian, 8, 0) = (var_x150 - var_chaste_interface__fast_sodium_current_j_gate__j) * (1.0 * ((var_x141) ? (-00025500480000000003 * var_x157 + 0033402720000000005 * var_x154 * var_x156 / pow(var_x155, 2)) : (034200000000000001 * var_x161 + 059999999999999998 * var_x158 * var_x160 / pow(var_x159, 2))) + 1.0 * ((var_x141) ? (var_x168 + var_x167 * var_x169 * (3.0508668000000001e-7 * var_x163 - 6214.6032000000005 * var_x162) - 0.311 * var_x164 * var_x165 * var_x169 / pow(var_x166, 2)) : (0))) - var_x153 * (var_x170 + var_x171);
        IJth(rJacobian, 9, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1.0 / var_x185) * (-050000000000000003 * var_x172 / pow(var_x173, 2) + 0.27999999999999997 * var_x175 * var_x182 / pow(var_x176, 2) - 0.15076923076923074 * var_x177 * var_x180 / pow(var_x181, 2)) / pow((var_x183 + 0.7142857142857143 * var_x174), 2) + 0.13333333333333333 * var_x184 * var_x186 / pow(var_x185, 2);
        IJth(rJacobian, 10, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1.0 / var_x196) * (18.0 * var_x197 - var_x198 * (-0.23999999999999999 - 0088888888888888889 * var_chaste_interface__membrane__V) - 20 * var_x190 / pow(var_x191, 2)) / pow((018140589569160998 + var_x194 + 0.16326530612244897 * var_x189 + 0.18140589569160998 * var_x192), 2) - 0.14285714285714285 * var_x195 * var_x199 / pow(var_x196, 2);
        IJth(rJacobian, 11, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x205) * (8.0 * var_x197 - var_x206 * (-0.22500000000000001 - 0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x200 / pow(var_x201, 2)) / pow((var_x203 + 055160142348754451 * var_x202 + 0.14234875444839859 * var_x189), 2) - 095714285714285724 * var_x204 * var_x207 / pow(var_x205, 2);
        IJth(rJacobian, 13, 0) = 00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / var_x217) * (-var_x218 * (-0.15625 - 0062500000000000003 * var_chaste_interface__membrane__V) + 1.0 * var_x212 / pow(var_x213, 2)) / pow((0.49411764705882355 + var_x215 + 058823529411764705 * var_x214), 2) - 076923076923076927 * var_x216 * var_x219 / pow(var_x217, 2);
        IJth(rJacobian, 14, 0) = 076923076923076927 * var_x220 * var_x223 / pow(var_x221, 2) - 09569377990430622 * var_x222 * (-044444444444444446 - 0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / var_x221) / pow((0.69856459330143539 + var_x222), 2);
        IJth(rJacobian, 16, 0) = var_x251 * (-var_x247 + 18.964139992238998 * var_x45 - 4.7410349980597495 * var_x46);
        IJth(rJacobian, 18, 0) = -3.389679425876563e-8 - 1.7024840244711204e-6 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 3.0388663876087416e-11 * var_x22 - 7.3941785176126764e-14 * var_x30 - 00080594011556369446 * var_x35 - var_x257 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 19, 0) = 7.5975573338612627e-7 * var_x15 + 00053729341037579627 * var_x35 - 2.6533007919792409e-6 * var_x6 - 1.5607651717524947e-7 * var_x24 - 2.8537261917770623e-7 * var_x23 - 2.7491468998833366e-5 * var_x10 - 9.5659091108185493e-6 * var_x11 - 2.7391648784016175e-6 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 1.7065282626826835e-6 * var_x9 - 00011688549744401942 * var_x25 - 7.5975573338612623e-6 * var_x3;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (0.12379999999999999 * var_x50 + 0.59450270777405179 * var_x51 - 0.12379999999999999 * var_x48 - 0079072731552699126 * var_x49);
        IJth(rJacobian, 1, 1) = var_x83 * (-0038240087783467445 - var_x84 + 7.2352122917848019e-6 * var_x50 - 6.9488744729986565e-5 * var_x51 - 5.3144431236283834e-11 * var_x86 - 4.6212277808973232e-7 * var_x49) + 00040000000000000002 * (0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973232e-7 * log(2.0 * var_x49) - 0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 00042515544989027063 * var_x87 - var_x84 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-11 * var_x21 * var_x29) / (pow(var_x80, 3) * pow(var_x81, 2));
        IJth(rJacobian, 15, 1) = var_x227 * (00036000000000000002 + 7.96875e-10 * var_x86);
        IJth(rJacobian, 16, 1) = 1.1399999999999999 * var_x250;
        IJth(rJacobian, 18, 1) = 00020846623418995967 * var_x51;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (0.38909660951273101 * var_x53 + 0.62602629555570366 * var_x13 - 037999999999999999 * var_chaste_interface__membrane__V);
        ...
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (var_x54 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2);
        ...
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (var_x54 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1);
        ...
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (-0.47039999999999998 * var_x56);
        IJth(rJacobian, 5, 5) = -var_x125;
        IJth(rJacobian, 19, 5) = -5.4982937997666732e-5 * var_x56;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (-3.0 * var_x59);
        IJth(rJacobian, 6, 6) = -1.0 * var_x139;
        IJth(rJacobian, 18, 6) = -00035065649233205829 * var_x59;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (-var_x28 * var_x57);
        IJth(rJacobian, 7, 7) = -var_x151 - var_x152;
        IJth(rJacobian, 18, 7) = -var_x257 * var_x57;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (-1.0 * var_x60);
        IJth(rJacobian, 8, 8) = -var_x170 - var_x171;
        IJth(rJacobian, 18, 8) = -00011688549744401942 * var_x60;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0 : (-var_x62 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 9, 9) = -var_x186;
        IJth(rJacobian, 16, 9) = -var_x253 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0 : (-var_x62 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 10, 10) = -var_x199;
        IJth(rJacobian, 16, 10) = -var_x253 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0 : (-var_x64 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass);
        IJth(rJacobian, 11, 11) = -var_x207;
        IJth(rJacobian, 16, 11) = -var_x254 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0 : (-var_x64 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 12, 12) = -var_x210;
        IJth(rJacobian, 16, 12) = -var_x254 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0 : (var_x65 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 13, 13) = -var_x219;
        IJth(rJacobian, 19, 13) = var_x259 * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0 : (var_x65 * var_chaste_interface__transient_outward_current_s_gate__s);
        ...
        IJth(rJacobian, 15, 15) = var_x227 * (-00036000000000000002 - var_x235 + 021759999999999998 * var_x242 - 0032639999999999995 * var_x239) + 0.66666666666666674 * (00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0063749999999999996 * var_x87 - 00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x235 * var_x237) / (pow(var_x224, 3) * pow((0.33333333333333337 + var_x225), 2));
        IJth(rJacobian, 16, 15) = var_x251 * (var_x255 + 065303877103145572 * var_x239 - 0.43535918068763713 * var_x242);
        IJth(rJacobian, 17, 15) = 059999999999999998 * var_x240 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0 : (-3611.8217397063127 * var_x66);
        IJth(rJacobian, 1, 16) = 0038 * var_x82;
        IJth(rJacobian, 12, 16) = -0030000000000000001 * var_x210 * var_x211 + 6.2500000000000001e-5 * var_x211 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x209) / pow((025000000000000001 + var_x209), 2);
        IJth(rJacobian, 15, 16) = var_x227 * (var_x235 + 032639999999999995 * var_x243 - 030599999999999995 * var_x244);
        IJth(rJacobian, 16, 16) = var_x251 * (-1.1399999999999999 - var_x255 + 0.61222384784198969 * var_x244 - 0.65303877103145569 * var_x243 - 63.325437108704392 * var_x66) + 00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x237 * var_x255 - var_x247 * var_x43) / (pow(var_x248, 3) * pow(var_x249, 2));
        IJth(rJacobian, 17, 16) = var_x256 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 15, 17) = -015299999999999998 * var_x226 * var_x245;
        IJth(rJacobian, 16, 17) = 0.30611192392099484 * var_x245 * var_x250;
        IJth(rJacobian, 17, 17) = -0050000000000000001 + var_x256 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0 : (001436484375 * var_x70 - 26.713760659695652 * var_x73 - 0.38909660951273101 * var_x67 - 5.1997321379654684e-7 * var_x72 - 2.2983750000000001 * var_x69 - 1.8095260340621999 * var_x71 - 0077469905913117388 * var_x52);
        IJth(rJacobian, 1, 18) = 6.0777327752174832e-11 * var_x72 * var_x82;
        IJth(rJacobian, 18, 18) = 5.0371257222730904e-7 * var_x70 - 4.5479750756676942e-5 * var_x67 - 1.823319832565245e-10 * var_x72 - 9.0551084895961074e-7 * var_x52 - 0031224512033090025 * var_x73 - 00080594011556369446 * var_x69;
        IJth(rJacobian, 19, 18) = 00053729341037579627 * var_x69 - 3.3580838148487267e-7 * var_x70 - 00021150735062926387 * var_x71;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0 : (-2.1862541723894919 * var_x78 - 1.7363944428802174 * var_x74 - 0.62602629555570366 * var_x75 - 0.60640236697509131 * var_x76 - 0.3900209056315565 * var_x77 - 26.713760659695648 * var_x79 - 60.31753446874 * var_x71);
        IJth(rJacobian, 19, 19) = -7.3173394969065143e-5 * var_x75 - 0031224512033090025 * var_x79 - 00025554140647880875 * var_x78 - 7.0879642315114355e-5 * var_x76 - 4.5587787568311439e-5 * var_x77 - 00020295932821508516 * var_x74 - 0070502450209754628 * var_x71;
    }
