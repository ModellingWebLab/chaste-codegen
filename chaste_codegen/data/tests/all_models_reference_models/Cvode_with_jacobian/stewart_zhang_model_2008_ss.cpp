...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x56 = NV_Ith_S(mParameters, 4) * exp(0.013101861787960915 * var_chaste_interface__membrane__V);
        ...
        const double var_x185 = exp(-11.764705882352942 - var_x133 + 0.14705882352941177 * NV_Ith_S(mParameters, 11));
        const double var_x186 = var_chaste_interface__membrane__V < -40.0;
        const double var_x187 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 11));
        const double var_x188 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x189 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 11) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x190 = 1.0 + var_x189;
        const double var_x191 = 0.01 * NV_Ith_S(mParameters, 10);
        const double var_x192 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 11));
        const double var_x193 = 1.0 + var_x192;
        const double var_x194 = 1.0 - var_x191;
        const double var_x195 = var_x191 + var_x194 / pow(var_x193, 2);
        ...
        const double var_x198 = 0.26917900403768508 * var_x192 * var_x194 / pow(var_x193, 3);
        const double var_x199 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 11) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x200 = 1.0 + var_x199;
        const double var_x201 = exp(0.01052 * NV_Ith_S(mParameters, 11) - 0.01052 * var_chaste_interface__membrane__V);
        const double var_x202 = var_x201 / var_x200;
        const double var_x203 = exp(-3.2000000000000002 - var_x33 + 0.10000000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x204 = 1.0 + var_x203;
        const double var_x205 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * NV_Ith_S(mParameters, 11));
        const double var_x206 = var_x205 / var_x204;
        const double var_x207 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 11));
        const double var_x208 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 11) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x209 = -25428.0 * var_x207 - 6.9480000000000002e-6 * var_x208;
        const double var_x210 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 11));
        ...
        const double var_x229 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x240 = exp(2.8571428571428572 + var_x144);
        const double var_x241 = 1.0 + var_x240;
        const double var_x242 = var_x232 / pow(var_x233, 2);
        ...
        const double var_x249 = exp(5.0 + var_x144);
        ...
        const double var_x256 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x253), 2);
        ...
        const double var_x279 = var_chaste_interface__calcium_dynamics__R_prime * NV_Ith_S(mParameters, 1);
        ...
        const double var_x290 = var_x278 * var_x283 * NV_Ith_S(mParameters, 1);
        ...
        const double var_x295 = 0.094772024954610332 * NV_Ith_S(mParameters, 8);
        ...
        const double var_x302 = NV_Ith_S(mParameters, 8) * NV_Ith_S(mParameters, 3);
        const double var_x303 = 0.00063181349969740233 * var_x302;
        const double var_x304 = 0.00027188924024856262 * var_x302;
        const double var_x305 = var_x303 * var_x42;
        ...
        IJth(rJacobian, 7, 0) = (var_x195 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x186) ? (-0.008382352941176471 * var_x185) : (0)) + ((var_x186) ? (108035.0 * var_x187 + 0.21330000000000002 * var_x188) : (0.53361053361053368 * var_x189 / pow(var_x190, 2)))) - var_x198 * (var_x196 + var_x197);
        IJth(rJacobian, 8, 0) = (var_x195 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x186) ? (-0.00025500480000000003 * var_x202 + 0.0033402720000000005 * var_x199 * var_x201 / pow(var_x200, 2)) : (0.034200000000000001 * var_x206 + 0.059999999999999998 * var_x203 * var_x205 / pow(var_x204, 2))) + ((var_x186) ? (var_x213 + var_x212 * var_x214 * (3.0508668000000001e-7 * var_x208 - 6214.6032000000005 * var_x207) - 0.311 * var_x209 * var_x210 * var_x214 / pow(var_x211, 2)) : (0))) - var_x198 * (var_x215 + var_x216);
        IJth(rJacobian, 9, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x230) * (-0.050000000000000003 * var_x217 / pow(var_x218, 2) + 0.27999999999999997 * var_x220 * var_x227 / pow(var_x221, 2) - 0.15076923076923074 * var_x222 * var_x225 / pow(var_x226, 2)) / pow((var_x228 + 0.7142857142857143 * var_x219), 2) + 0.13333333333333333 * var_x229 * var_x231 / pow(var_x230, 2);
        IJth(rJacobian, 10, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x241) * (18.0 * var_x242 - var_x243 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x235 / pow(var_x236, 2)) / pow((0.018140589569160998 + var_x239 + 0.16326530612244897 * var_x234 + 0.18140589569160998 * var_x237), 2) - 0.14285714285714285 * var_x240 * var_x244 / pow(var_x241, 2);
        IJth(rJacobian, 11, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x250) * (8.0 * var_x242 - var_x251 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x245 / pow(var_x246, 2)) / pow((var_x248 + 0.055160142348754451 * var_x247 + 0.14234875444839859 * var_x234), 2) - 0.095714285714285724 * var_x249 * var_x252 / pow(var_x250, 2);
        IJth(rJacobian, 13, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x262) * (-var_x263 * (-0.15625 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + var_x257 / pow(var_x258, 2)) / pow((0.49411764705882355 + var_x260 + 0.058823529411764705 * var_x259), 2) - 0.076923076923076927 * var_x261 * var_x264 / pow(var_x262, 2);
        IJth(rJacobian, 14, 0) = 0.076923076923076927 * var_x265 * var_x268 / pow(var_x266, 2) - 0.09569377990430622 * var_x267 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x266) / pow((0.69856459330143539 + var_x267), 2);
        IJth(rJacobian, 16, 0) = -var_x25 * var_x296;
        IJth(rJacobian, 18, 0) = var_x302 * (-1.8322591491224666e-7 - 0.0018954404990922068 * var_x61 - 9.2026163484925422e-6 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 4.6119913257618111e-6 * var_x69 - 0.00063181349969740233 * var_x47 - 0.0051631799195271718 * var_x67);
        IJth(rJacobian, 19, 0) = var_x302 * (6.318134996974023e-5 * var_x48 + 0.0034421199463514477 * var_x67 - 0.00027188924024856262 * var_x122 - 9.2244770955820725e-6 * var_x31 - 1.4806296640008744e-5 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 0.00063181349969740233 * var_x32 - 0.00063181349969740233 * var_x36 - 0.00063181349969740233 * var_x38 - 1.5425546982578716e-6 * var_x43 - 8.4365684959594308e-7 * var_x44 - 1.4342166443131033e-5 * var_x28);
        ...
        IJth(rJacobian, 15, 1) = var_x272 * (1.2499999999999999e-7 * var_x130 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 16, 1) = 1.1399999999999999 * var_x294;
        IJth(rJacobian, 18, 1) = 0.0047386012477305169 * var_x302 * var_x75;
        ...
        IJth(rJacobian, 18, 2) = var_x302 * (0.00024583649057663214 * var_x77 - 9.2026163484925422e-6 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 19, 2) = var_x302 * (0.00039553186469764944 * var_x40 - 1.4806296640008744e-5 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x42 * var_x51);
        IJth(rJacobian, 3, 3) = -var_x150;
        IJth(rJacobian, 19, 3) = -var_x304 * var_x42 * var_x50;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.43033148291193518 * var_x78);
        IJth(rJacobian, 4, 4) = -var_x160;
        IJth(rJacobian, 19, 4) = -var_x304 * var_x78;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-2 * var_x80);
        IJth(rJacobian, 5, 5) = -var_x170;
        IJth(rJacobian, 19, 5) = -0.0012636269993948047 * var_x302 * var_x80;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x83);
        IJth(rJacobian, 6, 6) = -var_x184;
        IJth(rJacobian, 18, 6) = -0.0018954404990922068 * var_x302 * var_x83;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x84);
        IJth(rJacobian, 7, 7) = -var_x196 - var_x197;
        IJth(rJacobian, 18, 7) = -var_x303 * var_x84;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x85);
        IJth(rJacobian, 8, 8) = -var_x215 - var_x216;
        IJth(rJacobian, 18, 8) = -var_x303 * var_x85;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x93);
        IJth(rJacobian, 9, 9) = -var_x231;
        IJth(rJacobian, 16, 9) = -var_x296 * var_x93;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x96);
        IJth(rJacobian, 10, 10) = -var_x244;
        IJth(rJacobian, 16, 10) = -var_x296 * var_x96;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x101);
        IJth(rJacobian, 11, 11) = -var_x252;
        IJth(rJacobian, 16, 11) = -var_x101 * var_x296;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x104);
        IJth(rJacobian, 12, 12) = -var_x255;
        IJth(rJacobian, 16, 12) = -var_x104 * var_x296;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x105 * var_x37);
        IJth(rJacobian, 13, 13) = -var_x264;
        IJth(rJacobian, 19, 13) = -var_x305 * var_x37;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x105 * var_x106);
        IJth(rJacobian, 14, 14) = -var_x268;
        IJth(rJacobian, 19, 14) = -var_x106 * var_x305;
        IJth(rJacobian, 1, 15) = var_x126 * var_x128;
        IJth(rJacobian, 15, 15) = var_x272 * (-var_x281 - NV_Ith_S(mParameters, 0) + 0.21333333333333335 * var_x287 - 0.032000000000000001 * var_x285) + 0.66666666666666674 * (var_x132 - var_x131 * NV_Ith_S(mParameters, 0) - var_x281 * var_x283) / (pow(var_x269, 3) * pow((0.33333333333333337 + var_x270), 2));
        IJth(rJacobian, 16, 15) = var_x299 * (var_x298 + 0.64023408924652514 * var_x285 - 4.2682272616435011 * var_x287);
        IJth(rJacobian, 17, 15) = 0.059999999999999998 * var_x282 * var_x289;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x109);
        IJth(rJacobian, 1, 16) = 0.0038 * var_x126;
        IJth(rJacobian, 12, 16) = -0.0030000000000000001 * var_x255 * var_x256 + 6.2500000000000001e-5 * var_x256 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x254) / pow((0.025000000000000001 + var_x254), 2);
        IJth(rJacobian, 15, 16) = var_x272 * (var_x281 + 0.32000000000000001 * var_x288 - 0.29999999999999999 * var_x291);
        IJth(rJacobian, 16, 16) = var_x299 * (-1.1399999999999999 - var_x298 + 6.0021945866861737 * var_x291 - 6.4023408924652525 * var_x288 - var_x109 * var_x295) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x283 * var_x298 - var_x295 * ((var_x14) ? (-var_x300 + 374338.90822798351 * (-14.999998664311967 + var_chaste_interface__membrane__V) * (var_x300 + var_x89 * var_chaste_interface__L_type_Ca_current_d_gate__d)) : (var_x13 * var_x22))) / (pow(var_x292, 3) * pow(var_x293, 2));
        IJth(rJacobian, 17, 16) = var_x301 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 15, 17) = -var_x271 * var_x277 * var_x290;
        IJth(rJacobian, 16, 17) = var_x290 * var_x294 * var_x297;
        IJth(rJacobian, 17, 17) = -0.0050000000000000001 + var_x301 * var_chaste_interface__calcium_dynamics__Ca_ss;
        ...
        IJth(rJacobian, 18, 18) = var_x302 * (3.2269874497044823e-6 * var_x114 - 0.016878114612481093 * var_x115 - 4.8946532376195178e-6 * var_x76 - 0.0056863214972766203 * var_x116 - 0.00024583649057663214 * var_x110 - 0.0051631799195271718 * var_x113);
        IJth(rJacobian, 19, 18) = var_x302 * (0.0034421199463514477 * var_x113 - 2.151324966469655e-6 * var_x114 - 0.00050634343837443281 * var_x111);
        ...
        IJth(rJacobian, 19, 19) = var_x302 * (-0.00024642047334222399 * var_x119 - 0.016878114612481093 * var_x111 - 0.016878114612481093 * var_x120 - 0.016878114612481093 * var_x121 - 0.00038313320170332084 * var_x118 - 0.00039553186469764944 * var_x117 - 0.0072631840899465916 * var_x123);
    }
