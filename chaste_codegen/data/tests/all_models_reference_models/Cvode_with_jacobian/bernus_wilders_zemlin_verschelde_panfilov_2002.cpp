...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 1, 0) = (1.0 - var_chaste_interface__sodium_current_m_gate__m) * ((var_x60) ? (0.16 * var_x57 + 0.16 * var_x58) : (var_x63 - 0.032000000000000001 * var_x59 * var_x61 / pow(var_x62, 2))) + 0.0072727272727272727 * var_x64 * var_chaste_interface__sodium_current_m_gate__m;
        ...
        IJth(rJacobian, 1, 1) = -((var_x60) ? (var_x65 - 499999.99998562218 * (47.129999000000005 + var_chaste_interface__membrane__V) * (-var_x65 - 3.200000000092018e-7 * var_x57)) : (var_x59 * var_x63)) - 0.080000000000000002 * var_x64;
