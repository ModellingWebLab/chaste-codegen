...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x184 = exp(-3.2000000000000002 - var_x21);
        ...
        const double var_x228 = 14.994515539305301 / (1.0 + 3.0 * var_x227);
        ...
        const double var_x235 = 0.00173434701107436 * var_x29;
        const double var_x236 = 6.3176611368492499e-5 * var_x40;
        const double var_x237 = 0.00029975531551766426 * var_x13 - 1.1221007754625865e-5 * var_chaste_interface__membrane__V;
        const double var_x238 = 0.00022793893784155717 * var_x13 - 8.5326413134134178e-6 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 15, 0) = -3.389679425876563e-8 - 3.0388663876087418e-8 * var_x11 - 7.3941785176126768e-11 * var_x34 - 0.00040297005778184723 * var_x46 - var_x235 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 16, 0) = 0.00026864670518789814 * var_x46 + 3.79059668210955e-6 * var_x37 - 2.8537261917770623e-7 * var_x32 - 6.3176611368492499e-5 * var_x26 - 8.5326413134134178e-6 * var_x4 - 1.1221007754625865e-5 * var_x27 - 1.7065282626826835e-6 * var_x3 - 2.8636946873784758e-5 * var_x0 - var_x236 * var_x39;
        ...
        IJth(rJacobian, 13, 13) = var_x228 * (-8.0000000000000007e-5 + var_x111 * (var_x110 - var_x109)) + 9.9963436928702016 * pow(var_x226, (-3.0)) * (var_x100 + var_x99 - var_x107 - var_x98) / pow((0.33333333333333337 + var_x227), 2);
        ...
        IJth(rJacobian, 16, 16) = 0.00010126109252331096 * var_x89 - 0.0073440052301827737 * var_x81 - 0.00029975531551766426 * var_x85 - 0.0016876848753885161 * var_x84 - 4.5587787568311439e-5 * var_x83 - 0.00022793893784155717 * var_x86 - var_x236 * var_x88;
    }
