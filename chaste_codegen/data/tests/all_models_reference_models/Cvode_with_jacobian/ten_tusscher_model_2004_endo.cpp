...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x27 = NV_Ith_S(mParameters, 3) * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        const double var_x34 = NV_Ith_S(mParameters, 2) * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x35 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3);
        const double var_x36 = var_x35 * NV_Ith_S(mParameters, 1) * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x55 = var_x52 * var_x54 * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_current_fCa_gate__fCa;
        ...
        const double var_x61 = var_x54 * var_x60 * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_current_f_gate__f / pow(var_x51, 2);
        const double var_x62 = var_x52 * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_current_f_gate__f;
        ...
        const double var_x69 = 14447.286958825251 * var_x58;
        const double var_x70 = var_x62 * var_x69;
        const double var_x71 = (26.713760659695648 * var_x13 - 1.0 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2);
        ...
        const double var_x73 = 26.713760659695652 * var_x11;
        const double var_x74 = (-var_x73 * log10(9.5999999999999996 * var_x72) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs;
        const double var_x75 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        const double var_x76 = -var_x73 * log10(140.0 * var_x75) + var_chaste_interface__membrane__V;
        const double var_x77 = var_x76 * NV_Ith_S(mParameters, 1) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x78 = var_x77 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x79 = var_x36 * var_x76;
        const double var_x80 = var_x35 * var_x77;
        const double var_x81 = var_x29 - var_chaste_interface__membrane__V;
        const double var_x82 = NV_Ith_S(mParameters, 3) * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        const double var_x114 = var_x98 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        const double var_x115 = var_x114 * var_chaste_interface__membrane__V;
        ...
        const double var_x122 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x123 = exp(-3.7142857142857144 - var_x122);
        const double var_x124 = 1.0 + var_x123;
        const double var_x125 = 1 / var_x124 - var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        const double var_x133 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x134 = 1.0 + var_x133;
        const double var_x135 = 1 / var_x134 - var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        const double var_x144 = 1 / var_x143 - var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs;
        ...
        const double var_x155 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x156 = 1.0 + var_x155;
        const double var_x157 = pow(var_x156, (-2)) - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x158 = exp(-12.0 - var_x147);
        const double var_x159 = 1.0 + var_x158;
        const double var_x160 = var_x154 * var_x159;
        const double var_x161 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V);
        const double var_x162 = 1.0 + var_x161;
        const double var_x163 = pow(var_x162, (-2));
        ...
        const double var_x172 = 0.26917900403768508 * var_x161 / pow(var_x162, 3);
        ...
        const double var_x201 = exp(-0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x208 = exp(2.8571428571428572 + var_x122);
        ...
        const double var_x219 = exp(5.5999999999999996 + var_x147);
        ...
        const double var_x223 = exp(3.3333333333333335 + var_x139);
        ...
        const double var_x230 = var_x229 * (-0.0082319999999999997 - var_x110);
        ...
        const double var_x237 = (0.0031224512033090025 * var_x13 - 0.00011688549744401942 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2);
        const double var_x238 = 0.0031224512033090025 * var_x13 - 0.00011688549744401942 * var_chaste_interface__membrane__V;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00088199999999999997 - var_x28 - var_x37 + 1081.6363254030778 * var_x61 + 0.03243 * var_x40 - 0.245 * var_x0 - 0.0146 * var_x3 - 0.0024414715719063545 * var_x31 - 1081.6363254030778 * var_x63 - 8.6662202299424464e-5 * var_x10 - 0.54050000000000009 * var_x26 - 1.1491875 * var_x49 - 2.1086672225679691e-7 * var_x33 - 1.0 * var_x34 - var_x42 * var_x44 - var_x57 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 1, 0) = var_x98 * (-3.4598107243429746e-8 + 2.464726172537559e-11 * var_x33 + 1.0129554625362472e-8 * var_x10 + 0.06321379997413 * var_x61 - 0.06321379997413 * var_x63 - var_x99 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x121 * var_x125 * var_x126 + 0.14285714285714285 * var_x123 * var_x128 / pow(var_x124, 2) - 0.10000000000000001 * var_x120 * var_x125 * var_x127;
        IJth(rJacobian, 3, 0) = 0.01488095238095238 * var_x132 * var_x135 * var_x136 - 0.041666666666666664 * var_x133 * var_x138 / pow(var_x134, 2) - 0.050000000000000003 * var_x131 * var_x135 * var_x137;
        IJth(rJacobian, 4, 0) = 4.5454545454545452e-5 * var_x136 * var_x141 * var_x144 + 6.4935064935064935e-5 * var_x142 * var_x146 / pow(var_x143, 2) - 7.5757575757575758e-5 * var_x140 * var_x144 * var_x145 / var_x141;
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x155 * var_x160 / pow(var_x156, 3) - 0.20000000000000001 * var_x154 * var_x157 * var_x158 + 99.999999999999986 * var_x157 * var_x159 * (0.02 * var_x148 / pow(var_x149, 2) + 0.00050000000000000001 * var_x151 / pow(var_x152, 2)) / pow((var_x150 + var_x153), 2);
        IJth(rJacobian, 6, 0) = (var_x163 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x165) ? (-0.008382352941176471 * var_x164) : (0)) + ((var_x165) ? (108035.0 * var_x166 + 0.21330000000000002 * var_x167) : (0.53361053361053368 * var_x168 / pow(var_x169, 2)))) - var_x172 * (var_x170 + var_x171);
        IJth(rJacobian, 7, 0) = (var_x163 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x165) ? (-0.00025500480000000003 * var_x176 + 0.0033402720000000005 * var_x173 * var_x175 / pow(var_x174, 2)) : (0.034200000000000001 * var_x180 + 0.059999999999999998 * var_x177 * var_x179 / pow(var_x178, 2))) + ((var_x165) ? (var_x187 + var_x183 * var_x188 * (3.0508668000000001e-7 * var_x185 - 6214.6032000000005 * var_x184) - 0.311 * var_x181 * var_x186 * var_x188 / pow(var_x182, 2)) : (0))) - var_x172 * (var_x189 + var_x190);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (1 / var_x202 - var_chaste_interface__L_type_Ca_current_d_gate__d) * (-0.050000000000000003 * var_x191 / pow(var_x192, 2) + 0.27999999999999997 * var_x194 * var_x199 / pow(var_x195, 2) - 0.15076923076923074 * var_x196 * var_x197 / pow(var_x198, 2)) / pow((var_x200 + 0.7142857142857143 * var_x193), 2) + 0.13333333333333333 * var_x201 * var_x203 / pow(var_x202, 2);
        IJth(rJacobian, 9, 0) = 7.9012345679012348e-7 * (1 / var_x209 - var_chaste_interface__L_type_Ca_current_f_gate__f) * (-var_x210 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 16.5 * var_x204 / pow(var_x205, 2)) / pow((0.071111111111111111 + var_x207 + 0.14666666666666667 * var_x206), 2) - 0.14285714285714285 * var_x208 * var_x211 / pow(var_x209, 2);
        IJth(rJacobian, 11, 0) = -0.20000000000000001 * var_x219 * var_x222 / pow(var_x220, 2) - 0.001 * var_x221 * (-0.13400000000000001 - 0.002 * var_chaste_interface__membrane__V) * (1 / var_x220 - var_chaste_interface__transient_outward_current_s_gate__s) / pow((0.0080000000000000002 + var_x221), 2);
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x223 * var_x226 / pow(var_x224, 2) - 0.10526315789473684 * var_x225 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (1 / var_x224 - var_chaste_interface__transient_outward_current_r_gate__r) / pow((0.084210526315789472 + var_x225), 2);
        IJth(rJacobian, 15, 0) = -3.389679425876563e-8 - 3.0388663876087418e-8 * var_x10 - 0.00011688549744401942 * var_x37 - 7.3941785176126768e-11 * var_x33 - 0.00040297005778184723 * var_x49;
        IJth(rJacobian, 16, 0) = 0.00026864670518789814 * var_x49 + 3.79059668210955e-6 * var_x40 - 2.8537261917770623e-7 * var_x31 - 0.00011688549744401942 * var_x28 - 6.3176611368492499e-5 * var_x26 - 1.7065282626826835e-6 * var_x3 - 2.8636946873784758e-5 * var_x0 - 0.00011688549744401942 * var_x34 - var_x236 * var_x42;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.82499999999999996 * var_x67 + 594.50270777405183 * var_x68 - 0.82499999999999996 * var_x65 - 0.0079072731552699126 * var_x66 - var_x59 * var_x70);
        IJth(rJacobian, 1, 1) = var_x98 * (-8.0000000000000007e-5 - var_x100 - var_x102 + 4.8215267695658011e-5 * var_x67 - 0.069488744729986562 * var_x68 - 4.6212277808973232e-7 * var_x66 - var_x103 * var_x60) + 0.00029999999999999997 * (var_x104 + var_x113 - var_x105 - var_x106 - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - var_x100 * var_chaste_interface__calcium_dynamics__Ca_i - var_x58 * var_x99 + 1.0129554625362472e-8 * var_x32 * var_x6 + 4.6212277808973232e-7 * var_x11 * log10(2.0 * var_x66)) / (pow(var_x96, 3) * pow(var_x97, 2));
        IJth(rJacobian, 10, 1) = ((var_x218) ? (0) : (-3.4101542475452148e-28 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 7) / pow((1.2447063003540035e-28 + var_x217), 2) - 85.61643835616438 * var_x215 / pow(var_x216, 2) - 342.46575342465752 * var_x213 / pow(var_x214, 2)));
        IJth(rJacobian, 13, 1) = var_x229 * (8.0000000000000007e-5 + var_x102);
        IJth(rJacobian, 14, 1) = ((var_x235) ? (0) : ((var_x232) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5) / pow((1.8382656249999998e-21 + var_x233), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15) / pow((5.0709427749024951e-56 + var_x234), 2))));
        IJth(rJacobian, 15, 1) = 0.20846623418995969 * var_x68;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x71 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2);
        ...
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (var_x71 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1);
        IJth(rJacobian, 3, 3) = -var_x138;
        IJth(rJacobian, 16, 3) = var_x237 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.48999999999999999 * var_x74);
        IJth(rJacobian, 4, 4) = -0.00090909090909090909 * var_x146;
        IJth(rJacobian, 16, 4) = -5.7273893747569515e-5 * var_x74;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x78);
        IJth(rJacobian, 5, 5) = -var_x160;
        IJth(rJacobian, 15, 5) = -0.00035065649233205829 * var_x78;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x79);
        IJth(rJacobian, 6, 6) = -var_x170 - var_x171;
        IJth(rJacobian, 15, 6) = -0.00011688549744401942 * var_x79;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x80);
        IJth(rJacobian, 7, 7) = -var_x189 - var_x190;
        IJth(rJacobian, 15, 7) = -0.00011688549744401942 * var_x80;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x57 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 1, 8) = var_x98 * (var_x112 - var_x99 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 8, 8) = -var_x203;
        IJth(rJacobian, 13, 8) = var_x230 * var_chaste_interface__calcium_dynamics__g;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * var_x69);
        IJth(rJacobian, 1, 9) = -0.84433916144939192 * var_x115 * var_x55;
        IJth(rJacobian, 9, 9) = -var_x211;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x54 * var_x70);
        IJth(rJacobian, 1, 10) = -var_x103 * var_x115 * var_x54;
        IJth(rJacobian, 10, 10) = ((var_x218) ? (0) : (-0.5));
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x27 * var_x81);
        IJth(rJacobian, 11, 11) = -var_x222;
        IJth(rJacobian, 16, 11) = var_x238 * var_x27;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x81 * var_x82);
        IJth(rJacobian, 12, 12) = -var_x226;
        IJth(rJacobian, 16, 12) = var_x238 * var_x82;
        IJth(rJacobian, 1, 13) = var_x98 * (8.0000000000000007e-5 + var_x118 * (var_x116 - var_x117));
        IJth(rJacobian, 13, 13) = var_x229 * (-8.0000000000000007e-5 + var_x118 * (var_x117 - var_x116)) + 9.9963436928702016 * (var_x105 + var_x106 - var_x104 - var_x113) / (pow(var_x227, 3) * pow((0.33333333333333337 + var_x228), 2));
        IJth(rJacobian, 1, 14) = var_x111 * var_x114;
        IJth(rJacobian, 13, 14) = var_x230 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 14, 14) = ((var_x235) ? (0) : (-0.5));
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.00071824218750000002 * var_x86 - 26.713760659695652 * var_x88 - 0.19634614084876301 * var_x83 - 0.00051997321379654684 * var_x87 - 1.1491875 * var_x85 - 0.0077469905913117388 * var_x75);
        IJth(rJacobian, 1, 15) = 6.0777327752174836e-8 * var_x87 * var_x98;
        IJth(rJacobian, 15, 15) = 2.5185628611365452e-7 * var_x86 - 9.0551084895961074e-7 * var_x75 - 1.823319832565245e-7 * var_x87 - 0.0031224512033090025 * var_x88 - 0.00040297005778184723 * var_x85;
        IJth(rJacobian, 16, 15) = 0.00026864670518789814 * var_x85 - 1.6790419074243634e-7 * var_x86 - 2.2950016344321166e-5 * var_x83;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (0.86632725819392997 * var_x95 - 26.713760659695652 * var_x91 - 6.5448713616254341 * var_x83 - 14.4387876365655 * var_x90 - 0.3900209056315565 * var_x89 - 26.713760659695648 * var_x94 - var_x44 * var_x93);
        IJth(rJacobian, 16, 16) = 0.00010126109252331096 * var_x95 - 0.0031224512033090025 * var_x94 - 0.0016876848753885161 * var_x90 - 4.5587787568311439e-5 * var_x89 - 0.00076500054481070561 * var_x83 - 0.0031224512033090025 * var_x91 - var_x236 * var_x93;
    }
