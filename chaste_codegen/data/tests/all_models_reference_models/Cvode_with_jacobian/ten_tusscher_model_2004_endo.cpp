...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x169 = exp(0.34849999999999998 * var_chaste_interface__membrane__V);
        const double var_x170 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
        ...
        const double var_x173 = 0.01 * NV_Ith_S(mParameters, 14);
        const double var_x174 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 15));
        ...
        const double var_x189 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
        const double var_x190 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x191 = -25428.0 * var_x189 - 6.9480000000000002e-6 * var_x190;
        const double var_x192 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
        ...
        const double var_x199 = exp(2.5 + var_x136);
        ...
        const double var_x209 = exp(-0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x210 = 1.0 + var_x209;
        const double var_x211 = 1 / (var_x201 + 1.3999999999999999 * var_x208);
        const double var_x212 = exp(2.5 + var_x125);
        const double var_x213 = 1.0 + var_x212;
        const double var_x214 = 1 / var_x213;
        const double var_x215 = exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2));
        const double var_x216 = exp(2.8571428571428572 + var_x128);
        const double var_x217 = 1.0 + var_x216;
        const double var_x218 = 1125.0 * var_x215;
        const double var_x219 = 1 / (80.0 + var_x218 + 165.0 * var_x214);
        const double var_x220 = var_chaste_interface__membrane__V > -60.0;
        const double var_x221 = exp(-5.0 + 10000.0 * var_chaste_interface__calcium_dynamics__Ca_i);
        const double var_x222 = 1.0 + var_x221;
        const double var_x223 = exp(-0.9375 + 1250.0 * var_chaste_interface__calcium_dynamics__Ca_i);
        const double var_x224 = 1.0 + var_x223;
        const double var_x225 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 8);
        const double var_x226 = (var_x220) && (var_chaste_interface__L_type_Ca_current_fCa_gate__fCa < 0.15753424657534248 + 0.068493150684931517 / var_x222 + 0.13698630136986303 / var_x224 + 0.68493150684931503 / (1.0 + 8.034023767017109e+27 * var_x225));
        const double var_x227 = 1 / NV_Ith_S(mParameters, 8);
        const double var_x228 = exp(5.5999999999999996 + var_x153);
        const double var_x229 = 1.0 + var_x228;
        const double var_x230 = exp(-4.4889999999999999 * pow((1 + 0.014925373134328358 * var_chaste_interface__membrane__V), 2));
        const double var_x231 = 1 / (8.0 + 1000.0 * var_x230);
        const double var_x232 = exp(3.3333333333333335 + var_x145);
        const double var_x233 = 1.0 + var_x232;
        const double var_x234 = exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_x235 = 1 / (0.80000000000000004 + 9.5 * var_x234);
        const double var_x236 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x237 = pow(var_x236, (-2));
        const double var_x238 = 14.994515539305301 / (1.0 + 3.0 * var_x237);
        const double var_x239 = var_x238 * (-0.0082319999999999997 - var_x116);
        const double var_x240 = var_chaste_interface__calcium_dynamics__Ca_i >= 0.00035;
        const double var_x241 = var_chaste_interface__calcium_dynamics__Ca_i < 0.00035;
        const double var_x242 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6);
        const double var_x243 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16);
        const double var_x244 = (((var_x220) || (var_x240))) && (((var_x220) || (var_x241))) && (((var_x240) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x242)))) && (((var_x241) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x243))));
        const double var_x245 = NV_Ith_S(mParameters, 12) * NV_Ith_S(mParameters, 3);
        const double var_x246 = 0.00063181349969740233 * var_x245;
        const double var_x247 = var_x246 * var_x7 * var_x81;
        const double var_x248 = 2.7188924024856265e-5 * var_x48;
        const double var_x249 = 0.00027188924024856262 * var_x245;
        const double var_x250 = var_x246 * var_x28;
        ...
        IJth(rJacobian, 9, 0) = 7.9012345679012348e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x217) * (-var_x218 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 16.5 * var_x212 / pow(var_x213, 2)) / pow((0.071111111111111111 + var_x215 + 0.14666666666666667 * var_x214), 2) - 0.14285714285714285 * var_x216 * var_x219 / pow(var_x217, 2);
        IJth(rJacobian, 11, 0) = -0.20000000000000001 * var_x228 * var_x231 / pow(var_x229, 2) - 0.001 * var_x230 * (-0.13400000000000001 - 0.002 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x229) / pow((0.0080000000000000002 + var_x230), 2);
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x232 * var_x235 / pow(var_x233, 2) - 0.10526315789473684 * var_x234 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x233) / pow((0.084210526315789472 + var_x234), 2);
        IJth(rJacobian, 15, 0) = var_x245 * (-0.0018954404990922068 * var_x39 - 0.0018954404990922068 * var_x63 - 4.6119913257618111e-6 * var_x44 - 0.00063181349969740233 * var_x91 - 0.00063181349969740233 * NV_Ith_S(mParameters, 10));
        IJth(rJacobian, 16, 0) = var_x245 * (0.0012636269993948047 * var_x63 + 1.631335441491376e-6 * var_x42 - 0.00027188924024856262 * var_x98 - 2.7188924024856265e-5 * var_x26 - 0.00010565443138752546 * var_x29 - 0.00063181349969740233 * var_x2 - 0.00063181349969740233 * var_x3 - 0.00063181349969740233 * var_x5 - var_x248 * var_x46);
        ...
        IJth(rJacobian, 10, 1) = ((var_x226) ? (0) : (var_x227 * (-6.8203084950904297e-28 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 7) / pow((1.2447063003540035e-28 + var_x225), 2) - 171.23287671232876 * var_x223 / pow(var_x224, 2) - 684.93150684931504 * var_x221 / pow(var_x222, 2))));
        IJth(rJacobian, 13, 1) = var_x238 * (var_x110 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 14, 1) = ((var_x244) ? (0) : ((var_x241) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5) / pow((1.8382656249999998e-21 + var_x242), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15) / pow((5.0709427749024951e-56 + var_x243), 2))));
        IJth(rJacobian, 15, 1) = 0.0047386012477305169 * var_x245 * var_x73;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x28);
        IJth(rJacobian, 2, 2) = -var_x134;
        IJth(rJacobian, 16, 2) = -var_x10 * var_x249 * var_x28;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.43033148291193518 * var_x75);
        IJth(rJacobian, 3, 3) = -var_x144;
        IJth(rJacobian, 16, 3) = -var_x249 * var_x75;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-2.0 * var_x77);
        IJth(rJacobian, 4, 4) = -0.00090909090909090909 * var_x152;
        IJth(rJacobian, 16, 4) = -0.0012636269993948047 * var_x245 * var_x77;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x80);
        IJth(rJacobian, 5, 5) = -var_x166;
        IJth(rJacobian, 15, 5) = -0.0018954404990922068 * var_x245 * var_x80;
        ...
        IJth(rJacobian, 15, 6) = -var_x247 * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        IJth(rJacobian, 15, 7) = -var_x247 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        IJth(rJacobian, 13, 8) = var_x239 * var_chaste_interface__calcium_dynamics__g;
        ...
        IJth(rJacobian, 10, 10) = ((var_x226) ? (0) : (-var_x227));
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 11, 11) = -var_x231;
        IJth(rJacobian, 16, 11) = -var_x250 * var_x4;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 12, 12) = -var_x235;
        IJth(rJacobian, 16, 12) = -var_x250 * NV_Ith_S(mParameters, 22) * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 13) = var_x107 * (var_x124 * (var_x123 - var_x122) + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 13, 13) = var_x238 * (var_x108 + var_x124 * (var_x122 - var_x123)) + 9.9963436928702016 * (var_x112 - var_x111 - var_x119) / (pow(var_x236, 3) * pow((0.33333333333333337 + var_x237), 2));
        IJth(rJacobian, 1, 14) = var_x107 * var_x117 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 13, 14) = var_x239 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 14, 14) = ((var_x244) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 15, 15) = var_x245 * (1.1846503119326294e-6 * var_x93 - 0.0018954404990922068 * var_x90 - 0.016878114612481093 * var_x87 - 0.016878114612481093 * var_x92 - 0.0056863214972766203 * var_x94);
        IJth(rJacobian, 16, 15) = var_x245 * (0.0012636269993948047 * var_x90 - 0.00050634343837443281 * var_x88 - 7.8976687462175284e-7 * var_x93);
        ...
        IJth(rJacobian, 16, 16) = var_x245 * (4.357910453967955e-5 * var_x102 - 0.016878114612481093 * var_x88 - 0.016878114612481093 * var_x95 - 0.016878114612481093 * var_x96 - 0.00072631840899465921 * var_x97 - 0.0072631840899465916 * var_x99 - var_x101 * var_x248);
    }
