...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x205 = exp(2.8571428571428572 + var_x115);
        ...
        const double var_x236 = 0.00022793893784155717 * var_x13 - 8.5326413134134178e-6 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 16, 0) = 0.00026864670518789814 * var_x46 + 3.79059668210955e-6 * var_x37 - 2.8537261917770623e-7 * var_x32 - 6.3176611368492499e-5 * var_x26 - 8.5326413134134178e-6 * var_x4 - 1.1221007754625865e-5 * var_x27 - 1.7065282626826835e-6 * var_x3 - 2.8636946873784758e-5 * var_x0 - var_x234 * var_x39;
        ...
        IJth(rJacobian, 16, 16) = 0.00010126109252331096 * var_x89 - 0.0073440052301827737 * var_x81 - 0.00029975531551766426 * var_x85 - 0.0016876848753885161 * var_x84 - 4.5587787568311439e-5 * var_x83 - 0.00022793893784155717 * var_x86 - var_x234 * var_x88;
    }
