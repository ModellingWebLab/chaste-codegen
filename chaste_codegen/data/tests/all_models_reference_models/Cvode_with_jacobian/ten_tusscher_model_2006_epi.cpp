...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x74 = -NV_Ith_S(mParameters, 4) + 0.25 * var_x73;
        const double var_x75 = var_x74 * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x76 = var_x72 * var_x75;
        const double var_x77 = pow(NV_Ith_S(mParameters, 7), 2);
        const double var_x78 = var_x38 * var_x77;
        const double var_x79 = 4.0 * var_x78;
        const double var_x80 = 1 / (pow(NV_Ith_S(mParameters, 8), 2) * pow(NV_Ith_S(mParameters, 22), 2));
        const double var_x81 = var_x80 * pow(NV_Ith_S(mParameters, 7), 3);
        const double var_x82 = var_x68 * var_x70 * var_x75 / pow(var_x71, 2);
        const double var_x83 = var_x72 * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f;
        ...
        const double var_x89 = var_x87 * var_x88 * NV_Ith_S(mParameters, 10);
        const double var_x90 = var_x45 * var_x49;
        const double var_x91 = var_x63 * NV_Ith_S(mParameters, 18) * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        const double var_x93 = (-var_x20 * log(var_x92 * (0.029999999999999999 * NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 5))) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 19) * var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs;
        const double var_x94 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        const double var_x95 = -var_x20 * log(var_x94 * NV_Ith_S(mParameters, 6)) + var_chaste_interface__membrane__V;
        const double var_x96 = NV_Ith_S(mParameters, 13) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x97 = var_x95 * var_x96 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x98 = var_x95;
        const double var_x99 = var_x10 * var_x96;
        const double var_x100 = var_x68 * var_x83;
        const double var_x101 = var_x74 * var_x79;
        const double var_x102 = var_x68 * var_x72 * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x103 = var_x101 * var_x102;
        const double var_x104 = var_x68 * var_x72 * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x105 = (var_x21 - var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 21);
        const double var_x106 = var_x100 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        const double var_x107 = var_x106 * var_x70;
        const double var_x108 = var_x53 * NV_Ith_S(mParameters, 5) / var_x57;
        ...
        const double var_x114 = 0.029999999999999999 * var_x113;
        ...
        const double var_x124 = var_x19 * NV_Ith_S(mParameters, 12);
        const double var_x125 = 30.480370641307001 * var_x124;
        const double var_x126 = 0.066691050963179718 * NV_Ith_S(mParameters, 0);
        const double var_x127 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
        const double var_x128 = NV_Ith_S(mParameters, 2) / (pow(var_x127, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
        const double var_x129 = -var_chaste_interface__calcium_dynamics__Ca_i + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x130 = NV_Ith_S(mParameters, 2) / var_x127;
        ...
        const double var_x135 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x136 = exp(-3.7142857142857144 - var_x135);
        const double var_x137 = 1.0 + var_x136;
        const double var_x138 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + 1 / var_x137;
        ...
        const double var_x146 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x147 = 1.0 + var_x146;
        const double var_x148 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 + 1 / var_x147;
        ...
        const double var_x160 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        ...
        const double var_x177 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 15) - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x178 = var_chaste_interface__membrane__V < -40.0 + NV_Ith_S(mParameters, 15);
        const double var_x179 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 15));
        const double var_x180 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 15));
        const double var_x181 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 15) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        ...
        const double var_x191 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 15) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x192 = 1.0 + var_x191;
        const double var_x193 = exp(0.01052 * NV_Ith_S(mParameters, 15) - 0.01052 * var_chaste_interface__membrane__V);
        const double var_x194 = var_x193 / var_x192;
        const double var_x195 = exp(-3.2000000000000002 - var_x29 + 0.10000000000000001 * NV_Ith_S(mParameters, 15));
        const double var_x196 = 1.0 + var_x195;
        const double var_x197 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * NV_Ith_S(mParameters, 15));
        const double var_x198 = var_x197 / var_x196;
        const double var_x199 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 15));
        const double var_x200 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 15) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x201 = -25428.0 * var_x199 - 6.9480000000000002e-6 * var_x200;
        const double var_x202 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 15));
        ...
        const double var_x219 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x230 = exp(2.8571428571428572 + var_x135);
        const double var_x231 = 1.0 + var_x230;
        const double var_x232 = var_x222 / pow(var_x223, 2);
        ...
        const double var_x239 = exp(5.0 + var_x135);
        ...
        const double var_x246 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x243), 2);
        ...
        const double var_x269 = var_chaste_interface__calcium_dynamics__R_prime * NV_Ith_S(mParameters, 1);
        ...
        const double var_x280 = var_x268 * var_x273 * NV_Ith_S(mParameters, 1);
        const double var_x281 = var_x265 * var_x279 * var_x280;
        const double var_x282 = var_x39 * NV_Ith_S(mParameters, 12);
        const double var_x283 = 36576.444769568399 * var_x282;
        const double var_x284 = var_x283 * var_x76;
        const double var_x285 = var_x77 * var_x80 * NV_Ith_S(mParameters, 12);
        ...
        const double var_x290 = var_x283 * var_x288 * var_x74;
        const double var_x291 = var_x102 * var_x290;
        ...
        const double var_x295 = var_x124 * NV_Ith_S(mParameters, 3);
        const double var_x296 = 60.960741282614002 * var_x295;
        const double var_x297 = var_x296 * var_x95;
        const double var_x298 = 26.23332619555811 * var_x295;
        const double var_x299 = var_x296 * var_x36;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x52 - var_x0 - var_x13 - var_x17 - var_x35 - var_x37 - var_x4 - var_x6 - var_x65 - var_x9 - var_x50 - NV_Ith_S(mParameters, 10) - 2.7240000000000002 * var_x58 - 0.065000000000000002 * var_x67 - var_x76 * var_x79 + 8.0 * var_x81 * var_x82 - var_x69 * var_x73 * var_x81 * var_x83 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 1, 0) = -var_x123 * var_x125 * (-2.0 * var_x50 - 0.13 * var_x67 + NV_Ith_S(mParameters, 10));
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x134 * var_x138 * var_x139 + 0.14285714285714285 * var_x136 * var_x141 / pow(var_x137, 2) - 0.10000000000000001 * var_x133 * var_x138 * var_x140;
        IJth(rJacobian, 3, 0) = 0.01488095238095238 * var_x145 * var_x148 * var_x149 - 0.041666666666666664 * var_x146 * var_x151 / pow(var_x147, 2) - 0.050000000000000003 * var_x144 * var_x148 * var_x150;
        IJth(rJacobian, 4, 0) = 5.1020408163265302e-7 * (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1 / var_x161) * (93.333333333333329 * var_x155 * var_x156 / pow(var_x157, 2) - 116.66666666666667 * var_x153 * var_x158 / pow(var_x154, (3 / 2))) / pow((0.057142857142857141 + var_x159), 2) + 0.071428571428571425 * var_x160 * var_x162 / pow(var_x161, 2);
        ...
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x231) * (18.0 * var_x232 - var_x233 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x225 / pow(var_x226, 2)) / pow((0.018140589569160998 + var_x229 + 0.16326530612244897 * var_x224 + 0.18140589569160998 * var_x227), 2) - 0.14285714285714285 * var_x230 * var_x234 / pow(var_x231, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x240) * (8.0 * var_x232 - var_x241 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x235 / pow(var_x236, 2)) / pow((var_x238 + 0.055160142348754451 * var_x237 + 0.14234875444839859 * var_x224), 2) - 0.095714285714285724 * var_x239 * var_x242 / pow(var_x240, 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x252) * (-var_x253 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + var_x247 / pow(var_x248, 2)) / pow((0.035294117647058823 + var_x250 + 0.058823529411764705 * var_x249), 2) - 0.20000000000000001 * var_x251 * var_x254 / pow(var_x252, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x255 * var_x258 / pow(var_x256, 2) - 0.10526315789473684 * var_x257 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x256) / pow((0.084210526315789472 + var_x257), 2);
        IJth(rJacobian, 15, 0) = var_x289 * (-var_x284 + 73152.889539136799 * var_x285 * var_x82 - 18288.2223847842 * var_x106 * var_x285 * var_x73);
        IJth(rJacobian, 17, 0) = -var_x296 * (var_x12 + 3.0 * var_x50 + 8.1720000000000006 * var_x58 + 0.19500000000000001 * var_x67 + NV_Ith_S(mParameters, 11));
        IJth(rJacobian, 18, 0) = -var_x296 * (var_x17 + var_x3 + var_x35 + var_x37 + var_x5 + var_x65 + var_x8 - var_x52 - 5.4480000000000004 * var_x58);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86 - var_x85 - var_x89 + 2.5 * var_x90);
        IJth(rJacobian, 1, 1) = var_x123 * (-0.0038 - var_x126 - 8.3363813703974642e-9 * var_x128 - var_x125 * (var_x85 + var_x89 - var_x86 + 5.0 * var_x90)) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss - 0.0038 * var_chaste_interface__calcium_dynamics__Ca_i - 0.066691050963179718 * var_x130 + var_x126 * var_x129 - var_x125 * (var_x85 * var_chaste_interface__calcium_dynamics__Ca_i + (-var_x88 * log(var_x87 * NV_Ith_S(mParameters, 4)) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 10) - 2.0 * var_x49 * var_x66)) / (pow(var_x121, 3) * pow(var_x122, 2));
        IJth(rJacobian, 14, 1) = var_x262 * (1.2499999999999999e-7 * var_x128 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 15, 1) = 1.1399999999999999 * var_x288;
        IJth(rJacobian, 17, 1) = 457.20555961960503 * var_x295 * var_x90;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x16 * var_x36);
        IJth(rJacobian, 2, 2) = -var_x141;
        IJth(rJacobian, 18, 2) = -var_x15 * var_x298 * var_x36;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.43033148291193518 * var_x91);
        IJth(rJacobian, 3, 3) = -var_x151;
        IJth(rJacobian, 18, 3) = -var_x298 * var_x91;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-2.0 * var_x93);
        IJth(rJacobian, 4, 4) = -var_x162;
        IJth(rJacobian, 18, 4) = -121.921482565228 * var_x295 * var_x93;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x97);
        IJth(rJacobian, 5, 5) = -var_x176;
        IJth(rJacobian, 17, 5) = -182.882223847842 * var_x295 * var_x97;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x98);
        IJth(rJacobian, 6, 6) = -var_x188 - var_x189;
        IJth(rJacobian, 17, 6) = -var_x11 * var_x297;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x98 * var_x99);
        IJth(rJacobian, 7, 7) = -var_x207 - var_x208;
        IJth(rJacobian, 17, 7) = -var_x297 * var_x99;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x100 * var_x101);
        IJth(rJacobian, 8, 8) = -var_x221;
        IJth(rJacobian, 15, 8) = -var_x100 * var_x290;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x103 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 9, 9) = -var_x234;
        IJth(rJacobian, 15, 9) = -var_x291 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x103 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 10, 10) = -var_x242;
        IJth(rJacobian, 15, 10) = -var_x291 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x101 * var_x104);
        IJth(rJacobian, 11, 11) = -var_x245;
        IJth(rJacobian, 15, 11) = -var_x104 * var_x290;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x105 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 12, 12) = -var_x254;
        IJth(rJacobian, 18, 12) = -var_x299 * var_x7;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x105 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 13, 13) = -var_x258;
        IJth(rJacobian, 18, 13) = -var_x299 * NV_Ith_S(mParameters, 21) * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 14) = var_x123 * var_x126;
        IJth(rJacobian, 14, 14) = var_x262 * (-var_x271 - NV_Ith_S(mParameters, 0) + 0.21333333333333335 * var_x277 - 0.032000000000000001 * var_x275) + 0.66666666666666674 * (var_x130 - var_x129 * NV_Ith_S(mParameters, 0) - var_x271 * var_x273) / (pow(var_x259, 3) * pow((0.33333333333333337 + var_x260), 2));
        IJth(rJacobian, 15, 14) = var_x289 * (var_x293 + 0.64023408924652514 * var_x275 - 4.2682272616435011 * var_x277);
        IJth(rJacobian, 16, 14) = 0.059999999999999998 * var_x272 * var_x279;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x107 * var_x78);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x123;
        IJth(rJacobian, 11, 15) = -0.0030000000000000001 * var_x245 * var_x246 + 6.2500000000000001e-5 * var_x246 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x244) / pow((0.025000000000000001 + var_x244), 2);
        IJth(rJacobian, 14, 15) = var_x262 * (var_x271 + 0.32000000000000001 * var_x278 - 0.29999999999999999 * var_x281);
        IJth(rJacobian, 15, 15) = var_x289 * (-1.1399999999999999 - var_x293 + 6.0021945866861737 * var_x281 - 6.4023408924652525 * var_x278 - 9144.1111923920998 * var_x107 * var_x282) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x273 * var_x293 - var_x284 * var_x68) / (pow(var_x286, 3) * pow(var_x287, 2));
        IJth(rJacobian, 16, 15) = var_x294 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -var_x261 * var_x267 * var_x280;
        IJth(rJacobian, 15, 16) = var_x280 * var_x288 * var_x292;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x294 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x114 + 0.0017025 * var_x110 - 3.0 * var_x115 - 2.7240000000000002 * var_x109 - var_x0 * var_x111 - var_x111 * var_x13);
        IJth(rJacobian, 1, 17) = 182.882223847842 * var_x115 * var_x123 * var_x124;
        IJth(rJacobian, 17, 17) = -var_x296 * (9.0 * var_x115 + 8.1720000000000006 * var_x109 - 0.0051075000000000001 * var_x110 + var_x111 * var_x12 + var_x111 * NV_Ith_S(mParameters, 11));
        IJth(rJacobian, 18, 17) = -var_x296 * (var_x114 + 0.003405 * var_x110 - 5.4480000000000004 * var_x109);
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x120 - var_x117 - var_x118 - var_x119 - var_x112 * var_x6 - var_x116 * var_x4 - var_x116 * var_x9);
        IJth(rJacobian, 18, 18) = -var_x296 * (var_x113 + var_x117 + var_x118 + var_x119 - var_x120 + var_x116 * var_x3 + var_x116 * var_x8);
    }
