...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x10 = var_x9 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3.0);
        ...
        const double var_x65 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 1.0) * (-26.713760659695652 * log(9.5999999999999996 / var_x64) + var_chaste_interface__membrane__V);
        ...
        const double var_x69 = var_x68 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0) * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x80 = var_x7 * var_x9 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2.0);
        ...
        const double var_x91 = 1.0 + 0.00020000000000000001 * pow(var_x90, (-2.0));
        const double var_x92 = 1 / var_x91;
        const double var_x93 = 1.0 * var_x92;
        const double var_x94 = 7.2352122917848019e-6 * var_x59;
        const double var_x95 = 1.0 + 6.2499999999999997e-8 * pow(var_chaste_interface__calcium_dynamics__Ca_i, (-2.0));
        const double var_x96 = pow(var_chaste_interface__calcium_dynamics__Ca_i, (-3.0)) / pow(var_x95, 2);
        ...
        const double var_x140 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1.0 * pow(var_x139, (-2.0));
        ...
        const double var_x146 = 1.0 * pow(var_x145, (-2.0));
        const double var_x147 = var_x146 - var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x154 = var_x144 * pow(var_x145, (-3.0));
        const double var_x155 = 0.26917900403768508 * var_x154;
        ...
        const double var_x158 = 1 / (0.16883116883116883 + 0.16883116883116883 * var_x157);
        const double var_x159 = var_x146 - var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x167 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x168 = 1.0 + var_x167;
        const double var_x169 = exp(-0.01052 * var_chaste_interface__membrane__V);
        const double var_x170 = var_x169 / var_x168;
        const double var_x171 = 37.780000000000001 + var_chaste_interface__membrane__V;
        const double var_x172 = 0.024240000000000001 * var_x170;
        const double var_x173 = var_x166 * var_x171;
        const double var_x174 = exp(-3.2000000000000002 - var_x21);
        ...
        const double var_x178 = exp(2.5 + var_x110);
        const double var_x179 = 1.0 + var_x178;
        const double var_x180 = 1 / var_x179;
        const double var_x181 = exp(1.0 + var_x130);
        ...
        const double var_x191 = exp(3.0 + var_x98);
        const double var_x192 = 1.0 + var_x191;
        const double var_x193 = 1 / var_x192;
        const double var_x194 = exp(1.3 + var_x99);
        const double var_x195 = 1.0 + var_x194;
        const double var_x196 = 1 / var_x195;
        const double var_x197 = 1 + 0.037037037037037035 * var_chaste_interface__membrane__V;
        const double var_x198 = pow(var_x197, 2.0);
        const double var_x199 = exp(-3.2400000000000002 * var_x198);
        const double var_x200 = exp(2.8571428571428572 + var_x102);
        const double var_x201 = 1.0 + var_x200;
        const double var_x202 = var_x191 / pow(var_x192, 2);
        const double var_x203 = pow(var_x197, 1.0);
        const double var_x204 = 1 / (20.0 + 200.0 * var_x196 + 180.0 * var_x193 + 1102.5 * var_x199);
        ...
        const double var_x209 = exp(5.0 + var_x102);
        const double var_x210 = 1.0 + var_x209;
        const double var_x211 = 1 / (80.0 * var_x193 + 31.0 * var_x207 + 562.0 * var_x208);
        const double var_x212 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2.0);
        const double var_x213 = 1 / (1.0 + 399.99999999999994 * var_x212);
        const double var_x214 = 1 / (2.0 + 80.0 * var_x213);
        const double var_x215 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 1.0);
        const double var_x216 = var_x215 / pow((0.0025000000000000005 + var_x212), 2);
        const double var_x217 = exp(-4.0 + var_x130);
        const double var_x218 = 1.0 + var_x217;
        const double var_x219 = 1 / var_x218;
        const double var_x220 = 1 + 0.022222222222222223 * var_chaste_interface__membrane__V;
        const double var_x221 = exp(-6.328125 * pow(var_x220, 2.0));
        const double var_x222 = exp(4.0 + var_x130);
        const double var_x223 = 1.0 + var_x222;
        const double var_x224 = 1 / (3.0 + 5.0 * var_x219 + 85.0 * var_x221);
        const double var_x225 = exp(3.3333333333333335 + var_x119);
        const double var_x226 = 1.0 + var_x225;
        const double var_x227 = 1 + 0.025000000000000001 * var_chaste_interface__membrane__V;
        const double var_x228 = exp(-0.88888888888888884 * pow(var_x227, 2.0));
        const double var_x229 = 1 / (0.80000000000000004 + 9.5 * var_x228);
        const double var_x230 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x231 = pow(var_x230, (-2.0));
        const double var_x232 = 1 / (1.0 + 3.0 * var_x231);
        const double var_x233 = 1.0 * var_x232;
        const double var_x234 = 1 / var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x235 = pow(var_x234, 2.0);
        const double var_x236 = 1 / (1.0 + 2.25 * var_x235);
        const double var_x237 = 1 / (2.5 - 1.5 * var_x236);
        const double var_x238 = var_x212 * var_x237;
        const double var_x239 = 1 / (0.059999999999999998 + 0.14999999999999999 * var_x238);
        const double var_x240 = var_x239 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x241 = var_x238 * var_x240;
        const double var_x242 = 0.015299999999999998 * var_x241;
        const double var_x243 = -var_chaste_interface__calcium_dynamics__Ca_ss + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x244 = var_x243 / pow((1 - 0.59999999999999998 * var_x236), 2);
        const double var_x245 = var_x234 * var_x235 / pow((0.44444444444444442 + var_x235), 2);
        const double var_x246 = var_x212 * var_x240 * var_x244 * var_x245;
        const double var_x247 = var_x244 * var_chaste_interface__calcium_dynamics__R_prime / pow((0.40000000000000002 + var_x238), 2);
        const double var_x248 = var_x237 * var_x245 * var_x247 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4.0);
        const double var_x249 = var_x247 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3.0);
        const double var_x250 = var_x215 * var_x237 * var_x240 * var_x243;
        const double var_x251 = var_x238 * var_x239 * var_x243;
        const double var_x252 = 0.010081409587705739 * var_x52;
        const double var_x253 = var_x252 * var_x50;
        const double var_x254 = 0.00025000000000000001 + var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x255 = 1.0 + 0.0001 * pow(var_x254, (-2.0));
        const double var_x256 = 1 / var_x255;
        const double var_x257 = 1.0 * var_x256;
        const double var_x258 = var_x252 * var_x256;
        const double var_x259 = var_x258 * var_x71;
        const double var_x260 = var_x258 * var_x73;
        const double var_x261 = 0.30611192392099484 * var_x241;
        const double var_x262 = -0.11249999999999999 + 0.067500000000000004 * var_x236;
        const double var_x263 = 0.00173434701107436 * var_x29;
        const double var_x264 = 6.3176611368492499e-5 * var_x40;
        const double var_x265 = 0.00047773503410627734 * var_x13 - 1.788348110893497e-5 * var_chaste_interface__membrane__V;
        const double var_x266 = 0.00091800065377284671 * var_x13 - 3.4364336248541711e-5 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x138 * var_x143 * pow(var_x139, (-3.0)) - 0.20000000000000001 * var_x137 * var_x140 * var_x141 + 99.999999999999986 * var_x140 * var_x142 * (0.02 * var_x131 / pow(var_x132, 2) + 0.00050000000000000001 * var_x134 / pow(var_x135, 2)) / pow((var_x133 + var_x136), 2);
        IJth(rJacobian, 6, 0) = ((var_x156) ? (var_x147 * (108035.0 * var_x148 + 0.21330000000000002 * var_x149 - 0.008382352941176471 * var_x150) - var_x155 * (var_x151 + var_x152 + var_x153)) : (-var_x155 * var_x158 + 0.53361053361053368 * var_x147 * var_x157 / pow((1 + var_x157), 2)));
        IJth(rJacobian, 7, 0) = ((var_x156) ? (var_x159 * (var_x166 - 0.00025500480000000003 * var_x170 + var_x165 * var_x171 * (3.0508668000000001e-7 * var_x161 - 6214.6032000000005 * var_x160) + 0.0033402720000000005 * var_x167 * var_x169 / pow(var_x168, 2) - 0.311 * var_x162 * var_x163 * var_x171 / pow(var_x164, 2)) - var_x155 * (var_x172 + var_x173)) : (0.034200000000000001 * var_x159 * var_x177 - 0.16150740242261102 * var_x154 * var_x177 + 0.059999999999999998 * var_x159 * var_x174 * var_x176 / pow(var_x175, 2)));
        ...
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1.0 / var_x201) * (18.0 * var_x202 + 264.60000000000002 * var_x199 * var_x203 - 20.0 * var_x194 / pow(var_x195, 2)) / pow((0.018140589569160998 + var_x199 + 0.16326530612244897 * var_x193 + 0.18140589569160998 * var_x196), 2) - 0.14285714285714285 * var_x200 * var_x204 / pow(var_x201, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x210) * (8.0 * var_x202 + 126.45 * var_x203 * var_x208 - 3.1000000000000001 * var_x205 / pow(var_x206, 2)) / pow((var_x208 + 0.055160142348754451 * var_x207 + 0.14234875444839859 * var_x193), 2) - 0.095714285714285724 * var_x209 * var_x211 / pow(var_x210, 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / var_x223) * (1.0 * var_x217 / pow(var_x218, 2) + 23.90625 * var_x221 * pow(var_x220, 1.0)) / pow((0.035294117647058823 + var_x221 + 0.058823529411764705 * var_x219), 2) - 0.20000000000000001 * var_x222 * var_x224 / pow(var_x223, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x225 * var_x229 / pow(var_x226, 2) + 0.0046783625730994153 * var_x228 * pow(var_x227, 1.0) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / var_x226) / pow((0.084210526315789472 + var_x228), 2);
        IJth(rJacobian, 15, 0) = var_x257 * (-var_x253 + 0.00075477277169111218 * var_x56 - 0.00018869319292277804 * var_x57);
        IJth(rJacobian, 17, 0) = -3.389679425876563e-8 - 3.0388663876087418e-8 * var_x11 - 7.3941785176126768e-11 * var_x34 - 0.00080594011556369446 * var_x46 - var_x263 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 18, 0) = 0.00053729341037579627 * var_x46 + 3.79059668210955e-6 * var_x37 - 3.4364336248541711e-5 * var_x4 - 1.788348110893497e-5 * var_x27 - 2.8537261917770623e-7 * var_x32 - 6.3176611368492499e-5 * var_x26 - 4.5819114998055616e-5 * var_x0 - 1.7065282626826835e-6 * var_x3 - var_x264 * var_x39;
        ...
        IJth(rJacobian, 18, 2) = var_x265 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        IJth(rJacobian, 18, 3) = var_x265 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        IJth(rJacobian, 6, 6) = ((var_x156) ? (-var_x151 - var_x152 - var_x153) : (-var_x158));
        IJth(rJacobian, 17, 6) = -var_x263 * var_x67;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-14.837999999999999 * var_x70);
        IJth(rJacobian, 7, 7) = ((var_x156) ? (-var_x172 - var_x173) : (-0.59999999999999998 * var_x177));
        ...
        IJth(rJacobian, 15, 8) = -var_x259 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        ...
        IJth(rJacobian, 15, 9) = -var_x259 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        ...
        IJth(rJacobian, 15, 10) = -var_x260 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        ...
        IJth(rJacobian, 15, 11) = -var_x260 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        ...
        IJth(rJacobian, 18, 12) = var_x266 * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 13, 13) = -var_x229;
        IJth(rJacobian, 18, 13) = var_x266 * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 14) = 2.40087783467447e-5 * var_x92;
        IJth(rJacobian, 14, 14) = var_x233 * (-0.00036000000000000002 - var_x242 + 0.021759999999999998 * var_x248 - 0.0032639999999999995 * var_x246) + 0.66666666666666674 * pow(var_x230, (-3.0)) * (0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0.0063749999999999996 * var_x97 - 0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x242 * var_x243) / pow((0.33333333333333337 + var_x231), 2);
        IJth(rJacobian, 15, 14) = var_x257 * (var_x261 + 0.065303877103145572 * var_x246 - 0.43535918068763713 * var_x248);
        IJth(rJacobian, 16, 14) = 0.059999999999999998 * var_x245 * var_chaste_interface__calcium_dynamics__Ca_ss * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-0.14375050524031124 * var_x76);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x92;
        IJth(rJacobian, 11, 15) = -0.0030000000000000001 * var_x214 * var_x216 + 6.2500000000000001e-5 * var_x216 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x213) / pow((0.025000000000000001 + var_x213), 2);
        IJth(rJacobian, 14, 15) = var_x233 * (var_x242 + 0.032639999999999995 * var_x249 - 0.030599999999999995 * var_x250);
        IJth(rJacobian, 15, 15) = var_x257 * (-1.1399999999999999 - var_x261 + 0.61222384784198969 * var_x250 - 0.65303877103145569 * var_x249 - 0.0025203523969264349 * var_x76) + 0.00020000000000000001 * pow(var_x254, (-3.0)) * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x243 * var_x261 - var_x253 * var_x54) / pow(var_x255, 2);
        IJth(rJacobian, 16, 15) = var_x262 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -0.015299999999999998 * var_x232 * var_x251;
        IJth(rJacobian, 15, 16) = 0.30611192392099484 * var_x251 * var_x256;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x262 * var_chaste_interface__calcium_dynamics__Ca_ss;
        ...
        IJth(rJacobian, 18, 18) = 0.00010126109252331096 * var_x89 - 0.00091800065377284671 * var_x86 - 0.0016876848753885161 * var_x84 - 0.00047773503410627734 * var_x85 - 4.5587787568311439e-5 * var_x83 - 0.011750408368292439 * var_x81 - var_x264 * var_x88;
    }
