...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x68 = -NV_Ith_S(mParameters, 4);
        ...
        const double var_x71 = var_x67 * var_x70 * (var_x68 + var_x66 * var_x69);
        const double var_x72 = exp(-9.9999999999999995e-8);
        const double var_x73 = 1 / (-1.0 + var_x72);
        const double var_x74 = 10000000.0 * var_x39;
        const double var_x75 = var_x74 * (-var_x71 - var_x70 * var_x73 * (var_x68 + var_x69 * var_x72));
        ...
        const double var_x87 = 4.0 * var_x38 * pow(NV_Ith_S(mParameters, 7), 2);
        const double var_x88 = var_x87 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        const double var_x89 = NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f;
        ...
        const double var_x98 = var_x96 * var_x97 * NV_Ith_S(mParameters, 10);
        const double var_x99 = var_x45 * var_x49;
        const double var_x100 = var_x63 * NV_Ith_S(mParameters, 18) * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        const double var_x102 = (-var_x20 * log(var_x101 * (0.029999999999999999 * NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 5))) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 19) * var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs;
        const double var_x103 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        const double var_x104 = -var_x20 * log(var_x103 * NV_Ith_S(mParameters, 6)) + var_chaste_interface__membrane__V;
        const double var_x105 = NV_Ith_S(mParameters, 13) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x106 = var_x104 * var_x105 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x107 = var_x104;
        const double var_x108 = var_x10 * var_x105;
        const double var_x109 = var_x76 - var_x70;
        const double var_x110 = ((var_x77) ? (var_x71 - var_x109 * var_x75) : (var_x76 * var_x83));
        const double var_x111 = var_x110 * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x112 = var_x111 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x113 = var_x110 * NV_Ith_S(mParameters, 9) * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x114 = var_x113 * var_x88;
        const double var_x115 = (var_x21 - var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 21);
        const double var_x116 = 1.2499999999999999e-8 * var_x20;
        const double var_x117 = var_x116 * var_x66 * var_x67;
        const double var_x118 = ((var_x77) ? (var_x117 - var_x109 * var_x74 * (-var_x117 - var_x116 * var_x72 * var_x73)) : (0.25 * var_x85));
        const double var_x119 = var_x53 * NV_Ith_S(mParameters, 5) / var_x57;
        ...
        const double var_x135 = var_x19 * NV_Ith_S(mParameters, 12);
        const double var_x136 = 30.480370641307001 * var_x135;
        const double var_x137 = 0.066691050963179718 * NV_Ith_S(mParameters, 0);
        const double var_x138 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
        const double var_x139 = NV_Ith_S(mParameters, 2) / (pow(var_x138, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
        const double var_x140 = -var_chaste_interface__calcium_dynamics__Ca_i + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x141 = NV_Ith_S(mParameters, 2) / var_x138;
        ...
        const double var_x146 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x147 = exp(-3.7142857142857144 - var_x146);
        const double var_x148 = 1.0 + var_x147;
        const double var_x149 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + 1 / var_x148;
        ...
        const double var_x157 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x158 = 1.0 + var_x157;
        const double var_x159 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 + 1 / var_x158;
        ...
        const double var_x171 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        ...
        const double var_x182 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x183 = 1.0 + var_x182;
        const double var_x184 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1 / pow(var_x183, 2);
        const double var_x185 = exp(-12.0 - var_x174);
        const double var_x186 = 1.0 + var_x185;
        const double var_x187 = var_x181 * var_x186;
        const double var_x188 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 15) - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x189 = var_chaste_interface__membrane__V < -40.0 + NV_Ith_S(mParameters, 15);
        const double var_x190 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 15));
        const double var_x191 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 15));
        const double var_x192 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 15) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x193 = 1.0 + var_x192;
        const double var_x194 = 0.01 * NV_Ith_S(mParameters, 14);
        const double var_x195 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 15));
        const double var_x196 = 1.0 + var_x195;
        const double var_x197 = 1.0 - var_x194;
        const double var_x198 = var_x194 + var_x197 / pow(var_x196, 2);
        ...
        const double var_x201 = 0.26917900403768508 * var_x195 * var_x197 / pow(var_x196, 3);
        const double var_x202 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 15) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x203 = 1.0 + var_x202;
        const double var_x204 = exp(0.01052 * NV_Ith_S(mParameters, 15) - 0.01052 * var_chaste_interface__membrane__V);
        const double var_x205 = var_x204 / var_x203;
        const double var_x206 = exp(-3.2000000000000002 - var_x29 + 0.10000000000000001 * NV_Ith_S(mParameters, 15));
        const double var_x207 = 1.0 + var_x206;
        const double var_x208 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * NV_Ith_S(mParameters, 15));
        const double var_x209 = var_x208 / var_x207;
        const double var_x210 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 15));
        const double var_x211 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 15) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x212 = -25428.0 * var_x210 - 6.9480000000000002e-6 * var_x211;
        const double var_x213 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 15));
        ...
        const double var_x230 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x241 = exp(2.8571428571428572 + var_x146);
        const double var_x242 = 1.0 + var_x241;
        const double var_x243 = var_x233 / pow(var_x234, 2);
        ...
        const double var_x250 = exp(5.0 + var_x146);
        ...
        const double var_x257 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x254), 2);
        ...
        const double var_x280 = var_chaste_interface__calcium_dynamics__R_prime * NV_Ith_S(mParameters, 1);
        ...
        const double var_x291 = var_x279 * var_x284 * NV_Ith_S(mParameters, 1);
        ...
        const double var_x296 = 36576.444769568399 * var_x39 * NV_Ith_S(mParameters, 12);
        const double var_x297 = var_x295 * var_x296;
        const double var_x298 = var_x297 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        const double var_x299 = var_x113 * var_x298;
        ...
        const double var_x305 = var_x135 * NV_Ith_S(mParameters, 3);
        const double var_x306 = 60.960741282614002 * var_x305;
        const double var_x307 = var_x104 * var_x306;
        const double var_x308 = 26.23332619555811 * var_x305;
        const double var_x309 = var_x306 * var_x36;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x52 - var_x0 - var_x13 - var_x17 - var_x35 - var_x37 - var_x4 - var_x6 - var_x65 - var_x9 - var_x50 - NV_Ith_S(mParameters, 10) - 2.7240000000000002 * var_x58 - 0.065000000000000002 * var_x92 - var_x86 * var_x90);
        IJth(rJacobian, 1, 0) = -var_x134 * var_x136 * (-2.0 * var_x50 - 0.13 * var_x92 + NV_Ith_S(mParameters, 10));
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x145 * var_x149 * var_x150 + 0.14285714285714285 * var_x147 * var_x152 / pow(var_x148, 2) - 0.10000000000000001 * var_x144 * var_x149 * var_x151;
        IJth(rJacobian, 3, 0) = 0.01488095238095238 * var_x156 * var_x159 * var_x160 - 0.041666666666666664 * var_x157 * var_x162 / pow(var_x158, 2) - 0.050000000000000003 * var_x155 * var_x159 * var_x161;
        IJth(rJacobian, 4, 0) = 5.1020408163265302e-7 * (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1 / var_x172) * (93.333333333333329 * var_x166 * var_x167 / pow(var_x168, 2) - 116.66666666666667 * var_x164 * var_x169 / pow(var_x165, (3 / 2))) / pow((0.057142857142857141 + var_x170), 2) + 0.071428571428571425 * var_x171 * var_x173 / pow(var_x172, 2);
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x182 * var_x187 / pow(var_x183, 3) - 0.20000000000000001 * var_x181 * var_x184 * var_x185 + 99.999999999999986 * var_x184 * var_x186 * (0.02 * var_x175 / pow(var_x176, 2) + 0.00050000000000000001 * var_x178 / pow(var_x179, 2)) / pow((var_x177 + var_x180), 2);
        IJth(rJacobian, 6, 0) = (var_x198 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x189) ? (-0.008382352941176471 * var_x188) : (0)) + ((var_x189) ? (108035.0 * var_x190 + 0.21330000000000002 * var_x191) : (0.53361053361053368 * var_x192 / pow(var_x193, 2)))) - var_x201 * (var_x199 + var_x200);
        IJth(rJacobian, 7, 0) = (var_x198 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x189) ? (-0.00025500480000000003 * var_x205 + 0.0033402720000000005 * var_x202 * var_x204 / pow(var_x203, 2)) : (0.034200000000000001 * var_x209 + 0.059999999999999998 * var_x206 * var_x208 / pow(var_x207, 2))) + ((var_x189) ? (var_x216 + var_x215 * var_x217 * (3.0508668000000001e-7 * var_x211 - 6214.6032000000005 * var_x210) - 0.311 * var_x212 * var_x213 * var_x217 / pow(var_x214, 2)) : (0))) - var_x201 * (var_x218 + var_x219);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x231) * (-0.050000000000000003 * var_x220 / pow(var_x221, 2) + 0.27999999999999997 * var_x223 * var_x228 / pow(var_x224, 2) - 0.15076923076923074 * var_x225 * var_x226 / pow(var_x227, 2)) / pow((var_x229 + 0.7142857142857143 * var_x222), 2) + 0.13333333333333333 * var_x230 * var_x232 / pow(var_x231, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x242) * (18.0 * var_x243 - var_x244 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x236 / pow(var_x237, 2)) / pow((0.018140589569160998 + var_x240 + 0.16326530612244897 * var_x235 + 0.18140589569160998 * var_x238), 2) - 0.14285714285714285 * var_x241 * var_x245 / pow(var_x242, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x251) * (8.0 * var_x243 - var_x252 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x246 / pow(var_x247, 2)) / pow((var_x249 + 0.055160142348754451 * var_x248 + 0.14234875444839859 * var_x235), 2) - 0.095714285714285724 * var_x250 * var_x253 / pow(var_x251, 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x263) * (-var_x264 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + var_x258 / pow(var_x259, 2)) / pow((0.035294117647058823 + var_x261 + 0.058823529411764705 * var_x260), 2) - 0.20000000000000001 * var_x262 * var_x265 / pow(var_x263, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x266 * var_x269 / pow(var_x267, 2) - 0.10526315789473684 * var_x268 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x267) / pow((0.084210526315789472 + var_x268), 2);
        IJth(rJacobian, 15, 0) = -var_x298 * var_x86 * var_x89;
        IJth(rJacobian, 17, 0) = -var_x306 * (var_x12 + 3.0 * var_x50 + 8.1720000000000006 * var_x58 + 0.19500000000000001 * var_x92 + NV_Ith_S(mParameters, 11));
        IJth(rJacobian, 18, 0) = -var_x306 * (var_x17 + var_x3 + var_x35 + var_x37 + var_x5 + var_x65 + var_x8 - var_x52 - 5.4480000000000004 * var_x58);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x95 - var_x94 - var_x98 + 2.5 * var_x99);
        IJth(rJacobian, 1, 1) = var_x134 * (-0.0038 - var_x137 - 8.3363813703974642e-9 * var_x139 - var_x136 * (var_x94 + var_x98 - var_x95 + 5.0 * var_x99)) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss - 0.0038 * var_chaste_interface__calcium_dynamics__Ca_i - 0.066691050963179718 * var_x141 + var_x137 * var_x140 - var_x136 * (var_x94 * var_chaste_interface__calcium_dynamics__Ca_i + (-var_x97 * log(var_x96 * NV_Ith_S(mParameters, 4)) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 10) - 2.0 * var_x49 * var_x91)) / (pow(var_x132, 3) * pow(var_x133, 2));
        IJth(rJacobian, 14, 1) = var_x273 * (1.2499999999999999e-7 * var_x139 + NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 15, 1) = 1.1399999999999999 * var_x295;
        IJth(rJacobian, 17, 1) = 457.20555961960503 * var_x305 * var_x99;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x16 * var_x36);
        IJth(rJacobian, 2, 2) = -var_x152;
        IJth(rJacobian, 18, 2) = -var_x15 * var_x308 * var_x36;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.43033148291193518 * var_x100);
        IJth(rJacobian, 3, 3) = -var_x162;
        IJth(rJacobian, 18, 3) = -var_x100 * var_x308;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-2.0 * var_x102);
        IJth(rJacobian, 4, 4) = -var_x173;
        IJth(rJacobian, 18, 4) = -121.921482565228 * var_x102 * var_x305;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x106);
        IJth(rJacobian, 5, 5) = -var_x187;
        IJth(rJacobian, 17, 5) = -182.882223847842 * var_x106 * var_x305;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x107 * var_x11);
        IJth(rJacobian, 6, 6) = -var_x199 - var_x200;
        IJth(rJacobian, 17, 6) = -var_x11 * var_x307;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x107 * var_x108);
        IJth(rJacobian, 7, 7) = -var_x218 - var_x219;
        IJth(rJacobian, 17, 7) = -var_x108 * var_x307;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x112 * var_x87);
        IJth(rJacobian, 8, 8) = -var_x232;
        IJth(rJacobian, 15, 8) = -var_x112 * var_x297;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x111 * var_x88);
        IJth(rJacobian, 9, 9) = -var_x245;
        IJth(rJacobian, 15, 9) = -var_x111 * var_x298;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x114 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass);
        IJth(rJacobian, 10, 10) = -var_x253;
        IJth(rJacobian, 15, 10) = -var_x299 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x114 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 11, 11) = -var_x256;
        IJth(rJacobian, 15, 11) = -var_x299 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x115 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 12, 12) = -var_x265;
        IJth(rJacobian, 18, 12) = -var_x309 * var_x7;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x115 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 13, 13) = -var_x269;
        IJth(rJacobian, 18, 13) = -var_x309 * NV_Ith_S(mParameters, 21) * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 14) = var_x134 * var_x137;
        IJth(rJacobian, 14, 14) = var_x273 * (-var_x282 - NV_Ith_S(mParameters, 0) + 0.21333333333333335 * var_x288 - 0.032000000000000001 * var_x286) + 0.66666666666666674 * (var_x141 - var_x140 * NV_Ith_S(mParameters, 0) - var_x282 * var_x284) / (pow(var_x270, 3) * pow((0.33333333333333337 + var_x271), 2));
        IJth(rJacobian, 15, 14) = var_x302 * (var_x301 + 0.64023408924652514 * var_x286 - 4.2682272616435011 * var_x288);
        IJth(rJacobian, 16, 14) = 0.059999999999999998 * var_x283 * var_x290;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x118 * var_x90);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x134;
        IJth(rJacobian, 11, 15) = -0.0030000000000000001 * var_x256 * var_x257 + 6.2500000000000001e-5 * var_x257 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x255) / pow((0.025000000000000001 + var_x255), 2);
        IJth(rJacobian, 14, 15) = var_x273 * (var_x282 + 0.32000000000000001 * var_x289 - 0.29999999999999999 * var_x292);
        IJth(rJacobian, 15, 15) = var_x302 * (-1.1399999999999999 - var_x301 + 6.0021945866861737 * var_x292 - 6.4023408924652525 * var_x289 - var_x118 * var_x303 * var_x89) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x284 * var_x301 - var_x112 * var_x303) / (pow(var_x293, 3) * pow(var_x294, 2));
        IJth(rJacobian, 16, 15) = var_x304 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -var_x272 * var_x278 * var_x291;
        IJth(rJacobian, 15, 16) = var_x291 * var_x295 * var_x300;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x304 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x125 + 0.0017025 * var_x121 - 3.0 * var_x126 - 2.7240000000000002 * var_x120 - var_x0 * var_x122 - var_x122 * var_x13);
        IJth(rJacobian, 1, 17) = 182.882223847842 * var_x126 * var_x134 * var_x135;
        IJth(rJacobian, 17, 17) = -var_x306 * (9.0 * var_x126 + 8.1720000000000006 * var_x120 - 0.0051075000000000001 * var_x121 + var_x12 * var_x122 + var_x122 * NV_Ith_S(mParameters, 11));
        IJth(rJacobian, 18, 17) = -var_x306 * (var_x125 + 0.003405 * var_x121 - 5.4480000000000004 * var_x120);
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x131 - var_x128 - var_x129 - var_x130 - var_x123 * var_x6 - var_x127 * var_x4 - var_x127 * var_x9);
        IJth(rJacobian, 18, 18) = -var_x306 * (var_x124 + var_x128 + var_x129 + var_x130 - var_x131 + var_x127 * var_x3 + var_x127 * var_x8);
    }
