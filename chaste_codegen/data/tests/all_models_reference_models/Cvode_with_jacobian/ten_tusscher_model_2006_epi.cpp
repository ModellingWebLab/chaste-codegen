...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x69 = -26.713760659695652 * log(140 * var_x68) + var_chaste_interface__membrane__V;
        ...
        const double var_x117 = exp(3.6666666666666665 + 041666666666666664 * var_chaste_interface__membrane__V);
        ...
        const double var_x131 = exp(-0.35714285714285715 - 071428571428571425 * var_chaste_interface__membrane__V);
        ...
        const double var_x215 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0025000000000000005 + var_x212), 2);
        ...
        const double var_x262 = (0031224512033090025 * var_x12 - 00011688549744401942 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2);
        const double var_x263 = 0031224512033090025 * var_x12 - 00011688549744401942 * var_chaste_interface__membrane__V;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0 : (-00088199999999999997 - var_x27 - var_x36 + 1081.6363254030778 * var_x58 + 03243 * var_x39 - 0.39200000000000002 * var_x0 - 0146 * var_x3 - 0024414715719063545 * var_x30 - 270.40908135076944 * var_x59 - 8.6662202299424464e-5 * var_x10 - 0.54050000000000009 * var_x25 - 2.2983750000000001 * var_x48 - 2.1086672225679691e-7 * var_x32 - 1.0 * var_x33 - var_x41 * var_x43 - var_x52 * var_x55);
        ...
        IJth(rJacobian, 3, 0) = 01488095238095238 * var_x116 * var_x119 * var_x120 - 041666666666666664 * var_x117 * var_x122 / pow(var_x118, 2) - 050000000000000003 * var_x115 * var_x119 * var_x121;
        IJth(rJacobian, 4, 0) = 5.1020408163265302e-7 * (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1.0 / var_x132) * (93.333333333333329 * var_x126 * var_x127 / pow(var_x128, 2) - 116.66666666666667 * var_x124 * var_x129 / pow(var_x125, (3 / 2))) / pow((057142857142857141 + var_x130), 2) + 071428571428571425 * var_x131 * var_x133 / pow(var_x132, 2);
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x142 * var_x147 / pow(var_x143, 3) - 0.20000000000000001 * var_x141 * var_x144 * var_x145 + 99.999999999999986 * var_x144 * var_x146 * (02 * var_x135 / pow(var_x136, 2) + 00050000000000000001 * var_x138 / pow(var_x139, 2)) / pow((var_x137 + var_x140), 2);
        IJth(rJacobian, 6, 0) = (var_x150 - var_chaste_interface__fast_sodium_current_h_gate__h) * (1.0 * ((var_x152) ? (-008382352941176471 * var_x151) : (0)) + 1.0 * ((var_x152) ? (108035.0 * var_x153 + 0.21330000000000002 * var_x154) : (0.53361053361053368 * var_x155 / pow(var_x156, 2)))) - var_x159 * (var_x157 + var_x158);
        IJth(rJacobian, 7, 0) = (var_x150 - var_chaste_interface__fast_sodium_current_j_gate__j) * (1.0 * ((var_x152) ? (-00025500480000000003 * var_x163 + 0033402720000000005 * var_x160 * var_x162 / pow(var_x161, 2)) : (034200000000000001 * var_x167 + 059999999999999998 * var_x164 * var_x166 / pow(var_x165, 2))) + 1.0 * ((var_x152) ? (var_x174 + var_x173 * var_x175 * (3.0508668000000001e-7 * var_x169 - 6214.6032000000005 * var_x168) - 0.311 * var_x170 * var_x171 * var_x175 / pow(var_x172, 2)) : (0))) - var_x159 * (var_x176 + var_x177);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1.0 / var_x189) * (-050000000000000003 * var_x178 / pow(var_x179, 2) + 0.27999999999999997 * var_x181 * var_x186 / pow(var_x182, 2) - 0.15076923076923074 * var_x183 * var_x184 / pow(var_x185, 2)) / pow((var_x187 + 0.7142857142857143 * var_x180), 2) + 0.13333333333333333 * var_x188 * var_x190 / pow(var_x189, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1.0 / var_x200) * (18.0 * var_x201 - var_x202 * (-0.23999999999999999 - 0088888888888888889 * var_chaste_interface__membrane__V) - 20 * var_x194 / pow(var_x195, 2)) / pow((018140589569160998 + var_x198 + 0.16326530612244897 * var_x193 + 0.18140589569160998 * var_x196), 2) - 0.14285714285714285 * var_x199 * var_x203 / pow(var_x200, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x209) * (8.0 * var_x201 - var_x210 * (-0.22500000000000001 - 0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x204 / pow(var_x205, 2)) / pow((var_x207 + 055160142348754451 * var_x206 + 0.14234875444839859 * var_x193), 2) - 095714285714285724 * var_x208 * var_x211 / pow(var_x209, 2);
        IJth(rJacobian, 12, 0) = 00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / var_x221) * (-var_x222 * (-0.28125 - 0062500000000000003 * var_chaste_interface__membrane__V) + 1.0 * var_x216 / pow(var_x217, 2)) / pow((035294117647058823 + var_x219 + 058823529411764705 * var_x218), 2) - 0.20000000000000001 * var_x220 * var_x223 / pow(var_x221, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x224 * var_x227 / pow(var_x225, 2) - 0.10526315789473684 * var_x226 * (-044444444444444446 - 0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / var_x225) / pow((084210526315789472 + var_x226), 2);
        IJth(rJacobian, 15, 0) = var_x255 * (-var_x251 + 18.964139992238998 * var_x58 - 4.7410349980597495 * var_x59);
        IJth(rJacobian, 17, 0) = -3.389679425876563e-8 - 3.0388663876087418e-8 * var_x10 - 00011688549744401942 * var_x36 - 7.3941785176126768e-11 * var_x32 - 00080594011556369446 * var_x48;
        IJth(rJacobian, 18, 0) = 00053729341037579627 * var_x48 + 3.79059668210955e-6 * var_x39 - 2.8537261917770623e-7 * var_x30 - 00011688549744401942 * var_x27 - 6.3176611368492499e-5 * var_x25 - 4.5819114998055616e-5 * var_x0 - 1.7065282626826835e-6 * var_x3 - 00011688549744401942 * var_x33 - var_x261 * var_x41;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (0.12379999999999999 * var_x63 + 594.50270777405183 * var_x64 - 0.12379999999999999 * var_x61 - 0079072731552699126 * var_x62);
        IJth(rJacobian, 1, 1) = var_x97 * (-0038240087783467445 - var_x98 + 7.2352122917848019e-6 * var_x63 - 069488744729986562 * var_x64 - 5.3144431236283834e-11 * var_x100 - 4.6212277808973232e-7 * var_x62) + 00040000000000000002 * (0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973232e-7 * log(2.0 * var_x62) - 0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 00042515544989027063 * var_x101 - var_x98 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x31 * var_x6) / (pow(var_x94, 3) * pow(var_x95, 2));
        IJth(rJacobian, 14, 1) = var_x231 * (00036000000000000002 + 7.96875e-10 * var_x100);
        IJth(rJacobian, 15, 1) = 1.1399999999999999 * var_x254;
        IJth(rJacobian, 17, 1) = 0.20846623418995969 * var_x64;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (var_x65 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2);
        ...
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (var_x65 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1);
        ...
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (-0.78400000000000003 * var_x67);
        IJth(rJacobian, 4, 4) = -var_x133;
        IJth(rJacobian, 18, 4) = -9.1638229996111233e-5 * var_x67;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (-3 * var_x71);
        IJth(rJacobian, 5, 5) = -1.0 * var_x147;
        IJth(rJacobian, 17, 5) = -00035065649233205829 * var_x71;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (-var_x72);
        IJth(rJacobian, 6, 6) = -var_x157 - var_x158;
        IJth(rJacobian, 17, 6) = -00011688549744401942 * var_x72;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (-var_x73);
        IJth(rJacobian, 7, 7) = -var_x176 - var_x177;
        IJth(rJacobian, 17, 7) = -00011688549744401942 * var_x73;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (-var_x75 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 8, 8) = -var_x190;
        IJth(rJacobian, 15, 8) = -var_x257 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0 : (-var_x75 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 9, 9) = -var_x203;
        IJth(rJacobian, 15, 9) = -var_x257 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0 : (-var_x77 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass);
        IJth(rJacobian, 10, 10) = -var_x211;
        IJth(rJacobian, 15, 10) = -var_x258 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0 : (-var_x77 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 11, 11) = -var_x214;
        IJth(rJacobian, 15, 11) = -var_x258 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0 : (var_x26 * var_x78);
        IJth(rJacobian, 12, 12) = -var_x223;
        IJth(rJacobian, 18, 12) = var_x26 * var_x263;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0 : (var_x78 * var_x79);
        IJth(rJacobian, 13, 13) = -var_x227;
        IJth(rJacobian, 18, 13) = var_x263 * var_x79;
        IJth(rJacobian, 1, 14) = 2.40087783467447e-5 * var_x96;
        IJth(rJacobian, 14, 14) = var_x231 * (-00036000000000000002 - var_x239 + 021759999999999998 * var_x246 - 0032639999999999995 * var_x243) + 0.66666666666666674 * (00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0063749999999999996 * var_x101 - 00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x239 * var_x241) / (pow(var_x228, 3) * pow((0.33333333333333337 + var_x229), 2));
        IJth(rJacobian, 15, 14) = var_x255 * (var_x259 + 065303877103145572 * var_x243 - 0.43535918068763713 * var_x246);
        IJth(rJacobian, 16, 14) = 059999999999999998 * var_x244 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0 : (-3611.8217397063127 * var_x80);
        IJth(rJacobian, 1, 15) = 0038 * var_x96;
        IJth(rJacobian, 11, 15) = -0030000000000000001 * var_x214 * var_x215 + 6.2500000000000001e-5 * var_x215 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x213) / pow((025000000000000001 + var_x213), 2);
        IJth(rJacobian, 14, 15) = var_x231 * (var_x239 + 032639999999999995 * var_x247 - 030599999999999995 * var_x248);
        IJth(rJacobian, 15, 15) = var_x255 * (-1.1399999999999999 - var_x259 + 0.61222384784198969 * var_x248 - 0.65303877103145569 * var_x247 - 63.325437108704392 * var_x80) + 00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x241 * var_x259 - var_x251 * var_x56) / (pow(var_x252, 3) * pow(var_x253, 2));
        IJth(rJacobian, 16, 15) = var_x260 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -015299999999999998 * var_x230 * var_x249;
        IJth(rJacobian, 15, 16) = 0.30611192392099484 * var_x249 * var_x254;
        IJth(rJacobian, 16, 16) = -0050000000000000001 + var_x260 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0 : (001436484375 * var_x83 - 26.713760659695652 * var_x86 - 00051997321379654684 * var_x84 - 2.2983750000000001 * var_x82 - 3.0158767234370001 * var_x85 - 0077469905913117388 * var_x68);
        IJth(rJacobian, 1, 17) = 6.0777327752174836e-8 * var_x84 * var_x96;
        IJth(rJacobian, 17, 17) = 5.0371257222730904e-7 * var_x83 - 9.0551084895961074e-7 * var_x68 - 1.823319832565245e-7 * var_x84 - 0031224512033090025 * var_x86 - 00080594011556369446 * var_x82;
        IJth(rJacobian, 18, 17) = 00053729341037579627 * var_x82 - 00035251225104877316 * var_x85 - 3.3580838148487267e-7 * var_x83;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0 : (0.86632725819392997 * var_x93 - 26.713760659695652 * var_x89 - 100.52922411456667 * var_x85 - 14.4387876365655 * var_x88 - 0.3900209056315565 * var_x87 - 26.713760659695648 * var_x92 - var_x43 * var_x91);
        IJth(rJacobian, 18, 18) = 00010126109252331096 * var_x93 - 0031224512033090025 * var_x92 - 0016876848753885161 * var_x88 - 4.5587787568311439e-5 * var_x87 - 011750408368292439 * var_x85 - 0031224512033090025 * var_x89 - var_x261 * var_x91;
    }
