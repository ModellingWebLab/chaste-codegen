...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x0 = pow(var_chaste_interface__IKs_Xs_gate__Xs, 2.0);
        ...
        const double var_x26 = pow(var_chaste_interface__INa_m_gate__m, 3.0);
        ...
        const double var_x55 = var_x54 * pow(var_chaste_interface__Ionic_concentrations__Nai, 3.0);
        ...
        const double var_x72 = var_x25 * var_x71 * pow(var_chaste_interface__INa_m_gate__m, 2.0);
        ...
        const double var_x82 = var_x81 * pow(var_chaste_interface__IKs_Xs_gate__Xs, 1.0);
        const double var_x83 = 0.026725757487819562 * var_x34;
        const double var_x84 = var_x53 * var_x54 * pow(var_chaste_interface__Ionic_concentrations__Nai, 2.0);
        ...
        const double var_x101 = 1.0 + 0.00011900000000000002 * pow(var_x99, (-2.0)) + 3.5000000000000004e-5 * pow(var_x100, (-2.0));
        ...
        const double var_x124 = 1.0 * (0.00023800000000000004 * pow(var_x99, (-3.0)) + 7.0000000000000007e-5 * pow(var_x100, (-3.0))) / pow(var_x101, 2);
        ...
        const double var_x168 = -1 + 0.044722719141323794 * var_chaste_interface__cell__V;
        const double var_x169 = 1 / sqrt(M_PI);
        const double var_x170 = var_x169 * exp(-0.89836705491478086 * pow(var_x168, 2.0));
        const double var_x171 = -1 + 0.15937778911130945 * var_chaste_interface__cell__V;
        const double var_x172 = var_x169 * exp(-0.08830693125184777 * pow(var_x171, 2.0));
        ...
        const double var_x184 = 1.0 - var_chaste_interface__Ito_r_gate__r;
        ...
        const double var_x193 = 1.0 - var_chaste_interface__Ito_t_gate__t;
        ...
        const double var_x205 = 1.0 - var_chaste_interface__IKr_Xr_gate__Xr;
        ...
        const double var_x216 = var_x36 * var_x42;
        const double var_x217 = 0.00019322513682643524 * var_x104;
        const double var_x218 = 0.0030916021892229638 * var_x104 * var_x26 * var_x71;
        const double var_x219 = var_x217 * (var_x78 - var_x77);
        const double var_x220 = 0.80000000000000004 + var_chaste_interface__Ionic_concentrations__Ca_JSR;
        const double var_x221 = pow(var_x220, (-2.0));
        const double var_x222 = 1 / (1.0 + 8.0 * var_x221);
        const double var_x223 = 22.0 * var_x110;
        const double var_x224 = var_x109 * var_x223;
        const double var_x225 = 22.0 * var_x131;
        const double var_x226 = var_x129 * var_x223;
        const double var_x227 = 1.0 * var_x222;
        const double var_x228 = 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_JSR;
        const double var_x229 = 0.25 * pow(var_x220, (-3.0)) / pow((0.125 + var_x221), 2);
        const double var_x230 = 0.0055555555555555558 * var_x222;
        ...
        IJth(rJacobian, 5, 0) = -0.051044617407047757 * var_x170 * pow(var_x168, 1.0) * (1.0 - var_chaste_interface__ICa_d_gate__d) - 0.0070656748908302881 * var_x172 * pow(var_x171, 1.0) * var_chaste_interface__ICa_d_gate__d;
        IJth(rJacobian, 6, 0) = (0.0074264700000000001 * var_x175 * var_x176 - 0.27789999999999998 * var_x173 * var_x177 / pow(var_x174, 2)) * var_chaste_interface__ICa_f_gate__f - 0.0011224539797135063 * var_x178 * (1.0 - var_chaste_interface__ICa_f_gate__f) / pow(var_x179, 2);
        IJth(rJacobian, 7, 0) = -0.0087415599999999989 * var_x184 * var_x188 - var_x182 * (5.1860000000000002e-5 - 0.069202559999999996 * var_x183) * var_chaste_interface__Ito_r_gate__r + 0.049658379999999995 * var_x184 * var_x185 * var_x187 / pow(var_x186, 2) - 0.1348 * var_x180 * var_x189 * var_chaste_interface__Ito_r_gate__r / pow(var_x181, 2);
        IJth(rJacobian, 8, 0) = var_x192 * var_x193 * (5.6119999999999998e-5 - 0.012473299999999998 * var_x194) - var_x197 * (0.0001215 - 1.2732200000000002e-10 * var_x198) * var_chaste_interface__Ito_t_gate__t + 0.17319999999999999 * var_x190 * var_x193 * var_x199 / pow(var_x191, 2) - 0.16039999999999999 * var_x195 * var_x200 * var_chaste_interface__Ito_t_gate__t / pow(var_x196, 2);
        IJth(rJacobian, 9, 0) = 0.00021044764652059425 * var_x201 * (1.0 - var_chaste_interface__IKs_Xs_gate__Xs) / pow(var_x202, 2) + 0.00037104930467762328 * var_x203 * var_chaste_interface__IKs_Xs_gate__Xs / pow(var_x204, 2);
        IJth(rJacobian, 10, 0) = 2.633e-6 * var_x205 * var_x209 - 2.5600000000000002e-5 * var_x213 * var_chaste_interface__IKr_Xr_gate__Xr + 0.0012527999999999999 * var_x210 * var_x212 * var_chaste_interface__IKr_Xr_gate__Xr / pow(var_x211, 2) + 0.00063100000000000005 * var_x205 * var_x206 * var_x208 / pow(var_x207, 2);
        IJth(rJacobian, 14, 0) = ((var_x215) ? (-var_x105 * (var_x103 + var_x60)) : (0));
        IJth(rJacobian, 18, 0) = -var_x217 * (0.001 + var_x28 + 0.00026912541324748262 * var_x57 + 2.8363636363636364 * var_x216 + 6.545427896312757e-7 * var_x59);
        IJth(rJacobian, 19, 0) = -var_x217 * (var_x1 + var_x24 + var_x50 + var_x6 + var_x8 - var_x44 - var_x47 - 1.8909090909090909 * var_x216);
        ...
        IJth(rJacobian, 14, 1) = ((var_x215) ? (-var_x105 * (var_x117 + var_x64)) : (0));
        IJth(rJacobian, 18, 1) = 0.13666446085893647 * var_x104 * var_x63;
        IJth(rJacobian, 20, 1) = ((var_x125) ? (var_x222 * var_x224) : (0));
        ...
        IJth(rJacobian, 18, 3) = -var_x218 * var_chaste_interface__INa_j_gate__j;
        ...
        IJth(rJacobian, 18, 4) = -var_x218 * var_chaste_interface__INa_h_gate__h;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x32 * var_x66);
        IJth(rJacobian, 1, 5) = -var_x102 * var_x127;
        IJth(rJacobian, 5, 5) = -0.14710000000000001 + 0.25101580310038191 * var_x172 - 0.63524014987941491 * var_x170;
        IJth(rJacobian, 14, 5) = ((var_x215) ? (-var_x127) : (0));
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x30 * var_x67);
        IJth(rJacobian, 1, 6) = -var_x102 * var_x128;
        IJth(rJacobian, 6, 6) = -0.00054739999999999997 - 0.0068719999999999996 / var_x179 - var_x175 * var_x177;
        IJth(rJacobian, 14, 6) = ((var_x215) ? (-var_x128) : (0));
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79 * var_chaste_interface__Ito_t_gate__t);
        IJth(rJacobian, 7, 7) = -0.52659999999999996 * var_x188 - var_x182 * var_x189;
        IJth(rJacobian, 19, 7) = -var_x219 * var_chaste_interface__Ito_t_gate__t;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79 * var_chaste_interface__Ito_r_gate__r);
        IJth(rJacobian, 8, 8) = -var_x192 * var_x199 - var_x197 * var_x200;
        IJth(rJacobian, 19, 8) = -var_x219 * var_chaste_interface__Ito_r_gate__r;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.040000000000000001 * var_x82);
        IJth(rJacobian, 9, 9) = -0.0058700000000000002 / var_x204 - 0.0030130000000000001 / var_x202;
        ...
        IJth(rJacobian, 10, 10) = -0.016 * var_x213 - 0.0050000000000000001 * var_x209;
        ...
        IJth(rJacobian, 12, 12) = ((var_x214) ? (-100.5) : (-0.5));
        IJth(rJacobian, 20, 12) = ((var_x125) ? (var_x227 * (var_x225 - var_x108 * var_x226)) : (0));
        IJth(rJacobian, 13, 13) = ((var_x214) ? (-100.5) : (-0.01));
        IJth(rJacobian, 1, 14) = ((var_x125) ? (var_x119 * (var_x130 * var_chaste_interface__Irel__APtrack2 - var_x111 * var_x132)) : (0));
        IJth(rJacobian, 14, 14) = (((var_x215) || (var_chaste_interface__Irel__APtrack2 > 0.01)) ? (0) : (-0.5));
        IJth(rJacobian, 20, 14) = ((var_x125) ? (var_x227 * (var_x132 * var_x223 - var_x226 * var_chaste_interface__Irel__APtrack2)) : (0));
        ...
        IJth(rJacobian, 14, 18) = ((var_x215) ? (5.200179479821575e-8 * var_x133) : (0));
        IJth(rJacobian, 18, 18) = -var_x217 * (var_x83 + var_x91 + 0.0016147524794848955 * var_x84 + 0.13454054045080013 * var_x88);
        IJth(rJacobian, 19, 18) = -var_x217 * (var_x86 + var_x90 - 0.089693693633866756 * var_x88);
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x98 - var_x92 - var_x93 - var_x94 - var_x96 - var_x97);
        IJth(rJacobian, 19, 19) = -var_x217 * (var_x92 + var_x93 + var_x94 + var_x96 + var_x97 - var_x98);
        IJth(rJacobian, 1, 20) = ((var_x125) ? (var_x102 * var_x112) : (0));
        IJth(rJacobian, 20, 20) = ((var_x125) ? (var_x227 * (-0.0055555555555555558 - var_x224) + var_x229 * (var_x228 - var_x110 * var_x225)) : (-var_x230 + var_x228 * var_x229));
