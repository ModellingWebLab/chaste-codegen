...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x84 = 0.026725757487819562 * var_x25;
        const double var_x85 = var_x53 * var_x54 * pow(var_chaste_interface__Ionic_concentrations__Nai, 2);
        const double var_x86 = var_x0 * (0.15315014533948793 * var_chaste_interface__Ionic_concentrations__Ki + 0.0028072421640728137 * var_chaste_interface__Ionic_concentrations__Nai) / pow(var_x81, 2);
        const double var_x87 = 0.063974230473736557 * var_x86;
        const double var_x88 = 1 / var_x32;
        const double var_x89 = var_x25 * var_x26 * var_x88 / pow((0.031622776601683791 + var_x26), 2);
        const double var_x90 = var_x2 * (0.10066438494060802 * var_chaste_interface__Ionic_concentrations__Ki + 0.004328568552446144 * var_chaste_interface__Ionic_concentrations__Nai) / pow(var_x76, 2);
        const double var_x91 = 3.4248684060035934 * var_x90;
        const double var_x92 = 26.725757487819561 * var_x25 * var_x40;
        const double var_x93 = 3.4901380509403466 * var_x86;
        const double var_x94 = 6.681439371954891 * var_x18 * var_x4;
        const double var_x95 = var_x34 * var_x4;
        const double var_x96 = var_x48 * (0.16035454492691736 * var_x95 - var_x11 * (2.6725757487819561 * var_x13 * var_x4 + 0.016035454492691736 * var_x14 * var_x4) - 13.36287874390978 * var_x4 * var_x47);
        const double var_x97 = 79.648102465199855 * var_x90;
        const double var_x98 = 26.725757487819561 * var_x22 * var_x4 * var_chaste_interface__IKr_Xr_gate__Xr;
        const double var_x99 = 0.40088636231729341 * var_x36 * var_x95;
        const double var_x100 = 0.0023800000000000002 + var_chaste_interface__Ionic_concentrations__Cai;
        const double var_x101 = 0.00050000000000000001 + var_chaste_interface__Ionic_concentrations__Cai;
        const double var_x102 = 1.0 + 0.00011900000000000002 / pow(var_x100, 2) + 3.5000000000000004e-5 / pow(var_x101, 2);
        const double var_x103 = 1 / var_x102;
        const double var_x104 = 0.00084999999999999995 + var_x46;
        const double var_x105 = 1 / M_PI;
        const double var_x106 = 9.661256841321762e-5 * var_x105;
        const double var_x107 = 1.0 - var_chaste_interface__Irel__APtrack2;
        const double var_x108 = 0.00079500000000000003 + var_chaste_interface__Irel__Cainfluxtrack;
        const double var_x109 = 1 / var_x108;
        const double var_x110 = -5.0000000000000004e-6 + var_chaste_interface__Irel__Cainfluxtrack;
        const double var_x111 = 22.0 * var_x109 * var_x110;
        const double var_x112 = var_x107 * var_x111;
        const double var_x113 = var_chaste_interface__Irel__Cainfluxtrack > 5.0000000000000004e-6;
        const double var_x114 = ((var_x113) ? (var_x112 * var_chaste_interface__Irel__APtrack2) : (0));
        const double var_x115 = 0.0070588235294117632 * var_x114;
        ...
        const double var_x121 = var_x103;
        ...
        const double var_x125 = 5.7967541047930573e-8 * var_x105 * var_x66;
        ...
        const double var_x128 = ((var_x113) ? (var_x112 - var_x111 * var_chaste_interface__Irel__APtrack2) : (0));
        const double var_x129 = var_x121 * (0.0070588235294117632 * var_chaste_interface__Ionic_concentrations__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__Ionic_concentrations__Cai);
        const double var_x130 = 22.0 * var_x107 * var_chaste_interface__Irel__APtrack2;
        const double var_x131 = ((var_x113) ? (var_x109 * var_x130 - var_x110 * var_x130 / pow(var_x108, 2)) : (0));
        const double var_x132 = var_x105 * var_x85;
        const double var_x133 = -var_x12;
        ...
        const double var_x209 = 0.00019322513682643524 * var_x105;
        ...
        const double var_x216 = var_x215 * (-var_chaste_interface__Ionic_concentrations__Ca_JSR + var_chaste_interface__Ionic_concentrations__Cai);
        ...
        IJth(rJacobian, 1, 0) = -var_x103 * var_x106 * (var_x104 - 4.3636185975418378e-7 * var_x59 - 0.00017941694216498839 * var_x57);
        ...
        IJth(rJacobian, 14, 0) = ((var_x207) ? (-var_x106 * (var_x104 + var_x60)) : (0));
        ...
        IJth(rJacobian, 19, 0) = -var_x209 * (var_x1 + var_x19 + var_x24 + var_x3 + var_x49 - var_x37 - var_x50 - 1.8909090909090909 * var_x208);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 + var_x68 - var_x62 - var_x69);
        IJth(rJacobian, 1, 1) = var_x121 * (-var_x115 - var_x118 + 0.00036529411764705876 * var_x119 - var_x106 * (var_x120 + 471.5206420294254 * var_x63)) + (0.00023800000000000004 / pow(var_x100, 3) + 7.0000000000000007e-5 / pow(var_x101, 3)) * (2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR + var_x115 * var_x122 - var_x106 * (var_x124 + 0.00084999999999999995 * var_chaste_interface__cell__V - 0.00017941694216498839 * var_x123) - var_x118 * var_chaste_interface__Ionic_concentrations__Cai) / pow(var_x102, 2);
        IJth(rJacobian, 14, 1) = ((var_x207) ? (-var_x106 * (var_x120 + var_x64)) : (0));
        IJth(rJacobian, 18, 1) = 0.13666446085893647 * var_x105 * var_x63;
        IJth(rJacobian, 20, 1) = var_x114 * var_x215;
        ...
        IJth(rJacobian, 18, 2) = -0.0005796754104793058 * var_x105 * var_x73;
        ...
        IJth(rJacobian, 1, 5) = -var_x103 * var_x126;
        ...
        IJth(rJacobian, 1, 6) = -var_x103 * var_x127;
        ...
        IJth(rJacobian, 19, 9) = -7.7290054730574101e-6 * var_x105 * var_x83;
        ...
        IJth(rJacobian, 20, 14) = var_x131 * var_x216;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x84 - var_x87 - var_x91 - var_x92 - 0.00053825082649496523 * var_x85 - 0.044846846816933378 * var_x89);
        IJth(rJacobian, 1, 18) = 1.040035895964315e-7 * var_x103 * var_x132;
        IJth(rJacobian, 14, 18) = ((var_x207) ? (5.200179479821575e-8 * var_x132) : (0));
        IJth(rJacobian, 18, 18) = -var_x209 * (var_x84 + var_x92 + 0.0016147524794848955 * var_x85 + 0.13454054045080013 * var_x89);
        IJth(rJacobian, 19, 18) = -var_x209 * (var_x87 + var_x91 - 0.089693693633866756 * var_x89);
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x99 - var_x93 - var_x94 - var_x96 - var_x97 - var_x98);
        IJth(rJacobian, 19, 19) = -var_x209 * (var_x93 + var_x94 + var_x96 + var_x97 + var_x98 - var_x99);
        IJth(rJacobian, 1, 20) = var_x103 * var_x115;
        IJth(rJacobian, 20, 20) = var_x215 * (-0.0055555555555555558 - var_x114) + 0.25 * (0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_JSR - var_x114 * var_x122) / (pow(var_x212, 3) * pow((0.125 + var_x213), 2));
        IJth(rJacobian, 21, 20) = 0.00048309178743961351;
        IJth(rJacobian, 1, 21) = 2.1105882352941172e-5 * var_x103;
