...
#include "MathsCustomFunctions.hpp"
    ...
    double CellTrovato2020FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_ICab__PCab = 2.4999999999999999e-8; // milliS_per_microF
        ...
        const double var_INab__PNab = 9.3749999999999992e-10; // milliS_per_microF
        ...
        const double var_membrane__vffrt = pow(NV_Ith_S(mParameters, 3), 2) * var_chaste_interface__membrane__v / (NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 14)); // coulomb_per_mole
        const double var_membrane__vfrt = var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 3) / (NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 14)); // dimensionless
        const double var_ICaL__PhiCaK = (-0.75 * NV_Ith_S(mParameters, 1) + 0.75 * var_chaste_interface__intracellular_ions__kss * exp(var_membrane__vfrt)) * var_membrane__vffrt / (-1.0 + exp(var_membrane__vfrt)); // dimensionless
        ...
        const double var_ICaL__PhiCaL = 4.0 * (-0.34100000000000003 * NV_Ith_S(mParameters, 0) + var_chaste_interface__intracellular_ions__cass * exp(2.0 * var_membrane__vfrt)) * var_membrane__vffrt / (-1.0 + exp(2.0 * var_membrane__vfrt)); // dimensionless
        ...
        const double var_ICaL__PhiCaNa = (-0.75 * NV_Ith_S(mParameters, 2) + 0.75 * var_chaste_interface__intracellular_ions__nass * exp(var_membrane__vfrt)) * var_membrane__vffrt / (-1.0 + exp(var_membrane__vfrt)); // dimensionless
        ...
        const double var_ICab__ICab = 4.0 * (-0.34100000000000003 * NV_Ith_S(mParameters, 0) + var_chaste_interface__intracellular_ions__casl * exp(2.0 * var_membrane__vfrt)) * var_ICab__PCab * var_membrane__vffrt / (-1.0 + exp(2.0 * var_membrane__vfrt)); // microA_per_microF
        const double var_INab__INab = (-NV_Ith_S(mParameters, 2) + var_chaste_interface__intracellular_ions__nasl * exp(var_membrane__vfrt)) * var_INab__PNab * var_membrane__vffrt / (-1.0 + exp(var_membrane__vfrt)); // microA_per_microF
    ...
    void CellTrovato2020FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x368 = var_x21 * var_x76;
        const double var_x369 = var_x368 * (var_x351 + var_x353 + var_x354 - var_x346 - var_x349);
        const double var_x370 = var_x358 + var_x75;
        const double var_x371 = var_x10 * var_x370;
        const double var_x372 = 3.3261382388091721e-14 * var_x371;
        const double var_x373 = var_x21 * var_x72;
        const double var_x374 = 1.9046600420239519e-18 * var_x373;
        const double var_x375 = var_x1 * var_x368 * var_x72;
        const double var_x376 = exp(var_x2);
        const double var_x377 = 0.75 * var_x376;
        const double var_x378 = -0.75 * NV_Ith_S(mParameters, 1) + var_x377 * var_chaste_interface__intracellular_ions__kss;
        const double var_x379 = -1.0 + var_x376;
        const double var_x380 = 1 / var_x379;
        const double var_x381 = var_x0 * pow(NV_Ith_S(mParameters, 3), 2);
        const double var_x382 = var_x380 * var_x381;
        const double var_x383 = var_x378 * var_x382;
        const double var_x384 = NV_Ith_S(mParameters, 5) * var_chaste_interface__ICaL__d;
        const double var_x385 = 1.0 - var_chaste_interface__CaMK__CaMKt;
        const double var_x386 = 1 / var_chaste_interface__intracellular_ions__cass;
        const double var_x387 = 1.0 + 0.0015 * var_x386;
        const double var_x388 = 1 / var_x387;
        const double var_x389 = 0.050000000000000003 * var_x388;
        const double var_x390 = var_x385 * var_x389 + var_chaste_interface__CaMK__CaMKt;
        const double var_x391 = 1.0 + 0.14999999999999999 / var_x390;
        const double var_x392 = 1 / var_x391;
        const double var_x393 = var_x392;
        const double var_x394 = 1.0 - var_x393;
        const double var_x395 = 1.0 - var_chaste_interface__ICaL__nca;
        const double var_x396 = 0.40000000000000002 * var_chaste_interface__ICaL__fs;
        const double var_x397 = 0.59999999999999998 * var_chaste_interface__ICaL__ff;
        const double var_x398 = 0.10000000000000001 * var_chaste_interface__membrane__v;
        const double var_x399 = exp(-1.0 + var_x398);
        const double var_x400 = 1.0 + var_x399;
        const double var_x401 = 0.59999999999999998 / var_x400;
        const double var_x402 = 0.29999999999999999 + var_x401;
        const double var_x403 = 0.69999999999999996 - var_x401;
        const double var_x404 = var_x403 * var_chaste_interface__ICaL__fcas;
        const double var_x405 = var_x404 + var_x402 * var_chaste_interface__ICaL__fcaf;
        const double var_x406 = var_x405 * var_chaste_interface__ICaL__jca;
        const double var_x407 = var_x395 * (var_x396 + var_x397) + var_x406 * var_chaste_interface__ICaL__nca;
        const double var_x408 = var_x394 * var_x407;
        const double var_x409 = var_x384 * var_x408;
        const double var_x410 = 0.00035740000000000001 * var_x409;
        const double var_x411 = var_x383 * var_x410;
        const double var_x412 = var_x72 * var_x76;
        const double var_x413 = var_x35 * var_x412;
        const double var_x414 = 0.59999999999999998 * var_chaste_interface__ICaL__ffp;
        const double var_x415 = var_x404 + var_x402 * var_chaste_interface__ICaL__fcafp;
        const double var_x416 = var_x415 * var_chaste_interface__ICaL__jca;
        const double var_x417 = var_x395 * (var_x396 + var_x414) + var_x416 * var_chaste_interface__ICaL__nca;
        const double var_x418 = var_x392 * var_x417;
        const double var_x419 = var_x384 * var_x418;
        const double var_x420 = 0.00039314000000000005 * var_x383;
        const double var_x421 = var_x419 * var_x420;
        const double var_x422 = var_x338 * var_x370 * var_x76;
        const double var_x423 = pow(NV_Ith_S(mParameters, 3), 3) / (pow(NV_Ith_S(mParameters, 4), 2) * pow(NV_Ith_S(mParameters, 14), 2));
        const double var_x424 = var_x423 * var_chaste_interface__membrane__v;
        const double var_x425 = var_x424 / pow(var_x379, 2);
        const double var_x426 = var_x378 * var_x425;
        const double var_x427 = var_x376 * var_x410 * var_x426;
        const double var_x428 = var_x376 * var_x419;
        const double var_x429 = 0.00039314000000000005 * var_x426 * var_x428;
        const double var_x430 = var_x376 * var_x409;
        const double var_x431 = 0.00026805000000000004 * var_x430;
        const double var_x432 = var_x380 * var_x424;
        const double var_x433 = var_x432 * var_chaste_interface__intracellular_ions__kss;
        const double var_x434 = var_x431 * var_x433;
        const double var_x435 = 0.00029485500000000001 * var_x428 * var_x433;
        const double var_x436 = 0.00035740000000000001 * var_x383;
        const double var_x437 = var_x384 * var_chaste_interface__membrane__v;
        const double var_x438 = 0.059999999999999998 * var_x399 / pow(var_x400, 2);
        const double var_x439 = var_x438 * var_chaste_interface__ICaL__fcas;
        const double var_x440 = var_x394 * var_chaste_interface__ICaL__nca;
        const double var_x441 = var_x440 * var_chaste_interface__ICaL__jca;
        const double var_x442 = var_x441 * (var_x439 - var_x438 * var_chaste_interface__ICaL__fcaf);
        const double var_x443 = var_x437 * var_x442;
        const double var_x444 = var_x436 * var_x443;
        const double var_x445 = var_x392 * var_chaste_interface__ICaL__nca;
        const double var_x446 = var_x445 * var_chaste_interface__ICaL__jca;
        const double var_x447 = var_x446 * (var_x439 - var_x438 * var_chaste_interface__ICaL__fcafp);
        const double var_x448 = var_x437 * var_x447;
        const double var_x449 = var_x420 * var_x448;
        const double var_x450 = var_chaste_interface__ICaT__b * var_chaste_interface__ICaT__g;
        const double var_x451 = 0.075399999999999995 * var_x450;
        const double var_x452 = -0.34100000000000003 * NV_Ith_S(mParameters, 0);
        const double var_x453 = exp(2.0 * var_x2);
        const double var_x454 = var_x453 * var_chaste_interface__intracellular_ions__casl;
        const double var_x455 = var_x452 + var_x454;
        const double var_x456 = -1.0 + var_x453;
        const double var_x457 = 1 / var_x456;
        const double var_x458 = var_x381 * var_x457;
        const double var_x459 = 9.9999999999999995e-8 * var_x458;
        const double var_x460 = var_x455 * var_x459;
        const double var_x461 = 1.9999999999999999e-7 * var_x423;
        const double var_x462 = var_x453 * var_chaste_interface__membrane__v;
        const double var_x463 = var_x462 / pow(var_x456, 2);
        const double var_x464 = var_x457 * var_chaste_interface__membrane__v;
        const double var_x465 = -var_x451 - var_x460 + var_x455 * var_x461 * var_x463 - var_x454 * var_x461 * var_x464;
        const double var_x466 = -0.75 * NV_Ith_S(mParameters, 2) + var_x377 * var_chaste_interface__intracellular_ions__nass;
        const double var_x467 = var_x382 * var_x466;
        const double var_x468 = 0.00125 * var_x467;
        const double var_x469 = 0.0013750000000000001 * var_x467;
        const double var_x470 = var_x425 * var_x466;
        const double var_x471 = 0.00093749999999999997 * var_x430;
        const double var_x472 = var_x432 * var_chaste_interface__intracellular_ions__nass;
        const double var_x473 = -var_x409 * var_x468 - var_x419 * var_x469 - var_x443 * var_x468 - var_x448 * var_x469 - var_x471 * var_x472 + 0.00125 * var_x430 * var_x470 + 0.0013750000000000001 * var_x428 * var_x470 - 0.00103125 * var_x428 * var_x472;
        const double var_x474 = var_x453 * var_chaste_interface__intracellular_ions__cass;
        const double var_x475 = var_x452 + var_x474;
        const double var_x476 = var_x458 * var_x475;
        const double var_x477 = var_x384 * var_x476;
        const double var_x478 = 4.0 * var_x408;
        const double var_x479 = var_x477 * var_x478;
        const double var_x480 = 4.4000000000000004 * var_x418;
        const double var_x481 = var_x477 * var_x480;
        const double var_x482 = var_x423 * var_x463 * var_x475;
        const double var_x483 = 8.0 * var_x409;
        const double var_x484 = var_x482 * var_x483;
        const double var_x485 = 8.8000000000000007 * var_x419;
        const double var_x486 = var_x482 * var_x485;
        const double var_x487 = var_x423 * var_x464 * var_x474;
        const double var_x488 = var_x483 * var_x487;
        const double var_x489 = var_x485 * var_x487;
        const double var_x490 = var_x477 * var_chaste_interface__membrane__v;
        const double var_x491 = 4.0 * var_x490;
        const double var_x492 = var_x442 * var_x491;
        const double var_x493 = 4.4000000000000004 * var_x490;
        const double var_x494 = var_x447 * var_x493;
        const double var_x495 = var_x484 + var_x486 - var_x479 - var_x481 - var_x488 - var_x489 - var_x492 - var_x494;
        const double var_x496 = pow(var_chaste_interface__If__y, 2);
        const double var_x497 = var_x496 * NV_Ith_S(mParameters, 8);
        const double var_x498 = (-var_x393 * var_chaste_interface__INaL__hLp - var_x394 * var_chaste_interface__INaL__hL) * NV_Ith_S(mParameters, 10);
        const double var_x499 = var_x498 * var_chaste_interface__INaL__mL;
        const double var_x500 = 0.98999999999999999 * var_chaste_interface__INa__hf;
        const double var_x501 = var_x500 + 0.010000000000000009 * var_chaste_interface__INa__hs;
        const double var_x502 = var_x394 * var_x501;
        const double var_x503 = var_x500 + 0.010000000000000009 * var_chaste_interface__INa__hsp;
        const double var_x504 = var_x503 * var_chaste_interface__INa__jp;
        const double var_x505 = var_x393 * var_x504 + var_x502 * var_chaste_interface__INa__j;
        const double var_x506 = pow(var_chaste_interface__INa__m, 3) * NV_Ith_S(mParameters, 6);
        const double var_x507 = var_x505 * var_x506;
        const double var_x508 = exp(var_x2);
        const double var_x509 = var_x508 * var_chaste_interface__intracellular_ions__nasl;
        const double var_x510 = 9.3749999999999992e-10 * var_x509 - 9.3749999999999992e-10 * NV_Ith_S(mParameters, 2);
        const double var_x511 = -1.0 + var_x508;
        const double var_x512 = 1 / var_x511;
        const double var_x513 = var_x381 * var_x512;
        const double var_x514 = var_x508 * var_chaste_interface__membrane__v;
        const double var_x515 = var_x499 - var_x497 - var_x507 - var_x510 * var_x513 - 9.3749999999999992e-10 * var_x424 * var_x509 * var_x512 + var_x423 * var_x510 * var_x514 / pow(var_x511, 2);
        const double var_x516 = exp(0.75 - 0.0625 * var_chaste_interface__membrane__v);
        const double var_x517 = 1.0 + var_x516;
        const double var_x518 = 0.030099999999999998 / var_x517;
        const double var_x519 = var_x496 * NV_Ith_S(mParameters, 7);
        const double var_x520 = 1 / var_chaste_interface__intracellular_ions__ksl;
        const double var_x521 = 1 / NV_Ith_S(mParameters, 3);
        const double var_x522 = var_x521 * NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 14);
        const double var_x523 = var_x522 * log(var_x520 * NV_Ith_S(mParameters, 1));
        const double var_x524 = -var_x523 + var_chaste_interface__membrane__v;
        const double var_x525 = 1 / var_chaste_interface__intracellular_ions__casl;
        ...
        const double var_x529 = var_x528 * NV_Ith_S(mParameters, 12) * var_chaste_interface__IKs__xs2;
        const double var_x530 = var_x529 * var_chaste_interface__IKs__xs1;
        const double var_x531 = NV_Ith_S(mParameters, 13) * var_chaste_interface__Ito__i1 * var_chaste_interface__Ito__i2;
        const double var_x532 = var_x531 * var_chaste_interface__Ito__a;
        const double var_x533 = exp(10.545454545454545 + 0.090909090909090912 * var_chaste_interface__membrane__v - 0.5 * NV_Ith_S(mParameters, 1));
        const double var_x534 = 1.0 + var_x533;
        const double var_x535 = sqrt(NV_Ith_S(mParameters, 1));
        const double var_x536 = var_x535 * NV_Ith_S(mParameters, 9) / var_x534;
        const double var_x537 = 1.000004299990755 * var_x536;
        const double var_x538 = var_x537 * var_chaste_interface__IK1__xk1;
        const double var_x539 = exp(-1.0416666666666667 + 0.10416666666666667 * var_chaste_interface__membrane__v);
        const double var_x540 = 1.0 + var_x539;
        const double var_x541 = 1 / var_x540;
        const double var_x542 = exp(1.4344412457471867 + 0.026171159382360639 * var_chaste_interface__membrane__v);
        const double var_x543 = 1.0 + var_x542;
        const double var_x544 = 1 / var_x543;
        const double var_x545 = var_x544;
        const double var_x546 = 1.0 - var_x545;
        const double var_x547 = var_x545 * var_chaste_interface__IKr__xrf + var_x546 * var_chaste_interface__IKr__xrs;
        const double var_x548 = var_x535 * var_x541 * var_x547 * NV_Ith_S(mParameters, 11);
        const double var_x549 = exp(2.2916666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__v);
        const double var_x550 = 1.0 + var_x549;
        const double var_x551 = 1 / var_x550;
        const double var_x552 = 0.43033148291193518 * var_x551;
        const double var_x553 = var_x548 * var_x552;
        const double var_x554 = var_x524 * var_x535;
        const double var_x555 = 0.026171159382360639 * var_x542 / pow(var_x543, 2);
        const double var_x556 = var_x554 * NV_Ith_S(mParameters, 11);
        const double var_x557 = var_x541 * var_x552 * var_x556;
        const double var_x558 = var_x530 - var_x518 - var_x519 - var_x532 - var_x538 - var_x553 - var_x557 * (var_x555 * var_chaste_interface__IKr__xrs - var_x555 * var_chaste_interface__IKr__xrf) - 0.0018812499999999999 * var_x516 * var_x524 / pow(var_x517, 2) + 0.017930478454663966 * var_x524 * var_x548 * var_x549 / pow(var_x550, 2) + 0.044826196136659918 * var_x539 * var_x547 * var_x551 * var_x556 / pow(var_x540, 2) + 0.090909481817341362 * var_x533 * var_x554 * NV_Ith_S(mParameters, 9) * var_chaste_interface__IK1__xk1 / pow(var_x534, 2);
        const double var_x559 = -1 + var_x389;
        const double var_x560 = 1 / (pow(var_x390, 2) * pow(var_x391, 2));
        const double var_x561 = var_x559 * var_x560;
        const double var_x562 = var_x417 * var_x561;
        const double var_x563 = var_x437 * var_x562;
        const double var_x564 = 5.8971000000000002e-5 * var_x383 * var_x563;
        const double var_x565 = var_x407 * var_x561;
        const double var_x566 = var_x437 * var_x565;
        const double var_x567 = 5.3610000000000003e-5 * var_x383 * var_x566;
        const double var_x568 = var_x560 * var_chaste_interface__INaL__hLp;
        const double var_x569 = 0.14999999999999999 * var_x559;
        const double var_x570 = var_x560 * var_x569;
        const double var_x571 = 1 / var_chaste_interface__intracellular_ions__nasl;
        const double var_x572 = -var_x522 * log(var_x571 * NV_Ith_S(mParameters, 2)) + var_chaste_interface__membrane__v;
        const double var_x573 = var_x572 * NV_Ith_S(mParameters, 10) * var_chaste_interface__INaL__mL;
        const double var_x574 = var_x501 * var_chaste_interface__INa__j;
        const double var_x575 = var_x506 * var_x572;
        const double var_x576 = var_x573 * (var_x568 * var_x569 - var_x570 * var_chaste_interface__INaL__hL) - var_x575 * (var_x570 * var_x574 - var_x504 * var_x570);
        const double var_x577 = 0.00020625000000000003 * var_x467 * var_x563 - 0.0001875 * var_x467 * var_x566;
        const double var_x578 = 0.66000000000000003 * var_x490 * var_x562;
        const double var_x579 = 0.59999999999999998 * var_x490 * var_x565;
        const double var_x580 = var_x578 - var_x579;
        const double var_x581 = 1 / (0.018329999999999999 * var_chaste_interface__intracellular_ions__nasl + var_chaste_interface__intracellular_ions__ksl);
        const double var_x582 = var_x522 * var_x530 * var_x581;
        const double var_x583 = 0.018329999999999999 * var_x582;
        const double var_x584 = var_x20 * var_x257;
        const double var_x585 = var_x10 * var_x584;
        const double var_x586 = 4.4788223776203591 * var_x25 * var_x584;
        const double var_x587 = var_x11 * var_x31;
        const double var_x588 = var_x33 * var_x587;
        const double var_x589 = var_x10 * var_x588;
        const double var_x590 = 4.0448001575983228e-12 * var_x52 * var_x584;
        const double var_x591 = pow((1 + 0.0028096208831939005 * var_chaste_interface__intracellular_ions__nasl + 0.0021553256090254577 * var_chaste_interface__intracellular_ions__ksl), (-2));
        const double var_x592 = var_x21 * var_x591;
        const double var_x593 = var_x25 * var_x592;
        const double var_x594 = 2.3840715066649271e-15 * var_x593;
        const double var_x595 = 0.030852683632896775 * var_x25 * var_x588;
        const double var_x596 = 2.786289097871654e-14 * var_x52 * var_x588;
        const double var_x597 = var_x55 * var_x591;
        const double var_x598 = var_x25 * var_x597;
        const double var_x599 = var_x13 * var_x64;
        const double var_x600 = var_x52 * var_x599;
        const double var_x601 = -3.0005234378016216e-13 * var_x598 - 3.5067428637450051e-12 * var_x600;
        const double var_x602 = var_x586 + var_x590 + var_x601 - var_x594 - var_x595 - var_x596 + 36069335.67075488 * var_x585 - 248466.16107375509 * var_x589;
        const double var_x603 = -0.011348161597821153 - 0.011348161597821153 * var_x80;
        const double var_x604 = var_x603 * var_x96;
        const double var_x605 = var_x256 * var_x604;
        const double var_x606 = var_x603 * var_x80;
        const double var_x607 = 56.740807989105761 * var_x606;
        const double var_x608 = var_x260 * var_x607;
        const double var_x609 = var_x245 + var_x608 + 60000.0 * var_x605;
        const double var_x610 = var_x263 * var_x609;
        const double var_x611 = (-0.066666666666666666 - 0.026666666666666668 * var_chaste_interface__intracellular_ions__nasl) / pow(var_x248, 2);
        const double var_x612 = var_x611 * var_chaste_interface__intracellular_ions__casl;
        const double var_x613 = 1500000.0 * var_x612;
        const double var_x614 = var_x277 * var_x613;
        const double var_x615 = var_x257 * var_x265;
        const double var_x616 = 40853381.752156146 * var_x122;
        const double var_x617 = var_x270 * var_x615 * var_x616;
        const double var_x618 = var_x268 * var_x609;
        const double var_x619 = var_x244 * var_x611;
        const double var_x620 = var_x11 * var_x619;
        const double var_x621 = 13617793.917385383 * var_x270;
        const double var_x622 = var_x122 * var_x620 * var_x621;
        const double var_x623 = var_x11 * var_x274 * var_x606 * var_x621;
        const double var_x624 = var_x610 + var_x614 + var_x617 + var_x618 + var_x622 + var_x623;
        const double var_x625 = 283704.03994552878 * var_x606;
        const double var_x626 = var_x279 * (var_x293 + 300000000.0 * var_x605 + var_x260 * var_x625);
        const double var_x627 = 9.0785292782569211 * var_x11;
        const double var_x628 = var_x295 * var_x606;
        const double var_x629 = var_x613 + 27.235587834770765 * var_x615 + var_x619 * var_x627 + var_x627 * var_x628;
        const double var_x630 = var_x294 * var_x629;
        const double var_x631 = var_x180 * var_x629;
        const double var_x632 = 136177.93917385384 * var_x150;
        const double var_x633 = var_x615 * var_x632;
        const double var_x634 = 45392.646391284608 * var_x150;
        const double var_x635 = var_x620 * var_x634;
        const double var_x636 = var_x11 * var_x628;
        const double var_x637 = var_x634 * var_x636;
        const double var_x638 = 13617793.917385383 * var_x154;
        const double var_x639 = var_x612 * var_x638;
        const double var_x640 = -var_x610 - var_x614 - var_x617 - var_x618 - var_x622 - var_x623 - var_x626 - var_x630 - var_x631 - var_x633 - var_x635 - var_x637 - var_x639 - var_x189 * var_x609;
        const double var_x641 = var_x291 * var_x313;
        const double var_x642 = var_x626 + var_x630 + var_x633 + var_x635 + var_x637;
        const double var_x643 = var_x291 * var_x318;
        const double var_x644 = 3.0597222222222222e-13 * var_x291;
        const double var_x645 = var_x640 * var_x644;
        const double var_x646 = var_x291 * var_x640;
        const double var_x647 = var_x286 * var_x321;
        const double var_x648 = 1236295.4078425223 * var_x87 * var_x89;
        const double var_x649 = var_x245 * var_x328 + var_x288 * var_x624 + var_x316 * (var_x631 + var_x639) + var_x320 * var_x645 + var_x325 * var_x646 + var_x328 * var_x608 + var_x620 * var_x647 + var_x636 * var_x647 + var_x640 * var_x641 - var_x315 * var_x642 - var_x317 * var_x624 - var_x323 * var_x645 - var_x324 * var_x642 - var_x326 * var_x646 - var_x640 * var_x643 + 81.706763504312292 * var_x330 * var_x615 + var_x11 * var_x242 * var_x249 * var_x287 * var_x609 * var_x648;
        const double var_x650 = 34076345.656450219 * var_x10 * var_x599;
        const double var_x651 = 0.055419764988303033 * var_x25 * var_x599;
        const double var_x652 = -var_x650 - var_x651 + 38790059.315200046 * var_x585 - 267208.05766560155 * var_x589;
        const double var_x653 = 1.1219685328242758e-7 * var_x597;
        const double var_x654 = 1674740.3831249396 * var_x584;
        const double var_x655 = 8.9146219515644901e-10 * var_x592;
        const double var_x656 = var_x25 * var_x591;
        const double var_x657 = 11536.567171311443 * var_x588;
        const double var_x658 = 1.5124489418129408e-6 * var_x43 * var_x584;
        const double var_x659 = 1.3112562615776865e-6 * var_x43 * var_x599;
        const double var_x660 = 1.0418611138907615e-8 * var_x43 * var_x588;
        const double var_x661 = var_x594 + var_x595 + var_x596 + var_x650 + var_x651 + var_x653 + var_x655 + var_x657 + var_x659 + var_x660 - var_x586 - var_x590 - var_x654 - var_x658 + 6.0010468756032432e-13 * var_x598 + 7.0134857274900101e-12 * var_x600 + 1.7102983595469244e-14 * var_x656 + 515674.21873935661 * var_x589 - 74859394.985954925 * var_x585;
        const double var_x662 = var_x591 * var_x76;
        const double var_x663 = var_x362 * var_x662;
        const double var_x664 = var_x357 * var_x364;
        const double var_x665 = var_x601 + var_x654 + var_x658 - var_x653 - var_x655 - var_x657 - var_x659 - var_x660;
        const double var_x666 = var_x412 * var_x584;
        const double var_x667 = var_x357 * var_x372;
        const double var_x668 = var_x357 * var_x374;
        const double var_x669 = var_x412 * var_x588;
        const double var_x670 = var_x26 * var_x662;
        const double var_x671 = var_x522 * var_x571;
        const double var_x672 = var_x499 * var_x671 - var_x497 * var_x671 - var_x507 * var_x671 - 9.3749999999999992e-10 * var_x513 * var_x514;
        const double var_x673 = var_x113 * var_x604;
        const double var_x674 = var_x118 * var_x607;
        const double var_x675 = var_x674 + var_x99 + 60000.0 * var_x673;
        const double var_x676 = var_x125 * var_x675;
        const double var_x677 = (-0.066666666666666666 - 0.026666666666666668 * var_chaste_interface__intracellular_ions__nass) / pow(var_x102, 2);
        const double var_x678 = var_x677 * var_chaste_interface__intracellular_ions__cass;
        const double var_x679 = 1500000.0 * var_x678;
        const double var_x680 = var_x143 * var_x679;
        const double var_x681 = var_x114 * var_x128;
        const double var_x682 = var_x133 * var_x616 * var_x681;
        const double var_x683 = var_x131 * var_x675;
        const double var_x684 = var_x677 * var_x98;
        const double var_x685 = var_x127 * var_x684;
        const double var_x686 = 13617793.917385383 * var_x133;
        const double var_x687 = var_x122 * var_x685 * var_x686;
        const double var_x688 = var_x127 * var_x139 * var_x606 * var_x686;
        const double var_x689 = var_x676 + var_x680 + var_x682 + var_x683 + var_x687 + var_x688;
        const double var_x690 = var_x145 * (var_x173 + 300000000.0 * var_x673 + var_x118 * var_x625);
        const double var_x691 = 9.0785292782569211 * var_x127;
        const double var_x692 = var_x176 * var_x606;
        const double var_x693 = var_x679 + 27.235587834770765 * var_x681 + var_x684 * var_x691 + var_x691 * var_x692;
        const double var_x694 = var_x174 * var_x693;
        const double var_x695 = var_x180 * var_x693;
        const double var_x696 = var_x632 * var_x681;
        const double var_x697 = var_x127 * var_x634;
        const double var_x698 = var_x684 * var_x697;
        const double var_x699 = var_x692 * var_x697;
        const double var_x700 = var_x638 * var_x678;
        const double var_x701 = -var_x676 - var_x680 - var_x682 - var_x683 - var_x687 - var_x688 - var_x690 - var_x694 - var_x695 - var_x696 - var_x698 - var_x699 - var_x700 - var_x189 * var_x675;
        const double var_x702 = var_x167 * var_x212;
        const double var_x703 = var_x690 + var_x694 + var_x696 + var_x698 + var_x699;
        const double var_x704 = var_x162 * var_x213;
        const double var_x705 = var_x167 * var_x701;
        const double var_x706 = var_x152 * var_x217;
        const double var_x707 = 3.0597222222222222e-13 * var_x705;
        const double var_x708 = var_x222 * var_x90;
        const double var_x709 = var_x161 * var_x222;
        const double var_x710 = var_x152 * var_x227;
        const double var_x711 = var_x163 * var_x689 + var_x215 * (var_x695 + var_x700) + var_x220 * var_x707 + var_x226 * var_x705 + var_x229 * var_x674 + var_x229 * var_x99 + var_x685 * var_x709 + var_x701 * var_x702 - var_x216 * var_x689 - var_x224 * var_x707 - var_x703 * var_x704 - var_x703 * var_x708 - var_x705 * var_x706 - var_x705 * var_x710 + 81.706763504312292 * var_x233 * var_x681 + var_x127 * var_x692 * var_x709 + var_x103 * var_x127 * var_x162 * var_x648 * var_x675 * var_x95;
        const double var_x712 = var_x382 * var_chaste_interface__membrane__v;
        const double var_x713 = var_x428 * var_x712;
        const double var_x714 = -0.00103125 * var_x713 - var_x471 * var_x712;
        const double var_x715 = var_x431 * var_x712;
        const double var_x716 = 0.00029485500000000001 * var_x713;
        const double var_x717 = -4.0 - 8.0 * var_chaste_interface__intracellular_ions__ksl;
        const double var_x718 = var_x19 * var_x587;
        const double var_x719 = var_x717 * var_x718;
        const double var_x720 = var_x10 * var_x719;
        const double var_x721 = 0.09330879953375748 * var_x25 * var_x719;
        const double var_x722 = 1.8288767722361083e-15 * var_x593;
        const double var_x723 = 8.4266669949965062e-14 * var_x52 * var_x719;
        const double var_x724 = var_x18 * var_chaste_interface__intracellular_ions__ksl;
        const double var_x725 = var_x43 * var_x724;
        const double var_x726 = var_x25 * var_x725;
        const double var_x727 = var_x63 * var_x717;
        const double var_x728 = var_x52 * var_x727;
        const double var_x729 = 1.0605559334252811e-11 * var_x728 + 3.3937789869608994e-10 * var_x726 - 2.3017714043409702e-13 * var_x598;
        const double var_x730 = var_x721 + var_x723 + var_x729 - var_x722 + 751444.4931407267 * var_x720;
        const double var_x731 = 3297863297.5037103 * var_x10 * var_x724;
        const double var_x732 = 5.3634509625479838 * var_x25 * var_x724;
        const double var_x733 = 103058228.04699095 * var_x10 * var_x727;
        const double var_x734 = 0.16760784257962449 * var_x25 * var_x727;
        const double var_x735 = var_x731 + var_x732 + var_x733 + var_x734 + 808126.23573333421 * var_x720;
        const double var_x736 = 8.6068818956382799e-8 * var_x597;
        const double var_x737 = 0.00012690163265380641 * var_x725;
        const double var_x738 = 6.8386140998302939e-10 * var_x592;
        const double var_x739 = var_x43 * var_x717;
        const double var_x740 = 3.9656760204314505e-6 * var_x63 * var_x739;
        const double var_x741 = 34890.424648436237 * var_x719;
        const double var_x742 = 3.1509352954436263e-8 * var_x718 * var_x739;
        const double var_x743 = var_x722 + var_x736 + var_x738 - var_x721 - var_x723 - var_x731 - var_x732 - var_x733 - var_x734 - var_x737 - var_x740 - var_x741 - var_x742 + 4.6035428086819405e-13 * var_x598 + 1.3120097004743531e-14 * var_x656 - 2.1211118668505621e-11 * var_x728 - 6.7875579739217989e-10 * var_x726 - 1559570.728874061 * var_x720;
        const double var_x744 = var_x729 + var_x737 + var_x740 + var_x741 + var_x742 - var_x736 - var_x738;
        const double var_x745 = var_x412 * var_x719;
        const double var_x746 = var_x520 * var_x522;
        const double var_x747 = var_x582 - var_x518 * var_x746 - var_x519 * var_x746 - var_x532 * var_x746 - var_x538 * var_x746 - var_x553 * var_x746;
        const double var_x748 = 2250000000000.0 * var_x149;
        const double var_x749 = var_x138 * var_x748;
        const double var_x750 = 13617793.917385383 * var_x155;
        const double var_x751 = -var_x749 - var_x750 - var_x104 * var_x143 - var_x104 * var_x174;
        const double var_x752 = var_x162 * var_x165;
        const double var_x753 = var_x162 * var_x174;
        const double var_x754 = var_x167 * var_x751;
        const double var_x755 = 3.0597222222222222e-13 * var_x754;
        const double var_x756 = 85111211.983658642 * var_x147;
        const double var_x757 = 15000000000.0 * var_x752 + var_x215 * (var_x749 + var_x750) + var_x220 * var_x755 + var_x226 * var_x754 + var_x702 * var_x751 - var_x224 * var_x755 - var_x706 * var_x754 - var_x710 * var_x754 - var_x752 * var_x756 - 4500000000000.0 * var_x138 * var_x753 - 40853381.752156146 * var_x193 * var_x753;
        const double var_x758 = var_x100 * var_x229 + var_x144 * var_x163 + var_x161 * var_x223 - var_x144 * var_x216 - var_x152 * var_x704 - var_x152 * var_x708;
        const double var_x759 = var_x758 / (pow(var_x238, 2) * pow(var_chaste_interface__intracellular_ions__cass, 3));
        const double var_x760 = var_x237 * var_x385 / pow(var_x387, 2);
        const double var_x761 = var_x560 * var_x760;
        const double var_x762 = var_x407 * var_x761;
        const double var_x763 = var_x437 * var_x762;
        const double var_x764 = 4.0207500000000006e-9 * var_x383 * var_x763;
        const double var_x765 = var_x417 * var_x761;
        const double var_x766 = var_x437 * var_x765;
        const double var_x767 = 4.4228250000000006e-9 * var_x383 * var_x766;
        const double var_x768 = 1.1250000000000001e-5 * var_x760;
        const double var_x769 = var_x560 * var_x768;
        const double var_x770 = var_x573 * (var_x769 * var_chaste_interface__INaL__hL - var_x568 * var_x768) - var_x575 * (var_x504 * var_x769 - var_x574 * var_x769);
        const double var_x771 = 1.4062500000000001e-8 * var_x467 * var_x763 - 1.5468750000000001e-8 * var_x467 * var_x766;
        const double var_x772 = var_x384 * var_x458 * var_x462;
        const double var_x773 = var_x478 * var_x772;
        const double var_x774 = var_x480 * var_x772;
        const double var_x775 = 4.5000000000000003e-5 * var_x490 * var_x762;
        const double var_x776 = 4.9500000000000004e-5 * var_x490 * var_x765;
        const double var_x777 = var_x775 - var_x773 - var_x774 - var_x776;
        const double var_x778 = var_x273 * var_x748;
        const double var_x779 = 13617793.917385383 * var_x283;
        const double var_x780 = -var_x778 - var_x779 - var_x250 * var_x277 - var_x250 * var_x294;
        const double var_x781 = var_x287 * var_x289;
        const double var_x782 = var_x287 * var_x294;
        const double var_x783 = var_x644 * var_x780;
        const double var_x784 = var_x291 * var_x780;
        const double var_x785 = 15000000000.0 * var_x781 + var_x316 * (var_x778 + var_x779) + var_x320 * var_x783 + var_x325 * var_x784 + var_x641 * var_x780 - var_x323 * var_x783 - var_x326 * var_x784 - var_x643 * var_x780 - var_x756 * var_x781 - 4500000000000.0 * var_x273 * var_x782 - 40853381.752156146 * var_x303 * var_x782;
        const double var_x786 = var_x246 * var_x328 + var_x278 * var_x288 + var_x286 * var_x322 - var_x278 * var_x317 - var_x282 * var_x315 - var_x282 * var_x324;
        const double var_x787 = var_x786 / (pow(var_x333, 2) * pow(var_chaste_interface__intracellular_ions__casl, 3));
        const double var_x788 = -var_x522 * log(var_x581 * (0.018329999999999999 * NV_Ith_S(mParameters, 2) + NV_Ith_S(mParameters, 1))) + var_chaste_interface__membrane__v;
        const double var_x789 = var_x788 * NV_Ith_S(mParameters, 12) * var_chaste_interface__IKs__xs1;
        const double var_x790 = var_x525 * var_x526 * var_x789 * var_chaste_interface__IKs__xs2 / pow(var_x527, 2);
        const double var_x791 = 0.00050000000000000001 + var_chaste_interface__intracellular_ions__casl;
        const double var_x792 = 0.00050000000000000001 / var_x791;
        const double var_x793 = pow(var_x791, (-2));
        const double var_x794 = -var_x792 - var_x459 * var_x462 + 0.00050000000000000001 * var_x793 * var_chaste_interface__intracellular_ions__casl - 0.037699999999999997 * var_x450 * var_x522 * var_x525;
        const double var_x795 = var_x505 * var_x572 * pow(var_chaste_interface__INa__m, 2) * NV_Ith_S(mParameters, 6);
        const double var_x796 = 0.98999999999999999 * var_x392;
        const double var_x797 = var_x575 * (var_x796 * var_chaste_interface__INa__jp + (0.98999999999999999 - var_x796) * var_chaste_interface__INa__j);
        const double var_x798 = 0.010000000000000009 * var_x392;
        const double var_x799 = var_x575 * (0.010000000000000009 - var_x798) * var_chaste_interface__INa__j;
        const double var_x800 = var_x502 * var_x575;
        const double var_x801 = var_x575 * var_chaste_interface__INa__jp;
        const double var_x802 = var_x503 * var_x575;
        const double var_x803 = var_x498 * var_x572;
        const double var_x804 = var_x573 * (-1.0 + var_x393);
        const double var_x805 = -var_chaste_interface__membrane__v;
        const double var_x806 = var_x523 + var_x805;
        const double var_x807 = var_x531 * var_x806;
        const double var_x808 = var_x806 * NV_Ith_S(mParameters, 13) * var_chaste_interface__Ito__a;
        const double var_x809 = var_x808 * var_chaste_interface__Ito__i2;
        const double var_x810 = var_x808 * var_chaste_interface__Ito__i1;
        const double var_x811 = NV_Ith_S(mParameters, 5) * var_chaste_interface__membrane__v;
        const double var_x812 = var_x408 * var_x811;
        const double var_x813 = var_x436 * var_x812;
        const double var_x814 = var_x418 * var_x811;
        const double var_x815 = var_x420 * var_x814;
        const double var_x816 = -var_x468 * var_x812 - var_x469 * var_x814;
        const double var_x817 = var_x476 * var_x811;
        const double var_x818 = var_x478 * var_x817;
        const double var_x819 = var_x480 * var_x817;
        ...
        const double var_x822 = var_x394 * var_x821;
        const double var_x823 = var_x437 * var_x822;
        const double var_x824 = 0.40000000000000002 - 0.40000000000000002 * var_chaste_interface__ICaL__nca;
        const double var_x825 = var_x394 * var_x824;
        const double var_x826 = var_x437 * var_x825;
        const double var_x827 = var_x436 * var_x826;
        const double var_x828 = var_x392 * var_x824;
        const double var_x829 = var_x437 * var_x828;
        const double var_x830 = var_x420 * var_x829;
        const double var_x831 = -var_x468 * var_x826 - var_x469 * var_x829;
        const double var_x832 = var_x491 * var_x825;
        const double var_x833 = var_x493 * var_x828;
        const double var_x834 = -var_x832 - var_x833;
        const double var_x835 = var_x402 * var_x441;
        const double var_x836 = var_x437 * var_x835;
        const double var_x837 = var_x403 * var_x441;
        const double var_x838 = var_x437 * var_x837;
        const double var_x839 = var_x436 * var_x838;
        const double var_x840 = var_x403 * var_x446;
        const double var_x841 = var_x437 * var_x840;
        const double var_x842 = var_x420 * var_x841;
        const double var_x843 = -var_x468 * var_x838 - var_x469 * var_x841;
        const double var_x844 = var_x491 * var_x837;
        const double var_x845 = var_x493 * var_x840;
        const double var_x846 = -var_x844 - var_x845;
        const double var_x847 = var_x405 * var_x440;
        const double var_x848 = var_x437 * var_x847;
        const double var_x849 = var_x436 * var_x848;
        const double var_x850 = var_x415 * var_x445;
        const double var_x851 = var_x437 * var_x850;
        const double var_x852 = var_x420 * var_x851;
        const double var_x853 = -var_x468 * var_x848 - var_x469 * var_x851;
        const double var_x854 = var_x491 * var_x847;
        const double var_x855 = var_x493 * var_x850;
        const double var_x856 = -var_x854 - var_x855;
        const double var_x857 = var_x392 * var_x821;
        const double var_x858 = var_x437 * var_x857;
        const double var_x859 = var_x402 * var_x446;
        const double var_x860 = var_x437 * var_x859;
        const double var_x861 = -var_x396;
        const double var_x862 = var_x394 * (var_x406 + var_x861 - var_x397);
        const double var_x863 = var_x437 * var_x862;
        const double var_x864 = var_x436 * var_x863;
        const double var_x865 = var_x392 * (var_x416 + var_x861 - var_x414);
        const double var_x866 = var_x437 * var_x865;
        const double var_x867 = var_x420 * var_x866;
        const double var_x868 = -var_x468 * var_x863 - var_x469 * var_x866;
        const double var_x869 = var_x491 * var_x862;
        const double var_x870 = var_x493 * var_x865;
        const double var_x871 = -var_x869 - var_x870;
        const double var_x872 = var_x522 * log(var_x525 * NV_Ith_S(mParameters, 0));
        const double var_x873 = 0.037699999999999997 * var_x872 - 0.075399999999999995 * var_chaste_interface__membrane__v;
        const double var_x874 = var_x873 * var_chaste_interface__ICaT__g;
        const double var_x875 = var_x873 * var_chaste_interface__ICaT__b;
        const double var_x876 = var_x529 * var_x788;
        const double var_x877 = var_x528 * var_x789;
        const double var_x878 = 2 * var_chaste_interface__If__y;
        const double var_x879 = var_x524 * NV_Ith_S(mParameters, 7);
        const double var_x880 = var_x572 * NV_Ith_S(mParameters, 8);
        const double var_x881 = 1 / var_chaste_interface__intracellular_ions__cai;
        const double var_x882 = 0.14999999999999999 + var_x390;
        const double var_x883 = 1 / var_x882;
        const double var_x884 = var_x390 * var_x883;
        const double var_x885 = 0.00027999999999999998 - 0.00017000000000000001 * var_x884;
        const double var_x886 = 1.0 + var_x881 * var_x885;
        const double var_x887 = pow(var_x886, (-2));
        const double var_x888 = 0.00017333333333333334 * var_x887;
        const double var_x889 = 1.0 + 0.75 * var_x884;
        const double var_x890 = var_x885 * var_x889;
        const double var_x891 = var_x890 / pow(var_chaste_interface__intracellular_ions__cai, 2);
        const double var_x892 = -0.020833333333333332 - var_x888 * var_x891;
        const double var_x893 = 0.00050000000000000001 + var_chaste_interface__intracellular_ions__cai;
        const double var_x894 = 0.0023800000000000002 + var_chaste_interface__intracellular_ions__cai;
        const double var_x895 = 1.0 + 1.575e-5 / pow(var_x893, 2) + 0.00026775000000000003 / pow(var_x894, 2);
        const double var_x896 = 1 / var_x895;
        const double var_x897 = var_x896;
        const double var_x898 = 1.8666666666666665e-5 * var_chaste_interface__intracellular_ions__cansr;
        const double var_x899 = 1 / var_x886;
        const double var_x900 = 0.00017333333333333334 * var_x899;
        const double var_x901 = var_x898 + 0.020833333333333332 * var_chaste_interface__intracellular_ions__casl + 0.013333333333333334 * var_chaste_interface__ryr__Jrel2 - 0.020833333333333332 * var_chaste_interface__intracellular_ions__cai - var_x889 * var_x900;
        const double var_x902 = 1 - var_x389;
        const double var_x903 = var_x883 * var_x902;
        const double var_x904 = var_x390 / pow(var_x882, 2);
        const double var_x905 = var_x559 * var_x904;
        const double var_x906 = 0.75 * var_x903 + 0.75 * var_x905;
        const double var_x907 = var_x889 * (-0.00017000000000000001 * var_x903 - 0.00017000000000000001 * var_x905);
        const double var_x908 = var_x881 * var_x888;
        const double var_x909 = var_x907 * var_x908 - var_x900 * var_x906;
        const double var_x910 = var_x760 * var_x883;
        const double var_x911 = var_x760 * var_x904;
        const double var_x912 = 5.6250000000000005e-5 * var_x910 - 5.6250000000000005e-5 * var_x911;
        const double var_x913 = var_x889 * (1.2750000000000002e-8 * var_x911 - 1.2750000000000002e-8 * var_x910);
        const double var_x914 = var_x908 * var_x913 - var_x900 * var_x912;
        const double var_x915 = 0.0025000000000000005 * var_x388;
        const double var_x916 = 1777.6995840000002 * var_x76;
        const double var_x917 = 0.0022970159999999998 * var_x334;
        const double var_x918 = 1.6872866561388904e-7 * var_x344;
        const double var_x919 = 4.0991265609206957e-17 * var_x359;
        const double var_x920 = 3.8906469970046351e-27 * var_x363;
        const double var_x921 = 4327415.4693063302 * var_x366;
        const double var_x922 = 9.9784147164275156e-14 * var_x371;
        const double var_x923 = 5.7139801260718552e-18 * var_x373;
        const double var_x924 = 16.864111498257842 * var_x521;
        const double var_x925 = var_x357 * var_x920;
        const double var_x926 = var_x357 * var_x922;
        const double var_x927 = var_x357 * var_x923;
        const double var_x928 = var_x392 * var_x924;
        const double var_x929 = 33.728222996515683 * var_x521 * var_chaste_interface__If__y;
        const double var_x930 = 0.00057425399999999995 * var_x239;
        const double var_x931 = 126.4808362369338 * var_x521;
        const double var_x932 = var_x2 * var_x384;
        const double var_x933 = var_x380 * var_x932;
        const double var_x934 = var_x466 * var_x933;
        const double var_x935 = 0.15810104529616725 * var_x934;
        const double var_x936 = 0.17391114982578398 * var_x934;
        const double var_x937 = var_x378 * var_x933;
        const double var_x938 = 0.04520425087108014 * var_x937;
        const double var_x939 = 0.049724675958188157 * var_x937;
        const double var_x940 = 1185.1330560000001 * var_x76;
        const double var_x941 = 2.7327510406137971e-17 * var_x359;
        const double var_x942 = 1.1248577707592603e-7 * var_x344;
        const double var_x943 = 2884943.6462042201 * var_x366;
        const double var_x944 = 2.5937646646697565e-27 * var_x363;
        const double var_x945 = 6.6522764776183441e-14 * var_x371;
        const double var_x946 = 3.8093200840479037e-18 * var_x373;
        const double var_x947 = var_x357 * var_x944;
        const double var_x948 = var_x357 * var_x945;
        const double var_x949 = var_x357 * var_x946;
        const double var_x950 = var_x521 * var_x524;
        const double var_x951 = 7.2571581090375137 * var_x535 * var_x541 * var_x551 * var_x950 * NV_Ith_S(mParameters, 11);
        const double var_x952 = 0.00038283600000000001 * var_x239;
        const double var_x953 = 0.0086999999999999994 + var_chaste_interface__intracellular_ions__cass;
        const double var_x954 = 0.00087000000000000001 + var_chaste_interface__intracellular_ions__cass;
        const double var_x955 = 1.0 + 0.00415599 / pow(var_x953, 2) + 1.7378249999999999e-5 / pow(var_x954, 2);
        const double var_x956 = 1 / var_x955;
        const double var_x957 = 63.240418118466899 * var_x521;
        const double var_x958 = var_x956 * var_x957;
        const double var_x959 = -var_chaste_interface__intracellular_ions__cass + var_chaste_interface__intracellular_ions__cajsr;
        const double var_x960 = 1 / (1.0 + 9090.9090909090901 * var_chaste_interface__intracellular_ions__cass);
        const double var_x961 = 1.0 - var_chaste_interface__IP3__u;
        const double var_x962 = var_x960 * var_x961;
        const double var_x963 = 0.00020202000000000002 * var_x962;
        const double var_x964 = var_x959 * var_x963;
        const double var_x965 = var_x963 * var_chaste_interface__intracellular_ions__cass;
        const double var_x966 = var_x959 * var_chaste_interface__intracellular_ions__cass;
        const double var_x967 = var_x961 * var_x966 / pow((0.00011 + var_chaste_interface__intracellular_ions__cass), 2);
        const double var_x968 = -5.0 + var_x964 - var_x965 - 2.22222e-8 * var_x967;
        const double var_x969 = var_x479 * var_chaste_interface__membrane__v;
        const double var_x970 = var_x481 * var_chaste_interface__membrane__v;
        const double var_x971 = 5.0 * var_chaste_interface__intracellular_ions__casl + 0.10000000000000001 * var_chaste_interface__ryr__Jrel1 - 5.0 * var_chaste_interface__intracellular_ions__cass + var_x964 * var_chaste_interface__intracellular_ions__cass;
        const double var_x972 = var_x457 * var_x475 * var_x932;
        const double var_x973 = var_x956 * var_x972;
        const double var_x974 = 252.96167247386759 * var_x973;
        const double var_x975 = 278.25783972125436 * var_x973;
        const double var_x976 = var_x960 * var_x966;
        const double var_x977 = 0.001531344 * var_x334;
        const double var_x978 = 0.0023800000000000002 + var_chaste_interface__intracellular_ions__casl;
        const double var_x979 = 1.0 + 2.9750000000000005e-5 / pow(var_x978, 2) + 1.75e-6 * var_x793;
        const double var_x980 = 1 / var_x979;
        const double var_x981 = 8.4320557491289208 * var_x521;
        const double var_x982 = var_x980 * var_x981;
        const double var_x983 = 1.0 + var_x525 * var_x885;
        const double var_x984 = 1 / var_x983;
        const double var_x985 = 5.333333333333334e-5 * var_x984;
        const double var_x986 = pow(var_x983, (-2));
        const double var_x987 = 5.333333333333334e-5 * var_x986;
        const double var_x988 = var_x525 * var_x987;
        const double var_x989 = var_x980;
        const double var_x990 = var_x332 * var_x890;
        const double var_x991 = 0.0025999999999999999 * var_x887;
        const double var_x992 = 0.0025999999999999999 * var_x899;
        const double var_x993 = 0.00020000000000000001 * var_x984;
        const double var_x994 = var_x881 * var_x991;
        const double var_x995 = 0.00020000000000000001 * var_x986;
        const double var_x996 = var_x525 * var_x995;
        const double var_x997 = 0.0020202000000000002 * var_x962;
        const double var_x998 = var_x997 * var_chaste_interface__intracellular_ions__cass;
        const double var_x999 = 0.80000000000000004 + var_chaste_interface__intracellular_ions__cajsr;
        const double var_x1000 = 1.0 + 0.95999999999999996 / pow(var_x999, 2);
        const double var_x1001 = 1 / var_x1000;
        const double var_x1002 = var_x1001;
        const double var_x1003 = -var_chaste_interface__ryr__Jrel1;
        const double var_x1004 = 0.0083333333333333332 * var_chaste_interface__intracellular_ions__cansr;
        const double var_x1005 = 0.80000000000000004 + var_chaste_interface__intracellular_ions__cacsr;
        const double var_x1006 = pow(var_x1005, (-2));
        const double var_x1007 = 1 / (1.0 + 2.3039999999999998 * var_x1006);
        const double var_x1008 = 0.0083333333333333332 * var_x1007;
        const double var_x1009 = -var_chaste_interface__ryr__Jrel2;
        const double var_x1010 = exp(-6.401120907300438 - 0.13218246467423633 * var_chaste_interface__membrane__v);
        const double var_x1011 = 1.0 + var_x1010;
        const double var_x1012 = exp(0.33477135461604829 + 0.02876042565429968 * var_chaste_interface__membrane__v);
        const double var_x1013 = exp(-13.000839630562552 - 0.16792611251049538 * var_chaste_interface__membrane__v);
        const double var_x1014 = 0.19456427955133734 * var_x1012 - 1.4361041141897564 * var_x1013;
        const double var_x1015 = 8.5519999999999996 * var_x1013;
        const double var_x1016 = 6.7649999999999997 * var_x1012;
        const double var_x1017 = var_x1015 + var_x1016;
        const double var_x1018 = -var_x1015 - var_x1016;
        const double var_x1019 = 0.16077170418006431 * var_chaste_interface__membrane__v;
        const double var_x1020 = exp(12.620578778135048 + var_x1019);
        const double var_x1021 = 1.0 + var_x1020;
        const double var_x1022 = 1 / var_x1021;
        const double var_x1023 = exp(-0.054037868972050131 + 0.10888146075367747 * var_chaste_interface__membrane__v);
        const double var_x1024 = exp(-0.49472505376754605 - 0.12726046399165172 * var_chaste_interface__membrane__v);
        const double var_x1025 = 16.0 * var_x1023;
        const double var_x1026 = 3.6859999999999999e-6 * var_x1024;
        const double var_x1027 = 0.16077170418006431 * var_x1020 / pow(var_x1021, 2);
        const double var_x1028 = exp(0.10112954465231205 + 0.017649135192375574 * var_chaste_interface__membrane__v);
        const double var_x1029 = exp(-0.63992869875222813 - 0.035650623885918005 * var_chaste_interface__membrane__v);
        const double var_x1030 = 0.0097940000000000006 * var_x1029;
        const double var_x1031 = 0.33429999999999999 * var_x1028;
        const double var_x1032 = exp(-15.357647523189264 - 0.13157029142819551 * var_chaste_interface__membrane__v);
        const double var_x1033 = exp(0.69411673565151943 + 0.11067088691648774 * var_chaste_interface__membrane__v);
        const double var_x1034 = 1 / (0.86280000000000001 * var_x1032 + 1.1095999999999999 * var_x1033);
        const double var_x1035 = 1 / (4.859 + var_x1034);
        const double var_x1036 = (0.11351884744424709 * var_x1032 - 0.1228004161225348 * var_x1033) / (pow((1 + 0.20580366330520683 * var_x1034), 2) * pow((var_x1033 + 0.77757750540735404 * var_x1032), 2));
        const double var_x1037 = exp(13.617363344051448 + var_x1019);
        const double var_x1038 = 1.0 + var_x1037;
        const double var_x1039 = 0.11143333333333333 * var_x1028;
        const double var_x1040 = 0.003264666666666667 * var_x1029;
        const double var_x1041 = 1 / (7.0941399999999994 + 1.46 * var_x1034);
        const double var_x1042 = exp(-8.1401975683890573 - 0.18996960486322187 * var_chaste_interface__membrane__v);
        const double var_x1043 = 1.0 + var_x1042;
        const double var_x1044 = 0.13354700854700854 * var_chaste_interface__membrane__v;
        const double var_x1045 = exp(11.700053418803417 + var_x1044);
        const double var_x1046 = exp(12.528044871794872 + var_x1044);
        const double var_x1047 = 0.076923076923076927 * var_chaste_interface__membrane__v;
        const double var_x1048 = exp(1.5384615384615385 - var_x1047);
        const double var_x1049 = 1.0 + var_x1048;
        const double var_x1050 = 0.034035137876343539 * var_chaste_interface__membrane__v;
        const double var_x1051 = exp(0.62658348478969694 - var_x1050);
        const double var_x1052 = 1.0 + var_x1051;
        const double var_x1053 = exp(3.403513787634354 + var_x1050);
        const double var_x1054 = 1.0 + var_x1053;
        const double var_x1055 = 3.3285782215882072 / var_x1054;
        const double var_x1056 = 0.78668405081082138 / var_x1052;
        const double var_x1057 = exp(14.123035029087756 + 0.12377769525931426 * var_chaste_interface__membrane__v);
        const double var_x1058 = exp(-1.6345469940728197 - 0.016934801016088061 * var_chaste_interface__membrane__v);
        const double var_x1059 = 1 / (1.7800000000000001e-8 * var_x1057 + 0.0014159999999999999 * var_x1058);
        const double var_x1060 = 1 / (43.0 + var_x1059);
        const double var_x1061 = exp(2.0769230769230771 + var_x1047);
        const double var_x1062 = 1.0 + var_x1061;
        const double var_x1063 = 0.076923076923076927 * var_x1061 / pow(var_x1062, 2);
        const double var_x1064 = 1 / var_x1062;
        const double var_x1065 = exp(-1.0 - 0.01 * var_chaste_interface__membrane__v);
        const double var_x1066 = exp(-0.93131548311990686 + 0.11641443538998836 * var_chaste_interface__membrane__v);
        const double var_x1067 = 1 / (0.39329999999999998 * var_x1065 + 0.08004 * var_x1066);
        const double var_x1068 = 1 / (6.1619999999999999 + var_x1067);
        const double var_x1069 = exp(-1.7115839243498816 - 0.23640661938534277 * var_chaste_interface__membrane__v);
        const double var_x1070 = 1.0 + var_x1069;
        const double var_x1071 = exp(1.26 + 0.089999999999999997 * var_chaste_interface__membrane__v);
        const double var_x1072 = exp(-0.30000000000000004 - 0.050000000000000003 * var_chaste_interface__membrane__v);
        const double var_x1073 = var_x1071 + var_x1072;
        const double var_x1074 = 0.59999999999999998 + 1 / var_x1073;
        const double var_x1075 = 1 / var_x1074;
        const double var_x1076 = exp(3.5190000000000001 + var_x398);
        const double var_x1077 = -var_x398;
        const double var_x1078 = exp(-3.5190000000000001 + var_x1077);
        const double var_x1079 = 1 / (0.0044999999999999997 * var_x1076 + 0.0044999999999999997 * var_x1078);
        const double var_x1080 = 1 / (7.0 + var_x1079);
        const double var_x1081 = exp(6.1904761904761898 + 0.27056277056277056 * var_chaste_interface__membrane__v);
        ...
        const double var_x1086 = (0.00044999999999999999 * var_x1078 - 0.00044999999999999999 * var_x1076) / (pow((1 + 0.14285714285714285 * var_x1079), 2) * pow((var_x1076 + var_x1078), 2));
        const double var_x1087 = exp(3.3649999999999998 + 0.16666666666666666 * var_chaste_interface__membrane__v);
        const double var_x1088 = exp(-5.0474999999999994 - 0.25 * var_chaste_interface__membrane__v);
        ...
        const double var_x1092 = exp(1.5985714285714285 + var_x1091);
        const double var_x1093 = -var_x1091;
        const double var_x1094 = exp(-1.5985714285714285 + var_x1093);
        const double var_x1095 = 1 / (0.040000000000000001 * var_x1092 + 0.040000000000000001 * var_x1094);
        const double var_x1096 = 1 / (5.04 + 0.71999999999999997 * var_x1095);
        const double var_x1097 = (0.0057142857142857143 * var_x1094 - 0.0057142857142857143 * var_x1092) / (pow((1 + 0.14285714285714285 * var_x1095), 2) * pow((var_x1092 + var_x1094), 2));
        const double var_x1098 = exp(2.1699999999999999 + var_x1091);
        const double var_x1099 = exp(-5.0633333333333335 - 0.33333333333333331 * var_chaste_interface__membrane__v);
        const double var_x1100 = 1 / (0.00012 * var_x1098 + 0.00012 * var_x1099);
        const double var_x1101 = 1 / (49.0 + 0.48999999999999999 * var_x1100);
        const double var_x1102 = 1 / (17.5 + 2.5 * var_x1079);
        const double var_x1103 = 1 / (12.6 + 1.7999999999999998 * var_x1095);
        const double var_x1104 = 1.0 + 0.002 * var_x386;
        const double var_x1105 = pow((1 / var_chaste_interface__ICaL__jca + 0.001 * pow(var_x1104, 4)), (-2));
        const double var_x1106 = exp(-4.2857142857142856 + var_x1093);
        const double var_x1107 = 1.0 + var_x1106;
        const double var_x1108 = 0.033333333333333333 * var_chaste_interface__membrane__v;
        const double var_x1109 = exp(0.54333333333333333 + var_x1108);
        const double var_x1110 = exp(-0.54333333333333333 - var_x1108);
        const double var_x1111 = 1.0680000000000001 * var_x1109;
        const double var_x1112 = 1.0680000000000001 * var_x1110;
        const double var_x1113 = exp(12.199999999999999 + 0.20000000000000001 * var_chaste_interface__membrane__v);
        const double var_x1114 = 1.0 + var_x1113;
        const double var_x1115 = exp(4.6558441558441563 + 0.064935064935064929 * var_chaste_interface__membrane__v);
        const double var_x1116 = exp(-0.86074429771908767 - 0.012004801920768308 * var_chaste_interface__membrane__v);
        const double var_x1117 = 0.014999999999999999 * var_x1115;
        const double var_x1118 = 0.014999999999999999 * var_x1116;
        const double var_x1119 = exp(1.4808635917566242 - 0.049067713444553483 * var_chaste_interface__membrane__v);
        const double var_x1120 = exp(-3.6340139570948562 + 0.25846471956577927 * var_chaste_interface__membrane__v);
        const double var_x1121 = 1 / (4.1230000000000003e-5 * var_x1119 + 0.36520000000000002 * var_x1120);
        const double var_x1122 = 1 / (12.98 + var_x1121);
        const double var_x1123 = exp(-1.2280159080866107 - 0.14729709824716453 * var_chaste_interface__membrane__v);
        const double var_x1124 = 1.0 + var_x1123;
        const double var_x1125 = 0.14729709824716453 * var_x1123 / pow(var_x1124, 2);
        const double var_x1126 = 1 / var_x1124;
        const double var_x1127 = exp(0.4834232845026985 - 0.038550501156515031 * var_chaste_interface__membrane__v);
        const double var_x1128 = exp(-2.3793337865397692 + 0.13596193065941536 * var_chaste_interface__membrane__v);
        const double var_x1129 = 1 / (1.128e-5 * var_x1127 + 0.066290000000000002 * var_x1128);
        const double var_x1130 = 1 / (1.865 + var_x1129);
        const double var_x1131 = exp(-0.91304347826086951 - 0.0043478260869565218 * var_chaste_interface__membrane__v);
        const double var_x1132 = exp(2.7123595505617977 + 0.056179775280898875 * var_chaste_interface__membrane__v);
        const double var_x1133 = 1 / (0.001292 * var_x1131 + 0.00023259999999999999 * var_x1132);
        const double var_x1134 = 1 / (817.29999999999995 + var_x1133);
        const double var_x1135 = exp(-1.2987012987012987 - 0.11195700850873264 * var_chaste_interface__membrane__v);
        const double var_x1136 = 1.0 + var_x1135;
        const double var_x1137 = 0.11195700850873264 * var_x1135 / pow(var_x1136, 2);
        const double var_x1138 = 1 / var_x1136;
        const double var_x1139 = exp(-2.5 + 0.050000000000000003 * var_chaste_interface__membrane__v);
        const double var_x1140 = exp(-2.1464516129032258 - 0.032258064516129031 * var_chaste_interface__membrane__v);
        const double var_x1141 = 0.019300000000000001 * var_x1140;
        const double var_x1142 = 0.01 * var_x1139;
        const double var_x1143 = exp(9.1578947368421044 + 0.10526315789473684 * var_chaste_interface__membrane__v);
        const double var_x1144 = 1.0 + var_x1143;
        const double var_x1145 = exp(0.94999999999999996 + 0.016666666666666666 * var_chaste_interface__membrane__v);
        const double var_x1146 = exp(-13.199999999999999 + var_x1077);
        const double var_x1147 = 0.00050000000000000001 * var_x1145;
        const double var_x1148 = 0.00050000000000000001 * var_x1146;
        const double var_x1149 = 1 / (3.8115000000000001 + 1.5691999999999999 * NV_Ith_S(mParameters, 1));
        const double var_x1150 = exp(var_x1149 * (-144.59 + var_x805 - 2.5537999999999998 * NV_Ith_S(mParameters, 1)));
        const double var_x1151 = 1.0 + var_x1150;
        const double var_x1152 = exp(3.4155488244627148 + 0.014423770373575654 * var_chaste_interface__membrane__v);
        const double var_x1153 = exp(-6.2475442043222005 - 0.049115913555992145 * var_chaste_interface__membrane__v);
        const double var_x1154 = 0.0081833060556464818 * var_x1152;
        const double var_x1155 = 0.0081833060556464818 * var_x1153;
        const double var_x1156 = 1.0 + 1 / pow(var_chaste_interface__intracellular_ions__cajsr, 8);
        const double var_x1157 = 1 / var_x1156;
        const double var_x1158 = 1.0 + 3.7780199833600026e-5 / pow(var_x390, 8);
        const double var_x1159 = 1.0 + 1 / var_x1158;
        const double var_x1160 = var_x1157 * var_x1159;
        const double var_x1161 = 948.60627177700349 * var_x1160 * var_x521;
        const double var_x1162 = var_x971 - var_x957 * (var_x969 + var_x970);
        const double var_x1163 = var_x1162 > 0;
        const double var_x1164 = 1 / var_x1159;
        const double var_x1165 = 1.0 + 0.0123 / var_chaste_interface__intracellular_ions__cajsr;
        const double var_x1166 = 0.5 * var_x1164 * var_x1165;
        const double var_x1167 = 1 / (pow(var_x1158, 2) * pow(var_x390, 9));
        const double var_x1168 = var_x1167 * (-8 + 0.40000000000000002 * var_x388);
        const double var_x1169 = var_x1157 * var_x1162;
        const double var_x1170 = pow(var_x1159, (-2));
        const double var_x1171 = var_x1168 * var_x1170;
        const double var_x1172 = 15.0 * var_x1160;
        const double var_x1173 = var_x1003 + ((var_x1163) ? (var_x1162 * var_x1172) : (0));
        const double var_x1174 = var_x1165 * var_x1173;
        const double var_x1175 = var_x1167 * var_x760;
        const double var_x1176 = var_x1170 * var_x1175;
        const double var_x1177 = 0.0030303000000000001 * var_x1160;
        const double var_x1178 = var_x1160 * var_x972;
        const double var_x1179 = 3794.4250871080139 * var_x1178;
        const double var_x1180 = 4173.8675958188151 * var_x1178;
        const double var_x1181 = 1.0 + 1 / pow(var_chaste_interface__intracellular_ions__cacsr, 8);
        const double var_x1182 = 1 / var_x1181;
        const double var_x1183 = var_x1159 * var_x1182;
        const double var_x1184 = 91.0 * var_x1183;
        const double var_x1185 = var_x901 > 0;
        const double var_x1186 = 1.0 + 0.0123 / var_chaste_interface__intracellular_ions__cacsr;
        const double var_x1187 = 0.16666666666666666 * var_x1164 * var_x1186;
        const double var_x1188 = var_x1182 * var_x901;
        const double var_x1189 = var_x1009 + ((var_x1185) ? (var_x1184 * var_x901) : (0));
        const double var_x1190 = var_x1186 * var_x1189;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x427 + var_x429 + var_x465 + var_x473 + var_x495 + var_x515 + var_x558 - var_x411 - var_x421 - var_x434 - var_x435 - var_x444 - var_x449 + 82.600849572375722 * var_x369 + 12.803131683718236 * var_x375 - 0.088195275017347044 * var_x413 - 987.32334834492804 * var_x422 + var_x343 * var_x345 + var_x361 * var_x364 + var_x361 * var_x374 - var_x236 * var_x240 - var_x331 * var_x335 - var_x356 * var_x360 - var_x361 * var_x372 - var_x365 * var_x367 - var_x68 * var_x77);
        IJth(rJacobian, 4, 0) = var_x924 * (var_x515 + 247.80254871712717 * var_x369 + 38.409395051154711 * var_x375 - 2961.9700450347841 * var_x422 - 0.26458582505204115 * var_x413 + var_x343 * var_x918 + var_x361 * var_x920 + var_x361 * var_x923 - var_x331 * var_x917 - var_x356 * var_x919 - var_x361 * var_x922 - var_x365 * var_x921 - var_x68 * var_x916);
        IJth(rJacobian, 5, 0) = var_x931 * (var_x473 - var_x236 * var_x930);
        IJth(rJacobian, 7, 0) = -var_x931 * (var_x411 + var_x421 + var_x434 + var_x435 + var_x444 + var_x449 - var_x427 - var_x429);
        IJth(rJacobian, 8, 0) = var_x924 * (var_x558 + 0.17639055003469409 * var_x413 + 1974.6466966898561 * var_x422 - 165.20169914475144 * var_x369 - 25.606263367436473 * var_x375 + var_x356 * var_x941 + var_x361 * var_x945 + var_x365 * var_x943 + var_x68 * var_x940 - var_x343 * var_x942 - var_x361 * var_x944 - var_x361 * var_x946);
        IJth(rJacobian, 9, 0) = var_x958 * (var_x495 + var_x236 * var_x952);
        IJth(rJacobian, 10, 0) = var_x982 * (var_x465 + var_x331 * var_x977);
        IJth(rJacobian, 14, 0) = var_x1014 * (-var_chaste_interface__INa__m + 1 / var_x1011) + 0.13218246467423633 * var_x1010 * var_x1017 / pow(var_x1011, 2);
        IJth(rJacobian, 15, 0) = (var_x1022 - var_chaste_interface__INa__hf) * (1.7421033720588395 * var_x1023 - 4.6908207027322822e-7 * var_x1024) - var_x1027 * (var_x1025 + var_x1026);
        IJth(rJacobian, 16, 0) = (var_x1022 - var_chaste_interface__INa__hs) * (0.0059001058948111541 * var_x1028 - 0.00034916221033868096 * var_x1029) - var_x1027 * (var_x1030 + var_x1031);
        IJth(rJacobian, 17, 0) = -var_x1027 * var_x1035 - 0.034401177316054889 * var_x1036 * (var_x1022 - var_chaste_interface__INa__j);
        IJth(rJacobian, 18, 0) = (-var_chaste_interface__INa__hsp + 1 / var_x1038) * (0.0019667019649370517 * var_x1028 - 0.00011638740344622698 * var_x1029) - 0.16077170418006431 * var_x1037 * (var_x1039 + var_x1040) / pow(var_x1038, 2);
        IJth(rJacobian, 19, 0) = -var_x1027 * var_x1041 - 0.023562450216475954 * var_x1036 * (var_x1022 - var_chaste_interface__INa__jp);
        IJth(rJacobian, 20, 0) = var_x1014 * (-var_chaste_interface__INaL__mL + 1 / var_x1043) + 0.18996960486322187 * var_x1017 * var_x1042 / pow(var_x1043, 2);
        IJth(rJacobian, 21, 0) = -0.00066773504273504275 * var_x1045 / pow((1.0 + var_x1045), 2);
        IJth(rJacobian, 22, 0) = -0.00022257834757834756 * var_x1046 / pow((1.0 + var_x1046), 2);
        IJth(rJacobian, 23, 0) = (-var_chaste_interface__Ito__a + 1 / var_x1049) * (0.026774900134466751 * var_x1051 / pow(var_x1052, 2) - 0.113288618703949 * var_x1053 / pow(var_x1054, 2)) + 0.076923076923076927 * var_x1048 * (var_x1055 + var_x1056) / pow(var_x1049, 2);
        IJth(rJacobian, 24, 0) = -var_x1060 * var_x1063 - 269.73455237123778 * (var_x1064 - var_chaste_interface__Ito__i1) * (2.3979678238780695e-5 * var_x1058 - 2.2032429756157938e-9 * var_x1057) / (pow((1 + 0.023255813953488372 * var_x1059), 2) * pow((var_x1058 + 1.2570621468926554e-5 * var_x1057), 2));
        IJth(rJacobian, 25, 0) = -var_x1063 * var_x1068 - 0.1702584672014123 * (var_x1064 - var_chaste_interface__Ito__i2) * (0.0039329999999999999 * var_x1065 - 0.0093178114086146686 * var_x1066) / (pow((1 + 0.16228497241155468 * var_x1067), 2) * pow((var_x1065 + 0.20350877192982458 * var_x1066), 2));
        IJth(rJacobian, 26, 0) = 0.23640661938534277 * var_x1069 * var_x1075 / pow(var_x1070, 2) - (-var_chaste_interface__ICaL__d + 1 / var_x1070) * (0.050000000000000003 * var_x1072 - 0.089999999999999997 * var_x1071) / (pow(var_x1073, 2) * pow(var_x1074, 2));
        IJth(rJacobian, 27, 0) = -var_x1080 * var_x1084 - 1007.8105316200556 * var_x1086 * (var_x1085 - var_chaste_interface__ICaL__ff);
        IJth(rJacobian, 28, 0) = -var_x1084 * var_x1090 - 816.32653061224505 * (var_x1085 - var_chaste_interface__ICaL__fs) * (8.7499999999999992e-6 * var_x1088 - 5.8333333333333331e-6 * var_x1087) / (pow((1 + 0.001 * var_x1089), 2) * pow((var_x1087 + var_x1088), 2));
        IJth(rJacobian, 29, 0) = -var_x1084 * var_x1096 - 17.715419501133788 * var_x1097 * (var_x1085 - var_chaste_interface__ICaL__fcaf);
        IJth(rJacobian, 30, 0) = -var_x1084 * var_x1101 - 14172.335600907028 * (var_x1085 - var_chaste_interface__ICaL__fcas) * (4.0000000000000003e-5 * var_x1099 - 1.7142857142857142e-5 * var_x1098) / (pow((1 + 0.01 * var_x1100), 2) * pow((var_x1098 + var_x1099), 2));
        IJth(rJacobian, 31, 0) = -0.0036075036075036075 * var_x1083;
        IJth(rJacobian, 32, 0) = -var_x1084 * var_x1102 - 403.12421264802225 * var_x1086 * (var_x1085 - var_chaste_interface__ICaL__ffp);
        IJth(rJacobian, 33, 0) = -var_x1084 * var_x1103 - 7.0861678004535147 * var_x1097 * (var_x1085 - var_chaste_interface__ICaL__fcafp);
        IJth(rJacobian, 35, 0) = (-var_chaste_interface__ICaT__b + 1 / var_x1107) * (0.0356 * var_x1109 - 0.0356 * var_x1110) + 0.14285714285714285 * var_x1106 * (var_x1111 + var_x1112) / pow(var_x1107, 2);
        IJth(rJacobian, 36, 0) = (-var_chaste_interface__ICaT__g + 1 / var_x1114) * (0.00097402597402597392 * var_x1115 - 0.0001800720288115246 * var_x1116) - 0.20000000000000001 * var_x1113 * (var_x1117 + var_x1118) / pow(var_x1114, 2);
        IJth(rJacobian, 37, 0) = var_x1122 * var_x1125 - 0.044502978385908498 * (var_x1126 - var_chaste_interface__IKr__xrf) * (2.0230618253189406e-6 * var_x1119 - 0.094391315585422589 * var_x1120) / (pow((1 + 0.077041602465331274 * var_x1121), 2) * pow((var_x1120 + 0.00011289704271631982 * var_x1119), 2));
        IJth(rJacobian, 38, 0) = var_x1125 * var_x1130 - 65.425385409990326 * (var_x1126 - var_chaste_interface__IKr__xrs) * (4.348496530454896e-7 * var_x1127 - 0.0090129163834126447 * var_x1128) / (pow((1 + 0.53619302949061665 * var_x1129), 2) * pow((var_x1128 + 0.00017016141197767387 * var_x1127), 2));
        IJth(rJacobian, 39, 0) = var_x1134 * var_x1137 - 0.89683381486126834 * (var_x1138 - var_chaste_interface__IKs__xs1) * (5.617391304347826e-6 * var_x1131 - 1.3067415730337078e-5 * var_x1132) / (pow((1 + 0.001223540927444023 * var_x1133), 2) * pow((var_x1131 + 0.18003095975232197 * var_x1132), 2));
        IJth(rJacobian, 40, 0) = var_x1137 * (var_x1141 + var_x1142) + (var_x1138 - var_chaste_interface__IKs__xs2) * (0.00050000000000000001 * var_x1139 - 0.00062258064516129035 * var_x1140);
        IJth(rJacobian, 41, 0) = (-var_chaste_interface__If__y + 1 / var_x1144) * (8.3333333333333337e-6 * var_x1145 - 5.0000000000000002e-5 * var_x1146) - 0.10526315789473684 * var_x1143 * (var_x1147 + var_x1148) / pow(var_x1144, 2);
        IJth(rJacobian, 42, 0) = (-var_chaste_interface__IK1__xk1 + 1 / var_x1151) * (0.00011803412744333594 * var_x1152 - 0.00040193055283135957 * var_x1153) + var_x1149 * var_x1150 * (var_x1154 + var_x1155) / pow(var_x1151, 2);
        IJth(rJacobian, 43, 0) = var_x1166 * ((var_x1163) ? (-var_x1161 * (var_x479 + var_x481 + var_x488 + var_x489 + var_x492 + var_x494 - var_x484 - var_x486)) : (0));
        IJth(rJacobian, 1, 1) = var_x892 * var_x897 + var_x901 * (3.15e-5 / pow(var_x893, 3) + 0.00053550000000000006 / pow(var_x894, 3)) / pow(var_x895, 2);
        IJth(rJacobian, 10, 1) = 0.083333333333333329 * var_x980;
        IJth(rJacobian, 11, 1) = var_x891 * var_x991;
        IJth(rJacobian, 44, 1) = var_x1187 * ((var_x1185) ? (var_x1184 * var_x892) : (0));
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x564 + var_x576 + var_x577 + var_x580 - var_x567);
        IJth(rJacobian, 1, 2) = var_x897 * var_x909;
        IJth(rJacobian, 2, 2) = -0.00068000000000000005 - var_x390 * var_x915 + var_x385 * var_x902 * var_x915;
        IJth(rJacobian, 4, 2) = var_x576 * var_x924;
        IJth(rJacobian, 5, 2) = var_x577 * var_x931;
        IJth(rJacobian, 7, 2) = -var_x931 * (var_x567 - var_x564);
        IJth(rJacobian, 9, 2) = var_x580 * var_x958;
        IJth(rJacobian, 10, 2) = var_x989 * (var_x907 * var_x988 - var_x906 * var_x985);
        IJth(rJacobian, 11, 2) = var_x906 * var_x992 + var_x906 * var_x993 - var_x907 * var_x994 - var_x907 * var_x996;
        IJth(rJacobian, 43, 2) = var_x1166 * ((var_x1163) ? (-var_x1161 * (var_x579 - var_x578) - 0.00056670299750400039 * var_x1168 * var_x1169) : (0)) + 1.8890099916800013e-5 * var_x1171 * var_x1174;
        IJth(rJacobian, 44, 2) = var_x1187 * ((var_x1185) ? (var_x1184 * var_x909 - 0.0034379981848576026 * var_x1168 * var_x1188) : (0)) + 6.2966999722666711e-6 * var_x1171 * var_x1190;
        IJth(rJacobian, 3, 3) = -0.020833333333333332;
        IJth(rJacobian, 4, 3) = 0.083333333333333329;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x583 + var_x672 + 247.80254871712717 * var_x666 - 1.4127209752081648e-12 * var_x670 - 1.7070053229163944 * var_x669 - 9.9451440954877066e-11 * var_x663 + var_x345 * var_x652 + var_x661 * var_x664 + var_x661 * var_x668 - var_x335 * var_x649 - var_x360 * var_x661 - var_x367 * var_x665 - var_x602 * var_x77 - var_x661 * var_x667);
        IJth(rJacobian, 3, 4) = 0.020833333333333332;
        IJth(rJacobian, 4, 4) = -0.75 + var_x924 * (var_x672 + 743.40764615138153 * var_x666 - 2.9835432286463117e-10 * var_x663 - 4.2381629256244946e-12 * var_x670 - 5.1210159687491839 * var_x669 + var_x652 * var_x918 + var_x661 * var_x925 + var_x661 * var_x927 - var_x602 * var_x916 - var_x649 * var_x917 - var_x661 * var_x919 - var_x661 * var_x926 - var_x665 * var_x921);
        IJth(rJacobian, 5, 4) = 5.0;
        IJth(rJacobian, 8, 4) = var_x924 * (var_x583 + 2.8254419504163296e-12 * var_x670 + 3.4140106458327888 * var_x669 + 1.9890288190975413e-10 * var_x663 - 495.60509743425433 * var_x666 + var_x602 * var_x940 + var_x661 * var_x941 + var_x661 * var_x948 + var_x665 * var_x943 - var_x652 * var_x942 - var_x661 * var_x947 - var_x661 * var_x949);
        IJth(rJacobian, 10, 4) = 0.012912377979094078 * var_x334 * var_x521 * var_x649 * var_x980;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x714 - var_x240 * var_x711);
        IJth(rJacobian, 4, 5) = 0.66666666666666663;
        IJth(rJacobian, 5, 5) = -5.0 + var_x931 * (var_x714 - var_x711 * var_x930);
        IJth(rJacobian, 9, 5) = 0.024210708710801394 * var_x239 * var_x521 * var_x711 * var_x956;
        IJth(rJacobian, 6, 6) = -0.020833333333333332;
        IJth(rJacobian, 8, 6) = 0.083333333333333329;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x715 - var_x716);
        IJth(rJacobian, 7, 7) = -5.0 - var_x931 * (var_x715 + var_x716);
        IJth(rJacobian, 8, 7) = 0.66666666666666663;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x747 + 5.1625530982734826 * var_x745 - 1.0837311590637976e-12 * var_x670 - 7.6291516348946786e-11 * var_x663 + var_x345 * var_x735 + var_x664 * var_x743 + var_x668 * var_x743 - var_x360 * var_x743 - var_x367 * var_x744 - var_x667 * var_x743 - var_x730 * var_x77);
        IJth(rJacobian, 4, 8) = var_x924 * (15.487659294820448 * var_x745 - 2.2887454904684036e-10 * var_x663 - 3.2511934771913929e-12 * var_x670 + var_x735 * var_x918 + var_x743 * var_x925 + var_x743 * var_x927 - var_x730 * var_x916 - var_x743 * var_x919 - var_x743 * var_x926 - var_x744 * var_x921);
        IJth(rJacobian, 6, 8) = 0.020833333333333332;
        IJth(rJacobian, 7, 8) = 5.0;
        IJth(rJacobian, 8, 8) = -0.75 + var_x924 * (var_x747 + 2.1674623181275951e-12 * var_x670 + 1.5258303269789357e-10 * var_x663 - 10.325106196546965 * var_x745 + var_x730 * var_x940 + var_x743 * var_x941 + var_x743 * var_x948 + var_x744 * var_x943 - var_x735 * var_x942 - var_x743 * var_x947 - var_x743 * var_x949);
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x764 + var_x770 + var_x771 + var_x777 - var_x767 - 8.6138099999999988e-12 * var_x759 - var_x240 * var_x757);
        IJth(rJacobian, 1, 9) = var_x897 * var_x914;
        IJth(rJacobian, 2, 9) = 3.7500000000000005e-6 * var_x390 * var_x760 + 1.8750000000000003e-7 * var_x237 * pow(var_x385, 2) / pow(var_x387, 3);
        IJth(rJacobian, 4, 9) = var_x770 * var_x924;
        IJth(rJacobian, 5, 9) = var_x931 * (var_x771 - 2.5841429999999996e-11 * var_x759 - var_x757 * var_x930);
        IJth(rJacobian, 7, 9) = -var_x931 * (var_x767 - var_x764);
        IJth(rJacobian, 9, 9) = var_x956 * (var_x968 + var_x957 * (var_x777 + 1.7227619999999998e-11 * var_x759 + var_x757 * var_x952)) + (var_x971 + var_x957 * (-var_x969 - var_x970 + var_x758 * var_x952)) * (0.0083119800000000001 / pow(var_x953, 3) + 3.4756499999999998e-5 / pow(var_x954, 3)) / pow(var_x955, 2);
        IJth(rJacobian, 10, 9) = var_x989 * (0.66666666666666663 + var_x913 * var_x988 - var_x912 * var_x985);
        IJth(rJacobian, 11, 9) = var_x912 * var_x992 + var_x912 * var_x993 - var_x913 * var_x994 - var_x913 * var_x996;
        IJth(rJacobian, 12, 9) = var_x1002 * (var_x998 + 2.2222200000000002e-7 * var_x967 - var_x959 * var_x997);
        IJth(rJacobian, 34, 9) = 7.9999999999999996e-6 * var_x1105 * var_x237 * pow(var_x1104, 3);
        IJth(rJacobian, 43, 9) = var_x1166 * ((var_x1163) ? (var_x1172 * (var_x968 - var_x957 * (var_x773 + var_x774 + var_x776 - var_x775)) + 3.4002179850240029e-7 * var_x1169 * var_x1175) : (0)) - 1.1334059950080009e-8 * var_x1174 * var_x1176;
        IJth(rJacobian, 44, 9) = var_x1187 * ((var_x1185) ? (var_x1184 * var_x914 + 2.0627989109145618e-6 * var_x1175 * var_x1188) : (0)) - 3.7780199833600036e-9 * var_x1176 * var_x1190;
        IJth(rJacobian, 45, 9) = 1800.0 - 1800.0 * var_chaste_interface__IP3__u;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x794 - 5.4447296618926212e-7 * var_x790 - 3.4455239999999995e-11 * var_x787 - var_x335 * var_x785);
        IJth(rJacobian, 1, 10) = 0.020833333333333332 * var_x896;
        IJth(rJacobian, 4, 10) = var_x924 * (-1.0336571999999999e-10 * var_x787 - var_x785 * var_x917);
        IJth(rJacobian, 8, 10) = -9.1820528096028884e-6 * var_x521 * var_x790;
        IJth(rJacobian, 9, 10) = 5.0 * var_x956;
        IJth(rJacobian, 10, 10) = var_x989 * (-0.75 + var_x981 * (var_x794 + 6.8910479999999991e-11 * var_x787 + var_x785 * var_x977) - var_x987 * var_x990) + (5.950000000000001e-5 / pow(var_x978, 3) + 3.4999999999999999e-6 / pow(var_x791, 3)) * (var_x898 + 0.66666666666666663 * var_chaste_interface__intracellular_ions__cass + 0.083333333333333329 * var_chaste_interface__intracellular_ions__cai - 0.75 * var_chaste_interface__intracellular_ions__casl + var_x981 * (var_x786 * var_x977 - var_x451 * (-0.5 * var_x872 + var_chaste_interface__membrane__v) - var_x460 * var_chaste_interface__membrane__v - var_x792 * var_chaste_interface__intracellular_ions__casl) - var_x889 * var_x985) / pow(var_x979, 2);
        IJth(rJacobian, 11, 10) = var_x990 * var_x995;
        IJth(rJacobian, 43, 10) = var_x1166 * ((var_x1163) ? (75.0 * var_x1160) : (0));
        IJth(rJacobian, 44, 10) = var_x1187 * ((var_x1185) ? (1.8958333333333333 * var_x1183) : (0));
        IJth(rJacobian, 1, 11) = 1.8666666666666665e-5 * var_x896;
        IJth(rJacobian, 10, 11) = 1.8666666666666665e-5 * var_x980;
        IJth(rJacobian, 11, 11) = -0.0024333333333333334;
        IJth(rJacobian, 12, 11) = 0.0083333333333333332 * var_x1001;
        IJth(rJacobian, 13, 11) = var_x1008;
        IJth(rJacobian, 44, 11) = var_x1187 * ((var_x1185) ? (0.0016986666666666667 * var_x1183) : (0));
        IJth(rJacobian, 9, 12) = var_x956 * var_x965;
        IJth(rJacobian, 11, 12) = 0.00041666666666666669;
        IJth(rJacobian, 12, 12) = var_x1002 * (-0.0083333333333333332 - var_x998) + 1.9199999999999999 * (var_x1003 + var_x1004 - 0.0083333333333333332 * var_chaste_interface__intracellular_ions__cajsr - var_x959 * var_x998) / (pow(var_x1000, 2) * pow(var_x999, 3));
        IJth(rJacobian, 43, 12) = var_x1166 * ((var_x1163) ? (var_x1177 * var_x962 * var_chaste_interface__intracellular_ions__cass + 120.0 * var_x1159 * var_x1162 / (pow(var_x1156, 2) * pow(var_chaste_interface__intracellular_ions__cajsr, 9))) : (0)) - 0.0061500000000000001 * var_x1164 * var_x1173 / pow(var_chaste_interface__intracellular_ions__cajsr, 2);
        IJth(rJacobian, 11, 13) = 0.0016666666666666668;
        IJth(rJacobian, 13, 13) = -var_x1008 + 0.86805555555555558 * (var_x1004 + var_x1009 - 0.0083333333333333332 * var_chaste_interface__intracellular_ions__cacsr) / (pow(var_x1005, 3) * pow((0.43402777777777779 + var_x1006), 2));
        IJth(rJacobian, 44, 13) = var_x1187 * ((var_x1185) ? (728.0 * var_x1159 * var_x901 / (pow(var_x1181, 2) * pow(var_chaste_interface__intracellular_ions__cacsr, 9))) : (0)) - 0.0020500000000000002 * var_x1164 * var_x1189 / pow(var_chaste_interface__intracellular_ions__cacsr, 2);
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x795);
        IJth(rJacobian, 4, 14) = -50.592334494773517 * var_x521 * var_x795;
        IJth(rJacobian, 14, 14) = var_x1018;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x797);
        IJth(rJacobian, 4, 15) = -var_x797 * var_x924;
        IJth(rJacobian, 15, 15) = -var_x1025 - var_x1026;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x799);
        IJth(rJacobian, 4, 16) = -var_x799 * var_x924;
        IJth(rJacobian, 16, 16) = -var_x1030 - var_x1031;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x800);
        IJth(rJacobian, 4, 17) = -var_x800 * var_x924;
        IJth(rJacobian, 17, 17) = -var_x1035;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x798 * var_x801);
        IJth(rJacobian, 4, 18) = -0.16864111498257855 * var_x392 * var_x521 * var_x801;
        IJth(rJacobian, 18, 18) = -var_x1039 - var_x1040;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x393 * var_x802);
        IJth(rJacobian, 4, 19) = -var_x802 * var_x928;
        IJth(rJacobian, 19, 19) = -var_x1041;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (var_x803);
        IJth(rJacobian, 4, 20) = var_x803 * var_x924;
        IJth(rJacobian, 20, 20) = var_x1018;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (var_x804);
        IJth(rJacobian, 4, 21) = var_x804 * var_x924;
        IJth(rJacobian, 21, 21) = -0.0050000000000000001;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x393 * var_x573);
        IJth(rJacobian, 4, 22) = -var_x573 * var_x928;
        IJth(rJacobian, 22, 22) = -0.0016666666666666668;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (var_x807);
        IJth(rJacobian, 8, 23) = var_x807 * var_x924;
        IJth(rJacobian, 23, 23) = -var_x1055 - var_x1056;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (var_x809);
        IJth(rJacobian, 8, 24) = var_x809 * var_x924;
        IJth(rJacobian, 24, 24) = -var_x1060;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (var_x810);
        IJth(rJacobian, 8, 25) = var_x810 * var_x924;
        IJth(rJacobian, 25, 25) = -var_x1068;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (var_x816 + var_x820 - var_x813 - var_x815);
        IJth(rJacobian, 5, 26) = var_x816 * var_x931;
        IJth(rJacobian, 7, 26) = -var_x931 * (var_x813 + var_x815);
        IJth(rJacobian, 9, 26) = var_x820 * var_x958;
        IJth(rJacobian, 26, 26) = -var_x1075;
        IJth(rJacobian, 43, 26) = var_x1166 * ((var_x1163) ? (-var_x1161 * (var_x818 + var_x819)) : (0));
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x436 * var_x823 - var_x468 * var_x823 - var_x491 * var_x822);
        IJth(rJacobian, 5, 27) = -var_x822 * var_x935;
        IJth(rJacobian, 7, 27) = -var_x822 * var_x938;
        IJth(rJacobian, 9, 27) = -var_x822 * var_x974;
        IJth(rJacobian, 27, 27) = -var_x1080;
        IJth(rJacobian, 43, 27) = var_x1166 * ((var_x1163) ? (-var_x1179 * var_x822) : (0));
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (var_x831 + var_x834 - var_x827 - var_x830);
        IJth(rJacobian, 5, 28) = var_x831 * var_x931;
        IJth(rJacobian, 7, 28) = -var_x931 * (var_x827 + var_x830);
        IJth(rJacobian, 9, 28) = var_x834 * var_x958;
        IJth(rJacobian, 28, 28) = -var_x1090;
        IJth(rJacobian, 43, 28) = var_x1166 * ((var_x1163) ? (-var_x1161 * (var_x832 + var_x833)) : (0));
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x436 * var_x836 - var_x468 * var_x836 - var_x491 * var_x835);
        IJth(rJacobian, 5, 29) = -var_x835 * var_x935;
        IJth(rJacobian, 7, 29) = -var_x835 * var_x938;
        IJth(rJacobian, 9, 29) = -var_x835 * var_x974;
        IJth(rJacobian, 29, 29) = -var_x1096;
        IJth(rJacobian, 43, 29) = var_x1166 * ((var_x1163) ? (-var_x1179 * var_x835) : (0));
        IJth(rJacobian, 0, 30) = mSetVoltageDerivativeToZero ? 0.0 : (var_x843 + var_x846 - var_x839 - var_x842);
        IJth(rJacobian, 5, 30) = var_x843 * var_x931;
        IJth(rJacobian, 7, 30) = -var_x931 * (var_x839 + var_x842);
        IJth(rJacobian, 9, 30) = var_x846 * var_x958;
        IJth(rJacobian, 30, 30) = -var_x1101;
        IJth(rJacobian, 43, 30) = var_x1166 * ((var_x1163) ? (-var_x1161 * (var_x844 + var_x845)) : (0));
        IJth(rJacobian, 0, 31) = mSetVoltageDerivativeToZero ? 0.0 : (var_x853 + var_x856 - var_x849 - var_x852);
        IJth(rJacobian, 5, 31) = var_x853 * var_x931;
        IJth(rJacobian, 7, 31) = -var_x931 * (var_x849 + var_x852);
        IJth(rJacobian, 9, 31) = var_x856 * var_x958;
        IJth(rJacobian, 31, 31) = -0.013333333333333334;
        IJth(rJacobian, 34, 31) = -var_chaste_interface__ICaL__nca + 1.0 * var_x1105 / pow(var_chaste_interface__ICaL__jca, 2);
        IJth(rJacobian, 43, 31) = var_x1166 * ((var_x1163) ? (-var_x1161 * (var_x854 + var_x855)) : (0));
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x420 * var_x858 - var_x469 * var_x858 - var_x493 * var_x857);
        IJth(rJacobian, 5, 32) = -var_x857 * var_x936;
        IJth(rJacobian, 7, 32) = -var_x857 * var_x939;
        IJth(rJacobian, 9, 32) = -var_x857 * var_x975;
        IJth(rJacobian, 32, 32) = -var_x1102;
        IJth(rJacobian, 43, 32) = var_x1166 * ((var_x1163) ? (-var_x1180 * var_x857) : (0));
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x420 * var_x860 - var_x469 * var_x860 - var_x493 * var_x859);
        IJth(rJacobian, 5, 33) = -var_x859 * var_x936;
        IJth(rJacobian, 7, 33) = -var_x859 * var_x939;
        IJth(rJacobian, 9, 33) = -var_x859 * var_x975;
        IJth(rJacobian, 33, 33) = -var_x1103;
        IJth(rJacobian, 43, 33) = var_x1166 * ((var_x1163) ? (-var_x1180 * var_x859) : (0));
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (var_x868 + var_x871 - var_x864 - var_x867);
        IJth(rJacobian, 5, 34) = var_x868 * var_x931;
        IJth(rJacobian, 7, 34) = -var_x931 * (var_x864 + var_x867);
        IJth(rJacobian, 9, 34) = var_x871 * var_x958;
        IJth(rJacobian, 34, 34) = -var_chaste_interface__ICaL__jca;
        IJth(rJacobian, 43, 34) = var_x1166 * ((var_x1163) ? (-var_x1161 * (var_x869 + var_x870)) : (0));
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (var_x874);
        IJth(rJacobian, 10, 35) = var_x874 * var_x982;
        IJth(rJacobian, 35, 35) = -var_x1111 - var_x1112;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (var_x875);
        IJth(rJacobian, 10, 36) = var_x875 * var_x982;
        IJth(rJacobian, 36, 36) = -var_x1117 - var_x1118;
        IJth(rJacobian, 0, 37) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x544 * var_x557);
        IJth(rJacobian, 8, 37) = -var_x544 * var_x951;
        IJth(rJacobian, 37, 37) = -var_x1122;
        IJth(rJacobian, 0, 38) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x546 * var_x557);
        IJth(rJacobian, 8, 38) = -var_x546 * var_x951;
        IJth(rJacobian, 38, 38) = -var_x1130;
        IJth(rJacobian, 0, 39) = mSetVoltageDerivativeToZero ? 0.0 : (var_x876);
        IJth(rJacobian, 8, 39) = var_x876 * var_x924;
        IJth(rJacobian, 39, 39) = -var_x1134;
        IJth(rJacobian, 0, 40) = mSetVoltageDerivativeToZero ? 0.0 : (var_x877);
        IJth(rJacobian, 8, 40) = var_x877 * var_x924;
        IJth(rJacobian, 40, 40) = -var_x1141 - var_x1142;
        IJth(rJacobian, 0, 41) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x878 * var_x879 - var_x878 * var_x880);
        IJth(rJacobian, 4, 41) = -var_x880 * var_x929;
        IJth(rJacobian, 8, 41) = -var_x879 * var_x929;
        IJth(rJacobian, 41, 41) = -var_x1147 - var_x1148;
        IJth(rJacobian, 0, 42) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x524 * var_x537);
        IJth(rJacobian, 8, 42) = -16.864184013781372 * var_x536 * var_x950;
        IJth(rJacobian, 42, 42) = -var_x1154 - var_x1155;
        IJth(rJacobian, 9, 43) = 0.10000000000000001 * var_x956;
        IJth(rJacobian, 12, 43) = -var_x1002;
        IJth(rJacobian, 43, 43) = var_x1166 * (-1 + ((var_x1163) ? (1.5 * var_x1160) : (0)));
        IJth(rJacobian, 1, 44) = 0.013333333333333334 * var_x896;
        IJth(rJacobian, 13, 44) = -var_x1007;
        IJth(rJacobian, 44, 44) = var_x1187 * (-1 + ((var_x1185) ? (1.2133333333333334 * var_x1183) : (0)));
        IJth(rJacobian, 9, 45) = -0.00020202000000000002 * var_x956 * var_x976;
        IJth(rJacobian, 12, 45) = 0.0020202000000000002 * var_x1001 * var_x976;
        IJth(rJacobian, 43, 45) = var_x1166 * ((var_x1163) ? (-var_x1177 * var_x976) : (0));
