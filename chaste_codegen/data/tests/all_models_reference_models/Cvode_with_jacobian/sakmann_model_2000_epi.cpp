...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellsakmann_model_2000_epiFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_L_type_Ca_channel__i_Ca_L_Na_cyt = (1.0 - var_L_type_Ca_channel__FrICa) * (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(50.0 * var_membrane__F / (var_membrane__R * var_membrane__T)) - NV_Ith_S(mParameters, 2) * exp((50.0 - var_chaste_interface__membrane__V) * var_membrane__F / (var_membrane__R * var_membrane__T))) * var_L_type_Ca_channel__P_CaNa * var_L_type_Ca_channel__P_Ca_L * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2_gate__f2 * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_membrane__F / ((1.0 - exp((50.0 - var_chaste_interface__membrane__V) * var_membrane__F / (var_membrane__R * var_membrane__T))) * var_membrane__R * var_membrane__T); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_Na_ds = ((fabs(-50.0 + var_chaste_interface__membrane__V) < 2.6713760661323249e-6) ? (187169.45410232362 * (-49.999997328623934 + var_chaste_interface__membrane__V) * (1.1000000000670202e-10 * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736) - NV_Ith_S(mParameters, 2) * exp(1.0000000000609274e-7)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.0000000000609274e-7)) + 1.1000000000670202e-10 * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736) - NV_Ith_S(mParameters, 2) * exp(-1.0000000000609274e-7)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(-1.0000000000609274e-7))) - 1.1000000000670202e-10 * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736) - NV_Ith_S(mParameters, 2) * exp(1.0000000000609274e-7)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.0000000000609274e-7))) : (4.1177279905020022e-5 * (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736) - NV_Ith_S(mParameters, 2) * exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V)))); // nanoA
        const double var_L_type_Ca_channel_d_gate__alpha_d = ((fabs(19.0 + var_chaste_interface__membrane__V) < 7.1999999917693458e-7) ? (-2.1599999975308037e-5 / (1.0 - exp(9.9999999885685355e-8)) + 694444.44523829618 * (19.000000719999999 + var_chaste_interface__membrane__V) * (2.1599999975308037e-5 / (1.0 - exp(9.9999999885685355e-8)) + 2.1599999975308037e-5 / (1.0 - exp(-9.9999999885685355e-8)))) : (30.0 * (19.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-2.6388888888888888 - 0.1388888888888889 * var_chaste_interface__membrane__V)))); // per_second
        const double var_L_type_Ca_channel_d_gate__beta_d = ((fabs(19.0 + var_chaste_interface__membrane__V) < 1.7999999997186933e-6) ? (2.1599999996624319e-5 / (-1.0 + exp(9.9999999984371841e-8)) - 277777.77782118932 * (18.9999982 + var_chaste_interface__membrane__V) * (-2.1599999996624319e-5 / (-1.0 + exp(9.9999999984371841e-8)) - 2.1599999996624319e-5 / (-1.0 + exp(-9.9999999984371841e-8)))) : (12.0 * (19.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(1.0555555555555556 + 0.055555555555555552 * var_chaste_interface__membrane__V)))); // per_second
        ...
        const double var_L_type_Ca_channel_f_gate__alpha_f = ((fabs(34.0 + var_chaste_interface__membrane__V) < 5.0999999956502506e-7) ? (3.1874999972814066e-6 / (-1.0 + exp(9.9999999914710805e-8)) - 980392.15769891371 * (33.99999949 + var_chaste_interface__membrane__V) * (-3.1874999972814066e-6 / (-1.0 + exp(9.9999999914710805e-8)) - 3.1874999972814066e-6 / (-1.0 + exp(-9.9999999914710805e-8)))) : (6.25 * (34.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(6.666666666666667 + 0.19607843137254904 * var_chaste_interface__membrane__V)))); // per_second
    ...
    void Cellsakmann_model_2000_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x70 = exp(3.7433890822745473 - 0.074867781645490947 * var_chaste_interface__membrane__V);
        ...
        const double var_x177 = 1 / (-1.0 + exp(-9.9999999179090074e-8));
        const double var_x178 = 1 / (-1.0 + exp(1.0000000020937704e-7));
        const double var_x179 = exp(-1.7465999999999999 - 0.123 * var_chaste_interface__membrane__V);
        const double var_x180 = 1.0 - var_x179;
        const double var_x181 = 1.3799999999999999 / var_x180;
        const double var_x182 = 14.199999999999999 + var_chaste_interface__membrane__V;
        const double var_x183 = var_x181 - 0.16973999999999997 * var_x179 * var_x182 / pow(var_x180, 2);
        const double var_x184 = 38.899999999999999 + var_chaste_interface__membrane__V;
        const double var_x185 = fabs(var_x184) < 6.8965517030505907e-7;
        const double var_x186 = 1 / (1.0 - exp(1.0000000000864873e-7));
        const double var_x187 = 1 / (1.0 - exp(-1.0000000000864873e-7));
        const double var_x188 = exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__membrane__V);
        const double var_x189 = -1.0 + var_x188;
        const double var_x190 = 0.60999999999999999 / var_x189;
        const double var_x191 = var_x190 - 0.088449999999999987 * var_x184 * var_x188 / pow(var_x189, 2);
        const double var_x192 = fabs(var_x182) < 8.1300813015161566e-7;
        const double var_x193 = var_x181 * var_x182;
        const double var_x194 = var_x184 * var_x190;
        const double var_x195 = ((var_x185) ? (var_x193 + 4.2068965605324133e-7 * var_x178 - 725000002.21680665 * (38.899999310344825 + var_chaste_interface__membrane__V) * (-4.2068965171893065e-10 * var_x177 - 4.2068965605324136e-10 * var_x178)) : ((var_x192) ? (var_x194 - 1.1219512196092295e-6 * var_x186 + 614999999.94681036 * (14.200000813008129 + var_chaste_interface__membrane__V) * (1.1219512196092296e-9 * var_x186 + 1.1219512196092296e-9 * var_x187)) : (var_x193 + var_x194)));
        const double var_x196 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V);
        const double var_x197 = 1.0 + var_x196;
        const double var_x198 = 1 / (-1.0 + exp(9.9999999925515227e-8));
        const double var_x199 = 1 / (-1.0 + exp(-9.9999999925515227e-8));
        const double var_x200 = 1 / (1.0 - exp(2.1542940304186685e-7));
        const double var_x201 = 1 / (1.0 - exp(-2.1542940304186685e-7));
        const double var_x202 = 30.0 + var_chaste_interface__membrane__V;
        const double var_x203 = fabs(var_x202) < 1.4556040746072085e-6;
        const double var_x204 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V);
        const double var_x205 = -1.0 + var_x204;
        const double var_x206 = 0.13100000000000001 / var_x205;
        const double var_x207 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V);
        const double var_x208 = 1.0 - var_x207;
        const double var_x209 = 0.071899999999999992 / var_x208;
        const double var_x210 = ((var_x203) ? (-1.9068413377354434e-7 * var_x199 - 1.0465793296425829e-7 * var_x200 + 343500000.2558552 * (30.000001455604075 + var_chaste_interface__membrane__V) * (1.9068413377354434e-10 * var_x198 + 1.9068413377354434e-10 * var_x199 + 1.0465793296425829e-10 * var_x200 + 1.0465793296425829e-10 * var_x201)) : (var_x202 * var_x206 + var_x202 * var_x209));
        const double var_x211 = 1 / (1.0 - exp(-9.9999999747524276e-8));
        const double var_x212 = 1 / (1.0 - exp(1.0000000045806701e-7));
        const double var_x213 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x214 = fabs(var_x213) < 1.0000000010279564e-6;
        const double var_x215 = -0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x216 = exp(-4.1000000000000005 + var_x215);
        const double var_x217 = 1.0 - var_x216;
        const double var_x218 = 200.0 / var_x217;
        const double var_x219 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x220 = 0.00020000000091613401 * var_x212;
        const double var_x221 = -0.125 * var_chaste_interface__membrane__V;
        const double var_x222 = exp(-9.3737545557863378 + var_x221);
        const double var_x223 = exp(-7.4990036446290711 + var_x215);
        const double var_x224 = 0.0030000000000000001 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x225 = 1 / (1.0 - exp(9.9999999885685355e-8));
        const double var_x226 = 1 / (1.0 - exp(-9.9999999885685355e-8));
        const double var_x227 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x228 = fabs(var_x227);
        const double var_x229 = var_x228 < 7.1999999917693458e-7;
        const double var_x230 = exp(-2.6388888888888888 - 0.1388888888888889 * var_chaste_interface__membrane__V);
        const double var_x231 = 1.0 - var_x230;
        const double var_x232 = 30.0 / var_x231;
        const double var_x233 = 1 / (-1.0 + exp(9.9999999984371841e-8));
        const double var_x234 = 1 / (-1.0 + exp(-9.9999999984371841e-8));
        const double var_x235 = var_x228 < 1.7999999997186933e-6;
        const double var_x236 = exp(1.0555555555555556 + 0.055555555555555552 * var_chaste_interface__membrane__V);
        const double var_x237 = -1.0 + var_x236;
        const double var_x238 = 12.0 / var_x237;
        const double var_x239 = 2.1599999996624319e-5 * var_x233;
        const double var_x240 = 2.1599999975308037e-5 * var_x225;
        const double var_x241 = 1 / (-1.0 + exp(9.9999999914710805e-8));
        const double var_x242 = 1 / (-1.0 + exp(-9.9999999914710805e-8));
        const double var_x243 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x244 = fabs(var_x243) < 5.0999999956502506e-7;
        const double var_x245 = 0.19607843137254904 * var_chaste_interface__membrane__V;
        const double var_x246 = exp(6.666666666666667 + var_x245);
        const double var_x247 = -1.0 + var_x246;
        const double var_x248 = 6.25 / var_x247;
        const double var_x249 = exp(-6.666666666666667 - var_x245);
        const double var_x250 = 1.0 + var_x249;
        const double var_x251 = 3.1874999972814066e-6 * var_x241;
        const double var_x252 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x253 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x254 = exp(-1.25 + var_x221);
        const double var_x255 = 1.0 + var_x254;
        const double var_x256 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x257 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x258 = 0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x259 = 1 / var_x258;
        const double var_x260 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x258, 2);
        const double var_x261 = 0.01 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x262 = 1 / var_x261;
        const double var_x263 = 2 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x264 = ((var_chaste_interface__membrane__V < -50.0) ? (5.0) : (1.0));
        const double var_x265 = var_x259 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x266 = 1.0 - var_x265;
        const double var_x267 = var_x262 * var_x266;
        const double var_x268 = var_x265 + var_x267 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x269 = 0.5 * var_x264 * var_x268;
        const double var_x270 = var_x269 * (-2 * var_x260 + 2 * var_x259 + var_x262 * var_x263 * (var_x260 - var_x259));
        const double var_x271 = var_x270 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x272 = 0.5 * pow(var_x268, 2);
        const double var_x273 = -var_x264 * var_x272;
        const double var_x274 = var_x269 * (2 * var_x267 - var_x263 * var_x266 / pow(var_x261, 2));
        const double var_x275 = var_x274 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x276 = 8.4392437745822447e-5 * var_x19 - 3.1591373008424612e-6 * var_chaste_interface__membrane__V;
        const double var_x277 = -var_x174;
        ...
        IJth(rJacobian, 2, 0) = (0.001 / var_x176 - 0.001 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr) * ((var_x185) ? (var_x183 + 0.30499999842881237 * var_x177 + 0.30500000157118762 * var_x178) : ((var_x192) ? (var_x191 + 0.68999999999999995 * var_x186 + 0.68999999999999995 * var_x187) : (var_x183 + var_x191))) + 0.00013333333333333334 * var_x175 * var_x195 / pow(var_x176, 2);
        IJth(rJacobian, 3, 0) = (0.001 / var_x197 - 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs) * ((var_x203) ? (0.065500000000000003 * var_x198 + 0.065500000000000003 * var_x199 + 0.035949999999999996 * var_x200 + 0.035949999999999996 * var_x201) : (var_x206 + var_x209 - 0.0089997000000000011 * var_x202 * var_x204 / pow(var_x205, 2) - 0.0106412 * var_x202 * var_x207 / pow(var_x208, 2))) + 5.9880239520958083e-5 * var_x196 * var_x210 / pow(var_x197, 2);
        IJth(rJacobian, 4, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x214) ? (99.999999644728632 * var_x211 + 100.00000035527137 * var_x212) : (var_x218 - 20.0 * var_x213 * var_x216 / pow(var_x217, 2))) + 0.44800000000000001 * var_x219 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 5, 0) = -0.125 * var_x222 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x223 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x223), 2);
        IJth(rJacobian, 6, 0) = (0.0030000000000000001 - var_x224) * ((var_x229) ? (15.0 * var_x225 + 15.0 * var_x226) : (var_x232 - 4.166666666666667 * var_x227 * var_x230 / pow(var_x231, 2))) - var_x224 * ((var_x235) ? (6.0 * var_x233 + 6.0 * var_x234) : (var_x238 - 0.66666666666666663 * var_x227 * var_x236 / pow(var_x237, 2)));
        IJth(rJacobian, 7, 0) = (0.00029999999999999997 - 0.00029999999999999997 * var_chaste_interface__L_type_Ca_channel_f_gate__f) * ((var_x244) ? (3.125 * var_x241 + 3.125 * var_x242) : (var_x248 - 1.2254901960784315 * var_x243 * var_x246 / pow(var_x247, 2))) - 0.00070588235294117652 * var_x249 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x250, 2);
        IJth(rJacobian, 10, 0) = -0.058823529411764705 * var_x253 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x254 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x255, 2);
        IJth(rJacobian, 11, 0) = 0.066600000000000006 * var_x256 / pow((1.0 + var_x256), 2);
        ...
        IJth(rJacobian, 12, 1) = -var_x271 + var_x257 * var_x270;
        IJth(rJacobian, 13, 1) = var_x271;
        ...
        IJth(rJacobian, 17, 1) = 0.019599999999999999 * var_x164 + 3.5279999999999993e-7 * var_x167 - 0.019599999999999999 * var_x166;
        ...
        IJth(rJacobian, 2, 2) = -0.001 * var_x195;
        ...
        IJth(rJacobian, 3, 3) = -0.001 * var_x210;
        ...
        IJth(rJacobian, 4, 4) = -8.0 * var_x219 - 0.001 * ((var_x214) ? (-var_x220 + 499999.99948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (var_x220 + 0.00019999999949504854 * var_x211)) : (var_x213 * var_x218));
        ...
        IJth(rJacobian, 5, 5) = -2.0 / (1.0 + 320.0 * var_x223) - 0.02 * var_x222;
        ...
        IJth(rJacobian, 6, 6) = -0.0030000000000000001 * ((var_x235) ? (var_x239 - 277777.77782118932 * (18.9999982 + var_chaste_interface__membrane__V) * (-var_x239 - 2.1599999996624319e-5 * var_x234)) : (var_x227 * var_x238)) - 0.0030000000000000001 * ((var_x229) ? (-var_x240 + 694444.44523829618 * (19.000000719999999 + var_chaste_interface__membrane__V) * (var_x240 + 2.1599999975308037e-5 * var_x226)) : (var_x227 * var_x232));
        ...
        IJth(rJacobian, 7, 7) = -0.00029999999999999997 * ((var_x244) ? (var_x251 - 980392.15769891371 * (33.99999949 + var_chaste_interface__membrane__V) * (-var_x251 - 3.1874999972814066e-6 * var_x242)) : (var_x243 * var_x248)) - 0.0035999999999999999 / var_x250;
        ...
        IJth(rJacobian, 10, 10) = -0.033000000000000002 / var_x255 - 3.3000000000000003e-5 * var_x253;
        IJth(rJacobian, 15, 10) = var_x276 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        IJth(rJacobian, 15, 11) = var_x276 * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        IJth(rJacobian, 12, 12) = var_x273 + var_x264 * (-0.059999999999999998 - var_x272);
        IJth(rJacobian, 13, 12) = var_x264 * (0.059999999999999998 + var_x272);
        IJth(rJacobian, 18, 12) = (0.5 * var_x172 - 0.5 * var_x170) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 12, 13) = var_x273;
        ...
        IJth(rJacobian, 14, 14) = 8.2927354147114598e-7 * var_x148 - 6.8169128332498961e-7 * var_x147 - 0.33764393503417345 * var_x149 - 0.00063182746016849224 * var_x153 - 1.0127092529498691e-5 * var_x142 - 0.0013268376663538336 * var_x144;
        ...
        IJth(rJacobian, 9, 16) = -0.02 / var_x252 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x252, 2);
        IJth(rJacobian, 12, 16) = -var_x275 + var_x257 * var_x274;
        IJth(rJacobian, 13, 16) = var_x275;
        ...
        IJth(rJacobian, 17, 17) = -0.050000000000000003 + 8.4671999999999982e-11 * var_x167 - 3.5279999999999993e-7 * var_x164 - 4.7039999999999993e-6 * var_x166;
        ...
        IJth(rJacobian, 19, 19) = -0.050000000000000003 + var_x277;
        IJth(rJacobian, 1, 20) = 0.20000000000000001 + var_x174;
        IJth(rJacobian, 20, 20) = -0.20000000000000001 + var_x277;
    }
