#ifndef CELLPRIEBE_BEUCKELMANN_1998FROMCELLMLGRL1OPT_HPP_
#define CELLPRIEBE_BEUCKELMANN_1998FROMCELLMLGRL1OPT_HPP_
...
class Cellpriebe_beuckelmann_1998FromCellMLGRL1Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellpriebe_beuckelmann_1998FromCellMLGRL1Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellpriebe_beuckelmann_1998FromCellMLGRL1Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellpriebe_beuckelmann_1998FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellpriebe_beuckelmann_1998FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellpriebe_beuckelmann_1998FromCellMLGRL1Opt(p_solver, p_stimulus);
        }
...
#endif // CELLPRIEBE_BEUCKELMANN_1998FROMCELLMLGRL1OPT_HPP_