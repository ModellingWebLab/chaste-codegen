...
// LCOV_EXCL_STOP
        ...
        const double var_sodium_current__E_Na = 26.53945091048535 * log(mParameters[2] / var_chaste_interface__intracellular_ion_concentrations__Na_i); // millivolt
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x40 = (-1.0 + var_x39) * mParameters[2];
            ...
            const double var_x46 = var_x43 * var_x44 * var_x45 * mParameters[5];
            ...
            const double var_x59 = var_x39 * var_x46 * mParameters[2];
            const double var_x60 = var_x40 * var_x41 * var_x44 * var_x45 * mParameters[5] / pow(var_x42, 2);
            const double var_x61 = 1 / mParameters[4];
            const double var_x62 = 0.001 * var_x61;
            
            partialF = -var_x62 * (0.0014400000000000001 + var_x16 + var_x21 + var_x23 + var_x5 + 2.0 * var_x33 + 0.0060000000000000001 * var_x6 + 0.0011450666666666667 * var_x54 - 0.10497579657532749 * var_x57 + var_x34 * var_x35 + var_x40 * var_x47 + var_x58 * var_x59 + (1.8 * var_x3 + 1.8 * var_x4) * mParameters[3] - var_x58 * var_x60);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x68 = (var_x9 - var_x13) * mParameters[9] / pow(var_x14, 2);
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -18.399999999999999 * var_x126 + var_x129 * var_x130;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 0.016719999999999999 * var_x160 * var_x163 + 0.050000000000000003 * var_x156 * var_x162 - 0.0044800000000000005 * var_x152 * var_x164;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.067921999999999996 * var_x168 - var_x169 * var_x176;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.67417300000000002 * var_x185 - 0.67417300000000002 * var_x186;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x193 - 0.0096369999999999997 * var_x187;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0089999999999999993 * var_x227 - 0.0012999999999999999 * var_x228;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.65600000000000003 * var_x229 - 0.10000000000000001 * var_x230;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x52 = 1 / (36.4828726939094 + var_x51);
            const double var_x68 = (var_x9 - var_x13) * mParameters[9] / pow(var_x14, 2);
            const double var_x89 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2) * mParameters[1];
            ...
            partialF = 2.2208765355510512e-6 * var_x95 + 2.8659485630822583e-7 * var_x96 - 0.00038145775374624855 * var_x94 - 4.3659884291485854e-7 * var_x37 - 0.0074029217851701709 * var_x90 - var_x233 * var_x97;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 0.0022916155659426776 * var_x101 - 0.043659884291485852 * var_x100 + var_x236 * var_x99 - var_x244 * var_x25 - var_x245 * var_x25;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.47599999999999998 + var_x247;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x108 = var_x24 * var_x29 * mParameters[6] / pow(var_x30, 4);
            ...
            partialF = 0.011549742452351092 * var_x110 + 0.00085446536839159674 * var_x109 - 0.00085446536839159674 * var_x103 - 0.22004581682908866 * var_x106 + var_x106 * var_x254 - var_x102 * var_x252 - var_x102 * var_x253 - var_x104 * var_x249 - var_x108 * var_x254;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative23(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -14.98 - var_x255 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative24(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.011085915847820609 - 2.6321499680605046e-9 * var_x114 - 0.011698444302491135 * var_x113;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt::EvaluatePartialDerivative27(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.033960000000000004 - var_x271;
        }
        else
        {
