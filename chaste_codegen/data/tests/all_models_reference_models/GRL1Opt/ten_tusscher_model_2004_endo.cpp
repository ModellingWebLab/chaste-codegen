...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x165 = exp(0.34849999999999998 * var_chaste_interface__membrane__V);
            ...
            const double var_x173 = var_chaste_interface__membrane__V < -40.0;
            const double var_x174 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x181 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
            const double var_x182 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x183 = -25428.0 * var_x181 - 6.9480000000000002e-6 * var_x182;
            const double var_x184 = var_x180 * var_x183;
            const double var_x185 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x186 = 1.0 + var_x185;
            const double var_x187 = exp(-0.01052 * var_chaste_interface__membrane__V);
            ...
            const double var_x192 = exp(-3.2000000000000002 - var_x21);
            const double var_x193 = 1.0 + var_x192;
            const double var_x194 = exp(0.057000000000000002 * var_chaste_interface__membrane__V);
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x130 = -var_x129;
            const double var_x147 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x196 = exp(2.5 + var_x130);
            const double var_x197 = 1.0 + var_x196;
            const double var_x198 = 1 / var_x197;
            const double var_x199 = exp(1.0 + var_x147);
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x119 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x209 = exp(2.5 + var_x119);
            const double var_x210 = 1.0 + var_x209;
            const double var_x211 = 1 / var_x210;
            const double var_x212 = exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2));
            const double var_x215 = 1125.0 * var_x212;
            const double var_x216 = 1 / (80.0 + var_x215 + 165.0 * var_x211);
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x217 = var_chaste_interface__membrane__V > -60.0;
            const double var_x218 = exp(-5.0 + 10000.0 * var_chaste_interface__calcium_dynamics__Ca_i);
            const double var_x219 = 1.0 + var_x218;
            const double var_x220 = exp(-0.9375 + 1250.0 * var_chaste_interface__calcium_dynamics__Ca_i);
            const double var_x221 = 1.0 + var_x220;
            const double var_x222 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 8);
            const double var_x223 = (var_x217) && (var_chaste_interface__L_type_Ca_current_fCa_gate__fCa < 0.15753424657534248 + 0.068493150684931517 / var_x219 + 0.13698630136986303 / var_x221 + 0.68493150684931503 / (1.0 + 8.034023767017109e+27 * var_x222));
            
            partialF = ((var_x223) ? (0) : (-0.5));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x226 = exp(-4.4889999999999999 * pow((1 + 0.014925373134328358 * var_chaste_interface__membrane__V), 2));
            const double var_x227 = 1 / (8.0 + 1000.0 * var_x226);
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x234 = 14.994515539305301 / (1.0 + 3.0 * var_x233);
            
            partialF = var_x234 * (-8.0000000000000007e-5 + var_x118 * (var_x117 - var_x116)) + 9.9963436928702016 * (var_x105 + var_x106 - var_x104 - var_x113) / (pow(var_x232, 3) * pow((0.33333333333333337 + var_x233), 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x238 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6);
            const double var_x239 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16);
            const double var_x240 = (((var_x217) || (var_x236))) && (((var_x217) || (var_x237))) && (((var_x236) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x238)))) && (((var_x237) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x239))));
            
            partialF = ((var_x240) ? (0) : (-0.5));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 2.5185628611365452e-7 * var_x86 - 1.823319832565245e-7 * var_x87 - 9.0551084895961074e-7 * var_x75 - 0.0031224512033090025 * var_x88 - 0.00040297005778184723 * var_x85;
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x241 = 6.3176611368492499e-5 * var_x43;
            
            partialF = 0.00010126109252331096 * var_x95 - 0.0031224512033090025 * var_x94 - 0.0016876848753885161 * var_x90 - 4.5587787568311439e-5 * var_x89 - 0.00076500054481070561 * var_x83 - 0.0031224512033090025 * var_x91 - var_x241 * var_x93;
        }
        else
        {
