...
class Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables()
    {
...
protected:
    Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables(const Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables&);
    Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables& operator= (const Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables&);
    Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables()
    {
        ...
        Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables> mpInstance;
...
std::shared_ptr<Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables> Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt::GetLookupTableCollection()
    {
        return Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables::Instance();
    }
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
        ...
        const double var_Na_Ca_exchanger_current__i_NaCa = 0.00014738024843876965 * _lt_0_row[2] * (1.8 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * _lt_0_row[0] - 2744000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i * _lt_0_row[1]) * mParameters[0]; // picoA
        ...
        const double var_sodium_potassium_pump__i_NaK = 0.46904770956521741 * _lt_0_row[3] * mParameters[0] / (1.0 + 31.622776601683793 * pow(1 / var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5)); // picoA
        ...
        const double var_rapid_delayed_rectifier_K_current__i_Kr = 0.029411764999999999 * _lt_0_row[4] * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[0] * var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr; // picoA
        ...
        const double var_time_independent_potassium_current__i_K1 = 0.089999999999999997 * _lt_0_row[5] * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[0]; // picoA
