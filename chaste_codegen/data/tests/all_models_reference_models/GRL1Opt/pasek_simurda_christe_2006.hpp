#ifndef CELLPASEK_SIMURDA_CHRISTE_2006FROMCELLMLGRL1OPT_HPP_
#define CELLPASEK_SIMURDA_CHRISTE_2006FROMCELLMLGRL1OPT_HPP_
...
class Cellpasek_simurda_christe_2006FromCellMLGRL1Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellpasek_simurda_christe_2006FromCellMLGRL1Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellpasek_simurda_christe_2006FromCellMLGRL1Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellpasek_simurda_christe_2006FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellpasek_simurda_christe_2006FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellpasek_simurda_christe_2006FromCellMLGRL1Opt(p_solver, p_stimulus);
        }
...
#endif // CELLPASEK_SIMURDA_CHRISTE_2006FROMCELLMLGRL1OPT_HPP_