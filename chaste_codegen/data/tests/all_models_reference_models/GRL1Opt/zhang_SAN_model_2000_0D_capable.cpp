...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellzhang_SAN_model_2000_0D_capableFromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_slow_delayed_rectifying_potassium_current__i_K_s = pow(var_chaste_interface__slow_delayed_rectifying_potassium_current_xs_gate__xs, 2) * (0.00034450000000000003 + 0.0100555 * var_membrane__FCell) * (71.365322852196968 + var_chaste_interface__membrane__V); // nanoA
