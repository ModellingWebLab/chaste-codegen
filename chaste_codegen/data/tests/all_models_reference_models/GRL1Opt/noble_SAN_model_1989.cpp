...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnoble_SAN_model_1989FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.20000000000000001 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 9.5418840923404938e-11 * var_x56 - 1.8066221665073799e-10 * var_x55 - 8.7430565504672044e-7 * var_x53 - 0.071845959781105084 * var_x57 - 1.1761547293737243e-5 * var_x58 + var_x83 * var_x87 - var_x83 * var_x88;
        }
        else
        {
    ...
    double Cellnoble_SAN_model_1989FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.02 * var_x104 - 2.0 / (1.0 + 320.0 * var_x105);
        }
        else
        {
    ...
    double Cellnoble_SAN_model_1989FromCellMLGRL1::EvaluatePartialDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x128 = 5.8807736468686214e-8 * var_x35;
            const double var_x132 = 0.00013114584825700806 * var_x0;
            const double var_x133 = -var_x128 * var_x78;
            
            partialF = var_x133 + 6.2592534133428895e-16 * var_x75 + 8.2844426792967482e-7 * var_x72 - 0.061358770871178837 * var_x77 - 4.7129273908888172e-7 * var_x76 - 0.0013255108286874798 * var_x71 - 2.4480558341308171e-5 * var_x60 - var_x132 * var_x60;
        }
        else
        {
    ...
    double Cellnoble_SAN_model_1989FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x136 - 0.10000000000000001 * var_x89;
        }
        else
        {
