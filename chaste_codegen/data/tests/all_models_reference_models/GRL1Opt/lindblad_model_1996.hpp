#ifndef CELLLINDBLAD_MODEL_1996FROMCELLMLGRL1OPT_HPP_
#define CELLLINDBLAD_MODEL_1996FROMCELLMLGRL1OPT_HPP_
...
class Celllindblad_model_1996FromCellMLGRL1Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Celllindblad_model_1996FromCellMLGRL1Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Celllindblad_model_1996FromCellMLGRL1Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Celllindblad_model_1996FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Celllindblad_model_1996FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Celllindblad_model_1996FromCellMLGRL1Opt(p_solver, p_stimulus);
        }
...
#endif // CELLLINDBLAD_MODEL_1996FROMCELLMLGRL1OPT_HPP_