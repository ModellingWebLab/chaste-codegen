...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_current__i_CaL_converted = 14447.286958825251 * HeartConfig::Instance()->GetCapacitance() * ((fabs(-15.0 + var_chaste_interface__membrane__V) < 1.3356880330661625e-6) ? (1.3356880330661625e-6 * (-mParameters[4] + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * exp(1.0000000000609274e-7)) / (-1.0 + exp(1.0000000000609274e-7)) - 374338.90820464725 * (-15.000001335688033 + var_chaste_interface__membrane__V) * (-1.3356880330661625e-6 * (-mParameters[4] + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * exp(1.0000000000609274e-7)) / (-1.0 + exp(1.0000000000609274e-7)) - 1.3356880330661625e-6 * (-mParameters[4] + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * exp(-1.0000000000609274e-7)) / (-1.0 + exp(-1.0000000000609274e-7)))) : ((-15.0 + var_chaste_interface__membrane__V) * (-mParameters[4] + 0.25 * var_chaste_interface__calcium_dynamics__Ca_ss * _lt_0_row[0]) / (_lt_0_row[1]))) * mParameters[7] * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f; // uA_per_cm2
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2006_endoFromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x5 = exp(-1.0000000000609274e-7);
            ...
            const double var_x12 = fabs(var_x11) < 1.3356880330661625e-6;
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2006_endoFromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x20 = var_x10 * var_x11 * var_x14;
            const double var_x21 = var_x16 * var_x20;
            const double var_x93 = 1.3356880330661625e-6 * var_x4;
            const double var_x94 = (-15.000001335688033 + var_chaste_interface__membrane__V) * (-var_x93 - 1.3356880330661625e-6 * var_x7);
            const double var_x107 = var_x0 * var_x1;
            const double var_x108 = ((var_x12) ? (var_x10 * (0.0048242670752939301 * var_x107 + 14447.286958825251 * (5615084.1230697082 - 374338.90820464725 * var_chaste_interface__membrane__V) * (-3.3392200826654062e-7 * var_x107 - 3.3392200826654062e-7 * var_x5 * var_x6))) : (3611.8217397063127 * var_x21));
            const double var_x251 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2);
            const double var_x267 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
            const double var_x268 = 1 / (1.0 + 2.25 * var_x267);
            const double var_x269 = 1 / (2.5 - 1.5 * var_x268);
            ...
            partialF = var_x293 * (-1.1399999999999999 - var_x292 + 6.0021945866861737 * var_x285 - 6.4023408924652525 * var_x282 - var_x108 * var_x289) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x277 * var_x292 - var_x289 * ((var_x12) ? (var_x13 * (var_x93 - 374338.90820464725 * var_x94)) : (var_x11 * var_x19))) / (pow(var_x286, 3) * pow(var_x287, 2));
        }
        else
        {
