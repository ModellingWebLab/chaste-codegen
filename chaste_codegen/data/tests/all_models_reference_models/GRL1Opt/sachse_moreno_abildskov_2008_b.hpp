#ifndef CELLSACHSE_MORENO_ABILDSKOV_2008_BFROMCELLMLGRL1OPT_HPP_
#define CELLSACHSE_MORENO_ABILDSKOV_2008_BFROMCELLMLGRL1OPT_HPP_
...
class Cellsachse_moreno_abildskov_2008_bFromCellMLGRL1Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellsachse_moreno_abildskov_2008_bFromCellMLGRL1Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellsachse_moreno_abildskov_2008_bFromCellMLGRL1Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellsachse_moreno_abildskov_2008_bFromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellsachse_moreno_abildskov_2008_bFromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellsachse_moreno_abildskov_2008_bFromCellMLGRL1Opt(p_solver, p_stimulus);
        }
...
#endif // CELLSACHSE_MORENO_ABILDSKOV_2008_BFROMCELLMLGRL1OPT_HPP_