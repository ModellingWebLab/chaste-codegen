...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2004_MFromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x58 = mParameters[4] * _lt_0_row[3];
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2004_MFromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x62 = var_x61 / var_x60;
            const double var_x67 = var_x59 - 2.5 * var_x57;
            const double var_x80 = 0.5 - 374338.9082274547 * var_chaste_interface__membrane__V;
            ...
            const double var_x84 = var_x0 * var_x1 * var_x83;
            const double var_x85 = ((var_x12) ? (var_x84 + var_x80 * (-var_x84 - var_x8 * var_x83 * var_x9)) : (14447.286958825251 * var_x13 * var_x21));
            ...
            const double var_x137 = var_x100 * var_chaste_interface__L_type_Ca_current_d_gate__d;
            ...
            partialF = var_x131 * (var_x132 - var_x134 + (0.00031590674984870116 * var_x90 - 0.0042195286531202733 * var_x89 - 0.0015795337492435057 * var_x91 - 0.00031590674984870116 * var_x85 - 0.00031590674984870116 * var_x87) * mParameters[12]) + 0.00029999999999999997 * (var_x135 + var_x145 - var_x136 - var_x138 * (var_x87 * var_chaste_interface__calcium_dynamics__Ca_i + (-13.356880329847826 * log(var_x88 * mParameters[4]) + var_chaste_interface__membrane__V) * mParameters[9] - 2.0 * var_x62 * var_x67 + ((var_x12) ? (var_x137 - 374338.9082274547 * (-1.3356880329847825e-6 + var_chaste_interface__membrane__V) * (-var_x137 - var_x101 * var_chaste_interface__L_type_Ca_current_d_gate__d)) : (var_x20 * var_chaste_interface__membrane__V)))) / (pow(var_x128, 3) * pow(var_x129, 2));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_MFromCellMLGRL1Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x198 = exp(0.34849999999999998 * var_chaste_interface__membrane__V);
            const double var_x199 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
            const double var_x200 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x201 = 310000.0 * var_x198;
            const double var_x202 = 2.7000000000000002 * var_x199;
            const double var_x203 = 0.057000000000000002 * var_x200;
            const double var_x206 = var_chaste_interface__membrane__V < -40.0;
            const double var_x207 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x208 = 1.0 + var_x207;
            const double var_x209 = 1 / var_x208;
            
            partialF = ((var_x206) ? (-var_x201 - var_x202 - var_x203) : (-5.9230769230769234 * var_x209));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_MFromCellMLGRL1Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x214 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
            ...
            const double var_x225 = exp(-3.2000000000000002 - var_x45);
            const double var_x226 = 1.0 + var_x225;
            const double var_x227 = exp(0.057000000000000002 * var_chaste_interface__membrane__V);
            const double var_x228 = var_x227 / var_x226;
            
            partialF = ((var_x206) ? (-var_x223 - var_x224) : (-0.59999999999999998 * var_x228));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_MFromCellMLGRL1Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x161 = -var_x160;
            const double var_x178 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x229 = exp(2.5 + var_x161);
            const double var_x230 = 1.0 + var_x229;
            const double var_x231 = 1 / var_x230;
            const double var_x232 = exp(1.0 + var_x178);
            const double var_x233 = 1.0 + var_x232;
            const double var_x234 = 1 / var_x233;
            const double var_x235 = exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x236 = 1.0 + var_x235;
            const double var_x237 = 0.25 + 1.3999999999999999 / var_x236;
            const double var_x238 = var_x234 * var_x237;
            const double var_x241 = 1 / (var_x231 + 1.3999999999999999 * var_x238);
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_MFromCellMLGRL1Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x150 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x242 = exp(2.5 + var_x150);
            const double var_x243 = 1.0 + var_x242;
            const double var_x244 = 1 / var_x243;
            const double var_x245 = exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2));
            const double var_x248 = 1125.0 * var_x245;
            const double var_x249 = 1 / (80.0 + var_x248 + 165.0 * var_x244);
    ...
    double Cellten_tusscher_model_2004_MFromCellMLGRL1Opt::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x250 = var_chaste_interface__membrane__V > -60.0;
            const double var_x251 = exp(-5.0 + 10000.0 * var_chaste_interface__calcium_dynamics__Ca_i);
            const double var_x252 = 1.0 + var_x251;
            const double var_x253 = exp(-0.9375 + 1250.0 * var_chaste_interface__calcium_dynamics__Ca_i);
            const double var_x254 = 1.0 + var_x253;
            const double var_x255 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 8);
            const double var_x256 = (var_x250) && (var_chaste_interface__L_type_Ca_current_fCa_gate__fCa < 0.15753424657534248 + 0.068493150684931517 / var_x252 + 0.13698630136986303 / var_x254 + 0.68493150684931503 / (1.0 + 8.034023767017109e+27 * var_x255));
            const double var_x257 = 1 / mParameters[8];
            
            partialF = ((var_x256) ? (0) : (-var_x257));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_MFromCellMLGRL1Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x178 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x258 = exp(-4.0 + var_x178);
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_MFromCellMLGRL1Opt::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x272 = 14.994515539305301 / (1.0 + 3.0 * var_x271);
            
            partialF = var_x272 * (var_x132 + var_x149 * (var_x147 - var_x148)) + 9.9963436928702016 * (var_x136 - var_x135 - var_x145) / (pow(var_x270, 3) * pow((0.33333333333333337 + var_x271), 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_MFromCellMLGRL1Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x250 = var_chaste_interface__membrane__V > -60.0;
            const double var_x274 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6);
            const double var_x275 = var_chaste_interface__calcium_dynamics__Ca_i < 0.00035;
            const double var_x276 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16);
            const double var_x277 = (var_x250) && (((var_x275) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x276)))) && (((var_chaste_interface__calcium_dynamics__Ca_i >= 0.00035) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x274))));
            
            partialF = ((var_x277) ? (0) : (-0.5));
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2004_MFromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x278 = mParameters[12] * mParameters[3];
            
            partialF = var_x278 * (1.1846503119326294e-6 * var_x118 - 0.0018954404990922068 * var_x115 - 0.016878114612481093 * var_x112 - 0.016878114612481093 * var_x117 - 0.0056863214972766203 * var_x119);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2004_MFromCellMLGRL1Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x278 = mParameters[12] * mParameters[3];
            const double var_x281 = 2.7188924024856265e-5 * var_x72;
            
            partialF = var_x278 * (4.357910453967955e-5 * var_x127 - 0.016878114612481093 * var_x113 - 0.016878114612481093 * var_x120 - 0.016878114612481093 * var_x121 - 0.00072631840899465921 * var_x122 - 0.0072631840899465916 * var_x124 - var_x126 * var_x281);
        }
        else
        {
