...
class Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables);
        }
    ...
    ~Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables()
    {

    }

protected:
    Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables(const Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables&);
    Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables& operator= (const Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables&);
    Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables()
    {
        ...
        Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables> mpInstance;

};

std::shared_ptr<Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables> Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellbueno_2007_endoFromCellMLGRL1Opt::UseCellMLDefaultStimulus()
    {
    ...
    Cellbueno_2007_endoFromCellMLGRL1Opt::Cellbueno_2007_endoFromCellMLGRL1Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbueno_2007_endoFromCellMLGRL1Opt>::Instance();
        Init();
    ...
    Cellbueno_2007_endoFromCellMLGRL1Opt::~Cellbueno_2007_endoFromCellMLGRL1Opt()
    {
    }

    AbstractLookupTableCollection* Cellbueno_2007_endoFromCellMLGRL1Opt::GetLookupTableCollection()
    {
        return Cellbueno_2007_endoFromCellMLGRL1Opt_LookupTables::Instance();
    }
    
    double Cellbueno_2007_endoFromCellMLGRL1Opt::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbueno_2007_endoFromCellMLGRL1Opt::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
    ...
    void Cellbueno_2007_endoFromCellMLGRL1Opt::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        std::vector<double>& rY = rGetStateVariables();
        const double delta = 1e-8;
    ...
    double Cellbueno_2007_endoFromCellMLGRL1Opt::EvaluateYDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
        double d_dt_chaste_interface_var_membrane__V;
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: mV; Initial value: 0.0
    ...
    double Cellbueno_2007_endoFromCellMLGRL1Opt::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
    ...
    double Cellbueno_2007_endoFromCellMLGRL1Opt::EvaluateYDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellbueno_2007_endoFromCellMLGRL1Opt::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellbueno_2007_endoFromCellMLGRL1Opt::EvaluateYDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellbueno_2007_endoFromCellMLGRL1Opt::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellbueno_2007_endoFromCellMLGRL1Opt::EvaluateYDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellbueno_2007_endoFromCellMLGRL1Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    std::vector<double> Cellbueno_2007_endoFromCellMLGRL1Opt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellbueno_2007_endoFromCellMLGRL1Opt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbueno_2007_endoFromCellMLGRL1Opt)
