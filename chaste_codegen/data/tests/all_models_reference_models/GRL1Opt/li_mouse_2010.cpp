...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellli_mouse_2010FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
            ...
            const double var_x21 = 0.0023079445283571576 * var_x20;
            const double var_x22 = var_x17 * var_x21;
            const double var_x90 = 0.5 + 376848.3140626513 * var_chaste_interface__cell__V;
            ...
            const double var_x95 = ((var_x14) ? (-var_x93 + var_x90 * (var_x93 + var_x94)) : (var_x21 * var_chaste_interface__cell__V));
            const double var_x151 = var_chaste_interface__environment__time < 3333330000000.0005;
            ...
            const double var_x173 = var_x3 * var_x93;
            const double var_x174 = ((var_x14) ? (var_x173 + 376848.3140626513 * (1.3267937823834197e-6 + var_chaste_interface__cell__V) * (-var_x173 - var_x11 * var_x94)) : (-var_x22 * var_chaste_interface__cell__V));
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellli_mouse_2010FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
            ...
            const double var_x319 = 1 / (1.0 - exp(-9.9999999747524276e-8));
            const double var_x320 = 1 / (1.0 - exp(1.0000000020227162e-7));
            const double var_x321 = _lt_0_row[32];
            const double var_x323 = 26.5 + var_chaste_interface__cell__V;
            const double var_x324 = fabs(var_x323) < 7.812499998038902e-7;
            ...
            const double var_x328 = 3.7604140701062501e-12 * var_x320;
            const double var_x329 = -9.5333299999999997e-5 * var_x321;
            
            partialF = ((var_x324) ? (var_x328 + var_x329 - 640000.00016065314 * (26.500000781250002 + var_chaste_interface__cell__V) * (var_x328 + 3.760414053005867e-12 * var_x319)) : (var_x329 - var_x323 * var_x327));
        }
        else
        {
