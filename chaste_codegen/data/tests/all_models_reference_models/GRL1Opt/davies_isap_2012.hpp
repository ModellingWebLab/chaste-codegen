#ifndef CELLDAVIES_ISAP_2012FROMCELLMLGRL1OPT_HPP_
#define CELLDAVIES_ISAP_2012FROMCELLMLGRL1OPT_HPP_
...
class Celldavies_isap_2012FromCellMLGRL1Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Celldavies_isap_2012FromCellMLGRL1Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Celldavies_isap_2012FromCellMLGRL1Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Celldavies_isap_2012FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Celldavies_isap_2012FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Celldavies_isap_2012FromCellMLGRL1Opt(p_solver, p_stimulus);
        }
...
#endif // CELLDAVIES_ISAP_2012FROMCELLMLGRL1OPT_HPP_