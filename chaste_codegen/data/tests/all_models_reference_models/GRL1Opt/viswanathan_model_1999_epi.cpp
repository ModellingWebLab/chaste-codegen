...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x6 = var_x4 * log10(4.5 * var_x5);
            ...
            const double var_x19 = 698.34626081908675 * var_x18;
            const double var_x20 = exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V);
            const double var_x21 = 1.0 + var_x20;
            const double var_x22 = 1 / var_x21;
            const double var_x23 = var_x22 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr;
            const double var_x24 = 0.023862446088641735 * var_x23;
            const double var_x25 = 1 / var_chaste_interface__calcium_dynamics__Cai;
            const double var_x26 = pow(var_x25, 1.3999999999999999);
            const double var_x27 = 1.0 + 6.4818210260626455e-7 * var_x26;
            const double var_x28 = 0.25979999999999998 / var_x27;
            const double var_x29 = 0.433 + var_x28;
            const double var_x30 = var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
            ...
            const double var_x35 = 16.0 * var_x34;
            const double var_x36 = pow(var_chaste_interface__ionic_concentrations__Nai, (-2));
            ...
            const double var_x48 = pow(var_chaste_interface__ionic_concentrations__Nai, 3.0);
            ...
            const double var_x57 = -26.712338705498265 * var_x6 + var_chaste_interface__membrane__V;
            const double var_x58 = 0.00092307692307692295 * var_x0 * var_x57 / pow(var_x1, 2);
            const double var_x59 = var_x7 / pow(var_x8, 2);
            const double var_x60 = 1000.0 * var_x12;
            const double var_x61 = var_x10 * var_x15 / pow(var_x11, 2);
            const double var_x62 = 0.00067122862439358594 * var_x57 * var_x9 / pow((var_x9 + 0.98039215686274506 * var_x16), 2);
            const double var_x63 = var_x62 * (243.26999999999998 * var_x59 - 514.29999999999995 * var_x61 - var_x60 * (0.061749999999999999 * var_x14 + 0.039456396800000001 * var_x13));
            const double var_x64 = 0.0010652877718143633 * var_x20 * var_x57 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / pow(var_x21, 2);
            const double var_x65 = var_x17 * var_x57;
            ...
            const double var_x95 = -0.61380000000000001 + 1.0 * var_x94;
            ...
            partialF = -var_x102 * (0.0070160275741043606 + var_x100 + var_x19 + var_x24 + var_x3 + var_x31 + var_x35 + var_x56 + var_x58 + var_x63 + var_x77 + var_x80 + var_x82 + var_x83 - var_x64 - var_x66 - var_x86 - var_x87 + var_x38 * var_x44);
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x114 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__membrane__V;
            const double var_x115 = var_x114 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
            const double var_x119 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai;
            const double var_x120 = 1.1499999999999999 / var_x119;
            const double var_x121 = pow(var_x119, (-2));
            const double var_x122 = var_x120 + 0.040282206767891383 * var_x25 + 7.8019226357407252 * var_x91 * var_x99 + 0.6678084676374566 * var_x25 * var_x89 - 1.1499999999999999 * var_x121 * var_chaste_interface__calcium_dynamics__Cai - 0.0046811535814444347 * var_x115 * var_x96;
            const double var_x135 = var_x4 * log10(1.8 * var_x25);
            ...
            const double var_x163 = 1.0 + 0.00011900000000000002 / pow(var_x162, 2) + 3.5000000000000004e-5 * var_x121;
            const double var_x164 = 1 / var_x163;
            const double var_x165 = 1 / M_PI;
            const double var_x168 = 0.00062 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
            const double var_x169 = 1 / var_x168;
            const double var_x170 = 1.0 - var_chaste_interface__calcium_dynamics__APtrack2;
            const double var_x171 = -0.00018000000000000001 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
            const double var_x172 = 60000.0 * var_x169 * var_x170 * var_x171;
            const double var_x173 = var_x172 * var_chaste_interface__calcium_dynamics__APtrack2;
            const double var_x174 = var_chaste_interface__calcium_dynamics__Cainfluxtrack > 0.00018000000000000001;
            const double var_x175 = 4000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2;
            const double var_x176 = var_chaste_interface__calcium_dynamics__OVRLDtrack2 > 0;
            const double var_x177 = ((var_x174) ? (-var_x173) : ((var_x176) ? ((-4000.0 + var_x175) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
            const double var_x178 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
            const double var_x179 = 1 / var_x178;
            const double var_x180 = 0.40588235294117642 * var_x179;
            const double var_x181 = var_chaste_interface__calcium_dynamics__Cai / pow(var_x178, 2);
            const double var_x182 = var_x104 + var_x107 + var_x109 + var_x122;
            const double var_x183 = 0.090316078310111333 * var_x165;
            const double var_x184 = -var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR;
            const double var_x185 = ((var_x174) ? (var_x173 * var_x184) : ((var_x176) ? (var_x175 * var_x184 * (1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2)) : (0)));
            const double var_x186 = var_x105 * var_x55;
            const double var_x187 = -0.040282206767891383 * var_x135 + var_x120 * var_chaste_interface__calcium_dynamics__Cai + var_x136 * var_x90 + var_x98 * var_chaste_interface__membrane__V;
            
            partialF = 0.001 * var_x164 * (-var_x180 + 0.40588235294117642 * var_x181 + 0.0070588235294117632 * var_x177 - var_x182 * var_x183) + 0.001 * (0.00023800000000000004 / pow(var_x162, 3) + 7.0000000000000007e-5 / pow(var_x119, 3)) * (0.027058823529411764 * var_chaste_interface__calcium_dynamics__Ca_NSR + 0.0070588235294117632 * var_x185 - var_x180 * var_chaste_interface__calcium_dynamics__Cai - var_x183 * (var_x187 - var_x186 + 0.003016 * var_chaste_interface__membrane__V)) / pow(var_x163, 2);
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x201 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
            const double var_x204 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x205 = exp(-4.7130000000000001 + var_x204);
            const double var_x206 = 1.0 - var_x205;
            const double var_x207 = 0.32000000000000001 / var_x206;
            const double var_x208 = 47.130000000000003 + var_chaste_interface__membrane__V;
            const double var_x209 = fabs(var_x208) >= 1.0000000000000001e-5;
            const double var_x210 = -0.080000000000000002 * var_x201;
            
            partialF = ((var_x209) ? (var_x210 - var_x207 * var_x208) : (-3.2000000000000002 + var_x210));
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x212 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
            ...
            const double var_x215 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x216 = 1.0 + var_x215;
            
            partialF = ((var_x214) ? (-310000.0 * var_x211 - 0.13500000000000001 * var_x213 - 3.5600000000000001 * var_x212) : (-7.6923076923076934 / var_x216));
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x204 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x214 = var_chaste_interface__membrane__V < -40.0;
            const double var_x218 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
            const double var_x219 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x220 = -127140.0 * var_x218 - 3.4740000000000003e-5 * var_x219;
            const double var_x222 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
            const double var_x223 = 1.0 + var_x222;
            const double var_x224 = 1.0 / var_x223;
            const double var_x225 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x226 = 1.0 + var_x225;
            const double var_x227 = exp(-0.01052 * var_chaste_interface__membrane__V);
            const double var_x228 = var_x227 / var_x226;
            const double var_x229 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x230 = var_x224 * var_x229;
            const double var_x231 = exp(-3.2000000000000002 + var_x204);
            const double var_x232 = 1.0 + var_x231;
            const double var_x233 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V);
            const double var_x234 = var_x233 / var_x232;
            
            partialF = ((var_x214) ? (-0.1212 * var_x228 - var_x220 * var_x230) : (-0.29999999999999999 * var_x234));
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x235 = exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V);
            const double var_x236 = 1.0 + var_x235;
            const double var_x237 = 0.001 / var_x236;
            const double var_x238 = -0.001 + var_x237;
            const double var_x239 = 10.0 + var_chaste_interface__membrane__V;
            const double var_x240 = fabs(var_x239) < 1.0000000000000001e-5;
            const double var_x241 = 1.0 - var_x235;
            const double var_x242 = 1 / var_x241;
            const double var_x243 = 35.0 * var_x236 * var_x242;
            const double var_x247 = ((var_x240) ? (218.40000000000003) : (var_x239 * var_x243));
            
            partialF = var_x238 * var_x247 - var_x237 * var_x247;
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x249 = exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
            const double var_x252 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V);
            const double var_x253 = 1.0 + var_x252;
            const double var_x255 = exp(4.0 + 0.125 * var_chaste_interface__membrane__V);
            const double var_x256 = 1.0 + var_x255;
            const double var_x258 = 0.019699999999999999 * var_x249;
            const double var_x259 = -0.02 - var_x258;
            const double var_x260 = 1 / var_x256;
            const double var_x261 = 0.59999999999999998 / var_x253;
            const double var_x262 = var_x260 + var_x261;
            const double var_x264 = 1.0 - var_x260 - var_x261;
            
            partialF = var_x259 * var_x262 + var_x259 * var_x264;
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x267 = exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__membrane__V);
            const double var_x268 = 1.0 + var_x267;
            const double var_x269 = 1 / var_x268;
            const double var_x270 = 1 / (0.0037000000000000002 + 0.0061000000000000004 * var_x269);
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x273 = 1 / (0.012 - 0.00087500000000000002 * var_chaste_interface__membrane__V);
            const double var_x275 = var_chaste_interface__membrane__V <= 0;
            
            partialF = ((var_x275) ? (-0.001 * var_x273) : (-0.083333333333333329));
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x184 = -var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR;
            const double var_x185 = ((var_x174) ? (var_x173 * var_x184) : ((var_x176) ? (var_x175 * var_x184 * (1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2)) : (0)));
            const double var_x193 = 4000.0 - var_x175;
            const double var_x194 = ((var_x174) ? (var_x173) : ((var_x176) ? (var_x193 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
            ...
            partialF = var_x340 * (-5.5555555555555554 - var_x194) + 0.00025000000000000001 * (-var_x185 + 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR) / (pow(var_x337, 3) * pow((0.125 + var_x338), 2));
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x111 = 26.712338705498265 * var_x4;
            const double var_x112 = -var_x111 * log10(6.9195599999999997 * var_x110) + var_chaste_interface__membrane__V;
            const double var_x119 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai;
            const double var_x120 = 1.1499999999999999 / var_x119;
            const double var_x123 = 1 / var_chaste_interface__ionic_concentrations__Nai;
            const double var_x124 = log10(132.0 * var_x123);
            const double var_x125 = -var_x111 * var_x124 + var_chaste_interface__membrane__V;
            const double var_x135 = var_x4 * log10(1.8 * var_x25);
            const double var_x136 = -13.356169352749133 * var_x135 + var_chaste_interface__membrane__V;
            const double var_x144 = 1 / var_x43;
            const double var_x186 = var_x105 * var_x55;
            const double var_x187 = -0.040282206767891383 * var_x135 + var_x120 * var_chaste_interface__calcium_dynamics__Cai + var_x136 * var_x90 + var_x98 * var_chaste_interface__membrane__V;
            
            partialF = ((1.0 * var_x101 * (var_x186 + var_x187 + 0.0070160275741043606 * var_chaste_interface__membrane__V - 7.3656881518639831e-7 * var_x6 + var_x112 * var_x31 + var_x125 * var_x35 + var_x144 * var_x38 + var_x19 * var_x57 + var_x24 * var_x57 + var_x3 * var_x57 + var_x77 * var_chaste_interface__membrane__V + var_x80 * var_chaste_interface__membrane__V + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() - 0.10684935482199306 * var_x124 * var_x4) < -150000.0) ? (-100.5) : (-0.5));
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x341 = (var_chaste_interface__calcium_dynamics__APtrack > 0.17999999999999999) && (var_chaste_interface__calcium_dynamics__APtrack < 0.20000000000000001);
            
            partialF = ((var_x341) ? (-100.5) : (-0.5));
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative19(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x342 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
            
            partialF = (((var_x342) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-0.5));
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative21(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x343 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
            
            partialF = (((var_x343) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50.0) : (-0.5));
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (((var_x343) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50.0) : (-0.01));
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative23(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x108 = var_x105 * var_x52 / pow((0.00043478865792915378 + 7.8261958427247687e-7 * var_x48 + var_chaste_interface__calcium_dynamics__Cai), 2);
            const double var_x123 = 1 / var_chaste_interface__ionic_concentrations__Nai;
            const double var_x143 = 0.10684935482199306 * var_x123;
            const double var_x144 = 1 / var_x43;
            const double var_x145 = var_x144 / (pow((0.01 + var_x36), 2) * pow(var_chaste_interface__ionic_concentrations__Nai, 3));
            const double var_x146 = pow(var_chaste_interface__ionic_concentrations__Nai, 2.0);
            const double var_x147 = var_x146 * var_x49 * var_x54;
            const double var_x150 = 427.39741928797224 * var_x123 * var_x34;
            const double var_x151 = var_x108 * var_x146;
            const double var_x153 = 0.0018285756177517324 * var_x81;
            const double var_x165 = 1 / M_PI;
            const double var_x345 = 0.00018063215662022267 * var_x165;
            
            partialF = var_x345 * (-var_x143 - var_x150 - var_x153 + 6.124934136868245e-12 * var_x151 - 0.032399999999999998 * var_x147 - 0.089999999999999997 * var_x145);
        }
        else
        {
    ...
    double Cellviswanathan_model_1999_epiFromCellMLGRL1::EvaluatePartialDerivative24(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x81 = var_x67 * var_x73 * var_chaste_interface__membrane__V;
            const double var_x110 = 1 / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki);
            const double var_x154 = 7.3656881518639831e-7 * var_x5;
            const double var_x155 = 0.14745210965435041 * var_x2 * var_x5;
            const double var_x156 = 18654.461852717679 * var_x18 * var_x5;
            const double var_x157 = 0.63742174226149029 * var_x23 * var_x5;
            const double var_x158 = var_x5 * var_x59;
            const double var_x159 = var_x62 * (6498.310636886562 * var_x158 - var_x60 * (1.053972635420138 * var_x13 * var_x5 + 1.6494869150645177 * var_x14 * var_x5) - 13738.155796237757 * var_x5 * var_x61);
            const double var_x160 = 4449.089151873166 * var_x158 * var_x65;
            const double var_x161 = 0.00052283717663123607 * var_x81;
            const double var_x165 = 1 / M_PI;
            const double var_x345 = 0.00018063215662022267 * var_x165;
            const double var_x350 = -0.433 - var_x28;
            const double var_x351 = var_x30 * var_x350;
            const double var_x354 = var_x110 * var_x351;
            
            partialF = var_x345 * (var_x160 - var_x154 - var_x155 - var_x156 - var_x157 - var_x159 - var_x161 + 26.712338705498265 * var_x354);
        }
        else
        {
