...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x75 = _lt_0_row[5];
            ...
            const double var_x79 = _lt_0_row[6] / (1.0 + 669921.875 * (1.0 + 0.7246376811594204 * mParameters[5]) / var_x78);
            ...
            const double var_x102 = _lt_0_row[4];
