...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL1Opt::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x7 = var_x1 * var_x6 * (var_x2 + var_x0 * var_x3);
            const double var_x8 = exp(-9.9999999999999995e-8);
            const double var_x9 = 1 / (-1.0 + var_x8);
            const double var_x10 = -var_x7 - var_x6 * var_x9 * (var_x2 + var_x3 * var_x8);
...
// LCOV_EXCL_STOP
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL1Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x111 = var_x18 * (var_x7 - var_x10 * var_x110);
            const double var_x112 = var_x11 * var_x111;
            const double var_x123 = 1.2499999999999999e-8 * var_x5;
            const double var_x124 = var_x0 * var_x1 * var_x123;
            const double var_x125 = ((var_x15) ? (var_x19 * (var_x124 - var_x110 * (-var_x124 - var_x123 * var_x8 * var_x9))) : (var_x12 * var_x14 * var_x16 * var_x17 * var_x28));
            const double var_x142 = var_x4 * mParameters[12];
            const double var_x266 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2);
            const double var_x286 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
            const double var_x287 = 1 / (1.0 + 2.25 * var_x286);
