...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnoble_model_1998FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x125 = exp(-3.6960000000000002 - 056000000000000001 * var_chaste_interface__membrane__V);
    ...
    double Cellnoble_model_1998FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -02 * var_x135 - 2.0 / (1.0 + 320 * var_x136);
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x138 = fabs(var_x137) < 0001;
            ...
            const double var_x144 = 089999999999999997 / var_x143;
            ...
            const double var_x147 = 036000000000000004 / var_x146;
    ...
    double Cellnoble_model_1998FromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x152 = fabs(var_x151) < 0001;
            const double var_x154 = exp(8.5 + var_x140);
            const double var_x155 = -1.0 + var_x154;
            const double var_x156 = 0018749999999999999 / var_x155;
            const double var_x157 = -0035999999999999999 / var_x149;
            
            partialF = ((var_x152) ? (-0074999999999999997 + var_x157) : (var_x157 - var_x151 * var_x156));
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x0 = -0.125 * var_chaste_interface__membrane__V;
            const double var_x159 = exp(-058823529411764705 * var_chaste_interface__membrane__V);
            const double var_x160 = exp(-1.25 + var_x0);
            const double var_x161 = 1.0 + var_x160;
            
            partialF = -033000000000000002 / var_x161 - 3.3000000000000003e-5 * var_x159;
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x164 = 00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            const double var_x165 = 1 / var_x164;
            const double var_x167 = 01 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
            const double var_x168 = 1 / var_x167;
            const double var_x170 = ((var_chaste_interface__membrane__V < -50) ? (5.0) : (1.0));
            ...
            partialF = var_x179 + var_x170 * (-059999999999999998 - var_x178);
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 6.634188331769168e-7 * var_x87 - 5.9277248272665686 * var_x92 - 0010614701330830668 * var_x85 - 6.7513950196657958e-5 * var_x86 - 1.0127092529498693e-5 * var_x28 - 5.6807606943749135e-6 * var_x91 - 2.3651760162759904e-8 * var_x93;
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 00011282633217294504 * var_x97 - 0024112125070234985 * var_x94 - 4.7303520325519805e-9 * var_x93 - 8.4392437745822447e-5 * var_x96 - 016878487549164489 * var_x95 - 00035984935454818685 * var_x90;
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL1::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -050000000000000003 + 8.4671999999999982e-11 * var_x106 - 4.7040000000000002e-6 * var_x105 - 3.5279999999999993e-7 * var_x103;
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL1::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -050000000000000003 + var_x186;
        }
        else
        {
