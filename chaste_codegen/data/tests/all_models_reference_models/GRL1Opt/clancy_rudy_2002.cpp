...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellclancy_rudy_2002FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x149 = var_x146 * var_x147 * var_x148 * mParameters[0];
...
// LCOV_EXCL_STOP
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x201 + var_x203 - var_x193;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x201 + var_x219 - var_x194 - var_x218;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x238 - var_x235 * var_x238;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellclancy_rudy_2002FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x268 = var_x267 * pow(mParameters[2], (-0.29999999999999999));
...
// LCOV_EXCL_STOP
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1.077 - 0.13100000000000001 * var_x271;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -2.1720000000000002 - var_x288;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellclancy_rudy_2002FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x275 = var_x274 / mParameters[2];
            const double var_x280 = 1.9755 * var_x275;
            const double var_x281 = var_x266 * var_x274 * pow(mParameters[2], (-0.69999999999999996)) / var_x267;
            const double var_x283 = 0.0056301648793171408 * var_x281;
            
            partialF = -var_x280 - var_x283;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.00013100000000000001 * var_x305 - 7.1899999999999999e-5 * var_x306;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative21(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -3.2750000000000003e-5 * var_x305 - 1.7975e-5 * var_x306;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x318 - 10.0 * var_x315;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative23(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x338 - 0.10000000000000001 * var_x331;
        }
        else
        {
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative24(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x342 * (-5.5555555555555554 - var_x169) + 0.00025000000000000001 * (-var_x161 + 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR) / (pow(var_x339, 3) * pow((0.125 + var_x340), 2));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative29(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (((var_x344) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-0.5));
        }
        else
        {
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative31(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (((var_x345) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50.0) : (-0.5));
        }
        else
        {
    ...
    double Cellclancy_rudy_2002FromCellMLGRL1Opt::EvaluatePartialDerivative32(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (((var_x345) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50.0) : (-0.01));
        }
        else
        {
