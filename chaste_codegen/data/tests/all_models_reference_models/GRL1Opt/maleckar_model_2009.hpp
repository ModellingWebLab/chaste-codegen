#ifndef CELLMALECKAR_MODEL_2009FROMCELLMLGRL1OPT_HPP_
#define CELLMALECKAR_MODEL_2009FROMCELLMLGRL1OPT_HPP_
...
class Cellmaleckar_model_2009FromCellMLGRL1Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellmaleckar_model_2009FromCellMLGRL1Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellmaleckar_model_2009FromCellMLGRL1Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellmaleckar_model_2009FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellmaleckar_model_2009FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellmaleckar_model_2009FromCellMLGRL1Opt(p_solver, p_stimulus);
        }
...
#endif // CELLMALECKAR_MODEL_2009FROMCELLMLGRL1OPT_HPP_