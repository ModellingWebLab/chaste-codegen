...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellhund_rudy_2004FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
            ...
            const double var_x7 = -0.34100000000000003 * mParameters[5];
            ...
            const double var_x11 = pow(var_chaste_interface__INal__mL, 3) * mParameters[14];
            ...
            const double var_x18 = var_x14 * mParameters[6];
            ...
            const double var_x22 = log(var_x21 * mParameters[7]);
            ...
            const double var_x31 = mParameters[16] * var_chaste_interface__IKs__xs2;
            ...
            const double var_x35 = var_x34 * mParameters[10] * var_chaste_interface__INa__J;
            ...
            const double var_x41 = sqrt(mParameters[7]);
            const double var_x42 = var_x41 * mParameters[15] / var_x40;
            ...
            const double var_x55 = var_x41 * mParameters[13] / (var_x54 + 1.02 * var_x47);
            const double var_x56 = var_x47 * var_x55;
            const double var_x57 = pow(var_chaste_interface__Ito__ydv, 3);
            const double var_x58 = _lt_0_row[13];
            const double var_x59 = var_x57 * var_x58 * mParameters[18] * var_chaste_interface__Ito__zdv;
            ...
            const double var_x68 = pow(mParameters[8], 3);
            ...
            const double var_x77 = (1.0 + 416.66666666666669 * var_chaste_interface__Ca__Ca_i) * mParameters[5];
            ...
            const double var_x79 = var_x73 * var_x78 * mParameters[17];
            ...
            const double var_x85 = exp(0.01485884101040119 * mParameters[8]);
            ...
            const double var_x88 = mParameters[7] / (1.5 + mParameters[7]);
            ...
            const double var_x95 = var_x39 * var_x94 * mParameters[15] * var_chaste_interface__IKr__xr / pow(var_x40, 2);
            ...
            const double var_x98 = var_x47 * var_x94 * mParameters[13] / pow((var_x47 + 0.98039215686274506 * var_x54), 2);
            ...
            const double var_x108 = mParameters[9] / var_x107;
            ...
            const double var_x114 = var_x104 * var_x106 * mParameters[9] / var_x113;
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellhund_rudy_2004FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
            ...
            const double var_x127 = -1004882.8125 - var_x74 - 775361.25000000012 * mParameters[5];
            const double var_x128 = var_x100 * var_x71 * mParameters[17];
            ...
            const double var_x193 = (1.0 + 0.75 * var_x190) * mParameters[3];
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative2(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x216 = exp(-11.764705882352942 + 0.14705882352941177 * mParameters[12] - 0.14705882352941177 * var_chaste_interface__cell__V);
            const double var_x217 = ((var_x215) ? (0) : (0.13500000000000001 * var_x216));
            const double var_x218 = var_x217;
            const double var_x219 = exp(-0.96036036036036043 + 0.0900900900900901 * mParameters[12] - 0.0900900900900901 * var_chaste_interface__cell__V);
            const double var_x220 = 1.0 + var_x219;
            const double var_x221 = exp(0.34999999999999998 * var_chaste_interface__cell__V - 0.34999999999999998 * mParameters[12]);
            const double var_x222 = exp(0.079000000000000001 * var_chaste_interface__cell__V - 0.079000000000000001 * mParameters[12]);
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellhund_rudy_2004FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
            ...
            const double var_x236 = _lt_0_row[25];
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative4(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x242 = exp(0.24440000000000001 * var_chaste_interface__cell__V - 0.24440000000000001 * mParameters[12]);
            const double var_x243 = exp(0.043909999999999998 * mParameters[12] - 0.043909999999999998 * var_chaste_interface__cell__V);
            const double var_x244 = -127140.0 * var_x242 - 3.4740000000000003e-5 * var_x243;
            const double var_x245 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V - 0.311 * mParameters[12]);
            ...
            const double var_x251 = exp(-3.2000000000000002 + var_x232 + 0.10000000000000001 * mParameters[12]);
            const double var_x252 = 1.0 + var_x251;
            const double var_x253 = exp(2.5349999999999999e-7 * mParameters[12] - 2.5349999999999999e-7 * var_chaste_interface__cell__V);
            const double var_x254 = var_x253 / var_x252;
            const double var_x255 = exp(-5.5312920000000005 + 0.13780000000000001 * mParameters[12] - 0.13780000000000001 * var_chaste_interface__cell__V);
            const double var_x256 = 1.0 + var_x255;
            const double var_x257 = exp(0.01052 * mParameters[12] - 0.01052 * var_chaste_interface__cell__V);
...
// LCOV_EXCL_STOP
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative7(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.052900000000000003 - var_x276;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative8(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x282 * (-1 + var_x148 * var_x292);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative9(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x304 * (-1 + 6.9213708621806839e-7 * var_x293 * var_x305) - var_x293 * var_x310;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative10(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0054000000000000003 - var_x311;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative13(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -3.8050000000000003e-5 * var_x329 * var_x336 - 0.00018000000000000001 * var_x333 * var_x335;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative14(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -25.0 * var_x344 - 25.0 * var_x348;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative15(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.029999999999999999 * var_x359 - 0.20000000000000001 * var_x355;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative16(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.10000000000000001 * var_x355 - 0.0022499999999999998 * var_x359;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative20(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.00068000000000000005 - var_x187 * var_x363 + var_x182 * var_x202 * var_x363;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellhund_rudy_2004FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
            ...
            const double var_x137 = log(var_x136 * mParameters[8]);
            ...
            const double var_x162 = var_x82 * mParameters[5];
            ...
            const double var_x421 = log(var_x173 * mParameters[6]);
            ...
            partialF = (var_x426 - 0.0016433629212878199 * var_x158 - 0.0016433629212878199 * var_x160 - 0.00055368668594131857 * var_x164 - 2.283957579507939e-6 * var_x161 - var_x163 * var_x418) * mParameters[4];
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellhund_rudy_2004FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
            ...
            partialF = (var_x436 + 26.712338705500134 * var_x432 + 0.00017203830661668509 * var_x172 - 0.00070719080288027735 * var_x168 - 4.535681662754383e-6 * var_x165 - 0.0016433629212878199 * var_x169 - 0.00072133461893788295 * var_x166 - var_x171 * var_x431) * mParameters[4];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative25(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (var_x427 + var_x437 + 8.8885199344722979e-8 * var_x61 - 3.6975665728975948e-7 * var_x173) * mParameters[4];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative26(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x453 = var_x452 * mParameters[1] * var_chaste_interface__Irel__ri;
            const double var_x455 = var_x453 * var_chaste_interface__Irel__ro;
            const double var_x456 = var_x455;
            
            partialF = var_x443 * (-0.0083333333333333332 - var_x456) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0.0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x439 * var_x456) / (pow(var_x440, 3) * pow((0.125 + var_x441), 2));
        }
        else
        {
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative27(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.00072463768115942019 - 0.066666666666666666 * var_x200;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellhund_rudy_2004FromCellMLGRL1Opt::EvaluatePartialDerivative28(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x447 = exp(2.6000000000000001 + var_x115 * var_x445);
            const double var_x448 = 1.0 + var_x447;
            const double var_x449 = mParameters[1] * var_chaste_interface__Irel__ro;
            ...
            partialF = var_x464 * (-5.0 - var_x467 - 15.110483888602907 * var_x298 - 693.50423428801582 * var_x457) + (0.019557600000000001 / pow(var_x460, 3) + 8.1780000000000006e-5 / pow(var_x461, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 15.110483888602907 * var_x283 + var_x439 * var_x467) / pow(var_x462, 2);
        }
        else
        {
