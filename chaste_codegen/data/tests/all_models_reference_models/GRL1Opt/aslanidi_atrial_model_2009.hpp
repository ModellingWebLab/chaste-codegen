#ifndef CELLASLANIDI_ATRIAL_MODEL_2009FROMCELLMLGRL1OPT_HPP_
#define CELLASLANIDI_ATRIAL_MODEL_2009FROMCELLMLGRL1OPT_HPP_
...
class Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellaslanidi_atrial_model_2009FromCellMLGRL1Opt(p_solver, p_stimulus);
        }
...
#endif // CELLASLANIDI_ATRIAL_MODEL_2009FROMCELLMLGRL1OPT_HPP_