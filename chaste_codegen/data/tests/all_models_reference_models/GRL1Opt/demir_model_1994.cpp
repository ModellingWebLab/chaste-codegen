...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x6 = var_x5 * mParameters[4];
            const double var_x7 = var_x5 * mParameters[5];
            ...
            const double var_x21 = mParameters[2] * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
            const double var_x22 = var_x21 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
            const double var_x23 = (46.399999999999999 - var_chaste_interface__membrane__V) * mParameters[0];
            ...
            const double var_x43 = var_x41 * var_x42 * mParameters[3] * var_chaste_interface__sodium_current_h_gate__h1 * var_chaste_interface__sodium_current_h_gate__h2;
            ...
            const double var_x49 = var_x48 * var_chaste_interface__membrane__V * mParameters[3] * var_chaste_interface__sodium_current_h_gate__h1;
            const double var_x50 = var_x39 * var_x42 * var_x49 / pow(var_x40, 2);
            const double var_x51 = 1 / mParameters[1];
            const double var_x52 = 0.001 * var_x51;
            
            partialF = var_x52 * (-0.00026580000000000001 - var_x6 - var_x7 + 135.20454067538472 * var_x50 - 0.02521 * var_x8 - 1.2480000000000001e-5 * var_x20 - 135.20454067538472 * var_x47 - 2.7046577588354044 * var_x22 - 2.3940879178437715e-5 * var_x32 + var_x23 * var_x25 + (-var_x4 - 0.095000000000000001 * var_x3) * mParameters[0] - var_x38 * var_x44);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x136 - 12.359999999999999 * var_x129;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x128 = exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V);
            const double var_x129 = 1 / (1.0 + 320.0 * var_x128);
            const double var_x138 = 0.0082500000000000004 * var_x128;
            
            partialF = -var_x138 - 0.61799999999999999 * var_x129;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x139 = exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V);
            const double var_x140 = -1.0 + var_x139;
            const double var_x141 = 1 / var_x140;
            const double var_x143 = exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V);
            const double var_x144 = -1.0 + var_x143;
            const double var_x145 = 1 / var_x144;
            const double var_x147 = exp(-0.20799999999999999 * var_chaste_interface__membrane__V);
            const double var_x148 = -1.0 + var_x147;
            const double var_x149 = 1 / var_x148;
            const double var_x151 = 35.0 + var_chaste_interface__membrane__V;
            const double var_x152 = -5.0 + var_chaste_interface__membrane__V;
            
            partialF = 0.028390000000000002 * var_x145 * var_x151 + 0.084900000000000003 * var_x149 * var_chaste_interface__membrane__V - 0.011429999999999999 * var_x141 * var_x152;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x162 = 28.0 + var_chaste_interface__membrane__V;
            const double var_x163 = 1 / var_x161;
            
            partialF = -0.029999999999999999 * var_x163 - 0.0037499999999999999 * var_x158 * var_x162;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x166 = 0.033333333333333333 * var_chaste_interface__membrane__V;
            const double var_x167 = exp(0.87666666666666671 + var_x166);
            const double var_x168 = exp(-0.87666666666666671 - var_x166);
            
            partialF = -1.0680000000000001 * var_x167 - 1.0680000000000001 * var_x168;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x172 = exp(-0.74069627851140463 - 0.012004801920768308 * var_chaste_interface__membrane__V);
            
            partialF = -0.015300000000000001 * var_x172 - 0.014999999999999999 * var_x171;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x173 = exp(0.039800000000000002 * var_chaste_interface__membrane__V);
            const double var_x174 = exp(-0.050999999999999997 * var_chaste_interface__membrane__V);
            
            partialF = -0.0021099999999999999 * var_x174 - 0.017000000000000001 * var_x173;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celldemir_model_1994FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x177 = _lt_0_row[16];
            const double var_x178 = _lt_0_row[17];
            
            partialF = -0.65600000000000003 * var_x178 - 0.10000000000000001 * var_x177;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x181 = exp(-2.2219482120838472 - 0.041101520756267988 * var_chaste_interface__membrane__V);
            const double var_x182 = exp(-10.909090909090908 - 0.18181818181818182 * var_chaste_interface__membrane__V);
            const double var_x183 = 0.69999999999999996 + var_x182;
            const double var_x184 = 1 / var_x183;
            
            partialF = -0.0016483000000000001 * var_x181 - 0.01401055 * var_x184;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x191 = 7.158914428402498e-11 * var_x59;
            const double var_x192 = 7.1589144284024978e-7 * var_x14;
            const double var_x193 = 23.020586507479816 * var_x46;
            
            partialF = 2.2637191644542304e-5 * var_x85 - 2.7242382709912566e-5 * var_x34 - 0.00012359906637920097 * var_x86 + var_x191 * var_x79 - var_x192 * var_x82 - var_x193 * var_x35;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x197 = 0.46050826103455306 * var_x22;
            
            partialF = -1.1816383500424576e-5 * var_x71 - var_x197 * var_x71;
        }
        else
        {
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x199 = -129.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
            
            partialF = -0.307 + var_x199;
        }
        else
        {
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0042500000000000003 + var_x199;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x194 = var_x37 * var_x45;
            const double var_x205 = 2.447717065593501e-6 * var_x14;
            const double var_x206 = 2.4477170655935014e-10 * var_x59;
            const double var_x207 = 78.710093573368496 * var_x46;
            
            partialF = -0.099999999999999992 - var_x207 + 78.710093573368496 * var_x194 - 9.3144911471392233e-5 * var_x89 - var_x205 * var_x91 - var_x206 * var_x90;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative19(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x210 = 2.7196856284372237e-11 * var_x59;
            const double var_x211 = 2.7196856284372236e-7 * var_x14;
            
            partialF = -0.099999999999999992 - 5.2976168399354324e-6 * var_x92 + var_x11 * var_x210 - var_x211 * var_x93;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x216 = 1.5745319219196114 * var_x22;
            const double var_x217 = 0.00018782211067427598 * var_x95;
            
            partialF = -0.099999999999999992 - 4.040160535071638e-5 * var_x94 + var_x217 * var_x97 - var_x216 * var_x94 - var_x217 * var_x98;
        }
        else
        {
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative21(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.015581177937052042 - 4.0251665946738841e-8 * var_x101 - 5.5905091592692838e-7 * var_x102;
        }
        else
        {
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -8.979782511378108 + 8.8396000000000008 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_Calse - 1.2294902345128229 * var_x112;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative24(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x219 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
            const double var_x221 = 0.0040000000000000001 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
            const double var_x222 = pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i, 4);
            const double var_x224 = pow(var_x221, (-4));
            const double var_x227 = 0.23999999999999999 * var_x219;
            const double var_x228 = 0.23999999999999999 * var_x222 * var_x224;
            const double var_x229 = -var_x228;
            
            partialF = var_x229 - var_x227;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative25(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.040000000000000001 + var_x229;
        }
        else
        {
