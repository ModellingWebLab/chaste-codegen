...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return ((fabs(-5.0 + var_chaste_interface__membrane__V) < 2.4999999981289989e-7) ? (2.8575000029373855e-6 / (-1.0 + exp(1.0000000010279565e-7)) - 2000000.0014968009 * (-5.0000002500000003 + var_chaste_interface__membrane__V) * (-2.8574999927855059e-6 / (-1.0 + exp(-9.9999999747524276e-8)) - 2.8575000029373855e-6 / (-1.0 + exp(1.0000000010279565e-7)))) : (11.43 * (-5.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V)))) + ((fabs(var_chaste_interface__membrane__V) < 4.8076923076923074e-7) ? (4.0817307692307694e-5 / (-1.0 + exp(9.9999999999999995e-8)) + 1040000.0 * (4.8076923076923074e-7 + var_chaste_interface__membrane__V) * (-4.0817307692307694e-5 / (-1.0 + exp(9.9999999999999995e-8)) - 4.0817307692307694e-5 / (-1.0 + exp(-9.9999999999999995e-8))) - 28.390000000000001 * (35.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V))) : (-28.390000000000001 * (35.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)) - 84.900000000000006 * var_chaste_interface__membrane__V / (-1.0 + exp(-0.20799999999999999 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return ((fabs(51.899999999999999 + var_chaste_interface__membrane__V) < 8.8999999903194293e-7) ? (0.00073335999627488491 / (-1.0 + exp(9.999999949204822e-8)) + 561797.75342005875 * (51.900000889999994 + var_chaste_interface__membrane__V) * (-0.00073335999627488491 / (-1.0 + exp(9.999999949204822e-8)) - 0.00073336000212975705 / (-1.0 + exp(-1.0000000029041085e-7)))) : (-824.0 * (51.899999999999999 + var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x17 = fabs(var_chaste_interface__membrane__V);
            const double var_x176 = 1 / (-1.0 + exp(-9.9999999747524276e-8));
            const double var_x177 = 1 / (-1.0 + exp(1.0000000010279565e-7));
            ...
            const double var_x182 = exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V);
            ...
            const double var_x189 = 2.8575000029373855e-6 * var_x177;
            const double var_x190 = (-5.0000002500000003 + var_chaste_interface__membrane__V) * (-var_x189 - 2.8574999927855059e-6 * var_x176);
            const double var_x194 = -5.0 + var_chaste_interface__membrane__V;
            const double var_x195 = fabs(var_x194) < 2.4999999981289989e-7;
            const double var_x196 = 1 / (-1.0 + exp(9.9999999999999995e-8));
            const double var_x197 = 1 / (-1.0 + exp(-9.9999999999999995e-8));
            const double var_x198 = exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V);
            const double var_x199 = -1.0 + var_x198;
            const double var_x200 = 1 / var_x199;
            const double var_x203 = 4.0817307692307694e-5 * var_x196;
            const double var_x205 = (4.8076923076923074e-7 + var_chaste_interface__membrane__V) * (-var_x203 - 4.0817307692307694e-5 * var_x197);
            const double var_x206 = var_x17 < 4.8076923076923074e-7;
            const double var_x207 = 0.028390000000000002 * var_x184 * var_x186;
            const double var_x208 = var_x207 + 0.084900000000000003 * var_x180 * var_chaste_interface__membrane__V;
            const double var_x209 = -0.011429999999999999 * var_x194 * var_x200;
            
            partialF = ((var_x195) ? (var_x208 + 2000.0000014968009 * var_x190 - 2.8575000029373855e-9 * var_x177) : ((var_x206) ? (var_x207 + var_x209 - 1040.0 * var_x205 - 4.0817307692307691e-8 * var_x196) : (var_x208 + var_x209)));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x212 = 0.25 * var_chaste_interface__membrane__V;
            const double var_x213 = exp(7.0 + var_x212);
            const double var_x214 = -1.0 + var_x213;
            const double var_x215 = 1 / var_x214;
            const double var_x217 = exp(-7.0 - var_x212);
            const double var_x218 = 1.0 + var_x217;
            const double var_x219 = 28.0 + var_chaste_interface__membrane__V;
            const double var_x220 = 1 / var_x218;
            
            partialF = -0.029999999999999999 * var_x220 - 0.0037499999999999999 * var_x215 * var_x219;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x223 = 0.033333333333333333 * var_chaste_interface__membrane__V;
            const double var_x224 = exp(0.87666666666666671 + var_x223);
            const double var_x225 = exp(-0.87666666666666671 - var_x223);
            
            partialF = -1.0680000000000001 * var_x224 - 1.0680000000000001 * var_x225;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x228 = exp(4.0117035110533159 + 0.065019505851755519 * var_chaste_interface__membrane__V);
            const double var_x229 = exp(-0.74069627851140463 - 0.012004801920768308 * var_chaste_interface__membrane__V);
            
            partialF = -0.015300000000000001 * var_x229 - 0.014999999999999999 * var_x228;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x230 = exp(0.039800000000000002 * var_chaste_interface__membrane__V);
            const double var_x231 = exp(-0.050999999999999997 * var_chaste_interface__membrane__V);
            
            partialF = -0.0021099999999999999 * var_x231 - 0.017000000000000001 * var_x230;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celldemir_model_1994FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x234 = _lt_0_row[16];
            const double var_x235 = _lt_0_row[17];
            
            partialF = -0.65600000000000003 * var_x235 - 0.10000000000000001 * var_x234;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x238 = exp(-2.2219482120838472 - 0.041101520756267988 * var_chaste_interface__membrane__V);
            const double var_x239 = exp(-10.909090909090908 - 0.18181818181818182 * var_chaste_interface__membrane__V);
            const double var_x240 = 0.69999999999999996 + var_x239;
            const double var_x241 = 1 / var_x240;
            
            partialF = -0.0016483000000000001 * var_x238 - 0.01401055 * var_x241;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x245 = 7.158914428402498e-11 * var_x71;
            const double var_x246 = 7.1589144284024978e-7 * var_x44;
            
            partialF = 2.2637191644542304e-5 * var_x117 - 2.7242382709912566e-5 * var_x0 - 0.00012359906637920097 * var_x118 - 0.0063736773757144738 * var_x109 + var_x111 * var_x245 - var_x114 * var_x246;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x249 = 0.46050826103455306 * var_x52;
            
            partialF = -1.1816383500424576e-5 * var_x96 - var_x249 * var_x96;
        }
        else
        {
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x251 = -129.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
            
            partialF = -0.307 + var_x251;
        }
        else
        {
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0042500000000000003 + var_x251;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x255 = 2.447717065593501e-6 * var_x44;
            const double var_x256 = 2.4477170655935014e-10 * var_x71;
            
            partialF = -0.099999999999999992 + 0.021792352791964929 * var_x122 - 9.3144911471392233e-5 * var_x123 - var_x124 * var_x256 - var_x125 * var_x255;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative19(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x259 = 2.7196856284372237e-11 * var_x71;
            const double var_x260 = 2.7196856284372236e-7 * var_x44;
            
            partialF = -0.099999999999999992 - 5.2976168399354324e-6 * var_x126 + var_x259 * var_x41 - var_x127 * var_x260;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x265 = 1.5745319219196114 * var_x52;
            const double var_x266 = 0.00018782211067427598 * var_x129;
            
            partialF = -0.099999999999999992 - 4.040160535071638e-5 * var_x128 + var_x131 * var_x266 - var_x128 * var_x265 - var_x132 * var_x266;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative24(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x268 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
            const double var_x270 = 0.0040000000000000001 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
            const double var_x271 = pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i, 4);
            const double var_x273 = pow(var_x270, (-4));
            const double var_x276 = 0.23999999999999999 * var_x268;
            const double var_x277 = 0.23999999999999999 * var_x271 * var_x273;
            const double var_x278 = -var_x277;
            
            partialF = var_x278 - var_x276;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celldemir_model_1994FromCellMLGRL1Opt::EvaluatePartialDerivative25(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.040000000000000001 + var_x278;
        }
        else
        {
