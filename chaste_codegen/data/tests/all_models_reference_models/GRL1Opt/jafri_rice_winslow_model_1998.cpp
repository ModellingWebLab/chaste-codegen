...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x108 = mParameters[4] * _lt_0_row[4];
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            partialF = ((var_x228) ? (var_x233 + var_x234 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x233 + 3.1999999919207769e-7 * var_x223)) : (var_x234 - var_x227 * var_x232));
        }
        else
        {
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x235 = exp(-11.764705882352942 + 0.14705882352941177 * mParameters[11] - 0.14705882352941177 * var_chaste_interface__membrane__V);
            ...
            const double var_x239 = exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * mParameters[11]);
            const double var_x240 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * mParameters[11]);
            const double var_x241 = exp(-0.96036036036036043 + 0.0900900900900901 * mParameters[11] - 0.0900900900900901 * var_chaste_interface__membrane__V);
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x229 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x236 = var_chaste_interface__membrane__V < -40.0;
            const double var_x251 = exp(-5.5312920000000005 + 0.13780000000000001 * mParameters[11] - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x252 = 1.0 + var_x251;
            const double var_x253 = exp(0.01052 * mParameters[11] - 0.01052 * var_chaste_interface__membrane__V);
            const double var_x254 = var_x253 / var_x252;
            const double var_x255 = exp(-3.2000000000000002 + var_x229 + 0.10000000000000001 * mParameters[11]);
            const double var_x256 = 1.0 + var_x255;
            const double var_x257 = exp(2.5349999999999999e-7 * mParameters[11] - 2.5349999999999999e-7 * var_chaste_interface__membrane__V);
            ...
            const double var_x262 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * mParameters[11]);
            const double var_x263 = 1.0 + var_x262;
            const double var_x264 = 1 / var_x263;
            const double var_x265 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * mParameters[11]);
            const double var_x266 = exp(0.043909999999999998 * mParameters[11] - 0.043909999999999998 * var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x287 - var_x286 - var_x288;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x295 + var_x297 - var_x294;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x298 - var_x302 - var_x303;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.29999999999999999 - var_x304 - var_x306;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.01 + var_x280 - var_x310;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0050000000000000001 - var_x311 - var_x313;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0025000000000000001 + var_x282 + var_x287;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.00125 + var_x297 - var_x315;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.00062500000000000001 + var_x295;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x333) ? (var_x342 + var_x344 - 740000.00029091549 * (30.000000675675675 + var_chaste_interface__membrane__V) * (var_x342 + 4.8581081061982445e-11 * var_x327)) : ((var_x338) ? (var_x344 + var_x345) : (var_x345 - var_x331 * var_x341)));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x355 = (var_chaste_interface__calcium_subsystem__P_O1 + var_chaste_interface__calcium_subsystem__P_O2) * mParameters[1];
            ...
            partialF = var_x349 * (-5490.7343857240912 + (-var_x353 - var_x354) * mParameters[1]) + 0.00023800000000000004 * (79.615648592999321 * var_x356 + 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Cai - 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Ca_SS - var_x2 * var_x351) / (pow(var_x346, 3) * pow(var_x347, 2));
        }
        else
        {
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.16049999999999998 - var_x362;
        }
        else
        {
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x369 = 12.345679012345679 * mParameters[0];
            
            partialF = -0.0016613674772994187 - var_x369;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            partialF = (var_x379 - 0.16330396408463044 * var_x163 - 2.3025858935932891e-6 * var_x114 - 1.1350943583223629e-5 * var_x167 - 0.055222823561630309 * var_x168 - var_x160 * var_x376) * mParameters[3];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (var_x405 + var_x413 - var_x406 - var_x408 - var_x409 - var_x410 - var_x411 - var_x412) * mParameters[3];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL1Opt::EvaluatePartialDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (var_x414 + var_x419 + var_x420 + var_x421 + var_x423 + var_x424 + var_x425 + var_x426 - var_x415 - var_x416 - var_x417 - var_x418 - var_x422) * mParameters[3];
        }
        else
        {
