...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellfox_mcharg_gilmour_2002FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x4 = -0.34100000000000003 * mParameters[5];
            ...
            const double var_x7 = 7.2262487681097562 * mParameters[8];
            ...
            const double var_x22 = var_x21 * ((var_x12) ? (var_x10 * var_x7 + var_x6 * var_x7) : (var_x17 + 1082.2522540644097 * var_x19 * var_chaste_interface__calcium_dynamics__Ca_i_converted - 1.0822522540644097 * var_x14 * var_x18 * mParameters[8] / pow(var_x15, 2)));
            const double var_x23 = 1.9300000000000002e-5 * mParameters[8];
            ...
            const double var_x31 = var_x9 * (var_x2 + var_x8 * mParameters[3]);
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellfox_mcharg_gilmour_2002FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x57 = var_x56 / var_x55;
            const double var_x64 = var_x54 - var_x5 * var_x53;
            const double var_x78 = 0.019300000000000001 * mParameters[8];
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellfox_mcharg_gilmour_2002FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            partialF = ((var_x141) ? (var_x146 + var_x147 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x146 + 3.1999999919207769e-7 * var_x136)) : (var_x147 - var_x140 * var_x145));
        }
        else
        {
