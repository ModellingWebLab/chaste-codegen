...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellearm_noble_model_1990FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -17.0 + var_x87 + var_x88 + 0.0030000000000000001 * var_x92 - 0.0030000000000000001 * var_x90 - 2.8102681769358871e-7 * var_x55 - 3.1504144536796187e-6 * var_x65 - 0.23093344215355205 * var_x58 - 5.8069998209165779e-10 * var_x59 - 3.0670341725380159e-10 * var_x57 - 5.5200000000000005e-8 * var_x93 - var_x63 * var_x86;
        }
        else
        {
    ...
    double Cellearm_noble_model_1990FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 8.1754862903173357e-6 * var_x85 - 0.0001091989920180802 * var_x83 - 3.8219647206328062e-5 * var_x1 - 3.1504144536796189e-9 * var_x82 - 0.00022482145415487099 * var_x84;
        }
        else
        {
