#ifndef CELLOHARA_RUDY_2011_ENDOFROMCELLMLGRL1OPT_HPP_
#define CELLOHARA_RUDY_2011_ENDOFROMCELLMLGRL1OPT_HPP_
...
class Cellohara_rudy_2011_endoFromCellMLGRL1Opt : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellohara_rudy_2011_endoFromCellMLGRL1Opt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellohara_rudy_2011_endoFromCellMLGRL1Opt();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellohara_rudy_2011_endoFromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellohara_rudy_2011_endoFromCellMLGRL1Opt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellohara_rudy_2011_endoFromCellMLGRL1Opt(p_solver, p_stimulus);
        }
...
#endif // CELLOHARA_RUDY_2011_ENDOFROMCELLMLGRL1OPT_HPP_