...
// LCOV_EXCL_STOP
    ...
    double Cellmaltsev_2009FromCellMLGRL1Opt::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x152) ? (var_x144 + var_x145 + var_x164) : ((var_x163) ? (var_x146 + var_x161 + var_x165 - var_x162) : (var_x164 + var_x165)));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellmaltsev_2009FromCellMLGRL1Opt::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0050000000000000001 + var_x267;
        }
        else
        {
    ...
    double Cellmaltsev_2009FromCellMLGRL1Opt::EvaluatePartialDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.54200000000000004 + var_x281;
        }
        else
        {
    ...
    double Cellmaltsev_2009FromCellMLGRL1Opt::EvaluatePartialDerivative24(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0075100000000000002 + var_x281;
        }
        else
        {
    ...
    double Cellmaltsev_2009FromCellMLGRL1Opt::EvaluatePartialDerivative27(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -5.3650000000000002 - var_x282 + 5.3399999999999999 * var_chaste_interface__calcium_buffering__fCQ;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellmaltsev_2009FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__Vm__Vm);
            ...
            partialF = -35.246499999999997 - var_x289 + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMs - var_x285 * (-var_x122 * var_x283 - var_x123 * var_x284);
        }
        else
        {
