...
// LCOV_EXCL_STOP
    ...
    double Cellpasek_simurda_orchard_christe_2008FromCellMLGRL1Opt::EvaluatePartialDerivative32(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x463) ? (var_x474 + 725000.00221680664 * var_x460 - 4.2068965605324136e-10 * var_x452) : ((var_x473) ? (var_x475 + 1.1219512196092296e-9 * var_x464 - 614999.99994681031 * var_x471) : (var_x474 + var_x475)));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellpasek_simurda_orchard_christe_2008FromCellMLGRL1Opt::EvaluatePartialDerivative34(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x498) ? (1.9068413377354434e-10 * var_x492 + 1.0465793296425829e-10 * var_x493 - 343500.00025585521 * var_x495) : (-0.00013100000000000001 * var_x497 * var_x501 - 7.1899999999999999e-5 * var_x497 * var_x505));
        }
        else
        {
