...
// LCOV_EXCL_STOP
        ...
        const double var_i_CaL_s__i_CaL_s = 0.55630930863148487 * (_lt_0_row[1]) * (var_chaste_interface__i_CaL_s__Ccao + var_chaste_interface__i_CaL_s__Co) * var_chaste_interface__Vm_s__Vm_s * var_chaste_interface__i_CaL_s_y_gate__y * mParameters[4] / (_lt_0_row[0]); // microA
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellpasek_simurda_orchard_christe_2008FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__Vm_s__Vm_s);
            ...
            const double var_x42 = var_chaste_interface__i_Na_s_h_gate__h * mParameters[5];
            ...
            const double var_x51 = mParameters[9] / var_x50;
            ...
            const double var_x63 = mParameters[8] / (1000.0 * var_x62 + 1020.0 * var_x55);
            ...
            const double var_x89 = var_x47 * var_x49 * var_chaste_interface__i_Kr_s_xr_gate__xr * mParameters[9] / pow(var_x50, 2);
            ...
            const double var_x98 = var_x47 * var_x55 * mParameters[8] / pow((var_x55 + 0.98039215686274506 * var_x62), 2);
            ...
            const double var_x109 = var_x108 * mParameters[4];
            ...
            const double var_x116 = var_x101 * mParameters[4];
            ...
            const double var_x125 = var_x72 * var_x92 * mParameters[11];
            ...
            const double var_x130 = var_x47 * var_chaste_interface__i_Kto_s_r2_gate__r2 * mParameters[12];
...
// LCOV_EXCL_STOP
    ...
    double Cellpasek_simurda_orchard_christe_2008FromCellMLGRL1Opt::EvaluatePartialDerivative47(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (var_x551 - 1.2588145919464355e-6 * var_x243 - 2.8003732904259173e-5 * var_x601 - 0.012588145919464354 * var_x602 - 4.8765371052902662e-7 * var_x554 - 0.045430644001839972 * var_x600 - 0.00019789304585676482 * var_x598) * mParameters[3];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellpasek_simurda_orchard_christe_2008FromCellMLGRL1Opt::EvaluatePartialDerivative51(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x647 * (-5333333.333333333 + (-var_x654 - var_x655) * mParameters[1]) + 2.3800000000000004e-7 * (77.45098039215685 * var_x439 + 5333333.333333333 * var_chaste_interface__ion_concentrations__Ca_i - 8745287.3346186504 * var_x111 - 5333333.333333333 * var_chaste_interface__ion_concentrations__Ca_ss - var_x643 * var_chaste_interface__Vm_s__Vm_s) / (pow(var_x644, 3) * pow(var_x645, 2));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Cellpasek_simurda_orchard_christe_2008FromCellMLGRL1Opt::EvaluatePartialDerivative54(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x207 = var_x104 * var_x105 * var_x106 * mParameters[4] / pow(var_x107, 2);
