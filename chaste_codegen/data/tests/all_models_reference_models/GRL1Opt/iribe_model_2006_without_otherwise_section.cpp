...
#include "MathsCustomFunctions.hpp"
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_fast_sodium_current__i_Na = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-26.713760659695652 * log(10) * log10(140.47999999999999 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i)) + var_chaste_interface__membrane_potential__V) * mParameters[3] * var_chaste_interface__fast_sodium_current_h_gate__h; // nanoA
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x55 * (0.0014499999999999999 + var_x14 + var_x16 + 1.0880000000000001 * var_x25 + 0.0050000000000000001 * var_x7 + 0.022420738914067644 * var_x47 + 0.0010695397377927277 * var_x20 + 0.0019730250244379527 * var_x49 + 0.2857142857142857 * var_x6 - 0.011210369457033822 * var_x50 - 2.8025923642584555e-6 * var_x52 - 0.021390794755854554 * var_x21 - 1.4012961821292276e-5 * var_x53 + var_x27 * var_x34 + var_x38 * var_x41 + var_x38 * var_x43);
        }
        else
        {
