...
#include "MathsCustomFunctions.hpp"
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_background_current__i_b_Ca = 0.00025000000000000001 * var_chaste_interface__membrane_potential__V - 0.0033392200824619565 * log(10) * log10(2.0 / var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
        ...
        const double var_fast_sodium_current__i_Na = 1.0 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-26.713760659695652 * log(10) * log10(140.47999999999999 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i)) + var_chaste_interface__membrane_potential__V) * mParameters[3] * var_chaste_interface__fast_sodium_current_h_gate__h; // nanoA
        const double var_sodium_background_current__i_b_Na = 0.00059999999999999995 * var_chaste_interface__membrane_potential__V - 0.016028256395817387 * log(10) * log10(140.0 / var_chaste_interface__intracellular_sodium_concentration__Na_i); // nanoA
        const double var_sodium_calcium_exchanger__i_NaCa = 1.0 * (2.0 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3) * exp(0.018716945411372737 * var_chaste_interface__membrane_potential__V) - 2744000.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(-0.018716945411372737 * var_chaste_interface__membrane_potential__V)) * mParameters[6] / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::UpdateTransmembranePotential(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_L_type_Ca_channel__i_Ca_L = 1.0 * var_L_type_Ca_channel__i_Ca_L_Ca + 1.0 * var_L_type_Ca_channel__i_Ca_L_K + 1.0 * var_L_type_Ca_channel__i_Ca_L_Na; // nanoA
        const double var_calcium_background_current__i_b_Ca = 0.00025000000000000001 * var_chaste_interface__membrane_potential__V - 0.0033392200824619565 * log(10) * log10(2.0 / var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
        const double var_reversal_potentials__E_K = 26.713760659695652 * log(10) * log10(4.0 / var_chaste_interface__intracellular_potassium_concentration__K_i); // millivolt
        const double var_potassium_background_current__i_b_K = 0.00059999999999999995 * var_chaste_interface__membrane_potential__V - 0.00059999999999999995 * var_reversal_potentials__E_K; // nanoA
        const double var_fast_sodium_current__i_Na = 1.0 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-26.713760659695652 * log(10) * log10(140.47999999999999 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i)) + var_chaste_interface__membrane_potential__V) * mParameters[3] * var_chaste_interface__fast_sodium_current_h_gate__h; // nanoA
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -5.8000000000000007 + var_x80 + var_x81 - var_x95 + 1.152e-10 * var_x85 - 1.0548821632800683e-6 * var_x56 - 1733.6962431696716 * var_x57 - 4.3595131479120748e-6 * var_x58 - 10138.888888888887 * var_x87 - 4.7302475136018565e-5 * var_x59;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x116 = 41.0 + var_chaste_interface__membrane_potential__V;
            const double var_x117 = fabs(var_x116) < 1.0000000000000001e-5;
            const double var_x119 = -0.10000000000000001 * var_chaste_interface__membrane_potential__V;
            const double var_x120 = exp(-4.1000000000000005 + var_x119);
            const double var_x121 = 1.0 - var_x120;
            const double var_x122 = 0.20000000000000001 / var_x121;
            const double var_x123 = -8.0 * var_x114;
            
            partialF = ((var_x117) ? (-2.0 + var_x123) : (var_x123 - var_x116 * var_x122));
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x119 = -0.10000000000000001 * var_chaste_interface__membrane_potential__V;
            const double var_x124 = exp(-7.5 + var_x119 + 0.10000000000000001 * mParameters[5]);
            const double var_x125 = 1 / (1.0 + 320.0 * var_x124);
            const double var_x126 = 2.0 * var_x125;
            const double var_x127 = -0.125 * var_chaste_interface__membrane_potential__V;
            const double var_x128 = exp(-9.375 + var_x127 + 0.125 * mParameters[5]);
            const double var_x129 = 0.02 * var_x128;
            
            partialF = -var_x126 - var_x129;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x136 = exp(-0.80000000000000004 - 0.040000000000000001 * var_chaste_interface__membrane_potential__V);
            const double var_x137 = 1.0 + var_x136;
            const double var_x138 = exp(-1.2 - 0.059999999999999998 * var_chaste_interface__membrane_potential__V);
            const double var_x139 = var_x138 / var_x137;
            const double var_x141 = exp(2.8500000000000001 + 0.057000000000000002 * var_chaste_interface__membrane_potential__V);
            const double var_x142 = 1.0 + var_x141;
            const double var_x143 = exp(4.1300000000000008 + 0.082600000000000007 * var_chaste_interface__membrane_potential__V);
            const double var_x144 = var_x143 / var_x142;
            
            partialF = -0.00050000000000000001 * var_x144 - 0.0012999999999999999 * var_x139;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x127 = -0.125 * var_chaste_interface__membrane_potential__V;
            const double var_x145 = exp(-0.058823529411764705 * var_chaste_interface__membrane_potential__V);
            const double var_x146 = exp(-1.25 + var_x127);
            const double var_x147 = 1.0 + var_x146;
            
            partialF = -0.033000000000000002 / var_x147 - 3.3000000000000003e-5 * var_x145;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x149 = 19.0 + var_chaste_interface__membrane_potential__V;
            const double var_x150 = fabs(var_x149) < 1.0000000000000001e-5;
            const double var_x151 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane_potential__V);
            const double var_x152 = 1.0 - var_x151;
            const double var_x153 = 0.035999999999999997 / var_x152;
            const double var_x155 = 0.25 * var_chaste_interface__membrane_potential__V;
            const double var_x156 = -var_x155;
            const double var_x157 = exp(-4.75 + var_x156);
            const double var_x158 = 1.0 - var_x157;
            const double var_x159 = 0.089999999999999997 / var_x158;
            
            partialF = ((var_x150) ? (-0.71999999999999997) : (var_x149 * var_x153 - var_x149 * var_x159));
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x155 = 0.25 * var_chaste_interface__membrane_potential__V;
            const double var_x156 = -var_x155;
            const double var_x160 = exp(-8.5 + var_x156);
            const double var_x161 = 1.0 + var_x160;
            const double var_x163 = 34.0 + var_chaste_interface__membrane_potential__V;
            const double var_x164 = fabs(var_x163) < 1.0000000000000001e-5;
            const double var_x166 = exp(8.5 + var_x155);
            const double var_x167 = -1.0 + var_x166;
            const double var_x168 = 0.0031250000000000002 / var_x167;
            const double var_x169 = -0.025000000000000001 / var_x161;
            
            partialF = ((var_x164) ? (-0.012500000000000001 + var_x169) : (var_x169 - var_x163 * var_x168));
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x44 = -50.0 + var_chaste_interface__membrane_potential__V;
            const double var_x82 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2);
            const double var_x170 = 0.03668521300629056 * var_x33;
            const double var_x171 = var_x170 * var_x27;
            const double var_x172 = 1.8342606503145281e-5 * var_x40;
            const double var_x173 = var_x172 * var_x38;
            const double var_x174 = 9.1713032515726407e-5 * var_x42;
            const double var_x175 = var_x174 * var_x38;
            const double var_x189 = 4.5454545454545459 * var_chaste_interface__RyR__F_SRCa_RyR;
            const double var_x190 = pow(var_chaste_interface__CaMKII_factor__F_CaMK, 2);
            const double var_x191 = pow(var_x189, (2.0408163265306123 * var_x190));
            const double var_x193 = 30625.0 * var_x82;
            const double var_x194 = -0.001885 * var_x191;
            const double var_x195 = var_x171 * var_x44;
            const double var_x196 = var_x173 * var_x44;
            const double var_x197 = var_x175 * var_x44;
            
            partialF = -0.0018 + var_x194 + var_x195 + var_x196 + var_x197 - var_x193;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x201 = 1.0 + 0.35999999999999999 / var_chaste_interface__SR_calcium_concentration__Ca_SR;
            
            partialF = -0.45000000000000001 / var_x201;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x202 = 0.5 * var_x93;
            const double var_x203 = var_x202 * var_chaste_interface__RyR__F_SRCa_RyR;
            
            partialF = -var_x203 - 0.001424696263447196 * var_x109 - 1.2089003260906828e-17 * var_x110;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 4.3794501115171722e-6 * var_x72 - 0.011372642994553239 * var_x73 - 1.0126868767488654e-5 * var_x69 - 0.0020622392630123207 * var_x71 - 0.016878114612481093 * var_x74 - 2.3651237568009284e-7 * var_x75;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 0.00036103628554137268 * var_x78 - 4.7302475136018567e-8 * var_x75 - 1.0126868767488654e-5 * var_x2 - 4.5129535692671587e-6 * var_x19 - 0.0048223184607088833 * var_x76 - 8.4390573062405455e-5 * var_x77;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x210 = 12600800.629436173 * pow(var_chaste_interface__troponin__Trpn_Ca, 5.1071428571428568);
            const double var_x211 = -var_x210;
            
            partialF = -0.040714285714285717 + var_x211;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.18071428571428572 + var_x211;
        }
        else
        {
