...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane_potential__stim_amplitude = -0040000000000000001 * HeartConfig::Instance()->GetCapacitance() / mParameters[1]; // uA_per_cm2
        const double var_chaste_interface__membrane_potential__stim_duration = 2.0; // millisecond
        const double var_chaste_interface__membrane_potential__stim_period = 500; // millisecond
                ...
                pIntracellularStimulus)
    {
        ...
        this->mParameters[6] = 00050000000000000001; // (var_sodium_calcium_exchanger__i_NaCa_max) [nanoA_per_millimolar4]
    }
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        // Units: dimensionless; Initial value: 0013809
        ...
        // Units: dimensionless; Initial value: 051127
        ...
        const double var_L_type_Ca_channel__i_Ca_L = 0.14973556329098189 * (-50 + var_chaste_interface__membrane_potential__V) * (-2.0 * exp(3.7433890822745473 - 074867781645490947 * var_chaste_interface__membrane_potential__V) + var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(3.7433890822745473)) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(3.7433890822745473 - 074867781645490947 * var_chaste_interface__membrane_potential__V)) + 7.4867781645490941e-5 * (-50 + var_chaste_interface__membrane_potential__V) * (-4.0 * exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane_potential__V) + var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372736)) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane_potential__V)) + 00037433890822745472 * (-50 + var_chaste_interface__membrane_potential__V) * (-140 * exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane_potential__V) + var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736)) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane_potential__V)); // nanoA
        const double var_calcium_background_current__i_b_Ca = 00025000000000000001 * var_chaste_interface__membrane_potential__V - 0033392200824619565 * log(2.0 / var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
        ...
        const double var_potassium_background_current__i_b_K = 00059999999999999995 * var_chaste_interface__membrane_potential__V - 00059999999999999995 * var_reversal_potentials__E_K; // nanoA
        ...
        const double var_sodium_background_current__i_b_Na = 00059999999999999995 * var_chaste_interface__membrane_potential__V - 016028256395817387 * log(140 / var_chaste_interface__intracellular_sodium_concentration__Na_i); // nanoA
        const double var_sodium_calcium_exchanger__i_NaCa = (2.0 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3) * exp(018716945411372737 * var_chaste_interface__membrane_potential__V) - 2744000 * var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(-018716945411372737 * var_chaste_interface__membrane_potential__V)) * mParameters[6] / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
        const double var_sodium_potassium_pump__i_NaK = 1.0880000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i / ((21.699999999999999 + var_chaste_interface__intracellular_sodium_concentration__Na_i) * (1.0 + 035299999999999998 * exp(-037433890822745473 * var_chaste_interface__membrane_potential__V) + 0.1245 * exp(-0037433890822745472 * var_chaste_interface__membrane_potential__V))); // nanoA
        const double var_time_dependent_rectifier_potassium_current__i_K = 0071428571428571426 * (-4.0 * exp(-037433890822745473 * var_chaste_interface__membrane_potential__V) + var_chaste_interface__intracellular_potassium_concentration__K_i) * mParameters[2] * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x; // nanoA
        const double var_time_independent_potassium_current__i_K1 = 0.2857142857142857 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane_potential__V) / (1.0 + exp(-0.74867781645490938 + 074867781645490947 * var_chaste_interface__membrane_potential__V - 074867781645490947 * var_reversal_potentials__E_K)); // nanoA
        const double var_transient_outward_current__i_to = 0050000000000000001 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane_potential__V) * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // nanoA
        const double var_chaste_interface__i_ionic = (001 * var_L_type_Ca_channel__i_Ca_L + 001 * var_calcium_background_current__i_b_Ca + 001 * var_fast_sodium_current__i_Na + 001 * var_potassium_background_current__i_b_K + 001 * var_sodium_background_current__i_b_Na + 001 * var_sodium_calcium_exchanger__i_NaCa + 001 * var_sodium_potassium_pump__i_NaK + 001 * var_time_dependent_rectifier_potassium_current__i_K + 001 * var_time_independent_potassium_current__i_K1 + 001 * var_transient_outward_current__i_to) * HeartConfig::Instance()->GetCapacitance() / mParameters[1]; // uA_per_cm2
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::UpdateTransmembranePotential(double var_chaste_interface__environment__time_converted)
    {
        ...
        // Mathematics
        const double var_L_type_Ca_channel__i_Ca_L_Ca = 0.14973556329098189 * (-50 + var_chaste_interface__membrane_potential__V) * (-2.0 * exp(3.7433890822745473 - 074867781645490947 * var_chaste_interface__membrane_potential__V) + var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(3.7433890822745473)) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(3.7433890822745473 - 074867781645490947 * var_chaste_interface__membrane_potential__V)); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_K = 7.4867781645490941e-5 * (-50 + var_chaste_interface__membrane_potential__V) * (-4.0 * exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane_potential__V) + var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372736)) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane_potential__V)); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_Na = 00037433890822745472 * (-50 + var_chaste_interface__membrane_potential__V) * (-140 * exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane_potential__V) + var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736)) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane_potential__V)); // nanoA
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        // Units: millimolar; Initial value: 00027661
        ...
        // Units: dimensionless; Initial value: 00013331
        double var_chaste_interface__Force__P_2 = rY[21];
        // Units: dimensionless; Initial value: 00023505
        double var_chaste_interface__Force__P_3 = rY[22];
        // Units: dimensionless; Initial value: 00015349
        ...
        const double d_dt_chaste_interface_var_Force__P_3 = 070000000000000007 * var_chaste_interface__Force__P_2 - 0.12214285714285715 * var_chaste_interface__Force__P_3; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_RyR__F_SRCa_RyR = 02 * var_chaste_interface__SR_calcium_concentration__Ca_SR - 02 * var_chaste_interface__RyR__F_SRCa_RyR; // millimolar / millisecond
        const double d_dt_chaste_interface_var_CaMKII_factor__F_CaMK = 24.999999999999996 * var_chaste_interface__calmodulin__Cmdn_Ca - 00125 * var_chaste_interface__CaMKII_factor__F_CaMK; // 1 / millisecond
        const double var_RyR__j_rel = 500 * pow(var_chaste_interface__RyR__F_2, 2) * (-var_chaste_interface__intracellular_calcium_concentration__Ca_i + var_chaste_interface__SR_calcium_concentration__Ca_SR) * var_chaste_interface__RyR__F_SRCa_RyR / (pow((0.25 + var_chaste_interface__RyR__F_2), 2) * (0.20000000000000001 + var_chaste_interface__RyR__F_SRCa_RyR)); // millimolar_per_second
        ...
        const double d_dt_chaste_interface_var_SR_calcium_concentration__Ca_SR = 0049000806523882071 * var_SERCA__j_up - 001 * var_RyR__j_rel; // millimolar / millisecond
        const double d_dt_chaste_interface_var_calmodulin__Cmdn_Ca = -0.5 * var_chaste_interface__calmodulin__Cmdn_Ca + 10 * (02 - var_chaste_interface__calmodulin__Cmdn_Ca) * var_chaste_interface__intracellular_calcium_concentration__Ca_i; // millimolar / millisecond
        const double var_L_type_Ca_channel__i_Ca_L_Ca = 0.14973556329098189 * (-50 + var_chaste_interface__membrane_potential__V) * (-2.0 * exp(3.7433890822745473 - 074867781645490947 * var_chaste_interface__membrane_potential__V) + var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(3.7433890822745473)) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(3.7433890822745473 - 074867781645490947 * var_chaste_interface__membrane_potential__V)); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_K = 7.4867781645490941e-5 * (-50 + var_chaste_interface__membrane_potential__V) * (-4.0 * exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane_potential__V) + var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372736)) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane_potential__V)); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_Na = 00037433890822745472 * (-50 + var_chaste_interface__membrane_potential__V) * (-140 * exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane_potential__V) + var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736)) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 037433890822745473 * var_chaste_interface__membrane_potential__V)); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L = var_L_type_Ca_channel__i_Ca_L_Ca + var_L_type_Ca_channel__i_Ca_L_K + var_L_type_Ca_channel__i_Ca_L_Na; // nanoA
        const double var_L_type_Ca_channel_d_gate__E0_d = 19.0 + var_chaste_interface__membrane_potential__V; // millivolt
        const double d_dt_chaste_interface_var_L_type_Ca_channel_d_gate__d = 001 * (1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d) * ((fabs(var_L_type_Ca_channel_d_gate__E0_d) < 1.0000000000000001e-5) ? (360) : (90 * var_L_type_Ca_channel_d_gate__E0_d / (1.0 - exp(-0.25 * var_L_type_Ca_channel_d_gate__E0_d)))) - 001 * ((fabs(var_L_type_Ca_channel_d_gate__E0_d) < 1.0000000000000001e-5) ? (360) : (-36.0 * var_L_type_Ca_channel_d_gate__E0_d / (1.0 - exp(0.10000000000000001 * var_L_type_Ca_channel_d_gate__E0_d)))) * var_chaste_interface__L_type_Ca_channel_d_gate__d; // 1 / millisecond
        const double var_L_type_Ca_channel_f_gate__E0_f = 34.0 + var_chaste_interface__membrane_potential__V; // millivolt
        const double d_dt_chaste_interface_var_L_type_Ca_channel_f_gate__f = 001 * (1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f) * ((fabs(var_L_type_Ca_channel_f_gate__E0_f) < 1.0000000000000001e-5) ? (12.5) : (3.125 * var_L_type_Ca_channel_f_gate__E0_f / (-1.0 + exp(0.25 * var_L_type_Ca_channel_f_gate__E0_f)))) - 025000000000000001 * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 + exp(-0.25 * var_L_type_Ca_channel_f_gate__E0_f)); // 1 / millisecond
        const double var_RyR__k_1 = 30625000 * pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2) - 245.0 * var_L_type_Ca_channel__i_Ca_L; // per_second
        const double d_dt_chaste_interface_var_RyR__F_1 = -0018000000000000002 * var_chaste_interface__RyR__F_1 + 001885 * pow((4.5454545454545459 * var_chaste_interface__RyR__F_SRCa_RyR), (2.0408163265306123 * pow(var_chaste_interface__CaMKII_factor__F_CaMK, 2))) * (1.0 - var_chaste_interface__RyR__F_1 - var_chaste_interface__RyR__F_2) - 001 * var_chaste_interface__RyR__F_1 * var_RyR__k_1; // 1 / millisecond
        const double d_dt_chaste_interface_var_RyR__F_2 = 001 * var_chaste_interface__RyR__F_1 * var_RyR__k_1 - 0.45000000000000001 * var_chaste_interface__RyR__F_2 / (1.0 + 0.35999999999999999 / var_chaste_interface__SR_calcium_concentration__Ca_SR); // 1 / millisecond
        const double var_fast_sodium_current_h_gate__alpha_h = 20 * exp(-9.375 + 0.125 * mParameters[5] - 0.125 * var_chaste_interface__membrane_potential__V); // per_second
        const double var_fast_sodium_current_h_gate__beta_h = 2000 / (1.0 + 320 * exp(-7.5 + 0.10000000000000001 * mParameters[5] - 0.10000000000000001 * var_chaste_interface__membrane_potential__V)); // per_second
        const double d_dt_chaste_interface_var_fast_sodium_current_h_gate__h = 001 * (1.0 * var_fast_sodium_current_h_gate__alpha_h + 1.0 * var_fast_sodium_current_h_gate__beta_h) * (-var_chaste_interface__fast_sodium_current_h_gate__h + 01 * mParameters[4] + (1.0 - 01 * mParameters[4]) * var_fast_sodium_current_h_gate__alpha_h / (var_fast_sodium_current_h_gate__alpha_h + var_fast_sodium_current_h_gate__beta_h)); // 1 / millisecond
        const double d_dt_chaste_interface_var_fast_sodium_current_m_gate__m = 001 * (1.0 - var_chaste_interface__fast_sodium_current_m_gate__m) * ((fabs(41.0 + var_chaste_interface__membrane_potential__V) < 1.0000000000000001e-5) ? (2000) : (200 * (41.0 + var_chaste_interface__membrane_potential__V) / (1.0 - exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane_potential__V)))) - 8.0 * var_chaste_interface__fast_sodium_current_m_gate__m * exp(-3.6960000000000002 - 056000000000000001 * var_chaste_interface__membrane_potential__V); // 1 / millisecond
        const double var_calcium_background_current__i_b_Ca = 00025000000000000001 * var_chaste_interface__membrane_potential__V - 0033392200824619565 * log(2.0 / var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
        const double var_reversal_potentials__E_K = 26.713760659695652 * log(4.0 / var_chaste_interface__intracellular_potassium_concentration__K_i); // millivolt
        const double var_potassium_background_current__i_b_K = 00059999999999999995 * var_chaste_interface__membrane_potential__V - 00059999999999999995 * var_reversal_potentials__E_K; // nanoA
        const double var_fast_sodium_current__i_Na = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-26.713760659695652 * log(140.47999999999999 / (1.0 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i)) + var_chaste_interface__membrane_potential__V) * mParameters[3] * var_chaste_interface__fast_sodium_current_h_gate__h; // nanoA
        ...
        const double var_sodium_calcium_exchanger__i_NaCa = (2.0 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3) * exp(018716945411372737 * var_chaste_interface__membrane_potential__V) - 2744000 * var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(-018716945411372737 * var_chaste_interface__membrane_potential__V)) * mParameters[6] / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
        const double var_sodium_potassium_pump__i_NaK = 1.0880000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i / ((21.699999999999999 + var_chaste_interface__intracellular_sodium_concentration__Na_i) * (1.0 + 035299999999999998 * exp(-037433890822745473 * var_chaste_interface__membrane_potential__V) + 0.1245 * exp(-0037433890822745472 * var_chaste_interface__membrane_potential__V))); // nanoA
        const double d_dt_chaste_interface_var_intracellular_sodium_concentration__Na_i = -00063181349969740222 * var_L_type_Ca_channel__i_Ca_L_Na - 00063181349969740222 * var_fast_sodium_current__i_Na - 00063181349969740222 * var_sodium_background_current__i_b_Na - 0018954404990922066 * var_sodium_calcium_exchanger__i_NaCa - 0018954404990922066 * var_sodium_potassium_pump__i_NaK; // millimolar / millisecond
        const double var_time_dependent_rectifier_potassium_current__i_K = 0071428571428571426 * (-4.0 * exp(-037433890822745473 * var_chaste_interface__membrane_potential__V) + var_chaste_interface__intracellular_potassium_concentration__K_i) * mParameters[2] * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x; // nanoA
        const double d_dt_chaste_interface_var_time_dependent_rectifier_potassium_current_x_gate__x = 00050000000000000001 * (1.0 - var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x) * exp(4.1300000000000008 + 082600000000000007 * var_chaste_interface__membrane_potential__V) / (1.0 + exp(2.8500000000000001 + 057000000000000002 * var_chaste_interface__membrane_potential__V)) - 0013000000000000002 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x * exp(-1.2 - 059999999999999998 * var_chaste_interface__membrane_potential__V) / (1.0 + exp(-0.80000000000000004 - 040000000000000001 * var_chaste_interface__membrane_potential__V)); // 1 / millisecond
        const double var_time_independent_potassium_current__i_K1 = 0.2857142857142857 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane_potential__V) / (1.0 + exp(-0.74867781645490938 + 074867781645490947 * var_chaste_interface__membrane_potential__V - 074867781645490947 * var_reversal_potentials__E_K)); // nanoA
        ...
        const double var_transient_outward_current__i_to = 0050000000000000001 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane_potential__V) * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // nanoA
        const double d_dt_chaste_interface_var_intracellular_potassium_concentration__K_i = 0012636269993948044 * var_sodium_potassium_pump__i_NaK - 00063181349969740222 * var_L_type_Ca_channel__i_Ca_L_K - 00063181349969740222 * var_potassium_background_current__i_b_K - 00063181349969740222 * var_time_dependent_rectifier_potassium_current__i_K - 00063181349969740222 * var_time_independent_potassium_current__i_K1 - 00063181349969740222 * var_transient_outward_current__i_to; // millimolar / millisecond
        const double d_dt_chaste_interface_var_transient_outward_current_s_gate__s = 3.3000000000000003e-5 * (1.0 - var_chaste_interface__transient_outward_current_s_gate__s) * exp(-058823529411764705 * var_chaste_interface__membrane_potential__V) - 033000000000000002 * var_chaste_interface__transient_outward_current_s_gate__s / (1.0 + exp(-1.25 - 0.125 * var_chaste_interface__membrane_potential__V)); // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_Force__N_0 = 040000000000000001 * var_chaste_interface__Force__P_0 + 040714285714285717 * var_Force__N_1 - 001 * var_chaste_interface__Force__N_0 * var_Force__alpha_tm; // 1 / millisecond
        const double d_dt_chaste_interface_var_Force__P_0 = 040714285714285717 * var_chaste_interface__Force__P_1 - 070000000000000007 * var_chaste_interface__Force__P_0 + 001 * var_chaste_interface__Force__N_0 * var_Force__alpha_tm; // 1 / millisecond
        const double d_dt_chaste_interface_var_Force__P_1 = 029999999999999999 * var_chaste_interface__Force__P_0 + 081428571428571433 * var_chaste_interface__Force__P_2 - 0.18071428571428572 * var_chaste_interface__Force__P_1 + 001 * var_Force__N_1 * var_Force__alpha_tm; // 1 / millisecond
        const double d_dt_chaste_interface_var_troponin__Trpn_Ca = 80 * (070000000000000007 - var_chaste_interface__troponin__Trpn_Ca) * var_chaste_interface__intracellular_calcium_concentration__Ca_i - 066666666666666666 * (3.0 - 2.0 * var_Force__Force_norm) * var_chaste_interface__troponin__Trpn_Ca; // millimolar / millisecond
        const double d_dt_chaste_interface_var_intracellular_calcium_concentration__Ca_i = 00063181349969740222 * var_sodium_calcium_exchanger__i_NaCa + 0.5 * var_chaste_interface__calmodulin__Cmdn_Ca + 00020407827359180688 * var_RyR__j_rel - 001 * var_SERCA__j_up - 00031590674984870111 * var_L_type_Ca_channel__i_Ca_L_Ca - 00031590674984870111 * var_calcium_background_current__i_b_Ca + 066666666666666666 * (3.0 - 2.0 * var_Force__Force_norm) * var_chaste_interface__troponin__Trpn_Ca - 10 * (02 - var_chaste_interface__calmodulin__Cmdn_Ca) * var_chaste_interface__intracellular_calcium_concentration__Ca_i - 80 * (070000000000000007 - var_chaste_interface__troponin__Trpn_Ca) * var_chaste_interface__intracellular_calcium_concentration__Ca_i; // millimolar / millisecond
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x0 = 074867781645490947 * var_chaste_interface__membrane_potential__V;
            ...
            const double var_x7 = 018716945411372737 * var_chaste_interface__membrane_potential__V;
            ...
            const double var_x13 = var_x12 * (037433890822745473 * var_x9 + 51359.298208806787 * var_x11);
            ...
            const double var_x16 = -037433890822745473 * var_chaste_interface__membrane_potential__V;
            ...
            const double var_x22 = exp(-0037433890822745472 * var_chaste_interface__membrane_potential__V);
            const double var_x23 = 1.0 + 035299999999999998 * var_x17 + 0.1245 * var_x22;
            const double var_x24 = var_x21 * (001321416346042915 * var_x17 + 00046605194074318115 * var_x22) * var_chaste_interface__intracellular_sodium_concentration__Na_i / pow(var_x23, 2);
            ...
            const double var_x41 = -140 * var_x34 + var_x38 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
            const double var_x42 = 00037433890822745472 * var_x41;
            const double var_x43 = -50 + var_chaste_interface__membrane_potential__V;
            ...
            const double var_x54 = 001 * var_x53;
            
            partialF = -var_x54 * (0014499999999999999 + var_x13 + var_x15 + 1.0880000000000001 * var_x24 + 0050000000000000001 * var_x6 + 022420738914067644 * var_x46 + 0010695397377927277 * var_x19 + 0019730250244379527 * var_x48 + 0.2857142857142857 * var_x5 - 011210369457033822 * var_x49 - 2.8025923642584555e-6 * var_x51 - 021390794755854554 * var_x20 - 1.4012961821292276e-5 * var_x52 + var_x26 * var_x33 + var_x37 * var_x40 + var_x37 * var_x42);
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x57 = (2.0 * var_x9 - 2744000 * var_x11) * mParameters[6] / pow((0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
            const double var_x58 = var_x30 * var_x45;
            const double var_x79 = 10 * var_chaste_interface__calmodulin__Cmdn_Ca;
            const double var_x80 = 80 * var_chaste_interface__troponin__Trpn_Ca;
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x113 = exp(-3.6960000000000002 - 056000000000000001 * var_chaste_interface__membrane_potential__V);
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x125 = 02 * var_x124;
            const double var_x126 = exp(-7.5 + var_x118 + 0.10000000000000001 * mParameters[5]);
            const double var_x127 = 1 / (1.0 + 320 * var_x126);
            const double var_x128 = 2.0 * var_x127;
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x135 = exp(-0.80000000000000004 - 040000000000000001 * var_chaste_interface__membrane_potential__V);
            const double var_x136 = 1.0 + var_x135;
            const double var_x137 = exp(-1.2 - 059999999999999998 * var_chaste_interface__membrane_potential__V);
            const double var_x138 = var_x137 / var_x136;
            const double var_x140 = exp(2.8500000000000001 + 057000000000000002 * var_chaste_interface__membrane_potential__V);
            const double var_x141 = 1.0 + var_x140;
            const double var_x142 = exp(4.1300000000000008 + 082600000000000007 * var_chaste_interface__membrane_potential__V);
            const double var_x143 = var_x142 / var_x141;
            
            partialF = -00050000000000000001 * var_x143 - 0013000000000000002 * var_x138;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x123 = -0.125 * var_chaste_interface__membrane_potential__V;
            const double var_x144 = exp(-058823529411764705 * var_chaste_interface__membrane_potential__V);
            const double var_x145 = exp(-1.25 + var_x123);
            const double var_x146 = 1.0 + var_x145;
            
            partialF = -033000000000000002 / var_x146 - 3.3000000000000003e-5 * var_x144;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x152 = 036000000000000004 / var_x151;
            ...
            const double var_x158 = 089999999999999997 / var_x157;
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x167 = 0031250000000000002 / var_x166;
            const double var_x168 = -025000000000000001 / var_x160;
            
            partialF = ((var_x163) ? (-012500000000000001 + var_x168) : (var_x168 - var_x162 * var_x167));
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x43 = -50 + var_chaste_interface__membrane_potential__V;
            const double var_x81 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2);
            const double var_x169 = 1.8342606503145281e-5 * var_x39;
            const double var_x170 = var_x169 * var_x37;
            const double var_x171 = 03668521300629056 * var_x32;
            const double var_x172 = var_x171 * var_x26;
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x102 = 10 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x103 = 80 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            const double var_x104 = 080480480480480482 * var_chaste_interface__Force__N_0;
            const double var_x105 = 080480480480480482 * var_chaste_interface__Force__P_0;
            const double var_x106 = 080480480480480482 * var_chaste_interface__Force__P_2;
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x202 - 001424696263447196 * var_x108 - 1.2089003260906828e-17 * var_x109;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x71 = var_x69 * var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 046082949308755762 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
            const double var_x72 = var_x12 * var_x8 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2);
            const double var_x73 = var_x15 * (00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) / pow(var_x59, 2);
            const double var_x74 = var_x38 * var_x47;
            
            partialF = 4.3794501115171722e-6 * var_x71 - 011372642994553239 * var_x72 - 2.371037540761344 * var_x73 - 1.0126868767488654e-5 * var_x68 - 2.3651237568009284e-7 * var_x74 - 0020622392630123211 * var_x70;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 00036103628554137268 * var_x77 - 4.7302475136018567e-8 * var_x74 - 4.5129535692671587e-6 * var_x18 - 1.0126868767488654e-5 * var_x1 - 8.4390573062405468e-5 * var_x76 - 0048223184607088833 * var_x75;
        }
        else
        {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -040714285714285717 + var_x210;
        }
        else
        {
    ...
    std::vector<double> Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        ...
        const double var_cell_parameters__Na_o = 140; // millimolar
        const double var_cell_parameters__R = 8314.4719999999998; // millijoule_per_mole_kelvin
        const double var_cell_parameters__T = 310; // kelvin
        const double var_L_type_Ca_channel__i_Ca_L_Ca = 4.0 * (-50 + var_chaste_interface__membrane_potential__V) * (var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(100 * var_cell_parameters__F / (var_cell_parameters__R * var_cell_parameters__T)) - var_cell_parameters__Ca_o * exp(-2.0 * (-50 + var_chaste_interface__membrane_potential__V) * var_cell_parameters__F / (var_cell_parameters__R * var_cell_parameters__T))) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_cell_parameters__F / ((1.0 - exp(-2.0 * (-50 + var_chaste_interface__membrane_potential__V) * var_cell_parameters__F / (var_cell_parameters__R * var_cell_parameters__T))) * var_cell_parameters__R * var_cell_parameters__T); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_K = 002 * (-50 + var_chaste_interface__membrane_potential__V) * (var_chaste_interface__intracellular_potassium_concentration__K_i * exp(50 * var_cell_parameters__F / (var_cell_parameters__R * var_cell_parameters__T)) - var_cell_parameters__K_o * exp((50 - var_chaste_interface__membrane_potential__V) * var_cell_parameters__F / (var_cell_parameters__R * var_cell_parameters__T))) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_cell_parameters__F / ((1.0 - exp((50 - var_chaste_interface__membrane_potential__V) * var_cell_parameters__F / (var_cell_parameters__R * var_cell_parameters__T))) * var_cell_parameters__R * var_cell_parameters__T); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_Na = 01 * (-50 + var_chaste_interface__membrane_potential__V) * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(50 * var_cell_parameters__F / (var_cell_parameters__R * var_cell_parameters__T)) - var_cell_parameters__Na_o * exp((50 - var_chaste_interface__membrane_potential__V) * var_cell_parameters__F / (var_cell_parameters__R * var_cell_parameters__T))) * mParameters[0] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_cell_parameters__F / ((1.0 - exp((50 - var_chaste_interface__membrane_potential__V) * var_cell_parameters__F / (var_cell_parameters__R * var_cell_parameters__T))) * var_cell_parameters__R * var_cell_parameters__T); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L = var_L_type_Ca_channel__i_Ca_L_Ca + var_L_type_Ca_channel__i_Ca_L_K + var_L_type_Ca_channel__i_Ca_L_Na; // nanoA
...
void OdeSystemInformation<Celliribe_model_2006_without_otherwise_sectionFromCellMLGRL1>::Initialise(void)
{
    ...
    this->mInitialConditions.push_back(0013809);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(051127);
    ...
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(00027661);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(00013331);

    // rY[21]:
    this->mVariableNames.push_back("Force__P_2");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(00023505);

    // rY[22]:
    this->mVariableNames.push_back("Force__P_3");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(00015349);
