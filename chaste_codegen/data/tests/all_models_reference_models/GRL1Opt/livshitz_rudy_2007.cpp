...
#include "MathsCustomFunctions.hpp"
    ...
    void Celllivshitz_rudy_2007FromCellMLGRL1::UpdateTransmembranePotential(double var_chaste_interface__Environment__time)
    {
        ...
        const double var_Ca__Ca_i = -040960000000000003 + 0.33333333333333331 * var_chaste_interface__Ca__Ca_T + 0.66666666666666663 * sqrt(-00057837000000000014 + pow((0.12288 - var_chaste_interface__Ca__Ca_T), 2) + 0086400000000000001 * var_chaste_interface__Ca__Ca_T) * cos(0.33333333333333331 * acos(0.5 * pow((-00057837000000000014 + pow((0.12288 - var_chaste_interface__Ca__Ca_T), 2) + 0086400000000000001 * var_chaste_interface__Ca__Ca_T), (-1.5)) * (3.2130000000000006e-5 * var_chaste_interface__Ca__Ca_T - 2.0 * pow((0.12288 - var_chaste_interface__Ca__Ca_T), 3) + 9.0 * (0.12288 - var_chaste_interface__Ca__Ca_T) * (00019279000000000003 - 0028800000000000002 * var_chaste_interface__Ca__Ca_T)))); // mM
        const double var_ICaL__fca = 1.0 / (1.0 + 1666.6666666666667 * var_Ca__Ca_i); // dimensionless
        const double var_ICaL__ilca = 7.8019226357407252 * (-0.61380000000000001 + 1.0 * var_Ca__Ca_i * exp(074871767015605231 * var_chaste_interface__cell__V)) * mParameters[0] * var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_chaste_interface__cell__V / (-1.0 + exp(074871767015605231 * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_INaCa__inaca = 00025000000000000001 * (-2744000 * var_Ca__Ca_i + 1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(037435883507802616 * var_chaste_interface__cell__V)) * exp(-031820500981632228 * var_chaste_interface__cell__V) / (1.0 + 0001 * (2744000 * var_Ca__Ca_i + 1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(037435883507802616 * var_chaste_interface__cell__V)) * exp(-031820500981632228 * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_INaK__inak = 1.6875 / ((1.0 + 100 / pow(var_chaste_interface__Na__Na_i, 2)) * (1.0 + 0.1245 * exp(-003743588350780262 * var_chaste_interface__cell__V) + 036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-037435883507802616 * var_chaste_interface__cell__V))); // uA_per_uF
    ...
    void Celllivshitz_rudy_2007FromCellMLGRL1::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        ...
        const double var_ICaL__fca = 1.0 / (1.0 + 1666.6666666666667 * var_Ca__Ca_i); // dimensionless
        const double var_Irel__Ca_JSR_free = -5.4000000000000004 + 0.5 * var_chaste_interface__Ca__Ca_JSR_T + 5.4000000000000004 * sqrt(pow((1 - 092592592592592587 * var_chaste_interface__Ca__Ca_JSR_T), 2) + 027434842249657067 * var_chaste_interface__Ca__Ca_JSR_T); // mM
        const double var_Itr__itr = 0083333333333333332 * var_chaste_interface__Ca__Ca_NSR - 0083333333333333332 * var_Irel__Ca_JSR_free; // mM_per_ms
        const double d_dt_chaste_interface_var_Ca__Ca_JSR_T = -var_chaste_interface__Irel__Rel + var_Itr__itr; // mM / ms
        const double var_Iup_Ileak__iup = 0087500000000000008 * var_Ca__Ca_i / (00092000000000000003 + var_Ca__Ca_i); // mM_per_ms
        const double var_Iup_Ileak__ileak = 00058333333333333338 * var_chaste_interface__Ca__Ca_NSR; // mM_per_ms
        ...
        const double var_ICaL__ilca = 7.8019226357407252 * (-0.61380000000000001 + 1.0 * var_Ca__Ca_i * exp(074871767015605231 * var_chaste_interface__cell__V)) * mParameters[0] * var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_chaste_interface__cell__V / (-1.0 + exp(074871767015605231 * var_chaste_interface__cell__V)); // uA_per_uF
        const double d_dt_chaste_interface_var_ICaL__d = 035000000000000003 * (10 + var_chaste_interface__cell__V) * (-var_chaste_interface__ICaL__d + 1.0 * var_ICaL__dss0 / (1.0 + exp(-2500 - 41.666666666666664 * var_chaste_interface__cell__V))) / ((1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__cell__V)) * var_ICaL__dss0); // 1 / ms
        const double d_dt_chaste_interface_var_ICaL__f = (02 + 019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__cell__V), 2))) * (-var_chaste_interface__ICaL__f + 1.0 / (1.0 + exp(4.0 + 0.125 * var_chaste_interface__cell__V)) + 0.59999999999999998 / (1.0 + exp(2.5 - 050000000000000003 * var_chaste_interface__cell__V))); // 1 / ms
        const double d_dt_chaste_interface_var_ICaT__b = (-var_chaste_interface__ICaT__b + 1.0 / (1.0 + exp(-1.2962962962962963 - 092592592592592587 * var_chaste_interface__cell__V))) / (3.7000000000000002 + 6.0999999999999996 / (1.0 + exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__cell__V))); // 1 / ms
        ...
        const double d_dt_chaste_interface_var_IKr__xr = (-var_chaste_interface__IKr__xr + 1.0 / (1.0 + exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__cell__V))) * (00060999999999999997 * (38.899999999999999 + var_chaste_interface__cell__V) / (-1.0 + exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__cell__V)) + 0013799999999999999 * (14.199999999999999 + var_chaste_interface__cell__V) / (1.0 - exp(-1.7465999999999999 - 0.123 * var_chaste_interface__cell__V))); // 1 / ms
        ...
        const double d_dt_chaste_interface_var_INa__H = -((3.5600000000000001 * exp(079000000000000001 * var_chaste_interface__cell__V) + 310000 * exp(0.34999999999999998 * var_chaste_interface__cell__V)) * var_INa__a + 7.6923076923076916 * (1.0 - var_INa__a) / (1.0 + exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__cell__V))) * var_chaste_interface__INa__H + 0.13500000000000001 * (1.0 - var_chaste_interface__INa__H) * var_INa__a * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V); // 1 / ms
        const double d_dt_chaste_interface_var_INa__J = -(0.1212 * var_INa__a * exp(-01052 * var_chaste_interface__cell__V) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V)) + 0.29999999999999999 * (1.0 - var_INa__a) * exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V) / (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__cell__V))) * var_chaste_interface__INa__J + 1.0 * (1.0 - var_chaste_interface__INa__J) * (37.780000000000001 + var_chaste_interface__cell__V) * (-127140 * exp(0.24440000000000001 * var_chaste_interface__cell__V) - 3.4740000000000003e-5 * exp(-043909999999999998 * var_chaste_interface__cell__V)) * var_INa__a / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)); // 1 / ms
        ...
        const double var_INaCa__inaca = 00025000000000000001 * (-2744000 * var_Ca__Ca_i + 1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(037435883507802616 * var_chaste_interface__cell__V)) * exp(-031820500981632228 * var_chaste_interface__cell__V) / (1.0 + 0001 * (2744000 * var_Ca__Ca_i + 1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(037435883507802616 * var_chaste_interface__cell__V)) * exp(-031820500981632228 * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_INaK__inak = 1.6875 / ((1.0 + 100 / pow(var_chaste_interface__Na__Na_i, 2)) * (1.0 + 0.1245 * exp(-003743588350780262 * var_chaste_interface__cell__V) + 036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-037435883507802616 * var_chaste_interface__cell__V))); // uA_per_uF
        const double d_dt_chaste_interface_var_Irel__Rel = (0.21052631578947367 + 0025894736842105265 / var_Irel__Ca_JSR_free) * (-var_chaste_interface__Irel__Rel - 0.59375 * var_ICaL__ilca / (1.0 + 1.0 * pow(1 / var_Irel__Ca_JSR_free, 9.0))); // mM_per_ms / ms
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x4 = 050000000000000003 * var_x3;
            ...
            const double var_x13 = exp(-36.698642499999998 + 061749999999999999 * var_chaste_interface__cell__V - 1.6494869150645177 * var_x6);
            const double var_x14 = exp(0.43983232 + 080320000000000003 * var_chaste_interface__cell__V - 2.1455350448256207 * var_x6);
            ...
            const double var_x21 = -00057837000000000014 + var_x20 + 0086400000000000001 * var_chaste_interface__Ca__Ca_T;
            const double var_x22 = sqrt(var_x21);
            const double var_x23 = pow(var_x19, 3);
            const double var_x24 = var_x19 * (00019279000000000003 - 0028800000000000002 * var_chaste_interface__Ca__Ca_T);
            ...
            const double var_x31 = -040960000000000003 + var_x30;
            ...
            const double var_x41 = 037435883507802616 * var_chaste_interface__cell__V;
            ...
            const double var_x47 = exp(-031820500981632228 * var_chaste_interface__cell__V);
            const double var_x48 = 1.0 + 0001 * var_x47 * (-112394.24000000001 + var_x39 + var_x44 + var_x45);
            ...
            const double var_x53 = exp(-003743588350780262 * var_chaste_interface__cell__V);
            const double var_x54 = exp(2.0802377414561666);
            const double var_x55 = exp(-var_x41);
            const double var_x56 = 1.0 + 0.1245 * var_x53 + 036499999999999998 * var_x55 * (-0.14285714285714285 + 0.14285714285714285 * var_x54);
            const double var_x57 = (00046607674967214262 * var_x53 + 037435883507802616 * var_x55 * (-0052142857142857138 + 0052142857142857138 * var_x54)) / (pow(var_x56, 2) * (1.0 + 100 * var_x52));
            const double var_x58 = exp(0.4017857142857143 + 044642857142857144 * var_chaste_interface__cell__V);
            ...
            const double var_x71 = 00025000000000000001 * var_x70;
            const double var_x72 = var_x47 * (031820500981632228 * var_x47 * (-11.239424000000001 + 182.93333333333334 * var_x29 + 00018000000000000001 * var_x43 + 91.466666666666669 * var_chaste_interface__Ca__Ca_T) - 6.7384590314044719e-6 * var_x43 * var_x47);
            const double var_x73 = var_x43 * var_x49;
            const double var_x74 = var_x10 * var_x15 / pow(var_x11, 2);
            const double var_x75 = 0.24326999999999999 * var_x67 - 0.51429999999999998 * var_x74 - var_x12 * (061749999999999999 * var_x13 + 039456396800000001 * var_x14);
            ...
            const double var_x82 = exp(074871767015605231 * var_chaste_interface__cell__V);
            ...
            const double var_x94 = 0024381008236689767 * var_x93;
            const double var_x95 = -3.375 + var_x92 * var_chaste_interface__K__K_i;
            const double var_x96 = 00069711623550831479 * var_x95;
            ...
            partialF = -0070159999999999997 + var_x38 - var_x66 + 2.6097162183887167e-5 * var_x99 + 0.16655558320535219 * var_x69 + 7.9551252454080567e-6 * var_x50 + 040753166481039146 * var_x78 + 9.1272458415149417e-5 * var_x103 - 1.6875 * var_x57 - 0055199999999999997 * var_x2 - 6.8454343811362063e-5 * var_x105 - 1.684614757851118e-5 * var_x73 - 1.9572871637915374e-5 * var_x107 - 0.69834626081908679 * var_x18 - 00092307692307692295 * var_x63 + var_x101 * var_x102 - var_x101 * var_x106 - var_x4 * var_chaste_interface__ICaT__g - var_x61 * var_chaste_interface__IKr__xr - var_x71 * var_x72 - var_x75 * var_x77 - var_x81 * var_x88 - var_x91 * var_x94 - var_x91 * var_x96;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x166 = exp(079000000000000001 * var_chaste_interface__cell__V);
            const double var_x167 = exp(0.34999999999999998 * var_chaste_interface__cell__V);
            const double var_x168 = 3.5600000000000001 * var_x166 + 310000 * var_x167;
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x181 = exp(-090909090909090912 * var_chaste_interface__cell__V);
            const double var_x182 = 47.130000000000003 + var_chaste_interface__cell__V;
            
            partialF = -080000000000000002 * var_x181 - var_x180 * var_x182;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x190 = exp(-01052 * var_chaste_interface__cell__V);
            ...
            const double var_x195 = exp(-043909999999999998 * var_chaste_interface__cell__V);
            const double var_x196 = -127140 * var_x194 - 3.4740000000000003e-5 * var_x195;
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x215 = 1.0 + 1.0 * var_x205;
            const double var_x216 = 035000000000000003 * var_x215;
            const double var_x217 = 10 + var_chaste_interface__cell__V;
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x220 = 019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__cell__V), 2));
            
            partialF = -02 - var_x220;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x240 = exp(2.0609999999999999 + 068699999999999997 * var_chaste_interface__cell__V);
            const double var_x241 = -1.0 + var_x240;
            const double var_x242 = 1 / var_x241;
            const double var_x243 = 00013100000000000001 * var_x242;
            ...
            const double var_x248 = 30 + var_chaste_interface__cell__V;
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative10(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x267 = 1 / (1.0 * var_x263 + 12.0 * var_x261);
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x268 = 092592592592592587 * var_chaste_interface__Ca__Ca_JSR_T;
            const double var_x269 = sqrt(pow((1 - var_x268), 2) + 027434842249657067 * var_chaste_interface__Ca__Ca_JSR_T);
            ...
            const double var_x272 = 0025894736842105265 * var_x271;
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x124 = 1 / (var_x40 * var_x56 * pow((01 + var_x52), 2));
            ...
            partialF = 2.4915900867359339e-11 * var_x130 - 2.4915900867359336e-7 * var_x126 - 6.2289752168398339e-6 * var_x124 - 6.5734516851508199e-6 * var_x108 - 001643362921287705 * var_x131 - 1.1249533042067289e-7 * var_x104;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x97 = var_x42 * var_chaste_interface__cell__V;
            const double var_x104 = var_x91 * var_x97;
            const double var_x119 = 018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i;
            const double var_x127 = (0.14151877954204523 * var_chaste_interface__K__K_i + 0025940392290056888 * var_chaste_interface__Na__Na_i) / pow(var_x119, 2);
            ...
            partialF = 188.75472776079184 * var_x293 + 000273711269773125 * var_x137 - 0015001782369281045 * var_x136 - 9.0713633255081308e-6 * var_x132 - 3.2165331512873877e-8 * var_x104 - 0011476363512500001 * var_x133 - var_x135 * var_x291;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x140 = var_x22 * (var_x26 * (-0048880296000000005 + 6.0 * var_x20 + 051840000000000004 * var_chaste_interface__Ca__Ca_T) + 0.5 * var_x25 * pow(var_x21, (-2.5)) * (0.35568000000000005 - 3.0 * var_chaste_interface__Ca__Ca_T)) * sin(var_x27) / sqrt(049382716049382713 - pow(var_x21, (-3.0)) * pow((var_x24 + 3.5700000000000001e-6 * var_chaste_interface__Ca__Ca_T - 0.22222222222222221 * var_x23), 2));
            const double var_x141 = 049382716049382713 * var_x140;
            const double var_x142 = 0.33333333333333331 + var_x139 + var_x141;
            const double var_x143 = var_x142 / (-040460000000000003 + var_x30);
            ...
            const double var_x146 = var_x145 / pow((-061440000000000002 + var_x144), 2);
            const double var_x147 = var_x146 * (-022755555555555557 + 0.37037037037037035 * var_x29 + 0.18518518518518517 * var_chaste_interface__Ca__Ca_T);
            ...
            const double var_x150 = var_x149 / pow((-060690000000000008 + var_x144), 2);
            ...
            const double var_x154 = var_x116 * (-555.55555555555566 - 1111.1111111111113 * var_x138 - 82.304526748971199 * var_x140) * var_chaste_interface__ICaL__f / pow((-060540000000000004 + var_x29 + 0.5 * var_chaste_interface__Ca__Ca_T), 2);
            ...
            const double var_x298 = var_x142 / (-040040000000000006 + var_x30);
            const double var_x299 = var_x149 / pow((-060060000000000002 + var_x144), 2);
            
            partialF = 8.319524789019007e-5 * var_x152 + 1.5380185720592182e-8 * var_x148 + 5.0183373527362646e-6 * var_x147 - 0015981617647058825 * var_x299 - 00023999003823076885 * var_x158 - 3.5374427157362017e-5 * var_x143 - 1.9439193096692272e-10 * var_x160 - 7.9592461104064537e-5 * var_x150 - 00071029411764705886 * var_x298 - var_x151 * var_x295;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x268 = 092592592592592587 * var_chaste_interface__Ca__Ca_JSR_T;
            const double var_x269 = sqrt(pow((1 - var_x268), 2) + 027434842249657067 * var_chaste_interface__Ca__Ca_JSR_T);
            const double var_x283 = (-078875171467764058 + 0085733882030178329 * var_chaste_interface__Ca__Ca_JSR_T) / var_x269;
            
            partialF = -0041666666666666666 - 044999999999999998 * var_x283;
        }
        else
        {
