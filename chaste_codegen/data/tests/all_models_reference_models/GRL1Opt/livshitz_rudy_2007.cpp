...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celllivshitz_rudy_2007FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
            ...
            const double var_x255 = 1 / (1.0 - exp(-9.9999999747524276e-8));
            const double var_x256 = 1 / (1.0 - exp(1.0000000045806701e-7));
            const double var_x257 = _lt_0_row[28];
            const double var_x259 = 47.130000000000003 + var_chaste_interface__cell__V;
            const double var_x260 = fabs(var_x259) < 1.0000000010279564e-6;
            ...
            const double var_x265 = 3.2000000146581445e-7 * var_x256;
            const double var_x266 = -0.080000000000000002 * var_x257;
            
            partialF = ((var_x260) ? (var_x265 + var_x266 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__cell__V) * (var_x265 + 3.1999999919207769e-7 * var_x255)) : (var_x266 - var_x259 * var_x264));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1Opt::EvaluatePartialDerivative4(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x302 = exp(1.0000000001853256e-7);
            const double var_x303 = (1.0 - var_x302) / (1.0 + var_x302);
            const double var_x304 = 45787545.779060178 * var_x303;
            const double var_x305 = exp(-1.0000000001853256e-7);
            const double var_x306 = (1.0 - var_x305) / (1.0 + var_x305);
            const double var_x307 = (10.000000624 + var_chaste_interface__cell__V) * (var_x304 + 45787545.779060178 * var_x306);
            const double var_x308 = 1 / (-var_x304 + 801282.05113355326 * var_x307);
            ...
            const double var_x318 = fabs(var_x317) < 6.2400000011564316e-7;
...
// LCOV_EXCL_STOP
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1Opt::EvaluatePartialDerivative6(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x333 = 1 / (-1.0 + exp(-9.9999999179090074e-8));
            const double var_x334 = 1 / (-1.0 + exp(1.0000000020937704e-7));
            ...
            const double var_x340 = 4.2068965605324136e-10 * var_x334;
            const double var_x341 = var_x337 * var_x338;
            const double var_x342 = -var_x340;
            const double var_x343 = 725000.00221680664 * (38.899999310344825 + var_chaste_interface__cell__V) * (var_x342 - 4.2068965171893065e-10 * var_x333);
            const double var_x345 = 38.899999999999999 + var_chaste_interface__cell__V;
            const double var_x346 = fabs(var_x345) < 6.8965517030505907e-7;
            const double var_x347 = 1 / (1.0 - exp(1.0000000000864873e-7));
            const double var_x348 = 1 / (1.0 - exp(-1.0000000000864873e-7));
            const double var_x349 = exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__cell__V);
            const double var_x350 = -1.0 + var_x349;
            const double var_x351 = 0.00060999999999999997 / var_x350;
            const double var_x353 = 1.1219512196092296e-9 * var_x347;
            const double var_x354 = var_x345 * var_x351;
            const double var_x355 = 614999.99994681031 * (14.200000813008129 + var_chaste_interface__cell__V) * (var_x353 + 1.1219512196092296e-9 * var_x348);
            const double var_x356 = fabs(var_x338) < 8.1300813015161566e-7;
            const double var_x357 = -var_x341;
            const double var_x358 = -var_x354;
            
            partialF = ((var_x346) ? (var_x342 + var_x343 + var_x357) : ((var_x356) ? (var_x353 + var_x358 - var_x355) : (var_x357 + var_x358)));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1Opt::EvaluatePartialDerivative7(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x367 = fabs(var_x366) < 1.4556040746072085e-6;
            ...
            const double var_x375 = 1.9068413377354434e-10 * var_x363;
            const double var_x376 = 1.0465793296425829e-10 * var_x364;
            const double var_x377 = ((var_x367) ? (-var_x375 - var_x376 + 343500.00025585521 * (30.000001455604075 + var_chaste_interface__cell__V) * (var_x375 + var_x376 + 1.9068413377354434e-10 * var_x362 + 1.0465793296425829e-10 * var_x365)) : (var_x366 * var_x370 + var_x366 * var_x373));
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celllivshitz_rudy_2007FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
            ...
            const double var_x176 = 4.8845531249999998e-9 * var_x175;
            const double var_x177 = var_x19 * var_x20;
            ...
            const double var_x185 = ((var_x83) ? (var_x184 + var_x31 * (var_x176 + var_x174 * (-var_x176 - 4.8845531249999998e-9 * var_x177))) : (var_x184 + 0.0018285756177517324 * var_x91));
...
// LCOV_EXCL_STOP
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1Opt::EvaluatePartialDerivative13(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x187 = 1.3966203749999998e-9 * var_x175;
            ...
            const double var_x190 = ((var_x83) ? (var_x189 + var_x31 * (var_x187 + var_x174 * (-var_x187 - 1.3966203749999998e-9 * var_x177))) : (var_x189 + 0.00052283717663123607 * var_x91));
            const double var_x407 = 6.1520742882368733e-5 * mParameters[3];
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celllivshitz_rudy_2007FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
            ...
            const double var_x156 = var_x155 * var_x18;
            const double var_x157 = var_x156 - 374358.83507802623 * (-1.3356169352749131e-6 + var_chaste_interface__cell__V) * (-var_x156 - var_x155 * var_x21);
            ...
            const double var_x197 = var_x175 * var_x196;
            ...
            const double var_x205 = ((var_x33) ? (var_x157 * var_x203 + var_x31 * (var_x197 + (0.5 - 374358.83507802623 * var_chaste_interface__cell__V) * (-var_x197 - var_x177 * var_x196))) : (0.011702883953611085 * var_x159 * var_x204 * var_x41 + 14448.004881001343 * var_x195 * var_x34 * var_x44));
