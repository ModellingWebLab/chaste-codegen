...
#include "MathsCustomFunctions.hpp"
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_cell__caiont = 0.003016 * var_chaste_interface__cell__V - 2.0 * var_INaCa__inaca + 1.1499999999999999 * var_Ca__Ca_i / (0.00050000000000000001 + var_Ca__Ca_i) - 0.040282206767891383 * log(10) * log10(1.8 / var_Ca__Ca_i) + 0.050000000000000003 * pow(var_chaste_interface__ICaT__b, 2) * (-13.356169352749133 * log(10) * log10(1.8 / var_Ca__Ca_i) + var_chaste_interface__cell__V) * var_chaste_interface__ICaT__g + 7.8019226357407252 * (-0.61380000000000001 + 1.0 * var_Ca__Ca_i * exp(0.074871767015605231 * var_chaste_interface__cell__V)) * mParameters[0] * var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_chaste_interface__cell__V / (-1.0 + exp(0.074871767015605231 * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_reversal_potentials__EK = 26.712338705498265 * log(10) * log10(4.5 / var_chaste_interface__K__K_i); // mV
        const double var_reversal_potentials__ENa = 26.712338705498265 * log(10) * log10(140.0 / var_chaste_interface__Na__Na_i); // mV
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x7 = var_x5 * log10(4.5 * var_x6);
            const double var_x8 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 6.3708927812613361 * var_x7);
            const double var_x9 = 1.0 + var_x8;
            const double var_x10 = 1 / var_x9;
            const double var_x11 = exp(-2.4444678999999998 + 13.738155796237757 * var_x7 - 0.51429999999999998 * var_chaste_interface__cell__V);
            const double var_x12 = 1.0 + var_x11;
            const double var_x13 = 1 / var_x12;
            const double var_x14 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 2.1455350448256207 * var_x7);
            const double var_x15 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150645177 * var_x7);
            ...
            const double var_x20 = 0.12288 - var_chaste_interface__Ca__Ca_T;
            const double var_x21 = pow(var_x20, 2);
            const double var_x22 = -0.00057837000000000014 + var_x21 + 0.0086400000000000001 * var_chaste_interface__Ca__Ca_T;
            const double var_x23 = sqrt(var_x22);
            const double var_x24 = pow(var_x20, 3);
            const double var_x25 = var_x20 * (0.00019279000000000003 - 0.0028800000000000002 * var_chaste_interface__Ca__Ca_T);
            const double var_x26 = 9.0 * var_x25 + 3.2130000000000006e-5 * var_chaste_interface__Ca__Ca_T - 2.0 * var_x24;
            const double var_x27 = 0.5 * pow(var_x22, (-1.5));
            const double var_x28 = 0.33333333333333331 * acos(var_x26 * var_x27);
            const double var_x29 = cos(var_x28);
            const double var_x30 = var_x23 * var_x29;
            const double var_x31 = 0.66666666666666663 * var_x30 + 0.33333333333333331 * var_chaste_interface__Ca__Ca_T;
            const double var_x32 = -0.040960000000000003 + var_x31;
            const double var_x33 = 1 / var_x32;
            const double var_x34 = pow(var_x33, 1.3999999999999999);
            const double var_x35 = 1.0 + 6.4818210260626455e-7 * var_x34;
            const double var_x36 = 1 / var_x35;
            const double var_x37 = -0.433 - 0.25979999999999998 * var_x36;
            const double var_x38 = var_x37 * var_chaste_interface__IKs__xs2;
            const double var_x39 = var_x38 * var_chaste_interface__IKs__xs1;
            const double var_x40 = 914666.66666666663 * var_chaste_interface__Ca__Ca_T;
            const double var_x41 = pow(var_chaste_interface__Na__Na_i, 3);
            const double var_x42 = 0.037435883507802616 * var_chaste_interface__cell__V;
            const double var_x43 = exp(var_x42);
            const double var_x44 = var_x41 * var_x43;
            const double var_x45 = 1.8 * var_x44;
            const double var_x46 = 1829333.3333333333 * var_x30;
            const double var_x47 = 112394.24000000001 + var_x45 - var_x40 - var_x46;
            const double var_x48 = exp(-0.031820500981632228 * var_chaste_interface__cell__V);
            const double var_x49 = 1.0 + 0.0001 * var_x48 * (-112394.24000000001 + var_x40 + var_x45 + var_x46);
            ...
            const double var_x54 = exp(-0.003743588350780262 * var_chaste_interface__cell__V);
            const double var_x55 = exp(2.0802377414561666);
            const double var_x56 = exp(-var_x42);
            const double var_x57 = 1.0 + 0.1245 * var_x54 + 0.036499999999999998 * var_x56 * (-0.14285714285714285 + 0.14285714285714285 * var_x55);
            const double var_x58 = (0.00046607674967214262 * var_x54 + 0.037435883507802616 * var_x56 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x55)) / (pow(var_x57, 2) * (1.0 + 100.0 * var_x53));
            const double var_x59 = exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__cell__V);
            const double var_x60 = 1.0 + var_x59;
            const double var_x61 = mParameters[2] / var_x60;
            const double var_x62 = 0.91287092917527679 * var_x61;
            const double var_x63 = -26.712338705498265 * var_x7 + var_chaste_interface__cell__V;
            const double var_x64 = var_x0 * var_x63 / pow(var_x1, 2);
            const double var_x65 = pow(var_chaste_interface__INa__m, 3);
            const double var_x66 = var_x65 * mParameters[1] * var_chaste_interface__INa__J;
            const double var_x67 = var_x66 * var_chaste_interface__INa__H;
            const double var_x68 = var_x8 / pow(var_x9, 2);
            const double var_x69 = var_x18 * var_x63;
            const double var_x70 = var_x68 * var_x69;
            const double var_x71 = var_x47 / pow(var_x49, 2);
            const double var_x72 = 0.00025000000000000001 * var_x71;
            const double var_x73 = var_x48 * (0.031820500981632228 * var_x48 * (-11.239424000000001 + 182.93333333333334 * var_x30 + 0.00018000000000000001 * var_x44 + 91.466666666666669 * var_chaste_interface__Ca__Ca_T) - 6.7384590314044719e-6 * var_x44 * var_x48);
            const double var_x74 = var_x44 * var_x50;
            const double var_x75 = var_x11 * var_x16 / pow(var_x12, 2);
            const double var_x76 = 0.24326999999999999 * var_x68 - 0.51429999999999998 * var_x75 - var_x13 * (0.061749999999999999 * var_x15 + 0.039456396800000001 * var_x14);
            const double var_x77 = var_x10 * var_x63 / pow((var_x10 + 0.98039215686274506 * var_x17), 2);
            const double var_x78 = 0.67122862439358588 * var_x77;
            const double var_x79 = var_x59 * var_x63 * mParameters[2] * var_chaste_interface__IKr__xr / pow(var_x60, 2);
            const double var_x80 = 1 / (-67.26666666666668 + 555.55555555555566 * var_chaste_interface__Ca__Ca_T + 1111.1111111111113 * var_x30);
            const double var_x81 = var_x80 * mParameters[0] * var_chaste_interface__ICaL__f;
            const double var_x82 = var_x81 * var_chaste_interface__ICaL__d;
            const double var_x83 = exp(0.074871767015605231 * var_chaste_interface__cell__V);
            const double var_x84 = -1.0 + var_x83;
            const double var_x85 = 1 / var_x84;
            const double var_x86 = var_x32 * var_x83;
            const double var_x87 = -0.61380000000000001 + 1.0 * var_x86;
            const double var_x88 = var_x85 * var_x87;
            const double var_x89 = 7.8019226357407252 * var_x88;
            const double var_x90 = -1.0 + var_x43;
            const double var_x91 = 1 / var_x90;
            const double var_x92 = var_x82 * var_x91;
            const double var_x93 = 0.75 * var_x43;
            const double var_x94 = -105.0 + var_x93 * var_chaste_interface__Na__Na_i;
            const double var_x95 = 0.0024381008236689767 * var_x94;
            const double var_x96 = -3.375 + var_x93 * var_chaste_interface__K__K_i;
            const double var_x97 = 0.00069711623550831479 * var_x96;
            const double var_x98 = var_x43 * var_chaste_interface__cell__V;
            const double var_x99 = var_x82 * var_x98 / pow(var_x90, 2);
            const double var_x100 = var_x96 * var_x99;
            const double var_x101 = var_x82 * var_chaste_interface__cell__V;
            const double var_x102 = 0.58414373385695628 * var_x101;
            const double var_x103 = var_x83 * var_x87 / pow(var_x84, 2);
            const double var_x104 = var_x94 * var_x99;
            const double var_x105 = var_x92 * var_x98;
            const double var_x106 = var_x105 * var_chaste_interface__Na__Na_i;
            const double var_x107 = var_x85 * var_x86;
            const double var_x108 = var_x105 * var_chaste_interface__K__K_i;
            
            partialF = -0.0070159999999999997 + var_x39 - var_x67 + 2.6097162183887167e-5 * var_x100 + 0.16655558320535219 * var_x70 + 7.9551252454080567e-6 * var_x51 + 0.040753166481039146 * var_x79 + 9.1272458415149417e-5 * var_x104 - 1.6875 * var_x58 - 0.0055199999999999997 * var_x2 - 6.8454343811362063e-5 * var_x106 - 1.684614757851118e-5 * var_x74 - 1.9572871637915374e-5 * var_x108 - 0.69834626081908679 * var_x19 - 0.00092307692307692295 * var_x64 + var_x102 * var_x103 - var_x102 * var_x107 - var_x4 * var_chaste_interface__ICaT__g - var_x62 * var_chaste_interface__IKr__xr - var_x72 * var_x73 - var_x76 * var_x78 - var_x82 * var_x89 - var_x92 * var_x95 - var_x92 * var_x97;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x193 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V);
            const double var_x194 = 1.0 + var_x193;
            const double var_x195 = 1 / var_x194;
            const double var_x196 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
            const double var_x197 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
            const double var_x198 = -127140.0 * var_x196 - 3.4740000000000003e-5 * var_x197;
            const double var_x199 = var_x164 * var_x195 * var_x198;
            const double var_x200 = 37.780000000000001 + var_chaste_interface__cell__V;
            
            partialF = -0.1212 * var_x191 - 0.29999999999999999 * var_x186 - var_x199 * var_x200;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x216 = 0.019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__cell__V), 2));
            
            partialF = -0.02 - var_x216;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x223 = exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__cell__V);
            const double var_x224 = -1.0 + var_x223;
            const double var_x225 = 0.00060999999999999997 / var_x224;
            const double var_x226 = exp(-1.7465999999999999 - 0.123 * var_chaste_interface__cell__V);
            const double var_x227 = 1.0 - var_x226;
            const double var_x228 = 0.0013799999999999999 / var_x227;
            const double var_x229 = 14.199999999999999 + var_chaste_interface__cell__V;
            const double var_x230 = 38.899999999999999 + var_chaste_interface__cell__V;
            const double var_x231 = var_x225 * var_x230;
            const double var_x232 = var_x228 * var_x229;
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x236 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V);
            const double var_x237 = -1.0 + var_x236;
            const double var_x238 = 1 / var_x237;
            const double var_x239 = 0.00013100000000000001 * var_x238;
            const double var_x240 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V);
            const double var_x241 = 1.0 - var_x240;
            const double var_x242 = 1 / var_x241;
            const double var_x243 = 7.1899999999999999e-5 * var_x242;
            const double var_x244 = 30.0 + var_chaste_interface__cell__V;
            const double var_x246 = var_x239 * var_x244;
            const double var_x247 = var_x243 * var_x244;
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -3.2750000000000003e-5 * var_x238 * var_x244 - 1.7975e-5 * var_x242 * var_x244;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative9(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x251 = exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__cell__V);
            const double var_x252 = 1.0 + var_x251;
            const double var_x253 = 1 / var_x252;
            const double var_x254 = 1 / (3.7000000000000002 + 6.0999999999999996 * var_x253);
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative10(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x255 = exp(-416.66666666666669 * var_chaste_interface__cell__V);
            const double var_x256 = 1.0 + var_x255;
            const double var_x257 = 1 / var_x256;
            const double var_x258 = 12.0 - 0.875 * var_chaste_interface__cell__V;
            const double var_x259 = var_x258 * (1.0 - 1.0 * var_x257);
            const double var_x263 = 1 / (var_x259 + 12.0 * var_x257);
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x264 = 0.092592592592592587 * var_chaste_interface__Ca__Ca_JSR_T;
            const double var_x265 = sqrt(pow((1 - var_x264), 2) + 0.027434842249657067 * var_chaste_interface__Ca__Ca_JSR_T);
            const double var_x266 = -5.4000000000000004 + 0.5 * var_chaste_interface__Ca__Ca_JSR_T + 5.4000000000000004 * var_x265;
            const double var_x267 = 1 / var_x266;
            const double var_x268 = 0.0025894736842105265 * var_x267;
            
            partialF = -0.21052631578947367 - var_x268;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x98 = var_x43 * var_chaste_interface__cell__V;
            const double var_x105 = var_x92 * var_x98;
            const double var_x109 = 1 / var_chaste_interface__Na__Na_i;
            const double var_x126 = 1 / (var_x41 * var_x57 * pow((0.01 + var_x53), 2));
            const double var_x128 = var_x43 * var_x52;
            const double var_x129 = var_x128 * var_x50;
            const double var_x130 = pow(var_x48, 2);
            const double var_x131 = var_x128 * var_x130 * var_x71;
            const double var_x132 = var_x109 * var_x67;
            
            partialF = 2.4915900867359339e-11 * var_x131 - 2.4915900867359336e-7 * var_x129 - 6.2289752168398339e-6 * var_x126 - 6.5734516851508199e-6 * var_x109 - 0.001643362921287705 * var_x132 - 1.1249533042067289e-7 * var_x105;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x98 = var_x43 * var_chaste_interface__cell__V;
            const double var_x105 = var_x92 * var_x98;
            const double var_x121 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
            const double var_x133 = var_x2 * var_x6;
            const double var_x134 = var_x19 * var_x6;
            const double var_x135 = var_x6 * var_x68;
            const double var_x136 = 6.4983106368865622 * var_x135 - var_x13 * (1.053972635420138 * var_x14 * var_x6 + 1.6494869150645177 * var_x15 * var_x6) - 13.738155796237757 * var_x6 * var_x75;
            const double var_x137 = var_x6 * var_x61 * var_chaste_interface__IKr__xr;
            const double var_x138 = var_x135 * var_x69;
            const double var_x283 = -2.663848166806566e-5 - 1.5983089000839395e-5 * var_x36;
            const double var_x284 = var_x283 * var_chaste_interface__IKs__xs2;
            const double var_x285 = var_x284 * var_chaste_interface__IKs__xs1;
            const double var_x287 = 4.129448361660385e-5 * var_x77;
            const double var_x289 = var_x121 * var_x285;
            
            partialF = 0.000273711269773125 * var_x138 + 26.712338705498265 * var_x289 - 0.0015001782369281045 * var_x137 - 9.0713633255081308e-6 * var_x133 - 3.2165331512873877e-8 * var_x105 - 0.0011476363512500001 * var_x134 - var_x136 * var_x287;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x88 = var_x85 * var_x87;
            const double var_x101 = var_x82 * var_chaste_interface__cell__V;
            const double var_x118 = mParameters[0] * var_chaste_interface__ICaL__d * var_chaste_interface__cell__V;
            const double var_x130 = pow(var_x48, 2);
            const double var_x139 = var_x29 * (-0.11856000000000001 + var_chaste_interface__Ca__Ca_T) / var_x23;
            const double var_x140 = 0.66666666666666663 * var_x139;
            const double var_x141 = var_x23 * (var_x27 * (-0.0048880296000000005 + 6.0 * var_x21 + 0.051840000000000004 * var_chaste_interface__Ca__Ca_T) + 0.5 * var_x26 * pow(var_x22, (-2.5)) * (0.35568000000000005 - 3.0 * var_chaste_interface__Ca__Ca_T)) * sin(var_x28) / sqrt(0.049382716049382713 - pow(var_x22, (-3.0)) * pow((var_x25 + 3.5700000000000001e-6 * var_chaste_interface__Ca__Ca_T - 0.22222222222222221 * var_x24), 2));
            const double var_x142 = 0.049382716049382713 * var_x141;
            const double var_x143 = 0.33333333333333331 + var_x140 + var_x142;
            const double var_x144 = var_x143 / (-0.040460000000000003 + var_x31);
            const double var_x145 = var_x30 + 0.5 * var_chaste_interface__Ca__Ca_T;
            const double var_x146 = var_x32 * (-0.33333333333333331 - var_x140 - var_x142);
            const double var_x147 = var_x146 / pow((-0.061440000000000002 + var_x145), 2);
            const double var_x148 = var_x50 * (-914666.66666666663 - 1829333.3333333333 * var_x139 - 135506.17283950618 * var_x141);
            const double var_x149 = var_x146 / pow((-0.060690000000000008 + var_x145), 2);
            const double var_x150 = var_x130 * (91.466666666666669 + 182.93333333333334 * var_x139 + 13.550617283950618 * var_x141);
            const double var_x151 = var_x147 * var_x3 * var_chaste_interface__ICaT__g;
            const double var_x153 = var_x118 * (-555.55555555555566 - 1111.1111111111113 * var_x139 - 82.304526748971199 * var_x141) * var_chaste_interface__ICaL__f / pow((-0.060540000000000004 + var_x30 + 0.5 * var_chaste_interface__Ca__Ca_T), 2);
            const double var_x156 = var_x143 * var_x83 * var_x85;
            const double var_x157 = var_x101 * var_x156;
            const double var_x159 = var_x153 * var_x88;
            const double var_x291 = 1.5380185720592182e-8 * var_x71;
            const double var_x294 = var_x143 / (-0.040040000000000006 + var_x31);
            const double var_x295 = var_x146 / pow((-0.060060000000000002 + var_x145), 2);
            
            partialF = 2.7879651959645917e-6 * var_x147 + 4.6219582161216707e-5 * var_x151 + 1.5380185720592182e-8 * var_x148 - 0.0015981617647058825 * var_x295 - 0.00023999003823076885 * var_x157 - 3.5374427157362017e-5 * var_x144 - 1.9439193096692272e-10 * var_x159 - 7.9592461104064537e-5 * var_x149 - 0.00071029411764705886 * var_x294 - var_x150 * var_x291;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x264 = 0.092592592592592587 * var_chaste_interface__Ca__Ca_JSR_T;
            const double var_x265 = sqrt(pow((1 - var_x264), 2) + 0.027434842249657067 * var_chaste_interface__Ca__Ca_JSR_T);
            const double var_x279 = (-0.078875171467764058 + 0.0085733882030178329 * var_chaste_interface__Ca__Ca_JSR_T) / var_x265;
            
            partialF = -0.0041666666666666666 - 0.044999999999999998 * var_x279;
        }
        else
        {
