...
class CellShannon2004FromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellShannon2004FromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellShannon2004FromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = CellShannon2004FromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellShannon2004FromCellMLCvodeOpt_LookupTables()
    {
...
protected:
    CellShannon2004FromCellMLCvodeOpt_LookupTables(const CellShannon2004FromCellMLCvodeOpt_LookupTables&);
    CellShannon2004FromCellMLCvodeOpt_LookupTables& operator= (const CellShannon2004FromCellMLCvodeOpt_LookupTables&);
    CellShannon2004FromCellMLCvodeOpt_LookupTables()
    {
        ...
        CellShannon2004FromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellShannon2004FromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellShannon2004FromCellMLCvodeOpt_LookupTables> CellShannon2004FromCellMLCvodeOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* CellShannon2004FromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return CellShannon2004FromCellMLCvodeOpt_LookupTables::Instance();
    }
    ...
    double CellShannon2004FromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellShannon2004FromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellShannon2004FromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
        ...
        const double var_IKr__i_Kr_converted = 0.43033148291193518 * _lt_0_row[10] * sqrt(NV_Ith_S(mParameters, 5)) * (-var_reversal_potentials__E_K + var_chaste_interface__cell__V) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 9) * var_chaste_interface__IKr_Xr_gate__Xr; // uA_per_cm2
