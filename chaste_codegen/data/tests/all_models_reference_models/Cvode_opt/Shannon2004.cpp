...
// LCOV_EXCL_STOP
        ...
        const double var_IKr__i_Kr_converted = 0.43033148291193518 * _lt_0_row[0] * sqrt(NV_Ith_S(mParameters, 8)) * (-var_reversal_potentials__E_K + var_chaste_interface__cell__V) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 19) * var_chaste_interface__IKr_Xr_gate__Xr; // uA_per_cm2
