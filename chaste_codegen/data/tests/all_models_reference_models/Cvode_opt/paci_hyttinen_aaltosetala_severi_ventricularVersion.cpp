...
private:
    ...
    static std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLCvodeOpt_LookupTables> Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLCvodeOpt_LookupTables::mpInstance;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_i_f__i_f_converted = (0.017000000000000001 + var_Membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 6) * var_chaste_interface__i_f_Xf_gate__Xf; // uA_per_cm2
        const double var_electric_potentials__E_K = 8.6173421482889202e-5 * NV_Ith_S(mParameters, 12) * log(NV_Ith_S(mParameters, 2) / NV_Ith_S(mParameters, 0)); // volt
        const double var_i_CaL__i_CaL_converted = 4478658957.2358274 * (-0.34100000000000003 * NV_Ith_S(mParameters, 1) + var_chaste_interface__calcium_dynamics__Cai * exp(23209.012310102189 * var_Membrane__Vm / NV_Ith_S(mParameters, 12))) * HeartConfig::Instance()->GetCapacitance() * var_Membrane__Vm * NV_Ith_S(mParameters, 4) * var_chaste_interface__i_CaL_d_gate__d * var_chaste_interface__i_CaL_f1_gate__f1 * var_chaste_interface__i_CaL_f2_gate__f2 * var_chaste_interface__i_CaL_fCa_gate__fCa / ((-1.0 + exp(23209.012310102189 * var_Membrane__Vm / NV_Ith_S(mParameters, 12))) * NV_Ith_S(mParameters, 12)); // uA_per_cm2
        const double var_i_K1__i_K1_converted = 1.6825960981856667 * sqrt(NV_Ith_S(mParameters, 2)) * (-var_electric_potentials__E_K + var_Membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 7) / ((1.0 + exp(-118.83999999999999 + 594.19999999999993 * var_Membrane__Vm - 594.19999999999993 * var_electric_potentials__E_K)) * (3.9100000000000001 / (1.0 + exp(-118.83999999999999 + 594.19999999999993 * var_Membrane__Vm - 594.19999999999993 * var_electric_potentials__E_K)) + (-1.5089999999999999 * exp(0.02 + 0.20000000000000001 * var_Membrane__Vm - 0.20000000000000001 * var_electric_potentials__E_K) + exp(-5.8860000000000001 + 588.60000000000002 * var_Membrane__Vm - 588.60000000000002 * var_electric_potentials__E_K)) / (1.0 + exp(454.69999999999999 * var_Membrane__Vm - 454.69999999999999 * var_electric_potentials__E_K)))); // uA_per_cm2
        const double var_i_Kr__i_Kr_converted = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 2)) * (-var_electric_potentials__E_K + var_Membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 8) * var_chaste_interface__i_Kr_Xr1_gate__Xr1 * var_chaste_interface__i_Kr_Xr2_gate__Xr2; // uA_per_cm2
        const double var_i_b_Ca__i_b_Ca = 0.69264000000000003 * var_Membrane__Vm - 2.9843579327954189e-5 * NV_Ith_S(mParameters, 12) * log(NV_Ith_S(mParameters, 1) / var_chaste_interface__calcium_dynamics__Cai); // A_per_F
        const double var_i_to__i_to_converted = (-var_electric_potentials__E_K + var_Membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 10) * var_chaste_interface__i_to_q_gate__q * var_chaste_interface__i_to_r_gate__r; // uA_per_cm2
        const double var_electric_potentials__E_Na = 8.6173421482889202e-5 * NV_Ith_S(mParameters, 12) * log(NV_Ith_S(mParameters, 3) / var_chaste_interface__sodium_dynamics__Nai); // volt
        const double var_i_Ks__i_Ks_converted = pow(var_chaste_interface__i_Ks_Xs_gate__Xs, 2) * (1.0 + 0.59999999999999998 / (1.0 + 6.4818210260626455e-7 * pow((1 / var_chaste_interface__calcium_dynamics__Cai), 1.3999999999999999))) * (-8.6173421482889202e-5 * NV_Ith_S(mParameters, 12) * log((0.029999999999999999 * NV_Ith_S(mParameters, 3) + NV_Ith_S(mParameters, 2)) / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Nai + NV_Ith_S(mParameters, 0))) + var_Membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 9); // uA_per_cm2
        const double var_i_Na__i_Na_converted = pow(var_chaste_interface__i_Na_m_gate__m, 3) * (-var_electric_potentials__E_Na + var_Membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 5) * var_chaste_interface__i_Na_h_gate__h * var_chaste_interface__i_Na_j_gate__j; // uA_per_cm2
        const double var_i_NaCa__i_NaCa_converted = 4900.0 * (pow(var_chaste_interface__sodium_dynamics__Nai, 3) * NV_Ith_S(mParameters, 1) * exp(4061.5771542678831 * var_Membrane__Vm / NV_Ith_S(mParameters, 12)) - 2.8571431999999999 * pow(NV_Ith_S(mParameters, 3), 3) * var_chaste_interface__calcium_dynamics__Cai * exp(-7542.9290007832124 * var_Membrane__Vm / NV_Ith_S(mParameters, 12))) * HeartConfig::Instance()->GetCapacitance() / ((1.0 + 0.10000000000000001 * exp(-7542.9290007832124 * var_Membrane__Vm / NV_Ith_S(mParameters, 12))) * (669921.875 + pow(NV_Ith_S(mParameters, 3), 3)) * (1.3799999999999999 + NV_Ith_S(mParameters, 1))); // uA_per_cm2
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Membrane__Vm_converted = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_electric_potentials__E_Na = 8.6173421482889202e-5 * NV_Ith_S(mParameters, 12) * log(NV_Ith_S(mParameters, 3) / var_chaste_interface__sodium_dynamics__Nai); // volt
        const double var_i_Na__i_Na = pow(var_chaste_interface__i_Na_m_gate__m, 3) * (-var_electric_potentials__E_Na + var_Membrane__Vm) * NV_Ith_S(mParameters, 5) * var_chaste_interface__i_Na_h_gate__h * var_chaste_interface__i_Na_j_gate__j; // A_per_F
        const double var_i_NaCa__i_NaCa = 4900.0 * (pow(var_chaste_interface__sodium_dynamics__Nai, 3) * NV_Ith_S(mParameters, 1) * exp(4061.5771542678831 * var_Membrane__Vm / NV_Ith_S(mParameters, 12)) - 2.8571431999999999 * pow(NV_Ith_S(mParameters, 3), 3) * var_chaste_interface__calcium_dynamics__Cai * exp(-7542.9290007832124 * var_Membrane__Vm / NV_Ith_S(mParameters, 12))) / ((1.0 + 0.10000000000000001 * exp(-7542.9290007832124 * var_Membrane__Vm / NV_Ith_S(mParameters, 12))) * (669921.875 + pow(NV_Ith_S(mParameters, 3), 3)) * (1.3799999999999999 + NV_Ith_S(mParameters, 1))); // A_per_F
        const double d_dt_chaste_interface_var_calcium_dynamics__Cai = 0.001 * (-var_calcium_dynamics__i_up - 588878900.51341963 * (-2.0 * var_i_NaCa__i_NaCa + var_i_CaL__i_CaL + var_i_PCa__i_PCa + var_i_b_Ca__i_b_Ca) * NV_Ith_S(mParameters, 11) + var_calcium_dynamics__i_leak + var_calcium_dynamics__i_rel) / (1.0 + 0.00025000000000000001 / pow((0.001 + var_chaste_interface__calcium_dynamics__Cai), 2)); // millimolar / millisecond
        const double var_i_NaK__i_NaK = 1.8414239999999999 * NV_Ith_S(mParameters, 2) * var_chaste_interface__sodium_dynamics__Nai / ((1.0 + NV_Ith_S(mParameters, 2)) * (40.0 + var_chaste_interface__sodium_dynamics__Nai) * (1.0 + 0.035299999999999998 * exp(-11604.506155051095 * var_Membrane__Vm / NV_Ith_S(mParameters, 12)) + 0.1245 * exp(-1160.4506155051097 * var_Membrane__Vm / NV_Ith_S(mParameters, 12)))); // A_per_F
        const double var_i_b_Na__i_b_Na = 0.90000000000000002 * var_Membrane__Vm - 0.90000000000000002 * var_electric_potentials__E_Na; // A_per_F
        const double d_dt_chaste_interface_var_sodium_dynamics__Nai = -1177757.8010268393 * (3.0 * var_i_NaCa__i_NaCa + 3.0 * var_i_NaK__i_NaK + var_i_Na__i_Na + var_i_b_Na__i_b_Na) * NV_Ith_S(mParameters, 11); // millimolar / millisecond
    ...
    N_Vector Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLCvodeOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Membrane__Vm_converted = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
