...
class Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__Vm)
    {
        ...
        const double* const _lt_0_row = Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables()
    {
...
protected:
    Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables(const Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables&);
    Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables& operator= (const Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables&);
    Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables()
    {
        ...
        Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables> Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellmatsuoka_model_2003FromCellMLCvodeOpt::UseCellMLDefaultStimulus()
    {
    ...
    Cellmatsuoka_model_2003FromCellMLCvodeOpt::Cellmatsuoka_model_2003FromCellMLCvodeOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                37,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmatsuoka_model_2003FromCellMLCvodeOpt>::Instance();
        Init();
    ...
    Cellmatsuoka_model_2003FromCellMLCvodeOpt::~Cellmatsuoka_model_2003FromCellMLCvodeOpt()
    {
    }

    AbstractLookupTableCollection* Cellmatsuoka_model_2003FromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables::Instance();
    }
    
    double Cellmatsuoka_model_2003FromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__Vm);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellmatsuoka_model_2003FromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
    ...
    void Cellmatsuoka_model_2003FromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    N_Vector Cellmatsuoka_model_2003FromCellMLCvodeOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellmatsuoka_model_2003FromCellMLCvodeOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellmatsuoka_model_2003FromCellMLCvodeOpt)
