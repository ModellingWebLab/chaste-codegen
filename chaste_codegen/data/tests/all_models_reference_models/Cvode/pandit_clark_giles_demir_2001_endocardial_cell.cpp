...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLCvode::Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                26,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLCvode>::Instance();
        Init();
    ...
    Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLCvode::~Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLCvode()
    {
    }

    

    void Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLCvode::VerifyStateVariables()
    {
    ...
    double Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_background_currents__E_Ca = 0.5 * var_membrane__R * var_membrane__T * log(NV_Ith_S(mParameters, 3) / var_chaste_interface__intracellular_ion_concentrations__Ca_i) / var_membrane__F; // millivolt
    ...
    void Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_L_type_Ca_channel_Ca_inact_gate__Ca_inact_orig_deriv = (-var_chaste_interface__L_type_Ca_channel_Ca_inact_gate__Ca_inact + var_L_type_Ca_channel_Ca_inact_gate__Ca_inact_infinity) / NV_Ith_S(mParameters, 7); // 1 / second
        ...
        const double var_sarcolemmal_calcium_pump_current__i_Ca_P = var_chaste_interface__intracellular_ion_concentrations__Ca_i * var_sarcolemmal_calcium_pump_current__i_Ca_P_max / (0.00040000000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i); // nanoA
        const double var_sodium_current__g_Na_endo = 1.3300000000000001 * NV_Ith_S(mParameters, 9); // microS
        const double var_sodium_current_h_gate__h_infinity = 0.01 * NV_Ith_S(mParameters, 10) + (1.0 - 0.01 * NV_Ith_S(mParameters, 10)) / (1.0 + exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V - 0.16474464579901152 * NV_Ith_S(mParameters, 11))); // dimensionless
        ...
        const double var_sodium_current_j_gate__j_infinity = 0.01 * NV_Ith_S(mParameters, 10) + (1.0 - 0.01 * NV_Ith_S(mParameters, 10)) / (1.0 + exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V - 0.16474464579901152 * NV_Ith_S(mParameters, 11))); // dimensionless
    ...
    N_Vector Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLCvode>::Initialise(void)
{
