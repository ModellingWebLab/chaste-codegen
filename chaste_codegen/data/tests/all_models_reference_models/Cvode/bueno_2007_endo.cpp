...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellbueno_2007_endoFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    Cellbueno_2007_endoFromCellMLCvode::Cellbueno_2007_endoFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                4,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbueno_2007_endoFromCellMLCvode>::Instance();
        Init();
    ...
    Cellbueno_2007_endoFromCellMLCvode::~Cellbueno_2007_endoFromCellMLCvode()
    {
    }

    
    double Cellbueno_2007_endoFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbueno_2007_endoFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        else
        {
            ...
            const double var_slow_outward_current__tau_so = 0.5 * (1.0 + tanh((-var_slow_outward_current__u_so + var_membrane__u) * var_slow_outward_current__k_so)) * (-var_slow_outward_current__tau_so1 + var_slow_outward_current__tau_so2) + var_slow_outward_current__tau_so1; // cm2_per_uA
            const double var_slow_outward_current__i_so = var_p__p / var_slow_outward_current__tau_so + (1.0 - var_p__p) * var_membrane__u / var_slow_outward_current__tau_o; // uA_per_cm2
            d_dt_chaste_interface_var_membrane__V = -(var_fast_inward_current__i_fi + var_membrane__i_stim + var_slow_inward_current__i_si + var_slow_outward_current__i_so) / NV_Ith_S(mParameters, 0); // mV / ms
        }
    ...
    N_Vector Cellbueno_2007_endoFromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellbueno_2007_endoFromCellMLCvode>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbueno_2007_endoFromCellMLCvode)
