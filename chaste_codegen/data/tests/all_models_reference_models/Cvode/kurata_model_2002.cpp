...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellkurata_model_2002FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_background_muscarinic_potassium_channel_current__g_K_ACh = 0.0011000000000000001 * pow(NV_Ith_S(mParameters, 1), 0.40999999999999998); // picoA
        ...
        const double var_background_muscarinic_potassium_channel_current__i_K_ACh = (-NV_Ith_S(mParameters, 1) * exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + var_chaste_interface__intracellular_ion_concentrations__Ki) * var_background_muscarinic_potassium_channel_current__g_K_ACh; // picoA
        ...
        const double var_sodium_calcium_exchange_current__do = 1.0 + (1.0 + exp(var_membrane__F * var_chaste_interface__membrane__V * var_sodium_calcium_exchange_current__Qco / (var_membrane__R * var_membrane__T))) * NV_Ith_S(mParameters, 0) / var_sodium_calcium_exchange_current__Kco + (1.0 + NV_Ith_S(mParameters, 2) / var_sodium_calcium_exchange_current__K2no) * (1.0 + NV_Ith_S(mParameters, 2) / var_sodium_calcium_exchange_current__K3no) * NV_Ith_S(mParameters, 2) / var_sodium_calcium_exchange_current__K1no; // dimensionless
        ...
        const double var_sodium_calcium_exchange_current__k21 = NV_Ith_S(mParameters, 0) * exp(var_membrane__F * var_chaste_interface__membrane__V * var_sodium_calcium_exchange_current__Qco / (var_membrane__R * var_membrane__T)) / (var_sodium_calcium_exchange_current__Kco * var_sodium_calcium_exchange_current__do); // dimensionless
        const double var_sodium_calcium_exchange_current__k23 = pow(NV_Ith_S(mParameters, 2), 2) * (1.0 + NV_Ith_S(mParameters, 2) / var_sodium_calcium_exchange_current__K3no) * exp(-0.5 * var_membrane__F * var_chaste_interface__membrane__V * var_sodium_calcium_exchange_current__Qn / (var_membrane__R * var_membrane__T)) / (var_sodium_calcium_exchange_current__K1no * var_sodium_calcium_exchange_current__K2no * var_sodium_calcium_exchange_current__do); // dimensionless
        ...
        const double var_sodium_calcium_exchange_current__k34 = NV_Ith_S(mParameters, 2) / (NV_Ith_S(mParameters, 2) + var_sodium_calcium_exchange_current__K3no); // dimensionless
