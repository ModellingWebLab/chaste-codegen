...
class Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V)
    {
        ...
        const double* const _lt_0_row = Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables(const Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables&);
    Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables&);
    Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables> Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    Celliyer_model_2004FromCellMLCvodeDataClampOpt::Celliyer_model_2004FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celliyer_model_2004FromCellMLCvodeDataClampOpt>::Instance();
        Init();
        
        NV_Ith_S(this->mParameters, 0) = 0.0; // (var_membrane_data_clamp_current_conductance) [dimensionless]
    }

    Celliyer_model_2004FromCellMLCvodeDataClampOpt::~Celliyer_model_2004FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Celliyer_model_2004FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Celliyer_model_2004FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Celliyer_model_2004FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const bool _oob_0 = Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY , var_chaste_interface__environment__time));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliyer_model_2004FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
    ...
    N_Vector Celliyer_model_2004FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Celliyer_model_2004FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celliyer_model_2004FromCellMLCvodeDataClampOpt)
