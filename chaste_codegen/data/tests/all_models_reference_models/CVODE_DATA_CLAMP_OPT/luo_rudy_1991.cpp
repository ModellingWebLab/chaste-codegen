...
class Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables(const Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables> Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellluo_rudy_1991FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellluo_rudy_1991FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellluo_rudy_1991FromCellMLCvodeDataClampOpt::Cellluo_rudy_1991FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellluo_rudy_1991FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellluo_rudy_1991FromCellMLCvodeDataClampOpt::~Cellluo_rudy_1991FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellluo_rudy_1991FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    

    void Cellluo_rudy_1991FromCellMLCvodeDataClampOpt::VerifyStateVariables()
    {
    ...
    double Cellluo_rudy_1991FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellluo_rudy_1991FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);

        const double var_background_current__i_b = (59.869999999999997 + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 12); // microA_per_cm2
        ...
        const double var_plateau_potassium_current__i_Kp = (-var_time_independent_potassium_current__E_K1 + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 13) / (_lt_0_row[1]); // microA_per_cm2
    ...
    void Cellluo_rudy_1991FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    N_Vector Cellluo_rudy_1991FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellluo_rudy_1991FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellluo_rudy_1991FromCellMLCvodeDataClampOpt)
