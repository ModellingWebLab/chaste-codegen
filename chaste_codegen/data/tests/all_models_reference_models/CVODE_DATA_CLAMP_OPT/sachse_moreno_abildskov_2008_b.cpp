...
class Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    ~Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables()
    {

    }

protected:
    Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables(const Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;

};

std::shared_ptr<Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables> Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt::Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt::~Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_I_Shkr__k_v = 2.0 * exp(-17.767148014440433 * var_chaste_interface__membrane__Vm / NV_Ith_S(mParameters, 7)); // first_order_rate_constant
        const double var_I_Shkr__kv = 30.0 * exp(14.864019253910952 * var_chaste_interface__membrane__Vm / NV_Ith_S(mParameters, 7)); // first_order_rate_constant
    ...
    N_Vector Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellsachse_moreno_abildskov_2008_bFromCellMLCvodeDataClampOpt)
