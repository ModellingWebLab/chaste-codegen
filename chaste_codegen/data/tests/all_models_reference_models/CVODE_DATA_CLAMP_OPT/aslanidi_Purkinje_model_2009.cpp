...
// LCOV_EXCL_STOP
        ...
        const double var_i_Kr__i_Kr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 5)) * (-var_equilibrium_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 13) * var_chaste_interface__i_Kr_xr_gate__xr / (_lt_0_row[8]); // microA_per_microF
