...
class Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables(const Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables> Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt::Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt::~Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_i_Na_h_gate__h = (var_i_Na_h_gate__alpha_h + var_i_Na_h_gate__beta_h) * (-var_chaste_interface__i_Na_h_gate__h + 0.01 * NV_Ith_S(mParameters, 10) + (1.0 - 0.01 * NV_Ith_S(mParameters, 10)) * var_i_Na_h_gate__alpha_h / (var_i_Na_h_gate__alpha_h + var_i_Na_h_gate__beta_h)); // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_i_Na_j_gate__j = (var_i_Na_j_gate__alpha_j + var_i_Na_j_gate__beta_j) * (-var_chaste_interface__i_Na_j_gate__j + 0.01 * NV_Ith_S(mParameters, 10) + (1.0 - 0.01 * NV_Ith_S(mParameters, 10)) * var_i_Na_j_gate__alpha_j / (var_i_Na_j_gate__alpha_j + var_i_Na_j_gate__beta_j)); // 1 / millisecond
        ...
        const double var_i_Kr__i_Kr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 5)) * (-var_equilibrium_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 13) * var_chaste_interface__i_Kr_xr_gate__xr / (_lt_0_row[10]); // microA_per_microF
        const double var_i_Ks__i_Ks = (1.0 + 0.59999999999999998 / (1.0 + 6.4818210260626455e-7 * pow((1 / var_chaste_interface__Ca_i__Ca_i), 1.3999999999999999))) * (-26.712338705498265 * log((0.018329999999999999 * NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 5)) / (0.018329999999999999 * var_chaste_interface__intracellular_ion_concentrations__Na_i + var_chaste_interface__intracellular_ion_concentrations__K_i)) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 14) * var_chaste_interface__i_Ks_xs1_gate__xs1 * var_chaste_interface__i_Ks_xs2_gate__xs2; // microA_per_microF
    ...
    N_Vector Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellaslanidi_Purkinje_model_2009FromCellMLCvodeDataClampOpt>::Initialise(void)
{
