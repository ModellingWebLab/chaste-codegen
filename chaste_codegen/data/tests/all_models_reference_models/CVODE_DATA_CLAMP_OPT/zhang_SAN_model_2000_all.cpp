...
class Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables(const Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables> Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt::Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt>::Instance();
        Init();
        
        NV_Ith_S(this->mParameters, 0) = 0.0; // (var_membrane_data_clamp_current_conductance) [dimensionless]
    }

    Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt::~Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    N_Vector Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellzhang_SAN_model_2000_allFromCellMLCvodeDataClampOpt)
