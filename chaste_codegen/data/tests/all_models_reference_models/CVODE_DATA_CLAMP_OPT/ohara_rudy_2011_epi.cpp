...
class Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables(const Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables> Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt::Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt::~Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
        ...
        const double var_INaCa_i__Gncx = 1.1000000000000001 * NV_Ith_S(mParameters, 17); // milliS_per_microF
        ...
        const double var_INaCa_i__hca = exp(0.16700000000000001 * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 5) / (NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 20))); // dimensionless
        const double var_INaCa_i__hna = exp(0.52239999999999998 * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 5) / (NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 20))); // dimensionless
        ...
        const double var_INaK__Knai = 9.0730000000000004 * exp(-0.051666666666666666 * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 5) / (NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 20))); // millimolar
        const double var_INaK__Knao = 27.780000000000001 * exp(0.38500000000000001 * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 5) / (NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 20))); // millimolar
        ...
        const double var_membrane__vffrt = pow(NV_Ith_S(mParameters, 5), 2) * var_chaste_interface__membrane__v / (NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 20)); // coulomb_per_mole
        const double var_membrane__vfrt = var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 5) / (NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 20)); // dimensionless
        ...
        const double var_reversal_potentials__EK = NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 20) * log(NV_Ith_S(mParameters, 3) / var_chaste_interface__intracellular_ions__ki) / NV_Ith_S(mParameters, 5); // millivolt
        const double var_IK1__IK1_converted = 1.2 * sqrt(NV_Ith_S(mParameters, 3)) * (-var_reversal_potentials__EK + var_chaste_interface__membrane__v) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 13) * var_chaste_interface__IK1__xk1 / (1.0 + exp(11.145054250500367 + 0.10534077741493732 * var_chaste_interface__membrane__v - 0.27388602127883704 * NV_Ith_S(mParameters, 3))); // uA_per_cm2
        ...
        const double var_reversal_potentials__ENa = NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 20) * log(NV_Ith_S(mParameters, 4) / var_chaste_interface__intracellular_ions__nai) / NV_Ith_S(mParameters, 5); // millivolt
    ...
    void Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        {
            d_dt_chaste_interface_var_membrane__v = -var_ICaL__ICaK - var_ICaL__ICaL - var_ICaL__ICaNa - var_ICab__ICab - var_IK1__IK1 - var_IKb__IKb - var_IKr__IKr - var_IKs__IKs - var_INa__INa - var_INaCa_i__INaCa_i - var_INaCa_i__INaCa_ss - var_INaK__INaK - var_INaL__INaL - var_INab__INab - var_IpCa__IpCa - var_Ito__Ito - var_membrane__Istim - (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__membrane__v) * NV_Ith_S(mParameters, 11); // millivolt / millisecond
        }
    ...
    N_Vector Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        if (mDataClampIsOn)
        {
            var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__membrane__v) * NV_Ith_S(mParameters, 11); // uA_per_cm2
        }
        const double var_INaCa_i__hca = exp(var_INaCa_i__qca * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 5) / (NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 20))); // dimensionless
        const double var_INaCa_i__hna = exp(var_INaCa_i__qna * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 5) / (NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 20))); // dimensionless
        ...
        const double var_INaK__Knai = var_INaK__Knai0 * exp(0.33333333333333331 * var_INaK__delta * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 5) / (NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 20))); // millimolar
        const double var_INaK__Knao = var_INaK__Knao0 * exp(0.33333333333333331 * (1.0 - var_INaK__delta) * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 5) / (NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 20))); // millimolar
        ...
        NV_Ith_S(dqs, 11) = var_chaste_interface__membrane_data_clamp_current;
        NV_Ith_S(dqs, 12) = var_INa__INa_converted;
        NV_Ith_S(dqs, 13) = var_INa__h;
        NV_Ith_S(dqs, 14) = var_IK1__IK1_converted;
        NV_Ith_S(dqs, 15) = var_IK1__GK1_total;
        NV_Ith_S(dqs, 16) = var_INaL__INaL_converted;
        NV_Ith_S(dqs, 17) = var_INaL__GNaL;
        NV_Ith_S(dqs, 18) = var_IKr__IKr_converted;
        NV_Ith_S(dqs, 19) = var_IKr__GKr_total;
        NV_Ith_S(dqs, 20) = var_IKs__IKs_converted;
        NV_Ith_S(dqs, 21) = var_IKs__GKs_total;
        NV_Ith_S(dqs, 22) = var_INaCa_i__INaCa_i_converted;
        NV_Ith_S(dqs, 23) = var_INaCa_i__INaCa_ss_converted;
        NV_Ith_S(dqs, 24) = var_INaK__INaK_converted;
        NV_Ith_S(dqs, 25) = var_membrane__Istim_converted;
        NV_Ith_S(dqs, 26) = var_Ito__Gto;
        NV_Ith_S(dqs, 27) = var_reversal_potentials__EK;
        NV_Ith_S(dqs, 28) = var_reversal_potentials__ENa;
        NV_Ith_S(dqs, 29) = var_chaste_interface__environment__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellohara_rudy_2011_epiFromCellMLCvodeDataClampOpt)
