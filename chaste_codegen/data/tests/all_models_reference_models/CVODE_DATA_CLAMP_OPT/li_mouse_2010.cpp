...
class Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables(const Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables> Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellli_mouse_2010FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellli_mouse_2010FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellli_mouse_2010FromCellMLCvodeDataClampOpt::Cellli_mouse_2010FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellli_mouse_2010FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellli_mouse_2010FromCellMLCvodeDataClampOpt::~Cellli_mouse_2010FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellli_mouse_2010FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellli_mouse_2010FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellli_mouse_2010FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
        ...
        const double var_non_inactivating_steady_state_K_I__i_Kss_converted = (-var_fast_transient_outward_K_I__E_K + var_chaste_interface__cell__V) * HeartConfig::Instance()->GetCapacitance() * var_chaste_interface__non_inactivating_steady_state_K_I__aKss * NV_Ith_S(mParameters, 9) * var_chaste_interface__non_inactivating_steady_state_K_I__iKss; // uA_per_cm2
        const double var_slow_delayed_rectifier_K_I__i_Ks_converted = pow(var_chaste_interface__slow_delayed_rectifier_K_I__nKs, 2) * (-var_fast_transient_outward_K_I__E_K + var_chaste_interface__cell__V) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 11); // uA_per_cm2
        ...
        const double var_fast_sodium_current__i_Na_converted = (-var_fast_sodium_current__E_Na + var_chaste_interface__cell__V) * HeartConfig::Instance()->GetCapacitance() * var_chaste_interface__fast_sodium_current__O_Na * NV_Ith_S(mParameters, 7); // uA_per_cm2
    ...
    void Cellli_mouse_2010FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    N_Vector Cellli_mouse_2010FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellli_mouse_2010FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellli_mouse_2010FromCellMLCvodeDataClampOpt)
