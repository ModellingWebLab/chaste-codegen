...
class Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables(const Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables> Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    double Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt::Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 10) = 130.5744; // (var_fast_sodium_current__g_Na) [nanoS_per_picoF]
        ...
        NV_Ith_S(this->mParameters, 13) = 0.065000000000000002; // (var_inward_rectifier_potassium_current__g_K1) [nanoS_per_picoF]
        NV_Ith_S(this->mParameters, 14) = 0.091800000000000007; // (var_rapid_time_dependent_potassium_current__g_Kr) [nanoS_per_picoF]
        NV_Ith_S(this->mParameters, 15) = 0.23519999999999999; // (var_slow_time_dependent_potassium_current__g_Ks) [nanoS_per_picoF]
        NV_Ith_S(this->mParameters, 16) = 1000.0; // (var_sodium_calcium_exchanger_current__K_NaCa) [picoA_per_picoF]
        NV_Ith_S(this->mParameters, 17) = 0.081839999999999996; // (var_transient_outward_current__g_to) [nanoS_per_picoF]
    }

    Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt::~Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
        ...
        const double var_inward_rectifier_potassium_current__i_K1_converted = (-8.0 - var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 13) / (_lt_0_row[2]); // uA_per_cm2
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_inward_rectifier_potassium_current__i_K1 = (-8.0 - var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 13) / (_lt_0_row[2]); // picoA_per_picoF
        const double var_potassium_pump_current__i_p_K = 0.0146 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) / (_lt_0_row[3]); // picoA_per_picoF
        ...
        const double var_transient_outward_current__i_to = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 17) * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // picoA_per_picoF
    ...
    N_Vector Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40.0) ? (0.057000000000000002 * exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 12) - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0)); // per_millisecond
        ...
        const double var_inward_rectifier_potassium_current__i_K1 = (-8.0 - var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 13) * var_inward_rectifier_potassium_current__xK1_inf; // picoA_per_picoF
        ...
        const double var_slow_time_dependent_potassium_current__i_Ks = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * (-var_reversal_potentials__E_Ks + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 15); // picoA_per_picoF
        ...
        NV_Ith_S(dqs, 10) = var_rapid_time_dependent_potassium_current__i_Kr_converted;
        NV_Ith_S(dqs, 11) = var_slow_time_dependent_potassium_current__i_Ks_converted;
        NV_Ith_S(dqs, 12) = var_sodium_calcium_exchanger_current__i_NaCa_converted;
...
template<>
void OdeSystemInformation<Cellstewart_zhang_model_2008_ssFromCellMLCvodeDataClampOpt>::Initialise(void)
{
