...
class Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    ~Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables()
    {

    }

protected:
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables(const Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;

};

std::shared_ptr<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables> Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt::Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt::~Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_i_f__i_f_converted = (0.017000000000000001 + var_Membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 10) * var_chaste_interface__i_f_Xf_gate__Xf; // uA_per_cm2
        const double var_electric_potentials__E_K = 8.6173421482889202e-5 * NV_Ith_S(mParameters, 18) * log(NV_Ith_S(mParameters, 2) / NV_Ith_S(mParameters, 0)); // volt
        ...
        const double var_i_K1__i_K1_converted = 1.6825960981856667 * sqrt(NV_Ith_S(mParameters, 2)) * (-var_electric_potentials__E_K + var_Membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 11) / ((1.0 + exp(-118.83999999999999 + 594.19999999999993 * var_Membrane__Vm - 594.19999999999993 * var_electric_potentials__E_K)) * (3.9100000000000001 / (1.0 + exp(-118.83999999999999 + 594.19999999999993 * var_Membrane__Vm - 594.19999999999993 * var_electric_potentials__E_K)) + (-1.5089999999999999 * exp(0.02 + 0.20000000000000001 * var_Membrane__Vm - 0.20000000000000001 * var_electric_potentials__E_K) + exp(-5.8860000000000001 + 588.60000000000002 * var_Membrane__Vm - 588.60000000000002 * var_electric_potentials__E_K)) / (1.0 + exp(454.69999999999999 * var_Membrane__Vm - 454.69999999999999 * var_electric_potentials__E_K)))); // uA_per_cm2
        const double var_i_Kr__i_Kr_converted = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 2)) * (-var_electric_potentials__E_K + var_Membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 12) * var_chaste_interface__i_Kr_Xr1_gate__Xr1 * var_chaste_interface__i_Kr_Xr2_gate__Xr2; // uA_per_cm2
        const double var_i_b_Ca__i_b_Ca = (-4.3086710741444601e-5 * NV_Ith_S(mParameters, 18) * log(NV_Ith_S(mParameters, 1) / var_chaste_interface__calcium_dynamics__Cai) + var_Membrane__Vm) * NV_Ith_S(mParameters, 5); // A_per_F
        const double var_i_to__i_to_converted = (-var_electric_potentials__E_K + var_Membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 16) * var_chaste_interface__i_to_q_gate__q * var_chaste_interface__i_to_r_gate__r; // uA_per_cm2
        const double var_electric_potentials__E_Na = 8.6173421482889202e-5 * NV_Ith_S(mParameters, 18) * log(NV_Ith_S(mParameters, 3) / var_chaste_interface__sodium_dynamics__Nai); // volt
        const double var_i_Ks__i_Ks_converted = pow(var_chaste_interface__i_Ks_Xs_gate__Xs, 2) * (1.0 + 0.59999999999999998 / (1.0 + 6.4818210260626455e-7 * pow((1 / var_chaste_interface__calcium_dynamics__Cai), 1.3999999999999999))) * (-8.6173421482889202e-5 * NV_Ith_S(mParameters, 18) * log((0.029999999999999999 * NV_Ith_S(mParameters, 3) + NV_Ith_S(mParameters, 2)) / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Nai + NV_Ith_S(mParameters, 0))) + var_Membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 13); // uA_per_cm2
        const double var_i_Na__i_Na_converted = pow(var_chaste_interface__i_Na_m_gate__m, 3) * (-var_electric_potentials__E_Na + var_Membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 9) * var_chaste_interface__i_Na_h_gate__h * var_chaste_interface__i_Na_j_gate__j; // uA_per_cm2
        const double var_i_NaCa__i_NaCa_converted = (pow(var_chaste_interface__sodium_dynamics__Nai, 3) * NV_Ith_S(mParameters, 1) * exp(4061.5771542678831 * var_Membrane__Vm / NV_Ith_S(mParameters, 18)) - 2.8571431999999999 * pow(NV_Ith_S(mParameters, 3), 3) * var_chaste_interface__calcium_dynamics__Cai * exp(-7542.9290007832124 * var_Membrane__Vm / NV_Ith_S(mParameters, 18))) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 14) / ((1.0 + 0.10000000000000001 * exp(-7542.9290007832124 * var_Membrane__Vm / NV_Ith_S(mParameters, 18))) * (669921.875 + pow(NV_Ith_S(mParameters, 3), 3)) * (1.3799999999999999 + NV_Ith_S(mParameters, 1))); // uA_per_cm2
    ...
    void Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Membrane__Vm_converted = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double d_dt_chaste_interface_var_calcium_dynamics__Cai = 0.001 * (-var_calcium_dynamics__i_up - 739037981.24901497 * (-2.0 * var_i_NaCa__i_NaCa + var_i_CaL__i_CaL + var_i_PCa__i_PCa + var_i_b_Ca__i_b_Ca) * NV_Ith_S(mParameters, 17) + var_calcium_dynamics__i_leak + var_calcium_dynamics__i_rel) / (1.0 + 0.00025000000000000001 / pow((0.001 + var_chaste_interface__calcium_dynamics__Cai), 2)); // millimolar / millisecond
        const double var_i_NaK__i_NaK = NV_Ith_S(mParameters, 15) * NV_Ith_S(mParameters, 2) * var_chaste_interface__sodium_dynamics__Nai / ((1.0 + NV_Ith_S(mParameters, 2)) * (40.0 + var_chaste_interface__sodium_dynamics__Nai) * (1.0 + 0.035299999999999998 * exp(-11604.506155051095 * var_Membrane__Vm / NV_Ith_S(mParameters, 18)) + 0.1245 * exp(-1160.4506155051097 * var_Membrane__Vm / NV_Ith_S(mParameters, 18)))); // A_per_F
        const double var_i_b_Na__i_b_Na = (-var_electric_potentials__E_Na + var_Membrane__Vm) * NV_Ith_S(mParameters, 6); // A_per_F
        const double d_dt_chaste_interface_var_sodium_dynamics__Nai = -1478075.9624980299 * (3.0 * var_i_NaCa__i_NaCa + 3.0 * var_i_NaK__i_NaK + var_i_Na__i_Na + var_i_b_Na__i_b_Na) * NV_Ith_S(mParameters, 17); // millimolar / millisecond
    ...
    N_Vector Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Membrane__Vm_converted = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLCvodeDataClampOpt)
