...
std::shared_ptr<Cellespinosa_model_1998_normalFromCellMLCvodeDataClampOpt_LookupTables> Cellespinosa_model_1998_normalFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 12) = 1.5; // (var_time_dependent_potassium_current__i_K_max) [nanoA]
        NV_Ith_S(this->mParameters, 13) = 0.59999999999999998; // (var_fast_sodium_current__g_Na) [microS]
        ...
        NV_Ith_S(this->mParameters, 16) = 0.12; // (var_time_independent_potassium_current__g_K1) [microS]
        NV_Ith_S(this->mParameters, 17) = 0.00020000000000000001; // (var_sodium_calcium_exchanger__k_NaCa) [nanoA]
        NV_Ith_S(this->mParameters, 18) = 0.080000000000000002; // (var_transient_outward_current__g_to) [microS]
    }
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = 20.0 * exp(-9.375 + 0.125 * NV_Ith_S(mParameters, 15) - 0.125 * var_chaste_interface__membrane__V); // per_second
        const double var_fast_sodium_current_h_gate__beta_h = 2000.0 / (1.0 + 320.0 * exp(-7.5 + 0.10000000000000001 * NV_Ith_S(mParameters, 15) - 0.10000000000000001 * var_chaste_interface__membrane__V)); // per_second
        const double d_dt_chaste_interface_var_fast_sodium_current_h_gate__h = 0.001 * (var_fast_sodium_current_h_gate__alpha_h + var_fast_sodium_current_h_gate__beta_h) * (-var_chaste_interface__fast_sodium_current_h_gate__h + 0.01 * NV_Ith_S(mParameters, 14) + (1.0 - 0.01 * NV_Ith_S(mParameters, 14)) * var_fast_sodium_current_h_gate__alpha_h / (var_fast_sodium_current_h_gate__alpha_h + var_fast_sodium_current_h_gate__beta_h)); // 1 / millisecond
        ...
        const double var_transient_outward_current__i_to = (0.14999999999999999 + 0.84999999999999998 * var_chaste_interface__transient_outward_current_s_gate__s) * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 18) * var_chaste_interface__transient_outward_current_r_gate__r; // nanoA
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current__i_Na = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-var_reversal_potentials__E_mh + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 13) * var_chaste_interface__fast_sodium_current_h_gate__h; // nanoA
        ...
        const double var_time_independent_potassium_current__i_K1 = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__extracellular_potassium_concentration__K_o * NV_Ith_S(mParameters, 16) / ((1.0 + exp(1.6699999999999999 * (10.0 - var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_membrane__F / (var_membrane__R * var_membrane__T))) * (var_chaste_interface__extracellular_potassium_concentration__K_o + var_time_independent_potassium_current__K_mk1)); // nanoA
