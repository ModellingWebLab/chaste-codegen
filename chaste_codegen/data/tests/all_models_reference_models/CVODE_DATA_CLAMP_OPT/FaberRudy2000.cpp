...
class CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables(const CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables&);
    CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables& operator= (const CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables&);
    CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables> CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> CellFaberRudy2000FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellFaberRudy2000FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    CellFaberRudy2000FromCellMLCvodeDataClampOpt::CellFaberRudy2000FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<CellFaberRudy2000FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    CellFaberRudy2000FromCellMLCvodeDataClampOpt::~CellFaberRudy2000FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* CellFaberRudy2000FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double CellFaberRudy2000FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellFaberRudy2000FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void CellFaberRudy2000FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        {
            d_dt_chaste_interface_var_membrane__V = -0.001 * ((-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time_converted) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 4) + var_ATP_sensitive_potassium_current__i_K_ATP + var_L_type_Ca_channel__i_Ca_L + var_Na_Ca_exchanger__i_NaCa + var_T_type_Ca_channel__i_Ca_T + var_calcium_background_current__i_Ca_b + var_fast_sodium_current__i_Na + var_membrane__I_st + var_non_specific_calcium_activated_current__i_ns_Ca + var_plateau_potassium_current__i_Kp + var_rapid_delayed_rectifier_potassium_current__i_Kr + var_sarcolemmal_calcium_pump__i_p_Ca + var_slow_delayed_rectifier_potassium_current__i_Ks + var_sodium_activated_potassium_current__i_K_Na + var_sodium_background_current__i_Na_b + var_sodium_potassium_pump__i_NaK + var_time_independent_potassium_current__i_K1 + var_transient_outward_current__i_to) / NV_Ith_S(mParameters, 3); // millivolt / millisecond
        }
    ...
    N_Vector CellFaberRudy2000FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<CellFaberRudy2000FromCellMLCvodeDataClampOpt>::Initialise(void)
{
