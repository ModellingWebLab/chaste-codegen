...
std::shared_ptr<Celliyer_2004FromCellMLCvodeDataClampOpt_LookupTables> Celliyer_2004FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;
    ...
    double Celliyer_2004FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__PKv14 = 0.11099999999999999 * NV_Ith_S(mParameters, 13); // litre_per_farad_second
...
// LCOV_EXCL_STOP
    ...
    N_Vector Celliyer_2004FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        ...
        const double var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__PKv14 = (1.0 - var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__Kv43Frac) * NV_Ith_S(mParameters, 13); // litre_per_farad_second
