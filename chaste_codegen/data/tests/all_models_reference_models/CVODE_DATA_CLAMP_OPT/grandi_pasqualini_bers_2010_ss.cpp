...
std::shared_ptr<Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables> Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 12) = 0.0; // (var_membrane_data_clamp_current_conductance) [dimensionless]
        NV_Ith_S(this->mParameters, 13) = 23.0; // (var_parameters__GNa) [mS_per_uF]
        ...
        NV_Ith_S(this->mParameters, 16) = 1.0; // (var_I_to__GtoFast_factor) [dimensionless]
        ...
        NV_Ith_S(this->mParameters, 19) = 1.0; // (var_I_Ks__GKs_factor) [dimensionless]
        NV_Ith_S(this->mParameters, 20) = 1.0; // (var_I_to__GtoSlow_factor) [dimensionless]
        ...
        NV_Ith_S(this->mParameters, 24) = 310.0; // (var_parameters__Temp) [kelvin]
    }
...
// LCOV_EXCL_STOP
        ...
        const double var_I_NaK__I_nak_junc = 0.11 * var_I_NaK__fnak * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1.0 + 14641.0 / pow(var_chaste_interface__Na_Concentrations__Na_j, 4)) * (1.5 + NV_Ith_S(mParameters, 7))); // uA_per_uF
        const double var_I_NaK__I_nak_sl = 0.89000000000000001 * var_I_NaK__fnak * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1.0 + 14641.0 / pow(var_chaste_interface__Na_Concentrations__Na_sl, 4)) * (1.5 + NV_Ith_S(mParameters, 7))); // uA_per_uF
        const double var_parameters__Qpow = -31.0 + 0.10000000000000001 * NV_Ith_S(mParameters, 24); // dimensionless
...
// LCOV_EXCL_STOP
        ...
        const double var_I_Na__ah = ((var_chaste_interface__membrane_potential__V_m >= -40.0) ? (0) : (0.057000000000000002 * exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 15) - 0.14705882352941177 * var_chaste_interface__membrane_potential__V_m))); // dimensionless
        ...
        const double var_parameters__Cmem_converted = 1000000.0 * NV_Ith_S(mParameters, 23); // uF
        ...
        const double var_I_NaK__I_nak_junc = var_I_NaK__fnak * var_parameters__Fjunc * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1.0 + pow(var_parameters__KmNaip, 4) / pow(var_chaste_interface__Na_Concentrations__Na_j, 4)) * (var_parameters__KmKo + NV_Ith_S(mParameters, 7))); // uA_per_uF
        const double var_I_NaK__I_nak_sl = var_I_NaK__fnak * var_parameters__Fsl * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1.0 + pow(var_parameters__KmNaip, 4) / pow(var_chaste_interface__Na_Concentrations__Na_sl, 4)) * (var_parameters__KmKo + NV_Ith_S(mParameters, 7))); // uA_per_uF
        ...
        const double var_I_to__GtoFast = ((var_parameters__epi == 1.0) ? (0.1144 * NV_Ith_S(mParameters, 16)) : (0.0014039999999999999 * NV_Ith_S(mParameters, 16))); // mS_per_uF
        const double var_I_to__GtoSlow = ((var_parameters__epi == 1.0) ? (0.015599999999999999 * NV_Ith_S(mParameters, 20)) : (0.037595999999999997 * NV_Ith_S(mParameters, 20))); // mS_per_uF
        ...
        const double var_I_NCX__I_ncx_sl = pow(var_parameters__Q10NCX, var_parameters__Qpow) * (-var_I_NCX__s2_sl + var_I_NCX__s1_sl) * var_I_NCX__Ka_sl * var_parameters__Fsl * NV_Ith_S(mParameters, 21) / ((1.0 + var_parameters__ksat * exp((-1.0 + var_parameters__nu) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * var_I_NCX__s3_sl); // uA_per_uF
