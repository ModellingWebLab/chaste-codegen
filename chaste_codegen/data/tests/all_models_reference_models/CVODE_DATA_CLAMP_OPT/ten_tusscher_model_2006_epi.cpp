...
std::shared_ptr<Cellten_tusscher_model_2006_epiFromCellMLCvodeDataClampOpt_LookupTables> Cellten_tusscher_model_2006_epiFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLCvodeDataClampOpt::VerifyStateVariables()
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_reversal_potentials__E_K = NV_Ith_S(mParameters, 8) * NV_Ith_S(mParameters, 23) * log(NV_Ith_S(mParameters, 5) / var_chaste_interface__potassium_dynamics__K_i) / NV_Ith_S(mParameters, 7); // millivolt
        ...
        const double var_potassium_pump_current__i_p_K_converted = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 18) / (_lt_0_row[0]); // uA_per_cm2
        ...
        const double var_reversal_potentials__E_Na = NV_Ith_S(mParameters, 8) * NV_Ith_S(mParameters, 23) * log(NV_Ith_S(mParameters, 6) / var_chaste_interface__sodium_dynamics__Na_i) / NV_Ith_S(mParameters, 7); // millivolt
...
// LCOV_EXCL_STOP
        ...
        const double var_calcium_background_current__i_b_Ca = (-0.5 * NV_Ith_S(mParameters, 8) * NV_Ith_S(mParameters, 23) * log(NV_Ith_S(mParameters, 4) / var_chaste_interface__calcium_dynamics__Ca_i) / NV_Ith_S(mParameters, 7) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 10); // picoA_per_picoF
        const double var_reversal_potentials__E_K = NV_Ith_S(mParameters, 8) * NV_Ith_S(mParameters, 23) * log(NV_Ith_S(mParameters, 5) / var_chaste_interface__potassium_dynamics__K_i) / NV_Ith_S(mParameters, 7); // millivolt
        ...
        const double var_potassium_pump_current__i_p_K = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 18) / (_lt_0_row[0]); // picoA_per_picoF
...
// LCOV_EXCL_STOP
        ...
        const double var_inward_rectifier_potassium_current__g_K1_total = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 5)) * NV_Ith_S(mParameters, 17); // nanoS_per_picoF
        const double var_rapid_time_dependent_potassium_current__g_Kr_total = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 5)) * NV_Ith_S(mParameters, 19); // nanoS_per_picoF
        const double var_reversal_potentials__E_Ca = 0.5 * NV_Ith_S(mParameters, 8) * NV_Ith_S(mParameters, 23) * log(NV_Ith_S(mParameters, 4) / var_chaste_interface__calcium_dynamics__Ca_i) / NV_Ith_S(mParameters, 7); // millivolt
        ...
        NV_Ith_S(dqs, 13) = var_chaste_interface__membrane_data_clamp_current;
        NV_Ith_S(dqs, 14) = var_fast_sodium_current__i_Na_converted;
        NV_Ith_S(dqs, 15) = var_fast_sodium_current_h_gate__tau_h;
        NV_Ith_S(dqs, 16) = var_fast_sodium_current_j_gate__tau_j;
        NV_Ith_S(dqs, 17) = var_inward_rectifier_potassium_current__i_K1_converted;
        NV_Ith_S(dqs, 18) = var_inward_rectifier_potassium_current__g_K1_total;
        NV_Ith_S(dqs, 19) = var_potassium_pump_current__i_p_K_converted;
        NV_Ith_S(dqs, 20) = var_rapid_time_dependent_potassium_current__i_Kr_converted;
        NV_Ith_S(dqs, 21) = var_rapid_time_dependent_potassium_current__g_Kr_total;
        NV_Ith_S(dqs, 22) = var_slow_time_dependent_potassium_current__i_Ks_converted;
        NV_Ith_S(dqs, 23) = var_sodium_calcium_exchanger_current__i_NaCa_converted;
        NV_Ith_S(dqs, 24) = var_membrane__i_Stim_converted;
        NV_Ith_S(dqs, 25) = var_transient_outward_current__i_to_converted;
        NV_Ith_S(dqs, 26) = var_reversal_potentials__E_K;
        NV_Ith_S(dqs, 27) = var_reversal_potentials__E_Na;
