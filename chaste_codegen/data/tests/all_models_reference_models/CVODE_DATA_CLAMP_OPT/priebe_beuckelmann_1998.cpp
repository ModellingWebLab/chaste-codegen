...
class Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables(const Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables> Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt::Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 10) = 16.0; // (var_INa__g_Na) [mS_per_uF]
        ...
        NV_Ith_S(this->mParameters, 13) = 1.0; // (var_IK1__g_K1_scale) [dimensionless]
        NV_Ith_S(this->mParameters, 14) = 0.014999999999999999; // (var_IKr__g_Kr_max) [mS_per_uF]
        NV_Ith_S(this->mParameters, 15) = 0.02; // (var_IKs__g_Ks_max) [mS_per_uF]
        NV_Ith_S(this->mParameters, 16) = 1000.0; // (var_INaCa__K_NaCa_normal) [uA_per_uF]
        NV_Ith_S(this->mParameters, 17) = 1.0; // (var_Ito__g_to_max_factor) [dimensionless]
        NV_Ith_S(this->mParameters, 18) = 310.14999999999998; // (var_cell__T) [kelvin]
    }

    Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt::~Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);

        const double var_cell__FonRT = NV_Ith_S(mParameters, 6) / (NV_Ith_S(mParameters, 7) * NV_Ith_S(mParameters, 18)); // per_mV
    ...
    void Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_IKr__i_Kr = (-log(NV_Ith_S(mParameters, 4) / var_chaste_interface__Ionic_concentrations__Ki) / var_cell__FonRT + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 14) * var_chaste_interface__IKr_Xr_gate__Xr / (_lt_0_row[0]); // uA_per_uF
        ...
        const double var_INa__i_Na = pow(var_chaste_interface__INa_m_gate__m, 3) * (-var_INa__E_Na + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 10) * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j; // uA_per_uF
        const double var_INa_h_gate__alpha_h = ((var_chaste_interface__cell__V < -40.0) ? (0.13500000000000001 * exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 12) - 0.14705882352941177 * var_chaste_interface__cell__V)) : (0)); // per_ms
        ...
        const double d_dt_chaste_interface_var_INa_h_gate__h = (var_INa_h_gate__alpha_h + var_INa_h_gate__beta_h) * (-var_chaste_interface__INa_h_gate__h + 0.01 * NV_Ith_S(mParameters, 11) + (1.0 - 0.01 * NV_Ith_S(mParameters, 11)) * var_INa_h_gate__alpha_h / (var_INa_h_gate__alpha_h + var_INa_h_gate__beta_h)); // 1 / ms
        ...
        const double d_dt_chaste_interface_var_INa_j_gate__j = (var_INa_j_gate__alpha_j + var_INa_j_gate__beta_j) * (-var_chaste_interface__INa_j_gate__j + 0.01 * NV_Ith_S(mParameters, 11) + (1.0 - 0.01 * NV_Ith_S(mParameters, 11)) * var_INa_j_gate__alpha_j / (var_INa_j_gate__alpha_j + var_INa_j_gate__beta_j)); // 1 / ms
        ...
        const double var_Ito__i_to = (-log((NV_Ith_S(mParameters, 4) + 0.042999999999999997 * NV_Ith_S(mParameters, 5)) / (var_chaste_interface__Ionic_concentrations__Ki + 0.042999999999999997 * var_chaste_interface__Ionic_concentrations__Nai)) / var_cell__FonRT + var_chaste_interface__cell__V) * ((var_cell__failing == 0) ? (0.29999999999999999 * NV_Ith_S(mParameters, 17)) : (0.191 * NV_Ith_S(mParameters, 17))) * var_chaste_interface__Ito_r_gate__r * var_chaste_interface__Ito_t_gate__t; // uA_per_uF
        ...
        {
            d_dt_chaste_interface_var_cell__V = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 9) + var_cell__dVdt; // mV / ms
        }
    ...
    N_Vector Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_IKr__i_Kr = (-var_IKr__E_K + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 14) * var_IKr__rik * var_chaste_interface__IKr_Xr_gate__Xr; // uA_per_uF
        const double var_IKr__i_Kr_converted = HeartConfig::Instance()->GetCapacitance() * var_IKr__i_Kr; // uA_per_cm2
        const double var_IKs__i_Ks = pow(var_chaste_interface__IKs_Xs_gate__Xs, 2) * (-var_IKs__E_Ks + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 15); // uA_per_uF
        ...
        const double var_IK1__i_K1 = (-var_IK1__E_K1 + var_chaste_interface__cell__V) * var_IK1__g_K1_max * NV_Ith_S(mParameters, 13) * var_IK1_K1_gate__K1_infinity; // uA_per_uF
        const double var_IK1__i_K1_converted = HeartConfig::Instance()->GetCapacitance() * var_IK1__i_K1; // uA_per_cm2
        const double var_INaCa__K_NaCa = ((var_cell__failing == 0) ? (NV_Ith_S(mParameters, 16)) : (1650.0)); // uA_per_uF
        ...
        const double var_Ito__g_to_max = ((var_cell__failing == 0) ? (0.29999999999999999 * NV_Ith_S(mParameters, 17)) : (0.191 * NV_Ith_S(mParameters, 17))); // mS_per_uF
        ...
        NV_Ith_S(dqs, 14) = var_INa__i_Na_converted;
        NV_Ith_S(dqs, 15) = var_INa_h_gate__tau_h;
        NV_Ith_S(dqs, 16) = var_INa_j_gate__tau_j;
        NV_Ith_S(dqs, 17) = var_IK1__i_K1_converted;
        NV_Ith_S(dqs, 18) = var_IKr__i_Kr_converted;
        NV_Ith_S(dqs, 19) = var_IKs__i_Ks_converted;
        NV_Ith_S(dqs, 20) = var_INaCa__i_NaCa_converted;
        NV_Ith_S(dqs, 21) = var_cell__i_Stim_converted;
        NV_Ith_S(dqs, 22) = var_Ito__i_to_converted;
        NV_Ith_S(dqs, 23) = var_Ito__g_to_max;
        NV_Ith_S(dqs, 24) = var_IKr__E_K;
        NV_Ith_S(dqs, 25) = var_INa__E_Na;
        NV_Ith_S(dqs, 26) = var_chaste_interface__environment__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpriebe_beuckelmann_1998FromCellMLCvodeDataClampOpt)
