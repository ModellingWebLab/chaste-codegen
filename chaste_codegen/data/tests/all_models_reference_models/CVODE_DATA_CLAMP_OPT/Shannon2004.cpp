...
// LCOV_EXCL_STOP
        ...
        const double var_IKr__i_Kr_converted = 0.43033148291193518 * _lt_0_row[10] * sqrt(NV_Ith_S(mParameters, 5)) * (-var_reversal_potentials__E_K + var_chaste_interface__cell__V) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 10) * var_chaste_interface__IKr_Xr_gate__Xr; // uA_per_cm2
        ...
        const double var_Itos__i_tos_converted = (-var_reversal_potentials__E_K + var_chaste_interface__cell__V) * (0.5 * var_chaste_interface__Itos_R_gate__R_tos + var_chaste_interface__Itos_Y_gate__Y_tos) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 13) * var_chaste_interface__Itos_X_gate__X_tos; // uA_per_cm2
        ...
        const double var_INa__i_Na_converted = (0.11 * (-var_reversal_potentials__E_Na_jct + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 9) * var_INa__openProb + 0.89000000000000001 * (-var_reversal_potentials__E_Na_SL + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 9) * var_INa__openProb) * HeartConfig::Instance()->GetCapacitance(); // uA_per_cm2
...
// LCOV_EXCL_STOP
        ...
        const double var_ICaL__temp = 1625.34190074 * var_chaste_interface__ICaL_d_gate__d * var_chaste_interface__ICaL_f_gate__f * var_chaste_interface__cell__V; // coulomb_per_mole
        const double var_ICaL__i_CaL_Ca_SL = 0.40000000000000002 * _lt_0_row[3] * (-0.34100000000000003 * NV_Ith_S(mParameters, 4) + 0.34100000000000003 * var_chaste_interface__Ca_buffer__Ca_SL * _lt_0_row[2]) * NV_Ith_S(mParameters, 7) * var_ICaL__temp * var_ICaL_fCa_gate__fCa_SL; // microA_per_microF
        const double var_ICaL__i_CaL_Ca_jct = 3.6000000000000001 * _lt_0_row[3] * (-0.34100000000000003 * NV_Ith_S(mParameters, 4) + 0.34100000000000003 * var_chaste_interface__Ca_buffer__Ca_jct * _lt_0_row[2]) * NV_Ith_S(mParameters, 7) * var_ICaL__temp * var_ICaL_fCa_gate__fCa_jct; // microA_per_microF
        const double var_ICaL__i_CaL_Na_SL = 1.5e-9 * _lt_0_row[1] * (-0.75 * NV_Ith_S(mParameters, 6) + 0.75 * var_chaste_interface__Na_buffer__Na_SL * _lt_0_row[0]) * var_ICaL__temp * var_ICaL_fCa_gate__fCa_SL; // microA_per_microF
        const double var_ICaL__i_CaL_Na_jct = 1.3499999999999998e-8 * _lt_0_row[1] * (-0.75 * NV_Ith_S(mParameters, 6) + 0.75 * var_chaste_interface__Na_buffer__Na_jct * _lt_0_row[0]) * var_ICaL__temp * var_ICaL_fCa_gate__fCa_jct; // microA_per_microF
        const double var_ICap__Q_SLCaP = 1; // dimensionless
        ...
        const double var_reversal_potentials__E_Na_SL = 26.713302585894176 * log(NV_Ith_S(mParameters, 6) / var_chaste_interface__Na_buffer__Na_SL); // millivolt
        const double var_INa__i_Na_SL = 0.89000000000000001 * (-var_reversal_potentials__E_Na_SL + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 9) * var_INa__openProb; // microA_per_microF
        ...
        const double var_reversal_potentials__E_Na_jct = 26.713302585894176 * log(NV_Ith_S(mParameters, 6) / var_chaste_interface__Na_buffer__Na_jct); // millivolt
        const double var_INa__i_Na_jct = 0.11 * (-var_reversal_potentials__E_Na_jct + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 9) * var_INa__openProb; // microA_per_microF
