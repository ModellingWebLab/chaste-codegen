...
class Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables(const Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables> Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt::Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt::~Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_calcium_background_current__i_Ca_b = 0.00038420000000000001 * var_chaste_interface__membrane__V - 0.0051306426321243524 * log(NV_Ith_S(mParameters, 5) / var_calcium_dynamics__Ca_i); // microA_per_microF
        const double var_Na_Ca_exchanger__i_NaCa = (pow(NV_Ith_S(mParameters, 4), 3) * NV_Ith_S(mParameters, 5) * _lt_0_row[6] - pow(NV_Ith_S(mParameters, 7), 3) * var_calcium_dynamics__Ca_i * _lt_0_row[7]) * NV_Ith_S(mParameters, 17) / ((_lt_0_row[8]) * (1380.0 + NV_Ith_S(mParameters, 5)) * (669921.875 + pow(NV_Ith_S(mParameters, 7), 3))); // microA_per_microF
    ...
    N_Vector Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellfox_mcharg_gilmour_2002FromCellMLCvodeDataClampOpt>::Initialise(void)
{
