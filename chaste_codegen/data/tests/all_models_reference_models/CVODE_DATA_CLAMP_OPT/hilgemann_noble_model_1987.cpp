...
class Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables(const Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables> Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt::Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 10) = 50.0; // (var_fast_sodium_current__g_Na) [microS]
        ...
        NV_Ith_S(this->mParameters, 13) = 1.7; // (var_time_independent_potassium_current__g_K1) [microS]
        NV_Ith_S(this->mParameters, 14) = 0.01; // (var_Na_Ca_exchanger__k_NaCa) [nanoA]
    }

    Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt::~Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);

        const double var_Na_Ca_exchanger__i_NaCa_converted = 0.001 * (pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) * var_chaste_interface__extracellular_calcium_concentration__Ca_o * _lt_0_row[0] - pow(NV_Ith_S(mParameters, 6), 3.0) * var_chaste_interface__intracellular_calcium_concentration__Ca_i * _lt_0_row[1]) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 14) / ((1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) * (1.0 + 0.0001 * pow(NV_Ith_S(mParameters, 6), 3.0) * var_chaste_interface__intracellular_calcium_concentration__Ca_i + 0.0001 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) * var_chaste_interface__extracellular_calcium_concentration__Ca_o) * NV_Ith_S(mParameters, 8)); // uA_per_cm2
    ...
    void Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    N_Vector Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_time_independent_potassium_current__i_K1 = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 5) * NV_Ith_S(mParameters, 13) / ((1.0 + exp(2.0 * (-10.0 - var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) / var_membrane__RTONF)) * (NV_Ith_S(mParameters, 5) + var_time_independent_potassium_current__K_m_K1)); // nanoA
...
template<>
void OdeSystemInformation<Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellhilgemann_noble_model_1987FromCellMLCvodeDataClampOpt)
