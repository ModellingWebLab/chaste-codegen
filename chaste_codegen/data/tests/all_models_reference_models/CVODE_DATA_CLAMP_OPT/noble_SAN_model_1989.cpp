...
class Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables(const Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables> Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    double Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt::Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt::~Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_hyperpolarising_activated_current__i_fK = pow(var_chaste_interface__hyperpolarising_activated_current_y_gate__y, 2) * (-var_hyperpolarising_activated_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 1) * NV_Ith_S(mParameters, 8) / (45.0 + NV_Ith_S(mParameters, 1)); // nanoA
        const double var_hyperpolarising_activated_current__i_fNa = pow(var_chaste_interface__hyperpolarising_activated_current_y_gate__y, 2) * (-var_hyperpolarising_activated_current__E_Na + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 1) * NV_Ith_S(mParameters, 9) / (45.0 + NV_Ith_S(mParameters, 1)); // nanoA
        ...
        const double var_time_dependent_potassium_current__i_K = 0.0071428571428571426 * (-NV_Ith_S(mParameters, 1) * _lt_0_row[6] + var_chaste_interface__intracellular_potassium_concentration__Ki) * NV_Ith_S(mParameters, 6) * var_chaste_interface__time_dependent_potassium_current_x_gate__x; // nanoA
        ...
        {
            d_dt_chaste_interface_var_membrane__V = 0.001 * (-var_Na_Ca_exchanger__i_NaCa - var_calcium_background_current__i_Ca_b - var_fast_sodium_current__i_Na - var_hyperpolarising_activated_current__i_fK - var_hyperpolarising_activated_current__i_fNa - var_second_inward_current__i_siCa - var_second_inward_current__i_siK - var_second_inward_current__i_siNa - var_sodium_background_current__i_Na_b - var_sodium_potassium_pump__i_p - var_time_dependent_potassium_current__i_K - var_time_independent_potassium_current__i_K1 - (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time_converted) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 5)) / NV_Ith_S(mParameters, 4); // millivolt / millisecond
        }
    ...
    N_Vector Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellnoble_SAN_model_1989FromCellMLCvodeDataClampOpt)
