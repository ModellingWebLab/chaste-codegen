...
class Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables(const Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
std::shared_ptr<Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables> Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt::Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 5) = 7.7999999999999998; // (var_fast_sodium_current__g_Na) [nanoS_per_picoF]
        NV_Ith_S(this->mParameters, 6) = 0.14999999999999999; // (var_time_independent_potassium_current__g_K1) [nanoS_per_picoF]
        NV_Ith_S(this->mParameters, 7) = 0.069839999999999999; // (var_rapid_delayed_rectifier_K_current__g_Kr) [nanoS_per_picoF]
    }

    Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt::~Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
        ...
        const double var_rapid_delayed_rectifier_K_current__i_Kr_converted = (_lt_0_row[5]) * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 7) * var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr; // uA_per_cm2
        ...
        const double var_time_independent_potassium_current__i_K1_converted = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 6) / (_lt_0_row[6]); // uA_per_cm2
    ...
    void Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_time_independent_potassium_current__E_K = 26.712831923985377 * log(NV_Ith_S(mParameters, 1) / var_chaste_interface__intracellular_ion_concentrations__K_i); // millivolt
        const double var_rapid_delayed_rectifier_K_current__i_Kr = (_lt_0_row[5]) * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 7) * var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr; // picoA_per_picoF
        const double var_slow_delayed_rectifier_K_current__i_Ks = 0.056099999999999997 * pow(var_chaste_interface__slow_delayed_rectifier_K_current_xs_gate__xs, 2) * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V); // picoA_per_picoF
        const double var_time_independent_potassium_current__i_K1 = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 6) / (_lt_0_row[6]); // picoA_per_picoF
    ...
    N_Vector Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        NV_Ith_S(dqs, 4) = var_rapid_delayed_rectifier_K_current__i_Kr_converted;
...
template<>
void OdeSystemInformation<Cellramirez_nattel_courtemanche_2000FromCellMLCvodeDataClampOpt>::Initialise(void)
{
