...
class Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables(const Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables> Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt::Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt::~Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_time_independent_potassium_current__E_K = 26.712831923985377 * log(NV_Ith_S(mParameters, 5) / var_chaste_interface__intracellular_ion_concentrations__K_i); // millivolt
        const double var_rapid_delayed_rectifier_K_current__i_Kr = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 9) * NV_Ith_S(mParameters, 15) * var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr / (_lt_0_row[5]); // picoA
        ...
        const double var_time_independent_potassium_current__i_K1 = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 9) * NV_Ith_S(mParameters, 14) / (_lt_0_row[6]); // picoA
    ...
    N_Vector Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellcourtemanche_ramirez_nattel_1998FromCellMLCvodeDataClampOpt>::Initialise(void)
{
