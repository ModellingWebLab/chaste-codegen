...
class Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables(const Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables> Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt::Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 10) = 13.0; // (var_fast_sodium_current__g_Na) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 11) = 0; // (var_fast_sodium_current__shift_INa_inact) [millivolt]
        NV_Ith_S(this->mParameters, 12) = 0.29380000000000001; // (var_time_independent_potassium_current__g_K1) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 13) = 0.032399999999999998; // (var_non_inactivating_steady_state_potassium_current__g_Kss) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 14) = 0.078; // (var_rapid_delayed_rectifier_potassium_current__g_Kr) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 15) = 0.0057499999999999999; // (var_slow_delayed_rectifier_potassium_current__g_Ks) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 16) = 292.80000000000001; // (var_sodium_calcium_exchange_current__k_NaCa) [picoA_per_picoF]
        NV_Ith_S(this->mParameters, 17) = 0.079799999999999996; // (var_fast_transient_outward_potassium_current__g_Kto_f) [milliS_per_microF]
    }

    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt::~Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
        ...
        const double var_fast_sodium_current__i_Na_converted = (-var_fast_sodium_current__E_Na + var_chaste_interface__membrane__V) * HeartConfig::Instance()->GetCapacitance() * var_chaste_interface__fast_sodium_current__O_Na * NV_Ith_S(mParameters, 10); // uA_per_cm2
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current__alpha_Na2 = 1 / (0.39395599999999997 + 0.188495 * exp(-0.42168674698795178 + 0.060240963855421679 * NV_Ith_S(mParameters, 11) - 0.060240963855421679 * var_chaste_interface__membrane__V)); // per_millisecond
        ...
        const double var_slow_delayed_rectifier_potassium_current__i_Ks = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 2) * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 15); // picoA_per_picoF
        ...
        const double var_fast_sodium_current__E_Na = 25.674321243523316 * log((NV_Ith_S(mParameters, 6) + 0.1111111111111111 * NV_Ith_S(mParameters, 5)) / (var_chaste_interface__sodium_concentration__Nai + 0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki)); // millivolt
        const double var_fast_sodium_current__i_Na = (-var_fast_sodium_current__E_Na + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current__O_Na * NV_Ith_S(mParameters, 10); // picoA_per_picoF
    ...
    N_Vector Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        if (mDataClampIsOn)
        {
            var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 9); // uA_per_cm2
        }
        ...
        NV_Ith_S(dqs, 9) = var_sodium_calcium_exchange_current__i_NaCa_converted;
        NV_Ith_S(dqs, 10) = var_membrane__i_stim_converted;
        NV_Ith_S(dqs, 11) = var_fast_transient_outward_potassium_current__i_Kto_f_converted;
        NV_Ith_S(dqs, 12) = var_chaste_interface__environment__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbondarenko_szigeti_bett_kim_rasmusson_2004_septalFromCellMLCvodeDataClampOpt)
