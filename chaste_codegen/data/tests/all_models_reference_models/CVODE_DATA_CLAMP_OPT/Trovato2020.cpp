...
class CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables(const CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables&);
    CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables& operator= (const CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables&);
    CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables> CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> CellTrovato2020FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double CellTrovato2020FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    CellTrovato2020FromCellMLCvodeDataClampOpt::CellTrovato2020FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<CellTrovato2020FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    CellTrovato2020FromCellMLCvodeDataClampOpt::~CellTrovato2020FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* CellTrovato2020FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double CellTrovato2020FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = CellTrovato2020FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
        ...
        const double var_INaCa_i__hca = exp(0.16700000000000001 * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 3) / (NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15))); // dimensionless
        const double var_INaCa_i__hna = exp(0.52239999999999998 * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 3) / (NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15))); // dimensionless
        ...
        const double var_INaK__Knai = 9.0730000000000004 * exp(-0.051666666666666666 * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 3) / (NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15))); // millimolar
        const double var_INaK__Knao = 27.780000000000001 * exp(0.38500000000000001 * var_chaste_interface__membrane__v * NV_Ith_S(mParameters, 3) / (NV_Ith_S(mParameters, 4) * NV_Ith_S(mParameters, 15))); // millimolar
        ...
        const double var_Ito__Ito_converted = (-var_reversal_potentials__EK + var_chaste_interface__membrane__v) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 14) * var_chaste_interface__Ito__a * var_chaste_interface__Ito__i1 * var_chaste_interface__Ito__i2; // uA_per_cm2
    ...
    void CellTrovato2020FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_IKr__IKr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 1)) * (-var_reversal_potentials__EK + var_chaste_interface__membrane__v) * ((1.0 - var_IKr__Axrf) * var_chaste_interface__IKr__xrs + var_IKr__Axrf * var_chaste_interface__IKr__xrf) * NV_Ith_S(mParameters, 12) / ((_lt_0_row[2]) * (_lt_0_row[3])); // microA_per_microF
    ...
    N_Vector CellTrovato2020FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<CellTrovato2020FromCellMLCvodeDataClampOpt>::Initialise(void)
{
