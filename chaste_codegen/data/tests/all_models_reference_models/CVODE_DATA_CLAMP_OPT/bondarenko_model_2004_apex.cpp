...
class Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables(const Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables> Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt::Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt::~Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    N_Vector Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbondarenko_model_2004_apexFromCellMLCvodeDataClampOpt)
