...
class Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables(const Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables&);
    Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables&);
    Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__cell__V) {
                    return ((fabs(10.0 + var_chaste_interface__cell__V) < 6.2400000011564316e-7) ? (1 / (801282.05113355326 * (10.000000624 + var_chaste_interface__cell__V) * (45787545.779060178 * (1.0 - exp(1.0000000001853256e-7)) / (1.0 + exp(1.0000000001853256e-7)) + 45787545.779060178 * (1.0 - exp(-1.0000000001853256e-7)) / (1.0 + exp(-1.0000000001853256e-7))) - 45787545.779060178 * (1.0 - exp(1.0000000001853256e-7)) / (1.0 + exp(1.0000000001853256e-7)))) : (0.035000000000000003 * (1.0 + exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__cell__V)) * (10.0 + var_chaste_interface__cell__V) / (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__cell__V))));
                };
                const double var_chaste_interface__cell__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__cell__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
...
private:
    ...
    static std::shared_ptr<Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables> Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt::Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 9) = 16.0; // (var_INa__GNa) [mS_per_uF]
        NV_Ith_S(this->mParameters, 10) = 0; // (var_INa__perc_reduced_inact_for_IpNa) [dimensionless]
        NV_Ith_S(this->mParameters, 11) = 0; // (var_INa__shift_h) [mV]
        NV_Ith_S(this->mParameters, 12) = 0.02614; // (var_IKr__gkrmax) [mS_per_uF]
        NV_Ith_S(this->mParameters, 13) = 0.433; // (var_IKs__GKsmax) [mS_per_uF]
        NV_Ith_S(this->mParameters, 14) = 0.00025000000000000001; // (var_INaCa__c1) [uA_per_uF]
    }

    Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt::~Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_INa__aH = 0.13500000000000001 * var_INa__a * exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 11) - 0.14705882352941177 * var_chaste_interface__cell__V); // per_ms
        const double var_INa__aj = (37.780000000000001 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.24440000000000001 * var_chaste_interface__cell__V - 0.24440000000000001 * NV_Ith_S(mParameters, 11)) - 3.4740000000000003e-5 * exp(0.043909999999999998 * NV_Ith_S(mParameters, 11) - 0.043909999999999998 * var_chaste_interface__cell__V)) * var_INa__a / (_lt_0_row[23]); // per_ms
        const double var_INa__bH = (3.5600000000000001 * exp(0.079000000000000001 * var_chaste_interface__cell__V - 0.079000000000000001 * NV_Ith_S(mParameters, 11)) + 310000.0 * exp(0.34999999999999998 * var_chaste_interface__cell__V - 0.34999999999999998 * NV_Ith_S(mParameters, 11))) * var_INa__a + 7.6923076923076916 * (1.0 - var_INa__a) / (_lt_0_row[24]); // per_ms
        const double var_INa__bj = 0.1212 * var_INa__a * exp(0.01052 * NV_Ith_S(mParameters, 11) - 0.01052 * var_chaste_interface__cell__V) / (_lt_0_row[25]) + 0.29999999999999999 * (1.0 - var_INa__a) * exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 11) - 2.5349999999999999e-7 * var_chaste_interface__cell__V) / (_lt_0_row[26]); // per_ms
        ...
        const double d_dt_chaste_interface_var_INa__H = (var_INa__aH + var_INa__bH) * (-var_chaste_interface__INa__H + 0.01 * NV_Ith_S(mParameters, 10) + (1.0 - 0.01 * NV_Ith_S(mParameters, 10)) * var_INa__aH / (var_INa__aH + var_INa__bH)); // 1 / ms
        const double d_dt_chaste_interface_var_INa__J = (var_INa__aj + var_INa__bj) * (-var_chaste_interface__INa__J + 0.01 * NV_Ith_S(mParameters, 10) + (1.0 - 0.01 * NV_Ith_S(mParameters, 10)) * var_INa__aj / (var_INa__aj + var_INa__bj)); // 1 / ms
        const double var_INaCa__inaca = (-pow(NV_Ith_S(mParameters, 6), 3) * var_Ca__Ca_i + pow(var_chaste_interface__Na__Na_i, 3) * NV_Ith_S(mParameters, 4) * _lt_0_row[0]) * NV_Ith_S(mParameters, 14) * _lt_0_row[1] / (1.0 + 0.0001 * (pow(NV_Ith_S(mParameters, 6), 3) * var_Ca__Ca_i + pow(var_chaste_interface__Na__Na_i, 3) * NV_Ith_S(mParameters, 4) * _lt_0_row[0]) * _lt_0_row[1]); // uA_per_uF
        const double var_INaK__inak = 2.25 / ((1.0 + 1.5 / NV_Ith_S(mParameters, 5)) * (1.0 + 100.0 / pow(var_chaste_interface__Na__Na_i, 2)) * (1.0 + _lt_0_row[3] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * NV_Ith_S(mParameters, 6))) * _lt_0_row[2])); // uA_per_uF
        ...
        {
            d_dt_chaste_interface_var_cell__V = -var_cell__caiont - var_cell__kiont - var_cell__naiont - (-GetExperimentalVoltageAtTimeT(var_chaste_interface__Environment__time) + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 8); // mV / ms
        }
    ...
    N_Vector Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_IKr__gkr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 5)) * NV_Ith_S(mParameters, 12); // mS_per_uF
        const double var_IKs__gks = (1.0 + 0.59999999999999998 / (1.0 + 6.4818210260626455e-7 * pow((1 / var_Ca__Ca_i), 1.3999999999999999))) * NV_Ith_S(mParameters, 13); // mS_per_uF
        ...
        const double var_INa__ina = pow(var_chaste_interface__INa__m, 3) * (-var_reversal_potentials__ENa + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 9) * var_chaste_interface__INa__H * var_chaste_interface__INa__J; // uA_per_uF
        ...
        NV_Ith_S(dqs, 5) = var_INa__tau_H;
        NV_Ith_S(dqs, 6) = var_INa__tau_j;
        NV_Ith_S(dqs, 7) = var_IK1__IK1_converted;
        NV_Ith_S(dqs, 8) = var_IK1__GK1_;
        NV_Ith_S(dqs, 9) = var_IK1__gK1;
        NV_Ith_S(dqs, 10) = var_IKr__ikr_converted;
        NV_Ith_S(dqs, 11) = var_IKr__gkr;
        NV_Ith_S(dqs, 12) = var_IKs__iks_converted;
        NV_Ith_S(dqs, 13) = var_IKs__gks;
        NV_Ith_S(dqs, 14) = var_INaCa__inaca_converted;
        NV_Ith_S(dqs, 15) = var_cell__i_Stim_converted;
        NV_Ith_S(dqs, 16) = var_chaste_interface__Environment__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celllivshitz_rudy_2007FromCellMLCvodeDataClampOpt)
