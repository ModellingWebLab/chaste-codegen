...
class Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__E)
    {
        ...
        const double* const _lt_0_row = Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables(const Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables&);
    Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables&);
    Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables> Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    double Celldokos_model_1996FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Celldokos_model_1996FromCellMLCvodeDataClampOpt::Celldokos_model_1996FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celldokos_model_1996FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Celldokos_model_1996FromCellMLCvodeDataClampOpt::~Celldokos_model_1996FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Celldokos_model_1996FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Celldokos_model_1996FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__E);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celldokos_model_1996FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__E);
    ...
    void Celldokos_model_1996FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__E = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_fast_sodium_current_m_gate__m = -8.0 * var_chaste_interface__fast_sodium_current_m_gate__m * _lt_0_row[15] + 0.20000000000000001 * (1.0 - var_chaste_interface__fast_sodium_current_m_gate__m) * (34.299999999999997 + var_chaste_interface__membrane__E) / (_lt_0_row[16]); // 1 / millisecond
        const double d_dt_chaste_interface_var_hyperpolarising_activated_current_y_gate__y = 0.00035999999999999997 * (1.0 - var_chaste_interface__hyperpolarising_activated_current_y_gate__y) * (137.80000000000001 + var_chaste_interface__membrane__E) / (_lt_0_row[17]) - 0.0001 * (76.299999999999997 + var_chaste_interface__membrane__E) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / (_lt_0_row[18]); // 1 / millisecond
        const double var_reversal_potentials__E_Ca = 13.356880329847826 * log(var_chaste_interface__ion_concentrations__Cao / var_chaste_interface__ion_concentrations__Cai); // millivolt
        ...
        const double var_hyperpolarising_activated_current__i_fK = pow(var_chaste_interface__ion_concentrations__Ko, 1.8300000000000001) * (-26.713760659695652 * log(var_chaste_interface__ion_concentrations__Ko / var_chaste_interface__ion_concentrations__Ki) + var_chaste_interface__membrane__E) * NV_Ith_S(mParameters, 5) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / (71.36612580598495 + pow(var_chaste_interface__ion_concentrations__Ko, 1.8300000000000001)); // picoA
        const double var_reversal_potentials__E_Na = 26.713760659695652 * log(var_chaste_interface__ion_concentrations__Nao / var_chaste_interface__ion_concentrations__Nai); // millivolt
    ...
    N_Vector Celldokos_model_1996FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__E = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Celldokos_model_1996FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celldokos_model_1996FromCellMLCvodeDataClampOpt)
