...
class Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables(const Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables> Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellnoble_model_1991FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellnoble_model_1991FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellnoble_model_1991FromCellMLCvodeDataClampOpt::Cellnoble_model_1991FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnoble_model_1991FromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 11) = 1.0; // (var_time_dependent_potassium_current__i_K_max) [nanoA]
        ...
        NV_Ith_S(this->mParameters, 15) = 1.0; // (var_time_independent_potassium_current__g_K1) [microS]
        NV_Ith_S(this->mParameters, 16) = 0.00050000000000000001; // (var_sodium_calcium_exchanger__k_NaCa) [nanoA]
        NV_Ith_S(this->mParameters, 17) = 0.0050000000000000001; // (var_transient_outward_current__g_to) [microS]
    }

    Cellnoble_model_1991FromCellMLCvodeDataClampOpt::~Cellnoble_model_1991FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellnoble_model_1991FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellnoble_model_1991FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellnoble_model_1991FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellnoble_model_1991FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_time_dependent_potassium_current__i_K = 0.0071428571428571426 * (-NV_Ith_S(mParameters, 6) * _lt_0_row[6] + var_chaste_interface__intracellular_potassium_concentration__K_i) * NV_Ith_S(mParameters, 11) * var_chaste_interface__time_dependent_potassium_current_x_gate__x; // nanoA
        ...
        const double var_transient_outward_current__i_to = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 17) * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // nanoA
    ...
    N_Vector Cellnoble_model_1991FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_time_dependent_potassium_current__I_K = 0.0071428571428571426 * (-NV_Ith_S(mParameters, 6) * exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + var_chaste_interface__intracellular_potassium_concentration__K_i) * NV_Ith_S(mParameters, 11); // nanoA
        ...
        const double var_time_independent_potassium_current__i_K1 = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 6) * NV_Ith_S(mParameters, 15) / ((1.0 + exp(2.0 * (-10.0 - var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_membrane__F / (var_membrane__R * var_membrane__T))) * (NV_Ith_S(mParameters, 6) + var_time_independent_potassium_current__K_mk1)); // nanoA
...
template<>
void OdeSystemInformation<Cellnoble_model_1991FromCellMLCvodeDataClampOpt>::Initialise(void)
{
