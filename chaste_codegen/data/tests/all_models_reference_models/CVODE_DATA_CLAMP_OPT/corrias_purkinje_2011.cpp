...
class Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__Vm)
    {
        ...
        const double* const _lt_0_row = Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables(const Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables> Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt::Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 10) = 1140.0; // (var_i_na_fast__G_max_na_fast) [conductance_units]
        NV_Ith_S(this->mParameters, 11) = 0; // (var_y_na_fast__shift_INa_inact) [voltage_units]
        NV_Ith_S(this->mParameters, 12) = 20.0; // (var_i_k1__G_max_k1) [conductance_units]
        NV_Ith_S(this->mParameters, 13) = 1.5; // (var_i_kr__G_max_kr) [conductance_units]
        NV_Ith_S(this->mParameters, 14) = 3.0; // (var_i_ks__G_max_ks) [conductance_units]
        NV_Ith_S(this->mParameters, 15) = 0.001; // (var_i_naca__g_NaCa) [current_units]
        NV_Ith_S(this->mParameters, 16) = 10.0; // (var_i_to_fast__G_max_to_fast) [conductance_units]
    }

    Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt::~Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__Vm);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
        ...
        const double var_i_to_fast__i_to_fast_converted = 9.9999999999999995e-7 * (-26.713760659695652 * log(NV_Ith_S(mParameters, 5) / var_chaste_interface__membrane__K_i) + var_chaste_interface__membrane__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 16) * var_chaste_interface__x_to_fast__x_to_fast * var_chaste_interface__y_to_fast__y_to_fast / var_membrane__Cm_converted; // uA_per_cm2
    ...
    void Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__Time__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_i_k1__i_k1 = 0.25946870969507452 * pow(NV_Ith_S(mParameters, 5), 0.80000000000000004) * (-26.713760659695652 * log(NV_Ith_S(mParameters, 5) / var_chaste_interface__membrane__K_i) + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 12) / (_lt_0_row[2]); // current_units
        ...
        const double var_i_kr__i_kr = 0.18518518518518517 * (-26.713760659695652 * log(NV_Ith_S(mParameters, 5) / var_chaste_interface__membrane__K_i) + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 5) * NV_Ith_S(mParameters, 13) * var_chaste_interface__y_kr__y_kr / (_lt_0_row[4]); // current_units
        ...
        const double var_i_ks__i_ks = (-26.713760659695652 * log(NV_Ith_S(mParameters, 5) / var_chaste_interface__membrane__K_i) + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 14) * var_chaste_interface__x_ks__x_ks * var_chaste_interface__y_ks__y_ks; // current_units
        const double d_dt_chaste_interface_var_y_na_fast__y_na_fast = 0.5 / (1.0 + exp(17.424242424242426 + 0.25252525252525254 * var_chaste_interface__membrane__Vm - 0.25252525252525254 * NV_Ith_S(mParameters, 11))) - 0.5 * var_chaste_interface__y_na_fast__y_na_fast; // 1 / time_units
        const double var_i_na_fast__i_na_fast = (-26.713760659695652 * log(NV_Ith_S(mParameters, 6) / var_chaste_interface__membrane__Na_i) + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 10) * var_chaste_interface__x_na_fast__x_na_fast * var_chaste_interface__y_na_fast__y_na_fast; // current_units
        ...
        const double var_i_to_fast__i_to_fast = (-26.713760659695652 * log(NV_Ith_S(mParameters, 5) / var_chaste_interface__membrane__K_i) + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 16) * var_chaste_interface__x_to_fast__x_to_fast * var_chaste_interface__y_to_fast__y_to_fast; // current_units
    ...
    N_Vector Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__Time__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        if (mDataClampIsOn)
        {
            var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__Time__time) + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 9); // uA_per_cm2
        }
        const double var_x_k1__x_k1 = 1 / (_lt_0_row[2]); // dimensionless
        const double var_i_k1__i_k1 = 0.25946870969507452 * pow(NV_Ith_S(mParameters, 5), 0.80000000000000004) * (-var_i_k1__E_k + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 12) * var_x_k1__x_k1; // current_units
        ...
        const double var_i_kr__i_kr = 0.18518518518518517 * (-var_i_kr__E_k + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 5) * NV_Ith_S(mParameters, 13) * var_x_kr__x_kr * var_chaste_interface__y_kr__y_kr; // current_units
        ...
        const double var_i_ks__i_ks = (-var_i_ks__E_k + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 14) * var_chaste_interface__x_ks__x_ks * var_chaste_interface__y_ks__y_ks; // current_units
        ...
        const double var_i_na_fast__i_na_fast = (-var_i_na_fast__E_na + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 10) * var_chaste_interface__x_na_fast__x_na_fast * var_chaste_interface__y_na_fast__y_na_fast; // current_units
        ...
        const double var_i_to_fast__i_to_fast = (-var_i_to_fast__E_k + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 16) * var_chaste_interface__x_to_fast__x_to_fast * var_chaste_interface__y_to_fast__y_to_fast; // current_units
        ...
        NV_Ith_S(dqs, 4) = var_i_na_fast__i_na_fast_converted;
        NV_Ith_S(dqs, 5) = var_i_k1__i_k1_converted;
        NV_Ith_S(dqs, 6) = var_i_kr__i_kr_converted;
        NV_Ith_S(dqs, 7) = var_i_ks__i_ks_converted;
        NV_Ith_S(dqs, 8) = var_i_naca__i_naca_converted;
        NV_Ith_S(dqs, 9) = var_membrane__i_stim_converted;
        NV_Ith_S(dqs, 10) = var_i_to_fast__i_to_fast_converted;
        NV_Ith_S(dqs, 11) = var_chaste_interface__Time__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellcorrias_purkinje_2011FromCellMLCvodeDataClampOpt>::Initialise(void)
{
