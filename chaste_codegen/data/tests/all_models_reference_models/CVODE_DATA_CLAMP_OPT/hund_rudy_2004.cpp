...
class Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables(const Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables> Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellhund_rudy_2004FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellhund_rudy_2004FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellhund_rudy_2004FromCellMLCvodeDataClampOpt::Cellhund_rudy_2004FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellhund_rudy_2004FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellhund_rudy_2004FromCellMLCvodeDataClampOpt::~Cellhund_rudy_2004FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellhund_rudy_2004FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellhund_rudy_2004FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellhund_rudy_2004FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellhund_rudy_2004FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_INa__H = (var_INa__ah + var_INa__bh) * (-var_chaste_interface__INa__H + 0.01 * NV_Ith_S(mParameters, 12) + (1.0 - 0.01 * NV_Ith_S(mParameters, 12)) * var_INa__ah / (var_INa__ah + var_INa__bh)); // 1 / ms
        const double d_dt_chaste_interface_var_INa__J = (var_INa__aj + var_INa__bj) * (-var_chaste_interface__INa__J + 0.01 * NV_Ith_S(mParameters, 12) + (1.0 - 0.01 * NV_Ith_S(mParameters, 12)) * var_INa__aj / (var_INa__aj + var_INa__bj)); // 1 / ms
        const double var_INaCa__INaCa = (pow(var_chaste_interface__Na__Na_i, 3) * NV_Ith_S(mParameters, 5) * _lt_0_row[0] - pow(NV_Ith_S(mParameters, 8), 3) * var_INaCa__ca_i_NaCa * _lt_0_row[1]) * NV_Ith_S(mParameters, 18) / ((_lt_0_row[2]) * (1.0 + 1.5624999999999999e-8 / pow(var_INaCa__ca_i_NaCa, 2)) * (669921.875 * var_INaCa__ca_i_NaCa + 1.3 * pow(var_chaste_interface__Na__Na_i, 3) + pow(NV_Ith_S(mParameters, 8), 3) * var_INaCa__ca_i_NaCa + pow(var_chaste_interface__Na__Na_i, 3) * NV_Ith_S(mParameters, 5) + 0.0035999999999999999 * pow(NV_Ith_S(mParameters, 8), 3) * (1.0 + 0.00053738391835633597 * pow(var_chaste_interface__Na__Na_i, 3)) + 1860.8670000000004 * (1.0 + 277.77777777777777 * var_INaCa__ca_i_NaCa) * NV_Ith_S(mParameters, 5))); // uA_per_uF
        const double var_INaK__INaK = 0.61875000000000002 * NV_Ith_S(mParameters, 7) / ((1.0 + 100.0 / pow(var_chaste_interface__Na__Na_i, 2)) * (1.5 + NV_Ith_S(mParameters, 7)) * (1.0 + _lt_0_row[4] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * NV_Ith_S(mParameters, 8))) * _lt_0_row[3])); // uA_per_uF
        ...
        {
            d_dt_chaste_interface_var_cell__V = -var_ICaL__ICaL - var_ICab__ICab - var_IpCa__IpCa - var_cell__clont - var_cell__kiont - var_cell__naiont + 2.0 * var_INaCa__INaCa - (-GetExperimentalVoltageAtTimeT(var_chaste_interface__Environment__time) + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 10); // mV / ms
        }
    ...
    N_Vector Cellhund_rudy_2004FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_Environment__tissue = 0; // dimensionless
        const double var_IK1__g_K1_calc = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 7)) * NV_Ith_S(mParameters, 14); // mS_per_uF
        const double var_IKr__gkr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 7)) * NV_Ith_S(mParameters, 16); // mS_per_uF
        ...
        if (mDataClampIsOn)
        {
            var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__Environment__time) + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 10); // uA_per_cm2
        }
...
template<>
void OdeSystemInformation<Cellhund_rudy_2004FromCellMLCvodeDataClampOpt>::Initialise(void)
{
