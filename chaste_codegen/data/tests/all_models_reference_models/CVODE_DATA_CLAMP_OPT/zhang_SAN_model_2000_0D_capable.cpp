...
class Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables(const Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables> Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt::Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 8) = 1.0; // (var_hyperpolarisation_activated_current__g_f_K_factor) [dimensionless]
        NV_Ith_S(this->mParameters, 9) = 1.0; // (var_hyperpolarisation_activated_current__g_f_Na_factor) [dimensionless]
        NV_Ith_S(this->mParameters, 10) = 1.0; // (var_rapid_delayed_rectifying_potassium_current__g_K_r_Scaling) [dimensionless]
    }

    Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt::~Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
        ...
        const double var_hyperpolarisation_activated_current__i_f_K = (0.0005465 + 0.0063284999999999999 * var_membrane__FCell) * (-var_reversal_and_equilibrium_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 8) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y; // nanoA
        ...
        const double var_hyperpolarisation_activated_current__i_f_Na = (0.0005465 + 0.0063284999999999999 * var_membrane__FCell) * (-var_reversal_and_equilibrium_potentials__E_Na + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 9) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y; // nanoA
    ...
    void Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    N_Vector Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        if (mDataClampIsOn)
        {
            var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time_converted) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 7); // uA_per_cm2
        }
        ...
        const double var_hyperpolarisation_activated_current__i_f_K = (-var_reversal_and_equilibrium_potentials__E_K + var_chaste_interface__membrane__V) * var_hyperpolarisation_activated_current__g_f_K * NV_Ith_S(mParameters, 8) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y; // nanoA
        ...
        const double var_hyperpolarisation_activated_current__i_f_Na = (-var_reversal_and_equilibrium_potentials__E_Na + var_chaste_interface__membrane__V) * var_hyperpolarisation_activated_current__g_f_Na * NV_Ith_S(mParameters, 9) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y; // nanoA
        ...
        NV_Ith_S(dqs, 6) = var_rapid_delayed_rectifying_potassium_current__i_K_r_converted;
        NV_Ith_S(dqs, 7) = var_chaste_interface__environment__time_converted;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellzhang_SAN_model_2000_0D_capableFromCellMLCvodeDataClampOpt>::Initialise(void)
{
