...
class Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables(const Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables> Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt::Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt::~Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_INa__bj = ((var_chaste_interface__cell__V < -40.0) ? (0.1212 * exp(0.01052 * NV_Ith_S(mParameters, 14) - 0.01052 * var_chaste_interface__cell__V) / (_lt_0_row[12])) : (0.29999999999999999 * exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 14) - 2.5349999999999999e-7 * var_chaste_interface__cell__V) / (_lt_0_row[13]))); // per_ms
        ...
        const double d_dt_chaste_interface_var_INa__xh = (var_INa__ah + var_INa__bh) * (-var_chaste_interface__INa__xh + 0.01 * NV_Ith_S(mParameters, 13) + (1.0 - 0.01 * NV_Ith_S(mParameters, 13)) * var_INa__ah / (var_INa__ah + var_INa__bh)); // 1 / ms
        const double d_dt_chaste_interface_var_INa__xj = (var_INa__aj + var_INa__bj) * (-var_chaste_interface__INa__xj + 0.01 * NV_Ith_S(mParameters, 13) + (1.0 - 0.01 * NV_Ith_S(mParameters, 13)) * var_INa__aj / (var_INa__aj + var_INa__bj)); // 1 / ms
        ...
        const double var_INa__xina = pow(var_chaste_interface__INa__xm, 3) * (-log(NV_Ith_S(mParameters, 7) / var_chaste_interface__Na__Na_i) / var_Environment__FonRT + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 12) * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj; // nA_per_nF
    ...
    N_Vector Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellmahajan_shiferaw_2008FromCellMLCvodeDataClampOpt)
