...
class Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables(const Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables> Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    Cellnoble_model_1962FromCellMLCvodeDataClampOpt::Cellnoble_model_1962FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnoble_model_1962FromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 2) = 1.2; // (var_potassium_channel__G_K_max) [milliS_per_cm2]
        NV_Ith_S(this->mParameters, 3) = 400.0; // (var_sodium_channel__g_Na_max) [milliS_per_cm2]
        NV_Ith_S(this->mParameters, 4) = 0; // (var_sodium_channel__perc_reduced_inact_for_IpNa) [dimensionless]
        NV_Ith_S(this->mParameters, 5) = 0; // (var_sodium_channel__shift_INa_inact) [millivolt]
        NV_Ith_S(this->mParameters, 6) = 0.014999999999999999; // (var_potassium_channel__G_K1_max) [milliS_per_cm2]
        NV_Ith_S(this->mParameters, 7) = 0.074999999999999997; // (var_leakage_current__g_L) [milliS_per_cm2]
    }

    Cellnoble_model_1962FromCellMLCvodeDataClampOpt::~Cellnoble_model_1962FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellnoble_model_1962FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellnoble_model_1962FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellnoble_model_1962FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);

        const double var_leakage_current__i_Leak = (60.0 + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 7); // microA_per_cm2
        const double var_potassium_channel__i_K = (100.0 + var_chaste_interface__membrane__V) * (pow(var_chaste_interface__potassium_channel_n_gate__n, 4) * NV_Ith_S(mParameters, 2) + NV_Ith_S(mParameters, 6) * _lt_0_row[0] + NV_Ith_S(mParameters, 2) * _lt_0_row[1]); // microA_per_cm2
        const double var_sodium_channel__i_Na = (0.14000000000000001 + pow(var_chaste_interface__sodium_channel_m_gate__m, 3) * NV_Ith_S(mParameters, 3) * var_chaste_interface__sodium_channel_h_gate__h) * (-40.0 + var_chaste_interface__membrane__V); // microA_per_cm2
    ...
    void Cellnoble_model_1962FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_sodium_channel_h_gate__alpha_h = 0.17000000000000001 * exp(-4.5 + 0.050000000000000003 * NV_Ith_S(mParameters, 5) - 0.050000000000000003 * var_chaste_interface__membrane__V); // per_millisecond
        const double var_sodium_channel_h_gate__beta_h = 1 / (1.0 + exp(-4.2000000000000002 + 0.10000000000000001 * NV_Ith_S(mParameters, 5) - 0.10000000000000001 * var_chaste_interface__membrane__V)); // per_millisecond
        const double d_dt_chaste_interface_var_sodium_channel_h_gate__h = (var_sodium_channel_h_gate__alpha_h + var_sodium_channel_h_gate__beta_h) * (-var_chaste_interface__sodium_channel_h_gate__h + 0.01 * NV_Ith_S(mParameters, 4) + (1.0 - 0.01 * NV_Ith_S(mParameters, 4)) * var_sodium_channel_h_gate__alpha_h / (var_sodium_channel_h_gate__alpha_h + var_sodium_channel_h_gate__beta_h)); // 1 / millisecond
        ...
        {
            d_dt_chaste_interface_var_membrane__V = (-(60.0 + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 7) - (100.0 + var_chaste_interface__membrane__V) * (pow(var_chaste_interface__potassium_channel_n_gate__n, 4) * NV_Ith_S(mParameters, 2) + NV_Ith_S(mParameters, 6) * _lt_0_row[0] + NV_Ith_S(mParameters, 2) * _lt_0_row[1]) - (0.14000000000000001 + pow(var_chaste_interface__sodium_channel_m_gate__m, 3) * NV_Ith_S(mParameters, 3) * var_chaste_interface__sodium_channel_h_gate__h) * (-40.0 + var_chaste_interface__membrane__V) - (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 1)) / NV_Ith_S(mParameters, 0); // millivolt / millisecond
        }
    ...
    N_Vector Cellnoble_model_1962FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_leakage_current__i_Leak = (-var_leakage_current__E_L + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 7); // microA_per_cm2
        ...
        const double var_potassium_channel__g_K1 = NV_Ith_S(mParameters, 6) * _lt_0_row[0] + NV_Ith_S(mParameters, 2) * _lt_0_row[1]; // milliS_per_cm2
        const double var_potassium_channel__g_K2 = pow(var_chaste_interface__potassium_channel_n_gate__n, 4) * NV_Ith_S(mParameters, 2); // milliS_per_cm2
        ...
        const double var_sodium_channel__g_Na = pow(var_chaste_interface__sodium_channel_m_gate__m, 3) * NV_Ith_S(mParameters, 3) * var_chaste_interface__sodium_channel_h_gate__h; // milliS_per_cm2
        ...
        NV_Ith_S(dqs, 1) = var_potassium_channel__i_K;
        NV_Ith_S(dqs, 2) = var_sodium_channel__i_Na;
        NV_Ith_S(dqs, 3) = var_sodium_channel_h_gate__tau_h;
        NV_Ith_S(dqs, 4) = var_leakage_current__i_Leak;
        NV_Ith_S(dqs, 5) = var_chaste_interface__environment__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellnoble_model_1962FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellnoble_model_1962FromCellMLCvodeDataClampOpt)
