...
// LCOV_EXCL_STOP
        ...
        const double var_transient_outward_current__i_to = ((fabs(10.0 + var_chaste_interface__membrane__V) < 4.9999999962579977e-7) ? (1000000.0007484005 * (10.000000500000001 + var_chaste_interface__membrane__V) * (4.9999999873762135e-7 * (0.20000000000000001 + var_chaste_interface__extracellular_potassium_concentration__Kc / (10.0 + var_chaste_interface__extracellular_potassium_concentration__Kc)) * (var_chaste_interface__intracellular_potassium_concentration__Ki * exp(-0.18716944475525468) - var_chaste_interface__extracellular_potassium_concentration__Kc * exp(0.18716944475525468)) * var_chaste_interface__intracellular_calcium_concentration__Cai * NV_Ith_S(mParameters, 18) * var_chaste_interface__transient_outward_current_s_gate__s / ((1.0 - exp(-9.9999999747524276e-8)) * (0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Cai)) + 5.0000000051397819e-7 * (0.20000000000000001 + var_chaste_interface__extracellular_potassium_concentration__Kc / (10.0 + var_chaste_interface__extracellular_potassium_concentration__Kc)) * (var_chaste_interface__intracellular_potassium_concentration__Ki * exp(-0.18716946347220006) - var_chaste_interface__extracellular_potassium_concentration__Kc * exp(0.18716946347220006)) * var_chaste_interface__intracellular_calcium_concentration__Cai * NV_Ith_S(mParameters, 18) * var_chaste_interface__transient_outward_current_s_gate__s / ((1.0 - exp(1.0000000010279565e-7)) * (0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Cai))) - 5.0000000051397819e-7 * (0.20000000000000001 + var_chaste_interface__extracellular_potassium_concentration__Kc / (10.0 + var_chaste_interface__extracellular_potassium_concentration__Kc)) * (var_chaste_interface__intracellular_potassium_concentration__Ki * exp(-0.18716946347220006) - var_chaste_interface__extracellular_potassium_concentration__Kc * exp(0.18716946347220006)) * var_chaste_interface__intracellular_calcium_concentration__Cai * NV_Ith_S(mParameters, 18) * var_chaste_interface__transient_outward_current_s_gate__s / ((1.0 - exp(1.0000000010279565e-7)) * (0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Cai))) : ((10.0 + var_chaste_interface__membrane__V) * (0.20000000000000001 + var_chaste_interface__extracellular_potassium_concentration__Kc / (10.0 + var_chaste_interface__extracellular_potassium_concentration__Kc)) * (var_chaste_interface__intracellular_potassium_concentration__Ki * _lt_0_row[7] - var_chaste_interface__extracellular_potassium_concentration__Kc * _lt_0_row[8]) * var_chaste_interface__intracellular_calcium_concentration__Cai * NV_Ith_S(mParameters, 18) * var_chaste_interface__transient_outward_current_s_gate__s / ((_lt_0_row[9]) * (0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Cai)))); // nanoA
