...
class Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane_potential__V)
    {
        ...
        const double* const _lt_0_row = Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables(const Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables&);
    Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables&);
    Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables> Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt::Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt::~Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane_potential__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane_potential__V);
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_time_dependent_rectifier_potassium_current__i_K = 0.0071428571428571426 * (_lt_0_row[8] + var_chaste_interface__intracellular_potassium_concentration__K_i) * NV_Ith_S(mParameters, 3) * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x; // nanoA
    ...
    N_Vector Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celliribe_model_2006_without_otherwise_sectionFromCellMLCvodeDataClampOpt)
