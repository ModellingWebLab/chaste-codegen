...
class Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__Vm__Vm)
    {
        ...
        const double* const _lt_0_row = Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables(const Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables> Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    double Cellmaltsev_2009FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellmaltsev_2009FromCellMLCvodeDataClampOpt::Cellmaltsev_2009FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmaltsev_2009FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellmaltsev_2009FromCellMLCvodeDataClampOpt::~Cellmaltsev_2009FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellmaltsev_2009FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellmaltsev_2009FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__Vm__Vm);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellmaltsev_2009FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__Vm__Vm);

        const double var_i_NaCa__Qco = 0; // dimensionless
        const double var_i_CaT__i_CaT = 0.1832 * (-45.0 + var_chaste_interface__Vm__Vm) * var_chaste_interface__i_CaT_dT_gate__dT * var_chaste_interface__i_CaT_fT_gate__fT * NV_Ith_S(mParameters, 10); // picoA
        const double var_i_b_Ca__i_b_Ca = 0.00059999999999999995 * (-45.0 + var_chaste_interface__Vm__Vm) * NV_Ith_S(mParameters, 10); // picoA
        const double var_i_st__i_st = 0.0030000000000000001 * (-37.399999999999999 + var_chaste_interface__Vm__Vm) * var_chaste_interface__i_st_qa_gate__qa * var_chaste_interface__i_st_qi_gate__qi * NV_Ith_S(mParameters, 10); // picoA
        const double var_model_parameters__Cm_converted = 9.9999999999999995e-7 * NV_Ith_S(mParameters, 10); // uF
        const double var_i_CaL__i_CaL_converted = 9.9999999999999995e-7 * (-45.0 + var_chaste_interface__Vm__Vm) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 5) * var_chaste_interface__i_CaL_dL_gate__dL * var_chaste_interface__i_CaL_fCa_gate__fCa * var_chaste_interface__i_CaL_fL_gate__fL * NV_Ith_S(mParameters, 10) / var_model_parameters__Cm_converted; // uA_per_cm2
        ...
        const double var_AP_sensitive_currents__i_sus = 0.02 * (-var_electric_potentials__E_K + var_chaste_interface__Vm__Vm) * var_chaste_interface__AP_sensitive_currents_r_gate__r * NV_Ith_S(mParameters, 10); // picoA
        const double var_AP_sensitive_currents__i_to = 0.252 * (-var_electric_potentials__E_K + var_chaste_interface__Vm__Vm) * var_chaste_interface__AP_sensitive_currents_q_gate__q * var_chaste_interface__AP_sensitive_currents_r_gate__r * NV_Ith_S(mParameters, 10); // picoA
        ...
        const double var_i_Kr__i_Kr_converted = 9.9999999999999995e-7 * (-var_electric_potentials__E_K + var_chaste_interface__Vm__Vm) * (0.40000000000000002 * var_chaste_interface__i_Kr_pa_gate__paS + 0.59999999999999998 * var_chaste_interface__i_Kr_pa_gate__paF) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 9) * var_chaste_interface__i_Kr_pi_gate__pi_ * NV_Ith_S(mParameters, 10) / var_model_parameters__Cm_converted; // uA_per_cm2
        const double var_i_Ks__i_Ks = 0.025899999999999999 * pow(var_chaste_interface__i_Ks_n_gate__n, 2) * (-26.726549826397882 * log((NV_Ith_S(mParameters, 3) + 0.12 * NV_Ith_S(mParameters, 4)) / (NV_Ith_S(mParameters, 0) + 0.12 * NV_Ith_S(mParameters, 1))) + var_chaste_interface__Vm__Vm) * NV_Ith_S(mParameters, 10); // picoA
    ...
    void Cellmaltsev_2009FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Vm__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_i_CaL__i_CaL = (-45.0 + var_chaste_interface__Vm__Vm) * NV_Ith_S(mParameters, 5) * var_chaste_interface__i_CaL_dL_gate__dL * var_chaste_interface__i_CaL_fCa_gate__fCa * var_chaste_interface__i_CaL_fL_gate__fL * NV_Ith_S(mParameters, 10); // picoA
        const double var_i_CaT__i_CaT = 0.1832 * (-45.0 + var_chaste_interface__Vm__Vm) * var_chaste_interface__i_CaT_dT_gate__dT * var_chaste_interface__i_CaT_fT_gate__fT * NV_Ith_S(mParameters, 10); // picoA
        const double var_i_b_Ca__i_b_Ca = 0.00059999999999999995 * (-45.0 + var_chaste_interface__Vm__Vm) * NV_Ith_S(mParameters, 10); // picoA
        ...
        else
        {
            const double var_electric_potentials__E_K = 26.726549826397882 * log(NV_Ith_S(mParameters, 3) / NV_Ith_S(mParameters, 0)); // millivolt
            const double var_electric_potentials__E_Na = 26.726549826397882 * log(NV_Ith_S(mParameters, 4) / NV_Ith_S(mParameters, 1)); // millivolt
            d_dt_chaste_interface_var_Vm__Vm = (-var_i_CaL__i_CaL - var_i_CaT__i_CaT - var_i_NaCa__i_NaCa - var_i_b_Ca__i_b_Ca - (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__Vm__Vm) * NV_Ith_S(mParameters, 6) - 0.0048599999999999997 * (-var_electric_potentials__E_Na + var_chaste_interface__Vm__Vm) * NV_Ith_S(mParameters, 10) - 0.025899999999999999 * pow(var_chaste_interface__i_Ks_n_gate__n, 2) * (-26.726549826397882 * log((NV_Ith_S(mParameters, 3) + 0.12 * NV_Ith_S(mParameters, 4)) / (NV_Ith_S(mParameters, 0) + 0.12 * NV_Ith_S(mParameters, 1))) + var_chaste_interface__Vm__Vm) * NV_Ith_S(mParameters, 10) - 0.02 * (-var_electric_potentials__E_K + var_chaste_interface__Vm__Vm) * var_chaste_interface__AP_sensitive_currents_r_gate__r * NV_Ith_S(mParameters, 10) - 0.252 * (-var_electric_potentials__E_K + var_chaste_interface__Vm__Vm) * var_chaste_interface__AP_sensitive_currents_q_gate__q * var_chaste_interface__AP_sensitive_currents_r_gate__r * NV_Ith_S(mParameters, 10) - 2.8799999999999999 * NV_Ith_S(mParameters, 10) / ((1.0 + 1.4974545260150962 * pow((1 / NV_Ith_S(mParameters, 3)), 1.2)) * (1.0 + 30.900566853219949 * pow((1 / NV_Ith_S(mParameters, 1)), 1.3)) * (1.0 + exp(-4.0 + 0.033333333333333333 * var_electric_potentials__E_Na - 0.033333333333333333 * var_chaste_interface__Vm__Vm))) - 0.0030000000000000001 * (-37.399999999999999 + var_chaste_interface__Vm__Vm) * var_chaste_interface__i_st_qa_gate__qa * var_chaste_interface__i_st_qi_gate__qi * NV_Ith_S(mParameters, 10) - 0.14999999999999999 * pow(var_chaste_interface__i_f_y_gate__y, 2) * (-var_electric_potentials__E_K + var_chaste_interface__Vm__Vm) * NV_Ith_S(mParameters, 7) * NV_Ith_S(mParameters, 10) - 0.14999999999999999 * pow(var_chaste_interface__i_f_y_gate__y, 2) * (-var_electric_potentials__E_Na + var_chaste_interface__Vm__Vm) * NV_Ith_S(mParameters, 8) * NV_Ith_S(mParameters, 10) - (-var_electric_potentials__E_K + var_chaste_interface__Vm__Vm) * (0.40000000000000002 * var_chaste_interface__i_Kr_pa_gate__paS + 0.59999999999999998 * var_chaste_interface__i_Kr_pa_gate__paF) * NV_Ith_S(mParameters, 9) * var_chaste_interface__i_Kr_pi_gate__pi_ * NV_Ith_S(mParameters, 10)) / NV_Ith_S(mParameters, 10); // millivolt / millisecond
        }
    ...
    N_Vector Cellmaltsev_2009FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Vm__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellmaltsev_2009FromCellMLCvodeDataClampOpt>::Initialise(void)
{
