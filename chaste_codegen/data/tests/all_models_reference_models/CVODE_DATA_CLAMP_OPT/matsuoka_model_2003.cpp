...
// LCOV_EXCL_STOP
        ...
        const double var_constant_field_equations__CF_Ca = 0.074870384603595908 * (-NV_Ith_S(mParameters, 5) * _lt_0_row[0] + var_internal_ion_concentrations__Cai) * var_chaste_interface__membrane__Vm / (_lt_0_row[1]); // millimolar
        const double var_constant_field_equations__CF_K = 0.037435192301797954 * (-NV_Ith_S(mParameters, 6) * _lt_0_row[2] + var_chaste_interface__internal_ion_concentrations__Ki) * var_chaste_interface__membrane__Vm / (_lt_0_row[3]); // millimolar
        const double var_constant_field_equations__CF_Na = 0.037435192301797954 * (-NV_Ith_S(mParameters, 7) * _lt_0_row[2] + var_chaste_interface__internal_ion_concentrations__Nai) * var_chaste_interface__membrane__Vm / (_lt_0_row[3]); // millimolar
...
// LCOV_EXCL_STOP
        ...
        const double var_background_Kpl_current__i_Kpl = 8.3986538766456042e-5 * pow(NV_Ith_S(mParameters, 6), 0.16) * (3.0 + var_chaste_interface__membrane__Vm) * var_constant_field_equations__CF_K / (_lt_0_row[7]); // picoA
