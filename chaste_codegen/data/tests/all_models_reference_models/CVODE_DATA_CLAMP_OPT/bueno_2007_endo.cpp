...
class Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    ~Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables()
    {

    }

protected:
    Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables(const Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;

};

std::shared_ptr<Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables> Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellbueno_2007_endoFromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    Cellbueno_2007_endoFromCellMLCvodeDataClampOpt::Cellbueno_2007_endoFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbueno_2007_endoFromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellbueno_2007_endoFromCellMLCvodeDataClampOpt::~Cellbueno_2007_endoFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellbueno_2007_endoFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellbueno_2007_endoFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellbueno_2007_endoFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbueno_2007_endoFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    N_Vector Cellbueno_2007_endoFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellbueno_2007_endoFromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbueno_2007_endoFromCellMLCvodeDataClampOpt)
