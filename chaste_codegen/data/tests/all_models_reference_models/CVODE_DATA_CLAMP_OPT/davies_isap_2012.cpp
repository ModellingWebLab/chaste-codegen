...
class Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables(const Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables&);
    Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables&);
    Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables> Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Celldavies_isap_2012FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Celldavies_isap_2012FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Celldavies_isap_2012FromCellMLCvodeDataClampOpt::Celldavies_isap_2012FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celldavies_isap_2012FromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 10) = 8.25; // (var_INa__GNa) [mS_per_uF]
        NV_Ith_S(this->mParameters, 11) = 0.5; // (var_IK1__GK1) [mS_per_uF]
        NV_Ith_S(this->mParameters, 12) = 0.010999999999999999; // (var_INal__GNaL) [mS_per_uF]
        NV_Ith_S(this->mParameters, 13) = 0.0027599999999999999; // (var_IKp__GKp) [mS_per_uF]
        NV_Ith_S(this->mParameters, 14) = 0.013854200000000001; // (var_IKr__GKrMax) [mS_per_uF]
        NV_Ith_S(this->mParameters, 15) = 0.0074692500000000002; // (var_IKs__gks_max) [mS_per_uF]
        NV_Ith_S(this->mParameters, 16) = 5.8499999999999996; // (var_INaCa__NCXmax) [uA_per_uF]
        NV_Ith_S(this->mParameters, 17) = 0.61875000000000002; // (var_INaK__ibarnak) [uA_per_uF]
        NV_Ith_S(this->mParameters, 18) = 3.9999999999999998e-7; // (var_Ito2__PCl) [L_per_F_ms]
        NV_Ith_S(this->mParameters, 19) = 0.18049999999999999; // (var_Ito__gitodv) [mS_per_uF]
        NV_Ith_S(this->mParameters, 20) = 300.0; // (var_Ito__Cto) [mV]
    }

    Celldavies_isap_2012FromCellMLCvodeDataClampOpt::~Celldavies_isap_2012FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Celldavies_isap_2012FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Celldavies_isap_2012FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celldavies_isap_2012FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);

        const double var_INaCa__ca_i_NaCa = 1.5 * var_chaste_interface__Ca__Ca_i; // mM
        const double var_INaCa__INaCa = (pow(var_chaste_interface__Na__Na_i, 3) * NV_Ith_S(mParameters, 0) * _lt_0_row[0] - pow(NV_Ith_S(mParameters, 3), 3) * var_INaCa__ca_i_NaCa * _lt_0_row[1]) * NV_Ith_S(mParameters, 16) / ((_lt_0_row[2]) * (1.0 + 1.5624999999999999e-8 / pow(var_INaCa__ca_i_NaCa, 2)) * (669921.875 * var_INaCa__ca_i_NaCa + 1.3 * pow(var_chaste_interface__Na__Na_i, 3) + pow(NV_Ith_S(mParameters, 3), 3) * var_INaCa__ca_i_NaCa + pow(var_chaste_interface__Na__Na_i, 3) * NV_Ith_S(mParameters, 0) + 0.0035999999999999999 * pow(NV_Ith_S(mParameters, 3), 3) * (1.0 + 0.00053738391835633597 * pow(var_chaste_interface__Na__Na_i, 3)) + 1860.8670000000004 * (1.0 + 277.77777777777777 * var_INaCa__ca_i_NaCa) * NV_Ith_S(mParameters, 0))); // uA_per_uF
        const double var_INaK__INaK = NV_Ith_S(mParameters, 2) * NV_Ith_S(mParameters, 17) / ((1.0 + 100.0 / pow(var_chaste_interface__Na__Na_i, 2)) * (1.5 + NV_Ith_S(mParameters, 2)) * (1.0 + _lt_0_row[4] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * NV_Ith_S(mParameters, 3))) * _lt_0_row[3])); // uA_per_uF
    ...
    void Celldavies_isap_2012FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        {
            d_dt_chaste_interface_var_cell__V = -var_ICaL__ICaL - var_ICab__ICab - var_IpCa__IpCa - var_cell__clont - var_cell__kiont - var_cell__naiont + 2.0 * var_INaCa__INaCa - (-GetExperimentalVoltageAtTimeT(var_chaste_interface__Environment__time) + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 9); // mV / ms
        }
    ...
    N_Vector Celldavies_isap_2012FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_IKr__gkr = 0.5 * sqrt(NV_Ith_S(mParameters, 2)) * NV_Ith_S(mParameters, 14); // mS_per_uF
        const double var_IKs__gks = (1.0 + 0.59999999999999998 / (1.0 + 6.4818210260626455e-7 * pow((1 / var_chaste_interface__Ca__Ca_i), 1.3999999999999999))) * NV_Ith_S(mParameters, 15); // mS_per_uF
        const double var_INa__gNa = pow(var_chaste_interface__INa__m, 3) * NV_Ith_S(mParameters, 10) * var_chaste_interface__INa__H * var_chaste_interface__INa__J; // mS_per_uF
        ...
        const double var_INaCa__INaCa = NV_Ith_S(mParameters, 16) * var_INaCa__allo * var_INaCa__num / ((var_INaCa__denom2 + var_INaCa__denom3) * var_INaCa__denom1); // uA_per_uF
        ...
        const double var_INaK__INaK = NV_Ith_S(mParameters, 2) * var_INaK__fnak * NV_Ith_S(mParameters, 17) / ((1.0 + pow(var_INaK__kmnai, 2) / pow(var_chaste_interface__Na__Na_i, 2)) * (NV_Ith_S(mParameters, 2) + var_INaK__kmko)); // uA_per_uF
        const double var_INaK__INaK_converted = HeartConfig::Instance()->GetCapacitance() * var_INaK__INaK; // uA_per_cm2
        const double var_Ito__rv = ((var_chaste_interface__cell__V <= 0) ? (exp(var_chaste_interface__cell__V / NV_Ith_S(mParameters, 20))) : (1.0)); // dimensionless
        const double var_Ito2__Ito2_max = ((fabs(var_chaste_interface__cell__V) < 2.6712338705500134e-6) ? (-187179.41753899999 * (-2.6712338705500134e-6 + var_chaste_interface__cell__V) * (-0.0096485000000000008 * (-NV_Ith_S(mParameters, 1) * exp(1.0000000000000001e-7) + var_chaste_interface__Cl__Cl_i) * NV_Ith_S(mParameters, 18) / (1.0 - exp(1.0000000000000001e-7)) - 0.0096485000000000008 * (-NV_Ith_S(mParameters, 1) * exp(-1.0000000000000001e-7) + var_chaste_interface__Cl__Cl_i) * NV_Ith_S(mParameters, 18) / (1.0 - exp(-1.0000000000000001e-7))) + 0.0096485000000000008 * (-NV_Ith_S(mParameters, 1) * exp(1.0000000000000001e-7) + var_chaste_interface__Cl__Cl_i) * NV_Ith_S(mParameters, 18) / (1.0 - exp(1.0000000000000001e-7))) : (3612.001220250083 * (-NV_Ith_S(mParameters, 1) * _lt_0_row[9] + var_chaste_interface__Cl__Cl_i) * NV_Ith_S(mParameters, 18) * var_chaste_interface__cell__V / (_lt_0_row[10]))); // uA_per_uF
        ...
        const double var_IK1__IK1 = 0.5 * sqrt(NV_Ith_S(mParameters, 2)) * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 11) * var_IK1__ak1 / (var_IK1__ak1 + var_IK1__bk1); // uA_per_uF
        const double var_IK1__IK1_converted = HeartConfig::Instance()->GetCapacitance() * var_IK1__IK1; // uA_per_cm2
        const double var_IKp__IKp = (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 13) / (_lt_0_row[11]); // uA_per_uF
        ...
        const double var_INal__INal = pow(var_chaste_interface__INal__mL, 3) * (-var_reversal_potentials__ENa + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 12) * var_chaste_interface__INal__hL; // uA_per_uF
...
template<>
void OdeSystemInformation<Celldavies_isap_2012FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celldavies_isap_2012FromCellMLCvodeDataClampOpt)
