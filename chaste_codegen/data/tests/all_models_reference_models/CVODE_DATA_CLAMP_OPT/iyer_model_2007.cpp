...
class Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V)
    {
        ...
        const double* const _lt_0_row = Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables(const Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables&);
    Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables&);
    Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables> Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Celliyer_model_2007FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Celliyer_model_2007FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Celliyer_model_2007FromCellMLCvodeDataClampOpt::Celliyer_model_2007FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celliyer_model_2007FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Celliyer_model_2007FromCellMLCvodeDataClampOpt::~Celliyer_model_2007FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Celliyer_model_2007FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Celliyer_model_2007FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celliyer_model_2007FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
    ...
    void Celliyer_model_2007FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__IK1 = sqrt(NV_Ith_S(mParameters, 3)) * (-var_COMPUTE_REVERSAL_POTENTIALS__EK + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * NV_Ith_S(mParameters, 8) / (0.93999999999999995 + exp(0.047170872694120618 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V - 0.047170872694120618 * var_COMPUTE_REVERSAL_POTENTIALS__EK)); // uA_per_uF
        const double var_COMPUTE_REVERSAL_POTENTIALS__ENa = 26.71139896373057 * log(NV_Ith_S(mParameters, 4) / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai); // mV
        ...
        const double var_COMPUTE_INa_IKr_IKs_Ito1_IK1_INab_IKp__IKr = 0.5 * sqrt(NV_Ith_S(mParameters, 3)) * (-var_COMPUTE_REVERSAL_POTENTIALS__EK + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) * NV_Ith_S(mParameters, 9) * var_chaste_interface__IKr__OHerg; // uA_per_uF
    ...
    N_Vector Celliyer_model_2007FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Celliyer_model_2007FromCellMLCvodeDataClampOpt>::Initialise(void)
{
