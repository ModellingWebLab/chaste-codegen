...
class Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables(const Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables> Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt::Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 21) = 2.7240000000000002; // (var_sodium_potassium_pump_current__P_NaK) [picoA_per_picoF]
        NV_Ith_S(this->mParameters, 22) = 0.072999999999999995; // (var_transient_outward_current__g_to) [nanoS_per_picoF]
    }

    Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt::~Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    

    void Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt::VerifyStateVariables()
    {
    ...
    double Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    N_Vector Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        if (mDataClampIsOn)
        {
            var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 12); // uA_per_cm2
        }
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellten_tusscher_model_2006_endoFromCellMLCvodeDataClampOpt)
