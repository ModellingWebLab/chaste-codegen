...
class Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__v)
    {
        ...
        const double* const _lt_0_row = Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables(const Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables> Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt::Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 17) = 0.0; // (var_membrane_data_clamp_current_conductance) [dimensionless]
    ...
    Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt::~Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__v);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__v);
        ...
        const double var_INaCa_i__Gncx = ((var_environment__celltype == 1.0) ? (1.1000000000000001 * NV_Ith_S(mParameters, 23)) : ((var_environment__celltype == 2.0) ? (1.3999999999999999 * NV_Ith_S(mParameters, 23)) : (NV_Ith_S(mParameters, 23)))); // milliS_per_microF
    ...
    void Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    N_Vector Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_IK1__GK1 = ((var_environment__celltype == 1.0) ? (1.2 * NV_Ith_S(mParameters, 19)) : ((var_environment__celltype == 2.0) ? (1.3 * NV_Ith_S(mParameters, 19)) : (NV_Ith_S(mParameters, 19)))); // milliS_per_microF
        ...
        const double var_IKr__GKr = ((var_environment__celltype == 1.0) ? (1.3 * NV_Ith_S(mParameters, 21)) : ((var_environment__celltype == 2.0) ? (0.80000000000000004 * NV_Ith_S(mParameters, 21)) : (NV_Ith_S(mParameters, 21)))); // milliS_per_microF
        const double var_IKs__GKs = ((var_environment__celltype == 1.0) ? (1.3999999999999999 * NV_Ith_S(mParameters, 22)) : (NV_Ith_S(mParameters, 22))); // milliS_per_microF
        const double var_INaCa_i__Gncx = ((var_environment__celltype == 1.0) ? (1.1000000000000001 * NV_Ith_S(mParameters, 23)) : ((var_environment__celltype == 2.0) ? (1.3999999999999999 * NV_Ith_S(mParameters, 23)) : (NV_Ith_S(mParameters, 23)))); // milliS_per_microF
        const double var_INaK__Pnak = ((var_environment__celltype == 1.0) ? (0.90000000000000002 * NV_Ith_S(mParameters, 24)) : ((var_environment__celltype == 2.0) ? (0.69999999999999996 * NV_Ith_S(mParameters, 24)) : (NV_Ith_S(mParameters, 24)))); // milliS_per_microF
        const double var_INaL__GNaL = ((var_environment__celltype == 1.0) ? (0.59999999999999998 * NV_Ith_S(mParameters, 20)) : (NV_Ith_S(mParameters, 20))); // milliS_per_microF
        const double var_Ito__Gto = (((var_environment__celltype == 1.0) || (var_environment__celltype == 2.0)) ? (4.0 * NV_Ith_S(mParameters, 25)) : (NV_Ith_S(mParameters, 25))); // milliS_per_microF
        ...
        if (mDataClampIsOn)
        {
            var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__membrane__v) * NV_Ith_S(mParameters, 17); // uA_per_cm2
        }
        ...
        const double var_INa__INa = pow(var_chaste_interface__INa__m, 3) * (-var_reversal_potentials__ENa + var_chaste_interface__membrane__v) * ((1.0 - var_INa__fINap) * var_INa__h * var_chaste_interface__INa__j + var_INa__fINap * var_INa__hp * var_chaste_interface__INa__jp) * NV_Ith_S(mParameters, 18); // microA_per_microF
        ...
        NV_Ith_S(dqs, 12) = var_IK1__GK1_calc;
        NV_Ith_S(dqs, 13) = var_INaL__INaL_converted;
        NV_Ith_S(dqs, 14) = var_INaL__GNaL;
        NV_Ith_S(dqs, 15) = var_IKr__IKr_converted;
        NV_Ith_S(dqs, 16) = var_IKr__GKr_calc;
        NV_Ith_S(dqs, 17) = var_IKs__IKs_converted;
        NV_Ith_S(dqs, 18) = var_IKs__GKs_calc;
        NV_Ith_S(dqs, 19) = var_INaCa_i__INaCa_i_converted;
        NV_Ith_S(dqs, 20) = var_INaCa_i__INaCa_ss_converted;
        NV_Ith_S(dqs, 21) = var_INaK__INaK_converted;
        NV_Ith_S(dqs, 22) = var_membrane__Istim_converted;
        NV_Ith_S(dqs, 23) = var_Ito__Ito_converted;
        NV_Ith_S(dqs, 24) = var_Ito__Gto;
        NV_Ith_S(dqs, 25) = var_chaste_interface__environment__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellohara_rudy_cipa_v1_2017FromCellMLCvodeDataClampOpt>::Initialise(void)
{
