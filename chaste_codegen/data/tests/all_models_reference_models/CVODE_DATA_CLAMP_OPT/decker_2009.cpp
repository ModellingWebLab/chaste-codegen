...
// LCOV_EXCL_STOP
        ...
        const double var_Ito2__Ito2 = 3612.0012202503358 * (1.0 - 1 / (1.0 + 6.2499999999999991 * pow(var_chaste_interface__Irel__Irel, 2))) * (_lt_0_row[6] + var_chaste_interface__Cl__Cl_i) * NV_Ith_S(mParameters, 20) * var_chaste_interface__Ito2_i2f_gate__i2f * var_chaste_interface__membrane__Vm / (_lt_0_row[7]); // uA_per_uF
