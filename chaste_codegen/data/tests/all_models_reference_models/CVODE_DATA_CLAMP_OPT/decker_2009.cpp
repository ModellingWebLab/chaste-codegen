...
class Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__Vm)
    {
        ...
        const double* const _lt_0_row = Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables(const Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables&);
    Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables&);
    Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return ((fabs(38.360799999999998 + var_chaste_interface__membrane__Vm) < 6.5703022045227044e-7) ? (1.9710906613568111e-10 / (-1.0 + exp(9.9999999552835566e-8)) + 0.00059999999999999995 * (-1.7383999999999999 + var_chaste_interface__membrane__Vm) / (1.0 - exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm)) - 761000.00340292137 * (38.360799342969777 + var_chaste_interface__membrane__Vm) * (-1.9710906613568111e-10 / (-1.0 + exp(9.9999999552835566e-8)) - 1.9710906613568111e-10 / (-1.0 + exp(-9.9999999552835566e-8)))) : ((fabs(-1.7384000000000002 + var_chaste_interface__membrane__Vm) < 7.3529411770412167e-7) ? (-4.4117647055585959e-10 / (1.0 - exp(9.9999999992661527e-8)) + 0.00029999999999999997 * (38.360799999999998 + var_chaste_interface__membrane__Vm) / (-1.0 + exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm)) + 679999.99994722824 * (-1.7383992647058824 + var_chaste_interface__membrane__Vm) * (4.4117647055585959e-10 / (1.0 - exp(9.9999999992661527e-8)) + 4.4117647068908634e-10 / (1.0 - exp(-1.0000000002285959e-7)))) : (0.00029999999999999997 * (38.360799999999998 + var_chaste_interface__membrane__Vm) / (-1.0 + exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm)) + 0.00059999999999999995 * (-1.7383999999999999 + var_chaste_interface__membrane__Vm) / (1.0 - exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm)))));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return ((fabs(47.130000000000003 + var_chaste_interface__membrane__Vm) < 1.0000000010279564e-6) ? (-3.2000000146581445e-7 / (1.0 - exp(1.0000000045806701e-7)) + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__Vm) * (3.2000000146581445e-7 / (1.0 - exp(1.0000000045806701e-7)) + 3.1999999919207769e-7 / (1.0 - exp(-9.9999999747524276e-8)))) : (0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__Vm) / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__Vm))));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
...
private:
    ...
    static std::shared_ptr<Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables> Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Celldecker_2009FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Celldecker_2009FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Celldecker_2009FromCellMLCvodeDataClampOpt::Celldecker_2009FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celldecker_2009FromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 12) = 9.0749999999999993; // (var_INa__g_Na) [mS_per_uF]
        NV_Ith_S(this->mParameters, 13) = 0.5; // (var_IK1__g_K1_max) [mS_per_uF]
        NV_Ith_S(this->mParameters, 14) = 0.0064999999999999997; // (var_INaL__gNaL) [mS_per_uF]
        NV_Ith_S(this->mParameters, 15) = 0.0027599999999999999; // (var_IKp__gKp) [mS_per_uF]
        NV_Ith_S(this->mParameters, 16) = 0.013854200000000001; // (var_IKr__gKr_max) [mS_per_uF]
        NV_Ith_S(this->mParameters, 17) = 0.082600000000000007; // (var_IKs__gKs_max) [mS_per_uF]
        NV_Ith_S(this->mParameters, 18) = 4.5; // (var_INaCa__Vmax) [uA_per_uF]
        NV_Ith_S(this->mParameters, 19) = 1.3999999999999999; // (var_INaK__ibarnak) [uA_per_uF]
        NV_Ith_S(this->mParameters, 20) = 8.9999999999999996e-7; // (var_Ito2__PCl) [L_per_F_ms]
        NV_Ith_S(this->mParameters, 21) = 0.49745800000000001; // (var_Ito1__gto1) [mS_per_uF]
    }

    Celldecker_2009FromCellMLCvodeDataClampOpt::~Celldecker_2009FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Celldecker_2009FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Celldecker_2009FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__Vm);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celldecker_2009FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);

        const double var_INaCa__INaCa_ss_sr = 0.20000000000000001 * (pow(var_chaste_interface__Na__Na_ss_sr, 3) * NV_Ith_S(mParameters, 3) * _lt_0_row[0] - pow(NV_Ith_S(mParameters, 5), 3) * var_chaste_interface__Ca__Ca_ss_sr * _lt_0_row[1]) * NV_Ith_S(mParameters, 18) / ((_lt_0_row[2]) * (1.0 + 1.5624999999999999e-8 / pow(var_chaste_interface__Ca__Ca_ss_sr, 2)) * (669921.875 * var_chaste_interface__Ca__Ca_ss_sr + 1.3 * pow(var_chaste_interface__Na__Na_ss_sr, 3) + pow(var_chaste_interface__Na__Na_ss_sr, 3) * NV_Ith_S(mParameters, 3) + pow(NV_Ith_S(mParameters, 5), 3) * var_chaste_interface__Ca__Ca_ss_sr + 0.0035999999999999999 * pow(NV_Ith_S(mParameters, 5), 3) * (1.0 + 0.00053738391835633597 * pow(var_chaste_interface__Na__Na_ss_sr, 3)) + 1860.8670000000004 * (1.0 + 277.77777777777777 * var_chaste_interface__Ca__Ca_ss_sr) * NV_Ith_S(mParameters, 3))); // uA_per_uF
        const double var_INaCa__INaCa = 0.80000000000000004 * (pow(var_chaste_interface__Na__Na_i, 3) * NV_Ith_S(mParameters, 3) * _lt_0_row[0] - pow(NV_Ith_S(mParameters, 5), 3) * var_chaste_interface__Ca__Ca_i * _lt_0_row[1]) * NV_Ith_S(mParameters, 18) / ((_lt_0_row[2]) * (1.0 + 1.5624999999999999e-8 / pow(var_chaste_interface__Ca__Ca_i, 2)) * (669921.875 * var_chaste_interface__Ca__Ca_i + 1.3 * pow(var_chaste_interface__Na__Na_i, 3) + pow(var_chaste_interface__Na__Na_i, 3) * NV_Ith_S(mParameters, 3) + pow(NV_Ith_S(mParameters, 5), 3) * var_chaste_interface__Ca__Ca_i + 0.0035999999999999999 * pow(NV_Ith_S(mParameters, 5), 3) * (1.0 + 0.00053738391835633597 * pow(var_chaste_interface__Na__Na_i, 3)) + 1860.8670000000004 * (1.0 + 277.77777777777777 * var_chaste_interface__Ca__Ca_i) * NV_Ith_S(mParameters, 3))) + var_INaCa__INaCa_ss_sr; // uA_per_uF
        const double var_INaK__INaK = 0.056895766954938545 * pow(var_chaste_interface__Na__Na_i, 3) * NV_Ith_S(mParameters, 19) * NV_Ith_S(mParameters, 4) / (pow((1 + 0.38461538461538458 * var_chaste_interface__Na__Na_i), 3) * (_lt_0_row[3]) * (1.5 + NV_Ith_S(mParameters, 4))); // uA_per_uF
    ...
    void Celldecker_2009FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_IKp__IKp = (-var_reversal_potentials__EK + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 15) / (_lt_0_row[10]); // uA_per_uF
        const double var_IKr__IKr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 4)) * (-var_reversal_potentials__EK + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 16) * var_chaste_interface__IKr_xr_gate__xr / (_lt_0_row[11]); // uA_per_uF
        const double var_Ito1__Ito1 = pow(var_chaste_interface__Ito1_a_gate__a, 3) * (-var_reversal_potentials__EK + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 21) * var_chaste_interface__Ito1_i1f_gate__i1f * var_chaste_interface__Ito1_i1s_gate__i1s * _lt_0_row[12]; // uA_per_uF
        const double var_reversal_potentials__ENa = 26.712338705498265 * log(NV_Ith_S(mParameters, 5) / var_chaste_interface__Na__Na_i); // mV
        ...
        const double var_INa__INa = pow(var_chaste_interface__INa_m_gate__m, 3) * (-var_reversal_potentials__ENa + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 12) * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j; // uA_per_uF
        const double var_INaL__INaL = pow(var_chaste_interface__INaL_mL_gate__mL, 3) * (-var_reversal_potentials__ENa + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 14) * var_chaste_interface__INaL_hL_gate__hL; // uA_per_uF
        ...
        {
            d_dt_chaste_interface_var_membrane__Vm = -var_ICaL__ICaL - var_ICab__ICab - var_IClb__IClb - var_IK1__IK1 - var_IKp__IKp - var_IKr__IKr - var_IKs__IKs - var_INa__INa - var_INaL__INaL - var_INab__INab - var_IpCa__IpCa - var_Ito1__Ito1 - var_Ito2__Ito2 - var_membrane__i_Stim - var_INaCa__INaCa - var_INaCa__INaCa_ss_sr - var_INaK__INaK - (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 11); // mV / ms
        }
    ...
    N_Vector Celldecker_2009FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        if (mDataClampIsOn)
        {
            var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 11); // uA_per_cm2
        }
        ...
        const double var_IK1__gK1 = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 4)) * NV_Ith_S(mParameters, 13); // mS_per_uF
        const double var_IKr__gKr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 4)) * NV_Ith_S(mParameters, 16); // mS_per_uF
        ...
        const double var_INaK__INaK = var_INaK__PK * var_INaK__PNa * var_INaK__fv * NV_Ith_S(mParameters, 19); // uA_per_uF
        ...
        const double var_IKp__IKp = (-var_reversal_potentials__EK + var_chaste_interface__membrane__Vm) * var_IKp__Kp * NV_Ith_S(mParameters, 15); // uA_per_uF
        ...
        const double var_Ito1__Ito1 = pow(var_chaste_interface__Ito1_a_gate__a, 3) * (-var_reversal_potentials__EK + var_chaste_interface__membrane__Vm) * NV_Ith_S(mParameters, 21) * var_Ito1__rto1 * var_chaste_interface__Ito1_i1f_gate__i1f * var_chaste_interface__Ito1_i1s_gate__i1s; // uA_per_uF
        ...
        NV_Ith_S(dqs, 7) = var_chaste_interface__membrane_data_clamp_current;
        NV_Ith_S(dqs, 8) = var_INa__INa_converted;
        NV_Ith_S(dqs, 9) = var_IK1__IK1_converted;
        NV_Ith_S(dqs, 10) = var_INaL__INaL_converted;
        NV_Ith_S(dqs, 11) = var_IKp__IKp_converted;
        NV_Ith_S(dqs, 12) = var_IKr__IKr_converted;
        NV_Ith_S(dqs, 13) = var_IKs__IKs_converted;
        NV_Ith_S(dqs, 14) = var_INaCa__INaCa_converted;
        NV_Ith_S(dqs, 15) = var_INaCa__INaCa_ss_sr_converted;
        NV_Ith_S(dqs, 16) = var_INaK__INaK_converted;
        NV_Ith_S(dqs, 17) = var_membrane__i_Stim_converted;
        NV_Ith_S(dqs, 18) = var_Ito2__Ito2_converted;
        NV_Ith_S(dqs, 19) = var_Ito1__Ito1_converted;
        NV_Ith_S(dqs, 20) = var_chaste_interface__environment__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Celldecker_2009FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celldecker_2009FromCellMLCvodeDataClampOpt)
