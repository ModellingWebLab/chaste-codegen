...
class Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables(const Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables> Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt::Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt::~Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_potassium_pump_current__i_p_K = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 18) / (_lt_0_row[2]); // picoA_per_picoF
        ...
        const double var_sodium_potassium_pump_current__i_NaK = NV_Ith_S(mParameters, 5) * var_chaste_interface__sodium_dynamics__Na_i * NV_Ith_S(mParameters, 22) / ((1.0 + NV_Ith_S(mParameters, 5)) * (40.0 + var_chaste_interface__sodium_dynamics__Na_i) * (_lt_0_row[6])); // picoA_per_picoF
    ...
    N_Vector Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_inward_rectifier_potassium_current__i_K1 = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 5)) * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 17) * var_inward_rectifier_potassium_current__xK1_inf; // picoA_per_picoF
        ...
        NV_Ith_S(dqs, 7) = var_fast_sodium_current__i_Na_converted;
        NV_Ith_S(dqs, 8) = var_fast_sodium_current_h_gate__tau_h;
        NV_Ith_S(dqs, 9) = var_fast_sodium_current_j_gate__tau_j;
        NV_Ith_S(dqs, 10) = var_inward_rectifier_potassium_current__i_K1_converted;
        NV_Ith_S(dqs, 11) = var_potassium_pump_current__i_p_K_converted;
        NV_Ith_S(dqs, 12) = var_rapid_time_dependent_potassium_current__i_Kr_converted;
        NV_Ith_S(dqs, 13) = var_slow_time_dependent_potassium_current__i_Ks_converted;
        NV_Ith_S(dqs, 14) = var_sodium_calcium_exchanger_current__i_NaCa_converted;
        NV_Ith_S(dqs, 15) = var_sodium_potassium_pump_current__i_NaK_converted;
        NV_Ith_S(dqs, 16) = var_membrane__i_Stim_converted;
        NV_Ith_S(dqs, 17) = var_transient_outward_current__i_to_converted;
        NV_Ith_S(dqs, 18) = var_chaste_interface__environment__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellten_tusscher_model_2004_epiFromCellMLCvodeDataClampOpt>::Initialise(void)
{
