...
class Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane_potential__V_m)
    {
        ...
        const double* const _lt_0_row = Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables(const Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables> Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt::Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 9) = 23.0; // (var_parameters__GNa) [mS_per_uF]
        NV_Ith_S(this->mParameters, 10) = 0; // (var_I_Na__perc_reduced_inact_for_IpNa) [dimensionless]
        NV_Ith_S(this->mParameters, 11) = 0; // (var_I_Na__shift_INa_inact) [mV]
        NV_Ith_S(this->mParameters, 12) = 1.0; // (var_I_to__GtoFast_factor) [dimensionless]
        NV_Ith_S(this->mParameters, 13) = 0.34999999999999998; // (var_I_Ki__g_ki) [mS_per_uF]
        NV_Ith_S(this->mParameters, 14) = 0.035000000000000003; // (var_I_Kr__gkr_max) [mS_per_uF]
        NV_Ith_S(this->mParameters, 15) = 0.0035000000000000001; // (var_I_Ks__gks_sl) [mS_per_uF]
        NV_Ith_S(this->mParameters, 16) = 1.0; // (var_I_to__GtoSlow_factor) [dimensionless]
        NV_Ith_S(this->mParameters, 17) = 4.5; // (var_parameters__IbarNCX) [uA_per_uF]
        NV_Ith_S(this->mParameters, 18) = 1.8; // (var_parameters__IbarNaK) [uA_per_uF]
        NV_Ith_S(this->mParameters, 19) = 1.3809999999999999e-10; // (var_parameters__Cmem) [farad]
    }

    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt::~Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane_potential__V_m);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_I_NaK__I_nak_junc = 0.11 * var_I_NaK__fnak * NV_Ith_S(mParameters, 18) * NV_Ith_S(mParameters, 5) / ((1.0 + 14641.0 / pow(var_chaste_interface__Na_Concentrations__Na_j, 4)) * (1.5 + NV_Ith_S(mParameters, 5))); // uA_per_uF
        const double var_I_NaK__I_nak_sl = 0.89000000000000001 * var_I_NaK__fnak * NV_Ith_S(mParameters, 18) * NV_Ith_S(mParameters, 5) / ((1.0 + 14641.0 / pow(var_chaste_interface__Na_Concentrations__Na_sl, 4)) * (1.5 + NV_Ith_S(mParameters, 5))); // uA_per_uF
    ...
    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_I_Na__h = (((var_chaste_interface__membrane_potential__V_m >= -40.0) ? (0) : (0.057000000000000002 * exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 11) - 0.14705882352941177 * var_chaste_interface__membrane_potential__V_m))) + ((var_chaste_interface__membrane_potential__V_m >= -40.0) ? (5.9230769230769234 / (1.0 + exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 11) - 0.0900900900900901 * var_chaste_interface__membrane_potential__V_m))) : (310000.0 * exp(0.34849999999999998 * var_chaste_interface__membrane_potential__V_m - 0.34849999999999998 * NV_Ith_S(mParameters, 11)) + 2.7000000000000002 * exp(0.079000000000000001 * var_chaste_interface__membrane_potential__V_m - 0.079000000000000001 * NV_Ith_S(mParameters, 11))))) * (-var_chaste_interface__I_Na__h + 0.01 * NV_Ith_S(mParameters, 10) + (1.0 - 0.01 * NV_Ith_S(mParameters, 10)) / pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * NV_Ith_S(mParameters, 11))), 2)); // 1 / msec
        const double d_dt_chaste_interface_var_I_Na__j = (((var_chaste_interface__membrane_potential__V_m >= -40.0) ? (0) : ((37.780000000000001 + var_chaste_interface__membrane_potential__V_m) * (-25428.0 * exp(0.24440000000000001 * var_chaste_interface__membrane_potential__V_m - 0.24440000000000001 * NV_Ith_S(mParameters, 11)) - 6.9480000000000002e-6 * exp(0.043909999999999998 * NV_Ith_S(mParameters, 11) - 0.043909999999999998 * var_chaste_interface__membrane_potential__V_m)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane_potential__V_m - 0.311 * NV_Ith_S(mParameters, 11))))) + ((var_chaste_interface__membrane_potential__V_m >= -40.0) ? (0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__membrane_potential__V_m - 0.057000000000000002 * NV_Ith_S(mParameters, 11)) / (1.0 + exp(-3.2000000000000002 + 0.10000000000000001 * NV_Ith_S(mParameters, 11) - 0.10000000000000001 * var_chaste_interface__membrane_potential__V_m))) : (0.024240000000000001 * exp(0.01052 * NV_Ith_S(mParameters, 11) - 0.01052 * var_chaste_interface__membrane_potential__V_m) / (1.0 + exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 11) - 0.13780000000000001 * var_chaste_interface__membrane_potential__V_m))))) * (-var_chaste_interface__I_Na__j + 0.01 * NV_Ith_S(mParameters, 10) + (1.0 - 0.01 * NV_Ith_S(mParameters, 10)) / pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * NV_Ith_S(mParameters, 11))), 2)); // 1 / msec
        ...
        else
        {
            ...
            const double var_parameters__epi = 0; // dimensionless
            const double var_I_Ks__eks = 26.712338705498265 * log((0.018329999999999999 * NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 5)) / (0.018329999999999999 * var_chaste_interface__Na_Concentrations__Na_i + var_chaste_interface__K_Concentration__K_i)); // mV
            d_dt_chaste_interface_var_membrane_potential__V_m = -0.5535668961205934 - var_Ca_Concentrations__I_Ca_tot_junc - var_Ca_Concentrations__I_Ca_tot_sl - var_Na_Concentrations__I_Na_tot_junc - var_Na_Concentrations__I_Na_tot_sl + 2.0 * var_I_NaK__I_nak_junc + 2.0 * var_I_NaK__I_nak_sl - 0.0089999999999999993 * var_chaste_interface__membrane_potential__V_m - GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() - (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 8) - 0.002 * (-var_parameters__ek + var_chaste_interface__membrane_potential__V_m) * var_I_Kp__kp_kp - 0.006029375 * (61.507432902288166 + var_chaste_interface__membrane_potential__V_m) / (1.0 + 0.10000000000000001 / var_chaste_interface__Ca_Concentrations__Ca_j) - 0.048783124999999997 * (61.507432902288166 + var_chaste_interface__membrane_potential__V_m) / (1.0 + 0.10000000000000001 / var_chaste_interface__Ca_Concentrations__Ca_sl) - 0.00038500000000000003 * pow(var_chaste_interface__I_Ks__x_ks, 2) * (-var_I_Ks__eks + var_chaste_interface__membrane_potential__V_m) - 0.89000000000000001 * pow(var_chaste_interface__I_Ks__x_ks, 2) * (-var_I_Ks__eks + var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 15) - (-var_parameters__ek + var_chaste_interface__membrane_potential__V_m) * ((var_parameters__epi == 1.0) ? (0.1144 * NV_Ith_S(mParameters, 12)) : (0.0014039999999999999 * NV_Ith_S(mParameters, 12))) * var_chaste_interface__I_to__x_to_f * var_chaste_interface__I_to__y_to_f - (-var_parameters__ek + var_chaste_interface__membrane_potential__V_m) * ((var_parameters__epi == 1.0) ? (0.015599999999999999 * NV_Ith_S(mParameters, 16)) : (0.037595999999999997 * NV_Ith_S(mParameters, 16))) * var_chaste_interface__I_to__x_to_s * var_chaste_interface__I_to__y_to_s - 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 5)) * (-var_parameters__ek + var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 14) * var_chaste_interface__I_Kr__x_kr / (_lt_0_row[6]) - 0.4389381125701739 * sqrt(NV_Ith_S(mParameters, 5)) * (-var_parameters__ek + var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 13) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane_potential__V_m - 0.23849999999999999 * var_parameters__ek)) * (1.02 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane_potential__V_m - 0.23849999999999999 * var_parameters__ek)) + (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane_potential__V_m - 0.080320000000000003 * var_parameters__ek) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane_potential__V_m - 0.061749999999999999 * var_parameters__ek)) / (1.0 + exp(-2.4444678999999998 + 0.51429999999999998 * var_parameters__ek - 0.51429999999999998 * var_chaste_interface__membrane_potential__V_m)))) - 0.0002194290741302079 * pow(1.8, var_parameters__Qpow) * (-0.75 * NV_Ith_S(mParameters, 5) + 0.75 * var_chaste_interface__K_Concentration__K_i * _lt_0_row[7]) * (1.0 + 0.099999999999999978 * var_I_Ca__fcaCaMSL + 0.90000000000000002 * var_I_Ca__fcaCaj - 0.099999999999999978 * var_chaste_interface__I_Ca__f_Ca_Bsl - 0.90000000000000002 * var_chaste_interface__I_Ca__f_Ca_Bj) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f * var_chaste_interface__membrane_potential__V_m / (_lt_0_row[8]); // mV / msec
        }
    ...
    N_Vector Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_I_Na__ah = ((var_chaste_interface__membrane_potential__V_m >= -40.0) ? (0) : (0.057000000000000002 * exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 11) - 0.14705882352941177 * var_chaste_interface__membrane_potential__V_m))); // dimensionless
        ...
        if (mDataClampIsOn)
        {
            var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 8); // uA_per_cm2
        }
        ...
        const double var_parameters__Cmem_converted = 1000000.0 * NV_Ith_S(mParameters, 19); // uF
        ...
        const double var_I_Kr__gkr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 5)) * NV_Ith_S(mParameters, 14); // mS_per_uF
        ...
        const double var_I_Ki__I_ki = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 5)) * (-var_parameters__ek + var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 13) * var_I_Ki__kiss; // uA_per_uF
        ...
        const double var_I_Na__I_Na_junc = pow(var_chaste_interface__I_Na__m, 3) * (-var_parameters__ena_junc + var_chaste_interface__membrane_potential__V_m) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * var_parameters__Fjunc * NV_Ith_S(mParameters, 9); // uA_per_uF
        ...
        const double var_I_Na__I_Na_sl = pow(var_chaste_interface__I_Na__m, 3) * (-var_parameters__ena_sl + var_chaste_interface__membrane_potential__V_m) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * var_parameters__Fsl * NV_Ith_S(mParameters, 9); // uA_per_uF
        ...
        const double var_parameters__epi = 0; // dimensionless
        const double var_I_to__GtoFast = ((var_parameters__epi == 1.0) ? (0.1144 * NV_Ith_S(mParameters, 12)) : (0.0014039999999999999 * NV_Ith_S(mParameters, 12))); // mS_per_uF
        const double var_I_to__GtoSlow = ((var_parameters__epi == 1.0) ? (0.015599999999999999 * NV_Ith_S(mParameters, 16)) : (0.037595999999999997 * NV_Ith_S(mParameters, 16))); // mS_per_uF
        ...
        const double var_I_NCX__I_ncx_sl = pow(var_parameters__Q10NCX, var_parameters__Qpow) * (-var_I_NCX__s2_sl + var_I_NCX__s1_sl) * var_I_NCX__Ka_sl * var_parameters__Fsl * NV_Ith_S(mParameters, 17) / ((1.0 + var_parameters__ksat * exp((-1.0 + var_parameters__nu) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * var_I_NCX__s3_sl); // uA_per_uF
        ...
        const double var_I_Ks__I_ks_sl = pow(var_chaste_interface__I_Ks__x_ks, 2) * (-var_I_Ks__eks + var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 15) * var_parameters__Fsl; // uA_per_uF
        ...
        NV_Ith_S(dqs, 6) = var_I_Na__tauh;
        NV_Ith_S(dqs, 7) = var_I_Na__tauj;
        NV_Ith_S(dqs, 8) = var_I_to__I_tof_converted;
        NV_Ith_S(dqs, 9) = var_I_Ki__I_ki_converted;
        NV_Ith_S(dqs, 10) = var_I_Kr__I_kr_converted;
        NV_Ith_S(dqs, 11) = var_I_Ks__I_ks_converted;
        NV_Ith_S(dqs, 12) = var_I_to__I_tos_converted;
        NV_Ith_S(dqs, 13) = var_I_NCX__I_ncx_converted;
        NV_Ith_S(dqs, 14) = var_membrane_potential__i_Stim_converted;
...
template<>
void OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLCvodeDataClampOpt>::Initialise(void)
{
