...
std::shared_ptr<Cellwinslow_model_1999FromCellMLCvodeDataClampOpt_LookupTables> Cellwinslow_model_1999FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;
    ...
    double Cellwinslow_model_1999FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_current__i_Ca_max = ((fabs(var_chaste_interface__membrane__V) < 1.3356880329847825e-6) ? (-374338.9082274547 * (-1.3356880329847825e-6 + var_chaste_interface__membrane__V) * (-0.019297068300000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * NV_Ith_S(mParameters, 3)) * NV_Ith_S(mParameters, 6) / (-1.0 + exp(1.0000000000000001e-7)) - 0.019297068300000001 * (0.001 * exp(-1.0000000000000001e-7) - 0.34100000000000003 * NV_Ith_S(mParameters, 3)) * NV_Ith_S(mParameters, 6) / (-1.0 + exp(-1.0000000000000001e-7))) + 0.019297068300000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * NV_Ith_S(mParameters, 3)) * NV_Ith_S(mParameters, 6) / (-1.0 + exp(1.0000000000000001e-7))) : (14447.286958825252 * (_lt_0_row[0] - 0.34100000000000003 * NV_Ith_S(mParameters, 3)) * NV_Ith_S(mParameters, 6) * var_chaste_interface__membrane__V / (_lt_0_row[1]))); // microA_per_microF
        ...
        const double var_L_type_Ca_current__i_Ca_K = ((fabs(var_chaste_interface__membrane__V) < 2.671376065969565e-6) ? (-187169.45411372735 * (-2.671376065969565e-6 + var_chaste_interface__membrane__V) * (-5.5865012728500001e-12 * (-NV_Ith_S(mParameters, 4) + var_chaste_interface__intracellular_ion_concentrations__Ki * exp(1.0000000000000001e-7)) * (var_chaste_interface__L_type_Ca_current__O + var_chaste_interface__L_type_Ca_current__O_Ca) * var_chaste_interface__L_type_Ca_current_y_gate__y / ((1.0 - 3.773584905660377 * var_L_type_Ca_current__i_Ca_max) * (-1.0 + exp(1.0000000000000001e-7))) - 5.5865012728500001e-12 * (-NV_Ith_S(mParameters, 4) + var_chaste_interface__intracellular_ion_concentrations__Ki * exp(-1.0000000000000001e-7)) * (var_chaste_interface__L_type_Ca_current__O + var_chaste_interface__L_type_Ca_current__O_Ca) * var_chaste_interface__L_type_Ca_current_y_gate__y / ((1.0 - 3.773584905660377 * var_L_type_Ca_current__i_Ca_max) * (-1.0 + exp(-1.0000000000000001e-7)))) + 5.5865012728500001e-12 * (-NV_Ith_S(mParameters, 4) + var_chaste_interface__intracellular_ion_concentrations__Ki * exp(1.0000000000000001e-7)) * (var_chaste_interface__L_type_Ca_current__O + var_chaste_interface__L_type_Ca_current__O_Ca) * var_chaste_interface__L_type_Ca_current_y_gate__y / ((1.0 - 3.773584905660377 * var_L_type_Ca_current__i_Ca_max) * (-1.0 + exp(1.0000000000000001e-7)))) : (2.0912447872899554e-6 * (-NV_Ith_S(mParameters, 4) + var_chaste_interface__intracellular_ion_concentrations__Ki * _lt_0_row[2]) * (var_chaste_interface__L_type_Ca_current__O + var_chaste_interface__L_type_Ca_current__O_Ca) * var_chaste_interface__L_type_Ca_current_y_gate__y * var_chaste_interface__membrane__V / ((1.0 - 3.773584905660377 * var_L_type_Ca_current__i_Ca_max) * (_lt_0_row[3])))); // microA_per_microF
