...
class Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__Vm_s__Vm_s)
    {
        ...
        const double* const _lt_0_row = Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables(const Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables> Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt::Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt::~Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__Vm_s__Vm_s);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__Vm_s__Vm_s);
        ...
        const double var_i_Kto_s__i_Kto_s_converted = 1.0002089945597463 * (-var_i_Kr_s__E_Kr_s + var_chaste_interface__Vm_s__Vm_s) * HeartConfig::Instance()->GetCapacitance() * var_chaste_interface__i_Kto_s_r2_gate__r2 * NV_Ith_S(mParameters, 13) / ((_lt_0_row[6]) * (_lt_0_row[7])); // uA_per_cm2
        ...
        const double var_i_Kr_s__i_Kr_s_converted = 0.026145463117791767 * (-var_i_Kr_s__E_Kr_s + var_chaste_interface__Vm_s__Vm_s) * HeartConfig::Instance()->GetCapacitance() * var_chaste_interface__i_Kr_s_xr_gate__xr * NV_Ith_S(mParameters, 10) / (_lt_0_row[11]); // uA_per_cm2
    ...
    void Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Vm_s__Vm_s = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_i_Kto_s__i_Kto_s = 5.0657093428584157e-5 * (-var_i_Kr_s__E_Kr_s + var_chaste_interface__Vm_s__Vm_s) * var_chaste_interface__i_Kto_s_r2_gate__r2 * NV_Ith_S(mParameters, 13) / ((_lt_0_row[6]) * (_lt_0_row[7])); // microA
        const double var_i_Kto_t__i_Kto_t = 5.6214411695011118e-5 * (-var_i_Kr_t__E_Kr_t + var_chaste_interface__Vm_t__Vm_t) * var_chaste_interface__i_Kto_t_r2_gate__r2 * NV_Ith_S(mParameters, 13) / ((1.0 + exp(-1.7703904136064939 + 0.038654812524159254 * var_chaste_interface__Vm_t__Vm_t)) * (1.0 + exp(-9.8123827392120067 - 0.17056114617090226 * var_chaste_interface__Vm_t__Vm_t))); // microA
        ...
        const double var_i_Kr_s__i_Kr_s = 1.3241764222231898e-6 * (-var_i_Kr_s__E_Kr_s + var_chaste_interface__Vm_s__Vm_s) * var_chaste_interface__i_Kr_s_xr_gate__xr * NV_Ith_S(mParameters, 10) / (_lt_0_row[11]); // microA
        const double var_i_Kr_t__i_Kr_t = 6.3234832614954339e-7 * sqrt(var_chaste_interface__ion_concentrations__K_t) * (-var_i_Kr_t__E_Kr_t + var_chaste_interface__Vm_t__Vm_t) * var_chaste_interface__i_Kr_t_xr_gate__xr * NV_Ith_S(mParameters, 10) / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__Vm_t__Vm_t)); // microA
    ...
    N_Vector Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Vm_s__Vm_s = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpasek_simurda_orchard_christe_2008FromCellMLCvodeDataClampOpt)
