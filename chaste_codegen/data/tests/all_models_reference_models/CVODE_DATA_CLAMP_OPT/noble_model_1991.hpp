#ifdef CHASTE_CVODE
#ifndef CELLNOBLE_MODEL_1991FROMCELLMLCVODEDATACLAMPOPT_HPP_
#define CELLNOBLE_MODEL_1991FROMCELLMLCVODEDATACLAMPOPT_HPP_
...
class Cellnoble_model_1991FromCellMLCvodeDataClampOpt : public AbstractCvodeCellWithDataClamp
{
...
CHASTE_CLASS_EXPORT(Cellnoble_model_1991FromCellMLCvodeDataClampOpt)
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellnoble_model_1991FromCellMLCvodeDataClampOpt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellnoble_model_1991FromCellMLCvodeDataClampOpt * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellnoble_model_1991FromCellMLCvodeDataClampOpt(p_solver, p_stimulus);
        }
...
#endif // CELLNOBLE_MODEL_1991FROMCELLMLCVODEDATACLAMPOPT_HPP_
#endif // CHASTE_CVODE