...
class Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables(const Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt::Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt>::Instance();
        Init();
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt::~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
        ...
        const double var_sodium_current__i_Na_converted = pow(var_chaste_interface__sodium_current_m_gate__m, 3) * pow(var_chaste_interface__sodium_current_v_gate__v, 2) * (-var_sodium_current__E_Na + var_chaste_interface__membrane__V) * HeartConfig::Instance()->GetCapacitance() * NV_Ith_S(mParameters, 9); // uA_per_cm2
    ...
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
    ...
    N_Vector Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
template<>
void OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLCvodeDataClampOpt)
