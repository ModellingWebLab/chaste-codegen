...
class Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__cell__V)
    {
        ...
        const double* const _lt_0_row = Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables()
    {
...
protected:
    Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables(const Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables&);
    Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables> Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt::Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 6) = 11.5; // (var_INa__GNa_max) [mS_per_uF]
        NV_Ith_S(this->mParameters, 7) = 0.5; // (var_IK1__gK1_max) [mS_per_uF]
        NV_Ith_S(this->mParameters, 8) = 0.013854200000000001; // (var_IKr__gkr_max) [mS_per_uF]
        NV_Ith_S(this->mParameters, 9) = 0.024897499999999999; // (var_IKs__gks_max) [mS_per_uF]
        NV_Ith_S(this->mParameters, 10) = 4.5; // (var_INaCa__NCXmax) [uA_per_uF]
        NV_Ith_S(this->mParameters, 11) = 0.19; // (var_Ito__gitodv) [mS_per_uF]
    }

    Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt::~Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }
    
    double Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__cell__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__cell__V);
    ...
    void Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        {
            d_dt_chaste_interface_var_cell__V = -var_ICaL__ICaL - var_ICab__ICab - var_IpCa__IpCa - var_cell__clont - var_cell__kiont - var_cell__naiont + 2.0 * var_INaCa__INaCa - (-GetExperimentalVoltageAtTimeT(var_chaste_interface__Environment__time) + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 5); // mV / ms
        }
    ...
    N_Vector Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_Environment__tissue = 0; // dimensionless
        const double var_IKr__gkr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 2)) * NV_Ith_S(mParameters, 8); // mS_per_uF
        const double var_IKs__gks = (1.0 + 0.59999999999999998 / (1.0 + 6.4818210260626455e-7 * pow((1 / var_chaste_interface__Ca__Ca_i), 1.3999999999999999))) * NV_Ith_S(mParameters, 9); // mS_per_uF
        const double var_INa__GNa = ((var_Environment__tissue == 0) ? (NV_Ith_S(mParameters, 6)) : (4.0 * NV_Ith_S(mParameters, 6))); // mS_per_uF
        ...
        const double var_INaCa__INaCa = NV_Ith_S(mParameters, 10) * var_INaCa__allo * var_INaCa__num / ((var_INaCa__denom2 + var_INaCa__denom3) * var_INaCa__denom1); // uA_per_uF
        ...
        if (mDataClampIsOn)
        {
            var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__Environment__time) + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 5); // uA_per_cm2
        }
        ...
        const double var_IK1__IK1 = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 2)) * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * var_IK1__ak1 * NV_Ith_S(mParameters, 7) / (var_IK1__ak1 + var_IK1__bk1); // uA_per_uF
        ...
        const double var_Ito__Ito = pow(var_chaste_interface__Ito__ydv, 3) * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 11) * var_Ito__rv * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv; // uA_per_uF
        ...
        NV_Ith_S(dqs, 4) = var_IK1__IK1_converted;
        NV_Ith_S(dqs, 5) = var_IKr__IKr_converted;
        NV_Ith_S(dqs, 6) = var_IKs__IKs_converted;
        NV_Ith_S(dqs, 7) = var_INaCa__INaCa_converted;
        NV_Ith_S(dqs, 8) = var_cell__i_Stim_converted;
        NV_Ith_S(dqs, 9) = var_Ito__Ito_converted;
        NV_Ith_S(dqs, 10) = var_chaste_interface__Environment__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbenson_epicardial_2008FromCellMLCvodeDataClampOpt)
