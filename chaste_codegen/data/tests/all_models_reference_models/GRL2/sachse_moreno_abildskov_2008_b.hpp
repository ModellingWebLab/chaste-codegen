#ifndef CELLSACHSE_MORENO_ABILDSKOV_2008_BFROMCELLMLGRL2_HPP_
#define CELLSACHSE_MORENO_ABILDSKOV_2008_BFROMCELLMLGRL2_HPP_
...
class Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellsachse_moreno_abildskov_2008_bFromCellMLGRL2(p_solver, p_stimulus);
        }
...
#endif // CELLSACHSE_MORENO_ABILDSKOV_2008_BFROMCELLMLGRL2_HPP_