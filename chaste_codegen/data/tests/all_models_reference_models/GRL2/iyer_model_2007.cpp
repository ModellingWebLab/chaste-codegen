...
#include "MathsCustomFunctions.hpp"
    ...
    double Celliyer_model_2007FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1.8494079065353104e-10 * var_x68 - 5.3730734579697901e-6 * var_x67 - 092547526753060952 * var_x65 - 1.6432444380870198e-6 * var_x15 - 2.1854162994937459e-7 * var_x66;
        }
        else
        {
    ...
    double Celliyer_model_2007FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 1.9425621197603174e-5 * var_x73 - 00012738562343605624 * var_x72 - 3.0564346548418563e-5 * var_x71 - 9.2470395326765519e-9 * var_x68 - 7.1159095070575419e-7 * var_x74 - 5.7513555333045694e-6 * var_x69 - 00041181390311704764 * var_x70;
        }
        else
        {
    ...
    double Celliyer_model_2007FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.13257434520702313 - 3.9156227113154178e-9 * var_x101 - 001427202778983934 * var_x97;
        }
        else
        {
