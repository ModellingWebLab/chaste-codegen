...
#include "MathsCustomFunctions.hpp"
    ...
    double Celliyer_model_2007FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.13257434520702313 - 3.9156227113154178e-9 * var_x100 - 0.001427202778983934 * var_x96;
        }
        else
        {
