...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1998FromCellMLGRL2::VerifyStateVariables()
    {
    ...
    double Cellnoble_model_1998FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -7.0 + var_x173 + var_x174 - 0.00063119563270832375 * var_x95 - 1.0549054718227806e-6 * var_x93 - 4.3552498656874335e-6 * var_x94 + (0.00040000000000000002 * var_x178 - 0.00040000000000000002 * var_x176 - 7.1999999999999991e-9 * var_x179) * mParameters[4];
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -8.0 * var_x207 - 0.001 * ((var_x202) ? (-var_x208 + 499999.99948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (var_x208 + 0.00019999999949504854 * var_x199)) : (var_x201 * var_x206));
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x0 = -0.125 * var_chaste_interface__membrane__V;
            const double var_x203 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x209 = exp(-7.5 + var_x203 + 0.10000000000000001 * mParameters[13]);
            const double var_x210 = 1 / (1.0 + 320.0 * var_x209);
            const double var_x211 = 2.0 * var_x210;
            const double var_x212 = exp(-9.375 + var_x0 + 0.125 * mParameters[13]);
            const double var_x213 = 0.02 * var_x212;
            
            partialF = -var_x211 - var_x213;
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0030000000000000001 * ((var_x233) ? (var_x237 - 499999.99948602181 * (18.999998999999999 + var_chaste_interface__membrane__V) * (-var_x237 - 1.2000000012335477e-5 * var_x232)) : (var_x223 * var_x236)) - 0.0030000000000000001 * ((var_x225) ? (-var_x238 + 1249999.9964946085 * (19.000000400000001 + var_chaste_interface__membrane__V) * (var_x238 + 1.2000000033651759e-5 * var_x222)) : (var_x223 * var_x230));
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0035999999999999999 / var_x244 - var_x242 * var_x245;
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.033000000000000002 / var_x249 - 3.3000000000000003e-5 * var_x247;
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x252 = mParameters[2] + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            const double var_x253 = 1 / var_x252;
            const double var_x255 = mParameters[3] + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
            ...
            partialF = var_x267 + var_x258 * (-0.059999999999999998 - var_x266);
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.050000000000000003 + var_x274;
        }
        else
        {
    ...
    double Cellnoble_model_1998FromCellMLGRL2::EvaluatePartialDerivative21(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.20000000000000001 + var_x274;
        }
        else
        {
