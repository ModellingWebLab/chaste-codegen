#ifndef CELLPACI_HYTTINEN_AALTOSETALA_SEVERI_ATRIALVERSIONFROMCELLMLGRL2_HPP_
#define CELLPACI_HYTTINEN_AALTOSETALA_SEVERI_ATRIALVERSIONFROMCELLMLGRL2_HPP_
...
class Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellpaci_hyttinen_aaltosetala_severi_atrialVersionFromCellMLGRL2(p_solver, p_stimulus);
        }
...
#endif // CELLPACI_HYTTINEN_AALTOSETALA_SEVERI_ATRIALVERSIONFROMCELLMLGRL2_HPP_