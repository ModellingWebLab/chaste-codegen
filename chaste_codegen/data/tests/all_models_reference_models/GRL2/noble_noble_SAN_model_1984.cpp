...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_background_current__E_Ca = 0.5 * var_membrane__RTONF * log(10) * log10(var_extracellular_calcium_concentration__Cao / var_chaste_interface__intracellular_calcium_concentration__Cai); // millivolt
        const double var_fast_sodium_current__E_mh = var_membrane__RTONF * log(10) * log10((0.12 * var_chaste_interface__extracellular_potassium_concentration__Kc + var_extracellular_sodium_concentration__Nao) / (0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki + var_chaste_interface__intracellular_sodium_concentration__Nai)); // millivolt
        const double var_hyperpolarising_activated_current__E_K = var_membrane__RTONF * log(10) * log10(var_chaste_interface__extracellular_potassium_concentration__Kc / var_chaste_interface__intracellular_potassium_concentration__Ki); // millivolt
        const double var_hyperpolarising_activated_current__E_Na = var_membrane__RTONF * log(10) * log10(var_extracellular_sodium_concentration__Nao / var_chaste_interface__intracellular_sodium_concentration__Nai); // millivolt
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x5 = var_x3 * log10(var_x4);
            const double var_x6 = exp(0.74867781645490938 + var_x2 - 2.0 * var_x5);
            ...
            const double var_x11 = 0.75 * var_x10;
            const double var_x12 = 1 / (45.0 + var_chaste_interface__extracellular_potassium_concentration__Kc);
            const double var_x13 = var_x12 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
            const double var_x14 = var_x13 * var_chaste_interface__extracellular_potassium_concentration__Kc;
            ...
            const double var_x25 = -0.037433890822745473 * var_chaste_interface__membrane__V;
            ...
            const double var_x28 = var_x27 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
            const double var_x29 = -26.713760659695652 * var_x5 + var_chaste_interface__membrane__V;
            const double var_x30 = var_x29 * var_chaste_interface__extracellular_potassium_concentration__Kc;
            const double var_x31 = var_x6 * var_x9 / pow(var_x7, 2);
            const double var_x32 = var_x30 * var_x31;
            const double var_x33 = var_chaste_interface__second_inward_current_f2_gate__f2 * var_chaste_interface__second_inward_current_f_gate__f;
            const double var_x34 = var_x33 * var_chaste_interface__second_inward_current_d_gate__d;
            const double var_x35 = exp(3.7433890822745473 - var_x2);
            ...
            const double var_x41 = 1.1230167246823641 * var_x40;
            const double var_x42 = exp(1.8716945411372736 + var_x25);
            const double var_x43 = 1.0 - var_x42;
            const double var_x44 = 1 / var_x43;
            const double var_x45 = 0.0028075418117059106 * var_x44;
            const double var_x46 = exp(1.8716945411372736);
            const double var_x47 = -140.0 * var_x42 + var_x46 * var_chaste_interface__intracellular_sodium_concentration__Nai;
            const double var_x48 = var_x34 * var_x47;
            const double var_x49 = var_x42 * var_chaste_interface__extracellular_potassium_concentration__Kc;
            const double var_x50 = -var_x49 + var_x46 * var_chaste_interface__intracellular_potassium_concentration__Ki;
            ...
            const double var_x54 = var_x37 * var_x53;
            const double var_x55 = var_x35 * var_x54;
            const double var_x56 = var_x42 * var_x53;
            const double var_x57 = var_x44 * var_x56;
            const double var_x58 = var_x35 * var_x39 * var_x53 / pow(var_x36, 2);
            const double var_x59 = var_x42 * var_x52 / pow(var_x43, 2);
            const double var_x60 = 0.00010509721365969207 * var_x59;
            const double var_x61 = var_x34 * var_x50;
            const double var_x62 = var_x44 * var_x49 * var_x53;
            const double var_x63 = 1 / mParameters[0];
            const double var_x64 = 0.001 * var_x63;
            
            partialF = var_x64 * (-0.080000000000000002 + 0.084077770927753662 * var_x58 + 0.056150836234118207 * var_x32 - 12.0 * var_x14 - 1.25 * var_x1 - 0.002 * var_x24 - 0.16815554185550732 * var_x55 - 0.00010509721365969207 * var_x62 - 0.01471360991235689 * var_x57 - 0.0053476986889636384 * var_x28 + var_x48 * var_x60 + var_x60 * var_x61 - var_x11 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x34 * var_x41 - var_x34 * var_x51 - var_x45 * var_x48);
        }
        else
        {
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x53 = var_x34 * var_x52;
            const double var_x54 = var_x37 * var_x53;
            const double var_x65 = 1 / var_chaste_interface__intracellular_calcium_concentration__Cai;
            const double var_x66 = var_x19 * var_x23;
            const double var_x67 = 2.0 * var_x18 - 2744000.0 * var_x20;
            const double var_x68 = var_x22 * var_x67 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
            const double var_x69 = var_x21 * var_x67 / pow((0.0036443148688046646 + 7.2886297376093296e-7 * var_x15 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
            const double var_x70 = var_x38 * var_x54;
            const double var_x113 = 0.0040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
            const double var_x114 = pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 2.0);
            const double var_x115 = 3.9999999999999998e-6 + var_x114;
            const double var_x116 = 1 / var_x115;
            const double var_x117 = var_x116 * pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 1.0);
            const double var_x118 = pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 3.0) / pow(var_x115, 2);
            
            partialF = -0.19999999999999998 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 9.8799649730872331e-11 * var_x68 - 4.7813590510367518e-7 * var_x65 - 4.0200601101640967e-6 * var_x70 - 0.039290759255291838 * var_x66 - 5.2182178629987073e-11 * var_x69 + var_x113 * var_x117 - var_x113 * var_x118;
        }
        else
        {
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x120 = exp(-3.484 - 0.067000000000000004 * var_chaste_interface__membrane__V);
            const double var_x121 = 52.0 + var_chaste_interface__membrane__V;
            const double var_x122 = fabs(var_x121) < 1.0000000000000001e-5;
            const double var_x123 = exp(-10.4 - 0.20000000000000001 * var_chaste_interface__membrane__V);
            const double var_x124 = 1.0 - 1.0 * var_x123;
            const double var_x125 = 1 / var_x124;
            
            partialF = -0.0001 * var_x120 - 0.002 * ((var_x122) ? (2.5) : (var_x121 * var_x125));
        }
        else
        {
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x127 = 22.0 + var_chaste_interface__membrane__V;
            ...
            const double var_x131 = 0.5 / var_x130;
            ...
            const double var_x134 = 0.17799999999999999 / var_x133;
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x151 = 30.0 / var_x150;
            ...
            const double var_x154 = 12.0 / var_x153;
            
            partialF = -0.001 * ((var_x146) ? (120.0) : (var_x145 * var_x151)) - 0.001 * ((var_x146) ? (120.0) : (var_x145 * var_x154));
        }
        else
        {
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x147 = 0.25 * var_chaste_interface__membrane__V;
            const double var_x148 = -var_x147;
            const double var_x155 = 34.0 + var_chaste_interface__membrane__V;
            const double var_x156 = fabs(var_x155) < 0.0001;
            const double var_x157 = exp(8.5 + var_x147);
            const double var_x158 = -1.0 + var_x157;
            const double var_x159 = 6.25 / var_x158;
            const double var_x160 = exp(-8.5 + var_x148);
            const double var_x161 = 1.0 + var_x160;
            
            partialF = -0.001 * ((var_x156) ? (25.0) : (var_x155 * var_x159)) - 0.050000000000000003 / var_x161;
        }
        else
        {
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x67 = 2.0 * var_x18 - 2744000.0 * var_x20;
            const double var_x69 = var_x21 * var_x67 / pow((0.0036443148688046646 + 7.2886297376093296e-7 * var_x15 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
            const double var_x71 = 1 / var_chaste_interface__intracellular_sodium_concentration__Nai;
            const double var_x77 = 1 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki + var_chaste_interface__intracellular_sodium_concentration__Nai);
            const double var_x87 = 1.0 + var_chaste_interface__extracellular_potassium_concentration__Kc;
            const double var_x88 = 1 / var_x87;
            const double var_x89 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Nai);
            const double var_x90 = var_x88 * var_x89;
            const double var_x92 = var_x1 * var_x77;
            const double var_x93 = var_chaste_interface__extracellular_potassium_concentration__Kc * var_chaste_interface__intracellular_sodium_concentration__Nai;
            const double var_x94 = var_x88 * var_x93 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Nai), 2);
            const double var_x95 = pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 2.0);
            const double var_x96 = var_x69 * var_x95;
            const double var_x97 = var_x17 * var_x23 * var_x95;
            const double var_x99 = var_x71 * var_chaste_interface__extracellular_potassium_concentration__Kc;
            const double var_x100 = var_x46 * var_x53;
            const double var_x163 = 2.0100300550820484e-8 * var_x44;
            const double var_x167 = 0.0010739092362051341 * var_x90;
            const double var_x168 = 0.0011475261722488205 * var_x13;
            const double var_x169 = -var_x100 * var_x163;
            
            partialF = var_x169 + 6.7119327262820874e-7 * var_x94 + 3.4230292104218926e-16 * var_x96 - 2.5773821668923216e-7 * var_x97 - 1.3387805342902908e-5 * var_x71 - 0.0002390679525518376 * var_x92 - var_x167 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x168 * var_x99;
        }
        else
        {
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x171 = 0.002 * var_chaste_interface__intracellular_calcium_concentration__p;
            
            partialF = -var_x171 - 0.79999999999999993 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        }
        else
        {
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x115 = 3.9999999999999998e-6 + var_x114;
            const double var_x116 = 1 / var_x115;
            const double var_x119 = var_x114 * var_x116;
            const double var_x173 = 0.0050000000000000001 * var_chaste_interface__intracellular_calcium_concentration__p;
            
            partialF = -var_x173 - 0.099999999999999992 * var_x119;
        }
        else
        {
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x147 = 0.25 * var_chaste_interface__membrane__V;
            const double var_x148 = -var_x147;
            const double var_x175 = exp(16.0 + var_x147);
            const double var_x176 = -1.0 + var_x175;
            const double var_x177 = 0.00062500000000000001 / var_x176;
            const double var_x178 = exp(-16.0 + var_x148);
            const double var_x179 = 1.0 + var_x178;
            const double var_x180 = 64.0 + var_chaste_interface__membrane__V;
            
            partialF = -0.0050000000000000001 / var_x179 - var_x177 * var_x180;
        }
        else
        {
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x90 = var_x88 * var_x89;
            const double var_x93 = var_chaste_interface__extracellular_potassium_concentration__Kc * var_chaste_interface__intracellular_sodium_concentration__Nai;
            const double var_x105 = var_x89 * var_x93 / pow(var_x87, 2);
            const double var_x106 = var_x30 * var_x8 / pow((1 + 0.10000000000000001 * var_chaste_interface__extracellular_potassium_concentration__Kc), 2);
            const double var_x107 = var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow((1 + 0.022222222222222223 * var_chaste_interface__extracellular_potassium_concentration__Kc), 2);
            const double var_x110 = var_x29 * var_x31;
            const double var_x181 = 4.8349825755906823e-5 * var_x10;
            const double var_x182 = 1.8099220986453831e-7 * var_x44;
            const double var_x183 = 0.00038679860604725458 * var_x29;
            const double var_x185 = 0.0064466434341209095 * var_x90;
            const double var_x186 = 9.2094906201727277e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
            const double var_x187 = 0.0012916056731812832 * var_x10;
            const double var_x188 = 0.010332845385450266 * var_x13;
            const double var_x189 = 9.6699651511813646e-5 * var_x110;
            
            partialF = -0.001 + var_x189 - var_x187 - var_x188 + 0.0064466434341209095 * var_x105 - 4.8349825755906825e-7 * var_x106 + var_x13 * var_x183 + var_x181 * var_x29 - var_x182 * var_x56 - var_x185 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x186 * var_x26 - 1.9101165730728621e-7 * var_x107 * var_x30;
        }
        else
        {
    ...
    double Cellnoble_noble_SAN_model_1984FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x168 = 0.0011475261722488205 * var_x13;
            const double var_x169 = -var_x100 * var_x163;
            const double var_x194 = 1.0227707011477466e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
            const double var_x195 = 0.00014344077153110256 * var_x10;
            const double var_x196 = 1.073909236205134e-5 * var_x110;
            
            partialF = var_x169 - var_x194 + var_x196 * var_x4 - var_x168 * var_x4 - var_x195 * var_x4;
        }
        else
        {
