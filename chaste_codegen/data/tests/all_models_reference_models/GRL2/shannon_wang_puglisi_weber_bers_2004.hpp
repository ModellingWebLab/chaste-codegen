#ifndef CELLSHANNON_WANG_PUGLISI_WEBER_BERS_2004FROMCELLMLGRL2_HPP_
#define CELLSHANNON_WANG_PUGLISI_WEBER_BERS_2004FROMCELLMLGRL2_HPP_
...
class Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL2 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL2();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL2(p_solver, p_stimulus);
        }
...
#endif // CELLSHANNON_WANG_PUGLISI_WEBER_BERS_2004FROMCELLMLGRL2_HPP_