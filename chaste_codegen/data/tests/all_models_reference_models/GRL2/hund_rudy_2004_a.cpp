...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_reversal_potentials__ECl = -log(10) * log10(var_Environment__Cl_o / var_chaste_interface__Cl__Cl_i) / var_Environment__FonRT; // mV
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x68 = 1 / (13227.9606 + 8.4084932990912282 * var_x63 + 6516533.0625 * var_chaste_interface__Ca__Ca_i);
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x161 * (-0.14705882352941174 + var_x180 - var_x163 - var_x177 + 3.8450464301480458e-12 * var_x121 + 1.768721357868101e-6 * var_x117 - 4.2483225407660435e-11 * var_x120 - 1139.4871996672337 * var_x119 - 8.8666719524733664e-8 * var_x118) + (0.00023800000000000004 / pow(var_x159, 3) + 7.0000000000000007e-5 / pow(var_x114, 3)) * (0.14705882352941174 * var_chaste_interface__Ca__Ca_ss + 2.3676470588235295e-5 * var_chaste_interface__Ca__Ca_nsr - 0.14705882352941174 * var_chaste_interface__Ca__Ca_i - var_x162 * var_chaste_interface__cell__V - var_x163 * var_chaste_interface__Ca__Ca_i - var_x177 * var_chaste_interface__Ca__Ca_i + 0.00027684334297065928 * var_x74 * var_x92) / pow(var_x160, 2);
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x244 = var_x137 * var_chaste_interface__ICaL__fca;
            ...
            partialF = var_x243 * (-1 + var_x137 * var_x253);
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x244 = var_x137 * var_chaste_interface__ICaL__fca;
            const double var_x245 = -var_x244;
            const double var_x251 = var_x135 * var_chaste_interface__ICaL__fca;
            ...
            partialF = var_x264 * (-1 + 351.08651860830804 * var_x100 * var_x108 * var_x267 * var_x95 * var_x98 * mParameters[0] * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca) - var_x254 * var_x271;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative23(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x381 = var_x12 * log10(100.0 * var_x156);
            const double var_x382 = var_x127 + var_x381;
            ...
            const double var_x386 = var_x126 * var_x384 - var_x126 * var_x385;
            
            partialF = var_x386 + 4.9335731356566794e-16 * var_x146 - 1.7874450622236046e-6 * var_x143 - 1.068185898837083e-5 * var_x144 - 0.013557744100624516 * var_x148 - 0.0044848621561246801 * var_x147;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x156 = 1 / var_chaste_interface__Cl__Cl_i;
            const double var_x381 = var_x12 * log10(100.0 * var_x156);
            const double var_x388 = -1.5317126959137754e-6 - 9.1902761754826519e-7 * var_x30;
            ...
            const double var_x393 = 3.0157226903121925e-5 * var_x86;
            const double var_x394 = var_x122 * var_x390;
            const double var_x395 = var_x52 + 26.712338705500134 * var_x381;
            const double var_x396 = 0.00018900582374463672 / (87.825100000000006 + var_x395);
            const double var_x397 = 2.4504050574883893e-8 * var_x395 / pow((1 + 0.30415380916731244 * var_x14 + 0.30415380916731244 * var_x381), 2);
            const double var_x398 = var_x13 * var_x397 - var_x13 * var_x396;
            
            partialF = var_x398 + 0.00019989044893084398 * var_x154 + 26.712338705500134 * var_x394 - 4.535681662754383e-6 * var_x149 - 0.00031223895504468581 * var_x155 - 2.2767478584105716e-5 * var_x151 - 0.0008381150898567882 * var_x150 - var_x153 * var_x393;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative25(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x387 + var_x399 + 8.8885199344722979e-8 * var_x58 - 3.6975665728975948e-7 * var_x156;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative26(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x405 = 0.70217303721661617 * var_x102;
            const double var_x407 = exp(2.6000000000000001 + var_x108 * var_x405);
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative28(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x244 = var_x137 * var_chaste_interface__ICaL__fca;
            const double var_x259 = var_x110 * var_x158;
            const double var_x405 = 0.70217303721661617 * var_x102;
            const double var_x407 = exp(2.6000000000000001 + var_x108 * var_x405);
            const double var_x408 = 1.0 + var_x407;
            const double var_x409 = -var_chaste_interface__Ca__Ca_ss + var_chaste_interface__Ca__Ca_jsr;
            ...
            const double var_x414 = var_x413 * var_chaste_interface__Irel__ri;
            const double var_x417 = var_x414 * var_chaste_interface__Irel__ro;
            const double var_x419 = var_x108 * var_x157 * var_x411;
