...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_Environment__Cl_o = 100; // mM
        const double var_Environment__F = 96485.0; // C_per_mole
        const double var_Environment__FonRT = 0374358835078; // per_mV
        const double var_Environment__K_o = 5.4000000000000004; // mM
        const double var_Environment__Na_o = 140; // mM
        ...
        const double var_ICaL__pca = 000243; // L_per_F_ms
        const double var_IClb__GClb = 00022499999999999999; // mS_per_uF
        const double var_IKr__gkr = 0059618984305585326 * sqrt(var_Environment__K_o); // mS_per_uF
        const double var_IKs__gks = 024897499999999999 + 014938499999999999 / (1.0 + 6.4818210260626455e-7 * pow(1 / var_chaste_interface__Ca__Ca_i, 1.3999999999999999)); // mS_per_uF
        ...
        const double var_INaCa__KmCa = 000125; // mM
        const double var_INaCa__KmCai = 0035999999999999999; // mM
        ...
        const double var_INaK__kmnai = 10; // mM
        const double var_INaK__sigma = -0.14285714285714285 + 0.14285714285714285 * exp(01485884101040119 * var_Environment__Na_o); // dimensionless
        const double var_INal__GNaL = 0064999999999999997; // mS_per_uF
        const double var_IpCa__ibarpca = 057500000000000002; // uA_per_uF
        const double var_IpCa__kmpca = 00050000000000000001; // mM
        ...
        const double var_IKr__r = 1.0 / (1.0 + exp(0.64935064935064934 + 064935064935064929 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_INaK__fnak = 1.0 / (1.0 + 0.1245 * exp(-0.10000000000000001 * var_Environment__FonRT * var_chaste_interface__cell__V) + 036499999999999998 * var_INaK__sigma * exp(-var_Environment__FonRT * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_Ito__rv = exp(0033333333333333335 * var_chaste_interface__cell__V); // dimensionless
        ...
        const double var_IKp__IKp = 0027599999999999999 * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__cell__V)); // uA_per_uF
        ...
        const double var_reversal_potentials__prnak = 018329999999999999; // dimensionless
    ...
    void Cellhund_rudy_2004_aFromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        ...
        const double var_Ca__BSRmax = 047; // mM
        const double var_Ca__KmBSL = 0086999999999999994; // mM
        const double var_Ca__KmBSR = 00087000000000000001; // mM
        ...
        const double var_Ca__cbar = 050000000000000003; // mM
        const double var_Ca__csqnbar = 10; // mM
        const double var_Ca__kmc = 0023800000000000002; // mM
        ...
        const double var_Ca__kmt = 00050000000000000001; // mM
        const double var_Ca__tbar = 070000000000000007; // mM
        ...
        const double var_IpCa__kmpca = 00050000000000000001; // mM
        const double var_IpCa__IpCa = var_chaste_interface__Ca__Ca_i * var_IpCa__ibarpca / (var_chaste_interface__Ca__Ca_i + var_IpCa__kmpca); // uA_per_uF
        const double var_Irel__CaMK0 = 050000000000000003; // dimensionless
        const double var_Irel__Km = 0015; // mM
        ...
        const double var_ICaL__taufca = 0.5 + 1.0 / (1.0 + 333.33333333333331 * var_chaste_interface__Ca__Ca_ss) + 10 * var_Irel__CaMKactive / (0.14999999999999999 + var_Irel__CaMKactive); // ms
        const double var_Irel__KmCaMK = 0.14999999999999999; // dimensionless
        const double var_Irel__dro_inf = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999) / (pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999) + 1644.6531773416521 * pow((var_chaste_interface__Ca__Ca_ss / (0028 + var_chaste_interface__Ca__Ca_ss)), 1.8999999999999999)); // dimensionless
        const double var_Irel__dtau_rel_max = 10; // ms
        ...
        const double var_Ito2__PCl = 3.9999999999999998e-7; // L_per_F_ms
        const double var_Iup_Ileak__Kmup = 00092000000000000003; // mM
        ...
        const double var_Iup_Ileak__dKmPLBmax = 00017000000000000001; // mM
        ...
        const double var_Iup_Ileak__iupmax = 0043750000000000004; // mM_per_ms
        ...
        const double var_ICaL__ibarca = 4.0 * (-15.0 + var_chaste_interface__cell__V) * (-var_Environment__Ca_o * var_ICaL__gacao + var_chaste_interface__Ca__Ca_ss * var_ICaL__gacai * exp(2.0 * (-15.0 + var_chaste_interface__cell__V) * var_Environment__FonRT)) * var_Environment__F * var_Environment__FonRT * mParameters[0] * var_ICaL__pca / (-1.0 + exp(2.0 * (-15.0 + var_chaste_interface__cell__V) * var_Environment__FonRT)); // uA_per_uF
        const double var_ICaL__ICaL = ((var_Environment__tissue == 0) ? (pow(var_chaste_interface__ICaL__d, var_chaste_interface__ICaL__dp) * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca * var_chaste_interface__ICaL__fca2 * var_ICaL__ibarca) : (var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca * var_chaste_interface__ICaL__fca2 * var_ICaL__ibarca)); // uA_per_uF
        const double var_ICaL__fca2ss = 1.0 / (1.0 - 100 * var_ICaL__ICaL); // dimensionless
        const double var_ICaL__fcass = 0.14999999999999999 + 0.55000000000000004 / (1.0 + 333.33333333333331 * var_chaste_interface__Ca__Ca_ss) + 0.29999999999999999 / (1.0 - 20 * var_ICaL__ICaL); // dimensionless
        ...
        const double var_ICaL__taufca2 = 125.0 + 300 / (1.0 + exp(-4.375 - 25.0 * var_ICaL__ICaL)); // ms
        ...
        const double d_dt_chaste_interface_var_INal__hL = 0016666666666666668 * var_INal__hLss - 0016666666666666668 * var_chaste_interface__INal__hL; // 1 / ms
        const double var_Irel__cafac = 1.0 / (1.0 + exp(3.3333333333333335 + 66.666666666666671 * var_ICaL__ICaL)); // dimensionless
        const double var_Irel__riss = 1.0 / (1.0 + exp(-16.0 + 80 * var_Irel__cafac + 40000 * var_chaste_interface__Ca__Ca_ss)); // dimensionless
        ...
        const double var_Irel__tauri = 3.0 + (350 - var_Irel__dtau_rel) / (1.0 + exp(-15.0 + 5000 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_Irel__cafac)) + var_Irel__dtau_rel; // ms
        const double d_dt_chaste_interface_var_Irel__ri = (-var_chaste_interface__Irel__ri + var_Irel__riss) / var_Irel__tauri; // 1 / ms
        const double var_Irel__vg = ((var_Environment__tissue == 0) ? (1.0 / (1.0 + exp(2.6000000000000001 + 0.20000000000000001 * var_ICaL__ibarca))) : (1.0)); // dimensionless
        const double var_Irel__Grel = 3000 * var_Irel__vg; // per_ms
        ...
        const double var_Ito2__Ito2_max = (-var_Environment__Cl_o * exp(var_Environment__FonRT * var_chaste_interface__cell__V) + var_chaste_interface__Cl__Cl_i) * var_Environment__F * var_Environment__FonRT * var_Ito2__PCl * var_chaste_interface__cell__V / (1.0 - exp(var_Environment__FonRT * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_Ito2__Ito2 = var_chaste_interface__Ito2__AA * var_Ito2__Ito2_max; // uA_per_uF
        const double var_cell__a = 0011000000000000001; // cm
        const double var_cell__i_Stim_converter = GetIntracellularAreaStimulus(var_chaste_interface__Environment__time); // uA_per_cm2
        const double var_cell__i_Stim = var_cell__i_Stim_converter / HeartConfig::Instance()->GetCapacitance(); // uA_per_uF
        const double var_cell__l = 01; // cm
        ...
        const double var_cell__vcell = 1000 * M_PI * pow(var_cell__a, 2) * var_cell__l; // uL
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x194 = var_chaste_interface__cell__V >= -40;
            const double var_x195 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V);
            const double var_x196 = exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__cell__V);
            const double var_x197 = 1.0 + var_x196;
            const double var_x198 = exp(079000000000000001 * var_chaste_interface__cell__V);
            const double var_x199 = exp(0.34999999999999998 * var_chaste_interface__cell__V);
            
            partialF = -((var_x194) ? (0) : (0.13500000000000001 * var_x195)) - ((var_x194) ? (7.6923076923076916 / var_x197) : (310000 * var_x199 + 3.5600000000000001 * var_x198));
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x211 = exp(-043909999999999998 * var_chaste_interface__cell__V);
            const double var_x212 = -127140 * var_x210 - 3.4740000000000003e-5 * var_x211;
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x228 = exp(0.67599999999999993 + 051999999999999998 * var_chaste_interface__cell__V);
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -052900000000000003 - var_x237;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x242 = 10 * var_x172;
            ...
            const double var_x246 = pow((0142415038316475 + var_x245), (-2));
            const double var_x253 = 0042724511494942495 * var_x246;
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x265 = 1 / (125.0 + 300 * var_x264);
            const double var_x266 = pow((0028483007663294996 + var_x245), (-2));
            ...
            partialF = var_x265 * (-1 + 0028483007663294996 * var_x254 * var_x266) - var_x254 * var_x271;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x272 = 042299999999999997 * exp(-1.20074125971556 * pow((-1 + 053842757610673787 * var_chaste_interface__cell__V), 2));
            
            partialF = -0054000000000000003 - var_x272;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x292 = exp(-070400000000000004 + 0.128 * var_chaste_interface__cell__V);
            const double var_x293 = -1.0 + var_x292;
            const double var_x294 = 1 / var_x293;
            const double var_x295 = 00036000000000000002 * var_x294;
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -3.8050000000000003e-5 * var_x290 * var_x297 - 00018000000000000001 * var_x294 * var_x296;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x302 = 040000000000000001 * var_chaste_interface__cell__V;
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -029999999999999999 * var_x320 - 0.20000000000000001 * var_x316;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.10000000000000001 * var_x316 - 0022499999999999998 * var_x320;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x324 = 0025000000000000005 * var_x167;
            
            partialF = -00068000000000000005 - var_x169 * var_x324 + var_x164 * var_x181 * var_x324;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x359 = exp(-15.0 + 5000 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_x356);
            const double var_x360 = 1.0 + var_x359;
            const double var_x361 = 1 / var_x360;
            const double var_x362 = 350 - var_x242;
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative23(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x381 = log(100 * var_x155);
            const double var_x382 = var_x125 + var_x381;
            const double var_x383 = pow(var_x382, 4);
            const double var_x384 = 2.8839711417381356e-9 * pow(var_x382, 7) / pow((1 + 008558014922736952 * var_x383), 2);
            const double var_x385 = 2048989239405216 * pow(var_x382, 3) / (59494197.640692554 + 509152.23122530844 * var_x383);
            const double var_x386 = var_x124 * var_x384 - var_x124 * var_x385;
            
            partialF = var_x386 + 4.9335731356566794e-16 * var_x143 - 1.7874450622236046e-6 * var_x141 - 1.068185898837083e-5 * var_x142 - 013557744100624516 * var_x147 - 0044848621561246801 * var_x146;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x396 = 00018900582374463672 / (87.825100000000006 + var_x395);
            ...
            partialF = var_x398 + 212.79583259575517 * var_x394 + 00019989044893084398 * var_x153 - 4.535681662754383e-6 * var_x148 - 00031223895504468581 * var_x154 - 2.2767478584105716e-5 * var_x150 - 0008381150898567882 * var_x149 - var_x152 * var_x393;
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative26(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x418 = 3000 * var_x417;
            const double var_x419 = 1.0 * var_x403;
            
            partialF = var_x419 * (-0083333333333333332 - var_x418) + 0.25 * (0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x409 * var_x418) / (pow(var_x401, 3) * pow((0.125 + var_x402), 2));
        }
        else
        {
    ...
    double Cellhund_rudy_2004_aFromCellMLGRL2::EvaluatePartialDerivative28(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x425 = 0086999999999999994 + var_chaste_interface__Ca__Ca_ss;
            const double var_x426 = 00087000000000000001 + var_chaste_interface__Ca__Ca_ss;
            const double var_x427 = 1.0 + 0097788000000000007 / pow(var_x425, 2) + 4.0890000000000003e-5 / pow(var_x426, 2);
            const double var_x428 = 1 / var_x427;
            const double var_x429 = 1.0 * var_x428;
            const double var_x432 = 719.99999999999989 * var_x417;
            
            partialF = var_x429 * (-5.0 - var_x432 - 0036718475849305066 * var_x259 - 505.56458679596358 * var_x420) + 1.0 * (019557600000000001 / pow(var_x425, 3) + 8.1780000000000006e-5 / pow(var_x426, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0036718475849305066 * var_x244 + var_x409 * var_x432) / pow(var_x427, 2);
        }
        else
        {
