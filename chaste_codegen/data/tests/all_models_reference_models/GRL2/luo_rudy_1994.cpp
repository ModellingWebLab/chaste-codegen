...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel_f_Ca_gate__Km_Ca = 00059999999999999995; // mM
        ...
        const double var_L_type_Ca_channel_f_Ca_gate__f_Ca = 1.0 / (1.0 + pow(var_chaste_interface__ionic_concentrations__Cai, 2) / pow(var_L_type_Ca_channel_f_Ca_gate__Km_Ca, 2)); // dimensionless
        ...
        const double var_non_specific_calcium_activated_current__i_ns_K = 1.0 * var_non_specific_calcium_activated_current__I_ns_K / (1.0 + pow(var_non_specific_calcium_activated_current__K_m_ns_Ca, 3) / pow(var_chaste_interface__ionic_concentrations__Cai, 3)); // uA_per_mm2
        const double var_non_specific_calcium_activated_current__i_ns_Na = 1.0 * var_non_specific_calcium_activated_current__I_ns_Na / (1.0 + pow(var_non_specific_calcium_activated_current__K_m_ns_Ca, 3) / pow(var_chaste_interface__ionic_concentrations__Cai, 3)); // uA_per_mm2
        ...
        const double var_plateau_potassium_current__g_Kp = 000183; // mS_per_mm2
        ...
        const double var_sodium_potassium_pump__I_NaK = 014999999999999999; // uA_per_mm2
        const double var_sodium_potassium_pump__K_mKo = 1.5; // mM
        const double var_sodium_potassium_pump__K_mNai = 10; // mM
        const double var_sodium_potassium_pump__sigma = -0.14285714285714285 + 0.14285714285714285 * exp(01485884101040119 * mParameters[2]); // dimensionless
        ...
        const double var_time_dependent_potassium_current__PR_NaK = 018329999999999999; // dimensionless
        ...
        const double var_time_dependent_potassium_current__g_K_max = 00282; // mS_per_mm2
    ...
    void Cellluo_rudy_1994FromCellMLGRL2::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        ...
        const double var_membrane__I_st = 0099999999999999985 * var_membrane__I_st_converter; // uA_per_mm2
        const double var_membrane__R = 8314.5; // gas_constant_units
        const double var_membrane__T = 310; // kelvin
        const double var_calcium_background_current__E_CaN = 0.5 * var_membrane__R * var_membrane__T * log(mParameters[0] / var_chaste_interface__ionic_concentrations__Cai) / var_membrane__F; // mV
        const double var_fast_sodium_current__E_Na = var_membrane__R * var_membrane__T * log(mParameters[2] / var_chaste_interface__ionic_concentrations__Nai) / var_membrane__F; // mV
    ...
    void Cellluo_rudy_1994FromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_calcium_fluxes_in_the_SR__I_up = 0050000000000000001; // mM_per_ms
        ...
        const double var_calcium_fluxes_in_the_SR__K_mrel = 00080000000000000004; // mM
        const double var_calcium_fluxes_in_the_SR__K_mup = 00092000000000000003; // mM
        const double var_calcium_fluxes_in_the_SR__delta_Ca_i2 = 0; // mM
        const double var_calcium_fluxes_in_the_SR__delta_Ca_ith = 00018000000000000001; // mM
        ...
        const double var_ionic_concentrations__V_JSR = 0047999999999999996; // dimensionless
        const double var_ionic_concentrations__V_NSR = 055199999999999999; // dimensionless
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x166 = var_chaste_interface__membrane__V < -40;
            const double var_x167 = exp(079000000000000001 * var_chaste_interface__membrane__V);
            ...
            partialF = -((var_x166) ? (0.13500000000000001 * var_x165) : (0)) - ((var_x166) ? (310000 * var_x168 + 3.5600000000000001 * var_x167) : (7.6923076923076916 / var_x170));
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x175 = exp(-043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x176 = -127140 * var_x174 - 3.4740000000000003e-5 * var_x175;
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x191 = 035000000000000003 * var_x190;
            ...
            const double var_x197 = 10 + var_chaste_interface__membrane__V;
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x203 = 019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
            const double var_x204 = exp(2.5 - 050000000000000003 * var_chaste_interface__membrane__V);
            ...
            const double var_x210 = -02 - var_x203;
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x220 = exp(2.0609999999999999 + 068699999999999997 * var_chaste_interface__membrane__V);
            const double var_x221 = -1.0 + var_x220;
            const double var_x222 = 00013100000000000001 / var_x221;
            const double var_x223 = 30 + var_chaste_interface__membrane__V;
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x233 - 5.594554271400994e-8 * var_x107 - 0.54665885146975302 * var_x139 - 1.139681818874567e-6 * var_x63 - 080828497792522477 * var_x138 - 6.4825765265103909e-6 * var_x143 - var_x135 * var_x230;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x231 = 5.1470588235294113e-7 * var_x140;
            const double var_x232 = 1.9339199950521953e-8 * var_x145;
            const double var_x236 = 0012812882037032361 * var_x99;
            const double var_x237 = var_x11 * var_x232 - var_x11 * var_x231;
            
            partialF = var_x237 + 0084616719207093495 * var_x153 - 1.5996281101931733e-8 * var_x107 - 035478708262932285 * var_x150 - 9.808819343281279e-5 * var_x137 - 1.4791615096031613e-5 * var_x148 - var_x149 * var_x230 - var_x152 * var_x236;
        }
        else
        {
