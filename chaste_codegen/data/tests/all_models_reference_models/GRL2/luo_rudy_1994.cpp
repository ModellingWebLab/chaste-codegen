...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x166 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x167 = var_chaste_interface__membrane__V < -40.0;
            ...
            partialF = -((var_x167) ? (0.13500000000000001 * var_x166) : (0)) - ((var_x167) ? (310000.0 * var_x169 + 3.5600000000000001 * var_x168) : (7.6923076923076916 / var_x171));
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x184 = exp(-3.2000000000000002 + var_x160);
            const double var_x185 = 1.0 + var_x184;
            const double var_x186 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V);
            const double var_x187 = var_x186 / var_x185;
            
            partialF = -((var_x167) ? (0.1212 * var_x183) : (0.29999999999999999 * var_x187)) - ((var_x167) ? (var_x178 * var_x179) : (0));
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x193 = 1.0 + var_x189;
            ...
            const double var_x202 = var_x192 * var_x198;
            
            partialF = -var_x202 - var_x196 * var_x202;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x204 = 0.019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
            const double var_x205 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V);
            const double var_x206 = 1.0 + var_x205;
            const double var_x208 = exp(4.0767441860465121 + 0.11627906976744186 * var_chaste_interface__membrane__V);
            const double var_x209 = 1.0 + var_x208;
            const double var_x211 = -0.02 - var_x204;
            const double var_x212 = 1 / var_x209;
            const double var_x213 = 0.59999999999999998 / var_x206;
            const double var_x214 = var_x212 + var_x213;
            const double var_x216 = 1.0 - var_x212 - var_x213;
            
            partialF = var_x211 * var_x214 + var_x211 * var_x216;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x220 = 7.1899999999999999e-5 / var_x219;
            const double var_x221 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V);
            const double var_x222 = -1.0 + var_x221;
            const double var_x223 = 0.00013100000000000001 / var_x222;
            const double var_x224 = 30.0 + var_chaste_interface__membrane__V;
            
            partialF = -var_x220 * var_x224 - var_x223 * var_x224;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x225 = 1.9339199950521953e-8 * var_x16;
            const double var_x231 = var_x225 * var_x56;
            const double var_x232 = 5.1470588235294113e-7 * var_x141;
            const double var_x233 = 1.9339199950521953e-8 * var_x146;
            const double var_x234 = var_x20 * var_x233 - var_x20 * var_x232;
            
            partialF = var_x234 - 5.594554271400994e-8 * var_x107 - 0.54665885146975302 * var_x140 - 1.139681818874567e-6 * var_x63 - 0.080828497792522477 * var_x139 - 6.4825765265103909e-6 * var_x144 - var_x136 * var_x231;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x232 = 5.1470588235294113e-7 * var_x141;
            const double var_x233 = 1.9339199950521953e-8 * var_x146;
            const double var_x237 = 0.0012812882037032361 * var_x99;
            const double var_x238 = var_x11 * var_x233 - var_x11 * var_x232;
            
            partialF = var_x238 + 0.0084616719207093495 * var_x154 - 1.5996281101931733e-8 * var_x107 - 0.035478708262932285 * var_x151 - 9.808819343281279e-5 * var_x138 - 1.4791615096031613e-5 * var_x149 - var_x150 * var_x231 - var_x153 * var_x237;
        }
        else
        {
