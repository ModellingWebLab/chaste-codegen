...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -17.0 + var_x87 + var_x88 + 0030000000000000001 * var_x92 - 0030000000000000001 * var_x90 - 2.8102681769358871e-7 * var_x55 - 5.8069998209165779e-10 * var_x59 - 3.0670341725380159e-10 * var_x57 - 3.1504144536796187e-6 * var_x65 - 0.23093344215355205 * var_x58 - 5.5200000000000005e-8 * var_x93 - var_x63 * var_x86;
        }
        else
        {
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x107 = 200 / var_x106;
            const double var_x108 = exp(-3.6960000000000002 - 056000000000000001 * var_chaste_interface__membrane__V);
            
            partialF = -001 * ((var_x103) ? (2000) : (var_x102 * var_x107)) - 8.0 * var_x108;
        }
        else
        {
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -02 * var_x110 - 2.0 / (1.0 + 320 * var_x111);
        }
        else
        {
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x109 = -0.125 * var_chaste_interface__membrane__V;
            const double var_x113 = exp(-058823529411764705 * var_chaste_interface__membrane__V);
            const double var_x114 = exp(-1.25 + var_x109);
            const double var_x115 = 1.0 + var_x114;
            
            partialF = -033000000000000002 / var_x115 - 3.3000000000000003e-5 * var_x113;
        }
        else
        {
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x118 = fabs(var_x117) < 0001;
            ...
            const double var_x123 = 30 / var_x122;
            ...
            partialF = -001 * ((var_x118) ? (120) : (var_x117 * var_x123)) - 001 * ((var_x118) ? (120) : (var_x117 * var_x126));
        }
        else
        {
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x135 = 012 / var_x133;
            
            partialF = -001 * ((var_x128) ? (25.0) : (var_x127 * var_x131)) + var_x135 * (-1.0 - 119.0 * var_x26);
        }
        else
        {
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x137 = exp(-3.2000000000000002 + 080000000000000002 * var_chaste_interface__membrane__V);
            const double var_x138 = 00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            ...
            partialF = -059999999999999998 + var_x145 - var_x140 * var_x142;
        }
        else
        {
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 8.1754862903173357e-6 * var_x85 - 3.1504144536796189e-9 * var_x82 - 00022482145415487099 * var_x84 - 0001091989920180802 * var_x83 - 3.8219647206328062e-5 * var_x1;
        }
        else
        {
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -050000000000000003 + var_x151;
        }
        else
        {
