...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x976 = exp(0.10112954465231205 + 0.017649135192375574 * var_chaste_interface__membrane__v);
            const double var_x977 = exp(-0.63992869875222813 - 0.035650623885918005 * var_chaste_interface__membrane__v);
            const double var_x978 = 0.0097940000000000006 * var_x977;
            const double var_x979 = 0.33429999999999999 * var_x976;
            
            partialF = -var_x978 - var_x979;
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x980 = exp(0.025854356306892066 + 0.02600780234070221 * var_chaste_interface__membrane__v);
            const double var_x981 = exp(-12.148291269170388 - 0.12075836251660427 * var_chaste_interface__membrane__v);
            const double var_x982 = 1 / (0.30520000000000003 * var_x980 + 0.021360000000000001 * var_x981);
            const double var_x983 = 1 / (2.0379999999999998 + var_x982);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x976 = exp(0.10112954465231205 + 0.017649135192375574 * var_chaste_interface__membrane__v);
            const double var_x977 = exp(-0.63992869875222813 - 0.035650623885918005 * var_chaste_interface__membrane__v);
            const double var_x987 = 0.11143333333333333 * var_x976;
            const double var_x988 = 0.003264666666666667 * var_x977;
            
            partialF = -var_x987 - var_x988;
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x981 = exp(-12.148291269170388 - 0.12075836251660427 * var_chaste_interface__membrane__v);
            const double var_x982 = 1 / (0.30520000000000003 * var_x980 + 0.021360000000000001 * var_x981);
            const double var_x989 = 1 / (2.9754799999999997 + 1.46 * var_x982);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative31(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1051 = exp(-2.0 - var_x397);
            const double var_x1052 = 1 / (0.0044999999999999997 * var_x1050 + 0.0044999999999999997 * var_x1051);
            const double var_x1074 = 1 / (17.5 + 2.5 * var_x1052);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative32(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1066 = exp(-0.5714285714285714 + var_x1064);
            const double var_x1067 = 1 / (0.040000000000000001 * var_x1065 + 0.040000000000000001 * var_x1066);
            const double var_x1075 = 1 / (17.5 + 2.5 * var_x1067);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative34(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1078 = exp(2.3444553483807655 - 0.049067713444553483 * var_chaste_interface__membrane__v);
            const double var_x1079 = exp(-8.182993021452571 + 0.25846471956577927 * var_chaste_interface__membrane__v);
            const double var_x1080 = 1 / (4.1230000000000003e-5 * var_x1078 + 0.36520000000000002 * var_x1079);
            const double var_x1081 = 1 / (12.98 + var_x1080);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative35(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1086 = exp(1.146491904394757 - 0.038550501156515031 * var_chaste_interface__membrane__v);
            const double var_x1087 = exp(-4.7178789938817136 + 0.13596193065941536 * var_chaste_interface__membrane__v);
            const double var_x1088 = 1 / (1.128e-5 * var_x1086 + 0.066290000000000002 * var_x1087);
            const double var_x1089 = 1 / (1.865 + var_x1088);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative37(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1024 = 0.050000000000000003 * var_chaste_interface__membrane__v;
            const double var_x1098 = exp(-2.5 + var_x1024);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative39(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1115 = ((var_x1114) ? (1000.0) : (0.21052631578947367 + 0.0025894736842105265 * var_x1112));
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative40(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1112 = 1 / var_chaste_interface__intracellular_ions__cajsr;
            const double var_x1113 = 1 / (1.0 + 0.0123 * var_x1112);
            const double var_x1133 = 5.9375 * var_x1113 < 0.001;
            const double var_x1134 = ((var_x1133) ? (1000.0) : (0.16842105263157894 + 0.0020715789473684213 * var_x1112));
