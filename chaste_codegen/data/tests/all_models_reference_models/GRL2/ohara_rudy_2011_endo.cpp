...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellohara_rudy_2011_endoFromCellMLGRL2::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellohara_rudy_2011_endoFromCellMLGRL2::Cellohara_rudy_2011_endoFromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_2011_endoFromCellMLGRL2>::Instance();
        Init();
    ...
    Cellohara_rudy_2011_endoFromCellMLGRL2::~Cellohara_rudy_2011_endoFromCellMLGRL2()
    {
    }

    
    double Cellohara_rudy_2011_endoFromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellohara_rudy_2011_endoFromCellMLGRL2::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
    ...
    void Cellohara_rudy_2011_endoFromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        std::vector<double>& rY = rGetStateVariables();
        const double delta=1e-8;
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
        double d_dt_chaste_interface_var_membrane__v;
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -87.0
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x33 = -((var_x17) ? (-var_x12) : (var_x27 + var_x20 * var_x30 * mParameters[8] - var_x21 * var_x32 * mParameters[8]));
            const double var_x34 = exp(0.38500000000000001 * var_x18);
            const double var_x35 = mParameters[4] / var_x34;
            const double var_x36 = 1.0 + 0.035997120230381568 * var_x35;
            const double var_x37 = pow(var_x36, 3);
            const double var_x38 = pow((0.35820000000000002 + mParameters[3]), 2);
            const double var_x39 = 1 / (-1.0 + var_x37 + 7.7937924625297832 * var_x38);
            const double var_x40 = pow(mParameters[3], 2);
            ...
            const double var_x55 = pow(mParameters[4], 3);
            ...
            const double var_x69 = pow(mParameters[4], 4);
            ...
            const double var_x108 = 18.240000000000002 * var_x107;
            ...
            const double var_x118 = 1.7312322557180369e-9 * var_x117;
            ...
            const double var_x133 = 4.2058888433195179e-19 * var_x132;
            ...
            const double var_x145 = 1.0238303820609877e-15 * var_x144;
            const double var_x146 = var_x103 * var_x52;
            const double var_x147 = 5.8628014788099666e-20 * var_x146;
            ...
            const double var_x152 = 1 / (13.5 + 0.066666666666666666 * (1.0 + 0.20000000000000001 * mParameters[4]) * mParameters[4]);
            const double var_x153 = exp(0.52239999999999998 * var_x18);
            const double var_x154 = 1 / var_x153;
            const double var_x155 = 1.0 + 0.011348161597821153 * (1.0 + var_x154) * mParameters[4];
            ...
            const double var_x195 = var_x152 * mParameters[2];
            ...
            const double var_x220 = var_x161 * mParameters[4];
            ...
            const double var_x255 = var_x154 * var_x156 * mParameters[4];
            const double var_x256 = var_x158 * pow(mParameters[4], 2);
            ...
            const double var_x310 = mParameters[16] / var_x309;
            const double var_x311 = 0.20000000000000001 * var_x310;
            ...
            const double var_x404 = mParameters[16] / var_x403;
            const double var_x405 = 0.80000000000000004 * var_x404;
            const double var_x406 = -0.75 * mParameters[3];
            const double var_x407 = 0.75 * var_chaste_interface__intracellular_ions__kss;
            const double var_x408 = 9.9999999999999995e-8 * mParameters[5];
            const double var_x409 = var_x2 * var_x408;
            const double var_x410 = var_x409 * (var_x406 + var_x1 * var_x407);
            const double var_x411 = var_x408 * var_x7;
            const double var_x412 = 5000000.0 * var_x10;
            const double var_x413 = var_x412 * (-var_x410 - var_x411 * (var_x406 + var_x407 * var_x6));
            ...
            const double var_x434 = 0.00035740000000000001 * var_x433;
            ...
            const double var_x448 = (var_x436 * (var_x437 + var_x438) + var_x447 * var_chaste_interface__ICaL__nca) * mParameters[7];
            ...
            const double var_x456 = var_x455 * mParameters[7];
            const double var_x457 = 0.00039314000000000005 * var_x456;
            ...
            const double var_x461 = ((var_x414) ? (var_x410 - var_x413 * var_x460) : (var_x421 * var_chaste_interface__membrane__v));
            const double var_x462 = var_x435 * var_x461;
            const double var_x463 = mParameters[7] * var_chaste_interface__ICaL__d;
            ...
            const double var_x469 = 0.00039314000000000005 * var_x461;
            ...
            const double var_x474 = -mParameters[4];
            const double var_x475 = 3.7499999999999999e-17 * mParameters[5];
            const double var_x476 = var_x2 * var_x475;
            const double var_x477 = var_x475 * var_x7;
            ...
            const double var_x485 = var_x433;
            const double var_x486 = 1.0 - var_x485;
            const double var_x487 = (-var_x485 * var_chaste_interface__INaL__hLp - var_x486 * var_chaste_interface__INaL__hL) * mParameters[13];
            const double var_x488 = var_x487 * var_chaste_interface__INaL__mL;
            const double var_x489 = 0.98999999999999999 * var_chaste_interface__INa__hf;
            const double var_x490 = var_x489 + 0.010000000000000009 * var_chaste_interface__INa__hs;
            const double var_x491 = var_x486 * var_x490;
            const double var_x492 = var_x489 + 0.010000000000000009 * var_chaste_interface__INa__hsp;
            const double var_x493 = var_x492 * var_chaste_interface__INa__jp;
            const double var_x494 = var_x485 * var_x493 + var_x491 * var_chaste_interface__INa__j;
            const double var_x495 = pow(var_chaste_interface__INa__m, 3) * mParameters[11];
            const double var_x496 = var_x494 * var_x495;
            const double var_x497 = var_x488 - var_x496 - ((var_x414) ? (-var_x412 * (-var_x476 * (var_x474 + var_x1 * var_chaste_interface__intracellular_ions__nai) - var_x477 * (var_x474 + var_x6 * var_chaste_interface__intracellular_ions__nai))) : (var_x480 * var_x483 + var_x29 * var_x479 * var_x482 - 3.75e-10 * var_x28 * var_x480 * var_x484 / pow(var_x481, 2)));
            const double var_x498 = -0.75 * mParameters[4];
            const double var_x499 = 0.75 * var_chaste_interface__intracellular_ions__nass;
            const double var_x500 = var_x409 * (var_x498 + var_x1 * var_x499);
            const double var_x501 = var_x412 * (-var_x500 - var_x411 * (var_x498 + var_x499 * var_x6));
            const double var_x502 = var_x415 * var_x499;
            const double var_x503 = var_x498 + var_x502;
            const double var_x504 = var_x420 * var_x503;
            const double var_x505 = ((var_x414) ? (-var_x501) : (var_x504 + var_x422 * var_x502 - var_x424 * var_x503));
            const double var_x506 = -0.00125 + 0.00125 * var_x433;
            const double var_x507 = var_x448 * var_x506;
            const double var_x508 = var_x507 * var_chaste_interface__ICaL__d;
            const double var_x509 = 0.0013750000000000001 * var_x456;
            const double var_x510 = var_x509 * var_chaste_interface__ICaL__d;
            const double var_x511 = ((var_x414) ? (var_x500 - var_x460 * var_x501) : (var_x504 * var_chaste_interface__membrane__v));
            const double var_x512 = var_x506 * var_x511;
            const double var_x513 = 0.0013750000000000001 * var_x511;
            const double var_x514 = var_x468 * var_x512 + var_x505 * var_x508 - var_x472 * var_x513 - var_x505 * var_x510;
            const double var_x515 = var_x4 * (var_x0 + var_x1 * var_chaste_interface__intracellular_ions__cass);
            const double var_x516 = var_x11 * (-var_x515 - var_x8 * (var_x0 + var_x6 * var_chaste_interface__intracellular_ions__cass));
            const double var_x517 = var_x19 * var_chaste_interface__intracellular_ions__cass;
            const double var_x518 = var_x0 + var_x517;
            const double var_x519 = var_x25 * var_x518;
            const double var_x520 = ((var_x17) ? (-var_x516) : (var_x519 + var_x30 * var_x517 - var_x32 * var_x518));
            const double var_x521 = -1.0 + var_x485;
            const double var_x522 = var_x449 * var_x521;
            const double var_x523 = 1.1000000000000001 * var_x455;
            const double var_x524 = var_x463 * var_x523;
            const double var_x525 = var_x520 * var_x524;
            const double var_x526 = -4.9999999999999998e-8 * var_x15 + var_chaste_interface__membrane__v;
            const double var_x527 = ((var_x17) ? (var_x515 - var_x516 * var_x526) : (var_x519 * var_chaste_interface__membrane__v));
            const double var_x528 = var_x527 * mParameters[7];
            const double var_x529 = var_x521 * var_x528;
            const double var_x530 = var_x529 * var_chaste_interface__ICaL__d;
            const double var_x531 = var_x433 * var_x528;
            const double var_x532 = 1.1000000000000001 * var_x531;
            const double var_x533 = var_x532 * var_chaste_interface__ICaL__d;
            const double var_x534 = var_x471 * var_x533;
            const double var_x535 = -var_x525 - var_x534 + var_x467 * var_x530 + var_x520 * var_x522;
            const double var_x536 = exp(-1.4126984126984128 + 0.0066137566137566143 * var_chaste_interface__membrane__v);
            const double var_x537 = 1.0 + var_x536;
            const double var_x538 = 1 / var_x537;
            const double var_x539 = var_x538;
            const double var_x540 = 1.0 - var_x539;
            const double var_x541 = var_x539 * var_chaste_interface__Ito__iF + var_x540 * var_chaste_interface__Ito__iS;
            const double var_x542 = var_x486 * var_chaste_interface__Ito__a;
            const double var_x543 = var_x539 * var_chaste_interface__Ito__iFp + var_x540 * var_chaste_interface__Ito__iSp;
            const double var_x544 = var_x485 * var_chaste_interface__Ito__ap;
            const double var_x545 = (-var_x541 * var_x542 - var_x543 * var_x544) * mParameters[18];
            const double var_x546 = exp(0.78953107960741553 - 0.054525627044711013 * var_chaste_interface__membrane__v);
            const double var_x547 = 1.0 + var_x546;
            const double var_x548 = mParameters[9] / var_x547;
            const double var_x549 = 0.0066137566137566143 * var_x536 / pow(var_x537, 2);
            const double var_x550 = 1 / var_chaste_interface__intracellular_ions__ki;
            const double var_x551 = -var_x15 * log(var_x550 * mParameters[3]) + var_chaste_interface__membrane__v;
            const double var_x552 = var_x551 * mParameters[18];
            const double var_x553 = 1 / var_chaste_interface__intracellular_ions__cai;
            const double var_x554 = pow(var_x553, 1.3999999999999999);
            const double var_x555 = 1.0 + 6.4818210260626455e-7 * var_x554;
            const double var_x556 = -1.0 - 0.59999999999999998 / var_x555;
            const double var_x557 = var_x556 * mParameters[15] * var_chaste_interface__IKs__xs2;
            const double var_x558 = var_x557 * var_chaste_interface__IKs__xs1;
            const double var_x559 = exp(11.145054250500367 + 0.10534077741493732 * var_chaste_interface__membrane__v - 0.27388602127883704 * mParameters[3]);
            const double var_x560 = 1.0 + var_x559;
            const double var_x561 = sqrt(mParameters[3]);
            const double var_x562 = var_x561 * mParameters[12] / var_x560;
            const double var_x563 = var_x562;
            const double var_x564 = var_x563 * var_chaste_interface__IK1__xk1;
            const double var_x565 = exp(-0.33333333333333331 + 0.033333333333333333 * var_chaste_interface__membrane__v);
            const double var_x566 = 1.0 + var_x565;
            const double var_x567 = 1 / var_x566;
            const double var_x568 = exp(1.4344412457471867 + 0.026171159382360639 * var_chaste_interface__membrane__v);
            ...
            const double var_x573 = var_x571 * var_chaste_interface__IKr__xrf + var_x572 * var_chaste_interface__IKr__xrs;
            const double var_x574 = var_x561 * var_x567 * var_x573 * mParameters[14];
            const double var_x575 = exp(0.73333333333333328 + 0.013333333333333334 * var_chaste_interface__membrane__v);
            const double var_x576 = 1.0 + var_x575;
            const double var_x577 = 1 / var_x576;
            const double var_x578 = 0.43033148291193518 * var_x577;
            const double var_x579 = var_x574 * var_x578;
            const double var_x580 = var_x551 * var_x561;
            const double var_x581 = 0.026171159382360639 * var_x568 / pow(var_x569, 2);
            const double var_x582 = var_x580 * mParameters[14];
            const double var_x583 = var_x567 * var_x582;
            const double var_x584 = var_x578 * var_x583;
            const double var_x585 = var_x545 + var_x558 - var_x548 - var_x564 - var_x579 + var_x552 * (-var_x542 * (var_x549 * var_chaste_interface__Ito__iS - var_x549 * var_chaste_interface__Ito__iF) - var_x544 * (var_x549 * var_chaste_interface__Ito__iSp - var_x549 * var_chaste_interface__Ito__iFp)) - var_x584 * (var_x581 * var_chaste_interface__IKr__xrs - var_x581 * var_chaste_interface__IKr__xrf) + 0.0057377531054924689 * var_x551 * var_x574 * var_x575 / pow(var_x576, 2) - 0.054525627044711013 * var_x546 * var_x551 * mParameters[9] / pow(var_x547, 2) + 0.10534077741493732 * var_x559 * var_x580 * mParameters[12] * var_chaste_interface__IK1__xk1 / pow(var_x560, 2) + 0.014344382763731173 * var_x565 * var_x573 * var_x577 * var_x582 / pow(var_x566, 2);
            
            partialF = var_x33 + var_x497 + var_x514 + var_x535 + var_x585 - var_x459 - var_x473 + var_x425 * var_x450 + var_x462 * var_x468 + (2.5425659820598794 * var_x142 + 0.39409772721928132 * var_x148 - 0.0027147699714763674 * var_x150 - 30.391149386371492 * var_x151 + var_x116 * var_x118 + var_x134 * var_x137 + var_x134 * var_x147 - var_x108 * var_x99 - var_x129 * var_x133 - var_x134 * var_x145 - var_x138 * var_x140) * mParameters[17] - var_x307 * var_x311 - var_x402 * var_x405;
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x486 = 1.0 - var_x485;
            const double var_x526 = -4.9999999999999998e-8 * var_x15 + var_chaste_interface__membrane__v;
            const double var_x586 = 2250000000000.0 * var_x222;
            const double var_x587 = var_x344 * var_x586;
            const double var_x588 = 13617793.917385383 * var_x354;
            const double var_x589 = -var_x587 - var_x588 - var_x321 * var_x348 - var_x321 * var_x365;
            const double var_x590 = var_x362 * var_x384;
            const double var_x591 = var_x358 * var_x360;
            const double var_x592 = var_x358 * var_x365;
            const double var_x593 = var_x362 * var_x389;
            const double var_x594 = 3.0597222222222222e-13 * var_x362;
            const double var_x595 = var_x589 * var_x594;
            const double var_x596 = var_x362 * var_x589;
            const double var_x597 = 85111211.983658642 * var_x220;
            const double var_x598 = 15000000000.0 * var_x591 + var_x387 * (var_x587 + var_x588) + var_x391 * var_x595 + var_x396 * var_x596 + var_x589 * var_x590 - var_x394 * var_x595 - var_x397 * var_x596 - var_x589 * var_x593 - var_x591 * var_x597 - 4500000000000.0 * var_x344 * var_x592 - 40853381.752156146 * var_x374 * var_x592;
            const double var_x599 = var_x317 * var_x399 + var_x349 * var_x359 + var_x357 * var_x393 - var_x349 * var_x388 - var_x353 * var_x386 - var_x353 * var_x395;
            const double var_x600 = var_x599 * mParameters[16] / (pow(var_x403, 2) * pow(var_chaste_interface__intracellular_ions__cai, 3));
            const double var_x605 = var_x1 * var_x4;
            const double var_x606 = var_x605 * mParameters[8];
            const double var_x607 = var_x6 * var_x8;
            const double var_x608 = var_x11 * var_x526;
            const double var_x609 = 0.00050000000000000001 + var_chaste_interface__intracellular_ions__cai;
            const double var_x610 = mParameters[10] / var_x609;
            const double var_x611 = pow(var_x609, (-2));
            const double var_x612 = -var_x610 - ((var_x17) ? (var_x606 - var_x608 * (-var_x606 - var_x607 * mParameters[8])) : (var_x26 * var_x31)) + var_x611 * mParameters[10] * var_chaste_interface__intracellular_ions__cai;
            const double var_x892 = 0.0023800000000000002 + var_chaste_interface__intracellular_ions__cai;
            const double var_x893 = 1.0 + 0.00011900000000000002 / pow(var_x892, 2) + 3.5000000000000004e-5 * var_x611;
            const double var_x894 = 1 / var_x893;
            const double var_x895 = 1.6000000000000001 * var_x404;
            const double var_x896 = 2.9679144385026732 * var_x14;
            const double var_x897 = 0.00075000000000000002 + var_chaste_interface__intracellular_ions__cai;
            const double var_x898 = 1 / var_x897;
            const double var_x899 = var_x433 * var_x898;
            const double var_x900 = 0.00092000000000000003 + var_chaste_interface__intracellular_ions__cai;
            const double var_x901 = 1 / var_x900;
            const double var_x902 = var_x486 * var_x901;
            const double var_x903 = var_x433 * var_chaste_interface__intracellular_ions__cai / pow(var_x897, 2);
            const double var_x904 = var_x486 * var_chaste_interface__intracellular_ions__cai / pow(var_x900, 2);
            const double var_x905 = var_x894;
            const double var_x906 = 0.0043750000000000004 * var_x902;
            const double var_x907 = 0.01203125 * var_x899;
            
            partialF = var_x905 * (-0.14705882352941174 + var_x896 * (var_x612 + 7.1999999999999996e-8 * var_x600 + var_x598 * var_x895) + (0.00097665441176470586 * var_x903 + 0.00035514705882352943 * var_x904 - 0.00097665441176470586 * var_x899 - 0.00035514705882352943 * var_x902) * mParameters[1]) + (0.00023800000000000004 / pow(var_x892, 3) + 7.0000000000000007e-5 / pow(var_x609, 3)) * (0.14705882352941174 * var_chaste_interface__intracellular_ions__cass - 0.14705882352941174 * var_chaste_interface__intracellular_ions__cai + var_x896 * (-((var_x17) ? (var_x5 - var_x12 * var_x526) : (var_x27 * var_chaste_interface__membrane__v)) + var_x599 * var_x895 - var_x610 * var_chaste_interface__intracellular_ions__cai) - 0.081176470588235281 * (-0.00026249999999999998 * var_chaste_interface__intracellular_ions__cansr + var_x906 * var_chaste_interface__intracellular_ions__cai + var_x907 * var_chaste_interface__intracellular_ions__cai) * mParameters[1]) / pow(var_x893, 2);
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x430 = 0.050000000000000003 * var_x429;
            const double var_x431 = var_x426 * var_x430 + var_chaste_interface__CaMK__CaMKt;
            const double var_x914 = 0.0025000000000000005 * var_x429;
            
            partialF = -0.00068000000000000005 - var_x431 * var_x914 + var_x426 * var_x914 * (1 - var_x430);
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x593 = var_x362 * var_x389;
            const double var_x594 = 3.0597222222222222e-13 * var_x362;
            const double var_x625 = 1 / var_chaste_interface__intracellular_ions__nai;
            const double var_x641 = var_x327 * var_x51;
            const double var_x642 = var_x41 * var_x641;
            const double var_x643 = 4.4788223776203591 * var_x56 * var_x641;
            const double var_x644 = var_x42 * var_x62;
            const double var_x645 = var_x64 * var_x644;
            const double var_x646 = var_x41 * var_x645;
            const double var_x647 = 4.0448001575983228e-12 * var_x641 * var_x83;
            const double var_x648 = pow((1 + 0.0028096208831939005 * var_chaste_interface__intracellular_ions__nai + 0.0021553256090254577 * var_chaste_interface__intracellular_ions__ki), (-2));
            const double var_x649 = var_x52 * var_x648;
            const double var_x650 = var_x56 * var_x649;
            const double var_x651 = 2.3840715066649271e-15 * var_x650;
            const double var_x652 = 0.030852683632896775 * var_x56 * var_x645;
            const double var_x653 = 2.786289097871654e-14 * var_x645 * var_x83;
            const double var_x654 = var_x648 * var_x86;
            const double var_x655 = var_x56 * var_x654;
            const double var_x656 = var_x44 * var_x95;
            const double var_x657 = var_x656 * var_x83;
            const double var_x658 = -3.0005234378016216e-13 * var_x655 - 3.5067428637450051e-12 * var_x657;
            const double var_x659 = var_x643 + var_x647 + var_x658 - var_x651 - var_x652 - var_x653 + 36069335.67075488 * var_x642 - 248466.16107375509 * var_x646;
            const double var_x660 = 34076345.656450219 * var_x41 * var_x656;
            const double var_x661 = 0.055419764988303033 * var_x56 * var_x656;
            const double var_x662 = -var_x660 - var_x661 + 38790059.315200046 * var_x642 - 267208.05766560155 * var_x646;
            const double var_x663 = var_x107 * var_x648;
            const double var_x664 = var_x135 * var_x663;
            const double var_x665 = 1.1219685328242758e-7 * var_x654;
            const double var_x666 = 1674740.3831249396 * var_x641;
            const double var_x667 = 8.9146219515644901e-10 * var_x649;
            const double var_x668 = var_x56 * var_x648;
            const double var_x669 = 11536.567171311443 * var_x645;
            const double var_x670 = 1.5124489418129408e-6 * var_x641 * var_x74;
            const double var_x671 = 1.3112562615776865e-6 * var_x656 * var_x74;
            const double var_x672 = 1.0418611138907615e-8 * var_x645 * var_x74;
            const double var_x673 = var_x651 + var_x652 + var_x653 + var_x660 + var_x661 + var_x665 + var_x667 + var_x669 + var_x671 + var_x672 - var_x643 - var_x647 - var_x666 - var_x670 + 6.0010468756032432e-13 * var_x655 + 7.0134857274900101e-12 * var_x657 + 1.7102983595469244e-14 * var_x668 + 515674.21873935661 * var_x646 - 74859394.985954925 * var_x642;
            const double var_x675 = var_x658 + var_x666 + var_x670 - var_x665 - var_x667 - var_x669 - var_x671 - var_x672;
            const double var_x676 = var_x149 * var_x641;
            const double var_x679 = var_x149 * var_x645;
            const double var_x680 = var_x57 * var_x663;
            const double var_x681 = -0.011348161597821153 - 0.011348161597821153 * var_x153;
            const double var_x682 = var_x169 * var_x681;
            const double var_x683 = var_x328 * var_x682;
            const double var_x684 = var_x153 * var_x681;
            const double var_x685 = 56.740807989105761 * var_x684;
            const double var_x686 = var_x331 * var_x685;
            const double var_x687 = var_x316 + var_x686 + 60000.0 * var_x683;
            const double var_x688 = var_x334 * var_x687;
            const double var_x689 = (-0.066666666666666666 - 0.026666666666666668 * var_chaste_interface__intracellular_ions__nai) / pow(var_x319, 2);
            const double var_x690 = var_x689 * var_chaste_interface__intracellular_ions__cai;
            const double var_x691 = 1500000.0 * var_x690;
            const double var_x692 = var_x348 * var_x691;
            const double var_x693 = var_x327 * var_x336;
            const double var_x694 = 40853381.752156146 * var_x195;
            const double var_x695 = var_x341 * var_x693 * var_x694;
            const double var_x696 = var_x339 * var_x687;
            const double var_x697 = var_x315 * var_x689;
            const double var_x698 = var_x42 * var_x697;
            const double var_x699 = 13617793.917385383 * var_x341;
            const double var_x700 = var_x195 * var_x698 * var_x699;
            const double var_x701 = var_x345 * var_x42 * var_x684 * var_x699;
            const double var_x702 = var_x688 + var_x692 + var_x695 + var_x696 + var_x700 + var_x701;
            const double var_x703 = 283704.03994552878 * var_x684;
            const double var_x704 = var_x350 * (var_x364 + 300000000.0 * var_x683 + var_x331 * var_x703);
            const double var_x705 = 9.0785292782569211 * var_x42;
            const double var_x706 = var_x366 * var_x684;
            const double var_x707 = var_x691 + 27.235587834770765 * var_x693 + var_x697 * var_x705 + var_x705 * var_x706;
            const double var_x708 = var_x365 * var_x707;
            const double var_x709 = var_x253 * var_x707;
            const double var_x710 = 136177.93917385384 * var_x223;
            const double var_x711 = var_x693 * var_x710;
            const double var_x712 = 45392.646391284608 * var_x223;
            const double var_x713 = var_x698 * var_x712;
            const double var_x714 = var_x42 * var_x706;
            const double var_x715 = var_x712 * var_x714;
            const double var_x716 = 13617793.917385383 * var_x227;
            const double var_x717 = var_x690 * var_x716;
            const double var_x718 = -var_x688 - var_x692 - var_x695 - var_x696 - var_x700 - var_x701 - var_x704 - var_x708 - var_x709 - var_x711 - var_x713 - var_x715 - var_x717 - var_x262 * var_x687;
            const double var_x719 = var_x704 + var_x708 + var_x711 + var_x713 + var_x715;
            const double var_x720 = var_x594 * var_x718;
            const double var_x721 = var_x362 * var_x718;
            const double var_x722 = var_x357 * var_x392;
            const double var_x723 = 1236295.4078425223 * var_x160 * var_x162;
            const double var_x724 = var_x316 * var_x399 + var_x359 * var_x702 + var_x387 * (var_x709 + var_x717) + var_x391 * var_x720 + var_x396 * var_x721 + var_x399 * var_x686 + var_x590 * var_x718 + var_x698 * var_x722 + var_x714 * var_x722 - var_x386 * var_x719 - var_x388 * var_x702 - var_x394 * var_x720 - var_x395 * var_x719 - var_x397 * var_x721 - var_x593 * var_x718 + 81.706763504312292 * var_x401 * var_x693 + var_x313 * var_x320 * var_x358 * var_x42 * var_x687 * var_x723;
            const double var_x725 = var_x1 * var_x476;
            const double var_x726 = var_x412 * var_x460;
            const double var_x727 = var_x15 * var_x625;
            const double var_x728 = -((var_x414) ? (var_x725 - var_x726 * (-var_x725 - var_x477 * var_x6)) : (var_x483 * var_x484)) + var_x488 * var_x727 - var_x496 * var_x727;
            const double var_x915 = 54.720000000000006 * var_x107;
            const double var_x916 = 5.1936967671541106e-9 * var_x117;
            const double var_x917 = 1.2617666529958554e-18 * var_x132;
            const double var_x918 = 1.1975938206446337e-28 * var_x136;
            const double var_x919 = 133203.70697709653 * var_x139;
            const double var_x920 = 3.0714911461829631e-15 * var_x144;
            const double var_x921 = 1.7588404436429901e-19 * var_x146;
            const double var_x922 = 2.4000000000000004 * var_x404;
            const double var_x923 = 5.9358288770053464 * var_x14;
            const double var_x924 = var_x130 * var_x918;
            const double var_x925 = var_x130 * var_x920;
            const double var_x926 = var_x130 * var_x921;
            
            partialF = -0.014705882352941176 + var_x923 * (var_x728 + (22.883093838538915 * var_x676 - 1.3045639284470481e-13 * var_x680 - 9.183749995833164e-12 * var_x664 - 0.15763180479540198 * var_x679 + var_x662 * var_x916 + var_x673 * var_x924 + var_x673 * var_x926 - var_x659 * var_x915 - var_x673 * var_x917 - var_x673 * var_x925 - var_x675 * var_x919) * mParameters[17] - var_x724 * var_x922);
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x723 = 1236295.4078425223 * var_x160 * var_x162;
            const double var_x726 = var_x412 * var_x460;
            const double var_x729 = var_x186 * var_x682;
            const double var_x730 = var_x191 * var_x685;
            const double var_x731 = var_x172 + var_x730 + 60000.0 * var_x729;
            const double var_x732 = var_x198 * var_x731;
            const double var_x733 = (-0.066666666666666666 - 0.026666666666666668 * var_chaste_interface__intracellular_ions__nass) / pow(var_x175, 2);
            const double var_x734 = var_x733 * var_chaste_interface__intracellular_ions__cass;
            const double var_x735 = 1500000.0 * var_x734;
            const double var_x736 = var_x216 * var_x735;
            const double var_x737 = var_x187 * var_x201;
            const double var_x738 = var_x206 * var_x694 * var_x737;
            const double var_x739 = var_x204 * var_x731;
            const double var_x740 = var_x171 * var_x733;
            const double var_x741 = var_x200 * var_x740;
            const double var_x742 = 13617793.917385383 * var_x206;
            const double var_x743 = var_x195 * var_x741 * var_x742;
            const double var_x744 = var_x200 * var_x212 * var_x684 * var_x742;
            const double var_x745 = var_x732 + var_x736 + var_x738 + var_x739 + var_x743 + var_x744;
            const double var_x746 = var_x218 * (var_x246 + 300000000.0 * var_x729 + var_x191 * var_x703);
            const double var_x747 = 9.0785292782569211 * var_x200;
            const double var_x748 = var_x249 * var_x684;
            const double var_x749 = var_x735 + 27.235587834770765 * var_x737 + var_x740 * var_x747 + var_x747 * var_x748;
            const double var_x750 = var_x247 * var_x749;
            const double var_x751 = var_x253 * var_x749;
            const double var_x752 = var_x710 * var_x737;
            const double var_x753 = var_x200 * var_x712;
            const double var_x754 = var_x740 * var_x753;
            const double var_x755 = var_x748 * var_x753;
            const double var_x756 = var_x716 * var_x734;
            const double var_x757 = -var_x732 - var_x736 - var_x738 - var_x739 - var_x743 - var_x744 - var_x746 - var_x750 - var_x751 - var_x752 - var_x754 - var_x755 - var_x756 - var_x262 * var_x731;
            const double var_x758 = var_x240 * var_x284;
            const double var_x759 = var_x746 + var_x750 + var_x752 + var_x754 + var_x755;
            const double var_x760 = var_x235 * var_x285;
            const double var_x761 = var_x240 * var_x757;
            const double var_x762 = var_x225 * var_x289;
            const double var_x763 = 3.0597222222222222e-13 * var_x761;
            const double var_x764 = var_x163 * var_x294;
            const double var_x765 = var_x234 * var_x294;
            const double var_x766 = var_x225 * var_x299;
            const double var_x767 = var_x172 * var_x301 + var_x236 * var_x745 + var_x287 * (var_x751 + var_x756) + var_x292 * var_x763 + var_x298 * var_x761 + var_x301 * var_x730 + var_x741 * var_x765 + var_x757 * var_x758 - var_x288 * var_x745 - var_x296 * var_x763 - var_x759 * var_x760 - var_x759 * var_x764 - var_x761 * var_x762 - var_x761 * var_x766 + 81.706763504312292 * var_x305 * var_x737 + var_x200 * var_x748 * var_x765 + var_x168 * var_x176 * var_x200 * var_x235 * var_x723 * var_x731;
            const double var_x768 = 7.4999999999999997e-8 * mParameters[5];
            const double var_x769 = var_x1 * var_x2 * var_x768;
            const double var_x770 = ((var_x414) ? (var_x769 - var_x726 * (-var_x769 - var_x6 * var_x7 * var_x768)) : (0.75 * var_x420 * var_x423));
            const double var_x771 = var_x508 * var_x770 - var_x510 * var_x770;
            const double var_x928 = 0.60000000000000009 * var_x310;
            const double var_x929 = 201.81818181818181 * var_x14;
            
            partialF = -0.5 + var_x929 * (var_x771 - var_x767 * var_x928);
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x578 = 0.43033148291193518 * var_x577;
            const double var_x579 = var_x574 * var_x578;
            const double var_x601 = 1 / (0.018329999999999999 * var_chaste_interface__intracellular_ions__nai + var_chaste_interface__intracellular_ions__ki);
            const double var_x639 = var_x15 * var_x558 * var_x601;
            const double var_x644 = var_x42 * var_x62;
            const double var_x648 = pow((1 + 0.0028096208831939005 * var_chaste_interface__intracellular_ions__nai + 0.0021553256090254577 * var_chaste_interface__intracellular_ions__ki), (-2));
            const double var_x649 = var_x52 * var_x648;
            const double var_x650 = var_x56 * var_x649;
            ...
            const double var_x668 = var_x56 * var_x648;
            const double var_x680 = var_x57 * var_x663;
            const double var_x772 = -4.0 - 8.0 * var_chaste_interface__intracellular_ions__ki;
            const double var_x773 = var_x50 * var_x644;
            const double var_x774 = var_x772 * var_x773;
            const double var_x775 = var_x41 * var_x774;
            const double var_x776 = 0.09330879953375748 * var_x56 * var_x774;
            const double var_x777 = 1.8288767722361083e-15 * var_x650;
            const double var_x778 = 8.4266669949965062e-14 * var_x774 * var_x83;
            const double var_x779 = var_x49 * var_chaste_interface__intracellular_ions__ki;
            const double var_x780 = var_x74 * var_x779;
            const double var_x781 = var_x56 * var_x780;
            const double var_x782 = var_x772 * var_x94;
            const double var_x783 = var_x782 * var_x83;
            const double var_x784 = 1.0605559334252811e-11 * var_x783 + 3.3937789869608994e-10 * var_x781 - 2.3017714043409702e-13 * var_x655;
            const double var_x785 = var_x776 + var_x778 + var_x784 - var_x777 + 751444.4931407267 * var_x775;
            const double var_x786 = 3297863297.5037103 * var_x41 * var_x779;
            const double var_x787 = 5.3634509625479838 * var_x56 * var_x779;
            const double var_x788 = 103058228.04699095 * var_x41 * var_x782;
            const double var_x789 = 0.16760784257962449 * var_x56 * var_x782;
            const double var_x790 = var_x786 + var_x787 + var_x788 + var_x789 + 808126.23573333421 * var_x775;
            const double var_x791 = 8.6068818956382799e-8 * var_x654;
            const double var_x792 = 0.00012690163265380641 * var_x780;
            const double var_x793 = 6.8386140998302939e-10 * var_x649;
            const double var_x794 = var_x74 * var_x772;
            const double var_x795 = 3.9656760204314505e-6 * var_x794 * var_x94;
            const double var_x796 = 34890.424648436237 * var_x774;
            const double var_x797 = 3.1509352954436263e-8 * var_x773 * var_x794;
            const double var_x798 = var_x777 + var_x791 + var_x793 - var_x776 - var_x778 - var_x786 - var_x787 - var_x788 - var_x789 - var_x792 - var_x795 - var_x796 - var_x797 + 4.6035428086819405e-13 * var_x655 + 1.3120097004743531e-14 * var_x668 - 2.1211118668505621e-11 * var_x783 - 6.7875579739217989e-10 * var_x781 - 1559570.728874061 * var_x775;
            const double var_x799 = var_x784 + var_x792 + var_x795 + var_x796 + var_x797 - var_x791 - var_x793;
            const double var_x800 = var_x149 * var_x774;
            const double var_x801 = var_x15 * var_x550;
            const double var_x802 = var_x639 + var_x545 * var_x801 - var_x548 * var_x801 - var_x564 * var_x801 - var_x579 * var_x801;
            const double var_x923 = 5.9358288770053464 * var_x14;
            const double var_x933 = 36.480000000000004 * var_x107;
            const double var_x934 = 8.4117776866390357e-19 * var_x132;
            const double var_x935 = 3.4624645114360737e-9 * var_x117;
            const double var_x936 = 88802.471318064345 * var_x139;
            const double var_x937 = 7.9839588042975586e-29 * var_x136;
            const double var_x938 = 2.0476607641219754e-15 * var_x144;
            const double var_x939 = 1.1725602957619933e-19 * var_x146;
            const double var_x940 = var_x130 * var_x937;
            const double var_x941 = var_x130 * var_x938;
            const double var_x942 = var_x130 * var_x939;
            
            partialF = -0.014705882352941176 + var_x923 * (var_x802 + (4.6967123266361392e-12 * var_x664 + 6.6717424651173238e-14 * var_x680 - 0.31782074775748492 * var_x800 + var_x785 * var_x933 + var_x798 * var_x934 + var_x798 * var_x941 + var_x799 * var_x936 - var_x790 * var_x935 - var_x798 * var_x940 - var_x798 * var_x942) * mParameters[17]);
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x769 = var_x1 * var_x2 * var_x768;
            const double var_x770 = ((var_x414) ? (var_x769 - var_x726 * (-var_x769 - var_x6 * var_x7 * var_x768)) : (0.75 * var_x420 * var_x423));
            const double var_x803 = var_x458 * var_x770;
            const double var_x929 = 201.81818181818181 * var_x14;
            const double var_x945 = 0.00035740000000000001 - var_x434;
            const double var_x946 = var_x449 * var_x945;
            
            partialF = -0.5 - var_x929 * (var_x803 + var_x770 * var_x946);
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x607 = var_x6 * var_x8;
            const double var_x608 = var_x11 * var_x526;
            const double var_x613 = 1 / (pow(var_x431, 2) * pow(var_x432, 2));
            const double var_x633 = var_x528 * var_chaste_interface__ICaL__d;
            const double var_x635 = var_x448 * var_x527;
            const double var_x636 = var_x635 * var_chaste_interface__ICaL__d;
            const double var_x758 = var_x240 * var_x284;
            const double var_x760 = var_x235 * var_x285;
            const double var_x762 = var_x225 * var_x289;
            const double var_x764 = var_x163 * var_x294;
            const double var_x766 = var_x225 * var_x299;
            const double var_x804 = var_x308 * var_x426 / pow(var_x428, 2);
            const double var_x805 = var_x613 * var_x804;
            const double var_x806 = 1.1250000000000001e-5 * var_x805;
            const double var_x808 = var_x211 * var_x586;
            const double var_x809 = 13617793.917385383 * var_x228;
            const double var_x810 = -var_x808 - var_x809 - var_x177 * var_x216 - var_x177 * var_x247;
            const double var_x811 = var_x235 * var_x238;
            const double var_x812 = var_x235 * var_x247;
            const double var_x813 = var_x240 * var_x810;
            const double var_x814 = 3.0597222222222222e-13 * var_x813;
            const double var_x815 = 15000000000.0 * var_x811 + var_x287 * (var_x808 + var_x809) + var_x292 * var_x814 + var_x298 * var_x813 + var_x758 * var_x810 - var_x296 * var_x814 - var_x597 * var_x811 - var_x762 * var_x813 - var_x766 * var_x813 - 4500000000000.0 * var_x211 * var_x812 - 40853381.752156146 * var_x266 * var_x812;
            const double var_x816 = var_x173 * var_x301 + var_x217 * var_x236 + var_x234 * var_x295 - var_x217 * var_x288 - var_x225 * var_x760 - var_x225 * var_x764;
            const double var_x817 = var_x816 * mParameters[16] / (pow(var_x309, 2) * pow(var_chaste_interface__intracellular_ions__cass, 3));
            const double var_x819 = var_x454 * var_x805;
            const double var_x824 = ((var_x17) ? (var_x605 - var_x608 * (-var_x605 - var_x607)) : (var_x25 * var_x31));
            const double var_x825 = var_x524 * var_x824;
            const double var_x826 = var_x636 * var_x806;
            const double var_x827 = 1.2375000000000001e-5 * var_x633 * var_x819;
            const double var_x828 = var_x826 - var_x825 - var_x827 + var_x522 * var_x824;
            const double var_x846 = var_x523 * var_x528;
            const double var_x950 = 0.40000000000000002 * var_x310;
            const double var_x951 = 0.0086999999999999994 + var_chaste_interface__intracellular_ions__cass;
            const double var_x952 = 0.00087000000000000001 + var_chaste_interface__intracellular_ions__cass;
            const double var_x953 = 1.0 + 0.0097788000000000007 / pow(var_x951, 2) + 4.0890000000000003e-5 / pow(var_x952, 2);
            const double var_x954 = 1 / var_x953;
            const double var_x955 = 100.90909090909091 * var_x14;
            const double var_x958 = var_x954;
            const double var_x960 = 2.7e-6 * var_x805;
            const double var_x961 = var_x486 * var_x635;
            const double var_x962 = var_x961 * var_chaste_interface__ICaL__d;
            const double var_x963 = var_x846 * var_chaste_interface__ICaL__d;
            const double var_x964 = (var_x485 * var_chaste_interface__ryr__Jrelp + var_x486 * var_chaste_interface__ryr__Jrelnp) * mParameters[0];
            
            partialF = var_x958 * (-5.0 + var_x955 * (var_x828 + 1.7999999999999999e-8 * var_x817 + var_x815 * var_x950) + (var_x960 * var_chaste_interface__ryr__Jrelp - var_x960 * var_chaste_interface__ryr__Jrelnp) * mParameters[0]) + (0.019557600000000001 / pow(var_x951, 3) + 8.1780000000000006e-5 / pow(var_x952, 3)) * (5.0 * var_chaste_interface__intracellular_ions__cai + 0.23999999999999996 * var_x964 - 5.0 * var_chaste_interface__intracellular_ions__cass + var_x955 * (-var_x962 - var_x963 + var_x816 * var_x950)) / pow(var_x953, 2);
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x486 = 1.0 - var_x485;
            const double var_x964 = (var_x485 * var_chaste_interface__ryr__Jrelp + var_x486 * var_chaste_interface__ryr__Jrelnp) * mParameters[0];
            const double var_x969 = 0.80000000000000004 + var_chaste_interface__intracellular_ions__cajsr;
            const double var_x970 = pow(var_x969, (-2));
            const double var_x971 = 1 / (1.0 + 8.0 * var_x970);
            const double var_x974 = 0.01 * var_x971;
            
            partialF = -var_x974 + 0.25 * (-var_x964 + 0.01 * var_chaste_interface__intracellular_ions__cansr - 0.01 * var_chaste_interface__intracellular_ions__cajsr) / (pow(var_x969, 3) * pow((0.125 + var_x970), 2));
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x977 = exp(0.33477135461604829 + 0.02876042565429968 * var_chaste_interface__membrane__v);
            const double var_x978 = exp(-13.000839630562552 - 0.16792611251049538 * var_chaste_interface__membrane__v);
            const double var_x980 = 8.5519999999999996 * var_x978;
            const double var_x981 = 6.7649999999999997 * var_x977;
            const double var_x983 = -var_x980 - var_x981;
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x988 = exp(0.025140601874691665 + 0.049333991119881598 * var_chaste_interface__membrane__v);
            const double var_x989 = exp(-0.19029435163086714 - 0.15910898965791567 * var_chaste_interface__membrane__v);
            const double var_x990 = 6.149 * var_x988;
            const double var_x991 = 1.432e-5 * var_x989;
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x993 = exp(0.10112954465231205 + 0.017649135192375574 * var_chaste_interface__membrane__v);
            const double var_x994 = exp(-0.63992869875222813 - 0.035650623885918005 * var_chaste_interface__membrane__v);
            const double var_x995 = 0.0097940000000000006 * var_x994;
            const double var_x996 = 0.33429999999999999 * var_x993;
            
            partialF = -var_x995 - var_x996;
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x997 = exp(0.025854356306892066 + 0.02600780234070221 * var_chaste_interface__membrane__v);
            const double var_x998 = exp(-12.148291269170388 - 0.12075836251660427 * var_chaste_interface__membrane__v);
            const double var_x999 = 1 / (0.30520000000000003 * var_x997 + 0.021360000000000001 * var_x998);
            const double var_x1000 = 1 / (2.0379999999999998 + var_x999);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x993 = exp(0.10112954465231205 + 0.017649135192375574 * var_chaste_interface__membrane__v);
            const double var_x994 = exp(-0.63992869875222813 - 0.035650623885918005 * var_chaste_interface__membrane__v);
            const double var_x1004 = 0.11143333333333333 * var_x993;
            const double var_x1005 = 0.003264666666666667 * var_x994;
            
            partialF = -var_x1004 - var_x1005;
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x998 = exp(-12.148291269170388 - 0.12075836251660427 * var_chaste_interface__membrane__v);
            const double var_x999 = 1 / (0.30520000000000003 * var_x997 + 0.021360000000000001 * var_x998);
            const double var_x1006 = 1 / (2.9754799999999997 + 1.46 * var_x999);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1015 = 0.034035137876343539 * var_chaste_interface__membrane__v;
            const double var_x1016 = exp(0.62658348478969694 - var_x1015);
            const double var_x1017 = 1.0 + var_x1016;
            const double var_x1018 = exp(3.403513787634354 + var_x1015);
            const double var_x1019 = 1.0 + var_x1018;
            const double var_x1021 = 3.3285782215882072 / var_x1019;
            const double var_x1022 = 0.78668405081082138 / var_x1017;
            const double var_x1024 = -var_x1021 - var_x1022;
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1025 = exp(-1.0 - 0.01 * var_chaste_interface__membrane__v);
            const double var_x1026 = exp(3.0138637733574445 + 0.060277275467148887 * var_chaste_interface__membrane__v);
            const double var_x1027 = 1 / (0.39329999999999998 * var_x1025 + 0.08004 * var_x1026);
            const double var_x1028 = 1 / (4.5620000000000003 + var_x1027);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1034 = exp(14.123035029087756 + 0.12377769525931426 * var_chaste_interface__membrane__v);
            const double var_x1035 = exp(-1.6345469940728197 - 0.016934801016088061 * var_chaste_interface__membrane__v);
            const double var_x1036 = 1 / (1.7800000000000001e-8 * var_x1034 + 0.0014159999999999999 * var_x1035);
            const double var_x1037 = 1 / (23.620000000000001 + var_x1036);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative22(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative23(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative23(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1027 = 1 / (0.39329999999999998 * var_x1025 + 0.08004 * var_x1026);
            const double var_x1028 = 1 / (4.5620000000000003 + var_x1027);
            const double var_x1041 = 0.050000000000000003 * var_chaste_interface__membrane__v;
            const double var_x1042 = exp(3.5 + var_x1041);
            const double var_x1043 = 1.0 + var_x1042;
            const double var_x1044 = 1.0 - 0.5 / var_x1043;
            const double var_x1045 = 1 / var_x1044;
            const double var_x1046 = exp(56.77808727948004 - 4.6425255338904359 * var_chaste_interface__membrane__v);
            const double var_x1047 = exp(-10.534927627438641 + 0.062932662051604776 * var_chaste_interface__membrane__v);
            const double var_x1048 = var_x1046 + var_x1047;
            const double var_x1049 = 1 / var_x1048;
            const double var_x1050 = 1 / (1.3540000000000001 + 0.0001 * var_x1049);
            const double var_x1051 = var_x1045 * var_x1050;
            const double var_x1052 = var_x1028 * var_x1051;
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative24(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1050 = 1 / (1.3540000000000001 + 0.0001 * var_x1049);
            const double var_x1051 = var_x1045 * var_x1050;
            const double var_x1057 = var_x1037 * var_x1051;
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1062 = exp(1.26 + 0.089999999999999997 * var_chaste_interface__membrane__v);
            const double var_x1063 = exp(-0.30000000000000004 - 0.050000000000000003 * var_chaste_interface__membrane__v);
            const double var_x1064 = var_x1062 + var_x1063;
            const double var_x1065 = 0.59999999999999998 + 1 / var_x1064;
            const double var_x1066 = 1 / var_x1065;
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative26(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative26(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x439 = 0.10000000000000001 * var_chaste_interface__membrane__v;
            const double var_x1067 = exp(2.0 + var_x439);
            const double var_x1068 = exp(-2.0 - var_x439);
            const double var_x1069 = 1 / (0.0044999999999999997 * var_x1067 + 0.0044999999999999997 * var_x1068);
            const double var_x1070 = 1 / (7.0 + var_x1069);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative27(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative27(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1077 = exp(0.83333333333333337 + 0.16666666666666666 * var_chaste_interface__membrane__v);
            const double var_x1078 = exp(-1.25 - 0.25 * var_chaste_interface__membrane__v);
            const double var_x1079 = 1 / (3.4999999999999997e-5 * var_x1077 + 3.4999999999999997e-5 * var_x1078);
            const double var_x1080 = 1 / (1000.0 + var_x1079);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative28(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative28(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1081 = 0.14285714285714285 * var_chaste_interface__membrane__v;
            const double var_x1082 = exp(0.5714285714285714 - var_x1081);
            const double var_x1083 = exp(-0.5714285714285714 + var_x1081);
            const double var_x1084 = 1 / (0.040000000000000001 * var_x1082 + 0.040000000000000001 * var_x1083);
            const double var_x1085 = 1 / (7.0 + var_x1084);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1081 = 0.14285714285714285 * var_chaste_interface__membrane__v;
            const double var_x1087 = exp(var_x1081);
            const double var_x1088 = exp(-0.33333333333333331 * var_chaste_interface__membrane__v);
            const double var_x1089 = 1 / (0.00012 * var_x1087 + 0.00012 * var_x1088);
            const double var_x1090 = 1 / (100.0 + var_x1089);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative31(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative31(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1068 = exp(-2.0 - var_x439);
            const double var_x1069 = 1 / (0.0044999999999999997 * var_x1067 + 0.0044999999999999997 * var_x1068);
            const double var_x1091 = 1 / (17.5 + 2.5 * var_x1069);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative32(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative32(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1083 = exp(-0.5714285714285714 + var_x1081);
            const double var_x1084 = 1 / (0.040000000000000001 * var_x1082 + 0.040000000000000001 * var_x1083);
            const double var_x1092 = 1 / (17.5 + 2.5 * var_x1084);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative33(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative33(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative34(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative34(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1095 = exp(2.3444553483807655 - 0.049067713444553483 * var_chaste_interface__membrane__v);
            const double var_x1096 = exp(-8.182993021452571 + 0.25846471956577927 * var_chaste_interface__membrane__v);
            const double var_x1097 = 1 / (4.1230000000000003e-5 * var_x1095 + 0.36520000000000002 * var_x1096);
            const double var_x1098 = 1 / (12.98 + var_x1097);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative35(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative35(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1103 = exp(1.146491904394757 - 0.038550501156515031 * var_chaste_interface__membrane__v);
            const double var_x1104 = exp(-4.7178789938817136 + 0.13596193065941536 * var_chaste_interface__membrane__v);
            const double var_x1105 = 1 / (1.128e-5 * var_x1103 + 0.066290000000000002 * var_x1104);
            const double var_x1106 = 1 / (1.865 + var_x1105);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative36(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative36(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1107 = exp(-0.91304347826086951 - 0.0043478260869565218 * var_chaste_interface__membrane__v);
            const double var_x1108 = exp(2.7123595505617977 + 0.056179775280898875 * var_chaste_interface__membrane__v);
            const double var_x1109 = 1 / (0.001292 * var_x1107 + 0.00023259999999999999 * var_x1108);
            const double var_x1110 = 1 / (817.29999999999995 + var_x1109);
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative37(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative37(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1041 = 0.050000000000000003 * var_chaste_interface__membrane__v;
            const double var_x1115 = exp(-2.5 + var_x1041);
            const double var_x1116 = exp(-2.1464516129032258 - 0.032258064516129031 * var_chaste_interface__membrane__v);
            const double var_x1117 = 0.019300000000000001 * var_x1116;
            const double var_x1118 = 0.01 * var_x1115;
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative38(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative38(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1122 = exp(3.4155488244627148 + 0.014423770373575654 * var_chaste_interface__membrane__v);
            const double var_x1123 = exp(-6.2475442043222005 - 0.049115913555992145 * var_chaste_interface__membrane__v);
            const double var_x1124 = 0.0081833060556464818 * var_x1122;
            const double var_x1125 = 0.0081833060556464818 * var_x1123;
            
            partialF = -var_x1124 - var_x1125;
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative39(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative39(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1132 = 1 / var_chaste_interface__intracellular_ions__cajsr;
            const double var_x1133 = 1 / (1.0 + 0.0123 * var_x1132);
            const double var_x1134 = 4.75 * var_x1133 < 0.001;
            const double var_x1135 = ((var_x1134) ? (1000.0) : (0.21052631578947367 + 0.0025894736842105265 * var_x1132));
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluateYDerivative40(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative40(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1132 = 1 / var_chaste_interface__intracellular_ions__cajsr;
            const double var_x1133 = 1 / (1.0 + 0.0123 * var_x1132);
            const double var_x1154 = 5.9375 * var_x1133 < 0.001;
            const double var_x1155 = ((var_x1154) ? (1000.0) : (0.16842105263157894 + 0.0020715789473684213 * var_x1132));
    ...
    std::vector<double> Cellohara_rudy_2011_endoFromCellMLGRL2::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellohara_rudy_2011_endoFromCellMLGRL2>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellohara_rudy_2011_endoFromCellMLGRL2)
