...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x497 = var_x488 - var_x496 - ((var_x414) ? (var_x412 * (var_x476 * (var_x474 + var_x1 * var_chaste_interface__intracellular_ions__nai) + var_x477 * (var_x474 + var_x5 * var_chaste_interface__intracellular_ions__nai))) : (var_x480 * var_x483 + var_x29 * var_x479 * var_x482 - 3.75e-10 * var_x28 * var_x480 * var_x484 / pow(var_x481, 2)));
            const double var_x498 = -0.75 * mParameters[4];
            const double var_x499 = 0.75 * var_chaste_interface__intracellular_ions__nass;
            const double var_x500 = var_x410 * (var_x498 + var_x499 * var_x5);
            const double var_x501 = var_x412 * (var_x500 + var_x409 * (var_x498 + var_x1 * var_x499));
            ...
            const double var_x515 = var_x7 * (var_x0 + var_x5 * var_chaste_interface__intracellular_ions__cass);
            const double var_x516 = var_x11 * (var_x515 + var_x4 * (var_x0 + var_x1 * var_chaste_interface__intracellular_ions__cass));
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x605 = var_x5 * var_x7;
            const double var_x606 = var_x605 * mParameters[8];
            const double var_x607 = var_x1 * var_x4;
            ...
            partialF = var_x905 * (-0.14705882352941174 + var_x896 * (var_x612 + 7.1999999999999996e-8 * var_x600 + var_x598 * var_x895) + (0.00097665441176470586 * var_x903 + 0.00035514705882352943 * var_x904 - 0.00097665441176470586 * var_x899 - 0.00035514705882352943 * var_x902) * mParameters[1]) + (0.00023800000000000004 / pow(var_x892, 3) + 7.0000000000000007e-5 / pow(var_x609, 3)) * (0.14705882352941174 * var_chaste_interface__intracellular_ions__cass - 0.14705882352941174 * var_chaste_interface__intracellular_ions__cai + var_x896 * (-((var_x17) ? (-var_x8 + var_x12 * var_x526) : (var_x27 * var_chaste_interface__membrane__v)) + var_x599 * var_x895 - var_x610 * var_chaste_interface__intracellular_ions__cai) - 0.081176470588235281 * (-0.00026249999999999998 * var_chaste_interface__intracellular_ions__cansr + var_x906 * var_chaste_interface__intracellular_ions__cai + var_x907 * var_chaste_interface__intracellular_ions__cai) * mParameters[1]) / pow(var_x893, 2);
        }
        else
        {
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x725 = var_x477 * var_x5;
            const double var_x726 = var_x412 * var_x460;
            const double var_x727 = var_x15 * var_x625;
            const double var_x728 = -((var_x414) ? (-var_x725 + var_x726 * (var_x725 + var_x1 * var_x476)) : (var_x483 * var_x484)) + var_x488 * var_x727 - var_x496 * var_x727;
    ...
    double Cellohara_rudy_2011_endoFromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x769 = var_x5 * var_x6 * var_x768;
            const double var_x770 = ((var_x414) ? (-var_x769 + var_x726 * (var_x769 + var_x1 * var_x2 * var_x768)) : (0.75 * var_x420 * var_x423));
