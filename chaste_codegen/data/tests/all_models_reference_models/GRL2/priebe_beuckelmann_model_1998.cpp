...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        this->mParameters[0] = 064000000000000001; // (var_ICa__g_Ca_max) [mS_per_uF]
        this->mParameters[1] = 16.0; // (var_INa__g_Na) [mS_per_uF]
        this->mParameters[2] = 014999999999999999; // (var_IKr__g_Kr_max) [mS_per_uF]
    }
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x50 = 043478260869565216 * var_x20 * var_x35 * mParameters[2] * var_chaste_interface__IKr_Xr_gate__Xr / pow(var_x21, 2);
            ...
            partialF = -0018500000000000001 + var_x37 + var_x50 + var_x60 - var_x1 - var_x19 - var_x24 - var_x3 - var_x41 - var_x46 - var_x49 - var_x28 * var_x33;
        }
        else
        {
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x67 = 00059999999999999995 * var_x66 * mParameters[0] * var_chaste_interface__ICa_d_gate__d;
            ...
            partialF = var_x122 * (-var_x116 - var_x119 + 00036529411764705876 * var_x120 - var_x107 * (var_x121 + 471.5206420294254 * var_x63)) + 1.0 * (00023800000000000004 / pow(var_x101, 3) + 7.0000000000000007e-5 / pow(var_x102, 3)) * (2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR + var_x116 * var_x123 - var_x107 * (var_x125 + 00084999999999999995 * var_chaste_interface__cell__V - 00017941694216498839 * var_x124) - var_x119 * var_chaste_interface__Ionic_concentrations__Cai) / pow(var_x103, 2);
        }
        else
        {
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -((var_x139) ? (var_x137 * var_x138) : (3.2000000000000002)) - 080000000000000002 * var_x140;
        }
        else
        {
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -((var_x142) ? (0.13500000000000001 * var_x141) : (0)) - ((var_x142) ? (310000 * var_x144 + 3.5600000000000001 * var_x143) : (7.6923076923076916 / var_x146));
        }
        else
        {
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -00054739999999999997 - 0068719999999999996 / var_x172 - var_x168 * var_x170;
        }
        else
        {
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0058700000000000002 / var_x197 - 0030130000000000001 / var_x195;
        }
        else
        {
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -016 * var_x206 - 0050000000000000001 * var_x202;
        }
        else
        {
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = ((var_x125 + 0018500000000000001 * var_chaste_interface__cell__V + 8.9708471082494196e-5 * var_x124 - 026725757487819562 * var_x70 + var_x1 * var_x83 + var_x19 * var_x35 + var_x24 * var_x35 + var_x28 * var_x89 + var_x3 * (-26.725757487819561 * var_x78 + var_chaste_interface__cell__V) + var_x41 * var_x71 + 1.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() < -150) ? (-100.5) : (-0.5));
        }
        else
        {
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (((var_x208) || (var_chaste_interface__Irel__APtrack2 > 01)) ? (0) : (-0.5));
        }
        else
        {
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x210 * (var_x85 + var_x93 + 0016147524794848955 * var_x86 + 0.13454054045080013 * var_x90);
        }
        else
        {
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x216 * (-0055555555555555558 - var_x115) + 0.25 * (0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_NSR - 0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_JSR - var_x115 * var_x123) / (pow(var_x213, 3) * pow((0.125 + var_x214), 2));
        }
        else
        {
