...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellpasek_simurda_christe_2006FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.001 * ((var_x137) ? (-var_x143 + 2749999.9727482134 * (59.300000181818184 + var_chaste_interface__Vms__Vms) * (var_x143 + 2.1319999794684464e-5 * var_x136)) : (var_x140 * var_x141)) - 3.7999999999999998 * var_x142;
        }
        else
        {
    ...
    double Cellpasek_simurda_christe_2006FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.001 * ((var_x147) ? (-var_x153 + 1099999.9933980689 * (64.400000454545463 + var_chaste_interface__Vms__Vms) * (var_x153 + 8.531818233024069e-6 * var_x145)) : (var_x146 * var_x150)) - 0.28439999999999999 / var_x152;
        }
        else
        {
