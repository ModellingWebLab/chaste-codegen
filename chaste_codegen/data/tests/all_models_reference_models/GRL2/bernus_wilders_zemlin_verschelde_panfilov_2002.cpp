...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::UseCellMLDefaultStimulus()
    {
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2>::Instance();
        Init();
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2()
    {
    }

    
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
    ...
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        std::vector<double>& rY = rGetStateVariables();
        const double delta=1e-8;
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::EvaluateYDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
        double d_dt_chaste_interface_var_membrane__V;
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -90.2
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::EvaluateYDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x11 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x57 = 1 / (1.0 - exp(-9.9999999747524276e-8));
            const double var_x58 = 1 / (1.0 - exp(1.0000000045806701e-7));
            const double var_x59 = 47.130000000000003 + var_chaste_interface__membrane__V;
            const double var_x60 = fabs(var_x59) < 1.0000000010279564e-6;
            ...
            const double var_x65 = 3.2000000146581445e-7 * var_x58;
            
            partialF = -((var_x60) ? (-var_x65 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x65 + 3.1999999919207769e-7 * var_x57)) : (var_x59 * var_x63)) - 0.080000000000000002 * var_x64;
        }
        else
        {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::EvaluateYDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::EvaluateYDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::EvaluateYDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::EvaluateYDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    std::vector<double> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellMLGRL2)
