...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellbeeler_reuter_model_1977FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x0 * (-3.0000000000000001e-5 - var_x11 - ((fabs(var_x7) < 2.5000000007935341e-6) ? ((var_x6 + 0.10000000000000001 / (1.0 - exp(1.0000000003174136e-7)) + 0.10000000000000001 / (1.0 - exp(-1.0000000003174136e-7))) * mParameters[5]) : ((var_x6 + 0.20000000000000001 / var_x9 - 0.0080000000000000002 * var_x7 * var_x8 / pow(var_x9, 2)) * mParameters[5])) + var_x16 * var_x17 - var_x13 * var_chaste_interface__sodium_current_h_gate__h - var_x14 * var_x15 * var_x17);
        }
        else
        {
    ...
    double Cellbeeler_reuter_model_1977FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x26 = 1 / (-1.0 + exp(1.0000000045806701e-7));
            const double var_x27 = 47.0 + var_chaste_interface__membrane__V;
            const double var_x28 = fabs(var_x27) < 1.0000000010279564e-6;
            ...
            const double var_x34 = 1.0000000045806701e-6 * var_x26;
            
            partialF = -((var_x28) ? (var_x34 + 499999.99948602181 * (47.000001000000005 + var_chaste_interface__membrane__V) * (-var_x34 - 9.9999999747524271e-7 * var_x25)) : (-var_x27 * var_x32)) - 40.0 * var_x33;
        }
        else
        {
