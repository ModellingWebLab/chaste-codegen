#ifndef CELLPANDIT_CLARK_GILES_DEMIR_2001_ENDOCARDIAL_CELLFROMCELLMLGRL2_HPP_
#define CELLPANDIT_CLARK_GILES_DEMIR_2001_ENDOCARDIAL_CELLFROMCELLMLGRL2_HPP_
...
class Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLGRL2 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLGRL2();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLGRL2 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLGRL2 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellMLGRL2(p_solver, p_stimulus);
        }
...
#endif // CELLPANDIT_CLARK_GILES_DEMIR_2001_ENDOCARDIAL_CELLFROMCELLMLGRL2_HPP_