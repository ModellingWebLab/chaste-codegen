...
#include "MathsCustomFunctions.hpp"
    ...
    Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::Cellmcallister_noble_tsien_1975_bFromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellmcallister_noble_tsien_1975_bFromCellMLGRL2>::Instance();
        Init();
    ...
    Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::~Cellmcallister_noble_tsien_1975_bFromCellMLGRL2()
    {
    }

    
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_time_independent_outward_current__i_K1 = (-1.0 + exp(4.4000000000000004 + 0.040000000000000001 * var_chaste_interface__membrane__V)) / (exp(2.3999999999999999 + 0.040000000000000001 * var_chaste_interface__membrane__V) + exp(4.7999999999999998 + 0.080000000000000002 * var_chaste_interface__membrane__V)) + ((fabs(30.0 + var_chaste_interface__membrane__V) < 2.5000000007935341e-6) ? (-5.0000000015870685e-7 / (1.0 - exp(1.0000000003174136e-7)) + 199999.99993651727 * (30.000002500000001 + var_chaste_interface__membrane__V) * (5.0000000015870685e-7 / (1.0 - exp(1.0000000003174136e-7)) + 5.0000000015870685e-7 / (1.0 - exp(-1.0000000003174136e-7)))) : (0.20000000000000001 * (30.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-1.2 - 0.040000000000000001 * var_chaste_interface__membrane__V)))); // microA_per_cm2
    ...
    void Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
    ...
    void Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        std::vector<double>& rY = rGetStateVariables();
        const double delta=1e-8;
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = ((fabs(47.0 + var_chaste_interface__membrane__V) < 9.9999999747524271e-7) ? (-9.9999999747524271e-7 / (1.0 - exp(9.9999999747524276e-8)) + 500000.00126237865 * (47.000000999999997 + var_chaste_interface__membrane__V) * (9.9999999747524271e-7 / (1.0 - exp(9.9999999747524276e-8)) + 9.9999999747524271e-7 / (1.0 - exp(-9.9999999747524276e-8)))) : ((47.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.7000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V)))); // per_millisecond
        ...
        const double var_pacemaker_potassium_current_s_gate__alpha_s = ((fabs(52.0 + var_chaste_interface__membrane__V) < 4.9999999873762135e-7) ? (-5.0000000584304868e-10 / (1.0 - exp(1.0000000116860974e-7)) + 1000000.0025247573 * (52.000000500000006 + var_chaste_interface__membrane__V) * (5.0000000584304868e-10 / (1.0 - exp(1.0000000116860974e-7)) + 4.9999999163219401e-10 / (1.0 - exp(-9.999999832643881e-8)))) : (0.001 * (52.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-10.4 - 0.20000000000000001 * var_chaste_interface__membrane__V)))); // per_millisecond
        ...
        const double var_transient_chloride_current_q_gate__alpha_q = ((fabs(var_chaste_interface__membrane__V) < 9.9999999999999995e-7) ? (-8.0000000000000005e-9 / (1.0 - exp(9.9999999999999995e-8)) + 500000.0 * (9.9999999999999995e-7 + var_chaste_interface__membrane__V) * (8.0000000000000005e-9 / (1.0 - exp(9.9999999999999995e-8)) + 8.0000000000000005e-9 / (1.0 - exp(-9.9999999999999995e-8)))) : (0.0080000000000000002 * var_chaste_interface__membrane__V / (1.0 - exp(-0.10000000000000001 * var_chaste_interface__membrane__V)))); // per_millisecond
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluateYDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
        double d_dt_chaste_interface_var_membrane__V;
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -78.041367
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x8 = -1.0 + var_x6;
            const double var_x9 = var_x8 * (-0.040000000000000001 * var_x2 - 0.080000000000000002 * var_x3) / pow(var_x4, 2);
            const double var_x10 = var_x9 + 0.040000000000000001 * var_x7;
            const double var_x11 = 30.0 + var_chaste_interface__membrane__V;
            const double var_x12 = -var_x1;
            const double var_x13 = exp(-1.2 + var_x12);
            const double var_x14 = 1.0 - var_x13;
            const double var_x15 = exp(-6.0 - 0.14999999999999999 * var_chaste_interface__membrane__V);
            const double var_x16 = 1.0 + var_x15;
            const double var_x17 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * mParameters[2];
            const double var_x18 = 1 / exp(1.8 + var_x1);
            const double var_x19 = exp(3.7999999999999998 + var_x1);
            const double var_x20 = var_x18 * (-1.0 + var_x19);
            const double var_x21 = 0.048000000000000001 * var_chaste_interface__plateau_potassium_current1_x1_gate__x1;
            
            partialF = var_x0 * (-0.11499999999999999 - ((fabs(var_x11) < 2.5000000007935341e-6) ? (var_x10 + 0.10000000000000001 / (1.0 - exp(1.0000000003174136e-7)) + 0.10000000000000001 / (1.0 - exp(-1.0000000003174136e-7))) : (var_x10 + 0.20000000000000001 / var_x14 - 0.0080000000000000002 * var_x11 * var_x13 / pow(var_x14, 2))) - 0.38500000000000001 * var_chaste_interface__plateau_potassium_current2_x2_gate__x2 + var_x20 * var_x21 + (-0.040000000000000001 / var_x16 - 0.80000000000000004 * var_chaste_interface__secondary_inward_current_d_gate__d * var_chaste_interface__secondary_inward_current_f_gate__f - 0.0060000000000000001 * var_x15 * (-70.0 + var_chaste_interface__membrane__V) / pow(var_x16, 2)) * mParameters[0] - var_x17 * var_chaste_interface__fast_sodium_current_h_gate__h - 2.5 * var_chaste_interface__transient_chloride_current_q_gate__q * var_chaste_interface__transient_chloride_current_r_gate__r - 2.7999999999999998 * var_x9 * var_chaste_interface__pacemaker_potassium_current_s_gate__s - 0.11199999999999999 * var_x7 * var_chaste_interface__pacemaker_potassium_current_s_gate__s - var_x18 * var_x19 * var_x21);
        }
        else
        {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluateYDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x25 = 1 / (1.0 - exp(9.9999999747524276e-8));
            const double var_x26 = 1 / (1.0 - exp(-9.9999999747524276e-8));
            const double var_x27 = 47.0 + var_chaste_interface__membrane__V;
            const double var_x28 = fabs(var_x27) < 9.9999999747524271e-7;
            const double var_x29 = exp(-4.7000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V);
            ...
            const double var_x33 = 9.9999999747524271e-7 * var_x25;
            
            partialF = -((var_x28) ? (-var_x33 + 500000.00126237865 * (47.000000999999997 + var_chaste_interface__membrane__V) * (var_x33 + 9.9999999747524271e-7 * var_x26)) : (var_x27 * var_x31)) - 40.0 * var_x32;
        }
        else
        {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluateYDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluateYDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x38 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x39 = exp(-4.0 + var_x38);
            const double var_x40 = 1.0 - var_x39;
            const double var_x41 = 0.002 / var_x40;
            const double var_x42 = -0.088800000000000004 * var_chaste_interface__membrane__V;
            const double var_x43 = exp(-3.552 + var_x42);
            const double var_x44 = 40.0 + var_chaste_interface__membrane__V;
            
            partialF = -0.02 * var_x43 - var_x41 * var_x44;
        }
        else
        {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluateYDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x45 = exp(-2.3999999999999999 - 0.040000000000000001 * var_chaste_interface__membrane__V);
            const double var_x46 = exp(-2.262 - 0.086999999999999994 * var_chaste_interface__membrane__V);
            const double var_x47 = 1.0 + var_x46;
            
            partialF = -0.00098700000000000003 * var_x45 - 0.02 / var_x47;
        }
        else
        {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluateYDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x48 = 1 / (1.0 - exp(-9.999999832643881e-8));
            const double var_x49 = 1 / (1.0 - exp(1.0000000116860974e-7));
            const double var_x50 = 52.0 + var_chaste_interface__membrane__V;
            const double var_x51 = fabs(var_x50) < 4.9999999873762135e-7;
            const double var_x52 = exp(-10.4 - 0.20000000000000001 * var_chaste_interface__membrane__V);
            const double var_x53 = 1.0 - var_x52;
            const double var_x54 = 0.001 / var_x53;
            const double var_x55 = exp(-3.484 - 0.067000000000000004 * var_chaste_interface__membrane__V);
            const double var_x56 = 5.0000000584304868e-10 * var_x49;
            
            partialF = -((var_x51) ? (-var_x56 + 1000000.0025247573 * (52.000000500000006 + var_chaste_interface__membrane__V) * (var_x56 + 4.9999999163219401e-10 * var_x48)) : (var_x50 * var_x54)) - 5.0000000000000002e-5 * var_x55;
        }
        else
        {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluateYDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1 = 0.040000000000000001 * var_chaste_interface__membrane__V;
            const double var_x12 = -var_x1;
            const double var_x57 = exp(-0.80000000000000004 + var_x12);
            const double var_x58 = 1.0 + var_x57;
            const double var_x59 = exp(-1.1997600479904018 - 0.059988002399520089 * var_chaste_interface__membrane__V);
            const double var_x60 = var_x59 / var_x58;
            const double var_x62 = exp(2.8571428571428572 + 0.057142857142857141 * var_chaste_interface__membrane__V);
            const double var_x63 = 1.0 + var_x62;
            const double var_x64 = exp(4.1322314049586781 + 0.082644628099173556 * var_chaste_interface__membrane__V);
            const double var_x65 = var_x64 / var_x63;
            
            partialF = -0.00050000000000000001 * var_x65 - 0.0012999999999999999 * var_x60;
        }
        else
        {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluateYDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x59 = exp(-1.1997600479904018 - 0.059988002399520089 * var_chaste_interface__membrane__V);
            const double var_x60 = var_x59 / var_x58;
            const double var_x67 = exp(-3.7999999999999998 - 0.20000000000000001 * var_chaste_interface__membrane__V);
            const double var_x68 = 1.0 + var_x67;
            
            partialF = -0.000127 / var_x68 - 0.00029999999999999997 * var_x60;
        }
        else
        {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluateYDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x38 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x42 = -0.088800000000000004 * var_chaste_interface__membrane__V;
            const double var_x69 = 1 / (1.0 - exp(9.9999999999999995e-8));
            const double var_x70 = 1 / (1.0 - exp(-9.9999999999999995e-8));
            const double var_x71 = fabs(var_chaste_interface__membrane__V) < 9.9999999999999995e-7;
            const double var_x72 = exp(var_x38);
            const double var_x73 = 1.0 - var_x72;
            const double var_x74 = 0.0080000000000000002 / var_x73;
            const double var_x75 = exp(var_x42);
            const double var_x76 = 8.0000000000000005e-9 * var_x69;
            
            partialF = -((var_x71) ? (-var_x76 + 500000.0 * (9.9999999999999995e-7 + var_chaste_interface__membrane__V) * (var_x76 + 8.0000000000000005e-9 * var_x70)) : (var_x74 * var_chaste_interface__membrane__V)) - 0.080000000000000002 * var_x75;
        }
        else
        {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluateYDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x77 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
            const double var_x78 = exp(-3.75 - 0.125 * var_chaste_interface__membrane__V);
            const double var_x79 = 1.0 + var_x78;
            
            partialF = -0.033000000000000002 / var_x79 - 3.3000000000000003e-5 * var_x77;
        }
        else
        {
    ...
    std::vector<double> Cellmcallister_noble_tsien_1975_bFromCellMLGRL2::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellmcallister_noble_tsien_1975_bFromCellMLGRL2>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellmcallister_noble_tsien_1975_bFromCellMLGRL2)
