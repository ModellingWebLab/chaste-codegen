...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x160 = exp(-11.764705882352942 + 0.14705882352941177 * mParameters[14] - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x161 = var_chaste_interface__membrane__V < -40.0 + mParameters[14];
            const double var_x162 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * mParameters[14]);
            const double var_x163 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * mParameters[14]);
            const double var_x164 = exp(-0.96036036036036043 + 0.0900900900900901 * mParameters[14] - 0.0900900900900901 * var_chaste_interface__membrane__V);
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x21 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x161 = var_chaste_interface__membrane__V < -40.0 + mParameters[14];
            const double var_x174 = exp(-5.5312920000000005 + 0.13780000000000001 * mParameters[14] - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x175 = 1.0 + var_x174;
            const double var_x176 = exp(0.01052 * mParameters[14] - 0.01052 * var_chaste_interface__membrane__V);
            const double var_x177 = var_x176 / var_x175;
            const double var_x178 = exp(-3.2000000000000002 - var_x21 + 0.10000000000000001 * mParameters[14]);
            const double var_x179 = 1.0 + var_x178;
            const double var_x180 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * mParameters[14]);
            const double var_x181 = var_x180 / var_x179;
            const double var_x182 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * mParameters[14]);
            const double var_x183 = exp(0.043909999999999998 * mParameters[14] - 0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x184 = -25428.0 * var_x182 - 6.9480000000000002e-6 * var_x183;
            const double var_x185 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * mParameters[14]);
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x245 * (-var_x254 - mParameters[0] + 0.21333333333333335 * var_x260 - 0.032000000000000001 * var_x258) + 0.66666666666666674 * (var_x113 - var_x112 * mParameters[0] - var_x254 * var_x256) / (pow(var_x242, 3) * pow((0.33333333333333337 + var_x243), 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x276 * (1.1846503119326294e-6 * var_x95 - 0.0018954404990922068 * var_x93 - 0.016878114612481093 * var_x90 - 0.016878114612481093 * var_x94 - 0.0056863214972766203 * var_x96);
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_MFromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x276 * (4.357910453967955e-5 * var_x104 - 0.016878114612481093 * var_x91 - 0.016878114612481093 * var_x97 - 0.016878114612481093 * var_x98 - 0.00072631840899465921 * var_x99 - 0.0072631840899465916 * var_x101 - var_x103 * var_x278);
        }
        else
        {
