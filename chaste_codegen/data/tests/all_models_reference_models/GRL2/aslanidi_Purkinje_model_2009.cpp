...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellaslanidi_Purkinje_model_2009FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x61 = mParameters[14] * exp(0.013102559227730915 * var_chaste_interface__membrane__V);
    ...
    double Cellaslanidi_Purkinje_model_2009FromCellMLGRL2::EvaluatePartialDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (var_x413 - 2.5123533374587338e-10 * var_x153 - 2.4362214181418025e-8 * var_x154 - 4.5192480335411901e-10 * var_x131 - 6.7562758101440786e-9 * var_x148 - 1.8076992134164759e-7 * var_x149 - var_x152 * var_x405) * mParameters[3];
        }
        else
        {
