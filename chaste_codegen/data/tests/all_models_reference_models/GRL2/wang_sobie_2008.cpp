...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellwang_sobie_2008FromCellMLGRL2::EvaluatePartialDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x234 = 1 / (1.0 - exp(-9.9999999747524276e-8));
            const double var_x235 = 1 / (1.0 - exp(1.0000000045806701e-7));
            const double var_x236 = 47.130000000000003 + var_chaste_interface__membrane__V;
            const double var_x237 = fabs(var_x236) < 1.0000000010279564e-6;
            ...
            const double var_x244 = 3.2000000146581445e-7 * var_x235;
            
            partialF = -((var_x237) ? (-var_x244 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x244 + 3.1999999919207769e-7 * var_x234)) : (var_x236 * var_x241)) - 0.080000000000000002 * var_x243;
        }
        else
        {
    ...
    double Cellwang_sobie_2008FromCellMLGRL2::EvaluatePartialDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -((var_x312) ? (-var_x317 + 640000.00016065314 * (26.500000781250002 + var_chaste_interface__membrane__V) * (var_x317 + 3.760414053005867e-12 * var_x309)) : (var_x311 * var_x315)) - 9.5333299999999997e-5 * var_x316;
        }
        else
        {
