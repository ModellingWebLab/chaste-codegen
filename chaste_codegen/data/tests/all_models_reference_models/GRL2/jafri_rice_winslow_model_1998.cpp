...
#include "MathsCustomFunctions.hpp"
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_background_current__E_CaN = 0.5 * var_membrane__R * var_membrane__T * log(10) * log10(var_ionic_concentrations__Cao / var_chaste_interface__calcium_subsystem__Cai) / var_membrane__F; // mV
        const double var_fast_sodium_current__E_Na = var_membrane__R * var_membrane__T * log(10) * log10(var_ionic_concentrations__Nao / var_chaste_interface__ionic_concentrations__Nai) / var_membrane__F; // mV
        ...
        const double var_non_specific_calcium_activated_current__EnsCa = var_membrane__R * var_membrane__T * log(10) * log10((var_chaste_interface__ionic_concentrations__Ko + var_ionic_concentrations__Nao) / (var_chaste_interface__ionic_concentrations__Ki + var_chaste_interface__ionic_concentrations__Nai)) / var_membrane__F; // mV
        ...
        const double var_time_independent_potassium_current__E_K1 = var_membrane__R * var_membrane__T * log(10) * log10(var_chaste_interface__ionic_concentrations__Ko / var_chaste_interface__ionic_concentrations__Ki) / var_membrane__F; // mV
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x179 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
            const double var_x180 = exp(0.34999999999999998 * var_chaste_interface__membrane__V);
            ...
            partialF = -((var_x178) ? (0.13500000000000001 * var_x177) : (0)) - ((var_x178) ? (310000.0 * var_x180 + 3.5600000000000001 * var_x179) : (7.6923076923076916 / var_x182));
        }
        else
        {
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x171 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x178 = var_chaste_interface__membrane__V < -40.0;
            const double var_x183 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
            const double var_x184 = 1.0 + var_x183;
            const double var_x185 = 1 / var_x184;
            const double var_x186 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
            const double var_x187 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x188 = -127140.0 * var_x186 - 3.4740000000000003e-5 * var_x187;
            const double var_x189 = var_x185 * var_x188;
            const double var_x190 = 37.780000000000001 + var_chaste_interface__membrane__V;
            ...
            const double var_x195 = exp(-3.2000000000000002 + var_x171);
            ...
            partialF = -((var_x178) ? (0.1212 * var_x194) : (0.29999999999999999 * var_x198)) - ((var_x178) ? (var_x189 * var_x190) : (0));
        }
        else
        {
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x262 = 3.5281248386597142e-5 * var_x124;
            ...
            const double var_x265 = var_x43 / pow(var_x264, 2);
            ...
            partialF = var_x259 * (-5.9200580000000009 + var_x260 + var_x261 - var_x262 + 0.0035999999999999999 * var_x265 + 3.5281248386597142e-5 * var_x126 - 0.0035999999999999999 * var_x267 - 0.077544234316921451 * var_x127 - 2.4626237783962268e-6 * var_x125) + 0.00023800000000000004 * (5.8e-5 * var_chaste_interface__calcium_subsystem__Ca_NSR + 6.6000000000000005e-5 * var_chaste_interface__calcium_subsystem__HTRPNCa + 0.040000000000000001 * var_chaste_interface__calcium_subsystem__LTRPNCa + 0.32000000000000001 * var_chaste_interface__calcium_subsystem__Ca_SS - 0.32005800000000001 * var_chaste_interface__calcium_subsystem__Cai - 1.8505781762430779e-7 * var_chaste_interface__membrane__V - var_x262 * var_chaste_interface__calcium_subsystem__Cai - var_x268 * (0.14000000000000001 - var_chaste_interface__calcium_subsystem__HTRPNCa) - var_x269 * (0.070000000000000007 - var_chaste_interface__calcium_subsystem__LTRPNCa) + 2.4626237783962268e-6 * var_x11 * log10(1.8 * var_x125) + 2.8259560611122977e-8 * var_x33 * var_x5 - 0.0018 * var_x263 * var_x266) / (pow(var_x257, 3) * pow(var_x258, 2));
        }
        else
        {
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x272 * (-5490.7343857240912 - var_x275 - var_x276) + 0.00023800000000000004 * (143.30816746739879 * var_x277 + 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Cai - 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Ca_SS - var_x121 * var_x273) / (pow(var_x270, 3) * pow(var_x271, 2));
        }
        else
        {
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL2::EvaluatePartialDerivative28(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x290 = 3.9072457120905308e-8 * var_x48;
            const double var_x295 = var_x290 * var_x75;
            const double var_x296 = 1.0398994565217392e-6 * var_x48;
            const double var_x297 = 3.9072457120905308e-8 * var_x77;
            const double var_x298 = var_x140 * var_x297 - var_x140 * var_x296;
            
            partialF = var_x298 - 0.020902907402832696 * var_x131 - 1.1350943583223629e-5 * var_x138 - 4.5780488190019227e-7 * var_x130 - 2.3025858935932891e-6 * var_x83 - var_x132 * var_x295;
        }
        else
        {
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL2::EvaluatePartialDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x296 = 1.0398994565217392e-6 * var_x48;
            const double var_x297 = 3.9072457120905308e-8 * var_x77;
            const double var_x312 = 1.9415130354461213e-5 * var_x81;
            const double var_x327 = var_x296 * var_x51;
            const double var_x328 = var_x327 * var_x36;
            const double var_x329 = var_x297 * var_x51;
            ...
            const double var_x333 = var_x12 * var_x332;
            const double var_x334 = 7.9270016169768288e-5 * var_x134;
            const double var_x335 = var_x146 * var_x295;
            const double var_x336 = 0.0005376025032790136 * var_x147;
            const double var_x337 = var_x152 * var_x312;
            const double var_x338 = 0.00012821819703204474 * var_x153;
            const double var_x339 = 2.2327118354803037e-8 * var_x112;
            const double var_x340 = var_x339 * var_x96;
    ...
    double Celljafri_rice_winslow_model_1998FromCellMLGRL2::EvaluatePartialDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x332 = 1.3521568226207399e-5 * var_x2;
            const double var_x339 = 2.2327118354803037e-8 * var_x112;
            const double var_x341 = var_x155 * var_x332;
            const double var_x342 = 0.00015953260140026533 * var_x159;
            const double var_x343 = 0.0005376025032790136 * var_x157;
            const double var_x344 = var_x162 * var_x327;
            const double var_x345 = 7.9270016169768288e-5 * var_x160;
            const double var_x346 = 1.0099750810390723e-5 * var_x164;
            const double var_x347 = var_x166 * var_x295;
            const double var_x348 = 7.090337840011793e-5 * var_x161;
            const double var_x349 = 1.4892181587085931e-6 * var_x165;
            const double var_x350 = 0.00012821819703204474 * var_x167;
            const double var_x351 = var_x168 * var_x312;
            const double var_x352 = var_x162 * var_x329;
