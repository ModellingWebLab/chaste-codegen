...
#include "MathsCustomFunctions.hpp"
    ...
    double Celliribe_model_2006FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -5.8000000000000007 + var_x93 + var_x94 - var_x110 - var_x95 + 1.152e-10 * var_x99 - 0.00063181349969740222 * var_x69 - 4.7302475136018565e-5 * var_x70 - 1.0548821632800683e-6 * var_x67 - 4.3595131479120748e-6 * var_x68 - 10138.888888888887 * var_x101;
        }
        else
        {
