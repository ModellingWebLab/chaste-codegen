...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x76 = 116045061550.51096 * var_x62 - 0.5 * mParameters[12];
