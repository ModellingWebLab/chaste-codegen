...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x90 = exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x91 = var_chaste_interface__membrane__V >= -40;
            ...
            const double var_x95 = ((var_x91) ? (1 / (00045370000000000002 + 00045370000000000002 * var_x90)) : (88825214.899713472 * var_x93 + 38.681948424068771 * var_x94 + 1020573065902579 * var_x92));
            
            partialF = -001 * var_x95;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x102 = exp(-043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x103 = -127140 * var_x101 - 3.4740000000000003e-5 * var_x102;
            ...
            const double var_x110 = exp(-01052 * var_chaste_interface__membrane__V);
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x114 = exp(-0.64800000000000002 * pow((-1 + 055555555555555552 * var_chaste_interface__membrane__V), 2));
            const double var_x115 = exp(-0.22049999999999997 * pow((1 + 0.14285714285714285 * var_chaste_interface__membrane__V), 2));
            const double var_x119 = 0010499999999999999 * var_x114;
            const double var_x120 = 0030500000000000002 * var_x115;
            const double var_x121 = 1 / (00025000000000000001 + var_x119 + var_x120);
            
            partialF = -001 * var_x121;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x128 = exp(-14.0625 * pow((1 + 022222222222222223 * var_chaste_interface__membrane__V), 2));
            const double var_x133 = 0.105 * var_x128;
            const double var_x134 = 0016999999999999999 + 014999999999999999 * var_x127;
            const double var_x135 = 1 / (var_x133 + var_x134 + 040000000000000001 * var_x124);
            
            partialF = -001 * var_x135;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x140 = exp(-15.340277777777779 * pow((1 + 021276595744680851 * var_chaste_interface__membrane__V), 2));
            const double var_x141 = 041000000000000002 * var_x140;
            const double var_x142 = 1 / (var_x134 + var_x141 + 080000000000000002 * var_x139);
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x80 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x145 = exp(1.7885000000000002 + 035770000000000003 * var_chaste_interface__membrane__V);
            const double var_x146 = exp(-3.8000000000000003 + var_x80);
            
            partialF = -045159999999999999 * var_x145 - 098900000000000002 * var_x146;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x147 = pow((1 + 014285714285714285 * var_chaste_interface__membrane__V), 2);
            const double var_x148 = exp(-21.777777777777779 * var_x147);
            const double var_x149 = 1 / (035000000000000003 + 0.34999999999999998 * var_x148);
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x155 = 1 / (035000000000000003 + 3.7000000000000002 * var_x154);
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -004516 * var_x145 - 0098900000000000012 * var_x146;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x161 = exp(2.8198801550934083 + 035248501938667604 * var_chaste_interface__membrane__V);
            const double var_x162 = exp(-5.6377730796335452 - 070472163495419307 * var_chaste_interface__membrane__V);
            
            partialF = -00056230000000000006 * var_x162 - 00011885 * var_x161;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x164 = 4050000 * var_x163;
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x165 = 12150000000 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 4.0);
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 1.5856796826686865e-16 * var_x63 - 8.1628665394625614e-6 * var_x59 - 9.8651233004461501e-6 * var_x65 - 1.193943225512245e-7 * var_x64 - 2.2560474246135324e-6 * var_x34 - 022518252522655345 * var_x66;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative21(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x169 = 00014999999999999999 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
            const double var_x170 = 0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
            const double var_x171 = 1.0 + 0014999999999999998 / pow(var_x169, 2) + 00011900000000000002 / pow(var_x170, 2);
            const double var_x172 = 1 / var_x171;
            const double var_x173 = 001 * var_x172;
            const double var_x174 = 200000 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
            const double var_x175 = 40000 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
            const double var_x176 = 0022145492519739826 * var_x68;
            ...
            partialF = var_x173 * (-30837.453183520603 - var_x176 + 40000 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 200000 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 3.5444788081288787e-5 * var_x184 + 0022145492519739826 * var_x70 - 4.0288009715211813e-8 * var_x62 - 00022799730679188537 * var_x69 - 30.33500195190371 * var_x71 - 1625.0626147884036 * var_x181) + 001 * (0029999999999999996 / pow(var_x169, 3) + 00023800000000000004 / pow(var_x170, 3)) * (40 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 066000000000000003 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 00022799730679188537 * log(1.2 * var_x69) + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 1.7937848940989261e-5 * var_chaste_interface__membrane__V - var_x174 * (0.14000000000000001 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa) - var_x175 * (070000000000000007 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa) - var_x176 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 1.1055029865854122e-5 * var_x14 * var_x61 - 1.0 * var_x179 * var_x182) / pow(var_x171, 2);
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 4.286481532120841e-5 * var_x77 - 00067554757567966038 * var_x75 - 3.8843985601580465e-6 * var_x8 - 3.2651466157850246e-5 * var_x72 - 1.6557538619599519e-7 * var_x76 - 00019703470957323427 * var_x74 + var_x186 * var_x73;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative23(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x188 = 0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            const double var_x189 = 1.0 + 00011900000000000002 / pow(var_x188, 2);
            const double var_x190 = 1 / var_x189;
            const double var_x191 = 001 * var_x190;
            const double var_x196 = 84000 * var_chaste_interface__SR_Ca_release_channel__P_O1;
            const double var_x197 = 84000 * var_chaste_interface__SR_Ca_release_channel__P_O2;
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x202 = 001 * var_x201;
            const double var_x204 = 1800 * var_chaste_interface__SR_Ca_release_channel__P_O1;
            const double var_x205 = 1800 * var_chaste_interface__SR_Ca_release_channel__P_O2;
            
            partialF = var_x202 * (-1740382808421784 - var_x204 - var_x205) + 00016666666666666666 * (1740382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800 * var_x198 - 1740382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / (pow(var_x199, 3) * pow((083333333333333329 + var_x200), 2));
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL2::EvaluatePartialDerivative25(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.19333758676024207 - 4.9248350664764349e-13 * var_x183 - 00050803300043421621 * var_x179;
        }
        else
        {
