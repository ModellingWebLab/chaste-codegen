#ifndef CELLTORORD_FKATP_EPIFROMCELLMLGRL2_HPP_
#define CELLTORORD_FKATP_EPIFROMCELLMLGRL2_HPP_
...
class CellToRORd_fkatp_epiFromCellMLGRL2 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    CellToRORd_fkatp_epiFromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~CellToRORd_fkatp_epiFromCellMLGRL2();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const CellToRORd_fkatp_epiFromCellMLGRL2 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, CellToRORd_fkatp_epiFromCellMLGRL2 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)CellToRORd_fkatp_epiFromCellMLGRL2(p_solver, p_stimulus);
        }
...
#endif // CELLTORORD_FKATP_EPIFROMCELLMLGRL2_HPP_