...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_L_type_Ca_current_fCass_gate__tau_fCass = 2.0 + 80 / (1.0 + 399.99999999999994 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2)); // millisecond
        ...
        const double var_calcium_dynamics__K_buf_ss = 00025000000000000001; // millimolar
        ...
        const double var_calcium_dynamics__V_leak = 00036000000000000002; // per_millisecond
        ...
        const double var_calcium_dynamics__V_xfer = 0038; // per_millisecond
        const double var_calcium_dynamics__Vmax_up = 0063749999999999996; // millimolar_per_millisecond
        ...
        const double var_calcium_dynamics__k2_prime = 044999999999999998; // per_millimolar_per_millisecond
        const double var_calcium_dynamics__k3 = 059999999999999998; // per_millisecond
        const double var_calcium_dynamics__k4 = 0050000000000000001; // per_millisecond
        ...
        const double var_L_type_Ca_current_f2_gate__tau_f2 = 80 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 31.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 562.0 * exp(-3.0375000000000001 * pow((1 + 037037037037037035 * var_chaste_interface__membrane__V), 2)); // millisecond
        ...
        const double var_L_type_Ca_current_f_gate__tau_f = 20 + 200 / (1.0 + exp(1.3 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 180 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1102.5 * exp(-3.2400000000000002 * pow((1 + 037037037037037035 * var_chaste_interface__membrane__V), 2)); // millisecond
        ...
        const double var_reversal_potentials__P_kna = 029999999999999999; // dimensionless
        const double var_slow_time_dependent_potassium_current__g_Ks = 0.39200000000000002; // nanoS_per_picoF
        const double var_slow_time_dependent_potassium_current_Xs_gate__alpha_xs = 1400 / sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_slow_time_dependent_potassium_current_Xs_gate__beta_xs = 1.0 / (1.0 + exp(-2.3333333333333335 + 066666666666666666 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_slow_time_dependent_potassium_current_Xs_gate__tau_xs = 80 + 1.0 * var_slow_time_dependent_potassium_current_Xs_gate__alpha_xs * var_slow_time_dependent_potassium_current_Xs_gate__beta_xs; // millisecond
        ...
        const double var_transient_outward_current_s_gate__s_gateparam = 20; // millivolt
        ...
        const double var_transient_outward_current_s_gate__tau_s_t1Vdenom = 320; // millivolt_square
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x49 = exp(-1.1230167246823641 + 074867781645490947 * var_chaste_interface__membrane__V);
            ...
            partialF = -00088199999999999997 - var_x27 - var_x36 + 1081.6363254030778 * var_x58 + 03243 * var_x39 - 0.39200000000000002 * var_x0 - 0146 * var_x3 - 0024414715719063545 * var_x30 - 270.40908135076944 * var_x59 - 8.6662202299424464e-5 * var_x10 - 0.54050000000000009 * var_x25 - 2.2983750000000001 * var_x48 - 2.1086672225679691e-7 * var_x32 - 1.0 * var_x33 - var_x41 * var_x43 - var_x52 * var_x55;
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x9 = var_x8 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3);
            const double var_x31 = 2.0 * var_x9 - 6860000 * var_x7;
            const double var_x60 = 00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i;
            ...
            const double var_x94 = 001 + var_chaste_interface__calcium_dynamics__Ca_i;
            const double var_x95 = 1.0 + 00020000000000000001 / pow(var_x94, 2);
            ...
            partialF = var_x97 * (-0038240087783467445 - var_x98 + 7.2352122917848019e-6 * var_x63 - 069488744729986562 * var_x64 - 5.3144431236283834e-11 * var_x100 - 4.6212277808973232e-7 * var_x62) + 00040000000000000002 * (0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973232e-7 * log(2.0 * var_x62) - 0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 00042515544989027063 * var_x101 - var_x98 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x31 * var_x6) / (pow(var_x94, 3) * pow(var_x95, 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x110 = exp(2.6086956521739131 + 086956521739130432 * var_chaste_interface__membrane__V);
            const double var_x111 = 00037037037037037035 + 00037037037037037035 * var_x110;
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x113 = 050000000000000003 * var_chaste_interface__membrane__V;
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x127 = exp(-2.3333333333333335 + 066666666666666666 * var_chaste_interface__membrane__V);
            const double var_x128 = 1.0 + var_x127;
            const double var_x129 = 1 / var_x128;
            const double var_x130 = var_x126 * var_x129;
            const double var_x133 = 1 / (80 + 1400 * var_x130);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x138 = exp(-0.25 + 0050000000000000001 * var_chaste_interface__membrane__V);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x152 = var_chaste_interface__membrane__V < -40;
            const double var_x153 = exp(0.34849999999999998 * var_chaste_interface__membrane__V);
            const double var_x154 = exp(079000000000000001 * var_chaste_interface__membrane__V);
            const double var_x155 = exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x156 = 1.0 + var_x155;
            const double var_x157 = 1.0 * ((var_x152) ? (057000000000000002 * var_x151) : (0));
            const double var_x158 = 1.0 * ((var_x152) ? (310000 * var_x153 + 2.7000000000000002 * var_x154) : (5.9230769230769234 / var_x156));
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x162 = exp(-01052 * var_chaste_interface__membrane__V);
            ...
            const double var_x166 = exp(057000000000000002 * var_chaste_interface__membrane__V);
            const double var_x167 = var_x166 / var_x165;
            const double var_x168 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
            const double var_x169 = exp(-043909999999999998 * var_chaste_interface__membrane__V);
            ...
            const double var_x176 = 1.0 * ((var_x152) ? (024240000000000001 * var_x163) : (0.59999999999999998 * var_x167));
            const double var_x177 = 1.0 * ((var_x152) ? (var_x174 * var_x175) : (0));
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x184 = exp(-2.6923076923076925 - 076923076923076927 * var_chaste_interface__membrane__V);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x197 = pow((1 + 037037037037037035 * var_chaste_interface__membrane__V), 2);
            const double var_x198 = exp(-3.2400000000000002 * var_x197);
            const double var_x202 = 1102.5 * var_x198;
            const double var_x203 = 1 / (20 + var_x202 + 200 * var_x196 + 180 * var_x193);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x211 = 1 / (var_x210 + 80 * var_x193 + 31.0 * var_x206);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x214 = 1 / (2.0 + 80 * var_x213);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x219 = exp(-6.328125 * pow((1 + 022222222222222223 * var_chaste_interface__membrane__V), 2));
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x226 = exp(-0.88888888888888884 * pow((1 + 025000000000000001 * var_chaste_interface__membrane__V), 2));
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x236 = 1 / (059999999999999998 + 0.14999999999999999 * var_x235);
            const double var_x237 = var_x236 * var_chaste_interface__calcium_dynamics__R_prime;
            const double var_x238 = var_x235 * var_x237;
            const double var_x239 = 015299999999999998 * var_x238;
            ...
            partialF = var_x231 * (-00036000000000000002 - var_x239 + 021759999999999998 * var_x246 - 0032639999999999995 * var_x243) + 0.66666666666666674 * (00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0063749999999999996 * var_x101 - 00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x239 * var_x241) / (pow(var_x228, 3) * pow((0.33333333333333337 + var_x229), 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x252 = 00025000000000000001 + var_chaste_interface__calcium_dynamics__Ca_ss;
            const double var_x253 = 1.0 + 0001 / pow(var_x252, 2);
            const double var_x254 = 1 / var_x253;
            const double var_x255 = 1.0 * var_x254;
            const double var_x259 = 0.30611192392099484 * var_x238;
            
            partialF = var_x255 * (-1.1399999999999999 - var_x259 + 0.61222384784198969 * var_x248 - 0.65303877103145569 * var_x247 - 63.325437108704392 * var_x80) + 00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x241 * var_x259 - var_x251 * var_x56) / (pow(var_x252, 3) * pow(var_x253, 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x232 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
            const double var_x233 = 1 / (1.0 + 2.25 * var_x232);
            const double var_x260 = -0.11249999999999999 + 067500000000000004 * var_x233;
            
            partialF = -0050000000000000001 + var_x260 * var_chaste_interface__calcium_dynamics__Ca_ss;
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 5.0371257222730904e-7 * var_x83 - 9.0551084895961074e-7 * var_x68 - 1.823319832565245e-7 * var_x84 - 0031224512033090025 * var_x86 - 00080594011556369446 * var_x82;
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x40 = var_x16 * var_x22 / pow(var_x17, 2);
            const double var_x42 = var_x15 * var_x29 / pow(var_x23, 2);
            const double var_x66 = 029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i;
            const double var_x85 = var_x0 * (0031249999999999997 * var_chaste_interface__sodium_dynamics__Na_i + 0.10416666666666667 * var_chaste_interface__potassium_dynamics__K_i) / pow(var_x66, 2);
            ...
            partialF = 00010126109252331096 * var_x93 - 0031224512033090025 * var_x92 - 0016876848753885161 * var_x88 - 4.5587787568311439e-5 * var_x87 - 011750408368292439 * var_x85 - 0031224512033090025 * var_x89 - var_x261 * var_x91;
        }
        else
        {
