...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_I_Ca__taud = ((fabs(5.0 + var_chaste_interface__membrane_potential__V_m) < 5.999999999062311e-7) ? (833333.33346356789 * (5.0000005999999999 + var_chaste_interface__membrane_potential__V_m) * (47619047.626489595 * (1.0 - exp(9.9999999984371854e-8)) / (1.0 + exp(9.9999999984371854e-8)) + 47619047.626489595 * (1.0 - exp(-9.9999999984371854e-8)) / (1.0 + exp(-9.9999999984371854e-8))) - 47619047.626489595 * (1.0 - exp(9.9999999984371854e-8)) / (1.0 + exp(9.9999999984371854e-8))) : (28.571428571428569 * (1.0 - exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane_potential__V_m)) / ((1.0 + exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane_potential__V_m)) * (5.0 + var_chaste_interface__membrane_potential__V_m)))); // msec
    ...
    double Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x359 = exp(9.9999999984371854e-8);
            const double var_x360 = (1.0 - var_x359) / (1.0 + var_x359);
            const double var_x361 = 47619047.626489595 * var_x360;
            const double var_x362 = exp(-9.9999999984371854e-8);
            const double var_x363 = (1.0 - var_x362) / (1.0 + var_x362);
            const double var_x364 = (5.0000005999999999 + var_chaste_interface__membrane_potential__V_m) * (var_x361 + 47619047.626489595 * var_x363);
            const double var_x365 = 5.0 + var_chaste_interface__membrane_potential__V_m;
            const double var_x366 = fabs(var_x365) < 5.999999999062311e-7;
            ...
            const double var_x371 = ((var_x366) ? (1 / (-var_x361 + 833333.33346356789 * var_x364)) : (var_x365 * var_x369));
    ...
    double Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLGRL2::EvaluatePartialDerivative33(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x203 = 5.4272812499999989e-11 * var_x202;
            const double var_x204 = var_x20 * var_x22;
            const double var_x205 = ((var_x25) ? (var_x203 + var_x201 * (-var_x203 - 5.4272812499999989e-11 * var_x204)) : (2.0317506863908137e-5 * var_x34));
    ...
    double Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLGRL2::EvaluatePartialDerivative37(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x238 = var_x202 * var_x237;
            const double var_x239 = ((var_x50) ? (var_x238 + (0.5 - 374358.83507802623 * var_chaste_interface__membrane_potential__V_m) * (-var_x238 - var_x204 * var_x237)) : (2.6604556187875876 * var_x58));
