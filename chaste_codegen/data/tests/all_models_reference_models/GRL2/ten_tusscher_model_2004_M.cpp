...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellten_tusscher_model_2004_MFromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x267 * (var_x132 + var_x149 * (var_x147 - var_x148)) + 9.9963436928702016 * (var_x136 - var_x135 - var_x145) / (pow(var_x265, 3) * pow((0.33333333333333337 + var_x266), 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_MFromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x273 = mParameters[12] * mParameters[3];
            
            partialF = var_x273 * (1.1846503119326294e-6 * var_x118 - 0.0018954404990922068 * var_x115 - 0.016878114612481093 * var_x112 - 0.016878114612481093 * var_x117 - 0.0056863214972766203 * var_x119);
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_MFromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x273 * (4.357910453967955e-5 * var_x127 - 0.016878114612481093 * var_x113 - 0.016878114612481093 * var_x120 - 0.016878114612481093 * var_x121 - 0.00072631840899465921 * var_x122 - 0.0072631840899465916 * var_x124 - var_x126 * var_x276);
        }
        else
        {
