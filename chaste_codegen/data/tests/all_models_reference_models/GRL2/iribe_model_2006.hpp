#ifndef CELLIRIBE_MODEL_2006FROMCELLMLGRL2_HPP_
#define CELLIRIBE_MODEL_2006FROMCELLMLGRL2_HPP_
...
class Celliribe_model_2006FromCellMLGRL2 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Celliribe_model_2006FromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Celliribe_model_2006FromCellMLGRL2();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Celliribe_model_2006FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Celliribe_model_2006FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Celliribe_model_2006FromCellMLGRL2(p_solver, p_stimulus);
        }
...
#endif // CELLIRIBE_MODEL_2006FROMCELLMLGRL2_HPP_