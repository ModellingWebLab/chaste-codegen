#ifndef CELLLI_MOUSE_2010FROMCELLMLGRL2_HPP_
#define CELLLI_MOUSE_2010FROMCELLMLGRL2_HPP_
...
class Cellli_mouse_2010FromCellMLGRL2 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellli_mouse_2010FromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellli_mouse_2010FromCellMLGRL2();
...
CHASTE_CLASS_EXPORT(Cellli_mouse_2010FromCellMLGRL2)
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellli_mouse_2010FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellli_mouse_2010FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellli_mouse_2010FromCellMLGRL2(p_solver, p_stimulus);
        }
...
#endif // CELLLI_MOUSE_2010FROMCELLMLGRL2_HPP_