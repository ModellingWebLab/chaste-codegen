...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnygren_atrial_model_1998FromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 7.9263098651550091e-6 * var_x93 - 0.00013939759074981328 * var_x92 - var_x194 * var_x23 - var_x195 * var_x23 - var_x196 * var_x23 - var_x197 * var_x23;
        }
        else
        {
    ...
    double Cellnygren_atrial_model_1998FromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -4.048582995951417e-5 - 6.7205525966826332e-6 * var_x99 + var_x209 * var_x9 - var_x100 * var_x210;
        }
        else
        {
    ...
    double Cellnygren_atrial_model_1998FromCellMLGRL2::EvaluatePartialDerivative23(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0001 + 1.7317432876958762e-5 * var_x104 + 5.8281690184963299e-5 * var_x105 - 0.0010249822849250976 * var_x103 + var_x107 * var_x215 - var_x101 * var_x218 - var_x101 * var_x219 - var_x101 * var_x220 - var_x101 * var_x221 - var_x106 * var_x215;
        }
        else
        {
