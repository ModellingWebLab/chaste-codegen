...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x24 = 1.9299999999999998e-5 * mParameters[8];
            ...
            const double var_x30 = var_x10 * (var_x3 + var_x9 * mParameters[3]);
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x69 = var_x68 / var_x67;
            const double var_x75 = var_x66 - var_x6 * var_x65;
            const double var_x77 = 0.019299999999999998 * mParameters[8];
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -((var_x133) ? (var_x139 - 499999.99998562218 * (47.129999000000005 + var_chaste_interface__membrane__V) * (-var_x139 - 3.200000000092018e-7 * var_x130)) : (var_x132 * var_x137)) - 0.080000000000000002 * var_x138;
        }
        else
        {
