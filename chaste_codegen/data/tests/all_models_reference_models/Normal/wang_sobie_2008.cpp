...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellwang_sobie_2008FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellwang_sobie_2008FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellwang_sobie_2008FromCellML::Cellwang_sobie_2008FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                35,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellwang_sobie_2008FromCellML>::Instance();
        Init();
    ...
    Cellwang_sobie_2008FromCellML::~Cellwang_sobie_2008FromCellML()
    {
    }

    
    double Cellwang_sobie_2008FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellwang_sobie_2008FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellwang_sobie_2008FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellwang_sobie_2008FromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellwang_sobie_2008FromCellML)
