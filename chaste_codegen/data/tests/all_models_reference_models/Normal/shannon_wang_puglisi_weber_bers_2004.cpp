...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellshannon_wang_puglisi_weber_bers_2004FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellshannon_wang_puglisi_weber_bers_2004FromCellML::Cellshannon_wang_puglisi_weber_bers_2004FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                45,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellshannon_wang_puglisi_weber_bers_2004FromCellML>::Instance();
        Init();
    ...
    Cellshannon_wang_puglisi_weber_bers_2004FromCellML::~Cellshannon_wang_puglisi_weber_bers_2004FromCellML()
    {
    }

    
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellshannon_wang_puglisi_weber_bers_2004FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellshannon_wang_puglisi_weber_bers_2004FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellshannon_wang_puglisi_weber_bers_2004FromCellML>::Initialise(void)
{
