...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellML::Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                26,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellML>::Instance();
        Init();
    ...
    Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellML::~Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellML()
    {
    }

    
    
    void Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellML::VerifyStateVariables()
    {
    ...
    double Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellpandit_clark_giles_demir_2001_endocardial_cellFromCellML>::Initialise(void)
{
