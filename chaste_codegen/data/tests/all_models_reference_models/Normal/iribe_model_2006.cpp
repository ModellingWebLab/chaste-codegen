...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celliribe_model_2006FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Celliribe_model_2006FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celliribe_model_2006FromCellML::Celliribe_model_2006FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                23,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celliribe_model_2006FromCellML>::Instance();
        Init();
    ...
    Celliribe_model_2006FromCellML::~Celliribe_model_2006FromCellML()
    {
    }

    
    double Celliribe_model_2006FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Celliribe_model_2006FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Celliribe_model_2006FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celliribe_model_2006FromCellML>::Initialise(void)
{
