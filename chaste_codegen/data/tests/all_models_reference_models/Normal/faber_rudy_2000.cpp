...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellfaber_rudy_2000FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellfaber_rudy_2000FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellfaber_rudy_2000FromCellML::Cellfaber_rudy_2000FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                25,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellfaber_rudy_2000FromCellML>::Instance();
        Init();
    ...
    Cellfaber_rudy_2000FromCellML::~Cellfaber_rudy_2000FromCellML()
    {
    }

    
    double Cellfaber_rudy_2000FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellfaber_rudy_2000FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellfaber_rudy_2000FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellfaber_rudy_2000FromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellfaber_rudy_2000FromCellML)
