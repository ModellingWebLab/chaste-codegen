...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellTrovato2020FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double CellTrovato2020FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    CellTrovato2020FromCellML::CellTrovato2020FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                46,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<CellTrovato2020FromCellML>::Instance();
        Init();
    ...
    CellTrovato2020FromCellML::~CellTrovato2020FromCellML()
    {
    }

    
    double CellTrovato2020FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void CellTrovato2020FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        rDY[14] = d_dt_chaste_interface_var_INa__m;
        rDY[15] = d_dt_chaste_interface_var_INa__hf;
        rDY[16] = d_dt_chaste_interface_var_INa__hs;
        rDY[17] = d_dt_chaste_interface_var_INa__j;
        rDY[18] = d_dt_chaste_interface_var_INa__hsp;
        rDY[19] = d_dt_chaste_interface_var_INa__jp;
        rDY[20] = d_dt_chaste_interface_var_INaL__mL;
        rDY[21] = d_dt_chaste_interface_var_INaL__hL;
        rDY[22] = d_dt_chaste_interface_var_INaL__hLp;
        rDY[23] = d_dt_chaste_interface_var_Ito__a;
        rDY[24] = d_dt_chaste_interface_var_Ito__i1;
        rDY[25] = d_dt_chaste_interface_var_Ito__i2;
        rDY[26] = d_dt_chaste_interface_var_ICaL__d;
        rDY[27] = d_dt_chaste_interface_var_ICaL__ff;
        rDY[28] = d_dt_chaste_interface_var_ICaL__fs;
        rDY[29] = d_dt_chaste_interface_var_ICaL__fcaf;
        rDY[30] = d_dt_chaste_interface_var_ICaL__fcas;
        rDY[31] = d_dt_chaste_interface_var_ICaL__jca;
        rDY[32] = d_dt_chaste_interface_var_ICaL__ffp;
        rDY[33] = d_dt_chaste_interface_var_ICaL__fcafp;
        rDY[34] = d_dt_chaste_interface_var_ICaL__nca;
        rDY[35] = d_dt_chaste_interface_var_ICaT__b;
        rDY[36] = d_dt_chaste_interface_var_ICaT__g;
        rDY[37] = d_dt_chaste_interface_var_IKr__xrf;
        rDY[38] = d_dt_chaste_interface_var_IKr__xrs;
        rDY[39] = d_dt_chaste_interface_var_IKs__xs1;
        rDY[40] = d_dt_chaste_interface_var_IKs__xs2;
        rDY[41] = d_dt_chaste_interface_var_If__y;
        rDY[42] = d_dt_chaste_interface_var_IK1__xk1;
    ...
    std::vector<double> CellTrovato2020FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<CellTrovato2020FromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(CellTrovato2020FromCellML)
