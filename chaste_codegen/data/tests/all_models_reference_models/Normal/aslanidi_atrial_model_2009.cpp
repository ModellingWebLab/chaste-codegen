...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellaslanidi_atrial_model_2009FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellaslanidi_atrial_model_2009FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellaslanidi_atrial_model_2009FromCellML::Cellaslanidi_atrial_model_2009FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                29,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellaslanidi_atrial_model_2009FromCellML>::Instance();
        Init();
    ...
    Cellaslanidi_atrial_model_2009FromCellML::~Cellaslanidi_atrial_model_2009FromCellML()
    {
    }

    
    double Cellaslanidi_atrial_model_2009FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellaslanidi_atrial_model_2009FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellaslanidi_atrial_model_2009FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellaslanidi_atrial_model_2009FromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellaslanidi_atrial_model_2009FromCellML)
