...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellpasek_simurda_christe_2006FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpasek_simurda_christe_2006FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellpasek_simurda_christe_2006FromCellML::Cellpasek_simurda_christe_2006FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpasek_simurda_christe_2006FromCellML>::Instance();
        Init();
    ...
    Cellpasek_simurda_christe_2006FromCellML::~Cellpasek_simurda_christe_2006FromCellML()
    {
    }

    
    double Cellpasek_simurda_christe_2006FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellpasek_simurda_christe_2006FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Vms__Vms = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellpasek_simurda_christe_2006FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellpasek_simurda_christe_2006FromCellML>::Initialise(void)
{
