...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellclancy_rudy_2002FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellclancy_rudy_2002FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellclancy_rudy_2002FromCellML::Cellclancy_rudy_2002FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                35,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellclancy_rudy_2002FromCellML>::Instance();
        Init();
    ...
    Cellclancy_rudy_2002FromCellML::~Cellclancy_rudy_2002FromCellML()
    {
    }

    
    double Cellclancy_rudy_2002FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellclancy_rudy_2002FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellclancy_rudy_2002FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellclancy_rudy_2002FromCellML>::Initialise(void)
{
