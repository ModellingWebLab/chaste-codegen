...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellML::Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                26,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellML>::Instance();
        Init();
    ...
    Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellML::~Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellML()
    {
    }

    
    double Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellpandit_clark_giles_demir_2001_epicardial_cellFromCellML)
