...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celldifrancesco_noble_model_1985FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Celldifrancesco_noble_model_1985FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celldifrancesco_noble_model_1985FromCellML::Celldifrancesco_noble_model_1985FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                16,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celldifrancesco_noble_model_1985FromCellML>::Instance();
        Init();
    ...
    Celldifrancesco_noble_model_1985FromCellML::~Celldifrancesco_noble_model_1985FromCellML()
    {
    }

    
    double Celldifrancesco_noble_model_1985FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Celldifrancesco_noble_model_1985FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Celldifrancesco_noble_model_1985FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celldifrancesco_noble_model_1985FromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celldifrancesco_noble_model_1985FromCellML)
