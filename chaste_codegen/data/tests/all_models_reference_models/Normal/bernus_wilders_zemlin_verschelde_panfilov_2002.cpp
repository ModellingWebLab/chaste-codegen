...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellML::Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                6,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellML>::Instance();
        Init();
    ...
    Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellML::~Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellML()
    {
    }

    
    double Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        rDY[2] = d_dt_chaste_interface_var_sodium_current_v_gate__v;
        rDY[3] = d_dt_chaste_interface_var_calcium_current_f_gate__f;
        rDY[4] = d_dt_chaste_interface_var_transient_outward_current_to_gate__to;
        rDY[5] = d_dt_chaste_interface_var_delayed_rectifier_potassium_current_X_gate__X;
    }

    std::vector<double> Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbernus_wilders_zemlin_verschelde_panfilov_2002FromCellML)
