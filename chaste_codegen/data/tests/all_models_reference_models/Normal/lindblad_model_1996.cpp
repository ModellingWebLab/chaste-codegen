...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celllindblad_model_1996FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Celllindblad_model_1996FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celllindblad_model_1996FromCellML::Celllindblad_model_1996FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                28,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celllindblad_model_1996FromCellML>::Instance();
        Init();
    ...
    Celllindblad_model_1996FromCellML::~Celllindblad_model_1996FromCellML()
    {
    }

    
    double Celllindblad_model_1996FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Celllindblad_model_1996FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Celllindblad_model_1996FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celllindblad_model_1996FromCellML>::Initialise(void)
{
