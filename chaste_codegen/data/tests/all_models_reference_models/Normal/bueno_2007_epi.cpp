...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellbueno_2007_epiFromCellML::UseCellMLDefaultStimulus()
    {
    ...
    Cellbueno_2007_epiFromCellML::Cellbueno_2007_epiFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                4,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbueno_2007_epiFromCellML>::Instance();
        Init();
    ...
    Cellbueno_2007_epiFromCellML::~Cellbueno_2007_epiFromCellML()
    {
    }

    
    double Cellbueno_2007_epiFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbueno_2007_epiFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellbueno_2007_epiFromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Cellbueno_2007_epiFromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbueno_2007_epiFromCellML)
