...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celliyer_2004FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Celliyer_2004FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Celliyer_2004FromCellML::Celliyer_2004FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                67,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celliyer_2004FromCellML>::Instance();
        Init();
    ...
    Celliyer_2004FromCellML::~Celliyer_2004FromCellML()
    {
    }

    
    double Celliyer_2004FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Celliyer_2004FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Celliyer_2004FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celliyer_2004FromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Celliyer_2004FromCellML)
