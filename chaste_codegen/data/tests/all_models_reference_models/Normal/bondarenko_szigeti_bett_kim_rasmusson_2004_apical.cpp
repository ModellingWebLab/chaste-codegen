...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellML::Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellML>::Instance();
        Init();
    ...
    Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellML::~Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellML()
    {
    }

    
    double Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellML>::Initialise(void)
{
