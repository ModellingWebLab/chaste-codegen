...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellli_mouse_2010FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellli_mouse_2010FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellli_mouse_2010FromCellML::Cellli_mouse_2010FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                36,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellli_mouse_2010FromCellML>::Instance();
        Init();
    ...
    Cellli_mouse_2010FromCellML::~Cellli_mouse_2010FromCellML()
    {
    }

    
    double Cellli_mouse_2010FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellli_mouse_2010FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellli_mouse_2010FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellli_mouse_2010FromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellli_mouse_2010FromCellML)
