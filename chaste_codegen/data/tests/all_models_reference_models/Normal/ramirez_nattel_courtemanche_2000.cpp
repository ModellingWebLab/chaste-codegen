...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellramirez_nattel_courtemanche_2000FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellramirez_nattel_courtemanche_2000FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellramirez_nattel_courtemanche_2000FromCellML::Cellramirez_nattel_courtemanche_2000FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                25,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellramirez_nattel_courtemanche_2000FromCellML>::Instance();
        Init();
    ...
    Cellramirez_nattel_courtemanche_2000FromCellML::~Cellramirez_nattel_courtemanche_2000FromCellML()
    {
    }

    
    double Cellramirez_nattel_courtemanche_2000FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellramirez_nattel_courtemanche_2000FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellramirez_nattel_courtemanche_2000FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellramirez_nattel_courtemanche_2000FromCellML>::Initialise(void)
{
