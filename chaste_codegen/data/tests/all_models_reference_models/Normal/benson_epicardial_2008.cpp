...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellbenson_epicardial_2008FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellbenson_epicardial_2008FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellbenson_epicardial_2008FromCellML::Cellbenson_epicardial_2008FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                29,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellbenson_epicardial_2008FromCellML>::Instance();
        Init();
    ...
    Cellbenson_epicardial_2008FromCellML::~Cellbenson_epicardial_2008FromCellML()
    {
    }

    
    double Cellbenson_epicardial_2008FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellbenson_epicardial_2008FromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellbenson_epicardial_2008FromCellML::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellbenson_epicardial_2008FromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellbenson_epicardial_2008FromCellML)
