...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellohara_rudy_2011_epiFromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_2011_epiFromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellohara_rudy_2011_epiFromCellML::Cellohara_rudy_2011_epiFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_2011_epiFromCellML>::Instance();
        Init();
    ...
    Cellohara_rudy_2011_epiFromCellML::~Cellohara_rudy_2011_epiFromCellML()
    {
    }

    
    double Cellohara_rudy_2011_epiFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellohara_rudy_2011_epiFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellohara_rudy_2011_epiFromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellohara_rudy_2011_epiFromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellohara_rudy_2011_epiFromCellML)
