...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2004_MFromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2004_MFromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellten_tusscher_model_2004_MFromCellML::Cellten_tusscher_model_2004_MFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                17,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellten_tusscher_model_2004_MFromCellML>::Instance();
        Init();
    ...
    Cellten_tusscher_model_2004_MFromCellML::~Cellten_tusscher_model_2004_MFromCellML()
    {
    }

    
    double Cellten_tusscher_model_2004_MFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellten_tusscher_model_2004_MFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellten_tusscher_model_2004_MFromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellten_tusscher_model_2004_MFromCellML>::Initialise(void)
{
