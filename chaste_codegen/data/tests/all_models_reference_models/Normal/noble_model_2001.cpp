...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellnoble_model_2001FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellnoble_model_2001FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellnoble_model_2001FromCellML::Cellnoble_model_2001FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                20,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnoble_model_2001FromCellML>::Instance();
        Init();
    ...
    Cellnoble_model_2001FromCellML::~Cellnoble_model_2001FromCellML()
    {
    }

    
    double Cellnoble_model_2001FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellnoble_model_2001FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellnoble_model_2001FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellnoble_model_2001FromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellnoble_model_2001FromCellML)
