...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellohara_rudy_cipa_v1_2017FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellohara_rudy_cipa_v1_2017FromCellML::Cellohara_rudy_cipa_v1_2017FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                48,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_cipa_v1_2017FromCellML>::Instance();
        Init();
    ...
    Cellohara_rudy_cipa_v1_2017FromCellML::~Cellohara_rudy_cipa_v1_2017FromCellML()
    {
    }

    
    double Cellohara_rudy_cipa_v1_2017FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellohara_rudy_cipa_v1_2017FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellohara_rudy_cipa_v1_2017FromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellohara_rudy_cipa_v1_2017FromCellML>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellohara_rudy_cipa_v1_2017FromCellML)
