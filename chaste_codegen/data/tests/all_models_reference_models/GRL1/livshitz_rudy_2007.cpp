...
#include "MathsCustomFunctions.hpp"
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_Environment__Temp = 310; // kelvin
        ...
        const double var_ICaL__kmca = 00059999999999999995; // mM
        const double var_ICaL__fca = 1.0 / (1.0 + var_Ca__Ca_i / var_ICaL__kmca); // dimensionless
        const double var_ICaL__pca = 00054000000000000001; // L_per_F_ms
        const double var_ICaL__pk = 1.9299999999999999e-7; // L_per_F_ms
        const double var_ICaL__pna = 6.75e-7; // L_per_F_ms
        const double var_ICaT__gcat = 050000000000000003; // mS_per_uF
        const double var_ICab__gcab = 003016; // mS_per_uF
        ...
        const double var_IKp__GKpmax = 0055199999999999997; // mS_per_uF
        ...
        const double var_INaCa__c1 = 00025000000000000001; // uA_per_uF
        const double var_INaCa__c2 = 0001; // dimensionless
        ...
        const double var_INab__GNab = 0040000000000000001; // mS_per_uF
        ...
        const double var_IKr__r = 1.0 / (1.0 + exp(0.4017857142857143 + 044642857142857144 * var_chaste_interface__cell__V)); // dimensionless
    ...
    void Celllivshitz_rudy_2007FromCellMLGRL1::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        ...
        const double var_Irel__csqnbar = 10; // mM
        ...
        const double var_Irel__tau_Rel = var_Irel__tau / (1.0 + 0123 / var_Irel__Ca_JSR_free); // ms
        const double var_Itr__tautr = 120; // ms
        ...
        const double var_Iup_Ileak__iupbar = 0087500000000000008; // mM_per_ms
        ...
        const double var_ICaL__dss1 = 1.0 / (1.0 + exp(-2500 - 41.666666666666664 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_ICaL__ilcak = var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_ICaL__ibark; // uA_per_uF
        const double var_ICaL__ilcana = var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_ICaL__ibarna; // uA_per_uF
        const double var_ICaL__taud = 28.571428571428569 * (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__cell__V)) * var_ICaL__dss0 / (10 + var_chaste_interface__cell__V); // ms
        ...
        const double var_INa__aj = 1.0 * (37.780000000000001 + var_chaste_interface__cell__V) * (-127140 * exp(0.24440000000000001 * var_chaste_interface__cell__V) - 3.4740000000000003e-5 * exp(-043909999999999998 * var_chaste_interface__cell__V)) * var_INa__a / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_INa__bH = (3.5600000000000001 * exp(079000000000000001 * var_chaste_interface__cell__V) + 310000 * exp(0.34999999999999998 * var_chaste_interface__cell__V)) * var_INa__a + 7.6923076923076916 * (1.0 - var_INa__a) / (1.0 + exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_cell__ra = 0011000000000000001; // cm
        ...
        const double var_cell__vcell = 1000 * M_PI * pow(var_cell__ra, 2) * var_cell__l; // uL
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x215 = 035000000000000003 * var_x208;
            const double var_x216 = 10 + var_chaste_interface__cell__V;
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x219 = 019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__cell__V), 2));
            
            partialF = -02 - var_x219;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x239 = exp(2.0609999999999999 + 068699999999999997 * var_chaste_interface__cell__V);
            const double var_x240 = -1.0 + var_x239;
            const double var_x241 = 1 / var_x240;
            const double var_x242 = 00013100000000000001 * var_x241;
            ...
            const double var_x247 = 30 + var_chaste_interface__cell__V;
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x267 = 092592592592592587 * var_chaste_interface__Ca__Ca_JSR_T;
            const double var_x268 = sqrt(pow((1 - var_x267), 2) + 027434842249657067 * var_chaste_interface__Ca__Ca_JSR_T);
            ...
            const double var_x271 = 0025894736842105265 * var_x270;
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 188.75472776079184 * var_x292 + 000273711269773125 * var_x137 - 0015001782369281045 * var_x136 - 9.0713633255081308e-6 * var_x132 - 3.2165331512873877e-8 * var_x104 - 0011476363512500001 * var_x133 - var_x135 * var_x290;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x297 = var_x142 / (-040040000000000006 + var_x30);
            const double var_x298 = var_x149 / pow((-060060000000000002 + var_x144), 2);
            
            partialF = 8.319524789019007e-5 * var_x152 + 1.5380185720592182e-8 * var_x148 + 5.0183373527362646e-6 * var_x147 - 0015981617647058825 * var_x298 - 00023999003823076885 * var_x158 - 3.5374427157362017e-5 * var_x143 - 1.9439193096692272e-10 * var_x160 - 7.9592461104064537e-5 * var_x150 - 00071029411764705886 * var_x297 - var_x151 * var_x294;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x267 = 092592592592592587 * var_chaste_interface__Ca__Ca_JSR_T;
            const double var_x268 = sqrt(pow((1 - var_x267), 2) + 027434842249657067 * var_chaste_interface__Ca__Ca_JSR_T);
            const double var_x282 = (-078875171467764058 + 0085733882030178329 * var_chaste_interface__Ca__Ca_JSR_T) / var_x268;
            
            partialF = -0041666666666666666 - 044999999999999998 * var_x282;
        }
        else
        {
