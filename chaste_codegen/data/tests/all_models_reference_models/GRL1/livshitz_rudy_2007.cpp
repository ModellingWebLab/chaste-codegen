...
#include "MathsCustomFunctions.hpp"
    ...
    void Celllivshitz_rudy_2007FromCellMLGRL1::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        ...
        const double var_ICaL__ilcak = var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_ICaL__ibark; // uA_per_uF
        const double var_ICaL__ilcana = var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_ICaL__ibarna; // uA_per_uF
        const double var_ICaL__taud = ((fabs(10.0 + var_chaste_interface__cell__V) < 6.2400000011564316e-7) ? (801282.05113355326 * (10.000000624 + var_chaste_interface__cell__V) * (45787545.779060178 * (1.0 - exp(1.0000000001853256e-7)) / (1.0 + exp(1.0000000001853256e-7)) + 45787545.779060178 * (1.0 - exp(-1.0000000001853256e-7)) / (1.0 + exp(-1.0000000001853256e-7))) - 45787545.779060178 * (1.0 - exp(1.0000000001853256e-7)) / (1.0 + exp(1.0000000001853256e-7))) : (28.571428571428569 * (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__cell__V)) / ((1.0 + exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__cell__V)) * (10.0 + var_chaste_interface__cell__V)))); // ms
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x65 = 0.75 * var_chaste_interface__Na__Na_i;
            ...
            const double var_x75 = 0.0024381008236689767 * var_x73 * var_x74;
            ...
            const double var_x79 = ((var_x71) ? (0.0012190504118344883 * var_x66 + 0.0012190504118344883 * var_x69) : (var_x75 + 6.8454343811362063e-5 * var_x77 * var_chaste_interface__Na__Na_i - 9.1272458415149417e-5 * var_x74 * var_x78));
            ...
            const double var_x85 = 0.75 * var_chaste_interface__K__K_i;
            ...
            const double var_x89 = 0.00069711623550831479 * var_x73 * var_x88;
            const double var_x90 = ((var_x71) ? (0.0003485581177541574 * var_x86 + 0.0003485581177541574 * var_x87) : (var_x89 + 1.9572871637915374e-5 * var_x77 * var_chaste_interface__K__K_i - 2.6097162183887167e-5 * var_x78 * var_x88));
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x239 = 1 / (1.0 - exp(-9.9999999747524276e-8));
            ...
            const double var_x242 = fabs(var_x241) < 1.0000000010279564e-6;
            ...
            const double var_x248 = 3.2000000146581445e-7 * var_x240;
            
            partialF = -((var_x242) ? (-var_x248 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__cell__V) * (var_x248 + 3.1999999919207769e-7 * var_x239)) : (var_x241 * var_x246)) - 0.080000000000000002 * var_x247;
        }
        else
        {
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x290 = exp(1.0000000001853256e-7);
            const double var_x291 = (1.0 - var_x290) / (1.0 + var_x290);
            const double var_x292 = 45787545.779060178 * var_x291;
            const double var_x293 = exp(-1.0000000001853256e-7);
            const double var_x294 = (1.0 - var_x293) / (1.0 + var_x293);
            const double var_x295 = (10.000000624 + var_chaste_interface__cell__V) * (var_x292 + 45787545.779060178 * var_x294);
            const double var_x296 = 10.0 + var_chaste_interface__cell__V;
            const double var_x297 = fabs(var_x296) < 6.2400000011564316e-7;
            ...
            const double var_x302 = ((var_x297) ? (1 / (-var_x292 + 801282.05113355326 * var_x295)) : (var_x296 * var_x300));
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x310 = 1 / (-1.0 + exp(-9.9999999179090074e-8));
            const double var_x311 = 1 / (-1.0 + exp(1.0000000020937704e-7));
            ...
            const double var_x318 = fabs(var_x317) < 6.8965517030505907e-7;
            const double var_x319 = 1 / (1.0 - exp(1.0000000000864873e-7));
            const double var_x320 = 1 / (1.0 - exp(-1.0000000000864873e-7));
            ...
            const double var_x325 = fabs(var_x315) < 8.1300813015161566e-7;
            const double var_x326 = 4.2068965605324136e-10 * var_x311;
            const double var_x327 = var_x314 * var_x315;
            const double var_x328 = 1.1219512196092296e-9 * var_x319;
            const double var_x329 = var_x317 * var_x323;
            const double var_x330 = ((var_x318) ? (var_x326 + var_x327 - 725000.00221680664 * (38.899999310344825 + var_chaste_interface__cell__V) * (-var_x326 - 4.2068965171893065e-10 * var_x310)) : ((var_x325) ? (var_x329 - var_x328 + 614999.99994681031 * (14.200000813008129 + var_chaste_interface__cell__V) * (var_x328 + 1.1219512196092296e-9 * var_x320)) : (var_x327 + var_x329)));
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x334 = 1 / (-1.0 + exp(9.9999999925515227e-8));
            const double var_x335 = 1 / (-1.0 + exp(-9.9999999925515227e-8));
            const double var_x336 = 1 / (1.0 - exp(2.1542940304186685e-7));
            const double var_x337 = 1 / (1.0 - exp(-2.1542940304186685e-7));
            const double var_x338 = 30.0 + var_chaste_interface__cell__V;
            const double var_x339 = fabs(var_x338) < 1.4556040746072085e-6;
            ...
            const double var_x347 = 1.9068413377354434e-10 * var_x335;
            const double var_x348 = 1.0465793296425829e-10 * var_x336;
            const double var_x349 = ((var_x339) ? (-var_x347 - var_x348 + 343500.00025585521 * (30.000001455604075 + var_chaste_interface__cell__V) * (var_x347 + var_x348 + 1.9068413377354434e-10 * var_x334 + 1.0465793296425829e-10 * var_x337)) : (var_x338 * var_x342 + var_x338 * var_x345));
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x162 = 4.8845531249999998e-9 * var_x161;
            const double var_x163 = var_x67 * var_x68;
            const double var_x164 = ((var_x71) ? (var_x162 + var_x160 * (-var_x162 - 4.8845531249999998e-9 * var_x163)) : (0.0018285756177517324 * var_x77));
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x174 = 1.3966203749999998e-9 * var_x161;
            const double var_x175 = ((var_x71) ? (var_x174 + var_x160 * (-var_x174 - 1.3966203749999998e-9 * var_x163)) : (0.00052283717663123607 * var_x77));
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x151 = var_x150 * var_x99;
            const double var_x152 = ((var_x101) ? (var_x151 - 374358.83507802623 * (-1.3356169352749131e-6 + var_chaste_interface__cell__V) * (-var_x151 - var_x100 * var_x150)) : (var_x108 * var_chaste_interface__cell__V));
            const double var_x161 = var_x62 * var_x63;
            const double var_x163 = var_x67 * var_x68;
            const double var_x171 = var_x128 * pow(var_x49, 2);
            ...
            const double var_x199 = var_x161 * var_x198;
            const double var_x200 = ((var_x101) ? (var_x199 + (0.5 - 374358.83507802623 * var_chaste_interface__cell__V) * (-var_x199 - var_x163 * var_x198)) : (var_x102 * var_x107 * var_x197 * var_chaste_interface__cell__V));
