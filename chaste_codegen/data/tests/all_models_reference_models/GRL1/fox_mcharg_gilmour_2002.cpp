...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellfox_mcharg_gilmour_2002FromCellMLGRL1::UseCellMLDefaultStimulus()
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellfox_mcharg_gilmour_2002FromCellMLGRL1::Cellfox_mcharg_gilmour_2002FromCellMLGRL1(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellfox_mcharg_gilmour_2002FromCellMLGRL1>::Instance();
        Init();
    ...
    Cellfox_mcharg_gilmour_2002FromCellMLGRL1::~Cellfox_mcharg_gilmour_2002FromCellMLGRL1()
    {
    }

    
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellfox_mcharg_gilmour_2002FromCellMLGRL1::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
    ...
    void Cellfox_mcharg_gilmour_2002FromCellMLGRL1::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        std::vector<double>& rY = rGetStateVariables();
        const double delta = 1e-8;
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
        double d_dt_chaste_interface_var_membrane__V;
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -94.7
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x3 = -mParameters[6];
            const double var_x4 = var_x2 * (var_x3 + var_x1 * mParameters[3]);
            const double var_x5 = -0.34100000000000003 * mParameters[5];
            ...
            const double var_x8 = 7.2262487681097562 * mParameters[8];
            ...
            const double var_x13 = var_x12 < 1.3354093264248706e-6;
            ...
            const double var_x17 = mParameters[8] / var_x16;
            ...
            const double var_x23 = var_x22 * ((var_x13) ? (var_x11 * var_x8 + var_x7 * var_x8) : (var_x18 + 1082.2522540644097 * var_x20 * var_chaste_interface__calcium_dynamics__Ca_i_converted - 1.0822522540644097 * var_x15 * var_x19 * mParameters[8] / pow(var_x16, 2)));
            const double var_x24 = 1.9300000000000002e-5 * mParameters[8];
            const double var_x25 = var_x24 * var_x7;
            const double var_x26 = ((var_x13) ? (var_x25 - 374417.03461708582 * (-1.3354093264248706e-6 + var_chaste_interface__membrane__V) * (-var_x25 - var_x11 * var_x24)) : (var_x18 * var_chaste_interface__membrane__V));
            const double var_x27 = pow((0.26500000000000001 - var_x26), (-2));
            const double var_x28 = 1.4806477500000002e-9 * var_x27;
            const double var_x29 = var_x23 * var_x28;
            const double var_x30 = var_x29 * var_x4;
            const double var_x31 = var_x10 * (var_x3 + var_x9 * mParameters[3]);
            ...
            const double var_x35 = var_x12 < 2.6708186528497411e-6;
            ...
            const double var_x41 = var_x37 * mParameters[3];
            ...
            const double var_x49 = mParameters[17] * var_chaste_interface__transient_outward_potassium_current_Y_to_gate__Y_to;
            const double var_x50 = log(mParameters[6] / mParameters[3]);
            ...
            const double var_x54 = var_x53 * mParameters[10] * var_chaste_interface__fast_sodium_current_j_gate__j;
            const double var_x55 = sqrt(mParameters[6]);
            const double var_x56 = var_x55 * mParameters[14] * var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr;
            ...
            const double var_x61 = mParameters[6];
            const double var_x62 = mParameters[13] / (13.0 + mParameters[6]);
            const double var_x63 = exp(-0.024337107250110578 * var_chaste_interface__membrane__V);
            const double var_x64 = pow(mParameters[7], 3);
            const double var_x65 = var_x63 * var_x64;
            const double var_x66 = pow(mParameters[4], 3) * mParameters[5] * exp(0.013104596211598003 * var_chaste_interface__membrane__V);
            const double var_x67 = 1.0 + 0.20000000000000001 * var_x63;
            const double var_x68 = mParameters[16] / ((1380.0 + mParameters[5]) * (669921.875 + var_x64));
            ...
            const double var_x71 = 1 / mParameters[4];
            const double var_x72 = exp(-0.0037441703461708587 * var_chaste_interface__membrane__V);
            const double var_x73 = exp(0.01485884101040119 * mParameters[7]);
            ...
            partialF = -0.0034841999999999998 - var_x23 - var_x70 - ((var_x35) ? (var_x30 + var_x0 * (-var_x30 - var_x29 * var_x31) + var_x31 * var_x34 + var_x34 * var_x4) : (var_x23 * var_x46 + var_x40 * var_x43 + var_x40 * var_x41 * var_x44 - var_x33 * var_x37 * var_x42 * var_x44 / pow(var_x38, 2))) - 0.0022160000000000001 / var_x48 - 0.0048674214500221162 * var_x76 - var_x49 * var_chaste_interface__transient_outward_potassium_current_X_to_gate__X_to - var_x54 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x56 * var_x59 - pow(var_chaste_interface__slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks, 2) * mParameters[15] - var_x61 * var_x62 / (2.0 + var_x60) - 0.00037056856187290968 * var_x47 * var_x52 / pow(var_x48, 2) + 0.02 * var_x52 * var_x56 * var_x58 / pow((0.40000000000000002 + var_x58), 2) + 0.015163889901991977 * var_x52 * var_x60 * var_x62 * mParameters[6] / pow((1 + 0.5 * var_x60), 2) - 0.69299999999999995 * (0.00046614920809827186 * var_x72 + 0.037441703461708581 * var_x74 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x73)) * mParameters[6] / ((1.0 + 31.622776601683793 * pow(var_x71, 1.5)) * (1.5 + mParameters[6]) * pow((1.0 + 0.1245 * var_x72 + 0.036499999999999998 * var_x74 * (-0.14285714285714285 + 0.14285714285714285 * var_x73)), 2));
        }
        else
        {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x69 = var_x68 / var_x67;
            const double var_x75 = var_x66 - var_x6 * var_x65;
            const double var_x77 = 0.019300000000000001 * mParameters[8];
            const double var_x78 = var_x1 * var_x2 * var_x77;
            const double var_x79 = var_x22 * ((var_x13) ? (var_x78 + (0.5 - 374417.03461708582 * var_chaste_interface__membrane__V) * (-var_x78 - var_x10 * var_x77 * var_x9)) : (14452.497536219513 * var_x20));
            ...
            const double var_x113 = 1000.0 * mParameters[0];
            ...
            const double var_x117 = 2.0480000000000001e-7 * mParameters[2] / (pow(var_x115, 2) * var_x116);
            const double var_x118 = mParameters[1] / (1.0 + 1.6499999999999999 * var_x103);
            const double var_x119 = var_x118 * var_x22;
            const double var_x120 = 1000.0 * var_x119;
            const double var_x121 = (var_x104 + var_chaste_interface__calcium_dynamics__Ca_SR) * mParameters[0];
            const double var_x122 = mParameters[2] / var_x115;
            ...
            partialF = var_x111 * (-var_x112 - var_x113 - var_x117 - var_x120 + 0.001537961789569932 * var_x84 - 0.00015781464648291512 * var_x83 - 61.518471582797282 * var_x85 - 0.03075923579139864 * var_x79) + 4.0000000000000001e-8 * (var_x121 + var_x125 - var_x122 + 0.00015781464648291512 * log(0.001 * var_x83 * mParameters[5]) - 1.1817698391055359e-5 * var_chaste_interface__membrane__V - var_x112 * var_chaste_interface__calcium_dynamics__Ca_i_converted - var_x123 * var_chaste_interface__L_type_Ca_current_f_gate__f + 0.061518471582797281 * var_x69 * var_x75) / (pow(var_x109, 3) * pow(var_x110, 2));
        }
        else
        {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x57 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x130 = 1 / (1.0 - exp(-9.9999999747524276e-8));
            const double var_x131 = 1 / (1.0 - exp(1.0000000045806701e-7));
            const double var_x132 = 47.130000000000003 + var_chaste_interface__membrane__V;
            const double var_x133 = fabs(var_x132) < 1.0000000010279564e-6;
            ...
            const double var_x139 = 3.2000000146581445e-7 * var_x131;
            
            partialF = -((var_x133) ? (-var_x139 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x139 + 3.1999999919207769e-7 * var_x130)) : (var_x132 * var_x137)) - 0.080000000000000002 * var_x138;
        }
        else
        {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x57 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x134 = -var_x57;
            const double var_x140 = var_x134 + 0.10000000000000001 * mParameters[12];
            ...
            const double var_x145 = exp(-11.764705882352942 + 0.14705882352941177 * mParameters[12] - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x146 = 0.13500000000000001 * var_x145;
            
            partialF = -var_x144 - var_x146;
        }
        else
        {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x157 = exp(11.85 + 0.14999999999999999 * var_chaste_interface__membrane__V - 0.14999999999999999 * mParameters[12]);
            const double var_x158 = 1.0 + var_x157;
            const double var_x159 = exp(-4.3478260869565215 + 0.043478260869565216 * mParameters[12] - 0.043478260869565216 * var_chaste_interface__membrane__V);
            const double var_x160 = var_x159 / var_x158;
            const double var_x161 = 0.17499999999999999 * var_x160;
            
            partialF = -var_x156 - var_x161;
        }
        else
        {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x176 = 1 / (-1.0 + exp(1.0000000004755094e-7));
            const double var_x177 = 1 / (-1.0 + exp(-1.0000000004755094e-7));
            const double var_x178 = 1 / (1.0 - exp(2.1542940330476766e-7));
            const double var_x179 = 1 / (1.0 - exp(-2.1542940330476766e-7));
            const double var_x180 = -10.0 + var_chaste_interface__membrane__V;
            const double var_x181 = fabs(var_x180) < 1.4556040763835654e-6;
            ...
            const double var_x188 = 1.0465793309197835e-10 * var_x178;
            const double var_x189 = 1.9068413400624708e-10 * var_x177;
            const double var_x190 = ((var_x181) ? (-var_x188 - var_x189 + 343499.99983666249 * (-9.9999985443959236 + var_chaste_interface__membrane__V) * (var_x188 + var_x189 + 1.0465793309197835e-10 * var_x179 + 1.9068413400624708e-10 * var_x176)) : (var_x180 * var_x184 + var_x180 * var_x187));
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.045159999999999999 * var_x191 - 0.098900000000000002 * var_x192;
        }
        else
        {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0054149999999999997 * var_x199 - 0.0054149999999999997 * var_x200;
        }
        else
        {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x220 = 1 / mParameters[9];
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluateYDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x224 * (-var_x129 - mParameters[0]) + 0.0025839999999999999 * (var_x122 - var_x121 - var_x125) / (pow(var_x221, 3) * pow((0.059999999999999998 + var_x222), 2));
        }
        else
        {
    ...
    std::vector<double> Cellfox_mcharg_gilmour_2002FromCellMLGRL1::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellfox_mcharg_gilmour_2002FromCellMLGRL1>::Initialise(void)
{
