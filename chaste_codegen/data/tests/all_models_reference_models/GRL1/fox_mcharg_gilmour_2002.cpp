...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x16 = exp(-0.024337107250110578 * var_chaste_interface__membrane__V);
            const double var_x17 = pow(mParameters[7], 3);
            const double var_x18 = var_x16 * var_x17;
            const double var_x19 = pow(mParameters[4], 3) * mParameters[5] * exp(0.013104596211598003 * var_chaste_interface__membrane__V);
            ...
            const double var_x32 = exp(0.074883406923417162 * var_chaste_interface__membrane__V);
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x105 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
    ...
    double Cellfox_mcharg_gilmour_2002FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x152 = exp(0.035770000000000003 * var_chaste_interface__membrane__V);
            const double var_x153 = exp(-0.062370000000000002 * var_chaste_interface__membrane__V);
