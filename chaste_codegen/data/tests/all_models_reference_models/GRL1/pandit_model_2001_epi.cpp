...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_background_currents__E_Ca = 0.5 * var_membrane__R * var_membrane__T * log(10) * log10(var_standard_ionic_concentrations__Ca_o / var_chaste_interface__intracellular_ion_concentrations__Ca_i) / var_membrane__F; // millivolt
        ...
        const double var_Ca_independent_transient_outward_K_current__E_K = var_membrane__R * var_membrane__T * log(10) * log10(var_standard_ionic_concentrations__K_o / var_chaste_interface__intracellular_ion_concentrations__K_i) / var_membrane__F; // millivolt
        ...
        const double var_sodium_current__E_Na = var_membrane__R * var_membrane__T * log(10) * log10(var_standard_ionic_concentrations__Na_o / var_chaste_interface__intracellular_ion_concentrations__Na_i) / var_membrane__F; // millivolt
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x8 = log(10);
            const double var_x9 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
            const double var_x10 = var_x8 * log10(5.4000000000000004 * var_x9);
            const double var_x11 = exp(-0.10977188457982838 + 0.06345195640452507 * var_chaste_interface__membrane__V - 1.613 * var_x10);
            const double var_x12 = 1.0 + var_x11;
            const double var_x13 = var_x7 / var_x12;
            const double var_x14 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3);
            ...
            const double var_x22 = var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss;
            const double var_x23 = pow(var_chaste_interface__sodium_current_m_gate__m, 3);
            const double var_x24 = var_x23 * var_chaste_interface__sodium_current_j_gate__j;
            const double var_x25 = var_x24 * var_chaste_interface__sodium_current_h_gate__h;
            const double var_x26 = exp(4.5158823529411762 + 1.4953416461467837 * var_x10 - 0.058823529411764705 * var_chaste_interface__membrane__V);
            const double var_x27 = 1.0 + var_x26;
            const double var_x28 = 0.040000000000000001 * var_chaste_interface__membrane__V;
            const double var_x29 = exp(1.48 + var_x28);
            const double var_x30 = -var_x28;
            const double var_x31 = exp(-1.48 + var_x30);
            const double var_x32 = var_x29 + var_x31;
            const double var_x33 = (0.040000000000000001 * var_x31 - 0.040000000000000001 * var_x29) / (var_x27 * pow(var_x32, 2));
            const double var_x34 = var_x26 * (10.0 + 48.0 / var_x32) / pow(var_x27, 2);
            const double var_x35 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
            const double var_x36 = pow(var_x35, 1.5);
            const double var_x37 = exp(-0.0039337852699643568 * var_chaste_interface__membrane__V);
            const double var_x38 = exp(2.0802377414561666);
            const double var_x39 = exp(-0.039337852699643565 * var_chaste_interface__membrane__V);
            const double var_x40 = 1.0 + 0.1245 * var_x37 + 0.036499999999999998 * var_x39 * (-0.14285714285714285 + 0.14285714285714285 * var_x38);
            const double var_x41 = (0.00048975626611056245 * var_x37 + 0.039337852699643565 * var_x39 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x38)) / (pow(var_x40, 2) * (1.0 + 31.622776601683793 * var_x36));
            const double var_x42 = -25.420807984495319 * var_x10 + var_chaste_interface__membrane__V;
            const double var_x43 = var_x11 * var_x7 * (-1.73 + var_x42) / pow(var_x12, 2);
            const double var_x44 = 1 / mParameters[0];
            const double var_x45 = 0.001 * var_x44;
            
            partialF = var_x45 * (-0.00025054999999999999 + var_x1 + 0.0015228469537086019 * var_x43 - 0.0014499999999999999 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.024 * var_x13 - 0.80000000000000004 * var_x25 - 9.9839999999999996e-6 * var_x21 - 0.0070000000000000001 * var_x22 - 0.0048000000000000004 * var_x33 - 5.8823529411764709e-6 * var_x34 - 0.062608695652173918 * var_x41 + (-0.031 * var_x4 - 0.031 * var_x6) * var_chaste_interface__L_type_Ca_channel_d_gate__d);
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x86 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
            const double var_x87 = 47.130000000000003 + var_chaste_interface__membrane__V;
            
            partialF = -0.058823529411764705 * var_x86 - 0.23529411764705882 * var_x84 * var_x87;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x92 = var_chaste_interface__membrane__V >= -40.0;
            const double var_x93 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
            const double var_x94 = exp(0.34999999999999998 * var_chaste_interface__membrane__V);
            const double var_x95 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x96 = ((var_x92) ? (1 / (0.00045370000000000002 + 0.00045370000000000002 * var_x91)) : (88825214.899713472 * var_x94 + 38.681948424068771 * var_x95 + 1020.0573065902579 * var_x93));
            
            partialF = -0.001 * var_x96;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x81 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x92 = var_chaste_interface__membrane__V >= -40.0;
            const double var_x98 = exp(-3.2000000000000002 + var_x81);
            ...
            const double var_x102 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
            const double var_x103 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x104 = -127140.0 * var_x102 - 3.4740000000000003e-5 * var_x103;
            const double var_x105 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
            const double var_x106 = 1.0 + var_x105;
            const double var_x107 = 286.53295128939828 / var_x106;
            const double var_x108 = var_x104 * var_x107;
            const double var_x109 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x110 = 1.0 + var_x109;
            const double var_x111 = exp(-0.01052 * var_chaste_interface__membrane__V);
            const double var_x112 = var_x111 / var_x110;
            const double var_x113 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x114 = ((var_x92) ? (85.984522785898534 * var_x101) : (34.727793696275072 * var_x112 + var_x108 * var_x113));
            
            partialF = -0.001 * var_x114;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x115 = exp(-0.64800000000000002 * pow((-1 + 0.055555555555555552 * var_chaste_interface__membrane__V), 2));
            const double var_x116 = exp(-0.22049999999999997 * pow((1 + 0.14285714285714285 * var_chaste_interface__membrane__V), 2));
            const double var_x120 = 0.0010499999999999999 * var_x115;
            const double var_x121 = 0.0030500000000000002 * var_x116;
            const double var_x122 = 1 / (0.00025000000000000001 + var_x120 + var_x121);
            
            partialF = -0.001 * var_x122;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x28 = 0.040000000000000001 * var_chaste_interface__membrane__V;
            const double var_x30 = -var_x28;
            const double var_x123 = exp(1.0 + var_x30);
            const double var_x124 = 1.0 + var_x123;
            const double var_x125 = 1 / var_x124;
            const double var_x126 = exp(3.0 + var_x28);
            const double var_x127 = 1.0 + var_x126;
            const double var_x128 = 1 / var_x127;
            const double var_x129 = exp(-14.0625 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2));
            const double var_x134 = 0.105 * var_x129;
            const double var_x135 = 0.0016999999999999999 + 0.014999999999999999 * var_x128;
            const double var_x136 = 1 / (var_x134 + var_x135 + 0.040000000000000001 * var_x125);
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x128 = 1 / var_x127;
            const double var_x135 = 0.0016999999999999999 + 0.014999999999999999 * var_x128;
            const double var_x138 = exp(-11.0 + var_x117);
            const double var_x139 = 1.0 + var_x138;
            const double var_x140 = 1 / var_x139;
            const double var_x141 = exp(-15.340277777777779 * pow((1 + 0.021276595744680851 * var_chaste_interface__membrane__V), 2));
            const double var_x142 = 0.041000000000000002 * var_x141;
            const double var_x143 = 1 / (var_x135 + var_x142 + 0.080000000000000002 * var_x140);
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x81 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x146 = exp(1.7885000000000002 + 0.035770000000000003 * var_chaste_interface__membrane__V);
            const double var_x147 = exp(-3.8000000000000003 + var_x81);
            
            partialF = -0.045159999999999999 * var_x146 - 0.098900000000000002 * var_x147;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x148 = pow((1 + 0.014285714285714285 * var_chaste_interface__membrane__V), 2);
            const double var_x149 = exp(-21.777777777777779 * var_x148);
            const double var_x150 = 1 / (0.035000000000000003 + 0.34999999999999998 * var_x149);
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative10(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x148 = pow((1 + 0.014285714285714285 * var_chaste_interface__membrane__V), 2);
            const double var_x155 = exp(-5.4444444444444446 * var_x148);
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0098900000000000012 * var_x147 - 0.004516 * var_x146;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.00056230000000000006 * var_x163 - 0.00011885 * var_x162;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.67600000000000005 - var_x165;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x39 = exp(-0.039337852699643565 * var_chaste_interface__membrane__V);
            const double var_x40 = 1.0 + 0.1245 * var_x37 + 0.036499999999999998 * var_x39 * (-0.14285714285714285 + 0.14285714285714285 * var_x38);
            const double var_x60 = var_x35 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
            const double var_x61 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2);
            const double var_x62 = 1.2 * var_x18 - 2744000.0 * var_x20;
            const double var_x63 = var_x62 / pow((0.0036443148688046646 + 4.3731778425655972e-7 * var_x14 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
            const double var_x64 = var_x61 * var_x63;
            const double var_x65 = var_x15 * var_x17 * var_x61;
            const double var_x66 = var_x35 * var_x36 / (var_x40 * pow((0.031622776601683791 + var_x36), 2));
            const double var_x67 = var_x25 * var_x35;
            
            partialF = 1.5856796826686865e-16 * var_x64 - 2.2560474246135324e-6 * var_x35 - 1.193943225512245e-7 * var_x65 - 0.022518252522655345 * var_x67 - 8.1628665394625614e-6 * var_x60 - 9.8651233004461501e-6 * var_x66;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative21(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x62 = 1.2 * var_x18 - 2744000.0 * var_x20;
            const double var_x63 = var_x62 / pow((0.0036443148688046646 + 4.3731778425655972e-7 * var_x14 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
            const double var_x68 = 0.00040000000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
            const double var_x69 = 1 / var_x68;
            const double var_x70 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_i;
            const double var_x71 = var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x68, 2);
            const double var_x72 = var_x15 * var_x19;
            const double var_x169 = 40.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa;
            const double var_x171 = 0.00014999999999999999 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
            const double var_x172 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
            const double var_x173 = 1.0 + 0.0014999999999999998 / pow(var_x171, 2) + 0.00011900000000000002 / pow(var_x172, 2);
            ...
            const double var_x178 = 0.0022145492519739826 * var_x69;
            ...
            const double var_x181 = 1 / (1.0 + 33855.471141425078 * var_x179 + 0.303951367781155 * var_x180);
            ...
            const double var_x184 = 1354.2188456570032 * var_x179 - 0.2735562310030395 * var_x180;
            const double var_x185 = var_x184 / pow((2.9537323401073989e-5 + var_x179 + 8.9779098483507565e-6 * var_x180), 2);
            const double var_x186 = var_x182 * var_x185;
            
            partialF = var_x175 * (-30837.453183520603 - var_x178 + 40000.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 200000.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 3.5444788081288787e-5 * var_x186 + 0.0022145492519739826 * var_x71 - 4.0288009715211813e-8 * var_x63 - 0.00022799730679188537 * var_x70 - 30.33500195190371 * var_x72 - 1625.0626147884036 * var_x183) + 0.001 * (0.0029999999999999996 / pow(var_x171, 3) + 0.00023800000000000004 / pow(var_x172, 3)) * (var_x169 + 0.066000000000000003 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 1.7937848940989261e-5 * var_chaste_interface__membrane__V - var_x176 * (0.14000000000000001 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa) - var_x177 * (0.070000000000000007 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa) - var_x178 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 0.00022799730679188537 * var_x8 * log10(1.2 * var_x70) + 1.1055029865854122e-5 * var_x15 * var_x62 - 1.0 * var_x181 * var_x184) / pow(var_x173, 2);
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x42 = -25.420807984495319 * var_x10 + var_chaste_interface__membrane__V;
            const double var_x43 = var_x11 * var_x7 * (-1.73 + var_x42) / pow(var_x12, 2);
            const double var_x73 = var_x9 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
            const double var_x74 = 25.420807984495319 * var_x9;
            const double var_x75 = var_x22 * var_x9;
            const double var_x76 = var_x13 * var_x9;
            const double var_x77 = var_x34 * var_x9;
            const double var_x78 = var_x43 * var_x9;
            const double var_x187 = -3.4336586151856603e-5 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s - 4.4180257576880957e-6 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow;
            const double var_x188 = var_x187 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
            
            partialF = 4.286481532120841e-5 * var_x78 - 3.2651466157850246e-5 * var_x73 - 3.8843985601580465e-6 * var_x9 - 0.00019703470957323427 * var_x75 - 0.00067554757567966038 * var_x76 - 1.6557538619599519e-7 * var_x77 + var_x188 * var_x74;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative23(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x5 = 0.90000000000000002 + var_x2;
            const double var_x6 = var_x5 * var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11;
            const double var_x52 = var_x4 + var_x6;
            ...
            partialF = var_x193 * (-29213.483146067414 - var_x198 - var_x199) + 2.3800000000000004e-7 * (29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 84000.0 * var_x200 - 29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 13.386950228182727 * var_x52 * (-65.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_channel_d_gate__d) / (pow(var_x190, 3) * pow(var_x191, 2));
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative24(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x202 = pow(var_x201, (-2));
            ...
            partialF = var_x204 * (-1740.0382808421784 - var_x206 - var_x207) + 0.00016666666666666666 * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800.0 * var_x200 - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / (pow(var_x201, 3) * pow((0.083333333333333329 + var_x202), 2));
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative25(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.19333758676024207 - 4.9248350664764349e-13 * var_x185 - 0.00050803300043421621 * var_x181;
        }
        else
        {
