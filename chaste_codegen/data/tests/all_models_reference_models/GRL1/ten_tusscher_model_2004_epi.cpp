...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x147 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x219 = exp(-4.0 + var_x147);
            const double var_x220 = 1.0 + var_x219;
            const double var_x221 = 1 / var_x220;
            const double var_x222 = exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2));
            const double var_x225 = 85.0 * var_x222;
            const double var_x226 = 1 / (3.0 + var_x225 + 5.0 * var_x221);
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x229 = exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2));
            const double var_x230 = 1 / (0.80000000000000004 + 9.5 * var_x229);
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x231 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
            const double var_x232 = pow(var_x231, (-2));
            const double var_x233 = 14.994515539305301 / (1.0 + 3.0 * var_x232);
            
            partialF = var_x233 * (-8.0000000000000007e-5 + var_x118 * (var_x117 - var_x116)) + 9.9963436928702016 * (var_x105 + var_x106 - var_x104 - var_x113) / (pow(var_x231, 3) * pow((0.33333333333333337 + var_x232), 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x236 = var_chaste_interface__calcium_dynamics__Ca_i < 0.00035;
            const double var_x237 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6);
            const double var_x238 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16);
            const double var_x239 = (((var_x212) || (var_x235))) && (((var_x212) || (var_x236))) && (((var_x235) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x237)))) && (((var_x236) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x238))));
            
            partialF = ((var_x239) ? (0) : (-0.5));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x240 = 6.3176611368492499e-5 * var_x43;
            
            partialF = 0.00010126109252331096 * var_x95 - 0.0031224512033090025 * var_x94 - 0.0016876848753885161 * var_x90 - 4.5587787568311439e-5 * var_x89 - 0.00076500054481070561 * var_x83 - 0.0031224512033090025 * var_x91 - var_x240 * var_x93;
        }
        else
        {
