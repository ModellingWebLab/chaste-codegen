...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellli_mouse_2010FromCellMLGRL1::EvaluatePartialDerivative31(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x318 = 1 / (1.0 - exp(9.9999999999766942e-8));
            const double var_x319 = 1 / (1.0 - exp(-9.9999999999766942e-8));
            const double var_x320 = 26.5 + var_chaste_interface__cell__V;
            const double var_x321 = fabs(var_x320) < 7.8124999999817923e-7;
            ...
            const double var_x326 = 3.7604140624912359e-12 * var_x319;
            
            partialF = -((var_x321) ? (var_x326 - 640000.00000149151 * (26.499999218749998 + var_chaste_interface__cell__V) * (-var_x326 - 3.7604140624912359e-12 * var_x318)) : (var_x320 * var_x324)) - 9.5333299999999997e-5 * var_x325;
        }
        else
        {
