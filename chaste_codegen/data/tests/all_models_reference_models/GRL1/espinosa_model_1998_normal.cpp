...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -8.0 * var_x233 - 0.001 * ((var_x228) ? (-var_x234 + 499999.99948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (var_x234 + 0.00019999999949504854 * var_x225)) : (var_x227 * var_x232));
        }
        else
        {
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x229 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x235 = exp(-7.5 + var_x229 + 0.10000000000000001 * mParameters[14]);
            const double var_x236 = 1 / (1.0 + 320.0 * var_x235);
            const double var_x237 = 2.0 * var_x236;
            const double var_x238 = exp(-9.375 + 0.125 * mParameters[14] - 0.125 * var_chaste_interface__membrane__V);
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.01 * ((var_x255) ? (var_x259 - 666666.66677085438 * (3.9999992500000001 + var_chaste_interface__membrane__V) * (-var_x259 - 8.9999999985934664e-6 * var_x218)) : (var_x249 * var_x258)) - 0.01 * ((var_x251) ? (-var_x260 + 1666666.6669271358 * (4.0000003 + var_chaste_interface__membrane__V) * (var_x260 + 8.9999999985934664e-6 * var_x248)) : (var_x249 * var_x254));
        }
        else
        {
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.002 * ((var_x264) ? (var_x271 - 909090.91021169221 * (23.999999450000001 + var_chaste_interface__membrane__V) * (-var_x271 - 3.4374999957620389e-6 * var_x262)) : (var_x263 * var_x268)) - 0.024 / var_x270;
        }
        else
        {
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL1::EvaluatePartialDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -8.5800000000000009e-6 * var_x273 - 0.0085800000000000008 / var_x275;
        }
        else
        {
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x278 = mParameters[2] + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            const double var_x279 = 1 / var_x278;
            const double var_x281 = mParameters[3] + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (8.2927354147114598e-7 * var_x164 + 2.8403803471874569e-5 * var_x171 - 0.016878487549164489 * var_x162 - 0.00063182746016849224 * var_x175 - 0.0056807606943749134 * var_x167 - 1.6878487549164488e-6 * var_x156 - var_x297 * var_chaste_interface__extracellular_potassium_concentration__K_o) * mParameters[6];
        }
        else
        {
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (-0.00069999999999999999 + var_x306 - var_x304 + 0.00077398863870640285 * var_x179 + 0.00077398863870640285 * var_x188 + 0.001083584094188964 * var_x180 - 8.2704588990905987e-5 * var_x176 - 7.7398863870640281e-6 * var_x184 - var_x176 * var_x305 - var_x30 * var_x303 - var_x302 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * mParameters[6];
        }
        else
        {
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (-var_x309 - 6.7513950196657958e-5 * var_x5 - 0.00063182746016849224 * var_x190 + var_x311 * var_x6 - var_x308 * var_x6 - var_x310 * var_x5) * mParameters[6];
        }
        else
        {
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL1::EvaluatePartialDerivative19(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.050000000000000003 + var_x313;
        }
        else
        {
    ...
    double Cellespinosa_model_1998_normalFromCellMLGRL1::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.20000000000000001 + var_x313;
        }
        else
        {
