...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x69 = 1 / (1.0 + mParameters[2]);
            ...
            const double var_x74 = var_x69 * var_x70 * (0.14447610163038616 * var_x13 * var_x72 + 0.40963906727330363 * var_x13 * var_x71) * mParameters[2] * var_chaste_interface__sodium_dynamics__Nai / pow(var_x73, 2);
            
            partialF = -0.00159264 - var_x29 - 4900.0 * var_x45 - 0.001 * var_x35 - 3696.035210383774 * var_x68 - 1.8414239999999999 * var_x74 - var_x46 * var_x48 - 0.001 * mParameters[6] * var_chaste_interface__i_f_Xf_gate__Xf - 0.0016825960981856666 * var_x52 * var_x61 - 0.00043033148291193521 * var_x62 * var_chaste_interface__i_Kr_Xr1_gate__Xr1 + 0.99979860154192302 * var_x61 * var_x65 * var_x66 - 0.001 * mParameters[10] * var_chaste_interface__i_to_q_gate__q * var_chaste_interface__i_to_r_gate__r - 0.11005920279077626 * var_x52 * var_x60 * var_x65 * (2.3233220000000001 * var_x66 - var_x55 * (0.58860000000000001 * var_x57 - 0.00030180000000000002 * var_x56) + 0.45469999999999999 * var_x53 * var_x58 / pow(var_x54, 2)) * mParameters[7] / pow((var_x52 + 0.25575447570332482 * var_x59), 2);
        }
        else
        {
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x113 = var_x69 * mParameters[2] / var_x73;
    ...
    double Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x274 * (-0.00044443999999999999 + var_x132 * (var_x139 - var_x138)) + 0.010050308647262718 * (var_x125 + var_x126 - var_x124 - var_x133) / (pow(var_x272, 3) * pow((0.33333333333333337 + var_x273), 2));
        }
        else
        {
