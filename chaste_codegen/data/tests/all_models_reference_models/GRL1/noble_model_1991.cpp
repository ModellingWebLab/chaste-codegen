...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnoble_model_1991FromCellMLGRL1::GetIntracellularCalciumConcentration()
    {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x31 = var_x28 * (var_x30 - var_x27 * mParameters[5]);
            ...
            const double var_x37 = var_x36 * (var_x30 - var_x35 * mParameters[5]);
            ...
            const double var_x45 = var_x41 * mParameters[5];
            ...
            const double var_x61 = var_x57 * mParameters[7];
            ...
            const double var_x68 = var_x28 * (var_x67 - var_x27 * mParameters[6]);
            const double var_x69 = 3.743389082274547e-5 * var_x33;
            const double var_x70 = var_x36 * (var_x67 - var_x35 * mParameters[6]);
            const double var_x71 = var_x57 * mParameters[6];
            ...
            const double var_x75 = 1 / mParameters[9];
            const double var_x76 = 0.001 * var_x75;
            
            partialF = -var_x76 * (0.0014499999999999999 + var_x1 + var_x19 + var_x50 + var_x66 + var_x74 + var_x10 + var_x8 + 0.00026738493444818193 * var_x23 - 0.074867781645490947 * var_x26);
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x78 = (var_x6 - var_x4) * mParameters[15] / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
            ...
            partialF = -7.0 + var_x135 + var_x136 - 1.0549054718227806e-6 * var_x77 - 4.3596094751625959e-6 * var_x78 - 0.00031591373008424612 * var_x86 - 0.00063182746016849224 * var_x79 + (0.00040000000000000002 * var_x140 - 0.00040000000000000002 * var_x138 - 7.1999999999999991e-9 * var_x141) * mParameters[3];
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.00050000000000000001 * var_x158 - 0.0012999999999999999 * var_x153;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -8.0 * var_x167 - 0.001 * ((var_x162) ? (-var_x168 + 499999.99948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (var_x168 + 0.00019999999949504854 * var_x159)) : (var_x161 * var_x166));
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x163 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x169 = exp(-7.5 + var_x163 + 0.10000000000000001 * mParameters[13]);
            ...
            const double var_x173 = exp(-9.375 + var_x172 + 0.125 * mParameters[13]);
            const double var_x174 = 0.02 * var_x173;
            
            partialF = -var_x171 - var_x174;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0030000000000000001 * ((var_x194) ? (var_x198 - 499999.99948602181 * (18.999998999999999 + var_chaste_interface__membrane__V) * (-var_x198 - 1.2000000012335477e-5 * var_x193)) : (var_x184 * var_x197)) - 0.0030000000000000001 * ((var_x186) ? (-var_x199 + 1249999.9964946085 * (19.000000400000001 + var_chaste_interface__membrane__V) * (var_x199 + 1.2000000033651759e-5 * var_x183)) : (var_x184 * var_x191));
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.025000000000000001 / var_x205 - var_x203 * var_x206;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.033000000000000002 / var_x209 - 3.3000000000000003e-5 * var_x207;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x211 = mParameters[2] + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            ...
            partialF = -0.059999999999999998 - var_x213 * var_x215;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x120 = mParameters[6] / (1.0 + mParameters[6]);
            ...
            partialF = (8.2927354147114598e-7 * var_x123 - 0.00063182746016849224 * var_x128 - 1.0127092529498693e-5 * var_x119 - 0.0013268376663538336 * var_x121 - 0.016878487549164489 * var_x122 - 0.0056864471415164304 * var_x124) * mParameters[4];
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (0.0012636549203369845 * var_x131 - 4.5130532869178019e-6 * var_x22 - 0.00063182746016849224 * var_x134 - 1.0127092529498693e-5 * var_x12 - 0.016878487549164489 * var_x129 - 0.016878487549164489 * var_x130) * mParameters[4];
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.050000000000000003 + (8.4671999999999982e-11 * var_x141 - 4.7039999999999993e-6 * var_x140 - 3.5279999999999993e-7 * var_x138) * mParameters[3];
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x148 = var_x144 * var_x146 * mParameters[1];
            
            partialF = -0.0050000000000000001 - 0.001 * var_x148 - 0.001 * mParameters[0];
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.050000000000000003 + var_x222;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.20000000000000001 + var_x222;
        }
        else
        {
