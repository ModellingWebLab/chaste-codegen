...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x14 = var_x8 * (037433890822745473 * var_x11 + 51359.298208806787 * var_x13);
            ...
            const double var_x16 = -037433890822745473 * var_chaste_interface__membrane__V;
            ...
            const double var_x27 = 037433890822745473 * var_x26;
            ...
            const double var_x35 = -140 * var_x28 + var_x32 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
            const double var_x36 = 9.3584727056863679e-5 * var_x35;
            const double var_x37 = -50 + var_chaste_interface__membrane__V;
            ...
            const double var_x48 = 001 * var_x47;
            
            partialF = -var_x48 * (0014499999999999999 + 2.5 * var_x7 + 00050000000000000001 * var_x14 + 0050000000000000001 * var_x15 + 0056051847285169109 * var_x40 + 0010695397377927277 * var_x18 + 00049325625610948819 * var_x42 + 0.2857142857142857 * var_x5 - 0028025923642584554 * var_x43 - 021390794755854554 * var_x19 - 7.0064809106461387e-7 * var_x45 - 3.503240455323069e-6 * var_x46 + var_x20 * var_x27 + var_x31 * var_x34 + var_x31 * var_x36);
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x71 = exp(-0.80000000000000004 - 040000000000000001 * var_chaste_interface__membrane__V);
            const double var_x72 = 1.0 + var_x71;
            const double var_x73 = exp(-1.2 - 059999999999999998 * var_chaste_interface__membrane__V);
            const double var_x74 = var_x73 / var_x72;
            const double var_x76 = exp(2.8500000000000001 + 057000000000000002 * var_chaste_interface__membrane__V);
            const double var_x77 = 1.0 + var_x76;
            const double var_x78 = exp(4.1300000000000008 + 082600000000000007 * var_chaste_interface__membrane__V);
            const double var_x79 = var_x78 / var_x77;
            
            partialF = -00050000000000000001 * var_x79 - 0013000000000000002 * var_x74;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x85 = 200 / var_x84;
            const double var_x86 = exp(-3.6960000000000002 - 056000000000000001 * var_chaste_interface__membrane__V);
            
            partialF = -001 * ((var_x81) ? (2000) : (var_x80 * var_x85)) - 8.0 * var_x86;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -02 * var_x88 - 2.0 / (1.0 + 320 * var_x89);
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x92 = fabs(var_x91) < 0001;
            ...
            const double var_x97 = 30 / var_x96;
            ...
            partialF = -0030000000000000001 * ((var_x92) ? (120) : (var_x100 * var_x91)) - 0030000000000000001 * ((var_x92) ? (120) : (var_x91 * var_x97));
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x102 = fabs(var_x101) < 0001;
            ...
            partialF = -00050000000000000001 * ((var_x102) ? (25.0) : (var_x101 * var_x105)) - 025000000000000001 / var_x107;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x87 = -0.125 * var_chaste_interface__membrane__V;
            const double var_x108 = exp(-058823529411764705 * var_chaste_interface__membrane__V);
            const double var_x109 = exp(-1.25 + var_x87);
            const double var_x110 = 1.0 + var_x109;
            
            partialF = -033000000000000002 / var_x110 - 3.3000000000000003e-5 * var_x108;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x112 = 00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            ...
            partialF = -059999999999999998 - 1.0 * var_x115;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative10(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x58 = 1 / (40 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
            const double var_x59 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
            const double var_x60 = var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
            const double var_x61 = var_x10 * var_x8 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
            const double var_x62 = var_x7 * (00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) / pow(var_x49, 2);
            const double var_x63 = var_x32 * var_x41;
            
            partialF = 6.634188331769168e-7 * var_x60 - 1.0127092529498693e-5 * var_x59 - 5.9129400406899753e-8 * var_x63 - 0010614701330830668 * var_x58 - 5.9277248272665686 * var_x62 - 5.6864471415164302e-6 * var_x61;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 00036104426295342415 * var_x66 - 004822425014046997 * var_x64 - 1.0127092529498693e-5 * var_x1 - 4.5130532869178019e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 8.4392437745822447e-5 * var_x65 - 1.1825880081379952e-8 * var_x63;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x69 = (2.0 * var_x11 - 2744000 * var_x13) / pow((0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
            const double var_x70 = var_x24 * var_x39;
            const double var_x130 = 100 * var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod;
            const double var_x131 = 100 * var_chaste_interface__intracellular_calcium_concentration__Ca_Trop;
            const double var_x132 = 00041999999999999996 + 00023999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_up + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            ...
            partialF = -7.0000000000000009 + var_x130 + var_x131 + 00040000000000000002 * var_x135 - 0.86686727535117136 * var_x68 - 1.1825880081379951e-5 * var_x70 - 7.2e-9 * var_x136 - 1.0549054718227806e-6 * var_x67 - 2.1798047375812981e-9 * var_x69 - 00040000000000000002 * var_x133;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -050000000000000003 + 8.4671999999999982e-11 * var_x136 - 3.5279999999999993e-7 * var_x133 - 4.7040000000000002e-6 * var_x135;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0050000000000000001 - 0.25 * var_x137;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x138 = 100 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            const double var_x140 = -var_x138;
            
            partialF = -050000000000000003 + var_x140;
        }
        else
        {
