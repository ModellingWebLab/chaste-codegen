...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmahajan_2008FromCellMLGRL1::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        ...
        const double var_IKr__xkrv1 = ((fabs(7.0 + var_chaste_interface__cell__V) > 001) ? (0013799999999999999 * (7.0 + var_chaste_interface__cell__V) / (1.0 - exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V))) : (011219512195121951)); // per_ms
        const double var_IKr__xkrv2 = ((fabs(10 + var_chaste_interface__cell__V) > 001) ? (00060999999999999997 * (10 + var_chaste_interface__cell__V) / (-1.0 + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V))) : (0042068965517241376)); // per_ms
        ...
        const double var_Ito__rt4 = -0011111111111111111 * pow(var_chaste_interface__cell__V, 2); // dimensionless
        ...
        const double var_Ito__tyf = 20 + 20 / (1.0 + exp(var_Ito__rt5)); // ms
        const double var_Ito__tys = 30 + 3000 / (1.0 + exp(var_Ito__rt3)); // ms
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x99 = 0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x100 = 012999999999999999 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x101 = 00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x102 = 00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
            const double var_x103 = 1.0 + 00016799999999999999 / pow(var_x99, 2) + 00054599999999999994 / pow(var_x100, 2) + 4.4999999999999993e-6 / pow(var_x101, 2) + 2.8199999999999998e-5 / pow(var_x102, 2);
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x118 = fabs(var_x117) > 001;
            const double var_x119 = exp(-090909090909090912 * var_chaste_interface__cell__V);
            
            partialF = -((var_x118) ? (var_x116 * var_x117) : (3.2000000000000002)) - 080000000000000002 * var_x119;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x121 = var_chaste_interface__cell__V < -40;
            const double var_x122 = exp(079000000000000001 * var_chaste_interface__cell__V);
            const double var_x123 = exp(0.34999999999999998 * var_chaste_interface__cell__V);
            const double var_x124 = exp(-0.96036036036036043 - 0900900900900901 * var_chaste_interface__cell__V);
            const double var_x125 = 1.0 + var_x124;
            
            partialF = -((var_x121) ? (0.13500000000000001 * var_x120) : (0)) - ((var_x121) ? (310000 * var_x123 + 3.5600000000000001 * var_x122) : (7.6923076923076916 / var_x125));
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x127 = exp(-043909999999999998 * var_chaste_interface__cell__V);
            const double var_x128 = -127140 * var_x126 - 3.4740000000000003e-5 * var_x127;
            ...
            const double var_x136 = exp(-01052 * var_chaste_interface__cell__V);
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -4.3041299999999998 + var_x148 - 024167999999999999 * var_x151;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x156 = exp(-10 - 0.25 * var_chaste_interface__cell__V);
            const double var_x157 = 1.0 + var_x156;
            const double var_x158 = 1.0 - 1.0 / var_x157;
            const double var_x159 = exp(064102564102564111 * var_chaste_interface__cell__V);
            const double var_x160 = 4954.0 * var_x159;
            const double var_x161 = -440 + var_x160;
            const double var_x162 = var_x158 * var_x161;
            const double var_x163 = 1 / (450 + var_x162);
            const double var_x164 = exp(-3.5335689045936394 - 088339222614840993 * var_chaste_interface__cell__V);
            const double var_x165 = 1.0 + var_x164;
            const double var_x168 = 1 / var_x165;
            const double var_x173 = 1.0 + 00072525373756441506 * var_x152;
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x218 = -018268800000000002 * var_x151;
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x239 = 00060999999999999997 / var_x238;
            const double var_x240 = 10 + var_chaste_interface__cell__V;
            const double var_x241 = fabs(var_x240) > 001;
            const double var_x242 = exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V);
            const double var_x243 = 1.0 - var_x242;
            const double var_x244 = 0013799999999999999 / var_x243;
            const double var_x245 = 7.0 + var_chaste_interface__cell__V;
            const double var_x246 = fabs(var_x245) > 001;
            const double var_x247 = 1.0 * ((var_x241) ? (var_x239 * var_x240) : (0042068965517241376));
            const double var_x248 = 1.0 * ((var_x246) ? (var_x244 * var_x245) : (011219512195121951));
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x252 = 30 + var_chaste_interface__cell__V;
            const double var_x253 = fabs(var_x252) < 014556040756914121;
            const double var_x254 = exp(2.0609999999999999 + 068699999999999997 * var_chaste_interface__cell__V);
            const double var_x255 = -1.0 + var_x254;
            const double var_x256 = 00013100000000000001 / var_x255;
            ...
            const double var_x261 = ((var_x253) ? (0023926521499665608) : (var_x252 * var_x256 + var_x252 * var_x259));
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x263 = 066666666666666666 * var_chaste_interface__cell__V;
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x275 = 1 / (30 + 3000 * var_x274);
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x278 = exp(-0011111111111111111 * pow(var_chaste_interface__cell__V, 2));
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative17(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x13 = 1.0 + var_x12;
            const double var_x14 = 1 / var_x13;
            const double var_x280 = 1 / (20 + 20 * var_x14);
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative19(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -033333333333333333 - var_x300 + var_x299 * var_x303;
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative22(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x315 = (-50 + 50 * var_chaste_interface__ICaL__c1 + 50 * var_chaste_interface__ICaL__c2 + 50 * var_chaste_interface__ICaL__xi1ba + 50 * var_chaste_interface__ICaL__xi1ca + 50 * var_chaste_interface__ICaL__xi2ba + 50 * var_chaste_interface__ICaL__xi2ca) * mParameters[3];
            const double var_x316 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_submem;
            const double var_x317 = pow(var_x316, (-2));
            const double var_x318 = 1 + 076923076923076927 * var_chaste_interface__Ca__Ca_submem;
            ...
            const double var_x328 = 0327 * var_chaste_interface__Ca__trops;
            const double var_x329 = 0327 * var_chaste_interface__Ca__Ca_submem;
            
            partialF = var_x325 * (-14.789 + var_x328 + 3.4019999999999997 * var_x89 - 0011233033614805057 * var_x83 - 105649.152 * var_x88 + var_x315 * var_x87) + 0012574820180071425 * (9.0 / pow(var_x316, 3) + 56.399999999999999 / pow(var_x320, 3) + 0.97959183673469385 / pow(var_x322, 3) + 0.49704142011834318 / pow(var_x318, 3)) * (50 * var_chaste_interface__Irel__xir + 12500 * var_chaste_interface__Ca__Ca_i_converted + 019599999999999999 * var_chaste_interface__Ca__trops - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x329 * (70 - var_chaste_interface__Ca__trops) + 42.0 * var_x48 * var_x60 - 50 * var_x223 * var_x76) / pow((035460992907801421 + var_x321 + 0.15957446808510639 * var_x317 + 0.12158054711246201 * var_x323 + 0.11456628477905074 * var_x319), 2);
        }
        else
        {
    ...
    double Cellmahajan_2008FromCellMLGRL1::EvaluatePartialDerivative25(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -019599999999999999 - var_x329;
        }
        else
        {
