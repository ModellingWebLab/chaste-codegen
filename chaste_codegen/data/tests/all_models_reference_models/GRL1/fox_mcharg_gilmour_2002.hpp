#ifndef CELLFOX_MCHARG_GILMOUR_2002FROMCELLMLGRL1_HPP_
#define CELLFOX_MCHARG_GILMOUR_2002FROMCELLMLGRL1_HPP_
...
class Cellfox_mcharg_gilmour_2002FromCellMLGRL1 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellfox_mcharg_gilmour_2002FromCellMLGRL1(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellfox_mcharg_gilmour_2002FromCellMLGRL1();
...
CHASTE_CLASS_EXPORT(Cellfox_mcharg_gilmour_2002FromCellMLGRL1)
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellfox_mcharg_gilmour_2002FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellfox_mcharg_gilmour_2002FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellfox_mcharg_gilmour_2002FromCellMLGRL1(p_solver, p_stimulus);
        }
...
#endif // CELLFOX_MCHARG_GILMOUR_2002FROMCELLMLGRL1_HPP_