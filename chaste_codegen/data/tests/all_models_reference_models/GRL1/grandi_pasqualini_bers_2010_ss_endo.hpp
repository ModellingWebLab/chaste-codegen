#ifndef CELLGRANDI_PASQUALINI_BERS_2010_SS_ENDOFROMCELLMLGRL1_HPP_
#define CELLGRANDI_PASQUALINI_BERS_2010_SS_ENDOFROMCELLMLGRL1_HPP_
...
class Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLGRL1 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLGRL1(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLGRL1();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLGRL1 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLGRL1 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellgrandi_pasqualini_bers_2010_ss_endoFromCellMLGRL1(p_solver, p_stimulus);
        }
...
#endif // CELLGRANDI_PASQUALINI_BERS_2010_SS_ENDOFROMCELLMLGRL1_HPP_