...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 00010126109252331096 * var_x93 - 0073440052301827737 * var_x85 - 0031224512033090025 * var_x92 - 0016876848753885161 * var_x88 - 4.5587787568311439e-5 * var_x87 - 0031224512033090025 * var_x89 - var_x233 * var_x91;
        }
        else
        {
