...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2004_endoFromCellMLGRL1::UseCellMLDefaultStimulus()
    {
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x227 = 1 / mParameters[8];
            
            partialF = ((var_x226) ? (0) : (-var_x227));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x238 * (var_x108 + var_x124 * (var_x122 - var_x123)) + 9.9963436928702016 * (var_x112 - var_x111 - var_x119) / (pow(var_x236, 3) * pow((0.33333333333333337 + var_x237), 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x245 = mParameters[12] * mParameters[3];
            
            partialF = var_x245 * (1.1846503119326294e-6 * var_x93 - 0.0018954404990922068 * var_x90 - 0.016878114612481093 * var_x87 - 0.016878114612481093 * var_x92 - 0.0056863214972766203 * var_x94);
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x245 * (4.357910453967955e-5 * var_x102 - 0.016878114612481093 * var_x88 - 0.016878114612481093 * var_x95 - 0.016878114612481093 * var_x96 - 0.00072631840899465921 * var_x97 - 0.0072631840899465916 * var_x99 - var_x101 * var_x248);
        }
        else
        {
