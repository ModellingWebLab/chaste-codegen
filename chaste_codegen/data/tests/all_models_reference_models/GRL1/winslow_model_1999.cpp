...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellwinslow_model_1999FromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_current__i_Ca_max = ((fabs(var_chaste_interface__membrane__V) < 1.3356880329847825e-6) ? (-374338.9082274547 * (-1.3356880329847825e-6 + var_chaste_interface__membrane__V) * (-0.019297068300000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * mParameters[3]) * mParameters[6] / (-1.0 + exp(1.0000000000000001e-7)) - 0.019297068300000001 * (0.001 * exp(-1.0000000000000001e-7) - 0.34100000000000003 * mParameters[3]) * mParameters[6] / (-1.0 + exp(-1.0000000000000001e-7))) + 0.019297068300000001 * (0.001 * exp(1.0000000000000001e-7) - 0.34100000000000003 * mParameters[3]) * mParameters[6] / (-1.0 + exp(1.0000000000000001e-7))) : (14447.286958825252 * (0.001 * exp(0.074867781645490947 * var_chaste_interface__membrane__V) - 0.34100000000000003 * mParameters[3]) * mParameters[6] * var_chaste_interface__membrane__V / (-1.0 + exp(0.074867781645490947 * var_chaste_interface__membrane__V)))); // microA_per_microF
        ...
        const double var_L_type_Ca_current__i_Ca_K = ((fabs(var_chaste_interface__membrane__V) < 2.671376065969565e-6) ? (-187169.45411372735 * (-2.671376065969565e-6 + var_chaste_interface__membrane__V) * (-5.5865012728500001e-12 * (-mParameters[4] + var_chaste_interface__intracellular_ion_concentrations__Ki * exp(1.0000000000000001e-7)) * (var_chaste_interface__L_type_Ca_current__O + var_chaste_interface__L_type_Ca_current__O_Ca) * var_chaste_interface__L_type_Ca_current_y_gate__y / ((1.0 - 3.773584905660377 * var_L_type_Ca_current__i_Ca_max) * (-1.0 + exp(1.0000000000000001e-7))) - 5.5865012728500001e-12 * (-mParameters[4] + var_chaste_interface__intracellular_ion_concentrations__Ki * exp(-1.0000000000000001e-7)) * (var_chaste_interface__L_type_Ca_current__O + var_chaste_interface__L_type_Ca_current__O_Ca) * var_chaste_interface__L_type_Ca_current_y_gate__y / ((1.0 - 3.773584905660377 * var_L_type_Ca_current__i_Ca_max) * (-1.0 + exp(-1.0000000000000001e-7)))) + 5.5865012728500001e-12 * (-mParameters[4] + var_chaste_interface__intracellular_ion_concentrations__Ki * exp(1.0000000000000001e-7)) * (var_chaste_interface__L_type_Ca_current__O + var_chaste_interface__L_type_Ca_current__O_Ca) * var_chaste_interface__L_type_Ca_current_y_gate__y / ((1.0 - 3.773584905660377 * var_L_type_Ca_current__i_Ca_max) * (-1.0 + exp(1.0000000000000001e-7)))) : (2.0912447872899554e-6 * (-mParameters[4] + var_chaste_interface__intracellular_ion_concentrations__Ki * exp(0.037433890822745473 * var_chaste_interface__membrane__V)) * (var_chaste_interface__L_type_Ca_current__O + var_chaste_interface__L_type_Ca_current__O_Ca) * var_chaste_interface__L_type_Ca_current_y_gate__y * var_chaste_interface__membrane__V / ((1.0 - 3.773584905660377 * var_L_type_Ca_current__i_Ca_max) * (-1.0 + exp(0.037433890822745473 * var_chaste_interface__membrane__V))))); // microA_per_microF
    ...
    void Cellwinslow_model_1999FromCellMLGRL1::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_slow_activating_delayed_rectifiyer_K_current_X_ks_gate__tau_X_ks = 0.001 * ((fabs(-10.0 + var_chaste_interface__membrane__V) < 1.4556040763835654e-6) ? (1 / (-1.0465793309197835e-10 / (1.0 - exp(2.1542940330476766e-7)) - 1.9068413400624708e-10 / (-1.0 + exp(-1.0000000004755094e-7)) + 343499.99983666249 * (-9.9999985443959236 + var_chaste_interface__membrane__V) * (1.0465793309197835e-10 / (1.0 - exp(2.1542940330476766e-7)) + 1.0465793309197835e-10 / (1.0 - exp(-2.1542940330476766e-7)) + 1.9068413400624708e-10 / (-1.0 + exp(1.0000000004755094e-7)) + 1.9068413400624708e-10 / (-1.0 + exp(-1.0000000004755094e-7))))) : (1 / (0.00013100000000000001 * (-10.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-0.68699999999999994 + 0.068699999999999997 * var_chaste_interface__membrane__V)) + 7.1899999999999999e-5 * (-10.0 + var_chaste_interface__membrane__V) / (1.0 - exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V))))); // second
    ...
    double Cellwinslow_model_1999FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x10 = exp(-1.0000000000000001e-7);
            ...
            const double var_x65 = 0.5 - 187169.45411372735 * var_chaste_interface__membrane__V;
            ...
            const double var_x69 = var_x68 * var_x9;
            const double var_x70 = ((var_x14) ? (var_x69 - 374338.9082274547 * (-1.3356880329847825e-6 + var_chaste_interface__membrane__V) * (-var_x69 - var_x12 * var_x68)) : (var_x19 * var_chaste_interface__membrane__V));
            const double var_x71 = var_x22 / pow((0.26500000000000001 - var_x70), 2);
            const double var_x72 = 1.4804228373052501e-12 * var_x71;
            const double var_x73 = var_x67 * var_x72;
            const double var_x74 = var_x11 * (var_x66 + var_x10 * var_chaste_interface__intracellular_ion_concentrations__Ki);
            ...
            const double var_x88 = ((var_x79) ? (var_x73 + var_x65 * (-var_x73 - var_x72 * var_x74) + var_x67 * var_x78 + var_x74 * var_x78) : (var_x77 * var_x86 + 7.8283429051047759e-8 * var_x83 * var_x87 + 5.5417986863183814e-7 * var_x71 * var_x85 * var_chaste_interface__membrane__V - 7.8283429051047759e-8 * var_x77 * var_x80 * var_x84 * var_chaste_interface__membrane__V / pow(var_x81, 2)));
    ...
    double Cellwinslow_model_1999FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x144 = 1 / (1.0 - exp(-9.9999999747524276e-8));
            const double var_x145 = 1 / (1.0 - exp(1.0000000045806701e-7));
            const double var_x146 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
            const double var_x148 = (var_chaste_interface__membrane__V > -47.130001000000007) && (var_chaste_interface__membrane__V < -47.129998999999998);
            ...
            const double var_x155 = 0.00032000000146581442 * var_x145;
            const double var_x156 = -80.0 * var_x146;
            
            partialF = 0.001 * ((var_x148) ? (var_x155 + var_x156 - 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x155 + 0.00031999999919207767 * var_x144)) : ((var_x154) ? (var_x156 - var_x152 * var_x153) : (0)));
        }
        else
        {
    ...
    double Cellwinslow_model_1999FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x206 = 1 / (1.0 - exp(2.1542940330476766e-7));
            const double var_x207 = 1 / (1.0 - exp(-2.1542940330476766e-7));
            const double var_x208 = 1 / (-1.0 + exp(1.0000000004755094e-7));
            const double var_x209 = 1 / (-1.0 + exp(-1.0000000004755094e-7));
            const double var_x210 = -10.0 + var_chaste_interface__membrane__V;
            const double var_x211 = fabs(var_x210) < 1.4556040763835654e-6;
            ...
            const double var_x218 = ((var_x211) ? (-1.9068413400624708e-7 * var_x209 - 1.0465793309197835e-7 * var_x206 + 343499999.83666253 * (-9.9999985443959236 + var_chaste_interface__membrane__V) * (1.0465793309197835e-10 * var_x206 + 1.0465793309197835e-10 * var_x207 + 1.9068413400624708e-10 * var_x208 + 1.9068413400624708e-10 * var_x209)) : (var_x210 * var_x214 + var_x210 * var_x217));
    ...
    double Cellwinslow_model_1999FromCellMLGRL1::EvaluatePartialDerivative29(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x126 = var_x125 * var_x6 * var_x7;
            const double var_x127 = ((var_x79) ? (var_x126 + var_x65 * (-var_x126 - var_x10 * var_x11 * var_x125)) : (2.0912447872899554e-6 * var_x80 * var_x87));
