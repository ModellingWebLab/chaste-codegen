...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.001 * ((var_x152) ? (var_x156 + 394539.57230297127 * (44.400001267299999 + var_chaste_interface__membrane__V) * (-var_x156 - 0.00058295800002383658 * var_x150)) : (-var_x151 * var_x155)) - 18.399999999999999 * var_x153;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.001 * var_x196 - 0.001 * var_x199;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x217 - 0.067921999999999996 * var_x212;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 0.0022916155659426776 * var_x124 - 0.043659884291485852 * var_x123 + var_x122 * var_x270 - var_x25 * var_x278 - var_x25 * var_x279;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.47599999999999998 + var_x281;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 0.011549742452351092 * var_x133 + 0.00085446536839159674 * var_x132 - 0.00085446536839159674 * var_x126 - 0.22004581682908866 * var_x129 + var_x129 * var_x288 - var_x125 * var_x286 - var_x125 * var_x287 - var_x127 * var_x283 - var_x131 * var_x288;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1::EvaluatePartialDerivative23(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -14.98 - var_x289 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse;
        }
        else
        {
    ...
    double Cellaslanidi_atrial_model_2009FromCellMLGRL1::EvaluatePartialDerivative27(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.033960000000000004 - var_x305;
        }
        else
        {
