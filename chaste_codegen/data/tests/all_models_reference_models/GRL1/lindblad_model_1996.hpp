#ifndef CELLLINDBLAD_MODEL_1996FROMCELLMLGRL1_HPP_
#define CELLLINDBLAD_MODEL_1996FROMCELLMLGRL1_HPP_
...
class Celllindblad_model_1996FromCellMLGRL1 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Celllindblad_model_1996FromCellMLGRL1(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Celllindblad_model_1996FromCellMLGRL1();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Celllindblad_model_1996FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Celllindblad_model_1996FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Celllindblad_model_1996FromCellMLGRL1(p_solver, p_stimulus);
        }
...
#endif // CELLLINDBLAD_MODEL_1996FROMCELLMLGRL1_HPP_