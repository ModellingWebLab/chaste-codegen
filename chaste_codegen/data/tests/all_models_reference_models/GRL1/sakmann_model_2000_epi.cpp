...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellsakmann_model_2000_epiFromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -8.0 * var_x219 - 0.001 * ((var_x214) ? (-var_x220 + 499999.99948602181 * (41.000001000000005 + var_chaste_interface__membrane__V) * (var_x220 + 0.00019999999949504854 * var_x211)) : (var_x213 * var_x218));
        }
        else
        {
    ...
    double Cellsakmann_model_2000_epiFromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -2.0 / (1.0 + 320.0 * var_x223) - 0.02 * var_x222;
        }
        else
        {
    ...
    double Cellsakmann_model_2000_epiFromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0030000000000000001 * ((var_x235) ? (var_x239 - 277777.77782118932 * (18.9999982 + var_chaste_interface__membrane__V) * (-var_x239 - 2.1599999996624319e-5 * var_x234)) : (var_x227 * var_x238)) - 0.0030000000000000001 * ((var_x229) ? (-var_x240 + 694444.44523829618 * (19.000000719999999 + var_chaste_interface__membrane__V) * (var_x240 + 2.1599999975308037e-5 * var_x226)) : (var_x227 * var_x232));
        }
        else
        {
    ...
    double Cellsakmann_model_2000_epiFromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.00029999999999999997 * ((var_x244) ? (var_x251 - 980392.15769891371 * (33.99999949 + var_chaste_interface__membrane__V) * (-var_x251 - 3.1874999972814066e-6 * var_x242)) : (var_x243 * var_x248)) - 0.0035999999999999999 / var_x250;
        }
        else
        {
    ...
    double Cellsakmann_model_2000_epiFromCellMLGRL1::EvaluatePartialDerivative10(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.033000000000000002 / var_x255 - 3.3000000000000003e-5 * var_x253;
        }
        else
        {
    ...
    double Cellsakmann_model_2000_epiFromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x273 + var_x264 * (-0.059999999999999998 - var_x272);
        }
        else
        {
    ...
    double Cellsakmann_model_2000_epiFromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 8.2927354147114598e-7 * var_x148 - 6.8169128332498961e-7 * var_x147 - 0.33764393503417345 * var_x149 - 0.00063182746016849224 * var_x153 - 1.0127092529498691e-5 * var_x142 - 0.0013268376663538336 * var_x144;
        }
        else
        {
    ...
    double Cellsakmann_model_2000_epiFromCellMLGRL1::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.050000000000000003 + 8.4671999999999982e-11 * var_x167 - 3.5279999999999993e-7 * var_x164 - 4.7039999999999993e-6 * var_x166;
        }
        else
        {
    ...
    double Cellsakmann_model_2000_epiFromCellMLGRL1::EvaluatePartialDerivative19(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.050000000000000003 + var_x277;
        }
        else
        {
    ...
    double Cellsakmann_model_2000_epiFromCellMLGRL1::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.20000000000000001 + var_x277;
        }
        else
        {
