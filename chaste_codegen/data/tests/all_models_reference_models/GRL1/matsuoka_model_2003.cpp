...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellmatsuoka_model_2003FromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_constant_field_equations__CF_K = ((fabs(var_chaste_interface__membrane__Vm) < 2.6712831923985376e-6) ? (187175.96150898977 * (2.6712831923985376e-6 + var_chaste_interface__membrane__Vm) * (9.9999999999999995e-8 * (-mParameters[6] * exp(9.9999999999999995e-8) + var_chaste_interface__internal_ion_concentrations__Ki) / (1.0 - exp(9.9999999999999995e-8)) + 9.9999999999999995e-8 * (-mParameters[6] * exp(-9.9999999999999995e-8) + var_chaste_interface__internal_ion_concentrations__Ki) / (1.0 - exp(-9.9999999999999995e-8))) - 9.9999999999999995e-8 * (-mParameters[6] * exp(9.9999999999999995e-8) + var_chaste_interface__internal_ion_concentrations__Ki) / (1.0 - exp(9.9999999999999995e-8))) : (0.037435192301797954 * (-mParameters[6] * exp(-0.037435192301797954 * var_chaste_interface__membrane__Vm) + var_chaste_interface__internal_ion_concentrations__Ki) * var_chaste_interface__membrane__Vm / (1.0 - exp(-0.037435192301797954 * var_chaste_interface__membrane__Vm)))); // millimolar
    ...
    double Cellmatsuoka_model_2003FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x78 = exp(-0.025455930765222609 * var_chaste_interface__membrane__Vm) / (1.0 + 669921.875 * (1.0 + 0.7246376811594204 * mParameters[5]) / var_x77);
