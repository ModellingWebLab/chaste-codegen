...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellmatsuoka_model_2003FromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_background_Kpl_current__P_Kpl = 8.3986538766456042e-5 * pow(mParameters[6], 0.16); // nanoS_per_millimolar
    ...
    double Cellmatsuoka_model_2003FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x31 = exp(-0.025455930765222609 * var_chaste_interface__membrane__Vm) / (1.0 + 669921.875 * (1.0 + 0.7246376811594204 * mParameters[5]) / var_x30);
