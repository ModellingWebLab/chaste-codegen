...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL1::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_ICaL_d_gate__tau_d = ((fabs(14.5 + var_chaste_interface__cell__V) < 5.999999999062311e-7) ? (833333.33346356789 * (14.5000006 + var_chaste_interface__cell__V) * (47619047.626489595 * (1.0 - exp(9.9999999984371854e-8)) / (1.0 + exp(9.9999999984371854e-8)) + 47619047.626489595 * (1.0 - exp(-9.9999999984371854e-8)) / (1.0 + exp(-9.9999999984371854e-8))) - 47619047.626489595 * (1.0 - exp(9.9999999984371854e-8)) / (1.0 + exp(9.9999999984371854e-8))) : (28.571428571428569 * (1.0 - exp(-2.4166666666666665 - 0.16666666666666666 * var_chaste_interface__cell__V)) / ((1.0 + exp(-2.4166666666666665 - 0.16666666666666666 * var_chaste_interface__cell__V)) * (14.5 + var_chaste_interface__cell__V)))); // millisecond
        ...
        const double var_IKr_Xr_gate__tau_Xr = 1 / (((fabs(10.0 + var_chaste_interface__cell__V) < 6.8965517296959433e-7) ? (4.2068965605324136e-10 / (-1.0 + exp(1.0000000020937704e-7)) - 724999.99941571394 * (9.9999993103448261 + var_chaste_interface__cell__V) * (-4.206896549696637e-10 / (-1.0 + exp(-9.9999999951805303e-8)) - 4.2068965605324136e-10 / (-1.0 + exp(1.0000000020937704e-7)))) : (0.00060999999999999997 * (10.0 + var_chaste_interface__cell__V) / (-1.0 + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V)))) + ((fabs(7.0 + var_chaste_interface__cell__V) < 8.1300813015161566e-7) ? (-1.1219512196092296e-9 / (1.0 - exp(1.0000000000864873e-7)) + 614999.99994681031 * (7.0000008130081302 + var_chaste_interface__cell__V) * (1.1219512196092296e-9 / (1.0 - exp(1.0000000000864873e-7)) + 1.1219512196092296e-9 / (1.0 - exp(-1.0000000000864873e-7)))) : (0.0013799999999999999 * (7.0 + var_chaste_interface__cell__V) / (1.0 - exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V))))); // millisecond
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x401 = 1 / (1.0 - exp(1.0000000045806701e-7));
            const double var_x402 = 3.2000000146581445e-7 * var_x401;
            const double var_x403 = 1 / (1.0 - exp(-9.9999999747524276e-8));
            const double var_x404 = 47.130000000000003 + var_chaste_interface__cell__V;
            const double var_x405 = fabs(var_x404) < 1.0000000010279564e-6;
            ...
            const double var_x409 = ((var_x405) ? (-var_x402 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__cell__V) * (var_x402 + 3.1999999919207769e-7 * var_x403)) : (var_x404 * var_x408));
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x417 = 1 / (-1.0 + exp(-9.9999999951805303e-8));
            const double var_x418 = 1 / (-1.0 + exp(1.0000000020937704e-7));
            ...
            const double var_x425 = fabs(var_x424) < 6.8965517296959433e-7;
            const double var_x426 = 1 / (1.0 - exp(1.0000000000864873e-7));
            const double var_x427 = 1 / (1.0 - exp(-1.0000000000864873e-7));
            ...
            const double var_x432 = fabs(var_x422) < 8.1300813015161566e-7;
            const double var_x433 = 4.2068965605324136e-10 * var_x418;
            const double var_x434 = var_x421 * var_x422;
            const double var_x435 = 1.1219512196092296e-9 * var_x426;
            const double var_x436 = var_x424 * var_x430;
            const double var_x437 = ((var_x425) ? (var_x433 + var_x434 - 724999.99941571394 * (9.9999993103448261 + var_chaste_interface__cell__V) * (-var_x433 - 4.206896549696637e-10 * var_x417)) : ((var_x432) ? (var_x436 - var_x435 + 614999.99994681031 * (7.0000008130081302 + var_chaste_interface__cell__V) * (var_x435 + 1.1219512196092296e-9 * var_x427)) : (var_x434 + var_x436)));
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x440 = 1 / (-1.0 + exp(9.9999999925515227e-8));
            const double var_x441 = 1 / (-1.0 + exp(-9.9999999925515227e-8));
            const double var_x442 = 1 / (1.0 - exp(2.1542940304186685e-7));
            const double var_x443 = 1 / (1.0 - exp(-2.1542940304186685e-7));
            const double var_x444 = 30.0 + var_chaste_interface__cell__V;
            const double var_x445 = fabs(var_x444) < 1.4556040746072085e-6;
            ...
            const double var_x452 = 1.9068413377354434e-10 * var_x441;
            const double var_x453 = 1.0465793296425829e-10 * var_x442;
            const double var_x454 = ((var_x445) ? (-var_x452 - var_x453 + 343500.00025585521 * (30.000001455604075 + var_chaste_interface__cell__V) * (var_x452 + var_x453 + 1.9068413377354434e-10 * var_x440 + 1.0465793296425829e-10 * var_x443)) : (var_x444 * var_x448 + var_x444 * var_x451));
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x482 = exp(9.9999999984371854e-8);
            const double var_x483 = (1.0 - var_x482) / (1.0 + var_x482);
            const double var_x484 = 47619047.626489595 * var_x483;
            const double var_x485 = exp(-9.9999999984371854e-8);
            const double var_x486 = (1.0 - var_x485) / (1.0 + var_x485);
            const double var_x487 = (14.5000006 + var_chaste_interface__cell__V) * (var_x484 + 47619047.626489595 * var_x486);
            const double var_x488 = 14.5 + var_chaste_interface__cell__V;
            const double var_x489 = fabs(var_x488) < 5.999999999062311e-7;
            ...
            const double var_x494 = ((var_x489) ? (1 / (-var_x484 + 833333.33346356789 * var_x487)) : (var_x488 * var_x492));
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL1::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x276 = var_x14 * var_x16;
            const double var_x277 = ((var_x27) ? (var_x275 - var_x228 * (-var_x275 - var_x273 * var_x276)) : (var_x38 * var_x40));
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL1::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x294 = var_x274 * var_x293;
            const double var_x295 = ((var_x27) ? (var_x294 - var_x228 * (-var_x294 - var_x276 * var_x293)) : (var_x58 * var_x60));
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL1::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x310 = var_x14 * var_x87;
            const double var_x311 = ((var_x92) ? (var_x309 - var_x232 * (-var_x309 - var_x307 * var_x310)) : (0.061380000000000011 * var_x100 * var_x97));
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLGRL1::EvaluatePartialDerivative26(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x324 = var_x308 * var_x323;
            const double var_x325 = ((var_x92) ? (var_x324 - var_x232 * (-var_x324 - var_x310 * var_x323)) : (0.55242000000000002 * var_x100 * var_x113));
