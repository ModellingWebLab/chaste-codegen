#ifndef CELLMALECKAR_MODEL_2009FROMCELLMLGRL1_HPP_
#define CELLMALECKAR_MODEL_2009FROMCELLMLGRL1_HPP_
...
class Cellmaleckar_model_2009FromCellMLGRL1 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellmaleckar_model_2009FromCellMLGRL1(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellmaleckar_model_2009FromCellMLGRL1();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellmaleckar_model_2009FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellmaleckar_model_2009FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellmaleckar_model_2009FromCellMLGRL1(p_solver, p_stimulus);
        }
...
#endif // CELLMALECKAR_MODEL_2009FROMCELLMLGRL1_HPP_