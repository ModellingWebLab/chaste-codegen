...
#include "MathsCustomFunctions.hpp"
    ...
    double CellShannon2004FromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_ICab__G_CaBk = 00025129999999999998; // milliS_per_microF
        ...
        const double var_ICap__Km = 00050000000000000001; // millimolar
        const double var_ICap__Q10_SLCaP = 2.3500000000000001; // dimensionless
        const double var_ICap__V_maxAF = 067299999999999999; // microA_per_microF
        ...
        const double var_IClb__G_ClBk = 0089999999999999993; // milliS_per_microF
        const double var_IKp__g_Kp = 001; // milliS_per_microF
        ...
        const double var_INab__G_NaBk = 00029700000000000001; // milliS_per_microF
        const double var_Itof__G_tof = 02; // milliS_per_microF
        ...
        const double var_model_parameters__Clo = 150; // millimolar
        ...
        const double var_INaK__sigma = -0.14285714285714285 + 0.14285714285714285 * exp(01485884101040119 * mParameters[6]); // dimensionless
        ...
        const double var_INaK__f_NaK = 1.0 / (1.0 + 0.1245 * exp(-0.10000000000000001 * var_chaste_interface__cell__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T)) + 036499999999999998 * var_INaK__sigma * exp(-var_chaste_interface__cell__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T))); // dimensionless
    ...
    void CellShannon2004FromCellMLGRL1::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_Ca_buffer__Bmax_SLB_SL = 037400000000000003; // millimolar
        const double var_Ca_buffer__Bmax_SLB_jct = 0045999999999999999; // millimolar
        const double var_Ca_buffer__Bmax_SLHigh_SL = 0134; // millimolar
        const double var_Ca_buffer__Bmax_SLHigh_jct = 00165; // millimolar
        ...
        const double var_Ca_buffer__koff_SLHigh = 029999999999999999; // per_millisecond
        ...
        const double var_Jpump_SR__Kmf = 00024600000000000002; // millimolar
        ...
        const double var_Jrel_SR__kim = 0050000000000000001; // per_millisecond
        ...
        const double var_Jrel_SR__kom = 059999999999999998; // per_millisecond
        ...
        const double var_Na_buffer__koff = 001; // per_millisecond
        const double var_Na_buffer__kon = 0001; // per_millimolar_per_millisecond
        ...
        const double var_cytosolic_Ca_buffer__Bmax_Calmodulin = 024; // millimolar
        ...
        const double var_cytosolic_Ca_buffer__Bmax_SRB = 017100000000000001; // millimolar
        const double var_cytosolic_Ca_buffer__Bmax_TroponinC = 070000000000000007; // millimolar
        ...
        const double var_cytosolic_Ca_buffer__koff_Myosin_Ca = 00046000000000000001; // per_millisecond
        const double var_cytosolic_Ca_buffer__koff_Myosin_Mg = 5.7000000000000003e-5; // per_millisecond
        const double var_cytosolic_Ca_buffer__koff_SRB = 059999999999999998; // per_millisecond
        const double var_cytosolic_Ca_buffer__koff_TroponinC = 019599999999999999; // per_millisecond
        const double var_cytosolic_Ca_buffer__koff_TroponinC_Ca_Mg_Ca = 3.1999999999999999e-5; // per_millisecond
        const double var_cytosolic_Ca_buffer__koff_TroponinC_Ca_Mg_Mg = 0033300000000000001; // per_millisecond
        ...
        const double var_cytosolic_Ca_buffer__kon_Myosin_Mg = 015699999999999999; // per_millimolar_per_millisecond
        ...
        const double var_cytosolic_Ca_buffer__kon_TroponinC_Ca_Mg_Mg = 0030000000000000001; // per_millimolar_per_millisecond
        ...
        const double var_model_parameters__Vol_SL = 02 * var_model_parameters__Vol_Cell; // liter
        const double var_model_parameters__Vol_SR = 035000000000000003 * var_model_parameters__Vol_Cell; // liter
        const double var_model_parameters__Vol_jct = 00053900000000000009 * var_model_parameters__Vol_Cell; // liter
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x235 = var_chaste_interface__cell__V < -40;
            const double var_x236 = exp(079000000000000001 * var_chaste_interface__cell__V);
            ...
            partialF = -((var_x235) ? (0.13500000000000001 * var_x234) : (0)) - ((var_x235) ? (310000 * var_x237 + 3.5600000000000001 * var_x236) : (7.6923076923076916 / var_x239));
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x241 = exp(-043909999999999998 * var_chaste_interface__cell__V);
            const double var_x242 = -127140 * var_x240 - 3.4740000000000003e-5 * var_x241;
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x261 = exp(-090909090909090912 * var_chaste_interface__cell__V);
            const double var_x262 = 47.130000000000003 + var_chaste_interface__cell__V;
            
            partialF = -080000000000000002 * var_x261 - var_x260 * var_x262;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x277 = exp(2.0609999999999999 + 068699999999999997 * var_chaste_interface__cell__V);
            const double var_x278 = -1.0 + var_x277;
            const double var_x279 = 00013100000000000001 / var_x278;
            ...
            const double var_x283 = 30 + var_chaste_interface__cell__V;
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x286 = 066666666666666666 * var_chaste_interface__cell__V;
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x299 = 1 / (30 + 3000 * var_x298);
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x297 = 1.0 + var_x296;
            const double var_x298 = 1 / var_x297;
            const double var_x307 = 1 / (220 + 2800 * var_x298);
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x308 = exp(-0011111111111111111 * pow(var_chaste_interface__cell__V, 2));
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x310 = 1 / (20 + 20 * var_x304);
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x318 = 035000000000000003 * var_x314;
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x323 = 019699999999999999 * exp(-0.23877882250000002 * pow((1 + 068965517241379309 * var_chaste_interface__cell__V), 2));
            
            partialF = -02 - var_x323;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x336 = 10 * var_x204 * var_x335;
            const double var_x337 = -var_x336;
            
            partialF = -0050000000000000001 + var_x334 + var_x337;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -065000000000000002 + var_x337;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -059999999999999998 + var_x334;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x350 = 0001 * var_chaste_interface__Na_buffer__Na_SL_buf;
            const double var_x351 = 1.2899391426308094e-14 * var_x181;
            
            partialF = -2.5101556644976917 + var_x350 - 017367559454884197 * var_x186 - 1.5310180739595352e-5 * var_x82 - 3.9646379347775894e-9 * var_x137 - 3.0164820906368501e-6 * var_x184 - 051549430099647651 * var_x174 - var_x178 * var_x351;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x356 = 0001 * var_chaste_interface__Na_buffer__Na_jct_buf;
            const double var_x357 = 5.9157951966558558e-14 * var_x191;
            
            partialF = -1.0301299389968197 + var_x356 - 1.3833900897210959e-5 * var_x193 - 7.0214082731462295e-5 * var_x72 - 079649435702289356 * var_x194 - 1.3239978260852802e-6 * var_x133 - 0.2364110529678865 * var_x187 - var_x189 * var_x357;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x352 = 0001 * var_chaste_interface__Na_buffer__Na_SL;
            
            partialF = -001 - var_x352;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative22(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x358 = 0001 * var_chaste_interface__Na_buffer__Na_jct;
            
            partialF = -001 - var_x358;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative24(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x359 = 100 * var_chaste_interface__Ca_buffer__Ca_Calsequestrin;
            ...
            partialF = -260 + var_x359 - var_x360 - var_x361 - 0.69232869146389786 * var_x227 - 8.7400597733819945e-14 * var_x228;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x365 = 100 * var_chaste_interface__Ca_buffer__Ca_SLB_SL;
            const double var_x366 = 100 * var_chaste_interface__Ca_buffer__Ca_SLHigh_SL;
            
            partialF = -171.99023312516786 + var_x365 + var_x366 + 9.7126432122478125e-14 * var_x200 - 5.4319197230928918e-10 * var_x197 - 3.2385929460103637e-6 * var_x4 - 0.24034516191273925 * var_x143 - 0019297288283204664 * var_x199 + var_x202 * var_x364;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative26(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x372 = 100 * var_chaste_interface__Ca_buffer__Ca_SLB_jct;
            const double var_x373 = 100 * var_chaste_interface__Ca_buffer__Ca_SLHigh_jct;
            
            partialF = -121.69540971903938 + var_x372 + var_x373 - var_x370 - var_x371 + 4.4543192901847336e-13 * var_x209 - 1.4852524402707469e-5 * var_x2 - 0088499373002543739 * var_x207 - 80.263690434680996 * var_x145 - 2.4911349337733966e-9 * var_x206 + var_x208 * var_x369;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative27(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x367 = 100 * var_chaste_interface__Ca_buffer__Ca_SL;
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative28(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x374 = 100 * var_chaste_interface__Ca_buffer__Ca_jct;
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -029999999999999999 + var_x375;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -029999999999999999 + var_x376;
        }
        else
        {
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative31(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x362 = 100 * var_chaste_interface__Ca_buffer__Ca_SR;
    ...
    double CellShannon2004FromCellMLGRL1::EvaluatePartialDerivative36(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -00046000000000000001 + var_x378;
        }
        else
        {
