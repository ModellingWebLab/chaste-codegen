...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldecker_2009FromCellMLGRL1::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_INaL_mL_gate__amL = ((fabs(47.130000000000003 + var_chaste_interface__membrane__Vm) < 1.0000000010279564e-6) ? (-3.2000000146581445e-7 / (1.0 - exp(1.0000000045806701e-7)) + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__Vm) * (3.2000000146581445e-7 / (1.0 - exp(1.0000000045806701e-7)) + 3.1999999919207769e-7 / (1.0 - exp(-9.9999999747524276e-8)))) : (0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__Vm) / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__Vm)))); // per_ms
        ...
        const double var_INa_m_gate__am = ((fabs(47.130000000000003 + var_chaste_interface__membrane__Vm) < 1.0000000010279564e-6) ? (-3.2000000146581445e-7 / (1.0 - exp(1.0000000045806701e-7)) + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__Vm) * (3.2000000146581445e-7 / (1.0 - exp(1.0000000045806701e-7)) + 3.1999999919207769e-7 / (1.0 - exp(-9.9999999747524276e-8)))) : (0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__Vm) / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__Vm)))); // per_ms
    ...
    double Celldecker_2009FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x159 = var_x4 * var_x5;
            const double var_x160 = ((var_x23) ? (var_x158 + var_x155 * (-var_x158 - var_x156 * var_x159)) : (var_x27 * var_x31));
    ...
    double Celldecker_2009FromCellMLGRL1::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x423 = 1 / (1.0 - exp(-9.9999999747524276e-8));
            const double var_x424 = 1 / (1.0 - exp(1.0000000045806701e-7));
            const double var_x425 = 47.130000000000003 + var_chaste_interface__membrane__Vm;
            const double var_x426 = fabs(var_x425) < 1.0000000010279564e-6;
            ...
            const double var_x434 = 3.2000000146581445e-7 * var_x424;
            const double var_x435 = -((var_x426) ? (-var_x434 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__Vm) * (var_x434 + 3.1999999919207769e-7 * var_x423)) : (var_x425 * var_x430)) - 0.080000000000000002 * var_x432;
    ...
    double Celldecker_2009FromCellMLGRL1::EvaluatePartialDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x461 = 1 / (-1.0 + exp(9.9999999552835566e-8));
            const double var_x462 = 1 / (-1.0 + exp(-9.9999999552835566e-8));
            ...
            const double var_x469 = fabs(var_x468) < 6.5703022045227044e-7;
            const double var_x470 = 1 / (1.0 - exp(9.9999999992661527e-8));
            const double var_x471 = 1 / (1.0 - exp(-1.0000000002285959e-7));
            ...
            const double var_x476 = fabs(-1.7384000000000002 + var_chaste_interface__membrane__Vm) < 7.3529411770412167e-7;
            const double var_x477 = 1.9710906613568111e-10 * var_x461;
            const double var_x478 = var_x465 * var_x466;
            const double var_x479 = 4.4117647055585959e-10 * var_x470;
            const double var_x480 = var_x468 * var_x474;
            const double var_x481 = ((var_x469) ? (var_x477 + var_x478 - 761000.00340292137 * (38.360799342969777 + var_chaste_interface__membrane__Vm) * (-var_x477 - 1.9710906613568111e-10 * var_x462)) : ((var_x476) ? (var_x480 - var_x479 + 679999.99994722824 * (-1.7383992647058824 + var_chaste_interface__membrane__Vm) * (var_x479 + 4.4117647068908634e-10 * var_x471)) : (var_x478 + var_x480)));
    ...
    double Celldecker_2009FromCellMLGRL1::EvaluatePartialDerivative39(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x180 = -0.5 + 374358.83507802623 * var_chaste_interface__membrane__Vm;
            const double var_x181 = ((var_x23) ? (var_x179 - var_x180 * (-var_x179 - var_x178 * var_x39)) : (var_x42 * var_chaste_interface__membrane__Vm));
            const double var_x207 = var_x157 * var_x178;
            const double var_x208 = ((var_x23) ? (var_x207 + var_x155 * (-var_x207 - var_x159 * var_x178)) : (var_x30 * var_x41));
    ...
    double Celldecker_2009FromCellMLGRL1::EvaluatePartialDerivative40(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x211 = var_x157 * var_x210;
            const double var_x212 = ((var_x7) ? (var_x211 + var_x209 * (-var_x211 - var_x159 * var_x210)) : (var_x14 * var_x15));
