...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellluo_rudy_1991FromCellMLGRL1::UseCellMLDefaultStimulus()
    {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellluo_rudy_1991FromCellMLGRL1::Cellluo_rudy_1991FromCellMLGRL1(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellluo_rudy_1991FromCellMLGRL1>::Instance();
        Init();
    ...
    Cellluo_rudy_1991FromCellMLGRL1::~Cellluo_rudy_1991FromCellMLGRL1()
    {
    }

    
    
    void Cellluo_rudy_1991FromCellMLGRL1::VerifyStateVariables()
    {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellluo_rudy_1991FromCellMLGRL1::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    void Cellluo_rudy_1991FromCellMLGRL1::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        std::vector<double>& rY = rGetStateVariables();
        const double delta = 1e-8;
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluateYDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
        double d_dt_chaste_interface_var_membrane__V;
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -83.853
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x2 = mParameters[4] * var_chaste_interface__slow_inward_current_f_gate__f;
            ...
            const double var_x5 = var_x4 * mParameters[7] * var_chaste_interface__fast_sodium_current_j_gate__j;
            ...
            const double var_x8 = exp(9.9999999747524276e-8);
            const double var_x9 = 1134800.0028650947 * var_x8;
            const double var_x10 = exp(-1.0000000031595847e-7);
            const double var_x11 = var_x7 * (-1134800.0028650947 + var_x9 - 199999.99993651727 * (76.999997500000006 + var_chaste_interface__membrane__V) * (2269599.9992795982 - var_x9 - 1134799.9964145035 * var_x10));
            const double var_x12 = (var_chaste_interface__membrane__V > -77.000002499999994) && (var_chaste_interface__membrane__V < -76.999997500000006);
            const double var_x13 = exp(3.0800000000000001 + var_x6);
            const double var_x14 = -1.0 + var_x13;
            const double var_x15 = var_x7 / (77.0 + var_chaste_interface__membrane__V);
            const double var_x16 = var_x14 * var_x15;
            const double var_x17 = var_chaste_interface__membrane__V > -100.0;
            const double var_x18 = ((var_x12) ? (var_x11) : ((var_x17) ? (2.8370000000000002 * var_x16) : (1.0)));
            const double var_x19 = sqrt(mParameters[2]);
            const double var_x20 = 0.43033148291193518 * var_x19 * mParameters[6] * var_chaste_interface__time_dependent_potassium_current_X_gate__X;
            ...
            const double var_x34 = var_x19 * var_x25 * mParameters[10];
            const double var_x35 = -26.712449447891164 * log((0.018329999999999999 * mParameters[3] + mParameters[2]) / (0.018329999999999999 * mParameters[1] + mParameters[0])) + var_chaste_interface__membrane__V;
            const double var_x36 = var_x23 / pow(var_x24, 2);
            const double var_x37 = 1 / mParameters[5];
            const double var_x38 = var_x37;
            
            partialF = -var_x38 * (var_x3 + var_x18 * var_x20 + var_x5 * var_chaste_interface__fast_sodium_current_h_gate__h + mParameters[12] / var_x1 + 0.4389381125701739 * var_x33 * var_x34 + var_x20 * var_x35 * ((var_x12) ? (-0.040000000000000001 * var_x11 + var_x7 * (-453919999711.83923 + 226960000500.97873 * var_x8 + 226959999210.8605 * var_x10)) : ((var_x17) ? (-0.11348000000000001 * var_x16 + 0.11348000000000001 * var_x13 * var_x15 - 0.0004784955304435824 * var_x14 * var_x7 / pow((1 + 0.012987012987012988 * var_chaste_interface__membrane__V), 2)) : (0))) + 0.42189361069797565 * var_x22 * var_x34 * (0.24326999999999999 * var_x36 - var_x28 * (0.061749999999999999 * var_x29 + 0.039456396800000001 * var_x30) - 0.51429999999999998 * var_x26 * var_x31 / pow(var_x27, 2)) / pow((var_x25 + 0.98039215686274506 * var_x32), 2) + 0.16722408026755853 * var_x0 * var_x22 * mParameters[12] / pow(var_x1, 2) - 0.10468673984798647 * var_x19 * var_x22 * var_x33 * var_x36 * mParameters[10] + mParameters[11]);
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluateYDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x2 = mParameters[4] * var_chaste_interface__slow_inward_current_f_gate__f;
            const double var_x3 = var_x2 * var_chaste_interface__slow_inward_current_d_gate__d;
            const double var_x39 = var_x3 / var_chaste_interface__intracellular_calcium_concentration__Cai;
            
            partialF = -0.070000000000000007 - 0.00130287 * var_x39;
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluateYDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x47 = 1 / (1.0 - exp(-9.9999999747524276e-8));
            const double var_x48 = 1 / (1.0 - exp(1.0000000045806701e-7));
            const double var_x49 = 47.130000000000003 + var_chaste_interface__membrane__V;
            const double var_x50 = fabs(var_x49) < 1.0000000010279564e-6;
            const double var_x51 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x52 = exp(-4.7130000000000001 + var_x51);
            const double var_x53 = 1.0 - var_x52;
            const double var_x54 = 0.32000000000000001 / var_x53;
            const double var_x55 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
            const double var_x56 = 3.2000000146581445e-7 * var_x48;
            
            partialF = -((var_x50) ? (-var_x56 + 499999.99948602181 * (47.130001000000007 + var_chaste_interface__membrane__V) * (var_x56 + 3.1999999919207769e-7 * var_x47)) : (var_x49 * var_x54)) - 0.080000000000000002 * var_x55;
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluateYDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x57 = exp(-11.764705882352942 + 0.14705882352941177 * mParameters[9] - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x58 = var_chaste_interface__membrane__V < -40.0;
            const double var_x59 = ((var_x58) ? (0.13500000000000001 * var_x57) : (0));
            const double var_x60 = var_x59;
            const double var_x61 = exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * mParameters[9]);
            const double var_x62 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * mParameters[9]);
            const double var_x63 = exp(-0.96036036036036043 + 0.0900900900900901 * mParameters[9] - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x64 = 1.0 + var_x63;
            const double var_x65 = ((var_x58) ? (310000.0 * var_x61 + 3.5600000000000001 * var_x62) : (7.6923076923076916 / var_x64));
            const double var_x66 = var_x65;
            
            partialF = -var_x60 - var_x66;
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluateYDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x51 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x58 = var_chaste_interface__membrane__V < -40.0;
            const double var_x73 = exp(-5.5312920000000005 + 0.13780000000000001 * mParameters[9] - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x74 = 1.0 + var_x73;
            const double var_x75 = exp(0.01052 * mParameters[9] - 0.01052 * var_chaste_interface__membrane__V);
            const double var_x76 = var_x75 / var_x74;
            const double var_x77 = exp(-3.2000000000000002 + var_x51 + 0.10000000000000001 * mParameters[9]);
            const double var_x78 = 1.0 + var_x77;
            const double var_x79 = exp(2.5349999999999999e-7 * mParameters[9] - 2.5349999999999999e-7 * var_chaste_interface__membrane__V);
            const double var_x80 = var_x79 / var_x78;
            const double var_x81 = ((var_x58) ? (0.1212 * var_x76) : (0.29999999999999999 * var_x80));
            const double var_x82 = var_x81;
            const double var_x83 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x84 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * mParameters[9]);
            const double var_x85 = 1.0 + var_x84;
            const double var_x86 = 1 / var_x85;
            const double var_x87 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * mParameters[9]);
            const double var_x88 = exp(0.043909999999999998 * mParameters[9] - 0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x89 = -127140.0 * var_x87 - 3.4740000000000003e-5 * var_x88;
            const double var_x90 = var_x86 * var_x89;
            const double var_x91 = ((var_x58) ? (var_x83 * var_x90) : (0));
            const double var_x92 = var_x91;
            
            partialF = -var_x82 - var_x92;
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluateYDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x97 = exp(2.2000000000000002 + 0.050000000000000003 * var_chaste_interface__membrane__V);
            const double var_x98 = 1.0 + var_x97;
            const double var_x99 = exp(-0.748 - 0.017000000000000001 * var_chaste_interface__membrane__V);
            const double var_x100 = var_x99 / var_x98;
            const double var_x102 = exp(0.35999999999999999 - 0.071999999999999995 * var_chaste_interface__membrane__V);
            const double var_x103 = 1.0 + var_x102;
            const double var_x104 = exp(0.050000000000000003 - 0.01 * var_chaste_interface__membrane__V);
            const double var_x105 = var_x104 / var_x103;
            
            partialF = -0.070000000000000007 * var_x100 - 0.095000000000000001 * var_x105;
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluateYDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x106 = exp(-6.0 - 0.20000000000000001 * var_chaste_interface__membrane__V);
            const double var_x107 = 1.0 + var_x106;
            const double var_x108 = exp(-0.59999999999999998 - 0.02 * var_chaste_interface__membrane__V);
            const double var_x109 = var_x108 / var_x107;
            const double var_x111 = exp(4.2000000000000002 + 0.14999999999999999 * var_chaste_interface__membrane__V);
            const double var_x112 = 1.0 + var_x111;
            const double var_x113 = exp(-0.224 - 0.0080000000000000002 * var_chaste_interface__membrane__V);
            const double var_x114 = var_x113 / var_x112;
            
            partialF = -0.012 * var_x114 - 0.0064999999999999997 * var_x109;
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluateYDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x6 = 0.040000000000000001 * var_chaste_interface__membrane__V;
            const double var_x115 = exp(-0.80000000000000004 - var_x6);
            const double var_x116 = 1.0 + var_x115;
            const double var_x117 = exp(-1.2 - 0.059999999999999998 * var_chaste_interface__membrane__V);
            const double var_x118 = var_x117 / var_x116;
            const double var_x120 = exp(2.8500000000000001 + 0.057000000000000002 * var_chaste_interface__membrane__V);
            const double var_x121 = 1.0 + var_x120;
            const double var_x122 = exp(4.1500000000000004 + 0.083000000000000004 * var_chaste_interface__membrane__V);
            const double var_x123 = var_x122 / var_x121;
            
            partialF = -0.00050000000000000001 * var_x123 - 0.0012999999999999999 * var_x118;
        }
        else
        {
    ...
    std::vector<double> Cellluo_rudy_1991FromCellMLGRL1::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellluo_rudy_1991FromCellMLGRL1>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellluo_rudy_1991FromCellMLGRL1)
