...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x7 = exp(3.0800000000000001 + var_x6);
            const double var_x8 = -1.0 + var_x7;
            const double var_x9 = 1 / exp(1.4000000000000001 + var_x6);
            const double var_x10 = var_x9 / (77.0 + var_chaste_interface__membrane__V);
            const double var_x11 = var_x10 * var_x8;
            const double var_x12 = var_chaste_interface__membrane__V > -100.0;
            const double var_x13 = ((var_x12) ? (2.8370000000000002 * var_x11) : (1.0));
            const double var_x14 = sqrt(mParameters[2]);
            const double var_x15 = 0.43033148291193518 * var_x14 * mParameters[6] * var_chaste_interface__time_dependent_potassium_current_X_gate__X;
            const double var_x16 = log(mParameters[2] / mParameters[0]);
            const double var_x17 = -26.712449447891164 * var_x16 + var_chaste_interface__membrane__V;
            const double var_x18 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3709191933220426 * var_x16);
            const double var_x19 = 1.0 + var_x18;
            const double var_x20 = 1 / var_x19;
            const double var_x21 = exp(-2.4444678999999998 + 13.738212751050426 * var_x16 - 0.51429999999999998 * var_chaste_interface__membrane__V);
            const double var_x22 = 1.0 + var_x21;
            const double var_x23 = 1 / var_x22;
            const double var_x24 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494937534072793 * var_x16);
            const double var_x25 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455439396546185 * var_x16);
            const double var_x26 = var_x24 + 0.49124000000000001 * var_x25;
            const double var_x27 = var_x23 * var_x26;
            const double var_x28 = 1 / (var_x27 + 1.02 * var_x20);
            const double var_x29 = var_x14 * var_x20 * mParameters[10];
            const double var_x30 = -26.712449447891164 * log((0.018329999999999999 * mParameters[3] + mParameters[2]) / (0.018329999999999999 * mParameters[1] + mParameters[0])) + var_chaste_interface__membrane__V;
            const double var_x31 = var_x18 / pow(var_x19, 2);
            const double var_x32 = 1 / mParameters[5];
            const double var_x33 = var_x32;
            
            partialF = -var_x33 * (var_x3 + var_x13 * var_x15 + var_x5 * var_chaste_interface__fast_sodium_current_h_gate__h + mParameters[12] / var_x1 + 0.4389381125701739 * var_x28 * var_x29 + var_x15 * var_x30 * ((var_x12) ? (-0.11348000000000001 * var_x11 + 0.11348000000000001 * var_x10 * var_x7 - 0.0004784955304435824 * var_x8 * var_x9 / pow((1 + 0.012987012987012988 * var_chaste_interface__membrane__V), 2)) : (0)) + 0.42189361069797565 * var_x17 * var_x29 * (0.24326999999999999 * var_x31 - var_x23 * (0.061749999999999999 * var_x24 + 0.039456396800000001 * var_x25) - 0.51429999999999998 * var_x21 * var_x26 / pow(var_x22, 2)) / pow((var_x20 + 0.98039215686274506 * var_x27), 2) + 0.16722408026755853 * var_x0 * var_x17 * mParameters[12] / pow(var_x1, 2) - 0.10468673984798647 * var_x14 * var_x17 * var_x28 * var_x31 * mParameters[10] + mParameters[11]);
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x2 = mParameters[4] * var_chaste_interface__slow_inward_current_f_gate__f;
            const double var_x3 = var_x2 * var_chaste_interface__slow_inward_current_d_gate__d;
            const double var_x34 = var_x3 / var_chaste_interface__intracellular_calcium_concentration__Cai;
            
            partialF = -0.070000000000000007 - 0.00130287 * var_x34;
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x43 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x44 = exp(-4.7130000000000001 + var_x43);
            const double var_x45 = 1.0 - var_x44;
            const double var_x46 = 0.32000000000000001 / var_x45;
            const double var_x47 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
            const double var_x48 = 47.130000000000003 + var_chaste_interface__membrane__V;
            
            partialF = -0.080000000000000002 * var_x47 - var_x46 * var_x48;
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x49 = exp(-11.764705882352942 + 0.14705882352941177 * mParameters[9] - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x50 = var_chaste_interface__membrane__V < -40.0;
            const double var_x51 = ((var_x50) ? (0.13500000000000001 * var_x49) : (0));
            const double var_x52 = var_x51;
            const double var_x53 = exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * mParameters[9]);
            const double var_x54 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * mParameters[9]);
            const double var_x55 = exp(-0.96036036036036043 + 0.0900900900900901 * mParameters[9] - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x56 = 1.0 + var_x55;
            const double var_x57 = ((var_x50) ? (310000.0 * var_x53 + 3.5600000000000001 * var_x54) : (7.6923076923076916 / var_x56));
            const double var_x58 = var_x57;
            
            partialF = -var_x52 - var_x58;
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x43 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x50 = var_chaste_interface__membrane__V < -40.0;
            const double var_x65 = exp(-5.5312920000000005 + 0.13780000000000001 * mParameters[9] - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x66 = 1.0 + var_x65;
            const double var_x67 = exp(0.01052 * mParameters[9] - 0.01052 * var_chaste_interface__membrane__V);
            const double var_x68 = var_x67 / var_x66;
            const double var_x69 = exp(-3.2000000000000002 + var_x43 + 0.10000000000000001 * mParameters[9]);
            const double var_x70 = 1.0 + var_x69;
            const double var_x71 = exp(2.5349999999999999e-7 * mParameters[9] - 2.5349999999999999e-7 * var_chaste_interface__membrane__V);
            const double var_x72 = var_x71 / var_x70;
            const double var_x73 = ((var_x50) ? (0.1212 * var_x68) : (0.29999999999999999 * var_x72));
            const double var_x74 = var_x73;
            const double var_x75 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x76 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * mParameters[9]);
            const double var_x77 = 1.0 + var_x76;
            const double var_x78 = 1 / var_x77;
            const double var_x79 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * mParameters[9]);
            const double var_x80 = exp(0.043909999999999998 * mParameters[9] - 0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x81 = -127140.0 * var_x79 - 3.4740000000000003e-5 * var_x80;
            const double var_x82 = var_x78 * var_x81;
            const double var_x83 = ((var_x50) ? (var_x75 * var_x82) : (0));
            const double var_x84 = var_x83;
            
            partialF = -var_x74 - var_x84;
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x89 = exp(2.2000000000000002 + 0.050000000000000003 * var_chaste_interface__membrane__V);
            const double var_x90 = 1.0 + var_x89;
            const double var_x91 = exp(-0.748 - 0.017000000000000001 * var_chaste_interface__membrane__V);
            const double var_x92 = var_x91 / var_x90;
            const double var_x94 = exp(0.35999999999999999 - 0.071999999999999995 * var_chaste_interface__membrane__V);
            const double var_x95 = 1.0 + var_x94;
            const double var_x96 = exp(0.050000000000000003 - 0.01 * var_chaste_interface__membrane__V);
            const double var_x97 = var_x96 / var_x95;
            
            partialF = -0.070000000000000007 * var_x92 - 0.095000000000000001 * var_x97;
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x98 = exp(-6.0 - 0.20000000000000001 * var_chaste_interface__membrane__V);
            const double var_x99 = 1.0 + var_x98;
            const double var_x100 = exp(-0.59999999999999998 - 0.02 * var_chaste_interface__membrane__V);
            const double var_x101 = var_x100 / var_x99;
            const double var_x103 = exp(4.2000000000000002 + 0.14999999999999999 * var_chaste_interface__membrane__V);
            const double var_x104 = 1.0 + var_x103;
            const double var_x105 = exp(-0.224 - 0.0080000000000000002 * var_chaste_interface__membrane__V);
            const double var_x106 = var_x105 / var_x104;
            
            partialF = -0.012 * var_x106 - 0.0064999999999999997 * var_x101;
        }
        else
        {
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x6 = 0.040000000000000001 * var_chaste_interface__membrane__V;
            const double var_x107 = exp(-0.80000000000000004 - var_x6);
            const double var_x108 = 1.0 + var_x107;
            const double var_x109 = exp(-1.2 - 0.059999999999999998 * var_chaste_interface__membrane__V);
            const double var_x110 = var_x109 / var_x108;
            const double var_x112 = exp(2.8500000000000001 + 0.057000000000000002 * var_chaste_interface__membrane__V);
            const double var_x113 = 1.0 + var_x112;
            const double var_x114 = exp(4.1500000000000004 + 0.083000000000000004 * var_chaste_interface__membrane__V);
            const double var_x115 = var_x114 / var_x113;
            
            partialF = -0.00050000000000000001 * var_x115 - 0.0012999999999999999 * var_x110;
        }
        else
        {
