...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x8 = exp(-1.0000000000065512e-7);
            const double var_x9 = 1134799.9999925657 * var_x8;
            const double var_x10 = exp(1.0000000000065512e-7);
            const double var_x11 = var_x7 * (1134799.9999925657 - var_x9 + 199999.99999868975 * (77.000002499999994 + var_chaste_interface__membrane__V) * (-2269599.9999851314 + var_x9 + 1134799.9999925657 * var_x10));
    ...
    double Cellluo_rudy_1991FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x47 = 1 / (1.0 - exp(1.0000000000287557e-7));
            const double var_x48 = 1 / (1.0 - exp(-1.0000000000287557e-7));
            const double var_x49 = 47.130000000000003 + var_chaste_interface__membrane__V;
            const double var_x50 = fabs(var_x49) < 1.0000000000287557e-6;
            ...
            const double var_x56 = 3.200000000092018e-7 * var_x48;
            
            partialF = -((var_x50) ? (var_x56 - 499999.99998562218 * (47.129999000000005 + var_chaste_interface__membrane__V) * (-var_x56 - 3.200000000092018e-7 * var_x47)) : (var_x49 * var_x54)) - 0.080000000000000002 * var_x55;
        }
        else
        {
