#ifndef CELLLI_MOUSE_2010FROMCELLMLGRL1_HPP_
#define CELLLI_MOUSE_2010FROMCELLMLGRL1_HPP_
...
class Cellli_mouse_2010FromCellMLGRL1 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Cellli_mouse_2010FromCellMLGRL1(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Cellli_mouse_2010FromCellMLGRL1();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellli_mouse_2010FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellli_mouse_2010FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellli_mouse_2010FromCellMLGRL1(p_solver, p_stimulus);
        }
...
#endif // CELLLI_MOUSE_2010FROMCELLMLGRL1_HPP_