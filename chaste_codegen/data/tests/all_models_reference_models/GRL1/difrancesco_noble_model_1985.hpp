#ifndef CELLDIFRANCESCO_NOBLE_MODEL_1985FROMCELLMLGRL1_HPP_
#define CELLDIFRANCESCO_NOBLE_MODEL_1985FROMCELLMLGRL1_HPP_
...
class Celldifrancesco_noble_model_1985FromCellMLGRL1 : public AbstractGeneralizedRushLarsenCardiacCell
{
...
public:
    ...
    Celldifrancesco_noble_model_1985FromCellMLGRL1(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Celldifrancesco_noble_model_1985FromCellMLGRL1();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Celldifrancesco_noble_model_1985FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Celldifrancesco_noble_model_1985FromCellMLGRL1 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Celldifrancesco_noble_model_1985FromCellMLGRL1(p_solver, p_stimulus);
        }
...
#endif // CELLDIFRANCESCO_NOBLE_MODEL_1985FROMCELLMLGRL1_HPP_