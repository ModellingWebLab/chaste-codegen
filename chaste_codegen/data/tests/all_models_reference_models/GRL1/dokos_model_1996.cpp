...
#include "MathsCustomFunctions.hpp"
    ...
    double Celldokos_model_1996FromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.01 - 0.00013289692420950713 * var_x180 + var_x194 * var_x286 + var_x195 * var_x288 - var_x1 * var_x291 - var_x180 * var_x292 - var_x180 * var_x294;
        }
        else
        {
    ...
    double Celldokos_model_1996FromCellMLGRL1::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.01 + 5.9490902045467693e-7 * var_x200 + 0.00051209851394887792 * var_x208 + 3.179757621524301e-6 * var_x203 - 1.0054703611008608e-7 * var_x207 - 0.0074754519867847747 * var_x201 + var_x210 * var_x300 - var_x1 * var_x303 - var_x1 * var_x304 - var_x302 * var_chaste_interface__ion_concentrations__Nai;
        }
        else
        {
