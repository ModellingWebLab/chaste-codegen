...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::Cellohara_rudy_cipa_v1_2017FromCellMLGRL1(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_cipa_v1_2017FromCellMLGRL1>::Instance();
        Init();
    ...
    Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::~Cellohara_rudy_cipa_v1_2017FromCellMLGRL1()
    {
    }

    
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_ICaL__PhiCaK = (-0.75 * mParameters[10] + 0.75 * var_chaste_interface__intracellular_ions__kss * exp(var_membrane__vfrt)) * var_membrane__vffrt / (-1.0 + exp(var_membrane__vfrt)); // dimensionless
        ...
        const double var_ICaL__PhiCaL = 4.0 * (-0.34100000000000003 * mParameters[9] + var_chaste_interface__intracellular_ions__cass * exp(2.0 * var_membrane__vfrt)) * var_membrane__vffrt / (-1.0 + exp(2.0 * var_membrane__vfrt)); // dimensionless
        ...
        const double var_ICaL__PhiCaNa = (-0.75 * mParameters[11] + 0.75 * var_chaste_interface__intracellular_ions__nass * exp(var_membrane__vfrt)) * var_membrane__vffrt / (-1.0 + exp(var_membrane__vfrt)); // dimensionless
        ...
        const double var_ICab__ICab = 4.0 * (-0.34100000000000003 * mParameters[9] + var_chaste_interface__intracellular_ions__cai * exp(2.0 * var_membrane__vfrt)) * mParameters[13] * var_membrane__vffrt / (-1.0 + exp(2.0 * var_membrane__vfrt)); // microA_per_microF
        const double var_ICab__ICab_converted = HeartConfig::Instance()->GetCapacitance() * var_ICab__ICab; // uA_per_cm2
        const double var_INab__INab = (-mParameters[11] + var_chaste_interface__intracellular_ions__nai * exp(var_membrane__vfrt)) * mParameters[15] * var_membrane__vffrt / (-1.0 + exp(var_membrane__vfrt)); // microA_per_microF
    ...
    void Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
    ...
    void Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        std::vector<double>& rY = rGetStateVariables();
        const double delta = 1e-8;
        ...
        }
        {
            if (fabs(mPartialF[34]) < delta){
                rY[34] += mDt*d_dt_chaste_interface_var_IKr__IC1;
            }
            else
            {
                rY[34] += (d_dt_chaste_interface_var_IKr__IC1/mPartialF[34])*(exp(mPartialF[34]*mDt)-1.0);
            }
            
        }
        {
            if (fabs(mPartialF[35]) < delta){
                rY[35] += mDt*d_dt_chaste_interface_var_IKr__IC2;
            }
            else
            {
                rY[35] += (d_dt_chaste_interface_var_IKr__IC2/mPartialF[35])*(exp(mPartialF[35]*mDt)-1.0);
            }
            
        }
        {
            if (fabs(mPartialF[36]) < delta){
                rY[36] += mDt*d_dt_chaste_interface_var_IKr__C1;
            }
            else
            {
                rY[36] += (d_dt_chaste_interface_var_IKr__C1/mPartialF[36])*(exp(mPartialF[36]*mDt)-1.0);
            }
            
        }
        {
            if (fabs(mPartialF[37]) < delta){
                rY[37] += mDt*d_dt_chaste_interface_var_IKr__C2;
            }
            else
            {
                rY[37] += (d_dt_chaste_interface_var_IKr__C2/mPartialF[37])*(exp(mPartialF[37]*mDt)-1.0);
            }
        ...
        }
        {
            if (fabs(mPartialF[39]) < delta){
                rY[39] += mDt*d_dt_chaste_interface_var_IKr__IO;
            }
            else
            {
                rY[39] += (d_dt_chaste_interface_var_IKr__IO/mPartialF[39])*(exp(mPartialF[39]*mDt)-1.0);
            }
            
        }
        {
            if (fabs(mPartialF[40]) < delta){
                rY[40] += mDt*d_dt_chaste_interface_var_IKr__IObound;
            }
            else
            {
                rY[40] += (d_dt_chaste_interface_var_IKr__IObound/mPartialF[40])*(exp(mPartialF[40]*mDt)-1.0);
            }
            
        }
        {
            if (fabs(mPartialF[41]) < delta){
                rY[41] += mDt*d_dt_chaste_interface_var_IKr__Obound;
            }
            else
            {
                rY[41] += (d_dt_chaste_interface_var_IKr__Obound/mPartialF[41])*(exp(mPartialF[41]*mDt)-1.0);
            }
            
        }
        {
            if (fabs(mPartialF[42]) < delta){
                rY[42] += mDt*d_dt_chaste_interface_var_IKr__Cbound;
            }
            else
            {
                rY[42] += (d_dt_chaste_interface_var_IKr__Cbound/mPartialF[42])*(exp(mPartialF[42]*mDt)-1.0);
            }
            
        }
        {
            if (fabs(mPartialF[43]) < delta){
                rY[43] += mDt*d_dt_chaste_interface_var_IKs__xs1;
            }
            else
            {
                rY[43] += (d_dt_chaste_interface_var_IKs__xs1/mPartialF[43])*(exp(mPartialF[43]*mDt)-1.0);
            }
            
        }
        {
            if (fabs(mPartialF[44]) < delta){
                rY[44] += mDt*d_dt_chaste_interface_var_IKs__xs2;
            }
            else
            {
                rY[44] += (d_dt_chaste_interface_var_IKs__xs2/mPartialF[44])*(exp(mPartialF[44]*mDt)-1.0);
            }
            
        }
        {
            if (fabs(mPartialF[45]) < delta){
                rY[45] += mDt*d_dt_chaste_interface_var_IK1__xk1;
            }
            else
            {
                rY[45] += (d_dt_chaste_interface_var_IK1__xk1/mPartialF[45])*(exp(mPartialF[45]*mDt)-1.0);
            }
            
        }
        {
            if (fabs(mPartialF[46]) < delta){
                rY[46] += mDt*d_dt_chaste_interface_var_ryr__Jrelnp;
            }
            else
            {
                rY[46] += (d_dt_chaste_interface_var_ryr__Jrelnp/mPartialF[46])*(exp(mPartialF[46]*mDt)-1.0);
            }
            
        }
        {
            if (fabs(mPartialF[47]) < delta){
                rY[47] += mDt*d_dt_chaste_interface_var_ryr__Jrelp;
            }
            else
            {
                rY[47] += (d_dt_chaste_interface_var_ryr__Jrelp/mPartialF[47])*(exp(mPartialF[47]*mDt)-1.0);
            }
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
        double d_dt_chaste_interface_var_membrane__v;
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -88.00190465
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x41 = pow(mParameters[11], 3);
            ...
            const double var_x51 = pow(mParameters[11], 4);
            ...
            const double var_x132 = mParameters[14] / var_x131;
            ...
            const double var_x137 = log(var_x136 * mParameters[10]);
            const double var_x138 = 26.712338705498265 * var_x137;
            const double var_x139 = (var_x135 + var_x138) * mParameters[24];
            ...
            const double var_x142 = mParameters[19] * var_chaste_interface__INaL__mL;
            ...
            const double var_x149 = pow(var_chaste_interface__INa__m, 3) * mParameters[17];
            const double var_x150 = var_x148 * var_x149;
            const double var_x151 = 1 / (13.5 + 0.066666666666666666 * (1.0 + 0.20000000000000001 * mParameters[11]) * mParameters[11]);
            const double var_x152 = exp(0.019556505544476088 * var_chaste_interface__membrane__v);
            const double var_x153 = 1 / var_x152;
            const double var_x154 = 1.0 + 0.011348161597821153 * (1.0 + var_x153) * mParameters[11];
            ...
            const double var_x188 = var_x151 * mParameters[9];
            ...
            const double var_x211 = var_x153 * mParameters[11];
            ...
            const double var_x245 = var_x157 * pow(mParameters[11], 2);
            ...
            const double var_x294 = mParameters[22] / var_x293;
            ...
            const double var_x384 = mParameters[22] / var_x383;
            const double var_x385 = 0.80000000000000004 * var_x384;
            const double var_x386 = sqrt(mParameters[10]);
            const double var_x387 = var_x386 * mParameters[20];
            ...
            const double var_x394 = mParameters[21] * var_chaste_interface__IKs__xs2;
            const double var_x395 = var_x393 * var_x394;
            const double var_x396 = var_x395 * var_chaste_interface__IKs__xs1;
            const double var_x397 = exp(11.145054250500367 + 0.10534077741493732 * var_chaste_interface__membrane__v - 0.27388602127883704 * mParameters[10]);
            const double var_x398 = 1.0 + var_x397;
            const double var_x399 = var_x386 * mParameters[18] / var_x398;
            ...
            const double var_x404 = var_x403 - mParameters[11];
            const double var_x405 = -1.0 + var_x402;
            const double var_x406 = 1 / var_x405;
            const double var_x407 = var_x406 * mParameters[15];
            const double var_x408 = var_x404 * var_x407;
            const double var_x409 = -0.34100000000000003 * mParameters[9];
            ...
            const double var_x415 = var_x414 * mParameters[13];
            ...
            const double var_x419 = var_x130 * var_x418 * mParameters[14] / pow(var_x131, 2);
            ...
            const double var_x423 = var_x404 * var_x422 * mParameters[15];
            ...
            const double var_x427 = var_x412 * mParameters[13];
            ...
            const double var_x431 = var_x386 * var_x397 * var_x418 * mParameters[18] * var_chaste_interface__IK1__xk1 / pow(var_x398, 2);
            const double var_x432 = 0.75 * var_x402;
            const double var_x433 = -0.75 * mParameters[10] + var_x432 * var_chaste_interface__intracellular_ions__kss;
            const double var_x434 = mParameters[12] * var_chaste_interface__ICaL__d;
            ...
            const double var_x466 = -0.75 * mParameters[11] + var_x432 * var_chaste_interface__intracellular_ions__nass;
            ...
            const double var_x494 = var_x420 * mParameters[12];
            ...
            partialF = var_x396 + var_x479 + var_x483 - var_x150 - var_x463 - var_x465 - var_x490 - var_x497 - var_x513 - var_x515 + 5.0087657667109117e-7 * var_x474 + 1.9269873892634313e-6 * var_x476 + 0.0014014453740097681 * var_x423 + 5.5096423433820031e-7 * var_x480 + 0.10534077741493732 * var_x431 + 1.7518067175122102e-6 * var_x484 - var_x132 - 2.9435086484515047e-5 * var_x452 - 1.3138550381341575e-6 * var_x486 - 3.7565743250331833e-7 * var_x487 - 0.0014014453740097681 * var_x428 - 4.1322317575365023e-7 * var_x492 - 1.4452405419475734e-6 * var_x493 - 9.3589708769506547e-5 * var_x469 - 0.00010294867964645721 * var_x470 - 0.054525627044711013 * var_x419 - 2.6759169531377312e-5 * var_x471 + var_x134 * var_x139 + var_x142 * (-var_x140 - var_x141) + var_x426 * var_x427 + (-var_x17 - var_x20) * mParameters[24] + (0.014753396606870788 * var_x120 + 2.5425659820598794 * var_x121 - 1.1377195280964303 * var_x129 - 0.00010162981240266993 * var_x128 + var_x112 * var_x115 + var_x112 * var_x126 + var_x92 * var_x94 - var_x107 * var_x111 - var_x112 * var_x124 - var_x116 * var_x118 - var_x74 * var_x82) * mParameters[23] - var_x291 * var_x295 - var_x382 * var_x385 - var_x388 * var_chaste_interface__IKr__O - var_x400 * var_chaste_interface__IK1__xk1 - var_x401 * var_x408 - var_x416 * var_x417 - var_x429 * var_x430 - var_x501 * var_x506 - var_x506 * var_x520 - var_x517 * var_x518 - var_x518 * var_x521;
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x523 = mParameters[16] / var_x522;
            const double var_x524 = pow(var_x522, (-2));
            const double var_x525 = var_x524 * mParameters[16] * var_chaste_interface__intracellular_ions__cai;
            ...
            const double var_x544 = var_x543 * mParameters[22] / (pow(var_x383, 2) * pow(var_chaste_interface__intracellular_ions__cai, 3));
            ...
            partialF = var_x819 * (-0.14705882352941174 - var_x828 + 2.2147467437652741e-12 * var_x544 + 3.0760371441184366e-5 * var_x525 - 4.6061667277156659e-6 * var_x542 + var_x541 * var_x815 + (0.00097665441176470586 * var_x826 + 0.00035514705882352943 * var_x827 - 0.00097665441176470586 * var_x822 - 0.00035514705882352943 * var_x825) * mParameters[8]) + (0.00023800000000000004 / pow(var_x816, 3) + 7.0000000000000007e-5 / pow(var_x522, 3)) * (0.14705882352941174 * var_chaste_interface__intracellular_ions__cass - 0.14705882352941174 * var_chaste_interface__intracellular_ions__cai + var_x543 * var_x815 - var_x828 * var_chaste_interface__intracellular_ions__cai - 4.6061667277156659e-6 * var_x416 * var_x420 - 0.081176470588235281 * (-0.00026249999999999998 * var_chaste_interface__intracellular_ions__cansr + var_x829 * var_chaste_interface__intracellular_ions__cai + var_x830 * var_chaste_interface__intracellular_ions__cai) * mParameters[8]) / pow(var_x817, 2);
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.00068000000000000005 - var_x11 * var_x837 + var_x6 * var_x837 * (1 - var_x10);
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.5 - 7.3410782222968425e-8 * var_x485 - 8.0751860445265278e-8 * var_x491 - var_x701 * var_x854;
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x729 = (var_x17 + var_x20) * mParameters[24];
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.5 - 2.0989610853191134e-8 * var_x485 - 2.3088571938510247e-8 * var_x491;
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x748 = var_x747 * mParameters[22] / (pow(var_x293, 2) * pow(var_chaste_interface__intracellular_ions__cass, 3));
            ...
            const double var_x891 = (var_x14 * var_chaste_interface__ryr__Jrelp + var_x15 * var_chaste_interface__ryr__Jrelnp) * mParameters[7];
            const double var_x892 = var_x507 * var_x890;
            const double var_x893 = 0.00017227063561656592 * var_x780;
            
            partialF = var_x887 * (-5.0 + 1.7618587733512423e-9 * var_x755 + 1.882534732200483e-11 * var_x748 - 1.9380446506863667e-9 * var_x762 - 0.00017227063561656592 * var_x752 + var_x744 * var_x879 + (var_x889 * var_chaste_interface__ryr__Jrelp - var_x889 * var_chaste_interface__ryr__Jrelnp) * mParameters[7] - var_x750 * var_x890) + (0.019557600000000001 / pow(var_x883, 3) + 8.1780000000000006e-5 / pow(var_x884, 3)) * (5.0 * var_chaste_interface__intracellular_ions__cai + 0.23999999999999996 * var_x891 - 5.0 * var_chaste_interface__intracellular_ions__cass + var_x747 * var_x879 - var_x892 * var_chaste_interface__ICaL__d - var_x893 * var_chaste_interface__ICaL__d) / pow(var_x885, 2);
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x902 + 0.25 * (-var_x891 + 0.01 * var_chaste_interface__intracellular_ions__cansr - 0.01 * var_chaste_interface__intracellular_ions__cajsr) / (pow(var_x897, 3) * pow((0.125 + var_x898), 2));
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative22(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative22(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative23(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative23(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative24(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative24(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative26(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative26(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative27(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative27(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative28(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative28(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative31(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative31(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative32(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative32(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative33(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative33(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative34(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative34(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative35(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative35(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x1034 - var_x1044 - var_x1045;
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative36(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative36(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative37(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative37(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x1046 - var_x1053 - var_x1058;
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative38(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative38(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1067 = pow(mParameters[0], mParameters[6]);
            const double var_x1068 = var_x1067 * mParameters[1] * mParameters[3] / (var_x1067 + mParameters[5]);
            const double var_x1069 = -var_x1068;
            
            partialF = var_x1069 - var_x1059 - var_x1066;
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative39(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative39(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x1069 - var_x1047 - var_x1070;
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative40(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative40(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1062 = exp(2.9534155818343937);
            const double var_x1063 = exp(-0.02215 * var_chaste_interface__membrane__v);
            const double var_x1071 = var_x1060 * mParameters[3] / (var_x1062 * var_x1063);
            const double var_x1073 = 16.59612385832034 * var_x1071;
            const double var_x1078 = -mParameters[2];
            
            partialF = var_x1078 - var_x1073;
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative41(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative41(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x1078 - mParameters[3];
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative42(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative42(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1074 = exp(0.14729709824716453 * mParameters[4] - 0.14729709824716453 * var_chaste_interface__membrane__v);
            const double var_x1075 = 1.0 + var_x1074;
            const double var_x1079 = mParameters[2] / var_x1075;
            
            partialF = -2 * var_x1079;
        }
        else
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative43(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative43(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative44(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative44(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative45(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative45(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative46(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative46(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluateYDerivative47(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative47(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    std::vector<double> Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellohara_rudy_cipa_v1_2017FromCellMLGRL1>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellohara_rudy_cipa_v1_2017FromCellMLGRL1)
