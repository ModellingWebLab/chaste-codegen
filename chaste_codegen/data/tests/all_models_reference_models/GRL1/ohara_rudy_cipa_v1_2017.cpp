...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellohara_rudy_cipa_v1_2017FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x831 = var_x21 * var_x501 * mParameters[13];
            const double var_x832 = 0.0043750000000000004 * var_x827;
            const double var_x833 = 0.01203125 * var_x824;
            
            partialF = var_x821 * (-0.14705882352941174 - var_x830 + 2.2147467437652741e-12 * var_x548 + 3.0760371441184366e-5 * var_x530 - 3.0760371441184366e-5 * var_x526 + var_x546 * var_x817 + (0.00097665441176470586 * var_x828 + 0.00035514705882352943 * var_x829 - 0.00097665441176470586 * var_x824 - 0.00035514705882352943 * var_x827) * mParameters[8]) + (0.00023800000000000004 / pow(var_x818, 3) + 7.0000000000000007e-5 / pow(var_x527, 3)) * (0.14705882352941174 * var_chaste_interface__intracellular_ions__cass - 3.0760371441184366e-5 * ((var_x24) ? (var_x831 - var_x491 * (-var_x831 + var_x23 * var_x503 * mParameters[13])) : (var_x30 * var_x524)) - 0.14705882352941174 * var_chaste_interface__intracellular_ions__cai + var_x547 * var_x817 - var_x830 * var_chaste_interface__intracellular_ions__cai - 0.081176470588235281 * (-0.00026249999999999998 * var_chaste_interface__intracellular_ions__cansr + var_x832 * var_chaste_interface__intracellular_ions__cai + var_x833 * var_chaste_interface__intracellular_ions__cai) * mParameters[8]) / pow(var_x819, 2);
        }
        else
        {
