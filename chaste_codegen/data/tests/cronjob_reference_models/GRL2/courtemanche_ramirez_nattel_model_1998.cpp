...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_Na_Ca_exchanger_current__I_NaCa_max = 1600; // picoA_per_picoF
        ...
        const double var_background_currents__g_B_Ca = 0011310000000000001; // nanoS_per_picoF
        const double var_background_currents__g_B_Na = 00067443750000000002; // nanoS_per_picoF
        ...
        const double var_rapid_delayed_rectifier_K_current__g_Kr = 029411764999999999; // nanoS_per_picoF
        const double var_sarcolemmal_calcium_pump_current__i_CaP_max = 0.27500000000000002; // picoA_per_picoF
        const double var_sarcolemmal_calcium_pump_current__i_CaP = var_chaste_interface__intracellular_ion_concentrations__Ca_i * mParameters[0] * var_sarcolemmal_calcium_pump_current__i_CaP_max / (00050000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i); // picoA
        ...
        const double var_sodium_potassium_pump__Km_Na_i = 10; // millimolar
        ...
        const double var_standard_ionic_concentrations__Na_o = 140; // millimolar
        ...
        const double var_sodium_potassium_pump__sigma = -0.14285714285714285 + 0.14285714285714285 * exp(01485884101040119 * var_standard_ionic_concentrations__Na_o); // dimensionless
        const double var_sodium_potassium_pump__f_NaK = 1 / (1.0 + 0.1245 * exp(-0.10000000000000001 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + 036499999999999998 * var_sodium_potassium_pump__sigma * exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))); // dimensionless
        ...
        const double var_time_independent_potassium_current__g_K1 = 089999999999999997; // nanoS_per_picoF
        const double var_time_independent_potassium_current__i_K1 = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[0] * var_time_independent_potassium_current__g_K1 / (1.0 + exp(5.6000000000000005 + 070000000000000007 * var_chaste_interface__membrane__V)); // picoA
        ...
        const double var_ultrarapid_delayed_rectifier_K_current__g_Kur = 0050000000000000001 + 050000000000000003 / (1.0 + exp(1.1538461538461537 - 076923076923076927 * var_chaste_interface__membrane__V)); // nanoS_per_picoF
    ...
    void Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        // Mathematics
        double d_dt_chaste_interface_var_membrane__V;
        const double var_Ca_buffers__CMDN_max = 050000000000000003; // millimolar
        const double var_Ca_buffers__CSQN_max = 10; // millimolar
        const double var_Ca_buffers__Km_CMDN = 0023800000000000002; // millimolar
        const double var_Ca_buffers__Km_CSQN = 0.80000000000000004; // millimolar
        const double var_Ca_buffers__Km_TRPN = 00050000000000000001; // millimolar
        const double var_Ca_buffers__TRPN_max = 070000000000000007; // millimolar
        const double var_Ca_leak_current_by_the_NSR__Ca_up_max = 15.0; // millimolar
        const double var_Ca_release_current_from_JSR__K_rel = 30; // per_millisecond
        const double var_Ca_release_current_from_JSR_u_gate__tau_u = 8.0; // millisecond
        const double var_Ca_uptake_current_by_the_NSR__I_up_max = 0050000000000000001; // millimolar_per_millisecond
        const double var_Ca_uptake_current_by_the_NSR__K_up = 00092000000000000003; // millimolar
        const double var_L_type_Ca_channel__g_Ca_L = 0.12375; // nanoS_per_picoF
        ...
        const double var_intracellular_ion_concentrations__V_cell = 20100; // micrometre_3
        ...
        const double var_intracellular_ion_concentrations__V_rel = 0047999999999999996 * var_intracellular_ion_concentrations__V_cell; // micrometre_3
        const double var_intracellular_ion_concentrations__V_up = 055199999999999999 * var_intracellular_ion_concentrations__V_cell; // micrometre_3
        const double var_membrane__F = 96.486699999999999; // coulomb_per_millimole
        const double var_membrane__R = 8.3142999999999994; // joule_per_mole_kelvin
        const double var_membrane__T = 310; // kelvin
        ...
        const double var_Ca_release_current_from_JSR_w_gate__w_infinity = 1.0 - 1 / (1.0 + exp(2.3529411764705883 - 058823529411764705 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_L_type_Ca_channel_d_gate__tau_d = ((fabs(10 + var_chaste_interface__membrane__V) < 1.0e-10) ? (4.5789999999999997 / (1.0 + exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V))) : (28.571428571428569 * (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V)) / ((1.0 + exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V)) * (10 + var_chaste_interface__membrane__V)))); // millisecond
        ...
        const double var_L_type_Ca_channel_f_gate__tau_f = 9.0 / (02 + 019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2))); // millisecond
        ...
        const double var_rapid_delayed_rectifier_K_current__g_Kr = 029411764999999999; // nanoS_per_picoF
        const double var_rapid_delayed_rectifier_K_current_xr_gate__alpha_xr = ((fabs(14.1 + var_chaste_interface__membrane__V) < 1.0e-10) ? (0015) : (00029999999999999997 * (14.1 + var_chaste_interface__membrane__V) / (1.0 - exp(-2.8199999999999998 - 0.20000000000000001 * var_chaste_interface__membrane__V)))); // per_millisecond
        ...
        const double var_sarcolemmal_calcium_pump_current__i_CaP = var_chaste_interface__intracellular_ion_concentrations__Ca_i * mParameters[0] * var_sarcolemmal_calcium_pump_current__i_CaP_max / (00050000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i); // picoA
        const double var_slow_delayed_rectifier_K_current__g_Ks = 0.12941175999999999; // nanoS_per_picoF
        const double var_slow_delayed_rectifier_K_current_xs_gate__alpha_xs = ((fabs(-19.899999999999999 + var_chaste_interface__membrane__V) < 1.0e-10) ? (00068000000000000005) : (4.0000000000000003e-5 * (-19.899999999999999 + var_chaste_interface__membrane__V) / (1.0 - exp(1.1705882352941175 - 058823529411764705 * var_chaste_interface__membrane__V)))); // per_millisecond
        const double var_slow_delayed_rectifier_K_current_xs_gate__beta_xs = ((fabs(-19.899999999999999 + var_chaste_interface__membrane__V) < 1.0e-10) ? (00031500000000000001) : (3.4999999999999997e-5 * (-19.899999999999999 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.2111111111111108 + 0.1111111111111111 * var_chaste_interface__membrane__V)))); // per_millisecond
        ...
        const double var_slow_delayed_rectifier_K_current_xs_gate__xs_infinity = pow((1.0 + exp(1.5669291338582676 - 07874015748031496 * var_chaste_interface__membrane__V)), (-0.5)); // dimensionless
        ...
        const double var_Ca_release_current_from_JSR_u_gate__u_infinity = 1 / (1.0 + exp(250 - 731528895391368.0 * var_Ca_release_current_from_JSR__Fn)); // dimensionless
        const double var_Ca_release_current_from_JSR_v_gate__tau_v = 1.9099999999999999 + 2.0899999999999999 / (1.0 + exp(250 - 731528895391368.0 * var_Ca_release_current_from_JSR__Fn)); // millisecond
        const double var_Ca_release_current_from_JSR_v_gate__v_infinity = 1.0 - 1 / (1.0 + exp(50 - 731528895391368.0 * var_Ca_release_current_from_JSR__Fn)); // dimensionless
        ...
        const double var_time_independent_potassium_current__g_K1 = 089999999999999997; // nanoS_per_picoF
        const double var_time_independent_potassium_current__i_K1 = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[0] * var_time_independent_potassium_current__g_K1 / (1.0 + exp(5.6000000000000005 + 070000000000000007 * var_chaste_interface__membrane__V)); // picoA
        const double var_transfer_current_from_NSR_to_JSR__tau_tr = 180; // millisecond
        ...
        const double var_transient_outward_K_current__g_to = 0.16520000000000001; // nanoS_per_picoF
        const double var_transient_outward_K_current_oa_gate__alpha_oa = 0.65000000000000002 / (exp(0.50847457627118642 - 016949152542372881 * var_chaste_interface__membrane__V) + exp(-1.1764705882352942 - 0.11764705882352941 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_transient_outward_K_current_oa_gate__beta_oa = 0.65000000000000002 / (2.5 + exp(4.8235294117647056 + 058823529411764705 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_transient_outward_K_current_oa_gate__oa_infinity = 1 / (1.0 + exp(-1.1670467502850628 - 057012542759407071 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_transient_outward_K_current_oi_gate__alpha_oi = 1 / (18.530000000000001 + 1.0 * exp(10.383561643835618 + 091324200913242018 * var_chaste_interface__membrane__V)); // per_millisecond
        ...
        const double var_ultrarapid_delayed_rectifier_K_current__g_Kur = 0050000000000000001 + 050000000000000003 / (1.0 + exp(1.1538461538461537 - 076923076923076927 * var_chaste_interface__membrane__V)); // nanoS_per_picoF
        const double var_ultrarapid_delayed_rectifier_K_current_ua_gate__alpha_ua = 0.65000000000000002 / (exp(0.50847457627118642 - 016949152542372881 * var_chaste_interface__membrane__V) + exp(-1.1764705882352942 - 0.11764705882352941 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_ultrarapid_delayed_rectifier_K_current_ua_gate__beta_ua = 0.65000000000000002 / (2.5 + exp(4.8235294117647056 + 058823529411764705 * var_chaste_interface__membrane__V)); // per_millisecond
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__alpha_ui = 1 / (21.0 + 1.0 * exp(6.6071428571428568 - 035714285714285712 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__beta_ui = 1.0 / exp(9.875 - 0625 * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__ui_infinity = 1 / (1.0 + exp(-3.6189956331877728 + 036390101892285295 * var_chaste_interface__membrane__V)); // dimensionless
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x159 = 00029999999999999997 / var_x158;
            ...
            const double var_x165 = ((var_x155) ? (0015) : (var_x154 * var_x159));
            const double var_x166 = ((var_x161) ? (00037836118) : (var_x160 * var_x164));
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x178 = 2.0 * ((var_x170) ? (00068000000000000005) : (var_x169 * var_x177));
            const double var_x179 = 2.0 * ((var_x170) ? (00031500000000000001) : (var_x169 * var_x173));
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x188 = 035000000000000003 * var_x186 * var_x187;
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x191 = 0021888888888888887 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
            
            partialF = -0022222222222222222 - var_x191;
        }
        else
        {
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x204 = -00011173862339878819 * var_x197 + var_x195 * var_x203 - var_x198 * var_x202;
            const double var_x205 = exp(250 + var_x204);
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x222 = exp(50 + var_x204);
            ...
            const double var_x230 = 1013080166606582 * var_x226;
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x201 = var_x200 * var_chaste_interface__Ca_release_current_from_JSR_v_gate__v;
            const double var_x203 = -65.0 + var_chaste_interface__membrane__V;
            const double var_x244 = 0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
            const double var_x245 = 1.0 + 00011900000000000002 / pow(var_x244, 2) + 3.5000000000000004e-5 * var_x66;
            ...
            const double var_x251 = 1.0 + 00092000000000000003 * var_x64;
            ...
            partialF = var_x246 * (-var_x253 - var_x254 + 1.0426301393780176e-7 * var_x67 - 00030665564809977873 * var_x68 - 3.7341176470588232e-7 * var_x252 - 5.7273025005690459e-9 * var_x65) + (00023800000000000004 / pow(var_x244, 3) + 7.0000000000000007e-5 / pow(var_x62, 3)) * (2.7058823529411762e-5 * var_chaste_interface__intracellular_ion_concentrations__Ca_up + 1.1175497379729545e-10 * var_x197 - 00040588235294117644 / var_x251 + var_x198 * var_x254 - var_x203 * var_x248 - var_x247 * (-13.356415961992688 * log(1.8 * var_x64) + var_chaste_interface__membrane__V) - var_x253 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) / pow(var_x245, 2);
        }
        else
        {
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x261 = 30 * var_x201;
            
            partialF = var_x259 * (-0055555555555555558 - var_x261) + 0.25 * (0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_rel - var_x198 * var_x261) / (pow(var_x257, 3) * pow((0.125 + var_x258), 2));
        }
        else
        {
