...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        this->mParameters[3] = 072999999999999995; // (var_transient_outward_current__g_to) [nanoS_per_picoF]
    }
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double d_dt_chaste_interface_var_transient_outward_current_s_gate__s = (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / (1.0 + exp(5.5999999999999996 + 0.20000000000000001 * var_chaste_interface__membrane__V))) / (8.0 + 1000 * exp(-4.4889999999999999 * pow((1 + 014925373134328358 * var_chaste_interface__membrane__V), 2))); // 1 / millisecond
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x223 = exp(-4.4889999999999999 * pow((1 + 014925373134328358 * var_chaste_interface__membrane__V), 2));
            const double var_x224 = 1 / (8.0 + 1000 * var_x223);
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x214 = var_chaste_interface__membrane__V > -60;
            const double var_x233 = var_chaste_interface__calcium_dynamics__Ca_i >= 00035;
            const double var_x234 = var_chaste_interface__calcium_dynamics__Ca_i < 00035;
            ...
            const double var_x237 = (((var_x214) || (var_x233))) && (((var_x214) || (var_x234))) && (((var_x233) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 5.439910241481016e+20 * var_x235)))) && (((var_x234) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 1.9720198874049176e+55 * var_x236))));
    ...
    double Cellten_tusscher_model_2004_endoFromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 00010126109252331096 * var_x93 - 0073440052301827737 * var_x85 - 0031224512033090025 * var_x92 - 0016876848753885161 * var_x88 - 4.5587787568311439e-5 * var_x87 - 0031224512033090025 * var_x89 - var_x238 * var_x91;
        }
        else
        {
