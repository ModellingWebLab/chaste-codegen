...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellbondarenko_model_2004_apexFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rJacobian[32][32])
    {
        ...
        const double var_x40 = 4.5 * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x41 = 4.5 * var_chaste_interface__ryanodine_receptors__P_O2;
        ...
        const double var_x47 = var_x44 * var_chaste_interface__calcium_fluxes__P_RyR;
        ...
        const double var_x100 = 1.0 * var_chaste_interface__potassium_concentration__Ki + 0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai;
        const double var_x101 = (2.4715768660405338e-6 * var_chaste_interface__sodium_concentration__Nai + 0.00012110726643598615 * var_chaste_interface__potassium_concentration__Ki) * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K / pow(var_x100, 2);
        ...
        const double var_x113 = pow(var_chaste_interface__calcium_concentration__Cass, 3.0);
        const double var_x114 = -0.0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4.0);
        const double var_x115 = 0.0040499999999999998 * var_x113;
        ...
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        rJacobian[9][9] = 1.0 - (mDt * (var_x44 * (-0.050000000000000003 + (-var_x40 - var_x41) * var_chaste_interface__calcium_fluxes__P_RyR) + 0.00013333333333333334 * (0.050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 4.5 * var_x46 - 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR) / (pow(var_x42, 3) * pow((0.053333333333333337 + var_x43), 2))));
        rJacobian[9][10] = -(mDt * (0.050000000000000003 * var_x44));
        rJacobian[9][11] = 0.0;
        rJacobian[9][12] = -(mDt * (var_x47 * (var_x40 + var_x41)));
        rJacobian[9][13] = -(mDt * (var_x44 * var_x45 * var_x48));
        rJacobian[9][14] = 0.0;
        rJacobian[9][15] = 0.0;
        rJacobian[9][16] = 0.0;
        rJacobian[9][17] = 0.0;
        ...
        rJacobian[29][10] = 0.0;
        rJacobian[29][11] = 0.0;
        rJacobian[29][12] = -(mDt * (-var_x112 + 0.024299999999999999 * var_x113 * (1.0 - var_chaste_interface__ryanodine_receptors__P_C2 - var_chaste_interface__ryanodine_receptors__P_O1 - var_chaste_interface__ryanodine_receptors__P_O2)));
        rJacobian[29][13] = 0.0;
        rJacobian[29][14] = 0.0;
        rJacobian[29][15] = 0.0;
        rJacobian[29][16] = 0.0;
