...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellcourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[8], double rJacobian[8][8])
    {
        ...
        const double var_x33 = 0.00050000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        ...
        const double var_x36 = 1.0 + 0.00011900000000000002 / pow(var_x35, 2) + 3.5000000000000004e-5 * var_x34;
        const double var_x37 = 1 / var_x36;
        const double var_x38 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x39 = 0.21176470588235291 * var_x8;
        const double var_x40 = 1.0426301393780176e-5 / var_x33;
        const double var_x41 = 1.0 + 0.00092000000000000003 * var_x38;
        const double var_x42 = 1 / (pow(var_x41, 2) * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 2));
        ...
        rJacobian[3][3] = 1.0 - (mDt * (var_x37 * (-var_x39 - var_x40 - 3.7341176470588232e-7 * var_x42 - 0.030665564809977872 * var_x19 - 5.727302500569046e-7 * var_x38 + 1.0426301393780176e-5 * var_x34 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) + (0.00023800000000000004 / pow(var_x35, 3) + 7.0000000000000007e-5 / pow(var_x33, 3)) * (5.727302500569046e-7 * log(1.8 * var_x38) + 1.1175497379729546e-8 * var_x3 + 2.7058823529411762e-5 * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 4.6918356272010783e-6 * var_x5 - 0.00040588235294117644 / var_x41 - 4.28805340958741e-8 * var_chaste_interface__membrane__V + var_x39 * var_x6 - var_x40 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) / pow(var_x36, 2)));
        rJacobian[3][4] = -(mDt * (var_x37 * var_x39));
        ...
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (4.6e-6 * var_x42));
