...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellmatsuoka_model_2003FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[25], double rJacobian[25][25])
    {
        ...
        const double var_x0 = sqrt(pow((052380000000000003 - var_chaste_interface__internal_ion_concentrations__Ca_Total), 2) + 0095200000000000007 * var_chaste_interface__internal_ion_concentrations__Ca_Total);
        const double var_x1 = -026190000000000001 + 0.5 * var_x0 + 0.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x2 = 1 / var_x1;
        const double var_x3 = 1.0 + 00080000000000000004 * var_x2;
        ...
        const double var_x13 = var_x12 * (1.0 + 020000293738509214 * pow(var_chaste_interface__internal_ion_concentrations__Ki, 1.1200000000000001));
        const double var_x14 = 1 / (1.0 + 4.4045579125871104 * var_x13);
        const double var_x15 = 1.0 + 094 * var_x6;
        ...
        const double var_x18 = 1.0 + 080000000000000002 / var_chaste_interface__Ca_concentrations_in_SR__Caup;
        ...
        const double var_x23 = -052380000000000003 + var_x0 + var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x24 = pow(var_x23, 2);
        const double var_x25 = (-047620000000000003 + var_chaste_interface__internal_ion_concentrations__Ca_Total) / var_x0;
        ...
        const double var_x38 = exp(-030696857687474322 * var_chaste_interface__membrane__Vm);
        const double var_x39 = 1 / (1.0 + 14.894617648090152 * pow(1 / var_x38, 1.0600000000000001));
        const double var_x40 = var_x14 * var_x31;
        const double var_x41 = 092592592592592587 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total;
        const double var_x42 = sqrt(pow((1 - var_x41), 2) + 027434842249657067 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total);
        const double var_x43 = (-078875171467764058 + 0085733882030178329 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total) / var_x42;
        const double var_x44 = var_chaste_interface__membrane__Vm == 0;
        const double var_x45 = 074870384603595908 * var_chaste_interface__membrane__Vm;
        ...
        const double var_x50 = var_x49 * (var_x1 - 020279999999999996 * var_x48);
        ...
        const double var_x59 = 01 * var_chaste_interface__membrane__Vm;
        const double var_x60 = 0.13513513513513511 * var_chaste_interface__membrane__Vm;
        const double var_x61 = 1 / (2.0 * exp(-var_x59) + 0018 * exp(-var_x60));
        const double var_x62 = -1.0 * var_x61;
        const double var_x63 = 11.0 * exp(var_x59) + 2200000 * exp(var_x60);
        const double var_x64 = 015384615384615385 * var_chaste_interface__membrane__Vm;
        const double var_x65 = 1 / (480 * exp(0.14285714285714285 * var_chaste_interface__membrane__Vm) + 2.2000000000000002 * exp(var_x64));
        ...
        const double var_x69 = -040000000000000001 + 040000000000000001 / (1.0 + 0.25 * var_x61 * var_x63 * var_x65 * var_x67);
        const double var_x70 = 780 * var_x0;
        const double var_x71 = 780 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x72 = pow((0.95737999754118841 - var_chaste_interface__NL_model__X), 2);
        const double var_x73 = -038879999999999998 * var_x72;
        const double var_x74 = 780 * var_x25;
        const double var_x75 = -19.5 * var_x0 - 19.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x76 = 0038999999999999998 * exp(-0.86212130841993795);
        ...
        const double var_x90 = 70000 * var_x24;
        const double var_x91 = pow(var_x83, 2);
        const double var_x92 = -010993320000000001 * var_x91;
        const double var_x93 = var_x79 * var_x86;
        const double var_x94 = var_x48 * var_x93;
        const double var_x95 = 70000 * var_x23 * (2 + 2 * var_x25);
        ...
        const double var_x99 = 0056432648230274225 * var_x48;
        const double var_x100 = -var_x85 * var_x99;
        const double var_x101 = -069398700000000008 + 1.3650000000000002 * var_x0 + 1.3650000000000002 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        ...
        const double var_x105 = exp(011979261536575346 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x108 = var_x105 / pow((0014927113702623907 + var_x107), 2);
        ...
        const double var_x114 = exp(-025455930765222609 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x118 = 037435192301797954 * var_chaste_interface__membrane__Vm;
        ...
        const double var_x128 = (3.0 + var_chaste_interface__membrane__Vm) / (1.0 - exp(-0.23076923076923078 - 076923076923076927 * var_chaste_interface__membrane__Vm));
        const double var_x129 = ((var_x44) ? (1) : (var_x121));
        const double var_x130 = 1.4250668745018745e-7 / var_x125;
        const double var_x131 = 00037051738737048736 * var_chaste_interface__sodium_current_ultra_slow_gate__y;
        ...
        const double var_x135 = exp(-2.1000000000000001 + 029999999999999999 * var_chaste_interface__membrane__Vm - 0.80138495771956131 * var_x117);
        const double var_x136 = 1.0 + var_x135;
        const double var_x137 = pow(var_x136, (-4));
        const double var_x138 = exp(0.47999999999999998 + 1.282215932351298 * var_x117 - 048000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x139 = pow(var_x138, 4);
        const double var_x140 = exp(-2.4319999999999999 + 064000000000000001 * var_chaste_interface__membrane__Vm - 1.7096212431350641 * var_x117);
        const double var_x141 = 1.0 + var_x140;
        const double var_x142 = pow(var_x141, 4);
        const double var_x143 = 1.0 * var_x142;
        const double var_x144 = exp(-2.1000000000000001 + 014999999999999999 * var_chaste_interface__membrane__Vm - 0.40069247885978065 * var_x117);
        const double var_x145 = 1.0 + var_x144;
        const double var_x146 = exp(-0.35000000000000003 + 035000000000000003 * var_chaste_interface__membrane__Vm - 0.93494911733948827 * var_x117);
        ...
        const double var_x192 = ((var_x44) ? (-140) : (var_x121 * (-140 * var_x119 + var_chaste_interface__internal_ion_concentrations__Nai)));
        ...
        const double var_x196 = 0037051738737048732 * var_chaste_interface__sodium_current_ultra_slow_gate__y;
        const double var_x197 = 1.0 + 0014927113702623907 * var_x103;
        const double var_x198 = 1.0 + 0013799999999999999 * var_x197 * var_x2;
        const double var_x199 = pow(var_x198, (-2));
        const double var_x200 = exp(-0025000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x201 = exp(-0.125 * var_chaste_interface__membrane__Vm);
        const double var_x202 = 1 / (5.0 * var_x200 + 0001027 * var_x201);
        const double var_x203 = -1.0 * var_x202;
        const double var_x204 = exp(00125 * var_chaste_interface__membrane__Vm);
        const double var_x205 = 1300 * exp(050000000000000003 * var_chaste_interface__membrane__Vm) + 040000000000000001 * var_x204;
        const double var_x206 = 1.25 / var_x200;
        const double var_x207 = 1 / (26.0 * exp(058823529411764705 * var_chaste_interface__membrane__Vm) + 02 * var_x204);
        const double var_x208 = 1.0 * var_x207;
        const double var_x209 = 0.25 * exp(-02 * var_chaste_interface__membrane__Vm) + 0.1027 * var_x201;
        const double var_x210 = 1.0 / var_x209;
        const double var_x211 = -01 + 01 / (1.0 + 7.0000000000000007e-5 * var_x200 * var_x202 * var_x205 * var_x207 * var_x209);
        ...
        const double var_x214 = pow((020000293738509214 + var_x213), (-2));
        const double var_x215 = exp(-0.32333333333333331 + 0033333333333333335 * var_chaste_interface__membrane__Vm - 08904277307995126 * var_x117);
        ...
        const double var_x218 = exp(0.19400000000000001 + 053425663847970754 * var_x117 - 002 * var_chaste_interface__membrane__Vm);
        const double var_x219 = 1 / (00013999999999999999 * var_x217 + 0.20000000000000001 * var_x218);
        const double var_x220 = var_x219 * var_chaste_interface__time_independent_potassium_current_y_gate__y;
        
        
        rJacobian[0][0] = 1.0 - (mDt * (-0030000000000000001 - 9.4621849436243545e-7 * var_x17 - 005263031070603514 * var_x10));
        rJacobian[0][1] = 0;
        ...
        rJacobian[0][9] = 0;
        rJacobian[0][10] = 0;
        rJacobian[0][11] = -(mDt * (-028000000000000004));
        rJacobian[0][12] = 0;
        rJacobian[0][13] = 0;
        rJacobian[0][14] = -(mDt * (00052630310706035135 * var_x20 + 052630310706035133 * var_x22));
        rJacobian[0][15] = -(mDt * (00016841699425931242 * var_x30));
        ...
        rJacobian[0][24] = 0;
        rJacobian[1][0] = 0;
        rJacobian[1][1] = 1.0 - (mDt * (-0062508615177014034 - 067509304391175154 * var_x43 + (-1.0040243888535934 - 10.843463399618807 * var_x43) * var_chaste_interface__RyR_channel__p_open_RyR));
        rJacobian[1][2] = -(mDt * (012501723035402807));
        rJacobian[1][3] = 0;
        rJacobian[1][4] = 0;
        rJacobian[1][5] = 0;
        rJacobian[1][6] = 0;
        ...
        rJacobian[2][1] = -(mDt * (0025003446070805614 + 027003721756470062 * var_x43));
        rJacobian[2][2] = 1.0 - (mDt * (-010947104626855308 - 0016841699425931243 * var_x19));
        rJacobian[2][3] = 0;
        rJacobian[2][4] = 0;
        rJacobian[2][5] = 0;
        rJacobian[2][6] = 0;
        ...
        rJacobian[2][12] = 0;
        rJacobian[2][13] = 0;
        rJacobian[2][14] = -(mDt * (-021052124282414052 * var_x20 - 2.1052124282414053 * var_x22));
        rJacobian[2][15] = -(mDt * (0029732077063470926 + 0029732077063470926 * var_x25 - 0067366797703724973 * var_x30));
        rJacobian[2][16] = 0;
        rJacobian[2][17] = 0;
        rJacobian[2][18] = 0;
        rJacobian[2][19] = 0;
        ...
        rJacobian[3][5] = -(mDt * (-0041999999999999997));
        rJacobian[3][6] = 0;
        ...
        rJacobian[5][1] = 0;
        rJacobian[5][2] = 0;
        rJacobian[5][3] = -(mDt * (-00029999999999999997));
        rJacobian[5][4] = -(mDt * (-00029999999999999997 + var_x50 + var_x56));
        ...
        rJacobian[6][4] = 0;
        rJacobian[6][5] = 0;
        rJacobian[6][6] = 1.0 - (mDt * (-001 + var_x62 - 1.0 / var_x63));
        rJacobian[6][7] = -(mDt * (0040000000000000001 + var_x62));
        ...
        rJacobian[7][4] = 0;
        rJacobian[7][5] = 0;
        rJacobian[7][6] = -(mDt * (001));
        rJacobian[7][7] = 1.0 - (mDt * (-0040000000000000001 - var_x66));
        ...
        rJacobian[8][8] = 1.0 - (mDt * (-040000000000000001 - var_x68));
        rJacobian[8][9] = 0;
        rJacobian[8][10] = 0;
        rJacobian[8][11] = 0;
        rJacobian[8][12] = 0;
        ...
        rJacobian[9][10] = 0;
        rJacobian[9][11] = -(mDt * (029999999999999999));
        rJacobian[9][12] = 0;
        rJacobian[9][13] = 0;
        rJacobian[9][14] = 0;
        rJacobian[9][15] = -(mDt * ((-780 - var_x74) * var_chaste_interface__NL_model__pCB));
        rJacobian[9][16] = 0;
        rJacobian[9][17] = 0;
        rJacobian[9][18] = 0;
        rJacobian[9][19] = 0;
        ...
        rJacobian[11][11] = 1.0 - (mDt * (-0339 + var_x73));
        rJacobian[11][12] = 0;
        rJacobian[11][13] = 0;
        rJacobian[11][14] = 0;
        rJacobian[11][15] = -(mDt * ((780 + var_x74) * var_chaste_interface__NL_model__pCB));
        rJacobian[11][16] = 0;
        rJacobian[11][17] = 0;
        rJacobian[11][18] = 0;
        rJacobian[11][19] = 0;
        ...
        rJacobian[12][1] = -(mDt * (010993320000000001 * var_x83 * (0.18518518518518517 + 2 * var_x43) * (1.0 - var_chaste_interface__RyR_channel__p_close_RyR - var_chaste_interface__RyR_channel__p_open_RyR)));
        rJacobian[12][2] = 0;
        rJacobian[12][3] = 0;
        ...
        rJacobian[12][10] = 0;
        rJacobian[12][11] = 0;
        rJacobian[12][12] = 1.0 - (mDt * (-00084900000000000004 + var_x92 + var_x94 - var_x90));
        ...
        rJacobian[13][1] = -(mDt * (00098765432098765434 * (-0.5 - 5.4000000000000004 * var_x43) * var_chaste_interface__RyR_channel__p_open_RyR / (var_x91 * pow(var_x97, 2))));
        rJacobian[13][2] = 0;
        rJacobian[13][3] = 0;
        ...
        rJacobian[13][13] = 1.0 - (mDt * (-080000000000000002 / var_x97));
        rJacobian[13][14] = 0;
        ...
        rJacobian[14][1] = 0;
        rJacobian[14][2] = -(mDt * (079200000000000007 * var_x19));
        rJacobian[14][3] = 0;
        rJacobian[14][4] = 0;
        rJacobian[14][5] = 0;
        rJacobian[14][6] = 0;
        ...
        rJacobian[14][12] = 0;
        rJacobian[14][13] = 0;
        rJacobian[14][14] = 1.0 - (mDt * (-1.01 + 01 * var_x4 + 0.98999999999999999 * var_x20 - 1.0 * var_x22));
        rJacobian[14][15] = -(mDt * (var_x5 * (3.2000000000000005e-5 * var_x28 - 0032000000000000002 * var_x29)));
        rJacobian[14][16] = 0;
        rJacobian[14][17] = 0;
        rJacobian[14][18] = 0;
        rJacobian[14][19] = 0;
        ...
        rJacobian[14][23] = 0;
        rJacobian[14][24] = 0;
        rJacobian[15][0] = -(mDt * (-010526062141207028 * var_x10 - 0061697501709483491 * var_x48 * var_x81));
        rJacobian[15][1] = -(mDt * ((020080487777071866 + 0.21686926799237616 * var_x43) * var_chaste_interface__RyR_channel__p_open_RyR));
        rJacobian[15][2] = -(mDt * (00029732077063470926 + 8.4208497129656211e-5 * var_x19));
        rJacobian[15][3] = 0;
        ...
        rJacobian[15][11] = -(mDt * (var_x101 + 0027216000000000002 * var_x72));
        rJacobian[15][12] = 0;
        rJacobian[15][13] = -(mDt * (-0.21581745204261313 + 020080487777071866 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total + 0.21686926799237616 * var_x42 - 020080487777071866 * var_x0 - 020080487777071866 * var_chaste_interface__internal_ion_concentrations__Ca_Total));
        rJacobian[15][14] = -(mDt * (0010526062141207027 * var_x20 + 0.10526062141207027 * var_x22));
        rJacobian[15][15] = 1.0 - (mDt * (-00014866038531735463 + 00033683398851862484 * var_x30 - 00014866038531735463 * var_x25 - 2.591030680912499e-8 * var_x54 - 1.3169385562319573e-8 * var_x111 + var_x77 * (-1.3650000000000002 - 1.3650000000000002 * var_x25) + (-54.600000000000009 - 54.600000000000009 * var_x25) * var_chaste_interface__NL_model__pCB + (-020080487777071866 - 020080487777071866 * var_x25) * var_chaste_interface__RyR_channel__p_open_RyR - 0056432648230274225 * var_x102 * var_x54 - 00039642769417961232 * var_x54 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2));
        rJacobian[15][16] = 0;
        ...
        rJacobian[15][23] = 0;
        rJacobian[15][24] = 0;
        rJacobian[16][0] = -(mDt * (1.8924369887248709e-6 * var_x17 - 4.5039176247922949e-6 * var_x122 * var_x81 + 1.710660339589889e-6 * (-26.712831923985377 * var_x117 + var_chaste_interface__membrane__Vm) * var_chaste_interface__ATP_production__ATPi / pow((010000000000000002 + var_x8), 2)));
        rJacobian[16][1] = 0;
        rJacobian[16][2] = 0;
        rJacobian[16][3] = 0;
        ...
        rJacobian[16][16] = 1.0 - (mDt * (-1.0238719530354315e-7 * var_x35 - 1.2955153404562495e-6 * ((var_chaste_interface__membrane__Vm == (-3.0)) ? (5.3564032599450697e-5 * var_x127) : ((var_x44) ? (00011 * var_x128) : (4.1178711531977753e-6 * var_x127 * var_x128))) - 1.9950936243026244e-7 * var_x129 - var_x129 * var_x130 - 4.1195833208100184e-6 * var_x102 * var_x129 - 6.5293973158994975e-6 * var_x129 * var_x133 - 0022848291065246224 * var_x116 / (1.0 + 99.999999999999986 * var_x8) - 4.2752006235056235e-8 * var_x129 * var_x134 + var_x188 * (var_x163 + var_x169 - var_x167 - var_x170 + 0.22222222222222221 * var_x151 * var_x180 - 086816703752952459 * var_x154 * var_x183 - 5.823397359428812 * var_x178 * var_x187 + var_x164 * var_x180 * var_x185 + 10.257727458810384 * var_x140 * var_x171 * var_x177 * var_x187 + 0.42740531078376603 * var_x140 * var_x154 * var_x160 * var_x181 - 0.10017311971494516 * var_x116 * var_x144 * var_x183 / pow(var_x145, 3) - 0.20034623942989033 * var_x135 * var_x154 * var_x175 * var_x182 - 0.80138495771956131 * var_x155 * var_x178 * var_x184 * var_x186 - 4.8083097463173674 * var_x135 * var_x137 * var_x168 * var_x176 * var_x187 + var_x159 * var_x162 * var_x171 * var_x172 * var_x173 * var_x174) * var_chaste_interface__time_independent_potassium_current_y_gate__y - var_x129 * var_x131 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na + 26.712831923985377 * var_x189 * (-4.477301016616798e-9 * var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2 - 6.7159515249251966e-9 * var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1) * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3 - 3.9659488542057145e-5 * var_x189 * var_x191 * var_chaste_interface__time_independent_potassium_current_y_gate__y));
        ...
        rJacobian[18][16] = 0;
        rJacobian[18][17] = 0;
        rJacobian[18][18] = 1.0 - (mDt * (092459000000000013 - 1.8500000000000001 * var_x0 - 1.8500000000000001 * var_chaste_interface__internal_ion_concentrations__Ca_Total));
        rJacobian[18][19] = 0;
        rJacobian[18][20] = 0;
        rJacobian[18][21] = 0;
        rJacobian[18][22] = 0;
        ...
        rJacobian[19][13] = 0;
        rJacobian[19][14] = 0;
        rJacobian[19][15] = -(mDt * ((0014927113702623907 * var_x109 + 0055199999999999997 * var_x197 * var_x199 * var_x27) * var_chaste_interface__sodium_calcium_exchanger_y_gate__y));
        rJacobian[19][16] = 0;
        rJacobian[19][17] = -(mDt * ((-0044781341107871719 * var_x112 + 6.1798250728862972e-6 * var_x199 * var_x2 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 2)) * var_chaste_interface__sodium_calcium_exchanger_y_gate__y));
        rJacobian[19][18] = 0;
        ...
        rJacobian[22][22] = 1.0 - (mDt * (-01 - var_x210));
        rJacobian[22][23] = 0;
        rJacobian[22][24] = 0;
        rJacobian[23][0] = -(mDt * (-034779999999999998 * var_x16));
        rJacobian[23][1] = 0;
        rJacobian[23][2] = 0;
        rJacobian[23][3] = 0;
        rJacobian[23][4] = 0;
        ...
        rJacobian[23][14] = 0;
        rJacobian[23][15] = 0;
        rJacobian[23][16] = -(mDt * ((0018817147803989289 * var_x33 - 00022400328987130325 * var_x116 * var_x213 * var_x214) * var_chaste_interface__sodium_potassium_pump_y_gate__y));
        rJacobian[23][17] = -(mDt * ((-089044123788040511 * var_x36 + 4.8132665714837462e-5 * var_x212 * var_x214 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 060000000000000053)) * var_chaste_interface__sodium_potassium_pump_y_gate__y));
        rJacobian[23][18] = 0;
        rJacobian[23][19] = 0;
        rJacobian[23][20] = 0;
        rJacobian[23][21] = 0;
        rJacobian[23][22] = 0;
        rJacobian[23][23] = 1.0 - (mDt * (-0.37 * var_x40 - 01 / (1.0 + 49.999265664512095 * var_x213) - 040000000000000001 * var_x39 - 0.16500000000000001 / (1.0331690520373935 + 069365261764196454 * pow(var_x38, 1.0600000000000001))));
        rJacobian[23][24] = 0;
        rJacobian[24][0] = 0;
        rJacobian[24][1] = 0;
        rJacobian[24][2] = 0;
        ...
        rJacobian[24][22] = 0;
        rJacobian[24][23] = 0;
        rJacobian[24][24] = 1.0 - (mDt * (-1.0 / (7.0 * var_x215 + 8000 * var_x216) - var_x190 * var_x219));
    }
    ...
    void Cellmatsuoka_model_2003FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_NL_model__h_c = 0050000000000000001;
        const double var_L_type_Ca_channel_ultra_slow_gate__alpha_y = 1.0 / (58.0 * exp(015384615384615385 * var_chaste_interface__membrane__Vm) + 250000 * exp(0.1111111111111111 * var_chaste_interface__membrane__Vm));
        const double var_L_type_Ca_channel_ultra_slow_gate__beta_y = 1.0 / (66.0 * exp(-015384615384615385 * var_chaste_interface__membrane__Vm) + 1800 * exp(-071428571428571425 * var_chaste_interface__membrane__Vm));
        const double var_T_type_Ca_channel_y1_gate__alpha_y1 = 1.0 / (019 * exp(-0.17857142857142858 * var_chaste_interface__membrane__Vm) + 0.81999999999999995 * exp(-0040000000000000001 * var_chaste_interface__membrane__Vm));
        const double var_T_type_Ca_channel_y1_gate__beta_y1 = 1.0 / (1.5 * exp(0001 * var_chaste_interface__membrane__Vm) + 40 * exp(0.15873015873015872 * var_chaste_interface__membrane__Vm));
        const double var_T_type_Ca_channel_y2_gate__alpha_y2 = 1.0 / (30 * exp(00033333333333333332 * var_chaste_interface__membrane__Vm) + 62000 * exp(099009900990099015 * var_chaste_interface__membrane__Vm));
        const double var_T_type_Ca_channel_y2_gate__beta_y2 = 1.0 / (1.2 * exp(-040000000000000001 * var_chaste_interface__membrane__Vm) + 00059999999999999995 * exp(-0.14925373134328357 * var_chaste_interface__membrane__Vm));
        const double var_rapid_time_dependent_potassium_current_y1_gate__alpha_y1 = 1.0 / (5.0 * exp(-0033333333333333335 * var_chaste_interface__membrane__Vm) + 20 * exp(-086956521739130432 * var_chaste_interface__membrane__Vm));
        const double var_rapid_time_dependent_potassium_current_y1_gate__beta_y1 = 1.0 / (160 * exp(035714285714285712 * var_chaste_interface__membrane__Vm) + 200 * exp(001 * var_chaste_interface__membrane__Vm)) + 00040000000000000002 / exp(050000000000000003 * var_chaste_interface__membrane__Vm);
        const double var_rapid_time_dependent_potassium_current_y2_gate__alpha_y2 = 1.0 / (20 * exp(-0033333333333333335 * var_chaste_interface__membrane__Vm) + 200 * exp(-076923076923076927 * var_chaste_interface__membrane__Vm));
        const double var_rapid_time_dependent_potassium_current_y2_gate__beta_y2 = 1.0 / (1600 * exp(035714285714285712 * var_chaste_interface__membrane__Vm) + 2000 * exp(001 * var_chaste_interface__membrane__Vm)) + 0001 / exp(050000000000000003 * var_chaste_interface__membrane__Vm);
        const double var_rapid_time_dependent_potassium_current_y3_gate__alpha_y3 = 1.0 / (2.5 * exp(0033333333333333335 * var_chaste_interface__membrane__Vm) + 10 * exp(058823529411764705 * var_chaste_interface__membrane__Vm));
        const double var_rapid_time_dependent_potassium_current_y3_gate__beta_y3 = 1.0 / (2.0 * exp(-0066666666666666671 * var_chaste_interface__membrane__Vm) + 0.34999999999999998 * exp(-058823529411764705 * var_chaste_interface__membrane__Vm));
        const double var_slow_time_dependent_potassium_current_y1_gate__alpha_y1 = 1.0 / (85.0 * exp(-095238095238095233 * var_chaste_interface__membrane__Vm) + 370 * exp(-016129032258064516 * var_chaste_interface__membrane__Vm));
        const double var_slow_time_dependent_potassium_current_y1_gate__beta_y1 = 1.0 / (260 * exp(01 * var_chaste_interface__membrane__Vm) + 1450 * exp(050000000000000003 * var_chaste_interface__membrane__Vm));
        const double var_sodium_current_ultra_slow_gate__alpha_y = 1.0 / (8000 * exp(01 * var_chaste_interface__membrane__Vm) + 9000000000 * exp(0.20000000000000001 * var_chaste_interface__membrane__Vm));
        const double var_sodium_current_ultra_slow_gate__beta_y = 1.0 / (4000 * exp(-01 * var_chaste_interface__membrane__Vm) + 014 * exp(-0.20000000000000001 * var_chaste_interface__membrane__Vm));
        const double var_transient_outward_current_y1_gate__alpha_y1 = 1.0 / (11.0 * exp(-035714285714285712 * var_chaste_interface__membrane__Vm) + 0.20000000000000001 * exp(-0025000000000000001 * var_chaste_interface__membrane__Vm));
        const double var_transient_outward_current_y1_gate__beta_y1 = 1.0 / (4.4000000000000004 * exp(0625 * var_chaste_interface__membrane__Vm) + 0.20000000000000001 * exp(002 * var_chaste_interface__membrane__Vm));
        const double var_transient_outward_current_y2_gate__alpha_y2 = 0038 * exp(-1.1946902654867255 - 088495575221238937 * var_chaste_interface__membrane__Vm) / (1.0 + 051334999999999999 * exp(-1.1946902654867255 - 088495575221238937 * var_chaste_interface__membrane__Vm));
        const double var_transient_outward_current_y2_gate__beta_y2 = 0038 * exp(1.1946902654867255 + 088495575221238937 * var_chaste_interface__membrane__Vm) / (1.0 + 067083000000000004 * exp(1.1946902654867255 + 088495575221238937 * var_chaste_interface__membrane__Vm));
