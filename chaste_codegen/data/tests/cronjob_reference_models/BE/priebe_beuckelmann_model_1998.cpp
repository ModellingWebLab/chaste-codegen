...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x1 = 00079500000000000003 + var_chaste_interface__Irel__Cainfluxtrack;
        ...
        const double var_x17 = 00092000000000000003 + var_chaste_interface__Ionic_concentrations__Cai;
        const double var_x18 = 1 / var_x17;
        const double var_x19 = var_chaste_interface__Ionic_concentrations__Cai / pow(var_x17, 2);
        const double var_x20 = 0023800000000000002 + var_chaste_interface__Ionic_concentrations__Cai;
        const double var_x21 = 00050000000000000001 + var_chaste_interface__Ionic_concentrations__Cai;
        const double var_x22 = 1.0 + 00011900000000000002 / pow(var_x20, 2) + 3.5000000000000004e-5 / pow(var_x21, 2);
        const double var_x23 = 1 / var_x22;
        const double var_x24 = 0070588235294117632 * var_x7;
        const double var_x25 = 00036529411764705876 * var_x18;
        const double var_x26 = exp(-024321106718724127 * var_chaste_interface__cell__V);
        ...
        const double var_x30 = 00059999999999999995 + var_chaste_interface__Ionic_concentrations__Cai;
        ...
        const double var_x34 = 00059999999999999995 * var_chaste_interface__cell__V - 0080177272463458679 * var_x33;
        const double var_x35 = 011358446932323314 * var_x29 + 0080177272463458679 * var_x29 * var_x32 - var_x31 * var_x34 / pow(var_x30, 2);
        const double var_x36 = 1 / M_PI;
        const double var_x37 = 9.661256841321762e-5 * var_x36;
        const double var_x38 = 1.0 * var_x23;
        const double var_x39 = exp(013095980540851452 * var_chaste_interface__cell__V);
        ...
        const double var_x41 = -011358446932323314 * var_x33 + var_x32 * var_x34;
        ...
        const double var_x44 = var_x38 * (0070588235294117632 * var_chaste_interface__Ionic_concentrations__Ca_JSR - 0070588235294117632 * var_chaste_interface__Ionic_concentrations__Cai);
        ...
        const double var_x47 = var_x46 + 018329999999999999 * var_chaste_interface__Ionic_concentrations__Nai;
        const double var_x48 = var_x45 * (0.15315014533948793 * var_chaste_interface__Ionic_concentrations__Ki + 0028072421640728137 * var_chaste_interface__Ionic_concentrations__Nai) / pow(var_x47, 2);
        const double var_x49 = 1 / var_chaste_interface__Ionic_concentrations__Ki;
        const double var_x50 = log(4.0 * var_x49);
        const double var_x51 = exp(-12.0 + 059999999999999998 * var_chaste_interface__cell__V - 1.6035454492691736 * var_x50);
        ...
        const double var_x58 = exp(02 + 00020000000000000001 * var_chaste_interface__cell__V - 0053451514975639122 * var_x50);
        ...
        const double var_x66 = var_x46 + 042999999999999997 * var_chaste_interface__Ionic_concentrations__Nai;
        const double var_x67 = var_chaste_interface__Ito_r_gate__r * var_chaste_interface__Ito_t_gate__t;
        const double var_x68 = var_x67 * (0.10066438494060802 * var_chaste_interface__Ionic_concentrations__Ki + 004328568552446144 * var_chaste_interface__Ionic_concentrations__Nai) / pow(var_x66, 2);
        const double var_x69 = mParameters[2] * var_chaste_interface__IKr_Xr_gate__Xr / (1.0 + exp(1.1304347826086956 + 043478260869565216 * var_chaste_interface__cell__V));
        const double var_x70 = 00019322513682643524 * var_x36;
        const double var_x71 = 1 / var_chaste_interface__Ionic_concentrations__Nai;
        const double var_x72 = pow(var_x71, 1.5);
        const double var_x73 = 1 / (1.0 + 0.1245 * exp(-0037417087259575582 * var_chaste_interface__cell__V) + 036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0505200594353643)) * exp(-037417087259575585 * var_chaste_interface__cell__V));
        const double var_x74 = var_x71 * var_x72 * var_x73 / pow((031622776601683791 + var_x72), 2);
        ...
        rJacobian[0][0] = 1.0 - (mDt * (var_x11 * (-0055555555555555558 - var_x7) + 0.25 * (-var_x12 + 0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_NSR - 0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_JSR) / (pow(var_x8, 3) * pow((0.125 + var_x9), 2))));
        rJacobian[0][1] = -(mDt * (0055555555555555558 * var_x10));
        ...
        rJacobian[0][10] = 0;
        rJacobian[0][11] = 0;
        rJacobian[1][0] = -(mDt * (00048309178743961351));
        rJacobian[1][1] = 1.0 - (mDt * (-00074309178743961349));
        rJacobian[1][2] = -(mDt * (0044999999999999997 * var_x18 - 0044999999999999997 * var_x19));
        rJacobian[1][3] = 0;
        rJacobian[1][4] = 0;
        rJacobian[1][5] = 0;
        rJacobian[1][6] = 0;
        ...
        rJacobian[2][2] = 1.0 - (mDt * (var_x38 * (-var_x24 - var_x25 + 00036529411764705876 * var_x19 - var_x37 * (var_x35 + 471.5206420294254 * var_x28)) + 1.0 * (00023800000000000004 / pow(var_x20, 3) + 7.0000000000000007e-5 / pow(var_x21, 3)) * (0070588235294117632 * var_x12 + 2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR - var_x25 * var_chaste_interface__Ionic_concentrations__Cai - var_x37 * (var_x41 + 00084999999999999995 * var_chaste_interface__cell__V - 00017941694216498839 * var_x40)) / pow(var_x22, 2)));
        rJacobian[2][3] = 0;
        ...
        rJacobian[3][1] = 0;
        rJacobian[3][2] = 0;
        rJacobian[3][3] = 1.0 - (mDt * (-var_x70 * (3.4901380509403466 * var_x48 + 79.648102465199855 * var_x68 + 6.681439371954891 * var_x49 * var_x62 + 26.725757487819561 * var_x49 * var_x69 - 0.40088636231729341 * var_x61 * var_x63 * var_x64 + var_x53 * var_x65 * (0.16035454492691736 * var_x63 - var_x56 * (2.6725757487819561 * var_x49 * var_x57 + 016035454492691736 * var_x49 * var_x58) - 13.36287874390978 * var_x49 * var_x54 * var_x59 / pow(var_x55, 2)) / pow(var_x60, 2))));
        rJacobian[3][4] = -(mDt * (-var_x70 * (3.4248684060035934 * var_x68 + 063974230473736557 * var_x48 - 089693693633866756 * var_x74)));
        rJacobian[3][5] = 0;
        rJacobian[3][6] = 0;
        rJacobian[3][7] = 0;
        rJacobian[3][8] = 0;
        ...
        rJacobian[4][3] = 0;
        rJacobian[4][4] = 1.0 - (mDt * (-var_x70 * (026725757487819562 * var_x71 + 0016147524794848955 * var_x42 + 0.13454054045080013 * var_x74 + 26.725757487819561 * var_x71 * var_x75)));
        rJacobian[4][5] = 0;
        rJacobian[4][6] = 0;
        rJacobian[4][7] = 0;
        rJacobian[4][8] = 0;
        ...
        rJacobian[7][5] = 0;
        rJacobian[7][6] = 0;
        rJacobian[7][7] = 1.0 - (mDt * (((var_x77) ? (-100.5) : (-01))));
        rJacobian[7][8] = 0;
        rJacobian[7][9] = 0;
        rJacobian[7][10] = 0;
        rJacobian[7][11] = 0;
        ...
        rJacobian[8][6] = 0;
        rJacobian[8][7] = 0;
        rJacobian[8][8] = 1.0 - (mDt * ((((var_x78) || (var_chaste_interface__Irel__APtrack2 > 01)) ? (0) : (-0.5))));
        rJacobian[8][9] = 0;
        rJacobian[8][10] = 0;
        rJacobian[8][11] = 0;
        rJacobian[9][0] = 0;
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_ICa_d_gate__alpha_d = 0.63524014987941491 * exp(-0.89836705491478086 * pow((-1 + 044722719141323794 * var_chaste_interface__cell__V), 2)) / sqrt(M_PI);
        const double var_ICa_d_gate__beta_d = 0.14710000000000001 - 0.25101580310038191 * exp(-08830693125184777 * pow((-1 + 0.15937778911130945 * var_chaste_interface__cell__V), 2)) / sqrt(M_PI);
        const double var_ICa_f_gate__alpha_f = 0068719999999999996 / (1.0 + exp(-1.0052757950443461 + 0.16333730787449161 * var_chaste_interface__cell__V));
        const double var_ICa_f_gate__beta_f = 00054739999999999997 + (0112 + 068699999999999997 * exp(-1.06213655 - 0.1081 * var_chaste_interface__cell__V)) / (1.0 + exp(-2.7305064499999996 - 0.27789999999999998 * var_chaste_interface__cell__V));
        const double var_IKr_Xr_gate__alpha_Xr = 0050000000000000001 * exp(0021416822000000003 + 00052660000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(-0.51325540000000003 - 0.12620000000000001 * var_chaste_interface__cell__V));
        const double var_IKr_Xr_gate__beta_Xr = 016 * exp(0.105056 + 0016000000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(5.1411779999999991 + 078299999999999995 * var_chaste_interface__cell__V));
        const double var_IKs_Xs_gate__alpha_Xs = 0030130000000000001 / (1.0 + exp(-0.17842998931347828 - 069846547135942336 * var_chaste_interface__cell__V));
        const double var_IKs_Xs_gate__beta_Xs = 0058700000000000002 / (1.0 + exp(1.0082174462705435 + 063211125158027806 * var_chaste_interface__cell__V));
        ...
        const double var_INa_m_gate__alpha_m = ((fabs(47.130000000000003 + var_chaste_interface__cell__V) > 001) ? (0.32000000000000001 * (47.130000000000003 + var_chaste_interface__cell__V) / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__cell__V))) : (3.2000000000000002));
        const double var_INa_m_gate__beta_m = 080000000000000002 * exp(-090909090909090912 * var_chaste_interface__cell__V);
        const double var_Ito_r_gate__alpha_r = 0.52659999999999996 * exp(0.70203392000000009 - 0166 * var_chaste_interface__cell__V) / (1.0 + exp(3.9880601600000003 - 094299999999999995 * var_chaste_interface__cell__V));
        ...
        const double var_Ito_t_gate__alpha_t = (5.6119999999999998e-5 * var_chaste_interface__cell__V + 072099999999999997 * exp(-5.9257863000000004 - 0.17299999999999999 * var_chaste_interface__cell__V)) / (1.0 + exp(-5.9326369200000002 - 0.17319999999999999 * var_chaste_interface__cell__V));
        const double var_Ito_t_gate__beta_t = (0001215 * var_chaste_interface__cell__V + 076700000000000004 * exp(-5.6479010000000002e-8 - 1.6600000000000001e-9 * var_chaste_interface__cell__V)) / (1.0 + exp(-5.4573693999999993 - 0.16039999999999999 * var_chaste_interface__cell__V));
