...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellviswanathan_model_1999_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x0 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai;
        ...
        const double var_x6 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x7 = log(132.0 * var_x6);
        const double var_x8 = pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2) * var_chaste_interface__T_type_Ca_channel_g_gate__g;
        const double var_x9 = var_x8 * (-13.356169352749133 * var_x3 + var_chaste_interface__membrane__V);
        const double var_x10 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x11 = -26.712338705498265 * var_x5 + var_chaste_interface__membrane__V;
        const double var_x12 = 1 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V));
        const double var_x13 = var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V));
        const double var_x14 = exp(0.074871767015605231 * var_chaste_interface__membrane__V);
        const double var_x15 = -0.61380000000000001 + 1.0 * var_x14 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x16 = 1 / (-1.0 + var_x14);
        const double var_x17 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V;
        const double var_x18 = var_x17 / (1.0 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai);
        ...
        const double var_x24 = -3.375 + var_x23 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x25 = 1 / (-1.0 + var_x22);
        const double var_x26 = var_x18 * var_x25;
        const double var_x27 = -99.0 + var_x23 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x28 = pow(var_chaste_interface__ionic_concentrations__Nai, (-2));
        const double var_x29 = 1 / (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.961367013372957)) * exp(-var_x21));
        const double var_x30 = pow(var_x2, 1.3999999999999999);
        const double var_x31 = 1.0 + 6.4818210260626455e-7 * var_x30;
        const double var_x32 = 0.25979999999999998 / var_x31;
        const double var_x33 = 0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki;
        const double var_x34 = var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        const double var_x35 = var_x34 * (-26.712338705498265 * log(6.9195599999999997 / var_x33) + var_chaste_interface__membrane__V);
        const double var_x36 = 0.018717941753901308 * var_chaste_interface__membrane__V;
        const double var_x37 = exp(-var_x36);
        const double var_x38 = pow(var_chaste_interface__ionic_concentrations__Nai, 3.0);
        const double var_x39 = exp(var_x36);
        const double var_x40 = 1.8 * var_x38 * var_x39 - 2299968.0 * var_x37 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x41 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x42 = 1 / (1.0 + 2299.9679999999998 * var_chaste_interface__calcium_dynamics__Cai + 0.0018000000000000002 * var_x38);
        const double var_x43 = var_x41 * var_x42;
        const double var_x44 = var_x40 * var_x43;
        const double var_x45 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * var_x5);
        const double var_x46 = 1.0 + var_x45;
        const double var_x47 = 1 / var_x46;
        const double var_x48 = exp(-2.4444678999999998 + 13.738155796237757 * var_x5 - 0.51429999999999998 * var_chaste_interface__membrane__V);
        const double var_x49 = 1.0 + var_x48;
        const double var_x50 = 1 / var_x49;
        const double var_x51 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * var_x5);
        const double var_x52 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * var_x5);
        const double var_x53 = var_x51 + 0.49124000000000001 * var_x52;
        const double var_x54 = var_x50 * var_x53;
        const double var_x55 = 1 / (1000.0 * var_x54 + 1020.0 * var_x47);
        ...
        const double var_x87 = pow(var_x0, (-2));
        const double var_x88 = 0.0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x89 = 1.0 + 0.00011900000000000002 / pow(var_x88, 2) + 3.5000000000000004e-5 * var_x87;
        ...
        const double var_x94 = 0.40588235294117642 * var_x84;
        const double var_x95 = 1.1499999999999999 * var_x1;
        const double var_x96 = 1 / M_PI;
        const double var_x97 = 0.090316078310111333 * var_x96;
        const double var_x98 = 0.027058823529411764 * var_chaste_interface__calcium_dynamics__Ca_NSR - var_x94 * var_chaste_interface__calcium_dynamics__Cai - var_x97 * (0.050000000000000003 * var_x9 + 0.003016 * var_chaste_interface__membrane__V + 7.8019226357407252 * var_x20 - 0.002 * var_x44 - 0.040282206767891383 * var_x3 + var_x95 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x99 = 0.001 * (0.00023800000000000004 / pow(var_x88, 3) + 7.0000000000000007e-5 / pow(var_x0, 3)) / pow(var_x89, 2);
        const double var_x100 = 423.5294117647058 * var_x72;
        const double var_x101 = var_x37 * var_x43;
        const double var_x102 = var_x17 / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x103 = var_x40 * var_x41 / pow((0.00043478865792915378 + 7.8261958427247687e-7 * var_x38 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x104 = var_x40 * var_x42 / pow((0.0068999999999999999 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x105 = var_x95 + 4599.9359999999997 * var_x101 + 0.040282206767891383 * var_x2 + 1.38e-5 * var_x104 + 8.6957731585830757e-7 * var_x103 + 7.8019226357407252 * var_x14 * var_x19 + 0.6678084676374566 * var_x2 * var_x8 - 1.1499999999999999 * var_x87 * var_chaste_interface__calcium_dynamics__Cai - 0.0046811535814444347 * var_x102 * var_x15 * var_x16;
        const double var_x106 = -var_x94 + 0.40588235294117642 * var_x85 - var_x105 * var_x97;
        const double var_x107 = pow(var_chaste_interface__ionic_concentrations__Nai, 2.0);
        const double var_x108 = var_x107 * var_x39 * var_x43;
        const double var_x109 = var_x103 * var_x107;
        const double var_x110 = 9.0316078310111333e-5 * var_x96;
        const double var_x111 = var_x110 * (2.0416447122894152e-12 * var_x109 - 0.010800000000000001 * var_x108);
        ...
        const double var_x114 = var_x102 * var_x25;
        const double var_x115 = 0.00018063215662022267 * var_x96;
        const double var_x116 = var_x22 * var_x26;
        const double var_x117 = var_x34 * (-0.433 - var_x32) * (0.14451785951707913 * var_chaste_interface__ionic_concentrations__Ki + 0.0026490123649480601 * var_chaste_interface__ionic_concentrations__Nai) / pow(var_x33, 2);
        const double var_x118 = var_x4 * var_x45 / pow(var_x46, 2);
        const double var_x119 = var_x29 / (pow((0.01 + var_x28), 2) * pow(var_chaste_interface__ionic_concentrations__Nai, 3));
        
        
        rJacobian[0][0] = 1.0 - (mDt * (((2.0 * var_x44 + 50.0 * var_x9 + 7801.9226357407251 * var_x20 + 7.0160275741043607 * var_chaste_interface__membrane__V - 106.84935482199306 * var_x7 - 40.282206767891381 * var_x3 - 0.00073656881518639836 * var_x5 + 698346.2608190868 * var_x11 * var_x56 + 2.4381008236689765 * var_x26 * var_x27 + 0.6971162355083147 * var_x24 * var_x26 + 1150.0 * var_x1 * var_chaste_interface__calcium_dynamics__Cai + 5.5199999999999996 * var_x11 * var_x12 + 1500.0 * var_x29 / (1.0 + 100.0 * var_x28) + 23.862446088641736 * var_x11 * var_x13 + 1000.0 * var_x35 * (0.433 + var_x32) + 1000.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 16000.0 * var_x10 * (-26.712338705498265 * var_x7 + var_chaste_interface__membrane__V) < -150000.0) ? (-100.5) : (-0.5))));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = 0.0;
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = 0.0;
        ...
        rJacobian[5][5] = 1.0 - (mDt * (((var_x70) ? (var_x91 * (var_x106 - var_x100 * var_x61) + var_x99 * (var_x98 + var_x71 * var_x86)) : ((var_x79) ? (var_x91 * (var_x106 + (-28.235294117647054 + var_x92) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) + var_x99 * (var_x98 + var_x78 * var_x92)) : (var_x106 * var_x91 + var_x98 * var_x99)))));
        rJacobian[5][6] = -(mDt * (((var_x70) ? (var_x91 * (-423.5294117647058 * var_x82 + var_x100 * var_x58)) : (0))));
        rJacobian[5][7] = 0.0;
        ...
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (((var_x112) ? (-var_x105 * var_x110) : (0))));
        ...
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = -(mDt * (var_x115 * (4.1826974130498884e-7 * var_x114 * var_x24 - 2.3575679435995052e-7 * var_x2 * var_x30 * var_x35 / pow(var_x31, 2))));
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (var_x115 * (184.83763041301756 * var_x117 - 0.00052283717663123607 * var_x116 - 7.3656881518639831e-7 * var_x4 - 18654.461852717679 * var_x4 * var_x56 - 0.63742174226149029 * var_x13 * var_x4 - 0.14745210965435041 * var_x12 * var_x4 + 4449.089151873166 * var_x11 * var_x118 * var_x55 - 0.00067122862439358594 * var_x11 * var_x47 * (6498.310636886562 * var_x118 - 1000.0 * var_x50 * (1.053972635420138 * var_x4 * var_x52 + 1.6494869150645177 * var_x4 * var_x51) - 13738.155796237757 * var_x4 * var_x48 * var_x53 / pow(var_x49, 2)) / pow((var_x47 + 0.98039215686274506 * var_x54), 2))));
        ...
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = -(mDt * (var_x115 * (2.6087319475749228e-6 * var_x103 + 4.1400000000000003e-5 * var_x104 + 13799.808000000001 * var_x101 + 1.4628604942013857e-6 * var_x114 * var_x27)));
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x115 * (6.124934136868245e-12 * var_x109 - 0.032399999999999998 * var_x108 - 0.10684935482199306 * var_x6 - 0.0018285756177517324 * var_x116 - 0.089999999999999997 * var_x119 - 427.39741928797224 * var_x10 * var_x6)));
    }
