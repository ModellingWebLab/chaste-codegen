...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbeeler_reuter_model_1977FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_slow_inward_current__E_s = -82.3 - 13.0287 * log(0.001 * var_slow_inward_current__Cai); // mV
        const double var_slow_inward_current__g_s = 0.0009; // mS_per_mm2
        const double var_slow_inward_current_d_gate__alpha_d = 0.095 * exp(0.05 - 0.01 * var_chaste_interface__membrane__V) / (1.0 + exp(0.3599712023038157 - 0.07199424046076314 * var_chaste_interface__membrane__V)); // per_ms
        const double var_slow_inward_current_d_gate__beta_d = 0.07 * exp(-0.7457627118644068 - 0.01694915254237288 * var_chaste_interface__membrane__V) / (1.0 + exp(2.2 + 0.05 * var_chaste_interface__membrane__V)); // per_ms
        ...
        const double var_slow_inward_current_f_gate__alpha_f = 0.012 * exp(-0.224 - 0.008 * var_chaste_interface__membrane__V) / (1.0 + exp(4.197901049475263 + 0.14992503748125938 * var_chaste_interface__membrane__V)); // per_ms
        const double var_slow_inward_current_f_gate__beta_f = 0.0065 * exp(-0.6 - 0.02 * var_chaste_interface__membrane__V) / (1.0 + exp(-6.0 - 0.2 * var_chaste_interface__membrane__V)); // per_ms
        ...
        const double var_slow_inward_current__i_s = (-var_slow_inward_current__E_s + var_chaste_interface__membrane__V) * var_slow_inward_current__g_s * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f; // uA_per_mm2
        const double var_slow_inward_current__Cai_orig_deriv = 7.000000000000001e-06 - 0.07 * var_slow_inward_current__Cai - 0.01 * var_slow_inward_current__i_s; // concentration_units / ms
        ...
        const double var_sodium_current_h_gate__beta_h = 1.7 / (1.0 + exp(-1.845 - 0.082 * var_chaste_interface__membrane__V)); // per_ms
        ...
        const double var_sodium_current_j_gate__alpha_j = 0.055 * exp(-19.5 - 0.25 * var_chaste_interface__membrane__V) / (1.0 + exp(-15.600000000000001 - 0.2 * var_chaste_interface__membrane__V)); // per_ms
        const double var_sodium_current_j_gate__beta_j = 0.3 / (1.0 + exp(-3.2 - 0.1 * var_chaste_interface__membrane__V)); // per_ms
        ...
        const double var_sodium_current_m_gate__alpha_m = -1.0 * (47.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-4.7 - 0.1 * var_chaste_interface__membrane__V)); // per_ms
        const double var_sodium_current_m_gate__beta_m = 40.0 * exp(-4.032 - 0.056 * var_chaste_interface__membrane__V); // per_ms
        ...
        const double var_time_dependent_outward_current_x1_gate__alpha_x1 = 0.0005 * exp(4.132231404958678 + 0.08264462809917356 * var_chaste_interface__membrane__V) / (1.0 + exp(2.857142857142857 + 0.05714285714285714 * var_chaste_interface__membrane__V)); // per_ms
        const double var_time_dependent_outward_current_x1_gate__beta_x1 = 0.0013 * exp(-1.1997600479904018 - 0.05998800239952009 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.8 - 0.04 * var_chaste_interface__membrane__V)); // per_ms
