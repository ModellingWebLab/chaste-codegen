...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellgrandi2010ssFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_cell__aki = 1.02 / (1.0 + exp(-14.1227775 + 0.2385 * var_chaste_interface__cell__sVm - 0.2385 * var_cell__ek)); // dimensionless
        const double var_cell__bki = (0.49124 * exp(0.43983232 + 0.08032 * var_chaste_interface__cell__sVm - 0.08032 * var_cell__ek) + exp(-36.6986425 + 0.06175 * var_chaste_interface__cell__sVm - 0.06175 * var_cell__ek)) / (1.0 + exp(-2.4444679 + 0.5143 * var_cell__ek - 0.5143 * var_chaste_interface__cell__sVm)); // dimensionless
        ...
        const double var_cell__rkr = 1.0 / (1.0 + exp(3.083333333333333 + 0.041666666666666664 * var_chaste_interface__cell__sVm)); // dimensionless
    ...
    void Cellgrandi2010ssFromCellML::EvaluateYDerivatives(double var_chaste_interface__cell__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_cell__I_nabk_junc = (-var_cell__ena_junc + var_chaste_interface__cell__sVm) * var_cell__Fjunc * var_cell__GNaB; // dimensionless
        const double var_cell__I_nabk_sl = (-var_cell__ena_sl + var_chaste_interface__cell__sVm) * var_cell__Fsl * var_cell__GNaB; // dimensionless
        const double var_cell__ah = ((var_chaste_interface__cell__sVm >= -40.0) ? (0.0) : (0.057 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__sVm))); // dimensionless
        const double var_cell__aj = ((var_chaste_interface__cell__sVm >= -40.0) ? (0.0) : ((37.78 + var_chaste_interface__cell__sVm) * (-25428.0 * exp(0.2444 * var_chaste_interface__cell__sVm) - 6.948e-06 * exp(-0.04391 * var_chaste_interface__cell__sVm)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__sVm)))); // dimensionless
        const double var_cell__bh = ((var_chaste_interface__cell__sVm >= -40.0) ? (5.9230769230769225 / (1.0 + exp(-0.9603603603603604 - 0.0900900900900901 * var_chaste_interface__cell__sVm))) : (310000.0 * exp(0.3485 * var_chaste_interface__cell__sVm) + 2.7 * exp(0.079 * var_chaste_interface__cell__sVm))); // dimensionless
        const double var_cell__bj = ((var_chaste_interface__cell__sVm >= -40.0) ? (0.6 * exp(0.057 * var_chaste_interface__cell__sVm) / (1.0 + exp(-3.2 - 0.1 * var_chaste_interface__cell__sVm))) : (0.02424 * exp(-0.01052 * var_chaste_interface__cell__sVm) / (1.0 + exp(-5.5312920000000005 - 0.1378 * var_chaste_interface__cell__sVm)))); // dimensionless
        ...
        const double var_cell__fss = 1.0 / (1.0 + exp(3.888888888888889 + 0.1111111111111111 * var_chaste_interface__cell__sVm)) + 0.6 / (1.0 + exp(2.5 - 0.05 * var_chaste_interface__cell__sVm)); // dimensionless
        const double var_cell__hss = 1.0 * pow((1.0 + exp(9.629878869448182 + 0.13458950201884254 * var_chaste_interface__cell__sVm)), (-2.0)); // dimensionless
        const double var_cell__ibarca_j = 4.0 * (-0.341 * var_cell__Cao + 0.341 * var_chaste_interface__cell__sCaj * exp(2.0 * var_cell__FoRT * var_chaste_interface__cell__sVm)) * var_cell__FoRT * var_cell__Frdy * var_cell__pCa * var_chaste_interface__cell__sVm / (-1.0 + exp(2.0 * var_cell__FoRT * var_chaste_interface__cell__sVm)); // dimensionless
        const double var_cell__ibarca_sl = 4.0 * (-0.341 * var_cell__Cao + 0.341 * var_chaste_interface__cell__sCasl * exp(2.0 * var_cell__FoRT * var_chaste_interface__cell__sVm)) * var_cell__FoRT * var_cell__Frdy * var_cell__pCa * var_chaste_interface__cell__sVm / (-1.0 + exp(2.0 * var_cell__FoRT * var_chaste_interface__cell__sVm)); // dimensionless
        const double var_cell__ibarna_j = (-0.75 * var_cell__Nao + 0.75 * var_chaste_interface__cell__sNaj * exp(var_cell__FoRT * var_chaste_interface__cell__sVm)) * var_cell__FoRT * var_cell__Frdy * var_cell__pNa * var_chaste_interface__cell__sVm / (-1.0 + exp(var_cell__FoRT * var_chaste_interface__cell__sVm)); // dimensionless
        const double var_cell__ibarna_sl = (-0.75 * var_cell__Nao + 0.75 * var_chaste_interface__cell__sNasl * exp(var_cell__FoRT * var_chaste_interface__cell__sVm)) * var_cell__FoRT * var_cell__Frdy * var_cell__pNa * var_chaste_interface__cell__sVm / (-1.0 + exp(var_cell__FoRT * var_chaste_interface__cell__sVm)); // dimensionless
        const double var_cell__jss = 1.0 * pow((1.0 + exp(9.629878869448182 + 0.13458950201884254 * var_chaste_interface__cell__sVm)), (-2.0)); // dimensionless
        const double var_cell__mss = 1.0 * pow((1.0 + exp(-6.2967884828349945 - 0.1107419712070875 * var_chaste_interface__cell__sVm)), (-2.0)); // dimensionless
        const double var_cell__s1_junc = pow(var_chaste_interface__cell__sNaj, 3.0) * var_cell__Cao * exp(var_cell__FoRT * var_cell__nu * var_chaste_interface__cell__sVm); // dimensionless
        const double var_cell__s1_sl = pow(var_chaste_interface__cell__sNasl, 3.0) * var_cell__Cao * exp(var_cell__FoRT * var_cell__nu * var_chaste_interface__cell__sVm); // dimensionless
        const double var_cell__s2_junc = pow(var_cell__Nao, 3.0) * var_chaste_interface__cell__sCaj * exp((-1.0 + var_cell__nu) * var_cell__FoRT * var_chaste_interface__cell__sVm); // dimensionless
        const double var_cell__I_ncx_junc = pow(var_cell__Q10NCX, var_cell__Qpow) * (-var_cell__s2_junc + var_cell__s1_junc) * var_cell__Fjunc * var_cell__IbarNCX * var_cell__Ka_junc / ((1.0 + var_cell__ksat * exp((-1.0 + var_cell__nu) * var_cell__FoRT * var_chaste_interface__cell__sVm)) * var_cell__s3_junc); // dimensionless
        ...
        const double var_cell__taud = 28.57142857142857 * (1.0 - exp(-0.8333333333333333 - 0.16666666666666666 * var_chaste_interface__cell__sVm)) * var_cell__dss / (5.0 + var_chaste_interface__cell__sVm); // dimensionless
        const double d_dt_chaste_interface_var_cell__sd = (-var_chaste_interface__cell__sd + var_cell__dss) / var_cell__taud; // 1 / ms
        const double var_cell__tauf = 1.0 / (0.02 + 0.0197 * exp(-0.23877882250000002 * pow((1 + 0.06896551724137931 * var_chaste_interface__cell__sVm), 2.0))); // dimensionless
        ...
        const double var_cell__taum = 0.1292 * exp(-8.6823893667523 * pow((1 + 0.021838829438742085 * var_chaste_interface__cell__sVm), 2.0)) + 0.06487 * exp(-0.008901287605217465 * pow((-1 + 0.2073398299813394 * var_chaste_interface__cell__sVm), 2.0)); // dimensionless
        const double d_dt_chaste_interface_var_cell__sm = (-var_chaste_interface__cell__sm + var_cell__mss) / var_cell__taum; // 1 / ms
        const double var_cell__tauxr = 230.0 / (1.0 + exp(2.0 + 0.05 * var_chaste_interface__cell__sVm)) + 3300.0 / ((1.0 + exp(1.222222222222222 + 0.1111111111111111 * var_chaste_interface__cell__sVm)) * (1.0 + exp(-2.444444444444444 - 0.1111111111111111 * var_chaste_interface__cell__sVm))); // dimensionless
        const double var_cell__tauxs = 990.1 / (1.0 + exp(-0.1725212464589235 - 0.0708215297450425 * var_chaste_interface__cell__sVm)); // dimensionless
        const double var_cell__tauxtof = 0.5 + 8.5 * exp(-0.81 * pow((1 + 0.022222222222222223 * var_chaste_interface__cell__sVm), 2.0)); // dimensionless
        const double var_cell__tauxtos = 0.5 + 9.0 / (1.0 + exp(0.2 + 0.06666666666666667 * var_chaste_interface__cell__sVm)); // dimensionless
        const double var_cell__tauytof = 7.0 + 85.0 * exp(-7.2727272727272725 * pow((1 + 0.025 * var_chaste_interface__cell__sVm), 2.0)); // dimensionless
        const double var_cell__tauytos = 30.0 + 800.0 / (1.0 + exp(6.0 + 0.1 * var_chaste_interface__cell__sVm)); // dimensionless
        const double var_cell__xrss = 1.0 / (1.0 + exp(-2.0 - 0.2 * var_chaste_interface__cell__sVm)); // dimensionless
        const double d_dt_chaste_interface_var_cell__sxkr = (-var_chaste_interface__cell__sxkr + var_cell__xrss) / var_cell__tauxr; // 1 / ms
        const double var_cell__xsss = 1.0 / (1.0 + exp(-0.26666666666666666 - 0.07017543859649122 * var_chaste_interface__cell__sVm)); // dimensionless
