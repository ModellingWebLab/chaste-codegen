...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellcourtemanche_ramirez_nattel_model_1998FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_rapid_delayed_rectifier_K_current__i_Kr = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * var_membrane__Cm * var_rapid_delayed_rectifier_K_current__g_Kr * var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr / (1.0 + exp(0.6696428571428572 + 0.044642857142857144 * var_chaste_interface__membrane__V)); // picoA
        ...
        const double var_time_independent_potassium_current__i_K1 = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * var_membrane__Cm * var_time_independent_potassium_current__g_K1 / (1.0 + exp(5.6000000000000005 + 0.07 * var_chaste_interface__membrane__V)); // picoA
        ...
        const double var_ultrarapid_delayed_rectifier_K_current__g_Kur = 0.005 + 0.05 / (1.0 + exp(1.153846153846154 - 0.07692307692307693 * var_chaste_interface__membrane__V)); // nanoS_per_picoF
    ...
    void Cellcourtemanche_ramirez_nattel_model_1998FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_membrane__R = 8.3143; // joule_per_mole_kelvin
        const double var_membrane__T = 310.0; // kelvin
        const double var_Ca_release_current_from_JSR_w_gate__tau_w = ((fabs(-7.9 + var_chaste_interface__membrane__V) < 1e-10) ? (0.9230769230769231) : (6.0 * (1.0 - exp(1.58 - 0.2 * var_chaste_interface__membrane__V)) / ((1.0 + 0.3 * exp(1.58 - 0.2 * var_chaste_interface__membrane__V)) * (-7.9 + var_chaste_interface__membrane__V)))); // millisecond
        ...
        const double var_L_type_Ca_channel_d_gate__tau_d = ((fabs(10.0 + var_chaste_interface__membrane__V) < 1e-10) ? (4.579 / (1.0 + exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V))) : (28.57142857142857 * (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V)) / ((1.0 + exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V)) * (10.0 + var_chaste_interface__membrane__V)))); // millisecond
        ...
        const double var_L_type_Ca_channel_f_gate__f_infinity = exp(-4.057971014492754 - 0.14492753623188406 * var_chaste_interface__membrane__V) / (1.0 + exp(-4.057971014492754 - 0.14492753623188406 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_L_type_Ca_channel_f_gate__tau_f = 9.0 * pow((0.02 + 0.0197 * exp(-0.113569 * pow((1 + 0.1 * var_chaste_interface__membrane__V), 2.0))), (-1.0)); // millisecond
        ...
        const double var_rapid_delayed_rectifier_K_current__g_Kr = 0.029411765; // nanoS_per_picoF
        const double var_rapid_delayed_rectifier_K_current_xr_gate__alpha_xr = ((fabs(14.1 + var_chaste_interface__membrane__V) < 1e-10) ? (0.0015) : (0.0003 * (14.1 + var_chaste_interface__membrane__V) / (1.0 - exp(-2.8200000000000003 - 0.2 * var_chaste_interface__membrane__V)))); // per_millisecond
        const double var_rapid_delayed_rectifier_K_current_xr_gate__beta_xr = ((fabs(-3.3328 + var_chaste_interface__membrane__V) < 1e-10) ? (0.00037836118) : (7.3898e-05 * (-3.3328 + var_chaste_interface__membrane__V) / (-1.0 + exp(-0.6504674356422117 + 0.19517145812596365 * var_chaste_interface__membrane__V)))); // per_millisecond
        ...
        const double var_rapid_delayed_rectifier_K_current_xr_gate__xr_infinity = pow((1.0 + exp(-2.1692307692307695 - 0.15384615384615385 * var_chaste_interface__membrane__V)), (-1.0)); // dimensionless
        ...
        const double var_sarcolemmal_calcium_pump_current__i_CaP = var_chaste_interface__intracellular_ion_concentrations__Ca_i * var_membrane__Cm * var_sarcolemmal_calcium_pump_current__i_CaP_max / (0.0005 + var_chaste_interface__intracellular_ion_concentrations__Ca_i); // picoA
        const double var_slow_delayed_rectifier_K_current__g_Ks = 0.12941176; // nanoS_per_picoF
        const double var_slow_delayed_rectifier_K_current_xs_gate__alpha_xs = ((fabs(-19.9 + var_chaste_interface__membrane__V) < 1e-10) ? (0.00068) : (4e-05 * (-19.9 + var_chaste_interface__membrane__V) / (1.0 - exp(1.1705882352941175 - 0.058823529411764705 * var_chaste_interface__membrane__V)))); // per_millisecond
        const double var_slow_delayed_rectifier_K_current_xs_gate__beta_xs = ((fabs(-19.9 + var_chaste_interface__membrane__V) < 1e-10) ? (0.000315) : (3.5e-05 * (-19.9 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.211111111111111 + 0.1111111111111111 * var_chaste_interface__membrane__V)))); // per_millisecond
        ...
        const double var_Ca_release_current_from_JSR_v_gate__tau_v = 1.91 + 2.09 * pow((1.0 + exp(250.0 - 731528895391368.0 * var_Ca_release_current_from_JSR__Fn)), (-1.0)); // millisecond
        ...
        const double var_transient_outward_K_current__g_to = 0.1652; // nanoS_per_picoF
        const double var_transient_outward_K_current_oa_gate__alpha_oa = 0.65 * pow((exp(0.5084745762711864 - 0.01694915254237288 * var_chaste_interface__membrane__V) + exp(-1.1764705882352942 - 0.11764705882352941 * var_chaste_interface__membrane__V)), (-1.0)); // per_millisecond
        const double var_transient_outward_K_current_oa_gate__beta_oa = 0.65 * pow((2.5 + exp(4.823529411764706 + 0.058823529411764705 * var_chaste_interface__membrane__V)), (-1.0)); // per_millisecond
        const double var_transient_outward_K_current_oa_gate__oa_infinity = pow((1.0 + exp(-1.1670467502850628 - 0.05701254275940707 * var_chaste_interface__membrane__V)), (-1.0)); // dimensionless
        ...
        const double var_transient_outward_K_current_oi_gate__alpha_oi = pow((18.53 + 1.0 * exp(10.383561643835618 + 0.09132420091324202 * var_chaste_interface__membrane__V)), (-1.0)); // per_millisecond
        const double var_transient_outward_K_current_oi_gate__beta_oi = pow((35.56 + 1.0 * exp(-0.1693548387096775 - 0.13440860215053763 * var_chaste_interface__membrane__V)), (-1.0)); // per_millisecond
        const double var_transient_outward_K_current__i_to = pow(var_chaste_interface__transient_outward_K_current_oa_gate__oa, 3.0) * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * var_membrane__Cm * var_transient_outward_K_current__g_to * var_chaste_interface__transient_outward_K_current_oi_gate__oi; // picoA
        const double var_transient_outward_K_current_oi_gate__oi_infinity = pow((1.0 + exp(8.132075471698114 + 0.18867924528301888 * var_chaste_interface__membrane__V)), (-1.0)); // dimensionless
        ...
        const double var_ultrarapid_delayed_rectifier_K_current__g_Kur = 0.005 + 0.05 / (1.0 + exp(1.153846153846154 - 0.07692307692307693 * var_chaste_interface__membrane__V)); // nanoS_per_picoF
        const double var_ultrarapid_delayed_rectifier_K_current_ua_gate__alpha_ua = 0.65 * pow((exp(0.5084745762711864 - 0.01694915254237288 * var_chaste_interface__membrane__V) + exp(-1.1764705882352942 - 0.11764705882352941 * var_chaste_interface__membrane__V)), (-1.0)); // per_millisecond
        const double var_ultrarapid_delayed_rectifier_K_current_ua_gate__beta_ua = 0.65 * pow((2.5 + exp(4.823529411764706 + 0.058823529411764705 * var_chaste_interface__membrane__V)), (-1.0)); // per_millisecond
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__alpha_ui = pow((21.0 + 1.0 * exp(6.607142857142857 - 0.03571428571428571 * var_chaste_interface__membrane__V)), (-1.0)); // per_millisecond
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__ui_infinity = pow((1.0 + exp(-3.618995633187773 + 0.036390101892285295 * var_chaste_interface__membrane__V)), (-1.0)); // dimensionless
