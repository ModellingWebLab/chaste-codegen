...
#include "MathsCustomFunctions.hpp"
    ...
    double CellShannon2004FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IKs__G_Ks_SL = (0.057 + 0.19 / (1.0 + exp(-12.0 + 1.6666666666666667 * var_IKs__pCa_SL))) * var_IKs__G_Ks_Max; // milliS_per_microF
        const double var_IKs__pCa_jct = 3.0 - log(1.0 * var_chaste_interface__Ca_buffer__Ca_jct) / log(10); // dimensionless
        const double var_IKs__G_Ks_jct = (0.057 + 0.19 / (1.0 + exp(-12.0 + 1.6666666666666667 * var_IKs__pCa_jct))) * var_IKs__G_Ks_Max; // milliS_per_microF
        ...
        const double var_IK1_K1_gate__alpha_K1 = 1.02 / (1.0 + exp(-14.1227775 + 0.2385 * var_chaste_interface__cell__V - 0.2385 * var_reversal_potentials__E_K)); // per_millisecond
        const double var_IK1_K1_gate__beta_K1 = (1.0 * exp(-36.6986425 + 0.06175 * var_chaste_interface__cell__V - 0.06175 * var_reversal_potentials__E_K) + 0.49124 * exp(0.43983232 + 0.08032 * var_chaste_interface__cell__V - 0.08032 * var_reversal_potentials__E_K)) / (1.0 + exp(-2.4444679 + 0.5143 * var_reversal_potentials__E_K - 0.5143 * var_chaste_interface__cell__V)); // per_millisecond
        ...
        const double var_IKp__i_Kp = (-var_reversal_potentials__E_K + var_chaste_interface__cell__V) * var_IKp__g_Kp / (1.0 + exp(7.488 - 0.16722408026755853 * var_chaste_interface__cell__V)); // microA_per_microF
    ...
    void CellShannon2004FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_ICaL_d_gate__tau_d = 28.57142857142857 * (1.0 - exp(-2.4166666666666665 - 0.16666666666666666 * var_chaste_interface__cell__V)) * var_ICaL_d_gate__d_infinity / (14.5 + var_chaste_interface__cell__V); // millisecond
        ...
        const double var_ICaL_f_gate__f_infinity = 1.0 / (1.0 + exp(9.73888888888889 + 0.2777777777777778 * var_chaste_interface__cell__V)) + 0.6 / (1.0 + exp(2.5 - 0.05 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL_f_gate__tau_f = 1.0 / (0.02 + 0.0197 * exp(-0.23877882250000002 * pow((1 + 0.06896551724137931 * var_chaste_interface__cell__V), 2.0))); // millisecond
        ...
        const double var_IKr_Xr_gate__tau_Xr = 1.0 / (0.00061 * (10.0 + var_chaste_interface__cell__V) / (-1.0 + exp(1.45 + 0.145 * var_chaste_interface__cell__V)) + 0.00138 * (7.0 + var_chaste_interface__cell__V) / (1.0 - exp(-0.861 - 0.123 * var_chaste_interface__cell__V))); // millisecond
        ...
        const double var_IKs_Xs_gate__Xs_infinity = 1.0 / (1.0 + exp(0.08982035928143713 - 0.059880239520958084 * var_chaste_interface__cell__V)); // dimensionless
        const double var_IKs_Xs_gate__tau_Xs = 1.0 / (0.000131 * (30.0 + var_chaste_interface__cell__V) / (-1.0 + exp(2.061 + 0.0687 * var_chaste_interface__cell__V)) + 7.19e-05 * (30.0 + var_chaste_interface__cell__V) / (1.0 - exp(-4.4399999999999995 - 0.148 * var_chaste_interface__cell__V))); // millisecond
        ...
        const double var_INa_h_gate__alpha_h = ((var_chaste_interface__cell__V < -40.0) ? (0.135 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V)) : (0.0)); // per_millisecond
        const double var_INa_h_gate__beta_h = ((var_chaste_interface__cell__V < -40.0) ? (310000.0 * exp(0.35 * var_chaste_interface__cell__V) + 3.56 * exp(0.079 * var_chaste_interface__cell__V)) : (7.692307692307692 / (1.0 + exp(-0.9603603603603604 - 0.0900900900900901 * var_chaste_interface__cell__V)))); // per_millisecond
        ...
        const double var_INa_j_gate__alpha_j = ((var_chaste_interface__cell__V < -40.0) ? (1.0 * (37.78 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.2444 * var_chaste_interface__cell__V) - 3.474e-05 * exp(-0.04391 * var_chaste_interface__cell__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))) : (0.0)); // per_millisecond
        const double var_INa_j_gate__beta_j = ((var_chaste_interface__cell__V < -40.0) ? (0.1212 * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 + exp(-5.5312920000000005 - 0.1378 * var_chaste_interface__cell__V))) : (0.3 * exp(-2.535e-07 * var_chaste_interface__cell__V) / (1.0 + exp(-3.2 - 0.1 * var_chaste_interface__cell__V)))); // per_millisecond
        ...
        const double var_INa_m_gate__alpha_m = 0.32 * (47.13 + var_chaste_interface__cell__V) / (1.0 - exp(-4.713 - 0.1 * var_chaste_interface__cell__V)); // per_millisecond
        ...
        const double var_Itof_X_gate__X_tof_infinity = 1.0 / (1.0 + exp(-0.2 - 0.06666666666666667 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_Itof_Y_gate__Y_tof_infinity = 1.0 / (1.0 + exp(3.35 + 0.1 * var_chaste_interface__cell__V)); // dimensionless
        const double var_Itof_Y_gate__tau_Y_tof = 20.0 + 20.0 / (1.0 + exp(3.35 + 0.1 * var_chaste_interface__cell__V)); // millisecond
        ...
        const double var_Itos_R_gate__R_tos_infinity = 1.0 / (1.0 + exp(3.35 + 0.1 * var_chaste_interface__cell__V)); // dimensionless
        const double var_Itos_R_gate__tau_R_tos = 220.0 + 2800.0 / (1.0 + exp(6.0 + 0.1 * var_chaste_interface__cell__V)); // millisecond
        ...
        const double var_Itos_X_gate__X_tos_infinity = 1.0 / (1.0 + exp(-0.2 - 0.06666666666666667 * var_chaste_interface__cell__V)); // dimensionless
        const double var_Itos_X_gate__tau_X_tos = 0.5 + 9.0 / (1.0 + exp(0.2 + 0.06666666666666667 * var_chaste_interface__cell__V)); // millisecond
        ...
        const double var_Itos_Y_gate__Y_tos_infinity = 1.0 / (1.0 + exp(3.35 + 0.1 * var_chaste_interface__cell__V)); // dimensionless
        const double var_Itos_Y_gate__tau_Y_tos = 30.0 + 3000.0 / (1.0 + exp(6.0 + 0.1 * var_chaste_interface__cell__V)); // millisecond
