...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellstewart_zhang_model_2008_ssFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_inward_rectifier_potassium_current__xK1_inf = 1.0 / (1.0 + exp(7.5440000000000005 + 0.1 * var_chaste_interface__membrane__V)); // dimensionless
    ...
    void Cellstewart_zhang_model_2008_ssFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_L_type_Ca_current_f2_gate__f2_inf = 0.33 + 0.67 / (1.0 + exp(5.0 + 0.14285714285714285 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_L_type_Ca_current_f2_gate__tau_f2 = 80.0 / (1.0 + exp(3.0 + 0.1 * var_chaste_interface__membrane__V)) + 31.0 / (1.0 + exp(2.5 - 0.1 * var_chaste_interface__membrane__V)) + 562.0 * exp(-3.0375 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0)); // millisecond
        ...
        const double var_L_type_Ca_current_f_gate__tau_f = 20.0 + 200.0 / (1.0 + exp(1.3 - 0.1 * var_chaste_interface__membrane__V)) + 180.0 / (1.0 + exp(3.0 + 0.1 * var_chaste_interface__membrane__V)) + 1102.5 * exp(-3.24 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0)); // millisecond
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40.0) ? (0.057 * exp(-11.764705882352942 + 0.14705882352941177 * var_fast_sodium_current__shift_INa_inact - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0.0)); // per_millisecond
        const double var_fast_sodium_current_h_gate__beta_h = ((var_chaste_interface__membrane__V < -40.0) ? (310000.0 * exp(0.3485 * var_chaste_interface__membrane__V - 0.3485 * var_fast_sodium_current__shift_INa_inact) + 2.7 * exp(0.079 * var_chaste_interface__membrane__V - 0.079 * var_fast_sodium_current__shift_INa_inact)) : (5.9230769230769225 / (1.0 + exp(-0.9603603603603604 + 0.0900900900900901 * var_fast_sodium_current__shift_INa_inact - 0.0900900900900901 * var_chaste_interface__membrane__V)))); // per_millisecond
        ...
        const double var_fast_sodium_current_j_gate__alpha_j = ((var_chaste_interface__membrane__V < -40.0) ? (1.0 * (37.78 + var_chaste_interface__membrane__V) * (-25428.0 * exp(0.2444 * var_chaste_interface__membrane__V - 0.2444 * var_fast_sodium_current__shift_INa_inact) - 6.948e-06 * exp(0.04391 * var_fast_sodium_current__shift_INa_inact - 0.04391 * var_chaste_interface__membrane__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * var_fast_sodium_current__shift_INa_inact))) : (0.0)); // per_millisecond
        const double var_fast_sodium_current_j_gate__beta_j = ((var_chaste_interface__membrane__V < -40.0) ? (0.02424 * exp(0.01052 * var_fast_sodium_current__shift_INa_inact - 0.01052 * var_chaste_interface__membrane__V) / (1.0 + exp(-5.5312920000000005 + 0.1378 * var_fast_sodium_current__shift_INa_inact - 0.1378 * var_chaste_interface__membrane__V))) : (0.6 * exp(0.057 * var_chaste_interface__membrane__V - 0.057 * var_fast_sodium_current__shift_INa_inact) / (1.0 + exp(-3.2 + 0.1 * var_fast_sodium_current__shift_INa_inact - 0.1 * var_chaste_interface__membrane__V)))); // per_millisecond
        ...
        const double var_hyperpolarization_activated_current_y_gate__beta_y = 1.0 * exp(3.6 + 0.11 * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double var_reversal_potentials__P_kna = 0.03; // dimensionless
        const double var_slow_time_dependent_potassium_current__g_Ks = 0.2352; // nanoS_per_picoF
        const double var_slow_time_dependent_potassium_current_Xs_gate__alpha_xs = 1400.0 / sqrt(1.0 + exp(0.8333333333333333 - 0.16666666666666666 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_slow_time_dependent_potassium_current_Xs_gate__beta_xs = 1.0 / (1.0 + exp(-2.3333333333333335 + 0.06666666666666667 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_sustained_outward_current__i_sus = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_sustained_outward_current__a * var_sustained_outward_current__g_sus; // picoA_per_picoF
        const double var_transient_outward_current__g_to = 0.08184; // nanoS_per_picoF
        const double var_transient_outward_current_r_gate__r_inf = 1.0 / (1.0 + exp(1.5384615384615385 - 0.07692307692307693 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_transient_outward_current_r_gate__tau_r = 7.3 + 10.45 * exp(-0.8888888888888888 * pow((1 + 0.025 * var_chaste_interface__membrane__V), 2.0)); // millisecond
        ...
        const double var_transient_outward_current_s_gate__s_inf = 1.0 / (1.0 + exp(2.076923076923077 + 0.07692307692307693 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_transient_outward_current_s_gate__tau_s = 42.0 + 5.0 / (1.0 + exp(-8.0 + 0.2 * var_chaste_interface__membrane__V)) + 85.0 * exp(-1.953125 * pow((1 + 0.04 * var_chaste_interface__membrane__V), 2.0)); // millisecond
