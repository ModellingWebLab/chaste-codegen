...
#include "MathsCustomFunctions.hpp"
    ...
    double Chaste_CG::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel__d_prime = 1.0 / (1.0 + exp(1.9166666666666665 - 0.08333333333333333 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_sodium_potassium_pump__i_p = 1.6 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c * var_sodium_potassium_pump__i_NaK_max / ((1.5 + exp(-1.5 - 0.025 * var_chaste_interface__membrane__V)) * (pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5) + pow(var_sodium_potassium_pump__k_NaK_Na, 1.5)) * (var_chaste_interface__cleft_space_ion_concentrations__K_c + var_sodium_potassium_pump__k_NaK_K)); // picoA
    ...
    void Chaste_CG::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_Ca_independent_transient_outward_K_current__E_K = var_membrane__R * var_membrane__T * log(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) / var_membrane__F; // millivolt
        const double var_background_currents__E_Ca = 0.5 * var_membrane__R * var_membrane__T * log(var_cleft_space_ion_concentrations__Ca_c / var_chaste_interface__intracellular_ion_concentrations__Ca_i) / var_membrane__F; // millivolt
        const double var_Ca_handling_by_the_SR__r_act = 240.0 * exp(-1.6 + 0.08 * var_chaste_interface__membrane__V) + 203.8 * pow((var_chaste_interface__intracellular_ion_concentrations__Ca_i / (var_Ca_handling_by_the_SR__k_rel + var_chaste_interface__intracellular_ion_concentrations__Ca_i)), 4.0); // per_second
        ...
        const double var_Ca_independent_transient_outward_K_current_r_gate__r_infinity = 1.0 / (1.0 + exp(-2.6628794603230963 - 0.17752529735487307 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_Ca_independent_transient_outward_K_current_s1_gate__s1_infinity = 1.0 / (1.0 + exp(4.007082152974504 + 0.141643059490085 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_Ca_independent_transient_outward_K_current_s1_gate__tau_s1 = 0.0204 + 0.5466 / (1.0 + exp(328.0 + 10.0 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_Ca_independent_transient_outward_K_current_s2_gate__s2_infinity = 1.0 / (1.0 + exp(4.007082152974504 + 0.141643059490085 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_Ca_independent_transient_outward_K_current_s2_gate__tau_s2 = 5.75 / (1.0 + exp(328.0 + 10.0 * var_chaste_interface__membrane__V)) + 0.45 / (1.0 + exp(0.9692197566213313 - 0.07158196134574087 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_Ca_independent_transient_outward_K_current_s3_gate__s3_infinity = 0.39975990396158473 + 0.6002400960384154 / (1.0 + exp(1.850620891161432 + 0.03652300949598247 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_T_type_Ca_channel_d_T_gate__d_T_infinity = 1.0 / (1.0 + exp(0.049180327868852465 - 0.1639344262295082 * var_T_type_Ca_channel_d_T_gate__E0_d_T)); // dimensionless
        ...
        const double var_delayed_rectifier_K_current_pa_gate__p_a_infinity = 1.0 / (1.0 + exp(-0.689189189189189 - 0.13513513513513511 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_delayed_rectifier_K_current_z_gate__z_infinity = 1.0 / (1.0 + exp(0.06521739130434782 - 0.07246376811594203 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_sarcolemmal_calcium_pump_current__k_CaP = 0.0002; // millimolar
        const double var_sarcolemmal_calcium_pump_current__i_CaP = var_chaste_interface__intracellular_ion_concentrations__Ca_i * var_sarcolemmal_calcium_pump_current__i_CaP_max / (var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_sarcolemmal_calcium_pump_current__k_CaP); // picoA
        const double var_intracellular_ion_concentrations__Ca_i_orig_deriv = -0.045 * var_intracellular_Ca_buffering__dOCdt - 0.08 * var_intracellular_Ca_buffering__dOTCdt - 0.16 * var_intracellular_Ca_buffering__dOTMgCdt + 0.5 * (-var_Ca_handling_by_the_SR__i_up - var_L_type_Ca_channel__i_Ca_L - var_T_type_Ca_channel__i_Ca_T - var_background_currents__i_B_Ca - var_sarcolemmal_calcium_pump_current__i_CaP + 2.0 * var_Na_Ca_ion_exchanger_current__i_NaCa + var_Ca_handling_by_the_SR__i_rel) / (var_intracellular_ion_concentrations__Vol_Ca * var_membrane__F); // millimolar / second
        ...
        const double var_background_currents__i_B_Na = (((var_environment__CT == 1.0) && (var_environment__PM == 0.0)) ? (2e-05 * var_chaste_interface__membrane__V - 2e-05 * var_sodium_current__E_Na) : (((var_environment__CT == 0.0) && (var_environment__PM == 1.0)) ? (3e-05 * var_chaste_interface__membrane__V - 3e-05 * var_sodium_current__E_Na) : ((-var_sodium_current__E_Na + var_chaste_interface__membrane__V) * var_background_currents__g_B_Na))); // picoA
        const double var_sodium_current__P_Na = 1.4e-06; // nanolitre_per_second
        const double var_sodium_current_h1_gate__alpha_h = 44.9 * exp(-12.010771992818672 - 0.17953321364452424 * var_chaste_interface__membrane__V); // per_second
        const double var_sodium_current_h1_gate__beta_h = 1491.0 / (1.0 + 323.3 * exp(-7.333333333333333 - 0.07751937984496124 * var_chaste_interface__membrane__V)); // per_second
        ...
        const double var_sodium_current_h1_gate__tau_h1 = 0.00015 + 0.03 / (1.0 + exp(6.666666666666666 + 0.16666666666666666 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_sodium_current_h2_gate__tau_h2 = 0.00045 + 0.12 / (1.0 + exp(30.0 + 0.5 * var_chaste_interface__membrane__V)); // second
