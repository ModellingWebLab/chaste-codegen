...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellsakmann_model_2000_epiFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_persistent_sodium_current__i_p_Na = 1000.0 * (-51.5397 + var_chaste_interface__membrane__V) * var_membrane__Cm * var_persistent_sodium_current__g_pna / (1.0 + exp(-8.248180060285502 - 0.1421827901950748 * var_chaste_interface__membrane__V)); // nanoA
    ...
    void Cellsakmann_model_2000_epiFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_L_type_Ca_channel_f_gate__beta_f = 12.0 / (1.0 + exp(-6.666666666666668 - 0.19607843137254904 * var_chaste_interface__membrane__V)); // per_second
        ...
        const double var_fast_sodium_current_h_gate__beta_h = 2000.0 / (1.0 + 320.0 * exp(-7.5 + 0.1 * var_fast_sodium_current_h_gate__shifth - 0.1 * var_chaste_interface__membrane__V)); // per_second
        ...
        const double var_slow_delayed_rectifier_potassium_current__i_Ks = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2.0) * (-var_reversal_potentials__E_Ks + var_chaste_interface__membrane__V) * var_slow_delayed_rectifier_potassium_current__g_Ks; // nanoA
        const double var_slow_delayed_rectifier_potassium_current_xs_gate__xs_inf = 1.0 / (1.0 + exp(0.08982035928143713 - 0.059880239520958084 * var_chaste_interface__membrane__V)); // dimensionless
