...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellviswanathan_model_1999_epiFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_environment__time = 0.001 * var_chaste_interface__environment__time_converted; // second
        ...
        const double var_plateau_potassium_current__Kp = 1.0 / (1.0 + exp(1.2521739130434784 - 0.16722408026755853 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_time_independent_potassium_current_K1_gate__alpha_K1 = 1020.0 / (1.0 + exp(-14.1227775 + 0.2385 * var_chaste_interface__membrane__V - 0.2385 * var_time_independent_potassium_current__E_K)); // per_second
        const double var_time_independent_potassium_current_K1_gate__beta_K1 = 1000.0 * (0.49124 * exp(0.43983232 + 0.08032 * var_chaste_interface__membrane__V - 0.08032 * var_time_independent_potassium_current__E_K) + exp(-36.6986425 + 0.06175 * var_chaste_interface__membrane__V - 0.06175 * var_time_independent_potassium_current__E_K)) / (1.0 + exp(-2.4444679 + 0.5143 * var_time_independent_potassium_current__E_K - 0.5143 * var_chaste_interface__membrane__V)); // per_second
    ...
    void Cellviswanathan_model_1999_epiFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_T_type_Ca_channel__g_CaT = 0.05; // milliS_per_microF
        const double var_calcium_background_current__g_Cab = 0.003016; // milliS_per_microF
        const double var_calcium_dynamics__APtrack2_orig_deriv = (((var_chaste_interface__calcium_dynamics__APtrack > 0.18) && (var_chaste_interface__calcium_dynamics__APtrack < 0.2)) ? (100000.0 - 100500.0 * var_chaste_interface__calcium_dynamics__APtrack2) : (-500.0 * var_chaste_interface__calcium_dynamics__APtrack2)); // 1 / second
        ...
        const double var_calcium_dynamics__APtrack3_orig_deriv = (((var_chaste_interface__calcium_dynamics__APtrack > 0.18) && (var_chaste_interface__calcium_dynamics__APtrack < 0.2)) ? (100000.0 - 100500.0 * var_chaste_interface__calcium_dynamics__APtrack3) : (-10.0 * var_chaste_interface__calcium_dynamics__APtrack3)); // 1 / second
        ...
        const double var_Na_Ca_exchanger__i_NaCa = (pow(var_chaste_interface__ionic_concentrations__Nai, var_Na_Ca_exchanger__n_NaCa) * var_calcium_dynamics__Cao * exp((-2.0 + var_Na_Ca_exchanger__n_NaCa) * var_Na_Ca_exchanger__gamma * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) - pow(var_ionic_concentrations__Nao, var_Na_Ca_exchanger__n_NaCa) * var_chaste_interface__calcium_dynamics__Cai * exp((-1.0 + var_Na_Ca_exchanger__gamma) * (-2.0 + var_Na_Ca_exchanger__n_NaCa) * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * var_Na_Ca_exchanger__K_NaCa / ((1.0 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai) * (1.0 + (pow(var_chaste_interface__ionic_concentrations__Nai, var_Na_Ca_exchanger__n_NaCa) * var_calcium_dynamics__Cao + pow(var_ionic_concentrations__Nao, var_Na_Ca_exchanger__n_NaCa) * var_chaste_interface__calcium_dynamics__Cai) * var_Na_Ca_exchanger__d_NaCa)); // microA_per_microF
        const double var_T_type_Ca_channel__i_Ca_T = pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2) * (-var_calcium_background_current__E_Ca + var_chaste_interface__membrane__V) * var_T_type_Ca_channel__g_CaT * var_chaste_interface__T_type_Ca_channel_g_gate__g; // microA_per_microF
        const double var_T_type_Ca_channel_b_gate__b_inf = 1.0 / (1.0 + exp(-1.2962962962962963 - 0.09259259259259259 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_T_type_Ca_channel_b_gate__tau_b = 0.0037 + 0.0061 / (1.0 + exp(5.555555555555555 + 0.2222222222222222 * var_chaste_interface__membrane__V)); // second
        ...
        const double var_fast_sodium_current_j_gate__beta_j = ((var_chaste_interface__membrane__V < -40.0) ? (121.2 * exp(-0.01052 * var_chaste_interface__membrane__V) / (1.0 + exp(-5.5312920000000005 - 0.1378 * var_chaste_interface__membrane__V))) : (300.0 * exp(-2.535e-07 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.2 - 0.1 * var_chaste_interface__membrane__V)))); // per_second
        ...
        const double var_rapid_delayed_rectifier_potassium_current__g_Kr_max = 0.02614; // milliS_per_cm2
        const double var_rapid_delayed_rectifier_potassium_current__g_Kr = 0.4303314829119352 * sqrt(var_ionic_concentrations__Ko) * var_rapid_delayed_rectifier_potassium_current__g_Kr_max; // milliS_per_microF
        const double var_rapid_delayed_rectifier_potassium_current_xr_gate__tau_xr = 0.001 / (0.00061 * (38.9 + var_chaste_interface__membrane__V) / (-1.0 + exp(5.640499999999999 + 0.145 * var_chaste_interface__membrane__V)) + 0.00138 * (14.2 + var_chaste_interface__membrane__V) / (1.0 - exp(-1.7466 - 0.123 * var_chaste_interface__membrane__V))); // second
        ...
        const double var_slow_delayed_rectifier_potassium_current__E_Ks = var_membrane__R * var_membrane__T * log((var_ionic_concentrations__Nao * var_slow_delayed_rectifier_potassium_current__PNaK + var_ionic_concentrations__Ko) / (var_chaste_interface__ionic_concentrations__Nai * var_slow_delayed_rectifier_potassium_current__PNaK + var_chaste_interface__ionic_concentrations__Ki)) / var_membrane__F; // millivolt
        const double var_slow_delayed_rectifier_potassium_current__g_Ks = 0.433 + 0.2598 / (1.0 + 6.481821026062645e-07 * pow(1 / var_chaste_interface__calcium_dynamics__Cai, 1.4)); // milliS_per_microF
        const double var_slow_delayed_rectifier_potassium_current_xs1_gate__tau_xs1 = 0.001 / (0.000131 * (30.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(2.061 + 0.0687 * var_chaste_interface__membrane__V)) + 7.19e-05 * (30.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.4399999999999995 - 0.148 * var_chaste_interface__membrane__V))); // second
        const double var_slow_delayed_rectifier_potassium_current_xs1_gate__xs1_infinity = 1.0 / (1.0 + exp(0.08982035928143713 - 0.059880239520958084 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_slow_delayed_rectifier_potassium_current_xs2_gate__tau_xs2 = 0.004 / (0.000131 * (30.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(2.061 + 0.0687 * var_chaste_interface__membrane__V)) + 7.19e-05 * (30.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-4.4399999999999995 - 0.148 * var_chaste_interface__membrane__V))); // second
        const double var_slow_delayed_rectifier_potassium_current__i_Ks = (-var_slow_delayed_rectifier_potassium_current__E_Ks + var_chaste_interface__membrane__V) * var_slow_delayed_rectifier_potassium_current__g_Ks * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2; // microA_per_microF
        const double var_slow_delayed_rectifier_potassium_current_xs2_gate__xs2_infinity = 1.0 / (1.0 + exp(0.08982035928143713 - 0.059880239520958084 * var_chaste_interface__membrane__V)); // dimensionless
