...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnoble_model_1998FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_time_independent_potassium_current__i_K1 = 0.14285714285714285 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(-0.46792363528431841 + 0.046792363528431843 * var_chaste_interface__membrane__V - 0.046792363528431843 * var_reversal_potentials__E_K)); // nanoA
