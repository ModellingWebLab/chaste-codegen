...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellluo_rudy_1994FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel_f_Ca_gate__f_Ca = 1.0 / (1.0 + 2777777.7777777785 * pow(var_ionic_concentrations__Cai, 2.0)); // dimensionless
        ...
        const double var_Na_Ca_exchanger__i_NaCa = 1.8422531054846208e-6 * (1.8 * pow(var_chaste_interface__ionic_concentrations__Nai, 3.0) * exp(0.013150655966354929 * var_chaste_interface__membrane__V) - 2744000.0 * var_ionic_concentrations__Cai * exp(-0.024422646794659157 * var_chaste_interface__membrane__V)) / (1.0 + 0.10000000000000001 * exp(-0.024422646794659157 * var_chaste_interface__membrane__V)); // uA_per_mm2
