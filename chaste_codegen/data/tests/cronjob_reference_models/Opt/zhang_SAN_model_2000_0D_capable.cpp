...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellzhang_SAN_model_2000_0D_capableFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_hyperpolarisation_activated_current__i_f_Na = 1.0 * (0.0005465 + 0.0063284999999999999 * var_membrane__FCell) * (-76.171870705299767 + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y; // nanoA
        const double var_slow_delayed_rectifying_potassium_current__i_K_s = pow(var_chaste_interface__slow_delayed_rectifying_potassium_current_xs_gate__xs, 2.0) * (0.00034450000000000003 + 0.0100555 * var_membrane__FCell) * (71.365322852196968 + var_chaste_interface__membrane__V); // nanoA
