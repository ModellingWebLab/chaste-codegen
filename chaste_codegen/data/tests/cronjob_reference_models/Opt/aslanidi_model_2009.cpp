...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellaslanidi_model_2009FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_inward_rectifier__i_K1 = 0.010160000000000001 * pow((var_chaste_interface__cleft_space_ion_concentrations__K_c / (0.58999999999999997 + var_chaste_interface__cleft_space_ion_concentrations__K_c)), 3.0) * (-var_Ca_independent_transient_outward_K_current__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(0.18895643383558952 + 0.052487898287663752 * var_chaste_interface__membrane__V - 0.052487898287663752 * var_Ca_independent_transient_outward_K_current__E_K)); // picoA
