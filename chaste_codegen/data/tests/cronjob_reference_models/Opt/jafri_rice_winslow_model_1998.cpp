...
#include "MathsCustomFunctions.hpp"
    ...
    double Celljafri_rice_winslow_model_1998FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel__i_Ca_L_Ca_max = 0.49123617829520522 * (-0.61380000000000001 + 0.001 * exp(0.075146605522028162 * var_chaste_interface__membrane__V)) * var_chaste_interface__membrane__V / (-1.0 + exp(0.075146605522028162 * var_chaste_interface__membrane__V)); // uA_per_mm2
        ...
        const double var_L_type_Ca_channel__i_Ca_L_K = 3.6387865058904094e-6 * (-var_chaste_interface__ionic_concentrations__Ko + var_chaste_interface__ionic_concentrations__Ki * exp(0.037573302761014081 * var_chaste_interface__membrane__V)) * (var_chaste_interface__L_type_Ca_channel__O + var_chaste_interface__L_type_Ca_channel__O_Ca) * var_chaste_interface__L_type_Ca_channel_y_gate__y * var_chaste_interface__membrane__V / ((1.0 - 218.34061135371181 * var_L_type_Ca_channel__i_Ca_L_Ca_max) * (-1.0 + exp(0.037573302761014081 * var_chaste_interface__membrane__V))); // uA_per_mm2
        const double var_Na_Ca_exchanger__i_NaCa = 4.6056327637115525e-6 * (1.8 * pow(var_chaste_interface__ionic_concentrations__Nai, 3.0) * exp(0.013150655966354927 * var_chaste_interface__membrane__V) - 2744000.0 * var_chaste_interface__calcium_subsystem__Cai * exp(-0.024422646794659154 * var_chaste_interface__membrane__V)) / (1.0 + 0.10000000000000001 * exp(-0.024422646794659154 * var_chaste_interface__membrane__V)); // uA_per_mm2
        ...
        const double var_non_specific_calcium_activated_current__i_ns_Ca = 6.3678763853082156e-6 * (-105.0 + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(0.037573302761014081 * var_non_specific_calcium_activated_current__VnsCa)) * var_non_specific_calcium_activated_current__VnsCa / ((1.0 + 1.7279999999999996e-9 * pow(1 / var_chaste_interface__calcium_subsystem__Cai, 3.0)) * (-1.0 + exp(0.037573302761014081 * var_non_specific_calcium_activated_current__VnsCa))) + 6.3678763853082156e-6 * (-0.75 * var_chaste_interface__ionic_concentrations__Ko + 0.75 * var_chaste_interface__ionic_concentrations__Ki * exp(0.037573302761014081 * var_non_specific_calcium_activated_current__VnsCa)) * var_non_specific_calcium_activated_current__VnsCa / ((1.0 + 1.7279999999999996e-9 * pow(1 / var_chaste_interface__calcium_subsystem__Cai, 3.0)) * (-1.0 + exp(0.037573302761014081 * var_non_specific_calcium_activated_current__VnsCa))); // uA_per_mm2
    ...
    void Celljafri_rice_winslow_model_1998FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_sodium_background_current__i_Na_b = 1.4100000000000001e-5 * var_chaste_interface__membrane__V - 1.4100000000000001e-5 * var_fast_sodium_current__E_Na; // uA_per_mm2
        const double var_sodium_potassium_pump__i_NaK = 0.012999999999999999 * var_chaste_interface__ionic_concentrations__Ko / ((1.0 + 31.622776601683793 * pow(1 / var_chaste_interface__ionic_concentrations__Nai, 1.5)) * (1.5 + var_chaste_interface__ionic_concentrations__Ko) * (1.0 + 0.1245 * exp(-0.0037573302761014088 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.037573302761014081 * var_chaste_interface__membrane__V))); // uA_per_mm2
        const double d_dt_chaste_interface_var_ionic_concentrations__Nai = -0.0061358692846255891 * var_fast_sodium_current__i_Na - 0.0061358692846255891 * var_non_specific_calcium_activated_current__i_ns_Na - 0.0061358692846255891 * var_sodium_background_current__i_Na_b - 0.018407607853876767 * var_Na_Ca_exchanger__i_NaCa - 0.018407607853876767 * var_sodium_potassium_pump__i_NaK; // mM / ms
        ...
        const double var_plateau_potassium_current__i_Kp = 8.2799999999999993e-5 * (-var_time_independent_potassium_current__E_K1 + var_chaste_interface__membrane__V) / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V)); // uA_per_mm2
        const double var_time_independent_potassium_current__i_K1 = 0.0032920358442763043 * sqrt(var_chaste_interface__ionic_concentrations__Ko) * (-var_time_independent_potassium_current__E_K1 + var_chaste_interface__membrane__V) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 0.23849999999999999 * var_time_independent_potassium_current__E_K1)) * (1.02 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 0.23849999999999999 * var_time_independent_potassium_current__E_K1)) + (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 0.080320000000000003 * var_time_independent_potassium_current__E_K1) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 0.061749999999999999 * var_time_independent_potassium_current__E_K1)) / (1.0 + exp(-2.4444678999999998 + 0.51429999999999998 * var_time_independent_potassium_current__E_K1 - 0.51429999999999998 * var_chaste_interface__membrane__V)))); // uA_per_mm2
        const double d_dt_chaste_interface_var_ionic_concentrations__Ki = 0.012271738569251178 * var_sodium_potassium_pump__i_NaK - 0.0061358692846255891 * var_L_type_Ca_channel__i_Ca_L_K - 0.0061358692846255891 * var_non_specific_calcium_activated_current__i_ns_K - 0.0061358692846255891 * var_plateau_potassium_current__i_Kp - 0.0061358692846255891 * var_time_dependent_potassium_current__i_K - 0.0061358692846255891 * var_time_independent_potassium_current__i_K1; // mM / ms
        const double d_dt_chaste_interface_var_ionic_concentrations__Ko = 0.0061358692846255891 * var_L_type_Ca_channel__i_Ca_L_K + 0.0061358692846255891 * var_non_specific_calcium_activated_current__i_ns_K + 0.0061358692846255891 * var_plateau_potassium_current__i_Kp + 0.0061358692846255891 * var_time_dependent_potassium_current__i_K + 0.0061358692846255891 * var_time_independent_potassium_current__i_K1 - 0.012271738569251178 * var_sodium_potassium_pump__i_NaK; // mM / ms
        ...
        {
            d_dt_chaste_interface_var_membrane__V = -100.0 * var_L_type_Ca_channel__i_Ca_L_Ca - 100.0 * var_L_type_Ca_channel__i_Ca_L_K - 100.0 * var_Na_Ca_exchanger__i_NaCa - 100.0 * var_calcium_background_current__i_Ca_b - 100.0 * var_fast_sodium_current__i_Na - 100.0 * var_non_specific_calcium_activated_current__i_ns_K - 100.0 * var_non_specific_calcium_activated_current__i_ns_Na - 100.0 * var_plateau_potassium_current__i_Kp - 100.0 * var_sarcolemmal_calcium_pump__i_p_Ca - 100.0 * var_sodium_background_current__i_Na_b - 100.0 * var_sodium_potassium_pump__i_NaK - 100.0 * var_time_dependent_potassium_current__i_K - 100.0 * var_time_independent_potassium_current__i_K1 - 0.99999999999999989 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time); // mV / ms
        }
