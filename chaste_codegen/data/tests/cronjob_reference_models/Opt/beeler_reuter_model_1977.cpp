...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellbeeler_reuter_model_1977FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_slow_inward_current__i_s = 0.0009 * (82.3 + 13.0287 * log(0.001 * var_chaste_interface__slow_inward_current__Cai_converted) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f; // uA_per_mm2
        const double var_sodium_current__i_Na = (3e-05 + 0.04 * pow(var_chaste_interface__sodium_current_m_gate__m, 3.0) * var_chaste_interface__sodium_current_h_gate__h * var_chaste_interface__sodium_current_j_gate__j) * (-50.0 + var_chaste_interface__membrane__V); // uA_per_mm2
        const double var_time_dependent_outward_current__i_x1 = 0.008 * (-1.0 + exp(3.08 + 0.04 * var_chaste_interface__membrane__V)) * var_chaste_interface__time_dependent_outward_current_x1_gate__x1 / exp(1.4000000000000001 + 0.04 * var_chaste_interface__membrane__V); // uA_per_mm2
        const double var_time_independent_outward_current__i_K1 = 0.0007000000000000001 * (23.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-0.92 - 0.04 * var_chaste_interface__membrane__V)) + 0.014 * (-1.0 + exp(3.4 + 0.04 * var_chaste_interface__membrane__V)) / (exp(2.12 + 0.04 * var_chaste_interface__membrane__V) + exp(4.24 + 0.08 * var_chaste_interface__membrane__V)); // uA_per_mm2
    ...
    void Cellbeeler_reuter_model_1977FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_slow_inward_current_d_gate__d = 0.095 * (1.0 - var_chaste_interface__slow_inward_current_d_gate__d) * exp(0.05 - 0.01 * var_chaste_interface__membrane__V) / (1.0 + exp(0.3599712023038157 - 0.07199424046076314 * var_chaste_interface__membrane__V)) - 0.07 * var_chaste_interface__slow_inward_current_d_gate__d * exp(-0.7457627118644068 - 0.01694915254237288 * var_chaste_interface__membrane__V) / (1.0 + exp(2.2 + 0.05 * var_chaste_interface__membrane__V)); // 1 / ms
        const double d_dt_chaste_interface_var_slow_inward_current_f_gate__f = 0.012 * (1.0 - var_chaste_interface__slow_inward_current_f_gate__f) * exp(-0.224 - 0.008 * var_chaste_interface__membrane__V) / (1.0 + exp(4.197901049475263 + 0.14992503748125938 * var_chaste_interface__membrane__V)) - 0.0065 * var_chaste_interface__slow_inward_current_f_gate__f * exp(-0.6 - 0.02 * var_chaste_interface__membrane__V) / (1.0 + exp(-6.0 - 0.2 * var_chaste_interface__membrane__V)); // 1 / ms
        const double var_slow_inward_current__i_s = 0.0009 * (82.3 + 13.0287 * log(0.001 * var_slow_inward_current__Cai) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f; // uA_per_mm2
        const double d_dt_chaste_interface_var_slow_inward_current__Cai_converted = 7.000000000000001e-06 - 0.07 * var_slow_inward_current__Cai - 0.01 * var_slow_inward_current__i_s; // millimolar / ms
        const double d_dt_chaste_interface_var_sodium_current_h_gate__h = 0.126 * (1.0 - var_chaste_interface__sodium_current_h_gate__h) * exp(-19.25 - 0.25 * var_chaste_interface__membrane__V) - 1.7 * var_chaste_interface__sodium_current_h_gate__h / (1.0 + exp(-1.845 - 0.082 * var_chaste_interface__membrane__V)); // 1 / ms
        const double d_dt_chaste_interface_var_sodium_current_j_gate__j = -0.3 * var_chaste_interface__sodium_current_j_gate__j / (1.0 + exp(-3.2 - 0.1 * var_chaste_interface__membrane__V)) + 0.055 * (1.0 - var_chaste_interface__sodium_current_j_gate__j) * exp(-19.5 - 0.25 * var_chaste_interface__membrane__V) / (1.0 + exp(-15.600000000000001 - 0.2 * var_chaste_interface__membrane__V)); // 1 / ms
        const double d_dt_chaste_interface_var_sodium_current_m_gate__m = -40.0 * var_chaste_interface__sodium_current_m_gate__m * exp(-4.032 - 0.056 * var_chaste_interface__membrane__V) - 1.0 * (1.0 - var_chaste_interface__sodium_current_m_gate__m) * (47.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-4.7 - 0.1 * var_chaste_interface__membrane__V)); // 1 / ms
        const double d_dt_chaste_interface_var_time_dependent_outward_current_x1_gate__x1 = 0.0005 * (1.0 - var_chaste_interface__time_dependent_outward_current_x1_gate__x1) * exp(4.132231404958678 + 0.08264462809917356 * var_chaste_interface__membrane__V) / (1.0 + exp(2.857142857142857 + 0.05714285714285714 * var_chaste_interface__membrane__V)) - 0.0013 * var_chaste_interface__time_dependent_outward_current_x1_gate__x1 * exp(-1.1997600479904018 - 0.05998800239952009 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.8 - 0.04 * var_chaste_interface__membrane__V)); // 1 / ms
        ...
        {
            d_dt_chaste_interface_var_membrane__V = -1.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) - 100.0 * var_slow_inward_current__i_s - 100.0 * (3e-05 + 0.04 * pow(var_chaste_interface__sodium_current_m_gate__m, 3.0) * var_chaste_interface__sodium_current_h_gate__h * var_chaste_interface__sodium_current_j_gate__j) * (-50.0 + var_chaste_interface__membrane__V) - 0.07 * (23.0 + var_chaste_interface__membrane__V) / (1.0 - exp(-0.92 - 0.04 * var_chaste_interface__membrane__V)) - 1.4000000000000001 * (-1.0 + exp(3.4 + 0.04 * var_chaste_interface__membrane__V)) / (exp(2.12 + 0.04 * var_chaste_interface__membrane__V) + exp(4.24 + 0.08 * var_chaste_interface__membrane__V)) - 0.8 * (-1.0 + exp(3.08 + 0.04 * var_chaste_interface__membrane__V)) * var_chaste_interface__time_dependent_outward_current_x1_gate__x1 / exp(1.4000000000000001 + 0.04 * var_chaste_interface__membrane__V); // mV / ms
        }
