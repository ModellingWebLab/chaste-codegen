...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnoble_noble_SAN_model_1984FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_hyperpolarising_activated_current__E_K = 26.71376065969565 * log(var_chaste_interface__extracellular_potassium_concentration__Kc / var_chaste_interface__intracellular_potassium_concentration__Ki); // millivolt
        ...
        const double var_fast_sodium_current__i_Na = 1.25 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (-26.71376065969565 * log((140.0 + 0.12 * var_chaste_interface__extracellular_potassium_concentration__Kc) / (0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki + var_chaste_interface__intracellular_sodium_concentration__Nai)) + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current_h_gate__h; // nanoA
        ...
        const double var_second_inward_current__i_si = 0.00280754181170591 * (-50.0 + var_chaste_interface__membrane__V) * (-140.0 * exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_sodium_concentration__Nai * exp(1.8716945411372734)) * var_chaste_interface__second_inward_current_d_gate__d * var_chaste_interface__second_inward_current_f2_gate__f2 * var_chaste_interface__second_inward_current_f_gate__f / (1.0 - exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V)) + 0.00280754181170591 * (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_potassium_concentration__Ki * exp(1.8716945411372734) - var_chaste_interface__extracellular_potassium_concentration__Kc * exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V)) * var_chaste_interface__second_inward_current_d_gate__d * var_chaste_interface__second_inward_current_f2_gate__f2 * var_chaste_interface__second_inward_current_f_gate__f / (1.0 - exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V)) + 1.123016724682364 * (-50.0 + var_chaste_interface__membrane__V) * (-2.0 * exp(3.743389082274547 - 0.07486778164549093 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_calcium_concentration__Cai * exp(3.743389082274547)) * var_chaste_interface__second_inward_current_d_gate__d * var_chaste_interface__second_inward_current_f2_gate__f2 * var_chaste_interface__second_inward_current_f_gate__f / (1.0 - exp(3.743389082274547 - 0.07486778164549093 * var_chaste_interface__membrane__V)); // nanoA
        const double var_sodium_background_current__i_Na_b = 0.07 * var_chaste_interface__membrane__V - 0.07 * var_hyperpolarising_activated_current__E_Na; // nanoA
        ...
        const double var_time_dependent_potassium_current__i_K = 0.14285714285714285 * (-var_chaste_interface__extracellular_potassium_concentration__Kc * exp(-0.037433890822745466 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_potassium_concentration__Ki) * var_chaste_interface__time_dependent_potassium_current_x_gate__x; // nanoA
        const double var_time_independent_potassium_current__i_K1 = 0.75 * (-var_hyperpolarising_activated_current__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__extracellular_potassium_concentration__Kc / ((1.0 + exp(0.7486778164549093 + 0.07486778164549093 * var_chaste_interface__membrane__V - 0.07486778164549093 * var_hyperpolarising_activated_current__E_K)) * (10.0 + var_chaste_interface__extracellular_potassium_concentration__Kc)); // nanoA
    ...
    void Cellnoble_noble_SAN_model_1984FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_intracellular_calcium_concentration__i_rel = 558.7064341863899 * pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 2.0) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel / (4e-06 + pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 2.0)); // nanoA
        ...
        const double d_dt_chaste_interface_var_intracellular_calcium_concentration__Ca_rel = 0.0001789848727008557 * var_intracellular_calcium_concentration__i_tr - 0.0001789848727008557 * var_intracellular_calcium_concentration__i_rel; // millimolar / millisecond
        const double var_intracellular_calcium_concentration__i_up = 11174.128683727797 * (5.0 - var_chaste_interface__intracellular_calcium_concentration__Ca_up) * var_chaste_interface__intracellular_calcium_concentration__Cai; // nanoA
        const double d_dt_chaste_interface_var_intracellular_calcium_concentration__Ca_up = 7.159394908034226e-05 * var_intracellular_calcium_concentration__i_up - 7.159394908034226e-05 * var_intracellular_calcium_concentration__i_tr; // millimolar / millisecond
        const double var_hyperpolarising_activated_current__E_K = 26.71376065969565 * log(var_chaste_interface__extracellular_potassium_concentration__Kc / var_chaste_interface__intracellular_potassium_concentration__Ki); // millivolt
        const double var_hyperpolarising_activated_current__E_Na = 26.71376065969565 * log(140.0 / var_chaste_interface__intracellular_sodium_concentration__Nai); // millivolt
        const double var_Na_Ca_exchanger__i_NaCa = 0.002 * (2.0 * pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 3.0) * exp(0.018716945411372733 * var_chaste_interface__membrane__V) - 2744000.0 * var_chaste_interface__intracellular_calcium_concentration__Cai * exp(-0.018716945411372733 * var_chaste_interface__membrane__V)) / ((1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Cai) * (1.0 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Cai + 0.0002 * pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 3.0))); // nanoA
        const double var_calcium_background_current__i_Ca_b = 0.01 * var_chaste_interface__membrane__V - 0.13356880329847826 * log(2.0 / var_chaste_interface__intracellular_calcium_concentration__Cai); // nanoA
        ...
        const double d_dt_chaste_interface_var_hyperpolarising_activated_current_y_gate__y = 0.0001 * (1.0 - var_chaste_interface__hyperpolarising_activated_current_y_gate__y) * exp(-0.067 * var_hyperpolarising_activated_current_y_gate__E0_y) - 0.002 * ((fabs(var_hyperpolarising_activated_current_y_gate__E0_y) < 1e-05) ? (2.5) : (var_hyperpolarising_activated_current_y_gate__E0_y / (1.0 - 1.0 * exp(-0.2 * var_hyperpolarising_activated_current_y_gate__E0_y)))) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y; // 1 / millisecond
        ...
        const double var_second_inward_current__i_siCa = 1.123016724682364 * (-50.0 + var_chaste_interface__membrane__V) * (-2.0 * exp(3.743389082274547 - 0.07486778164549093 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_calcium_concentration__Cai * exp(3.743389082274547)) * var_chaste_interface__second_inward_current_d_gate__d * var_chaste_interface__second_inward_current_f2_gate__f2 * var_chaste_interface__second_inward_current_f_gate__f / (1.0 - exp(3.743389082274547 - 0.07486778164549093 * var_chaste_interface__membrane__V)); // nanoA
        const double d_dt_chaste_interface_var_intracellular_calcium_concentration__Cai = 3.579697454017114e-06 * var_intracellular_calcium_concentration__i_rel + 7.159394908034228e-06 * var_Na_Ca_exchanger__i_NaCa - 3.579697454017114e-06 * var_calcium_background_current__i_Ca_b - 3.579697454017114e-06 * var_intracellular_calcium_concentration__i_up - 3.579697454017114e-06 * var_second_inward_current__i_siCa; // millimolar / millisecond
        ...
        const double var_second_inward_current__i_siNa = 0.00280754181170591 * (-50.0 + var_chaste_interface__membrane__V) * (-140.0 * exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_sodium_concentration__Nai * exp(1.8716945411372734)) * var_chaste_interface__second_inward_current_d_gate__d * var_chaste_interface__second_inward_current_f2_gate__f2 * var_chaste_interface__second_inward_current_f_gate__f / (1.0 - exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V)); // nanoA
        ...
        const double var_sodium_background_current__i_Na_b = 0.07 * var_chaste_interface__membrane__V - 0.07 * var_hyperpolarising_activated_current__E_Na; // nanoA
        const double var_sodium_potassium_pump__i_p = 50.0 * var_chaste_interface__extracellular_potassium_concentration__Kc * var_chaste_interface__intracellular_sodium_concentration__Nai / ((1.0 + var_chaste_interface__extracellular_potassium_concentration__Kc) * (40.0 + var_chaste_interface__intracellular_sodium_concentration__Nai)); // nanoA
        const double d_dt_chaste_interface_var_intracellular_sodium_concentration__Nai = -2.1478184724102686e-05 * var_Na_Ca_exchanger__i_NaCa - 2.1478184724102686e-05 * var_sodium_potassium_pump__i_p - 7.159394908034228e-06 * var_fast_sodium_current__i_Na - 7.159394908034228e-06 * var_hyperpolarising_activated_current__i_fNa - 7.159394908034228e-06 * var_second_inward_current__i_siNa - 7.159394908034228e-06 * var_sodium_background_current__i_Na_b; // millimolar / millisecond
        const double var_time_dependent_potassium_current_x_gate__E0_x = 22.0 + var_chaste_interface__membrane__V; // millivolt
        const double var_time_dependent_potassium_current__i_K = 0.14285714285714285 * (-var_chaste_interface__extracellular_potassium_concentration__Kc * exp(-0.037433890822745466 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_potassium_concentration__Ki) * var_chaste_interface__time_dependent_potassium_current_x_gate__x; // nanoA
        const double d_dt_chaste_interface_var_time_dependent_potassium_current_x_gate__x = 0.001 * (1.0 - var_chaste_interface__time_dependent_potassium_current_x_gate__x) * ((fabs(var_time_dependent_potassium_current_x_gate__E0_x) < 0.0001) ? (2.5) : (0.5 * var_time_dependent_potassium_current_x_gate__E0_x / (1.0 - exp(-0.2 * var_time_dependent_potassium_current_x_gate__E0_x)))) - 0.001 * ((fabs(var_time_dependent_potassium_current_x_gate__E0_x) < 0.0001) ? (2.5) : (0.178 * var_time_dependent_potassium_current_x_gate__E0_x / (-1.0 + exp(0.06666666666666667 * var_time_dependent_potassium_current_x_gate__E0_x)))) * var_chaste_interface__time_dependent_potassium_current_x_gate__x; // 1 / millisecond
        const double var_time_independent_potassium_current__i_K1 = 0.75 * (-var_hyperpolarising_activated_current__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__extracellular_potassium_concentration__Kc / ((1.0 + exp(0.7486778164549093 + 0.07486778164549093 * var_chaste_interface__membrane__V - 0.07486778164549093 * var_hyperpolarising_activated_current__E_K)) * (10.0 + var_chaste_interface__extracellular_potassium_concentration__Kc)); // nanoA
        ...
        const double d_dt_chaste_interface_var_extracellular_potassium_concentration__Kc = 0.003 + 6.44664343412091e-05 * var_extracellular_potassium_concentration__i_mK - 0.001 * var_chaste_interface__extracellular_potassium_concentration__Kc; // millimolar / millisecond
        const double d_dt_chaste_interface_var_intracellular_potassium_concentration__Ki = -7.159394908034228e-06 * var_extracellular_potassium_concentration__i_mK; // millimolar / millisecond
