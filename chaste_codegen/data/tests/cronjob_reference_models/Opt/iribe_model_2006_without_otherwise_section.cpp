...
#include "MathsCustomFunctions.hpp"
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_sodium_background_current__i_b_Na = 0.00059999999999999995 * var_chaste_interface__membrane_potential__V - 0.01602825639581739 * log(140.0 / var_chaste_interface__intracellular_sodium_concentration__Na_i); // nanoA
        ...
        const double var_time_independent_potassium_current__i_K1 = 0.2857142857142857 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane_potential__V) / (1.0 + exp(-0.74867781645490949 + 0.074867781645490947 * var_chaste_interface__membrane_potential__V - 0.074867781645490947 * var_reversal_potentials__E_K)); // nanoA
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_RyR__j_rel = 500.0 * pow((var_chaste_interface__RyR__F_2 / (0.25 + var_chaste_interface__RyR__F_2)), 2.0) * (-var_chaste_interface__intracellular_calcium_concentration__Ca_i + var_chaste_interface__SR_calcium_concentration__Ca_SR) * var_chaste_interface__RyR__F_SRCa_RyR / (0.20000000000000001 + var_chaste_interface__RyR__F_SRCa_RyR); // millimolar_per_second
        const double var_SERCA__j_up = (-0.14537477691850093 * pow(var_chaste_interface__SR_calcium_concentration__Ca_SR, 2.0) + 5069444.444444444 * pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2.0) * var_chaste_interface__CaMKII_factor__F_CaMK) / (1.0 + 17361111.111111112 * pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2.0) + 0.37180249851279007 * pow(var_chaste_interface__SR_calcium_concentration__Ca_SR, 2.0)); // millimolar_per_second
        ...
        const double var_L_type_Ca_channel__i_Ca_L_K = 1.8716945411372739e-5 * (-50.0 + var_chaste_interface__membrane_potential__V) * (-4.0 * exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane_potential__V) + var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372736)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane_potential__V)); // nanoA
        ...
        const double var_Force__alpha_tm = 12600800629.436176 * pow(var_chaste_interface__troponin__Trpn_Ca, 5.1071428571428568); // per_second
