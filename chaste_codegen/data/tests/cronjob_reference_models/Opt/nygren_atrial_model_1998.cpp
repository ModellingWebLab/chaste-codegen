...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnygren_atrial_model_1998FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_Na_Ca_ion_exchanger_current__i_NaCa = 0.037484200000000002 * (pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0) * var_chaste_interface__cleft_space_ion_concentrations__Ca_c * exp(0.017058350483361479 * var_chaste_interface__membrane__V) - pow(var_chaste_interface__cleft_space_ion_concentrations__Na_c, 3.0) * var_chaste_interface__intracellular_ion_concentrations__Ca_i * exp(-0.020849095035219586 * var_chaste_interface__membrane__V)) / (1.0 + 0.00029999999999999997 * pow(var_chaste_interface__cleft_space_ion_concentrations__Na_c, 3.0) * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 0.00029999999999999997 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0) * var_chaste_interface__cleft_space_ion_concentrations__Ca_c); // picoA
        ...
        const double var_inward_rectifier__i_K1 = 3.0 * pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 0.44569999999999999) * (-var_Ca_independent_transient_outward_K_current__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(0.20470020580033776 + 0.056861168277871597 * var_chaste_interface__membrane__V - 0.056861168277871597 * var_Ca_independent_transient_outward_K_current__E_K)); // picoA
        ...
        const double var_sodium_current__i_Na = 5.8521211132021307 * pow(var_chaste_interface__sodium_current_m_gate__m, 3.0) * (-1.0 + exp(0.037907445518581065 * var_chaste_interface__membrane__V - 0.037907445518581065 * var_sodium_current__E_Na)) * (0.10000000000000001 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.90000000000000002 * var_chaste_interface__sodium_current_h1_gate__h1) * var_chaste_interface__cleft_space_ion_concentrations__Na_c * var_chaste_interface__membrane__V / (-1.0 + exp(0.037907445518581065 * var_chaste_interface__membrane__V)); // picoA
    ...
    void Cellnygren_atrial_model_1998FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_Ca_handling_by_the_SR__r_act = 203.80000000000001 * pow((var_chaste_interface__intracellular_ion_concentrations__Ca_d / (0.0030000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_d)), 4.0) + 203.80000000000001 * pow((var_chaste_interface__intracellular_ion_concentrations__Ca_i / (0.00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i)), 4.0); // per_second
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_channel_f_L1_gate__f_L_1 = 0.001 * (-var_chaste_interface__L_type_Ca_channel_f_L1_gate__f_L_1 + var_L_type_Ca_channel_f_L1_gate__f_L_infinity) / (0.01 + 0.161 * exp(-7.716049382716049 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0))); // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Ca_i = 8.8070109612833444e-7 * var_Ca_handling_by_the_SR__i_rel + 8.8070109612833444e-7 * var_intracellular_ion_concentrations__i_di + 1.7614021922566689e-6 * var_Na_Ca_ion_exchanger_current__i_NaCa - 8.8070109612833444e-7 * var_Ca_handling_by_the_SR__i_up - 8.8070109612833444e-7 * var_background_currents__i_B_Ca - 8.8070109612833444e-7 * var_sarcolemmal_calcium_pump_current__i_CaP - 8.0000000000000007e-5 * var_intracellular_Ca_buffering__O_TC_orig_deriv - 0.00016000000000000001 * var_intracellular_Ca_buffering__O_TMgC_orig_deriv - 4.4999999999999996e-5 * var_intracellular_Ca_buffering__O_C_orig_deriv; // millimolar / millisecond
        const double var_sodium_current__E_Na = 26.38004187092562 * log(var_chaste_interface__cleft_space_ion_concentrations__Na_c / var_chaste_interface__intracellular_ion_concentrations__Na_i); // millivolt
        const double var_background_currents__i_B_Na = 0.060599 * var_chaste_interface__membrane__V - 0.060599 * var_sodium_current__E_Na; // picoA
        ...
        const double var_sodium_current__i_Na = 5.8521211132021307 * pow(var_chaste_interface__sodium_current_m_gate__m, 3.0) * (-1.0 + exp(0.037907445518581065 * var_chaste_interface__membrane__V - 0.037907445518581065 * var_sodium_current__E_Na)) * (0.10000000000000001 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.90000000000000002 * var_chaste_interface__sodium_current_h1_gate__h1) * var_chaste_interface__cleft_space_ion_concentrations__Na_c * var_chaste_interface__membrane__V / (-1.0 + exp(0.037907445518581065 * var_chaste_interface__membrane__V)); // picoA
        const double d_dt_chaste_interface_var_sodium_current_m_gate__m = 0.001 * (-var_chaste_interface__sodium_current_m_gate__m + 1.0 / (1.0 + exp(-3.3032886723507917 - 0.12180267965895249 * var_chaste_interface__membrane__V))) / (2.4000000000000001e-5 + 4.1999999999999998e-5 * exp(-0.78827269000771605 * pow((1 + 0.039108330074305829 * var_chaste_interface__membrane__V), 2.0))); // 1 / millisecond
        const double var_sodium_potassium_pump__i_NaK = 70.825299999999999 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5) * (150.0 + var_chaste_interface__membrane__V) * var_chaste_interface__cleft_space_ion_concentrations__K_c / ((1.0 + var_chaste_interface__cleft_space_ion_concentrations__K_c) * (200.0 + var_chaste_interface__membrane__V) * (36.4828726939094 + pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5))); // picoA
        const double d_dt_chaste_interface_var_cleft_space_ion_concentrations__Na_c = 0.0090691505932400367 + 1.2951486707769622e-5 * var_background_currents__i_B_Na + 1.2951486707769622e-5 * var_sodium_current__i_Na + 3.885446012330887e-5 * var_Na_Ca_ion_exchanger_current__i_NaCa + 3.885446012330887e-5 * var_sodium_potassium_pump__i_NaK - 6.9930069930069916e-5 * var_chaste_interface__cleft_space_ion_concentrations__Na_c; // millimolar / millisecond
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Na_i = 2.9591556829912038e-6 - 1.7614021922566689e-6 * var_background_currents__i_B_Na - 1.7614021922566689e-6 * var_sodium_current__i_Na - 5.2842065767700066e-6 * var_Na_Ca_ion_exchanger_current__i_NaCa - 5.2842065767700066e-6 * var_sodium_potassium_pump__i_NaK; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__K_i = 3.5228043845133377e-6 * var_sodium_potassium_pump__i_NaK - 1.7614021922566689e-6 * var_Ca_independent_transient_outward_K_current__i_t - 1.7614021922566689e-6 * var_delayed_rectifier_K_currents__i_Kr - 1.7614021922566689e-6 * var_delayed_rectifier_K_currents__i_Ks - 1.7614021922566689e-6 * var_inward_rectifier__i_K1 - 1.7614021922566689e-6 * var_sustained_outward_K_current__i_sus; // millimolar / millisecond
