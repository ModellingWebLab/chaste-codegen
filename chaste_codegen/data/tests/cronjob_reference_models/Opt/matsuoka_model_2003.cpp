...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmatsuoka_model_2003FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_background_lCa_current__p_open = 1.0 / (1.0 + 1.7279999999999996e-9 * pow(1 / var_internal_ion_concentrations__Cai, 3.0)); // dimensionless
        const double d_dt_chaste_interface_var_Ca_concentrations_in_SR__Ca_Total = 3.2387883511406241e-5 * var_SR_T_current__i_SR_T - 3.2387883511406241e-5 * var_RyR_channel__i_RyR; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_channel_Ca_dependent_gate__p_U = 2.0019999999999998 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_UCa + 0.14299999999999999 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C - (0.34999999999999998 + var_L_type_Ca_channel_Ca_dependent_gate__k_UUCa_Ca) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U; // 1 / millisecond
        ...
        const double var_sodium_potassium_pump__p_E2Na = 1.0 / (1.0 + 2804.9496956618659 * pow(1 / var_sodium_potassium_pump__Nao_Eff, 1.0600000000000001)); // dimensionless
        ...
        const double d_dt_chaste_interface_var_internal_ion_concentrations__Nai = -1.2955153404562495e-6 * var_L_type_Ca_channel__i_CaL_Na - 1.2955153404562495e-6 * var_background_NSC_current__i_bNSC_Na - 1.2955153404562495e-6 * var_background_lCa_current__i_lCa_Na - 1.2955153404562495e-6 * var_slow_time_dependent_potassium_current__i_Ks_Na - 1.2955153404562495e-6 * var_sodium_current__i_Na_Na - 1.2955153404562495e-6 * var_transient_outward_current__i_to_Na - 3.886546021368749e-6 * var_sodium_calcium_exchanger__i_NaCa - 3.886546021368749e-6 * var_sodium_potassium_pump__i_NaK; // millimolar / millisecond
