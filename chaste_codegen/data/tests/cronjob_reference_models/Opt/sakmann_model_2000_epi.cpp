...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellsakmann_model_2000_epiFromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = -16.528925619834709 * HeartConfig::Instance()->GetCapacitance(); // uA_per_cm2
    ...
    double Cellsakmann_model_2000_epiFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel__i_Ca_L_K_ds = 8.2354559810040027e-6 * (-50.0 + var_chaste_interface__membrane__V) * (-4.0 * exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372736)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V)); // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_Na_cyt = 0; // nanoA
        const double var_L_type_Ca_channel__i_Ca_L_Na_ds = 4.1177279905020015e-5 * (-50.0 + var_chaste_interface__membrane__V) * (-140.0 * exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372736)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds * var_chaste_interface__L_type_Ca_channel_f_gate__f / (1.0 - exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V)); // nanoA
        ...
        const double var_fast_sodium_current__i_Na = 2.602071703500719 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (-26.713760659695652 * log(140.47999999999999 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i)) + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current_h_gate__h; // nanoA
        ...
        const double var_time_independent_potassium_current__i_K1 = 0.057142857142857141 * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(-0.56150836234118207 + 0.056150836234118214 * var_chaste_interface__membrane__V - 0.056150836234118214 * var_reversal_potentials__E_K)); // nanoA
    ...
    void Cellsakmann_model_2000_epiFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        {
            d_dt_chaste_interface_var_membrane__V = -8.2644628099173545 * var_L_type_Ca_channel__i_Ca_L_Ca_cyt - 8.2644628099173545 * var_L_type_Ca_channel__i_Ca_L_Ca_ds - 8.2644628099173545 * var_L_type_Ca_channel__i_Ca_L_K_cyt - 8.2644628099173545 * var_L_type_Ca_channel__i_Ca_L_K_ds - 8.2644628099173545 * var_L_type_Ca_channel__i_Ca_L_Na_cyt - 8.2644628099173545 * var_L_type_Ca_channel__i_Ca_L_Na_ds - 8.2644628099173545 * var_calcium_background_current__i_b_Ca - 8.2644628099173545 * var_fast_sodium_current__i_Na - 8.2644628099173545 * var_persistent_sodium_current__i_p_Na - 8.2644628099173545 * var_rapid_delayed_rectifier_potassium_current__i_Kr - 8.2644628099173545 * var_slow_delayed_rectifier_potassium_current__i_Ks - 8.2644628099173545 * var_sodium_background_current__i_b_Na - 8.2644628099173545 * var_sodium_calcium_exchanger__i_NaCa_cyt - 8.2644628099173545 * var_sodium_potassium_pump__i_NaK - 8.2644628099173545 * var_time_independent_potassium_current__i_K1 - 8.2644628099173545 * var_transient_outward_current__i_to - 1.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() - 9.9173553719008269e-7 * (2.0 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) * exp(0.018716945411372737 * var_chaste_interface__membrane__V) - 2744000.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds * exp(-0.018716945411372737 * var_chaste_interface__membrane__V)) / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds); // millivolt / millisecond
        }
