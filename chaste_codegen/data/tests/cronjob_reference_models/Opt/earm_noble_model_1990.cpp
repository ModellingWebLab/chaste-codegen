...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellearm_noble_model_1990FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_calcium_current__i_Ca_L = 3.7433890822745467e-06 * (-50.0 + var_chaste_interface__membrane__V) * (-4.0 * exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372734)) * var_chaste_interface__L_type_calcium_current_d_gate__d * var_L_type_calcium_current_f_Ca_gate__CaChon / (1.0 - exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V)) + 1.8716945411372735e-05 * (-50.0 + var_chaste_interface__membrane__V) * (-140.0 * exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372734)) * var_chaste_interface__L_type_calcium_current_d_gate__d * var_L_type_calcium_current_f_Ca_gate__CaChon / (1.0 - exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V)) + 0.0074867781645490935 * (-50.0 + var_chaste_interface__membrane__V) * (-2.0 * exp(3.743389082274547 - 0.07486778164549093 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(3.743389082274547)) * var_chaste_interface__L_type_calcium_current_d_gate__d * var_L_type_calcium_current_f_Ca_gate__CaChon / (1.0 - exp(3.743389082274547 - 0.07486778164549093 * var_chaste_interface__membrane__V)); // nanoA
        ...
        const double var_calcium_background_current__i_b_Ca = 5e-05 * var_chaste_interface__membrane__V - 0.0006678440164923913 * log(2.0 / var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
        const double var_fast_sodium_current__i_Na = 0.5 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (-26.71376065969565 * log(140.48 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i)) + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current_h_gate__h; // nanoA
        ...
        const double var_transient_outward_current__E_K = 26.71376065969565 * log(4.0 / var_chaste_interface__intracellular_potassium_concentration__K_i); // millivolt
        const double var_potassium_background_current__i_b_K = 0.0017 * var_chaste_interface__membrane__V - 0.0017 * var_transient_outward_current__E_K; // nanoA
        const double var_time_independent_potassium_current__i_K1 = 0.004857142857142858 * (-var_transient_outward_current__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(-0.7486778164549093 + 0.07486778164549093 * var_chaste_interface__membrane__V - 0.07486778164549093 * var_transient_outward_current__E_K)); // nanoA
    ...
    void Cellearm_noble_model_1990FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_calcium_release__RegBindSite = pow((var_chaste_interface__intracellular_calcium_concentration__Ca_i / (0.0005 + var_chaste_interface__intracellular_calcium_concentration__Ca_i)), 2.0); // dimensionless
        ...
        const double var_L_type_calcium_current__i_Ca_L_Ca = 0.0074867781645490935 * (-50.0 + var_chaste_interface__membrane__V) * (-2.0 * exp(3.743389082274547 - 0.07486778164549093 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(3.743389082274547)) * var_chaste_interface__L_type_calcium_current_d_gate__d * var_L_type_calcium_current_f_Ca_gate__CaChon / (1.0 - exp(3.743389082274547 - 0.07486778164549093 * var_chaste_interface__membrane__V)); // nanoA
        const double var_L_type_calcium_current__i_Ca_L_K = 3.7433890822745467e-06 * (-50.0 + var_chaste_interface__membrane__V) * (-4.0 * exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372734)) * var_chaste_interface__L_type_calcium_current_d_gate__d * var_L_type_calcium_current_f_Ca_gate__CaChon / (1.0 - exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V)); // nanoA
        const double var_L_type_calcium_current__i_Ca_L_Na = 1.8716945411372735e-05 * (-50.0 + var_chaste_interface__membrane__V) * (-140.0 * exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372734)) * var_chaste_interface__L_type_calcium_current_d_gate__d * var_L_type_calcium_current_f_Ca_gate__CaChon / (1.0 - exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V)); // nanoA
        const double var_L_type_calcium_current_d_gate__E0_d = 19.0 + var_chaste_interface__membrane__V; // millivolt
        const double d_dt_chaste_interface_var_L_type_calcium_current_d_gate__d = 0.001 * (1.0 - var_chaste_interface__L_type_calcium_current_d_gate__d) * ((fabs(var_L_type_calcium_current_d_gate__E0_d) < 0.0001) ? (120.0) : (30.0 * var_L_type_calcium_current_d_gate__E0_d / (1.0 - exp(-0.25 * var_L_type_calcium_current_d_gate__E0_d)))) - 0.001 * ((fabs(var_L_type_calcium_current_d_gate__E0_d) < 0.0001) ? (120.0) : (12.0 * var_L_type_calcium_current_d_gate__E0_d / (-1.0 + exp(0.1 * var_L_type_calcium_current_d_gate__E0_d)))) * var_chaste_interface__L_type_calcium_current_d_gate__d; // 1 / millisecond
        ...
        const double var_Na_Ca_exchanger__i_NaCa = 0.0001 * (2.0 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) * exp(0.018716945411372733 * var_chaste_interface__membrane__V) - 2744000.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(-0.018716945411372733 * var_chaste_interface__membrane__V)) / ((1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) * (1.0 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Ca_i + 0.0002 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0))); // nanoA
        const double var_calcium_background_current__i_b_Ca = 5e-05 * var_chaste_interface__membrane__V - 0.0006678440164923913 * log(2.0 / var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
        const double d_dt_chaste_interface_var_calcium_release__ActFrac = 0.001 * (600.0 * exp(-3.2 + 0.08 * var_chaste_interface__membrane__V) + 500.0 * var_calcium_release__RegBindSite) * (1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac) - 0.001 * var_chaste_interface__calcium_release__ActFrac * var_calcium_release__InactRate; // 1 / millisecond
        const double var_fast_sodium_current__i_Na = 0.5 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (-26.71376065969565 * log(140.48 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i)) + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current_h_gate__h; // nanoA
        ...
        const double var_sodium_background_current__i_b_Na = 0.00012 * var_chaste_interface__membrane__V - 0.0032056512791634783 * log(140.0 / var_chaste_interface__intracellular_sodium_concentration__Na_i); // nanoA
        const double var_sodium_potassium_pump__i_NaK = 0.11200000000000002 * var_chaste_interface__intracellular_sodium_concentration__Na_i / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i); // nanoA
        const double d_dt_chaste_interface_var_intracellular_sodium_concentration__Na_i = -0.0025247825308332946 * var_Na_Ca_exchanger__i_NaCa - 0.0025247825308332946 * var_sodium_potassium_pump__i_NaK - 0.0008415941769444316 * var_L_type_calcium_current__i_Ca_L_Na - 0.0008415941769444316 * var_fast_sodium_current__i_Na - 0.0008415941769444316 * var_sodium_background_current__i_b_Na; // millimolar / millisecond
        const double var_transient_outward_current__E_K = 26.71376065969565 * log(4.0 / var_chaste_interface__intracellular_potassium_concentration__K_i); // millivolt
        const double var_potassium_background_current__i_b_K = 0.0017 * var_chaste_interface__membrane__V - 0.0017 * var_transient_outward_current__E_K; // nanoA
        const double var_time_independent_potassium_current__i_K1 = 0.004857142857142858 * (-var_transient_outward_current__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(-0.7486778164549093 + 0.07486778164549093 * var_chaste_interface__membrane__V - 0.07486778164549093 * var_transient_outward_current__E_K)); // nanoA
        ...
        const double var_transient_outward_current__i_to = 0.01 * (-var_transient_outward_current__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // nanoA
        const double d_dt_chaste_interface_var_intracellular_potassium_concentration__K_i = 0.0016831883538888633 * var_sodium_potassium_pump__i_NaK - 0.0008415941769444316 * var_L_type_calcium_current__i_Ca_L_K - 0.0008415941769444316 * var_potassium_background_current__i_b_K - 0.0008415941769444316 * var_time_independent_potassium_current__i_K1 - 0.0008415941769444316 * var_transient_outward_current__i_to; // millimolar / millisecond
