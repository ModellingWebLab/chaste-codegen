...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldemir_model_1994FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_sodium_potassium_pump__i_NaK = 0.35072000000000003 * pow((var_chaste_interface__cleft_space_equations__K_c / (0.621 + var_chaste_interface__cleft_space_equations__K_c)), 2.0) * pow((var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i / (5.46 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i)), 3.0) / (1.5 + exp(-1.5 - 0.025000000000000001 * var_chaste_interface__membrane__V)); // nanoA
        const double d_dt_chaste_interface_var_cleft_space_equations__K_c = 0.54000000000000004 + 0.021792352791964932 * var_delayed_rectifying_potassium_current__i_K + 0.021792352791964932 * var_hyperpolarisation_activated_current__i_f_K + 0.021792352791964932 * var_linear_background_current__i_B_K - 0.10000000000000001 * var_chaste_interface__cleft_space_equations__K_c - 0.043584705583929864 * var_sodium_potassium_pump__i_NaK; // millimolar / millisecond
        const double d_dt_chaste_interface_var_cleft_space_equations__Na_c = 14.0 + 0.065377058375894789 * var_sodium_calcium_pump__i_NaCa + 0.065377058375894789 * var_sodium_potassium_pump__i_NaK + 0.021792352791964932 * var_hyperpolarisation_activated_current__i_f_Na + 0.021792352791964932 * var_linear_background_current__i_B_Na + 0.021792352791964932 * var_sodium_current__i_Na - 0.10000000000000001 * var_chaste_interface__cleft_space_equations__Na_c; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Na_i = -0.019121032127143424 * var_sodium_calcium_pump__i_NaCa - 0.019121032127143424 * var_sodium_potassium_pump__i_NaK - 0.0063736773757144746 * var_hyperpolarisation_activated_current__i_f_Na - 0.0063736773757144746 * var_linear_background_current__i_B_Na - 0.0063736773757144746 * var_sodium_current__i_Na; // millimolar / millisecond
