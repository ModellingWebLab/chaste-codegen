...
#include "MathsCustomFunctions.hpp"
    ...
    double CellShannon2004FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_ICaL__i_CaL = 1.3499999999999998e-8 * (-105.0 + 0.75 * var_chaste_interface__Na_buffer__Na_jct * exp(0.037434532730821715 * var_chaste_interface__cell__V)) * var_ICaL__temp * var_ICaL_fCa_gate__fCa_jct / (-1.0 + exp(0.037434532730821715 * var_chaste_interface__cell__V)) + 2.7000000000000001e-7 * (-4.0500000000000007 + 101.25 * exp(0.037434532730821715 * var_chaste_interface__cell__V)) * (0.10000000000000001 * var_ICaL_fCa_gate__fCa_SL + 0.90000000000000002 * var_ICaL_fCa_gate__fCa_jct) * var_ICaL__temp / (-1.0 + exp(0.037434532730821715 * var_chaste_interface__cell__V)) + 1.5e-9 * (-105.0 + 0.75 * var_chaste_interface__Na_buffer__Na_SL * exp(0.037434532730821715 * var_chaste_interface__cell__V)) * var_ICaL__temp * var_ICaL_fCa_gate__fCa_SL / (-1.0 + exp(0.037434532730821715 * var_chaste_interface__cell__V)) + 0.00021600000000000002 * (-0.61380000000000001 + 0.34100000000000003 * var_chaste_interface__Ca_buffer__Ca_SL * exp(0.07486906546164343 * var_chaste_interface__cell__V)) * var_ICaL__temp * var_ICaL_fCa_gate__fCa_SL / (-1.0 + exp(0.07486906546164343 * var_chaste_interface__cell__V)) + 0.001944 * (-0.61380000000000001 + 0.34100000000000003 * var_chaste_interface__Ca_buffer__Ca_jct * exp(0.07486906546164343 * var_chaste_interface__cell__V)) * var_ICaL__temp * var_ICaL_fCa_gate__fCa_jct / (-1.0 + exp(0.07486906546164343 * var_chaste_interface__cell__V)); // microA_per_microF
        ...
        const double var_IKs__E_Ks = 26.71330258589418 * log(7.9662000000000006 / (135.0 + 0.018329999999999999 * var_chaste_interface__Na_buffer__Nai)); // millivolt
        const double var_IKs__i_Ks = 0.11 * pow(var_chaste_interface__IKs_Xs_gate__Xs, 2.0) * (0.0039900000000000005 + 0.013300000000000001 / (1.0 + exp(-7.0000000000000009 - 1.6666666666666667 * log(1.0 * var_chaste_interface__Ca_buffer__Ca_jct) / log(10)))) * (-var_IKs__E_Ks + var_chaste_interface__cell__V) + 0.89000000000000001 * pow(var_chaste_interface__IKs_Xs_gate__Xs, 2.0) * (0.0039900000000000005 + 0.013300000000000001 / (1.0 + exp(-7.0000000000000009 - 1.6666666666666667 * log(1.0 * var_chaste_interface__Ca_buffer__Ca_SL) / log(10)))) * (-var_IKs__E_Ks + var_chaste_interface__cell__V); // microA_per_microF
        const double var_INaCa__Q_NCX = 1; // dimensionless
        const double var_INaCa__i_NaCa = 0.98999999999999999 * (1.8 * pow(var_chaste_interface__Na_buffer__Na_jct, 3.0) * exp(0.013102086455787598 * var_chaste_interface__cell__V) - 2744000.0 * var_chaste_interface__Ca_buffer__Ca_jct * exp(-0.024332446275034114 * var_chaste_interface__cell__V)) * var_INaCa__Q_NCX / ((1.0 + 0.27000000000000002 * exp(-0.024332446275034114 * var_chaste_interface__cell__V)) * (1.0 + 1.6777215999999998e-11 * pow(1 / var_chaste_interface__Ca_buffer__Ca_jct, 3.0)) * (9850.9599999999991 + 2744000.0 * var_chaste_interface__Ca_buffer__Ca_jct + 8.4066800865219609 * pow(var_chaste_interface__Na_buffer__Na_jct, 3.0) + 669921.875 * (1.0 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_jct) * var_chaste_interface__Ca_buffer__Ca_jct)) + 8.0099999999999998 * (1.8 * pow(var_chaste_interface__Na_buffer__Na_SL, 3.0) * exp(0.013102086455787598 * var_chaste_interface__cell__V) - 2744000.0 * var_chaste_interface__Ca_buffer__Ca_SL * exp(-0.024332446275034114 * var_chaste_interface__cell__V)) * var_INaCa__Q_NCX / ((1.0 + 0.27000000000000002 * exp(-0.024332446275034114 * var_chaste_interface__cell__V)) * (1.0 + 1.6777215999999998e-11 * pow(1 / var_chaste_interface__Ca_buffer__Ca_SL, 3.0)) * (9850.9599999999991 + 2744000.0 * var_chaste_interface__Ca_buffer__Ca_SL + 8.4066800865219609 * pow(var_chaste_interface__Na_buffer__Na_SL, 3.0) + 669921.875 * (1.0 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_SL) * var_chaste_interface__Ca_buffer__Ca_SL)); // microA_per_microF
        ...
        const double var_INaK__i_NaK = 1.328399295652174 * var_INaK__f_NaK / (1.0 + 14641.0 * pow(1 / var_chaste_interface__Na_buffer__Na_SL, 4.0)) + 0.16418418260869566 * var_INaK__f_NaK / (1.0 + 14641.0 * pow(1 / var_chaste_interface__Na_buffer__Na_jct, 4.0)); // microA_per_microF
        const double var_ICab__i_Cab = 0.00025129999999999998 * var_chaste_interface__cell__V - 0.00036921791169093637 * log(1.8 / var_chaste_interface__Ca_buffer__Ca_jct) - 0.0029873085582266673 * log(1.8 / var_chaste_interface__Ca_buffer__Ca_SL); // microA_per_microF
        const double var_ICl_Ca__i_Cl_Ca = 0.109625 * (61.509652318919223 + var_chaste_interface__cell__V) * (0.11 / (1.0 + 0.10000000000000001 / var_chaste_interface__Ca_buffer__Ca_jct) + 0.89000000000000001 / (1.0 + 0.10000000000000001 / var_chaste_interface__Ca_buffer__Ca_SL)); // microA_per_microF
        const double var_IClb__i_Clb = 0.55358687087027292 + 0.0089999999999999993 * var_chaste_interface__cell__V; // microA_per_microF
    ...
    void CellShannon2004FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_INaCa__i_NaCa_jct = 0.98999999999999999 * (1.8 * pow(var_chaste_interface__Na_buffer__Na_jct, 3.0) * exp(0.013102086455787598 * var_chaste_interface__cell__V) - 2744000.0 * var_chaste_interface__Ca_buffer__Ca_jct * exp(-0.024332446275034114 * var_chaste_interface__cell__V)) * var_INaCa__Q_NCX / ((1.0 + 0.27000000000000002 * exp(-0.024332446275034114 * var_chaste_interface__cell__V)) * (1.0 + 1.6777215999999998e-11 * pow(1 / var_chaste_interface__Ca_buffer__Ca_jct, 3.0)) * (9850.9599999999991 + 2744000.0 * var_chaste_interface__Ca_buffer__Ca_jct + 8.4066800865219609 * pow(var_chaste_interface__Na_buffer__Na_jct, 3.0) + 669921.875 * (1.0 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_jct) * var_chaste_interface__Ca_buffer__Ca_jct)); // microA_per_microF
        const double var_INaK__f_NaK = 1.0 / (1.0 + 0.1245 * exp(-0.0037434532730821718 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.037434532730821715 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_Jpump_SR__j_pump_SR = 0.0053114 * (2814485.1633595931 * pow(var_chaste_interface__Ca_buffer__Cai, 1.7869999999999999) - 0.38742512113256738 * pow(var_chaste_interface__Ca_buffer__Ca_SR, 1.7869999999999999)) / (1.0 + 2814485.1633595931 * pow(var_chaste_interface__Ca_buffer__Cai, 1.7869999999999999) + 0.38742512113256738 * pow(var_chaste_interface__Ca_buffer__Ca_SR, 1.7869999999999999)); // millimolar_per_millisecond
        ...
        const double var_ICab__i_Cab_SL = 0.00022365699999999999 * var_chaste_interface__cell__V - 0.0029873085582266673 * log(1.8 / var_chaste_interface__Ca_buffer__Ca_SL); // microA_per_microF
        const double d_dt_chaste_interface_var_Ca_buffer__Ca_SL = 1514859660403.2268 * var_ion_diffusion__J_Ca_jct_SL + 0.0021682346385623217 * var_INaCa__i_NaCa_SL - 1.0 * var_Ca_buffer__dCa_SLB_SL - 1.0 * var_Ca_buffer__dCa_SLHigh_SL - 1514859660403.2268 * var_ion_diffusion__J_Ca_SL_myo - 0.0010841173192811609 * var_ICaL__i_CaL_Ca_SL - 0.0010841173192811609 * var_ICab__i_Cab_SL - 0.0010841173192811609 * var_ICap__i_Cap_SL; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_Ca_buffer__Ca_jct = 64.935064935064929 * var_Jrel_SR__j_rel_SR + 0.080453975456857951 * var_INaCa__i_NaCa_jct + 1205.9369202226344 * var_Jleak_SR__j_leak_SR - 1.0 * var_Ca_buffer__dCa_SLB_jct - 1.0 * var_Ca_buffer__dCa_SLHigh_jct - 0.040226987728428976 * var_ICaL__i_CaL_Ca_jct - 0.040226987728428976 * var_ICab__i_Cab_jct - 0.040226987728428976 * var_ICap__i_Cap_jct - 56210005951882.25 * var_ion_diffusion__J_Ca_jct_SL; // millimolar / millisecond
        const double var_reversal_potentials__E_Na_SL = 26.71330258589418 * log(140.0 / var_chaste_interface__Na_buffer__Na_SL); // millivolt
        ...
        const double d_dt_chaste_interface_var_Na_buffer__Na_SL = -var_Na_buffer__dNa_SL_buf + 1514859660403.2268 * var_ion_diffusion__J_Na_jct_SL - 1514859660403.2268 * var_ion_diffusion__J_Na_SL_myo - 0.0065047039156869652 * var_INaCa__i_NaCa_SL - 0.0065047039156869652 * var_INaK__i_NaK_SL - 0.0021682346385623217 * var_ICaL__i_CaL_Na_SL - 0.0021682346385623217 * var_INa__i_Na_SL - 0.0021682346385623217 * var_INab__i_Nab_SL; // millimolar / millisecond
        const double var_reversal_potentials__E_Na_jct = 26.71330258589418 * log(140.0 / var_chaste_interface__Na_buffer__Na_jct); // millivolt
        ...
        const double d_dt_chaste_interface_var_Na_buffer__Na_jct = -var_Na_buffer__dNa_jct_buf - 0.080453975456857951 * var_ICaL__i_CaL_Na_jct - 0.080453975456857951 * var_INa__i_Na_jct - 0.080453975456857951 * var_INab__i_Nab_jct - 56210005951882.25 * var_ion_diffusion__J_Na_jct_SL - 0.24136192637057383 * var_INaCa__i_NaCa_jct - 0.24136192637057383 * var_INaK__i_NaK_jct; // millimolar / millisecond
        ...
        {
            const double var_IKs__E_Ks = 26.71330258589418 * log(7.9662000000000006 / (135.0 + 0.018329999999999999 * var_chaste_interface__Na_buffer__Nai)); // millivolt
            d_dt_chaste_interface_var_cell__V = -0.55358687087027292 - var_ICaL__i_CaL_Ca_SL - var_ICaL__i_CaL_Ca_jct - var_ICaL__i_CaL_Na_SL - var_ICaL__i_CaL_Na_jct - var_ICab__i_Cab_SL - var_ICab__i_Cab_jct - var_ICap__i_Cap_SL - var_ICap__i_Cap_jct - var_INa__i_Na_SL - var_INa__i_Na_jct - var_INaCa__i_NaCa_SL - var_INaCa__i_NaCa_jct - var_INaK__i_NaK_SL - var_INaK__i_NaK_jct - var_INab__i_Nab_SL - var_INab__i_Nab_jct - 0.0089999999999999993 * var_chaste_interface__cell__V - GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() - 0.001 * (85.986803896123959 + var_chaste_interface__cell__V) / (1.0 + exp(7.4880000000000004 - 0.16722408026755853 * var_chaste_interface__cell__V)) - 0.109625 * (61.509652318919223 + var_chaste_interface__cell__V) * (0.11 / (1.0 + 0.10000000000000001 / var_chaste_interface__Ca_buffer__Ca_jct) + 0.89000000000000001 / (1.0 + 0.10000000000000001 / var_chaste_interface__Ca_buffer__Ca_SL)) - 0.059999999999999998 * (85.986803896123959 + var_chaste_interface__cell__V) * (0.5 * var_chaste_interface__Itos_R_gate__R_tos + var_chaste_interface__Itos_Y_gate__Y_tos) * var_chaste_interface__Itos_X_gate__X_tos - 0.02 * (85.986803896123959 + var_chaste_interface__cell__V) * var_chaste_interface__Itof_X_gate__X_tof * var_chaste_interface__Itof_Y_gate__Y_tof - 0.11 * pow(var_chaste_interface__IKs_Xs_gate__Xs, 2.0) * (0.0039900000000000005 + 0.013300000000000001 / (1.0 + exp(-7.0000000000000009 - 1.6666666666666667 * log(1.0 * var_chaste_interface__Ca_buffer__Ca_jct) / log(10)))) * (-var_IKs__E_Ks + var_chaste_interface__cell__V) - 0.89000000000000001 * pow(var_chaste_interface__IKs_Xs_gate__Xs, 2.0) * (0.0039900000000000005 + 0.013300000000000001 / (1.0 + exp(-7.0000000000000009 - 1.6666666666666667 * log(1.0 * var_chaste_interface__Ca_buffer__Ca_SL) / log(10)))) * (-var_IKs__E_Ks + var_chaste_interface__cell__V) - 0.029999999999999999 * (85.986803896123959 + var_chaste_interface__cell__V) * var_chaste_interface__IKr_Xr_gate__Xr / (1.0 + exp(1.4732142857142858 + 0.044642857142857144 * var_chaste_interface__cell__V)) - 0.91800000000000004 * (85.986803896123959 + var_chaste_interface__cell__V) / ((1.0 + exp(6.3850752292255635 + 0.23849999999999999 * var_chaste_interface__cell__V)) * (1.02 / (1.0 + exp(6.3850752292255635 + 0.23849999999999999 * var_chaste_interface__cell__V)) + (1.0 * exp(-31.388957359414341 + 0.061749999999999999 * var_chaste_interface__cell__V) + 0.49124000000000001 * exp(7.3462924089366766 + 0.080320000000000003 * var_chaste_interface__cell__V)) / (1.0 + exp(-46.667481143776548 - 0.51429999999999998 * var_chaste_interface__cell__V)))) - 2.7000000000000001e-7 * (-4.0500000000000007 + 101.25 * exp(0.037434532730821715 * var_chaste_interface__cell__V)) * (0.10000000000000001 * var_ICaL_fCa_gate__fCa_SL + 0.90000000000000002 * var_ICaL_fCa_gate__fCa_jct) * var_ICaL__temp / (-1.0 + exp(0.037434532730821715 * var_chaste_interface__cell__V)); // millivolt / millisecond
        }
