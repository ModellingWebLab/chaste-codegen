...
#include "MathsCustomFunctions.hpp"
    ...
    double CellShannon2004FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_INaK__i_NaK = 1.328399295652174 * var_INaK__f_NaK / (1.0 + 14641.0 * pow(1 / var_chaste_interface__Na_buffer__Na_SL, 4.0)) + 0.16418418260869569 * var_INaK__f_NaK / (1.0 + 14641.0 * pow(1 / var_chaste_interface__Na_buffer__Na_jct, 4.0)); // microA_per_microF
    ...
    void CellShannon2004FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_INaK__i_NaK_jct = 0.16418418260869569 * var_INaK__f_NaK / (1.0 + 14641.0 * pow(1 / var_chaste_interface__Na_buffer__Na_jct, 4.0)); // microA_per_microF
        ...
        const double d_dt_chaste_interface_var_Na_buffer__Na_SL = -var_Na_buffer__dNa_SL_buf + 1514859660403.2268 * var_ion_diffusion__J_Na_jct_SL - 0.0065047039156869652 * var_INaCa__i_NaCa_SL - 0.0065047039156869652 * var_INaK__i_NaK_SL - 0.0021682346385623217 * var_ICaL__i_CaL_Na_SL - 0.0021682346385623217 * var_INa__i_Na_SL - 0.0021682346385623217 * var_INab__i_Nab_SL - 1514859660403.2268 * var_ion_diffusion__J_Na_SL_myo; // millimolar / millisecond
        const double var_reversal_potentials__E_Na_jct = 26.71330258589418 * log(140.0 / var_chaste_interface__Na_buffer__Na_jct); // millivolt
        ...
        const double d_dt_chaste_interface_var_Na_buffer__Na_jct = -var_Na_buffer__dNa_jct_buf - 0.080453975456857951 * var_ICaL__i_CaL_Na_jct - 0.080453975456857951 * var_INa__i_Na_jct - 0.080453975456857951 * var_INab__i_Nab_jct - 0.24136192637057385 * var_INaCa__i_NaCa_jct - 0.24136192637057385 * var_INaK__i_NaK_jct - 56210005951882.25 * var_ion_diffusion__J_Na_jct_SL; // millimolar / millisecond
