...
#include "MathsCustomFunctions.hpp"
    ...
    void CellShannon2004FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_Ca_buffer__Ca_jct = 64.935064935064929 * var_Jrel_SR__j_rel_SR + 1205.9369202226344 * var_Jleak_SR__j_leak_SR + 0.080453975456857937 * var_INaCa__i_NaCa_jct - 1.0 * var_Ca_buffer__dCa_SLB_jct - 1.0 * var_Ca_buffer__dCa_SLHigh_jct - 56210005951882.25 * var_ion_diffusion__J_Ca_jct_SL - 0.040226987728428969 * var_ICaL__i_CaL_Ca_jct - 0.040226987728428969 * var_ICab__i_Cab_jct - 0.040226987728428969 * var_ICap__i_Cap_jct; // millimolar / millisecond
        const double var_reversal_potentials__E_Na_SL = 26.713302585894176 * log(140.0 / var_chaste_interface__Na_buffer__Na_SL); // millivolt
        ...
        const double d_dt_chaste_interface_var_Na_buffer__Na_jct = -var_Na_buffer__dNa_jct_buf - 56210005951882.25 * var_ion_diffusion__J_Na_jct_SL - 0.24136192637057383 * var_INaCa__i_NaCa_jct - 0.24136192637057383 * var_INaK__i_NaK_jct - 0.080453975456857937 * var_ICaL__i_CaL_Na_jct - 0.080453975456857937 * var_INa__i_Na_jct - 0.080453975456857937 * var_INab__i_Nab_jct; // millimolar / millisecond
