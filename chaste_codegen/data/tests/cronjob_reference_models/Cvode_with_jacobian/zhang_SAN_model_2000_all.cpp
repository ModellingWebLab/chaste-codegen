...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellzhang_SAN_model_2000_allFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x5 = 13.441615999999998 - 0.28968999999999995 * var_chaste_interface__membrane__V;
        const double var_x6 = 9.6256349999999991 - 0.21390299999999998 * var_chaste_interface__membrane__V;
        const double var_x7 = -21.246480684717334 - 0.24524999999999994 * var_chaste_interface__membrane__V;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0048327079999999989 - 0.0017381399999999998 / var_x2 - 0.0023092690674785805 * exp(var_x3) - 0.0033227519999999996 * var_chaste_interface__four_AP_sensitive_currents_r_gate__r - 0.05464999999999999 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.017225000000000001 * pow(var_chaste_interface__slow_delayed_rectifying_potassium_current_xs_gate__xs, 2.0) - 0.00061881194542590091 * exp(-var_x3) + (-0.015940800000000001 * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_as_gate__P_as - 0.023911199999999997 * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_af_gate__P_af) * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_i_gate__P_i - 0.28968999999999995 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L * var_chaste_interface__L_type_Ca_channel_f_gate__f_L - 0.0068989604918571288 * var_x4 / pow((1 + 0.66666666666666663 * var_x4), 2) - 0.21390299999999998 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T * var_chaste_interface__T_type_Ca_channel_f_gate__f_T - 0.24524999999999994 * var_chaste_interface__four_AP_sensitive_currents_q_gate__q * var_chaste_interface__four_AP_sensitive_currents_r_gate__r + 0.001 * var_x1 * var_x5 / pow(var_x2, 2));
        ...
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.28785641666913719 - 0.0033227519999999996 * var_chaste_interface__membrane__V + var_x7 * var_chaste_interface__four_AP_sensitive_currents_q_gate__q);
        IJth(rJacobian, 9, 9) = -0.001 * var_x77;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : ((-2.071473390207597 - 0.023911199999999997 * var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_i_gate__P_i);
        IJth(rJacobian, 10, 10) = -0.037200000000000004 * var_x81 - 0.00096000000000000002 * var_x82;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : ((-1.3809822601383981 - 0.015940800000000001 * var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_i_gate__P_i);
        IJth(rJacobian, 11, 11) = -0.0042000000000000006 * var_x84 - 0.00014999999999999999 * var_x85;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : ((-3.4524556503459949 - 0.039851999999999999 * var_chaste_interface__membrane__V) * (0.40000000000000002 * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_as_gate__P_as + 0.59999999999999998 * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_af_gate__P_af));
