...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellzhang_SAN_model_2000_allFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_hyperpolarisation_activated_current_y_gate__alpha_y = ((var_membrane__Version == 0) ? (1.0 * exp(-2.9643125469571747 - 0.037565740045078885 * var_chaste_interface__membrane__V)) : (1.0 * exp(-2.9631993991738641 - 0.037551633496057078 * var_chaste_interface__membrane__V))); // per_second
    ...
    void Cellzhang_SAN_model_2000_allFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 1, 0) = 6.105006105006105e-5 * var_x10 * var_x14 * var_x8 * var_x9 - 2.3112969460591231 * (-var_chaste_interface__sodium_current_m_gate__m + 1.0 * var_x10) * (0.27934182395599999 * var_x12 - 0.051635019999999997 * var_x11) / (pow((0.073139106771250198 + var_x13), 2) * pow((var_x12 + 0.75389027327741354 * var_x11), 2));
