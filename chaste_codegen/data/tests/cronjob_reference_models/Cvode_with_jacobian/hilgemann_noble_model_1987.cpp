...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhilgemann_noble_model_1987FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x7 = 8.3333333333333321 * var_x6;
        const double var_x8 = var_x3 * (-26.713760659695652 * var_x2 + var_chaste_interface__membrane__V) / pow(var_x4, 2);
        const double var_x9 = 0.018716945411372733 * var_chaste_interface__membrane__V;
        ...
        const double var_x17 = 1 / (1.0 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Ca_i + 0.0001 * var_x14);
        const double var_x18 = var_x16 * var_x17;
        const double var_x19 = var_x18 * (0.018716945411372733 * var_x15 + 51359.29820880678 * var_x11);
        const double var_x20 = 1.0 - var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca;
        const double var_x21 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x22 = 1 / var_x21;
        const double var_x23 = var_x22 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x24 = 1.0 - var_x23;
        const double var_x25 = var_x20 * var_x24;
        const double var_x26 = var_x25 * var_chaste_interface__second_inward_calcium_current_d_gate__d;
        const double var_x27 = exp(3.7433890822745468 - var_x0);
        const double var_x28 = 1.0 - var_x27;
        const double var_x29 = 1 / var_x28;
        const double var_x30 = exp(3.7433890822745468);
        const double var_x31 = var_x27 * var_chaste_interface__extracellular_calcium_concentration__Ca_o;
        ...
        const double var_x34 = 0.12477963607581821 * var_x33;
        ...
        const double var_x47 = var_x26 * var_x44;
        const double var_x48 = var_x35 * var_x47 / pow(var_x36, 2);
        const double var_x49 = var_x40 * var_x48;
        const double var_x50 = var_x27 * var_x32 * var_x47 / pow(var_x28, 2);
        const double var_x51 = var_x42 * var_x48;
        const double var_x52 = var_x29 * var_x47;
        ...
        const double var_x58 = var_x16 * var_x56 / pow((0.0036443148688046641 + 3.6443148688046643e-7 * var_x14 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x59 = 0.12477963607581821 * var_x52;
        const double var_x60 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x21, 2);
        const double var_x61 = var_x20 * (var_x60 - var_x22);
        const double var_x62 = var_x44 * var_chaste_interface__second_inward_calcium_current_d_gate__d;
        ...
        const double var_x68 = var_x25 * var_x44;
        const double var_x69 = var_x37 * var_x68;
        const double var_x70 = var_x24 * var_x62;
        const double var_x71 = var_x37 * var_x70;
        const double var_x72 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        ...
        const double var_x75 = var_x6 * var_x65 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x80 = var_x39 * var_x45;
        ...
        const double var_x86 = 4.9225225838744033e-6 * var_x33;
        ...
        const double var_x94 = 4.9225225838744033e-6 * var_x52;
        ...
        const double var_x101 = 0.44800000000000001 * var_x100 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x102 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x103 = fabs(var_x102) < 1.0000000000000001e-5;
        const double var_x104 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x110 = -8.0 * var_x100;
        const double var_x111 = exp(-9.375 - 0.125 * var_chaste_interface__membrane__V);
        const double var_x112 = 20.0 * var_x111;
        const double var_x113 = exp(-7.5 + var_x106);
        const double var_x114 = 1 / (1.0 + 320.0 * var_x113);
        const double var_x115 = var_x112 + 2000.0 * var_x114;
        const double var_x116 = 1 / var_x115;
        const double var_x117 = 2.5 * var_x111;
        const double var_x118 = 0.625 * var_x113 / pow((0.0031250000000000002 + var_x113), 2);
        const double var_x119 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x120 = fabs(var_x119) < 0.0001;
        const double var_x121 = 1.0 - var_chaste_interface__second_inward_calcium_current_d_gate__d;
        ...
        const double var_x127 = exp(1.8999999999999999 + var_x105);
        ...
        const double var_x132 = 120.0 * var_x20;
        const double var_x133 = 0.0030000000000000001 * var_x130 * (var_x25 + var_x132 * var_x23) / pow(var_x131, 2);
        ...
        const double var_x140 = var_x139 * (-1.0 - 119.0 * var_x23);
        ...
        const double var_x145 = pow((var_x144 * var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2.0);
        const double var_x146 = 1.0 * var_x145;
        const double var_x147 = var_x143 * var_x146 * var_x54 * (var_x144 - var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x143, 2));
        const double var_x148 = var_x147 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x149 = -0.59999999999999998 * var_x142;
        const double var_x150 = 0.5 * var_x145;
        const double var_x151 = 0.00065749545073783716 * var_x6;
        const double var_x152 = 2.4612612919372018e-8 * var_x40;
        const double var_x153 = 6.0300901652461434e-6 * var_x33;
        const double var_x154 = 6.0300901652461434e-6 * var_x52;
        const double var_x155 = 4.922522583874404e-9 * var_x42;
        const double var_x156 = -var_x99;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.031166666666666669 + 1.1677468184410227e-5 * var_x49 + 0.0093419745475281802 * var_x50 + 2.3354936368820456e-6 * var_x51 + 0.0060607251808254556 * var_x8 - 0.080952380952380942 * var_x5 - 0.0016666666666666666 * var_x19 - 0.0093419745475281802 * var_x53 - 0.00164418752036496 * var_x46 - var_x26 * var_x34 - var_x38 * var_x41 - var_x38 * var_x43 - var_x7 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 1, 0) = -3.2874772536891862e-8 + 1.3149909014756745e-7 * var_x19 + 3.6853834595450663e-7 * var_x50 - 3.6853834595450663e-7 * var_x53 - var_x26 * var_x86;
        IJth(rJacobian, 2, 0) = ((var_x103) ? (var_x101) : (var_x101 + var_x104 * var_x109 - 0.020000000000000004 * var_x102 * var_x104 * var_x107 / pow(var_x108, 2)));
        IJth(rJacobian, 3, 0) = 0.001 * var_x115 * (-var_x116 * var_x117 + 5.0000000000000004e-6 * var_x111 * (var_x117 - var_x118) / pow((var_x114 + 0.01 * var_x111), 2)) + 0.001 * (var_x118 - var_x117) * (-var_chaste_interface__fast_sodium_current_h_gate__h + var_x112 * var_x116);
        IJth(rJacobian, 4, 0) = ((var_x120) ? (0) : (var_x121 * var_x126 - var_x129 * var_chaste_interface__second_inward_calcium_current_d_gate__d + 0.0012000000000000001 * var_x119 * var_x127 * var_chaste_interface__second_inward_calcium_current_d_gate__d / pow(var_x128, 2) - 0.0074999999999999997 * var_x119 * var_x121 * var_x124 / pow(var_x125, 2)));
        IJth(rJacobian, 5, 0) = ((var_x135) ? (var_x133) : (var_x133 - var_x138 * var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca + 0.0015625000000000001 * var_x134 * var_x136 * var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca / pow(var_x137, 2)));
        IJth(rJacobian, 6, 0) = 0.048000000000000001 * var_x141 * var_x142;
        IJth(rJacobian, 8, 0) = -1.5779890817708093e-7 + 9.2134586488626671e-10 * var_x49 - 3.9449727044270234e-7 * var_x19 - 1.2898842108407735e-7 * var_x46 - var_x151 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x152 * var_x38;
        IJth(rJacobian, 9, 0) = -4.0271596357692526e-8 + 4.5145947379427062e-7 * var_x50 - 8.0543192715385052e-8 * var_x19 - 4.5145947379427062e-7 * var_x53 - var_x153 * var_x26;
        IJth(rJacobian, 10, 0) = -2.2354845325086465e-6 + 4.781879081477991e-7 * var_x8 + 1.8426917297725334e-10 * var_x51 - 6.3870986643104177e-6 * var_x5 - 7.3707669190901337e-10 * var_x46 - var_x155 * var_x38;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (4573.333333333333 * var_x55 + 1.1499999999999998e-5 * var_x57 + 6.0738581146744397e-6 * var_x58 - 0.011130733608206522 * var_x54 - var_x30 * var_x59 - var_x34 * var_x63 - var_x41 * var_x64 - var_x43 * var_x64);
        IJth(rJacobian, 1, 1) = -17.0 + var_x87 + var_x88 + 0.0030000000000000001 * var_x92 - 4.3910440264623239e-7 * var_x54 - 0.0030000000000000001 * var_x90 - 5.5199999999999998e-8 * var_x93 - 9.0734372201821535e-10 * var_x57 - 0.36083350336492509 * var_x55 - 4.7922408945906498e-10 * var_x58 - var_x30 * var_x94 - var_x63 * var_x86;
        IJth(rJacobian, 5, 1) = var_x139 * (var_x61 + var_x132 * var_x22 - var_x132 * var_x60);
        IJth(rJacobian, 6, 1) = -var_x148 + var_x141 * var_x147;
        IJth(rJacobian, 7, 1) = var_x148;
        IJth(rJacobian, 8, 1) = 1.4376722683771949e-9 * var_x58 + 2.7220311660546463e-9 * var_x57 + 1.0825005100947753 * var_x55 - var_x152 * var_x64;
        IJth(rJacobian, 9, 1) = 2.9352475479367729e-10 * var_x58 + 5.5574802973615687e-10 * var_x57 + 0.22101052081101658 * var_x55 - 5.3790289324163466e-7 * var_x54 - var_x153 * var_x63 - var_x154 * var_x30;
        IJth(rJacobian, 10, 1) = -var_x155 * var_x64;
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-24.999999999999996 * var_x67);
        IJth(rJacobian, 2, 2) = ((var_x103) ? (-2.0 + var_x110) : (var_x110 - var_x102 * var_x109));
        IJth(rJacobian, 8, 2) = -0.0019724863522135117 * var_x67;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x66 * var_x7);
        IJth(rJacobian, 3, 3) = -0.02 * var_x111 - 2.0 * var_x114;
        IJth(rJacobian, 8, 3) = -var_x151 * var_x66;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x34 * var_x68 - var_x41 * var_x69 - var_x43 * var_x69);
        IJth(rJacobian, 1, 4) = -var_x68 * var_x86;
        IJth(rJacobian, 4, 4) = ((var_x120) ? (-0.23999999999999999) : (-var_x119 * var_x126 - var_x119 * var_x129));
        IJth(rJacobian, 8, 4) = -var_x152 * var_x69;
        IJth(rJacobian, 9, 4) = -var_x153 * var_x68;
        IJth(rJacobian, 10, 4) = -var_x155 * var_x69;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x34 * var_x70 + var_x41 * var_x71 + var_x43 * var_x71);
        IJth(rJacobian, 1, 5) = var_x70 * var_x86;
        IJth(rJacobian, 5, 5) = ((var_x135) ? (-0.025000000000000001 + var_x140) : (var_x140 - var_x134 * var_x138));
        IJth(rJacobian, 8, 5) = var_x152 * var_x71;
        IJth(rJacobian, 9, 5) = var_x153 * var_x70;
        IJth(rJacobian, 10, 5) = var_x155 * var_x71;
        IJth(rJacobian, 1, 6) = 0.10204081632653063 * var_x98;
        IJth(rJacobian, 6, 6) = -0.059999999999999998 + var_x149 - var_x146;
        IJth(rJacobian, 7, 6) = 0.059999999999999998 + var_x150;
        IJth(rJacobian, 12, 6) = -0.5 * var_x98;
        IJth(rJacobian, 6, 7) = var_x149 - var_x150;
        IJth(rJacobian, 7, 7) = -0.00059999999999999995;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (0.0011666666666666668 * var_x74 + 6.6405154314953787e-12 * var_x77 - 0.00031194909018954556 * var_x80 - 1.8666666666666667 * var_x72 - 0.053427521319391304 * var_x73 - 0.0049999999999999992 * var_x79 - 222.61467216413041 * var_x75);
        IJth(rJacobian, 1, 8) = 3.9449727044270234e-7 * var_x79 - 5.2393304241151412e-16 * var_x77;
        IJth(rJacobian, 8, 8) = 1.5717991272345424e-15 * var_x77 + 2.7614808930989166e-7 * var_x74 - 0.00044183694289582666 * var_x72 - 4.215402265403831e-6 * var_x73 - 2.4612612919372018e-8 * var_x80 - 1.1834918113281069e-6 * var_x79 - 0.017564176105849295 * var_x75;
        IJth(rJacobian, 9, 8) = 3.2090898847705236e-16 * var_x77 - 2.4162957814615514e-7 * var_x79;
        IJth(rJacobian, 10, 8) = 0.00029455796193055109 * var_x72 - 1.8409872620659443e-7 * var_x74;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (0.011130733608206522 * var_x81 + 2.2135051438317929e-12 * var_x82 - 0.0016666666666666666 * var_x83 + var_x27 * var_x59);
        IJth(rJacobian, 1, 9) = 1.3149909014756745e-7 * var_x83 + 4.3910440264623239e-7 * var_x81 - 1.7464434747050471e-16 * var_x82 + var_x27 * var_x94;
        IJth(rJacobian, 8, 9) = 5.2393304241151412e-16 * var_x82 - 3.9449727044270234e-7 * var_x83;
        IJth(rJacobian, 9, 9) = -4.9999999999999998e-7 + 5.3790289324163466e-7 * var_x81 + 1.0696966282568412e-16 * var_x82 - 8.0543192715385052e-8 * var_x83 + var_x154 * var_x27;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (0.16190476190476186 * var_x85 - 0.75688988535804347 * var_x1 - 6.2389818037909115e-5 * var_x80 - 2.1625425295944094 * var_x84 - 26.713760659695648 * var_x75);
        IJth(rJacobian, 8, 10) = -0.0021077011327019154 * var_x75;
        IJth(rJacobian, 10, 10) = 1.2774197328620834e-5 * var_x85 - 4.922522583874404e-9 * var_x80 - 5.9718198759887604e-5 * var_x1 - 0.00017062342502825029 * var_x84;
        IJth(rJacobian, 1, 11) = 5.5199999999999998e-8 * var_x90 + 7.1999999999999999e-7 * var_x92 - 1.3247999999999998e-11 * var_x93;
        IJth(rJacobian, 11, 11) = -0.050000000000000003 + 6.4915199999999989e-10 * var_x93 - 2.7047999999999999e-6 * var_x90 - 3.5279999999999994e-5 * var_x92;
        IJth(rJacobian, 12, 11) = 0.0050000000000000001;
        IJth(rJacobian, 1, 12) = 0.051020408163265314 * var_x97;
        IJth(rJacobian, 11, 12) = 0.050000000000000003;
        IJth(rJacobian, 12, 12) = -0.0050000000000000001 - 0.25 * var_x97;
        IJth(rJacobian, 1, 13) = 0.050000000000000003 + var_x99;
        IJth(rJacobian, 13, 13) = -0.050000000000000003 + var_x156;
        IJth(rJacobian, 1, 14) = 0.20000000000000001 + var_x99;
