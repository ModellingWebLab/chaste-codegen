...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhilgemann_noble_model_1987FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x121 = exp(1.8999999999999999 + var_x105);
        ...
        const double var_x126 = 120.0 * var_x20;
        const double var_x127 = 0.0030000000000000001 * var_x124 * (var_x25 + var_x126 * var_x23) / pow(var_x125, 2);
        ...
        const double var_x134 = var_x133 * (-1.0 - 119.0 * var_x23);
        ...
        const double var_x141 = var_x137 * var_x140 * var_x54 * (var_x138 - var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x137, 2));
        ...
        const double var_x144 = 0.5 * var_x139;
        const double var_x145 = 0.00065749545073783716 * var_x6;
        const double var_x146 = 2.4612612919372018e-8 * var_x40;
        const double var_x147 = 6.0300901652461434e-6 * var_x33;
        const double var_x148 = 6.0300901652461434e-6 * var_x52;
        const double var_x149 = 4.922522583874404e-9 * var_x42;
        const double var_x150 = -var_x99;
        ...
        IJth(rJacobian, 3, 0) = -0.0025000000000000001 * var_x111 * (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x112 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x112), 2);
        ...
        IJth(rJacobian, 8, 0) = -1.5779890817708093e-7 + 9.2134586488626671e-10 * var_x49 - 3.9449727044270234e-7 * var_x19 - 1.2898842108407735e-7 * var_x46 - var_x145 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x146 * var_x38;
        IJth(rJacobian, 9, 0) = -4.0271596357692526e-8 + 4.5145947379427062e-7 * var_x50 - 8.0543192715385052e-8 * var_x19 - 4.5145947379427062e-7 * var_x53 - var_x147 * var_x26;
        IJth(rJacobian, 10, 0) = -2.2354845325086465e-6 + 4.781879081477991e-7 * var_x8 + 1.8426917297725334e-10 * var_x51 - 6.3870986643104177e-6 * var_x5 - 7.3707669190901337e-10 * var_x46 - var_x149 * var_x38;
        ...
        IJth(rJacobian, 5, 1) = var_x133 * (var_x61 + var_x126 * var_x22 - var_x126 * var_x60);
        IJth(rJacobian, 6, 1) = -var_x142 + var_x135 * var_x141;
        IJth(rJacobian, 7, 1) = var_x142;
        IJth(rJacobian, 8, 1) = 1.4376722683771949e-9 * var_x58 + 2.7220311660546463e-9 * var_x57 + 1.0825005100947753 * var_x55 - var_x146 * var_x64;
        IJth(rJacobian, 9, 1) = 2.9352475479367729e-10 * var_x58 + 5.5574802973615687e-10 * var_x57 + 0.22101052081101658 * var_x55 - 5.3790289324163466e-7 * var_x54 - var_x147 * var_x63 - var_x148 * var_x30;
        IJth(rJacobian, 10, 1) = -var_x149 * var_x64;
        ...
        IJth(rJacobian, 3, 3) = -2.0 / (1.0 + 320.0 * var_x112) - 0.02 * var_x111;
        IJth(rJacobian, 8, 3) = -var_x145 * var_x66;
        ...
        IJth(rJacobian, 8, 4) = -var_x146 * var_x69;
        IJth(rJacobian, 9, 4) = -var_x147 * var_x68;
        IJth(rJacobian, 10, 4) = -var_x149 * var_x69;
        ...
        IJth(rJacobian, 8, 5) = var_x146 * var_x71;
        IJth(rJacobian, 9, 5) = var_x147 * var_x70;
        IJth(rJacobian, 10, 5) = var_x149 * var_x71;
        IJth(rJacobian, 1, 6) = 0.10204081632653063 * var_x98;
        IJth(rJacobian, 6, 6) = -0.059999999999999998 + var_x143 - var_x140;
        IJth(rJacobian, 7, 6) = 0.059999999999999998 + var_x144;
        IJth(rJacobian, 12, 6) = -0.5 * var_x98;
        IJth(rJacobian, 6, 7) = var_x143 - var_x144;
        ...
        IJth(rJacobian, 9, 9) = -4.9999999999999998e-7 + 5.3790289324163466e-7 * var_x81 + 1.0696966282568412e-16 * var_x82 - 8.0543192715385052e-8 * var_x83 + var_x148 * var_x27;
