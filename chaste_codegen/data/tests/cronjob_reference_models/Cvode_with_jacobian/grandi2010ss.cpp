...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellgrandi2010ssFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__cell__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x2 = 1 / var_chaste_interface__cell__sCaj;
        const double var_x3 = 1.0 + 0.10000000000000001 * var_x2;
        const double var_x4 = 1 / var_chaste_interface__cell__sCasl;
        const double var_x5 = 1.0 + 0.10000000000000001 * var_x4;
        const double var_x6 = pow(var_chaste_interface__cell__sxks, 2.0);
        ...
        const double var_x10 = exp(5.633952164811145 + 0.23849999999999999 * var_chaste_interface__cell__sVm);
        ...
        const double var_x16 = exp(7.0933355765099844 + 0.080320000000000003 * var_chaste_interface__cell__sVm);
        ...
        const double var_x21 = 0.1144 * var_chaste_interface__cell__sytof;
        const double var_x22 = 0.015599999999999999 * var_chaste_interface__cell__sytos;
        const double var_x23 = 1 / var_chaste_interface__cell__sNaj;
        const double var_x24 = pow(var_x23, 4.0);
        const double var_x25 = exp(-0.0037435883507802624 * var_chaste_interface__cell__sVm);
        const double var_x26 = 0.037435883507802623 * var_chaste_interface__cell__sVm;
        const double var_x27 = (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x26);
        const double var_x28 = 1.0 + 0.1245 * var_x25 + 0.036499999999999998 * var_x27;
        const double var_x29 = (0.0013664097480347956 * var_x27 + 0.00046607674967214267 * var_x25) / pow(var_x28, 2);
        const double var_x30 = var_x29 / (1.0 + 14641.0 * var_x24);
        const double var_x31 = 1 / var_chaste_interface__cell__sNasl;
        const double var_x32 = pow(var_x31, 4.0);
        const double var_x33 = var_x29 / (1.0 + 14641.0 * var_x32);
        const double var_x34 = pow(var_chaste_interface__cell__sm, 3.0);
        const double var_x35 = var_x34 * var_chaste_interface__cell__sj;
        const double var_x36 = var_x35 * var_chaste_interface__cell__sh;
        const double var_x37 = 82.837440942604388 + var_chaste_interface__cell__sVm;
        const double var_x38 = var_x10 / pow(var_x11, 2);
        const double var_x39 = exp(-0.027328194960695915 * var_chaste_interface__cell__sVm);
        const double var_x40 = 74988.566972149594 * var_x39;
        const double var_x41 = pow(var_chaste_interface__cell__sNaj, 3.0);
        const double var_x42 = exp(0.010107688547106709 * var_chaste_interface__cell__sVm);
        const double var_x43 = 0.018193839384792077 * var_x42;
        const double var_x44 = 1.0 + 0.32000000000000001 * var_x39;
        const double var_x45 = 1 / var_x44;
        const double var_x46 = pow(var_x2, 2.0);
        const double var_x47 = 1.0 + 2.2499999999999996e-8 * var_x46;
        const double var_x48 = 1 / var_x47;
        const double var_x49 = 2744000.0 * var_chaste_interface__cell__sCaj;
        const double var_x50 = (1.0 + 278.55153203342621 * var_chaste_interface__cell__sCaj) * var_chaste_interface__cell__sCaj;
        const double var_x51 = 1 / (9850.9599999999991 + var_x49 + 669921.875 * var_x50 + 8.4066800865219609 * var_x41);
        const double var_x52 = var_x48 * var_x51;
        const double var_x53 = var_x45 * var_x52;
        const double var_x54 = var_x53 * (var_x40 * var_chaste_interface__cell__sCaj + var_x41 * var_x43);
        const double var_x55 = pow(var_chaste_interface__cell__sNasl, 3.0);
        const double var_x56 = pow(var_x4, 2.0);
        const double var_x57 = 1.0 + 2.2499999999999996e-8 * var_x56;
        const double var_x58 = 1 / var_x57;
        const double var_x59 = 2744000.0 * var_chaste_interface__cell__sCasl;
        const double var_x60 = (1.0 + 278.55153203342621 * var_chaste_interface__cell__sCasl) * var_chaste_interface__cell__sCasl;
        const double var_x61 = 1 / (9850.9599999999991 + var_x59 + 669921.875 * var_x60 + 8.4066800865219609 * var_x55);
        const double var_x62 = var_x58 * var_x61;
        const double var_x63 = var_x45 * var_x62;
        const double var_x64 = var_x63 * (var_x40 * var_chaste_interface__cell__sCasl + var_x43 * var_x55);
        const double var_x65 = exp(var_x26);
        const double var_x66 = -1.0 + var_x65;
        const double var_x67 = 1 / var_x66;
        const double var_x68 = 1.0 - var_chaste_interface__cell__sfcaBsl;
        const double var_x69 = var_chaste_interface__cell__sd * var_chaste_interface__cell__sf;
        const double var_x70 = var_x68 * var_x69;
        const double var_x71 = var_x67 * var_x70;
        const double var_x72 = 0.75 * var_x65;
        const double var_x73 = -105.0 + var_x72 * var_chaste_interface__cell__sNasl;
        const double var_x74 = 1.2190504118344881e-6 * var_x73;
        const double var_x75 = var_x71 * var_x74;
        const double var_x76 = exp(0.074871767015605245 * var_chaste_interface__cell__sVm);
        const double var_x77 = -1.0 + var_x76;
        const double var_x78 = 1 / var_x77;
        const double var_x79 = var_x70 * var_x78;
        const double var_x80 = 0.34100000000000003 * var_x76;
        const double var_x81 = -0.61380000000000001 + var_x80 * var_chaste_interface__cell__sCasl;
        const double var_x82 = 0.17554325930416631 * var_x81;
        const double var_x83 = var_x79 * var_x82;
        const double var_x84 = -4.0500000000000007 + 90.0 * var_x65;
        const double var_x85 = var_x67 * var_x69;
        const double var_x86 = var_x84 * var_x85;
        const double var_x87 = 1.0 - 0.099999999999999978 * var_chaste_interface__cell__sfcaBsl - 0.90000000000000002 * var_chaste_interface__cell__sfcaBj;
        const double var_x88 = 0.00021942907413020793 * var_x87;
        const double var_x89 = 1.0 - var_chaste_interface__cell__sfcaBj;
        const double var_x90 = var_x85 * var_x89;
        const double var_x91 = -105.0 + var_x72 * var_chaste_interface__cell__sNaj;
        const double var_x92 = 1.0971453706510396e-5 * var_x91;
        const double var_x93 = var_x90 * var_x92;
        const double var_x94 = var_x69 * var_x78;
        const double var_x95 = var_x89 * var_x94;
        const double var_x96 = -0.61380000000000001 + var_x80 * var_chaste_interface__cell__sCaj;
        const double var_x97 = 1.5798893337374971 * var_x96;
        const double var_x98 = var_x95 * var_x97;
        const double var_x99 = 1.8 * var_x42;
        const double var_x100 = var_x41 * var_x99 - var_x39 * var_x49;
        const double var_x101 = var_x39 / pow(var_x44, 2);
        const double var_x102 = var_x100 * var_x101 * var_x52;
        const double var_x103 = var_x55 * var_x99 - var_x39 * var_x59;
        const double var_x104 = var_x101 * var_x103 * var_x62;
        const double var_x105 = var_x85 * var_chaste_interface__cell__sVm;
        const double var_x106 = var_x65 * var_x87;
        const double var_x107 = pow(var_x66, (-2));
        const double var_x108 = var_x65 * var_chaste_interface__cell__sVm;
        const double var_x109 = var_x107 * var_x108;
        const double var_x110 = 4.5636229207574704e-8 * var_x109 * var_x70 * var_x73;
        const double var_x111 = var_x76 * var_chaste_interface__cell__sVm;
        const double var_x112 = var_x111 / pow(var_x77, 2);
        const double var_x113 = 0.013143234011781517 * var_x112 * var_x70 * var_x81;
        const double var_x114 = var_x89 * var_x91;
        const double var_x115 = 4.1072606286817249e-7 * var_x109 * var_x114 * var_x69;
        const double var_x116 = 0.11828910610603369 * var_x112 * var_x69 * var_x89 * var_x96;
        const double var_x117 = var_x108 * var_x71;
        const double var_x118 = var_x117 * var_chaste_interface__cell__sNasl;
        const double var_x119 = var_x111 * var_x95;
        const double var_x120 = 0.040336585182157485 * var_x119 * var_chaste_interface__cell__sCaj;
        const double var_x121 = var_x111 * var_x79;
        const double var_x122 = 0.0044818427980174982 * var_x121 * var_chaste_interface__cell__sCasl;
        const double var_x123 = var_x108 * var_x90;
        const double var_x124 = 3.0804454715112939e-7 * var_x123 * var_chaste_interface__cell__sNaj;
        const double var_x125 = -26.712338705498262 * log(140.0 * var_x31) + var_chaste_interface__cell__sVm;
        const double var_x126 = pow(var_chaste_interface__cell__sm, 2.0) * var_chaste_interface__cell__sh * var_chaste_interface__cell__sj;
        const double var_x127 = var_x125 * var_x126;
        const double var_x128 = -26.712338705498262 * log(140.0 * var_x23) + var_chaste_interface__cell__sVm;
        const double var_x129 = var_x126 * var_x128;
        const double var_x130 = 20.469999999999999 * var_x125;
        const double var_x131 = 2.5299999999999998 * var_x128;
        const double var_x132 = var_x34 * var_chaste_interface__cell__sh;
        const double var_x133 = var_chaste_interface__cell__sVm * var_chaste_interface__cell__sf;
        const double var_x134 = var_x133 * var_x68;
        const double var_x135 = var_x67 * var_x74;
        const double var_x136 = var_x78 * var_x82;
        const double var_x137 = var_x133 * var_x67;
        const double var_x138 = var_x84 * var_x88;
        const double var_x139 = var_x89 * var_x92;
        const double var_x140 = var_x78 * var_x89;
        const double var_x141 = var_x140 * var_x97;
        const double var_x142 = var_chaste_interface__cell__sVm * var_chaste_interface__cell__sd;
        const double var_x143 = var_x142 * var_x68;
        const double var_x144 = var_x142 * var_x67;
        const double var_x145 = var_x94 * var_chaste_interface__cell__sVm;
        const double var_x146 = var_x86 * var_chaste_interface__cell__sVm;
        const double var_x147 = 1 / (120.0 + 0.018329999999999999 * var_chaste_interface__cell__sNai);
        const double var_x148 = 0.0017541992827900708 * var_x23;
        const double var_x149 = 67.582216924910597 * var_x23 * var_x36;
        const double var_x150 = 1 / var_x28;
        const double var_x151 = var_x150 * var_x23 * var_x24 / pow((6.8301345536507063e-5 + var_x24), 2);
        const double var_x152 = pow(var_chaste_interface__cell__sNaj, 2.0);
        const double var_x153 = var_x100 * var_x45;
        const double var_x154 = var_x153 * var_x48 / pow((0.0035899999999999999 + 0.244140625 * var_x50 + 3.0636589236596067e-6 * var_x41 + var_chaste_interface__cell__sCaj), 2);
        const double var_x155 = var_x152 * var_x154;
        const double var_x156 = var_x152 * var_x42 * var_x53;
        const double var_x157 = 8.2285902798827967e-6 * var_x123;
        const double var_x158 = 0.014193066924392391 * var_x31;
        const double var_x159 = var_x150 * var_x31 * var_x32 / pow((6.8301345536507063e-5 + var_x32), 2);
        const double var_x160 = 546.80157330154941 * var_x31 * var_x36;
        const double var_x161 = pow(var_chaste_interface__cell__sNasl, 2.0);
        const double var_x162 = var_x103 * var_x45;
        const double var_x163 = var_x162 * var_x58 / pow((0.0035899999999999999 + 0.244140625 * var_x60 + 3.0636589236596067e-6 * var_x55 + var_chaste_interface__cell__sCasl), 2);
        const double var_x164 = var_x161 * var_x163;
        const double var_x165 = var_x161 * var_x42 * var_x63;
        const double var_x166 = 9.1428780887586606e-7 * var_x117;
        const double var_x167 = 0.00080995817805876559 * var_x2;
        ...
        const double var_x171 = 61.507432902288151 + var_chaste_interface__cell__sVm;
        const double var_x172 = var_x39 * var_x53;
        const double var_x173 = var_x154 * (-3413921.875 - 373215529.24791092 * var_chaste_interface__cell__sCaj);
        const double var_x174 = var_x153 * var_x2 * var_x46 * var_x51 / pow(var_x47, 2);
        const double var_x175 = 0.53874226280448656 * var_x119;
        const double var_x176 = 0.0065532979861118307 * var_x4;
        ...
        const double var_x180 = var_x39 * var_x63;
        const double var_x181 = var_x163 * (-3413921.875 - 373215529.24791092 * var_chaste_interface__cell__sCasl);
        const double var_x182 = 0.059860251422720716 * var_x121;
        const double var_x183 = var_x162 * var_x4 * var_x56 * var_x61 / pow(var_x57, 2);
        const double var_x184 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__cell__sVm);
        const double var_x185 = 1.0 + var_x184;
        const double var_x186 = 1 + 0.021838829438742085 * var_chaste_interface__cell__sVm;
        const double var_x187 = exp(-8.682389366752302 * pow(var_x186, 2.0));
        const double var_x188 = -1 + 0.2073398299813394 * var_chaste_interface__cell__sVm;
        const double var_x189 = exp(-0.0089012876052174655 * pow(var_x188, 2.0));
        const double var_x190 = 1 / (0.12920000000000001 * var_x187 + 0.064869999999999997 * var_x189);
        ...
        const double var_x194 = 1.0 * pow(var_x193, (-2.0));
        ...
        const double var_x197 = var_x192 * pow(var_x193, (-3.0));
        ...
        const double var_x207 = 0.10000000000000001 * var_chaste_interface__cell__sVm;
        const double var_x208 = exp(-3.2000000000000002 - var_x207);
        ...
        const double var_x229 = 1.0 + var_x226;
        const double var_x230 = 1 / var_x229;
        const double var_x231 = -var_chaste_interface__cell__sd + 1.0 * var_x230;
        const double var_x232 = var_x228 * var_x231;
        const double var_x233 = 0.035000000000000003 * var_x229;
        const double var_x234 = 5.0 + var_chaste_interface__cell__sVm;
        const double var_x235 = var_x228 * var_x234;
        const double var_x236 = 0.0058333333333333336 * var_x226;
        const double var_x237 = var_x234 * var_x236;
        const double var_x238 = 1 + 0.068965517241379309 * var_chaste_interface__cell__sVm;
        const double var_x239 = exp(-0.23877882250000002 * pow(var_x238, 2.0));
        const double var_x240 = 0.019699999999999999 * var_x239;
        const double var_x241 = 0.050000000000000003 * var_chaste_interface__cell__sVm;
        const double var_x242 = exp(2.5 - var_x241);
        const double var_x243 = 1.0 + var_x242;
        const double var_x244 = 0.1111111111111111 * var_chaste_interface__cell__sVm;
        const double var_x245 = exp(3.8888888888888888 + var_x244);
        const double var_x246 = 1.0 + var_x245;
        const double var_x247 = exp(0.20000000000000001 + 0.066666666666666666 * var_chaste_interface__cell__sVm);
        const double var_x248 = 1.0 + var_x247;
        const double var_x249 = 1 / var_x248;
        const double var_x250 = 1 / (0.5 + 9.0 * var_x249);
        const double var_x251 = exp(1.4615384615384615 - 0.076923076923076927 * var_chaste_interface__cell__sVm);
        const double var_x252 = 1.0 + var_x251;
        const double var_x253 = 0.076923076923076927 * var_x251 / pow(var_x252, 2);
        const double var_x254 = 1.0 / var_x252;
        const double var_x255 = exp(6.0 + var_x207);
        const double var_x256 = 1.0 + var_x255;
        const double var_x257 = 1 / var_x256;
        const double var_x258 = 1 / (30.0 + 800.0 * var_x257);
        const double var_x259 = 0.20000000000000001 * var_chaste_interface__cell__sVm;
        const double var_x260 = exp(3.8999999999999999 + var_x259);
        const double var_x261 = 1.0 + var_x260;
        const double var_x262 = 0.20000000000000001 * var_x260 / pow(var_x261, 2);
        const double var_x263 = 1.0 / var_x261;
        const double var_x264 = 1 + 0.022222222222222223 * var_chaste_interface__cell__sVm;
        const double var_x265 = exp(-0.81000000000000005 * pow(var_x264, 2.0));
        const double var_x266 = 1 / (0.5 + 8.5 * var_x265);
        const double var_x267 = 1 + 0.025000000000000001 * var_chaste_interface__cell__sVm;
        const double var_x268 = exp(-7.2727272727272725 * pow(var_x267, 2.0));
        const double var_x269 = 1 / (7.0 + 85.0 * var_x268);
        const double var_x270 = exp(-2.0 - var_x259);
        const double var_x271 = 1.0 + var_x270;
        const double var_x272 = exp(2.0 + var_x241);
        const double var_x273 = 1.0 + var_x272;
        const double var_x274 = 1 / var_x273;
        const double var_x275 = exp(1.2222222222222223 + var_x244);
        const double var_x276 = 1.0 + var_x275;
        const double var_x277 = 1 / var_x276;
        const double var_x278 = exp(-2.4444444444444446 - var_x244);
        const double var_x279 = 1.0 + var_x278;
        const double var_x280 = 1 / var_x279;
        const double var_x281 = var_x277 * var_x280;
        const double var_x282 = 1 / (230.0 * var_x274 + 3300.0 * var_x281);
        const double var_x283 = exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__cell__sVm);
        const double var_x284 = 1.0 + var_x283;
        const double var_x285 = exp(-0.17252124645892353 - 0.070821529745042494 * var_chaste_interface__cell__sVm);
        const double var_x286 = 0.00100999899000101 * var_x285;
        const double var_x287 = 1 / var_chaste_interface__cell__sCa_sr;
        const double var_x288 = pow(var_x287, 2.5);
        const double var_x289 = 1.0 + 0.13584112963311223 * var_x288;
        const double var_x290 = 1 / var_x289;
        const double var_x291 = 7.0 * var_x290;
        const double var_x292 = -7.5 + var_x291;
        const double var_x293 = var_x292 * var_chaste_interface__cell__sCaj;
        const double var_x294 = 1 / (15.0 - 14.0 * var_x290);
        const double var_x295 = pow(var_chaste_interface__cell__sCaj, 2.0);
        const double var_x296 = 10.0 * var_x294 * var_x295;
        const double var_x297 = -var_x296;
        const double var_x298 = var_x287 * var_x288 / pow(var_x289, 2);
        const double var_x299 = var_x298 * var_chaste_interface__cell__sRyRr;
        const double var_x300 = 2.3772197685794643 * var_chaste_interface__cell__sCaj;
        const double var_x301 = 0.21130842387373014 * var_x295 / pow((1 - 0.93333333333333335 * var_x290), 2);
        const double var_x302 = var_x299 * var_x301;
        const double var_x303 = 20.0 * var_x294 * pow(var_chaste_interface__cell__sCaj, 1.0);
        const double var_x304 = var_x303 * var_chaste_interface__cell__sRyRr;
        const double var_x305 = var_x298 * var_x300 * var_chaste_interface__cell__sRyRo;
        const double var_x306 = 7.5 - var_x291;
        const double var_x307 = 1.0 - var_chaste_interface__cell__sRyRi - var_chaste_interface__cell__sRyRo - var_chaste_interface__cell__sRyRr;
        const double var_x308 = 0.0001 * var_chaste_interface__cell__sNaj;
        const double var_x309 = 0.0001 * var_chaste_interface__cell__sNaBj;
        const double var_x310 = 0.0001 * var_chaste_interface__cell__sNasl;
        const double var_x311 = 0.0001 * var_chaste_interface__cell__sNaBsl;
        const double var_x312 = 32.700000000000003 * var_chaste_interface__cell__sCai;
        const double var_x313 = 32.700000000000003 * var_chaste_interface__cell__sTnCL;
        const double var_x314 = 2.3700000000000001 * var_chaste_interface__cell__sCai;
        const double var_x315 = -var_x314;
        const double var_x316 = 2.3700000000000001 * var_chaste_interface__cell__sTnCHc;
        const double var_x317 = 2.3700000000000001 * var_chaste_interface__cell__sTnCHm;
        const double var_x318 = 34.0 * var_chaste_interface__cell__sCai;
        const double var_x319 = 34.0 * var_chaste_interface__cell__sCaM;
        const double var_x320 = 13.800000000000001 * var_chaste_interface__cell__sCai;
        const double var_x321 = -var_x320;
        const double var_x322 = 13.800000000000001 * var_chaste_interface__cell__sMyoc;
        const double var_x323 = 13.800000000000001 * var_chaste_interface__cell__sMyom;
        const double var_x324 = 100.0 * var_chaste_interface__cell__sCai;
        const double var_x325 = 100.0 * var_chaste_interface__cell__sSRB;
        const double var_x326 = 100.0 * var_chaste_interface__cell__sCaj;
        const double var_x327 = -var_x326;
        const double var_x328 = 100.0 * var_chaste_interface__cell__sSLLj;
        const double var_x329 = 100.0 * var_chaste_interface__cell__sCasl;
        const double var_x330 = -var_x329;
        const double var_x331 = 100.0 * var_chaste_interface__cell__sSLLsl;
        const double var_x332 = 100.0 * var_chaste_interface__cell__sSLHj;
        const double var_x333 = 100.0 * var_chaste_interface__cell__sSLHsl;
        const double var_x334 = 100.0 * var_chaste_interface__cell__sCa_sr;
        const double var_x335 = 100.0 * var_chaste_interface__cell__sCsqnb;
        const double var_x336 = 25.0 * var_chaste_interface__cell__sRyRo;
        const double var_x337 = pow(var_chaste_interface__cell__sCai, 1.7869999999999999);
        const double var_x338 = 2814485.1633595931 * var_x337;
        const double var_x339 = pow(var_chaste_interface__cell__sCa_sr, 1.7869999999999999);
        const double var_x340 = 0.38742512113256738 * var_x339;
        const double var_x341 = 1 / (1.0 + var_x338 + var_x340);
        const double var_x342 = pow(var_chaste_interface__cell__sCa_sr, 0.78699999999999992);
        const double var_x343 = var_x341 * var_x342;
        const double var_x344 = (var_x338 - var_x340) / pow((3.5530476870814998e-7 + var_x337 + 1.3765399305573384e-7 * var_x339), 2);
        const double var_x345 = var_x342 * var_x344;
        const double var_x346 = pow(var_chaste_interface__cell__sCai, 0.78699999999999992);
        const double var_x347 = var_x341 * var_x346;
        const double var_x348 = var_x344 * var_x346;
        const double var_x349 = 1 / M_PI;
        const double var_x350 = 0.25275361828036119 * var_x349;
        const double var_x351 = var_x349 * var_x35;
        const double var_x352 = 0.63946665424931382 * var_x128;
        const double var_x353 = var_x132 * var_x349;
        const double var_x354 = 2.7730746221159828e-6 * var_x349;
        const double var_x355 = var_x114 * var_x354;
        const double var_x356 = 3.2338348512952546 * var_x349;
        const double var_x357 = 0.0068117100126557353 * var_x349;
        const double var_x358 = 0.13943570395906291 * var_x125;
        const double var_x359 = var_x134 * var_x349;
        const double var_x360 = 8.3038178962250795e-9 * var_x73;
        const double var_x361 = var_x360 * var_x67;
        const double var_x362 = var_x143 * var_x349;
        const double var_x363 = 0.23994917636495411 * var_x349;
        const double var_x364 = 0.1263768091401806 * var_x349;
        const double var_x365 = 0.19966137279235074 * var_x349 * var_x96;
        const double var_x366 = var_x140 * var_x365;
        const double var_x367 = 1623.3766233766235 * var_chaste_interface__cell__sRyRo;
        const double var_x368 = 145.53234034920845 * var_x349;
        const double var_x369 = 0.0034058550063278672 * var_x349;
        const double var_x370 = 0.00059787488852820574 * var_x81;
        const double var_x371 = var_x370 * var_x78;
        const double var_x372 = 0.54535393106272634 * var_x349;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.010148299999999999 + var_x110 + var_x113 + var_x115 + var_x116 - var_x120 - var_x122 - var_x124 - var_x75 - var_x83 - var_x93 - var_x98 - 0.002 / var_x1 - 0.006029375 / var_x3 - 0.048783124999999997 / var_x5 - 0.495 * var_x54 - 4.0049999999999999 * var_x64 - 0.15495652173913047 * var_x30 - 1.2537391304347827 * var_x33 - 0.0035000000000000001 * var_x6 - 23.0 * var_x36 - 3.422717190568103e-8 * var_x118 - 0.0043287860817742326 * var_x102 - 0.035023814661627885 * var_x104 - var_x21 * var_chaste_interface__cell__sxtof - var_x22 * var_chaste_interface__cell__sxtos - var_x86 * var_x88 - var_x9 * var_chaste_interface__cell__sxkr - 0.35699999999999998 * var_x12 * var_x20 - 0.0007393069131627105 * var_x105 * var_x106 + 0.085144499999999998 * var_x20 * var_x37 * var_x38 - 0.00033444816053511704 * var_x0 * var_x37 / pow(var_x1, 2) + 0.0014583333333333334 * var_x37 * var_x7 * var_chaste_interface__cell__sxkr / pow(var_x8, 2) - 0.34313725490196073 * var_x12 * var_x37 * (0.24326999999999999 * var_x38 - var_x15 * (0.061749999999999999 * var_x17 + 0.039456396800000001 * var_x16) - 0.51429999999999998 * var_x13 * var_x18 / pow(var_x14, 2)) / pow((var_x12 + 0.98039215686274506 * var_x19), 2) + 8.2145212573634494e-6 * var_x106 * var_x107 * var_x69 * var_x84 * var_chaste_interface__cell__sVm);
        IJth(rJacobian, 1, 0) = 0.22148394241417499 * var_x184 * var_x190 * pow(var_x185, (-3.0)) + 59.906641489902128 * (-var_chaste_interface__cell__sm + 1.0 * pow(var_x185, (-2.0))) * (0.048996056177523374 * var_x187 * pow(var_x186, 1.0) + 0.00023944703584924607 * var_x189 * pow(var_x188, 1.0)) / pow((var_x187 + 0.5020897832817337 * var_x189), 2);
        ...
        IJth(rJacobian, 3, 0) = ((var_x199) ? (0.034200000000000001 * var_x206 * var_x211 - 0.16150740242261105 * var_x197 * var_x211 + 0.059999999999999998 * var_x206 * var_x208 * var_x210 / pow(var_x209, 2)) : (var_x206 * (var_x218 - 0.00025500480000000003 * var_x222 + var_x217 * var_x223 * (3.0508668000000001e-7 * var_x213 - 6214.6032000000005 * var_x212) + 0.0033402720000000005 * var_x219 * var_x221 / pow(var_x220, 2) - 0.311 * var_x214 * var_x215 * var_x223 / pow(var_x216, 2)) - var_x198 * (var_x224 + var_x225)));
        IJth(rJacobian, 4, 0) = var_x232 * var_x233 - var_x232 * var_x237 + var_x230 * var_x235 * var_x236 - var_x229 * var_x231 * var_x237 / pow(var_x227, 2);
        IJth(rJacobian, 5, 0) = (0.02 + var_x240) * (0.029999999999999999 * var_x242 / pow(var_x243, 2) - 0.1111111111111111 * var_x245 / pow(var_x246, 2)) - 0.00064881969699999995 * var_x239 * pow(var_x238, 1.0) * (-var_chaste_interface__cell__sf + 1.0 / var_x246 + 0.59999999999999998 / var_x243);
        IJth(rJacobian, 8, 0) = var_x250 * var_x253 + 0.0074074074074074077 * var_x247 * (var_x254 - var_chaste_interface__cell__sxtos) / (pow(var_x248, 2) * pow((0.055555555555555552 + var_x249), 2));
        IJth(rJacobian, 9, 0) = -var_x258 * var_x262 + 0.000125 * var_x255 * (var_x263 - var_chaste_interface__cell__sytos) / (pow(var_x256, 2) * pow((0.037499999999999999 + var_x257), 2));
        IJth(rJacobian, 10, 0) = var_x253 * var_x266 + 0.0042352941176470593 * var_x265 * pow(var_x264, 1.0) * (var_x254 - var_chaste_interface__cell__sxtof) / pow((0.058823529411764705 + var_x265), 2);
        IJth(rJacobian, 11, 0) = -var_x262 * var_x269 + 0.0042780748663101605 * var_x268 * pow(var_x267, 1.0) * (var_x263 - var_chaste_interface__cell__sytof) / pow((0.082352941176470587 + var_x268), 2);
        IJth(rJacobian, 12, 0) = 0.20000000000000001 * var_x270 * var_x282 / pow(var_x271, 2) + 9.1827364554637282e-8 * (-var_chaste_interface__cell__sxkr + 1.0 / var_x271) * (11.5 * var_x272 / pow(var_x273, 2) + 366.66666666666663 * var_x275 * var_x280 / pow(var_x276, 2) - 366.66666666666663 * var_x277 * var_x278 / pow(var_x279, 2)) / pow((var_x281 + 0.069696969696969702 * var_x274), 2);
        IJth(rJacobian, 13, 0) = -7.1529673512819408e-5 * var_x285 * (-var_chaste_interface__cell__sxks + 1.0 / var_x284) + 0.070175438596491224 * var_x283 * (0.00100999899000101 + var_x286) / pow(var_x284, 2);
        IJth(rJacobian, 32, 0) = -var_x350 * (6.567e-5 + var_x124 + var_x93 - var_x115 + 2.5299999999999998 * var_x36 + 1.4850000000000001 * var_x54 + 0.46486956521739137 * var_x30 + 0.0129863582453227 * var_x102);
        IJth(rJacobian, 33, 0) = -var_x357 * (0.00053133 + var_x75 - var_x110 + 20.469999999999999 * var_x36 + 12.015000000000001 * var_x64 + 3.7612173913043483 * var_x33 + 0.10507144398488366 * var_x104 + 3.422717190568103e-8 * var_x118);
        IJth(rJacobian, 35, 0) = -var_x364 * (6.0643000000000002e-5 + var_x120 + var_x98 - var_x116 - 0.98999999999999999 * var_x54 - 0.0086575721635484652 * var_x102);
        IJth(rJacobian, 36, 0) = -var_x369 * (0.00049065700000000003 + var_x122 + var_x83 - var_x113 - 8.0099999999999998 * var_x64 - 0.07004762932325577 * var_x104);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-61.409999999999997 * var_x127 - 7.5899999999999999 * var_x129);
        IJth(rJacobian, 1, 1) = -var_x190;
        IJth(rJacobian, 32, 1) = -1.9183999627479413 * var_x129 * var_x349;
        IJth(rJacobian, 33, 1) = -0.41830711187718866 * var_x127 * var_x349;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x130 * var_x35 - var_x131 * var_x35);
        IJth(rJacobian, 2, 2) = ((var_x199) ? (-var_x196) : (-var_x203 - var_x204 - var_x205));
        IJth(rJacobian, 32, 2) = -var_x351 * var_x352;
        IJth(rJacobian, 33, 2) = -var_x351 * var_x358;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x130 * var_x132 - var_x131 * var_x132);
        IJth(rJacobian, 3, 3) = ((var_x199) ? (-0.59999999999999998 * var_x211) : (-var_x224 - var_x225));
        IJth(rJacobian, 32, 3) = -var_x352 * var_x353;
        IJth(rJacobian, 33, 3) = -var_x353 * var_x358;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x133 * var_x141 - var_x134 * var_x135 - var_x134 * var_x136 - var_x137 * var_x138 - var_x137 * var_x139);
        IJth(rJacobian, 4, 4) = -var_x233 * var_x235;
        IJth(rJacobian, 32, 4) = -var_x137 * var_x355;
        IJth(rJacobian, 33, 4) = -var_x359 * var_x361;
        IJth(rJacobian, 35, 4) = -var_x133 * var_x366;
        IJth(rJacobian, 36, 4) = -var_x359 * var_x371;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x135 * var_x143 - var_x136 * var_x143 - var_x138 * var_x144 - var_x139 * var_x144 - var_x141 * var_x142);
        IJth(rJacobian, 5, 5) = -0.02 - var_x240;
        IJth(rJacobian, 32, 5) = -var_x144 * var_x355;
        IJth(rJacobian, 33, 5) = -var_x361 * var_x362;
        IJth(rJacobian, 35, 5) = -var_x142 * var_x366;
        IJth(rJacobian, 36, 5) = -var_x362 * var_x371;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (0.00019748616671718715 * var_x146 + var_x105 * var_x92 + var_x145 * var_x97);
        IJth(rJacobian, 6, 6) = -0.011900000000000001 - 1.7 * var_chaste_interface__cell__sCaj;
        IJth(rJacobian, 32, 6) = var_x105 * var_x354 * var_x91;
        IJth(rJacobian, 35, 6) = var_x145 * var_x365;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (2.1942907413020789e-5 * var_x146 + var_x105 * var_x74 + var_x145 * var_x82);
        IJth(rJacobian, 7, 7) = -0.011900000000000001 - 1.7 * var_chaste_interface__cell__sCasl;
        IJth(rJacobian, 33, 7) = var_x105 * var_x349 * var_x360;
        IJth(rJacobian, 36, 7) = var_x145 * var_x349 * var_x370;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x22 * var_x37);
        IJth(rJacobian, 8, 8) = -var_x250;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.015599999999999999 * var_x37 * var_chaste_interface__cell__sxtos);
        IJth(rJacobian, 9, 9) = -var_x258;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x21 * var_x37);
        IJth(rJacobian, 10, 10) = -var_x266;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-0.1144 * var_x37 * var_chaste_interface__cell__sxtof);
        IJth(rJacobian, 11, 11) = -var_x269;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x37 * var_x9);
        IJth(rJacobian, 12, 12) = -var_x282;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0070000000000000001 * pow(var_chaste_interface__cell__sxks, 1.0) * (-26.712338705498262 * log(7.9662000000000006 * var_x147) + var_chaste_interface__cell__sVm));
        IJth(rJacobian, 13, 13) = -0.00100999899000101 - var_x286;
        IJth(rJacobian, 14, 14) = -0.0050000000000000001 + var_x293 + var_x297;
        IJth(rJacobian, 15, 14) = var_x296;
        IJth(rJacobian, 16, 14) = var_x297;
        IJth(rJacobian, 14, 15) = 0.055;
        IJth(rJacobian, 15, 15) = -0.059999999999999998 + var_x293;
        IJth(rJacobian, 16, 15) = var_x297 + var_x306 * var_chaste_interface__cell__sCaj;
        ...
        IJth(rJacobian, 16, 16) = -0.065000000000000002 + var_x297;
        IJth(rJacobian, 17, 17) = -0.001 - var_x308;
        IJth(rJacobian, 32, 17) = 0.001 + var_x308;
        IJth(rJacobian, 18, 18) = -0.001 - var_x310;
        IJth(rJacobian, 33, 18) = 0.001 + var_x310;
        IJth(rJacobian, 19, 19) = -0.019599999999999999 - var_x312;
        IJth(rJacobian, 37, 19) = 0.019599999999999999 + var_x312;
        IJth(rJacobian, 20, 20) = -3.1999999999999999e-5 + var_x315;
        IJth(rJacobian, 21, 20) = -0.0030000000000000001;
        IJth(rJacobian, 37, 20) = 0.003032 + var_x314;
        IJth(rJacobian, 20, 21) = var_x315;
        IJth(rJacobian, 21, 21) = -0.0063300000000000006;
        IJth(rJacobian, 37, 21) = 0.0063300000000000006 + var_x314;
        IJth(rJacobian, 22, 22) = -0.23799999999999999 - var_x318;
        IJth(rJacobian, 37, 22) = 0.23799999999999999 + var_x318;
        IJth(rJacobian, 23, 23) = -0.00046000000000000001 + var_x321;
        IJth(rJacobian, 24, 23) = -0.015699999999999999;
        IJth(rJacobian, 37, 23) = 0.016159999999999997 + var_x320;
        IJth(rJacobian, 23, 24) = var_x321;
        IJth(rJacobian, 24, 24) = -0.015757;
        IJth(rJacobian, 37, 24) = 0.015757 + var_x320;
        IJth(rJacobian, 25, 25) = -0.059999999999999998 - var_x324;
        IJth(rJacobian, 37, 25) = 0.059999999999999998 + var_x324;
        IJth(rJacobian, 26, 26) = -1.3 + var_x327;
        IJth(rJacobian, 35, 26) = 1.3 + var_x326;
        IJth(rJacobian, 27, 27) = -1.3 + var_x330;
        IJth(rJacobian, 36, 27) = 1.3 + var_x329;
        IJth(rJacobian, 28, 28) = -0.029999999999999999 + var_x327;
        IJth(rJacobian, 35, 28) = 0.029999999999999999 + var_x326;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x330;
        IJth(rJacobian, 36, 29) = 0.029999999999999999 + var_x329;
        IJth(rJacobian, 30, 30) = -65.0 - var_x334;
        IJth(rJacobian, 31, 30) = 65.0 + var_x334;
        IJth(rJacobian, 14, 31) = -var_x302 + var_x299 * var_x300;
        IJth(rJacobian, 15, 31) = var_x302 + var_x305;
        IJth(rJacobian, 16, 31) = -var_x305 + var_x298 * var_x301 * var_x307;
        IJth(rJacobian, 30, 31) = 260.0 - var_x335;
        IJth(rJacobian, 31, 31) = -260.00009932 + var_x335 - var_x336 - 4.6421953480341139e-16 * var_x345 - 0.0036772346118413473 * var_x343;
        IJth(rJacobian, 35, 31) = 0.0064493506493506492 + var_x367;
        IJth(rJacobian, 37, 31) = 2.4996436489414462e-17 * var_x345 + 0.00019800494063761101 * var_x343;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x148 - var_x149 - var_x157 + 1.6579932586131619e-12 * var_x155 - 2.673 * var_x156 - 4.2334955737758478e-5 * var_x151);
        IJth(rJacobian, 17, 32) = 0.0007561 - var_x309;
        IJth(rJacobian, 32, 32) = -0.0007561 + var_x309 - var_x356 - var_x350 * (var_x148 + var_x149 + var_x157 + 0.00012700486721327543 * var_x151 + 8.0190000000000001 * var_x156 - 4.9739797758394858e-12 * var_x155);
        IJth(rJacobian, 33, 32) = 0.087151849242407126 * var_x349;
        IJth(rJacobian, 35, 32) = -var_x364 * (3.3159865172263237e-12 * var_x155 - 5.3460000000000001 * var_x156);
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x158 - var_x160 - var_x166 + 1.3414672728779218e-11 * var_x164 - 0.00034252827824186399 * var_x159 - 21.626999999999999 * var_x165);
        IJth(rJacobian, 18, 33) = 0.000165 - var_x311;
        IJth(rJacobian, 32, 33) = var_x356;
        IJth(rJacobian, 33, 33) = -0.000165 + var_x311 - 7.8855000811034159 * var_x349 - var_x357 * (var_x158 + var_x160 + var_x166 + 64.881 * var_x165 + 0.001027584834725592 * var_x159 - 4.0244018186337659e-11 * var_x164);
        IJth(rJacobian, 34, 33) = var_x363;
        IJth(rJacobian, 36, 33) = -var_x369 * (2.6829345457558435e-11 * var_x164 - 43.253999999999998 * var_x165);
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (-0.001713730089651241 * var_x147 * var_x6);
        IJth(rJacobian, 33, 34) = 7.7983482318610085 * var_x349;
        IJth(rJacobian, 34, 34) = -var_x363;
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (var_x169 - var_x167 - var_x170 - var_x175 + 1358280.0 * var_x172 - 2.2274999999999996e-8 * var_x174 - 6.5741102771804265e-14 * var_x173 - 0.00060293750000000007 * var_x171 / (pow(var_x3, 2) * pow(var_chaste_interface__cell__sCaj, 2)));
        IJth(rJacobian, 6, 35) = 1.7 - 1.7 * var_chaste_interface__cell__sfcaBj;
        IJth(rJacobian, 14, 35) = -var_x304 + var_x292 * var_chaste_interface__cell__sRyRr;
        IJth(rJacobian, 15, 35) = var_x304 + var_x292 * var_chaste_interface__cell__sRyRo;
        IJth(rJacobian, 16, 35) = var_x303 * var_x307 + var_x306 * var_chaste_interface__cell__sRyRo;
        IJth(rJacobian, 26, 35) = 55.473098330241186 - var_x328;
        IJth(rJacobian, 28, 35) = 19.897959183673468 - var_x332;
        IJth(rJacobian, 31, 35) = 9.9320000000000005e-5 + var_x336;
        IJth(rJacobian, 32, 35) = -var_x350 * (6.6824999999999991e-8 * var_x174 + 1.9722330831541282e-13 * var_x173 - 4074840.0000000005 * var_x172);
        IJth(rJacobian, 35, 35) = -75.377506864564012 + var_x328 + var_x332 - var_x367 - var_x368 - var_x364 * (var_x167 + var_x170 + var_x175 - var_x169 + 2716560.0 * var_x172 - 4.4549999999999992e-8 * var_x174 - 1.3148220554360853e-13 * var_x173);
        IJth(rJacobian, 36, 35) = 3.9220965724111685 * var_x349;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (var_x178 - var_x176 - var_x179 - var_x182 + 10989720.0 * var_x180 - 5.3190528606277995e-13 * var_x181 - 1.8022499999999996e-7 * var_x183 - 0.0048783124999999998 * var_x171 / (pow(var_x5, 2) * pow(var_chaste_interface__cell__sCasl, 2)));
        IJth(rJacobian, 7, 36) = 1.7 - 1.7 * var_chaste_interface__cell__sfcaBsl;
        IJth(rJacobian, 27, 36) = 121.55 - var_x331;
        IJth(rJacobian, 29, 36) = 43.549999999999997 - var_x333;
        IJth(rJacobian, 33, 36) = -var_x357 * (1.5957158581883401e-12 * var_x181 + 5.4067499999999991e-7 * var_x183 - 32969160.0 * var_x180);
        IJth(rJacobian, 35, 36) = var_x368;
        IJth(rJacobian, 36, 36) = -165.09999999999999 + var_x331 + var_x333 - 21.646099331949774 * var_x349 - var_x369 * (var_x176 + var_x179 + var_x182 - var_x178 + 21979440.0 * var_x180 - 1.0638105721255599e-12 * var_x181 - 3.6044999999999992e-7 * var_x183);
        IJth(rJacobian, 37, 36) = var_x372;
        IJth(rJacobian, 19, 37) = 2.2890000000000006 - var_x313;
        IJth(rJacobian, 20, 37) = 0.33180000000000004 - var_x316 - var_x317;
        IJth(rJacobian, 22, 37) = 0.81600000000000006 - var_x319;
        IJth(rJacobian, 23, 37) = 1.9320000000000004 - var_x322 - var_x323;
        IJth(rJacobian, 25, 37) = 1.71 - var_x325;
        IJth(rJacobian, 31, 37) = 26713.60655954597 * var_x347 - 3.3723651925989282e-9 * var_x348;
        IJth(rJacobian, 36, 37) = 17.724002759538607 * var_x349;
        IJth(rJacobian, 37, 37) = -7.0788000000000011 + var_x313 + var_x316 + var_x317 + var_x319 + var_x322 + var_x323 + var_x325 - var_x372 + 1.8158889498609613e-10 * var_x348 - 1438.4249685909369 * var_x347;
    }
