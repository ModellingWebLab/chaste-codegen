...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellgrandi2010ssFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__cell__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x21 = 82.837440942604388 + var_chaste_interface__cell__sVm;
        const double var_x22 = pow(var_chaste_interface__cell__sm, 3.0);
        const double var_x23 = var_x22 * var_chaste_interface__cell__sj;
        const double var_x24 = var_x23 * var_chaste_interface__cell__sh;
        const double var_x25 = 1 / var_chaste_interface__cell__sNasl;
        const double var_x26 = pow(var_x25, 4.0);
        const double var_x27 = exp(-0.0037435883507802624 * var_chaste_interface__cell__sVm);
        const double var_x28 = exp(2.0802377414561666);
        const double var_x29 = 0.037435883507802623 * var_chaste_interface__cell__sVm;
        ...
        const double var_x32 = (0.00046607674967214267 * var_x27 + 0.037435883507802623 * var_x30 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x28)) / pow(var_x31, 2);
        const double var_x33 = var_x32 / (1.0 + 14641.0 * var_x26);
        const double var_x34 = 1 / var_chaste_interface__cell__sNaj;
        ...
        const double var_x38 = pow(var_chaste_interface__cell__sNaj, 3.0);
        const double var_x39 = exp(0.010107688547106709 * var_chaste_interface__cell__sVm);
        const double var_x40 = 0.018193839384792077 * var_x39;
        const double var_x41 = exp(-0.027328194960695915 * var_chaste_interface__cell__sVm);
        const double var_x42 = 74988.566972149594 * var_x41;
        const double var_x43 = 1.0 + 0.32000000000000001 * var_x41;
        ...
        const double var_x50 = 1 / (9850.9599999999991 + var_x48 + 669921.875 * var_x49 + 8.4066800865219609 * var_x38);
        const double var_x51 = var_x47 * var_x50;
        const double var_x52 = var_x44 * var_x51;
        const double var_x53 = var_x52 * (var_x38 * var_x40 + var_x42 * var_chaste_interface__cell__sCaj);
        ...
        const double var_x60 = 1 / (9850.9599999999991 + var_x58 + 669921.875 * var_x59 + 8.4066800865219609 * var_x54);
        const double var_x61 = var_x57 * var_x60;
        const double var_x62 = var_x44 * var_x61;
        const double var_x63 = var_x62 * (var_x40 * var_x54 + var_x42 * var_chaste_interface__cell__sCasl);
        ...
        const double var_x73 = 1.2190504118344881e-6 * var_x72;
        ...
        const double var_x81 = 0.34100000000000003 * var_x76;
        const double var_x82 = -0.61380000000000001 + var_x81 * var_chaste_interface__cell__sCaj;
        const double var_x83 = 1.5798893337374971 * var_x82;
        const double var_x84 = var_x80 * var_x83;
        const double var_x85 = -4.0500000000000007 + 90.0 * var_x65;
        const double var_x86 = var_x69 * var_x85;
        ...
        const double var_x89 = 1.8 * var_x39;
        const double var_x90 = var_x38 * var_x89 - var_x41 * var_x48;
        const double var_x91 = var_x41 / pow(var_x43, 2);
        const double var_x92 = var_x51 * var_x90 * var_x91;
        const double var_x93 = var_x54 * var_x89 - var_x41 * var_x58;
        const double var_x94 = var_x61 * var_x91 * var_x93;
        const double var_x95 = var_x64 * var_x79;
        const double var_x96 = -0.61380000000000001 + var_x81 * var_chaste_interface__cell__sCasl;
        const double var_x97 = 0.17554325930416631 * var_x96;
        const double var_x98 = var_x95 * var_x97;
        const double var_x99 = var_x69 * var_x75;
        const double var_x100 = -105.0 + var_x71 * var_chaste_interface__cell__sNaj;
        const double var_x101 = 1.0971453706510396e-5 * var_x100;
        const double var_x102 = var_x101 * var_x99;
        const double var_x103 = var_x69 * var_chaste_interface__cell__sVm;
        const double var_x104 = var_x65 * var_x87;
        const double var_x105 = var_x68 / pow(var_x66, 2);
        const double var_x106 = var_x65 * var_chaste_interface__cell__sVm;
        const double var_x107 = var_x105 * var_x106;
        const double var_x108 = 4.5636229207574711e-8 * var_x107 * var_x64 * var_x72;
        const double var_x109 = var_x76 * var_chaste_interface__cell__sVm;
        const double var_x110 = var_x109 * var_x68 / pow(var_x77, 2);
        const double var_x111 = 0.013143234011781517 * var_x110 * var_x64 * var_x96;
        const double var_x112 = var_x100 * var_x75;
        const double var_x113 = 4.1072606286817249e-7 * var_x107 * var_x112;
        const double var_x114 = var_x75 * var_x82;
        const double var_x115 = 0.11828910610603369 * var_x110 * var_x114;
        const double var_x116 = var_x109 * var_x95;
        const double var_x117 = 0.0044818427980174973 * var_x116 * var_chaste_interface__cell__sCasl;
        const double var_x118 = var_x106 * var_x70;
        const double var_x119 = 3.422717190568103e-8 * var_x118 * var_chaste_interface__cell__sNasl;
        const double var_x120 = var_x109 * var_x80;
        const double var_x121 = 0.040336585182157485 * var_x120 * var_chaste_interface__cell__sCaj;
        const double var_x122 = var_x106 * var_x99;
        const double var_x123 = 3.0804454715112934e-7 * var_x122 * var_chaste_interface__cell__sNaj;
        const double var_x124 = -26.712338705498262 * log(140.0 * var_x34) + var_chaste_interface__cell__sVm;
        ...
        const double var_x127 = -26.712338705498262 * log(140.0 * var_x25) + var_chaste_interface__cell__sVm;
        const double var_x128 = var_x125 * var_x127;
        const double var_x129 = 2.5299999999999998 * var_x124;
        const double var_x130 = 20.469999999999999 * var_x127;
        const double var_x131 = var_x22 * var_chaste_interface__cell__sh;
        ...
        const double var_x135 = var_x132 * var_x78;
        const double var_x136 = var_x75 * var_x83;
        const double var_x137 = var_x85 * var_x88;
        const double var_x138 = var_x64 * var_x97;
        const double var_x139 = var_x101 * var_x75;
        ...
        const double var_x142 = var_x140 * var_x78;
        const double var_x143 = var_x79 * var_chaste_interface__cell__sVm;
        const double var_x144 = var_x86 * var_chaste_interface__cell__sVm;
        ...
        const double var_x147 = 0.0017541992827900708 * var_x34;
        const double var_x148 = 67.582216924910597 * var_x24 * var_x34;
        const double var_x149 = 1 / var_x31;
        const double var_x150 = var_x149 * var_x34 * var_x35 / pow((6.8301345536507063e-5 + var_x35), 2);
        const double var_x151 = pow(var_chaste_interface__cell__sNaj, 2.0);
        const double var_x152 = var_x44 * var_x90;
        const double var_x153 = var_x152 * var_x47 / pow((0.0035899999999999999 + 0.244140625 * var_x49 + 3.0636589236596067e-6 * var_x38 + var_chaste_interface__cell__sCaj), 2);
        const double var_x154 = var_x151 * var_x153;
        const double var_x155 = var_x151 * var_x39 * var_x52;
        const double var_x156 = 8.2285902798827967e-6 * var_x122;
        const double var_x157 = 0.014193066924392391 * var_x25;
        const double var_x158 = 546.80157330154941 * var_x24 * var_x25;
        const double var_x159 = var_x149 * var_x25 * var_x26 / pow((6.8301345536507063e-5 + var_x26), 2);
        const double var_x160 = pow(var_chaste_interface__cell__sNasl, 2.0);
        const double var_x161 = var_x44 * var_x93;
        const double var_x162 = var_x161 * var_x57 / pow((0.0035899999999999999 + 0.244140625 * var_x59 + 3.0636589236596067e-6 * var_x54 + var_chaste_interface__cell__sCasl), 2);
        const double var_x163 = var_x160 * var_x162;
        const double var_x164 = var_x160 * var_x39 * var_x62;
        const double var_x165 = 9.1428780887586606e-7 * var_x118;
        ...
        const double var_x170 = 61.507432902288151 + var_chaste_interface__cell__sVm;
        const double var_x171 = var_x41 * var_x52;
        const double var_x172 = var_x153 * (-3413921.875 - 373215529.24791092 * var_chaste_interface__cell__sCaj);
        const double var_x173 = 0.53874226280448656 * var_x120;
        ...
        const double var_x179 = var_x41 * var_x62;
        const double var_x180 = var_x162 * (-3413921.875 - 373215529.24791092 * var_chaste_interface__cell__sCasl);
        const double var_x181 = 0.059860251422720709 * var_x116;
        const double var_x182 = var_x161 * var_x5 * var_x55 * var_x60 / pow(var_x56, 2);
        ...
        const double var_x336 = 2814485.1633595931 * var_x335;
        const double var_x337 = pow(var_chaste_interface__cell__sCa_sr, 1.7869999999999999);
        const double var_x338 = 0.38742512113256738 * var_x337;
        ...
        const double var_x342 = (var_x336 - var_x338) / pow((3.5530476870814998e-7 + var_x335 + 1.3765399305573384e-7 * var_x337), 2);
        ...
        const double var_x349 = var_x23 * var_x347;
        const double var_x350 = 0.63946665424931382 * var_x124;
        const double var_x351 = var_x131 * var_x347;
        const double var_x352 = var_x133 * var_x347;
        const double var_x353 = 2.7730746221159828e-6 * var_x112;
        ...
        const double var_x357 = 0.0068117100126557353 * var_x347;
        const double var_x358 = 0.13943570395906291 * var_x127;
        const double var_x359 = 8.3038178962250795e-9 * var_x72;
        ...
        const double var_x363 = var_x135 * var_x347;
        const double var_x364 = 0.19966137279235077 * var_x114;
        ...
        const double var_x370 = 0.00059787488852820574 * var_x96;
        const double var_x371 = var_x370 * var_x64;
        const double var_x372 = 0.54535393106272634 * var_x347;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.010148299999999999 + var_x108 + var_x111 + var_x113 + var_x115 - var_x102 - var_x117 - var_x119 - var_x121 - var_x123 - var_x74 - var_x84 - var_x98 - 0.002 / var_x1 - 0.0035000000000000001 * var_x2 - 0.495 * var_x53 - 23.0 * var_x24 - 1.2537391304347827 * var_x33 - 0.006029375 / var_x4 - 4.0049999999999999 * var_x63 - 0.15495652173913047 * var_x36 - 0.0043287860817742326 * var_x92 - 0.035023814661627885 * var_x94 - 0.048783124999999997 / var_x6 - var_x86 * var_x88 - var_x9 * var_chaste_interface__cell__sxkr - 0.0007393069131627105 * var_x103 * var_x104 - 0.1144 * var_chaste_interface__cell__sxtof * var_chaste_interface__cell__sytof - 0.015599999999999999 * var_chaste_interface__cell__sxtos * var_chaste_interface__cell__sytos - 0.35699999999999998 * var_x12 * var_x20 + 0.085144499999999998 * var_x20 * var_x21 * var_x37 - 0.00033444816053511704 * var_x0 * var_x21 / pow(var_x1, 2) + 0.0014583333333333334 * var_x21 * var_x7 * var_chaste_interface__cell__sxkr / pow(var_x8, 2) + 8.214521257363451e-6 * var_x104 * var_x105 * var_x85 * var_chaste_interface__cell__sVm - 0.34313725490196073 * var_x12 * var_x21 * (0.24326999999999999 * var_x37 - var_x15 * (0.061749999999999999 * var_x17 + 0.039456396800000001 * var_x16) - 0.51429999999999998 * var_x13 * var_x18 / pow(var_x14, 2)) / pow((var_x12 + 0.98039215686274506 * var_x19), 2));
        ...
        IJth(rJacobian, 32, 0) = -var_x348 * (6.567e-5 + var_x102 + var_x123 - var_x113 + 2.5299999999999998 * var_x24 + 1.4850000000000001 * var_x53 + 0.012986358245322698 * var_x92 + 0.46486956521739137 * var_x36);
        IJth(rJacobian, 33, 0) = -var_x357 * (0.00053133 + var_x119 + var_x74 - var_x108 + 20.469999999999999 * var_x24 + 12.015000000000001 * var_x63 + 3.7612173913043483 * var_x33 + 0.10507144398488365 * var_x94);
        IJth(rJacobian, 35, 0) = -var_x362 * (6.0643000000000002e-5 + var_x121 + var_x84 - var_x115 - 0.98999999999999999 * var_x53 - 0.0086575721635484652 * var_x92);
        IJth(rJacobian, 36, 0) = -var_x369 * (0.00049065700000000003 + var_x117 + var_x98 - var_x111 - 0.07004762932325577 * var_x94 - 8.0099999999999998 * var_x63);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-7.5899999999999999 * var_x126 - 61.409999999999997 * var_x128);
        IJth(rJacobian, 1, 1) = -var_x189;
        IJth(rJacobian, 32, 1) = -1.9183999627479413 * var_x126 * var_x347;
        IJth(rJacobian, 33, 1) = -0.41830711187718866 * var_x128 * var_x347;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x129 * var_x23 - var_x130 * var_x23);
        ...
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x133 * var_x134 - var_x133 * var_x137 - var_x133 * var_x139 - var_x135 * var_x136 - var_x135 * var_x138);
        ...
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x134 * var_x141 - var_x136 * var_x142 - var_x137 * var_x141 - var_x138 * var_x142 - var_x139 * var_x141);
        ...
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (0.00019748616671718715 * var_x144 + var_x101 * var_x103 + var_x143 * var_x83);
        IJth(rJacobian, 6, 6) = -0.011900000000000001 - 1.7 * var_chaste_interface__cell__sCaj;
        IJth(rJacobian, 32, 6) = 2.7730746221159828e-6 * var_x100 * var_x355;
        IJth(rJacobian, 35, 6) = 0.19966137279235077 * var_x366 * var_x82;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (2.1942907413020789e-5 * var_x144 + var_x103 * var_x73 + var_x143 * var_x97);
        ...
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x21 * var_x9);
        IJth(rJacobian, 12, 12) = -var_x280;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0070000000000000001 * pow(var_chaste_interface__cell__sxks, 1.0) * (-26.712338705498262 * log(7.9662000000000006 / (120.0 + 0.018329999999999999 * var_chaste_interface__cell__sNai)) + var_chaste_interface__cell__sVm));
        ...
        IJth(rJacobian, 31, 31) = -260.00009932 + var_x333 - var_x334 - 4.6421953480341139e-16 * var_x343 - 0.0036772346118413473 * var_x341;
        IJth(rJacobian, 35, 31) = 0.0064493506493506492 + var_x367;
        IJth(rJacobian, 37, 31) = 2.4996436489414462e-17 * var_x343 + 0.00019800494063761101 * var_x341;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x147 - var_x148 - var_x156 + 1.6579932586131619e-12 * var_x154 - 4.2334955737758471e-5 * var_x150 - 2.673 * var_x155);
        IJth(rJacobian, 17, 32) = 0.0007561 - var_x307;
        IJth(rJacobian, 32, 32) = -0.0007561 + var_x307 - var_x356 - var_x348 * (var_x147 + var_x148 + var_x156 + 8.0190000000000001 * var_x155 + 0.00012700486721327543 * var_x150 - 4.9739797758394858e-12 * var_x154);
        IJth(rJacobian, 33, 32) = 0.087151849242407126 * var_x347;
        IJth(rJacobian, 35, 32) = -var_x362 * (3.3159865172263237e-12 * var_x154 - 5.3460000000000001 * var_x155);
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x157 - var_x158 - var_x165 + 1.3414672728779218e-11 * var_x163 - 21.626999999999999 * var_x164 - 0.00034252827824186399 * var_x159);
        IJth(rJacobian, 18, 33) = 0.000165 - var_x309;
        IJth(rJacobian, 32, 33) = var_x356;
        IJth(rJacobian, 33, 33) = -0.000165 + var_x309 - 7.8855000811034159 * var_x347 - var_x357 * (var_x157 + var_x158 + var_x165 + 64.881 * var_x164 + 0.001027584834725592 * var_x159 - 4.0244018186337653e-11 * var_x163);
        IJth(rJacobian, 34, 33) = var_x361;
        IJth(rJacobian, 36, 33) = -var_x369 * (2.6829345457558435e-11 * var_x163 - 43.253999999999998 * var_x164);
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (-9.4804976667914686e-7 * var_x2 * (15.063643895458313 + 0.002300971605031257 * var_chaste_interface__cell__sNai) / pow((1 + 0.00015275 * var_chaste_interface__cell__sNai), 2));
        ...
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (var_x177 - var_x175 - var_x178 - var_x181 + 10989720.0 * var_x179 - 5.3190528606277995e-13 * var_x180 - 1.8022499999999996e-7 * var_x182 - 0.0048783125000000007 * var_x170 / (pow(var_x6, 2) * pow(var_chaste_interface__cell__sCasl, 2)));
        ...
        IJth(rJacobian, 33, 36) = -var_x357 * (5.4067499999999991e-7 * var_x182 + 1.5957158581883399e-12 * var_x180 - 32969160.0 * var_x179);
        IJth(rJacobian, 35, 36) = var_x368;
        IJth(rJacobian, 36, 36) = -165.10000000000002 + var_x329 + var_x331 - 21.646099331949777 * var_x347 - var_x369 * (var_x175 + var_x178 + var_x181 - var_x177 + 21979440.0 * var_x179 - 1.0638105721255599e-12 * var_x180 - 3.6044999999999992e-7 * var_x182);
        ...
        IJth(rJacobian, 31, 37) = 26713.606559545973 * var_x345 - 3.3723651925989286e-9 * var_x346;
        IJth(rJacobian, 36, 37) = 17.724002759538607 * var_x347;
        IJth(rJacobian, 37, 37) = -7.0788000000000011 + var_x311 + var_x314 + var_x315 + var_x317 + var_x320 + var_x321 + var_x323 - var_x372 + 1.8158889498609616e-10 * var_x346 - 1438.4249685909369 * var_x345;
    }
