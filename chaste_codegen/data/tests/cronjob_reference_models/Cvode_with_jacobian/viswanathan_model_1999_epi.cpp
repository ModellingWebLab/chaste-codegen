...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellviswanathan_model_1999_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x0 = pow(var_chaste_interface__ionic_concentrations__Nai, 3.0);
        const double var_x1 = 0.018717941753901311 * var_chaste_interface__membrane__V;
        const double var_x2 = exp(var_x1);
        const double var_x3 = var_x0 * var_x2;
        const double var_x4 = exp(-var_x1);
        const double var_x5 = var_x4 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x6 = 0.033692295157022364 * var_x3 + 43050.667059836895 * var_x5;
        const double var_x7 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x8 = 1 / (1.0 + 2299.9679999999998 * var_chaste_interface__calcium_dynamics__Cai + 0.0018000000000000002 * var_x0);
        const double var_x9 = var_x7 * var_x8;
        const double var_x10 = 0.002 * var_x9;
        const double var_x11 = -var_x10 * var_x6;
        const double var_x12 = pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2);
        const double var_x13 = 0.050000000000000003 * var_x12;
        const double var_x14 = var_x13 * var_chaste_interface__T_type_Ca_channel_g_gate__g;
        const double var_x15 = var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        const double var_x16 = 1 / var_chaste_interface__calcium_dynamics__Cai;
        const double var_x17 = pow(var_x16, 1.3999999999999999);
        const double var_x18 = 1.0 + 6.4818210260626455e-7 * var_x17;
        const double var_x19 = 0.25979999999999998 / var_x18;
        const double var_x20 = 0.433 + var_x19;
        const double var_x21 = 1.0 * var_x20;
        const double var_x22 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x23 = pow(var_x22, 2.0);
        const double var_x24 = 1 / (1.0 + 100.0 * var_x23);
        const double var_x25 = exp(-0.003743588350780262 * var_chaste_interface__membrane__V);
        const double var_x26 = 0.037435883507802623 * var_chaste_interface__membrane__V;
        const double var_x27 = (-0.14285714285714285 + 0.14285714285714285 * exp(1.961367013372957)) * exp(-var_x26);
        const double var_x28 = 1.0 + 0.1245 * var_x25 + 0.036499999999999998 * var_x27;
        const double var_x29 = var_x24 * (0.0013664097480347956 * var_x27 + 0.00046607674967214262 * var_x25) / pow(var_x28, 2);
        const double var_x30 = 1 / (1.0 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x31 = var_x30 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x32 = var_x31 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x33 = exp(0.074871767015605245 * var_chaste_interface__membrane__V);
        const double var_x34 = -1.0 + var_x33;
        const double var_x35 = 1 / var_x34;
        const double var_x36 = var_x33 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x37 = -0.61380000000000001 + 1.0 * var_x36;
        const double var_x38 = var_x35 * var_x37;
        const double var_x39 = 7.8019226357407252 * var_x38;
        const double var_x40 = var_x32 * var_x39;
        const double var_x41 = var_x32 * var_chaste_interface__membrane__V;
        const double var_x42 = var_x33 * var_x41;
        const double var_x43 = 0.58414373385695639 * var_x37 * var_x42 / pow(var_x34, 2);
        const double var_x44 = 0.58414373385695639 * var_x35 * var_x36 * var_x41;
        const double var_x45 = var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x46 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0);
        const double var_x47 = 16.0 * var_x46;
        const double var_x48 = exp(var_x26);
        const double var_x49 = -1.0 + var_x48;
        const double var_x50 = 1 / var_x49;
        const double var_x51 = var_x32 * var_x50;
        const double var_x52 = 0.75 * var_x48;
        ...
        const double var_x55 = var_x41 * var_x48 / pow(var_x49, 2);
        const double var_x56 = var_x51 * var_chaste_interface__membrane__V;
        const double var_x57 = var_x48 * var_x56;
        const double var_x58 = -var_x45 * var_x47 - var_x51 * var_x54 + 9.127245841514943e-5 * var_x53 * var_x55 - 6.8454343811362076e-5 * var_x57 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x59 = exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V);
        const double var_x60 = 1.0 + var_x59;
        const double var_x61 = 1 / var_x60;
        const double var_x62 = exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V);
        const double var_x63 = 1.0 + var_x62;
        const double var_x64 = 1 / var_x63;
        const double var_x65 = 0.023862446088641735 * var_x64;
        const double var_x66 = 1 / var_chaste_interface__ionic_concentrations__Ki;
        const double var_x67 = log(4.5 * var_x66);
        const double var_x68 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * var_x67);
        const double var_x69 = 1.0 + var_x68;
        const double var_x70 = 1 / var_x69;
        const double var_x71 = exp(-2.4444678999999998 + 13.738155796237757 * var_x67 - 0.51429999999999998 * var_chaste_interface__membrane__V);
        const double var_x72 = 1.0 + var_x71;
        const double var_x73 = 1 / var_x72;
        const double var_x74 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * var_x67);
        const double var_x75 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645179 * var_x67);
        const double var_x76 = var_x75 + 0.49124000000000001 * var_x74;
        const double var_x77 = var_x73 * var_x76;
        const double var_x78 = 1 / (1000.0 * var_x77 + 1020.0 * var_x70);
        const double var_x79 = var_x70 * var_x78;
        const double var_x80 = -26.712338705498265 * var_x67 + var_chaste_interface__membrane__V;
        const double var_x81 = var_x68 / pow(var_x69, 2);
        const double var_x82 = var_x78 * var_x80;
        const double var_x83 = 1000.0 * var_x73;
        const double var_x84 = var_x71 * var_x76 / pow(var_x72, 2);
        const double var_x85 = 0.00067122862439358583 * var_x70 * var_x80 / pow((var_x70 + 0.98039215686274506 * var_x77), 2);
        const double var_x86 = -3.375 + var_x52 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x87 = 0.00069711623550831479 * var_x86;
        const double var_x88 = -698.34626081908675 * var_x79 - 0.0055199999999999997 * var_x61 - var_x51 * var_x87 - var_x65 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr - var_x85 * (243.26999999999998 * var_x81 - 514.29999999999995 * var_x84 - var_x83 * (0.061749999999999999 * var_x75 + 0.039456396800000001 * var_x74)) + 166.55558320535218 * var_x81 * var_x82 + 2.6097162183887171e-5 * var_x55 * var_x86 - 1.9572871637915377e-5 * var_x57 * var_chaste_interface__ionic_concentrations__Ki - 0.00092307692307692305 * var_x59 * var_x80 / pow(var_x60, 2) + 0.0010652877718143631 * var_x62 * var_x80 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / pow(var_x63, 2);
        const double var_x89 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__membrane__V;
        const double var_x90 = var_x89 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x91 = var_x50 * var_x90;
        const double var_x92 = 1.462860494201386e-6 * var_x53 * var_x91;
        const double var_x93 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x94 = 1 / var_x93;
        const double var_x95 = 1.1499999999999999 * var_x94;
        const double var_x96 = 0.040282206767891383 * var_x16;
        const double var_x97 = 1.1499999999999999 * var_chaste_interface__calcium_dynamics__Cai / pow(var_x93, 2);
        const double var_x98 = var_x12 * var_chaste_interface__T_type_Ca_channel_g_gate__g;
        const double var_x99 = 0.66780846763745672 * var_x16 * var_x98;
        const double var_x100 = 0.0046811535814444347 * var_x38 * var_x90;
        const double var_x101 = 7.8019226357407252 * var_x35 * var_x42;
        const double var_x102 = 1 / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki);
        const double var_x103 = -26.712338705498265 * log(6.9195599999999997 * var_x102) + var_chaste_interface__membrane__V;
        const double var_x104 = 4.1826974130498884e-7 * var_x86 * var_x91 - 2.3575679435995049e-7 * var_x103 * var_x15 * var_x16 * var_x17 / pow(var_x18, 2);
        const double var_x105 = var_x4 * var_x9;
        const double var_x106 = 1.8 * var_x3 - 2299968.0 * var_x5;
        const double var_x107 = var_x106 * var_x8 / pow((0.0068999999999999999 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x108 = var_x106 * var_x7 / pow((0.00043478865792915384 + 7.8261958427247698e-7 * var_x0 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x109 = 4599.9359999999997 * var_x105 + 1.38e-5 * var_x107 + 8.6957731585830768e-7 * var_x108;
        const double var_x110 = log(132.0 * var_x22);
        const double var_x111 = -26.712338705498265 * var_x110 + var_chaste_interface__membrane__V;
        const double var_x112 = var_x111 * var_x45;
        const double var_x113 = var_x112 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0);
        const double var_x114 = var_x111 * var_x47;
        const double var_x115 = var_x31 * var_chaste_interface__membrane__V;
        const double var_x116 = var_x115 * var_x50;
        const double var_x117 = var_x30 * var_x89;
        const double var_x118 = var_x117 * var_x50;
        const double var_x119 = log(1.8 * var_x16);
        const double var_x120 = -13.356169352749133 * var_x119 + var_chaste_interface__membrane__V;
        const double var_x121 = var_x120 * var_chaste_interface__T_type_Ca_channel_b_gate__b * var_chaste_interface__T_type_Ca_channel_g_gate__g;
        const double var_x122 = var_x103 * var_x21;
        const double var_x123 = var_x15 * var_x20;
        const double var_x124 = 0.48963716847178318 * var_x102;
        const double var_x125 = 1 / var_x28;
        const double var_x126 = var_x125 * var_x22 * var_x23 / pow((0.01 + var_x23), 2);
        const double var_x127 = pow(var_chaste_interface__ionic_concentrations__Nai, 2.0);
        const double var_x128 = var_x108 * var_x127;
        const double var_x129 = var_x127 * var_x2 * var_x9;
        const double var_x130 = 2.0416447122894156e-12 * var_x128 - 0.010800000000000001 * var_x129;
        const double var_x131 = -0.10684935482199306 * var_x22 - 0.0018285756177517324 * var_x57 - 427.39741928797224 * var_x22 * var_x45 * var_x46;
        const double var_x132 = 26.712338705498265 * var_x102;
        const double var_x133 = var_x64 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr;
        const double var_x134 = var_x66 * var_x81;
        const double var_x135 = -7.3656881518639841e-7 * var_x66 - 0.00052283717663123607 * var_x57 - var_x85 * (6498.3106368865629 * var_x134 - var_x83 * (1.6494869150645179 * var_x66 * var_x75 + 1.053972635420138 * var_x66 * var_x74) - 13738.155796237757 * var_x66 * var_x84) + 4449.089151873166 * var_x134 * var_x82 - 18654.461852717679 * var_x66 * var_x79 - 0.14745210965435041 * var_x61 * var_x66 - 0.63742174226149029 * var_x133 * var_x66;
        const double var_x136 = 0.003016 + var_x11 + var_x14 + var_x40 + var_x44 - var_x43;
        const double var_x137 = 0.0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x138 = 1.0 + 0.00011900000000000002 * pow(var_x137, (-2.0)) + 3.5000000000000004e-5 * pow(var_x93, (-2.0));
        const double var_x139 = 1 / var_x138;
        const double var_x140 = 1 / M_PI;
        const double var_x141 = var_x139 * var_x140;
        const double var_x142 = 9.0316078310111346e-5 * var_x141;
        const double var_x143 = 0.00062 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x144 = 1 / var_x143;
        const double var_x145 = -0.00018000000000000001 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x146 = var_x144 * var_x145 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x147 = 1.0 - var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x148 = 423.5294117647058 * var_x147;
        const double var_x149 = var_x146 * var_x148;
        const double var_x150 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x151 = 1 / var_x150;
        const double var_x152 = 0.40588235294117642 * var_x151;
        const double var_x153 = var_chaste_interface__calcium_dynamics__Cai / pow(var_x150, 2);
        const double var_x154 = var_x101 + var_x109 + var_x95 + var_x96 + var_x99 - var_x100 - var_x97;
        const double var_x155 = 0.090316078310111347 * var_x140;
        const double var_x156 = -var_x152 + 0.40588235294117642 * var_x153 - var_x154 * var_x155;
        const double var_x157 = 0.001 * var_x139;
        const double var_x158 = -var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x159 = 0.02705882352941176 * var_chaste_interface__calcium_dynamics__Ca_NSR - var_x152 * var_chaste_interface__calcium_dynamics__Cai - var_x155 * (0.003016 * var_chaste_interface__membrane__V - 0.040282206767891383 * var_x119 + var_x120 * var_x14 + var_x40 * var_chaste_interface__membrane__V + var_x95 * var_chaste_interface__calcium_dynamics__Cai - var_x10 * var_x106);
        const double var_x160 = 0.001 * (0.00023800000000000004 * pow(var_x137, (-3.0)) + 7.0000000000000007e-5 * pow(var_x93, (-3.0))) / pow(var_x138, 2);
        const double var_x161 = var_chaste_interface__calcium_dynamics__Cainfluxtrack > 0.00018000000000000001;
        const double var_x162 = -1.0 + var_chaste_interface__calcium_dynamics__OVRLDtrack2;
        const double var_x163 = 28.235294117647054 * var_chaste_interface__calcium_dynamics__OVRLDtrack2;
        const double var_x164 = 1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2;
        const double var_x165 = var_x158 * var_x164;
        const double var_x166 = var_chaste_interface__calcium_dynamics__OVRLDtrack2 > 0.0;
        const double var_x167 = var_x115 * var_x38;
        const double var_x168 = 0.00070463905573898966 * var_x141;
        const double var_x169 = var_x117 * var_x38;
        const double var_x170 = var_x12 * var_x120;
        const double var_x171 = var_x146 * var_x147;
        const double var_x172 = var_x144 * var_x158;
        const double var_x173 = var_x148 * var_x172;
        const double var_x174 = var_x146 * var_x158;
        const double var_x175 = var_x145 * var_x158 * var_chaste_interface__calcium_dynamics__APtrack2 / pow(var_x143, 2);
        const double var_x176 = -var_chaste_interface__calcium_dynamics__Ca_JSR + var_chaste_interface__calcium_dynamics__Cai;
        ...
        const double var_x180 = exp(-4.7130000000000001 + var_x179);
        const double var_x181 = 1.0 - var_x180;
        const double var_x182 = 0.32000000000000001 / var_x181;
        const double var_x183 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
        const double var_x184 = 0.0072727272727272727 * var_x183 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x185 = 47.130000000000003 + var_chaste_interface__membrane__V;
        const double var_x186 = fabs(var_x185) >= 1.0000000000000001e-5;
        const double var_x187 = -0.080000000000000002 * var_x183;
        const double var_x188 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
        const double var_x189 = exp(0.34999999999999998 * var_chaste_interface__membrane__V);
        const double var_x190 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x191 = var_chaste_interface__membrane__V < -40.0;
        const double var_x192 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x193 = 1.0 + var_x192;
        const double var_x194 = 1.0 - var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x195 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
        const double var_x196 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x197 = -127140.0 * var_x195 - 3.4740000000000003e-5 * var_x196;
        const double var_x198 = var_x194 * var_x197;
        const double var_x199 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
        const double var_x200 = 1.0 + var_x199;
        const double var_x201 = 1.0 / var_x200;
        const double var_x202 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x203 = 1.0 + var_x202;
        const double var_x204 = exp(-0.01052 * var_chaste_interface__membrane__V);
        const double var_x205 = var_x204 / var_x203;
        const double var_x206 = 37.780000000000001 + var_chaste_interface__membrane__V;
        const double var_x207 = var_x201 * var_x206;
        const double var_x208 = exp(-3.2000000000000002 + var_x179);
        const double var_x209 = 1.0 + var_x208;
        const double var_x210 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V);
        const double var_x211 = var_x210 / var_x209;
        const double var_x212 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x213 = exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V);
        const double var_x214 = var_x212 * var_x213;
        const double var_x215 = 1.0 + var_x213;
        const double var_x216 = 0.035000000000000003 / pow(var_x215, 2);
        const double var_x217 = var_x213 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x218 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x219 = fabs(var_x218) < 1.0000000000000001e-5;
        const double var_x220 = 1.0 - var_x213;
        const double var_x221 = 1 / var_x220;
        const double var_x222 = 0.035000000000000003 * var_x221;
        const double var_x223 = 1 / var_x215;
        const double var_x224 = 1.0 - 1.0 * var_x223;
        const double var_x225 = var_x215 * var_x224;
        const double var_x226 = 0.005608974358974359 * var_x218;
        const double var_x227 = var_x226 / pow(var_x220, 2);
        const double var_x228 = var_x217 * var_x221 * var_x226;
        const double var_x229 = var_x218 * var_x222;
        const double var_x230 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x231 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V);
        const double var_x232 = 1.0 + var_x231;
        const double var_x233 = 0.029999999999999999 * var_x231 / pow(var_x232, 2);
        const double var_x234 = exp(4.0 + 0.125 * var_chaste_interface__membrane__V);
        const double var_x235 = 1.0 + var_x234;
        const double var_x236 = 0.125 * var_x234 / pow(var_x235, 2);
        const double var_x237 = 1 + var_x178;
        const double var_x238 = exp(-0.113569 * pow(var_x237, 2.0));
        const double var_x239 = 0.02 + 0.019699999999999999 * var_x238;
        const double var_x240 = 1.0 / var_x235;
        const double var_x241 = 0.59999999999999998 / var_x232;
        const double var_x242 = -var_x240 - var_x241;
        const double var_x243 = 1.0 + var_x242;
        const double var_x244 = 0.00044746186000000005 * var_x238 * pow(var_x237, 1.0);
        const double var_x245 = exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__membrane__V);
        const double var_x246 = 1.0 + var_x245;
        const double var_x247 = exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__membrane__V);
        const double var_x248 = 1.0 + var_x247;
        const double var_x249 = 1 / var_x248;
        const double var_x250 = 1 / (0.0037000000000000002 + 0.0061000000000000004 * var_x249);
        const double var_x251 = exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__membrane__V);
        const double var_x252 = 1.0 + var_x251;
        const double var_x253 = 1 / (0.012 - 0.00087500000000000002 * var_chaste_interface__membrane__V);
        const double var_x254 = var_x251 / pow(var_x252, 2);
        const double var_x255 = var_chaste_interface__membrane__V <= 0.0;
        ...
        const double var_x258 = exp(-1.7465999999999999 - 0.123 * var_chaste_interface__membrane__V);
        const double var_x259 = 1.0 - var_x258;
        const double var_x260 = 1 / var_x259;
        const double var_x261 = 1.3799999999999999 * var_x260;
        const double var_x262 = exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__membrane__V);
        const double var_x263 = -1.0 + var_x262;
        const double var_x264 = 1 / var_x263;
        const double var_x265 = 0.60999999999999999 * var_x264;
        const double var_x266 = 38.899999999999999 + var_chaste_interface__membrane__V;
        const double var_x267 = 14.199999999999999 + var_chaste_interface__membrane__V;
        ...
        const double var_x282 = 5.9880239520958083e-5 * var_x268 / pow(var_x269, 2);
        const double var_x283 = var_x273 * var_x279;
        const double var_x284 = var_x277 * var_x279;
        ...
        const double var_x291 = 10000.0 * var_x290;
        const double var_x292 = exp(-3.6000000000000001 - var_x287);
        const double var_x293 = 1.0 + var_x292;
        const double var_x294 = var_x292 / var_x293;
        const double var_x295 = var_x291 + 10000.0 * var_x294;
        const double var_x296 = 1 / var_x295;
        const double var_x297 = 400.0 * var_x290;
        const double var_x298 = 0.080000000000000002 * var_chaste_interface__membrane__V;
        const double var_x299 = 400.0 * exp(-7.2000000000000002 - var_x298) / pow(var_x293, 2);
        const double var_x300 = 400.0 * exp(-3.2000000000000002 + var_x298) / pow(var_x289, 2);
        const double var_x301 = 400.0 * var_x294;
        const double var_x302 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x303 = exp(12.0 + var_x302);
        const double var_x304 = 1.0 + var_x303;
        const double var_x305 = 1 / var_x304;
        const double var_x306 = 15.0 * var_x305;
        const double var_x307 = exp(5.0 + var_x302);
        const double var_x308 = 1.0 + var_x307;
        const double var_x309 = var_x307 / var_x308;
        const double var_x310 = var_x306 + 100.0 * var_x309;
        const double var_x311 = 1 / var_x310;
        const double var_x312 = 20.0 * var_x309;
        const double var_x313 = 3.0 * var_x303 / pow(var_x304, 2);
        const double var_x314 = 20.0 * exp(10.0 + 0.40000000000000002 * var_chaste_interface__membrane__V) / pow(var_x308, 2);
        const double var_x315 = 0.80000000000000004 + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x316 = pow(var_x315, (-2.0));
        const double var_x317 = 1 / (1.0 + 8.0 * var_x316);
        const double var_x318 = 60000.0 * var_x147;
        const double var_x319 = 0.001 * var_x317;
        const double var_x320 = 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x321 = 0.00025000000000000001 * pow(var_x315, (-3.0)) / pow((0.125 + var_x316), 2);
        const double var_x322 = 4000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2;
        const double var_x323 = 0.0055555555555555558 * var_x317;
        const double var_x324 = var_x172 * var_x318;
        const double var_x325 = (var_chaste_interface__calcium_dynamics__APtrack > 0.17999999999999999) && (var_chaste_interface__calcium_dynamics__APtrack < 0.20000000000000001);
        const double var_x326 = 9.0316078310111346e-5 * var_x140;
        const double var_x327 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
        const double var_x328 = 0.00070463905573898966 * var_x140;
        const double var_x329 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        const double var_x330 = 0.00018063215662022269 * var_x140;
        const double var_x331 = 0.0028901145059235631 * var_x111 * var_x140 * var_x46;
        const double var_x332 = var_x116 * var_x140;
        const double var_x333 = 4.4039940983686853e-7 * var_x53;
        const double var_x334 = var_x118 * var_x140;
        const double var_x335 = -0.433 - var_x19;
        const double var_x336 = var_x15 * var_x335;
        const double var_x337 = 1.2592160903483795e-7 * var_x86;
        const double var_x338 = var_x103 * var_x330 * var_x335;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0070160275741043615 + var_x11 + var_x43 + var_x58 + var_x88 - var_x14 - var_x40 - var_x44 - 1.5 * var_x29 - var_x15 * var_x21);
        IJth(rJacobian, 1, 0) = -var_x136 * var_x142;
        IJth(rJacobian, 2, 0) = ((var_x186) ? (var_x184 + var_x177 * var_x182 - 0.032000000000000001 * var_x177 * var_x180 * var_x185 / pow(var_x181, 2)) : (var_x184));
        IJth(rJacobian, 3, 0) = ((var_x191) ? (-0.001 * (281.24000000000001 * var_x188 + 108500000.0 * var_x189) * var_chaste_interface__fast_sodium_current_h_gate__h - 0.019852941176470591 * var_x190 * (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h)) : (-0.69300069300069322 * var_x192 * var_chaste_interface__fast_sodium_current_h_gate__h / pow(var_x193, 2)));
        IJth(rJacobian, 4, 0) = ((var_x191) ? (var_x198 * var_x201 + 0.001275024 * var_x205 * var_chaste_interface__fast_sodium_current_j_gate__j + var_x194 * var_x207 * (1.5254334000000001e-6 * var_x196 - 31073.016 * var_x195) - 0.311 * var_x198 * var_x199 * var_x206 / pow(var_x200, 2) - 0.016701360000000002 * var_x202 * var_x204 * var_chaste_interface__fast_sodium_current_j_gate__j / pow(var_x203, 2)) : (7.6049999999999996e-8 * var_x211 * var_chaste_interface__fast_sodium_current_j_gate__j - 0.029999999999999999 * var_x208 * var_x210 * var_chaste_interface__fast_sodium_current_j_gate__j / pow(var_x209, 2)));
        IJth(rJacobian, 5, 0) = ((var_x219) ? (var_x214 * var_x216 + var_x216 * var_x217) : (var_x212 * var_x222 + var_x223 * var_x228 + var_x224 * var_x228 - var_x214 * var_x227 + var_x217 * var_x225 * var_x227 - var_x222 * var_x225 * var_chaste_interface__L_type_Ca_channel_d_gate__d));
        IJth(rJacobian, 6, 0) = var_x230 * var_x239 * (var_x233 - var_x236) + var_x243 * var_x244 * var_chaste_interface__L_type_Ca_channel_f_gate__f - var_x230 * var_x244 * (var_x240 + var_x241) - var_x239 * (var_x236 - var_x233) * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 7, 0) = 9.2592592592592588e-5 * var_x245 * var_x250 / pow(var_x246, 2) + 0.036429872495446262 * var_x247 * (-var_chaste_interface__T_type_Ca_channel_b_gate__b + 1.0 / var_x246) / (pow(var_x248, 2) * pow((0.60655737704918034 + var_x249), 2));
        IJth(rJacobian, 8, 0) = ((var_x255) ? (0.006076388888888889 * (-var_chaste_interface__T_type_Ca_channel_g_gate__g + 1.0 / var_x252) / pow((1 - 0.072916666666666671 * var_chaste_interface__membrane__V), 2) - 0.00017857142857142857 * var_x253 * var_x254) : (-0.01488095238095238 * var_x254));
        IJth(rJacobian, 9, 0) = 0.001 * (-var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr + 1.0 / var_x257) * (var_x261 + var_x265 - 0.088449999999999987 * var_x262 * var_x266 / pow(var_x263, 2) - 0.16973999999999997 * var_x258 * var_x267 / pow(var_x259, 2)) + 0.00013333333333333334 * var_x256 * (var_x261 * var_x267 + var_x265 * var_x266) / pow(var_x257, 2);
        IJth(rJacobian, 10, 0) = var_x282 * (var_x274 * var_x279 + var_x278 * var_x279) + 0.001 * (var_x270 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1) * (var_x274 + var_x278 - 0.0089996999999999994 * var_x280 - 0.010641199999999998 * var_x281);
        IJth(rJacobian, 11, 0) = var_x282 * (var_x279 * var_x285 + var_x279 * var_x286) + 0.001 * (var_x270 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2) * (var_x285 + var_x286 - 0.0022499249999999998 * var_x280 - 0.0026602999999999996 * var_x281);
        IJth(rJacobian, 12, 0) = 0.001 * var_x295 * (var_x296 * var_x297 - var_x296 * var_x300 + 0.0001 * var_x290 * (var_x300 + var_x301 - var_x297 - var_x299) / pow((var_x290 + var_x294), 2)) + 0.001 * (-var_chaste_interface__transient_outward_current_zdv_gate__zdv + var_x291 * var_x296) * (var_x297 + var_x299 - var_x300 - var_x301);
        IJth(rJacobian, 13, 0) = 0.001 * var_x310 * (-var_x311 * var_x313 + 0.0015 * var_x305 * (var_x313 + var_x314 - var_x312) / pow((var_x309 + 0.14999999999999999 * var_x305), 2)) + 0.001 * (-var_chaste_interface__transient_outward_current_ydv_gate__ydv + var_x306 * var_x311) * (var_x312 - var_x313 - var_x314);
        IJth(rJacobian, 19, 0) = ((var_x327) ? (-var_x136 * var_x326) : (0));
        IJth(rJacobian, 23, 0) = var_x330 * (-0.0040000000000000001 + var_x58 - 4.5 * var_x29 - 0.0060000000000000001 * var_x6 * var_x9);
        IJth(rJacobian, 24, 0) = var_x330 * (-2.7574104360798206e-8 + var_x336 + var_x88 + 3.0 * var_x29);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x100 + var_x104 + var_x109 + var_x92 + var_x97 - var_x101 - var_x95 - var_x96 - var_x99);
        IJth(rJacobian, 1, 1) = ((var_x161) ? (var_x157 * (var_x156 - var_x149) + var_x160 * (var_x159 + var_x149 * var_x158)) : ((var_x166) ? (var_x157 * (var_x156 + var_x162 * var_x163) + var_x160 * (var_x159 + var_x163 * var_x165)) : (var_x156 * var_x157 + var_x159 * var_x160)));
        IJth(rJacobian, 14, 1) = ((var_x161) ? (60.0 * var_x171 * var_x317) : ((var_x166) ? (-4.0 * var_x162 * var_x317 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        IJth(rJacobian, 15, 1) = 0.0050000000000000001 * var_x151 - 0.0050000000000000001 * var_x153;
        IJth(rJacobian, 19, 1) = ((var_x327) ? (-var_x154 * var_x326) : (0));
        IJth(rJacobian, 23, 1) = var_x330 * (var_x92 + 2.6087319475749228e-6 * var_x108 + 4.1399999999999997e-5 * var_x107 + 13799.808000000001 * var_x105);
        IJth(rJacobian, 24, 1) = var_x104 * var_x330;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-48.0 * var_x113);
        IJth(rJacobian, 2, 2) = ((var_x186) ? (var_x187 - var_x182 * var_x185) : (-3.2000000000000002 + var_x187));
        IJth(rJacobian, 23, 2) = -0.0086703435177706897 * var_x113 * var_x140;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x114 * var_chaste_interface__fast_sodium_current_j_gate__j);
        IJth(rJacobian, 3, 3) = ((var_x191) ? (-0.13500000000000001 * var_x190 - 310000.0 * var_x189 - 3.5600000000000001 * var_x188) : (-7.6923076923076934 / var_x193));
        IJth(rJacobian, 23, 3) = -var_x331 * var_chaste_interface__fast_sodium_current_j_gate__j;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x114 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 4, 4) = ((var_x191) ? (-0.1212 * var_x205 - var_x197 * var_x207) : (-0.29999999999999999 * var_x211));
        IJth(rJacobian, 23, 4) = -var_x331 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x115 * var_x39 - var_x116 * var_x54 - var_x116 * var_x87);
        IJth(rJacobian, 1, 5) = -var_x167 * var_x168;
        IJth(rJacobian, 5, 5) = ((var_x219) ? (-0.21840000000000004) : (-var_x229 - var_x225 * var_x229));
        IJth(rJacobian, 19, 5) = ((var_x327) ? (-var_x167 * var_x328) : (0));
        IJth(rJacobian, 23, 5) = -var_x332 * var_x333;
        IJth(rJacobian, 24, 5) = -var_x332 * var_x337;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x117 * var_x39 - var_x118 * var_x54 - var_x118 * var_x87);
        IJth(rJacobian, 1, 6) = -var_x168 * var_x169;
        IJth(rJacobian, 6, 6) = var_x239 * var_x242 - var_x239 * var_x243;
        IJth(rJacobian, 19, 6) = ((var_x327) ? (-var_x169 * var_x328) : (0));
        IJth(rJacobian, 23, 6) = -var_x333 * var_x334;
        IJth(rJacobian, 24, 6) = -var_x334 * var_x337;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.10000000000000001 * var_x121);
        IJth(rJacobian, 1, 7) = -9.0316078310111353e-6 * var_x121 * var_x141;
        IJth(rJacobian, 7, 7) = -0.001 * var_x250;
        IJth(rJacobian, 19, 7) = ((var_x327) ? (-9.0316078310111353e-6 * var_x121 * var_x140) : (0));
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x120 * var_x13);
        IJth(rJacobian, 1, 8) = -4.5158039155055676e-6 * var_x141 * var_x170;
        IJth(rJacobian, 8, 8) = ((var_x255) ? (-0.001 * var_x253) : (-0.083333333333333329));
        IJth(rJacobian, 19, 8) = ((var_x327) ? (-4.5158039155055676e-6 * var_x140 * var_x170) : (0));
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * var_x80);
        IJth(rJacobian, 9, 9) = -0.00060999999999999997 * var_x264 * var_x266 - 0.0013799999999999999 * var_x260 * var_x267;
        IJth(rJacobian, 24, 9) = -4.3103250992251546e-6 * var_x140 * var_x64 * var_x80;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x122 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2);
        IJth(rJacobian, 10, 10) = -0.00013100000000000001 * var_x283 - 7.1899999999999999e-5 * var_x284;
        IJth(rJacobian, 24, 10) = var_x338 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x122 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1);
        IJth(rJacobian, 11, 11) = -3.2750000000000003e-5 * var_x283 - 1.7975e-5 * var_x284;
        IJth(rJacobian, 24, 11) = var_x338 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
        IJth(rJacobian, 12, 12) = -10.0 * var_x290 - 10.0 * var_x294;
        IJth(rJacobian, 13, 13) = -0.014999999999999999 * var_x305 - 0.10000000000000001 * var_x309;
        IJth(rJacobian, 1, 14) = ((var_x161) ? (0.42352941176470582 * var_x139 * var_x171) : ((var_x166) ? (0.028235294117647056 * var_x139 * var_x164 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        IJth(rJacobian, 14, 14) = ((var_x161) ? (var_x319 * (-5.5555555555555554 - var_x146 * var_x318) + var_x321 * (var_x320 - var_x174 * var_x318)) : ((var_x166) ? (var_x319 * (-5.5555555555555554 - var_x164 * var_x322) + var_x321 * (var_x320 - var_x165 * var_x322)) : (-var_x323 + var_x320 * var_x321)));
        IJth(rJacobian, 15, 14) = 0.00048309178743961346;
        IJth(rJacobian, 1, 15) = 2.7058823529411762e-5 * var_x139;
        IJth(rJacobian, 14, 15) = var_x323;
        IJth(rJacobian, 15, 15) = -0.00081642512077294684;
        IJth(rJacobian, 16, 16) = ((7.0160275741043607 * var_chaste_interface__membrane__V - 0.00073656881518639836 * var_x67 - 40.282206767891381 * var_x119 - 106.84935482199306 * var_x110 + 2.0 * var_x106 * var_x9 + 50.0 * var_x120 * var_x98 + 1000.0 * var_x103 * var_x123 + 1000.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 16000.0 * var_x112 * var_x46 + 1500.0 * var_x125 * var_x24 + 1150.0 * var_x94 * var_chaste_interface__calcium_dynamics__Cai + 5.5199999999999996 * var_x61 * var_x80 + 23.862446088641732 * var_x133 * var_x80 + 2.4381008236689765 * var_x53 * var_x56 + 698346.26081908669 * var_x79 * var_x80 + 0.69711623550831481 * var_x56 * var_x86 + 7801.9226357407251 * var_x38 * var_x41 < -150000.0) ? (-100.5) : (-0.5));
        IJth(rJacobian, 1, 17) = ((var_x161) ? (var_x157 * (-423.5294117647058 * var_x174 + var_x145 * var_x173)) : (0));
        IJth(rJacobian, 14, 17) = ((var_x161) ? (var_x319 * (60000.0 * var_x174 - var_x145 * var_x324)) : (0));
        IJth(rJacobian, 17, 17) = ((var_x325) ? (-100.5) : (-0.5));
        IJth(rJacobian, 18, 18) = ((var_x325) ? (-100.5) : (-0.01));
        IJth(rJacobian, 1, 19) = ((var_x161) ? (var_x157 * (var_x173 * var_chaste_interface__calcium_dynamics__APtrack2 - var_x148 * var_x175)) : (0));
        IJth(rJacobian, 14, 19) = ((var_x161) ? (var_x319 * (var_x175 * var_x318 - var_x324 * var_chaste_interface__calcium_dynamics__APtrack2)) : (0));
        IJth(rJacobian, 19, 19) = (((var_x327) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 1, 21) = ((var_x161) ? (0) : ((var_x166) ? (var_x157 * (28.235294117647054 * var_x165 + var_x163 * var_x176)) : (0)));
        IJth(rJacobian, 14, 21) = ((var_x161) ? (0) : ((var_x166) ? (var_x319 * (-4000.0 * var_x165 - var_x176 * var_x322)) : (0)));
        IJth(rJacobian, 21, 21) = (((var_x329) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50.0) : (-0.5));
        IJth(rJacobian, 22, 22) = (((var_x329) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50.0) : (-0.01));
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (var_x130 + var_x131 - 0.029999999999999999 * var_x126 - var_x123 * var_x124);
        IJth(rJacobian, 1, 23) = -var_x130 * var_x142;
        IJth(rJacobian, 19, 23) = ((var_x327) ? (-var_x130 * var_x326) : (0));
        IJth(rJacobian, 23, 23) = var_x330 * (var_x131 + 6.1249341368682459e-12 * var_x128 - 0.032399999999999998 * var_x129 - 0.089999999999999997 * var_x126);
        IJth(rJacobian, 24, 23) = var_x330 * (0.059999999999999998 * var_x126 + var_x124 * var_x336);
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (var_x135 - var_x123 * var_x132);
        IJth(rJacobian, 24, 24) = var_x330 * (var_x135 + var_x132 * var_x336);
    }
