...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 0) = 001; // (var_membrane__Cm) [microF]
    }
    ...
    void Cellviswanathan_model_1999_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x127 = 016 * var_x100;
        ...
        const double var_x146 = 010800000000000001 * var_x145;
        ...
        const double var_x161 = 003016 + var_x99 - var_x55;
        ...
        const double var_x189 = 00070463905573898956 * var_x166;
        ...
        const double var_x192 = var_x184 * (0070588235294117632 * var_chaste_interface__calcium_dynamics__Ca_JSR - 0070588235294117632 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x193 = 60000 * var_x171 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x194 = ((var_x177) ? (var_x173 * var_x193 - var_x174 * var_x193 / pow(var_x172, 2)) : (0));
        const double var_x195 = ((var_x177) ? (0) : ((var_x178) ? (4000 - 8000 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        ...
        const double var_x204 = 001 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x211 = 001 * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x241 = 00016025641025641026 * var_x228 * var_x240 / pow(var_x229, 2);
        ...
        const double var_x244 = 001 - 001 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x245 = exp(2.5 - 050000000000000003 * var_chaste_interface__membrane__V);
        const double var_x246 = 1.0 + var_x245;
        const double var_x247 = 029999999999999999 * var_x245 / pow(var_x246, 2);
        ...
        const double var_x256 = -022713800000000003 - 0022713799999999999 * var_chaste_interface__membrane__V;
        const double var_x257 = 1.0 - var_x253 - var_x254;
        const double var_x258 = exp(-1.2962962962962963 - 092592592592592587 * var_chaste_interface__membrane__V);
        ...
        const double var_x280 = exp(089820359281437126 - 059880239520958084 * var_chaste_interface__membrane__V);
        const double var_x281 = 1.0 + var_x280;
        const double var_x282 = 001 / var_x281;
        ...
        const double var_x290 = 071899999999999992 * var_x289;
        ...
        const double var_x297 = 032750000000000001 * var_x285;
        const double var_x298 = 017974999999999998 * var_x289;
        ...
        const double var_x306 = 10000 * var_x302 + 10000 * var_x305;
        const double var_x307 = 1 / var_x306;
        const double var_x308 = 10 * var_x302;
        const double var_x309 = 400 * var_x302;
        const double var_x310 = 400 * pow(var_x303, 2) / pow(var_x304, 2);
        const double var_x311 = pow(var_x300, 2) / pow(var_x301, 2);
        const double var_x312 = 400 * var_x311;
        const double var_x313 = 400 * var_x305;
        ...
        const double var_x322 = 15.0 * var_x318 + 100 * var_x321;
        const double var_x323 = var_x316 / pow(var_x317, 2);
        const double var_x324 = 3.0 * var_x323;
        const double var_x325 = 20 * pow(var_x319, 2) / pow(var_x320, 2);
        const double var_x326 = 20 * var_x321;
        ...
        const double var_x340 = 0028901145059235626 * var_x165;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0 : (-var_x101 * (0070160275741043606 + var_x18 + var_x23 + var_x3 + var_x30 + var_x34 + var_x55 + var_x57 + var_x62 + var_x76 + var_x79 + var_x81 + var_x82 + var_x99 - var_x63 - var_x65 - var_x85 - var_x86 + var_x37 * var_x43));
        IJth(rJacobian, 1, 0) = -var_x161 * var_x167;
        IJth(rJacobian, 2, 0) = (001 - 001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x202) ? (var_x200 - 32.0 * var_x198 * var_x201 / pow(var_x199, 2)) : (0)) + 0072727272727272727 * var_x203 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 3, 0) = (001 - var_x204) * ((var_x206) ? (-19.852941176470587 * var_x205) : (0)) - var_x204 * ((var_x206) ? (281.24000000000001 * var_x207 + 108500000 * var_x208) : (693.0006930006931 * var_x209 / pow(var_x210, 2)));
        IJth(rJacobian, 4, 0) = (001 - var_x211) * ((var_x206) ? (var_x218 + var_x217 * var_x219 * (1.5254334000000001e-6 * var_x213 - 31073.016 * var_x212) - 311.0 * var_x214 * var_x215 * var_x219 / pow(var_x216, 2)) : (0)) - var_x211 * ((var_x206) ? (-1.2750239999999999 * var_x223 + 16.701360000000001 * var_x220 * var_x222 / pow(var_x221, 2)) : (-7.6049999999999992e-5 * var_x227 + 30 * var_x224 * var_x226 / pow(var_x225, 2)));
        ...
        IJth(rJacobian, 6, 0) = var_x244 * (20 + var_x243) * (var_x247 - var_x250) + var_x252 * (var_x250 - var_x247) * var_chaste_interface__L_type_Ca_channel_f_gate__f + var_x243 * var_x244 * var_x255 * var_x256 - var_x251 * var_x256 * var_x257 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 7, 0) = 9.2592592592592588e-5 * var_x258 * var_x263 / pow(var_x259, 2) + 036429872495446262 * var_x260 * (-var_chaste_interface__T_type_Ca_channel_b_gate__b + 1.0 / var_x259) / (pow(var_x261, 2) * pow((0.60655737704918034 + var_x262), 2));
        IJth(rJacobian, 8, 0) = (001 / var_x265 - 001 * var_chaste_interface__T_type_Ca_channel_g_gate__g) * ((var_x266) ? (6.0763888888888884 / pow((1 - 072916666666666671 * var_chaste_interface__membrane__V), 2)) : (0)) - 0001785714285714286 * var_x264 * var_x267 / pow(var_x265, 2);
        IJth(rJacobian, 9, 0) = (001 / var_x269 - 001 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr) * (var_x273 + var_x277 - 0.16973999999999997 * var_x274 * var_x278 / pow(var_x275, 2) - 088449999999999987 * var_x270 * var_x279 / pow(var_x271, 2)) + 00013333333333333334 * var_x268 * (var_x273 * var_x279 + var_x277 * var_x278) / pow(var_x269, 2);
        IJth(rJacobian, 10, 0) = var_x294 * (var_x286 * var_x291 + var_x290 * var_x291) + (var_x282 - 001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1) * (var_x286 + var_x290 - 0089997000000000011 * var_x292 - 0106412 * var_x293);
        IJth(rJacobian, 11, 0) = var_x294 * (var_x291 * var_x297 + var_x291 * var_x298) + (var_x282 - 001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2) * (var_x297 + var_x298 - 0022499250000000003 * var_x292 - 0026603 * var_x293);
        IJth(rJacobian, 12, 0) = var_x306 * (var_x302 * var_x314 - var_x311 * var_x314 + 9.9999999999999995e-8 * var_x302 * (var_x312 + var_x313 - var_x309 - var_x310) / pow((var_x302 + var_x305), 2)) + (-001 * var_chaste_interface__transient_outward_current_zdv_gate__zdv + var_x307 * var_x308) * (var_x309 + var_x310 - var_x312 - var_x313);
        IJth(rJacobian, 13, 0) = var_x322 * (-0030000000000000001 * var_x323 * var_x327 + 1.5e-6 * var_x318 * (var_x324 + var_x325 - var_x326) / pow((var_x321 + 0.14999999999999999 * var_x318), 2)) + (-001 * var_chaste_interface__transient_outward_current_ydv_gate__ydv + var_x327 * var_x328) * (var_x326 - var_x324 - var_x325);
        IJth(rJacobian, 19, 0) = 001 * ((var_x335) ? (-var_x161 * var_x182) : (0));
        IJth(rJacobian, 23, 0) = var_x339 * (-0040000000000000001 + var_x86 - var_x34 - var_x76 - var_x81 - 4.5 * var_x338 - 0060000000000000001 * var_x50 * var_x53);
        ...
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (-var_x101 * (var_x111 + var_x120 - var_x103 - var_x106 - var_x108 - var_x115 - var_x116));
        ...
        IJth(rJacobian, 15, 1) = 0050000000000000001 * var_x169 - 0050000000000000001 * var_x181;
        IJth(rJacobian, 19, 1) = 001 * ((var_x335) ? (var_x183) : (0));
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (-048000000000000001 * var_x100 * var_x125);
        IJth(rJacobian, 2, 2) = -001 * ((var_x202) ? (var_x200 * var_x201) : (3200)) - 080000000000000002 * var_x203;
        IJth(rJacobian, 23, 2) = -0086703435177706879 * var_x125 * var_x165;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (-var_x126 * var_x127);
        IJth(rJacobian, 3, 3) = -001 * ((var_x206) ? (135.0 * var_x205) : (0)) - 001 * ((var_x206) ? (3560 * var_x207 + 310000000 * var_x208) : (7692.3076923076933 / var_x210));
        IJth(rJacobian, 23, 3) = -var_x126 * var_x340;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (-var_x127 * var_x128);
        IJth(rJacobian, 4, 4) = -001 * ((var_x206) ? (121.2 * var_x223) : (300 * var_x227)) - 001 * ((var_x206) ? (var_x218 * var_x219) : (0));
        IJth(rJacobian, 23, 4) = -var_x128 * var_x340;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (-var_x101 * (var_x129 * var_x96 + var_x130 * var_x75 + var_x130 * var_x78));
        IJth(rJacobian, 1, 5) = -var_x188 * var_x189;
        IJth(rJacobian, 5, 5) = var_x231 * var_x240 - var_x230 * var_x240;
        IJth(rJacobian, 19, 5) = 001 * ((var_x335) ? (-var_x188 * var_x336) : (0));
        IJth(rJacobian, 23, 5) = -var_x341 * var_x342;
        IJth(rJacobian, 24, 5) = -var_x341 * var_x346;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (-var_x101 * (var_x131 * var_x96 + var_x132 * var_x75 + var_x132 * var_x78));
        IJth(rJacobian, 1, 6) = -var_x189 * var_x190;
        IJth(rJacobian, 6, 6) = var_x252 * var_x255 + var_x252 * var_x257;
        IJth(rJacobian, 19, 6) = 001 * ((var_x335) ? (-var_x190 * var_x336) : (0));
        IJth(rJacobian, 23, 6) = -var_x342 * var_x343;
        IJth(rJacobian, 24, 6) = -var_x343 * var_x346;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (-0001 * var_x100 * var_x135);
        IJth(rJacobian, 1, 7) = -9.0316078310111336e-6 * var_x135 * var_x166;
        IJth(rJacobian, 7, 7) = -001 * var_x263;
        IJth(rJacobian, 19, 7) = 001 * ((var_x335) ? (-0090316078310111337 * var_x135 * var_x165) : (0));
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (-5.0000000000000002e-5 * var_x100 * var_x136);
        IJth(rJacobian, 1, 8) = -4.5158039155055668e-6 * var_x136 * var_x166;
        IJth(rJacobian, 8, 8) = -001 * var_x267;
        IJth(rJacobian, 19, 8) = 001 * ((var_x335) ? (-0045158039155055668 * var_x136 * var_x165) : (0));
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0 : (-2.3862446088641737e-5 * var_x100 * var_x137);
        IJth(rJacobian, 9, 9) = -00060999999999999997 * var_x272 * var_x279 - 0013799999999999999 * var_x276 * var_x278;
        IJth(rJacobian, 24, 9) = -4.3103250992251538e-6 * var_x137 * var_x165;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0 : (-var_x138 * var_x139);
        IJth(rJacobian, 10, 10) = -7.1899999999999999e-5 * var_x295 - 00013100000000000001 * var_x296;
        IJth(rJacobian, 24, 10) = var_x138 * var_x347;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0 : (-var_x139 * var_x140);
        IJth(rJacobian, 11, 11) = -1.7975e-5 * var_x295 - 3.2750000000000003e-5 * var_x296;
        IJth(rJacobian, 24, 11) = var_x140 * var_x347;
        IJth(rJacobian, 12, 12) = -var_x308 - 10 * var_x305;
        IJth(rJacobian, 13, 13) = -var_x328 - 0.10000000000000001 * var_x321;
        IJth(rJacobian, 1, 14) = 7.0588235294117641e-6 * var_x164 * var_x179;
        IJth(rJacobian, 14, 14) = var_x332 * (-5.5555555555555554 - var_x179) + 00025000000000000001 * (5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR - var_x179 * var_x185) / (pow(var_x329, 3) * pow((0.125 + var_x330), 2));
        IJth(rJacobian, 15, 14) = 00048309178743961351;
        IJth(rJacobian, 1, 15) = 2.7058823529411762e-5 * var_x164;
        IJth(rJacobian, 14, 15) = 0055555555555555558 * var_x331;
        IJth(rJacobian, 15, 15) = -00081642512077294684;
        IJth(rJacobian, 16, 16) = 001 * ((1.0 * var_x100 * (var_x186 + var_x187 + 0070160275741043606 * var_chaste_interface__membrane__V - 0.10684935482199306 * var_x122 - 7.3656881518639831e-7 * var_x5 + var_x110 * var_x30 + var_x123 * var_x34 + var_x142 * var_x37 + var_x18 * var_x56 + var_x23 * var_x56 + var_x3 * var_x56 + var_x76 * var_chaste_interface__membrane__V + var_x79 * var_chaste_interface__membrane__V + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance()) < -150000) ? (-100500) : (-500));
        IJth(rJacobian, 1, 17) = var_x191 * var_x192;
        IJth(rJacobian, 14, 17) = var_x191 * var_x333;
        IJth(rJacobian, 17, 17) = 001 * ((var_x334) ? (-100500) : (-500));
        IJth(rJacobian, 18, 18) = 001 * ((var_x334) ? (-100500) : (-10));
        IJth(rJacobian, 1, 19) = var_x192 * var_x194;
        IJth(rJacobian, 14, 19) = var_x194 * var_x333;
        IJth(rJacobian, 19, 19) = 001 * (((var_x335) || (var_chaste_interface__calcium_dynamics__APtrack2 > 01)) ? (0) : (-500));
        IJth(rJacobian, 20, 20) = 001 * (((var_chaste_interface__calcium_dynamics__APtrack3 < 0.37) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.37) && (1.0 / (1.0 + 0.80000000000000004 / var_chaste_interface__calcium_dynamics__Ca_JSR) > 0.69999999999999996)) ? (-50000) : (-500));
        IJth(rJacobian, 1, 21) = var_x192 * var_x195;
        IJth(rJacobian, 14, 21) = var_x195 * var_x333;
        IJth(rJacobian, 21, 21) = 001 * (((var_x337) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50000) : (-500));
        IJth(rJacobian, 22, 22) = 001 * (((var_x337) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50000) : (-10));
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0 : (-var_x101 * (var_x141 + var_x146 + var_x147 + var_x152 - var_x149 + 3.3880737654706117 * var_x151 + 029999999999999999 * var_x143));
        IJth(rJacobian, 1, 23) = -var_x167 * var_x196;
        IJth(rJacobian, 19, 23) = 001 * ((var_x335) ? (-var_x182 * var_x196) : (0));
        IJth(rJacobian, 23, 23) = var_x339 * (-var_x141 - var_x147 - var_x152 + 6.124934136868245e-12 * var_x148 - 032399999999999998 * var_x145 - 089999999999999997 * var_x143);
        IJth(rJacobian, 24, 23) = var_x339 * (3.3880737654706117 * var_x348 + 059999999999999998 * var_x143);
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0 : (-var_x101 * (var_x153 + var_x154 + var_x155 + var_x156 + var_x158 + var_x160 - var_x159 + 184.83763041301756 * var_x151));
