...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x122 = 0.44800000000000001 * var_x121 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x123 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x124 = fabs(var_x123) < 1.0000000000000001e-5;
        const double var_x125 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x135 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x146 = -0.00089999999999999998 * var_x144 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x145, 2);
        const double var_x147 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x148 = fabs(var_x147) < 0.0001;
        const double var_x149 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        const double var_x162 = var_x161 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x165 = 1.0 - var_x162;
        const double var_x166 = var_x164 * var_x165;
        const double var_x167 = var_x162 + var_x166 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x168 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x160, 2);
        const double var_x169 = 2 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x170 = var_x167 * (-2 * var_x168 + 2 * var_x161 + var_x164 * var_x169 * (var_x168 - var_x161));
        ...
        const double var_x176 = pow(var_x167, 2);
        const double var_x177 = 2.5 * var_x176;
        const double var_x178 = 0.5 * var_x176;
        const double var_x179 = var_x167 * (2 * var_x166 - var_x165 * var_x169 / pow(var_x163, 2));
        ...
        const double var_x189 = -var_x109;
        ...
        IJth(rJacobian, 5, 0) = ((var_x124) ? (var_x122) : (var_x122 + var_x125 * var_x129 - 0.02 * var_x123 * var_x125 * var_x127 / pow(var_x128, 2)));
        IJth(rJacobian, 6, 0) = -0.125 * var_x131 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x132 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x132), 2);
        IJth(rJacobian, 7, 0) = ((var_x134) ? (0) : (var_x135 * var_x140 - var_x143 * var_chaste_interface__L_type_Ca_channel_d_gate__d + 0.0035999999999999999 * var_x133 * var_x141 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x142, 2) - 0.022499999999999999 * var_x133 * var_x135 * var_x138 / pow(var_x139, 2)));
        IJth(rJacobian, 8, 0) = ((var_x148) ? (var_x146) : (var_x146 + var_x149 * var_x152 - 0.00046874999999999998 * var_x147 * var_x149 * var_x150 / pow(var_x151, 2)));
        ...
        IJth(rJacobian, 13, 1) = ((var_x173) ? (-var_x172 + var_x159 * var_x171) : (-var_x175 + var_x159 * var_x174));
        ...
        IJth(rJacobian, 5, 5) = ((var_x124) ? (-2.0 + var_x130) : (var_x130 - var_x123 * var_x129));
        IJth(rJacobian, 15, 5) = -0.0047387059512636921 * var_x72;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x27 * var_x71);
        IJth(rJacobian, 6, 6) = -0.02 * var_x131 - 2.0 / (1.0 + 320.0 * var_x132);
        ...
        IJth(rJacobian, 7, 7) = ((var_x134) ? (-0.71999999999999997) : (-var_x133 * var_x140 - var_x133 * var_x143));
        ...
        IJth(rJacobian, 8, 8) = ((var_x148) ? (-0.0074999999999999997 + var_x153) : (var_x153 - var_x147 * var_x152));
        ...
        IJth(rJacobian, 13, 17) = ((var_x173) ? (-var_x181 + var_x159 * var_x180) : (-var_x183 + var_x159 * var_x182));
        ...
        IJth(rJacobian, 20, 20) = -0.050000000000000003 + var_x189;
        IJth(rJacobian, 1, 21) = 0.20000000000000001 + var_x109;
        IJth(rJacobian, 21, 21) = -0.20000000000000001 + var_x189;
    }
