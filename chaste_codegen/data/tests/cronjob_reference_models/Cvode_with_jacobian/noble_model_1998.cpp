...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x9 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2.0);
        ...
        const double var_x130 = exp(-9.375 + var_x0);
        ...
        const double var_x155 = exp(-1.25 + var_x0);
        ...
        const double var_x184 = 0.0015795686504212307 * var_x26;
        const double var_x185 = 2.3651760162759904e-8 * var_x49;
        const double var_x186 = 4.7303520325519805e-9 * var_x47;
        const double var_x187 = 8.4392437745822447e-5 * var_x5 - 3.1591373008424612e-6 * var_chaste_interface__membrane__V;
        const double var_x188 = 4.7303520325519803e-5 * var_x40;
        ...
        IJth(rJacobian, 15, 0) = -3.7909647610109532e-7 + 8.8537740769851495e-10 * var_x60 - 3.1591373008424611e-7 * var_x31 - 2.5273098406739689e-6 * var_x3 - 1.2395283707779208e-7 * var_x53 - 9.4679344906248566e-7 * var_x17 - var_x184 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x185 * var_x45;
        IJth(rJacobian, 16, 0) = 1.7707548153970298e-10 * var_x59 + 4.2235286004928392e-6 * var_x29 + 2.8206583043236264e-5 * var_x32 - 1.6427513964380798e-6 * var_x9 - 3.1591373008424612e-6 * var_x18 - 9.0261065738356038e-5 * var_x8 - 7.0830192615881192e-10 * var_x53 - 0.00063182746016849224 * var_x23 - var_x186 * var_x45;
        IJth(rJacobian, 17, 0) = 3.5415096307940594e-6 * var_x57 - 7.0830192615881188e-6 * var_x56 - var_x188 * var_x34;
        ...
        IJth(rJacobian, 19, 19) = -0.0050499999999999998 - var_x189;
