...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x2 = exp(-0.46792363528431841 + 0.046792363528431843 * var_chaste_interface__membrane__V - 1.2500000000000002 * var_x1);
        const double var_x3 = 1.0 + var_x2;
        const double var_x4 = 1 / var_x3;
        const double var_x5 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2.0);
        const double var_x6 = -0.125 * var_chaste_interface__membrane__V;
        const double var_x7 = exp(-6.5 + var_x6);
        const double var_x8 = 1.0 + var_x7;
        const double var_x9 = 1 / var_x8;
        const double var_x10 = 0.052631578947368418 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        const double var_x19 = var_x18 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        const double var_x20 = 0.037433890822745473 * var_x19;
        const double var_x21 = exp(-var_x17);
        const double var_x22 = 51359.298208806787 * var_x21;
        const double var_x23 = var_x16 * (var_x20 + var_x22 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x24 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x25 = var_x24 * (var_x20 + var_x22 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x26 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0);
        const double var_x27 = 26.315789473684209 * var_x26;
        const double var_x28 = -26.713760659695652 * var_x1 + var_chaste_interface__membrane__V;
        const double var_x29 = var_x2 * var_x28 / pow(var_x3, 2);
        const double var_x30 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x31 = var_x7 * (-26.713760659695652 * log(140.0 * var_x30) + var_chaste_interface__membrane__V) / pow(var_x8, 2);
        const double var_x32 = var_x11 * var_x14 * var_x28 / pow(var_x12, 2);
        ...
        const double var_x48 = 7.8808191205779937e-5 * var_x47;
        const double var_x49 = -140.0 * var_x42 + var_x46 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x50 = 0.00039404095602889967 * var_x49;
        const double var_x51 = -50.0 + var_chaste_interface__membrane__V;
        const double var_x52 = var_x34 * var_x51;
        const double var_x53 = var_x37 * var_x52;
        const double var_x54 = var_x35 * var_x53;
        const double var_x55 = var_x45 * var_x51;
        const double var_x56 = var_x42 * var_x55;
        const double var_x57 = var_x35 * var_x39 * var_x52 / pow(var_x36, 2);
        const double var_x58 = var_x42 * var_x52 / pow(var_x43, 2);
        ...
        const double var_x62 = 2.0 * var_x19;
        const double var_x63 = 2744000.0 * var_x21;
        ...
        const double var_x65 = var_x16 * var_x21;
        const double var_x66 = var_x38 * var_x53;
        const double var_x67 = var_x13 * var_x28;
        ...
        const double var_x69 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 1.0) * (-26.713760659695652 * log(8.1999999999999993 * var_x68) + var_chaste_interface__membrane__V);
        const double var_x70 = 1 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x71 = -26.713760659695652 * log(140.47999999999999 * var_x70) + var_chaste_interface__membrane__V;
        const double var_x72 = var_x71 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0) * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x80 = var_x28 * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        const double var_x83 = var_x5 * var_x68;
        const double var_x84 = var_x30 * var_x9;
        const double var_x85 = var_x18 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x86 = var_x16 * var_x85;
        const double var_x87 = var_x24 * var_x85;
        const double var_x88 = var_x26 * var_x70 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x89 = var_x46 * var_x55;
        const double var_x90 = var_x0 * var_x4;
        const double var_x91 = var_x0 * var_x15;
        const double var_x92 = var_x0 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x93 = var_x0 * var_x29;
        const double var_x94 = var_x21 * var_x24;
        const double var_x95 = (var_x62 - var_x63 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2);
        ...
        const double var_x105 = pow((var_x104 * var_chaste_interface__calcium_release__ActFrac), 2.0);
        const double var_x106 = var_x103 * var_x105 * (var_x104 - var_chaste_interface__calcium_release__ActFrac / pow(var_x103, 2)) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel / var_chaste_interface__calcium_release__ActFrac;
        const double var_x107 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x108 = exp(1.3333333333333333 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x109 = -0.1111111111111111 * var_chaste_interface__membrane__V;
        const double var_x110 = exp(0.55555555555555558 + var_x109);
        const double var_x111 = 1.0 + var_x110;
        const double var_x112 = 0.0055555555555555558 * var_x110 / pow(var_x111, 2);
        const double var_x113 = -0.050000000000000003 / var_x111;
        const double var_x114 = 1.0 + 0.033333333333333333 * var_chaste_interface__membrane__V;
        const double var_x115 = exp(-pow(var_x114, 3.0));
        const double var_x116 = exp(-0.022222222222222223 * var_chaste_interface__membrane__V);
        const double var_x117 = exp(4.4444444444444446 + var_x109);
        const double var_x118 = 1.0 + var_x117;
        const double var_x119 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x120 = 0.44800000000000001 * var_x119 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x121 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x122 = fabs(var_x121) < 1.0000000000000001e-5;
        const double var_x123 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x129 = -8.0 * var_x119;
        const double var_x130 = exp(-9.375 + var_x6);
        const double var_x131 = 20.0 * var_x130;
        const double var_x132 = exp(-7.5 + var_x125);
        const double var_x133 = 1 / (1.0 + 320.0 * var_x132);
        const double var_x134 = var_x131 + 2000.0 * var_x133;
        const double var_x135 = 1 / var_x134;
        const double var_x136 = 2.5 * var_x130;
        const double var_x137 = 0.625 * var_x132 / pow((0.0031250000000000002 + var_x132), 2);
        const double var_x138 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x139 = fabs(var_x138) < 0.0001;
        const double var_x140 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x141 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x142 = -var_x141;
        const double var_x143 = exp(-4.75 + var_x142);
        const double var_x144 = 1.0 - var_x143;
        const double var_x145 = 0.089999999999999997 / var_x144;
        const double var_x146 = exp(1.8999999999999999 + var_x124);
        const double var_x147 = -1.0 + var_x146;
        const double var_x148 = 0.036000000000000004 / var_x147;
        const double var_x149 = exp(-8.5 + var_x142);
        const double var_x150 = 1.0 + var_x149;
        const double var_x151 = -0.00089999999999999998 * var_x149 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x150, 2);
        const double var_x152 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x153 = fabs(var_x152) < 0.0001;
        const double var_x154 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x155 = exp(8.5 + var_x141);
        const double var_x156 = -1.0 + var_x155;
        const double var_x157 = 0.0018749999999999999 / var_x156;
        const double var_x158 = -0.0035999999999999999 / var_x150;
        ...
        const double var_x161 = exp(-1.25 + var_x6);
        ...
        const double var_x167 = var_x166 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x172 = var_x167 + var_x171 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x173 = pow(var_x172, 1.0);
        const double var_x174 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x165, 2);
        const double var_x175 = var_x173 * (var_x166 - var_x174 + var_x169 * (var_x174 - var_x166) * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x176 = var_x164 * var_x175;
        const double var_x177 = var_x175 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x178 = 5.0 * var_x177;
        const double var_x179 = var_chaste_interface__membrane__V < -50.0;
        const double var_x180 = 1.0 * var_x177;
        const double var_x181 = pow(var_x172, 2.0);
        const double var_x182 = var_x173 * (var_x171 - var_x170 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x168, 2));
        const double var_x183 = var_x164 * var_x182;
        const double var_x184 = var_x182 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x185 = 5.0 * var_x184;
        const double var_x186 = 1.0 * var_x184;
        const double var_x187 = 0.0015795686504212307 * var_x26;
        const double var_x188 = 2.3651760162759901e-8 * var_x49;
        const double var_x189 = 3.1591373008424612e-6 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x190 = 4.7303520325519805e-9 * var_x47;
        const double var_x191 = 4.730352032551981e-5 * var_x40;
        const double var_x192 = -var_x107;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0089473684210526309 + 0.011800388902140866 * var_x57 + 0.46992481203007513 * var_x32 + 0.070364456433732098 * var_x29 + 2.9500972255352159e-6 * var_x59 + 1.475048612767608e-5 * var_x60 - 1.5037593984962405 * var_x4 - 0.027368421052631577 * var_x5 - 10.526315789473683 * var_x15 - 0.0052578947368421046 * var_x23 - 0.005263157894736842 * var_x31 - 0.042105263157894736 * var_x9 - 5.2631578947368422e-6 * var_x25 - 0.023600777804281731 * var_x54 - 0.0020768684467767922 * var_x56 - var_x10 * var_chaste_interface__transient_outward_current_s_gate__s - var_x27 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x34 * var_x41 - var_x45 * var_x48 - var_x45 * var_x50);
        IJth(rJacobian, 1, 0) = -7.8978432521061529e-8 + 3.1591373008424614e-10 * var_x25 + 3.155978163541619e-7 * var_x23;
        IJth(rJacobian, 2, 0) = var_x112 * (1.0 - var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1) + 3.3333333333333333e-6 * var_x108 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1;
        IJth(rJacobian, 3, 0) = var_x112 * (1.0 - var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2) + 4.0000000000000003e-5 * var_x115 * pow(var_x114, 2.0) * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2;
        IJth(rJacobian, 4, 0) = 2.2222222222222223e-5 * var_x116 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs + 0.0015555555555555555 * var_x117 * (1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs) / pow(var_x118, 2);
        IJth(rJacobian, 5, 0) = ((var_x122) ? (var_x120) : (var_x120 + var_x123 * var_x128 - 0.020000000000000004 * var_x121 * var_x123 * var_x126 / pow(var_x127, 2)));
        IJth(rJacobian, 6, 0) = 0.001 * var_x134 * (-var_x135 * var_x136 + 5.0000000000000004e-6 * var_x130 * (var_x136 - var_x137) / pow((var_x133 + 0.01 * var_x130), 2)) + 0.001 * (var_x137 - var_x136) * (-var_chaste_interface__fast_sodium_current_h_gate__h + var_x131 * var_x135);
        IJth(rJacobian, 7, 0) = ((var_x139) ? (0) : (var_x140 * var_x145 - var_x148 * var_chaste_interface__L_type_Ca_channel_d_gate__d + 0.0036000000000000008 * var_x138 * var_x146 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x147, 2) - 0.022499999999999999 * var_x138 * var_x140 * var_x143 / pow(var_x144, 2)));
        IJth(rJacobian, 8, 0) = ((var_x153) ? (var_x151) : (var_x151 + var_x154 * var_x157 - 0.00046874999999999998 * var_x152 * var_x154 * var_x155 / pow(var_x156, 2)));
        IJth(rJacobian, 11, 0) = -1.9411764705882353e-6 * var_x160 * (1.0 - var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x161 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x162, 2);
        IJth(rJacobian, 12, 0) = 0.066600000000000006 * var_x163 / pow((1.0 + var_x163), 2);
        IJth(rJacobian, 15, 0) = -3.7909647610109532e-7 + 8.8537740769851485e-10 * var_x60 - 9.4679344906248566e-7 * var_x23 - 3.1591373008424611e-7 * var_x31 - 2.5273098406739689e-6 * var_x9 - 1.2395283707779208e-7 * var_x56 - var_x187 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x188 * var_x45;
        IJth(rJacobian, 16, 0) = 1.7707548153970298e-10 * var_x59 + 2.820658304323626e-5 * var_x32 + 4.2235286004928401e-6 * var_x29 - 0.00063182746016849224 * var_x15 - 9.0261065738356038e-5 * var_x4 - 1.6427513964380798e-6 * var_x5 - 7.0830192615881192e-10 * var_x56 - var_x189 * var_chaste_interface__transient_outward_current_s_gate__s - var_x190 * var_x45;
        IJth(rJacobian, 17, 0) = 3.5415096307940598e-6 * var_x57 - 7.0830192615881196e-6 * var_x54 - var_x191 * var_x34;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (3.6279473684210518e-5 * var_x64 + 14427.663157894734 * var_x65 - 0.035149685078546905 * var_x61 - 0.1576163824115599 * var_x66);
        IJth(rJacobian, 1, 1) = -7.0 + var_x96 + var_x97 + 0.00040000000000000002 * var_x101 - 1.0549054718227806e-6 * var_x61 - 0.00040000000000000002 * var_x99 - 7.1999999999999991e-9 * var_x102 - 0.86600040807582024 * var_x65 - 2.1776249328437171e-9 * var_x64;
        ...
        IJth(rJacobian, 13, 1) = ((var_x179) ? (-var_x178 + 5.0 * var_x176) : (-var_x180 + 1.0 * var_x176));
        IJth(rJacobian, 14, 1) = ((var_x179) ? (var_x178) : (var_x180));
        IJth(rJacobian, 15, 1) = 2.5980012242274606 * var_x65 + 6.5328747985311509e-9 * var_x64;
        IJth(rJacobian, 17, 1) = -4.730352032551981e-5 * var_x66;
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.022105263157894732 * var_x67);
        IJth(rJacobian, 2, 2) = var_x113 - 5.0000000000000002e-5 * var_x108;
        ...
        IJth(rJacobian, 3, 3) = var_x113 - 0.00040000000000000002 * var_x115;
        ...
        IJth(rJacobian, 4, 4) = -0.001 * var_x116 - 0.014 / var_x118;
        ...
        IJth(rJacobian, 5, 5) = ((var_x122) ? (-2.0 + var_x129) : (var_x129 - var_x121 * var_x128));
        IJth(rJacobian, 15, 5) = -0.0047387059512636921 * var_x72;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x27 * var_x71);
        IJth(rJacobian, 6, 6) = -0.02 * var_x130 - 2.0 * var_x133;
        IJth(rJacobian, 15, 6) = -var_x187 * var_x71;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x41 * var_x73 - var_x48 * var_x74 - var_x50 * var_x74);
        IJth(rJacobian, 7, 7) = ((var_x139) ? (-0.71999999999999997) : (-var_x138 * var_x145 - var_x138 * var_x148));
        IJth(rJacobian, 15, 7) = -var_x188 * var_x74;
        IJth(rJacobian, 16, 7) = -var_x190 * var_x74;
        IJth(rJacobian, 17, 7) = -var_x191 * var_x73;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x41 * var_x76 - var_x48 * var_x77 - var_x50 * var_x77);
        IJth(rJacobian, 8, 8) = ((var_x153) ? (-0.0074999999999999997 + var_x158) : (var_x158 - var_x152 * var_x157));
        IJth(rJacobian, 15, 8) = -var_x188 * var_x77;
        IJth(rJacobian, 16, 8) = -var_x190 * var_x77;
        IJth(rJacobian, 17, 8) = -var_x191 * var_x76;
        ...
        IJth(rJacobian, 15, 10) = -var_x188 * var_x79;
        IJth(rJacobian, 16, 10) = -var_x190 * var_x79;
        IJth(rJacobian, 17, 10) = -var_x191 * var_x78;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x10 * var_x28);
        IJth(rJacobian, 11, 11) = -0.033000000000000002 / var_x162 - 3.3000000000000003e-5 * var_x160;
        IJth(rJacobian, 16, 11) = -var_x189 * var_x28;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-0.052631578947368418 * var_x80);
        IJth(rJacobian, 12, 12) = -0.33300000000000002;
        IJth(rJacobian, 16, 12) = -3.1591373008424612e-6 * var_x80;
        IJth(rJacobian, 1, 13) = 0.10204081632653063 * var_x106;
        IJth(rJacobian, 13, 13) = ((var_x179) ? (-0.29999999999999999 - 5.0 * var_x181) : (-0.059999999999999998 - 1.0 * var_x181));
        IJth(rJacobian, 14, 13) = ((var_x179) ? (0.29999999999999999 + 2.5 * var_x181) : (0.059999999999999998 + 0.5 * var_x181));
        IJth(rJacobian, 19, 13) = -0.5 * var_x106;
        IJth(rJacobian, 13, 14) = ((var_x179) ? (-2.5 * var_x181) : (-0.5 * var_x181));
        IJth(rJacobian, 14, 14) = ((var_x179) ? (-0.0050000000000000001) : (-0.001));
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.0036842105263157885 * var_x82 - 5.8947368421052619 * var_x81 - 0.16871848837702516 * var_x30 - 0.00039404095602889967 * var_x89 - 0.03154736842105263 * var_x86 - 3.1578947368421052e-5 * var_x87 - 702.99370157093813 * var_x88 - 0.021933403489013268 * var_x83 - 1.1247899225135012 * var_x84);
        IJth(rJacobian, 1, 15) = 1.8954823805054768e-9 * var_x87 + 1.8935868981249713e-6 * var_x86;
        IJth(rJacobian, 15, 15) = 6.634188331769168e-7 * var_x82 - 0.0010614701330830668 * var_x81 - 1.0127092529498694e-5 * var_x30 - 2.3651760162759901e-8 * var_x89 - 5.6807606943749135e-6 * var_x86 - 0.042196218872911223 * var_x88 - 6.7513950196657958e-5 * var_x84;
        IJth(rJacobian, 16, 15) = 0.00070764675538871125 * var_x81 - 4.4227922211794452e-7 * var_x82 - 1.31652202883483e-6 * var_x83;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (1.879699248120301 * var_x93 - 7.8808191205779937e-5 * var_x89 - 281.19748062837527 * var_x91 - 40.171068661196465 * var_x90 - 84.359244188512577 * var_x88 - 1.4059874031418764 * var_x92 - 0.73111344963377567 * var_x83);
        IJth(rJacobian, 15, 16) = -0.0050635462647493469 * var_x88;
        IJth(rJacobian, 16, 16) = 0.00011282633217294507 * var_x93 - 4.7303520325519805e-9 * var_x89 - 0.016878487549164489 * var_x91 - 4.388406762782767e-5 * var_x83 - 0.0024112125070234985 * var_x90 - 8.4392437745822447e-5 * var_x92;
        ...
        IJth(rJacobian, 10, 17) = -0.02 / var_x159 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x159, 2);
        IJth(rJacobian, 13, 17) = ((var_x179) ? (-var_x185 + 5.0 * var_x183) : (-var_x186 + 1.0 * var_x183));
        IJth(rJacobian, 14, 17) = ((var_x179) ? (var_x185) : (var_x186));
        IJth(rJacobian, 17, 17) = -0.01;
        IJth(rJacobian, 1, 18) = 7.1999999999999991e-9 * var_x99 + 9.5999999999999999e-8 * var_x101 - 1.7279999999999997e-12 * var_x102;
        IJth(rJacobian, 18, 18) = -0.050000000000000003 + 8.4671999999999982e-11 * var_x102 - 3.5279999999999993e-7 * var_x99 - 4.7039999999999993e-6 * var_x101;
        IJth(rJacobian, 19, 18) = 0.0050000000000000001;
        IJth(rJacobian, 1, 19) = 1.0204081632653063e-5 + 0.051020408163265314 * var_x105;
        IJth(rJacobian, 18, 19) = 0.050000000000000003;
        IJth(rJacobian, 19, 19) = -0.0050499999999999998 - 0.25 * var_x105;
        IJth(rJacobian, 1, 20) = 0.050000000000000003 + var_x107;
        IJth(rJacobian, 20, 20) = -0.050000000000000003 + var_x192;
        IJth(rJacobian, 1, 21) = 0.20000000000000001 + var_x107;
        IJth(rJacobian, 21, 21) = -0.20000000000000001 + var_x192;
    }
