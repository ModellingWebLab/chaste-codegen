...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x131 = exp(-7.5 + var_x125);
        const double var_x132 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x133 = fabs(var_x132) < 0.0001;
        const double var_x134 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x135 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x136 = -var_x135;
        const double var_x137 = exp(-4.75 + var_x136);
        const double var_x138 = 1.0 - var_x137;
        const double var_x139 = 0.089999999999999997 / var_x138;
        const double var_x140 = exp(1.8999999999999999 + var_x124);
        const double var_x141 = -1.0 + var_x140;
        const double var_x142 = 0.036000000000000004 / var_x141;
        const double var_x143 = exp(-8.5 + var_x136);
        const double var_x144 = 1.0 + var_x143;
        const double var_x145 = -0.00089999999999999998 * var_x143 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x144, 2);
        const double var_x146 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x147 = fabs(var_x146) < 0.0001;
        const double var_x148 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x149 = exp(8.5 + var_x135);
        const double var_x150 = -1.0 + var_x149;
        const double var_x151 = 0.0018749999999999999 / var_x150;
        const double var_x152 = -0.0035999999999999999 / var_x144;
        const double var_x153 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x154 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x155 = exp(-1.25 + var_x6);
        const double var_x156 = 1.0 + var_x155;
        const double var_x157 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x158 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x159 = 0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x160 = 1 / var_x159;
        const double var_x161 = var_x160 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x162 = 0.01 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x163 = 1 / var_x162;
        const double var_x164 = 1.0 - var_x161;
        const double var_x165 = var_x163 * var_x164;
        const double var_x166 = var_x161 + var_x165 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x167 = pow(var_x166, 1.0);
        const double var_x168 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x159, 2);
        const double var_x169 = var_x167 * (var_x160 - var_x168 + var_x163 * (var_x168 - var_x160) * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x170 = var_x158 * var_x169;
        const double var_x171 = var_x169 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x172 = 5.0 * var_x171;
        const double var_x173 = var_chaste_interface__membrane__V < -50.0;
        const double var_x174 = 1.0 * var_x171;
        const double var_x175 = pow(var_x166, 2.0);
        const double var_x176 = var_x167 * (var_x165 - var_x164 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x162, 2));
        const double var_x177 = var_x158 * var_x176;
        const double var_x178 = var_x176 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x179 = 5.0 * var_x178;
        const double var_x180 = 1.0 * var_x178;
        const double var_x181 = 0.0015795686504212307 * var_x26;
        const double var_x182 = 2.3651760162759901e-8 * var_x49;
        const double var_x183 = 3.1591373008424612e-6 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x184 = 4.7303520325519805e-9 * var_x47;
        const double var_x185 = 4.730352032551981e-5 * var_x40;
        const double var_x186 = -var_x107;
        ...
        IJth(rJacobian, 6, 0) = -0.0025000000000000001 * var_x130 * (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x131 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x131), 2);
        IJth(rJacobian, 7, 0) = ((var_x133) ? (0) : (var_x134 * var_x139 - var_x142 * var_chaste_interface__L_type_Ca_channel_d_gate__d + 0.0036000000000000008 * var_x132 * var_x140 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x141, 2) - 0.022499999999999999 * var_x132 * var_x134 * var_x137 / pow(var_x138, 2)));
        IJth(rJacobian, 8, 0) = ((var_x147) ? (var_x145) : (var_x145 + var_x148 * var_x151 - 0.00046874999999999998 * var_x146 * var_x148 * var_x149 / pow(var_x150, 2)));
        IJth(rJacobian, 11, 0) = -1.9411764705882353e-6 * var_x154 * (1.0 - var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x155 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x156, 2);
        IJth(rJacobian, 12, 0) = 0.066600000000000006 * var_x157 / pow((1.0 + var_x157), 2);
        IJth(rJacobian, 15, 0) = -3.7909647610109532e-7 + 8.8537740769851485e-10 * var_x60 - 9.4679344906248566e-7 * var_x23 - 3.1591373008424611e-7 * var_x31 - 2.5273098406739689e-6 * var_x9 - 1.2395283707779208e-7 * var_x56 - var_x181 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x182 * var_x45;
        IJth(rJacobian, 16, 0) = 1.7707548153970298e-10 * var_x59 + 2.820658304323626e-5 * var_x32 + 4.2235286004928401e-6 * var_x29 - 0.00063182746016849224 * var_x15 - 9.0261065738356038e-5 * var_x4 - 1.6427513964380798e-6 * var_x5 - 7.0830192615881192e-10 * var_x56 - var_x183 * var_chaste_interface__transient_outward_current_s_gate__s - var_x184 * var_x45;
        IJth(rJacobian, 17, 0) = 3.5415096307940598e-6 * var_x57 - 7.0830192615881196e-6 * var_x54 - var_x185 * var_x34;
        ...
        IJth(rJacobian, 13, 1) = ((var_x173) ? (-var_x172 + 5.0 * var_x170) : (-var_x174 + 1.0 * var_x170));
        IJth(rJacobian, 14, 1) = ((var_x173) ? (var_x172) : (var_x174));
        ...
        IJth(rJacobian, 6, 6) = -2.0 / (1.0 + 320.0 * var_x131) - 0.02 * var_x130;
        IJth(rJacobian, 15, 6) = -var_x181 * var_x71;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x41 * var_x73 - var_x48 * var_x74 - var_x50 * var_x74);
        IJth(rJacobian, 7, 7) = ((var_x133) ? (-0.71999999999999997) : (-var_x132 * var_x139 - var_x132 * var_x142));
        IJth(rJacobian, 15, 7) = -var_x182 * var_x74;
        IJth(rJacobian, 16, 7) = -var_x184 * var_x74;
        IJth(rJacobian, 17, 7) = -var_x185 * var_x73;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x41 * var_x76 - var_x48 * var_x77 - var_x50 * var_x77);
        IJth(rJacobian, 8, 8) = ((var_x147) ? (-0.0074999999999999997 + var_x152) : (var_x152 - var_x146 * var_x151));
        IJth(rJacobian, 15, 8) = -var_x182 * var_x77;
        IJth(rJacobian, 16, 8) = -var_x184 * var_x77;
        IJth(rJacobian, 17, 8) = -var_x185 * var_x76;
        ...
        IJth(rJacobian, 15, 10) = -var_x182 * var_x79;
        IJth(rJacobian, 16, 10) = -var_x184 * var_x79;
        IJth(rJacobian, 17, 10) = -var_x185 * var_x78;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x10 * var_x28);
        IJth(rJacobian, 11, 11) = -0.033000000000000002 / var_x156 - 3.3000000000000003e-5 * var_x154;
        IJth(rJacobian, 16, 11) = -var_x183 * var_x28;
        ...
        IJth(rJacobian, 13, 13) = ((var_x173) ? (-0.29999999999999999 - 5.0 * var_x175) : (-0.059999999999999998 - 1.0 * var_x175));
        IJth(rJacobian, 14, 13) = ((var_x173) ? (0.29999999999999999 + 2.5 * var_x175) : (0.059999999999999998 + 0.5 * var_x175));
        IJth(rJacobian, 19, 13) = -0.5 * var_x106;
        IJth(rJacobian, 13, 14) = ((var_x173) ? (-2.5 * var_x175) : (-0.5 * var_x175));
        IJth(rJacobian, 14, 14) = ((var_x173) ? (-0.0050000000000000001) : (-0.001));
        ...
        IJth(rJacobian, 10, 17) = -0.02 / var_x153 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x153, 2);
        IJth(rJacobian, 13, 17) = ((var_x173) ? (-var_x179 + 5.0 * var_x177) : (-var_x180 + 1.0 * var_x177));
        IJth(rJacobian, 14, 17) = ((var_x173) ? (var_x179) : (var_x180));
        ...
        IJth(rJacobian, 20, 20) = -0.050000000000000003 + var_x186;
        IJth(rJacobian, 1, 21) = 0.20000000000000001 + var_x107;
        IJth(rJacobian, 21, 21) = -0.20000000000000001 + var_x186;
    }
