...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellespinosa_model_1998_normalFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x206 = 0.0024811376697271795 * var_x30;
        ...
        IJth(rJacobian, 13, 0) = -6.3182746016849228e-8 + 5.3122644461910889e-10 * var_x62 - 7.8887127025937665e-8 * var_x60 - 3.7871737962499429e-7 * var_x15 - var_x197 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x198 * var_x41;
        ...
        IJth(rJacobian, 15, 0) = -2.5273098406739689e-6 + var_x210 + 4.7398127366170842e-6 * var_x35 + 1.5936793338573268e-10 * var_x64 - 2.5341171602957037e-7 * var_x19 - 1.5936793338573268e-10 * var_x65 - var_x211 * var_chaste_interface__extracellular_potassium_concentration__K_o - var_x212 * var_x41;
        ...
        IJth(rJacobian, 13, 1) = 1.240208194723039 * var_x72 + 2.6131499194124605e-9 * var_x73 + 2.3129480072827907e-11 * var_x71;
        ...
        IJth(rJacobian, 13, 13) = 8.2927354147114598e-7 * var_x95 + 5.2972171058904767e-17 * var_x99 - 0.010127092529498692 * var_x88 - 2.8403803471874572e-6 * var_x101 - 1.687848754916449e-6 * var_x86 - 1.4191056097655941e-8 * var_x102 - var_x199 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        ...
        IJth(rJacobian, 13, 14) = 0.001215251103539843 * var_x106 + 0.0013268376663538336 * var_x109 - var_x199 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        IJth(rJacobian, 14, 14) = -0.00069999999999999999 + var_x208 - var_x206 + 0.001083584094188964 * var_x109 - 8.2704588990905987e-5 * var_x103 - 5.215213115888558e-9 * var_x60 - 9.2878636644768348e-7 * var_x108 + var_x202 * var_x32 - var_x103 * var_x207 - var_x17 * var_x205 - var_x204 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        IJth(rJacobian, 15, 14) = var_x215 - var_x217 + 4.2573168292967824e-9 * var_x60 + 6.7513950196657958e-5 * var_x103 + 7.5819295220219063e-7 * var_x108 - 0.00088455844423588909 * var_x109 + var_x17 * var_x214 + var_x213 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x103 * var_x216 - var_x211 * var_x32;
        ...
        IJth(rJacobian, 14, 15) = var_x205 + 8.2704588990905987e-5 * var_x23 + 5.215213115888558e-9 * var_x102 + var_x206 * var_x24 + var_x207 * var_x23 - var_x208 * var_x24;
