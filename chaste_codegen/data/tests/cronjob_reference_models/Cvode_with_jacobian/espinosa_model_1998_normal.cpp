...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellespinosa_model_1998_normalFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x0 = 0.14999999999999999 + 0.84999999999999998 * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x1 = 0.84210526315789469 * var_x0;
        ...
        const double var_x8 = 0.046792363528431843 * var_x7;
        const double var_x9 = exp(-var_x5);
        const double var_x10 = 61293.487778019749 * var_x9;
        ...
        const double var_x13 = 1 / (var_x12 + 16373.795625000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x14 = var_x11 * var_x13;
        const double var_x15 = 1 / var_chaste_interface__intracellular_potassium_concentration__K_i;
        ...
        const double var_x18 = exp(0.6251459767398494 + 0.062514597673984942 * var_chaste_interface__membrane__V - 1.6700000000000002 * var_x17);
        const double var_x19 = 1.0 + var_x18;
        const double var_x20 = 1 / var_x19;
        const double var_x21 = 1 / (10.0 + var_chaste_interface__extracellular_potassium_concentration__K_o);
        const double var_x22 = var_x20 * var_x21;
        const double var_x23 = 1.263157894736842 * var_x22;
        const double var_x24 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x25 = 1 / (var_x12 + 16373.795625000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x26 = var_x24 * var_x25;
        const double var_x27 = var_x26 * (var_x8 + var_x10 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        ...
        const double var_x31 = var_x30 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x32 = -26.713760659695652 * var_x17 + var_chaste_interface__membrane__V;
        const double var_x33 = var_x32 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x34 = var_x18 * var_x21 / pow(var_x19, 2);
        ...
        const double var_x42 = -2.5 * var_x38 + var_x41 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x43 = var_x40 * var_x42;
        const double var_x44 = 0.094569829446935927 * var_x43;
        const double var_x45 = exp(1.8716945411372736 + var_x28);
        const double var_x46 = 1.0 - var_x45;
        const double var_x47 = 1 / var_x46;
        const double var_x48 = var_x37 * var_x47;
        const double var_x49 = exp(1.8716945411372736);
        const double var_x50 = -148.5 * var_x45 + var_x49 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x51 = 0.00023642457361733977 * var_x50;
        const double var_x52 = var_x45 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x53 = -var_x52 + var_x49 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x54 = 7.0927372085201944e-5 * var_x53;
        ...
        const double var_x61 = var_x38 * var_x42 * var_x56 / pow(var_x39, 2);
        const double var_x62 = var_x45 * var_x56 / pow(var_x46, 2);
        const double var_x63 = var_x53 * var_x62;
        const double var_x64 = var_x50 * var_x62;
        const double var_x65 = var_x52 * var_x59;
        const double var_x66 = 1 / var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x67 = var_x26 * var_x9;
        const double var_x68 = 6.1073194200199382e-5 + 7.6341492750249225e-7 * var_x4;
        const double var_x69 = 2.5 * var_x7;
        const double var_x70 = 3274759.125 * var_x9;
        const double var_x71 = var_x69 - var_x70 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x72 = var_x24 * var_x71 / pow((var_x68 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x73 = var_x25 * var_x71 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x74 = var_x41 * var_x57;
        ...
        const double var_x79 = var_x36 * var_x55;
        ...
        const double var_x83 = var_x47 * var_x82;
        const double var_x84 = var_x81 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x85 = var_x47 * var_x84;
        const double var_x86 = var_x32 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x87 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x88 = 1.0 + var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x89 = 1 / var_x88;
        const double var_x90 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x91 = var_x89 * var_x90;
        const double var_x92 = 7.3684210526315779 * var_x91;
        const double var_x93 = var_x2 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x94 = var_x75 * var_x93;
        const double var_x95 = var_chaste_interface__extracellular_potassium_concentration__K_o * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x96 = var_x89 * var_x95 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x97 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        ...
        const double var_x100 = var_x11 * var_x99 / pow((var_x68 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2);
        const double var_x101 = var_x6 * var_x97;
        const double var_x102 = var_x101 * var_x26;
        const double var_x103 = var_x49 * var_x59;
        const double var_x104 = 1 / var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x105 = 33.743697675405031 * var_x22;
        const double var_x106 = 0.11278195488721804 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x107 = var_x0 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x108 = 22.495798450270023 * var_x107;
        const double var_x109 = var_x93 / var_x76;
        const double var_x110 = var_x90 * var_x95 / pow(var_x88, 2);
        const double var_x111 = var_x20 * var_x33 / pow((1 + 0.10000000000000001 * var_chaste_interface__extracellular_potassium_concentration__K_o), 2);
        const double var_x112 = var_x32 * var_x34;
        const double var_x113 = 2.1094736842105264 * var_x112;
        const double var_x114 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod;
        const double var_x115 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Trop;
        const double var_x116 = 0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_up + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x117 = 1 / var_x116;
        const double var_x118 = pow(var_x116, (-2));
        const double var_x119 = var_x118 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x120 = var_x118 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
        const double var_x121 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
        const double var_x122 = 1 / var_x121;
        const double var_x123 = pow((var_x122 * var_chaste_interface__calcium_release__ActFrac), 2.0);
        const double var_x124 = var_x121 * var_x123 * (var_x122 - var_chaste_interface__calcium_release__ActFrac / pow(var_x121, 2)) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel / var_chaste_interface__calcium_release__ActFrac;
        ...
        const double var_x146 = 20.0 * var_x145;
        const double var_x147 = exp(-7.5 + var_x140);
        const double var_x148 = 1 / (1.0 + 320.0 * var_x147);
        const double var_x149 = var_x146 + 2000.0 * var_x148;
        const double var_x150 = 1 / var_x149;
        const double var_x151 = 2.5 * var_x145;
        const double var_x152 = 0.625 * var_x147 / pow((0.0031250000000000002 + var_x147), 2);
        const double var_x153 = 4.0 + var_chaste_interface__membrane__V;
        const double var_x154 = fabs(var_x153) < 0.0001;
        const double var_x155 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x156 = exp(-1.3333333333333333 - 0.33333333333333331 * var_chaste_interface__membrane__V);
        const double var_x157 = 1.0 - var_x156;
        const double var_x158 = 0.29999999999999999 / var_x157;
        const double var_x159 = exp(0.53333333333333333 + 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x160 = -1.0 + var_x159;
        const double var_x161 = 0.12 / var_x160;
        const double var_x162 = 0.18181818181818182 * var_chaste_interface__membrane__V;
        const double var_x163 = exp(-6.1818181818181817 - var_x162);
        const double var_x164 = 1.0 + var_x163;
        const double var_x165 = -0.0043636363636363638 * var_x163 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x164, 2);
        const double var_x166 = 24.0 + var_chaste_interface__membrane__V;
        const double var_x167 = fabs(var_x166) < 0.0001;
        const double var_x168 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x169 = exp(4.3636363636363633 + var_x162);
        const double var_x170 = -1.0 + var_x169;
        const double var_x171 = 0.012500000000000001 / var_x170;
        const double var_x172 = -0.024 / var_x164;
        const double var_x173 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x174 = exp(-0.067226890756302518 * var_chaste_interface__membrane__V);
        const double var_x175 = exp(-1.4285714285714286 - 0.14285714285714285 * var_chaste_interface__membrane__V);
        const double var_x176 = 1.0 + var_x175;
        const double var_x177 = exp(2.0 + var_x140);
        const double var_x178 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x179 = 0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x182 = 0.01 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x183 = 1 / var_x182;
        const double var_x184 = 1.0 - var_x181;
        const double var_x185 = var_x183 * var_x184;
        const double var_x186 = var_x181 + var_x185 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x187 = pow(var_x186, 1.0);
        const double var_x188 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x179, 2);
        const double var_x189 = var_x187 * (var_x180 - var_x188 + var_x183 * (var_x188 - var_x180) * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x190 = var_x178 * var_x189;
        const double var_x191 = var_x189 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x192 = 5.0 * var_x191;
        const double var_x193 = var_chaste_interface__membrane__V < -50.0;
        const double var_x194 = 1.0 * var_x191;
        const double var_x195 = pow(var_x186, 2.0);
        const double var_x196 = var_x187 * (var_x185 - var_x184 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x182, 2));
        const double var_x197 = var_x178 * var_x196;
        const double var_x198 = var_x196 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x199 = 5.0 * var_x198;
        const double var_x200 = 1.0 * var_x198;
        const double var_x201 = 0.00037909647610109533 * var_x2;
        const double var_x202 = 1.419105609765594e-8 * var_x50;
        const double var_x203 = 0.0013268376663538336 * var_x91;
        const double var_x204 = 6.1919091096512239e-5 * var_x0;
        const double var_x205 = 9.2878636644768344e-5 * var_x22;
        const double var_x206 = 5.215213115888558e-9 * var_x53;
        const double var_x207 = 0.001083584094188964 * var_x91;
        const double var_x208 = 0.0024811376697271795 * var_x22;
        const double var_x209 = 8.2927354147114596e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x210 = 0.0016540917798181199 * var_x107;
        const double var_x211 = 0.00015510732319676314 * var_x112;
        const double var_x212 = 5.054619681347938e-5 * var_x0;
        const double var_x213 = 7.5819295220219067e-5 * var_x22;
        const double var_x214 = 4.2573168292967824e-9 * var_x53;
        const double var_x215 = 0.00088455844423588909 * var_x91;
        const double var_x216 = 6.7695799303767029e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x217 = 0.0020254185058997385 * var_x22;
        const double var_x218 = 0.0013502790039331592 * var_x107;
        const double var_x219 = 0.00012661822301776585 * var_x112;
        const double var_x220 = 2.8382112195311883e-5 * var_x43;
        const double var_x221 = -var_x125;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.045789473684210526 + 0.0070802333412845189 * var_x61 + 2.6550875029816946e-6 * var_x63 + 8.8502916766056468e-6 * var_x64 + 0.078965807588191508 * var_x35 - 0.0021031578947368419 * var_x27 - 2.6550875029816946e-6 * var_x65 - 0.0042218673860239253 * var_x31 - 0.017700583353211296 * var_x58 - 0.0013142683139759385 * var_x60 - var_x1 * var_chaste_interface__transient_outward_current_r_gate__r - var_x23 * var_chaste_interface__extracellular_potassium_concentration__K_o - var_x3 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x37 * var_x44 - var_x48 * var_x51 - var_x48 * var_x54 - 2.1052631578947371e-6 * var_x14 * (var_x8 + var_x10 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds));
        IJth(rJacobian, 1, 0) = -7.8978432521061529e-8 + 1.2623912654166476e-7 * var_x27;
        ...
        IJth(rJacobian, 3, 0) = ((var_x138) ? (var_x136) : (var_x136 + var_x139 * var_x143 - 0.020000000000000004 * var_x137 * var_x139 * var_x141 / pow(var_x142, 2)));
        IJth(rJacobian, 4, 0) = 0.001 * var_x149 * (-var_x150 * var_x151 + 5.0000000000000004e-6 * var_x145 * (var_x151 - var_x152) / pow((var_x148 + 0.01 * var_x145), 2)) + 0.001 * (var_x152 - var_x151) * (-var_chaste_interface__fast_sodium_current_h_gate__h + var_x146 * var_x150);
        IJth(rJacobian, 5, 0) = ((var_x154) ? (0) : (var_x155 * var_x158 - var_x161 * var_chaste_interface__L_type_Ca_channel_d_gate__d + 0.016 * var_x153 * var_x159 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x160, 2) - 0.099999999999999992 * var_x153 * var_x155 * var_x156 / pow(var_x157, 2)));
        IJth(rJacobian, 6, 0) = ((var_x167) ? (var_x165) : (var_x165 + var_x168 * var_x171 - 0.0022727272727272731 * var_x166 * var_x168 * var_x169 / pow(var_x170, 2)));
        IJth(rJacobian, 9, 0) = -5.7680672268907566e-7 * var_x174 * (1.0 - var_chaste_interface__transient_outward_current_s_gate__s) - 0.0012257142857142857 * var_x175 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x176, 2);
        IJth(rJacobian, 10, 0) = 0.033300000000000003 * var_x177 / pow((1.0 + var_x177), 2);
        IJth(rJacobian, 13, 0) = -6.3182746016849228e-8 + 5.3122644461910889e-10 * var_x64 - 3.7871737962499429e-7 * var_x27 - 7.8887127025937665e-8 * var_x60 - var_x201 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x202 * var_x48;
        IJth(rJacobian, 14, 0) = 3.0959545548256117e-6 + 3.1042935213622369e-7 * var_x31 + 1.9522571839752251e-10 * var_x65 - 5.806270602355928e-6 * var_x35 - 1.9522571839752251e-10 * var_x63 + var_x204 * var_chaste_interface__transient_outward_current_r_gate__r + var_x205 * var_chaste_interface__extracellular_potassium_concentration__K_o + var_x206 * var_x48;
        IJth(rJacobian, 15, 0) = -2.5273098406739689e-6 + 4.7398127366170842e-6 * var_x35 + 1.5936793338573268e-10 * var_x63 - 2.5341171602957037e-7 * var_x31 - 1.5936793338573268e-10 * var_x65 - var_x212 * var_chaste_interface__transient_outward_current_r_gate__r - var_x213 * var_chaste_interface__extracellular_potassium_concentration__K_o - var_x214 * var_x48;
        IJth(rJacobian, 16, 0) = 2.1249057784764359e-6 * var_x61 - 5.3122644461910897e-6 * var_x58 - var_x220 * var_x37;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (6887.3355071052629 * var_x67 + 1.2844657053894564e-7 * var_x72 + 1.4511789473684209e-5 * var_x73 - 0.094569829446935927 * var_x74 - 0.035149685078546905 * var_x66);
        IJth(rJacobian, 1, 1) = -7.0 + var_x114 + var_x115 + 0.00040000000000000002 * var_x119 - 1.0549054718227806e-6 * var_x66 - 0.41340273157434637 * var_x67 - 0.00040000000000000002 * var_x117 - 7.1999999999999991e-9 * var_x120 - 7.7098266909426358e-12 * var_x72 - 8.7104997313748684e-10 * var_x73;
        ...
        IJth(rJacobian, 11, 1) = ((var_x193) ? (-var_x192 + 5.0 * var_x190) : (-var_x194 + 1.0 * var_x190));
        IJth(rJacobian, 12, 1) = ((var_x193) ? (var_x192) : (var_x194));
        IJth(rJacobian, 13, 1) = 1.240208194723039 * var_x67 + 2.3129480072827907e-11 * var_x72 + 2.6131499194124605e-9 * var_x73;
        IJth(rJacobian, 16, 1) = -2.8382112195311883e-5 * var_x74;
        IJth(rJacobian, 17, 1) = 0.019599999999999999 * var_x117 + 3.5279999999999993e-7 * var_x120 - 0.019599999999999999 * var_x119;
        IJth(rJacobian, 19, 1) = 2.0 - var_x114;
        IJth(rJacobian, 20, 1) = 5.0 - var_x115;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (0.11278195488721804 * var_x30 - 0.11278195488721804 * var_chaste_interface__intracellular_potassium_concentration__K_i);
        IJth(rJacobian, 2, 2) = ((var_x127) ? (-0.0050000000000000001) : (-var_x126 * var_x131 - var_x126 * var_x134));
        IJth(rJacobian, 14, 2) = 8.2927354147114596e-6 * var_chaste_interface__intracellular_potassium_concentration__K_i - 8.2927354147114596e-6 * var_x30;
        IJth(rJacobian, 15, 2) = 6.7695799303767029e-6 * var_x30 - 6.7695799303767029e-6 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        ...
        IJth(rJacobian, 4, 4) = -0.02 * var_x145 - 2.0 * var_x148;
        IJth(rJacobian, 13, 4) = -var_x201 * var_x77;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x44 * var_x79 - var_x51 * var_x80 - var_x54 * var_x80);
        IJth(rJacobian, 5, 5) = ((var_x154) ? (-2.3999999999999999) : (-var_x153 * var_x158 - var_x153 * var_x161));
        IJth(rJacobian, 13, 5) = -var_x202 * var_x80;
        IJth(rJacobian, 14, 5) = var_x206 * var_x80;
        IJth(rJacobian, 15, 5) = -var_x214 * var_x80;
        IJth(rJacobian, 16, 5) = -var_x220 * var_x79;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x44 * var_x82 - var_x51 * var_x83 - var_x54 * var_x83);
        IJth(rJacobian, 6, 6) = ((var_x167) ? (-0.050000000000000003 + var_x172) : (var_x172 - var_x166 * var_x171));
        IJth(rJacobian, 13, 6) = -var_x202 * var_x83;
        IJth(rJacobian, 14, 6) = var_x206 * var_x83;
        IJth(rJacobian, 15, 6) = -var_x214 * var_x83;
        IJth(rJacobian, 16, 6) = -var_x220 * var_x82;
        IJth(rJacobian, 7, 7) = -0.001;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x44 * var_x84 - var_x51 * var_x85 - var_x54 * var_x85);
        IJth(rJacobian, 8, 8) = -0.02;
        IJth(rJacobian, 13, 8) = -var_x202 * var_x85;
        IJth(rJacobian, 14, 8) = var_x206 * var_x85;
        IJth(rJacobian, 15, 8) = -var_x214 * var_x85;
        IJth(rJacobian, 16, 8) = -var_x220 * var_x84;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.71578947368421042 * var_x86);
        IJth(rJacobian, 9, 9) = -0.0085800000000000008 / var_x176 - 8.5800000000000009e-6 * var_x174;
        IJth(rJacobian, 14, 9) = 5.2631227432035401e-5 * var_x86;
        IJth(rJacobian, 15, 9) = -4.2964267291457472e-5 * var_x86;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x1 * var_x32);
        IJth(rJacobian, 10, 10) = -0.33300000000000002;
        IJth(rJacobian, 14, 10) = var_x204 * var_x32;
        IJth(rJacobian, 15, 10) = -var_x212 * var_x32;
        IJth(rJacobian, 1, 11) = 0.10204081632653063 * var_x124;
        IJth(rJacobian, 11, 11) = ((var_x193) ? (-0.29999999999999999 - 5.0 * var_x195) : (-0.059999999999999998 - 1.0 * var_x195));
        IJth(rJacobian, 12, 11) = ((var_x193) ? (0.29999999999999999 + 2.5 * var_x195) : (0.059999999999999998 + 0.5 * var_x195));
        IJth(rJacobian, 18, 11) = -0.5 * var_x124;
        IJth(rJacobian, 11, 12) = ((var_x193) ? (-2.5 * var_x195) : (-0.5 * var_x195));
        IJth(rJacobian, 12, 12) = ((var_x193) ? (-0.0050000000000000001) : (-0.001));
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (0.0046052631578947364 * var_x96 + 2.9417408800779881e-13 * var_x98 - 0.028119748062837527 * var_x87 - 0.00023642457361733977 * var_x103 - 0.015773684210526315 * var_x102 - 168.71848837702515 * var_x94 - var_x92 * var_chaste_interface__extracellular_potassium_concentration__K_o + 2.9446855656436323e-16 * var_x100 * var_x97 - 1.5789473684210529e-5 * var_x101 * var_x14);
        IJth(rJacobian, 1, 13) = 9.4679344906248566e-7 * var_x102 - 1.7657390352968258e-17 * var_x98;
        IJth(rJacobian, 13, 13) = 5.2972171058904767e-17 * var_x98 + 8.2927354147114598e-7 * var_x96 - 1.419105609765594e-8 * var_x103 - 1.687848754916449e-6 * var_x87 - 2.8403803471874572e-6 * var_x102 - 0.010127092529498694 * var_x94 - var_x203 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        IJth(rJacobian, 14, 13) = 6.7724005886810246e-7 * var_x96 - var_x207 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        IJth(rJacobian, 15, 13) = -5.5284902764743069e-7 * var_x96 + var_x215 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x105 - var_x113 + 1.124789922513501 * var_x104 + 7.0927372085201944e-5 * var_x60 + 7.3684210526315779 * var_x110 + 0.012631578947368421 * var_x111 + 20.246218605243016 * var_x109 + var_x104 * var_x108 + var_x106 * var_x29 - var_x23 * var_x32 - var_x92 * var_chaste_interface__intracellular_sodium_concentration__Na_i);
        IJth(rJacobian, 13, 14) = 0.0013268376663538336 * var_x110 + 0.0012152511035398432 * var_x109 - var_x203 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        IJth(rJacobian, 14, 14) = -0.00069999999999999999 + var_x211 - var_x208 + 0.001083584094188964 * var_x110 - 8.2704588990905987e-5 * var_x104 - 5.215213115888558e-9 * var_x60 - 9.2878636644768348e-7 * var_x111 + var_x205 * var_x32 - var_x104 * var_x210 - var_x207 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x209 * var_x29;
        IJth(rJacobian, 15, 14) = var_x217 - var_x219 + 6.7513950196657958e-5 * var_x104 + 4.2573168292967824e-9 * var_x60 + 7.5819295220219063e-7 * var_x111 - 0.00088455844423588909 * var_x110 + var_x104 * var_x218 + var_x215 * var_chaste_interface__intracellular_sodium_concentration__Na_i + var_x216 * var_x29 - var_x213 * var_x32;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x106 - 1.124789922513501 * var_x15 - 7.0927372085201944e-5 * var_x103 - 20.246218605243016 * var_x94 + var_x113 * var_x16 - var_x105 * var_x16 - var_x108 * var_x15);
        IJth(rJacobian, 13, 15) = -0.0012152511035398432 * var_x94;
        IJth(rJacobian, 14, 15) = var_x209 + 8.2704588990905987e-5 * var_x15 + 5.215213115888558e-9 * var_x103 + var_x15 * var_x210 + var_x16 * var_x208 - var_x16 * var_x211;
        IJth(rJacobian, 15, 15) = -var_x216 - 6.7513950196657958e-5 * var_x15 - 4.2573168292967824e-9 * var_x103 + var_x16 * var_x219 - var_x15 * var_x218 - var_x16 * var_x217;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (1.285751456846303e-10 * var_x100 + 6.8942297368421057 * var_x14 * var_x9 + 1.4526315789473685e-8 * var_x13 * var_x99 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2));
        IJth(rJacobian, 1, 16) = 0.001;
        IJth(rJacobian, 8, 16) = -0.02 / var_x173 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x173, 2);
        IJth(rJacobian, 11, 16) = ((var_x193) ? (-var_x199 + 5.0 * var_x197) : (-var_x200 + 1.0 * var_x197));
        IJth(rJacobian, 12, 16) = ((var_x193) ? (var_x199) : (var_x200));
        IJth(rJacobian, 16, 16) = -0.01;
        IJth(rJacobian, 1, 17) = 7.1999999999999991e-9 * var_x117 + 9.5999999999999999e-8 * var_x119 - 1.7279999999999997e-12 * var_x120;
        IJth(rJacobian, 17, 17) = -0.050000000000000003 + 8.4671999999999982e-11 * var_x120 - 3.5279999999999993e-7 * var_x117 - 4.7039999999999993e-6 * var_x119;
        IJth(rJacobian, 18, 17) = 0.0050000000000000001;
        IJth(rJacobian, 1, 18) = 1.0204081632653063e-5 + 0.051020408163265314 * var_x123;
        IJth(rJacobian, 17, 18) = 0.050000000000000003;
        IJth(rJacobian, 18, 18) = -0.0050499999999999998 - 0.25 * var_x123;
        IJth(rJacobian, 1, 19) = 0.050000000000000003 + var_x125;
        IJth(rJacobian, 19, 19) = -0.050000000000000003 + var_x221;
        IJth(rJacobian, 1, 20) = 0.20000000000000001 + var_x125;
        IJth(rJacobian, 20, 20) = -0.20000000000000001 + var_x221;
    }
