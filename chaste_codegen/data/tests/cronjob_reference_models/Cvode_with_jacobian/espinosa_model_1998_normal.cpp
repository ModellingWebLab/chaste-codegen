...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellespinosa_model_1998_normalFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x0 = -0.12631578947368419 - 0.71578947368421053 * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        const double var_x36 = exp(1.8716945411372736 + var_x28);
        ...
        const double var_x54 = 0.00023642457361733977 * var_x53;
        ...
        const double var_x63 = var_x53 * var_x61;
        const double var_x64 = var_x46 * var_x50 * var_x56 / pow(var_x47, 2);
        ...
        const double var_x70 = var_x25 * var_x69 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x71 = 6.1073194200199382e-5 + 7.6341492750249225e-7 * var_x4;
        const double var_x72 = var_x24 * var_x69 / pow((var_x71 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x73 = var_x26 * var_x9;
        ...
        const double var_x94 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x95 = var_x67 - var_x68 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x96 = var_x11 * var_x95 / pow((var_x71 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2);
        const double var_x97 = var_x72 * var_x94;
        const double var_x98 = var_chaste_interface__extracellular_potassium_concentration__K_o * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x99 = var_x90 * var_x98 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x100 = var_x6 * var_x94;
        const double var_x101 = var_x100 * var_x26;
        ...
        const double var_x104 = 33.743697675405031 * var_x22;
        const double var_x105 = 0.11278195488721804 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x106 = var_x87 / var_x76;
        const double var_x107 = 26.713760659695652 * var_x1;
        const double var_x108 = var_x20 * var_x33 / pow((1 + 0.10000000000000001 * var_chaste_interface__extracellular_potassium_concentration__K_o), 2);
        const double var_x109 = var_x91 * var_x98 / pow(var_x89, 2);
        const double var_x110 = var_x32 * var_x34;
        const double var_x111 = 2.1094736842105264 * var_x110;
        ...
        const double var_x198 = 1.419105609765594e-8 * var_x53;
        ...
        const double var_x202 = 9.2878636644768344e-5 * var_x22;
        const double var_x203 = 5.215213115888558e-9 * var_x44;
        const double var_x204 = 0.001083584094188964 * var_x92;
        const double var_x205 = 8.2927354147114596e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x206 = 0.0024811376697271795 * var_x22;
        const double var_x207 = 26.713760659695652 * var_x201;
        const double var_x208 = 0.00015510732319676314 * var_x110;
        const double var_x209 = -7.5819295220219072e-6 - 4.2964267291457472e-5 * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x210 = var_x209 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x211 = 7.5819295220219067e-5 * var_x22;
        ...
        const double var_x215 = 0.0020254185058997385 * var_x22;
        const double var_x216 = 26.713760659695652 * var_x210;
        const double var_x217 = 0.00012661822301776585 * var_x110;
        const double var_x218 = 2.8382112195311883e-5 * var_x51;
        const double var_x219 = 0.25 * var_x121;
        const double var_x220 = -var_x124;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.045789473684210526 + var_x1 + 2.6550875029816942e-6 * var_x62 + 8.8502916766056468e-6 * var_x63 + 0.078965807588191494 * var_x35 + 0.0070802333412845189 * var_x64 - 2.6550875029816942e-6 * var_x65 - 0.0021031578947368419 * var_x27 - 0.0042218673860239253 * var_x31 - 0.017700583353211296 * var_x58 - 0.0013142683139759387 * var_x60 - var_x23 * var_chaste_interface__extracellular_potassium_concentration__K_o - var_x3 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x40 * var_x52 - var_x41 * var_x45 - var_x41 * var_x54 - 2.1052631578947371e-6 * var_x14 * (var_x8 + var_x10 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds));
        ...
        IJth(rJacobian, 13, 0) = -6.3182746016849228e-8 + 5.3122644461910889e-10 * var_x63 - 7.8887127025937665e-8 * var_x60 - 3.7871737962499429e-7 * var_x27 - var_x197 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x198 * var_x41;
        IJth(rJacobian, 14, 0) = 3.0959545548256117e-6 + var_x201 + 1.9522571839752251e-10 * var_x65 + 3.1042935213622369e-7 * var_x31 - 1.9522571839752251e-10 * var_x62 - 5.8062706023559271e-6 * var_x35 + var_x202 * var_chaste_interface__extracellular_potassium_concentration__K_o + var_x203 * var_x41;
        IJth(rJacobian, 15, 0) = -2.5273098406739689e-6 + var_x210 + 4.7398127366170842e-6 * var_x35 + 1.5936793338573268e-10 * var_x62 - 1.5936793338573268e-10 * var_x65 - 2.5341171602957037e-7 * var_x31 - var_x211 * var_chaste_interface__extracellular_potassium_concentration__K_o - var_x212 * var_x41;
        IJth(rJacobian, 16, 0) = 2.1249057784764359e-6 * var_x64 - 5.3122644461910897e-6 * var_x58 - var_x218 * var_x40;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (1.4511789473684209e-5 * var_x70 + 1.2844657053894564e-7 * var_x72 + 6887.3355071052629 * var_x73 - 0.035149685078546905 * var_x66 - 0.094569829446935927 * var_x74);
        IJth(rJacobian, 1, 1) = -7.0 + var_x112 + var_x113 + 0.00040000000000000002 * var_x117 - 0.00040000000000000002 * var_x115 - 7.1999999999999991e-9 * var_x118 - 7.7098266909426342e-12 * var_x72 - 0.41340273157434637 * var_x73 - 1.0549054718227806e-6 * var_x66 - 8.7104997313748684e-10 * var_x70;
        ...
        IJth(rJacobian, 13, 1) = 1.240208194723039 * var_x73 + 2.6131499194124605e-9 * var_x70 + 2.3129480072827904e-11 * var_x72;
        ...
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : ((19.121428682729519 * var_x17 - 0.71578947368421053 * var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 9, 9) = -0.0085800000000000008 / var_x169 - 8.5800000000000009e-6 * var_x167;
        IJth(rJacobian, 14, 9) = (5.2631227432035401e-5 * var_chaste_interface__membrane__V - 0.0014059780128454018 * var_x17) * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 15, 9) = (0.0011477371533431854 * var_x17 - 4.2964267291457472e-5 * var_chaste_interface__membrane__V) * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (2.9417408800779881e-13 * var_x97 + 0.0046052631578947364 * var_x99 - 0.028119748062837527 * var_x86 - 168.71848837702515 * var_x88 - 0.015773684210526315 * var_x101 - 0.00023642457361733977 * var_x102 - var_x93 * var_chaste_interface__extracellular_potassium_concentration__K_o + 2.9446855656436323e-16 * var_x94 * var_x96 - 1.5789473684210526e-5 * var_x100 * var_x14);
        IJth(rJacobian, 1, 13) = 9.4679344906248566e-7 * var_x101 - 1.7657390352968258e-17 * var_x97;
        IJth(rJacobian, 13, 13) = 5.2972171058904767e-17 * var_x97 + 8.2927354147114608e-7 * var_x99 - 1.419105609765594e-8 * var_x102 - 0.010127092529498694 * var_x88 - 2.8403803471874572e-6 * var_x101 - 1.687848754916449e-6 * var_x86 - var_x199 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        IJth(rJacobian, 14, 13) = 6.7724005886810257e-7 * var_x99 - var_x204 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        IJth(rJacobian, 15, 13) = -5.5284902764743069e-7 * var_x99 + var_x213 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x104 - var_x111 + 1.124789922513501 * var_x103 + 0.012631578947368421 * var_x108 + 7.0927372085201944e-5 * var_x60 + 20.246218605243016 * var_x106 + 7.3684210526315779 * var_x109 + var_x105 * var_x29 - var_x103 * var_x107 - var_x23 * var_x32 - var_x93 * var_chaste_interface__intracellular_sodium_concentration__Na_i);
        IJth(rJacobian, 13, 14) = 0.0012152511035398432 * var_x106 + 0.0013268376663538336 * var_x109 - var_x199 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        IJth(rJacobian, 14, 14) = -0.00069999999999999999 + var_x208 - var_x206 + 0.001083584094188964 * var_x109 - 5.215213115888558e-9 * var_x60 - 8.2704588990905987e-5 * var_x103 - 9.2878636644768348e-7 * var_x108 + var_x202 * var_x32 - var_x103 * var_x207 - var_x204 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x205 * var_x29;
        IJth(rJacobian, 15, 14) = var_x215 - var_x217 + 4.2573168292967824e-9 * var_x60 + 6.7513950196657958e-5 * var_x103 + 7.5819295220219074e-7 * var_x108 - 0.00088455844423588909 * var_x109 + var_x213 * var_chaste_interface__intracellular_sodium_concentration__Na_i + var_x214 * var_x29 - var_x103 * var_x216 - var_x211 * var_x32;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x105 - 1.124789922513501 * var_x15 - 7.0927372085201944e-5 * var_x102 - 20.246218605243016 * var_x88 + var_x107 * var_x15 + var_x111 * var_x16 - var_x104 * var_x16);
        IJth(rJacobian, 13, 15) = -0.0012152511035398432 * var_x88;
        IJth(rJacobian, 14, 15) = var_x205 + 5.215213115888558e-9 * var_x102 + 8.2704588990905987e-5 * var_x15 + var_x15 * var_x207 + var_x16 * var_x206 - var_x16 * var_x208;
        IJth(rJacobian, 15, 15) = -var_x214 - 4.2573168292967824e-9 * var_x102 - 6.7513950196657958e-5 * var_x15 + var_x15 * var_x216 + var_x16 * var_x217 - var_x16 * var_x215;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (1.2857514568463027e-10 * var_x96 + 6.8942297368421057 * var_x14 * var_x9 + 1.4526315789473684e-8 * var_x13 * var_x95 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2));
        ...
        IJth(rJacobian, 1, 17) = 9.5999999999999999e-8 * var_x117 + 7.1999999999999991e-9 * var_x115 - 1.7279999999999997e-12 * var_x118;
        ...
        IJth(rJacobian, 18, 18) = -0.0050500000000000007 - var_x219;
