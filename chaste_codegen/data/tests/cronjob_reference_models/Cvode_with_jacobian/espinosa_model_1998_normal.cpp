...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellespinosa_model_1998_normalFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x171 = exp(2.0 + var_x140);
        ...
        const double var_x181 = pow(var_x180, 1.0);
        const double var_x182 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x173, 2);
        const double var_x183 = var_x181 * (var_x174 - var_x182 + var_x177 * (var_x182 - var_x174) * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x184 = var_x172 * var_x183;
        const double var_x185 = var_x183 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x186 = 5.0 * var_x185;
        const double var_x187 = var_chaste_interface__membrane__V < -50.0;
        const double var_x188 = 1.0 * var_x185;
        const double var_x189 = pow(var_x180, 2.0);
        const double var_x190 = var_x181 * (var_x179 - var_x178 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x176, 2));
        const double var_x191 = var_x172 * var_x190;
        const double var_x192 = var_x190 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x193 = 5.0 * var_x192;
        const double var_x194 = 1.0 * var_x192;
        const double var_x195 = 0.00037909647610109533 * var_x2;
        const double var_x196 = 1.419105609765594e-8 * var_x50;
        const double var_x197 = 0.0013268376663538336 * var_x91;
        const double var_x198 = 6.1919091096512239e-5 * var_x0;
        const double var_x199 = 9.2878636644768344e-5 * var_x22;
        const double var_x200 = 5.215213115888558e-9 * var_x53;
        const double var_x201 = 0.001083584094188964 * var_x91;
        const double var_x202 = 0.0024811376697271795 * var_x22;
        const double var_x203 = 8.2927354147114596e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x204 = 0.0016540917798181199 * var_x107;
        const double var_x205 = 0.00015510732319676314 * var_x112;
        const double var_x206 = 5.054619681347938e-5 * var_x0;
        const double var_x207 = 7.5819295220219067e-5 * var_x22;
        const double var_x208 = 4.2573168292967824e-9 * var_x53;
        const double var_x209 = 0.00088455844423588909 * var_x91;
        const double var_x210 = 6.7695799303767029e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x211 = 0.0020254185058997385 * var_x22;
        const double var_x212 = 0.0013502790039331592 * var_x107;
        const double var_x213 = 0.00012661822301776585 * var_x112;
        const double var_x214 = 2.8382112195311883e-5 * var_x43;
        const double var_x215 = -var_x125;
        ...
        IJth(rJacobian, 4, 0) = -0.0025000000000000001 * var_x145 * (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x146 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x146), 2);
        IJth(rJacobian, 5, 0) = ((var_x148) ? (0) : (var_x149 * var_x152 - var_x155 * var_chaste_interface__L_type_Ca_channel_d_gate__d + 0.016 * var_x147 * var_x153 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x154, 2) - 0.099999999999999992 * var_x147 * var_x149 * var_x150 / pow(var_x151, 2)));
        IJth(rJacobian, 6, 0) = ((var_x161) ? (var_x159) : (var_x159 + var_x162 * var_x165 - 0.0022727272727272731 * var_x160 * var_x162 * var_x163 / pow(var_x164, 2)));
        IJth(rJacobian, 9, 0) = -5.7680672268907566e-7 * var_x168 * (1.0 - var_chaste_interface__transient_outward_current_s_gate__s) - 0.0012257142857142857 * var_x169 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x170, 2);
        IJth(rJacobian, 10, 0) = 0.033300000000000003 * var_x171 / pow((1.0 + var_x171), 2);
        IJth(rJacobian, 13, 0) = -6.3182746016849228e-8 + 5.3122644461910889e-10 * var_x64 - 3.7871737962499429e-7 * var_x27 - 7.8887127025937665e-8 * var_x60 - var_x195 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x196 * var_x48;
        IJth(rJacobian, 14, 0) = 3.0959545548256117e-6 + 3.1042935213622369e-7 * var_x31 + 1.9522571839752251e-10 * var_x65 - 5.806270602355928e-6 * var_x35 - 1.9522571839752251e-10 * var_x63 + var_x198 * var_chaste_interface__transient_outward_current_r_gate__r + var_x199 * var_chaste_interface__extracellular_potassium_concentration__K_o + var_x200 * var_x48;
        IJth(rJacobian, 15, 0) = -2.5273098406739689e-6 + 4.7398127366170842e-6 * var_x35 + 1.5936793338573268e-10 * var_x63 - 2.5341171602957037e-7 * var_x31 - 1.5936793338573268e-10 * var_x65 - var_x206 * var_chaste_interface__transient_outward_current_r_gate__r - var_x207 * var_chaste_interface__extracellular_potassium_concentration__K_o - var_x208 * var_x48;
        IJth(rJacobian, 16, 0) = 2.1249057784764359e-6 * var_x61 - 5.3122644461910897e-6 * var_x58 - var_x214 * var_x37;
        ...
        IJth(rJacobian, 11, 1) = ((var_x187) ? (-var_x186 + 5.0 * var_x184) : (-var_x188 + 1.0 * var_x184));
        IJth(rJacobian, 12, 1) = ((var_x187) ? (var_x186) : (var_x188));
        ...
        IJth(rJacobian, 13, 4) = -var_x195 * var_x77;
        ...
        IJth(rJacobian, 13, 5) = -var_x196 * var_x80;
        IJth(rJacobian, 14, 5) = var_x200 * var_x80;
        IJth(rJacobian, 15, 5) = -var_x208 * var_x80;
        IJth(rJacobian, 16, 5) = -var_x214 * var_x79;
        ...
        IJth(rJacobian, 13, 6) = -var_x196 * var_x83;
        IJth(rJacobian, 14, 6) = var_x200 * var_x83;
        IJth(rJacobian, 15, 6) = -var_x208 * var_x83;
        IJth(rJacobian, 16, 6) = -var_x214 * var_x82;
        ...
        IJth(rJacobian, 13, 8) = -var_x196 * var_x85;
        IJth(rJacobian, 14, 8) = var_x200 * var_x85;
        IJth(rJacobian, 15, 8) = -var_x208 * var_x85;
        IJth(rJacobian, 16, 8) = -var_x214 * var_x84;
        ...
        IJth(rJacobian, 14, 10) = var_x198 * var_x32;
        IJth(rJacobian, 15, 10) = -var_x206 * var_x32;
        IJth(rJacobian, 1, 11) = 0.10204081632653063 * var_x124;
        IJth(rJacobian, 11, 11) = ((var_x187) ? (-0.29999999999999999 - 5.0 * var_x189) : (-0.059999999999999998 - 1.0 * var_x189));
        IJth(rJacobian, 12, 11) = ((var_x187) ? (0.29999999999999999 + 2.5 * var_x189) : (0.059999999999999998 + 0.5 * var_x189));
        IJth(rJacobian, 18, 11) = -0.5 * var_x124;
        IJth(rJacobian, 11, 12) = ((var_x187) ? (-2.5 * var_x189) : (-0.5 * var_x189));
        IJth(rJacobian, 12, 12) = ((var_x187) ? (-0.0050000000000000001) : (-0.001));
        ...
        IJth(rJacobian, 13, 13) = 5.2972171058904767e-17 * var_x98 + 8.2927354147114598e-7 * var_x96 - 1.419105609765594e-8 * var_x103 - 1.687848754916449e-6 * var_x87 - 2.8403803471874572e-6 * var_x102 - 0.010127092529498694 * var_x94 - var_x197 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        IJth(rJacobian, 14, 13) = 6.7724005886810246e-7 * var_x96 - var_x201 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        IJth(rJacobian, 15, 13) = -5.5284902764743069e-7 * var_x96 + var_x209 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        ...
        IJth(rJacobian, 13, 14) = 0.0013268376663538336 * var_x110 + 0.0012152511035398432 * var_x109 - var_x197 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        IJth(rJacobian, 14, 14) = -0.00069999999999999999 + var_x205 - var_x202 + 0.001083584094188964 * var_x110 - 8.2704588990905987e-5 * var_x104 - 5.215213115888558e-9 * var_x60 - 9.2878636644768348e-7 * var_x111 + var_x199 * var_x32 - var_x104 * var_x204 - var_x201 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x203 * var_x29;
        IJth(rJacobian, 15, 14) = var_x211 - var_x213 + 6.7513950196657958e-5 * var_x104 + 4.2573168292967824e-9 * var_x60 + 7.5819295220219063e-7 * var_x111 - 0.00088455844423588909 * var_x110 + var_x104 * var_x212 + var_x209 * var_chaste_interface__intracellular_sodium_concentration__Na_i + var_x210 * var_x29 - var_x207 * var_x32;
        ...
        IJth(rJacobian, 14, 15) = var_x203 + 8.2704588990905987e-5 * var_x15 + 5.215213115888558e-9 * var_x103 + var_x15 * var_x204 + var_x16 * var_x202 - var_x16 * var_x205;
        IJth(rJacobian, 15, 15) = -var_x210 - 6.7513950196657958e-5 * var_x15 - 4.2573168292967824e-9 * var_x103 + var_x16 * var_x213 - var_x15 * var_x212 - var_x16 * var_x211;
        ...
        IJth(rJacobian, 11, 16) = ((var_x187) ? (-var_x193 + 5.0 * var_x191) : (-var_x194 + 1.0 * var_x191));
        IJth(rJacobian, 12, 16) = ((var_x187) ? (var_x193) : (var_x194));
        ...
        IJth(rJacobian, 19, 19) = -0.050000000000000003 + var_x215;
        IJth(rJacobian, 1, 20) = 0.20000000000000001 + var_x125;
        IJth(rJacobian, 20, 20) = -0.20000000000000001 + var_x215;
    }
