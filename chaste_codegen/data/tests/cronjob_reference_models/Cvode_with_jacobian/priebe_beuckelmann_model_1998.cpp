...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x75 = 0.042999999999999997 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki;
        ...
        const double var_x80 = 0.018329999999999999 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki;
        const double var_x81 = -26.725757487819564 * log(6.5295399999999999 / var_x80) + var_chaste_interface__cell__V;
        const double var_x82 = var_x81 * pow(var_chaste_interface__IKs_Xs_gate__Xs, 1.0);
        const double var_x83 = 0.026725757487819565 * var_x34;
        ...
        const double var_x87 = var_x25 * var_x26;
        const double var_x88 = var_x34 * var_x87;
        const double var_x89 = 1 / var_x41;
        const double var_x90 = var_x34 * var_x35 * var_x89 / pow((0.031622776601683791 + var_x35), 2);
        const double var_x91 = var_x7 * (0.10066438494060802 * var_chaste_interface__Ionic_concentrations__Ki + 0.004328568552446144 * var_chaste_interface__Ionic_concentrations__Nai) / pow(var_x75, 2);
        const double var_x92 = 3.4248684060035934 * var_x91;
        const double var_x93 = 0.40088636231729347 * var_x4 * var_x9 * var_chaste_interface__IKr_Xr_gate__Xr;
        const double var_x94 = 3.490138050940347 * var_x85;
        const double var_x95 = 6.681439371954891 * var_x23 * var_x9;
        const double var_x96 = var_x45 * var_x9;
        const double var_x97 = var_x49 * (0.16035454492691739 * var_x96 - var_x16 * (2.6725757487819566 * var_x18 * var_x9 + 0.016035454492691739 * var_x19 * var_x9) - 13.362878743909782 * var_x48 * var_x9);
        const double var_x98 = 79.648102465199855 * var_x91;
        const double var_x99 = 0.40088636231729347 * var_x46 * var_x96;
        ...
        const double var_x102 = 1.0 + 0.00011900000000000002 * pow(var_x100, (-2.0)) + 3.5000000000000004e-5 * pow(var_x101, (-2.0));
        const double var_x103 = 1 / var_x102;
        const double var_x104 = 3.8399999999999998e-5 * var_x68;
        const double var_x105 = 0.00084999999999999995 + var_x104;
        const double var_x106 = 1 / M_PI;
        const double var_x107 = 9.6612568413217634e-5 * var_x106;
        ...
        const double var_x111 = var_x109 * var_x110 * var_chaste_interface__Irel__APtrack2;
        const double var_x112 = 1.0 - var_chaste_interface__Irel__APtrack2;
        const double var_x113 = 0.1552941176470588 * var_x112;
        ...
        const double var_x119 = var_x62 + var_x69 - 3.8399999999999998e-5 * var_x67;
        const double var_x120 = -var_x117 + 0.00036529411764705876 * var_x118 - var_x107 * (var_x119 + 471.5206420294254 * var_x63);
        const double var_x121 = 1.0 * var_x103;
        const double var_x122 = -var_chaste_interface__Ionic_concentrations__Cai + var_chaste_interface__Ionic_concentrations__Ca_JSR;
        const double var_x123 = -0.011358446932323314 * var_x65;
        const double var_x124 = var_x53 * var_x58;
        const double var_x125 = 2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR - var_x107 * (var_x123 + 0.00084999999999999995 * var_chaste_interface__cell__V - 0.00017941694216498839 * var_x124 + var_x104 * var_x66) - var_x117 * var_chaste_interface__Ionic_concentrations__Cai;
        const double var_x126 = 1.0 * (0.00023800000000000004 * pow(var_x100, (-3.0)) + 7.0000000000000007e-5 * pow(var_x101, (-3.0))) / pow(var_x102, 2);
        const double var_x127 = var_chaste_interface__Irel__Cainfluxtrack > 5.0000000000000004e-6;
        const double var_x128 = 3.7099226270675569e-9 * var_x106 * var_x31 * var_x66;
        const double var_x129 = var_x128 * var_chaste_interface__ICa_f_gate__f;
        const double var_x130 = var_x128 * var_chaste_interface__ICa_d_gate__d;
        const double var_x131 = var_x109 * var_x122;
        const double var_x132 = var_x113 * var_x131;
        const double var_x133 = var_x111 * var_x122;
        const double var_x134 = var_x110 * var_x122 * var_chaste_interface__Irel__APtrack2 / pow(var_x108, 2);
        const double var_x135 = var_x106 * var_x84;
        const double var_x136 = 1.0 - var_chaste_interface__INa_m_gate__m;
        const double var_x137 = -var_x17;
        ...
        const double var_x142 = 0.0072727272727272727 * var_x141 * var_chaste_interface__INa_m_gate__m;
        ...
        const double var_x152 = 1.0 - var_chaste_interface__INa_j_gate__j;
        ...
        const double var_x165 = var_x152 * var_x164;
        ...
        const double var_x170 = -1 + 0.044722719141323794 * var_chaste_interface__cell__V;
        const double var_x171 = 1 / sqrt(M_PI);
        const double var_x172 = var_x171 * exp(-0.89836705491478086 * pow(var_x170, 2.0));
        const double var_x173 = -1 + 0.15937778911130945 * var_chaste_interface__cell__V;
        const double var_x174 = var_x171 * exp(-0.08830693125184777 * pow(var_x173, 2.0));
        const double var_x175 = exp(-2.7305064499999996 - 0.27789999999999998 * var_chaste_interface__cell__V);
        const double var_x176 = 1.0 + var_x175;
        const double var_x177 = 1 / var_x176;
        const double var_x178 = exp(-1.06213655 - 0.1081 * var_chaste_interface__cell__V);
        const double var_x179 = 0.0112 + 0.068699999999999997 * var_x178;
        const double var_x180 = exp(-1.0052757950443461 + 0.16333730787449161 * var_chaste_interface__cell__V);
        const double var_x181 = 1.0 + var_x180;
        const double var_x182 = exp(6.9907280000000006e-6 - 0.1348 * var_chaste_interface__cell__V);
        const double var_x183 = 1.0 + var_x182;
        const double var_x184 = 1 / var_x183;
        const double var_x185 = exp(0.67236288 - 0.13439999999999999 * var_chaste_interface__cell__V);
        const double var_x186 = 1.0 - var_chaste_interface__Ito_r_gate__r;
        const double var_x187 = exp(3.9880601600000003 - 0.094299999999999995 * var_chaste_interface__cell__V);
        const double var_x188 = 1.0 + var_x187;
        const double var_x189 = exp(0.70203392000000009 - 0.0166 * var_chaste_interface__cell__V);
        const double var_x190 = var_x189 / var_x188;
        const double var_x191 = 0.51490000000000002 * var_x185 + 5.1860000000000002e-5 * var_chaste_interface__cell__V;
        const double var_x192 = exp(-5.9326369200000002 - 0.17319999999999999 * var_chaste_interface__cell__V);
        const double var_x193 = 1.0 + var_x192;
        const double var_x194 = 1 / var_x193;
        const double var_x195 = 1.0 - var_chaste_interface__Ito_t_gate__t;
        const double var_x196 = exp(-5.9257863000000004 - 0.17299999999999999 * var_chaste_interface__cell__V);
        const double var_x197 = exp(-5.4573693999999993 - 0.16039999999999999 * var_chaste_interface__cell__V);
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = 1 / var_x198;
        const double var_x200 = exp(-5.6479010000000002e-8 - 1.6600000000000001e-9 * var_chaste_interface__cell__V);
        const double var_x201 = 5.6119999999999998e-5 * var_chaste_interface__cell__V + 0.072099999999999997 * var_x196;
        const double var_x202 = 0.0001215 * var_chaste_interface__cell__V + 0.076700000000000004 * var_x200;
        const double var_x203 = exp(-0.17842998931347828 - 0.069846547135942336 * var_chaste_interface__cell__V);
        const double var_x204 = 1.0 + var_x203;
        const double var_x205 = exp(1.0082174462705435 + 0.063211125158027806 * var_chaste_interface__cell__V);
        const double var_x206 = 1.0 + var_x205;
        const double var_x207 = 1.0 - var_chaste_interface__IKr_Xr_gate__Xr;
        const double var_x208 = exp(-0.51325540000000003 - 0.12620000000000001 * var_chaste_interface__cell__V);
        const double var_x209 = 1.0 + var_x208;
        const double var_x210 = exp(0.0021416822000000003 + 0.00052660000000000001 * var_chaste_interface__cell__V);
        const double var_x211 = var_x210 / var_x209;
        const double var_x212 = exp(5.1411779999999991 + 0.078299999999999995 * var_chaste_interface__cell__V);
        const double var_x213 = 1.0 + var_x212;
        const double var_x214 = exp(0.105056 + 0.0016000000000000001 * var_chaste_interface__cell__V);
        const double var_x215 = var_x214 / var_x213;
        const double var_x216 = (var_chaste_interface__Irel__APtrack > 0.17999999999999999) && (var_chaste_interface__Irel__APtrack < 0.20000000000000001);
        const double var_x217 = var_chaste_interface__Irel__APtrack > 0.20000000000000001;
        const double var_x218 = var_x36 * var_x42;
        const double var_x219 = 0.00019322513682643527 * var_x106;
        const double var_x220 = 0.0030916021892229643 * var_x106 * var_x26 * var_x71;
        const double var_x221 = var_x219 * (var_x78 - var_x77);
        const double var_x222 = 0.80000000000000004 + var_chaste_interface__Ionic_concentrations__Ca_JSR;
        const double var_x223 = pow(var_x222, (-2.0));
        const double var_x224 = 1 / (1.0 + 8.0 * var_x223);
        const double var_x225 = 22.0 * var_x112;
        const double var_x226 = var_x111 * var_x225;
        const double var_x227 = 22.0 * var_x133;
        const double var_x228 = var_x131 * var_x225;
        const double var_x229 = 1.0 * var_x224;
        const double var_x230 = 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_JSR;
        const double var_x231 = 0.25 * pow(var_x222, (-3.0)) / pow((0.125 + var_x223), 2);
        const double var_x232 = 0.0055555555555555558 * var_x224;
        ...
        IJth(rJacobian, 1, 0) = -var_x103 * var_x107 * (var_x105 - 4.3636185975418378e-7 * var_x59 - 0.00017941694216498839 * var_x57);
        IJth(rJacobian, 2, 0) = ((var_x144) ? (var_x142 + var_x136 * var_x140 - 0.032000000000000001 * var_x136 * var_x138 * var_x143 / pow(var_x139, 2)) : (var_x142));
        IJth(rJacobian, 3, 0) = ((var_x149) ? ((-0.28123999999999999 * var_x146 - 108500.0 * var_x147) * var_chaste_interface__INa_h_gate__h - 0.14705882352941177 * var_x148 * (0.13500000000000001 - 0.13500000000000001 * var_chaste_interface__INa_h_gate__h)) : (-0.693000693000693 * var_x150 * var_chaste_interface__INa_h_gate__h / pow(var_x151, 2)));
        IJth(rJacobian, 4, 0) = ((var_x149) ? (var_x152 * var_x159 + 0.001275024 * var_x163 * var_chaste_interface__INa_j_gate__j + var_x155 * var_x165 * (1.5254334000000001e-6 * var_x157 - 31022.16 * var_x156) - 0.311 * var_x153 * var_x158 * var_x165 / pow(var_x154, 2) - 0.016701360000000002 * var_x160 * var_x162 * var_chaste_interface__INa_j_gate__j / pow(var_x161, 2)) : (7.6049999999999996e-8 * var_x169 * var_chaste_interface__INa_j_gate__j - 0.029999999999999999 * var_x166 * var_x168 * var_chaste_interface__INa_j_gate__j / pow(var_x167, 2)));
        IJth(rJacobian, 5, 0) = -0.051044617407047757 * var_x172 * pow(var_x170, 1.0) * (1.0 - var_chaste_interface__ICa_d_gate__d) - 0.0070656748908302881 * var_x174 * pow(var_x173, 1.0) * var_chaste_interface__ICa_d_gate__d;
        IJth(rJacobian, 6, 0) = (0.0074264700000000001 * var_x177 * var_x178 - 0.27789999999999998 * var_x175 * var_x179 / pow(var_x176, 2)) * var_chaste_interface__ICa_f_gate__f - 0.0011224539797135063 * var_x180 * (1.0 - var_chaste_interface__ICa_f_gate__f) / pow(var_x181, 2);
        IJth(rJacobian, 7, 0) = -0.0087415599999999989 * var_x186 * var_x190 - var_x184 * (5.1860000000000002e-5 - 0.069202559999999996 * var_x185) * var_chaste_interface__Ito_r_gate__r + 0.049658379999999995 * var_x186 * var_x187 * var_x189 / pow(var_x188, 2) - 0.1348 * var_x182 * var_x191 * var_chaste_interface__Ito_r_gate__r / pow(var_x183, 2);
        IJth(rJacobian, 8, 0) = var_x194 * var_x195 * (5.6119999999999998e-5 - 0.012473299999999998 * var_x196) - var_x199 * (0.0001215 - 1.2732200000000002e-10 * var_x200) * var_chaste_interface__Ito_t_gate__t + 0.17319999999999999 * var_x192 * var_x195 * var_x201 / pow(var_x193, 2) - 0.16039999999999999 * var_x197 * var_x202 * var_chaste_interface__Ito_t_gate__t / pow(var_x198, 2);
        IJth(rJacobian, 9, 0) = 0.00021044764652059425 * var_x203 * (1.0 - var_chaste_interface__IKs_Xs_gate__Xs) / pow(var_x204, 2) + 0.00037104930467762328 * var_x205 * var_chaste_interface__IKs_Xs_gate__Xs / pow(var_x206, 2);
        IJth(rJacobian, 10, 0) = 2.633e-6 * var_x207 * var_x211 - 2.5600000000000002e-5 * var_x215 * var_chaste_interface__IKr_Xr_gate__Xr + 0.0012527999999999999 * var_x212 * var_x214 * var_chaste_interface__IKr_Xr_gate__Xr / pow(var_x213, 2) + 0.00063100000000000005 * var_x207 * var_x208 * var_x210 / pow(var_x209, 2);
        IJth(rJacobian, 14, 0) = ((var_x217) ? (-var_x107 * (var_x105 + var_x60)) : (0));
        IJth(rJacobian, 18, 0) = -var_x219 * (0.001 + 16.0 * var_x87 + 0.00026912541324748262 * var_x57 + 2.8363636363636364 * var_x218 + 6.5454278963127559e-7 * var_x59);
        IJth(rJacobian, 19, 0) = -var_x219 * (var_x24 + var_x50 + var_x6 + var_x8 - var_x44 - var_x47 + 0.02 * var_x0 - 1.8909090909090911 * var_x218);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 - var_x62 - var_x69 + 3.8399999999999998e-5 * var_x67);
        IJth(rJacobian, 1, 1) = ((var_x127) ? (var_x121 * (var_x120 - var_x114) + var_x126 * (var_x125 + var_x114 * var_x122)) : (var_x120 * var_x121 + var_x125 * var_x126));
        IJth(rJacobian, 14, 1) = ((var_x217) ? (-var_x107 * (var_x119 + var_x64)) : (0));
        IJth(rJacobian, 18, 1) = 0.13666446085893647 * var_x106 * var_x63;
        IJth(rJacobian, 20, 1) = ((var_x127) ? (var_x224 * var_x226) : (0));
        ...
        IJth(rJacobian, 2, 2) = ((var_x144) ? (var_x145 - var_x140 * var_x143) : (-3.2000000000000002 + var_x145));
        IJth(rJacobian, 18, 2) = -0.0092748065676688928 * var_x106 * var_x72;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x73 * var_chaste_interface__INa_j_gate__j);
        IJth(rJacobian, 3, 3) = ((var_x149) ? (-310000.0 * var_x147 - 0.13500000000000001 * var_x148 - 3.5600000000000001 * var_x146) : (-7.6923076923076916 / var_x151));
        IJth(rJacobian, 18, 3) = -var_x220 * var_chaste_interface__INa_j_gate__j;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x73 * var_chaste_interface__INa_h_gate__h);
        IJth(rJacobian, 4, 4) = ((var_x149) ? (-0.1212 * var_x163 - var_x159 * var_x164) : (-0.29999999999999999 * var_x169));
        IJth(rJacobian, 18, 4) = -var_x220 * var_chaste_interface__INa_h_gate__h;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x74 * var_chaste_interface__ICa_f_gate__f);
        IJth(rJacobian, 1, 5) = -var_x103 * var_x129;
        IJth(rJacobian, 5, 5) = -0.14710000000000001 + 0.25101580310038191 * var_x174 - 0.63524014987941491 * var_x172;
        IJth(rJacobian, 14, 5) = ((var_x217) ? (-var_x129) : (0));
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x74 * var_chaste_interface__ICa_d_gate__d);
        IJth(rJacobian, 1, 6) = -var_x103 * var_x130;
        IJth(rJacobian, 6, 6) = -0.00054739999999999997 - 0.0068719999999999996 / var_x181 - var_x177 * var_x179;
        IJth(rJacobian, 14, 6) = ((var_x217) ? (-var_x130) : (0));
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79 * var_chaste_interface__Ito_t_gate__t);
        IJth(rJacobian, 7, 7) = -0.52659999999999996 * var_x190 - var_x184 * var_x191;
        IJth(rJacobian, 19, 7) = -var_x221 * var_chaste_interface__Ito_t_gate__t;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79 * var_chaste_interface__Ito_r_gate__r);
        IJth(rJacobian, 8, 8) = -var_x194 * var_x201 - var_x199 * var_x202;
        IJth(rJacobian, 19, 8) = -var_x221 * var_chaste_interface__Ito_r_gate__r;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.040000000000000001 * var_x82);
        IJth(rJacobian, 9, 9) = -0.0058700000000000002 / var_x206 - 0.0030130000000000001 / var_x204;
        IJth(rJacobian, 19, 9) = -7.7290054730574101e-6 * var_x106 * var_x82;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x43 * var_x5);
        IJth(rJacobian, 10, 10) = -0.016 * var_x215 - 0.0050000000000000001 * var_x211;
        IJth(rJacobian, 19, 10) = -2.8983770523965286e-6 * var_x106 * var_x4 * var_x43;
        IJth(rJacobian, 11, 11) = ((var_x123 + 0.0018500000000000001 * var_chaste_interface__cell__V + 8.9708471082494196e-5 * var_x124 - 0.026725757487819565 * var_x70 + var_x1 * var_x81 + var_x24 * var_x43 + var_x28 * var_x71 + var_x33 * var_x66 + var_x37 * var_x89 + var_x43 * var_x6 + var_x8 * (-26.725757487819564 * var_x76 + var_chaste_interface__cell__V) + 1.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() < -150.0) ? (-100.5) : (-0.5));
        IJth(rJacobian, 1, 12) = ((var_x127) ? (var_x121 * (-0.1552941176470588 * var_x133 + var_x110 * var_x132)) : (0));
        IJth(rJacobian, 12, 12) = ((var_x216) ? (-100.5) : (-0.5));
        IJth(rJacobian, 20, 12) = ((var_x127) ? (var_x229 * (var_x227 - var_x110 * var_x228)) : (0));
        IJth(rJacobian, 13, 13) = ((var_x216) ? (-100.5) : (-0.01));
        IJth(rJacobian, 1, 14) = ((var_x127) ? (var_x121 * (var_x132 * var_chaste_interface__Irel__APtrack2 - var_x113 * var_x134)) : (0));
        IJth(rJacobian, 14, 14) = (((var_x217) || (var_chaste_interface__Irel__APtrack2 > 0.01)) ? (0) : (-0.5));
        IJth(rJacobian, 20, 14) = ((var_x127) ? (var_x229 * (var_x134 * var_x225 - var_x228 * var_chaste_interface__Irel__APtrack2)) : (0));
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x83 - var_x86 - var_x92 - 427.61211980511302 * var_x88 - 0.044846846816933385 * var_x90 - 0.00053825082649496523 * var_x84);
        IJth(rJacobian, 1, 18) = 1.0400358959643151e-7 * var_x103 * var_x135;
        IJth(rJacobian, 14, 18) = ((var_x217) ? (5.2001794798215757e-8 * var_x135) : (0));
        IJth(rJacobian, 18, 18) = -var_x219 * (var_x83 + 427.61211980511302 * var_x88 + 0.13454054045080013 * var_x90 + 0.0016147524794848955 * var_x84);
        IJth(rJacobian, 19, 18) = -var_x219 * (var_x86 + var_x92 - 0.08969369363386677 * var_x90);
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x99 - var_x93 - var_x94 - var_x95 - var_x97 - var_x98);
        IJth(rJacobian, 19, 19) = -var_x219 * (var_x93 + var_x94 + var_x95 + var_x97 + var_x98 - var_x99);
        IJth(rJacobian, 1, 20) = ((var_x127) ? (var_x103 * var_x114) : (0));
        IJth(rJacobian, 20, 20) = ((var_x127) ? (var_x229 * (-0.0055555555555555558 - var_x226) + var_x231 * (var_x230 - var_x112 * var_x227)) : (-var_x232 + var_x230 * var_x231));
