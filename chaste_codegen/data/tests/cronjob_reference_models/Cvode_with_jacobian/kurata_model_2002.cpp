...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellkurata_model_2002FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x105 = 1.0 * var_chaste_interface__intracellular_ion_concentrations__Ki + 0.12 * var_chaste_interface__intracellular_ion_concentrations__Nai;
        ...
        const double var_x139 = var_x1 * (0.0054054054054054048 * var_chaste_interface__intracellular_ion_concentrations__Nai + 0.045045045045045043 * var_chaste_interface__intracellular_ion_concentrations__Ki) / pow(var_x105, 2);
        ...
        IJth(rJacobian, 20, 19) = 0.0010971826087489212 * var_x142 + 5.181245576427157e-5 * var_x141 - 0.00037785751221943326 * var_x139;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0021962113249247841 - 6.1808487292273409 * var_x143 - 0.53453099652795777 * var_x144 - 15.367231619182256 * var_x139 - 4.8107789687516194 * var_x146 + var_x145 * var_x4);
