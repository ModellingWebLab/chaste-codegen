...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellkurata_model_2002FromCellMLCvode::GetIntracellularCalciumConcentration()
    {
    ...
    void Cellkurata_model_2002FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x138 = 1 / (pow((1.0 + 0.00059999999999999995 / var_chaste_interface__intracellular_ion_concentrations__Cai), 2) * pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 2));
        const double var_x139 = 14.1174 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        const double var_x140 = -0.16666666666666666 * var_chaste_interface__membrane__V;
        const double var_x141 = exp(-2.3500000000000001 + var_x140);
        const double var_x142 = 1.0 + var_x141;
        const double var_x143 = 0.40000000000000002 * var_chaste_interface__membrane__V;
        const double var_x144 = exp(-2.0 + var_x143);
        const double var_x145 = -1.0 + var_x144;
        const double var_x146 = 0.011429999999999999 / var_x145;
        const double var_x147 = exp(-14.0 - var_x143);
        const double var_x148 = -1.0 + var_x147;
        const double var_x149 = 0.028389999999999999 / var_x148;
        const double var_x150 = exp(-0.20798668885191349 * var_chaste_interface__membrane__V);
        const double var_x151 = -1.0 + var_x150;
        const double var_x152 = 0.084900000000000003 / var_x151;
        const double var_x153 = -5.0 + var_chaste_interface__membrane__V;
        const double var_x154 = 35.0 + var_chaste_interface__membrane__V;
        const double var_x155 = var_x146 * var_x153;
        const double var_x156 = var_x149 * var_x154;
        const double var_x157 = var_x152 * var_chaste_interface__membrane__V;
        const double var_x158 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x159 = exp(6.0 + var_x158);
        const double var_x160 = 1.0 + var_x159;
        const double var_x161 = 1 + 0.030769230769230771 * var_chaste_interface__membrane__V;
        const double var_x162 = exp(-5.4668495419491743 * pow(var_x161, 2.0));
        const double var_x163 = 1 / (44.299999999999997 + 257.10000000000002 * var_x162);
        const double var_x164 = 60.000000000000014 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x165 = 0.00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x166 = exp(-4.3833333333333337 + var_x140);
        const double var_x167 = 1.0 + var_x166;
        const double var_x168 = exp(0.87666666666666671 + var_x76);
        const double var_x169 = exp(-0.87666666666666671 + var_x77);
        const double var_x170 = 1.0680000000000001 * var_x168;
        const double var_x171 = 1.0680000000000001 * var_x169;
        const double var_x172 = exp(11.017857142857144 + 0.17857142857142858 * var_chaste_interface__membrane__V);
        const double var_x173 = 1.0 + var_x172;
        const double var_x174 = exp(4.0117035110533159 + 0.065019505851755519 * var_chaste_interface__membrane__V);
        const double var_x175 = exp(-0.74069627851140463 - 0.012004801920768308 * var_chaste_interface__membrane__V);
        const double var_x176 = 0.014999999999999999 * var_x174;
        const double var_x177 = 0.015299999999999999 * var_x175;
        const double var_x178 = exp(-2.1886792452830188 - 0.094339622641509441 * var_chaste_interface__membrane__V);
        const double var_x179 = 1.0 + var_x178;
        const double var_x180 = 1.0 / var_x179;
        const double var_x181 = exp(0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x182 = exp(-0.046296296296296294 * var_chaste_interface__membrane__V);
        const double var_x183 = 0.0001771890292963632 * var_x182;
        const double var_x184 = 0.0049612928202981696 * var_x181;
        const double var_x185 = 0.094339622641509441 * var_x178 / pow(var_x179, 2);
        const double var_x186 = exp(0.062893081761006289 * var_chaste_interface__membrane__V);
        const double var_x187 = exp(-0.044444444444444446 * var_chaste_interface__membrane__V);
        const double var_x188 = 0.0011340097874967246 * var_x187;
        const double var_x189 = 0.043942879265498072 * var_x186;
        const double var_x190 = exp(1.672514619883041 + 0.058479532163742687 * var_chaste_interface__membrane__V);
        const double var_x191 = 1.0 + var_x190;
        const double var_x192 = exp(0.009420009985210585 * var_chaste_interface__membrane__V);
        const double var_x193 = exp(-0.018299935950224173 * var_chaste_interface__membrane__V);
        const double var_x194 = 0.10000000000000001 * var_x193;
        const double var_x195 = 0.65600000000000003 * var_x192;
        const double var_x196 = exp(-0.022222222222222223 * var_chaste_interface__membrane__V);
        const double var_x197 = 0.001 * var_x196;
        const double var_x198 = exp(4.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane__V);
        ...
        const double var_x205 = 0.0015555555555555555 * var_x198 / pow(var_x199, 2);
        const double var_x206 = 0.076923076923076927 * var_chaste_interface__membrane__V;
        ...
        const double var_x210 = exp(4.593 + var_x209);
        const double var_x211 = exp(-3.52 - 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x212 = 1 / (0.065000000000000002 * var_x210 + 0.56999999999999995 * var_x211);
        const double var_x213 = 1 / (6.0599999999999996 + 39.101999999999997 * var_x212);
        const double var_x214 = exp(1.2866666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x215 = 1.0 + var_x214;
        const double var_x216 = exp(2.7548999999999997 + 0.089999999999999997 * var_chaste_interface__membrane__V);
        const double var_x217 = exp(-2.8607999999999998 - 0.12 * var_chaste_interface__membrane__V);
        const double var_x218 = 1 / (1.0369999999999999 * var_x216 + 0.36899999999999999 * var_x217);
        const double var_x219 = 1 / (2.75352 + 14.40516 * var_x218);
        const double var_x220 = exp(4.7407407407407405 + 0.07407407407407407 * var_chaste_interface__membrane__V);
        const double var_x221 = 1.0 + var_x220;
        const double var_x222 = exp(-3.8001143986272159 + 0.051999376007487906 * var_chaste_interface__membrane__V);
        const double var_x223 = exp(-8.5404617897664554 - 0.022074080614542406 * var_chaste_interface__membrane__V);
        const double var_x224 = 1.3953756414018557 * var_x223;
        const double var_x225 = 1.3953756414018557 * var_x222;
        const double var_x226 = -var_x158;
        const double var_x227 = exp(-11.4 + var_x226);
        const double var_x228 = 1.0 + var_x227;
        const double var_x229 = exp(var_x101);
        const double var_x230 = exp(0.125 * var_chaste_interface__membrane__V);
        const double var_x231 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
        const double var_x232 = exp(-0.0014285714285714286 * var_chaste_interface__membrane__V);
        const double var_x233 = 1.0 / (16.0 * var_x230 + 15.0 * var_x229);
        const double var_x234 = 1.0 / (0.20000000000000001 * var_x232 + 0.14999999999999999 * var_x231);
        const double var_x235 = exp(-var_x209);
        const double var_x236 = 1 / (50.0 * var_x232 + 95.0 * var_x235);
        const double var_x237 = exp(0.014285714285714285 * var_chaste_interface__membrane__V);
        const double var_x238 = exp(var_x206);
        const double var_x239 = 1 / (700.0 * var_x237 + 3100.0 * var_x238);
        const double var_x240 = 1.0 * var_x239;
        const double var_x241 = exp(var_x226);
        const double var_x242 = 1.0 + var_x241;
        const double var_x243 = 1 / var_x242;
        const double var_x244 = var_x240 + 1.0 * var_x236 + 0.00022900000000000001 * var_x243;
        const double var_x245 = 1 / var_x244;
        const double var_x246 = var_x241 / pow(var_x242, 2);
        const double var_x247 = (-10.0 * var_x237 - 238.46153846153848 * var_x238) / pow((var_x238 + 0.22580645161290322 * var_x237), 2);
        const double var_x248 = (0.071428571428571425 * var_x232 + 9.5 * var_x235) / pow((var_x235 + 0.52631578947368418 * var_x232), 2);
        const double var_x249 = 1.0405827263267429e-7 * var_x247;
        const double var_x250 = 0.15037593984962405 * var_x236;
        const double var_x251 = 0.15037593984962405 * var_x239;
        const double var_x252 = 3.4436090225563911e-5 * var_x243;
        ...
        IJth(rJacobian, 2, 0) = (-var_chaste_interface__L_type_calcium_channel_current_d_gate__d + 1.0 / var_x142) * (var_x146 - var_x149 - var_x152 - 0.017658069883527455 * var_x150 * var_chaste_interface__membrane__V / pow(var_x151, 2) - 0.0045719999999999997 * var_x144 * var_x153 / pow(var_x145, 2) - 0.011356 * var_x147 * var_x154 / pow(var_x148, 2)) + 0.16666666666666666 * var_x141 * (var_x155 - var_x156 - var_x157) / pow(var_x142, 2);
        IJth(rJacobian, 3, 0) = -0.20000000000000001 * var_x159 * var_x163 / pow(var_x160, 2) + 0.0013085239606137509 * var_x162 * pow(var_x161, 1.0) * (-var_chaste_interface__L_type_calcium_channel_current_f_gate__f + 1.0 / var_x160) / pow((0.17230649552703226 + var_x162), 2);
        IJth(rJacobian, 5, 0) = (-var_chaste_interface__T_type_calcium_channel_current_d_gate__d + 1.0 / var_x167) * (0.0356 * var_x168 - 0.0356 * var_x169) + 0.16666666666666666 * var_x166 * (var_x170 + var_x171) / pow(var_x167, 2);
        IJth(rJacobian, 6, 0) = (-var_chaste_interface__T_type_calcium_channel_current_f_gate__f + 1.0 / var_x173) * (0.0009752925877763327 * var_x174 - 0.00018367346938775509 * var_x175) - 0.17857142857142858 * var_x172 * (var_x176 + var_x177) / pow(var_x173, 2);
        IJth(rJacobian, 7, 0) = var_x185 * (var_x183 + var_x184) + (var_x180 - var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS) * (0.00029184075413518645 * var_x181 - 8.2031958007575546e-6 * var_x182);
        IJth(rJacobian, 8, 0) = var_x185 * (var_x188 + var_x189) + (var_x180 - var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF) * (0.0027637030984589981 * var_x186 - 5.0400434999854427e-5 * var_x187);
        IJth(rJacobian, 9, 0) = (-var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy + 1.0 / var_x191) * (0.0061795265502981441 * var_x192 - 0.0018299935950224174 * var_x193) - 0.058479532163742687 * var_x190 * (var_x194 + var_x195) / pow(var_x191, 2);
        IJth(rJacobian, 10, 0) = var_x202 * (var_x203 * var_x205 + 71.428571428571431 * var_x200 * (var_x204 - var_x205) / pow((var_x200 + 0.071428571428571425 * var_x196), 2)) + (var_x205 - var_x204) * (-var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n + var_x201 * var_x203);
        IJth(rJacobian, 11, 0) = -0.076923076923076927 * var_x207 * var_x213 / pow(var_x208, 2) - 0.078713879440468384 * (-var_chaste_interface__AP_sensitive_currents_q_gate__q + 1.0 / var_x208) * (0.045599999999999995 * var_x211 - 0.0065000000000000006 * var_x210) / (pow((0.15497928494706154 + var_x212), 2) * pow((var_x211 + 0.11403508771929825 * var_x210), 2));
        IJth(rJacobian, 12, 0) = 0.066666666666666666 * var_x214 * var_x219 / pow(var_x215, 2) - 0.064554184748538135 * (-var_chaste_interface__AP_sensitive_currents_r_gate__r + 1.0 / var_x215) * (0.04428 * var_x217 - 0.093329999999999996 * var_x216) / (pow((0.19114817190506733 + var_x218), 2) * pow((var_x216 + 0.35583413693346194 * var_x217), 2));
        IJth(rJacobian, 13, 0) = (-var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + 1.0 / var_x221) * (0.0725586626489447 * var_x222 - 0.030801634395873377 * var_x223) - 0.07407407407407407 * var_x220 * (var_x224 + var_x225) / pow(var_x221, 2);
        IJth(rJacobian, 14, 0) = (-var_chaste_interface__sustained_inward_current_qa_gate__qa + 1.0 / var_x228) * (0.00390625 * (-2.0 * var_x230 - 0.29999999999999999 * var_x229) / pow((var_x230 + 0.9375 * var_x229), 2) + 24.999999999999996 * (0.013636363636363636 * var_x231 + 0.00028571428571428574 * var_x232) / pow((var_x232 + 0.74999999999999989 * var_x231), 2)) + 0.20000000000000001 * var_x227 * (var_x233 + var_x234) / pow(var_x228, 2);
        IJth(rJacobian, 15, 0) = (-var_chaste_interface__sustained_inward_current_qi_gate__qi + var_x240 * var_x245) * (6.8872180451127825e-6 * var_x246 + 1.5647860546266811e-8 * var_x247 + 1.6662153999958345e-5 * var_x248) + (var_x245 * var_x249 + var_x240 * (-var_x249 - 4.5800000000000002e-5 * var_x246 - 0.00011080332409972299 * var_x248) / pow(var_x244, 2)) * (var_x250 + var_x251 + var_x252);
        ...
        IJth(rJacobian, 1, 1) = -27.670820618882221 + 2.7527999999999997 * var_chaste_interface__calcium_buffering__fTC + 14.1174 * var_chaste_interface__calcium_buffering__fTMC + 14.1174 * var_chaste_interface__calcium_buffering__fTMM + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMi - 7.7327439216924522e-8 * var_x138;
        IJth(rJacobian, 16, 1) = 2.9999999999999997e-6 * var_x138;
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x72 * var_x91);
        IJth(rJacobian, 2, 2) = var_x156 + var_x157 - var_x155;
        IJth(rJacobian, 18, 2) = -var_x263 * var_x91;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x93 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa);
        IJth(rJacobian, 3, 3) = -var_x163;
        IJth(rJacobian, 18, 3) = -var_x264 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x93 * var_chaste_interface__L_type_calcium_channel_current_f_gate__f);
        IJth(rJacobian, 4, 4) = -0.021000000000000005 - var_x164;
        IJth(rJacobian, 18, 4) = -var_x264 * var_chaste_interface__L_type_calcium_channel_current_f_gate__f;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x70 * var_x91);
        IJth(rJacobian, 5, 5) = -var_x170 - var_x171;
        IJth(rJacobian, 18, 5) = -var_x261 * var_x91;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.45800000000000002 * var_x94);
        IJth(rJacobian, 6, 6) = -var_x176 - var_x177;
        IJth(rJacobian, 18, 6) = -0.0021639304084587262 * var_x94;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.027046577588354045 * var_x98);
        IJth(rJacobian, 7, 7) = -var_x183 - var_x184;
        IJth(rJacobian, 20, 7) = -5.5419613927232791e-6 * var_x98;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-0.040569866382531065 * var_x98);
        IJth(rJacobian, 8, 8) = -var_x188 - var_x189;
        IJth(rJacobian, 20, 8) = -8.3129420890849178e-6 * var_x98;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x69 * var_x97);
        IJth(rJacobian, 9, 9) = -var_x194 - var_x195;
        IJth(rJacobian, 20, 9) = -var_x269 * var_x97;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-0.051799999999999999 * var_x100);
        IJth(rJacobian, 10, 10) = -var_x197 - var_x201;
        IJth(rJacobian, 20, 10) = -1.0614045315170541e-5 * var_x100;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * var_x97);
        IJth(rJacobian, 11, 11) = -var_x213;
        IJth(rJacobian, 20, 11) = -var_x270 * var_x97;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x101 + 0.53453099652795777 * var_x96 - 0.17999999999999999 * var_x102);
        IJth(rJacobian, 12, 12) = -var_x219;
        IJth(rJacobian, 20, 12) = 0.00010952772624538629 * var_x96 - 4.0980869942743402e-6 * var_chaste_interface__membrane__V - 3.6882782948469062e-5 * var_x102;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.28747499999999998 * var_x104 - 0.46252500000000002 * var_x105);
        IJth(rJacobian, 13, 13) = -var_x224 - var_x225;
        IJth(rJacobian, 19, 13) = -5.8904877933950796e-5 * var_x104;
        IJth(rJacobian, 20, 13) = -9.4773384351336967e-5 * var_x105;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x106 * var_x66);
        IJth(rJacobian, 14, 14) = -var_x233 - var_x234;
        IJth(rJacobian, 19, 14) = -var_x106 * var_x266;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-0.014999999999999999 * var_x107);
        IJth(rJacobian, 15, 15) = -var_x250 - var_x251 - var_x252;
        IJth(rJacobian, 19, 15) = -3.0735652457057552e-6 * var_x107;
        ...
        IJth(rJacobian, 4, 18) = 0.021000000000000005 / var_x165 - 60.000000000000014 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa - 0.00035 * (0.021000000000000005 + var_x164) / pow(var_x165, 2);
        ...
        IJth(rJacobian, 1, 25) = 0.00046562000000000003 + var_x139;
