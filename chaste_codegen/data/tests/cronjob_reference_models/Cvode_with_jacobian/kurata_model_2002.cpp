...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellkurata_model_2002FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x17 = 0.24745156456805775 * var_x16;
        ...
        const double var_x27 = var_x13 - var_x17 + 8.9214469789726909e-6 * var_x23 + var_x25 * var_x26;
        ...
        const double var_x40 = 0.96776646412697098 + var_x20;
        const double var_x41 = var_x39 * var_x40;
        const double var_x42 = var_x13 * var_x41;
        const double var_x43 = 0.38997571260451763 * var_x16 * var_x20 * var_x39;
        ...
        const double var_x56 = 0.96776646412697098 * var_x53 + var_x49 * var_x55;
        const double var_x57 = var_x48 * pow(var_x39, 2);
        const double var_x58 = 0.0051975633156138403 * var_x57;
        const double var_x59 = 0.64386064857757164 * var_x50;
        const double var_x60 = var_x46 * var_x48;
        const double var_x61 = 0.0080724972509135153 * var_x39 * (var_x59 + 0.52840101781434401 * var_x60);
        const double var_x62 = var_x55 * var_x60;
        const double var_x63 = 0.0044075879065866861 * var_x62;
        const double var_x64 = 0.0044075879065866861 * var_x20 * var_x46 * var_x50;
        const double var_x65 = var_x17 * var_x56 + var_x49 * (var_x31 + var_x38 + var_x42 + var_x43 - var_x45) - var_x13 * var_x56 - var_x34 * (var_x63 - var_x58 - var_x61 - var_x64);
        ...
        const double var_x72 = 32.140377158446256 * var_x71;
        const double var_x73 = var_x40 * var_x60;
        const double var_x74 = var_x23 * var_x73;
        const double var_x75 = var_x37 + var_x34 * var_x41;
        const double var_x76 = 1 / (var_x56 + var_x75 + 0.0011051656880977081 * var_x70 + 0.00060342106912241779 * var_x74 + var_x16 * var_x72 + var_x35 * var_x59);
        ...
        const double var_x81 = var_chaste_interface__L_type_calcium_channel_current_d_gate__d * var_chaste_interface__L_type_calcium_channel_current_f_gate__f;
        const double var_x82 = var_x81 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa;
        const double var_x83 = var_x35 * var_x50;
        const double var_x84 = 4.871114921634011e-6 * var_x60;
        const double var_x85 = var_x68 * var_x7;
        const double var_x86 = var_x20 * var_x66 * var_x67 * var_x7;
        const double var_x87 = var_x25 * var_x73;
        const double var_x88 = var_x45 + var_x58 + var_x61 + var_x64 - var_x31 - var_x38 - var_x42 - var_x43 - var_x63 + 0.0051975633156138403 * var_x83 - 8.9214469789726909e-6 * var_x70 - var_x26 * var_x86 - var_x27 * var_x59 + 0.42408406915774627 * var_x16 * var_x71 + 0.25945310625488094 * var_x16 * var_x57 - 0.0034078609320893128 * var_x12 * var_x71 - var_x23 * var_x40 * var_x84 + 5.9354904835575489e-6 * var_x28 * var_x50 * var_x85 - 6.398105028215114e-8 * var_x11 * var_x15 * var_x87 - var_x14 * var_x24 * var_x84 * pow(var_x20, 2);
        const double var_x89 = (var_x49 * var_x75 - var_x34 * var_x56) / pow((var_x44 + 0.0207 * var_x37 + 0.020032765807428299 * var_x53 + 2.2876929743622558e-5 * var_x70 + 0.011302211302211302 * var_x62 + 1.2490816130834047e-5 * var_x74 + 0.013327915425555734 * var_x83 + var_x16 * var_x51 * var_x54), 2);
        const double var_x90 = 0.053561249999999998 * var_x89;
        const double var_x91 = 1 / var_chaste_interface__intracellular_ion_concentrations__Nai;
        const double var_x92 = pow(var_x91, 1.3);
        const double var_x93 = log(140.0 * var_x91);
        const double var_x94 = 0.033333333333333333 * var_chaste_interface__membrane__V;
        const double var_x95 = -var_x94;
        const double var_x96 = exp(-4.0 + var_x95 + 0.89088499421326284 * var_x93);
        const double var_x97 = 1.0 + var_x96;
        const double var_x98 = var_x96 * pow(var_x97, (-2.0)) * pow((1.0 + 30.900566853219949 * var_x92), (-1.0));
        ...
        const double var_x104 = -26.726549826397882 * var_x103 + var_chaste_interface__membrane__V;
        ...
        const double var_x106 = pow(var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n, 1.0) * (-26.726549826397882 * log(22.199999999999999 / var_x105) + var_chaste_interface__membrane__V);
        const double var_x107 = 4.8107789687516185 * var_x103 - 0.17999999999999999 * var_chaste_interface__membrane__V;
        const double var_x108 = pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 1.0);
        const double var_x109 = var_x108 * (-26.726549826397882 * var_x93 + var_chaste_interface__membrane__V);
        ...
        const double var_x112 = var_x11 * (-48.309178743961354 - var_x32 - 1.8271247633873431 * var_chaste_interface__intracellular_ion_concentrations__Nai);
        ...
        const double var_x121 = 0.013771830208622637 * var_x15 * var_x71;
        const double var_x122 = 4.7355244569298691e-7 * var_x86;
        const double var_x123 = 2.5855989390826479e-7 * var_x87;
        const double var_x124 = -var_x117 - var_x118 - var_x119 - var_x112 * var_x121 - var_x112 * var_x122 - var_x112 * var_x123 - var_x116 * var_x59 - var_x14 * var_x5 * var_x72;
        ...
        const double var_x128 = var_x21 * var_x9;
        const double var_x129 = var_x127 + 0.0022103313761954162 * var_x128 + 4.1799004844845232e-5 * var_x22 + var_x115 * var_x126;
        ...
        const double var_x134 = var_x127 * var_x41;
        const double var_x135 = var_x28 - var_x132;
        const double var_x136 = var_x135 * var_x20;
        const double var_x137 = var_x49 * (var_x125 + var_x130 + var_x134 - var_x133) - var_x127 * var_x56 - 26.376837971040871 * var_x136 * var_x16 * var_x60;
        const double var_x138 = var_x0 * var_x91;
        const double var_x139 = var_x133 - var_x125 - var_x130 - var_x134 - 4.1799004844845232e-5 * var_x69 - var_x121 * var_x126 - var_x122 * var_x126 - var_x123 * var_x126 - var_x129 * var_x59 - var_x136 * var_x49 - 0.0033154970642931239 * var_x23 * var_x66 - 0.0012068421382448356 * var_x128 * var_x73 - 2.2822279467564968e-5 * var_x22 * var_x73 + 1.5809003345251601e-6 * var_x131 * var_x52 * var_x85 - 32.140377158446256 * var_x135 * var_x16 * var_x50;
        const double var_x140 = var_x1 * (0.0054054054054054048 * var_chaste_interface__intracellular_ion_concentrations__Nai + 0.045045045045045043 * var_chaste_interface__intracellular_ion_concentrations__Ki) / pow(var_x105, 2);
        const double var_x141 = var_x91 * var_x92 * pow(var_x97, (-1.0)) * pow((0.032361865876120534 + var_x92), (-2.0));
        const double var_x142 = var_x91 * var_x98;
        ...
        const double var_x145 = 26.726549826397882 * var_x102;
        ...
        const double var_x171 = 60.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        ...
        const double var_x175 = exp(0.87666666666666671 + var_x94);
        const double var_x176 = exp(-0.87666666666666671 + var_x95);
        ...
        const double var_x269 = 0.00050612584100462852 * var_x89;
        const double var_x270 = 0.12331568484884879 - 0.0027403485521966401 * var_chaste_interface__membrane__V;
        const double var_x271 = var_x270 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa;
        const double var_x272 = 0.097376868380642675 - 0.0021639304084587262 * var_chaste_interface__membrane__V;
        const double var_x273 = 0.060150151005755319 * var_x265;
        const double var_x274 = 0.076839131142643888 * var_x76;
        const double var_x275 = 3.2924799303311478e-5 * var_x89;
        const double var_x276 = 0.00011495134018939525 - 3.0735652457057556e-6 * var_chaste_interface__membrane__V;
        ...
        const double var_x279 = 0.00098574953620847667 * var_x103 - 3.6882782948469069e-5 * var_chaste_interface__membrane__V;
        const double var_x280 = -227.69999999999999 * var_chaste_interface__intracellular_ion_concentrations__Cai;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0054000000000000003 + var_x4 - 0.375 * var_x0 - 0.014999999999999999 * var_x78 - 0.17999999999999999 * var_x79 - 0.025899999999999999 * var_x1 - 0.57999999999999996 * var_x82 - 0.02 * var_chaste_interface__AP_sensitive_currents_r_gate__r - 0.45800000000000002 * var_x80 - 0.10017396017979863 * var_x98 - 0.00044373633078820127 * var_x2 - var_x65 * var_x77 - var_x88 * var_x90);
        ...
        IJth(rJacobian, 18, 0) = -0.0021639304084587262 * var_x80 - 0.0027403485521966401 * var_x82 + var_x268 * var_x65 + var_x269 * var_x88;
        IJth(rJacobian, 19, 0) = -1.1064834884540721e-6 - 6.1578240506668277e-5 * var_x98 - 3.0735652457057556e-6 * var_x78 - 2.9452438966975401e-5 * var_x0 - var_x274 * var_x65 - var_x275 * var_x88;
        IJth(rJacobian, 20, 0) = var_x278 + 4.1052160337778847e-5 * var_x98 - 9.0923504304507221e-8 * var_x2 - 4.0980869942743411e-6 * var_chaste_interface__AP_sensitive_currents_r_gate__r - 5.3070226575852715e-6 * var_x1 - 4.738669217566849e-5 * var_x0 - 3.6882782948469069e-5 * var_x79;
        ...
        IJth(rJacobian, 3, 3) = -0.021000000000000001 - var_x171;
        IJth(rJacobian, 18, 3) = var_x270 * var_x81;
        ...
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : ((1.0842925553230209 * var_x103 - 0.040569866382531065 * var_chaste_interface__membrane__V) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy);
        ...
        IJth(rJacobian, 20, 9) = -1.0614045315170543e-5 * var_x106;
        ...
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (0.53453099652795766 * var_x103 - 0.02 * var_chaste_interface__membrane__V + var_x107 * var_chaste_interface__AP_sensitive_currents_q_gate__q);
        IJth(rJacobian, 11, 11) = -var_x225;
        IJth(rJacobian, 20, 11) = 0.00010952772624538631 * var_x103 - 4.0980869942743411e-6 * var_chaste_interface__membrane__V + var_x279 * var_chaste_interface__AP_sensitive_currents_q_gate__q;
        ...
        IJth(rJacobian, 15, 15) = -27.670820618882221 + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMi + 2.7527999999999997 * var_chaste_interface__calcium_buffering__fTC + 14.1174 * var_chaste_interface__calcium_buffering__fTMC + 14.1174 * var_chaste_interface__calcium_buffering__fTMM - 7.7327439216924522e-8 * var_x259;
        ...
        IJth(rJacobian, 17, 17) = -5.3566666666666674 - var_x266 + 5.3399999999999999 * var_chaste_interface__calcium_buffering__fCQ;
        ...
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x120 * var_x77 - var_x124 * var_x90);
        IJth(rJacobian, 3, 18) = 0.021000000000000001 / var_x172 - 60.0 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa - 0.00035 * (0.021000000000000001 + var_x171) / pow(var_x172, 2);
        IJth(rJacobian, 15, 18) = 0.55412061888222286;
        IJth(rJacobian, 17, 18) = var_x266 - var_x263 * var_x267;
        IJth(rJacobian, 18, 18) = -35.246499999999997 - var_x273 + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMs + var_x120 * var_x268 + var_x124 * var_x269 + 1.7323243489657528e-7 * var_x262 * var_x267;
        ...
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-1.8440677943018704 * var_x140 - 0.14432336906254858 * var_x91 - 0.12643083428112081 * var_x141 - 2.6773043380529855 * var_x142 - 3.8416074556718653 * var_x138 - var_x137 * var_x77 - var_x139 * var_x90);
        IJth(rJacobian, 18, 19) = var_x137 * var_x268 + var_x139 * var_x269;
        IJth(rJacobian, 19, 19) = -0.00078716207755981068 * var_x138 - 7.7718683646407365e-5 * var_x141 - 0.0016457739131233819 * var_x142 - 2.9572486086254304e-5 * var_x91 - var_x137 * var_x274 - var_x139 * var_x275;
        ...
        IJth(rJacobian, 20, 20) = -4.5001325336761377e-7 - 0.0012664827895411826 * var_x143 - 0.0031488126018286108 * var_x140 - 0.00010952772624538631 * var_x144 - 0.00098574953620847667 * var_x146 + var_x145 * var_x278;
