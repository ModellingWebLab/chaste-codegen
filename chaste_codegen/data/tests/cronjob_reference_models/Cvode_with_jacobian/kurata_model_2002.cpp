...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellkurata_model_2002FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x3 = exp(-0.0051222473865587962 * var_chaste_interface__membrane__V);
        const double var_x4 = 1.0 + 0.037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai;
        const double var_x5 = var_x3 + var_x4;
        const double var_x6 = var_x5 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x7 = var_x4 * var_chaste_interface__intracellular_ion_concentrations__Nai;
        ...
        const double var_x10 = var_x9 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_sub, 2) * exp(-0.010244494773117592 * var_chaste_interface__membrane__V);
        const double var_x11 = 0.0051222473865587962 * var_x10;
        const double var_x12 = 1 / (1.0 + 48.309178743961354 * var_x6 + 0.0025297242600556538 * var_x8);
        const double var_x13 = var_x12 * var_x3;
        const double var_x14 = var_x13 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x15 = 0.24745156456805778 * var_x14;
        const double var_x16 = 0.0080724972509135153 * var_chaste_interface__membrane__V;
        ...
        const double var_x21 = var_x20 * var_x4;
        const double var_x22 = var_x3 * var_x9;
        const double var_x23 = var_x22 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x24 = var_x17 * var_x18;
        const double var_x25 = var_x23 * var_x24 * var_x4;
        const double var_x26 = var_x11 - var_x15 + 8.9214469789726926e-6 * var_x21 + 1.1718129359175984e-7 * var_x25;
        ...
        const double var_x29 = 0.10064186356183184 * var_x17;
        const double var_x30 = var_x28 * var_x29;
        const double var_x31 = 48.309178743961354 * var_x13;
        const double var_x32 = var_x31 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x33 = var_x32 + 0.0011051656880977081 * var_x21;
        const double var_x34 = var_x17 * var_x33;
        const double var_x35 = var_x28 * var_x34;
        const double var_x36 = exp(-var_x16);
        const double var_x37 = 0.10064186356183184 + 0.12263287420415996 * var_x36;
        const double var_x38 = var_x36 * var_x37;
        const double var_x39 = var_x28 + var_x36;
        const double var_x40 = var_x17 * var_x39;
        const double var_x41 = 0.96776646412697087 * var_x38 + 0.10064186356183184 * var_x40;
        const double var_x42 = 0.016144994501827031 * var_chaste_interface__membrane__V;
        const double var_x43 = exp(-var_x42);
        const double var_x44 = 0.00095804383694419841 * var_x43;
        const double var_x45 = 0.0008124311669297006 * var_x40;
        const double var_x46 = 0.0078122921211912656 * var_x38;
        const double var_x47 = var_x17 * var_x36;
        const double var_x48 = 0.0008124311669297006 * var_x47;
        const double var_x49 = var_x14 * var_x47;
        const double var_x50 = 0.96776646412697087 + var_x17;
        const double var_x51 = var_x36 * var_x50;
        const double var_x52 = var_x14 * var_x51;
        const double var_x53 = 0.0008124311669297006 * var_x35 + 0.039247882460372009 * var_x49 - 0.06415186905979231 * var_x52 + var_x15 * var_x41 + var_x26 * var_x30 - var_x11 * var_x41 - var_x32 * (var_x45 - var_x44 - var_x46 - var_x48) + 0.00051551252260800004 * var_x10 * var_x51;
        const double var_x54 = var_x33 * var_x36;
        const double var_x55 = var_x21 * var_x50;
        const double var_x56 = var_x36 * var_x39;
        const double var_x57 = 5.9242934398144911 * var_x56;
        const double var_x58 = pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 3);
        const double var_x59 = var_x27 * var_x58;
        const double var_x60 = var_x12 * var_x17;
        const double var_x61 = var_x37 * var_x60;
        const double var_x62 = var_x59 * var_x61;
        const double var_x63 = var_x4 * var_x62;
        const double var_x64 = 1 / (var_x35 + var_x41 + 0.0011051656880977081 * var_x63 + 0.00011122593439474754 * var_x55 + 0.11867998305428749 * var_x54 + var_x14 * var_x57 + var_x32 * var_x51);
        const double var_x65 = 125.0 * var_x64;
        const double var_x66 = 0.014999999999999999 * var_chaste_interface__sustained_inward_current_qi_gate__qi;
        const double var_x67 = 0.17999999999999999 * var_chaste_interface__AP_sensitive_currents_r_gate__r;
        const double var_x68 = 0.40000000000000002 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS + 0.59999999999999998 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF;
        const double var_x69 = 0.067616443970885107 * var_x68;
        const double var_x70 = 0.45800000000000002 * var_chaste_interface__T_type_calcium_channel_current_f_gate__f;
        const double var_x71 = var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa * var_chaste_interface__L_type_calcium_channel_current_f_gate__f;
        const double var_x72 = 0.57999999999999996 * var_x71;
        const double var_x73 = 1 / var_chaste_interface__intracellular_ion_concentrations__Nai;
        const double var_x74 = pow(var_x73, 1.3);
        const double var_x75 = log(140.0 * var_x73);
        const double var_x76 = 0.033333333333333333 * var_chaste_interface__membrane__V;
        const double var_x77 = -var_x76;
        const double var_x78 = exp(-4.0 + var_x77 + 0.89088499421326284 * var_x75);
        const double var_x79 = 1.0 + var_x78;
        const double var_x80 = var_x78 * pow(var_x79, (-2.0)) * pow((1.0 + 30.900566853219949 * var_x74), (-1.0));
        const double var_x81 = 0.11867998305428749 * var_x36;
        const double var_x82 = var_x17 * var_x28;
        const double var_x83 = var_x14 * var_x56;
        const double var_x84 = var_x4 * var_x59;
        const double var_x85 = var_x17 * var_x37;
        const double var_x86 = var_x44 + var_x46 + var_x48 - var_x45 + 0.078169539095804652 * var_x83 + 0.63742727717257541 * var_x52 + 0.00095804383694419841 * var_x54 - 0.0080724972509135153 * var_x35 - 8.9214469789726926e-6 * var_x63 - 0.38997571260451763 * var_x49 - 8.978710496318865e-7 * var_x55 - var_x11 * var_x51 - var_x26 * var_x81 - var_x26 * var_x82 + 0.047823842506507452 * var_x14 * var_x43 - 0.00062815591939845204 * var_x10 * var_x56 - 1.1793343761660852e-8 * var_x25 * var_x50 + 1.0940626850914411e-6 * var_x12 * var_x47 * var_x84 - 8.978710496318865e-7 * var_x19 * var_x4 * exp(var_x42) - 1.1718129359175984e-7 * var_x23 * var_x84 * var_x85;
        const double var_x87 = 2.2876929743622558e-5 * var_x4;
        const double var_x88 = var_x29 * var_x33;
        const double var_x89 = (4.8619257759339058 * var_x52 + var_x28 * var_x88 - var_x32 * var_x41) / pow((var_x52 + 0.12263287420415997 * var_x83 + 0.0020832865757299192 * var_x40 + 2.302376841971274e-6 * var_x55 + 0.0024566756492237509 * var_x54 + 0.020032765807428295 * var_x38 + 0.0207 * var_x35 + var_x62 * var_x87), 2);
        const double var_x90 = 0.053561249999999998 * var_x89;
        const double var_x91 = -45.0 + var_chaste_interface__membrane__V;
        const double var_x92 = var_x91 * var_chaste_interface__L_type_calcium_channel_current_d_gate__d;
        const double var_x93 = 0.57999999999999996 * var_x92;
        const double var_x94 = var_x91 * var_chaste_interface__T_type_calcium_channel_current_d_gate__d;
        const double var_x95 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ki;
        const double var_x96 = log(5.4000000000000004 * var_x95);
        const double var_x97 = -26.726549826397886 * var_x96 + var_chaste_interface__membrane__V;
        const double var_x98 = var_x97 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy;
        const double var_x99 = 1 / (0.12 * var_chaste_interface__intracellular_ion_concentrations__Nai + var_chaste_interface__intracellular_ion_concentrations__Ki);
        const double var_x100 = pow(var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n, 1.0) * (-26.726549826397886 * log(22.199999999999999 * var_x99) + var_chaste_interface__membrane__V);
        const double var_x101 = 0.02 * var_chaste_interface__membrane__V;
        const double var_x102 = var_x97 * var_chaste_interface__AP_sensitive_currents_q_gate__q;
        const double var_x103 = pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 1.0);
        const double var_x104 = var_x103 * (-26.726549826397886 * var_x75 + var_chaste_interface__membrane__V);
        const double var_x105 = var_x103 * var_x97;
        const double var_x106 = -37.399999999999999 + var_chaste_interface__membrane__V;
        const double var_x107 = var_x106 * var_chaste_interface__sustained_inward_current_qa_gate__qa;
        const double var_x108 = var_x22 * var_x6;
        const double var_x109 = 1.0 * var_x108;
        const double var_x110 = var_x24 * var_x9;
        const double var_x111 = var_x110 * var_x5;
        const double var_x112 = var_x31 - var_x109 - var_x111 * var_x87;
        const double var_x113 = var_x109 * var_x41 + var_x112 * var_x30 - var_x31 * var_x41 + 4.8619257759339058 * var_x13 * var_x51 - 0.10064186356183184 * var_x108 * var_x51;
        const double var_x114 = var_x85 * var_x9;
        const double var_x115 = var_x109 * var_x51 - var_x112 * var_x81 - var_x112 * var_x82 - var_x13 * var_x57 - var_x31 * var_x51 + 0.12263287420415997 * var_x108 * var_x56 + 2.302376841971274e-6 * var_x111 * var_x4 * var_x50 + var_x114 * var_x5 * var_x59 * var_x87;
        const double var_x116 = var_x60 * var_x7;
        const double var_x117 = -0.0025297242600556538 - 0.0011051656880977081 * var_x7 - 1.8271247633873429 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub - 0.0025297242600556538 * (0.43687199650502401 + 0.033046293230334638 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai;
        const double var_x118 = var_x117 * var_x23;
        const double var_x119 = 0.0207 * var_x118;
        const double var_x120 = var_x110 * var_x117 * var_x4;
        const double var_x121 = var_x119 + 0.0022103313761954162 * var_x116 + 4.7355244569298691e-7 * var_x120 + 4.1799004844845232e-5 * var_x20;
        const double var_x122 = pow((1 + 0.037821482602117998 * var_chaste_interface__intracellular_ion_concentrations__Nai), (-2));
        const double var_x123 = var_x122 * var_chaste_interface__intracellular_ion_concentrations__Nai;
        const double var_x124 = 0.0014304645462223146 * var_x123;
        const double var_x125 = var_x27 - var_x124;
        const double var_x126 = var_x125 * var_x14;
        const double var_x127 = var_x121 * var_x30 + var_x27 * var_x88 - var_x119 * var_x41 + 0.0020832865757299192 * var_x118 * var_x51 - 0.00014396461769094389 * var_x123 * var_x34 - 4.8619257759339058 * var_x126 * var_x17;
        const double var_x128 = var_x0 * var_x73;
        const double var_x129 = var_x1 * var_x99;
        const double var_x130 = -4.1799004844845232e-5 * var_x62 + var_x124 * var_x34 - var_x119 * var_x51 - var_x121 * var_x81 - var_x121 * var_x82 - var_x125 * var_x29 - var_x27 * var_x34 - 0.00022245186878949507 * var_x116 * var_x50 - 5.9242934398144911 * var_x126 * var_x36 - 4.2067297426152623e-6 * var_x20 * var_x50 - 0.0025385004960261112 * var_x118 * var_x56 - 4.7659200628805372e-8 * var_x120 * var_x50 - 0.0033154970642931244 * var_x21 * var_x27 * var_x37 - 4.7355244569298691e-7 * var_x114 * var_x117 * var_x84 + 1.5809003345251601e-6 * var_x122 * var_x4 * var_x58 * var_x61;
        const double var_x131 = pow(var_x79, (-1.0));
        const double var_x132 = 0.0010472903629840148 * pow((0.032361865876120534 + var_x74), (-2.0));
        const double var_x133 = var_x73 * var_x80;
        const double var_x134 = var_x0 * var_x95;
        const double var_x135 = var_x95 * var_chaste_interface__AP_sensitive_currents_r_gate__r;
        const double var_x136 = var_x135 * var_chaste_interface__AP_sensitive_currents_q_gate__q;
        const double var_x137 = var_x68 * var_x95 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy;
        const double var_x138 = -0.16666666666666666 * var_chaste_interface__membrane__V;
        const double var_x139 = exp(-2.3500000000000001 + var_x138);
        const double var_x140 = 1.0 + var_x139;
        const double var_x141 = 0.40000000000000002 * var_chaste_interface__membrane__V;
        const double var_x142 = exp(-2.0 + var_x141);
        const double var_x143 = -1.0 + var_x142;
        const double var_x144 = 0.011429999999999999 / var_x143;
        const double var_x145 = exp(-14.0 - var_x141);
        const double var_x146 = -1.0 + var_x145;
        const double var_x147 = 0.028389999999999999 / var_x146;
        const double var_x148 = exp(-0.20798668885191349 * var_chaste_interface__membrane__V);
        const double var_x149 = -1.0 + var_x148;
        const double var_x150 = 0.084900000000000003 / var_x149;
        const double var_x151 = -5.0 + var_chaste_interface__membrane__V;
        const double var_x152 = 35.0 + var_chaste_interface__membrane__V;
        const double var_x153 = var_x144 * var_x151;
        const double var_x154 = var_x147 * var_x152;
        const double var_x155 = var_x150 * var_chaste_interface__membrane__V;
        const double var_x156 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x157 = exp(6.0 + var_x156);
        const double var_x158 = 1.0 + var_x157;
        const double var_x159 = 1 + 0.030769230769230771 * var_chaste_interface__membrane__V;
        const double var_x160 = exp(-5.4668495419491743 * pow(var_x159, 2.0));
        const double var_x161 = 1 / (44.299999999999997 + 257.10000000000002 * var_x160);
        const double var_x162 = 60.000000000000014 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x163 = 0.00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x164 = exp(-4.3833333333333337 + var_x138);
        const double var_x165 = 1.0 + var_x164;
        const double var_x166 = exp(0.87666666666666671 + var_x76);
        const double var_x167 = exp(-0.87666666666666671 + var_x77);
        const double var_x168 = 1.0680000000000001 * var_x166;
        const double var_x169 = 1.0680000000000001 * var_x167;
        const double var_x170 = exp(11.017857142857144 + 0.17857142857142858 * var_chaste_interface__membrane__V);
        const double var_x171 = 1.0 + var_x170;
        const double var_x172 = exp(4.0117035110533159 + 0.065019505851755519 * var_chaste_interface__membrane__V);
        const double var_x173 = exp(-0.74069627851140463 - 0.012004801920768308 * var_chaste_interface__membrane__V);
        const double var_x174 = 0.014999999999999999 * var_x172;
        const double var_x175 = 0.015299999999999999 * var_x173;
        const double var_x176 = exp(-2.1886792452830188 - 0.094339622641509441 * var_chaste_interface__membrane__V);
        const double var_x177 = 1.0 + var_x176;
        const double var_x178 = 1.0 / var_x177;
        const double var_x179 = exp(0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x180 = exp(-0.046296296296296294 * var_chaste_interface__membrane__V);
        const double var_x181 = 0.0001771890292963632 * var_x180;
        const double var_x182 = 0.0049612928202981696 * var_x179;
        const double var_x183 = 0.094339622641509441 * var_x176 / pow(var_x177, 2);
        const double var_x184 = exp(0.062893081761006289 * var_chaste_interface__membrane__V);
        const double var_x185 = exp(-0.044444444444444446 * var_chaste_interface__membrane__V);
        const double var_x186 = 0.0011340097874967246 * var_x185;
        const double var_x187 = 0.043942879265498072 * var_x184;
        const double var_x188 = exp(1.672514619883041 + 0.058479532163742687 * var_chaste_interface__membrane__V);
        const double var_x189 = 1.0 + var_x188;
        const double var_x190 = exp(0.009420009985210585 * var_chaste_interface__membrane__V);
        const double var_x191 = exp(-0.018299935950224173 * var_chaste_interface__membrane__V);
        const double var_x192 = 0.10000000000000001 * var_x191;
        const double var_x193 = 0.65600000000000003 * var_x190;
        const double var_x194 = exp(-0.022222222222222223 * var_chaste_interface__membrane__V);
        const double var_x195 = 0.001 * var_x194;
        const double var_x196 = exp(4.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane__V);
        const double var_x197 = 1.0 + var_x196;
        const double var_x198 = 1 / var_x197;
        const double var_x199 = 0.014 * var_x198;
        const double var_x200 = var_x195 + var_x199;
        const double var_x201 = 1 / var_x200;
        const double var_x202 = 2.2222222222222223e-5 * var_x194;
        const double var_x203 = 0.0015555555555555555 * var_x196 / pow(var_x197, 2);
        const double var_x204 = 0.076923076923076927 * var_chaste_interface__membrane__V;
        const double var_x205 = exp(3.7692307692307692 + var_x204);
        const double var_x206 = 1.0 + var_x205;
        const double var_x207 = 0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x208 = exp(4.593 + var_x207);
        const double var_x209 = exp(-3.52 - 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x210 = 1 / (0.065000000000000002 * var_x208 + 0.56999999999999995 * var_x209);
        const double var_x211 = 1 / (6.0599999999999996 + 39.101999999999997 * var_x210);
        const double var_x212 = exp(1.2866666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x213 = 1.0 + var_x212;
        const double var_x214 = exp(2.7548999999999997 + 0.089999999999999997 * var_chaste_interface__membrane__V);
        const double var_x215 = exp(-2.8607999999999998 - 0.12 * var_chaste_interface__membrane__V);
        const double var_x216 = 1 / (1.0369999999999999 * var_x214 + 0.36899999999999999 * var_x215);
        const double var_x217 = 1 / (2.75352 + 14.40516 * var_x216);
        const double var_x218 = exp(4.7407407407407405 + 0.07407407407407407 * var_chaste_interface__membrane__V);
        const double var_x219 = 1.0 + var_x218;
        const double var_x220 = exp(-3.8001143986272159 + 0.051999376007487906 * var_chaste_interface__membrane__V);
        const double var_x221 = exp(-8.5404617897664554 - 0.022074080614542406 * var_chaste_interface__membrane__V);
        const double var_x222 = 1.3953756414018557 * var_x221;
        const double var_x223 = 1.3953756414018557 * var_x220;
        const double var_x224 = -var_x156;
        const double var_x225 = exp(-11.4 + var_x224);
        const double var_x226 = 1.0 + var_x225;
        const double var_x227 = exp(var_x101);
        const double var_x228 = exp(0.125 * var_chaste_interface__membrane__V);
        const double var_x229 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
        const double var_x230 = exp(-0.0014285714285714286 * var_chaste_interface__membrane__V);
        const double var_x231 = 1.0 / (16.0 * var_x228 + 15.0 * var_x227);
        const double var_x232 = 1.0 / (0.20000000000000001 * var_x230 + 0.14999999999999999 * var_x229);
        const double var_x233 = exp(-var_x207);
        const double var_x234 = 1 / (50.0 * var_x230 + 95.0 * var_x233);
        const double var_x235 = exp(0.014285714285714285 * var_chaste_interface__membrane__V);
        const double var_x236 = exp(var_x204);
        const double var_x237 = 1 / (700.0 * var_x235 + 3100.0 * var_x236);
        const double var_x238 = 1.0 * var_x237;
        const double var_x239 = exp(var_x224);
        const double var_x240 = 1.0 + var_x239;
        const double var_x241 = 1 / var_x240;
        const double var_x242 = var_x238 + 1.0 * var_x234 + 0.00022900000000000001 * var_x241;
        const double var_x243 = 1 / var_x242;
        const double var_x244 = var_x239 / pow(var_x240, 2);
        const double var_x245 = (-10.0 * var_x235 - 238.46153846153848 * var_x236) / pow((var_x236 + 0.22580645161290322 * var_x235), 2);
        const double var_x246 = (0.071428571428571425 * var_x230 + 9.5 * var_x233) / pow((var_x233 + 0.52631578947368418 * var_x230), 2);
        const double var_x247 = 1.0405827263267429e-7 * var_x245;
        const double var_x248 = 0.15037593984962405 * var_x234;
        const double var_x249 = 0.15037593984962405 * var_x237;
        const double var_x250 = 3.4436090225563911e-5 * var_x241;
        const double var_x251 = 1 / (pow((1.0 + 0.00059999999999999995 / var_chaste_interface__intracellular_ion_concentrations__Cai), 2) * pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 2));
        const double var_x252 = 14.1174 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        const double var_x253 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x254 = pow(var_x253, 2.0);
        const double var_x255 = 1.4399999999999998e-6 * var_x254;
        const double var_x256 = 1.0 + var_x255;
        const double var_x257 = 1 / var_x256;
        const double var_x258 = 0.5 * var_x257;
        const double var_x259 = var_x253 * (-var_chaste_interface__intracellular_ion_concentrations__Ca_sub + var_chaste_interface__intracellular_ion_concentrations__Ca_rel) / pow(var_x256, 2);
        const double var_x260 = 1.1811847207744139 * var_x64;
        const double var_x261 = 0.0021639304084587262 * var_chaste_interface__T_type_calcium_channel_current_f_gate__f;
        const double var_x262 = 0.00050612584100462863 * var_x89;
        const double var_x263 = 0.0027403485521966401 * var_x71;
        const double var_x264 = 0.0027403485521966401 * var_x92;
        const double var_x265 = 0.060150151005755326 * var_x257;
        const double var_x266 = 3.0735652457057552e-6 * var_chaste_interface__sustained_inward_current_qi_gate__qi;
        const double var_x267 = 0.076839131142643888 * var_x64;
        const double var_x268 = 3.2924799303311478e-5 * var_x89;
        const double var_x269 = 1.3854903481808197e-5 * var_x68;
        const double var_x270 = 3.6882782948469062e-5 * var_chaste_interface__AP_sensitive_currents_r_gate__r;
        const double var_x271 = -227.69999999999999 * var_chaste_interface__intracellular_ion_concentrations__Cai;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0054000000000000003 - 0.375 * var_x0 - 0.025899999999999999 * var_x1 - 0.02 * var_chaste_interface__AP_sensitive_currents_r_gate__r - 0.10017396017979863 * var_x80 - 0.00044373633078820127 * var_x2 - var_x53 * var_x65 - var_x66 * var_chaste_interface__sustained_inward_current_qa_gate__qa - var_x67 * var_chaste_interface__AP_sensitive_currents_q_gate__q - var_x69 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy - var_x70 * var_chaste_interface__T_type_calcium_channel_current_d_gate__d - var_x72 * var_chaste_interface__L_type_calcium_channel_current_d_gate__d - var_x86 * var_x90);
        IJth(rJacobian, 1, 0) = (-var_chaste_interface__L_type_calcium_channel_current_d_gate__d + 1.0 / var_x140) * (var_x144 - var_x147 - var_x150 - 0.017658069883527455 * var_x148 * var_chaste_interface__membrane__V / pow(var_x149, 2) - 0.0045719999999999997 * var_x142 * var_x151 / pow(var_x143, 2) - 0.011356 * var_x145 * var_x152 / pow(var_x146, 2)) + 0.16666666666666666 * var_x139 * (var_x153 - var_x154 - var_x155) / pow(var_x140, 2);
        IJth(rJacobian, 2, 0) = -0.20000000000000001 * var_x157 * var_x161 / pow(var_x158, 2) + 0.0013085239606137509 * var_x160 * pow(var_x159, 1.0) * (-var_chaste_interface__L_type_calcium_channel_current_f_gate__f + 1.0 / var_x158) / pow((0.17230649552703226 + var_x160), 2);
        IJth(rJacobian, 4, 0) = (-var_chaste_interface__T_type_calcium_channel_current_d_gate__d + 1.0 / var_x165) * (0.0356 * var_x166 - 0.0356 * var_x167) + 0.16666666666666666 * var_x164 * (var_x168 + var_x169) / pow(var_x165, 2);
        IJth(rJacobian, 5, 0) = (-var_chaste_interface__T_type_calcium_channel_current_f_gate__f + 1.0 / var_x171) * (0.0009752925877763327 * var_x172 - 0.00018367346938775509 * var_x173) - 0.17857142857142858 * var_x170 * (var_x174 + var_x175) / pow(var_x171, 2);
        IJth(rJacobian, 6, 0) = var_x183 * (var_x181 + var_x182) + (var_x178 - var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS) * (0.00029184075413518645 * var_x179 - 8.2031958007575546e-6 * var_x180);
        IJth(rJacobian, 7, 0) = var_x183 * (var_x186 + var_x187) + (var_x178 - var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF) * (0.0027637030984589981 * var_x184 - 5.0400434999854427e-5 * var_x185);
        IJth(rJacobian, 8, 0) = (-var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy + 1.0 / var_x189) * (0.0061795265502981441 * var_x190 - 0.0018299935950224174 * var_x191) - 0.058479532163742687 * var_x188 * (var_x192 + var_x193) / pow(var_x189, 2);
        IJth(rJacobian, 9, 0) = var_x200 * (var_x201 * var_x203 + 71.428571428571431 * var_x198 * (var_x202 - var_x203) / pow((var_x198 + 0.071428571428571425 * var_x194), 2)) + (var_x203 - var_x202) * (-var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n + var_x199 * var_x201);
        IJth(rJacobian, 10, 0) = -0.076923076923076927 * var_x205 * var_x211 / pow(var_x206, 2) - 0.078713879440468384 * (-var_chaste_interface__AP_sensitive_currents_q_gate__q + 1.0 / var_x206) * (0.045599999999999995 * var_x209 - 0.0065000000000000006 * var_x208) / (pow((0.15497928494706154 + var_x210), 2) * pow((var_x209 + 0.11403508771929825 * var_x208), 2));
        IJth(rJacobian, 11, 0) = 0.066666666666666666 * var_x212 * var_x217 / pow(var_x213, 2) - 0.064554184748538135 * (-var_chaste_interface__AP_sensitive_currents_r_gate__r + 1.0 / var_x213) * (0.04428 * var_x215 - 0.093329999999999996 * var_x214) / (pow((0.19114817190506733 + var_x216), 2) * pow((var_x214 + 0.35583413693346194 * var_x215), 2));
        IJth(rJacobian, 12, 0) = (-var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + 1.0 / var_x219) * (0.0725586626489447 * var_x220 - 0.030801634395873377 * var_x221) - 0.07407407407407407 * var_x218 * (var_x222 + var_x223) / pow(var_x219, 2);
        IJth(rJacobian, 13, 0) = (-var_chaste_interface__sustained_inward_current_qa_gate__qa + 1.0 / var_x226) * (0.00390625 * (-2.0 * var_x228 - 0.29999999999999999 * var_x227) / pow((var_x228 + 0.9375 * var_x227), 2) + 24.999999999999996 * (0.013636363636363636 * var_x229 + 0.00028571428571428574 * var_x230) / pow((var_x230 + 0.74999999999999989 * var_x229), 2)) + 0.20000000000000001 * var_x225 * (var_x231 + var_x232) / pow(var_x226, 2);
        IJth(rJacobian, 14, 0) = (-var_chaste_interface__sustained_inward_current_qi_gate__qi + var_x238 * var_x243) * (6.8872180451127825e-6 * var_x244 + 1.5647860546266811e-8 * var_x245 + 1.6662153999958345e-5 * var_x246) + (var_x243 * var_x247 + var_x238 * (-var_x247 - 4.5800000000000002e-5 * var_x244 - 0.00011080332409972299 * var_x246) / pow(var_x242, 2)) * (var_x248 + var_x249 + var_x250);
        IJth(rJacobian, 18, 0) = var_x260 * var_x53 + var_x262 * var_x86 - var_x261 * var_chaste_interface__T_type_calcium_channel_current_d_gate__d - var_x263 * var_chaste_interface__L_type_calcium_channel_current_d_gate__d;
        IJth(rJacobian, 19, 0) = -1.1064834884540721e-6 - 6.1578240506668264e-5 * var_x80 - 2.9452438966975398e-5 * var_x0 - var_x266 * var_chaste_interface__sustained_inward_current_qa_gate__qa - var_x267 * var_x53 - var_x268 * var_x86;
        IJth(rJacobian, 20, 0) = 4.105216033777884e-5 * var_x80 - 4.0980869942743402e-6 * var_chaste_interface__AP_sensitive_currents_r_gate__r - 5.3070226575852706e-6 * var_x1 - 4.7386692175668483e-5 * var_x0 - 9.0923504304507221e-8 * var_x2 - var_x269 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy - var_x270 * var_chaste_interface__AP_sensitive_currents_q_gate__q;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x72 * var_x91);
        IJth(rJacobian, 1, 1) = var_x154 + var_x155 - var_x153;
        IJth(rJacobian, 18, 1) = -var_x263 * var_x91;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x93 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa);
        IJth(rJacobian, 2, 2) = -var_x161;
        IJth(rJacobian, 18, 2) = -var_x264 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x93 * var_chaste_interface__L_type_calcium_channel_current_f_gate__f);
        IJth(rJacobian, 3, 3) = -0.021000000000000005 - var_x162;
        IJth(rJacobian, 18, 3) = -var_x264 * var_chaste_interface__L_type_calcium_channel_current_f_gate__f;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x70 * var_x91);
        IJth(rJacobian, 4, 4) = -var_x168 - var_x169;
        IJth(rJacobian, 18, 4) = -var_x261 * var_x91;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-0.45800000000000002 * var_x94);
        IJth(rJacobian, 5, 5) = -var_x174 - var_x175;
        IJth(rJacobian, 18, 5) = -0.0021639304084587262 * var_x94;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.027046577588354045 * var_x98);
        IJth(rJacobian, 6, 6) = -var_x181 - var_x182;
        IJth(rJacobian, 20, 6) = -5.5419613927232791e-6 * var_x98;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.040569866382531065 * var_x98);
        IJth(rJacobian, 7, 7) = -var_x186 - var_x187;
        IJth(rJacobian, 20, 7) = -8.3129420890849178e-6 * var_x98;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x69 * var_x97);
        IJth(rJacobian, 8, 8) = -var_x192 - var_x193;
        IJth(rJacobian, 20, 8) = -var_x269 * var_x97;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.051799999999999999 * var_x100);
        IJth(rJacobian, 9, 9) = -var_x195 - var_x199;
        IJth(rJacobian, 20, 9) = -1.0614045315170541e-5 * var_x100;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x67 * var_x97);
        IJth(rJacobian, 10, 10) = -var_x211;
        IJth(rJacobian, 20, 10) = -var_x270 * var_x97;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x101 + 0.53453099652795777 * var_x96 - 0.17999999999999999 * var_x102);
        IJth(rJacobian, 11, 11) = -var_x217;
        IJth(rJacobian, 20, 11) = 0.00010952772624538629 * var_x96 - 4.0980869942743402e-6 * var_chaste_interface__membrane__V - 3.6882782948469062e-5 * var_x102;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-0.28747499999999998 * var_x104 - 0.46252500000000002 * var_x105);
        IJth(rJacobian, 12, 12) = -var_x222 - var_x223;
        IJth(rJacobian, 19, 12) = -5.8904877933950796e-5 * var_x104;
        IJth(rJacobian, 20, 12) = -9.4773384351336967e-5 * var_x105;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x106 * var_x66);
        IJth(rJacobian, 13, 13) = -var_x231 - var_x232;
        IJth(rJacobian, 19, 13) = -var_x106 * var_x266;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-0.014999999999999999 * var_x107);
        IJth(rJacobian, 14, 14) = -var_x248 - var_x249 - var_x250;
        IJth(rJacobian, 19, 14) = -3.0735652457057552e-6 * var_x107;
        IJth(rJacobian, 15, 15) = -27.670820618882221 + 2.7527999999999997 * var_chaste_interface__calcium_buffering__fTC + 14.1174 * var_chaste_interface__calcium_buffering__fTMC + 14.1174 * var_chaste_interface__calcium_buffering__fTMM + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMi - 7.7327439216924522e-8 * var_x251;
        IJth(rJacobian, 16, 15) = 2.9999999999999997e-6 * var_x251;
        ...
        IJth(rJacobian, 17, 17) = -5.3566666666666665 - var_x258 + 5.3399999999999999 * var_chaste_interface__calcium_buffering__fCQ;
        IJth(rJacobian, 18, 17) = var_x265;
        IJth(rJacobian, 26, 17) = 0.53400000000000003 - 0.53400000000000003 * var_chaste_interface__calcium_buffering__fCQ;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x113 * var_x65 - var_x115 * var_x90);
        IJth(rJacobian, 3, 18) = 0.021000000000000005 / var_x163 - 60.000000000000014 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa - 0.00035 * (0.021000000000000005 + var_x162) / pow(var_x163, 2);
        IJth(rJacobian, 15, 18) = 0.55412061888222286;
        IJth(rJacobian, 17, 18) = var_x258 - var_x255 * var_x259;
        IJth(rJacobian, 18, 18) = -35.246499999999997 - var_x265 + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMs + var_x113 * var_x260 + var_x115 * var_x262 + 1.7323243489657531e-7 * var_x254 * var_x259;
        IJth(rJacobian, 19, 18) = -var_x113 * var_x267 - var_x115 * var_x268;
        IJth(rJacobian, 23, 18) = 227.69999999999999 - 227.69999999999999 * var_chaste_interface__calcium_buffering__fCMs;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-0.14432336906254858 * var_x73 - 3.8416074556718658 * var_x128 - 0.083066116860444628 * var_x129 - 2.6773043380529855 * var_x133 - var_x127 * var_x65 - var_x130 * var_x90 - 120.72185398601877 * var_x131 * var_x132 * var_x73 * var_x74);
        IJth(rJacobian, 18, 19) = var_x127 * var_x260 + var_x130 * var_x262;
        IJth(rJacobian, 19, 19) = -2.9572486086254304e-5 * var_x73 - 0.00078716207755981068 * var_x128 - 0.0016457739131233819 * var_x133 - var_x127 * var_x267 - var_x130 * var_x268 - 0.07420929896171842 * var_x131 * var_x132 * var_x73 * var_x74;
        IJth(rJacobian, 20, 19) = 0.0010971826087489212 * var_x133 - 1.7020608658533032e-5 * var_x129 + 0.04947286597447894 * var_x131 * var_x132 * var_x73 * var_x74;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0021962113249247841 - 6.1808487292273409 * var_x134 - 0.53453099652795777 * var_x135 - 0.69221764050370527 * var_x129 - 4.8107789687516194 * var_x136 - 1.8071542588717018 * var_x137);
        IJth(rJacobian, 20, 20) = -4.5001325336761377e-7 - 0.00010952772624538629 * var_x135 - 0.00098574953620847667 * var_x136 - 0.00014183840548777525 * var_x129 - 0.0012664827895411826 * var_x134 - 0.00037029376824648032 * var_x137;
        IJth(rJacobian, 15, 21) = var_x252;
        IJth(rJacobian, 21, 21) = -6.4435000000000011;
        IJth(rJacobian, 25, 21) = var_x271;
        IJth(rJacobian, 15, 22) = 0.024390000000000002 + 10.246499999999999 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        IJth(rJacobian, 22, 22) = -0.54200000000000004 + var_x271;
        ...
        IJth(rJacobian, 15, 25) = 0.00046562000000000003 + var_x252;
        IJth(rJacobian, 21, 25) = -5.6925000000000008;
        IJth(rJacobian, 25, 25) = -0.0075100000000000002 + var_x271;
