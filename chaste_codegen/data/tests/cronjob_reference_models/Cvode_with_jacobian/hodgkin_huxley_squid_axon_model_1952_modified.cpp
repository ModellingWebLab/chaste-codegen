...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x12 = exp(0.9375 + 0.012500000000000001 * var_chaste_interface__membrane__V);
        ...
        IJth(rJacobian, 1, 0) = -var_x3 * var_x7 + 0.22222222222222221 * var_x2 * var_chaste_interface__sodium_channel_m_gate__m - 0.010000000000000002 * var_x3 * var_x5 * var_x8 / pow(var_x6, 2);
        IJth(rJacobian, 2, 0) = -0.0035000000000000005 * var_x9 * (1.0 - var_chaste_interface__sodium_channel_h_gate__h) - 0.10000000000000001 * var_x10 * var_chaste_interface__sodium_channel_h_gate__h / pow(var_x11, 2);
        IJth(rJacobian, 3, 0) = -var_x13 * var_x16 - 0.0015625000000000001 * var_x12 * var_chaste_interface__potassium_channel_n_gate__n - 0.001 * var_x13 * var_x14 * var_x17 / pow(var_x15, 2);
        ...
        IJth(rJacobian, 3, 3) = -0.125 * var_x12 + var_x16 * var_x17;
    }
