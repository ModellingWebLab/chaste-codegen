...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x154 = var_x144 / pow(var_x145, 3);
        ...
        const double var_x199 = exp(2.8571428571428572 + var_x102);
        ...
        const double var_x261 = 0.00173434701107436 * var_x29;
        const double var_x262 = 6.3176611368492499e-5 * var_x40;
        const double var_x263 = 0.00047773503410627734 * var_x13 - 1.788348110893497e-5 * var_chaste_interface__membrane__V;
        const double var_x264 = 0.00091800065377284671 * var_x13 - 3.4364336248541711e-5 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 17, 0) = -3.389679425876563e-8 - 3.0388663876087418e-8 * var_x11 - 7.3941785176126768e-11 * var_x34 - 0.00080594011556369446 * var_x46 - var_x261 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 18, 0) = 0.00053729341037579627 * var_x46 + 3.79059668210955e-6 * var_x37 - 3.4364336248541711e-5 * var_x4 - 1.788348110893497e-5 * var_x27 - 2.8537261917770623e-7 * var_x32 - 6.3176611368492499e-5 * var_x26 - 4.5819114998055616e-5 * var_x0 - 1.7065282626826835e-6 * var_x3 - var_x262 * var_x39;
        ...
        IJth(rJacobian, 14, 1) = var_x231 * (0.00036000000000000002 + 7.96875e-10 * var_x96);
        ...
        IJth(rJacobian, 18, 2) = var_x263 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        IJth(rJacobian, 18, 3) = var_x263 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        IJth(rJacobian, 18, 12) = var_x264 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        IJth(rJacobian, 18, 13) = var_x264 * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        IJth(rJacobian, 15, 15) = var_x255 * (-1.1399999999999999 - var_x259 + 0.61222384784198969 * var_x248 - 0.65303877103145569 * var_x247 - 0.0025203523969264349 * var_x76) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x241 * var_x259 - var_x251 * var_x54) / (pow(var_x252, 3) * pow(var_x253, 2));
        ...
        IJth(rJacobian, 18, 18) = 0.00010126109252331096 * var_x89 - 0.00091800065377284671 * var_x86 - 0.0016876848753885161 * var_x84 - 0.00047773503410627734 * var_x85 - 4.5587787568311439e-5 * var_x83 - 0.011750408368292439 * var_x81 - var_x262 * var_x88;
    }
