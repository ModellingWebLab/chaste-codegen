...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x13 = exp(-12.0 + 0.059999999999999998 * var_chaste_interface__membrane__V - 1.6028256395817391 * var_x12);
        ...
        const double var_x19 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__membrane__V - 0.0053427521319391307 * var_x12);
        ...
        const double var_x26 = 0.29399999999999998 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x27 = 0.153 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        const double var_x31 = -26.713760659695652 * var_x12 + var_chaste_interface__membrane__V;
        ...
        const double var_x35 = var_x13 / pow(var_x14, 2);
        const double var_x36 = var_x24 * var_x31;
        ...
        const double var_x43 = var_x16 * var_x22 / pow(var_x17, 2);
        const double var_x44 = 0.0060000000000000001 * var_x35 - 0.5 * var_x43 - var_x18 * (0.10000000000000001 * var_x21 + 0.00060000000000000006 * var_x19);
        const double var_x45 = var_x15 * var_x31 / pow(var_x23, 2);
        ...
        const double var_x62 = var_x4 * var_x6;
        const double var_x63 = var_x31 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        const double var_x64 = 1 / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i);
        const double var_x65 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 1.0) * (-26.713760659695652 * log(9.6000000000000014 * var_x64) + var_chaste_interface__membrane__V);
        ...
        const double var_x75 = var_x31 * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x76 = var_x50 * var_x55;
        const double var_x77 = 1 / var_x41;
        const double var_x78 = var_x38 * var_x77;
        const double var_x79 = var_x0 * var_x64;
        ...
        const double var_x83 = var_x11 * var_x3;
        const double var_x84 = var_x11 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x85 = var_x11 * var_x25;
        const double var_x86 = var_x11 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x87 = var_x11 * var_x35;
        const double var_x88 = 0.16028256395817392 * var_x87 - var_x18 * (2.6713760659695653 * var_x11 * var_x21 + 0.01602825639581739 * var_x11 * var_x19) - 13.356880329847826 * var_x11 * var_x43;
        ...
        const double var_x98 = -var_x20;
        const double var_x99 = exp(-4.5 + var_x98);
        const double var_x100 = 1.0 + var_x99;
        const double var_x101 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x102 = exp(-3.7142857142857144 - var_x101);
        const double var_x103 = 1.0 + var_x102;
        const double var_x104 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + 1.0 / var_x103;
        const double var_x105 = exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__membrane__V);
        const double var_x106 = 1.0 + var_x105;
        const double var_x107 = 0.050000000000000003 * var_chaste_interface__membrane__V;
        const double var_x108 = -var_x107;
        const double var_x109 = exp(-3.0 + var_x108);
        const double var_x110 = 1.0 + var_x109;
        const double var_x111 = exp(-3.0 + var_x107);
        const double var_x112 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x113 = 1.0 + var_x112;
        const double var_x114 = 0.014880952380952382 / var_x113 - 0.014880952380952382 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x115 = 1.0 + var_x111;
        const double var_x116 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        const double var_x117 = 1.0 + var_x116;
        const double var_x118 = -0.16666666666666666 * var_chaste_interface__membrane__V;
        const double var_x119 = exp(0.83333333333333337 + var_x118);
        const double var_x120 = 1.0 + var_x119;
        const double var_x121 = 1 / sqrt(var_x120);
        const double var_x122 = exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x123 = 1.0 + var_x122;
        const double var_x124 = 1 / var_x123;
        const double var_x125 = var_x121 * var_x124;
        const double var_x126 = 1 / (80.0 + 1400.0 * var_x125);
        const double var_x127 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x128 = exp(7.0 + var_x127);
        const double var_x129 = 1.0 + var_x128;
        const double var_x130 = 1 / var_x129;
        const double var_x131 = exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V);
        const double var_x132 = 1.0 + var_x131;
        const double var_x133 = 1 / var_x132;
        const double var_x134 = 1 / (0.10000000000000001 * var_x130 + 0.10000000000000001 * var_x133);
        const double var_x135 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x136 = 1.0 + var_x135;
        const double var_x137 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1.0 * pow(var_x136, (-2.0));
        const double var_x138 = exp(-12.0 - var_x127);
        const double var_x139 = 1.0 + var_x138;
        const double var_x140 = var_x134 * var_x139;
        const double var_x141 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V);
        const double var_x142 = 1.0 + var_x141;
        const double var_x143 = 1.0 * pow(var_x142, (-2.0));
        const double var_x144 = var_x143 - var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x151 = var_x141 * pow(var_x142, (-3.0));
        const double var_x152 = 0.26917900403768508 * var_x151;
        ...
        const double var_x155 = 1 / (0.16883116883116883 + 0.16883116883116883 * var_x154);
        const double var_x156 = var_x143 - var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x171 = exp(-3.2000000000000002 + var_x98);
        ...
        const double var_x175 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x176 = 1.0 + var_x175;
        const double var_x177 = exp(2.5 + var_x108);
        const double var_x178 = 1.0 + var_x177;
        const double var_x179 = 1 / var_x178;
        const double var_x180 = exp(1.0 + var_x127);
        ...
        const double var_x187 = 1 / (1.0 * var_x179 + 1.3999999999999999 * var_x186);
        const double var_x188 = exp(3.0 + var_x20);
        const double var_x189 = 1.0 + var_x188;
        const double var_x190 = 1 / var_x189;
        const double var_x191 = exp(1.3 + var_x98);
        const double var_x192 = 1.0 + var_x191;
        const double var_x193 = 1 / var_x192;
        const double var_x194 = 1 + 0.037037037037037035 * var_chaste_interface__membrane__V;
        const double var_x195 = pow(var_x194, 2.0);
        const double var_x196 = exp(-3.2400000000000002 * var_x195);
        const double var_x197 = exp(2.8571428571428572 + var_x101);
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = var_x188 / pow(var_x189, 2);
        const double var_x200 = pow(var_x194, 1.0);
        const double var_x201 = 1 / (20.0 + 200.0 * var_x193 + 180.0 * var_x190 + 1102.5 * var_x196);
        const double var_x202 = exp(2.5 + var_x98);
        const double var_x203 = 1.0 + var_x202;
        const double var_x204 = 1 / var_x203;
        const double var_x205 = exp(-3.0375000000000001 * var_x195);
        const double var_x206 = exp(5.0 + var_x101);
        const double var_x207 = 1.0 + var_x206;
        const double var_x208 = 1 / (80.0 * var_x190 + 31.0 * var_x204 + 562.0 * var_x205);
        const double var_x209 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2.0);
        const double var_x210 = 1 / (1.0 + 399.99999999999994 * var_x209);
        const double var_x211 = 1 / (2.0 + 80.0 * var_x210);
        const double var_x212 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 1.0);
        const double var_x213 = var_x212 / pow((0.0025000000000000005 + var_x209), 2);
        const double var_x214 = exp(-4.0 + var_x127);
        const double var_x215 = 1.0 + var_x214;
        const double var_x216 = 1 / var_x215;
        const double var_x217 = 1 + 0.022222222222222223 * var_chaste_interface__membrane__V;
        const double var_x218 = exp(-6.328125 * pow(var_x217, 2.0));
        const double var_x219 = exp(4.0 + var_x127);
        const double var_x220 = 1.0 + var_x219;
        const double var_x221 = 1 / (3.0 + 5.0 * var_x216 + 85.0 * var_x218);
        const double var_x222 = exp(3.3333333333333335 + var_x118);
        const double var_x223 = 1.0 + var_x222;
        const double var_x224 = 1 + 0.025000000000000001 * var_chaste_interface__membrane__V;
        const double var_x225 = exp(-0.88888888888888884 * pow(var_x224, 2.0));
        ...
        const double var_x228 = pow(var_x227, (-2.0));
        const double var_x229 = 1 / (1.0 + 3.0 * var_x228);
        const double var_x230 = 1.0 * var_x229;
        const double var_x231 = 1 / var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x232 = pow(var_x231, 2.0);
        ...
        const double var_x241 = 1 - 0.59999999999999998 * var_x233;
        const double var_x242 = var_chaste_interface__calcium_dynamics__R_prime / pow((0.40000000000000002 + var_x235), 2);
        const double var_x243 = var_x231 * var_x232 / pow((0.44444444444444442 + var_x232), 2);
        const double var_x244 = var_x240 * var_x242 * var_x243 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4.0) / pow(var_x241, 3);
        const double var_x245 = var_x240 / pow(var_x241, 2);
        const double var_x246 = var_x209 * var_x237 * var_x243 * var_x245;
        const double var_x247 = var_x242 * var_x245 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3.0);
        const double var_x248 = var_x212 * var_x234 * var_x237 * var_x240;
        const double var_x249 = var_x235 * var_x236 * var_x240;
        const double var_x250 = 0.010081409587705739 * var_x52;
        const double var_x251 = var_x250 * var_x50;
        ...
        const double var_x257 = var_x256 * var_x71;
        const double var_x258 = var_x256 * var_x73;
        const double var_x259 = 0.30611192392099479 * var_x238;
        const double var_x260 = -0.11249999999999999 + 0.067500000000000004 * var_x233;
        const double var_x261 = 0.0017343470110743602 * var_x29;
        const double var_x262 = 1.788348110893497e-5 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x263 = 3.4364336248541711e-5 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x264 = 6.3176611368492499e-5 * var_x45;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00088199999999999997 + 0.032430000000000007 * var_x37 + 0.0430491257510425 * var_x56 - 2.2983750000000001 * var_x42 - 8.6662202299424464e-5 * var_x10 - 0.39200000000000002 * var_x0 - 0.54050000000000009 * var_x25 - 0.0146 * var_x3 - 0.0024414715719063545 * var_x32 - 0.010762281437760625 * var_x57 - 2.1086672225679694e-7 * var_x34 - var_x26 * var_chaste_interface__transient_outward_current_s_gate__s - var_x27 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x30 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x44 * var_x46 - var_x50 * var_x53);
        IJth(rJacobian, 1, 0) = var_x93 * (-3.4598107243429746e-8 + 1.0129554625362473e-8 * var_x10 + 2.4647261725375594e-11 * var_x34);
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x100 * var_x104 * var_x105 - 3.7037037037037037e-5 * var_x104 * var_x106 * var_x99 + 5.2910052910052905e-5 * var_x100 * var_x102 * var_x106 / pow(var_x103, 2);
        IJth(rJacobian, 3, 0) = var_x110 * var_x111 * var_x114 - var_x109 * var_x114 * var_x115 - 0.01240079365079365 * var_x110 * var_x112 * var_x115 / pow(var_x113, 2);
        IJth(rJacobian, 4, 0) = 0.071428571428571425 * var_x116 * var_x126 / pow(var_x117, 2) + 5.1020408163265302e-7 * (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1.0 / var_x117) * (93.333333333333329 * var_x121 * var_x122 / pow(var_x123, 2) - 116.66666666666666 * var_x119 * var_x124 / pow(var_x120, (3 / 2))) / pow((0.057142857142857141 + var_x125), 2);
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x135 * var_x140 * pow(var_x136, (-3.0)) - 0.20000000000000001 * var_x134 * var_x137 * var_x138 + 99.999999999999986 * var_x137 * var_x139 * (0.00050000000000000001 * var_x131 / pow(var_x132, 2) + 0.020000000000000004 * var_x128 / pow(var_x129, 2)) / pow((var_x130 + var_x133), 2);
        IJth(rJacobian, 6, 0) = ((var_x153) ? (var_x144 * (108035.0 * var_x145 + 0.21330000000000002 * var_x146 - 0.008382352941176471 * var_x147) - var_x152 * (var_x148 + var_x149 + var_x150)) : (-var_x152 * var_x155 + 0.53361053361053368 * var_x144 * var_x154 / pow((1 + var_x154), 2)));
        IJth(rJacobian, 7, 0) = ((var_x153) ? (var_x156 * (var_x163 - 0.00025500480000000003 * var_x167 + var_x162 * var_x168 * (3.0508668000000001e-7 * var_x158 - 6214.6032000000005 * var_x157) + 0.0033402720000000005 * var_x164 * var_x166 / pow(var_x165, 2) - 0.311 * var_x159 * var_x160 * var_x168 / pow(var_x161, 2)) - var_x152 * (var_x169 + var_x170)) : (0.034200000000000001 * var_x156 * var_x174 - 0.16150740242261105 * var_x151 * var_x174 + 0.059999999999999998 * var_x156 * var_x171 * var_x173 / pow(var_x172, 2)));
        IJth(rJacobian, 8, 0) = 0.13333333333333333 * var_x175 * var_x187 / pow(var_x176, 2) + 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1.0 / var_x176) * (-0.050000000000000003 * var_x177 / pow(var_x178, 2) + 0.27999999999999997 * var_x180 * var_x185 / pow(var_x181, 2) - 0.15076923076923077 * var_x182 * var_x183 / pow(var_x184, 2)) / pow((var_x186 + 0.7142857142857143 * var_x179), 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1.0 / var_x198) * (18.0 * var_x199 + 264.60000000000002 * var_x196 * var_x200 - 20.0 * var_x191 / pow(var_x192, 2)) / pow((0.018140589569160998 + var_x196 + 0.16326530612244897 * var_x190 + 0.18140589569160998 * var_x193), 2) - 0.14285714285714285 * var_x197 * var_x201 / pow(var_x198, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x207) * (8.0 * var_x199 + 126.45 * var_x200 * var_x205 - 3.1000000000000001 * var_x202 / pow(var_x203, 2)) / pow((var_x205 + 0.055160142348754451 * var_x204 + 0.14234875444839859 * var_x190), 2) - 0.09571428571428571 * var_x206 * var_x208 / pow(var_x207, 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / var_x220) * (1.0 * var_x214 / pow(var_x215, 2) + 23.90625 * var_x218 * pow(var_x217, 1.0)) / pow((0.035294117647058823 + var_x218 + 0.058823529411764705 * var_x216), 2) - 0.20000000000000001 * var_x219 * var_x221 / pow(var_x220, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x222 * var_x226 / pow(var_x223, 2) + 0.0046783625730994153 * var_x225 * pow(var_x224, 1.0) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / var_x223) / pow((0.084210526315789472 + var_x225), 2);
        IJth(rJacobian, 15, 0) = var_x255 * (-var_x251 + 0.00075477277169111218 * var_x56 - 0.00018869319292277804 * var_x57);
        IJth(rJacobian, 17, 0) = -3.389679425876563e-8 - 0.00080594011556369446 * var_x42 - 3.0388663876087418e-8 * var_x10 - 7.3941785176126781e-11 * var_x34 - var_x261 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 18, 0) = 0.00053729341037579627 * var_x42 + 3.79059668210955e-6 * var_x37 - 6.3176611368492499e-5 * var_x25 - 1.7065282626826835e-6 * var_x3 - 4.5819114998055616e-5 * var_x0 - 2.8537261917770629e-7 * var_x32 - var_x262 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x263 * var_chaste_interface__transient_outward_current_s_gate__s - var_x264 * var_x44;
        ...
        IJth(rJacobian, 1, 1) = var_x93 * (-0.0038240087783467445 - var_x94 + 7.2352122917848019e-6 * var_x61 - 4.6212277808973237e-7 * var_x60 - 5.3144431236283834e-11 * var_x96 - 0.069488744729986562 * var_x62) + 0.00040000000000000002 * pow(var_x90, (-3.0)) * (2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973237e-7 * log(2.0 * var_x60) + 0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027069 * var_x97 - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - var_x94 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362473e-8 * var_x33 * var_x6) / pow(var_x91, 2);
        IJth(rJacobian, 14, 1) = var_x230 * (0.00036000000000000002 + 7.968749999999999e-10 * var_x96);
        IJth(rJacobian, 15, 1) = 1.1399999999999999 * var_x254;
        IJth(rJacobian, 17, 1) = 0.20846623418995969 * var_x62;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x27 * var_x31);
        IJth(rJacobian, 2, 2) = 0.00037037037037037035 * var_x106 * (-1.0 - var_x99);
        IJth(rJacobian, 18, 2) = -var_x262 * var_x31;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.153 * var_x63);
        IJth(rJacobian, 3, 3) = 0.29761904761904762 * var_x115 * (-1.0 - var_x109);
        IJth(rJacobian, 18, 3) = -1.788348110893497e-5 * var_x63;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.78400000000000003 * var_x65);
        IJth(rJacobian, 4, 4) = -var_x126;
        ...
        IJth(rJacobian, 5, 5) = -1.0 * var_x140;
        IJth(rJacobian, 17, 5) = -0.0052030410332230808 * var_x69;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x30 * var_x67);
        IJth(rJacobian, 6, 6) = ((var_x153) ? (-var_x148 - var_x149 - var_x150) : (-var_x155));
        IJth(rJacobian, 17, 6) = -var_x261 * var_x67;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-14.837999999999999 * var_x70);
        IJth(rJacobian, 7, 7) = ((var_x153) ? (-var_x169 - var_x170) : (-0.59999999999999998 * var_x174));
        IJth(rJacobian, 17, 7) = -0.0017343470110743602 * var_x70;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x72 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 8, 8) = -var_x187;
        ...
        IJth(rJacobian, 11, 11) = -var_x211;
        IJth(rJacobian, 15, 11) = -var_x258 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x26 * var_x31);
        IJth(rJacobian, 12, 12) = -var_x221;
        IJth(rJacobian, 18, 12) = -var_x263 * var_x31;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.29399999999999998 * var_x75);
        IJth(rJacobian, 13, 13) = -var_x226;
        IJth(rJacobian, 18, 13) = -3.4364336248541711e-5 * var_x75;
        IJth(rJacobian, 1, 14) = 2.40087783467447e-5 * var_x92;
        IJth(rJacobian, 14, 14) = var_x230 * (-0.00036000000000000002 - var_x239 + 0.0087039999999999982 * var_x244 - 0.0032639999999999995 * var_x246) + 0.66666666666666663 * pow(var_x227, (-3.0)) * (0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0.0063749999999999996 * var_x97 - 0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x239 * var_x240) / pow((0.33333333333333331 + var_x228), 2);
        IJth(rJacobian, 15, 14) = var_x255 * (var_x259 + 0.065303877103145558 * var_x246 - 0.17414367227505481 * var_x244);
        IJth(rJacobian, 16, 14) = 0.060000000000000005 * var_x243 * var_chaste_interface__calcium_dynamics__Ca_ss * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-0.14375050524031124 * var_x76);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x92;
        IJth(rJacobian, 11, 15) = -0.0030000000000000005 * var_x211 * var_x213 + 6.2500000000000015e-5 * var_x213 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x210) / pow((0.025000000000000001 + var_x210), 2);
        IJth(rJacobian, 14, 15) = var_x230 * (var_x239 + 0.032639999999999995 * var_x247 - 0.030599999999999995 * var_x248);
        IJth(rJacobian, 15, 15) = var_x255 * (-1.1399999999999999 - var_x259 + 0.61222384784198958 * var_x248 - 0.0025203523969264349 * var_x76 - 0.65303877103145558 * var_x247) + 0.00020000000000000001 * pow(var_x252, (-3.0)) * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x240 * var_x259 - var_x251 * var_x54) / pow(var_x253, 2);
        IJth(rJacobian, 16, 15) = var_x260 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -0.015299999999999998 * var_x229 * var_x249;
        IJth(rJacobian, 15, 16) = 0.30611192392099479 * var_x249 * var_x254;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x260 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (0.001436484375 * var_x80 - 2.2983750000000001 * var_x78 - 0.0077469905913117388 * var_x66 - 0.00051997321379654684 * var_x81 - 0.31415382535802089 * var_x79 - 396.37878066856405 * var_x82);
        IJth(rJacobian, 1, 17) = 6.0777327752174836e-8 * var_x81 * var_x92;
        IJth(rJacobian, 17, 17) = 5.0371257222730904e-7 * var_x80 - 0.00080594011556369446 * var_x78 - 9.0551084895961074e-7 * var_x66 - 1.8233198325652452e-7 * var_x81 - 0.046330930954698979 * var_x82;
        IJth(rJacobian, 18, 17) = 0.00053729341037579627 * var_x78 - 3.6720026150913873e-5 * var_x79 - 3.3580838148487267e-7 * var_x80;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (0.86632725819393008 * var_x89 - 10.471794178600696 * var_x79 - 4.087205380933435 * var_x84 - 0.3900209056315565 * var_x83 - 14.438787636565502 * var_x85 - 7.8538456339505212 * var_x86 - var_x46 * var_x88);
        IJth(rJacobian, 18, 18) = 0.00010126109252331096 * var_x89 - 4.5587787568311439e-5 * var_x83 - 0.00091800065377284682 * var_x86 - 0.001224000871697129 * var_x79 - 0.0016876848753885161 * var_x85 - 0.00047773503410627734 * var_x84 - var_x264 * var_x88;
    }
