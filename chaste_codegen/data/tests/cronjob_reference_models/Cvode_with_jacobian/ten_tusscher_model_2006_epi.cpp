...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x5 = 1 / var_chaste_interface__potassium_dynamics__K_i;
        const double var_x6 = log(5.4000000000000004 * var_x5);
        const double var_x7 = exp(-12.0 + 0.059999999999999998 * var_chaste_interface__membrane__V - 1.6028256395817391 * var_x6);
        const double var_x8 = 1.0 + var_x7;
        const double var_x9 = 1 / var_x8;
        const double var_x10 = exp(13.356880329847826 * var_x6 - 0.5 * var_chaste_interface__membrane__V);
        const double var_x11 = 1.0 + var_x10;
        const double var_x12 = 1 / var_x11;
        const double var_x13 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__membrane__V - 0.0053427521319391307 * var_x6);
        const double var_x14 = 0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x15 = exp(-1.0 + var_x14 - 2.6713760659695653 * var_x6);
        ...
        const double var_x20 = var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        const double var_x31 = -26.713760659695652 * var_x6 + var_chaste_interface__membrane__V;
        ...
        const double var_x36 = var_x18 * var_x31;
        ...
        const double var_x43 = var_x10 * var_x16 / pow(var_x11, 2);
        const double var_x44 = 0.0060000000000000001 * var_x35 - 0.5 * var_x43 - var_x12 * (0.10000000000000001 * var_x15 + 0.00060000000000000006 * var_x13);
        const double var_x45 = var_x31 * var_x9 / pow(var_x17, 2);
        ...
        const double var_x62 = var_x21 * var_x23;
        const double var_x63 = 4.087205380933435 * var_x6 - 0.153 * var_chaste_interface__membrane__V;
        ...
        const double var_x75 = 7.8538456339505212 * var_x6 - 0.29399999999999998 * var_chaste_interface__membrane__V;
        ...
        const double var_x80 = var_x0 * (0.10416666666666666 * var_chaste_interface__potassium_dynamics__K_i + 0.0031249999999999997 * var_chaste_interface__sodium_dynamics__Na_i) / pow(var_x64, 2);
        ...
        const double var_x83 = var_x3 * var_x5;
        const double var_x84 = var_x4 * var_x5;
        const double var_x85 = var_x20 * var_x5;
        const double var_x86 = var_x19 * var_x5;
        const double var_x87 = var_x35 * var_x5;
        const double var_x88 = 0.16028256395817392 * var_x87 - var_x12 * (0.01602825639581739 * var_x13 * var_x5 + 2.6713760659695653 * var_x15 * var_x5) - 13.356880329847826 * var_x43 * var_x5;
        ...
        const double var_x174 = exp(-3.2000000000000002 - var_x14);
        ...
        const double var_x261 = 0.30611192392099479 * var_x241;
        const double var_x262 = -0.11249999999999999 + 0.067500000000000004 * var_x236;
        const double var_x263 = 0.0017343470110743602 * var_x29;
        const double var_x264 = 6.3176611368492499e-5 * var_x45;
        const double var_x265 = 0.00047773503410627739 * var_x6 - 1.788348110893497e-5 * var_chaste_interface__membrane__V;
        const double var_x266 = 0.00091800065377284671 * var_x6 - 3.4364336248541711e-5 * var_chaste_interface__membrane__V;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00088199999999999997 + 0.03243 * var_x37 + 0.0430491257510425 * var_x56 - 2.2983750000000001 * var_x42 - 0.39200000000000002 * var_x0 - 0.29399999999999998 * var_x4 - 0.0146 * var_x3 - 0.0024414715719063545 * var_x32 - 2.1086672225679694e-7 * var_x34 - 0.54050000000000009 * var_x19 - 0.153 * var_x20 - 0.010762281437760625 * var_x57 - 8.6662202299424464e-5 * var_x27 - var_x30 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x44 * var_x46 - var_x50 * var_x53);
        IJth(rJacobian, 1, 0) = var_x93 * (-3.4598107243429746e-8 + 1.0129554625362473e-8 * var_x27 + 2.464726172537559e-11 * var_x34);
        ...
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / var_x223) * (1.0 * var_x217 / pow(var_x218, 2) + 23.906250000000004 * var_x221 * pow(var_x220, 1.0)) / pow((0.035294117647058823 + var_x221 + 0.058823529411764705 * var_x219), 2) - 0.20000000000000001 * var_x222 * var_x224 / pow(var_x223, 2);
        ...
        IJth(rJacobian, 17, 0) = -3.389679425876563e-8 - 3.0388663876087418e-8 * var_x27 - 7.3941785176126768e-11 * var_x34 - 0.00080594011556369446 * var_x42 - var_x263 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 18, 0) = 0.00053729341037579627 * var_x42 + 3.79059668210955e-6 * var_x37 - 2.8537261917770629e-7 * var_x32 - 6.3176611368492499e-5 * var_x19 - 3.4364336248541711e-5 * var_x4 - 1.7065282626826835e-6 * var_x3 - 1.788348110893497e-5 * var_x20 - 4.5819114998055616e-5 * var_x0 - var_x264 * var_x44;
        ...
        IJth(rJacobian, 1, 1) = var_x93 * (-0.0038240087783467445 - var_x94 + 7.2352122917848019e-6 * var_x61 - 4.6212277808973237e-7 * var_x60 - 0.069488744729986562 * var_x62 - 5.314443123628384e-11 * var_x96) + 0.00040000000000000002 * pow(var_x90, (-3.0)) * (2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 4.6212277808973237e-7 * log(2.0 * var_x60) - 0.00042515544989027069 * var_x97 - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - var_x94 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362473e-8 * var_x23 * var_x33) / pow(var_x91, 2);
        ...
        IJth(rJacobian, 14, 14) = var_x233 * (-0.00036000000000000002 - var_x242 + 0.021759999999999998 * var_x248 - 0.0032639999999999995 * var_x246) + 0.66666666666666663 * pow(var_x230, (-3.0)) * (0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0.0063749999999999996 * var_x97 - 0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x242 * var_x243) / pow((0.33333333333333331 + var_x231), 2);
        IJth(rJacobian, 15, 14) = var_x257 * (var_x261 + 0.065303877103145558 * var_x246 - 0.43535918068763707 * var_x248);
        IJth(rJacobian, 16, 14) = 0.060000000000000005 * var_x245 * var_chaste_interface__calcium_dynamics__Ca_ss * var_chaste_interface__calcium_dynamics__R_prime;
        ...
        IJth(rJacobian, 15, 16) = 0.30611192392099479 * var_x251 * var_x256;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x262 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (0.001436484375 * var_x79 - 2.2983750000000001 * var_x78 - 3.015876723437001 * var_x80 - 396.37878066856405 * var_x82 - 0.0077469905913117388 * var_x66 - 0.00051997321379654684 * var_x81);
        IJth(rJacobian, 1, 17) = 6.0777327752174836e-8 * var_x81 * var_x92;
        IJth(rJacobian, 17, 17) = 5.0371257222730904e-7 * var_x79 - 0.046330930954698979 * var_x82 - 1.823319832565245e-7 * var_x81 - 0.00080594011556369446 * var_x78 - 9.0551084895961074e-7 * var_x66;
        IJth(rJacobian, 18, 17) = 0.00053729341037579627 * var_x78 - 3.3580838148487267e-7 * var_x79 - 0.00035251225104877322 * var_x80;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (0.86632725819393008 * var_x89 - 0.3900209056315565 * var_x83 - 100.5292241145667 * var_x80 - 7.8538456339505212 * var_x84 - 4.087205380933435 * var_x85 - 14.4387876365655 * var_x86 - var_x46 * var_x88);
        IJth(rJacobian, 18, 18) = 0.00010126109252331096 * var_x89 - 0.00047773503410627739 * var_x85 - 4.5587787568311439e-5 * var_x83 - 0.011750408368292442 * var_x80 - 0.0016876848753885161 * var_x86 - 0.00091800065377284671 * var_x84 - var_x264 * var_x88;
    }
