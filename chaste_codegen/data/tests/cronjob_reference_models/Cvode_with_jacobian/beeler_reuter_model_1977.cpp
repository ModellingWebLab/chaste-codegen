...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbeeler_reuter_model_1977FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x3 = var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f;
        const double var_x4 = exp(2.1200000000000001 + var_x0);
        ...
        const double var_x7 = exp(3.3999999999999999 + var_x0);
        ...
        const double var_x13 = 4.0 * pow(var_chaste_interface__sodium_current_m_gate__m, 3.0);
        const double var_x14 = var_x3 / var_chaste_interface__slow_inward_current__Cai_converted;
        const double var_x15 = -50.0 + var_chaste_interface__membrane__V;
        const double var_x16 = var_x13 * var_x15;
        const double var_x17 = log(0.001 * var_chaste_interface__slow_inward_current__Cai_converted);
        const double var_x18 = -7.4069999999999991 - 0.089999999999999997 * var_chaste_interface__membrane__V - 1.1725829999999999 * var_x17;
        const double var_x19 = -0.00074069999999999995 - 9.0000000000000002e-6 * var_chaste_interface__membrane__V - 0.0001172583 * var_x17;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0030000000000000001 - 0.089999999999999997 * var_x3 - 0.070000000000000007 / var_x2 + var_x10 * var_x11 - var_x12 * var_x13 - 0.056000000000000001 * var_x7 / var_x6 - var_x11 * var_x8 * var_x9 + 0.0028000000000000004 * var_x1 * (23.0 + var_chaste_interface__membrane__V) / pow(var_x2, 2) - 1.4000000000000001 * (-1.0 + var_x7) * (-0.040000000000000001 * var_x4 - 0.080000000000000002 * var_x5) / pow(var_x6, 2));
        IJth(rJacobian, 1, 0) = -9.0000000000000002e-6 * var_x3;
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-12.0 * var_x12 * var_x15 * pow(var_chaste_interface__sodium_current_m_gate__m, 2.0));
