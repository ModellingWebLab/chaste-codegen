...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpandit_model_2001_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x0 = 0.88600000000000001 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s + 0.114 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow;
        const double var_x1 = 0.35000000000000009 * var_x0;
        const double var_x2 = 1 / (1.0 + exp(-35.49354838709678));
        ...
        const double var_x5 = exp(-0.10977188457982837 + 0.06345195640452507 * var_chaste_interface__membrane__V - 1.613 * var_x4);
        const double var_x6 = 1.0 + var_x5;
        const double var_x7 = var_x2 / var_x6;
        const double var_x8 = 0.070000000000000007 * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss;
        const double var_x9 = 0.10000000000000001 * var_chaste_interface__L_type_Ca_channel_Ca_inact_gate__Ca_inact;
        const double var_x10 = 0.10000000000000001 - var_x9;
        const double var_x11 = 0.90000000000000002 + var_x9;
        const double var_x12 = var_x10 * var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12 + var_x11 * var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11;
        const double var_x13 = 0.31 * var_x12;
        const double var_x14 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0);
        const double var_x15 = 1 / (1.0 + 274.40000000000003 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 0.00012 * var_x14);
        ...
        const double var_x25 = exp(4.5158823529411762 + 1.4953416461467837 * var_x4 - 0.058823529411764705 * var_chaste_interface__membrane__V);
        ...
        const double var_x35 = exp(-0.0039337852699643568 * var_chaste_interface__membrane__V);
        const double var_x36 = (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.039337852699643565 * var_chaste_interface__membrane__V);
        const double var_x37 = 1.0 + 0.1245 * var_x35 + 0.036499999999999998 * var_x36;
        const double var_x38 = (0.00048975626611056245 * var_x35 + 0.0014358316235369901 * var_x36) / (pow(var_x37, 2) * (1.0 + 31.622776601683793 * var_x34));
        const double var_x39 = var_x25 * (10.0 + 48.0 / var_x31) / pow(var_x26, 2);
        const double var_x40 = -25.420807984495323 * var_x4 + var_chaste_interface__membrane__V;
        const double var_x41 = var_x2 * var_x5 * (-1.73 + var_x40) / pow(var_x6, 2);
        const double var_x42 = log(140.0 * var_x33);
        const double var_x43 = -25.420807984495323 * var_x42 + var_chaste_interface__membrane__V;
        const double var_x44 = var_x43 * var_chaste_interface__sodium_current_h_gate__h;
        const double var_x45 = var_x44 * pow(var_chaste_interface__sodium_current_m_gate__m, 2.0) * var_chaste_interface__sodium_current_j_gate__j;
        const double var_x46 = var_x22 * var_x44;
        const double var_x47 = -65.0 + var_chaste_interface__membrane__V;
        const double var_x48 = var_x47 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x49 = 0.31 * var_x48;
        const double var_x50 = 0.10000000000000001 * var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11 - 0.10000000000000001 * var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12;
        const double var_x51 = var_x40 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x52 = var_x40 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss;
        const double var_x53 = var_x33 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        ...
        const double var_x56 = var_x55 / pow((0.0036443148688046641 + 4.3731778425655972e-7 * var_x14 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x57 = var_x54 * var_x56;
        const double var_x58 = var_x15 * var_x17 * var_x54;
        const double var_x59 = var_x23 * var_x33 * var_chaste_interface__sodium_current_h_gate__h;
        const double var_x60 = var_x33 * var_x34 / (var_x37 * pow((0.031622776601683791 + var_x34), 2));
        ...
        const double var_x66 = var_x3 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        const double var_x67 = var_x0 * var_x3 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x68 = var_x3 * var_x7;
        const double var_x69 = var_x3 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss;
        const double var_x70 = var_x3 * var_x39;
        const double var_x71 = var_x3 * var_x41;
        ...
        const double var_x85 = var_x84 - var_chaste_interface__sodium_current_h_gate__h;
        ...
        const double var_x90 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
        const double var_x91 = exp(0.34999999999999998 * var_chaste_interface__membrane__V);
        const double var_x92 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x93 = var_x84 - var_chaste_interface__sodium_current_j_gate__j;
        const double var_x94 = exp(-3.2000000000000002 + var_x74);
        const double var_x95 = 1.0 + var_x94;
        const double var_x96 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V);
        const double var_x97 = var_x96 / var_x95;
        const double var_x98 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
        const double var_x99 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x100 = -127140.0 * var_x98 - 3.4740000000000003e-5 * var_x99;
        ...
        const double var_x104 = 286.53295128939828 * var_x103;
        const double var_x105 = var_x100 * var_x104;
        const double var_x106 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x107 = 1.0 + var_x106;
        const double var_x108 = exp(-0.01052 * var_chaste_interface__membrane__V);
        const double var_x109 = var_x108 / var_x107;
        const double var_x110 = 37.780000000000001 + var_chaste_interface__membrane__V;
        const double var_x111 = var_x100 * var_x110;
        const double var_x112 = -1 + 0.055555555555555552 * var_chaste_interface__membrane__V;
        const double var_x113 = exp(-0.64800000000000002 * pow(var_x112, 2.0));
        const double var_x114 = 1 + 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x115 = exp(-0.22049999999999997 * pow(var_x114, 2.0));
        ...
        const double var_x119 = 1 / (0.00025000000000000001 + 0.0010499999999999999 * var_x113 + 0.0030500000000000002 * var_x115);
        const double var_x120 = exp(1.0 + var_x29);
        const double var_x121 = 1.0 + var_x120;
        const double var_x122 = 1 / var_x121;
        const double var_x123 = exp(3.0 + var_x27);
        const double var_x124 = 1.0 + var_x123;
        const double var_x125 = 1 / var_x124;
        const double var_x126 = 1 + 0.022222222222222223 * var_chaste_interface__membrane__V;
        const double var_x127 = exp(-14.0625 * pow(var_x126, 2.0));
        const double var_x128 = exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__membrane__V);
        const double var_x129 = 1.0 + var_x128;
        const double var_x130 = 1.0 / var_x129;
        const double var_x131 = 0.00059999999999999995 * var_x123 / pow(var_x124, 2);
        const double var_x132 = 0.0016999999999999999 + 0.014999999999999999 * var_x125;
        const double var_x133 = 1 / (var_x132 + 0.040000000000000001 * var_x122 + 0.105 * var_x127);
        const double var_x134 = 0.00018518518518518518 * var_x128 / pow(var_x129, 2);
        const double var_x135 = exp(-11.0 + var_x116);
        const double var_x136 = 1.0 + var_x135;
        const double var_x137 = 1 / var_x136;
        const double var_x138 = 1 + 0.021276595744680851 * var_chaste_interface__membrane__V;
        const double var_x139 = exp(-15.340277777777779 * pow(var_x138, 2.0));
        const double var_x140 = 1 / (var_x132 + 0.080000000000000002 * var_x137 + 0.041000000000000002 * var_x139);
        const double var_x141 = exp(-0.92819614711033271 - 0.087565674255691769 * var_chaste_interface__membrane__V);
        const double var_x142 = 1.0 + var_x141;
        const double var_x143 = exp(1.7885000000000002 + 0.035770000000000003 * var_chaste_interface__membrane__V);
        const double var_x144 = exp(-3.8000000000000003 + var_x74);
        const double var_x145 = 1 + 0.014285714285714285 * var_chaste_interface__membrane__V;
        const double var_x146 = pow(var_x145, 2.0);
        ...
        const double var_x149 = exp(6.5803808776746413 + 0.14526227103034528 * var_chaste_interface__membrane__V);
        const double var_x150 = 1.0 + var_x149;
        const double var_x151 = 0.00014526227103034528 * var_x149 / pow(var_x150, 2);
        const double var_x152 = pow(var_x145, 1.0);
        const double var_x153 = 1.0 / var_x150;
        const double var_x154 = exp(-5.4444444444444446 * var_x146);
        ...
        const double var_x169 = 0.00088581970078959317 * var_x23;
        ...
        const double var_x172 = 1.0 + 0.00011900000000000002 * pow(var_x170, (-2.0)) + 0.0014999999999999998 * pow(var_x171, (-2.0));
        ...
        const double var_x177 = 0.0022145492519739826 * var_x63;
        ...
        const double var_x180 = 1 / (1.0 + 33855.471141425071 * var_x178 + 0.303951367781155 * var_x179);
        ...
        const double var_x183 = 1354.2188456570029 * var_x178 - 0.2735562310030395 * var_x179;
        const double var_x184 = var_x183 / pow((2.9537323401073992e-5 + var_x178 + 8.9779098483507582e-6 * var_x179), 2);
        const double var_x185 = var_x181 * var_x184;
        const double var_x186 = 7.7509223819089404e-6 * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss;
        const double var_x187 = 3.8754611909544704e-5 * var_x0;
        const double var_x188 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x189 = 1.0 + 0.00011900000000000002 * pow(var_x188, (-2.0));
        const double var_x190 = 1 / var_x189;
        const double var_x191 = 0.013386950228182724 * var_x190;
        const double var_x192 = var_x12 * var_x191;
        const double var_x193 = var_x191 * var_x48;
        const double var_x194 = -var_chaste_interface__intracellular_ion_concentrations__Ca_ss + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR;
        const double var_x195 = 84.0 * var_x190;
        const double var_x196 = var_x194 * var_x195;
        const double var_x197 = var_chaste_interface__SR_Ca_release_channel__P_O1 + var_chaste_interface__SR_Ca_release_channel__P_O2;
        ...
        const double var_x200 = pow(var_x199, (-2.0));
        const double var_x201 = 1 / (1.0 + 12.0 * var_x200);
        const double var_x202 = 1.8 * var_x201;
        const double var_x203 = -var_x194 * var_x202;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0025054999999999999 + 0.015228469537086016 * var_x41 - 0.014499999999999999 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.23999999999999999 * var_x7 - 0.048000000000000001 * var_x32 - 0.62608695652173918 * var_x38 - 9.9840000000000006e-5 * var_x21 - 5.8823529411764708e-5 * var_x39 - var_x1 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r - var_x13 * var_chaste_interface__L_type_Ca_channel_d_gate__d - var_x24 * var_chaste_interface__sodium_current_h_gate__h - var_x8 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss);
        IJth(rJacobian, 1, 0) = 0.001 * (-var_chaste_interface__sodium_current_m_gate__m + 1.0 / var_x73) * (var_x78 - 5.3475935828877006 * var_x79 - 23.529411764705884 * var_x75 * var_x80 / pow(var_x76, 2)) + 0.00015384615384615385 * var_x72 * (58.823529411764703 * var_x79 + var_x78 * var_x80) / pow(var_x73, 2);
        IJth(rJacobian, 2, 0) = ((var_x89) ? (-var_x86 * var_x88 + 0.19856753381108683 * var_x81 * var_x85 / pow((1 + var_x81), 2)) : (-var_x88 * (1020.0573065902579 * var_x90 + 38.681948424068771 * var_x92 + 88825214.899713472 * var_x91) + 0.001 * var_x85 * (80.584527220630378 * var_x90 + 31088825.214899711 * var_x91 - 5.6885218270689375 * var_x92)));
        IJth(rJacobian, 3, 0) = ((var_x89) ? (-0.014165489750559892 * var_x87 * var_x97 - 2.1797076526225281e-8 * var_x93 * var_x97 + 0.0085984522785898555 * var_x93 * var_x94 * var_x96 / pow(var_x95, 2)) : (-var_x88 * (34.727793696275072 * var_x109 + var_x105 * var_x110) + 0.001 * var_x93 * (var_x105 - 0.36533638968481374 * var_x109 + var_x104 * var_x110 * (1.5254334000000001e-6 * var_x99 - 31073.016 * var_x98) + 4.7854899713467054 * var_x106 * var_x108 / pow(var_x107, 2) - 89.11174785100286 * var_x101 * var_x111 / pow(var_x102, 2))));
        IJth(rJacobian, 4, 0) = 107.49798441279225 * (-var_chaste_interface__L_type_Ca_channel_d_gate__d + 1.0 / var_x118) * (7.5599999999999994e-5 * var_x113 * pow(var_x112, 1.0) + 0.00019214999999999998 * var_x115 * pow(var_x114, 1.0)) / pow((0.081967213114754092 + var_x115 + 0.34426229508196715 * var_x113), 2) + 0.00020000000000000001 * var_x117 * var_x119 / pow(var_x118, 2);
        IJth(rJacobian, 5, 0) = -var_x133 * var_x134 + 0.090702947845805001 * (var_x130 - var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11) * (var_x131 + 0.065625000000000003 * var_x127 * pow(var_x126, 1.0) - 0.0016000000000000001 * var_x120 / pow(var_x121, 2)) / pow((0.016190476190476189 + var_x127 + 0.38095238095238099 * var_x122 + 0.14285714285714285 * var_x125), 2);
        IJth(rJacobian, 6, 0) = -var_x134 * var_x140 + 0.15625 * (var_x130 - var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12) * (var_x131 + 0.026763888888888889 * var_x139 * pow(var_x138, 1.0) - 0.016 * var_x135 / pow(var_x136, 2)) / pow((0.021249999999999998 + var_x137 + 0.51249999999999996 * var_x139 + 0.1875 * var_x125), 2);
        IJth(rJacobian, 8, 0) = 0.001 * (-var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + 1.0 / var_x142) * (1.6153732000000001 * var_x143 - 9.8900000000000006 * var_x144) + 8.7565674255691772e-5 * var_x141 * (45.159999999999997 * var_x143 + 98.900000000000006 * var_x144) / pow(var_x142, 2);
        IJth(rJacobian, 9, 0) = -var_x148 * var_x151 + 0.0017777777777777779 * var_x147 * var_x152 * (var_x153 - var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s) / pow((0.10000000000000002 + var_x147), 2);
        IJth(rJacobian, 10, 0) = -var_x151 * var_x155 + 4.2042042042042043e-5 * var_x152 * var_x154 * (var_x153 - var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow) / pow((0.00945945945945946 + var_x154), 2);
        IJth(rJacobian, 11, 0) = 0.001 * (-var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss + 1.0 / var_x157) * (0.16153732000000001 * var_x143 - 0.9890000000000001 * var_x144) + 8.4602368866328257e-5 * var_x156 * (9.8900000000000006 * var_x144 + 4.516 * var_x143) / pow(var_x157, 2);
        IJth(rJacobian, 12, 0) = -4.6232085067036525e-5 * var_x158 / pow((1.0 + var_x158), 2);
        IJth(rJacobian, 13, 0) = 0.001 * (-var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + 1.0 / var_x160) * (0.0041892844554106447 * var_x161 - 0.039626497533474275 * var_x162) - 9.5419847328244274e-5 * var_x159 * (0.56230000000000002 * var_x162 + 0.11885 * var_x161) / pow(var_x160, 2);
        IJth(rJacobian, 20, 0) = -8.8748061272857362e-8 - 3.3165089597562367e-8 * var_x21 - 3.2110964153622756e-7 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.00020797506018538277 * var_x38 - var_x169 * var_chaste_interface__sodium_current_h_gate__h;
        IJth(rJacobian, 21, 0) = var_x174 * (-1.7937848940989261e-5 + 1.105502986585412e-5 * var_x21);
        IJth(rJacobian, 22, 0) = -1.528038983862048e-7 + 0.00013865004012358852 * var_x38 + 1.6862097911031215e-6 * var_x41 - 1.28443856614491e-6 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 2.6574591023687798e-5 * var_x7 - 5.31491820473756e-6 * var_x32 - 6.5133801528646561e-9 * var_x39 - var_x186 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss - var_x187 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        IJth(rJacobian, 23, 0) = -var_x192 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-24.0 * var_x45);
        IJth(rJacobian, 1, 1) = -0.058823529411764705 * var_x79 - 0.23529411764705882 * var_x77 * var_x80;
        IJth(rJacobian, 20, 1) = -0.0026574591023687793 * var_x45;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x24 * var_x43);
        IJth(rJacobian, 2, 2) = ((var_x89) ? (-0.001 * var_x86) : (-1.0200573065902578 * var_x90 - 0.038681948424068774 * var_x92 - 88825.214899713479 * var_x91));
        IJth(rJacobian, 20, 2) = -var_x169 * var_x43;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-8.0 * var_x46);
        IJth(rJacobian, 3, 3) = ((var_x89) ? (-0.085984522785898548 * var_x97) : (-0.034727793696275072 * var_x109 - 0.28653295128939826 * var_x103 * var_x111));
        IJth(rJacobian, 20, 3) = -0.00088581970078959317 * var_x46;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x13 * var_x47);
        IJth(rJacobian, 4, 4) = -0.001 * var_x119;
        IJth(rJacobian, 23, 4) = -var_x192 * var_x47;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x49);
        IJth(rJacobian, 5, 5) = -0.001 * var_x133;
        IJth(rJacobian, 23, 5) = -var_x11 * var_x193;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x10 * var_x49);
        IJth(rJacobian, 6, 6) = -0.001 * var_x140;
        IJth(rJacobian, 23, 6) = -var_x10 * var_x193;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x49 * var_x50);
        IJth(rJacobian, 7, 7) = -0.11111111111111112;
        IJth(rJacobian, 23, 7) = -var_x193 * var_x50;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x1 * var_x40);
        IJth(rJacobian, 8, 8) = -0.045159999999999999 * var_x143 - 0.098900000000000002 * var_x144;
        IJth(rJacobian, 22, 8) = -var_x187 * var_x40;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.3101000000000001 * var_x51);
        IJth(rJacobian, 9, 9) = -0.001 * var_x148;
        IJth(rJacobian, 22, 9) = -3.433658615185661e-5 * var_x51;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-0.039900000000000012 * var_x51);
        IJth(rJacobian, 10, 10) = -0.001 * var_x155;
        IJth(rJacobian, 22, 10) = -4.4180257576880966e-6 * var_x51;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x40 * var_x8);
        IJth(rJacobian, 11, 11) = -0.004516 * var_x143 - 0.0098900000000000012 * var_x144;
        IJth(rJacobian, 22, 11) = -var_x186 * var_x40;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-0.070000000000000007 * var_x52);
        IJth(rJacobian, 12, 12) = -0.00047619047619047619;
        IJth(rJacobian, 22, 12) = -7.7509223819089404e-6 * var_x52;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (0.073720343155036436 * var_x42 + 0.29488137262014574 * var_x4 - 0.014499999999999999 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 13, 13) = -0.00056230000000000006 * var_x162 - 0.00011885 * var_x161;
        IJth(rJacobian, 20, 13) = 8.1628665394625648e-6 * var_x42 - 3.2110964153622756e-7 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 22, 13) = 3.2651466157850252e-5 * var_x4 - 1.28443856614491e-6 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (4.7735212368995906e-13 * var_x57 - 0.020374777599573003 * var_x33 - 203.36646387596258 * var_x59 - 0.073720343155036436 * var_x53 - 0.00035942400000000001 * var_x58 - 0.029697911938972608 * var_x60);
        IJth(rJacobian, 20, 20) = 1.5856796826686862e-16 * var_x57 - 2.2560474246135324e-6 * var_x33 - 9.8651233004461518e-6 * var_x60 - 1.1939432255122452e-7 * var_x58 - 8.1628665394625648e-6 * var_x53 - 0.022518252522655349 * var_x59;
        IJth(rJacobian, 21, 20) = var_x174 * (3.9798107517074834e-5 * var_x58 - 5.2855989422289534e-14 * var_x57);
        IJth(rJacobian, 22, 20) = 6.5767488669641015e-6 * var_x60;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (0.040000000000000001 * var_x64 + 273.96096 * var_x65 + 3.6384839650145772e-7 * var_x56 - 0.0041181708934882426 * var_x61 - 0.040000000000000001 * var_x63);
        ...
        IJth(rJacobian, 21, 21) = var_x174 * (-30837.453183520603 - var_x177 + 40000.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 200000.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 0.0022145492519739826 * var_x64 + 3.5444788081288793e-5 * var_x185 - 0.00022799730679188537 * var_x61 - 4.0288009715211806e-8 * var_x56 - 1625.0626147884034 * var_x182 - 30.335001951903706 * var_x65) + 0.001 * (0.00023800000000000004 * pow(var_x170, (-3.0)) + 0.0029999999999999996 * pow(var_x171, (-3.0))) * (var_x168 + 0.066000000000000003 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 0.00022799730679188537 * log(1.2 * var_x61) + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 1.7937848940989261e-5 * var_chaste_interface__membrane__V - var_x175 * (0.14000000000000001 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa) - var_x176 * (0.070000000000000007 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa) - var_x177 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 1.105502986585412e-5 * var_x15 * var_x55 - 1.0 * var_x180 * var_x183) / pow(var_x172, 2);
        IJth(rJacobian, 23, 21) = 29.213483146067414 * var_x190;
        IJth(rJacobian, 25, 21) = 3.0179734274641778 * var_x182 - 6.5826035008107751e-8 * var_x185;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (0.38711999999999996 * var_x71 - 0.035080715018603541 * var_x3 - 8.8972827945733659 * var_x67 - 0.29488137262014574 * var_x66 - 6.1009939162788775 * var_x68 - 0.0014953416461467837 * var_x70 - 1.7794565589146727 * var_x69);
        IJth(rJacobian, 22, 22) = 4.2864815321208417e-5 * var_x71 - 3.8843985601580473e-6 * var_x3 - 0.00098517354786617148 * var_x67 - 1.6557538619599521e-7 * var_x70 - 0.0001970347095732343 * var_x69 - 3.2651466157850252e-5 * var_x66 - 0.00067554757567966049 * var_x68;
        ...
        IJth(rJacobian, 21, 23) = 0.037453183520599245 * var_x173;
        IJth(rJacobian, 23, 23) = 0.001 * var_x190 * (-29213.483146067414 - 84000.0 * var_chaste_interface__SR_Ca_release_channel__P_O1 - 84000.0 * var_chaste_interface__SR_Ca_release_channel__P_O2) + 2.3800000000000004e-7 * pow(var_x188, (-3.0)) * (84000.0 * var_x198 + 29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 13.386950228182725 * var_x12 * var_x48) / pow(var_x189, 2);
        IJth(rJacobian, 24, 23) = -var_x202 * (-var_chaste_interface__SR_Ca_release_channel__P_O1 - var_chaste_interface__SR_Ca_release_channel__P_O2);
        IJth(rJacobian, 23, 24) = var_x195 * var_x197;
        IJth(rJacobian, 24, 24) = 0.001 * var_x201 * (-1740.0382808421784 - 1800.0 * var_chaste_interface__SR_Ca_release_channel__P_O1 - 1800.0 * var_chaste_interface__SR_Ca_release_channel__P_O2) + 0.00016666666666666666 * pow(var_x199, (-3.0)) * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800.0 * var_x198 - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / pow((0.083333333333333329 + var_x200), 2);
        IJth(rJacobian, 25, 24) = 0.19333758676024207;
        IJth(rJacobian, 21, 25) = var_x174 * (0.2735562310030395 * var_x180 + 2.651834266564235e-10 * var_x184);
        IJth(rJacobian, 24, 25) = 1.7400382808421784 * var_x201;
        IJth(rJacobian, 25, 25) = -0.19333758676024207 - 0.00050803300043421621 * var_x180 - 4.924835066476436e-13 * var_x184;
    }
