...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpandit_model_2001_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x45 = log(140 * var_x34);
        ...
        const double var_x49 = 00080000000000000004 * var_x47;
        const double var_x50 = var_x22 * var_chaste_interface__sodium_current_h_gate__h;
        const double var_x51 = var_x4 + var_x6;
        const double var_x52 = var_x44 * (2.0150000000000001 - 031 * var_chaste_interface__membrane__V);
        ...
        const double var_x55 = 001 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x56 = var_x43 * var_x55;
        const double var_x57 = 0.17794565589146724 * var_x9 - 0070000000000000001 * var_chaste_interface__membrane__V;
        const double var_x58 = 001 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss;
        ...
        const double var_x89 = 001 / var_x88;
        ...
        const double var_x96 = 00016474464579901152 * var_x87 / pow(var_x88, 2);
        ...
        const double var_x132 = 00059999999999999995 * var_x125 / pow(var_x126, 2);
        ...
        const double var_x136 = 00018518518518518518 * var_x129 / pow(var_x130, 2);
        ...
        const double var_x143 = exp(-0.92819614711033271 - 087565674255691769 * var_chaste_interface__membrane__V);
        ...
        const double var_x152 = 00014526227103034528 * var_x150 / pow(var_x151, 2);
        ...
        const double var_x156 = exp(-0.97292724196277491 - 084602368866328256 * var_chaste_interface__membrane__V);
        const double var_x157 = 1.0 + var_x156;
        const double var_x158 = exp(8.4951456310679614 + 097087378640776698 * var_chaste_interface__membrane__V);
        const double var_x159 = exp(13.225190839694655 + 095419847328244267 * var_chaste_interface__membrane__V);
        ...
        const double var_x166 = 48600000000 * var_x163 * var_chaste_interface__SR_Ca_release_channel__P_C1;
        const double var_x167 = 12150000 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 2.0) * var_chaste_interface__SR_Ca_release_channel__P_O1;
        const double var_x168 = 00088581970078959317 * var_x46;
        ...
        const double var_x187 = 00019703470957323427 * var_x9 - 7.7509223819089404e-6 * var_chaste_interface__membrane__V;
        ...
        const double var_x195 = var_x191 * (84000 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR - 84000 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss);
        ...
        const double var_x203 = var_x202 * (1800 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 1800 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR);
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0 : (var_x44 * (-00025054999999999999 + var_x1 + 0015228469537086019 * var_x42 - 0014499999999999999 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 024 * var_x12 - 0.80000000000000004 * var_x24 - 9.9839999999999996e-6 * var_x20 - 0070000000000000001 * var_x21 - 0048000000000000004 * var_x32 - 5.8823529411764709e-6 * var_x33 - 062608695652173918 * var_x40 + (-031 * var_x4 - 031 * var_x6) * var_chaste_interface__L_type_Ca_channel_d_gate__d));
        IJth(rJacobian, 1, 0) = (001 / var_x79 - 001 * var_chaste_interface__sodium_current_m_gate__m) * (var_x84 - 5.3475935828877006 * var_x85 - 23.529411764705884 * var_x81 * var_x86 / pow(var_x82, 2)) + 00015384615384615385 * var_x78 * (58.823529411764703 * var_x85 + var_x84 * var_x86) / pow(var_x79, 2);
        IJth(rJacobian, 2, 0) = (var_x89 - 001 * var_chaste_interface__sodium_current_h_gate__h) * ((var_x91) ? (198.5675338110868 * var_x90 / pow((1 + var_x90), 2)) : (80.584527220630378 * var_x92 + 31088825.214899711 * var_x93 - 5.6885218270689366 * var_x94)) - var_x95 * var_x96;
        IJth(rJacobian, 3, 0) = (var_x89 - 001 * var_chaste_interface__sodium_current_j_gate__j) * ((var_x91) ? (-2.1797076526225279e-5 * var_x100 + 8.5984522785898552 * var_x97 * var_x99 / pow(var_x98, 2)) : (var_x107 - 0.36533638968481374 * var_x111 + var_x106 * var_x112 * (1.5254334000000001e-6 * var_x102 - 31073.016 * var_x101) + 4.7854899713467054 * var_x108 * var_x110 / pow(var_x109, 2) - 89.11174785100286 * var_x103 * var_x104 * var_x112 / pow(var_x105, 2))) - var_x113 * var_x96;
        IJth(rJacobian, 4, 0) = 107.49798441279225 * (-var_chaste_interface__L_type_Ca_channel_d_gate__d + 1.0 / var_x118) * (-var_x119 * (072000000000000008 - 0040000000000000001 * var_chaste_interface__membrane__V) - var_x120 * (-063 - 0089999999999999993 * var_chaste_interface__membrane__V)) / pow((081967213114754092 + var_x115 + 0.34426229508196715 * var_x114), 2) + 00020000000000000001 * var_x117 * var_x121 / pow(var_x118, 2);
        IJth(rJacobian, 5, 0) = -var_x135 * var_x136 + 090702947845805001 * (var_x131 - var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11) * (var_x132 - var_x133 * (-0.625 - 013888888888888888 * var_chaste_interface__membrane__V) - 0016000000000000001 * var_x122 / pow(var_x123, 2)) / pow((016190476190476189 + var_x128 + 0.38095238095238099 * var_x124 + 0.14285714285714285 * var_x127), 2);
        IJth(rJacobian, 6, 0) = -var_x136 * var_x142 + 0.15625 * (var_x131 - var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12) * (var_x132 - var_x141 * (-0.65277777777777779 - 013888888888888888 * var_chaste_interface__membrane__V) - 016 * var_x137 / pow(var_x138, 2)) / pow((021249999999999998 + var_x139 + 0.51249999999999996 * var_x140 + 0.1875 * var_x127), 2);
        IJth(rJacobian, 8, 0) = (-var_x55 + 001 / var_x144) * (1.6153732000000001 * var_x145 - 9.8900000000000006 * var_x146) + 8.7565674255691772e-5 * var_x143 * (45.159999999999997 * var_x145 + 98.900000000000006 * var_x146) / pow(var_x144, 2);
        IJth(rJacobian, 9, 0) = -var_x149 * var_x152 - 0028571428571428576 * var_x148 * (-0.62222222222222223 - 0088888888888888889 * var_chaste_interface__membrane__V) * (var_x153 - var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s) / pow((0.10000000000000002 + var_x148), 2);
        IJth(rJacobian, 10, 0) = -var_x152 * var_x155 - 00027027027027027027 * var_x154 * (-0.15555555555555556 - 0022222222222222222 * var_chaste_interface__membrane__V) * (var_x153 - var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow) / pow((00945945945945946 + var_x154), 2);
        IJth(rJacobian, 11, 0) = (-var_x58 + 001 / var_x157) * (0.16153732000000001 * var_x145 - 0.9890000000000001 * var_x146) + 8.4602368866328257e-5 * var_x156 * (9.8900000000000006 * var_x146 + 4.516 * var_x145) / pow(var_x157, 2);
        IJth(rJacobian, 12, 0) = -4.6232085067036518e-5 * var_x158 / pow((1.0 + var_x158), 2);
        IJth(rJacobian, 13, 0) = (001 / var_x160 - 001 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y) * (0041892844554106447 * var_x161 - 039626497533474282 * var_x162) - 9.5419847328244274e-5 * var_x159 * (0.56230000000000002 * var_x162 + 0.11885 * var_x161) / pow(var_x160, 2);
        IJth(rJacobian, 20, 0) = -8.8748061272857362e-8 - 3.2110964153622751e-7 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 00088581970078959317 * var_x24 - 3.3165089597562367e-8 * var_x20 - 00020797506018538275 * var_x40;
        IJth(rJacobian, 21, 0) = var_x173 * (-1.7937848940989261e-5 + 1.1055029865854122e-5 * var_x20);
        IJth(rJacobian, 22, 0) = -1.528038983862048e-7 + var_x186 + 00013865004012358849 * var_x40 + 1.6862097911031213e-6 * var_x42 - 5.3149182047375591e-6 * var_x32 - 7.7509223819089404e-6 * var_x21 - 1.2844385661449098e-6 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 2.6574591023687795e-5 * var_x12 - 6.5133801528646552e-9 * var_x33;
        IJth(rJacobian, 23, 0) = var_x192 * (-13.386950228182727 * var_x4 - 13.386950228182727 * var_x6);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (-0024000000000000002 * var_x47 * var_x48);
        IJth(rJacobian, 1, 1) = -058823529411764705 * var_x85 - 0.23529411764705882 * var_x83 * var_x86;
        IJth(rJacobian, 20, 1) = -0026574591023687793 * var_x46 * var_x48;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (-var_x23 * var_x49);
        IJth(rJacobian, 2, 2) = -001 * var_x95;
        IJth(rJacobian, 20, 2) = -var_x168 * var_x23;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (-var_x49 * var_x50);
        IJth(rJacobian, 3, 3) = -001 * var_x113;
        IJth(rJacobian, 20, 3) = -var_x168 * var_x50;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (var_x51 * var_x52);
        IJth(rJacobian, 4, 4) = -001 * var_x121;
        IJth(rJacobian, 23, 4) = var_x191 * var_x193 * var_x51;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (var_x5 * var_x53);
        IJth(rJacobian, 5, 5) = -001 * var_x135;
        IJth(rJacobian, 23, 5) = var_x194 * var_x5;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (var_x3 * var_x53);
        IJth(rJacobian, 6, 6) = -001 * var_x142;
        IJth(rJacobian, 23, 6) = var_x194 * var_x3;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (var_x53 * var_x54);
        IJth(rJacobian, 7, 7) = -0.11111111111111112;
        IJth(rJacobian, 23, 7) = var_x194 * var_x54;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (var_x0 * var_x41 * var_x44);
        IJth(rJacobian, 8, 8) = -045159999999999999 * var_x145 - 098900000000000002 * var_x146;
        IJth(rJacobian, 22, 8) = var_x185 * var_x41;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0 : (var_x56 * (0.7882992555992 * var_x9 - 031010000000000003 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 9, 9) = -001 * var_x149;
        IJth(rJacobian, 22, 9) = (00087286376340942788 * var_x9 - 3.433658615185661e-5 * var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0 : (var_x56 * (0.10142902385813635 * var_x9 - 0039900000000000005 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 10, 10) = -001 * var_x155;
        IJth(rJacobian, 22, 10) = (00011230978445674354 * var_x9 - 4.4180257576880966e-6 * var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0 : (var_x44 * var_x57 * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss);
        IJth(rJacobian, 11, 11) = -004516 * var_x145 - 0098900000000000012 * var_x146;
        IJth(rJacobian, 22, 11) = var_x187 * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0 : (var_x43 * var_x57 * var_x58);
        IJth(rJacobian, 12, 12) = -00047619047619047619;
        IJth(rJacobian, 22, 12) = var_x187 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0 : (var_x44 * (0073720343155036427 * var_x45 + 029488137262014571 * var_x9 - 0014499999999999999 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 13, 13) = -00056230000000000006 * var_x162 - 00011885 * var_x161;
        ...
        IJth(rJacobian, 14, 17) = 00080000000000000004;
        IJth(rJacobian, 17, 17) = -00080000000000000004;
        IJth(rJacobian, 18, 18) = -6.6000000000000005e-5 - 200 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        IJth(rJacobian, 21, 18) = var_x173 * (066000000000000003 + var_x174);
        IJth(rJacobian, 19, 19) = -040000000000000001 - 40 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        IJth(rJacobian, 21, 19) = var_x173 * (40 + var_x175);
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0 : (var_x44 * (4.7735212368995909e-14 * var_x63 - 0020374777599573 * var_x34 - 0029697911938972605 * var_x65 - 0073720343155036427 * var_x59 - 3.5942399999999997e-5 * var_x64 - 20.336646387596257 * var_x66));
        IJth(rJacobian, 20, 20) = 1.5856796826686865e-16 * var_x63 - 8.1628665394625614e-6 * var_x59 - 9.8651233004461501e-6 * var_x65 - 1.193943225512245e-7 * var_x64 - 2.2560474246135324e-6 * var_x34 - 022518252522655345 * var_x66;
        ...
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0 : (var_x44 * (038712000000000003 * var_x77 - 0.17794565589146724 * var_x74 - 0.61009939162788773 * var_x75 - 00014953416461467836 * var_x76 - 0035080715018603542 * var_x8 - 029488137262014571 * var_x72 + var_x1 * var_x73));
        IJth(rJacobian, 22, 22) = 4.286481532120841e-5 * var_x77 - 00067554757567966038 * var_x75 - 3.8843985601580465e-6 * var_x8 - 3.2651466157850246e-5 * var_x72 - 1.6557538619599519e-7 * var_x76 - 00019703470957323427 * var_x74 + var_x186 * var_x73;
        IJth(rJacobian, 7, 23) = -0011111111111111113 / pow((01 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss), 2);
        IJth(rJacobian, 14, 23) = var_x166 - var_x167;
        IJth(rJacobian, 15, 23) = var_x167;
        IJth(rJacobian, 16, 23) = -var_x166;
        IJth(rJacobian, 21, 23) = 037453183520599252 * var_x172;
        ...
        IJth(rJacobian, 24, 24) = var_x202 * (-1740382808421784 - var_x204 - var_x205) + 00016666666666666666 * (1740382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800 * var_x198 - 1740382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / (pow(var_x199, 3) * pow((083333333333333329 + var_x200), 2));
        ...
        IJth(rJacobian, 25, 25) = -0.19333758676024207 - 4.9248350664764349e-13 * var_x183 - 00050803300043421621 * var_x179;
    }
