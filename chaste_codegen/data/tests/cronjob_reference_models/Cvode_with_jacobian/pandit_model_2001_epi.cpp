...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpandit_model_2001_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x7 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0);
        ...
        const double var_x30 = pow(var_chaste_interface__sodium_current_m_gate__m, 3.0);
        ...
        const double var_x169 = 0.00088581970078959317 * var_x31;
        ...
        const double var_x172 = 1.0 + 0.0014999999999999998 * pow(var_x170, (-2.0)) + 0.00011900000000000002 * pow(var_x171, (-2.0));
        ...
        const double var_x186 = -3.433658615185661e-5 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s - 4.4180257576880966e-6 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow;
        const double var_x187 = var_x186 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x188 = 0.00019703470957323427 * var_x18 - 7.7509223819089404e-6 * var_chaste_interface__membrane__V;
        const double var_x189 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x190 = 1.0 + 0.00011900000000000002 * pow(var_x189, (-2.0));
        ...
        const double var_x201 = pow(var_x200, (-2.0));
        ...
        IJth(rJacobian, 20, 0) = -8.8748061272857362e-8 - 3.2110964153622751e-7 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 3.3165089597562367e-8 * var_x14 - 0.00020797506018538275 * var_x40 - var_x169 * var_chaste_interface__sodium_current_h_gate__h;
        IJth(rJacobian, 21, 0) = var_x174 * (-1.7937848940989261e-5 + 1.1055029865854122e-5 * var_x14);
        ...
        IJth(rJacobian, 20, 2) = -var_x169 * var_x44;
        ...
        IJth(rJacobian, 23, 4) = var_x192 * var_x194 * var_x49;
        ...
        IJth(rJacobian, 23, 7) = var_x195 * var_x51;
        ...
        IJth(rJacobian, 21, 20) = var_x174 * (3.9798107517074834e-5 * var_x58 - 5.2855989422289547e-14 * var_x57);
        ...
        IJth(rJacobian, 22, 22) = 4.286481532120841e-5 * var_x71 - 0.00067554757567966038 * var_x68 - 3.8843985601580465e-6 * var_x17 - 3.2651466157850246e-5 * var_x66 - 1.6557538619599519e-7 * var_x70 - 0.00019703470957323427 * var_x69 + var_x187 * var_x67;
        ...
        IJth(rJacobian, 23, 23) = var_x192 * (-29213.483146067414 - var_x197 - var_x198) + 2.3800000000000004e-7 * pow(var_x189, (-3.0)) * (29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 84000.0 * var_x199 - 29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 13.386950228182727 * var_x49 * (-65.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_channel_d_gate__d) / pow(var_x190, 2);
        IJth(rJacobian, 24, 23) = var_x203 * (var_x205 + var_x206);
        IJth(rJacobian, 23, 24) = var_x192 * (var_x197 + var_x198);
        IJth(rJacobian, 24, 24) = var_x203 * (-1740.0382808421784 - var_x205 - var_x206) + 0.00016666666666666666 * pow(var_x200, (-3.0)) * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800.0 * var_x199 - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / pow((0.083333333333333329 + var_x201), 2);
