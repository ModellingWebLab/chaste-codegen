...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellwinslow_model_1999FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x3 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ki;
        const double var_x4 = log(4.0 * var_x3);
        const double var_x5 = exp(0.056150836234118207 * var_chaste_interface__membrane__V - 1.4999999999999998 * var_x4);
        const double var_x6 = 1 / (2.0 + var_x5);
        ...
        const double var_x18 = 0.23815 * var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1;
        const double var_x19 = -26.713760659695648 * var_x4 + var_chaste_interface__membrane__V;
        const double var_x20 = var_x19 * var_x5 / pow((1 + 0.5 * var_x5), 2);
        const double var_x21 = 1 / var_chaste_interface__intracellular_ion_concentrations__Nai;
        const double var_x22 = pow(var_x21, 1.5);
        const double var_x23 = exp(-0.0037433890822745472 * var_chaste_interface__membrane__V);
        const double var_x24 = 0.037433890822745473 * var_chaste_interface__membrane__V;
        const double var_x25 = (-0.14285714285714285 + 0.14285714285714285 * exp(2.0505200594353643)) * exp(-var_x24);
        const double var_x26 = 1.0 + 0.1245 * var_x23 + 0.036499999999999998 * var_x25;
        const double var_x27 = var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x28 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0);
        const double var_x29 = 12.800000000000001 * var_x28;
        const double var_x30 = 2.0 * var_x12 - 2628072.0 * var_x13;
        const double var_x31 = var_x30 * var_x8 / pow(var_x9, 2);
        const double var_x32 = 4.5147771746328909 * var_chaste_interface__L_type_Ca_current_y_gate__y;
        const double var_x33 = var_chaste_interface__L_type_Ca_current__O + var_chaste_interface__L_type_Ca_current__O_Ca;
        const double var_x34 = exp(0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x35 = -1.0 + var_x34;
        const double var_x36 = 1 / var_x35;
        const double var_x37 = -0.68200000000000005 + 0.001 * var_x34;
        const double var_x38 = var_x36 * var_x37;
        const double var_x39 = var_x33 * var_x38;
        const double var_x40 = var_x38 * var_chaste_interface__membrane__V;
        const double var_x41 = 1 / (1.0 - 17.036894998614681 * var_x40);
        const double var_x42 = exp(var_x24);
        const double var_x43 = var_x42 * var_chaste_interface__intracellular_ion_concentrations__Ki;
        const double var_x44 = -4.0 + var_x43;
        const double var_x45 = var_x33 * var_chaste_interface__L_type_Ca_current_y_gate__y;
        const double var_x46 = var_x41 * var_x44 * var_x45;
        const double var_x47 = -1.0 + var_x42;
        const double var_x48 = 1 / var_x47;
        const double var_x49 = 2.091244787289955e-6 * var_x48;
        const double var_x50 = var_x34 * var_chaste_interface__membrane__V;
        const double var_x51 = var_x36 * var_x50;
        const double var_x52 = var_x45 * var_x51;
        const double var_x53 = var_x37 * var_x50 / pow(var_x35, 2);
        const double var_x54 = var_x45 * var_x53;
        const double var_x55 = var_x41 * var_chaste_interface__membrane__V;
        const double var_x56 = var_x45 * var_x48;
        const double var_x57 = -26.713760659695648 * log(138.0 * var_x21) + var_chaste_interface__membrane__V;
        const double var_x58 = var_x29 * var_x57;
        const double var_x59 = 1 / (0.018329999999999999 * var_chaste_interface__intracellular_ion_concentrations__Nai + var_chaste_interface__intracellular_ion_concentrations__Ki);
        const double var_x60 = var_x49 * var_x55;
        const double var_x61 = var_x44 * var_x60;
        const double var_x62 = -var_x32 * var_x40 - var_x61 * var_chaste_interface__L_type_Ca_current_y_gate__y;
        const double var_x63 = var_x33 * var_x40;
        const double var_x64 = var_x59 * var_x7;
        const double var_x65 = var_x10 * var_x11 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2.0);
        const double var_x66 = 1 / var_chaste_interface__intracellular_ion_concentrations__Cai;
        ...
        const double var_x69 = var_chaste_interface__intracellular_ion_concentrations__Cai / pow(var_x67, 2);
        const double var_x70 = var_x10 * var_x8;
        const double var_x71 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x72 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
        const double var_x73 = 0.0072727272727272727 * var_x72 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x74 = (var_chaste_interface__membrane__V > -47.130010000000006) && (var_chaste_interface__membrane__V < -47.129989999999999);
        const double var_x75 = 0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x76 = -var_x75;
        const double var_x77 = exp(-4.7130000000000001 + var_x76);
        const double var_x78 = 1.0 - var_x77;
        const double var_x79 = 0.32000000000000001 / var_x78;
        const double var_x80 = 47.130000000000003 + var_chaste_interface__membrane__V;
        const double var_x81 = var_chaste_interface__membrane__V >= -90.0;
        const double var_x82 = -0.080000000000000002 * var_x72;
        const double var_x83 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
        ...
        const double var_x89 = 1.0 - var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x90 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
        const double var_x91 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x92 = -127140.0 * var_x90 - 3.4740000000000003e-5 * var_x91;
        const double var_x93 = var_x89 * var_x92;
        const double var_x94 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
        ...
        const double var_x103 = exp(-3.2000000000000002 + var_x76);
        ...
        const double var_x111 = 0.1691 * var_x108;
        const double var_x112 = (-var_x111 + 0.012800000000000001 * var_x107) / pow(var_x109, 2);
        const double var_x113 = 0.001 / (0.027 + 0.001 * var_x110);
        const double var_x114 = exp(1.8161764705882353 - 0.073529411764705885 * var_chaste_interface__membrane__V);
        const double var_x115 = 1.0 + var_x114;
        const double var_x116 = exp(-0.68699999999999994 + 0.068699999999999997 * var_chaste_interface__membrane__V);
        const double var_x117 = -1.0 + var_x116;
        const double var_x118 = 1 / var_x117;
        const double var_x119 = 0.13100000000000001 * var_x118;
        const double var_x120 = exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V);
        ...
        const double var_x125 = exp(-0.062370000000000002 * var_chaste_interface__membrane__V);
        const double var_x126 = exp(0.035770000000000003 * var_chaste_interface__membrane__V);
        const double var_x127 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x128 = exp(6.7000000000000002 + var_x127);
        const double var_x129 = 1.0 + 0.051334999999999999 * var_x128;
        const double var_x130 = 0.40000000000000002 * var_chaste_interface__membrane__V;
        const double var_x131 = exp(-6.7000000000000002 - var_x127);
        ...
        const double var_x134 = var_x128 / var_x129;
        const double var_x135 = var_x131 / var_x132;
        const double var_x136 = exp(0.20000000000000001 + var_x75);
        const double var_x137 = var_x136 * var_chaste_interface__L_type_Ca_current__C0;
        ...
        const double var_x140 = -1.6000000000000001 * var_x136;
        const double var_x141 = 0.050000000000000003 * var_x138;
        const double var_x142 = -3.8461538461538463 * var_x138;
        const double var_x143 = 0.0076923076923076927 * var_x138;
        const double var_x144 = 1.6000000000000001 * var_x136;
        const double var_x145 = -0.050000000000000003 * var_x138;
        const double var_x146 = 0.10000000000000001 * var_x138;
        const double var_x147 = 80.0 * var_x136;
        const double var_x148 = -0.10000000000000001 * var_x138;
        const double var_x149 = -0.80000000000000004 * var_x136;
        const double var_x150 = 0.080000000000000016 * var_x136;
        const double var_x151 = var_x138 * var_chaste_interface__L_type_Ca_current__C4;
        const double var_x152 = 0.80000000000000004 * var_x136;
        const double var_x153 = var_x136 * var_chaste_interface__L_type_Ca_current__C_Ca0;
        const double var_x154 = exp(2.5 + var_x127);
        const double var_x155 = 1.0 + var_x154;
        const double var_x156 = exp(2.1052631578947367 + 0.10526315789473684 * var_chaste_interface__membrane__V);
        const double var_x157 = 1.0 + var_x156;
        const double var_x158 = 1 / var_x157;
        const double var_x159 = 1 / (0.02 + 0.59999999999999998 * var_x158);
        const double var_x160 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 3.0);
        const double var_x161 = 4050000.0 * var_x160;
        const double var_x162 = 12150000000.0 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 4.0);
        const double var_x163 = 48600000000.0 * var_x160 * var_chaste_interface__RyR_channel__P_C1;
        const double var_x164 = 12150000.0 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 2.0) * var_chaste_interface__RyR_channel__P_O1;
        const double var_x165 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Cai;
        const double var_x166 = 1.0 + 0.00011900000000000002 * pow(var_x165, (-2.0));
        const double var_x167 = 1 / var_x166;
        const double var_x168 = 0.001 * var_x167;
        const double var_x169 = 2800.0000000000005 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        const double var_x170 = 0.0015381954438488301 * var_x68;
        const double var_x171 = pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 1.2);
        const double var_x172 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_NSR, 1.0);
        const double var_x173 = 1 / (1.0 + 33855.471141425071 * var_x171 + 0.303951367781155 * var_x172);
        const double var_x174 = pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 0.19999999999999996);
        const double var_x175 = var_x173 * var_x174;
        const double var_x176 = 2752.4498037978583 * var_x171 - 0.096656534954407292 * var_x172;
        const double var_x177 = var_x176 / pow((2.9537323401073992e-5 + var_x171 + 8.9779098483507582e-6 * var_x172), 2);
        const double var_x178 = var_x174 * var_x177;
        const double var_x179 = 2990.8119021922685 * var_chaste_interface__L_type_Ca_current_y_gate__y;
        const double var_x180 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x181 = 1.0 + 0.00011900000000000002 * pow(var_x180, (-2.0));
        const double var_x182 = 1 / var_x181;
        const double var_x183 = 0.001 * var_x182;
        const double var_x184 = 2.9908119021922683 * var_x182;
        const double var_x185 = -var_x184 * var_x40 * var_chaste_interface__L_type_Ca_current_y_gate__y;
        const double var_x186 = -var_chaste_interface__intracellular_ion_concentrations__Ca_ss + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR;
        const double var_x187 = 240.00000000000003 * var_x182;
        const double var_x188 = var_x186 * var_x187;
        const double var_x189 = var_chaste_interface__RyR_channel__P_O1 + var_chaste_interface__RyR_channel__P_O2;
        const double var_x190 = var_x186 * var_x189;
        const double var_x191 = 0.80000000000000004 + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR;
        const double var_x192 = pow(var_x191, (-2.0));
        const double var_x193 = 1 / (1.0 + 12.0 * var_x192);
        const double var_x194 = 1.8 * var_x193;
        const double var_x195 = -var_x186 * var_x194;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0034841999999999998 + 0.0092483730267959394 * var_x20 + 0.3380113516884618 * var_x54 - 0.00013456270662374131 * var_x14 - 0.0022160000000000001 * var_x2 - 0.6588235294117647 * var_x6 - 0.0027133999999999999 * var_x7 - 6.54836736913614e-7 * var_x31 - 0.00033801135168846181 * var_x52 - var_x17 * var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr - var_x18 * var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1 - var_x27 * var_x29 - var_x32 * var_x39 - var_x46 * var_x49 - 0.504 * (0.0013663370150302097 * var_x25 + 0.0004660519407431811 * var_x23) / (pow(var_x26, 2) * (1.0 + 31.622776601683793 * var_x22)) - 0.00037056856187290974 * var_x0 * var_x19 / pow(var_x1, 2) - 7.8283429051047759e-8 * var_x43 * var_x55 * var_x56 + 7.8283429051047759e-8 * var_x42 * var_x46 * var_chaste_interface__membrane__V / pow(var_x47, 2) + 0.00010146537303445969 * var_x15 * var_x19 * var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr / pow((0.66912010705921721 + var_x15), 2) - 7.2048339800169574e-9 * var_x44 * var_x56 * (17.036894998614681 * var_x38 + 0.0012755145346734407 * var_x51 - 1.2755145346734407 * var_x53) * var_chaste_interface__membrane__V / pow((0.05869614152586565 - var_x40), 2));
        IJth(rJacobian, 1, 0) = ((var_x74) ? (var_x73 + 0.27172550724019401 * var_x71 / pow((-1 - 0.036859565057132324 * var_chaste_interface__membrane__V), 2)) : ((var_x81) ? (var_x73 + var_x71 * var_x79 - 0.032000000000000001 * var_x71 * var_x77 * var_x80 / pow(var_x78, 2)) : (0)));
        IJth(rJacobian, 2, 0) = ((var_x86) ? (-0.001 * (281.24000000000001 * var_x83 + 108500.0 * var_x84) * var_chaste_interface__fast_sodium_current_h_gate__h - 0.019852941176470591 * var_x85 * (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h)) : (-0.69300069300069311 * var_x87 * var_chaste_interface__fast_sodium_current_h_gate__h / pow(var_x88, 2)));
        IJth(rJacobian, 3, 0) = ((var_x86) ? (var_x93 * var_x96 + 0.001275024 * var_x100 * var_chaste_interface__fast_sodium_current_j_gate__j + var_x102 * var_x89 * (1.5254334000000001e-6 * var_x91 - 31073.016 * var_x90) - 0.311 * var_x101 * var_x93 * var_x94 / pow(var_x95, 2) - 0.016701360000000002 * var_x97 * var_x99 * var_chaste_interface__fast_sodium_current_j_gate__j / pow(var_x98, 2)) : (7.6049999999999996e-8 * var_x106 * var_chaste_interface__fast_sodium_current_j_gate__j - 0.029999999999999999 * var_x103 * var_x105 * var_chaste_interface__fast_sodium_current_j_gate__j / pow(var_x104, 2)));
        IJth(rJacobian, 4, 0) = var_x113 * (var_x108 * var_x112 + var_x110 * var_x111) - 0.0013717421124828533 * var_x112 * (-var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr + var_x108 * var_x110) / pow((1 + 0.037037037037037035 * var_x110), 2);
        IJth(rJacobian, 5, 0) = 0.001 * (-var_chaste_interface__slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks + 1.0 / var_x115) * (var_x119 + var_x123 - 0.0089996999999999994 * var_x116 * var_x124 / pow(var_x117, 2) - 0.010641199999999998 * var_x120 * var_x124 / pow(var_x121, 2)) + 7.3529411764705889e-5 * var_x114 * (var_x119 * var_x124 + var_x123 * var_x124) / pow(var_x115, 2);
        IJth(rJacobian, 6, 0) = 0.0061683930000000003 * var_x125 * var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1 + 0.0016153732000000001 * var_x126 * (1.0 - var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1);
        IJth(rJacobian, 7, 0) = -0.0010830000000000002 * var_x133 * var_x135 - 0.0010830000000000002 * var_x134 * var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1 + 5.5595805000000008e-5 * var_x133 * exp(-13.4 - var_x130) / pow(var_x132, 2) + 5.5595805000000008e-5 * var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1 * exp(13.4 + var_x130) / pow(var_x129, 2);
        IJth(rJacobian, 10, 0) = -0.16 * var_x137 - var_x139 * var_chaste_interface__L_type_Ca_current__C1;
        IJth(rJacobian, 11, 0) = 0.16000000000000003 * var_x137 - var_x143 * var_chaste_interface__L_type_Ca_current__C2 - 0.001 * (var_x142 + 120.0 * var_x136) * var_chaste_interface__L_type_Ca_current__C1;
        IJth(rJacobian, 12, 0) = 0.12 * var_x136 * var_chaste_interface__L_type_Ca_current__C1 - 0.001 * (var_x147 - 7.6923076923076925 * var_x138) * var_chaste_interface__L_type_Ca_current__C2 - 0.011538461538461539 * var_x138 * var_chaste_interface__L_type_Ca_current__C3;
        IJth(rJacobian, 13, 0) = -0.015384615384615385 * var_x151 + var_x150 * var_chaste_interface__L_type_Ca_current__C2 - 0.001 * (40.0 * var_x136 - 11.538461538461538 * var_x138) * var_chaste_interface__L_type_Ca_current__C3;
        IJth(rJacobian, 14, 0) = 0.015384615384615385 * var_x151 + 0.040000000000000008 * var_x136 * var_chaste_interface__L_type_Ca_current__C3;
        IJth(rJacobian, 15, 0) = -0.32000000000000001 * var_x153 - 0.0019230769230769232 * var_x138 * var_chaste_interface__L_type_Ca_current__C_Ca1;
        IJth(rJacobian, 16, 0) = 0.32000000000000006 * var_x153 - var_x139 * var_chaste_interface__L_type_Ca_current__C_Ca2 - 0.001 * (240.0 * var_x136 - 1.9230769230769231 * var_x138) * var_chaste_interface__L_type_Ca_current__C_Ca1;
        IJth(rJacobian, 17, 0) = 0.23999999999999999 * var_x136 * var_chaste_interface__L_type_Ca_current__C_Ca1 - 0.001 * (var_x142 + 160.0 * var_x136) * var_chaste_interface__L_type_Ca_current__C_Ca2 - 0.0057692307692307696 * var_x138 * var_chaste_interface__L_type_Ca_current__C_Ca3;
        IJth(rJacobian, 18, 0) = -var_x143 * var_chaste_interface__L_type_Ca_current__C_Ca4 + 0.16000000000000003 * var_x136 * var_chaste_interface__L_type_Ca_current__C_Ca2 - 0.001 * (var_x147 - 5.7692307692307692 * var_x138) * var_chaste_interface__L_type_Ca_current__C_Ca3;
        IJth(rJacobian, 19, 0) = var_x150 * var_chaste_interface__L_type_Ca_current__C_Ca3 + 0.0076923076923076927 * var_x138 * var_chaste_interface__L_type_Ca_current__C_Ca4;
        IJth(rJacobian, 20, 0) = -0.00016000000000000001 * var_x154 * var_x159 / pow(var_x155, 2) + 0.00017543859649122808 * var_x156 * (0.20000000000000001 - var_chaste_interface__L_type_Ca_current_y_gate__y + 0.80000000000000004 / var_x155) / (pow(var_x157, 2) * pow((0.033333333333333333 + var_x158), 2));
        IJth(rJacobian, 28, 0) = var_x168 * (-1.181949379053441e-5 + 8.279349689624225e-6 * var_x14 + 4.0290675407414237e-8 * var_x31);
        IJth(rJacobian, 30, 0) = var_x183 * (223.91545243606618 * var_x54 - 0.2239154524360662 * var_x52 - var_x179 * var_x39);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-38.400000000000006 * var_x27 * var_x57 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0));
        IJth(rJacobian, 1, 1) = ((var_x74) ? (var_x82 - 1.0 / (-0.13565000000000002 - 0.0050000000000000001 * var_chaste_interface__membrane__V)) : ((var_x81) ? (var_x82 - var_x79 * var_x80) : (0)));
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x58 * var_chaste_interface__fast_sodium_current_j_gate__j);
        IJth(rJacobian, 2, 2) = ((var_x86) ? (-0.13500000000000001 * var_x85 - 3.5600000000000001 * var_x83 - 310.0 * var_x84) : (-7.6923076923076925 / var_x88));
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x58 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 3, 3) = ((var_x86) ? (-0.1212 * var_x100 - var_x102 * var_x92) : (-0.29999999999999999 * var_x106));
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x19);
        IJth(rJacobian, 4, 4) = -var_x113;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0054267999999999999 * pow(var_chaste_interface__slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks, 1.0) * (-26.713760659695648 * log(6.5295399999999999 * var_x59) + var_chaste_interface__membrane__V));
        IJth(rJacobian, 5, 5) = -0.00013100000000000001 * var_x118 * var_x124 - 7.1899999999999999e-5 * var_x122 * var_x124;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x18 * var_x19);
        IJth(rJacobian, 6, 6) = -0.045159999999999999 * var_x126 - 0.098900000000000002 * var_x125;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.23815 * var_x19 * var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1);
        IJth(rJacobian, 7, 7) = -0.0054150000000000005 * var_x134 - 0.0054150000000000005 * var_x135;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x62);
        IJth(rJacobian, 8, 8) = -2.0;
        IJth(rJacobian, 14, 8) = 2.0;
        IJth(rJacobian, 30, 8) = var_x185;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x62);
        IJth(rJacobian, 9, 9) = -7.0;
        IJth(rJacobian, 19, 9) = 7.0;
        IJth(rJacobian, 30, 9) = var_x185;
        IJth(rJacobian, 10, 10) = var_x140 - 0.10375000000000001 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        IJth(rJacobian, 11, 10) = var_x144;
        IJth(rJacobian, 15, 10) = 0.10375000000000001 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        IJth(rJacobian, 10, 11) = var_x141;
        IJth(rJacobian, 11, 11) = var_x145 - 1.2 * var_x136 - 0.20750000000000002 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        IJth(rJacobian, 12, 11) = 1.2 * var_x136;
        IJth(rJacobian, 16, 11) = 0.20750000000000002 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        IJth(rJacobian, 11, 12) = var_x146;
        IJth(rJacobian, 12, 12) = var_x148 + var_x149 - 0.41500000000000004 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        IJth(rJacobian, 13, 12) = var_x152;
        IJth(rJacobian, 17, 12) = 0.41500000000000004 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        IJth(rJacobian, 12, 13) = 0.14999999999999999 * var_x138;
        IJth(rJacobian, 13, 13) = -0.40000000000000002 * var_x136 - 0.14999999999999999 * var_x138 - 0.83000000000000007 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        IJth(rJacobian, 14, 13) = 0.40000000000000002 * var_x136;
        IJth(rJacobian, 18, 13) = 0.83000000000000007 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        IJth(rJacobian, 8, 14) = 0.29999999999999999;
        IJth(rJacobian, 13, 14) = 0.20000000000000001 * var_x138;
        IJth(rJacobian, 14, 14) = -0.29999999999999999 - 0.20000000000000001 * var_x138 - 1.6600000000000001 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        IJth(rJacobian, 19, 14) = 1.6600000000000001 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        IJth(rJacobian, 10, 15) = 0.01;
        IJth(rJacobian, 15, 15) = -0.01 - 3.2000000000000002 * var_x136;
        IJth(rJacobian, 16, 15) = 3.2000000000000002 * var_x136;
        IJth(rJacobian, 11, 16) = 0.0050000000000000001;
        IJth(rJacobian, 15, 16) = 0.025000000000000001 * var_x138;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 - 0.025000000000000001 * var_x138 - 2.3999999999999999 * var_x136;
        IJth(rJacobian, 17, 16) = 2.3999999999999999 * var_x136;
        IJth(rJacobian, 12, 17) = 0.0025000000000000001;
        IJth(rJacobian, 16, 17) = var_x141;
        IJth(rJacobian, 17, 17) = -0.0025000000000000001 + var_x140 + var_x145;
        IJth(rJacobian, 18, 17) = var_x144;
        IJth(rJacobian, 13, 18) = 0.00125;
        IJth(rJacobian, 17, 18) = 0.074999999999999997 * var_x138;
        IJth(rJacobian, 18, 18) = -0.00125 + var_x149 - 0.074999999999999997 * var_x138;
        IJth(rJacobian, 19, 18) = var_x152;
        IJth(rJacobian, 9, 19) = 0.0070000000000000001;
        IJth(rJacobian, 14, 19) = 0.00062500000000000001;
        IJth(rJacobian, 18, 19) = var_x146;
        IJth(rJacobian, 19, 19) = -0.0076249999999999998 + var_x148;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-4.5147771746328909 * var_x63 - var_x33 * var_x61);
        IJth(rJacobian, 20, 20) = -0.001 * var_x159;
        IJth(rJacobian, 30, 20) = -var_x184 * var_x63;
        IJth(rJacobian, 21, 21) = -0.67600000000000005 - var_x161;
        IJth(rJacobian, 22, 21) = var_x161;
        IJth(rJacobian, 23, 21) = 0.57600000000000007;
        IJth(rJacobian, 24, 21) = 0.10000000000000001;
        IJth(rJacobian, 30, 21) = var_x188;
        IJth(rJacobian, 31, 21) = var_x195;
        IJth(rJacobian, 21, 22) = 1.9299999999999999;
        IJth(rJacobian, 22, 22) = -1.9299999999999999;
        IJth(rJacobian, 30, 22) = var_x188;
        IJth(rJacobian, 31, 22) = var_x195;
        IJth(rJacobian, 21, 23) = var_x162;
        IJth(rJacobian, 23, 23) = -var_x162;
        ...
        IJth(rJacobian, 28, 25) = var_x168 * (0.0092400000000000017 + var_x169);
        IJth(rJacobian, 26, 26) = -0.040000000000000001 - 40.0 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        IJth(rJacobian, 28, 26) = var_x168 * (2.8000000000000003 + var_x169);
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-0.082812658045056511 * var_x21 - 0.00080737623974244785 * var_x65 - 0.001328652216129753 * var_x64 - 341.93613644410431 * var_x21 * var_x27 * var_x28 - 0.023906819110872949 * var_x21 * var_x22 / (var_x26 * pow((0.031622776601683791 + var_x22), 2)));
        IJth(rJacobian, 28, 27) = 4.9676098137745351e-8 * var_x167 * var_x65;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (0.050000000000000003 * var_x69 + 353.64048152206908 * var_x70 - 0.0051317134227275348 * var_x66 - 0.050000000000000003 * var_x68);
        ...
        IJth(rJacobian, 28, 28) = var_x168 * (-5637.4531835205999 - var_x170 + 0.0015381954438488301 * var_x69 + 2800.0000000000005 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 2800.0000000000005 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa + 3.5444788081288793e-5 * var_x178 - 0.00015787156411954756 * var_x66 - 3302.93976455743 * var_x175 - 21.758727097510118 * var_x70) + 2.3800000000000004e-7 * pow(var_x165, (-3.0)) * (0.0092400000000000017 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss + 0.00015787156411954756 * log(2.0 * var_x66) + 2.8000000000000003 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Cai - 1.181949379053441e-5 * var_chaste_interface__membrane__V - var_x169 * (1.0 - var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa) - var_x169 * (1.0 - var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa) - var_x170 * var_chaste_interface__intracellular_ion_concentrations__Cai + 8.279349689624225e-6 * var_x10 * var_x30 - 1.0 * var_x173 * var_x176) / pow(var_x166, 2);
        IJth(rJacobian, 30, 28) = 806.49188514357047 * var_x182;
        IJth(rJacobian, 32, 28) = 40.641887388649522 * var_x175 - 4.3613967810500115e-7 * var_x178;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-0.072485118174018176 * var_x64 + 0.24705882352941172 * var_x20 * var_x3 - 17.599654081681837 * var_x3 * var_x6 - 0.05919769362188556 * var_x2 * var_x3 - var_x42 * var_x45 * var_x60 - 0.090826786242965196 * var_x16 * var_x3 * var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr - 6.3618821011065183 * var_x3 * var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1 * var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1);
        IJth(rJacobian, 10, 30) = -0.10375000000000001 * var_chaste_interface__L_type_Ca_current__C0;
        IJth(rJacobian, 11, 30) = -0.20750000000000002 * var_chaste_interface__L_type_Ca_current__C1;
        IJth(rJacobian, 12, 30) = -0.41500000000000004 * var_chaste_interface__L_type_Ca_current__C2;
        IJth(rJacobian, 13, 30) = -0.83000000000000007 * var_chaste_interface__L_type_Ca_current__C3;
        IJth(rJacobian, 14, 30) = -1.6600000000000001 * var_chaste_interface__L_type_Ca_current__C4;
        IJth(rJacobian, 15, 30) = 0.10375000000000001 * var_chaste_interface__L_type_Ca_current__C0;
        IJth(rJacobian, 16, 30) = 0.20750000000000002 * var_chaste_interface__L_type_Ca_current__C1;
        IJth(rJacobian, 17, 30) = 0.41500000000000004 * var_chaste_interface__L_type_Ca_current__C2;
        IJth(rJacobian, 18, 30) = 0.83000000000000007 * var_chaste_interface__L_type_Ca_current__C3;
        IJth(rJacobian, 19, 30) = 1.6600000000000001 * var_chaste_interface__L_type_Ca_current__C4;
        IJth(rJacobian, 21, 30) = var_x163 - var_x164;
        IJth(rJacobian, 22, 30) = var_x164;
        IJth(rJacobian, 23, 30) = -var_x163;
        IJth(rJacobian, 28, 30) = 0.037453183520599245 * var_x167;
        IJth(rJacobian, 30, 30) = var_x183 * (-806491.88514357049 - 240000.00000000003 * var_chaste_interface__RyR_channel__P_O1 - 240000.00000000003 * var_chaste_interface__RyR_channel__P_O2) + 2.3800000000000004e-7 * pow(var_x180, (-3.0)) * (806491.88514357049 * var_chaste_interface__intracellular_ion_concentrations__Cai + 240000.00000000003 * var_x190 - 806491.88514357049 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - var_x179 * var_x63) / pow(var_x181, 2);
        IJth(rJacobian, 31, 30) = -var_x194 * (-var_chaste_interface__RyR_channel__P_O1 - var_chaste_interface__RyR_channel__P_O2);
        IJth(rJacobian, 30, 31) = var_x187 * var_x189;
        IJth(rJacobian, 31, 31) = 0.001 * var_x193 * (-1740.0382808421784 - 1800.0 * var_chaste_interface__RyR_channel__P_O1 - 1800.0 * var_chaste_interface__RyR_channel__P_O2) + 0.00016666666666666666 * pow(var_x191, (-3.0)) * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800.0 * var_x190 - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / pow((0.083333333333333329 + var_x192), 2);
        IJth(rJacobian, 32, 31) = 0.13257434520702313;
        IJth(rJacobian, 28, 32) = var_x168 * (0.096656534954407292 * var_x173 + 2.651834266564235e-10 * var_x177);
        IJth(rJacobian, 31, 32) = 1.7400382808421784 * var_x193;
        IJth(rJacobian, 32, 32) = -0.13257434520702313 - 0.0011893356491532784 * var_x173 - 3.2630189260961825e-12 * var_x177;
    }
