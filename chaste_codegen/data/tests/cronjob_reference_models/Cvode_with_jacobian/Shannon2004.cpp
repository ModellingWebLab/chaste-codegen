...
#include "MathsCustomFunctions.hpp"
    ...
    void CellShannon2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 20, 0) = -2.6284313781755491e-6 + 6.6084319941501622e-8 * var_x111 - 0.0015698331482008195 * var_x85 - 0.14159899680406998 * var_x32 - 4.9563239956126223e-8 * var_x117 - 0.039627810594012845 * var_x41 - 0.2389483071068681 * var_x61 - var_x325 * var_x93;
        IJth(rJacobian, 25, 0) = -2.4247042727846657e-7 + 0.017367559454884197 * var_x71 + 2.8495558758775506e-5 * var_x114 + 0.00011410070598839625 * var_x99 - 9.7169855367424485e-6 * var_x121 - var_x332 * var_x76;
        IJth(rJacobian, 26, 0) = -1.1119946217769619e-6 + 0.00052327771606693984 * var_x85 + 0.0095161420715762363 * var_x115 + 0.079649435702289356 * var_x61 - 0.0032450044464074966 * var_x123 - var_x336 * var_x76;
        ...
        IJth(rJacobian, 19, 19) = -2.5101556644976917 + var_x323 + 1.7451694845309862e-13 * var_x156 - 1.5310180739595352e-5 * var_x42 - 3.9646379347775894e-9 * var_x124 - 0.28135446316912399 * var_x157 - 2.3607251144114479e-6 * var_x151 - 0.82479088159436242 * var_x152;
        ...
        IJth(rJacobian, 20, 20) = -1.0301299389968197 + var_x327 + 8.0035289361659539e-13 * var_x163 - 3.7825768474861841 * var_x158 - 1.2903208583770878 * var_x164 - 1.0826531136947708e-5 * var_x159 - 7.0214082731462295e-5 * var_x33 - 1.3239978260852802e-6 * var_x116;
        ...
        IJth(rJacobian, 25, 25) = -171.99023312516786 + var_x333 + var_x334 + 2.3065909313514399e-15 * var_x170 + 8.7413788910230311e-13 * var_x171 - 5.4319197230928918e-10 * var_x168 - 47656.583144202239 * var_x169 - 0.00012978638743287919 * var_x120 - 3.2385929460103637e-6 * var_x4;
        ...
        IJth(rJacobian, 20, 26) = 655674.15470124607 * var_x175 - 3.1734798413457098e-14 * var_x176 - 1.2026662083498781e-11 * var_x177;
        IJth(rJacobian, 24, 26) = 9.9320000000000005e-5 + var_x330;
        IJth(rJacobian, 25, 26) = 1.2484412919281114;
        IJth(rJacobian, 26, 26) = -121.70185906968872 + var_x338 + var_x339 - var_x337 + 1.0578266137819032e-14 * var_x176 + 4.0088873611662605e-12 * var_x177 - 2.4911349337733962e-9 * var_x174 - 0.043342392834727739 * var_x122 - 218558.051567082 * var_x175 - 1.4852524402707469e-5 * var_x2;
