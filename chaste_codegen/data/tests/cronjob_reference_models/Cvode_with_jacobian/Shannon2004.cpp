...
#include "MathsCustomFunctions.hpp"
    ...
    void CellShannon2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x7 = 1 / log(10);
        const double var_x8 = 1.6666666666666667 * var_x7;
        const double var_x9 = exp(-7.0000000000000009 - var_x8 * log(1.0 * var_chaste_interface__Ca_buffer__Ca_jct));
        const double var_x10 = 1.0 + var_x9;
        const double var_x11 = 0.0039900000000000005 + 0.013300000000000001 / var_x10;
        const double var_x12 = var_x11 * var_x6;
        const double var_x13 = exp(-7.0000000000000009 - var_x8 * log(1.0 * var_chaste_interface__Ca_buffer__Ca_SL));
        const double var_x14 = 1.0 + var_x13;
        const double var_x15 = 0.0039900000000000005 + 0.013300000000000001 / var_x14;
        ...
        const double var_x19 = 0.029999999999999999 / var_x18;
        const double var_x20 = exp(6.3850752292255635 + 0.23849999999999999 * var_chaste_interface__cell__V);
        const double var_x21 = 1.0 + var_x20;
        const double var_x22 = 1 / var_x21;
        const double var_x23 = exp(-46.667481143776548 - 0.51429999999999998 * var_chaste_interface__cell__V);
        const double var_x24 = 1.0 + var_x23;
        const double var_x25 = 1 / var_x24;
        const double var_x26 = exp(-31.388957359414341 + 0.061749999999999999 * var_chaste_interface__cell__V);
        const double var_x27 = exp(7.3462924089366766 + 0.080320000000000003 * var_chaste_interface__cell__V);
        ...
        const double var_x31 = pow(var_chaste_interface__INa_m_gate__m, 3.0);
        const double var_x32 = var_x31 * var_chaste_interface__INa_j_gate__j;
        const double var_x33 = var_x32 * var_chaste_interface__INa_h_gate__h;
        const double var_x34 = 1 / var_chaste_interface__Na_buffer__Na_SL;
        const double var_x35 = pow(var_x34, 4.0);
        const double var_x36 = exp(-0.0037434532730821718 * var_chaste_interface__cell__V);
        const double var_x37 = exp(2.0802377414561666);
        const double var_x38 = 0.037434532730821715 * var_chaste_interface__cell__V;
        const double var_x39 = exp(-var_x38);
        const double var_x40 = 1.0 + 0.1245 * var_x36 + 0.036499999999999998 * var_x39 * (-0.14285714285714285 + 0.14285714285714285 * var_x37);
        const double var_x41 = (0.00046605993249873036 * var_x36 + 0.037434532730821715 * var_x39 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x37)) / pow(var_x40, 2);
        const double var_x42 = var_x41 / (1.0 + 14641.0 * var_x35);
        const double var_x43 = 1 / var_chaste_interface__Na_buffer__Na_jct;
        const double var_x44 = pow(var_x43, 4.0);
        const double var_x45 = var_x41 / (1.0 + 14641.0 * var_x44);
        const double var_x46 = 85.986803896123959 + var_chaste_interface__cell__V;
        const double var_x47 = var_x20 / pow(var_x21, 2);
        const double var_x48 = pow(var_chaste_interface__Na_buffer__Na_jct, 3.0);
        const double var_x49 = exp(0.013102086455787598 * var_chaste_interface__cell__V);
        const double var_x50 = 0.023583755620417677 * var_x49;
        const double var_x51 = exp(-0.024332446275034114 * var_chaste_interface__cell__V);
        const double var_x52 = 66768.232578693613 * var_x51;
        const double var_x53 = 1.0 + 0.27000000000000002 * var_x51;
        const double var_x54 = 1 / var_x53;
        const double var_x55 = pow(var_x2, 3.0);
        const double var_x56 = 1.0 + 1.6777215999999998e-11 * var_x55;
        const double var_x57 = 1 / var_x56;
        const double var_x58 = 2744000.0 * var_chaste_interface__Ca_buffer__Ca_jct;
        ...
        const double var_x60 = 1 / (9850.9599999999991 + var_x58 + 669921.875 * var_x59 + 8.4066800865219609 * var_x48);
        const double var_x61 = var_x57 * var_x60;
        const double var_x62 = var_x54 * var_x61;
        const double var_x63 = var_x62 * (var_x48 * var_x50 + var_x52 * var_chaste_interface__Ca_buffer__Ca_jct);
        const double var_x64 = pow(var_chaste_interface__Na_buffer__Na_SL, 3.0);
        const double var_x65 = pow(var_x4, 3.0);
        const double var_x66 = 1.0 + 1.6777215999999998e-11 * var_x65;
        const double var_x67 = 1 / var_x66;
        const double var_x68 = 2744000.0 * var_chaste_interface__Ca_buffer__Ca_SL;
        ...
        const double var_x70 = 1 / (9850.9599999999991 + var_x68 + 669921.875 * var_x69 + 8.4066800865219609 * var_x64);
        const double var_x71 = var_x67 * var_x70;
        const double var_x72 = var_x54 * var_x71;
        const double var_x73 = var_x72 * (var_x50 * var_x64 + var_x52 * var_chaste_interface__Ca_buffer__Ca_SL);
        const double var_x74 = exp(var_x38);
        const double var_x75 = -4.0500000000000007 + 101.25 * var_x74;
        const double var_x76 = -1.0 + var_x74;
        const double var_x77 = 1 / var_x76;
        const double var_x78 = var_chaste_interface__ICaL_d_gate__d * var_chaste_interface__ICaL_f_gate__f;
        const double var_x79 = var_x77 * var_x78;
        const double var_x80 = var_x75 * var_x79;
        const double var_x81 = 1.0 - 0.10000000000000001 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL - 0.90000000000000002 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        const double var_x82 = 0.00043884231319980002 * var_x81;
        const double var_x83 = exp(0.07486906546164343 * var_chaste_interface__cell__V);
        const double var_x84 = -1.0 + var_x83;
        const double var_x85 = 1 / var_x84;
        const double var_x86 = var_x78 * var_x85;
        const double var_x87 = 1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        const double var_x88 = 0.34100000000000003 * var_x83;
        const double var_x89 = -0.61380000000000001 + var_x88 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x90 = var_x87 * var_x89;
        const double var_x91 = 3.1596646550385601 * var_x90;
        const double var_x92 = 1.8 * var_x49;
        const double var_x93 = var_x48 * var_x92 - var_x51 * var_x58;
        const double var_x94 = var_x51 / pow(var_x53, 2);
        const double var_x95 = var_x61 * var_x93 * var_x94;
        const double var_x96 = 1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL;
        const double var_x97 = 0.75 * var_x74;
        const double var_x98 = -105.0 + var_x97 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x99 = var_x96 * var_x98;
        const double var_x100 = 2.4380128511099999e-6 * var_x99;
        const double var_x101 = -0.61380000000000001 + var_x88 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x102 = var_x101 * var_x96;
        const double var_x103 = 0.35107385055984003 * var_x102;
        const double var_x104 = -105.0 + var_x97 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x105 = var_x104 * var_x87;
        const double var_x106 = 2.1942115659989996e-5 * var_x105;
        const double var_x107 = var_x64 * var_x92 - var_x51 * var_x68;
        const double var_x108 = var_x107 * var_x71 * var_x94;
        const double var_x109 = var_x79 * var_chaste_interface__cell__V;
        const double var_x110 = var_x109 * var_x74;
        const double var_x111 = var_x78 * var_chaste_interface__cell__V;
        const double var_x112 = var_x111 * var_x83 / pow(var_x84, 2);
        const double var_x113 = var_x112 * var_x90;
        const double var_x114 = var_x111 * var_x74 / pow(var_x76, 2);
        const double var_x115 = var_x114 * var_x99;
        const double var_x116 = var_x102 * var_x112;
        const double var_x117 = var_x105 * var_x114;
        const double var_x118 = var_x110 * var_x96;
        const double var_x119 = var_x118 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x120 = var_x110 * var_x87;
        const double var_x121 = var_x120 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x122 = var_x86 * var_chaste_interface__cell__V;
        const double var_x123 = var_x122 * var_x83;
        const double var_x124 = var_x123 * var_x96;
        const double var_x125 = var_x124 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x126 = var_x123 * var_x87;
        const double var_x127 = var_x126 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x128 = -26.71330258589418 * log(140.0 * var_x43) + var_chaste_interface__cell__V;
        const double var_x129 = 1.76 * var_x128;
        const double var_x130 = -26.71330258589418 * log(140.0 * var_x34) + var_chaste_interface__cell__V;
        const double var_x131 = 14.24 * var_x130;
        const double var_x132 = var_x31 * var_chaste_interface__INa_h_gate__h;
        const double var_x133 = pow(var_chaste_interface__INa_m_gate__m, 2.0) * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j;
        const double var_x134 = var_x128 * var_x133;
        const double var_x135 = var_x130 * var_x133;
        const double var_x136 = -26.71330258589418 * log(7.9662000000000006 / (135.0 + 0.018329999999999999 * var_chaste_interface__Na_buffer__Nai)) + var_chaste_interface__cell__V;
        const double var_x137 = var_x136 * pow(var_chaste_interface__IKs_Xs_gate__Xs, 1.0);
        const double var_x138 = -5.159208233767437 - 0.059999999999999998 * var_chaste_interface__cell__V;
        const double var_x139 = -1.7197360779224793 - 0.02 * var_chaste_interface__cell__V;
        const double var_x140 = var_chaste_interface__ICaL_f_gate__f * var_chaste_interface__cell__V;
        const double var_x141 = var_x140 * var_x77;
        const double var_x142 = var_x75 * var_x82;
        const double var_x143 = var_x140 * var_x85;
        const double var_x144 = var_chaste_interface__ICaL_d_gate__d * var_chaste_interface__cell__V;
        const double var_x145 = var_x144 * var_x77;
        const double var_x146 = var_x144 * var_x85;
        const double var_x147 = var_x109 * var_x98;
        const double var_x148 = var_x101 * var_x122;
        const double var_x149 = var_x80 * var_chaste_interface__cell__V;
        const double var_x150 = var_x122 * var_x89;
        const double var_x151 = var_x104 * var_x109;
        const double var_x152 = var_x33 * var_x34;
        const double var_x153 = 1 / var_x40;
        const double var_x154 = var_x153 * var_x34 * var_x35 / pow((6.8301345536507063e-5 + var_x35), 2);
        const double var_x155 = pow(var_chaste_interface__Na_buffer__Na_SL, 2.0);
        const double var_x156 = var_x107 * var_x54;
        const double var_x157 = var_x156 * var_x67 / pow((0.0035899999999999999 + 0.244140625 * var_x69 + 3.0636589236596067e-6 * var_x64 + var_chaste_interface__Ca_buffer__Ca_SL), 2);
        const double var_x158 = var_x155 * var_x157;
        const double var_x159 = var_x155 * var_x49 * var_x72;
        const double var_x160 = var_x33 * var_x43;
        const double var_x161 = var_x153 * var_x43 * var_x44 / pow((6.8301345536507063e-5 + var_x44), 2);
        const double var_x162 = pow(var_chaste_interface__Na_buffer__Na_jct, 2.0);
        const double var_x163 = var_x54 * var_x93;
        const double var_x164 = var_x163 * var_x57 / pow((0.0035899999999999999 + 0.244140625 * var_x59 + 3.0636589236596067e-6 * var_x48 + var_chaste_interface__Ca_buffer__Ca_jct), 2);
        const double var_x165 = var_x162 * var_x164;
        const double var_x166 = var_x162 * var_x49 * var_x62;
        const double var_x167 = (16.946599382390602 + 0.002300971605031257 * var_chaste_interface__Na_buffer__Nai) / pow((1 + 0.00013577777777777777 * var_chaste_interface__Na_buffer__Nai), 2);
        const double var_x168 = -6.7429956354615195 - 0.109625 * var_chaste_interface__cell__V;
        const double var_x169 = pow(var_x4, 1.6000000000000001);
        const double var_x170 = var_x169 * var_x4 / pow((1.0 + 5.2281977629563632e-6 * var_x169), 2);
        const double var_x171 = var_x51 * var_x72;
        const double var_x172 = var_x157 * (-3413921.875 - 373215529.24791092 * var_chaste_interface__Ca_buffer__Ca_SL);
        const double var_x173 = var_x136 * var_x6 * var_x7;
        const double var_x174 = var_x156 * var_x4 * var_x65 * var_x70 / pow(var_x66, 2);
        const double var_x175 = pow(var_x2, 1.6000000000000001);
        const double var_x176 = var_x175 * var_x2 / pow((1.0 + 5.2281977629563632e-6 * var_x175), 2);
        const double var_x177 = var_x51 * var_x62;
        const double var_x178 = var_x164 * (-3413921.875 - 373215529.24791092 * var_chaste_interface__Ca_buffer__Ca_jct);
        const double var_x179 = var_x163 * var_x2 * var_x55 * var_x60 / pow(var_x56, 2);
        const double var_x180 = pow(var_chaste_interface__Ca_buffer__Cai, 1.7869999999999999);
        const double var_x181 = 2814485.1633595931 * var_x180;
        const double var_x182 = pow(var_chaste_interface__Ca_buffer__Ca_SR, 1.7869999999999999);
        const double var_x183 = 0.38742512113256738 * var_x182;
        const double var_x184 = 1 / (1.0 + var_x181 + var_x183);
        const double var_x185 = pow(var_chaste_interface__Ca_buffer__Cai, 0.78699999999999992);
        const double var_x186 = var_x184 * var_x185;
        const double var_x187 = (var_x181 - var_x183) / pow((3.5530476870814998e-7 + var_x180 + 1.3765399305573384e-7 * var_x182), 2);
        const double var_x188 = var_x185 * var_x187;
        const double var_x189 = pow(var_chaste_interface__Ca_buffer__Ca_SR, 0.78699999999999992);
        const double var_x190 = var_x184 * var_x189;
        const double var_x191 = var_x187 * var_x189;
        const double var_x192 = 2.3700000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x193 = 13.800000000000001 * var_chaste_interface__Ca_buffer__Cai;
        ...
        const double var_x198 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x199 = 1.0 + var_x198;
        const double var_x200 = 1.0 - var_chaste_interface__INa_j_gate__j;
        const double var_x201 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
        const double var_x202 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x203 = -127140.0 * var_x201 - 3.4740000000000003e-5 * var_x202;
        const double var_x204 = var_x200 * var_x203;
        const double var_x205 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V);
        const double var_x206 = 1.0 + var_x205;
        const double var_x207 = 1.0 / var_x206;
        const double var_x208 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x209 = 1.0 + var_x208;
        const double var_x210 = exp(-0.01052 * var_chaste_interface__cell__V);
        const double var_x211 = var_x210 / var_x209;
        const double var_x212 = 37.780000000000001 + var_chaste_interface__cell__V;
        const double var_x213 = var_x207 * var_x212;
        const double var_x214 = -0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x215 = exp(-3.2000000000000002 + var_x214);
        const double var_x216 = 1.0 + var_x215;
        const double var_x217 = exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V);
        const double var_x218 = var_x217 / var_x216;
        const double var_x219 = 1.0 - var_chaste_interface__INa_m_gate__m;
        const double var_x220 = exp(-4.7130000000000001 + var_x214);
        const double var_x221 = 1.0 - var_x220;
        const double var_x222 = 0.32000000000000001 / var_x221;
        const double var_x223 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x224 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x225 = exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x226 = 1.0 + var_x225;
        const double var_x227 = exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V);
        const double var_x228 = -1.0 + var_x227;
        const double var_x229 = 0.00060999999999999997 / var_x228;
        const double var_x230 = exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V);
        const double var_x231 = 1.0 - var_x230;
        const double var_x232 = 0.0013799999999999999 / var_x231;
        const double var_x233 = 7.0 + var_chaste_interface__cell__V;
        const double var_x234 = 10.0 + var_chaste_interface__cell__V;
        const double var_x235 = var_x229 * var_x234;
        const double var_x236 = var_x232 * var_x233;
        const double var_x237 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        ...
        const double var_x247 = var_x244 * var_x245;
        const double var_x248 = 0.066666666666666666 * var_chaste_interface__cell__V;
        const double var_x249 = exp(0.20000000000000001 + var_x248);
        const double var_x250 = 1.0 + var_x249;
        const double var_x251 = 1 / var_x250;
        const double var_x252 = 1 / (0.5 + 9.0 * var_x251);
        const double var_x253 = exp(-0.20000000000000001 - var_x248);
        const double var_x254 = 1.0 + var_x253;
        const double var_x255 = 0.066666666666666666 * var_x253 / pow(var_x254, 2);
        const double var_x256 = 1.0 / var_x254;
        const double var_x257 = 0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x258 = exp(6.0 + var_x257);
        const double var_x259 = 1.0 + var_x258;
        const double var_x260 = 1 / var_x259;
        const double var_x261 = 1 / (30.0 + 3000.0 * var_x260);
        const double var_x262 = exp(3.3500000000000001 + var_x257);
        const double var_x263 = 1.0 + var_x262;
        const double var_x264 = var_x262 / pow(var_x263, 2);
        const double var_x265 = 0.10000000000000001 * var_x264;
        const double var_x266 = 1 / var_x263;
        const double var_x267 = 1.0 * var_x266;
        const double var_x268 = var_x258 / pow(var_x259, 2);
        const double var_x269 = 1 / (220.0 + 2800.0 * var_x260);
        const double var_x270 = exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2.0));
        const double var_x271 = 1 / (1.5 + 3.5 * var_x270);
        const double var_x272 = 1 / (20.0 + 20.0 * var_x266);
        const double var_x273 = exp(-2.4166666666666665 - 0.16666666666666666 * var_chaste_interface__cell__V);
        const double var_x274 = 1.0 - var_x273;
        const double var_x275 = 1 / var_x274;
        const double var_x276 = 1.0 + var_x273;
        const double var_x277 = 1 / var_x276;
        const double var_x278 = -var_chaste_interface__ICaL_d_gate__d + 1.0 * var_x277;
        const double var_x279 = var_x275 * var_x278;
        const double var_x280 = 0.035000000000000003 * var_x276;
        const double var_x281 = 14.5 + var_chaste_interface__cell__V;
        const double var_x282 = var_x275 * var_x281;
        const double var_x283 = 0.0058333333333333336 * var_x273;
        const double var_x284 = var_x281 * var_x283;
        const double var_x285 = 1 + 0.068965517241379309 * var_chaste_interface__cell__V;
        const double var_x286 = exp(-0.23877882250000002 * pow(var_x285, 2.0));
        const double var_x287 = 0.019699999999999999 * var_x286;
        const double var_x288 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x289 = 1.0 + var_x288;
        const double var_x290 = exp(9.7388888888888889 + 0.27777777777777779 * var_chaste_interface__cell__V);
        const double var_x291 = 1.0 + var_x290;
        const double var_x292 = 1 / var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x293 = pow(var_x292, 2.5);
        const double var_x294 = 1.0 + 0.13584112963311223 * var_x293;
        const double var_x295 = 1 / var_x294;
        const double var_x296 = 7.0 * var_x295;
        const double var_x297 = -7.5 + var_x296;
        const double var_x298 = var_x297 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x299 = 1 / (15.0 - 14.0 * var_x295);
        const double var_x300 = pow(var_chaste_interface__Ca_buffer__Ca_jct, 2.0);
        const double var_x301 = 10.0 * var_x299 * var_x300;
        const double var_x302 = -var_x301;
        const double var_x303 = var_x292 * var_x293 / pow(var_x294, 2);
        const double var_x304 = var_x303 * var_chaste_interface__Jrel_SR__R;
        const double var_x305 = 2.3772197685794643 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x306 = 0.21130842387373017 * var_x300 / pow((1 - 0.93333333333333335 * var_x295), 2);
        const double var_x307 = var_x304 * var_x306;
        const double var_x308 = 20.0 * var_x299 * pow(var_chaste_interface__Ca_buffer__Ca_jct, 1.0);
        const double var_x309 = var_x308 * var_chaste_interface__Jrel_SR__R;
        const double var_x310 = 7.5 - var_x296;
        const double var_x311 = var_x303 * var_x305 * var_chaste_interface__Jrel_SR__O;
        const double var_x312 = 1.0 - var_chaste_interface__Jrel_SR__I - var_chaste_interface__Jrel_SR__O - var_chaste_interface__Jrel_SR__R;
        const double var_x313 = 5.2861839130367859e-9 * var_x99;
        const double var_x314 = 0.030875661253127462 * var_x130;
        const double var_x315 = 0.0001 * var_chaste_interface__Na_buffer__Na_SL_buf;
        const double var_x316 = 0.0001 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x317 = 1.7653304347803735e-6 * var_x105;
        const double var_x318 = 0.14159899680406998 * var_x128;
        const double var_x319 = 0.0001 * var_chaste_interface__Na_buffer__Na_jct_buf;
        const double var_x320 = 0.0001 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x321 = 100.0 * var_chaste_interface__Ca_buffer__Ca_Calsequestrin;
        const double var_x322 = 25.0 * var_chaste_interface__Jrel_SR__O;
        const double var_x323 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x324 = 0.00038060524173864864 * var_x102;
        const double var_x325 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x326 = 0.12710379130418692 * var_x90;
        const double var_x327 = 1623.3766233766235 * var_chaste_interface__Jrel_SR__O;
        const double var_x328 = 100.0 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x329 = -100.0 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x330 = -100.0 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x331 = -2.3700000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x332 = -13.800000000000001 * var_chaste_interface__Ca_buffer__Cai;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0095482999999999991 + 0.23656113989492294 * var_x113 + 9.1265871873041266e-8 * var_x115 + 0.026284571099435886 * var_x116 + 8.2139284685737127e-7 * var_x117 - 16.0 * var_x33 - 1.328399295652174 * var_x42 - 0.001 / var_x1 - 0.01205875 / var_x3 - 0.16418418260869566 * var_x45 - 0.98999999999999999 * var_x63 - 8.0099999999999998 * var_x73 - 0.097566250000000007 / var_x5 - 0.11 * var_x12 - 0.89000000000000001 * var_x16 - 6.844940390478094e-8 * var_x119 - 6.1604463514302843e-7 * var_x121 - 0.0089630387449076369 * var_x125 - 0.0065040628893166192 * var_x95 - 0.080667348704168737 * var_x127 - 0.052623781559016279 * var_x108 + (-0.029999999999999999 * var_chaste_interface__Itos_R_gate__R_tos - 0.059999999999999998 * var_chaste_interface__Itos_Y_gate__Y_tos) * var_chaste_interface__Itos_X_gate__X_tos - var_x100 * var_x79 - var_x103 * var_x86 - var_x106 * var_x79 - var_x19 * var_chaste_interface__IKr_Xr_gate__Xr - var_x80 * var_x82 - var_x86 * var_x91 - 0.02 * var_chaste_interface__Itof_X_gate__X_tof * var_chaste_interface__Itof_Y_gate__Y_tof - 0.0016633205148861771 * var_x110 * var_x81 - 0.91800000000000004 * var_x22 * var_x30 + 1.6427856937147429e-5 * var_x114 * var_x75 * var_x81 + 0.218943 * var_x30 * var_x46 * var_x47 - 0.00016722408026755852 * var_x0 * var_x46 / pow(var_x1, 2) + 0.0013392857142857143 * var_x17 * var_x46 * var_chaste_interface__IKr_Xr_gate__Xr / pow(var_x18, 2) - 0.88235294117647056 * var_x22 * var_x46 * (0.24326999999999999 * var_x47 - var_x25 * (0.061749999999999999 * var_x26 + 0.039456396800000001 * var_x27) - 0.51429999999999998 * var_x23 * var_x28 / pow(var_x24, 2)) / pow((var_x22 + 0.98039215686274506 * var_x29), 2));
        IJth(rJacobian, 2, 0) = ((var_x197) ? ((-0.28123999999999999 * var_x194 - 108500.0 * var_x195) * var_chaste_interface__INa_h_gate__h - 0.14705882352941177 * var_x196 * (0.13500000000000001 - 0.13500000000000001 * var_chaste_interface__INa_h_gate__h)) : (-0.693000693000693 * var_x198 * var_chaste_interface__INa_h_gate__h / pow(var_x199, 2)));
        IJth(rJacobian, 3, 0) = ((var_x197) ? (var_x204 * var_x207 + 0.001275024 * var_x211 * var_chaste_interface__INa_j_gate__j + var_x200 * var_x213 * (1.5254334000000001e-6 * var_x202 - 31073.016 * var_x201) - 0.311 * var_x204 * var_x205 * var_x212 / pow(var_x206, 2) - 0.016701360000000002 * var_x208 * var_x210 * var_chaste_interface__INa_j_gate__j / pow(var_x209, 2)) : (7.6049999999999996e-8 * var_x218 * var_chaste_interface__INa_j_gate__j - 0.029999999999999999 * var_x215 * var_x217 * var_chaste_interface__INa_j_gate__j / pow(var_x216, 2)));
        IJth(rJacobian, 4, 0) = var_x219 * var_x222 + 0.0072727272727272727 * var_x223 * var_chaste_interface__INa_m_gate__m - 0.032000000000000001 * var_x219 * var_x220 * var_x224 / pow(var_x221, 2);
        IJth(rJacobian, 5, 0) = (-var_chaste_interface__IKr_Xr_gate__Xr + 1.0 / var_x226) * (var_x229 + var_x232 - 0.00016973999999999998 * var_x230 * var_x233 / pow(var_x231, 2) - 8.8449999999999995e-5 * var_x227 * var_x234 / pow(var_x228, 2)) + 0.13333333333333333 * var_x225 * (var_x235 + var_x236) / pow(var_x226, 2);
        IJth(rJacobian, 6, 0) = (-var_chaste_interface__IKs_Xs_gate__Xs + 1.0 / var_x238) * (var_x241 + var_x244 - 8.9997000000000013e-6 * var_x239 * var_x245 / pow(var_x240, 2) - 1.0641199999999999e-5 * var_x242 * var_x245 / pow(var_x243, 2)) + 0.059880239520958084 * var_x237 * (var_x246 + var_x247) / pow(var_x238, 2);
        IJth(rJacobian, 7, 0) = var_x252 * var_x255 + 0.0074074074074074077 * var_x249 * (var_x256 - var_chaste_interface__Itos_X_gate__X_tos) / (pow(var_x250, 2) * pow((0.055555555555555552 + var_x251), 2));
        IJth(rJacobian, 8, 0) = -var_x261 * var_x265 + 3.3333333333333335e-5 * var_x268 * (var_x267 - var_chaste_interface__Itos_Y_gate__Y_tos) / pow((0.01 + var_x260), 2);
        IJth(rJacobian, 9, 0) = -var_x265 * var_x269 + 3.5714285714285717e-5 * var_x268 * (var_x267 - var_chaste_interface__Itos_R_gate__R_tos) / pow((0.07857142857142857 + var_x260), 2);
        IJth(rJacobian, 10, 0) = var_x255 * var_x271 + 0.00063492063492063492 * var_x270 * pow(var_chaste_interface__cell__V, 1.0) * (var_x256 - var_chaste_interface__Itof_X_gate__X_tof) / pow((0.42857142857142855 + var_x270), 2);
        IJth(rJacobian, 11, 0) = -var_x265 * var_x272 + 0.0050000000000000001 * var_x264 * (var_x267 - var_chaste_interface__Itof_Y_gate__Y_tof) / pow((1 + var_x266), 2);
        IJth(rJacobian, 12, 0) = var_x279 * var_x280 - var_x279 * var_x284 + var_x277 * var_x282 * var_x283 - var_x276 * var_x278 * var_x284 / pow(var_x274, 2);
        IJth(rJacobian, 13, 0) = (0.02 + var_x287) * (0.029999999999999999 * var_x288 / pow(var_x289, 2) - 0.27777777777777779 * var_x290 / pow(var_x291, 2)) - 0.00064881969699999995 * var_x286 * pow(var_x285, 1.0) * (-var_chaste_interface__ICaL_f_gate__f + 1.0 / var_x291 + 0.59999999999999998 / var_x289);
        IJth(rJacobian, 19, 0) = -5.7312946201117851e-7 + 1.9788582471371878e-10 * var_x115 - 0.030875661253127462 * var_x33 - 0.052102678364652592 * var_x73 - 0.0086408441000245025 * var_x42 - 1.4841436853528909e-10 * var_x119 - 0.00034230211796518873 * var_x108 - var_x313 * var_x79;
        IJth(rJacobian, 20, 0) = -2.6284313781755495e-6 + 6.6084319941501622e-8 * var_x117 - 0.039627810594012852 * var_x45 - 0.0015698331482008195 * var_x95 - 0.14159899680406998 * var_x33 - 4.9563239956126217e-8 * var_x121 - 0.2389483071068681 * var_x63 - var_x317 * var_x79;
        IJth(rJacobian, 25, 0) = -2.4247042727846657e-7 + 0.017367559454884197 * var_x73 + 2.8495558758775506e-5 * var_x116 + 0.00011410070598839624 * var_x108 - 9.7169855367424485e-6 * var_x125 - var_x324 * var_x86;
        IJth(rJacobian, 26, 0) = -1.1119946217769621e-6 + 0.00052327771606693984 * var_x95 + 0.0095161420715762345 * var_x113 + 0.07964943570228937 * var_x63 - 0.0032450044464074966 * var_x127 - var_x326 * var_x86;
        IJth(rJacobian, 1, 1) = -7.2523935948689155 + 34.0 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Calmodulin + 100.0 * var_chaste_interface__cytosolic_Ca_buffer__Ca_SRB + 32.700000000000003 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC + 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC_Ca_Mg + 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_TroponinC_Ca_Mg + 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Myosin + 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_Myosin + 1.8158889498609616e-10 * var_x188 - 1438.4249685909369 * var_x186;
        IJth(rJacobian, 24, 1) = 26713.606559545973 * var_x186 - 3.3723651925989286e-9 * var_x188;
        IJth(rJacobian, 25, 1) = 5.6417918332397381;
        IJth(rJacobian, 32, 1) = 2.2890000000000006 - 32.700000000000003 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC;
        IJth(rJacobian, 33, 1) = 0.33180000000000004 - 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC_Ca_Mg - 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_TroponinC_Ca_Mg;
        IJth(rJacobian, 35, 1) = 0.81600000000000006 - 34.0 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Calmodulin;
        IJth(rJacobian, 36, 1) = 1.9320000000000004 - 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Myosin - 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_Myosin;
        IJth(rJacobian, 38, 1) = 1.71 - 100.0 * var_chaste_interface__cytosolic_Ca_buffer__Ca_SRB;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x129 * var_x32 - var_x131 * var_x32);
        IJth(rJacobian, 2, 2) = ((var_x197) ? (-310000.0 * var_x195 - 0.13500000000000001 * var_x196 - 3.5600000000000001 * var_x194) : (-7.6923076923076916 / var_x199));
        IJth(rJacobian, 19, 2) = -var_x314 * var_x32;
        IJth(rJacobian, 20, 2) = -var_x318 * var_x32;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x129 * var_x132 - var_x131 * var_x132);
        IJth(rJacobian, 3, 3) = ((var_x197) ? (-0.1212 * var_x211 - var_x203 * var_x213) : (-0.29999999999999999 * var_x218));
        IJth(rJacobian, 19, 3) = -var_x132 * var_x314;
        IJth(rJacobian, 20, 3) = -var_x132 * var_x318;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-5.2800000000000002 * var_x134 - 42.719999999999999 * var_x135);
        IJth(rJacobian, 4, 4) = -0.080000000000000002 * var_x223 - var_x222 * var_x224;
        IJth(rJacobian, 19, 4) = -0.092626983759382386 * var_x135;
        IJth(rJacobian, 20, 4) = -0.42479699041220997 * var_x134;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x19 * var_x46);
        IJth(rJacobian, 5, 5) = -var_x235 - var_x236;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.22 * var_x11 * var_x137 - 1.78 * var_x137 * var_x15);
        IJth(rJacobian, 6, 6) = -var_x246 - var_x247;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x138 * (0.5 * var_chaste_interface__Itos_R_gate__R_tos + var_chaste_interface__Itos_Y_gate__Y_tos));
        IJth(rJacobian, 7, 7) = -var_x252;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x138 * var_chaste_interface__Itos_X_gate__X_tos);
        IJth(rJacobian, 8, 8) = -var_x261;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : ((-2.5796041168837185 - 0.029999999999999999 * var_chaste_interface__cell__V) * var_chaste_interface__Itos_X_gate__X_tos);
        IJth(rJacobian, 9, 9) = -var_x269;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x139 * var_chaste_interface__Itof_Y_gate__Y_tof);
        IJth(rJacobian, 10, 10) = -var_x271;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x139 * var_chaste_interface__Itof_X_gate__X_tof);
        IJth(rJacobian, 11, 11) = -var_x272;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x100 * var_x141 - var_x103 * var_x143 - var_x106 * var_x141 - var_x141 * var_x142 - var_x143 * var_x91);
        IJth(rJacobian, 12, 12) = -var_x280 * var_x282;
        IJth(rJacobian, 19, 12) = -var_x141 * var_x313;
        IJth(rJacobian, 20, 12) = -var_x141 * var_x317;
        IJth(rJacobian, 25, 12) = -var_x143 * var_x324;
        IJth(rJacobian, 26, 12) = -var_x143 * var_x326;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x100 * var_x145 - var_x103 * var_x146 - var_x106 * var_x145 - var_x142 * var_x145 - var_x146 * var_x91);
        IJth(rJacobian, 13, 13) = -0.02 - var_x287;
        IJth(rJacobian, 19, 13) = -var_x145 * var_x313;
        IJth(rJacobian, 20, 13) = -var_x145 * var_x317;
        IJth(rJacobian, 25, 13) = -var_x146 * var_x324;
        IJth(rJacobian, 26, 13) = -var_x146 * var_x326;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (2.4380128511099999e-6 * var_x147 + 0.35107385055984003 * var_x148 + 4.3884231319980005e-5 * var_x149);
        ...
        IJth(rJacobian, 25, 14) = 0.00038060524173864864 * var_x148;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (3.1596646550385601 * var_x150 + 2.1942115659989996e-5 * var_x151 + 0.00039495808187982003 * var_x149);
        IJth(rJacobian, 15, 15) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 20, 15) = 1.7653304347803735e-6 * var_x151;
        IJth(rJacobian, 26, 15) = 0.12710379130418692 * var_x150;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x298 + var_x302;
        IJth(rJacobian, 17, 16) = var_x302;
        IJth(rJacobian, 18, 16) = var_x301;
        IJth(rJacobian, 16, 17) = -0.0050000000000000001;
        IJth(rJacobian, 17, 17) = -0.065000000000000002 + var_x302;
        IJth(rJacobian, 18, 17) = 0.0050000000000000001;
        IJth(rJacobian, 16, 18) = 0.055;
        IJth(rJacobian, 17, 18) = var_x302 + var_x310 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 18, 18) = -0.059999999999999998 + var_x298;
        ...
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (2.6829345457558438e-11 * var_x158 - 0.0070611272725294091 * var_x34 - 380.39742882313311 * var_x152 - 43.254000000000005 * var_x159 - 1.8285096383325e-6 * var_x118 - 0.00036292583721116698 * var_x154);
        IJth(rJacobian, 19, 19) = -2.5101556644976917 + var_x315 + 1.7451694845309867e-13 * var_x158 - 0.28135446316912399 * var_x159 - 3.9646379347775894e-9 * var_x118 - 2.3607251144114479e-6 * var_x154 - 1.5310180739595356e-5 * var_x34 - 0.82479088159436253 * var_x152;
        IJth(rJacobian, 20, 19) = 1.0293738389968197;
        IJth(rJacobian, 21, 19) = 0.000165 - var_x315;
        IJth(rJacobian, 23, 19) = 0.076376893524206985;
        IJth(rJacobian, 25, 19) = 0.093784821056374673 * var_x159 - 5.8172316151032891e-14 * var_x158;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (3.3159865172263241e-12 * var_x165 - 47.01541255117376 * var_x160 - 0.00087272359548116291 * var_x43 - 1.6456586744992497e-5 * var_x120 - 5.3460000000000001 * var_x166 - 4.4856002351941991e-5 * var_x161);
        IJth(rJacobian, 19, 20) = 0.02774162496096429;
        IJth(rJacobian, 20, 20) = -1.0301299389968197 + var_x319 + 8.0035289361659559e-13 * var_x165 - 7.0214082731462308e-5 * var_x43 - 1.3239978260852802e-6 * var_x120 - 1.2903208583770878 * var_x166 - 1.0826531136947709e-5 * var_x161 - 3.7825768474861845 * var_x160;
        IJth(rJacobian, 22, 20) = 0.0007561 - var_x319;
        IJth(rJacobian, 26, 20) = 0.43010695279236261 * var_x166 - 2.6678429787219855e-13 * var_x165;
        IJth(rJacobian, 19, 21) = 0.001 + var_x316;
        IJth(rJacobian, 21, 21) = -0.001 - var_x316;
        IJth(rJacobian, 20, 22) = 0.001 + var_x320;
        IJth(rJacobian, 22, 22) = -0.001 - var_x320;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-2.3543249347038373e-5 * var_x12 * var_x167 - 0.00019048629017149227 * var_x16 * var_x167);
        IJth(rJacobian, 19, 23) = 2.4822490395367272;
        IJth(rJacobian, 23, 23) = -0.076376893524206985;
        IJth(rJacobian, 1, 24) = 2.4996436489414462e-17 * var_x191 + 0.00019800494063761101 * var_x190;
        IJth(rJacobian, 16, 24) = -var_x307 + var_x304 * var_x305;
        IJth(rJacobian, 17, 24) = -var_x311 + var_x303 * var_x306 * var_x312;
        IJth(rJacobian, 18, 24) = var_x307 + var_x311;
        IJth(rJacobian, 24, 24) = -260.00009932 + var_x321 - var_x322 - 0.0036772346118413473 * var_x190 - 4.6421953480341139e-16 * var_x191;
        IJth(rJacobian, 26, 24) = 0.0064493506493506492 + var_x327;
        IJth(rJacobian, 31, 24) = 260.0 - var_x321;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (21979440.0 * var_x171 - 5.0104537825247566e-7 * var_x170 - 1.0638105721255599e-12 * var_x172 - 0.0029873085582266673 * var_x4 - 4.0315650047999994e-10 * var_x174 - 0.11971618304090545 * var_x124 + 0.08900000000000001 * var_x168 / (pow(var_x5, 2) * pow(var_chaste_interface__Ca_buffer__Ca_SL, 2)) - 0.019728333333333337 * var_x13 * var_x173 * var_x4 / pow(var_x14, 2));
        IJth(rJacobian, 1, 25) = 0.17359359486891501;
        IJth(rJacobian, 14, 25) = 1.7 - 1.7 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL;
        IJth(rJacobian, 19, 25) = 142969.74943260671 * var_x171 - 2.6224136673069093e-12 * var_x174 - 6.919772794054321e-15 * var_x172;
        IJth(rJacobian, 25, 25) = -171.99023312516786 + 100.0 * var_chaste_interface__Ca_buffer__Ca_SLB_SL + 100.0 * var_chaste_interface__Ca_buffer__Ca_SLHigh_SL + 2.3065909313514403e-15 * var_x172 + 8.7413788910230311e-13 * var_x174 - 47656.583144202239 * var_x171 - 0.00012978638743287919 * var_x124 - 5.4319197230928918e-10 * var_x170 - 3.2385929460103641e-6 * var_x4;
        IJth(rJacobian, 26, 25) = 46.324352205124718;
        IJth(rJacobian, 27, 25) = 121.55000000000001 - 100.0 * var_chaste_interface__Ca_buffer__Ca_SLB_SL;
        IJth(rJacobian, 29, 25) = 43.550000000000004 - 100.0 * var_chaste_interface__Ca_buffer__Ca_SLHigh_SL;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (2716560.0 * var_x177 - 6.1926956862665531e-8 * var_x176 - 0.00036921791169093637 * var_x2 - 4.9828331519999993e-11 * var_x179 - 1.0774456473681491 * var_x126 - 1.3148220554360853e-13 * var_x178 + 0.011000000000000001 * var_x168 / (pow(var_x3, 2) * pow(var_chaste_interface__Ca_buffer__Ca_jct, 2)) - 0.0024383333333333336 * var_x173 * var_x2 * var_x9 / pow(var_x10, 2));
        IJth(rJacobian, 15, 26) = 1.7 - 1.7 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        IJth(rJacobian, 16, 26) = -var_x309 + var_x297 * var_chaste_interface__Jrel_SR__R;
        IJth(rJacobian, 17, 26) = var_x308 * var_x312 + var_x310 * var_chaste_interface__Jrel_SR__O;
        IJth(rJacobian, 18, 26) = var_x309 + var_x297 * var_chaste_interface__Jrel_SR__O;
        IJth(rJacobian, 20, 26) = 655674.15470124607 * var_x177 - 1.2026662083498782e-11 * var_x179 - 3.1734798413457098e-14 * var_x178;
        IJth(rJacobian, 24, 26) = 9.9320000000000005e-5 + var_x322;
        IJth(rJacobian, 25, 26) = 1.2484412919281114;
        IJth(rJacobian, 26, 26) = -121.70185906968872 - var_x327 + 100.0 * var_chaste_interface__Ca_buffer__Ca_SLB_jct + 100.0 * var_chaste_interface__Ca_buffer__Ca_SLHigh_jct + 4.0088873611662605e-12 * var_x179 + 1.0578266137819034e-14 * var_x178 - 2.4911349337733966e-9 * var_x176 - 0.043342392834727739 * var_x126 - 218558.051567082 * var_x177 - 1.4852524402707471e-5 * var_x2;
        IJth(rJacobian, 28, 26) = 55.473098330241186 - 100.0 * var_chaste_interface__Ca_buffer__Ca_SLB_jct;
        IJth(rJacobian, 30, 26) = 19.897959183673468 - 100.0 * var_chaste_interface__Ca_buffer__Ca_SLHigh_jct;
        IJth(rJacobian, 25, 27) = 1.3 + var_x325;
        IJth(rJacobian, 27, 27) = -1.3 + var_x329;
        IJth(rJacobian, 26, 28) = 1.3 + var_x328;
        IJth(rJacobian, 28, 28) = -1.3 + var_x330;
        IJth(rJacobian, 25, 29) = 0.029999999999999999 + var_x325;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x329;
        IJth(rJacobian, 26, 30) = 0.029999999999999999 + var_x328;
        IJth(rJacobian, 30, 30) = -0.029999999999999999 + var_x330;
        IJth(rJacobian, 24, 31) = 65.0 + var_x323;
        IJth(rJacobian, 31, 31) = -65.0 - var_x323;
        IJth(rJacobian, 1, 32) = 0.019599999999999999 + 32.700000000000003 * var_chaste_interface__Ca_buffer__Cai;
        IJth(rJacobian, 32, 32) = -0.019599999999999999 - 32.700000000000003 * var_chaste_interface__Ca_buffer__Cai;
        IJth(rJacobian, 1, 33) = 0.003032 + var_x192;
        IJth(rJacobian, 33, 33) = -3.1999999999999999e-5 + var_x331;
        IJth(rJacobian, 34, 33) = -0.0030000000000000001;
        IJth(rJacobian, 1, 34) = 0.0063300000000000006 + var_x192;
        IJth(rJacobian, 33, 34) = var_x331;
        IJth(rJacobian, 34, 34) = -0.0063300000000000006;
        IJth(rJacobian, 1, 35) = 0.23799999999999999 + 34.0 * var_chaste_interface__Ca_buffer__Cai;
        IJth(rJacobian, 35, 35) = -0.23799999999999999 - 34.0 * var_chaste_interface__Ca_buffer__Cai;
        IJth(rJacobian, 1, 36) = 0.016159999999999997 + var_x193;
        IJth(rJacobian, 36, 36) = -0.00046000000000000001 + var_x332;
        IJth(rJacobian, 37, 36) = -0.015699999999999999;
        IJth(rJacobian, 1, 37) = 0.015757 + var_x193;
        IJth(rJacobian, 36, 37) = var_x332;
        IJth(rJacobian, 37, 37) = -0.015757;
        IJth(rJacobian, 1, 38) = 0.059999999999999998 + 100.0 * var_chaste_interface__Ca_buffer__Cai;
        IJth(rJacobian, 38, 38) = -0.059999999999999998 - 100.0 * var_chaste_interface__Ca_buffer__Cai;
    }
