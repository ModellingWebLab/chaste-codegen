...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_model_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x4 = 0.58999999999999997 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x5 = 1 / var_x4;
        const double var_x6 = pow((var_x5 * var_chaste_interface__cleft_space_ion_concentrations__K_c), 3.0);
        const double var_x7 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x8 = log(var_x7 * var_chaste_interface__cleft_space_ion_concentrations__K_c);
        const double var_x9 = exp(0.18895643383558949 + 0.052487898287663745 * var_chaste_interface__membrane__V - 1.3930000000000002 * var_x8);
        const double var_x10 = 1.0 + var_x9;
        const double var_x11 = var_x6 / var_x10;
        const double var_x12 = 0.20320000000000002 * var_x11;
        ...
        const double var_x14 = var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i;
        const double var_x15 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0);
        const double var_x16 = 1 / (1.0 + 0.00074999999999999991 * var_x15 + 823.19999999999993 * var_chaste_interface__intracellular_ion_concentrations__Ca_i);
        const double var_x17 = exp(0.016955889611951679 * var_chaste_interface__membrane__V);
        const double var_x18 = var_x15 * var_x17;
        const double var_x19 = exp(-0.020723865081274273 * var_chaste_interface__membrane__V);
        const double var_x20 = var_x19 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x21 = var_x16 * (0.0423897240298792 * var_x18 + 56866.285783016603 * var_x20);
        ...
        const double var_x24 = -0.08000320000000001 - 0.12000479999999999 * var_x23;
        ...
        const double var_x28 = 7.2000000000000002 - 0.14400000000000002 * var_chaste_interface__membrane__V;
        const double var_x29 = 0.083333333333333329 * var_x1 / pow(var_x2, 2);
        const double var_x30 = -26.539450910485353 * var_x8 + var_chaste_interface__membrane__V;
        const double var_x31 = var_x30 * var_x6 * var_x9 / pow(var_x10, 2);
        ...
        const double var_x33 = 0.037679754693225952 * var_chaste_interface__membrane__V;
        ...
        const double var_x39 = exp(var_x33 - 1.0000000000000002 * log(140.0 * var_x38));
        const double var_x40 = -1.0 + var_x39;
        const double var_x41 = var_x36 * var_x37 * var_x40;
        const double var_x42 = var_x32 * var_x41;
        const double var_x43 = 0.53699594212115953 * var_x37;
        ...
        const double var_x56 = 4.5600000000000005 - 0.12000000000000001 * var_chaste_interface__membrane__V;
        ...
        const double var_x62 = 1.8577615637339748 * var_x8 - 0.070000000000000007 * var_chaste_interface__membrane__V;
        const double var_x63 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0);
        const double var_x64 = (2.5 * var_x18 - 2744000.0 * var_x20) / pow((0.0012147716229348883 + 9.1107871720116612e-7 * var_x15 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x65 = var_x63 * var_x64;
        const double var_x66 = var_x16 * var_x17 * var_x63;
        ...
        const double var_x77 = var_x16 * var_x19;
        const double var_x78 = var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x75, 2);
        const double var_x79 = 1.3269725455242678 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x80 = 1.8577615637339748 * var_x14;
        const double var_x81 = 5.3928164250106239 * var_x11;
        const double var_x82 = 26.539450910485353 * var_x27;
        const double var_x83 = 0.28305760000000008 * var_x31;
        ...
        const double var_x87 = var_x30 * var_x4 * var_x84 * (3.0 * var_x5 - 3.0 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow(var_x4, 2));
        ...
        const double var_x203 = (var_x197 - 0.32000000000000006 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up) / pow((0.00041999999999999996 + 0.00024000000000000001 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        ...
        const double var_x206 = 8.357076148592106e-6 * var_x11;
        ...
        const double var_x211 = 7.6404797510100259e-5 * var_x8 - 2.8789140275661778e-6 * var_chaste_interface__membrane__V;
        const double var_x212 = 5.4574855364357316e-5 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x213 = 7.6404797510100259e-5 * var_x14;
        const double var_x214 = 0.00022179221220074819 * var_x11;
        const double var_x215 = 26.539450910485353 * var_x209;
        const double var_x216 = 1.1641407074988805e-5 * var_x31;
        const double var_x217 = -200.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x218 = 4.2119663788904208e-5 * var_x11;
        ...
        const double var_x223 = 1.4509726698933535e-5 * var_chaste_interface__membrane__V - 0.00038508017945090525 * var_x8;
        const double var_x224 = 0.00027505727103636088 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x225 = 0.00038508017945090525 * var_x14;
        const double var_x226 = 0.0011178327494917708 * var_x11;
        const double var_x227 = 26.539450910485353 * var_x221;
        const double var_x228 = 5.8672691657943569e-5 * var_x31;
        ...
        const double var_x236 = var_x232 * var_x74 * (4.0 * var_x233 - 4.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x232, 2));
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.028799999999999999 + var_x27 - var_x12 + 0.010665540932053274 * var_x31 - 0.022901333333333333 * var_x53 - 0.14400000000000002 * var_x13 - 0.14400000000000002 * var_x3 - 14.251577445054345 * var_x42 - 0.070000000000000007 * var_x14 - 0.050000000000000003 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z - 0.00040000000000000002 * var_x21 - 0.12000000000000001 * var_x22 + var_x28 * var_x29 + var_x43 * var_x46 - var_x43 * var_x45);
        ...
        IJth(rJacobian, 15, 0) = -1.6450937300378162e-8 - 0.00058612951745018146 * var_x42 - 2.2085216435981739e-5 * var_x72 - 2.8256129907129527e-6 * var_x53 - 4.9352811901134485e-8 * var_x21 + 2.2085216435981739e-5 * var_x37 * var_x46;
        IJth(rJacobian, 16, 0) = -1.7614021922566692e-8 + 3.5228043845133383e-8 * var_x21 - 6.3410478921240086e-6 * var_x13 - 6.3410478921240086e-6 * var_x3 - 5.2842065767700066e-6 * var_x22 + var_x195 * var_x29;
        IJth(rJacobian, 17, 0) = -1.151565611026471e-6 + var_x209 - var_x206 + 4.3864536286956311e-7 * var_x31 + 1.8837419938086351e-6 * var_x53 - 2.8789140275661778e-6 * var_x14 - 2.0563671625472697e-6 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        IJth(rJacobian, 22, 0) = 5.8038906795734136e-6 + var_x218 + var_x221 + 1.0364090499238238e-5 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z + 1.4509726698933535e-5 * var_x14 - 9.4940596487955202e-6 * var_x53 - 2.2107726288625979e-6 * var_x31;
        IJth(rJacobian, 26, 0) = -var_x231;
        IJth(rJacobian, 27, 0) = var_x231;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-42.754732335163034 * var_x54);
        IJth(rJacobian, 1, 1) = -18.400000000000002 * var_x88 + var_x91 * var_x92;
        IJth(rJacobian, 15, 1) = -0.0017583885523505445 * var_x54;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-9.0497516776095086 * var_x55);
        IJth(rJacobian, 2, 2) = -var_x103;
        IJth(rJacobian, 15, 2) = -0.00037219224358086525 * var_x55;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-5.201825767444836 * var_x55);
        IJth(rJacobian, 3, 3) = -var_x108;
        IJth(rJacobian, 15, 3) = -0.00021393727386931623 * var_x55;
        ...
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (1.3269725455242678 * var_x8 - 0.050000000000000003 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 12, 12) = -0.001 * var_x186;
        IJth(rJacobian, 17, 12) = 5.4574855364357316e-5 * var_x8 - 2.0563671625472697e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 22, 12) = 1.0364090499238238e-5 * var_chaste_interface__membrane__V - 0.00027505727103636088 * var_x8;
        ...
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.0023228249436513899 * var_x69 + 1.3281030862990763e-12 * var_x65 - 0.0030000000000000005 * var_x66 - 3.0916800000000002 * var_x71 - 14.251577445054348 * var_x73 - 0.010615780364194142 * var_x38);
        IJth(rJacobian, 15, 15) = 2.8659485630822583e-7 * var_x69 + 1.638640545085862e-16 * var_x65 - 3.701460892585086e-7 * var_x66 - 0.00058612951745018156 * var_x73 - 0.00038145775374624861 * var_x71 - 4.3659884291485865e-7 * var_x38;
        ...
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (1097.6000000000001 * var_x77 + 4.8590864917395538e-7 * var_x64 + 0.19018000000000002 * var_x78 - 0.0053078901820970709 * var_x74 - 0.19018000000000002 * var_x76);
        IJth(rJacobian, 15, 16) = 5.9952395409541403e-11 * var_x64 + 0.13542411585671302 * var_x77;
        IJth(rJacobian, 16, 16) = -47.271999999999998 - var_x202 + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 7.3978892074780085e-7 * var_x203 + 8.3745867230843319e-6 * var_x78 + 9.0 * var_chaste_interface__intracellular_Ca_buffering__O_C + 6.2720000000000002 * var_chaste_interface__intracellular_Ca_buffering__O_TC - 0.096665752311046002 * var_x77 - 8.2198768971977874 * var_x198 - 8.3745867230843319e-6 * var_x76 - 4.2794027994574083e-11 * var_x64 - 2.3373323507508576e-7 * var_x74;
        ...
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x7 * var_x82 + var_x7 * var_x83 - var_x7 * var_x79 - var_x7 * var_x80 - var_x7 * var_x81);
        IJth(rJacobian, 17, 17) = var_x215 * var_x7 + var_x216 * var_x7 - var_x212 * var_x7 - var_x213 * var_x7 - var_x214 * var_x7;
        IJth(rJacobian, 22, 17) = var_x224 * var_x7 + var_x225 * var_x7 + var_x226 * var_x7 + var_x227 * var_x7 - var_x228 * var_x7;
        ...
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (2.0611199999999998 * var_x86 - 2.0611199999999998 * var_x85 + var_x79 * var_x84 + var_x80 * var_x84 + var_x81 * var_x84 - var_x12 * var_x87 - var_x82 * var_x84 - var_x83 * var_x84);
        IJth(rJacobian, 15, 22) = 0.00025430516916416572 * var_x86 - 0.00025430516916416572 * var_x85;
        IJth(rJacobian, 17, 22) = 0.00016953677944277716 * var_x85 - 0.00016953677944277716 * var_x86 + var_x212 * var_x84 + var_x213 * var_x84 + var_x214 * var_x84 - var_x206 * var_x87 - var_x215 * var_x84 - var_x216 * var_x84;
        ...
        IJth(rJacobian, 16, 24) = 0.00078910818213098776 * var_x198 + 1.7754934097947219e-10 * var_x203;
        IJth(rJacobian, 23, 24) = 0.10000000000000002;
        IJth(rJacobian, 24, 24) = -0.011085915847820611 - 2.632149968060505e-9 * var_x203 - 0.011698444302491135 * var_x198;
