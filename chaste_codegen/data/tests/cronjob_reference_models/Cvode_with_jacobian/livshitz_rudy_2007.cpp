...
#include "MathsCustomFunctions.hpp"
    ...
    void Celllivshitz_rudy_2007FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x44 = 0.037435883507802616 * var_chaste_interface__cell__V;
        ...
        const double var_x49 = 112394.24000000001 + var_x47 - var_x43 - var_x48;
        const double var_x50 = exp(-0.031820500981632228 * var_chaste_interface__cell__V);
        const double var_x51 = 1.0 + 0.0001 * var_x50 * (-112394.24000000001 + var_x43 + var_x47 + var_x48);
        ...
        const double var_x59 = exp(-0.003743588350780262 * var_chaste_interface__cell__V);
        ...
        const double var_x63 = (0.00046607674967214262 * var_x59 + 0.037435883507802616 * var_x61 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x60)) / (pow(var_x62, 2) * (1.0 + 100.0 * var_x58));
        const double var_x64 = -26.712338705498265 * var_x10 + var_chaste_interface__cell__V;
        const double var_x65 = var_x0 * var_x64 / pow(var_x1, 2);
        const double var_x66 = var_x5 * var_x64 * var_chaste_interface__IKr__xr / pow(var_x6, 2);
        const double var_x67 = var_x11 / pow(var_x12, 2);
        const double var_x68 = var_x21 * var_x64;
        ...
        const double var_x72 = var_x50 * (0.031820500981632228 * var_x50 * (-11.239424000000001 + 182.93333333333334 * var_x33 + 0.00018000000000000001 * var_x46 + 91.466666666666669 * var_chaste_interface__Ca__Ca_T) - 6.7384590314044719e-6 * var_x46 * var_x50);
        const double var_x73 = var_x46 * var_x52;
        const double var_x74 = var_x14 * var_x19 / pow(var_x15, 2);
        const double var_x75 = 0.24326999999999999 * var_x67 - 0.51429999999999998 * var_x74 - var_x16 * (0.061749999999999999 * var_x17 + 0.039456396800000001 * var_x18);
        const double var_x76 = var_x13 * var_x64 / pow((var_x13 + 0.98039215686274506 * var_x20), 2);
        const double var_x77 = 0.67122862439358588 * var_x76;
        const double var_x78 = 1 / (-67.26666666666668 + 555.55555555555566 * var_chaste_interface__Ca__Ca_T + 1111.1111111111113 * var_x33);
        const double var_x79 = var_x78 * var_chaste_interface__ICaL__f;
        const double var_x80 = var_x79 * var_chaste_interface__ICaL__d;
        const double var_x81 = exp(0.074871767015605231 * var_chaste_interface__cell__V);
        const double var_x82 = -1.0 + var_x81;
        const double var_x83 = 1 / var_x82;
        const double var_x84 = var_x35 * var_x81;
        const double var_x85 = -0.61380000000000001 + 1.0 * var_x84;
        const double var_x86 = var_x83 * var_x85;
        const double var_x87 = 7.8019226357407252 * var_x86;
        const double var_x88 = -1.0 + var_x45;
        const double var_x89 = 1 / var_x88;
        const double var_x90 = var_x80 * var_x89;
        const double var_x91 = 0.75 * var_x45;
        const double var_x92 = -105.0 + var_x91 * var_chaste_interface__Na__Na_i;
        const double var_x93 = 0.0024381008236689767 * var_x92;
        const double var_x94 = -3.375 + var_x91 * var_chaste_interface__K__K_i;
        const double var_x95 = 0.00069711623550831479 * var_x94;
        const double var_x96 = var_x45 * var_chaste_interface__cell__V;
        const double var_x97 = var_x80 * var_x96 / pow(var_x88, 2);
        const double var_x98 = var_x94 * var_x97;
        const double var_x99 = var_x80 * var_chaste_interface__cell__V;
        const double var_x100 = 0.58414373385695628 * var_x99;
        const double var_x101 = var_x81 * var_x85 / pow(var_x82, 2);
        const double var_x102 = var_x92 * var_x97;
        const double var_x103 = var_x90 * var_x96;
        const double var_x104 = var_x103 * var_chaste_interface__Na__Na_i;
        const double var_x105 = var_x83 * var_x84;
        const double var_x106 = var_x103 * var_chaste_interface__K__K_i;
        const double var_x107 = -26.712338705498265 * log(140.0 * var_x57) + var_chaste_interface__cell__V;
        ...
        const double var_x111 = var_x79 * var_chaste_interface__cell__V;
        const double var_x112 = var_x111 * var_x89;
        ...
        const double var_x117 = -26.712338705498265 * log(7.0662000000000003 / var_x116) + var_chaste_interface__cell__V;
        const double var_x118 = var_x117 * var_chaste_interface__IKs__xs1;
        const double var_x119 = -13.356169352749133 * log(1.8 * var_x36) + var_chaste_interface__cell__V;
        const double var_x120 = var_x119 * var_chaste_interface__ICaT__b * var_chaste_interface__ICaT__g;
        const double var_x121 = var_x45 * pow(var_chaste_interface__Na__Na_i, 2.0);
        const double var_x122 = var_x121 * var_x52;
        const double var_x123 = var_x57 * var_x58 / (var_x62 * pow((0.01 + var_x58), 2));
        const double var_x124 = var_x55 * var_x57 * var_chaste_interface__INa__H;
        const double var_x125 = (0.14151877954204523 * var_chaste_interface__K__K_i + 0.0025940392290056888 * var_chaste_interface__Na__Na_i) / pow(var_x116, 2);
        const double var_x126 = var_x125 * var_x42;
        const double var_x127 = pow(var_x50, 2);
        const double var_x128 = var_x121 * var_x127 * var_x70;
        const double var_x129 = var_x2 * var_x9;
        const double var_x130 = var_x22 * var_x9;
        const double var_x131 = var_x7 * var_x9 * var_chaste_interface__IKr__xr;
        const double var_x132 = var_x67 * var_x9;
        const double var_x133 = 6.4983106368865622 * var_x132 - var_x16 * (1.053972635420138 * var_x18 * var_x9 + 1.6494869150645177 * var_x17 * var_x9) - 13.738155796237757 * var_x74 * var_x9;
        ...
        const double var_x143 = var_x142 / pow((-0.061440000000000002 + var_x141), 2);
        const double var_x144 = var_x143 * (-0.022755555555555557 + 0.37037037037037035 * var_x33 + 0.18518518518518517 * var_chaste_interface__Ca__Ca_T);
        ...
        const double var_x150 = var_x113 * (-555.55555555555566 - 1111.1111111111113 * var_x135 - 82.304526748971199 * var_x137) * var_chaste_interface__ICaL__f / pow((-0.060540000000000004 + var_x33 + 0.5 * var_chaste_interface__Ca__Ca_T), 2);
        const double var_x151 = var_x150 * var_x89;
        const double var_x152 = var_x151 * var_x92;
        const double var_x153 = var_x139 * var_x81 * var_x83;
        const double var_x154 = var_x153 * var_x99;
        const double var_x155 = var_x151 * var_x94;
        const double var_x156 = var_x150 * var_x86;
        ...
        const double var_x268 = sqrt(pow(var_x267, 2.0) + 0.027434842249657067 * var_chaste_interface__Ca__Ca_JSR_T);
        ...
        const double var_x276 = var_x275 * var_x80;
        const double var_x277 = 4.6323915649710559 * var_x86;
        ...
        const double var_x282 = (0.013717421124828533 - 0.092592592592592587 * pow(var_x267, 1.0)) / var_x268;
        const double var_x283 = (-0.5 - 5.4000000000000004 * var_x282) / pow((-1 + var_x266 + var_x268), 2);
        const double var_x284 = 0.00098433188611789972 * var_x55;
        const double var_x285 = 4.6140557161776547e-8 * var_x70;
        const double var_x286 = 1.4999377389423053e-7 * var_x92;
        const double var_x287 = 1.4680354103637137e-6 * var_x7;
        ...
        const double var_x292 = 4.288710868383184e-8 * var_x94;
        const double var_x293 = var_x125 * var_x290;
        const double var_x294 = 1.5380185720592184e-6 * var_x3;
        const double var_x295 = 1.5380185720592182e-8 * var_x70;
        const double var_x296 = 0.00023999003823076885 * var_x86;
        const double var_x297 = 1.796847822848032e-5 * var_x99;
        const double var_x298 = var_x139 / (-0.040040000000000006 + var_x34);
        const double var_x299 = var_x146 / pow((-0.060060000000000002 + var_x141), 2);
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0070159999999999997 + var_x42 + 2.6097162183887167e-5 * var_x98 + 0.0010652877718143633 * var_x66 + 0.16655558320535219 * var_x69 + 7.9551252454080567e-6 * var_x53 + 9.1272458415149417e-5 * var_x102 - 1.6875 * var_x63 - 0.0055199999999999997 * var_x2 - 6.8454343811362063e-5 * var_x104 - 1.684614757851118e-5 * var_x73 - 1.9572871637915374e-5 * var_x106 - 0.69834626081908679 * var_x22 - 0.00092307692307692295 * var_x65 + var_x100 * var_x101 - var_x100 * var_x105 - var_x4 * var_chaste_interface__ICaT__g - var_x56 * var_chaste_interface__INa__H - var_x71 * var_x72 - var_x75 * var_x77 - var_x8 * var_chaste_interface__IKr__xr - var_x80 * var_x87 - var_x90 * var_x93 - var_x90 * var_x95);
        ...
        IJth(rJacobian, 11, 0) = var_x272 * (-var_x278 + var_x101 * var_x280 - var_x105 * var_x280);
        IJth(rJacobian, 12, 0) = -2.4608297152947492e-7 + 5.615149446400099e-9 * var_x102 + 1.4682156444593685e-9 * var_x53 - 0.00031144876084199171 * var_x63 - 4.2113620848000749e-9 * var_x104 - 3.1091625412080743e-9 * var_x73 - var_x284 * var_chaste_interface__INa__H - var_x285 * var_x72 - var_x286 * var_x90;
        IJth(rJacobian, 13, 0) = var_x290 + 1.6055168046743987e-9 * var_x98 + 6.5537295105522939e-8 * var_x66 + 1.0246623209999443e-5 * var_x69 + 0.00020763250722799446 * var_x63 - 4.296278075471465e-5 * var_x22 - 3.3959450071067536e-7 * var_x2 - 1.2041376035057991e-9 * var_x106 - 5.6788378045263436e-8 * var_x65 - var_x287 * var_chaste_interface__IKr__xr - var_x291 * var_x75 - var_x292 * var_x90;
        IJth(rJacobian, 14, 0) = -9.277328026661204e-8 + 1.0363875137360248e-9 * var_x73 - 4.8940521481978945e-10 * var_x53 + var_x101 * var_x297 + var_x295 * var_x72 - var_x105 * var_x297 - var_x294 * var_chaste_interface__ICaT__g - var_x296 * var_x80;
        ...
        IJth(rJacobian, 12, 1) = -var_x107 * var_x284;
        ...
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x111 * var_x87 - var_x112 * var_x93 - var_x112 * var_x95);
        IJth(rJacobian, 4, 4) = -var_x214;
        IJth(rJacobian, 11, 4) = -var_x111 * var_x281;
        IJth(rJacobian, 12, 4) = -var_x112 * var_x286;
        IJth(rJacobian, 13, 4) = -var_x112 * var_x292;
        IJth(rJacobian, 14, 4) = -var_x111 * var_x296;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x114 * var_x87 - var_x115 * var_x93 - var_x115 * var_x95);
        IJth(rJacobian, 5, 5) = -0.02 - var_x218;
        IJth(rJacobian, 11, 5) = -var_x114 * var_x281;
        IJth(rJacobian, 12, 5) = -var_x115 * var_x286;
        IJth(rJacobian, 13, 5) = -var_x115 * var_x292;
        IJth(rJacobian, 14, 5) = -var_x114 * var_x296;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * var_x8);
        IJth(rJacobian, 6, 6) = -var_x233 - var_x234;
        IJth(rJacobian, 13, 6) = -var_x287 * var_x64;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x117 * var_x41);
        IJth(rJacobian, 7, 7) = -var_x248 - var_x249;
        IJth(rJacobian, 13, 7) = var_x117 * var_x289;
        ...
        IJth(rJacobian, 13, 8) = var_x118 * var_x288;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.10000000000000001 * var_x120);
        IJth(rJacobian, 9, 9) = -var_x256;
        IJth(rJacobian, 14, 9) = -3.0760371441184367e-6 * var_x120;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x119 * var_x4);
        IJth(rJacobian, 10, 10) = -var_x265;
        IJth(rJacobian, 14, 10) = -var_x119 * var_x294;
        IJth(rJacobian, 11, 11) = -0.21052631578947367 - var_x271;
        IJth(rJacobian, 14, 11) = 0.0070588235294117632;
        IJth(rJacobian, 15, 11) = -1;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (3.459874159855314 * var_x126 + 1.35e-7 * var_x128 - 0.0013500000000000001 * var_x122 - 0.10684935482199306 * var_x57 - 0.0018285756177517324 * var_x103 - 0.033750000000000002 * var_x123 - 427.39741928797224 * var_x124);
        IJth(rJacobian, 12, 12) = 2.4915900867359339e-11 * var_x128 - 2.4915900867359336e-7 * var_x122 - 6.2289752168398339e-6 * var_x123 - 6.5734516851508199e-6 * var_x57 - 0.02629380674060328 * var_x124 - 1.1249533042067289e-7 * var_x103;
        IJth(rJacobian, 13, 12) = 3.459874159855314 * var_x293 + 4.1526501445598893e-6 * var_x123;
        IJth(rJacobian, 14, 12) = 8.3053002891197791e-8 * var_x122 - 8.3053002891197795e-12 * var_x128;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (188.75472776079184 * var_x126 + 4.4490891518731663 * var_x134 - 0.00052283717663123607 * var_x103 - 18.654461852717677 * var_x130 - 0.14745210965435041 * var_x129 - 0.63742174226149029 * var_x131 - var_x133 * var_x77);
        IJth(rJacobian, 13, 13) = 188.75472776079184 * var_x293 + 0.000273711269773125 * var_x134 - 9.0713633255081308e-6 * var_x129 - 3.2165331512873877e-8 * var_x103 - 0.0011476363512500001 * var_x130 - 3.9214659113300655e-5 * var_x131 - var_x133 * var_x291;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (5.3045278730988868e-7 * var_x157 + 0.16314293740996011 * var_x144 + 2.7046242939316993 * var_x149 - 0.00025000000000000001 * var_x145 - 1.1499999999999999 * var_x140 - 1.9748616671718705e-9 * var_x152 - 7.8019226357407252 * var_x154 - 2.5874999999999999 * var_x147 - 5.6466415076173488e-10 * var_x155 - 6.3195573349499865e-6 * var_x156 + var_x148 * var_x71);
        IJth(rJacobian, 11, 14) = var_x272 * (-3.7522371676265542e-6 * var_x156 * var_x275 - 4.6323915649710559 * var_x153 * var_x279);
        IJth(rJacobian, 12, 14) = -1.214949568543267e-13 * var_x152 - 4.6140557161776547e-8 * var_x145 + var_x148 * var_x285;
        IJth(rJacobian, 13, 14) = 3.2633849539327485e-11 * var_x157 - 3.4738558033903784e-14 * var_x155;
        IJth(rJacobian, 14, 14) = 8.319524789019007e-5 * var_x149 + 1.5380185720592182e-8 * var_x145 + 5.0183373527362646e-6 * var_x144 - 0.0015981617647058825 * var_x299 - 0.00023999003823076885 * var_x154 - 3.5374427157362017e-5 * var_x140 - 1.9439193096692272e-10 * var_x156 - 7.9592461104064537e-5 * var_x147 - 0.00071029411764705886 * var_x298 - var_x148 * var_x295;
        IJth(rJacobian, 16, 14) = 0.0087500000000000008 * var_x298 + 0.0196875 * var_x299;
        IJth(rJacobian, 11, 15) = 8.8802252544942608e-5 * var_x283 * (-var_chaste_interface__Irel__Rel - var_x278 * var_chaste_interface__cell__V) + 1.4297504830157579 * var_x269 * var_x272 * var_x273 * var_x283 * var_x86 * var_x99 / pow(var_x274, 2);
