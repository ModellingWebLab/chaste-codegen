...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliyer_model_2007FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x12 = 0.0004330402307852333 * var_x11;
        ...
        const double var_x16 = 0.0004330402307852333 * var_x15;
        ...
        const double var_x28 = var_x24 * (0.026206040385622558 * var_x26 + 63951.978042015005 * var_x27);
        ...
        const double var_x30 = var_x5 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
        const double var_x31 = 0.00015031321966819388 * var_x2;
        const double var_x32 = var_x0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai;
        const double var_x33 = -138.0 + var_x32;
        const double var_x34 = 3.0062643933638775e-6 * var_x33;
        const double var_x35 = 1 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai;
        const double var_x36 = pow(var_x35, 1.5);
        const double var_x37 = exp(-0.0037437200550889376 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x38 = (-0.14285714285714285 + 0.14285714285714285 * exp(2.0505200594353643)) * exp(-0.049791476732682867 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x39 = 1.0 + 0.1245 * var_x37 + 0.036499999999999998 * var_x38;
        const double var_x40 = (0.0018173889007429246 * var_x38 + 0.00046609314685857272 * var_x37) / (pow(var_x39, 2) * (1.0 + 89.442719099991592 * var_x36));
        const double var_x41 = 2.0 * var_x26 - 2628072.0 * var_x27;
        const double var_x42 = var_x22 * var_x41 / pow(var_x23, 2);
        const double var_x43 = exp(0.074874401101778745 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x44 = -1.0 + var_x43;
        const double var_x45 = 1 / var_x44;
        const double var_x46 = -0.68200000000000005 + 0.001 * var_x43;
        const double var_x47 = var_x45 * var_x46;
        const double var_x48 = var_x47 * var_x6;
        const double var_x49 = var_x10 * var_x9 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
        const double var_x50 = var_x2 * var_x49;
        const double var_x51 = var_x33 * var_x49;
        const double var_x52 = var_x30 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x53 = var_x1 * var_x52;
        const double var_x54 = var_x43 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x55 = var_x45 * var_x54;
        const double var_x56 = var_x55 * var_x6;
        const double var_x57 = var_x32 * var_x52;
        const double var_x58 = var_x46 * var_x54 / pow(var_x44, 2);
        const double var_x59 = var_x58 * var_x6;
        const double var_x60 = -0.0010768399999999999 + 5.6273061501680632e-6 * var_x50 + 0.01182150430414204 * var_x29 + 1.8700066983974479 * var_x59 + 1.1254612300336127e-7 * var_x51 - 0.077520800000000001 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - 0.00019735863638148724 * var_x28 - 0.25061025223761602 * var_x21 - 0.018599999999999998 * var_chaste_interface__IKr__OHerg - 24.975247492871411 * var_x48 - 1.736 * var_x40 - 56.32 * var_chaste_interface__INa__na6 - 56.32 * var_chaste_interface__INa__na7 - 0.0035000000000000001 * var_chaste_interface__IKs__O1ks - 0.0035000000000000001 * var_chaste_interface__IKs__O2ks - 5.6273061501680632e-6 * var_x53 - 0.001870006698397448 * var_x56 - 9.6051213058629261e-7 * var_x42 - 1.1254612300336127e-7 * var_x57 - var_x30 * var_x31 - var_x30 * var_x34;
        const double var_x61 = var_x47 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x62 = 24.975247492871411 * var_x61;
        const double var_x63 = var_x62 >= 0.0;
        const double var_x64 = 1 / (1.0 - 94.246216954231727 * var_x61);
        const double var_x65 = var_x14 * var_x2 * (94.246216954231727 * var_x47 + 0.0070566290505564072 * var_x55 - 7.0566290505564071 * var_x58) / pow((0.010610505464485906 - var_x61), 2);
        const double var_x66 = var_x35 * (var_chaste_interface__INa__na6 + var_chaste_interface__INa__na7);
        const double var_x67 = var_x24 * var_x25 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai, 2.0);
        const double var_x68 = var_x10 * var_x30;
        const double var_x69 = var_x35 * var_x36 / (var_x39 * pow((0.011180339887498949 + var_x36), 2));
        const double var_x70 = var_x0 * var_x14;
        const double var_x71 = 0.011567110371850329 * var_x70;
        const double var_x72 = var_x17 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43;
        ...
        const double var_x75 = var_x17 * var_chaste_interface__IKr__OHerg;
        const double var_x76 = var_x17 * var_x29;
        const double var_x77 = 0.31576891781939614 * var_x76 - 0.00015031321966819388 * var_x68 - 2.0706890167875649 * var_x72 - 0.093489896373056991 * var_x73 - 6.6941504319201135 * var_x74 - 0.49683202072538857 * var_x75;
        ...
        const double var_x81 = var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai / pow(var_x79, 2);
        const double var_x82 = var_x22 * var_x24;
        const double var_x83 = -var_x62 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa;
        ...
        const double var_x86 = -var_x62 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open;
        const double var_x87 = var_x84 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open;
        const double var_x88 = log(138.0 * var_x35);
        const double var_x89 = 1504.3859896373058 * var_x88 - 56.32 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x90 = 0.093489896373056991 * var_x18 - 0.0035000000000000001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x91 = 1.8494079065353101e-10 * var_x33;
        const double var_x92 = 0.092547526753060966 * var_x88 - 0.0034647203195431434 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x93 = 7.1159095070575419e-7 * var_x2;
        const double var_x94 = var_x7 * var_x93;
        const double var_x95 = 2.6639973131769352e-8 * var_x11;
        const double var_x96 = 2.6639973131769352e-8 * var_x15;
        const double var_x97 = 9.2470395326765502e-9 * var_x2;
        const double var_x98 = 0.00021359213333547216 * var_x40 + 3.4618327348681436e-10 * var_x50 + 7.272408766002779e-7 * var_x29 - 2.1531465053979051e-7 * var_chaste_interface__IKs__O1ks - 2.1531465053979051e-7 * var_chaste_interface__IKs__O2ks - 1.5417159680637441e-5 * var_x21 - 1.1442435714400293e-6 * var_chaste_interface__IKr__OHerg - 4.7689611318757119e-6 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - 3.4618327348681436e-10 * var_x53 - var_x30 * var_x97;
        const double var_x99 = 7.1159095070575419e-7 * var_x70;
        const double var_x100 = 1.9425621197603171e-5 * var_x76 - 9.2470395326765502e-9 * var_x68 - 5.7513555333045702e-6 * var_x73 - 0.00041181390311704769 * var_x74 - 3.0564346548418563e-5 * var_x75 - 0.00012738562343605627 * var_x72;
        const double var_x101 = var_x13 * var_x93;
        const double var_x102 = var_x101 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa;
        const double var_x103 = var_x101 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open;
        const double var_x104 = 5.7513555333045702e-6 * var_x18 - 2.1531465053979051e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x105 = 0.0023800000000000002 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x106 = 1.0 + 0.00011900000000000002 * pow(var_x105, (-2.0));
        const double var_x107 = 1 / var_x106;
        const double var_x108 = 1.0 * var_x107;
        const double var_x109 = 1.5379617895699322e-6 * var_x80;
        const double var_x110 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai, 1.2);
        const double var_x111 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaNSR, 1.0);
        const double var_x112 = 1 / (1.0 + 33855.471141425071 * var_x110 + 0.303951367781155 * var_x111);
        ...
        const double var_x115 = 2.5323892413785956 * var_x110 - 9.6656534954407287e-5 * var_x111;
        const double var_x116 = var_x115 / pow((2.9537323401073992e-5 + var_x110 + 8.9779098483507582e-6 * var_x111), 2);
        const double var_x117 = var_x113 * var_x116;
        const double var_x118 = 2.8000000000000003 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x119 = 0.0023800000000000002 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x120 = 1.0 + 0.00011900000000000002 * pow(var_x119, (-2.0));
        const double var_x121 = 1 / var_x120;
        const double var_x122 = 1.0 * var_x121;
        const double var_x123 = -var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR;
        const double var_x124 = var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR + var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O2_RyR;
        const double var_x125 = 240.00000000000003 * var_x124;
        const double var_x126 = 16.54232713906077 * var_x61;
        const double var_x127 = 240.00000000000003 * var_x121 * var_x123;
        const double var_x128 = var_x121 * var_x126;
        const double var_x129 = 0.80000000000000004 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR;
        const double var_x130 = pow(var_x129, (-2.0));
        const double var_x131 = 1 / (1.0 + 6.0 * var_x130);
        const double var_x132 = 1.8 * var_x131;
        const double var_x133 = -var_x123 * var_x132;
        const double var_x134 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 3.0);
        const double var_x135 = 1 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR;
        const double var_x136 = pow(var_x135, 2.5);
        const double var_x137 = 1.0 + 1.0 * var_x136;
        const double var_x138 = 1 / var_x137;
        const double var_x139 = 0.5 + 4.5 * var_x138;
        const double var_x140 = 48600000000.0 * var_x134 * var_x139 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C1_RyR;
        const double var_x141 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 4.0);
        const double var_x142 = var_x135 * var_x136 / pow(var_x137, 2);
        const double var_x143 = 136687500000.0 * var_x141 * var_x142 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C1_RyR;
        const double var_x144 = 12150000000.0 * var_x139 * var_x141;
        ...
        const double var_x146 = 4050000.0 * var_x134;
        const double var_x147 = 0.0090000000000000011 * var_x142 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C2_RyR;
        const double var_x148 = 0.055555555555555559 * var_x142 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR / pow((0.1111111111111111 + var_x138), 2);
        const double var_x149 = 0.0036000000000000003 * var_x138;
        const double var_x150 = 0.10000000000000001 / var_x139;
        const double var_x151 = exp(1.4300000000000002 - 0.065000000000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x152 = 0.0057330000000000002 * var_x151;
        const double var_x153 = exp(-0.41999999999999998 + 0.012 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x154 = 0.095846399999999998 * var_x153;
        const double var_x155 = var_x154 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C0;
        const double var_x156 = 0.055397999999999996 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C0;
        const double var_x157 = 7.9871999999999996 * var_x153;
        ...
        const double var_x160 = 0.088200000000000001 * var_x151;
        const double var_x161 = 0.071884799999999999 * var_x153;
        const double var_x162 = 0.011466 * var_x151;
        const double var_x163 = 0.11079599999999999 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1;
        const double var_x164 = -var_x160;
        const double var_x165 = 5.9903999999999993 * var_x153;
        const double var_x166 = 0.11079599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x167 = 0.1764 * var_x151;
        const double var_x168 = 0.047923199999999999 * var_x153;
        const double var_x169 = -var_x168;
        const double var_x170 = 0.017198999999999999 * var_x151;
        const double var_x171 = 0.22159199999999998 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2;
        const double var_x172 = -var_x167;
        const double var_x173 = 3.9935999999999998 * var_x153;
        const double var_x174 = -var_x173;
        const double var_x175 = 0.22159199999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x176 = 0.2646 * var_x151;
        const double var_x177 = 0.0239616 * var_x153;
        const double var_x178 = 0.022932000000000001 * var_x151 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C4;
        const double var_x179 = 0.44318399999999997 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        const double var_x180 = 1.9967999999999999 * var_x153;
        const double var_x181 = 0.44318399999999997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x182 = 0.3528 * var_x151;
        const double var_x183 = 0.88636799999999993 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C4;
        const double var_x184 = 0.88636799999999993 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x185 = 0.0028665000000000001 * var_x151;
        const double var_x186 = 0.1916928 * var_x153 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa0;
        const double var_x187 = 15.974399999999999 * var_x153;
        const double var_x188 = 0.0441 * var_x151;
        const double var_x189 = 0.1437696 * var_x153;
        const double var_x190 = 11.980799999999999 * var_x153;
        const double var_x191 = 0.0085994999999999995 * var_x151;
        const double var_x192 = 0.1323 * var_x151;
        const double var_x193 = var_x162 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa4;
        const double var_x194 = exp(-0.02019777813343069 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x195 = exp(-0.18053804430634462 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x196 = 0.5 + var_x195;
        const double var_x197 = exp(3.6538461538461537 + 0.12820512820512822 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = 0.0033633620945199998 / var_x196;
        const double var_x200 = 0.0077904657073700001 * var_x194;
        const double var_x201 = exp(5.3739999999999997e-8 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x202 = 4.4038962679999997e-11 * var_x201;
        const double var_x203 = exp(0.028982999999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x204 = 0.063033155855999987 * var_x203;
        const double var_x205 = exp(-0.00037301599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x206 = 1.8592012678400001e-5 * var_x205;
        const double var_x207 = exp(-0.046843700000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x208 = 0.0037561620845000003 * var_x207;
        const double var_x209 = 2.1748319999999999 * var_x203;
        const double var_x210 = 0.00081948199999999996 * var_x201;
        const double var_x211 = 0.080185000000000006 * var_x207;
        const double var_x212 = 0.049842400000000002 * var_x205;
        const double var_x213 = 8.3392179730847992e-11 * var_x201;
        const double var_x214 = 0.047274866891999993 * var_x203;
        const double var_x215 = 2.7448243264023808e-6 * var_x205;
        const double var_x216 = 0.0075123241690000005 * var_x207;
        const double var_x217 = 1.6311239999999998 * var_x203;
        const double var_x218 = 0.0015517711151999999 * var_x201;
        const double var_x219 = 0.16037000000000001 * var_x207;
        const double var_x220 = 0.0073584627104531196 * var_x205;
        const double var_x221 = 0.031516577927999993 * var_x203;
        const double var_x222 = 6.2643871845094088e-10 * var_x201;
        const double var_x223 = 1.190172890246627e-6 * var_x205;
        const double var_x224 = 0.011268486253500002 * var_x207;
        const double var_x225 = 0.011656842546537791 * var_x201;
        const double var_x226 = 1.0874159999999999 * var_x203;
        const double var_x227 = 0.24055500000000002 * var_x207;
        const double var_x228 = 0.0031906751727717496 * var_x205;
        const double var_x229 = 0.015758288963999997 * var_x203;
        const double var_x230 = 6.9834511318773681e-9 * var_x201;
        const double var_x231 = 6.466053749793811e-7 * var_x205;
        const double var_x232 = 0.015024648338000001 * var_x207;
        const double var_x233 = 0.12994884875097448 * var_x201;
        const double var_x234 = 0.54370799999999997 * var_x203;
        const double var_x235 = 0.32074000000000003 * var_x207;
        const double var_x236 = 0.0017334521172801731 * var_x205;
        const double var_x237 = 6.2947815902170848e-9 * var_x201;
        const double var_x238 = 3.5441967137821161e-8 * var_x205;
        const double var_x239 = 0.11713400800552819 * var_x201;
        const double var_x240 = 9.5014602960251466e-5 * var_x205;
        const double var_x241 = 0.42695382052749881 * var_x203;
        const double var_x242 = 0.00198360904335657 * var_x207;
        const double var_x243 = 14.731181055359999 * var_x203;
        const double var_x244 = 0.042345268272074361 * var_x207;
        const double var_x245 = 0.10902718902100607 * var_x203;
        const double var_x246 = 0.0010000484785595239 * var_x207;
        const double var_x247 = 3.7617634137599998 * var_x203;
        const double var_x248 = 0.021348622729620501 * var_x207;
        const double var_x249 = 0.058010926130094301 * var_x203;
        const double var_x250 = 0.0010108205748447618 * var_x207;
        const double var_x251 = 2.0015500855706554 * var_x203;
        const double var_x252 = 0.021578581001175438 * var_x207;
        const double var_x253 = 0.2874951693560841 * var_x203;
        const double var_x254 = 0.016668393642939261 * var_x207;
        const double var_x255 = 9.9194413744637924 * var_x203;
        const double var_x256 = 0.35582999726621212 * var_x207;
        const double var_x257 = exp(-0.077933781739999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x258 = 0.00084304739027167303 * var_x257;
        const double var_x259 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x260 = 0.056565877361888978 * var_x259 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C0Kv14;
        const double var_x261 = 7.3600965821599997 * var_x259;
        const double var_x262 = 0.010817483399999999 * var_x257;
        const double var_x263 = 0.042424408021416733 * var_x259;
        const double var_x264 = 0.0016860947805433461 * var_x257;
        const double var_x265 = 5.5200724366199996 * var_x259;
        const double var_x266 = 0.021634966799999999 * var_x257;
        const double var_x267 = 0.028282938680944489 * var_x259;
        const double var_x268 = 0.0025291421708150191 * var_x257;
        const double var_x269 = 3.6800482910799999 * var_x259;
        const double var_x270 = 0.032452450199999996 * var_x257;
        const double var_x271 = 0.014141469340472244 * var_x259;
        const double var_x272 = 0.0033721895610866921 * var_x257 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
        const double var_x273 = 1.8400241455399999 * var_x259;
        const double var_x274 = 0.043269933599999998 * var_x257;
        const double var_x275 = 0.0016068735371190899 * var_x257;
        const double var_x276 = 0.057102035392881494 * var_x259 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI0Kv14;
        const double var_x277 = 7.4298590445392074 * var_x259;
        const double var_x278 = 0.020618446856331008 * var_x257;
        const double var_x279 = 0.049212749503964474 * var_x259;
        const double var_x280 = 5.0494790920257417e-5 * var_x257;
        const double var_x281 = 6.4033407827395079 * var_x259;
        const double var_x282 = 0.00064791916666788224 * var_x257;
        const double var_x283 = 0.015434242075859547 * var_x259;
        const double var_x284 = 4.7206750348744701e-5 * var_x257;
        const double var_x285 = 2.0082338973371914 * var_x259;
        const double var_x286 = 0.0006057289829234033 * var_x257;
        const double var_x287 = 0.04692272136005015 * var_x259;
        const double var_x288 = 5.7810813021376416e-5 * var_x257 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OIKv14;
        const double var_x289 = 6.1053726595326019 * var_x259;
        const double var_x290 = 0.00074179401705723534 * var_x257;
        ...
        const double var_x292 = 384756192.24456543 * var_x291 * var_chaste_interface__INa__na1;
        const double var_x293 = exp(-26.232056238852355 - 0.090161609404259865 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x294 = 767594485.71651864 * var_x293;
        const double var_x295 = exp(-23.156677820503312);
        const double var_x296 = 8513540195.0827656 * var_x295;
        const double var_x297 = 34054160780.331062 * var_x291;
        const double var_x298 = 8513540195.0827656 * var_x293;
        const double var_x299 = exp(-24.351833000860694);
        const double var_x300 = 8513540195.0827656 * var_x299;
        const double var_x301 = 288567144.18342406 * var_x291;
        const double var_x302 = 1535188971.4330373 * var_x293;
        const double var_x303 = 11922585210.267752 * var_x295;
        const double var_x304 = 25540620585.248295 * var_x291;
        const double var_x305 = 17027080390.165531 * var_x293;
        const double var_x306 = 6079249204.347868 * var_x299;
        const double var_x307 = 192378096.12228271 * var_x291;
        const double var_x308 = 2302783457.1495557 * var_x293;
        const double var_x309 = 17027080390.165531 * var_x291;
        const double var_x310 = 16696701353.239271 * var_x295;
        const double var_x311 = 25540620585.248295 * var_x293;
        const double var_x312 = 4340999166.2352047 * var_x299;
        const double var_x313 = 96189048.061141357 * var_x291;
        const double var_x314 = 3070377942.8660746 * var_x293;
        const double var_x315 = 8513540195.0827656 * var_x291;
        const double var_x316 = 23382498943.197018 * var_x295;
        const double var_x317 = 34054160780.331062 * var_x293;
        const double var_x318 = 3099769910.3661275 * var_x299;
        const double var_x319 = exp(-19.672905196314272 + 0.08427205410463634 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x320 = 717453519.942011 * var_x319;
        const double var_x321 = exp(-16.535928437145479 + 0.10971319924442288 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x322 = 934047731.69851828 * var_x321;
        const double var_x323 = exp(-27.092641999412574 - 0.061469636400174381 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x324 = 523324220.27000725 * var_x323;
        const double var_x325 = exp(-26.358496255772216 - 0.068762962366201302 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x326 = 585416244.03761828 * var_x325 * var_chaste_interface__INa__na7;
        const double var_x327 = 32745465422.278648 * var_x295;
        const double var_x328 = 8513540195.0827656 * var_x321;
        const double var_x329 = 8513540195.0827656 * var_x319;
        const double var_x330 = 8513540195.0827656 * var_x323;
        const double var_x331 = 8513540195.0827656 * var_x325;
        const double var_x332 = 2213447441.3051791 * var_x299;
        const double var_x333 = exp(-20.672646495412604 + 0.011394696340402197 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x334 = 97009205.304776594 * var_x333;
        const double var_x335 = exp(-39.744904705650839 + 0.0027019947965296331 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x336 = 23003541.30715951 * var_x335;
        const double var_x337 = 8513540195.0827656 * exp(-26.650781465416163);
        const double var_x338 = 8513540195.0827656 * var_x333;
        const double var_x339 = 8513540195.0827656 * exp(-22.779658962607591);
        const double var_x340 = 8513540195.0827656 * var_x335;
        const double var_x341 = 538822673.3061657 * var_x291 * var_chaste_interface__INa__na8;
        const double var_x342 = 548114892.23356998 * var_x293;
        const double var_x343 = 47690340841.071007 * var_x291;
        const double var_x344 = 6079249204.347868 * var_x293;
        const double var_x345 = 404117004.97962427 * var_x291;
        const double var_x346 = 1096229784.46714 * var_x293;
        const double var_x347 = 35767755630.803253 * var_x291;
        const double var_x348 = 12158498408.695736 * var_x293;
        const double var_x349 = 269411336.65308285 * var_x291;
        const double var_x350 = 1644344676.7007098 * var_x293;
        const double var_x351 = 23845170420.535503 * var_x291;
        const double var_x352 = 18237747613.043602 * var_x293;
        const double var_x353 = 134705668.32654142 * var_x291;
        const double var_x354 = 2192459568.9342799 * var_x293;
        const double var_x355 = 11922585210.267752 * var_x291;
        const double var_x356 = 24316996817.391472 * var_x293;
        const double var_x357 = exp(-21.94926195979755 + 0.030147161449011889 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x358 = 256659070.7638123 * var_x357;
        const double var_x359 = exp(-38.483942906307405 - 0.14399668707161886 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x360 = 1225921583.3429821 * var_x359;
        const double var_x361 = 8513540195.0827656 * var_x357;
        const double var_x362 = 8513540195.0827656 * var_x359;
        const double var_x363 = exp(-0.043060541639799998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x364 = 0.0090930200797394306 * var_x363 * var_chaste_interface__IKr__C2Herg;
        ...
        const double var_x367 = 0.091225454037165171 * var_x365;
        const double var_x368 = 0.21116826991639448 * var_x363;
        const double var_x369 = exp(6.9808923999999997e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x370 = 2.9856908086401855e-10 * var_x369;
        const double var_x371 = 0.026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x372 = exp(var_x371);
        const double var_x373 = 0.0028649222200750734 * var_x372;
        const double var_x374 = exp(-0.026913854983990002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x375 = 0.0001923883999223735 * var_x374;
        const double var_x376 = exp(-0.045366429595429997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x377 = 0.0056890885971700002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x378 = var_x369 * var_x374 * var_x376 * exp(-var_x371) * exp(-var_x377);
        const double var_x379 = 0.10945626585855089 * var_x372;
        const double var_x380 = 0.00042769471831999382 * var_x369;
        const double var_x381 = 0.0071483033566472664 * var_x374;
        const double var_x382 = 1.6926962184371784e-6 * var_x378;
        const double var_x383 = exp(var_x377);
        const double var_x384 = 0.0032282621593045183 * var_x383;
        const double var_x385 = 0.0015600678590465681 * var_x376;
        const double var_x386 = 0.56744803744318484 * var_x383;
        const double var_x387 = 0.034388156021070745 * var_x376;
        const double var_x388 = exp(-1.8891230210000001e-5 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x389 = 4.0853373267232939e-6 * var_x388 * var_chaste_interface__IKs__C1ks;
        const double var_x390 = 0.21625575895849999 * var_x388;
        const double var_x391 = exp(-0.14999754700285001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x392 = 0.0010511927526268654 * var_x391;
        const double var_x393 = 0.0070080662892900002 * var_x391;
        const double var_x394 = exp(0.08662945914655 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x395 = 0.00066466830499978399 * var_x394;
        const double var_x396 = exp(-0.014256681268810001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x397 = 5.4138036083884682e-5 * var_x396 * var_chaste_interface__IKs__O2ks;
        const double var_x398 = 0.00767254363063 * var_x394;
        const double var_x399 = 0.0037973799836799999 * var_x396;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x63) ? (var_x12 + var_x60 - var_x16 - var_x8) : (var_x60 - 1.3022579767677213e-6 * var_x65 + var_x12 * var_x64 - var_x16 * var_x64 - var_x64 * var_x8)));
        IJth(rJacobian, 1, 0) = -6.1518471582797284e-8 + 6.923665469736287e-12 * var_x51 - 3.6423604991562432e-8 * var_x28 - 0.00032038820000320829 * var_x40 - 0.0034647203195431434 * var_chaste_interface__INa__na6 - 0.0034647203195431434 * var_chaste_interface__INa__na7 - 6.923665469736287e-12 * var_x57 - 1.7726771463121474e-10 * var_x42 - var_x30 * var_x91;
        IJth(rJacobian, 2, 0) = ((var_x63) ? (var_x95 + var_x98 - var_x94 - var_x96) : (var_x98 - 8.0112920337256141e-11 * var_x65 + var_x64 * var_x95 - var_x64 * var_x94 - var_x64 * var_x96));
        IJth(rJacobian, 3, 0) = var_x108 * (-2.3635396782110719e-9 + 1.2141201663854145e-8 * var_x28 + 5.9089238210404917e-11 * var_x42);
        IJth(rJacobian, 4, 0) = var_x122 * (1.2385968373668761 * var_x59 - 16.54232713906077 * var_x48 - 0.0012385968373668762 * var_x56);
        IJth(rJacobian, 13, 0) = -var_x155 - var_x152 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1;
        IJth(rJacobian, 14, 0) = var_x155 + (var_x152 - var_x161) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1 - var_x162 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2;
        IJth(rJacobian, 15, 0) = var_x161 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1 + (var_x162 + var_x169) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2 - var_x170 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        IJth(rJacobian, 16, 0) = -var_x178 + var_x168 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2 + (var_x170 - var_x177) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        IJth(rJacobian, 17, 0) = var_x178 + var_x177 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        IJth(rJacobian, 18, 0) = -var_x186 - var_x185 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa1;
        IJth(rJacobian, 19, 0) = var_x186 + (var_x185 - var_x189) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa1 - var_x152 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa2;
        IJth(rJacobian, 20, 0) = var_x189 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa1 + (var_x152 - var_x154) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa2 - var_x191 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa3;
        IJth(rJacobian, 21, 0) = -var_x193 + var_x154 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa2 + (var_x169 + var_x191) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa3;
        IJth(rJacobian, 22, 0) = var_x193 + var_x168 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa3;
        IJth(rJacobian, 24, 0) = (-0.00015735009791355945 * var_x194 + 0.00060721481483873177 * var_x195 / pow(var_x196, 2)) * (0.18000000000000005 - var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa + 0.81999999999999995 / var_x198) - 0.10512820512820513 * var_x197 * (var_x199 + var_x200) / pow(var_x198, 2);
        IJth(rJacobian, 25, 0) = (-var_x202 - var_x204) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 - var_x206 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 - var_x208 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43;
        IJth(rJacobian, 26, 0) = var_x204 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 + (var_x208 - var_x213 - var_x214) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 - var_x215 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 - var_x216 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43;
        IJth(rJacobian, 27, 0) = var_x214 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 + (var_x216 - var_x221 - var_x222) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 - var_x223 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43 - var_x224 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43;
        IJth(rJacobian, 28, 0) = var_x221 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 + (var_x224 - var_x229 - var_x230) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 - var_x231 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43 - var_x232 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43;
        IJth(rJacobian, 29, 0) = var_x229 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 + (var_x232 - var_x237) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - var_x238 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OIKv43;
        IJth(rJacobian, 30, 0) = var_x202 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 + (var_x206 - var_x241) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 - var_x242 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43;
        IJth(rJacobian, 31, 0) = var_x213 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 + var_x241 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 + (var_x215 + var_x242 - var_x245) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 - var_x246 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43;
        IJth(rJacobian, 32, 0) = var_x222 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 + var_x245 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 + (var_x223 + var_x246 - var_x249) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43 - var_x250 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43;
        IJth(rJacobian, 33, 0) = var_x230 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 + var_x249 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43 + (var_x231 + var_x250 - var_x253) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43 - var_x254 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OIKv43;
        IJth(rJacobian, 34, 0) = var_x237 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 + var_x253 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43 + (var_x238 + var_x254) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OIKv43;
        IJth(rJacobian, 35, 0) = -var_x260 - var_x258 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C1Kv14;
        IJth(rJacobian, 36, 0) = var_x260 + (var_x258 - var_x263) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C1Kv14 - var_x264 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C2Kv14;
        IJth(rJacobian, 37, 0) = var_x263 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C1Kv14 + (var_x264 - var_x267) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C2Kv14 - var_x268 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C3Kv14;
        IJth(rJacobian, 38, 0) = -var_x272 + var_x267 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C2Kv14 + (var_x268 - var_x271) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C3Kv14;
        IJth(rJacobian, 39, 0) = var_x272 + var_x271 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C3Kv14;
        IJth(rJacobian, 40, 0) = -var_x276 - var_x275 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI1Kv14;
        IJth(rJacobian, 41, 0) = var_x276 + (var_x275 - var_x279) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI1Kv14 - var_x280 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI2Kv14;
        IJth(rJacobian, 42, 0) = var_x279 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI1Kv14 + (var_x280 - var_x283) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI2Kv14 - var_x284 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI3Kv14;
        IJth(rJacobian, 43, 0) = -var_x288 + var_x283 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI2Kv14 + (var_x284 - var_x287) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI3Kv14;
        IJth(rJacobian, 44, 0) = var_x288 + var_x287 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI3Kv14;
        IJth(rJacobian, 45, 0) = -var_x292 - var_x294 * var_chaste_interface__INa__na2;
        IJth(rJacobian, 46, 0) = var_x292 + (var_x294 - var_x301) * var_chaste_interface__INa__na2 - var_x302 * var_chaste_interface__INa__na3;
        IJth(rJacobian, 47, 0) = var_x301 * var_chaste_interface__INa__na2 + (var_x302 - var_x307) * var_chaste_interface__INa__na3 - var_x308 * var_chaste_interface__INa__na4;
        IJth(rJacobian, 48, 0) = var_x307 * var_chaste_interface__INa__na3 + (var_x308 - var_x313) * var_chaste_interface__INa__na4 - var_x314 * var_chaste_interface__INa__na5;
        IJth(rJacobian, 49, 0) = -var_x326 + var_x313 * var_chaste_interface__INa__na4 + (var_x314 - var_x320 - var_x322) * var_chaste_interface__INa__na5 - var_x324 * var_chaste_interface__INa__na6;
        IJth(rJacobian, 50, 0) = var_x322 * var_chaste_interface__INa__na5 + var_x336 * var_chaste_interface__INa__na13 + (var_x324 - var_x334) * var_chaste_interface__INa__na6;
        IJth(rJacobian, 51, 0) = var_x326 + var_x320 * var_chaste_interface__INa__na5;
        IJth(rJacobian, 52, 0) = -var_x341 - var_x342 * var_chaste_interface__INa__na9;
        IJth(rJacobian, 53, 0) = var_x341 + (var_x342 - var_x345) * var_chaste_interface__INa__na9 - var_x346 * var_chaste_interface__INa__na10;
        IJth(rJacobian, 54, 0) = var_x345 * var_chaste_interface__INa__na9 + (var_x346 - var_x349) * var_chaste_interface__INa__na10 - var_x350 * var_chaste_interface__INa__na11;
        IJth(rJacobian, 55, 0) = var_x349 * var_chaste_interface__INa__na10 + (var_x350 - var_x353) * var_chaste_interface__INa__na11 - var_x354 * var_chaste_interface__INa__na12;
        IJth(rJacobian, 56, 0) = var_x353 * var_chaste_interface__INa__na11 + (var_x354 - var_x358) * var_chaste_interface__INa__na12 - var_x360 * var_chaste_interface__INa__na13;
        IJth(rJacobian, 57, 0) = var_x334 * var_chaste_interface__INa__na6 + var_x358 * var_chaste_interface__INa__na12 + (var_x360 - var_x336) * var_chaste_interface__INa__na13;
        IJth(rJacobian, 58, 0) = -var_x364 - var_x366;
        IJth(rJacobian, 59, 0) = var_x364 + var_x366;
        IJth(rJacobian, 60, 0) = (-var_x370 - var_x373) * var_chaste_interface__IKr__C3Herg - var_x375 * var_chaste_interface__IKr__OHerg - 1.7628212752661065e-7 * var_x378 * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 61, 0) = var_x373 * var_chaste_interface__IKr__C3Herg + (var_x375 - var_x384) * var_chaste_interface__IKr__OHerg - var_x385 * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 62, 0) = var_x370 * var_chaste_interface__IKr__C3Herg + var_x384 * var_chaste_interface__IKr__OHerg + (var_x385 + 1.7628212752661065e-7 * var_x378) * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 63, 0) = -var_x389;
        IJth(rJacobian, 64, 0) = var_x389 - var_x392 * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 65, 0) = -var_x397 + (var_x392 - var_x395) * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 66, 0) = var_x397 + var_x395 * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-0.026711398963730572 * var_x35 - 0.0011841518182889234 * var_x67 - 3.0062643933638775e-6 * var_x68 - 1504.3859896373058 * var_x66 - 0.029113605067047261 * var_x69);
        IJth(rJacobian, 1, 1) = -1.8494079065353101e-10 * var_x68 - 1.64324443808702e-6 * var_x35 - 2.1854162994937459e-7 * var_x67 - 0.092547526753060966 * var_x66 - 5.3730734579697901e-6 * var_x69;
        IJth(rJacobian, 2, 1) = 3.5820489719798596e-6 * var_x69;
        IJth(rJacobian, 3, 1) = 7.2847209983124865e-8 * var_x107 * var_x67;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x63) ? (var_x77 - var_x71) : (var_x77 - var_x64 * var_x71)));
        IJth(rJacobian, 2, 2) = ((var_x63) ? (var_x100 - var_x99) : (var_x100 - var_x64 * var_x99));
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (0.050000000000000003 * var_x81 + 518.67270623236789 * var_x82 - 0.0010262519481865286 * var_x78 - 0.050000000000000003 * var_x80);
        IJth(rJacobian, 1, 3) = 0.095723856417385469 * var_x82;
        IJth(rJacobian, 3, 3) = var_x108 * (-5.6374531835205994 - var_x109 + 1.5379617895699322e-6 * var_x81 + 2.8000000000000003 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa + 2.8000000000000003 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa + 4.2533745697546545e-5 * var_x117 - 3.1566725655651652e-8 * var_x78 - 0.03190795213912849 * var_x82 - 3.6466405075851775 * var_x114) + 0.00023800000000000004 * pow(var_x105, (-3.0)) * (0.0028000000000000004 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa + 3.1566725655651652e-8 * log(2.0 * var_x78) + 0.037453183520599252 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS + 9.2400000000000013e-6 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa - 2.3635396782110719e-9 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V - 0.037453183520599252 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - var_x109 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - var_x118 * (1.0 - var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa) - var_x118 * (1.0 - var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa) + 1.2141201663854145e-8 * var_x24 * var_x41 - 1.2 * var_x112 * var_x115) / pow(var_x106, 2);
        IJth(rJacobian, 4, 3) = 806.4918851435707 * var_x121;
        IJth(rJacobian, 6, 3) = 44.871043198095705 * var_x114 - 0.00052336761372600129 * var_x117;
        ...
        IJth(rJacobian, 3, 4) = 0.037453183520599252 * var_x107;
        IJth(rJacobian, 4, 4) = var_x122 * (-806.4918851435707 - 240.00000000000003 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR - 240.00000000000003 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O2_RyR) + 0.00023800000000000004 * pow(var_x119, (-3.0)) * (806.4918851435707 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - 806.4918851435707 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS + var_x123 * var_x125 - var_x126 * var_x6) / pow(var_x120, 2);
        IJth(rJacobian, 5, 4) = -var_x132 * (-var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR - var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O2_RyR);
        IJth(rJacobian, 9, 4) = -var_x140;
        IJth(rJacobian, 10, 4) = var_x145;
        IJth(rJacobian, 12, 4) = var_x140 - var_x145;
        IJth(rJacobian, 13, 4) = -var_x156;
        IJth(rJacobian, 14, 4) = -var_x163;
        IJth(rJacobian, 15, 4) = -var_x171;
        IJth(rJacobian, 16, 4) = -var_x179;
        IJth(rJacobian, 17, 4) = -var_x183;
        IJth(rJacobian, 18, 4) = var_x156;
        IJth(rJacobian, 19, 4) = var_x163;
        IJth(rJacobian, 20, 4) = var_x171;
        IJth(rJacobian, 21, 4) = var_x179;
        IJth(rJacobian, 22, 4) = var_x183;
        IJth(rJacobian, 4, 5) = var_x121 * var_x125;
        IJth(rJacobian, 5, 5) = 1.0 * var_x131 * (-1.7400382808421786 - 1.8 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR - 1.8 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O2_RyR) + 0.33333333333333331 * pow(var_x129, (-3.0)) * (1.7400382808421786 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaNSR - 1.7400382808421786 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR - 1.8 * var_x123 * var_x124) / pow((0.16666666666666666 + var_x130), 2);
        IJth(rJacobian, 6, 5) = 0.13257434520702313;
        IJth(rJacobian, 9, 5) = -var_x143;
        IJth(rJacobian, 11, 5) = -var_x147 - var_x148;
        IJth(rJacobian, 12, 5) = var_x143 + var_x147 + var_x148;
        IJth(rJacobian, 3, 6) = var_x108 * (3.1822011198770817e-10 * var_x116 + 0.00011598784194528874 * var_x112);
        IJth(rJacobian, 5, 6) = 1.7400382808421786 * var_x131;
        IJth(rJacobian, 6, 6) = -0.13257434520702313 - 3.9156227113154186e-9 * var_x116 - 0.0014272027789839338 * var_x112;
        IJth(rJacobian, 3, 7) = var_x108 * (0.0028000000000000004 + var_x118);
        IJth(rJacobian, 7, 7) = -0.040000000000000001 - 40.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        IJth(rJacobian, 3, 8) = var_x108 * (9.2400000000000013e-6 + var_x118);
        IJth(rJacobian, 8, 8) = -6.6000000000000005e-5 - 20.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        IJth(rJacobian, 9, 9) = -var_x144;
        IJth(rJacobian, 12, 9) = var_x144;
        IJth(rJacobian, 4, 10) = var_x127;
        IJth(rJacobian, 5, 10) = var_x133;
        IJth(rJacobian, 10, 10) = -1.9299999999999999;
        IJth(rJacobian, 12, 10) = 1.9299999999999999;
        IJth(rJacobian, 11, 11) = -0.00040000000000000002 - var_x149;
        IJth(rJacobian, 12, 11) = 0.00040000000000000002 + var_x149;
        IJth(rJacobian, 4, 12) = var_x127;
        IJth(rJacobian, 5, 12) = var_x133;
        IJth(rJacobian, 9, 12) = 0.57599999999999996;
        IJth(rJacobian, 10, 12) = var_x146;
        IJth(rJacobian, 11, 12) = var_x150;
        IJth(rJacobian, 12, 12) = -0.57599999999999996 - var_x146 - var_x150;
        IJth(rJacobian, 13, 13) = var_x158 - var_x159;
        IJth(rJacobian, 14, 13) = var_x157;
        IJth(rJacobian, 18, 13) = var_x159;
        IJth(rJacobian, 13, 14) = var_x160;
        IJth(rJacobian, 14, 14) = var_x164 - var_x165 - var_x166;
        IJth(rJacobian, 15, 14) = var_x165;
        IJth(rJacobian, 19, 14) = var_x166;
        IJth(rJacobian, 14, 15) = var_x167;
        IJth(rJacobian, 15, 15) = var_x172 + var_x174 - var_x175;
        IJth(rJacobian, 16, 15) = var_x173;
        IJth(rJacobian, 20, 15) = var_x175;
        IJth(rJacobian, 15, 16) = var_x176;
        IJth(rJacobian, 16, 16) = -var_x176 - var_x180 - var_x181;
        IJth(rJacobian, 17, 16) = var_x180;
        IJth(rJacobian, 21, 16) = var_x181;
        IJth(rJacobian, 16, 17) = var_x182;
        IJth(rJacobian, 17, 17) = -0.29999999999999999 - var_x182 - var_x184;
        IJth(rJacobian, 22, 17) = var_x184;
        IJth(rJacobian, 23, 17) = 0.29999999999999999;
        IJth(rJacobian, 13, 18) = 0.0025000000000000001;
        IJth(rJacobian, 18, 18) = -0.0025000000000000001 - var_x187;
        IJth(rJacobian, 19, 18) = var_x187;
        IJth(rJacobian, 14, 19) = 0.00125;
        IJth(rJacobian, 18, 19) = var_x188;
        IJth(rJacobian, 19, 19) = -0.00125 - var_x188 - var_x190;
        IJth(rJacobian, 20, 19) = var_x190;
        IJth(rJacobian, 15, 20) = 0.00062500000000000001;
        IJth(rJacobian, 19, 20) = var_x160;
        IJth(rJacobian, 20, 20) = -0.00062500000000000001 + var_x158 + var_x164;
        IJth(rJacobian, 21, 20) = var_x157;
        IJth(rJacobian, 16, 21) = 0.00031250000000000001;
        IJth(rJacobian, 20, 21) = var_x192;
        IJth(rJacobian, 21, 21) = -0.00031250000000000001 + var_x174 - var_x192;
        IJth(rJacobian, 22, 21) = var_x173;
        IJth(rJacobian, 17, 22) = 0.00015625;
        IJth(rJacobian, 21, 22) = var_x167;
        IJth(rJacobian, 22, 22) = -0.00015625 + var_x172;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x63) ? (var_x83 - var_x85) : (var_x83 - var_x64 * var_x85)));
        IJth(rJacobian, 2, 23) = ((var_x63) ? (-var_x102) : (-var_x102 * var_x64));
        IJth(rJacobian, 4, 23) = -var_x128 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa;
        IJth(rJacobian, 17, 23) = 4.0;
        IJth(rJacobian, 23, 23) = -4.0;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x63) ? (var_x86 - var_x87) : (var_x86 - var_x64 * var_x87)));
        IJth(rJacobian, 2, 24) = ((var_x63) ? (-var_x103) : (-var_x103 * var_x64));
        IJth(rJacobian, 4, 24) = -var_x128 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open;
        IJth(rJacobian, 24, 24) = -var_x199 - var_x200;
        IJth(rJacobian, 25, 25) = -var_x209 - var_x210;
        IJth(rJacobian, 26, 25) = var_x209;
        IJth(rJacobian, 30, 25) = var_x210;
        IJth(rJacobian, 25, 26) = var_x211;
        IJth(rJacobian, 26, 26) = -var_x211 - var_x217 - var_x218;
        IJth(rJacobian, 27, 26) = var_x217;
        IJth(rJacobian, 31, 26) = var_x218;
        IJth(rJacobian, 26, 27) = var_x219;
        IJth(rJacobian, 27, 27) = -var_x219 - var_x225 - var_x226;
        IJth(rJacobian, 28, 27) = var_x226;
        IJth(rJacobian, 32, 27) = var_x225;
        IJth(rJacobian, 27, 28) = var_x227;
        IJth(rJacobian, 28, 28) = -var_x227 - var_x233 - var_x234;
        IJth(rJacobian, 29, 28) = var_x234;
        IJth(rJacobian, 33, 28) = var_x233;
        ...
        IJth(rJacobian, 28, 29) = var_x235;
        IJth(rJacobian, 29, 29) = -var_x235 - var_x239;
        IJth(rJacobian, 34, 29) = var_x239;
        IJth(rJacobian, 25, 30) = var_x212;
        IJth(rJacobian, 30, 30) = -var_x212 - var_x243;
        IJth(rJacobian, 31, 30) = var_x243;
        IJth(rJacobian, 26, 31) = var_x220;
        IJth(rJacobian, 30, 31) = var_x244;
        IJth(rJacobian, 31, 31) = -var_x220 - var_x244 - var_x247;
        IJth(rJacobian, 32, 31) = var_x247;
        IJth(rJacobian, 27, 32) = var_x228;
        IJth(rJacobian, 31, 32) = var_x248;
        IJth(rJacobian, 32, 32) = -var_x228 - var_x248 - var_x251;
        IJth(rJacobian, 33, 32) = var_x251;
        IJth(rJacobian, 28, 33) = var_x236;
        IJth(rJacobian, 32, 33) = var_x252;
        IJth(rJacobian, 33, 33) = -var_x236 - var_x252 - var_x255;
        IJth(rJacobian, 34, 33) = var_x255;
        IJth(rJacobian, 29, 34) = var_x240;
        IJth(rJacobian, 33, 34) = var_x256;
        IJth(rJacobian, 34, 34) = -var_x240 - var_x256;
        IJth(rJacobian, 35, 35) = -2.44936e-6 - var_x261;
        IJth(rJacobian, 36, 35) = var_x261;
        IJth(rJacobian, 40, 35) = 2.44936e-6;
        IJth(rJacobian, 35, 36) = var_x262;
        IJth(rJacobian, 36, 36) = -1.2850585364284256e-6 - var_x262 - var_x265;
        IJth(rJacobian, 37, 36) = var_x265;
        IJth(rJacobian, 41, 36) = 1.2850585364284256e-6;
        IJth(rJacobian, 36, 37) = var_x266;
        IJth(rJacobian, 37, 37) = -4.290998044504021e-5 - var_x266 - var_x269;
        IJth(rJacobian, 38, 37) = var_x269;
        IJth(rJacobian, 42, 37) = 4.290998044504021e-5;
        IJth(rJacobian, 37, 38) = var_x270;
        IJth(rJacobian, 38, 38) = -0.0022989390350036006 - var_x270 - var_x273;
        IJth(rJacobian, 39, 38) = var_x273;
        IJth(rJacobian, 43, 38) = 0.0022989390350036006;
        IJth(rJacobian, 0, 39) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x13 * var_x31 - var_x13 * var_x34);
        IJth(rJacobian, 1, 39) = -var_x13 * var_x91;
        IJth(rJacobian, 2, 39) = -var_x13 * var_x97;
        IJth(rJacobian, 38, 39) = var_x274;
        IJth(rJacobian, 39, 39) = -0.13410048761201937 - var_x274;
        IJth(rJacobian, 44, 39) = 0.13410048761201937;
        IJth(rJacobian, 35, 40) = 0.00305767916;
        IJth(rJacobian, 40, 40) = -0.00305767916 - var_x277;
        IJth(rJacobian, 41, 40) = var_x277;
        IJth(rJacobian, 36, 41) = 0.0030289691634726814;
        IJth(rJacobian, 40, 41) = var_x278;
        IJth(rJacobian, 41, 41) = -0.0030289691634726814 - var_x278 - var_x281;
        IJth(rJacobian, 42, 41) = var_x281;
        IJth(rJacobian, 37, 42) = 0.0026111571690401588;
        IJth(rJacobian, 41, 42) = var_x282;
        IJth(rJacobian, 42, 42) = -0.0026111571690401588 - var_x282 - var_x285;
        IJth(rJacobian, 43, 42) = var_x285;
        IJth(rJacobian, 38, 43) = 0.0047848930796401661;
        IJth(rJacobian, 42, 43) = var_x286;
        IJth(rJacobian, 43, 43) = -0.0047848930796401661 - var_x286 - var_x289;
        IJth(rJacobian, 44, 43) = var_x289;
        IJth(rJacobian, 39, 44) = 0.0014420608358145942;
        IJth(rJacobian, 43, 44) = var_x290;
        IJth(rJacobian, 44, 44) = -0.0014420608358145942 - var_x290;
        IJth(rJacobian, 45, 45) = -var_x296 - var_x297;
        IJth(rJacobian, 46, 45) = var_x297;
        IJth(rJacobian, 52, 45) = var_x296;
        IJth(rJacobian, 45, 46) = var_x298;
        IJth(rJacobian, 46, 46) = -var_x298 - var_x303 - var_x304;
        IJth(rJacobian, 47, 46) = var_x304;
        IJth(rJacobian, 53, 46) = var_x303;
        IJth(rJacobian, 46, 47) = var_x305;
        IJth(rJacobian, 47, 47) = -var_x305 - var_x309 - var_x310;
        IJth(rJacobian, 48, 47) = var_x309;
        IJth(rJacobian, 54, 47) = var_x310;
        IJth(rJacobian, 47, 48) = var_x311;
        IJth(rJacobian, 48, 48) = -var_x311 - var_x315 - var_x316;
        IJth(rJacobian, 49, 48) = var_x315;
        IJth(rJacobian, 55, 48) = var_x316;
        IJth(rJacobian, 48, 49) = var_x317;
        IJth(rJacobian, 49, 49) = -var_x317 - var_x327 - var_x328 - var_x329;
        IJth(rJacobian, 50, 49) = var_x328;
        IJth(rJacobian, 51, 49) = var_x329;
        IJth(rJacobian, 56, 49) = var_x327;
        IJth(rJacobian, 0, 50) = mSetVoltageDerivativeToZero ? 0.0 : (var_x89);
        IJth(rJacobian, 1, 50) = var_x92;
        IJth(rJacobian, 49, 50) = var_x330;
        IJth(rJacobian, 50, 50) = -var_x330 - var_x337 - var_x338;
        IJth(rJacobian, 51, 50) = var_x337;
        IJth(rJacobian, 57, 50) = var_x338;
        IJth(rJacobian, 0, 51) = mSetVoltageDerivativeToZero ? 0.0 : (var_x89);
        IJth(rJacobian, 1, 51) = var_x92;
        IJth(rJacobian, 49, 51) = var_x331;
        IJth(rJacobian, 50, 51) = var_x339;
        IJth(rJacobian, 51, 51) = -var_x331 - var_x339;
        IJth(rJacobian, 45, 52) = var_x300;
        IJth(rJacobian, 52, 52) = -var_x300 - var_x343;
        IJth(rJacobian, 53, 52) = var_x343;
        IJth(rJacobian, 46, 53) = var_x306;
        IJth(rJacobian, 52, 53) = var_x344;
        IJth(rJacobian, 53, 53) = -var_x306 - var_x344 - var_x347;
        IJth(rJacobian, 54, 53) = var_x347;
        IJth(rJacobian, 47, 54) = var_x312;
        IJth(rJacobian, 53, 54) = var_x348;
        IJth(rJacobian, 54, 54) = -var_x312 - var_x348 - var_x351;
        IJth(rJacobian, 55, 54) = var_x351;
        IJth(rJacobian, 48, 55) = var_x318;
        IJth(rJacobian, 54, 55) = var_x352;
        IJth(rJacobian, 55, 55) = -var_x318 - var_x352 - var_x355;
        IJth(rJacobian, 56, 55) = var_x355;
        IJth(rJacobian, 49, 56) = var_x332;
        IJth(rJacobian, 55, 56) = var_x356;
        IJth(rJacobian, 56, 56) = -var_x332 - var_x356 - var_x361;
        IJth(rJacobian, 57, 56) = var_x361;
        IJth(rJacobian, 50, 57) = var_x340;
        IJth(rJacobian, 56, 57) = var_x362;
        IJth(rJacobian, 57, 57) = -var_x340 - var_x362;
        IJth(rJacobian, 58, 58) = -var_x367;
        IJth(rJacobian, 59, 58) = var_x367;
        IJth(rJacobian, 58, 59) = var_x368;
        IJth(rJacobian, 59, 59) = -0.13876486073161204 - var_x368;
        IJth(rJacobian, 60, 59) = 0.13876486073161204;
        IJth(rJacobian, 59, 60) = 0.78911443677844384;
        IJth(rJacobian, 60, 60) = -0.78911443677844384 - var_x379 - var_x380;
        IJth(rJacobian, 61, 60) = var_x379;
        IJth(rJacobian, 62, 60) = var_x380;
        ...
        IJth(rJacobian, 2, 61) = 3.0564346548418563e-5 * var_x18 - 1.1442435714400293e-6 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        IJth(rJacobian, 60, 61) = var_x381;
        IJth(rJacobian, 61, 61) = -var_x381 - var_x386;
        IJth(rJacobian, 62, 61) = var_x386;
        IJth(rJacobian, 60, 62) = var_x382;
        IJth(rJacobian, 61, 62) = var_x387;
        IJth(rJacobian, 62, 62) = -var_x382 - var_x387;
        IJth(rJacobian, 63, 63) = -0.0079560079800399999;
        IJth(rJacobian, 64, 63) = 0.0079560079800399999;
        IJth(rJacobian, 63, 64) = var_x390;
        IJth(rJacobian, 64, 64) = -0.039667206760709998 - var_x390;
        IJth(rJacobian, 65, 64) = 0.039667206760709998;
        IJth(rJacobian, 0, 65) = mSetVoltageDerivativeToZero ? 0.0 : (var_x90);
        IJth(rJacobian, 2, 65) = var_x104;
        IJth(rJacobian, 64, 65) = var_x393;
        IJth(rJacobian, 65, 65) = -var_x393 - var_x398;
        IJth(rJacobian, 66, 65) = var_x398;
        IJth(rJacobian, 0, 66) = mSetVoltageDerivativeToZero ? 0.0 : (var_x90);
        IJth(rJacobian, 2, 66) = var_x104;
        IJth(rJacobian, 65, 66) = var_x399;
        IJth(rJacobian, 66, 66) = -var_x399;
    }
