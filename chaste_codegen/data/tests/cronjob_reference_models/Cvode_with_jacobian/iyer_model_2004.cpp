...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliyer_model_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x72 = var_x17 * var_x21;
        const double var_x73 = var_x17 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43;
        const double var_x74 = var_x17 * (var_chaste_interface__IKs__O1ks + var_chaste_interface__IKs__O2ks);
        const double var_x75 = var_x17 * var_chaste_interface__IKr__OHerg;
        const double var_x76 = var_x17 * var_x29;
        const double var_x77 = 0.31576891781939603 * var_x76 - 0.00015031321966819388 * var_x68 - 6.6941504319201117 * var_x72 - 2.0706890167875649 * var_x73 - 0.093489896373056991 * var_x74 - 0.49683202072538857 * var_x75;
        ...
        const double var_x98 = 0.00021359213333547216 * var_x40 + 7.2724087660027779e-7 * var_x29 + 3.4618327348681436e-10 * var_x50 - 1.5417159680637438e-5 * var_x21 - 2.1531465053979051e-7 * var_chaste_interface__IKs__O1ks - 2.1531465053979051e-7 * var_chaste_interface__IKs__O2ks - 1.1442435714400293e-6 * var_chaste_interface__IKr__OHerg - 4.7689611318757119e-6 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - 3.4618327348681436e-10 * var_x53 - var_x30 * var_x97;
        const double var_x99 = 7.1159095070575419e-7 * var_x70;
        const double var_x100 = 1.9425621197603168e-5 * var_x76 - 9.2470395326765502e-9 * var_x68 - 0.00041181390311704759 * var_x72 - 5.7513555333045702e-6 * var_x74 - 3.0564346548418563e-5 * var_x75 - 0.00012738562343605627 * var_x73;
        ...
        const double var_x131 = 1 / (1.0 + 12.0 * var_x130);
        ...
        const double var_x135 = 48600000000.0 * var_x134 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C1_RyR;
        const double var_x136 = 12150000000.0 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 4.0);
        const double var_x137 = 12150000.0 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 2.0) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR;
        const double var_x138 = 4050000.0 * var_x134;
        ...
        const double var_x145 = 7.9871999999999996 * var_x141;
        const double var_x146 = -var_x145;
        const double var_x147 = 0.055397999999999996 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        ...
        const double var_x152 = -var_x148;
        const double var_x153 = 5.9903999999999993 * var_x141;
        const double var_x154 = 0.11079599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x155 = 0.1764 * var_x139;
        const double var_x156 = 0.047923199999999999 * var_x141;
        const double var_x157 = -var_x156;
        const double var_x158 = 0.017198999999999999 * var_x139;
        const double var_x159 = 0.22159199999999998 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2;
        const double var_x160 = -var_x155;
        const double var_x161 = 3.9935999999999998 * var_x141;
        ...
        const double var_x168 = 1.9967999999999999 * var_x141;
        const double var_x169 = 0.44318399999999997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        ...
        const double var_x179 = 0.0085994999999999995 * var_x139;
        ...
        const double var_x201 = 8.3392179730847992e-11 * var_x189;
        const double var_x202 = 0.047274866891999993 * var_x191;
        const double var_x203 = 2.7448243264023808e-6 * var_x193;
        ...
        const double var_x208 = 0.0073584627104531196 * var_x193;
        const double var_x209 = 0.031516577927999993 * var_x191;
        const double var_x210 = 6.2643871845094088e-10 * var_x189;
        const double var_x211 = 1.190172890246627e-6 * var_x193;
        const double var_x212 = 0.011268486253500002 * var_x195;
        const double var_x213 = 0.011656842546537791 * var_x189;
        const double var_x214 = 1.0874159999999999 * var_x191;
        ...
        const double var_x218 = 6.9834511318773681e-9 * var_x189;
        const double var_x219 = 6.466053749793811e-7 * var_x193;
        const double var_x220 = 0.015024648338000001 * var_x195;
        const double var_x221 = 0.12994884875097448 * var_x189;
        const double var_x222 = 0.54370799999999997 * var_x191;
        const double var_x223 = 0.32074000000000003 * var_x195;
        const double var_x224 = 0.0017334521172801731 * var_x193;
        const double var_x225 = 6.2947815902170848e-9 * var_x189;
        ...
        const double var_x229 = 0.42695382052749881 * var_x191;
        ...
        const double var_x237 = 0.058010926130094301 * var_x191;
        ...
        const double var_x267 = 0.049212749503964474 * var_x247;
        ...
        const double var_x271 = 0.015434242075859547 * var_x247;
        const double var_x272 = 4.7206750348744701e-5 * var_x245;
        const double var_x273 = 2.0082338973371914 * var_x247;
        const double var_x274 = 0.0006057289829234033 * var_x245;
        const double var_x275 = 0.04692272136005015 * var_x247;
        const double var_x276 = 5.7810813021376409e-5 * var_x245 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OIKv14;
        const double var_x277 = 6.1053726595326019 * var_x247;
        const double var_x278 = 0.00074179401705723523 * var_x245;
        ...
        const double var_x281 = exp(-26.232056238852355 - 0.090161609404259865 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x282 = 767594485.71651864 * var_x281;
        const double var_x283 = exp(-23.156677820503312);
        const double var_x284 = 8513540195.0827656 * var_x283;
        const double var_x285 = 34054160780.331062 * var_x279;
        const double var_x286 = 8513540195.0827656 * var_x281;
        const double var_x287 = exp(-24.351833000860694);
        const double var_x288 = 8513540195.0827656 * var_x287;
        const double var_x289 = 288567144.18342406 * var_x279;
        const double var_x290 = 1535188971.4330373 * var_x281;
        const double var_x291 = 11922585210.267752 * var_x283;
        const double var_x292 = 25540620585.248295 * var_x279;
        const double var_x293 = 17027080390.165531 * var_x281;
        const double var_x294 = 6079249204.347868 * var_x287;
        const double var_x295 = 192378096.12228271 * var_x279;
        const double var_x296 = 2302783457.1495557 * var_x281;
        const double var_x297 = 17027080390.165531 * var_x279;
        const double var_x298 = 16696701353.239271 * var_x283;
        const double var_x299 = 25540620585.248295 * var_x281;
        const double var_x300 = 4340999166.2352047 * var_x287;
        const double var_x301 = 96189048.061141357 * var_x279;
        const double var_x302 = 3070377942.8660746 * var_x281;
        const double var_x303 = 8513540195.0827656 * var_x279;
        const double var_x304 = 23382498943.197018 * var_x283;
        const double var_x305 = 34054160780.331062 * var_x281;
        const double var_x306 = 3099769910.3661275 * var_x287;
        const double var_x307 = exp(-19.672905196314272 + 0.08427205410463634 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x308 = 717453519.942011 * var_x307;
        const double var_x309 = exp(-16.535928437145479 + 0.10971319924442288 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x310 = 934047731.69851828 * var_x309;
        const double var_x311 = exp(-27.092641999412574 - 0.061469636400174381 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x312 = 523324220.27000725 * var_x311;
        const double var_x313 = exp(-26.358496255772216 - 0.068762962366201302 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x314 = 585416244.03761828 * var_x313 * var_chaste_interface__INa__na7;
        ...
        const double var_x321 = exp(-20.672646495412604 + 0.011394696340402197 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x322 = 97009205.304776594 * var_x321;
        ...
        const double var_x325 = 8513540195.0827656 * exp(-26.650781465416163);
        const double var_x326 = 8513540195.0827656 * var_x321;
        const double var_x327 = 8513540195.0827656 * exp(-22.779658962607591);
        const double var_x328 = 8513540195.0827656 * var_x323;
        const double var_x329 = 538822673.3061657 * var_x279 * var_chaste_interface__INa__na8;
        const double var_x330 = 548114892.23356998 * var_x281;
        const double var_x331 = 47690340841.071007 * var_x279;
        const double var_x332 = 6079249204.347868 * var_x281;
        const double var_x333 = 404117004.97962427 * var_x279;
        const double var_x334 = 1096229784.46714 * var_x281;
        const double var_x335 = 35767755630.803253 * var_x279;
        const double var_x336 = 12158498408.695736 * var_x281;
        const double var_x337 = 269411336.65308285 * var_x279;
        const double var_x338 = 1644344676.7007098 * var_x281;
        const double var_x339 = 23845170420.535503 * var_x279;
        const double var_x340 = 18237747613.043602 * var_x281;
        const double var_x341 = 134705668.32654142 * var_x279;
        const double var_x342 = 2192459568.9342799 * var_x281;
        const double var_x343 = 11922585210.267752 * var_x279;
        const double var_x344 = 24316996817.391472 * var_x281;
        const double var_x345 = exp(-21.94926195979755 + 0.030147161449011889 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x346 = 256659070.7638123 * var_x345;
        ...
        const double var_x353 = exp(0.033046080388350003 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x354 = 0.0030146436875758886 * var_x353 * var_chaste_interface__IKr__C1Herg;
        const double var_x355 = 0.091225454037165171 * var_x353;
        const double var_x356 = 0.21116826991639448 * var_x351;
        ...
        const double var_x359 = 0.026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x360 = exp(var_x359);
        const double var_x361 = 0.0028649222200750734 * var_x360;
        const double var_x362 = exp(-0.026913854983990002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x363 = 0.0001923883999223735 * var_x362;
        const double var_x364 = exp(-0.045366429595429997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x365 = 0.0056890885971700002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x366 = var_x357 * var_x362 * var_x364 * exp(-var_x359) * exp(-var_x365);
        const double var_x367 = 0.10945626585855089 * var_x360;
        const double var_x368 = 0.00042769471831999382 * var_x357;
        const double var_x369 = 0.0071483033566472664 * var_x362;
        const double var_x370 = 1.6926962184371784e-6 * var_x366;
        const double var_x371 = exp(var_x365);
        const double var_x372 = 0.0032282621593045183 * var_x371;
        const double var_x373 = 0.0015600678590465681 * var_x364;
        const double var_x374 = 0.56744803744318484 * var_x371;
        const double var_x375 = 0.034388156021070745 * var_x364;
        const double var_x376 = exp(-1.8891230210000001e-5 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x377 = 4.0853373267232939e-6 * var_x376 * var_chaste_interface__IKs__C1ks;
        const double var_x378 = 0.21625575895849999 * var_x376;
        const double var_x379 = exp(-0.14999754700285001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x380 = 0.0010511927526268654 * var_x379;
        const double var_x381 = 0.0070080662892900002 * var_x379;
        const double var_x382 = exp(0.08662945914655 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x383 = 0.00066466830499978399 * var_x382;
        ...
        const double var_x386 = 0.00767254363063 * var_x382;
        const double var_x387 = 0.0037973799836799999 * var_x384;
        ...
        IJth(rJacobian, 31, 0) = var_x201 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 + var_x229 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 + (var_x203 + var_x230 - var_x233) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 - var_x234 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43;
        IJth(rJacobian, 32, 0) = var_x210 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 + var_x233 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 + (var_x211 + var_x234 - var_x237) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43 - var_x238 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43;
        ...
        IJth(rJacobian, 45, 0) = -var_x280 - var_x282 * var_chaste_interface__INa__na2;
        IJth(rJacobian, 46, 0) = var_x280 + (var_x282 - var_x289) * var_chaste_interface__INa__na2 - var_x290 * var_chaste_interface__INa__na3;
        ...
        IJth(rJacobian, 60, 0) = (-var_x358 - var_x361) * var_chaste_interface__IKr__C3Herg - var_x363 * var_chaste_interface__IKr__OHerg - 1.7628212752661065e-7 * var_x366 * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 61, 0) = var_x361 * var_chaste_interface__IKr__C3Herg + (var_x363 - var_x372) * var_chaste_interface__IKr__OHerg - var_x373 * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 62, 0) = var_x358 * var_chaste_interface__IKr__C3Herg + var_x372 * var_chaste_interface__IKr__OHerg + (var_x373 + 1.7628212752661065e-7 * var_x366) * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 63, 0) = -var_x377;
        IJth(rJacobian, 64, 0) = var_x377 - var_x380 * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 65, 0) = -var_x385 + (var_x380 - var_x383) * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 66, 0) = var_x385 + var_x383 * var_chaste_interface__IKs__O1ks;
        ...
        IJth(rJacobian, 9, 4) = -var_x135;
        IJth(rJacobian, 10, 4) = var_x137;
        IJth(rJacobian, 12, 4) = var_x135 - var_x137;
        ...
        IJth(rJacobian, 5, 5) = 1.0 * var_x131 * (-1.7400382808421786 - 1.8 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR - 1.8 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O2_RyR) + 0.16666666666666666 * pow(var_x129, (-3.0)) * (1.7400382808421786 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaNSR - 1.7400382808421786 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR - 1.8 * var_x123 * var_x124) / pow((0.083333333333333329 + var_x130), 2);
        ...
        IJth(rJacobian, 9, 9) = -var_x136;
        IJth(rJacobian, 12, 9) = var_x136;
        ...
        IJth(rJacobian, 10, 12) = var_x138;
        IJth(rJacobian, 11, 12) = 0.10000000000000001;
        IJth(rJacobian, 12, 12) = -0.67599999999999993 - var_x138;
        IJth(rJacobian, 13, 13) = var_x146 - var_x147;
        IJth(rJacobian, 14, 13) = var_x145;
        IJth(rJacobian, 18, 13) = var_x147;
        IJth(rJacobian, 13, 14) = var_x148;
        IJth(rJacobian, 14, 14) = var_x152 - var_x153 - var_x154;
        IJth(rJacobian, 15, 14) = var_x153;
        IJth(rJacobian, 19, 14) = var_x154;
        IJth(rJacobian, 14, 15) = var_x155;
        IJth(rJacobian, 15, 15) = var_x160 + var_x162 - var_x163;
        IJth(rJacobian, 16, 15) = var_x161;
        IJth(rJacobian, 20, 15) = var_x163;
        IJth(rJacobian, 15, 16) = var_x164;
        IJth(rJacobian, 16, 16) = -var_x164 - var_x168 - var_x169;
        IJth(rJacobian, 17, 16) = var_x168;
        IJth(rJacobian, 21, 16) = var_x169;
        ...
        IJth(rJacobian, 20, 20) = -0.00062500000000000001 + var_x146 + var_x152;
        IJth(rJacobian, 21, 20) = var_x145;
        IJth(rJacobian, 16, 21) = 0.00031250000000000001;
        IJth(rJacobian, 20, 21) = var_x180;
        IJth(rJacobian, 21, 21) = -0.00031250000000000001 + var_x162 - var_x180;
        IJth(rJacobian, 22, 21) = var_x161;
        IJth(rJacobian, 17, 22) = 0.00015625;
        IJth(rJacobian, 21, 22) = var_x155;
        IJth(rJacobian, 22, 22) = -0.00015625 + var_x160;
        ...
        IJth(rJacobian, 28, 27) = var_x214;
        IJth(rJacobian, 32, 27) = var_x213;
        IJth(rJacobian, 27, 28) = var_x215;
        IJth(rJacobian, 28, 28) = -var_x215 - var_x221 - var_x222;
        IJth(rJacobian, 29, 28) = var_x222;
        IJth(rJacobian, 33, 28) = var_x221;
        ...
        IJth(rJacobian, 39, 39) = -0.1341004876120194 - var_x262;
        ...
        IJth(rJacobian, 48, 47) = var_x297;
        IJth(rJacobian, 54, 47) = var_x298;
        IJth(rJacobian, 47, 48) = var_x299;
        IJth(rJacobian, 48, 48) = -var_x299 - var_x303 - var_x304;
        IJth(rJacobian, 49, 48) = var_x303;
        IJth(rJacobian, 55, 48) = var_x304;
        ...
        IJth(rJacobian, 61, 61) = -var_x369 - var_x374;
        IJth(rJacobian, 62, 61) = var_x374;
        IJth(rJacobian, 60, 62) = var_x370;
        IJth(rJacobian, 61, 62) = var_x375;
        IJth(rJacobian, 62, 62) = -var_x370 - var_x375;
        IJth(rJacobian, 63, 63) = -0.0079560079800399999;
        IJth(rJacobian, 64, 63) = 0.0079560079800399999;
        IJth(rJacobian, 63, 64) = var_x378;
        IJth(rJacobian, 64, 64) = -0.039667206760709998 - var_x378;
        ...
        IJth(rJacobian, 64, 65) = var_x381;
        IJth(rJacobian, 65, 65) = -var_x381 - var_x386;
        IJth(rJacobian, 66, 65) = var_x386;
        IJth(rJacobian, 0, 66) = mSetVoltageDerivativeToZero ? 0.0 : (var_x90);
        IJth(rJacobian, 2, 66) = var_x104;
        IJth(rJacobian, 65, 66) = var_x387;
        IJth(rJacobian, 66, 66) = -var_x387;
    }
