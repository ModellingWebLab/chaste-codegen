...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellfink_noble_giles_model_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x6 = exp(0.10989010989010989 * var_chaste_interface__cell__V - 3.1258035549938383 * var_x5);
        const double var_x7 = 1.0 + 0.036532500000000002 * var_x6;
        const double var_x8 = 1 / var_x7;
        const double var_x9 = 0.20000000000000001 * var_chaste_interface__ito_r_gate__r;
        const double var_x10 = exp(-0.024332029034784559 * var_chaste_interface__cell__V);
        const double var_x11 = 1.0 + 0.10000000000000001 * var_x10;
        const double var_x12 = 1 / var_x11;
        const double var_x13 = exp(0.013101861787960915 * var_chaste_interface__cell__V);
        const double var_x14 = var_x13 * pow(var_chaste_interface__Na__Na_i, 3.0);
        const double var_x15 = var_x10 * var_chaste_interface__Ca__Ca_i;
        const double var_x16 = var_x12 * (0.026203723575921829 * var_x14 + 166917.71917862206 * var_x15);
        const double var_x17 = var_x6 / pow(var_x7, 2);
        const double var_x18 = 0.050000000000000003 * var_chaste_interface__cell__V;
        const double var_x19 = exp(var_x18 - 1.4222406175221964 * var_x5);
        const double var_x20 = 1.0 + 0.079111111111111104 * var_x19;
        const double var_x21 = pow(var_x20, 3);
        const double var_x22 = exp(0.059333333333333335 + 0.20833333333333334 * var_chaste_interface__cell__V - 5.9260025730091517 * var_x5);
        const double var_x23 = exp(0.0055555555555555558 * var_chaste_interface__cell__V - 0.15802673528024405 * var_x5);
        const double var_x24 = 1 / (var_x21 + 2.0875714285714286 * var_x22 + 0.012714285714285714 * var_x23);
        const double var_x25 = var_x19 * var_x20 * var_x24;
        const double var_x26 = pow(var_x20, 2);
        const double var_x27 = var_x19 * var_x26;
        const double var_x28 = 0.20280156807699834 * var_x26 / pow((var_x22 + 0.0060904673920481765 * var_x23 + 0.47902552521727226 * var_x21), 2);
        const double var_x29 = 0.00699184 * var_x25 - 0.00046649192307692298 * var_x17 + var_x28 * (-7.0634920634920635e-5 * var_x23 - 0.43491071428571432 * var_x22 - 0.011866666666666666 * var_x27);
        const double var_x30 = -26.713760659695652 * var_x5 + var_chaste_interface__cell__V;
        const double var_x31 = 0.68210000000000004 * var_x30;
        const double var_x32 = var_x24 * var_x26;
        const double var_x33 = pow(var_chaste_interface__iNa_m_gate__m, 3.0);
        const double var_x34 = var_x33 * var_chaste_interface__iNa_j_gate__j;
        const double var_x35 = 11.0 * var_x34;
        const double var_x36 = 2.0 * var_x14 - 6860000.0 * var_x15;
        const double var_x37 = var_x10 * var_x36 / pow(var_x11, 2);
        const double var_x38 = var_x1 * var_x30 / pow(var_x2, 2);
        const double var_x39 = 1 / (40.0 + var_chaste_interface__Na__Na_i);
        const double var_x40 = exp(-0.037433890822745473 * var_chaste_interface__cell__V);
        const double var_x41 = exp(-0.0037433890822745476 * var_chaste_interface__cell__V);
        const double var_x42 = 1.0 + 0.035299999999999998 * var_x40 + 0.1245 * var_x41;
        const double var_x43 = var_x39 * (0.0013214163460429152 * var_x40 + 0.00046605194074318115 * var_x41) * var_chaste_interface__Na__Na_i / pow(var_x42, 2);
        const double var_x44 = exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__cell__V);
        const double var_x45 = -1.0 + var_x44;
        const double var_x46 = 1 / var_x45;
        const double var_x47 = var_x46 * var_chaste_interface__iCaL_d_gate__d * var_chaste_interface__iCaL_f2_gate__f2 * var_chaste_interface__iCaL_fCass_gate__fCass * var_chaste_interface__iCaL_f_gate__f;
        const double var_x48 = var_x44 * var_chaste_interface__Ca__Ca_ss;
        const double var_x49 = -2.0 + 0.25 * var_x48;
        const double var_x50 = 0.28894573917650507 * var_x49;
        const double var_x51 = -15.0 + var_chaste_interface__cell__V;
        const double var_x52 = var_x44 * var_x51;
        const double var_x53 = var_x49 * var_x52 * var_chaste_interface__iCaL_d_gate__d * var_chaste_interface__iCaL_f2_gate__f2 * var_chaste_interface__iCaL_fCass_gate__fCass * var_chaste_interface__iCaL_f_gate__f / pow(var_x45, 2);
        const double var_x54 = var_x47 * var_x48 * var_x51;
        const double var_x55 = 1 / (0.029999999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
        const double var_x56 = pow(var_chaste_interface__iKs_Xs_gate__Xs, 1.0) * (-26.713760659695652 * log(9.6000000000000014 * var_x55) + var_chaste_interface__cell__V);
        const double var_x57 = var_x30 * var_chaste_interface__ito_s_gate__s;
        const double var_x58 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x59 = -26.713760659695652 * log(140.0 * var_x58) + var_chaste_interface__cell__V;
        const double var_x60 = var_x59 * var_chaste_interface__iNa_h_gate__h;
        const double var_x61 = var_x60 * pow(var_chaste_interface__iNa_m_gate__m, 2.0) * var_chaste_interface__iNa_j_gate__j;
        const double var_x62 = var_x33 * var_x60;
        const double var_x63 = var_x46 * var_x51 * var_chaste_interface__iCaL_f2_gate__f2 * var_chaste_interface__iCaL_fCass_gate__fCass;
        const double var_x64 = var_x50 * var_x63;
        const double var_x65 = var_x46 * var_x51 * var_chaste_interface__iCaL_d_gate__d * var_chaste_interface__iCaL_f_gate__f;
        const double var_x66 = var_x50 * var_x65;
        const double var_x67 = 0.00050000000000000001 + var_chaste_interface__Ca__Ca_i;
        const double var_x68 = 1 / var_x67;
        const double var_x69 = 1 / var_chaste_interface__Ca__Ca_i;
        const double var_x70 = var_chaste_interface__Ca__Ca_i / pow(var_x67, 2);
        const double var_x71 = var_x10 * var_x12;
        const double var_x72 = var_x47 * var_x52;
        const double var_x73 = 1 / var_x42;
        const double var_x74 = var_x39 * var_x73;
        const double var_x75 = var_x0 * var_x55;
        const double var_x76 = var_x73 * var_chaste_interface__Na__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__Na__Na_i), 2);
        const double var_x77 = var_x12 * var_x13 * pow(var_chaste_interface__Na__Na_i, 2.0);
        const double var_x78 = var_x34 * var_x58 * var_chaste_interface__iNa_h_gate__h;
        const double var_x79 = var_x28 * (-0.0020091970628488172 * var_x23 * var_x4 - 0.33754510655860126 * var_x27 * var_x4 - 12.370953657054677 * var_x22 * var_x4) + 0.19888157678432786 * var_x25 * var_x4 - 0.013269275214920799 * var_x17 * var_x4;
        const double var_x80 = var_x4 * (0.11619999999999997 * var_x8 + 0.88380000000000003 * var_x32);
        const double var_x81 = var_x4 * var_chaste_interface__iKr_Markov__Or4;
        const double var_x82 = var_x3 * var_x4;
        const double var_x83 = var_x4 * var_chaste_interface__ito_r_gate__r * var_chaste_interface__ito_s_gate__s;
        const double var_x84 = exp(-1.5790000000000006 + 0.0112 * var_chaste_interface__cell__V);
        const double var_x85 = 0.0112 * var_x84;
        const double var_x86 = var_x85 * var_chaste_interface__iKr_Markov__Cr1;
        const double var_x87 = exp(-2.0190000000000001 - 0.060299999999999999 * var_chaste_interface__cell__V);
        const double var_x88 = 0.060299999999999999 * var_x87;
        const double var_x89 = var_x88 * var_chaste_interface__iKr_Markov__Cr2;
        const double var_x90 = 1.0 * var_x84;
        const double var_x91 = -var_x90;
        const double var_x92 = 1.0 * var_x87;
        const double var_x93 = 1.0 * exp(-3.1680000000000028);
        const double var_x94 = -var_x92 - var_x93;
        const double var_x95 = 1.0 * exp(-2.5140000000000011);
        const double var_x96 = exp(-3.8160000000000025 + 0.036499999999999998 * var_chaste_interface__cell__V);
        const double var_x97 = 0.036499999999999998 * var_x96;
        const double var_x98 = var_x97 * var_chaste_interface__iKr_Markov__Cr3;
        const double var_x99 = exp(-8.3940000000000019 - 0.039899999999999998 * var_chaste_interface__cell__V);
        const double var_x100 = 0.039899999999999998 * var_x99;
        const double var_x101 = 1.0 * var_x96;
        const double var_x102 = -var_x101 - var_x95;
        const double var_x103 = 1.0 * var_x99;
        const double var_x104 = exp(-0.87200000000000344 + 0.0223 * var_chaste_interface__cell__V);
        const double var_x105 = 0.0223 * var_x104;
        const double var_x106 = var_x100 - var_x105;
        const double var_x107 = exp(-3.1820000000000022 - 0.031199999999999999 * var_chaste_interface__cell__V);
        const double var_x108 = 0.031199999999999999 * var_x107;
        const double var_x109 = var_x108 * var_chaste_interface__iKr_Markov__Ir5;
        const double var_x110 = 1.0 * var_x104;
        const double var_x111 = -var_x103 - var_x110;
        const double var_x112 = 1.0 * var_x107;
        const double var_x113 = -var_x112;
        const double var_x114 = var_x85 * var_chaste_interface__iKr_Markov_Sotalol_block__BCr1;
        const double var_x115 = var_x88 * var_chaste_interface__iKr_Markov_Sotalol_block__BCr2;
        const double var_x116 = var_x97 * var_chaste_interface__iKr_Markov_Sotalol_block__BCr3;
        const double var_x117 = var_x108 * var_chaste_interface__iKr_Markov_Sotalol_block__BIr5;
        const double var_x118 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__cell__V);
        const double var_x119 = 1.0 + var_x118;
        const double var_x120 = -0.16666666666666666 * var_chaste_interface__cell__V;
        const double var_x121 = exp(0.83333333333333337 + var_x120);
        const double var_x122 = 1.0 + var_x121;
        const double var_x123 = 1 / sqrt(var_x122);
        const double var_x124 = exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__cell__V);
        const double var_x125 = 1.0 + var_x124;
        const double var_x126 = 1 / var_x125;
        const double var_x127 = var_x123 * var_x126;
        const double var_x128 = 1 / (80.0 + 1400.0 * var_x127);
        const double var_x129 = 0.20000000000000001 * var_chaste_interface__cell__V;
        const double var_x130 = exp(-4.0 + var_x129);
        const double var_x131 = 1.0 + var_x130;
        const double var_x132 = 1 / var_x131;
        const double var_x133 = 1 + 0.022222222222222223 * var_chaste_interface__cell__V;
        const double var_x134 = exp(-6.328125 * pow(var_x133, 2.0));
        const double var_x135 = exp(4.0 + var_x129);
        const double var_x136 = 1.0 + var_x135;
        const double var_x137 = 1 / (3.0 + 5.0 * var_x132 + 85.0 * var_x134);
        const double var_x138 = exp(3.3333333333333335 + var_x120);
        const double var_x139 = 1.0 + var_x138;
        const double var_x140 = 1 + 0.025000000000000001 * var_chaste_interface__cell__V;
        const double var_x141 = exp(-0.88888888888888884 * pow(var_x140, 2.0));
        const double var_x142 = 1 / (0.80000000000000004 + 9.5 * var_x141);
        const double var_x143 = exp(7.0 + var_x129);
        const double var_x144 = 1.0 + var_x143;
        const double var_x145 = 1 / var_x144;
        const double var_x146 = exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__cell__V);
        const double var_x147 = 1.0 + var_x146;
        const double var_x148 = 1 / var_x147;
        const double var_x149 = 1 / (0.10000000000000001 * var_x145 + 0.10000000000000001 * var_x148);
        const double var_x150 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__cell__V);
        const double var_x151 = 1.0 + var_x150;
        const double var_x152 = -var_chaste_interface__iNa_m_gate__m + 1.0 * pow(var_x151, (-2.0));
        const double var_x153 = exp(-12.0 - var_x129);
        const double var_x154 = 1.0 + var_x153;
        const double var_x155 = var_x149 * var_x154;
        const double var_x156 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V);
        const double var_x157 = 1.0 + var_x156;
        const double var_x158 = 1.0 * pow(var_x157, (-2.0));
        const double var_x159 = var_x158 - var_chaste_interface__iNa_h_gate__h;
        const double var_x160 = exp(0.34849999999999998 * var_chaste_interface__cell__V);
        const double var_x161 = exp(0.079000000000000001 * var_chaste_interface__cell__V);
        const double var_x162 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V);
        ...
        const double var_x166 = var_x156 * pow(var_x157, (-3.0));
        const double var_x167 = 0.26917900403768508 * var_x166;
        const double var_x168 = var_chaste_interface__cell__V < -40.0;
        const double var_x169 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x170 = 1 / (0.16883116883116883 + 0.16883116883116883 * var_x169);
        const double var_x171 = var_x158 - var_chaste_interface__iNa_j_gate__j;
        const double var_x172 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
        const double var_x173 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
        ...
        const double var_x179 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x180 = 1.0 + var_x179;
        const double var_x181 = exp(-0.01052 * var_chaste_interface__cell__V);
        const double var_x182 = var_x181 / var_x180;
        const double var_x183 = 37.780000000000001 + var_chaste_interface__cell__V;
        const double var_x184 = 0.024240000000000001 * var_x182;
        const double var_x185 = var_x178 * var_x183;
        const double var_x186 = 0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x187 = -var_x186;
        const double var_x188 = exp(-3.2000000000000002 + var_x187);
        ...
        const double var_x192 = exp(0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x193 = 1.0 + var_x192;
        const double var_x194 = exp(2.5 - var_x18);
        const double var_x195 = 1.0 + var_x194;
        const double var_x196 = 1 / var_x195;
        const double var_x197 = exp(1.0 + var_x129);
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = 1 / var_x198;
        const double var_x200 = exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__cell__V);
        ...
        const double var_x204 = 1 / (1.0 * var_x196 + 1.3999999999999999 * var_x203);
        const double var_x205 = exp(3.0 + var_x186);
        const double var_x206 = 1.0 + var_x205;
        const double var_x207 = 1 / var_x206;
        const double var_x208 = exp(1.3 + var_x187);
        const double var_x209 = 1.0 + var_x208;
        const double var_x210 = 1 / var_x209;
        const double var_x211 = 1 + 0.037037037037037035 * var_chaste_interface__cell__V;
        const double var_x212 = pow(var_x211, 2.0);
        const double var_x213 = exp(-3.2400000000000002 * var_x212);
        const double var_x214 = 0.14285714285714285 * var_chaste_interface__cell__V;
        const double var_x215 = exp(2.8571428571428572 + var_x214);
        const double var_x216 = 1.0 + var_x215;
        const double var_x217 = var_x205 / pow(var_x206, 2);
        const double var_x218 = pow(var_x211, 1.0);
        const double var_x219 = 1 / (5.0 + 50.0 * var_x210 + 45.0 * var_x207 + 275.625 * var_x213);
        const double var_x220 = exp(2.5 + var_x187);
        const double var_x221 = 1.0 + var_x220;
        const double var_x222 = 1 / var_x221;
        const double var_x223 = exp(-3.0375000000000001 * var_x212);
        const double var_x224 = exp(5.0 + var_x214);
        const double var_x225 = 1.0 + var_x224;
        const double var_x226 = 1 / (40.0 * var_x207 + 15.5 * var_x222 + 281.0 * var_x223);
        const double var_x227 = pow(var_chaste_interface__Ca__Ca_ss, 2.0);
        const double var_x228 = 1 / (1.0 + 399.99999999999994 * var_x227);
        const double var_x229 = 1 / (2.0 + 80.0 * var_x228);
        const double var_x230 = pow(var_chaste_interface__Ca__Ca_ss, 1.0);
        const double var_x231 = var_x230 / pow((0.0025000000000000005 + var_x227), 2);
        const double var_x232 = 0.001 + var_chaste_interface__Ca__Ca_i;
        const double var_x233 = 1.0 + 0.00020000000000000001 * pow(var_x232, (-2.0));
        const double var_x234 = 1 / var_x233;
        const double var_x235 = 1.0 * var_x234;
        const double var_x236 = 2.2487821987979791e-6 * var_x68;
        const double var_x237 = 1.0 + 6.2499999999999997e-8 * pow(var_chaste_interface__Ca__Ca_i, (-2.0));
        const double var_x238 = pow(var_chaste_interface__Ca__Ca_i, (-3.0)) / pow(var_x237, 2);
        const double var_x239 = 1 / var_x237;
        const double var_x240 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_SR;
        const double var_x241 = pow(var_x240, (-2.0));
        const double var_x242 = 1 / (1.0 + 3.0 * var_x241);
        const double var_x243 = 1.0 * var_x242;
        const double var_x244 = 1 / var_chaste_interface__Ca__Ca_SR;
        const double var_x245 = pow(var_x244, 2.0);
        ...
        const double var_x254 = 1 - 0.59999999999999998 * var_x246;
        const double var_x255 = var_chaste_interface__Irel__R_prime / pow((0.40000000000000002 + var_x248), 2);
        const double var_x256 = var_x244 * var_x245 / pow((0.44444444444444442 + var_x245), 2);
        const double var_x257 = var_x253 * var_x255 * var_x256 * pow(var_chaste_interface__Ca__Ca_ss, 4.0) / pow(var_x254, 3);
        const double var_x258 = var_x253 / pow(var_x254, 2);
        const double var_x259 = var_x227 * var_x250 * var_x256 * var_x258;
        const double var_x260 = var_x255 * var_x258 * pow(var_chaste_interface__Ca__Ca_ss, 3.0);
        const double var_x261 = var_x230 * var_x247 * var_x250 * var_x253;
        const double var_x262 = var_x248 * var_x249 * var_x253;
        const double var_x263 = 0.0031491568724328679 * var_x49;
        const double var_x264 = var_x263 * var_x47;
        const double var_x265 = 0.00025000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x266 = 1.0 + 0.0001 * pow(var_x265, (-2.0));
        const double var_x267 = 1 / var_x266;
        const double var_x268 = 1.0 * var_x267;
        const double var_x269 = var_x263 * var_x267;
        const double var_x270 = var_x269 * var_x63;
        const double var_x271 = var_x269 * var_x65;
        const double var_x272 = 0.91833577176298442 * var_x251;
        const double var_x273 = -0.11249999999999999 + 0.067500000000000004 * var_x246;
        const double var_x274 = 0.00079924407711721393 * var_x34;
        const double var_x275 = 4.9560398636513786e-5 * var_x30;
        const double var_x276 = 1.4531710493040254e-5 * var_chaste_interface__ito_r_gate__r;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00076360000000000002 + 0.02163272650806156 * var_x53 - 0.039199999999999999 * var_x0 - 0.024 * var_chaste_interface__iKr_Markov__Or4 - 1.0943437499999999 * var_x43 - 1.7332440459884893e-5 * var_x16 - 0.0097300000000000008 * var_x3 - 0.60283998000000005 * var_x32 - 0.079260019999999987 * var_x8 - 0.0054081816270153899 * var_x54 - 4.2173344451359387e-8 * var_x37 - 0.0016270903010033445 * var_x38 - var_x29 * var_x31 - var_x35 * var_chaste_interface__iNa_h_gate__h - var_x47 * var_x50 - var_x9 * var_chaste_interface__ito_s_gate__s);
        IJth(rJacobian, 1, 0) = -var_x86 - var_x89;
        IJth(rJacobian, 2, 0) = var_x86 + var_x89;
        IJth(rJacobian, 3, 0) = -var_x98 - var_x100 * var_chaste_interface__iKr_Markov__Or4;
        IJth(rJacobian, 4, 0) = var_x98 - var_x109 + var_x106 * var_chaste_interface__iKr_Markov__Or4;
        IJth(rJacobian, 5, 0) = var_x109 + var_x105 * var_chaste_interface__iKr_Markov__Or4;
        IJth(rJacobian, 6, 0) = -var_x114 - var_x115;
        IJth(rJacobian, 7, 0) = var_x114 + var_x115;
        IJth(rJacobian, 8, 0) = -var_x116 - var_x100 * var_chaste_interface__iKr_Markov_Sotalol_block__BOr4;
        IJth(rJacobian, 9, 0) = var_x116 - var_x117 + var_x106 * var_chaste_interface__iKr_Markov_Sotalol_block__BOr4;
        IJth(rJacobian, 10, 0) = var_x117 + var_x105 * var_chaste_interface__iKr_Markov_Sotalol_block__BOr4;
        IJth(rJacobian, 11, 0) = 0.071428571428571425 * var_x118 * var_x128 / pow(var_x119, 2) + 5.1020408163265302e-7 * (-var_chaste_interface__iKs_Xs_gate__Xs + 1.0 / var_x119) * (93.333333333333329 * var_x123 * var_x124 / pow(var_x125, 2) - 116.66666666666666 * var_x121 * var_x126 / pow(var_x122, (3 / 2))) / pow((0.057142857142857141 + var_x127), 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__ito_s_gate__s + 1.0 / var_x136) * (1.0 * var_x130 / pow(var_x131, 2) + 23.90625 * var_x134 * pow(var_x133, 1.0)) / pow((0.035294117647058823 + var_x134 + 0.058823529411764705 * var_x132), 2) - 0.20000000000000001 * var_x135 * var_x137 / pow(var_x136, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x138 * var_x142 / pow(var_x139, 2) + 0.0046783625730994153 * var_x141 * pow(var_x140, 1.0) * (-var_chaste_interface__ito_r_gate__r + 1.0 / var_x139) / pow((0.084210526315789472 + var_x141), 2);
        IJth(rJacobian, 14, 0) = 0.22148394241417499 * var_x150 * var_x155 * pow(var_x151, (-3.0)) - 0.20000000000000001 * var_x149 * var_x152 * var_x153 + 99.999999999999986 * var_x152 * var_x154 * (0.00050000000000000001 * var_x146 / pow(var_x147, 2) + 0.020000000000000004 * var_x143 / pow(var_x144, 2)) / pow((var_x145 + var_x148), 2);
        IJth(rJacobian, 15, 0) = ((var_x168) ? (var_x159 * (108035.0 * var_x160 + 0.21330000000000002 * var_x161 - 0.008382352941176471 * var_x162) - var_x167 * (var_x163 + var_x164 + var_x165)) : (-var_x167 * var_x170 + 0.53361053361053368 * var_x159 * var_x169 / pow((1 + var_x169), 2)));
        IJth(rJacobian, 16, 0) = ((var_x168) ? (var_x171 * (var_x178 - 0.00025500480000000003 * var_x182 + var_x177 * var_x183 * (3.0508668000000001e-7 * var_x173 - 6214.6032000000005 * var_x172) + 0.0033402720000000005 * var_x179 * var_x181 / pow(var_x180, 2) - 0.311 * var_x174 * var_x175 * var_x183 / pow(var_x176, 2)) - var_x167 * (var_x184 + var_x185)) : (0.034200000000000001 * var_x171 * var_x191 - 0.16150740242261105 * var_x166 * var_x191 + 0.059999999999999998 * var_x171 * var_x188 * var_x190 / pow(var_x189, 2)));
        IJth(rJacobian, 17, 0) = 0.13333333333333333 * var_x192 * var_x204 / pow(var_x193, 2) + 0.51020408163265307 * (-var_chaste_interface__iCaL_d_gate__d + 1.0 / var_x193) * (-0.050000000000000003 * var_x194 / pow(var_x195, 2) + 0.27999999999999997 * var_x197 * var_x202 / pow(var_x198, 2) - 0.15076923076923077 * var_x199 * var_x200 / pow(var_x201, 2)) / pow((var_x203 + 0.7142857142857143 * var_x196), 2);
        IJth(rJacobian, 18, 0) = 1.3163239596670111e-5 * (-var_chaste_interface__iCaL_f_gate__f + 1.0 / var_x216) * (4.5 * var_x217 + 66.150000000000006 * var_x213 * var_x218 - 5.0 * var_x208 / pow(var_x209, 2)) / pow((0.018140589569160998 + var_x213 + 0.16326530612244897 * var_x207 + 0.18140589569160998 * var_x210), 2) - 0.14285714285714285 * var_x215 * var_x219 / pow(var_x216, 2);
        IJth(rJacobian, 19, 0) = 1.2664479933131545e-5 * (0.25 - var_chaste_interface__iCaL_f2_gate__f2 + 0.75 / var_x225) * (4.0 * var_x217 + 63.225000000000001 * var_x218 * var_x223 - 1.55 * var_x220 / pow(var_x221, 2)) / pow((var_x223 + 0.055160142348754451 * var_x222 + 0.14234875444839859 * var_x207), 2) - 0.10714285714285714 * var_x224 * var_x226 / pow(var_x225, 2);
        IJth(rJacobian, 21, 0) = var_x235 * (-1.7205545223759661e-8 + 1.2593500345045236e-9 * var_x16 + 3.0642541604521007e-12 * var_x37);
        IJth(rJacobian, 23, 0) = var_x268 * (-var_x264 + 0.00023577038909270115 * var_x53 - 5.8942597273175287e-5 * var_x54);
        IJth(rJacobian, 25, 0) = -2.1070980214908366e-8 - 3.7780501035135707e-9 * var_x16 - 0.00023854029832302029 * var_x43 - 9.1927624813563017e-12 * var_x37 - var_x274 * var_chaste_interface__iNa_h_gate__h;
        IJth(rJacobian, 26, 0) = 0.00015902686554868019 * var_x43 - 1.7438052591648303e-6 * var_chaste_interface__iKr_Markov__Or4 - 7.0696771548640841e-7 * var_x3 - 2.8482152566358896e-6 * var_x0 - 5.7589183215629007e-6 * var_x8 - 4.3801480314950888e-5 * var_x32 - 1.1822202600107164e-7 * var_x38 - var_x275 * var_x29 - var_x276 * var_chaste_interface__ito_s_gate__s;
        IJth(rJacobian, 1, 1) = var_x91;
        IJth(rJacobian, 2, 1) = var_x90;
        IJth(rJacobian, 1, 2) = var_x92;
        IJth(rJacobian, 2, 2) = var_x94;
        IJth(rJacobian, 3, 2) = var_x93;
        IJth(rJacobian, 2, 3) = var_x95;
        IJth(rJacobian, 3, 3) = var_x102;
        IJth(rJacobian, 4, 3) = var_x101;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (0.64113025583269567 * var_x5 - 0.024 * var_chaste_interface__cell__V);
        IJth(rJacobian, 3, 4) = var_x103;
        IJth(rJacobian, 4, 4) = var_x111;
        IJth(rJacobian, 5, 4) = var_x110;
        IJth(rJacobian, 26, 4) = 4.6583596330447822e-5 * var_x5 - 1.7438052591648303e-6 * var_chaste_interface__cell__V;
        IJth(rJacobian, 4, 5) = var_x112;
        IJth(rJacobian, 5, 5) = var_x113;
        IJth(rJacobian, 6, 6) = var_x91;
        IJth(rJacobian, 7, 6) = var_x90;
        IJth(rJacobian, 6, 7) = var_x92;
        IJth(rJacobian, 7, 7) = var_x94;
        IJth(rJacobian, 8, 7) = var_x93;
        IJth(rJacobian, 7, 8) = var_x95;
        IJth(rJacobian, 8, 8) = var_x102;
        IJth(rJacobian, 9, 8) = var_x101;
        IJth(rJacobian, 4, 9) = 0.00125;
        IJth(rJacobian, 8, 9) = var_x103;
        IJth(rJacobian, 9, 9) = -0.00125 + var_x111;
        IJth(rJacobian, 10, 9) = var_x110;
        IJth(rJacobian, 9, 10) = var_x112;
        IJth(rJacobian, 10, 10) = var_x113;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-0.078399999999999997 * var_x56);
        IJth(rJacobian, 11, 11) = -var_x128;
        IJth(rJacobian, 26, 11) = -5.6964305132717792e-6 * var_x56;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x30 * var_x9);
        IJth(rJacobian, 12, 12) = -var_x137;
        IJth(rJacobian, 26, 12) = -var_x276 * var_x30;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.20000000000000001 * var_x57);
        IJth(rJacobian, 13, 13) = -var_x142;
        IJth(rJacobian, 26, 13) = -1.4531710493040254e-5 * var_x57;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-33.0 * var_x61);
        IJth(rJacobian, 14, 14) = -1.0 * var_x155;
        IJth(rJacobian, 25, 14) = -0.0023977322313516419 * var_x61;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x35 * var_x59);
        IJth(rJacobian, 15, 15) = ((var_x168) ? (-var_x163 - var_x164 - var_x165) : (-var_x170));
        IJth(rJacobian, 25, 15) = -var_x274 * var_x59;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-11.0 * var_x62);
        IJth(rJacobian, 16, 16) = ((var_x168) ? (-var_x184 - var_x185) : (-0.59999999999999998 * var_x191));
        IJth(rJacobian, 25, 16) = -0.00079924407711721393 * var_x62;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * var_chaste_interface__iCaL_f_gate__f);
        IJth(rJacobian, 17, 17) = -var_x204;
        IJth(rJacobian, 23, 17) = -var_x270 * var_chaste_interface__iCaL_f_gate__f;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * var_chaste_interface__iCaL_d_gate__d);
        IJth(rJacobian, 18, 18) = -var_x219;
        IJth(rJacobian, 23, 18) = -var_x270 * var_chaste_interface__iCaL_d_gate__d;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x66 * var_chaste_interface__iCaL_fCass_gate__fCass);
        IJth(rJacobian, 19, 19) = -var_x226;
        IJth(rJacobian, 23, 19) = -var_x271 * var_chaste_interface__iCaL_fCass_gate__fCass;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x66 * var_chaste_interface__iCaL_f2_gate__f2);
        IJth(rJacobian, 20, 20) = -var_x229;
        IJth(rJacobian, 23, 20) = -var_x271 * var_chaste_interface__iCaL_f2_gate__f2;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (0.061899999999999997 * var_x70 + 118.90054155481037 * var_x71 - 0.061899999999999997 * var_x68 - 0.0063258185242159306 * var_x69);
        IJth(rJacobian, 21, 21) = var_x235 * (-0.0038240087783467445 - var_x236 + 2.2487821987979791e-6 * var_x70 - 2.298124085635426e-7 * var_x69 - 0.0086391412367010315 * var_x71 - 5.3144431236283834e-11 * var_x238) + 0.00040000000000000002 * pow(var_x232, (-3.0)) * (2.40087783467447e-5 * var_chaste_interface__Ca__Ca_SR + 2.298124085635426e-7 * log(2.0 * var_x69) + 0.0038 * var_chaste_interface__Ca__Ca_ss - 1.7205545223759661e-8 * var_chaste_interface__cell__V - 0.00042515544989027069 * var_x239 - 0.0038240087783467445 * var_chaste_interface__Ca__Ca_i - var_x236 * var_chaste_interface__Ca__Ca_i + 1.2593500345045236e-9 * var_x12 * var_x36) / pow(var_x233, 2);
        IJth(rJacobian, 22, 21) = var_x243 * (0.00036000000000000002 + 7.968749999999999e-10 * var_x238);
        IJth(rJacobian, 23, 21) = 1.1399999999999999 * var_x267;
        IJth(rJacobian, 25, 21) = 0.025917423710103096 * var_x71;
        IJth(rJacobian, 21, 22) = 2.40087783467447e-5 * var_x234;
        IJth(rJacobian, 22, 22) = var_x243 * (-0.00036000000000000002 - var_x252 + 0.026112 * var_x257 - 0.0097919999999999986 * var_x259) + 0.66666666666666663 * pow(var_x240, (-3.0)) * (0.00036000000000000002 * var_chaste_interface__Ca__Ca_i + 0.0063749999999999996 * var_x239 - 0.00036000000000000002 * var_chaste_interface__Ca__Ca_SR - var_x252 * var_x253) / pow((0.33333333333333331 + var_x241), 2);
        IJth(rJacobian, 23, 22) = var_x268 * (var_x272 + 0.19591163130943667 * var_x259 - 0.52243101682516446 * var_x257);
        IJth(rJacobian, 24, 22) = 0.060000000000000005 * var_x256 * var_chaste_interface__Ca__Ca_ss * var_chaste_interface__Irel__R_prime;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.072236434794126267 * var_x72);
        IJth(rJacobian, 20, 23) = -0.0020000000000000005 * var_x229 * var_x231 + 6.2500000000000015e-5 * var_x231 * (0.59999999999999998 - var_chaste_interface__iCaL_fCass_gate__fCass + 0.40000000000000002 * var_x228) / pow((0.025000000000000001 + var_x228), 2);
        IJth(rJacobian, 21, 23) = 0.0038 * var_x234;
        IJth(rJacobian, 22, 23) = var_x243 * (var_x252 + 0.097919999999999993 * var_x260 - 0.091799999999999993 * var_x261);
        IJth(rJacobian, 23, 23) = var_x268 * (-1.1399999999999999 - var_x272 + 1.8366715435259688 * var_x261 - 0.00078728921810821697 * var_x72 - 1.9591163130943667 * var_x260) + 0.00020000000000000001 * pow(var_x265, (-3.0)) * (1.1399999999999999 * var_chaste_interface__Ca__Ca_i - 1.1399999999999999 * var_chaste_interface__Ca__Ca_ss + var_x253 * var_x272 - var_x264 * var_x51) / pow(var_x266, 2);
        IJth(rJacobian, 24, 23) = var_x273 * var_chaste_interface__Irel__R_prime;
        IJth(rJacobian, 22, 24) = -0.045899999999999996 * var_x242 * var_x262;
        IJth(rJacobian, 23, 24) = 0.91833577176298442 * var_x262 * var_x267;
        IJth(rJacobian, 24, 24) = -0.0050000000000000001 + var_x273 * var_chaste_interface__Ca__Ca_ss;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (0.00068396484375 * var_x76 - 1.0943437499999999 * var_x74 - 293.85136725665217 * var_x78 - 0.0077469905913117388 * var_x58 - 0.00010399464275930937 * var_x77 - 0.031415382535802082 * var_x75);
        IJth(rJacobian, 21, 25) = 7.5561002070271413e-9 * var_x234 * var_x77;
        IJth(rJacobian, 25, 25) = 1.4908768645188767e-7 * var_x76 - 0.00023854029832302029 * var_x74 - 5.6288512232624455e-7 * var_x58 - 2.2668300621081424e-8 * var_x77 - 0.021350814984788587 * var_x78;
        IJth(rJacobian, 26, 25) = 0.00015902686554868019 * var_x74 - 2.2825962201919434e-6 * var_x75 - 9.9391790967925116e-8 * var_x76;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (-18.221456145978404 * var_x80 - 0.64113025583269567 * var_x81 - 5.3427521319391307 * var_x83 - 1.0471794178600695 * var_x75 - 0.25992489121883872 * var_x82 - var_x31 * var_x79);
        IJth(rJacobian, 26, 26) = -1.8885766345635726e-5 * var_x82 - 0.0013239446273749359 * var_x80 - 4.6583596330447822e-5 * var_x81 - 7.6086540673064781e-5 * var_x75 - 0.00038819663608706523 * var_x83 - var_x275 * var_x79;
    }
