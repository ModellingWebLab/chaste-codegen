...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellfink_noble_giles_model_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x29 = var_x28 * pow(var_chaste_interface__Na__Na_i, 3.0);
        ...
        const double var_x57 = pow(var_chaste_interface__iKs_Xs_gate__Xs, 1.0) * (-26.713760659695652 * log(9.5999999999999996 / var_x56) + var_chaste_interface__cell__V);
        ...
        const double var_x77 = var_x26 * var_x28 * pow(var_chaste_interface__Na__Na_i, 2.0);
        ...
        const double var_x274 = 0.91833577176298453 * var_x254;
        ...
        const double var_x277 = 1.0050926558006126e-5 * var_x21;
        ...
        IJth(rJacobian, 23, 0) = var_x270 * (-var_x266 + 0.00023577038909270109 * var_x51 - 5.8942597273175273e-5 * var_x52);
        IJth(rJacobian, 25, 0) = -2.1070980214908366e-8 - 9.1927624813563017e-12 * var_x35 - 3.7780501035135707e-9 * var_x30 - 0.00023854029832302029 * var_x41 - var_x276 * var_chaste_interface__iNa_h_gate__h;
        IJth(rJacobian, 26, 0) = var_x278 + 0.00015902686554868019 * var_x41 - 1.7438052591648303e-6 * var_chaste_interface__iKr_Markov__Or4 - 1.4531710493040254e-5 * var_x23 - 1.1822202600107163e-7 * var_x36 - 7.0696771548640841e-7 * var_x3 - 2.8482152566358896e-6 * var_x0 + var_x6 * (2.3119525668406228e-8 * var_x9 - 3.4651837760272254e-7 * var_x17 - var_x20 * var_x277);
        ...
        IJth(rJacobian, 21, 21) = var_x238 * (-0.0038240087783467445 - var_x239 + 2.2487821987979791e-6 * var_x71 - 0.0086391412367010315 * var_x72 - 5.3144431236283834e-11 * var_x241 - 2.298124085635426e-7 * var_x70) + 0.00040000000000000002 * pow(var_x235, (-3.0)) * (0.0038 * var_chaste_interface__Ca__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__Ca__Ca_SR + 2.298124085635426e-7 * log(2.0 * var_x70) - 0.0038240087783467445 * var_chaste_interface__Ca__Ca_i - 1.7205545223759661e-8 * var_chaste_interface__cell__V - 0.00042515544989027063 * var_x242 - var_x239 * var_chaste_interface__Ca__Ca_i + 1.2593500345045236e-9 * var_x26 * var_x34) / pow(var_x236, 2);
        ...
        IJth(rJacobian, 22, 22) = var_x246 * (-0.00036000000000000002 - var_x255 + 0.065280000000000005 * var_x261 - 0.0097919999999999986 * var_x259) + 0.66666666666666674 * pow(var_x243, (-3.0)) * (0.00036000000000000002 * var_chaste_interface__Ca__Ca_i + 0.0063749999999999996 * var_x242 - 0.00036000000000000002 * var_chaste_interface__Ca__Ca_SR - var_x255 * var_x256) / pow((0.33333333333333337 + var_x244), 2);
        IJth(rJacobian, 23, 22) = var_x270 * (var_x274 + 0.1959116313094367 * var_x259 - 1.3060775420629114 * var_x261);
        IJth(rJacobian, 24, 22) = 0.059999999999999998 * var_x258 * var_chaste_interface__Ca__Ca_ss * var_chaste_interface__Irel__R_prime;
        ...
        IJth(rJacobian, 23, 24) = 0.91833577176298453 * var_x264 * var_x269;
        ...
        IJth(rJacobian, 21, 25) = 7.5561002070271413e-9 * var_x237 * var_x77;
        ...
        IJth(rJacobian, 26, 26) = -4.6583596330447822e-5 * var_x84 - 1.8885766345635723e-5 * var_x85 - 0.00038819663608706523 * var_x86 - 0.00073043079046142181 * var_x78 + var_x278 * var_x83 + var_x6 * (6.576305692690868e-7 * var_x80 - 9.8566502268897146e-6 * var_x82 - var_x277 * var_x81);
    }
