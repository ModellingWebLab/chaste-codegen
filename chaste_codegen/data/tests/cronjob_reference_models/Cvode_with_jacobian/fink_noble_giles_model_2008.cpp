...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellfink_noble_giles_model_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x27 = exp(0.013101861787960915 * var_chaste_interface__cell__V);
        const double var_x28 = var_x27 * pow(var_chaste_interface__Na__Na_i, 3.0);
        const double var_x29 = var_x24 * var_chaste_interface__Ca__Ca_i;
        const double var_x30 = var_x26 * (0.026203723575921829 * var_x28 + 166917.71917862206 * var_x29);
        ...
        const double var_x34 = 2.0 * var_x28 - 6860000.0 * var_x29;
        ...
        const double var_x39 = exp(-0.0037433890822745476 * var_chaste_interface__cell__V);
        const double var_x40 = 1.0 + 0.035299999999999998 * var_x38 + 0.1245 * var_x39;
        const double var_x41 = var_x37 * (0.00046605194074318115 * var_x39 + 0.0013214163460429152 * var_x38) * var_chaste_interface__Na__Na_i / pow(var_x40, 2);
        ...
        const double var_x48 = 0.28894573917650507 * var_x47;
        ...
        const double var_x55 = -0.079260019999999987 * var_x53 - 0.60283998000000005 * var_x54;
        const double var_x56 = 0.029999999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i;
        const double var_x57 = pow(var_chaste_interface__iKs_Xs_gate__Xs, 1.0) * (-26.713760659695652 * log(9.6000000000000014 / var_x56) + var_chaste_interface__cell__V);
        ...
        const double var_x62 = var_x61 * pow(var_chaste_interface__iNa_m_gate__m, 2.0) * var_chaste_interface__iNa_j_gate__j;
        ...
        const double var_x77 = var_x0 * (0.10416666666666666 * var_chaste_interface__K__K_i + 0.0031249999999999997 * var_chaste_interface__Na__Na_i) / pow(var_x56, 2);
        const double var_x78 = var_x26 * var_x27 * pow(var_chaste_interface__Na__Na_i, 2.0);
        const double var_x79 = var_x32 * var_x59 * var_chaste_interface__iNa_h_gate__h;
        const double var_x80 = var_x4 * var_x9;
        const double var_x81 = -12.370953657054677 * var_x14 * var_x4 - 0.0020091970628488172 * var_x15 * var_x4 - 0.33754510655860126 * var_x19 * var_x4;
        const double var_x82 = var_x17 * var_x4;
        const double var_x83 = 26.713760659695652 * var_x4;
        const double var_x84 = var_x3 * var_x4;
        const double var_x85 = var_x4 * var_chaste_interface__iKr_Markov__Or4;
        ...
        const double var_x136 = 1 + 0.022222222222222223 * var_chaste_interface__cell__V;
        const double var_x137 = exp(-6.328125 * pow(var_x136, 2.0));
        const double var_x138 = exp(4.0 + var_x132);
        const double var_x139 = 1.0 + var_x138;
        const double var_x140 = 1 / (3.0 + 5.0 * var_x135 + 85.0 * var_x137);
        const double var_x141 = exp(3.3333333333333335 + var_x121);
        const double var_x142 = 1.0 + var_x141;
        const double var_x143 = 1 + 0.025000000000000001 * var_chaste_interface__cell__V;
        const double var_x144 = exp(-0.88888888888888884 * pow(var_x143, 2.0));
        const double var_x145 = 1 / (0.80000000000000004 + 9.5 * var_x144);
        const double var_x146 = exp(7.0 + var_x132);
        const double var_x147 = 1.0 + var_x146;
        const double var_x148 = 1 / var_x147;
        const double var_x149 = exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__cell__V);
        ...
        const double var_x153 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__cell__V);
        const double var_x154 = 1.0 + var_x153;
        const double var_x155 = -var_chaste_interface__iNa_m_gate__m + 1.0 * pow(var_x154, (-2.0));
        const double var_x156 = exp(-12.0 - var_x132);
        const double var_x157 = 1.0 + var_x156;
        const double var_x158 = var_x152 * var_x157;
        const double var_x159 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V);
        const double var_x160 = 1.0 + var_x159;
        const double var_x161 = 1.0 * pow(var_x160, (-2.0));
        const double var_x162 = var_x161 - var_chaste_interface__iNa_h_gate__h;
        ...
        const double var_x165 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V);
        ...
        const double var_x169 = var_x159 * pow(var_x160, (-3.0));
        const double var_x170 = 0.26917900403768508 * var_x169;
        const double var_x171 = var_chaste_interface__cell__V < -40.0;
        const double var_x172 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x173 = 1 / (0.16883116883116883 + 0.16883116883116883 * var_x172);
        const double var_x174 = var_x161 - var_chaste_interface__iNa_j_gate__j;
        ...
        const double var_x214 = 1 + 0.037037037037037035 * var_chaste_interface__cell__V;
        const double var_x215 = pow(var_x214, 2.0);
        const double var_x216 = exp(-3.2400000000000002 * var_x215);
        const double var_x217 = 0.14285714285714285 * var_chaste_interface__cell__V;
        const double var_x218 = exp(2.8571428571428572 + var_x217);
        const double var_x219 = 1.0 + var_x218;
        const double var_x220 = var_x207 / pow(var_x208, 2);
        const double var_x221 = pow(var_x214, 1.0);
        const double var_x222 = 1 / (5.0 + 50.0 * var_x213 + 45.0 * var_x209 + 275.625 * var_x216);
        const double var_x223 = exp(2.5 + var_x210);
        const double var_x224 = 1.0 + var_x223;
        const double var_x225 = 1 / var_x224;
        const double var_x226 = exp(-3.0375000000000001 * var_x215);
        const double var_x227 = exp(5.0 + var_x217);
        const double var_x228 = 1.0 + var_x227;
        const double var_x229 = 1 / (40.0 * var_x209 + 15.5 * var_x225 + 281.0 * var_x226);
        const double var_x230 = pow(var_chaste_interface__Ca__Ca_ss, 2.0);
        const double var_x231 = 1 / (1.0 + 399.99999999999994 * var_x230);
        const double var_x232 = 1 / (2.0 + 80.0 * var_x231);
        const double var_x233 = pow(var_chaste_interface__Ca__Ca_ss, 1.0);
        const double var_x234 = var_x233 / pow((0.0025000000000000005 + var_x230), 2);
        const double var_x235 = 0.001 + var_chaste_interface__Ca__Ca_i;
        const double var_x236 = 1.0 + 0.00020000000000000001 * pow(var_x235, (-2.0));
        const double var_x237 = 1 / var_x236;
        const double var_x238 = 1.0 * var_x237;
        const double var_x239 = 2.2487821987979791e-6 * var_x69;
        const double var_x240 = 1.0 + 6.2499999999999997e-8 * pow(var_chaste_interface__Ca__Ca_i, (-2.0));
        const double var_x241 = pow(var_chaste_interface__Ca__Ca_i, (-3.0)) / pow(var_x240, 2);
        const double var_x242 = 1 / var_x240;
        const double var_x243 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_SR;
        const double var_x244 = pow(var_x243, (-2.0));
        const double var_x245 = 1 / (1.0 + 3.0 * var_x244);
        const double var_x246 = 1.0 * var_x245;
        const double var_x247 = 1 / var_chaste_interface__Ca__Ca_SR;
        const double var_x248 = pow(var_x247, 2.0);
        const double var_x249 = 1 / (1.0 + 2.25 * var_x248);
        const double var_x250 = 1 / (2.5 - 1.5 * var_x249);
        const double var_x251 = var_x230 * var_x250;
        const double var_x252 = 1 / (0.059999999999999998 + 0.14999999999999999 * var_x251);
        const double var_x253 = var_x252 * var_chaste_interface__Irel__R_prime;
        const double var_x254 = var_x251 * var_x253;
        const double var_x255 = 0.045899999999999996 * var_x254;
        const double var_x256 = -var_chaste_interface__Ca__Ca_ss + var_chaste_interface__Ca__Ca_SR;
        const double var_x257 = var_x256 / pow((1 - 0.59999999999999998 * var_x249), 2);
        const double var_x258 = var_x247 * var_x248 / pow((0.44444444444444442 + var_x248), 2);
        const double var_x259 = var_x230 * var_x253 * var_x257 * var_x258;
        const double var_x260 = var_x257 * var_chaste_interface__Irel__R_prime / pow((0.40000000000000002 + var_x251), 2);
        const double var_x261 = var_x250 * var_x258 * var_x260 * pow(var_chaste_interface__Ca__Ca_ss, 4.0);
        const double var_x262 = var_x260 * pow(var_chaste_interface__Ca__Ca_ss, 3.0);
        const double var_x263 = var_x233 * var_x250 * var_x253 * var_x256;
        const double var_x264 = var_x251 * var_x252 * var_x256;
        const double var_x265 = 0.0031491568724328679 * var_x47;
        const double var_x266 = var_x265 * var_x45;
        const double var_x267 = 0.00025000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x268 = 1.0 + 0.0001 * pow(var_x267, (-2.0));
        const double var_x269 = 1 / var_x268;
        const double var_x270 = 1.0 * var_x269;
        const double var_x271 = var_x265 * var_x269;
        const double var_x272 = var_x271 * var_x64;
        const double var_x273 = var_x271 * var_x66;
        const double var_x274 = 0.91833577176298442 * var_x254;
        const double var_x275 = -0.11249999999999999 + 0.067500000000000004 * var_x249;
        const double var_x276 = 0.00079924407711721393 * var_x32;
        const double var_x277 = 1.0050926558006127e-5 * var_x21;
        const double var_x278 = -4.3801480314950888e-5 * var_x54 - 5.7589183215629007e-6 * var_x53;
        const double var_x279 = 0.00038819663608706523 * var_x5 - 1.4531710493040254e-5 * var_chaste_interface__cell__V;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00076360000000000002 + var_x55 + 0.02163272650806156 * var_x51 - 0.039199999999999999 * var_x0 - 0.20000000000000001 * var_x23 - 1.0943437499999999 * var_x41 - 0.0097300000000000008 * var_x3 - 4.2173344451359387e-8 * var_x35 - 1.7332440459884893e-5 * var_x30 - 0.0054081816270153899 * var_x52 - 0.024 * var_chaste_interface__iKr_Markov__Or4 - 0.0016270903010033445 * var_x36 + var_x6 * (0.00031819414073076916 * var_x9 - 0.0047691340640000001 * var_x17 - var_x20 * var_x22) - var_x33 * var_chaste_interface__iNa_h_gate__h - var_x45 * var_x48);
        ...
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__ito_s_gate__s + 1.0 / var_x139) * (1.0 * var_x133 / pow(var_x134, 2) + 23.90625 * var_x137 * pow(var_x136, 1.0)) / pow((0.035294117647058823 + var_x137 + 0.058823529411764705 * var_x135), 2) - 0.20000000000000001 * var_x138 * var_x140 / pow(var_x139, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x141 * var_x145 / pow(var_x142, 2) + 0.0046783625730994153 * var_x144 * pow(var_x143, 1.0) * (-var_chaste_interface__ito_r_gate__r + 1.0 / var_x142) / pow((0.084210526315789472 + var_x144), 2);
        IJth(rJacobian, 14, 0) = 0.22148394241417499 * var_x153 * var_x158 * pow(var_x154, (-3.0)) - 0.20000000000000001 * var_x152 * var_x155 * var_x156 + 99.999999999999986 * var_x155 * var_x157 * (0.02 * var_x146 / pow(var_x147, 2) + 0.00050000000000000001 * var_x149 / pow(var_x150, 2)) / pow((var_x148 + var_x151), 2);
        IJth(rJacobian, 15, 0) = ((var_x171) ? (var_x162 * (108035.0 * var_x163 + 0.21330000000000002 * var_x164 - 0.008382352941176471 * var_x165) - var_x170 * (var_x166 + var_x167 + var_x168)) : (-var_x170 * var_x173 + 0.53361053361053368 * var_x162 * var_x172 / pow((1 + var_x172), 2)));
        IJth(rJacobian, 16, 0) = ((var_x171) ? (var_x174 * (var_x181 - 0.00025500480000000003 * var_x185 + var_x180 * var_x186 * (3.0508668000000001e-7 * var_x176 - 6214.6032000000005 * var_x175) + 0.0033402720000000005 * var_x182 * var_x184 / pow(var_x183, 2) - 0.311 * var_x177 * var_x178 * var_x186 / pow(var_x179, 2)) - var_x170 * (var_x187 + var_x188)) : (0.034200000000000001 * var_x174 * var_x192 - 0.16150740242261102 * var_x169 * var_x192 + 0.059999999999999998 * var_x174 * var_x189 * var_x191 / pow(var_x190, 2)));
        IJth(rJacobian, 17, 0) = 0.51020408163265307 * (-var_chaste_interface__iCaL_d_gate__d + 1.0 / var_x204) * (-0.050000000000000003 * var_x193 / pow(var_x194, 2) + 0.27999999999999997 * var_x196 * var_x201 / pow(var_x197, 2) - 0.15076923076923074 * var_x198 * var_x199 / pow(var_x200, 2)) / pow((var_x202 + 0.7142857142857143 * var_x195), 2) + 0.13333333333333333 * var_x203 * var_x205 / pow(var_x204, 2);
        IJth(rJacobian, 18, 0) = 1.3163239596670111e-5 * (-var_chaste_interface__iCaL_f_gate__f + 1.0 / var_x219) * (4.5 * var_x220 + 66.150000000000006 * var_x216 * var_x221 - 5.0 * var_x211 / pow(var_x212, 2)) / pow((0.018140589569160998 + var_x216 + 0.16326530612244897 * var_x209 + 0.18140589569160998 * var_x213), 2) - 0.14285714285714285 * var_x218 * var_x222 / pow(var_x219, 2);
        IJth(rJacobian, 19, 0) = 1.2664479933131545e-5 * (0.25 - var_chaste_interface__iCaL_f2_gate__f2 + 0.75 / var_x228) * (4.0 * var_x220 + 63.225000000000001 * var_x221 * var_x226 - 1.55 * var_x223 / pow(var_x224, 2)) / pow((var_x226 + 0.055160142348754451 * var_x225 + 0.14234875444839859 * var_x209), 2) - 0.10714285714285714 * var_x227 * var_x229 / pow(var_x228, 2);
        IJth(rJacobian, 21, 0) = var_x238 * (-1.7205545223759661e-8 + 3.0642541604521007e-12 * var_x35 + 1.2593500345045236e-9 * var_x30);
        IJth(rJacobian, 23, 0) = var_x270 * (-var_x266 + 0.00023577038909270112 * var_x51 - 5.894259727317528e-5 * var_x52);
        IJth(rJacobian, 25, 0) = -2.1070980214908366e-8 - 3.7780501035135707e-9 * var_x30 - 0.00023854029832302029 * var_x41 - 9.1927624813563017e-12 * var_x35 - var_x276 * var_chaste_interface__iNa_h_gate__h;
        IJth(rJacobian, 26, 0) = var_x278 + 0.00015902686554868019 * var_x41 - 7.0696771548640841e-7 * var_x3 - 2.8482152566358896e-6 * var_x0 - 1.4531710493040254e-5 * var_x23 - 1.7438052591648303e-6 * var_chaste_interface__iKr_Markov__Or4 - 1.1822202600107163e-7 * var_x36 + var_x6 * (2.3119525668406228e-8 * var_x9 - 3.4651837760272254e-7 * var_x17 - var_x20 * var_x277);
        ...
        IJth(rJacobian, 26, 4) = 4.6583596330447829e-5 * var_x5 - 1.7438052591648303e-6 * var_chaste_interface__cell__V;
        ...
        IJth(rJacobian, 26, 12) = var_x279 * var_chaste_interface__ito_r_gate__r;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x58 * var_chaste_interface__ito_s_gate__s);
        IJth(rJacobian, 13, 13) = -var_x145;
        IJth(rJacobian, 26, 13) = var_x279 * var_chaste_interface__ito_s_gate__s;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-33.0 * var_x62);
        IJth(rJacobian, 14, 14) = -1.0 * var_x158;
        IJth(rJacobian, 25, 14) = -0.0023977322313516419 * var_x62;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x33 * var_x60);
        IJth(rJacobian, 15, 15) = ((var_x171) ? (-var_x166 - var_x167 - var_x168) : (-var_x173));
        IJth(rJacobian, 25, 15) = -var_x276 * var_x60;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-11.0 * var_x63);
        IJth(rJacobian, 16, 16) = ((var_x171) ? (-var_x187 - var_x188) : (-0.59999999999999998 * var_x192));
        ...
        IJth(rJacobian, 23, 17) = -var_x272 * var_chaste_interface__iCaL_f_gate__f;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * var_chaste_interface__iCaL_d_gate__d);
        IJth(rJacobian, 18, 18) = -var_x222;
        IJth(rJacobian, 23, 18) = -var_x272 * var_chaste_interface__iCaL_d_gate__d;
        ...
        IJth(rJacobian, 23, 19) = -var_x273 * var_chaste_interface__iCaL_fCass_gate__fCass;
        ...
        IJth(rJacobian, 23, 20) = -var_x273 * var_chaste_interface__iCaL_f2_gate__f2;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (0.061899999999999997 * var_x71 + 118.90054155481037 * var_x72 - 0.061899999999999997 * var_x69 - 0.0063258185242159306 * var_x70);
        IJth(rJacobian, 21, 21) = var_x238 * (-0.0038240087783467445 - var_x239 + 2.2487821987979791e-6 * var_x71 - 2.298124085635426e-7 * var_x70 - 0.0086391412367010333 * var_x72 - 5.314443123628384e-11 * var_x241) + 0.00040000000000000002 * pow(var_x235, (-3.0)) * (2.40087783467447e-5 * var_chaste_interface__Ca__Ca_SR + 0.0038 * var_chaste_interface__Ca__Ca_ss + 2.298124085635426e-7 * log(2.0 * var_x70) - 0.00042515544989027069 * var_x242 - 0.0038240087783467445 * var_chaste_interface__Ca__Ca_i - 1.7205545223759661e-8 * var_chaste_interface__cell__V - var_x239 * var_chaste_interface__Ca__Ca_i + 1.2593500345045236e-9 * var_x26 * var_x34) / pow(var_x236, 2);
        IJth(rJacobian, 22, 21) = var_x246 * (0.00036000000000000002 + 7.96875e-10 * var_x241);
        IJth(rJacobian, 23, 21) = 1.1399999999999999 * var_x269;
        IJth(rJacobian, 25, 21) = 0.025917423710103096 * var_x72;
        IJth(rJacobian, 21, 22) = 2.40087783467447e-5 * var_x237;
        IJth(rJacobian, 22, 22) = var_x246 * (-0.00036000000000000002 - var_x255 + 0.065280000000000005 * var_x261 - 0.0097919999999999986 * var_x259) + 0.66666666666666663 * pow(var_x243, (-3.0)) * (0.00036000000000000002 * var_chaste_interface__Ca__Ca_i + 0.0063749999999999996 * var_x242 - 0.00036000000000000002 * var_chaste_interface__Ca__Ca_SR - var_x255 * var_x256) / pow((0.33333333333333331 + var_x244), 2);
        IJth(rJacobian, 23, 22) = var_x270 * (var_x274 + 0.19591163130943667 * var_x259 - 1.3060775420629114 * var_x261);
        IJth(rJacobian, 24, 22) = 0.060000000000000005 * var_x258 * var_chaste_interface__Ca__Ca_ss * var_chaste_interface__Irel__R_prime;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.072236434794126267 * var_x73);
        IJth(rJacobian, 20, 23) = -0.0020000000000000005 * var_x232 * var_x234 + 6.2500000000000001e-5 * var_x234 * (0.59999999999999998 - var_chaste_interface__iCaL_fCass_gate__fCass + 0.40000000000000002 * var_x231) / pow((0.025000000000000001 + var_x231), 2);
        IJth(rJacobian, 21, 23) = 0.0038 * var_x237;
        IJth(rJacobian, 22, 23) = var_x246 * (var_x255 + 0.097920000000000007 * var_x262 - 0.091799999999999993 * var_x263);
        IJth(rJacobian, 23, 23) = var_x270 * (-1.1399999999999999 - var_x274 + 1.8366715435259688 * var_x263 - 0.00078728921810821697 * var_x73 - 1.959116313094367 * var_x262) + 0.00020000000000000001 * pow(var_x267, (-3.0)) * (1.1399999999999999 * var_chaste_interface__Ca__Ca_i - 1.1399999999999999 * var_chaste_interface__Ca__Ca_ss + var_x256 * var_x274 - var_x266 * var_x49) / pow(var_x268, 2);
        IJth(rJacobian, 24, 23) = var_x275 * var_chaste_interface__Irel__R_prime;
        IJth(rJacobian, 22, 24) = -0.045899999999999996 * var_x245 * var_x264;
        IJth(rJacobian, 23, 24) = 0.91833577176298442 * var_x264 * var_x269;
        IJth(rJacobian, 24, 24) = -0.0050000000000000001 + var_x275 * var_chaste_interface__Ca__Ca_ss;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (0.00068396484375 * var_x76 - 1.0943437499999999 * var_x75 - 293.85136725665217 * var_x79 - 0.30158767234370004 * var_x77 - 0.0077469905913117388 * var_x59 - 0.00010399464275930935 * var_x78);
        IJth(rJacobian, 21, 25) = 7.5561002070271413e-9 * var_x237 * var_x78;
        IJth(rJacobian, 25, 25) = 1.4908768645188767e-7 * var_x76 - 0.021350814984788587 * var_x79 - 5.6288512232624455e-7 * var_x59 - 2.2668300621081427e-8 * var_x78 - 0.00023854029832302029 * var_x75;
        IJth(rJacobian, 26, 25) = 0.00015902686554868019 * var_x75 - 2.1912923713842662e-5 * var_x77 - 9.9391790967925116e-8 * var_x76;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (-5.3427521319391307 * var_x86 - 0.25992489121883872 * var_x84 - 10.052922411456668 * var_x77 - 0.64113025583269567 * var_x85 + var_x55 * var_x83 + var_x6 * (0.009050972624097476 * var_x80 - 0.13565712352459006 * var_x82 - var_x22 * var_x81));
        IJth(rJacobian, 26, 26) = -1.8885766345635726e-5 * var_x84 - 0.00073043079046142202 * var_x77 - 0.00038819663608706523 * var_x86 - 4.6583596330447829e-5 * var_x85 + var_x278 * var_x83 + var_x6 * (6.576305692690869e-7 * var_x80 - 9.8566502268897146e-6 * var_x82 - var_x277 * var_x81);
    }
