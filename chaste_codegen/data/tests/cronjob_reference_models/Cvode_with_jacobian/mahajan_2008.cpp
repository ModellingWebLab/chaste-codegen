...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmahajan_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x265 = fabs(var_x254) > 0.001;
        const double var_x266 = fabs(var_x259) > 0.001;
        ...
        const double var_x317 = 0.0014337722222222222 * var_x316;
        const double var_x318 = exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        ...
        const double var_x323 = Signum(var_x312);
        const double var_x324 = var_x323 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x325 = var_x324 * var_x4;
        const double var_x326 = 2.2516516071905171e-7 * var_x325;
        const double var_x327 = var_chaste_interface__Irel__Ca_JSR > 50.0;
        const double var_x328 = var_chaste_interface__Irel__Ca_JSR < 90.0;
        const double var_x329 = (var_x327) && (var_x328) && (var_x64);
        const double var_x330 = 0.0014337722222222222 * var_x320;
        const double var_x331 = -977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR;
        const double var_x332 = var_x0 * var_x314;
        const double var_x333 = var_x331 * var_x332;
        const double var_x334 = 0.0014337722222222222 * var_x321;
        const double var_x335 = var_x321 * var_x331;
        const double var_x336 = var_chaste_interface__Irel__Ca_JSR >= 90.0;
        const double var_x337 = (var_x336) && (var_x64);
        const double var_x338 = 0.0078521942756732063 * var_x68;
        const double var_x339 = fabs(var_x338 * var_chaste_interface__cell__V);
        const double var_x340 = var_x339 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x341 = var_x0 * var_x340;
        const double var_x342 = var_x311 * var_x341;
        const double var_x343 = 0.028675444444444444 * var_x321;
        const double var_x344 = var_x311 * var_x343;
        const double var_x345 = var_x338 + 5.9169374547212151e-7 * var_x3 * var_x73 - 0.00059169374547212144 * var_x2 * var_x71;
        const double var_x346 = Signum(var_x82);
        const double var_x347 = var_x346 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x348 = var_x0 * var_x345 * var_x347;
        const double var_x349 = (var_x327) && (var_x328);
        const double var_x350 = var_x331 * var_x341;
        const double var_x351 = var_x331 * var_x343;
        const double var_x352 = var_x101 + var_x105 - var_x99;
        const double var_x353 = 1.0 / var_chaste_interface__Ca__Ca_NSR;
        const double var_x354 = var_x353 * var_chaste_interface__Irel__xir;
        const double var_x355 = ((var_x329) ? (-var_x315 * var_x343) : ((var_x337) ? (-var_x314 * var_x351) : ((var_x64) ? (0) : ((var_x349) ? (-var_x340 * var_x344) : ((var_x336) ? (-var_x340 * var_x351) : (0))))));
        const double var_x356 = 0.32403252222222223 * var_x321;
        const double var_x357 = var_x113 - var_x116 - var_chaste_interface__Irel__xir;
        const double var_x358 = var_x324 * var_x70;
        const double var_x359 = 2.9881008538774201e-6 * var_x358;
        const double var_x360 = var_x347 * var_x96;
        const double var_x361 = 2.2516516071905171e-7 * var_x360;
        const double var_x362 = var_x119 - var_x117 - var_x118;
        const double var_x363 = (var_x353 * var_x362 - 1.0 * var_x357 / var_x102) * var_chaste_interface__Irel__xir;
        const double var_x364 = var_x0 * var_x313;
        const double var_x365 = var_x0 * var_x339;
        const double var_x366 = 0.0015 * var_x22;
        const double var_x367 = 9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca;
        const double var_x368 = var_x323 * var_x367;
        const double var_x369 = 7.8521942756732062e-6 * var_x3 * var_x368;
        const double var_x370 = 106.65141866666666 * var_x316;
        const double var_x371 = exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V);
        const double var_x372 = 1.0 + var_x371;
        const double var_x373 = pow(var_x371, 2) / pow(var_x372, 2);
        const double var_x374 = var_x371 / var_x372;
        const double var_x375 = var_x311 * var_x374;
        const double var_x376 = 0.0023418558700973894 * var_x325;
        const double var_x377 = 106.65141866666666 * var_x333;
        const double var_x378 = var_x331 * var_x374;
        const double var_x379 = var_x346 * var_x367;
        const double var_x380 = var_x345 * var_x379;
        const double var_x381 = 106.65141866666666 * var_x342;
        const double var_x382 = 298.24222222222221 * var_x374;
        const double var_x383 = var_x311 * var_x382;
        const double var_x384 = 106.65141866666666 * var_x350;
        const double var_x385 = var_x331 * var_x382;
        const double var_x386 = -9000.0 * var_x313;
        const double var_x387 = -9000.0 * var_x339;
        const double var_x388 = ((var_x329) ? (var_x386 - var_x315 * var_x382) : ((var_x337) ? (var_x386 - var_x314 * var_x385) : ((var_x64) ? (var_x386) : ((var_x349) ? (var_x387 - var_x340 * var_x383) : ((var_x336) ? (var_x387 - var_x340 * var_x385) : (var_x387))))));
        const double var_x389 = 3370.1371111111112 * var_x374;
        const double var_x390 = 0.031078082873696403 * var_x358;
        const double var_x391 = 2.0 + 0.00010420416882000001 * var_x2 * var_x368;
        const double var_x392 = 0.0023418558700973894 * var_x360;
        const double var_x393 = 2.0 + 7.8521942756732062e-6 * var_x2 * var_x379 * var_x73;
        const double var_x394 = 0.20571624547590583 * var_x59 + 42.0 * var_x56;
        const double var_x395 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_submem;
        const double var_x396 = pow(var_x395, (-2));
        const double var_x397 = 1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem;
        const double var_x398 = pow(var_x397, (-2));
        const double var_x399 = 1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem;
        const double var_x400 = pow(var_x399, (-2));
        const double var_x401 = 0.59999999999999998 + var_chaste_interface__Ca__Ca_submem;
        const double var_x402 = pow(var_x401, (-2));
        const double var_x403 = 1 / (1.0 + 4.5 * var_x396 + 3.2307692307692308 * var_x398 + 3.4285714285714284 * var_x400 + 28.199999999999999 * var_x402);
        const double var_x404 = 1.0 * var_x403;
        const double var_x405 = 71.454967908626173 * var_x82;
        const double var_x406 = ((var_x64) ? (var_x404 * (-582.04072127761572 + 0.94825793626200006 * var_x3)) : (var_x403 * var_x405));
        const double var_x407 = 0.0327 * var_chaste_interface__Ca__trops;
        const double var_x408 = -14.789 + var_x407 + 3.4019999999999997 * var_x94 - 0.0011233033614805057 * var_x90 - 105649.152 * var_x93;
        const double var_x409 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
        const double var_x410 = 50.0 * var_chaste_interface__Irel__xir + 12500.0 * var_chaste_interface__Ca__Ca_i_converted + 0.019599999999999999 * var_chaste_interface__Ca__trops - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x409 * (70.0 - var_chaste_interface__Ca__trops) + 42.0 * var_x55 * var_x57;
        const double var_x411 = 0.0012574820180071425 * (9.0 / pow(var_x395, 3) + 56.399999999999999 / pow(var_x401, 3) + 0.97959183673469374 / pow(var_x399, 3) + 0.49704142011834324 / pow(var_x397, 3)) / pow((0.035460992907801421 + var_x402 + 0.15957446808510639 * var_x396 + 0.11456628477905074 * var_x398 + 0.12158054711246201 * var_x400), 2);
        ...
        IJth(rJacobian, 11, 0) = ((var_x267) ? (var_x250 * (var_x255 + var_x260) + var_x264 * (var_x261 + var_x262)) : ((var_x265) ? (var_x250 * var_x255 + var_x264 * (0.0042068965517241376 + var_x262)) : ((var_x266) ? (var_x250 * var_x260 + var_x264 * (0.011219512195121951 + var_x261)) : (0.0020568544995794784 * var_x263))));
        ...
        IJth(rJacobian, 19, 0) = ((var_x329) ? (var_x317 * var_x320 + var_x322 * var_x326 - var_x317 * var_x321) : ((var_x337) ? (var_x326 * var_x335 + var_x330 * var_x333 - var_x333 * var_x334) : ((var_x64) ? (0) : ((var_x349) ? (var_x330 * var_x342 + var_x344 * var_x348 - var_x334 * var_x342) : ((var_x336) ? (var_x330 * var_x350 + var_x348 * var_x351 - var_x334 * var_x350) : (0))))));
        ...
        IJth(rJacobian, 21, 0) = ((var_x329) ? (var_x369 + var_x370 * var_x373 + var_x375 * var_x376 - var_x370 * var_x374) : ((var_x337) ? (var_x369 + var_x373 * var_x377 + var_x376 * var_x378 - var_x374 * var_x377) : ((var_x64) ? (var_x369) : ((var_x349) ? (var_x380 + var_x348 * var_x383 + var_x373 * var_x381 - var_x374 * var_x381) : ((var_x336) ? (var_x380 + var_x348 * var_x385 + var_x373 * var_x384 - var_x374 * var_x384) : (var_x380))))));
        IJth(rJacobian, 22, 0) = ((var_x64) ? (var_x404 * (var_x394 - 0.071454967908626169 * var_x4)) : (var_x404 * (var_x394 + 5.3844130837963053 * var_x72 - 71.454967908626173 * var_x69 - 0.0053844130837963052 * var_x74)));
        ...
        IJth(rJacobian, 19, 1) = var_x352 * var_x354;
        IJth(rJacobian, 22, 1) = 12500.0 * var_x403;
        IJth(rJacobian, 23, 1) = var_x352;
        ...
        IJth(rJacobian, 21, 5) = var_x388;
        IJth(rJacobian, 22, 5) = var_x406;
        ...
        IJth(rJacobian, 21, 6) = var_x388;
        IJth(rJacobian, 22, 6) = var_x406;
        ...
        IJth(rJacobian, 21, 7) = var_x388;
        IJth(rJacobian, 22, 7) = var_x406;
        ...
        IJth(rJacobian, 21, 8) = var_x388;
        IJth(rJacobian, 22, 8) = var_x406;
        ...
        IJth(rJacobian, 21, 9) = var_x388;
        IJth(rJacobian, 22, 9) = var_x406;
        ...
        IJth(rJacobian, 21, 10) = var_x388;
        IJth(rJacobian, 22, 10) = var_x406;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x27 * var_x34 * NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 11, 11) = ((var_x267) ? (var_x268 + var_x269) : ((var_x265) ? (-0.0042068965517241376 + var_x269) : ((var_x266) ? (-0.011219512195121951 + var_x268) : (-0.015426408746846089))));
        ...
        IJth(rJacobian, 19, 18) = ((var_x329) ? (var_x332 * var_x343) : ((var_x337) ? (var_x332 * var_x356) : ((var_x64) ? (0) : ((var_x349) ? (var_x341 * var_x343) : ((var_x336) ? (var_x341 * var_x356) : (0))))));
        IJth(rJacobian, 21, 18) = ((var_x329) ? (var_x332 * var_x382) : ((var_x337) ? (var_x332 * var_x389) : ((var_x64) ? (0) : ((var_x349) ? (var_x341 * var_x382) : ((var_x336) ? (var_x341 * var_x389) : (0))))));
        IJth(rJacobian, 19, 19) = -0.033333333333333333 - var_x354 + var_x353 * var_x357;
        IJth(rJacobian, 22, 19) = 50.0 * var_x403;
        ...
        IJth(rJacobian, 22, 20) = var_x404 * (226.80000000000001 * var_x92 - 6.5226273837343809e-6 * var_x91);
        ...
        IJth(rJacobian, 19, 22) = ((var_x329) ? (var_x322 * var_x359) : ((var_x337) ? (var_x335 * var_x359) : ((var_x64) ? (0) : ((var_x349) ? (var_x322 * var_x361) : ((var_x336) ? (var_x335 * var_x361) : (0))))));
        IJth(rJacobian, 20, 22) = 6.3389491199999997 * var_x93 + 6.7398201688830334e-8 * var_x90 - 0.00020411999999999996 * var_x94;
        IJth(rJacobian, 21, 22) = ((var_x329) ? (var_x391 + var_x375 * var_x390) : ((var_x337) ? (var_x391 + var_x378 * var_x390) : ((var_x64) ? (var_x391) : ((var_x349) ? (var_x393 + var_x375 * var_x392) : ((var_x336) ? (var_x393 + var_x378 * var_x392) : (var_x393))))));
        IJth(rJacobian, 22, 22) = ((var_x64) ? (var_x404 * (var_x408 - 0.94825793626200006 * var_x70) + var_x411 * (var_x410 - 9100.0 * var_x0 * var_x312)) : (var_x404 * (var_x408 - 0.071454967908626169 * var_x96) + var_x411 * (var_x410 - var_x0 * var_x405)));
        IJth(rJacobian, 25, 22) = 2.2890000000000001 - var_x407;
        IJth(rJacobian, 1, 23) = var_x112 * (var_x117 + var_x118 - var_x119);
        IJth(rJacobian, 18, 23) = 0.01;
        IJth(rJacobian, 19, 23) = ((var_x329) ? (var_x363 + var_x344 * var_x364) : ((var_x337) ? (var_x363 + var_x351 * var_x364) : ((var_x64) ? (var_x363) : ((var_x349) ? (var_x363 + var_x344 * var_x365) : ((var_x336) ? (var_x363 + var_x351 * var_x365) : (var_x363))))));
        IJth(rJacobian, 21, 23) = ((var_x329) ? (var_x364 * var_x383) : ((var_x337) ? (var_x364 * var_x385) : ((var_x64) ? (0) : ((var_x349) ? (var_x365 * var_x383) : ((var_x336) ? (var_x365 * var_x385) : (0))))));
        ...
        IJth(rJacobian, 22, 25) = var_x404 * (0.019599999999999999 + var_x409);
        IJth(rJacobian, 25, 25) = -0.019599999999999999 - var_x409;
    }
