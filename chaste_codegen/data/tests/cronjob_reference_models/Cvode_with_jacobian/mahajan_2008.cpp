...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmahajan_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x5 = exp(6.4833277106546525 + 0.23849999999999999 * var_chaste_interface__cell__V);
        const double var_x6 = 1.0 + var_x5;
        const double var_x7 = 1 / var_x6;
        const double var_x8 = exp(-46.87935221798611 - 0.51429999999999998 * var_chaste_interface__cell__V);
        ...
        const double var_x12 = exp(7.3793810433533826 + 0.080320000000000003 * var_chaste_interface__cell__V);
        ...
        const double var_x36 = 1 / (12.0 + var_chaste_interface__Na__Na_i);
        const double var_x37 = exp(-0.0037676968035880187 * var_chaste_interface__cell__V);
        const double var_x38 = exp(2.0208023774145616);
        const double var_x39 = exp(-0.037676968035880186 * var_chaste_interface__cell__V);
        const double var_x40 = 1.0 + 0.1245 * var_x37 + 0.036499999999999998 * var_x39 * (-0.14285714285714285 + 0.14285714285714285 * var_x38);
        const double var_x41 = var_x36 * (0.00046907825204670832 * var_x37 + 0.037676968035880186 * var_x39 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x38)) * var_chaste_interface__Na__Na_i / pow(var_x40, 2);
        const double var_x42 = exp(-0.024490029223322121 * var_chaste_interface__cell__V);
        const double var_x43 = var_x42 * var_chaste_interface__Ca__Ca_submem;
        const double var_x44 = pow(var_chaste_interface__Na__Na_i, 3.0);
        const double var_x45 = exp(0.013186938812558065 * var_chaste_interface__cell__V);
        const double var_x46 = var_x44 * var_x45;
        const double var_x47 = 1 / (12405.2022 + 7.96635616623864 * var_x44 + 4115.8113750000002 * var_chaste_interface__Ca__Ca_submem);
        const double var_x48 = 1.0 + 0.20000000000000001 * var_x42;
        const double var_x49 = 1 / var_x48;
        const double var_x50 = 1 / var_chaste_interface__Ca__Ca_submem;
        const double var_x51 = pow(var_x50, 3.0);
        const double var_x52 = 1.0 + 0.026999999999999996 * var_x51;
        const double var_x53 = 1 / var_x52;
        const double var_x54 = var_x49 * var_x53;
        const double var_x55 = var_x47 * var_x54;
        const double var_x56 = var_x55 * (61.603590949980969 * var_x43 + 0.023736489862604515 * var_x46);
        const double var_x57 = 1.8 * var_x46 - 2515.4560000000001 * var_x43;
        const double var_x58 = var_x47 * var_x57;
        const double var_x59 = var_x42 * var_x53 * var_x58 / pow(var_x48, 2);
        const double var_x60 = -9.5038640384570723 - 0.11 * var_chaste_interface__cell__V;
        const double var_x61 = var_x20 * var_x60;
        const double var_x62 = var_x17 / pow(var_x18, 2);
        const double var_x63 = var_x33 - 1.173913043478261 * var_x41 - 6.7199999999999998 * var_x56 - 0.032914599276144929 * var_x59 + var_x20 * (-0.055 * var_x19 - 0.11 * var_chaste_interface__Ito__ytos) - var_x23 * var_chaste_interface__INa__xh - var_x24 * var_x27 - 0.040000000000000001 * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof - 0.30599999999999999 * var_x15 * var_x7 - 0.050000000000000003 * var_x61 * var_x62 + 0.07298099999999999 * var_x15 * var_x34 * var_x35 + 0.00055803571428571436 * var_x24 * var_x25 * var_x34 / pow(var_x26, 2) - 0.29411764705882354 * var_x34 * var_x7 * (0.24326999999999999 * var_x35 - var_x10 * (0.061749999999999999 * var_x11 + 0.039456396800000001 * var_x12) - 0.51429999999999998 * var_x13 * var_x8 / pow(var_x9, 2)) / pow((var_x7 + 0.98039215686274506 * var_x14), 2);
        const double var_x64 = 0.075353936071760372 * fabs(var_chaste_interface__cell__V) < 0.001;
        ...
        const double var_x71 = var_x67 / pow(var_x65, 2);
        const double var_x72 = var_x70 * var_x71 * var_chaste_interface__cell__V;
        const double var_x73 = var_x66 * var_chaste_interface__cell__V;
        const double var_x74 = var_x4 * var_x73;
        const double var_x75 = -26.541413816729868 * log(7.8928799999999999 / (140.0 + 0.018329999999999999 * var_chaste_interface__Na__Na_i)) + var_chaste_interface__cell__V;
        ...
        const double var_x78 = -26.541413816729868 * log(136.0 * var_x77) + var_chaste_interface__cell__V;
        ...
        const double var_x83 = ((var_x64) ? (-186.25303080883702 + 0.30344253960384004 * var_x3) : (22.865589730760377 * var_x82));
        const double var_x84 = -3.4559505594389357 - 0.040000000000000001 * var_chaste_interface__cell__V;
        const double var_x85 = 1 / var_x40;
        const double var_x86 = var_x36 * var_x85;
        ...
        const double var_x90 = var_x54 * var_x57 / pow((1 + 0.0006421786632577935 * var_x44 + 0.33178107931203249 * var_chaste_interface__Ca__Ca_submem), 2);
        const double var_x91 = var_x89 * var_x90;
        const double var_x92 = var_x45 * var_x55 * var_x89;
        const double var_x93 = var_x42 * var_x55;
        const double var_x94 = var_x49 * var_x50 * var_x51 * var_x58 / pow(var_x52, 2);
        const double var_x95 = 0.00017972853783688089 * var_x90 + 16903.864320000001 * var_x93 - 0.54431999999999992 * var_x94;
        ...
        const double var_x99 = 0.79999999999999993 * pow(var_chaste_interface__Ca__Ca_i_converted, 3) / pow((2.4999999999999999e-7 + var_x98), 2);
        const double var_x100 = 1 / (0.25 + 1000000.0 * var_x98);
        const double var_x101 = 800000.0 * var_x100 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x102 = pow(var_chaste_interface__Ca__Ca_NSR, 2);
        const double var_x103 = 1 / (2500.0 + var_x102);
        const double var_x104 = var_x102 * var_x103;
        const double var_x105 = 0.02069 * var_x104;
        const double var_x106 = 0.012999999999999999 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x107 = 0.00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x108 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x109 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x110 = 1.0 + 0.00054599999999999994 / pow(var_x106, 2) + 4.5000000000000001e-6 / pow(var_x107, 2) + 0.00016799999999999999 / pow(var_x108, 2) + 2.8199999999999998e-5 / pow(var_x109, 2);
        const double var_x111 = 1 / var_x110;
        const double var_x112 = 0.001 * var_x111;
        const double var_x113 = 400000.0 * var_x100 * var_x98;
        const double var_x114 = 32.700000000000003 * var_chaste_interface__Ca__Ca_i_converted;
        ...
        const double var_x116 = 2.069e-5 * var_x104 * var_x115;
        const double var_x117 = 0.00034484023000000001 * var_x104;
        const double var_x118 = 4.138e-5 * var_x103 * var_x115 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x119 = 6.6208000000000002e-12 * var_x115 * pow(var_chaste_interface__Ca__Ca_NSR, 3) / pow((1 + 0.00040000000000000002 * var_x102), 2);
        ...
        const double var_x175 = exp(-3.5335689045936398 - 0.088339222614840993 * var_chaste_interface__cell__V);
        ...
        const double var_x184 = 1.0 + 0.00072525373756441496 * pow(var_chaste_interface__Ca__Ca_dyad, 4.0);
        ...
        const double var_x189 = pow((0.0012815107473898831 + var_x185 + 0.012815107473898831 * var_x188), (-2));
        const double var_x190 = var_x189 * (var_x180 + var_x181 * var_x187);
        const double var_x191 = 0.00016422697956757767 * var_x163 * var_x179;
        const double var_x192 = var_x190 * var_x191;
        const double var_x193 = 1 / (0.10000000000000001 + var_x186 + var_x188);
        const double var_x194 = var_x163 * var_x193;
        const double var_x195 = var_x177 * var_x194;
        const double var_x196 = 1.0 * var_x179;
        const double var_x197 = 1.0 - var_x196;
        const double var_x198 = 0.00016422697956757767 * var_x197;
        const double var_x199 = var_x190 * var_x198;
        const double var_x200 = var_x182 * var_x197;
        const double var_x201 = var_x177 * var_x193;
        const double var_x202 = -var_x160;
        const double var_x203 = 1.0 + var_x202;
        const double var_x204 = var_x174 * var_x196;
        const double var_x205 = var_x194 * var_x196;
        const double var_x206 = var_x193 * var_x197;
        const double var_x207 = var_x174 * var_x197;
        const double var_x208 = 0.22637460951196092 * pow(var_chaste_interface__Ca__Ca_dyad, 3.0) / pow(var_x184, 2);
        const double var_x209 = var_x189 * (var_x208 - var_x169 * var_x208);
        const double var_x210 = var_x191 * var_x209;
        const double var_x211 = 0.1111111111111111 * var_x165 * var_x179 * var_x193;
        const double var_x212 = var_x198 * var_x209 * var_chaste_interface__ICaL__xi2ca;
        const double var_x213 = exp(-13.333333333333332 - 0.33333333333333331 * var_chaste_interface__cell__V);
        ...
        const double var_x218 = 1 / var_x203;
        const double var_x219 = 0.33333333333333331 / var_x214;
        const double var_x220 = 0.33333333333333331 - var_x219;
        const double var_x221 = var_x159 * var_x218 * var_x220;
        ...
        const double var_x225 = var_x197 * var_x223;
        const double var_x226 = 29.156010230179028 * var_x220;
        const double var_x227 = var_x176 * var_x197;
        const double var_x228 = var_x218 * var_x227;
        const double var_x229 = var_x156 * var_x228;
        const double var_x230 = var_x226 * var_x229;
        const double var_x231 = var_x154 * var_x227 / (pow(var_x155, 3) * pow(var_x203, 2));
        const double var_x232 = var_x226 * var_x231;
        const double var_x233 = var_x159 * var_x215 * var_x228;
        const double var_x234 = 25.91645353793691 * var_x233;
        const double var_x235 = -0.018268800000000002 * var_x163;
        const double var_x236 = 41.377027474346242 + 1117.1797418073486 * var_x162;
        const double var_x237 = var_x221 * var_x227;
        const double var_x238 = 233.24808184143222 * var_x237;
        const double var_x239 = var_x216 * var_chaste_interface__ICaL__xi1ba;
        const double var_x240 = 0.16287544169611309 * var_x222;
        const double var_x241 = var_x179 * var_x240;
        const double var_x242 = var_x197 * var_x240;
        const double var_x243 = 0.23046875 * var_x220;
        const double var_x244 = var_x229 * var_x243;
        const double var_x245 = var_x231 * var_x243;
        const double var_x246 = 0.20486111111111108 * var_x233;
        const double var_x247 = 1.84375 * var_x237;
        ...
        const double var_x250 = -var_chaste_interface__IKr__xr + 1.0 / var_x249;
        const double var_x251 = exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V);
        const double var_x252 = 1.0 - var_x251;
        const double var_x253 = 0.0013799999999999999 / var_x252;
        const double var_x254 = 7.0 + var_chaste_interface__cell__V;
        const double var_x255 = var_x253 - 0.00016973999999999998 * var_x251 * var_x254 / pow(var_x252, 2);
        ...
        const double var_x261 = var_x258 * var_x259;
        const double var_x262 = var_x253 * var_x254;
        const double var_x263 = var_x248 / pow(var_x249, 2);
        const double var_x264 = 0.13333333333333333 * var_x263;
        const double var_x265 = (var_chaste_interface__cell__V > -6.9989999999999997) || (var_chaste_interface__cell__V < -10.000999999999999) || ((var_chaste_interface__cell__V > -9.9990000000000006) && (var_chaste_interface__cell__V < -7.0010000000000003));
        const double var_x266 = fabs(var_x254) > 0.001;
        const double var_x267 = fabs(var_x259) > 0.001;
        const double var_x268 = -var_x261;
        const double var_x269 = -var_x262;
        const double var_x270 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        const double var_x271 = 1.0 + var_x270;
        const double var_x272 = var_x270 / pow(var_x271, 2);
        const double var_x273 = 30.0 + var_chaste_interface__cell__V;
        const double var_x274 = fabs(var_x273) < 0.014556040756914121;
        const double var_x275 = 1.0 / var_x271;
        ...
        const double var_x284 = var_x273 * var_x276 / pow(var_x277, 2);
        const double var_x285 = var_x273 * var_x280 / pow(var_x281, 2);
        const double var_x286 = var_x273 * var_x279;
        const double var_x287 = var_x273 * var_x283;
        const double var_x288 = 0.059880239520958084 * var_x272;
        const double var_x289 = 3.2750000000000003e-5 * var_x278;
        const double var_x290 = 1.7975e-5 * var_x282;
        const double var_x291 = var_x273 * var_x289;
        const double var_x292 = var_x273 * var_x290;
        const double var_x293 = 0.066666666666666666 * var_chaste_interface__cell__V;
        const double var_x294 = exp(0.20000000000000001 + var_x293);
        const double var_x295 = 1.0 + var_x294;
        const double var_x296 = 1 / var_x295;
        const double var_x297 = 1 / (0.5 + 9.0 * var_x296);
        const double var_x298 = exp(-0.20000000000000001 - var_x293);
        const double var_x299 = 1.0 + var_x298;
        const double var_x300 = 0.066666666666666666 * var_x298 / pow(var_x299, 2);
        const double var_x301 = 1.0 / var_x299;
        const double var_x302 = exp(6.0 + var_x16);
        const double var_x303 = 1.0 + var_x302;
        const double var_x304 = 1 / var_x303;
        const double var_x305 = 1 / (30.0 + 3000.0 * var_x304);
        const double var_x306 = 0.10000000000000001 * var_x62;
        const double var_x307 = 1.0 * var_x19;
        ...
        const double var_x310 = 1 / (20.0 + 20.0 * var_x19);
        const double var_x311 = -50.0 + 1.0 * var_chaste_interface__Irel__Ca_JSR;
        const double var_x312 = -0.063960518821716009 + 0.00010420416882000001 * var_x3;
        const double var_x313 = fabs(var_x312);
        const double var_x314 = var_x313 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x315 = var_x311 * var_x314;
        const double var_x316 = var_x0 * var_x315;
        const double var_x317 = exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x318 = 1.0 + var_x317;
        const double var_x319 = pow(var_x317, 2) / pow(var_x318, 2);
        const double var_x320 = 0.0014337722222222222 * var_x319;
        const double var_x321 = var_x317 / var_x318;
        const double var_x322 = var_x311 * var_x321;
        const double var_x323 = var_x0 * var_x322;
        const double var_x324 = 0.0014337722222222222 * var_x314;
        const double var_x325 = Signum(var_x312);
        const double var_x326 = var_x325 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x327 = var_x326 * var_x4;
        const double var_x328 = 2.2516516071905171e-7 * var_x327;
        const double var_x329 = var_chaste_interface__Irel__Ca_JSR > 50.0;
        const double var_x330 = var_chaste_interface__Irel__Ca_JSR < 90.0;
        const double var_x331 = (var_x329) && (var_x330) && (var_x64);
        const double var_x332 = -977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR;
        const double var_x333 = var_x0 * var_x332;
        const double var_x334 = var_x314 * var_x333;
        const double var_x335 = var_x321 * var_x332;
        const double var_x336 = var_x0 * var_x335;
        const double var_x337 = var_chaste_interface__Irel__Ca_JSR >= 90.0;
        const double var_x338 = (var_x337) && (var_x64);
        const double var_x339 = var_x0 * var_x311;
        const double var_x340 = fabs(var_x82);
        const double var_x341 = var_x340 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x342 = 1.1258258035952585e-5 * var_x341;
        const double var_x343 = var_x319 * var_x342;
        const double var_x344 = var_x68 + 7.5353936071760369e-5 * var_x3 * var_x73 - var_x1 * var_x2 * var_x71;
        const double var_x345 = Signum(var_x82);
        const double var_x346 = var_x345 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x347 = var_x344 * var_x346;
        const double var_x348 = 0.00022516516071905169 * var_x347;
        const double var_x349 = (var_x329) && (var_x330);
        const double var_x350 = var_x101 + var_x105 - var_x99;
        const double var_x351 = 1.0 / var_chaste_interface__Ca__Ca_NSR;
        const double var_x352 = var_x351 * var_chaste_interface__Irel__xir;
        const double var_x353 = 0.028675444444444444 * var_x314;
        const double var_x354 = 0.00022516516071905169 * var_x341;
        const double var_x355 = ((var_x331) ? (-var_x322 * var_x353) : ((var_x338) ? (-var_x335 * var_x353) : ((var_x64) ? (0) : ((var_x349) ? (-var_x322 * var_x354) : ((var_x337) ? (-var_x335 * var_x354) : (0))))));
        const double var_x356 = var_x0 * var_x321;
        const double var_x357 = var_x113 - var_x116 - var_chaste_interface__Irel__xir;
        const double var_x358 = var_x326 * var_x70;
        const double var_x359 = 2.9881008538774201e-6 * var_x358;
        const double var_x360 = var_x346 * var_x96;
        const double var_x361 = 2.2516516071905171e-7 * var_x360;
        const double var_x362 = var_x119 - var_x117 - var_x118;
        const double var_x363 = (var_x351 * var_x362 - 1.0 * var_x357 / var_x102) * var_chaste_interface__Irel__xir;
        const double var_x364 = 0.028675444444444444 * var_x313;
        const double var_x365 = 0.00022516516071905169 * var_x340;
        const double var_x366 = 0.0015 * var_x22;
        const double var_x367 = var_x325 * (9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca);
        const double var_x368 = 7.8521942756732062e-6 * var_x3 * var_x367;
        const double var_x369 = exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V);
        const double var_x370 = 1.0 + var_x369;
        const double var_x371 = pow(var_x369, 2) / pow(var_x370, 2);
        const double var_x372 = 106.65141866666666 * var_x371;
        const double var_x373 = var_x369 / var_x370;
        const double var_x374 = var_x0 * var_x373;
        const double var_x375 = var_x311 * var_x373;
        const double var_x376 = 0.0023418558700973894 * var_x327;
        const double var_x377 = var_x314 * var_x374;
        const double var_x378 = var_x332 * var_x373;
        const double var_x379 = var_x345 * (70.669748481058846 - 70.669748481058846 * var_chaste_interface__ICaL__c1 - 70.669748481058846 * var_chaste_interface__ICaL__c2 - 70.669748481058846 * var_chaste_interface__ICaL__xi1ba - 70.669748481058846 * var_chaste_interface__ICaL__xi1ca - 70.669748481058846 * var_chaste_interface__ICaL__xi2ba - 70.669748481058846 * var_chaste_interface__ICaL__xi2ca);
        const double var_x380 = var_x344 * var_x379;
        const double var_x381 = 0.8374476591468264 * var_x341 * var_x371;
        const double var_x382 = var_x341 * var_x373;
        const double var_x383 = var_x0 * var_x382;
        const double var_x384 = 0.8374476591468264 * var_x383;
        const double var_x385 = 2.3418558700973895 * var_x374;
        const double var_x386 = var_x347 * var_x385;
        const double var_x387 = -9000.0 * var_x313;
        const double var_x388 = 298.24222222222221 * var_x373;
        const double var_x389 = var_x314 * var_x388;
        const double var_x390 = -70.669748481058846 * var_x340;
        const double var_x391 = 2.3418558700973895 * var_x382;
        const double var_x392 = ((var_x331) ? (var_x387 - var_x315 * var_x388) : ((var_x338) ? (var_x387 - var_x332 * var_x389) : ((var_x64) ? (var_x387) : ((var_x349) ? (var_x390 - var_x311 * var_x391) : ((var_x337) ? (var_x390 - var_x332 * var_x391) : (var_x390))))));
        const double var_x393 = 0.031078082873696403 * var_x358;
        const double var_x394 = 2.0 + 0.00010420416882000001 * var_x2 * var_x367;
        const double var_x395 = 0.0023418558700973894 * var_x360;
        const double var_x396 = 2.0 + 0.001 * var_x2 * var_x379 * var_x73;
        const double var_x397 = var_x313 * var_x388;
        const double var_x398 = var_x340 * var_x385;
        const double var_x399 = 0.20571624547590583 * var_x59 + 42.0 * var_x56;
        ...
        const double var_x404 = 1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem;
        const double var_x405 = pow(var_x404, (-2));
        const double var_x406 = 0.59999999999999998 + var_chaste_interface__Ca__Ca_submem;
        const double var_x407 = pow(var_x406, (-2));
        const double var_x408 = 1 / (1.0 + 4.5 * var_x401 + 3.2307692307692308 * var_x403 + 3.4285714285714284 * var_x405 + 28.199999999999999 * var_x407);
        const double var_x409 = 1.0 * var_x408;
        const double var_x410 = 71.454967908626173 * var_x82;
        const double var_x411 = ((var_x64) ? (var_x409 * (-582.04072127761572 + 0.94825793626200006 * var_x3)) : (var_x408 * var_x410));
        const double var_x412 = 0.0327 * var_chaste_interface__Ca__trops;
        const double var_x413 = -14.789 + var_x412 + 3.4019999999999997 * var_x94 - 0.0011233033614805057 * var_x90 - 105649.152 * var_x93;
        const double var_x414 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
        const double var_x415 = 50.0 * var_chaste_interface__Irel__xir + 12500.0 * var_chaste_interface__Ca__Ca_i_converted + 0.019599999999999999 * var_chaste_interface__Ca__trops - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x414 * (70.0 - var_chaste_interface__Ca__trops) + 42.0 * var_x55 * var_x57;
        const double var_x416 = 0.0012574820180071425 * (9.0 / pow(var_x400, 3) + 56.399999999999999 / pow(var_x406, 3) + 0.97959183673469374 / pow(var_x404, 3) + 0.49704142011834324 / pow(var_x402, 3)) / pow((0.035460992907801421 + var_x407 + 0.15957446808510639 * var_x401 + 0.11456628477905074 * var_x403 + 0.12158054711246201 * var_x405), 2);

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x64) ? (var_x63 - 0.022865589730760374 * var_x4) : (var_x63 + 1.7230121868148178 * var_x72 - 0.0017230121868148178 * var_x74 - 22.865589730760377 * var_x69)));
        ...
        IJth(rJacobian, 6, 0) = -var_x158 + var_x199 * var_chaste_interface__ICaL__xi2ca + var_x200 * var_chaste_interface__ICaL__xi2ba + (-var_x157 - var_x178 - var_x183 - var_x192 - var_x195) * var_chaste_interface__ICaL__c2 - var_x178 * var_chaste_interface__ICaL__xi2ba - var_x201 * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 7, 0) = var_x217 + var_x230 * var_chaste_interface__ICaL__xi2ca + var_x232 * var_chaste_interface__ICaL__xi2ca - var_x224 * var_chaste_interface__ICaL__xi2ca - var_x225 * var_chaste_interface__ICaL__xi2ca - var_x234 * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 8, 0) = var_x239 + var_x244 * var_chaste_interface__ICaL__xi2ba + var_x245 * var_chaste_interface__ICaL__xi2ba - var_x241 * var_chaste_interface__ICaL__xi2ba - var_x242 * var_chaste_interface__ICaL__xi2ba - var_x246 * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 9, 0) = -var_x217 + var_x192 * var_chaste_interface__ICaL__c2 + var_x195 * var_chaste_interface__ICaL__c2 + (var_x201 + var_x224 + var_x225 + var_x234 - var_x199 - var_x230 - var_x232) * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 10, 0) = -var_x239 + var_x178 * var_chaste_interface__ICaL__c2 + var_x183 * var_chaste_interface__ICaL__c2 + (var_x178 + var_x241 + var_x242 + var_x246 - var_x200 - var_x244 - var_x245) * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 11, 0) = ((var_x265) ? (var_x250 * (var_x255 + var_x260) + var_x264 * (var_x261 + var_x262)) : ((var_x266) ? (var_x250 * var_x255 + var_x264 * (0.0042068965517241376 + var_x262)) : ((var_x267) ? (var_x250 * var_x260 + var_x264 * (0.011219512195121951 + var_x261)) : (0.0020568544995794784 * var_x263))));
        IJth(rJacobian, 12, 0) = ((var_x274) ? (0.00014327258383033299 * var_x272) : (var_x288 * (var_x286 + var_x287) + (var_x275 - var_chaste_interface__IKs__xs1) * (var_x279 + var_x283 - 8.9997000000000013e-6 * var_x284 - 1.0641199999999999e-5 * var_x285)));
        IJth(rJacobian, 13, 0) = ((var_x274) ? (3.5818145957583247e-5 * var_x272) : (var_x288 * (var_x291 + var_x292) + (var_x275 - var_chaste_interface__IKs__xs2) * (var_x289 + var_x290 - 2.2499250000000003e-6 * var_x284 - 2.6602999999999998e-6 * var_x285)));
        IJth(rJacobian, 14, 0) = var_x297 * var_x300 + 0.0074074074074074077 * var_x294 * (var_x301 - var_chaste_interface__Ito__xtos) / (pow(var_x295, 2) * pow((0.055555555555555552 + var_x296), 2));
        IJth(rJacobian, 15, 0) = -var_x305 * var_x306 + 3.3333333333333335e-5 * var_x302 * (var_x307 - var_chaste_interface__Ito__ytos) / (pow(var_x303, 2) * pow((0.01 + var_x304), 2));
        IJth(rJacobian, 16, 0) = var_x300 * var_x309 + 0.00063492063492063492 * var_x308 * (var_x301 - var_chaste_interface__Ito__xtof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x308), 2);
        IJth(rJacobian, 17, 0) = -var_x306 * var_x310 + 0.0050000000000000001 * var_x62 * (var_x307 - var_chaste_interface__Ito__ytof) / pow((1 + var_x19), 2);
        IJth(rJacobian, 19, 0) = ((var_x331) ? (var_x316 * var_x320 + var_x322 * var_x328 - var_x323 * var_x324) : ((var_x338) ? (var_x320 * var_x334 + var_x328 * var_x335 - var_x324 * var_x336) : ((var_x64) ? (0) : ((var_x349) ? (var_x323 * var_x348 + var_x339 * var_x343 - var_x323 * var_x342) : ((var_x337) ? (var_x333 * var_x343 + var_x336 * var_x348 - var_x336 * var_x342) : (0))))));
        IJth(rJacobian, 20, 0) = -0.0025200000000000001 * var_x56 - 0.00044021739130434788 * var_x41 - 1.234297472855435e-5 * var_x59 - var_x366 * var_chaste_interface__INa__xh;
        IJth(rJacobian, 21, 0) = ((var_x331) ? (var_x368 + var_x316 * var_x372 + var_x375 * var_x376 - 106.65141866666666 * var_x315 * var_x374) : ((var_x338) ? (var_x368 + var_x334 * var_x372 + var_x376 * var_x378 - 106.65141866666666 * var_x332 * var_x377) : ((var_x64) ? (var_x368) : ((var_x349) ? (var_x380 + var_x311 * var_x386 + var_x339 * var_x381 - var_x311 * var_x384) : ((var_x337) ? (var_x380 + var_x332 * var_x386 + var_x333 * var_x381 - var_x332 * var_x384) : (var_x380))))));
        IJth(rJacobian, 22, 0) = ((var_x64) ? (var_x409 * (var_x399 - 0.071454967908626169 * var_x4)) : (var_x409 * (var_x399 + 5.3844130837963053 * var_x72 - 71.454967908626173 * var_x69 - 0.0053844130837963052 * var_x74)));
        ...
        IJth(rJacobian, 1, 1) = var_x112 * (-2539.0 + var_x97 + var_x99 - var_x101 - var_x105) + 0.001 * (0.0010919999999999999 / pow(var_x106, 3) + 9.0000000000000002e-6 / pow(var_x107, 3) + 0.00033599999999999998 / pow(var_x108, 3) + 5.6399999999999995e-5 / pow(var_x109, 3)) * (var_x116 - var_x113 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x114 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x110, 2);
        ...
        IJth(rJacobian, 20, 3) = -var_x366 * var_x78;
        ...
        IJth(rJacobian, 6, 5) = var_x203;
        IJth(rJacobian, 7, 5) = 0.0058991999999999968 * var_x163;
        IJth(rJacobian, 8, 5) = 0.0021800000000000001;
        IJth(rJacobian, 19, 5) = var_x355;
        IJth(rJacobian, 21, 5) = var_x392;
        IJth(rJacobian, 22, 5) = var_x411;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83);
        IJth(rJacobian, 5, 6) = -3.0 + var_x160;
        IJth(rJacobian, 6, 6) = var_x202 - var_x204 - var_x205;
        IJth(rJacobian, 7, 6) = var_x235;
        IJth(rJacobian, 8, 6) = -0.0019499999999999999;
        IJth(rJacobian, 9, 6) = var_x205;
        IJth(rJacobian, 10, 6) = var_x204;
        IJth(rJacobian, 19, 6) = var_x355;
        IJth(rJacobian, 21, 6) = var_x392;
        IJth(rJacobian, 22, 6) = var_x411;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83);
        IJth(rJacobian, 5, 7) = -2.999896385;
        IJth(rJacobian, 7, 7) = -0.33343694833333332 + var_x219 + var_x235 - 1.8929217120000003e-7 * var_x163 * var_x236;
        IJth(rJacobian, 8, 7) = -0.0019499999999999999;
        IJth(rJacobian, 9, 7) = var_x220;
        IJth(rJacobian, 19, 7) = var_x355;
        IJth(rJacobian, 21, 7) = var_x392;
        IJth(rJacobian, 22, 7) = var_x411;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83);
        IJth(rJacobian, 5, 8) = -2.99776;
        IJth(rJacobian, 7, 8) = var_x235;
        IJth(rJacobian, 8, 8) = -0.3376290960451977 + var_x219;
        IJth(rJacobian, 10, 8) = var_x220;
        IJth(rJacobian, 19, 8) = var_x355;
        IJth(rJacobian, 21, 8) = var_x392;
        IJth(rJacobian, 22, 8) = var_x411;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83);
        IJth(rJacobian, 5, 9) = -3.0;
        IJth(rJacobian, 6, 9) = var_x206;
        IJth(rJacobian, 7, 9) = var_x235 + var_x238;
        IJth(rJacobian, 8, 9) = -0.0019499999999999999;
        IJth(rJacobian, 9, 9) = -var_x206 - var_x238;
        IJth(rJacobian, 19, 9) = var_x355;
        IJth(rJacobian, 21, 9) = var_x392;
        IJth(rJacobian, 22, 9) = var_x411;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83);
        IJth(rJacobian, 5, 10) = -3.0;
        IJth(rJacobian, 6, 10) = var_x207;
        IJth(rJacobian, 7, 10) = var_x235;
        IJth(rJacobian, 8, 10) = -0.0019499999999999999 + var_x247;
        IJth(rJacobian, 10, 10) = -var_x207 - var_x247;
        IJth(rJacobian, 19, 10) = var_x355;
        IJth(rJacobian, 21, 10) = var_x392;
        IJth(rJacobian, 22, 10) = var_x411;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x27 * var_x34 * NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 11, 11) = ((var_x265) ? (var_x268 + var_x269) : ((var_x266) ? (-0.0042068965517241376 + var_x269) : ((var_x267) ? (-0.011219512195121951 + var_x268) : (-0.015426408746846089))));
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x32 * var_x75);
        IJth(rJacobian, 12, 12) = ((var_x274) ? (-0.0023926521499665608) : (-var_x286 - var_x287));
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x31 * var_x76);
        IJth(rJacobian, 13, 13) = ((var_x274) ? (-0.00059816303749164019) : (-var_x291 - var_x292));
        ...
        IJth(rJacobian, 14, 14) = -var_x297;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (var_x61);
        IJth(rJacobian, 15, 15) = -var_x305;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x84 * var_chaste_interface__Ito__ytof);
        IJth(rJacobian, 16, 16) = -var_x309;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x84 * var_chaste_interface__Ito__xtof);
        IJth(rJacobian, 17, 17) = -var_x310;
        IJth(rJacobian, 18, 18) = -0.01;
        IJth(rJacobian, 19, 18) = ((var_x331) ? (var_x353 * var_x356) : ((var_x338) ? (0.32403252222222223 * var_x314 * var_x356) : ((var_x64) ? (0) : ((var_x349) ? (var_x354 * var_x356) : ((var_x337) ? (0.0025443663161252845 * var_x341 * var_x356) : (0))))));
        IJth(rJacobian, 21, 18) = ((var_x331) ? (var_x0 * var_x389) : ((var_x338) ? (3370.1371111111112 * var_x377) : ((var_x64) ? (0) : ((var_x349) ? (var_x0 * var_x391) : ((var_x337) ? (26.462971332100505 * var_x383) : (0))))));
        IJth(rJacobian, 19, 19) = -0.033333333333333333 - var_x352 + var_x351 * var_x357;
        IJth(rJacobian, 22, 19) = 50.0 * var_x408;
        IJth(rJacobian, 23, 19) = -1;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (0.008152173913043478 * var_x87 + 1.0436203813975009e-6 * var_x91 - 1.173913043478261 * var_x86 - 318.4969658007584 * var_x88 - 36.287999999999997 * var_x92 + 0.00019591421434992582 * var_x33 * (17.737505194555094 + 0.0023223462158299631 * var_chaste_interface__Na__Na_i) / pow((1 + 0.00013092857142857142 * var_chaste_interface__Na__Na_i), 2));
        IJth(rJacobian, 20, 20) = 3.9135764302406284e-10 * var_x91 + 3.0570652173913045e-6 * var_x87 - 0.013608 * var_x92 - 0.00044021739130434788 * var_x86 - 0.039812120725094803 * var_x88;
        IJth(rJacobian, 22, 20) = var_x409 * (226.80000000000001 * var_x92 - 6.5226273837343809e-6 * var_x91);
        IJth(rJacobian, 5, 21) = -var_x166;
        IJth(rJacobian, 6, 21) = var_x212 + (-var_x210 - var_x211) * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 7, 21) = var_x166 + (0.00063442013684210537 * var_x163 * var_x164 - 2.1032463466666669e-8 * var_x165 * var_x236) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x0 * var_x165;
        IJth(rJacobian, 9, 21) = -var_x212 + var_x210 * var_chaste_interface__ICaL__c2 + var_x211 * var_chaste_interface__ICaL__c2;
        ...
        IJth(rJacobian, 19, 22) = ((var_x331) ? (var_x322 * var_x359) : ((var_x338) ? (var_x335 * var_x359) : ((var_x64) ? (0) : ((var_x349) ? (var_x322 * var_x361) : ((var_x337) ? (var_x335 * var_x361) : (0))))));
        IJth(rJacobian, 20, 22) = 6.3389491199999997 * var_x93 + 6.7398201688830334e-8 * var_x90 - 0.00020411999999999996 * var_x94;
        IJth(rJacobian, 21, 22) = ((var_x331) ? (var_x394 + var_x375 * var_x393) : ((var_x338) ? (var_x394 + var_x378 * var_x393) : ((var_x64) ? (var_x394) : ((var_x349) ? (var_x396 + var_x375 * var_x395) : ((var_x337) ? (var_x396 + var_x378 * var_x395) : (var_x396))))));
        IJth(rJacobian, 22, 22) = ((var_x64) ? (var_x409 * (var_x413 - 0.94825793626200006 * var_x70) + var_x416 * (var_x415 - 9100.0 * var_x0 * var_x312)) : (var_x409 * (var_x413 - 0.071454967908626169 * var_x96) + var_x416 * (var_x415 - var_x0 * var_x410)));
        IJth(rJacobian, 25, 22) = 2.2890000000000001 - var_x412;
        IJth(rJacobian, 1, 23) = var_x112 * (var_x117 + var_x118 - var_x119);
        IJth(rJacobian, 18, 23) = 0.01;
        IJth(rJacobian, 19, 23) = ((var_x331) ? (var_x363 + var_x323 * var_x364) : ((var_x338) ? (var_x363 + var_x336 * var_x364) : ((var_x64) ? (var_x363) : ((var_x349) ? (var_x363 + var_x323 * var_x365) : ((var_x337) ? (var_x363 + var_x336 * var_x365) : (var_x363))))));
        IJth(rJacobian, 21, 23) = ((var_x331) ? (var_x339 * var_x397) : ((var_x338) ? (var_x333 * var_x397) : ((var_x64) ? (0) : ((var_x349) ? (var_x311 * var_x398) : ((var_x337) ? (var_x332 * var_x398) : (0))))));
        IJth(rJacobian, 23, 23) = var_x362;
        IJth(rJacobian, 1, 24) = var_x112 * (0.019599999999999999 + var_x114);
        IJth(rJacobian, 24, 24) = -0.019599999999999999 - var_x114;
