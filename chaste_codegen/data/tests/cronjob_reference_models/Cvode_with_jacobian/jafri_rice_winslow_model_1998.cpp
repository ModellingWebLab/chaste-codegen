...
#include "MathsCustomFunctions.hpp"
    ...
    void Celljafri_rice_winslow_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x8 = var_x3 * var_chaste_interface__calcium_subsystem__Cai;
        const double var_x9 = var_x5 * (0.023671180739438871 * var_x7 + 67015.742804544716 * var_x8);
        const double var_x10 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0);
        const double var_x11 = var_x10 * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x12 = 12.800000000000001 * var_x11;
        const double var_x13 = sqrt(var_chaste_interface__ionic_concentrations__Ko);
        const double var_x14 = 1 / var_chaste_interface__ionic_concentrations__Ki;
        const double var_x15 = log(var_x14 * var_chaste_interface__ionic_concentrations__Ko);
        const double var_x16 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3475921059424856 * var_x15);
        const double var_x17 = 1.0 + var_x16;
        const double var_x18 = 1 / var_x17;
        const double var_x19 = exp(-2.4444678999999998 + 13.687910356755641 * var_x15 - 0.51429999999999998 * var_chaste_interface__membrane__V);
        const double var_x20 = 1.0 + var_x19;
        const double var_x21 = 1 / var_x20;
        const double var_x22 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1376880417161446 * var_x15);
        const double var_x23 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6434541406371006 * var_x15);
        const double var_x24 = var_x23 + 0.49124000000000001 * var_x22;
        const double var_x25 = var_x21 * var_x24;
        const double var_x26 = 1 / (var_x25 + 1.02 * var_x18);
        const double var_x27 = var_x18 * var_x26;
        const double var_x28 = var_x13 * var_x27;
        const double var_x29 = -26.614641953637257 * var_x15 + var_chaste_interface__membrane__V;
        const double var_x30 = var_x0 * var_x29 / pow(var_x1, 2);
        const double var_x31 = 0.037573302761014081 * var_chaste_interface__membrane__V;
        const double var_x32 = 1 / (var_chaste_interface__ionic_concentrations__Ki + var_chaste_interface__ionic_concentrations__Nai);
        const double var_x33 = 140.0 + var_chaste_interface__ionic_concentrations__Ko;
        const double var_x34 = log(var_x32 * var_x33);
        const double var_x35 = exp(var_x31 - 0.99999999999999989 * var_x34);
        const double var_x36 = 0.75 * var_x35;
        const double var_x37 = -105.0 + var_x36 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x38 = 1 / var_chaste_interface__calcium_subsystem__Cai;
        ...
        const double var_x46 = -0.75 * var_chaste_interface__ionic_concentrations__Ko + var_x36 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x47 = pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 2.0);
        const double var_x48 = exp(-1.7526479750778814 + 0.031152647975077882 * var_chaste_interface__membrane__V);
        const double var_x49 = 1.0 + var_x48;
        const double var_x50 = 1 / var_x49;
        const double var_x51 = var_x13 * var_x50;
        const double var_x52 = var_x47 * var_x51;
        const double var_x53 = 1.8 * var_x7 - 2744000.0 * var_x8;
        const double var_x54 = var_x3 * var_x53 / pow(var_x4, 2);
        const double var_x55 = 49.123617829520519 * var_chaste_interface__L_type_Ca_channel_y_gate__y;
        const double var_x56 = var_chaste_interface__L_type_Ca_channel__O + var_chaste_interface__L_type_Ca_channel__O_Ca;
        const double var_x57 = exp(0.075146605522028162 * var_chaste_interface__membrane__V);
        const double var_x58 = -1.0 + var_x57;
        const double var_x59 = 1 / var_x58;
        const double var_x60 = -0.61380000000000001 + 0.001 * var_x57;
        const double var_x61 = var_x59 * var_x60;
        const double var_x62 = var_x56 * var_x61;
        const double var_x63 = var_x13 * var_x29;
        const double var_x64 = var_x16 / pow(var_x17, 2);
        const double var_x65 = var_x26 * var_x64;
        const double var_x66 = var_x63 * var_x65;
        const double var_x67 = -26.614641953637257 * var_x34 + var_chaste_interface__membrane__V;
        const double var_x68 = var_x35 * var_x67;
        const double var_x69 = var_x41 * var_x68 / pow(var_x42, 2);
        const double var_x70 = 2.3926214736989754e-5 * var_x69;
        const double var_x71 = 1 / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki);
        const double var_x72 = 2.5661999999999998 + var_chaste_interface__ionic_concentrations__Ko;
        const double var_x73 = -26.614641953637257 * log(var_x71 * var_x72) + var_chaste_interface__membrane__V;
        const double var_x74 = var_x47 * var_x73;
        const double var_x75 = var_x13 * var_x48 * var_x74 / pow(var_x49, 2);
        const double var_x76 = var_x44 * var_x68;
        const double var_x77 = 1.7944661052742317e-5 * var_x76;
        const double var_x78 = var_x19 * var_x24 / pow(var_x20, 2);
        const double var_x79 = 0.24326999999999999 * var_x64 - 0.51429999999999998 * var_x78 - var_x21 * (0.061749999999999999 * var_x23 + 0.039456396800000001 * var_x22);
        const double var_x80 = var_x18 * var_x63 / pow((var_x18 + 0.98039215686274506 * var_x25), 2);
        const double var_x81 = 0.31642020802348175 * var_x80;
        const double var_x82 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x83 = pow(var_x82, 1.5);
        const double var_x84 = 1 / (1.0 + 31.622776601683793 * var_x83);
        const double var_x85 = exp(-0.0037573302761014088 * var_chaste_interface__membrane__V);
        const double var_x86 = exp(2.0802377414561666);
        const double var_x87 = exp(-var_x31);
        const double var_x88 = 1.0 + 0.1245 * var_x85 + 0.036499999999999998 * var_x87 * (-0.14285714285714285 + 0.14285714285714285 * var_x86);
        const double var_x89 = 1 / (1.5 + var_chaste_interface__ionic_concentrations__Ko);
        const double var_x90 = var_x89 * var_chaste_interface__ionic_concentrations__Ko;
        const double var_x91 = var_x84 * var_x90 * (0.00046778761937462537 * var_x85 + 0.037573302761014081 * var_x87 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x86)) / pow(var_x88, 2);
        const double var_x92 = var_x56 * var_chaste_interface__L_type_Ca_channel_y_gate__y;
        const double var_x93 = var_x61 * var_chaste_interface__membrane__V;
        const double var_x94 = 1 / (1.0 - 107.25680748803609 * var_x93);
        const double var_x95 = exp(var_x31);
        const double var_x96 = -1.0 + var_x95;
        const double var_x97 = 1 / var_x96;
        const double var_x98 = var_x95 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x99 = var_x98 - var_chaste_interface__ionic_concentrations__Ko;
        const double var_x100 = var_x94 * var_x97 * var_x99;
        const double var_x101 = 0.00036387865058904091 * var_x100;
        const double var_x102 = var_x57 * var_chaste_interface__membrane__V;
        const double var_x103 = var_x102 * var_x59;
        const double var_x104 = var_x103 * var_x92;
        const double var_x105 = var_x102 * var_x60 / pow(var_x58, 2);
        const double var_x106 = var_x105 * var_x92;
        const double var_x107 = var_x92 * var_x94 * var_chaste_interface__membrane__V;
        const double var_x108 = var_x107 * var_x95 * var_x99 / pow(var_x96, 2);
        const double var_x109 = var_x107 * var_x97;
        const double var_x110 = var_x109 * var_x98;
        const double var_x111 = var_x92 * var_x97 * var_x99 * (0.0080599850018555647 * var_x103 + 107.25680748803609 * var_x61 - 8.0599850018555639 * var_x105) * var_chaste_interface__membrane__V / pow((0.0093234175379641477 - var_x93), 2);
        const double var_x112 = -26.614641953637257 * log(140.0 * var_x82) + var_chaste_interface__membrane__V;
        const double var_x113 = var_x112 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x114 = var_x113 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x115 = var_x10 * var_x113;
        const double var_x116 = var_x101 * var_chaste_interface__membrane__V;
        const double var_x117 = -var_x116 * var_chaste_interface__L_type_Ca_channel_y_gate__y - var_x55 * var_x93;
        const double var_x118 = var_x56 * var_x93;
        const double var_x119 = var_x51 * var_x73 * pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 1.0);
        const double var_x120 = 0.00050000000000000001 + var_chaste_interface__calcium_subsystem__Cai;
        const double var_x121 = 1 / var_x120;
        const double var_x122 = var_chaste_interface__calcium_subsystem__Cai / pow(var_x120, 2);
        const double var_x123 = var_x3 * var_x5;
        const double var_x124 = var_x38 * var_x39 * var_x43 * var_x67 / pow(var_x40, 2);
        const double var_x125 = 3.301107118143778e-12 * var_x124;
        const double var_x126 = var_x5 * var_x6 * pow(var_chaste_interface__ionic_concentrations__Nai, 2.0);
        const double var_x127 = var_x11 * var_x82 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x128 = 0.74999999999999989 * var_x35;
        const double var_x129 = var_x128 * var_x32;
        const double var_x130 = var_x36 + var_x129 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x131 = var_x45 * var_x67;
        const double var_x132 = var_x52 * var_x71;
        const double var_x133 = 0.00047759072889811614 * var_x76;
        const double var_x134 = var_x133 * var_x32;
        const double var_x135 = 1 / var_x88;
        const double var_x136 = var_x135 * var_x82 * var_x83 * var_x90 / pow((0.031622776601683791 + var_x83), 2);
        const double var_x137 = 0.016947875000000001 * var_x44;
        const double var_x138 = var_x32 * var_x37;
        const double var_x139 = var_x137 * var_x46;
        const double var_x140 = 0.00063678763853082152 * var_x69;
        const double var_x141 = var_x140 * var_x46;
        const double var_x142 = var_x138 * var_x140 + var_x141 * var_x32 - var_x137 * var_x138 - var_x139 * var_x32;
        const double var_x143 = 0.22036923537611647 * var_x2;
        const double var_x144 = var_x36 + var_x129 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x145 = var_x14 * var_x28;
        const double var_x146 = 1.0501178736126389 * var_x22;
        const double var_x147 = 1.6434541406371006 * var_x23;
        const double var_x148 = 6.4745439480613349 * var_x64;
        const double var_x149 = 13.687910356755641 * var_x78;
        const double var_x150 = var_x14 * var_x148 - var_x14 * var_x149 - var_x21 * (var_x14 * var_x146 + var_x14 * var_x147);
        const double var_x151 = var_x14 * var_x66;
        const double var_x152 = 0.00036387865058904091 * var_x109;
        const double var_x153 = 1 / var_chaste_interface__ionic_concentrations__Ko;
        const double var_x154 = 1 / var_x13;
        const double var_x155 = var_x154 * var_x27;
        const double var_x156 = var_x135 * var_x84;
        const double var_x157 = var_x156 * var_x89;
        const double var_x158 = var_x52 / var_x72;
        const double var_x159 = 1 / var_x33;
        const double var_x160 = var_x159 * var_x37;
        const double var_x161 = var_x156 * var_chaste_interface__ionic_concentrations__Ko / pow((1 + 0.66666666666666663 * var_chaste_interface__ionic_concentrations__Ko), 2);
        const double var_x162 = var_x155 * var_x29;
        const double var_x163 = -0.75 - var_x128 * var_x159 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x164 = var_x154 * var_x50 * var_x74;
        const double var_x165 = var_x149 * var_x153 - var_x148 * var_x153 - var_x21 * (-var_x146 * var_x153 - var_x147 * var_x153);
        const double var_x166 = var_x154 * var_x29 * var_x65;
        const double var_x167 = var_x159 * var_chaste_interface__ionic_concentrations__Nai;
        ...
        const double var_x258 = 1.0 + 0.00011900000000000002 * pow(var_x257, (-2.0));
        ...
        const double var_x263 = 3.5281248386597142e-5 * var_x121;
        const double var_x264 = pow(var_chaste_interface__calcium_subsystem__Cai, 2.0);
        const double var_x265 = 2.4999999999999999e-7 + var_x264;
        const double var_x266 = pow(var_chaste_interface__calcium_subsystem__Cai, 3.0) / pow(var_x265, 2);
        const double var_x267 = 1 / var_x265;
        const double var_x268 = var_x267 * pow(var_chaste_interface__calcium_subsystem__Cai, 1.0);
        ...
        const double var_x273 = 1.0 + 0.00011900000000000002 * pow(var_x272, (-2.0));
        const double var_x274 = 1 / var_x273;
        const double var_x275 = 1.0 * var_x274;
        const double var_x276 = -var_x271 * var_x274 * var_x93;
        ...
        const double var_x289 = pow(var_x288, (-2.0));
        ...
        const double var_x293 = 0.00078539126843207537 * var_x11;
        const double var_x294 = 3.9072457120905302e-8 * var_x44;
        const double var_x295 = 1.4680812610205155e-9 * var_x69;
        const double var_x296 = 1.1010609457653866e-9 * var_x76;
        const double var_x297 = 2.0255161771477304e-16 * var_x124;
        const double var_x298 = var_x294 * var_x67;
        const double var_x299 = 1.039899456521739e-6 * var_x44;
        const double var_x300 = 3.9072457120905302e-8 * var_x69;
        const double var_x301 = var_x138 * var_x300 - var_x138 * var_x299;
        const double var_x302 = 2.9304342840678975e-8 * var_x76;
        const double var_x303 = var_x302 * var_x32;
        const double var_x304 = 5.0804997676699878e-7 * var_x2;
        const double var_x305 = 2.0199501620781443e-5 * var_x28;
        const double var_x306 = var_x294 * var_x46;
        const double var_x307 = 8.4958190094815836e-8 * var_x30;
        const double var_x308 = 2.9784363174171858e-6 * var_x52;
        const double var_x309 = 0.0001595326014002653 * var_x91;
        const double var_x310 = var_x295 * var_x46;
        const double var_x311 = 4.817581136556374e-6 * var_x66;
        const double var_x312 = 9.2786178112684914e-8 * var_x75;
        const double var_x313 = 1.941513035446121e-5 * var_x80;
        const double var_x314 = var_x313 * var_x79;
        const double var_x315 = var_x296 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x316 = 2.2327118354803033e-8 * var_x100;
        const double var_x317 = var_x316 * var_x92;
        const double var_x318 = 8.3890357772600894e-10 * var_x108;
        const double var_x319 = 1.9408096485119747e-12 * var_x111;
        const double var_x320 = 8.3890357772600894e-10 * var_x110;
        const double var_x321 = var_x316 * var_chaste_interface__membrane__V;
        const double var_x322 = var_x321 * var_chaste_interface__L_type_Ca_channel_y_gate__y;
        const double var_x323 = -var_x322;
        const double var_x324 = var_x321 * var_x56;
        const double var_x325 = 5.9568726348343716e-6 * var_x119;
        const double var_x326 = var_x297 * var_x46;
        const double var_x327 = 1.4530193963918526e-6 * var_x132;
        const double var_x328 = 7.5672957221490853e-6 * var_x136;
        const double var_x329 = var_x303 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x330 = var_x299 * var_x46;
        const double var_x331 = var_x32 * var_x330;
        const double var_x332 = var_x300 * var_x46;
        const double var_x333 = var_x32 * var_x332;
        const double var_x334 = var_x333 - var_x331;
        const double var_x335 = 1.3521568226207398e-5 * var_x2;
        const double var_x336 = var_x14 * var_x335;
        const double var_x337 = 0.0005376025032790136 * var_x145;
        const double var_x338 = 7.9270016169768288e-5 * var_x132;
        const double var_x339 = var_x144 * var_x298;
        const double var_x340 = var_x150 * var_x313;
        const double var_x341 = 0.00012821819703204474 * var_x151;
        const double var_x342 = 2.2327118354803033e-8 * var_x109;
        const double var_x343 = var_x342 * var_x95;
        const double var_x344 = var_x153 * var_x335;
        const double var_x345 = 0.0001595326014002653 * var_x157;
        const double var_x346 = 0.0005376025032790136 * var_x155;
        const double var_x347 = var_x159 * var_x330;
        const double var_x348 = 7.9270016169768288e-5 * var_x158;
        const double var_x349 = 7.0903378400117916e-5 * var_x161;
        const double var_x350 = 1.0099750810390721e-5 * var_x162;
        const double var_x351 = var_x163 * var_x298;
        const double var_x352 = 1.4892181587085929e-6 * var_x164;
        const double var_x353 = var_x165 * var_x313;
        const double var_x354 = 0.00012821819703204474 * var_x166;
        const double var_x355 = var_x159 * var_x332;
        const double var_x356 = var_x331 - var_x333;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0074419999999999998 + 0.078515054885989852 * var_x66 + 1.3672122706851289e-5 * var_x108 + 0.0015121928745316603 * var_x75 + 3.6914731308498481 * var_x106 - 0.00046056327637115522 * var_x9 - 0.32920358442763042 * var_x28 - 0.0013846153846153843 * var_x30 - 0.0082799999999999992 * var_x2 - 1.3 * var_x91 - 1.3672122706851289e-5 * var_x110 - 3.1630557276945034e-8 * var_x111 - 0.048541391272466296 * var_x52 - 1.1248174225403713e-6 * var_x54 - 0.0036914731308498486 * var_x104 + var_x37 * var_x70 + var_x46 * var_x70 - var_x101 * var_x92 - var_x12 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x37 * var_x45 - var_x45 * var_x46 - var_x55 * var_x62 - var_x77 * var_chaste_interface__ionic_concentrations__Ki - var_x77 * var_chaste_interface__ionic_concentrations__Nai - var_x79 * var_x81);
        ...
        IJth(rJacobian, 18, 0) = var_x260 * (-1.8505781762430779e-7 + 2.825956061112298e-8 * var_x9 + 6.901732673777188e-11 * var_x54);
        IJth(rJacobian, 19, 0) = var_x275 * (1.9432392414723958 * var_x106 - 0.0019432392414723959 * var_x104 - var_x271 * var_x62);
        IJth(rJacobian, 28, 0) = -8.651575691322081e-8 - 2.0705198021331562e-10 * var_x54 - 8.4778681833368931e-8 * var_x9 - 0.00023929890210039797 * var_x91 + var_x295 * var_x37 - var_x293 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x294 * var_x37 - var_x296 * var_chaste_interface__ionic_concentrations__Nai;
        IJth(rJacobian, 29, 0) = var_x309 + var_x310 + var_x311 + var_x312 + var_x318 - var_x304 - var_x305 - var_x306 - var_x307 - var_x308 - var_x314 - var_x315 - var_x317 - var_x319 - var_x320;
        IJth(rJacobian, 30, 0) = var_x304 + var_x305 + var_x306 + var_x307 + var_x308 + var_x314 + var_x315 + var_x317 + var_x319 + var_x320 - var_x309 - var_x310 - var_x311 - var_x312 - var_x318;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-38.400000000000006 * var_x114);
        IJth(rJacobian, 1, 1) = -0.080000000000000002 * var_x173 - var_x172 * var_x174;
        IJth(rJacobian, 28, 1) = -0.002356173805296226 * var_x114;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x112 * var_x12);
        ...
        IJth(rJacobian, 28, 2) = -var_x112 * var_x293;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-12.800000000000001 * var_x115);
        IJth(rJacobian, 3, 3) = ((var_x178) ? (-0.1212 * var_x192 - var_x188 * var_x193) : (-0.29999999999999999 * var_x198));
        IJth(rJacobian, 28, 3) = -0.00078539126843207537 * var_x115;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x117);
        ...
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x117);
        ...
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-49.123617829520519 * var_x118 - var_x116 * var_x56);
        IJth(rJacobian, 16, 16) = -var_x244;
        IJth(rJacobian, 19, 16) = -25.859308321022734 * var_x118 * var_x274;
        IJth(rJacobian, 29, 16) = -var_x324;
        IJth(rJacobian, 30, 16) = var_x324;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-0.097082782544932592 * var_x119);
        IJth(rJacobian, 17, 17) = -var_x252 * var_x256 - var_x255 * var_x256;
        IJth(rJacobian, 29, 17) = -var_x325;
        IJth(rJacobian, 30, 17) = var_x325;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (1.1499999999999999 * var_x122 + 1263.7856303624499 * var_x123 - 1.1499999999999999 * var_x121 - 0.080269760132169965 * var_x38 - var_x125 * var_x37 - var_x125 * var_x46);
        IJth(rJacobian, 18, 18) = var_x260 * (-5.9200580000000009 + var_x261 + var_x262 - var_x263 + 0.0035999999999999999 * var_x266 + 3.5281248386597142e-5 * var_x122 - 0.0035999999999999999 * var_x268 - 0.077544234316921451 * var_x123 - 2.4626237783962268e-6 * var_x38) + 0.00023800000000000004 * pow(var_x257, (-3.0)) * (5.8e-5 * var_chaste_interface__calcium_subsystem__Ca_NSR + 6.6000000000000005e-5 * var_chaste_interface__calcium_subsystem__HTRPNCa + 0.040000000000000001 * var_chaste_interface__calcium_subsystem__LTRPNCa + 0.32000000000000001 * var_chaste_interface__calcium_subsystem__Ca_SS + 2.4626237783962268e-6 * log(1.8 * var_x38) - 0.32005800000000001 * var_chaste_interface__calcium_subsystem__Cai - 1.8505781762430779e-7 * var_chaste_interface__membrane__V - var_x263 * var_chaste_interface__calcium_subsystem__Cai - var_x269 * (0.14000000000000001 - var_chaste_interface__calcium_subsystem__HTRPNCa) - var_x270 * (0.070000000000000007 - var_chaste_interface__calcium_subsystem__LTRPNCa) + 2.825956061112298e-8 * var_x5 * var_x53 - 0.0018 * var_x264 * var_x267) / pow(var_x258, 2);
        ...
        IJth(rJacobian, 28, 18) = 0.23263270295076435 * var_x123 - var_x297 * var_x37;
        ...
        IJth(rJacobian, 19, 19) = var_x275 * (-5490.7343857240912 - var_x277 - var_x278) + 0.00023800000000000004 * pow(var_x272, (-3.0)) * (143.30816746739879 * var_x279 + 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Cai - 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Ca_SS - var_x118 * var_x271) / pow(var_x273, 2);
        ...
        IJth(rJacobian, 24, 24) = var_x291 * (-0.029002320185614851 - var_x286 - var_x287) + 0.16666666666666666 * pow(var_x288, (-3.0)) * (0.029002320185614851 * var_chaste_interface__calcium_subsystem__Ca_NSR - 1.8 * var_x279 - 0.029002320185614851 * var_chaste_interface__calcium_subsystem__Ca_JSR) / pow((0.083333333333333329 + var_x289), 2);
        ...
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (var_x142 - 340.66741700655689 * var_x127 - 0.037526645154628537 * var_x82 - 0.0024870416924042383 * var_x126 - 0.023680742352719726 * var_x132 - 0.061664414373283391 * var_x136 - var_x130 * var_x131 - var_x134 * var_chaste_interface__ionic_concentrations__Ki);
        IJth(rJacobian, 18, 28) = 1.526016273000641e-7 * var_x126 * var_x259;
        IJth(rJacobian, 28, 28) = var_x301 - 2.3025858935932891e-6 * var_x82 - 0.020902907402832693 * var_x127 - 1.1350943583223629e-5 * var_x136 - 4.5780488190019221e-7 * var_x126 - var_x130 * var_x298;
        IJth(rJacobian, 29, 28) = var_x328 + var_x334 - var_x327 - var_x329;
        IJth(rJacobian, 30, 28) = var_x327 + var_x329 + var_x356 - var_x328;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (var_x142 + 2.0896500737607973 * var_x151 - 1.2919117486481029 * var_x132 - 8.7616355293953774 * var_x145 - var_x131 * var_x144 - var_x134 * var_chaste_interface__ionic_concentrations__Nai - var_x14 * var_x143 - var_x150 * var_x81 - var_x152 * var_x95);
        ...
        IJth(rJacobian, 0, 30) = mSetVoltageDerivativeToZero ? 0.0 : (var_x152 + 1.2919117486481029 * var_x158 + 8.7616355293953774 * var_x155 + 0.57777777777777772 * var_x161 - 0.16460179221381521 * var_x162 - 1.3 * var_x157 - 0.024270695636233148 * var_x164 - 2.0896500737607973 * var_x166 + var_x133 * var_x167 + var_x137 * var_x160 + var_x139 * var_x159 + var_x143 * var_x153 - var_x131 * var_x163 - var_x140 * var_x160 - var_x141 * var_x159 - var_x165 * var_x81);
        IJth(rJacobian, 28, 30) = 0.00010635506760017686 * var_x161 - 0.00023929890210039797 * var_x157 + var_x160 * var_x299 + var_x167 * var_x302 - var_x160 * var_x300;
