...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x192 = 9.2094906201727294e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.013333333333333332 + 0.0093584727056863666 * var_x31 + 0.014012961821292271 * var_x57 - 2.0 * var_x13 - 0.00033333333333333332 * var_x23 - 0.028025923642584542 * var_x54 - 1.7516202276615342e-5 * var_x61 - 0.000891283114827273 * var_x27 - 0.0024522683187261475 * var_x56 + var_x47 * var_x59 + var_x59 * var_x60 - var_x1 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x10 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x33 * var_x40 - var_x33 * var_x50 - var_x44 * var_x47);
        ...
        IJth(rJacobian, 13, 13) = -0.001 + var_x195 - var_x193 - var_x194 + 0.0064466434341209104 * var_x101 - 4.8349825755906825e-7 * var_x104 + var_x12 * var_x189 + var_x187 * var_x28 - var_x188 * var_x55 - var_x191 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x192 * var_x25 - 1.9101165730728621e-7 * var_x102 * var_x28;
        ...
        IJth(rJacobian, 13, 14) = var_x192 + var_x188 * var_x96 + var_x193 * var_x3 + var_x194 * var_x3 - var_x195 * var_x3;
