...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x24 = -0.037433890822745466 * var_chaste_interface__membrane__V;
        ...
        const double var_x34 = exp(3.7433890822745468 - var_x2);
        ...
        const double var_x40 = 0.18716945411372732 * var_x39;
        const double var_x41 = exp(1.8716945411372734 + var_x24);
        const double var_x42 = 1.0 - var_x41;
        const double var_x43 = 1 / var_x42;
        const double var_x44 = 0.00046792363528431834 * var_x43;
        const double var_x45 = exp(1.8716945411372734);
        ...
        const double var_x59 = 1.7516202276615342e-5 * var_x58;
        ...
        const double var_x63 = var_x18 * var_x22;
        const double var_x64 = 2.0 * var_x17 - 2744000.0 * var_x19;
        const double var_x65 = var_x21 * var_x64 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x66 = var_x20 * var_x64 / pow((0.0036443148688046641 + 7.2886297376093286e-7 * var_x14 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x67 = var_x37 * var_x53;
        ...
        const double var_x71 = var_x11 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x72 = 1.0 * var_x28;
        const double var_x73 = 1 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki + var_chaste_interface__intracellular_sodium_concentration__Nai);
        ...
        const double var_x77 = var_x32 * var_x51;
        const double var_x78 = var_x44 * var_x46;
        ...
        const double var_x86 = 8.3333333333333321 * var_x85;
        const double var_x87 = var_x0 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x88 = var_x73 * var_x87;
        const double var_x89 = var_chaste_interface__extracellular_potassium_concentration__Kc * var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x90 = var_x83 * var_x89 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Nai), 2);
        const double var_x91 = pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 2.0);
        const double var_x92 = var_x66 * var_x91;
        const double var_x93 = 26.713760659695652 * var_x12;
        const double var_x94 = var_x68 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x95 = var_x16 * var_x22 * var_x91;
        const double var_x96 = var_x45 * var_x52;
        const double var_x97 = -var_x44 * var_x96;
        const double var_x98 = 3.3392200824619565 * var_x9;
        const double var_x99 = 0.023809523809523808 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x100 = var_x87 / var_x74;
        const double var_x101 = var_x84 * var_x89 / pow(var_x82, 2);
        const double var_x102 = var_chaste_interface__extracellular_potassium_concentration__Kc * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow((1 + 0.022222222222222223 * var_chaste_interface__extracellular_potassium_concentration__Kc), 2);
        ...
        const double var_x106 = 0.24999999999999997 * var_x105;
        const double var_x107 = 4.0200601101640959e-6 * var_x39;
        ...
        const double var_x116 = -6.7000000000000011e-6 * var_x115 * (1.0 - var_chaste_interface__hyperpolarising_activated_current_y_gate__y);
        const double var_x117 = 52.0 + var_chaste_interface__membrane__V;
        const double var_x118 = fabs(var_x117) < 1.0000000000000001e-5;
        const double var_x119 = -0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x120 = exp(-10.4 + var_x119);
        const double var_x121 = 1.0 - 1.0 * var_x120;
        const double var_x122 = 0.002 / var_x121;
        const double var_x123 = -0.0001 * var_x115;
        ...
        const double var_x127 = exp(-4.4000000000000004 + var_x119);
        ...
        const double var_x143 = -8.0 * var_x133;
        ...
        const double var_x148 = 1.0 - var_chaste_interface__second_inward_current_d_gate__d;
        ...
        const double var_x154 = exp(1.8999999999999999 + var_x138);
        ...
        const double var_x159 = -0.012500000000000001 * var_x157 * var_chaste_interface__second_inward_current_f_gate__f / pow(var_x158, 2);
        const double var_x160 = 34.0 + var_chaste_interface__membrane__V;
        ...
        const double var_x166 = -0.050000000000000003 / var_x158;
        const double var_x167 = 8.9492436350427843e-6 * var_x0;
        const double var_x168 = -4.2956369448205359e-5 * var_x13;
        const double var_x169 = 2.0100300550820481e-8 * var_x43;
        const double var_x170 = 7.5243245632378442e-10 * var_x58;
        const double var_x171 = 4.2956369448205359e-5 * var_x69;
        const double var_x172 = var_x169 * var_x46;
        const double var_x173 = 0.0010739092362051341 * var_x85;
        const double var_x174 = 0.0011475261722488205 * var_x12;
        const double var_x175 = -var_x169 * var_x96;
        const double var_x176 = 2.1213021949731043e-8 * var_x102;
        const double var_x177 = 0.002 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x178 = 0.20000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        ...
        const double var_x188 = 1.8099220986453829e-7 * var_x43;
        const double var_x189 = 0.00038679860604725458 * var_x28;
        const double var_x190 = var_x188 * var_x49;
        const double var_x191 = 0.0064466434341209104 * var_x85;
        const double var_x192 = 0.0012916056731812832 * var_x9;
        const double var_x193 = 0.010332845385450266 * var_x12;
        const double var_x194 = 9.2094906201727294e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x195 = 9.6699651511813632e-5 * var_x105;
        ...
        const double var_x199 = 0.00071593949080342272 * var_x85;
        ...
        const double var_x202 = 1.0739092362051338e-5 * var_x105;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.013333333333333332 + 0.0093584727056863666 * var_x31 + 0.014012961821292271 * var_x57 - 2.0 * var_x13 - 0.00033333333333333332 * var_x23 - 0.028025923642584542 * var_x54 - 1.7516202276615342e-5 * var_x61 - 0.0024522683187261475 * var_x56 - 0.00089128311482727289 * var_x27 + var_x47 * var_x59 + var_x59 * var_x60 - var_x1 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x10 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x33 * var_x40 - var_x33 * var_x50 - var_x44 * var_x47);
        IJth(rJacobian, 1, 0) = -3.5796974540171133e-8 + 1.4318789816068455e-8 * var_x23 + 3.0097298252951375e-7 * var_x57 - 6.0194596505902749e-7 * var_x54 - var_x107 * var_x33;
        IJth(rJacobian, 2, 0) = ((var_x118) ? (var_x116) : (var_x116 - var_x122 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y + 0.00040000000000000002 * var_x117 * var_x120 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow(var_x121, 2)));
        ...
        IJth(rJacobian, 4, 0) = ((var_x136) ? (var_x134) : (var_x134 + var_x137 * var_x142 - 0.020000000000000004 * var_x135 * var_x137 * var_x140 / pow(var_x141, 2)));
        IJth(rJacobian, 5, 0) = -0.0025000000000000001 * var_x144 * (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x145 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x145), 2);
        IJth(rJacobian, 6, 0) = ((var_x147) ? (0) : (var_x148 * var_x153 - var_x156 * var_chaste_interface__second_inward_current_d_gate__d + 0.0012000000000000001 * var_x146 * var_x154 * var_chaste_interface__second_inward_current_d_gate__d / pow(var_x155, 2) - 0.0074999999999999997 * var_x146 * var_x148 * var_x151 / pow(var_x152, 2)));
        IJth(rJacobian, 7, 0) = ((var_x161) ? (var_x159) : (var_x159 + var_x162 * var_x165 - 0.0015625000000000001 * var_x160 * var_x162 * var_x163 / pow(var_x164, 2)));
        IJth(rJacobian, 9, 0) = -5.0115764356239594e-7 + var_x168 - 4.2956369448205366e-8 * var_x23 - 1.0534054388532982e-7 * var_x56 + var_x170 * var_x47 - var_x167 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x169 * var_x47;
        ...
        IJth(rJacobian, 13, 0) = 0.00038679860604725458 * var_x13 + 6.7752426238365617e-9 * var_x61 + 3.4474706640864439e-7 * var_x27 - 3.6198441972907654e-6 * var_x31 + var_x187 * var_chaste_interface__extracellular_potassium_concentration__Kc + var_x188 * var_x60 - 6.7752426238365617e-9 * var_x58 * var_x60;
        IJth(rJacobian, 14, 0) = var_x168 + 4.0200601101640959e-7 * var_x31 - 3.8286286763467583e-8 * var_x27 - 7.5243245632378442e-10 * var_x61 + var_x170 * var_x60 - var_x169 * var_x60 - var_x196 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (914.66666666666663 * var_x63 + 2.3e-6 * var_x65 + 1.214771622934888e-6 * var_x66 - 0.18716945411372732 * var_x67 - 0.022261467216413044 * var_x62);
        IJth(rJacobian, 1, 1) = -0.20000000000000001 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 4.7813590510367528e-7 * var_x62 - 4.0200601101640959e-6 * var_x67 - 0.039290759255291838 * var_x63 - 9.8799649730872331e-11 * var_x65 - 5.2182178629987073e-11 * var_x66 + var_x108 * var_x112 - var_x108 * var_x113;
        IJth(rJacobian, 8, 1) = -20.0 * var_chaste_interface__second_inward_current_f2_gate__f2;
        IJth(rJacobian, 9, 1) = 1.5654653588996123e-10 * var_x66 + 0.11787227776587553 * var_x63 + 2.9639894919261703e-10 * var_x65;
        IJth(rJacobian, 10, 1) = 4.0 - 0.80000000000000004 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
        IJth(rJacobian, 11, 1) = var_x113 * var_x178 - var_x112 * var_x178;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x70 * var_x71 - var_x71 * var_x72);
        IJth(rJacobian, 2, 2) = ((var_x118) ? (-0.0050000000000000001 + var_x123) : (var_x123 - var_x117 * var_x122));
        IJth(rJacobian, 9, 2) = -var_x171 * var_x71;
        IJth(rJacobian, 13, 2) = var_x189 * var_x71;
        IJth(rJacobian, 14, 2) = -var_x197 * var_x71;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (0.023809523809523808 * var_x26 - 0.023809523809523808 * var_chaste_interface__intracellular_potassium_concentration__Ki);
        IJth(rJacobian, 3, 3) = ((var_x125) ? (-0.0050000000000000001) : (-var_x124 * var_x129 - var_x124 * var_x132));
        IJth(rJacobian, 13, 3) = 9.2094906201727294e-6 * var_chaste_interface__intracellular_potassium_concentration__Ki - 9.2094906201727294e-6 * var_x26;
        ...
        IJth(rJacobian, 4, 4) = ((var_x136) ? (-2.0 + var_x143) : (var_x143 - var_x135 * var_x142));
        IJth(rJacobian, 9, 4) = -2.6847730905128355e-5 * var_x76;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x1 * var_x75);
        IJth(rJacobian, 5, 5) = -2.0 / (1.0 + 320.0 * var_x145) - 0.02 * var_x144;
        IJth(rJacobian, 9, 5) = -var_x167 * var_x75;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x40 * var_x77 - var_x50 * var_x77 - var_x77 * var_x78);
        IJth(rJacobian, 1, 6) = -var_x107 * var_x77;
        IJth(rJacobian, 6, 6) = ((var_x147) ? (-0.23999999999999999) : (-var_x146 * var_x153 - var_x146 * var_x156));
        IJth(rJacobian, 9, 6) = -var_x172 * var_x77;
        IJth(rJacobian, 13, 6) = var_x190 * var_x77;
        IJth(rJacobian, 14, 6) = -var_x198 * var_x77;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x40 * var_x80 - var_x50 * var_x80 - var_x78 * var_x80);
        IJth(rJacobian, 1, 7) = -var_x107 * var_x80;
        IJth(rJacobian, 7, 7) = ((var_x161) ? (-0.025000000000000001 + var_x166) : (var_x166 - var_x160 * var_x165));
        IJth(rJacobian, 9, 7) = -var_x172 * var_x80;
        IJth(rJacobian, 13, 7) = var_x190 * var_x80;
        IJth(rJacobian, 14, 7) = -var_x198 * var_x80;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x40 * var_x81 - var_x50 * var_x81 - var_x78 * var_x81);
        IJth(rJacobian, 1, 8) = -var_x107 * var_x81;
        IJth(rJacobian, 8, 8) = -0.01 - 20.0 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 9, 8) = -var_x172 * var_x81;
        IJth(rJacobian, 13, 8) = var_x190 * var_x81;
        IJth(rJacobian, 14, 8) = -var_x198 * var_x81;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x97 + 0.0052083333333333322 * var_x90 + 2.6562061725981517e-12 * var_x92 - 0.31166054102978263 * var_x68 - 0.002 * var_x95 - 5.5653668041032605 * var_x88 - var_x86 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x93 * var_x94);
        IJth(rJacobian, 1, 9) = 8.5912738896410732e-8 * var_x95 - 1.1410097368072975e-16 * var_x92;
        IJth(rJacobian, 9, 9) = var_x175 + 6.7119327262820884e-7 * var_x90 + 3.4230292104218926e-16 * var_x92 - 1.3387805342902908e-5 * var_x68 - 2.5773821668923221e-7 * var_x95 - 0.00023906795255183765 * var_x88 - var_x173 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x174 * var_x94;
        IJth(rJacobian, 13, 9) = 4.0291521463255691e-6 * var_x90 - var_x191 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 14, 9) = -4.4746218175213919e-7 * var_x90 + var_x199 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 1, 10) = 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 10, 10) = -var_x177 - 0.80000000000000004 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 11, 10) = var_x179;
        IJth(rJacobian, 1, 11) = 0.002 * var_x114;
        IJth(rJacobian, 10, 11) = var_x177;
        IJth(rJacobian, 11, 11) = -var_x179 - 0.10000000000000001 * var_x114;
        ...
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x93 + var_x98 - var_x106 + 8.3333333333333321 * var_x101 + 0.66784401649239122 * var_x100 + 0.00125 * var_x104 + var_x103 * var_x28 + var_x103 * var_x69 + var_x25 * var_x99 + var_x44 * var_x55 - var_x10 * var_x28 - var_x12 * var_x70 - var_x12 * var_x72 - var_x86 * var_chaste_interface__intracellular_sodium_concentration__Nai);
        IJth(rJacobian, 9, 13) = 0.0010739092362051341 * var_x101 + 2.8688154306220515e-5 * var_x100 + var_x176 * var_x69 - var_x12 * var_x171 - var_x173 * var_chaste_interface__intracellular_sodium_concentration__Nai;
        IJth(rJacobian, 13, 13) = -0.001 + var_x195 - var_x192 - var_x193 + 0.0064466434341209104 * var_x101 - 4.8349825755906825e-7 * var_x104 + var_x12 * var_x189 + var_x187 * var_x28 - var_x188 * var_x55 - var_x191 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x194 * var_x25 - 1.9101165730728621e-7 * var_x102 * var_x28;
        IJth(rJacobian, 14, 13) = var_x174 + var_x201 - var_x202 + 5.3695461810256699e-8 * var_x104 - 0.00071593949080342272 * var_x101 + var_x169 * var_x55 + var_x176 * var_x28 + var_x199 * var_chaste_interface__intracellular_sodium_concentration__Nai + var_x200 * var_x25 - var_x12 * var_x197 - var_x196 * var_x28;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x97 - var_x99 - 0.66784401649239122 * var_x88 + var_x106 * var_x3 - var_x3 * var_x93 - var_x3 * var_x98);
        IJth(rJacobian, 9, 14) = -2.8688154306220515e-5 * var_x88;
        IJth(rJacobian, 13, 14) = var_x194 + var_x188 * var_x96 + var_x192 * var_x3 + var_x193 * var_x3 - var_x195 * var_x3;
