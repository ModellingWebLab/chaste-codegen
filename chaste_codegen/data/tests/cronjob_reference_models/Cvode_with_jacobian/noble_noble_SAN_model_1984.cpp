...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x1 = 0.20833333333333331 * var_x0;
        const double var_x2 = 0.074867781645490933 * var_chaste_interface__membrane__V;
        ...
        const double var_x5 = exp(0.74867781645490927 + var_x2 - 1.9999999999999998 * var_x4);
        ...
        const double var_x15 = 0.018716945411372733 * var_chaste_interface__membrane__V;
        ...
        const double var_x21 = 1 / (1.0 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Cai + 0.00020000000000000001 * var_x14);
        const double var_x22 = var_x20 * var_x21;
        const double var_x23 = var_x22 * (0.037433890822745466 * var_x17 + 51359.29820880678 * var_x19);
        const double var_x24 = exp(-0.037433890822745466 * var_chaste_interface__membrane__V);
        const double var_x25 = var_x24 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x26 = var_x25 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x27 = -26.713760659695652 * var_x4 + var_chaste_interface__membrane__V;
        const double var_x28 = var_x27 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x29 = var_x5 * var_x8 / pow(var_x6, 2);
        const double var_x30 = var_x28 * var_x29;
        const double var_x31 = var_chaste_interface__second_inward_current_f2_gate__f2 * var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x32 = var_x31 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x33 = exp(3.7433890822745468 - var_x2);
        const double var_x34 = 1.0 - var_x33;
        const double var_x35 = 1 / var_x34;
        const double var_x36 = exp(3.7433890822745468);
        const double var_x37 = -2.0 * var_x33 + var_x36 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        const double var_x38 = var_x35 * var_x37;
        const double var_x39 = 0.18716945411372732 * var_x38;
        const double var_x40 = exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V);
        const double var_x41 = 1.0 - var_x40;
        const double var_x42 = 1 / var_x41;
        const double var_x43 = 0.00046792363528431834 * var_x42;
        const double var_x44 = exp(1.8716945411372734);
        const double var_x45 = -140.0 * var_x40 + var_x44 * var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x46 = var_x32 * var_x45;
        const double var_x47 = var_x40 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x48 = -var_x47 + var_x44 * var_chaste_interface__intracellular_potassium_concentration__Ki;
        ...
        const double var_x57 = var_x40 * var_x50 / pow(var_x41, 2);
        const double var_x58 = 1.7516202276615342e-5 * var_x57;
        const double var_x59 = var_x32 * var_x48;
        const double var_x60 = var_x42 * var_x47 * var_x51;
        const double var_x61 = 1 / var_chaste_interface__intracellular_calcium_concentration__Cai;
        const double var_x62 = 2.0 * var_x17 - 2744000.0 * var_x19;
        const double var_x63 = var_x20 * var_x62 / pow((0.0036443148688046641 + 7.2886297376093286e-7 * var_x14 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x64 = var_x18 * var_x22;
        const double var_x65 = var_x21 * var_x62 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x66 = var_x36 * var_x52;
        const double var_x67 = 1 / var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x68 = -26.713760659695652 * log(140.0 * var_x67) + var_chaste_interface__membrane__V;
        const double var_x69 = 1.0 * var_x68;
        const double var_x70 = var_x11 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x71 = 1.0 * var_x27;
        const double var_x72 = 1 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki + var_chaste_interface__intracellular_sodium_concentration__Nai);
        const double var_x73 = 140.0 + 0.12 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x74 = -26.713760659695652 * log(var_x72 * var_x73) + var_chaste_interface__membrane__V;
        const double var_x75 = var_x74 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x76 = var_x31 * var_x50;
        const double var_x77 = var_x43 * var_x45;
        const double var_x78 = var_x50 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x79 = var_x78 * var_chaste_interface__second_inward_current_f2_gate__f2;
        const double var_x80 = var_x78 * var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x81 = 1.0 + var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x82 = 1 / var_x81;
        const double var_x83 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Nai);
        const double var_x84 = var_x82 * var_x83;
        const double var_x85 = 8.3333333333333321 * var_x84;
        const double var_x86 = var_x0 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x87 = var_x72 * var_x86;
        const double var_x88 = var_chaste_interface__extracellular_potassium_concentration__Kc * var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x89 = var_x82 * var_x88 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Nai), 2);
        const double var_x90 = pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 2.0);
        const double var_x91 = var_x63 * var_x90;
        const double var_x92 = 26.713760659695652 * var_x12;
        const double var_x93 = var_x67 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x94 = var_x16 * var_x22 * var_x90;
        const double var_x95 = var_x44 * var_x51;
        const double var_x96 = -var_x43 * var_x95;
        const double var_x97 = 3.3392200824619565 * var_x9;
        const double var_x98 = 0.023809523809523808 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x99 = var_x86 / var_x73;
        const double var_x100 = var_x83 * var_x88 / pow(var_x81, 2);
        ...
        const double var_x102 = 0.00049382716049382717 * var_x101;
        const double var_x103 = var_x28 * var_x7 / pow((1 + 0.10000000000000001 * var_chaste_interface__extracellular_potassium_concentration__Kc), 2);
        const double var_x104 = var_x27 * var_x29;
        const double var_x105 = 0.24999999999999997 * var_x104;
        const double var_x106 = 4.0200601101640959e-6 * var_x38;
        const double var_x107 = 0.0040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x108 = pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 2.0);
        const double var_x109 = 3.9999999999999998e-6 + var_x108;
        const double var_x110 = 1 / var_x109;
        const double var_x111 = var_x110 * pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 1.0);
        const double var_x112 = pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 3.0) / pow(var_x109, 2);
        const double var_x113 = var_x108 * var_x110;
        const double var_x114 = exp(-3.484 - 0.067000000000000004 * var_chaste_interface__membrane__V);
        const double var_x115 = -0.067000000000000004 * var_x114 * (0.0001 - 0.0001 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y);
        ...
        const double var_x120 = 0.002 / var_x119;
        const double var_x121 = -0.0001 * var_x114;
        const double var_x122 = 22.0 + var_chaste_interface__membrane__V;
        const double var_x123 = fabs(var_x122) < 0.0001;
        const double var_x124 = 1.0 - var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        ...
        const double var_x127 = 0.00050000000000000001 / var_x126;
        ...
        const double var_x130 = 0.00017799999999999999 / var_x129;
        const double var_x131 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x132 = 0.44800000000000001 * var_x131 * var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x137 = exp(-4.1000000000000005 + var_x136);
        const double var_x138 = 1.0 - var_x137;
        const double var_x139 = 0.20000000000000001 / var_x138;
        const double var_x140 = -8.0 * var_x131;
        const double var_x141 = exp(-9.375 - 0.125 * var_chaste_interface__membrane__V);
        const double var_x142 = exp(-7.5 + var_x136);
        const double var_x143 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x144 = fabs(var_x143) < 0.0001;
        const double var_x145 = 1.0 - var_chaste_interface__second_inward_current_d_gate__d;
        ...
        const double var_x150 = 0.029999999999999999 / var_x149;
        ...
        const double var_x153 = 0.012 / var_x152;
        const double var_x154 = exp(-8.5 + var_x147);
        const double var_x155 = 1.0 + var_x154;
        const double var_x156 = -0.012500000000000001 * var_x154 * var_chaste_interface__second_inward_current_f_gate__f / pow(var_x155, 2);
        const double var_x157 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x158 = fabs(var_x157) < 0.0001;
        const double var_x159 = 1.0 - var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x160 = exp(8.5 + var_x146);
        const double var_x161 = -1.0 + var_x160;
        const double var_x162 = 0.0062500000000000003 / var_x161;
        const double var_x163 = -0.050000000000000003 / var_x155;
        const double var_x164 = 8.9492436350427843e-6 * var_x0;
        const double var_x165 = -4.2956369448205359e-5 * var_x13;
        const double var_x166 = 2.0100300550820481e-8 * var_x42;
        const double var_x167 = 7.5243245632378442e-10 * var_x57;
        const double var_x168 = 4.2956369448205359e-5 * var_x68;
        const double var_x169 = var_x166 * var_x45;
        const double var_x170 = 0.0010739092362051341 * var_x84;
        const double var_x171 = 0.0011475261722488205 * var_x12;
        const double var_x172 = -var_x166 * var_x95;
        const double var_x173 = 2.1213021949731043e-8 * var_x101;
        const double var_x174 = 0.002 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x175 = 0.20000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x176 = 0.0050000000000000001 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x177 = 1.0 - var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x178 = exp(16.0 + var_x146);
        const double var_x179 = -1.0 + var_x178;
        const double var_x180 = 0.00062500000000000001 / var_x179;
        const double var_x181 = exp(-16.0 + var_x147);
        const double var_x182 = 1.0 + var_x181;
        const double var_x183 = 64.0 + var_chaste_interface__membrane__V;
        const double var_x184 = 4.8349825755906823e-5 * var_x9;
        const double var_x185 = 1.8099220986453829e-7 * var_x42;
        const double var_x186 = 0.00038679860604725458 * var_x27;
        const double var_x187 = var_x185 * var_x48;
        const double var_x188 = 0.0064466434341209104 * var_x84;
        const double var_x189 = 9.2094906201727294e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x190 = 0.0012916056731812834 * var_x9;
        const double var_x191 = 0.010332845385450267 * var_x12;
        const double var_x192 = 9.6699651511813646e-5 * var_x104;
        const double var_x193 = 5.3695461810256699e-6 * var_x9;
        const double var_x194 = 4.2956369448205359e-5 * var_x27;
        const double var_x195 = var_x166 * var_x48;
        const double var_x196 = 0.00071593949080342272 * var_x84;
        const double var_x197 = 1.0227707011477468e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x198 = 0.00014344077153110256 * var_x9;
        const double var_x199 = 1.073909236205134e-5 * var_x104;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.013333333333333332 + 0.0093584727056863666 * var_x30 + 0.014012961821292271 * var_x56 - 2.0 * var_x13 - 0.00033333333333333332 * var_x23 - 0.028025923642584542 * var_x53 - 1.7516202276615342e-5 * var_x60 - 0.0024522683187261475 * var_x55 - 0.000891283114827273 * var_x26 + var_x46 * var_x58 + var_x58 * var_x59 - var_x1 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x10 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x32 * var_x39 - var_x32 * var_x49 - var_x43 * var_x46);
        IJth(rJacobian, 1, 0) = -3.5796974540171133e-8 + 3.0097298252951375e-7 * var_x56 + 1.4318789816068455e-8 * var_x23 - 6.0194596505902749e-7 * var_x53 - var_x106 * var_x32;
        IJth(rJacobian, 2, 0) = ((var_x117) ? (var_x115) : (var_x115 - var_x120 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y + 0.00040000000000000002 * var_x116 * var_x118 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow(var_x119, 2)));
        IJth(rJacobian, 3, 0) = ((var_x123) ? (0) : (var_x124 * var_x127 - var_x130 * var_chaste_interface__time_dependent_potassium_current_x_gate__x + 1.1866666666666666e-5 * var_x122 * var_x128 * var_chaste_interface__time_dependent_potassium_current_x_gate__x / pow(var_x129, 2) - 0.0001 * var_x122 * var_x124 * var_x125 / pow(var_x126, 2)));
        IJth(rJacobian, 4, 0) = ((var_x134) ? (var_x132) : (var_x132 + var_x135 * var_x139 - 0.02 * var_x133 * var_x135 * var_x137 / pow(var_x138, 2)));
        ...
        IJth(rJacobian, 6, 0) = ((var_x144) ? (0) : (var_x145 * var_x150 - var_x153 * var_chaste_interface__second_inward_current_d_gate__d + 0.0012000000000000001 * var_x143 * var_x151 * var_chaste_interface__second_inward_current_d_gate__d / pow(var_x152, 2) - 0.0074999999999999997 * var_x143 * var_x145 * var_x148 / pow(var_x149, 2)));
        IJth(rJacobian, 7, 0) = ((var_x158) ? (var_x156) : (var_x156 + var_x159 * var_x162 - 0.0015625000000000001 * var_x157 * var_x159 * var_x160 / pow(var_x161, 2)));
        IJth(rJacobian, 9, 0) = -5.0115764356239594e-7 + var_x165 - 1.0534054388532982e-7 * var_x55 - 4.2956369448205366e-8 * var_x23 + var_x167 * var_x46 - var_x164 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x166 * var_x46;
        IJth(rJacobian, 12, 0) = var_x177 * var_x180 - 0.00125 * var_x181 * var_chaste_interface__intracellular_calcium_concentration__p / pow(var_x182, 2) - 0.00015625 * var_x177 * var_x178 * var_x183 / pow(var_x179, 2);
        IJth(rJacobian, 13, 0) = 3.4474706640864439e-7 * var_x26 + 6.7752426238365617e-9 * var_x60 + 0.00038679860604725458 * var_x13 - 3.6198441972907658e-6 * var_x30 + var_x184 * var_chaste_interface__extracellular_potassium_concentration__Kc + var_x185 * var_x59 - 6.7752426238365617e-9 * var_x57 * var_x59;
        IJth(rJacobian, 14, 0) = var_x165 + 4.0200601101640959e-7 * var_x30 - 7.5243245632378442e-10 * var_x60 - 3.8286286763467583e-8 * var_x26 + var_x167 * var_x59 - var_x166 * var_x59 - var_x193 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (1.214771622934888e-6 * var_x63 + 914.66666666666663 * var_x64 + 2.3e-6 * var_x65 - 0.022261467216413044 * var_x61 - 0.18716945411372732 * var_x66);
        IJth(rJacobian, 1, 1) = -0.20000000000000001 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 0.039290759255291838 * var_x64 - 4.7813590510367528e-7 * var_x61 - 4.0200601101640959e-6 * var_x66 - 9.8799649730872331e-11 * var_x65 - 5.2182178629987073e-11 * var_x63 + var_x107 * var_x111 - var_x107 * var_x112;
        IJth(rJacobian, 8, 1) = -20.0 * var_chaste_interface__second_inward_current_f2_gate__f2;
        IJth(rJacobian, 9, 1) = 2.9639894919261698e-10 * var_x65 + 1.5654653588996121e-10 * var_x63 + 0.11787227776587551 * var_x64;
        IJth(rJacobian, 10, 1) = 4.0 - 0.80000000000000004 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
        IJth(rJacobian, 11, 1) = var_x112 * var_x175 - var_x111 * var_x175;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x69 * var_x70 - var_x70 * var_x71);
        IJth(rJacobian, 2, 2) = ((var_x117) ? (-0.0050000000000000001 + var_x121) : (var_x121 - var_x116 * var_x120));
        IJth(rJacobian, 9, 2) = -var_x168 * var_x70;
        IJth(rJacobian, 13, 2) = var_x186 * var_x70;
        IJth(rJacobian, 14, 2) = -var_x194 * var_x70;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (0.023809523809523808 * var_x25 - 0.023809523809523808 * var_chaste_interface__intracellular_potassium_concentration__Ki);
        IJth(rJacobian, 3, 3) = ((var_x123) ? (-0.0050000000000000001) : (-var_x122 * var_x127 - var_x122 * var_x130));
        IJth(rJacobian, 13, 3) = 9.2094906201727294e-6 * var_chaste_interface__intracellular_potassium_concentration__Ki - 9.2094906201727294e-6 * var_x25;
        IJth(rJacobian, 14, 3) = 1.0227707011477468e-6 * var_x25 - 1.0227707011477468e-6 * var_chaste_interface__intracellular_potassium_concentration__Ki;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.625 * var_x75);
        IJth(rJacobian, 4, 4) = ((var_x134) ? (-2.0 + var_x140) : (var_x140 - var_x133 * var_x139));
        IJth(rJacobian, 9, 4) = -2.6847730905128351e-5 * var_x75;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x1 * var_x74);
        IJth(rJacobian, 5, 5) = -0.02 * var_x141 - 2.0 / (1.0 + 320.0 * var_x142);
        IJth(rJacobian, 9, 5) = -var_x164 * var_x74;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x39 * var_x76 - var_x49 * var_x76 - var_x76 * var_x77);
        IJth(rJacobian, 1, 6) = -var_x106 * var_x76;
        IJth(rJacobian, 6, 6) = ((var_x144) ? (-0.23999999999999999) : (-var_x143 * var_x150 - var_x143 * var_x153));
        IJth(rJacobian, 9, 6) = -var_x169 * var_x76;
        IJth(rJacobian, 13, 6) = var_x187 * var_x76;
        IJth(rJacobian, 14, 6) = -var_x195 * var_x76;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x39 * var_x79 - var_x49 * var_x79 - var_x77 * var_x79);
        IJth(rJacobian, 1, 7) = -var_x106 * var_x79;
        IJth(rJacobian, 7, 7) = ((var_x158) ? (-0.025000000000000001 + var_x163) : (var_x163 - var_x157 * var_x162));
        IJth(rJacobian, 9, 7) = -var_x169 * var_x79;
        IJth(rJacobian, 13, 7) = var_x187 * var_x79;
        IJth(rJacobian, 14, 7) = -var_x195 * var_x79;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x39 * var_x80 - var_x49 * var_x80 - var_x77 * var_x80);
        IJth(rJacobian, 1, 8) = -var_x106 * var_x80;
        IJth(rJacobian, 8, 8) = -0.01 - 20.0 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 9, 8) = -var_x169 * var_x80;
        IJth(rJacobian, 13, 8) = var_x187 * var_x80;
        IJth(rJacobian, 14, 8) = -var_x195 * var_x80;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x96 + 0.005208333333333333 * var_x89 + 2.6562061725981517e-12 * var_x91 - 0.002 * var_x94 - 0.31166054102978263 * var_x67 - 5.5653668041032605 * var_x87 - var_x85 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x92 * var_x93);
        IJth(rJacobian, 1, 9) = 8.5912738896410732e-8 * var_x94 - 1.1410097368072975e-16 * var_x91;
        IJth(rJacobian, 9, 9) = var_x172 + 3.4230292104218922e-16 * var_x91 + 6.7119327262820884e-7 * var_x89 - 1.3387805342902908e-5 * var_x67 - 2.5773821668923216e-7 * var_x94 - 0.00023906795255183763 * var_x87 - var_x170 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x171 * var_x93;
        IJth(rJacobian, 13, 9) = 4.0291521463255691e-6 * var_x89 - var_x188 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 14, 9) = -4.4746218175213919e-7 * var_x89 + var_x196 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 1, 10) = 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 10, 10) = -var_x174 - 0.80000000000000004 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 11, 10) = var_x176;
        IJth(rJacobian, 1, 11) = 0.002 * var_x113;
        IJth(rJacobian, 10, 11) = var_x174;
        IJth(rJacobian, 11, 11) = -var_x176 - 0.10000000000000001 * var_x113;
        ...
        IJth(rJacobian, 12, 12) = -0.0050000000000000001 / var_x182 - var_x180 * var_x183;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x92 + var_x97 - var_x105 + 8.3333333333333321 * var_x100 + 0.00125 * var_x103 + 0.66784401649239122 * var_x99 + var_x102 * var_x27 + var_x102 * var_x68 + var_x24 * var_x98 + var_x43 * var_x54 - var_x10 * var_x27 - var_x12 * var_x69 - var_x12 * var_x71 - var_x85 * var_chaste_interface__intracellular_sodium_concentration__Nai);
        IJth(rJacobian, 9, 13) = 2.8688154306220515e-5 * var_x99 + 0.0010739092362051341 * var_x100 + var_x173 * var_x68 - var_x12 * var_x168 - var_x170 * var_chaste_interface__intracellular_sodium_concentration__Nai;
        IJth(rJacobian, 13, 13) = -0.001 + var_x192 - var_x190 - var_x191 + 0.0064466434341209104 * var_x100 - 4.8349825755906825e-7 * var_x103 + var_x12 * var_x186 + var_x184 * var_x27 - var_x185 * var_x54 - var_x188 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x189 * var_x24 - 1.9101165730728623e-7 * var_x101 * var_x27;
        IJth(rJacobian, 14, 13) = var_x171 + var_x198 - var_x199 + 5.3695461810256706e-8 * var_x103 - 0.00071593949080342272 * var_x100 + var_x166 * var_x54 + var_x173 * var_x27 + var_x196 * var_chaste_interface__intracellular_sodium_concentration__Nai + var_x197 * var_x24 - var_x12 * var_x194 - var_x193 * var_x27;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x96 - var_x98 - 0.66784401649239122 * var_x87 + var_x105 * var_x3 - var_x3 * var_x92 - var_x3 * var_x97);
        IJth(rJacobian, 9, 14) = -2.8688154306220515e-5 * var_x87;
        IJth(rJacobian, 13, 14) = var_x189 + var_x185 * var_x95 + var_x190 * var_x3 + var_x191 * var_x3 - var_x192 * var_x3;
        IJth(rJacobian, 14, 14) = var_x172 - var_x197 + var_x199 * var_x3 - var_x171 * var_x3 - var_x198 * var_x3;
    }
