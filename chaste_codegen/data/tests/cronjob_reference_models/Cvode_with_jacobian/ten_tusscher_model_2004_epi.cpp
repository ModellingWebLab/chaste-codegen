...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x14 = 0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x15 = exp(-1.0 + var_x14 - 2.6713760659695653 * var_x7);
        const double var_x16 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__membrane__V - 0.0053427521319391307 * var_x7);
        const double var_x17 = 1.0 * var_x15 + 3.0 * var_x16;
        ...
        const double var_x44 = 0.0060000000000000001 * var_x35 - 0.5 * var_x43 - var_x13 * (0.10000000000000001 * var_x15 + 0.00060000000000000006 * var_x16);
        ...
        const double var_x76 = 7.8538456339505212 * var_x7 - 0.29399999999999998 * var_chaste_interface__membrane__V;
        ...
        const double var_x88 = 0.16028256395817392 * var_x87 - var_x13 * (0.01602825639581739 * var_x16 * var_x6 + 2.6713760659695653 * var_x15 * var_x6) - 13.356880329847826 * var_x43 * var_x6;
        ...
        const double var_x184 = exp(-3.2000000000000002 - var_x14);
        ...
        const double var_x219 = 1 + 0.022222222222222223 * var_chaste_interface__membrane__V;
        const double var_x220 = exp(-6.328125 * pow(var_x219, 2.0));
        const double var_x221 = exp(4.0 + var_x140);
        const double var_x222 = 1.0 + var_x221;
        const double var_x223 = 1 / (3.0 + 5.0 * var_x218 + 85.0 * var_x220);
        const double var_x224 = exp(3.3333333333333335 + var_x132);
        const double var_x225 = 1.0 + var_x224;
        const double var_x226 = 1 + 0.025000000000000001 * var_chaste_interface__membrane__V;
        const double var_x227 = exp(-0.88888888888888884 * pow(var_x226, 2.0));
        ...
        const double var_x230 = pow(var_x229, (-2.0));
        const double var_x231 = 14.994515539305302 / (1.0 + 3.0 * var_x230);
        const double var_x232 = var_x231 * (-0.0082319999999999997 - var_x104);
        ...
        const double var_x235 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6.0);
        const double var_x236 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16.0);
        const double var_x237 = (((var_x209) || (var_x233))) && (((var_x209) || (var_x234))) && (((var_x233) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 5.439910241481016e+20 * var_x235)))) && (((var_x234) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 1.9720198874049176e+55 * var_x236))));
        const double var_x238 = 0.0017343470110743602 * var_x29;
        const double var_x239 = 6.3176611368492499e-5 * var_x45;
        const double var_x240 = 0.00029975531551766426 * var_x7 - 1.1221007754625865e-5 * var_chaste_interface__membrane__V;
        const double var_x241 = 0.00091800065377284671 * var_x7 - 3.4364336248541711e-5 * var_chaste_interface__membrane__V;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00088199999999999997 + 0.03243 * var_x37 + 0.18928635694553864 * var_x56 - 1.1491875 * var_x42 - 0.245 * var_x0 - 0.29399999999999998 * var_x4 - 0.0146 * var_x3 - 0.0024414715719063545 * var_x32 - 0.096000000000000002 * var_x5 - 2.1086672225679694e-7 * var_x34 - 0.54050000000000009 * var_x20 - 8.6662202299424464e-5 * var_x27 - 0.18928635694553864 * var_x59 - var_x30 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x44 * var_x46 - var_x53 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        ...
        IJth(rJacobian, 11, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / var_x222) * (1.0 * var_x216 / pow(var_x217, 2) + 23.906250000000004 * var_x220 * pow(var_x219, 1.0)) / pow((0.035294117647058823 + var_x220 + 0.058823529411764705 * var_x218), 2) - 0.20000000000000001 * var_x221 * var_x223 / pow(var_x222, 2);
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x224 * var_x228 / pow(var_x225, 2) + 0.0046783625730994153 * var_x227 * pow(var_x226, 1.0) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / var_x225) / pow((0.084210526315789472 + var_x227), 2);
        IJth(rJacobian, 15, 0) = -3.389679425876563e-8 - 3.0388663876087418e-8 * var_x27 - 7.3941785176126768e-11 * var_x34 - 0.00040297005778184723 * var_x42 - var_x238 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 16, 0) = 0.00026864670518789814 * var_x42 + 3.79059668210955e-6 * var_x37 - 2.8537261917770629e-7 * var_x32 - 6.3176611368492499e-5 * var_x20 - 3.4364336248541711e-5 * var_x4 - 1.7065282626826835e-6 * var_x3 - 2.8636946873784758e-5 * var_x0 - 1.1221007754625865e-5 * var_x5 - var_x239 * var_x44;
        ...
        IJth(rJacobian, 13, 1) = var_x231 * (8.0000000000000007e-5 + var_x97);
        IJth(rJacobian, 14, 1) = ((var_x237) ? (0) : ((var_x234) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5.0) / pow((1.8382656249999998e-21 + var_x235), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15.0) / pow((5.0709427749024951e-56 + var_x236), 2))));
        ...
        IJth(rJacobian, 16, 2) = var_x240 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        IJth(rJacobian, 16, 3) = var_x240 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        IJth(rJacobian, 15, 6) = -var_x238 * var_x70;
        ...
        IJth(rJacobian, 16, 11) = var_x241 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        IJth(rJacobian, 16, 12) = var_x241 * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 13) = var_x94 * (8.0000000000000007e-5 + var_x111 * (var_x109 - var_x110));
        IJth(rJacobian, 13, 13) = var_x231 * (-8.0000000000000007e-5 + var_x111 * (var_x110 - var_x109)) + 9.9963436928702016 * pow(var_x229, (-3.0)) * (var_x100 + var_x99 - var_x107 - var_x98) / pow((0.33333333333333331 + var_x230), 2);
        ...
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (0.86632725819393008 * var_x89 - 0.3900209056315565 * var_x83 - 7.8538456339505212 * var_x84 - 62.830765071604183 * var_x80 - 2.5645210233307827 * var_x85 - 14.4387876365655 * var_x86 - var_x46 * var_x88);
        IJth(rJacobian, 16, 16) = 0.00010126109252331096 * var_x89 - 0.00029975531551766426 * var_x85 - 4.5587787568311439e-5 * var_x83 - 0.0016876848753885161 * var_x86 - 0.00091800065377284671 * var_x84 - 0.0073440052301827754 * var_x80 - var_x239 * var_x88;
    }
