...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x7 = exp(0.013101861787960915 * var_chaste_interface__membrane__V);
        const double var_x8 = var_x7 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3.0);
        const double var_x9 = var_x4 * var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x10 = var_x6 * (0.026203723575921829 * var_x8 + 166917.71917862206 * var_x9);
        const double var_x11 = 0.096000000000000002 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x12 = 1 / var_chaste_interface__potassium_dynamics__K_i;
        const double var_x13 = log(5.4000000000000004 * var_x12);
        const double var_x14 = exp(-12.0 + 0.059999999999999998 * var_chaste_interface__membrane__V - 1.6028256395817391 * var_x13);
        ...
        const double var_x22 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__membrane__V - 0.0053427521319391307 * var_x13);
        ...
        const double var_x27 = 0.29399999999999998 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        const double var_x33 = 2.0 * var_x8 - 6860000.0 * var_x9;
        const double var_x34 = var_x33 * var_x4 / pow(var_x5, 2);
        ...
        const double var_x42 = var_x38 * (0.0013214163460429152 * var_x39 + 0.00046605194074318115 * var_x40) * var_chaste_interface__sodium_dynamics__Na_i / pow(var_x41, 2);
        const double var_x43 = var_x17 * var_x23 / pow(var_x18, 2);
        const double var_x44 = 0.0060000000000000001 * var_x35 - 0.5 * var_x43 - var_x19 * (0.10000000000000001 * var_x21 + 0.00060000000000000006 * var_x22);
        const double var_x45 = var_x16 * var_x31 / pow(var_x24, 2);
        ...
        const double var_x66 = var_x31 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        const double var_x67 = 1 / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i);
        ...
        const double var_x76 = var_x31 * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x77 = 1 / var_x41;
        const double var_x78 = var_x38 * var_x77;
        const double var_x79 = var_x0 * var_x67;
        const double var_x80 = var_x77 * var_chaste_interface__sodium_dynamics__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        const double var_x81 = var_x6 * var_x7 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2.0);
        ...
        const double var_x84 = var_x12 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x85 = var_x12 * var_x26;
        const double var_x86 = var_x12 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x87 = var_x12 * var_x35;
        const double var_x88 = 0.16028256395817392 * var_x87 - var_x19 * (2.6713760659695653 * var_x12 * var_x21 + 0.01602825639581739 * var_x12 * var_x22) - 13.356880329847826 * var_x12 * var_x43;
        ...
        const double var_x121 = 0.050000000000000003 * var_chaste_interface__membrane__V;
        const double var_x122 = -var_x121;
        const double var_x123 = exp(-3.0 + var_x122);
        const double var_x124 = 1.0 + var_x123;
        const double var_x125 = exp(-3.0 + var_x121);
        ...
        const double var_x128 = 0.014880952380952382 / var_x127 - 0.014880952380952382 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x129 = 1.0 + var_x125;
        const double var_x130 = -0.16666666666666666 * var_chaste_interface__membrane__V;
        const double var_x131 = exp(-1.6666666666666667 + var_x130);
        const double var_x132 = sqrt(1.0 + var_x131);
        const double var_x133 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        const double var_x134 = 1.0 + var_x133;
        const double var_x135 = -var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1.0 / var_x134;
        const double var_x136 = var_x129 * var_x132;
        const double var_x137 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x138 = exp(7.0 + var_x137);
        const double var_x139 = 1.0 + var_x138;
        const double var_x140 = 1 / var_x139;
        const double var_x141 = exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V);
        const double var_x142 = 1.0 + var_x141;
        const double var_x143 = 1 / var_x142;
        const double var_x144 = 1 / (0.10000000000000001 * var_x140 + 0.10000000000000001 * var_x143);
        const double var_x145 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x146 = 1.0 + var_x145;
        const double var_x147 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1.0 * pow(var_x146, (-2.0));
        const double var_x148 = exp(-12.0 - var_x137);
        const double var_x149 = 1.0 + var_x148;
        const double var_x150 = var_x144 * var_x149;
        const double var_x151 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V);
        const double var_x152 = 1.0 + var_x151;
        const double var_x153 = 1.0 * pow(var_x152, (-2.0));
        const double var_x154 = var_x153 - var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x155 = exp(0.34849999999999998 * var_chaste_interface__membrane__V);
        const double var_x156 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
        const double var_x157 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x158 = 310000.0 * var_x155;
        const double var_x159 = 2.7000000000000002 * var_x156;
        const double var_x160 = 0.057000000000000002 * var_x157;
        const double var_x161 = var_x151 * pow(var_x152, (-3.0));
        const double var_x162 = 0.26917900403768508 * var_x161;
        ...
        const double var_x165 = 1 / (0.16883116883116883 + 0.16883116883116883 * var_x164);
        const double var_x166 = var_x153 - var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x169 = -25428.0 * var_x167 - 6.9480000000000002e-6 * var_x168;
        const double var_x170 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
        ...
        const double var_x179 = 0.024240000000000001 * var_x177;
        const double var_x180 = var_x173 * var_x178;
        const double var_x181 = exp(-3.2000000000000002 + var_x112);
        const double var_x182 = 1.0 + var_x181;
        const double var_x183 = exp(0.057000000000000002 * var_chaste_interface__membrane__V);
        const double var_x184 = var_x183 / var_x182;
        const double var_x185 = exp(-0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x186 = 1.0 + var_x185;
        const double var_x187 = exp(2.5 + var_x122);
        const double var_x188 = 1.0 + var_x187;
        const double var_x189 = 1 / var_x188;
        const double var_x190 = exp(1.0 + var_x137);
        const double var_x191 = 1.0 + var_x190;
        const double var_x192 = 1 / var_x191;
        const double var_x193 = exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V);
        ...
        const double var_x197 = 1 / (1.0 * var_x189 + 1.3999999999999999 * var_x196);
        const double var_x198 = exp(2.5 + var_x112);
        const double var_x199 = 1.0 + var_x198;
        const double var_x200 = 1 / var_x199;
        const double var_x201 = 1 + 0.037037037037037035 * var_chaste_interface__membrane__V;
        const double var_x202 = exp(-3.0375000000000001 * pow(var_x201, 2.0));
        const double var_x203 = exp(2.8571428571428572 + var_x115);
        const double var_x204 = 1.0 + var_x203;
        const double var_x205 = 1 / (80.0 + 165.0 * var_x200 + 1125.0 * var_x202);
        const double var_x206 = var_chaste_interface__membrane__V > -60.0;
        const double var_x207 = exp(-5.0 + 10000.0 * var_chaste_interface__calcium_dynamics__Ca_i);
        const double var_x208 = 1.0 + var_x207;
        const double var_x209 = exp(-0.9375 + 1250.0 * var_chaste_interface__calcium_dynamics__Ca_i);
        const double var_x210 = 1.0 + var_x209;
        const double var_x211 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 8.0);
        const double var_x212 = (var_x206) && (var_chaste_interface__L_type_Ca_current_fCa_gate__fCa < 0.15753424657534248 + 0.068493150684931517 / var_x208 + 0.13698630136986303 / var_x210 + 0.68493150684931503 / (1.0 + 8.034023767017109e+27 * var_x211));
        const double var_x213 = exp(-4.0 + var_x137);
        const double var_x214 = 1.0 + var_x213;
        const double var_x215 = 1 / var_x214;
        const double var_x216 = 1 + 0.022222222222222223 * var_chaste_interface__membrane__V;
        const double var_x217 = exp(-6.328125 * pow(var_x216, 2.0));
        const double var_x218 = exp(4.0 + var_x137);
        const double var_x219 = 1.0 + var_x218;
        const double var_x220 = 1 / (3.0 + 5.0 * var_x215 + 85.0 * var_x217);
        const double var_x221 = exp(3.3333333333333335 + var_x130);
        ...
        const double var_x234 = (((var_x206) || (var_x230))) && (((var_x206) || (var_x231))) && (((var_x230) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 5.439910241481016e+20 * var_x232)))) && (((var_x231) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 1.9720198874049176e+55 * var_x233))));
        const double var_x235 = 0.0017343470110743602 * var_x29;
        const double var_x236 = 3.4364336248541711e-5 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x237 = 1.1221007754625865e-5 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x238 = 6.3176611368492499e-5 * var_x45;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00088199999999999997 + 0.032430000000000007 * var_x37 + 0.18928635694553861 * var_x56 - 1.1491875 * var_x42 - 0.245 * var_x0 - 8.6662202299424464e-5 * var_x10 - 0.54050000000000009 * var_x26 - 0.0146 * var_x3 - 0.0024414715719063545 * var_x32 - 0.18928635694553861 * var_x59 - 2.1086672225679694e-7 * var_x34 - var_x11 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x27 * var_chaste_interface__transient_outward_current_s_gate__s - var_x30 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x44 * var_x46 - var_x53 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 1, 0) = var_x94 * (-3.4598107243429746e-8 + 1.0129554625362473e-8 * var_x10 + 1.106241499547275e-5 * var_x56 + 2.4647261725375594e-11 * var_x34 - 1.106241499547275e-5 * var_x59 - var_x90 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x114 * var_x118 * var_x119 - 3.7037037037037037e-5 * var_x113 * var_x118 * var_x120 + 5.2910052910052905e-5 * var_x114 * var_x116 * var_x120 / pow(var_x117, 2);
        IJth(rJacobian, 3, 0) = var_x124 * var_x125 * var_x128 - var_x123 * var_x128 * var_x129 - 0.01240079365079365 * var_x124 * var_x126 * var_x129 / pow(var_x127, 2);
        IJth(rJacobian, 4, 0) = 6.4935064935064935e-5 * var_x133 * var_x136 / pow(var_x134, 2) + 4.5454545454545459e-5 * var_x125 * var_x132 * var_x135 - 7.5757575757575758e-5 * var_x129 * var_x131 * var_x135 / var_x132;
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x145 * var_x150 * pow(var_x146, (-3.0)) - 0.20000000000000001 * var_x144 * var_x147 * var_x148 + 99.999999999999986 * var_x147 * var_x149 * (0.00050000000000000001 * var_x141 / pow(var_x142, 2) + 0.020000000000000004 * var_x138 / pow(var_x139, 2)) / pow((var_x140 + var_x143), 2);
        IJth(rJacobian, 6, 0) = ((var_x163) ? (var_x154 * (108035.0 * var_x155 + 0.21330000000000002 * var_x156 - 0.008382352941176471 * var_x157) - var_x162 * (var_x158 + var_x159 + var_x160)) : (-var_x162 * var_x165 + 0.53361053361053368 * var_x154 * var_x164 / pow((1 + var_x164), 2)));
        IJth(rJacobian, 7, 0) = ((var_x163) ? (var_x166 * (var_x173 - 0.00025500480000000003 * var_x177 + var_x172 * var_x178 * (3.0508668000000001e-7 * var_x168 - 6214.6032000000005 * var_x167) + 0.0033402720000000005 * var_x174 * var_x176 / pow(var_x175, 2) - 0.311 * var_x169 * var_x170 * var_x178 / pow(var_x171, 2)) - var_x162 * (var_x179 + var_x180)) : (0.034200000000000001 * var_x166 * var_x184 - 0.16150740242261105 * var_x161 * var_x184 + 0.059999999999999998 * var_x166 * var_x181 * var_x183 / pow(var_x182, 2)));
        IJth(rJacobian, 8, 0) = 0.13333333333333333 * var_x185 * var_x197 / pow(var_x186, 2) + 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1.0 / var_x186) * (-0.050000000000000003 * var_x187 / pow(var_x188, 2) + 0.27999999999999997 * var_x190 * var_x195 / pow(var_x191, 2) - 0.15076923076923077 * var_x192 * var_x193 / pow(var_x194, 2)) / pow((var_x196 + 0.7142857142857143 * var_x189), 2);
        IJth(rJacobian, 9, 0) = 7.9012345679012348e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1.0 / var_x204) * (253.125 * var_x202 * pow(var_x201, 1.0) - 16.5 * var_x198 / pow(var_x199, 2)) / pow((0.071111111111111111 + var_x202 + 0.14666666666666667 * var_x200), 2) - 0.14285714285714285 * var_x203 * var_x205 / pow(var_x204, 2);
        IJth(rJacobian, 11, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / var_x219) * (1.0 * var_x213 / pow(var_x214, 2) + 23.90625 * var_x217 * pow(var_x216, 1.0)) / pow((0.035294117647058823 + var_x217 + 0.058823529411764705 * var_x215), 2) - 0.20000000000000001 * var_x218 * var_x220 / pow(var_x219, 2);
        ...
        IJth(rJacobian, 15, 0) = -3.389679425876563e-8 - 0.00040297005778184723 * var_x42 - 3.0388663876087418e-8 * var_x10 - 7.3941785176126781e-11 * var_x34 - var_x235 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 16, 0) = 0.00026864670518789814 * var_x42 + 3.79059668210955e-6 * var_x37 - 2.8636946873784758e-5 * var_x0 - 6.3176611368492499e-5 * var_x26 - 1.7065282626826835e-6 * var_x3 - 2.8537261917770629e-7 * var_x32 - var_x236 * var_chaste_interface__transient_outward_current_s_gate__s - var_x237 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x238 * var_x44;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.82499999999999996 * var_x63 + 594.50270777405183 * var_x64 - 2.5282752177944188 * var_x65 - 0.82499999999999996 * var_x61 - 0.0079072731552699126 * var_x62);
        IJth(rJacobian, 1, 1) = var_x94 * (-8.0000000000000007e-5 - var_x95 - var_x97 + 4.8215267695658011e-5 * var_x63 - 0.00014775935325364359 * var_x65 - 4.6212277808973237e-7 * var_x62 - 0.069488744729986562 * var_x64) + 0.00029999999999999997 * pow(var_x91, (-3.0)) * (var_x107 + var_x98 - var_x100 - var_x99 + 4.6212277808973237e-7 * log(2.0 * var_x62) - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - var_x54 * var_x90 - var_x95 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362473e-8 * var_x33 * var_x6) / pow(var_x92, 2);
        IJth(rJacobian, 10, 1) = ((var_x212) ? (0) : (-3.4101542475452148e-28 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 7.0) / pow((1.2447063003540035e-28 + var_x211), 2) - 85.616438356164394 * var_x209 / pow(var_x210, 2) - 342.46575342465758 * var_x207 / pow(var_x208, 2)));
        IJth(rJacobian, 13, 1) = var_x228 * (8.0000000000000007e-5 + var_x97);
        IJth(rJacobian, 14, 1) = ((var_x234) ? (0) : ((var_x231) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5.0) / pow((1.8382656249999998e-21 + var_x232), 2)) : (-4.0567542199219968e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15.0) / pow((5.070942774902496e-56 + var_x233), 2))));
        IJth(rJacobian, 15, 1) = 0.20846623418995969 * var_x64;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x31);
        IJth(rJacobian, 2, 2) = 0.00037037037037037035 * var_x120 * (-1.0 - var_x113);
        IJth(rJacobian, 16, 2) = -var_x237 * var_x31;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.096000000000000002 * var_x66);
        IJth(rJacobian, 3, 3) = 0.29761904761904762 * var_x129 * (-1.0 - var_x123);
        IJth(rJacobian, 16, 3) = -1.1221007754625865e-5 * var_x66;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.48999999999999999 * var_x68);
        IJth(rJacobian, 4, 4) = -0.00090909090909090909 * var_x136;
        ...
        IJth(rJacobian, 5, 5) = -1.0 * var_x150;
        IJth(rJacobian, 15, 5) = -0.0052030410332230808 * var_x72;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x30 * var_x70);
        IJth(rJacobian, 6, 6) = ((var_x163) ? (-var_x158 - var_x159 - var_x160) : (-var_x165));
        IJth(rJacobian, 15, 6) = -var_x235 * var_x70;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-14.837999999999999 * var_x73);
        IJth(rJacobian, 7, 7) = ((var_x163) ? (-var_x179 - var_x180) : (-0.59999999999999998 * var_x184));
        ...
        IJth(rJacobian, 9, 9) = -var_x205;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x74 * var_x75);
        IJth(rJacobian, 1, 10) = -var_x108 * var_x75;
        IJth(rJacobian, 10, 10) = ((var_x212) ? (0) : (-0.5));
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x27 * var_x31);
        IJth(rJacobian, 11, 11) = -var_x220;
        IJth(rJacobian, 16, 11) = -var_x236 * var_x31;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-0.29399999999999998 * var_x76);
        IJth(rJacobian, 12, 12) = -var_x225;
        IJth(rJacobian, 16, 12) = -3.4364336248541711e-5 * var_x76;
        ...
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.00071824218750000002 * var_x80 - 1.1491875 * var_x78 - 0.0077469905913117388 * var_x69 - 0.00051997321379654684 * var_x81 - 396.37878066856405 * var_x82 - 0.19634614084876303 * var_x79);
        IJth(rJacobian, 1, 15) = 6.0777327752174836e-8 * var_x81 * var_x93;
        IJth(rJacobian, 15, 15) = 2.5185628611365452e-7 * var_x80 - 0.00040297005778184723 * var_x78 - 9.0551084895961074e-7 * var_x69 - 1.8233198325652452e-7 * var_x81 - 0.046330930954698979 * var_x82;
        IJth(rJacobian, 16, 15) = 0.00026864670518789814 * var_x78 - 1.6790419074243634e-7 * var_x80 - 2.2950016344321169e-5 * var_x79;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (0.86632725819393008 * var_x89 - 2.5645210233307827 * var_x84 - 0.3900209056315565 * var_x83 - 6.5448713616254341 * var_x79 - 14.438787636565502 * var_x85 - 7.8538456339505212 * var_x86 - var_x46 * var_x88);
        IJth(rJacobian, 16, 16) = 0.00010126109252331096 * var_x89 - 4.5587787568311439e-5 * var_x83 - 0.00029975531551766426 * var_x84 - 0.00091800065377284682 * var_x86 - 0.00076500054481070561 * var_x79 - 0.0016876848753885161 * var_x85 - var_x238 * var_x88;
    }
