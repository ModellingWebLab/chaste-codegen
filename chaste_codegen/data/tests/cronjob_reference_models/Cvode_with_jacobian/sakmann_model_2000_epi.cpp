...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellsakmann_model_2000_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 14, 0) = -3.7909647610109532e-7 + 9.7391514846836631e-10 * var_x56 - 5.4350169681217345e-8 * var_x27 - 3.8225561340193784e-7 * var_x2 - 1.3634812078557129e-7 * var_x52 - 2.2723042777499654e-7 * var_x20 - var_x188 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x189 * var_x34;
        IJth(rJacobian, 15, 0) = 2.2618285932916757e-8 * var_x28 + 2.0272937282365629e-6 * var_x26 + 1.9478302969367326e-10 * var_x55 - 3.1591373008424612e-6 * var_x21 - 2.0335998632983093e-6 * var_x3 - 3.6104426295342415e-5 * var_x8 - 7.7913211877469303e-10 * var_x52 - var_x190 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr - var_x191 * var_x34;
        ...
        IJth(rJacobian, 1, 1) = -7.0000000000000009 + var_x88 + var_x89 + 0.00040000000000000002 * var_x93 - 7.2e-9 * var_x94 - 1.0549054718227806e-6 * var_x57 - 5.2262998388249204e-10 * var_x61 - 0.00040000000000000002 * var_x91 - 0.20784009793819685 * var_x58;
        ...
        IJth(rJacobian, 14, 1) = 1.5678899516474762e-9 * var_x61 + 0.62352029381459051 * var_x58;
        ...
        IJth(rJacobian, 14, 14) = 6.634188331769168e-7 * var_x78 - 1.0127092529498693e-5 * var_x76 - 1.3633825666499794e-6 * var_x80 - 2.6016936179035892e-8 * var_x83 - 0.0010614701330830668 * var_x77 - 6.1697460156676094 * var_x82;
        IJth(rJacobian, 15, 14) = 0.00070764675538871125 * var_x77 - 4.4227922211794452e-7 * var_x78 - 1.3363974606332242e-5 * var_x81;
