...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellsakmann_model_2000_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x2 = exp(-0.56150836234118207 + 0.056150836234118214 * var_chaste_interface__membrane__V - 1.5000000000000002 * var_x1);
        ...
        const double var_x8 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2.0);
        const double var_x9 = 0.041322314049586778 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        const double var_x19 = 21.504724822319993 * var_x18;
        ...
        const double var_x58 = var_x10 * var_x15;
        const double var_x59 = 2.0 * var_x13;
        const double var_x60 = 2744000.0 * var_x15;
        ...
        const double var_x63 = 1 / (0.029999999999999999 * var_chaste_interface__intracellular_sodium_concentration__Na_i + var_chaste_interface__intracellular_potassium_concentration__K_i);
        ...
        const double var_x65 = 1 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        ...
        const double var_x75 = var_x25 * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        const double var_x79 = var_x63 * var_x8;
        const double var_x80 = var_x12 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x81 = var_x10 * var_x80;
        const double var_x82 = var_x18 * var_x65 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x83 = var_x35 * var_x51;
        const double var_x84 = var_x0 * var_x4;
        const double var_x85 = var_x0 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x86 = var_x0 * var_x23 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr;
        ...
        const double var_x98 = var_x95 * var_x97 * (var_x96 - var_chaste_interface__calcium_release__ActFrac / pow(var_x95, 2)) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel / var_chaste_interface__calcium_release__ActFrac;
        const double var_x99 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x100 = exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x101 = 1.0 + var_x100;
        const double var_x102 = exp(-1.7465999999999999 - 0.123 * var_chaste_interface__membrane__V);
        const double var_x103 = 1.0 - var_x102;
        const double var_x104 = 1 / var_x103;
        const double var_x105 = 1.3799999999999999 * var_x104;
        const double var_x106 = exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__membrane__V);
        const double var_x107 = -1.0 + var_x106;
        const double var_x108 = 1 / var_x107;
        const double var_x109 = 0.60999999999999999 * var_x108;
        const double var_x110 = 38.899999999999999 + var_chaste_interface__membrane__V;
        const double var_x111 = 14.199999999999999 + var_chaste_interface__membrane__V;
        const double var_x112 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V);
        const double var_x113 = 1.0 + var_x112;
        const double var_x114 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V);
        const double var_x115 = -1.0 + var_x114;
        const double var_x116 = 1 / var_x115;
        const double var_x117 = 0.13100000000000001 * var_x116;
        const double var_x118 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V);
        const double var_x119 = 1.0 - var_x118;
        const double var_x120 = 1 / var_x119;
        const double var_x121 = 0.071899999999999992 * var_x120;
        const double var_x122 = 30.0 + var_chaste_interface__membrane__V;
        const double var_x123 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x124 = 0.44800000000000001 * var_x123 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x125 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x126 = fabs(var_x125) < 1.0000000000000001e-5;
        const double var_x127 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x128 = -0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x129 = exp(-4.1000000000000005 + var_x128);
        const double var_x130 = 1.0 - var_x129;
        const double var_x131 = 0.20000000000000001 / var_x130;
        const double var_x132 = -8.0 * var_x123;
        const double var_x133 = -0.125 * var_chaste_interface__membrane__V;
        const double var_x134 = exp(-9.3737545557863378 + var_x133);
        const double var_x135 = exp(-7.4990036446290711 + var_x128);
        const double var_x136 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x137 = fabs(var_x136) < 0.0001;
        const double var_x138 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x139 = exp(-2.6388888888888888 - 0.1388888888888889 * var_chaste_interface__membrane__V);
        const double var_x140 = 1.0 - var_x139;
        const double var_x141 = 0.089999999999999997 / var_x140;
        const double var_x142 = exp(1.0555555555555556 + 0.055555555555555552 * var_chaste_interface__membrane__V);
        const double var_x143 = -1.0 + var_x142;
        const double var_x144 = 0.036000000000000004 / var_x143;
        const double var_x145 = 0.19607843137254904 * var_chaste_interface__membrane__V;
        const double var_x146 = exp(-6.666666666666667 - var_x145);
        const double var_x147 = 1.0 + var_x146;
        const double var_x148 = -0.00070588235294117652 * var_x146 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x147, 2);
        const double var_x149 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x150 = fabs(var_x149) < 0.0001;
        const double var_x151 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x152 = exp(6.666666666666667 + var_x145);
        const double var_x153 = -1.0 + var_x152;
        const double var_x154 = 0.0018749999999999999 / var_x153;
        const double var_x155 = -0.0035999999999999999 / var_x147;
        const double var_x156 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x157 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x158 = exp(-1.25 + var_x133);
        const double var_x159 = 1.0 + var_x158;
        const double var_x160 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x161 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x162 = 0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x165 = 0.01 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x166 = 1 / var_x165;
        const double var_x167 = 1.0 - var_x164;
        const double var_x168 = var_x166 * var_x167;
        const double var_x169 = var_x164 + var_x168 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x170 = pow(var_x169, 1.0);
        const double var_x171 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x162, 2);
        const double var_x172 = var_x170 * (var_x163 - var_x171 + var_x166 * (var_x171 - var_x163) * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x173 = var_x161 * var_x172;
        const double var_x174 = var_x172 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x175 = 5.0 * var_x174;
        const double var_x176 = var_chaste_interface__membrane__V < -50.0;
        const double var_x177 = 1.0 * var_x174;
        const double var_x178 = pow(var_x169, 2.0);
        const double var_x179 = var_x170 * (var_x168 - var_x167 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x165, 2));
        const double var_x180 = var_x161 * var_x179;
        const double var_x181 = var_x179 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x182 = 5.0 * var_x181;
        const double var_x183 = 1.0 * var_x181;
        const double var_x184 = 0.0016440603555991614 * var_x18;
        const double var_x185 = 2.6016936179035892e-8 * var_x45;
        const double var_x186 = 5.0664960489733537e-7 * var_x23;
        const double var_x187 = 3.1591373008424612e-6 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x188 = 5.2033872358071777e-9 * var_x36;
        const double var_x189 = 5.2033872358071788e-5 * var_x43;
        const double var_x190 = -var_x99;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0070247933884297516 + 0.010191244960939837 * var_x53 + 2.5478112402349594e-6 * var_x55 + 1.2739056201174797e-5 * var_x56 + 0.00029585289450195546 * var_x28 + 0.026517514160150277 * var_x26 - 0.0009907438016528926 * var_x17 - 0.47225501770956313 * var_x4 - 0.0050000000000000001 * var_x7 - 0.026600000000000002 * var_x8 - 0.020382489921879673 * var_x50 - 0.00071091395097537394 * var_x27 - 0.0017936591131254113 * var_x52 - var_x19 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x24 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr - var_x33 * var_x44 - var_x34 * var_x37 - var_x34 * var_x46 - var_x9 * var_chaste_interface__transient_outward_current_s_gate__s - 9.9173553719008269e-7 * var_x20 * (var_x14 + var_x16 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds));
        IJth(rJacobian, 1, 0) = -7.8978432521061529e-8 + 7.5743475924998857e-8 * var_x17;
        IJth(rJacobian, 2, 0) = 0.001 * (-var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr + 1.0 / var_x101) * (var_x105 + var_x109 - 0.088449999999999987 * var_x106 * var_x110 / pow(var_x107, 2) - 0.16973999999999997 * var_x102 * var_x111 / pow(var_x103, 2)) + 0.00013333333333333334 * var_x100 * (var_x105 * var_x111 + var_x109 * var_x110) / pow(var_x101, 2);
        IJth(rJacobian, 3, 0) = 0.001 * (-var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs + 1.0 / var_x113) * (var_x117 + var_x121 - 0.0089996999999999994 * var_x114 * var_x122 / pow(var_x115, 2) - 0.010641199999999998 * var_x118 * var_x122 / pow(var_x119, 2)) + 5.9880239520958083e-5 * var_x112 * (var_x117 * var_x122 + var_x121 * var_x122) / pow(var_x113, 2);
        IJth(rJacobian, 4, 0) = ((var_x126) ? (var_x124) : (var_x124 + var_x127 * var_x131 - 0.020000000000000004 * var_x125 * var_x127 * var_x129 / pow(var_x130, 2)));
        IJth(rJacobian, 5, 0) = -0.0025000000000000001 * var_x134 * (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x135 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x135), 2);
        IJth(rJacobian, 6, 0) = ((var_x137) ? (0) : (var_x138 * var_x141 - var_x144 * var_chaste_interface__L_type_Ca_channel_d_gate__d + 0.002 * var_x136 * var_x142 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x143, 2) - 0.012500000000000001 * var_x136 * var_x138 * var_x139 / pow(var_x140, 2)));
        IJth(rJacobian, 7, 0) = ((var_x150) ? (var_x148) : (var_x148 + var_x151 * var_x154 - 0.00036764705882352946 * var_x149 * var_x151 * var_x152 / pow(var_x153, 2)));
        IJth(rJacobian, 10, 0) = -1.9411764705882353e-6 * var_x157 * (1.0 - var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x158 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x159, 2);
        IJth(rJacobian, 11, 0) = 0.066600000000000006 * var_x160 / pow((1.0 + var_x160), 2);
        IJth(rJacobian, 14, 0) = -3.7909647610109532e-7 + 9.7391514846836631e-10 * var_x56 - 3.8225561340193784e-7 * var_x7 - 2.2723042777499657e-7 * var_x17 - 1.3634812078557129e-7 * var_x52 - 5.4350169681217345e-8 * var_x27 - var_x184 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x185 * var_x34;
        IJth(rJacobian, 15, 0) = 2.0272937282365633e-6 * var_x26 + 2.2618285932916757e-8 * var_x28 + 1.9478302969367326e-10 * var_x55 - 3.6104426295342415e-5 * var_x4 - 2.0335998632983093e-6 * var_x8 - 7.7913211877469303e-10 * var_x52 - var_x186 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr - var_x187 * var_chaste_interface__transient_outward_current_s_gate__s - var_x188 * var_x34;
        IJth(rJacobian, 16, 0) = 3.8956605938734658e-6 * var_x53 - 7.7913211877469316e-6 * var_x50 - var_x189 * var_x33;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (2718.6009917355373 * var_x58 + 6.836132231404959e-6 * var_x61 - 0.13612323935543807 * var_x62 - 0.027596860185636004 * var_x57);
        IJth(rJacobian, 1, 1) = -7.0 + var_x88 + var_x89 + 0.00040000000000000002 * var_x93 - 1.0549054718227806e-6 * var_x57 - 0.00040000000000000002 * var_x91 - 7.1999999999999991e-9 * var_x94 - 5.2262998388249214e-10 * var_x61 - 0.20784009793819685 * var_x58;
        ...
        IJth(rJacobian, 12, 1) = ((var_x176) ? (-var_x175 + 5.0 * var_x173) : (-var_x177 + 1.0 * var_x173));
        IJth(rJacobian, 13, 1) = ((var_x176) ? (var_x175) : (var_x177));
        IJth(rJacobian, 14, 1) = 1.5678899516474762e-9 * var_x61 + 0.62352029381459062 * var_x58;
        ...
        IJth(rJacobian, 2, 2) = -0.00060999999999999997 * var_x108 * var_x110 - 0.0013799999999999999 * var_x104 * var_x111;
        IJth(rJacobian, 15, 2) = -var_x186 * var_x25;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.053200000000000004 * var_x64);
        IJth(rJacobian, 3, 3) = -0.00013100000000000001 * var_x116 * var_x122 - 7.1899999999999999e-5 * var_x120 * var_x122;
        IJth(rJacobian, 15, 3) = -4.0671997265966185e-6 * var_x64;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-64.514174466959986 * var_x67);
        IJth(rJacobian, 4, 4) = ((var_x126) ? (-2.0 + var_x132) : (var_x132 - var_x125 * var_x131));
        IJth(rJacobian, 14, 4) = -0.0049321810667974841 * var_x67;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x19 * var_x66);
        IJth(rJacobian, 5, 5) = -2.0 / (1.0 + 320.0 * var_x135) - 0.02 * var_x134;
        IJth(rJacobian, 14, 5) = -var_x184 * var_x66;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x37 * var_x69 - var_x44 * var_x68 - var_x46 * var_x69);
        IJth(rJacobian, 6, 6) = ((var_x137) ? (-0.71999999999999997) : (-var_x136 * var_x141 - var_x136 * var_x144));
        IJth(rJacobian, 14, 6) = -var_x185 * var_x69;
        IJth(rJacobian, 15, 6) = -var_x188 * var_x69;
        IJth(rJacobian, 16, 6) = -var_x189 * var_x68;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x37 * var_x72 - var_x44 * var_x71 - var_x46 * var_x72);
        IJth(rJacobian, 7, 7) = ((var_x150) ? (-0.0074999999999999997 + var_x155) : (var_x155 - var_x149 * var_x154));
        IJth(rJacobian, 14, 7) = -var_x185 * var_x72;
        IJth(rJacobian, 15, 7) = -var_x188 * var_x72;
        IJth(rJacobian, 16, 7) = -var_x189 * var_x71;
        ...
        IJth(rJacobian, 14, 9) = -var_x185 * var_x74;
        IJth(rJacobian, 15, 9) = -var_x188 * var_x74;
        IJth(rJacobian, 16, 9) = -var_x189 * var_x73;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x25 * var_x9);
        IJth(rJacobian, 10, 10) = -0.033000000000000002 / var_x159 - 3.3000000000000003e-5 * var_x157;
        IJth(rJacobian, 15, 10) = -var_x187 * var_x25;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-0.041322314049586778 * var_x75);
        IJth(rJacobian, 11, 11) = -0.33300000000000002;
        IJth(rJacobian, 15, 11) = -3.1591373008424612e-6 * var_x75;
        IJth(rJacobian, 1, 12) = 0.10204081632653063 * var_x98;
        IJth(rJacobian, 12, 12) = ((var_x176) ? (-0.29999999999999999 - 5.0 * var_x178) : (-0.059999999999999998 - 1.0 * var_x178));
        IJth(rJacobian, 13, 12) = ((var_x176) ? (0.29999999999999999 + 2.5 * var_x178) : (0.059999999999999998 + 0.5 * var_x178));
        IJth(rJacobian, 18, 12) = -0.5 * var_x98;
        IJth(rJacobian, 12, 13) = ((var_x176) ? (-2.5 * var_x178) : (-0.5 * var_x178));
        IJth(rJacobian, 13, 13) = ((var_x176) ? (-0.0050000000000000001) : (-0.001));
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (0.0028925619834710742 * var_x78 - 0.13246492889105282 * var_x76 - 4.6280991735537187 * var_x77 - 0.00034030809838859517 * var_x83 - 0.0059444628099173556 * var_x81 - 574.47207195607234 * var_x82 - 0.021317581006437131 * var_x79 - 5.9504132231404965e-6 * var_x20 * var_x80);
        IJth(rJacobian, 1, 14) = 4.5446085554999314e-7 * var_x81;
        IJth(rJacobian, 14, 14) = 6.634188331769168e-7 * var_x78 - 2.6016936179035892e-8 * var_x83 - 0.0010614701330830668 * var_x77 - 1.0127092529498693e-5 * var_x76 - 1.3633825666499794e-6 * var_x81 - 0.043919034849570118 * var_x82;
        IJth(rJacobian, 15, 14) = 0.00070764675538871125 * var_x77 - 1.6297530007722247e-6 * var_x79 - 4.4227922211794452e-7 * var_x78;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.70838252656434475 * var_x87 - 6.8061619677719034e-5 * var_x83 - 0.71058603354790439 * var_x79 - 12.6157075134336 * var_x84 - 68.936648634728684 * var_x82 - 1.1038744074254401 * var_x85 - 0.17703489247815671 * var_x86);
        IJth(rJacobian, 14, 15) = -0.0052702841819484139 * var_x82;
        IJth(rJacobian, 15, 15) = 5.415663944301363e-5 * var_x87 - 5.2033872358071777e-9 * var_x83 - 8.4392437745822447e-5 * var_x85 - 1.3534516283556782e-5 * var_x86 - 5.4325100025740829e-5 * var_x79 - 0.00096448500280939947 * var_x84;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (2.721322314049587 * var_x15 * var_x20 + 6.8429752066115703e-9 * (var_x59 - var_x60 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2));
        IJth(rJacobian, 1, 16) = 0.001;
        IJth(rJacobian, 9, 16) = -0.02 / var_x156 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x156, 2);
        IJth(rJacobian, 12, 16) = ((var_x176) ? (-var_x182 + 5.0 * var_x180) : (-var_x183 + 1.0 * var_x180));
        IJth(rJacobian, 13, 16) = ((var_x176) ? (var_x182) : (var_x183));
        IJth(rJacobian, 16, 16) = -0.01;
        IJth(rJacobian, 1, 17) = 7.1999999999999991e-9 * var_x91 + 9.5999999999999999e-8 * var_x93 - 1.7279999999999997e-12 * var_x94;
        ...
        IJth(rJacobian, 1, 18) = 1.0204081632653063e-5 + 0.051020408163265314 * var_x97;
        IJth(rJacobian, 17, 18) = 0.050000000000000003;
        IJth(rJacobian, 18, 18) = -0.0050499999999999998 - 0.25 * var_x97;
        IJth(rJacobian, 1, 19) = 0.050000000000000003 + var_x99;
        IJth(rJacobian, 19, 19) = -0.050000000000000003 + var_x190;
        IJth(rJacobian, 1, 20) = 0.20000000000000001 + var_x99;
        IJth(rJacobian, 20, 20) = -0.20000000000000001 + var_x190;
    }
