...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellearm_noble_model_1990FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x78 = var_x6 * (0.00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * var_chaste_interface__fast_sodium_current_h_gate__h / pow(var_x64, 2);
        ...
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (0.24285714285714283 * var_x82 - 1.135334828037065 * var_x1 - 5629.1236462110664 * var_x78 - 9.3584727056863666e-5 * var_x79 - 3.2438137943916145 * var_x80 - 6.678440164923912 * var_x81);
