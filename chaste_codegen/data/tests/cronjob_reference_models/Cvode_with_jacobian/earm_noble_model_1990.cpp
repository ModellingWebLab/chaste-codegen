...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellearm_noble_model_1990FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x11 = 0.018716945411372733 * var_chaste_interface__membrane__V;
        ...
        const double var_x17 = 1 / (1.0 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Ca_i + 0.00020000000000000001 * var_x10);
        const double var_x18 = var_x16 * var_x17;
        const double var_x19 = var_x18 * (0.037433890822745466 * var_x13 + 51359.29820880678 * var_x15);
        ...
        const double var_x40 = -2.0 * var_x36 + var_x39 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x41 = var_x38 * var_x40;
        const double var_x42 = 0.18716945411372732 * var_x41;
        ...
        const double var_x51 = var_x36 * var_x40 * var_x44 / pow(var_x37, 2);
        const double var_x52 = var_x32 * var_x49;
        ...
        const double var_x55 = var_x16 * var_x54 / pow((0.0036443148688046641 + 7.2886297376093286e-7 * var_x10 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x56 = var_x17 * var_x54 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        ...
        const double var_x63 = var_x39 * var_x45;
        const double var_x64 = 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x65 = -26.713760659695652 * log(140.47999999999999 / var_x64) + var_chaste_interface__membrane__V;
        const double var_x66 = var_x65 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x67 = 6.678440164923912 * var_x2 - 0.24999999999999997 * var_chaste_interface__membrane__V;
        ...
        const double var_x77 = var_x12 * var_x18 * var_x75;
        const double var_x78 = var_x6 * (0.0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.00085421412300683373 * var_chaste_interface__intracellular_potassium_concentration__K_i) * var_chaste_interface__fast_sodium_current_h_gate__h / pow(var_x64, 2);
        const double var_x79 = var_x31 * var_x47;
        const double var_x80 = var_x1 * var_x5;
        const double var_x81 = var_x1 * var_x8;
        const double var_x82 = var_x1 * var_x9;
        const double var_x83 = 3.1504144536796183e-6 * var_x41;
        ...
        const double var_x91 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
        const double var_x92 = 1 / var_x91;
        const double var_x93 = pow((var_x92 * var_chaste_interface__calcium_release__ActFrac), 2.0);
        const double var_x94 = 0.051020408163265314 * var_x93;
        const double var_x95 = var_x91 * (2.0 * var_x92 - 2.0 * var_chaste_interface__calcium_release__ActFrac / pow(var_x91, 2)) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel / var_chaste_interface__calcium_release__ActFrac;
        ...
        const double var_x103 = exp(-4.1000000000000005 + var_x102);
        const double var_x104 = 1.0 - var_x103;
        const double var_x105 = 0.20000000000000001 / var_x104;
        const double var_x106 = -8.0 * var_x97;
        const double var_x107 = -0.125 * var_chaste_interface__membrane__V;
        const double var_x108 = exp(-9.375 + var_x107);
        const double var_x109 = exp(-7.5 + var_x102);
        const double var_x110 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x111 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x112 = exp(-1.25 + var_x107);
        ...
        const double var_x116 = 1.0 - var_chaste_interface__L_type_calcium_current_d_gate__d;
        const double var_x117 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x118 = -var_x117;
        const double var_x119 = exp(-4.75 + var_x118);
        const double var_x120 = 1.0 - var_x119;
        const double var_x121 = 0.029999999999999999 / var_x120;
        const double var_x122 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x123 = -1.0 + var_x122;
        const double var_x124 = 0.012 / var_x123;
        const double var_x125 = exp(-8.5 + var_x118);
        const double var_x126 = 1.0 + var_x125;
        const double var_x127 = 120.0 * var_x23;
        const double var_x128 = 0.0030000000000000001 * var_x125 * (var_x28 + var_x127 * var_x26) / pow(var_x126, 2);
        const double var_x129 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x130 = fabs(var_x129) < 0.0001;
        const double var_x131 = exp(8.5 + var_x117);
        const double var_x132 = -1.0 + var_x131;
        const double var_x133 = 0.0062500000000000003 / var_x132;
        const double var_x134 = 0.012 / var_x126;
        const double var_x135 = var_x134 * (-1.0 - 119.0 * var_x26);
        ...
        const double var_x140 = pow((var_x139 * var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2.0);
        const double var_x141 = 0.5 * var_x140;
        const double var_x142 = var_x138 * var_x141 * var_x53 * (2.0 * var_x139 - 2.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x138, 2));
        const double var_x143 = var_x142 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x144 = -0.59999999999999998 * var_x137;
        const double var_x145 = 0.00042079708847221582 * var_x6;
        const double var_x146 = 1.5752072268398093e-8 * var_x34;
        const double var_x147 = 3.1504144536796185e-9 * var_x32;
        const double var_x148 = 0.00022482145415487099 * var_x2 - 8.4159417694443166e-6 * var_chaste_interface__membrane__V;
        const double var_x149 = 0.25 * var_x93;
        const double var_x150 = -var_x96;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.046749999999999993 + 0.0090910877712381839 * var_x9 + 1.7516202276615338e-5 * var_x50 + 0.014012961821292271 * var_x51 + 3.5032404553230678e-6 * var_x52 - 0.0024999999999999996 * var_x19 - 0.12142857142857143 * var_x5 - 0.028025923642584542 * var_x46 - 0.0024662812805474397 * var_x48 - 0.24999999999999997 * var_x8 - var_x29 * var_x42 - var_x30 * var_x33 - var_x30 * var_x35 - var_x7 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 1, 0) = -2.103985442361079e-8 + 2.3586454141088428e-7 * var_x51 + 8.4159417694443161e-8 * var_x19 - 4.7172908282176856e-7 * var_x46 - var_x29 * var_x83;
        IJth(rJacobian, 2, 0) = ((var_x100) ? (var_x98) : (var_x98 + var_x101 * var_x105 - 0.02 * var_x101 * var_x103 * var_x99 / pow(var_x104, 2)));
        IJth(rJacobian, 3, 0) = -0.125 * var_x108 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x109 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x109), 2);
        IJth(rJacobian, 4, 0) = 0.066600000000000006 * var_x110 / pow((1.0 + var_x110), 2);
        IJth(rJacobian, 5, 0) = -0.058823529411764705 * var_x111 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x112 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x113, 2);
        IJth(rJacobian, 6, 0) = ((var_x115) ? (0) : (var_x116 * var_x121 - var_x124 * var_chaste_interface__L_type_calcium_current_d_gate__d + 0.0012000000000000001 * var_x114 * var_x122 * var_chaste_interface__L_type_calcium_current_d_gate__d / pow(var_x123, 2) - 0.0074999999999999997 * var_x114 * var_x116 * var_x119 / pow(var_x120, 2)));
        IJth(rJacobian, 7, 0) = ((var_x130) ? (var_x128) : (var_x128 - var_x133 * var_chaste_interface__L_type_calcium_current_f_Ca_gate__f_Ca + 0.0015625000000000001 * var_x129 * var_x131 * var_chaste_interface__L_type_calcium_current_f_Ca_gate__f_Ca / pow(var_x132, 2)));
        IJth(rJacobian, 8, 0) = 0.048000000000000001 * var_x136 * var_x137;
        IJth(rJacobian, 10, 0) = -1.009913012333318e-7 + 5.8966135352721076e-10 * var_x50 - 2.5247825308332952e-7 * var_x19 - 8.2552589493809504e-8 * var_x48 - var_x145 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x146 * var_x30;
        IJth(rJacobian, 11, 0) = -1.4307101008055338e-6 + 1.1793227070544215e-10 * var_x52 + 3.0604026121459151e-7 * var_x9 - 4.0877431451586679e-6 * var_x5 - 8.4159417694443166e-6 * var_x8 - 4.7172908282176859e-10 * var_x48 - var_x147 * var_x30;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (9.11078717201166e-6 * var_x55 + 1.7249999999999999e-5 * var_x56 + 6859.9999999999991 * var_x57 - 0.016696100412309782 * var_x53 - 0.18716945411372732 * var_x63 - var_x33 * var_x62 - var_x35 * var_x62 - var_x42 * var_x61);
        IJth(rJacobian, 1, 1) = -17.0 + var_x84 + var_x85 + 0.0030000000000000001 * var_x89 - 0.0030000000000000001 * var_x87 - 5.5199999999999998e-8 * var_x90 - 3.1504144536796183e-6 * var_x63 - 2.8102681769358876e-7 * var_x53 - 5.8069998209165789e-10 * var_x56 - 3.0670341725380159e-10 * var_x55 - 0.23093344215355205 * var_x57 - var_x61 * var_x83;
        IJth(rJacobian, 7, 1) = var_x134 * (var_x59 + var_x127 * var_x25 - var_x127 * var_x58);
        IJth(rJacobian, 8, 1) = -var_x143 + var_x136 * var_x142;
        IJth(rJacobian, 9, 1) = var_x143;
        IJth(rJacobian, 10, 1) = 9.2011025176140472e-10 * var_x55 + 0.69280032646065615 * var_x57 + 1.7420999462749735e-9 * var_x56 - var_x146 * var_x62;
        IJth(rJacobian, 11, 1) = -var_x147 * var_x62;
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-37.499999999999993 * var_x66);
        IJth(rJacobian, 2, 2) = ((var_x100) ? (-2.0 + var_x106) : (var_x106 - var_x105 * var_x99));
        IJth(rJacobian, 10, 2) = -0.0012623912654166475 * var_x66;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * var_x7);
        IJth(rJacobian, 3, 3) = -0.02 * var_x108 - 2.0 / (1.0 + 320.0 * var_x109);
        IJth(rJacobian, 10, 3) = -var_x145 * var_x65;
        ...
        IJth(rJacobian, 11, 4) = var_x148 * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x67 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 5, 5) = -0.033000000000000002 / var_x113 - 3.3000000000000003e-5 * var_x111;
        IJth(rJacobian, 11, 5) = var_x148 * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x33 * var_x69 - var_x35 * var_x69 - var_x42 * var_x68);
        IJth(rJacobian, 1, 6) = -var_x68 * var_x83;
        IJth(rJacobian, 6, 6) = ((var_x115) ? (-0.23999999999999999) : (-var_x114 * var_x121 - var_x114 * var_x124));
        IJth(rJacobian, 10, 6) = -var_x146 * var_x69;
        IJth(rJacobian, 11, 6) = -var_x147 * var_x69;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x33 * var_x71 + var_x35 * var_x71 + var_x42 * var_x70);
        IJth(rJacobian, 1, 7) = var_x70 * var_x83;
        IJth(rJacobian, 7, 7) = ((var_x130) ? (-0.025000000000000001 + var_x135) : (var_x135 - var_x129 * var_x133));
        IJth(rJacobian, 10, 7) = var_x146 * var_x71;
        IJth(rJacobian, 11, 7) = var_x147 * var_x71;
        IJth(rJacobian, 1, 8) = var_x94 * var_x95;
        IJth(rJacobian, 8, 8) = -0.059999999999999998 + var_x144 - 1.0 * var_x140;
        IJth(rJacobian, 9, 8) = 0.059999999999999998 + var_x141;
        IJth(rJacobian, 13, 8) = -var_x149 * var_x95;
        IJth(rJacobian, 8, 9) = var_x144 - var_x141;
        IJth(rJacobian, 9, 9) = -0.00059999999999999995;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (0.00175 * var_x74 + 1.9921546294486135e-11 * var_x76 - 0.080141281979086945 * var_x72 - 0.014999999999999999 * var_x77 - 0.00046792363528431829 * var_x79 - 2.8000000000000003 * var_x73 - 46909.363718425557 * var_x78);
        IJth(rJacobian, 1, 10) = 5.0495650616665905e-7 * var_x77 - 6.7063429428673813e-16 * var_x76;
        IJth(rJacobian, 10, 10) = 1.7673477715833067e-7 * var_x74 + 2.0119028828602145e-15 * var_x76 - 2.697857449858452e-6 * var_x72 - 1.5791458939838139 * var_x78 - 1.5148695184999769e-6 * var_x77 - 1.5752072268398093e-8 * var_x79 - 0.00028277564345332906 * var_x73;
        IJth(rJacobian, 11, 10) = 0.00018851709563555272 * var_x73 - 1.1782318477222044e-7 * var_x74;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (0.24285714285714283 * var_x82 - 1.135334828037065 * var_x1 - 9.3584727056863666e-5 * var_x79 - 3.2438137943916145 * var_x80 - 5629.1236462110664 * var_x78 - 6.678440164923912 * var_x81);
        IJth(rJacobian, 10, 11) = -0.18949750727805764 * var_x78;
        IJth(rJacobian, 11, 11) = 8.1754862903173357e-6 * var_x82 - 0.00010919899201808021 * var_x80 - 0.00022482145415487099 * var_x81 - 3.8219647206328069e-5 * var_x1 - 3.1504144536796185e-9 * var_x79;
        IJth(rJacobian, 1, 12) = 7.1999999999999999e-7 * var_x89 + 5.5199999999999998e-8 * var_x87 - 1.3247999999999998e-11 * var_x90;
        IJth(rJacobian, 12, 12) = -0.050000000000000003 + 6.4915199999999989e-10 * var_x90 - 2.7047999999999999e-6 * var_x87 - 3.5279999999999994e-5 * var_x89;
        IJth(rJacobian, 13, 12) = 0.0050000000000000001;
        IJth(rJacobian, 1, 13) = var_x94;
        IJth(rJacobian, 12, 13) = 0.050000000000000003;
        IJth(rJacobian, 13, 13) = -0.0050000000000000001 - var_x149;
        IJth(rJacobian, 1, 14) = 0.050000000000000003 + var_x96;
        IJth(rJacobian, 14, 14) = -0.050000000000000003 + var_x150;
        IJth(rJacobian, 1, 15) = 0.20000000000000001 + var_x96;
        IJth(rJacobian, 15, 15) = -0.20000000000000001 + var_x150;
    }
