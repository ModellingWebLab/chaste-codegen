...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellearm_noble_model_1990FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x0 = 0.074867781645490933 * var_chaste_interface__membrane__V;
        const double var_x1 = 1 / var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x2 = log(4.0 * var_x1);
        const double var_x3 = exp(-0.74867781645490927 + var_x0 - 1.9999999999999998 * var_x2);
        ...
        const double var_x7 = 12.499999999999998 * var_x6;
        const double var_x8 = 0.24999999999999997 * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x9 = -26.713760659695652 * var_x2 + var_chaste_interface__membrane__V;
        const double var_x10 = var_x3 * var_x9 / pow(var_x4, 2);
        const double var_x11 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        const double var_x12 = 0.018716945411372733 * var_chaste_interface__membrane__V;
        const double var_x13 = exp(var_x12);
        const double var_x14 = var_x11 * var_x13;
        const double var_x15 = exp(-var_x12);
        ...
        const double var_x18 = 1 / (1.0 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Ca_i + 0.00020000000000000001 * var_x11);
        const double var_x19 = var_x17 * var_x18;
        const double var_x20 = var_x19 * (0.037433890822745466 * var_x14 + 51359.29820880678 * var_x16);
        const double var_x21 = 1.0 - var_chaste_interface__L_type_calcium_current_f_Ca_gate__f_Ca;
        const double var_x22 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x23 = 1 / var_x22;
        const double var_x24 = var_x23 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x25 = 1.0 - var_x24;
        const double var_x26 = var_x21 * var_x25;
        const double var_x27 = var_x26 * var_chaste_interface__L_type_calcium_current_d_gate__d;
        const double var_x28 = exp(3.7433890822745468 - var_x0);
        const double var_x29 = 1.0 - var_x28;
        const double var_x30 = 1 / var_x29;
        const double var_x31 = exp(3.7433890822745468);
        ...
        const double var_x34 = 0.18716945411372732 * var_x33;
        const double var_x35 = exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V);
        const double var_x36 = 1.0 - var_x35;
        const double var_x37 = 1 / var_x36;
        const double var_x38 = var_x27 * var_x37;
        const double var_x39 = exp(1.8716945411372734);
        const double var_x40 = -140.0 * var_x35 + var_x39 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x41 = 0.00046792363528431829 * var_x40;
        const double var_x42 = -4.0 * var_x35 + var_x39 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x43 = 9.3584727056863666e-5 * var_x42;
        ...
        const double var_x50 = var_x35 * var_x45 / pow(var_x36, 2);
        const double var_x51 = var_x40 * var_x50;
        const double var_x52 = var_x28 * var_x32 * var_x45 / pow(var_x29, 2);
        ...
        const double var_x55 = 2.0 * var_x14 - 2744000.0 * var_x16;
        const double var_x56 = var_x17 * var_x55 / pow((0.0036443148688046641 + 7.2886297376093286e-7 * var_x11 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x57 = var_x18 * var_x55 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x58 = var_x15 * var_x19;
        const double var_x59 = var_x31 * var_x46;
        const double var_x60 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x22, 2);
        const double var_x61 = var_x21 * (var_x60 - var_x23);
        const double var_x62 = var_x44 * var_chaste_interface__L_type_calcium_current_d_gate__d;
        const double var_x63 = var_x61 * var_x62;
        const double var_x64 = var_x37 * var_x63;
        ...
        const double var_x68 = var_x9 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x69 = var_x26 * var_x44;
        const double var_x70 = var_x37 * var_x69;
        const double var_x71 = var_x25 * var_x62;
        const double var_x72 = var_x37 * var_x71;
        const double var_x73 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x74 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x75 = var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x76 = var_x6 * var_x65 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x77 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x78 = var_x56 * var_x77;
        const double var_x79 = var_x13 * var_x19 * var_x77;
        const double var_x80 = var_x39 * var_x48;
        const double var_x81 = var_x1 * var_x5;
        const double var_x82 = var_x1 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x83 = var_x1 * var_x10;
        const double var_x84 = 3.1504144536796183e-6 * var_x33;
        const double var_x85 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod;
        const double var_x86 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Trop;
        const double var_x87 = 0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_up + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x88 = 1 / var_x87;
        const double var_x89 = pow(var_x87, (-2));
        const double var_x90 = var_x89 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x91 = var_x89 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
        const double var_x92 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
        const double var_x93 = 1 / var_x92;
        const double var_x94 = pow((var_x93 * var_chaste_interface__calcium_release__ActFrac), 2.0);
        const double var_x95 = var_x92 * var_x94 * (var_x93 - var_chaste_interface__calcium_release__ActFrac / pow(var_x92, 2)) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel / var_chaste_interface__calcium_release__ActFrac;
        const double var_x96 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x97 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x98 = 0.44800000000000001 * var_x97 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x99 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x100 = fabs(var_x99) < 1.0000000000000001e-5;
        const double var_x101 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x102 = 0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x103 = -var_x102;
        const double var_x104 = exp(-4.1000000000000005 + var_x103);
        const double var_x105 = 1.0 - var_x104;
        const double var_x106 = 0.20000000000000001 / var_x105;
        const double var_x107 = -8.0 * var_x97;
        const double var_x108 = -0.125 * var_chaste_interface__membrane__V;
        const double var_x109 = exp(-9.375 + var_x108);
        const double var_x110 = 20.0 * var_x109;
        const double var_x111 = exp(-7.5 + var_x103);
        const double var_x112 = 1 / (1.0 + 320.0 * var_x111);
        const double var_x113 = var_x110 + 2000.0 * var_x112;
        const double var_x114 = 1 / var_x113;
        const double var_x115 = 2.5 * var_x109;
        const double var_x116 = 0.625 * var_x111 / pow((0.0031250000000000002 + var_x111), 2);
        const double var_x117 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x118 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x119 = exp(-1.25 + var_x108);
        ...
        const double var_x123 = 1.0 - var_chaste_interface__L_type_calcium_current_d_gate__d;
        const double var_x124 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x125 = -var_x124;
        const double var_x126 = exp(-4.75 + var_x125);
        const double var_x127 = 1.0 - var_x126;
        const double var_x128 = 0.029999999999999999 / var_x127;
        const double var_x129 = exp(1.8999999999999999 + var_x102);
        const double var_x130 = -1.0 + var_x129;
        const double var_x131 = 0.012 / var_x130;
        const double var_x132 = exp(-8.5 + var_x125);
        const double var_x133 = 1.0 + var_x132;
        const double var_x134 = 120.0 * var_x21;
        const double var_x135 = 0.0030000000000000001 * var_x132 * (var_x26 + var_x134 * var_x24) / pow(var_x133, 2);
        const double var_x136 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x137 = fabs(var_x136) < 0.0001;
        const double var_x138 = exp(8.5 + var_x124);
        const double var_x139 = -1.0 + var_x138;
        const double var_x140 = 0.0062500000000000003 / var_x139;
        const double var_x141 = 0.012 / var_x133;
        const double var_x142 = var_x141 * (-1.0 - 119.0 * var_x24);
        const double var_x143 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x144 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x145 = 0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x146 = 1 / var_x145;
        const double var_x147 = pow((var_x146 * var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2.0);
        const double var_x148 = 1.0 * var_x147;
        const double var_x149 = var_x145 * var_x148 * var_x54 * (var_x146 - var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x145, 2));
        const double var_x150 = var_x149 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x151 = -0.59999999999999998 * var_x144;
        const double var_x152 = 0.5 * var_x147;
        const double var_x153 = 0.00042079708847221582 * var_x6;
        const double var_x154 = 1.5752072268398093e-8 * var_x40;
        const double var_x155 = 8.4159417694443166e-6 * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x156 = 3.1504144536796185e-9 * var_x42;
        const double var_x157 = -var_x96;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.046749999999999993 + 1.7516202276615338e-5 * var_x51 + 0.0090910877712381839 * var_x10 + 0.014012961821292271 * var_x52 + 3.5032404553230682e-6 * var_x53 - 0.0024999999999999996 * var_x20 - 0.12142857142857143 * var_x5 - 0.028025923642584542 * var_x47 - 0.0024662812805474397 * var_x49 - var_x27 * var_x34 - var_x38 * var_x41 - var_x38 * var_x43 - var_x7 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x8 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 1, 0) = -2.103985442361079e-8 + 8.4159417694443161e-8 * var_x20 + 2.3586454141088428e-7 * var_x52 - 4.7172908282176856e-7 * var_x47 - var_x27 * var_x84;
        IJth(rJacobian, 2, 0) = ((var_x100) ? (var_x98) : (var_x98 + var_x101 * var_x106 - 0.020000000000000004 * var_x101 * var_x104 * var_x99 / pow(var_x105, 2)));
        IJth(rJacobian, 3, 0) = 0.001 * var_x113 * (-var_x114 * var_x115 + 5.0000000000000004e-6 * var_x109 * (var_x115 - var_x116) / pow((var_x112 + 0.01 * var_x109), 2)) + 0.001 * (var_x116 - var_x115) * (-var_chaste_interface__fast_sodium_current_h_gate__h + var_x110 * var_x114);
        IJth(rJacobian, 4, 0) = 0.066600000000000006 * var_x117 / pow((1.0 + var_x117), 2);
        IJth(rJacobian, 5, 0) = -1.9411764705882353e-6 * var_x118 * (1.0 - var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x119 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x120, 2);
        IJth(rJacobian, 6, 0) = ((var_x122) ? (0) : (var_x123 * var_x128 - var_x131 * var_chaste_interface__L_type_calcium_current_d_gate__d + 0.0012000000000000001 * var_x121 * var_x129 * var_chaste_interface__L_type_calcium_current_d_gate__d / pow(var_x130, 2) - 0.0074999999999999997 * var_x121 * var_x123 * var_x126 / pow(var_x127, 2)));
        IJth(rJacobian, 7, 0) = ((var_x137) ? (var_x135) : (var_x135 - var_x140 * var_chaste_interface__L_type_calcium_current_f_Ca_gate__f_Ca + 0.0015625000000000001 * var_x136 * var_x138 * var_chaste_interface__L_type_calcium_current_f_Ca_gate__f_Ca / pow(var_x139, 2)));
        IJth(rJacobian, 8, 0) = 0.048000000000000001 * var_x143 * var_x144;
        IJth(rJacobian, 10, 0) = -1.009913012333318e-7 + 5.8966135352721076e-10 * var_x51 - 2.5247825308332952e-7 * var_x20 - 8.2552589493809504e-8 * var_x49 - var_x153 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x154 * var_x38;
        IJth(rJacobian, 11, 0) = -1.4307101008055338e-6 + 3.0604026121459151e-7 * var_x10 + 1.1793227070544215e-10 * var_x53 - 4.0877431451586679e-6 * var_x5 - 4.7172908282176859e-10 * var_x49 - var_x155 * var_chaste_interface__transient_outward_current_r_gate__r - var_x156 * var_x38;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (9.11078717201166e-6 * var_x56 + 1.7249999999999996e-5 * var_x57 + 6859.9999999999991 * var_x58 - 0.18716945411372732 * var_x59 - 0.016696100412309782 * var_x54 - var_x34 * var_x63 - var_x41 * var_x64 - var_x43 * var_x64);
        IJth(rJacobian, 1, 1) = -17.0 + var_x85 + var_x86 + 0.0030000000000000001 * var_x90 - 0.0030000000000000001 * var_x88 - 2.8102681769358876e-7 * var_x54 - 3.1504144536796183e-6 * var_x59 - 5.5199999999999998e-8 * var_x91 - 3.0670341725380159e-10 * var_x56 - 5.8069998209165779e-10 * var_x57 - 0.23093344215355202 * var_x58 - var_x63 * var_x84;
        IJth(rJacobian, 7, 1) = var_x141 * (var_x61 + var_x134 * var_x23 - var_x134 * var_x60);
        IJth(rJacobian, 8, 1) = -var_x150 + var_x143 * var_x149;
        IJth(rJacobian, 9, 1) = var_x150;
        IJth(rJacobian, 10, 1) = 0.69280032646065626 * var_x58 + 1.7420999462749737e-9 * var_x57 + 9.2011025176140482e-10 * var_x56 - var_x154 * var_x64;
        IJth(rJacobian, 11, 1) = -var_x156 * var_x64;
        IJth(rJacobian, 12, 1) = 2.7047999999999999e-6 * var_x91 + 0.14699999999999999 * var_x88 - 0.14699999999999999 * var_x90;
        IJth(rJacobian, 14, 1) = 2.0 - var_x85;
        IJth(rJacobian, 15, 1) = 15.0 - var_x86;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-37.499999999999993 * var_x67);
        IJth(rJacobian, 2, 2) = ((var_x100) ? (-2.0 + var_x107) : (var_x107 - var_x106 * var_x99));
        IJth(rJacobian, 10, 2) = -0.0012623912654166475 * var_x67;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x66 * var_x7);
        IJth(rJacobian, 3, 3) = -0.02 * var_x109 - 2.0 * var_x112;
        IJth(rJacobian, 10, 3) = -var_x153 * var_x66;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x8 * var_x9);
        IJth(rJacobian, 4, 4) = -0.33300000000000002;
        IJth(rJacobian, 11, 4) = -var_x155 * var_x9;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-0.24999999999999997 * var_x68);
        IJth(rJacobian, 5, 5) = -0.033000000000000002 / var_x120 - 3.3000000000000003e-5 * var_x118;
        IJth(rJacobian, 11, 5) = -8.4159417694443166e-6 * var_x68;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x34 * var_x69 - var_x41 * var_x70 - var_x43 * var_x70);
        IJth(rJacobian, 1, 6) = -var_x69 * var_x84;
        IJth(rJacobian, 6, 6) = ((var_x122) ? (-0.23999999999999999) : (-var_x121 * var_x128 - var_x121 * var_x131));
        IJth(rJacobian, 10, 6) = -var_x154 * var_x70;
        IJth(rJacobian, 11, 6) = -var_x156 * var_x70;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x34 * var_x71 + var_x41 * var_x72 + var_x43 * var_x72);
        IJth(rJacobian, 1, 7) = var_x71 * var_x84;
        IJth(rJacobian, 7, 7) = ((var_x137) ? (-0.025000000000000001 + var_x142) : (var_x142 - var_x136 * var_x140));
        IJth(rJacobian, 10, 7) = var_x154 * var_x72;
        IJth(rJacobian, 11, 7) = var_x156 * var_x72;
        IJth(rJacobian, 1, 8) = 0.10204081632653063 * var_x95;
        IJth(rJacobian, 8, 8) = -0.059999999999999998 + var_x151 - var_x148;
        IJth(rJacobian, 9, 8) = 0.059999999999999998 + var_x152;
        IJth(rJacobian, 13, 8) = -0.5 * var_x95;
        IJth(rJacobian, 8, 9) = var_x151 - var_x152;
        IJth(rJacobian, 9, 9) = -0.001;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (1.9921546294486135e-11 * var_x78 + 0.0017500000000000003 * var_x75 - 0.00046792363528431829 * var_x80 - 0.080141281979086945 * var_x73 - 2.8000000000000003 * var_x74 - 0.014999999999999998 * var_x79 - 333.92200824619562 * var_x76);
        IJth(rJacobian, 1, 10) = 5.0495650616665894e-7 * var_x79 - 6.7063429428673803e-16 * var_x78;
        IJth(rJacobian, 10, 10) = 1.7673477715833067e-7 * var_x75 + 2.0119028828602145e-15 * var_x78 - 2.697857449858452e-6 * var_x73 - 1.5148695184999771e-6 * var_x79 - 1.5752072268398093e-8 * var_x80 - 0.00028277564345332906 * var_x74 - 0.011241072707743549 * var_x76;
        IJth(rJacobian, 11, 10) = 0.00018851709563555272 * var_x74 - 1.1782318477222046e-7 * var_x75;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (0.24285714285714283 * var_x83 - 1.135334828037065 * var_x1 - 9.3584727056863666e-5 * var_x80 - 40.07064098954347 * var_x76 - 3.243813794391615 * var_x81 - 6.678440164923912 * var_x82);
        IJth(rJacobian, 10, 11) = -0.0013489287249292259 * var_x76;
        IJth(rJacobian, 11, 11) = 8.1754862903173341e-6 * var_x83 - 3.1504144536796185e-9 * var_x80 - 3.8219647206328069e-5 * var_x1 - 0.00022482145415487099 * var_x82 - 0.0001091989920180802 * var_x81;
        IJth(rJacobian, 1, 12) = 5.5199999999999998e-8 * var_x88 + 7.1999999999999999e-7 * var_x90 - 1.3247999999999998e-11 * var_x91;
        IJth(rJacobian, 12, 12) = -0.050000000000000003 + 6.4915199999999989e-10 * var_x91 - 2.7047999999999999e-6 * var_x88 - 3.5279999999999994e-5 * var_x90;
        IJth(rJacobian, 13, 12) = 0.0050000000000000001;
        IJth(rJacobian, 1, 13) = 0.051020408163265314 * var_x94;
        IJth(rJacobian, 12, 13) = 0.050000000000000003;
        IJth(rJacobian, 13, 13) = -0.0050000000000000001 - 0.25 * var_x94;
        IJth(rJacobian, 1, 14) = 0.050000000000000003 + var_x96;
        IJth(rJacobian, 14, 14) = -0.050000000000000003 + var_x157;
        IJth(rJacobian, 1, 15) = 0.20000000000000001 + var_x96;
        IJth(rJacobian, 15, 15) = -0.20000000000000001 + var_x157;
    }
