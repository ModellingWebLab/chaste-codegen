...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldecker_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x6 = 0.04956 / var_x5;
        const double var_x7 = -0.082600000000000007 - var_x6;
        const double var_x8 = var_chaste_interface__IKs__O1 + var_chaste_interface__IKs__O2;
        const double var_x9 = var_x7 * var_x8;
        const double var_x10 = 1 / var_chaste_interface__K__K_i;
        const double var_x11 = log(5.4000000000000004 * var_x10);
        const double var_x12 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__Vm - 6.3707607242426443 * var_x11);
        const double var_x13 = 1.0 + var_x12;
        const double var_x14 = 1 / var_x13;
        const double var_x15 = exp(-2.4444678999999998 + 13.737871029257828 * var_x11 - 0.51429999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x16 = 1.0 + var_x15;
        const double var_x17 = 1 / var_x16;
        const double var_x18 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__Vm - 2.1454905717868731 * var_x11);
        const double var_x19 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__Vm - 1.649452724201188 * var_x11);
        const double var_x20 = var_x19 + 0.49124000000000001 * var_x18;
        const double var_x21 = var_x17 * var_x20;
        const double var_x22 = 1 / (var_x21 + 1.02 * var_x14);
        const double var_x23 = var_x14 * var_x22;
        const double var_x24 = 0.037436659501656748 * var_chaste_interface__membrane__Vm;
        const double var_x25 = exp(var_x24);
        const double var_x26 = -1.0 + var_x25;
        const double var_x27 = 1 / var_x26;
        const double var_x28 = var_x25 * var_chaste_interface__Na__Na_i;
        const double var_x29 = -140.0 + var_x28;
        const double var_x30 = var_x27 * var_x29;
        const double var_x31 = exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__membrane__Vm);
        const double var_x32 = 1.0 + var_x31;
        const double var_x33 = 1 / var_x32;
        const double var_x34 = 0.013854200000000001 * var_x33;
        const double var_x35 = exp(0.074873319003313496 * var_chaste_interface__membrane__Vm);
        const double var_x36 = -1.0 + var_x35;
        const double var_x37 = 1 / var_x36;
        const double var_x38 = 1.0 * var_x35;
        const double var_x39 = -0.61380000000000001 + var_x38 * var_chaste_interface__Ca__Ca_i;
        const double var_x40 = var_x37 * var_x39;
        const double var_x41 = pow(var_chaste_interface__INaL_mL_gate__mL, 3.0);
        const double var_x42 = 0.0064999999999999997 * var_x41;
        const double var_x43 = var_chaste_interface__ICaL__O + var_chaste_interface__ICaL__O_star;
        const double var_x44 = -0.61380000000000001 + var_x38 * var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x45 = var_x37 * var_x44;
        const double var_x46 = 2.2470468725164396 * var_x45;
        const double var_x47 = var_x43 * var_x46;
        const double var_x48 = pow(var_chaste_interface__INa_m_gate__m, 3.0);
        const double var_x49 = var_x48 * var_chaste_interface__INa_j_gate__j;
        const double var_x50 = 9.0749999999999993 * var_x49;
        ...
        const double var_x54 = exp(-3.444172674152421 - var_x24);
        const double var_x55 = 1.0 + var_x54;
        const double var_x56 = var_x53 * var_x54 / pow(var_x55, 2);
        const double var_x57 = 26.711785007306688 * var_x11;
        const double var_x58 = -var_x57 + var_chaste_interface__membrane__Vm;
        const double var_x59 = var_x0 * var_x58 / pow(var_x1, 2);
        const double var_x60 = var_x35 * var_chaste_interface__membrane__Vm;
        const double var_x61 = var_x60 / pow(var_x36, 2);
        const double var_x62 = var_x39 * var_x61;
        const double var_x63 = var_x31 * var_x58 * var_chaste_interface__IKr_xr_gate__xr / pow(var_x32, 2);
        const double var_x64 = var_x25 * var_chaste_interface__membrane__Vm;
        const double var_x65 = var_x29 * var_x64 / pow(var_x26, 2);
        const double var_x66 = var_x12 / pow(var_x13, 2);
        const double var_x67 = var_x22 * var_x58;
        ...
        const double var_x73 = pow(var_chaste_interface__Na__Na_i, 3.0);
        const double var_x74 = exp(0.010107898065447322 * var_chaste_interface__membrane__Vm);
        const double var_x75 = var_x73 * var_x74;
        const double var_x76 = var_x69 * var_chaste_interface__Ca__Ca_i;
        const double var_x77 = pow(var_x3, 2.0);
        const double var_x78 = 1.0 + 1.5624999999999999e-8 * var_x77;
        const double var_x79 = 1 / var_x78;
        const double var_x80 = 1 / (13227.9606 + 4344355.375 * var_chaste_interface__Ca__Ca_i + 8.40849329909123 * var_x73);
        const double var_x81 = var_x79 * var_x80;
        const double var_x82 = var_x81 * (0.065499179464098653 * var_x75 + 269964.43697145121 * var_x76);
        const double var_x83 = pow(var_chaste_interface__Na__Na_ss_sr, 3.0);
        const double var_x84 = var_x74 * var_x83;
        const double var_x85 = var_x69 * var_chaste_interface__Ca__Ca_ss_sr;
        ...
        const double var_x90 = 1 / (13227.9606 + 4344355.375 * var_chaste_interface__Ca__Ca_ss_sr + 8.40849329909123 * var_x83);
        const double var_x91 = var_x89 * var_x90;
        const double var_x92 = var_x91 * (0.016374794866024663 * var_x84 + 67491.109242862804 * var_x85);
        const double var_x93 = 1.0 - var_x25;
        const double var_x94 = 1 / var_x93;
        const double var_x95 = pow(var_chaste_interface__Irel__Irel, 2.0);
        const double var_x96 = 1.0 - 1.0 / (1.0 + 6.25 * var_x95);
        const double var_x97 = -100.0 * var_x25 + var_chaste_interface__Cl__Cl_i;
        const double var_x98 = var_x94 * var_x96 * var_x97;
        const double var_x99 = 0.0032509358688027189 * var_x98;
        const double var_x100 = pow(var_chaste_interface__Ito1_a_gate__a, 3.0);
        const double var_x101 = exp(0.0018181818181818182 * var_chaste_interface__membrane__Vm);
        const double var_x102 = var_x100 * var_x101 * var_chaste_interface__Ito1_i1s_gate__i1s;
        const double var_x103 = 0.4975 * var_x102;
        const double var_x104 = var_x15 * var_x20 / pow(var_x16, 2);
        const double var_x105 = 0.24326999999999999 * var_x66 - 0.51429999999999998 * var_x104 - var_x17 * (0.061749999999999999 * var_x19 + 0.039456396800000001 * var_x18);
        const double var_x106 = var_x14 * var_x58 / pow((var_x14 + 0.98039215686274506 * var_x21), 2);
        const double var_x107 = 0.49019607843137253 * var_x106;
        const double var_x108 = var_x37 * var_x60;
        const double var_x109 = var_x108 * var_chaste_interface__Ca__Ca_i;
        const double var_x110 = var_x27 * var_x28 * var_chaste_interface__membrane__Vm;
        const double var_x111 = var_x43 * var_x44 * var_x61;
        const double var_x112 = 0.1682438573013213 * var_x111;
        const double var_x113 = var_x96 * var_chaste_interface__Ito2_i2f_gate__i2f;
        const double var_x114 = var_x113 * var_x94;
        const double var_x115 = var_x114 * var_x64;
        const double var_x116 = 6.4800000000000004 * var_x75 - 9878400.0 * var_x76;
        const double var_x117 = var_x116 * var_x81;
        const double var_x118 = var_x69 / pow(var_x70, 2);
        const double var_x119 = 0.008745203659587017 * var_x118;
        const double var_x120 = 1.6200000000000001 * var_x84 - 2469600.0 * var_x85;
        const double var_x121 = var_x120 * var_x91;
        const double var_x122 = var_x108 * var_x43;
        const double var_x123 = var_x122 * var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x124 = 0.1682438573013213 * var_x123;
        const double var_x125 = var_x58 * var_chaste_interface__Ito1_i1f_gate__i1f;
        const double var_x126 = var_x102 * var_x125;
        const double var_x127 = var_x113 * var_x64 * var_x97 / pow(var_x93, 2);
        ...
        const double var_x133 = 2.3018374734134176e-7 * var_x71;
        const double var_x134 = var_x116 * var_x79 / pow((0.0030448615405916234 + 1.9354984970793808e-6 * var_x73 + var_chaste_interface__Ca__Ca_i), 2);
        const double var_x135 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
        ...
        const double var_x139 = var_x116 * var_x3 * var_x77 * var_x80 / pow(var_x78, 2);
        const double var_x140 = var_x136 * var_x7;
        const double var_x141 = var_x46 * var_chaste_interface__membrane__Vm;
        ...
        const double var_x148 = var_x146 * var_x48;
        const double var_x149 = var_x145 * pow(var_chaste_interface__INaL_mL_gate__mL, 2.0) * var_chaste_interface__INaL_hL_gate__hL;
        const double var_x150 = var_x101 * var_x125;
        const double var_x151 = var_x150 * pow(var_chaste_interface__Ito1_a_gate__a, 2.0) * var_chaste_interface__Ito1_i1s_gate__i1s;
        const double var_x152 = var_x100 * var_x150;
        const double var_x153 = var_x94 * var_x97 * pow(var_chaste_interface__Irel__Irel, 1.0) * var_chaste_interface__Ito2_i2f_gate__i2f * var_chaste_interface__membrane__Vm / pow((0.16 + var_x95), 2);
        const double var_x154 = var_x131 * var_x91;
        const double var_x155 = var_x120 * var_x89 / pow((0.0030448615405916234 + 1.9354984970793808e-6 * var_x83 + var_chaste_interface__Ca__Ca_ss_sr), 2);
        const double var_x156 = var_x120 * var_x86 * var_x87 * var_x90 / pow(var_x88, 2);
        const double var_x157 = 2.2470468725164396 * var_x122;
        const double var_x158 = var_x135 * var_x9;
        const double var_x159 = var_x27 * var_x64;
        const double var_x160 = var_x143 * var_x41 * var_chaste_interface__INaL_hL_gate__hL;
        const double var_x161 = var_x143 * var_x49 * var_chaste_interface__INa_h_gate__h;
        const double var_x162 = pow(var_chaste_interface__Na__Na_i, 2.0);
        const double var_x163 = var_x134 * var_x71;
        const double var_x164 = var_x162 * var_x163;
        const double var_x165 = var_x143 * var_x51 * var_x53 * (var_x52 - 0.14792899408284022 * var_chaste_interface__Na__Na_i / pow((1 + 0.38461538461538458 * var_chaste_interface__Na__Na_i), 2)) / var_x55;
        const double var_x166 = var_x71 * var_x74;
        const double var_x167 = var_x162 * var_x166 * var_x81;
        const double var_x168 = pow(var_chaste_interface__Na__Na_ss_sr, 2.0);
        const double var_x169 = var_x155 * var_x71;
        const double var_x170 = var_x168 * var_x169;
        const double var_x171 = var_x166 * var_x168 * var_x91;
        const double var_x172 = 1 / var_chaste_interface__Cl__Cl_i;
        const double var_x173 = var_x114 * var_chaste_interface__membrane__Vm;
        const double var_x174 = var_x10 * var_x2;
        const double var_x175 = var_x10 * var_x33 * var_chaste_interface__IKr_xr_gate__xr;
        const double var_x176 = var_x10 * var_x23;
        const double var_x177 = var_x10 * var_x66;
        const double var_x178 = 6.4981759387274973 * var_x177 - var_x17 * (1.649452724201188 * var_x10 * var_x19 + 1.0539507884845836 * var_x10 * var_x18) - 13.737871029257828 * var_x10 * var_x104;
        const double var_x179 = var_x177 * var_x67;
        const double var_x180 = var_x10 * var_x102 * var_chaste_interface__Ito1_i1f_gate__i1f;
        const double var_x181 = 8.8930116629204317e-8 * var_x40;
        const double var_x182 = 6.1700941025231678e-5 * var_x71;
        const double var_x183 = var_x117 * var_x118;
        const double var_x184 = 0.0023800000000000002 + var_chaste_interface__Ca__Ca_i;
        const double var_x185 = 1.0 + 0.00011900000000000002 * pow(var_x184, (-2.0)) + 3.5000000000000004e-5 * pow(var_x128, (-2.0));
        const double var_x186 = 1 / var_x185;
        const double var_x187 = 1.0 * var_x186;
        const double var_x188 = 1.7739020544754107e-6 * var_x129;
        const double var_x189 = 1.0 - var_chaste_interface__CaMK_active__CaMK_trap;
        const double var_x190 = 1.0 + 0.0015 * var_x86;
        ...
        const double var_x194 = 0.14999999999999999 + var_x193 + 1.0 * var_chaste_interface__CaMK_active__CaMK_trap;
        const double var_x195 = 1 / var_x194;
        const double var_x196 = var_x193 + var_chaste_interface__CaMK_active__CaMK_trap;
        const double var_x197 = var_x195 * var_x196;
        const double var_x198 = 0.00092000000000000003 - 0.00017000000000000001 * var_x197 + var_chaste_interface__Ca__Ca_i;
        const double var_x199 = 1 / var_x198;
        const double var_x200 = 1.0 + 0.75 * var_x197;
        const double var_x201 = var_x199 * var_x200;
        const double var_x202 = 0.00035619469026548675 * var_x201;
        const double var_x203 = 0.00035619469026548675 * var_chaste_interface__Ca__Ca_i;
        const double var_x204 = var_x200 / pow(var_x198, 2);
        const double var_x205 = var_x203 * var_x204;
        const double var_x206 = var_x139 * var_x71;
        const double var_x207 = pow(var_chaste_interface__Ca__Ca_ss_sr, (-2));
        const double var_x208 = var_x189 * var_x207 / pow(var_x190, 2);
        const double var_x209 = var_x195 * var_x208;
        const double var_x210 = var_x196 / pow(var_x194, 2);
        ...
        const double var_x226 = 4.987593242591509e-5 * var_x220;
        ...
        const double var_x244 = 0.000523133988768539 * var_x222;
        ...
        const double var_x252 = 0.00040118636575835935 * var_x228;
        ...
        const double var_x272 = 0.00018735604223495546 * var_x271;
        const double var_x273 = 0.07732 * var_x271;
        const double var_x274 = exp(0.010559384179037302 * var_chaste_interface__membrane__Vm);
        const double var_x275 = 0.0061918116949038933 * var_x274;
        const double var_x276 = exp(-0.003001446738885828 * var_chaste_interface__membrane__Vm);
        const double var_x277 = 0.002383298783012292 * var_x276 * var_chaste_interface__IKs__O2;
        ...
        const double var_x287 = 0.0038918839011179403 * var_x285 / pow(var_x286, 2);
        const double var_x288 = exp(-0.019709447580272044 - 0.092532617747756077 * var_chaste_interface__membrane__Vm);
        const double var_x289 = 1.0 + var_x288;
        const double var_x290 = var_x288 / pow(var_x289, 2);
        const double var_x291 = 0.0030285935177480471 * var_x290;
        const double var_x292 = var_x287 - var_x291;
        const double var_x293 = 0.040277106492669565 / var_x286;
        const double var_x294 = -var_x293;
        const double var_x295 = 1 / var_x289;
        const double var_x296 = 0.032730010146303147 * var_x295;
        const double var_x297 = var_x280 / pow(var_x281, 2);
        const double var_x298 = 0.26666666666666666 * var_x297;
        const double var_x299 = var_x298 * (var_x294 - var_x296);
        const double var_x300 = var_x299 + var_x284 * var_x292;
        const double var_x301 = exp(1.4349206349206352 - 0.10582010582010583 * var_chaste_interface__membrane__Vm);
        const double var_x302 = 1.0 + var_x301;
        const double var_x303 = exp(1.7160000000000002 + 0.13200000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x304 = 1.0 + var_x303;
        const double var_x305 = exp(0.67599999999999993 + 0.051999999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x306 = var_x305 / var_x304;
        const double var_x307 = 1 / (0.58999999999999997 + 0.80000000000000004 * var_x306);
        const double var_x308 = 0.10582010582010583 * var_x301 * var_x307 / pow(var_x302, 2);
        const double var_x309 = 1 / var_x302;
        const double var_x310 = 1.5624999999999998 * (-0.041599999999999998 * var_x306 + 0.10560000000000001 * var_x303 * var_x305 / pow(var_x304, 2)) / pow((0.73749999999999993 + var_x306), 2);
        const double var_x311 = var_x309 * var_x310;
        const double var_x312 = -var_x308 - var_x311;
        const double var_x313 = 0.20000000000000001 + var_x283;
        const double var_x314 = -var_x287;
        const double var_x315 = var_x291 + var_x314;
        const double var_x316 = var_x313 * var_x315;
        const double var_x317 = 1.0 * var_x309;
        const double var_x318 = 1.0 - var_x317;
        const double var_x319 = var_x310 * var_x318;
        const double var_x320 = var_x293 + var_x296;
        const double var_x321 = var_x298 * var_x320;
        const double var_x322 = var_x307 * var_x317;
        const double var_x323 = -var_x322;
        const double var_x324 = 1 / var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x325 = pow(var_x324, 4.0);
        const double var_x326 = 1.0 + 8.1000000000000005e-11 * var_x325;
        const double var_x327 = 1 / var_x326;
        const double var_x328 = 3.0 * var_x327;
        const double var_x329 = var_x284 * var_x320;
        const double var_x330 = -var_x328 - var_x329;
        const double var_x331 = var_x307 * var_x318;
        const double var_x332 = var_x313 * var_x320;
        const double var_x333 = var_x324 * var_x325 / pow(var_x326, 2);
        const double var_x334 = 9.7199999999999995e-10 * var_x333;
        const double var_x335 = var_x334 * var_chaste_interface__ICaL__C;
        const double var_x336 = var_x308 - var_x319;
        const double var_x337 = -var_x331;
        const double var_x338 = var_x334 * var_chaste_interface__ICaL__O;
        const double var_x339 = 0.99990000999900008 * var_x282;
        const double var_x340 = 0.99990000999900008 - var_x339;
        const double var_x341 = 1 / (25.0 - 17.5 * var_x327);
        const double var_x342 = 0.092532617747756077 * var_x290 * var_x341;
        const double var_x343 = var_x287 - var_x342;
        const double var_x344 = 1.0 * var_x295 * var_x341;
        const double var_x345 = 0.33330000333300003 * var_x297;
        const double var_x346 = var_x345 * (var_x294 - var_x344);
        const double var_x347 = var_x346 + var_x340 * var_x343;
        const double var_x348 = 9.9990000999900015e-5 + var_x339;
        const double var_x349 = var_x314 + var_x342;
        const double var_x350 = var_x348 * var_x349;
        const double var_x351 = var_x293 + var_x344;
        const double var_x352 = var_x345 * var_x351;
        const double var_x353 = var_x340 * var_x351;
        const double var_x354 = -1.0 - var_x353;
        const double var_x355 = var_x348 * var_x351;
        const double var_x356 = 9.0720000000000001e-12 * var_x295 * var_x333 / pow((1 - 0.69999999999999996 * var_x327), 2);
        const double var_x357 = var_x348 * var_x356;
        const double var_x358 = var_x357 * var_chaste_interface__ICaL__CI_star;
        const double var_x359 = var_x340 * var_x356;
        const double var_x360 = var_x359 * var_chaste_interface__ICaL__C_star;
        const double var_x361 = var_x357 * var_chaste_interface__ICaL__OI_star;
        const double var_x362 = var_x359 * var_chaste_interface__ICaL__O_star;
        const double var_x363 = 1 / var_x284;
        const double var_x364 = 1 / var_x348;
        const double var_x365 = var_x327 * var_x340 * var_x363 * var_x364;
        const double var_x366 = var_x297 * var_x365;
        const double var_x367 = var_x313 * var_x363 * var_x364;
        const double var_x368 = var_x297 * var_x327;
        const double var_x369 = 9.9990000999900006e-7 * var_x367 * var_x368;
        const double var_x370 = var_x313 * var_x340 * var_x368;
        const double var_x371 = var_x364 * var_x370 / pow((1 - var_x282), 2);
        const double var_x372 = 1.0001e-6 * var_x363 * var_x370 / pow((0.0001 + var_x282), 2);
        const double var_x373 = -var_x299 - var_x369 - var_x372 + 8.0000000000000007e-7 * var_x366 + 1.2499999999999999e-6 * var_x371 + var_x292 * var_x313;
        const double var_x374 = var_x284 * var_x315;
        const double var_x375 = 3.0000000000000001e-6 * var_x313 * var_x365;
        const double var_x376 = -var_x332 - var_x375;
        const double var_x377 = 9.7200000000000002e-16 * var_x333 * var_x340 * var_x367;
        const double var_x378 = var_x377 * var_chaste_interface__ICaL__CI;
        const double var_x379 = var_x377 * var_chaste_interface__ICaL__OI;
        const double var_x380 = -var_x346 + var_x343 * var_x348;
        const double var_x381 = var_x340 * var_x349;
        const double var_x382 = 8.0000000000000007e-7 * var_x366;
        const double var_x383 = 1.2499999999999999e-6 * var_x371;
        const double var_x384 = -9.9999999999999995e-7 - var_x355;
        const double var_x385 = 1.0 - var_chaste_interface__INa_m_gate__m;
        const double var_x386 = -0.10000000000000001 * var_chaste_interface__membrane__Vm;
        const double var_x387 = exp(-4.7130000000000001 + var_x386);
        const double var_x388 = 1.0 - var_x387;
        const double var_x389 = 0.32000000000000001 / var_x388;
        const double var_x390 = exp(-0.090909090909090912 * var_chaste_interface__membrane__Vm);
        const double var_x391 = 0.0072727272727272727 * var_x390;
        const double var_x392 = 47.130000000000003 + var_chaste_interface__membrane__Vm;
        const double var_x393 = 0.032000000000000001 * var_x387 * var_x392 / pow(var_x388, 2);
        const double var_x394 = -0.080000000000000002 * var_x390 - var_x389 * var_x392;
        const double var_x395 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__Vm);
        const double var_x396 = 1.0 + var_x395;
        const double var_x397 = var_chaste_interface__membrane__Vm >= -40.0;
        const double var_x398 = exp(0.079000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x399 = exp(0.34999999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x400 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__Vm);
        const double var_x401 = exp(-3.2000000000000002 + var_x386);
        const double var_x402 = 1.0 + var_x401;
        const double var_x403 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__Vm);
        const double var_x404 = var_x403 / var_x402;
        const double var_x405 = 1.0 - var_chaste_interface__INa_j_gate__j;
        const double var_x406 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__Vm);
        const double var_x407 = 1.0 + var_x406;
        const double var_x408 = 1 / var_x407;
        const double var_x409 = exp(0.24440000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x410 = exp(-0.043909999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x411 = -127140.0 * var_x409 - 6.9480000000000006e-5 * var_x410;
        const double var_x412 = var_x408 * var_x411;
        const double var_x413 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x414 = 1.0 + var_x413;
        const double var_x415 = exp(-0.01052 * var_chaste_interface__membrane__Vm);
        const double var_x416 = var_x415 / var_x414;
        const double var_x417 = 37.780000000000001 + var_chaste_interface__membrane__Vm;
        const double var_x418 = var_x405 * var_x417;
        const double var_x419 = 1.0 - var_chaste_interface__INaL_mL_gate__mL;
        const double var_x420 = exp(14.918032786885247 + 0.16393442622950821 * var_chaste_interface__membrane__Vm);
        const double var_x421 = exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm);
        const double var_x422 = 1.0 + var_x421;
        const double var_x423 = exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm);
        const double var_x424 = -1.0 + var_x423;
        const double var_x425 = 0.00029999999999999997 / var_x424;
        const double var_x426 = exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x427 = 1.0 - var_x426;
        const double var_x428 = 0.00059999999999999995 / var_x427;
        const double var_x429 = -1.7383999999999999 + var_chaste_interface__membrane__Vm;
        const double var_x430 = 38.360799999999998 + var_chaste_interface__membrane__Vm;
        const double var_x431 = var_x425 * var_x430;
        const double var_x432 = var_x428 * var_x429;
        const double var_x433 = exp(-1.3230057479321462 - 0.14019346698443852 * var_chaste_interface__membrane__Vm);
        const double var_x434 = 1.0 + var_x433;
        const double var_x435 = 0.034035137876343539 * var_chaste_interface__membrane__Vm;
        const double var_x436 = exp(0.62658348478969694 - var_x435);
        const double var_x437 = 1.0 + var_x436;
        const double var_x438 = exp(3.403513787634354 + var_x435);
        const double var_x439 = 1.0 + var_x438;
        const double var_x440 = 3.5 / var_x439;
        const double var_x441 = 0.82719827942757873 / var_x437;
        const double var_x442 = exp(-2.1111111111111112 - 0.1111111111111111 * var_chaste_interface__membrane__Vm);
        const double var_x443 = 1.0 + var_x442;
        const double var_x444 = var_x442 / pow(var_x443, 2);
        const double var_x445 = 0.011343308638950427 * var_x444;
        const double var_x446 = 0.20000000000000001 * var_chaste_interface__membrane__Vm;
        const double var_x447 = exp(11.6 + var_x446);
        const double var_x448 = 1.0 + var_x447;
        const double var_x449 = var_x447 / pow(var_x448, 2);
        const double var_x450 = 0.005000000000000001 * var_x449;
        const double var_x451 = 1 / var_x448;
        const double var_x452 = 0.025000000000000001 * var_x451;
        const double var_x453 = 1 / var_x443;
        const double var_x454 = -0.10208977775055385 * var_x453;
        const double var_x455 = exp(12.0 + var_x446);
        const double var_x456 = 1.0 + var_x455;
        const double var_x457 = 1 / var_chaste_interface__Ca__Ca_JSR;
        const double var_x458 = pow(var_x457, 8.0);
        const double var_x459 = 1.0 + 1.0 * var_x458;
        const double var_x460 = 1 / var_x459;
        const double var_x461 = 1 / var_x196;
        const double var_x462 = pow(var_x461, 10.0);
        const double var_x463 = 1.0 + 2.9619676669542428e-6 * var_x462;
        const double var_x464 = 1 / var_x463;
        const double var_x465 = 0.53437500000000004 + 0.53437500000000004 * var_x464;
        const double var_x466 = var_x460 * var_x465;
        const double var_x467 = var_x466 * var_x47;
        const double var_x468 = 1 / (4.75 + 4.75 * var_x464);
        const double var_x469 = 1.0 + 0.0123 * var_x457;
        const double var_x470 = var_x468 * var_x469;
        const double var_x471 = var_x466 * var_x470;
        const double var_x472 = -var_x141 * var_x471;
        const double var_x473 = -var_chaste_interface__Irel__Irel;
        const double var_x474 = var_x473 - var_x467 * var_chaste_interface__membrane__Vm;
        const double var_x475 = var_x43 * var_x45 * var_x470 * var_chaste_interface__membrane__Vm;
        const double var_x476 = var_x469 * var_x474 / pow((1 + var_x464), 2);
        const double var_x477 = var_x461 * var_x462 / pow(var_x463, 2);
        const double var_x478 = var_x208 * var_x477;
        const double var_x479 = var_x460 * var_x475;
        const double var_x480 = var_x477 * (-1 + var_x192);
        const double var_x481 = 0.80000000000000004 + var_chaste_interface__Ca__Ca_JSR;
        const double var_x482 = pow(var_x481, (-2.0));
        const double var_x483 = 1 / (1.0 + 8.0 * var_x482);
        const double var_x484 = 0.040000000000000001 * var_x483;
        const double var_x485 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x486 = var_x204 * var_x485;
        const double var_x487 = var_x199 * var_x485;
        const double var_x488 = 0.0020916619007553539 * var_x71;
        const double var_x489 = var_x118 * var_x121;
        const double var_x490 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x491 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x492 = 1.0 + 0.0097788000000000007 * pow(var_x490, (-2.0)) + 4.0890000000000003e-5 * pow(var_x491, (-2.0));
        const double var_x493 = 1 / var_x492;
        const double var_x494 = 1.0 * var_x493;
        const double var_x495 = var_x156 * var_x71;
        const double var_x496 = 0.023500311662270547 * var_x45;
        const double var_x497 = var_x43 * var_x496;
        const double var_x498 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x499 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x500 = 1.0 + 0.0097788000000000007 * pow(var_x498, (-2.0)) + 4.0890000000000003e-5 * pow(var_x499, (-2.0));
        const double var_x501 = 1 / var_x500;
        const double var_x502 = 1.0 * var_x501;
        const double var_x503 = -var_x496 * var_x501 * var_chaste_interface__membrane__Vm;
        const double var_x504 = 4.0105611666400587e-7 * var_x41;
        const double var_x505 = 0.00055993603980397742 * var_x49;
        const double var_x506 = log(100.0 * var_x172);
        const double var_x507 = var_x144 + var_x506;
        const double var_x508 = pow(var_x507, 4.0);
        const double var_x509 = 7.2087469970547587e-9 * pow(var_x507, 7.0) / pow((1 + 0.0085573053764671243 * var_x508), 2);
        const double var_x510 = 50.118419258935795 * pow(var_x507, 3.0) / (59494197.640692554 + 509110.01733929612 * var_x508);
        const double var_x511 = var_x143 * var_x509 - var_x143 * var_x510;
        const double var_x512 = var_x172 * var_x509 - var_x172 * var_x510;
        const double var_x513 = var_x57 + 26.711785007306688 * var_x506;
        const double var_x514 = 0.00047279859462932838 / (87.825100000000006 + var_x513);
        const double var_x515 = 6.1296950776416711e-8 * var_x513 / pow((1 + 0.3041475046120834 * var_x11 + 0.3041475046120834 * var_x506), 2);
        const double var_x516 = var_x172 * var_x515 - var_x172 * var_x514;
        const double var_x517 = var_x10 * var_x515 - var_x10 * var_x514;
        const double var_x518 = 6.7998586985736529e-6 * var_x98;
        const double var_x519 = 0.082600000000000007 + var_x6;
        const double var_x520 = 6.1700941025231678e-5 * var_x519;
        const double var_x521 = 8.548171771517647e-7 * var_x33;
        const double var_x522 = 3.0696218160052759e-5 * var_x102;
        const double var_x523 = 3.0245559326093954e-5 * var_x106;
        const double var_x524 = -var_x136 * var_x520;
        const double var_x525 = var_x135 * var_x519 * var_x8;
        const double var_x526 = 0.0025000000000000005 * var_x191;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00022499999999999999 + var_x112 + var_x9 - var_x124 - var_x47 + 0.00021583116499495199 * var_x62 + 0.00089962337662337659 * var_x63 + 0.012170417918209005 * var_x115 + 4.3272597042520909e-7 * var_x65 + 0.12163499999999999 * var_x68 - 0.51000000000000001 * var_x23 - 1.1558883089076335e-5 * var_x30 - 0.0027599999999999999 * var_x2 - 0.0028826178386108466 * var_x40 - 0.00021583116499495199 * var_x109 - 0.00012170417918209005 * var_x127 - 0.041017557367032609 * var_x56 - 4.3272597042520909e-7 * var_x110 - 0.00090454545454545453 * var_x126 - 0.00046153846153846153 * var_x59 - var_x103 * var_chaste_interface__Ito1_i1f_gate__i1f - var_x105 * var_x107 - var_x117 * var_x119 - var_x119 * var_x121 - var_x34 * var_chaste_interface__IKr_xr_gate__xr - var_x42 * var_chaste_interface__INaL_hL_gate__hL - var_x50 * var_chaste_interface__INa_h_gate__h - var_x72 * var_x82 - var_x72 * var_x92 - var_x99 * var_chaste_interface__Ito2_i2f_gate__i2f);
        IJth(rJacobian, 1, 0) = var_x187 * (-var_x181 + 5.3958729525381878e-7 * var_x183 + 6.6584929913802891e-9 * var_x62 - 6.6584929913802891e-9 * var_x109 + var_x182 * var_x82);
        ...
        IJth(rJacobian, 19, 0) = var_x316 * var_chaste_interface__ICaL__CI + var_x319 * var_chaste_interface__ICaL__O + (var_x300 + var_x312) * var_chaste_interface__ICaL__C - var_x308 * var_chaste_interface__ICaL__O - var_x321 * var_chaste_interface__ICaL__CI;
        IJth(rJacobian, 20, 0) = var_x308 * var_chaste_interface__ICaL__C + var_x311 * var_chaste_interface__ICaL__C + var_x316 * var_chaste_interface__ICaL__OI + (var_x300 + var_x336) * var_chaste_interface__ICaL__O - var_x321 * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 21, 0) = var_x319 * var_chaste_interface__ICaL__O_star + var_x350 * var_chaste_interface__ICaL__CI_star + (var_x312 + var_x347) * var_chaste_interface__ICaL__C_star - var_x308 * var_chaste_interface__ICaL__O_star - var_x352 * var_chaste_interface__ICaL__CI_star;
        IJth(rJacobian, 22, 0) = var_x308 * var_chaste_interface__ICaL__C_star + var_x311 * var_chaste_interface__ICaL__C_star + var_x350 * var_chaste_interface__ICaL__OI_star + (var_x336 + var_x347) * var_chaste_interface__ICaL__O_star - var_x352 * var_chaste_interface__ICaL__OI_star;
        IJth(rJacobian, 23, 0) = var_x319 * var_chaste_interface__ICaL__OI + var_x321 * var_chaste_interface__ICaL__C + var_x374 * var_chaste_interface__ICaL__C + (var_x312 + var_x373) * var_chaste_interface__ICaL__CI - var_x308 * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 24, 0) = var_x308 * var_chaste_interface__ICaL__CI + var_x311 * var_chaste_interface__ICaL__CI + var_x321 * var_chaste_interface__ICaL__O + var_x374 * var_chaste_interface__ICaL__O + (var_x336 + var_x373) * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 25, 0) = var_x319 * var_chaste_interface__ICaL__OI_star + var_x352 * var_chaste_interface__ICaL__C_star + var_x369 * var_chaste_interface__ICaL__CI + var_x372 * var_chaste_interface__ICaL__CI + var_x381 * var_chaste_interface__ICaL__C_star + (var_x312 + var_x380) * var_chaste_interface__ICaL__CI_star - var_x308 * var_chaste_interface__ICaL__OI_star - var_x382 * var_chaste_interface__ICaL__CI - var_x383 * var_chaste_interface__ICaL__CI;
        IJth(rJacobian, 26, 0) = var_x308 * var_chaste_interface__ICaL__CI_star + var_x311 * var_chaste_interface__ICaL__CI_star + var_x352 * var_chaste_interface__ICaL__O_star + var_x369 * var_chaste_interface__ICaL__OI + var_x372 * var_chaste_interface__ICaL__OI + var_x381 * var_chaste_interface__ICaL__O_star + (var_x336 + var_x380) * var_chaste_interface__ICaL__OI_star - var_x382 * var_chaste_interface__ICaL__OI - var_x383 * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 27, 0) = var_x385 * var_x389 + var_x391 * var_chaste_interface__INa_m_gate__m - var_x385 * var_x393;
        IJth(rJacobian, 28, 0) = ((var_x397) ? (-0.693000693000693 * var_x395 * var_chaste_interface__INa_h_gate__h / pow(var_x396, 2)) : ((-0.28123999999999999 * var_x398 - 108500.0 * var_x399) * var_chaste_interface__INa_h_gate__h - 0.019852941176470591 * var_x400 * (1.0 - var_chaste_interface__INa_h_gate__h)));
        IJth(rJacobian, 29, 0) = ((var_x397) ? (7.6049999999999996e-8 * var_x404 * var_chaste_interface__INa_j_gate__j - 0.029999999999999999 * var_x401 * var_x403 * var_chaste_interface__INa_j_gate__j / pow(var_x402, 2)) : (var_x405 * var_x412 + 0.001275024 * var_x416 * var_chaste_interface__INa_j_gate__j + var_x408 * var_x418 * (3.0508668000000001e-6 * var_x410 - 31073.016 * var_x409) - 0.311 * var_x406 * var_x411 * var_x418 / pow(var_x407, 2) - 0.016701360000000002 * var_x413 * var_x415 * var_chaste_interface__INa_j_gate__j / pow(var_x414, 2)));
        IJth(rJacobian, 30, 0) = var_x389 * var_x419 + var_x391 * var_chaste_interface__INaL_mL_gate__mL - var_x393 * var_x419;
        IJth(rJacobian, 31, 0) = -0.00027322404371584705 * var_x420 / pow((1.0 + var_x420), 2);
        IJth(rJacobian, 32, 0) = (-var_chaste_interface__IKr_xr_gate__xr + 1.0 / var_x422) * (var_x425 + var_x428 - 8.1600000000000005e-5 * var_x426 * var_x429 / pow(var_x427, 2) - 4.566e-5 * var_x423 * var_x430 / pow(var_x424, 2)) + 0.23529411764705882 * var_x421 * (var_x431 + var_x432) / pow(var_x422, 2);
        IJth(rJacobian, 33, 0) = (-var_chaste_interface__Ito1_a_gate__a + 1.0 / var_x434) * (0.028153807491391791 * var_x436 / pow(var_x437, 2) - 0.11912298256720238 * var_x438 / pow(var_x439, 2)) + 0.14019346698443852 * var_x433 * (var_x440 + var_x441) / pow(var_x434, 2);
        IJth(rJacobian, 34, 0) = -var_x445 * var_chaste_interface__Ito1_i1f_gate__i1f - var_x450 * (1.0 - var_chaste_interface__Ito1_i1f_gate__i1f);
        IJth(rJacobian, 35, 0) = -var_x445 * var_chaste_interface__Ito1_i1s_gate__i1s - 0.00080000000000000004 * var_x455 * (1.0 - var_chaste_interface__Ito1_i1s_gate__i1s) / pow(var_x456, 2);
        IJth(rJacobian, 36, 0) = -0.00062500000000000012 * var_x449 / (var_x452 + 0.20000000000000001 * var_x453) + 0.078125 * var_x451 * (var_x450 - 0.022222222222222223 * var_x444) / pow((var_x453 + 0.125 * var_x451), 2);
        IJth(rJacobian, 37, 0) = var_x470 * (-var_x467 + var_x112 * var_x466 - var_x124 * var_x466);
        IJth(rJacobian, 40, 0) = var_x494 * (1.8292009309104455e-5 * var_x489 + var_x488 * var_x92);
        IJth(rJacobian, 41, 0) = var_x502 * (-var_x497 + 0.0017595463317664711 * var_x111 - 0.0017595463317664711 * var_x123);
        IJth(rJacobian, 42, 0) = 2.669959958129197e-11 * var_x65 - 7.1319396379664668e-10 * var_x30 - 1.6187618857614561e-6 * var_x183 - 2.669959958129197e-11 * var_x110 - 7.5924656643070068e-6 * var_x56 - var_x504 * var_chaste_interface__INaL_hL_gate__hL - var_x505 * var_chaste_interface__INa_h_gate__h - 0.00018510282307569501 * var_x71 * var_x82;
        IJth(rJacobian, 43, 0) = -5.487602792731337e-5 * var_x489 - 0.0062749857022660616 * var_x71 * var_x92;
        IJth(rJacobian, 44, 0) = 1.3882711730677126e-8;
        IJth(rJacobian, 45, 0) = 2.5456399475788062e-7 * var_x127 - 2.5456399475788062e-5 * var_x115 + var_x518 * var_chaste_interface__Ito2_i2f_gate__i2f;
        IJth(rJacobian, 46, 0) = 5.0616437762046715e-6 * var_x56 + 7.5049939616040537e-6 * var_x68 + 5.5507608905958744e-8 * var_x63 - 3.1467479922868152e-5 * var_x23 - 1.7029459722963942e-7 * var_x2 - 2.8477357396260772e-8 * var_x59 - 5.581130574555047e-8 * var_x126 - var_x105 * var_x523 - var_x520 * var_x8 - var_x521 * var_chaste_interface__IKr_xr_gate__xr - var_x522 * var_chaste_interface__Ito1_i1f_gate__i1f;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (9878400.0 * var_x132 + 0.057500000000000002 * var_x130 - 0.0028826178386108466 * var_x108 - 0.057500000000000002 * var_x129 - 4.4973467007233054e-8 * var_x137 + var_x133 * var_x134 - var_x138 * var_x139);
        IJth(rJacobian, 1, 1) = var_x187 * (-0.014749262536873156 + var_x205 - var_x188 - var_x202 + 1.7739020544754107e-6 * var_x130 + 1.9281544070384897e-12 * var_x206 - 8.8930116629204317e-8 * var_x108 - 609.50657582364863 * var_x132 - 1.4202553819674957e-11 * var_x163) + 1.0 * (0.00023800000000000004 * pow(var_x184, (-3.0)) + 7.0000000000000007e-5 * pow(var_x128, (-3.0))) * (0.014749262536873156 * var_chaste_interface__Ca__Ca_ss_sr + 2.3746312684365782e-5 * var_chaste_interface__Ca__Ca_NSR - 0.014749262536873156 * var_chaste_interface__Ca__Ca_i + var_x117 * var_x182 - var_x181 * var_chaste_interface__membrane__Vm - var_x188 * var_chaste_interface__Ca__Ca_i - var_x202 * var_chaste_interface__Ca__Ca_i) / pow(var_x185, 2);
        IJth(rJacobian, 39, 1) = -var_x486 + 0.0043750000000000004 * var_x201;
        IJth(rJacobian, 40, 1) = 5.0 * var_x493;
        IJth(rJacobian, 42, 1) = 4.2607661459024865e-11 * var_x163 + 1828.5197274709456 * var_x132 - 5.784463221115469e-12 * var_x206;
        ...
        IJth(rJacobian, 46, 17) = var_x524;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x140);
        IJth(rJacobian, 17, 18) = var_x279;
        IJth(rJacobian, 18, 18) = -var_x279;
        IJth(rJacobian, 46, 18) = var_x524;
        IJth(rJacobian, 19, 19) = var_x323 + var_x330;
        IJth(rJacobian, 20, 19) = var_x322;
        IJth(rJacobian, 21, 19) = var_x328;
        IJth(rJacobian, 23, 19) = var_x329;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (var_x142);
        IJth(rJacobian, 19, 20) = var_x331;
        IJth(rJacobian, 20, 20) = var_x330 + var_x337;
        IJth(rJacobian, 22, 20) = var_x328;
        IJth(rJacobian, 24, 20) = var_x329;
        IJth(rJacobian, 37, 20) = var_x472;
        IJth(rJacobian, 41, 20) = var_x503;
        IJth(rJacobian, 19, 21) = 1.0;
        IJth(rJacobian, 21, 21) = var_x323 + var_x354;
        IJth(rJacobian, 22, 21) = var_x322;
        IJth(rJacobian, 25, 21) = var_x353;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (var_x142);
        IJth(rJacobian, 20, 22) = 1.0;
        IJth(rJacobian, 21, 22) = var_x331;
        IJth(rJacobian, 22, 22) = var_x337 + var_x354;
        IJth(rJacobian, 26, 22) = var_x353;
        IJth(rJacobian, 37, 22) = var_x472;
        IJth(rJacobian, 41, 22) = var_x503;
        IJth(rJacobian, 19, 23) = var_x332;
        IJth(rJacobian, 23, 23) = var_x323 + var_x376;
        IJth(rJacobian, 24, 23) = var_x322;
        IJth(rJacobian, 25, 23) = var_x375;
        IJth(rJacobian, 20, 24) = var_x332;
        IJth(rJacobian, 23, 24) = var_x331;
        IJth(rJacobian, 24, 24) = var_x337 + var_x376;
        IJth(rJacobian, 26, 24) = var_x375;
        IJth(rJacobian, 21, 25) = var_x355;
        IJth(rJacobian, 23, 25) = 9.9999999999999995e-7;
        IJth(rJacobian, 25, 25) = var_x323 + var_x384;
        IJth(rJacobian, 26, 25) = var_x322;
        IJth(rJacobian, 22, 26) = var_x355;
        IJth(rJacobian, 24, 26) = 9.9999999999999995e-7;
        IJth(rJacobian, 25, 26) = var_x331;
        IJth(rJacobian, 26, 26) = var_x337 + var_x384;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-27.224999999999998 * var_x147);
        IJth(rJacobian, 27, 27) = var_x394;
        IJth(rJacobian, 42, 27) = -0.0016798081194119322 * var_x147;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x145 * var_x50);
        IJth(rJacobian, 28, 28) = ((var_x397) ? (-7.6923076923076916 / var_x396) : (-310000.0 * var_x399 - 0.13500000000000001 * var_x400 - 3.5600000000000001 * var_x398));
        IJth(rJacobian, 42, 28) = -var_x145 * var_x505;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-9.0749999999999993 * var_x148);
        IJth(rJacobian, 29, 29) = ((var_x397) ? (-0.29999999999999999 * var_x404) : (-0.1212 * var_x416 - var_x412 * var_x417));
        IJth(rJacobian, 42, 29) = -0.00055993603980397742 * var_x148;
        IJth(rJacobian, 0, 30) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0195 * var_x149);
        IJth(rJacobian, 30, 30) = var_x394;
        IJth(rJacobian, 42, 30) = -1.2031683499920175e-6 * var_x149;
        IJth(rJacobian, 0, 31) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x145 * var_x42);
        IJth(rJacobian, 31, 31) = -0.0016666666666666668;
        IJth(rJacobian, 42, 31) = -var_x145 * var_x504;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x34 * var_x58);
        IJth(rJacobian, 32, 32) = -var_x431 - var_x432;
        IJth(rJacobian, 46, 32) = -var_x521 * var_x58;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-1.4924999999999999 * var_x151);
        IJth(rJacobian, 33, 33) = -var_x440 - var_x441;
        IJth(rJacobian, 46, 33) = -9.2088654480158277e-5 * var_x151;
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x103 * var_x58);
        IJth(rJacobian, 34, 34) = var_x454 - var_x452;
        IJth(rJacobian, 46, 34) = -var_x522 * var_x58;
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (-0.4975 * var_x152);
        IJth(rJacobian, 35, 35) = var_x454 - 0.0040000000000000001 / var_x456;
        IJth(rJacobian, 46, 35) = -3.0696218160052759e-5 * var_x152;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x99 * var_chaste_interface__membrane__Vm);
        IJth(rJacobian, 36, 36) = -0.125;
        IJth(rJacobian, 45, 36) = var_x518 * var_chaste_interface__membrane__Vm;
        IJth(rJacobian, 0, 37) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00104029947801687 * var_x153);
        IJth(rJacobian, 37, 37) = -var_x470;
        IJth(rJacobian, 38, 37) = -1.0 * var_x483;
        IJth(rJacobian, 40, 37) = 0.23999999999999996 * var_x493;
        IJth(rJacobian, 45, 37) = 2.175954783543569e-6 * var_x153;
        IJth(rJacobian, 37, 38) = -0.0123 * var_x468 * var_x474 / pow(var_chaste_interface__Ca__Ca_JSR, 2) - 17.976374980131517 * var_x457 * var_x458 * var_x465 * var_x475 / pow(var_x459, 2);
        IJth(rJacobian, 38, 38) = -var_x484 + 0.25 * pow(var_x481, (-3.0)) * (var_x473 + 0.040000000000000001 * var_chaste_interface__Ca__Ca_NSR - 0.040000000000000001 * var_chaste_interface__Ca__Ca_JSR) / pow((0.125 + var_x482), 2);
        IJth(rJacobian, 39, 38) = 0.0034782608695652171;
        IJth(rJacobian, 1, 39) = 2.3746312684365782e-5 * var_x186;
        IJth(rJacobian, 38, 39) = var_x484;
        ...
        IJth(rJacobian, 1, 40) = var_x187 * (0.014749262536873156 - var_x205 * var_x214 - var_x212 * var_x213);
        IJth(rJacobian, 37, 40) = -2.667471823152336e-9 * var_x478 * var_x479 - 4.6767910530856466e-10 * var_x476 * var_x478;
        IJth(rJacobian, 39, 40) = var_x212 * var_x487 + var_x214 * var_x486;
        IJth(rJacobian, 40, 40) = var_x494 * (-5.5 + 6.53644343986048e-11 * var_x495 - 4.8146657448698097e-10 * var_x169 - 5165.5682301054221 * var_x154) + 1.0 * (0.019557600000000001 * pow(var_x490, (-3.0)) + 8.1780000000000006e-5 * pow(var_x491, (-3.0))) * (0.5 * var_chaste_interface__Ca__Ca_ss_CaL + 5.0 * var_chaste_interface__Ca__Ca_i + 0.23999999999999996 * var_chaste_interface__Irel__Irel - 5.5 * var_chaste_interface__Ca__Ca_ss_sr + var_x121 * var_x488) / pow(var_x492, 2);
        IJth(rJacobian, 41, 40) = 5.0 * var_x501;
        IJth(rJacobian, 43, 40) = 1.444399723460943e-9 * var_x169 + 15496.704690316266 * var_x154 - 1.9609330319581443e-10 * var_x495;
        IJth(rJacobian, 47, 40) = 3.7500000000000009e-6 * var_x196 * var_x208 + 1.8750000000000006e-7 * var_x207 * pow(var_x189, 2) / pow(var_x190, 3);
        IJth(rJacobian, 0, 41) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x157);
        IJth(rJacobian, 19, 41) = -var_x335;
        IJth(rJacobian, 20, 41) = -var_x338;
        IJth(rJacobian, 21, 41) = var_x335 + var_x358 - var_x360;
        IJth(rJacobian, 22, 41) = var_x338 + var_x361 - var_x362;
        IJth(rJacobian, 23, 41) = -var_x378;
        IJth(rJacobian, 24, 41) = -var_x379;
        IJth(rJacobian, 25, 41) = var_x360 + var_x378 - var_x358;
        IJth(rJacobian, 26, 41) = var_x362 + var_x379 - var_x361;
        IJth(rJacobian, 37, 41) = -var_x157 * var_x471;
        IJth(rJacobian, 40, 41) = 0.5 * var_x493;
        IJth(rJacobian, 41, 41) = var_x502 * (-5.0 - 0.023500311662270547 * var_x122) + 1.0 * (0.019557600000000001 * pow(var_x498, (-3.0)) + 8.1780000000000006e-5 * pow(var_x499, (-3.0))) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x497 * var_chaste_interface__membrane__Vm) / pow(var_x500, 2);
        IJth(rJacobian, 0, 42) = mSetVoltageDerivativeToZero ? 0.0 : (1.3365608910938007e-12 * var_x164 + 0.48962701918393153 * var_x158 - 3.2869565217391301 * var_x165 - 1.1558883089076335e-5 * var_x159 - 19.440000000000001 * var_x167 - 0.17362660254749346 * var_x160 - 242.40944894130817 * var_x161);
        IJth(rJacobian, 1, 42) = var_x187 * (0.0011994662935305039 * var_x167 - 8.2467064718009699e-17 * var_x164);
        IJth(rJacobian, 42, 42) = -0.14749262536873156 + var_x511 + 2.4740119415402903e-16 * var_x164 - 0.00060842493150098007 * var_x165 - 7.1319396379664668e-10 * var_x159 - 1.0712924764194234e-5 * var_x160 - 0.0035983988805915112 * var_x167 - 0.014956891113086564 * var_x161;
        IJth(rJacobian, 43, 42) = 5.0;
        IJth(rJacobian, 44, 42) = var_x511;
        IJth(rJacobian, 46, 42) = 0.00040561662100065338 * var_x165 - 3.0210447835027739e-5 * var_x525;
        IJth(rJacobian, 0, 43) = mSetVoltageDerivativeToZero ? 0.0 : (1.3365608910938007e-12 * var_x170 - 4.8600000000000003 * var_x171);
        IJth(rJacobian, 40, 43) = var_x494 * (0.010165476837671021 * var_x171 - 2.7956334939405284e-15 * var_x170);
        IJth(rJacobian, 42, 43) = 0.14749262536873156;
        IJth(rJacobian, 43, 43) = -5.0 + 8.3869004818215861e-15 * var_x170 - 0.030496430513013061 * var_x171;
        IJth(rJacobian, 0, 44) = mSetVoltageDerivativeToZero ? 0.0 : (0.006010151626644005 * var_x172 - 0.0032509358688027189 * var_x173);
        IJth(rJacobian, 42, 44) = var_x512;
        IJth(rJacobian, 44, 44) = -0.14749262536873156 + var_x512 + var_x516 - 3.7083201106826194e-7 * var_x172;
        IJth(rJacobian, 45, 44) = 5.0 + 6.7998586985736529e-6 * var_x173;
        IJth(rJacobian, 46, 44) = var_x516;
        IJth(rJacobian, 44, 45) = 0.14749262536873156;
        IJth(rJacobian, 45, 45) = -5.0;
        IJth(rJacobian, 0, 46) = mSetVoltageDerivativeToZero ? 0.0 : (26.711785007306688 * var_x158 + 3.2490879693637487 * var_x179 - 13.289113041135076 * var_x180 - 0.073724526620166458 * var_x174 - 0.37007041184822831 * var_x175 - 13.623010353726411 * var_x176 - var_x107 * var_x178);
        IJth(rJacobian, 44, 46) = var_x517;
        IJth(rJacobian, 46, 46) = var_x517 + 0.00020047178518350236 * var_x179 - 4.5488726691040136e-6 * var_x174 - 0.00081995078002871258 * var_x180 - 0.00084055255842139371 * var_x176 - 2.2833692656630735e-5 * var_x175 - 0.0016481422714144977 * var_x525 - var_x178 * var_x523;
        IJth(rJacobian, 1, 47) = var_x187 * (-var_x205 * var_x219 - var_x213 * var_x218);
        IJth(rJacobian, 37, 47) = 6.2357214041141949e-6 * var_x476 * var_x480 + 3.5566290975364481e-5 * var_x479 * var_x480;
        IJth(rJacobian, 39, 47) = var_x218 * var_x487 + var_x219 * var_x486;
        IJth(rJacobian, 47, 47) = -0.00068000000000000005 - var_x196 * var_x526 + var_x189 * var_x215 * var_x526;
    }
