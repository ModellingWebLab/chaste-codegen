...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellluo_rudy_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x211 = var_x200 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V);
        ...
        const double var_x223 = 7.2663761489674998e-10 * var_x67;
        const double var_x224 = 5.4497821117256254e-10 * var_x71;
        const double var_x225 = 7.4594056952013249e-8 * var_x83;
        const double var_x226 = 1.0025441254350579e-16 * var_x110;
        ...
        const double var_x231 = 2.1089397546044193e-6 * var_x136;
        const double var_x232 = 2.2330835435855923e-5 * var_x63;
        const double var_x233 = 2.1328374802575643e-8 * var_x85;
        ...
        IJth(rJacobian, 6, 0) = var_x199 * var_x210 * var_x211 + var_x199 * (0.02 + var_x200) * (var_x203 - var_x206) + var_x207 * (var_x206 - var_x203) * var_chaste_interface__L_type_Ca_channel_f_gate__f - var_x211 * var_x212 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        IJth(rJacobian, 8, 0) = -4.2821610031797325e-8 + 2.8027450860303217e-9 * var_x98 - 2.1020588145227411e-9 * var_x101 - 1.6784732779346808e-8 * var_x28 - 4.0992760021272483e-11 * var_x32 - 0.00010695499267886472 * var_x40 + var_x223 * var_x66 - var_x221 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x222 * var_x45 - var_x224 * var_x73 - var_x225 * var_x81;
        IJth(rJacobian, 9, 0) = 7.1303328452576475e-5 * var_x40 + 5.5410707832102833e-6 * var_x60 + 2.668013086093291e-7 * var_x57 + 8.0137748385755867e-10 * var_x99 - 5.5576983232758224e-7 * var_x2 - 9.2938099051435146e-8 * var_x54 - 8.5643220063594646e-6 * var_x21 - 6.0103311289316898e-10 * var_x103 - 2.3233001187464504e-5 * var_x16 + var_x223 * var_x69 - var_x222 * var_x52 - var_x224 * var_x70 - var_x232 * var_x62 - var_x233 * var_x81;
        ...
        IJth(rJacobian, 8, 1) = 0.046057306746527645 * var_x109 + 5.3707721005449532e-14 * var_x118 - var_x226 * var_x66;
        IJth(rJacobian, 9, 1) = 1.5356429857854459e-14 * var_x116 - var_x226 * var_x69;
        ...
        IJth(rJacobian, 8, 3) = -var_x119 * var_x221;
        ...
        IJth(rJacobian, 8, 5) = -var_x124 * var_x225;
        IJth(rJacobian, 9, 5) = -var_x124 * var_x233;
        ...
        IJth(rJacobian, 6, 6) = var_x207 * var_x210 + var_x207 * var_x212;
        IJth(rJacobian, 8, 6) = -var_x126 * var_x225;
        IJth(rJacobian, 9, 6) = -var_x126 * var_x233;
        ...
        IJth(rJacobian, 8, 8) = var_x230 - 5.594554271400994e-8 * var_x100 - 5.073320759877697e-6 * var_x135 - 1.139681818874567e-6 * var_x33 - 9.0637557008472766e-8 * var_x128 - 0.012932559646803597 * var_x134 - var_x132 * var_x227;
        IJth(rJacobian, 9, 8) = var_x234 + 3.3822138399184648e-6 * var_x135 - 3.3283369498031096e-5 * var_x129 - var_x231 * var_x70;
        ...
        IJth(rJacobian, 8, 9) = var_x230 - var_x231 * var_x73;
        IJth(rJacobian, 9, 9) = var_x234 + 0.00014747361493490206 * var_x148 - 1.5996281101931733e-8 * var_x100 - 0.001815786661103715 * var_x129 - 0.00061833800811279696 * var_x144 - 1.4791615096031613e-5 * var_x143 - var_x145 * var_x227 - var_x147 * var_x232;
