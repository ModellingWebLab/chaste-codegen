...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellluo_rudy_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x20 = pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 2.0);
        ...
        const double var_x27 = var_x26 * pow(var_chaste_interface__ionic_concentrations__Nai, 3.0);
        ...
        const double var_x46 = 1 / var_chaste_interface__ionic_concentrations__Cai_converted;
        const double var_x47 = pow(var_x46, 3.0);
        const double var_x48 = 1.0 + 1.7279999999999996e-9 * var_x47;
        ...
        const double var_x53 = 0.00063678763853082152 * var_x52;
        const double var_x54 = -4.0500000000000007 + var_x44 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x55 = -26.614641953637257 * var_x4 + var_chaste_interface__membrane__V;
        ...
        const double var_x59 = var_x17 * var_x20 * var_x58 / pow(var_x18, 2);
        const double var_x60 = var_x5 / pow(var_x6, 2);
        const double var_x61 = var_x15 * var_x55;
        const double var_x62 = var_x60 * var_x61;
        const double var_x63 = var_x13 * var_x8 / pow(var_x9, 2);
        const double var_x64 = 0.24326999999999999 * var_x60 - 0.51429999999999998 * var_x63 - var_x10 * (0.061749999999999999 * var_x12 + 0.039456396800000001 * var_x11);
        const double var_x65 = var_x55 * var_x7 / pow((var_x7 + 0.98039215686274506 * var_x14), 2);
        const double var_x66 = 0.73529411764705876 * var_x65;
        const double var_x67 = -26.614641953637257 * var_x42 + var_chaste_interface__membrane__V;
        const double var_x68 = var_x45 * var_x67;
        const double var_x69 = var_x43 * var_x49 / pow(var_x50, 2);
        const double var_x70 = 2.3926214736989757e-5 * var_x69;
        const double var_x71 = var_x54 * var_x67;
        const double var_x72 = var_x43 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x73 = var_x52 * var_x67;
        const double var_x74 = 1.7944661052742317e-5 * var_x73;
        const double var_x75 = var_x43 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x76 = exp(var_x37);
        const double var_x77 = -1.0 + var_x76;
        const double var_x78 = 1 / var_x77;
        const double var_x79 = pow(var_chaste_interface__ionic_concentrations__Cai_converted, 2.0);
        const double var_x80 = 1 / (1.0 + 2777777.7777777785 * var_x79);
        const double var_x81 = var_x80 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x82 = var_x81 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x83 = var_x78 * var_x82;
        const double var_x84 = 0.75 * var_x76;
        const double var_x85 = -105.0 + var_x84 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x86 = 0.0024561808914760263 * var_x85;
        const double var_x87 = -4.0500000000000007 + var_x84 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x88 = 0.00070228579563684902 * var_x87;
        const double var_x89 = exp(0.075146605522028176 * var_chaste_interface__membrane__V);
        const double var_x90 = -1.0 + var_x89;
        const double var_x91 = 1 / var_x90;
        const double var_x92 = var_x89 * var_chaste_interface__ionic_concentrations__Cai_converted;
        const double var_x93 = -0.6120000000000001 + 1.0 * var_x92;
        const double var_x94 = var_x91 * var_x93;
        const double var_x95 = 7.8597788527232835 * var_x94;
        const double var_x96 = var_x82 * var_chaste_interface__membrane__V;
        const double var_x97 = var_x89 * var_x96;
        const double var_x98 = var_x93 * var_x97 / pow(var_x90, 2);
        const double var_x99 = var_x76 * var_x96 / pow(var_x77, 2);
        const double var_x100 = var_x85 * var_x99;
        const double var_x101 = var_x87 * var_x99;
        const double var_x102 = var_x76 * var_x83 * var_chaste_interface__membrane__V;
        const double var_x103 = var_x102 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x104 = var_x91 * var_x92 * var_x96;
        const double var_x105 = var_x102 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x106 = 1.0 * var_chaste_interface__ionic_concentrations__Cai_converted;
        const double var_x107 = 0.00050000000000000001 + var_x106;
        ...
        const double var_x110 = var_x22 * var_x24;
        const double var_x111 = var_x46 * var_x47 * var_x51 / pow(var_x48, 2);
        const double var_x112 = 3.301107118143778e-12 * var_x111;
        const double var_x113 = var_x91 * var_x97;
        const double var_x114 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__membrane__V;
        const double var_x115 = var_x114 * pow(var_chaste_interface__ionic_concentrations__Cai_converted, 1.0) * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow((3.5999999999999994e-7 + var_x79), 2);
        const double var_x116 = var_x115 * var_x78;
        const double var_x117 = var_x116 * var_x85;
        const double var_x118 = var_x116 * var_x87;
        const double var_x119 = var_x115 * var_x94;
        const double var_x120 = -26.614641953637257 * log(140.0 * var_x33) + var_chaste_interface__membrane__V;
        const double var_x121 = var_x120 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x122 = var_x121 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x123 = var_x121 * var_x29;
        const double var_x124 = var_x81 * var_chaste_interface__membrane__V;
        const double var_x125 = var_x124 * var_x78;
        const double var_x126 = var_x114 * var_x80;
        const double var_x127 = var_x126 * var_x78;
        const double var_x128 = var_x19 * var_x58 * pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 1.0);
        const double var_x129 = var_x24 * var_x26 * pow(var_chaste_interface__ionic_concentrations__Nai, 2.0);
        const double var_x130 = var_x21 * (0.12553036579548593 * var_chaste_interface__ionic_concentrations__Ki + 0.002300971605031257 * var_chaste_interface__ionic_concentrations__Nai) / pow(var_x57, 2);
        const double var_x131 = (0.0068775790921595595 * var_chaste_interface__ionic_concentrations__Ki + 0.0068775790921595595 * var_chaste_interface__ionic_concentrations__Nai) / pow(var_x41, 2);
        const double var_x132 = 109.05 * var_x131;
        const double var_x133 = var_x44 + var_x132 * var_x75;
        const double var_x134 = var_x53 * var_x67;
        const double var_x135 = var_x30 * var_x33 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x136 = var_x33 * var_x34 / (var_x39 * pow((0.031622776601683791 + var_x34), 2));
        const double var_x137 = var_x131 * var_x73;
        const double var_x138 = 0.069441691981786097 * var_x137;
        const double var_x139 = var_x131 * var_x52;
        const double var_x140 = 2.4642210250000001 * var_x139;
        const double var_x141 = var_x131 * var_x69;
        const double var_x142 = 0.092588922642381458 * var_x141;
        const double var_x143 = var_x142 * var_x68 + var_x142 * var_x71 - var_x140 * var_x45 - var_x140 * var_x54;
        const double var_x144 = var_x2 * var_x3;
        const double var_x145 = var_x16 * var_x3;
        const double var_x146 = var_x44 + var_x132 * var_x72;
        const double var_x147 = var_x3 * var_x60;
        const double var_x148 = 6.4745439480613349 * var_x147 - var_x10 * (1.0501178736126389 * var_x11 * var_x3 + 1.6434541406371006 * var_x12 * var_x3) - 13.687910356755641 * var_x3 * var_x63;
        const double var_x149 = var_x147 * var_x61;
        const double var_x150 = 0.00011935049112322121 * var_x94;
        const double var_x151 = 0.00092000000000000003 + var_x106;
        const double var_x152 = 1 / var_x151;
        const double var_x153 = var_chaste_interface__ionic_concentrations__Cai_converted / pow(var_x151, 2);
        const double var_x154 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x155 = -0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x156 = exp(-4.7130000000000001 + var_x155);
        const double var_x157 = 1.0 - var_x156;
        const double var_x158 = 0.32000000000000001 / var_x157;
        const double var_x159 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
        const double var_x160 = 47.130000000000003 + var_chaste_interface__membrane__V;
        const double var_x161 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
        const double var_x162 = exp(0.34999999999999998 * var_chaste_interface__membrane__V);
        const double var_x163 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x164 = var_chaste_interface__membrane__V < -40.0;
        ...
        const double var_x167 = 1.0 - var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x173 = -127140.0 * var_x171 - 3.4740000000000003e-5 * var_x172;
        const double var_x174 = var_x170 * var_x173;
        const double var_x175 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x176 = 1.0 + var_x175;
        const double var_x177 = exp(-0.01052 * var_chaste_interface__membrane__V);
        const double var_x178 = var_x177 / var_x176;
        const double var_x179 = 37.780000000000001 + var_chaste_interface__membrane__V;
        const double var_x180 = var_x167 * var_x179;
        const double var_x181 = exp(-3.2000000000000002 + var_x155);
        const double var_x182 = 1.0 + var_x181;
        const double var_x183 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V);
        const double var_x184 = var_x183 / var_x182;
        const double var_x185 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x189 = 0.035000000000000003 * var_x188;
        const double var_x190 = 1.0 + var_x186;
        const double var_x191 = 1 / var_x190;
        const double var_x192 = 1.0 - 1.0 * var_x191;
        const double var_x193 = var_x190 * var_x192;
        const double var_x194 = var_x193 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x195 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x196 = 0.005608974358974359 * var_x186 * var_x195;
        const double var_x197 = var_x196 / pow(var_x187, 2);
        const double var_x198 = var_x188 * var_x196 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x199 = var_x189 * var_x195;
        const double var_x200 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x201 = 1 + 0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x202 = exp(-0.113569 * pow(var_x201, 2.0));
        const double var_x203 = 0.019699999999999999 * var_x202;
        ...
        const double var_x213 = 1.0 - var_x211 - var_x212;
        const double var_x214 = 0.00044746186 * var_x202 * pow(var_x201, 1.0);
        const double var_x215 = var_x211 + var_x212;
        ...
        const double var_x224 = 0.00048591897908422494 * var_x30;
        const double var_x225 = 1.9339199950521953e-8 * var_x52;
        const double var_x226 = 7.2663761489674998e-10 * var_x69;
        const double var_x227 = 5.4497821117256254e-10 * var_x73;
        const double var_x228 = 7.4594056952013249e-8 * var_x85;
        const double var_x229 = 1.0025441254350579e-16 * var_x111;
        const double var_x230 = var_x225 * var_x67;
        const double var_x231 = 7.4838235294117636e-5 * var_x139;
        const double var_x232 = 2.8119196728058921e-6 * var_x141;
        const double var_x233 = var_x232 * var_x68 - var_x231 * var_x45;
        const double var_x234 = 2.1089397546044193e-6 * var_x137;
        const double var_x235 = 2.2330835435855923e-5 * var_x65;
        const double var_x236 = 2.1328374802575643e-8 * var_x87;
        const double var_x237 = var_x232 * var_x71 - var_x231 * var_x54;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0044260000000000002 + 0.0087850467289719621 * var_x59 + 0.59063570093597573 * var_x98 + 0.18245249999999999 * var_x62 + 9.2286828271246203e-5 * var_x100 + 2.6387196824222993e-5 * var_x101 - 4.4992696901614849e-7 * var_x32 - 1.1739130434782608 * var_x40 - 0.76500000000000001 * var_x16 - 0.28199999999999997 * var_x21 - 0.0183 * var_x2 - 0.00018422531054846207 * var_x28 - 6.9215121203434652e-5 * var_x103 - 0.59063570093597573 * var_x104 - 1.9790397618167245e-5 * var_x105 - 0.003060200668896321 * var_x56 + var_x68 * var_x70 + var_x70 * var_x71 - var_x31 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x45 * var_x53 - var_x53 * var_x54 - var_x64 * var_x66 - var_x72 * var_x74 - var_x74 * var_x75 - var_x82 * var_x95 - var_x83 * var_x86 - var_x83 * var_x88);
        IJth(rJacobian, 1, 0) = -4.5797863778688198e-8 + 2.7974554632244679e-9 * var_x28 + 6.8321266702120803e-12 * var_x32 + 8.9687842752970284e-6 * var_x98 - 8.9687842752970284e-6 * var_x104 - var_x150 * var_x82;
        IJth(rJacobian, 2, 0) = var_x154 * var_x158 + 0.0072727272727272727 * var_x159 * var_chaste_interface__fast_sodium_current_m_gate__m - 0.032000000000000001 * var_x154 * var_x156 * var_x160 / pow(var_x157, 2);
        IJth(rJacobian, 3, 0) = ((var_x164) ? ((-0.28123999999999999 * var_x161 - 108500.0 * var_x162) * var_chaste_interface__fast_sodium_current_h_gate__h - 0.14705882352941177 * var_x163 * (0.13500000000000001 - 0.13500000000000001 * var_chaste_interface__fast_sodium_current_h_gate__h)) : (-0.693000693000693 * var_x165 * var_chaste_interface__fast_sodium_current_h_gate__h / pow(var_x166, 2)));
        IJth(rJacobian, 4, 0) = ((var_x164) ? (var_x167 * var_x174 + 0.001275024 * var_x178 * var_chaste_interface__fast_sodium_current_j_gate__j + var_x170 * var_x180 * (1.5254334000000001e-6 * var_x172 - 31073.016 * var_x171) - 0.311 * var_x168 * var_x173 * var_x180 / pow(var_x169, 2) - 0.016701360000000002 * var_x175 * var_x177 * var_chaste_interface__fast_sodium_current_j_gate__j / pow(var_x176, 2)) : (7.6049999999999996e-8 * var_x184 * var_chaste_interface__fast_sodium_current_j_gate__j - 0.029999999999999999 * var_x181 * var_x183 * var_chaste_interface__fast_sodium_current_j_gate__j / pow(var_x182, 2)));
        IJth(rJacobian, 5, 0) = var_x185 * var_x189 + var_x191 * var_x198 + var_x192 * var_x198 + var_x194 * var_x197 - var_x185 * var_x197 - var_x189 * var_x194;
        IJth(rJacobian, 6, 0) = var_x200 * (0.02 + var_x203) * (var_x206 - var_x209) + var_x210 * (var_x209 - var_x206) * var_chaste_interface__L_type_Ca_channel_f_gate__f + var_x213 * var_x214 * var_chaste_interface__L_type_Ca_channel_f_gate__f - var_x200 * var_x214 * var_x215;
        ...
        IJth(rJacobian, 8, 0) = -4.2821610031797325e-8 + 2.8027450860303217e-9 * var_x100 - 2.1020588145227411e-9 * var_x103 - 1.6784732779346808e-8 * var_x28 - 4.0992760021272483e-11 * var_x32 - 0.00010695499267886472 * var_x40 + var_x226 * var_x68 - var_x224 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x225 * var_x45 - var_x227 * var_x75 - var_x228 * var_x83;
        IJth(rJacobian, 9, 0) = 7.1303328452576475e-5 * var_x40 + 5.5410707832102833e-6 * var_x62 + 2.668013086093291e-7 * var_x59 + 8.0137748385755867e-10 * var_x101 - 5.5576983232758224e-7 * var_x2 - 9.2938099051435146e-8 * var_x56 - 8.5643220063594646e-6 * var_x21 - 6.0103311289316898e-10 * var_x105 - 2.3233001187464504e-5 * var_x16 + var_x226 * var_x71 - var_x225 * var_x54 - var_x227 * var_x72 - var_x235 * var_x64 - var_x236 * var_x83;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (1.7684502418627384e-9 * var_x117 + 5.0564577285853114e-10 * var_x118 + 1.1499999999999999 * var_x109 + 5.6590407739607631e-6 * var_x119 + 505.51425214497993 * var_x110 - 1.1499999999999999 * var_x108 - 0.040134880066084982 * var_x46 - 7.8597788527232835 * var_x113 - var_x112 * var_x68 - var_x112 * var_x71);
        IJth(rJacobian, 1, 1) = 1.7462713310839333e-5 * var_x109 + 8.5932353608719255e-11 * var_x119 + 0.00040588235294117644 * var_x153 - 0.0076762177910879408 * var_x110 - 0.00011935049112322121 * var_x113 - 6.0944687335561951e-7 * var_x46 - 1.7462713310839333e-5 * var_x108 - 0.00040588235294117644 * var_x152;
        IJth(rJacobian, 8, 1) = 5.3707721005449532e-14 * var_x117 + 0.046057306746527645 * var_x110 - var_x229 * var_x68;
        IJth(rJacobian, 9, 1) = 1.5356429857854459e-14 * var_x118 - var_x229 * var_x71;
        IJth(rJacobian, 11, 1) = 0.0050000000000000001 * var_x152 - 0.0050000000000000001 * var_x153;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-48.0 * var_x122);
        IJth(rJacobian, 2, 2) = -0.080000000000000002 * var_x159 - var_x158 * var_x160;
        IJth(rJacobian, 8, 2) = -0.0014577569372526747 * var_x122;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x120 * var_x31);
        IJth(rJacobian, 3, 3) = ((var_x164) ? (-310000.0 * var_x162 - 0.13500000000000001 * var_x163 - 3.5600000000000001 * var_x161) : (-7.6923076923076916 / var_x166));
        IJth(rJacobian, 8, 3) = -var_x120 * var_x224;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-16.0 * var_x123);
        IJth(rJacobian, 4, 4) = ((var_x164) ? (-0.1212 * var_x178 - var_x174 * var_x179) : (-0.29999999999999999 * var_x184));
        IJth(rJacobian, 8, 4) = -0.00048591897908422494 * var_x123;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x124 * var_x95 - var_x125 * var_x86 - var_x125 * var_x88);
        IJth(rJacobian, 1, 5) = -var_x124 * var_x150;
        IJth(rJacobian, 5, 5) = -var_x199 - var_x193 * var_x199;
        IJth(rJacobian, 8, 5) = -var_x125 * var_x228;
        IJth(rJacobian, 9, 5) = -var_x125 * var_x236;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * var_x95 - var_x127 * var_x86 - var_x127 * var_x88);
        IJth(rJacobian, 1, 6) = -var_x126 * var_x150;
        IJth(rJacobian, 6, 6) = var_x210 * var_x213 + var_x210 * var_x215;
        IJth(rJacobian, 8, 6) = -var_x127 * var_x228;
        IJth(rJacobian, 9, 6) = -var_x127 * var_x236;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.56399999999999995 * var_x128);
        IJth(rJacobian, 7, 7) = -var_x219 * var_x223 - var_x222 * var_x223;
        IJth(rJacobian, 9, 7) = -1.7128644012718929e-5 * var_x128;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x143 - 0.00099481667696169518 * var_x129 - 1.0959314924725194 * var_x130 - 0.03752664515462853 * var_x33 - 0.0018421356686070195 * var_x102 - 425.83427125819611 * var_x135 - 0.055683584885573637 * var_x136 - var_x133 * var_x134 - var_x138 * var_x72);
        IJth(rJacobian, 1, 8) = 1.5106259501412128e-8 * var_x129;
        IJth(rJacobian, 8, 8) = var_x233 - 5.594554271400994e-8 * var_x102 - 5.073320759877697e-6 * var_x136 - 1.139681818874567e-6 * var_x33 - 9.0637557008472766e-8 * var_x129 - 0.012932559646803597 * var_x135 - var_x133 * var_x230;
        IJth(rJacobian, 9, 8) = var_x237 + 3.3822138399184648e-6 * var_x136 - 3.3283369498031096e-5 * var_x130 - var_x234 * var_x72;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x143 + 4.8559079610460012 * var_x149 - 0.00052671434672763679 * var_x102 - 59.78895212616036 * var_x130 - 20.360201094532499 * var_x145 - 0.48704794775156179 * var_x144 - var_x134 * var_x146 - var_x138 * var_x75 - var_x148 * var_x66);
        IJth(rJacobian, 8, 9) = var_x233 - var_x234 * var_x75;
        IJth(rJacobian, 9, 9) = var_x237 + 0.00014747361493490206 * var_x149 - 1.5996281101931733e-8 * var_x102 - 0.001815786661103715 * var_x130 - 0.00061833800811279696 * var_x145 - 1.4791615096031613e-5 * var_x144 - var_x146 * var_x230 - var_x148 * var_x235;
