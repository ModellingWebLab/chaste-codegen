...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x11 = 0.081839999999999996 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        const double var_x19 = 0.091800000000000007 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        const double var_x27 = var_x22 * var_x4 / pow(var_x5, 2);
        const double var_x28 = var_x22 * var_x7 / pow(var_x8, 2);
        const double var_x29 = 2.0 * var_x16 - 6860000.0 * var_x17;
        ...
        const double var_x35 = var_x31 * (0.0013214163460429152 * var_x32 + 0.00046605194074318115 * var_x33) * var_chaste_interface__sodium_dynamics__Na_i / pow(var_x34, 2);
        ...
        const double var_x54 = var_x22 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        const double var_x55 = 1 / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i);
        ...
        const double var_x65 = var_x22 * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        const double var_x70 = var_x10 * var_x55;
        const double var_x71 = var_x67 * var_chaste_interface__sodium_dynamics__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        ...
        const double var_x78 = var_x20 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x79 = var_x20 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        const double var_x92 = 0.040000000000000001 * var_chaste_interface__membrane__V;
        const double var_x93 = exp(-2.8999999999999999 - var_x92);
        const double var_x94 = 0.00025000000000000001 * var_x91;
        const double var_x95 = 0.00025000000000000001 * var_x93;
        const double var_x96 = -var_x0;
        ...
        const double var_x109 = exp(-3.0 + var_x105);
        ...
        const double var_x112 = 0.014880952380952382 / var_x111 - 0.014880952380952382 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x113 = 1.0 + var_x109;
        const double var_x114 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        ...
        const double var_x123 = 1 / (80.0 + 1400.0 * var_x122);
        const double var_x124 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x125 = exp(7.0 + var_x124);
        const double var_x126 = 1.0 + var_x125;
        const double var_x127 = 1 / var_x126;
        const double var_x128 = exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V);
        const double var_x129 = 1.0 + var_x128;
        const double var_x130 = 1 / var_x129;
        const double var_x131 = 1 / (0.10000000000000001 * var_x127 + 0.10000000000000001 * var_x130);
        const double var_x132 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x133 = 1.0 + var_x132;
        const double var_x134 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1.0 * pow(var_x133, (-2.0));
        const double var_x135 = exp(-12.0 - var_x124);
        const double var_x136 = 1.0 + var_x135;
        const double var_x137 = var_x131 * var_x136;
        const double var_x138 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V);
        const double var_x139 = 1.0 + var_x138;
        const double var_x140 = 1.0 * pow(var_x139, (-2.0));
        const double var_x141 = var_x140 - var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x142 = exp(0.34849999999999998 * var_chaste_interface__membrane__V);
        const double var_x143 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
        const double var_x144 = exp(-11.764705882352942 - var_x88);
        const double var_x145 = 310000.0 * var_x142;
        const double var_x146 = 2.7000000000000002 * var_x143;
        const double var_x147 = 0.057000000000000002 * var_x144;
        const double var_x148 = var_x138 * pow(var_x139, (-3.0));
        const double var_x149 = 0.26917900403768508 * var_x148;
        const double var_x150 = var_chaste_interface__membrane__V < -40.0;
        const double var_x151 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x152 = 1 / (0.16883116883116883 + 0.16883116883116883 * var_x151);
        const double var_x153 = var_x140 - var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x154 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
        const double var_x155 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x156 = -25428.0 * var_x154 - 6.9480000000000002e-6 * var_x155;
        const double var_x157 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
        const double var_x158 = 1.0 + var_x157;
        const double var_x159 = 1.0 / var_x158;
        const double var_x160 = var_x156 * var_x159;
        const double var_x161 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x162 = 1.0 + var_x161;
        const double var_x163 = exp(-0.01052 * var_chaste_interface__membrane__V);
        const double var_x164 = var_x163 / var_x162;
        const double var_x165 = 37.780000000000001 + var_chaste_interface__membrane__V;
        const double var_x166 = 0.024240000000000001 * var_x164;
        const double var_x167 = var_x160 * var_x165;
        const double var_x168 = exp(-3.2000000000000002 + var_x96);
        const double var_x169 = 1.0 + var_x168;
        const double var_x170 = exp(0.057000000000000002 * var_chaste_interface__membrane__V);
        const double var_x171 = var_x170 / var_x169;
        const double var_x172 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x173 = 1.0 + var_x172;
        const double var_x174 = exp(2.5 + var_x106);
        const double var_x175 = 1.0 + var_x174;
        const double var_x176 = 1 / var_x175;
        const double var_x177 = exp(1.0 + var_x124);
        ...
        const double var_x186 = 1 / (1.0 * var_x176 + 1.3999999999999999 * var_x185);
        const double var_x187 = exp(3.0 + var_x0);
        ...
        const double var_x193 = 1 + 0.037037037037037035 * var_chaste_interface__membrane__V;
        const double var_x194 = pow(var_x193, 2.0);
        const double var_x195 = exp(-3.2400000000000002 * var_x194);
        const double var_x196 = exp(2.8571428571428572 + var_x99);
        const double var_x197 = 1.0 + var_x196;
        const double var_x198 = var_x187 / pow(var_x188, 2);
        const double var_x199 = pow(var_x193, 1.0);
        const double var_x200 = 1 / (20.0 + 200.0 * var_x192 + 180.0 * var_x189 + 1102.5 * var_x195);
        const double var_x201 = exp(2.5 + var_x96);
        const double var_x202 = 1.0 + var_x201;
        const double var_x203 = 1 / var_x202;
        const double var_x204 = exp(-3.0375000000000001 * var_x194);
        const double var_x205 = exp(5.0 + var_x99);
        const double var_x206 = 1.0 + var_x205;
        const double var_x207 = 1 / (80.0 * var_x189 + 31.0 * var_x203 + 562.0 * var_x204);
        const double var_x208 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2.0);
        const double var_x209 = 1 / (1.0 + 399.99999999999994 * var_x208);
        const double var_x210 = 1 / (2.0 + 80.0 * var_x209);
        const double var_x211 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 1.0);
        const double var_x212 = var_x211 / pow((0.0025000000000000005 + var_x208), 2);
        const double var_x213 = exp(-8.0 + var_x124);
        const double var_x214 = 1.0 + var_x213;
        const double var_x215 = 1 / var_x214;
        const double var_x216 = 1 + var_x92;
        const double var_x217 = exp(-1.953125 * pow(var_x216, 2.0));
        const double var_x218 = exp(2.0769230769230771 + var_x180);
        const double var_x219 = 1.0 + var_x218;
        const double var_x220 = 1 / (42.0 + 5.0 * var_x215 + 85.0 * var_x217);
        const double var_x221 = exp(1.5384615384615385 + var_x181);
        ...
        const double var_x225 = 1 / (7.2999999999999998 + 10.449999999999999 * var_x224);
        ...
        const double var_x228 = 1 / (1.0 + 3.0 * var_x227);
        const double var_x229 = 1.0 * var_x228;
        const double var_x230 = 1 / var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x231 = pow(var_x230, 2.0);
        const double var_x232 = 1 / (1.0 + 2.25 * var_x231);
        const double var_x233 = 1 / (2.5 - 1.5 * var_x232);
        const double var_x234 = var_x208 * var_x233;
        ...
        const double var_x240 = 1 - 0.59999999999999998 * var_x232;
        const double var_x241 = var_chaste_interface__calcium_dynamics__R_prime / pow((0.40000000000000002 + var_x234), 2);
        const double var_x242 = var_x230 * var_x231 / pow((0.44444444444444442 + var_x231), 2);
        const double var_x243 = var_x239 * var_x241 * var_x242 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4.0) / pow(var_x240, 3);
        const double var_x244 = var_x239 / pow(var_x240, 2);
        const double var_x245 = var_x208 * var_x236 * var_x242 * var_x244;
        const double var_x246 = var_x241 * var_x244 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3.0);
        const double var_x247 = var_x211 * var_x233 * var_x236 * var_x239;
        const double var_x248 = var_x234 * var_x235 * var_x239;
        ...
        const double var_x252 = 1.0 + 0.0001 * pow(var_x251, (-2.0));
        const double var_x253 = 1 / var_x252;
        const double var_x254 = 1.0 * var_x253;
        const double var_x255 = var_x249 * var_x253;
        const double var_x256 = var_x255 * var_x61;
        const double var_x257 = var_x255 * var_x63;
        const double var_x258 = 0.30611192392099479 * var_x237;
        const double var_x259 = -0.11249999999999999 + 0.067500000000000004 * var_x232;
        const double var_x260 = 0.015262253697454368 * var_x25;
        const double var_x261 = 1.0730088665360983e-5 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x262 = 9.5659091108185493e-6 * var_chaste_interface__transient_outward_current_r_gate__r;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00088199999999999997 + 0.0065000000000000006 * var_x23 + 0.0430491257510425 * var_x45 - 2.2983750000000001 * var_x35 - 0.065000000000000002 * var_x3 - 8.6662202299424464e-5 * var_x18 - 0.037999999999999999 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 0.022700000000000001 * var_x6 - 0.0146 * var_x9 - 0.23519999999999999 * var_x10 - 0.0013352941176470589 * var_x27 - 0.0024414715719063545 * var_x28 - 0.010762281437760625 * var_x46 - 2.1086672225679694e-7 * var_x30 - var_x11 * var_chaste_interface__transient_outward_current_s_gate__s - var_x19 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x26 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x39 * var_x42);
        IJth(rJacobian, 1, 0) = var_x83 * (-3.4598107243429746e-8 + 1.0129554625362473e-8 * var_x18 + 2.4647261725375594e-11 * var_x30);
        IJth(rJacobian, 2, 0) = (-var_chaste_interface__hyperpolarization_activated_current_y_gate__y + 1.0 / var_x90) * (2.7500000000000001e-5 * var_x91 - 1.0000000000000001e-5 * var_x93) - 0.14705882352941177 * var_x89 * (var_x94 + var_x95) / pow(var_x90, 2);
        IJth(rJacobian, 3, 0) = 3.2206119162640899e-5 * var_x102 * var_x103 * var_x98 - 3.7037037037037037e-5 * var_x102 * var_x104 * var_x97 + 5.2910052910052905e-5 * var_x100 * var_x104 * var_x98 / pow(var_x101, 2);
        IJth(rJacobian, 4, 0) = var_x108 * var_x109 * var_x112 - var_x107 * var_x112 * var_x113 - 0.01240079365079365 * var_x108 * var_x110 * var_x113 / pow(var_x111, 2);
        IJth(rJacobian, 5, 0) = 0.071428571428571425 * var_x114 * var_x123 / pow(var_x115, 2) + 5.1020408163265302e-7 * (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1.0 / var_x115) * (93.333333333333329 * var_x118 * var_x119 / pow(var_x120, 2) - 116.66666666666666 * var_x116 * var_x121 / pow(var_x117, (3 / 2))) / pow((0.057142857142857141 + var_x122), 2);
        IJth(rJacobian, 6, 0) = 0.22148394241417499 * var_x132 * var_x137 * pow(var_x133, (-3.0)) - 0.20000000000000001 * var_x131 * var_x134 * var_x135 + 99.999999999999986 * var_x134 * var_x136 * (0.00050000000000000001 * var_x128 / pow(var_x129, 2) + 0.020000000000000004 * var_x125 / pow(var_x126, 2)) / pow((var_x127 + var_x130), 2);
        IJth(rJacobian, 7, 0) = ((var_x150) ? (var_x141 * (108035.0 * var_x142 + 0.21330000000000002 * var_x143 - 0.008382352941176471 * var_x144) - var_x149 * (var_x145 + var_x146 + var_x147)) : (-var_x149 * var_x152 + 0.53361053361053368 * var_x141 * var_x151 / pow((1 + var_x151), 2)));
        IJth(rJacobian, 8, 0) = ((var_x150) ? (var_x153 * (var_x160 - 0.00025500480000000003 * var_x164 + var_x159 * var_x165 * (3.0508668000000001e-7 * var_x155 - 6214.6032000000005 * var_x154) + 0.0033402720000000005 * var_x161 * var_x163 / pow(var_x162, 2) - 0.311 * var_x156 * var_x157 * var_x165 / pow(var_x158, 2)) - var_x149 * (var_x166 + var_x167)) : (0.034200000000000001 * var_x153 * var_x171 - 0.16150740242261105 * var_x148 * var_x171 + 0.059999999999999998 * var_x153 * var_x168 * var_x170 / pow(var_x169, 2)));
        IJth(rJacobian, 9, 0) = 0.13333333333333333 * var_x172 * var_x186 / pow(var_x173, 2) + 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1.0 / var_x173) * (-0.050000000000000003 * var_x174 / pow(var_x175, 2) + 0.27999999999999997 * var_x177 * var_x184 / pow(var_x178, 2) - 0.15076923076923077 * var_x179 * var_x182 / pow(var_x183, 2)) / pow((var_x185 + 0.7142857142857143 * var_x176), 2);
        IJth(rJacobian, 10, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1.0 / var_x197) * (18.0 * var_x198 + 264.60000000000002 * var_x195 * var_x199 - 20.0 * var_x190 / pow(var_x191, 2)) / pow((0.018140589569160998 + var_x195 + 0.16326530612244897 * var_x189 + 0.18140589569160998 * var_x192), 2) - 0.14285714285714285 * var_x196 * var_x200 / pow(var_x197, 2);
        IJth(rJacobian, 11, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x206) * (8.0 * var_x198 + 126.45 * var_x199 * var_x204 - 3.1000000000000001 * var_x201 / pow(var_x202, 2)) / pow((var_x204 + 0.055160142348754451 * var_x203 + 0.14234875444839859 * var_x189), 2) - 0.09571428571428571 * var_x205 * var_x207 / pow(var_x206, 2);
        IJth(rJacobian, 13, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / var_x219) * (1.0 * var_x213 / pow(var_x214, 2) + 13.28125 * var_x217 * pow(var_x216, 1.0)) / pow((0.49411764705882355 + var_x217 + 0.058823529411764705 * var_x215), 2) - 0.076923076923076927 * var_x218 * var_x220 / pow(var_x219, 2);
        IJth(rJacobian, 14, 0) = 0.076923076923076927 * var_x221 * var_x225 / pow(var_x222, 2) + 0.0042530568846358323 * var_x224 * pow(var_x223, 1.0) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / var_x222) / pow((0.69856459330143539 + var_x224), 2);
        IJth(rJacobian, 16, 0) = var_x254 * (-var_x250 + 0.00075477277169111218 * var_x45 - 0.00018869319292277804 * var_x46);
        IJth(rJacobian, 18, 0) = -3.389679425876563e-8 - 1.7024840244711204e-6 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 0.00080594011556369446 * var_x35 - 3.0388663876087418e-8 * var_x18 - 7.3941785176126781e-11 * var_x30 - var_x260 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 19, 0) = 7.5975573338612627e-7 * var_x23 + 0.00053729341037579627 * var_x35 - 2.7491468998833366e-5 * var_x10 - 2.6533007919792409e-6 * var_x6 - 1.7065282626826835e-6 * var_x9 - 7.5975573338612623e-6 * var_x3 - 2.7391648784016175e-6 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 1.5607651717524947e-7 * var_x27 - 2.8537261917770629e-7 * var_x28 - var_x261 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x262 * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        IJth(rJacobian, 1, 1) = var_x83 * (-0.0038240087783467445 - var_x84 + 7.2352122917848019e-6 * var_x50 - 4.6212277808973237e-7 * var_x49 - 5.3144431236283834e-11 * var_x86 - 0.069488744729986562 * var_x51) + 0.00040000000000000002 * pow(var_x80, (-3.0)) * (2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973237e-7 * log(2.0 * var_x49) + 0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027069 * var_x87 - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - var_x84 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362473e-8 * var_x14 * var_x29) / pow(var_x81, 2);
        IJth(rJacobian, 15, 1) = var_x229 * (0.00036000000000000002 + 7.968749999999999e-10 * var_x86);
        IJth(rJacobian, 16, 1) = 1.1399999999999999 * var_x253;
        ...
        IJth(rJacobian, 2, 2) = -var_x94 - var_x95;
        IJth(rJacobian, 18, 2) = 4.5479750756676949e-5 * var_x53 - 1.7024840244711204e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 19, 2) = 7.3173394969065157e-5 * var_x21 - 2.7391648784016175e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x19 * var_x22);
        IJth(rJacobian, 3, 3) = 0.00037037037037037035 * var_x104 * (-1.0 - var_x97);
        IJth(rJacobian, 19, 3) = -var_x22 * var_x261;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.091800000000000007 * var_x54);
        IJth(rJacobian, 4, 4) = 0.29761904761904762 * var_x113 * (-1.0 - var_x107);
        IJth(rJacobian, 19, 4) = -1.0730088665360983e-5 * var_x54;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-0.47039999999999998 * var_x56);
        IJth(rJacobian, 5, 5) = -var_x123;
        ...
        IJth(rJacobian, 6, 6) = -1.0 * var_x137;
        IJth(rJacobian, 18, 6) = -0.045786761092363105 * var_x59;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x26 * var_x57);
        IJth(rJacobian, 7, 7) = ((var_x150) ? (-var_x145 - var_x146 - var_x147) : (-var_x152));
        IJth(rJacobian, 18, 7) = -var_x260 * var_x57;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-130.5744 * var_x60);
        IJth(rJacobian, 8, 8) = ((var_x150) ? (-var_x166 - var_x167) : (-0.59999999999999998 * var_x171));
        ...
        IJth(rJacobian, 16, 9) = -var_x256 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x62 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 10, 10) = -var_x200;
        IJth(rJacobian, 16, 10) = -var_x256 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        ...
        IJth(rJacobian, 16, 11) = -var_x257 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        ...
        IJth(rJacobian, 16, 12) = -var_x257 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x22);
        IJth(rJacobian, 13, 13) = -var_x220;
        IJth(rJacobian, 19, 13) = -var_x22 * var_x262;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-0.081839999999999996 * var_x65);
        IJth(rJacobian, 14, 14) = -var_x225;
        IJth(rJacobian, 19, 14) = -9.5659091108185493e-6 * var_x65;
        IJth(rJacobian, 1, 15) = 2.40087783467447e-5 * var_x82;
        IJth(rJacobian, 15, 15) = var_x229 * (-0.00036000000000000002 - var_x238 + 0.0087039999999999982 * var_x243 - 0.0032639999999999995 * var_x245) + 0.66666666666666663 * pow(var_x226, (-3.0)) * (0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0.0063749999999999996 * var_x87 - 0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x238 * var_x239) / pow((0.33333333333333331 + var_x227), 2);
        IJth(rJacobian, 16, 15) = var_x254 * (var_x258 + 0.065303877103145558 * var_x245 - 0.17414367227505481 * var_x243);
        IJth(rJacobian, 17, 15) = 0.060000000000000005 * var_x242 * var_chaste_interface__calcium_dynamics__Ca_ss * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-0.14375050524031124 * var_x66);
        IJth(rJacobian, 1, 16) = 0.0038 * var_x82;
        IJth(rJacobian, 12, 16) = -0.0030000000000000005 * var_x210 * var_x212 + 6.2500000000000015e-5 * var_x212 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x209) / pow((0.025000000000000001 + var_x209), 2);
        IJth(rJacobian, 15, 16) = var_x229 * (var_x238 + 0.032639999999999995 * var_x246 - 0.030599999999999995 * var_x247);
        IJth(rJacobian, 16, 16) = var_x254 * (-1.1399999999999999 - var_x258 + 0.61222384784198958 * var_x247 - 0.0025203523969264349 * var_x66 - 0.65303877103145558 * var_x246) + 0.00020000000000000001 * pow(var_x251, (-3.0)) * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x239 * var_x258 - var_x250 * var_x43) / pow(var_x252, 2);
        IJth(rJacobian, 17, 16) = var_x259 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 15, 17) = -0.015299999999999998 * var_x228 * var_x248;
        IJth(rJacobian, 16, 17) = 0.30611192392099479 * var_x248 * var_x253;
        IJth(rJacobian, 17, 17) = -0.0050000000000000001 + var_x259 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (0.001436484375 * var_x71 - 2.2983750000000001 * var_x68 - 0.0077469905913117388 * var_x52 - 0.00051997321379654684 * var_x72 - 0.38909660951273101 * var_x69 - 3488.1332698833639 * var_x73 - 0.18849229521481251 * var_x70);
        IJth(rJacobian, 1, 18) = 6.0777327752174836e-8 * var_x72 * var_x82;
        IJth(rJacobian, 18, 18) = 5.0371257222730904e-7 * var_x71 - 0.00080594011556369446 * var_x68 - 9.0551084895961074e-7 * var_x52 - 1.8233198325652452e-7 * var_x72 - 0.40771219240135104 * var_x73 - 4.5479750756676949e-5 * var_x69;
        IJth(rJacobian, 19, 18) = 0.00053729341037579627 * var_x68 - 3.3580838148487267e-7 * var_x71 - 2.2032015690548319e-5 * var_x70;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-2.1862541723894919 * var_x78 - 0.62602629555570366 * var_x74 - 0.60640236697509131 * var_x75 - 2.4523232285600609 * var_x79 - 0.3900209056315565 * var_x76 - 6.2830765071604171 * var_x70 - 1.7363944428802174 * var_x77);
        IJth(rJacobian, 19, 19) = -4.5587787568311439e-5 * var_x76 - 0.00025554140647880875 * var_x78 - 0.00073440052301827741 * var_x70 - 7.0879642315114355e-5 * var_x75 - 0.00028664102046376645 * var_x79 - 7.3173394969065157e-5 * var_x74 - 0.00020295932821508516 * var_x77;
    }
