...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x17 = var_x16 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3.0);
        ...
        const double var_x56 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 1.0) * (-26.713760659695652 * log(9.5999999999999996 / var_x55) + var_chaste_interface__membrane__V);
        ...
        const double var_x71 = var_x14 * var_x16 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2.0);
        ...
        const double var_x259 = 0.30611192392099484 * var_x239;
        ...
        IJth(rJacobian, 18, 0) = -3.389679425876563e-8 - 1.7024840244711204e-6 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 3.0388663876087418e-8 * var_x18 - 7.3941785176126768e-11 * var_x30 - 0.00080594011556369446 * var_x35 - var_x261 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        IJth(rJacobian, 1, 1) = var_x83 * (-0.0038240087783467445 - var_x84 + 7.2352122917848019e-6 * var_x50 - 0.069488744729986562 * var_x51 - 5.3144431236283834e-11 * var_x86 - 4.6212277808973232e-7 * var_x49) + 0.00040000000000000002 * pow(var_x80, (-3.0)) * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973232e-7 * log(2.0 * var_x49) - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027063 * var_x87 - var_x84 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x14 * var_x29) / pow(var_x81, 2);
        ...
        IJth(rJacobian, 15, 15) = var_x231 * (-0.00036000000000000002 - var_x240 + 0.021759999999999998 * var_x246 - 0.0032639999999999995 * var_x244) + 0.66666666666666674 * pow(var_x228, (-3.0)) * (0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0.0063749999999999996 * var_x87 - 0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x240 * var_x241) / pow((0.33333333333333337 + var_x229), 2);
        IJth(rJacobian, 16, 15) = var_x255 * (var_x259 + 0.065303877103145572 * var_x244 - 0.43535918068763713 * var_x246);
        IJth(rJacobian, 17, 15) = 0.059999999999999998 * var_x243 * var_chaste_interface__calcium_dynamics__Ca_ss * var_chaste_interface__calcium_dynamics__R_prime;
        ...
        IJth(rJacobian, 16, 17) = 0.30611192392099484 * var_x249 * var_x254;
