...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhund_rudy_2004_aFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x187 = 00017000000000000001 * var_x182 + 00017000000000000001 * var_x184;
        ...
        const double var_x206 = 0072727272727272727 * var_x205;
        const double var_x207 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x208 = 032000000000000001 * var_x202 * var_x207 / pow(var_x203, 2);
        ...
        const double var_x248 = 0042724511494942495 * var_x247;
        ...
        const double var_x256 = -10 * var_x182 - 10 * var_x184;
        const double var_x257 = 01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x241 + 0.29999999999999999 / (1.0 - 70.217303721661608 * var_x244)) / pow((050000000000000003 + var_x172 + 0.10000000000000001 * var_x241), 2);
        const double var_x258 = pow((0030000000000000001 + var_chaste_interface__Ca__Ca_ss), (-2));
        const double var_x259 = var_x108 * var_x157;
        const double var_x260 = 00075000000000000002 * var_x191 - 00075000000000000002 * var_x190;
        ...
        const double var_x270 = 0028483007663294996 * var_x267;
        ...
        const double var_x285 = exp(0.4251012145748988 - 04048582995951417 * var_chaste_interface__cell__V);
        ...
        const double var_x298 = var_x291 + var_x295 - 4.6080000000000006e-5 * var_x292 * var_x296 / pow(var_x293, 2) - 00075871700000000012 * var_x288 * var_x297 / pow(var_x289, 2);
        ...
        const double var_x311 = 040000000000000001 * var_chaste_interface__Ito__ydv2;
        ...
        const double var_x321 = 02 * var_chaste_interface__Ito__zdv;
        ...
        const double var_x325 = -1 + 066666666666666666 * var_chaste_interface__cell__V;
        ...
        const double var_x340 = 0028 + var_chaste_interface__Ca__Ca_ss;
        ...
        const double var_x345 = 1.0 + 00036056965579880955 * var_x344;
        const double var_x346 = var_x339 * var_x343 / pow(var_x345, 2);
        const double var_x347 = 00024037977053253972 * var_x346;
        ...
        const double var_x353 = var_x352 / pow((var_x342 + 00060803092942449902 * var_x339), 2);
        ...
        const double var_x357 = exp(-16.0 + 80 * var_x356 + 40000 * var_chaste_interface__Ca__Ca_ss);
        ...
        const double var_x404 = 3000 * var_x403;
        const double var_x405 = 0.70217303721661617 * var_x100;
        const double var_x406 = 052572936047118712 * var_x106;
        ...
        const double var_x421 = 0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x422 = var_x179 * var_x421;
        const double var_x423 = var_x174 * var_x421;
        const double var_x424 = 0002749177168957104 * var_x109;
        ...
        const double var_x430 = 0036718475849305066 * var_x428;
        const double var_x431 = 719.99999999999989 * var_x428;
        const double var_x432 = 719.99999999999989 * var_x417;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0 : (-00022499999999999999 + var_x32 - var_x103 + 00021581774391076088 * var_x55 + 00089962337662337659 * var_x87 + 005408738276452542 * var_x58 + 0.12163499999999999 * var_x61 - 4.5 * var_x74 - 0027599999999999999 * var_x2 - 00021581774391076088 * var_x82 - 5.4087382764525417e-5 * var_x88 - 0028824983370005666 * var_x11 - 0.48423913043478262 * var_x50 - 0.51000000000000001 * var_x25 - 0006333333333333333 * var_x90 - 00046153846153846147 * var_x53 - 029564989000285053 * var_x93 + var_x105 * var_x110 - var_x110 * var_x111 - var_x36 * var_chaste_interface__IKr__xr - var_x4 * var_chaste_interface__INal__hL - var_x43 * var_chaste_interface__Ito2__AA - var_x77 * var_chaste_interface__INa__H - var_x81 * var_chaste_interface__Ito__ydv2 - var_x84 * var_x86);
        IJth(rJacobian, 1, 0) = var_x162 * (-var_x158 + 1.8188600866065964e-6 * var_x93 + 6.6386339662934098e-9 * var_x55 + 00027684334297065928 * var_x74 - 6.6386339662934098e-9 * var_x82);
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__INa__H) * ((var_x194) ? (0) : (-019852941176470591 * var_x195)) - ((var_x194) ? (0.693000693000693 * var_x196 / pow(var_x197, 2)) : (0.28123999999999999 * var_x198 + 108500 * var_x199)) * var_chaste_interface__INa__H;
        IJth(rJacobian, 3, 0) = var_x200 * var_x204 + var_x206 * var_chaste_interface__INa__m - var_x200 * var_x208;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__INa__J) * ((var_x194) ? (0) : (var_x216 + var_x215 * var_x217 * (1.5254334000000001e-6 * var_x211 - 31073.016 * var_x210) - 0.311 * var_x212 * var_x213 * var_x217 / pow(var_x214, 2))) - ((var_x194) ? (-7.6049999999999996e-8 * var_x221 + 029999999999999999 * var_x218 * var_x220 / pow(var_x219, 2)) : (-001275024 * var_x225 + 016701360000000002 * var_x222 * var_x224 / pow(var_x223, 2))) * var_chaste_interface__INa__J;
        IJth(rJacobian, 5, 0) = 1.5624999999999998 * (-var_chaste_interface__ICaL__d + 1.0 / var_x231) * (-041599999999999998 * var_x229 + 0.10560000000000001 * var_x226 * var_x228 / pow(var_x227, 2)) / pow((0.73749999999999993 + var_x229), 2) + 0.14836795252225518 * var_x230 * var_x232 / pow(var_x231, 2);
        IJth(rJacobian, 6, 0) = -0.23529411764705882 * var_x233 / pow((1.0 + var_x233), 2);
        IJth(rJacobian, 7, 0) = -099999999999999992 * var_x238 * (052900000000000003 + var_x237) + var_x237 * (039250169999999994 - 0040499999999999998 * var_chaste_interface__cell__V) * (0.29999999999999999 - var_chaste_interface__ICaL__f + 0.69999999999999996 * var_x236);
        IJth(rJacobian, 8, 0) = 6.0846129416049119e-5 * var_x247 * (70.217303721661608 * var_x239 + var_x111 * var_x240 - var_x105 * var_x240);
        IJth(rJacobian, 9, 0) = 8.1128172554732154e-6 * var_x267 * (351.08651860830804 * var_x239 + var_x111 * var_x261 - var_x105 * var_x261) + 0033333333333333335 * var_x269 * (-87.77162965207701 * var_x239 + var_x105 * var_x268 - var_x111 * var_x268);
        IJth(rJacobian, 10, 0) = -0.11 * var_x238 * (0054000000000000003 + var_x272) + var_x272 * (0.12930244120000001 - 0069619999999999994 * var_chaste_interface__cell__V) * (0.23000000000000001 - var_chaste_interface__ICaL__f2 + 0.77000000000000002 * var_x236);
        ...
        IJth(rJacobian, 12, 0) = 04048582995951417 * var_x301 + var_x298 * (-var_chaste_interface__IKs__xs1 + 1.0 * var_x287);
        IJth(rJacobian, 13, 0) = 020242914979757085 * var_x301 + var_x298 * (0.5 * var_x287 - 0.5 * var_chaste_interface__IKs__xs2);
        ...
        IJth(rJacobian, 15, 0) = var_x311 * var_x315 - var_x311 * var_x316 - 0060000000000000001 * var_x319 * (1.0 - var_chaste_interface__Ito__ydv2);
        IJth(rJacobian, 16, 0) = var_x315 * var_x321 - var_x316 * var_x321 - 00044999999999999999 * var_x319 * (1.0 - var_chaste_interface__Ito__zdv);
        IJth(rJacobian, 18, 0) = var_x204 * var_x322 + var_x206 * var_chaste_interface__INal__mL - var_x208 * var_x322;
        IJth(rJacobian, 19, 0) = -00027322404371584699 * var_x323 / pow((1.0 + var_x323), 2);
        ...
        IJth(rJacobian, 22, 0) = 80 * var_x365 * var_x368 - 0.14999999999999999 * var_x368 * var_x371;
        IJth(rJacobian, 23, 0) = -8.9372253111180233e-5 * var_x50 - 5.456580259819789e-6 * var_x93 - 00083053002891197785 * var_x74 - var_x379 * var_chaste_interface__INal__hL - var_x380 * var_chaste_interface__INa__H;
        ...
        IJth(rJacobian, 28, 0) = var_x429 * (-719.99999999999989 * var_x412 - 0036718475849305066 * var_x239 + var_x105 * var_x424 - var_x111 * var_x424);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0 : (18522000 * var_x117 + 057500000000000002 * var_x115 + 6.9055124202402519e-7 * var_x118 - 057500000000000002 * var_x113 - 1.3556015675697155e-8 * var_x123 - 0028824983370005666 * var_x116 - 6.2499999999999997e-8 * var_x119);
        ...
        IJth(rJacobian, 27, 1) = -var_x422 + 0043750000000000004 * var_x176;
        IJth(rJacobian, 28, 1) = 5.0 * var_x428;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0 : (-var_x126 * var_x77);
        IJth(rJacobian, 2, 2) = -((var_x194) ? (0) : (0.13500000000000001 * var_x195)) - ((var_x194) ? (7.6923076923076916 / var_x197) : (310000 * var_x199 + 3.5600000000000001 * var_x198));
        IJth(rJacobian, 23, 2) = -var_x126 * var_x380;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0 : (-24.75 * var_x128);
        IJth(rJacobian, 3, 3) = var_x209;
        IJth(rJacobian, 23, 3) = -001522638386338626 * var_x128;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0 : (-8.25 * var_x129);
        IJth(rJacobian, 4, 4) = -((var_x194) ? (0) : (var_x216 * var_x217)) - ((var_x194) ? (0.29999999999999999 * var_x221) : (0.1212 * var_x225));
        IJth(rJacobian, 23, 4) = -00050754612877954204 * var_x129;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0 : (-var_x130 * var_x131);
        ...
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0 : (-var_x130 * var_x132);
        ...
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0 : (-var_x134 * var_chaste_interface__ICaL__fca2);
        IJth(rJacobian, 7, 7) = -052900000000000003 - var_x237;
        ...
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0 : (-3.5108651860830804 * var_x135);
        ...
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0 : (-var_x134 * var_chaste_interface__ICaL__f);
        IJth(rJacobian, 8, 9) = var_x248 * var_x254;
        IJth(rJacobian, 9, 9) = var_x265 * (-1 + 0028483007663294996 * var_x254 * var_x266) - var_x254 * var_x271;
        ...
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0 : (-var_x100 * var_x136);
        IJth(rJacobian, 8, 10) = var_x248 * var_x255;
        IJth(rJacobian, 9, 10) = var_x255 * var_x270 - var_x255 * var_x271;
        IJth(rJacobian, 10, 10) = -0054000000000000003 - var_x272;
        ...
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0 : (-var_x36 * var_x52);
        IJth(rJacobian, 11, 11) = -var_x283 - var_x284;
        IJth(rJacobian, 24, 11) = -var_x391 * var_x52;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0 : (var_x121 * var_x31);
        IJth(rJacobian, 12, 12) = -var_x299 - var_x300;
        IJth(rJacobian, 24, 12) = var_x121 * var_x389;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0 : (var_x122 * var_x30);
        IJth(rJacobian, 13, 13) = -3.8050000000000003e-5 * var_x290 * var_x297 - 00018000000000000001 * var_x294 * var_x296;
        IJth(rJacobian, 24, 13) = var_x122 * var_x388;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0 : (-0.57000000000000006 * var_x138);
        IJth(rJacobian, 14, 14) = -25.0 * var_x305 - 25.0 * var_x309;
        IJth(rJacobian, 24, 14) = -3.5066823442950178e-5 * var_x138;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0 : (-var_x52 * var_x81);
        IJth(rJacobian, 15, 15) = -029999999999999999 * var_x320 - 0.20000000000000001 * var_x316;
        IJth(rJacobian, 24, 15) = -var_x392 * var_x52;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0 : (-0.19 * var_x139);
        IJth(rJacobian, 16, 16) = -0.10000000000000001 * var_x316 - 0022499999999999998 * var_x320;
        IJth(rJacobian, 24, 16) = -1.1688941147650058e-5 * var_x139;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0 : (-var_x43 * var_chaste_interface__cell__V);
        IJth(rJacobian, 17, 17) = -1.0;
        IJth(rJacobian, 25, 17) = var_x400 * var_chaste_interface__cell__V;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0 : (-0195 * var_x140);
        IJth(rJacobian, 18, 18) = var_x209;
        IJth(rJacobian, 23, 18) = -1.1996544862061903e-6 * var_x140;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0 : (-var_x126 * var_x4);
        IJth(rJacobian, 19, 19) = -0016666666666666668;
        ...
        IJth(rJacobian, 20, 20) = -00068000000000000005 - var_x169 * var_x324 + var_x164 * var_x181 * var_x324;
        ...
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0 : (2.6731217821876006e-12 * var_x143 + 3.9005476114801918 * var_x145 - 24.300000000000001 * var_x146 - 220.37679432037609 * var_x147 - 0096847826086956523 * var_x141 - 0.17363020158575085 * var_x142);
        IJth(rJacobian, 1, 23) = var_x162 * (0014949540520415602 * var_x146 - 1.6445243785522266e-16 * var_x143);
        IJth(rJacobian, 23, 23) = var_x386 + 4.9335731356566794e-16 * var_x143 - 1.7874450622236046e-6 * var_x141 - 1.068185898837083e-5 * var_x142 - 013557744100624516 * var_x147 - 0044848621561246801 * var_x146;
        IJth(rJacobian, 24, 23) = 3.9005476114801918 * var_x394 + 1.191630041482403e-6 * var_x141;
        IJth(rJacobian, 25, 23) = var_x386;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0 : (3.2491553184435085 * var_x153 + 212.79583259575517 * var_x145 - 0.37007808289373995 * var_x150 - 073726054827180365 * var_x148 - 5.0753443540450256 * var_x154 - 13.623292739805068 * var_x149 - var_x152 * var_x86);
        IJth(rJacobian, 24, 24) = var_x398 + 212.79583259575517 * var_x394 + 00019989044893084398 * var_x153 - 4.535681662754383e-6 * var_x148 - 00031223895504468581 * var_x154 - 2.2767478584105716e-5 * var_x150 - 0008381150898567882 * var_x149 - var_x152 * var_x393;
        IJth(rJacobian, 25, 24) = var_x398;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0 : (00601027620873753 * var_x155 - 001444800488100033 * var_x57);
        ...
        IJth(rJacobian, 26, 26) = var_x419 * (-0083333333333333332 - var_x418) + 0.25 * (0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x409 * var_x418) / (pow(var_x401, 3) * pow((0.125 + var_x402), 2));
        IJth(rJacobian, 27, 26) = 00072463768115942019;
        IJth(rJacobian, 28, 26) = var_x428 * var_x432;
        IJth(rJacobian, 1, 27) = 2.3676470588235295e-5 * var_x161;
        IJth(rJacobian, 26, 27) = 0083333333333333332 * var_x403;
        IJth(rJacobian, 27, 27) = -0010163043478260869;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0 : (-var_x136 * var_x157);
        IJth(rJacobian, 1, 28) = var_x162 * (0.14705882352941174 - var_x180 * var_x193 - var_x186 * var_x192);
        IJth(rJacobian, 8, 28) = var_x243 * (-0016500000000000002 * var_x258 + var_x253 * var_x259) + var_x257 * (var_x260 + 0030000000000000001 * var_x258);
        ...
        IJth(rJacobian, 21, 28) = var_x329 * var_x338 * var_x347 * var_x95 - 00020267697647483301 * var_x165 * var_x339 * var_x340 * var_x342 * var_x353 * (1.8999999999999999 * var_x341 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x340, 2));
        IJth(rJacobian, 22, 28) = var_x377 * (var_x260 + var_x370 * (5000 - 3510.8651860830805 * var_x378) - var_x260 * var_x361) - 1.0 * var_x365 * (40000 - 18724.614325776431 * var_x378);
        ...
        IJth(rJacobian, 28, 28) = var_x429 * (-5.0 - var_x432 - 0036718475849305066 * var_x259 - 505.56458679596358 * var_x420) + 1.0 * (019557600000000001 / pow(var_x425, 3) + 8.1780000000000006e-5 / pow(var_x426, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0036718475849305066 * var_x244 + var_x409 * var_x432) / pow(var_x427, 2);
    }
