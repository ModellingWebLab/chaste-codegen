...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnygren_atrial_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x7 = pow(var_chaste_interface__cleft_space_ion_concentrations__Na_c, 3.0);
        const double var_x8 = var_x7 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x9 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0);
        ...
        const double var_x58 = 0.0044367792453369539 * var_chaste_interface__membrane__V;
        const double var_x59 = var_x45 * var_x53 * var_chaste_interface__cleft_space_ion_concentrations__Na_c;
        const double var_x60 = var_x47 * var_x48 * var_x51 * var_x52 / pow(var_x49, 2);
        ...
        const double var_x65 = 0.00074968400000000003 * var_x12;
        const double var_x66 = var_x15 * var_x7;
        const double var_x67 = (var_x14 - var_x16) / pow(var_x11, 2);
        const double var_x68 = 2.249052e-7 * var_x67;
        const double var_x69 = var_x47 * var_x50 * var_chaste_interface__membrane__V;
        const double var_x70 = var_x52 * var_x69 * pow(var_chaste_interface__sodium_current_m_gate__m, 2.0);
        const double var_x71 = var_x51 * var_x69;
        const double var_x72 = 8.0999999999999996 - 0.13500000000000001 * var_chaste_interface__membrane__V;
        const double var_x73 = var_x4 + var_x5;
        const double var_x74 = var_x72 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        const double var_x75 = 3.9570062806388422 * var_x24 - 0.14999999999999999 * var_chaste_interface__membrane__V;
        const double var_x76 = 1.4509023029009087 * var_x24 - 0.055 * var_chaste_interface__membrane__V;
        const double var_x77 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0);
        const double var_x78 = var_x77 * var_chaste_interface__cleft_space_ion_concentrations__Ca_c;
        const double var_x79 = 6.7471559999999992e-7 * var_x67;
        const double var_x80 = 0.0022490520000000001 * var_x12;
        const double var_x81 = var_x13 * var_x78;
        const double var_x82 = var_x37 * var_x55;
        const double var_x83 = var_x77 * var_x82 / pow((1 + 0.027410122234342148 * var_x38), 2);
        ...
        const double var_x114 = (var_x108 - 0.32000000000000006 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up) / pow((0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x115 = 6.6024752054987431e-8 * var_x12;
        const double var_x116 = 1.9807425616496228e-11 * var_x67;
        const double var_x117 = 1.9807425616496229e-7 * var_x12;
        const double var_x118 = 5.9422276849488674e-11 * var_x67;
        ...
        const double var_x184 = 1.0307938958145768e-5 * var_x53;
        const double var_x185 = 0.00037425551606170871 * var_x40;
        const double var_x186 = var_x59 * var_chaste_interface__membrane__V;
        const double var_x187 = var_x60 * var_chaste_interface__membrane__V;
        const double var_x188 = 1.9807425616496229e-7 * var_x12;
        const double var_x189 = 1.7826683054846605e-10 * var_x67;
        const double var_x190 = 5.942227684948868e-7 * var_x12;
        const double var_x191 = var_x184 * var_chaste_interface__membrane__V;
        const double var_x192 = var_x191 * var_x45;
        const double var_x193 = 8.8070109612833433e-7 * var_x21;
        const double var_x194 = 0.00024950367737447247 * var_x40;
        const double var_x195 = 0.00034849397687453321 * var_x24 - 1.3210516441925016e-5 * var_chaste_interface__membrane__V;
        const double var_x196 = 0.00012778112485399551 * var_x24 - 4.843856028705839e-6 * var_chaste_interface__membrane__V;
        const double var_x197 = 4.6465863583271093e-5 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x198 = 2.3232931791635546e-5 * var_x89;
        const double var_x199 = 0.00012778112485399551 * var_x6;
        ...
        const double var_x204 = 7.5793668809895348e-5 * var_x53;
        const double var_x205 = 0.0027518787945713876 * var_x40;
        const double var_x206 = 1.4564283541541343e-6 * var_x12;
        const double var_x207 = 4.3692850624624026e-10 * var_x67;
        const double var_x208 = 4.369285062462403e-6 * var_x12;
        const double var_x209 = 1.3107855187387207e-9 * var_x67;
        const double var_x210 = var_x204 * var_chaste_interface__membrane__V;
        const double var_x211 = var_x210 * var_x45;
        const double var_x212 = 1.4564283541541343e-10 * var_x67;
        const double var_x213 = 4.8547611805137808e-7 * var_x12;
        ...
        const double var_x216 = 4.3692850624624026e-10 * var_x67;
        const double var_x217 = 6.4757433538848112e-6 * var_x21;
        const double var_x218 = 0.0018345858630475916 * var_x40;
        const double var_x219 = 9.7136150308272163e-5 * var_chaste_interface__membrane__V - 0.0025624557123127439 * var_x24;
        const double var_x220 = 3.5616588446366462e-5 * var_chaste_interface__membrane__V - 0.00093956709451467277 * var_x24;
        const double var_x221 = 0.00034166076164169918 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x222 = 0.00093956709451467277 * var_x6;
        const double var_x223 = 0.0025624557123127439 * var_x18;
        const double var_x224 = 0.00017083038082084959 * var_x89;
        const double var_x225 = 23.501339000540224 * var_x112;
        ...
        const double var_x228 = pow((var_x227 * var_chaste_interface__intracellular_ion_concentrations__Ca_i), 4.0);
        const double var_x229 = 0.20380000000000001 * var_x228;
        const double var_x230 = var_x226 * var_x61 * (4.0 * var_x227 - 4.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x226, 2));
        const double var_x231 = var_x229 * var_x230 * var_chaste_interface__Ca_handling_by_the_SR__F1;
        ...
        const double var_x234 = 0.20380000000000001 * pow((var_x233 * var_chaste_interface__intracellular_ion_concentrations__Ca_d), 4.0);
        const double var_x235 = var_x232 * var_x234 * (4.0 * var_x233 - 4.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_d / pow(var_x232, 2)) * var_chaste_interface__Ca_handling_by_the_SR__F1 / var_chaste_interface__intracellular_ion_concentrations__Ca_d;
        const double var_x236 = 0.33960000000000001 * var_x228;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0027856000000000001 + 3.5412649999999997e-5 * var_x57 + 0.00041666666666666664 * var_x31 + 0.0034116700966722955 * var_x33 - 0.055 * var_x6 - 0.00074968400000000003 * var_x17 - 0.14999999999999999 * var_x18 - 0.02 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n - 0.059999999999999998 * var_x29 + var_x58 * var_x60 + (-0.13500000000000001 * var_x4 - 0.13500000000000001 * var_x5) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L - var_x22 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a - var_x37 * var_x41 - var_x47 * var_x54 - var_x58 * var_x59);
        ...
        IJth(rJacobian, 14, 0) = -1.0673921144856187e-7 + 3.9074763446476996e-7 * var_x187 + 9.3563879015427174e-9 * var_x57 - 3.9074763446476996e-7 * var_x186 - 1.9807425616496229e-7 * var_x17 - var_x184 * var_x47 - var_x185 * var_x37;
        IJth(rJacobian, 15, 0) = 3.6695879005347264e-8 * var_x31 + 3.0046615937675515e-7 * var_x33 - 1.3210516441925016e-5 * var_x18 - 1.7614021922566687e-6 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n - 4.843856028705839e-6 * var_x6 - 5.2842065767700066e-6 * var_x29 - 6.2375919343618122e-9 * var_x57 + var_x194 * var_x37 - var_x193 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a;
        ...
        IJth(rJacobian, 21, 0) = 7.848471430041313e-7 + 2.8731443710644848e-6 * var_x186 + 1.4564283541541343e-6 * var_x17 - 6.879696986428469e-8 * var_x57 - 2.8731443710644848e-6 * var_x187 + var_x204 * var_x47 + var_x205 * var_x37;
        ...
        IJth(rJacobian, 23, 0) = 3.5616588446366462e-5 * var_x6 + 3.8854460123308864e-5 * var_x29 + 4.5864646576189789e-8 * var_x57 + 9.7136150308272163e-5 * var_x18 + 1.2951486707769622e-5 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n - 2.6982263974520048e-7 * var_x31 - 2.2093099954173172e-6 * var_x33 + var_x217 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a - var_x218 * var_x37;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.080000000000000002 * var_x64 - 0.020756080744462984 * var_x61 - 0.080000000000000002 * var_x63 + var_x65 * var_x66 + var_x68 * var_x7);
        IJth(rJacobian, 1, 1) = -47.274000000000001 - var_x113 + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 7.3978892074780085e-7 * var_x114 + 3.5228043845133373e-6 * var_x64 + 9.0 * var_chaste_interface__intracellular_Ca_buffering__O_C + 6.2720000000000002 * var_chaste_interface__intracellular_Ca_buffering__O_TC - 3.5228043845133373e-6 * var_x63 - 8.2198768971977891 * var_x109 - 9.1399515314883825e-7 * var_x61 - var_x115 * var_x66 - var_x116 * var_x7;
        IJth(rJacobian, 14, 1) = var_x118 * var_x7 + var_x188 * var_x66;
        ...
        IJth(rJacobian, 21, 1) = -var_x206 * var_x66 - var_x207 * var_x7;
        IJth(rJacobian, 22, 1) = 2.5902973415539245e-5 * var_x63 + 6.7205525966826332e-6 * var_x61 - 2.5902973415539245e-5 * var_x64 + var_x212 * var_x7 + var_x213 * var_x66;
        IJth(rJacobian, 24, 1) = var_x225;
        IJth(rJacobian, 25, 1) = 121.858794817616 * var_x109 - 1.0967291533585438e-5 * var_x114;
        IJth(rJacobian, 27, 1) = -var_x231;
        IJth(rJacobian, 28, 1) = var_x231 - var_x230 * var_x236 * var_chaste_interface__Ca_handling_by_the_SR__F2;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.3511272667921278 * var_x70);
        IJth(rJacobian, 2, 2) = -0.001 * var_x125;
        IJth(rJacobian, 14, 2) = -3.0923816874437303e-5 * var_x70;
        IJth(rJacobian, 21, 2) = 0.00022738100642968604 * var_x70;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.10533818003763834 * var_x71);
        IJth(rJacobian, 3, 3) = -0.001 * var_x129;
        IJth(rJacobian, 14, 3) = -9.2771450623311923e-6 * var_x71;
        IJth(rJacobian, 21, 3) = 6.8214301928905822e-5 * var_x71;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.01170424222640426 * var_x71);
        IJth(rJacobian, 4, 4) = -0.001 * var_x135;
        IJth(rJacobian, 14, 4) = -1.0307938958145769e-6 * var_x71;
        IJth(rJacobian, 21, 4) = 7.5793668809895352e-6 * var_x71;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x72 * var_x73);
        IJth(rJacobian, 5, 5) = -0.001 * var_x140;
        IJth(rJacobian, 16, 5) = var_x201 * var_x73;
        IJth(rJacobian, 22, 5) = var_x214 * var_x73;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x2 * var_x74);
        IJth(rJacobian, 6, 6) = -0.001 * var_x144;
        IJth(rJacobian, 16, 6) = var_x2 * var_x202;
        IJth(rJacobian, 22, 6) = var_x2 * var_x215;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x3 * var_x74);
        IJth(rJacobian, 7, 7) = -0.001 * var_x151;
        IJth(rJacobian, 16, 7) = var_x202 * var_x3;
        IJth(rJacobian, 22, 7) = var_x215 * var_x3;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s);
        ...
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r);
        ...
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x76 * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus);
        ...
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x76 * var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus);
        ...
        IJth(rJacobian, 15, 13) = -var_x193 * var_x30;
        IJth(rJacobian, 23, 13) = var_x217 * var_x30;
        ...
        IJth(rJacobian, 1, 14) = var_x117 * var_x81 - var_x118 * var_x78;
        IJth(rJacobian, 14, 14) = 4.2177556280432989e-7 * var_x83 - 0.00056138327409256303 * var_x84 - 2.8157848672826448e-6 * var_x43 + var_x189 * var_x78 - var_x190 * var_x81 - var_x192 * var_x44;
        IJth(rJacobian, 15, 14) = 0.00037425551606170871 * var_x84 - 2.8118370853621991e-7 * var_x83;
        IJth(rJacobian, 21, 14) = 0.0041278181918570815 * var_x84 + 2.0704300494725328e-5 * var_x43 - 3.1012909029730135e-6 * var_x83 + var_x208 * var_x81 + var_x211 * var_x44 - var_x209 * var_x78;
        IJth(rJacobian, 22, 14) = var_x216 * var_x78 - var_x206 * var_x81;
        ...
        IJth(rJacobian, 15, 15) = 7.9263098651550091e-6 * var_x93 - 0.00013939759074981328 * var_x92 - var_x197 * var_x23 - var_x198 * var_x23 - var_x199 * var_x23 - var_x200 * var_x23;
        IJth(rJacobian, 23, 15) = 0.0010249822849250976 * var_x92 - 5.8281690184963299e-5 * var_x93 + var_x221 * var_x23 + var_x222 * var_x23 + var_x223 * var_x23 + var_x224 * var_x23;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x74 * var_x95);
        IJth(rJacobian, 1, 16) = 0.002;
        IJth(rJacobian, 16, 16) = -0.10000000000000001 + var_x202 * var_x95;
        IJth(rJacobian, 22, 16) = var_x215 * var_x95;
        IJth(rJacobian, 27, 16) = -var_x235;
        IJth(rJacobian, 28, 16) = var_x235;
        ...
        IJth(rJacobian, 14, 21) = var_x192 + 2.8157848672826448e-6 * var_x96 + var_x189 * var_x97 + var_x190 * var_x98 - var_x191 * var_x46;
        IJth(rJacobian, 21, 21) = -6.993006993006993e-5 - var_x211 - 2.0704300494725328e-5 * var_x96 + var_x210 * var_x46 - var_x208 * var_x98 - var_x209 * var_x97;
        IJth(rJacobian, 22, 21) = var_x206 * var_x98 + var_x216 * var_x97;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (0.020756080744462984 * var_x99 + var_x68 * var_x9 - var_x100 * var_x65);
        IJth(rJacobian, 1, 22) = 9.1399515314883825e-7 * var_x99 + var_x100 * var_x115 - var_x116 * var_x9;
        IJth(rJacobian, 14, 22) = var_x118 * var_x9 - var_x100 * var_x188;
        IJth(rJacobian, 21, 22) = var_x100 * var_x206 - var_x207 * var_x9;
        IJth(rJacobian, 22, 22) = -4.048582995951417e-5 - 6.7205525966826332e-6 * var_x99 + var_x212 * var_x9 - var_x100 * var_x213;
        ...
        IJth(rJacobian, 14, 23) = var_x107 * var_x185 - var_x106 * var_x185;
        IJth(rJacobian, 15, 23) = 0.00013939759074981328 * var_x103 - 7.9263098651550091e-6 * var_x105 - 2.3551708712663917e-6 * var_x104 + var_x101 * var_x197 + var_x101 * var_x198 + var_x101 * var_x199 + var_x101 * var_x200 + var_x106 * var_x194 - var_x107 * var_x194;
        IJth(rJacobian, 21, 23) = var_x106 * var_x205 - var_x107 * var_x205;
        IJth(rJacobian, 23, 23) = -0.0001 + 1.7317432876958762e-5 * var_x104 + 5.8281690184963299e-5 * var_x105 - 0.0010249822849250976 * var_x103 + var_x107 * var_x218 - var_x101 * var_x221 - var_x101 * var_x222 - var_x101 * var_x223 - var_x101 * var_x224 - var_x106 * var_x218;
        ...
        IJth(rJacobian, 1, 25) = 1.7754934097947219e-10 * var_x114 + 0.00078910818213098765 * var_x109;
        ...
        IJth(rJacobian, 27, 27) = -0.00081499999999999997 - var_x229 - var_x234;
        IJth(rJacobian, 28, 27) = var_x229 + var_x234;
        IJth(rJacobian, 1, 28) = var_x113 * var_x120;
        IJth(rJacobian, 24, 28) = -var_x120 * var_x225;
        IJth(rJacobian, 27, 28) = -0.00081499999999999997;
        IJth(rJacobian, 28, 28) = -0.033960000000000004 - var_x236;
    }
