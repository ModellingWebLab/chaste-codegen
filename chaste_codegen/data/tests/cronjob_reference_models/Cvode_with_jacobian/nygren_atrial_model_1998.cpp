...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnygren_atrial_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x9 = 0.01 * var_x8;
        ...
        const double var_x12 = exp(0.20470020580033776 + 0.056861168277871597 * var_chaste_interface__membrane__V - 1.5000000000000004 * var_x11);
        ...
        const double var_x19 = pow(var_chaste_interface__cleft_space_ion_concentrations__Na_c, 3.0);
        const double var_x20 = var_x19 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x21 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0);
        ...
        const double var_x30 = -26.38004187092562 * var_x11 + var_chaste_interface__membrane__V;
        const double var_x31 = var_x30 * var_x6 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a / pow(var_x7, 2);
        const double var_x32 = var_x12 * var_x30 / pow(var_x13, 2);
        const double var_x33 = var_x15 * var_x32;
        ...
        const double var_x66 = (var_x26 - var_x28) / pow(var_x23, 2);
        const double var_x67 = 2.249052e-7 * var_x66;
        const double var_x68 = 0.00074968400000000003 * var_x24;
        const double var_x69 = var_x19 * var_x27;
        ...
        const double var_x76 = 3.9570062806388431 * var_x11 - 0.14999999999999999 * var_chaste_interface__membrane__V;
        const double var_x77 = 1.4509023029009092 * var_x11 - 0.055 * var_chaste_interface__membrane__V;
        ...
        const double var_x80 = 6.7471560000000002e-7 * var_x66;
        const double var_x81 = 0.0022490520000000001 * var_x24;
        const double var_x82 = var_x25 * var_x79;
        const double var_x83 = var_x37 * var_x55;
        const double var_x84 = var_x78 * var_x83 / pow((1 + 0.027410122234342148 * var_x38), 2);
        const double var_x85 = var_x39 * var_x83 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 0.5);
        const double var_x86 = 0.11704242226404263 * var_x59;
        const double var_x87 = 0.52760083741851238 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x88 = 1.4509023029009092 * var_x17;
        const double var_x89 = var_x10 * var_x16;
        const double var_x90 = 3.9570062806388431 * var_x18;
        const double var_x91 = var_x8 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a;
        const double var_x92 = 0.26380041870925619 * var_x91;
        const double var_x93 = var_x10 * var_x33;
        ...
        const double var_x97 = pow(var_chaste_interface__cleft_space_ion_concentrations__Na_c, 2.0) * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x98 = var_x27 * var_x97;
        const double var_x99 = 1 / var_chaste_interface__cleft_space_ion_concentrations__Ca_c;
        const double var_x100 = var_x21 * var_x25;
        const double var_x101 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, (-0.55430000000000001));
        const double var_x102 = var_x101 * var_x14;
        const double var_x103 = 1 / var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x104 = var_x102 * var_x30;
        const double var_x105 = var_x101 * var_x32;
        const double var_x106 = var_x36 * var_x56;
        const double var_x107 = var_x36 * var_x55 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow(var_x34, 2);
        ...
        const double var_x114 = (var_x108 - 0.32000000000000006 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up) / pow((0.00041999999999999996 + 0.00024000000000000001 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x115 = 6.6024752054987431e-8 * var_x24;
        const double var_x116 = 1.9807425616496228e-11 * var_x66;
        const double var_x117 = 1.9807425616496229e-7 * var_x24;
        const double var_x118 = 5.9422276849488687e-11 * var_x66;
        const double var_x119 = 32.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x120 = var_x110 * (-var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_chaste_interface__Ca_handling_by_the_SR__Ca_rel) * (2.0 * var_x111 - 2.0 * var_chaste_interface__Ca_handling_by_the_SR__F2 / pow(var_x110, 2)) / var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x121 = exp(-3.3032886723507917 - 0.12180267965895249 * var_chaste_interface__membrane__V);
        const double var_x122 = 1.0 + var_x121;
        const double var_x123 = 1 + 0.039108330074305829 * var_chaste_interface__membrane__V;
        const double var_x124 = exp(-0.78827269000771605 * pow(var_x123, 2.0));
        const double var_x125 = 1 / (2.4000000000000001e-5 + 4.1999999999999998e-5 * var_x124);
        const double var_x126 = exp(10.96875 + 0.3125 * var_chaste_interface__membrane__V);
        const double var_x127 = 1.0 + var_x126;
        const double var_x128 = 1 / var_x127;
        const double var_x129 = 1 / (0.00029999999999999997 + 0.029999999999999999 * var_x128);
        const double var_x130 = exp(12.0 + 0.18867924528301888 * var_chaste_interface__membrane__V);
        const double var_x131 = 1.0 + var_x130;
        const double var_x132 = 0.00018867924528301889 * var_x130 / pow(var_x131, 2);
        const double var_x133 = 1.0 / var_x131;
        const double var_x134 = var_x126 / pow(var_x127, 2);
        const double var_x135 = 1 / (0.0030000000000000001 + 0.12 * var_x128);
        const double var_x136 = exp(-1.5517241379310345 - 0.17241379310344829 * var_chaste_interface__membrane__V);
        const double var_x137 = 1.0 + var_x136;
        const double var_x138 = 1 + 0.028571428571428571 * var_chaste_interface__membrane__V;
        const double var_x139 = exp(-1.3611111111111112 * pow(var_x138, 2.0));
        const double var_x140 = 1 / (0.002 + 0.0027000000000000001 * var_x139);
        const double var_x141 = 1 + 0.025000000000000001 * var_chaste_interface__membrane__V;
        const double var_x142 = pow(var_x141, 2.0);
        const double var_x143 = exp(-7.716049382716049 * var_x142);
        const double var_x144 = 1 / (0.01 + 0.161 * var_x143);
        const double var_x145 = exp(3.859154929577465 + 0.14084507042253522 * var_chaste_interface__membrane__V);
        const double var_x146 = 1.0 + var_x145;
        const double var_x147 = 0.00014084507042253522 * var_x145 / pow(var_x146, 2);
        const double var_x148 = pow(var_x141, 1.0);
        const double var_x149 = 1.0 / var_x146;
        const double var_x150 = exp(-7.9349335449315621 * var_x142);
        ...
        const double var_x154 = exp(-0.0011111111111111111 * pow(var_chaste_interface__membrane__V, 2.0));
        ...
        const double var_x158 = 1 + 0.019065776930409912 * var_chaste_interface__membrane__V;
        const double var_x159 = exp(-12.275731601256398 * pow(var_x158, 2.0));
        const double var_x160 = 1 / (0.01414 + 0.48120000000000002 * var_x159);
        const double var_x161 = exp(-0.53749999999999998 - 0.125 * var_chaste_interface__membrane__V);
        const double var_x162 = 1.0 + var_x161;
        const double var_x163 = exp(0.41666666666666669 + 0.083333333333333329 * var_chaste_interface__membrane__V);
        const double var_x164 = 1.0 + var_x163;
        const double var_x165 = 1 / var_x164;
        const double var_x166 = 1 / (0.00050000000000000001 + 0.0089999999999999993 * var_x165);
        const double var_x167 = 0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x168 = exp(2.0 + var_x167);
        const double var_x169 = 1.0 + var_x168;
        const double var_x170 = exp(6.0 + var_x167);
        const double var_x171 = 1.0 + var_x170;
        const double var_x172 = 1 / var_x171;
        const double var_x173 = 1 / (0.29999999999999999 + 0.047 * var_x172);
        const double var_x174 = exp(1.5669291338582676 - 0.07874015748031496 * var_chaste_interface__membrane__V);
        const double var_x175 = 1.0 + var_x174;
        const double var_x176 = -1.0 + 0.050000000000000003 * var_chaste_interface__membrane__V;
        const double var_x177 = exp(-pow(var_x176, 2.0));
        const double var_x178 = 1 / (0.69999999999999996 + 0.40000000000000002 * var_x177);
        const double var_x179 = exp(-2.5 - 0.16666666666666666 * var_chaste_interface__membrane__V);
        const double var_x180 = 1.0 + var_x179;
        const double var_x181 = 1 + 0.049658350548228189 * var_chaste_interface__membrane__V;
        const double var_x182 = exp(-0.82285842787521646 * pow(var_x181, 2.0));
        const double var_x183 = 1 / (0.031179999999999999 + 0.21718000000000001 * var_x182);
        const double var_x184 = 0.00037425551606170876 * var_x40;
        const double var_x185 = var_x47 * var_x53;
        const double var_x186 = 5.9422276849488687e-11 * var_x66;
        const double var_x187 = 1.9807425616496229e-7 * var_x24;
        const double var_x188 = 1.7826683054846605e-10 * var_x66;
        const double var_x189 = 5.9422276849488691e-7 * var_x24;
        const double var_x190 = 1.0307938958145773e-5 * var_x59;
        const double var_x191 = var_x46 * var_x58;
        const double var_x192 = 8.8070109612833444e-7 * var_x8;
        const double var_x193 = 0.00024950367737447253 * var_x40;
        const double var_x194 = 0.00034849397687453332 * var_x11 - 1.3210516441925017e-5 * var_chaste_interface__membrane__V;
        const double var_x195 = 0.00012778112485399554 * var_x11 - 4.8438560287058398e-6 * var_chaste_interface__membrane__V;
        const double var_x196 = 4.6465863583271106e-5 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x197 = 2.3232931791635553e-5 * var_x91;
        const double var_x198 = 0.00012778112485399554 * var_x17;
        const double var_x199 = 0.00034849397687453332 * var_x18;
        const double var_x200 = 0.017834197196598772 - 0.00029723661994331287 * var_chaste_interface__membrane__V;
        ...
        const double var_x204 = 4.3692850624624026e-10 * var_x66;
        const double var_x205 = 1.4564283541541345e-6 * var_x24;
        const double var_x206 = 4.369285062462403e-6 * var_x24;
        const double var_x207 = 1.3107855187387209e-9 * var_x66;
        const double var_x208 = 7.5793668809895375e-5 * var_x59;
        const double var_x209 = 4.8547611805137808e-7 * var_x24;
        const double var_x210 = 1.4564283541541343e-10 * var_x66;
        const double var_x211 = -0.0026226760583233488 + 4.3711267638722479e-5 * var_chaste_interface__membrane__V;
        const double var_x212 = var_x211 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        const double var_x213 = 6.4757433538848112e-6 * var_x8;
        const double var_x214 = 0.0018345858630475916 * var_x40;
        const double var_x215 = 9.7136150308272176e-5 * var_chaste_interface__membrane__V - 0.0025624557123127443 * var_x11;
        const double var_x216 = 3.5616588446366462e-5 * var_chaste_interface__membrane__V - 0.00093956709451467298 * var_x11;
        const double var_x217 = 0.00034166076164169929 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x218 = 0.0025624557123127443 * var_x18;
        const double var_x219 = 0.00017083038082084964 * var_x91;
        const double var_x220 = 0.00093956709451467298 * var_x17;
        const double var_x221 = 23.501339000540227 * var_x112;
        const double var_x222 = 0.00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x223 = 1 / var_x222;
        const double var_x224 = pow((var_x223 * var_chaste_interface__intracellular_ion_concentrations__Ca_i), 4.0);
        const double var_x225 = 0.20380000000000001 * var_x224;
        const double var_x226 = var_x222 * var_x64 * (4.0 * var_x223 - 4.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x222, 2));
        const double var_x227 = var_x225 * var_x226 * var_chaste_interface__Ca_handling_by_the_SR__F1;
        const double var_x228 = 0.0030000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_d;
        const double var_x229 = 1 / var_x228;
        const double var_x230 = 0.20380000000000001 * pow((var_x229 * var_chaste_interface__intracellular_ion_concentrations__Ca_d), 4.0);
        const double var_x231 = var_x228 * var_x230 * (4.0 * var_x229 - 4.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_d / pow(var_x228, 2)) * var_chaste_interface__Ca_handling_by_the_SR__F1 / var_chaste_interface__intracellular_ion_concentrations__Ca_d;
        const double var_x232 = 0.33960000000000001 * var_x224;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0027856000000000005 + 0.00041666666666666669 * var_x31 + 0.0044367792453369548 * var_x61 + 3.5412649999999997e-5 * var_x57 + 0.0034116700966722959 * var_x33 - 0.02 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n - 0.059999999999999998 * var_x16 - 0.055 * var_x17 - 0.14999999999999999 * var_x18 - 0.0044367792453369548 * var_x60 - 0.00074968400000000003 * var_x29 + (-0.13500000000000001 * var_x4 - 0.13500000000000001 * var_x5) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L - var_x37 * var_x41 - var_x47 * var_x54 - var_x9 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a);
        IJth(rJacobian, 1, 0) = -6.9294442944473487e-8 + 6.6024752054987431e-8 * var_x29;
        IJth(rJacobian, 2, 0) = 0.00012180267965895249 * var_x121 * var_x125 / pow(var_x122, 2) + 1.468001359494415 * var_x124 * pow(var_x123, 1.0) * (-var_chaste_interface__sodium_current_m_gate__m + 1.0 / var_x122) / pow((0.57142857142857151 + var_x124), 2);
        IJth(rJacobian, 3, 0) = -var_x129 * var_x132 + 0.010416666666666666 * var_x134 * (var_x133 - var_chaste_interface__sodium_current_h1_gate__h1) / pow((0.01 + var_x128), 2);
        IJth(rJacobian, 4, 0) = -var_x132 * var_x135 + 0.0026041666666666665 * var_x134 * (var_x133 - var_chaste_interface__sodium_current_h2_gate__h2) / pow((0.025000000000000001 + var_x128), 2);
        IJth(rJacobian, 5, 0) = 0.00017241379310344829 * var_x136 * var_x140 / pow(var_x137, 2) + 0.028806584362139918 * var_x139 * pow(var_x138, 1.0) * (-var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L + 1.0 / var_x137) / pow((0.7407407407407407 + var_x139), 2);
        IJth(rJacobian, 6, 0) = -var_x144 * var_x147 + 0.0023962886281726861 * var_x143 * var_x148 * (var_x149 - var_chaste_interface__L_type_Ca_channel_f_L1_gate__f_L_1) / pow((0.062111801242236024 + var_x143), 2);
        IJth(rJacobian, 7, 0) = -var_x147 * var_x151 + 0.00029779079580167985 * var_x148 * var_x150 * (var_x149 - var_chaste_interface__L_type_Ca_channel_f_L2_gate__f_L_2) / pow((0.046986414471215196 + var_x150), 2);
        IJth(rJacobian, 8, 0) = 9.0909090909090917e-5 * var_x152 * var_x155 / pow(var_x153, 2) + 0.00063492063492063492 * var_x154 * pow(var_chaste_interface__membrane__V, 1.0) * (-var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + 1.0 / var_x153) / pow((0.42857142857142855 + var_x154), 2);
        IJth(rJacobian, 9, 0) = -8.6956521739130441e-5 * var_x156 * var_x160 / pow(var_x157, 2) + 0.00097276126503382458 * var_x159 * pow(var_x158, 1.0) * (-var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s + 1.0 / var_x157) / pow((0.02938487115544472 + var_x159), 2);
        IJth(rJacobian, 10, 0) = 0.000125 * var_x161 * var_x166 / pow(var_x162, 2) + 0.0092592592592592605 * var_x163 * (-var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus + 1.0 / var_x162) / (pow(var_x164, 2) * pow((0.055555555555555559 + var_x165), 2));
        IJth(rJacobian, 11, 0) = -4.0000000000000003e-5 * var_x168 * var_x173 / pow(var_x169, 2) + 5.2222222222222227e-5 * var_x170 * (0.59999999999999998 - var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus + 0.40000000000000002 / var_x169) / (pow(var_x171, 2) * pow((1 + 0.15666666666666668 * var_x172), 2));
        IJth(rJacobian, 12, 0) = 7.874015748031497e-5 * var_x174 * var_x178 / pow(var_x175, 2) + 8.1632653061224504e-5 * var_x177 * pow(var_x176, 1.0) * (-var_chaste_interface__delayed_rectifier_K_currents_n_gate__n + 1.0 / var_x175) / pow((1 + 0.57142857142857151 * var_x177), 2);
        IJth(rJacobian, 13, 0) = 0.00016666666666666666 * var_x179 * var_x183 / pow(var_x180, 2) + 0.0003762942468274375 * var_x182 * pow(var_x181, 1.0) * (-var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a + 1.0 / var_x180) / pow((0.14356754765632193 + var_x182), 2);
        IJth(rJacobian, 14, 0) = -1.0673921144856187e-7 + 9.3563879015427191e-9 * var_x57 + 3.9074763446477007e-7 * var_x61 - 1.0307938958145771e-5 * var_x185 - 3.9074763446477007e-7 * var_x60 - 1.9807425616496229e-7 * var_x29 - var_x184 * var_x37;
        IJth(rJacobian, 15, 0) = 3.669587900534727e-8 * var_x31 + 3.0046615937675521e-7 * var_x33 - 1.7614021922566689e-6 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n - 4.8438560287058398e-6 * var_x17 - 1.3210516441925017e-5 * var_x18 - 6.237591934361813e-9 * var_x57 - 5.2842065767700066e-6 * var_x16 + var_x193 * var_x37 - var_x192 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a;
        ...
        IJth(rJacobian, 21, 0) = 7.8484714300413141e-7 + 2.8731443710644852e-6 * var_x60 + 1.4564283541541345e-6 * var_x29 + 7.5793668809895362e-5 * var_x185 - 2.8731443710644852e-6 * var_x61 - 6.879696986428469e-8 * var_x57 + var_x203 * var_x37;
        IJth(rJacobian, 22, 0) = 5.0951796282701088e-7 - 4.8547611805137808e-7 * var_x29 + (4.3711267638722479e-5 * var_x4 + 4.3711267638722479e-5 * var_x5) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        IJth(rJacobian, 23, 0) = 1.2951486707769622e-5 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n + 3.885446012330887e-5 * var_x16 + 4.5864646576189795e-8 * var_x57 + 9.7136150308272176e-5 * var_x18 + 3.5616588446366462e-5 * var_x17 - 2.6982263974520048e-7 * var_x31 - 2.2093099954173172e-6 * var_x33 + var_x213 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a - var_x214 * var_x37;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.080000000000000002 * var_x65 - 0.080000000000000002 * var_x63 - 0.020756080744462984 * var_x64 + var_x19 * var_x67 + var_x68 * var_x69);
        IJth(rJacobian, 1, 1) = -47.274000000000001 - var_x113 + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 3.5228043845133377e-6 * var_x65 + 9.0 * var_chaste_interface__intracellular_Ca_buffering__O_C + 6.2720000000000002 * var_chaste_interface__intracellular_Ca_buffering__O_TC + 7.3978892074780085e-7 * var_x114 - 3.5228043845133377e-6 * var_x63 - 8.2198768971977891 * var_x109 - 9.1399515314883835e-7 * var_x64 - var_x115 * var_x69 - var_x116 * var_x19;
        IJth(rJacobian, 14, 1) = var_x186 * var_x19 + var_x187 * var_x69;
        ...
        IJth(rJacobian, 21, 1) = -var_x19 * var_x204 - var_x205 * var_x69;
        IJth(rJacobian, 22, 1) = 2.5902973415539245e-5 * var_x63 + 6.7205525966826341e-6 * var_x64 - 2.5902973415539245e-5 * var_x65 + var_x19 * var_x210 + var_x209 * var_x69;
        IJth(rJacobian, 24, 1) = var_x221;
        IJth(rJacobian, 25, 1) = 121.85879481761599 * var_x109 - 1.0967291533585437e-5 * var_x114;
        IJth(rJacobian, 27, 1) = -var_x227;
        IJth(rJacobian, 28, 1) = var_x227 - var_x226 * var_x232 * var_chaste_interface__Ca_handling_by_the_SR__F2;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.3511272667921278 * var_x71);
        IJth(rJacobian, 2, 2) = -0.001 * var_x125;
        IJth(rJacobian, 14, 2) = -3.092381687443731e-5 * var_x71;
        ...
        IJth(rJacobian, 3, 3) = -0.001 * var_x129;
        ...
        IJth(rJacobian, 23, 8) = var_x215 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s;
        ...
        IJth(rJacobian, 9, 9) = -0.001 * var_x160;
        IJth(rJacobian, 15, 9) = var_x194 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        IJth(rJacobian, 23, 9) = var_x215 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        ...
        IJth(rJacobian, 10, 10) = -0.001 * var_x166;
        IJth(rJacobian, 15, 10) = var_x195 * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus;
        IJth(rJacobian, 23, 10) = var_x216 * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus;
        ...
        IJth(rJacobian, 11, 11) = -0.001 * var_x173;
        IJth(rJacobian, 15, 11) = var_x195 * var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus;
        IJth(rJacobian, 23, 11) = var_x216 * var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (0.52760083741851238 * var_x11 - 0.02 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 12, 12) = -0.001 * var_x178;
        IJth(rJacobian, 15, 12) = 4.6465863583271106e-5 * var_x11 - 1.7614021922566689e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 23, 12) = 1.2951486707769622e-5 * var_chaste_interface__membrane__V - 0.00034166076164169929 * var_x11;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x30 * var_x9);
        IJth(rJacobian, 13, 13) = -0.001 * var_x183;
        IJth(rJacobian, 15, 13) = -var_x192 * var_x30;
        IJth(rJacobian, 23, 13) = var_x213 * var_x30;
        ...
        IJth(rJacobian, 1, 14) = var_x117 * var_x82 - var_x118 * var_x79;
        IJth(rJacobian, 14, 14) = 4.2177556280432994e-7 * var_x84 - 2.8157848672826461e-6 * var_x43 - 0.00056138327409256314 * var_x85 + var_x188 * var_x79 - var_x189 * var_x82 - var_x190 * var_x44;
        IJth(rJacobian, 15, 14) = 0.00037425551606170876 * var_x85 - 2.8118370853621996e-7 * var_x84;
        IJth(rJacobian, 21, 14) = 0.0041278181918570815 * var_x85 + 2.0704300494725335e-5 * var_x43 - 3.1012909029730139e-6 * var_x84 + var_x206 * var_x82 + var_x208 * var_x44 - var_x207 * var_x79;
        IJth(rJacobian, 22, 14) = var_x204 * var_x79 - var_x205 * var_x82;
        IJth(rJacobian, 23, 14) = 2.067527268648676e-6 * var_x84 - 0.0027518787945713876 * var_x85;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.090000000000000024 * var_x93 - 1.5828025122555371 * var_x89 - var_x10 * var_x87 - var_x10 * var_x88 - var_x10 * var_x90 - var_x10 * var_x92);
        IJth(rJacobian, 15, 15) = 7.9263098651550125e-6 * var_x93 - 0.00013939759074981331 * var_x89 - var_x10 * var_x196 - var_x10 * var_x197 - var_x10 * var_x198 - var_x10 * var_x199;
        IJth(rJacobian, 23, 15) = 0.0010249822849250979 * var_x89 - 5.8281690184963319e-5 * var_x93 + var_x10 * var_x217 + var_x10 * var_x218 + var_x10 * var_x219 + var_x10 * var_x220;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75 * var_x95);
        IJth(rJacobian, 1, 16) = 0.002;
        IJth(rJacobian, 16, 16) = -0.10000000000000001 + var_x201 * var_x95;
        IJth(rJacobian, 22, 16) = var_x212 * var_x95;
        IJth(rJacobian, 27, 16) = -var_x231;
        ...
        IJth(rJacobian, 1, 19) = 0.0010560000000000001 + var_x119;
        IJth(rJacobian, 19, 19) = -0.0066 + var_x202;
        IJth(rJacobian, 20, 19) = -5.0;
        IJth(rJacobian, 1, 20) = var_x119;
        IJth(rJacobian, 19, 20) = var_x202;
        IJth(rJacobian, 20, 20) = -5.6660000000000004;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86 + 0.031972083146724437 * var_x96 + var_x80 * var_x97 + var_x81 * var_x98 - var_x46 * var_x54 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 1, 21) = -var_x117 * var_x98 - var_x118 * var_x97;
        IJth(rJacobian, 14, 21) = var_x190 + 2.8157848672826461e-6 * var_x96 - 1.0307938958145771e-5 * var_x191 + var_x188 * var_x97 + var_x189 * var_x98;
        IJth(rJacobian, 21, 21) = -6.9930069930069916e-5 - var_x208 + 7.5793668809895362e-5 * var_x191 - 2.0704300494725335e-5 * var_x96 - var_x206 * var_x98 - var_x207 * var_x97;
        IJth(rJacobian, 22, 21) = var_x204 * var_x97 + var_x205 * var_x98;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (0.020756080744462984 * var_x99 + var_x21 * var_x67 - var_x100 * var_x68);
        IJth(rJacobian, 1, 22) = 9.1399515314883835e-7 * var_x99 + var_x100 * var_x115 - var_x116 * var_x21;
        IJth(rJacobian, 14, 22) = var_x186 * var_x21 - var_x100 * var_x187;
        IJth(rJacobian, 21, 22) = var_x100 * var_x205 - var_x204 * var_x21;
        IJth(rJacobian, 22, 22) = -4.048582995951417e-5 - 6.7205525966826341e-6 * var_x99 + var_x21 * var_x210 - var_x100 * var_x209;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (1.5828025122555371 * var_x102 - 0.090000000000000024 * var_x105 - 0.026741999999999998 * var_x104 + var_x103 * var_x87 + var_x103 * var_x88 + var_x103 * var_x90 + var_x103 * var_x92 + var_x107 * var_x41 - var_x106 * var_x41);
        IJth(rJacobian, 14, 23) = var_x107 * var_x184 - var_x106 * var_x184;
        IJth(rJacobian, 15, 23) = 0.00013939759074981331 * var_x102 - 7.9263098651550125e-6 * var_x105 - 2.3551708712663921e-6 * var_x104 + var_x103 * var_x196 + var_x103 * var_x197 + var_x103 * var_x198 + var_x103 * var_x199 + var_x106 * var_x193 - var_x107 * var_x193;
        IJth(rJacobian, 21, 23) = var_x106 * var_x203 - var_x107 * var_x203;
        IJth(rJacobian, 23, 23) = -0.0001 + 1.7317432876958762e-5 * var_x104 + 5.8281690184963319e-5 * var_x105 - 0.0010249822849250979 * var_x102 + var_x107 * var_x214 - var_x103 * var_x217 - var_x103 * var_x218 - var_x103 * var_x219 - var_x103 * var_x220 - var_x106 * var_x214;
        IJth(rJacobian, 1, 24) = var_x113;
        IJth(rJacobian, 24, 24) = -14.98 - var_x221 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse;
        ...
        IJth(rJacobian, 1, 25) = 0.00078910818213098776 * var_x109 + 1.7754934097947222e-10 * var_x114;
        IJth(rJacobian, 24, 25) = 0.10000000000000001;
        IJth(rJacobian, 25, 25) = -0.011111111111111112 - 2.632149968060505e-9 * var_x114 - 0.011698444302491135 * var_x109;
        ...
        IJth(rJacobian, 27, 27) = -0.00081499999999999997 - var_x225 - var_x230;
        IJth(rJacobian, 28, 27) = var_x225 + var_x230;
        IJth(rJacobian, 1, 28) = var_x113 * var_x120;
        IJth(rJacobian, 24, 28) = -var_x120 * var_x221;
        IJth(rJacobian, 27, 28) = -0.00081499999999999997;
        IJth(rJacobian, 28, 28) = -0.033960000000000004 - var_x232;
    }
