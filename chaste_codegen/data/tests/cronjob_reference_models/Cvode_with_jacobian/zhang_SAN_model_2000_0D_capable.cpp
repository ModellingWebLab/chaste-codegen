...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 0) = 0001; // (var_ionic_concentrations__Ca_i) [millimolar]
    }
    ...
    double Cellzhang_SAN_model_2000_0D_capableFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_persistent_calcium_current__i_Ca_p = NV_Ith_S(mParameters, 0) * var_persistent_calcium_current__i_Ca_p_max / (00040000000000000002 + NV_Ith_S(mParameters, 0)); // nanoA
