...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmatsuoka_model_2003FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x10 = 1 / var_chaste_interface__internal_ion_concentrations__Ki;
        const double var_x11 = log(5.4000000000000004 * var_x10);
        const double var_x12 = exp(-2.1000000000000001 + 0.014999999999999999 * var_chaste_interface__membrane__Vm - 0.40069247885978071 * var_x11);
        const double var_x13 = 1.0 + var_x12;
        const double var_x14 = 0.035000000000000003 * var_chaste_interface__membrane__Vm;
        const double var_x15 = 0.93494911733948838 * var_x11;
        const double var_x16 = exp(-0.35000000000000003 + var_x14 - var_x15);
        const double var_x17 = var_x16 / var_x13;
        const double var_x18 = exp(-2.4319999999999999 + 0.064000000000000001 * var_chaste_interface__membrane__Vm - 1.7096212431350644 * var_x11);
        const double var_x19 = 1.0 + var_x18;
        const double var_x20 = exp(-2.1000000000000001 + 0.029999999999999999 * var_chaste_interface__membrane__Vm - 0.80138495771956142 * var_x11);
        const double var_x21 = 1.0 + var_x20;
        const double var_x22 = 1.2822159323512983 * var_x11;
        const double var_x23 = 0.048000000000000001 * var_chaste_interface__membrane__Vm;
        const double var_x24 = exp(0.47999999999999998 + var_x22 - var_x23);
        const double var_x25 = var_x24 / var_x21;
        const double var_x26 = var_x19 * var_x25;
        const double var_x27 = 0.75 * var_x17 + 3.0 * var_x26;
        const double var_x28 = 1 / var_x27;
        const double var_x29 = var_x26 * var_x28;
        const double var_x30 = pow(var_x29, 4.0);
        const double var_x31 = 81.0 * var_x30;
        const double var_x32 = var_x17 * var_x28;
        const double var_x33 = pow(var_x29, 2.0) * pow(var_x32, 2.0);
        const double var_x34 = pow(var_x29, 3.0);
        const double var_x35 = var_x32 * var_x34;
        const double var_x36 = var_x31 + 54.0 * var_x35 + 10.125 * var_x33;
        const double var_x37 = 1.1459999999999999 * var_x36;
        const double var_x38 = 0.40000000000000002 * var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2 + 0.59999999999999998 * var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1;
        const double var_x39 = 0.0086400000000000001 * var_x38;
        const double var_x40 = exp(-0.025455930765222609 * var_chaste_interface__membrane__Vm);
        const double var_x41 = var_x40 * (1.0 - var_chaste_interface__sodium_calcium_exchanger_y_gate__y);
        const double var_x42 = var_x12 * var_x16 / pow(var_x13, 2);
        const double var_x43 = var_x18 * var_x25;
        const double var_x44 = var_x19 * var_x20 * var_x24 / pow(var_x21, 2);
        const double var_x45 = 0.01125 * var_x42 + 0.089999999999999997 * var_x44 + 0.14400000000000002 * var_x26 - 0.192 * var_x43 - 0.026250000000000002 * var_x17;
        const double var_x46 = pow((var_x26 + 0.25 * var_x17), (-2));
        const double var_x47 = var_x17 * var_x46;
        const double var_x48 = 6.0 * var_x34 * var_x47;
        const double var_x49 = var_x28 * var_x42;
        const double var_x50 = var_x34 * var_x49;
        const double var_x51 = 0.1111111111111111 * var_x47;
        const double var_x52 = 20.25 * var_x27 * var_x33;
        const double var_x53 = var_x13 * var_x52 * exp(0.35000000000000003 + var_x15 - var_x14);
        const double var_x54 = var_x28 * var_x43;
        const double var_x55 = 0.1111111111111111 * var_x26 * var_x46;
        const double var_x56 = var_x28 * var_x44;
        const double var_x57 = var_x21 * exp(-0.47999999999999998 + var_x23 - var_x22) / var_x19;
        const double var_x58 = var_x57 * (0.064000000000000001 * var_x54 - 0.029999999999999999 * var_x56 - 0.048000000000000001 * var_x29 + var_x45 * var_x55);
        const double var_x59 = 324.0 * var_x27;
        const double var_x60 = var_x30 * var_x59;
        const double var_x61 = 162.0 * var_x17 * var_x34;
        const double var_x62 = 1.8900000000000001 * var_x35 - 0.80999999999999994 * var_x50 + var_x45 * var_x48 + var_x52 * var_x58 + var_x53 * (0.035000000000000003 * var_x32 - 0.014999999999999999 * var_x49 + var_x45 * var_x51) + var_x58 * var_x60 + var_x58 * var_x61;
        const double var_x63 = -26.71283192398538 * var_x11 + var_chaste_interface__membrane__Vm;
        const double var_x64 = var_x63 * var_chaste_interface__time_independent_potassium_current_y_gate__y;
        const double var_x65 = 1.1459999999999999 * var_x64;
        const double var_x66 = 1.0 - var_chaste_interface__sodium_potassium_pump_y_gate__y;
        const double var_x67 = 0.032538669148722783 * var_chaste_interface__membrane__Vm;
        const double var_x68 = exp(var_x67);
        const double var_x69 = var_x68 / pow((0.067138346456864173 + var_x68), 2);
        const double var_x70 = var_x66 * var_x69;
        const double var_x71 = 1 / var_chaste_interface__internal_ion_concentrations__Nai;
        const double var_x72 = pow(var_x71, 3.0);
        const double var_x73 = 0.052380000000000003 - var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x74 = sqrt(pow(var_x73, 2.0) + 0.0095200000000000007 * var_chaste_interface__internal_ion_concentrations__Ca_Total);
        const double var_x75 = var_x72 * (-17.978260869565222 + 362.31884057971018 * var_x74 + 362.31884057971018 * var_chaste_interface__internal_ion_concentrations__Ca_Total);
        const double var_x76 = exp(0.011979261536575345 * var_chaste_interface__membrane__Vm);
        const double var_x77 = var_x76 / (1.0 + 669.921875 * var_x75);
        const double var_x78 = var_x77 * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
        const double var_x79 = -0.50016960905426588 * var_x9 - 0.0018350576517438713 * var_x70 - 0.081578771064078098 * var_x78 - 0.11094109923957883 * var_x41 - var_x37 * var_chaste_interface__time_independent_potassium_current_y_gate__y - var_x39 * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3 - var_x62 * var_x65;
        const double var_x80 = var_chaste_interface__membrane__Vm == 0.0;
        const double var_x81 = exp(-0.037435192301797954 * var_chaste_interface__membrane__Vm);
        const double var_x82 = 1.0 - var_x81;
        const double var_x83 = 1 / var_x82;
        const double var_x84 = -5.4000000000000004 * var_x81 + var_chaste_interface__internal_ion_concentrations__Ki;
        const double var_x85 = var_x83 * var_x84;
        const double var_x86 = var_x83 * var_chaste_interface__membrane__Vm;
        const double var_x87 = var_x81 * var_x86;
        const double var_x88 = var_x81 * var_chaste_interface__membrane__Vm / pow(var_x82, 2);
        const double var_x89 = var_x84 * var_x88;
        const double var_x90 = exp(-0.074870384603595908 * var_chaste_interface__membrane__Vm);
        const double var_x91 = 1.0 - var_x90;
        const double var_x92 = 1 / var_x91;
        const double var_x93 = 0.5 * var_x74 + 0.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x94 = -0.026190000000000001 + var_x93;
        const double var_x95 = var_x94 - 1.8 * var_x90;
        const double var_x96 = var_x92 * var_x95;
        const double var_x97 = -140.0 * var_x81 + var_chaste_interface__internal_ion_concentrations__Nai;
        const double var_x98 = 0.00010918597754691071 * var_x83;
        const double var_x99 = var_x83 * var_x97;
        const double var_x100 = 1 / var_x94;
        const double var_x101 = pow(var_x100, 3.0);
        const double var_x102 = 1.0 + 1.7279999999999996e-9 * var_x101;
        const double var_x103 = 1 / var_x102;
        const double var_x104 = 3.1195993584831627e-5 * var_x103;
        const double var_x105 = var_x92 * var_chaste_interface__membrane__Vm;
        const double var_x106 = var_x105 * var_x90;
        const double var_x107 = var_x90 * var_x95 * var_chaste_interface__membrane__Vm / pow(var_x91, 2);
        const double var_x108 = var_x88 * var_x97;
        ...
        const double var_x112 = 5.7173748242745964e-5 * var_x111;
        const double var_x113 = var_x96 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2;
        const double var_x114 = 0.34712632861667192 * var_x113;
        const double var_x115 = var_chaste_interface__sodium_current_ultra_slow_gate__y * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na;
        const double var_x116 = 0.8110958332056224 * var_x115;
        const double var_x117 = pow(var_chaste_interface__transient_outward_current_y1_gate__y1, 3.0);
        const double var_x118 = var_x117 * var_chaste_interface__transient_outward_current_y2_gate__y2;
        const double var_x119 = 9.358798075449489e-6 * var_x118;
        const double var_x120 = 0.081109583320562242 * var_x115;
        const double var_x121 = 0.0014293437060686491 * var_x111;
        const double var_x122 = 8.4229182679045397e-7 * var_x118;
        const double var_x123 = var_x103 * var_x87;
        const double var_x124 = 1.1678280188938273e-6 * var_x103;
        const double var_x125 = var_x111 * var_x87;
        const double var_x126 = var_x115 * var_x87;
        const double var_x127 = var_chaste_interface__T_type_Ca_channel_y1_gate__y1 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2;
        const double var_x128 = var_x106 * var_x127;
        const double var_x129 = var_x118 * var_x87;
        const double var_x130 = var_x115 * var_x89;
        const double var_x131 = var_x108 * var_x115;
        const double var_x132 = var_x108 * var_x118;
        const double var_x133 = var_x108 * var_x111;
        const double var_x134 = var_x118 * var_x89;
        const double var_x135 = var_x107 * var_x127;
        const double var_x136 = var_x111 * var_x89;
        const double var_x137 = 1 / var_chaste_interface__ATP_production__ATPi;
        const double var_x138 = pow(var_x137, 3.0);
        const double var_x139 = 1 / (1.0 + 2.7439999999999993 * var_x138);
        const double var_x140 = var_x139 * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y;
        const double var_x141 = var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U + var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_UCa;
        const double var_x142 = var_x141 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x143 = var_x140 * var_x142;
        const double var_x144 = var_x143 * var_x96;
        const double var_x145 = 4.5708369800495303e-5 * var_x143;
        const double var_x146 = 0.00090181378255031264 * var_x143;
        const double var_x147 = var_x143 * var_x87;
        const double var_x148 = var_x106 * var_x143;
        const double var_x149 = var_x107 * var_x143;
        const double var_x150 = var_x108 * var_x143;
        const double var_x151 = var_x143 * var_x89;
        const double var_x152 = var_x79 + 0.36996791638556448 * var_x149 + 0.0030363528491239512 * var_x130 + 1.6986589365728397e-6 * var_x107 + 1.7111016132832358e-6 * var_x150 + 0.030363528491239512 * var_x131 + 3.1531356510133335e-8 * var_x132 + 4.0873980661283962e-6 * var_x108 + 3.3759572370182757e-5 * var_x151 + 2.1403102600817781e-6 * var_x133 + 3.5034840566814821e-7 * var_x134 + 0.025989481729564445 * var_x135 + 5.3507756502044447e-5 * var_x136 - 2.2687995334423004e-5 * var_x96 - 4.9414453838373298 * var_x144 - 0.0004218559166586399 * var_x147 - 0.00058858532152248895 * var_x125 - 4.2672902941588013 * var_x126 - 0.66594224949401604 * var_x148 - 0.00016980219394716249 * var_x123 - 0.046781067113216009 * var_x128 - 3.0575860858311117e-6 * var_x106 - 6.3062713020266675e-6 * var_x129 + var_x108 * var_x124 + var_x124 * var_x89 - var_x104 * var_x85 - var_x104 * var_x99 - var_x112 * var_x99 - var_x114 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1 - var_x116 * var_x99 - var_x119 * var_x85 - var_x120 * var_x85 - var_x121 * var_x85 - var_x122 * var_x99 - var_x145 * var_x99 - var_x146 * var_x85 - var_x97 * var_x98;
        const double var_x153 = var_chaste_interface__membrane__Vm == (-3.0);
        const double var_x154 = var_x3 * var_x85;
        const double var_x155 = 3.1195993584831633e-8 * var_x154;
        const double var_x156 = var_x3 * var_x5;
        const double var_x157 = var_x156 * var_x87;
        const double var_x158 = var_x156 * var_x89;
        const double var_x159 = var_x85 * var_chaste_interface__membrane__Vm;
        const double var_x160 = var_x159 * var_x6;
        const double var_x161 = pow(var_x71, 1.0600000000000001);
        ...
        const double var_x163 = 1.0 + 0.094 * var_x137;
        const double var_x164 = 1 / var_x163;
        const double var_x165 = var_x164 / pow((0.22703754152993502 + var_x162), 2);
        const double var_x166 = var_x162 * var_x165 * var_x71;
        const double var_x167 = var_x166 * var_chaste_interface__sodium_potassium_pump_y_gate__y;
        const double var_x168 = var_x76 / pow((0.0014927113702623907 + var_x75), 2);
        const double var_x169 = var_x168 * var_x71 * var_x75;
        const double var_x170 = var_x169 * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
        const double var_x171 = -1.869926599548851 * var_x167 - 0.030496093294460638 * var_x170;
        const double var_x172 = -var_x104 * var_x86;
        const double var_x173 = 0.00025000000000000001 * var_x117;
        const double var_x174 = 2.166666666666667 * var_chaste_interface__sodium_current_ultra_slow_gate__y;
        const double var_x175 = 0.02409 * var_x140;
        const double var_x176 = var_x10 * var_x9;
        const double var_x177 = 3.8466477970538948 * var_x10 * var_x26 + 0.30051935914483552 * var_x10 * var_x42 + 2.4041548731586841 * var_x10 * var_x44 - 5.1288637294051931 * var_x10 * var_x43 - 0.70121183800461628 * var_x10 * var_x17;
        const double var_x178 = var_x57 * (var_x177 * var_x55 + 1.7096212431350644 * var_x10 * var_x54 - 1.2822159323512983 * var_x10 * var_x29 - 0.80138495771956142 * var_x10 * var_x56);
        const double var_x179 = var_x177 * var_x48 + var_x178 * var_x52 + var_x178 * var_x60 + var_x178 * var_x61 + var_x53 * (var_x177 * var_x51 + 0.93494911733948838 * var_x10 * var_x32 - 0.40069247885978071 * var_x10 * var_x49) + 50.487252336332375 * var_x10 * var_x35 - 21.637393858428158 * var_x10 * var_x50;
        const double var_x180 = var_x10 * var_x38 * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3;
        const double var_x181 = var_x10 * var_x36 * var_chaste_interface__time_independent_potassium_current_y_gate__y;
        const double var_x182 = var_x161 * var_x165 * pow(var_chaste_interface__internal_ion_concentrations__Ki, 0.12000000000000011);
        const double var_x183 = var_x182 * var_chaste_interface__sodium_potassium_pump_y_gate__y;
        const double var_x184 = 0.039516010388377508 * var_x183 - 0.23079886782323369 * var_x180 - 13.360946700152081 * var_x176 - 30.612905384887242 * var_x181 - var_x179 * var_x65;
        const double var_x185 = var_x172 + var_x184 - var_x119 * var_x86 - var_x120 * var_x86 - var_x121 * var_x86 - var_x146 * var_x86;
        const double var_x186 = var_x156 * var_x86;
        const double var_x187 = (0.0047600000000000003 - 1.0 * pow(var_x73, 1.0)) / var_x74;
        const double var_x188 = 0.5 * var_x187;
        const double var_x189 = -0.5 - var_x188;
        const double var_x190 = var_x100 * var_x101 * var_x189 / pow(var_x102, 2);
        const double var_x191 = var_x190 * var_chaste_interface__internal_ion_concentrations__Ki;
        const double var_x192 = var_x168 * var_x72 * (362.31884057971018 + 362.31884057971018 * var_x187);
        ...
        const double var_x195 = 0.5 + var_x188;
        const double var_x196 = var_x105 * var_x195;
        const double var_x197 = 0.34712632861667192 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1;
        const double var_x198 = var_x196 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2;
        const double var_x199 = var_x86 * var_x97;
        const double var_x200 = 1.6172003074376712e-13 * var_x190;
        const double var_x201 = var_x143 * var_x196;
        const double var_x202 = var_x137 * var_x138 * var_x142 * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y / pow((0.36443148688046656 + var_x138), 2);
        const double var_x203 = var_x202 * var_chaste_interface__internal_ion_concentrations__Ki;
        const double var_x204 = var_x63 * pow(var_chaste_interface__ATP_production__ATPi, 1.0) / pow((0.010000000000000002 + var_x8), 2);
        const double var_x205 = 1 / (1.0 + 4.4045579125871104 * var_x162);
        const double var_x206 = pow(var_chaste_interface__ATP_production__ATPi, (-2));
        const double var_x207 = var_x205 * var_x206 * var_chaste_interface__sodium_potassium_pump_y_gate__y / pow(var_x163, 2);
        const double var_x208 = 0.010003392181085318 * var_x204 - 0.73038000000000003 * var_x207;
        const double var_x209 = var_x96 * var_chaste_interface__membrane__Vm;
        const double var_x210 = var_x202 * var_x209;
        const double var_x211 = var_x159 * var_x202;
        const double var_x212 = var_x199 * var_x202;
        const double var_x213 = 0.8110958332056224 * var_x199;
        const double var_x214 = 0.081109583320562242 * var_x159;
        const double var_x215 = var_chaste_interface__internal_ion_concentrations__Ki * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na;
        const double var_x216 = 118.97094000000001 * var_x140;
        const double var_x217 = var_x175 * var_chaste_interface__internal_ion_concentrations__Ki;
        const double var_x218 = var_x140 * var_x141;
        const double var_x219 = 4.9414453838373298 * var_x209;
        const double var_x220 = 4.5708369800495303e-5 * var_x199;
        const double var_x221 = 0.00090181378255031264 * var_x159;
        const double var_x222 = var_x140 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x223 = ((var_x80) ? (var_x216 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL - var_x217 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL) : (-var_x219 * var_x222 - var_x220 * var_x222 - var_x221 * var_x222));
        const double var_x224 = var_x139 * var_x142;
        const double var_x225 = var_x224 * var_chaste_interface__internal_ion_concentrations__Ki;
        const double var_x226 = var_x63 * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3;
        const double var_x227 = var_x110 * pow(var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1, 1.0);
        const double var_x228 = var_x227 * var_chaste_interface__internal_ion_concentrations__Ki;
        const double var_x229 = var_x199 * var_x227;
        const double var_x230 = var_x159 * var_x227;
        const double var_x231 = var_x109 * var_chaste_interface__internal_ion_concentrations__Ki;
        const double var_x232 = var_x109 * var_x199;
        const double var_x233 = var_x109 * var_x159;
        const double var_x234 = pow(var_chaste_interface__transient_outward_current_y1_gate__y1, 2.0) * var_chaste_interface__transient_outward_current_y2_gate__y2;
        const double var_x235 = var_x234 * var_chaste_interface__internal_ion_concentrations__Ki;
        const double var_x236 = var_x159 * var_x234;
        const double var_x237 = var_x199 * var_x234;
        const double var_x238 = var_x117 * var_x159;
        const double var_x239 = var_x117 * var_x199;
        const double var_x240 = 1 / (1.0 + 14.894617648090152 * var_x68);
        const double var_x241 = var_x164 * var_x205;
        const double var_x242 = -4.1851873550156299e-5 * var_x78 - 5.69154547969736e-5 * var_x41 - 9.414287540284996e-7 * var_x70;
        const double var_x243 = 5.3347652489899843e-9 * var_x103;
        const double var_x244 = 0.00013870389647373959 * var_x115;
        const double var_x245 = 9.7771697654216435e-9 * var_x111;
        const double var_x246 = 1.4403866172272957e-10 * var_x118;
        const double var_x247 = 1.997079629808891e-10 * var_x103;
        const double var_x248 = 7.8164980428201246e-9 * var_x143;
        const double var_x249 = -0.00095931736371611973 * var_x167 - 1.5645230048035654e-5 * var_x170;
        const double var_x250 = -var_x243 * var_x86;
        const double var_x251 = 5.2150766826785515e-6 * var_x193;
        const double var_x252 = 2.7655423050764072e-17 * var_x190;
        const double var_x253 = -0.00037470252376752445 * var_x207;
        const double var_x254 = 0.00013870389647373959 * var_x199;
        const double var_x255 = 2.923211178328205e-5 * var_x140;
        const double var_x256 = 7.8164980428201246e-9 * var_x199;
        const double var_x257 = ((var_x80) ? (var_x255 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL) : (-var_x222 * var_x256));
        const double var_x258 = 1.4250668745018745e-10 * var_x3;
        const double var_x259 = 0.00019597519658149775 * var_x36;
        const double var_x260 = 1.4775093354835435e-6 * var_x38;
        const double var_x261 = 0.00019597519658149775 * var_x64;
        const double var_x262 = 6.276191693523331e-7 * var_x70 - 8.5533016979494453e-5 * var_x9 - var_x259 * var_chaste_interface__time_independent_potassium_current_y_gate__y - var_x260 * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3 - var_x261 * var_x62;
        const double var_x263 = 2.4442924413554108e-7 * var_x111;
        const double var_x264 = 1.6004295746969954e-9 * var_x118;
        const double var_x265 = 1.387038964737396e-5 * var_x115;
        const double var_x266 = 1.5421739381780246e-7 * var_x143;
        const double var_x267 = var_x262 + 5.1924070375031173e-7 * var_x130 + 5.9912388894266729e-11 * var_x134 + 9.1502557583970997e-9 * var_x136 + 5.7731577938515422e-9 * var_x151 - 4.9411381095344342e-8 * var_x125 - 2.8038998002516832e-6 * var_x126 - 3.1175052086798328e-8 * var_x147 - 3.2352690002904036e-10 * var_x129 - 1.0784230000968012e-9 * var_x123 + var_x247 * var_x89 - var_x243 * var_x85 - var_x263 * var_x85 - var_x264 * var_x85 - var_x265 * var_x85 - var_x266 * var_x85;
        const double var_x268 = 5.3347652489899846e-12 * var_x154;
        const double var_x269 = 0.00037051738737048736 * var_chaste_interface__sodium_current_ultra_slow_gate__y;
        const double var_x270 = 4.2752006235056235e-8 * var_x117;
        const double var_x271 = 4.1195833208100184e-6 * var_x140;
        const double var_x272 = -0.0052350524875515439 * var_x181 - 1.3515109780067696e-5 * var_x183 - 0.0022848291065246228 * var_x176 - 3.9468458544891228e-5 * var_x180 - var_x179 * var_x261;
        const double var_x273 = var_x250 + var_x272 - var_x263 * var_x86 - var_x264 * var_x86 - var_x265 * var_x86 - var_x266 * var_x86;
        const double var_x274 = 0.00024980168251168298 * var_x207 + 1.7106603395898892e-6 * var_x204;
        const double var_x275 = 1.387038964737396e-5 * var_x159;
        const double var_x276 = var_x271 * var_chaste_interface__internal_ion_concentrations__Ki;
        const double var_x277 = 1.5421739381780246e-7 * var_x159;
        const double var_x278 = ((var_x80) ? (-var_x276 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL) : (-var_x222 * var_x277));
        const double var_x279 = 1.8971818265657867e-5 * var_x41 + 1.3950624516718767e-5 * var_x78;
        const double var_x280 = 2.9680693930744274e-5 * var_x113;
        const double var_x281 = 0.040160975554143732 * var_chaste_interface__RyR_channel__p_open_RyR;
        const double var_x282 = var_x195 * (1.0 - var_chaste_interface__NL_model__pCB - var_chaste_interface__NL_model__pCa - var_chaste_interface__NL_model__pCaCB);
        const double var_x283 = var_x195 * var_chaste_interface__NL_model__pCB;
        const double var_x284 = 1.0 - var_chaste_interface__SR_calcium_pump_y_gate__y;
        const double var_x285 = 1.0 + 0.10000000000000001 * var_x137;
        const double var_x286 = 1 / var_x285;
        const double var_x287 = 1.0 + 0.00080000000000000004 * var_x100;
        const double var_x288 = -0.052380000000000003 + var_x74 + var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x289 = var_x189 / pow(var_x288, 2);
        const double var_x290 = var_x289 / pow(var_x287, 2);
        const double var_x291 = var_x286 * var_x290;
        const double var_x292 = var_x284 * var_x291;
        const double var_x293 = -0.00014866038531735463 + 0.00033683398851862484 * var_x292 - 2.7300000000000004 * var_x282 - 0.00014866038531735463 * var_x187 - 109.20000000000002 * var_x283 - 1.7383588942261838e-6 * var_x193 + var_x189 * var_x281;
        const double var_x294 = 2.9680693930744274e-5 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1;
        const double var_x295 = 1 / var_x287;
        const double var_x296 = var_x206 * var_x284 * var_x295 / pow(var_x285, 2);
        const double var_x297 = -0.010526062141207028 * var_x296;
        const double var_x298 = 0.010157876681449362 * var_x140;
        const double var_x299 = 0.00042251340772000675 * var_x209;
        const double var_x300 = ((var_x80) ? (var_x298 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL) : (-var_x222 * var_x299));
        const double var_x301 = 1.0 + 0.080000000000000002 / var_chaste_interface__Ca_concentrations_in_SR__Caup;
        const double var_x302 = 1 / var_x301;
        const double var_x303 = var_x286 * var_x295;
        const double var_x304 = 0.092592592592592587 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total;
        ...
        const double var_x308 = 5.4000000000000004 * var_x307;
        const double var_x309 = 0.5 + var_x308;
        const double var_x310 = var_chaste_interface__SR_calcium_pump_y_gate__y / (pow(var_x301, 2) * pow(var_chaste_interface__Ca_concentrations_in_SR__Caup, 2));
        const double var_x311 = -0.069398700000000021 + 1.3650000000000002 * var_x74 + 1.3650000000000002 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x312 = 0.95737999754118841 - var_chaste_interface__NL_model__X;
        const double var_x313 = pow(var_x312, 2.0);
        const double var_x314 = pow(var_x312, 1.0);
        const double var_x315 = var_x314 * var_chaste_interface__NL_model__pCaCB;
        const double var_x316 = 0.0025000000000000001 * var_chaste_interface__membrane__Vm;
        const double var_x317 = exp(var_x316);
        const double var_x318 = 0.0031250000000000002 * var_x317;
        const double var_x319 = exp(0.00125 * var_chaste_interface__membrane__Vm);
        const double var_x320 = 0.058823529411764705 * var_chaste_interface__membrane__Vm;
        const double var_x321 = exp(var_x320);
        const double var_x322 = (-1.5294117647058822 * var_x321 - 2.5000000000000001e-5 * var_x319) / pow((var_x321 + 0.00076923076923076923 * var_x319), 2);
        const double var_x323 = 0.0014792899408284023 * var_x322;
        const double var_x324 = exp(-0.125 * var_chaste_interface__membrane__Vm);
        const double var_x325 = exp(-0.02 * var_chaste_interface__membrane__Vm);
        const double var_x326 = 0.0050000000000000001 * var_x325;
        const double var_x327 = 0.0128375 * var_x324;
        const double var_x328 = 16.0 * (var_x326 + var_x327) / pow((var_x325 + 0.4108 * var_x324), 2);
        const double var_x329 = 1 / (26.0 * var_x321 + 0.02 * var_x319);
        const double var_x330 = 1.0 * var_x329;
        const double var_x331 = 1.25 * var_x317;
        const double var_x332 = 0.25 * var_x325 + 0.1027 * var_x324;
        const double var_x333 = 1.0 / var_x332;
        const double var_x334 = exp(-var_x316);
        const double var_x335 = 1 / (5.0 * var_x334 + 0.0001027 * var_x324);
        const double var_x336 = 0.050000000000000003 * var_chaste_interface__membrane__Vm;
        const double var_x337 = exp(var_x336);
        const double var_x338 = 1300.0 * var_x337 + 0.040000000000000001 * var_x319;
        const double var_x339 = var_x329 * var_x332 * var_x334 * var_x338;
        const double var_x340 = var_x335 * var_x339;
        const double var_x341 = 1.0 + 7.0000000000000007e-5 * var_x340;
        const double var_x342 = 65.0 * var_x337;
        const double var_x343 = 5.0000000000000002e-5 * var_x319;
        const double var_x344 = var_x332 * var_x334 * var_x335;
        const double var_x345 = 7.0000000000000007e-5 * var_x329;
        const double var_x346 = (1.28375e-5 * var_x324 + 0.012500000000000001 * var_x334) / pow((var_x334 + 2.054e-5 * var_x324), 2);
        const double var_x347 = 0.01 * (1.7500000000000002e-7 * var_x340 - 2.8000000000000003e-6 * var_x339 * var_x346 - var_x344 * var_x345 * (var_x342 + var_x343) - 1.0355029585798818e-7 * var_x322 * var_x338 * var_x344 - var_x334 * var_x335 * var_x338 * var_x345 * (-var_x326 - var_x327)) / pow(var_x341, 2);
        const double var_x348 = 1.0 - var_chaste_interface__sodium_current_voltage_dependent_gate__p_AI_Na - var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na - var_chaste_interface__sodium_current_voltage_dependent_gate__p_RP_Na;
        const double var_x349 = -0.01 + 0.01 / var_x341;
        const double var_x350 = -1.0 * var_x335;
        const double var_x351 = 0.01 * var_chaste_interface__membrane__Vm;
        const double var_x352 = exp(var_x351);
        const double var_x353 = 0.20000000000000001 * var_chaste_interface__membrane__Vm;
        const double var_x354 = exp(var_x353);
        const double var_x355 = exp(-var_x353);
        const double var_x356 = exp(-var_x351);
        const double var_x357 = exp(-0.16949152542372881 * var_chaste_interface__membrane__Vm);
        const double var_x358 = 0.015384615384615385 * var_chaste_interface__membrane__Vm;
        const double var_x359 = exp(-var_x358);
        const double var_x360 = 0.023076923076923078 * var_x359;
        const double var_x361 = 0.04576271186440678 * var_x357;
        const double var_x362 = 0.44444444444444442 * (var_x360 + var_x361) / pow((var_x359 + 0.18000000000000002 * var_x357), 2);
        const double var_x363 = exp(var_x358);
        const double var_x364 = exp(0.14285714285714285 * var_chaste_interface__membrane__Vm);
        const double var_x365 = (-68.571428571428569 * var_x364 - 0.033846153846153852 * var_x363) / pow((var_x364 + 0.0045833333333333334 * var_x363), 2);
        const double var_x366 = 4.3402777777777778e-6 * var_x365 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x367 = 1 / (480.0 * var_x364 + 2.2000000000000002 * var_x363);
        const double var_x368 = 1.0 * var_x367;
        const double var_x369 = 1.5 * var_x359 + 0.27000000000000002 * var_x357;
        const double var_x370 = 1.0 / var_x369;
        const double var_x371 = 0.13513513513513511 * var_chaste_interface__membrane__Vm;
        const double var_x372 = exp(var_x371);
        const double var_x373 = 11.0 * var_x352 + 2200000.0 * var_x372;
        const double var_x374 = var_x367 * var_x369 * var_x373;
        const double var_x375 = exp(-var_x371);
        const double var_x376 = 1 / (2.0 * var_x356 + 0.0018 * var_x375);
        const double var_x377 = 0.25 * var_x376;
        const double var_x378 = 1.0 + var_x374 * var_x377;
        const double var_x379 = 0.11 * var_x352;
        const double var_x380 = 297297.29729729728 * var_x372;
        const double var_x381 = var_x367 * var_x377;
        const double var_x382 = (0.02 * var_x356 + 0.0002432432432432432 * var_x375) / pow((var_x356 + 0.00089999999999999998 * var_x375), 2);
        const double var_x383 = 0.040000000000000001 * (-0.0625 * var_x374 * var_x382 - var_x369 * var_x381 * (var_x379 + var_x380) - var_x373 * var_x381 * (-var_x360 - var_x361) - 1.0850694444444444e-6 * var_x365 * var_x369 * var_x373 * var_x376) / pow(var_x378, 2);
        const double var_x384 = 1.0 - var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x385 = var_x384 - var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AI_CaL - var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_RP_CaL;
        const double var_x386 = -0.040000000000000001 + 0.040000000000000001 / var_x378;
        const double var_x387 = -1.0 * var_x376;
        const double var_x388 = 0.0015183713997609248 * var_x96;
        const double var_x389 = 6.9539999999999997 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x390 = var_x389 * (-var_x388 + 0.00011368105067120071 * var_x107 - 0.00020462589120816128 * var_x106);
        const double var_x391 = var_x390 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U;
        const double var_x392 = 6.9539999999999997 * var_x195;
        const double var_x393 = var_x384 * var_x392;
        const double var_x394 = -var_x393;
        const double var_x395 = var_x392 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x396 = var_x389 * (var_x195 - 0.0015183713997609248 * var_x196);
        const double var_x397 = 0.25384881599999998 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U;
        const double var_x398 = 0.01055875471393747 * var_x209 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U;
        const double var_x399 = 0.010313999999999995 + var_x93;
        const double var_x400 = var_x389 * var_x399;
        const double var_x401 = -var_x400;
        const double var_x402 = 6.9539999999999997 * var_x384 * var_x94;
        const double var_x403 = -0.34999999999999998 - var_x402;
        const double var_x404 = var_x94 - var_x388 * var_chaste_interface__membrane__Vm;
        const double var_x405 = var_x389 * var_x404;
        const double var_x406 = -var_x405;
        const double var_x407 = -0.00029999999999999997 + var_x402;
        const double var_x408 = 6.9539999999999997 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C;
        const double var_x409 = exp(0.1111111111111111 * var_chaste_interface__membrane__Vm);
        const double var_x410 = exp(-0.071428571428571425 * var_chaste_interface__membrane__Vm);
        const double var_x411 = exp(-0.17857142857142858 * var_chaste_interface__membrane__Vm);
        const double var_x412 = exp(-0.0040000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x413 = exp(0.0001 * var_chaste_interface__membrane__Vm);
        const double var_x414 = exp(0.15873015873015872 * var_chaste_interface__membrane__Vm);
        const double var_x415 = exp(0.00033333333333333332 * var_chaste_interface__membrane__Vm);
        const double var_x416 = exp(0.099009900990099015 * var_chaste_interface__membrane__Vm);
        const double var_x417 = exp(-0.14925373134328357 * var_chaste_interface__membrane__Vm);
        const double var_x418 = exp(-0.040000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x419 = 0.0033333333333333335 * var_chaste_interface__membrane__Vm;
        const double var_x420 = exp(-0.32333333333333331 + var_x419 - 0.089042773079951273 * var_x11);
        const double var_x421 = exp(-11.411764705882353 + 0.11764705882352941 * var_chaste_interface__membrane__Vm - 3.1426861087041624 * var_x11);
        const double var_x422 = 1.5624999999999999e-8 * (1.0 - var_chaste_interface__time_independent_potassium_current_y_gate__y) / pow((var_x421 + 0.00087500000000000002 * var_x420), 2);
        const double var_x423 = exp(10.659340659340661 + 2.9354760356027891 * var_x11 - 0.10989010989010989 * var_chaste_interface__membrane__Vm);
        const double var_x424 = 0.002 * var_chaste_interface__membrane__Vm;
        const double var_x425 = exp(0.19400000000000001 - var_x424 + 0.053425663847970761 * var_x11);
        const double var_x426 = var_x30 * var_chaste_interface__time_independent_potassium_current_y_gate__y;
        const double var_x427 = 2024.9999999999998 * var_x426 / pow((var_x425 + 0.00069999999999999988 * var_x423), 2);
        const double var_x428 = 1 / (0.00013999999999999999 * var_x423 + 0.20000000000000001 * var_x425);
        const double var_x429 = var_x426 * var_x428 * var_x59;
        const double var_x430 = exp(-var_x336);
        const double var_x431 = 0.035714285714285712 * var_chaste_interface__membrane__Vm;
        const double var_x432 = exp(var_x431);
        const double var_x433 = exp(0.001 * var_chaste_interface__membrane__Vm);
        const double var_x434 = pow((var_x433 + 0.80000000000000004 * var_x432), (-2));
        const double var_x435 = exp(-var_x419);
        const double var_x436 = exp(-0.086956521739130432 * var_chaste_interface__membrane__Vm);
        const double var_x437 = exp(var_x0);
        const double var_x438 = exp(var_x419);
        const double var_x439 = exp(-var_x320);
        const double var_x440 = exp(-0.0066666666666666671 * var_chaste_interface__membrane__Vm);
        const double var_x441 = exp(-0.095238095238095233 * var_chaste_interface__membrane__Vm);
        const double var_x442 = exp(-0.016129032258064516 * var_chaste_interface__membrane__Vm);
        const double var_x443 = exp(-var_x431);
        const double var_x444 = exp(var_x424);
        const double var_x445 = exp(0.0625 * var_chaste_interface__membrane__Vm);
        const double var_x446 = 0.088495575221238937 * var_chaste_interface__membrane__Vm;
        const double var_x447 = exp(1.1946902654867255 + var_x446);
        const double var_x448 = 1.0 + 0.067083000000000004 * var_x447;
        const double var_x449 = 0.17699115044247787 * var_chaste_interface__membrane__Vm;
        const double var_x450 = exp(-1.1946902654867255 - var_x446);
        const double var_x451 = 1.0 + 0.051334999999999999 * var_x450;
        const double var_x452 = 1.0 - var_chaste_interface__transient_outward_current_y2_gate__y2;
        const double var_x453 = var_x447 / var_x448;
        const double var_x454 = var_x450 / var_x451;
        const double var_x455 = 1.0 + 0.0014927113702623905 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 3.0);
        const double var_x456 = 1.0 + 0.0013799999999999999 * var_x100 * var_x455;
        const double var_x457 = pow(var_x456, (-2));
        const double var_x458 = exp(-var_x67);
        const double var_x459 = pow(var_x10, 1.1200000000000001);
        const double var_x460 = var_x459 * (1.0 + 0.22703754152993499 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 1.0600000000000001));
        const double var_x461 = pow((0.020000293738509214 + var_x460), (-2));
        const double var_x462 = 0.75918569988046247 * var_x144;
        const double var_x463 = 0.10231294560408065 * var_x148;
        const double var_x464 = 0.056840525335600363 * var_x149;
        const double var_x465 = 140000.0 * pow(var_x288, 1.0) * (1 + var_x187);
        const double var_x466 = var_x465 * var_chaste_interface__RyR_channel__p_close_RyR;
        const double var_x467 = 0.75918569988046247 * var_x201;
        const double var_x468 = var_x202 * var_chaste_interface__RyR_channel__p_close_RyR;
        const double var_x469 = 19.954810495626827 * var_x468;
        const double var_x470 = 0.83001352027747377 * var_x209 * var_x468;
        const double var_x471 = 18.251999999999999 * var_chaste_interface__RyR_channel__p_close_RyR;
        const double var_x472 = var_x218 * var_x471;
        const double var_x473 = 0.75918569988046247 * var_x209;
        const double var_x474 = var_x473 * var_chaste_interface__RyR_channel__p_close_RyR;
        const double var_x475 = var_x218 * var_x474;
        const double var_x476 = var_x222 * var_x471;
        const double var_x477 = var_x222 * var_x474;
        const double var_x478 = ((var_x80) ? (var_x476) : (-var_x477));
        const double var_x479 = var_x224 * var_x471;
        const double var_x480 = var_x224 * var_x474;
        const double var_x481 = 1.0 + 0.35999999999999999 / (-5.4000000000000004 + 0.5 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total + 5.4000000000000004 * var_x306);
        const double var_x482 = 70000.0 * pow(var_x288, 2.0);
        const double var_x483 = 18.251999999999999 * var_x143;
        const double var_x484 = var_x143 * var_x473;
        const double var_x485 = -1 + var_x306;
        const double var_x486 = ((var_x80) ? (-var_x476) : (var_x477));
        const double var_x487 = var_x304 + var_x485;
        const double var_x488 = -0.010993320000000001 * pow(var_x487, 2.0);
        const double var_x489 = -0.00084900000000000004 + var_x488 - var_x482;
        const double var_x490 = 2.0080487777071867 * var_chaste_interface__RyR_channel__p_open_RyR;
        const double var_x491 = 0.0038999999999999998 * exp(-0.86212130841993795);
        const double var_x492 = -19.5 * var_x74 - 19.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x493 = 1560.0 * var_x283;
        const double var_x494 = -0.038879999999999998 * var_x313;
        const double var_x495 = 780.0 * var_x74;
        const double var_x496 = 780.0 * var_chaste_interface__internal_ion_concentrations__Ca_Total;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (var_x79 + 6.4102564102564118e-8 * var_x7 - var_x4 * var_chaste_interface__internal_ion_concentrations__Ki) : ((var_x153) ? (var_x152 + 1.6501499829727237e-6 * var_x89 - 4.40801791445177e-5 * var_x85 - 0.00058114653916602817 * var_x87) : (var_x152 + 1.1678280188938275e-9 * var_x158 + 1.6349592264513586e-6 * var_x89 + 2.3996918142178179e-9 * var_x160 - 4.3674391018764285e-5 * var_x85 - 0.00058106450908081272 * var_x87 - 6.3062713020266686e-9 * var_x157 - var_x155 * var_x5 - var_x155 * var_chaste_interface__membrane__Vm))));
        IJth(rJacobian, 1, 0) = ((var_x80) ? (var_x242) : (var_x242 + 5.1924070375031169e-6 * var_x131 + 2.9261210735959872e-10 * var_x150 + 5.3921150004840055e-12 * var_x132 + 6.989778704331119e-10 * var_x108 + 3.6601023033588403e-10 * var_x133 - 1.8671678371464946e-8 * var_x99 - 9.785690186063566e-8 * var_x87 - 0.00072693698525043632 * var_x126 - 4.096569503034382e-8 * var_x147 - 7.5489610006776072e-10 * var_x129 - 5.124143224702376e-8 * var_x125 - 2.7959114817324473e-8 * var_x123 + var_x108 * var_x247 - var_x243 * var_x99 - var_x244 * var_x99 - var_x245 * var_x99 - var_x246 * var_x99 - var_x248 * var_x99));
        IJth(rJacobian, 2, 0) = ((var_x80) ? (var_x262 + 1.096205288078365e-11 * var_x7 - var_x258 * var_chaste_interface__internal_ion_concentrations__Ki) : ((var_x153) ? (var_x267 + 2.8218888944331128e-10 * var_x89 - 7.5380643745152652e-9 * var_x85 - 1.523820002993881e-9 * var_x87) : (var_x267 + 1.997079629808891e-13 * var_x158 + 2.7959114817324479e-10 * var_x89 + 4.1036655761461423e-13 * var_x160 - 7.4686713485859786e-9 * var_x85 - 1.0784230000968012e-12 * var_x157 - 1.5097922001355219e-9 * var_x87 - var_x268 * var_x5 - var_x268 * var_chaste_interface__membrane__Vm)));
        IJth(rJacobian, 3, 0) = ((var_x80) ? (var_x279) : (var_x279 + 2.2222049698964385e-6 * var_x135 + 3.1633741336172835e-5 * var_x149 + 1.4524215489519207e-10 * var_x107 - 1.9399146359963579e-9 * var_x96 - 0.00042251340772000675 * var_x144 - 3.9999689458135897e-6 * var_x128 - 2.6143587881134573e-10 * var_x106 - 5.69407344051111e-5 * var_x148 - var_x280 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1));
        IJth(rJacobian, 4, 0) = -3.1380958467616655e-7 * var_x70;
        IJth(rJacobian, 5, 0) = var_x328 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_RP_Na + (-var_x318 - var_x323) * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na;
        IJth(rJacobian, 6, 0) = var_x323 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na + (-var_x328 - var_x347) * var_chaste_interface__sodium_current_voltage_dependent_gate__p_RP_Na - var_x347 * var_x348;
        IJth(rJacobian, 7, 0) = var_x318 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na + 0.040000000000000001 * var_x346 * var_x348 - 5.917159763313609e-7 * (-var_x342 - var_x343) * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AI_Na / pow((var_x337 + 3.0769230769230768e-5 * var_x319), 2);
        IJth(rJacobian, 8, 0) = 1.2345679012345679e-20 * (1.0 - var_chaste_interface__sodium_current_ultra_slow_gate__y) * (-1800000000.0 * var_x354 - 80.0 * var_x352) / pow((var_x354 + 8.8888888888888887e-7 * var_x352), 2) - 6.2499999999999997e-8 * (40.0 * var_x356 + 0.0028000000000000004 * var_x355) * var_chaste_interface__sodium_current_ultra_slow_gate__y / pow((var_x356 + 3.4999999999999999e-6 * var_x355), 2);
        IJth(rJacobian, 9, 0) = -var_x366 + var_x362 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_RP_CaL;
        IJth(rJacobian, 10, 0) = var_x366 + (-var_x362 - var_x383) * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_RP_CaL - var_x383 * var_x385;
        IJth(rJacobian, 11, 0) = 0.25 * var_x382 * var_x385 - 2.0661157024793388e-13 * (-var_x379 - var_x380) * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AI_CaL / pow((var_x372 + 5.0000000000000004e-6 * var_x352), 2);
        IJth(rJacobian, 12, 0) = ((var_x80) ? (0) : (-var_x391));
        IJth(rJacobian, 13, 0) = ((var_x80) ? (0) : (var_x391));
        IJth(rJacobian, 14, 0) = ((var_x80) ? (0) : (-var_x390 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C));
        IJth(rJacobian, 15, 0) = 1.6e-11 * (1.0 - var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y) * (-0.89230769230769236 * var_x363 - 27777.777777777777 * var_x409) / pow((var_x409 + 0.000232 * var_x363), 2) - 3.0864197530864198e-7 * (1.0153846153846153 * var_x359 + 128.57142857142856 * var_x410) * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y / pow((var_x410 + 0.036666666666666667 * var_x359), 2);
        IJth(rJacobian, 16, 0) = 1.4872099940511603 * (1.0 - var_chaste_interface__T_type_Ca_channel_y1_gate__y1) * (0.0033928571428571428 * var_x411 + 0.0032799999999999999 * var_x412) / pow((var_x412 + 0.023170731707317073 * var_x411), 2) - 0.00062500000000000001 * (-6.3492063492063489 * var_x414 - 0.00015000000000000001 * var_x413) * var_chaste_interface__T_type_Ca_channel_y1_gate__y1 / pow((var_x414 + 0.037499999999999999 * var_x413), 2);
        IJth(rJacobian, 17, 0) = 2.6014568158168572e-10 * (1.0 - var_chaste_interface__T_type_Ca_channel_y2_gate__y2) * (-0.01 * var_x415 - 6138.6138613861385 * var_x416) / pow((var_x416 + 0.00048387096774193548 * var_x415), 2) - 0.69444444444444453 * (8.9552238805970128e-5 * var_x417 + 0.048000000000000001 * var_x418) * var_chaste_interface__T_type_Ca_channel_y2_gate__y2 / pow((var_x418 + 0.00050000000000000001 * var_x417), 2);
        IJth(rJacobian, 18, 0) = var_x422 * (-0.023333333333333334 * var_x420 - 941.17647058823525 * var_x421) - var_x427 * (1.5384615384615384e-5 * var_x423 + 0.00040000000000000002 * var_x425) - var_x429 * var_x58;
        IJth(rJacobian, 19, 0) = (2.0000000000000002e-5 * var_x430 - 2.5000000000000001e-5 * var_x434 * (-5.7142857142857135 * var_x432 - 0.20000000000000001 * var_x433)) * var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1 + 0.0025000000000000001 * (1.0 - var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1) * (1.7391304347826086 * var_x436 + 0.016666666666666666 * var_x435) / pow((var_x436 + 0.25 * var_x435), 2);
        IJth(rJacobian, 20, 0) = (5.0000000000000004e-6 * var_x430 - 2.4999999999999999e-7 * var_x434 * (-57.142857142857139 * var_x432 - 2.0 * var_x433)) * var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2 + 2.5000000000000001e-5 * (1.0 - var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2) * (15.384615384615385 * var_x437 + 0.066666666666666666 * var_x435) / pow((var_x437 + 0.10000000000000001 * var_x435), 2);
        IJth(rJacobian, 21, 0) = 0.01 * (1.0 - var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3) * (-0.58823529411764708 * var_x321 - 0.0083333333333333332 * var_x438) / pow((var_x321 + 0.25 * var_x438), 2) - 0.25 * (0.013333333333333334 * var_x440 + 0.020588235294117647 * var_x439) * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3 / pow((var_x440 + 0.17499999999999999 * var_x439), 2);
        IJth(rJacobian, 22, 0) = 7.3046018991964936e-6 * (1.0 - var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1) * (8.0952380952380949 * var_x441 + 5.967741935483871 * var_x442) / pow((var_x442 + 0.22972972972972974 * var_x441), 2) - 4.7562425683709868e-7 * (-72.5 * var_x337 - 2.6000000000000001 * var_x352) * var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1 / pow((var_x337 + 0.1793103448275862 * var_x352), 2);
        IJth(rJacobian, 24, 0) = 0.0082644628099173556 * (1.0 - var_chaste_interface__transient_outward_current_y1_gate__y1) * (0.39285714285714285 * var_x443 + 0.00050000000000000001 * var_x334) / pow((var_x443 + 0.018181818181818184 * var_x334), 2) - 0.051652892561983466 * (-0.27500000000000002 * var_x445 - 0.00040000000000000002 * var_x444) * var_chaste_interface__transient_outward_current_y1_gate__y1 / pow((var_x445 + 0.045454545454545456 * var_x444), 2);
        IJth(rJacobian, 25, 0) = -0.00033628318584070794 * var_x452 * var_x454 - 0.00033628318584070794 * var_x453 * var_chaste_interface__transient_outward_current_y2_gate__y2 + 2.2558884955752213e-5 * var_chaste_interface__transient_outward_current_y2_gate__y2 * exp(2.389380530973451 + var_x449) / pow(var_x448, 2) + 1.7263097345132742e-5 * var_x452 * exp(-2.389380530973451 - var_x449) / pow(var_x451, 2);
        IJth(rJacobian, 26, 0) = -0.011979261536575345 * var_x78 - 0.016290910314181915 * var_x41;
        IJth(rJacobian, 27, 0) = var_x66 * (-8.738369770208911e-5 * var_x69 + 0.00034888555005620849 * var_x458 / pow((1 + 0.067138346456864159 * var_x458), 2));
        IJth(rJacobian, 29, 0) = ((var_x80) ? (0) : ((var_x464 - var_x462 - var_x463) * var_chaste_interface__RyR_channel__p_close_RyR));
        IJth(rJacobian, 30, 0) = ((var_x80) ? (0) : ((var_x462 + var_x463 - var_x464) * var_chaste_interface__RyR_channel__p_close_RyR));
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (var_x171) : (var_x171 + var_x172 - var_x112 * var_x86 - var_x116 * var_x86 - var_x122 * var_x86 - var_x145 * var_x86 - var_x98 * var_chaste_interface__membrane__Vm)));
        IJth(rJacobian, 1, 1) = ((var_x80) ? (var_x249) : (var_x249 + var_x250 - 1.8671678371464946e-8 * var_x86 - var_x244 * var_x86 - var_x245 * var_x86 - var_x246 * var_x86 - var_x248 * var_x86));
        IJth(rJacobian, 2, 1) = 0.00063954490914407982 * var_x167;
        IJth(rJacobian, 3, 1) = 5.2150766826785515e-6 * var_x170;
        IJth(rJacobian, 4, 1) = -0.00031977245457203991 * var_x167;
        IJth(rJacobian, 26, 1) = (-0.0044781341107871719 * var_x169 + 6.1798250728862963e-6 * var_x100 * var_x457 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 2.0)) * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
        IJth(rJacobian, 27, 1) = (-0.089044123788040525 * var_x166 + 4.8132665714837462e-5 * var_x459 * var_x461 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 0.060000000000000053)) * var_chaste_interface__sodium_potassium_pump_y_gate__y;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (-0.0011666666666666668 + var_x184 - 0.038181818181818185 * var_x111 - 0.00083333333333333339 * var_x103 - var_x142 * var_x175 - var_x173 * var_chaste_interface__transient_outward_current_y2_gate__y2 - var_x174 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na - var_x4 * var_x5) : ((var_x153) ? (var_x185 - 4.40801791445177e-5 * var_x86) : (var_x185 - 3.1195993584831633e-8 * var_x186 - 4.3674391018764285e-5 * var_x86))));
        IJth(rJacobian, 1, 2) = 2.0272664670101546e-5 * var_x183;
        IJth(rJacobian, 2, 2) = ((var_x80) ? (-1.9950936243026244e-7 + var_x272 - 1.4250668745018745e-7 * var_x103 - 6.5293973158994975e-6 * var_x111 - var_x142 * var_x271 - var_x258 * var_x5 - var_x269 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na - var_x270 * var_chaste_interface__transient_outward_current_y2_gate__y2) : ((var_x153) ? (var_x273 - 7.5380643745152652e-9 * var_x86) : (var_x273 - 7.4686713485859786e-9 * var_x86 - 5.3347652489899846e-12 * var_x186)));
        IJth(rJacobian, 4, 2) = 6.7575548900338482e-6 * var_x183;
        IJth(rJacobian, 18, 2) = var_x422 * (-0.62329941155965896 * var_x10 * var_x420 - 25141.4888696333 * var_x10 * var_x421) - var_x178 * var_x429 - var_x427 * (0.00041096664498439046 * var_x10 * var_x423 + 0.010685132769594152 * var_x10 * var_x425);
        IJth(rJacobian, 27, 2) = (0.0018817147803989289 * var_x182 - 0.00022400328987130322 * var_x10 * var_x460 * var_x461) * var_chaste_interface__sodium_potassium_pump_y_gate__y;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (var_x194 + 4.3199999999999994e-12 * var_x191 - 6.0479999999999992e-10 * var_x190) : (var_x194 - 2.2687995334423004e-5 * var_x196 - 4.9414453838373298 * var_x201 + var_x159 * var_x200 + var_x199 * var_x200 - var_x197 * var_x198)));
        IJth(rJacobian, 1, 3) = ((var_x80) ? (var_x251 - 1.0342565348384801e-13 * var_x190) : (var_x251 + var_x199 * var_x252));
        IJth(rJacobian, 2, 3) = ((var_x80) ? (7.3875466774177154e-16 * var_x191) : (var_x159 * var_x252));
        IJth(rJacobian, 3, 3) = ((var_x80) ? (var_x293) : (var_x293 - 1.9399146359963579e-9 * var_x196 - 0.00042251340772000675 * var_x201 - var_x198 * var_x294));
        IJth(rJacobian, 4, 3) = 0.00016841699425931242 * var_x292;
        IJth(rJacobian, 12, 3) = ((var_x80) ? ((var_x394 - var_x395) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U) : ((var_x394 - var_x396) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U));
        IJth(rJacobian, 13, 3) = ((var_x80) ? ((var_x393 + var_x395) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U) : ((var_x393 + var_x396) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U));
        IJth(rJacobian, 14, 3) = ((var_x80) ? (-var_x395 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C) : (-var_x396 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C));
        IJth(rJacobian, 23, 3) = (1.0 - var_chaste_interface__slow_time_dependent_potassium_current_y2_gate__y2) * (1.8500000000000001 + 1.8500000000000001 * var_x187);
        IJth(rJacobian, 26, 3) = (0.0014927113702623907 * var_x192 + 0.0055199999999999997 * var_x289 * var_x455 * var_x457) * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
        IJth(rJacobian, 28, 3) = var_x284 * (3.2000000000000005e-5 * var_x290 - 0.0032000000000000002 * var_x291);
        IJth(rJacobian, 29, 3) = ((var_x80) ? (var_x466) : ((var_x465 - var_x467) * var_chaste_interface__RyR_channel__p_close_RyR));
        IJth(rJacobian, 30, 3) = ((var_x80) ? (-var_x466) : ((var_x467 - var_x465) * var_chaste_interface__RyR_channel__p_close_RyR));
        IJth(rJacobian, 31, 3) = -var_x189 * var_x490;
        IJth(rJacobian, 32, 3) = 0.0029732077063470926 + 0.0029732077063470926 * var_x187 - 0.0067366797703724973 * var_x292;
        IJth(rJacobian, 33, 3) = 39.0 * var_x282;
        IJth(rJacobian, 34, 3) = var_x493;
        IJth(rJacobian, 35, 3) = -var_x493;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (var_x208 + 130.07026967930034 * var_x202 - 0.02633746355685132 * var_x203) : (var_x208 - 5.402454865711368 * var_x210 - 0.00098594801299232461 * var_x211 - 4.9972707507830156e-5 * var_x212)));
        IJth(rJacobian, 1, 4) = ((var_x80) ? (var_x253 + 3.1959305885512452e-5 * var_x202) : (var_x253 - 8.5457340118295849e-9 * var_x212));
        IJth(rJacobian, 2, 4) = ((var_x80) ? (var_x274 - 4.5039176247922949e-6 * var_x203) : (var_x274 - 1.6860502239555665e-7 * var_x211));
        IJth(rJacobian, 3, 4) = ((var_x80) ? (var_x297 + 0.01110555030770703 * var_x202) : (var_x297 - 0.00046193156820700457 * var_x210));
        IJth(rJacobian, 4, 4) = -0.0030000000000000001 - 0.00012490084125584149 * var_x207 - 0.005263031070603514 * var_x296;
        IJth(rJacobian, 27, 4) = -0.034779999999999998 * var_x207;
        IJth(rJacobian, 28, 4) = 0.10000000000000001 * var_x296;
        IJth(rJacobian, 29, 4) = ((var_x80) ? (var_x469) : (-var_x470));
        IJth(rJacobian, 30, 4) = ((var_x80) ? (-var_x469) : (var_x470));
        IJth(rJacobian, 32, 4) = 0.21052124282414053 * var_x296;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (3033.3333333333335 * var_chaste_interface__sodium_current_ultra_slow_gate__y - var_x174 * var_chaste_interface__internal_ion_concentrations__Ki) : (-var_x213 * var_chaste_interface__sodium_current_ultra_slow_gate__y - var_x214 * var_chaste_interface__sodium_current_ultra_slow_gate__y)));
        IJth(rJacobian, 1, 5) = ((var_x80) ? (0.51872434231868225 * var_chaste_interface__sodium_current_ultra_slow_gate__y) : (-var_x254 * var_chaste_interface__sodium_current_ultra_slow_gate__y));
        IJth(rJacobian, 2, 5) = ((var_x80) ? (-var_x269 * var_chaste_interface__internal_ion_concentrations__Ki) : (-var_x275 * var_chaste_interface__sodium_current_ultra_slow_gate__y));
        IJth(rJacobian, 5, 5) = -var_x330 - var_x331;
        IJth(rJacobian, 6, 5) = var_x330 + var_x349;
        IJth(rJacobian, 7, 5) = var_x331 + var_x350;
        IJth(rJacobian, 5, 6) = var_x333;
        IJth(rJacobian, 6, 6) = -0.01 - var_x333;
        IJth(rJacobian, 7, 6) = var_x350;
        IJth(rJacobian, 5, 7) = 8.7499999999999999e-5;
        IJth(rJacobian, 6, 7) = var_x349;
        IJth(rJacobian, 7, 7) = -8.7499999999999999e-5 + var_x350 - 1.0 / var_x338;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (3033.3333333333335 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na - 2.166666666666667 * var_x215) : (-var_x213 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na - var_x214 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na)));
        IJth(rJacobian, 1, 8) = ((var_x80) ? (0.51872434231868225 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na) : (-var_x254 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na));
        IJth(rJacobian, 2, 8) = ((var_x80) ? (-0.00037051738737048736 * var_x215) : (-var_x275 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na));
        IJth(rJacobian, 8, 8) = -1.0 / (4000.0 * var_x356 + 0.014 * var_x355) - 1.0 / (8000.0 * var_x352 + 9000000000.0 * var_x354);
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (var_x141 * var_x216 - var_x141 * var_x217) : (-var_x218 * var_x219 - var_x218 * var_x220 - var_x218 * var_x221)));
        IJth(rJacobian, 1, 9) = ((var_x80) ? (var_x141 * var_x255) : (-var_x218 * var_x256));
        IJth(rJacobian, 2, 9) = ((var_x80) ? (-var_x141 * var_x276) : (-var_x218 * var_x277));
        IJth(rJacobian, 3, 9) = ((var_x80) ? (var_x141 * var_x298) : (-var_x218 * var_x299));
        IJth(rJacobian, 9, 9) = -0.0040000000000000001 - var_x368;
        IJth(rJacobian, 10, 9) = var_x368 + var_x386;
        IJth(rJacobian, 11, 9) = 0.0040000000000000001 + var_x387;
        IJth(rJacobian, 12, 9) = ((var_x80) ? (-var_x397) : (var_x398));
        IJth(rJacobian, 13, 9) = ((var_x80) ? (var_x397) : (-var_x398));
        IJth(rJacobian, 14, 9) = ((var_x80) ? (-var_x399 * var_x408) : (-var_x404 * var_x408));
        IJth(rJacobian, 29, 9) = ((var_x80) ? (var_x472) : (-var_x475));
        IJth(rJacobian, 30, 9) = ((var_x80) ? (-var_x472) : (var_x475));
        IJth(rJacobian, 9, 10) = var_x370;
        IJth(rJacobian, 10, 10) = -0.040000000000000001 - var_x370;
        IJth(rJacobian, 11, 10) = var_x387;
        IJth(rJacobian, 9, 11) = 0.001;
        IJth(rJacobian, 10, 11) = var_x386;
        IJth(rJacobian, 11, 11) = -0.001 + var_x387 - 1.0 / var_x373;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x223);
        IJth(rJacobian, 1, 12) = var_x257;
        IJth(rJacobian, 2, 12) = var_x278;
        IJth(rJacobian, 3, 12) = var_x300;
        IJth(rJacobian, 12, 12) = ((var_x80) ? (var_x401 + var_x403) : (var_x403 + var_x406));
        IJth(rJacobian, 13, 12) = ((var_x80) ? (var_x400 + var_x407) : (var_x405 + var_x407));
        IJth(rJacobian, 14, 12) = 0.3458;
        IJth(rJacobian, 29, 12) = var_x478;
        IJth(rJacobian, 30, 12) = var_x486;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x223);
        IJth(rJacobian, 1, 13) = var_x257;
        IJth(rJacobian, 2, 13) = var_x278;
        IJth(rJacobian, 3, 13) = var_x300;
        IJth(rJacobian, 12, 13) = 2.0019999999999998;
        IJth(rJacobian, 13, 13) = -2.3523000000000001;
        IJth(rJacobian, 14, 13) = -0.0041999999999999997;
        IJth(rJacobian, 29, 13) = var_x478;
        IJth(rJacobian, 30, 13) = var_x486;
        IJth(rJacobian, 12, 14) = 0.14299999999999999;
        IJth(rJacobian, 13, 14) = -0.00029999999999999997;
        IJth(rJacobian, 14, 14) = ((var_x80) ? (-0.1472 + var_x401) : (-0.1472 + var_x406));
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (118.97094000000001 * var_x224 - 0.02409 * var_x225) : (-var_x219 * var_x224 - var_x220 * var_x224 - var_x221 * var_x224)));
        IJth(rJacobian, 1, 15) = ((var_x80) ? (2.923211178328205e-5 * var_x224) : (-var_x224 * var_x256));
        IJth(rJacobian, 2, 15) = ((var_x80) ? (-4.1195833208100184e-6 * var_x225) : (-var_x224 * var_x277));
        IJth(rJacobian, 3, 15) = ((var_x80) ? (0.010157876681449362 * var_x224) : (-var_x224 * var_x299));
        IJth(rJacobian, 15, 15) = -1.0 / (58.0 * var_x363 + 250000.0 * var_x409) - 1.0 / (66.0 * var_x359 + 1800.0 * var_x410);
        IJth(rJacobian, 29, 15) = ((var_x80) ? (var_x479) : (-var_x480));
        IJth(rJacobian, 30, 15) = ((var_x80) ? (-var_x479) : (var_x480));
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (8.3454545454545475 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2) : (-var_x114 * var_chaste_interface__membrane__Vm)));
        IJth(rJacobian, 3, 16) = ((var_x80) ? (0.00071356984952330234 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2) : (-var_x280 * var_chaste_interface__membrane__Vm));
        IJth(rJacobian, 16, 16) = -1.0 / (1.5 * var_x413 + 40.0 * var_x414) - 1.0 / (0.019 * var_x411 + 0.81999999999999995 * var_x412);
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (8.3454545454545475 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1) : (-var_x197 * var_x209)));
        IJth(rJacobian, 3, 17) = ((var_x80) ? (0.00071356984952330234 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1) : (-var_x209 * var_x294));
        IJth(rJacobian, 17, 17) = -1.0 / (30.0 * var_x415 + 62000.0 * var_x416) - 1.0 / (1.2 * var_x418 + 0.00059999999999999995 * var_x417);
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x37 * var_x63);
        IJth(rJacobian, 2, 18) = -var_x259 * var_x63;
        IJth(rJacobian, 18, 18) = -1.0 / (7.0 * var_x420 + 8000.0 * var_x421) - var_x31 * var_x428;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0051840000000000002 * var_x226);
        IJth(rJacobian, 2, 19) = -8.8650560129012604e-7 * var_x226;
        IJth(rJacobian, 19, 19) = -1.0 / (5.0 * var_x435 + 20.0 * var_x436) - 1.0 / (160.0 * var_x432 + 200.0 * var_x433) - 0.00040000000000000002 * var_x430;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0034560000000000003 * var_x226);
        IJth(rJacobian, 2, 20) = -5.9100373419341746e-7 * var_x226;
        IJth(rJacobian, 20, 20) = -1.0 / (20.0 * var_x435 + 200.0 * var_x437) - 1.0 / (1600.0 * var_x432 + 2000.0 * var_x433) - 0.0001 * var_x430;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x39 * var_x63);
        IJth(rJacobian, 2, 21) = -var_x260 * var_x63;
        IJth(rJacobian, 21, 21) = -1.0 / (2.0 * var_x440 + 0.34999999999999998 * var_x439) - 1.0 / (2.5 * var_x438 + 10.0 * var_x321);
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (0.42763636363636365 * var_x227 - 0.07636363636363637 * var_x228) : (-0.00011434749648549193 * var_x229 - 0.0028586874121372982 * var_x230)));
        IJth(rJacobian, 1, 22) = ((var_x80) ? (7.3129249938074371e-5 * var_x227) : (-1.9554339530843287e-8 * var_x229));
        IJth(rJacobian, 2, 22) = ((var_x80) ? (-1.3058794631798995e-5 * var_x228) : (-4.8885848827108217e-7 * var_x230));
        IJth(rJacobian, 22, 22) = -1.0 / (260.0 * var_x352 + 1450.0 * var_x337) - 1.0 / (85.0 * var_x441 + 370.0 * var_x442);
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (0.19243636363636366 * var_x109 - 0.034363636363636367 * var_x231) : (-5.1456373418471366e-5 * var_x232 - 0.0012864093354617843 * var_x233)));
        IJth(rJacobian, 1, 23) = ((var_x80) ? (3.2908162472133468e-5 * var_x109) : (-8.7994527888794801e-9 * var_x232));
        IJth(rJacobian, 2, 23) = ((var_x80) ? (-5.876457584309548e-6 * var_x231) : (-2.1998631972198697e-7 * var_x233));
        IJth(rJacobian, 23, 23) = 0.092459000000000013 - 1.8500000000000001 * var_x74 - 1.8500000000000001 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (0.0094500000000000001 * var_x234 - 0.00075000000000000002 * var_x235) : (-2.8076394226348465e-5 * var_x236 - 2.526875480371362e-6 * var_x237)));
        IJth(rJacobian, 1, 24) = ((var_x80) ? (1.6160258356851256e-6 * var_x234) : (-4.3211598516818873e-10 * var_x237));
        IJth(rJacobian, 2, 24) = ((var_x80) ? (-1.2825601870516871e-7 * var_x235) : (-4.8012887240909857e-9 * var_x236));
        IJth(rJacobian, 24, 24) = -1.0 / (11.0 * var_x443 + 0.20000000000000001 * var_x334) - 1.0 / (4.4000000000000004 * var_x445 + 0.20000000000000001 * var_x444);
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x80) ? (0.00315 * var_x117 - var_x173 * var_chaste_interface__internal_ion_concentrations__Ki) : (-9.358798075449489e-6 * var_x238 - 8.4229182679045397e-7 * var_x239)));
        IJth(rJacobian, 1, 25) = ((var_x80) ? (5.3867527856170855e-7 * var_x117) : (-1.4403866172272957e-10 * var_x239));
        IJth(rJacobian, 2, 25) = ((var_x80) ? (-var_x270 * var_chaste_interface__internal_ion_concentrations__Ki) : (-1.6004295746969954e-9 * var_x238));
        IJth(rJacobian, 25, 25) = -0.0038 * var_x453 - 0.0038 * var_x454;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (-4.3581631433074284 * var_x40 - 6.8099999999999996 * var_x77);
        IJth(rJacobian, 1, 26) = -0.0022358426145128573 * var_x40 - 0.0034936939495287954 * var_x77;
        IJth(rJacobian, 3, 26) = 0.0011645646498429317 * var_x77 + 0.0007452808715042858 * var_x40;
        IJth(rJacobian, 26, 26) = -0.20379327210477691 - 1.0 * var_x77 - 1.0 / var_x456 - 0.6399652192815608 * var_x40;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-0.84000000000000008 * var_x240 - 7.7700000000000005 * var_x241);
        IJth(rJacobian, 1, 27) = -0.0039861970613566432 * var_x241 - 0.00043094022284936683 * var_x240;
        IJth(rJacobian, 2, 27) = 0.0026574647075710955 * var_x241 + 0.0002872934818995779 * var_x240;
        IJth(rJacobian, 4, 27) = -0.0013287323537855477 * var_x241 - 0.00014364674094978895 * var_x240;
        IJth(rJacobian, 27, 27) = -0.37 * var_x241 - 0.01 / (1.0 + 49.999265664512095 * var_x460) - 0.040000000000000001 * var_x240 - 0.16500000000000001 / (1.0331690520373935 + 0.06936526176419644 * var_x458);
        IJth(rJacobian, 3, 28) = 0.10526062141207027 * var_x303 + 0.0010526062141207027 * var_x302;
        IJth(rJacobian, 4, 28) = 0.052630310706035133 * var_x303 + 0.00052630310706035135 * var_x302;
        IJth(rJacobian, 28, 28) = -1.01 + 0.98999999999999999 * var_x302 + 0.01 * var_x295 - 1.0 * var_x303;
        IJth(rJacobian, 32, 28) = -0.021052124282414056 * var_x302 - 2.1052124282414053 * var_x303;
        IJth(rJacobian, 3, 29) = -0.21581745204261316 + 0.020080487777071866 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total + 0.21686926799237616 * var_x306 - 0.020080487777071866 * var_x74 - 0.020080487777071866 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        IJth(rJacobian, 29, 29) = -0.080000000000000002 / var_x481;
        IJth(rJacobian, 30, 29) = var_x488;
        IJth(rJacobian, 31, 29) = 10.790872602130658 + 1.0040243888535934 * var_x74 + 1.0040243888535934 * var_chaste_interface__internal_ion_concentrations__Ca_Total - 1.0040243888535934 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total - 10.843463399618809 * var_x306;
        IJth(rJacobian, 29, 30) = ((var_x80) ? (var_x482 + var_x483) : (var_x482 - var_x484));
        IJth(rJacobian, 30, 30) = ((var_x80) ? (var_x489 - var_x483) : (var_x484 + var_x489));
        IJth(rJacobian, 3, 31) = var_x281 * var_x309;
        IJth(rJacobian, 29, 31) = 0.00098765432098765413 * (-0.5 - var_x308) * var_chaste_interface__RyR_channel__p_open_RyR / (pow(var_x481, 2) * pow((var_x485 + 0.092592592592592587 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total), 2));
        IJth(rJacobian, 30, 31) = 0.021986640000000002 * pow(var_x487, 1.0) * (0.092592592592592587 + var_x307) * (1.0 - var_chaste_interface__RyR_channel__p_close_RyR - var_chaste_interface__RyR_channel__p_open_RyR);
        IJth(rJacobian, 31, 31) = -0.0062508615177014042 - 0.067509304391175168 * var_x307 - var_x309 * var_x490;
        IJth(rJacobian, 32, 31) = 0.0025003446070805614 + 0.027003721756470065 * var_x307;
        IJth(rJacobian, 3, 32) = 0.00029732077063470926 + 8.4208497129656225e-5 * var_x310;
        IJth(rJacobian, 4, 32) = 4.2104248564828112e-5 * var_x310;
        IJth(rJacobian, 28, 32) = 0.079200000000000007 * var_x310;
        IJth(rJacobian, 31, 32) = 0.012501723035402808;
        IJth(rJacobian, 32, 32) = -0.010947104626855308 - 0.0016841699425931245 * var_x310;
        IJth(rJacobian, 3, 33) = var_x311;
        IJth(rJacobian, 33, 33) = 0.99141000000000001 + var_x492 - var_x491;
        IJth(rJacobian, 34, 33) = var_x491;
        IJth(rJacobian, 3, 34) = var_x311 + 0.0027216000000000002 * var_x313;
        IJth(rJacobian, 4, 34) = -0.028000000000000004;
        IJth(rJacobian, 33, 34) = 1.0253100000000002 + var_x492;
        IJth(rJacobian, 34, 34) = -0.0339 + var_x494;
        IJth(rJacobian, 35, 34) = 0.029999999999999999;
        IJth(rJacobian, 3, 35) = 2.7884493000000008 - 53.235000000000007 * var_x74 - 53.235000000000007 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        IJth(rJacobian, 33, 35) = 1.0214100000000002 + var_x492;
        IJth(rJacobian, 34, 35) = -40.856400000000001 + var_x495 + var_x496;
        IJth(rJacobian, 35, 35) = 40.736400000000003 + var_x494 - var_x495 - var_x496;
        IJth(rJacobian, 3, 36) = -0.0054432000000000005 * var_x315;
        IJth(rJacobian, 34, 36) = 0.077759999999999996 * var_x315;
        IJth(rJacobian, 35, 36) = 0.077759999999999996 * var_x314 * var_chaste_interface__NL_model__pCB;
