...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1991FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x59 = var_x6 * (0.00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * var_chaste_interface__fast_sodium_current_h_gate__h / pow(var_x47, 2);
        ...
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (6.0150375939849621 * var_x63 - 0.16871848837702516 * var_x1 - 0.075187969924812026 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 11850.786623602246 * var_x59 - 80.342137322392929 * var_x61 - 1.4059874031418764 * var_x62 - 0.00019702047801444983 * var_x60);
