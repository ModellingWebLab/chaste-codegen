...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1991FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x121 = 0.0015795686504212307 * var_x17;
        const double var_x122 = 5.9129400406899753e-8 * var_x26;
        const double var_x123 = 1.1825880081379952e-8 * var_x35;
        const double var_x124 = 8.4392437745822447e-5 * var_x2 - 3.1591373008424612e-6 * var_chaste_interface__membrane__V;
        const double var_x125 = 1.1825880081379951e-5 * var_x33;
        ...
        IJth(rJacobian, 10, 0) = -3.7909647610109532e-7 + 2.2134435192462872e-9 * var_x44 - 9.477411902527384e-7 * var_x12 - 3.0988209269448018e-7 * var_x39 - var_x121 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x122 * var_x24;
        IJth(rJacobian, 11, 0) = -3.7909647610109532e-7 + 1.3515291521577086e-5 * var_x19 + 4.4268870384925742e-10 * var_x46 - 6.7576457607885431e-7 * var_x15 - 3.1591373008424612e-6 * var_x16 - 0.00018052213147671208 * var_x5 - 1.7707548153970297e-9 * var_x39 - var_x123 * var_x24;
        IJth(rJacobian, 12, 0) = -7.8978432521061529e-8 + 3.1591373008424611e-7 * var_x12 + 8.8537740769851485e-7 * var_x45 - 1.7707548153970297e-6 * var_x42 - var_x125 * var_x23;
        ...
        IJth(rJacobian, 12, 12) = -7.0000000000000009 + var_x131 + var_x132 + 0.00040000000000000002 * var_x136 - 0.86686727535117136 * var_x66 - 1.1825880081379951e-5 * var_x67 - 7.2e-9 * var_x137 - 1.0549054718227806e-6 * var_x64 - 2.1798047375812981e-9 * var_x65 - 0.00040000000000000002 * var_x134;
        ...
        IJth(rJacobian, 12, 13) = 7.2e-9 * var_x134 + 9.5999999999999999e-8 * var_x136 - 1.7279999999999999e-12 * var_x137;
        IJth(rJacobian, 13, 13) = -0.050000000000000003 + 8.4671999999999982e-11 * var_x137 - 3.5279999999999993e-7 * var_x134 - 4.7040000000000002e-6 * var_x136;
