...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1991FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x8 = 0.018716945411372737 * var_chaste_interface__membrane__V;
        ...
        const double var_x19 = -26.713760659695652 * var_x2 + var_chaste_interface__membrane__V;
        ...
        const double var_x27 = -140.0 * var_x21 + var_x26 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x28 = 0.00098510239007224909 * var_x27;
        const double var_x29 = exp(3.7433890822745473 - var_x0);
        const double var_x30 = 1.0 - var_x29;
        const double var_x31 = 1 / var_x30;
        const double var_x32 = exp(3.7433890822745473);
        const double var_x33 = -2.0 * var_x29 + var_x32 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x34 = var_x31 * var_x33;
        const double var_x35 = 0.39404095602889971 * var_x34;
        const double var_x36 = -4.0 * var_x21 + var_x26 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x37 = 0.00019702047801444983 * var_x36;
        ...
        const double var_x41 = var_x24 * var_x38;
        const double var_x42 = var_x31 * var_x41;
        const double var_x43 = var_x29 * var_x42;
        const double var_x44 = var_x21 * var_x41 / pow(var_x22, 2);
        const double var_x45 = var_x27 * var_x44;
        const double var_x46 = var_x29 * var_x33 * var_x41 / pow(var_x30, 2);
        const double var_x47 = var_x36 * var_x44;
        const double var_x48 = 1 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x49 = -26.713760659695652 * log(140.47999999999999 * var_x48) + var_chaste_interface__membrane__V;
        const double var_x50 = var_x49 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x51 = var_x38 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x52 = var_x23 * var_x51;
        const double var_x53 = var_x38 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x54 = var_x23 * var_x53;
        const double var_x55 = var_x19 * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x56 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x57 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
        ...
        const double var_x59 = var_x7 * var_x9 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x60 = var_x14 * var_x48 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x61 = var_x26 * var_x39;
        const double var_x62 = var_x1 * var_x5;
        const double var_x63 = var_x1 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x64 = var_x1 * var_x20;
        const double var_x65 = 1 / var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x66 = (2.0 * var_x10 - 2744000.0 * var_x12) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x67 = var_x11 * var_x7;
        const double var_x68 = var_x32 * var_x42;
        const double var_x69 = exp(-0.80000000000000004 - 0.040000000000000001 * var_chaste_interface__membrane__V);
        const double var_x70 = 1.0 + var_x69;
        const double var_x71 = exp(-1.2 - 0.059999999999999998 * var_chaste_interface__membrane__V);
        const double var_x72 = var_x71 / var_x70;
        const double var_x73 = 1.0 - var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x74 = exp(2.8500000000000001 + 0.057000000000000002 * var_chaste_interface__membrane__V);
        const double var_x75 = 1.0 + var_x74;
        const double var_x76 = exp(4.1300000000000008 + 0.082600000000000007 * var_chaste_interface__membrane__V);
        const double var_x77 = var_x76 / var_x75;
        const double var_x78 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x79 = 0.44800000000000001 * var_x78 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x80 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x81 = fabs(var_x80) < 1.0000000000000001e-5;
        const double var_x82 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x83 = 0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x84 = -var_x83;
        const double var_x85 = exp(-4.1000000000000005 + var_x84);
        const double var_x86 = 1.0 - var_x85;
        const double var_x87 = 0.20000000000000001 / var_x86;
        const double var_x88 = -8.0 * var_x78;
        const double var_x89 = -0.125 * var_chaste_interface__membrane__V;
        const double var_x90 = exp(-9.375 + var_x89);
        const double var_x91 = exp(-7.5 + var_x84);
        const double var_x92 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x93 = fabs(var_x92) < 0.0001;
        const double var_x94 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x95 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x96 = -var_x95;
        const double var_x97 = exp(-4.75 + var_x96);
        const double var_x98 = 1.0 - var_x97;
        const double var_x99 = 0.089999999999999997 / var_x98;
        const double var_x100 = exp(1.8999999999999999 + var_x83);
        const double var_x101 = -1.0 + var_x100;
        const double var_x102 = 0.036000000000000004 / var_x101;
        const double var_x103 = exp(-8.5 + var_x96);
        const double var_x104 = 1.0 + var_x103;
        const double var_x105 = -0.0062500000000000003 * var_x103 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x104, 2);
        const double var_x106 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x107 = fabs(var_x106) < 0.0001;
        const double var_x108 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x109 = exp(8.5 + var_x95);
        const double var_x110 = -1.0 + var_x109;
        const double var_x111 = 0.0031250000000000002 / var_x110;
        const double var_x112 = -0.025000000000000001 / var_x104;
        const double var_x113 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x114 = exp(-1.25 + var_x89);
        const double var_x115 = 1.0 + var_x114;
        const double var_x116 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x117 = 0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x118 = 1 / var_x117;
        const double var_x119 = pow((var_x118 * var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2.0);
        const double var_x120 = var_x117 * var_x119 * var_x65 * (var_x118 - var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x117, 2));
        const double var_x121 = 1.0 * var_x120 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x122 = 0.0015795686504212307 * var_x14;
        const double var_x123 = 5.9129400406899753e-8 * var_x27;
        const double var_x124 = 3.1591373008424612e-6 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x125 = 1.182588008137995e-8 * var_x36;
        const double var_x126 = 1.1825880081379952e-5 * var_x34;
        const double var_x127 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
        const double var_x128 = 1 / var_x127;
        const double var_x129 = pow((var_x128 * var_chaste_interface__calcium_release__ActFrac), 2.0);
        const double var_x130 = var_x127 * var_x129 * (var_x128 - var_chaste_interface__calcium_release__ActFrac / pow(var_x127, 2)) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel / var_chaste_interface__calcium_release__ActFrac;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.01526315789473684 + 3.6876215319190196e-5 * var_x45 + 0.22516626058794267 * var_x20 + 0.029500972255352163 * var_x46 + 7.3752430638380402e-6 * var_x47 - 3.007518796992481 * var_x5 - 0.005263157894736842 * var_x13 - 0.011258313029397133 * var_x18 - 0.0051921711169419793 * var_x40 - 0.059001944510704327 * var_x43 - var_x15 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x24 * var_x35 - var_x25 * var_x28 - var_x25 * var_x37 - var_x6 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 1, 0) = 7.8000000000000012e-5 * var_x72 * var_chaste_interface__time_dependent_potassium_current_x_gate__x + 4.1300000000000001e-5 * var_x73 * var_x77 - 5.200000000000001e-5 * var_x69 * var_x71 * var_chaste_interface__time_dependent_potassium_current_x_gate__x / pow(var_x70, 2) - 2.8500000000000002e-5 * var_x73 * var_x74 * var_x76 / pow(var_x75, 2);
        IJth(rJacobian, 2, 0) = ((var_x81) ? (var_x79) : (var_x79 + var_x82 * var_x87 - 0.020000000000000004 * var_x80 * var_x82 * var_x85 / pow(var_x86, 2)));
        IJth(rJacobian, 3, 0) = -0.0025000000000000001 * var_x90 * (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x91 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x91), 2);
        IJth(rJacobian, 4, 0) = ((var_x93) ? (0) : (var_x94 * var_x99 - var_x102 * var_chaste_interface__L_type_Ca_channel_d_gate__d + 0.0036000000000000008 * var_x100 * var_x92 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x101, 2) - 0.022499999999999999 * var_x92 * var_x94 * var_x97 / pow(var_x98, 2)));
        IJth(rJacobian, 5, 0) = ((var_x107) ? (var_x105) : (var_x105 + var_x108 * var_x111 - 0.00078125000000000004 * var_x106 * var_x108 * var_x109 / pow(var_x110, 2)));
        IJth(rJacobian, 6, 0) = -1.9411764705882353e-6 * var_x113 * (1.0 - var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x114 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x115, 2);
        IJth(rJacobian, 7, 0) = 0.066600000000000006 * var_x116 / pow((1.0 + var_x116), 2);
        IJth(rJacobian, 10, 0) = -3.7909647610109532e-7 + 2.2134435192462872e-9 * var_x45 - 9.477411902527384e-7 * var_x13 - 3.0988209269448018e-7 * var_x40 - var_x122 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x123 * var_x25;
        IJth(rJacobian, 11, 0) = -3.7909647610109532e-7 + 1.3515291521577088e-5 * var_x20 + 4.4268870384925742e-10 * var_x47 - 0.00018052213147671208 * var_x5 - 1.7707548153970297e-9 * var_x40 - 6.7576457607885431e-7 * var_x18 - var_x124 * var_chaste_interface__transient_outward_current_s_gate__s - var_x125 * var_x25;
        IJth(rJacobian, 12, 0) = -7.8978432521061529e-8 + 3.1591373008424611e-7 * var_x13 + 8.8537740769851495e-7 * var_x46 - 1.7707548153970299e-6 * var_x43 - var_x126 * var_x24;
        ...
        IJth(rJacobian, 1, 1) = -0.00050000000000000001 * var_x77 - 0.0013000000000000002 * var_x72;
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-78.94736842105263 * var_x50);
        IJth(rJacobian, 2, 2) = ((var_x81) ? (-2.0 + var_x88) : (var_x88 - var_x80 * var_x87));
        IJth(rJacobian, 10, 2) = -0.0047387059512636921 * var_x50;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x15 * var_x49);
        IJth(rJacobian, 3, 3) = -2.0 / (1.0 + 320.0 * var_x91) - 0.02 * var_x90;
        IJth(rJacobian, 10, 3) = -var_x122 * var_x49;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x28 * var_x52 - var_x35 * var_x51 - var_x37 * var_x52);
        IJth(rJacobian, 4, 4) = ((var_x93) ? (-0.71999999999999997) : (-var_x102 * var_x92 - var_x92 * var_x99));
        IJth(rJacobian, 10, 4) = -var_x123 * var_x52;
        IJth(rJacobian, 11, 4) = -var_x125 * var_x52;
        IJth(rJacobian, 12, 4) = -var_x126 * var_x51;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x28 * var_x54 - var_x35 * var_x53 - var_x37 * var_x54);
        IJth(rJacobian, 5, 5) = ((var_x107) ? (-0.012500000000000001 + var_x112) : (var_x112 - var_x106 * var_x111));
        IJth(rJacobian, 10, 5) = -var_x123 * var_x54;
        IJth(rJacobian, 11, 5) = -var_x125 * var_x54;
        IJth(rJacobian, 12, 5) = -var_x126 * var_x53;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x19 * var_x6);
        IJth(rJacobian, 6, 6) = -0.033000000000000002 / var_x115 - 3.3000000000000003e-5 * var_x113;
        IJth(rJacobian, 11, 6) = -var_x124 * var_x19;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.052631578947368418 * var_x55);
        IJth(rJacobian, 7, 7) = -0.33300000000000002;
        IJth(rJacobian, 11, 7) = -3.1591373008424612e-6 * var_x55;
        IJth(rJacobian, 8, 8) = -0.059999999999999998 - 1.0 * var_x119;
        IJth(rJacobian, 9, 8) = 0.059999999999999998 + 0.5 * var_x119;
        IJth(rJacobian, 12, 8) = 0.10204081632653063 * var_x130;
        IJth(rJacobian, 14, 8) = -0.5 * var_x130;
        IJth(rJacobian, 8, 9) = -0.5 * var_x119;
        IJth(rJacobian, 9, 9) = -0.001;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (0.0036842105263157885 * var_x58 - 0.00098510239007224909 * var_x61 - 5.8947368421052619 * var_x56 - 0.16871848837702516 * var_x57 - 0.031578947368421054 * var_x59 - 702.99370157093813 * var_x60);
        IJth(rJacobian, 10, 10) = 6.634188331769168e-7 * var_x58 - 0.0010614701330830668 * var_x56 - 1.0127092529498694e-5 * var_x57 - 5.9129400406899753e-8 * var_x61 - 5.6864471415164302e-6 * var_x59 - 0.042196218872911223 * var_x60;
        IJth(rJacobian, 11, 10) = 0.00070764675538871125 * var_x56 - 4.4227922211794452e-7 * var_x58;
        IJth(rJacobian, 12, 10) = 1.8954823805054766e-6 * var_x59;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (6.0150375939849638 * var_x64 - 0.16871848837702516 * var_x1 - 0.00019702047801444983 * var_x61 - 80.342137322392929 * var_x62 - 84.359244188512577 * var_x60 - 1.4059874031418764 * var_x63 - 0.075187969924812026 * var_chaste_interface__time_dependent_potassium_current_x_gate__x);
        IJth(rJacobian, 10, 11) = -0.0050635462647493469 * var_x60;
        IJth(rJacobian, 11, 11) = 0.00036104426295342421 * var_x64 - 1.0127092529498694e-5 * var_x1 - 1.182588008137995e-8 * var_x61 - 4.5130532869178019e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 0.004822425014046997 * var_x62 - 8.4392437745822447e-5 * var_x63;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (3.6315789473684208e-5 * var_x66 + 14442.105263157895 * var_x67 - 0.035149685078546905 * var_x65 - 0.39404095602889971 * var_x68);
        IJth(rJacobian, 8, 12) = -var_x121 + 1.0 * var_x120 * (1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac);
        IJth(rJacobian, 9, 12) = var_x121;
        IJth(rJacobian, 10, 12) = 2.6006018260535142 * var_x67 + 6.5394142127438948e-9 * var_x66;
        IJth(rJacobian, 12, 12) = -7.0 + var_x131 + var_x132 + 0.00040000000000000002 * var_x136 - 1.0549054718227806e-6 * var_x65 - 1.1825880081379952e-5 * var_x68 - 0.00040000000000000002 * var_x134 - 7.1999999999999991e-9 * var_x137 - 0.86686727535117136 * var_x67 - 2.1798047375812981e-9 * var_x66;
        IJth(rJacobian, 13, 12) = 0.019599999999999999 * var_x134 + 3.5279999999999993e-7 * var_x137 - 0.019599999999999999 * var_x136;
        IJth(rJacobian, 15, 12) = 2.0 - var_x131;
        IJth(rJacobian, 16, 12) = 5.0 - var_x132;
        IJth(rJacobian, 12, 13) = 7.1999999999999991e-9 * var_x134 + 9.5999999999999999e-8 * var_x136 - 1.7279999999999997e-12 * var_x137;
        ...
        IJth(rJacobian, 12, 14) = 0.051020408163265314 * var_x129;
        IJth(rJacobian, 13, 14) = 0.050000000000000003;
        IJth(rJacobian, 14, 14) = -0.0050000000000000001 - 0.25 * var_x129;
        IJth(rJacobian, 12, 15) = 0.050000000000000003 + var_x138;
        IJth(rJacobian, 15, 15) = -0.050000000000000003 + var_x139;
        IJth(rJacobian, 12, 16) = 0.20000000000000001 + var_x138;
        IJth(rJacobian, 16, 16) = -0.20000000000000001 + var_x139;
    }
