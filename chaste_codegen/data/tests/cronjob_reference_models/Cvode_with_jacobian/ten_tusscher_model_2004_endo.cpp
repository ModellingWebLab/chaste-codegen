...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x20 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__membrane__V - 0.0053427521319391307 * var_x13);
        ...
        const double var_x27 = 0.072999999999999995 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        const double var_x44 = 0.0060000000000000001 * var_x35 - 0.5 * var_x43 - var_x19 * (0.10000000000000001 * var_x22 + 0.00060000000000000006 * var_x20);
        ...
        const double var_x88 = 0.16028256395817392 * var_x87 - var_x19 * (2.6713760659695653 * var_x12 * var_x22 + 0.01602825639581739 * var_x12 * var_x20) - 13.356880329847826 * var_x12 * var_x43;
        ...
        const double var_x213 = exp(5.5999999999999996 + var_x137);
        const double var_x214 = 1.0 + var_x213;
        const double var_x215 = 1 + 0.014925373134328358 * var_chaste_interface__membrane__V;
        const double var_x216 = exp(-4.4889999999999999 * pow(var_x215, 2.0));
        const double var_x217 = 1 / (8.0 + 1000.0 * var_x216);
        const double var_x218 = exp(3.3333333333333335 + var_x130);
        const double var_x219 = 1.0 + var_x218;
        const double var_x220 = 1 + 0.025000000000000001 * var_chaste_interface__membrane__V;
        const double var_x221 = exp(-0.88888888888888884 * pow(var_x220, 2.0));
        const double var_x222 = 1 / (0.80000000000000004 + 9.5 * var_x221);
        ...
        const double var_x225 = 14.994515539305302 / (1.0 + 3.0 * var_x224);
        const double var_x226 = var_x225 * (-0.0082319999999999997 - var_x104);
        const double var_x227 = var_chaste_interface__calcium_dynamics__Ca_i >= 0.00035;
        const double var_x228 = var_chaste_interface__calcium_dynamics__Ca_i < 0.00035;
        const double var_x229 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6.0);
        const double var_x230 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16.0);
        const double var_x231 = (((var_x206) || (var_x227))) && (((var_x206) || (var_x228))) && (((var_x227) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 5.439910241481016e+20 * var_x229)))) && (((var_x228) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 1.9720198874049176e+55 * var_x230))));
        const double var_x232 = 0.0017343470110743602 * var_x29;
        const double var_x233 = 8.5326413134134178e-6 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x234 = 1.1221007754625865e-5 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x235 = 6.3176611368492499e-5 * var_x45;
        ...
        IJth(rJacobian, 11, 0) = -0.20000000000000001 * var_x213 * var_x217 / pow(var_x214, 2) + 0.000134 * var_x216 * pow(var_x215, 1.0) * (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / var_x214) / pow((0.0080000000000000002 + var_x216), 2);
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x218 * var_x222 / pow(var_x219, 2) + 0.0046783625730994153 * var_x221 * pow(var_x220, 1.0) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / var_x219) / pow((0.084210526315789472 + var_x221), 2);
        IJth(rJacobian, 15, 0) = -3.389679425876563e-8 - 0.00040297005778184723 * var_x42 - 3.0388663876087418e-8 * var_x10 - 7.3941785176126781e-11 * var_x34 - var_x232 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 16, 0) = 0.00026864670518789814 * var_x42 + 3.79059668210955e-6 * var_x37 - 2.8636946873784758e-5 * var_x0 - 6.3176611368492499e-5 * var_x26 - 1.7065282626826835e-6 * var_x3 - 2.8537261917770629e-7 * var_x32 - var_x233 * var_chaste_interface__transient_outward_current_s_gate__s - var_x234 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 - var_x235 * var_x44;
        ...
        IJth(rJacobian, 13, 1) = var_x225 * (8.0000000000000007e-5 + var_x97);
        IJth(rJacobian, 14, 1) = ((var_x231) ? (0) : ((var_x228) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5.0) / pow((1.8382656249999998e-21 + var_x229), 2)) : (-4.0567542199219968e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15.0) / pow((5.070942774902496e-56 + var_x230), 2))));
        ...
        IJth(rJacobian, 16, 2) = -var_x234 * var_x31;
        ...
        IJth(rJacobian, 15, 6) = -var_x232 * var_x70;
        ...
        IJth(rJacobian, 13, 8) = var_x226 * var_chaste_interface__calcium_dynamics__g;
        ...
        IJth(rJacobian, 16, 11) = -var_x233 * var_x31;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-0.072999999999999995 * var_x76);
        IJth(rJacobian, 12, 12) = -var_x222;
        IJth(rJacobian, 16, 12) = -8.5326413134134178e-6 * var_x76;
        IJth(rJacobian, 1, 13) = var_x94 * (8.0000000000000007e-5 + var_x111 * (var_x109 - var_x110));
        IJth(rJacobian, 13, 13) = var_x225 * (-8.0000000000000007e-5 + var_x111 * (var_x110 - var_x109)) + 9.9963436928702016 * pow(var_x223, (-3.0)) * (var_x100 + var_x99 - var_x107 - var_x98) / pow((0.33333333333333331 + var_x224), 2);
        IJth(rJacobian, 1, 14) = var_x105 * var_x94 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 13, 14) = var_x226 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 14, 14) = ((var_x231) ? (0) : (-0.5));
        ...
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (0.86632725819393008 * var_x89 - 2.5645210233307827 * var_x84 - 0.3900209056315565 * var_x83 - 6.5448713616254341 * var_x79 - 14.438787636565502 * var_x85 - 1.9501045281577825 * var_x86 - var_x46 * var_x88);
        IJth(rJacobian, 16, 16) = 0.00010126109252331096 * var_x89 - 4.5587787568311439e-5 * var_x83 - 0.00029975531551766426 * var_x84 - 0.00022793893784155719 * var_x86 - 0.00076500054481070561 * var_x79 - 0.0016876848753885161 * var_x85 - var_x235 * var_x88;
    }
