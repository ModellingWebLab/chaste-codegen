...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_SAN_model_1989FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x9 = -0.037433890822745466 * var_chaste_interface__membrane__V;
        ...
        const double var_x35 = exp(3.7433890822745468 - var_x1);
        const double var_x36 = 1.0 - var_x35;
        const double var_x37 = 1 / var_x36;
        const double var_x38 = exp(3.7433890822745468);
        ...
        const double var_x41 = 0.29947112658196373 * var_x40;
        ...
        const double var_x49 = 2.8025923642584549e-5 * var_x48;
        ...
        const double var_x52 = var_x18 * var_x22;
        const double var_x53 = 2.0 * var_x17 - 2744000.0 * var_x19;
        const double var_x54 = var_x20 * var_x53 / pow((0.0036443148688046641 + 7.2886297376093286e-7 * var_x14 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x55 = var_x21 * var_x53 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        ...
        const double var_x61 = 1 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki + var_chaste_interface__intracellular_sodium_concentration__Nai);
        ...
        const double var_x65 = var_x27 * var_x29;
        ...
        const double var_x71 = 1.6696100412309782 * var_x0;
        const double var_x72 = var_x61 * var_x7 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x73 = pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 2.0);
        const double var_x74 = var_x54 * var_x73;
        const double var_x75 = var_x16 * var_x22 * var_x73;
        const double var_x76 = var_x28 * var_x43;
        const double var_x77 = -var_x27 * var_x76;
        const double var_x78 = var_x2 * var_x6;
        const double var_x79 = var_x13 * var_x2;
        const double var_x80 = 1.1761547293737241e-5 * var_x40;
        ...
        const double var_x91 = exp(-0.041666666666666664 * var_chaste_interface__membrane__V);
        ...
        const double var_x101 = 0.20000000000000001 / var_x100;
        const double var_x102 = -8.0 * var_x92;
        const double var_x103 = exp(-9.375 - 0.125 * var_chaste_interface__membrane__V);
        const double var_x104 = exp(-7.5 + var_x98);
        const double var_x105 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x106 = fabs(var_x105) < 0.0001;
        const double var_x107 = 1.0 - var_chaste_interface__second_inward_current_d_gate__d;
        ...
        const double var_x112 = 0.029999999999999999 / var_x111;
        const double var_x113 = exp(1.8999999999999999 + var_x97);
        const double var_x114 = -1.0 + var_x113;
        const double var_x115 = 0.012 / var_x114;
        const double var_x116 = exp(-8.5 + var_x109);
        const double var_x117 = 1.0 + var_x116;
        const double var_x118 = -0.012500000000000001 * var_x116 * var_chaste_interface__second_inward_current_f_gate__f / pow(var_x117, 2);
        const double var_x119 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x120 = fabs(var_x119) < 0.0001;
        const double var_x121 = 1.0 - var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x122 = exp(8.5 + var_x108);
        const double var_x123 = -1.0 + var_x122;
        const double var_x124 = 0.0062500000000000003 / var_x123;
        const double var_x125 = -0.050000000000000003 / var_x117;
        const double var_x126 = -4.9092993655091844e-6 * var_x0;
        const double var_x127 = 1.6364331218363949e-5 * var_x7;
        const double var_x128 = 5.8807736468686208e-8 * var_x26;
        const double var_x129 = 2.2014023865015864e-9 * var_x48;
        const double var_x130 = 9.8185987310183688e-6 * var_x57;
        const double var_x131 = var_x128 * var_x33;
        const double var_x132 = 0.00013114584825700808 * var_x0;
        const double var_x133 = -var_x128 * var_x76;
        const double var_x134 = 0.002 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x135 = 0.20000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        ...
        const double var_x138 = exp(16.0 + var_x108);
        const double var_x139 = -1.0 + var_x138;
        const double var_x140 = 0.00062500000000000001 / var_x139;
        const double var_x141 = exp(-16.0 + var_x109);
        const double var_x142 = 1.0 + var_x141;
        const double var_x143 = 64.0 + var_chaste_interface__membrane__V;
        const double var_x144 = var_x128 * var_x29;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.013333333333333336 + 0.022420738914067637 * var_x47 + 0.0021596475474660848 * var_x13 - 0.125 * var_x0 - 0.00033333333333333338 * var_x23 - 0.028846153846153851 * var_x6 - 0.010695397377927277 * var_x11 - 0.0040077070808895903 * var_x44 - 0.044841477828135273 * var_x46 + var_x32 * var_x49 + var_x49 * var_x50 - var_x27 * var_x32 - var_x31 * var_x34 - var_x31 * var_x41 - var_x8 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 1, 0) = -6.5457324873455795e-8 + 2.6182929949382318e-8 * var_x23 + 8.8056095460063457e-7 * var_x47 - 1.7611219092012691e-6 * var_x46 - var_x31 * var_x80;
        IJth(rJacobian, 2, 0) = -1.75e-6 * var_x88 * (1.0 - var_chaste_interface__hyperpolarising_activated_current_y_gate__y) - 0.0010263157894736842 * var_x89 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        IJth(rJacobian, 3, 0) = 7.5000000000000007e-5 * var_x90 * (1.0 - var_chaste_interface__time_dependent_potassium_current_x_gate__x) + 3.9999999999999996e-5 * var_x91 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        IJth(rJacobian, 4, 0) = ((var_x95) ? (var_x93) : (var_x93 + var_x101 * var_x96 - 0.020000000000000004 * var_x94 * var_x96 * var_x99 / pow(var_x100, 2)));
        IJth(rJacobian, 5, 0) = -0.0025000000000000001 * var_x103 * (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x104 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x104), 2);
        IJth(rJacobian, 6, 0) = ((var_x106) ? (0) : (var_x107 * var_x112 - var_x115 * var_chaste_interface__second_inward_current_d_gate__d + 0.0012000000000000001 * var_x105 * var_x113 * var_chaste_interface__second_inward_current_d_gate__d / pow(var_x114, 2) - 0.0074999999999999997 * var_x105 * var_x107 * var_x110 / pow(var_x111, 2)));
        IJth(rJacobian, 7, 0) = ((var_x120) ? (var_x118) : (var_x118 + var_x121 * var_x124 - 0.0015625000000000001 * var_x119 * var_x121 * var_x122 / pow(var_x123, 2)));
        IJth(rJacobian, 9, 0) = -9.16402548228381e-7 + var_x126 - 7.8548789848146954e-8 * var_x23 - 3.0819633411022213e-7 * var_x44 + var_x129 * var_x50 - var_x127 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x128 * var_x50;
        ...
        IJth(rJacobian, 13, 0) = var_x126 + 1.6963770135197943e-7 * var_x13 - 2.2658304763888542e-6 * var_x6 - 6.6042071595047592e-9 * var_x44 - 8.401105209812315e-7 * var_x11 + var_x129 * var_x32 - var_x128 * var_x32;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (914.66666666666674 * var_x52 + 1.2147716229348882e-6 * var_x54 + 2.3000000000000004e-6 * var_x55 - 0.022261467216413047 * var_x51 - 0.29947112658196373 * var_x56);
        IJth(rJacobian, 1, 1) = -0.20000000000000001 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 1.1761547293737241e-5 * var_x56 - 8.7430565504672055e-7 * var_x51 - 9.5418840923404938e-11 * var_x54 - 0.071845959781105084 * var_x52 - 1.8066221665073799e-10 * var_x55 + var_x81 * var_x85 - var_x81 * var_x86;
        IJth(rJacobian, 8, 1) = -20.0 * var_chaste_interface__second_inward_current_f2_gate__f2;
        IJth(rJacobian, 9, 1) = 5.4198664995221396e-10 * var_x55 + 2.862565227702148e-10 * var_x54 + 0.21553787934331525 * var_x52;
        IJth(rJacobian, 10, 1) = 4.0 - 0.80000000000000004 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
        IJth(rJacobian, 11, 1) = var_x135 * var_x86 - var_x135 * var_x85;
        ...
        IJth(rJacobian, 9, 2) = -var_x130 * var_x60;
        IJth(rJacobian, 13, 2) = -var_x12 * var_x130;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (0.28571428571428575 * var_x10 - 0.095238095238095247 * var_chaste_interface__intracellular_potassium_concentration__Ki);
        IJth(rJacobian, 3, 3) = -0.0021000000000000003 * var_x90 - 0.00096000000000000002 * var_x91;
        ...
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.62500000000000011 * var_x63);
        IJth(rJacobian, 4, 4) = ((var_x95) ? (-2.0 + var_x102) : (var_x102 - var_x101 * var_x94));
        IJth(rJacobian, 9, 4) = -4.9092993655091846e-5 * var_x63;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x62 * var_x8);
        IJth(rJacobian, 5, 5) = -2.0 / (1.0 + 320.0 * var_x104) - 0.02 * var_x103;
        IJth(rJacobian, 9, 5) = -var_x127 * var_x62;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x34 * var_x64 - var_x41 * var_x64 - var_x64 * var_x65);
        IJth(rJacobian, 1, 6) = -var_x64 * var_x80;
        IJth(rJacobian, 6, 6) = ((var_x106) ? (-0.23999999999999999) : (-var_x105 * var_x112 - var_x105 * var_x115));
        IJth(rJacobian, 9, 6) = -var_x131 * var_x64;
        IJth(rJacobian, 13, 6) = -var_x144 * var_x64;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x34 * var_x67 - var_x41 * var_x67 - var_x65 * var_x67);
        IJth(rJacobian, 1, 7) = -var_x67 * var_x80;
        IJth(rJacobian, 7, 7) = ((var_x120) ? (-0.025000000000000001 + var_x125) : (var_x125 - var_x119 * var_x124));
        IJth(rJacobian, 9, 7) = -var_x131 * var_x67;
        IJth(rJacobian, 13, 7) = -var_x144 * var_x67;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x34 * var_x68 - var_x41 * var_x68 - var_x65 * var_x68);
        ...
        IJth(rJacobian, 9, 8) = -var_x131 * var_x68;
        IJth(rJacobian, 13, 8) = -var_x144 * var_x68;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x77 + 2.6562061725981521e-12 * var_x74 + 0.0035156250000000005 * var_x70 - 0.31166054102978263 * var_x59 - 5.6250000000000009 * var_x69 - 0.002 * var_x75 - 5.5653668041032613 * var_x72 - var_x59 * var_x71);
        IJth(rJacobian, 1, 9) = 1.5709757969629391e-7 * var_x75 - 2.0864178044476296e-16 * var_x74;
        IJth(rJacobian, 9, 9) = var_x133 + 8.2844426792967482e-7 * var_x70 + 6.2592534133428895e-16 * var_x74 - 2.4480558341308175e-5 * var_x59 - 0.0013255108286874798 * var_x69 - 4.7129273908888172e-7 * var_x75 - 0.00043715282752336028 * var_x72 - var_x132 * var_x59;
        ...
        IJth(rJacobian, 10, 10) = -var_x134 - 0.80000000000000004 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 11, 10) = var_x136;
        IJth(rJacobian, 1, 11) = 0.002 * var_x87;
        IJth(rJacobian, 10, 11) = var_x134;
        IJth(rJacobian, 11, 11) = -var_x136 - 0.10000000000000001 * var_x87;
        ...
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x77 + 0.057692307692307696 * var_x79 - 0.095238095238095247 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 0.66784401649239133 * var_x72 - 0.77058924979891319 * var_x78 - var_x2 * var_x71);
        IJth(rJacobian, 9, 13) = -5.2458339302803232e-5 * var_x72;
        IJth(rJacobian, 13, 13) = var_x133 + 4.5316609527777075e-6 * var_x79 - 7.4808371283949473e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 6.0528853041696031e-5 * var_x78 - var_x132 * var_x2;
    }
