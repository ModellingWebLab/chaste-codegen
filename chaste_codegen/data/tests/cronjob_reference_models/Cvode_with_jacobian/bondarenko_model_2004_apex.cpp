...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_model_2004_apexFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x33 = (0.00048492031714920903 * var_x29 + 0.038949423064193495 * var_x31 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x30)) / (pow(var_x32, 2) * (1.0 + 3043189.1166997822 * var_x28));
        ...
        const double var_x53 = var_x1 * var_x7;
        const double var_x54 = var_x1 * var_x6;
        ...
        const double var_x162 = 0.23324 * var_x124;
        const double var_x163 = var_x161 * var_x162;
        const double var_x164 = 0.00058310000000000002 * var_x127 * var_x161;
        const double var_x165 = 0.00093296000000000004 * var_x115 * var_x124;
        const double var_x166 = 2.3324000000000003e-6 * var_x115 * var_x127;
        const double var_x167 = 0.026000000000000002 * var_x97;
        const double var_x168 = var_x160 * var_x162 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x169 = var_x112 * var_x157;
        const double var_x170 = 0.00040000000000000002 * var_x94;
        const double var_x171 = 0.0001 * var_x94;
        const double var_x172 = var_x99 * var_chaste_interface__L_type_calcium_current__I1;
        const double var_x173 = var_x94 * (-0.026000000000000002 + 0.026000000000000002 * var_x97);
        const double var_x174 = var_x113 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x175 = var_x117 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x176 = var_x120 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x177 = var_x125 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x178 = var_x128 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x179 = 0.013000000000000001 - var_x130;
        const double var_x180 = -var_x135;
        const double var_x181 = -0.04926108374384236 * var_chaste_interface__membrane__V;
        const double var_x182 = exp(0.36945812807881773 + var_x181);
        const double var_x183 = 0.01083743842364532 * var_x182 * var_chaste_interface__fast_sodium_current__O_Na;
        const double var_x184 = exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__membrane__V);
        const double var_x185 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__membrane__V);
        const double var_x186 = (0.0085583333333333327 * var_x184 + 0.0016666666666666668 * var_x185) / pow((var_x185 + 0.4108 * var_x184), 2);
        const double var_x187 = 60.832000000000001 * var_x186 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x188 = exp(-0.42168674698795178 - 0.060240963855421679 * var_chaste_interface__membrane__V);
        const double var_x189 = var_x188 / pow((1 + 0.47846713846216332 * var_x188), 2);
        const double var_x190 = 0.073163809141391992 * var_x189 * var_chaste_interface__fast_sodium_current__O_Na;
        const double var_x191 = 2.0000000000000002e-5 * var_chaste_interface__membrane__V;
        const double var_x192 = 0.008539999999999999 + var_x191;
        const double var_x193 = 1 / var_x192;
        const double var_x194 = 1 / (0.39395599999999997 + 0.188495 * var_x188);
        const double var_x195 = 1 / (0.25 * var_x185 + 0.1027 * var_x184);
        const double var_x196 = -0.12987012987012986 * var_chaste_interface__membrane__V;
        const double var_x197 = exp(-0.90909090909090906 + var_x196);
        const double var_x198 = 1 / var_x182;
        const double var_x199 = var_x194 * var_x195 * var_x197 * var_x198;
        const double var_x200 = var_x193 * var_x199;
        const double var_x201 = 9.7514961527500711e-7 * var_x200 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x202 = 3.317429681310359e-6 * var_x199 * var_chaste_interface__fast_sodium_current__IF_Na / pow((1 + 0.0023419203747072604 * var_chaste_interface__membrane__V), 2);
        const double var_x203 = var_x189 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x204 = var_x193 * var_x197 * var_x198;
        const double var_x205 = 8.8508255294954831e-7 * var_x195 * var_x203 * var_x204;
        const double var_x206 = 0.00019355636363636362 * var_x186 * var_x194 * var_x204 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x207 = 1.0 * var_x194;
        const double var_x208 = 0.22 * var_x182;
        const double var_x209 = 3.802 * var_x195;
        const double var_x210 = 1.2097272727272726e-5 * var_x200;
        const double var_x211 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x212 = -var_x211;
        const double var_x213 = exp(0.12315270935960591 + var_x181);
        const double var_x214 = 0.009852216748768473 * var_x213;
        const double var_x215 = var_x214 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x216 = 9.0909090909090901e-8 * var_x197;
        const double var_x217 = var_x216 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x218 = exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x219 = 71.871455576559541 * (0.0068466666666666667 * var_x218 + 0.0015333333333333334 * var_x185) / pow((var_x185 + 0.44652173913043475 * var_x218), 2);
        const double var_x220 = var_x219 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x221 = 0.20000000000000001 * var_x213;
        const double var_x222 = -var_x221;
        const double var_x223 = -0.008539999999999999 - var_x191;
        const double var_x224 = 3.802 / (0.1027 * var_x218 + 0.23000000000000001 * var_x185);
        const double var_x225 = 6.9999999999999997e-7 * var_x197;
        const double var_x226 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x227 = -var_x226;
        const double var_x228 = exp(-0.12315270935960591 + var_x181);
        const double var_x229 = 0.0094433497536945809 * var_x228;
        const double var_x230 = var_x216 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x231 = exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x232 = 95.049999999999997 * (0.0013333333333333335 * var_x185 + 0.0060411764705882356 * var_x231) / pow((var_x185 + 0.51349999999999996 * var_x231), 2);
        const double var_x233 = 3.802 / (0.20000000000000001 * var_x185 + 0.1027 * var_x231);
        const double var_x234 = -var_x233;
        const double var_x235 = 0.19170000000000001 * var_x228;
        const double var_x236 = -var_x224 - var_x235;
        const double var_x237 = var_x223 + var_x234;
        const double var_x238 = var_x216 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x239 = 1.818181818181818e-9 * var_x197 * var_chaste_interface__fast_sodium_current__I2_Na;
        const double var_x240 = 7.3163809141391995e-5 * var_x203;
        const double var_x241 = 7.7014535938307356e-7 * var_x189 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x242 = -var_x225;
        const double var_x243 = 1.0526315789473684e-5 * var_x194;
        const double var_x244 = 1.4e-8 * var_x197;
        const double var_x245 = 0.001 * var_x194;
        const double var_x246 = var_x214 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x247 = var_x219 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x248 = var_x229 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x249 = var_x232 * var_chaste_interface__fast_sodium_current__IC_Na3;
        const double var_x250 = 0.025019562392723658 * var_x8;
        const double var_x251 = 0.25271120029236765 * var_x2 - 0.0098429554532475667 * var_chaste_interface__membrane__V;
        const double var_x252 = 0.078972250091364896 * var_x2 - 0.0030759235791398645 * var_chaste_interface__membrane__V;
        const double var_x253 = exp(1.0731000000000002 + 0.035770000000000003 * var_chaste_interface__membrane__V);
        const double var_x254 = exp(-1.8711 - 0.062370000000000002 * var_chaste_interface__membrane__V);
        const double var_x255 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x256 = exp(4.7857142857142856 + var_x255);
        const double var_x257 = 1.0 + 0.051334999999999999 * var_x256;
        const double var_x258 = var_x256 / var_x257;
        const double var_x259 = 1.0 - var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x260 = -var_x255;
        const double var_x261 = exp(-4.7857142857142856 + var_x260);
        const double var_x262 = 1.0 + 0.0067083000000000004 * var_x261;
        const double var_x263 = exp(-1.9285714285714286 + var_x260);
        const double var_x264 = var_x263 / var_x262;
        const double var_x265 = exp(-2.9220779220779218 + var_x196);
        const double var_x266 = 1.0 + var_x265;
        const double var_x267 = 1.0 / var_x266;
        const double var_x268 = exp(-0.062899999999999998 * var_chaste_interface__membrane__V);
        const double var_x269 = 0.0073216139155926159 * var_x268 / pow((1 + 0.23955296404275997 * var_x268), 2);
        const double var_x270 = 1 / (2.0579999999999998 + 0.49299999999999999 * var_x268);
        const double var_x271 = 0.12987012987012986 * var_x265 / pow(var_x266, 2);
        const double var_x272 = var_x270 * var_x271;
        const double var_x273 = -var_x270;
        const double var_x274 = exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V);
        const double var_x275 = 1.0 + var_x274;
        const double var_x276 = 1 / var_x275;
        const double var_x277 = 1 / (270.0 + 1050.0 * var_x276);
        const double var_x278 = var_x274 / pow(var_x275, 2);
        const double var_x279 = 0.17543859649122806 * var_x278;
        const double var_x280 = 1.0 * var_x276;
        const double var_x281 = 1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        const double var_x282 = exp(-3.3919999999999999 - 0.128 * var_chaste_interface__membrane__V);
        const double var_x283 = 1.0 - var_x282;
        const double var_x284 = 4.8133299999999997e-6 / var_x283;
        const double var_x285 = exp(-1.0069999999999999 - 0.037999999999999999 * var_chaste_interface__membrane__V);
        const double var_x286 = 26.5 + var_chaste_interface__membrane__V;
        const double var_x287 = 1 / (1200.0 - 170.0 * var_x276);
        ...
        const double var_x290 = exp(0.038198000000000003 * var_chaste_interface__membrane__V);
        const double var_x291 = 0.00052457313400000008 * var_x290 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2;
        const double var_x292 = exp(-0.041779999999999998 * var_chaste_interface__membrane__V);
        const double var_x293 = 2.8786419999999997e-6 * var_x292 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x294 = exp(0.11695499999999999 + 0.023390999999999999 * var_chaste_interface__membrane__V);
        const double var_x295 = 0.0021243940109999999 * var_x294 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x296 = exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x297 = 0.00021232196 * var_x296 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K;
        const double var_x298 = 6.8899999999999994e-5 * var_x292;
        const double var_x299 = 0.090820999999999999 * var_x294;
        const double var_x300 = 0.013733 * var_x290;
        const double var_x301 = 0.0064970000000000002 * var_x296;
        const double var_x302 = exp(0.01176 * var_chaste_interface__membrane__V);
        const double var_x303 = exp(-0.063100000000000003 * var_chaste_interface__membrane__V);
        const double var_x304 = -0.022348 * var_x302;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.002967 + 0.025339071657754012 * var_x18 - 13.0 * var_chaste_interface__fast_sodium_current__O_Na - 0.1729 * var_chaste_interface__L_type_calcium_current__O - 0.0057499999999999999 * var_x0 - 0.050000000000000003 * var_x6 - 0.078 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K - 0.16 * var_x7 - 0.28280213903743318 * var_x5 - 6.8281768329957496e-20 * var_x26 - 0.68869565217391304 * var_x33 - 2.6970585464294846e-17 * var_x16 - var_x22 * var_x24 - var_x9 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 0.25641025641025644 * var_x19 * var_x23 * var_x34 * var_chaste_interface__calcium_concentration__Cai / pow(var_x20, 2));
        IJth(rJacobian, 1, 0) = var_x63 * (-1.1288639535443301e-5 + 1.6591891954566279e-18 * var_x16 + 4.2005900246296372e-21 * var_x26);
        ...
        IJth(rJacobian, 15, 0) = var_x158 + var_x159 + var_x174 + var_x175 - var_x156 - var_x172 - var_x176 - 0.0075400000000000007 * var_x151 * var_x98 - 0.076923076923076927 * var_x173 * var_chaste_interface__L_type_calcium_current__I1;
        IJth(rJacobian, 16, 0) = var_x100 + var_x121 + var_x150 + var_x153 - var_x114 - var_x118;
        IJth(rJacobian, 17, 0) = var_x149 + var_x155 + var_x172 + var_x176 - var_x174 - var_x175;
        IJth(rJacobian, 18, 0) = -0.00015994802611527293 - 0.79974013057636473 * var_chaste_interface__fast_sodium_current__O_Na - 1.2601770073888914e-20 * var_x26 - 0.12710251172237075 * var_x33 - 4.9775675863698846e-18 * var_x16;
        IJth(rJacobian, 19, 0) = var_x183 + var_x187 + var_x205 + var_x206 - var_x190 - var_x201 - var_x202;
        IJth(rJacobian, 20, 0) = var_x212 + var_x215 + var_x220 - var_x183 - var_x187 - var_x217;
        IJth(rJacobian, 21, 0) = var_x227 - var_x215 - var_x220 - var_x230 + var_x229 * var_chaste_interface__fast_sodium_current__C_Na2 + var_x232 * (1.0 - var_chaste_interface__fast_sodium_current__C_Na1 - var_chaste_interface__fast_sodium_current__C_Na2 - var_chaste_interface__fast_sodium_current__I1_Na - var_chaste_interface__fast_sodium_current__I2_Na - var_chaste_interface__fast_sodium_current__IC_Na2 - var_chaste_interface__fast_sodium_current__IC_Na3 - var_chaste_interface__fast_sodium_current__IF_Na - var_chaste_interface__fast_sodium_current__O_Na);
        IJth(rJacobian, 22, 0) = var_x238 + var_x240 - var_x239 - var_x241;
        IJth(rJacobian, 23, 0) = var_x239 + var_x241;
        IJth(rJacobian, 24, 0) = var_x190 + var_x201 + var_x202 + var_x211 + var_x217 + var_x246 + var_x247 - var_x205 - var_x206 - var_x238 - var_x240;
        IJth(rJacobian, 25, 0) = var_x226 + var_x230 + var_x248 + var_x249 - var_x246 - var_x247;
        IJth(rJacobian, 26, 0) = 2.0000000000000002e-5 + var_x212 + var_x227 - var_x248 - var_x249 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I1_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I2_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na2 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na3 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IF_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__O_Na + var_x216 * var_chaste_interface__fast_sodium_current__IC_Na3;
        IJth(rJacobian, 27, 0) = 0.0015588209597120044 * var_x18 + 0.084735007814913832 * var_x33 - 0.0047984407834581883 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K - 0.0098429554532475667 * var_x7 - 0.0003537312116010844 * var_x0 - 0.0030759235791398645 * var_x6 - 0.017397555353928621 * var_x5 - var_x250 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        IJth(rJacobian, 28, 0) = 0.035770000000000003 * var_x253 * (0.18064 - 0.18064 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f) + 0.024673572000000001 * var_x254 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f;
        IJth(rJacobian, 29, 0) = -0.00013571428571428572 * var_x258 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 2.1714285714285715e-5 * var_x259 * var_x264 + 6.9668928571428572e-6 * pow(var_x256, 2) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f / pow(var_x257, 2) + 1.4566594285714287e-7 * var_x259 * var_x261 * var_x263 / pow(var_x262, 2);
        IJth(rJacobian, 30, 0) = var_x272 + var_x269 * (var_x267 - var_chaste_interface__slow_transient_outward_potassium_current__ato_s);
        IJth(rJacobian, 31, 0) = -var_x277 * var_x279 + 0.00016708437761069341 * var_x278 * (var_x280 - var_chaste_interface__slow_transient_outward_potassium_current__ito_s) / pow((0.25714285714285712 + var_x276), 2);
        IJth(rJacobian, 32, 0) = var_x281 * var_x284 + 3.6226653999999999e-6 * var_x285 * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs - 6.1610624e-7 * var_x281 * var_x282 * var_x286 / pow(var_x283, 2);
        IJth(rJacobian, 33, 0) = var_x272 + var_x269 * (var_x267 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur);
        IJth(rJacobian, 34, 0) = -var_x279 * var_x287 - 2.0711500974658867e-5 * var_x278 * (var_x280 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur) / pow((1 - 0.14166666666666666 * var_x276), 2);
        IJth(rJacobian, 35, 0) = var_x271 * var_x289 + 0.0021933842239185751 * var_x288 * (var_x267 - var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss) / pow((0.33511450381679392 + var_x288), 2);
        IJth(rJacobian, 37, 0) = var_x291 + var_x293 - var_x295 - var_x297;
        IJth(rJacobian, 38, 0) = 0.01176 * var_x302 * (0.022348 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K) + 0.0029658262000000005 * var_x303 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1;
        IJth(rJacobian, 39, 0) = -var_x291 - var_x293;
        IJth(rJacobian, 40, 0) = var_x295 + var_x297;
        ...
        IJth(rJacobian, 1, 1) = var_x63 * (-2.7458174 + var_x64 + var_x65 + 0.96151847158279735 * var_x38 - 0.00014491407891765456 * var_x35 - 0.0045528151523329874 * var_x39 - 0.96151847158279735 * var_x41) + 0.16806722689075632 * pow(var_x61, (-3.0)) * pow((0.084033613445378158 + var_x62), (-2.0)) * (0.125 * var_chaste_interface__calcium_concentration__Cass + 0.019599999999999999 * var_chaste_interface__calcium_buffering__LTRPN_Ca + 3.1999999999999999e-5 * var_chaste_interface__calcium_buffering__HTRPN_Ca + 1.7399999999999999e-5 * var_chaste_interface__calcium_concentration__CaNSR + 0.00014491407891765456 * log(1800.0 * var_x35) - 0.1250174 * var_chaste_interface__calcium_concentration__Cai - 1.1288639535443301e-5 * var_chaste_interface__membrane__V - var_x66 * (70.0 - var_chaste_interface__calcium_buffering__LTRPN_Ca) - var_x67 * (140.0 - var_chaste_interface__calcium_buffering__HTRPN_Ca) + 1.6591891954566279e-18 * var_x12 * var_x25 - 0.48075923579139868 * var_x36 * var_x40);
        IJth(rJacobian, 2, 1) = 2175.0841750841751 * var_x70;
        IJth(rJacobian, 4, 1) = 0.00021430695900857957 + 11.084842707340323 * var_x41 - 11.084842707340323 * var_x38;
        IJth(rJacobian, 6, 1) = 2.2890000000000001 - var_x64;
        IJth(rJacobian, 7, 1) = 0.33180000000000004 - var_x65;
        IJth(rJacobian, 18, 1) = 0.013658445456998963 * var_x39;
        ...
        IJth(rJacobian, 14, 2) = var_x164 + var_x166 - var_x163 - var_x165;
        IJth(rJacobian, 15, 2) = var_x126 + var_x165 - var_x129 - var_x166;
        IJth(rJacobian, 16, 2) = var_x178 - var_x177;
        IJth(rJacobian, 17, 2) = var_x163 + var_x177 - var_x164 - var_x178;
        ...
        IJth(rJacobian, 14, 14) = -0.026000000000000002 + var_x167 - var_x134 - var_x148 - var_x168 - var_x169;
        IJth(rJacobian, 15, 14) = var_x169;
        IJth(rJacobian, 16, 14) = 0.026000000000000002 - var_x167;
        IJth(rJacobian, 17, 14) = var_x168;
        ...
        IJth(rJacobian, 15, 15) = -0.0135 + var_x130 + var_x173;
        IJth(rJacobian, 17, 15) = var_x179;
        IJth(rJacobian, 11, 16) = var_x135;
        IJth(rJacobian, 12, 16) = var_x141;
        IJth(rJacobian, 14, 16) = var_x170;
        IJth(rJacobian, 16, 16) = var_x133 + var_x180 - var_x170;
        ...
        IJth(rJacobian, 17, 17) = -0.00050000000000000001 + var_x180 - var_x171;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-1.4564116150719216e-13 * var_x44 - 337.46387724285864 * var_x46 - 46927524.368911915 * var_x47 - 3.3946082173859908e-7 * var_x48 - 9385.5048737823836 * var_x43);
        IJth(rJacobian, 1, 18) = 8.9596216554657907e-15 * var_x44 * var_x63;
        IJth(rJacobian, 18, 18) = -6.2649332746797074e-8 * var_x48 - 2.6878864966397375e-14 * var_x44 - 577.38191486798701 * var_x43 - 2886909.5743399351 * var_x47;
        IJth(rJacobian, 27, 18) = 4.1766221831198049e-8 * var_x48 - 20.760261942385391 * var_x46;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (333.76617616580313 * var_x49 - 13.0 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 18, 19) = 20.532785023754872 * var_x49 - 0.79974013057636473 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 19, 19) = -var_x207 - var_x208;
        IJth(rJacobian, 20, 19) = var_x208;
        IJth(rJacobian, 21, 19) = var_x234;
        IJth(rJacobian, 24, 19) = var_x207;
        IJth(rJacobian, 26, 19) = var_x223;
        IJth(rJacobian, 19, 20) = var_x209;
        IJth(rJacobian, 20, 20) = var_x222 + var_x223 - var_x209;
        IJth(rJacobian, 21, 20) = var_x221 + var_x234;
        IJth(rJacobian, 24, 20) = var_x192;
        IJth(rJacobian, 26, 20) = var_x223;
        IJth(rJacobian, 20, 21) = var_x224;
        IJth(rJacobian, 21, 21) = var_x236 + var_x237;
        IJth(rJacobian, 25, 21) = var_x192;
        IJth(rJacobian, 26, 21) = var_x223;
        IJth(rJacobian, 21, 22) = var_x234;
        IJth(rJacobian, 22, 22) = var_x242 - var_x243;
        IJth(rJacobian, 23, 22) = var_x243;
        IJth(rJacobian, 24, 22) = var_x225;
        IJth(rJacobian, 26, 22) = var_x223;
        IJth(rJacobian, 21, 23) = var_x234;
        IJth(rJacobian, 22, 23) = var_x244;
        IJth(rJacobian, 23, 23) = -var_x244;
        IJth(rJacobian, 26, 23) = var_x223;
        IJth(rJacobian, 19, 24) = var_x210;
        IJth(rJacobian, 20, 24) = var_x225;
        IJth(rJacobian, 21, 24) = var_x234;
        IJth(rJacobian, 22, 24) = var_x245;
        IJth(rJacobian, 24, 24) = var_x222 + var_x242 - var_x210 - var_x245;
        IJth(rJacobian, 25, 24) = var_x221;
        IJth(rJacobian, 26, 24) = var_x223;
        IJth(rJacobian, 21, 25) = var_x225 + var_x234;
        IJth(rJacobian, 24, 25) = var_x224;
        IJth(rJacobian, 25, 25) = var_x236 + var_x242;
        IJth(rJacobian, 26, 25) = var_x223 + var_x235;
        IJth(rJacobian, 21, 26) = var_x234;
        IJth(rJacobian, 25, 26) = var_x233;
        IJth(rJacobian, 26, 26) = var_x237 + var_x242;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (0.65056346575383339 * var_x55 - 10.441746449740933 * var_x52 - 4.1078913989637309 * var_x53 - 0.14762734715025908 * var_x50 - 1.2837160621761659 * var_x54 - 16535.729984900074 * var_x46 - 5214169.374323546 * var_x47 - 7.2607529660026051 * var_x51 - 1042.8338748647093 * var_x43);
        IJth(rJacobian, 18, 27) = -320767.730482215 * var_x47 - 64.153546096442994 * var_x43;
        IJth(rJacobian, 27, 27) = 0.040021670080783313 * var_x55 - 0.0090818087605069632 * var_x50 - 0.25271120029236765 * var_x53 - 0.078972250091364896 * var_x54 - 0.64236028224316211 * var_x52 - 0.44667042500874238 * var_x51 - 1017.2528351768842 * var_x46;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-1.2201 * var_x56);
        IJth(rJacobian, 27, 28) = -0.075058687178170977 * var_x56;
        IJth(rJacobian, 28, 28) = -0.18064 * var_x253 - 0.39560000000000001 * var_x254;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x9);
        IJth(rJacobian, 27, 29) = -var_x17 * var_x250;
        IJth(rJacobian, 29, 29) = -0.00015200000000000001 * var_x264 - 0.00095 * var_x258;
        IJth(rJacobian, 30, 30) = var_x273;
        IJth(rJacobian, 31, 31) = -var_x277;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0115 * var_x57);
        IJth(rJacobian, 27, 32) = -0.00070746242320216879 * var_x57;
        IJth(rJacobian, 32, 32) = -9.5333299999999997e-5 * var_x285 - var_x284 * var_x286;
        ...
        IJth(rJacobian, 27, 33) = var_x251 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur;
        IJth(rJacobian, 33, 33) = var_x273;
        ...
        IJth(rJacobian, 27, 34) = var_x251 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur;
        IJth(rJacobian, 34, 34) = -var_x287;
        ...
        IJth(rJacobian, 27, 35) = var_x252 * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss;
        IJth(rJacobian, 35, 35) = -var_x289;
        ...
        IJth(rJacobian, 27, 36) = var_x252 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss;
        ...
        IJth(rJacobian, 37, 37) = -var_x298 - var_x299;
        IJth(rJacobian, 38, 37) = var_x304;
        IJth(rJacobian, 39, 37) = var_x298;
        IJth(rJacobian, 40, 37) = var_x299;
        IJth(rJacobian, 38, 38) = -0.023761000000000001 + var_x304 - 0.047002000000000002 * var_x303;
        IJth(rJacobian, 39, 38) = 0.023761000000000001;
        IJth(rJacobian, 37, 39) = var_x300;
        IJth(rJacobian, 38, 39) = 0.036777999999999998 + var_x304;
        IJth(rJacobian, 39, 39) = -0.036777999999999998 - var_x300;
        IJth(rJacobian, 37, 40) = var_x301;
        IJth(rJacobian, 38, 40) = var_x304;
        IJth(rJacobian, 40, 40) = -var_x301;
    }
