...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_model_2004_apexFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x43 = var_x12 * var_x13 * pow(var_chaste_interface__sodium_concentration__Nai, 2.0);
        const double var_x44 = (2.4715768660405338e-6 * var_chaste_interface__sodium_concentration__Nai + 0.00012110726643598615 * var_chaste_interface__potassium_concentration__Ki) * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K / pow((0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai + var_chaste_interface__potassium_concentration__Ki), 2);
        const double var_x45 = var_x42 * var_chaste_interface__fast_sodium_current__O_Na;
        ...
        const double var_x50 = var_x1 * var_x8 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x51 = var_x1 * var_x7;
        const double var_x52 = var_x1 * var_x6;
        ...
        const double var_x80 = pow(var_x79, (-2.0));
        const double var_x81 = pow((1.0 + 18.75 * var_x80), (-1.0));
        ...
        const double var_x85 = -1 + 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x86 = exp(-0.038580246913580245 * pow(var_x85, 2.0));
        ...
        const double var_x94 = 1 + 0.068965517241379309 * var_chaste_interface__membrane__V;
        const double var_x95 = exp(-2.1025 * pow(var_x94, 2.0));
        const double var_x96 = var_x95 * pow(var_x94, 1.0);
        const double var_x97 = 0.0037699999999999999 * var_x96;
        const double var_x98 = var_x97 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x99 = 1 + 0.050000000000000003 * var_chaste_interface__membrane__V;
        const double var_x100 = exp(-1.0 * pow(var_x99, 2.0));
        const double var_x101 = 1 + 0.025000000000000001 * var_chaste_interface__membrane__V;
        const double var_x102 = exp(-160.0 * pow(var_x101, 2.0));
        ...
        const double var_x106 = var_x105 * (0.074999999999999997 * var_x100 * pow(var_x99, 1.0) - 5.5999999999999996 * var_x102 * pow(var_x101, 1.0));
        ...
        const double var_x109 = 1.0 + 0.69999999999999996 * var_x102 - 0.75 * var_x100;
        ...
        const double var_x128 = 0.013000000000000001 * var_x95;
        const double var_x129 = 0.20000000000000001 * var_x92;
        const double var_x130 = var_x123 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x131 = -var_x130;
        const double var_x132 = 0.40000000000000002 * var_x110;
        const double var_x133 = 0.00040000000000000002 * var_x110;
        const double var_x134 = 0.0076923076923076927 * var_x92 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x135 = 1.0 - var_chaste_interface__L_type_calcium_current__C3 - var_chaste_interface__L_type_calcium_current__C4 - var_chaste_interface__L_type_calcium_current__I1 - var_chaste_interface__L_type_calcium_current__I2 - var_chaste_interface__L_type_calcium_current__I3 - var_chaste_interface__L_type_calcium_current__O - 2 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x136 = 0.0144 * var_x117 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x137 = 1.2000000000000002 * var_x106 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x138 = 0.12000000000000001 * var_x110 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x139 = -1.6000000000000001 * var_x110;
        const double var_x140 = 0.10000000000000001 * var_x92;
        const double var_x141 = 0.011538461538461539 * var_x92 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x142 = 0.0096000000000000009 * var_x117 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x143 = 0.80000000000000004 * var_x106 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x144 = 0.080000000000000002 * var_x110 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x145 = 0.80000000000000004 * var_x110;
        const double var_x146 = 0.15000000000000002 * var_x92;
        const double var_x147 = 7.6923076923076936e-6 * var_x92 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x148 = 3.0769230769230774e-5 * var_x92 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x149 = var_x92 * var_chaste_interface__L_type_calcium_current__I1;
        const double var_x150 = var_x96 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x151 = 0.0075399999999999998 * var_x150;
        const double var_x152 = var_x122 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x153 = 0.87931480000000006 * var_x150 * var_x152;
        ...
        const double var_x158 = 13.0 - 13.0 * var_x95;
        const double var_x159 = var_x158 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x160 = 0.23324 * var_x122;
        const double var_x161 = var_x159 * var_x160;
        const double var_x162 = 0.00058310000000000002 * var_x125 * var_x159;
        const double var_x163 = 0.00093296000000000004 * var_x113 * var_x122;
        const double var_x164 = 2.3324000000000003e-6 * var_x113 * var_x125;
        const double var_x165 = 0.026000000000000002 * var_x95;
        const double var_x166 = var_x158 * var_x160 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x167 = var_x110 * var_x155;
        const double var_x168 = 0.00040000000000000002 * var_x92;
        const double var_x169 = 0.0001 * var_x92;
        const double var_x170 = var_x97 * var_chaste_interface__L_type_calcium_current__I1;
        const double var_x171 = var_x92 * (-0.026000000000000002 + 0.026000000000000002 * var_x95);
        const double var_x172 = var_x111 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x173 = var_x115 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x174 = var_x118 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x175 = var_x123 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x176 = var_x126 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x177 = 0.013000000000000001 - var_x128;
        const double var_x178 = -var_x133;
        const double var_x179 = -0.04926108374384236 * var_chaste_interface__membrane__V;
        ...
        const double var_x184 = (0.0085583333333333327 * var_x182 + 0.0016666666666666668 * var_x183) / pow((var_x183 + 0.4108 * var_x182), 2);
        ...
        const double var_x196 = 1 / var_x180;
        const double var_x197 = var_x192 * var_x193 * var_x195 * var_x196;
        const double var_x198 = var_x191 * var_x197;
        const double var_x199 = 9.7514961527500711e-7 * var_x198 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x200 = 3.317429681310359e-6 * var_x197 * var_chaste_interface__fast_sodium_current__IF_Na / pow((1 + 0.0023419203747072604 * var_chaste_interface__membrane__V), 2);
        const double var_x201 = var_x187 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x202 = var_x191 * var_x195 * var_x196;
        const double var_x203 = 8.8508255294954831e-7 * var_x193 * var_x201 * var_x202;
        const double var_x204 = 0.00019355636363636362 * var_x184 * var_x192 * var_x202 * var_chaste_interface__fast_sodium_current__IF_Na;
        ...
        const double var_x217 = 71.871455576559541 * (0.0068466666666666667 * var_x216 + 0.0015333333333333334 * var_x183) / pow((var_x183 + 0.44652173913043475 * var_x216), 2);
        ...
        const double var_x238 = 7.3163809141391995e-5 * var_x201;
        const double var_x239 = 7.7014535938307356e-7 * var_x187 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x240 = -var_x223;
        const double var_x241 = 1.0526315789473684e-5 * var_x192;
        ...
        const double var_x248 = 0.025019562392723658 * var_x8;
        const double var_x249 = 0.25271120029236765 * var_x2 - 0.0098429554532475667 * var_chaste_interface__membrane__V;
        const double var_x250 = 0.078972250091364896 * var_x2 - 0.0030759235791398645 * var_chaste_interface__membrane__V;
        ...
        const double var_x263 = exp(-2.9220779220779218 + var_x194);
        const double var_x264 = 1.0 + var_x263;
        const double var_x265 = 1.0 / var_x264;
        const double var_x266 = exp(-0.062899999999999998 * var_chaste_interface__membrane__V);
        const double var_x267 = 0.0073216139155926159 * var_x266 / pow((1 + 0.23955296404275997 * var_x266), 2);
        const double var_x268 = 1 / (2.0579999999999998 + 0.49299999999999999 * var_x266);
        const double var_x269 = 0.12987012987012986 * var_x263 / pow(var_x264, 2);
        const double var_x270 = var_x268 * var_x269;
        const double var_x271 = -var_x268;
        ...
        IJth(rJacobian, 1, 0) = var_x61 * (-1.1288639535443301e-5 + 1.6591891954566279e-18 * var_x16 + 4.2005900246296372e-21 * var_x26);
        IJth(rJacobian, 2, 0) = -var_x68 * var_x69;
        IJth(rJacobian, 5, 0) = -0.00247 * var_x86 * var_chaste_interface__L_type_calcium_current__O - 0.015432098765432098 * var_x87 * pow(var_x85, 1.0) * var_chaste_interface__L_type_calcium_current__O;
        IJth(rJacobian, 11, 0) = var_x108 + var_x112 + var_x114 + var_x116 + var_x93 - var_x119 - var_x121 - var_x98;
        IJth(rJacobian, 12, 0) = var_x136 - var_x134 - var_x137 - var_x138 + 1.6000000000000001 * var_x106 * var_x135 + 0.16 * var_x110 * var_x135 + 0.0038461538461538464 * var_x92 * var_chaste_interface__L_type_calcium_current__C2 - 0.019200000000000002 * var_x117 * var_x135;
        IJth(rJacobian, 13, 0) = var_x134 + var_x137 + var_x138 + var_x142 - var_x136 - var_x141 - var_x143 - var_x144;
        IJth(rJacobian, 14, 0) = var_x121 + var_x141 + var_x143 + var_x144 + var_x154 - var_x108 - var_x114 - var_x142 - var_x147 - var_x148 - var_x151 - var_x153 - var_x156 - var_x157 - var_x93 - 7.6923076923076936e-8 * var_x149;
        IJth(rJacobian, 15, 0) = var_x156 + var_x157 + var_x172 + var_x173 - var_x154 - var_x170 - var_x174 - 0.0075400000000000007 * var_x149 * var_x96 - 0.076923076923076927 * var_x171 * var_chaste_interface__L_type_calcium_current__I1;
        IJth(rJacobian, 16, 0) = var_x119 + var_x148 + var_x151 + var_x98 - var_x112 - var_x116;
        IJth(rJacobian, 17, 0) = var_x147 + var_x153 + var_x170 + var_x174 - var_x172 - var_x173;
        ...
        IJth(rJacobian, 19, 0) = var_x181 + var_x185 + var_x203 + var_x204 - var_x188 - var_x199 - var_x200;
        ...
        IJth(rJacobian, 22, 0) = var_x236 + var_x238 - var_x237 - var_x239;
        IJth(rJacobian, 23, 0) = var_x237 + var_x239;
        IJth(rJacobian, 24, 0) = var_x188 + var_x199 + var_x200 + var_x209 + var_x215 + var_x244 + var_x245 - var_x203 - var_x204 - var_x236 - var_x238;
        ...
        IJth(rJacobian, 27, 0) = 0.0015588209597120044 * var_x18 + 0.084735007814913832 * var_x33 - 0.0047984407834581883 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K - 0.0098429554532475667 * var_x7 - 0.0003537312116010844 * var_x0 - 0.0030759235791398645 * var_x6 - 0.017397555353928621 * var_x5 - var_x248 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        IJth(rJacobian, 28, 0) = 0.035770000000000003 * var_x251 * (0.18064 - 0.18064 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f) + 0.024673572000000001 * var_x252 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f;
        IJth(rJacobian, 29, 0) = -0.00013571428571428572 * var_x256 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 2.1714285714285715e-5 * var_x257 * var_x262 + 6.9668928571428572e-6 * pow(var_x254, 2) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f / pow(var_x255, 2) + 1.4566594285714287e-7 * var_x257 * var_x259 * var_x261 / pow(var_x260, 2);
        IJth(rJacobian, 30, 0) = var_x270 + var_x267 * (var_x265 - var_chaste_interface__slow_transient_outward_potassium_current__ato_s);
        IJth(rJacobian, 31, 0) = -var_x275 * var_x277 + 0.00016708437761069341 * var_x276 * (var_x278 - var_chaste_interface__slow_transient_outward_potassium_current__ito_s) / pow((0.25714285714285712 + var_x274), 2);
        ...
        IJth(rJacobian, 33, 0) = var_x270 + var_x267 * (var_x265 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur);
        ...
        IJth(rJacobian, 2, 2) = var_x68 * (-2175.0841750841751 + (-var_x70 - var_x71) * var_chaste_interface__calcium_fluxes__P_RyR) + 0.16806722689075632 * pow(var_x66, (-3.0)) * pow((0.084033613445378158 + var_x67), (-2.0)) * (363.63636363636363 * var_x73 + 2175.0841750841751 * var_chaste_interface__calcium_concentration__Cai - 2175.0841750841751 * var_chaste_interface__calcium_concentration__Cass - var_x69 * (-63.0 + var_chaste_interface__membrane__V));
        ...
        IJth(rJacobian, 15, 2) = var_x124 + var_x163 - var_x127 - var_x164;
        IJth(rJacobian, 16, 2) = var_x176 - var_x175;
        IJth(rJacobian, 17, 2) = var_x161 + var_x175 - var_x162 - var_x176;
        IJth(rJacobian, 2, 3) = var_x74 * (var_x70 + var_x71);
        IJth(rJacobian, 3, 3) = var_x81 * (-0.050000000000000003 + (-var_x77 - var_x78) * var_chaste_interface__calcium_fluxes__P_RyR) + 0.00013333333333333334 * pow(var_x79, (-3.0)) * pow((0.053333333333333337 + var_x80), (-2.0)) * (0.050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 4.5 * var_x73 - 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR);
        ...
        IJth(rJacobian, 11, 11) = -0.013000000000000001 + var_x128 + var_x131 - var_x129;
        IJth(rJacobian, 12, 11) = var_x139;
        IJth(rJacobian, 14, 11) = var_x129;
        IJth(rJacobian, 15, 11) = var_x130;
        IJth(rJacobian, 16, 11) = var_x177;
        IJth(rJacobian, 12, 12) = -0.050000000000000003 * var_x92 - 4.4000000000000004 * var_x110;
        IJth(rJacobian, 13, 12) = 1.2000000000000002 * var_x110;
        IJth(rJacobian, 12, 13) = var_x139 + var_x140;
        IJth(rJacobian, 13, 13) = -var_x140 - var_x145;
        IJth(rJacobian, 14, 13) = var_x145;
        IJth(rJacobian, 11, 14) = var_x132;
        IJth(rJacobian, 12, 14) = var_x139;
        IJth(rJacobian, 13, 14) = var_x146;
        IJth(rJacobian, 14, 14) = -0.026000000000000002 + var_x165 - var_x132 - var_x146 - var_x166 - var_x167;
        ...
        IJth(rJacobian, 12, 15) = var_x139;
        IJth(rJacobian, 14, 15) = 1.0000000000000002e-6 * var_x92;
        IJth(rJacobian, 15, 15) = -0.0135 + var_x128 + var_x171;
        IJth(rJacobian, 17, 15) = var_x177;
        IJth(rJacobian, 11, 16) = var_x133;
        IJth(rJacobian, 12, 16) = var_x139;
        IJth(rJacobian, 14, 16) = var_x168;
        IJth(rJacobian, 16, 16) = var_x131 + var_x178 - var_x168;
        IJth(rJacobian, 17, 16) = var_x130;
        IJth(rJacobian, 12, 17) = var_x139;
        IJth(rJacobian, 14, 17) = var_x169;
        IJth(rJacobian, 15, 17) = var_x133;
        IJth(rJacobian, 16, 17) = 0.00050000000000000001;
        IJth(rJacobian, 17, 17) = -0.00050000000000000001 + var_x178 - var_x169;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-9385.5048737823836 * var_x42 - 1.4564116150719216e-13 * var_x43 - 3.3946082173859908e-7 * var_x46 - 337.46387724285864 * var_x44 - 46927524.368911915 * var_x45);
        IJth(rJacobian, 1, 18) = 8.9596216554657907e-15 * var_x43 * var_x61;
        IJth(rJacobian, 18, 18) = -6.2649332746797074e-8 * var_x46 - 577.38191486798701 * var_x42 - 2886909.5743399351 * var_x45 - 2.6878864966397375e-14 * var_x43;
        IJth(rJacobian, 27, 18) = 4.1766221831198049e-8 * var_x46 - 20.760261942385394 * var_x44;
        ...
        IJth(rJacobian, 22, 22) = var_x240 - var_x241;
        IJth(rJacobian, 23, 22) = var_x241;
        ...
        IJth(rJacobian, 24, 24) = var_x220 + var_x240 - var_x208 - var_x243;
        ...
        IJth(rJacobian, 25, 25) = var_x234 + var_x240;
        IJth(rJacobian, 26, 25) = var_x221 + var_x233;
        IJth(rJacobian, 21, 26) = var_x232;
        IJth(rJacobian, 25, 26) = var_x231;
        IJth(rJacobian, 26, 26) = var_x235 + var_x240;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (0.65056346575383339 * var_x53 - 10.441746449740933 * var_x50 - 4.1078913989637309 * var_x51 - 0.14762734715025908 * var_x48 - 1.2837160621761659 * var_x52 - 5214169.3743235469 * var_x45 - 7.2607529660026051 * var_x49 - 16535.729984900074 * var_x44 - 1042.8338748647093 * var_x42);
        IJth(rJacobian, 18, 27) = -320767.730482215 * var_x45 - 64.153546096442994 * var_x42;
        IJth(rJacobian, 27, 27) = 0.040021670080783313 * var_x53 - 0.0090818087605069632 * var_x48 - 0.25271120029236765 * var_x51 - 0.078972250091364896 * var_x52 - 0.64236028224316211 * var_x50 - 1017.2528351768842 * var_x44 - 0.44667042500874238 * var_x49;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-1.2201 * var_x54);
        IJth(rJacobian, 27, 28) = -0.075058687178170977 * var_x54;
        IJth(rJacobian, 28, 28) = -0.18064 * var_x251 - 0.39560000000000001 * var_x252;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x9);
        IJth(rJacobian, 27, 29) = -var_x17 * var_x248;
        ...
        IJth(rJacobian, 27, 33) = var_x249 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur;
        ...
        IJth(rJacobian, 27, 34) = var_x249 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur;
        ...
        IJth(rJacobian, 27, 35) = var_x250 * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss;
        ...
        IJth(rJacobian, 27, 36) = var_x250 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss;
