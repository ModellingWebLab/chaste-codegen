...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x10 = exp(0.018716945411372737 * var_chaste_interface__membrane_potential__V);
        const double var_x11 = var_x10 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        const double var_x12 = exp(-0.018716945411372737 * var_chaste_interface__membrane_potential__V);
        const double var_x13 = var_x12 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x14 = var_x9 * (0.037433890822745473 * var_x11 + 51359.298208806787 * var_x13);
        const double var_x15 = -0.037433890822745473 * var_chaste_interface__membrane_potential__V;
        const double var_x16 = exp(var_x15);
        const double var_x17 = var_x16 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x;
        const double var_x18 = var_x3 * (-26.713760659695652 * var_x2 + var_chaste_interface__membrane_potential__V) / pow(var_x4, 2);
        const double var_x19 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x20 = exp(3.7433890822745473 - var_x0);
        const double var_x21 = 1.0 - var_x20;
        const double var_x22 = 1 / var_x21;
        const double var_x23 = exp(3.7433890822745473);
        const double var_x24 = -2.0 * var_x20 + var_x23 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x25 = var_x22 * var_x24;
        const double var_x26 = 0.39404095602889971 * var_x25;
        const double var_x27 = exp(1.8716945411372736 + var_x15);
        ...
        const double var_x32 = -140.0 * var_x27 + var_x31 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x33 = 0.00098510239007224931 * var_x32;
        const double var_x34 = 1 / (21.699999999999999 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x35 = exp(-0.0037433890822745476 * var_chaste_interface__membrane_potential__V);
        const double var_x36 = 1.0 + 0.035299999999999998 * var_x16 + 0.1245 * var_x35;
        const double var_x37 = var_x34 * (0.00046605194074318115 * var_x35 + 0.0013214163460429152 * var_x16) * var_chaste_interface__intracellular_sodium_concentration__Na_i / pow(var_x36, 2);
        const double var_x38 = -4.0 * var_x27 + var_x31 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x39 = 0.00019702047801444986 * var_x38;
        const double var_x40 = -50.0 + var_chaste_interface__membrane_potential__V;
        const double var_x41 = var_x19 * var_x40;
        const double var_x42 = var_x22 * var_x41;
        const double var_x43 = var_x20 * var_x42;
        const double var_x44 = var_x30 * var_x40;
        const double var_x45 = var_x27 * var_x44;
        const double var_x46 = var_x20 * var_x24 * var_x41 / pow(var_x21, 2);
        const double var_x47 = var_x27 * var_x41 / pow(var_x28, 2);
        const double var_x48 = var_x38 * var_x47;
        const double var_x49 = var_x32 * var_x47;
        const double var_x50 = 1 / var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x51 = (2.0 * var_x11 - 2744000.0 * var_x13) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x52 = var_x12 * var_x9;
        const double var_x53 = var_x23 * var_x42;
        const double var_x54 = 1.0 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x55 = -26.713760659695652 * log(140.47999999999999 / var_x54) + var_chaste_interface__membrane_potential__V;
        const double var_x56 = var_x55 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x57 = 1.4059874031418764 * var_x2 - 0.052631578947368418 * var_chaste_interface__membrane_potential__V;
        const double var_x58 = var_x40 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x59 = var_x29 * var_x58;
        const double var_x60 = var_x40 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x61 = var_x29 * var_x60;
        const double var_x62 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x63 = 1 / var_x36;
        const double var_x64 = var_x34 * var_x63;
        const double var_x65 = var_x63 * var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 0.046082949308755762 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x66 = var_x10 * var_x9 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x67 = var_x6 * (0.00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * var_chaste_interface__fast_sodium_current_h_gate__h / pow(var_x54, 2);
        const double var_x68 = var_x31 * var_x44;
        const double var_x69 = var_x1 * var_x5;
        const double var_x70 = var_x1 * var_x8;
        const double var_x71 = var_x1 * var_x18;
        const double var_x72 = 1.1825618784004641e-5 * var_x25;
        const double var_x73 = 10.0 * var_chaste_interface__calmodulin__Cmdn_Ca;
        const double var_x74 = 80.0 * var_chaste_interface__troponin__Trpn_Ca;
        const double var_x75 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 1.0);
        const double var_x76 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2.0);
        const double var_x77 = pow(var_chaste_interface__SR_calcium_concentration__Ca_SR, 2.0);
        ...
        const double var_x80 = 0.25 + var_chaste_interface__RyR__F_2;
        const double var_x81 = 1 / var_x80;
        const double var_x82 = pow((var_x81 * var_chaste_interface__RyR__F_2), 2.0);
        const double var_x83 = 0.20000000000000001 + var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x84 = var_x82 / var_x83;
        const double var_x85 = 0.10203913679590343 * var_x84;
        const double var_x86 = var_x85 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x87 = 1 / (1.0 + 17361111.111111112 * var_x76 + 0.37180249851279007 * var_x77);
        const double var_x88 = var_x75 * var_x87 * var_chaste_interface__CaMKII_factor__F_CaMK;
        const double var_x89 = var_x76 * var_x87;
        const double var_x90 = -var_chaste_interface__intracellular_calcium_concentration__Ca_i + var_chaste_interface__SR_calcium_concentration__Ca_SR;
        const double var_x91 = var_x82 * var_x90 * var_chaste_interface__RyR__F_SRCa_RyR / pow(var_x83, 2);
        const double var_x92 = var_x80 * var_x90 * (2.0 * var_x81 - 2.0 * var_chaste_interface__RyR__F_2 / pow(var_x80, 2)) / var_chaste_interface__RyR__F_2;
        const double var_x93 = 10.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x94 = 80.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x95 = 0.080480480480480482 * var_chaste_interface__Force__N_0;
        const double var_x96 = 0.080480480480480482 * var_chaste_interface__Force__P_0;
        const double var_x97 = 0.080480480480480482 * var_chaste_interface__Force__P_2;
        const double var_x98 = 0.16096096096096096 * var_chaste_interface__Force__P_3;
        const double var_x99 = pow(var_chaste_interface__SR_calcium_concentration__Ca_SR, 1.0);
        const double var_x100 = var_x87 * var_x99;
        const double var_x101 = var_x78 * var_x99;
        const double var_x102 = 0.080480480480480482 * var_chaste_interface__troponin__Trpn_Ca;
        const double var_x103 = -var_x102;
        const double var_x104 = 0.16096096096096096 * var_chaste_interface__troponin__Trpn_Ca;
        const double var_x105 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane_potential__V);
        const double var_x106 = 0.44800000000000001 * var_x105 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x107 = 41.0 + var_chaste_interface__membrane_potential__V;
        const double var_x108 = fabs(var_x107) < 1.0000000000000001e-5;
        const double var_x109 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x113 = 0.20000000000000001 / var_x112;
        const double var_x114 = -8.0 * var_x105;
        ...
        const double var_x137 = 19.0 + var_chaste_interface__membrane_potential__V;
        const double var_x138 = fabs(var_x137) < 1.0000000000000001e-5;
        const double var_x139 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane_potential__V);
        const double var_x140 = 1.0 - var_x139;
        const double var_x141 = 0.036000000000000004 / var_x140;
        const double var_x142 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x143 = 0.25 * var_chaste_interface__membrane_potential__V;
        const double var_x144 = -var_x143;
        const double var_x145 = exp(-4.75 + var_x144);
        const double var_x146 = 1.0 - var_x145;
        const double var_x147 = 0.089999999999999997 / var_x146;
        const double var_x148 = exp(-8.5 + var_x144);
        const double var_x149 = 1.0 + var_x148;
        const double var_x150 = -0.0062500000000000003 * var_x148 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x149, 2);
        const double var_x151 = 34.0 + var_chaste_interface__membrane_potential__V;
        const double var_x152 = fabs(var_x151) < 1.0000000000000001e-5;
        const double var_x153 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x154 = exp(8.5 + var_x143);
        const double var_x155 = -1.0 + var_x154;
        const double var_x156 = 0.0031250000000000002 / var_x155;
        const double var_x157 = -0.025000000000000001 / var_x149;
        const double var_x158 = 4.5856516257863203e-6 * var_x38;
        const double var_x159 = var_x158 * var_x30;
        const double var_x160 = 0.0091713032515726416 * var_x25;
        const double var_x161 = var_x160 * var_x19;
        const double var_x162 = 2.2928258128931605e-5 * var_x32;
        const double var_x163 = var_x162 * var_x30;
        const double var_x164 = 0.0013732702584866433 * var_x43;
        const double var_x165 = 0.00012084778274682461 * var_x45;
        const double var_x166 = 0.00068663512924332167 * var_x46;
        const double var_x167 = 1.7165878231083041e-7 * var_x48;
        const double var_x168 = 8.5829391155415208e-7 * var_x49;
        const double var_x169 = 61250.0 * var_x75;
        const double var_x170 = 0.0091713032515726416 * var_x53;
        const double var_x171 = var_x158 * var_x59;
        const double var_x172 = var_x160 * var_x58;
        const double var_x173 = var_x162 * var_x59;
        const double var_x174 = var_x158 * var_x61;
        const double var_x175 = var_x160 * var_x60;
        const double var_x176 = var_x162 * var_x61;
        const double var_x177 = 4.5454545454545459 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x178 = pow(var_chaste_interface__CaMKII_factor__F_CaMK, 2.0);
        const double var_x179 = pow(var_x177, (2.0408163265306123 * var_x178));
        const double var_x180 = var_x179 * (1.0 - var_chaste_interface__RyR__F_1 - var_chaste_interface__RyR__F_2);
        const double var_x181 = 30625.0 * var_x76;
        const double var_x182 = -0.001885 * var_x179;
        const double var_x183 = var_x159 * var_x40;
        const double var_x184 = var_x161 * var_x40;
        const double var_x185 = var_x163 * var_x40;
        const double var_x186 = var_x68 * var_chaste_interface__RyR__F_1;
        const double var_x187 = 2.2928258128931605e-5 * var_x186;
        const double var_x188 = 4.5856516257863203e-6 * var_x186;
        const double var_x189 = 1.0 + 0.35999999999999999 / var_chaste_interface__SR_calcium_concentration__Ca_SR;
        const double var_x190 = 0.5 * var_x84;
        const double var_x191 = var_x190 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x192 = 0.0015795337492435055 * var_x6;
        const double var_x193 = 5.9128093920023211e-8 * var_x32;
        const double var_x194 = 1.1825618784004642e-8 * var_x38;
        const double var_x195 = 8.4390573062405468e-5 * var_x2 - 3.1590674984870109e-6 * var_chaste_interface__membrane_potential__V;
        const double var_x196 = 64354088.928906187 * pow(var_chaste_interface__troponin__Trpn_Ca, 4.1071428571428568);
        const double var_x197 = var_x196 * var_chaste_interface__Force__N_0;
        const double var_x198 = 12600800.629436176 * pow(var_chaste_interface__troponin__Trpn_Ca, 5.1071428571428568);
        const double var_x199 = -var_x198;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.01526315789473684 + 0.029500972255352163 * var_x46 + 7.3752430638380402e-6 * var_x48 + 3.6876215319190203e-5 * var_x49 + 0.22516626058794267 * var_x18 - 0.059001944510704327 * var_x43 - 11.452631578947368 * var_x37 - 0.052631578947368418 * var_x8 - 0.0051921711169419802 * var_x45 - 0.005263157894736842 * var_x14 - 0.011258313029397135 * var_x17 - 3.007518796992481 * var_x5 - var_x19 * var_x26 - var_x30 * var_x33 - var_x30 * var_x39 - var_x7 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 1, 0) = -7.8976687462175278e-8 + 3.1590674984870111e-7 * var_x14 + 8.853578449436757e-7 * var_x46 - 1.7707156898873514e-6 * var_x43 - var_x19 * var_x72;
        IJth(rJacobian, 2, 0) = ((var_x108) ? (var_x106) : (var_x106 + var_x109 * var_x113 - 0.02 * var_x107 * var_x109 * var_x111 / pow(var_x112, 2)));
        ...
        IJth(rJacobian, 7, 0) = ((var_x138) ? (0) : (var_x141 * var_chaste_interface__L_type_Ca_channel_d_gate__d + var_x142 * var_x147 + 0.0035999999999999999 * var_x137 * var_x139 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x140, 2) - 0.022499999999999999 * var_x137 * var_x142 * var_x145 / pow(var_x146, 2)));
        IJth(rJacobian, 8, 0) = ((var_x152) ? (var_x150) : (var_x150 + var_x153 * var_x156 - 0.00078125000000000004 * var_x151 * var_x153 * var_x154 / pow(var_x155, 2)));
        IJth(rJacobian, 11, 0) = (var_x159 + var_x161 + var_x163 + var_x164 + var_x165 - var_x166 - var_x167 - var_x168) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 12, 0) = (var_x166 + var_x167 + var_x168 - var_x159 - var_x161 - var_x163 - var_x164 - var_x165) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 16, 0) = -3.7908809981844132e-7 + 2.2133946123591894e-9 * var_x49 - 3.0987524573028653e-7 * var_x45 - 0.0020622392630123211 * var_x37 - 9.4772024954610334e-7 * var_x14 - var_x192 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x193 * var_x30;
        IJth(rJacobian, 17, 0) = -3.7908809981844132e-7 + 1.3514992896005306e-5 * var_x18 + 0.0013748261753415473 * var_x37 + 4.4267892247183788e-10 * var_x48 - 0.00018051814277068634 * var_x5 - 3.1590674984870109e-6 * var_x8 - 6.7574964480026522e-7 * var_x17 - 1.7707156898873515e-9 * var_x45 - var_x194 * var_x30;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (3.6315789473684208e-5 * var_x51 + 14442.105263157893 * var_x52 - 0.39404095602889971 * var_x53 - 0.035149685078546905 * var_x50);
        IJth(rJacobian, 1, 1) = -5.8000000000000007 + var_x73 + var_x74 - var_x86 + 1.1520000000000001e-10 * var_x79 - 1.0548821632800683e-6 * var_x50 - 2.1797565739560378e-9 * var_x51 - 10138.888888888889 * var_x88 - 1.1825618784004641e-5 * var_x53 - 0.86684812158483582 * var_x52;
        IJth(rJacobian, 11, 1) = (var_x170 - var_x169) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 12, 1) = (var_x169 - var_x170) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 13, 1) = 0.20000000000000001 - var_x73;
        IJth(rJacobian, 14, 1) = 5.6000000000000005 - var_x74;
        IJth(rJacobian, 15, 1) = var_x191 + 49681.373281158201 * var_x88 - 5.6448929115512146e-10 * var_x79;
        IJth(rJacobian, 16, 1) = 2.6005443647545077 * var_x52 + 6.5392697218681124e-9 * var_x51;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-78.94736842105263 * var_x56);
        IJth(rJacobian, 2, 2) = ((var_x108) ? (-2.0 + var_x114) : (var_x114 - var_x107 * var_x113));
        IJth(rJacobian, 16, 2) = -0.0047386012477305169 * var_x56;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * var_x7);
        IJth(rJacobian, 3, 3) = -var_x123 - 2.0 * var_x118;
        IJth(rJacobian, 16, 3) = -var_x192 * var_x55;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (0.3007518796992481 * var_x16 - 0.075187969924812026 * var_chaste_interface__intracellular_potassium_concentration__K_i);
        IJth(rJacobian, 4, 4) = -0.00050000000000000001 * var_x132 - 0.0013000000000000002 * var_x127;
        IJth(rJacobian, 17, 4) = 1.8051814277068635e-5 * var_x16 - 4.5129535692671587e-6 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x57 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 5, 5) = -0.033000000000000002 / var_x135 - 3.3000000000000003e-5 * var_x133;
        IJth(rJacobian, 17, 5) = var_x195 * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x57 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 6, 6) = -0.33300000000000002;
        IJth(rJacobian, 17, 6) = var_x195 * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x26 * var_x58 - var_x33 * var_x59 - var_x39 * var_x59);
        IJth(rJacobian, 1, 7) = -var_x58 * var_x72;
        IJth(rJacobian, 7, 7) = ((var_x138) ? (-0.71999999999999997) : (var_x137 * var_x141 - var_x137 * var_x147));
        IJth(rJacobian, 11, 7) = (var_x171 + var_x172 + var_x173) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 12, 7) = (-var_x171 - var_x172 - var_x173) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 16, 7) = -var_x193 * var_x59;
        IJth(rJacobian, 17, 7) = -var_x194 * var_x59;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x26 * var_x60 - var_x33 * var_x61 - var_x39 * var_x61);
        IJth(rJacobian, 1, 8) = -var_x60 * var_x72;
        IJth(rJacobian, 8, 8) = ((var_x152) ? (-0.012500000000000001 + var_x157) : (var_x157 - var_x151 * var_x156));
        IJth(rJacobian, 11, 8) = (var_x174 + var_x175 + var_x176) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 12, 8) = (-var_x174 - var_x175 - var_x176) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 16, 8) = -var_x193 * var_x61;
        IJth(rJacobian, 17, 8) = -var_x194 * var_x61;
        IJth(rJacobian, 1, 9) = -5069.4444444444443 * var_x89;
        IJth(rJacobian, 9, 9) = -0.00125;
        IJth(rJacobian, 11, 9) = 0.007693877551020409 * var_x180 * pow(var_chaste_interface__CaMKII_factor__F_CaMK, 1.0) * log(var_x177);
        IJth(rJacobian, 15, 9) = 24840.686640579101 * var_x89;
        IJth(rJacobian, 1, 10) = -0.10203913679590343 * var_x91 + var_x85 * var_x90;
        IJth(rJacobian, 10, 10) = -0.02;
        IJth(rJacobian, 11, 10) = 0.0038469387755102045 * var_x178 * var_x180 / var_chaste_interface__RyR__F_SRCa_RyR;
        IJth(rJacobian, 15, 10) = 0.5 * var_x91 - var_x190 * var_x90;
        IJth(rJacobian, 11, 11) = -0.0018000000000000002 + var_x182 + var_x183 + var_x184 + var_x185 - var_x181;
        IJth(rJacobian, 12, 11) = var_x181 - var_x183 - var_x184 - var_x185;
        IJth(rJacobian, 1, 12) = var_x86 * var_x92;
        IJth(rJacobian, 11, 12) = var_x182;
        IJth(rJacobian, 12, 12) = -0.45000000000000001 / var_x189;
        IJth(rJacobian, 15, 12) = -var_x191 * var_x92;
        IJth(rJacobian, 1, 13) = 0.5 + var_x93;
        IJth(rJacobian, 9, 13) = 25.0;
        IJth(rJacobian, 13, 13) = -0.5 - var_x93;
        IJth(rJacobian, 1, 14) = 0.11951951951951952 + var_x94 + var_x95 + var_x96 - var_x97 - var_x98;
        IJth(rJacobian, 14, 14) = -0.11951951951951952 + var_x97 + var_x98 - var_x94 - var_x95 - var_x96;
        IJth(rJacobian, 18, 14) = -var_x197;
        IJth(rJacobian, 19, 14) = var_x197;
        IJth(rJacobian, 20, 14) = var_x196 * (1.0 - var_chaste_interface__Force__N_0 - var_chaste_interface__Force__P_0 - var_chaste_interface__Force__P_1 - var_chaste_interface__Force__P_2 - var_chaste_interface__Force__P_3);
        IJth(rJacobian, 1, 15) = var_x86 + 0.00029074955383700184 * var_x100 + 2.4671029149315891e-18 * var_x101;
        IJth(rJacobian, 10, 15) = 0.02;
        IJth(rJacobian, 12, 15) = -0.16200000000000001 * var_chaste_interface__RyR__F_2 / (pow(var_x189, 2) * pow(var_chaste_interface__SR_calcium_concentration__Ca_SR, 2));
        IJth(rJacobian, 15, 15) = -var_x191 - 0.001424696263447196 * var_x100 - 1.2089003260906828e-17 * var_x101;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (0.024321246106197562 * var_x65 - 0.031578947368421054 * var_x66 - 0.16871848837702516 * var_x62 - 98756.555196685396 * var_x67 - 0.00098510239007224931 * var_x68 - 11.452631578947368 * var_x64);
        IJth(rJacobian, 1, 16) = 1.8954404990922067e-6 * var_x66;
        IJth(rJacobian, 11, 16) = var_x187;
        IJth(rJacobian, 12, 16) = -var_x187;
        IJth(rJacobian, 16, 16) = 4.3794501115171722e-6 * var_x65 - 1.0126868767488654e-5 * var_x62 - 0.0020622392630123211 * var_x64 - 5.9275938519033602 * var_x67 - 5.6863214972766202e-6 * var_x66 - 5.9128093920023211e-8 * var_x68;
        IJth(rJacobian, 17, 16) = 0.0013748261753415473 * var_x64 - 2.9196334076781148e-6 * var_x65;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (6.0150375939849621 * var_x71 - 0.16871848837702516 * var_x1 - 0.075187969924812026 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x - 11850.786623602246 * var_x67 - 0.00019702047801444986 * var_x68 - 80.342137322392929 * var_x69 - 1.4059874031418764 * var_x70);
        IJth(rJacobian, 11, 17) = var_x188;
        IJth(rJacobian, 12, 17) = -var_x188;
        IJth(rJacobian, 16, 17) = -0.71131126222840313 * var_x67;
        IJth(rJacobian, 17, 17) = 0.00036103628554137274 * var_x71 - 8.4390573062405468e-5 * var_x70 - 1.0126868767488654e-5 * var_x1 - 0.0048223184607088842 * var_x69 - 1.1825618784004642e-8 * var_x68 - 4.5129535692671587e-6 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x;
        IJth(rJacobian, 1, 18) = var_x102;
        IJth(rJacobian, 14, 18) = var_x103;
        IJth(rJacobian, 18, 18) = -0.040714285714285717 + var_x199;
        IJth(rJacobian, 19, 18) = var_x198;
        IJth(rJacobian, 20, 18) = var_x199;
        IJth(rJacobian, 1, 19) = var_x102;
        IJth(rJacobian, 14, 19) = var_x103;
        IJth(rJacobian, 18, 19) = -0.00071428571428571494;
        IJth(rJacobian, 19, 19) = -0.070000000000000007;
        IJth(rJacobian, 20, 19) = 0.029999999999999999 + var_x199;
        IJth(rJacobian, 18, 20) = -0.040714285714285717;
        IJth(rJacobian, 19, 20) = 0.040714285714285717;
        IJth(rJacobian, 20, 20) = -0.18071428571428572 + var_x199;
        IJth(rJacobian, 21, 20) = 0.10000000000000001;
        IJth(rJacobian, 1, 21) = var_x103;
        IJth(rJacobian, 14, 21) = var_x102;
        IJth(rJacobian, 18, 21) = -0.040714285714285717;
        IJth(rJacobian, 20, 21) = 0.081428571428571433 + var_x199;
        IJth(rJacobian, 21, 21) = -0.15142857142857144;
        IJth(rJacobian, 22, 21) = 0.070000000000000007;
        IJth(rJacobian, 1, 22) = -var_x104;
        IJth(rJacobian, 14, 22) = var_x104;
        IJth(rJacobian, 18, 22) = -0.040714285714285717;
        IJth(rJacobian, 20, 22) = var_x199;
