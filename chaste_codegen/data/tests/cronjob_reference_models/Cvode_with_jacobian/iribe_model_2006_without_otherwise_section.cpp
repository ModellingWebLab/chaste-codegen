...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x122 = 20.0 * var_x119 + 2000.0 * var_x121;
        const double var_x123 = 1 / var_x122;
        const double var_x124 = 2.5 * var_x119;
        const double var_x125 = 0.625 * var_x120 / pow((0.0031250000000000002 + var_x120), 2);
        ...
        const double var_x131 = 1.0 - var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x;
        ...
        const double var_x139 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane_potential__V);
        ...
        const double var_x153 = -0.0062500000000000003 * var_x151 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x152, 2);
        ...
        const double var_x156 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        ...
        const double var_x161 = 4.5856516257863203e-6 * var_x26;
        const double var_x162 = var_x161 * var_x24;
        const double var_x163 = 0.0091713032515726399 * var_x39;
        const double var_x164 = var_x163 * var_x23;
        const double var_x165 = 2.2928258128931602e-5 * var_x32;
        const double var_x166 = var_x165 * var_x24;
        const double var_x167 = 0.0013732702584866431 * var_x46;
        const double var_x168 = 0.0001208477827468246 * var_x43;
        const double var_x169 = 0.00068663512924332156 * var_x49;
        const double var_x170 = 8.5829391155415197e-7 * var_x48;
        const double var_x171 = 1.7165878231083041e-7 * var_x50;
        const double var_x172 = 61250.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x173 = 0.0091713032515726399 * var_x54;
        const double var_x174 = var_x161 * var_x60;
        const double var_x175 = var_x163 * var_x59;
        const double var_x176 = var_x165 * var_x60;
        const double var_x177 = var_x161 * var_x62;
        const double var_x178 = var_x163 * var_x61;
        const double var_x179 = var_x165 * var_x62;
        ...
        const double var_x183 = var_x182 * (1.0 - var_chaste_interface__RyR__F_1 - var_chaste_interface__RyR__F_2);
        ...
        const double var_x189 = var_x69 * var_chaste_interface__RyR__F_1;
        const double var_x190 = 2.2928258128931602e-5 * var_x189;
        const double var_x191 = 4.5856516257863203e-6 * var_x189;
        ...
        const double var_x195 = 1.0 * var_x85;
        const double var_x196 = 0.0015795337492435055 * var_x17;
        const double var_x197 = 5.9128093920023211e-8 * var_x32;
        const double var_x198 = 1.1825618784004642e-8 * var_x26;
        const double var_x199 = 8.4390573062405468e-5 * var_x2 - 3.1590674984870109e-6 * var_chaste_interface__membrane_potential__V;
        const double var_x200 = 64354088.928906165 * pow(var_chaste_interface__troponin__Trpn_Ca, 4.1071428571428568);
        const double var_x201 = var_x200 * var_chaste_interface__Force__N_0;
        ...
        IJth(rJacobian, 2, 0) = ((var_x111) ? (var_x109) : (var_x109 + var_x112 * var_x116 - 0.02 * var_x110 * var_x112 * var_x114 / pow(var_x115, 2)));
        IJth(rJacobian, 3, 0) = var_x122 * (-0.0025000000000000001 * var_x119 * var_x123 + 5.0000000000000001e-9 * var_x119 * (var_x124 - var_x125) / pow((var_x121 + 0.01 * var_x119), 2)) + (var_x125 - var_x124) * (-0.001 * var_chaste_interface__fast_sodium_current_h_gate__h + var_x123 * var_x126);
        IJth(rJacobian, 4, 0) = 7.7999999999999999e-5 * var_x130 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x + 4.1300000000000001e-5 * var_x131 * var_x135 - 5.2000000000000004e-5 * var_x127 * var_x129 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x / pow(var_x128, 2) - 2.8500000000000002e-5 * var_x131 * var_x132 * var_x134 / pow(var_x133, 2);
        IJth(rJacobian, 5, 0) = -0.058823529411764705 * var_x136 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x137 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x138, 2);
        IJth(rJacobian, 6, 0) = 0.066600000000000006 * var_x139 / pow((1.0 + var_x139), 2);
        IJth(rJacobian, 7, 0) = ((var_x141) ? (0) : (var_x144 * var_chaste_interface__L_type_Ca_channel_d_gate__d + var_x145 * var_x150 + 0.0035999999999999999 * var_x140 * var_x142 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x143, 2) - 0.022499999999999999 * var_x140 * var_x145 * var_x148 / pow(var_x149, 2)));
        IJth(rJacobian, 8, 0) = ((var_x155) ? (var_x153) : (var_x153 + var_x156 * var_x159 - 0.00078125000000000004 * var_x154 * var_x156 * var_x157 / pow(var_x158, 2)));
        IJth(rJacobian, 11, 0) = (var_x162 + var_x164 + var_x166 + var_x167 + var_x168 - var_x169 - var_x170 - var_x171) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 12, 0) = (var_x169 + var_x170 + var_x171 - var_x162 - var_x164 - var_x166 - var_x167 - var_x168) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 16, 0) = -3.7908809981844127e-7 + 2.213394612359189e-9 * var_x48 - 3.0987524573028648e-7 * var_x43 - 0.0020622392630123211 * var_x31 - 9.4772024954610334e-7 * var_x12 - var_x196 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x197 * var_x24;
        IJth(rJacobian, 17, 0) = -3.7908809981844127e-7 + 4.4267892247183783e-10 * var_x50 + 0.0013748261753415473 * var_x31 + 1.3514992896005304e-5 * var_x19 - 6.7574964480026522e-7 * var_x15 - 3.1590674984870109e-6 * var_x16 - 1.7707156898873513e-9 * var_x43 - 0.00018051814277068634 * var_x5 - var_x198 * var_x24;
        ...
        IJth(rJacobian, 11, 1) = (var_x173 - var_x172) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 12, 1) = (var_x172 - var_x173) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 13, 1) = 0.20000000000000001 - var_x74;
        IJth(rJacobian, 14, 1) = 5.6000000000000005 - var_x75;
        IJth(rJacobian, 15, 1) = var_x194 + 49681.373281158201 * var_x81 - 5.6448929115512146e-10 * var_x79;
        ...
        IJth(rJacobian, 2, 2) = ((var_x111) ? (-2.0 + var_x117) : (var_x117 - var_x110 * var_x116));
        IJth(rJacobian, 16, 2) = -0.0047386012477305169 * var_x57;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x18 * var_x56);
        IJth(rJacobian, 3, 3) = -var_x126 - 2.0 * var_x121;
        IJth(rJacobian, 16, 3) = -var_x196 * var_x56;
        ...
        IJth(rJacobian, 4, 4) = -0.00050000000000000001 * var_x135 - 0.0013000000000000002 * var_x130;
        ...
        IJth(rJacobian, 5, 5) = -0.033000000000000002 / var_x138 - 3.3000000000000003e-5 * var_x136;
        IJth(rJacobian, 17, 5) = var_x199 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        IJth(rJacobian, 17, 6) = var_x199 * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        IJth(rJacobian, 7, 7) = ((var_x141) ? (-0.71999999999999997) : (var_x140 * var_x144 - var_x140 * var_x150));
        IJth(rJacobian, 11, 7) = (var_x174 + var_x175 + var_x176) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 12, 7) = (-var_x174 - var_x175 - var_x176) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 16, 7) = -var_x197 * var_x60;
        IJth(rJacobian, 17, 7) = -var_x198 * var_x60;
        ...
        IJth(rJacobian, 8, 8) = ((var_x155) ? (-0.012500000000000001 + var_x160) : (var_x160 - var_x154 * var_x159));
        IJth(rJacobian, 11, 8) = (var_x177 + var_x178 + var_x179) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 12, 8) = (-var_x177 - var_x178 - var_x179) * var_chaste_interface__RyR__F_1;
        IJth(rJacobian, 16, 8) = -var_x197 * var_x62;
        IJth(rJacobian, 17, 8) = -var_x198 * var_x62;
        IJth(rJacobian, 1, 9) = -5069.4444444444443 * var_x90;
        IJth(rJacobian, 9, 9) = -0.00125;
        IJth(rJacobian, 11, 9) = 0.007693877551020409 * var_x183 * var_chaste_interface__CaMKII_factor__F_CaMK * log(var_x180);
        ...
        IJth(rJacobian, 11, 10) = 0.0038469387755102045 * var_x181 * var_x183 / var_chaste_interface__RyR__F_SRCa_RyR;
        IJth(rJacobian, 15, 10) = 0.5 * var_x93 - var_x193 * var_x91;
        IJth(rJacobian, 11, 11) = -0.0018000000000000002 + var_x185 + var_x186 + var_x187 + var_x188 - var_x184;
        IJth(rJacobian, 12, 11) = var_x184 - var_x186 - var_x187 - var_x188;
        IJth(rJacobian, 1, 12) = var_x94 * var_x95 - var_x94 * var_x96;
        IJth(rJacobian, 11, 12) = var_x185;
        IJth(rJacobian, 12, 12) = -0.45000000000000001 / var_x192;
        IJth(rJacobian, 15, 12) = var_x195 * var_x96 - var_x195 * var_x95;
        ...
        IJth(rJacobian, 18, 14) = -var_x201;
        IJth(rJacobian, 19, 14) = var_x201;
        IJth(rJacobian, 20, 14) = var_x200 * (1.0 - var_chaste_interface__Force__N_0 - var_chaste_interface__Force__P_0 - var_chaste_interface__Force__P_1 - var_chaste_interface__Force__P_2 - var_chaste_interface__Force__P_3);
        IJth(rJacobian, 1, 15) = var_x89 + 0.00029074955383700184 * var_x103 + 2.4671029149315891e-18 * var_x104;
        IJth(rJacobian, 10, 15) = 0.02;
        IJth(rJacobian, 12, 15) = -0.16200000000000001 * var_chaste_interface__RyR__F_2 / (pow(var_x192, 2) * var_x77);
        IJth(rJacobian, 15, 15) = -var_x194 - 0.001424696263447196 * var_x103 - 1.2089003260906828e-17 * var_x104;
        ...
        IJth(rJacobian, 11, 17) = var_x191;
        IJth(rJacobian, 12, 17) = -var_x191;
        ...
        IJth(rJacobian, 18, 18) = -0.040714285714285717 + var_x203;
        IJth(rJacobian, 19, 18) = var_x202;
        IJth(rJacobian, 20, 18) = var_x203;
        ...
        IJth(rJacobian, 20, 19) = 0.029999999999999999 + var_x203;
        IJth(rJacobian, 18, 20) = -0.040714285714285717;
        IJth(rJacobian, 19, 20) = 0.040714285714285717;
        IJth(rJacobian, 20, 20) = -0.18071428571428572 + var_x203;
        ...
        IJth(rJacobian, 20, 21) = 0.081428571428571433 + var_x203;
