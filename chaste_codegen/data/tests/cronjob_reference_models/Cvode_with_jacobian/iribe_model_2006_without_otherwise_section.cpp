...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x6 = 0.052631578947368418 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x7 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x8 = 0.018716945411372737 * var_chaste_interface__membrane_potential__V;
        const double var_x9 = exp(var_x8);
        const double var_x10 = var_x9 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        const double var_x11 = exp(-var_x8);
        const double var_x12 = var_x11 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x13 = var_x7 * (0.037433890822745473 * var_x10 + 51359.298208806787 * var_x12);
        const double var_x14 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0);
        const double var_x15 = 26.315789473684209 * var_x14;
        const double var_x16 = -0.037433890822745473 * var_chaste_interface__membrane_potential__V;
        const double var_x17 = exp(var_x16);
        const double var_x18 = var_x17 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x;
        const double var_x19 = -26.713760659695652 * var_x2 + var_chaste_interface__membrane_potential__V;
        const double var_x20 = var_x19 * var_x3 / pow(var_x4, 2);
        const double var_x21 = exp(1.8716945411372736 + var_x16);
        const double var_x22 = 1.0 - var_x21;
        const double var_x23 = 1 / var_x22;
        const double var_x24 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x25 = var_x23 * var_x24;
        const double var_x26 = exp(1.8716945411372736);
        const double var_x27 = -4.0 * var_x21 + var_x26 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x28 = 0.00019702047801444986 * var_x27;
        const double var_x29 = 1 / (21.699999999999999 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x30 = exp(-0.0037433890822745476 * var_chaste_interface__membrane_potential__V);
        const double var_x31 = 1.0 + 0.035299999999999998 * var_x17 + 0.1245 * var_x30;
        const double var_x32 = var_x29 * (0.0013214163460429152 * var_x17 + 0.00046605194074318115 * var_x30) * var_chaste_interface__intracellular_sodium_concentration__Na_i / pow(var_x31, 2);
        const double var_x33 = -140.0 * var_x21 + var_x26 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x34 = 0.00098510239007224931 * var_x33;
        ...
        const double var_x41 = 0.39404095602889971 * var_x40;
        const double var_x42 = -50.0 + var_chaste_interface__membrane_potential__V;
        const double var_x43 = var_x25 * var_x42;
        const double var_x44 = var_x21 * var_x43;
        const double var_x45 = var_x24 * var_x42;
        const double var_x46 = var_x37 * var_x45;
        const double var_x47 = var_x35 * var_x46;
        const double var_x48 = var_x21 * var_x45 / pow(var_x22, 2);
        const double var_x49 = var_x27 * var_x48;
        const double var_x50 = var_x33 * var_x48;
        const double var_x51 = var_x35 * var_x39 * var_x45 / pow(var_x36, 2);
        const double var_x52 = 1 / var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x53 = (2.0 * var_x10 - 2744000.0 * var_x12) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x54 = var_x11 * var_x7;
        const double var_x55 = var_x38 * var_x46;
        const double var_x56 = 1 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x57 = -26.713760659695652 * log(140.47999999999999 * var_x56) + var_chaste_interface__membrane_potential__V;
        const double var_x58 = var_x57 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x59 = var_x19 * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x60 = var_x42 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x61 = var_x23 * var_x60;
        const double var_x62 = var_x42 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x63 = var_x23 * var_x62;
        const double var_x64 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x65 = 1 / var_x31;
        const double var_x66 = var_x29 * var_x65;
        const double var_x67 = var_x65 * var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 0.046082949308755762 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x68 = var_x7 * var_x9 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x69 = var_x14 * var_x56 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x70 = var_x26 * var_x43;
        const double var_x71 = var_x1 * var_x5;
        const double var_x72 = var_x1 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s;
        const double var_x73 = var_x1 * var_x20;
        const double var_x74 = 1.1825618784004641e-5 * var_x40;
        const double var_x75 = 10.0 * var_chaste_interface__calmodulin__Cmdn_Ca;
        const double var_x76 = 80.0 * var_chaste_interface__troponin__Trpn_Ca;
        const double var_x77 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 1.0);
        const double var_x78 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2.0);
        const double var_x79 = pow(var_chaste_interface__SR_calcium_concentration__Ca_SR, 2.0);
        const double var_x80 = (-0.14537477691850093 * var_x79 + 5069444.444444444 * var_x78 * var_chaste_interface__CaMKII_factor__F_CaMK) / pow((5.76e-8 + var_x78 + 2.1415823914336707e-8 * var_x79), 2);
        ...
        const double var_x84 = pow((var_x83 * var_chaste_interface__RyR__F_2), 2.0);
        const double var_x85 = 0.20000000000000001 + var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x86 = var_x84 / var_x85;
        const double var_x87 = 0.10203913679590343 * var_x86;
        const double var_x88 = var_x87 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x89 = 1 / (1.0 + 17361111.111111112 * var_x78 + 0.37180249851279007 * var_x79);
        const double var_x90 = var_x77 * var_x89 * var_chaste_interface__CaMKII_factor__F_CaMK;
        const double var_x91 = var_x78 * var_x89;
        const double var_x92 = -var_chaste_interface__intracellular_calcium_concentration__Ca_i + var_chaste_interface__SR_calcium_concentration__Ca_SR;
        const double var_x93 = var_x92 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x94 = var_x84 * var_x93 / pow(var_x85, 2);
        const double var_x95 = var_x82 * var_x86 * var_x93 * (var_x83 - var_chaste_interface__RyR__F_2 / pow(var_x82, 2)) / var_chaste_interface__RyR__F_2;
        const double var_x96 = 10.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x97 = 80.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x98 = 0.080480480480480482 * var_chaste_interface__Force__N_0;
        const double var_x99 = 0.080480480480480482 * var_chaste_interface__Force__P_0;
        const double var_x100 = 0.080480480480480482 * var_chaste_interface__Force__P_2;
        const double var_x101 = 0.16096096096096096 * var_chaste_interface__Force__P_3;
        const double var_x102 = pow(var_chaste_interface__SR_calcium_concentration__Ca_SR, 1.0);
        const double var_x103 = var_x102 * var_x89;
        const double var_x104 = var_x102 * var_x80;
        ...
        const double var_x109 = 0.44800000000000001 * var_x108 * var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x112 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x113 = 0.10000000000000001 * var_chaste_interface__membrane_potential__V;
        const double var_x114 = -var_x113;
        const double var_x115 = exp(-4.1000000000000005 + var_x114);
        const double var_x116 = 1.0 - var_x115;
        const double var_x117 = 0.20000000000000001 / var_x116;
        const double var_x118 = -8.0 * var_x108;
        const double var_x119 = -0.125 * var_chaste_interface__membrane_potential__V;
        const double var_x120 = exp(-9.375 + var_x119);
        const double var_x121 = 20.0 * var_x120;
        const double var_x122 = exp(-7.5 + var_x114);
        const double var_x123 = 1 / (1.0 + 320.0 * var_x122);
        const double var_x124 = var_x121 + 2000.0 * var_x123;
        const double var_x125 = 1 / var_x124;
        const double var_x126 = 2.5 * var_x120;
        const double var_x127 = 0.625 * var_x122 / pow((0.0031250000000000002 + var_x122), 2);
        const double var_x128 = exp(-0.80000000000000004 - 0.040000000000000001 * var_chaste_interface__membrane_potential__V);
        const double var_x129 = 1.0 + var_x128;
        const double var_x130 = exp(-1.2 - 0.059999999999999998 * var_chaste_interface__membrane_potential__V);
        const double var_x131 = var_x130 / var_x129;
        const double var_x132 = 1.0 - var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x;
        const double var_x133 = exp(2.8500000000000001 + 0.057000000000000002 * var_chaste_interface__membrane_potential__V);
        const double var_x134 = 1.0 + var_x133;
        const double var_x135 = exp(4.1300000000000008 + 0.082600000000000007 * var_chaste_interface__membrane_potential__V);
        const double var_x136 = var_x135 / var_x134;
        const double var_x137 = exp(-0.058823529411764705 * var_chaste_interface__membrane_potential__V);
        const double var_x138 = exp(-1.25 + var_x119);
        const double var_x139 = 1.0 + var_x138;
        const double var_x140 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane_potential__V);
        const double var_x141 = 19.0 + var_chaste_interface__membrane_potential__V;
        const double var_x142 = fabs(var_x141) < 1.0000000000000001e-5;
        const double var_x143 = exp(1.8999999999999999 + var_x113);
        const double var_x144 = 1.0 - var_x143;
        const double var_x145 = 0.036000000000000004 / var_x144;
        const double var_x146 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x147 = 0.25 * var_chaste_interface__membrane_potential__V;
        const double var_x148 = -var_x147;
        const double var_x149 = exp(-4.75 + var_x148);
        const double var_x150 = 1.0 - var_x149;
        const double var_x151 = 0.089999999999999997 / var_x150;
        const double var_x152 = exp(-8.5 + var_x148);
        const double var_x153 = 1.0 + var_x152;
        const double var_x154 = -0.0062500000000000003 * var_x152 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x153, 2);
        const double var_x155 = 34.0 + var_chaste_interface__membrane_potential__V;
        const double var_x156 = fabs(var_x155) < 1.0000000000000001e-5;
        const double var_x157 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x158 = exp(8.5 + var_x147);
        const double var_x159 = -1.0 + var_x158;
        const double var_x160 = 0.0031250000000000002 / var_x159;
        const double var_x161 = -0.025000000000000001 / var_x153;
        const double var_x162 = 9.1713032515726418 * var_x40;
        const double var_x163 = 0.022928258128931601 * var_x33;
        const double var_x164 = 0.0045856516257863208 * var_x27;
        const double var_x165 = 0.001 * var_chaste_interface__RyR__F_1;
        const double var_x166 = var_x165 * (0.00085829391155415203 * var_x50 + 0.68663512924332171 * var_x51 + 0.00017165878231083042 * var_x49 - 0.1208477827468246 * var_x44 - 1.3732702584866434 * var_x47 - var_x162 * var_x24 - var_x163 * var_x25 - var_x164 * var_x25);
        const double var_x167 = var_x165 * (61250000.0 * var_x77 - 9.1713032515726418 * var_x55);
        const double var_x168 = var_x165 * (-var_x162 * var_x60 - var_x163 * var_x61 - var_x164 * var_x61);
        const double var_x169 = var_x165 * (-var_x162 * var_x62 - var_x163 * var_x63 - var_x164 * var_x63);
        const double var_x170 = 4.5454545454545459 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x171 = pow(var_chaste_interface__CaMKII_factor__F_CaMK, 2.0);
        const double var_x172 = pow(var_x170, (2.0408163265306123 * var_x171));
        const double var_x173 = var_x172 * (1.0 - var_chaste_interface__RyR__F_1 - var_chaste_interface__RyR__F_2);
        const double var_x174 = -0.001885 * var_x172;
        const double var_x175 = 30625.0 * var_x78;
        const double var_x176 = 4.5856516257863212e-6 * var_x27 * var_x43;
        const double var_x177 = 2.2928258128931602e-5 * var_x33 * var_x43;
        const double var_x178 = 0.0091713032515726416 * var_x40 * var_x45;
        const double var_x179 = var_x70 * var_chaste_interface__RyR__F_1;
        const double var_x180 = 2.2928258128931602e-5 * var_x179;
        const double var_x181 = 4.5856516257863212e-6 * var_x179;
        const double var_x182 = 1.0 + 0.35999999999999999 / var_chaste_interface__SR_calcium_concentration__Ca_SR;
        const double var_x183 = 0.5 * var_x86;
        const double var_x184 = var_x183 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x185 = 0.0015795337492435055 * var_x14;
        const double var_x186 = 5.9128093920023211e-8 * var_x33;
        const double var_x187 = 3.1590674984870109e-6 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x188 = 1.1825618784004642e-8 * var_x27;
        const double var_x189 = 64354088.92890618 * pow(var_chaste_interface__troponin__Trpn_Ca, 4.1071428571428568);
        const double var_x190 = var_x189 * var_chaste_interface__Force__N_0;
        const double var_x191 = 12600800.629436176 * pow(var_chaste_interface__troponin__Trpn_Ca, 5.1071428571428568);
        const double var_x192 = -var_x191;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.01526315789473684 + 7.375243063838041e-6 * var_x49 + 3.6876215319190203e-5 * var_x50 + 0.22516626058794267 * var_x20 + 0.029500972255352163 * var_x51 - 11.452631578947368 * var_x32 - 3.007518796992481 * var_x5 - 0.005263157894736842 * var_x13 - 0.005192171116941981 * var_x44 - 0.011258313029397135 * var_x18 - 0.059001944510704327 * var_x47 - var_x15 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x24 * var_x41 - var_x25 * var_x28 - var_x25 * var_x34 - var_x6 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 1, 0) = -7.8976687462175278e-8 + 3.1590674984870111e-7 * var_x13 + 8.8535784494367559e-7 * var_x51 - 1.7707156898873512e-6 * var_x47 - var_x24 * var_x74;
        IJth(rJacobian, 2, 0) = ((var_x111) ? (var_x109) : (var_x109 + var_x112 * var_x117 - 0.020000000000000004 * var_x110 * var_x112 * var_x115 / pow(var_x116, 2)));
        IJth(rJacobian, 3, 0) = 0.001 * var_x124 * (-var_x125 * var_x126 + 5.0000000000000004e-6 * var_x120 * (var_x126 - var_x127) / pow((var_x123 + 0.01 * var_x120), 2)) + 0.001 * (var_x127 - var_x126) * (-var_chaste_interface__fast_sodium_current_h_gate__h + var_x121 * var_x125);
        IJth(rJacobian, 4, 0) = 7.8000000000000012e-5 * var_x131 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x + 4.1300000000000001e-5 * var_x132 * var_x136 - 5.200000000000001e-5 * var_x128 * var_x130 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x / pow(var_x129, 2) - 2.8500000000000002e-5 * var_x132 * var_x133 * var_x135 / pow(var_x134, 2);
        IJth(rJacobian, 5, 0) = -1.9411764705882353e-6 * var_x137 * (1.0 - var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x138 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x139, 2);
        IJth(rJacobian, 6, 0) = 0.066600000000000006 * var_x140 / pow((1.0 + var_x140), 2);
        IJth(rJacobian, 7, 0) = ((var_x142) ? (0) : (var_x145 * var_chaste_interface__L_type_Ca_channel_d_gate__d + var_x146 * var_x151 + 0.0036000000000000008 * var_x141 * var_x143 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x144, 2) - 0.022499999999999999 * var_x141 * var_x146 * var_x149 / pow(var_x150, 2)));
        IJth(rJacobian, 8, 0) = ((var_x156) ? (var_x154) : (var_x154 + var_x157 * var_x160 - 0.00078125000000000004 * var_x155 * var_x157 * var_x158 / pow(var_x159, 2)));
        IJth(rJacobian, 11, 0) = -var_x166;
        IJth(rJacobian, 12, 0) = var_x166;
        IJth(rJacobian, 16, 0) = -3.7908809981844132e-7 + 2.2133946123591894e-9 * var_x50 - 0.0020622392630123211 * var_x32 - 9.4772024954610334e-7 * var_x13 - 3.0987524573028648e-7 * var_x44 - var_x185 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x186 * var_x25;
        IJth(rJacobian, 17, 0) = -3.7908809981844132e-7 + 0.0013748261753415473 * var_x32 + 1.3514992896005306e-5 * var_x20 + 4.4267892247183783e-10 * var_x49 - 0.00018051814277068634 * var_x5 - 6.7574964480026533e-7 * var_x18 - 1.7707156898873513e-9 * var_x44 - var_x187 * var_chaste_interface__transient_outward_current_s_gate__s - var_x188 * var_x25;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (3.6315789473684208e-5 * var_x53 + 14442.105263157895 * var_x54 - 0.035149685078546905 * var_x52 - 0.39404095602889971 * var_x55);
        IJth(rJacobian, 1, 1) = -5.8000000000000007 + var_x75 + var_x76 - var_x88 + 1.152e-10 * var_x81 - 1.0548821632800683e-6 * var_x52 - 1.1825618784004641e-5 * var_x55 - 0.86684812158483582 * var_x54 - 2.1797565739560378e-9 * var_x53 - 10138.888888888889 * var_x90;
        IJth(rJacobian, 11, 1) = -var_x167;
        IJth(rJacobian, 12, 1) = var_x167;
        IJth(rJacobian, 13, 1) = 0.20000000000000001 - var_x75;
        IJth(rJacobian, 14, 1) = 5.6000000000000005 - var_x76;
        IJth(rJacobian, 15, 1) = var_x184 + 49681.373281158209 * var_x90 - 5.6448929115512146e-10 * var_x81;
        IJth(rJacobian, 16, 1) = 6.5392697218681124e-9 * var_x53 + 2.6005443647545077 * var_x54;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-78.94736842105263 * var_x58);
        IJth(rJacobian, 2, 2) = ((var_x111) ? (-2.0 + var_x118) : (var_x118 - var_x110 * var_x117));
        IJth(rJacobian, 16, 2) = -0.0047386012477305169 * var_x58;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x15 * var_x57);
        IJth(rJacobian, 3, 3) = -0.02 * var_x120 - 2.0 * var_x123;
        IJth(rJacobian, 16, 3) = -var_x185 * var_x57;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (0.3007518796992481 * var_x17 - 0.075187969924812026 * var_chaste_interface__intracellular_potassium_concentration__K_i);
        IJth(rJacobian, 4, 4) = -0.00050000000000000001 * var_x136 - 0.0013000000000000002 * var_x131;
        IJth(rJacobian, 17, 4) = 1.8051814277068635e-5 * var_x17 - 4.5129535692671587e-6 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x19 * var_x6);
        IJth(rJacobian, 5, 5) = -0.033000000000000002 / var_x139 - 3.3000000000000003e-5 * var_x137;
        IJth(rJacobian, 17, 5) = -var_x187 * var_x19;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.052631578947368418 * var_x59);
        IJth(rJacobian, 6, 6) = -0.33300000000000002;
        IJth(rJacobian, 17, 6) = -3.1590674984870109e-6 * var_x59;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x28 * var_x61 - var_x34 * var_x61 - var_x41 * var_x60);
        IJth(rJacobian, 1, 7) = -var_x60 * var_x74;
        IJth(rJacobian, 7, 7) = ((var_x142) ? (-0.71999999999999997) : (var_x141 * var_x145 - var_x141 * var_x151));
        IJth(rJacobian, 11, 7) = -var_x168;
        IJth(rJacobian, 12, 7) = var_x168;
        IJth(rJacobian, 16, 7) = -var_x186 * var_x61;
        IJth(rJacobian, 17, 7) = -var_x188 * var_x61;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x28 * var_x63 - var_x34 * var_x63 - var_x41 * var_x62);
        IJth(rJacobian, 1, 8) = -var_x62 * var_x74;
        IJth(rJacobian, 8, 8) = ((var_x156) ? (-0.012500000000000001 + var_x161) : (var_x161 - var_x155 * var_x160));
        IJth(rJacobian, 11, 8) = -var_x169;
        IJth(rJacobian, 12, 8) = var_x169;
        IJth(rJacobian, 16, 8) = -var_x186 * var_x63;
        IJth(rJacobian, 17, 8) = -var_x188 * var_x63;
        IJth(rJacobian, 1, 9) = -5069.4444444444443 * var_x91;
        IJth(rJacobian, 9, 9) = -0.00125;
        IJth(rJacobian, 11, 9) = 0.0076938775510204081 * var_x173 * pow(var_chaste_interface__CaMKII_factor__F_CaMK, 1.0) * log(var_x170);
        IJth(rJacobian, 15, 9) = 24840.686640579104 * var_x91;
        IJth(rJacobian, 1, 10) = -0.10203913679590343 * var_x94 + var_x87 * var_x92;
        IJth(rJacobian, 10, 10) = -0.02;
        IJth(rJacobian, 11, 10) = 0.0038469387755102041 * var_x171 * var_x173 / var_chaste_interface__RyR__F_SRCa_RyR;
        IJth(rJacobian, 15, 10) = 0.5 * var_x94 - var_x183 * var_x92;
        IJth(rJacobian, 11, 11) = -0.0018000000000000002 + var_x174 + var_x176 + var_x177 + var_x178 - var_x175;
        IJth(rJacobian, 12, 11) = var_x175 - var_x176 - var_x177 - var_x178;
        IJth(rJacobian, 1, 12) = 0.20407827359180686 * var_x95;
        IJth(rJacobian, 11, 12) = var_x174;
        IJth(rJacobian, 12, 12) = -0.45000000000000001 / var_x182;
        IJth(rJacobian, 15, 12) = -1.0 * var_x95;
        IJth(rJacobian, 1, 13) = 0.5 + var_x96;
        IJth(rJacobian, 9, 13) = 25.0;
        IJth(rJacobian, 13, 13) = -0.5 - var_x96;
        IJth(rJacobian, 1, 14) = 0.11951951951951952 + var_x97 + var_x98 + var_x99 - var_x100 - var_x101;
        IJth(rJacobian, 14, 14) = -0.11951951951951952 + var_x100 + var_x101 - var_x97 - var_x98 - var_x99;
        IJth(rJacobian, 18, 14) = -var_x190;
        IJth(rJacobian, 19, 14) = var_x190;
        IJth(rJacobian, 20, 14) = var_x189 * (1.0 - var_chaste_interface__Force__N_0 - var_chaste_interface__Force__P_0 - var_chaste_interface__Force__P_1 - var_chaste_interface__Force__P_2 - var_chaste_interface__Force__P_3);
        IJth(rJacobian, 1, 15) = var_x88 + 0.00029074955383700184 * var_x103 + 2.4671029149315887e-18 * var_x104;
        IJth(rJacobian, 10, 15) = 0.02;
        IJth(rJacobian, 12, 15) = -0.16200000000000001 * var_chaste_interface__RyR__F_2 / (pow(var_x182, 2) * pow(var_chaste_interface__SR_calcium_concentration__Ca_SR, 2));
        IJth(rJacobian, 15, 15) = -var_x184 - 1.2089003260906826e-17 * var_x104 - 0.0014246962634471962 * var_x103;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (0.024321246106197559 * var_x67 - 11.452631578947368 * var_x66 - 0.00098510239007224931 * var_x70 - 0.16871848837702516 * var_x64 - 0.031578947368421054 * var_x68 - 702.99370157093813 * var_x69);
        IJth(rJacobian, 1, 16) = 1.8954404990922067e-6 * var_x68;
        IJth(rJacobian, 11, 16) = var_x180;
        IJth(rJacobian, 12, 16) = -var_x180;
        IJth(rJacobian, 16, 16) = 4.3794501115171722e-6 * var_x67 - 1.0126868767488654e-5 * var_x64 - 5.9128093920023211e-8 * var_x70 - 0.0020622392630123211 * var_x66 - 5.6863214972766202e-6 * var_x68 - 0.042195286531202733 * var_x69;
        IJth(rJacobian, 17, 16) = 0.0013748261753415473 * var_x66 - 2.9196334076781144e-6 * var_x67;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (6.0150375939849638 * var_x73 - 0.075187969924812026 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x - 0.00019702047801444986 * var_x70 - 0.16871848837702516 * var_x1 - 80.342137322392929 * var_x71 - 84.359244188512577 * var_x69 - 1.4059874031418764 * var_x72);
        IJth(rJacobian, 11, 17) = var_x181;
        IJth(rJacobian, 12, 17) = -var_x181;
        IJth(rJacobian, 16, 17) = -0.0050634343837443275 * var_x69;
        IJth(rJacobian, 17, 17) = 0.00036103628554137274 * var_x73 - 1.0126868767488654e-5 * var_x1 - 4.5129535692671587e-6 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x - 1.1825618784004642e-8 * var_x70 - 0.0048223184607088842 * var_x71 - 8.4390573062405468e-5 * var_x72;
        IJth(rJacobian, 1, 18) = var_x105;
        IJth(rJacobian, 14, 18) = var_x106;
        IJth(rJacobian, 18, 18) = -0.040714285714285717 + var_x192;
        IJth(rJacobian, 19, 18) = var_x191;
        IJth(rJacobian, 20, 18) = var_x192;
        ...
        IJth(rJacobian, 20, 19) = 0.029999999999999999 + var_x192;
        IJth(rJacobian, 18, 20) = -0.040714285714285717;
        IJth(rJacobian, 19, 20) = 0.040714285714285717;
        IJth(rJacobian, 20, 20) = -0.18071428571428572 + var_x192;
        ...
        IJth(rJacobian, 20, 21) = 0.081428571428571433 + var_x192;
