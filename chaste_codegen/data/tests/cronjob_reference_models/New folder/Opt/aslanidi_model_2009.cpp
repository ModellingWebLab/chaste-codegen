...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellaslanidi_model_2009FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_Na_Ca_ion_exchanger_current__i_NaCa = 2.0000000000000002e-5 * (2.5 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0) * exp(0.016955889611951679 * var_chaste_interface__membrane__V) - 2744000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i * exp(-0.020723865081274273 * var_chaste_interface__membrane__V)) / (1.0 + 0.00074999999999999991 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0) + 823.19999999999993 * var_chaste_interface__intracellular_ion_concentrations__Ca_i); // picoA
        ...
        const double var_background_currents__i_B_Ca = 2.0000000000000002e-5 * var_chaste_interface__membrane__V - 0.00026539450910485356 * log(2.5 / var_chaste_interface__intracellular_ion_concentrations__Ca_i); // picoA
        ...
        const double var_sodium_current__i_Na = 0.71257887225271721 * pow(var_chaste_interface__sodium_current_m_gate__m, 3.0) * (-1.0 + exp(0.037679754693225952 * var_chaste_interface__membrane__V - 0.037679754693225952 * var_sodium_current__E_Na)) * (0.36499999999999999 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.63500000000000001 * var_chaste_interface__sodium_current_h1_gate__h1) * var_chaste_interface__membrane__V / (-1.0 + exp(0.037679754693225952 * var_chaste_interface__membrane__V)); // picoA
    ...
    void Cellaslanidi_model_2009FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_Ca_handling_by_the_SR__i_tr = 0.8490856 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up - 0.8490856 * var_chaste_interface__Ca_handling_by_the_SR__Ca_rel; // picoA
        const double d_dt_chaste_interface_var_Ca_handling_by_the_SR__Ca_rel = 0.11777375567316184 * var_Ca_handling_by_the_SR__i_tr - 0.031 * var_Ca_handling_by_the_SR__O_Calse_orig_deriv - 0.11777375567316184 * var_Ca_handling_by_the_SR__i_rel; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Na_i = -0.00082254686501890791 * var_background_currents__i_B_Na - 0.00082254686501890791 * var_sodium_current__i_Na - 0.0024676405950567241 * var_Na_Ca_ion_exchanger_current__i_NaCa - 0.0024676405950567241 * var_sodium_potassium_pump__i_p; // millimolar / millisecond
