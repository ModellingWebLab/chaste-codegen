...
class Cellzhang_SAN_model_2000_allFromCellML : public AbstractCvodeCell
{
...
public:
    Cellzhang_SAN_model_2000_allFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
