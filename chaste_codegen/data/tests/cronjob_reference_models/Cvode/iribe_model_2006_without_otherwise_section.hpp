...
class Celliribe_model_2006_without_otherwise_sectionFromCellML : public AbstractCvodeCell
{
...
public:
    ...
    Celliribe_model_2006_without_otherwise_sectionFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
