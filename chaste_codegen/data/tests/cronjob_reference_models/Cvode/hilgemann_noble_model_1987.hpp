...
class Cellhilgemann_noble_model_1987FromCellML : public AbstractCvodeCell
{
...
public:
    ...
    Cellhilgemann_noble_model_1987FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
