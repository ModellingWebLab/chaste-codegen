...
class Cellpandit_model_2001_epiFromCellML : public AbstractCvodeCell
{
...
public:
    ...
    Cellpandit_model_2001_epiFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
