...
#include "MathsCustomFunctions.hpp"
    ...
    Cellmatsuoka_model_2003FromCellML::Cellmatsuoka_model_2003FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                37,
                0,
    ...
    void Cellmatsuoka_model_2003FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__Vm = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_membrane__i_ext = 1000000.0 * var_membrane__i_ext_converter / HeartConfig::Instance()->GetCapacitance(); // picoA
        const double var_rapid_time_dependent_potassium_current__P_Kr = 0.0086400000000000001; // nanoS_per_picoF
        const double var_rapid_time_dependent_potassium_current__g_Kr = 0.71370912277944121 * pow(var_external_ion_concentrations__Ko, 0.20000000000000001) * var_membrane__Cm * var_rapid_time_dependent_potassium_current__P_Kr; // nanoS
