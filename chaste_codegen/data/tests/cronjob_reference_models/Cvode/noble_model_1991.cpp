...
#include "MathsCustomFunctions.hpp"
    ...
    Cellnoble_model_1991FromCellML::Cellnoble_model_1991FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                17,
                0,
    ...
    void Cellnoble_model_1991FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        else
        {
            ...
            const double var_membrane__i_Stim = 1000.0 * var_membrane__i_Stim_converter / HeartConfig::Instance()->GetCapacitance(); // nanoA
