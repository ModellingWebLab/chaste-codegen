...
class Cellsakmann_model_2000_epiFromCellML : public AbstractCvodeCell
{
...
public:
    ...
    Cellsakmann_model_2000_epiFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
