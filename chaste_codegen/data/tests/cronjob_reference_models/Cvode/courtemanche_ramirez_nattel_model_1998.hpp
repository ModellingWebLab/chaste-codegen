...
class Cellcourtemanche_ramirez_nattel_model_1998FromCellML : public AbstractCvodeCell
{
...
public:
    ...
    Cellcourtemanche_ramirez_nattel_model_1998FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
