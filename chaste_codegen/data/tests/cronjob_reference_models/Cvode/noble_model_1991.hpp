...
class Cellnoble_model_1991FromCellML : public AbstractCvodeCell
{
...
public:
    ...
    Cellnoble_model_1991FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
