...
class Cellmatsuoka_model_2003FromCellML : public AbstractCvodeCell
{
...
public:
    ...
    Cellmatsuoka_model_2003FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
