...
class Cellpriebe_beuckelmann_model_1998FromCellML : public AbstractCvodeCell
{
...
public:
    ...
    Cellpriebe_beuckelmann_model_1998FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
