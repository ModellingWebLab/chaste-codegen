...
#include "CvodeContextManager.hpp"
    ...
    std::shared_ptr<RegularStimulus> Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvodeDataClamp::UseCellMLDefaultStimulus()
    {
    ...
    Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvodeDataClamp::Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvodeDataClamp(std::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, std::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
