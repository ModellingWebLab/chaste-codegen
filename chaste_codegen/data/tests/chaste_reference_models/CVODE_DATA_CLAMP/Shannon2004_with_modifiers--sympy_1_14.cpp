...
bool Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp::registered = ModelFactory::Register("Shannon2004_with_modifiers", "CvodeCellWithDataClamp", (ModelFactory::TCreateMethod)Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp::CreateMethod);
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp::GetIntracellularCalciumConcentration()
    {
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp>::Instance();
        Init();
        ...
        this->AddModifier("chloride_reversal_potential",
                          mp_chloride_reversal_potential_modifier);
        ...
        this->AddModifier("cytosolic_chloride_concentration",
                          mp_cytosolic_chloride_concentration_modifier);
        ...
        this->AddModifier("dyadic_space_sodium_concentration",
                          mp_dyadic_space_sodium_concentration_modifier);
        this->AddModifier("extracellular_calcium_concentration",
                          mp_extracellular_calcium_concentration_modifier);
        this->AddModifier("extracellular_chloride_concentration",
                          mp_extracellular_chloride_concentration_modifier);
        ...
        this->AddModifier("faraday_constant",
                          mp_faraday_constant_modifier);
        this->AddModifier("gas_constant",
        ...
        this->AddModifier("membrane_background_calcium_current",
                          mp_ICab__i_Cab_modifier);
        this->AddModifier("membrane_background_chloride_current",
                          mp_IClb__i_Clb_modifier);
        this->AddModifier("membrane_background_chloride_current_conductance",
                          mp_membrane_background_chloride_current_conductance_modifier);
        this->AddModifier("membrane_background_sodium_current",
                          mp_INab__i_Nab_modifier);
        this->AddModifier("membrane_calcium_pump_current",
                          mp_ICap__i_Cap_modifier);
        ...
        this->AddModifier("membrane_fast_transient_outward_current",
                          mp_Itof__i_tof_modifier);
        this->AddModifier("membrane_fast_transient_outward_current_conductance",
                          mp_membrane_fast_transient_outward_current_conductance_modifier);
        ...
        this->AddModifier("membrane_inward_rectifier_potassium_current_conductance_scaling_factor",
        ...
        this->AddModifier("membrane_slow_transient_outward_current",
                          mp_Itos__i_tos_modifier);
        this->AddModifier("membrane_slow_transient_outward_current_conductance",
                          mp_membrane_slow_transient_outward_current_conductance_modifier);
        ...
        this->AddModifier("submembrane_space_calcium_concentration",
                          mp_submembrane_space_calcium_concentration_modifier);
        this->AddModifier("submembrane_space_sodium_concentration",
                          mp_submembrane_space_sodium_concentration_modifier);
        this->AddModifier("temperature",
                          mp_temperature_modifier);
        ...
        NV_Ith_S(this->mParameters, 14) = 0; // (var_membrane_data_clamp_current_conductance) [dimensionless]
        NV_Ith_S(this->mParameters, 15) = 16; // (var_INa__G_INa) [milliS_per_microF]
        ...
        NV_Ith_S(this->mParameters, 24) = 310; // (var_model_parameters__T) [kelvin]
    }

    Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp::~Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp()
    {
    }
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IKs__G_Ks_SL = (0.057000000000000002 + 0.19 / (1 + exp(-12 + 1.6666666666666667 * var_IKs__pCa_SL))) * NV_Ith_S(mParameters, 21); // milliS_per_microF
        const double var_IKs__pCa_jct = 3 - log10(1 * var_chaste_interface__Ca_buffer__Ca_jct); // dimensionless
        const double var_IKs__G_Ks_jct = (0.057000000000000002 + 0.19 / (1 + exp(-12 + 1.6666666666666667 * var_IKs__pCa_jct))) * NV_Ith_S(mParameters, 21); // milliS_per_microF
        ...
        const double var_ICaL__Q_CaL = pow(var_ICaL__Q10_CaL, (-31 + 0.10000000000000001 * NV_Ith_S(mParameters, 24))); // dimensionless
        const double var_ICaL__temp = 0.45000000000000001 * pow(NV_Ith_S(mParameters, 10), 2) * var_ICaL__Q_CaL * var_chaste_interface__ICaL_d_gate__d * var_chaste_interface__ICaL_f_gate__f * var_chaste_interface__cell__V / (NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 24)); // coulomb_per_mole
        ...
        const double var_ICap__Q_SLCaP = pow(var_ICap__Q10_SLCaP, (-31 + 0.10000000000000001 * NV_Ith_S(mParameters, 24))); // dimensionless
        ...
        const double var_INaCa__Q_NCX = pow(var_INaCa__Q10_NCX, (-31 + 0.10000000000000001 * NV_Ith_S(mParameters, 24))); // dimensionless
        ...
        const double var_INaK__Q_Km_Nai = pow(var_INaK__Q10_Km_Nai, (-31 + 0.10000000000000001 * NV_Ith_S(mParameters, 24))); // dimensionless
        const double var_INaK__Q_NaK = pow(var_INaK__Q10_NaK, (-31 + 0.10000000000000001 * NV_Ith_S(mParameters, 24))); // dimensionless
    ...
    void Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        ...
        double var_chaste_interface__Na_buffer__Na_SL = mp_submembrane_space_sodium_concentration_modifier->Calc(NV_Ith_S(rY, 19), var_chaste_interface__environment__time);
        // Units: millimolar; Initial value: 8.87161932058707
        double var_chaste_interface__Na_buffer__Na_jct = mp_dyadic_space_sodium_concentration_modifier->Calc(NV_Ith_S(rY, 20), var_chaste_interface__environment__time);
        // Units: millimolar; Initial value: 8.87031835089116
        ...
        // Units: millimolar; Initial value: 0.000104971310105451
        double var_chaste_interface__Ca_buffer__Ca_jct = mp_dyadic_space_calcium_concentration_modifier->Calc(NV_Ith_S(rY, 26), var_chaste_interface__environment__time);
        // Units: millimolar; Initial value: 0.000174045152623969
        ...
        const double var_ICaL_fCa_gate__fCa_SL = mp_membrane_L_type_calcium_current_fCa_gate_modifier->Calc(1 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL, var_chaste_interface__environment__time); // dimensionless
        const double var_ICaL_fCa_gate__fCa_jct = 1 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct; // dimensionless
        const double var_ICab__Fx_CaBk_SL = 0.89000000000000001; // dimensionless
        const double var_ICab__Fx_CaBk_jct = 0.11; // dimensionless
        const double var_ICab__G_CaBk = 0.00025129999999999998; // milliS_per_microF
        ...
        const double var_ICaL_f_gate__tau_f = mp_membrane_L_type_calcium_current_f_gate_tau_modifier->Calc(1 / (0.02 + 0.019699999999999999 * exp(-pow((0.48865000000000003 + 0.033700000000000001 * var_chaste_interface__cell__V), 2))), var_chaste_interface__environment__time); // millisecond
        ...
        const double var_INa_j_gate__j_infinity = 0.01 * mp_membrane_fast_sodium_current_reduced_inactivation_modifier->Calc(NV_Ith_S(mParameters, 16), var_chaste_interface__environment__time) + (1 - 0.01 * mp_membrane_fast_sodium_current_reduced_inactivation_modifier->Calc(NV_Ith_S(mParameters, 16), var_chaste_interface__environment__time)) * var_INa_j_gate__alpha_j / (var_INa_j_gate__alpha_j + var_INa_j_gate__beta_j); // dimensionless
        const double var_INa_j_gate__tau_j = mp_membrane_fast_sodium_current_j_gate_tau_modifier->Calc(1 / (var_INa_j_gate__alpha_j + var_INa_j_gate__beta_j), var_chaste_interface__environment__time); // millisecond
        ...
        const double var_INaCa__i_NaCa_jct = var_INaCa__Fx_NCX_jct * var_INaCa__Ka_jct * var_INaCa__Q_NCX * mp_membrane_sodium_calcium_exchanger_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 23), var_chaste_interface__environment__time) * var_INaCa__temp_jct / (pow(var_chaste_interface__Na_buffer__Na_jct, var_INaCa__HNa) * var_INaCa__K_mCao + pow(var_chaste_interface__Na_buffer__Na_jct, var_INaCa__HNa) * mp_extracellular_calcium_concentration_modifier->Calc(NV_Ith_S(mParameters, 6), var_chaste_interface__environment__time) + pow(mp_extracellular_sodium_concentration_modifier->Calc(NV_Ith_S(mParameters, 9), var_chaste_interface__environment__time), var_INaCa__HNa) * var_chaste_interface__Ca_buffer__Ca_jct + pow(var_INaCa__K_mNao, var_INaCa__HNa) * (1 + var_chaste_interface__Ca_buffer__Ca_jct / var_INaCa__K_mCai) * var_chaste_interface__Ca_buffer__Ca_jct + pow(mp_extracellular_sodium_concentration_modifier->Calc(NV_Ith_S(mParameters, 9), var_chaste_interface__environment__time), var_INaCa__HNa) * (1 + pow((var_chaste_interface__Na_buffer__Na_jct / var_INaCa__K_mNai), var_INaCa__HNa)) * var_INaCa__K_mCai); // microA_per_microF
        const double var_INaK__Q_Km_Nai = pow(var_INaK__Q10_Km_Nai, (-31 + 0.10000000000000001 * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time))); // dimensionless
        const double var_INaK__Q_NaK = pow(var_INaK__Q10_NaK, (-31 + 0.10000000000000001 * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time))); // dimensionless
        ...
        const double var_INaK__i_NaK_jct = var_INaK__Fx_NaK_jct * var_INaK__I_NaK_max * var_INaK__Q_NaK * var_INaK__f_NaK * mp_extracellular_potassium_concentration_modifier->Calc(NV_Ith_S(mParameters, 8), var_chaste_interface__environment__time) / ((1 + pow((var_INaK__Km_Nai * var_INaK__Q_Km_Nai / var_chaste_interface__Na_buffer__Na_jct), var_INaK__H_NaK)) * (var_INaK__Km_Ko + mp_extracellular_potassium_concentration_modifier->Calc(NV_Ith_S(mParameters, 8), var_chaste_interface__environment__time))); // microA_per_microF
        const double var_Jpump_SR__Q_SRCaP = pow(var_Jpump_SR__Q10_SRCaP, (-31 + 0.10000000000000001 * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time))); // dimensionless
        ...
        const double d_dt_chaste_interface_var_Na_buffer__Nai = mp_concentration_clamp_onoff_modifier->Calc(NV_Ith_S(mParameters, 3), var_chaste_interface__environment__time) * var_ion_diffusion__J_Na_SL_cytosol / var_model_parameters__Vol_cytosol; // millimolar / millisecond
        ...
        const double var_reversal_potentials__E_Na_jct = mp_gas_constant_modifier->Calc(NV_Ith_S(mParameters, 11), var_chaste_interface__environment__time) * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time) * log(mp_extracellular_sodium_concentration_modifier->Calc(NV_Ith_S(mParameters, 9), var_chaste_interface__environment__time) / var_chaste_interface__Na_buffer__Na_jct) / mp_faraday_constant_modifier->Calc(NV_Ith_S(mParameters, 10), var_chaste_interface__environment__time); // millivolt
        const double var_INa__i_Na_jct = (-var_reversal_potentials__E_Na_jct + var_chaste_interface__cell__V) * var_INa__Fx_Na_jct * mp_membrane_fast_sodium_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 15), var_chaste_interface__environment__time) * var_INa__openProb; // microA_per_microF
        const double var_INab__i_Nab_jct = (-var_reversal_potentials__E_Na_jct + var_chaste_interface__cell__V) * var_INab__Fx_NaBk_jct * var_INab__G_NaBk; // microA_per_microF
        ...
        else
        {
            ...
            const double var_IKs__Fx_Ks_jct = 0.11; // dimensionless
            const double var_IKs__pCa_SL = 3 - log10(1 * var_chaste_interface__Ca_buffer__Ca_SL); // dimensionless
            const double var_IKs__G_Ks_SL = (0.057000000000000002 + 0.19 / (1 + exp(-12 + 1.6666666666666667 * var_IKs__pCa_SL))) * mp_membrane_slow_delayed_rectifier_potassium_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 21), var_chaste_interface__environment__time); // milliS_per_microF
            const double var_IKs__pCa_jct = 3 - log10(1 * var_chaste_interface__Ca_buffer__Ca_jct); // dimensionless
            const double var_IKs__G_Ks_jct = (0.057000000000000002 + 0.19 / (1 + exp(-12 + 1.6666666666666667 * var_IKs__pCa_jct))) * mp_membrane_slow_delayed_rectifier_potassium_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 21), var_chaste_interface__environment__time); // milliS_per_microF
            const double var_IKs__pKNa = 0.018329999999999999; // dimensionless
            const double var_IKr_Rr_gate__Rr = 1 / (1 + exp(1.4732142857142858 + 0.044642857142857144 * var_chaste_interface__cell__V)); // dimensionless
            ...
            const double var_INaK__i_NaK = var_INaK__i_NaK_SL + var_INaK__i_NaK_jct; // microA_per_microF
            const double var_ICab__i_Cab = mp_ICab__i_Cab_modifier->Calc(var_ICab__i_Cab_SL + var_ICab__i_Cab_jct, var_chaste_interface__environment__time); // microA_per_microF
            const double var_reversal_potentials__E_Cl = mp_chloride_reversal_potential_modifier->Calc(-mp_gas_constant_modifier->Calc(NV_Ith_S(mParameters, 11), var_chaste_interface__environment__time) * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time) * log(mp_extracellular_chloride_concentration_modifier->Calc(NV_Ith_S(mParameters, 7), var_chaste_interface__environment__time) / mp_cytosolic_chloride_concentration_modifier->Calc(NV_Ith_S(mParameters, 4), var_chaste_interface__environment__time)) / mp_faraday_constant_modifier->Calc(NV_Ith_S(mParameters, 10), var_chaste_interface__environment__time), var_chaste_interface__environment__time); // millivolt
            const double var_ICl_Ca__i_Cl_Ca = (-var_reversal_potentials__E_Cl + var_chaste_interface__cell__V) * (var_ICl_Ca__Fx_Cl_SL / (1 + var_ICl_Ca__Kd_ClCa / var_chaste_interface__Ca_buffer__Ca_SL) + var_ICl_Ca__Fx_Cl_jct / (1 + var_ICl_Ca__Kd_ClCa / var_chaste_interface__Ca_buffer__Ca_jct)) * var_ICl_Ca__G_Cl; // microA_per_microF
            const double var_IClb__i_Clb = mp_IClb__i_Clb_modifier->Calc((-var_reversal_potentials__E_Cl + var_chaste_interface__cell__V) * mp_membrane_background_chloride_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 13), var_chaste_interface__environment__time), var_chaste_interface__environment__time); // microA_per_microF
            ...
            const double var_Itof__i_tof = mp_Itof__i_tof_modifier->Calc((-var_reversal_potentials__E_K + var_chaste_interface__cell__V) * mp_membrane_fast_transient_outward_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 18), var_chaste_interface__environment__time) * var_chaste_interface__Itof_X_gate__X_tof * var_chaste_interface__Itof_Y_gate__Y_tof, var_chaste_interface__environment__time); // microA_per_microF
            const double var_Itos__i_tos = mp_Itos__i_tos_modifier->Calc((-var_reversal_potentials__E_K + var_chaste_interface__cell__V) * (0.5 * var_chaste_interface__Itos_R_gate__R_tos + var_chaste_interface__Itos_Y_gate__Y_tos) * mp_membrane_slow_transient_outward_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 22), var_chaste_interface__environment__time) * var_chaste_interface__Itos_X_gate__X_tos, var_chaste_interface__environment__time); // microA_per_microF
    ...
    N_Vector Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : mp_membrane_voltage_modifier->Calc(NV_Ith_S(rY, 0), var_chaste_interface__environment__time));
        ...
        const double var_model_parameters__cell_radius = 10.25; // micrometre
        const double var_model_parameters__Cm = 2.0e-8 * M_PI * var_model_parameters__Cm_per_area * var_model_parameters__cell_length * var_model_parameters__cell_radius; // farad
        const double var_model_parameters__Cm_converted = mp_membrane_capacitance_modifier->Calc(1000000 * var_model_parameters__Cm, var_chaste_interface__environment__time); // uF
        const double var_reversal_potentials__E_Ca_SL = 0.5 * mp_gas_constant_modifier->Calc(NV_Ith_S(mParameters, 11), var_chaste_interface__environment__time) * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time) * log(mp_extracellular_calcium_concentration_modifier->Calc(NV_Ith_S(mParameters, 6), var_chaste_interface__environment__time) / var_chaste_interface__Ca_buffer__Ca_SL) / mp_faraday_constant_modifier->Calc(NV_Ith_S(mParameters, 10), var_chaste_interface__environment__time); // millivolt
        const double var_ICab__i_Cab_SL = (-var_reversal_potentials__E_Ca_SL + var_chaste_interface__cell__V) * var_ICab__Fx_CaBk_SL * var_ICab__G_CaBk; // microA_per_microF
        const double var_reversal_potentials__E_Ca_jct = 0.5 * mp_gas_constant_modifier->Calc(NV_Ith_S(mParameters, 11), var_chaste_interface__environment__time) * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time) * log(mp_extracellular_calcium_concentration_modifier->Calc(NV_Ith_S(mParameters, 6), var_chaste_interface__environment__time) / var_chaste_interface__Ca_buffer__Ca_jct) / mp_faraday_constant_modifier->Calc(NV_Ith_S(mParameters, 10), var_chaste_interface__environment__time); // millivolt
        const double var_ICab__i_Cab_jct = (-var_reversal_potentials__E_Ca_jct + var_chaste_interface__cell__V) * var_ICab__Fx_CaBk_jct * var_ICab__G_CaBk; // microA_per_microF
...
template<>
void OdeSystemInformation<Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp>::Initialise(void)
{
