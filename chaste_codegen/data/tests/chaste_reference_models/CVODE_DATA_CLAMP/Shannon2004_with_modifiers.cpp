...
bool Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp::registered = ModelFactory::Register("Shannon2004_with_modifiers", "CvodeCellWithDataClamp", (ModelFactory::TCreateMethod)Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp::CreateMethod);
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 18) = CHASTE_CONST(0.02); // (var_Itof__G_tof) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 19) = CHASTE_CONST(0.90000000000000002); // (var_IK1__G_K1_max) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 20) = CHASTE_CONST(0.029999999999999999); // (var_IKr__G_IKr_const) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 21) = CHASTE_CONST(0.070000000000000007); // (var_IKs__G_Ks_max) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 22) = CHASTE_CONST(0.059999999999999998); // (var_Itos__G_tos) [milliS_per_microF]
    ...
    double Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IKs__G_Ks_SL = (CHASTE_CONST(0.057000000000000002) + CHASTE_CONST(0.19) / (1 + CHASTE_MATH::Exp(-12 + CHASTE_CONST(1.6666666666666667) * var_IKs__pCa_SL))) * NV_Ith_S(mParameters, 21); // milliS_per_microF
        const double var_IKs__pCa_jct = 3 - CHASTE_MATH::Log10(var_chaste_interface__Ca_buffer__Ca_jct); // dimensionless
        const double var_IKs__G_Ks_jct = (CHASTE_CONST(0.057000000000000002) + CHASTE_CONST(0.19) / (1 + CHASTE_MATH::Exp(-12 + CHASTE_CONST(1.6666666666666667) * var_IKs__pCa_jct))) * NV_Ith_S(mParameters, 21); // milliS_per_microF
        ...
        const double var_IK1__G_K1 = CHASTE_CONST(0.43033148291193518) * CHASTE_MATH::Sqrt(NV_Ith_S(mParameters, 8)) * NV_Ith_S(mParameters, 19); // milliS_per_microF
        const double var_IKr__G_IKr = CHASTE_CONST(0.43033148291193518) * CHASTE_MATH::Sqrt(NV_Ith_S(mParameters, 8)) * NV_Ith_S(mParameters, 20); // milliS_per_microF
        ...
        const double var_ICaL__Q_CaL = CHASTE_MATH::Pow(var_ICaL__Q10_CaL, (-31 + CHASTE_CONST(0.10000000000000001) * NV_Ith_S(mParameters, 24))); // dimensionless
        const double var_ICaL__temp = CHASTE_CONST(0.45000000000000001) * CHASTE_MATH::Pow(NV_Ith_S(mParameters, 10), 2) * var_ICaL__Q_CaL * var_chaste_interface__ICaL_d_gate__d * var_chaste_interface__ICaL_f_gate__f * var_chaste_interface__cell__V / (NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 24)); // coulomb_per_mole
        ...
        const double var_ICap__Q_SLCaP = CHASTE_MATH::Pow(var_ICap__Q10_SLCaP, (-31 + CHASTE_CONST(0.10000000000000001) * NV_Ith_S(mParameters, 24))); // dimensionless
        ...
        const double var_IKs__E_Ks = NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 24) * CHASTE_MATH::Log((var_IKs__pKNa * NV_Ith_S(mParameters, 9) + NV_Ith_S(mParameters, 8)) / (var_IKs__pKNa * var_chaste_interface__Na_buffer__Nai + NV_Ith_S(mParameters, 5))) / NV_Ith_S(mParameters, 10); // millivolt
        ...
        const double var_INaCa__Q_NCX = CHASTE_MATH::Pow(var_INaCa__Q10_NCX, (-31 + CHASTE_CONST(0.10000000000000001) * NV_Ith_S(mParameters, 24))); // dimensionless
        ...
        const double var_INaK__Q_Km_Nai = CHASTE_MATH::Pow(var_INaK__Q10_Km_Nai, (-31 + CHASTE_CONST(0.10000000000000001) * NV_Ith_S(mParameters, 24))); // dimensionless
        const double var_INaK__Q_NaK = CHASTE_MATH::Pow(var_INaK__Q10_NaK, (-31 + CHASTE_CONST(0.10000000000000001) * NV_Ith_S(mParameters, 24))); // dimensionless
        ...
        const double var_reversal_potentials__E_Ca_SL = CHASTE_CONST(0.5) * NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 24) * CHASTE_MATH::Log(NV_Ith_S(mParameters, 6) / var_chaste_interface__Ca_buffer__Ca_SL) / NV_Ith_S(mParameters, 10); // millivolt
        ...
        const double var_reversal_potentials__E_Ca_jct = CHASTE_CONST(0.5) * NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 24) * CHASTE_MATH::Log(NV_Ith_S(mParameters, 6) / var_chaste_interface__Ca_buffer__Ca_jct) / NV_Ith_S(mParameters, 10); // millivolt
        ...
        const double var_reversal_potentials__E_Cl = -NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 24) * CHASTE_MATH::Log(NV_Ith_S(mParameters, 7) / NV_Ith_S(mParameters, 4)) / NV_Ith_S(mParameters, 10); // millivolt
        ...
        const double var_reversal_potentials__E_K = NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 24) * CHASTE_MATH::Log(NV_Ith_S(mParameters, 8) / NV_Ith_S(mParameters, 5)) / NV_Ith_S(mParameters, 10); // millivolt
        ...
        const double var_Itos__i_tos = (-var_reversal_potentials__E_K + var_chaste_interface__cell__V) * (CHASTE_CONST(0.5) * var_chaste_interface__Itos_R_gate__R_tos + var_chaste_interface__Itos_Y_gate__Y_tos) * NV_Ith_S(mParameters, 22) * var_chaste_interface__Itos_X_gate__X_tos; // microA_per_microF
        const double var_Itos__i_tos_converted = CHASTE_CAP() * var_Itos__i_tos; // uA_per_cm2
        const double var_reversal_potentials__E_Na_SL = NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 24) * CHASTE_MATH::Log(NV_Ith_S(mParameters, 9) / var_chaste_interface__Na_buffer__Na_SL) / NV_Ith_S(mParameters, 10); // millivolt
        ...
        const double var_reversal_potentials__E_Na_jct = NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 24) * CHASTE_MATH::Log(NV_Ith_S(mParameters, 9) / var_chaste_interface__Na_buffer__Na_jct) / NV_Ith_S(mParameters, 10); // millivolt
    ...
    void Cellshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? CHASTE_THIS(mFixedVoltage) : mp_membrane_voltage_modifier->Calc(NV_Ith_S(rY, 0), var_chaste_interface__environment__time));
        // Units: millivolt; Initial value: -85.721630473733
        ...
        const double var_ICaL_f_gate__tau_f = mp_membrane_L_type_calcium_current_f_gate_tau_modifier->Calc(1 / (CHASTE_CONST(0.02) + CHASTE_CONST(0.019699999999999999) * CHASTE_MATH::Exp(-CHASTE_CONST(0.23877882250000002) * CHASTE_MATH::Pow((1 + CHASTE_CONST(0.068965517241379309) * var_chaste_interface__cell__V), 2))), var_chaste_interface__environment__time); // millisecond
        ...
        const double var_INa_j_gate__j_infinity = CHASTE_CONST(0.01) * mp_membrane_fast_sodium_current_reduced_inactivation_modifier->Calc(NV_Ith_S(mParameters, 16), var_chaste_interface__environment__time) + (1 - CHASTE_CONST(0.01) * mp_membrane_fast_sodium_current_reduced_inactivation_modifier->Calc(NV_Ith_S(mParameters, 16), var_chaste_interface__environment__time)) * var_INa_j_gate__alpha_j / (var_INa_j_gate__alpha_j + var_INa_j_gate__beta_j); // dimensionless
        ...
        const double var_INaK__sigma = -CHASTE_CONST(0.14285714285714285) + CHASTE_CONST(0.14285714285714285) * CHASTE_MATH::Exp(CHASTE_CONST(0.01485884101040119) * mp_extracellular_sodium_concentration_modifier->Calc(NV_Ith_S(mParameters, 9), var_chaste_interface__environment__time)); // dimensionless
        const double var_ICaL__Q_CaL = CHASTE_MATH::Pow(var_ICaL__Q10_CaL, (-31 + CHASTE_CONST(0.10000000000000001) * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time))); // dimensionless
        ...
        const double var_ICap__Q_SLCaP = CHASTE_MATH::Pow(var_ICap__Q10_SLCaP, (-31 + CHASTE_CONST(0.10000000000000001) * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time))); // dimensionless
        const double var_ICap__i_Cap_SL = var_ICap__Fx_SLCaP_SL * var_ICap__Q_SLCaP * var_ICap__V_maxAF / (1 + CHASTE_MATH::Pow((var_ICap__Km / var_chaste_interface__Ca_buffer__Ca_SL), var_ICap__H)); // microA_per_microF
        const double var_ICap__i_Cap_jct = var_ICap__Fx_SLCaP_jct * var_ICap__Q_SLCaP * var_ICap__V_maxAF / (1 + CHASTE_MATH::Pow((var_ICap__Km / var_chaste_interface__Ca_buffer__Ca_jct), var_ICap__H)); // microA_per_microF
        const double var_INaCa__Q_NCX = CHASTE_MATH::Pow(var_INaCa__Q10_NCX, (-31 + CHASTE_CONST(0.10000000000000001) * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time))); // dimensionless
        ...
        const double var_INaCa__i_NaCa_jct = var_INaCa__Fx_NCX_jct * var_INaCa__Ka_jct * var_INaCa__Q_NCX * mp_membrane_sodium_calcium_exchanger_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 23), var_chaste_interface__environment__time) * var_INaCa__temp_jct / (CHASTE_MATH::Pow(var_chaste_interface__Na_buffer__Na_jct, var_INaCa__HNa) * var_INaCa__K_mCao + CHASTE_MATH::Pow(var_chaste_interface__Na_buffer__Na_jct, var_INaCa__HNa) * mp_extracellular_calcium_concentration_modifier->Calc(NV_Ith_S(mParameters, 6), var_chaste_interface__environment__time) + CHASTE_MATH::Pow(mp_extracellular_sodium_concentration_modifier->Calc(NV_Ith_S(mParameters, 9), var_chaste_interface__environment__time), var_INaCa__HNa) * var_chaste_interface__Ca_buffer__Ca_jct + CHASTE_MATH::Pow(var_INaCa__K_mNao, var_INaCa__HNa) * (1 + var_chaste_interface__Ca_buffer__Ca_jct / var_INaCa__K_mCai) * var_chaste_interface__Ca_buffer__Ca_jct + CHASTE_MATH::Pow(mp_extracellular_sodium_concentration_modifier->Calc(NV_Ith_S(mParameters, 9), var_chaste_interface__environment__time), var_INaCa__HNa) * (1 + CHASTE_MATH::Pow((var_chaste_interface__Na_buffer__Na_jct / var_INaCa__K_mNai), var_INaCa__HNa)) * var_INaCa__K_mCai); // microA_per_microF
        const double var_INaK__Q_Km_Nai = CHASTE_MATH::Pow(var_INaK__Q10_Km_Nai, (-31 + CHASTE_CONST(0.10000000000000001) * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time))); // dimensionless
        const double var_INaK__Q_NaK = CHASTE_MATH::Pow(var_INaK__Q10_NaK, (-31 + CHASTE_CONST(0.10000000000000001) * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time))); // dimensionless
        ...
        const double var_Jpump_SR__Q_SRCaP = CHASTE_MATH::Pow(var_Jpump_SR__Q10_SRCaP, (-31 + CHASTE_CONST(0.10000000000000001) * mp_temperature_modifier->Calc(NV_Ith_S(mParameters, 24), var_chaste_interface__environment__time))); // dimensionless
        ...
        else
        {
            ...
            const double var_IKs__Fx_Ks_jct = CHASTE_CONST(0.11); // dimensionless
            const double var_IKs__pCa_SL = 3 - CHASTE_MATH::Log10(var_chaste_interface__Ca_buffer__Ca_SL); // dimensionless
            const double var_IKs__G_Ks_SL = (CHASTE_CONST(0.057000000000000002) + CHASTE_CONST(0.19) / (1 + CHASTE_MATH::Exp(-12 + CHASTE_CONST(1.6666666666666667) * var_IKs__pCa_SL))) * mp_membrane_slow_delayed_rectifier_potassium_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 21), var_chaste_interface__environment__time); // milliS_per_microF
            const double var_IKs__pCa_jct = 3 - CHASTE_MATH::Log10(var_chaste_interface__Ca_buffer__Ca_jct); // dimensionless
            const double var_IKs__G_Ks_jct = (CHASTE_CONST(0.057000000000000002) + CHASTE_CONST(0.19) / (1 + CHASTE_MATH::Exp(-12 + CHASTE_CONST(1.6666666666666667) * var_IKs__pCa_jct))) * mp_membrane_slow_delayed_rectifier_potassium_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 21), var_chaste_interface__environment__time); // milliS_per_microF
            const double var_IKs__pKNa = CHASTE_CONST(0.018329999999999999); // dimensionless
            const double var_IKr_Rr_gate__Rr = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(1.4732142857142858) + CHASTE_CONST(0.044642857142857144) * var_chaste_interface__cell__V)); // dimensionless
            ...
            if (mDataClampIsOn)
            {
                var_chaste_interface__membrane_data_clamp_current = (-CHASTE_EXP_VOLT(var_chaste_interface__environment__time) + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 14); // uA_per_cm2
            }
