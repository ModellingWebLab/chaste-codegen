...
public:
    ...
    Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp(std::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, std::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
