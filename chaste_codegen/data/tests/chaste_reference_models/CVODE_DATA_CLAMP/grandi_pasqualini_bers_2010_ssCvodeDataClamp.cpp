...
bool Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClamp::registered = ModelFactory::Register("grandi_pasqualini_bers_2010_ss", "CvodeCellWithDataClamp", (ModelFactory::TCreateMethod)Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClamp::CreateMethod);
    ...
    double Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_parameters__eca_junc = CHASTE_CONST(0.5) * CHASTE_MATH::Log(NV_Ith_S(mParameters, 5) / var_chaste_interface__Ca_Concentrations__Ca_j) / var_parameters__FoRT; // mV
        ...
        const double var_parameters__eca_sl = CHASTE_CONST(0.5) * CHASTE_MATH::Log(NV_Ith_S(mParameters, 5) / var_chaste_interface__Ca_Concentrations__Ca_sl) / var_parameters__FoRT; // mV
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_I_Ca__dss = 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(0.83333333333333337) - CHASTE_CONST(0.16666666666666666) * var_chaste_interface__membrane_potential__V_m)); // dimensionless
        const double var_I_Ca__fss = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(3.8888888888888888) + CHASTE_CONST(0.1111111111111111) * var_chaste_interface__membrane_potential__V_m)) + CHASTE_CONST(0.59999999999999998) / (1 + CHASTE_MATH::Exp(CHASTE_CONST(2.5) - CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane_potential__V_m)); // dimensionless
        const double var_I_Ca__taud = CHASTE_CONST(28.571428571428569) * (1 - CHASTE_MATH::Exp(-CHASTE_CONST(0.83333333333333337) - CHASTE_CONST(0.16666666666666666) * var_chaste_interface__membrane_potential__V_m)) * var_I_Ca__dss / (5 + var_chaste_interface__membrane_potential__V_m); // msec
        ...
        const double var_I_Kr__tauxr = 230 / (1 + CHASTE_MATH::Exp(2 + CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane_potential__V_m)) + 3300 / ((1 + CHASTE_MATH::Exp(CHASTE_CONST(1.2222222222222223) + CHASTE_CONST(0.1111111111111111) * var_chaste_interface__membrane_potential__V_m)) * (1 + CHASTE_MATH::Exp(-CHASTE_CONST(2.4444444444444446) - CHASTE_CONST(0.1111111111111111) * var_chaste_interface__membrane_potential__V_m))); // msec
        const double var_I_Kr__xrss = 1 / (1 + CHASTE_MATH::Exp(-2 - CHASTE_CONST(0.20000000000000001) * var_chaste_interface__membrane_potential__V_m)); // dimensionless
        const double d_dt_chaste_interface_var_I_Kr__x_kr = (-var_chaste_interface__I_Kr__x_kr + var_I_Kr__xrss) / var_I_Kr__tauxr; // 1 / msec
        const double var_I_Ks__tauxs = CHASTE_CONST(990.10000000000002) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(0.17252124645892353) - CHASTE_CONST(0.070821529745042494) * var_chaste_interface__membrane_potential__V_m)); // msec
        const double var_I_Ks__xsss = 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(0.26666666666666666) - CHASTE_CONST(0.070175438596491224) * var_chaste_interface__membrane_potential__V_m)); // dimensionless
        ...
        const double var_I_Na__hss = CHASTE_CONST(0.01) * NV_Ith_S(mParameters, 14) + (1 - CHASTE_CONST(0.01) * NV_Ith_S(mParameters, 14)) / CHASTE_MATH::Pow((1 + CHASTE_MATH::Exp(CHASTE_CONST(9.6298788694481825) + CHASTE_CONST(0.13458950201884254) * var_chaste_interface__membrane_potential__V_m - CHASTE_CONST(0.13458950201884254) * NV_Ith_S(mParameters, 15))), 2); // dimensionless
        const double var_I_Na__jss = CHASTE_CONST(0.01) * NV_Ith_S(mParameters, 14) + (1 - CHASTE_CONST(0.01) * NV_Ith_S(mParameters, 14)) / CHASTE_MATH::Pow((1 + CHASTE_MATH::Exp(CHASTE_CONST(9.6298788694481825) + CHASTE_CONST(0.13458950201884254) * var_chaste_interface__membrane_potential__V_m - CHASTE_CONST(0.13458950201884254) * NV_Ith_S(mParameters, 15))), 2); // dimensionless
        const double var_I_Na__mss = 1 / CHASTE_MATH::Pow((1 + CHASTE_MATH::Exp(-CHASTE_CONST(6.2967884828349945) - CHASTE_CONST(0.11074197120708749) * var_chaste_interface__membrane_potential__V_m)), 2); // dimensionless
        ...
        const double var_I_Na__taum = CHASTE_CONST(0.12920000000000001) * CHASTE_MATH::Exp(-CHASTE_CONST(8.682389366752302) * CHASTE_MATH::Pow((1 + CHASTE_CONST(0.021838829438742085) * var_chaste_interface__membrane_potential__V_m), 2)) + CHASTE_CONST(0.064869999999999997) * CHASTE_MATH::Exp(-CHASTE_CONST(0.0089012876052174655) * CHASTE_MATH::Pow((-1 + CHASTE_CONST(0.2073398299813394) * var_chaste_interface__membrane_potential__V_m), 2)); // msec
        const double d_dt_chaste_interface_var_I_Na__m = (-var_chaste_interface__I_Na__m + var_I_Na__mss) / var_I_Na__taum; // 1 / msec
        const double var_I_to__tauxtof = CHASTE_CONST(0.5) + CHASTE_CONST(8.5) * CHASTE_MATH::Exp(-CHASTE_CONST(0.81000000000000005) * CHASTE_MATH::Pow((1 + CHASTE_CONST(0.022222222222222223) * var_chaste_interface__membrane_potential__V_m), 2)); // msec
        const double var_I_to__tauxtos = CHASTE_CONST(0.5) + 9 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(0.20000000000000001) + CHASTE_CONST(0.066666666666666666) * var_chaste_interface__membrane_potential__V_m)); // msec
        const double var_I_to__tauytof = 7 + 85 * CHASTE_MATH::Exp(-CHASTE_CONST(7.2727272727272725) * CHASTE_MATH::Pow((1 + CHASTE_CONST(0.025000000000000001) * var_chaste_interface__membrane_potential__V_m), 2)); // msec
        const double var_I_to__tauytos = 30 + 800 / (1 + CHASTE_MATH::Exp(6 + CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane_potential__V_m)); // msec
        const double var_I_to__xtoss = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(1.4615384615384615) - CHASTE_CONST(0.076923076923076927) * var_chaste_interface__membrane_potential__V_m)); // dimensionless
        ...
        const double var_I_to__ytoss = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(3.8999999999999999) + CHASTE_CONST(0.20000000000000001) * var_chaste_interface__membrane_potential__V_m)); // dimensionless
