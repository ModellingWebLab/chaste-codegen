...
bool Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClamp::registered = ModelFactory::Register("grandi_pasqualini_bers_2010_ss", "CvodeCellWithDataClamp", (ModelFactory::TCreateMethod)Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClamp::CreateMethod);
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_I_Na__hss = 0.01 * NV_Ith_S(mParameters, 14) + (1 - 0.01 * NV_Ith_S(mParameters, 14)) / pow((1 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * NV_Ith_S(mParameters, 15))), 2); // dimensionless
        const double var_I_Na__jss = 0.01 * NV_Ith_S(mParameters, 14) + (1 - 0.01 * NV_Ith_S(mParameters, 14)) / pow((1 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * NV_Ith_S(mParameters, 15))), 2); // dimensionless
        ...
        const double var_I_Na__taum = 0.12920000000000001 * exp(-pow((2.9465894465894467 + 0.064350064350064351 * var_chaste_interface__membrane_potential__V_m), 2)) + 0.064869999999999997 * exp(-pow((-0.094346635367762138 + 0.019561815336463225 * var_chaste_interface__membrane_potential__V_m), 2)); // msec
        const double d_dt_chaste_interface_var_I_Na__m = (-var_chaste_interface__I_Na__m + var_I_Na__mss) / var_I_Na__taum; // 1 / msec
        const double var_I_to__tauxtof = 0.5 + 8.5 * exp(-pow((0.90000000000000002 + 0.02 * var_chaste_interface__membrane_potential__V_m), 2)); // msec
        ...
        const double var_I_to__tauytof = 7 + 85 * exp(-0.0045454545454545452 * pow((40 + var_chaste_interface__membrane_potential__V_m), 2)); // msec
