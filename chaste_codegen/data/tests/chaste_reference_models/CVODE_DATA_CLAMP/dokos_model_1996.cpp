...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldokos_model_1996FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = ((fabs(34.299999999999997 + var_chaste_interface__membrane__E) < 1.1111111111183902e-6) ? (-0.00022222222222367805 / (1.0 - exp(1.0000000000065512e-7)) + 449999.99999705196 * (34.300001111111108 + var_chaste_interface__membrane__E) * (0.00022222222222367805 / (1.0 - exp(1.0000000000065512e-7)) + 0.00022222222222367805 / (1.0 - exp(-1.0000000000065512e-7)))) : (200.0 * (34.299999999999997 + var_chaste_interface__membrane__E) / (1.0 - exp(-3.0869999999999997 - 0.089999999999999997 * var_chaste_interface__membrane__E)))); // per_second
