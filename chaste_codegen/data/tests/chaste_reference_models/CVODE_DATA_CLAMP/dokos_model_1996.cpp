...
#include "CvodeContextManager.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 0) = CHASTE_CONST(0.40000000000000002); // (var_L_type_calcium_current__g_CaL) [nanoS]
        NV_Ith_S(this->mParameters, 1) = CHASTE_CONST(3.1999999999999999e-5); // (var_membrane__C) [nanoF]
        NV_Ith_S(this->mParameters, 2) = 0; // (var_membrane_data_clamp_current_conductance) [dimensionless]
        NV_Ith_S(this->mParameters, 3) = CHASTE_CONST(0.00025999999999999998); // (var_delayed_rectifying_potassium_current__Kk) [picoA_per_millimolar]
        NV_Ith_S(this->mParameters, 4) = CHASTE_CONST(0.25); // (var_fast_sodium_current__g_Na) [nanoS]
        NV_Ith_S(this->mParameters, 5) = CHASTE_CONST(0.0135); // (var_hyperpolarising_activated_current__g_fK) [nanoS]
        NV_Ith_S(this->mParameters, 6) = CHASTE_CONST(0.0080999999999999996); // (var_hyperpolarising_activated_current__g_fNa) [nanoS]
    }
    ...
    double Celldokos_model_1996FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        double var_chaste_interface__membrane__E = (mSetVoltageDerivativeToZero ? CHASTE_THIS(mFixedVoltage) : NV_Ith_S(rY, 0));
        ...
        const double var_T_type_calcium_current__g_CaT = CHASTE_CONST(0.085000000000000006); // nanoS
        const double var_background_potassium_current__KbK = CHASTE_CONST(6.9999999999999994e-5); // picoA_per_millimolar
        const double var_background_sodium_current__g_Nab = CHASTE_CONST(0.00024000000000000001); // nanoS
        const double var_constants__F = CHASTE_CONST(96485.341499999995); // coulomb_per_mole
        const double var_constants__R = CHASTE_CONST(8314.4719999999998); // joule_per_kilomole_kelvin
        const double var_constants__T = 310; // kelvin
        const double var_delayed_rectifying_potassium_current__P_KNa = CHASTE_CONST(0.035000000000000003); // dimensionless
        const double var_hyperpolarising_activated_current__Kmf = CHASTE_CONST(10.300000000000001); // millimolar
        const double var_membrane__C_converted = CHASTE_CONST(0.001) * NV_Ith_S(mParameters, 1); // uF
        const double var_background_potassium_current__i_bK = CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(0.40999999999999998)) * (-var_chaste_interface__ion_concentrations__Ko * CHASTE_MATH::Exp(-var_constants__F * var_chaste_interface__membrane__E / (var_constants__R * var_constants__T)) + var_chaste_interface__ion_concentrations__Ki) * var_background_potassium_current__KbK; // picoA
        const double var_delayed_rectifying_potassium_current__i_KK = CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(0.58999999999999997)) * (-var_chaste_interface__ion_concentrations__Ko * CHASTE_MATH::Exp(-var_constants__F * var_chaste_interface__membrane__E / (var_constants__R * var_constants__T)) + var_chaste_interface__ion_concentrations__Ki) * NV_Ith_S(mParameters, 3) * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x; // picoA
        ...
        const double var_reversal_potentials__E_Ca = CHASTE_CONST(0.5) * var_constants__R * var_constants__T * CHASTE_MATH::Log(var_chaste_interface__ion_concentrations__Cao / var_chaste_interface__ion_concentrations__Cai) / var_constants__F; // millivolt
        ...
        const double var_reversal_potentials__E_K = var_constants__R * var_constants__T * CHASTE_MATH::Log(var_chaste_interface__ion_concentrations__Ko / var_chaste_interface__ion_concentrations__Ki) / var_constants__F; // millivolt
        const double var_hyperpolarising_activated_current__i_fK = CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(1.8300000000000001)) * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__E) * NV_Ith_S(mParameters, 5) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / (CHASTE_MATH::Pow(var_hyperpolarising_activated_current__Kmf, CHASTE_CONST(1.8300000000000001)) + CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(1.8300000000000001))); // picoA
        const double var_reversal_potentials__E_Na = var_constants__R * var_constants__T * CHASTE_MATH::Log(var_chaste_interface__ion_concentrations__Nao / var_chaste_interface__ion_concentrations__Nai) / var_constants__F; // millivolt
        ...
        const double var_fast_sodium_current__i_Na = CHASTE_MATH::Pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__E) * NV_Ith_S(mParameters, 4) * var_chaste_interface__fast_sodium_current_h_gate__h; // picoA
        const double var_hyperpolarising_activated_current__i_fNa = CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(1.8300000000000001)) * (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__E) * NV_Ith_S(mParameters, 6) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / (CHASTE_MATH::Pow(var_hyperpolarising_activated_current__Kmf, CHASTE_CONST(1.8300000000000001)) + CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(1.8300000000000001))); // picoA
        ...
        const double var_sodium_calcium_exchange_current__K1ni = CHASTE_CONST(395.30000000000001); // millimolar
        const double var_sodium_calcium_exchange_current__K1no = 1628; // millimolar
        const double var_sodium_calcium_exchange_current__K2ni = CHASTE_CONST(2.2890000000000001); // millimolar
        const double var_sodium_calcium_exchange_current__K2no = CHASTE_CONST(561.39999999999998); // millimolar
        const double var_sodium_calcium_exchange_current__K3ni = CHASTE_CONST(26.440000000000001); // millimolar
        const double var_sodium_calcium_exchange_current__K3no = CHASTE_CONST(4.6630000000000003); // millimolar
        const double var_sodium_calcium_exchange_current__Kci = CHASTE_CONST(0.0207); // millimolar
        const double var_sodium_calcium_exchange_current__Kcni = CHASTE_CONST(26.440000000000001); // millimolar
        const double var_sodium_calcium_exchange_current__Kco = CHASTE_CONST(3.6629999999999998); // millimolar
        const double var_sodium_calcium_exchange_current__Qci = CHASTE_CONST(0.13689999999999999); // dimensionless
        const double var_sodium_calcium_exchange_current__Qco = 0; // dimensionless
        const double var_sodium_calcium_exchange_current__Qn = CHASTE_CONST(0.43149999999999999); // dimensionless
        ...
        const double var_sodium_calcium_exchange_current__k32 = CHASTE_MATH::Exp(CHASTE_CONST(0.5) * var_constants__F * var_chaste_interface__membrane__E * var_sodium_calcium_exchange_current__Qn / (var_constants__R * var_constants__T)); // dimensionless
        ...
        const double var_sodium_calcium_exchange_current__k41 = CHASTE_MATH::Exp(-CHASTE_CONST(0.5) * var_constants__F * var_chaste_interface__membrane__E * var_sodium_calcium_exchange_current__Qn / (var_constants__R * var_constants__T)); // dimensionless
        ...
        const double var_sodium_potassium_pump__i_pmax = CHASTE_CONST(0.22600000000000001); // picoA
        const double var_sodium_potassium_pump__i_p = (1 - CHASTE_CONST(0.035938096628557313) * CHASTE_MATH::Pow((-1 + CHASTE_CONST(0.025000000000000001) * var_chaste_interface__membrane__E), 2)) * var_chaste_interface__ion_concentrations__Ko * var_chaste_interface__ion_concentrations__Nai * var_sodium_potassium_pump__i_pmax / ((var_chaste_interface__ion_concentrations__Ko + var_sodium_potassium_pump__KmK) * (var_chaste_interface__ion_concentrations__Nai + var_sodium_potassium_pump__KmNa)); // picoA
        ...
        const double var_chaste_interface__i_ionic = CHASTE_CONST(9.9999999999999995e-7) * CHASTE_CAP() * var_membrane__i_tot / var_membrane__C_converted; // uA_per_cm2
    ...
    void Celldokos_model_1996FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_L_type_calcium_current_d_gate__tau_dL = CHASTE_CONST(0.002); // second
        ...
        const double d_dt_chaste_interface_var_L_type_calcium_current_f2_gate__fL2 = CHASTE_CONST(0.001) * var_L_type_calcium_current_f2_gate__fL2_orig_deriv; // 1 / millisecond
        const double var_ion_concentrations__Kb = CHASTE_CONST(5.4000000000000004); // millimolar
        const double var_ion_concentrations__Nab = 140; // millimolar
        const double var_ion_concentrations__V_i = CHASTE_CONST(2.5000000000000002e-6); // microlitre
        const double var_ion_concentrations__V_e = CHASTE_CONST(0.20000000000000001) * var_ion_concentrations__V_i; // microlitre
        const double var_ion_concentrations__tau_b = CHASTE_CONST(0.10000000000000001); // second
        const double var_L_type_calcium_current_d_gate__dL_infinity = 1 / (1 + CHASTE_MATH::Exp(-1 - CHASTE_CONST(0.15151515151515152) * var_chaste_interface__membrane__E)); // dimensionless
        ...
        const double d_dt_chaste_interface_var_L_type_calcium_current_d_gate__dL = CHASTE_CONST(0.001) * var_L_type_calcium_current_d_gate__dL_orig_deriv; // 1 / millisecond
        const double var_L_type_calcium_current_f_gate__fL_infinity = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(4.166666666666667) + CHASTE_CONST(0.16666666666666666) * var_chaste_interface__membrane__E)); // dimensionless
        const double var_L_type_calcium_current_f_gate__tau_fL = CHASTE_CONST(0.031) + 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(4.6419753086419755) + CHASTE_CONST(0.1234567901234568) * var_chaste_interface__membrane__E)); // second
        ...
        const double d_dt_chaste_interface_var_L_type_calcium_current_f_gate__fL = CHASTE_CONST(0.001) * var_L_type_calcium_current_f_gate__fL_orig_deriv; // 1 / millisecond
        const double var_T_type_calcium_current_d_gate__dT_infinity = 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(3.7704918032786887) - CHASTE_CONST(0.16393442622950821) * var_chaste_interface__membrane__E)); // dimensionless
        const double var_T_type_calcium_current_d_gate__tau_dT = CHASTE_CONST(0.00059999999999999995) + CHASTE_CONST(0.0054000000000000003) / (1 + CHASTE_MATH::Exp(3 + CHASTE_CONST(0.029999999999999999) * var_chaste_interface__membrane__E)); // second
        ...
        const double d_dt_chaste_interface_var_T_type_calcium_current_d_gate__dT = CHASTE_CONST(0.001) * var_T_type_calcium_current_d_gate__dT_orig_deriv; // 1 / millisecond
        const double var_T_type_calcium_current_f_gate__fT_infinity = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(11.363636363636365) + CHASTE_CONST(0.15151515151515152) * var_chaste_interface__membrane__E)); // dimensionless
        const double var_T_type_calcium_current_f_gate__tau_fT = CHASTE_CONST(0.001) + CHASTE_CONST(0.040000000000000001) / (1 + CHASTE_MATH::Exp(CHASTE_CONST(5.2000000000000002) + CHASTE_CONST(0.080000000000000002) * var_chaste_interface__membrane__E)); // second
        ...
        const double d_dt_chaste_interface_var_T_type_calcium_current_f_gate__fT = CHASTE_CONST(0.001) * var_T_type_calcium_current_f_gate__fT_orig_deriv; // 1 / millisecond
        const double var_background_potassium_current__i_bK = CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(0.40999999999999998)) * (-var_chaste_interface__ion_concentrations__Ko * CHASTE_MATH::Exp(-var_constants__F * var_chaste_interface__membrane__E / (var_constants__R * var_constants__T)) + var_chaste_interface__ion_concentrations__Ki) * var_background_potassium_current__KbK; // picoA
        const double var_delayed_rectifying_potassium_current__i_KK = CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(0.58999999999999997)) * (-var_chaste_interface__ion_concentrations__Ko * CHASTE_MATH::Exp(-var_constants__F * var_chaste_interface__membrane__E / (var_constants__R * var_constants__T)) + var_chaste_interface__ion_concentrations__Ki) * NV_Ith_S(mParameters, 3) * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x; // picoA
        const double var_delayed_rectifying_potassium_current__i_KNa = CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(0.58999999999999997)) * (-var_chaste_interface__ion_concentrations__Nao * CHASTE_MATH::Exp(-var_constants__F * var_chaste_interface__membrane__E / (var_constants__R * var_constants__T)) + var_chaste_interface__ion_concentrations__Nai) * NV_Ith_S(mParameters, 3) * var_delayed_rectifying_potassium_current__P_KNa * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x; // picoA
        const double var_delayed_rectifying_potassium_current_x_gate__tau_x = 1 / (17 * CHASTE_MATH::Exp(CHASTE_CONST(0.039800000000000002) * var_chaste_interface__membrane__E) + CHASTE_CONST(0.21099999999999999) * CHASTE_MATH::Exp(-CHASTE_CONST(0.050999999999999997) * var_chaste_interface__membrane__E)); // second
        const double var_delayed_rectifying_potassium_current_x_gate__x_infinity = 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(3.3918918918918921) - CHASTE_CONST(0.13513513513513511) * var_chaste_interface__membrane__E)); // dimensionless
        ...
        const double d_dt_chaste_interface_var_delayed_rectifying_potassium_current_x_gate__x = CHASTE_CONST(0.001) * var_delayed_rectifying_potassium_current_x_gate__x_orig_deriv; // 1 / millisecond
        const double var_fast_sodium_current_h_gate__alpha_h = CHASTE_CONST(32.399999999999999) * CHASTE_MATH::Exp(-CHASTE_CONST(13.076000000000002) - CHASTE_CONST(0.14000000000000001) * var_chaste_interface__membrane__E); // per_second
        const double var_fast_sodium_current_h_gate__beta_h = 709 / (1 + CHASTE_CONST(4.2000000000000002) * CHASTE_MATH::Exp(-CHASTE_CONST(2.7239999999999998) - CHASTE_CONST(0.059999999999999998) * var_chaste_interface__membrane__E)); // per_second
        ...
        const double d_dt_chaste_interface_var_hyperpolarising_activated_current_y_gate__y = CHASTE_CONST(0.001) * var_hyperpolarising_activated_current_y_gate__y_orig_deriv; // 1 / millisecond
        const double var_reversal_potentials__E_Ca = CHASTE_CONST(0.5) * var_constants__R * var_constants__T * CHASTE_MATH::Log(var_chaste_interface__ion_concentrations__Cao / var_chaste_interface__ion_concentrations__Cai) / var_constants__F; // millivolt
        const double var_L_type_calcium_current__i_CaL = (75 - var_reversal_potentials__E_Ca + var_chaste_interface__membrane__E) * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_calcium_current_d_gate__dL * var_chaste_interface__L_type_calcium_current_f2_gate__fL2 * var_chaste_interface__L_type_calcium_current_f_gate__fL; // picoA
        const double var_T_type_calcium_current__i_CaT = (75 - var_reversal_potentials__E_Ca + var_chaste_interface__membrane__E) * var_T_type_calcium_current__g_CaT * var_chaste_interface__T_type_calcium_current_d_gate__dT * var_chaste_interface__T_type_calcium_current_f_gate__fT; // picoA
        const double var_reversal_potentials__E_K = var_constants__R * var_constants__T * CHASTE_MATH::Log(var_chaste_interface__ion_concentrations__Ko / var_chaste_interface__ion_concentrations__Ki) / var_constants__F; // millivolt
        ...
        const double var_fast_sodium_current__i_Na = CHASTE_MATH::Pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__E) * NV_Ith_S(mParameters, 4) * var_chaste_interface__fast_sodium_current_h_gate__h; // picoA
        const double var_hyperpolarising_activated_current__i_fNa = CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(1.8300000000000001)) * (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__E) * NV_Ith_S(mParameters, 6) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / (CHASTE_MATH::Pow(var_hyperpolarising_activated_current__Kmf, CHASTE_CONST(1.8300000000000001)) + CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(1.8300000000000001))); // picoA
        const double var_sarcoplasmic_reticulum_kinetics__KmCarel = CHASTE_CONST(0.001); // millimolar
        const double var_sarcoplasmic_reticulum_kinetics__KmCaup = CHASTE_CONST(0.00050000000000000001); // millimolar
        const double var_sarcoplasmic_reticulum_kinetics__V_rel = CHASTE_CONST(0.0060000000000000001) * var_ion_concentrations__V_i; // microlitre
        const double var_sarcoplasmic_reticulum_kinetics__V_up = CHASTE_CONST(0.014) * var_ion_concentrations__V_i; // microlitre
        const double var_sarcoplasmic_reticulum_kinetics__i_up_max = CHASTE_CONST(0.0212); // picoA
        const double var_sarcoplasmic_reticulum_kinetics__i_up = CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Cai, 2) * var_sarcoplasmic_reticulum_kinetics__i_up_max / (CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Cai, 2) + CHASTE_MATH::Pow(var_sarcoplasmic_reticulum_kinetics__KmCaup, 2)); // picoA
        const double var_sarcoplasmic_reticulum_kinetics__tau_rel = CHASTE_CONST(0.0050000000000000001); // second
        const double var_sarcoplasmic_reticulum_kinetics__i_rel = 2 * CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Cai, 2) * var_constants__F * var_chaste_interface__ion_concentrations__Carel * var_sarcoplasmic_reticulum_kinetics__V_rel / ((CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Cai, 2) + CHASTE_MATH::Pow(var_sarcoplasmic_reticulum_kinetics__KmCarel, 2)) * var_sarcoplasmic_reticulum_kinetics__tau_rel); // picoA
        const double var_sarcoplasmic_reticulum_kinetics__tau_tr = CHASTE_CONST(0.40000000000000002); // second
        ...
        const double var_ion_concentrations__Carel_orig_deriv = CHASTE_CONST(0.5) * (-var_sarcoplasmic_reticulum_kinetics__i_rel + var_sarcoplasmic_reticulum_kinetics__i_tr) / (var_constants__F * var_sarcoplasmic_reticulum_kinetics__V_rel); // millimolar / second
        const double d_dt_chaste_interface_var_ion_concentrations__Carel = CHASTE_CONST(0.001) * var_ion_concentrations__Carel_orig_deriv; // millimolar / millisecond
        const double var_ion_concentrations__Caup_orig_deriv = CHASTE_CONST(0.5) * (-var_sarcoplasmic_reticulum_kinetics__i_tr + var_sarcoplasmic_reticulum_kinetics__i_up) / (var_constants__F * var_sarcoplasmic_reticulum_kinetics__V_up); // millimolar / second
        const double d_dt_chaste_interface_var_ion_concentrations__Caup = CHASTE_CONST(0.001) * var_ion_concentrations__Caup_orig_deriv; // millimolar / millisecond
        const double var_sodium_calcium_exchange_current__K1ni = CHASTE_CONST(395.30000000000001); // millimolar
        const double var_sodium_calcium_exchange_current__K1no = 1628; // millimolar
        const double var_sodium_calcium_exchange_current__K2ni = CHASTE_CONST(2.2890000000000001); // millimolar
        const double var_sodium_calcium_exchange_current__K2no = CHASTE_CONST(561.39999999999998); // millimolar
        ...
        const double var_sodium_calcium_exchange_current__x4 = (var_sodium_calcium_exchange_current__k12 + var_sodium_calcium_exchange_current__k14) * var_sodium_calcium_exchange_current__k23 * var_sodium_calcium_exchange_current__k34 + (var_sodium_calcium_exchange_current__k32 + var_sodium_calcium_exchange_current__k34) * var_sodium_calcium_exchange_current__k14 * var_sodium_calcium_exchange_current__k21; // dimensionless
        const double var_sodium_calcium_exchange_current__i_NaCa = (var_sodium_calcium_exchange_current__k21 * var_sodium_calcium_exchange_current__x2 - var_sodium_calcium_exchange_current__k12 * var_sodium_calcium_exchange_current__x1) * var_sodium_calcium_exchange_current__kNaCa / (var_sodium_calcium_exchange_current__x1 + var_sodium_calcium_exchange_current__x2 + var_sodium_calcium_exchange_current__x3 + var_sodium_calcium_exchange_current__x4); // picoA
        const double var_ion_concentrations__Cai_orig_deriv = -CHASTE_CONST(0.5) * (-var_sarcoplasmic_reticulum_kinetics__i_rel - 2 * var_sodium_calcium_exchange_current__i_NaCa + var_L_type_calcium_current__i_CaL + var_T_type_calcium_current__i_CaT + var_sarcoplasmic_reticulum_kinetics__i_up) / (var_constants__F * var_ion_concentrations__V_i); // millimolar / second
        const double d_dt_chaste_interface_var_ion_concentrations__Cai = CHASTE_CONST(0.001) * var_ion_concentrations__Cai_orig_deriv; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_ion_concentrations__Cao = CHASTE_CONST(0.001) * var_ion_concentrations__Cao_orig_deriv; // millimolar / millisecond
        const double var_sodium_potassium_pump__KmK = 1; // millimolar
        const double var_sodium_potassium_pump__KmNa = 40; // millimolar
        const double var_sodium_potassium_pump__i_pmax = CHASTE_CONST(0.22600000000000001); // picoA
        const double var_sodium_potassium_pump__i_p = (1 - CHASTE_CONST(0.035938096628557313) * CHASTE_MATH::Pow((-1 + CHASTE_CONST(0.025000000000000001) * var_chaste_interface__membrane__E), 2)) * var_chaste_interface__ion_concentrations__Ko * var_chaste_interface__ion_concentrations__Nai * var_sodium_potassium_pump__i_pmax / ((var_chaste_interface__ion_concentrations__Ko + var_sodium_potassium_pump__KmK) * (var_chaste_interface__ion_concentrations__Nai + var_sodium_potassium_pump__KmNa)); // picoA
        ...
        const double d_dt_chaste_interface_var_ion_concentrations__Ki = CHASTE_CONST(0.001) * var_ion_concentrations__Ki_orig_deriv; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_ion_concentrations__Ko = CHASTE_CONST(0.001) * var_ion_concentrations__Ko_orig_deriv; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_ion_concentrations__Nai = CHASTE_CONST(0.001) * var_ion_concentrations__Nai_orig_deriv; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface_var_ion_concentrations__Nao = CHASTE_CONST(0.001) * var_ion_concentrations__Nao_orig_deriv; // millimolar / millisecond
        ...
        else
        {
            ...
            if (mDataClampIsOn)
            {
                var_chaste_interface__membrane_data_clamp_current = (-CHASTE_EXP_VOLT(var_chaste_interface__environment__time_converted) + var_chaste_interface__membrane__E) * NV_Ith_S(mParameters, 2); // uA_per_cm2
            }
            ...
            d_dt_chaste_interface_var_membrane__E = CHASTE_CONST(0.001) * var_membrane__E_orig_deriv; // millivolt / millisecond
        }
    ...
    N_Vector Celldokos_model_1996FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        ...
        const double var_delayed_rectifying_potassium_current__i_KNa = CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(0.58999999999999997)) * (-var_chaste_interface__ion_concentrations__Nao * CHASTE_MATH::Exp(-var_constants__F * var_chaste_interface__membrane__E / (var_constants__R * var_constants__T)) + var_chaste_interface__ion_concentrations__Nai) * NV_Ith_S(mParameters, 3) * var_delayed_rectifying_potassium_current__P_KNa * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x; // picoA
        const double var_delayed_rectifying_potassium_current__i_K = var_delayed_rectifying_potassium_current__i_KK + var_delayed_rectifying_potassium_current__i_KNa; // picoA
        const double var_delayed_rectifying_potassium_current__i_K_converted = CHASTE_CONST(9.9999999999999995e-7) * CHASTE_CAP() * var_delayed_rectifying_potassium_current__i_K / var_membrane__C_converted; // uA_per_cm2
        // Special handling of data clamp current here
        // (we want to save expense of calling the interpolation method if possible.)
        double var_chaste_interface__membrane_data_clamp_current = 0.0;
        if (mDataClampIsOn)
        ...
        const double var_reversal_potentials__E_Ca = CHASTE_CONST(0.5) * var_constants__R * var_constants__T * CHASTE_MATH::Log(var_chaste_interface__ion_concentrations__Cao / var_chaste_interface__ion_concentrations__Cai) / var_constants__F; // millivolt
        const double var_L_type_calcium_current__i_CaL = (75 - var_reversal_potentials__E_Ca + var_chaste_interface__membrane__E) * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_calcium_current_d_gate__dL * var_chaste_interface__L_type_calcium_current_f2_gate__fL2 * var_chaste_interface__L_type_calcium_current_f_gate__fL; // picoA
        const double var_L_type_calcium_current__i_CaL_converted = CHASTE_CONST(9.9999999999999995e-7) * CHASTE_CAP() * var_L_type_calcium_current__i_CaL / var_membrane__C_converted; // uA_per_cm2
        const double var_reversal_potentials__E_K = var_constants__R * var_constants__T * CHASTE_MATH::Log(var_chaste_interface__ion_concentrations__Ko / var_chaste_interface__ion_concentrations__Ki) / var_constants__F; // millivolt
        const double var_hyperpolarising_activated_current__i_fK = CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(1.8300000000000001)) * (-var_reversal_potentials__E_K + var_chaste_interface__membrane__E) * NV_Ith_S(mParameters, 5) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / (CHASTE_MATH::Pow(var_hyperpolarising_activated_current__Kmf, CHASTE_CONST(1.8300000000000001)) + CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(1.8300000000000001))); // picoA
        const double var_reversal_potentials__E_Na = var_constants__R * var_constants__T * CHASTE_MATH::Log(var_chaste_interface__ion_concentrations__Nao / var_chaste_interface__ion_concentrations__Nai) / var_constants__F; // millivolt
        const double var_fast_sodium_current__i_Na = CHASTE_MATH::Pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__E) * NV_Ith_S(mParameters, 4) * var_chaste_interface__fast_sodium_current_h_gate__h; // picoA
        const double var_fast_sodium_current__i_Na_converted = CHASTE_CONST(9.9999999999999995e-7) * CHASTE_CAP() * var_fast_sodium_current__i_Na / var_membrane__C_converted; // uA_per_cm2
        const double var_hyperpolarising_activated_current__i_fNa = CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(1.8300000000000001)) * (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__E) * NV_Ith_S(mParameters, 6) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / (CHASTE_MATH::Pow(var_hyperpolarising_activated_current__Kmf, CHASTE_CONST(1.8300000000000001)) + CHASTE_MATH::Pow(var_chaste_interface__ion_concentrations__Ko, CHASTE_CONST(1.8300000000000001))); // picoA
        const double var_hyperpolarising_activated_current__i_f = var_hyperpolarising_activated_current__i_fK + var_hyperpolarising_activated_current__i_fNa; // picoA
        const double var_hyperpolarising_activated_current__i_f_converted = CHASTE_CONST(9.9999999999999995e-7) * CHASTE_CAP() * var_hyperpolarising_activated_current__i_f / var_membrane__C_converted; // uA_per_cm2
