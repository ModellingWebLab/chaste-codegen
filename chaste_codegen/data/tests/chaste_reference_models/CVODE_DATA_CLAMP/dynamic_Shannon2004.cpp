...
#include "CvodeContextManager.hpp"
    ...
    void Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_INa_h_gate__alpha_h = ((var_chaste_interface__cell__V < -40) ? (CHASTE_CONST(0.13500000000000001) * CHASTE_MATH::Exp(-CHASTE_CONST(11.764705882352942) + CHASTE_CONST(0.14705882352941177) * NV_Ith_S(mParameters, 17) - CHASTE_CONST(0.14705882352941177) * var_chaste_interface__cell__V)) : (0)); // per_millisecond
        const double var_INa_h_gate__beta_h = ((var_chaste_interface__cell__V < -40) ? (310000 * CHASTE_MATH::Exp(CHASTE_CONST(0.34999999999999998) * var_chaste_interface__cell__V - CHASTE_CONST(0.34999999999999998) * NV_Ith_S(mParameters, 17)) + CHASTE_CONST(3.5600000000000001) * CHASTE_MATH::Exp(CHASTE_CONST(0.079000000000000001) * var_chaste_interface__cell__V - CHASTE_CONST(0.079000000000000001) * NV_Ith_S(mParameters, 17))) : (CHASTE_CONST(7.6923076923076916) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(0.96036036036036043) + CHASTE_CONST(0.0900900900900901) * NV_Ith_S(mParameters, 17) - CHASTE_CONST(0.0900900900900901) * var_chaste_interface__cell__V)))); // per_millisecond
        const double var_INa_h_gate__h_infinity = CHASTE_CONST(0.01) * NV_Ith_S(mParameters, 16) + (1 - CHASTE_CONST(0.01) * NV_Ith_S(mParameters, 16)) * var_INa_h_gate__alpha_h / (var_INa_h_gate__alpha_h + var_INa_h_gate__beta_h); // dimensionless
        ...
        const double var_INa_j_gate__j_infinity = CHASTE_CONST(0.01) * NV_Ith_S(mParameters, 16) + (1 - CHASTE_CONST(0.01) * NV_Ith_S(mParameters, 16)) * var_INa_j_gate__alpha_j / (var_INa_j_gate__alpha_j + var_INa_j_gate__beta_j); // dimensionless
        ...
        const double var_INaK__i_NaK_SL = var_INaK__Fx_NaK_SL * var_INaK__I_NaK_max * var_INaK__Q_NaK * var_INaK__f_NaK * NV_Ith_S(mParameters, 8) / ((1 + CHASTE_MATH::Pow((var_INaK__Km_Nai * var_INaK__Q_Km_Nai / var_chaste_interface__Na_buffer__Na_SL), var_INaK__H_NaK)) * (var_INaK__Km_Ko + NV_Ith_S(mParameters, 8))); // microA_per_microF
        const double var_INaK__i_NaK_jct = var_INaK__Fx_NaK_jct * var_INaK__I_NaK_max * var_INaK__Q_NaK * var_INaK__f_NaK * NV_Ith_S(mParameters, 8) / ((1 + CHASTE_MATH::Pow((var_INaK__Km_Nai * var_INaK__Q_Km_Nai / var_chaste_interface__Na_buffer__Na_jct), var_INaK__H_NaK)) * (var_INaK__Km_Ko + NV_Ith_S(mParameters, 8))); // microA_per_microF
        const double var_Jpump_SR__Q_SRCaP = CHASTE_MATH::Pow(var_Jpump_SR__Q10_SRCaP, (-31 + CHASTE_CONST(0.10000000000000001) * NV_Ith_S(mParameters, 24))); // dimensionless
