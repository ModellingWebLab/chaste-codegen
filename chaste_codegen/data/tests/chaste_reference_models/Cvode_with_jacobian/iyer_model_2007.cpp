...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliyer_model_2007FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x78 = 0.3157689178193962 * var_x77 - 0.093489896373056991 * var_x73 - 6.6941504319201126 * var_x74 - 0.49683202072538851 * var_x75 - 2.0706890167875649 * var_x76 - 0.00015031321966819388 * var_x68;
        ...
        const double var_x101 = 1.9425621197603174e-5 * var_x77 - 0.00012738562343605624 * var_x76 - 3.0564346548418563e-5 * var_x75 - 9.2470395326765519e-9 * var_x68 - 5.7513555333045694e-6 * var_x73 - 0.00041181390311704764 * var_x74;
        ...
        const double var_x154 = exp(-0.41999999999999998 + 0.012 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x155 = 0.095846399999999998 * var_x154;
        const double var_x156 = var_x155 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C0;
        const double var_x157 = exp(1.4300000000000002 - 0.065000000000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x158 = 0.0057330000000000002 * var_x157;
        ...
        const double var_x161 = 7.9871999999999996 * var_x154;
        const double var_x162 = -var_x161;
        const double var_x163 = 0.088200000000000001 * var_x157;
        const double var_x164 = 0.011466 * var_x157;
        const double var_x165 = 0.071884799999999999 * var_x154;
        ...
        const double var_x168 = -var_x163;
        const double var_x169 = 5.9903999999999993 * var_x154;
        const double var_x170 = 0.1764 * var_x157;
        const double var_x171 = 0.017199000000000002 * var_x157;
        const double var_x172 = 0.047923199999999999 * var_x154;
        ...
        const double var_x177 = 3.9935999999999998 * var_x154;
        const double var_x178 = -var_x177;
        const double var_x179 = 0.2646 * var_x157;
        const double var_x180 = 0.022932000000000001 * var_x157 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C4;
        const double var_x181 = 0.0239616 * var_x154;
        ...
        const double var_x184 = 1.9967999999999999 * var_x154;
        const double var_x185 = 0.3528 * var_x157;
        ...
        const double var_x188 = 0.1916928 * var_x154 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa0;
        const double var_x189 = 0.0028665000000000001 * var_x157;
        const double var_x190 = 15.974399999999999 * var_x154;
        const double var_x191 = 0.0441 * var_x157;
        const double var_x192 = 0.1437696 * var_x154;
        const double var_x193 = 11.980799999999999 * var_x154;
        const double var_x194 = 0.0085995000000000012 * var_x157;
        const double var_x195 = 0.1323 * var_x157;
        const double var_x196 = var_x164 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa4;
        ...
        const double var_x200 = 0.0077904657073700001 * var_x199;
        const double var_x201 = exp(-0.18053804430634462 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x202 = 0.5 + var_x201;
        const double var_x203 = 0.0033633620945199998 / var_x202;
        ...
        const double var_x206 = exp(-0.00037301599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x207 = 1.8592012678400001e-5 * var_x206;
        ...
        const double var_x212 = 0.00081948199999999996 * var_x208;
        const double var_x213 = 2.1748319999999999 * var_x210;
        const double var_x214 = 0.080185000000000006 * var_x204;
        const double var_x215 = 0.049842400000000002 * var_x206;
        const double var_x216 = 0.0075123241690000005 * var_x204;
        const double var_x217 = 2.7448243264023812e-6 * var_x206;
        const double var_x218 = 8.3392179730847992e-11 * var_x208;
        const double var_x219 = 0.047274866891999993 * var_x210;
        const double var_x220 = 0.0015517711151999999 * var_x208;
        const double var_x221 = 1.6311239999999998 * var_x210;
        const double var_x222 = 0.16037000000000001 * var_x204;
        const double var_x223 = 0.0073584627104531205 * var_x206;
        const double var_x224 = 0.011268486253500002 * var_x204;
        const double var_x225 = 1.190172890246627e-6 * var_x206;
        const double var_x226 = 6.2643871845094088e-10 * var_x208;
        const double var_x227 = 0.031516577927999993 * var_x210;
        const double var_x228 = 0.011656842546537791 * var_x208;
        const double var_x229 = 1.0874159999999999 * var_x210;
        const double var_x230 = 0.24055500000000002 * var_x204;
        const double var_x231 = 0.0031906751727717496 * var_x206;
        const double var_x232 = 6.466053749793811e-7 * var_x206;
        const double var_x233 = 0.015024648338000001 * var_x204;
        const double var_x234 = 6.9834511318773689e-9 * var_x208;
        const double var_x235 = 0.015758288963999997 * var_x210;
        const double var_x236 = 0.12994884875097448 * var_x208;
        const double var_x237 = 0.54370799999999997 * var_x210;
        const double var_x238 = 0.32074000000000003 * var_x204;
        const double var_x239 = 0.0017334521172801731 * var_x206;
        const double var_x240 = 3.5441967137821161e-8 * var_x206;
        const double var_x241 = 6.2947815902170839e-9 * var_x208;
        const double var_x242 = 0.11713400800552819 * var_x208;
        const double var_x243 = 9.5014602960251466e-5 * var_x206;
        const double var_x244 = 0.00198360904335657 * var_x204;
        const double var_x245 = 0.42695382052749886 * var_x210;
        const double var_x246 = 14.731181055359999 * var_x210;
        const double var_x247 = 0.042345268272074361 * var_x204;
        const double var_x248 = 0.0010000484785595239 * var_x204;
        const double var_x249 = 0.10902718902100607 * var_x210;
        const double var_x250 = 3.7617634137599998 * var_x210;
        const double var_x251 = 0.021348622729620501 * var_x204;
        const double var_x252 = 0.0010108205748447618 * var_x204;
        const double var_x253 = 0.058010926130094308 * var_x210;
        const double var_x254 = 2.0015500855706554 * var_x210;
        const double var_x255 = 0.021578581001175438 * var_x204;
        const double var_x256 = 0.016668393642939261 * var_x204;
        const double var_x257 = 0.2874951693560841 * var_x210;
        const double var_x258 = 9.9194413744637924 * var_x210;
        const double var_x259 = 0.35582999726621212 * var_x204;
        const double var_x260 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x261 = 0.056565877361888978 * var_x260 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C0Kv14;
        ...
        const double var_x264 = 7.3600965821599997 * var_x260;
        const double var_x265 = 0.010817483399999999 * var_x262;
        const double var_x266 = 0.0016860947805433461 * var_x262;
        const double var_x267 = 0.042424408021416733 * var_x260;
        const double var_x268 = 5.5200724366199996 * var_x260;
        const double var_x269 = 0.021634966799999999 * var_x262;
        const double var_x270 = 0.0025291421708150191 * var_x262;
        const double var_x271 = 0.028282938680944489 * var_x260;
        const double var_x272 = 3.6800482910799999 * var_x260;
        const double var_x273 = 0.032452450199999996 * var_x262;
        const double var_x274 = 0.0033721895610866921 * var_x262 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
        const double var_x275 = 0.014141469340472244 * var_x260;
        const double var_x276 = 1.8400241455399999 * var_x260;
        const double var_x277 = 0.043269933599999998 * var_x262;
        const double var_x278 = 0.057102035392881494 * var_x260 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI0Kv14;
        const double var_x279 = 0.0016068735371190899 * var_x262;
        const double var_x280 = 7.4298590445392074 * var_x260;
        const double var_x281 = 0.020618446856331008 * var_x262;
        const double var_x282 = 5.0494790920257417e-5 * var_x262;
        const double var_x283 = 0.049212749503964481 * var_x260;
        const double var_x284 = 6.4033407827395079 * var_x260;
        const double var_x285 = 0.00064791916666788224 * var_x262;
        const double var_x286 = 4.7206750348744694e-5 * var_x262;
        const double var_x287 = 0.015434242075859545 * var_x260;
        const double var_x288 = 2.0082338973371909 * var_x260;
        const double var_x289 = 0.00060572898292340319 * var_x262;
        const double var_x290 = 5.7810813021376416e-5 * var_x262 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OIKv14;
        const double var_x291 = 0.04692272136005015 * var_x260;
        const double var_x292 = 6.1053726595326019 * var_x260;
        const double var_x293 = 0.00074179401705723534 * var_x262;
        const double var_x294 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x295 = 384756192.24456543 * var_x294 * var_chaste_interface__INa__na1;
        const double var_x296 = exp(-26.232056238852348 - 0.090161609404259865 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x297 = 767594485.71651864 * var_x296;
        const double var_x298 = exp(-23.156677820503301);
        const double var_x299 = 8513540195.0827656 * var_x298;
        const double var_x300 = 34054160780.331062 * var_x294;
        const double var_x301 = 8513540195.0827656 * var_x296;
        const double var_x302 = exp(-24.35183300086069);
        const double var_x303 = 8513540195.0827656 * var_x302;
        const double var_x304 = 1535188971.4330373 * var_x296;
        const double var_x305 = 288567144.18342406 * var_x294;
        const double var_x306 = 11922585210.267752 * var_x298;
        const double var_x307 = 25540620585.248295 * var_x294;
        const double var_x308 = 17027080390.165531 * var_x296;
        const double var_x309 = 6079249204.347868 * var_x302;
        const double var_x310 = 2302783457.1495562 * var_x296;
        const double var_x311 = 192378096.12228271 * var_x294;
        const double var_x312 = 16696701353.239271 * var_x298;
        const double var_x313 = 17027080390.165531 * var_x294;
        const double var_x314 = 25540620585.248295 * var_x296;
        const double var_x315 = 4340999166.2352047 * var_x302;
        const double var_x316 = 3070377942.8660746 * var_x296;
        const double var_x317 = 96189048.061141357 * var_x294;
        const double var_x318 = 23382498943.197018 * var_x298;
        const double var_x319 = 8513540195.0827656 * var_x294;
        const double var_x320 = 34054160780.331062 * var_x296;
        const double var_x321 = 3099769910.3661275 * var_x302;
        const double var_x322 = exp(-27.092641999412571 - 0.061469636400174388 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x323 = 523324220.27000725 * var_x322;
        const double var_x324 = exp(-26.358496255772213 - 0.068762962366201316 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x325 = 585416244.0376184 * var_x324 * var_chaste_interface__INa__na7;
        ...
        const double var_x332 = 8513540195.0827656 * var_x328;
        const double var_x333 = 8513540195.0827656 * var_x322;
        const double var_x334 = 8513540195.0827656 * var_x324;
        const double var_x335 = 2213447441.3051791 * var_x302;
        const double var_x336 = exp(-39.744904705650839 + 0.0027019947965296331 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x337 = 23003541.30715951 * var_x336;
        const double var_x338 = exp(-20.6726464954126 + 0.011394696340402199 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x339 = 97009205.304776609 * var_x338;
        const double var_x340 = 8513540195.0827656 * exp(-26.650781465416159);
        const double var_x341 = 8513540195.0827656 * var_x338;
        const double var_x342 = 8513540195.0827656 * exp(-22.779658962607588);
        const double var_x343 = 8513540195.0827656 * var_x336;
        const double var_x344 = 538822673.3061657 * var_x294 * var_chaste_interface__INa__na8;
        const double var_x345 = 548114892.2335701 * var_x296;
        const double var_x346 = 47690340841.071007 * var_x294;
        const double var_x347 = 6079249204.347868 * var_x296;
        const double var_x348 = 1096229784.4671402 * var_x296;
        const double var_x349 = 404117004.97962433 * var_x294;
        const double var_x350 = 35767755630.803253 * var_x294;
        const double var_x351 = 12158498408.695736 * var_x296;
        const double var_x352 = 1644344676.7007101 * var_x296;
        const double var_x353 = 269411336.65308285 * var_x294;
        const double var_x354 = 23845170420.535503 * var_x294;
        const double var_x355 = 18237747613.043602 * var_x296;
        const double var_x356 = 2192459568.9342804 * var_x296;
        const double var_x357 = 134705668.32654142 * var_x294;
        const double var_x358 = 11922585210.267752 * var_x294;
        const double var_x359 = 24316996817.391472 * var_x296;
        const double var_x360 = exp(-38.483942906307405 - 0.14399668707161886 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x361 = 1225921583.3429821 * var_x360;
        const double var_x362 = exp(-21.949261959797553 + 0.030147161449011892 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x363 = 256659070.76381233 * var_x362;
        const double var_x364 = 8513540195.0827656 * var_x362;
        const double var_x365 = 8513540195.0827656 * var_x360;
        ...
        const double var_x372 = exp(-0.026913854983990002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x373 = 0.0001923883999223735 * var_x372;
        const double var_x374 = exp(6.9808923999999997e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x375 = 2.9856908086401855e-10 * var_x374;
        const double var_x376 = exp(0.026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x377 = 0.0028649222200750738 * var_x376;
        ...
        const double var_x380 = var_x372 * var_x374 * var_x378 / (var_x376 * var_x379);
        const double var_x381 = 1.7628212752661065e-7 * var_x380;
        const double var_x382 = 0.00042769471831999382 * var_x374;
        const double var_x383 = 0.10945626585855089 * var_x376;
        const double var_x384 = 0.0071483033566472664 * var_x372;
        const double var_x385 = 1.6926962184371784e-6 * var_x380;
        const double var_x386 = 0.0015600678590465679 * var_x378;
        const double var_x387 = 0.0032282621593045179 * var_x379;
        ...
        const double var_x400 = 0.00767254363063 * var_x398;
        const double var_x401 = 0.0037973799836799999 * var_x396;
        ...
        IJth(rJacobian, 13, 0) = -var_x156 - var_x158 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1;
        IJth(rJacobian, 14, 0) = var_x156 + (var_x158 - var_x165) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1 - var_x164 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2;
        IJth(rJacobian, 15, 0) = var_x165 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1 + (var_x164 + var_x173) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2 - var_x171 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        IJth(rJacobian, 16, 0) = -var_x180 + var_x172 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2 + (var_x171 - var_x181) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        IJth(rJacobian, 17, 0) = var_x180 + var_x181 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        IJth(rJacobian, 18, 0) = -var_x188 - var_x189 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa1;
        IJth(rJacobian, 19, 0) = var_x188 + (var_x189 - var_x192) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa1 - var_x158 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa2;
        IJth(rJacobian, 20, 0) = var_x192 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa1 + (var_x158 - var_x155) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa2 - var_x194 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa3;
        IJth(rJacobian, 21, 0) = -var_x196 + var_x155 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa2 + (var_x173 + var_x194) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa3;
        IJth(rJacobian, 22, 0) = var_x196 + var_x172 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa3;
        IJth(rJacobian, 24, 0) = (-0.00015735009791355945 * var_x199 + 0.00060721481483873177 * var_x201 / pow(var_x202, 2)) * (0.18000000000000005 - var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa + 0.81999999999999995 / var_x198) - 0.10512820512820513 * var_x197 * (var_x200 + var_x203) / pow(var_x198, 2);
        IJth(rJacobian, 25, 0) = (-var_x209 - var_x211) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 - var_x205 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 - var_x207 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43;
        IJth(rJacobian, 26, 0) = var_x211 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 + (var_x205 - var_x218 - var_x219) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 - var_x216 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 - var_x217 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43;
        IJth(rJacobian, 27, 0) = var_x219 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 + (var_x216 - var_x226 - var_x227) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 - var_x224 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 - var_x225 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43;
        IJth(rJacobian, 28, 0) = var_x227 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 + (var_x224 - var_x234 - var_x235) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 - var_x232 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43 - var_x233 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43;
        IJth(rJacobian, 29, 0) = var_x235 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 + (var_x233 - var_x241) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - var_x240 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OIKv43;
        IJth(rJacobian, 30, 0) = var_x209 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 + (var_x207 - var_x245) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 - var_x244 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43;
        IJth(rJacobian, 31, 0) = var_x218 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 + var_x245 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 + (var_x217 + var_x244 - var_x249) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 - var_x248 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43;
        IJth(rJacobian, 32, 0) = var_x226 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 + var_x249 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 + (var_x225 + var_x248 - var_x253) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43 - var_x252 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43;
        IJth(rJacobian, 33, 0) = var_x234 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 + var_x253 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43 + (var_x232 + var_x252 - var_x257) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43 - var_x256 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OIKv43;
        IJth(rJacobian, 34, 0) = var_x241 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 + var_x257 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43 + (var_x240 + var_x256) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OIKv43;
        IJth(rJacobian, 35, 0) = -var_x261 - var_x263 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C1Kv14;
        IJth(rJacobian, 36, 0) = var_x261 + (var_x263 - var_x267) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C1Kv14 - var_x266 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C2Kv14;
        IJth(rJacobian, 37, 0) = var_x267 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C1Kv14 + (var_x266 - var_x271) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C2Kv14 - var_x270 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C3Kv14;
        IJth(rJacobian, 38, 0) = -var_x274 + var_x271 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C2Kv14 + (var_x270 - var_x275) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C3Kv14;
        IJth(rJacobian, 39, 0) = var_x274 + var_x275 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C3Kv14;
        IJth(rJacobian, 40, 0) = -var_x278 - var_x279 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI1Kv14;
        IJth(rJacobian, 41, 0) = var_x278 + (var_x279 - var_x283) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI1Kv14 - var_x282 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI2Kv14;
        IJth(rJacobian, 42, 0) = var_x283 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI1Kv14 + (var_x282 - var_x287) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI2Kv14 - var_x286 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI3Kv14;
        IJth(rJacobian, 43, 0) = -var_x290 + var_x287 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI2Kv14 + (var_x286 - var_x291) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI3Kv14;
        IJth(rJacobian, 44, 0) = var_x290 + var_x291 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI3Kv14;
        IJth(rJacobian, 45, 0) = -var_x295 - var_x297 * var_chaste_interface__INa__na2;
        IJth(rJacobian, 46, 0) = var_x295 + (var_x297 - var_x305) * var_chaste_interface__INa__na2 - var_x304 * var_chaste_interface__INa__na3;
        IJth(rJacobian, 47, 0) = var_x305 * var_chaste_interface__INa__na2 + (var_x304 - var_x311) * var_chaste_interface__INa__na3 - var_x310 * var_chaste_interface__INa__na4;
        IJth(rJacobian, 48, 0) = var_x311 * var_chaste_interface__INa__na3 + (var_x310 - var_x317) * var_chaste_interface__INa__na4 - var_x316 * var_chaste_interface__INa__na5;
        IJth(rJacobian, 49, 0) = -var_x325 + var_x317 * var_chaste_interface__INa__na4 + (var_x316 - var_x327 - var_x329) * var_chaste_interface__INa__na5 - var_x323 * var_chaste_interface__INa__na6;
        IJth(rJacobian, 50, 0) = var_x329 * var_chaste_interface__INa__na5 + var_x337 * var_chaste_interface__INa__na13 + (var_x323 - var_x339) * var_chaste_interface__INa__na6;
        IJth(rJacobian, 51, 0) = var_x325 + var_x327 * var_chaste_interface__INa__na5;
        IJth(rJacobian, 52, 0) = -var_x344 - var_x345 * var_chaste_interface__INa__na9;
        IJth(rJacobian, 53, 0) = var_x344 + (var_x345 - var_x349) * var_chaste_interface__INa__na9 - var_x348 * var_chaste_interface__INa__na10;
        IJth(rJacobian, 54, 0) = var_x349 * var_chaste_interface__INa__na9 + (var_x348 - var_x353) * var_chaste_interface__INa__na10 - var_x352 * var_chaste_interface__INa__na11;
        IJth(rJacobian, 55, 0) = var_x353 * var_chaste_interface__INa__na10 + (var_x352 - var_x357) * var_chaste_interface__INa__na11 - var_x356 * var_chaste_interface__INa__na12;
        IJth(rJacobian, 56, 0) = var_x357 * var_chaste_interface__INa__na11 + (var_x356 - var_x363) * var_chaste_interface__INa__na12 - var_x361 * var_chaste_interface__INa__na13;
        IJth(rJacobian, 57, 0) = var_x339 * var_chaste_interface__INa__na6 + var_x363 * var_chaste_interface__INa__na12 + (var_x361 - var_x337) * var_chaste_interface__INa__na13;
        IJth(rJacobian, 58, 0) = -var_x367 - var_x369;
        IJth(rJacobian, 59, 0) = var_x367 + var_x369;
        IJth(rJacobian, 60, 0) = (-var_x375 - var_x377) * var_chaste_interface__IKr__C3Herg - var_x373 * var_chaste_interface__IKr__OHerg - var_x381 * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 61, 0) = var_x377 * var_chaste_interface__IKr__C3Herg + (var_x373 - var_x387) * var_chaste_interface__IKr__OHerg - var_x386 * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 62, 0) = var_x375 * var_chaste_interface__IKr__C3Herg + var_x387 * var_chaste_interface__IKr__OHerg + (var_x381 + var_x386) * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 63, 0) = -var_x391;
        IJth(rJacobian, 64, 0) = var_x391 - var_x394 * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 65, 0) = -var_x397 + (var_x394 - var_x399) * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 66, 0) = var_x397 + var_x399 * var_chaste_interface__IKs__O1ks;
        ...
        IJth(rJacobian, 14, 14) = var_x168 - var_x167 - var_x169;
        ...
        IJth(rJacobian, 20, 20) = -0.00062500000000000001 + var_x162 + var_x168;
