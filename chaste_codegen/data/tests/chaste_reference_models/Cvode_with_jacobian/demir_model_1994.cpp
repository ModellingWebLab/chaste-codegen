...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldemir_model_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x5 = 0.45836363636363631 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T;
        const double var_x6 = 0.38454545454545452 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        const double var_x7 = 0.34078687761326093 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        ...
        const double var_x20 = -46.399999999999999 + var_chaste_interface__membrane__V;
        ...
        const double var_x38 = exp(var_x30 - 1.0000000000000002 * log(var_x37));
        ...
        const double var_x51 = 0.0002269090909090909 * var_x13;
        const double var_x52 = var_x15 * var_x8;
        const double var_x53 = (var_x18 - var_x16) / pow(var_x12, 2);
        const double var_x54 = 2.269090909090909e-8 * var_x53;
        ...
        const double var_x58 = var_x20 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L;
        const double var_x59 = -45.0 + var_chaste_interface__membrane__V;
        const double var_x60 = var_x59 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T;
        const double var_x61 = 1 / var_chaste_interface__intracellular_concentrations_and_buffer_equations__K_i;
        const double var_x62 = -26.713760659695652 * log(var_x61 * var_chaste_interface__cleft_space_equations__K_c) + var_chaste_interface__membrane__V;
        const double var_x63 = var_x62 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        const double var_x64 = pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 1.0);
        const double var_x65 = var_x64 * (85.0 + var_chaste_interface__membrane__V);
        const double var_x66 = var_x64 * (-75.0 + var_chaste_interface__membrane__V);
        const double var_x67 = pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i, 2.0) * var_chaste_interface__cleft_space_equations__Ca_c;
        const double var_x68 = 6.8072727272727277e-8 * var_x53;
        const double var_x69 = 0.00068072727272727273 * var_x13;
        const double var_x70 = var_x17 * var_x67;
        const double var_x71 = var_x28 / (1.5 + var_x23);
        const double var_x72 = var_x26 * var_x36 * var_x71 * (var_x27 - 0.033543989587945633 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i / pow((1 + 0.18315018315018314 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i), 2));
        const double var_x73 = 225.90303244708579 * var_x43;
        const double var_x74 = var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        const double var_x75 = 9.1036990845256458 * var_x74;
        const double var_x76 = 1 / var_chaste_interface__cleft_space_equations__Na_c;
        const double var_x77 = pow(var_chaste_interface__cleft_space_equations__Na_c, 2.0) * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x78 = var_x15 * var_x77;
        const double var_x79 = var_x39 * var_x42;
        const double var_x80 = 1 / var_chaste_interface__cleft_space_equations__Ca_c;
        const double var_x81 = var_x10 * var_x17;
        const double var_x82 = 1 / var_chaste_interface__cleft_space_equations__K_c;
        const double var_x83 = var_x24 * var_x71 * var_x82 * (var_x25 - var_chaste_interface__cleft_space_equations__K_c / pow(var_x24, 2));
        const double var_x84 = 8.0340203320880944e-5 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T;
        const double var_x85 = 6.7401638248180558e-5 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        const double var_x86 = 9.5000000000000005e-5 + 2.0454545454545457e-6 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_up + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x87 = 1 / var_x86;
        const double var_x88 = (0.080000000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i - 1.4727272727272728e-7 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_up) / pow(var_x86, 2);
        const double var_x89 = 7.9543493648916641e-8 * var_x13;
        const double var_x90 = 7.9543493648916639e-12 * var_x53;
        const double var_x91 = 2.3863048094674991e-7 * var_x13;
        const double var_x92 = 2.3863048094674993e-11 * var_x53;
        const double var_x93 = 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x94 = 0.25 + var_chaste_interface__SR_Ca_uptake_and_release__F2;
        const double var_x95 = 1 / var_x94;
        const double var_x96 = pow((var_x95 * var_chaste_interface__SR_Ca_uptake_and_release__F2), 2.0);
        const double var_x97 = var_x94 * var_x96 * (var_x95 - var_chaste_interface__SR_Ca_uptake_and_release__F2 / pow(var_x94, 2)) * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel / var_chaste_interface__SR_Ca_uptake_and_release__F2;
        const double var_x98 = exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V);
        const double var_x99 = 51.899999999999999 + var_chaste_interface__membrane__V;
        const double var_x100 = -1.0 + var_x98;
        const double var_x101 = 1 / var_x100;
        const double var_x102 = 824.0 * var_x101;
        const double var_x103 = var_x102 * var_x99;
        const double var_x104 = 1 / (-var_x103 + 32960.0 * var_x98);
        const double var_x105 = var_x101 * var_x99;
        const double var_x106 = 92.584269662921344 * var_x98 * var_x99 / pow(var_x100, 2);
        const double var_x107 = (var_x102 + var_x106 + 3703.370786516854 * var_x98) / pow((var_x98 - 0.025000000000000001 * var_x105), 2);
        const double var_x108 = 1.5e-5 + 1.0 * var_x104;
        const double var_x109 = 0.001 / var_x108;
        const double var_x110 = exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V);
        const double var_x111 = 165.0 * var_x110;
        const double var_x112 = 1 / (1.0 + 320.0 * var_x110);
        const double var_x113 = var_x111 + 12360.0 * var_x112;
        const double var_x114 = 1 / var_x113;
        const double var_x115 = var_x111 * var_x114;
        const double var_x116 = 13.095238095238095 * var_x110;
        const double var_x117 = var_x110 / pow((0.0031250000000000002 + var_x110), 2);
        const double var_x118 = 3.0654761904761902 * var_x117;
        const double var_x119 = -0.001 * var_x114 * var_x116 + 1.0800578125490936e-9 * var_x110 * (var_x116 - var_x118) / pow((var_x112 + 0.013349514563106795 * var_x110), 2);
        const double var_x120 = 0.40000000000000002 * var_chaste_interface__membrane__V;
        const double var_x121 = exp(-2.0 + var_x120);
        const double var_x122 = -1.0 + var_x121;
        const double var_x123 = 1 / var_x122;
        const double var_x124 = 11.43 * var_x123;
        const double var_x125 = exp(-14.0 - var_x120);
        const double var_x126 = -1.0 + var_x125;
        const double var_x127 = 1 / var_x126;
        const double var_x128 = 28.390000000000001 * var_x127;
        const double var_x129 = exp(-0.20799999999999999 * var_chaste_interface__membrane__V);
        const double var_x130 = -1.0 + var_x129;
        const double var_x131 = 1 / var_x130;
        const double var_x132 = 84.900000000000006 * var_x131;
        const double var_x133 = -5.0 + var_chaste_interface__membrane__V;
        const double var_x134 = 35.0 + var_chaste_interface__membrane__V;
        const double var_x135 = exp(6.0 + 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x136 = 1.0 + var_x135;
        const double var_x137 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x138 = exp(7.0 + var_x137);
        const double var_x139 = -1.0 + var_x138;
        const double var_x140 = 1 / var_x139;
        const double var_x141 = 3.75 * var_x140;
        const double var_x142 = exp(-7.0 - var_x137);
        const double var_x143 = 1.0 + var_x142;
        const double var_x144 = 28.0 + var_chaste_interface__membrane__V;
        const double var_x145 = 1 / var_x143;
        const double var_x146 = exp(-4.3833333333333337 + var_x1);
        const double var_x147 = 1.0 + var_x146;
        const double var_x148 = 0.033333333333333333 * var_chaste_interface__membrane__V;
        const double var_x149 = exp(0.87666666666666671 + var_x148);
        const double var_x150 = exp(-0.87666666666666671 - var_x148);
        const double var_x151 = exp(11.017857142857144 + 0.17857142857142858 * var_chaste_interface__membrane__V);
        const double var_x152 = 1.0 + var_x151;
        const double var_x153 = exp(4.0117035110533159 + 0.065019505851755519 * var_chaste_interface__membrane__V);
        const double var_x154 = exp(-0.74069627851140463 - 0.012004801920768308 * var_chaste_interface__membrane__V);
        const double var_x155 = exp(-0.68918918918918914 - 0.13513513513513511 * var_chaste_interface__membrane__V);
        const double var_x156 = 1.0 + var_x155;
        const double var_x157 = exp(0.039800000000000002 * var_chaste_interface__membrane__V);
        const double var_x158 = exp(-0.050999999999999997 * var_chaste_interface__membrane__V);
        const double var_x159 = exp(-0.0183 * var_chaste_interface__membrane__V);
        const double var_x160 = exp(0.0094199999999999996 * var_chaste_interface__membrane__V);
        const double var_x161 = exp(8.0222222222222221 + 0.1111111111111111 * var_chaste_interface__membrane__V);
        const double var_x162 = 1.0 + var_x161;
        const double var_x163 = exp(-2.2219482120838472 - 0.041101520756267988 * var_chaste_interface__membrane__V);
        const double var_x164 = exp(-10.909090909090908 - 0.18181818181818182 * var_chaste_interface__membrane__V);
        const double var_x165 = 0.69999999999999996 + var_x164;
        const double var_x166 = 1 / var_x165;
        const double var_x167 = 0.079190817585730572 * var_x40;
        const double var_x168 = 2.3863048094674996e-7 * var_x13;
        const double var_x169 = 2.3863048094674996e-11 * var_x53;
        const double var_x170 = var_x167 * var_x56;
        const double var_x171 = 7.1589144284024993e-11 * var_x53;
        const double var_x172 = 7.1589144284024988e-7 * var_x13;
        const double var_x173 = 0.079190817585730586 * var_x43;
        const double var_x174 = 0.00011946360864812104 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        const double var_x175 = 0.003191322248969453 * var_x74;
        const double var_x176 = -129.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x177 = 0.27076272189238765 * var_x40;
        const double var_x178 = 8.1590568853116704e-7 * var_x13;
        const double var_x179 = 8.159056885311671e-11 * var_x53;
        const double var_x180 = var_x177 * var_x56;
        const double var_x181 = 2.447717065593501e-6 * var_x13;
        const double var_x182 = 2.4477170655935014e-10 * var_x53;
        const double var_x183 = 0.2707627218923877 * var_x43;
        const double var_x184 = 0.00027469260694271797 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T;
        const double var_x185 = 0.00023045413077502912 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        const double var_x186 = 2.7196856284372236e-7 * var_x13;
        const double var_x187 = 2.7196856284372237e-11 * var_x53;
        const double var_x188 = 8.159056885311671e-11 * var_x53;
        const double var_x189 = 8.1590568853116714e-7 * var_x13;
        const double var_x190 = 0.00040846013251011971 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        const double var_x191 = 0.010911506218902909 * var_x74;
        const double var_x192 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x193 = 0.019200000000000002 * var_x192 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        const double var_x194 = 0.0040000000000000001 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x195 = 1 / var_x194;
        const double var_x196 = pow((var_x195 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i), 4.0);
        const double var_x197 = 0.95999999999999996 * var_x194 * var_x196 * var_x49 * (var_x195 - var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i / pow(var_x194, 2));
        const double var_x198 = var_x197 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        const double var_x199 = 0.23999999999999999 * var_x196;
        const double var_x200 = -var_x199;
        const double var_x201 = 0.23999999999999999 * var_x192;
        const double var_x202 = var_x197 * var_chaste_interface__SR_Ca_uptake_and_release__F2;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0048327272727272724 + 8.4564294531513351 * var_x46 - 0.0002269090909090909 * var_x19 - 0.35690727272727274 * var_x0 - 8.4564294531513351 * var_x44 - 0.07085252525252525 * var_x29 - 0.036531818181818179 * var_x4 - 0.0060886363636363629 * var_x22 - var_x35 * var_x41 - var_x5 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T - var_x6 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L - var_x7 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a);
        IJth(rJacobian, 1, 0) = -1.1600092823800343e-7 + 7.9543493648916641e-8 * var_x19 - 1.0671926055961921e-6 * var_x22 - 6.4031556335771533e-6 * var_x4 - var_x84 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T - var_x85 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L;
        IJth(rJacobian, 2, 0) = var_x109 * (-var_x102 * var_x104 - var_x104 * var_x106 - 7.5849514563106801e-7 * var_x105 * var_x107) - 9.2050381751343198e-13 * var_x107 * (-var_chaste_interface__sodium_current_m_gate__m - var_x103 * var_x104) / pow(var_x108, 2);
        IJth(rJacobian, 3, 0) = var_x113 * var_x119 + 0.001 * (var_x115 - var_chaste_interface__sodium_current_h_gate__h1) * (var_x118 - var_x116);
        IJth(rJacobian, 4, 0) = var_x119 * (8.25 * var_x110 + 618.0 * var_x112) + 0.001 * (var_x115 - var_chaste_interface__sodium_current_h_gate__h2) * (0.15327380952380951 * var_x117 - 0.65476190476190477 * var_x110);
        IJth(rJacobian, 5, 0) = 0.001 * (-var_chaste_interface__L_type_Ca_channel_d_gate__d_L + 1.0 * var_x4) * (var_x124 - var_x128 - var_x132 - 17.659200000000002 * var_x129 * var_chaste_interface__membrane__V / pow(var_x130, 2) - 4.5720000000000001 * var_x121 * var_x133 / pow(var_x122, 2) - 11.356000000000002 * var_x125 * var_x134 / pow(var_x126, 2)) + 0.00016666666666666666 * var_x21 * (var_x124 * var_x133 - var_x128 * var_x134 - var_x132 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 6, 0) = 0.001 * (-var_chaste_interface__L_type_Ca_channel_f_gate__f_L + 1.0 / var_x136) * (var_x141 + 7.5 * var_x142 / pow(var_x143, 2) - 0.9375 * var_x138 * var_x144 / pow(var_x139, 2)) - 0.00020000000000000001 * var_x135 * (30.0 * var_x145 + var_x141 * var_x144) / pow(var_x136, 2);
        IJth(rJacobian, 7, 0) = 0.001 * (-var_chaste_interface__T_type_Ca_channel_d_gate__d_T + 1.0 / var_x147) * (35.600000000000001 * var_x149 - 35.600000000000001 * var_x150) + 0.00016666666666666666 * var_x146 * (1068.0 * var_x149 + 1068.0 * var_x150) / pow(var_x147, 2);
        IJth(rJacobian, 8, 0) = 0.001 * (-var_chaste_interface__T_type_Ca_channel_f_gate__f_T + 1.0 / var_x152) * (0.97529258777633276 * var_x153 - 0.18367346938775511 * var_x154) - 0.00017857142857142857 * var_x151 * (15.0 * var_x153 + 15.300000000000001 * var_x154) / pow(var_x152, 2);
        IJth(rJacobian, 9, 0) = 0.001 * (-var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a + 1.0 / var_x156) * (0.67660000000000009 * var_x157 - 0.10760999999999998 * var_x158) + 0.00013513513513513511 * var_x155 * (17.0 * var_x157 + 2.1099999999999999 * var_x158) / pow(var_x156, 2);
        IJth(rJacobian, 10, 0) = -0.00183 * var_x159 * (1.0 - var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i) - 0.00617952 * var_x160 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        IJth(rJacobian, 11, 0) = 0.001 * (-var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + 1.0 / var_x162) * (-0.067747636662556524 * var_x163 + 2.5473727272727276 * var_x164 / pow(var_x165, 2)) - 0.0001111111111111111 * var_x161 * (1.6483000000000001 * var_x163 + 14.01055 * var_x166) / pow(var_x162, 2);
        IJth(rJacobian, 12, 0) = -1.0197883801143159e-6 + 0.0029644204196681906 * var_x46 - 4.3008300195846133e-5 * var_x0 - 2.3863048094674996e-7 * var_x19 - 7.4512537640352696e-5 * var_x29 - 0.0029644204196681906 * var_x44 - var_x167 * var_x35;
        IJth(rJacobian, 13, 0) = -4.4233320987458456e-7 + 4.967502509356846e-5 * var_x29 - 8.2106349321691435e-5 * var_x0 - var_x174 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        IJth(rJacobian, 18, 0) = 3.486776446714389e-6 + 0.00014705043816962094 * var_x0 + 8.1590568853116704e-7 * var_x19 + 0.010135702170189035 * var_x44 + 0.00025476713237326473 * var_x29 - 0.010135702170189035 * var_x46 + var_x177 * var_x35;
        IJth(rJacobian, 19, 0) = 3.9662082081376173e-7 + 3.6488570706046276e-6 * var_x22 + 2.1893142423627767e-5 * var_x4 - 2.7196856284372236e-7 * var_x19 + var_x184 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T + var_x185 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L;
        IJth(rJacobian, 20, 0) = 1.5123892837623664e-6 + 0.00028073126790137144 * var_x0 - 0.00016984475491550982 * var_x29 + var_x190 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        IJth(rJacobian, 24, 0) = -var_x193;
        IJth(rJacobian, 25, 0) = var_x193;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.52163636363636368 * var_x50 - 0.52163636363636368 * var_x48 - 0.008839826254662923 * var_x49 + var_x51 * var_x52 + var_x54 * var_x8);
        IJth(rJacobian, 1, 1) = -21.173500000000001 + 1.5655000000000001 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Trop + 11.609999999999999 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Calmod + 0.0031868386878572373 * var_x88 + 9.1430401954624137e-5 * var_x50 + 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop + 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop - 1.5494105166262771e-6 * var_x49 - 9.1430401954624137e-5 * var_x48 - 0.00025494709502857897 * var_x87 - var_x52 * var_x89 - var_x8 * var_x90;
        IJth(rJacobian, 12, 1) = var_x168 * var_x52 + var_x169 * var_x8;
        ...
        IJth(rJacobian, 18, 1) = -var_x178 * var_x52 - var_x179 * var_x8;
        IJth(rJacobian, 19, 1) = 0.00031261130080073693 * var_x48 + 5.2976168399354324e-6 * var_x49 - 0.00031261130080073693 * var_x50 + var_x186 * var_x52 + var_x187 * var_x8;
        IJth(rJacobian, 21, 1) = 0.021865102489586535 * var_x87 - 0.27331378111983168 * var_x88;
        IJth(rJacobian, 24, 1) = -var_x198;
        IJth(rJacobian, 25, 1) = var_x198 - var_x202;
        IJth(rJacobian, 26, 1) = var_x202;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-677.70909734125723 * var_x55);
        IJth(rJacobian, 2, 2) = -var_x109;
        IJth(rJacobian, 12, 2) = -0.23757245275719172 * var_x55;
        IJth(rJacobian, 18, 2) = 0.812288165677163 * var_x55;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x57 * var_chaste_interface__sodium_current_h_gate__h2);
        IJth(rJacobian, 3, 3) = -0.16500000000000001 * var_x110 - 12.359999999999999 * var_x112;
        IJth(rJacobian, 12, 3) = -var_x170 * var_chaste_interface__sodium_current_h_gate__h2;
        IJth(rJacobian, 18, 3) = var_x180 * var_chaste_interface__sodium_current_h_gate__h2;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x57 * var_chaste_interface__sodium_current_h_gate__h1);
        IJth(rJacobian, 4, 4) = -0.0082500000000000004 * var_x110 - 0.61799999999999999 * var_x112;
        IJth(rJacobian, 12, 4) = -var_x170 * var_chaste_interface__sodium_current_h_gate__h1;
        IJth(rJacobian, 18, 4) = var_x180 * var_chaste_interface__sodium_current_h_gate__h1;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x20 * var_x6);
        IJth(rJacobian, 1, 5) = -var_x20 * var_x85;
        IJth(rJacobian, 5, 5) = 0.028390000000000002 * var_x127 * var_x134 + 0.084900000000000003 * var_x131 * var_chaste_interface__membrane__V - 0.011429999999999999 * var_x123 * var_x133;
        IJth(rJacobian, 19, 5) = var_x185 * var_x20;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.38454545454545452 * var_x58);
        IJth(rJacobian, 1, 6) = -6.7401638248180558e-5 * var_x58;
        IJth(rJacobian, 6, 6) = -0.029999999999999999 * var_x145 - 0.0037499999999999999 * var_x140 * var_x144;
        IJth(rJacobian, 19, 6) = 0.00023045413077502912 * var_x58;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x5 * var_x59);
        IJth(rJacobian, 1, 7) = -var_x59 * var_x84;
        IJth(rJacobian, 7, 7) = -1.0680000000000001 * var_x149 - 1.0680000000000001 * var_x150;
        IJth(rJacobian, 19, 7) = var_x184 * var_x59;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-0.45836363636363631 * var_x60);
        IJth(rJacobian, 1, 8) = -8.0340203320880944e-5 * var_x60;
        IJth(rJacobian, 8, 8) = -0.014999999999999999 * var_x153 - 0.015300000000000001 * var_x154;
        IJth(rJacobian, 19, 8) = 0.00027469260694271797 * var_x60;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x62 * var_x7);
        IJth(rJacobian, 9, 9) = -0.017000000000000001 * var_x157 - 0.0021099999999999999 * var_x158;
        IJth(rJacobian, 13, 9) = -var_x174 * var_x62;
        IJth(rJacobian, 20, 9) = var_x190 * var_x62;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-0.34078687761326093 * var_x63);
        IJth(rJacobian, 10, 10) = -0.10000000000000001 * var_x159 - 0.65600000000000003 * var_x160;
        IJth(rJacobian, 13, 10) = -0.00011946360864812104 * var_x63;
        IJth(rJacobian, 20, 10) = 0.00040846013251011971 * var_x63;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-0.46844000000000002 * var_x65 - 0.24537454545454543 * var_x66);
        IJth(rJacobian, 11, 11) = -0.0016483000000000001 * var_x163 - 0.01401055 * var_x166;
        IJth(rJacobian, 12, 11) = -8.6016600391692266e-5 * var_x66;
        IJth(rJacobian, 13, 11) = -0.00016421269864338287 * var_x65;
        IJth(rJacobian, 18, 11) = 0.00029410087633924189 * var_x66;
        IJth(rJacobian, 20, 11) = 0.00056146253580274287 * var_x65;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-19.130181818181818 * var_x72 - 0.077712758282750996 * var_x36 + var_x67 * var_x68 - var_x37 * var_x73 - var_x69 * var_x70);
        IJth(rJacobian, 1, 12) = var_x70 * var_x91 - var_x67 * var_x92;
        IJth(rJacobian, 12, 12) = -2.7242382709912573e-5 * var_x36 - 0.020118385162895228 * var_x72 + var_x171 * var_x67 - var_x172 * var_x70 - var_x173 * var_x37;
        IJth(rJacobian, 13, 12) = 0.013412256775263483 * var_x72;
        IJth(rJacobian, 18, 12) = 0.068787125740781468 * var_x72 + 9.3144911471392246e-5 * var_x36 + var_x181 * var_x70 + var_x183 * var_x37 - var_x182 * var_x67;
        IJth(rJacobian, 19, 12) = var_x188 * var_x67 - var_x189 * var_x70;
        IJth(rJacobian, 20, 12) = -0.045858083827187646 * var_x72;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.03370790890514324 * var_x61 - var_x61 * var_x75);
        IJth(rJacobian, 13, 13) = -1.1816383500424578e-5 * var_x61 - var_x175 * var_x61;
        IJth(rJacobian, 20, 13) = 4.0401605350716387e-5 * var_x61 + var_x191 * var_x61;
        ...
        IJth(rJacobian, 14, 14) = -0.307 + var_x176;
        ...
        IJth(rJacobian, 1, 16) = 0.00026350000000000001 + var_x93;
        IJth(rJacobian, 16, 16) = -0.0042500000000000003 + var_x176;
        IJth(rJacobian, 17, 16) = -3.2250000000000001;
        IJth(rJacobian, 1, 17) = var_x93;
        IJth(rJacobian, 16, 17) = var_x176;
        IJth(rJacobian, 17, 17) = -3.6539999999999999;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x73 + 0.077712758282750996 * var_x76 - 225.90303244708574 * var_x79 + var_x68 * var_x77 + var_x69 * var_x78);
        IJth(rJacobian, 1, 18) = -var_x77 * var_x92 - var_x78 * var_x91;
        IJth(rJacobian, 12, 18) = var_x173 + 2.7242382709912573e-5 * var_x76 - 0.079190817585730572 * var_x79 + var_x171 * var_x77 + var_x172 * var_x78;
        IJth(rJacobian, 18, 18) = -0.10000000000000001 - var_x183 + 0.27076272189238765 * var_x79 - 9.3144911471392246e-5 * var_x76 - var_x181 * var_x78 - var_x182 * var_x77;
        IJth(rJacobian, 19, 18) = var_x188 * var_x77 + var_x189 * var_x78;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (0.008839826254662923 * var_x80 + var_x10 * var_x54 - var_x51 * var_x81);
        IJth(rJacobian, 1, 19) = 1.5494105166262771e-6 * var_x80 + var_x81 * var_x89 - var_x10 * var_x90;
        IJth(rJacobian, 12, 19) = var_x10 * var_x169 - var_x168 * var_x81;
        IJth(rJacobian, 18, 19) = var_x178 * var_x81 - var_x10 * var_x179;
        IJth(rJacobian, 19, 19) = -0.10000000000000001 - 5.2976168399354324e-6 * var_x80 + var_x10 * var_x187 - var_x186 * var_x81;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (0.03370790890514324 * var_x82 - 12.753454545454545 * var_x83 + var_x75 * var_x82);
        IJth(rJacobian, 12, 20) = -0.013412256775263484 * var_x83;
        IJth(rJacobian, 13, 20) = 0.0089415045168423218 * var_x83 + 1.1816383500424578e-5 * var_x82 + var_x175 * var_x82;
        IJth(rJacobian, 18, 20) = 0.045858083827187646 * var_x83;
        IJth(rJacobian, 20, 20) = -0.10000000000000001 - 4.0401605350716387e-5 * var_x82 - 0.030572055884791765 * var_x83 - var_x191 * var_x82;
        IJth(rJacobian, 1, 21) = 4.6933442493897499e-10 * var_x87 + 6.5185336797079863e-9 * var_x88;
        IJth(rJacobian, 21, 21) = -0.015581177937052042 - 5.5905091592692849e-7 * var_x88 - 4.0251665946738848e-8 * var_x87;
        IJth(rJacobian, 22, 21) = 0.14018251137810711;
        IJth(rJacobian, 1, 22) = 0.0015934193439286187 * var_x96;
        IJth(rJacobian, 21, 22) = 0.015581177937052042;
        IJth(rJacobian, 22, 22) = -8.979782511378108 + 8.8396000000000008 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_Calse - 1.2294902345128229 * var_x96;
        ...
        IJth(rJacobian, 24, 24) = var_x200 - var_x201;
        IJth(rJacobian, 25, 24) = var_x199 + var_x201;
        IJth(rJacobian, 1, 25) = 0.0031868386878572373 * var_x97;
        IJth(rJacobian, 22, 25) = -2.4589804690256458 * var_x97;
        IJth(rJacobian, 25, 25) = -0.040000000000000001 + var_x200;
        IJth(rJacobian, 26, 25) = 0.040000000000000001 + var_x199;
