...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldemir_model_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x5 = var_chaste_interface__T_type_Ca_channel_d_gate__d_T * var_chaste_interface__T_type_Ca_channel_f_gate__f_T;
        const double var_x6 = var_chaste_interface__L_type_Ca_channel_d_gate__d_L * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        const double var_x7 = pow(var_chaste_interface__cleft_space_equations__Na_c, 3.0);
        const double var_x8 = var_x7 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x9 = pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i, 3.0);
        ...
        const double var_x51 = (var_x17 - var_x15) / pow(var_x11, 2);
        const double var_x52 = 2.269090909090909e-8 * var_x51;
        const double var_x53 = 0.0002269090909090909 * var_x12;
        const double var_x54 = var_x14 * var_x7;
        ...
        const double var_x58 = 20.626363636363635 - 0.45836363636363631 * var_chaste_interface__membrane__V;
        ...
        const double var_x61 = 9.1036990845256476 * var_x60 - 0.34078687761326093 * var_chaste_interface__membrane__V;
        ...
        const double var_x67 = 0.00068072727272727273 * var_x12;
        const double var_x68 = var_x16 * var_x65;
        const double var_x69 = var_x28 / (1.5 + var_x23);
        const double var_x70 = 6.3767272727272726 * var_x69;
        ...
        const double var_x72 = 225.90303244708576 * var_x43;
        const double var_x73 = 9.1036990845256476 * var_x19;
        ...
        const double var_x86 = 7.9543493648916655e-12 * var_x51;
        const double var_x87 = 7.9543493648916641e-8 * var_x12;
        const double var_x88 = 0.0036153091494396427 - 8.0340203320880944e-5 * var_chaste_interface__membrane__V;
        const double var_x89 = 2.3863048094674996e-7 * var_x12;
        const double var_x90 = 2.3863048094674996e-11 * var_x51;
        ...
        const double var_x144 = exp(-4.3833333333333337 + var_x1);
        ...
        const double var_x168 = 7.1589144284024978e-7 * var_x12;
        const double var_x169 = 0.0067061283876317422 * var_x69;
        const double var_x170 = 0.0791908175857306 * var_x43;
        const double var_x171 = 0.003191322248969453 * var_x60 - 0.00011946360864812104 * var_chaste_interface__membrane__V;
        const double var_x172 = 0.0044707522584211609 * var_x69;
        const double var_x173 = 0.003191322248969453 * var_x19;
        const double var_x174 = -129.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x175 = 0.27076272189238765 * var_x40;
        const double var_x176 = 8.159056885311671e-11 * var_x51;
        const double var_x177 = 8.1590568853116704e-7 * var_x12;
        const double var_x178 = var_x175 * var_x56;
        const double var_x179 = 2.447717065593501e-6 * var_x12;
        const double var_x180 = 2.4477170655935014e-10 * var_x51;
        const double var_x181 = 0.022929041913593823 * var_x69;
        const double var_x182 = 0.2707627218923877 * var_x43;
        const double var_x183 = -0.010693071667961351 + 0.00023045413077502912 * var_chaste_interface__membrane__V;
        const double var_x184 = 2.7196856284372236e-7 * var_x12;
        const double var_x185 = 2.7196856284372237e-11 * var_x51;
        const double var_x186 = -0.012361167312422308 + 0.00027469260694271797 * var_chaste_interface__membrane__V;
        const double var_x187 = 8.159056885311671e-11 * var_x51;
        const double var_x188 = 8.1590568853116704e-7 * var_x12;
        const double var_x189 = 0.00040846013251011971 * var_chaste_interface__membrane__V - 0.010911506218902909 * var_x60;
        const double var_x190 = 0.015286027942395882 * var_x69;
        const double var_x191 = 0.010911506218902909 * var_x19;
        const double var_x192 = 1.2294902345128229 * var_x94;
        const double var_x193 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x194 = 0.019200000000000002 * var_x193 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        const double var_x195 = 0.0040000000000000001 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x196 = 1 / var_x195;
        const double var_x197 = 0.23999999999999999 * pow((var_x196 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i), 4.0);
        const double var_x198 = var_x195 * var_x197 * var_x49 * (4.0 * var_x196 - 4.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i / pow(var_x195, 2));
        const double var_x199 = var_x198 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        const double var_x200 = -var_x197;
        const double var_x201 = 0.23999999999999999 * var_x193;
        const double var_x202 = var_x198 * var_chaste_interface__SR_Ca_uptake_and_release__F2;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0048327272727272724 + 8.4564294531513351 * var_x46 - 0.45836363636363631 * var_x5 - 0.38454545454545452 * var_x6 - 0.35690727272727274 * var_x0 - 0.0002269090909090909 * var_x18 - 0.036531818181818179 * var_x4 - 8.4564294531513351 * var_x44 - 0.07085252525252525 * var_x29 - 0.34078687761326093 * var_x19 + var_x20 * var_x22 - var_x35 * var_x41);
        IJth(rJacobian, 1, 0) = -1.1600092823800343e-7 + 7.9543493648916641e-8 * var_x18 - 8.0340203320880944e-5 * var_x5 - 6.4031556335771533e-6 * var_x4 - 6.7401638248180558e-5 * var_x6 + var_x22 * var_x82;
        ...
        IJth(rJacobian, 5, 0) = (0.001 * var_x4 - 0.001 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L) * (var_x122 - var_x126 - var_x130 - 11.356 * var_x123 * var_x131 / pow(var_x124, 2) - 17.659200000000002 * var_x127 * var_chaste_interface__membrane__V / pow(var_x128, 2) - 4.5720000000000001 * var_x119 * var_x132 / pow(var_x120, 2)) + 0.00016666666666666666 * var_x21 * (var_x122 * var_x132 - var_x126 * var_x131 - var_x130 * var_chaste_interface__membrane__V);
        ...
        IJth(rJacobian, 12, 0) = -1.0197883801143159e-6 + 0.0029644204196681906 * var_x46 - 0.0029644204196681906 * var_x44 - 2.3863048094674996e-7 * var_x18 - 7.4512537640352683e-5 * var_x29 - 4.3008300195846133e-5 * var_x0 - var_x165 * var_x35;
        IJth(rJacobian, 13, 0) = -4.4233320987458456e-7 + 4.967502509356846e-5 * var_x29 - 8.2106349321691435e-5 * var_x0 - 0.00011946360864812104 * var_x19;
        IJth(rJacobian, 18, 0) = 3.486776446714389e-6 + 0.00014705043816962094 * var_x0 + 0.010135702170189035 * var_x44 + 0.00025476713237326473 * var_x29 + 8.1590568853116704e-7 * var_x18 - 0.010135702170189035 * var_x46 + var_x175 * var_x35;
        IJth(rJacobian, 19, 0) = 3.9662082081376173e-7 + 2.1893142423627767e-5 * var_x4 + 0.00023045413077502912 * var_x6 + 0.00027469260694271797 * var_x5 - 2.7196856284372236e-7 * var_x18 + var_x183 * var_x22;
        IJth(rJacobian, 20, 0) = 1.5123892837623664e-6 + 0.00040846013251011971 * var_x19 + 0.00028073126790137144 * var_x0 - 0.00016984475491550979 * var_x29;
        IJth(rJacobian, 24, 0) = -var_x194;
        IJth(rJacobian, 25, 0) = var_x194;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.52163636363636368 * var_x50 - 0.52163636363636368 * var_x48 - 0.008839826254662923 * var_x49 + var_x52 * var_x7 + var_x53 * var_x54);
        IJth(rJacobian, 1, 1) = -21.173500000000001 + 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop + 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop + 11.609999999999999 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Calmod + 9.1430401954624137e-5 * var_x50 + 1.5655000000000001 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Trop + 0.0031868386878572373 * var_x85 - 9.1430401954624137e-5 * var_x48 - 0.00025494709502857897 * var_x84 - 1.5494105166262771e-6 * var_x49 - var_x54 * var_x87 - var_x7 * var_x86;
        IJth(rJacobian, 12, 1) = var_x54 * var_x89 + var_x7 * var_x90;
        ...
        IJth(rJacobian, 18, 1) = -var_x176 * var_x7 - var_x177 * var_x54;
        IJth(rJacobian, 19, 1) = 5.2976168399354324e-6 * var_x49 + 0.00031261130080073693 * var_x48 - 0.00031261130080073693 * var_x50 + var_x184 * var_x54 + var_x185 * var_x7;
        IJth(rJacobian, 21, 1) = 0.021865102489586532 * var_x84 - 0.27331378111983168 * var_x85;
        IJth(rJacobian, 24, 1) = -var_x199;
        IJth(rJacobian, 25, 1) = var_x199 - var_x202;
        ...
        IJth(rJacobian, 18, 2) = 0.81228816567716289 * var_x55;
        ...
        IJth(rJacobian, 20, 9) = var_x189 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        ...
        IJth(rJacobian, 20, 10) = var_x189 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-0.46844000000000002 * var_x63 - 0.24537454545454543 * var_x64);
        ...
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-0.077712758282750996 * var_x36 + var_x65 * var_x66 - var_x37 * var_x72 - var_x67 * var_x68 - var_x70 * var_x71);
        IJth(rJacobian, 1, 12) = var_x68 * var_x89 - var_x65 * var_x90;
        IJth(rJacobian, 12, 12) = -2.7242382709912573e-5 * var_x36 + var_x167 * var_x65 - var_x168 * var_x68 - var_x169 * var_x71 - var_x170 * var_x37;
        IJth(rJacobian, 13, 12) = var_x172 * var_x71;
        IJth(rJacobian, 18, 12) = 9.3144911471392246e-5 * var_x36 + var_x179 * var_x68 + var_x181 * var_x71 + var_x182 * var_x37 - var_x180 * var_x65;
        IJth(rJacobian, 19, 12) = var_x187 * var_x65 - var_x188 * var_x68;
        IJth(rJacobian, 20, 12) = -var_x190 * var_x71;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.03370790890514324 * var_x59 - var_x59 * var_x73);
        IJth(rJacobian, 13, 13) = -1.1816383500424578e-5 * var_x59 - var_x173 * var_x59;
        IJth(rJacobian, 20, 13) = 4.0401605350716387e-5 * var_x59 + var_x191 * var_x59;
        ...
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x72 + 0.077712758282750996 * var_x74 - 225.90303244708574 * var_x77 + var_x66 * var_x75 + var_x67 * var_x76);
        IJth(rJacobian, 1, 18) = -var_x75 * var_x90 - var_x76 * var_x89;
        IJth(rJacobian, 12, 18) = var_x170 + 2.7242382709912573e-5 * var_x74 - 0.079190817585730572 * var_x77 + var_x167 * var_x75 + var_x168 * var_x76;
        IJth(rJacobian, 18, 18) = -0.10000000000000001 - var_x182 + 0.27076272189238765 * var_x77 - 9.3144911471392246e-5 * var_x74 - var_x179 * var_x76 - var_x180 * var_x75;
        IJth(rJacobian, 19, 18) = var_x187 * var_x75 + var_x188 * var_x76;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (0.008839826254662923 * var_x78 + var_x52 * var_x9 - var_x53 * var_x79);
        IJth(rJacobian, 1, 19) = 1.5494105166262771e-6 * var_x78 + var_x79 * var_x87 - var_x86 * var_x9;
        IJth(rJacobian, 12, 19) = var_x9 * var_x90 - var_x79 * var_x89;
        IJth(rJacobian, 18, 19) = var_x177 * var_x79 - var_x176 * var_x9;
        IJth(rJacobian, 19, 19) = -0.10000000000000001 - 5.2976168399354324e-6 * var_x78 + var_x185 * var_x9 - var_x184 * var_x79;
        ...
        IJth(rJacobian, 13, 20) = 1.1816383500424578e-5 * var_x80 + var_x172 * var_x81 + var_x173 * var_x80;
        IJth(rJacobian, 18, 20) = var_x181 * var_x81;
        IJth(rJacobian, 20, 20) = -0.10000000000000001 - 4.0401605350716387e-5 * var_x80 - var_x190 * var_x81 - var_x191 * var_x80;
        IJth(rJacobian, 1, 21) = 6.5185336797079863e-9 * var_x85 + 4.6933442493897499e-10 * var_x84;
        IJth(rJacobian, 21, 21) = -0.015581177937052042 - 5.5905091592692849e-7 * var_x85 - 4.0251665946738848e-8 * var_x84;
        IJth(rJacobian, 22, 21) = 0.14018251137810711;
        IJth(rJacobian, 1, 22) = var_x95;
        IJth(rJacobian, 21, 22) = 0.015581177937052042;
        IJth(rJacobian, 22, 22) = -8.979782511378108 - var_x192 + 8.8396000000000008 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_Calse;
        ...
        IJth(rJacobian, 25, 24) = var_x197 + var_x201;
        IJth(rJacobian, 1, 25) = var_x95 * var_x96;
        IJth(rJacobian, 22, 25) = -var_x192 * var_x96;
        IJth(rJacobian, 25, 25) = -0.040000000000000001 + var_x200;
        IJth(rJacobian, 26, 25) = 0.040000000000000001 + var_x197;
