...
bool Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::registered = ModelFactory::Register("dynamic_Shannon2004", "AnalyticCvode", (ModelFactory::TCreateMethod)Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::CreateMethod);
    ...
    void Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x281 = ((var_x267) ? (0.28123999999999999 * var_x271 + 108500 * var_x270) : (0.693000693000693 * var_x272 / pow(var_x273, 2)));
        ...
        const double var_x328 = 7 + var_chaste_interface__cell__V;
        const double var_x329 = 10 + var_chaste_interface__cell__V;
        ...
        const double var_x340 = 30 + var_chaste_interface__cell__V;
        ...
        const double var_x347 = 1 / (0.5 + 9 * var_x346);
        ...
        const double var_x353 = exp(6 + var_x352);
        const double var_x354 = 1 + var_x353;
        const double var_x355 = 1 / var_x354;
        const double var_x356 = 1 / (30 + 3000 * var_x355);
        ...
        const double var_x364 = 1 / (220 + 2800 * var_x355);
        ...
        const double var_x367 = 1 / (20 + 20 * var_x361);
        ...
        const double var_x371 = 1 + var_x368;
        ...
        const double var_x382 = 1 + var_x381;
        ...
        const double var_x387 = 1 + 0.13584112963311223 * var_x386;
        const double var_x388 = 1 / var_x387;
        const double var_x389 = 7 * var_x388;
        const double var_x390 = -7.5 + var_x389;
        const double var_x391 = var_x390 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x392 = 1 / (15 - 14 * var_x388);
        const double var_x393 = 10 * var_x233 * var_x392;
        ...
        const double var_x400 = 20 * var_x392;
        ...
        const double var_x404 = 1 - var_chaste_interface__Jrel_SR__I - var_chaste_interface__Jrel_SR__O - var_chaste_interface__Jrel_SR__R;
        ...
        const double var_x433 = 100 * var_chaste_interface__Ca_buffer__Ca_SR;
        ...
        const double var_x439 = 100 * var_chaste_interface__Ca_buffer__Ca_SL;
        ...
        const double var_x446 = 100 * var_chaste_interface__Ca_buffer__Ca_SLB_jct;
        const double var_x447 = 100 * var_chaste_interface__Ca_buffer__Ca_SLHigh_jct;
        const double var_x448 = 100 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x449 = -var_x439;
        const double var_x450 = -var_x448;
        const double var_x451 = -var_x262;
        const double var_x452 = -var_x264;
        const double var_x453 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_Cytosol;
        ...
        const double var_x458 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL;
        const double var_x459 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x460 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol;
        ...
        const double var_x465 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL;
        const double var_x466 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        ...
        IJth(rJacobian, 24, 24) = -260 + var_x430 - var_x431 - var_x432 - 1.6231539579137989e-12 * var_x260 - 12.857532841472388 * var_x259;
        IJth(rJacobian, 26, 24) = var_x444 + var_x445;
        IJth(rJacobian, 31, 24) = 260 - var_x430;
        ...
        IJth(rJacobian, 24, 31) = 65 + var_x433;
        IJth(rJacobian, 31, 31) = -65 - var_x433;
