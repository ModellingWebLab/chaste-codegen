...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_atrial_model_2009FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_L_type_Ca_channel_d_L_gate__alpha_d_L = -16.719999999999999 * (45.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-18.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)) + ((fabs(10.0 + var_chaste_interface__membrane__V) < 4.8079999981354149e-7) ? (2.4040000035085995e-5 / (-1.0 + exp(1.000000001459484e-7)) + 1039933.4446628628 * (10.000000480800001 + var_chaste_interface__membrane__V) * (-2.4040000035085995e-5 / (-1.0 + exp(1.000000001459484e-7)) - 2.4039999946268154e-5 / (-1.0 + exp(-9.9999999776489825e-8)))) : (-50.0 * (10.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V)))); // per_second
        const double var_L_type_Ca_channel_d_L_gate__beta_d_L = ((fabs(5.0 + var_chaste_interface__membrane__V) < 2.500000002569891e-7) ? (1.1200000011513112e-6 / (-1.0 + exp(1.0000000010279564e-7)) - 1999999.9979440873 * (4.9999997499999997 + var_chaste_interface__membrane__V) * (-1.1200000011513112e-6 / (-1.0 + exp(1.0000000010279564e-7)) - 1.1200000011513112e-6 / (-1.0 + exp(-1.0000000010279564e-7)))) : (4.4800000000000004 * (5.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V)))); // per_second
        ...
        const double var_sodium_current_m_gate__alpha_m = ((fabs(44.399999999999999 + var_chaste_interface__membrane__V) < 1.2673000000518186e-6) ? (0.00058295800002383658 / (-1.0 + exp(1.000000000040889e-7)) + 394539.57230297127 * (44.400001267299999 + var_chaste_interface__membrane__V) * (-0.00058295800002383658 / (-1.0 + exp(1.000000000040889e-7)) - 0.00058295800002383658 / (-1.0 + exp(-1.000000000040889e-7)))) : (-460.0 * (44.399999999999999 + var_chaste_interface__membrane__V) / (-1.0 + exp(-3.5035114021936398 - 0.078907914463820727 * var_chaste_interface__membrane__V)))); // per_second
    ...
    void Cellaslanidi_atrial_model_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x152 = fabs(var_x151) < 1.2673000000518186e-6;
        ...
        const double var_x156 = 0.00058295800002383658 * var_x149;
        ...
        const double var_x173 = 1 / (-1.0 + exp(1.0000000010279564e-7));
        const double var_x174 = 1 / (-1.0 + exp(-1.0000000010279564e-7));
        const double var_x175 = 5.0 + var_chaste_interface__membrane__V;
        const double var_x176 = fabs(var_x175) < 2.500000002569891e-7;
        ...
        const double var_x181 = 1 / (-1.0 + exp(1.000000001459484e-7));
        const double var_x182 = 1 / (-1.0 + exp(-9.9999999776489825e-8));
        ...
        const double var_x189 = fabs(var_x188) < 4.8079999981354149e-7;
        const double var_x190 = exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V);
        const double var_x191 = -1.0 + var_x190;
        const double var_x192 = 50.0 / var_x191;
        ...
        const double var_x195 = 1.1200000011513112e-6 * var_x173;
        const double var_x196 = ((var_x176) ? (var_x195 - 1999999.9979440873 * (4.9999997499999997 + var_chaste_interface__membrane__V) * (-var_x195 - 1.1200000011513112e-6 * var_x174)) : (var_x175 * var_x180));
        const double var_x197 = 2.4040000035085995e-5 * var_x181;
        const double var_x198 = -var_x185 * var_x186;
        const double var_x199 = ((var_x189) ? (var_x197 + var_x198 + 1039933.4446628628 * (10.000000480800001 + var_chaste_interface__membrane__V) * (-var_x197 - 2.4039999946268154e-5 * var_x182)) : (var_x198 - var_x188 * var_x192));
        const double var_x200 = 1 / (-1.0 + exp(1.0000000028043132e-7));
        const double var_x201 = 1 / (-1.0 + exp(-1.0000000028043132e-7));
        const double var_x202 = 18.0 + var_chaste_interface__membrane__V;
        const double var_x203 = fabs(var_x202) < 4.0000000112172529e-7;
        const double var_x204 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x205 = exp(4.5 + var_x204);
        const double var_x206 = -1.0 + var_x205;
        const double var_x207 = 8.4900000000000002 / var_x206;
        const double var_x208 = ((var_x203) ? (4.2450000000000001 * var_x200 + 4.2450000000000001 * var_x201) : (var_x207 - 2.1225000000000001 * var_x202 * var_x205 / pow(var_x206, 2)));
        const double var_x209 = exp(-4.5 - var_x204);
        const double var_x210 = 1.0 + var_x209;
        const double var_x211 = 16.980499999999999 * var_x209 / pow(var_x210, 2);
        const double var_x212 = 1 / var_x210;
        const double var_x213 = 67.921999999999997 * var_x212;
        const double var_x214 = 3.3960000095234478e-6 * var_x200;
        const double var_x215 = ((var_x203) ? (var_x214 - 1249999.9964946085 * (17.999999599999999 + var_chaste_interface__membrane__V) * (-var_x214 - 3.3960000095234478e-6 * var_x201)) : (var_x202 * var_x207));
        const double var_x216 = 1 / (var_x213 + var_x215);
        const double var_x217 = 0.001 * var_x215;
        ...
        const double var_x221 = exp(0.77666666666666673 + var_x220);
        const double var_x222 = exp(-0.77666666666666673 - var_x220);
        const double var_x223 = exp(4.876462938881664 + 0.065019505851755519 * var_chaste_interface__membrane__V);
        const double var_x224 = exp(-0.9003601440576231 - 0.012004801920768308 * var_chaste_interface__membrane__V);
        const double var_x225 = 9.6370000000000005 * var_x223 + 9.6370000000000005 * var_x224;
        const double var_x226 = 1 / var_x225;
        const double var_x227 = 0.11569027611044419 * var_x224;
        const double var_x228 = 0.62659297789336799 * var_x223;
        ...
        const double var_x233 = exp(var_x0);
        ...
        const double var_x269 = -3.290319067574035e-6 - 4.9354786013610522e-6 * var_x17;
        const double var_x270 = var_x20 * var_x269;
        const double var_x271 = var_x43 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x272 = var_x269 * var_x271;
        const double var_x273 = 1.77 * var_x101;
        const double var_x274 = 1.23 * var_x104;
        const double var_x275 = var_x105 * var_x43;
        const double var_x276 = 0.021829942145742926 * var_x26 - 0.00082254686501890791 * var_chaste_interface__membrane__V;
        const double var_x277 = NV_Ith_S(mParameters, 7) * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a;
        const double var_x278 = 0.021829942145742926 * var_x5;
        const double var_x279 = 0.021829942145742926 * var_x23;
        const double var_x280 = 0.0049352811901134472 * var_x43;
        const double var_x281 = -200.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x282 = 1.6583208100573134e-5 + 2.4874812150859699e-5 * var_x17;
        const double var_x283 = var_x20 * var_x282;
        const double var_x284 = var_x271 * var_x282;
        const double var_x285 = 0.0041456361996952953 * var_chaste_interface__membrane__V - 0.11002290841454433 * var_x26;
        const double var_x286 = 0.11002290841454433 * var_x5;
        const double var_x287 = 0.11002290841454433 * var_x23;
        const double var_x288 = 0.024873817198171774 * var_x43;
        const double var_x289 = 0.11777375567316183 * var_x141;
        const double var_x290 = 0.23554751134632365 * var_x145;
        const double var_x291 = exp(-1.6000000000000001 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x292 = 0.019200000000000002 * var_x291 * var_chaste_interface__Ca_handling_by_the_SR__F1;
        const double var_x293 = 0.00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x294 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 4);
        const double var_x295 = var_x294 / pow(var_x293, 5);
        const double var_x296 = 0.81520000000000004 * var_x295;
        const double var_x297 = pow(var_x293, (-4));
        const double var_x298 = var_x297 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 3);
        const double var_x299 = 0.81520000000000004 * var_x298;
        const double var_x300 = 0.23999999999999999 * var_x291;
        const double var_x301 = var_x294 * var_x297;
        const double var_x302 = 0.20380000000000001 * var_x301;
        const double var_x303 = 1.3584000000000001 * var_x295;
        const double var_x304 = 1.3584000000000001 * var_x298;
        const double var_x305 = 0.33960000000000001 * var_x301;
        ...
        IJth(rJacobian, 5, 0) = (-var_x96 + 0.001 / var_x194) * (((var_x176) ? (2.2400000000000002 * var_x173 + 2.2400000000000002 * var_x174) : (var_x180 - 1.7920000000000003 * var_x175 * var_x178 / pow(var_x179, 2))) + ((var_x189) ? (var_x187 - 25.000000046182322 * var_x181 - 24.999999953817678 * var_x182) : (var_x187 - var_x192 - 10.399334442595674 * var_x188 * var_x190 / pow(var_x191, 2)))) + 0.00015151515151515152 * var_x193 * (var_x196 + var_x199) / pow(var_x194, 2);
        IJth(rJacobian, 6, 0) = (var_x211 + var_x208) * (-var_x94 + var_x216 * var_x217) + (var_x213 + var_x215) * (0.001 * var_x208 * var_x216 + 2.1675996343523e-7 * var_x215 * (-var_x208 - var_x211) / pow((var_x212 + 0.014722770236447691 * var_x215), 2));
        IJth(rJacobian, 7, 0) = (-var_x99 + 0.001 / var_x219) * (22.472433333333335 * var_x221 - 22.472433333333335 * var_x222) + 0.0001639344262295082 * var_x218 * (674.173 * var_x221 + 674.173 * var_x222) / pow(var_x219, 2);
        IJth(rJacobian, 8, 0) = var_x225 * (-0.00011569027611044419 * var_x224 * var_x226 + 0.00010376673238559718 * var_x224 * (var_x227 - var_x228) / pow((var_x223 + var_x224), 2)) + (var_x228 - var_x227) * (-var_x97 + var_x226 * var_x229);
        ...
        IJth(rJacobian, 14, 0) = (-var_x108 + 0.001 / var_x262) * (0.35473572188719404 * var_x263 - 0.099800399201596807 * var_x264) + 0.00013513513513513514 * var_x261 * (9.0 * var_x263 + 1.3 * var_x264) / pow(var_x262, 2);
        IJth(rJacobian, 15, 0) = (-var_x106 + 0.001 / var_x268) * (6.1795265502981431 * var_x265 - 1.8299935950224173 * var_x266) - 5.3589706489177562e-5 * var_x267 * (100.0 * var_x266 + 656.0 * var_x265) / pow(var_x268, 2);
        ...
        IJth(rJacobian, 17, 0) = -1.151565611026471e-6 + var_x270 + 8.6347512375898239e-5 * var_x45 + 1.8837419938086349e-6 * var_x42 - 0.00082254686501890791 * var_x23 - 0.00082254686501890791 * var_x5 - 0.0016450937300378158 * var_x33;
        IJth(rJacobian, 22, 0) = 5.8038906795734136e-6 + var_x283 + 0.0041456361996952953 * var_x23 + 0.0041456361996952953 * var_x5 + 0.0082912723993905906 * var_x33 - 9.4940596487955185e-6 * var_x42 - 0.00043519146237452704 * var_x45;
        IJth(rJacobian, 26, 0) = -var_x292;
        IJth(rJacobian, 27, 0) = var_x292;
        ...
        IJth(rJacobian, 23, 1) = var_x289;
        IJth(rJacobian, 24, 1) = 121.85879481761599 * var_x136 - 1.0967291533585437e-5 * var_x137;
        IJth(rJacobian, 26, 1) = (var_x296 - var_x299) * var_chaste_interface__Ca_handling_by_the_SR__F1;
        IJth(rJacobian, 27, 1) = (var_x299 - var_x296) * var_chaste_interface__Ca_handling_by_the_SR__F1 + (var_x303 - var_x304) * var_chaste_interface__Ca_handling_by_the_SR__F2;
        IJth(rJacobian, 28, 1) = (var_x304 - var_x303) * var_chaste_interface__Ca_handling_by_the_SR__F2;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x73 * var_x86);
        IJth(rJacobian, 2, 2) = -0.001 * ((var_x152) ? (var_x156 + 394539.57230297127 * (44.400001267299999 + var_chaste_interface__membrane__V) * (-var_x156 - 0.00058295800002383658 * var_x150)) : (-var_x151 * var_x155)) - 18.399999999999999 * var_x153;
        ...
        IJth(rJacobian, 5, 5) = -0.001 * var_x196 - 0.001 * var_x199;
        ...
        IJth(rJacobian, 6, 6) = -var_x217 - 0.067921999999999996 * var_x212;
        ...
        IJth(rJacobian, 17, 9) = var_x100 * var_x269;
        IJth(rJacobian, 22, 9) = var_x100 * var_x282;
        ...
        IJth(rJacobian, 17, 10) = var_x272 * var_x273;
        IJth(rJacobian, 22, 10) = var_x273 * var_x284;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00123 * var_x103 * var_x104);
        IJth(rJacobian, 11, 11) = -0.001 * var_x248;
        IJth(rJacobian, 17, 11) = var_x272 * var_x274;
        IJth(rJacobian, 22, 11) = var_x274 * var_x284;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-3.600144e-5 * var_x102 * var_x105);
        IJth(rJacobian, 12, 12) = -0.001 * var_x252;
        IJth(rJacobian, 17, 12) = -2.9612871608166312e-5 * var_x275;
        IJth(rJacobian, 22, 12) = 0.00014924887290515819 * var_x275;
        ...
        IJth(rJacobian, 17, 13) = var_x276 * NV_Ith_S(mParameters, 8);
        IJth(rJacobian, 22, 13) = var_x285 * NV_Ith_S(mParameters, 8);
        ...
        IJth(rJacobian, 17, 14) = var_x22 * var_x276;
        IJth(rJacobian, 22, 14) = var_x22 * var_x285;
        ...
        IJth(rJacobian, 17, 15) = var_x276 * var_x277;
        IJth(rJacobian, 22, 15) = var_x277 * var_x285;
        ...
        IJth(rJacobian, 17, 17) = 0.0022916155659426776 * var_x124 - 0.043659884291485852 * var_x123 + var_x122 * var_x270 - var_x25 * var_x278 - var_x25 * var_x279;
        IJth(rJacobian, 22, 17) = 0.22004581682908866 * var_x123 - 0.011549742452351092 * var_x124 + var_x122 * var_x283 + var_x25 * var_x286 + var_x25 * var_x287;
        IJth(rJacobian, 1, 18) = 0.021419999999999998 + 9.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        IJth(rJacobian, 18, 18) = -0.47599999999999998 + var_x281;
        ...
        IJth(rJacobian, 20, 20) = -0.0066 + var_x281;
        IJth(rJacobian, 21, 20) = -5.0;
        IJth(rJacobian, 1, 21) = var_x144;
        IJth(rJacobian, 20, 21) = var_x281;
        ...
        IJth(rJacobian, 17, 22) = 0.043659884291485852 * var_x129 + 0.00016953677944277714 * var_x126 - 0.0022916155659426776 * var_x133 - 0.00016953677944277714 * var_x132 + var_x125 * var_x278 + var_x125 * var_x279 + var_x131 * var_x280 - var_x127 * var_x270 - var_x129 * var_x280;
        IJth(rJacobian, 22, 22) = 0.011549742452351092 * var_x133 + 0.00085446536839159674 * var_x132 - 0.00085446536839159674 * var_x126 - 0.22004581682908866 * var_x129 + var_x129 * var_x288 - var_x125 * var_x286 - var_x125 * var_x287 - var_x127 * var_x283 - var_x131 * var_x288;
        IJth(rJacobian, 1, 23) = var_x142;
        IJth(rJacobian, 23, 23) = -14.98 - var_x289 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse;
        ...
        IJth(rJacobian, 26, 26) = -var_x300 - var_x302;
        IJth(rJacobian, 27, 26) = var_x300 + var_x302;
        IJth(rJacobian, 1, 27) = var_x146 * var_x147 - var_x146 * var_x148;
        IJth(rJacobian, 23, 27) = var_x148 * var_x290 - var_x147 * var_x290;
        IJth(rJacobian, 27, 27) = -0.033960000000000004 - var_x305;
        IJth(rJacobian, 28, 27) = 0.033960000000000004 + var_x305;
