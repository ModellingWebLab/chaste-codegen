...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_atrial_model_2009FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_L_type_Ca_channel_d_L_gate__alpha_d_L = (((var_chaste_interface__membrane__V >= -10.000000480800001) && (var_chaste_interface__membrane__V <= -9.9999995191999993)) ? (2.4040000000391526e-5 / (-1.0 + exp(1.0000000000162864e-7)) + 1039933.4442576389 * (10.000000480800001 + var_chaste_interface__membrane__V) * (-2.4040000000391526e-5 / (-1.0 + exp(1.0000000000162864e-7)) - 2.4039999999697637e-5 / (-1.0 + exp(-9.9999999998742257e-8)))) : (-50.0 * (10.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V)))) + (((var_chaste_interface__membrane__V >= -45.000000249999999) && (var_chaste_interface__membrane__V <= -44.999999750000001)) ? (4.1799999996561256e-6 / (-1.0 + exp(9.9999999991773334e-8)) + 1999999.9999424887 * (45.000000249999999 + var_chaste_interface__membrane__V) * (-4.1800000005842713e-6 / (-1.0 + exp(-1.000000000139778e-7)) - 4.1799999996561256e-6 / (-1.0 + exp(9.9999999991773334e-8)))) : (-16.719999999999999 * (45.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-18.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)))); // per_second
        ...
        const double var_L_type_Ca_channel_f_L_gate__alpha_f_L = (((var_chaste_interface__membrane__V >= -18.000000400000001) && (var_chaste_interface__membrane__V <= -17.999999599999999)) ? (-3.3960000000976542e-6 / (-1.0 + exp(-1.0000000000287557e-7)) + 1249999.9999640554 * (18.000000400000001 + var_chaste_interface__membrane__V) * (3.3960000000976542e-6 / (-1.0 + exp(1.0000000000287557e-7)) + 3.3960000000976542e-6 / (-1.0 + exp(-1.0000000000287557e-7)))) : (8.4900000000000002 * (18.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)))); // per_second
        ...
        const double var_sodium_current_m_gate__alpha_m = (((var_chaste_interface__membrane__V >= -44.400001267299999) && (var_chaste_interface__membrane__V <= -44.399998732699999)) ? (0.00058295799999830145 / (-1.0 + exp(9.9999999999708629e-8)) + 394539.57232025318 * (44.400001267299999 + var_chaste_interface__membrane__V) * (-0.00058295799999830145 / (-1.0 + exp(9.9999999999708629e-8)) - 0.00058295799999830145 / (-1.0 + exp(-9.9999999999708629e-8)))) : (-460.0 * (44.399999999999999 + var_chaste_interface__membrane__V) / (-1.0 + exp(-3.5035114021936398 - 0.078907914463820727 * var_chaste_interface__membrane__V)))); // per_second
    ...
    void Cellaslanidi_atrial_model_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x36 = (-90.0 + 1.8 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 3);
        ...
        const double var_x39 = 1.0 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        ...
        const double var_x62 = 1 / (-1.0 + exp(-9.9999999999999995e-8));
        const double var_x63 = exp(-9.9999999999999995e-8 - var_x53);
        const double var_x64 = var_x62 * (-1.0 + var_x63);
        ...
        const double var_x124 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0);
        ...
        const double var_x156 = 1 / (-1.0 + exp(9.9999999999708629e-8));
        const double var_x157 = 1 / (-1.0 + exp(-9.9999999999708629e-8));
        ...
        const double var_x161 = 460.0 / var_x160;
        ...
        const double var_x165 = 1 / (1.0 + 323.30000000000001 * var_x164);
        const double var_x166 = exp(-12.010771992818672 - 0.17953321364452424 * var_chaste_interface__membrane__V);
        const double var_x167 = 1 / (1491.0 * var_x165 + 44.899999999999999 * var_x166);
        ...
        const double var_x175 = exp(30.0 + 0.5 * var_chaste_interface__membrane__V);
        ...
        const double var_x180 = 1 / (-1.0 + exp(-1.0000000000010001e-7));
        ...
        const double var_x183 = exp(2.0 + var_x182);
        const double var_x184 = -1.0 + var_x183;
        const double var_x185 = 1 / var_x184;
        const double var_x186 = 5.0 + var_chaste_interface__membrane__V;
        const double var_x187 = 1 / (-1.0 + exp(-1.000000000139778e-7));
        const double var_x188 = 1 / (-1.0 + exp(9.9999999991773334e-8));
        const double var_x189 = 8.3600000009281459 * var_x187 + 8.359999999071853 * var_x188;
        const double var_x190 = 1 / (-1.0 + exp(-9.9999999998742257e-8));
        const double var_x191 = 1 / (-1.0 + exp(1.0000000000162864e-7));
        ...
        const double var_x200 = 50.0 / var_x199;
        const double var_x201 = 10.0 + var_chaste_interface__membrane__V;
        ...
        const double var_x204 = exp(-18.0 - var_x182);
        const double var_x205 = -1.0 + var_x204;
        const double var_x206 = 16.719999999999999 / var_x205;
        const double var_x207 = 45.0 + var_chaste_interface__membrane__V;
        ...
        const double var_x228 = 18.0 + var_chaste_interface__membrane__V;
        ...
        const double var_x254 = exp(327.99999999999994 + 10.0 * var_chaste_interface__membrane__V);
        ...
        const double var_x267 = exp(46.0 + 2.0 * var_chaste_interface__membrane__V);
        ...
        const double var_x299 = 200.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x77 * (0.0014400000000000001 + var_x17 + var_x22 + var_x24 + var_x5 + var_x75 + 2.0 * var_x35 + 0.0060000000000000001 * var_x6 + 0.0011450666666666667 * var_x45 - 0.10497579657532749 * var_x49 + var_x36 * var_x37 + (1.8 * var_x3 + 1.8 * var_x4) * NV_Ith_S(mParameters, 3)));
        ...
        IJth(rJacobian, 2, 0) = (0.001 - 0.001 * var_chaste_interface__sodium_current_m_gate__m) * ((var_x158) ? (-230.0 * var_x156 - 230.0 * var_x157) : (-var_x161 - 36.297640653357533 * var_x159 * var_x162 / pow(var_x160, 2))) + 1.4519056261343013 * var_x159 * var_chaste_interface__sodium_current_m_gate__m;
        ...
        IJth(rJacobian, 14, 0) = (-var_x114 + 0.001 / var_x280) * (0.35473572188719404 * var_x282 - 0.099800399201596807 * var_x281) + 0.00013513513513513514 * var_x279 * (9.0 * var_x282 + 1.3 * var_x281) / pow(var_x280, 2);
        IJth(rJacobian, 15, 0) = (-var_x112 + 0.001 / var_x286) * (6.1795265502981431 * var_x284 - 1.8299935950224173 * var_x283) - 5.3589706489177562e-5 * var_x285 * (100.0 * var_x283 + 656.0 * var_x284) / pow(var_x286, 2);
