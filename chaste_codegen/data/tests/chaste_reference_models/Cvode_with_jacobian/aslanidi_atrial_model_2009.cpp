...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_atrial_model_2009FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_L_type_Ca_channel_d_L_gate__alpha_d_L = ((fabs(10.0 + var_chaste_interface__membrane__V) < 4.8080000000089163e-7) ? (2.4040000000391526e-5 / (-1.0 + exp(1.0000000000162864e-7)) + 1039933.4442576389 * (10.000000480800001 + var_chaste_interface__membrane__V) * (-2.4040000000391526e-5 / (-1.0 + exp(1.0000000000162864e-7)) - 2.4039999999697637e-5 / (-1.0 + exp(-9.9999999998742257e-8)))) : (-50.0 * (10.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V)))) + ((fabs(45.0 + var_chaste_interface__membrane__V) < 2.5000000000718892e-7) ? (4.1799999996561256e-6 / (-1.0 + exp(9.9999999991773334e-8)) + 1999999.9999424887 * (45.000000249999999 + var_chaste_interface__membrane__V) * (-4.1800000005842713e-6 / (-1.0 + exp(-1.000000000139778e-7)) - 4.1799999996561256e-6 / (-1.0 + exp(9.9999999991773334e-8)))) : (-16.719999999999999 * (45.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-18.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)))); // per_second
        ...
        const double var_L_type_Ca_channel_f_L_gate__alpha_f_L = ((fabs(18.0 + var_chaste_interface__membrane__V) < 4.0000000001150227e-7) ? (3.3960000000976542e-6 / (-1.0 + exp(1.0000000000287557e-7)) - 1249999.9999640554 * (17.999999599999999 + var_chaste_interface__membrane__V) * (-3.3960000000976542e-6 / (-1.0 + exp(1.0000000000287557e-7)) - 3.3960000000976542e-6 / (-1.0 + exp(-1.0000000000287557e-7)))) : (8.4900000000000002 * (18.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)))); // per_second
        ...
        const double var_sodium_current_m_gate__alpha_m = ((fabs(44.399999999999999 + var_chaste_interface__membrane__V) < 1.2672999999963075e-6) ? (0.00058295799999830145 / (-1.0 + exp(9.9999999999708629e-8)) + 394539.57232025318 * (44.400001267299999 + var_chaste_interface__membrane__V) * (-0.00058295799999830145 / (-1.0 + exp(9.9999999999708629e-8)) - 0.00058295799999830145 / (-1.0 + exp(-9.9999999999708629e-8)))) : (-460.0 * (44.399999999999999 + var_chaste_interface__membrane__V) / (-1.0 + exp(-3.5035114021936398 - 0.078907914463820727 * var_chaste_interface__membrane__V)))); // per_second
    ...
    void Cellaslanidi_atrial_model_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x84 = var_x51 * var_x83;
        const double var_x85 = var_x68 * var_chaste_interface__membrane__V;
        const double var_x86 = ((var_x61) ? (var_x84 + var_x81 * (-var_x84 - var_x60 * var_x83)) : (10906.819473255875 * var_x82 * var_x85));
        const double var_x87 = 0.0061269244999999995 * var_x55;
        const double var_x88 = var_x51 * var_x87;
        const double var_x89 = var_x55 * var_x85;
        const double var_x90 = ((var_x61) ? (var_x88 + var_x81 * (-var_x88 - var_x60 * var_x87)) : (2308.6101218391605 * var_x89));
        const double var_x91 = 0.0035217754999999997 * var_x55;
        const double var_x92 = var_x51 * var_x91;
        const double var_x93 = ((var_x61) ? (var_x92 + var_x81 * (-var_x92 - var_x60 * var_x91)) : (1326.9963692461315 * var_x89));
        ...
        const double var_x199 = 1.1200000000011203e-6 * var_x173;
        const double var_x200 = ((var_x176) ? (var_x199 - 1999999.9999979998 * (4.9999997499999997 + var_chaste_interface__membrane__V) * (-var_x199 - 1.1200000000011203e-6 * var_x174)) : (var_x175 * var_x180));
        const double var_x201 = 2.4040000000391526e-5 * var_x182;
        const double var_x202 = -var_x185 * var_x186;
        const double var_x203 = 4.1799999996561256e-6 * var_x191;
        const double var_x204 = -var_x188 * var_x194;
        const double var_x205 = ((var_x189) ? (var_x201 + var_x202 + 1039933.4442576389 * (10.000000480800001 + var_chaste_interface__membrane__V) * (-var_x201 - 2.4039999999697637e-5 * var_x181)) : ((var_x196) ? (var_x203 + var_x204 + 1999999.9999424887 * (45.000000249999999 + var_chaste_interface__membrane__V) * (-var_x203 - 4.1800000005842713e-6 * var_x190)) : (var_x202 + var_x204)));
        ...
        const double var_x220 = 3.3960000000976542e-6 * var_x206;
        const double var_x221 = ((var_x209) ? (var_x220 - 1249999.9999640554 * (17.999999599999999 + var_chaste_interface__membrane__V) * (-var_x220 - 3.3960000000976542e-6 * var_x207)) : (var_x208 * var_x213));
        ...
        IJth(rJacobian, 2, 2) = -0.001 * ((var_x152) ? (var_x156 + 394539.57232025318 * (44.400001267299999 + var_chaste_interface__membrane__V) * (-var_x156 - 0.00058295799999830145 * var_x150)) : (-var_x151 * var_x155)) - 18.399999999999999 * var_x153;
