...
bool Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::registered = ModelFactory::Register("dynamic_Shannon2004", "AnalyticCvode", (ModelFactory::TCreateMethod)Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::CreateMethod);
    ...
    void Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_ICaL_f_gate__tau_f = 1 / (0.02 + 0.019699999999999999 * exp(-pow((0.48865000000000003 + 0.033700000000000001 * var_chaste_interface__cell__V), 2))); // millisecond
    ...
    void Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x35 = 1.02 * var_x28 + var_x31 * var_x34;
        const double var_x36 = 1 / var_x35;
        const double var_x37 = 0.4389381125701739 * var_x28;
        const double var_x38 = 1 + 1.6777215999999998e-11 / pow(var_chaste_interface__Ca_buffer__Ca_jct, 3);
        const double var_x39 = 1 / var_x38;
        const double var_x40 = 0.11 * var_x39;
        ...
        const double var_x43 = exp(0.34999999999999998 * var_x42 * var_chaste_interface__cell__V);
        const double var_x44 = pow(var_chaste_interface__Na_buffer__Na_jct, 3);
        ...
        const double var_x50 = pow(NV_Ith_S(mParameters, 9), 3);
        ...
        const double var_x54 = 0.0035899999999999999 * var_x50;
        const double var_x55 = var_x45 + var_x51 + 1.3 * var_x44 + var_x54 * (1 + 0.00053869674493876331 * var_x44) + 669921.875 * (1 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_jct) * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x56 = 1 / var_x55;
        const double var_x57 = 1 + 0.27000000000000002 * var_x49;
        const double var_x58 = 1 / var_x57;
        const double var_x59 = -31 + 0.10000000000000001 * NV_Ith_S(mParameters, 23);
        const double var_x60 = pow(1.5700000000000001, var_x59);
        const double var_x61 = var_x60 * NV_Ith_S(mParameters, 22);
        const double var_x62 = var_x58 * var_x61;
        const double var_x63 = var_x56 * var_x62;
        const double var_x64 = var_x63 * (var_x46 * var_x47 + var_x52 * var_x53);
        const double var_x65 = 1 + 1.6777215999999998e-11 / pow(var_chaste_interface__Ca_buffer__Ca_SL, 3);
        const double var_x66 = 1 / var_x65;
        const double var_x67 = 0.89000000000000001 * var_x66;
        const double var_x68 = pow(var_chaste_interface__Na_buffer__Na_SL, 3);
        const double var_x69 = var_x68 * NV_Ith_S(mParameters, 6);
        const double var_x70 = var_x43 * var_x69;
        const double var_x71 = var_x50 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x72 = var_x49 * var_x71;
        const double var_x73 = var_x69 + var_x71 + 1.3 * var_x68 + var_x54 * (1 + 0.00053869674493876331 * var_x68) + 669921.875 * (1 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_SL) * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x74 = 1 / var_x73;
        const double var_x75 = var_x62 * var_x74;
        const double var_x76 = var_x75 * (var_x47 * var_x70 + var_x53 * var_x72);
        const double var_x77 = 1 / var_chaste_interface__Na_buffer__Na_jct;
        const double var_x78 = pow(var_x77, 4);
        const double var_x79 = pow(1.49, (-124 + 0.40000000000000002 * NV_Ith_S(mParameters, 23)));
        const double var_x80 = 14641 * var_x79;
        const double var_x81 = 1 + var_x78 * var_x80;
        const double var_x82 = 0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x83 = exp(-var_x42 * var_x82);
        const double var_x84 = 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * NV_Ith_S(mParameters, 9))) * exp(-var_x48);
        const double var_x85 = 1 + var_x84 + 0.1245 * var_x83;
        const double var_x86 = pow(1.6299999999999999, var_x59) * NV_Ith_S(mParameters, 8) / (1.5 + NV_Ith_S(mParameters, 8));
        const double var_x87 = var_x86 * (var_x42 * var_x84 + 0.012450000000000001 * var_x42 * var_x83) / pow(var_x85, 2);
        const double var_x88 = var_x87 / var_x81;
        const double var_x89 = 1 / var_chaste_interface__Na_buffer__Na_SL;
        const double var_x90 = pow(var_x89, 4);
        const double var_x91 = 1 + var_x80 * var_x90;
        const double var_x92 = var_x87 / var_x91;
        const double var_x93 = pow(var_x27, (-2));
        const double var_x94 = -var_x25 + var_chaste_interface__cell__V;
        const double var_x95 = var_x15 * var_x94;
        const double var_x96 = exp(var_x48);
        const double var_x97 = 0.75 * var_x96;
        const double var_x98 = -0.75 * NV_Ith_S(mParameters, 8) + var_x97 * NV_Ith_S(mParameters, 5);
        const double var_x99 = var_x41 * pow(NV_Ith_S(mParameters, 10), 2);
        const double var_x100 = -1 + var_x96;
        const double var_x101 = 1 / var_x100;
        const double var_x102 = pow(1.8, var_x59);
        const double var_x103 = var_x102 * var_chaste_interface__ICaL_f_gate__f;
        const double var_x104 = var_x103 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x105 = var_x101 * var_x104;
        const double var_x106 = var_x105 * var_x99;
        const double var_x107 = var_x106 * var_x98;
        const double var_x108 = 1 - 0.10000000000000001 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL - 0.90000000000000002 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        const double var_x109 = 1.215e-7 * var_x108;
        const double var_x110 = var_x70 - var_x72;
        const double var_x111 = var_x42 * var_x49 * var_x61 / pow(var_x57, 2);
        const double var_x112 = var_x110 * var_x111 * var_x66 * var_x74;
        const double var_x113 = var_x46 - var_x52;
        const double var_x114 = var_x111 * var_x113 * var_x39 * var_x56;
        const double var_x115 = 1 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL;
        const double var_x116 = exp(2 * var_x48);
        const double var_x117 = -1 + var_x116;
        const double var_x118 = NV_Ith_S(mParameters, 12) / var_x117;
        const double var_x119 = var_x104 * var_x118;
        ...
        const double var_x125 = var_x120 * var_x124 * var_x99;
        const double var_x126 = 1 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        const double var_x127 = var_x126 * var_x99;
        ...
        const double var_x132 = var_x105 * var_x96;
        ...
        const double var_x137 = pow(var_x100, (-2));
        ...
        const double var_x142 = var_x104 * var_x136;
        ...
        const double var_x148 = var_x147 + var_x97 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x149 = var_x115 * var_x148;
        const double var_x150 = 6.7499999999999994e-10 * var_x149;
        const double var_x151 = 5.0624999999999998e-10 * var_x115 * var_x96;
        const double var_x152 = var_x137 * var_x142 * var_x96;
        const double var_x153 = var_x106 * var_x150 - var_x150 * var_x152 + var_x105 * var_x136 * var_x151 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x154 = var_x147 + var_x97 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x155 = var_x105 * var_x154;
        ...
        const double var_x160 = -var_x24 * log(var_x77 * NV_Ith_S(mParameters, 9)) + var_chaste_interface__cell__V;
        const double var_x161 = 0.11 * var_x160;
        const double var_x162 = -var_x24 * log(var_x89 * NV_Ith_S(mParameters, 9)) + var_chaste_interface__cell__V;
        ...
        const double var_x172 = var_x94 * NV_Ith_S(mParameters, 21) * var_chaste_interface__Itos_X_gate__X_tos;
        const double var_x173 = var_x101 * var_chaste_interface__cell__V;
        const double var_x174 = var_x103 * var_x173;
        const double var_x175 = var_x154 * var_x156;
        const double var_x176 = var_x174 * var_x99;
        const double var_x177 = var_x109 * var_x98;
        const double var_x178 = var_x99 * var_chaste_interface__cell__V;
        const double var_x179 = var_x124 * var_x178;
        const double var_x180 = var_x103 * var_x118;
        ...
        const double var_x184 = var_x102 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x185 = var_x173 * var_x184;
        const double var_x186 = var_x185 * var_x99;
        const double var_x187 = var_x118 * var_x184;
        const double var_x188 = var_x115 * var_x187;
        const double var_x189 = var_x106 * var_chaste_interface__cell__V;
        const double var_x190 = var_x107 * var_chaste_interface__cell__V;
        const double var_x191 = pow(var_chaste_interface__Na_buffer__Na_SL, 2);
        const double var_x192 = 3 * NV_Ith_S(mParameters, 6);
        const double var_x193 = 5.8017639429904805e-6 * var_x50;
        const double var_x194 = -3.9000000000000004 * var_x191 - var_x191 * var_x192 - var_x191 * var_x193;
        const double var_x195 = var_x110 * var_x62 / pow(var_x73, 2);
        const double var_x196 = var_x195 * var_x67;
        const double var_x197 = 2.6699999999999999 * var_x66;
        const double var_x198 = var_x43 * NV_Ith_S(mParameters, 6);
        const double var_x199 = var_x191 * var_x198 * var_x75;
        const double var_x200 = var_x79 * var_x86 / var_x85;
        const double var_x201 = var_x200 * var_x89 * var_x90 / pow(var_x91, 2);
        const double var_x202 = var_x24 * var_x89;
        ...
        const double var_x207 = var_x113 * var_x62 / pow(var_x55, 2);
        const double var_x208 = var_x207 * var_x40;
        const double var_x209 = 0.33000000000000002 * var_x39;
        const double var_x210 = var_x198 * var_x205 * var_x63;
        const double var_x211 = var_x200 * var_x77 * var_x78 / pow(var_x81, 2);
        const double var_x212 = var_x24 * var_x77;
        const double var_x213 = 0.11 * var_x21;
        const double var_x214 = 3.2670000000000004e-5 * var_x212 + var_x157 * var_x182 + var_x212 * var_x213;
        const double var_x215 = var_x169 * var_x24;
        const double var_x216 = var_x24 * log(NV_Ith_S(mParameters, 7) / NV_Ith_S(mParameters, 4)) + var_chaste_interface__cell__V;
        const double var_x217 = 669921.875 + var_x50;
        const double var_x218 = -var_x217 - 373215529.24791086 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x219 = var_x170 * var_x9 / log(10);
        const double var_x220 = var_x110 * var_x75 / (pow(var_x65, 2) * pow(var_chaste_interface__Ca_buffer__Ca_SL, 4));
        const double var_x221 = pow(2.3500000000000001, var_x59);
        const double var_x222 = pow(var_x2, 1.6000000000000001);
        const double var_x223 = 0.00011182849999999999 * var_x2 * var_x24 + 0.061380000000000011 * var_x140 * var_x178 + 5.0104537825247566e-7 * var_x2 * var_x221 * var_x222 / pow((1 + 5.2281977629563632e-6 * var_x222), 2);
        const double var_x224 = pow(var_chaste_interface__Ca_buffer__Ca_jct, 2);
        const double var_x225 = -var_x217 - 373215529.24791086 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x226 = var_x113 * var_x63 / (pow(var_x38, 2) * pow(var_chaste_interface__Ca_buffer__Ca_jct, 4));
        const double var_x227 = pow(var_x0, 1.6000000000000001);
        const double var_x228 = 1.38215e-5 * var_x0 * var_x24 + 0.55242000000000002 * var_x116 * var_x128 * var_chaste_interface__cell__V + 6.1926956862665531e-8 * var_x0 * var_x221 * var_x227 / pow((1 + 5.2281977629563632e-6 * var_x227), 2);
        const double var_x229 = 32.700000000000003 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC;
        const double var_x230 = 34 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Calmodulin;
        const double var_x231 = 100 * var_chaste_interface__cytosolic_Ca_buffer__Ca_SRB;
        const double var_x232 = pow(var_chaste_interface__Ca_buffer__Cai, 0.78699999999999992);
        const double var_x233 = 0.38742512113256738 * pow(var_chaste_interface__Ca_buffer__Ca_SR, 1.7869999999999999);
        const double var_x234 = pow(var_chaste_interface__Ca_buffer__Cai, 1.7869999999999999);
        const double var_x235 = 1 + var_x233 + 2814485.1633595936 * var_x234;
        const double var_x236 = 1 / var_x235;
        const double var_x237 = pow(2.6000000000000001, var_x59);
        const double var_x238 = var_x237 * NV_Ith_S(mParameters, 2);
        const double var_x239 = var_x236 * var_x238;
        const double var_x240 = var_x238 * (-var_x233 + 2814485.1633595936 * var_x234) / pow(var_x235, 2);
        const double var_x241 = var_x232 * var_x240;
        const double var_x242 = 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC_Ca_Mg + 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_TroponinC_Ca_Mg;
        const double var_x243 = 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Myosin + 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_Myosin;
        const double var_x244 = pow(var_chaste_interface__Ca_buffer__Ca_SR, 0.78699999999999992);
        const double var_x245 = var_x239 * var_x244;
        const double var_x246 = var_x240 * var_x244;
        const double var_x247 = 0.019599999999999999 + 32.700000000000003 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x248 = 2.3700000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x249 = 0.23799999999999999 + 34 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x250 = 13.800000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x251 = 100 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x252 = 0.059999999999999998 + var_x251;
        const double var_x253 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 16) - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x254 = var_chaste_interface__cell__V < -40;
        const double var_x255 = ((var_x254) ? (0.13500000000000001 * var_x253) : (0));
        const double var_x256 = exp(0.34999999999999998 * var_chaste_interface__cell__V - 0.34999999999999998 * NV_Ith_S(mParameters, 16));
        const double var_x257 = exp(0.079000000000000001 * var_chaste_interface__cell__V - 0.079000000000000001 * NV_Ith_S(mParameters, 16));
        const double var_x258 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 16) - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x259 = 1 + var_x258;
        const double var_x260 = ((var_x254) ? (310000 * var_x256 + 3.5600000000000001 * var_x257) : (7.6923076923076916 / var_x259));
        const double var_x261 = 1 * var_x255 + 1 * var_x260;
        const double var_x262 = ((var_x254) ? (-0.019852941176470591 * var_x253) : (0));
        const double var_x263 = var_x255 + var_x260;
        const double var_x264 = 0.01 * NV_Ith_S(mParameters, 15);
        const double var_x265 = 1 - var_x264;
        const double var_x266 = var_x265 / var_x263;
        const double var_x267 = ((var_x254) ? (0.28123999999999999 * var_x257 + 108500 * var_x256) : (0.693000693000693 * var_x258 / pow(var_x259, 2)));
        const double var_x268 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 16) - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x269 = 1 + var_x268;
        const double var_x270 = exp(0.01052 * NV_Ith_S(mParameters, 16) - 0.01052 * var_chaste_interface__cell__V);
        const double var_x271 = var_x270 / var_x269;
        const double var_x272 = exp(-3.2000000000000002 - var_x82 + 0.10000000000000001 * NV_Ith_S(mParameters, 16));
        const double var_x273 = 1 + var_x272;
        const double var_x274 = exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 16) - 2.5349999999999999e-7 * var_chaste_interface__cell__V);
        const double var_x275 = var_x274 / var_x273;
        const double var_x276 = ((var_x254) ? (0.1212 * var_x271) : (0.29999999999999999 * var_x275));
        const double var_x277 = 37.780000000000001 + var_chaste_interface__cell__V;
        const double var_x278 = exp(0.24440000000000001 * var_chaste_interface__cell__V - 0.24440000000000001 * NV_Ith_S(mParameters, 16));
        const double var_x279 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 16) - 0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x280 = -127140 * var_x278 - 3.4740000000000003e-5 * var_x279;
        const double var_x281 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V - 0.311 * NV_Ith_S(mParameters, 16));
        const double var_x282 = 1 + var_x281;
        const double var_x283 = 1 / var_x282;
        const double var_x284 = var_x280 * var_x283;
        const double var_x285 = ((var_x254) ? (var_x277 * var_x284) : (0));
        const double var_x286 = 1 * var_x276 + 1 * var_x285;
        const double var_x287 = ((var_x254) ? (var_x284 + var_x277 * var_x283 * (1.5254334000000001e-6 * var_x279 - 31073.016 * var_x278) - 0.311 * var_x277 * var_x280 * var_x281 / pow(var_x282, 2)) : (0));
        const double var_x288 = var_x276 + var_x285;
        const double var_x289 = var_x265 / var_x288;
        const double var_x290 = ((var_x254) ? (-0.001275024 * var_x271 + 0.016701360000000002 * var_x268 * var_x270 / pow(var_x269, 2)) : (-7.6049999999999996e-8 * var_x275 + 0.029999999999999999 * var_x272 * var_x274 / pow(var_x273, 2)));
        const double var_x291 = exp(-4.7130000000000001 - var_x82);
        const double var_x292 = 1 - var_x291;
        const double var_x293 = 1 / var_x292;
        const double var_x294 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x295 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x296 = 0.32000000000000001 * var_x293;
        const double var_x297 = var_x295 * var_x296;
        const double var_x298 = var_x297 + 0.080000000000000002 * var_x294;
        const double var_x299 = 1 / var_x298;
        const double var_x300 = 0.032000000000000001 * var_x291 * var_x295 / pow(var_x292, 2);
        const double var_x301 = var_x300 + 0.0072727272727272727 * var_x294 - 0.32000000000000001 * var_x293;
        const double var_x302 = exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x303 = 1 + var_x302;
        const double var_x304 = exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V);
        const double var_x305 = -1 + var_x304;
        const double var_x306 = 1 / var_x305;
        const double var_x307 = exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V);
        const double var_x308 = 1 - var_x307;
        const double var_x309 = 1 / var_x308;
        const double var_x310 = 7 + var_chaste_interface__cell__V;
        const double var_x311 = 10 + var_chaste_interface__cell__V;
        const double var_x312 = 0.00060999999999999997 * var_x306 * var_x311 + 0.0013799999999999999 * var_x309 * var_x310;
        const double var_x313 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        const double var_x314 = 1 + var_x313;
        const double var_x315 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V);
        const double var_x316 = -1 + var_x315;
        const double var_x317 = 1 / var_x316;
        const double var_x318 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V);
        const double var_x319 = 1 - var_x318;
        const double var_x320 = 1 / var_x319;
        const double var_x321 = 30 + var_chaste_interface__cell__V;
        const double var_x322 = 0.00013100000000000001 * var_x317 * var_x321 + 7.1899999999999999e-5 * var_x320 * var_x321;
        const double var_x323 = 0.20000000000000001 + 0.066666666666666666 * var_chaste_interface__cell__V;
        const double var_x324 = exp(var_x323);
        const double var_x325 = 1 + var_x324;
        const double var_x326 = 0.5 + 9 / var_x325;
        const double var_x327 = 1 / var_x326;
        const double var_x328 = exp(-var_x323);
        const double var_x329 = 1 + var_x328;
        const double var_x330 = 0.066666666666666666 * var_x328 / pow(var_x329, 2);
        const double var_x331 = -1 / var_x329;
        const double var_x332 = 0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x333 = exp(6 + var_x332);
        const double var_x334 = 1 + var_x333;
        const double var_x335 = 1 / var_x334;
        const double var_x336 = 30 + 3000 * var_x335;
        const double var_x337 = 1 / var_x336;
        const double var_x338 = exp(3.3500000000000001 + var_x332);
        const double var_x339 = 1 + var_x338;
        const double var_x340 = pow(var_x339, (-2));
        const double var_x341 = 0.10000000000000001 * var_x338 * var_x340;
        const double var_x342 = pow(var_x334, (-2));
        const double var_x343 = 1 / var_x339;
        const double var_x344 = -1 * var_x343;
        const double var_x345 = 220 + 2800 * var_x335;
        const double var_x346 = 1 / var_x345;
        const double var_x347 = exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2));
        const double var_x348 = 1.5 + 3.5 * var_x347;
        const double var_x349 = 1 / var_x348;
        const double var_x350 = 20 + 20 * var_x343;
        const double var_x351 = 1 / var_x350;
        const double var_x352 = exp(-2.4166666666666665 - 0.16666666666666666 * var_chaste_interface__cell__V);
        const double var_x353 = 1 - var_x352;
        const double var_x354 = 1 / var_x353;
        const double var_x355 = 1 + var_x352;
        const double var_x356 = 1 / var_x355;
        const double var_x357 = -var_chaste_interface__ICaL_d_gate__d + 1 * var_x356;
        const double var_x358 = 14.5 + var_chaste_interface__cell__V;
        const double var_x359 = 0.0058333333333333336 * var_x352 * var_x358;
        const double var_x360 = 0.019699999999999999 * exp(-pow((0.48865000000000003 + 0.033700000000000001 * var_chaste_interface__cell__V), 2));
        const double var_x361 = 0.02 + var_x360;
        const double var_x362 = exp(9.7388888888888889 + 0.27777777777777779 * var_chaste_interface__cell__V);
        const double var_x363 = 1 + var_x362;
        const double var_x364 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x365 = 1 + var_x364;
        const double var_x366 = 1 / var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x367 = pow(var_x366, 2.5);
        const double var_x368 = 1 + 0.13584112963311223 * var_x367;
        const double var_x369 = 1 / var_x368;
        const double var_x370 = 7.5 - 7 * var_x369;
        const double var_x371 = var_x370 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x372 = 15 - 14 * var_x369;
        const double var_x373 = 1 / var_x372;
        const double var_x374 = 10 * var_x224 * var_x373;
        const double var_x375 = pow(var_x368, (-2));
        const double var_x376 = var_x366 * var_x367 * var_x375;
        const double var_x377 = 47.544395371589282 * var_x224 * var_x376 / pow(var_x372, 2);
        const double var_x378 = var_x377 * var_chaste_interface__Jrel_SR__R;
        const double var_x379 = 20 * var_x373;
        const double var_x380 = var_x379 * var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__R;
        const double var_x381 = 2.3772197685794643 * var_x376 * var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__O;
        const double var_x382 = 1 - var_chaste_interface__Jrel_SR__I - var_chaste_interface__Jrel_SR__O - var_chaste_interface__Jrel_SR__R;
        const double var_x383 = var_x370 * var_chaste_interface__Jrel_SR__O;
        const double var_x384 = var_x66 * var_x76;
        const double var_x385 = M_PI * var_x23;
        const double var_x386 = 62.109246076532294 * var_x385;
        const double var_x387 = var_x386 * NV_Ith_S(mParameters, 3);
        const double var_x388 = var_x385 * NV_Ith_S(mParameters, 3);
        const double var_x389 = var_x20 * var_x388;
        const double var_x390 = 55.277229008113743 * var_x162;
        const double var_x391 = var_x165 * var_x388;
        const double var_x392 = var_x101 * var_x103;
        const double var_x393 = M_PI * var_x48;
        const double var_x394 = var_x393 * NV_Ith_S(mParameters, 3);
        const double var_x395 = 4.1923741101659298e-8 * var_x394;
        const double var_x396 = var_x149 * var_x395;
        const double var_x397 = var_x101 * var_x184;
        const double var_x398 = 0.0001 * var_chaste_interface__Na_buffer__Na_SL_buf;
        const double var_x399 = var_x195 * var_x197;
        const double var_x400 = var_x199 * var_x66;
        const double var_x401 = 0.001 + 0.0001 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x402 = var_x49 * var_x50;
        const double var_x403 = var_x402 * var_x75;
        const double var_x404 = var_x39 * var_x64;
        const double var_x405 = 2435.6567088836191 * var_x385;
        const double var_x406 = var_x405 * NV_Ith_S(mParameters, 3);
        const double var_x407 = 267.92223797719811 * var_x160;
        const double var_x408 = 1.4796614506467986e-5 * var_x394;
        const double var_x409 = var_x158 * var_x408;
        const double var_x410 = 0.0001 * var_chaste_interface__Na_buffer__Na_jct_buf;
        const double var_x411 = var_x207 * var_x209;
        const double var_x412 = var_x210 * var_x39;
        const double var_x413 = 0.001 + 0.0001 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x414 = var_x402 * var_x63;
        const double var_x415 = 0.076376893524206985 * NV_Ith_S(mParameters, 3);
        const double var_x416 = (-var_chaste_interface__Ca_buffer__Ca_jct + var_chaste_interface__Ca_buffer__Ca_SR) * NV_Ith_S(mParameters, 1);
        const double var_x417 = 100 * var_chaste_interface__Ca_buffer__Ca_Calsequestrin;
        const double var_x418 = var_chaste_interface__Jrel_SR__O * NV_Ith_S(mParameters, 1);
        const double var_x419 = var_x418 + 18.571428571428569 * NV_Ith_S(mParameters, 0);
        const double var_x420 = 65 + 100 * var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x421 = 31.054623038266147 * var_x385;
        const double var_x422 = 5.5898321468879066 * var_x123 * var_x393;
        const double var_x423 = 1.78 * var_x66;
        const double var_x424 = var_x195 * var_x423;
        const double var_x425 = 100 * var_chaste_interface__Ca_buffer__Ca_SLB_SL;
        const double var_x426 = 100 * var_chaste_interface__Ca_buffer__Ca_SLHigh_SL;
        const double var_x427 = 100 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x428 = 1.3 + var_x427;
        const double var_x429 = 0.029999999999999999 + var_x427;
        const double var_x430 = 1217.8283544418096 * var_x385;
        const double var_x431 = 1972.8819341957317 * var_x393;
        const double var_x432 = var_x145 * var_x431;
        const double var_x433 = 0.22 * var_x39;
        const double var_x434 = var_x207 * var_x433;
        const double var_x435 = 68.627450980392155 * var_x418 + 1274.5098039215686 * NV_Ith_S(mParameters, 0);
        const double var_x436 = 100 * var_chaste_interface__Ca_buffer__Ca_SLB_jct;
        const double var_x437 = 100 * var_chaste_interface__Ca_buffer__Ca_SLHigh_jct;
        const double var_x438 = 100 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x439 = 1.3 + var_x438;
        const double var_x440 = 0.029999999999999999 + var_x438;
        const double var_x441 = 0.025000000000000001 - var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_Cytosol;
        const double var_x442 = -var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_Cytosol - 0.030769230769230767 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL - 0.00078461538461538469 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x443 = 100 * var_x442;
        const double var_x444 = var_x441 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x445 = 0.025024999999999999 - var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL;
        const double var_x446 = var_x445 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x447 = 0.025490196078431372 - var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x448 = var_x447 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x449 = 0.025000000000000001 - var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol;
        const double var_x450 = -var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol - 0.030769230769230767 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL - 0.00078461538461538469 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        const double var_x451 = 100 * var_x450;
        const double var_x452 = var_x449 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x453 = 0.025024999999999999 - var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL;
        const double var_x454 = var_x453 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x455 = 0.025490196078431372 - var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        const double var_x456 = var_x455 * var_chaste_interface__Ca_buffer__Ca_jct;
        ...
        IJth(rJacobian, 2, 0) = var_x261 * (var_x262 * var_x266 + var_x255 * var_x265 * (-var_x262 - var_x267) / pow(var_x263, 2)) + (1 * var_x262 + 1 * var_x267) * (var_x264 - var_chaste_interface__INa_h_gate__h + var_x255 * var_x266);
        IJth(rJacobian, 3, 0) = var_x286 * (var_x287 * var_x289 + var_x265 * var_x285 * (-var_x287 - var_x290) / pow(var_x288, 2)) + (1 * var_x287 + 1 * var_x290) * (var_x264 - var_chaste_interface__INa_j_gate__j + var_x285 * var_x289);
        IJth(rJacobian, 4, 0) = var_x298 * (var_x296 * var_x299 - var_x299 * var_x300 + var_x297 * var_x301 / pow(var_x298, 2)) - var_x301 * (-var_chaste_interface__INa_m_gate__m + 0.32000000000000001 * var_x293 * var_x295 * var_x299);
        IJth(rJacobian, 5, 0) = (-var_chaste_interface__IKr_Xr_gate__Xr + 1 / var_x303) * (0.00060999999999999997 * var_x306 + 0.0013799999999999999 * var_x309 - 0.00016973999999999998 * var_x307 * var_x310 / pow(var_x308, 2) - 8.8449999999999995e-5 * var_x304 * var_x311 / pow(var_x305, 2)) + 0.13333333333333333 * var_x302 * var_x312 / pow(var_x303, 2);
        IJth(rJacobian, 6, 0) = (-var_chaste_interface__IKs_Xs_gate__Xs + 1 / var_x314) * (0.00013100000000000001 * var_x317 + 7.1899999999999999e-5 * var_x320 - 8.9997000000000013e-6 * var_x315 * var_x321 / pow(var_x316, 2) - 1.0641199999999999e-5 * var_x318 * var_x321 / pow(var_x319, 2)) + 0.059880239520958084 * var_x313 * var_x322 / pow(var_x314, 2);
        IJth(rJacobian, 7, 0) = var_x327 * var_x330 + 0.59999999999999998 * var_x324 * (-var_x331 - var_chaste_interface__Itos_X_gate__X_tos) / (pow(var_x325, 2) * pow(var_x326, 2));
        IJth(rJacobian, 8, 0) = -var_x337 * var_x341 + 300 * var_x333 * var_x342 * (-var_x344 - var_chaste_interface__Itos_Y_gate__Y_tos) / pow(var_x336, 2);
        IJth(rJacobian, 9, 0) = -var_x341 * var_x346 + 280 * var_x333 * var_x342 * (-var_x344 - var_chaste_interface__Itos_R_gate__R_tos) / pow(var_x345, 2);
        IJth(rJacobian, 10, 0) = var_x330 * var_x349 + 0.0077777777777777776 * var_x347 * (-var_x331 - var_chaste_interface__Itof_X_gate__X_tof) * var_chaste_interface__cell__V / pow(var_x348, 2);
        IJth(rJacobian, 11, 0) = -var_x341 * var_x351 + 2 * var_x338 * var_x340 * (-var_x344 - var_chaste_interface__Itof_Y_gate__Y_tof) / pow(var_x350, 2);
        IJth(rJacobian, 12, 0) = -var_x354 * var_x357 * var_x359 + 0.035000000000000003 * var_x354 * var_x355 * var_x357 - var_x355 * var_x357 * var_x359 / pow(var_x353, 2) + 0.0058333333333333336 * var_x352 * var_x354 * var_x356 * var_x358;
        IJth(rJacobian, 13, 0) = var_x361 * (0.029999999999999999 * var_x364 / pow(var_x365, 2) - 0.27777777777777779 * var_x362 / pow(var_x363, 2)) + var_x360 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__cell__V) * (-var_chaste_interface__ICaL_f_gate__f + 1 / var_x363 + 0.59999999999999998 / var_x365);
        IJth(rJacobian, 19, 0) = -var_x387 * (0.00026433000000000001 + var_x153 + var_x203 + 2.6699999999999999 * var_x384 + 5.0996999999999995 * var_x92 + 0.46858500000000003 * var_x112);
        IJth(rJacobian, 20, 0) = -var_x406 * (3.2670000000000004e-5 + var_x159 + var_x213 + 0.33000000000000002 * var_x404 + 0.63029999999999997 * var_x88 + 0.057915000000000008 * var_x114);
        IJth(rJacobian, 25, 0) = -var_x421 * (0.00022365699999999999 + var_x125 + var_x141 - var_x144 - 1.78 * var_x384 - 0.31239000000000006 * var_x112);
        IJth(rJacobian, 26, 0) = -var_x430 * (2.7642999999999999e-5 + var_x131 + var_x139 - var_x146 - 0.22 * var_x404 - 0.038610000000000005 * var_x114);
        IJth(rJacobian, 1, 1) = -7.2523935948689155 + var_x229 + var_x230 + var_x231 + var_x242 + var_x243 + 5029484.9869235931 * var_x241 - 5029484.9869235931 * var_x232 * var_x239;
        IJth(rJacobian, 24, 1) = -93404721.185723871 * var_x241 + 93404721.185723871 * var_x232 * var_x236 * var_x237 * NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 25, 1) = 5.6417918332397381;
        IJth(rJacobian, 32, 1) = 2.2890000000000006 - var_x229;
        IJth(rJacobian, 33, 1) = 0.33180000000000004 - var_x242;
        IJth(rJacobian, 35, 1) = 0.81600000000000006 - var_x230;
        IJth(rJacobian, 36, 1) = 1.9320000000000004 - var_x243;
        IJth(rJacobian, 38, 1) = 1.71 - var_x231;
        IJth(rJacobian, 39, 1) = var_x441 * var_x443;
        IJth(rJacobian, 42, 1) = var_x449 * var_x451;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x161 * var_x20 - var_x163 * var_x20);
        IJth(rJacobian, 2, 2) = -var_x261;
        IJth(rJacobian, 19, 2) = -var_x389 * var_x390;
        IJth(rJacobian, 20, 2) = -var_x389 * var_x407;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x161 * var_x165 - var_x163 * var_x165);
        IJth(rJacobian, 3, 3) = -var_x286;
        IJth(rJacobian, 19, 3) = -var_x390 * var_x391;
        IJth(rJacobian, 20, 3) = -var_x391 * var_x407;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.33000000000000002 * var_x167 - 2.6699999999999999 * var_x168);
        IJth(rJacobian, 4, 4) = -var_x298;
        IJth(rJacobian, 19, 4) = -165.83168702434122 * var_x168 * var_x388;
        IJth(rJacobian, 20, 4) = -803.76671393159438 * var_x167 * var_x388;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x18 * var_x95 * NV_Ith_S(mParameters, 19));
        IJth(rJacobian, 5, 5) = -var_x312;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.22 * var_x171 * var_x8 - 1.78 * var_x13 * var_x171);
        IJth(rJacobian, 6, 6) = -var_x322;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x4 * var_x94);
        IJth(rJacobian, 7, 7) = -var_x327;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x172);
        IJth(rJacobian, 8, 8) = -var_x337;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.5 * var_x172);
        IJth(rJacobian, 9, 9) = -var_x346;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x5 * var_x94);
        IJth(rJacobian, 10, 10) = -var_x349;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x94 * NV_Ith_S(mParameters, 17) * var_chaste_interface__Itof_X_gate__X_tof);
        IJth(rJacobian, 11, 11) = -var_x351;
        ...
        IJth(rJacobian, 12, 12) = -0.035000000000000003 * var_x354 * var_x355 * var_x358;
        IJth(rJacobian, 19, 12) = -var_x392 * var_x396;
        IJth(rJacobian, 20, 12) = -var_x392 * var_x409;
        IJth(rJacobian, 25, 12) = -var_x181 * var_x422;
        IJth(rJacobian, 26, 12) = -var_x180 * var_x432;
        ...
        IJth(rJacobian, 13, 13) = -var_x361;
        IJth(rJacobian, 19, 13) = -var_x396 * var_x397;
        IJth(rJacobian, 20, 13) = -var_x397 * var_x409;
        IJth(rJacobian, 25, 13) = -var_x188 * var_x422;
        IJth(rJacobian, 26, 13) = -var_x187 * var_x432;
        ...
        IJth(rJacobian, 19, 14) = var_x105 * var_x148 * var_x395;
        IJth(rJacobian, 25, 14) = var_x119 * var_x422;
        ...
        IJth(rJacobian, 20, 15) = var_x155 * var_x408;
        IJth(rJacobian, 26, 15) = var_x119 * var_x129 * var_x431;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 - var_x371 - var_x374;
        IJth(rJacobian, 17, 16) = -var_x374;
        IJth(rJacobian, 18, 16) = var_x374;
        IJth(rJacobian, 16, 17) = -0.0050000000000000001;
        IJth(rJacobian, 17, 17) = -0.065000000000000002 - var_x374;
        IJth(rJacobian, 18, 17) = 0.0050000000000000001;
        IJth(rJacobian, 16, 18) = 0.055;
        IJth(rJacobian, 17, 18) = var_x371 - var_x374;
        IJth(rJacobian, 18, 18) = -0.059999999999999998 - var_x371;
        IJth(rJacobian, 24, 18) = -var_x416;
        IJth(rJacobian, 26, 18) = 68.627450980392155 * var_x416;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x204 - 99552.943599999999 * var_x201 - var_x194 * var_x196 - var_x197 * var_x199);
        IJth(rJacobian, 19, 19) = (-2.5101556644976917 + var_x398 - var_x386 * (var_x204 + 8.0099999999999998 * var_x400 + 298658.8308 * var_x201 + var_x194 * var_x399)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 20, 19) = 1.0879068612142859 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 19) = 0.000165 - var_x398;
        IJth(rJacobian, 23, 19) = var_x415;
        IJth(rJacobian, 25, 19) = -var_x421 * (-5.3399999999999999 * var_x400 - var_x194 * var_x424);
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x214 - 12304.296399999999 * var_x211 - var_x206 * var_x208 - var_x209 * var_x210);
        IJth(rJacobian, 19, 20) = 0.02774162496096429 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 20, 20) = (-1.0886629612142857 + var_x410 - var_x405 * (var_x214 + 0.98999999999999999 * var_x412 + 36912.889199999998 * var_x211 + var_x206 * var_x411)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 20) = 0.0007561 - var_x410;
        IJth(rJacobian, 26, 20) = -var_x430 * (-0.66000000000000003 * var_x412 - var_x206 * var_x434);
        IJth(rJacobian, 19, 21) = var_x401 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 21) = -var_x401;
        IJth(rJacobian, 20, 22) = var_x413 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 22) = -var_x413;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0020162999999999999 * var_x10 * var_x215 - 0.0163137 * var_x14 * var_x215);
        IJth(rJacobian, 19, 23) = 2.4822490395367272 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 23) = -var_x415;
        IJth(rJacobian, 1, 24) = 0.69232869146389786 * var_x245 + 0.69232869146389786 * var_x246;
        IJth(rJacobian, 16, 24) = -var_x378 + 2.3772197685794643 * var_x366 * var_x367 * var_x375 * var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__R;
        IJth(rJacobian, 17, 24) = -var_x381 + var_x377 * var_x382;
        IJth(rJacobian, 18, 24) = var_x378 + var_x381;
        IJth(rJacobian, 24, 24) = -260 + var_x417 - var_x419 - 12.857532841472388 * var_x245 - 12.857532841472388 * var_x246;
        IJth(rJacobian, 26, 24) = var_x435;
        IJth(rJacobian, 31, 24) = 260 - var_x417;
        ...
        IJth(rJacobian, 19, 25) = -var_x387 * (1.3438550016e-10 * var_x220 + var_x218 * var_x399 - var_x197 * var_x403);
        IJth(rJacobian, 25, 25) = -171.99023312516786 + var_x425 + var_x426 - var_x421 * (var_x223 - 8.9590333439999989e-11 * var_x220 + var_x403 * var_x423 - var_x218 * var_x424);
        IJth(rJacobian, 26, 25) = 48.958482036396518;
        IJth(rJacobian, 27, 25) = 121.55000000000001 - var_x425;
        IJth(rJacobian, 29, 25) = 43.550000000000004 - var_x426;
        IJth(rJacobian, 40, 25) = var_x443 * var_x445;
        IJth(rJacobian, 43, 25) = var_x451 * var_x453;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x228 - 5.5364812799999996e-12 * var_x226 - var_x208 * var_x225 - 0.0012058750000000001 * var_x216 / (pow(var_x1, 2) * var_x224) - 0.034833333333333334 * var_x0 * var_x219 * var_x6 / pow(var_x7, 2) + 0.11 * var_x39 * var_x49 * var_x50 * var_x56 * var_x58 * var_x60 * NV_Ith_S(mParameters, 22));
        IJth(rJacobian, 15, 26) = 1.7 - 1.7 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        IJth(rJacobian, 16, 26) = -var_x380 - var_x370 * var_chaste_interface__Jrel_SR__R;
        IJth(rJacobian, 17, 26) = var_x383 + var_x379 * var_x382 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 18, 26) = var_x380 - var_x383;
        IJth(rJacobian, 20, 26) = -var_x406 * (1.6609443839999999e-11 * var_x226 + var_x225 * var_x411 - var_x209 * var_x414);
        IJth(rJacobian, 24, 26) = var_x419;
        IJth(rJacobian, 25, 26) = 1.2484412919281114;
        IJth(rJacobian, 26, 26) = -128.61534478149457 + var_x436 + var_x437 - var_x435 - var_x430 * (var_x228 - 1.1072962559999999e-11 * var_x226 + var_x414 * var_x433 - var_x225 * var_x434);
        IJth(rJacobian, 28, 26) = 58.627450980392155 - var_x436;
        IJth(rJacobian, 30, 26) = 21.029411764705884 - var_x437;
        IJth(rJacobian, 41, 26) = var_x443 * var_x447;
        IJth(rJacobian, 44, 26) = var_x451 * var_x455;
        IJth(rJacobian, 25, 27) = var_x428;
        IJth(rJacobian, 27, 27) = -var_x428;
        IJth(rJacobian, 26, 28) = var_x439;
        IJth(rJacobian, 28, 28) = -var_x439;
        IJth(rJacobian, 25, 29) = var_x429;
        IJth(rJacobian, 29, 29) = -var_x429;
        IJth(rJacobian, 26, 30) = var_x440;
        IJth(rJacobian, 30, 30) = -var_x440;
        IJth(rJacobian, 24, 31) = var_x420;
        IJth(rJacobian, 31, 31) = -var_x420;
        IJth(rJacobian, 1, 32) = var_x247;
        IJth(rJacobian, 32, 32) = -var_x247;
        IJth(rJacobian, 1, 33) = 0.003032 + var_x248;
        IJth(rJacobian, 33, 33) = -3.1999999999999999e-5 - var_x248;
        IJth(rJacobian, 34, 33) = -0.0030000000000000001;
        IJth(rJacobian, 1, 34) = 0.0063300000000000006 + var_x248;
        IJth(rJacobian, 33, 34) = -var_x248;
        IJth(rJacobian, 34, 34) = -0.0063300000000000006;
        IJth(rJacobian, 1, 35) = var_x249;
        IJth(rJacobian, 35, 35) = -var_x249;
        IJth(rJacobian, 1, 36) = 0.016159999999999997 + var_x250;
        IJth(rJacobian, 36, 36) = -0.00046000000000000001 - var_x250;
        IJth(rJacobian, 37, 36) = -0.015699999999999999;
        IJth(rJacobian, 1, 37) = 0.015757 + var_x250;
        IJth(rJacobian, 36, 37) = -var_x250;
        IJth(rJacobian, 37, 37) = -0.015757;
        IJth(rJacobian, 1, 38) = var_x252;
        IJth(rJacobian, 38, 38) = -var_x252;
        IJth(rJacobian, 39, 39) = -0.059999999999999998 - var_x251 * var_x441 - var_x251 * var_x442;
        IJth(rJacobian, 40, 39) = -var_x427 * var_x445;
        IJth(rJacobian, 41, 39) = -var_x438 * var_x447;
        IJth(rJacobian, 39, 40) = -3.0769230769230771 * var_x444;
        IJth(rJacobian, 40, 40) = -0.059999999999999998 - 3.0769230769230771 * var_x446 - var_x427 * var_x442;
        IJth(rJacobian, 41, 40) = -3.0769230769230771 * var_x448;
        IJth(rJacobian, 39, 41) = -0.078461538461538471 * var_x444;
        IJth(rJacobian, 40, 41) = -0.078461538461538471 * var_x446;
        IJth(rJacobian, 41, 41) = -0.059999999999999998 - 0.078461538461538471 * var_x448 - var_x438 * var_x442;
        IJth(rJacobian, 42, 42) = -0.11 - var_x251 * var_x449 - var_x251 * var_x450;
        IJth(rJacobian, 43, 42) = -var_x427 * var_x453;
        IJth(rJacobian, 44, 42) = -var_x438 * var_x455;
        IJth(rJacobian, 42, 43) = -3.0769230769230771 * var_x452;
        IJth(rJacobian, 43, 43) = -0.11 - 3.0769230769230771 * var_x454 - var_x427 * var_x450;
        IJth(rJacobian, 44, 43) = -3.0769230769230771 * var_x456;
        IJth(rJacobian, 42, 44) = -0.078461538461538471 * var_x452;
        IJth(rJacobian, 43, 44) = -0.078461538461538471 * var_x454;
        IJth(rJacobian, 44, 44) = -0.11 - 0.078461538461538471 * var_x456 - var_x438 * var_x450;
    }
