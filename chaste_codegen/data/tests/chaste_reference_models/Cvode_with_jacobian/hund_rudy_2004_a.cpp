...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhund_rudy_2004_aFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x214 = 1.0 - var_chaste_interface__INa__J;
        ...
        const double var_x232 = exp(0.59347181008902072 - 0.14836795252225518 * var_chaste_interface__cell__V);
        const double var_x233 = 1.0 + var_x232;
        const double var_x234 = 1 / (0.58999999999999997 + 0.80000000000000004 * var_x231);
        const double var_x235 = exp(-19.117647058823529 - 0.29411764705882354 * var_chaste_interface__cell__V);
        const double var_x236 = exp(2.4457142857142857 + 0.14285714285714285 * var_chaste_interface__cell__V);
        ...
        const double var_x240 = var_x236 / pow(var_x237, 2);
        const double var_x241 = var_x101 * var_chaste_interface__ICaL__fca;
        const double var_x242 = 5.2572936047118706 * var_x109;
        ...
        const double var_x250 = 0.0042724511494942495 * var_x249;
        const double var_x251 = var_x131 * var_x246;
        const double var_x252 = var_x132 * var_x246;
        const double var_x253 = var_x133 * var_chaste_interface__ICaL__fca;
        const double var_x254 = var_x253 * var_chaste_interface__ICaL__fca2;
        const double var_x255 = 0.0042724511494942495 * var_x248;
        const double var_x256 = var_x253 * var_chaste_interface__ICaL__f;
        const double var_x257 = var_x100 * var_x108;
        const double var_x258 = -10.0 * var_x182 - 10.0 * var_x184;
        const double var_x259 = 0.01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x243 + 0.29999999999999999 / (1.0 - 70.217303721661608 * var_x246)) / pow((0.050000000000000003 + var_x172 + 0.10000000000000001 * var_x243), 2);
        const double var_x260 = pow((0.0030000000000000001 + var_chaste_interface__Ca__Ca_ss), (-2));
        const double var_x261 = var_x108 * var_x157;
        const double var_x262 = 0.00075000000000000002 * var_x191 - 0.00075000000000000002 * var_x190;
        const double var_x263 = 26.286468023559355 * var_x109;
        ...
        const double var_x270 = 6.5716170058898387 * var_x109;
        ...
        const double var_x272 = 0.0028483007663294996 * var_x269;
        ...
        const double var_x275 = exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__cell__V);
        ...
        const double var_x287 = exp(0.4251012145748988 - 0.04048582995951417 * var_chaste_interface__cell__V);
        ...
        const double var_x300 = var_x293 + var_x297 - 4.6080000000000006e-5 * var_x294 * var_x298 / pow(var_x295, 2) - 0.00075871700000000012 * var_x290 * var_x299 / pow(var_x291, 2);
        const double var_x301 = var_x293 * var_x299;
        const double var_x302 = var_x297 * var_x298;
        const double var_x303 = var_x287 * (var_x301 + var_x302) / pow(var_x288, 2);
        ...
        const double var_x308 = 1.0 - 1.0 * var_chaste_interface__Ito__ydv;
        ...
        const double var_x312 = 1.0 * var_chaste_interface__Ito__ydv;
        const double var_x313 = 0.040000000000000001 * var_chaste_interface__Ito__ydv2;
        ...
        const double var_x321 = var_x319 / pow(var_x320, 2);
        const double var_x322 = 1 / var_x320;
        const double var_x323 = 0.02 * var_chaste_interface__Ito__zdv;
        const double var_x324 = 1.0 - var_chaste_interface__INal__mL;
        const double var_x325 = exp(14.918032786885247 + 0.16393442622950821 * var_chaste_interface__cell__V);
        const double var_x326 = 0.0025000000000000005 * var_x167;
        const double var_x327 = -1 + 0.066666666666666666 * var_chaste_interface__cell__V;
        const double var_x328 = pow(var_x99, (-2));
        const double var_x329 = pow(var_chaste_interface__ICaL__d, (-2 * var_chaste_interface__ICaL__dp));
        const double var_x330 = pow(var_chaste_interface__ICaL__f, (-2));
        const double var_x331 = pow(var_chaste_interface__ICaL__f2, (-2));
        const double var_x332 = pow(var_chaste_interface__ICaL__fca, (-2));
        const double var_x333 = pow(var_chaste_interface__ICaL__fca2, (-2));
        const double var_x334 = var_x104 * var_x328 * var_x329 * var_x330 * var_x331 * var_x332 * var_x333;
        const double var_x335 = pow(var_x327, (-2));
        const double var_x336 = var_x328 * var_x329 * var_x331 * var_x332 * var_x333 * var_x335;
        const double var_x337 = 5.399297452372711e-5 * var_x330;
        const double var_x338 = var_x104 * var_x329 * var_x331 * var_x333 * var_x335;
        const double var_x339 = var_x332 * var_x338 / pow(var_x99, 3);
        const double var_x340 = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999);
        const double var_x341 = 0.0028 + var_chaste_interface__Ca__Ca_ss;
        const double var_x342 = 1 / var_x341;
        const double var_x343 = pow((var_x342 * var_chaste_interface__Ca__Ca_ss), 1.8999999999999999);
        const double var_x344 = 1 / (var_x340 + 1644.6531773416521 * var_x343);
        const double var_x345 = var_x334 * var_x335;
        const double var_x346 = 1.0 + 0.00036056965579880955 * var_x345;
        const double var_x347 = var_x340 * var_x344 / pow(var_x346, 2);
        const double var_x348 = 0.00024037977053253972 * var_x347;
        const double var_x349 = var_x345 * var_x348;
        const double var_x350 = var_x104 * var_x348;
        const double var_x351 = var_x328 * var_x330;
        const double var_x352 = var_x329 * var_x332 * var_x335 * var_x350 * var_x351;
        const double var_x353 = 1 / var_x346;
        const double var_x354 = var_x353 / pow((var_x343 + 0.00060803092942449902 * var_x340), 2);
        ...
        const double var_x358 = exp(-16.0 + 80.0 * var_x357 + 40000.0 * var_chaste_interface__Ca__Ca_ss);
        ...
        const double var_x366 = var_x358 * var_x365 / pow(var_x359, 2);
        const double var_x367 = 17.524312015706236 * var_x109;
        const double var_x368 = var_x355 / pow(var_x356, 2);
        const double var_x369 = var_x368 * (234.05767907220539 * var_x241 + var_x111 * var_x367 - var_x105 * var_x367);
        const double var_x370 = (-var_chaste_interface__Irel__ri + 1.0 / var_x359) / pow((0.29999999999999999 + var_x172 + 0.10000000000000001 * var_x364), 2);
        const double var_x371 = var_x360 * var_x363 / pow(var_x361, 2);
        const double var_x372 = var_x370 * var_x371;
        const double var_x373 = 18724.614325776431 * var_x366;
        const double var_x374 = var_x368 * var_x373;
        const double var_x375 = 35.108651860830804 * var_x372;
        const double var_x376 = var_x368 * var_x375;
        const double var_x377 = var_x254 * var_x368;
        const double var_x378 = 0.01 * var_x370;
        const double var_x379 = var_x261 * var_x368;
        const double var_x380 = 3.998848287353967e-7 * var_x7;
        const double var_x381 = 0.00050754612877954204 * var_x38;
        ...
        const double var_x389 = 8.5232067604091287e-7 * var_x5;
        ...
        const double var_x393 = 1.1688941147650058e-5 * var_x81;
        ...
        const double var_x401 = 8.8885199344722979e-8 * var_x45;
        ...
        const double var_x405 = 3000.0 * var_x404;
        const double var_x406 = 0.70217303721661617 * var_x100;
        const double var_x407 = 0.052572936047118712 * var_x106;
        ...
        const double var_x413 = var_x412 * (var_x406 + var_x111 * var_x407 - var_x105 * var_x407);
        ...
        const double var_x417 = var_x411 * var_x414;
        ...
        const double var_x422 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x423 = var_x179 * var_x422;
        const double var_x424 = var_x174 * var_x422;
        const double var_x425 = 0.0002749177168957104 * var_x109;
        ...
        const double var_x431 = 0.0036718475849305066 * var_x429;
        const double var_x432 = 719.99999999999989 * var_x429;
        ...
        IJth(rJacobian, 2, 0) = ((var_x196) ? (-0.693000693000693 * var_x194 * var_chaste_interface__INa__H / pow(var_x195, 2)) : ((-0.28123999999999999 * var_x197 - 108500.0 * var_x198) * var_chaste_interface__INa__H - 0.14705882352941177 * var_x199 * (0.13500000000000001 - 0.13500000000000001 * var_chaste_interface__INa__H)));
        IJth(rJacobian, 3, 0) = var_x200 * var_x204 + var_x206 * var_chaste_interface__INa__m - var_x200 * var_x208;
        IJth(rJacobian, 4, 0) = ((var_x196) ? (7.6049999999999996e-8 * var_x213 * var_chaste_interface__INa__J - 0.029999999999999999 * var_x210 * var_x212 * var_chaste_interface__INa__J / pow(var_x211, 2)) : (var_x218 * var_x221 + 0.001275024 * var_x225 * var_chaste_interface__INa__J + var_x214 * var_x227 * (1.5254334000000001e-6 * var_x216 - 31073.016 * var_x215) - 0.311 * var_x218 * var_x219 * var_x226 / pow(var_x220, 2) - 0.016701360000000002 * var_x222 * var_x224 * var_chaste_interface__INa__J / pow(var_x223, 2)));
        IJth(rJacobian, 5, 0) = 1.5624999999999998 * (-var_chaste_interface__ICaL__d + 1.0 / var_x233) * (-0.041599999999999998 * var_x231 + 0.10560000000000001 * var_x228 * var_x230 / pow(var_x229, 2)) / pow((0.73749999999999993 + var_x231), 2) + 0.14836795252225518 * var_x232 * var_x234 / pow(var_x233, 2);
        IJth(rJacobian, 6, 0) = -0.23529411764705882 * var_x235 / pow((1.0 + var_x235), 2);
        IJth(rJacobian, 7, 0) = -0.099999999999999992 * var_x240 * (0.052900000000000003 + var_x239) + var_x239 * (0.039250169999999994 - 0.0040499999999999998 * var_chaste_interface__cell__V) * (0.29999999999999999 - var_chaste_interface__ICaL__f + 0.69999999999999996 * var_x238);
        IJth(rJacobian, 8, 0) = 6.0846129416049119e-5 * var_x249 * (70.217303721661608 * var_x241 + var_x111 * var_x242 - var_x105 * var_x242);
        IJth(rJacobian, 9, 0) = 8.1128172554732154e-6 * var_x269 * (351.08651860830804 * var_x241 + var_x111 * var_x263 - var_x105 * var_x263) + 0.0033333333333333335 * var_x271 * (-87.77162965207701 * var_x241 + var_x105 * var_x270 - var_x111 * var_x270);
        IJth(rJacobian, 10, 0) = -0.11 * var_x240 * (0.0054000000000000003 + var_x274) + var_x274 * (0.12930244120000001 - 0.0069619999999999994 * var_chaste_interface__cell__V) * (0.23000000000000001 - var_chaste_interface__ICaL__f2 + 0.77000000000000002 * var_x238);
        IJth(rJacobian, 11, 0) = (-var_chaste_interface__IKr__xr + 1.0 / var_x276) * (var_x279 + var_x282 - 8.1600000000000005e-5 * var_x280 * var_x283 / pow(var_x281, 2) - 4.566e-5 * var_x277 * var_x284 / pow(var_x278, 2)) + 0.23529411764705882 * var_x275 * (var_x285 + var_x286) / pow(var_x276, 2);
        IJth(rJacobian, 12, 0) = 0.04048582995951417 * var_x303 + var_x300 * (-var_chaste_interface__IKs__xs1 + 1.0 * var_x289);
        IJth(rJacobian, 13, 0) = 0.020242914979757085 * var_x303 + var_x300 * (0.5 * var_x289 - 0.5 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 14, 0) = var_x307 * var_x308 + var_x311 * var_x312 - var_x308 * pow(var_x305, 2) / pow(var_x306, 2) - var_x312 * pow(var_x309, 2) / pow(var_x310, 2);
        IJth(rJacobian, 15, 0) = var_x313 * var_x317 - var_x313 * var_x318 - 0.0060000000000000001 * var_x321 * (1.0 - var_chaste_interface__Ito__ydv2);
        IJth(rJacobian, 16, 0) = var_x317 * var_x323 - var_x318 * var_x323 - 0.00044999999999999999 * var_x321 * (1.0 - var_chaste_interface__Ito__zdv);
        IJth(rJacobian, 18, 0) = var_x204 * var_x324 + var_x206 * var_chaste_interface__INal__mL - var_x208 * var_x324;
        IJth(rJacobian, 19, 0) = -0.00027322404371584699 * var_x325 / pow((1.0 + var_x325), 2);
        IJth(rJacobian, 21, 0) = 0.33333333333333331 * var_x347 * (4.8075954106507941e-5 * var_x334 / pow(var_x327, 3) + var_x337 * var_x339 * var_x98 - var_x336 * var_x337 * var_x95 * var_x96);
        IJth(rJacobian, 22, 0) = 80.0 * var_x366 * var_x369 - 0.14999999999999999 * var_x369 * var_x372;
        IJth(rJacobian, 23, 0) = -8.9372253111180233e-5 * var_x53 - 5.456580259819789e-6 * var_x93 - 0.00083053002891197785 * var_x78 - var_x380 * var_chaste_interface__INal__hL - var_x381 * var_chaste_interface__INa__H;
        IJth(rJacobian, 24, 0) = var_x392 + 5.5345498444215123e-8 * var_x59 + 5.9581502074120151e-5 * var_x53 + 7.4830755604969202e-6 * var_x65 - 1.6979725035533768e-7 * var_x2 - 3.137557887000805e-5 * var_x29 - 3.8963137158833531e-8 * var_x90 - 2.8394189022631718e-8 * var_x56 - var_x389 * var_chaste_interface__IKr__xr - var_x393 * var_chaste_interface__Ito__ydv2 - var_x394 * var_x85;
        IJth(rJacobian, 25, 0) = 1.3842167148532964e-8 + 3.3274959682366304e-9 * var_x88 - 3.3274959682366302e-7 * var_x62 + var_x401 * var_chaste_interface__Ito2__AA;
        IJth(rJacobian, 26, 0) = var_x405 * var_x413;
        IJth(rJacobian, 28, 0) = var_x430 * (-719.99999999999989 * var_x413 - 0.0036718475849305066 * var_x241 + var_x105 * var_x425 - var_x111 * var_x425);
        ...
        IJth(rJacobian, 27, 1) = -var_x423 + 0.0043750000000000004 * var_x176;
        IJth(rJacobian, 28, 1) = 5.0 * var_x429;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * var_x39);
        IJth(rJacobian, 2, 2) = ((var_x196) ? (-7.6923076923076916 / var_x195) : (-310000.0 * var_x198 - 0.13500000000000001 * var_x199 - 3.5600000000000001 * var_x197));
        IJth(rJacobian, 23, 2) = -var_x126 * var_x381;
        ...
        IJth(rJacobian, 4, 4) = ((var_x196) ? (-0.29999999999999999 * var_x213) : (-0.1212 * var_x225 - var_x217 * var_x227));
        IJth(rJacobian, 23, 4) = -0.00050754612877954204 * var_x129;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x130 * var_x131);
        IJth(rJacobian, 5, 5) = -var_x234;
        IJth(rJacobian, 8, 5) = var_x250 * var_x251;
        IJth(rJacobian, 9, 5) = var_x251 * var_x272 - var_x251 * var_x273;
        IJth(rJacobian, 21, 5) = var_x131 * var_x349;
        IJth(rJacobian, 22, 5) = var_x251 * var_x374 - var_x251 * var_x376;
        IJth(rJacobian, 28, 5) = -var_x251 * var_x431;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x130 * var_x132);
        IJth(rJacobian, 6, 6) = -0.10000000000000001;
        IJth(rJacobian, 8, 6) = var_x250 * var_x252;
        IJth(rJacobian, 9, 6) = var_x252 * var_x272 - var_x252 * var_x273;
        IJth(rJacobian, 21, 6) = var_x132 * var_x349;
        IJth(rJacobian, 22, 6) = var_x252 * var_x374 - var_x252 * var_x376;
        IJth(rJacobian, 28, 6) = -var_x252 * var_x431;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x134 * var_chaste_interface__ICaL__fca2);
        IJth(rJacobian, 7, 7) = -0.052900000000000003 - var_x239;
        IJth(rJacobian, 8, 7) = var_x250 * var_x254;
        IJth(rJacobian, 9, 7) = var_x254 * var_x272 - var_x254 * var_x273;
        IJth(rJacobian, 21, 7) = var_x336 * var_x350 / pow(var_chaste_interface__ICaL__f, 3);
        IJth(rJacobian, 22, 7) = var_x373 * var_x377 - var_x375 * var_x377;
        IJth(rJacobian, 28, 7) = -var_x254 * var_x431;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-3.5108651860830804 * var_x135);
        IJth(rJacobian, 8, 8) = var_x245 * (-1 + var_x135 * var_x255);
        IJth(rJacobian, 9, 8) = var_x135 * var_x272 - var_x135 * var_x273;
        IJth(rJacobian, 21, 8) = var_x338 * var_x348 * var_x351 / pow(var_chaste_interface__ICaL__fca, 3);
        IJth(rJacobian, 22, 8) = var_x135 * var_x374 - var_x135 * var_x376;
        IJth(rJacobian, 28, 8) = -var_x135 * var_x431;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x134 * var_chaste_interface__ICaL__f);
        IJth(rJacobian, 8, 9) = var_x250 * var_x256;
        IJth(rJacobian, 9, 9) = var_x267 * (-1 + 0.0028483007663294996 * var_x256 * var_x268) - var_x256 * var_x273;
        IJth(rJacobian, 21, 9) = var_x331 * var_x352 / pow(var_chaste_interface__ICaL__fca2, 3);
        IJth(rJacobian, 22, 9) = var_x256 * var_x374 - var_x256 * var_x376;
        IJth(rJacobian, 28, 9) = -var_x256 * var_x431;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x100 * var_x136);
        IJth(rJacobian, 8, 10) = var_x250 * var_x257;
        IJth(rJacobian, 9, 10) = var_x257 * var_x272 - var_x257 * var_x273;
        IJth(rJacobian, 10, 10) = -0.0054000000000000003 - var_x274;
        IJth(rJacobian, 21, 10) = var_x333 * var_x352 / pow(var_chaste_interface__ICaL__f2, 3);
        IJth(rJacobian, 22, 10) = var_x257 * var_x374 - var_x257 * var_x376;
        IJth(rJacobian, 28, 10) = -var_x257 * var_x431;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * var_x6);
        IJth(rJacobian, 11, 11) = -var_x285 - var_x286;
        IJth(rJacobian, 24, 11) = -var_x389 * var_x55;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x121 * var_x35);
        IJth(rJacobian, 12, 12) = -var_x301 - var_x302;
        IJth(rJacobian, 24, 12) = var_x121 * var_x391;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x122 * var_x34);
        IJth(rJacobian, 13, 13) = -3.8050000000000003e-5 * var_x292 * var_x299 - 0.00018000000000000001 * var_x296 * var_x298;
        IJth(rJacobian, 24, 13) = var_x122 * var_x390;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-0.57000000000000006 * var_x138);
        IJth(rJacobian, 14, 14) = -25.0 * var_x307 - 25.0 * var_x311;
        IJth(rJacobian, 24, 14) = -3.5066823442950178e-5 * var_x138;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * var_x82);
        IJth(rJacobian, 15, 15) = -0.029999999999999999 * var_x322 - 0.20000000000000001 * var_x318;
        IJth(rJacobian, 24, 15) = -var_x393 * var_x55;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-0.19 * var_x139);
        IJth(rJacobian, 16, 16) = -0.10000000000000001 * var_x318 - 0.0022499999999999998 * var_x322;
        ...
        IJth(rJacobian, 25, 17) = var_x401 * var_chaste_interface__cell__V;
        ...
        IJth(rJacobian, 23, 19) = -var_x126 * var_x380;
        IJth(rJacobian, 1, 20) = var_x162 * (-var_x180 * var_x187 - var_x185 * var_x186);
        IJth(rJacobian, 8, 20) = var_x258 * var_x259;
        IJth(rJacobian, 20, 20) = -0.00068000000000000005 - var_x169 * var_x326 + var_x164 * var_x181 * var_x326;
        IJth(rJacobian, 22, 20) = var_x378 * (var_x258 - var_x258 * var_x362);
        IJth(rJacobian, 27, 20) = var_x185 * var_x424 + var_x187 * var_x423;
        IJth(rJacobian, 21, 21) = -0.33333333333333331;
        IJth(rJacobian, 26, 21) = -var_x405 * var_x416;
        IJth(rJacobian, 28, 21) = var_x416 * var_x432;
        IJth(rJacobian, 22, 22) = -var_x365;
        IJth(rJacobian, 26, 22) = -var_x405 * var_x417;
        IJth(rJacobian, 28, 22) = var_x417 * var_x432;
        ...
        IJth(rJacobian, 23, 23) = var_x387 + 4.9335731356566794e-16 * var_x144 - 1.7874450622236046e-6 * var_x141 - 1.068185898837083e-5 * var_x142 - 0.013557744100624516 * var_x143 - 0.0044848621561246801 * var_x147;
        IJth(rJacobian, 24, 23) = 3.9005476114801918 * var_x395 + 1.191630041482403e-6 * var_x141;
        IJth(rJacobian, 25, 23) = var_x387;
        ...
        IJth(rJacobian, 24, 24) = var_x399 + 212.79583259575517 * var_x395 + 0.00019989044893084398 * var_x153 - 4.535681662754383e-6 * var_x148 - 0.00031223895504468581 * var_x154 - 2.2767478584105716e-5 * var_x149 - 0.0008381150898567882 * var_x150 - var_x152 * var_x394;
        IJth(rJacobian, 25, 24) = var_x399;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (0.00601027620873753 * var_x155 - 0.001444800488100033 * var_x61);
        IJth(rJacobian, 23, 25) = var_x388;
        IJth(rJacobian, 24, 25) = var_x400;
        IJth(rJacobian, 25, 25) = var_x388 + var_x400 + 8.8885199344722979e-8 * var_x61 - 3.6975665728975948e-7 * var_x155;
        IJth(rJacobian, 21, 26) = -2.3414435371998602e-7 * var_x354 * pow(var_chaste_interface__Ca__Ca_jsr, 2.7999999999999998) + 0.6333333333333333 * var_x344 * var_x353 * pow(var_chaste_interface__Ca__Ca_jsr, 0.89999999999999991);
        IJth(rJacobian, 26, 26) = var_x420 * (-0.0083333333333333332 - var_x419) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0.0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x410 * var_x419) / (pow(var_x402, 3) * pow((0.125 + var_x403), 2));
        IJth(rJacobian, 27, 26) = 0.00072463768115942019;
        IJth(rJacobian, 28, 26) = var_x429 * var_x433;
        IJth(rJacobian, 1, 27) = 2.3676470588235295e-5 * var_x161;
        IJth(rJacobian, 26, 27) = 0.0083333333333333332 * var_x404;
        ...
        IJth(rJacobian, 8, 28) = var_x245 * (-0.0016500000000000002 * var_x260 + var_x255 * var_x261) + var_x259 * (var_x262 + 0.0030000000000000001 * var_x260);
        IJth(rJacobian, 9, 28) = var_x261 * var_x272 - var_x261 * var_x273;
        ...
        IJth(rJacobian, 21, 28) = var_x330 * var_x339 * var_x348 * var_x95 - 0.00020267697647483301 * var_x165 * var_x340 * var_x341 * var_x343 * var_x354 * (1.8999999999999999 * var_x342 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x341, 2));
        IJth(rJacobian, 22, 28) = var_x378 * (var_x262 + var_x371 * (5000.0 - 3510.8651860830805 * var_x379) - var_x262 * var_x362) - 1.0 * var_x366 * (40000.0 - 18724.614325776431 * var_x379);
        IJth(rJacobian, 26, 28) = var_x420 * (var_x419 + 2106.5191116498486 * var_x421);
        IJth(rJacobian, 27, 28) = var_x192 * var_x424 + var_x193 * var_x423;
        IJth(rJacobian, 28, 28) = var_x430 * (-5.0 - var_x433 - 0.0036718475849305066 * var_x261 - 505.56458679596358 * var_x421) + 1.0 * (0.019557600000000001 / pow(var_x426, 3) + 8.1780000000000006e-5 / pow(var_x427, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0.0036718475849305066 * var_x246 + var_x410 * var_x433) / pow(var_x428, 2);
    }
