...
bool Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::registered = ModelFactory::Register("dynamic_Shannon2004", "AnalyticCvode", (ModelFactory::TCreateMethod)Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::CreateMethod);
    ...
    void Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x54 = (1 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_jct) * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x55 = 1 + 0.00053869674493876331 * var_x44;
        ...
        const double var_x58 = 1 + 1.6777215999999998e-11 / pow(var_chaste_interface__Ca_buffer__Ca_jct, 3);
        const double var_x59 = 1 / var_x58;
        const double var_x60 = 1 + 0.27000000000000002 * var_x49;
        const double var_x61 = -31 + 0.10000000000000001 * NV_Ith_S(mParameters, 23);
        ...
        const double var_x67 = pow(var_chaste_interface__Na_buffer__Na_SL, 3);
        ...
        const double var_x72 = (1 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_SL) * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x73 = 1 + 0.00053869674493876331 * var_x67;
        const double var_x74 = 1 / (var_x68 + var_x70 + 669921.875 * var_x72 + 1.3 * var_x67 + var_x56 * var_x73);
        const double var_x75 = 1 + 1.6777215999999998e-11 / pow(var_chaste_interface__Ca_buffer__Ca_SL, 3);
        ...
        const double var_x99 = -1 + var_x96;
        ...
        const double var_x106 = 1 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        ...
        const double var_x112 = 1 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL;
        ...
        const double var_x119 = 1 - 0.10000000000000001 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL - 0.90000000000000002 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        ...
        const double var_x128 = exp(2 * var_x48);
        ...
        const double var_x195 = pow(var_chaste_interface__Na_buffer__Na_SL, 2);
        const double var_x196 = 3 * NV_Ith_S(mParameters, 6);
        ...
        const double var_x211 = pow(var_chaste_interface__Na_buffer__Na_jct, 2);
        ...
        const double var_x224 = 5.0104537825247566e-7 * var_x2 * var_x222 * var_x223 / pow((1 + 5.2281977629563632e-6 * var_x223), 2);
        ...
        const double var_x236 = 6.1926956862665531e-8 * var_x0 * var_x222 * var_x235 / pow((1 + 5.2281977629563632e-6 * var_x235), 2);
        ...
        const double var_x241 = 34 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Calmodulin;
        const double var_x242 = 100 * var_chaste_interface__cytosolic_Ca_buffer__Ca_SRB;
        ...
        const double var_x254 = var_x253 / (1 + var_x250 + var_x252);
        ...
        const double var_x263 = 34 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x264 = 13.800000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x265 = 100 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x266 = exp(0.14705882352941177 * NV_Ith_S(mParameters, 16) - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x267 = var_chaste_interface__cell__V < -40;
        const double var_x268 = ((var_x267) ? (1.0495108254269646e-6 * var_x266) : (0));
        ...
        const double var_x272 = exp(0.0900900900900901 * NV_Ith_S(mParameters, 16) - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x273 = 1 + 0.38275493141491301 * var_x272;
        const double var_x274 = ((var_x267) ? (310000 * var_x270 + 3.5600000000000001 * var_x271) : (7.6923076923076916 / var_x273));
        const double var_x275 = var_x274;
        const double var_x276 = ((var_x267) ? (-1.5433982726867125e-7 * var_x266) : (0));
        ...
        const double var_x281 = ((var_x267) ? (0.28123999999999999 * var_x271 + 108500 * var_x270) : (0.26524943271996743 * var_x272 / pow(var_x273, 2)));
        const double var_x282 = exp(0.13780000000000001 * NV_Ith_S(mParameters, 16) - 0.13780000000000001 * var_chaste_interface__cell__V);
        ...
        const double var_x287 = exp(var_x286 + 0.10000000000000001 * NV_Ith_S(mParameters, 16));
        const double var_x288 = 1 + 0.040762203978366211 * var_x287;
        ...
        const double var_x296 = -127140 * var_x294 - 3.4740000000000003e-5 * var_x295;
        const double var_x297 = exp(0.311 * var_chaste_interface__cell__V - 0.311 * NV_Ith_S(mParameters, 16));
        const double var_x298 = 1 / (1 + 50262745825.953949 * var_x297);
        const double var_x299 = var_x296 * var_x298;
        const double var_x300 = ((var_x267) ? (var_x293 * var_x299) : (0));
        const double var_x301 = var_x300;
        const double var_x302 = ((var_x267) ? (var_x299 + var_x293 * var_x298 * (1.5254334000000001e-6 * var_x295 - 31073.016 * var_x294) - 6.1874852813833003e-12 * var_x293 * var_x296 * var_x297 / pow((1.989545106554116e-11 + var_x297), 2)) : (0));
        const double var_x303 = var_x291 + var_x300;
        const double var_x304 = var_x279 / var_x303;
        const double var_x305 = ((var_x267) ? (-0.001275024 * var_x285 + 6.6151888057343371e-5 * var_x282 * var_x284 / pow(var_x283, 2)) : (-7.6049999999999996e-8 * var_x290 + 0.0012228661193509863 * var_x287 * var_x289 / pow(var_x288, 2)));
        const double var_x306 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x307 = 0.080000000000000002 * var_x306;
        const double var_x308 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x309 = exp(-4.7130000000000001 + var_x286);
        const double var_x310 = 1 - var_x309;
        const double var_x311 = 1 / var_x310;
        const double var_x312 = 0.32000000000000001 * var_x311;
        const double var_x313 = var_x308 * var_x312;
        const double var_x314 = var_x307 + var_x313;
        const double var_x315 = 1 / var_x314;
        const double var_x316 = 0.0072727272727272727 * var_x306;
        const double var_x317 = 0.032000000000000001 * var_x308 * var_x309 / pow(var_x310, 2);
        const double var_x318 = var_x308 * var_x311;
        const double var_x319 = exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x320 = 1 + var_x319;
        const double var_x321 = exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V);
        const double var_x322 = -1 + var_x321;
        const double var_x323 = 0.00060999999999999997 / var_x322;
        const double var_x324 = exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V);
        const double var_x325 = 1 - var_x324;
        const double var_x326 = 0.0013799999999999999 / var_x325;
        const double var_x327 = 7 + var_chaste_interface__cell__V;
        const double var_x328 = 10 + var_chaste_interface__cell__V;
        const double var_x329 = var_x323 * var_x328;
        const double var_x330 = var_x326 * var_x327;
        ...
        const double var_x339 = 30 + var_chaste_interface__cell__V;
        const double var_x340 = var_x335 * var_x339;
        const double var_x341 = var_x338 * var_x339;
        const double var_x342 = 0.066666666666666666 * var_chaste_interface__cell__V;
        const double var_x343 = exp(0.20000000000000001 + var_x342);
        const double var_x344 = 1 + var_x343;
        const double var_x345 = 1 / var_x344;
        const double var_x346 = 1 / (0.5 + 9 * var_x345);
        const double var_x347 = exp(-0.20000000000000001 - var_x342);
        const double var_x348 = 1 + var_x347;
        const double var_x349 = 0.066666666666666666 * var_x347 / pow(var_x348, 2);
        const double var_x350 = 1 / var_x348;
        const double var_x351 = 0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x352 = exp(6 + var_x351);
        const double var_x353 = 1 + var_x352;
        const double var_x354 = 1 / var_x353;
        const double var_x355 = 1 / (30 + 3000 * var_x354);
        const double var_x356 = exp(3.3500000000000001 + var_x351);
        const double var_x357 = 1 + var_x356;
        const double var_x358 = var_x356 / pow(var_x357, 2);
        const double var_x359 = 0.10000000000000001 * var_x358;
        const double var_x360 = 1 / var_x357;
        const double var_x361 = var_x360;
        const double var_x362 = var_x352 / pow(var_x353, 2);
        const double var_x363 = 1 / (220 + 2800 * var_x354);
        const double var_x364 = exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2));
        const double var_x365 = 1 / (1.5 + 3.5 * var_x364);
        const double var_x366 = 1 / (20 + 20 * var_x360);
        const double var_x367 = exp(-2.4166666666666665 - 0.16666666666666666 * var_chaste_interface__cell__V);
        const double var_x368 = 1 - var_x367;
        const double var_x369 = 1 / var_x368;
        const double var_x370 = 1 + var_x367;
        const double var_x371 = 1 / var_x370;
        const double var_x372 = -var_chaste_interface__ICaL_d_gate__d + var_x371;
        const double var_x373 = var_x369 * var_x372;
        const double var_x374 = 0.035000000000000003 * var_x370;
        const double var_x375 = 14.5 + var_chaste_interface__cell__V;
        const double var_x376 = var_x369 * var_x375;
        const double var_x377 = 0.0058333333333333336 * var_x367;
        const double var_x378 = var_x375 * var_x377;
        const double var_x379 = 0.019699999999999999 * exp(-0.23877882250000002 * pow((1 + 0.068965517241379309 * var_chaste_interface__cell__V), 2));
        const double var_x380 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x381 = 1 + var_x380;
        const double var_x382 = exp(9.7388888888888889 + 0.27777777777777779 * var_chaste_interface__cell__V);
        const double var_x383 = 1 + var_x382;
        const double var_x384 = 1 / var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x385 = pow(var_x384, 2.5);
        const double var_x386 = 1 + 0.13584112963311223 * var_x385;
        const double var_x387 = 1 / var_x386;
        const double var_x388 = 7 * var_x387;
        const double var_x389 = -7.5 + var_x388;
        const double var_x390 = var_x389 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x391 = 1 / (15 - 14 * var_x387);
        const double var_x392 = 10 * var_x233 * var_x391;
        const double var_x393 = -var_x392;
        const double var_x394 = var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__R;
        const double var_x395 = var_x384 * var_x385 / pow(var_x386, 2);
        const double var_x396 = 2.3772197685794643 * var_x395;
        const double var_x397 = 0.21130842387373014 * var_x233 * var_x395 / pow((1 - 0.93333333333333335 * var_x387), 2);
        const double var_x398 = var_x397 * var_chaste_interface__Jrel_SR__R;
        const double var_x399 = 20 * var_x391;
        const double var_x400 = var_x394 * var_x399;
        const double var_x401 = 7.5 - var_x388;
        const double var_x402 = var_x396 * var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__O;
        const double var_x403 = 1 - var_chaste_interface__Jrel_SR__I - var_chaste_interface__Jrel_SR__O - var_chaste_interface__Jrel_SR__R;
        const double var_x404 = M_PI * var_x24;
        const double var_x405 = 62.109246076532294 * var_x404;
        const double var_x406 = var_x405 * NV_Ith_S(mParameters, 3);
        const double var_x407 = var_x404 * NV_Ith_S(mParameters, 3);
        const double var_x408 = var_x22 * var_x407;
        const double var_x409 = 55.277229008113743 * var_x164;
        const double var_x410 = var_x167 * var_x407;
        const double var_x411 = var_x100 * var_x102;
        const double var_x412 = M_PI * var_x48;
        const double var_x413 = var_x412 * NV_Ith_S(mParameters, 3);
        const double var_x414 = 4.1923741101659298e-8 * var_x413;
        const double var_x415 = var_x114 * var_x414;
        const double var_x416 = var_x100 * var_x186;
        const double var_x417 = 0.0001 * var_chaste_interface__Na_buffer__Na_SL_buf;
        const double var_x418 = 5.9492599172113663e-12 * var_x200;
        const double var_x419 = 0.0001 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x420 = 2435.6567088836191 * var_x404;
        const double var_x421 = var_x420 * NV_Ith_S(mParameters, 3);
        const double var_x422 = 267.92223797719811 * var_x162;
        const double var_x423 = 1.4796614506467986e-5 * var_x413;
        const double var_x424 = var_x142 * var_x423;
        const double var_x425 = 0.0001 * var_chaste_interface__Na_buffer__Na_jct_buf;
        const double var_x426 = 7.3530178752050587e-13 * var_x213;
        const double var_x427 = 0.0001 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x428 = 0.076376893524206985 * NV_Ith_S(mParameters, 3);
        const double var_x429 = 100 * var_chaste_interface__Ca_buffer__Ca_Calsequestrin;
        const double var_x430 = 18.571428571428569 * NV_Ith_S(mParameters, 0);
        const double var_x431 = var_chaste_interface__Jrel_SR__O * NV_Ith_S(mParameters, 1);
        const double var_x432 = 100 * var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x433 = 31.054623038266147 * var_x404;
        const double var_x434 = 5.5898321468879066 * var_x135 * var_x412;
        ...
        const double var_x438 = 100 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x439 = 1217.8283544418096 * var_x404;
        const double var_x440 = 1972.8819341957317 * var_x412;
        const double var_x441 = var_x157 * var_x440;
        const double var_x442 = 4.9020119168033731e-13 * var_x213;
        const double var_x443 = 1274.5098039215686 * NV_Ith_S(mParameters, 0);
        const double var_x444 = 68.627450980392155 * var_x431;
        const double var_x445 = 100 * var_chaste_interface__Ca_buffer__Ca_SLB_jct;
        const double var_x446 = 100 * var_chaste_interface__Ca_buffer__Ca_SLHigh_jct;
        const double var_x447 = 100 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x448 = -var_x438;
        const double var_x449 = -var_x447;
        const double var_x450 = -var_x262;
        const double var_x451 = -var_x264;
        const double var_x452 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_Cytosol;
        const double var_x453 = -var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_Cytosol - 0.030769230769230767 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL - 0.00078461538461538469 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x454 = 0.078461538461538471 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x455 = 3.0769230769230771 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL;
        const double var_x456 = var_x452 + var_x454 + var_x455;
        const double var_x457 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL;
        const double var_x458 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x459 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol;
        const double var_x460 = -var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol - 0.030769230769230767 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL - 0.00078461538461538469 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        const double var_x461 = 0.078461538461538471 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        const double var_x462 = 3.0769230769230771 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL;
        const double var_x463 = var_x459 + var_x461 + var_x462;
        const double var_x464 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL;
        const double var_x465 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        ...
        IJth(rJacobian, 3, 0) = (var_x292 + var_x301) * (var_x302 * var_x304 + var_x279 * var_x300 * (-var_x302 - var_x305) / pow(var_x303, 2)) + (var_x302 + var_x305) * (var_x278 - var_chaste_interface__INa_j_gate__j + var_x300 * var_x304);
        IJth(rJacobian, 4, 0) = var_x314 * (var_x312 * var_x315 - var_x315 * var_x317 + 3.125 * var_x318 * (var_x316 + var_x317 - var_x312) / pow((var_x318 + 0.25 * var_x306), 2)) + (-var_chaste_interface__INa_m_gate__m + var_x313 * var_x315) * (var_x312 - var_x316 - var_x317);
        IJth(rJacobian, 5, 0) = (-var_chaste_interface__IKr_Xr_gate__Xr + 1 / var_x320) * (var_x323 + var_x326 - 0.00016973999999999998 * var_x324 * var_x327 / pow(var_x325, 2) - 8.8449999999999995e-5 * var_x321 * var_x328 / pow(var_x322, 2)) + 0.13333333333333333 * var_x319 * (var_x329 + var_x330) / pow(var_x320, 2);
        IJth(rJacobian, 6, 0) = (-var_chaste_interface__IKs_Xs_gate__Xs + 1 / var_x332) * (var_x335 + var_x338 - 8.9997000000000013e-6 * var_x333 * var_x339 / pow(var_x334, 2) - 1.0641199999999999e-5 * var_x336 * var_x339 / pow(var_x337, 2)) + 0.059880239520958084 * var_x331 * (var_x340 + var_x341) / pow(var_x332, 2);
        IJth(rJacobian, 7, 0) = var_x346 * var_x349 + 0.0074074074074074077 * var_x343 * (var_x350 - var_chaste_interface__Itos_X_gate__X_tos) / (pow(var_x344, 2) * pow((0.055555555555555552 + var_x345), 2));
        IJth(rJacobian, 8, 0) = -var_x355 * var_x359 + 3.3333333333333335e-5 * var_x362 * (var_x361 + var_x4) / pow((0.01 + var_x354), 2);
        IJth(rJacobian, 9, 0) = -var_x359 * var_x363 + 3.5714285714285717e-5 * var_x362 * (var_x361 - var_chaste_interface__Itos_R_gate__R_tos) / pow((0.07857142857142857 + var_x354), 2);
        IJth(rJacobian, 10, 0) = var_x349 * var_x365 + 0.00063492063492063492 * var_x364 * (var_x350 - var_chaste_interface__Itof_X_gate__X_tof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x364), 2);
        IJth(rJacobian, 11, 0) = -var_x359 * var_x366 + 0.0050000000000000001 * var_x358 * (var_x361 - var_chaste_interface__Itof_Y_gate__Y_tof) / pow((1 + var_x360), 2);
        IJth(rJacobian, 12, 0) = var_x373 * var_x374 - var_x373 * var_x378 + var_x371 * var_x376 * var_x377 - var_x370 * var_x372 * var_x378 / pow(var_x368, 2);
        IJth(rJacobian, 13, 0) = (0.02 + var_x379) * (0.029999999999999999 * var_x380 / pow(var_x381, 2) - 0.27777777777777779 * var_x382 / pow(var_x383, 2)) + var_x379 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__cell__V) * (-var_chaste_interface__ICaL_f_gate__f + 1 / var_x383 + 0.59999999999999998 / var_x381);
        IJth(rJacobian, 19, 0) = -var_x406 * (0.00026433000000000001 + var_x116 + var_x151 + var_x202 - var_x147 + 2.6699999999999999 * var_x79 + 5.0996999999999995 * var_x94 + 0.46858500000000003 * var_x124);
        IJth(rJacobian, 20, 0) = -var_x421 * (3.2670000000000004e-5 + var_x110 + var_x154 + var_x215 - var_x146 + 0.33000000000000002 * var_x66 + 0.63029999999999997 * var_x91 + 0.057915000000000008 * var_x127);
        IJth(rJacobian, 25, 0) = -var_x433 * (0.00022365699999999999 + var_x137 + var_x161 - var_x156 - 1.78 * var_x79 - 0.31239000000000006 * var_x124);
        IJth(rJacobian, 26, 0) = -var_x439 * (2.7642999999999999e-5 + var_x141 + var_x159 - var_x158 - 0.22 * var_x66 - 0.038610000000000005 * var_x127);
        ...
        IJth(rJacobian, 39, 1) = var_x453 * (2.5 - var_x452);
        IJth(rJacobian, 42, 1) = var_x460 * (2.5 - var_x459);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x163 * var_x22 - var_x165 * var_x22);
        IJth(rJacobian, 2, 2) = -var_x269 - var_x275;
        IJth(rJacobian, 19, 2) = -var_x408 * var_x409;
        IJth(rJacobian, 20, 2) = -var_x408 * var_x422;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x163 * var_x167 - var_x165 * var_x167);
        IJth(rJacobian, 3, 3) = -var_x292 - var_x301;
        IJth(rJacobian, 19, 3) = -var_x409 * var_x410;
        IJth(rJacobian, 20, 3) = -var_x410 * var_x422;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.33000000000000002 * var_x169 - 2.6699999999999999 * var_x170);
        IJth(rJacobian, 4, 4) = -var_x307 - var_x313;
        IJth(rJacobian, 19, 4) = -165.83168702434122 * var_x170 * var_x407;
        IJth(rJacobian, 20, 4) = -803.76671393159438 * var_x169 * var_x407;
        ...
        IJth(rJacobian, 6, 6) = -var_x340 - var_x341;
        ...
        IJth(rJacobian, 12, 12) = -var_x374 * var_x376;
        IJth(rJacobian, 19, 12) = -var_x411 * var_x415;
        IJth(rJacobian, 20, 12) = -var_x411 * var_x424;
        IJth(rJacobian, 25, 12) = -var_x183 * var_x434;
        IJth(rJacobian, 26, 12) = -var_x182 * var_x441;
        ...
        IJth(rJacobian, 13, 13) = -0.02 - var_x379;
        IJth(rJacobian, 19, 13) = -var_x415 * var_x416;
        IJth(rJacobian, 20, 13) = -var_x416 * var_x424;
        IJth(rJacobian, 25, 13) = -var_x190 * var_x434;
        IJth(rJacobian, 26, 13) = -var_x189 * var_x441;
        ...
        IJth(rJacobian, 19, 14) = var_x104 * var_x113 * var_x414;
        IJth(rJacobian, 25, 14) = var_x131 * var_x434;
        ...
        IJth(rJacobian, 20, 15) = var_x105 * var_x423;
        IJth(rJacobian, 26, 15) = var_x131 * var_x139 * var_x440;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x390 + var_x393;
        IJth(rJacobian, 17, 16) = var_x393;
        IJth(rJacobian, 18, 16) = var_x392;
        IJth(rJacobian, 16, 17) = -0.0050000000000000001;
        IJth(rJacobian, 17, 17) = -0.065000000000000002 + var_x393;
        IJth(rJacobian, 18, 17) = 0.0050000000000000001;
        IJth(rJacobian, 16, 18) = 0.055;
        IJth(rJacobian, 17, 18) = var_x393 + var_x401 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 18, 18) = -0.059999999999999998 + var_x390;
        ...
        IJth(rJacobian, 19, 19) = (-2.5101556644976917 + var_x417 - var_x405 * (var_x194 + var_x203 + var_x208 + 8.0099999999999998 * var_x205 + 0.0013932654873301004 * var_x207 + var_x198 * var_x418)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 20, 19) = 1.0879068612142859 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 19) = 0.000165 - var_x417;
        IJth(rJacobian, 23, 19) = var_x428;
        IJth(rJacobian, 25, 19) = -var_x433 * (-5.3399999999999999 * var_x205 - var_x198 * var_x435);
        ...
        IJth(rJacobian, 20, 20) = (-1.0886629612142857 + var_x425 - var_x420 * (var_x210 + var_x216 + var_x219 + 0.98999999999999999 * var_x217 + 0.00017220135236664162 * var_x218 + var_x212 * var_x426)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 20) = 0.0007561 - var_x425;
        IJth(rJacobian, 26, 20) = -var_x439 * (-0.66000000000000003 * var_x217 - var_x212 * var_x442);
        IJth(rJacobian, 19, 21) = (0.001 + var_x419) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 21) = -0.001 - var_x419;
        IJth(rJacobian, 20, 22) = (0.001 + var_x427) * NV_Ith_S(mParameters, 3);
        ...
        IJth(rJacobian, 23, 23) = -var_x428;
        IJth(rJacobian, 1, 24) = 0.69232869146389786 * var_x259 + 8.7400597733819945e-14 * var_x260;
        IJth(rJacobian, 16, 24) = -var_x398 + var_x394 * var_x396;
        IJth(rJacobian, 17, 24) = -var_x402 + var_x397 * var_x403;
        IJth(rJacobian, 18, 24) = var_x398 + var_x402;
        IJth(rJacobian, 24, 24) = -260 + var_x429 - var_x430 - var_x431 - 1.6231539579137989e-12 * var_x260 - 12.857532841472388 * var_x259;
        IJth(rJacobian, 26, 24) = var_x443 + var_x444;
        IJth(rJacobian, 31, 24) = 260 - var_x429;
        ...
        IJth(rJacobian, 19, 25) = -var_x406 * (1.3438550016e-10 * var_x229 - 2.6699999999999999 * var_x227 + var_x231 * var_x418);
        IJth(rJacobian, 25, 25) = -171.99023312516786 + var_x436 + var_x437 - var_x433 * (var_x224 + var_x225 + var_x232 + 1.78 * var_x227 - 8.9590333439999989e-11 * var_x229 - var_x231 * var_x435);
        IJth(rJacobian, 26, 25) = 48.958482036396518;
        IJth(rJacobian, 27, 25) = 121.55000000000001 - var_x436;
        IJth(rJacobian, 29, 25) = 43.550000000000004 - var_x437;
        IJth(rJacobian, 40, 25) = var_x453 * (2.5024999999999999 - var_x457);
        IJth(rJacobian, 43, 25) = var_x460 * (2.5024999999999999 - var_x464);
        ...
        IJth(rJacobian, 16, 26) = -var_x400 + var_x389 * var_chaste_interface__Jrel_SR__R;
        IJth(rJacobian, 17, 26) = var_x401 * var_chaste_interface__Jrel_SR__O + var_x399 * var_x403 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 18, 26) = var_x400 + var_x389 * var_chaste_interface__Jrel_SR__O;
        IJth(rJacobian, 20, 26) = -var_x421 * (1.6609443839999999e-11 * var_x239 - 0.33000000000000002 * var_x237 + var_x238 * var_x426);
        IJth(rJacobian, 24, 26) = var_x430 + var_x431;
        IJth(rJacobian, 25, 26) = 1.2484412919281114;
        IJth(rJacobian, 26, 26) = -128.61534478149457 + var_x445 + var_x446 - var_x443 - var_x444 - var_x439 * (var_x234 + var_x236 + var_x240 + 0.22 * var_x237 - 1.1072962559999999e-11 * var_x239 - var_x238 * var_x442);
        IJth(rJacobian, 28, 26) = 58.627450980392155 - var_x445;
        IJth(rJacobian, 30, 26) = 21.029411764705884 - var_x446;
        IJth(rJacobian, 41, 26) = var_x453 * (2.5490196078431375 - var_x458);
        IJth(rJacobian, 44, 26) = var_x460 * (2.5490196078431375 - var_x465);
        IJth(rJacobian, 25, 27) = 1.3 + var_x438;
        IJth(rJacobian, 27, 27) = -1.3 + var_x448;
        IJth(rJacobian, 26, 28) = 1.3 + var_x447;
        IJth(rJacobian, 28, 28) = -1.3 + var_x449;
        IJth(rJacobian, 25, 29) = 0.029999999999999999 + var_x438;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x448;
        IJth(rJacobian, 26, 30) = 0.029999999999999999 + var_x447;
        IJth(rJacobian, 30, 30) = -0.029999999999999999 + var_x449;
        IJth(rJacobian, 24, 31) = 65 + var_x432;
        IJth(rJacobian, 31, 31) = -65 - var_x432;
        ...
        IJth(rJacobian, 36, 36) = -0.00046000000000000001 + var_x451;
        IJth(rJacobian, 37, 36) = -0.015699999999999999;
        IJth(rJacobian, 1, 37) = 0.015757 + var_x264;
        IJth(rJacobian, 36, 37) = var_x451;
        ...
        IJth(rJacobian, 39, 39) = -0.059999999999999998 + var_x456 * var_chaste_interface__Ca_buffer__Cai + (-2.5 + var_x452) * var_chaste_interface__Ca_buffer__Cai;
        IJth(rJacobian, 40, 39) = (-2.5024999999999999 + var_x457) * var_chaste_interface__Ca_buffer__Ca_SL;
        IJth(rJacobian, 41, 39) = (-2.5490196078431375 + var_x458) * var_chaste_interface__Ca_buffer__Ca_jct;
        ...
        IJth(rJacobian, 40, 40) = -0.059999999999999998 + var_x456 * var_chaste_interface__Ca_buffer__Ca_SL + (-0.076999999999999999 + var_x455) * var_chaste_interface__Ca_buffer__Ca_SL;
        ...
        IJth(rJacobian, 41, 41) = -0.059999999999999998 + var_x456 * var_chaste_interface__Ca_buffer__Ca_jct + (-0.002 + var_x454) * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 42, 42) = -0.11 + var_x463 * var_chaste_interface__Ca_buffer__Cai + (-2.5 + var_x459) * var_chaste_interface__Ca_buffer__Cai;
        IJth(rJacobian, 43, 42) = (-2.5024999999999999 + var_x464) * var_chaste_interface__Ca_buffer__Ca_SL;
        IJth(rJacobian, 44, 42) = (-2.5490196078431375 + var_x465) * var_chaste_interface__Ca_buffer__Ca_jct;
        ...
        IJth(rJacobian, 43, 43) = -0.11 + var_x463 * var_chaste_interface__Ca_buffer__Ca_SL + (-0.076999999999999999 + var_x462) * var_chaste_interface__Ca_buffer__Ca_SL;
        ...
        IJth(rJacobian, 44, 44) = -0.11 + var_x463 * var_chaste_interface__Ca_buffer__Ca_jct + (-0.002 + var_x461) * var_chaste_interface__Ca_buffer__Ca_jct;
    }
