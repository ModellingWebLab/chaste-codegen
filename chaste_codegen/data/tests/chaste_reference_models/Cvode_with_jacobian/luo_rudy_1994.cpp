...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellluo_rudy_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x3 = exp(-1.7526479750778814 + 0.031152647975077882 * var_chaste_interface__membrane__V);
        const double var_x4 = 1.0 + var_x3;
        const double var_x5 = 1 / var_x4;
        const double var_x6 = pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 2.0);
        const double var_x7 = var_x5 * var_x6;
        const double var_x8 = exp(-0.024422646794659154 * var_chaste_interface__membrane__V);
        const double var_x9 = 1.0 + 0.10000000000000001 * var_x8;
        const double var_x10 = 1 / var_x9;
        const double var_x11 = var_x8 * var_chaste_interface__ionic_concentrations__Cai_converted;
        const double var_x12 = exp(0.013150655966354927 * var_chaste_interface__membrane__V);
        const double var_x13 = var_x12 * pow(var_chaste_interface__ionic_concentrations__Nai, 3.0);
        const double var_x14 = var_x10 * (67015.742804544716 * var_x11 + 0.023671180739438871 * var_x13);
        ...
        const double var_x33 = 1 / (var_chaste_interface__ionic_concentrations__Ki + var_chaste_interface__ionic_concentrations__Nai);
        ...
        const double var_x37 = var_x36 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x38 = -105.0 + var_x37;
        const double var_x39 = 1 / var_chaste_interface__ionic_concentrations__Cai_converted;
        const double var_x40 = pow(var_x39, 3.0);
        const double var_x41 = 1.0 + 1.7279999999999996e-9 * var_x40;
        const double var_x42 = 1 / var_x41;
        const double var_x43 = -1.0 + var_x35;
        const double var_x44 = 1 / var_x43;
        const double var_x45 = var_x42 * var_x44;
        const double var_x46 = 0.00063678763853082152 * var_x45;
        const double var_x47 = var_x36 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x48 = -4.0500000000000007 + var_x47;
        const double var_x49 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x50 = pow(var_x49, 1.5);
        const double var_x51 = exp(-0.0037573302761014088 * var_chaste_interface__membrane__V);
        const double var_x52 = (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x32);
        const double var_x53 = 1.0 + 0.1245 * var_x51 + 0.036499999999999998 * var_x52;
        const double var_x54 = (0.001371425550777014 * var_x52 + 0.00046778761937462537 * var_x51) / (pow(var_x53, 2) * (1.0 + 31.622776601683793 * var_x50));
        const double var_x55 = -26.614641953637257 * var_x16 + var_chaste_interface__membrane__V;
        const double var_x56 = var_x0 * var_x55 / pow(var_x1, 2);
        const double var_x57 = var_x8 * (1.8 * var_x13 - 2744000.0 * var_x11) / pow(var_x9, 2);
        const double var_x58 = var_x17 / pow(var_x18, 2);
        const double var_x59 = var_x27 * var_x55;
        const double var_x60 = var_x58 * var_x59;
        const double var_x61 = 1 / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki);
        const double var_x62 = -26.614641953637257 * log(7.9662000000000006 * var_x61) + var_chaste_interface__membrane__V;
        const double var_x63 = var_x3 * var_x6 * var_x62 / pow(var_x4, 2);
        const double var_x64 = var_x20 * var_x25 / pow(var_x21, 2);
        const double var_x65 = 0.24326999999999999 * var_x58 - 0.51429999999999998 * var_x64 - var_x22 * (0.061749999999999999 * var_x24 + 0.039456396800000001 * var_x23);
        const double var_x66 = var_x19 * var_x55 / pow((var_x19 + 0.98039215686274506 * var_x26), 2);
        const double var_x67 = 0.73529411764705876 * var_x66;
        const double var_x68 = -26.614641953637257 * var_x34 + var_chaste_interface__membrane__V;
        const double var_x69 = var_x35 * var_x68;
        const double var_x70 = var_x42 * var_x69 / pow(var_x43, 2);
        const double var_x71 = 2.3926214736989754e-5 * var_x70;
        const double var_x72 = exp(var_x32);
        const double var_x73 = -1.0 + var_x72;
        const double var_x74 = 1 / var_x73;
        const double var_x75 = pow(var_chaste_interface__ionic_concentrations__Cai_converted, 2.0);
        const double var_x76 = 1 / (1.0 + 2777777.777777778 * var_x75);
        ...
        const double var_x81 = -105.0 + var_x80 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x82 = 0.0024561808914760259 * var_x81;
        const double var_x83 = -4.0500000000000007 + var_x80 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x84 = 0.00070228579563684902 * var_x83;
        const double var_x85 = exp(0.075146605522028162 * var_chaste_interface__membrane__V);
        const double var_x86 = -1.0 + var_x85;
        const double var_x87 = 1 / var_x86;
        const double var_x88 = 1.0 * var_chaste_interface__ionic_concentrations__Cai_converted;
        const double var_x89 = -0.6120000000000001 + var_x85 * var_x88;
        const double var_x90 = var_x87 * var_x89;
        const double var_x91 = 7.8597788527232835 * var_x90;
        const double var_x92 = var_x45 * var_x69;
        const double var_x93 = 1.7944661052742313e-5 * var_x92;
        const double var_x94 = var_x78 * var_chaste_interface__membrane__V;
        const double var_x95 = var_x85 * var_x94;
        const double var_x96 = var_x89 * var_x95 / pow(var_x86, 2);
        const double var_x97 = var_x72 * var_x94 / pow(var_x73, 2);
        const double var_x98 = var_x81 * var_x97;
        const double var_x99 = var_x83 * var_x97;
        const double var_x100 = var_x72 * var_x79 * var_chaste_interface__membrane__V;
        const double var_x101 = var_x100 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x102 = var_x100 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x103 = var_x87 * var_x95;
        const double var_x104 = var_x103 * var_chaste_interface__ionic_concentrations__Cai_converted;
        const double var_x105 = 0.00050000000000000001 + var_x88;
        const double var_x106 = 1 / var_x105;
        const double var_x107 = var_chaste_interface__ionic_concentrations__Cai_converted / pow(var_x105, 2);
        const double var_x108 = var_x10 * var_x8;
        const double var_x109 = var_x39 * var_x40 * var_x44 * var_x68 / pow(var_x41, 2);
        const double var_x110 = 3.301107118143778e-12 * var_x109;
        const double var_x111 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__membrane__V;
        const double var_x112 = var_x111 * pow(var_chaste_interface__ionic_concentrations__Cai_converted, 1.0) * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow((3.5999999999999999e-7 + var_x75), 2);
        const double var_x113 = var_x112 * var_x74;
        const double var_x114 = var_x113 * var_x83;
        const double var_x115 = var_x113 * var_x81;
        const double var_x116 = var_x112 * var_x90;
        const double var_x117 = -26.614641953637257 * log(140.0 * var_x49) + var_chaste_interface__membrane__V;
        const double var_x118 = var_x117 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x119 = var_x118 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2.0) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x120 = var_x118 * var_x29;
        const double var_x121 = var_x77 * var_chaste_interface__membrane__V;
        const double var_x122 = var_x121 * var_x74;
        const double var_x123 = var_x111 * var_x76;
        const double var_x124 = var_x123 * var_x74;
        const double var_x125 = var_x5 * var_x62 * pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 1.0);
        const double var_x126 = var_x10 * var_x12 * pow(var_chaste_interface__ionic_concentrations__Nai, 2.0);
        const double var_x127 = var_x61 * var_x7;
        const double var_x128 = var_x36 + var_x33 * var_x37;
        const double var_x129 = var_x46 * var_x68;
        const double var_x130 = var_x30 * var_x49 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x131 = var_x49 * var_x50 / (var_x53 * pow((0.031622776601683791 + var_x50), 2));
        const double var_x132 = var_x33 * var_x45;
        const double var_x133 = var_x132 * var_x69;
        const double var_x134 = 0.00047759072889811614 * var_x133;
        const double var_x135 = 0.016947874999999998 * var_x132;
        const double var_x136 = var_x33 * var_x70;
        const double var_x137 = 0.00063678763853082152 * var_x136;
        const double var_x138 = var_x137 * var_x38 + var_x137 * var_x48 - var_x135 * var_x38 - var_x135 * var_x48;
        const double var_x139 = var_x15 * var_x2;
        const double var_x140 = var_x15 * var_x28;
        const double var_x141 = var_x36 + var_x33 * var_x47;
        const double var_x142 = var_x15 * var_x58;
        const double var_x143 = 6.4745439480613358 * var_x142 - var_x22 * (1.6434541406371006 * var_x15 * var_x24 + 1.0501178736126389 * var_x15 * var_x23) - 13.687910356755641 * var_x15 * var_x64;
        const double var_x144 = var_x142 * var_x59;
        const double var_x145 = 0.00011935049112322119 * var_x90;
        const double var_x146 = 0.00092000000000000003 + var_x88;
        const double var_x147 = 1 / var_x146;
        const double var_x148 = var_chaste_interface__ionic_concentrations__Cai_converted / pow(var_x146, 2);
        const double var_x149 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x150 = 0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x151 = -var_x150;
        const double var_x152 = exp(-4.7130000000000001 + var_x151);
        const double var_x153 = 1.0 - var_x152;
        const double var_x154 = 0.32000000000000001 / var_x153;
        const double var_x155 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
        const double var_x156 = 47.130000000000003 + var_chaste_interface__membrane__V;
        const double var_x157 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
        const double var_x158 = exp(0.34999999999999998 * var_chaste_interface__membrane__V);
        const double var_x159 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
        ...
        const double var_x163 = 1.0 - var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x167 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
        const double var_x168 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x169 = -127140.0 * var_x167 - 3.4740000000000003e-5 * var_x168;
        ...
        const double var_x176 = var_x163 * var_x175;
        const double var_x177 = exp(-3.2000000000000002 + var_x151);
        const double var_x178 = 1.0 + var_x177;
        const double var_x179 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V);
        const double var_x180 = var_x179 / var_x178;
        const double var_x181 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x185 = 0.035000000000000003 * var_x184;
        const double var_x186 = 1.0 + var_x182;
        const double var_x187 = 1 / var_x186;
        const double var_x188 = 1.0 - 1.0 * var_x187;
        const double var_x189 = var_x186 * var_x188;
        const double var_x190 = var_x189 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x191 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x192 = 0.005608974358974359 * var_x182 * var_x191;
        const double var_x193 = var_x192 / pow(var_x183, 2);
        const double var_x194 = var_x184 * var_x192 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x195 = var_x185 * var_x191;
        const double var_x196 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x197 = 1 + var_x150;
        const double var_x198 = exp(-0.113569 * pow(var_x197, 2.0));
        const double var_x199 = 0.019699999999999999 * var_x198;
        ...
        const double var_x203 = 0.029999999999999999 * var_x201 / pow(var_x202, 2);
        ...
        const double var_x206 = 0.11627906976744186 * var_x204 / pow(var_x205, 2);
        const double var_x207 = -0.02 - var_x199;
        ...
        const double var_x212 = 0.00044746186 * var_x198 * pow(var_x197, 1.0);
        const double var_x213 = 1.0 - var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        ...
        const double var_x221 = 0.00048591897908422494 * var_x30;
        const double var_x222 = 1.9339199950521953e-8 * var_x45;
        const double var_x223 = 7.2663761489674988e-10 * var_x70;
        const double var_x224 = 7.4594056952013249e-8 * var_x81;
        const double var_x225 = 5.4497821117256243e-10 * var_x92;
        const double var_x226 = 1.0025441254350579e-16 * var_x109;
        const double var_x227 = var_x222 * var_x68;
        const double var_x228 = 5.1470588235294113e-7 * var_x132;
        const double var_x229 = 1.9339199950521953e-8 * var_x136;
        const double var_x230 = var_x229 * var_x38 - var_x228 * var_x38;
        const double var_x231 = 1.4504399962891464e-8 * var_x133;
        const double var_x232 = 2.2330835435855923e-5 * var_x66;
        const double var_x233 = 2.1328374802575643e-8 * var_x83;
        const double var_x234 = var_x229 * var_x48 - var_x228 * var_x48;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0044260000000000002 + 0.18245249999999999 * var_x60 + 0.0087850467289719639 * var_x63 + 0.59063570093597562 * var_x96 + 9.2286828271246189e-5 * var_x98 + 2.638719682422299e-5 * var_x99 - 0.28200000000000003 * var_x7 - 0.0001842253105484621 * var_x14 - 0.0183 * var_x2 - 1.173913043478261 * var_x54 - 0.76500000000000001 * var_x28 - 6.9215121203434639e-5 * var_x101 - 1.9790397618167241e-5 * var_x102 - 0.003060200668896321 * var_x56 - 0.59063570093597562 * var_x104 - 4.4992696901614855e-7 * var_x57 + var_x38 * var_x71 + var_x48 * var_x71 - var_x31 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x38 * var_x46 - var_x46 * var_x48 - var_x65 * var_x67 - var_x78 * var_x91 - var_x79 * var_x82 - var_x79 * var_x84 - var_x93 * var_chaste_interface__ionic_concentrations__Ki - var_x93 * var_chaste_interface__ionic_concentrations__Nai);
        IJth(rJacobian, 1, 0) = -4.5797863778688198e-8 + 2.7974554632244683e-9 * var_x14 + 6.8321266702120803e-12 * var_x57 + 8.9687842752970267e-6 * var_x96 - 8.9687842752970267e-6 * var_x104 - var_x145 * var_x78;
        IJth(rJacobian, 2, 0) = var_x149 * var_x154 + 0.0072727272727272727 * var_x155 * var_chaste_interface__fast_sodium_current_m_gate__m - 0.032000000000000001 * var_x149 * var_x152 * var_x156 / pow(var_x153, 2);
        IJth(rJacobian, 3, 0) = ((var_x160) ? ((-0.28123999999999999 * var_x157 - 108500.0 * var_x158) * var_chaste_interface__fast_sodium_current_h_gate__h - 0.019852941176470591 * var_x159 * (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h)) : (-0.693000693000693 * var_x161 * var_chaste_interface__fast_sodium_current_h_gate__h / pow(var_x162, 2)));
        IJth(rJacobian, 4, 0) = ((var_x160) ? (var_x163 * var_x170 + 0.001275024 * var_x174 * var_chaste_interface__fast_sodium_current_j_gate__j + var_x166 * var_x176 * (1.5254334000000001e-6 * var_x168 - 31073.016 * var_x167) - 0.311 * var_x164 * var_x169 * var_x176 / pow(var_x165, 2) - 0.016701360000000002 * var_x171 * var_x173 * var_chaste_interface__fast_sodium_current_j_gate__j / pow(var_x172, 2)) : (7.6049999999999996e-8 * var_x180 * var_chaste_interface__fast_sodium_current_j_gate__j - 0.029999999999999999 * var_x177 * var_x179 * var_chaste_interface__fast_sodium_current_j_gate__j / pow(var_x178, 2)));
        IJth(rJacobian, 5, 0) = var_x181 * var_x185 + var_x187 * var_x194 + var_x188 * var_x194 + var_x190 * var_x193 - var_x181 * var_x193 - var_x185 * var_x190;
        IJth(rJacobian, 6, 0) = var_x196 * var_x200 * (var_x203 - var_x206) + var_x207 * (var_x206 - var_x203) * var_chaste_interface__L_type_Ca_channel_f_gate__f + var_x211 * var_x212 * var_chaste_interface__L_type_Ca_channel_f_gate__f - var_x196 * var_x212 * (var_x208 + var_x209);
        IJth(rJacobian, 7, 0) = var_x213 * var_x216 - var_x219 * var_chaste_interface__time_dependent_potassium_current_X_gate__X + 8.9997000000000013e-6 * var_x217 * var_x220 * var_chaste_interface__time_dependent_potassium_current_X_gate__X / pow(var_x218, 2) - 1.0641199999999999e-5 * var_x213 * var_x214 * var_x220 / pow(var_x215, 2);
        IJth(rJacobian, 8, 0) = -4.2821610031797325e-8 + 2.8027450860303209e-9 * var_x98 - 1.6784732779346811e-8 * var_x14 - 0.00010695499267886473 * var_x54 - 4.0992760021272483e-11 * var_x57 - 2.1020588145227406e-9 * var_x101 + var_x223 * var_x38 - var_x221 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x222 * var_x38 - var_x224 * var_x79 - var_x225 * var_chaste_interface__ionic_concentrations__Nai;
        IJth(rJacobian, 9, 0) = 7.1303328452576489e-5 * var_x54 + 2.668013086093291e-7 * var_x63 + 8.0137748385755857e-10 * var_x99 + 5.5410707832102842e-6 * var_x60 - 8.5643220063594646e-6 * var_x7 - 5.5576983232758224e-7 * var_x2 - 2.3233001187464504e-5 * var_x28 - 6.0103311289316887e-10 * var_x102 - 9.2938099051435159e-8 * var_x56 + var_x223 * var_x48 - var_x222 * var_x48 - var_x225 * var_chaste_interface__ionic_concentrations__Ki - var_x232 * var_x65 - var_x233 * var_x79;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (1.1499999999999999 * var_x107 + 505.51425214497999 * var_x108 + 5.0564577285853124e-10 * var_x114 + 1.7684502418627384e-9 * var_x115 + 5.659040773960764e-6 * var_x116 - 0.040134880066084982 * var_x39 - 1.1499999999999999 * var_x106 - 7.8597788527232835 * var_x103 - var_x110 * var_x38 - var_x110 * var_x48);
        IJth(rJacobian, 1, 1) = 1.7462713310839333e-5 * var_x107 + 0.00040588235294117644 * var_x148 + 8.5932353608719255e-11 * var_x116 - 0.00011935049112322119 * var_x103 - 1.7462713310839333e-5 * var_x106 - 6.094468733556194e-7 * var_x39 - 0.00040588235294117644 * var_x147 - 0.0076762177910879408 * var_x108;
        IJth(rJacobian, 8, 1) = 0.046057306746527651 * var_x108 + 5.3707721005449532e-14 * var_x115 - var_x226 * var_x38;
        IJth(rJacobian, 9, 1) = 1.5356429857854462e-14 * var_x114 - var_x226 * var_x48;
        IJth(rJacobian, 11, 1) = 0.0050000000000000001 * var_x147 - 0.0050000000000000001 * var_x148;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-48.0 * var_x119);
        IJth(rJacobian, 2, 2) = -0.080000000000000002 * var_x155 - var_x154 * var_x156;
        IJth(rJacobian, 8, 2) = -0.0014577569372526749 * var_x119;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x117 * var_x31);
        IJth(rJacobian, 3, 3) = ((var_x160) ? (-310000.0 * var_x158 - 0.13500000000000001 * var_x159 - 3.5600000000000001 * var_x157) : (-7.6923076923076916 / var_x162));
        IJth(rJacobian, 8, 3) = -var_x117 * var_x221;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-16.0 * var_x120);
        IJth(rJacobian, 4, 4) = ((var_x160) ? (-0.1212 * var_x174 - var_x170 * var_x175) : (-0.29999999999999999 * var_x180));
        IJth(rJacobian, 8, 4) = -0.00048591897908422494 * var_x120;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x121 * var_x91 - var_x122 * var_x82 - var_x122 * var_x84);
        IJth(rJacobian, 1, 5) = -var_x121 * var_x145;
        IJth(rJacobian, 5, 5) = -var_x195 - var_x189 * var_x195;
        IJth(rJacobian, 8, 5) = -var_x122 * var_x224;
        IJth(rJacobian, 9, 5) = -var_x122 * var_x233;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x123 * var_x91 - var_x124 * var_x82 - var_x124 * var_x84);
        IJth(rJacobian, 1, 6) = -var_x123 * var_x145;
        IJth(rJacobian, 6, 6) = var_x200 * var_x210 + var_x207 * var_x211;
        IJth(rJacobian, 8, 6) = -var_x124 * var_x224;
        IJth(rJacobian, 9, 6) = -var_x124 * var_x233;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.56400000000000006 * var_x125);
        IJth(rJacobian, 7, 7) = -var_x216 * var_x220 - var_x219 * var_x220;
        IJth(rJacobian, 9, 7) = -1.7128644012718929e-5 * var_x125;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x138 - 0.037526645154628537 * var_x49 - 425.83427125819611 * var_x130 - 0.0018421356686070195 * var_x100 - 0.0009948166769616954 * var_x126 - 0.055683584885573643 * var_x131 - 0.13757268113686821 * var_x127 - var_x128 * var_x129 - var_x134 * var_chaste_interface__ionic_concentrations__Ki);
        IJth(rJacobian, 1, 8) = 1.5106259501412128e-8 * var_x126;
        IJth(rJacobian, 8, 8) = var_x230 - 1.1396818188745672e-6 * var_x49 - 5.594554271400994e-8 * var_x100 - 9.063755700847278e-8 * var_x126 - 5.0733207598776979e-6 * var_x131 - 0.012932559646803598 * var_x130 - var_x128 * var_x227;
        IJth(rJacobian, 9, 8) = var_x234 + 3.3822138399184653e-6 * var_x131 - 4.1780735479941623e-6 * var_x127 - var_x231 * var_chaste_interface__ionic_concentrations__Ki;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x138 + 4.8559079610460012 * var_x144 - 0.00052671434672763679 * var_x100 - 0.48704794775156179 * var_x139 - 20.360201094532503 * var_x140 - 7.505329030925707 * var_x127 - var_x129 * var_x141 - var_x134 * var_chaste_interface__ionic_concentrations__Nai - var_x143 * var_x67);
        IJth(rJacobian, 8, 9) = var_x230 - var_x231 * var_chaste_interface__ionic_concentrations__Nai;
        IJth(rJacobian, 9, 9) = var_x234 + 0.00014747361493490209 * var_x144 - 1.5996281101931733e-8 * var_x100 - 0.00061833800811279696 * var_x140 - 0.00022793636377491341 * var_x127 - 1.4791615096031613e-5 * var_x139 - var_x141 * var_x227 - var_x143 * var_x232;
