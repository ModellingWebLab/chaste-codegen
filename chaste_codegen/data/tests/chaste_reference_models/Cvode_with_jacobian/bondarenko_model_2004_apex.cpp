...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_model_2004_apexFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x0 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 2.0);
        ...
        const double var_x6 = 0.050000000000000003 * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss;
        const double var_x7 = 0.16 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur;
        const double var_x8 = pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 3.0);
        ...
        const double var_x13 = var_x10 * var_chaste_interface__calcium_concentration__Cai;
        const double var_x14 = exp(0.013632298072467722 * var_chaste_interface__membrane__V);
        const double var_x15 = var_x14 * pow(var_chaste_interface__sodium_concentration__Nai, 3.0);
        const double var_x16 = var_x12 * (69470190977295.516 * var_x13 + 24.5381365304419 * var_x15);
        ...
        const double var_x25 = 1 / var_chaste_interface__sodium_concentration__Nai;
        const double var_x26 = pow(var_x25, 1.5);
        const double var_x27 = exp(-0.0038949423064193493 * var_chaste_interface__membrane__V);
        const double var_x28 = (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.038949423064193495 * var_chaste_interface__membrane__V);
        const double var_x29 = 1.0 + 0.1245 * var_x27 + 0.036499999999999998 * var_x28;
        const double var_x30 = (0.00048492031714920898 * var_x27 + 0.0014216539418430625 * var_x28) / (pow(var_x29, 2) * (1.0 + 3043189.1166997822 * var_x26));
        const double var_x31 = 1800.0 * var_x15 - 2744000000000000.0 * var_x13;
        const double var_x32 = var_x10 * var_x31 / pow(var_x11, 2);
        const double var_x33 = 40.0 + var_chaste_interface__membrane__V;
        const double var_x34 = 1 / var_chaste_interface__calcium_concentration__Cai;
        const double var_x35 = pow(var_chaste_interface__calcium_concentration__Cai, 2.0);
        const double var_x36 = 0.25 + var_x35;
        const double var_x37 = pow(var_chaste_interface__calcium_concentration__Cai, 3.0) / pow(var_x36, 2);
        const double var_x38 = var_x10 * var_x12;
        const double var_x39 = 1 / var_x36;
        const double var_x40 = var_x39 * pow(var_chaste_interface__calcium_concentration__Cai, 1.0);
        const double var_x41 = 1 / (0.10000000000000001 * var_chaste_interface__potassium_concentration__Ki + 0.90000000000000002 * var_chaste_interface__sodium_concentration__Nai);
        const double var_x42 = var_x41 * var_chaste_interface__fast_sodium_current__O_Na;
        const double var_x43 = 1 / (0.97999999999999998 * var_chaste_interface__potassium_concentration__Ki + 0.02 * var_chaste_interface__sodium_concentration__Nai);
        const double var_x44 = var_x43 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x45 = var_x12 * var_x14 * pow(var_chaste_interface__sodium_concentration__Nai, 2.0);
        const double var_x46 = var_x25 * var_x26 / (var_x29 * pow((3.2860264730588296e-7 + var_x26), 2));
        const double var_x47 = log(126540.0 * var_x41);
        const double var_x48 = var_x1 * var_x5;
        const double var_x49 = var_x0 * var_x1;
        const double var_x50 = var_x1 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur;
        const double var_x51 = var_x1 * var_x8 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x52 = var_x1 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss;
        const double var_x53 = var_x1 * var_x18;
        const double var_x54 = var_x17 * pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 2.0) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x55 = var_x17 * pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 1.0);
        const double var_x56 = var_x17 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur;
        const double var_x57 = var_x17 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss;
        const double var_x58 = log(8092.0 * var_x43);
        const double var_x59 = 0.23799999999999999 + var_chaste_interface__calcium_concentration__Cai;
        const double var_x60 = pow(var_x59, (-2.0));
        const double var_x61 = pow((1.0 + 11.899999999999999 * var_x60), (-1.0));
        const double var_x62 = 0.0327 * var_chaste_interface__calcium_buffering__LTRPN_Ca;
        const double var_x63 = 0.0023700000000000001 * var_chaste_interface__calcium_buffering__HTRPN_Ca;
        const double var_x64 = 0.0327 * var_chaste_interface__calcium_concentration__Cai;
        const double var_x65 = 0.0023700000000000001 * var_chaste_interface__calcium_concentration__Cai;
        const double var_x66 = 0.23799999999999999 + var_chaste_interface__calcium_concentration__Cass;
        const double var_x67 = pow(var_x66, (-2.0));
        const double var_x68 = pow((1.0 + 11.899999999999999 * var_x67), (-1.0));
        const double var_x69 = 92.541511836848613 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x70 = -var_chaste_interface__ryanodine_receptors__P_O1 - var_chaste_interface__ryanodine_receptors__P_O2;
        const double var_x71 = 363.63636363636363 * var_chaste_interface__calcium_fluxes__P_RyR;
        const double var_x72 = -63.0 + var_chaste_interface__membrane__V;
        const double var_x73 = -var_chaste_interface__calcium_concentration__Cass + var_chaste_interface__calcium_concentration__CaJSR;
        ...
        const double var_x76 = var_x68 * var_x73;
        const double var_x77 = var_x71 * var_x76;
        const double var_x78 = 1 + 0.00125 * var_chaste_interface__calcium_concentration__CaJSR;
        const double var_x79 = pow(var_x78, (-2.0));
        const double var_x80 = pow((1.0 + 18.75 * var_x79), (-1.0));
        const double var_x81 = 4.5 * var_chaste_interface__calcium_fluxes__P_RyR;
        const double var_x82 = var_x80 * var_x81;
        const double var_x83 = var_x74 * var_x81;
        const double var_x84 = -var_x73 * var_x82;
        const double var_x85 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x86 = -1 + var_x85;
        const double var_x87 = exp(-0.038580246913580245 * pow(var_x86, 2.0));
        const double var_x88 = 0.00247 * var_x87;
        const double var_x89 = pow(var_chaste_interface__calcium_concentration__Cass, 3.0);
        const double var_x90 = 0.012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2.0) * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x91 = 0.0040499999999999998 * var_x89;
        const double var_x92 = -0.0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4.0);
        const double var_x93 = exp(-0.92307692307692313 - 0.076923076923076927 * var_chaste_interface__membrane__V);
        const double var_x94 = 0.015384615384615385 * var_x93 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x95 = 1 + 0.068965517241379309 * var_chaste_interface__membrane__V;
        const double var_x96 = exp(-2.1025 * pow(var_x95, 2.0));
        const double var_x97 = var_x96 * pow(var_x95, 1.0);
        const double var_x98 = 0.0037699999999999999 * var_x97;
        const double var_x99 = var_x98 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x100 = 1 + 0.050000000000000003 * var_chaste_interface__membrane__V;
        const double var_x101 = exp(-1.0 * pow(var_x100, 2.0));
        const double var_x102 = 1 + 0.025000000000000001 * var_chaste_interface__membrane__V;
        const double var_x103 = exp(-160.0 * pow(var_x102, 2.0));
        const double var_x104 = exp(1.2 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x105 = 1.0 + 0.12 * var_x104;
        const double var_x106 = var_x104 / var_x105;
        const double var_x107 = var_x106 * (0.075000000000000011 * var_x101 * pow(var_x100, 1.0) - 5.5999999999999996 * var_x103 * pow(var_x102, 1.0));
        const double var_x108 = var_x107 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x109 = 0.40000000000000002 * var_x108;
        const double var_x110 = 0.00040000000000000002 * var_x107;
        const double var_x111 = var_x110 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x112 = 1.0 + 0.69999999999999996 * var_x103 - 0.75 * var_x101;
        const double var_x113 = var_x106 * var_x112;
        const double var_x114 = 4.0000000000000003e-5 * var_x113;
        const double var_x115 = var_x114 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x116 = var_x113 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x117 = 0.040000000000000008 * var_x116;
        const double var_x118 = var_x112 * exp(2.3999999999999999 + var_x85) / pow(var_x105, 2);
        const double var_x119 = var_x118 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x120 = 0.0048000000000000004 * var_x119;
        const double var_x121 = 4.8000000000000006e-6 * var_x118;
        const double var_x122 = var_x121 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x123 = 1 / (20.0 + var_chaste_interface__calcium_concentration__Cass);
        const double var_x124 = 0.23324 * var_x123;
        const double var_x125 = var_x124 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x126 = var_chaste_interface__calcium_concentration__Cass / pow((1 + 0.050000000000000003 * var_chaste_interface__calcium_concentration__Cass), 2);
        const double var_x127 = 0.00058310000000000002 * var_x126;
        const double var_x128 = var_x127 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x129 = 0.013000000000000001 * var_x96;
        const double var_x130 = 0.20000000000000001 * var_x93;
        const double var_x131 = var_x124 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x132 = -var_x131;
        const double var_x133 = 0.40000000000000002 * var_x113;
        const double var_x134 = 0.00040000000000000002 * var_x113;
        const double var_x135 = 0.0076923076923076927 * var_x93 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x136 = 1.0 - var_chaste_interface__L_type_calcium_current__C3 - var_chaste_interface__L_type_calcium_current__C4 - var_chaste_interface__L_type_calcium_current__I1 - var_chaste_interface__L_type_calcium_current__I2 - var_chaste_interface__L_type_calcium_current__I3 - var_chaste_interface__L_type_calcium_current__O - 2 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x137 = 0.014400000000000003 * var_x118 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x138 = 1.2000000000000002 * var_x107 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x139 = 0.12000000000000002 * var_x113 * var_chaste_interface__L_type_calcium_current__C2;
        const double var_x140 = -1.6000000000000001 * var_x113;
        const double var_x141 = 0.10000000000000001 * var_x93;
        const double var_x142 = 0.011538461538461541 * var_x93 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x143 = 0.0096000000000000009 * var_x118 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x144 = 0.80000000000000004 * var_x107 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x145 = 0.080000000000000016 * var_x113 * var_chaste_interface__L_type_calcium_current__C3;
        const double var_x146 = 0.80000000000000004 * var_x113;
        const double var_x147 = 0.15000000000000002 * var_x93;
        const double var_x148 = 7.6923076923076936e-6 * var_x93 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x149 = 3.0769230769230774e-5 * var_x93 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x150 = var_x93 * var_chaste_interface__L_type_calcium_current__I1;
        const double var_x151 = 0.0075399999999999998 * var_x97;
        const double var_x152 = var_x151 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x153 = var_x123 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x154 = 0.87931480000000006 * var_x153 * var_x97 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x155 = 1.1195520000000001e-5 * var_x119 * var_x153;
        const double var_x156 = 0.00093296000000000004 * var_x153;
        const double var_x157 = var_x108 * var_x156;
        const double var_x158 = 9.3296000000000009e-5 * var_x116 * var_x153;
        const double var_x159 = 13.0 - 13.0 * var_x96;
        const double var_x160 = var_x159 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x161 = var_x124 * var_x160;
        const double var_x162 = var_x127 * var_x160;
        const double var_x163 = 0.00093296000000000004 * var_x116 * var_x123;
        const double var_x164 = 2.3323999999999999e-6 * var_x116 * var_x126;
        const double var_x165 = 0.026000000000000002 * var_x96;
        const double var_x166 = var_x131 * var_x159;
        const double var_x167 = var_x113 * var_x156;
        const double var_x168 = 0.00040000000000000002 * var_x93;
        const double var_x169 = 0.0001 * var_x93;
        const double var_x170 = var_x98 * var_chaste_interface__L_type_calcium_current__I1;
        const double var_x171 = var_x110 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x172 = var_x114 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x173 = var_x121 * var_chaste_interface__L_type_calcium_current__I3;
        const double var_x174 = var_x124 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x175 = var_x127 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x176 = 0.013000000000000001 - var_x129;
        const double var_x177 = -var_x134;
        const double var_x178 = 0.04926108374384236 * var_chaste_interface__membrane__V;
        const double var_x179 = -var_x178;
        const double var_x180 = exp(0.36945812807881773 + var_x179);
        const double var_x181 = 0.01083743842364532 * var_x180 * var_chaste_interface__fast_sodium_current__O_Na;
        const double var_x182 = exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__membrane__V);
        const double var_x183 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__membrane__V);
        const double var_x184 = (0.0016666666666666668 * var_x183 + 0.0085583333333333327 * var_x182) / pow((var_x183 + 0.4108 * var_x182), 2);
        const double var_x185 = 60.832000000000001 * var_x184 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x186 = exp(-0.42168674698795178 - 0.060240963855421679 * var_chaste_interface__membrane__V);
        const double var_x187 = var_x186 / pow((1 + 0.47846713846216332 * var_x186), 2);
        const double var_x188 = 0.073163809141391992 * var_x187 * var_chaste_interface__fast_sodium_current__O_Na;
        const double var_x189 = 2.0000000000000002e-5 * var_chaste_interface__membrane__V;
        const double var_x190 = 0.008539999999999999 + var_x189;
        const double var_x191 = 1 / var_x190;
        const double var_x192 = 1 / (0.39395599999999997 + 0.188495 * var_x186);
        const double var_x193 = 1 / (0.25 * var_x183 + 0.1027 * var_x182);
        const double var_x194 = -0.12987012987012986 * var_chaste_interface__membrane__V;
        const double var_x195 = exp(-0.90909090909090906 + var_x194);
        const double var_x196 = exp(-0.36945812807881773 + var_x178);
        const double var_x197 = var_x192 * var_x193 * var_x195 * var_x196;
        const double var_x198 = var_x191 * var_x197;
        const double var_x199 = 9.751496152750069e-7 * var_x198 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x200 = 3.3174296813103594e-6 * var_x197 * var_chaste_interface__fast_sodium_current__IF_Na / pow((1 + 0.0023419203747072604 * var_chaste_interface__membrane__V), 2);
        const double var_x201 = var_x191 * var_x195 * var_x196;
        const double var_x202 = 0.00019355636363636362 * var_x184 * var_x192 * var_x201 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x203 = var_x187 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x204 = 8.8508255294954821e-7 * var_x193 * var_x201 * var_x203;
        const double var_x205 = 1.0 * var_x192;
        const double var_x206 = 0.22 * var_x180;
        const double var_x207 = 3.802 * var_x193;
        const double var_x208 = 1.2097272727272726e-5 * var_x198;
        const double var_x209 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x210 = -var_x209;
        const double var_x211 = exp(0.12315270935960591 + var_x179);
        const double var_x212 = 0.009852216748768473 * var_x211;
        const double var_x213 = var_x212 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x214 = 9.0909090909090901e-8 * var_x195;
        const double var_x215 = var_x214 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x216 = exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x217 = 71.871455576559541 * (0.0015333333333333336 * var_x183 + 0.0068466666666666667 * var_x216) / pow((var_x183 + 0.44652173913043475 * var_x216), 2);
        const double var_x218 = var_x217 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x219 = 0.20000000000000001 * var_x211;
        const double var_x220 = -var_x219;
        const double var_x221 = -0.008539999999999999 - var_x189;
        const double var_x222 = 3.802 / (0.1027 * var_x216 + 0.23000000000000001 * var_x183);
        const double var_x223 = 6.9999999999999997e-7 * var_x195;
        const double var_x224 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x225 = -var_x224;
        const double var_x226 = exp(-0.12315270935960591 + var_x179);
        const double var_x227 = 0.0094433497536945809 * var_x226;
        const double var_x228 = var_x214 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x229 = exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x230 = 95.049999999999997 * (0.0013333333333333335 * var_x183 + 0.0060411764705882356 * var_x229) / pow((var_x183 + 0.51349999999999996 * var_x229), 2);
        const double var_x231 = 3.802 / (0.20000000000000001 * var_x183 + 0.1027 * var_x229);
        const double var_x232 = -var_x231;
        const double var_x233 = 0.19170000000000001 * var_x226;
        const double var_x234 = -var_x222 - var_x233;
        const double var_x235 = var_x221 + var_x232;
        const double var_x236 = var_x214 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x237 = 1.818181818181818e-9 * var_x195 * var_chaste_interface__fast_sodium_current__I2_Na;
        const double var_x238 = 7.3163809141391995e-5 * var_x203;
        const double var_x239 = var_x187 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x240 = 1.0526315789473684e-5 * var_x192;
        const double var_x241 = -var_x223;
        const double var_x242 = 1.4e-8 * var_x195;
        const double var_x243 = 0.001 * var_x192;
        const double var_x244 = var_x212 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x245 = var_x217 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x246 = var_x227 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x247 = var_x230 * var_chaste_interface__fast_sodium_current__IC_Na3;
        const double var_x248 = 0.0098429554532475667 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur;
        const double var_x249 = 0.0030759235791398645 * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss;
        const double var_x250 = 0.025019562392723658 * var_x8;
        const double var_x251 = exp(-1.8711 - 0.062370000000000002 * var_chaste_interface__membrane__V);
        const double var_x252 = exp(1.0731000000000002 + 0.035770000000000003 * var_chaste_interface__membrane__V);
        const double var_x253 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x254 = exp(4.7857142857142856 + var_x253);
        const double var_x255 = 1.0 + 0.051334999999999999 * var_x254;
        const double var_x256 = var_x254 / var_x255;
        const double var_x257 = 1.0 - var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x258 = -var_x253;
        const double var_x259 = exp(-4.7857142857142856 + var_x258);
        const double var_x260 = 1.0 + 0.0067083000000000004 * var_x259;
        const double var_x261 = exp(-1.9285714285714286 + var_x258);
        const double var_x262 = var_x261 / var_x260;
        const double var_x263 = exp(-0.062899999999999998 * var_chaste_interface__membrane__V);
        const double var_x264 = 1 / (2.0579999999999998 + 0.49299999999999999 * var_x263);
        const double var_x265 = exp(-2.9220779220779218 + var_x194);
        const double var_x266 = 1.0 + var_x265;
        const double var_x267 = 0.12987012987012986 * var_x265 / pow(var_x266, 2);
        const double var_x268 = var_x264 * var_x267;
        const double var_x269 = 1.0 / var_x266;
        const double var_x270 = 0.0073216139155926159 * var_x263 / pow((1 + 0.23955296404275997 * var_x263), 2);
        const double var_x271 = -var_x264;
        const double var_x272 = exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V);
        const double var_x273 = 1.0 + var_x272;
        const double var_x274 = 1 / var_x273;
        const double var_x275 = 1 / (270.0 + 1050.0 * var_x274);
        const double var_x276 = var_x272 / pow(var_x273, 2);
        const double var_x277 = 0.17543859649122806 * var_x276;
        const double var_x278 = 1.0 * var_x274;
        const double var_x279 = 1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        const double var_x280 = exp(-3.3919999999999999 - 0.128 * var_chaste_interface__membrane__V);
        const double var_x281 = 1.0 - var_x280;
        const double var_x282 = 4.8133299999999997e-6 / var_x281;
        const double var_x283 = exp(-1.0069999999999999 - 0.037999999999999999 * var_chaste_interface__membrane__V);
        const double var_x284 = 26.5 + var_chaste_interface__membrane__V;
        const double var_x285 = 1 / (1200.0 - 170.0 * var_x274);
        const double var_x286 = exp(-0.086199999999999999 * var_chaste_interface__membrane__V);
        const double var_x287 = 1 / (13.17 + 39.299999999999997 * var_x286);
        const double var_x288 = exp(0.038198000000000003 * var_chaste_interface__membrane__V);
        const double var_x289 = 0.00052457313400000008 * var_x288 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2;
        const double var_x290 = exp(-0.041779999999999998 * var_chaste_interface__membrane__V);
        const double var_x291 = 2.8786419999999997e-6 * var_x290 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x292 = exp(0.11695499999999999 + 0.023390999999999999 * var_chaste_interface__membrane__V);
        const double var_x293 = 0.0021243940109999999 * var_x292 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x294 = exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x295 = 0.00021232196 * var_x294 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K;
        const double var_x296 = 6.8899999999999994e-5 * var_x290;
        const double var_x297 = 0.090820999999999999 * var_x292;
        const double var_x298 = 0.013733 * var_x288;
        const double var_x299 = 0.0064970000000000002 * var_x294;
        const double var_x300 = exp(0.01176 * var_chaste_interface__membrane__V);
        const double var_x301 = exp(-0.063100000000000003 * var_chaste_interface__membrane__V);
        const double var_x302 = -0.022348 * var_x300;

        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.002967 + 0.025339071657754012 * var_x18 - 13.0 * var_chaste_interface__fast_sodium_current__O_Na - 0.1729 * var_chaste_interface__L_type_calcium_current__O - 0.0057499999999999999 * var_x0 - 0.28280213903743318 * var_x5 - 0.078 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K - 0.68869565217391304 * var_x30 - 2.6970585464294846e-17 * var_x16 - 6.8281768329957483e-20 * var_x32 - var_x22 * var_x24 - var_x6 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss - var_x7 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur - var_x9 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 0.25641025641025644 * var_x19 * var_x23 * var_x33 * var_chaste_interface__calcium_concentration__Cai / pow(var_x20, 2));
        IJth(rJacobian, 1, 0) = var_x61 * (-1.1288639535443301e-5 + 1.6591891954566279e-18 * var_x16 + 4.2005900246296372e-21 * var_x32);
        IJth(rJacobian, 2, 0) = -var_x68 * var_x69;
        IJth(rJacobian, 5, 0) = -var_x88 * var_chaste_interface__L_type_calcium_current__O + 3.8117283950617286e-5 * var_x72 * var_x87 * pow(var_x86, 1.0) * var_chaste_interface__L_type_calcium_current__O;
        IJth(rJacobian, 11, 0) = var_x109 + var_x111 + var_x115 + var_x117 + var_x94 - var_x120 - var_x122 - var_x99;
        IJth(rJacobian, 12, 0) = var_x137 - var_x135 - var_x138 - var_x139 + 1.6000000000000001 * var_x107 * var_x136 + 0.16000000000000003 * var_x113 * var_x136 + 0.0038461538461538464 * var_x93 * var_chaste_interface__L_type_calcium_current__C2 - 0.019200000000000002 * var_x118 * var_x136;
        IJth(rJacobian, 13, 0) = var_x135 + var_x138 + var_x139 + var_x143 - var_x137 - var_x142 - var_x144 - var_x145;
        IJth(rJacobian, 14, 0) = var_x120 + var_x142 + var_x144 + var_x145 + var_x155 - var_x109 - var_x117 - var_x143 - var_x148 - var_x149 - var_x152 - var_x154 - var_x157 - var_x158 - var_x94 - 7.6923076923076936e-8 * var_x150;
        IJth(rJacobian, 15, 0) = var_x157 + var_x158 + var_x171 + var_x172 - var_x155 - var_x170 - var_x173 - var_x150 * var_x151 + 0.00015384615384615385 * var_x150 * var_x159;
        IJth(rJacobian, 16, 0) = var_x122 + var_x149 + var_x152 + var_x99 - var_x111 - var_x115;
        IJth(rJacobian, 17, 0) = var_x148 + var_x154 + var_x170 + var_x173 - var_x171 - var_x172;
        IJth(rJacobian, 18, 0) = -0.00015994802611527293 - 0.12710251172237075 * var_x30 - 0.79974013057636473 * var_chaste_interface__fast_sodium_current__O_Na - 4.9775675863698846e-18 * var_x16 - 1.2601770073888914e-20 * var_x32;
        IJth(rJacobian, 19, 0) = var_x181 + var_x185 + var_x202 + var_x204 - var_x188 - var_x199 - var_x200;
        IJth(rJacobian, 20, 0) = var_x210 + var_x213 + var_x218 - var_x181 - var_x185 - var_x215;
        IJth(rJacobian, 21, 0) = var_x225 - var_x213 - var_x218 - var_x228 + var_x227 * var_chaste_interface__fast_sodium_current__C_Na2 + var_x230 * (1.0 - var_chaste_interface__fast_sodium_current__C_Na1 - var_chaste_interface__fast_sodium_current__C_Na2 - var_chaste_interface__fast_sodium_current__I1_Na - var_chaste_interface__fast_sodium_current__I2_Na - var_chaste_interface__fast_sodium_current__IC_Na2 - var_chaste_interface__fast_sodium_current__IC_Na3 - var_chaste_interface__fast_sodium_current__IF_Na - var_chaste_interface__fast_sodium_current__O_Na);
        IJth(rJacobian, 22, 0) = var_x236 + var_x238 - var_x237 - 7.7014535938307356e-7 * var_x239;
        IJth(rJacobian, 23, 0) = var_x237 + 7.7014535938307356e-7 * var_x239;
        IJth(rJacobian, 24, 0) = var_x188 + var_x199 + var_x200 + var_x209 + var_x215 + var_x244 + var_x245 - var_x202 - var_x204 - var_x236 - var_x238;
        IJth(rJacobian, 25, 0) = var_x224 + var_x228 + var_x246 + var_x247 - var_x244 - var_x245;
        IJth(rJacobian, 26, 0) = 2.0000000000000002e-5 + var_x210 + var_x225 - var_x246 - var_x247 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I1_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I2_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na2 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na3 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IF_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__O_Na + var_x214 * var_chaste_interface__fast_sodium_current__IC_Na3;
        IJth(rJacobian, 27, 0) = 0.084735007814913832 * var_x30 + 0.0015588209597120044 * var_x18 - 0.0047984407834581883 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K - 0.017397555353928621 * var_x5 - 0.0003537312116010844 * var_x0 - var_x248 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur - var_x249 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss - var_x250 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        IJth(rJacobian, 28, 0) = 0.024673572000000001 * var_x251 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f + 0.0064614928000000004 * var_x252 * (1.0 - var_chaste_interface__fast_transient_outward_potassium_current__ato_f);
        IJth(rJacobian, 29, 0) = -0.00013571428571428569 * var_x256 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 2.1714285714285715e-5 * var_x257 * var_x262 + 6.9668928571428563e-6 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f * exp(9.5714285714285712 + 0.2857142857142857 * var_chaste_interface__membrane__V) / pow(var_x255, 2) + 1.4566594285714287e-7 * var_x257 * var_x259 * var_x261 / pow(var_x260, 2);
        IJth(rJacobian, 30, 0) = var_x268 + var_x270 * (var_x269 - var_chaste_interface__slow_transient_outward_potassium_current__ato_s);
        IJth(rJacobian, 31, 0) = -var_x275 * var_x277 + 0.00016708437761069338 * var_x276 * (var_x278 - var_chaste_interface__slow_transient_outward_potassium_current__ito_s) / pow((0.25714285714285712 + var_x274), 2);
        IJth(rJacobian, 32, 0) = var_x279 * var_x282 + 3.6226653999999999e-6 * var_x283 * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs - 6.1610624e-7 * var_x279 * var_x280 * var_x284 / pow(var_x281, 2);
        IJth(rJacobian, 33, 0) = var_x268 + var_x270 * (var_x269 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur);
        IJth(rJacobian, 34, 0) = -var_x277 * var_x285 - 2.0711500974658867e-5 * var_x276 * (var_x278 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur) / pow((1 - 0.14166666666666666 * var_x274), 2);
        IJth(rJacobian, 35, 0) = var_x267 * var_x287 + 0.0021933842239185751 * var_x286 * (var_x269 - var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss) / pow((0.33511450381679392 + var_x286), 2);
        IJth(rJacobian, 37, 0) = var_x289 + var_x291 - var_x293 - var_x295;
        IJth(rJacobian, 38, 0) = 0.00026281248 * var_x300 * (1.0 - var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K - var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K) + 0.0029658262000000005 * var_x301 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1;
        IJth(rJacobian, 39, 0) = -var_x289 - var_x291;
        IJth(rJacobian, 40, 0) = var_x293 + var_x295;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (2.0 * var_x37 + 0.074007286514025064 * var_x38 - 2.0 * var_x40 - 0.0047112379481865285 * var_x34 - var_x21 * var_x24 * var_x33 + 0.02 * var_x22 * var_x33 / pow((1 + 0.10000000000000001 * var_chaste_interface__calcium_concentration__Cai), 2));
        IJth(rJacobian, 1, 1) = var_x61 * (-2.7458174 + var_x62 + var_x63 + 0.96151847158279735 * var_x37 - 0.96151847158279735 * var_x40 - 0.00014491407891765456 * var_x34 - 0.0045528151523329865 * var_x38) + 0.16806722689075632 * pow(var_x59, (-3.0)) * pow((0.084033613445378158 + var_x60), (-2.0)) * (0.125 * var_chaste_interface__calcium_concentration__Cass + 0.019599999999999999 * var_chaste_interface__calcium_buffering__LTRPN_Ca + 3.1999999999999999e-5 * var_chaste_interface__calcium_buffering__HTRPN_Ca + 1.7399999999999999e-5 * var_chaste_interface__calcium_concentration__CaNSR + 0.00014491407891765456 * log(1800.0 * var_x34) - 0.1250174 * var_chaste_interface__calcium_concentration__Cai - 1.1288639535443301e-5 * var_chaste_interface__membrane__V - var_x64 * (70.0 - var_chaste_interface__calcium_buffering__LTRPN_Ca) - var_x65 * (140.0 - var_chaste_interface__calcium_buffering__HTRPN_Ca) + 1.6591891954566279e-18 * var_x12 * var_x31 - 0.48075923579139868 * var_x35 * var_x39);
        IJth(rJacobian, 2, 1) = 2175.0841750841751 * var_x68;
        IJth(rJacobian, 4, 1) = 0.00021430695900857957 + 11.084842707340323 * var_x40 - 11.084842707340323 * var_x37;
        IJth(rJacobian, 6, 1) = 2.2890000000000001 - var_x62;
        IJth(rJacobian, 7, 1) = 0.33180000000000004 - var_x63;
        IJth(rJacobian, 18, 1) = 0.013658445456998963 * var_x38;
        IJth(rJacobian, 1, 2) = 0.125 * var_x61;
        IJth(rJacobian, 2, 2) = var_x68 * (-2175.0841750841751 + var_x70 * var_x71) + 0.16806722689075632 * pow(var_x66, (-3.0)) * pow((0.084033613445378158 + var_x67), (-2.0)) * (2175.0841750841751 * var_chaste_interface__calcium_concentration__Cai - 2175.0841750841751 * var_chaste_interface__calcium_concentration__Cass + var_x73 * var_x75 - var_x69 * var_x72);
        IJth(rJacobian, 3, 2) = -var_x70 * var_x82;
        IJth(rJacobian, 8, 2) = -var_x90 + 0.024299999999999999 * var_x89 * (1.0 + var_x70 - var_chaste_interface__ryanodine_receptors__P_C2);
        IJth(rJacobian, 9, 2) = var_x90;
        IJth(rJacobian, 11, 2) = var_x128 - var_x125;
        IJth(rJacobian, 14, 2) = var_x162 + var_x164 - var_x161 - var_x163;
        IJth(rJacobian, 15, 2) = var_x125 + var_x163 - var_x128 - var_x164;
        IJth(rJacobian, 16, 2) = var_x175 - var_x174;
        IJth(rJacobian, 17, 2) = var_x161 + var_x174 - var_x162 - var_x175;
        IJth(rJacobian, 2, 3) = var_x68 * var_x75;
        IJth(rJacobian, 3, 3) = var_x80 * (-0.050000000000000003 - var_x83) + 0.00013333333333333334 * pow(var_x78, (-3.0)) * pow((0.053333333333333337 + var_x79), (-2.0)) * (0.050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR - var_x73 * var_x83);
        IJth(rJacobian, 4, 3) = 0.002859866539561487;
        IJth(rJacobian, 1, 4) = 1.7399999999999999e-5 * var_x61;
        IJth(rJacobian, 3, 4) = 0.050000000000000003 * var_x80;
        IJth(rJacobian, 4, 4) = -0.0030741734985700667;
        IJth(rJacobian, 2, 5) = 363.63636363636363 * var_x74 * var_x76;
        IJth(rJacobian, 3, 5) = -4.5 * var_x73 * var_x74 * var_x80;
        IJth(rJacobian, 5, 5) = -0.040000000000000001;
        IJth(rJacobian, 1, 6) = var_x61 * (0.019599999999999999 + var_x64);
        IJth(rJacobian, 6, 6) = -0.019599999999999999 - var_x64;
        IJth(rJacobian, 1, 7) = var_x61 * (3.1999999999999999e-5 + var_x65);
        IJth(rJacobian, 7, 7) = -3.1999999999999999e-5 - var_x65;
        IJth(rJacobian, 2, 8) = var_x77;
        IJth(rJacobian, 3, 8) = var_x84;
        IJth(rJacobian, 8, 8) = -0.080249999999999988 + var_x92 - var_x91;
        IJth(rJacobian, 9, 8) = var_x91;
        IJth(rJacobian, 10, 8) = 0.0089999999999999993;
        IJth(rJacobian, 2, 9) = var_x77;
        IJth(rJacobian, 3, 9) = var_x84;
        IJth(rJacobian, 8, 9) = 0.96499999999999997 + var_x92;
        IJth(rJacobian, 9, 9) = -0.96499999999999997;
        IJth(rJacobian, 8, 10) = 0.00080000000000000004 + var_x92;
        ...
        IJth(rJacobian, 2, 11) = -92.541511836848613 * var_x68 * var_x72;
        IJth(rJacobian, 5, 11) = -var_x72 * var_x88;
        IJth(rJacobian, 11, 11) = -0.013000000000000001 + var_x129 + var_x132 - var_x130;
        IJth(rJacobian, 12, 11) = var_x140;
        IJth(rJacobian, 14, 11) = var_x130;
        IJth(rJacobian, 15, 11) = var_x131;
        IJth(rJacobian, 16, 11) = var_x176;
        IJth(rJacobian, 12, 12) = -4.4000000000000004 * var_x113 - 0.050000000000000003 * var_x93;
        IJth(rJacobian, 13, 12) = 1.2000000000000002 * var_x113;
        IJth(rJacobian, 12, 13) = var_x140 + var_x141;
        IJth(rJacobian, 13, 13) = -var_x141 - var_x146;
        IJth(rJacobian, 14, 13) = var_x146;
        IJth(rJacobian, 11, 14) = var_x133;
        IJth(rJacobian, 12, 14) = var_x140;
        IJth(rJacobian, 13, 14) = var_x147;
        IJth(rJacobian, 14, 14) = -0.026000000000000002 + var_x165 - var_x133 - var_x147 - var_x166 - var_x167;
        IJth(rJacobian, 15, 14) = var_x167;
        IJth(rJacobian, 16, 14) = 0.026000000000000002 - var_x165;
        IJth(rJacobian, 17, 14) = var_x166;
        IJth(rJacobian, 11, 15) = 0.00050000000000000001;
        IJth(rJacobian, 12, 15) = var_x140;
        IJth(rJacobian, 14, 15) = 1.0000000000000002e-6 * var_x93;
        IJth(rJacobian, 15, 15) = -0.0135 + var_x129 - 0.002 * var_x159 * var_x93;
        IJth(rJacobian, 17, 15) = var_x176;
        IJth(rJacobian, 11, 16) = var_x134;
        IJth(rJacobian, 12, 16) = var_x140;
        IJth(rJacobian, 14, 16) = var_x168;
        IJth(rJacobian, 16, 16) = var_x132 + var_x177 - var_x168;
        IJth(rJacobian, 17, 16) = var_x131;
        IJth(rJacobian, 12, 17) = var_x140;
        IJth(rJacobian, 14, 17) = var_x169;
        IJth(rJacobian, 15, 17) = var_x134;
        IJth(rJacobian, 16, 17) = 0.00050000000000000001;
        IJth(rJacobian, 17, 17) = -0.00050000000000000001 + var_x177 - var_x169;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-1.4564116150719216e-13 * var_x45 - 300.38955854922278 * var_x42 - 0.060077911709844563 * var_x41 - 0.040051941139896373 * var_x44 - 3.3946082173859908e-7 * var_x46);
        IJth(rJacobian, 1, 18) = 8.9596216554657907e-15 * var_x45 * var_x61;
        IJth(rJacobian, 18, 18) = -6.2649332746797074e-8 * var_x46 - 18.479506521379385 * var_x42 - 2.6878864966397375e-14 * var_x45 - 0.0036959013042758768 * var_x41;
        IJth(rJacobian, 27, 18) = 4.1766221831198049e-8 * var_x46 - 0.0024639342028505845 * var_x44;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (333.76617616580313 * var_x47 - 13.0 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 18, 19) = 20.532785023754872 * var_x47 - 0.79974013057636473 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 19, 19) = -var_x205 - var_x206;
        IJth(rJacobian, 20, 19) = var_x206;
        IJth(rJacobian, 21, 19) = var_x232;
        IJth(rJacobian, 24, 19) = var_x205;
        IJth(rJacobian, 26, 19) = var_x221;
        IJth(rJacobian, 19, 20) = var_x207;
        IJth(rJacobian, 20, 20) = var_x220 + var_x221 - var_x207;
        IJth(rJacobian, 21, 20) = var_x219 + var_x232;
        IJth(rJacobian, 24, 20) = var_x190;
        IJth(rJacobian, 26, 20) = var_x221;
        IJth(rJacobian, 20, 21) = var_x222;
        IJth(rJacobian, 21, 21) = var_x234 + var_x235;
        IJth(rJacobian, 25, 21) = var_x190;
        IJth(rJacobian, 26, 21) = var_x221;
        IJth(rJacobian, 21, 22) = var_x232;
        IJth(rJacobian, 22, 22) = var_x241 - var_x240;
        IJth(rJacobian, 23, 22) = var_x240;
        IJth(rJacobian, 24, 22) = var_x223;
        IJth(rJacobian, 26, 22) = var_x221;
        IJth(rJacobian, 21, 23) = var_x232;
        IJth(rJacobian, 22, 23) = var_x242;
        IJth(rJacobian, 23, 23) = -var_x242;
        IJth(rJacobian, 26, 23) = var_x221;
        IJth(rJacobian, 19, 24) = var_x208;
        IJth(rJacobian, 20, 24) = var_x223;
        IJth(rJacobian, 21, 24) = var_x232;
        IJth(rJacobian, 22, 24) = var_x243;
        IJth(rJacobian, 24, 24) = var_x220 + var_x241 - var_x208 - var_x243;
        IJth(rJacobian, 25, 24) = var_x219;
        IJth(rJacobian, 26, 24) = var_x221;
        IJth(rJacobian, 21, 25) = var_x223 + var_x232;
        IJth(rJacobian, 24, 25) = var_x222;
        IJth(rJacobian, 25, 25) = var_x234 + var_x241;
        IJth(rJacobian, 26, 25) = var_x221 + var_x233;
        IJth(rJacobian, 21, 26) = var_x232;
        IJth(rJacobian, 25, 26) = var_x231;
        IJth(rJacobian, 26, 26) = var_x235 + var_x241;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (0.65056346575383339 * var_x53 - 4.1078913989637309 * var_x50 - 10.441746449740933 * var_x51 - 7.2607529660026051 * var_x48 - 33.376617616580312 * var_x42 - 0.14762734715025908 * var_x49 - 1.2837160621761659 * var_x52 - 0.0066753235233160627 * var_x41 - 1.9625451158549223 * var_x44);
        IJth(rJacobian, 18, 27) = -2.0532785023754871 * var_x42 - 0.00041065570047509742 * var_x41;
        IJth(rJacobian, 27, 27) = 0.04002167008078332 * var_x53 - 0.25271120029236765 * var_x50 - 0.0090818087605069632 * var_x49 - 0.078972250091364896 * var_x52 - 0.64236028224316211 * var_x51 - 0.44667042500874238 * var_x48 - 0.12073277593967864 * var_x44;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-1.2201 * var_x54);
        IJth(rJacobian, 27, 28) = -0.075058687178170977 * var_x54;
        IJth(rJacobian, 28, 28) = -0.18064 * var_x252 - 0.39560000000000001 * var_x251;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x9);
        IJth(rJacobian, 27, 29) = -var_x17 * var_x250;
        IJth(rJacobian, 29, 29) = -0.00015200000000000001 * var_x262 - 0.00095 * var_x256;
        IJth(rJacobian, 30, 30) = var_x271;
        IJth(rJacobian, 31, 31) = -var_x275;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0115 * var_x55);
        IJth(rJacobian, 27, 32) = -0.00070746242320216879 * var_x55;
        IJth(rJacobian, 32, 32) = -9.5333299999999997e-5 * var_x283 - var_x282 * var_x284;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x7);
        IJth(rJacobian, 27, 33) = -var_x17 * var_x248;
        IJth(rJacobian, 33, 33) = var_x271;
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (-0.16 * var_x56);
        IJth(rJacobian, 27, 34) = -0.0098429554532475667 * var_x56;
        IJth(rJacobian, 34, 34) = -var_x285;
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x6);
        IJth(rJacobian, 27, 35) = -var_x17 * var_x249;
        IJth(rJacobian, 35, 35) = -var_x287;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (-0.050000000000000003 * var_x57);
        IJth(rJacobian, 27, 36) = -0.0030759235791398645 * var_x57;
        IJth(rJacobian, 0, 37) = mSetVoltageDerivativeToZero ? 0.0 : (2.0025970569948188 * var_x58 - 0.078 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 27, 37) = 0.12319671014252923 * var_x58 - 0.0047984407834581883 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 37, 37) = -var_x296 - var_x297;
        IJth(rJacobian, 38, 37) = var_x302;
        IJth(rJacobian, 39, 37) = var_x296;
        IJth(rJacobian, 40, 37) = var_x297;
        IJth(rJacobian, 38, 38) = -0.023761000000000001 + var_x302 - 0.047002000000000002 * var_x301;
        IJth(rJacobian, 39, 38) = 0.023761000000000001;
        IJth(rJacobian, 37, 39) = var_x298;
        IJth(rJacobian, 38, 39) = 0.036777999999999998 + var_x302;
        IJth(rJacobian, 39, 39) = -0.036777999999999998 - var_x298;
        IJth(rJacobian, 37, 40) = var_x299;
        IJth(rJacobian, 38, 40) = var_x302;
        IJth(rJacobian, 40, 40) = -var_x299;
    }
