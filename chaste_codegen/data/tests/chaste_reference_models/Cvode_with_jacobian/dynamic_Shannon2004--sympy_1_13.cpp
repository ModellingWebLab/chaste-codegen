...
bool Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::registered = ModelFactory::Register("dynamic_Shannon2004", "AnalyticCvode", (ModelFactory::TCreateMethod)Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::CreateMethod);
    ...
    boost::shared_ptr<RegularStimulus> Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                45,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 1) = 25; // (var_Jrel_SR__ks) [per_millisecond]
        NV_Ith_S(this->mParameters, 2) = 0.00028600000000000001; // (var_Jpump_SR__V_max) [millimolar_per_millisecond]
        NV_Ith_S(this->mParameters, 3) = 1; // (var_Na_buffer__conc_clamp) [dimensionless]
        NV_Ith_S(this->mParameters, 4) = 15; // (var_model_parameters__Cli) [millimolar]
        NV_Ith_S(this->mParameters, 5) = 135; // (var_model_parameters__Ki) [millimolar]
        NV_Ith_S(this->mParameters, 6) = 1.8; // (var_model_parameters__Cao) [millimolar]
        NV_Ith_S(this->mParameters, 7) = 150; // (var_model_parameters__Clo) [millimolar]
        NV_Ith_S(this->mParameters, 8) = 5.4000000000000004; // (var_model_parameters__Ko) [millimolar]
        NV_Ith_S(this->mParameters, 9) = 140; // (var_model_parameters__Nao) [millimolar]
        ...
        NV_Ith_S(this->mParameters, 14) = 16; // (var_INa__G_INa) [milliS_per_microF]
        ...
        NV_Ith_S(this->mParameters, 23) = 310; // (var_model_parameters__T) [kelvin]
    }

    Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::~Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode()
    {
    }


    void Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::VerifyStateVariables()
    {
    ...
    double Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_ICaL_fCa_gate__fCa_SL = 1 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL; // dimensionless
        const double var_ICaL_fCa_gate__fCa_jct = 1 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct; // dimensionless
        ...
        const double var_IKs__pCa_SL = 3 - log10(1 * var_chaste_interface__Ca_buffer__Ca_SL); // dimensionless
        const double var_IKs__G_Ks_SL = (0.057000000000000002 + 0.19 / (1 + exp(-12 + 1.6666666666666667 * var_IKs__pCa_SL))) * NV_Ith_S(mParameters, 20); // milliS_per_microF
        const double var_IKs__pCa_jct = 3 - log10(1 * var_chaste_interface__Ca_buffer__Ca_jct); // dimensionless
        const double var_IKs__G_Ks_jct = (0.057000000000000002 + 0.19 / (1 + exp(-12 + 1.6666666666666667 * var_IKs__pCa_jct))) * NV_Ith_S(mParameters, 20); // milliS_per_microF
        ...
        const double var_INaCa__HNa = 3; // dimensionless
        ...
        const double var_INaCa__Ka_SL = 1 / (1 + pow(var_INaCa__Kd_act, 3) / pow(var_chaste_interface__Ca_buffer__Ca_SL, 3)); // dimensionless
        const double var_INaCa__Ka_jct = 1 / (1 + pow(var_INaCa__Kd_act, 3) / pow(var_chaste_interface__Ca_buffer__Ca_jct, 3)); // dimensionless
        ...
        const double var_IKr_Rr_gate__Rr = 1 / (1 + exp(1.4732142857142858 + 0.044642857142857144 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_ICaL__Q_CaL = pow(var_ICaL__Q10_CaL, (-31 + 0.10000000000000001 * NV_Ith_S(mParameters, 23))); // dimensionless
        ...
        const double var_ICap__Q_SLCaP = pow(var_ICap__Q10_SLCaP, (-31 + 0.10000000000000001 * NV_Ith_S(mParameters, 23))); // dimensionless
        const double var_ICap__i_Cap_SL = var_ICap__Fx_SLCaP_SL * var_ICap__Q_SLCaP * var_ICap__V_maxAF / (1 + pow((var_ICap__Km / var_chaste_interface__Ca_buffer__Ca_SL), var_ICap__H)); // microA_per_microF
        const double var_ICap__i_Cap_jct = var_ICap__Fx_SLCaP_jct * var_ICap__Q_SLCaP * var_ICap__V_maxAF / (1 + pow((var_ICap__Km / var_chaste_interface__Ca_buffer__Ca_jct), var_ICap__H)); // microA_per_microF
        ...
        const double var_INaCa__Q_NCX = pow(var_INaCa__Q10_NCX, (-31 + 0.10000000000000001 * NV_Ith_S(mParameters, 23))); // dimensionless
        ...
        const double var_INaK__Q_Km_Nai = pow(var_INaK__Q10_Km_Nai, (-31 + 0.10000000000000001 * NV_Ith_S(mParameters, 23))); // dimensionless
        const double var_INaK__Q_NaK = pow(var_INaK__Q10_NaK, (-31 + 0.10000000000000001 * NV_Ith_S(mParameters, 23))); // dimensionless
        ...
        const double var_INaK__i_NaK_SL = var_INaK__Fx_NaK_SL * var_INaK__I_NaK_max * var_INaK__Q_NaK * var_INaK__f_NaK * NV_Ith_S(mParameters, 8) / ((1 + pow((var_INaK__Km_Nai * var_INaK__Q_Km_Nai / var_chaste_interface__Na_buffer__Na_SL), var_INaK__H_NaK)) * (var_INaK__Km_Ko + NV_Ith_S(mParameters, 8))); // microA_per_microF
        const double var_INaK__i_NaK_jct = var_INaK__Fx_NaK_jct * var_INaK__I_NaK_max * var_INaK__Q_NaK * var_INaK__f_NaK * NV_Ith_S(mParameters, 8) / ((1 + pow((var_INaK__Km_Nai * var_INaK__Q_Km_Nai / var_chaste_interface__Na_buffer__Na_jct), var_INaK__H_NaK)) * (var_INaK__Km_Ko + NV_Ith_S(mParameters, 8))); // microA_per_microF
        ...
        const double var_ICl_Ca__i_Cl_Ca = (-var_reversal_potentials__E_Cl + var_chaste_interface__cell__V) * (var_ICl_Ca__Fx_Cl_SL / (1 + var_ICl_Ca__Kd_ClCa / var_chaste_interface__Ca_buffer__Ca_SL) + var_ICl_Ca__Fx_Cl_jct / (1 + var_ICl_Ca__Kd_ClCa / var_chaste_interface__Ca_buffer__Ca_jct)) * var_ICl_Ca__G_Cl; // microA_per_microF
        ...
        const double var_IK1_K1_gate__alpha_K1 = 1.02 / (1 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 0.23849999999999999 * var_reversal_potentials__E_K)); // per_millisecond
        const double var_IK1_K1_gate__beta_K1 = (1 * exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 0.061749999999999999 * var_reversal_potentials__E_K) + 0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 0.080320000000000003 * var_reversal_potentials__E_K)) / (1 + exp(-2.4444678999999998 + 0.51429999999999998 * var_reversal_potentials__E_K - 0.51429999999999998 * var_chaste_interface__cell__V)); // per_millisecond
    ...
    void Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_Ca_buffer__koff_Calsequestrin = 65; // per_millisecond
        ...
        const double var_Ca_buffer__kon_Calsequestrin = 100; // per_millimolar_per_millisecond
        ...
        const double var_ICaL__gamma_Nai = 0.75; // dimensionless
        const double var_ICaL__gamma_Nao = 0.75; // dimensionless
        const double d_dt_chaste_interface_var_ICaL_fCa_gate__fCaB_SL = -0.011900000000000001 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL + 1.7 * (1 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL) * var_chaste_interface__Ca_buffer__Ca_SL; // 1 / millisecond
        const double d_dt_chaste_interface_var_ICaL_fCa_gate__fCaB_jct = -0.011900000000000001 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct + 1.7 * (1 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct) * var_chaste_interface__Ca_buffer__Ca_jct; // 1 / millisecond
        const double var_ICaL_fCa_gate__fCa_SL = 1 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL; // dimensionless
        const double var_ICaL_fCa_gate__fCa_jct = 1 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct; // dimensionless
        const double var_ICab__Fx_CaBk_SL = 0.89000000000000001; // dimensionless
        const double var_ICab__Fx_CaBk_jct = 0.11; // dimensionless
        ...
        const double var_Jrel_SR__Max_SR = 15; // dimensionless
        const double var_Jrel_SR__Min_SR = 1; // dimensionless
        const double var_Jrel_SR__RI = 1 - var_chaste_interface__Jrel_SR__I - var_chaste_interface__Jrel_SR__O - var_chaste_interface__Jrel_SR__R; // dimensionless
        const double var_Jrel_SR__kCaSR = -(-var_Jrel_SR__Min_SR + var_Jrel_SR__Max_SR) / (1 + pow((var_Jrel_SR__EC50_SR / var_chaste_interface__Ca_buffer__Ca_SR), var_Jrel_SR__HSR)) + var_Jrel_SR__Max_SR; // dimensionless
        ...
        const double var_Jrel_SR__koCa = 10; // per_millimolar2_per_millisecond
        ...
        const double var_ICaL_d_gate__d_infinity = 1 / (1 + exp(-2.4166666666666665 - 0.16666666666666666 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL_d_gate__tau_d = 28.571428571428569 * (1 - exp(-2.4166666666666665 - 0.16666666666666666 * var_chaste_interface__cell__V)) * var_ICaL_d_gate__d_infinity / (14.5 + var_chaste_interface__cell__V); // millisecond
        ...
        const double var_ICaL_f_gate__f_infinity = 1 / (1 + exp(9.7388888888888889 + 0.27777777777777779 * var_chaste_interface__cell__V)) + 0.59999999999999998 / (1 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_IKr_Xr_gate__Xr_infinity = 1 / (1 + exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V)); // dimensionless
        const double var_IKr_Xr_gate__tau_Xr = 1 / (0.00060999999999999997 * (10 + var_chaste_interface__cell__V) / (-1 + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V)) + 0.0013799999999999999 * (7 + var_chaste_interface__cell__V) / (1 - exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V))); // millisecond
        ...
        const double var_IKs_Xs_gate__Xs_infinity = 1 / (1 + exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V)); // dimensionless
        const double var_IKs_Xs_gate__tau_Xs = 1 / (0.00013100000000000001 * (30 + var_chaste_interface__cell__V) / (-1 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V)) + 7.1899999999999999e-5 * (30 + var_chaste_interface__cell__V) / (1 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V))); // millisecond
        ...
        const double var_INa_h_gate__alpha_h = ((var_chaste_interface__cell__V < -40) ? (0.13500000000000001 * exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 16) - 0.14705882352941177 * var_chaste_interface__cell__V)) : (0)); // per_millisecond
        const double var_INa_h_gate__beta_h = ((var_chaste_interface__cell__V < -40) ? (310000 * exp(0.34999999999999998 * var_chaste_interface__cell__V - 0.34999999999999998 * NV_Ith_S(mParameters, 16)) + 3.5600000000000001 * exp(0.079000000000000001 * var_chaste_interface__cell__V - 0.079000000000000001 * NV_Ith_S(mParameters, 16))) : (7.6923076923076916 / (1 + exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 16) - 0.0900900900900901 * var_chaste_interface__cell__V)))); // per_millisecond
        const double var_INa_h_gate__h_infinity = 0.01 * NV_Ith_S(mParameters, 15) + (1 - 0.01 * NV_Ith_S(mParameters, 15)) * var_INa_h_gate__alpha_h / (var_INa_h_gate__alpha_h + var_INa_h_gate__beta_h); // dimensionless
        ...
        const double var_INa_j_gate__j_infinity = 0.01 * NV_Ith_S(mParameters, 15) + (1 - 0.01 * NV_Ith_S(mParameters, 15)) * var_INa_j_gate__alpha_j / (var_INa_j_gate__alpha_j + var_INa_j_gate__beta_j); // dimensionless
        ...
        const double var_INa_m_gate__alpha_m = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__cell__V) / (1 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__cell__V)); // per_millisecond
        ...
        const double var_Itof_X_gate__X_tof_infinity = 1 / (1 + exp(-0.20000000000000001 - 0.066666666666666666 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_Itof_Y_gate__Y_tof_infinity = 1 / (1 + exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V)); // dimensionless
        const double var_Itof_Y_gate__tau_Y_tof = 20 + 20 / (1 + exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V)); // millisecond
        ...
        const double var_Itos_R_gate__R_tos_infinity = 1 / (1 + exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V)); // dimensionless
        const double var_Itos_R_gate__tau_R_tos = 220 + 2800 / (1 + exp(6 + 0.10000000000000001 * var_chaste_interface__cell__V)); // millisecond
        ...
        const double var_Itos_X_gate__X_tos_infinity = 1 / (1 + exp(-0.20000000000000001 - 0.066666666666666666 * var_chaste_interface__cell__V)); // dimensionless
        const double var_Itos_X_gate__tau_X_tos = 0.5 + 9 / (1 + exp(0.20000000000000001 + 0.066666666666666666 * var_chaste_interface__cell__V)); // millisecond
        ...
        const double var_Itos_Y_gate__Y_tos_infinity = 1 / (1 + exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V)); // dimensionless
        const double var_Itos_Y_gate__tau_Y_tos = 30 + 3000 / (1 + exp(6 + 0.10000000000000001 * var_chaste_interface__cell__V)); // millisecond
        ...
        const double var_cytosolic_Ca_buffer__kon_Calmodulin = 34; // per_millimolar_per_millisecond
        ...
        const double var_cytosolic_Ca_buffer__kon_SRB = 100; // per_millimolar_per_millisecond
        ...
        const double var_indo_fluo_Ca_buffer_not_connected__kon_Fluo3 = 100; // per_millimolar2_per_millisecond
        const double var_indo_fluo_Ca_buffer_not_connected__kon_Indo1 = 100; // per_millimolar2_per_millisecond
        ...
        const double var_model_parameters__Mgi = 1; // millimolar
        ...
        const double var_INaK__i_NaK_SL = var_INaK__Fx_NaK_SL * var_INaK__I_NaK_max * var_INaK__Q_NaK * var_INaK__f_NaK * NV_Ith_S(mParameters, 8) / ((1 + pow((var_INaK__Km_Nai * var_INaK__Q_Km_Nai / var_chaste_interface__Na_buffer__Na_SL), var_INaK__H_NaK)) * (var_INaK__Km_Ko + NV_Ith_S(mParameters, 8))); // microA_per_microF
        const double var_INaK__i_NaK_jct = var_INaK__Fx_NaK_jct * var_INaK__I_NaK_max * var_INaK__Q_NaK * var_INaK__f_NaK * NV_Ith_S(mParameters, 8) / ((1 + pow((var_INaK__Km_Nai * var_INaK__Q_Km_Nai / var_chaste_interface__Na_buffer__Na_jct), var_INaK__H_NaK)) * (var_INaK__Km_Ko + NV_Ith_S(mParameters, 8))); // microA_per_microF
        const double var_Jpump_SR__Q_SRCaP = pow(var_Jpump_SR__Q10_SRCaP, (-31 + 0.10000000000000001 * NV_Ith_S(mParameters, 23))); // dimensionless
        ...
        const double d_dt_chaste_interface_var_Ca_buffer__Cai = -1 * var_cytosolic_Ca_buffer__dCa_cytosol_tot_bound + var_ion_diffusion__J_Ca_SL_cytosol / var_model_parameters__Vol_cytosol - var_Jpump_SR__j_pump_SR * var_model_parameters__Vol_SR / var_model_parameters__Vol_cytosol; // millimolar / millisecond
        ...
        const double var_reversal_potentials__E_Ca_SL = 0.5 * NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 23) * log(NV_Ith_S(mParameters, 6) / var_chaste_interface__Ca_buffer__Ca_SL) / NV_Ith_S(mParameters, 10); // millivolt
        const double var_ICab__i_Cab_SL = (-var_reversal_potentials__E_Ca_SL + var_chaste_interface__cell__V) * var_ICab__Fx_CaBk_SL * var_ICab__G_CaBk; // microA_per_microF
        const double var_Ca_buffer__i_Ca_SL_tot = -2 * var_INaCa__i_NaCa_SL + var_ICaL__i_CaL_Ca_SL + var_ICab__i_Cab_SL + var_ICap__i_Cap_SL; // microA_per_microF
        ...
        const double var_reversal_potentials__E_Ca_jct = 0.5 * NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 23) * log(NV_Ith_S(mParameters, 6) / var_chaste_interface__Ca_buffer__Ca_jct) / NV_Ith_S(mParameters, 10); // millivolt
        const double var_ICab__i_Cab_jct = (-var_reversal_potentials__E_Ca_jct + var_chaste_interface__cell__V) * var_ICab__Fx_CaBk_jct * var_ICab__G_CaBk; // microA_per_microF
        const double var_Ca_buffer__i_Ca_jct_tot = -2 * var_INaCa__i_NaCa_jct + var_ICaL__i_CaL_Ca_jct + var_ICab__i_Cab_jct + var_ICap__i_Cap_jct; // microA_per_microF
        const double d_dt_chaste_interface_var_Ca_buffer__Ca_jct = -1 * var_Ca_buffer__dCa_jct_tot_bound - var_ion_diffusion__J_Ca_jct_SL / var_model_parameters__Vol_jct + var_Jleak_SR__j_leak_SR * var_model_parameters__Vol_cytosol / var_model_parameters__Vol_jct + var_Jrel_SR__j_rel_SR * var_model_parameters__Vol_SR / var_model_parameters__Vol_jct - 0.5 * var_Ca_buffer__i_Ca_jct_tot * var_model_parameters__Cm / (NV_Ith_S(mParameters, 10) * var_model_parameters__Vol_jct); // millimolar / millisecond
        const double var_reversal_potentials__E_Na_SL = NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 23) * log(NV_Ith_S(mParameters, 9) / var_chaste_interface__Na_buffer__Na_SL) / NV_Ith_S(mParameters, 10); // millivolt
        const double var_INa__i_Na_SL = (-var_reversal_potentials__E_Na_SL + var_chaste_interface__cell__V) * var_INa__Fx_Na_SL * NV_Ith_S(mParameters, 14) * var_INa__openProb; // microA_per_microF
        const double var_INab__i_Nab_SL = (-var_reversal_potentials__E_Na_SL + var_chaste_interface__cell__V) * var_INab__Fx_NaBk_SL * var_INab__G_NaBk; // microA_per_microF
    ...
    void Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -85.721630473733
        double var_chaste_interface__Ca_buffer__Cai = NV_Ith_S(rY, 1);
        ...
        const double var_x1 = 1 + 0.10000000000000001 * var_x0;
        const double var_x2 = 1 / var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x3 = 1 + 0.10000000000000001 * var_x2;
        const double var_x4 = (0.5 * var_chaste_interface__Itos_R_gate__R_tos + var_chaste_interface__Itos_Y_gate__Y_tos) * NV_Ith_S(mParameters, 21);
        const double var_x5 = NV_Ith_S(mParameters, 17) * var_chaste_interface__Itof_Y_gate__Y_tof;
        ...
        const double var_x8 = 0.057000000000000002 + 0.19 / var_x7;
        const double var_x9 = pow(var_chaste_interface__IKs_Xs_gate__Xs, 2) * NV_Ith_S(mParameters, 20);
        const double var_x10 = var_x8 * var_x9;
        const double var_x11 = exp(-7.0000000000000009 - 1.6666666666666667 * log10(1 * var_chaste_interface__Ca_buffer__Ca_SL));
        const double var_x12 = 1 + var_x11;
        const double var_x13 = 0.057000000000000002 + 0.19 / var_x12;
        const double var_x14 = var_x13 * var_x9;
        const double var_x15 = sqrt(NV_Ith_S(mParameters, 8));
        const double var_x16 = exp(1.4732142857142858 + 0.044642857142857144 * var_chaste_interface__cell__V);
        const double var_x17 = 1 + var_x16;
        const double var_x18 = 0.43033148291193518 / var_x17;
        const double var_x19 = pow(var_chaste_interface__INa_m_gate__m, 3);
        const double var_x20 = var_x19 * NV_Ith_S(mParameters, 14) * var_chaste_interface__INa_j_gate__j;
        const double var_x21 = var_x20 * var_chaste_interface__INa_h_gate__h;
        const double var_x22 = log(NV_Ith_S(mParameters, 8) / NV_Ith_S(mParameters, 5));
        const double var_x23 = 1 / NV_Ith_S(mParameters, 10);
        const double var_x24 = var_x23 * NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 23);
        const double var_x25 = var_x22 * var_x24;
        const double var_x26 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__V - 0.23849999999999999 * var_x25);
        const double var_x27 = 1 + var_x26;
        const double var_x28 = 1 / var_x27;
        const double var_x29 = exp(-2.4444678999999998 - 0.51429999999999998 * var_chaste_interface__cell__V + 0.51429999999999998 * var_x22 * var_x23 * NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 23));
        const double var_x30 = 1 + var_x29;
        const double var_x31 = 1 / var_x30;
        const double var_x32 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 0.061749999999999999 * var_x25);
        const double var_x33 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 0.080320000000000003 * var_x25);
        const double var_x34 = 1 * var_x32 + 0.49124000000000001 * var_x33;
        const double var_x35 = var_x31 * var_x34;
        const double var_x36 = 1 / (var_x35 + 1.02 * var_x28);
        const double var_x37 = 1 / (NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 23));
        const double var_x38 = var_x37 * NV_Ith_S(mParameters, 10);
        const double var_x39 = exp(0.34999999999999998 * var_x38 * var_chaste_interface__cell__V);
        const double var_x40 = pow(var_chaste_interface__Na_buffer__Na_jct, 3);
        const double var_x41 = var_x40 * NV_Ith_S(mParameters, 6);
        const double var_x42 = var_x39 * var_x41;
        const double var_x43 = 0.34999999999999998 * var_x38;
        const double var_x44 = var_x38 * var_chaste_interface__cell__V;
        const double var_x45 = exp(-0.65000000000000002 * var_x44);
        const double var_x46 = pow(NV_Ith_S(mParameters, 9), 3);
        const double var_x47 = var_x46 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x48 = var_x45 * var_x47;
        const double var_x49 = 0.65000000000000002 * var_x38;
        const double var_x50 = (1 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_jct) * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x51 = 1 + 0.00053869674493876331 * var_x40;
        const double var_x52 = 0.0035899999999999999 * var_x46;
        const double var_x53 = 1 / (var_x41 + var_x47 + 669921.875 * var_x50 + 1.3 * var_x40 + var_x51 * var_x52);
        const double var_x54 = 1 + 1.6777215999999998e-11 / pow(var_chaste_interface__Ca_buffer__Ca_jct, 3);
        const double var_x55 = 1 / var_x54;
        const double var_x56 = 1 + 0.27000000000000002 * var_x45;
        const double var_x57 = 1 / var_x56;
        const double var_x58 = -31 + 0.10000000000000001 * NV_Ith_S(mParameters, 23);
        const double var_x59 = pow(1.5700000000000001, var_x58);
        const double var_x60 = var_x59 * NV_Ith_S(mParameters, 22);
        const double var_x61 = var_x57 * var_x60;
        const double var_x62 = var_x55 * var_x61;
        const double var_x63 = var_x53 * var_x62;
        const double var_x64 = var_x63 * (var_x42 * var_x43 + var_x48 * var_x49);
        const double var_x65 = pow(var_chaste_interface__Na_buffer__Na_SL, 3);
        const double var_x66 = var_x65 * NV_Ith_S(mParameters, 6);
        const double var_x67 = var_x39 * var_x66;
        const double var_x68 = var_x46 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x69 = var_x45 * var_x68;
        const double var_x70 = (1 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_SL) * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x71 = 1 + 0.00053869674493876331 * var_x65;
        const double var_x72 = 1 / (var_x66 + var_x68 + 669921.875 * var_x70 + 1.3 * var_x65 + var_x52 * var_x71);
        const double var_x73 = 1 + 1.6777215999999998e-11 / pow(var_chaste_interface__Ca_buffer__Ca_SL, 3);
        const double var_x74 = 1 / var_x73;
        const double var_x75 = var_x61 * var_x74;
        const double var_x76 = var_x72 * var_x75;
        const double var_x77 = var_x76 * (var_x43 * var_x67 + var_x49 * var_x69);
        const double var_x78 = pow(var_x27, (-2));
        const double var_x79 = -var_x25 + var_chaste_interface__cell__V;
        const double var_x80 = var_x15 * var_x79;
        const double var_x81 = pow(1.49, (-124 + 0.40000000000000002 * NV_Ith_S(mParameters, 23)));
        const double var_x82 = 1 / var_chaste_interface__Na_buffer__Na_jct;
        const double var_x83 = var_x81 * pow(var_x82, 4);
        const double var_x84 = 0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x85 = exp(-var_x38 * var_x84);
        const double var_x86 = 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * NV_Ith_S(mParameters, 9))) * exp(-var_x44);
        const double var_x87 = 1 + var_x86 + 0.1245 * var_x85;
        const double var_x88 = pow(1.6299999999999999, var_x58) * NV_Ith_S(mParameters, 8) / (1.5 + NV_Ith_S(mParameters, 8));
        const double var_x89 = var_x88 * (var_x38 * var_x86 + 0.012450000000000001 * var_x38 * var_x85) / pow(var_x87, 2);
        const double var_x90 = var_x89 / (1 + 14641 * var_x83);
        const double var_x91 = 1 / var_chaste_interface__Na_buffer__Na_SL;
        const double var_x92 = var_x81 * pow(var_x91, 4);
        const double var_x93 = var_x89 / (1 + 14641 * var_x92);
        const double var_x94 = exp(var_x44);
        const double var_x95 = 0.75 * var_x94;
        const double var_x96 = -0.75 * NV_Ith_S(mParameters, 8) + var_x95 * NV_Ith_S(mParameters, 5);
        const double var_x97 = var_x37 * pow(NV_Ith_S(mParameters, 10), 2);
        const double var_x98 = -1 + var_x94;
        const double var_x99 = 1 / var_x98;
        const double var_x100 = pow(1.8, var_x58);
        const double var_x101 = var_x100 * var_chaste_interface__ICaL_f_gate__f;
        ...
        const double var_x106 = 1 - 0.10000000000000001 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL - 0.90000000000000002 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        const double var_x107 = 1.215e-7 * var_x106;
        const double var_x108 = var_x67 - var_x69;
        const double var_x109 = var_x108 * var_x72;
        const double var_x110 = var_x38 * var_x45 * var_x60 / pow(var_x56, 2);
        const double var_x111 = var_x109 * var_x110 * var_x74;
        const double var_x112 = var_x42 - var_x48;
        const double var_x113 = var_x112 * var_x53;
        const double var_x114 = var_x110 * var_x113 * var_x55;
        const double var_x115 = 1 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL;
        const double var_x116 = exp(2 * var_x44);
        const double var_x117 = -1 + var_x116;
        const double var_x118 = NV_Ith_S(mParameters, 12) / var_x117;
        const double var_x119 = var_x102 * var_x118;
        const double var_x120 = var_x115 * var_x119;
        const double var_x121 = -0.34100000000000003 * NV_Ith_S(mParameters, 6);
        const double var_x122 = 0.34100000000000003 * var_x116;
        const double var_x123 = var_x121 + var_x122 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x124 = 0.18000000000000002 * var_x123;
        const double var_x125 = var_x120 * var_x124 * var_x97;
        const double var_x126 = 1 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        const double var_x127 = var_x126 * var_x97;
        const double var_x128 = var_x119 * var_x127;
        const double var_x129 = var_x121 + var_x122 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x130 = 1.6200000000000001 * var_x129;
        const double var_x131 = var_x128 * var_x130;
        const double var_x132 = var_x103 * var_x94;
        const double var_x133 = pow(NV_Ith_S(mParameters, 10), 3);
        const double var_x134 = pow(NV_Ith_S(mParameters, 11), (-2));
        const double var_x135 = pow(NV_Ith_S(mParameters, 23), (-2));
        const double var_x136 = var_x133 * var_x134 * var_x135 * var_chaste_interface__cell__V;
        const double var_x137 = pow(var_x98, (-2));
        const double var_x138 = var_x126 * var_x136;
        const double var_x139 = 1.10484 * var_x116 * var_x119 * var_x138 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x140 = var_x116 * var_x120;
        const double var_x141 = 0.12276000000000002 * var_x136 * var_x140 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x142 = var_x102 * var_x136;
        const double var_x143 = var_x116 * var_x142 * NV_Ith_S(mParameters, 12) / pow(var_x117, 2);
        const double var_x144 = 0.36000000000000004 * var_x115 * var_x123 * var_x143;
        const double var_x145 = var_x126 * var_x129;
        const double var_x146 = 3.2400000000000002 * var_x143 * var_x145;
        const double var_x147 = -0.75 * NV_Ith_S(mParameters, 9);
        const double var_x148 = var_x147 + var_x95 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x149 = var_x115 * var_x148;
        const double var_x150 = 6.7499999999999994e-10 * var_x149;
        const double var_x151 = 5.0624999999999998e-10 * var_x115 * var_x94;
        const double var_x152 = var_x137 * var_x142 * var_x94;
        const double var_x153 = var_x104 * var_x150 - var_x150 * var_x152 + var_x103 * var_x136 * var_x151 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x154 = var_x147 + var_x95 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x155 = var_x103 * var_x154;
        const double var_x156 = 6.0749999999999998e-9 * var_x127;
        const double var_x157 = 4.5562499999999999e-9 * var_x132;
        const double var_x158 = var_x126 * var_x154;
        const double var_x159 = var_x155 * var_x156 - 6.0749999999999998e-9 * var_x152 * var_x158 + var_x138 * var_x157 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x160 = -var_x24 * log(var_x82 * NV_Ith_S(mParameters, 9)) + var_chaste_interface__cell__V;
        const double var_x161 = 0.11 * var_x160;
        const double var_x162 = -var_x24 * log(var_x91 * NV_Ith_S(mParameters, 9)) + var_chaste_interface__cell__V;
        const double var_x163 = 0.89000000000000001 * var_x162;
        const double var_x164 = NV_Ith_S(mParameters, 14) * var_chaste_interface__INa_h_gate__h;
        const double var_x165 = var_x164 * var_x19;
        const double var_x166 = var_x164 * pow(var_chaste_interface__INa_m_gate__m, 2) * var_chaste_interface__INa_j_gate__j;
        const double var_x167 = var_x160 * var_x166;
        const double var_x168 = var_x162 * var_x166;
        const double var_x169 = 1 / (0.018329999999999999 * var_chaste_interface__Na_buffer__Nai + NV_Ith_S(mParameters, 5));
        const double var_x170 = -var_x24 * log(var_x169 * (0.018329999999999999 * NV_Ith_S(mParameters, 9) + NV_Ith_S(mParameters, 8))) + var_chaste_interface__cell__V;
        const double var_x171 = var_x170 * NV_Ith_S(mParameters, 20) * var_chaste_interface__IKs_Xs_gate__Xs;
        const double var_x172 = var_x79 * NV_Ith_S(mParameters, 21) * var_chaste_interface__Itos_X_gate__X_tos;
        const double var_x173 = var_x99 * var_chaste_interface__cell__V;
        const double var_x174 = var_x101 * var_x173;
        const double var_x175 = var_x154 * var_x156;
        const double var_x176 = var_x174 * var_x97;
        const double var_x177 = var_x107 * var_x96;
        const double var_x178 = var_x97 * var_chaste_interface__cell__V;
        const double var_x179 = var_x124 * var_x178;
        const double var_x180 = var_x101 * var_x118;
        const double var_x181 = var_x115 * var_x180;
        const double var_x182 = var_x127 * var_chaste_interface__cell__V;
        const double var_x183 = var_x130 * var_x182;
        const double var_x184 = var_x100 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x185 = var_x173 * var_x184;
        const double var_x186 = var_x185 * var_x97;
        const double var_x187 = var_x118 * var_x184;
        const double var_x188 = var_x115 * var_x187;
        const double var_x189 = var_x104 * var_chaste_interface__cell__V;
        const double var_x190 = var_x105 * var_chaste_interface__cell__V;
        const double var_x191 = pow(var_chaste_interface__Na_buffer__Na_SL, 2);
        const double var_x192 = 3 * NV_Ith_S(mParameters, 6);
        const double var_x193 = 5.8017639429904805e-6 * var_x46;
        const double var_x194 = -3.9000000000000004 * var_x191 - var_x191 * var_x192 - var_x191 * var_x193;
        const double var_x195 = 5.3588338192419823e-9 * var_x46;
        const double var_x196 = var_x108 * var_x75 / pow((var_x70 + 1.9405247813411081e-6 * var_x65 + 1.4927113702623908e-6 * var_x66 + 1.4927113702623908e-6 * var_x68 + var_x195 * var_x71), 2);
        const double var_x197 = 1.9830866390704556e-12 * var_x196;
        const double var_x198 = var_x39 * NV_Ith_S(mParameters, 6);
        const double var_x199 = var_x191 * var_x198 * var_x76;
        const double var_x200 = var_x88 / var_x87;
        const double var_x201 = var_x200 * var_x91 * var_x92 / pow((6.8301345536507063e-5 + var_x92), 2);
        const double var_x202 = var_x24 * var_x91;
        const double var_x203 = 0.89000000000000001 * var_x21;
        const double var_x204 = 0.00026433000000000001 * var_x202 + var_x151 * var_x189 + var_x202 * var_x203;
        const double var_x205 = pow(var_chaste_interface__Na_buffer__Na_jct, 2);
        const double var_x206 = -3.9000000000000004 * var_x205 - var_x192 * var_x205 - var_x193 * var_x205;
        const double var_x207 = var_x112 * var_x62 / pow((var_x50 + 1.9405247813411081e-6 * var_x40 + 1.4927113702623908e-6 * var_x41 + 1.4927113702623908e-6 * var_x47 + var_x195 * var_x51), 2);
        const double var_x208 = 2.4510059584016866e-13 * var_x207;
        const double var_x209 = var_x198 * var_x205 * var_x63;
        const double var_x210 = var_x200 * var_x82 * var_x83 / pow((6.8301345536507063e-5 + var_x83), 2);
        const double var_x211 = var_x24 * var_x82;
        const double var_x212 = 0.11 * var_x21;
        const double var_x213 = 3.2670000000000004e-5 * var_x211 + var_x157 * var_x182 + var_x211 * var_x212;
        const double var_x214 = var_x169 * var_x24;
        const double var_x215 = var_x24 * log(NV_Ith_S(mParameters, 7) / NV_Ith_S(mParameters, 4)) + var_chaste_interface__cell__V;
        const double var_x216 = var_x170 * var_x9 / log(10);
        const double var_x217 = var_x109 * var_x61 / (pow(var_x73, 2) * pow(var_chaste_interface__Ca_buffer__Ca_SL, 4));
        const double var_x218 = 669921.875 + var_x46;
        const double var_x219 = -var_x218 - 373215529.24791086 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x220 = pow(2.3500000000000001, var_x58);
        const double var_x221 = pow(var_x2, 1.6000000000000001);
        const double var_x222 = 0.00011182849999999999 * var_x2 * var_x24 + 0.061380000000000011 * var_x140 * var_x178 + 5.0104537825247566e-7 * var_x2 * var_x220 * var_x221 / pow((1 + 5.2281977629563632e-6 * var_x221), 2);
        const double var_x223 = pow(var_chaste_interface__Ca_buffer__Ca_jct, 2);
        const double var_x224 = -var_x218 - 373215529.24791086 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x225 = var_x113 * var_x61 / (pow(var_x54, 2) * pow(var_chaste_interface__Ca_buffer__Ca_jct, 4));
        const double var_x226 = pow(var_x0, 1.6000000000000001);
        const double var_x227 = 1.38215e-5 * var_x0 * var_x24 + 0.55242000000000002 * var_x116 * var_x128 * var_chaste_interface__cell__V + 6.1926956862665531e-8 * var_x0 * var_x220 * var_x226 / pow((1 + 5.2281977629563632e-6 * var_x226), 2);
        const double var_x228 = 32.700000000000003 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC;
        const double var_x229 = 34 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Calmodulin;
        const double var_x230 = 100 * var_chaste_interface__cytosolic_Ca_buffer__Ca_SRB;
        const double var_x231 = pow(var_chaste_interface__Ca_buffer__Cai, 0.78699999999999992);
        const double var_x232 = pow(var_chaste_interface__Ca_buffer__Ca_SR, 1.7869999999999999);
        const double var_x233 = 0.38742512113256738 * var_x232;
        const double var_x234 = pow(var_chaste_interface__Ca_buffer__Cai, 1.7869999999999999);
        const double var_x235 = 1 / (1 + var_x233 + 2814485.1633595936 * var_x234);
        const double var_x236 = pow(2.6000000000000001, var_x58);
        const double var_x237 = var_x236 * NV_Ith_S(mParameters, 2);
        const double var_x238 = var_x235 * var_x237;
        const double var_x239 = var_x237 * (-var_x233 + 2814485.1633595936 * var_x234) / pow((3.5530476870814998e-7 + var_x234 + 1.3765399305573384e-7 * var_x232), 2);
        const double var_x240 = var_x231 * var_x239;
        const double var_x241 = 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC_Ca_Mg + 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_TroponinC_Ca_Mg;
        const double var_x242 = 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Myosin + 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_Myosin;
        const double var_x243 = pow(var_chaste_interface__Ca_buffer__Ca_SR, 0.78699999999999992);
        const double var_x244 = var_x238 * var_x243;
        const double var_x245 = var_x239 * var_x243;
        const double var_x246 = 0.019599999999999999 + 32.700000000000003 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x247 = 2.3700000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x248 = 0.23799999999999999 + 34 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x249 = 13.800000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x250 = 100 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x251 = 0.059999999999999998 + var_x250;
        const double var_x252 = exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 16) - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x253 = var_chaste_interface__cell__V < -40;
        const double var_x254 = ((var_x253) ? (0.13500000000000001 * var_x252) : (0));
        const double var_x255 = exp(0.34999999999999998 * var_chaste_interface__cell__V - 0.34999999999999998 * NV_Ith_S(mParameters, 16));
        const double var_x256 = exp(0.079000000000000001 * var_chaste_interface__cell__V - 0.079000000000000001 * NV_Ith_S(mParameters, 16));
        const double var_x257 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 16) - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x258 = 1 + var_x257;
        const double var_x259 = ((var_x253) ? (310000 * var_x255 + 3.5600000000000001 * var_x256) : (7.6923076923076916 / var_x258));
        const double var_x260 = 1 * var_x254 + 1 * var_x259;
        const double var_x261 = ((var_x253) ? (-0.019852941176470591 * var_x252) : (0));
        const double var_x262 = var_x254 + var_x259;
        const double var_x263 = 0.01 * NV_Ith_S(mParameters, 15);
        const double var_x264 = 1 - var_x263;
        const double var_x265 = var_x264 / var_x262;
        const double var_x266 = ((var_x253) ? (0.28123999999999999 * var_x256 + 108500 * var_x255) : (0.693000693000693 * var_x257 / pow(var_x258, 2)));
        const double var_x267 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 16) - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x268 = 1 + var_x267;
        const double var_x269 = exp(0.01052 * NV_Ith_S(mParameters, 16) - 0.01052 * var_chaste_interface__cell__V);
        const double var_x270 = var_x269 / var_x268;
        const double var_x271 = exp(-3.2000000000000002 - var_x84 + 0.10000000000000001 * NV_Ith_S(mParameters, 16));
        const double var_x272 = 1 + var_x271;
        const double var_x273 = exp(2.5349999999999999e-7 * NV_Ith_S(mParameters, 16) - 2.5349999999999999e-7 * var_chaste_interface__cell__V);
        const double var_x274 = var_x273 / var_x272;
        const double var_x275 = ((var_x253) ? (0.1212 * var_x270) : (0.29999999999999999 * var_x274));
        const double var_x276 = 37.780000000000001 + var_chaste_interface__cell__V;
        const double var_x277 = exp(0.24440000000000001 * var_chaste_interface__cell__V - 0.24440000000000001 * NV_Ith_S(mParameters, 16));
        const double var_x278 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 16) - 0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x279 = -127140 * var_x277 - 3.4740000000000003e-5 * var_x278;
        const double var_x280 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V - 0.311 * NV_Ith_S(mParameters, 16));
        const double var_x281 = 1 + var_x280;
        const double var_x282 = 1 / var_x281;
        const double var_x283 = var_x279 * var_x282;
        const double var_x284 = ((var_x253) ? (var_x276 * var_x283) : (0));
        const double var_x285 = 1 * var_x275 + 1 * var_x284;
        const double var_x286 = ((var_x253) ? (var_x283 + var_x276 * var_x282 * (1.5254334000000001e-6 * var_x278 - 31073.016 * var_x277) - 0.311 * var_x276 * var_x279 * var_x280 / pow(var_x281, 2)) : (0));
        const double var_x287 = var_x275 + var_x284;
        const double var_x288 = var_x264 / var_x287;
        const double var_x289 = ((var_x253) ? (-0.001275024 * var_x270 + 0.016701360000000002 * var_x267 * var_x269 / pow(var_x268, 2)) : (-7.6049999999999996e-8 * var_x274 + 0.029999999999999999 * var_x271 * var_x273 / pow(var_x272, 2)));
        const double var_x290 = exp(-4.7130000000000001 - var_x84);
        const double var_x291 = 1 - var_x290;
        const double var_x292 = 1 / var_x291;
        const double var_x293 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x294 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x295 = 0.32000000000000001 * var_x292;
        const double var_x296 = 0.080000000000000002 * var_x293 + var_x294 * var_x295;
        const double var_x297 = 1 / var_x296;
        const double var_x298 = 0.032000000000000001 * var_x290 * var_x294 / pow(var_x291, 2);
        const double var_x299 = var_x298 + 0.0072727272727272727 * var_x293 - 0.32000000000000001 * var_x292;
        const double var_x300 = var_x292 * var_x294;
        const double var_x301 = exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x302 = 1 + var_x301;
        const double var_x303 = exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V);
        const double var_x304 = -1 + var_x303;
        const double var_x305 = 1 / var_x304;
        const double var_x306 = exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V);
        const double var_x307 = 1 - var_x306;
        const double var_x308 = 1 / var_x307;
        const double var_x309 = 7 + var_chaste_interface__cell__V;
        const double var_x310 = 10 + var_chaste_interface__cell__V;
        const double var_x311 = 0.00060999999999999997 * var_x305 * var_x310 + 0.0013799999999999999 * var_x308 * var_x309;
        ...
        const double var_x314 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V);
        const double var_x315 = -1 + var_x314;
        const double var_x316 = 1 / var_x315;
        const double var_x317 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V);
        const double var_x318 = 1 - var_x317;
        const double var_x319 = 1 / var_x318;
        const double var_x320 = 30 + var_chaste_interface__cell__V;
        const double var_x321 = 0.00013100000000000001 * var_x316 * var_x320 + 7.1899999999999999e-5 * var_x319 * var_x320;
        const double var_x322 = 0.20000000000000001 + 0.066666666666666666 * var_chaste_interface__cell__V;
        const double var_x323 = exp(var_x322);
        const double var_x324 = 1 + var_x323;
        const double var_x325 = 1 / var_x324;
        const double var_x326 = 1 / (0.5 + 9 * var_x325);
        const double var_x327 = exp(-var_x322);
        const double var_x328 = 1 + var_x327;
        const double var_x329 = 0.066666666666666666 * var_x327 / pow(var_x328, 2);
        const double var_x330 = -1 / var_x328;
        const double var_x331 = 0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x332 = exp(6 + var_x331);
        const double var_x333 = 1 + var_x332;
        const double var_x334 = 1 / var_x333;
        const double var_x335 = 1 / (30 + 3000 * var_x334);
        const double var_x336 = exp(3.3500000000000001 + var_x331);
        const double var_x337 = 1 + var_x336;
        const double var_x338 = pow(var_x337, (-2));
        const double var_x339 = 0.10000000000000001 * var_x336 * var_x338;
        const double var_x340 = pow(var_x333, (-2));
        const double var_x341 = 1 / var_x337;
        const double var_x342 = -1 * var_x341;
        const double var_x343 = 1 / (220 + 2800 * var_x334);
        const double var_x344 = exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2));
        const double var_x345 = 1 / (1.5 + 3.5 * var_x344);
        const double var_x346 = 1 / (20 + 20 * var_x341);
        const double var_x347 = exp(-2.4166666666666665 - 0.16666666666666666 * var_chaste_interface__cell__V);
        const double var_x348 = 1 - var_x347;
        const double var_x349 = 1 / var_x348;
        const double var_x350 = 1 + var_x347;
        const double var_x351 = 1 / var_x350;
        const double var_x352 = -var_chaste_interface__ICaL_d_gate__d + 1 * var_x351;
        const double var_x353 = 14.5 + var_chaste_interface__cell__V;
        const double var_x354 = 0.0058333333333333336 * var_x347 * var_x353;
        const double var_x355 = 0.019699999999999999 * exp(-0.23877882250000002 * pow((1 + 0.068965517241379309 * var_chaste_interface__cell__V), 2));
        const double var_x356 = 0.02 + var_x355;
        const double var_x357 = exp(9.7388888888888889 + 0.27777777777777779 * var_chaste_interface__cell__V);
        const double var_x358 = 1 + var_x357;
        const double var_x359 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x360 = 1 + var_x359;
        const double var_x361 = 1 / var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x362 = pow(var_x361, 2.5);
        const double var_x363 = 1 + 0.13584112963311223 * var_x362;
        const double var_x364 = 1 / var_x363;
        const double var_x365 = 7.5 - 7 * var_x364;
        const double var_x366 = var_x365 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x367 = 1 / (15 - 14 * var_x364);
        const double var_x368 = 10 * var_x223 * var_x367;
        const double var_x369 = pow(var_x363, (-2));
        const double var_x370 = var_x361 * var_x362 * var_x369;
        const double var_x371 = 0.21130842387373014 * var_x223 * var_x370 / pow((1 - 0.93333333333333335 * var_x364), 2);
        const double var_x372 = var_x371 * var_chaste_interface__Jrel_SR__R;
        const double var_x373 = 20 * var_x367;
        const double var_x374 = var_x373 * var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__R;
        const double var_x375 = 2.3772197685794643 * var_x370 * var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__O;
        const double var_x376 = 1 - var_chaste_interface__Jrel_SR__I - var_chaste_interface__Jrel_SR__O - var_chaste_interface__Jrel_SR__R;
        const double var_x377 = var_x365 * var_chaste_interface__Jrel_SR__O;
        const double var_x378 = M_PI * var_x23;
        const double var_x379 = 62.109246076532294 * var_x378;
        const double var_x380 = var_x379 * NV_Ith_S(mParameters, 3);
        const double var_x381 = var_x378 * NV_Ith_S(mParameters, 3);
        const double var_x382 = var_x20 * var_x381;
        const double var_x383 = 55.277229008113743 * var_x162;
        const double var_x384 = var_x165 * var_x381;
        const double var_x385 = var_x101 * var_x99;
        const double var_x386 = M_PI * var_x44;
        const double var_x387 = var_x386 * NV_Ith_S(mParameters, 3);
        const double var_x388 = 4.1923741101659298e-8 * var_x387;
        const double var_x389 = var_x149 * var_x388;
        const double var_x390 = var_x184 * var_x99;
        const double var_x391 = 0.0001 * var_chaste_interface__Na_buffer__Na_SL_buf;
        const double var_x392 = 5.9492599172113663e-12 * var_x196;
        const double var_x393 = 0.001 + 0.0001 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x394 = var_x45 * var_x46;
        const double var_x395 = var_x394 * var_x76;
        const double var_x396 = 2435.6567088836191 * var_x378;
        const double var_x397 = var_x396 * NV_Ith_S(mParameters, 3);
        const double var_x398 = 267.92223797719811 * var_x160;
        const double var_x399 = 1.4796614506467986e-5 * var_x387;
        const double var_x400 = var_x158 * var_x399;
        const double var_x401 = 0.0001 * var_chaste_interface__Na_buffer__Na_jct_buf;
        const double var_x402 = 7.3530178752050587e-13 * var_x207;
        const double var_x403 = 0.001 + 0.0001 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x404 = var_x394 * var_x63;
        const double var_x405 = 0.076376893524206985 * NV_Ith_S(mParameters, 3);
        const double var_x406 = (-var_chaste_interface__Ca_buffer__Ca_jct + var_chaste_interface__Ca_buffer__Ca_SR) * NV_Ith_S(mParameters, 1);
        const double var_x407 = 100 * var_chaste_interface__Ca_buffer__Ca_Calsequestrin;
        const double var_x408 = var_chaste_interface__Jrel_SR__O * NV_Ith_S(mParameters, 1);
        const double var_x409 = var_x408 + 18.571428571428569 * NV_Ith_S(mParameters, 0);
        const double var_x410 = 65 + 100 * var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x411 = 31.054623038266147 * var_x378;
        const double var_x412 = 5.5898321468879066 * var_x123 * var_x386;
        const double var_x413 = 3.9661732781409111e-12 * var_x196;
        const double var_x414 = 100 * var_chaste_interface__Ca_buffer__Ca_SLB_SL;
        const double var_x415 = 100 * var_chaste_interface__Ca_buffer__Ca_SLHigh_SL;
        const double var_x416 = 100 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x417 = 1.3 + var_x416;
        const double var_x418 = 0.029999999999999999 + var_x416;
        const double var_x419 = 1217.8283544418096 * var_x378;
        const double var_x420 = 1972.8819341957317 * var_x386;
        const double var_x421 = var_x145 * var_x420;
        const double var_x422 = 4.9020119168033731e-13 * var_x207;
        const double var_x423 = 68.627450980392155 * var_x408 + 1274.5098039215686 * NV_Ith_S(mParameters, 0);
        const double var_x424 = 100 * var_chaste_interface__Ca_buffer__Ca_SLB_jct;
        const double var_x425 = 100 * var_chaste_interface__Ca_buffer__Ca_SLHigh_jct;
        const double var_x426 = 100 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x427 = 1.3 + var_x426;
        const double var_x428 = 0.029999999999999999 + var_x426;
        const double var_x429 = 0.025000000000000001 - var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_Cytosol;
        const double var_x430 = -var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_Cytosol - 0.030769230769230767 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL - 0.00078461538461538469 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x431 = 100 * var_x430;
        const double var_x432 = var_x429 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x433 = 0.025024999999999999 - var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL;
        const double var_x434 = var_x433 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x435 = 0.025490196078431372 - var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x436 = var_x435 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x437 = 0.025000000000000001 - var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol;
        const double var_x438 = -var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol - 0.030769230769230767 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL - 0.00078461538461538469 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        const double var_x439 = 100 * var_x438;
        const double var_x440 = var_x437 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x441 = 0.025024999999999999 - var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL;
        const double var_x442 = var_x441 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x443 = 0.025490196078431372 - var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        const double var_x444 = var_x443 * var_chaste_interface__Ca_buffer__Ca_jct;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00054830000000000005 + var_x144 + var_x146 - var_x125 - var_x131 - var_x139 - var_x141 - var_x153 - var_x159 - NV_Ith_S(mParameters, 13) - 0.11 * var_x10 - 0.11 * var_x64 - 0.89000000000000001 * var_x14 - 0.89000000000000001 * var_x77 - 0.15619500000000003 * var_x111 - 1 * var_x21 - 0.01205875 / var_x1 - 0.019305000000000003 * var_x114 - 0.097566250000000007 / var_x3 - 0.21009999999999998 * var_x90 - 1.6999 * var_x93 - var_x105 * var_x107 - var_x4 * var_chaste_interface__Itos_X_gate__X_tos - var_x5 * var_chaste_interface__Itof_X_gate__X_tof - var_x15 * var_x18 * NV_Ith_S(mParameters, 19) * var_chaste_interface__IKr_Xr_gate__Xr - 9.1125000000000004e-8 * var_x106 * var_x132 * var_x136 * NV_Ith_S(mParameters, 5) - 0.4389381125701739 * var_x15 * var_x28 * var_x36 * NV_Ith_S(mParameters, 18) - 0.42189361069797565 * var_x28 * var_x80 * (-var_x31 * (0.061749999999999999 * var_x32 + 0.039456396800000001 * var_x33) + 0.24326999999999999 * var_x26 * var_x78 - 0.51429999999999998 * var_x29 * var_x34 / pow(var_x30, 2)) * NV_Ith_S(mParameters, 18) / pow((var_x28 + 0.98039215686274506 * var_x35), 2) + 0.10468673984798647 * var_x15 * var_x26 * var_x36 * var_x78 * var_x79 * NV_Ith_S(mParameters, 18) + 0.019211226915711394 * var_x15 * var_x16 * var_x79 * NV_Ith_S(mParameters, 19) * var_chaste_interface__IKr_Xr_gate__Xr / pow(var_x17, 2) + 1.215e-7 * var_x100 * var_x106 * var_x133 * var_x134 * var_x135 * var_x137 * var_x94 * var_x96 * var_chaste_interface__ICaL_d_gate__d * var_chaste_interface__ICaL_f_gate__f * var_chaste_interface__cell__V);
        IJth(rJacobian, 2, 0) = var_x260 * (var_x261 * var_x265 + var_x254 * var_x264 * (-var_x261 - var_x266) / pow(var_x262, 2)) + (1 * var_x261 + 1 * var_x266) * (var_x263 - var_chaste_interface__INa_h_gate__h + var_x254 * var_x265);
        IJth(rJacobian, 3, 0) = var_x285 * (var_x286 * var_x288 + var_x264 * var_x284 * (-var_x286 - var_x289) / pow(var_x287, 2)) + (1 * var_x286 + 1 * var_x289) * (var_x263 - var_chaste_interface__INa_j_gate__j + var_x284 * var_x288);
        IJth(rJacobian, 4, 0) = var_x296 * (var_x295 * var_x297 - var_x297 * var_x298 + 3.125 * var_x299 * var_x300 / pow((var_x300 + 0.25 * var_x293), 2)) - var_x299 * (-var_chaste_interface__INa_m_gate__m + 0.32000000000000001 * var_x292 * var_x294 * var_x297);
        IJth(rJacobian, 5, 0) = (-var_chaste_interface__IKr_Xr_gate__Xr + 1 / var_x302) * (0.00060999999999999997 * var_x305 + 0.0013799999999999999 * var_x308 - 0.00016973999999999998 * var_x306 * var_x309 / pow(var_x307, 2) - 8.8449999999999995e-5 * var_x303 * var_x310 / pow(var_x304, 2)) + 0.13333333333333333 * var_x301 * var_x311 / pow(var_x302, 2);
        IJth(rJacobian, 6, 0) = (-var_chaste_interface__IKs_Xs_gate__Xs + 1 / var_x313) * (0.00013100000000000001 * var_x316 + 7.1899999999999999e-5 * var_x319 - 8.9997000000000013e-6 * var_x314 * var_x320 / pow(var_x315, 2) - 1.0641199999999999e-5 * var_x317 * var_x320 / pow(var_x318, 2)) + 0.059880239520958084 * var_x312 * var_x321 / pow(var_x313, 2);
        IJth(rJacobian, 7, 0) = var_x326 * var_x329 + 0.0074074074074074077 * var_x323 * (-var_x330 - var_chaste_interface__Itos_X_gate__X_tos) / (pow(var_x324, 2) * pow((0.055555555555555552 + var_x325), 2));
        IJth(rJacobian, 8, 0) = -var_x335 * var_x339 + 3.3333333333333335e-5 * var_x332 * var_x340 * (-var_x342 - var_chaste_interface__Itos_Y_gate__Y_tos) / pow((0.01 + var_x334), 2);
        IJth(rJacobian, 9, 0) = -var_x339 * var_x343 + 3.5714285714285717e-5 * var_x332 * var_x340 * (-var_x342 - var_chaste_interface__Itos_R_gate__R_tos) / pow((0.07857142857142857 + var_x334), 2);
        IJth(rJacobian, 10, 0) = var_x329 * var_x345 + 0.00063492063492063492 * var_x344 * (-var_x330 - var_chaste_interface__Itof_X_gate__X_tof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x344), 2);
        IJth(rJacobian, 11, 0) = -var_x339 * var_x346 + 0.0050000000000000001 * var_x336 * var_x338 * (-var_x342 - var_chaste_interface__Itof_Y_gate__Y_tof) / pow((1 + var_x341), 2);
        IJth(rJacobian, 12, 0) = -var_x349 * var_x352 * var_x354 + 0.035000000000000003 * var_x349 * var_x350 * var_x352 - var_x350 * var_x352 * var_x354 / pow(var_x348, 2) + 0.0058333333333333336 * var_x347 * var_x349 * var_x351 * var_x353;
        IJth(rJacobian, 13, 0) = var_x356 * (0.029999999999999999 * var_x359 / pow(var_x360, 2) - 0.27777777777777779 * var_x357 / pow(var_x358, 2)) + var_x355 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__cell__V) * (-var_chaste_interface__ICaL_f_gate__f + 1 / var_x358 + 0.59999999999999998 / var_x360);
        IJth(rJacobian, 19, 0) = -var_x380 * (0.00026433000000000001 + var_x153 + var_x203 + 2.6699999999999999 * var_x77 + 5.0996999999999995 * var_x93 + 0.46858500000000003 * var_x111);
        IJth(rJacobian, 20, 0) = -var_x397 * (3.2670000000000004e-5 + var_x159 + var_x212 + 0.33000000000000002 * var_x64 + 0.63029999999999997 * var_x90 + 0.057915000000000008 * var_x114);
        IJth(rJacobian, 25, 0) = -var_x411 * (0.00022365699999999999 + var_x125 + var_x141 - var_x144 - 1.78 * var_x77 - 0.31239000000000006 * var_x111);
        IJth(rJacobian, 26, 0) = -var_x419 * (2.7642999999999999e-5 + var_x131 + var_x139 - var_x146 - 0.22 * var_x64 - 0.038610000000000005 * var_x114);
        IJth(rJacobian, 1, 1) = -7.2523935948689155 + var_x228 + var_x229 + var_x230 + var_x241 + var_x242 + 6.3492962168146398e-7 * var_x240 - 5029484.9869235931 * var_x231 * var_x238;
        IJth(rJacobian, 24, 1) = -1.1791550116941473e-5 * var_x240 + 93404721.185723871 * var_x231 * var_x235 * var_x236 * NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 25, 1) = 5.6417918332397381;
        IJth(rJacobian, 32, 1) = 2.2890000000000006 - var_x228;
        IJth(rJacobian, 33, 1) = 0.33180000000000004 - var_x241;
        IJth(rJacobian, 35, 1) = 0.81600000000000006 - var_x229;
        IJth(rJacobian, 36, 1) = 1.9320000000000004 - var_x242;
        IJth(rJacobian, 38, 1) = 1.71 - var_x230;
        IJth(rJacobian, 39, 1) = var_x429 * var_x431;
        IJth(rJacobian, 42, 1) = var_x437 * var_x439;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x161 * var_x20 - var_x163 * var_x20);
        IJth(rJacobian, 2, 2) = -var_x260;
        IJth(rJacobian, 19, 2) = -var_x382 * var_x383;
        IJth(rJacobian, 20, 2) = -var_x382 * var_x398;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x161 * var_x165 - var_x163 * var_x165);
        IJth(rJacobian, 3, 3) = -var_x285;
        IJth(rJacobian, 19, 3) = -var_x383 * var_x384;
        IJth(rJacobian, 20, 3) = -var_x384 * var_x398;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.33000000000000002 * var_x167 - 2.6699999999999999 * var_x168);
        IJth(rJacobian, 4, 4) = -var_x296;
        IJth(rJacobian, 19, 4) = -165.83168702434122 * var_x168 * var_x381;
        IJth(rJacobian, 20, 4) = -803.76671393159438 * var_x167 * var_x381;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x18 * var_x80 * NV_Ith_S(mParameters, 19));
        IJth(rJacobian, 5, 5) = -var_x311;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.22 * var_x171 * var_x8 - 1.78 * var_x13 * var_x171);
        IJth(rJacobian, 6, 6) = -var_x321;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x4 * var_x79);
        IJth(rJacobian, 7, 7) = -var_x326;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x172);
        IJth(rJacobian, 8, 8) = -var_x335;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.5 * var_x172);
        IJth(rJacobian, 9, 9) = -var_x343;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x5 * var_x79);
        IJth(rJacobian, 10, 10) = -var_x345;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x79 * NV_Ith_S(mParameters, 17) * var_chaste_interface__Itof_X_gate__X_tof);
        IJth(rJacobian, 11, 11) = -var_x346;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x150 * var_x176 - var_x174 * var_x175 - var_x176 * var_x177 - var_x179 * var_x181 - var_x180 * var_x183);
        IJth(rJacobian, 12, 12) = -0.035000000000000003 * var_x349 * var_x350 * var_x353;
        IJth(rJacobian, 19, 12) = -var_x385 * var_x389;
        IJth(rJacobian, 20, 12) = -var_x385 * var_x400;
        IJth(rJacobian, 25, 12) = -var_x181 * var_x412;
        IJth(rJacobian, 26, 12) = -var_x180 * var_x421;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x150 * var_x186 - var_x175 * var_x185 - var_x177 * var_x186 - var_x179 * var_x188 - var_x183 * var_x187);
        IJth(rJacobian, 13, 13) = -var_x356;
        IJth(rJacobian, 19, 13) = -var_x389 * var_x390;
        IJth(rJacobian, 20, 13) = -var_x390 * var_x400;
        IJth(rJacobian, 25, 13) = -var_x188 * var_x412;
        IJth(rJacobian, 26, 13) = -var_x187 * var_x421;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (1.2150000000000001e-8 * var_x190 + var_x119 * var_x179 + 6.7499999999999994e-10 * var_x148 * var_x189);
        IJth(rJacobian, 14, 14) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_buffer__Ca_SL;
        IJth(rJacobian, 19, 14) = var_x103 * var_x148 * var_x388;
        IJth(rJacobian, 25, 14) = var_x119 * var_x412;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (1.0935000000000001e-7 * var_x190 + 6.0749999999999998e-9 * var_x155 * var_x178 + var_x119 * var_x130 * var_x178);
        IJth(rJacobian, 15, 15) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 20, 15) = var_x155 * var_x399;
        IJth(rJacobian, 26, 15) = var_x119 * var_x129 * var_x420;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 - var_x366 - var_x368;
        IJth(rJacobian, 17, 16) = -var_x368;
        IJth(rJacobian, 18, 16) = var_x368;
        IJth(rJacobian, 16, 17) = -0.0050000000000000001;
        IJth(rJacobian, 17, 17) = -0.065000000000000002 - var_x368;
        IJth(rJacobian, 18, 17) = 0.0050000000000000001;
        IJth(rJacobian, 16, 18) = 0.055;
        IJth(rJacobian, 17, 18) = var_x366 - var_x368;
        IJth(rJacobian, 18, 18) = -0.059999999999999998 - var_x366;
        IJth(rJacobian, 24, 18) = -var_x406;
        IJth(rJacobian, 26, 18) = 68.627450980392155 * var_x406;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x204 - 2.6699999999999999 * var_x199 - 0.00046442182911003347 * var_x201 - var_x194 * var_x197);
        IJth(rJacobian, 19, 19) = (-2.5101556644976917 + var_x391 - var_x379 * (var_x204 + 8.0099999999999998 * var_x199 + 0.0013932654873301004 * var_x201 + var_x194 * var_x392)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 20, 19) = 1.0879068612142859 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 19) = 0.000165 - var_x391;
        IJth(rJacobian, 23, 19) = var_x405;
        IJth(rJacobian, 25, 19) = -var_x411 * (-5.3399999999999999 * var_x199 - var_x194 * var_x413);
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x213 - 0.33000000000000002 * var_x209 - 5.7400450788880541e-5 * var_x210 - var_x206 * var_x208);
        IJth(rJacobian, 19, 20) = 0.02774162496096429 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 20, 20) = (-1.0886629612142857 + var_x401 - var_x396 * (var_x213 + 0.98999999999999999 * var_x209 + 0.00017220135236664162 * var_x210 + var_x206 * var_x402)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 20) = 0.0007561 - var_x401;
        IJth(rJacobian, 26, 20) = -var_x419 * (-0.66000000000000003 * var_x209 - var_x206 * var_x422);
        IJth(rJacobian, 19, 21) = var_x393 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 21) = -var_x393;
        IJth(rJacobian, 20, 22) = var_x403 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 22) = -var_x403;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0020162999999999999 * var_x10 * var_x214 - 0.0163137 * var_x14 * var_x214);
        IJth(rJacobian, 19, 23) = 2.4822490395367272 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 23) = -var_x405;
        IJth(rJacobian, 1, 24) = 0.69232869146389786 * var_x244 + 8.7400597733819945e-14 * var_x245;
        IJth(rJacobian, 16, 24) = -var_x372 + 2.3772197685794643 * var_x361 * var_x362 * var_x369 * var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__R;
        IJth(rJacobian, 17, 24) = -var_x375 + var_x371 * var_x376;
        IJth(rJacobian, 18, 24) = var_x372 + var_x375;
        IJth(rJacobian, 24, 24) = -260 + var_x407 - var_x409 - 1.6231539579137989e-12 * var_x245 - 12.857532841472388 * var_x244;
        IJth(rJacobian, 26, 24) = var_x423;
        IJth(rJacobian, 31, 24) = 260 - var_x407;
        ...
        IJth(rJacobian, 19, 25) = -var_x380 * (1.3438550016e-10 * var_x217 - 2.6699999999999999 * var_x395 + var_x219 * var_x392);
        IJth(rJacobian, 25, 25) = -171.99023312516786 + var_x414 + var_x415 - var_x411 * (var_x222 + 1.78 * var_x395 - 8.9590333439999989e-11 * var_x217 - var_x219 * var_x413);
        IJth(rJacobian, 26, 25) = 48.958482036396518;
        IJth(rJacobian, 27, 25) = 121.55000000000001 - var_x414;
        IJth(rJacobian, 29, 25) = 43.550000000000004 - var_x415;
        IJth(rJacobian, 40, 25) = var_x431 * var_x433;
        IJth(rJacobian, 43, 25) = var_x439 * var_x441;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x227 - 5.5364812799999996e-12 * var_x225 - var_x208 * var_x224 - 0.0012058750000000001 * var_x215 / (pow(var_x1, 2) * var_x223) - 0.034833333333333334 * var_x0 * var_x216 * var_x6 / pow(var_x7, 2) + 0.11 * var_x45 * var_x46 * var_x53 * var_x55 * var_x57 * var_x59 * NV_Ith_S(mParameters, 22));
        IJth(rJacobian, 15, 26) = 1.7 - 1.7 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        IJth(rJacobian, 16, 26) = -var_x374 - var_x365 * var_chaste_interface__Jrel_SR__R;
        IJth(rJacobian, 17, 26) = var_x377 + var_x373 * var_x376 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 18, 26) = var_x374 - var_x377;
        IJth(rJacobian, 20, 26) = -var_x397 * (1.6609443839999999e-11 * var_x225 - 0.33000000000000002 * var_x404 + var_x224 * var_x402);
        IJth(rJacobian, 24, 26) = var_x409;
        IJth(rJacobian, 25, 26) = 1.2484412919281114;
        IJth(rJacobian, 26, 26) = -128.61534478149457 + var_x424 + var_x425 - var_x423 - var_x419 * (var_x227 + 0.22 * var_x404 - 1.1072962559999999e-11 * var_x225 - var_x224 * var_x422);
        IJth(rJacobian, 28, 26) = 58.627450980392155 - var_x424;
        IJth(rJacobian, 30, 26) = 21.029411764705884 - var_x425;
        IJth(rJacobian, 41, 26) = var_x431 * var_x435;
        IJth(rJacobian, 44, 26) = var_x439 * var_x443;
        IJth(rJacobian, 25, 27) = var_x417;
        IJth(rJacobian, 27, 27) = -var_x417;
        IJth(rJacobian, 26, 28) = var_x427;
        IJth(rJacobian, 28, 28) = -var_x427;
        IJth(rJacobian, 25, 29) = var_x418;
        IJth(rJacobian, 29, 29) = -var_x418;
        IJth(rJacobian, 26, 30) = var_x428;
        IJth(rJacobian, 30, 30) = -var_x428;
        IJth(rJacobian, 24, 31) = var_x410;
        IJth(rJacobian, 31, 31) = -var_x410;
        IJth(rJacobian, 1, 32) = var_x246;
        IJth(rJacobian, 32, 32) = -var_x246;
        IJth(rJacobian, 1, 33) = 0.003032 + var_x247;
        IJth(rJacobian, 33, 33) = -3.1999999999999999e-5 - var_x247;
        IJth(rJacobian, 34, 33) = -0.0030000000000000001;
        IJth(rJacobian, 1, 34) = 0.0063300000000000006 + var_x247;
        IJth(rJacobian, 33, 34) = -var_x247;
        IJth(rJacobian, 34, 34) = -0.0063300000000000006;
        IJth(rJacobian, 1, 35) = var_x248;
        IJth(rJacobian, 35, 35) = -var_x248;
        IJth(rJacobian, 1, 36) = 0.016159999999999997 + var_x249;
        IJth(rJacobian, 36, 36) = -0.00046000000000000001 - var_x249;
        IJth(rJacobian, 37, 36) = -0.015699999999999999;
        IJth(rJacobian, 1, 37) = 0.015757 + var_x249;
        IJth(rJacobian, 36, 37) = -var_x249;
        IJth(rJacobian, 37, 37) = -0.015757;
        IJth(rJacobian, 1, 38) = var_x251;
        IJth(rJacobian, 38, 38) = -var_x251;
        IJth(rJacobian, 39, 39) = -0.059999999999999998 - var_x250 * var_x429 - var_x250 * var_x430;
        IJth(rJacobian, 40, 39) = -var_x416 * var_x433;
        IJth(rJacobian, 41, 39) = -var_x426 * var_x435;
        IJth(rJacobian, 39, 40) = -3.0769230769230771 * var_x432;
        IJth(rJacobian, 40, 40) = -0.059999999999999998 - 3.0769230769230771 * var_x434 - var_x416 * var_x430;
        IJth(rJacobian, 41, 40) = -3.0769230769230771 * var_x436;
        IJth(rJacobian, 39, 41) = -0.078461538461538471 * var_x432;
        IJth(rJacobian, 40, 41) = -0.078461538461538471 * var_x434;
        IJth(rJacobian, 41, 41) = -0.059999999999999998 - 0.078461538461538471 * var_x436 - var_x426 * var_x430;
        IJth(rJacobian, 42, 42) = -0.11 - var_x250 * var_x437 - var_x250 * var_x438;
        IJth(rJacobian, 43, 42) = -var_x416 * var_x441;
        IJth(rJacobian, 44, 42) = -var_x426 * var_x443;
        IJth(rJacobian, 42, 43) = -3.0769230769230771 * var_x440;
        IJth(rJacobian, 43, 43) = -0.11 - 3.0769230769230771 * var_x442 - var_x416 * var_x438;
        IJth(rJacobian, 44, 43) = -3.0769230769230771 * var_x444;
        IJth(rJacobian, 42, 44) = -0.078461538461538471 * var_x440;
        IJth(rJacobian, 43, 44) = -0.078461538461538471 * var_x442;
        IJth(rJacobian, 44, 44) = -0.11 - 0.078461538461538471 * var_x444 - var_x426 * var_x438;
    }

    N_Vector Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_model_parameters__cell_radius = 10.25; // micrometre
        const double var_model_parameters__Cm = 2.0e-8 * M_PI * var_model_parameters__Cm_per_area * var_model_parameters__cell_length * var_model_parameters__cell_radius; // farad
        const double var_model_parameters__Cm_converted = 1000000 * var_model_parameters__Cm; // uF
        const double var_reversal_potentials__E_Ca_SL = 0.5 * NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 23) * log(NV_Ith_S(mParameters, 6) / var_chaste_interface__Ca_buffer__Ca_SL) / NV_Ith_S(mParameters, 10); // millivolt
        const double var_ICab__i_Cab_SL = (-var_reversal_potentials__E_Ca_SL + var_chaste_interface__cell__V) * var_ICab__Fx_CaBk_SL * var_ICab__G_CaBk; // microA_per_microF
        const double var_reversal_potentials__E_Ca_jct = 0.5 * NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 23) * log(NV_Ith_S(mParameters, 6) / var_chaste_interface__Ca_buffer__Ca_jct) / NV_Ith_S(mParameters, 10); // millivolt
        const double var_ICab__i_Cab_jct = (-var_reversal_potentials__E_Ca_jct + var_chaste_interface__cell__V) * var_ICab__Fx_CaBk_jct * var_ICab__G_CaBk; // microA_per_microF
...
template<>
void OdeSystemInformation<Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode>::Initialise(void)
{
...
extern "C"
{
    ...
    {
        return new Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode(pSolver, pStimulus);
    }
