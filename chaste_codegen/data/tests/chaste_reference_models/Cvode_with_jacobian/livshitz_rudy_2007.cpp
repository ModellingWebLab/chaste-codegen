...
#include "MathsCustomFunctions.hpp"
    ...
    void Celllivshitz_rudy_2007FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x165 = 310000.0 * var_x164 + 3.5600000000000001 * var_x163;
        const double var_x166 = var_x158 / pow(var_x159, 2);
        ...
        const double var_x172 = var_x171 * (1.0 - var_chaste_interface__INa__H);
        ...
        const double var_x175 = -var_x174;
        const double var_x176 = exp(-4.7130000000000001 + var_x175);
        const double var_x177 = 1.0 - var_x176;
        const double var_x178 = 0.32000000000000001 / var_x177;
        const double var_x179 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x180 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x181 = exp(-3.2000000000000002 + var_x175);
        const double var_x182 = 1.0 + var_x181;
        const double var_x183 = exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V);
        const double var_x184 = var_x183 / var_x182;
        const double var_x185 = var_x160 * var_x184;
        const double var_x186 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x187 = 1.0 + var_x186;
        const double var_x188 = exp(-0.01052 * var_chaste_interface__cell__V);
        const double var_x189 = var_x188 / var_x187;
        const double var_x190 = var_x162 * var_x189;
        const double var_x191 = 1.0 - var_chaste_interface__INa__J;
        const double var_x192 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
        const double var_x193 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x194 = -127140.0 * var_x192 - 3.4740000000000003e-5 * var_x193;
        const double var_x195 = var_x162 * var_x191 * var_x194;
        const double var_x196 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V);
        ...
        const double var_x201 = var_x162 * var_x199;
        const double var_x202 = var_x194 * var_x200;
        ...
        const double var_x206 = exp(-2500.0 + var_x157);
        const double var_x207 = 1.0 + var_x206;
        const double var_x208 = 1 / var_x207;
        const double var_x209 = 1.0 + var_x203;
        const double var_x210 = 1 / var_x209;
        const double var_x211 = -var_chaste_interface__ICaL__d + 1.0 * var_x208 * var_x210;
        const double var_x212 = var_x205 * var_x211;
        const double var_x213 = 0.035000000000000003 * var_x209;
        ...
        const double var_x217 = 1 + var_x174;
        const double var_x218 = exp(-0.113569 * pow(var_x217, 2.0));
        const double var_x219 = 0.019699999999999999 * var_x218;
        ...
        const double var_x267 = 1 - 0.092592592592592587 * var_chaste_interface__Ca__Ca_JSR_T;
        const double var_x268 = sqrt(pow(var_x267, 2.0) + 0.027434842249657063 * var_chaste_interface__Ca__Ca_JSR_T);
        const double var_x269 = 1 / (-5.4000000000000004 + 0.5 * var_chaste_interface__Ca__Ca_JSR_T + 5.4000000000000004 * var_x268);
        ...
        const double var_x276 = 4.6323915649710559 * var_x93;
        ...
        const double var_x281 = (0.013717421124828532 - 0.092592592592592587 * pow(var_x267, 1.0)) / var_x268;
        const double var_x282 = -0.5 - 5.4000000000000004 * var_x281;
        const double var_x283 = 0.00098433188611789972 * var_x56;
        const double var_x284 = 1.4999377389423059e-7 * var_x84;
        const double var_x285 = 1.4680354103637137e-6 * var_x19;
        const double var_x286 = 0.433 + var_x39;
        const double var_x287 = 6.1520742882368733e-5 * var_x286;
        const double var_x288 = var_x287 * var_chaste_interface__IKs__xs2;
        const double var_x289 = 4.129448361660385e-5 * var_x75;
        const double var_x290 = 4.2887108683831854e-8 * var_x86;
        const double var_x291 = var_x115 * var_x286 * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2;
        const double var_x292 = 1.5380185720592186e-6 * var_x21;
        const double var_x293 = 0.0002399900382307689 * var_x93;
        const double var_x294 = 1.7968478228480326e-5 * var_x98;
        const double var_x295 = var_x139 / (-0.040040000000000006 + var_x34);
        const double var_x296 = var_x145 / pow((-0.060060000000000009 + var_x144), 2);
        ...
        IJth(rJacobian, 1, 0) = (var_x165 * var_x167 - var_x162 * (0.28123999999999999 * var_x163 + 108500.0 * var_x164) - 320.51282051282044 * var_x166 * var_x170 - 0.693000693000693 * var_x160 * var_x168 / pow(var_x169, 2)) * var_chaste_interface__INa__H - 0.019852941176470591 * var_x162 * var_x172 - 5.625 * var_x166 * var_x172;
        IJth(rJacobian, 2, 0) = var_x173 * var_x178 + 0.0072727272727272727 * var_x179 * var_chaste_interface__INa__m - 0.032000000000000001 * var_x173 * var_x176 * var_x180 / pow(var_x177, 2);
        IJth(rJacobian, 3, 0) = var_x195 * var_x199 + (7.6049999999999996e-8 * var_x185 + 0.001275024 * var_x190 + 5.0499999999999998 * var_x166 * var_x189 - 12.499999999999998 * var_x166 * var_x184 - 0.016701360000000002 * var_x162 * var_x186 * var_x188 / pow(var_x187, 2) - 0.029999999999999999 * var_x160 * var_x181 * var_x183 / pow(var_x182, 2)) * var_chaste_interface__INa__J + var_x191 * var_x200 * var_x201 * (1.5254334000000001e-6 * var_x193 - 31073.016 * var_x192) - var_x167 * var_x191 * var_x198 * var_x202 - 0.311 * var_x195 * var_x196 * var_x200 / pow(var_x197, 2);
        IJth(rJacobian, 4, 0) = var_x212 * var_x213 + var_x215 * (0.16025641025641024 * var_x203 * var_x208 / pow(var_x209, 2) + 41.666666666666664 * var_x206 * var_x210 / pow(var_x207, 2)) - var_x212 * var_x216 - var_x209 * var_x211 * var_x216 / pow(var_x204, 2);
        IJth(rJacobian, 5, 0) = (0.02 + var_x219) * (0.029999999999999999 * var_x220 / pow(var_x221, 2) - 0.125 * var_x222 / pow(var_x223, 2)) - 0.00044746186 * var_x218 * pow(var_x217, 1.0) * (-var_chaste_interface__ICaL__f + 1.0 / var_x223 + 0.59999999999999998 / var_x221);
        ...
        IJth(rJacobian, 7, 0) = 0.059880239520958084 * var_x251 + var_x248 * (var_x238 - var_chaste_interface__IKs__xs1);
        IJth(rJacobian, 8, 0) = 0.014970059880239521 * var_x251 + 0.25 * var_x248 * (var_x238 - var_chaste_interface__IKs__xs2);
        ...
        IJth(rJacobian, 11, 0) = var_x271 * (-var_x277 + var_x100 * var_x279 - var_x105 * var_x279);
        IJth(rJacobian, 12, 0) = -2.4608297152947497e-7 + 1.4682156444593687e-9 * var_x54 + 5.6151494464001023e-9 * var_x101 - 0.00031144876084199171 * var_x63 - 4.6140557161776553e-8 * var_x71 - 4.2113620848000766e-9 * var_x104 - 3.1091625412080751e-9 * var_x72 - var_x283 * var_chaste_interface__INa__H - var_x284 * var_x82;
        IJth(rJacobian, 13, 0) = 0.00020763250722799449 * var_x63 + 1.0246623209999443e-5 * var_x69 + 6.5537295105522939e-8 * var_x66 + 1.6055168046743996e-9 * var_x97 - 4.296278075471465e-5 * var_x16 - 3.3959450071067542e-7 * var_x2 - 1.2041376035057997e-9 * var_x103 - 5.6788378045263449e-8 * var_x65 - var_x285 * var_chaste_interface__IKr__xr - var_x288 * var_chaste_interface__IKs__xs1 - var_x289 * var_x74 - var_x290 * var_x82;
        IJth(rJacobian, 14, 0) = -9.2773280266612054e-8 + 1.5380185720592186e-8 * var_x71 + 1.0363875137360252e-9 * var_x72 - 4.8940521481978966e-10 * var_x54 + var_x100 * var_x294 - var_x105 * var_x294 - var_x292 * var_chaste_interface__ICaT__g - var_x293 * var_x81;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x106 * var_x57);
        IJth(rJacobian, 1, 1) = -var_x162 * var_x165 + 0.13500000000000001 * var_x171 * (-1.0 + var_x161) - 7.6923076923076916 * var_x160 * var_x170;
        IJth(rJacobian, 12, 1) = -var_x106 * var_x283;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-48.0 * var_x108);
        IJth(rJacobian, 2, 2) = -0.080000000000000002 * var_x179 - var_x178 * var_x180;
        IJth(rJacobian, 12, 2) = -0.0029529956583536992 * var_x108;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-16.0 * var_x109);
        IJth(rJacobian, 3, 3) = -0.1212 * var_x190 - 0.29999999999999999 * var_x185 - var_x201 * var_x202;
        ...
        IJth(rJacobian, 11, 4) = -var_x110 * var_x280;
        IJth(rJacobian, 12, 4) = -var_x111 * var_x284;
        IJth(rJacobian, 13, 4) = -var_x111 * var_x290;
        IJth(rJacobian, 14, 4) = -var_x110 * var_x293;
        ...
        IJth(rJacobian, 11, 5) = -var_x113 * var_x280;
        IJth(rJacobian, 12, 5) = -var_x114 * var_x284;
        IJth(rJacobian, 13, 5) = -var_x114 * var_x290;
        IJth(rJacobian, 14, 5) = -var_x113 * var_x293;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x20 * var_x64);
        IJth(rJacobian, 6, 6) = -var_x234 - var_x235;
        IJth(rJacobian, 13, 6) = -var_x285 * var_x64;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x116 * var_x41);
        IJth(rJacobian, 7, 7) = -var_x249 - var_x250;
        IJth(rJacobian, 13, 7) = -var_x116 * var_x288;
        ...
        IJth(rJacobian, 13, 8) = -var_x117 * var_x287;
        ...
        IJth(rJacobian, 14, 10) = -var_x118 * var_x292;
        ...
        IJth(rJacobian, 13, 12) = 4.1526501445598901e-6 * var_x124 - 3.012284234720363e-5 * var_x291;
        ...
        IJth(rJacobian, 13, 13) = 0.000273711269773125 * var_x132 - 3.216533151287389e-8 * var_x102 - 9.0713633255081325e-6 * var_x127 - 3.9214659113300655e-5 * var_x129 - 0.0011476363512500001 * var_x128 - 0.001643362921287705 * var_x291 - var_x131 * var_x289;
        ...
        IJth(rJacobian, 11, 14) = var_x271 * (-4.6323915649710559 * var_x150 * var_x278 - 3.7522371676265554e-6 * var_x153 * var_x274);
        ...
        IJth(rJacobian, 14, 14) = 1.5380185720592186e-8 * var_x143 + 1.2390956426509296e-6 * var_x138 + 2.0542036516096317e-5 * var_x147 - 0.0002399900382307689 * var_x151 - 3.5374427157362023e-5 * var_x140 - 0.00071029411764705886 * var_x295 - 7.9592461104064564e-5 * var_x146 - 0.0015981617647058827 * var_x296 - 1.9439193096692283e-10 * var_x153 - 1.5380185720592186e-12 * var_x148;
        IJth(rJacobian, 16, 14) = 0.0087500000000000008 * var_x295 + 0.019687500000000004 * var_x296;
        IJth(rJacobian, 11, 15) = 8.8802252544942581e-5 * var_x282 * (-var_chaste_interface__Irel__Rel - var_x277 * var_chaste_interface__cell__V) / pow((-1 + var_x268 + 0.092592592592592587 * var_chaste_interface__Ca__Ca_JSR_T), 2) + 41.691524084739505 * var_x269 * var_x271 * var_x272 * var_x282 * var_x93 * var_x98 / pow(var_x273, 2);
