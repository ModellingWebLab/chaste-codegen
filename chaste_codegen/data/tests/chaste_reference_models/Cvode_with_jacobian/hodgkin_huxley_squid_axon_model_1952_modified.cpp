...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_potassium_channel_n_gate__alpha_n = ((fabs(65.0 + var_chaste_interface__membrane__V) < 1.0000000000287557e-6) ? (1.0000000000287556e-8 / (-1.0 + exp(1.0000000000287557e-7)) + 499999.99998562218 * (65.000000999999997 + var_chaste_interface__membrane__V) * (-1.0000000000287556e-8 / (-1.0 + exp(1.0000000000287557e-7)) - 1.0000000000287556e-8 / (-1.0 + exp(-1.0000000000287557e-7)))) : (-0.01 * (65.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-6.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)))); // per_millisecond
        ...
        const double var_sodium_channel_m_gate__alpha_m = ((fabs(50.0 + var_chaste_interface__membrane__V) < 1.0000000000287557e-6) ? (1.0000000000287557e-7 / (-1.0 + exp(1.0000000000287557e-7)) + 499999.99998562218 * (50.000000999999997 + var_chaste_interface__membrane__V) * (-1.0000000000287557e-7 / (-1.0 + exp(1.0000000000287557e-7)) - 1.0000000000287557e-7 / (-1.0 + exp(-1.0000000000287557e-7)))) : (-0.10000000000000001 * (50.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-5.0 - 0.10000000000000001 * var_chaste_interface__membrane__V)))); // per_millisecond
    ...
    void Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 1, 0) = (1.0 - var_chaste_interface__sodium_channel_m_gate__m) * ((var_x6) ? (-0.050000000000000003 * var_x3 - 0.050000000000000003 * var_x4) : (-var_x10 - 0.01 * var_x5 * var_x8 / pow(var_x9, 2))) + 0.22222222222222221 * var_x11 * var_chaste_interface__sodium_channel_m_gate__m;
        ...
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__potassium_channel_n_gate__n) * ((var_x17) ? (-0.0050000000000000001 * var_x3 - 0.0050000000000000001 * var_x4) : (-var_x20 - 0.001 * var_x16 * var_x18 / pow(var_x19, 2))) - 0.0015625000000000001 * var_x21 * var_chaste_interface__potassium_channel_n_gate__n;
        ...
        IJth(rJacobian, 1, 1) = -((var_x6) ? (var_x12 + 499999.99998562218 * (50.000000999999997 + var_chaste_interface__membrane__V) * (-var_x12 - 1.0000000000287557e-7 * var_x4)) : (-var_x10 * var_x5)) - 4.0 * var_x11;
        ...
        IJth(rJacobian, 3, 3) = -((var_x17) ? (var_x22 + 499999.99998562218 * (65.000000999999997 + var_chaste_interface__membrane__V) * (-var_x22 - 1.0000000000287556e-8 * var_x4)) : (-var_x16 * var_x20)) - 0.125 * var_x21;
    }
