...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 1, 0) = (1.0 - var_chaste_interface__sodium_channel_m_gate__m) * ((var_x5) ? (-0.050000000000000003 * var_x2 - 0.050000000000000003 * var_x3) : (-var_x9 - 0.01 * var_x4 * var_x7 / pow(var_x8, 2))) + 0.22222222222222221 * var_x10 * var_chaste_interface__sodium_channel_m_gate__m;
        IJth(rJacobian, 2, 0) = -0.050000000000000003 * var_x12 * (0.070000000000000007 - 0.070000000000000007 * var_chaste_interface__sodium_channel_h_gate__h) - 0.10000000000000001 * var_x13 * var_chaste_interface__sodium_channel_h_gate__h / pow(var_x14, 2);
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__potassium_channel_n_gate__n) * ((var_x16) ? (-0.0050000000000000001 * var_x2 - 0.0050000000000000001 * var_x3) : (-var_x19 - 0.001 * var_x15 * var_x17 / pow(var_x18, 2))) - 0.0015625000000000001 * var_x20 * var_chaste_interface__potassium_channel_n_gate__n;
        ...
        IJth(rJacobian, 1, 1) = -((var_x5) ? (-var_x11 - 499999.99998562218 * (49.999999000000003 + var_chaste_interface__membrane__V) * (var_x11 + 1.0000000000287557e-7 * var_x2)) : (-var_x4 * var_x9)) - 4.0 * var_x10;
        ...
        IJth(rJacobian, 3, 3) = -((var_x16) ? (-var_x21 - 499999.99998562218 * (64.999999000000003 + var_chaste_interface__membrane__V) * (var_x21 + 1.0000000000287556e-8 * var_x2)) : (-var_x15 * var_x19)) - 0.125 * var_x20;
    }
