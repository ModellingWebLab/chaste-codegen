...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 1, 1) = -((var_x6) ? (-var_x12 - 499999.99998562218 * (49.999999000000003 + var_chaste_interface__membrane__V) * (var_x12 + 1.0000000000287557e-7 * var_x3)) : (-var_x10 * var_x5)) - 4.0 * var_x11;
        ...
        IJth(rJacobian, 3, 3) = -((var_x17) ? (-var_x22 - 499999.99998562218 * (64.999999000000003 + var_chaste_interface__membrane__V) * (var_x22 + 1.0000000000287556e-8 * var_x3)) : (-var_x16 * var_x20)) - 0.125 * var_x21;
    }
