...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliyer_model_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x78 = 0.31576891781939609 * var_x77 - 0.093489896373056991 * var_x73 - 0.49683202072538851 * var_x74 - 2.0706890167875649 * var_x75 - 0.00015031321966819388 * var_x70 - 6.6941504319201117 * var_x76;
        ...
        const double var_x101 = 1.9425621197603171e-5 * var_x77 - 0.00012738562343605624 * var_x75 - 3.0564346548418563e-5 * var_x74 - 9.2470395326765519e-9 * var_x70 - 5.7513555333045694e-6 * var_x73 - 0.00041181390311704753 * var_x76;
        ...
        const double var_x196 = exp(-0.00037301599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x197 = 1.8592012678400001e-5 * var_x196;
        const double var_x198 = exp(-0.046843700000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x199 = 0.0037561620845000003 * var_x198;
        const double var_x200 = 2.1748319999999999 * var_x194;
        const double var_x201 = 0.00081948199999999996 * var_x192;
        const double var_x202 = 0.080185000000000006 * var_x198;
        const double var_x203 = 0.049842400000000002 * var_x196;
        const double var_x204 = 0.047274866891999993 * var_x194;
        const double var_x205 = 8.3392179730847992e-11 * var_x192;
        const double var_x206 = 2.7448243264023812e-6 * var_x196;
        const double var_x207 = 0.0075123241690000005 * var_x198;
        const double var_x208 = 1.6311239999999998 * var_x194;
        const double var_x209 = 0.0015517711151999999 * var_x192;
        const double var_x210 = 0.16037000000000001 * var_x198;
        const double var_x211 = 0.0073584627104531205 * var_x196;
        const double var_x212 = 6.2643871845094088e-10 * var_x192;
        const double var_x213 = 0.031516577927999993 * var_x194;
        const double var_x214 = 1.190172890246627e-6 * var_x196;
        const double var_x215 = 0.011268486253500002 * var_x198;
        const double var_x216 = 1.0874159999999999 * var_x194;
        const double var_x217 = 0.011656842546537791 * var_x192;
        const double var_x218 = 0.24055500000000002 * var_x198;
        const double var_x219 = 0.0031906751727717496 * var_x196;
        const double var_x220 = 0.015758288963999997 * var_x194;
        const double var_x221 = 6.9834511318773689e-9 * var_x192;
        const double var_x222 = 6.466053749793811e-7 * var_x196;
        const double var_x223 = 0.015024648338000001 * var_x198;
        const double var_x224 = 0.54370799999999997 * var_x194;
        const double var_x225 = 0.12994884875097448 * var_x192;
        const double var_x226 = 0.32074000000000003 * var_x198;
        const double var_x227 = 0.0017334521172801731 * var_x196;
        const double var_x228 = 6.2947815902170839e-9 * var_x192;
        const double var_x229 = 3.5441967137821161e-8 * var_x196;
        const double var_x230 = 0.11713400800552819 * var_x192;
        const double var_x231 = 9.5014602960251466e-5 * var_x196;
        const double var_x232 = 0.42695382052749886 * var_x194;
        const double var_x233 = 0.00198360904335657 * var_x198;
        const double var_x234 = 14.731181055359999 * var_x194;
        const double var_x235 = 0.042345268272074361 * var_x198;
        const double var_x236 = 0.10902718902100607 * var_x194;
        const double var_x237 = 0.0010000484785595239 * var_x198;
        const double var_x238 = 3.7617634137599998 * var_x194;
        const double var_x239 = 0.021348622729620501 * var_x198;
        const double var_x240 = 0.058010926130094308 * var_x194;
        const double var_x241 = 0.0010108205748447618 * var_x198;
        const double var_x242 = 2.0015500855706554 * var_x194;
        const double var_x243 = 0.021578581001175438 * var_x198;
        const double var_x244 = 0.2874951693560841 * var_x194;
        const double var_x245 = 0.016668393642939261 * var_x198;
        const double var_x246 = 9.9194413744637924 * var_x194;
        const double var_x247 = 0.35582999726621212 * var_x198;
        ...
        const double var_x271 = 5.0494790920257417e-5 * var_x248;
        ...
        const double var_x276 = 2.0082338973371909 * var_x250;
        const double var_x277 = 0.00060572898292340319 * var_x248;
        ...
        const double var_x282 = exp(-26.232056238852348 - 0.090161609404259865 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x283 = 767594485.71651864 * var_x282;
        ...
        const double var_x285 = 384756192.24456543 * var_x284 * var_chaste_interface__INa__na1;
        ...
        const double var_x292 = 288567144.18342406 * var_x284;
        const double var_x293 = 1535188971.4330373 * var_x282;
        ...
        const double var_x298 = 192378096.12228271 * var_x284;
        const double var_x299 = 2302783457.1495562 * var_x282;
        ...
        const double var_x304 = 96189048.061141357 * var_x284;
        const double var_x305 = 3070377942.8660746 * var_x282;
        ...
        const double var_x310 = exp(-19.672905196314268 + 0.084272054104636354 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x311 = 717453519.94201112 * var_x310;
        const double var_x312 = exp(-16.535928437145476 + 0.1097131992444229 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x313 = 934047731.6985184 * var_x312;
        const double var_x314 = exp(-27.092641999412571 - 0.061469636400174388 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x315 = 523324220.27000725 * var_x314;
        const double var_x316 = exp(-26.358496255772213 - 0.068762962366201316 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x317 = 585416244.0376184 * var_x316 * var_chaste_interface__INa__na7;
        const double var_x318 = 32745465422.278648 * var_x286;
        const double var_x319 = 8513540195.0827656 * var_x312;
        const double var_x320 = 8513540195.0827656 * var_x310;
        ...
        const double var_x324 = exp(-20.6726464954126 + 0.011394696340402199 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x325 = 97009205.304776609 * var_x324;
        ...
        const double var_x332 = 538822673.3061657 * var_x284 * var_chaste_interface__INa__na8;
        const double var_x333 = 548114892.2335701 * var_x282;
        const double var_x334 = 47690340841.071007 * var_x284;
        const double var_x335 = 6079249204.347868 * var_x282;
        const double var_x336 = 404117004.97962433 * var_x284;
        const double var_x337 = 1096229784.4671402 * var_x282;
        ...
        const double var_x345 = 2192459568.9342804 * var_x282;
        const double var_x346 = 11922585210.267752 * var_x284;
        const double var_x347 = 24316996817.391472 * var_x282;
        const double var_x348 = exp(-21.949261959797553 + 0.030147161449011892 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x349 = 256659070.76381233 * var_x348;
        ...
        const double var_x351 = 1225921583.3429821 * var_x350;
        ...
        const double var_x360 = exp(6.9808923999999997e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x361 = 2.9856908086401855e-10 * var_x360;
        const double var_x362 = exp(0.026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x363 = 0.0028649222200750738 * var_x362;
        ...
        const double var_x368 = var_x360 * var_x364 * var_x366 / (var_x362 * var_x367);
        const double var_x369 = 1.7628212752661065e-7 * var_x368;
        const double var_x370 = 0.10945626585855089 * var_x362;
        const double var_x371 = 0.00042769471831999382 * var_x360;
        const double var_x372 = 0.0071483033566472664 * var_x364;
        const double var_x373 = 1.6926962184371784e-6 * var_x368;
        const double var_x374 = 0.0032282621593045179 * var_x367;
        const double var_x375 = 0.0015600678590465679 * var_x366;
        ...
        IJth(rJacobian, 25, 0) = (-var_x193 - var_x195) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 - var_x197 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 - var_x199 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43;
        IJth(rJacobian, 26, 0) = var_x195 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 + (var_x199 - var_x204 - var_x205) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 - var_x206 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 - var_x207 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43;
        IJth(rJacobian, 27, 0) = var_x204 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 + (var_x207 - var_x212 - var_x213) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 - var_x214 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43 - var_x215 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43;
        ...
        IJth(rJacobian, 30, 0) = var_x193 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 + (var_x197 - var_x232) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 - var_x233 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43;
        IJth(rJacobian, 31, 0) = var_x205 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 + var_x232 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 + (var_x206 + var_x233 - var_x236) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 - var_x237 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43;
        ...
        IJth(rJacobian, 50, 0) = var_x313 * var_chaste_interface__INa__na5 + var_x327 * var_chaste_interface__INa__na13 + (var_x315 - var_x325) * var_chaste_interface__INa__na6;
        IJth(rJacobian, 51, 0) = var_x317 + var_x311 * var_chaste_interface__INa__na5;
        IJth(rJacobian, 52, 0) = -var_x332 - var_x333 * var_chaste_interface__INa__na9;
        IJth(rJacobian, 53, 0) = var_x332 + (var_x333 - var_x336) * var_chaste_interface__INa__na9 - var_x337 * var_chaste_interface__INa__na10;
        ...
        IJth(rJacobian, 61, 0) = var_x363 * var_chaste_interface__IKr__C3Herg + (var_x365 - var_x374) * var_chaste_interface__IKr__OHerg - var_x375 * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 62, 0) = var_x361 * var_chaste_interface__IKr__C3Herg + var_x374 * var_chaste_interface__IKr__OHerg + (var_x369 + var_x375) * var_chaste_interface__IKr__IHerg;
        ...
        IJth(rJacobian, 27, 26) = var_x208;
        IJth(rJacobian, 31, 26) = var_x209;
        IJth(rJacobian, 26, 27) = var_x210;
        IJth(rJacobian, 27, 27) = -var_x210 - var_x216 - var_x217;
        IJth(rJacobian, 28, 27) = var_x216;
        IJth(rJacobian, 32, 27) = var_x217;
        IJth(rJacobian, 27, 28) = var_x218;
        IJth(rJacobian, 28, 28) = -var_x218 - var_x224 - var_x225;
        IJth(rJacobian, 29, 28) = var_x224;
        IJth(rJacobian, 33, 28) = var_x225;
