...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliyer_model_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x35 = exp(-0.049791476732682874 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x36 = exp(2.0505200594353643);
        const double var_x37 = 1.0 + 0.1245 * var_x34 + 0.036499999999999998 * var_x35 * (-0.14285714285714285 + 0.14285714285714285 * var_x36);
        const double var_x38 = (0.00046609314685857277 * var_x34 + 0.049791476732682874 * var_x35 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x36)) / (pow(var_x37, 2) * (1.0 + 89.442719099991592 * var_x33));
        ...
        const double var_x68 = var_x10 * var_x39;
        const double var_x69 = var_x24 * var_x26 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai, 2);
        const double var_x70 = var_x32 * var_x33 / (var_x37 * pow((0.011180339887498949 + var_x33), 2));
        ...
        const double var_x74 = var_x17 * var_chaste_interface__IKr__OHerg;
        const double var_x75 = var_x17 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43;
        const double var_x76 = var_x17 * var_x21;
        const double var_x77 = var_x17 * var_x29;
        const double var_x78 = 0.31576891781939609 * var_x77 - 0.093489896373056991 * var_x73 - 0.49683202072538851 * var_x74 - 2.0706890167875649 * var_x75 - 0.00015031321966819388 * var_x68 - 6.6941504319201117 * var_x76;
        const double var_x79 = 1 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x80 = 0.00050000000000000001 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x81 = 1 / var_x80;
        const double var_x82 = var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai / pow(var_x80, 2);
        ...
        const double var_x99 = 0.00021359213333547216 * var_x38 + 3.4618327348681446e-10 * var_x51 + 7.2724087660027779e-7 * var_x29 - 2.1531465053979051e-7 * var_chaste_interface__IKs__O1ks - 2.1531465053979051e-7 * var_chaste_interface__IKs__O2ks - 1.5417159680637438e-5 * var_x21 - 1.1442435714400293e-6 * var_chaste_interface__IKr__OHerg - 4.7689611318757119e-6 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - 3.4618327348681446e-10 * var_x54 - var_x39 * var_x98;
        const double var_x100 = 7.1159095070575419e-7 * var_x71;
        const double var_x101 = 1.9425621197603171e-5 * var_x77 - 0.00012738562343605624 * var_x75 - 3.0564346548418563e-5 * var_x74 - 9.2470395326765519e-9 * var_x68 - 5.7513555333045694e-6 * var_x73 - 0.00041181390311704753 * var_x76;
        ...
        const double var_x110 = 1.5379617895699322e-6 * var_x81;
        const double var_x111 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaNSR, 1.0);
        const double var_x112 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai, 1.2);
        const double var_x113 = 1 / (1.0 + 33855.471141425078 * var_x112 + 0.303951367781155 * var_x111);
        ...
        const double var_x116 = 2.532389241378596 * var_x112 - 9.6656534954407287e-5 * var_x111;
        const double var_x117 = var_x116 / pow((2.9537323401073989e-5 + var_x112 + 8.9779098483507565e-6 * var_x111), 2);
        ...
        const double var_x142 = exp(-0.41999999999999998 + 0.012 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x143 = 0.095846399999999998 * var_x142;
        const double var_x144 = var_x143 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C0;
        const double var_x145 = exp(1.4300000000000002 - 0.065000000000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x146 = 0.0057330000000000002 * var_x145;
        ...
        const double var_x149 = 7.9871999999999996 * var_x142;
        const double var_x150 = -var_x149;
        const double var_x151 = 0.088200000000000001 * var_x145;
        const double var_x152 = 0.011466 * var_x145;
        const double var_x153 = 0.071884799999999999 * var_x142;
        const double var_x154 = 0.11079599999999999 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1;
        const double var_x155 = 0.11079599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x156 = -var_x151;
        const double var_x157 = 5.9903999999999993 * var_x142;
        const double var_x158 = 0.1764 * var_x145;
        const double var_x159 = 0.017199000000000002 * var_x145;
        const double var_x160 = 0.047923199999999999 * var_x142;
        ...
        const double var_x165 = 3.9935999999999998 * var_x142;
        const double var_x166 = -var_x165;
        const double var_x167 = 0.2646 * var_x145;
        const double var_x168 = 0.022932000000000001 * var_x145 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C4;
        const double var_x169 = 0.0239616 * var_x142;
        ...
        const double var_x172 = 1.9967999999999999 * var_x142;
        const double var_x173 = 0.3528 * var_x145;
        ...
        const double var_x176 = 0.1916928 * var_x142 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa0;
        const double var_x177 = 0.0028665000000000001 * var_x145;
        const double var_x178 = 15.974399999999999 * var_x142;
        const double var_x179 = 0.0441 * var_x145;
        const double var_x180 = 0.1437696 * var_x142;
        const double var_x181 = 11.980799999999999 * var_x142;
        const double var_x182 = 0.0085995000000000012 * var_x145;
        const double var_x183 = 0.1323 * var_x145;
        const double var_x184 = var_x152 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa4;
        ...
        const double var_x187 = exp(-0.02019777813343069 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x188 = 0.0077904657073700001 * var_x187;
        const double var_x189 = exp(-0.18053804430634462 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x190 = 0.5 + var_x189;
        const double var_x191 = 0.0033633620945199998 / var_x190;
        ...
        const double var_x194 = exp(-0.00037301599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x195 = 1.8592012678400001e-5 * var_x194;
        const double var_x196 = exp(5.3739999999999997e-8 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x197 = 4.4038962679999997e-11 * var_x196;
        const double var_x198 = exp(0.028982999999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x199 = 0.063033155855999987 * var_x198;
        const double var_x200 = 0.00081948199999999996 * var_x196;
        const double var_x201 = 2.1748319999999999 * var_x198;
        const double var_x202 = 0.080185000000000006 * var_x192;
        const double var_x203 = 0.049842400000000002 * var_x194;
        const double var_x204 = 0.0075123241690000005 * var_x192;
        const double var_x205 = 2.7448243264023812e-6 * var_x194;
        const double var_x206 = 8.3392179730847992e-11 * var_x196;
        const double var_x207 = 0.047274866891999993 * var_x198;
        const double var_x208 = 0.0015517711151999999 * var_x196;
        const double var_x209 = 1.6311239999999998 * var_x198;
        const double var_x210 = 0.16037000000000001 * var_x192;
        const double var_x211 = 0.0073584627104531205 * var_x194;
        const double var_x212 = 0.011268486253500002 * var_x192;
        const double var_x213 = 1.190172890246627e-6 * var_x194;
        const double var_x214 = 6.2643871845094088e-10 * var_x196;
        const double var_x215 = 0.031516577927999993 * var_x198;
        const double var_x216 = 0.011656842546537791 * var_x196;
        const double var_x217 = 1.0874159999999999 * var_x198;
        const double var_x218 = 0.24055500000000002 * var_x192;
        const double var_x219 = 0.0031906751727717496 * var_x194;
        const double var_x220 = 6.466053749793811e-7 * var_x194;
        const double var_x221 = 0.015024648338000001 * var_x192;
        const double var_x222 = 6.9834511318773689e-9 * var_x196;
        const double var_x223 = 0.015758288963999997 * var_x198;
        const double var_x224 = 0.12994884875097448 * var_x196;
        const double var_x225 = 0.54370799999999997 * var_x198;
        const double var_x226 = 0.32074000000000003 * var_x192;
        const double var_x227 = 0.0017334521172801731 * var_x194;
        const double var_x228 = 3.5441967137821161e-8 * var_x194;
        const double var_x229 = 6.2947815902170839e-9 * var_x196;
        const double var_x230 = 0.11713400800552819 * var_x196;
        const double var_x231 = 9.5014602960251466e-5 * var_x194;
        const double var_x232 = 0.00198360904335657 * var_x192;
        const double var_x233 = 0.42695382052749886 * var_x198;
        const double var_x234 = 14.731181055359999 * var_x198;
        const double var_x235 = 0.042345268272074361 * var_x192;
        const double var_x236 = 0.0010000484785595239 * var_x192;
        const double var_x237 = 0.10902718902100607 * var_x198;
        const double var_x238 = 3.7617634137599998 * var_x198;
        const double var_x239 = 0.021348622729620501 * var_x192;
        const double var_x240 = 0.0010108205748447618 * var_x192;
        const double var_x241 = 0.058010926130094308 * var_x198;
        const double var_x242 = 2.0015500855706554 * var_x198;
        const double var_x243 = 0.021578581001175438 * var_x192;
        const double var_x244 = 0.016668393642939261 * var_x192;
        const double var_x245 = 0.2874951693560841 * var_x198;
        const double var_x246 = 9.9194413744637924 * var_x198;
        const double var_x247 = 0.35582999726621212 * var_x192;
        const double var_x248 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x249 = 0.056565877361888978 * var_x248 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C0Kv14;
        const double var_x250 = exp(-0.077933781739999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x251 = 0.00084304739027167303 * var_x250;
        const double var_x252 = 7.3600965821599997 * var_x248;
        const double var_x253 = 0.010817483399999999 * var_x250;
        const double var_x254 = 0.0016860947805433461 * var_x250;
        const double var_x255 = 0.042424408021416733 * var_x248;
        const double var_x256 = 5.5200724366199996 * var_x248;
        const double var_x257 = 0.021634966799999999 * var_x250;
        const double var_x258 = 0.0025291421708150191 * var_x250;
        const double var_x259 = 0.028282938680944489 * var_x248;
        const double var_x260 = 3.6800482910799999 * var_x248;
        const double var_x261 = 0.032452450199999996 * var_x250;
        const double var_x262 = 0.0033721895610866921 * var_x250 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
        const double var_x263 = 0.014141469340472244 * var_x248;
        const double var_x264 = 1.8400241455399999 * var_x248;
        const double var_x265 = 0.043269933599999998 * var_x250;
        const double var_x266 = 0.057102035392881494 * var_x248 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI0Kv14;
        const double var_x267 = 0.0016068735371190899 * var_x250;
        const double var_x268 = 7.4298590445392074 * var_x248;
        const double var_x269 = 0.020618446856331008 * var_x250;
        const double var_x270 = 5.0494790920257417e-5 * var_x250;
        const double var_x271 = 0.049212749503964481 * var_x248;
        const double var_x272 = 6.4033407827395079 * var_x248;
        const double var_x273 = 0.00064791916666788224 * var_x250;
        const double var_x274 = 4.7206750348744694e-5 * var_x250;
        const double var_x275 = 0.015434242075859545 * var_x248;
        const double var_x276 = 2.0082338973371909 * var_x248;
        const double var_x277 = 0.00060572898292340319 * var_x250;
        const double var_x278 = 5.7810813021376402e-5 * var_x250 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OIKv14;
        const double var_x279 = 0.04692272136005015 * var_x248;
        const double var_x280 = 6.1053726595326019 * var_x248;
        const double var_x281 = 0.00074179401705723523 * var_x250;
        const double var_x282 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x283 = 384756192.24456543 * var_x282 * var_chaste_interface__INa__na1;
        const double var_x284 = exp(-26.232056238852348 - 0.090161609404259865 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x285 = 767594485.71651864 * var_x284;
        const double var_x286 = exp(-23.156677820503301);
        const double var_x287 = 8513540195.0827656 * var_x286;
        const double var_x288 = 34054160780.331062 * var_x282;
        const double var_x289 = 8513540195.0827656 * var_x284;
        const double var_x290 = exp(-24.35183300086069);
        const double var_x291 = 8513540195.0827656 * var_x290;
        const double var_x292 = 1535188971.4330373 * var_x284;
        const double var_x293 = 288567144.18342406 * var_x282;
        const double var_x294 = 11922585210.267752 * var_x286;
        const double var_x295 = 25540620585.248295 * var_x282;
        const double var_x296 = 17027080390.165531 * var_x284;
        const double var_x297 = 6079249204.347868 * var_x290;
        const double var_x298 = 2302783457.1495562 * var_x284;
        const double var_x299 = 192378096.12228271 * var_x282;
        const double var_x300 = 16696701353.239271 * var_x286;
        const double var_x301 = 17027080390.165531 * var_x282;
        const double var_x302 = 25540620585.248295 * var_x284;
        const double var_x303 = 4340999166.2352047 * var_x290;
        const double var_x304 = 3070377942.8660746 * var_x284;
        const double var_x305 = 96189048.061141357 * var_x282;
        const double var_x306 = 23382498943.197018 * var_x286;
        const double var_x307 = 8513540195.0827656 * var_x282;
        const double var_x308 = 34054160780.331062 * var_x284;
        const double var_x309 = 3099769910.3661275 * var_x290;
        const double var_x310 = exp(-27.092641999412571 - 0.061469636400174388 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x311 = 523324220.27000725 * var_x310;
        const double var_x312 = exp(-26.358496255772213 - 0.068762962366201316 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x313 = 585416244.0376184 * var_x312 * var_chaste_interface__INa__na7;
        const double var_x314 = exp(-19.672905196314268 + 0.084272054104636354 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x315 = 717453519.94201112 * var_x314;
        const double var_x316 = exp(-16.535928437145476 + 0.1097131992444229 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x317 = 934047731.6985184 * var_x316;
        const double var_x318 = 32745465422.278648 * var_x286;
        const double var_x319 = 8513540195.0827656 * var_x314;
        const double var_x320 = 8513540195.0827656 * var_x316;
        const double var_x321 = 8513540195.0827656 * var_x310;
        const double var_x322 = 8513540195.0827656 * var_x312;
        const double var_x323 = 2213447441.3051791 * var_x290;
        const double var_x324 = exp(-39.744904705650839 + 0.0027019947965296331 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x325 = 23003541.30715951 * var_x324;
        const double var_x326 = exp(-20.6726464954126 + 0.011394696340402199 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x327 = 97009205.304776609 * var_x326;
        const double var_x328 = 8513540195.0827656 * exp(-26.650781465416159);
        const double var_x329 = 8513540195.0827656 * var_x326;
        const double var_x330 = 8513540195.0827656 * exp(-22.779658962607588);
        const double var_x331 = 8513540195.0827656 * var_x324;
        const double var_x332 = 538822673.3061657 * var_x282 * var_chaste_interface__INa__na8;
        const double var_x333 = 548114892.2335701 * var_x284;
        const double var_x334 = 47690340841.071007 * var_x282;
        const double var_x335 = 6079249204.347868 * var_x284;
        const double var_x336 = 1096229784.4671402 * var_x284;
        const double var_x337 = 404117004.97962433 * var_x282;
        const double var_x338 = 35767755630.803253 * var_x282;
        const double var_x339 = 12158498408.695736 * var_x284;
        const double var_x340 = 1644344676.7007101 * var_x284;
        const double var_x341 = 269411336.65308285 * var_x282;
        const double var_x342 = 23845170420.535503 * var_x282;
        const double var_x343 = 18237747613.043602 * var_x284;
        const double var_x344 = 2192459568.9342804 * var_x284;
        const double var_x345 = 134705668.32654142 * var_x282;
        const double var_x346 = 11922585210.267752 * var_x282;
        const double var_x347 = 24316996817.391472 * var_x284;
        const double var_x348 = exp(-38.483942906307405 - 0.14399668707161886 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x349 = 1225921583.3429821 * var_x348;
        const double var_x350 = exp(-21.949261959797553 + 0.030147161449011892 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x351 = 256659070.76381233 * var_x350;
        const double var_x352 = 8513540195.0827656 * var_x350;
        const double var_x353 = 8513540195.0827656 * var_x348;
        const double var_x354 = exp(0.033046080388350003 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x355 = 0.0030146436875758886 * var_x354 * var_chaste_interface__IKr__C1Herg;
        const double var_x356 = exp(-0.043060541639799998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x357 = 0.0090930200797394306 * var_x356 * var_chaste_interface__IKr__C2Herg;
        const double var_x358 = 0.091225454037165171 * var_x354;
        const double var_x359 = 0.21116826991639448 * var_x356;
        const double var_x360 = exp(-0.026913854983990002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x361 = 0.0001923883999223735 * var_x360;
        ...
        const double var_x364 = exp(0.026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x365 = 0.0028649222200750738 * var_x364;
        ...
        const double var_x368 = var_x360 * var_x362 * var_x366 / (var_x364 * var_x367);
        const double var_x369 = 1.7628212752661065e-7 * var_x368;
        const double var_x370 = 0.00042769471831999382 * var_x362;
        const double var_x371 = 0.10945626585855089 * var_x364;
        const double var_x372 = 0.0071483033566472664 * var_x360;
        const double var_x373 = 1.6926962184371784e-6 * var_x368;
        const double var_x374 = 0.0015600678590465679 * var_x366;
        const double var_x375 = 0.0032282621593045179 * var_x367;
        ...
        const double var_x384 = exp(-0.014256681268810001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x385 = 5.4138036083884682e-5 * var_x384 * var_chaste_interface__IKs__O2ks;
        const double var_x386 = exp(0.08662945914655 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x387 = 0.00066466830499978399 * var_x386;
        const double var_x388 = 0.00767254363063 * var_x386;
        const double var_x389 = 0.0037973799836799999 * var_x384;
        ...
        IJth(rJacobian, 13, 0) = -var_x144 - var_x146 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1;
        IJth(rJacobian, 14, 0) = var_x144 + (var_x146 - var_x153) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1 - var_x152 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2;
        IJth(rJacobian, 15, 0) = var_x153 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1 + (var_x152 + var_x161) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2 - var_x159 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        IJth(rJacobian, 16, 0) = -var_x168 + var_x160 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2 + (var_x159 - var_x169) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        IJth(rJacobian, 17, 0) = var_x168 + var_x169 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        IJth(rJacobian, 18, 0) = -var_x176 - var_x177 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa1;
        IJth(rJacobian, 19, 0) = var_x176 + (var_x177 - var_x180) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa1 - var_x146 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa2;
        IJth(rJacobian, 20, 0) = var_x180 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa1 + (var_x146 - var_x143) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa2 - var_x182 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa3;
        IJth(rJacobian, 21, 0) = -var_x184 + var_x143 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa2 + (var_x161 + var_x182) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa3;
        IJth(rJacobian, 22, 0) = var_x184 + var_x160 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__CCa3;
        IJth(rJacobian, 24, 0) = (-0.00015735009791355945 * var_x187 + 0.00060721481483873177 * var_x189 / pow(var_x190, 2)) * (0.18000000000000005 - var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa + 0.81999999999999995 / var_x186) - 0.10512820512820513 * var_x185 * (var_x188 + var_x191) / pow(var_x186, 2);
        IJth(rJacobian, 25, 0) = (-var_x197 - var_x199) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 - var_x193 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 - var_x195 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43;
        IJth(rJacobian, 26, 0) = var_x199 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 + (var_x193 - var_x206 - var_x207) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 - var_x204 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 - var_x205 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43;
        IJth(rJacobian, 27, 0) = var_x207 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 + (var_x204 - var_x214 - var_x215) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 - var_x212 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 - var_x213 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43;
        IJth(rJacobian, 28, 0) = var_x215 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 + (var_x212 - var_x222 - var_x223) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 - var_x220 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43 - var_x221 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43;
        IJth(rJacobian, 29, 0) = var_x223 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 + (var_x221 - var_x229) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - var_x228 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OIKv43;
        IJth(rJacobian, 30, 0) = var_x197 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C0Kv43 + (var_x195 - var_x233) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 - var_x232 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43;
        IJth(rJacobian, 31, 0) = var_x206 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C1Kv43 + var_x233 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI0Kv43 + (var_x205 + var_x232 - var_x237) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 - var_x236 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43;
        IJth(rJacobian, 32, 0) = var_x214 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C2Kv43 + var_x237 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI1Kv43 + (var_x213 + var_x236 - var_x241) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43 - var_x240 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43;
        IJth(rJacobian, 33, 0) = var_x222 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__C3Kv43 + var_x241 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI2Kv43 + (var_x220 + var_x240 - var_x245) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43 - var_x244 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OIKv43;
        IJth(rJacobian, 34, 0) = var_x229 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 + var_x245 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__CI3Kv43 + (var_x228 + var_x244) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OIKv43;
        IJth(rJacobian, 35, 0) = -var_x249 - var_x251 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C1Kv14;
        IJth(rJacobian, 36, 0) = var_x249 + (var_x251 - var_x255) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C1Kv14 - var_x254 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C2Kv14;
        IJth(rJacobian, 37, 0) = var_x255 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C1Kv14 + (var_x254 - var_x259) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C2Kv14 - var_x258 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C3Kv14;
        IJth(rJacobian, 38, 0) = -var_x262 + var_x259 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C2Kv14 + (var_x258 - var_x263) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C3Kv14;
        IJth(rJacobian, 39, 0) = var_x262 + var_x263 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__C3Kv14;
        IJth(rJacobian, 40, 0) = -var_x266 - var_x267 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI1Kv14;
        IJth(rJacobian, 41, 0) = var_x266 + (var_x267 - var_x271) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI1Kv14 - var_x270 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI2Kv14;
        IJth(rJacobian, 42, 0) = var_x271 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI1Kv14 + (var_x270 - var_x275) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI2Kv14 - var_x274 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI3Kv14;
        IJth(rJacobian, 43, 0) = -var_x278 + var_x275 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI2Kv14 + (var_x274 - var_x279) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI3Kv14;
        IJth(rJacobian, 44, 0) = var_x278 + var_x279 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__CI3Kv14;
        IJth(rJacobian, 45, 0) = -var_x283 - var_x285 * var_chaste_interface__INa__na2;
        IJth(rJacobian, 46, 0) = var_x283 + (var_x285 - var_x293) * var_chaste_interface__INa__na2 - var_x292 * var_chaste_interface__INa__na3;
        IJth(rJacobian, 47, 0) = var_x293 * var_chaste_interface__INa__na2 + (var_x292 - var_x299) * var_chaste_interface__INa__na3 - var_x298 * var_chaste_interface__INa__na4;
        IJth(rJacobian, 48, 0) = var_x299 * var_chaste_interface__INa__na3 + (var_x298 - var_x305) * var_chaste_interface__INa__na4 - var_x304 * var_chaste_interface__INa__na5;
        IJth(rJacobian, 49, 0) = -var_x313 + var_x305 * var_chaste_interface__INa__na4 + (var_x304 - var_x315 - var_x317) * var_chaste_interface__INa__na5 - var_x311 * var_chaste_interface__INa__na6;
        IJth(rJacobian, 50, 0) = var_x317 * var_chaste_interface__INa__na5 + var_x325 * var_chaste_interface__INa__na13 + (var_x311 - var_x327) * var_chaste_interface__INa__na6;
        IJth(rJacobian, 51, 0) = var_x313 + var_x315 * var_chaste_interface__INa__na5;
        IJth(rJacobian, 52, 0) = -var_x332 - var_x333 * var_chaste_interface__INa__na9;
        IJth(rJacobian, 53, 0) = var_x332 + (var_x333 - var_x337) * var_chaste_interface__INa__na9 - var_x336 * var_chaste_interface__INa__na10;
        IJth(rJacobian, 54, 0) = var_x337 * var_chaste_interface__INa__na9 + (var_x336 - var_x341) * var_chaste_interface__INa__na10 - var_x340 * var_chaste_interface__INa__na11;
        IJth(rJacobian, 55, 0) = var_x341 * var_chaste_interface__INa__na10 + (var_x340 - var_x345) * var_chaste_interface__INa__na11 - var_x344 * var_chaste_interface__INa__na12;
        IJth(rJacobian, 56, 0) = var_x345 * var_chaste_interface__INa__na11 + (var_x344 - var_x351) * var_chaste_interface__INa__na12 - var_x349 * var_chaste_interface__INa__na13;
        IJth(rJacobian, 57, 0) = var_x327 * var_chaste_interface__INa__na6 + var_x351 * var_chaste_interface__INa__na12 + (var_x349 - var_x325) * var_chaste_interface__INa__na13;
        IJth(rJacobian, 58, 0) = -var_x355 - var_x357;
        IJth(rJacobian, 59, 0) = var_x355 + var_x357;
        IJth(rJacobian, 60, 0) = (-var_x363 - var_x365) * var_chaste_interface__IKr__C3Herg - var_x361 * var_chaste_interface__IKr__OHerg - var_x369 * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 61, 0) = var_x365 * var_chaste_interface__IKr__C3Herg + (var_x361 - var_x375) * var_chaste_interface__IKr__OHerg - var_x374 * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 62, 0) = var_x363 * var_chaste_interface__IKr__C3Herg + var_x375 * var_chaste_interface__IKr__OHerg + (var_x369 + var_x374) * var_chaste_interface__IKr__IHerg;
        IJth(rJacobian, 63, 0) = -var_x379;
        IJth(rJacobian, 64, 0) = var_x379 - var_x382 * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 65, 0) = -var_x385 + (var_x382 - var_x387) * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 66, 0) = var_x385 + var_x387 * var_chaste_interface__IKs__O1ks;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-1504.3859896373056 * var_x67 - 0.029113605067047261 * var_x70 - 0.0011841518182889234 * var_x69 - 3.006264393363878e-6 * var_x68 - 0.026711398963730568 * var_x32);
        IJth(rJacobian, 1, 1) = -1.8494079065353104e-10 * var_x68 - 5.3730734579697901e-6 * var_x70 - 0.092547526753060952 * var_x67 - 1.6432444380870198e-6 * var_x32 - 2.1854162994937459e-7 * var_x69;
        IJth(rJacobian, 2, 1) = 3.58204897197986e-6 * var_x70;
        IJth(rJacobian, 3, 1) = 7.2847209983124865e-8 * var_x108 * var_x69;
        ...
        IJth(rJacobian, 14, 14) = var_x156 - var_x155 - var_x157;
        IJth(rJacobian, 15, 14) = var_x157;
        IJth(rJacobian, 19, 14) = var_x155;
        ...
        IJth(rJacobian, 20, 20) = -0.00062500000000000001 + var_x150 + var_x156;
        ...
        IJth(rJacobian, 24, 24) = -var_x188 - var_x191;
        IJth(rJacobian, 25, 25) = -var_x200 - var_x201;
        IJth(rJacobian, 26, 25) = var_x201;
        IJth(rJacobian, 30, 25) = var_x200;
        ...
        IJth(rJacobian, 50, 49) = var_x320;
        IJth(rJacobian, 51, 49) = var_x319;
        ...
        IJth(rJacobian, 61, 60) = var_x371;
        IJth(rJacobian, 62, 60) = var_x370;
