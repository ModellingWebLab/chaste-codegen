...
AbstractCvodeCell* Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::CreateMethod(std::shared_ptr<AbstractIvpOdeSolver> p_solver, std::shared_ptr<AbstractStimulusFunction> p_stimulus) {
...
bool Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::registered = ModelFactory::Register("dynamic_Shannon2004", "AnalyticCvode", (ModelFactory::TCreateMethod)Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::CreateMethod);
    ...
    std::shared_ptr<RegularStimulus> Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode(std::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, std::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                45,
                0,
    ...
    void Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x88 = 1 + 0.1245 * var_x85 + 0.036499999999999998 * var_x87 * (-0.14285714285714285 + 0.14285714285714285 * var_x86);
        ...
        const double var_x93 = var_x81 * pow(var_x92, 4);
        ...
        const double var_x107 = 1 - 0.10000000000000001 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL - 0.90000000000000002 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        ...
        const double var_x117 = exp(2 * var_x44);
        ...
        const double var_x193 = pow(var_chaste_interface__Na_buffer__Na_SL, 2);
        ...
        const double var_x207 = pow(var_chaste_interface__Na_buffer__Na_jct, 2);
        ...
        const double var_x224 = 0.00011182849999999999 * var_x2 * var_x24 + 0.061380000000000011 * var_x141 * var_x180 + 5.0104537825247566e-7 * var_x2 * var_x222 * var_x223 / pow((1 + 5.2281977629563632e-6 * var_x223), 2);
        ...
        const double var_x229 = 1.38215e-5 * var_x0 * var_x24 + 0.55242000000000002 * var_x117 * var_x129 * var_chaste_interface__cell__V + 6.1926956862665531e-8 * var_x0 * var_x222 * var_x228 / pow((1 + 5.2281977629563632e-6 * var_x228), 2);
        ...
        const double var_x237 = 1 / (1 + var_x235 + 2814485.1633595936 * var_x236);
        ...
        const double var_x250 = 0.23799999999999999 + 34 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x251 = 13.800000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x252 = 0.059999999999999998 + 100 * var_chaste_interface__Ca_buffer__Cai;
        ...
        const double var_x327 = 1 / (0.5 + 9 * var_x326);
        ...
        const double var_x364 = 1 + 0.13584112963311223 * var_x363;
        const double var_x365 = 1 / var_x364;
        const double var_x366 = 7.5 - 7 * var_x365;
        ...
        const double var_x434 = -2.5024999999999999 + 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL;
        const double var_x435 = -2.5490196078431375 + 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        ...
        const double var_x442 = -2.5024999999999999 + 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL;
        const double var_x443 = -2.5490196078431375 + 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        ...
        IJth(rJacobian, 24, 24) = -260 + var_x406 - var_x408 - 1.6231539579137989e-12 * var_x247 - 12.857532841472388 * var_x246;
