...
#include "MathsCustomFunctions.hpp"
    ...
    void DynamicShannon2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x41 = pow(var_chaste_interface__Na_buffer__Na_jct, 3);
        ...
        const double var_x45 = pow(NV_Ith_S(mParameters, 6), 3);
        ...
        const double var_x50 = pow(var_x2, 3);
        const double var_x51 = 1.0 + 1.6777215999999998e-11 * var_x50;
        const double var_x52 = 1 / var_x51;
        const double var_x53 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_jct) * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x54 = 1.0 + 0.00053869674493876331 * var_x41;
        const double var_x55 = 0.0035899999999999999 * var_x45;
        const double var_x56 = 1 / (var_x42 + var_x46 + 669921.875 * var_x53 + 1.3 * var_x41 + var_x54 * var_x55);
        const double var_x57 = var_x52 * var_x56;
        const double var_x58 = var_x49 * var_x57;
        const double var_x59 = var_x58 * (0.013102086455787599 * var_x43 + 0.024332446275034118 * var_x47);
        const double var_x60 = pow(var_chaste_interface__Na_buffer__Na_SL, 3);
        const double var_x61 = var_x60 * NV_Ith_S(mParameters, 4);
        const double var_x62 = var_x40 * var_x61;
        const double var_x63 = var_x45 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x64 = var_x44 * var_x63;
        const double var_x65 = pow(var_x4, 3);
        const double var_x66 = 1.0 + 1.6777215999999998e-11 * var_x65;
        const double var_x67 = 1 / var_x66;
        const double var_x68 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_SL) * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x69 = 1.0 + 0.00053869674493876331 * var_x60;
        const double var_x70 = 1 / (var_x61 + var_x63 + 669921.875 * var_x68 + 1.3 * var_x60 + var_x55 * var_x69);
        const double var_x71 = var_x67 * var_x70;
        const double var_x72 = var_x49 * var_x71;
        const double var_x73 = var_x72 * (0.013102086455787599 * var_x62 + 0.024332446275034118 * var_x64);
        const double var_x74 = 1 / var_chaste_interface__Na_buffer__Na_jct;
        const double var_x75 = pow(var_x74, 4);
        const double var_x76 = exp(-0.0037434532730821718 * var_chaste_interface__cell__V);
        const double var_x77 = exp(0.01485884101040119 * NV_Ith_S(mParameters, 6));
        const double var_x78 = 0.037434532730821715 * var_chaste_interface__cell__V;
        const double var_x79 = exp(-var_x78);
        const double var_x80 = 1.0 + 0.1245 * var_x76 + 0.036499999999999998 * var_x79 * (-0.14285714285714285 + 0.14285714285714285 * var_x77);
        const double var_x81 = NV_Ith_S(mParameters, 5) / (1.5 + NV_Ith_S(mParameters, 5));
        const double var_x82 = var_x81 * (0.00046605993249873042 * var_x76 + 0.037434532730821715 * var_x79 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x77)) / pow(var_x80, 2);
        const double var_x83 = var_x82 / (1.0 + 14641.0 * var_x75);
        const double var_x84 = 1 / var_chaste_interface__Na_buffer__Na_SL;
        const double var_x85 = pow(var_x84, 4);
        const double var_x86 = var_x82 / (1.0 + 14641.0 * var_x85);
        const double var_x87 = 1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        const double var_x88 = var_x87 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x89 = -0.75 * NV_Ith_S(mParameters, 6);
        const double var_x90 = exp(var_x78);
        const double var_x91 = 0.75 * var_x90;
        const double var_x92 = var_x89 + var_x91 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x93 = -1.0 + var_x90;
        const double var_x94 = 1 / var_x93;
        const double var_x95 = var_x94 * var_chaste_interface__ICaL_f_gate__f;
        const double var_x96 = var_x92 * var_x95;
        const double var_x97 = 2.1942115659989999e-5 * var_x96;
        const double var_x98 = -0.75 * NV_Ith_S(mParameters, 5) + var_x91 * NV_Ith_S(mParameters, 3);
        const double var_x99 = var_x95 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x100 = var_x98 * var_x99;
        const double var_x101 = 1.0 - 0.10000000000000001 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL - 0.90000000000000002 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        const double var_x102 = 0.00043884231319980002 * var_x101;
        const double var_x103 = 1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL;
        const double var_x104 = var_x89 + var_x91 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x105 = var_x103 * var_x104;
        const double var_x106 = 2.4380128511099999e-6 * var_x105;
        const double var_x107 = var_x10 * var_x30;
        const double var_x108 = var_x43 - var_x47;
        const double var_x109 = var_x44 * NV_Ith_S(mParameters, 11) / pow(var_x48, 2);
        const double var_x110 = var_x108 * var_x109 * var_x57;
        const double var_x111 = exp(0.07486906546164343 * var_chaste_interface__cell__V);
        const double var_x112 = -1.0 + var_x111;
        const double var_x113 = NV_Ith_S(mParameters, 7) / var_x112;
        const double var_x114 = var_chaste_interface__ICaL_d_gate__d * var_chaste_interface__ICaL_f_gate__f;
        const double var_x115 = var_x113 * var_x114;
        const double var_x116 = -0.34100000000000003 * NV_Ith_S(mParameters, 4);
        const double var_x117 = 0.34100000000000003 * var_x111;
        const double var_x118 = var_x116 + var_x117 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x119 = var_x103 * var_x118;
        const double var_x120 = 650.13676029600003 * var_x119;
        const double var_x121 = var_x116 + var_x117 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x122 = 5851.2308426640002 * var_x121;
        const double var_x123 = var_x113 * var_chaste_interface__ICaL_f_gate__f;
        const double var_x124 = var_x123 * var_x88;
        const double var_x125 = var_x62 - var_x64;
        const double var_x126 = var_x109 * var_x125 * var_x71;
        const double var_x127 = var_x88 * var_x92;
        const double var_x128 = var_chaste_interface__ICaL_f_gate__f * var_chaste_interface__cell__V;
        const double var_x129 = var_x90 / pow(var_x93, 2);
        const double var_x130 = var_x127 * var_x128 * var_x129;
        const double var_x131 = var_x114 * var_chaste_interface__cell__V;
        const double var_x132 = var_x129 * var_x131;
        const double var_x133 = var_x105 * var_x132;
        const double var_x134 = var_x95 * var_chaste_interface__cell__V;
        const double var_x135 = var_x134 * var_x88 * var_x90;
        const double var_x136 = var_x135 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x137 = var_x99 * var_chaste_interface__cell__V;
        const double var_x138 = var_x137 * var_x90;
        const double var_x139 = var_x103 * var_x138;
        const double var_x140 = var_x139 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x141 = var_x111 * NV_Ith_S(mParameters, 7) / pow(var_x112, 2);
        const double var_x142 = var_x119 * var_x131 * var_x141;
        const double var_x143 = var_x121 * var_x128 * var_x141 * var_x88;
        const double var_x144 = var_x115 * var_chaste_interface__cell__V;
        const double var_x145 = var_x103 * var_x111 * var_x144;
        const double var_x146 = var_x145 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x147 = var_x111 * var_x124 * var_chaste_interface__cell__V;
        const double var_x148 = var_x147 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x149 = -26.713302585894176 * log(var_x74 * NV_Ith_S(mParameters, 6)) + var_chaste_interface__cell__V;
        const double var_x150 = 0.11 * var_x149;
        const double var_x151 = -26.713302585894176 * log(var_x84 * NV_Ith_S(mParameters, 6)) + var_chaste_interface__cell__V;
        const double var_x152 = 0.89000000000000001 * var_x151;
        const double var_x153 = NV_Ith_S(mParameters, 8) * var_chaste_interface__INa_h_gate__h;
        const double var_x154 = var_x153 * var_x36;
        const double var_x155 = var_x153 * pow(var_chaste_interface__INa_m_gate__m, 2) * var_chaste_interface__INa_j_gate__j;
        const double var_x156 = var_x149 * var_x155;
        const double var_x157 = var_x151 * var_x155;
        const double var_x158 = 1 / (0.018329999999999999 * var_chaste_interface__Na_buffer__Nai + NV_Ith_S(mParameters, 3));
        const double var_x159 = -26.713302585894176 * log(var_x158 * (0.018329999999999999 * NV_Ith_S(mParameters, 6) + NV_Ith_S(mParameters, 5))) + var_chaste_interface__cell__V;
        const double var_x160 = var_x159 * var_chaste_interface__IKs_Xs_gate__Xs * NV_Ith_S(mParameters, 10);
        const double var_x161 = NV_Ith_S(mParameters, 12) * var_chaste_interface__Itos_X_gate__X_tos;
        const double var_x162 = 0.53426605171788355 * var_x8 - 0.02 * var_chaste_interface__cell__V;
        const double var_x163 = var_x97 * var_chaste_interface__cell__V;
        const double var_x164 = var_x102 * var_x98;
        const double var_x165 = var_x123 * var_chaste_interface__cell__V;
        const double var_x166 = var_x165 * var_x87;
        const double var_x167 = var_x94 * var_chaste_interface__cell__V;
        const double var_x168 = var_x127 * var_x167;
        const double var_x169 = var_x167 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x170 = var_x113 * var_chaste_interface__cell__V;
        const double var_x171 = var_x170 * var_chaste_interface__ICaL_d_gate__d;
        const double var_x172 = var_x170 * var_x88;
        const double var_x173 = var_x100 * var_chaste_interface__cell__V;
        const double var_x174 = var_x104 * var_x137;
        const double var_x175 = var_x118 * var_x144;
        const double var_x176 = var_x38 * var_x84;
        const double var_x177 = pow(var_chaste_interface__Na_buffer__Na_SL, 2);
        const double var_x178 = 3.0 * NV_Ith_S(mParameters, 4);
        const double var_x179 = 5.8017639429904805e-6 * var_x45;
        const double var_x180 = -3.9000000000000004 * var_x177 - var_x177 * var_x178 - var_x177 * var_x179;
        const double var_x181 = 5.3588338192419823e-9 * var_x45;
        const double var_x182 = var_x125 * var_x49;
        const double var_x183 = var_x182 * var_x67 / pow((var_x68 + 1.9405247813411081e-6 * var_x60 + 1.4927113702623908e-6 * var_x61 + 1.4927113702623908e-6 * var_x63 + var_x181 * var_x69), 2);
        const double var_x184 = 1.9830866390704556e-12 * var_x183;
        const double var_x185 = var_x81 / var_x80;
        const double var_x186 = var_x185 * var_x84 * var_x85 / pow((6.8301345536507063e-5 + var_x85), 2);
        const double var_x187 = var_x40 * NV_Ith_S(mParameters, 4);
        const double var_x188 = var_x177 * var_x187 * var_x72;
        const double var_x189 = var_x38 * var_x74;
        const double var_x190 = pow(var_chaste_interface__Na_buffer__Na_jct, 2);
        const double var_x191 = -3.9000000000000004 * var_x190 - var_x178 * var_x190 - var_x179 * var_x190;
        const double var_x192 = var_x108 * var_x49;
        const double var_x193 = var_x192 * var_x52 / pow((var_x53 + 1.9405247813411081e-6 * var_x41 + 1.4927113702623908e-6 * var_x42 + 1.4927113702623908e-6 * var_x46 + var_x181 * var_x54), 2);
        const double var_x194 = 2.4510059584016866e-13 * var_x193;
        const double var_x195 = var_x185 * var_x74 * var_x75 / pow((6.8301345536507063e-5 + var_x75), 2);
        const double var_x196 = var_x187 * var_x190 * var_x58;
        const double var_x197 = -6.7429956354615204 - 0.109625 * var_chaste_interface__cell__V;
        ...
        const double var_x205 = var_x182 * var_x4 * var_x65 * var_x70 / pow(var_x66, 2);
        const double var_x206 = pow(var_x2, 1.6000000000000001);
        const double var_x207 = var_x2 * var_x206 / pow((1.0 + 5.2281977629563632e-6 * var_x206), 2);
        const double var_x208 = var_x200 * var_x58;
        const double var_x209 = var_x202 - 373215529.24791086 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x210 = var_x192 * var_x2 * var_x50 * var_x56 / pow(var_x51, 2);
        const double var_x211 = 34.0 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Calmodulin;
        const double var_x212 = 100.0 * var_chaste_interface__cytosolic_Ca_buffer__Ca_SRB;
        const double var_x213 = 32.700000000000003 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC;
        const double var_x214 = 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC_Ca_Mg;
        const double var_x215 = 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_TroponinC_Ca_Mg;
        const double var_x216 = 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Myosin;
        const double var_x217 = 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_Myosin;
        const double var_x218 = pow(var_chaste_interface__Ca_buffer__Cai, 0.78699999999999992);
        const double var_x219 = pow(var_chaste_interface__Ca_buffer__Ca_SR, 1.7869999999999999);
        const double var_x220 = 0.38742512113256738 * var_x219;
        const double var_x221 = pow(var_chaste_interface__Ca_buffer__Cai, 1.7869999999999999);
        const double var_x222 = 2814485.1633595936 * var_x221;
        const double var_x223 = NV_Ith_S(mParameters, 2) / (1.0 + var_x220 + var_x222);
        const double var_x224 = var_x218 * var_x223;
        const double var_x225 = (var_x222 - var_x220) * NV_Ith_S(mParameters, 2) / pow((3.5530476870814998e-7 + var_x221 + 1.3765399305573384e-7 * var_x219), 2);
        const double var_x226 = var_x218 * var_x225;
        const double var_x227 = pow(var_chaste_interface__Ca_buffer__Ca_SR, 0.78699999999999992);
        const double var_x228 = var_x223 * var_x227;
        const double var_x229 = var_x225 * var_x227;
        const double var_x230 = 32.700000000000003 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x231 = 2.3700000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x232 = 34.0 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x233 = 13.800000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x234 = 100.0 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x235 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x236 = var_chaste_interface__cell__V < -40.0;
        ...
        const double var_x239 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V);
        ...
        const double var_x249 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x250 = 1.0 + var_x249;
        const double var_x251 = exp(-0.01052 * var_chaste_interface__cell__V);
        const double var_x252 = var_x251 / var_x250;
        const double var_x253 = -0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x254 = exp(-3.2000000000000002 + var_x253);
        const double var_x255 = 1.0 + var_x254;
        const double var_x256 = exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V);
        const double var_x257 = var_x256 / var_x255;
        const double var_x258 = 1.0 - var_chaste_interface__INa_m_gate__m;
        const double var_x259 = exp(-4.7130000000000001 + var_x253);
        const double var_x260 = 1.0 - var_x259;
        const double var_x261 = 0.32000000000000001 / var_x260;
        const double var_x262 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x263 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x264 = exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x265 = 1.0 + var_x264;
        const double var_x266 = exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V);
        const double var_x267 = -1.0 + var_x266;
        const double var_x268 = 0.00060999999999999997 / var_x267;
        const double var_x269 = exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V);
        const double var_x270 = 1.0 - var_x269;
        const double var_x271 = 0.0013799999999999999 / var_x270;
        const double var_x272 = 7.0 + var_chaste_interface__cell__V;
        const double var_x273 = 10.0 + var_chaste_interface__cell__V;
        const double var_x274 = var_x268 * var_x273;
        const double var_x275 = var_x271 * var_x272;
        const double var_x276 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        const double var_x277 = 1.0 + var_x276;
        const double var_x278 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V);
        ...
        const double var_x286 = var_x283 * var_x284;
        const double var_x287 = 0.066666666666666666 * var_chaste_interface__cell__V;
        const double var_x288 = exp(0.20000000000000001 + var_x287);
        const double var_x289 = 1.0 + var_x288;
        const double var_x290 = 1 / var_x289;
        const double var_x291 = 1 / (0.5 + 9.0 * var_x290);
        const double var_x292 = exp(-0.20000000000000001 - var_x287);
        const double var_x293 = 1.0 + var_x292;
        const double var_x294 = 0.066666666666666666 * var_x292 / pow(var_x293, 2);
        const double var_x295 = 1 / var_x293;
        const double var_x296 = 0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x297 = exp(6.0 + var_x296);
        const double var_x298 = 1.0 + var_x297;
        const double var_x299 = 1 / var_x298;
        const double var_x300 = 1 / (30.0 + 3000.0 * var_x299);
        const double var_x301 = exp(3.3500000000000001 + var_x296);
        const double var_x302 = 1.0 + var_x301;
        const double var_x303 = var_x301 / pow(var_x302, 2);
        const double var_x304 = 0.10000000000000001 * var_x303;
        const double var_x305 = 1 / var_x302;
        const double var_x306 = var_x305;
        const double var_x307 = var_x297 / pow(var_x298, 2);
        const double var_x308 = 1 / (220.0 + 2800.0 * var_x299);
        ...
        const double var_x317 = -var_chaste_interface__ICaL_d_gate__d + var_x316;
        ...
        const double var_x322 = 0.0058333333333333336 * var_x312;
        const double var_x323 = var_x320 * var_x322;
        const double var_x324 = 1 + 0.068965517241379309 * var_chaste_interface__cell__V;
        const double var_x325 = exp(-0.23877882250000002 * pow(var_x324, 2));
        const double var_x326 = 0.019699999999999999 * var_x325;
        const double var_x327 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x328 = 1.0 + var_x327;
        const double var_x329 = exp(9.7388888888888889 + 0.27777777777777779 * var_chaste_interface__cell__V);
        const double var_x330 = 1.0 + var_x329;
        const double var_x331 = 1 / var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x332 = pow(var_x331, 2.5);
        const double var_x333 = 1.0 + 0.13584112963311223 * var_x332;
        const double var_x334 = 1 / var_x333;
        const double var_x335 = 7.0 * var_x334;
        const double var_x336 = -7.5 + var_x335;
        const double var_x337 = var_x336 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x338 = 1 / (15.0 - 14.0 * var_x334);
        const double var_x339 = pow(var_chaste_interface__Ca_buffer__Ca_jct, 2);
        const double var_x340 = 10.0 * var_x338 * var_x339;
        const double var_x341 = -var_x340;
        const double var_x342 = var_x331 * var_x332 / pow(var_x333, 2);
        const double var_x343 = var_x342 * var_chaste_interface__Jrel_SR__R;
        const double var_x344 = 2.3772197685794643 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x345 = 0.21130842387373014 * var_x339 / pow((1 - 0.93333333333333335 * var_x334), 2);
        const double var_x346 = var_x343 * var_x345;
        const double var_x347 = 20.0 * var_x338 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x348 = var_x347 * var_chaste_interface__Jrel_SR__R;
        const double var_x349 = 7.5 - var_x335;
        const double var_x350 = var_x342 * var_x344 * var_chaste_interface__Jrel_SR__O;
        const double var_x351 = 1.0 - var_chaste_interface__Jrel_SR__I - var_chaste_interface__Jrel_SR__O - var_chaste_interface__Jrel_SR__R;
        const double var_x352 = 5.2861839130367859e-9 * var_x105;
        const double var_x353 = 0.0019297288283204664 * var_x151;
        const double var_x354 = 0.0001 * var_chaste_interface__Na_buffer__Na_SL_buf;
        const double var_x355 = 1.2899391426308094e-14 * var_x183;
        const double var_x356 = 0.0001 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x357 = 1.7653304347803737e-6 * var_x96;
        const double var_x358 = 0.0088499373002543739 * var_x149;
        const double var_x359 = var_x357 * var_chaste_interface__cell__V;
        const double var_x360 = 0.0001 * var_chaste_interface__Na_buffer__Na_jct_buf;
        const double var_x361 = 5.9157951966558558e-14 * var_x193;
        ...
        const double var_x364 = 18.571428571428569 * NV_Ith_S(mParameters, 0);
        const double var_x365 = var_chaste_interface__Jrel_SR__O * NV_Ith_S(mParameters, 1);
        const double var_x366 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x367 = 0.70482452173823817 * var_x119;
        const double var_x368 = 4.2997971421026984e-15 * var_x183;
        ...
        const double var_x372 = 235.37739130404984 * var_x121;
        const double var_x373 = 1.9719317322186186e-14 * var_x193;
        const double var_x374 = 1205.9369202226344 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x381 = -var_x231;
        const double var_x382 = -var_x233;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0095482999999999991 + 8.2139284685737138e-7 * var_x130 + 48.675131665622011 * var_x142 + 9.1265871873041266e-8 * var_x133 + 438.07618499059811 * var_x143 - 0.001 / var_x1 - 0.11 * var_x15 - 0.11 * var_x59 - 0.89000000000000001 * var_x19 - 0.89000000000000001 * var_x73 - 1.0 * var_x38 - 6.1604463514302854e-7 * var_x136 - 0.01205875 / var_x3 - 0.2097909 * var_x83 - 1.6973990999999999 * var_x86 - 16.598219897977106 * var_x146 - 149.38397908179397 * var_x148 - 0.00072267365436851333 * var_x110 - 6.8449403904780953e-8 * var_x140 - 0.0058470868398906983 * var_x126 - 0.097566250000000007 / var_x5 + var_x7 * var_chaste_interface__Itos_X_gate__X_tos - var_x100 * var_x102 - var_x106 * var_x99 - var_x115 * var_x120 - var_x122 * var_x124 - var_x32 * var_x35 - var_x88 * var_x97 - 0.02 * var_chaste_interface__Itof_X_gate__X_tof * var_chaste_interface__Itof_Y_gate__Y_tof - 0.39504430131315654 * var_x22 * var_x31 + 0.09421806586318783 * var_x10 * var_x31 * var_x39 + 1.6427856937147429e-5 * var_x101 * var_x132 * var_x98 - 0.00016722408026755852 * var_x0 * var_x10 / pow(var_x1, 2) - 1.2320892702860571e-5 * var_x101 * var_x138 * NV_Ith_S(mParameters, 3) + 0.019211226915711394 * var_x10 * var_x32 * var_x33 / pow(var_x34, 2) - 0.37970424962817811 * var_x107 * var_x22 * (0.24326999999999999 * var_x39 - var_x25 * (0.061749999999999999 * var_x26 + 0.039456396800000001 * var_x27) - 0.51429999999999998 * var_x23 * var_x28 / pow(var_x24, 2)) / pow((var_x22 + 0.98039215686274506 * var_x29), 2));
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__INa_h_gate__h) * ((var_x236) ? (-0.019852941176470591 * var_x235) : (0)) - ((var_x236) ? (0.28123999999999999 * var_x237 + 108500.0 * var_x238) : (0.693000693000693 * var_x239 / pow(var_x240, 2))) * var_chaste_interface__INa_h_gate__h;
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__INa_j_gate__j) * ((var_x236) ? (var_x247 + var_x246 * var_x248 * (1.5254334000000001e-6 * var_x242 - 31073.016 * var_x241) - 0.311 * var_x243 * var_x244 * var_x248 / pow(var_x245, 2)) : (0)) - ((var_x236) ? (-0.001275024 * var_x252 + 0.016701360000000002 * var_x249 * var_x251 / pow(var_x250, 2)) : (-7.6049999999999996e-8 * var_x257 + 0.029999999999999999 * var_x254 * var_x256 / pow(var_x255, 2))) * var_chaste_interface__INa_j_gate__j;
        IJth(rJacobian, 4, 0) = var_x258 * var_x261 + 0.0072727272727272727 * var_x262 * var_chaste_interface__INa_m_gate__m - 0.032000000000000001 * var_x258 * var_x259 * var_x263 / pow(var_x260, 2);
        IJth(rJacobian, 5, 0) = (-var_chaste_interface__IKr_Xr_gate__Xr + 1 / var_x265) * (var_x268 + var_x271 - 0.00016973999999999998 * var_x269 * var_x272 / pow(var_x270, 2) - 8.8449999999999995e-5 * var_x266 * var_x273 / pow(var_x267, 2)) + 0.13333333333333333 * var_x264 * (var_x274 + var_x275) / pow(var_x265, 2);
        IJth(rJacobian, 6, 0) = (-var_chaste_interface__IKs_Xs_gate__Xs + 1 / var_x277) * (var_x280 + var_x283 - 8.9997000000000013e-6 * var_x278 * var_x284 / pow(var_x279, 2) - 1.0641199999999999e-5 * var_x281 * var_x284 / pow(var_x282, 2)) + 0.059880239520958084 * var_x276 * (var_x285 + var_x286) / pow(var_x277, 2);
        IJth(rJacobian, 7, 0) = var_x291 * var_x294 + 0.0074074074074074077 * var_x288 * (var_x295 - var_chaste_interface__Itos_X_gate__X_tos) / (pow(var_x289, 2) * pow((0.055555555555555552 + var_x290), 2));
        IJth(rJacobian, 8, 0) = -var_x300 * var_x304 + 3.3333333333333335e-5 * var_x307 * (var_x306 + var_x6) / pow((0.01 + var_x299), 2);
        IJth(rJacobian, 9, 0) = -var_x304 * var_x308 + 3.5714285714285717e-5 * var_x307 * (var_x306 - var_chaste_interface__Itos_R_gate__R_tos) / pow((0.07857142857142857 + var_x299), 2);
        IJth(rJacobian, 10, 0) = var_x294 * var_x310 + 0.00063492063492063492 * var_x309 * var_chaste_interface__cell__V * (var_x295 - var_chaste_interface__Itof_X_gate__X_tof) / pow((0.42857142857142855 + var_x309), 2);
        IJth(rJacobian, 11, 0) = -var_x304 * var_x311 + 0.0050000000000000001 * var_x303 * (var_x306 - var_chaste_interface__Itof_Y_gate__Y_tof) / pow((1 + var_x305), 2);
        IJth(rJacobian, 12, 0) = var_x318 * var_x319 - var_x318 * var_x323 + var_x316 * var_x321 * var_x322 - var_x315 * var_x317 * var_x323 / pow(var_x313, 2);
        IJth(rJacobian, 13, 0) = (0.02 + var_x326) * (0.029999999999999999 * var_x327 / pow(var_x328, 2) - 0.27777777777777779 * var_x329 / pow(var_x330, 2)) - 0.00064881969699999995 * var_x325 * var_x324 * (-var_chaste_interface__ICaL_f_gate__f + 1 / var_x330 + 0.59999999999999998 / var_x328);
        IJth(rJacobian, 19, 0) = -5.7312946201117851e-7 + 1.9788582471371878e-10 * var_x133 - 0.01104107857225353 * var_x86 - 0.0057891864849613991 * var_x73 - 3.8033568662798748e-5 * var_x126 - 1.4841436853528909e-10 * var_x140 - 0.0019297288283204664 * var_x38 - var_x352 * var_x99;
        IJth(rJacobian, 20, 0) = -2.6284313781755491e-6 + 6.6084319941501622e-8 * var_x130 - 0.050635535759016415 * var_x83 - 4.9563239956126223e-8 * var_x136 - 0.0088499373002543739 * var_x38 - 0.00017442590535564662 * var_x110 - 0.02654981190076312 * var_x59 - var_x357 * var_x88;
        IJth(rJacobian, 25, 0) = -2.4247042727846657e-7 + 1.2677856220932917e-5 * var_x126 + 0.052769553256991682 * var_x142 + 0.0019297288283204664 * var_x73 - 0.017994417660634164 * var_x146 - var_x115 * var_x367;
        IJth(rJacobian, 26, 0) = -1.1119946217769619e-6 + 5.814196845188221e-5 * var_x110 + 17.622485317733769 * var_x143 + 0.0088499373002543739 * var_x59 - 6.0092674933472159 * var_x148 - var_x124 * var_x372;
        IJth(rJacobian, 1, 1) = -7.2523935948689155 + var_x211 + var_x212 + var_x213 + var_x214 + var_x215 + var_x216 + var_x217 + 3.4188518090540365e-8 * var_x226 - 270818.42237280885 * var_x224;
        IJth(rJacobian, 24, 1) = 5029484.9869235931 * var_x224 - 6.3492962168146398e-7 * var_x226;
        IJth(rJacobian, 25, 1) = 5.6417918332397381;
        IJth(rJacobian, 32, 1) = 2.2890000000000006 - var_x213;
        IJth(rJacobian, 33, 1) = 0.33180000000000004 - var_x214 - var_x215;
        IJth(rJacobian, 35, 1) = 0.81600000000000006 - var_x211;
        IJth(rJacobian, 36, 1) = 1.9320000000000004 - var_x216 - var_x217;
        IJth(rJacobian, 38, 1) = 1.71 - var_x212;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x150 * var_x37 - var_x152 * var_x37);
        IJth(rJacobian, 2, 2) = -((var_x236) ? (0.13500000000000001 * var_x235) : (0)) - ((var_x236) ? (310000.0 * var_x238 + 3.5600000000000001 * var_x237) : (7.6923076923076916 / var_x240));
        IJth(rJacobian, 19, 2) = -var_x353 * var_x37;
        IJth(rJacobian, 20, 2) = -var_x358 * var_x37;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x150 * var_x154 - var_x152 * var_x154);
        IJth(rJacobian, 3, 3) = -((var_x236) ? (0.1212 * var_x252) : (0.29999999999999999 * var_x257)) - ((var_x236) ? (var_x247 * var_x248) : (0));
        IJth(rJacobian, 19, 3) = -var_x154 * var_x353;
        IJth(rJacobian, 20, 3) = -var_x154 * var_x358;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.33000000000000002 * var_x156 - 2.6699999999999999 * var_x157);
        IJth(rJacobian, 4, 4) = -0.080000000000000002 * var_x262 - var_x261 * var_x263;
        IJth(rJacobian, 19, 4) = -0.0057891864849613991 * var_x157;
        IJth(rJacobian, 20, 4) = -0.02654981190076312 * var_x156;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x107 * var_x35 * NV_Ith_S(mParameters, 9));
        IJth(rJacobian, 5, 5) = -var_x274 - var_x275;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.22 * var_x13 * var_x160 - 1.78 * var_x160 * var_x18);
        IJth(rJacobian, 6, 6) = -var_x285 - var_x286;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x10 * var_x7);
        IJth(rJacobian, 7, 7) = -var_x291;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x161 * (var_x9 - var_chaste_interface__cell__V));
        IJth(rJacobian, 8, 8) = -var_x300;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x161 * (13.356651292947088 * var_x8 - 0.5 * var_chaste_interface__cell__V));
        IJth(rJacobian, 9, 9) = -var_x308;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x162 * var_chaste_interface__Itof_Y_gate__Y_tof);
        IJth(rJacobian, 10, 10) = -var_x310;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x162 * var_chaste_interface__Itof_X_gate__X_tof);
        IJth(rJacobian, 11, 11) = -var_x311;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x106 * var_x134 - var_x120 * var_x165 - var_x122 * var_x166 - var_x134 * var_x164 - var_x163 * var_x87);
        IJth(rJacobian, 12, 12) = -var_x319 * var_x321;
        IJth(rJacobian, 19, 12) = -var_x134 * var_x352;
        IJth(rJacobian, 20, 12) = -var_x359 * var_x87;
        IJth(rJacobian, 25, 12) = -var_x165 * var_x367;
        IJth(rJacobian, 26, 12) = -var_x166 * var_x372;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-2.1942115659989999e-5 * var_x168 - var_x106 * var_x169 - var_x120 * var_x171 - var_x122 * var_x172 - var_x164 * var_x169);
        IJth(rJacobian, 13, 13) = -0.02 - var_x326;
        IJth(rJacobian, 19, 13) = -var_x169 * var_x352;
        IJth(rJacobian, 20, 13) = -1.7653304347803737e-6 * var_x168;
        IJth(rJacobian, 25, 13) = -var_x171 * var_x367;
        IJth(rJacobian, 26, 13) = -var_x172 * var_x372;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (4.3884231319980005e-5 * var_x173 + 650.13676029600003 * var_x175 + 2.4380128511099999e-6 * var_x174);
        IJth(rJacobian, 14, 14) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_buffer__Ca_SL;
        IJth(rJacobian, 19, 14) = 5.2861839130367859e-9 * var_x174;
        IJth(rJacobian, 25, 14) = 0.70482452173823817 * var_x175;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.00039495808187982003 * var_x173 + var_x122 * var_x144 + var_x163 * var_chaste_interface__ICaL_d_gate__d);
        IJth(rJacobian, 15, 15) = -0.011900000000000001 - 1.7 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 20, 15) = var_x359 * var_chaste_interface__ICaL_d_gate__d;
        IJth(rJacobian, 26, 15) = var_x144 * var_x372;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x337 + var_x341;
        IJth(rJacobian, 17, 16) = var_x341;
        IJth(rJacobian, 18, 16) = var_x340;
        IJth(rJacobian, 16, 17) = -0.0050000000000000001;
        IJth(rJacobian, 17, 17) = -0.065000000000000002 + var_x341;
        IJth(rJacobian, 18, 17) = 0.0050000000000000001;
        IJth(rJacobian, 16, 18) = 0.055;
        IJth(rJacobian, 17, 18) = var_x341 + var_x349 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 18, 18) = -0.059999999999999998 + var_x337;
        ...
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-2.6699999999999999 * var_x188 - 1.8285096383325e-6 * var_x139 - 23.774839301445819 * var_x176 - 0.0070611272725294083 * var_x84 - 0.00046373856976982447 * var_x186 - var_x180 * var_x184);
        IJth(rJacobian, 19, 19) = -2.5101556644976917 + var_x354 - 0.017367559454884197 * var_x188 - 1.5310180739595352e-5 * var_x84 - 3.9646379347775894e-9 * var_x139 - 3.0164820906368501e-6 * var_x186 - 0.051549430099647651 * var_x176 - var_x180 * var_x355;
        IJth(rJacobian, 20, 19) = 1.0293738389968197;
        IJth(rJacobian, 21, 19) = 0.000165 - var_x354;
        IJth(rJacobian, 23, 19) = 0.076376893524206985;
        IJth(rJacobian, 25, 19) = 0.0057891864849613991 * var_x188 + var_x180 * var_x368;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-0.33000000000000002 * var_x196 - 1.64565867449925e-5 * var_x135 - 2.9384632844483596 * var_x189 - 0.00087272359548116281 * var_x74 - 5.73160030052592e-5 * var_x195 - var_x191 * var_x194);
        IJth(rJacobian, 19, 20) = 0.02774162496096429;
        IJth(rJacobian, 20, 20) = -1.0301299389968197 + var_x360 - 1.3833900897210959e-5 * var_x195 - 7.0214082731462295e-5 * var_x74 - 0.079649435702289356 * var_x196 - 1.3239978260852802e-6 * var_x135 - 0.2364110529678865 * var_x189 - var_x191 * var_x361;
        IJth(rJacobian, 22, 20) = 0.0007561 - var_x360;
        IJth(rJacobian, 26, 20) = 0.02654981190076312 * var_x196 + var_x191 * var_x373;
        IJth(rJacobian, 19, 21) = 0.001 + var_x356;
        IJth(rJacobian, 21, 21) = -0.001 - var_x356;
        IJth(rJacobian, 20, 22) = 0.001 + var_x362;
        IJth(rJacobian, 22, 22) = -0.001 - var_x362;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.05386203200393843 * var_x15 * var_x158 - 0.43579280439550183 * var_x158 * var_x19);
        IJth(rJacobian, 19, 23) = 2.4822490395367272;
        IJth(rJacobian, 23, 23) = -0.076376893524206985;
        IJth(rJacobian, 1, 24) = 0.037279237232671424 * var_x228 + 4.7061860318210743e-15 * var_x229;
        IJth(rJacobian, 16, 24) = -var_x346 + var_x343 * var_x344;
        IJth(rJacobian, 17, 24) = -var_x350 + var_x342 * var_x345 * var_x351;
        IJth(rJacobian, 18, 24) = var_x346 + var_x350;
        IJth(rJacobian, 24, 24) = -260.0 + var_x363 - var_x364 - var_x365 - 0.69232869146389786 * var_x228 - 8.7400597733819945e-14 * var_x229;
        IJth(rJacobian, 26, 24) = var_x374 + var_x375;
        IJth(rJacobian, 31, 24) = 260.0 - var_x363;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (0.89000000000000001 * var_x201 - 5.0104537825247566e-7 * var_x199 - 0.0029873085582266669 * var_x4 - 4.4795166719999994e-11 * var_x205 - 221.69663526093603 * var_x145 - var_x184 * var_x203 + 0.08900000000000001 * var_x197 / (pow(var_x5, 2) * pow(var_chaste_interface__Ca_buffer__Ca_SL, 2)) - 0.28183333333333332 * var_x16 * var_x204 * var_x4 / pow(var_x17, 2));
        IJth(rJacobian, 1, 25) = 0.17359359486891501;
        IJth(rJacobian, 14, 25) = 1.7 - 1.7 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL;
        IJth(rJacobian, 19, 25) = 0.0057891864849613991 * var_x201 - 2.9137929636743439e-13 * var_x205 - var_x203 * var_x355;
        IJth(rJacobian, 25, 25) = -171.99023312516786 + var_x369 + var_x370 + 9.7126432122478125e-14 * var_x205 - 5.4319197230928918e-10 * var_x199 - 3.2385929460103637e-6 * var_x4 - 0.24034516191273925 * var_x145 - 0.0019297288283204664 * var_x201 + var_x203 * var_x368;
        IJth(rJacobian, 26, 25) = 46.324352205124718;
        IJth(rJacobian, 27, 25) = 121.55000000000001 - var_x369;
        IJth(rJacobian, 29, 25) = 43.550000000000004 - var_x370;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (0.11 * var_x208 - 6.1926956862665531e-8 * var_x207 - 0.00036921791169093637 * var_x2 - 5.5364812799999996e-12 * var_x210 - 1995.2697173484241 * var_x147 - var_x194 * var_x209 + 0.011000000000000001 * var_x197 / (pow(var_x3, 2) * pow(var_chaste_interface__Ca_buffer__Ca_jct, 2)) - 0.034833333333333334 * var_x11 * var_x2 * var_x204 / pow(var_x12, 2));
        IJth(rJacobian, 15, 26) = 1.7 - 1.7 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        IJth(rJacobian, 16, 26) = -var_x348 + var_x336 * var_chaste_interface__Jrel_SR__R;
        IJth(rJacobian, 17, 26) = var_x347 * var_x351 + var_x349 * var_chaste_interface__Jrel_SR__O;
        IJth(rJacobian, 18, 26) = var_x348 + var_x336 * var_chaste_interface__Jrel_SR__O;
        IJth(rJacobian, 20, 26) = 0.02654981190076312 * var_x208 - 1.3362957870554202e-12 * var_x210 - var_x209 * var_x361;
        IJth(rJacobian, 24, 26) = var_x364 + var_x365;
        IJth(rJacobian, 25, 26) = 1.2484412919281114;
        IJth(rJacobian, 26, 26) = -121.69540971903938 + var_x376 + var_x377 - var_x374 - var_x375 + 4.4543192901847336e-13 * var_x210 - 1.4852524402707469e-5 * var_x2 - 0.0088499373002543739 * var_x208 - 80.263690434680996 * var_x147 - 2.4911349337733966e-9 * var_x207 + var_x209 * var_x373;
        IJth(rJacobian, 28, 26) = 55.473098330241186 - var_x376;
        IJth(rJacobian, 30, 26) = 19.897959183673468 - var_x377;
        IJth(rJacobian, 25, 27) = 1.3 + var_x371;
        IJth(rJacobian, 27, 27) = -1.3 + var_x379;
        IJth(rJacobian, 26, 28) = 1.3 + var_x378;
        IJth(rJacobian, 28, 28) = -1.3 + var_x380;
        IJth(rJacobian, 25, 29) = 0.029999999999999999 + var_x371;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x379;
        IJth(rJacobian, 26, 30) = 0.029999999999999999 + var_x378;
        IJth(rJacobian, 30, 30) = -0.029999999999999999 + var_x380;
        IJth(rJacobian, 24, 31) = 65.0 + var_x366;
        IJth(rJacobian, 31, 31) = -65.0 - var_x366;
        IJth(rJacobian, 1, 32) = 0.019599999999999999 + var_x230;
        IJth(rJacobian, 32, 32) = -0.019599999999999999 - var_x230;
        IJth(rJacobian, 1, 33) = 0.003032 + var_x231;
        IJth(rJacobian, 33, 33) = -3.1999999999999999e-5 + var_x381;
        IJth(rJacobian, 34, 33) = -0.0030000000000000001;
        IJth(rJacobian, 1, 34) = 0.0063300000000000006 + var_x231;
        IJth(rJacobian, 33, 34) = var_x381;
        IJth(rJacobian, 34, 34) = -0.0063300000000000006;
        IJth(rJacobian, 1, 35) = 0.23799999999999999 + var_x232;
        IJth(rJacobian, 35, 35) = -0.23799999999999999 - var_x232;
        IJth(rJacobian, 1, 36) = 0.016159999999999997 + var_x233;
        IJth(rJacobian, 36, 36) = -0.00046000000000000001 + var_x382;
        IJth(rJacobian, 37, 36) = -0.015699999999999999;
        IJth(rJacobian, 1, 37) = 0.015757 + var_x233;
        IJth(rJacobian, 36, 37) = var_x382;
        IJth(rJacobian, 37, 37) = -0.015757;
        IJth(rJacobian, 1, 38) = 0.059999999999999998 + var_x234;
        IJth(rJacobian, 38, 38) = -0.059999999999999998 - var_x234;
    }
