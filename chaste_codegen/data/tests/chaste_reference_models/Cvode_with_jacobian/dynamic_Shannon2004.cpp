...
bool Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::registered = ModelFactory::Register("dynamic_Shannon2004", "AnalyticCvode", (ModelFactory::TCreateMethod)Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::CreateMethod);
    ...
    void Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x5 = -var_chaste_interface__Itos_Y_gate__Y_tos - 0.5 * var_chaste_interface__Itos_R_gate__R_tos;
        ...
        const double var_x40 = pow(var_chaste_interface__Na_buffer__Na_jct, 3.0);
        ...
        const double var_x46 = pow(NV_Ith_S(mParameters, 9), 3.0);
        ...
        const double var_x50 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_jct) * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x51 = 1.0 + 0.00053869674493876331 * var_x40;
        ...
        const double var_x54 = 1.0 + 1.6777215999999998e-11 / pow(var_chaste_interface__Ca_buffer__Ca_jct, 3);
        const double var_x55 = 1 / var_x54;
        const double var_x56 = 1.0 + 0.27000000000000002 * var_x45;
        const double var_x57 = 1 / var_x56;
        const double var_x58 = -31.0 + 0.10000000000000001 * NV_Ith_S(mParameters, 23);
        ...
        const double var_x71 = 1.0 + 0.00053869674493876331 * var_x65;
        const double var_x72 = 1 / (var_x66 + var_x68 + 669921.875 * var_x70 + 1.3 * var_x65 + var_x52 * var_x71);
        const double var_x73 = 1.0 + 1.6777215999999998e-11 / pow(var_chaste_interface__Ca_buffer__Ca_SL, 3);
        ...
        const double var_x87 = exp(-var_x44);
        const double var_x88 = 1.0 + 0.1245 * var_x85 + 0.036499999999999998 * var_x87 * (-0.14285714285714285 + 0.14285714285714285 * var_x86);
        const double var_x89 = pow(1.6299999999999999, var_x58) * NV_Ith_S(mParameters, 8) / (1.5 + NV_Ith_S(mParameters, 8));
        const double var_x90 = var_x89 * (0.012450000000000001 * var_x38 * var_x85 + var_x38 * var_x87 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x86)) / pow(var_x88, 2);
        ...
        const double var_x95 = exp(var_x44);
        const double var_x96 = 0.75 * var_x95;
        const double var_x97 = -0.75 * NV_Ith_S(mParameters, 8) + var_x96 * NV_Ith_S(mParameters, 5);
        const double var_x98 = var_x37 * pow(NV_Ith_S(mParameters, 10), 2);
        const double var_x99 = -1.0 + var_x95;
        const double var_x100 = 1 / var_x99;
        const double var_x101 = pow(1.8, var_x58);
        ...
        const double var_x107 = 1.0 - 0.10000000000000001 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL - 0.90000000000000002 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        const double var_x108 = 1.215e-7 * var_x107;
        const double var_x109 = var_x67 - var_x69;
        const double var_x110 = var_x109 * var_x72;
        const double var_x111 = var_x38 * var_x45 * var_x60 / pow(var_x56, 2);
        ...
        const double var_x116 = 1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL;
        const double var_x117 = exp(2.0 * var_x44);
        ...
        const double var_x122 = -0.34100000000000003 * NV_Ith_S(mParameters, 6);
        const double var_x123 = 0.34100000000000003 * var_x117;
        const double var_x124 = var_x122 + var_x123 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x125 = 0.18000000000000002 * var_x124;
        const double var_x126 = var_x121 * var_x125 * var_x98;
        const double var_x127 = 1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        ...
        const double var_x131 = 1.6200000000000001 * var_x130;
        const double var_x132 = var_x129 * var_x131;
        const double var_x133 = var_x104 * var_x95;
        const double var_x134 = pow(NV_Ith_S(mParameters, 10), 3);
        const double var_x135 = pow(NV_Ith_S(mParameters, 11), (-2));
        const double var_x136 = pow(NV_Ith_S(mParameters, 23), (-2));
        const double var_x137 = var_x134 * var_x135 * var_x136 * var_chaste_interface__cell__V;
        const double var_x138 = pow(var_x99, (-2));
        const double var_x139 = var_x127 * var_x137;
        const double var_x140 = 1.10484 * var_x117 * var_x120 * var_x139 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x141 = var_x117 * var_x121;
        const double var_x142 = 0.12276000000000002 * var_x137 * var_x141 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x143 = var_x103 * var_x137;
        const double var_x144 = var_x117 * var_x143 * NV_Ith_S(mParameters, 12) / pow(var_x118, 2);
        const double var_x145 = 0.36000000000000004 * var_x116 * var_x124 * var_x144;
        const double var_x146 = var_x127 * var_x130;
        const double var_x147 = 3.2400000000000002 * var_x144 * var_x146;
        const double var_x148 = -0.75 * NV_Ith_S(mParameters, 9);
        const double var_x149 = var_x148 + var_x96 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x150 = var_x116 * var_x149;
        const double var_x151 = 6.7499999999999994e-10 * var_x150;
        const double var_x152 = 5.0624999999999998e-10 * var_x116 * var_x95;
        ...
        const double var_x157 = 6.0749999999999998e-9 * var_x128;
        const double var_x158 = 4.5562499999999999e-9 * var_x133;
        const double var_x159 = var_x127 * var_x155;
        const double var_x160 = var_x156 * var_x157 - 6.0749999999999998e-9 * var_x153 * var_x159 + var_x139 * var_x158 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x161 = -var_x24 * log(var_x82 * NV_Ith_S(mParameters, 9)) + var_chaste_interface__cell__V;
        const double var_x162 = 0.11 * var_x161;
        const double var_x163 = -var_x24 * log(var_x92 * NV_Ith_S(mParameters, 9)) + var_chaste_interface__cell__V;
        const double var_x164 = 0.89000000000000001 * var_x163;
        const double var_x165 = NV_Ith_S(mParameters, 14) * var_chaste_interface__INa_h_gate__h;
        const double var_x166 = var_x165 * var_x19;
        const double var_x167 = var_x165 * pow(var_chaste_interface__INa_m_gate__m, 2) * var_chaste_interface__INa_j_gate__j;
        const double var_x168 = var_x161 * var_x167;
        const double var_x169 = var_x163 * var_x167;
        const double var_x170 = 1 / (0.018329999999999999 * var_chaste_interface__Na_buffer__Nai + NV_Ith_S(mParameters, 5));
        const double var_x171 = -var_x24 * log(var_x170 * (0.018329999999999999 * NV_Ith_S(mParameters, 9) + NV_Ith_S(mParameters, 8))) + var_chaste_interface__cell__V;
        ...
        const double var_x193 = pow(var_chaste_interface__Na_buffer__Na_SL, 2.0);
        const double var_x194 = 3.0 * NV_Ith_S(mParameters, 6);
        const double var_x195 = 5.8017639429904805e-6 * var_x46;
        const double var_x196 = -3.9000000000000004 * var_x193 - var_x193 * var_x194 - var_x193 * var_x195;
        const double var_x197 = 5.3588338192419823e-9 * var_x46;
        const double var_x198 = var_x109 * var_x75 / pow((var_x70 + 1.9405247813411081e-6 * var_x65 + 1.4927113702623908e-6 * var_x66 + 1.4927113702623908e-6 * var_x68 + var_x197 * var_x71), 2);
        const double var_x199 = 1.9830866390704556e-12 * var_x198;
        ...
        const double var_x203 = var_x202 * var_x92 * var_x93 / pow((6.8301345536507063e-5 + var_x93), 2);
        const double var_x204 = var_x24 * var_x92;
        const double var_x205 = 0.89000000000000001 * var_x21;
        const double var_x206 = 0.00026433000000000001 * var_x204 + var_x152 * var_x191 + var_x204 * var_x205;
        const double var_x207 = pow(var_chaste_interface__Na_buffer__Na_jct, 2.0);
        const double var_x208 = -3.9000000000000004 * var_x207 - var_x194 * var_x207 - var_x195 * var_x207;
        const double var_x209 = var_x113 * var_x62 / pow((var_x50 + 1.9405247813411081e-6 * var_x40 + 1.4927113702623908e-6 * var_x41 + 1.4927113702623908e-6 * var_x47 + var_x197 * var_x51), 2);
        const double var_x210 = 2.4510059584016866e-13 * var_x209;
        const double var_x211 = var_x200 * var_x207 * var_x63;
        const double var_x212 = var_x202 * var_x82 * var_x83 / pow((6.8301345536507063e-5 + var_x83), 2);
        const double var_x213 = var_x24 * var_x82;
        const double var_x214 = 0.11 * var_x21;
        const double var_x215 = 3.2670000000000004e-5 * var_x213 + var_x158 * var_x184 + var_x213 * var_x214;
        const double var_x216 = var_x170 * var_x24;
        const double var_x217 = var_x24 * log(NV_Ith_S(mParameters, 7) / NV_Ith_S(mParameters, 4)) + var_chaste_interface__cell__V;
        const double var_x218 = var_x171 * var_x9 / log(10);
        const double var_x219 = var_x110 * var_x61 / (pow(var_x73, 2) * pow(var_chaste_interface__Ca_buffer__Ca_SL, 4));
        const double var_x220 = 669921.875 + var_x46;
        const double var_x221 = -var_x220 - 373215529.24791086 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x222 = pow(2.3500000000000001, var_x58);
        const double var_x223 = pow(var_x2, 1.6000000000000001);
        const double var_x224 = 0.00011182849999999999 * var_x2 * var_x24 + 0.061380000000000011 * var_x141 * var_x180 + 5.0104537825247566e-7 * var_x2 * var_x222 * var_x223 / pow((1.0 + 5.2281977629563632e-6 * var_x223), 2);
        const double var_x225 = pow(var_chaste_interface__Ca_buffer__Ca_jct, 2);
        const double var_x226 = -var_x220 - 373215529.24791086 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x227 = var_x114 * var_x61 / (pow(var_x54, 2) * pow(var_chaste_interface__Ca_buffer__Ca_jct, 4));
        const double var_x228 = pow(var_x0, 1.6000000000000001);
        const double var_x229 = 1.38215e-5 * var_x0 * var_x24 + 0.55242000000000002 * var_x117 * var_x129 * var_chaste_interface__cell__V + 6.1926956862665531e-8 * var_x0 * var_x222 * var_x228 / pow((1.0 + 5.2281977629563632e-6 * var_x228), 2);
        const double var_x230 = 32.700000000000003 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC;
        const double var_x231 = 34.0 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Calmodulin;
        const double var_x232 = 100.0 * var_chaste_interface__cytosolic_Ca_buffer__Ca_SRB;
        const double var_x233 = pow(var_chaste_interface__Ca_buffer__Cai, 0.78699999999999992);
        const double var_x234 = pow(var_chaste_interface__Ca_buffer__Ca_SR, 1.7869999999999999);
        const double var_x235 = 0.38742512113256738 * var_x234;
        const double var_x236 = pow(var_chaste_interface__Ca_buffer__Cai, 1.7869999999999999);
        const double var_x237 = 1 / (1.0 + var_x235 + 2814485.1633595936 * var_x236);
        const double var_x238 = pow(2.6000000000000001, var_x58);
        const double var_x239 = var_x238 * NV_Ith_S(mParameters, 2);
        const double var_x240 = var_x237 * var_x239;
        const double var_x241 = var_x239 * (-var_x235 + 2814485.1633595936 * var_x236) / pow((3.5530476870814998e-7 + var_x236 + 1.3765399305573384e-7 * var_x234), 2);
        const double var_x242 = var_x233 * var_x241;
        const double var_x243 = 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC_Ca_Mg + 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_TroponinC_Ca_Mg;
        const double var_x244 = 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Myosin + 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_Myosin;
        const double var_x245 = pow(var_chaste_interface__Ca_buffer__Ca_SR, 0.78699999999999992);
        const double var_x246 = var_x240 * var_x245;
        const double var_x247 = var_x241 * var_x245;
        const double var_x248 = 0.019599999999999999 + 32.700000000000003 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x249 = 2.3700000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x250 = 0.23799999999999999 + 34.0 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x251 = 13.800000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x252 = 0.059999999999999998 + 100.0 * var_chaste_interface__Ca_buffer__Cai;
        ...
        const double var_x260 = ((var_x254) ? (310000.0 * var_x256 + 3.5600000000000001 * var_x257) : (7.6923076923076916 / var_x259));
        ...
        const double var_x267 = ((var_x254) ? (0.28123999999999999 * var_x257 + 108500.0 * var_x256) : (0.693000693000693 * var_x258 / pow(var_x259, 2)));
        ...
        const double var_x272 = exp(-3.2000000000000002 - var_x84 + 0.10000000000000001 * NV_Ith_S(mParameters, 16));
        ...
        const double var_x280 = -127140.0 * var_x278 - 3.4740000000000003e-5 * var_x279;
        ...
        const double var_x291 = exp(-4.7130000000000001 - var_x84);
        ...
        const double var_x297 = 0.080000000000000002 * var_x294 + var_x295 * var_x296;
        const double var_x298 = 1 / var_x297;
        const double var_x299 = 0.032000000000000001 * var_x291 * var_x295 / pow(var_x292, 2);
        const double var_x300 = var_x299 + 0.0072727272727272727 * var_x294 - 0.32000000000000001 * var_x293;
        ...
        const double var_x311 = 10.0 + var_chaste_interface__cell__V;
        ...
        const double var_x321 = 30.0 + var_chaste_interface__cell__V;
        ...
        const double var_x327 = 1 / (0.5 + 9.0 * var_x326);
        ...
        const double var_x333 = exp(6.0 + var_x332);
        const double var_x334 = 1.0 + var_x333;
        const double var_x335 = 1 / var_x334;
        const double var_x336 = 1 / (30.0 + 3000.0 * var_x335);
        const double var_x337 = exp(3.3500000000000001 + var_x332);
        const double var_x338 = 1.0 + var_x337;
        const double var_x339 = pow(var_x338, (-2));
        const double var_x340 = 0.10000000000000001 * var_x337 * var_x339;
        const double var_x341 = pow(var_x334, (-2));
        const double var_x342 = 1 / var_x338;
        const double var_x343 = -var_x342;
        const double var_x344 = 1 / (220.0 + 2800.0 * var_x335);
        const double var_x345 = exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2));
        const double var_x346 = 1 / (1.5 + 3.5 * var_x345);
        const double var_x347 = 1 / (20.0 + 20.0 * var_x342);
        const double var_x348 = exp(-2.4166666666666665 - 0.16666666666666666 * var_chaste_interface__cell__V);
        const double var_x349 = 1.0 - var_x348;
        const double var_x350 = 1 / var_x349;
        const double var_x351 = 1.0 + var_x348;
        const double var_x352 = 1 / var_x351;
        const double var_x353 = -var_chaste_interface__ICaL_d_gate__d + var_x352;
        const double var_x354 = 14.5 + var_chaste_interface__cell__V;
        const double var_x355 = 0.0058333333333333336 * var_x348 * var_x354;
        const double var_x356 = 0.019699999999999999 * exp(-0.23877882250000002 * pow((1 + 0.068965517241379309 * var_chaste_interface__cell__V), 2));
        const double var_x357 = 0.02 + var_x356;
        const double var_x358 = exp(9.7388888888888889 + 0.27777777777777779 * var_chaste_interface__cell__V);
        const double var_x359 = 1.0 + var_x358;
        const double var_x360 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x361 = 1.0 + var_x360;
        const double var_x362 = 1 / var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x363 = pow(var_x362, 2.5);
        const double var_x364 = 1.0 + 0.13584112963311223 * var_x363;
        const double var_x365 = 1 / var_x364;
        const double var_x366 = 7.5 - 7.0 * var_x365;
        const double var_x367 = -var_x366;
        const double var_x368 = 1 / (15.0 - 14.0 * var_x365);
        const double var_x369 = 10.0 * var_x225 * var_x368;
        const double var_x370 = pow(var_x364, (-2));
        const double var_x371 = var_x362 * var_x363 * var_x370;
        const double var_x372 = 0.21130842387373014 * var_x225 * var_x371 / pow((1 - 0.93333333333333335 * var_x365), 2);
        const double var_x373 = var_x372 * var_chaste_interface__Jrel_SR__R;
        const double var_x374 = 20.0 * var_x368;
        const double var_x375 = var_x374 * var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__R;
        const double var_x376 = 2.3772197685794643 * var_x371 * var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__O;
        const double var_x377 = 1.0 - var_chaste_interface__Jrel_SR__I - var_chaste_interface__Jrel_SR__O - var_chaste_interface__Jrel_SR__R;
        ...
        const double var_x383 = 55.277229008113743 * var_x163;
        ...
        const double var_x392 = 5.9492599172113663e-12 * var_x198;
        ...
        const double var_x398 = 267.92223797719811 * var_x161;
        ...
        const double var_x402 = 7.3530178752050587e-13 * var_x209;
        ...
        const double var_x406 = 100.0 * var_chaste_interface__Ca_buffer__Ca_Calsequestrin;
        const double var_x407 = var_chaste_interface__Jrel_SR__O * NV_Ith_S(mParameters, 1);
        const double var_x408 = var_x407 + 18.571428571428569 * NV_Ith_S(mParameters, 0);
        const double var_x409 = 65.0 + 100.0 * var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x410 = 31.054623038266147 * var_x378;
        const double var_x411 = 5.5898321468879066 * var_x124 * var_x386;
        const double var_x412 = 3.9661732781409111e-12 * var_x198;
        const double var_x413 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SLB_SL;
        const double var_x414 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SLHigh_SL;
        const double var_x415 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x416 = 1.3 + var_x415;
        const double var_x417 = 0.029999999999999999 + var_x415;
        const double var_x418 = 1217.8283544418096 * var_x378;
        const double var_x419 = 1972.8819341957317 * var_x386;
        const double var_x420 = var_x146 * var_x419;
        const double var_x421 = 4.9020119168033731e-13 * var_x209;
        const double var_x422 = 68.627450980392155 * var_x407 + 1274.5098039215686 * NV_Ith_S(mParameters, 0);
        const double var_x423 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SLB_jct;
        const double var_x424 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SLHigh_jct;
        const double var_x425 = 100.0 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x426 = 1.3 + var_x425;
        const double var_x427 = 0.029999999999999999 + var_x425;
        const double var_x428 = 100.0 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_Cytosol;
        const double var_x429 = -2.5 + var_x428;
        ...
        const double var_x431 = 0.078461538461538471 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x432 = 3.0769230769230771 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL;
        const double var_x433 = var_x428 + var_x431 + var_x432;
        const double var_x434 = -2.5024999999999999 + 100.0 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL;
        const double var_x435 = -2.5490196078431375 + 100.0 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x436 = 100.0 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol;
        const double var_x437 = -2.5 + var_x436;
        ...
        const double var_x439 = 0.078461538461538471 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        ...
        IJth(rJacobian, 4, 0) = var_x297 * (var_x296 * var_x298 - var_x298 * var_x299 + 3.125 * var_x300 * var_x301 / pow((var_x301 + 0.25 * var_x294), 2)) - var_x300 * (-var_chaste_interface__INa_m_gate__m + 0.32000000000000001 * var_x293 * var_x295 * var_x298);
        ...
        IJth(rJacobian, 7, 0) = var_x327 * var_x330 + 0.0074074074074074077 * var_x324 * (-var_x331 - var_chaste_interface__Itos_X_gate__X_tos) / (pow(var_x325, 2) * pow((0.055555555555555552 + var_x326), 2));
        IJth(rJacobian, 8, 0) = -var_x336 * var_x340 + 3.3333333333333335e-5 * var_x333 * var_x341 * (-var_x343 - var_chaste_interface__Itos_Y_gate__Y_tos) / pow((0.01 + var_x335), 2);
        IJth(rJacobian, 9, 0) = -var_x340 * var_x344 + 3.5714285714285717e-5 * var_x333 * var_x341 * (-var_x343 - var_chaste_interface__Itos_R_gate__R_tos) / pow((0.07857142857142857 + var_x335), 2);
        IJth(rJacobian, 10, 0) = var_x330 * var_x346 + 0.00063492063492063492 * var_x345 * (-var_x331 - var_chaste_interface__Itof_X_gate__X_tof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x345), 2);
        IJth(rJacobian, 11, 0) = -var_x340 * var_x347 + 0.0050000000000000001 * var_x337 * var_x339 * (-var_x343 - var_chaste_interface__Itof_Y_gate__Y_tof) / pow((1 + var_x342), 2);
        IJth(rJacobian, 12, 0) = -var_x350 * var_x353 * var_x355 + 0.035000000000000003 * var_x350 * var_x351 * var_x353 - var_x351 * var_x353 * var_x355 / pow(var_x349, 2) + 0.0058333333333333336 * var_x348 * var_x350 * var_x352 * var_x354;
        IJth(rJacobian, 13, 0) = var_x357 * (0.029999999999999999 * var_x360 / pow(var_x361, 2) - 0.27777777777777779 * var_x358 / pow(var_x359, 2)) + var_x356 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__cell__V) * (-var_chaste_interface__ICaL_f_gate__f + 1 / var_x359 + 0.59999999999999998 / var_x361);
        IJth(rJacobian, 19, 0) = -var_x380 * (0.00026433000000000001 + var_x154 + var_x205 + 2.6699999999999999 * var_x77 + 5.0996999999999995 * var_x94 + 0.46858500000000003 * var_x112);
        IJth(rJacobian, 20, 0) = -var_x397 * (3.2670000000000004e-5 + var_x160 + var_x214 + 0.33000000000000002 * var_x64 + 0.63029999999999997 * var_x91 + 0.057915000000000008 * var_x115);
        IJth(rJacobian, 25, 0) = -var_x410 * (0.00022365699999999999 + var_x126 + var_x142 - var_x145 - 1.78 * var_x77 - 0.31239000000000006 * var_x112);
        IJth(rJacobian, 26, 0) = -var_x418 * (2.7642999999999999e-5 + var_x132 + var_x140 - var_x147 - 0.22 * var_x64 - 0.038610000000000005 * var_x115);
        IJth(rJacobian, 1, 1) = -7.2523935948689155 + var_x230 + var_x231 + var_x232 + var_x243 + var_x244 + 6.3492962168146398e-7 * var_x242 - 5029484.9869235931 * var_x233 * var_x240;
        IJth(rJacobian, 24, 1) = -1.1791550116941473e-5 * var_x242 + 93404721.185723871 * var_x233 * var_x237 * var_x238 * NV_Ith_S(mParameters, 2);
        IJth(rJacobian, 25, 1) = 5.6417918332397381;
        IJth(rJacobian, 32, 1) = 2.2890000000000006 - var_x230;
        IJth(rJacobian, 33, 1) = 0.33180000000000004 - var_x243;
        IJth(rJacobian, 35, 1) = 0.81600000000000006 - var_x231;
        IJth(rJacobian, 36, 1) = 1.9320000000000004 - var_x244;
        IJth(rJacobian, 38, 1) = 1.71 - var_x232;
        ...
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.33000000000000002 * var_x168 - 2.6699999999999999 * var_x169);
        IJth(rJacobian, 4, 4) = -var_x297;
        IJth(rJacobian, 19, 4) = -165.83168702434122 * var_x169 * var_x381;
        IJth(rJacobian, 20, 4) = -803.76671393159438 * var_x168 * var_x381;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x18 * var_x80 * NV_Ith_S(mParameters, 19));
        IJth(rJacobian, 5, 5) = -var_x312;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-0.22 * var_x172 * var_x8 - 1.78 * var_x13 * var_x172);
        ...
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x174 * (-0.5 * var_chaste_interface__cell__V + 0.5 * var_x22 * var_x23 * NV_Ith_S(mParameters, 11) * NV_Ith_S(mParameters, 23)));
        ...
        IJth(rJacobian, 12, 12) = -0.035000000000000003 * var_x350 * var_x351 * var_x354;
        ...
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (1.2150000000000001e-8 * var_x192 + var_x120 * var_x181 + 6.7499999999999994e-10 * var_x149 * var_x191);
        ...
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (1.0935000000000001e-7 * var_x192 + 6.0749999999999998e-9 * var_x156 * var_x180 + var_x120 * var_x131 * var_x180);
        ...
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 - var_x369 + var_x367 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 17, 16) = -var_x369;
        IJth(rJacobian, 18, 16) = var_x369;
        IJth(rJacobian, 16, 17) = -0.0050000000000000001;
        IJth(rJacobian, 17, 17) = -0.065000000000000002 - var_x369;
        ...
        IJth(rJacobian, 18, 18) = -0.059999999999999998 + var_x367 * var_chaste_interface__Ca_buffer__Ca_jct;
        ...
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x206 - 2.6699999999999999 * var_x201 - 0.00046442182911003347 * var_x203 - var_x196 * var_x199);
        IJth(rJacobian, 19, 19) = (-2.5101556644976917 + var_x391 - var_x379 * (var_x206 + 8.0099999999999998 * var_x201 + 0.0013932654873301004 * var_x203 + var_x196 * var_x392)) * NV_Ith_S(mParameters, 3);
        ...
        IJth(rJacobian, 25, 19) = -var_x410 * (-5.3399999999999999 * var_x201 - var_x196 * var_x412);
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x215 - 0.33000000000000002 * var_x211 - 5.7400450788880541e-5 * var_x212 - var_x208 * var_x210);
        IJth(rJacobian, 19, 20) = 0.02774162496096429 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 20, 20) = (-1.0886629612142857 + var_x401 - var_x396 * (var_x215 + 0.98999999999999999 * var_x211 + 0.00017220135236664162 * var_x212 + var_x208 * var_x402)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 20) = 0.0007561 - var_x401;
        IJth(rJacobian, 26, 20) = -var_x418 * (-0.66000000000000003 * var_x211 - var_x208 * var_x421);
        ...
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0020162999999999999 * var_x10 * var_x216 - 0.0163137 * var_x14 * var_x216);
        IJth(rJacobian, 19, 23) = 2.4822490395367272 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 23, 23) = -var_x405;
        IJth(rJacobian, 1, 24) = 0.69232869146389786 * var_x246 + 8.7400597733819945e-14 * var_x247;
        IJth(rJacobian, 16, 24) = -var_x373 + 2.3772197685794643 * var_x362 * var_x363 * var_x370 * var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__R;
        IJth(rJacobian, 17, 24) = -var_x376 + var_x372 * var_x377;
        IJth(rJacobian, 18, 24) = var_x373 + var_x376;
        IJth(rJacobian, 24, 24) = -260.0 + var_x406 - var_x408 - 1.6231539579137989e-12 * var_x247 - 12.857532841472388 * var_x246;
        IJth(rJacobian, 26, 24) = var_x422;
        IJth(rJacobian, 31, 24) = 260.0 - var_x406;
        ...
        IJth(rJacobian, 19, 25) = -var_x380 * (1.3438550016e-10 * var_x219 - 2.6699999999999999 * var_x395 + var_x221 * var_x392);
        IJth(rJacobian, 25, 25) = -171.99023312516786 + var_x413 + var_x414 - var_x410 * (var_x224 + 1.78 * var_x395 - 8.9590333439999989e-11 * var_x219 - var_x221 * var_x412);
        IJth(rJacobian, 26, 25) = 48.958482036396518;
        IJth(rJacobian, 27, 25) = 121.55000000000001 - var_x413;
        IJth(rJacobian, 29, 25) = 43.550000000000004 - var_x414;
        IJth(rJacobian, 40, 25) = -var_x430 * var_x434;
        IJth(rJacobian, 43, 25) = -var_x438 * var_x442;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x229 - 5.5364812799999996e-12 * var_x227 - var_x210 * var_x226 - 0.0012058750000000001 * var_x217 / (pow(var_x1, 2) * var_x225) - 0.034833333333333334 * var_x0 * var_x218 * var_x6 / pow(var_x7, 2) + 0.11 * var_x45 * var_x46 * var_x53 * var_x55 * var_x57 * var_x59 * NV_Ith_S(mParameters, 22));
        ...
        IJth(rJacobian, 20, 26) = -var_x397 * (1.6609443839999999e-11 * var_x227 - 0.33000000000000002 * var_x404 + var_x226 * var_x402);
        IJth(rJacobian, 24, 26) = var_x408;
        IJth(rJacobian, 25, 26) = 1.2484412919281114;
        IJth(rJacobian, 26, 26) = -128.61534478149457 + var_x423 + var_x424 - var_x422 - var_x418 * (var_x229 + 0.22 * var_x404 - 1.1072962559999999e-11 * var_x227 - var_x226 * var_x421);
        IJth(rJacobian, 28, 26) = 58.627450980392155 - var_x423;
        IJth(rJacobian, 30, 26) = 21.029411764705884 - var_x424;
        ...
        IJth(rJacobian, 1, 33) = 0.003032 + var_x249;
        IJth(rJacobian, 33, 33) = -3.1999999999999999e-5 - var_x249;
        IJth(rJacobian, 34, 33) = -0.0030000000000000001;
        IJth(rJacobian, 1, 34) = 0.0063300000000000006 + var_x249;
        ...
        IJth(rJacobian, 1, 36) = 0.016159999999999997 + var_x251;
        IJth(rJacobian, 36, 36) = -0.00046000000000000001 - var_x251;
        IJth(rJacobian, 37, 36) = -0.015699999999999999;
        IJth(rJacobian, 1, 37) = 0.015757 + var_x251;
        IJth(rJacobian, 36, 37) = -var_x251;
        IJth(rJacobian, 37, 37) = -0.015757;
        IJth(rJacobian, 1, 38) = var_x252;
        IJth(rJacobian, 38, 38) = -var_x252;
        IJth(rJacobian, 39, 39) = -0.059999999999999998 + var_x429 * var_chaste_interface__Ca_buffer__Cai + var_x433 * var_chaste_interface__Ca_buffer__Cai;
        ...
        IJth(rJacobian, 40, 40) = -0.059999999999999998 + var_x433 * var_chaste_interface__Ca_buffer__Ca_SL + (-0.076999999999999999 + var_x432) * var_chaste_interface__Ca_buffer__Ca_SL;
        ...
        IJth(rJacobian, 41, 41) = -0.059999999999999998 + var_x433 * var_chaste_interface__Ca_buffer__Ca_jct + (-0.002 + var_x431) * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 42, 42) = -0.11 + var_x437 * var_chaste_interface__Ca_buffer__Cai + var_x441 * var_chaste_interface__Ca_buffer__Cai;
        ...
        IJth(rJacobian, 43, 43) = -0.11 + var_x441 * var_chaste_interface__Ca_buffer__Ca_SL + (-0.076999999999999999 + var_x440) * var_chaste_interface__Ca_buffer__Ca_SL;
        ...
        IJth(rJacobian, 44, 44) = -0.11 + var_x441 * var_chaste_interface__Ca_buffer__Ca_jct + (-0.002 + var_x439) * var_chaste_interface__Ca_buffer__Ca_jct;
    }
