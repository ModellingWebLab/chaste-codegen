...
bool Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::registered = ModelFactory::Register("dynamic_Shannon2004", "AnalyticCvode", (ModelFactory::TCreateMethod)Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::CreateMethod);
    ...
    void Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x253 = exp(0.14705882352941177 * NV_Ith_S(mParameters, 16) - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x254 = var_chaste_interface__cell__V < -40;
        const double var_x255 = ((var_x254) ? (1.0495108254269646e-6 * var_x253) : (0));
        ...
        const double var_x258 = exp(0.0900900900900901 * NV_Ith_S(mParameters, 16) - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x259 = 1 + 0.38275493141491301 * var_x258;
        ...
        const double var_x262 = ((var_x254) ? (-1.5433982726867125e-7 * var_x253) : (0));
        ...
        const double var_x267 = ((var_x254) ? (0.28123999999999999 * var_x257 + 108500 * var_x256) : (0.26524943271996743 * var_x258 / pow(var_x259, 2)));
        const double var_x268 = exp(0.13780000000000001 * NV_Ith_S(mParameters, 16) - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x269 = 1 + 0.0039608683399042569 * var_x268;
        ...
        const double var_x272 = exp(-var_x84 + 0.10000000000000001 * NV_Ith_S(mParameters, 16));
        const double var_x273 = 1 + 0.040762203978366211 * var_x272;
        ...
        const double var_x281 = exp(0.311 * var_chaste_interface__cell__V - 0.311 * NV_Ith_S(mParameters, 16));
        const double var_x282 = 1 / (1 + 50262745825.953949 * var_x281);
        const double var_x283 = var_x280 * var_x282;
        const double var_x284 = ((var_x254) ? (var_x277 * var_x283) : (0));
        const double var_x285 = var_x276 + var_x284;
        const double var_x286 = ((var_x254) ? (var_x283 + var_x277 * var_x282 * (1.5254334000000001e-6 * var_x279 - 31073.016 * var_x278) - 6.1874852813833003e-12 * var_x277 * var_x280 * var_x281 / pow((1.989545106554116e-11 + var_x281), 2)) : (0));
        const double var_x287 = var_x276 + var_x284;
        const double var_x288 = var_x265 / var_x287;
        const double var_x289 = ((var_x254) ? (-0.001275024 * var_x271 + 6.6151888057343371e-5 * var_x268 * var_x270 / pow(var_x269, 2)) : (-7.6049999999999996e-8 * var_x275 + 0.0012228661193509863 * var_x272 * var_x274 / pow(var_x273, 2)));
        ...
        const double var_x366 = -var_x365;
        const double var_x367 = 1 / (15 - 14 * var_x364);
        const double var_x368 = 10 * var_x225 * var_x367;
        const double var_x369 = pow(var_x363, (-2));
        const double var_x370 = var_x361 * var_x362 * var_x369;
        const double var_x371 = 0.21130842387373014 * var_x225 * var_x370 / pow((1 - 0.93333333333333335 * var_x364), 2);
        ...
        const double var_x377 = M_PI * var_x23;
        const double var_x378 = 62.109246076532294 * var_x377;
        const double var_x379 = var_x378 * NV_Ith_S(mParameters, 3);
        const double var_x380 = var_x377 * NV_Ith_S(mParameters, 3);
        const double var_x381 = var_x20 * var_x380;
        const double var_x382 = 55.277229008113743 * var_x163;
        const double var_x383 = var_x166 * var_x380;
        const double var_x384 = var_x100 * var_x102;
        const double var_x385 = M_PI * var_x44;
        const double var_x386 = var_x385 * NV_Ith_S(mParameters, 3);
        const double var_x387 = 4.1923741101659298e-8 * var_x386;
        const double var_x388 = var_x150 * var_x387;
        const double var_x389 = var_x100 * var_x186;
        const double var_x390 = 0.0001 * var_chaste_interface__Na_buffer__Na_SL_buf;
        const double var_x391 = 5.9492599172113663e-12 * var_x198;
        const double var_x392 = 0.001 + 0.0001 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x393 = var_x45 * var_x46;
        const double var_x394 = var_x393 * var_x76;
        const double var_x395 = 2435.6567088836191 * var_x377;
        const double var_x396 = var_x395 * NV_Ith_S(mParameters, 3);
        const double var_x397 = 267.92223797719811 * var_x161;
        const double var_x398 = 1.4796614506467986e-5 * var_x386;
        const double var_x399 = var_x159 * var_x398;
        const double var_x400 = 0.0001 * var_chaste_interface__Na_buffer__Na_jct_buf;
        const double var_x401 = 7.3530178752050587e-13 * var_x209;
        const double var_x402 = 0.001 + 0.0001 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x403 = var_x393 * var_x63;
        const double var_x404 = 0.076376893524206985 * NV_Ith_S(mParameters, 3);
        const double var_x405 = 100 * var_chaste_interface__Ca_buffer__Ca_Calsequestrin;
        const double var_x406 = var_chaste_interface__Jrel_SR__O * NV_Ith_S(mParameters, 1);
        const double var_x407 = var_x406 + 18.571428571428569 * NV_Ith_S(mParameters, 0);
        const double var_x408 = 65 + 100 * var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x409 = 31.054623038266147 * var_x377;
        const double var_x410 = 5.5898321468879066 * var_x124 * var_x385;
        const double var_x411 = 3.9661732781409111e-12 * var_x198;
        const double var_x412 = 100 * var_chaste_interface__Ca_buffer__Ca_SLB_SL;
        const double var_x413 = 100 * var_chaste_interface__Ca_buffer__Ca_SLHigh_SL;
        const double var_x414 = 100 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x415 = 1.3 + var_x414;
        const double var_x416 = 0.029999999999999999 + var_x414;
        const double var_x417 = 1217.8283544418096 * var_x377;
        const double var_x418 = 1972.8819341957317 * var_x385;
        const double var_x419 = var_x146 * var_x418;
        const double var_x420 = 4.9020119168033731e-13 * var_x209;
        const double var_x421 = 68.627450980392155 * var_x406 + 1274.5098039215686 * NV_Ith_S(mParameters, 0);
        const double var_x422 = 100 * var_chaste_interface__Ca_buffer__Ca_SLB_jct;
        const double var_x423 = 100 * var_chaste_interface__Ca_buffer__Ca_SLHigh_jct;
        const double var_x424 = 100 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x425 = 1.3 + var_x424;
        const double var_x426 = 0.029999999999999999 + var_x424;
        const double var_x427 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_Cytosol;
        const double var_x428 = -2.5 + var_x427;
        const double var_x429 = -var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_Cytosol - 0.030769230769230767 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL - 0.00078461538461538469 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x430 = 0.078461538461538471 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x431 = 3.0769230769230771 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL;
        const double var_x432 = var_x427 + var_x430 + var_x431;
        const double var_x433 = -2.5024999999999999 + 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL;
        const double var_x434 = -2.5490196078431375 + 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        const double var_x435 = 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol;
        const double var_x436 = -2.5 + var_x435;
        const double var_x437 = -var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol - 0.030769230769230767 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL - 0.00078461538461538469 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        const double var_x438 = 0.078461538461538471 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        const double var_x439 = 3.0769230769230771 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL;
        const double var_x440 = var_x435 + var_x438 + var_x439;
        const double var_x441 = -2.5024999999999999 + 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL;
        const double var_x442 = -2.5490196078431375 + 100 * var_chaste_interface__indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
        ...
        IJth(rJacobian, 3, 0) = var_x285 * (var_x286 * var_x288 + var_x265 * var_x284 * (-var_x286 - var_x289) / pow(var_x287, 2)) + (var_x286 + var_x289) * (var_x264 - var_chaste_interface__INa_j_gate__j + var_x284 * var_x288);
        ...
        IJth(rJacobian, 19, 0) = -var_x379 * (0.00026433000000000001 + var_x154 + var_x205 + 2.6699999999999999 * var_x77 + 5.0996999999999995 * var_x94 + 0.46858500000000003 * var_x112);
        IJth(rJacobian, 20, 0) = -var_x396 * (3.2670000000000004e-5 + var_x160 + var_x214 + 0.33000000000000002 * var_x64 + 0.63029999999999997 * var_x91 + 0.057915000000000008 * var_x115);
        IJth(rJacobian, 25, 0) = -var_x409 * (0.00022365699999999999 + var_x126 + var_x142 - var_x145 - 1.78 * var_x77 - 0.31239000000000006 * var_x112);
        IJth(rJacobian, 26, 0) = -var_x417 * (2.7642999999999999e-5 + var_x132 + var_x140 - var_x147 - 0.22 * var_x64 - 0.038610000000000005 * var_x115);
        ...
        IJth(rJacobian, 19, 4) = -165.83168702434122 * var_x169 * var_x380;
        IJth(rJacobian, 20, 4) = -803.76671393159438 * var_x168 * var_x380;
        ...
        IJth(rJacobian, 19, 12) = -var_x384 * var_x388;
        IJth(rJacobian, 20, 12) = -var_x384 * var_x399;
        IJth(rJacobian, 25, 12) = -var_x183 * var_x410;
        IJth(rJacobian, 26, 12) = -var_x182 * var_x419;
        ...
        IJth(rJacobian, 19, 13) = -var_x388 * var_x389;
        IJth(rJacobian, 20, 13) = -var_x389 * var_x399;
        IJth(rJacobian, 25, 13) = -var_x190 * var_x410;
        IJth(rJacobian, 26, 13) = -var_x189 * var_x419;
        ...
        IJth(rJacobian, 19, 14) = var_x104 * var_x149 * var_x387;
        IJth(rJacobian, 25, 14) = var_x120 * var_x410;
        ...
        IJth(rJacobian, 20, 15) = var_x156 * var_x398;
        IJth(rJacobian, 26, 15) = var_x120 * var_x130 * var_x418;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 - var_x368 + var_x366 * var_chaste_interface__Ca_buffer__Ca_jct;
        ...
        IJth(rJacobian, 17, 18) = -var_x368 + var_x365 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 18, 18) = -0.059999999999999998 + var_x366 * var_chaste_interface__Ca_buffer__Ca_jct;
        ...
        IJth(rJacobian, 19, 19) = (-2.5101556644976917 + var_x390 - var_x378 * (var_x206 + 8.0099999999999998 * var_x201 + 0.0013932654873301004 * var_x203 + var_x196 * var_x391)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 20, 19) = 1.0879068612142859 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 19) = 0.000165 - var_x390;
        IJth(rJacobian, 23, 19) = var_x404;
        IJth(rJacobian, 25, 19) = -var_x409 * (-5.3399999999999999 * var_x201 - var_x196 * var_x411);
        ...
        IJth(rJacobian, 20, 20) = (-1.0886629612142857 + var_x400 - var_x395 * (var_x215 + 0.98999999999999999 * var_x211 + 0.00017220135236664162 * var_x212 + var_x208 * var_x401)) * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 20) = 0.0007561 - var_x400;
        IJth(rJacobian, 26, 20) = -var_x417 * (-0.66000000000000003 * var_x211 - var_x208 * var_x420);
        IJth(rJacobian, 19, 21) = var_x392 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 21, 21) = -var_x392;
        IJth(rJacobian, 20, 22) = var_x402 * NV_Ith_S(mParameters, 3);
        IJth(rJacobian, 22, 22) = -var_x402;
        ...
        IJth(rJacobian, 24, 24) = -260 + var_x405 - var_x407 - 1.6231539579137989e-12 * var_x247 - 12.857532841472388 * var_x246;
        IJth(rJacobian, 26, 24) = var_x421;
        IJth(rJacobian, 31, 24) = 260 - var_x405;
        ...
        IJth(rJacobian, 19, 25) = -var_x379 * (1.3438550016e-10 * var_x219 - 2.6699999999999999 * var_x394 + var_x221 * var_x391);
        IJth(rJacobian, 25, 25) = -171.99023312516786 + var_x412 + var_x413 - var_x409 * (var_x224 + 1.78 * var_x394 - 8.9590333439999989e-11 * var_x219 - var_x221 * var_x411);
        IJth(rJacobian, 26, 25) = 48.958482036396518;
        IJth(rJacobian, 27, 25) = 121.55000000000001 - var_x412;
        IJth(rJacobian, 29, 25) = 43.550000000000004 - var_x413;
        IJth(rJacobian, 40, 25) = -var_x429 * var_x433;
        IJth(rJacobian, 43, 25) = -var_x437 * var_x441;
        ...
        IJth(rJacobian, 16, 26) = -var_x374 + var_x366 * var_chaste_interface__Jrel_SR__R;
        IJth(rJacobian, 17, 26) = var_x365 * var_chaste_interface__Jrel_SR__O + var_x373 * var_x376 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 18, 26) = var_x374 + var_x366 * var_chaste_interface__Jrel_SR__O;
        IJth(rJacobian, 20, 26) = -var_x396 * (1.6609443839999999e-11 * var_x227 - 0.33000000000000002 * var_x403 + var_x226 * var_x401);
        IJth(rJacobian, 24, 26) = var_x407;
        IJth(rJacobian, 25, 26) = 1.2484412919281114;
        IJth(rJacobian, 26, 26) = -128.61534478149457 + var_x422 + var_x423 - var_x421 - var_x417 * (var_x229 + 0.22 * var_x403 - 1.1072962559999999e-11 * var_x227 - var_x226 * var_x420);
        IJth(rJacobian, 28, 26) = 58.627450980392155 - var_x422;
        IJth(rJacobian, 30, 26) = 21.029411764705884 - var_x423;
        IJth(rJacobian, 41, 26) = -var_x429 * var_x434;
        IJth(rJacobian, 44, 26) = -var_x437 * var_x442;
        IJth(rJacobian, 25, 27) = var_x415;
        IJth(rJacobian, 27, 27) = -var_x415;
        IJth(rJacobian, 26, 28) = var_x425;
        IJth(rJacobian, 28, 28) = -var_x425;
        IJth(rJacobian, 25, 29) = var_x416;
        IJth(rJacobian, 29, 29) = -var_x416;
        IJth(rJacobian, 26, 30) = var_x426;
        IJth(rJacobian, 30, 30) = -var_x426;
        IJth(rJacobian, 24, 31) = var_x408;
        ...
        IJth(rJacobian, 39, 39) = -0.059999999999999998 + var_x428 * var_chaste_interface__Ca_buffer__Cai + var_x432 * var_chaste_interface__Ca_buffer__Cai;
        IJth(rJacobian, 40, 39) = var_x433 * var_chaste_interface__Ca_buffer__Ca_SL;
        IJth(rJacobian, 41, 39) = var_x434 * var_chaste_interface__Ca_buffer__Ca_jct;
        ...
        IJth(rJacobian, 40, 40) = -0.059999999999999998 + var_x432 * var_chaste_interface__Ca_buffer__Ca_SL + (-0.076999999999999999 + var_x431) * var_chaste_interface__Ca_buffer__Ca_SL;
        ...
        IJth(rJacobian, 41, 41) = -0.059999999999999998 + var_x432 * var_chaste_interface__Ca_buffer__Ca_jct + (-0.002 + var_x430) * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 42, 42) = -0.11 + var_x436 * var_chaste_interface__Ca_buffer__Cai + var_x440 * var_chaste_interface__Ca_buffer__Cai;
        IJth(rJacobian, 43, 42) = var_x441 * var_chaste_interface__Ca_buffer__Ca_SL;
        IJth(rJacobian, 44, 42) = var_x442 * var_chaste_interface__Ca_buffer__Ca_jct;
        ...
        IJth(rJacobian, 43, 43) = -0.11 + var_x440 * var_chaste_interface__Ca_buffer__Ca_SL + (-0.076999999999999999 + var_x439) * var_chaste_interface__Ca_buffer__Ca_SL;
        ...
        IJth(rJacobian, 44, 44) = -0.11 + var_x440 * var_chaste_interface__Ca_buffer__Ca_jct + (-0.002 + var_x438) * var_chaste_interface__Ca_buffer__Ca_jct;
    }
