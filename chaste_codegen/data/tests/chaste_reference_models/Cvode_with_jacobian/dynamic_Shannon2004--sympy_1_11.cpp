...
bool Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::registered = ModelFactory::Register("dynamic_Shannon2004", "AnalyticCvode", (ModelFactory::TCreateMethod)Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::CreateMethod);
    ...
    double Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IKs__pCa_SL = 3 - log10(var_chaste_interface__Ca_buffer__Ca_SL); // dimensionless
        ...
        const double var_IKs__pCa_jct = 3 - log10(var_chaste_interface__Ca_buffer__Ca_jct); // dimensionless
    ...
    void Dynamicshannon_wang_puglisi_weber_bers_2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x6 = exp(-7.0000000000000009 - 1.6666666666666667 * log10(var_chaste_interface__Ca_buffer__Ca_jct));
        ...
        const double var_x34 = var_x32 + 0.49124000000000001 * var_x33;
        ...
        const double var_x260 = var_x254 + var_x259;
        ...
        const double var_x285 = var_x275 + var_x284;
        ...
        const double var_x352 = -var_chaste_interface__ICaL_d_gate__d + var_x351;
        ...
        IJth(rJacobian, 2, 0) = var_x260 * (var_x261 * var_x265 + var_x254 * var_x264 * (-var_x261 - var_x266) / pow(var_x262, 2)) + (var_x261 + var_x266) * (var_x263 - var_chaste_interface__INa_h_gate__h + var_x254 * var_x265);
        IJth(rJacobian, 3, 0) = var_x285 * (var_x286 * var_x288 + var_x264 * var_x284 * (-var_x286 - var_x289) / pow(var_x287, 2)) + (var_x286 + var_x289) * (var_x263 - var_chaste_interface__INa_j_gate__j + var_x284 * var_x288);
