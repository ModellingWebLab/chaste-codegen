...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhilgemann_noble_model_1987FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x1 = 8.3333333333333339 * var_x0;
        const double var_x2 = 0.074867781645490947 * var_chaste_interface__membrane__V;
        const double var_x3 = 1 / var_chaste_interface__intracellular_potassium_concentration__K_i;
        ...
        const double var_x8 = exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V);
        const double var_x9 = -50.0 + var_chaste_interface__membrane__V;
        const double var_x10 = 1.0 - var_x8;
        ...
        const double var_x13 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x17 = var_x12 * var_x16;
        const double var_x18 = var_x17 * var_chaste_interface__second_inward_calcium_current_d_gate__d;
        const double var_x19 = var_x11 * var_x18;
        const double var_x20 = var_x19 * var_x9;
        const double var_x21 = var_x20 * var_x8;
        const double var_x22 = 0.018716945411372737 * var_chaste_interface__membrane__V;
        const double var_x23 = exp(-var_x22);
        const double var_x24 = var_x23 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x25 = exp(var_x22);
        const double var_x26 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        const double var_x27 = var_x26 * var_chaste_interface__extracellular_calcium_concentration__Ca_o;
        ...
        const double var_x30 = 1 / (1.0 + 0.0001 * var_x27 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x31 = var_x29 * var_x30;
        const double var_x32 = var_x31 * (0.018716945411372737 * var_x28 + 51359.298208806787 * var_x24);
        const double var_x33 = exp(3.7433890822745473 - var_x2);
        const double var_x34 = var_x33 * var_chaste_interface__extracellular_calcium_concentration__Ca_o;
        const double var_x35 = 1.0 - var_x33;
        const double var_x36 = 1 / var_x35;
        const double var_x37 = var_x18 * var_x9;
        const double var_x38 = var_x36 * var_x37;
        const double var_x39 = var_x34 * var_x38;
        const double var_x40 = exp(1.8716945411372736);
        const double var_x41 = -4.0 * var_x8 + var_x40 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x42 = 6.2389818037909115e-5 * var_x41;
        const double var_x43 = -140.0 * var_x8 + var_x40 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x44 = 0.00031194909018954561 * var_x43;
        const double var_x45 = var_x5 * (-26.713760659695652 * var_x4 + var_chaste_interface__membrane__V) / pow(var_x6, 2);
        const double var_x46 = exp(3.7433890822745473);
        const double var_x47 = -var_x34 + var_x46 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x48 = var_x36 * var_x47;
        const double var_x49 = 0.12477963607581824 * var_x48;
        const double var_x50 = var_x37 * var_x8 / pow(var_x10, 2);
        const double var_x51 = var_x41 * var_x50;
        const double var_x52 = var_x43 * var_x50;
        const double var_x53 = var_x33 * var_x37 * var_x47 / pow(var_x35, 2);
        const double var_x54 = 1 / var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x55 = var_x23 * var_x31;
        const double var_x56 = 0.12477963607581824 * var_x38;
        const double var_x57 = var_x28 - 2744000.0 * var_x24;
        const double var_x58 = var_x29 * var_x57 / pow((0.0036443148688046646 + 3.6443148688046648e-7 * var_x27 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x59 = var_x30 * var_x57 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x60 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x13, 2);
        const double var_x61 = var_x12 * (var_x60 - var_x14);
        const double var_x62 = var_x9 * var_chaste_interface__second_inward_calcium_current_d_gate__d;
        const double var_x63 = var_x61 * var_x62;
        const double var_x64 = var_x11 * var_x63;
        ...
        const double var_x68 = var_x17 * var_x9;
        const double var_x69 = var_x11 * var_x68;
        const double var_x70 = var_x16 * var_x62;
        ...
        const double var_x75 = var_x0 * (0.00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * var_chaste_interface__fast_sodium_current_h_gate__h / pow(var_x65, 2);
        const double var_x76 = var_x25 * var_x31;
        const double var_x77 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0) * var_chaste_interface__extracellular_calcium_concentration__Ca_o;
        const double var_x78 = var_x76 * var_x77;
        const double var_x79 = var_x20 * var_x40;
        const double var_x80 = var_x58 * var_x77;
        const double var_x81 = 1 / var_chaste_interface__extracellular_calcium_concentration__Ca_o;
        const double var_x82 = var_x26 * var_x76;
        const double var_x83 = var_x26 * var_x58;
        const double var_x84 = var_x3 * var_x7;
        const double var_x85 = var_x3 * var_x45;
        const double var_x86 = 4.9225225838744041e-6 * var_x48;
        ...
        const double var_x94 = 4.9225225838744041e-6 * var_x38;
        ...
        const double var_x104 = 0.44800000000000001 * var_x103 * var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x105 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x106 = fabs(var_x105) < 1.0000000000000001e-5;
        const double var_x107 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x117 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x118 = -1.0 + var_x117;
        const double var_x119 = 0.012 / var_x118;
        ...
        const double var_x126 = exp(-8.5 + var_x122);
        const double var_x127 = 1.0 + var_x126;
        const double var_x128 = 120.0 * var_x12;
        const double var_x129 = 0.0030000000000000001 * var_x126 * (var_x17 + var_x128 * var_x15) / pow(var_x127, 2);
        const double var_x130 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x131 = fabs(var_x130) < 0.0001;
        const double var_x132 = exp(8.5 + var_x121);
        ...
        const double var_x136 = var_x135 * (-1.0 - 119.0 * var_x15);
        ...
        const double var_x141 = 1.0 * var_x140 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x142 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2);
        const double var_x143 = 1.0 * var_x142;
        const double var_x144 = var_x143 / pow(var_x139, 3);
        const double var_x145 = var_x141 - var_x144;
        const double var_x146 = -0.59999999999999998 * var_x137;
        const double var_x147 = 0.5 * var_x140 * var_x142;
        const double var_x148 = 0.00065749545073783716 * var_x0;
        const double var_x149 = 2.4612612919372021e-8 * var_x43;
        const double var_x150 = 6.0300901652461443e-6 * var_x48;
        const double var_x151 = 6.0300901652461443e-6 * var_x38;
        const double var_x152 = 4.922522583874404e-9 * var_x41;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.031166666666666669 + 0.0060607251808254574 * var_x45 + 2.335493636882046e-6 * var_x51 + 0.0093419745475281837 * var_x53 + 1.167746818441023e-5 * var_x52 - 0.0093419745475281837 * var_x39 - 0.080952380952380956 * var_x7 - 0.0016441875203649604 * var_x21 - 0.0016666666666666668 * var_x32 - var_x1 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x18 * var_x49 - var_x19 * var_x42 - var_x19 * var_x44);
        IJth(rJacobian, 1, 0) = -3.2874772536891862e-8 + 3.6853834595450679e-7 * var_x53 + 1.3149909014756745e-7 * var_x32 - 3.6853834595450679e-7 * var_x39 - var_x18 * var_x86;
        IJth(rJacobian, 2, 0) = ((var_x106) ? (var_x104) : (var_x104 + var_x107 * var_x111 - 0.02 * var_x105 * var_x107 * var_x109 / pow(var_x110, 2)));
        ...
        IJth(rJacobian, 4, 0) = ((var_x116) ? (0) : (var_x120 * var_x125 - var_x119 * var_chaste_interface__second_inward_calcium_current_d_gate__d + 0.0012000000000000001 * var_x115 * var_x117 * var_chaste_interface__second_inward_calcium_current_d_gate__d / pow(var_x118, 2) - 0.0074999999999999997 * var_x115 * var_x120 * var_x123 / pow(var_x124, 2)));
        IJth(rJacobian, 5, 0) = ((var_x131) ? (var_x129) : (var_x129 - var_x134 * var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca + 0.0015625000000000001 * var_x130 * var_x132 * var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca / pow(var_x133, 2)));
        IJth(rJacobian, 6, 0) = 0.048000000000000001 * var_x137 * var_x138;
        IJth(rJacobian, 8, 0) = -1.5779890817708093e-7 + 9.2134586488626692e-10 * var_x52 - 1.2898842108407737e-7 * var_x21 - 3.9449727044270234e-7 * var_x32 - var_x148 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x149 * var_x19;
        IJth(rJacobian, 9, 0) = -4.0271596357692526e-8 + 4.5145947379427072e-7 * var_x53 - 4.5145947379427072e-7 * var_x39 - 8.0543192715385052e-8 * var_x32 - var_x150 * var_x18;
        IJth(rJacobian, 10, 0) = -2.2354845325086465e-6 + 1.8426917297725339e-10 * var_x51 + 4.7818790814779921e-7 * var_x45 - 7.3707669190901358e-10 * var_x21 - 6.3870986643104186e-6 * var_x7 - var_x152 * var_x19;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (4573.333333333333 * var_x55 + 6.0738581146744414e-6 * var_x58 + 1.15e-5 * var_x59 - 0.01113073360820652 * var_x54 - var_x42 * var_x64 - var_x44 * var_x64 - var_x46 * var_x56 - var_x49 * var_x63);
        IJth(rJacobian, 1, 1) = -17.0 + var_x87 + var_x88 + 0.0030000000000000001 * var_x92 - 0.0030000000000000001 * var_x90 - 9.0734372201821535e-10 * var_x59 - 4.3910440264623239e-7 * var_x54 - 4.7922408945906498e-10 * var_x58 - 0.36083350336492503 * var_x55 - 5.5200000000000005e-8 * var_x93 - var_x46 * var_x94 - var_x63 * var_x86;
        IJth(rJacobian, 5, 1) = var_x135 * (var_x61 + var_x128 * var_x14 - var_x128 * var_x60);
        IJth(rJacobian, 6, 1) = var_x138 * var_x145 + (var_x144 - var_x141) * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 7, 1) = var_x145 * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 8, 1) = 1.0825005100947751 * var_x55 + 2.7220311660546458e-9 * var_x59 + 1.4376722683771949e-9 * var_x58 - var_x149 * var_x64;
        IJth(rJacobian, 9, 1) = 2.9352475479367729e-10 * var_x58 + 5.5574802973615687e-10 * var_x59 + 0.22101052081101658 * var_x55 - 5.3790289324163455e-7 * var_x54 - var_x150 * var_x63 - var_x151 * var_x46;
        IJth(rJacobian, 10, 1) = -var_x152 * var_x64;
        ...
        IJth(rJacobian, 2, 2) = ((var_x106) ? (-2.0 + var_x112) : (var_x112 - var_x105 * var_x111));
        IJth(rJacobian, 8, 2) = -0.0019724863522135117 * var_x67;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x1 * var_x66);
        IJth(rJacobian, 3, 3) = -0.02 * var_x113 - 2.0 / (1.0 + 320.0 * var_x114);
        IJth(rJacobian, 8, 3) = -var_x148 * var_x66;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x42 * var_x69 - var_x44 * var_x69 - var_x49 * var_x68);
        IJth(rJacobian, 1, 4) = -var_x68 * var_x86;
        IJth(rJacobian, 4, 4) = ((var_x116) ? (-0.23999999999999999) : (-var_x115 * var_x119 - var_x115 * var_x125));
        IJth(rJacobian, 8, 4) = -var_x149 * var_x69;
        IJth(rJacobian, 9, 4) = -var_x150 * var_x68;
        IJth(rJacobian, 10, 4) = -var_x152 * var_x69;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x42 * var_x71 + var_x44 * var_x71 + var_x49 * var_x70);
        IJth(rJacobian, 1, 5) = var_x70 * var_x86;
        IJth(rJacobian, 5, 5) = ((var_x131) ? (-0.025000000000000001 + var_x136) : (var_x136 - var_x130 * var_x134));
        IJth(rJacobian, 8, 5) = var_x149 * var_x71;
        IJth(rJacobian, 9, 5) = var_x150 * var_x70;
        IJth(rJacobian, 10, 5) = var_x152 * var_x71;
        IJth(rJacobian, 1, 6) = var_x95 * var_x98 - var_x100 * var_x95;
        IJth(rJacobian, 6, 6) = -0.059999999999999998 + var_x146 - var_x140 * var_x143;
        IJth(rJacobian, 7, 6) = 0.059999999999999998 + var_x147;
        IJth(rJacobian, 12, 6) = var_x100 * var_x153 - var_x153 * var_x98;
        IJth(rJacobian, 6, 7) = var_x146 - var_x147;
        IJth(rJacobian, 7, 7) = -0.00059999999999999995;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (6.6405154314953803e-12 * var_x80 + 0.0011666666666666668 * var_x74 - 0.0050000000000000001 * var_x78 - 0.00031194909018954561 * var_x79 - 0.053427521319391304 * var_x72 - 1.8666666666666667 * var_x73 - 31272.909145617039 * var_x75);
        IJth(rJacobian, 1, 8) = 3.9449727044270234e-7 * var_x78 - 5.2393304241151422e-16 * var_x80;
        IJth(rJacobian, 8, 8) = 2.7614808930989161e-7 * var_x74 + 1.5717991272345426e-15 * var_x80 - 0.00044183694289582661 * var_x73 - 4.215402265403831e-6 * var_x72 - 2.4612612919372021e-8 * var_x79 - 2.4674154593497089 * var_x75 - 1.1834918113281069e-6 * var_x78;
        IJth(rJacobian, 9, 8) = 3.2090898847705241e-16 * var_x80 - 2.4162957814615514e-7 * var_x78;
        IJth(rJacobian, 10, 8) = 0.00029455796193055109 * var_x73 - 1.840987262065944e-7 * var_x74;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (2.2135051438317933e-12 * var_x83 + 0.01113073360820652 * var_x81 - 0.0016666666666666668 * var_x82 + var_x33 * var_x56);
        IJth(rJacobian, 1, 9) = 4.3910440264623239e-7 * var_x81 + 1.3149909014756745e-7 * var_x82 - 1.7464434747050473e-16 * var_x83 + var_x33 * var_x94;
        IJth(rJacobian, 8, 9) = 5.2393304241151422e-16 * var_x83 - 3.9449727044270234e-7 * var_x82;
        IJth(rJacobian, 9, 9) = -4.9999999999999998e-7 + 5.3790289324163455e-7 * var_x81 + 1.0696966282568414e-16 * var_x83 - 8.0543192715385052e-8 * var_x82 + var_x151 * var_x33;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (0.16190476190476191 * var_x85 - 2.1625425295944098 * var_x84 - 0.75688988535804347 * var_x3 - 6.2389818037909115e-5 * var_x79 - 3752.7490974740444 * var_x75);
        IJth(rJacobian, 8, 10) = -0.29608985512196506 * var_x75;
        IJth(rJacobian, 10, 10) = 1.2774197328620837e-5 * var_x85 - 4.922522583874404e-9 * var_x79 - 5.9718198759887604e-5 * var_x3 - 0.00017062342502825029 * var_x84;
        ...
        IJth(rJacobian, 13, 13) = -0.050000000000000003 + var_x154;
        IJth(rJacobian, 1, 14) = 0.20000000000000001 + var_x102;
        IJth(rJacobian, 14, 14) = -0.20000000000000001 + var_x154;
    }
