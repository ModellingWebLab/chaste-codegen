...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.001 / (0.02 + 0.019699999999999999 * exp(-pow((0.33700000000000002 + 0.033700000000000001 * var_chaste_interface__membrane__V), 2)));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (0.0037000000000000002 + 0.0061000000000000004 / (1 + exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__membrane__V)));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        ...
        const double var_non_specific_calcium_activated_current__i_ns_Ca = 3612.0012202503358 * _lt_0_row[3] * (-0.75 * mParameters[1] + 0.75 * var_chaste_interface__ionic_concentrations__Ki * _lt_0_row[2]) * var_chaste_interface__membrane__V * var_non_specific_calcium_activated_current__P_ns_Ca / (1 + 1.7279999999999996e-9 / pow(var_chaste_interface__calcium_dynamics__Cai, 3)) + 3612.0012202503358 * _lt_0_row[3] * (-0.75 * mParameters[2] + 0.75 * var_chaste_interface__ionic_concentrations__Nai * _lt_0_row[2]) * var_chaste_interface__membrane__V * var_non_specific_calcium_activated_current__P_ns_Ca / (1 + 1.7279999999999996e-9 / pow(var_chaste_interface__calcium_dynamics__Cai, 3)); // microA_per_microF
        ...
        const double var_plateau_potassium_current__i_Kp = 0.0055199999999999997 * _lt_0_row[8] * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V); // microA_per_microF
        const double var_rapid_delayed_rectifier_potassium_current__i_Kr_converted = 0.43033148291193518 * _lt_0_row[9] * sqrt(mParameters[1]) * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * HeartConfig::Instance()->GetCapacitance() * mParameters[6] * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr; // uA_per_cm2
...
// LCOV_EXCL_STOP
        ...
        const double var_calcium_background_current__E_Ca = 13.356169352749133 * log(mParameters[0] / var_chaste_interface__calcium_dynamics__Cai); // millivolt
        const double var_fast_sodium_current__E_Na = 26.712338705498265 * log(mParameters[2] / var_chaste_interface__ionic_concentrations__Nai); // millivolt
        const double var_L_type_Ca_channel__i_CaCa = 7.8019226357407252 * _lt_0_row[1] * (-0.34100000000000003 * mParameters[0] + 1 * var_chaste_interface__calcium_dynamics__Cai * _lt_0_row[0]) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_L_type_Ca_channel_f_Ca_gate__f_Ca * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V; // microA_per_microF
        ...
        const double var_L_type_Ca_channel__i_CaNa = 0.0024381008236689767 * _lt_0_row[3] * (-0.75 * mParameters[2] + 0.75 * var_chaste_interface__ionic_concentrations__Nai * _lt_0_row[2]) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_L_type_Ca_channel_f_Ca_gate__f_Ca * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V; // microA_per_microF
        const double var_Na_Ca_exchanger__i_NaCa = 0.002 * (pow(var_chaste_interface__ionic_concentrations__Nai, 3) * mParameters[0] * _lt_0_row[4] - pow(mParameters[2], 3) * var_chaste_interface__calcium_dynamics__Cai * _lt_0_row[5]) / ((1 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai) * (1 + 0.001 * pow(var_chaste_interface__ionic_concentrations__Nai, 3) * mParameters[0] + 0.001 * pow(mParameters[2], 3) * var_chaste_interface__calcium_dynamics__Cai)); // microA_per_microF
        const double var_T_type_Ca_channel__i_Ca_T = 0.050000000000000003 * pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2) * (-var_calcium_background_current__E_Ca + var_chaste_interface__membrane__V) * var_chaste_interface__T_type_Ca_channel_g_gate__g; // microA_per_microF
        const double var_calcium_background_current__i_Ca_b = 0.003016 * var_chaste_interface__membrane__V - 0.003016 * var_calcium_background_current__E_Ca; // microA_per_microF
        ...
        const double var_non_specific_calcium_activated_current__P_ns_Ca = 0; // cm_per_second
        const double var_non_specific_calcium_activated_current__i_ns_K = 3612.0012202503358 * _lt_0_row[3] * (-0.75 * mParameters[1] + 0.75 * var_chaste_interface__ionic_concentrations__Ki * _lt_0_row[2]) * var_chaste_interface__membrane__V * var_non_specific_calcium_activated_current__P_ns_Ca / (1 + 1.7279999999999996e-9 / pow(var_chaste_interface__calcium_dynamics__Cai, 3)); // microA_per_microF
        const double var_non_specific_calcium_activated_current__i_ns_Na = 3612.0012202503358 * _lt_0_row[3] * (-0.75 * mParameters[2] + 0.75 * var_chaste_interface__ionic_concentrations__Nai * _lt_0_row[2]) * var_chaste_interface__membrane__V * var_non_specific_calcium_activated_current__P_ns_Ca / (1 + 1.7279999999999996e-9 / pow(var_chaste_interface__calcium_dynamics__Cai, 3)); // microA_per_microF
        const double var_sarcolemmal_calcium_pump__i_p_Ca = 1.1499999999999999 * var_chaste_interface__calcium_dynamics__Cai / (0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai); // microA_per_microF
        const double var_slow_delayed_rectifier_potassium_current__i_Ks = (0.433 + 0.25979999999999998 / (1 + 6.4818210260626455e-7 * pow((1 / var_chaste_interface__calcium_dynamics__Cai), 1.3999999999999999))) * (-26.712338705498265 * log((0.018329999999999999 * mParameters[2] + mParameters[1]) / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki)) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2; // microA_per_microF
        const double var_sodium_background_current__i_Na_b = 0.0040000000000000001 * var_chaste_interface__membrane__V - 0.0040000000000000001 * var_fast_sodium_current__E_Na; // microA_per_microF
        const double var_sodium_potassium_pump__i_NaK = 2 * mParameters[1] / ((1 + 100 / pow(var_chaste_interface__ionic_concentrations__Nai, 2)) * (1.5 + mParameters[1]) * (1 + _lt_0_row[7] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[2])) * _lt_0_row[6])); // microA_per_microF
        ...
        const double var_ATP_sensitive_potassium_current__i_K_ATP = 1.921898339896919e-8 * pow(mParameters[1], 0.23999999999999999) * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V); // microA_per_microF
        const double var_plateau_potassium_current__i_Kp = 0.0055199999999999997 * _lt_0_row[8] * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V); // microA_per_microF
        const double var_rapid_delayed_rectifier_potassium_current__i_Kr = 0.43033148291193518 * _lt_0_row[9] * sqrt(mParameters[1]) * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[6] * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr; // microA_per_microF
...
// LCOV_EXCL_STOP
        ...
        const double var_Na_Ca_exchanger__i_NaCa = 0.002 * (pow(var_chaste_interface__ionic_concentrations__Nai, 3) * mParameters[0] * _lt_0_row[4] - pow(mParameters[2], 3) * var_chaste_interface__calcium_dynamics__Cai * _lt_0_row[5]) / ((1 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai) * (1 + 0.001 * pow(var_chaste_interface__ionic_concentrations__Nai, 3) * mParameters[0] + 0.001 * pow(mParameters[2], 3) * var_chaste_interface__calcium_dynamics__Cai)); // microA_per_microF
        const double var_T_type_Ca_channel__i_Ca_T = 0.050000000000000003 * pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2) * (-var_calcium_background_current__E_Ca + var_chaste_interface__membrane__V) * var_chaste_interface__T_type_Ca_channel_g_gate__g; // microA_per_microF
        const double d_dt_chaste_interface_var_T_type_Ca_channel_b_gate__b = 0.001 * _lt_0_row[13] * (-var_chaste_interface__T_type_Ca_channel_b_gate__b + _lt_0_row[12]); // 1 / millisecond
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x9 = 1 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai;
            const double var_x10 = 1 / var_x9;
            const double var_x11 = 1 + 0.001 * var_x2 + 0.001 * var_x6;
            const double var_x12 = 1 / var_x11;
            const double var_x13 = var_x10 * var_x12;
            const double var_x14 = 0.002 * var_x13;
            const double var_x15 = var_x14 * var_x8;
            const double var_x16 = 1 + 100 / pow(var_chaste_interface__ionic_concentrations__Nai, 2);
            const double var_x17 = 1 / var_x16;
            const double var_x18 = 2 * var_x17;
            const double var_x19 = 1 / (1.5 + mParameters[1]);
            const double var_x20 = exp(-0.003743588350780262 * var_chaste_interface__membrane__V);
            const double var_x21 = 0.037435883507802616 * var_chaste_interface__membrane__V;
            const double var_x22 = (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[2])) * exp(-var_x21);
            const double var_x23 = 1 + 0.1245 * var_x20 + 0.036499999999999998 * var_x22;
            const double var_x24 = pow(var_x23, (-2));
            const double var_x25 = 0.0013664097480347954 * var_x22 + 0.00046607674967214262 * var_x20;
            const double var_x26 = var_x19 * var_x24 * var_x25 * mParameters[1];
            const double var_x27 = pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2);
            const double var_x28 = var_x27 * var_chaste_interface__T_type_Ca_channel_g_gate__g;
            const double var_x29 = 0.050000000000000003 * var_x28;
            const double var_x30 = 1 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai;
            const double var_x31 = 1 / var_x30;
            const double var_x32 = var_x31 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
            ...
            const double var_x37 = var_x34 * var_chaste_interface__calcium_dynamics__Cai;
            const double var_x38 = 1 * var_x37 - 0.34100000000000003 * mParameters[0];
            const double var_x39 = var_x36 * var_x38;
            const double var_x40 = 7.8019226357407252 * var_x39;
            const double var_x41 = var_x33 * var_x40;
            const double var_x42 = var_x33 * var_chaste_interface__membrane__V;
            const double var_x43 = var_x36 * var_x42;
            const double var_x44 = var_x29 + var_x41 + 0.58414373385695628 * var_x37 * var_x43 - 0.58414373385695628 * var_x34 * var_x38 * var_x42 / pow(var_x35, 2);
            const double var_x45 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3);
            const double var_x46 = var_x45 * mParameters[4] * var_chaste_interface__fast_sodium_current_j_gate__j;
            const double var_x47 = var_x46 * var_chaste_interface__fast_sodium_current_h_gate__h;
            const double var_x48 = exp(var_x21);
            ...
            const double var_x53 = -0.75 * mParameters[2] + var_x52 * var_chaste_interface__ionic_concentrations__Nai;
            const double var_x54 = 0.0024381008236689767 * var_x53;
            const double var_x55 = var_x51 * var_x54;
            const double var_x56 = var_x48 * var_x51 * var_chaste_interface__membrane__V;
            const double var_x57 = var_x42 * var_x48 / pow(var_x49, 2);
            const double var_x58 = var_x47 + var_x55 + 6.8454343811362063e-5 * var_x56 * var_chaste_interface__ionic_concentrations__Nai - 9.1272458415149417e-5 * var_x53 * var_x57;
            ...
            const double var_x62 = 0.0055199999999999997 * var_x61;
            const double var_x63 = pow(mParameters[1], 0.23999999999999999);
            const double var_x64 = 1.921898339896919e-8 * var_x63;
            const double var_x65 = 1 / var_chaste_interface__calcium_dynamics__Cai;
            const double var_x66 = pow(var_x65, 1.3999999999999999);
            const double var_x67 = 1 + 6.4818210260626455e-7 * var_x66;
            const double var_x68 = 0.433 + 0.25979999999999998 / var_x67;
            const double var_x69 = var_x68 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
            ...
            const double var_x73 = -26.712338705498265 * var_x72 + var_chaste_interface__membrane__V;
            const double var_x74 = exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V);
            const double var_x75 = 1 + var_x74;
            const double var_x76 = sqrt(mParameters[1]);
            const double var_x77 = var_x76 * mParameters[6] / var_x75;
            ...
            const double var_x80 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * var_x72);
            const double var_x81 = 1 + var_x80;
            const double var_x82 = 1 / var_x81;
            const double var_x83 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * var_x72);
            const double var_x84 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * var_x72);
            const double var_x85 = var_x84 + 0.49124000000000001 * var_x83;
            const double var_x86 = exp(-2.4444678999999998 + 13.738155796237757 * var_x72 - 0.51429999999999998 * var_chaste_interface__membrane__V);
            const double var_x87 = 1 + var_x86;
            const double var_x88 = 1000 / var_x87;
            const double var_x89 = 1020 * var_x82 + var_x85 * var_x88;
            const double var_x90 = var_x76 * mParameters[5] / var_x89;
            const double var_x91 = var_x82 * var_x90;
            const double var_x92 = 438.93811257017387 * var_x91;
            const double var_x93 = -0.75 * mParameters[1] + var_x52 * var_chaste_interface__ionic_concentrations__Ki;
            const double var_x94 = 0.00069711623550831479 * var_x93;
            const double var_x95 = var_x51 * var_x94;
            const double var_x96 = pow(var_x81, (-2));
            const double var_x97 = var_x85 * var_x86 / pow(var_x87, 2);
            const double var_x98 = var_x73 * var_x76;
            const double var_x99 = 438.93811257017387 * var_x82 * var_x98 * mParameters[5] / pow(var_x89, 2);
            const double var_x100 = var_x80 * var_x96;
            const double var_x101 = var_x73 * var_x90;
            const double var_x102 = var_x62 + var_x64 + var_x70 + var_x79 + var_x92 + var_x95 + var_x99 * (-514.29999999999995 * var_x97 - var_x88 * (0.061749999999999999 * var_x84 + 0.039456396800000001 * var_x83) + 243.26999999999998 * var_x80 * var_x96) + 1.9572871637915374e-5 * var_x56 * var_chaste_interface__ionic_concentrations__Ki - 2.6097162183887167e-5 * var_x57 * var_x93 - 104.68673984798647 * var_x100 * var_x101 + 0.00092307692307692295 * var_x59 * var_x73 / pow(var_x60, 2) - 0.019211226915711394 * var_x74 * var_x98 * mParameters[6] * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / pow(var_x75, 2);
            const double var_x103 = 1 / mParameters[3];
            const double var_x104 = 0.001 * var_x103;
            
            partialF = -var_x104 * (0.0070159999999999997 + var_x102 + var_x15 + var_x44 + var_x58 + var_x18 * var_x26);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x106 = var_x105 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x30, 2);
            ...
            const double var_x113 = 13003.204392901209 * var_x106 * var_x39;
            const double var_x117 = var_x3 - var_x7;
            const double var_x118 = var_x117 * var_x12 / pow(var_x9, 2);
            const double var_x119 = var_x4 * var_x5;
            const double var_x120 = pow(var_x11, (-2));
            const double var_x121 = var_x10 * var_x117 * var_x120;
            const double var_x122 = var_x121 * var_x5;
            const double var_x123 = 1.9999999999999999e-6 * var_x122 + 0.28985507246376813 * var_x118 + var_x119 * var_x14;
            const double var_x135 = log(var_x65 * mParameters[0]);
            ...
            const double var_x175 = var_x123 + var_x174 - var_x112 - var_x113 + 0.040282206767891383 * var_x65 + 7.8019226357407252 * var_x34 * var_x43 + 0.6678084676374566 * var_x28 * var_x65;
            ...
            const double var_x179 = var_x117 * var_x14;
            const double var_x180 = -0.040282206767891383 * var_x135 + var_x136 * var_x29 + var_x174 * var_chaste_interface__calcium_dynamics__Cai + var_x41 * var_chaste_interface__membrane__V;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x236 = 1 - 1 * var_x228;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x245 = exp(-pow((0.33700000000000002 + 0.033700000000000001 * var_chaste_interface__membrane__V), 2));
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x256 = 0.0037000000000000002 + 0.0061000000000000004 / var_x255;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x258 = 0.012 - 0.00087500000000000002 * var_chaste_interface__membrane__V;
            const double var_x261 = 1 / var_x258;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x295 = exp(-3.6000000000000001 - var_x289);
            const double var_x296 = 1 + var_x295;
            const double var_x297 = var_x295 / var_x296;
            
            partialF = -10 * var_x293 - 10 * var_x297;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x316 = 1 + 8 / pow(var_x315, 2);
            const double var_x317 = 1 / var_x316;
            const double var_x318 = 0.001 * var_x317;
            
            partialF = var_x318 * (-5.5555555555555554 - var_x186) + 0.016 * (-var_x178 + 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR) / (pow(var_x315, 3) * pow(var_x316, 2));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative23(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x124 = 1 / var_chaste_interface__ionic_concentrations__Nai;
            const double var_x144 = var_x19 * mParameters[1] / var_x23;
            const double var_x145 = var_x144 / (pow(var_x16, 2) * pow(var_chaste_interface__ionic_concentrations__Nai, 3));
            const double var_x147 = pow(var_chaste_interface__ionic_concentrations__Nai, 2);
            const double var_x148 = var_x147 * mParameters[0];
            const double var_x149 = var_x1 * var_x148;
            const double var_x152 = 0.10684935482199306 * var_x124 + 0.0018285756177517324 * var_x56 + 26.712338705498265 * var_x124 * var_x47;
            const double var_x157 = 1 / M_PI;
            const double var_x322 = 0.00018063215662022267 * var_x157;
            
            partialF = var_x322 * (-var_x152 - 1200 * var_x145 - 0.018000000000000002 * var_x13 * var_x149 + 1.8e-5 * var_x10 * var_x117 * var_x120 * var_x147 * mParameters[0]);
        }
        else
        {
