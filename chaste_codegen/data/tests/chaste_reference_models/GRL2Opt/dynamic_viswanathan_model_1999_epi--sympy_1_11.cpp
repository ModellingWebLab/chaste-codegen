...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return -1 + exp(0.074871767015605231 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return -1 + exp(0.037435883507802616 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(4 + 0.125 * var_chaste_interface__membrane__V)) + 0.59999999999999998 / (1 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.0037000000000000002 + 0.0061000000000000004 / (1 + exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return ((var_chaste_interface__membrane__V < -40) ? (135 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return ((var_chaste_interface__membrane__V < -40) ? (3560 * exp(0.079000000000000001 * var_chaste_interface__membrane__V) + 310000000 * exp(0.34999999999999998 * var_chaste_interface__membrane__V)) : (7692.3076923076933 / (1 + exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return ((fabs(47.130000000000003 + var_chaste_interface__membrane__V) >= 1.0000000000000001e-5) ? (320 * (47.130000000000003 + var_chaste_interface__membrane__V) / (1 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V))) : (3200));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.60999999999999999 * (38.899999999999999 + var_chaste_interface__membrane__V) / (-1 + exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__membrane__V)) + 1.3799999999999999 * (14.199999999999999 + var_chaste_interface__membrane__V) / (1 - exp(-1.7465999999999999 - 0.123 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.13100000000000001 * (30 + var_chaste_interface__membrane__V) / (-1 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V)) + 0.071899999999999992 * (30 + var_chaste_interface__membrane__V) / (1 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.032750000000000001 * (30 + var_chaste_interface__membrane__V) / (-1 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V)) + 0.017974999999999998 * (30 + var_chaste_interface__membrane__V) / (1 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 15 / (1 + exp(12 + 0.20000000000000001 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 100 * exp(5 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1 + exp(5 + 0.20000000000000001 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 10000 * exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V) / (1 + exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 10000 * exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V) / (1 + exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_f_Ca_gate__f_Ca = 1 / (1 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai); // dimensionless
        ...
        const double var_slow_delayed_rectifier_potassium_current__i_Ks = (0.433 + 0.25979999999999998 / (1 + 6.4818210260626455e-7 * pow((1 / var_chaste_interface__calcium_dynamics__Cai), 1.3999999999999999))) * (-26.712338705498265 * log((0.018329999999999999 * mParameters[2] + mParameters[1]) / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki)) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2; // microA_per_microF
        ...
        const double var_sodium_potassium_pump__i_NaK = 2 * mParameters[1] / ((1 + 100 / pow(var_chaste_interface__ionic_concentrations__Nai, 2)) * (1.5 + mParameters[1]) * (1 + _lt_0_row[7] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[2])) * _lt_0_row[6])); // microA_per_microF
...
// LCOV_EXCL_STOP
        ...
        const double var_time_independent_potassium_current__i_K1 = 438.93811257017387 * sqrt(mParameters[1]) * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[5] / ((1 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 0.23849999999999999 * var_time_independent_potassium_current__E_K)) * (1020 / (1 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 0.23849999999999999 * var_time_independent_potassium_current__E_K)) + 1000 * (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 0.080320000000000003 * var_time_independent_potassium_current__E_K) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 0.061749999999999999 * var_time_independent_potassium_current__E_K)) / (1 + exp(-2.4444678999999998 + 0.51429999999999998 * var_time_independent_potassium_current__E_K - 0.51429999999999998 * var_chaste_interface__membrane__V)))); // microA_per_microF
        const double var_transient_outward_current__i_to = 0; // microA_per_microF
...
// LCOV_EXCL_STOP
        ...
        // Mathematics
        double d_dt_chaste_interface_var_membrane__V;
        const double d_dt_chaste_interface_var_calcium_dynamics__APtrack2 = 0.001 * (((var_chaste_interface__calcium_dynamics__APtrack > 0.17999999999999999) && (var_chaste_interface__calcium_dynamics__APtrack < 0.20000000000000001)) ? (100000 - 100500 * var_chaste_interface__calcium_dynamics__APtrack2) : (-500 * var_chaste_interface__calcium_dynamics__APtrack2)); // 1 / millisecond
        ...
        const double var_calcium_dynamics__i_up = 5 * var_chaste_interface__calcium_dynamics__Cai / (0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai); // millimolar_per_second
        ...
        const double d_dt_chaste_interface_var_calcium_dynamics__Ca_JSR = 0.001 * (-var_calcium_dynamics__i_rel + var_calcium_dynamics__i_tr) / (1 + 8 / pow((0.80000000000000004 + var_chaste_interface__calcium_dynamics__Ca_JSR), 2)); // millimolar / millisecond
        ...
        const double var_L_type_Ca_channel_d_gate__d_infinity = 1 / (1 + exp(-0.16025641025641024 * var_L_type_Ca_channel_d_gate__E0_d)); // dimensionless
        const double var_L_type_Ca_channel_d_gate__tau_d = ((fabs(var_L_type_Ca_channel_d_gate__E0_d) < 1.0000000000000001e-5) ? (0.0045787545787545781) : (0.028571428571428571 * (1 - exp(-0.16025641025641024 * var_L_type_Ca_channel_d_gate__E0_d)) * var_L_type_Ca_channel_d_gate__d_infinity / var_L_type_Ca_channel_d_gate__E0_d)); // second
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_channel_f_gate__f = 0.001 * (1 - var_chaste_interface__L_type_Ca_channel_f_gate__f) * var_L_type_Ca_channel_f_gate__f_infinity / var_L_type_Ca_channel_f_gate__tau_f - 0.001 * (1 - var_L_type_Ca_channel_f_gate__f_infinity) * var_chaste_interface__L_type_Ca_channel_f_gate__f / var_L_type_Ca_channel_f_gate__tau_f; // 1 / millisecond
        const double var_Na_Ca_exchanger__i_NaCa = 0.002 * (pow(var_chaste_interface__ionic_concentrations__Nai, 3) * mParameters[0] * _lt_0_row[4] - pow(mParameters[2], 3) * var_chaste_interface__calcium_dynamics__Cai * _lt_0_row[5]) / ((1 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai) * (1 + 0.001 * pow(var_chaste_interface__ionic_concentrations__Nai, 3) * mParameters[0] + 0.001 * pow(mParameters[2], 3) * var_chaste_interface__calcium_dynamics__Cai)); // microA_per_microF
        const double var_T_type_Ca_channel__i_Ca_T = 0.050000000000000003 * pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2) * (-var_calcium_background_current__E_Ca + var_chaste_interface__membrane__V) * var_chaste_interface__T_type_Ca_channel_g_gate__g; // microA_per_microF
        const double d_dt_chaste_interface_var_T_type_Ca_channel_b_gate__b = 0.001 * (-var_chaste_interface__T_type_Ca_channel_b_gate__b + _lt_0_row[12]) / (_lt_0_row[13]); // 1 / millisecond
        const double d_dt_chaste_interface_var_T_type_Ca_channel_g_gate__g = 0.001 * (-var_chaste_interface__T_type_Ca_channel_g_gate__g + _lt_0_row[14]) * ((var_chaste_interface__membrane__V <= 0) ? (1 / (0.012 - 0.00087500000000000002 * var_chaste_interface__membrane__V)) : (83.333333333333329)); // 1 / millisecond
        const double var_calcium_background_current__i_Ca_b = 0.003016 * var_chaste_interface__membrane__V - 0.003016 * var_calcium_background_current__E_Ca; // microA_per_microF
        const double var_fast_sodium_current__i_Na = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-var_fast_sodium_current__E_Na + var_chaste_interface__membrane__V) * mParameters[4] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j; // microA_per_microF
        const double d_dt_chaste_interface_var_fast_sodium_current_h_gate__h = 0.001 * (1 - var_chaste_interface__fast_sodium_current_h_gate__h) * _lt_0_row[15] - 0.001 * _lt_0_row[16] * var_chaste_interface__fast_sodium_current_h_gate__h; // 1 / millisecond
        const double d_dt_chaste_interface_var_fast_sodium_current_j_gate__j = 0.001 * (1 - var_chaste_interface__fast_sodium_current_j_gate__j) * _lt_0_row[17] - 0.001 * _lt_0_row[18] * var_chaste_interface__fast_sodium_current_j_gate__j; // 1 / millisecond
        const double d_dt_chaste_interface_var_fast_sodium_current_m_gate__m = 0.001 * (1 - var_chaste_interface__fast_sodium_current_m_gate__m) * _lt_0_row[19] - 0.080000000000000002 * var_chaste_interface__fast_sodium_current_m_gate__m * _lt_0_row[20]; // 1 / millisecond
        const double var_non_specific_calcium_activated_current__P_ns_Ca = 0; // cm_per_second
        const double var_non_specific_calcium_activated_current__i_ns_K = 3612.0012202503358 * (-0.75 * mParameters[1] + 0.75 * var_chaste_interface__ionic_concentrations__Ki * _lt_0_row[2]) * var_chaste_interface__membrane__V * var_non_specific_calcium_activated_current__P_ns_Ca / ((1 + 1.7279999999999996e-9 / pow(var_chaste_interface__calcium_dynamics__Cai, 3)) * (_lt_0_row[3])); // microA_per_microF
        const double var_non_specific_calcium_activated_current__i_ns_Na = 3612.0012202503358 * (-0.75 * mParameters[2] + 0.75 * var_chaste_interface__ionic_concentrations__Nai * _lt_0_row[2]) * var_chaste_interface__membrane__V * var_non_specific_calcium_activated_current__P_ns_Ca / ((1 + 1.7279999999999996e-9 / pow(var_chaste_interface__calcium_dynamics__Cai, 3)) * (_lt_0_row[3])); // microA_per_microF
        const double d_dt_chaste_interface_var_rapid_delayed_rectifier_potassium_current_xr_gate__xr = 0.001 * (-var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr + _lt_0_row[21]) * (_lt_0_row[22]); // 1 / millisecond
        const double var_sarcolemmal_calcium_pump__i_p_Ca = 1.1499999999999999 * var_chaste_interface__calcium_dynamics__Cai / (0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai); // microA_per_microF
        ...
        const double d_dt_chaste_interface_var_slow_delayed_rectifier_potassium_current_xs1_gate__xs1 = 0.001 * (-var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 + _lt_0_row[23]) * (_lt_0_row[24]); // 1 / millisecond
        const double var_slow_delayed_rectifier_potassium_current__i_Ks = (0.433 + 0.25979999999999998 / (1 + 6.4818210260626455e-7 * pow((1 / var_chaste_interface__calcium_dynamics__Cai), 1.3999999999999999))) * (-26.712338705498265 * log((0.018329999999999999 * mParameters[2] + mParameters[1]) / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki)) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2; // microA_per_microF
        const double d_dt_chaste_interface_var_slow_delayed_rectifier_potassium_current_xs2_gate__xs2 = 0.001 * (-var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2 + _lt_0_row[23]) * (_lt_0_row[25]); // 1 / millisecond
        const double var_sodium_background_current__i_Na_b = 0.0040000000000000001 * var_chaste_interface__membrane__V - 0.0040000000000000001 * var_fast_sodium_current__E_Na; // microA_per_microF
        const double var_sodium_potassium_pump__i_NaK = 2 * mParameters[1] / ((1 + 100 / pow(var_chaste_interface__ionic_concentrations__Nai, 2)) * (1.5 + mParameters[1]) * (1 + _lt_0_row[7] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[2])) * _lt_0_row[6])); // microA_per_microF
        ...
        const double var_membrane__dVdt = -(GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + var_ATP_sensitive_potassium_current__i_K_ATP + var_L_type_Ca_channel__i_CaCa + var_L_type_Ca_channel__i_CaK + var_L_type_Ca_channel__i_CaNa + var_Na_Ca_exchanger__i_NaCa + var_T_type_Ca_channel__i_Ca_T + var_calcium_background_current__i_Ca_b + var_fast_sodium_current__i_Na + var_non_specific_calcium_activated_current__i_ns_K + var_non_specific_calcium_activated_current__i_ns_Na + var_plateau_potassium_current__i_Kp + var_rapid_delayed_rectifier_potassium_current__i_Kr + var_sarcolemmal_calcium_pump__i_p_Ca + var_slow_delayed_rectifier_potassium_current__i_Ks + var_sodium_background_current__i_Na_b + var_sodium_potassium_pump__i_NaK + var_time_independent_potassium_current__i_K1 + var_transient_outward_current__i_to) / mParameters[3]; // dimensionless
        const double d_dt_chaste_interface_var_calcium_dynamics__APtrack = 0.001 * ((var_membrane__dVdt > 150000) ? (100000 - 100500 * var_chaste_interface__calcium_dynamics__APtrack) : (-500 * var_chaste_interface__calcium_dynamics__APtrack)); // 1 / millisecond
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x2 = pow(var_chaste_interface__ionic_concentrations__Nai, 3) * mParameters[0];
            const double var_x3 = var_x1 * var_x2;
            const double var_x4 = exp(-var_x0);
            const double var_x5 = pow(mParameters[2], 3);
            const double var_x6 = var_x5 * var_chaste_interface__calcium_dynamics__Cai;
            const double var_x7 = var_x4 * var_x6;
            const double var_x8 = 0.018717941753901308 * var_x3 + 0.018717941753901308 * var_x7;
            const double var_x9 = 1 / (1 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai);
            const double var_x10 = 1 + 0.001 * var_x2 + 0.001 * var_x6;
            const double var_x11 = 1 / var_x10;
            const double var_x12 = var_x11 * var_x9;
            const double var_x13 = 0.002 * var_x12;
            const double var_x14 = var_x13 * var_x8;
            const double var_x15 = pow(var_chaste_interface__ionic_concentrations__Nai, (-2));
            const double var_x16 = 1 / (1 + 100 * var_x15);
            const double var_x17 = 2 * var_x16;
            const double var_x18 = 1 / (1.5 + mParameters[1]);
            const double var_x19 = exp(-0.003743588350780262 * var_chaste_interface__membrane__V);
            const double var_x20 = 0.037435883507802616 * var_chaste_interface__membrane__V;
            const double var_x21 = (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[2])) * exp(-var_x20);
            const double var_x22 = 1 + 0.1245 * var_x19 + 0.036499999999999998 * var_x21;
            const double var_x23 = pow(var_x22, (-2));
            const double var_x24 = 0.0013664097480347954 * var_x21 + 0.00046607674967214262 * var_x19;
            const double var_x25 = var_x18 * var_x23 * var_x24 * mParameters[1];
            const double var_x26 = pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2);
            const double var_x27 = var_x26 * var_chaste_interface__T_type_Ca_channel_g_gate__g;
            const double var_x28 = 0.050000000000000003 * var_x27;
            ...
            const double var_x35 = var_x32 * var_chaste_interface__calcium_dynamics__Cai;
            const double var_x36 = var_x35 - 0.34100000000000003 * mParameters[0];
            const double var_x37 = var_x34 * var_x36;
            const double var_x38 = 7.8019226357407252 * var_x37;
            const double var_x39 = var_x31 * var_x38;
            const double var_x40 = var_x31 * var_chaste_interface__membrane__V;
            const double var_x41 = var_x34 * var_x40;
            const double var_x42 = var_x28 + var_x39 + 0.58414373385695628 * var_x35 * var_x41 - 0.58414373385695628 * var_x32 * var_x36 * var_x40 / pow(var_x33, 2);
            const double var_x43 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3);
            const double var_x44 = var_x43 * mParameters[4] * var_chaste_interface__fast_sodium_current_j_gate__j;
            const double var_x45 = var_x44 * var_chaste_interface__fast_sodium_current_h_gate__h;
            const double var_x46 = exp(var_x20);
            const double var_x47 = -1 + var_x46;
            const double var_x48 = 1 / var_x47;
            const double var_x49 = var_x31 * var_x48;
            const double var_x50 = 0.75 * var_x46;
            const double var_x51 = -0.75 * mParameters[2] + var_x50 * var_chaste_interface__ionic_concentrations__Nai;
            const double var_x52 = 0.0024381008236689767 * var_x51;
            const double var_x53 = var_x49 * var_x52;
            const double var_x54 = var_x46 * var_x49 * var_chaste_interface__membrane__V;
            const double var_x55 = var_x40 * var_x46 / pow(var_x47, 2);
            const double var_x56 = var_x45 + var_x53 + 6.8454343811362063e-5 * var_x54 * var_chaste_interface__ionic_concentrations__Nai - 9.1272458415149417e-5 * var_x51 * var_x55;
            const double var_x57 = exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V);
            const double var_x58 = 1 + var_x57;
            const double var_x59 = 1 / var_x58;
            const double var_x60 = 0.0055199999999999997 * var_x59;
            const double var_x61 = pow(mParameters[1], 0.23999999999999999);
            const double var_x62 = 1.921898339896919e-8 * var_x61;
            const double var_x63 = 1 / var_chaste_interface__calcium_dynamics__Cai;
            const double var_x64 = pow(var_x63, 1.3999999999999999);
            const double var_x65 = 1 + 6.4818210260626455e-7 * var_x64;
            const double var_x66 = 0.433 + 0.25979999999999998 / var_x65;
            const double var_x67 = var_x66 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
            const double var_x68 = var_x67 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
            const double var_x69 = 1 / var_chaste_interface__ionic_concentrations__Ki;
            const double var_x70 = log(var_x69 * mParameters[1]);
            const double var_x71 = -26.712338705498265 * var_x70 + var_chaste_interface__membrane__V;
            const double var_x72 = exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V);
            const double var_x73 = 1 + var_x72;
            const double var_x74 = sqrt(mParameters[1]);
            const double var_x75 = var_x74 * mParameters[6] / var_x73;
            const double var_x76 = var_x75 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr;
            const double var_x77 = 0.43033148291193518 * var_x76;
            const double var_x78 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * var_x70);
            const double var_x79 = 1 + var_x78;
            const double var_x80 = 1 / var_x79;
            const double var_x81 = exp(-2.4444678999999998 + 13.738155796237757 * var_x70 - 0.51429999999999998 * var_chaste_interface__membrane__V);
            const double var_x82 = 1 + var_x81;
            const double var_x83 = 1 / var_x82;
            const double var_x84 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * var_x70);
            const double var_x85 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * var_x70);
            const double var_x86 = var_x85 + 0.49124000000000001 * var_x84;
            const double var_x87 = var_x83 * var_x86;
            const double var_x88 = 1 / (1000 * var_x87 + 1020 * var_x80);
            const double var_x89 = var_x74 * var_x80 * mParameters[5];
            const double var_x90 = var_x88 * var_x89;
            const double var_x91 = 438.93811257017387 * var_x90;
            const double var_x92 = -0.75 * mParameters[1] + var_x50 * var_chaste_interface__ionic_concentrations__Ki;
            const double var_x93 = 0.00069711623550831479 * var_x92;
            const double var_x94 = var_x49 * var_x93;
            const double var_x95 = 1000 * var_x83;
            const double var_x96 = pow(var_x79, (-2));
            const double var_x97 = var_x81 * var_x86 / pow(var_x82, 2);
            const double var_x98 = 0.0004218936106979757 * var_x71 * var_x89 / pow((var_x80 + 0.98039215686274506 * var_x87), 2);
            const double var_x99 = var_x71 * var_x74;
            const double var_x100 = var_x78 * var_x96;
            const double var_x101 = var_x88 * var_x99 * mParameters[5];
            const double var_x102 = var_x60 + var_x62 + var_x68 + var_x77 + var_x91 + var_x94 + var_x98 * (-514.29999999999995 * var_x97 - var_x95 * (0.061749999999999999 * var_x85 + 0.039456396800000001 * var_x84) + 243.26999999999998 * var_x78 * var_x96) + 1.9572871637915374e-5 * var_x54 * var_chaste_interface__ionic_concentrations__Ki - 2.6097162183887167e-5 * var_x55 * var_x92 - 104.68673984798647 * var_x100 * var_x101 + 0.00092307692307692295 * var_x57 * var_x71 / pow(var_x58, 2) - 0.019211226915711394 * var_x72 * var_x99 * mParameters[6] * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / pow(var_x73, 2);
            const double var_x103 = 1 / mParameters[3];
            const double var_x104 = 0.001 * var_x103;
            
            partialF = -var_x104 * (0.0070159999999999997 + var_x102 + var_x14 + var_x42 + var_x56 + var_x17 * var_x25);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x41 = var_x34 * var_x40;
            const double var_x63 = 1 / var_chaste_interface__calcium_dynamics__Cai;
            const double var_x105 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__membrane__V;
            const double var_x106 = var_x105 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
            const double var_x109 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai;
            const double var_x110 = 1 / var_x109;
            const double var_x111 = pow(var_x109, (-2));
            const double var_x112 = 1.1499999999999999 * var_x111 * var_chaste_interface__calcium_dynamics__Cai;
            const double var_x113 = 0.0046811535814444347 * var_x106 * var_x37;
            const double var_x117 = var_x3 - var_x7;
            const double var_x118 = var_x11 * var_x117 / pow((0.0068999999999999999 + var_chaste_interface__calcium_dynamics__Cai), 2);
            const double var_x119 = var_x4 * var_x5;
            const double var_x120 = pow(var_x10, (-2));
            const double var_x121 = var_x117 * var_x120 * var_x9;
            const double var_x122 = var_x121 * var_x5;
            const double var_x123 = 1.38e-5 * var_x118 + 1.9999999999999999e-6 * var_x122 + var_x119 * var_x13;
            const double var_x135 = log(var_x63 * mParameters[0]);
            const double var_x136 = -13.356169352749133 * var_x135 + var_chaste_interface__membrane__V;
            const double var_x154 = 0.0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
            const double var_x155 = 1 + 0.00011900000000000002 / pow(var_x154, 2) + 3.5000000000000004e-5 * var_x111;
            const double var_x156 = 1 / var_x155;
            const double var_x157 = 1 / M_PI;
            const double var_x160 = 0.00062 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
            const double var_x161 = 1 / var_x160;
            const double var_x162 = 1 - var_chaste_interface__calcium_dynamics__APtrack2;
            const double var_x163 = -0.00018000000000000001 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
            const double var_x164 = 60000 * var_x161 * var_x162 * var_x163 * var_chaste_interface__calcium_dynamics__APtrack2;
            const double var_x165 = var_chaste_interface__calcium_dynamics__Cainfluxtrack > 0.00018000000000000001;
            const double var_x166 = 1 - var_chaste_interface__calcium_dynamics__OVRLDtrack2;
            const double var_x167 = 4000 * var_x166 * var_chaste_interface__calcium_dynamics__OVRLDtrack2;
            const double var_x168 = var_chaste_interface__calcium_dynamics__OVRLDtrack2 > 0;
            const double var_x169 = ((var_x165) ? (-var_x164) : ((var_x168) ? (-var_x167) : (0)));
            const double var_x170 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
            const double var_x171 = 1 / var_x170;
            const double var_x172 = 0.40588235294117642 * var_x171;
            const double var_x173 = var_chaste_interface__calcium_dynamics__Cai / pow(var_x170, 2);
            const double var_x174 = 1.1499999999999999 * var_x110;
            const double var_x175 = var_x123 + var_x174 - var_x112 - var_x113 + 0.040282206767891383 * var_x63 + 7.8019226357407252 * var_x32 * var_x41 + 0.6678084676374566 * var_x27 * var_x63;
            const double var_x176 = 0.090316078310111333 * var_x157;
            const double var_x177 = -var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR;
            const double var_x178 = ((var_x165) ? (var_x164 * var_x177) : ((var_x168) ? (var_x167 * var_x177) : (0)));
            const double var_x179 = var_x117 * var_x13;
            const double var_x180 = -0.040282206767891383 * var_x135 + var_x136 * var_x28 + var_x174 * var_chaste_interface__calcium_dynamics__Cai + var_x39 * var_chaste_interface__membrane__V;
            
            partialF = 0.001 * var_x156 * (-var_x172 + 0.40588235294117642 * var_x173 + 0.0070588235294117632 * var_x169 - var_x175 * var_x176) + 0.001 * (0.00023800000000000004 / pow(var_x154, 3) + 7.0000000000000007e-5 / pow(var_x109, 3)) * (0.027058823529411764 * var_chaste_interface__calcium_dynamics__Ca_NSR + 0.0070588235294117632 * var_x178 - var_x172 * var_chaste_interface__calcium_dynamics__Cai - var_x176 * (var_x180 - var_x179 + 0.003016 * var_chaste_interface__membrane__V)) / pow(var_x155, 2);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x196 = exp(-4.7130000000000001 - var_x195);
            const double var_x197 = 1 - var_x196;
            const double var_x198 = 0.32000000000000001 / var_x197;
            const double var_x199 = 47.130000000000003 + var_chaste_interface__membrane__V;
            const double var_x200 = fabs(var_x199) >= 1.0000000000000001e-5;
            const double var_x201 = 0.080000000000000002 * var_x192;
            
            partialF = ((var_x200) ? (-var_x201 - var_x198 * var_x199) : (-3.2000000000000002 - var_x201));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x202 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
            const double var_x203 = exp(0.34999999999999998 * var_chaste_interface__membrane__V);
            const double var_x204 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x205 = var_chaste_interface__membrane__V < -40;
            const double var_x206 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x207 = 1 + var_x206;
            
            partialF = ((var_x205) ? (-310000 * var_x203 - 0.13500000000000001 * var_x204 - 3.5600000000000001 * var_x202) : (-7.6923076923076934 / var_x207));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x211 = -127140 * var_x209 - 3.4740000000000003e-5 * var_x210;
            ...
            const double var_x218 = exp(-0.01052 * var_chaste_interface__membrane__V);
            const double var_x219 = var_x218 / var_x217;
            const double var_x220 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x221 = var_x215 * var_x220;
            const double var_x222 = exp(-3.2000000000000002 - var_x195);
            const double var_x223 = 1 + var_x222;
            const double var_x224 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V);
            const double var_x225 = var_x224 / var_x223;
            
            partialF = ((var_x205) ? (-0.1212 * var_x219 - var_x211 * var_x221) : (-0.29999999999999999 * var_x225));
        }
        else
        {
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x226 = exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V);
            const double var_x227 = 1 + var_x226;
            const double var_x228 = 1 / var_x227;
            const double var_x230 = 10 + var_chaste_interface__membrane__V;
            const double var_x231 = fabs(var_x230) < 1.0000000000000001e-5;
            const double var_x232 = 1 - var_x226;
            const double var_x233 = 1 / var_x232;
            const double var_x236 = 1 - var_x228;
            const double var_x237 = ((var_x231) ? (218.40000000000003) : (35 * var_x227 * var_x230 * var_x233));
            const double var_x239 = 0.001 * var_x237;
            
            partialF = -var_x228 * var_x239 - var_x236 * var_x239;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x240 = exp(4 + 0.125 * var_chaste_interface__membrane__V);
            ...
            const double var_x245 = exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
            const double var_x246 = 20 + 19.699999999999999 * var_x245;
            const double var_x247 = 0.001 * var_x246;
            const double var_x249 = 1 / var_x241 + 0.59999999999999998 / var_x243;
            const double var_x250 = 1 - var_x249;
            
            partialF = -var_x247 * var_x249 - var_x247 * var_x250;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x262 = var_chaste_interface__membrane__V <= 0;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x271 = 14.199999999999999 + var_chaste_interface__membrane__V;
            const double var_x272 = 38.899999999999999 + var_chaste_interface__membrane__V;
            
            partialF = -0.0013799999999999999 * var_x270 * var_x271 - 0.00060999999999999997 * var_x267 * var_x272;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative10(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x276 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V);
            const double var_x277 = -1 + var_x276;
            const double var_x278 = 1 / var_x277;
            const double var_x279 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V);
            const double var_x280 = 1 - var_x279;
            const double var_x281 = 1 / var_x280;
            const double var_x282 = 30 + var_chaste_interface__membrane__V;
            const double var_x286 = var_x278 * var_x282;
            const double var_x287 = var_x281 * var_x282;
            
            partialF = -0.00013100000000000001 * var_x286 - 7.1899999999999999e-5 * var_x287;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -3.2750000000000003e-5 * var_x286 - 1.7975e-5 * var_x287;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x288 = 0.040000000000000001 * var_chaste_interface__membrane__V;
            const double var_x289 = exp(-1.6000000000000001 + var_x288);
            const double var_x290 = 1 + var_x289;
            const double var_x291 = 1 / var_x290;
            const double var_x292 = var_x289 * var_x291;
            const double var_x293 = exp(-3.6000000000000001 - var_x288);
            const double var_x294 = 1 + var_x293;
            const double var_x295 = var_x293 / var_x294;
            
            partialF = -10 * var_x292 - 10 * var_x295;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x301 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x302 = exp(12 + var_x301);
            const double var_x303 = 1 + var_x302;
            const double var_x304 = 1 / var_x303;
            const double var_x305 = exp(5 + var_x301);
            const double var_x306 = 1 + var_x305;
            const double var_x307 = 1 / var_x306;
            const double var_x308 = var_x305 * var_x307;
            
            partialF = -0.014999999999999999 * var_x304 - 0.10000000000000001 * var_x308;
        }
        else
        {
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x177 = -var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR;
            const double var_x178 = ((var_x165) ? (var_x164 * var_x177) : ((var_x168) ? (var_x167 * var_x177) : (0)));
            const double var_x186 = ((var_x165) ? (var_x164) : ((var_x168) ? (var_x167) : (0)));
            const double var_x313 = 0.80000000000000004 + var_chaste_interface__calcium_dynamics__Ca_JSR;
            const double var_x314 = pow(var_x313, (-2));
            const double var_x315 = 1 / (1 + 8 * var_x314);
            const double var_x316 = 0.001 * var_x315;
            
            partialF = var_x316 * (-5.5555555555555554 - var_x186) + 0.00025000000000000001 * (-var_x178 + 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR) / (pow(var_x313, 3) * pow((0.125 + var_x314), 2));
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x115 = -26.712338705498265 * log(var_x114 * (0.018329999999999999 * mParameters[2] + mParameters[1])) + var_chaste_interface__membrane__V;
            const double var_x117 = var_x3 - var_x7;
            const double var_x124 = 1 / var_chaste_interface__ionic_concentrations__Nai;
            const double var_x125 = log(var_x124 * mParameters[2]);
            const double var_x126 = -26.712338705498265 * var_x125 + var_chaste_interface__membrane__V;
            const double var_x135 = log(var_x63 * mParameters[0]);
            const double var_x136 = -13.356169352749133 * var_x135 + var_chaste_interface__membrane__V;
            const double var_x149 = var_x18 * mParameters[1] / var_x22;
            const double var_x174 = 1.1499999999999999 * var_x110;
            const double var_x179 = var_x117 * var_x13;
            const double var_x180 = -0.040282206767891383 * var_x135 + var_x136 * var_x28 + var_x174 * var_chaste_interface__calcium_dynamics__Cai + var_x39 * var_chaste_interface__membrane__V;
            
            partialF = ((var_x103 * (var_x179 + var_x180 + 0.0070159999999999997 * var_chaste_interface__membrane__V - 0.10684935482199306 * var_x125 + var_x115 * var_x68 + var_x126 * var_x45 + var_x149 * var_x17 + var_x53 * var_chaste_interface__membrane__V + var_x60 * var_x71 + var_x62 * var_x71 + var_x71 * var_x77 + var_x71 * var_x91 + var_x94 * var_chaste_interface__membrane__V + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance()) < -150000) ? (-100.5) : (-0.5));
        }
        else
        {
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x317 = (var_chaste_interface__calcium_dynamics__APtrack > 0.17999999999999999) && (var_chaste_interface__calcium_dynamics__APtrack < 0.20000000000000001);
            
            partialF = ((var_x317) ? (-100.5) : (-0.5));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative19(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x318 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
            
            partialF = (((var_x318) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-0.5));
        }
        else
        {
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (((var_chaste_interface__calcium_dynamics__APtrack3 < 0.37) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.37) && (1 / (1 + 0.80000000000000004 / var_chaste_interface__calcium_dynamics__Ca_JSR) > 0.69999999999999996)) ? (-50) : (-0.5));
        }
        else
        {
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative21(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x319 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
            
            partialF = (((var_x319) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50) : (-0.5));
        }
        else
        {
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = (((var_x319) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50) : (-0.01));
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicviswanathan_model_1999_epiFromCellMLGRL2Opt::EvaluatePartialDerivative23(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x120 = pow(var_x10, (-2));
            const double var_x124 = 1 / var_chaste_interface__ionic_concentrations__Nai;
            const double var_x145 = pow(var_chaste_interface__ionic_concentrations__Nai, 2);
            const double var_x146 = var_x145 * mParameters[0];
            const double var_x147 = var_x1 * var_x146;
            const double var_x149 = var_x18 * mParameters[1] / var_x22;
            const double var_x150 = var_x149 / (pow((0.01 + var_x15), 2) * pow(var_chaste_interface__ionic_concentrations__Nai, 3));
            const double var_x152 = 0.10684935482199306 * var_x124 + 0.0018285756177517324 * var_x54 + 26.712338705498265 * var_x124 * var_x45;
            const double var_x157 = 1 / M_PI;
            const double var_x320 = 0.00018063215662022267 * var_x157;
            
            partialF = var_x320 * (-var_x152 - 0.12 * var_x150 - 0.018000000000000002 * var_x12 * var_x147 + 1.8e-5 * var_x117 * var_x120 * var_x145 * var_x9 * mParameters[0]);
        }
        else
        {
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel__I_CaCa = 4 * pow(var_membrane__F, 2) * (-var_L_type_Ca_channel__gamma_Cao * mParameters[0] + var_L_type_Ca_channel__gamma_Cai * var_chaste_interface__calcium_dynamics__Cai * exp(2 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * var_L_type_Ca_channel__P_Ca * var_chaste_interface__membrane__V / ((-1 + exp(2 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * var_membrane__R * var_membrane__T); // microA_per_microF
        ...
        const double var_time_independent_potassium_current_K1_gate__alpha_K1 = 1020 / (1 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 0.23849999999999999 * var_time_independent_potassium_current__E_K)); // per_second
        const double var_time_independent_potassium_current_K1_gate__beta_K1 = 1000 * (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 0.080320000000000003 * var_time_independent_potassium_current__E_K) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 0.061749999999999999 * var_time_independent_potassium_current__E_K)) / (1 + exp(-2.4444678999999998 + 0.51429999999999998 * var_time_independent_potassium_current__E_K - 0.51429999999999998 * var_chaste_interface__membrane__V)); // per_second
