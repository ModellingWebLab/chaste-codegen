...
class Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables()
    {
...
protected:
    Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables(const Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables&);
    Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables& operator= (const Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables&);
    Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables()
    {
        ...
        Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables::RegenerateTables();
    }
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = 1.0 + 0.1245 * exp(-0.0038949423064193493 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.038949423064193495 * var_chaste_interface__membrane__V);
            ...
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = 1 / (0.39395599999999997 + 0.188495 * exp(-0.42168674698795178 - 0.060240963855421679 * var_chaste_interface__membrane__V));
...
private:
    ...
    static std::shared_ptr<Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables> mpInstance;
...
std::shared_ptr<Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables> Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt::GetLookupTableCollection()
    {
        return Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables::Instance();
    }
    ...
    double Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicbondarenko_model_2004_apexFromCellMLRushLarsenOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
        ...
        const double var_calcium_activated_chloride_current__i_ClCa = 2.0 * (40.0 + var_chaste_interface__membrane__V) * var_chaste_interface__calcium_concentration__Cai / ((_lt_0_row[0]) * (10.0 + var_chaste_interface__calcium_concentration__Cai)); // picoA_per_picoF
        ...
        const double var_sodium_calcium_exchange_current__i_NaCa = 2.6970585464294846e-17 * (1800.0 * pow(var_chaste_interface__sodium_concentration__Nai, 3) * _lt_0_row[1] - 2744000000000000.0 * var_chaste_interface__calcium_concentration__Cai * _lt_0_row[2]) / (_lt_0_row[3]); // picoA_per_picoF
        const double var_sodium_potassium_pump_current__i_NaK = 0.68869565217391304 / ((1.0 + 3043189.1166997822 * pow((1 / var_chaste_interface__sodium_concentration__Nai), 1.5)) * (_lt_0_row[4])); // picoA_per_picoF
