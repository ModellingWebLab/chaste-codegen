...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 - CHASTE_MATH::Exp(-CHASTE_CONST(3.3919999999999999) - CHASTE_CONST(0.128) * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_calcium_fluxes__P_RyR = -CHASTE_CONST(0.040000000000000001) * var_chaste_interface__calcium_fluxes__P_RyR - CHASTE_CONST(0.10000000000000001) * var_L_type_calcium_current__i_CaL * _lt_0_row[9] / var_L_type_calcium_current__i_CaL_max; // 1 / millisecond
        ...
        const double var_fast_transient_outward_potassium_current__alpha_a = CHASTE_CONST(0.18064) * _lt_0_row[17]; // per_millisecond
        const double var_fast_transient_outward_potassium_current__alpha_i = CHASTE_CONST(0.00015200000000000001) * _lt_0_row[20] / (_lt_0_row[19]); // per_millisecond
        const double var_fast_transient_outward_potassium_current__beta_a = CHASTE_CONST(0.39560000000000001) * _lt_0_row[18]; // per_millisecond
        const double var_fast_transient_outward_potassium_current__beta_i = CHASTE_CONST(0.00095) * _lt_0_row[22] / (_lt_0_row[21]); // per_millisecond
        ...
        const double var_rapid_delayed_rectifier_potassium_current__alpha_a0 = CHASTE_CONST(0.022348) * _lt_0_row[27]; // per_millisecond
        ...
        const double var_rapid_delayed_rectifier_potassium_current__beta_a0 = CHASTE_CONST(0.047002000000000002) * _lt_0_row[28]; // per_millisecond
        ...
        const double var_slow_delayed_rectifier_potassium_current__alpha_n = CHASTE_CONST(4.8133299999999997e-6) * (CHASTE_CONST(26.5) + var_chaste_interface__membrane__V) / (_lt_0_row[30]); // per_millisecond
        const double var_slow_delayed_rectifier_potassium_current__beta_n = CHASTE_CONST(9.5333299999999997e-5) * _lt_0_row[29]; // per_millisecond
        ...
        else
        {
            ...
            const double var_calcium_activated_chloride_current__O_ClCa = CHASTE_CONST(0.20000000000000001) / (_lt_0_row[0]); // dimensionless
