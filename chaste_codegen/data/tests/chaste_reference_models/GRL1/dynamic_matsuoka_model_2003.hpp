...
class Dynamicmatsuoka_model_2003FromCellMLGRL1 : public AbstractCardiacCellWithModifiers<AbstractGeneralizedRushLarsenCardiacCell >, public AbstractDynamicallyLoadableEntity
{
    ...
    std::shared_ptr<AbstractModifier> mp_membrane_capacitance_modifier;
    std::shared_ptr<AbstractModifier> mp_membrane_voltage_modifier;

public:

    std::shared_ptr<RegularStimulus> UseCellMLDefaultStimulus();
    Dynamicmatsuoka_model_2003FromCellMLGRL1(std::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, std::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
