...
#include "MathsCustomFunctions.hpp"
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x27 = exp(-1.5 - 0.025000000000000001 * var_chaste_interface__membrane__V);
            const double var_x28 = 0.621 + var_chaste_interface__cleft_space_equations__K_c;
            const double var_x29 = pow(var_x28, (-2));
            const double var_x30 = pow(var_chaste_interface__cleft_space_equations__K_c, 2);
            const double var_x31 = 1 + 0.18315018315018314 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i;
            const double var_x32 = pow(var_x31, (-3));
            const double var_x33 = pow((1 + 0.66666666666666663 * var_x27), (-2));
            const double var_x34 = var_x11 * var_x27 * var_x29 * var_x30 * var_x32 * var_x33;
            ...
            const double var_x38 = exp(var_x35 - 1 * log(var_x37));
            ...
            const double var_x45 = var_x43 * var_x44 * mParameters[3] * var_chaste_interface__sodium_current_h_gate__h1 * var_chaste_interface__sodium_current_h_gate__h2;
            const double var_x46 = 3611.8217397063127 * var_x45;
            const double var_x47 = var_x45 * var_chaste_interface__membrane__V;
            const double var_x48 = var_x38 * var_x47;
            const double var_x49 = var_x48 * var_chaste_interface__cleft_space_equations__Na_c;
            const double var_x50 = pow(var_x42, (-2));
            const double var_x51 = 1 / mParameters[1];
            const double var_x52 = 0.001 * var_x51;
            
            partialF = var_x52 * (-0.00026580000000000001 - var_x1 - var_x2 - var_x7 - 0.02521 * var_x8 - 1.2480000000000001e-5 * var_x21 - 0.015833333333333335 * var_x26 - 135.20454067538472 * var_x49 - 2.7046577588354044 * var_x23 - 2.3940879178437715e-5 * var_x34 - var_x40 * var_x46 + 135.20454067538472 * var_x39 * var_x41 * var_x44 * var_x50 * var_chaste_interface__cleft_space_equations__Na_c * var_chaste_interface__membrane__V * mParameters[3] * var_chaste_interface__sodium_current_h_gate__h1 * var_chaste_interface__sodium_current_h_gate__h2);
        }
        else
        {
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x56 = pow(var_x53, (-2));
            const double var_x59 = var_x16 * var_x9;
            const double var_x60 = pow(var_x13, (-2));
            const double var_x61 = var_x19 - var_x17;
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x129 = 1 / (1 + 320 * var_x128);
            
            partialF = -0.16500000000000001 * var_x128 - 12.359999999999999 * var_x129;
        }
        else
        {
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x137 = exp(-14 - 0.40000000000000002 * var_chaste_interface__membrane__V);
            const double var_x138 = -1 + var_x137;
            const double var_x139 = 1 / var_x138;
            const double var_x141 = exp(-0.20799999999999999 * var_chaste_interface__membrane__V);
            const double var_x142 = -1 + var_x141;
            const double var_x143 = 1 / var_x142;
            const double var_x145 = exp(-2 + 0.40000000000000002 * var_chaste_interface__membrane__V);
            const double var_x146 = -1 + var_x145;
            const double var_x147 = 1 / var_x146;
            const double var_x148 = 35 + var_chaste_interface__membrane__V;
            const double var_x149 = -5 + var_chaste_interface__membrane__V;
            
            partialF = 0.028390000000000002 * var_x139 * var_x148 + 0.084900000000000003 * var_x143 * var_chaste_interface__membrane__V - 0.011429999999999999 * var_x147 * var_x149;
        }
        else
        {
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x152 = 7 + 0.25 * var_chaste_interface__membrane__V;
            const double var_x153 = exp(var_x152);
            const double var_x154 = -1 + var_x153;
            const double var_x155 = 1 / var_x154;
            const double var_x157 = exp(-var_x152);
            const double var_x158 = 1 + var_x157;
            const double var_x159 = 28 + var_chaste_interface__membrane__V;
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x163 = 0.87666666666666671 + 0.033333333333333333 * var_chaste_interface__membrane__V;
            const double var_x164 = exp(-var_x163);
            const double var_x165 = exp(var_x163);
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x169 = exp(4.0117035110533159 + 0.065019505851755519 * var_chaste_interface__membrane__V);
            
            partialF = -0.015300000000000001 * var_x168 - 0.014999999999999999 * var_x169;
        }
        else
        {
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative9(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0021099999999999999 * var_x172 - 0.017000000000000001 * var_x173;
        }
        else
        {
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x60 = pow(var_x13, (-2));
            const double var_x61 = var_x19 - var_x17;
            const double var_x80 = pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i, 2);
            const double var_x81 = var_x80 * var_chaste_interface__cleft_space_equations__Ca_c;
            const double var_x82 = var_x18 * var_x81;
            const double var_x83 = 1 / (1.5 + var_x27);
            const double var_x84 = var_x29 * var_x30 * var_x83;
            const double var_x85 = var_x32 * var_x80 * var_x84;
            const double var_x86 = pow(var_x31, (-4));
            const double var_x189 = 7.1589144284024978e-7 * var_x14;
            const double var_x190 = 23.020586507479816 * var_x48;
            
            partialF = -0.00012359906637920097 * var_x85 - 2.7242382709912566e-5 * var_x36 - var_x189 * var_x82 - var_x190 * var_x37 + 7.158914428402498e-11 * var_x60 * var_x61 * var_x80 * var_chaste_interface__cleft_space_equations__Ca_c + 2.2637191644542304e-5 * var_x11 * var_x29 * var_x30 * var_x83 * var_x86;
        }
        else
        {
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x22 = mParameters[2] * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
            const double var_x23 = var_x22 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
            const double var_x72 = 1 / var_chaste_interface__intracellular_concentrations_and_buffer_equations__K_i;
            const double var_x194 = 0.46050826103455306 * var_x23;
            
            partialF = -1.1816383500424576e-5 * var_x72 - var_x194 * var_x72;
        }
        else
        {
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x203 = 2.4477170655935014e-10 * var_x62;
            const double var_x204 = 78.710093573368496 * var_x48;
            
            partialF = -0.099999999999999992 - var_x204 - 9.3144911471392233e-5 * var_x89 - var_x202 * var_x91 - var_x203 * var_x90 + 78.710093573368496 * var_x39 * var_x43 * var_x44 * var_chaste_interface__membrane__V * mParameters[3] * var_chaste_interface__sodium_current_h_gate__h1 * var_chaste_interface__sodium_current_h_gate__h2;
        }
        else
        {
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative19(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x205 = 2.7196856284372236e-7 * var_x14;
            
            partialF = -0.099999999999999992 - 5.2976168399354324e-6 * var_x92 - var_x205 * var_x93 + 2.7196856284372237e-11 * var_x11 * var_x60 * var_x61;
        }
        else
        {
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x95 = var_x11 * var_x32 * var_x83;
            const double var_x97 = pow(var_x28, (-3));
            const double var_x99 = var_x29 * var_chaste_interface__cleft_space_equations__K_c;
            const double var_x209 = 1.5745319219196114 * var_x23;
            
            partialF = -0.099999999999999992 - 4.040160535071638e-5 * var_x94 - var_x209 * var_x94 - 0.00018782211067427598 * var_x95 * var_x99 + 0.00018782211067427598 * var_x11 * var_x30 * var_x32 * var_x83 * var_x97;
        }
        else
        {
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative21(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.015581177937052042 - 4.0251665946738841e-8 * var_x101 - 5.5905091592692838e-7 * var_x110;
        }
        else
        {
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x111 = 0.25 + var_chaste_interface__SR_Ca_uptake_and_release__F2;
            const double var_x112 = pow(var_x111, (-2));
            const double var_x113 = pow(var_chaste_interface__SR_Ca_uptake_and_release__F2, 2);
            const double var_x114 = var_x112 * var_x113;
            
            partialF = -8.979782511378108 + 8.8396000000000008 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_Calse - 1.2294902345128229 * var_x114;
        }
        else
        {
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative24(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x215 = pow(var_x213, (-4));
            const double var_x218 = 0.23999999999999999 * var_x214 * var_x215;
            const double var_x219 = var_x218 + 0.23999999999999999 * var_x211;
    ...
    double Dynamicdemir_model_1994FromCellMLGRL1::EvaluatePartialDerivative25(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x215 = pow(var_x213, (-4));
            const double var_x218 = 0.23999999999999999 * var_x214 * var_x215;
            const double var_x221 = 0.040000000000000001 + var_x218;
