...
#include "MathsCustomFunctions.hpp"
    ...
    Cellhund_rudy_2004_aFromCellML::Cellhund_rudy_2004_aFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                29,
                0,
    ...
    double Cellhund_rudy_2004_aFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IKr__gkr = 0.005961898430558533 * sqrt(var_Environment__K_o); // mS_per_uF
        const double var_IKs__gks = 0.0248975 + 0.014938499999999999 / (1.0 + 6.481821026062645e-07 * pow(1 / var_chaste_interface__Ca__Ca_i, 1.4)); // mS_per_uF
        ...
        const double var_cell__past = var_chaste_interface__cell__stim_period * floor(var_chaste_interface__Environment__time / var_chaste_interface__cell__stim_period); // ms
        ...
        const double var_IK1__ak1 = 1.02 / (1.0 + exp(-14.1227775 + 0.2385 * var_chaste_interface__cell__V - 0.2385 * var_reversal_potentials__EK)); // per_ms
        const double var_IK1__bk1 = (1.0 * exp(-36.6986425 + 0.06175 * var_chaste_interface__cell__V - 0.06175 * var_reversal_potentials__EK) + 0.49124 * exp(0.43983232 + 0.08032 * var_chaste_interface__cell__V - 0.08032 * var_reversal_potentials__EK)) / (1.0 + exp(-2.4444679 + 0.5143 * var_reversal_potentials__EK - 0.5143 * var_chaste_interface__cell__V)); // per_ms
        const double var_IK1__IK1 = 0.2151657414559676 * sqrt(var_Environment__K_o) * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * var_IK1__ak1 / (var_IK1__ak1 + var_IK1__bk1); // uA_per_uF
        const double var_IKp__IKp = 0.00276 * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) / (1.0 + exp(1.2521739130434784 - 0.16722408026755853 * var_chaste_interface__cell__V)); // uA_per_uF
    ...
    void Cellhund_rudy_2004_aFromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_ICaL__taufca = 0.5 + 1.0 / (1.0 + 333.3333333333333 * var_chaste_interface__Ca__Ca_ss) + 10.0 * var_Irel__CaMKactive / (0.15 + var_Irel__CaMKactive); // ms
        const double var_Irel__KmCaMK = 0.15; // dimensionless
        const double var_Irel__dro_inf = pow(var_chaste_interface__Ca__Ca_jsr, 1.9) / (pow(var_chaste_interface__Ca__Ca_jsr, 1.9) + 1644.653177341652 * pow((var_chaste_interface__Ca__Ca_ss / (0.0028 + var_chaste_interface__Ca__Ca_ss)), 1.9)); // dimensionless
        ...
        const double var_INaCa__denom2 = pow(var_INaCa__KmNao, 3.0) * var_INaCa__ca_i_NaCa + pow(var_chaste_interface__Na__Na_i, 3.0) * var_INaCa__KmCao + pow(var_INaCa__KmNai, 3.0) * (1.0 + var_INaCa__ca_i_NaCa / var_INaCa__KmCai) * var_Environment__Ca_o; // mM4
        const double var_INaCa__denom3 = pow(var_Environment__Na_o, 3.0) * var_INaCa__ca_i_NaCa + pow(var_chaste_interface__Na__Na_i, 3.0) * var_Environment__Ca_o + pow(var_Environment__Na_o, 3.0) * (1.0 + pow((var_chaste_interface__Na__Na_i / var_INaCa__KmNai), 3.0)) * var_INaCa__KmCai; // mM4
        const double var_ICaL__dpss = 9.0 - 8.0 / (1.0 + exp(-19.11764705882353 - 0.29411764705882354 * var_chaste_interface__cell__V)); // dimensionless
        const double d_dt_chaste_interface_var_ICaL__dp = 0.1 * var_ICaL__dpss - 0.1 * var_chaste_interface__ICaL__dp; // 1 / ms
        const double var_ICaL__dss = 1.0 / (1.0 + exp(0.5934718100890207 - 0.14836795252225518 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL__f2ss = 0.23 + 0.77 / (1.0 + exp(2.4457142857142857 + 0.14285714285714285 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL__fss = 0.3 + 0.7 / (1.0 + exp(2.4457142857142857 + 0.14285714285714285 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL__ibarca = 4.0 * (-15.0 + var_chaste_interface__cell__V) * (-var_Environment__Ca_o * var_ICaL__gacao + var_chaste_interface__Ca__Ca_ss * var_ICaL__gacai * exp(2.0 * (-15.0 + var_chaste_interface__cell__V) * var_Environment__FonRT)) * var_Environment__F * var_Environment__FonRT * var_ICaL__G_CaL_mult * var_ICaL__pca / (-1.0 + exp(2.0 * (-15.0 + var_chaste_interface__cell__V) * var_Environment__FonRT)); // uA_per_uF
        const double var_ICaL__ICaL = ((var_Environment__tissue == 0.0) ? (pow(var_chaste_interface__ICaL__d, var_chaste_interface__ICaL__dp) * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca * var_chaste_interface__ICaL__fca2 * var_ICaL__ibarca) : (var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca * var_chaste_interface__ICaL__fca2 * var_ICaL__ibarca)); // uA_per_uF
        const double var_ICaL__fca2ss = 1.0 / (1.0 - 100.0 * var_ICaL__ICaL); // dimensionless
        const double var_ICaL__fcass = 0.15 + 0.55 / (1.0 + 333.3333333333333 * var_chaste_interface__Ca__Ca_ss) + 0.3 / (1.0 - 20.0 * var_ICaL__ICaL); // dimensionless
        const double d_dt_chaste_interface_var_ICaL__fca = (-var_chaste_interface__ICaL__fca + var_ICaL__fcass) / var_ICaL__taufca; // 1 / ms
        const double var_ICaL__taud = 0.59 + 0.8 * exp(0.6759999999999999 + 0.052 * var_chaste_interface__cell__V) / (1.0 + exp(1.7160000000000002 + 0.132 * var_chaste_interface__cell__V)); // ms
        const double d_dt_chaste_interface_var_ICaL__d = (-var_chaste_interface__ICaL__d + var_ICaL__dss) / var_ICaL__taud; // 1 / ms
        const double var_ICaL__tauf = 1.0 / (0.0529 + 0.2411 * exp(-0.19019454876899997 * pow((-1 + 0.10318426646304972 * var_chaste_interface__cell__V), 2.0))); // ms
        const double d_dt_chaste_interface_var_ICaL__f = (-var_chaste_interface__ICaL__f + var_ICaL__fss) / var_ICaL__tauf; // 1 / ms
        const double var_ICaL__tauf2 = 1.0 / (0.0054 + 0.0423 * exp(-1.20074125971556 * pow((-1 + 0.05384275761067379 * var_chaste_interface__cell__V), 2.0))); // ms
        ...
        const double var_ICab__ICab = 7.980336e-07 * (-0.341 * var_Environment__Ca_o + var_chaste_interface__Ca__Ca_i * exp(2.0 * var_Environment__FonRT * var_chaste_interface__cell__V)) * var_Environment__F * var_Environment__FonRT * var_chaste_interface__cell__V / (-1.0 + exp(2.0 * var_Environment__FonRT * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_IKr__r = 1.0 / (1.0 + exp(0.6493506493506493 + 0.06493506493506493 * var_chaste_interface__cell__V)); // dimensionless
        const double var_IKr__tauxr = 1.0 / (0.0003 * (38.3608 + var_chaste_interface__cell__V) / (-1.0 + exp(5.83851376 + 0.1522 * var_chaste_interface__cell__V)) + 0.0006 * (-1.7384 + var_chaste_interface__cell__V) / (1.0 - exp(0.2364224 - 0.136 * var_chaste_interface__cell__V))); // ms
        ...
        const double var_INa__ah = ((var_chaste_interface__cell__V >= -40.0) ? (0.0) : (0.135 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V))); // per_ms
        const double var_INa__aj = ((var_chaste_interface__cell__V >= -40.0) ? (0.0) : (1.0 * (37.78 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.2444 * var_chaste_interface__cell__V) - 3.474e-05 * exp(-0.04391 * var_chaste_interface__cell__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)))); // per_ms
        const double var_INa__am = 0.32 * (47.13 + var_chaste_interface__cell__V) / (1.0 - exp(-4.713 - 0.1 * var_chaste_interface__cell__V)); // per_ms
        const double var_INa__bh = ((var_chaste_interface__cell__V >= -40.0) ? (7.692307692307692 / (1.0 + exp(-0.9603603603603604 - 0.0900900900900901 * var_chaste_interface__cell__V))) : (310000.0 * exp(0.35 * var_chaste_interface__cell__V) + 3.56 * exp(0.079 * var_chaste_interface__cell__V))); // per_ms
        ...
        const double var_INa__bj = ((var_chaste_interface__cell__V >= -40.0) ? (0.3 * exp(-2.535e-07 * var_chaste_interface__cell__V) / (1.0 + exp(-3.2 - 0.1 * var_chaste_interface__cell__V))) : (0.1212 * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 + exp(-5.5312920000000005 - 0.1378 * var_chaste_interface__cell__V)))); // per_ms
        ...
        const double var_INaK__fnak = 1.0 / (1.0 + 0.1245 * exp(-0.1 * var_Environment__FonRT * var_chaste_interface__cell__V) + 0.0365 * var_INaK__sigma * exp(-var_Environment__FonRT * var_chaste_interface__cell__V)); // dimensionless
        const double var_INaK__INaK = 1.0 * var_Environment__K_o * var_INaK__fnak * var_INaK__ibarnak / ((1.0 + pow((var_INaK__kmnai / var_chaste_interface__Na__Na_i), 2.0)) * (var_Environment__K_o + var_INaK__kmko)); // uA_per_uF
        const double var_INal__amL = 0.32 * (47.13 + var_chaste_interface__cell__V) / (1.0 - exp(-4.713 - 0.1 * var_chaste_interface__cell__V)); // per_ms
        const double var_INal__bmL = 0.08 * exp(-0.09090909090909091 * var_chaste_interface__cell__V); // per_ms
        ...
        const double var_INal__hLss = 1.0 / (1.0 + exp(14.918032786885247 + 0.1639344262295082 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double d_dt_chaste_interface_var_Irel__ro = 0.3333333333333333 * var_Irel__ross - 0.3333333333333333 * var_chaste_interface__Irel__ro; // 1 / ms
        const double var_Irel__tauri = 3.0 + (350.0 - var_Irel__dtau_rel) / (1.0 + exp(-15.0 + 15.0 * var_Irel__cafac + 5000.0 * var_chaste_interface__Ca__Ca_ss)) + var_Irel__dtau_rel; // ms
        const double d_dt_chaste_interface_var_Irel__ri = (-var_chaste_interface__Irel__ri + var_Irel__riss) / var_Irel__tauri; // 1 / ms
        const double var_Irel__vg = ((var_Environment__tissue == 0.0) ? (1.0 / (1.0 + exp(2.6 + 0.2 * var_ICaL__ibarca))) : (1.0)); // dimensionless
        ...
        const double var_Ito__ay = 25.0 * exp(-1.6 + 0.04 * var_chaste_interface__cell__V) / (1.0 + exp(-1.6 + 0.04 * var_chaste_interface__cell__V)); // per_ms
        const double var_Ito__ay2 = 0.03 / (1.0 + exp(12.0 + 0.2 * var_chaste_interface__cell__V)); // per_ms
        const double var_Ito__ay3 = 0.00225 / (1.0 + exp(12.0 + 0.2 * var_chaste_interface__cell__V)); // per_ms
        const double var_Ito__by = 25.0 * exp(-3.6 - 0.04 * var_chaste_interface__cell__V) / (1.0 + exp(-3.6 - 0.04 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_Ito__by2 = 0.2 * exp(5.0 + 0.2 * var_chaste_interface__cell__V) / (1.0 + exp(5.0 + 0.2 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_Ito__by3 = 0.1 * exp(5.0 + 0.2 * var_chaste_interface__cell__V) / (1.0 + exp(5.0 + 0.2 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_IKr__IKr = (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * var_IKr__G_Kr_mult * var_IKr__gkr * var_IKr__r * var_chaste_interface__IKr__xr; // uA_per_uF
        const double var_Ito__Ito = pow(var_chaste_interface__Ito__ydv, 3.0) * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * var_Ito__gitodv * var_Ito__rv * var_chaste_interface__Ito__ydv2 * var_chaste_interface__Ito__zdv; // uA_per_uF
        const double var_K__CTKCl = (-var_reversal_potentials__ECl + var_reversal_potentials__EK) * var_K__CTKClmax / (87.8251 - var_reversal_potentials__ECl + var_reversal_potentials__EK); // mM_per_ms
        const double var_reversal_potentials__ENa = log(var_Environment__Na_o / var_chaste_interface__Na__Na_i) / var_Environment__FonRT; // mV
        const double var_INa__INa = (-var_reversal_potentials__ENa + var_chaste_interface__cell__V) * var_INa__G_Na_mult * var_INa__gNa; // uA_per_uF
        const double var_INal__INal = pow(var_chaste_interface__INal__mL, 3.0) * (-var_reversal_potentials__ENa + var_chaste_interface__cell__V) * var_INal__GNaL * var_chaste_interface__INal__hL; // uA_per_uF
    ...
    void Cellhund_rudy_2004_aFromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
