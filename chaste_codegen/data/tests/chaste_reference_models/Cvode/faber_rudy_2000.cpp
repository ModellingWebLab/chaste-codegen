...
#include "CvodeContextManager.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellfaber_rudy_2000FromCellMLCvode::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__cell__stim_amplitude_converted = -CHASTE_CONST(25.5) * CHASTE_CAP(); // uA_per_cm2
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 2) = CHASTE_CONST(0.00080000000000000004); // (var_calcium_dynamics__K_mrel) [millimolar]
        NV_Ith_S(this->mParameters, 3) = CHASTE_CONST(0.0087500000000000008); // (var_calcium_dynamics__I_up) [millimolar_per_ms]
        NV_Ith_S(this->mParameters, 4) = 1; // (var_ionic_concentrations__conc_clamp) [dimensionless]
        NV_Ith_S(this->mParameters, 5) = CHASTE_CONST(1.8); // (var_calcium_dynamics__Cao) [millimolar]
        NV_Ith_S(this->mParameters, 6) = CHASTE_CONST(5.4000000000000004); // (var_ionic_concentrations__Ko) [millimolar]
        NV_Ith_S(this->mParameters, 7) = 140; // (var_ionic_concentrations__Nao) [millimolar]
        NV_Ith_S(this->mParameters, 8) = CHASTE_CONST(0.00054000000000000001); // (var_L_type_Ca_channel__P_Ca) [litre_per_farad_ms]
        ...
        NV_Ith_S(this->mParameters, 12) = CHASTE_CONST(0.75); // (var_time_independent_potassium_current__G_K1) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 13) = CHASTE_CONST(0.02614); // (var_rapid_delayed_rectifier_potassium_current__G_Kr) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 14) = CHASTE_CONST(0.433); // (var_slow_delayed_rectifier_potassium_current__G_Ks) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 15) = CHASTE_CONST(0.00025000000000000001); // (var_Na_Ca_exchanger__c1) [microA_per_microF]
        NV_Ith_S(this->mParameters, 16) = CHASTE_CONST(0.5); // (var_transient_outward_current__g_to) [milliS_per_microF]
    }
    ...
    double Cellfaber_rudy_2000FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_ATP_sensitive_potassium_current__GKbaraATP = CHASTE_MATH::Pow((CHASTE_CONST(0.25) * NV_Ith_S(mParameters, 6)), var_ATP_sensitive_potassium_current__nATP) * var_ATP_sensitive_potassium_current__g_K_ATP * var_ATP_sensitive_potassium_current__pATP; // milliS_per_microF
        ...
        const double var_rapid_delayed_rectifier_potassium_current__g_Kr = CHASTE_CONST(0.43033148291193518) * CHASTE_MATH::Sqrt(NV_Ith_S(mParameters, 6)) * NV_Ith_S(mParameters, 13); // milliS_per_microF
        ...
        const double var_slow_delayed_rectifier_potassium_current__E_Ks = var_cell__R * var_cell__T * CHASTE_MATH::Log((NV_Ith_S(mParameters, 7) * var_slow_delayed_rectifier_potassium_current__PNaK + NV_Ith_S(mParameters, 6)) / (var_chaste_interface__ionic_concentrations__Nai * var_slow_delayed_rectifier_potassium_current__PNaK + var_chaste_interface__ionic_concentrations__Ki)) / var_cell__F; // millivolt
        const double var_slow_delayed_rectifier_potassium_current__g_Ks = (1 + CHASTE_CONST(0.59999999999999998) / (1 + CHASTE_CONST(6.4818210260626455e-7) * CHASTE_MATH::Pow((1 / var_chaste_interface__calcium_dynamics__Cai), CHASTE_CONST(1.3999999999999999)))) * NV_Ith_S(mParameters, 14); // milliS_per_microF
        ...
        const double var_sodium_potassium_pump__sigma = -CHASTE_CONST(0.14285714285714285) + CHASTE_CONST(0.14285714285714285) * CHASTE_MATH::Exp(CHASTE_CONST(0.01485884101040119) * NV_Ith_S(mParameters, 7)); // dimensionless
        ...
        const double var_time_independent_potassium_current__E_K = var_cell__R * var_cell__T * CHASTE_MATH::Log(NV_Ith_S(mParameters, 6) / var_chaste_interface__ionic_concentrations__Ki) / var_cell__F; // millivolt
        ...
        const double var_time_independent_potassium_current__g_K1 = CHASTE_CONST(0.43033148291193518) * CHASTE_MATH::Sqrt(NV_Ith_S(mParameters, 6)) * NV_Ith_S(mParameters, 12); // milliS_per_microF
    ...
    void Cellfaber_rudy_2000FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__cell__V < -40) ? (CHASTE_CONST(0.13500000000000001) * CHASTE_MATH::Exp(-CHASTE_CONST(11.764705882352942) + CHASTE_CONST(0.14705882352941177) * NV_Ith_S(mParameters, 11) - CHASTE_CONST(0.14705882352941177) * var_chaste_interface__cell__V)) : (0)); // per_ms
        const double var_fast_sodium_current_h_gate__beta_h = ((var_chaste_interface__cell__V < -40) ? (310000 * CHASTE_MATH::Exp(CHASTE_CONST(0.34999999999999998) * var_chaste_interface__cell__V - CHASTE_CONST(0.34999999999999998) * NV_Ith_S(mParameters, 11)) + CHASTE_CONST(3.5600000000000001) * CHASTE_MATH::Exp(CHASTE_CONST(0.079000000000000001) * var_chaste_interface__cell__V - CHASTE_CONST(0.079000000000000001) * NV_Ith_S(mParameters, 11))) : (CHASTE_CONST(7.6923076923076916) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(0.96036036036036043) + CHASTE_CONST(0.0900900900900901) * NV_Ith_S(mParameters, 11) - CHASTE_CONST(0.0900900900900901) * var_chaste_interface__cell__V)))); // per_ms
        const double var_fast_sodium_current_h_gate__h_inf = CHASTE_CONST(0.01) * NV_Ith_S(mParameters, 10) + (1 - CHASTE_CONST(0.01) * NV_Ith_S(mParameters, 10)) * var_fast_sodium_current_h_gate__alpha_h / (var_fast_sodium_current_h_gate__alpha_h + var_fast_sodium_current_h_gate__beta_h); // dimensionless
