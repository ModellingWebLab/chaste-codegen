...
#include "CvodeContextManager.hpp"
    ...
    void Celldifrancesco_noble_model_1985FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = (((var_chaste_interface__membrane__V >= -41.000000999999997) && (var_chaste_interface__membrane__V <= -40.999999000000003)) ? (-0.00020000000000575113 / (1 - exp(1.0000000000287557e-7)) + 499999.99998562218 * (41.000000999999997 + var_chaste_interface__membrane__V) * (0.00020000000000575113 / (1 - exp(1.0000000000287557e-7)) + 0.00020000000000575113 / (1 - exp(-1.0000000000287557e-7)))) : (200 * (41 + var_chaste_interface__membrane__V) / (1 - exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane__V)))); // per_second
        ...
        const double var_hyperpolarising_activated_current_y_gate__beta_y = (((var_chaste_interface__membrane__V >= -42.000000499999999) && (var_chaste_interface__membrane__V <= -41.999999500000001)) ? (-5.0000000001437783e-7 / (1 - exp(1.0000000000287557e-7)) + 999999.99997124437 * (42.000000499999999 + var_chaste_interface__membrane__V) * (5.0000000001437783e-7 / (1 - exp(1.0000000000287557e-7)) + 5.0000000001437783e-7 / (1 - exp(-1.0000000000287557e-7)))) : ((42 + var_chaste_interface__membrane__V) / (1 - exp(-8.4000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V)))); // per_second
        ...
        const double var_second_inward_current_d_gate__alpha_d = (((var_chaste_interface__membrane__V >= -19.000000400000001) && (var_chaste_interface__membrane__V <= -18.999999599999999)) ? (-1.2000000000345068e-5 / (1 - exp(1.0000000000287557e-7)) + 1249999.9999640554 * (19.000000400000001 + var_chaste_interface__membrane__V) * (1.2000000000345068e-5 / (1 - exp(1.0000000000287557e-7)) + 1.2000000000345068e-5 / (1 - exp(-1.0000000000287557e-7)))) : (30 * (19 + var_chaste_interface__membrane__V) / (1 - exp(-4.75 - 0.25 * var_chaste_interface__membrane__V)))); // per_second
        const double var_second_inward_current_d_gate__beta_d = (((var_chaste_interface__membrane__V >= -19.000001000000001) && (var_chaste_interface__membrane__V <= -18.999998999999999)) ? (-1.1999999999678934e-5 / (-1 + exp(-9.9999999997324457e-8)) + 500000.00000643887 * (19.000001000000001 + var_chaste_interface__membrane__V) * (1.1999999999678934e-5 / (-1 + exp(-9.9999999997324457e-8)) + 1.2000000000012001e-5 / (-1 + exp(1.0000000000010001e-7)))) : (12 * (19 + var_chaste_interface__membrane__V) / (-1 + exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V)))); // per_second
