...
public:
    ...
    Cellpaci_hyttinen_aaltosetala_severi_ventricularVersionFromCellMLCvode(std::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, std::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
