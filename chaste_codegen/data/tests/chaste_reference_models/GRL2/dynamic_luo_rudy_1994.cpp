...
#include "dynamic_luo_rudy_1994.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Dynamicluo_rudy_1994FromCellMLGRL2::UseCellMLDefaultStimulus()
    {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Dynamicluo_rudy_1994FromCellMLGRL2::Dynamicluo_rudy_1994FromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Dynamicluo_rudy_1994FromCellMLGRL2>::Instance();
        Init();
    ...
    Dynamicluo_rudy_1994FromCellMLGRL2::~Dynamicluo_rudy_1994FromCellMLGRL2()
    {
    }
    
    double Dynamicluo_rudy_1994FromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicluo_rudy_1994FromCellMLGRL2::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
    ...
    void Dynamicluo_rudy_1994FromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        std::vector<double>& rY = rGetStateVariables();
        const double delta=1e-8;
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluateYDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
        double d_dt_chaste_interface_var_membrane__V;
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: mV; Initial value: -84.624
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluateYDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluateYDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluateYDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -((var_x161) ? (0.13500000000000001 * var_x160) : (0.0)) - ((var_x161) ? (310000.0 * var_x163 + 3.5600000000000001 * var_x162) : (7.6923076923076916 / var_x165));
        }
        else
        {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluateYDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -((var_x161) ? (0.1212 * var_x177) : (0.29999999999999999 * var_x181)) - ((var_x161) ? (var_x172 * var_x173) : (0.0));
        }
        else
        {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluateYDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x196 - var_x190 * var_x196;
        }
        else
        {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluateYDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x205 * var_x208 + var_x205 * var_x210;
        }
        else
        {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluateYDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -var_x214 * var_x218 - var_x217 * var_x218;
        }
        else
        {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluateYDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x228 - 5.594554271400994e-8 * var_x100 - 5.073320759877697e-6 * var_x135 - 1.139681818874567e-6 * var_x33 - 9.0637557008472766e-8 * var_x128 - 0.012932559646803597 * var_x134 - var_x132 * var_x225;
        }
        else
        {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluateYDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x232 + 0.00014747361493490206 * var_x148 - 1.5996281101931733e-8 * var_x100 - 0.001815786661103715 * var_x129 - 0.00061833800811279696 * var_x144 - 1.4791615096031613e-5 * var_x143 - var_x145 * var_x225 - var_x147 * var_x230;
        }
        else
        {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluateYDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluateYDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY)
    {
    ...
    double Dynamicluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        double partialF;
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
...
template<>
void OdeSystemInformation<Dynamicluo_rudy_1994FromCellMLGRL2>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Dynamicluo_rudy_1994FromCellMLGRL2)
extern "C"
{
    ...
    {
        return new Dynamicluo_rudy_1994FromCellMLGRL2(pSolver, pStimulus);
    }
