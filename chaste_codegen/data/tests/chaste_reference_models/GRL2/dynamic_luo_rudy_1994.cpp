...
#include "MathsCustomFunctions.hpp"
    ...
    std::vector<double> Dynamicluo_rudy_1994FromCellMLGRL2::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
