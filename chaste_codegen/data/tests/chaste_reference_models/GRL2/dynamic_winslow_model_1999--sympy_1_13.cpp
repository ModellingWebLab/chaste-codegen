...
#include "MathsCustomFunctions.hpp"
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_slow_activating_delayed_rectifiyer_K_current__E_Ks = var_membrane__R * var_membrane__T * log((1 * mParameters[4] + 0.018329999999999999 * mParameters[5]) / (1 * var_chaste_interface__intracellular_ion_concentrations__Ki + 0.018329999999999999 * var_chaste_interface__intracellular_ion_concentrations__Nai)) / var_membrane__F; // millivolt
    ...
    void Dynamicwinslow_model_1999FromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_transient_outward_potassium_current__i_to1 = (-var_rapid_activating_delayed_rectifiyer_K_current__E_K + var_chaste_interface__membrane__V) * mParameters[15] * var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1 * var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1; // microA_per_microF
        const double var_intracellular_ion_concentrations__Ki_orig_deriv = -1 * (-2 * var_sodium_potassium_pump__i_NaK + var_L_type_Ca_current__i_Ca_K + var_plateau_potassium_current__i_Kp + var_rapid_activating_delayed_rectifiyer_K_current__i_Kr + var_slow_activating_delayed_rectifiyer_K_current__i_Ks + var_time_independent_potassium_current__i_K1 + var_transient_outward_potassium_current__i_to1) * var_intracellular_ion_concentrations__A_cap * mParameters[2] / (var_intracellular_ion_concentrations__V_myo * var_membrane__F); // millimolar / second
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x1 = var_x0 * mParameters[8] * var_chaste_interface__fast_sodium_current_j_gate__j;
            const double var_x2 = var_x1 * var_chaste_interface__fast_sodium_current_h_gate__h;
            const double var_x3 = pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 3);
            const double var_x4 = exp(0.013101861787960915 * var_chaste_interface__membrane__V);
            const double var_x5 = var_x4 * mParameters[3];
            const double var_x6 = exp(-0.024332029034784559 * var_chaste_interface__membrane__V);
            const double var_x7 = pow(mParameters[5], 3);
            const double var_x8 = var_x6 * var_x7;
            const double var_x9 = var_x8 * var_chaste_interface__intracellular_ion_concentrations__Cai;
            const double var_x10 = 1 + 0.20000000000000001 * var_x6;
            const double var_x11 = 1 / var_x10;
            const double var_x12 = 1 / (669921.875 + var_x7);
            const double var_x13 = 1 / (1.3799999999999999 + mParameters[3]);
            const double var_x14 = var_x12 * var_x13 * mParameters[14];
            const double var_x15 = var_x11 * var_x14;
            const double var_x16 = var_x15 * (0.024332029034784559 * var_x9 + 0.013101861787960915 * var_x3 * var_x5);
            const double var_x17 = 1 / var_chaste_interface__intracellular_ion_concentrations__Nai;
            const double var_x18 = pow(var_x17, 1.5);
            const double var_x19 = exp(-0.0037433890822745476 * var_chaste_interface__membrane__V);
            const double var_x20 = 0.037433890822745473 * var_chaste_interface__membrane__V;
            const double var_x21 = (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[5])) * exp(-var_x20);
            const double var_x22 = 1 + 0.1245 * var_x19 + 0.036499999999999998 * var_x21;
            const double var_x23 = mParameters[4] / (1.5 + mParameters[4]);
            const double var_x24 = var_x23 * (0.0013663370150302097 * var_x21 + 0.00046605194074318115 * var_x19) / (pow(var_x22, 2) * (1 + 31.622776601683793 * var_x18));
            ...
            const double var_x28 = 0.001 * var_x25 - 0.34100000000000003 * mParameters[3];
            const double var_x29 = var_x27 * var_x28 * mParameters[6];
            const double var_x30 = var_chaste_interface__L_type_Ca_current__O + var_chaste_interface__L_type_Ca_current__O_Ca;
            const double var_x31 = var_x30 * var_chaste_interface__L_type_Ca_current_y_gate__y;
            const double var_x32 = var_x29 * var_x31;
            const double var_x33 = var_x25 * mParameters[6] * var_chaste_interface__membrane__V;
            const double var_x34 = var_x27 * var_x33;
            const double var_x35 = var_x31 * var_x34;
            const double var_x36 = -var_x9 + var_x3 * var_x4 * mParameters[3];
            const double var_x37 = var_x14 * var_x36 * var_x6 / pow(var_x10, 2);
            const double var_x38 = pow(var_x26, (-2));
            const double var_x39 = var_x28 * var_x33 * var_x38;
            const double var_x40 = exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V);
            const double var_x41 = 1 + var_x40;
            const double var_x42 = 1 / var_x41;
            const double var_x43 = pow(var_chaste_interface__slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks, 2) * mParameters[13];
            const double var_x44 = mParameters[15] * var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1;
            const double var_x45 = var_x44 * var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1;
            const double var_x46 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ki;
            const double var_x47 = var_x46 * mParameters[4];
            const double var_x48 = log(var_x47);
            const double var_x49 = -26.713760659695648 * var_x48 + var_chaste_interface__membrane__V;
            const double var_x50 = exp(0.044600000000000001 * var_chaste_interface__membrane__V);
            const double var_x51 = sqrt(mParameters[4]);
            const double var_x52 = var_x51 * mParameters[12] / (1 + 1.4944999999999999 * var_x50);
            const double var_x53 = var_x52 * var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr;
            const double var_x54 = 1 * mParameters[4];
            const double var_x55 = exp(0.056150836234118207 * var_chaste_interface__membrane__V - 1.5 * var_x48);
            const double var_x56 = mParameters[11] / (13 + mParameters[4]);
            const double var_x57 = var_x56 / (2 + var_x55);
            const double var_x58 = var_x29 * var_chaste_interface__membrane__V;
            const double var_x59 = 1 / (1 - 54518.063995566983 * var_x58);
            const double var_x60 = exp(var_x20);
            const double var_x61 = -1 + var_x60;
            const double var_x62 = 1 / var_x61;
            const double var_x63 = var_x60 * var_chaste_interface__intracellular_ion_concentrations__Ki;
            const double var_x64 = var_x63 - mParameters[4];
            const double var_x65 = var_x59 * var_x62 * var_x64;
            const double var_x66 = 2.0912447872899554e-6 * var_x65;
            const double var_x67 = var_x49 * var_x55 * var_x56 / pow((1 + 0.5 * var_x55), 2);
            const double var_x68 = var_x31 * var_x62 * var_chaste_interface__membrane__V;
            const double var_x69 = var_x59 * var_x68;
            const double var_x70 = var_x43 + var_x45 + 0.5 * var_x53 + 0.0022160000000000001 * var_x42 + var_x31 * var_x66 + var_x54 * var_x57 + 7.8283429051047759e-8 * var_x63 * var_x69 - 0.014037709058529552 * var_x67 * mParameters[4] + 0.00037056856187290968 * var_x40 * var_x49 / pow(var_x41, 2) + 7.035970683610309e-16 * var_x64 * var_x68 * (4.0816465109550109 * var_x34 + 54518.063995566983 * var_x29 - 4081.6465109550109 * var_x39) / pow((1.8342544226833014e-5 - var_x58), 2) - 7.8283429051047759e-8 * var_x31 * var_x59 * var_x60 * var_x64 * var_chaste_interface__membrane__V / pow(var_x61, 2) - 0.014921378387420543 * var_x49 * var_x50 * var_x51 * mParameters[12] * var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr / pow((0.66912010705921721 + var_x50), 2);
            const double var_x71 = 1 / mParameters[7];
            const double var_x72 = 0.001 * var_x71;
            
            partialF = -var_x72 * (0.0034841999999999998 + var_x2 + var_x70 + 5000 * var_x16 + 0.69299999999999995 * var_x24 + 1.0816363254030779 * var_x35 + 24.332029034784558 * var_x37 + 14447.286958825252 * var_x32 - 1081.636325403078 * var_x31 * var_x39);
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x75 = 1 / var_chaste_interface__intracellular_ion_concentrations__Cai;
            const double var_x76 = pow(var_x73, (-2));
            const double var_x97 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Cai;
            const double var_x98 = 1 + 0.00011900000000000002 / pow(var_x97, 2);
            const double var_x99 = 1 / var_x98;
            const double var_x100 = 0.001 * var_x99;
            const double var_x101 = 0.0015381954438488301 * var_x74;
            const double var_x102 = pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 0.19999999999999996);
            const double var_x103 = pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 1.2);
            const double var_x104 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_NSR, 1);
            const double var_x105 = 1 / (1 + 33855.471141425078 * var_x103 + 0.303951367781155 * var_x104);
            const double var_x106 = var_x105 * mParameters[1];
            const double var_x107 = pow((2.9537323401073989e-5 + var_x103 + 8.9779098483507565e-6 * var_x104), (-2));
            const double var_x108 = 2752.4498037978587 * var_x103 - 0.096656534954407292 * var_x104;
            const double var_x109 = 2800.0000000000005 * var_chaste_interface__intracellular_ion_concentrations__Cai;
            
            partialF = var_x100 * (-5637.4531835205999 - var_x101 + 2800.0000000000005 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 2800.0000000000005 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa - 0.00015787156411954756 * var_x75 + 0.0015381954438488301 * var_x76 * var_chaste_interface__intracellular_ion_concentrations__Cai - 307.63908876976598 * var_x15 * var_x8 - 3302.9397645574304 * var_x102 * var_x106 + 3.5444788081288787e-5 * var_x102 * var_x107 * var_x108 * mParameters[1]) + 2.3800000000000004e-7 * (2.8000000000000003 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss + 0.0092400000000000017 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 0.00015787156411954756 * log(var_x75 * mParameters[3]) - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Cai - 1.181949379053441e-5 * var_chaste_interface__membrane__V - var_x101 * var_chaste_interface__intracellular_ion_concentrations__Cai - var_x106 * var_x108 - var_x109 * (1 - var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa) - var_x109 * (1 - var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa) + 307.63908876976598 * var_x11 * var_x12 * var_x13 * var_x36 * mParameters[14]) / (pow(var_x97, 3) * pow(var_x98, 2));
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x112 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
            const double var_x114 = var_chaste_interface__membrane__V >= -90;
            const double var_x115 = 47.130000000000003 + var_chaste_interface__membrane__V;
            const double var_x116 = (var_x114) && (fabs(var_x115) < 1.0000000000000001e-5);
            const double var_x117 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x118 = exp(-4.7130000000000001 - var_x117);
            const double var_x119 = 1 - var_x118;
            const double var_x120 = 320 / var_x119;
            const double var_x121 = 80 * var_x112;
            
            partialF = 0.001 * ((var_x116) ? (-var_x121 - 1000 / (-0.13565000000000002 - 0.0050000000000000001 * var_chaste_interface__membrane__V)) : ((var_x114) ? (-var_x121 - var_x115 * var_x120) : (0)));
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x122 = exp(-11.764705882352942 + 0.14705882352941177 * mParameters[10] - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x123 = var_chaste_interface__membrane__V < -40;
            const double var_x124 = ((var_x123) ? (135 * var_x122) : (0));
            const double var_x125 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * mParameters[10]);
            const double var_x126 = exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * mParameters[10]);
            const double var_x127 = exp(-0.96036036036036043 + 0.0900900900900901 * mParameters[10] - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x128 = 1 + var_x127;
            const double var_x129 = ((var_x123) ? (3560 * var_x125 + 310000 * var_x126) : (7692.3076923076924 / var_x128));
            
            partialF = -0.001 * var_x124 - 0.001 * var_x129;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x117 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x123 = var_chaste_interface__membrane__V < -40;
            const double var_x136 = exp(-5.5312920000000005 + 0.13780000000000001 * mParameters[10] - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x137 = 1 + var_x136;
            const double var_x138 = exp(0.01052 * mParameters[10] - 0.01052 * var_chaste_interface__membrane__V);
            const double var_x139 = var_x138 / var_x137;
            const double var_x140 = exp(-3.2000000000000002 - var_x117 + 0.10000000000000001 * mParameters[10]);
            const double var_x141 = 1 + var_x140;
            const double var_x142 = exp(2.5349999999999999e-7 * mParameters[10] - 2.5349999999999999e-7 * var_chaste_interface__membrane__V);
            const double var_x143 = var_x142 / var_x141;
            const double var_x144 = ((var_x123) ? (121.2 * var_x139) : (300 * var_x143));
            const double var_x145 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x146 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * mParameters[10]);
            const double var_x147 = exp(0.043909999999999998 * mParameters[10] - 0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x148 = -127140 * var_x146 - 3.4740000000000003e-5 * var_x147;
            const double var_x149 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * mParameters[10]);
            const double var_x150 = 1 + var_x149;
            const double var_x151 = 1000 / var_x150;
            const double var_x152 = var_x148 * var_x151;
            const double var_x153 = ((var_x123) ? (var_x145 * var_x152) : (0));
            
            partialF = -0.001 * var_x144 - 0.001 * var_x153;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x158 = exp(-7.6769999999999996 - 0.012800000000000001 * var_chaste_interface__membrane__V);
            const double var_x159 = exp(-5.4950000000000001 + 0.1691 * var_chaste_interface__membrane__V);
            const double var_x160 = var_x158 + var_x159;
            const double var_x161 = 1 / var_x160;
            const double var_x162 = 1 / (0.027 + 0.001 * var_x161);
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x167 = exp(-0.68699999999999994 + 0.068699999999999997 * var_chaste_interface__membrane__V);
            const double var_x168 = -1 + var_x167;
            const double var_x169 = 1 / var_x168;
            const double var_x170 = exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V);
            const double var_x171 = 1 - var_x170;
            const double var_x172 = 1 / var_x171;
            const double var_x173 = -10 + var_chaste_interface__membrane__V;
            
            partialF = -0.00013100000000000001 * var_x169 * var_x173 - 7.1899999999999999e-5 * var_x172 * var_x173;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x174 = exp(-0.062370000000000002 * var_chaste_interface__membrane__V);
            const double var_x175 = exp(0.035770000000000003 * var_chaste_interface__membrane__V);
            
            partialF = -0.045159999999999999 * var_x175 - 0.098900000000000002 * var_x174;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x176 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x177 = 6.7000000000000002 + var_x176;
            const double var_x178 = exp(var_x177);
            const double var_x179 = 1 + 0.051334999999999999 * var_x178;
            const double var_x180 = var_x178 / var_x179;
            const double var_x182 = exp(-var_x177);
            const double var_x183 = 1 + 0.051334999999999999 * var_x182;
            const double var_x184 = var_x182 / var_x183;
            
            partialF = -0.0054149999999999997 * var_x180 - 0.0054149999999999997 * var_x184;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x187 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x189 = 1.6000000000000001 * var_x187;
            const double var_x190 = 0.10375 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x185 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x187 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x191 = 0.050000000000000003 * var_x185;
            const double var_x195 = 1.2 * var_x187;
            const double var_x196 = 0.20749999999999999 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            
            partialF = -var_x191 - var_x195 - var_x196;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x185 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x187 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x197 = 0.10000000000000001 * var_x185;
            const double var_x200 = 0.80000000000000004 * var_x187;
            const double var_x201 = 0.41499999999999998 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            
            partialF = -var_x197 - var_x200 - var_x201;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x185 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x187 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x202 = 0.14999999999999999 * var_x185;
            const double var_x205 = 0.40000000000000002 * var_x187;
            const double var_x206 = 0.82999999999999996 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            
            partialF = -var_x202 - var_x205 - var_x206;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x185 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x207 = 0.20000000000000001 * var_x185;
            const double var_x209 = 1.6599999999999999 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            
            partialF = -0.29999999999999999 - var_x207 - var_x209;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x187 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x212 = 3.2000000000000002 * var_x187;
            
            partialF = -0.01 - var_x212;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x185 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x187 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x213 = 0.025000000000000001 * var_x185;
            const double var_x214 = 2.3999999999999999 * var_x187;
            
            partialF = -0.0050000000000000001 - var_x213 - var_x214;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0025000000000000001 - var_x189 - var_x191;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x187 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x200 = 0.80000000000000004 * var_x187;
            const double var_x215 = 0.074999999999999997 * var_x185;
            
            partialF = -0.00125 - var_x200 - var_x215;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0076249999999999998 - var_x197;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative21(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x219 = exp(2.1052631578947367 + 0.10526315789473684 * var_chaste_interface__membrane__V);
            const double var_x220 = 1 + var_x219;
            const double var_x221 = 1 / var_x220;
            const double var_x222 = 1 / (0.02 + 0.59999999999999998 * var_x221);
            
            partialF = -0.001 * var_x222;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x223 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 3);
            const double var_x224 = 4050000 * var_x223;
            
            partialF = -0.67600000000000005 - var_x224;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x225 = 12150000000.0 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 4);
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative28(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x22 = 1 + 0.1245 * var_x19 + 0.036499999999999998 * var_x21;
            const double var_x23 = mParameters[4] / (1.5 + mParameters[4]);
            const double var_x93 = var_x17 * var_x18 * var_x23 / (var_x22 * pow((0.031622776601683791 + var_x18), 2));
            const double var_x94 = var_x15 * var_x5 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2);
            const double var_x95 = 0.082812658045056511 * var_x17 + 26.713760659695648 * var_x17 * var_x2;
            const double var_x228 = 6.1527817753953199e-5 * mParameters[2];
            
            partialF = -var_x228 * (var_x95 + 45000 * var_x94 + 0.098615628832350907 * var_x93);
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative29(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x68 = var_x31 * var_x62 * var_chaste_interface__membrane__V;
            const double var_x69 = var_x59 * var_x68;
            const double var_x84 = 1 / (1 * var_chaste_interface__intracellular_ion_concentrations__Ki + 0.018329999999999999 * var_chaste_interface__intracellular_ion_concentrations__Nai);
            const double var_x91 = var_x43 * var_x84;
            const double var_x96 = 26.713760659695648 * var_x91 + 13.356880329847824 * var_x46 * var_x53 + 26.713760659695648 * var_x45 * var_x46 + 26.713760659695648 * var_x47 * var_x57 + 0.05919769362188556 * var_x42 * var_x46 + 2.0912447872899554e-6 * var_x60 * var_x69 - 0.375 * var_x47 * var_x67;
            const double var_x228 = 6.1527817753953199e-5 * mParameters[2];
            
            partialF = -var_x228 * var_x96;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative30(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x31 = var_x30 * var_chaste_interface__L_type_Ca_current_y_gate__y;
            const double var_x58 = var_x29 * var_chaste_interface__membrane__V;
            const double var_x233 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            const double var_x234 = 1 + 0.00011900000000000002 / pow(var_x233, 2);
            const double var_x235 = 1 / var_x234;
            const double var_x236 = 0.001 * var_x235;
            const double var_x240 = -var_chaste_interface__intracellular_ion_concentrations__Ca_ss + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR;
            const double var_x243 = var_chaste_interface__RyR_channel__P_O1 + var_chaste_interface__RyR_channel__P_O2;
            const double var_x244 = var_x243 * mParameters[0];
            
            partialF = var_x236 * (-806491.88514357049 - 133.33333333333334 * var_x244) + 2.3800000000000004e-7 * (806491.88514357049 * var_chaste_interface__intracellular_ion_concentrations__Cai - 806491.88514357049 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 9570598.0870152581 * var_x31 * var_x58 + 133.33333333333334 * var_x240 * var_x243 * mParameters[0]) / (pow(var_x233, 3) * pow(var_x234, 2));
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative31(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x243 = var_chaste_interface__RyR_channel__P_O1 + var_chaste_interface__RyR_channel__P_O2;
            const double var_x244 = var_x243 * mParameters[0];
            const double var_x245 = 0.80000000000000004 + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR;
            const double var_x246 = pow(var_x245, (-2));
            const double var_x247 = 1 / (1 + 12 * var_x246);
            const double var_x248 = 0.001 * var_x247;
            
            partialF = var_x248 * (-1740.0382808421784 - var_x244) + 0.00016666666666666666 * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR - var_x240 * var_x244) / (pow(var_x245, 3) * pow((0.083333333333333329 + var_x246), 2));
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative32(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x107 = pow((2.9537323401073989e-5 + var_x103 + 8.9779098483507565e-6 * var_x104), (-2));
            const double var_x108 = 2752.4498037978587 * var_x103 - 0.096656534954407292 * var_x104;
            const double var_x110 = var_x107 * var_x108 * mParameters[1];
            
            partialF = -0.13257434520702313 - 0.0011893356491532784 * var_x106 - 3.2630189260961817e-12 * var_x110;
        }
        else
        {
