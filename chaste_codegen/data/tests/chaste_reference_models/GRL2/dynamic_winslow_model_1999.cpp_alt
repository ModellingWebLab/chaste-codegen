...
#include "MathsCustomFunctions.hpp"
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x23 = pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 3);
            ...
            const double var_x27 = pow(mParameters[5], 3);
            ...
            const double var_x30 = 1 + 0.20000000000000001 * var_x26;
            const double var_x31 = 1 / var_x30;
            const double var_x32 = 1 / (669921.875 + var_x27);
            const double var_x33 = 1 / (1.3799999999999999 + mParameters[3]);
            const double var_x34 = var_x32 * var_x33 * mParameters[14];
            const double var_x35 = var_x31 * var_x34;
            const double var_x36 = var_x35 * (0.024332029034784559 * var_x29 + 0.013101861787960915 * var_x23 * var_x25);
            const double var_x37 = 1 / var_chaste_interface__intracellular_ion_concentrations__Nai;
            const double var_x38 = pow(var_x37, 1.5);
            const double var_x39 = 1 / (1 + 31.622776601683793 * var_x38);
            const double var_x40 = exp(-0.0037433890822745476 * var_chaste_interface__membrane__V);
            const double var_x41 = exp(0.01485884101040119 * mParameters[5]);
            const double var_x42 = 0.037433890822745473 * var_chaste_interface__membrane__V;
            const double var_x43 = exp(-var_x42);
            const double var_x44 = 1 + 0.1245 * var_x40 + 0.036499999999999998 * var_x43 * (-0.14285714285714285 + 0.14285714285714285 * var_x41);
            const double var_x45 = pow(var_x44, (-2));
            const double var_x46 = 0.00046605194074318115 * var_x40 + 0.037433890822745473 * var_x43 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x41);
            const double var_x47 = 1 / (1.5 + mParameters[4]);
            ...
            const double var_x52 = exp(0.074867781645490947 * var_chaste_interface__membrane__V);
            const double var_x53 = -1 + var_x52;
            const double var_x54 = 1 / var_x53;
            const double var_x55 = 0.001 * var_x52 - 0.34100000000000003 * mParameters[3];
            const double var_x56 = var_x54 * var_x55 * mParameters[6];
            const double var_x57 = var_x56 * var_chaste_interface__membrane__V;
            const double var_x58 = 1 / (1 - 54518.063995566983 * var_x57);
            const double var_x59 = exp(var_x42);
            ...
            const double var_x65 = 2.0912447872899554e-6 * var_x64;
            ...
            const double var_x71 = var_x26 * var_x34 * var_x70 / pow(var_x30, 2);
            const double var_x72 = pow((1 + 0.5 * var_x19), (-2));
            const double var_x73 = var_x19 * var_x21 * var_x72 * var_x9;
            const double var_x74 = pow((0.66912010705921721 + var_x14), (-2));
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x87 = pow(var_x84, (-2));
            const double var_x113 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Cai;
            const double var_x114 = 1 + 0.00011900000000000002 / pow(var_x113, 2);
            const double var_x115 = 1 / var_x114;
            const double var_x116 = 0.001 * var_x115;
            const double var_x117 = 0.0015381954438488301 * var_x85;
            const double var_x118 = pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 0.19999999999999996);
            const double var_x119 = pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 1.2);
            const double var_x120 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_NSR, 1);
            const double var_x121 = 1 / (1 + 33855.471141425078 * var_x119 + 0.303951367781155 * var_x120);
            const double var_x122 = var_x121 * mParameters[1];
            const double var_x123 = pow((2.9537323401073989e-5 + var_x119 + 8.9779098483507565e-6 * var_x120), (-2));
            const double var_x124 = 2752.4498037978587 * var_x119 - 0.096656534954407292 * var_x120;
            const double var_x125 = 2800.0000000000005 * var_chaste_interface__intracellular_ion_concentrations__Cai;
            
            partialF = var_x116 * (-5637.4531835205999 - var_x117 + 2800.0000000000005 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 2800.0000000000005 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa - 0.00015787156411954756 * var_x86 + 0.0015381954438488301 * var_x87 * var_chaste_interface__intracellular_ion_concentrations__Cai - 307.63908876976598 * var_x28 * var_x35 - 3302.9397645574304 * var_x118 * var_x122 + 3.5444788081288787e-5 * var_x118 * var_x123 * var_x124 * mParameters[1]) + 2.3800000000000004e-7 * (2.8000000000000003 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss + 0.0092400000000000017 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 0.00015787156411954756 * log(var_x86 * mParameters[3]) - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Cai - 1.181949379053441e-5 * var_chaste_interface__membrane__V - var_x117 * var_chaste_interface__intracellular_ion_concentrations__Cai - var_x122 * var_x124 - var_x125 * (1 - var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa) - var_x125 * (1 - var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa) + 307.63908876976598 * var_x31 * var_x32 * var_x33 * var_x70 * mParameters[14]) / (pow(var_x113, 3) * pow(var_x114, 2));
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x130 = 1 - 0.00897780373069724 * var_x129;
            const double var_x131 = 320 / var_x130;
            const double var_x132 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
            const double var_x133 = 47.130000000000003 + var_chaste_interface__membrane__V;
            const double var_x134 = var_chaste_interface__membrane__V >= -90;
            
            partialF = 0.001 * ((var_x134) ? (-80 * var_x132 - var_x131 * var_x133) : (0));
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x135 = exp(0.14705882352941177 * mParameters[10] - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x136 = var_chaste_interface__membrane__V < -40;
            const double var_x137 = ((var_x136) ? (0.0010495108254269644 * var_x135) : (0));
            const double var_x138 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * mParameters[10]);
            const double var_x139 = exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * mParameters[10]);
            const double var_x140 = exp(0.0900900900900901 * mParameters[10] - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x141 = 1 + 0.38275493141491301 * var_x140;
            const double var_x142 = ((var_x136) ? (3560 * var_x138 + 310000 * var_x139) : (7692.3076923076924 / var_x141));
            const double var_x143 = 0.001 * var_x137 + 0.001 * var_x142;
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x128 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x136 = var_chaste_interface__membrane__V < -40;
            const double var_x150 = exp(0.13780000000000001 * mParameters[10] - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x151 = 1 + 0.0039608683399042569 * var_x150;
            const double var_x152 = exp(0.01052 * mParameters[10] - 0.01052 * var_chaste_interface__membrane__V);
            const double var_x153 = var_x152 / var_x151;
            const double var_x154 = exp(var_x128 + 0.10000000000000001 * mParameters[10]);
            const double var_x155 = 1 + 0.040762203978366211 * var_x154;
            const double var_x156 = exp(2.5349999999999999e-7 * mParameters[10] - 2.5349999999999999e-7 * var_chaste_interface__membrane__V);
            const double var_x157 = var_x156 / var_x155;
            const double var_x158 = ((var_x136) ? (121.2 * var_x153) : (300 * var_x157));
            const double var_x159 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x160 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * mParameters[10]);
            const double var_x161 = exp(0.043909999999999998 * mParameters[10] - 0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x162 = -127140 * var_x160 - 3.4740000000000003e-5 * var_x161;
            const double var_x163 = exp(0.311 * var_chaste_interface__membrane__V - 0.311 * mParameters[10]);
            const double var_x164 = 1000 / (1 + 50262745825.953949 * var_x163);
            const double var_x165 = var_x162 * var_x164;
            const double var_x166 = ((var_x136) ? (var_x159 * var_x165) : (0));
            const double var_x167 = 0.001 * var_x158 + 0.001 * var_x166;
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x172 = exp(-7.6769999999999996 - 0.012800000000000001 * var_chaste_interface__membrane__V);
            const double var_x173 = exp(-5.4950000000000001 + 0.1691 * var_chaste_interface__membrane__V);
            const double var_x174 = var_x172 + var_x173;
            const double var_x175 = 1 / var_x174;
            const double var_x176 = 1 / (0.027 + 0.001 * var_x175);
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x181 = exp(-0.68699999999999994 + 0.068699999999999997 * var_chaste_interface__membrane__V);
            const double var_x182 = -1 + var_x181;
            const double var_x183 = 1 / var_x182;
            const double var_x184 = exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V);
            const double var_x185 = 1 - var_x184;
            const double var_x186 = 1 / var_x185;
            const double var_x187 = -10 + var_chaste_interface__membrane__V;
            
            partialF = -0.00013100000000000001 * var_x183 * var_x187 - 7.1899999999999999e-5 * var_x186 * var_x187;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x188 = exp(0.035770000000000003 * var_chaste_interface__membrane__V);
            const double var_x189 = exp(-0.062370000000000002 * var_chaste_interface__membrane__V);
            
            partialF = -0.045159999999999999 * var_x188 - 0.098900000000000002 * var_x189;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x190 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x191 = 6.7000000000000002 + var_x190;
            const double var_x192 = exp(var_x191);
            const double var_x193 = 1 + 0.051334999999999999 * var_x192;
            const double var_x194 = var_x192 / var_x193;
            const double var_x196 = exp(-var_x191);
            const double var_x197 = 1 + 0.051334999999999999 * var_x196;
            const double var_x198 = var_x196 / var_x197;
            
            partialF = -0.0054149999999999997 * var_x194 - 0.0054149999999999997 * var_x198;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x201 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x204 = 1.6000000000000001 * var_x201;
            const double var_x205 = 0.10375 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x199 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x201 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x206 = 0.050000000000000003 * var_x199;
            const double var_x210 = 1.2 * var_x201;
            const double var_x211 = 0.20749999999999999 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            
            partialF = -var_x206 - var_x210 - var_x211;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x199 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x201 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x212 = 0.10000000000000001 * var_x199;
            const double var_x216 = 0.80000000000000004 * var_x201;
            const double var_x217 = 0.41499999999999998 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x199 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x201 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x218 = 0.14999999999999999 * var_x199;
            const double var_x222 = 0.40000000000000002 * var_x201;
            const double var_x223 = 0.82999999999999996 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            
            partialF = -var_x218 - var_x222 - var_x223;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x199 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x224 = 0.20000000000000001 * var_x199;
            const double var_x226 = 1.6599999999999999 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            
            partialF = -0.29999999999999999 - var_x224 - var_x226;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x201 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x230 = 3.2000000000000002 * var_x201;
            
            partialF = -0.01 - var_x230;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x199 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x201 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x231 = 0.025000000000000001 * var_x199;
            const double var_x233 = 2.3999999999999999 * var_x201;
            
            partialF = -0.0050000000000000001 - var_x231 - var_x233;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0025000000000000001 - var_x204 - var_x206;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x201 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x216 = 0.80000000000000004 * var_x201;
            const double var_x234 = 0.074999999999999997 * var_x199;
            
            partialF = -0.00125 - var_x216 - var_x234;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative21(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x238 = exp(2.1052631578947367 + 0.10526315789473684 * var_chaste_interface__membrane__V);
            const double var_x239 = 1 + var_x238;
            const double var_x240 = 1 / var_x239;
            const double var_x241 = 1 / (0.02 + 0.59999999999999998 * var_x240);
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x242 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 3);
            const double var_x243 = 4050000 * var_x242;
            
            partialF = -0.67600000000000005 - var_x243;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x244 = 12150000000 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 4);
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative28(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x104 = pow((0.031622776601683791 + var_x38), (-2));
            const double var_x105 = 1 / var_x44;
            const double var_x106 = var_x104 * var_x105 * var_x37 * var_x38 * var_x48;
            const double var_x107 = var_x25 * var_x35 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2);
            
            partialF = (-5.0952821319166834e-6 * var_x37 - 2.768751798927894 * var_x107 - 6.0676044384883792e-6 * var_x106 - 0.0016436393973924784 * var_x103) * mParameters[2];
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative29(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x75 = var_x51 * var_x61 * var_chaste_interface__membrane__V;
            const double var_x76 = var_x58 * var_x75;
            const double var_x95 = 1 / (var_chaste_interface__intracellular_ion_concentrations__Ki + 0.018329999999999999 * var_chaste_interface__intracellular_ion_concentrations__Nai);
            ...
            partialF = (-3.6423049046217326e-6 * var_x108 - 1.28669728151281e-10 * var_x112 - 0.00082181969869623921 * var_x110 - 0.0016436393973924784 * var_x102 - 0.0016436393973924784 * var_x109 - 0.0016436393973924784 * var_x111 + 2.3072931657732449e-5 * var_x19 * var_x20 * var_x6 * var_x72 * var_x9 * mParameters[4] * mParameters[11]) * mParameters[2];
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative30(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x56 = var_x54 * var_x55 * mParameters[6];
            const double var_x57 = var_x56 * var_chaste_interface__membrane__V;
            const double var_x253 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            const double var_x254 = 1 + 0.00011900000000000002 / pow(var_x253, 2);
            const double var_x255 = 1 / var_x254;
            const double var_x256 = 0.001 * var_x255;
            const double var_x261 = 133.33333333333334 * var_chaste_interface__RyR_channel__P_O1 + 133.33333333333334 * var_chaste_interface__RyR_channel__P_O2;
            const double var_x262 = -var_chaste_interface__intracellular_ion_concentrations__Ca_ss + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR;
            const double var_x263 = var_chaste_interface__RyR_channel__P_O1 + var_chaste_interface__RyR_channel__P_O2;
            
            partialF = var_x256 * (-806491.88514357049 - var_x261 * mParameters[0]) + 2.3800000000000004e-7 * (806491.88514357049 * var_chaste_interface__intracellular_ion_concentrations__Cai - 806491.88514357049 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 9570598.0870152581 * var_x51 * var_x57 + 133.33333333333334 * var_x262 * var_x263 * mParameters[0]) / (pow(var_x253, 3) * pow(var_x254, 2));
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative31(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x269 = var_x263 * mParameters[0];
            
            partialF = var_x267 * (-1740.0382808421784 - var_x263 * mParameters[0]) + 0.00016666666666666666 * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR - var_x262 * var_x269) / (pow(var_x264, 3) * pow((0.083333333333333329 + var_x265), 2));
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative32(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.13257434520702313 - 0.0011893356491532784 * var_x122 - 3.2630189260961817e-12 * var_x126;
        }
        else
        {
