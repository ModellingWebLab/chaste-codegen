...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLGRL2::VerifyStateVariables()
    {
    ...
    void Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLGRL2::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        // Mathematics
        double d_dt_chaste_interface_var_membrane__V;
        const double var_potassium_channel_n_gate__B = -0.10000000000000001; // per_millivolt
        const double var_potassium_channel_n_gate__A = -0.01 / var_potassium_channel_n_gate__B; // per_millisecond
    ...
    double Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x5 = (var_x4 >= -9.9999999999999995e-8) && (var_x4 <= 9.9999999999999995e-8);
            const double var_x6 = exp(-var_x4);
            ...
            partialF = -((var_x5) ? (3.5 + 0.050000000000000003 * var_chaste_interface__membrane__V) : (-1 * var_x4 * var_x8)) - 4 * var_x9;
        }
        else
        {
    ...
    double Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x3 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x13 = 6.5 + var_x3;
            const double var_x14 = (var_x13 >= -9.9999999999999995e-8) && (var_x13 <= 9.9999999999999995e-8);
            ...
            partialF = -((var_x14) ? (0.42499999999999999 + 0.0050000000000000001 * var_chaste_interface__membrane__V) : (-0.099999999999999992 * var_x13 * var_x17)) - 0.125 * var_x18;
        }
        else
        {
