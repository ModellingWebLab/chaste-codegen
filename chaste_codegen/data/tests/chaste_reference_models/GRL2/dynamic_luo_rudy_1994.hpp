#ifndef DYNAMICLUO_RUDY_1994FROMCELLMLGRL2_HPP_
#define DYNAMICLUO_RUDY_1994FROMCELLMLGRL2_HPP_
...
class Dynamicluo_rudy_1994FromCellMLGRL2 : public AbstractGeneralizedRushLarsenCardiacCell, public AbstractDynamicallyLoadableEntity
{
...
public:
    ...
    Dynamicluo_rudy_1994FromCellMLGRL2(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Dynamicluo_rudy_1994FromCellMLGRL2();
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Dynamicluo_rudy_1994FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Dynamicluo_rudy_1994FromCellMLGRL2 * t, const unsigned int fileVersion)
        {
            boost::shared_ptr<AbstractIvpOdeSolver> p_solver;
            boost::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Dynamicluo_rudy_1994FromCellMLGRL2(p_solver, p_stimulus);
        }
...
#endif // DYNAMICLUO_RUDY_1994FROMCELLMLGRL2_HPP_