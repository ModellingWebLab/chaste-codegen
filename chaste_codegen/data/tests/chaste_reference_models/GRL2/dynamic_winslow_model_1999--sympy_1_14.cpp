...
#include "MathsCustomFunctions.hpp"
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x19 = 1 + 31.622776601683793 * var_x18;
            const double var_x20 = exp(-0.0037433890822745476 * var_chaste_interface__membrane__V);
            const double var_x21 = 0.037433890822745473 * var_chaste_interface__membrane__V;
            const double var_x22 = (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[5])) * exp(-var_x21);
            const double var_x23 = 1 + 0.1245 * var_x20 + 0.036499999999999998 * var_x22;
            const double var_x24 = mParameters[4] / (1.5 + mParameters[4]);
            const double var_x25 = var_x24 * (0.0013663370150302097 * var_x22 + 0.00046605194074318115 * var_x20) / (var_x19 * pow(var_x23, 2));
            const double var_x26 = var_chaste_interface__L_type_Ca_current__O + var_chaste_interface__L_type_Ca_current__O_Ca;
            const double var_x27 = var_x26 * var_chaste_interface__L_type_Ca_current_y_gate__y;
            ...
            const double var_x30 = -1 + var_x28;
            const double var_x31 = mParameters[6] / var_x30;
            const double var_x32 = var_x29 * var_x31;
            const double var_x33 = 14447.286958825252 * var_x32;
            const double var_x34 = var_x28 * var_chaste_interface__membrane__V;
            const double var_x35 = var_x31 * var_x34;
            const double var_x36 = var_x27 * var_x35;
            const double var_x37 = -var_x9 + var_x3 * var_x4 * mParameters[3];
            const double var_x38 = var_x14 * var_x37 * var_x6 / pow(var_x10, 2);
            const double var_x39 = pow(var_x30, (-2));
            const double var_x40 = var_x29 * var_x34 * var_x39 * mParameters[6];
            const double var_x41 = exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V);
            const double var_x42 = 1 + var_x41;
            const double var_x43 = 1 / var_x42;
            const double var_x44 = pow(var_chaste_interface__slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks, 2) * mParameters[13];
            const double var_x45 = mParameters[15] * var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1;
            const double var_x46 = var_x45 * var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1;
            const double var_x47 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ki;
            const double var_x48 = var_x47 * mParameters[4];
            const double var_x49 = log(var_x48);
            const double var_x50 = -26.713760659695648 * var_x49 + var_chaste_interface__membrane__V;
            const double var_x51 = exp(0.044600000000000001 * var_chaste_interface__membrane__V);
            const double var_x52 = 1 + 1.4944999999999999 * var_x51;
            const double var_x53 = sqrt(mParameters[4]);
            const double var_x54 = var_x53 * mParameters[12] / var_x52;
            const double var_x55 = var_x54 * var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr;
            const double var_x56 = 1 * mParameters[4];
            const double var_x57 = exp(0.056150836234118207 * var_chaste_interface__membrane__V - 1.5 * var_x49);
            const double var_x58 = 2 + var_x57;
            const double var_x59 = mParameters[11] / (13 + mParameters[4]);
            const double var_x60 = var_x59 / var_x58;
            const double var_x61 = 54518.063995566983 * var_x32;
            const double var_x62 = 1 - var_x61 * var_chaste_interface__membrane__V;
            const double var_x63 = 1 / var_x62;
            const double var_x64 = exp(var_x21);
            const double var_x65 = -1 + var_x64;
            const double var_x66 = 1 / var_x65;
            const double var_x67 = var_x64 * var_chaste_interface__intracellular_ion_concentrations__Ki;
            const double var_x68 = var_x67 - mParameters[4];
            const double var_x69 = var_x63 * var_x66 * var_x68;
            const double var_x70 = 2.0912447872899554e-6 * var_x69;
            const double var_x71 = var_x50 * var_x57 * var_x59 / pow(var_x58, 2);
            const double var_x72 = var_x27 * var_x63 * var_x66 * var_chaste_interface__membrane__V;
            const double var_x73 = var_x27 * var_x68 * var_chaste_interface__membrane__V;
            const double var_x74 = var_x44 + var_x46 + 0.5 * var_x55 + 0.0022160000000000001 * var_x43 + var_x27 * var_x70 + var_x56 * var_x60 + 7.8283429051047759e-8 * var_x67 * var_x72 - 0.056150836234118207 * var_x71 * mParameters[4] + 0.00037056856187290968 * var_x41 * var_x50 / pow(var_x42, 2) + 2.0912447872899554e-6 * var_x66 * var_x73 * (var_x61 + 4.0816465109550109 * var_x35 - 4081.6465109550109 * var_x40) / pow(var_x62, 2) - 7.8283429051047759e-8 * var_x63 * var_x64 * var_x73 / pow(var_x65, 2) - 0.033327349999999999 * var_x50 * var_x51 * var_x53 * mParameters[12] * var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr / pow(var_x52, 2);
            const double var_x75 = 1 / mParameters[7];
            const double var_x76 = 0.001 * var_x75;
            
            partialF = -var_x76 * (0.0034841999999999998 + var_x2 + var_x74 + 5000 * var_x16 + 0.69299999999999995 * var_x25 + 1.0816363254030779 * var_x36 + 24.332029034784558 * var_x38 + var_x27 * var_x33 - 1081.636325403078 * var_x27 * var_x40);
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x79 = 1 / var_chaste_interface__intracellular_ion_concentrations__Cai;
            const double var_x80 = pow(var_x77, (-2));
            const double var_x101 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Cai;
            const double var_x102 = 1 + 0.00011900000000000002 / pow(var_x101, 2);
            const double var_x103 = 1 / var_x102;
            const double var_x104 = 0.001 * var_x103;
            const double var_x105 = 0.0015381954438488301 * var_x78;
            const double var_x106 = pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 0.19999999999999996);
            const double var_x107 = pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 1.2);
            const double var_x108 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_NSR, 1);
            const double var_x109 = 1 + 33855.471141425078 * var_x107 + 0.303951367781155 * var_x108;
            const double var_x110 = 1 / var_x109;
            const double var_x111 = var_x110 * mParameters[1];
            const double var_x112 = pow(var_x109, (-2));
            const double var_x113 = 2752.4498037978587 * var_x107 - 0.096656534954407292 * var_x108;
            const double var_x114 = 2800.0000000000005 * var_chaste_interface__intracellular_ion_concentrations__Cai;
            
            partialF = var_x104 * (-5637.4531835205999 - var_x105 + 2800.0000000000005 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 2800.0000000000005 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa - 0.00015787156411954756 * var_x79 + 0.0015381954438488301 * var_x80 * var_chaste_interface__intracellular_ion_concentrations__Cai - 307.63908876976598 * var_x15 * var_x8 - 3302.9397645574304 * var_x106 * var_x111 + 40626.565369710093 * var_x106 * var_x112 * var_x113 * mParameters[1]) + 2.3800000000000004e-7 * (2.8000000000000003 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss + 0.0092400000000000017 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 0.00015787156411954756 * log(var_x79 * mParameters[3]) - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Cai - 1.181949379053441e-5 * var_chaste_interface__membrane__V - var_x105 * var_chaste_interface__intracellular_ion_concentrations__Cai - var_x111 * var_x113 - var_x114 * (1 - var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa) - var_x114 * (1 - var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa) + 307.63908876976598 * var_x11 * var_x12 * var_x13 * var_x37 * mParameters[14]) / (pow(var_x101, 3) * pow(var_x102, 2));
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x116 = -0.13565000000000002 - 0.0050000000000000001 * var_chaste_interface__membrane__V;
            const double var_x118 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
            const double var_x120 = var_chaste_interface__membrane__V >= -90;
            const double var_x121 = 47.130000000000003 + var_chaste_interface__membrane__V;
            const double var_x122 = (var_x120) && (fabs(var_x121) < 1.0000000000000001e-5);
            const double var_x123 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x124 = exp(-4.7130000000000001 - var_x123);
            const double var_x125 = 1 - var_x124;
            const double var_x126 = 320 / var_x125;
            const double var_x127 = 80 * var_x118;
            
            partialF = 0.001 * ((var_x122) ? (-var_x127 - 1000 / var_x116) : ((var_x120) ? (-var_x127 - var_x121 * var_x126) : (0)));
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x128 = exp(-11.764705882352942 + 0.14705882352941177 * mParameters[10] - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x129 = var_chaste_interface__membrane__V < -40;
            const double var_x130 = ((var_x129) ? (135 * var_x128) : (0));
            const double var_x131 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * mParameters[10]);
            const double var_x132 = exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * mParameters[10]);
            const double var_x133 = exp(-0.96036036036036043 + 0.0900900900900901 * mParameters[10] - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x134 = 1 + var_x133;
            const double var_x135 = ((var_x129) ? (3560 * var_x131 + 310000 * var_x132) : (7692.3076923076924 / var_x134));
            
            partialF = -0.001 * var_x130 - 0.001 * var_x135;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x146 = exp(-3.2000000000000002 - var_x123 + 0.10000000000000001 * mParameters[10]);
            ...
            const double var_x150 = ((var_x129) ? (121.2 * var_x145) : (300 * var_x149));
            const double var_x151 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x152 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * mParameters[10]);
            const double var_x153 = exp(0.043909999999999998 * mParameters[10] - 0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x154 = -127140 * var_x152 - 3.4740000000000003e-5 * var_x153;
            const double var_x155 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * mParameters[10]);
            const double var_x156 = 1 + var_x155;
            const double var_x157 = 1000 / var_x156;
            const double var_x158 = var_x154 * var_x157;
            const double var_x159 = ((var_x129) ? (var_x151 * var_x158) : (0));
            
            partialF = -0.001 * var_x150 - 0.001 * var_x159;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x164 = exp(-7.6769999999999996 - 0.012800000000000001 * var_chaste_interface__membrane__V);
            const double var_x165 = exp(-5.4950000000000001 + 0.1691 * var_chaste_interface__membrane__V);
            const double var_x166 = var_x164 + var_x165;
            const double var_x167 = 1 / var_x166;
            const double var_x170 = 0.027 + 0.001 * var_x167;
            const double var_x171 = 0.001 / var_x170;
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x177 = exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V);
            const double var_x178 = 1 - var_x177;
            const double var_x179 = 1 / var_x178;
            const double var_x180 = -10 + var_chaste_interface__membrane__V;
            
            partialF = -0.00013100000000000001 * var_x176 * var_x180 - 7.1899999999999999e-5 * var_x179 * var_x180;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x181 = exp(-0.062370000000000002 * var_chaste_interface__membrane__V);
            const double var_x182 = exp(0.035770000000000003 * var_chaste_interface__membrane__V);
            
            partialF = -0.045159999999999999 * var_x182 - 0.098900000000000002 * var_x181;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x183 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x184 = 6.7000000000000002 + var_x183;
            const double var_x185 = exp(var_x184);
            const double var_x186 = 1 + 0.051334999999999999 * var_x185;
            const double var_x187 = var_x185 / var_x186;
            const double var_x189 = exp(-var_x184);
            const double var_x190 = 1 + 0.051334999999999999 * var_x189;
            const double var_x191 = var_x189 / var_x190;
            
            partialF = -0.0054149999999999997 * var_x187 - 0.0054149999999999997 * var_x191;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x194 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x196 = 1.6000000000000001 * var_x194;
            const double var_x197 = 0.10375 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x192 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x194 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x198 = 0.050000000000000003 * var_x192;
            const double var_x202 = 1.2 * var_x194;
            const double var_x203 = 0.20749999999999999 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            
            partialF = -var_x198 - var_x202 - var_x203;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x192 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x194 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x204 = 0.10000000000000001 * var_x192;
            const double var_x207 = 0.80000000000000004 * var_x194;
            const double var_x208 = 0.41499999999999998 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            
            partialF = -var_x204 - var_x207 - var_x208;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x192 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x194 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x209 = 0.14999999999999999 * var_x192;
            const double var_x212 = 0.40000000000000002 * var_x194;
            const double var_x213 = 0.82999999999999996 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            
            partialF = -var_x209 - var_x212 - var_x213;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x192 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x214 = 0.20000000000000001 * var_x192;
            const double var_x216 = 1.6599999999999999 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            
            partialF = -0.29999999999999999 - var_x214 - var_x216;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x194 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x219 = 3.2000000000000002 * var_x194;
            
            partialF = -0.01 - var_x219;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x192 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            const double var_x194 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x220 = 0.025000000000000001 * var_x192;
            const double var_x221 = 2.3999999999999999 * var_x194;
            
            partialF = -0.0050000000000000001 - var_x220 - var_x221;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0025000000000000001 - var_x196 - var_x198;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x194 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x207 = 0.80000000000000004 * var_x194;
            const double var_x222 = 0.074999999999999997 * var_x192;
            
            partialF = -0.00125 - var_x207 - var_x222;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0076249999999999998 - var_x204;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative21(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x226 = exp(2.1052631578947367 + 0.10526315789473684 * var_chaste_interface__membrane__V);
            const double var_x227 = 1 + var_x226;
            const double var_x228 = 0.02 + 0.59999999999999998 / var_x227;
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x230 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 3);
            const double var_x231 = 4050000 * var_x230;
            
            partialF = -0.67600000000000005 - var_x231;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x232 = 12150000000.0 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 4);
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative28(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x23 = 1 + 0.1245 * var_x20 + 0.036499999999999998 * var_x22;
            const double var_x24 = mParameters[4] / (1.5 + mParameters[4]);
            const double var_x97 = var_x17 * var_x18 * var_x24 / (pow(var_x19, 2) * var_x23);
            const double var_x98 = var_x15 * var_x5 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2);
            const double var_x99 = 0.082812658045056511 * var_x17 + 26.713760659695648 * var_x17 * var_x2;
            const double var_x235 = 6.1527817753953199e-5 * mParameters[2];
            
            partialF = -var_x235 * (var_x99 + 45000 * var_x98 + 98.615628832350907 * var_x97);
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative29(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x71 = var_x50 * var_x57 * var_x59 / pow(var_x58, 2);
            const double var_x72 = var_x27 * var_x63 * var_x66 * var_chaste_interface__membrane__V;
            const double var_x88 = 1 / (1 * var_chaste_interface__intracellular_ion_concentrations__Ki + 0.018329999999999999 * var_chaste_interface__intracellular_ion_concentrations__Nai);
            const double var_x95 = var_x44 * var_x88;
            const double var_x100 = 26.713760659695648 * var_x95 + 13.356880329847824 * var_x47 * var_x55 + 26.713760659695648 * var_x46 * var_x47 + 26.713760659695648 * var_x48 * var_x60 + 0.05919769362188556 * var_x43 * var_x47 + 2.0912447872899554e-6 * var_x64 * var_x72 - 1.5 * var_x48 * var_x71;
            const double var_x235 = 6.1527817753953199e-5 * mParameters[2];
            
            partialF = -var_x100 * var_x235;
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative30(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x31 = mParameters[6] / var_x30;
            const double var_x32 = var_x29 * var_x31;
            const double var_x240 = 9570598.0870152581 * var_x27 * var_x32;
            const double var_x241 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
            const double var_x242 = 1 + 0.00011900000000000002 / pow(var_x241, 2);
            const double var_x243 = 1 / var_x242;
            const double var_x244 = 0.001 * var_x243;
            const double var_x248 = -var_chaste_interface__intracellular_ion_concentrations__Ca_ss + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR;
            const double var_x251 = var_chaste_interface__RyR_channel__P_O1 + var_chaste_interface__RyR_channel__P_O2;
            const double var_x252 = var_x251 * mParameters[0];
            
            partialF = var_x244 * (-806491.88514357049 - 133.33333333333334 * var_x252) + 2.3800000000000004e-7 * (806491.88514357049 * var_chaste_interface__intracellular_ion_concentrations__Cai - 806491.88514357049 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - var_x240 * var_chaste_interface__membrane__V + 133.33333333333334 * var_x248 * var_x251 * mParameters[0]) / (pow(var_x241, 3) * pow(var_x242, 2));
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative31(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x251 = var_chaste_interface__RyR_channel__P_O1 + var_chaste_interface__RyR_channel__P_O2;
            const double var_x252 = var_x251 * mParameters[0];
            const double var_x253 = 0.80000000000000004 + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR;
            const double var_x254 = 1 + 12 / pow(var_x253, 2);
            const double var_x255 = 1 / var_x254;
            const double var_x256 = 0.001 * var_x255;
            
            partialF = var_x256 * (-1740.0382808421784 - var_x252) + 0.024 * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR - var_x248 * var_x252) / (pow(var_x253, 3) * pow(var_x254, 2));
        }
        else
        {
    ...
    double Dynamicwinslow_model_1999FromCellMLGRL2::EvaluatePartialDerivative32(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x112 = pow(var_x109, (-2));
            const double var_x113 = 2752.4498037978587 * var_x107 - 0.096656534954407292 * var_x108;
            const double var_x115 = var_x112 * var_x113 * mParameters[1];
            
            partialF = -0.13257434520702313 - 0.0011893356491532784 * var_x111 - 0.0037400492111738315 * var_x115;
        }
        else
        {
