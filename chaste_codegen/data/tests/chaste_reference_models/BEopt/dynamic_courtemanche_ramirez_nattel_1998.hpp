...
private:
    static AbstractBackwardEulerCardiacCell<8>* CreateMethod(std::shared_ptr<AbstractIvpOdeSolver> p_solver, std::shared_ptr<AbstractStimulusFunction> p_stimulus);
...
public:
    ...
    Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerOpt(std::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, std::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
