...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + 0.10000000000000001 * exp(-0.024332874996168673 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(0.66964285714285721 + 0.044642857142857144 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(5.6000000000000005 + 0.070000000000000007 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.0050000000000000001 + 0.050000000000000003 / (1 + exp(1.1538461538461537 - 0.076923076923076927 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return -1 / (1 + exp(2.3529411764705883 - 0.058823529411764705 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(-1.25 - 0.125 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-4.057971014492753 - 0.14492753623188406 * var_chaste_interface__membrane__V) / (1 + exp(-4.057971014492753 - 0.14492753623188406 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return ((var_chaste_interface__membrane__V == (-47.130000000000003)) ? (3.2000000000000002) : (0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__V) / (1 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(-2.1692307692307691 - 0.15384615384615385 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return pow((1 + exp(1.5669291338582676 - 0.07874015748031496 * var_chaste_interface__membrane__V)), (-0.5));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(-1.1670467502850628 - 0.057012542759407071 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.78000000000000003 / (1 + 0.40000000000000002 * exp(4.8235294117647056 + 0.058823529411764705 * var_chaste_interface__membrane__V)) + 1.9500000000000002 / (exp(0.50847457627118642 - 0.016949152542372881 * var_chaste_interface__membrane__V) + exp(-1.1764705882352942 - 0.11764705882352941 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(8.1320754716981138 + 0.18867924528301888 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.16189962223421478 / (1 + 0.053966540744738258 * exp(10.383561643835618 + 0.091324200913242018 * var_chaste_interface__membrane__V)) + 0.084364454443194598 / (1 + 0.028121484814398197 * exp(-0.16935483870967738 - 0.13440860215053763 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(-3.15625 - 0.10416666666666667 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(-3.6189956331877728 + 0.036390101892285295 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 3 / exp(9.875 - 0.0625 * var_chaste_interface__membrane__V) + 0.14285714285714285 / (1 + 0.047619047619047616 * exp(6.6071428571428568 - 0.035714285714285712 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        ...
        const double var_sodium_potassium_pump__i_NaK = 0.59933873999999998 * mParameters[9] * mParameters[5] / ((1 + 31.622776601683793 * pow((1 / var_chaste_interface__intracellular_ion_concentrations__Na_i), 1.5)) * (1.5 + mParameters[5]) * (1 + _lt_0_row[4] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[6])) * _lt_0_row[3])); // picoA
        ...
        const double var_time_independent_potassium_current__i_K1_converted = 9.9999999999999995e-7 * _lt_0_row[6] * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * HeartConfig::Instance()->GetCapacitance() * mParameters[9] * mParameters[13] / var_membrane__Cm_converted; // uA_per_cm2
...
// LCOV_EXCL_STOP
        ...
        //output_equations
        const double var_Ca_uptake_current_by_the_NSR__i_up = mParameters[2] / (1 + 0.00092000000000000003 / var_chaste_interface__intracellular_ion_concentrations__Ca_i); // millimolar_per_millisecond
        const double d_dt_chaste_interface_var_L_type_Ca_channel_f_Ca_gate__f_Ca = (-var_chaste_interface__L_type_Ca_channel_f_Ca_gate__f_Ca + 0.00035 / (0.00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_i)) / mParameters[8]; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_Ca_release_current_from_JSR_u_gate__u = 0.125 / (1 + exp(250 - 731528895391368.0 * var_Ca_release_current_from_JSR__Fn)) - 0.125 * var_chaste_interface__Ca_release_current_from_JSR_u_gate__u; // 1 / millisecond
        ...
        const double var_sodium_potassium_pump__i_NaK = 0.59933873999999998 * mParameters[9] * mParameters[5] / ((1 + 31.622776601683793 * pow((1 / var_chaste_interface__intracellular_ion_concentrations__Na_i), 1.5)) * (1.5 + mParameters[5]) * (1 + _lt_0_row[4] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[6])) * _lt_0_row[3])); // picoA
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Na_i = 7.5827646500219453e-7 * (-var_background_currents__i_B_Na - var_fast_sodium_current__i_Na - 3 * var_Na_Ca_exchanger_current__i_NaCa - 3 * var_sodium_potassium_pump__i_NaK) * mParameters[3]; // millimolar / millisecond
        const double var_time_independent_potassium_current__E_K = 26.712831923985377 * log(mParameters[5] / var_chaste_interface__intracellular_ion_concentrations__K_i); // millivolt
        const double var_rapid_delayed_rectifier_K_current__i_Kr = _lt_0_row[5] * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[9] * mParameters[14] * var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr; // picoA
        ...
        const double var_time_independent_potassium_current__i_K1 = _lt_0_row[6] * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[9] * mParameters[13]; // picoA
        ...
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Ca_rel = (-var_Ca_release_current_from_JSR__i_rel + var_transfer_current_from_NSR_to_JSR__i_tr) / (1 + 8 / pow((0.80000000000000004 + var_chaste_interface__intracellular_ion_concentrations__Ca_rel), 2)); // millimolar / millisecond
...
// LCOV_EXCL_STOP
        ...
        const double var_x1 = pow(var_chaste_interface__Ca_release_current_from_JSR_u_gate__u, 2);
        ...
        const double var_x4 = 70577.907827359188 * var_x3;
        const double var_x5 = _lt_0_row[1];
        const double var_x6 = pow(mParameters[6], 3);
        const double var_x7 = var_x5 * var_x6;
        const double var_x8 = _lt_0_row[0];
        const double var_x9 = -var_x7 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_x8 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * mParameters[4];
        const double var_x10 = 1 / (1 + 0.10000000000000001 * var_x5);
        const double var_x11 = 1 / (669921.875 + var_x6);
        const double var_x12 = 1 / (1.3799999999999999 + mParameters[4]);
        const double var_x13 = var_x10 * var_x11 * var_x12 * mParameters[16] * mParameters[9];
        const double var_x14 = -65 + var_chaste_interface__membrane__V;
        const double var_x15 = var_x0 * var_x4 + 0.75816552477322585 * var_x13 * var_x9 - 1.8954138119330646 * var_x14 * mParameters[7] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_Ca_gate__f_Ca * var_chaste_interface__L_type_Ca_channel_f_gate__f * mParameters[9];
        const double var_x16 = exp(250 - var_x15);
        const double var_x17 = 1 + var_x16;
        const double var_x18 = var_x16 / pow(var_x17, 2);
        const double var_x19 = var_x0 * mParameters[1] * var_chaste_interface__Ca_release_current_from_JSR_u_gate__u * var_chaste_interface__Ca_release_current_from_JSR_v_gate__v * var_chaste_interface__Ca_release_current_from_JSR_w_gate__w;
        const double var_x20 = var_x18 * var_x19;
        const double var_x21 = var_x0 * var_x2;
        const double var_x22 = 8822.2384784198985 * var_x18;
        const double var_x23 = var_x14 * mParameters[7] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * mParameters[9];
        const double var_x24 = var_x18 * var_x23;
        const double var_x25 = var_x13 * var_x7;
        const double var_x26 = var_x4 + 0.75816552477322585 * var_x25;
        const double var_x27 = var_x18 * var_x26;
        const double var_x28 = var_x13 * var_x8 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2) * mParameters[4];
        const double var_x29 = 1 / var_x17;
        const double var_x30 = 1 / (1.9099999999999999 + 2.0899999999999999 * var_x29);
        const double var_x31 = exp(50 - var_x15);
        const double var_x32 = 1 + var_x31;
        const double var_x33 = var_x31 / pow(var_x32, 2);
        const double var_x34 = var_x30 * var_x33;
        const double var_x35 = (1 - 1 / var_x32 - var_chaste_interface__Ca_release_current_from_JSR_v_gate__v) / pow((0.9138755980861244 + var_x29), 2);
        const double var_x36 = var_x18 * var_x35;
        const double var_x37 = 33769.333888688605 * var_x36;
        const double var_x38 = 1 / mParameters[8];
        const double var_x39 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x40 = 0.00050000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x41 = pow(var_x40, (-2));
        const double var_x42 = 1 + 0.00011900000000000002 / pow(var_x39, 2) + 3.5000000000000004e-5 * var_x41;
        const double var_x43 = 1 / var_x42;
        const double var_x44 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x45 = 1.0426301393780176e-7 * mParameters[9] / var_x40;
        const double var_x46 = 1 + 0.00092000000000000003 * var_x44;
        const double var_x47 = mParameters[2] / (pow(var_x46, 2) * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 2));
        const double var_x48 = 0.0070588235294117632 * var_x3;
        const double var_x49 = mParameters[0] * mParameters[2];
        const double var_x50 = 0.80000000000000004 + var_chaste_interface__intracellular_ion_concentrations__Ca_rel;
        const double var_x51 = pow(var_x50, (-2));
        const double var_x52 = 1 / (1 + 8 * var_x51);
        const double var_x53 = 26.712831923985377 * mParameters[9] / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x54 = 7.5827646500219453e-7 * mParameters[3];
        const double var_x55 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x56 = pow(var_x55, 1.5);
        const double var_x57 = var_x55 * mParameters[9];
        const double var_x58 = var_x56 * var_x57 * mParameters[5] / ((1.5 + mParameters[5]) * pow((0.031622776601683791 + var_x56), 2) * (1 + _lt_0_row[4] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[6])) * _lt_0_row[3]));
        
        
        rJacobian[0][0] = 1.0 - (mDt * (-0.125 + 17644.476956839797 * var_x20));
        rJacobian[0][1] = -(mDt * (var_x21 * var_x22));
        rJacobian[0][2] = -(mDt * (-0.23692672649163307 * var_x24));
        rJacobian[0][3] = -(mDt * (-0.125 * var_x27));
        rJacobian[0][4] = -(mDt * (var_x22 * var_x3));
        rJacobian[0][5] = 0.0;
        rJacobian[0][6] = 0.0;
        rJacobian[0][7] = -(mDt * (0.28431207178995971 * var_x18 * var_x28));
        rJacobian[1][0] = -(mDt * (-141155.81565471838 * var_x19 * var_x34 - 67538.66777737721 * var_x20 * var_x35));
        rJacobian[1][1] = 1.0 - (mDt * (var_x30 * (-1 - 70577.907827359188 * var_x21 * var_x33) - var_x21 * var_x37));
        rJacobian[1][2] = -(mDt * (0.90689656073352376 * var_x24 * var_x35 + 1.8954138119330646 * var_x23 * var_x34));
        rJacobian[1][3] = -(mDt * (var_x26 * var_x34 + 0.47846889952153115 * var_x27 * var_x35));
        rJacobian[1][4] = -(mDt * (-var_x3 * var_x37 - var_x34 * var_x4));
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[1][7] = -(mDt * (-1.0882758728802286 * var_x28 * var_x36 - 2.2744965743196777 * var_x28 * var_x34));
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (-var_x38));
        rJacobian[2][3] = -(mDt * (-0.00035 * var_x38 / pow((0.00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2)));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = 0.0;
        rJacobian[3][0] = -(mDt * (0.014117647058823526 * var_x19 * var_x43));
        rJacobian[3][1] = -(mDt * (0.0070588235294117632 * var_x21 * var_x43));
        rJacobian[3][2] = -(mDt * (-3.7913823250109726e-7 * var_x23 * var_x43));
        rJacobian[3][3] = 1.0 - (mDt * (var_x43 * (-var_x45 - var_x48 - 7.4682352941176462e-5 * var_x47 - 7.5827646500219453e-7 * var_x25 - 5.7273025005690459e-9 * var_x44 * mParameters[9] + 1.0426301393780176e-7 * var_x41 * var_chaste_interface__intracellular_ion_concentrations__Ca_i * mParameters[9]) + (0.00023800000000000004 / pow(var_x39, 3) + 7.0000000000000007e-5 / pow(var_x40, 3)) * (-var_x45 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 0.081176470588235281 * mParameters[2] / var_x46 - 3.7913823250109726e-7 * var_x23 * var_chaste_interface__L_type_Ca_channel_f_Ca_gate__f_Ca - 4.2880534095874102e-10 * (-13.356415961992688 * log(var_x44 * mParameters[4]) + var_chaste_interface__membrane__V) * mParameters[9] + 0.0054117647058823529 * mParameters[0] * mParameters[2] * var_chaste_interface__intracellular_ion_concentrations__Ca_up + 0.0070588235294117632 * var_x0 * var_x1 * mParameters[1] * var_chaste_interface__Ca_release_current_from_JSR_v_gate__v * var_chaste_interface__Ca_release_current_from_JSR_w_gate__w + 7.5827646500219453e-7 * var_x10 * var_x11 * var_x12 * var_x9 * mParameters[16] * mParameters[9]) / pow(var_x42, 2)));
        rJacobian[3][4] = -(mDt * (var_x43 * var_x48));
        rJacobian[3][5] = -(mDt * (0.0054117647058823529 * var_x43 * var_x49));
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = -(mDt * (2.2748293950065834e-6 * var_x28 * var_x43));
        rJacobian[4][0] = -(mDt * (-2 * var_x19 * var_x52));
        rJacobian[4][1] = -(mDt * (-var_x21 * var_x52));
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = -(mDt * (var_x3 * var_x52));
        rJacobian[4][4] = 1.0 - (mDt * (var_x52 * (-0.0055555555555555558 - var_x3) + 0.25 * (0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_rel - var_x0 * var_x3) / (pow(var_x50, 3) * pow((0.125 + var_x51), 2))));
        rJacobian[4][5] = -(mDt * (0.0055555555555555558 * var_x52));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (0.00092000000000000003 * var_x47));
        rJacobian[5][4] = -(mDt * (0.00048309178743961351));
        rJacobian[5][5] = 1.0 - (mDt * (-0.00048309178743961351 - 0.066666666666666666 * var_x49));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_f_gate__tau_f = 450 / (1 + 0.98499999999999988 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2)));
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40) ? (0.13500000000000001 * exp(-11.764705882352942 + 0.14705882352941177 * mParameters[12] - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0));
        const double var_fast_sodium_current_h_gate__beta_h = ((var_chaste_interface__membrane__V < -40) ? (310000 * exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * mParameters[12]) + 3.5600000000000001 * exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * mParameters[12])) : (7.6923076923076916 / (1 + exp(-0.96036036036036043 + 0.0900900900900901 * mParameters[12] - 0.0900900900900901 * var_chaste_interface__membrane__V))));
        const double var_fast_sodium_current_h_gate__h_inf = 0.01 * mParameters[11] + (1 - 0.01 * mParameters[11]) * var_fast_sodium_current_h_gate__alpha_h / (var_fast_sodium_current_h_gate__alpha_h + var_fast_sodium_current_h_gate__beta_h);
        ...
        const double var_fast_sodium_current_j_gate__beta_j = ((var_chaste_interface__membrane__V < -40) ? (0.1212 * exp(0.01052 * mParameters[12] - 0.01052 * var_chaste_interface__membrane__V) / (1 + exp(-5.5312920000000005 + 0.13780000000000001 * mParameters[12] - 0.13780000000000001 * var_chaste_interface__membrane__V))) : (0.29999999999999999 * exp(2.5349999999999999e-7 * mParameters[12] - 2.5349999999999999e-7 * var_chaste_interface__membrane__V) / (1 + exp(-3.2000000000000002 + 0.10000000000000001 * mParameters[12] - 0.10000000000000001 * var_chaste_interface__membrane__V))));
        ...
        const double var_rapid_delayed_rectifier_K_current_xr_gate__alpha_xr = ((fabs(14.1 + var_chaste_interface__membrane__V) < 1.0e-10) ? (0.0015) : (0.00029999999999999997 * (14.1 + var_chaste_interface__membrane__V) / (1 - exp(-2.8199999999999998 - 0.20000000000000001 * var_chaste_interface__membrane__V))));
        ...
        const double var_rapid_delayed_rectifier_K_current_xr_gate__xr_infinity = _lt_0_row[16];
        const double var_slow_delayed_rectifier_K_current_xs_gate__alpha_xs = ((fabs(-19.899999999999999 + var_chaste_interface__membrane__V) < 1.0e-10) ? (0.00068000000000000005) : (4.0000000000000003e-5 * (-19.899999999999999 + var_chaste_interface__membrane__V) / (1 - exp(1.1705882352941175 - 0.058823529411764705 * var_chaste_interface__membrane__V))));
        ...
        const double var_transient_outward_K_current_oa_gate__beta_oa = 0.26000000000000001 / (1 + 0.40000000000000002 * exp(4.8235294117647056 + 0.058823529411764705 * var_chaste_interface__membrane__V));
        ...
        const double var_transient_outward_K_current_oi_gate__alpha_oi = 0.053966540744738258 / (1 + 0.053966540744738258 * exp(10.383561643835618 + 0.091324200913242018 * var_chaste_interface__membrane__V));
        const double var_transient_outward_K_current_oi_gate__beta_oi = 0.028121484814398197 / (1 + 0.028121484814398197 * exp(-0.16935483870967738 - 0.13440860215053763 * var_chaste_interface__membrane__V));
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ua_gate__beta_ua = 0.26000000000000001 / (1 + 0.40000000000000002 * exp(4.8235294117647056 + 0.058823529411764705 * var_chaste_interface__membrane__V));
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__alpha_ui = 0.047619047619047616 / (1 + 0.047619047619047616 * exp(6.6071428571428568 - 0.035714285714285712 * var_chaste_interface__membrane__V));
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_f_gate__tau_f = 450 / (1 + 0.98499999999999988 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2))); // millisecond
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40) ? (0.13500000000000001 * exp(-11.764705882352942 + 0.14705882352941177 * mParameters[12] - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0)); // per_millisecond
