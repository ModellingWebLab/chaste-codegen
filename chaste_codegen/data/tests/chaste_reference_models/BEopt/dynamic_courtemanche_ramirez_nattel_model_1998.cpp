...
class Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables()
    {
...
protected:
    Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables(const Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables&);
    Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables& operator= (const Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables&);
    Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables()
    {
        ...
        Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables> mpInstance;
...
std::shared_ptr<Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables> Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables::mpInstance;

    boost::shared_ptr<RegularStimulus> Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt::UseCellMLDefaultStimulus()
    {
    ...
    Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt::Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt>::Instance();
        Init();
    ...
    Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt::~Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt()
    {
    }

    AbstractLookupTableCollection* Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt::GetLookupTableCollection()
    {
        return Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables::Instance();
    }
    
    double Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[8], double rResidual[8])
    {
...
// LCOV_EXCL_STOP
    ...
    void Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[8], double rJacobian[8][8])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -81.18
...
// LCOV_EXCL_STOP
    ...
    void Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    void Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
        ...
        CardiacNewtonSolver<8,Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt>* _p_solver = CardiacNewtonSolver<8,Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt>::Instance();
    ...
    std::vector<double> Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
...
template<>
void OdeSystemInformation<Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt>::Initialise(void)
{
...
extern "C"
{
    ...
    {
        return new Dynamiccourtemanche_ramirez_nattel_model_1998FromCellMLBackwardEulerOpt(pSolver, pStimulus);
    }
