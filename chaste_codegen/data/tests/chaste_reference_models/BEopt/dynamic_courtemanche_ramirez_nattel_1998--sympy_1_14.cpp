...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.0022222222222222222 + 0.0021888888888888887 * exp(-0.00113569 * pow((10 + var_chaste_interface__membrane__V), 2));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_channel_f_Ca_gate__f_Ca = (1 / (1 + 2857.1428571428573 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) - var_chaste_interface__L_type_Ca_channel_f_Ca_gate__f_Ca) / mParameters[8]; // 1 / millisecond
...
// LCOV_EXCL_STOP
        ...
        const double var_x29 = 1.9099999999999999 + 2.0899999999999999 / var_x17;
        ...
        const double var_x35 = (1 - 1 / var_x32 - var_chaste_interface__Ca_release_current_from_JSR_v_gate__v) / pow(var_x29, 2);
        const double var_x36 = var_x18 * var_x35;
        const double var_x37 = 147507.82735918069 * var_x36;
        ...
        const double var_x51 = 1 + 8 / pow(var_x50, 2);
        ...
        const double var_x58 = var_x56 * var_x57 * mParameters[5] / (pow((1 + 31.622776601683793 * var_x56), 2) * (1.5 + mParameters[5]) * (1 + _lt_0_row[4] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[6])) * _lt_0_row[3]));
        ...
        rJacobian[1][0] = -(mDt * (-141155.81565471838 * var_x19 * var_x34 - 295015.65471836139 * var_x20 * var_x35));
        rJacobian[1][1] = 1.0 - (mDt * (var_x30 * (-1 - 70577.907827359188 * var_x21 * var_x33) - var_x21 * var_x37));
        rJacobian[1][2] = -(mDt * (3.9614148669401046 * var_x24 * var_x35 + 1.8954138119330646 * var_x23 * var_x34));
        rJacobian[1][3] = -(mDt * (var_x26 * var_x34 + 2.0899999999999999 * var_x27 * var_x35));
        rJacobian[1][4] = -(mDt * (-var_x3 * var_x37 - var_x34 * var_x4));
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[1][7] = -(mDt * (-2.2744965743196777 * var_x28 * var_x34 - 4.753697840328126 * var_x28 * var_x36));
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (-var_x38));
        rJacobian[2][3] = -(mDt * (-2857.1428571428573 * var_x38 / pow((1 + 2857.1428571428573 * var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2)));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = 0.0;
        ...
        rJacobian[4][4] = 1.0 - (mDt * (var_x52 * (-0.0055555555555555558 - var_x3) + 16 * (0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_rel - var_x0 * var_x3) / (pow(var_x50, 3) * pow(var_x51, 2))));
        ...
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (var_x54 * (-9 * var_x28 - 0.018016135580732888 * var_x57 - 85.287397876895909 * var_x58 - 26.712831923985377 * var_x57 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * mParameters[10] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j)));
    }
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_f_gate__tau_f = 9 / (0.02 + 0.019699999999999999 * exp(-0.00113569 * pow((10 + var_chaste_interface__membrane__V), 2)));
...
// LCOV_EXCL_STOP
        ...
        const double var_L_type_Ca_channel_f_gate__tau_f = 9 / (0.02 + 0.019699999999999999 * exp(-0.00113569 * pow((10 + var_chaste_interface__membrane__V), 2))); // millisecond
