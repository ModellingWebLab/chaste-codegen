        ...
        if (mNeedsRegeneration[0])
        {
            ...
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(5.9871794871794881 - 0.12820512820512822 * var_chaste_interface__membrane__V));
                };
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + 0.10000000000000001 * exp(-0.025317124991725771 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 13 - 13 * exp(-2.1025 * pow((1 + 0.068965517241379309 * var_chaste_interface__membrane__V), 2));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + 0.0067083000000000004 * exp(-4.7857142857142856 - 0.14285714285714285 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + 0.051334999999999999 * exp(4.7857142857142856 + 0.14285714285714285 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(-2.9220779220779218 - 0.12987012987012986 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (13.17 + 39.299999999999997 * exp(-0.086199999999999999 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (2.0579999999999998 + 0.49299999999999999 * exp(-0.062899999999999998 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (270 + 1050 / (1 + exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V)));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1200 - 170 / (1 + exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V)));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-0.92307692307692313 - 0.076923076923076927 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(1.2 + 0.10000000000000001 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 + 0.69999999999999996 * exp(-160 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2)) - 0.75 * exp(-1 * pow((1 + 0.050000000000000003 * var_chaste_interface__membrane__V), 2));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-2.1025 * pow((1 + 0.068965517241379309 * var_chaste_interface__membrane__V), 2));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.1027 * exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.1027 * exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-0.90909090909090906 - 0.12987012987012986 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.1027 * exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 0.022348 * exp(0.01176 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        ...
        const double var_calcium_pump_current__i_pCa = 1 * pow(var_calcium_concentration__Cai, 2) / (0.25 + pow(var_calcium_concentration__Cai, 2)); // picoA_per_picoF
        const double var_L_type_calcium_current__i_CaL_converted = (-63 + var_chaste_interface__membrane__V) * HeartConfig::Instance()->GetCapacitance() * var_chaste_interface__L_type_calcium_current__O * mParameters[7]; // uA_per_cm2
        const double var_calcium_activated_chloride_current__i_ClCa = 2 * _lt_0_row[0] * (40 + var_chaste_interface__membrane__V) * var_calcium_concentration__Cai / (10 + var_calcium_concentration__Cai); // picoA_per_picoF
        ...
        const double var_fast_sodium_current__E_Na = 25.674321243523316 * log((1 * mParameters[6] + 0.1111111111111111 * mParameters[5]) / (1 * var_chaste_interface__sodium_concentration__Nai + 0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki)); // millivolt
        ...
        const double var_sodium_calcium_exchange_current__i_NaCa_converted = 1 * _lt_0_row[3] * (pow(var_chaste_interface__sodium_concentration__Nai, 3) * mParameters[4] * _lt_0_row[1] - pow(mParameters[6], 3) * var_calcium_concentration__Cai * _lt_0_row[2]) * HeartConfig::Instance()->GetCapacitance() * mParameters[15] / ((1380 + mParameters[4]) * (669921875000000.0 + pow(mParameters[6], 3))); // uA_per_cm2
        const double var_sodium_potassium_pump_current__i_NaK = 0.88 * mParameters[5] / ((1 + 3043189.1166997822 * pow((1 / var_chaste_interface__sodium_concentration__Nai), 1.5)) * (1500 + mParameters[5]) * (1 + _lt_0_row[5] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.4858841010401188e-5 * mParameters[6])) * _lt_0_row[4])); // picoA_per_picoF
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_calcium_buffering__HTRPN_Ca = -3.1999999999999999e-5 * var_chaste_interface__calcium_buffering__HTRPN_Ca + 0.0023700000000000001 * (140 - var_chaste_interface__calcium_buffering__HTRPN_Ca) * var_calcium_concentration__Cai; // micromolar / millisecond
        const double d_dt_chaste_interface_var_calcium_buffering__LTRPN_Ca = -0.019599999999999999 * var_chaste_interface__calcium_buffering__LTRPN_Ca + 0.0327 * (70 - var_chaste_interface__calcium_buffering__LTRPN_Ca) * var_calcium_concentration__Cai; // micromolar / millisecond
        ...
        const double d_dt_chaste_interface_var_rapid_delayed_rectifier_potassium_current__C_K1 = 0.036777999999999998 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - 0.023761000000000001 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 + 0.022348 * (1 - var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K - var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K) * _lt_0_row[27] - 0.047002000000000002 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 * _lt_0_row[28]; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_calcium_concentration__CaJSR = (-var_calcium_fluxes__J_rel + var_calcium_fluxes__J_tr) / (1 + 18.75 / pow((1 + 0.00125 * var_chaste_interface__calcium_concentration__CaJSR), 2)); // micromolar / millisecond
        ...
        const double d_dt_chaste_interface_var_ryanodine_receptors__P_O2 = -0.96499999999999997 * var_chaste_interface__ryanodine_receptors__P_O2 + 0.0040499999999999998 * pow(var_chaste_interface__calcium_concentration__Cass, 3) * var_chaste_interface__ryanodine_receptors__P_O1; // 1 / millisecond
        const double d_dt_chaste_interface_var_ryanodine_receptors__P_O1 = 0.00080000000000000004 * var_chaste_interface__ryanodine_receptors__P_C2 + 0.96499999999999997 * var_chaste_interface__ryanodine_receptors__P_O2 - 0.080249999999999988 * var_chaste_interface__ryanodine_receptors__P_O1 + 0.0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4) * (1 - var_chaste_interface__ryanodine_receptors__P_C2 - var_chaste_interface__ryanodine_receptors__P_O1 - var_chaste_interface__ryanodine_receptors__P_O2) - 0.0040499999999999998 * pow(var_chaste_interface__calcium_concentration__Cass, 3) * var_chaste_interface__ryanodine_receptors__P_O1; // 1 / millisecond
        ...
        const double var_rapid_delayed_rectifier_potassium_current__i_Kr = (-25.674321243523316 * log((1 * mParameters[5] + 0.020408163265306124 * mParameters[6]) / (1 * var_chaste_interface__potassium_concentration__Ki + 0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai)) + var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K * mParameters[13]; // picoA_per_picoF
        const double var_sodium_background_current__i_Nab = 0.0025999999999999999 * var_chaste_interface__membrane__V - 0.0025999999999999999 * var_fast_sodium_current__E_Na; // picoA_per_picoF
        const double var_sodium_calcium_exchange_current__i_NaCa = 1 * _lt_0_row[3] * (pow(var_chaste_interface__sodium_concentration__Nai, 3) * mParameters[4] * _lt_0_row[1] - pow(mParameters[6], 3) * var_calcium_concentration__Cai * _lt_0_row[2]) * mParameters[15] / ((1380 + mParameters[4]) * (669921875000000.0 + pow(mParameters[6], 3))); // picoA_per_picoF
        ...
        const double var_sodium_potassium_pump_current__i_NaK = 0.88 * mParameters[5] / ((1 + 3043189.1166997822 * pow((1 / var_chaste_interface__sodium_concentration__Nai), 1.5)) * (1500 + mParameters[5]) * (1 + _lt_0_row[5] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.4858841010401188e-5 * mParameters[6])) * _lt_0_row[4])); // picoA_per_picoF
        const double d_dt_chaste_interface_var_sodium_concentration__Nai = -0.061518471582797281 * (3 * var_sodium_calcium_exchange_current__i_NaCa + 3 * var_sodium_potassium_pump_current__i_NaK + var_fast_sodium_current__i_Na + var_sodium_background_current__i_Nab) * mParameters[8] * mParameters[3]; // micromolar / millisecond
...
// LCOV_EXCL_STOP
        ...
        const double var_x2 = var_x1 * (_lt_0_row[39]) / (1 + 0.12 * var_x1);
        ...
        const double var_x20 = var_chaste_interface__calcium_concentration__Cass / pow((1 + 0.050000000000000003 * var_chaste_interface__calcium_concentration__Cass), 2);
        const double var_x21 = -var_x15 * var_chaste_interface__L_type_calcium_current__C4 + 2.3324000000000003e-6 * var_x2 * var_x20 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x22 = var_x9 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x23 = 0.00058310000000000002 * var_x20;
        const double var_x24 = var_x22 * var_x23 - var_x11 * var_x22;
        const double var_x25 = 0.013000000000000001 * var_x7;
        const double var_x26 = -var_x25;
        const double var_x27 = 0.00040000000000000002 * var_x2;
        const double var_x28 = var_x23 * var_chaste_interface__L_type_calcium_current__O - var_x11 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x29 = 0.013000000000000001 - var_x25;
        const double var_x30 = var_x23 * var_chaste_interface__L_type_calcium_current__I2 - var_x11 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x31 = 2.3700000000000001 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x32 = 3.1999999999999999e-5 + var_x31;
        const double var_x33 = 2.3700000000000001 * var_chaste_interface__calcium_buffering__HTRPN_Ca;
        const double var_x34 = 32.699999999999996 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x35 = 0.019599999999999999 + var_x34;
        const double var_x36 = 32.699999999999996 * var_chaste_interface__calcium_buffering__LTRPN_Ca;
        const double var_x37 = 1 + 0.00125 * var_chaste_interface__calcium_concentration__CaJSR;
        const double var_x38 = pow(var_x37, (-2));
        const double var_x39 = 1 / (1 + 18.75 * var_x38);
        const double var_x40 = var_chaste_interface__ryanodine_receptors__P_O1 + var_chaste_interface__ryanodine_receptors__P_O2;
        const double var_x41 = var_x40 * mParameters[1];
        const double var_x42 = var_x41 * var_chaste_interface__calcium_fluxes__P_RyR;
        const double var_x43 = -var_chaste_interface__calcium_concentration__Cass + var_chaste_interface__calcium_concentration__CaJSR;
        const double var_x44 = var_x39 * var_x43;
        const double var_x45 = var_chaste_interface__calcium_fluxes__P_RyR * mParameters[1];
        const double var_x46 = -var_x44 * var_x45;
        const double var_x47 = pow(var_chaste_interface__calcium_concentration__Cai_converted, 2);
        const double var_x48 = 1000000 * var_x47;
        const double var_x49 = 1 / (0.25 + var_x48);
        const double var_x50 = var_x49 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x51 = pow((2.4999999999999999e-7 + var_x47), (-2));
        const double var_x52 = pow(var_chaste_interface__calcium_concentration__Cai_converted, 3);
        const double var_x53 = var_x51 * var_x52;
        const double var_x54 = 0.00023799999999999998 + var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x55 = 1 + 1.19e-5 / pow(var_x54, 2);
        ...
        const double var_x59 = 2000000 * var_x50;
        const double var_x60 = _lt_0_row[2];
        const double var_x61 = pow(mParameters[6], 3);
        const double var_x62 = var_x60 * var_x61;
        const double var_x63 = mParameters[15] / ((1 + 0.10000000000000001 * var_x60) * (1380 + mParameters[4]) * (669921875000000.0 + var_x61));
        const double var_x64 = var_x62 * var_x63;
        const double var_x65 = 0.03075923579139864 * mParameters[8];
        const double var_x66 = 1000 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x67 = var_x48 * var_x49;
        const double var_x68 = _lt_0_row[1];
        const double var_x69 = var_x63 * var_x68 * pow(var_chaste_interface__sodium_concentration__Nai, 2) * mParameters[4];
        const double var_x70 = 0.23799999999999999 + var_chaste_interface__calcium_concentration__Cass;
        const double var_x71 = pow(var_x70, (-2));
        const double var_x72 = 1 / (1 + 11.899999999999999 * var_x71);
        const double var_x73 = (-63 + var_chaste_interface__membrane__V) * mParameters[7];
        const double var_x74 = 535.23141606043157 * var_x73 * mParameters[8];
        const double var_x75 = 80.808080808080803 * var_x42;
        const double var_x76 = 80.808080808080803 * var_x43 * var_x72;
        const double var_x77 = var_x45 * var_x76;
        const double var_x78 = 0.04926108374384236 * var_chaste_interface__membrane__V;
        const double var_x79 = 0.20000000000000001 * exp(0.12315270935960591 - var_x78);
        const double var_x80 = _lt_0_row[41];
        const double var_x81 = 1 / (0.25 * var_x80 + _lt_0_row[42]);
        const double var_x82 = 3.802 * var_x81;
        const double var_x83 = 0.008539999999999999 + 2.0000000000000002e-5 * var_chaste_interface__membrane__V;
        const double var_x84 = 3.802 / (_lt_0_row[43] + 0.23000000000000001 * var_x80);
        const double var_x85 = _lt_0_row[44];
        const double var_x86 = 6.9999999999999997e-7 * var_x85;
        const double var_x87 = exp(0.36945812807881773 - var_x78);
        const double var_x88 = 0.22 * var_x87;
        const double var_x89 = 3.802 / (0.20000000000000001 * var_x80 + _lt_0_row[45]);
        const double var_x90 = -var_x89;
        const double var_x91 = 0.19170000000000001 * exp(-0.12315270935960591 - var_x78);
        const double var_x92 = var_x84 + var_x91;
        const double var_x93 = var_x83 + var_x89;
        const double var_x94 = 1 / (0.39395599999999997 + 0.188495 * exp(-0.42168674698795178 + 0.060240963855421679 * mParameters[10] - 0.060240963855421679 * var_chaste_interface__membrane__V));
        const double var_x95 = 1.0526315789473684e-5 * var_x94;
        const double var_x96 = 1.4e-8 * var_x85;
        const double var_x97 = 0.001 * var_x94;
        const double var_x98 = -var_x83;
        const double var_x99 = 1.2097272727272726e-5 * var_x81 * var_x85 * var_x94 / (var_x83 * var_x87);
        const double var_x100 = 1 * var_x94;
        const double var_x101 = 1 / var_chaste_interface__potassium_concentration__Ki;
        const double var_x102 = var_x101 * mParameters[5];
        const double var_x103 = log(var_x102);
        const double var_x104 = -25.674321243523316 * var_x103 + var_chaste_interface__membrane__V;
        const double var_x105 = mParameters[8] * mParameters[3];
        const double var_x106 = 0.061518471582797281 * var_x105;
        const double var_x107 = var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss * mParameters[12];
        const double var_x108 = 1 / (1 * var_chaste_interface__potassium_concentration__Ki + 0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai);
        const double var_x109 = 25.674321243523316 * var_x101;
        const double var_x110 = exp(0.089599999999999999 * var_chaste_interface__membrane__V - 2.300419183419689 * var_x103);
        const double var_x111 = 1 + var_x110;
        const double var_x112 = var_x102 * mParameters[11] / (210 + mParameters[5]);
        const double var_x113 = 1 / var_chaste_interface__sodium_concentration__Nai;
        const double var_x114 = pow(var_x113, 1.5);
        const double var_x115 = var_x113 * var_x114 * mParameters[5] / ((1500 + mParameters[5]) * pow((3.2860264730588296e-7 + var_x114), 2) * (1 + _lt_0_row[5] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.4858841010401188e-5 * mParameters[6])) * _lt_0_row[4]));
        const double var_x116 = _lt_0_row[46];
        const double var_x117 = -var_x116;
        const double var_x118 = _lt_0_row[23];
        const double var_x119 = _lt_0_row[25];
        const double var_x120 = _lt_0_row[26];
        const double var_x121 = _lt_0_row[24];
        const double var_x122 = 0.012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2) * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x123 = pow(var_chaste_interface__calcium_concentration__Cass, 3);
        const double var_x124 = 0.0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4);
        const double var_x125 = 0.0040499999999999998 * var_x123;
        const double var_x126 = 1 / (1 * var_chaste_interface__sodium_concentration__Nai + 0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki);
        const double var_x127 = var_x126 * var_chaste_interface__fast_sodium_current__O_Na * mParameters[9];
        ...
        rJacobian[3][3] = 1.0 - (mDt * (-0.0135 - var_x26 - 0.002 * var_x0 * var_x9));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (var_x27));
        ...
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = 0.0;
        rJacobian[3][12] = -(mDt * (-var_x21 - var_x28));
        rJacobian[3][13] = 0.0;
        rJacobian[3][14] = 0.0;
        rJacobian[3][15] = 0.0;
        rJacobian[3][16] = 0.0;
        ...
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-var_x12 - var_x17 - var_x27));
        rJacobian[4][5] = -(mDt * (0.00050000000000000001));
        rJacobian[4][6] = -(mDt * (var_x29));
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = 0.0;
        rJacobian[4][11] = 0.0;
        rJacobian[4][12] = -(mDt * (var_x30));
        rJacobian[4][13] = 0.0;
        rJacobian[4][14] = 0.0;
        rJacobian[4][15] = 0.0;
        rJacobian[4][16] = 0.0;
        ...
        rJacobian[5][3] = -(mDt * (var_x29));
        rJacobian[5][4] = -(mDt * (var_x12));
        rJacobian[5][5] = 1.0 - (mDt * (-0.00050000000000000001 - var_x18 - var_x27));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = 0.0;
        rJacobian[5][12] = -(mDt * (-var_x24 - var_x30));
        rJacobian[5][13] = 0.0;
        rJacobian[5][14] = 0.0;
        rJacobian[5][15] = 0.0;
        rJacobian[5][16] = 0.0;
        ...
        rJacobian[6][4] = -(mDt * (var_x27));
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.013000000000000001 - var_x12 - var_x19 - var_x26));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = 0.0;
        rJacobian[6][12] = -(mDt * (var_x28));
        rJacobian[6][13] = 0.0;
        rJacobian[6][14] = 0.0;
        rJacobian[6][15] = 0.0;
        rJacobian[6][16] = 0.0;
        ...
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = -(mDt * (331.80000000000001 - var_x33));
        rJacobian[7][12] = 0.0;
        rJacobian[7][13] = 0.0;
        rJacobian[7][14] = 0.0;
        rJacobian[7][15] = 0.0;
        ...
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (-var_x35));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = -(mDt * (2289 - var_x36));
        rJacobian[8][12] = 0.0;
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = 0.0;
        rJacobian[8][15] = 0.0;
        ...
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        rJacobian[9][9] = 1.0 - (mDt * (var_x39 * (-0.050000000000000003 - var_x42) + 0.00013333333333333334 * (0.050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR - var_x42 * var_x43) / (pow(var_x37, 3) * pow((0.053333333333333337 + var_x38), 2))));
        rJacobian[9][10] = -(mDt * (0.050000000000000003 * var_x39));
        rJacobian[9][11] = 0.0;
        rJacobian[9][12] = -(mDt * (var_x39 * var_x42));
        ...
        rJacobian[9][27] = 0.0;
        rJacobian[9][28] = 0.0;
        rJacobian[9][29] = -(mDt * (var_x46));
        rJacobian[9][30] = -(mDt * (var_x46));
        rJacobian[9][31] = 0.0;
        rJacobian[10][0] = 0.0;
        rJacobian[10][1] = 0.0;
        rJacobian[10][2] = 0.0;
        ...
        rJacobian[10][11] = -(mDt * (12316.491897044803 * mParameters[0] + 24632983.794089608 * var_x50 * mParameters[2] - 24.632983794089608 * var_x53 * mParameters[2]));
        rJacobian[10][12] = 0.0;
        rJacobian[10][13] = 0.0;
        rJacobian[10][14] = 0.0;
        rJacobian[10][15] = 0.0;
        ...
        rJacobian[11][29] = 0.0;
        rJacobian[11][30] = 0.0;
        rJacobian[11][31] = -(mDt * (0.00018455541474839184 * var_x56 * var_x69 * mParameters[8]));
        rJacobian[12][0] = 0.0;
        rJacobian[12][1] = 0.0;
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = 0.0;
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = -(mDt * (-var_x72 * var_x74));
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = -(mDt * (var_x72 * var_x75));
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = -(mDt * (2175084.1750841751 * var_x72));
        rJacobian[12][12] = 1.0 - (mDt * (var_x72 * (-2175.0841750841751 - var_x75) + 0.16806722689075632 * (2175084.1750841751 * var_chaste_interface__calcium_concentration__Cai_converted - 2175.0841750841751 * var_chaste_interface__calcium_concentration__Cass - var_x74 * var_chaste_interface__L_type_calcium_current__O + 80.808080808080803 * var_x40 * var_x43 * var_chaste_interface__calcium_fluxes__P_RyR * mParameters[1]) / (pow(var_x70, 3) * pow((0.084033613445378158 + var_x71), 2))));
        rJacobian[12][13] = -(mDt * (var_x41 * var_x76));
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        rJacobian[12][17] = 0.0;
        ...
        rJacobian[12][27] = 0.0;
        rJacobian[12][28] = 0.0;
        rJacobian[12][29] = -(mDt * (var_x77));
        rJacobian[12][30] = -(mDt * (var_x77));
        rJacobian[12][31] = 0.0;
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = 0.0;
        ...
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = -(mDt * (-0.014285714285714287 * var_x73 * _lt_0_row[9]));
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = 0.0;
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-var_x79 - var_x82 - var_x83));
        rJacobian[14][15] = -(mDt * (var_x84));
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        rJacobian[14][19] = 0.0;
        rJacobian[14][20] = -(mDt * (var_x86));
        rJacobian[14][21] = -(mDt * (var_x88));
        rJacobian[14][22] = 0.0;
        rJacobian[14][23] = 0.0;
        rJacobian[14][24] = 0.0;
        rJacobian[14][25] = 0.0;
        ...
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = -(mDt * (var_x79 + var_x90));
        rJacobian[15][15] = 1.0 - (mDt * (-var_x92 - var_x93));
        rJacobian[15][16] = -(mDt * (var_x90));
        rJacobian[15][17] = -(mDt * (var_x90));
        rJacobian[15][18] = -(mDt * (var_x86 + var_x90));
        rJacobian[15][19] = -(mDt * (var_x90));
        rJacobian[15][20] = -(mDt * (var_x90));
        rJacobian[15][21] = -(mDt * (var_x90));
        rJacobian[15][22] = 0.0;
        rJacobian[15][23] = 0.0;
        rJacobian[15][24] = 0.0;
        rJacobian[15][25] = 0.0;
        ...
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (-var_x86 - var_x95));
        rJacobian[16][17] = -(mDt * (var_x96));
        rJacobian[16][18] = 0.0;
        rJacobian[16][19] = 0.0;
        rJacobian[16][20] = -(mDt * (var_x97));
        rJacobian[16][21] = 0.0;
        rJacobian[16][22] = 0.0;
        rJacobian[16][23] = 0.0;
        rJacobian[16][24] = 0.0;
        ...
        rJacobian[17][14] = 0.0;
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = -(mDt * (var_x95));
        rJacobian[17][17] = 1.0 - (mDt * (-var_x96));
        rJacobian[17][18] = 0.0;
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = 0.0;
        rJacobian[17][21] = 0.0;
        ...
        rJacobian[18][13] = 0.0;
        rJacobian[18][14] = 0.0;
        rJacobian[18][15] = -(mDt * (var_x83));
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-var_x86 - var_x92));
        rJacobian[18][19] = -(mDt * (var_x89));
        rJacobian[18][20] = -(mDt * (var_x79));
        rJacobian[18][21] = 0.0;
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        ...
        rJacobian[19][12] = 0.0;
        rJacobian[19][13] = 0.0;
        rJacobian[19][14] = -(mDt * (var_x98));
        rJacobian[19][15] = -(mDt * (var_x98));
        rJacobian[19][16] = -(mDt * (var_x98));
        rJacobian[19][17] = -(mDt * (var_x98));
        rJacobian[19][18] = -(mDt * (var_x91 - var_x83));
        rJacobian[19][19] = 1.0 - (mDt * (-var_x86 - var_x93));
        rJacobian[19][20] = -(mDt * (var_x98));
        rJacobian[19][21] = -(mDt * (var_x98));
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = 0.0;
        ...
        rJacobian[20][12] = 0.0;
        rJacobian[20][13] = 0.0;
        rJacobian[20][14] = -(mDt * (var_x83));
        rJacobian[20][15] = 0.0;
        rJacobian[20][16] = -(mDt * (var_x86));
        rJacobian[20][17] = 0.0;
        rJacobian[20][18] = -(mDt * (var_x84));
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * (-var_x79 - var_x86 - var_x97 - var_x99));
        rJacobian[20][21] = -(mDt * (var_x100));
        rJacobian[20][22] = 0.0;
        rJacobian[20][23] = 0.0;
        rJacobian[20][24] = 0.0;
        rJacobian[20][25] = 0.0;
        ...
        rJacobian[21][12] = 0.0;
        rJacobian[21][13] = 0.0;
        rJacobian[21][14] = -(mDt * (var_x82));
        rJacobian[21][15] = 0.0;
        rJacobian[21][16] = 0.0;
        rJacobian[21][17] = 0.0;
        rJacobian[21][18] = 0.0;
        rJacobian[21][19] = 0.0;
        rJacobian[21][20] = -(mDt * (var_x99));
        rJacobian[21][21] = 1.0 - (mDt * (-var_x100 - var_x88));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (-var_x104 * var_x106 * var_x107));
        rJacobian[23][23] = 1.0 - (mDt * (-var_x106 * (25.674321243523316 * var_x112 / var_x111 + var_x107 * var_x109 * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss + var_x109 * pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 2) * mParameters[14] + 4.1078913989637309 * var_x101 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur + 25.674321243523316 * var_x108 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K * mParameters[13] + var_x109 * pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 3) * mParameters[16] * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 2.300419183419689 * var_x104 * var_x110 * var_x112 / pow(var_x111, 2))));
        rJacobian[23][24] = 0.0;
        rJacobian[23][25] = 0.0;
        rJacobian[23][26] = 0.0;
        rJacobian[23][27] = -(mDt * (-var_x106 * (-25.674321243523316 * log(var_x108 * (1 * mParameters[5] + 0.020408163265306124 * mParameters[6])) + var_chaste_interface__membrane__V) * mParameters[13]));
        rJacobian[23][28] = 0.0;
        rJacobian[23][29] = 0.0;
        rJacobian[23][30] = 0.0;
        rJacobian[23][31] = -(mDt * (-var_x106 * (-8.6751098888753097e-7 * var_x115 + 0.52396573966374116 * var_x108 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K * mParameters[13])));
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = 0.0;
        rJacobian[24][2] = 0.0;
        rJacobian[24][3] = 0.0;
        ...
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-0.023761000000000001 - var_x116 - 0.047002000000000002 * _lt_0_row[28]));
        rJacobian[24][25] = -(mDt * (0.036777999999999998 - var_x116));
        rJacobian[24][26] = -(mDt * (var_x117));
        rJacobian[24][27] = -(mDt * (var_x117));
        rJacobian[24][28] = 0.0;
        rJacobian[24][29] = 0.0;
        rJacobian[24][30] = 0.0;
        rJacobian[24][31] = 0.0;
        ...
        rJacobian[25][25] = 1.0 - (mDt * (-0.036777999999999998 - var_x118));
        rJacobian[25][26] = 0.0;
        rJacobian[25][27] = -(mDt * (var_x119));
        rJacobian[25][28] = 0.0;
        rJacobian[25][29] = 0.0;
        rJacobian[25][30] = 0.0;
        rJacobian[25][31] = 0.0;
        ...
        rJacobian[26][24] = 0.0;
        rJacobian[26][25] = 0.0;
        rJacobian[26][26] = 1.0 - (mDt * (-var_x120));
        rJacobian[26][27] = -(mDt * (var_x121));
        rJacobian[26][28] = 0.0;
        rJacobian[26][29] = 0.0;
        rJacobian[26][30] = 0.0;
        rJacobian[26][31] = 0.0;
        ...
        rJacobian[27][23] = 0.0;
        rJacobian[27][24] = 0.0;
        rJacobian[27][25] = -(mDt * (var_x118));
        rJacobian[27][26] = -(mDt * (var_x120));
        rJacobian[27][27] = 1.0 - (mDt * (-var_x119 - var_x121));
        rJacobian[27][28] = 0.0;
        rJacobian[27][29] = 0.0;
        rJacobian[27][30] = 0.0;
        rJacobian[27][31] = 0.0;
        ...
        rJacobian[29][10] = 0.0;
        rJacobian[29][11] = 0.0;
        rJacobian[29][12] = -(mDt * (-var_x122 + 0.024299999999999999 * var_x123 * (1 - var_x40 - var_chaste_interface__ryanodine_receptors__P_C2)));
        rJacobian[29][13] = 0.0;
        rJacobian[29][14] = 0.0;
        rJacobian[29][15] = 0.0;
        rJacobian[29][16] = 0.0;
        ...
        rJacobian[29][26] = 0.0;
        rJacobian[29][27] = 0.0;
        rJacobian[29][28] = -(mDt * (0.00080000000000000004 - var_x124));
        rJacobian[29][29] = 1.0 - (mDt * (-0.080249999999999988 - var_x124 - var_x125));
        rJacobian[29][30] = -(mDt * (0.96499999999999997 - var_x124));
        rJacobian[29][31] = 0.0;
        rJacobian[30][0] = 0.0;
        rJacobian[30][1] = 0.0;
        rJacobian[30][2] = 0.0;
        ...
        rJacobian[31][9] = 0.0;
        rJacobian[31][10] = 0.0;
        rJacobian[31][11] = -(mDt * (184.55541474839183 * var_x105 * var_x64));
        rJacobian[31][12] = 0.0;
        rJacobian[31][13] = 0.0;
        rJacobian[31][14] = 0.0;
        rJacobian[31][15] = 0.0;
        ...
        rJacobian[31][19] = 0.0;
        rJacobian[31][20] = 0.0;
        rJacobian[31][21] = -(mDt * (-var_x106 * (-25.674321243523316 * log(var_x126 * (1 * mParameters[6] + 0.1111111111111111 * mParameters[5])) + var_chaste_interface__membrane__V) * mParameters[9]));
        rJacobian[31][22] = 0.0;
        rJacobian[31][23] = -(mDt * (-var_x106 * (2.8527023603914796 * var_x127 + 0.007417026137017846 * var_x126)));
        rJacobian[31][24] = 0.0;
        rJacobian[31][25] = 0.0;
        rJacobian[31][26] = 0.0;
        rJacobian[31][27] = 0.0;
        ...
        rJacobian[31][29] = 0.0;
        rJacobian[31][30] = 0.0;
        rJacobian[31][31] = 1.0 - (mDt * (-var_x106 * (9 * var_x69 + 1.3012664833312966e-6 * var_x115 + 0.066753235233160624 * var_x126 + 25.674321243523316 * var_x127)));
    }
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_transient_outward_potassium_current__beta_i = 0.00095 * _lt_0_row[21] * _lt_0_row[22];
        ...
        const double var_slow_transient_outward_potassium_current__tau_ti_s = 270 + 1050 / (1 + exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V));
        ...
        const double var_ultra_rapidly_activating_delayed_rectifier_potassium_current__tau_iur = 1200 - 170 / (1 + exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V));
        
        
        rY[28] = (var_chaste_interface__fast_transient_outward_potassium_current__ato_f + ((1 * var_fast_transient_outward_potassium_current__alpha_a) * mDt)) / (1.0 - ((-var_fast_transient_outward_potassium_current__alpha_a - var_fast_transient_outward_potassium_current__beta_a) * mDt));
        rY[29] = (var_chaste_interface__fast_transient_outward_potassium_current__ito_f + ((1 * var_fast_transient_outward_potassium_current__alpha_i) * mDt)) / (1.0 - ((-var_fast_transient_outward_potassium_current__alpha_i - var_fast_transient_outward_potassium_current__beta_i) * mDt));
        ...
        rY[32] = (var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs + ((1 * var_slow_delayed_rectifier_potassium_current__alpha_n) * mDt)) / (1.0 - ((-var_slow_delayed_rectifier_potassium_current__alpha_n - var_slow_delayed_rectifier_potassium_current__beta_n) * mDt));
    ...
    std::vector<double> Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEulerOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        ...
        const double var_fast_sodium_current__E_Na = var_membrane__R * var_membrane__T * log((1 * mParameters[6] + 0.1111111111111111 * mParameters[5]) / (1 * var_chaste_interface__sodium_concentration__Nai + 0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki)) / var_membrane__F; // millivolt
        const double var_fast_sodium_current__i_Na = (-var_fast_sodium_current__E_Na + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current__O_Na * mParameters[9]; // picoA_per_picoF
        ...
        const double var_rapid_delayed_rectifier_potassium_current__i_Kr = (-var_membrane__R * var_membrane__T * log((1 * mParameters[5] + 0.020408163265306124 * mParameters[6]) / (1 * var_chaste_interface__potassium_concentration__Ki + 0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai)) / var_membrane__F + var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K * mParameters[13]; // picoA_per_picoF
