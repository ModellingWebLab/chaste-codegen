...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 13 - 13 * exp(-0.01 * pow((14.5 + var_chaste_interface__membrane__V), 2));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-0.0015432098765432098 * pow((-5 + var_chaste_interface__membrane__V), 2));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 + 0.69999999999999996 * exp(-0.10000000000000001 * pow((40 + var_chaste_interface__membrane__V), 2)) - 0.75 * exp(-0.0025000000000000001 * pow((20 + var_chaste_interface__membrane__V), 2));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return exp(-0.01 * pow((14.5 + var_chaste_interface__membrane__V), 2));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_calcium_concentration__CaJSR = (-var_calcium_fluxes__J_rel + var_calcium_fluxes__J_tr) / (1 + 12000000 / pow((800 + var_chaste_interface__calcium_concentration__CaJSR), 2)); // micromolar / millisecond
...
// LCOV_EXCL_STOP
        ...
        const double var_x82 = _lt_0_row[41];
        const double var_x83 = 1 / (0.25 * var_x82 + _lt_0_row[42]);
        ...
        const double var_x86 = 3.802 / (_lt_0_row[43] + 0.23000000000000001 * var_x82);
        const double var_x87 = _lt_0_row[44];
        ...
        const double var_x91 = 3.802 / (0.20000000000000001 * var_x82 + _lt_0_row[45]);
        ...
        const double var_x117 = var_x115 * var_x116 * mParameters[5] / (pow((1 + 3043189.1166997822 * var_x116), 2) * (1500 + mParameters[5]) * (1 + _lt_0_row[5] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.4858841010401188e-5 * mParameters[6])) * _lt_0_row[4]));
        const double var_x118 = _lt_0_row[46];
        const double var_x119 = -var_x118;
        const double var_x120 = _lt_0_row[23];
        const double var_x121 = _lt_0_row[25];
        const double var_x122 = _lt_0_row[26];
        const double var_x123 = _lt_0_row[24];
        ...
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = -(mDt * (-0.014285714285714287 * var_x75 * _lt_0_row[9]));
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = 0.0;
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = 0.0;
        ...
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-0.023761000000000001 - var_x118 - 0.047002000000000002 * _lt_0_row[28]));
