...
// LCOV_EXCL_STOP
        ...
        const double var_x10 = 1 / (1.0 + 0.10000000000000001 * var_x5);
        ...
        const double var_x17 = exp(250.0 - var_x16);
        ...
        const double var_x35 = exp(50.0 - var_x16);
        const double var_x36 = 1.0 + var_x35;
        const double var_x37 = var_x35 / pow(var_x36, 2);
        const double var_x38 = var_x34 * var_x37;
        const double var_x39 = (1.0 - 1 / var_x36 - var_chaste_interface__Ca_release_current_from_JSR_v_gate__v) / pow((0.9138755980861244 + var_x33), 2);
        ...
        const double var_x52 = 1.0 + 0.00092000000000000003 * var_x50;
        ...
        const double var_x58 = 1 / (1.0 + 8.0 * var_x57);
        ...
        const double var_x63 = var_x61 * var_x62 * mParameters[5] / ((1.5 + mParameters[5]) * pow((0.031622776601683791 + var_x61), 2) * (1.0 + _lt_0_row[4] + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[6])) * _lt_0_row[3]));
