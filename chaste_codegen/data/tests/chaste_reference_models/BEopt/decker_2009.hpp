#ifndef CELLDECKER_2009FROMCELLMLBACKWARDEULEROPT_HPP_
#define CELLDECKER_2009FROMCELLMLBACKWARDEULEROPT_HPP_
...
private:
const bool is_concentration[46] = {false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, true, true, true, true, false};
...
public:
    ...
    Celldecker_2009FromCellMLBackwardEulerOpt(std::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, std::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Celldecker_2009FromCellMLBackwardEulerOpt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Celldecker_2009FromCellMLBackwardEulerOpt * t, const unsigned int fileVersion)
        {
            std::shared_ptr<AbstractIvpOdeSolver> p_solver;
            std::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Celldecker_2009FromCellMLBackwardEulerOpt(p_solver, p_stimulus);
        }
