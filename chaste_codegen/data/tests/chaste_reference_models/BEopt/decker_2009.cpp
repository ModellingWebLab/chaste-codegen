...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return ((fabs(47.130000000000003 + var_chaste_interface__membrane__Vm) < 1.0000000000287557e-6) ? (-3.200000000092018e-7 / (1.0 - exp(1.0000000000287557e-7)) + 499999.99998562218 * (47.130001 + var_chaste_interface__membrane__Vm) * (3.200000000092018e-7 / (1.0 - exp(1.0000000000287557e-7)) + 3.200000000092018e-7 / (1.0 - exp(-1.0000000000287557e-7)))) : (0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__Vm) / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__Vm))));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
...
// LCOV_EXCL_STOP
        ...
        const double var_x80 = var_x41 * var_x43 * (var_x78 + var_x42 * var_x79);
        ...
        const double var_x114 = var_x113 * var_x44;
        const double var_x115 = var_x113 * var_x47;
        ...
        const double var_x118 = ((var_x50) ? (var_x116 * (var_x114 + var_x40 * (-var_x114 - var_x115 * var_x46))) : (var_x116 * var_x117 * var_x51));
        const double var_x119 = var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x120 = var_x113 * var_x43 * (var_x78 + var_x119 * var_x42);
        const double var_x121 = var_x120 - var_x81 * (-var_x120 - var_x115 * (var_x78 + var_x119 * var_x46));
        ...
        const double var_x152 = var_x150 / (1.0 - var_x46);
        ...
        const double var_x160 = var_x151 * (-100.0 * var_x42 + var_chaste_interface__Cl__Cl_i);
        ...
        const double var_x289 = var_x288 * var_x44;
        ...
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = -(mDt * (5.0 + 0.0020917052580005369 * ((var_x155) ? (var_x154 * (var_x151 + var_x149 * (-var_x151 - var_x152))) : (var_x154 * var_x156 * var_x159))));
        ...
        rJacobian[7][29] = 0.0;
        rJacobian[7][30] = 0.0;
        rJacobian[7][31] = -(mDt * (0.0020917052580005369 * ((var_x155) ? (0.32000000000000006 * var_x161 * (var_x160 - 187179.41753901311 * (-2.6712338705498262e-6 + var_chaste_interface__membrane__Vm) * (-var_x160 - var_x152 * (-100.0 * var_x46 + var_chaste_interface__Cl__Cl_i)))) : (1155.8403904801075 * var_x159 * var_x161 * (-100.0 * var_x158 + var_chaste_interface__Cl__Cl_i) * var_chaste_interface__membrane__Vm))));
        rJacobian[7][32] = 0.0;
        rJacobian[7][33] = 0.0;
        rJacobian[7][34] = 0.0;
        rJacobian[8][0] = 0.0;
        ...
        rJacobian[33][31] = 0.0;
        rJacobian[33][32] = 0.0;
        rJacobian[33][33] = 1.0 - (mDt * (-0.14749262536873156 + var_x148 + 1.2152060064426631e-5 * var_x285 - 3.1595356167509241e-5 * var_x284 - 6.1702220000015831e-5 * ((var_x155) ? (var_x289 + var_x149 * (-var_x289 - var_x288 * var_x46 * var_x47)) : (var_x156 * var_x158 * mParameters[9] / (-1.0 + var_x158))) - var_x101 * var_x286 - 0.00044425598400011404 * var_x102 * var_x105 - var_x290 * pow(var_chaste_interface__INaL_mL_gate__mL, 3) * mParameters[13] * var_chaste_interface__INaL_hL_gate__hL - var_x290 * pow(var_chaste_interface__INa_m_gate__m, 3) * mParameters[11] * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j));
...
// LCOV_EXCL_STOP
        ...
        const double var_IKr_xr_gate__tau_xr = 1 / (((fabs(38.360799999999998 + var_chaste_interface__membrane__Vm) < 6.5703022339436146e-7) ? (1.9710906701830842e-10 / (-1.0 + exp(1.0000000000062181e-7)) - 760999.99999526795 * (38.360799342969777 + var_chaste_interface__membrane__Vm) * (-1.9710906701830842e-10 / (-1.0 + exp(1.0000000000062181e-7)) - 1.9710906701830842e-10 / (-1.0 + exp(-1.0000000000062181e-7)))) : (0.00029999999999999997 * (38.360799999999998 + var_chaste_interface__membrane__Vm) / (-1.0 + exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm)))) + ((fabs(-1.7383999999999999 + var_chaste_interface__membrane__Vm) < 7.352941176468758e-7) ? (-4.4117647058812543e-10 / (1.0 - exp(9.9999999999975114e-8)) + 680000.00000016927 * (-1.7383992647058824 + var_chaste_interface__membrane__Vm) * (4.4117647058812543e-10 / (1.0 - exp(9.9999999999975114e-8)) + 4.4117647058812543e-10 / (1.0 - exp(-9.9999999999975114e-8)))) : (0.00059999999999999995 * (-1.7383999999999999 + var_chaste_interface__membrane__Vm) / (1.0 - exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm)))));
