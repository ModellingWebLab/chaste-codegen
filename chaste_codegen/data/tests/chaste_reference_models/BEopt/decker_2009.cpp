...
// LCOV_EXCL_STOP
        ...
        const double var_x19 = var_x18 * (-1.0 - var_x6);
        ...
        const double var_x27 = 1.0 + 0.75 * var_x20;
        ...
        const double var_x51 = (var_chaste_interface__membrane__Vm >= -1.3356169352749131e-6) && (var_chaste_interface__membrane__Vm <= 1.3356169352749131e-6);
        const double var_x52 = _lt_0_row[4];
        const double var_x53 = 14448.004881001343 * var_chaste_interface__membrane__Vm / (-1.0 + var_x52);
        const double var_x54 = var_x53 * mParameters[7];
        const double var_x55 = 3.0851110000007915e-5 * mParameters[10] / var_x34;
        const double var_x56 = 0.081415929203539822 * var_x23 * var_x27;
        const double var_x57 = 1.0 + 1.5624999999999999e-8 / pow(var_chaste_interface__Ca__Ca_i, 2);
        ...
        const double var_x61 = pow(mParameters[5], 3);
        const double var_x62 = var_x61 * var_chaste_interface__Ca__Ca_i;
        const double var_x63 = var_x61 * (1.0 + 0.00053738391835633597 * var_x59);
        const double var_x64 = (1.0 + 277.77777777777777 * var_chaste_interface__Ca__Ca_i) * mParameters[3];
        const double var_x65 = 1 / (var_x60 + var_x62 + 669921.875 * var_chaste_interface__Ca__Ca_i + 0.0035999999999999999 * var_x63 + 1.3 * var_x59 + 1860.8670000000004 * var_x64);
        const double var_x66 = 4.9361776000012672e-5 * var_x65;
        const double var_x67 = _lt_0_row[1];
        const double var_x68 = 1 / (1.0 + 0.32000000000000001 * var_x67);
        const double var_x69 = var_x68 * mParameters[17];
        const double var_x70 = var_x61 * var_x67 * var_x69;
        const double var_x71 = pow((1.9405247813411081e-6 * var_x59 + 1.4927113702623908e-6 * var_x60 + 1.4927113702623908e-6 * var_x62 + 0.0027777373294460648 * var_x64 + 5.3737609329446059e-9 * var_x63 + var_chaste_interface__Ca__Ca_i), (-2));
        const double var_x72 = _lt_0_row[0];
        const double var_x73 = -var_x62 * var_x67 + var_x59 * var_x72 * mParameters[3];
        const double var_x74 = -669921.875 - var_x61 - 516907.50000000012 * mParameters[3];
        const double var_x75 = pow(var_x57, (-2));
        const double var_x76 = pow(var_chaste_interface__Ca__Ca_i, (-3));
        const double var_x77 = 1.3356169352749131e-6 + var_chaste_interface__membrane__Vm;
        const double var_x78 = -0.34100000000000003 * mParameters[3];
        const double var_x79 = var_chaste_interface__Ca__Ca_i;
        const double var_x80 = var_x49 * (var_x78 + var_x46 * var_x79);
        ...
        const double var_x84 = var_x61 * (1.0 + 0.00053738391835633597 * var_x81);
        ...
        const double var_x89 = -var_x67 * var_x83 + var_x72 * var_x81 * mParameters[3];
        const double var_x90 = var_x69 * var_x88 * var_x89;
        const double var_x91 = var_x86 * var_x90;
        const double var_x92 = var_x58 * var_x69 * var_x73;
        const double var_x93 = var_x70 * var_x86 * var_x88;
        const double var_x94 = pow((1.9405247813411081e-6 * var_x81 + 1.4927113702623908e-6 * var_x82 + 1.4927113702623908e-6 * var_x83 + 0.0027777373294460648 * var_x85 + 5.3737609329446059e-9 * var_x84 + var_chaste_interface__Ca__Ca_ss_sr), (-2));
        const double var_x95 = pow(var_x87, (-2));
        const double var_x96 = pow(var_chaste_interface__Ca__Ca_ss_sr, (-3));
        const double var_x97 = pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x98 = 3 * mParameters[3];
        const double var_x99 = 5.8037463182484285e-6 * var_x61;
        const double var_x100 = -3.9000000000000004 * var_x97 - var_x97 * var_x98 - var_x97 * var_x99;
        const double var_x101 = var_x71 * var_x92;
        const double var_x102 = var_x65 * var_x69;
        const double var_x103 = var_x102 * var_x58;
        const double var_x104 = var_x72 * mParameters[3];
        const double var_x105 = var_x104 * var_x97;
        const double var_x106 = pow(var_chaste_interface__Na__Na_ss_sr, 2);
        const double var_x107 = -3.9000000000000004 * var_x106 - var_x106 * var_x98 - var_x106 * var_x99;
        const double var_x108 = var_x90 * var_x94;
        const double var_x109 = var_x69 * var_x86;
        const double var_x110 = var_x104 * var_x106 * var_x109 * var_x88;
        const double var_x111 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x112 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x113 = 1.0 + 0.0097788000000000007 / pow(var_x111, 2) + 4.0890000000000003e-5 / pow(var_x112, 2);
        const double var_x114 = 1 / var_x113;
        const double var_x115 = 0.019296999999999998 * mParameters[6];
        const double var_x116 = var_x115 * var_x48;
        const double var_x117 = var_x116 * var_x46;
        const double var_x118 = var_chaste_interface__ICaL__O + var_chaste_interface__ICaL__O_star;
        const double var_x119 = var_x53 * mParameters[6];
        const double var_x120 = ((var_x51) ? (var_x118 * (-var_x117 + var_x40 * (var_x117 + var_x115 * var_x45))) : (var_x118 * var_x119 * var_x52));
        const double var_x121 = var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x122 = var_x116 * (var_x78 + var_x121 * var_x46);
        const double var_x123 = -var_x122 + 374358.83507802623 * var_x77 * (var_x122 + var_x115 * var_x44 * (var_x78 + var_x121 * var_x42));
        const double var_x124 = var_x119 * (var_x78 + var_x121 * var_x52);
        const double var_x125 = ((var_x51) ? (var_x118 * var_x123) : (var_x118 * var_x124));
        const double var_x126 = ((var_x51) ? (var_x123) : (var_x124));
        const double var_x127 = -0.010458526290002684 * var_x114 * var_x126;
        const double var_x128 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x129 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x130 = 1.0 + 0.0097788000000000007 / pow(var_x128, 2) + 4.0890000000000003e-5 / pow(var_x129, 2);
        const double var_x131 = 1 / var_x130;
        const double var_x132 = var_x109 * var_x89 * var_x95 * var_x96;
        const double var_x133 = 9.3214219101444593e-16 * var_x108;
        const double var_x134 = var_x131;
        const double var_x135 = 1 / var_chaste_interface__Cl__Cl_i;
        const double var_x136 = log(100.0 * var_x135);
        const double var_x137 = 1 / var_chaste_interface__K__K_i;
        const double var_x138 = log(var_x137 * mParameters[4]);
        const double var_x139 = 26.712338705498265 * var_x138;
        const double var_x140 = var_x139 + 26.712338705498265 * var_x136;
        const double var_x141 = 0.00047280839508731927 / (87.825100000000006 + var_x140);
        const double var_x142 = var_x135 * var_x141;
        const double var_x143 = pow((1 + 0.30415380916729118 * var_x136 + 0.30415380916729118 * var_x138), (-2));
        const double var_x144 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x145 = var_x136 + log(var_x144 * mParameters[5]);
        const double var_x146 = pow(var_x145, 4);
        const double var_x147 = 50.122574928945262 * pow(var_x145, 3) / (59494197.640692554 + 509152.231225166 * var_x146);
        const double var_x148 = pow((1 + 0.0085580149227345564 * var_x146), (-2));
        const double var_x149 = pow(var_x145, 7);
        const double var_x150 = var_x135 * var_x147 - 7.2099425022651882e-9 * var_x135 * var_x148 * var_x149;
        const double var_x151 = var_x137 * var_x141;
        const double var_x152 = 6.1298221377044294e-8 * var_x140 * var_x143;
        const double var_x153 = var_x144 * var_x147 - 7.2099425022651882e-9 * var_x144 * var_x148 * var_x149;
        const double var_x154 = 0.5 + 187179.41753901311 * var_chaste_interface__membrane__Vm;
        const double var_x155 = 0.0096484999999999991 * mParameters[19];
        const double var_x156 = -var_x155 / var_x43;
        const double var_x157 = -var_x155 / var_x47;
        const double var_x158 = pow(var_chaste_interface__Irel__Irel, 2);
        const double var_x159 = (1.0 - 1 / (1.0 + 6.2499999999999991 * var_x158)) * var_chaste_interface__Ito2_i2f_gate__i2f;
        const double var_x160 = (var_chaste_interface__membrane__Vm >= -2.6712338705498262e-6) && (var_chaste_interface__membrane__Vm <= 2.6712338705498262e-6);
        const double var_x161 = 3612.0012202503358 * var_chaste_interface__membrane__Vm;
        const double var_x162 = 0.037435883507802616 * var_chaste_interface__membrane__Vm;
        const double var_x163 = exp(var_x162);
        const double var_x164 = -1.0 + var_x163;
        const double var_x165 = -mParameters[19] / var_x164;
        const double var_x166 = var_x157 * (-100.0 * var_x46 + var_chaste_interface__Cl__Cl_i);
        const double var_x167 = var_chaste_interface__Irel__Irel * var_chaste_interface__Ito2_i2f_gate__i2f / pow((0.16000000000000003 + var_x158), 2);
        const double var_x168 = 1.0 + 8.1000000000000005e-11 / pow(var_chaste_interface__Ca__Ca_ss_CaL, 4);
        const double var_x169 = 1 / (pow(var_x168, 2) * pow(var_chaste_interface__Ca__Ca_ss_CaL, 5));
        const double var_x170 = 9.7200000000000016e-10 * var_x169;
        const double var_x171 = var_x170 * var_chaste_interface__ICaL__C;
        const double var_x172 = 1 / (_lt_0_row[14]);
        const double var_x173 = _lt_0_row[13];
        const double var_x174 = var_x172 * var_x173;
        const double var_x175 = 1 / (_lt_0_row[42]);
        const double var_x176 = 0.80000000000000004 * var_x175;
        const double var_x177 = 0.80000000000000004 - var_x176;
        const double var_x178 = _lt_0_row[19];
        const double var_x179 = 1 / (_lt_0_row[18]);
        const double var_x180 = var_x178 + 0.032730010146303147 * var_x179;
        const double var_x181 = var_x177 * var_x180;
        const double var_x182 = 1 / var_x168;
        const double var_x183 = 3.0 * var_x182;
        const double var_x184 = var_x181 + var_x183;
        const double var_x185 = 0.20000000000000001 + var_x176;
        const double var_x186 = var_x180 * var_x185;
        const double var_x187 = var_x172 * (1.0 - var_x173);
        const double var_x188 = 0.99990000999900008 * var_x175;
        const double var_x189 = 0.99990000999900008 - var_x188;
        const double var_x190 = 9.9990000999900015e-5 + var_x188;
        const double var_x191 = var_x185 * var_x189 / (var_x177 * var_x190);
        const double var_x192 = 9.7200000000000002e-16 * var_x169 * var_x191;
        const double var_x193 = var_x192 * var_chaste_interface__ICaL__CI;
        const double var_x194 = 3.0000000000000001e-6 * var_x182 * var_x191;
        const double var_x195 = var_x186 + var_x194;
        const double var_x196 = 9.0720000000000001e-12 * var_x169 * var_x179 / pow((1 - 0.69999999999999996 * var_x182), 2);
        const double var_x197 = var_x196 * var_chaste_interface__ICaL__C_star;
        const double var_x198 = var_x196 * var_chaste_interface__ICaL__CI_star;
        const double var_x199 = -var_x187;
        const double var_x200 = var_x178 + var_x179 / (25.0 - 17.5 * var_x182);
        const double var_x201 = var_x190 * var_x200;
        const double var_x202 = 9.9999999999999995e-7 + var_x187;
        const double var_x203 = var_x189 * var_x200;
        const double var_x204 = -var_x189;
        const double var_x205 = 1.0 + var_x203;
        const double var_x206 = var_x170 * var_chaste_interface__ICaL__O;
        const double var_x207 = -var_x174;
        const double var_x208 = -var_x201;
        const double var_x209 = _lt_0_row[43];
        const double var_x210 = 0.059458391923439997 * var_x209;
        const double var_x211 = _lt_0_row[44];
        const double var_x212 = 0.083986312199829993 * var_x211;
        const double var_x213 = _lt_0_row[45];
        const double var_x214 = 0.0062346537747999999 * var_x213;
        const double var_x215 = 0.029729195961719999 * var_x209;
        const double var_x216 = _lt_0_row[46];
        const double var_x217 = 0.01460066118316 * var_x216;
        const double var_x218 = 0.014864597980859999 * var_x209;
        const double var_x219 = var_x212 + var_x217;
        const double var_x220 = 0.16797262439965999 * var_x211;
        const double var_x221 = 0.009351980662199999 * var_x213;
        const double var_x222 = 0.02920132236632 * var_x216;
        const double var_x223 = var_x220 + var_x222;
        const double var_x224 = 0.043801983549479999 * var_x216;
        const double var_x225 = 0.0124693075496 * var_x213;
        const double var_x226 = _lt_0_row[38];
        const double var_x227 = 0.04459379394258 * var_x209;
        const double var_x228 = 0.0031173268874 * var_x213;
        const double var_x229 = 0.25195893659948998 * var_x211;
        const double var_x230 = var_x224 + var_x229;
        const double var_x231 = 0.33594524879931997 * var_x211;
        const double var_x232 = 0.058402644732640001 * var_x216;
        ...
        const double var_x239 = -var_x238 * var_x7;
        ...
        const double var_x247 = var_x125 * var_x246;
        const double var_x248 = -var_chaste_interface__Irel__Irel - var_x243 * var_x247;
        ...
        const double var_x254 = var_x10 * var_x238;
        const double var_x255 = -var_x126 * var_x253;
        ...
        const double var_x262 = -6.1702220000015831e-5 - 3.7021332000009499e-5 / var_x258;
        const double var_x263 = var_x262 * mParameters[16];
        const double var_x264 = -var_x260 * var_x263;
        const double var_x265 = 0.0016482105995215921 * var_x137;
        const double var_x266 = sqrt(mParameters[4]);
        const double var_x267 = var_x137 * var_x266;
        const double var_x268 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__Vm - 6.3708927812613361 * var_x138);
        const double var_x269 = 1.0 + var_x268;
        const double var_x270 = 1 / var_x269;
        const double var_x271 = exp(-2.4444678999999998 + 13.738155796237757 * var_x138 - 0.51429999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x272 = 1.0 + var_x271;
        const double var_x273 = 1 / var_x272;
        const double var_x274 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__Vm - 2.1455350448256207 * var_x138);
        const double var_x275 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__Vm - 1.6494869150645177 * var_x138);
        ...
        const double var_x280 = pow(var_x269, (-2));
        const double var_x281 = -var_x139 + var_chaste_interface__membrane__Vm;
        const double var_x282 = 1 + 0.38461538461538458 * var_chaste_interface__Na__Na_i;
        const double var_x283 = 1 / (1.0 + exp(-3.444101282717841 - var_x162));
        const double var_x284 = 1 / (1.5 + mParameters[4]);
        const double var_x285 = var_x283 * var_x284 * mParameters[18] * mParameters[4];
        const double var_x286 = var_x285 * var_x97 / pow(var_x282, 3);
        const double var_x287 = pow(var_x282, (-4));
        const double var_x288 = 3.299618375272375e-16 * var_x101;
        const double var_x289 = 8.2490459381809375e-17 * var_x108;
        const double var_x290 = 0.0096484999999999991 * mParameters[9];
        const double var_x291 = var_x290 * var_x46 * var_x48;
        const double var_x292 = 0.0016482105995215921 * var_x144;
        const double var_x293 = 2.796426573043338e-15 * var_x108;
        ...
        rJacobian[3][3] = 1.0 - (mDt * (var_x38 * (-0.14749262536873156 - var_x55 - var_x56 - 3.0851110000007915e-5 * ((var_x51) ? (-var_x50 + var_x40 * (var_x50 + var_x41 * var_x45)) : (var_x52 * var_x54)) - var_x58 * var_x66 * var_x70 + 3.0851110000007915e-5 * var_x35 * var_chaste_interface__Ca__Ca_i * mParameters[10] + 0.081415929203539822 * var_x26 * var_x27 * var_chaste_interface__Ca__Ca_i * mParameters[2] + 1.0998727917574584e-16 * var_x58 * var_x68 * var_x71 * var_x73 * var_x74 * mParameters[17] + 1.5425555000003961e-12 * var_x65 * var_x68 * var_x73 * var_x75 * var_x76 * mParameters[17]) + (0.00023800000000000004 / pow(var_x33, 3) + 7.0000000000000007e-5 / pow(var_x34, 3)) * (0.14749262536873156 * var_chaste_interface__Ca__Ca_ss_sr + 1.2340444000003168e-5 * var_x91 - 0.14749262536873156 * var_chaste_interface__Ca__Ca_i - 3.0851110000007915e-5 * ((var_x51) ? (-var_x80 + 374358.83507802623 * var_x77 * (var_x80 + var_x41 * var_x44 * (var_x78 + var_x42 * var_x79))) : (var_x54 * (var_x78 + var_x52 * var_x79))) + var_x39 * var_chaste_interface__Ca__Ca_NSR + var_x66 * var_x92 - var_x55 * var_chaste_interface__Ca__Ca_i - var_x56 * var_chaste_interface__Ca__Ca_i) / pow(var_x36, 2)));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (var_x38 * (0.14749262536873156 - 1.2340444000003168e-5 * var_x93 - 0.081415929203539822 * var_x31 - 0.081415929203539822 * var_x32 + 2.7496819793936459e-17 * var_x68 * var_x74 * var_x88 * var_x89 * var_x94 * mParameters[17] + 3.8563887500009902e-13 * var_x68 * var_x86 * var_x89 * var_x95 * var_x96 * mParameters[17])));
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = 0.0;
        rJacobian[3][9] = 0.0;
        ...
        rJacobian[3][31] = 0.0;
        rJacobian[3][32] = 0.0;
        rJacobian[3][33] = -(mDt * (var_x38 * (1.0998727917574584e-16 * var_x100 * var_x101 + 0.00014808532800003802 * var_x103 * var_x105)));
        rJacobian[3][34] = -(mDt * (var_x38 * (3.7021332000009505e-5 * var_x110 + 2.7496819793936459e-17 * var_x107 * var_x108)));
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-var_x114 * (5.0 + 0.010458526290002684 * var_x120) - (0.019557600000000001 / pow(var_x111, 3) + 8.1780000000000006e-5 / pow(var_x112, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_CaL + 0.010458526290002684 * var_x125 - 5.0 * var_chaste_interface__Ca__Ca_ss_sr) / pow(var_x113, 2)));
        rJacobian[4][5] = -(mDt * (5.0 * var_x114));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = 0.0;
        rJacobian[4][11] = 0.0;
        rJacobian[4][12] = -(mDt * (var_x127));
        rJacobian[4][13] = 0.0;
        rJacobian[4][14] = -(mDt * (var_x127));
        rJacobian[4][15] = 0.0;
        rJacobian[4][16] = 0.0;
        rJacobian[4][17] = 0.0;
        rJacobian[4][18] = 0.0;
        ...
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (5.0 * var_x131));
        rJacobian[5][4] = -(mDt * (0.5 * var_x131));
        rJacobian[5][5] = 1.0 - (mDt * (-var_x134 * (5.5 + 0.0004183410516001074 * var_x93 - 1.3073157862503357e-11 * var_x132 - var_x133 * var_x74) - (0.019557600000000001 / pow(var_x128, 3) + 8.1780000000000006e-5 / pow(var_x129, 3)) * (5.5 * var_chaste_interface__Ca__Ca_ss_sr - 0.5 * var_chaste_interface__Ca__Ca_ss_CaL - 0.23999999999999996 * var_chaste_interface__Irel__Irel - 5.0 * var_chaste_interface__Ca__Ca_i - 0.0004183410516001074 * var_x91) / pow(var_x130, 2)));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        ...
        rJacobian[5][29] = 0.0;
        rJacobian[5][30] = 0.0;
        rJacobian[5][31] = -(mDt * (0.23999999999999996 * var_x131));
        rJacobian[5][32] = 0.0;
        rJacobian[5][33] = 0.0;
        rJacobian[5][34] = -(mDt * (-var_x134 * (-0.0012550231548003222 * var_x110 - var_x107 * var_x133)));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.14749262536873156 - var_x142 - var_x150 - 0.0016482105995215921 * var_x135 * mParameters[8] + 6.1298221377044294e-8 * var_x135 * var_x140 * var_x143));
        ...
        rJacobian[6][30] = 0.0;
        rJacobian[6][31] = 0.0;
        rJacobian[6][32] = -(mDt * (-var_x151 + var_x137 * var_x152));
        rJacobian[6][33] = -(mDt * (-var_x153));
        rJacobian[6][34] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        ...
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = -(mDt * (5.0 + 0.0020917052580005369 * ((var_x160) ? (var_x159 * (-var_x157 + var_x154 * (var_x156 + var_x157))) : (var_x159 * var_x161 * var_x165))));
        ...
        rJacobian[7][29] = 0.0;
        rJacobian[7][30] = 0.0;
        rJacobian[7][31] = -(mDt * (0.0020917052580005369 * ((var_x160) ? (0.32000000000000006 * var_x167 * (-var_x166 + 187179.41753901311 * (2.6712338705498262e-6 + var_chaste_interface__membrane__Vm) * (var_x166 + var_x156 * (-100.0 * var_x42 + var_chaste_interface__Cl__Cl_i)))) : (1155.8403904801075 * var_x165 * var_x167 * (-100.0 * var_x163 + var_chaste_interface__Cl__Cl_i) * var_chaste_interface__membrane__Vm))));
        rJacobian[7][32] = 0.0;
        rJacobian[7][33] = 0.0;
        rJacobian[7][34] = 0.0;
        rJacobian[8][0] = 0.0;
        ...
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = 0.0;
        rJacobian[8][4] = -(mDt * (-var_x171));
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (-var_x174 - var_x184));
        rJacobian[8][9] = -(mDt * (var_x186));
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = -(mDt * (1.0));
        rJacobian[8][12] = -(mDt * (var_x187));
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = 0.0;
        rJacobian[8][15] = 0.0;
        rJacobian[8][16] = 0.0;
        ...
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = 0.0;
        rJacobian[9][4] = -(mDt * (-var_x193));
        rJacobian[9][5] = 0.0;
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = -(mDt * (var_x181));
        rJacobian[9][9] = 1.0 - (mDt * (-var_x174 - var_x195));
        rJacobian[9][10] = -(mDt * (9.9999999999999995e-7));
        rJacobian[9][11] = 0.0;
        rJacobian[9][12] = 0.0;
        rJacobian[9][13] = -(mDt * (var_x187));
        rJacobian[9][14] = 0.0;
        rJacobian[9][15] = 0.0;
        rJacobian[9][16] = 0.0;
        rJacobian[9][17] = 0.0;
        ...
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = -(mDt * (var_x193 + var_x189 * var_x197 - var_x190 * var_x198));
        rJacobian[10][5] = 0.0;
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = -(mDt * (var_x199));
        rJacobian[10][9] = -(mDt * (var_x194 - var_x187));
        rJacobian[10][10] = 1.0 - (mDt * (-var_x174 - var_x201 - var_x202));
        rJacobian[10][11] = -(mDt * (var_x199 + var_x203));
        rJacobian[10][12] = -(mDt * (var_x199));
        rJacobian[10][13] = -(mDt * (var_x199));
        rJacobian[10][14] = -(mDt * (var_x199));
        rJacobian[10][15] = 0.0;
        rJacobian[10][16] = 0.0;
        rJacobian[10][17] = 0.0;
        rJacobian[10][18] = 0.0;
        ...
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = -(mDt * (var_x171 + var_x190 * var_x198 + var_x197 * var_x204));
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = -(mDt * (var_x183));
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = -(mDt * (var_x201));
        rJacobian[11][11] = 1.0 - (mDt * (-var_x174 - var_x205));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = -(mDt * (var_x187));
        rJacobian[11][15] = 0.0;
        rJacobian[11][16] = 0.0;
        rJacobian[11][17] = 0.0;
        rJacobian[11][18] = 0.0;
        ...
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (-var_x206));
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = 0.0;
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = -(mDt * (var_x174));
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-var_x184 - var_x187));
        rJacobian[12][13] = -(mDt * (var_x186));
        ...
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = -(mDt * (-var_x192 * var_chaste_interface__ICaL__OI));
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = -(mDt * (-9.9999999999999995e-7));
        rJacobian[13][9] = -(mDt * (-9.9999999999999995e-7 - var_x207));
        rJacobian[13][10] = -(mDt * (-9.9999999999999995e-7));
        rJacobian[13][11] = -(mDt * (-9.9999999999999995e-7));
        rJacobian[13][12] = -(mDt * (-9.9999999999999995e-7 + var_x181));
        rJacobian[13][13] = 1.0 - (mDt * (-var_x195 - var_x202));
        ...
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = 0.0;
        rJacobian[14][4] = -(mDt * (var_x206 + var_x190 * var_x196 * (1.0 - var_x118 - var_chaste_interface__ICaL__C - var_chaste_interface__ICaL__CI - var_chaste_interface__ICaL__CI_star - var_chaste_interface__ICaL__C_star - var_chaste_interface__ICaL__OI) + var_x196 * var_x204 * var_chaste_interface__ICaL__O_star));
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = 0.0;
        rJacobian[14][7] = 0.0;
        rJacobian[14][8] = -(mDt * (var_x208));
        rJacobian[14][9] = -(mDt * (var_x208));
        rJacobian[14][10] = -(mDt * (var_x208));
        rJacobian[14][11] = -(mDt * (-var_x201 - var_x207));
        rJacobian[14][12] = -(mDt * (var_x183 - var_x201));
        rJacobian[14][13] = -(mDt * (var_x208));
        rJacobian[14][14] = 1.0 - (mDt * (-var_x187 - var_x201 - var_x205));
        rJacobian[14][15] = 0.0;
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        ...
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (-var_x210));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (-var_x214 - var_x215));
        rJacobian[16][17] = -(mDt * (var_x212));
        rJacobian[16][18] = 0.0;
        rJacobian[16][19] = 0.0;
        rJacobian[16][20] = 0.0;
        rJacobian[16][21] = 0.0;
        ...
        rJacobian[17][14] = 0.0;
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = -(mDt * (var_x215));
        rJacobian[17][17] = 1.0 - (mDt * (-var_x214 - var_x218 - var_x219));
        rJacobian[17][18] = -(mDt * (var_x220));
        rJacobian[17][19] = -(mDt * (var_x221));
        rJacobian[17][20] = 0.0;
        rJacobian[17][21] = 0.0;
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = 0.0;
        ...
        rJacobian[18][15] = 0.0;
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = -(mDt * (var_x218));
        rJacobian[18][18] = 1.0 - (mDt * (-var_x214 - var_x223));
        rJacobian[18][19] = 0.0;
        rJacobian[18][20] = -(mDt * (var_x221));
        rJacobian[18][21] = 0.0;
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        ...
        rJacobian[19][15] = 0.0;
        rJacobian[19][16] = 0.0;
        rJacobian[19][17] = -(mDt * (var_x217));
        rJacobian[19][18] = 0.0;
        rJacobian[19][19] = 1.0 - (mDt * (-var_x218 - var_x221));
        rJacobian[19][20] = -(mDt * (var_x212));
        rJacobian[19][21] = 0.0;
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        ...
        rJacobian[20][16] = 0.0;
        rJacobian[20][17] = 0.0;
        rJacobian[20][18] = -(mDt * (var_x222));
        rJacobian[20][19] = -(mDt * (var_x218));
        rJacobian[20][20] = 1.0 - (mDt * (-var_x219 - var_x221));
        rJacobian[20][21] = -(mDt * (var_x225));
        rJacobian[20][22] = 0.0;
        rJacobian[20][23] = 0.0;
        rJacobian[20][24] = 0.0;
        rJacobian[20][25] = 0.0;
        ...
        rJacobian[21][18] = 0.0;
        rJacobian[21][19] = 0.0;
        rJacobian[21][20] = -(mDt * (var_x217));
        rJacobian[21][21] = 1.0 - (mDt * (-0.089538306411019994 - var_x225));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        ...
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (-var_x219 - var_x227));
        rJacobian[22][23] = -(mDt * (var_x220));
        rJacobian[22][24] = 0.0;
        rJacobian[22][25] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (var_x227));
        rJacobian[23][23] = 1.0 - (mDt * (-var_x215 - var_x223));
        ...
        rJacobian[24][21] = 0.0;
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = -(mDt * (var_x215));
        rJacobian[24][24] = 1.0 - (mDt * (-var_x218 - var_x230));
        ...
        rJacobian[26][20] = 0.0;
        rJacobian[26][21] = 0.0;
        rJacobian[26][22] = -(mDt * (var_x217));
        rJacobian[26][23] = 0.0;
        rJacobian[26][24] = 0.0;
        rJacobian[26][25] = 0.0;
        rJacobian[26][26] = 1.0 - (mDt * (-var_x227 - var_x228));
        rJacobian[26][27] = -(mDt * (var_x212));
        rJacobian[26][28] = 0.0;
        rJacobian[26][29] = 0.0;
        rJacobian[26][30] = 0.0;
        rJacobian[26][31] = 0.0;
        ...
        rJacobian[27][21] = 0.0;
        rJacobian[27][22] = 0.0;
        rJacobian[27][23] = -(mDt * (var_x222));
        rJacobian[27][24] = 0.0;
        rJacobian[27][25] = 0.0;
        rJacobian[27][26] = -(mDt * (var_x227));
        rJacobian[27][27] = 1.0 - (mDt * (-var_x215 - var_x219 - var_x228));
        rJacobian[27][28] = -(mDt * (var_x220));
        rJacobian[27][29] = 0.0;
        rJacobian[27][30] = 0.0;
        rJacobian[27][31] = 0.0;
        rJacobian[27][32] = 0.0;
        ...
        rJacobian[28][22] = 0.0;
        rJacobian[28][23] = 0.0;
        rJacobian[28][24] = -(mDt * (var_x224));
        rJacobian[28][25] = 0.0;
        rJacobian[28][26] = 0.0;
        rJacobian[28][27] = -(mDt * (var_x215));
        rJacobian[28][28] = 1.0 - (mDt * (-var_x218 - var_x223 - var_x228));
        ...
        rJacobian[29][26] = 0.0;
        rJacobian[29][27] = 0.0;
        rJacobian[29][28] = -(mDt * (var_x218));
        rJacobian[29][29] = 1.0 - (mDt * (-var_x228 - var_x230));
        rJacobian[29][30] = 0.0;
        rJacobian[29][31] = 0.0;
        rJacobian[29][32] = 0.0;
        rJacobian[29][33] = 0.0;
        ...
        rJacobian[30][30] = 1.0 - (mDt * (-var_x226 - var_x233 + _lt_0_row[40]));
        rJacobian[30][31] = 0.0;
        rJacobian[30][32] = 0.0;
        rJacobian[30][33] = 0.0;
        rJacobian[30][34] = 0.0;
        rJacobian[31][0] = -(mDt * (6.2357214041141957e-6 * var_x239 * var_x249 + 0.00014069346418032653 * var_x239 * var_x252));
        rJacobian[31][1] = -(mDt * (-0.0123 * var_x248 * var_x250 / pow(var_chaste_interface__Ca__Ca_JSR, 2) - 8.0 * var_x125 * var_x240 * var_x241 * var_x244 * mParameters[1] / pow(var_x245, 2)));
        rJacobian[31][2] = 0.0;
        rJacobian[31][3] = 0.0;
        rJacobian[31][4] = -(mDt * (-var_x120 * var_x253));
        ...
        rJacobian[32][4] = 0.0;
        rJacobian[32][5] = 0.0;
        rJacobian[32][6] = -(mDt * (-var_x142 + var_x135 * var_x152));
        rJacobian[32][7] = 0.0;
        rJacobian[32][8] = 0.0;
        rJacobian[32][9] = 0.0;
        rJacobian[32][10] = 0.0;
        ...
        rJacobian[32][13] = 0.0;
        rJacobian[32][14] = 0.0;
        rJacobian[32][15] = -(mDt * (var_x264));
        rJacobian[32][16] = -(mDt * (var_x264));
        rJacobian[32][17] = -(mDt * (var_x264));
        rJacobian[32][18] = -(mDt * (var_x264));
        rJacobian[32][19] = -(mDt * (var_x264));
        rJacobian[32][20] = -(mDt * (var_x264));
        rJacobian[32][21] = -(mDt * (var_x264));
        rJacobian[32][22] = -(mDt * (var_x264));
        rJacobian[32][23] = -(mDt * (var_x264));
        rJacobian[32][24] = -(mDt * (var_x264));
        rJacobian[32][25] = -(mDt * (var_x264));
        rJacobian[32][26] = -(mDt * (var_x264));
        rJacobian[32][27] = -(mDt * (var_x264));
        rJacobian[32][28] = -(mDt * (var_x264));
        rJacobian[32][29] = -(mDt * (var_x264));
        rJacobian[32][30] = 0.0;
        rJacobian[32][31] = 0.0;
        rJacobian[32][32] = 1.0 - (mDt * (-var_x151 - var_x265 * mParameters[14] / (_lt_0_row[10]) + 6.1298221377044294e-8 * var_x137 * var_x140 * var_x143 - 0.00072346244967216237 * var_x267 * var_x278 * var_x279 + 26.712338705498265 * var_x259 * var_x261 * var_x262 * mParameters[16] - 0.00070927691144329649 * var_x267 * mParameters[15] * var_chaste_interface__IKr_xr_gate__xr / (_lt_0_row[11]) - 2.6031772383887529e-5 * var_x266 * var_x279 * var_x281 * (-var_x273 * (1.053972635420138 * var_x137 * var_x274 + 1.6494869150645177 * var_x137 * var_x275) + 6.4983106368865622 * var_x137 * var_x268 * var_x280 - 13.738155796237757 * var_x137 * var_x271 * var_x276 / pow(var_x272, 2)) / pow((var_x270 + 0.98039215686274506 * var_x277), 2) - var_x265 * pow(var_chaste_interface__Ito1_a_gate__a, 3) * mParameters[20] * var_chaste_interface__Ito1_i1f_gate__i1f * var_chaste_interface__Ito1_i1s_gate__i1s * _lt_0_row[12] + 0.00017254579424681073 * var_x137 * var_x266 * var_x268 * var_x278 * var_x280 * var_x281 * mParameters[12]));
        rJacobian[32][33] = -(mDt * (2.1063570778339494e-5 * var_x286 + 0.48963716847178318 * var_x259 * var_x261 * var_x263 - 8.1013733762844218e-6 * var_x285 * var_x287 * var_x59));
        rJacobian[32][34] = 0.0;
        rJacobian[33][0] = 0.0;
        rJacobian[33][1] = 0.0;
        rJacobian[33][2] = 0.0;
        rJacobian[33][3] = -(mDt * (-var_x288 * var_x74 - 4.6276665000011881e-12 * var_x102 * var_x73 * var_x75 * var_x76 + 0.00014808532800003802 * var_x58 * var_x61 * var_x65 * var_x67 * var_x68 * mParameters[17]));
        rJacobian[33][4] = 0.0;
        rJacobian[33][5] = -(mDt * (-1.156916625000297e-12 * var_x132 - var_x289 * var_x74 + 3.7021332000009505e-5 * var_x61 * var_x67 * var_x68 * var_x86 * var_x88 * mParameters[17]));
        rJacobian[33][6] = -(mDt * (-var_x150));
        rJacobian[33][7] = 0.0;
        rJacobian[33][8] = 0.0;
        rJacobian[33][9] = 0.0;
        rJacobian[33][10] = 0.0;
        ...
        rJacobian[33][31] = 0.0;
        rJacobian[33][32] = 0.0;
        rJacobian[33][33] = 1.0 - (mDt * (-0.14749262536873156 - var_x153 - 3.1595356167509241e-5 * var_x286 - 6.1702220000015831e-5 * ((var_x160) ? (-var_x291 + var_x154 * (var_x291 + var_x290 * var_x45)) : (var_x161 * var_x163 * mParameters[9] / var_x164)) - var_x100 * var_x288 - 0.00044425598400011404 * var_x103 * var_x105 - var_x292 * pow(var_chaste_interface__INaL_mL_gate__mL, 3) * mParameters[13] * var_chaste_interface__INaL_hL_gate__hL - var_x292 * pow(var_chaste_interface__INa_m_gate__m, 3) * mParameters[11] * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j + 1.2152060064426631e-5 * var_x283 * var_x284 * var_x287 * var_x59 * mParameters[18] * mParameters[4]));
        rJacobian[33][34] = -(mDt * (0.14749262536873156 - 0.00011106399600002851 * var_x110 - var_x107 * var_x289));
        rJacobian[34][0] = 0.0;
        rJacobian[34][1] = 0.0;
        rJacobian[34][2] = 0.0;
        rJacobian[34][3] = 0.0;
        rJacobian[34][4] = 0.0;
        rJacobian[34][5] = -(mDt * (-3.9219473587510072e-11 * var_x132 - var_x293 * var_x74 + 0.0012550231548003222 * var_x61 * var_x67 * var_x68 * var_x86 * var_x88 * mParameters[17]));
        rJacobian[34][6] = 0.0;
        rJacobian[34][7] = 0.0;
        rJacobian[34][8] = 0.0;
        rJacobian[34][9] = 0.0;
        ...
        rJacobian[34][34] = 1.0 - (mDt * (-5.0 - 0.0037650694644009667 * var_x110 - var_x107 * var_x293));
    }
