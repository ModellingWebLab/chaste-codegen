...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(0.35999999999999999 - 0.071999999999999995 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(4.2000000000000002 + 0.14999999999999999 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(2.8500000000000001 + 0.057000000000000002 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
        ...
        const double var_plateau_potassium_current__i_Kp = 1 * _lt_0_row[1] * (-var_time_independent_potassium_current__E_K1 + var_chaste_interface__membrane__V) * mParameters[12]; // microA_per_cm2
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_slow_inward_current_d_gate__d = 0.095000000000000001 * _lt_0_row[4] * (1 - var_chaste_interface__slow_inward_current_d_gate__d) * _lt_0_row[5] - 0.070000000000000007 * _lt_0_row[6] * var_chaste_interface__slow_inward_current_d_gate__d * _lt_0_row[7]; // 1 / millisecond
        const double d_dt_chaste_interface_var_slow_inward_current_f_gate__f = 0.012 * _lt_0_row[8] * (1 - var_chaste_interface__slow_inward_current_f_gate__f) * _lt_0_row[9] - 0.0064999999999999997 * _lt_0_row[10] * var_chaste_interface__slow_inward_current_f_gate__f * _lt_0_row[11]; // 1 / millisecond
        const double var_slow_inward_current__i_si = (-7.7000000000000002 + 13.028700000000001 * log(var_chaste_interface__intracellular_calcium_concentration__Cai) + var_chaste_interface__membrane__V) * mParameters[4] * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f; // microA_per_cm2
...
// LCOV_EXCL_STOP
        ...
        const double var_slow_inward_current_f_gate__alpha_f = 0.012 * _lt_0_row[8] * _lt_0_row[9]; // per_millisecond
        ...
        const double var_time_independent_potassium_current_K1_gate__beta_K1 = (1 * exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 0.061749999999999999 * var_time_independent_potassium_current__E_K1) + 0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 0.080320000000000003 * var_time_independent_potassium_current__E_K1)) / (1 + exp(-2.4444678999999998 + 0.51429999999999998 * var_time_independent_potassium_current__E_K1 - 0.51429999999999998 * var_chaste_interface__membrane__V)); // per_millisecond
