...
// LCOV_EXCL_STOP
        ...
        const double var_plateau_potassium_current__i_Kp = _lt_0_row[1] * (-var_time_independent_potassium_current__E_K1 + var_chaste_interface__membrane__V) * mParameters[12]; // microA_per_cm2
...
// LCOV_EXCL_STOP
        ...
        const double var_plateau_potassium_current__Kp = _lt_0_row[1]; // dimensionless
