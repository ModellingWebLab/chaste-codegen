...
#include "MathsCustomFunctions.hpp"
    ...
    void Dynamicaslanidi_model_2009FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_Ca_handling_by_the_SR__i_rel = 200.0 * pow((var_chaste_interface__Ca_handling_by_the_SR__F2 / (0.25 + var_chaste_interface__Ca_handling_by_the_SR__F2)), 2) * (-var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_chaste_interface__Ca_handling_by_the_SR__Ca_rel); // picoA
        ...
        const double var_Ca_handling_by_the_SR__r_inact = 33.960000000000001 + 339.60000000000002 * pow((var_chaste_interface__intracellular_ion_concentrations__Ca_i / (0.00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i)), 4); // per_second
