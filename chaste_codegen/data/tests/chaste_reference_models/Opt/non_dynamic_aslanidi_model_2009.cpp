...
class Cellaslanidi_model_2009FromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Cellaslanidi_model_2009FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellaslanidi_model_2009FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellaslanidi_model_2009FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Cellaslanidi_model_2009FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellaslanidi_model_2009FromCellMLOpt_LookupTables(const Cellaslanidi_model_2009FromCellMLOpt_LookupTables&);
    Cellaslanidi_model_2009FromCellMLOpt_LookupTables& operator= (const Cellaslanidi_model_2009FromCellMLOpt_LookupTables&);
    Cellaslanidi_model_2009FromCellMLOpt_LookupTables()
    {
        ...
        Cellaslanidi_model_2009FromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Cellaslanidi_model_2009FromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellaslanidi_model_2009FromCellMLOpt_LookupTables> Cellaslanidi_model_2009FromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellaslanidi_model_2009FromCellMLOpt::GetLookupTableCollection()
    {
        return Cellaslanidi_model_2009FromCellMLOpt_LookupTables::Instance();
    }
    ...
    double Cellaslanidi_model_2009FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellaslanidi_model_2009FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellaslanidi_model_2009FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
