...
// LCOV_EXCL_STOP
        ...
        const double var_i_Ca_L__i_Ca_L_max = 3.510865186083326 * _lt_0_row[12] * (-15 + var_chaste_interface__membrane__V) * (-0.34100000000000003 * mp_extracellular_calcium_concentration_modifier->Calc(mParameters[4], var_chaste_interface__environment__time) + var_chaste_interface__Ca_r__Ca_r * _lt_0_row[11]); // microA_per_microF
