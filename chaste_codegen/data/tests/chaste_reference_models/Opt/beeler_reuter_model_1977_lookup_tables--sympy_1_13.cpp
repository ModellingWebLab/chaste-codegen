...
{
public:
    static Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }

    const double * IndexTable1(double var_chaste_interface__slow_inward_current__Cai)
    {
        const double _offset_1 = var_chaste_interface__slow_inward_current__Cai - mTableMins[1];
        ...
        const double* const _lt_1_row = Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables::Instance()->_lookup_1_row(_table_index_1, _factor_1);
        return _lt_1_row;
    }
...
// LCOV_EXCL_START
    bool CheckIndex1(double& var_chaste_interface__slow_inward_current__Cai)
    {
        bool _oob_1 = false;
        if (var_chaste_interface__slow_inward_current__Cai>mTableMaxs[1] || var_chaste_interface__slow_inward_current__Cai<mTableMins[1])
        {
// LCOV_EXCL_START
            _oob_1 = true;
// LCOV_EXCL_STOP
...
// LCOV_EXCL_STOP
    ...
    ~Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables()
    {
...
protected:
    Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables(const Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables&);
    Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables& operator= (const Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables&);
    Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables()
    {
        ...
        Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables::RegenerateTables();
    }
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / exp(1.4000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V);
                };
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(0.35997120230381568 - 0.071994240460763137 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(2.2000000000000002 + 0.050000000000000003 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(4.197901049475262 + 0.14992503748125938 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(-6 - 0.20000000000000001 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(2.8571428571428572 + 0.057142857142857141 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + exp(-0.80000000000000004 - 0.040000000000000001 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
        ...
        if (mNeedsRegeneration[1])
        {
            ...
            {
                auto f = [](double var_chaste_interface__slow_inward_current__Cai) {
                    return 13.028700000000001 * log(var_chaste_interface__slow_inward_current__Cai);
                };
                const double var_chaste_interface__slow_inward_current__Cai = mTableMins[1] + i*mTableSteps[1];
                double val = f(var_chaste_interface__slow_inward_current__Cai);

                _lookup_table_1[i][0] = val;
            }
...
private:
    ...
    static std::shared_ptr<Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables> mpInstance;
    ...
    int _lookup_table_1_num_misshit_piecewise[1] = {0};
...
std::shared_ptr<Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables> Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Cellbeeler_reuter_model_1977FromCellMLOpt::GetLookupTableCollection()
    {
    ...
    double Cellbeeler_reuter_model_1977FromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);

        // Lookup table indexing
        const bool _oob_1 = Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables::Instance()->CheckIndex1(var_chaste_interface__slow_inward_current__Cai);
// LCOV_EXCL_START
        if (_oob_1)
            EXCEPTION(DumpState("cytosolic_calcium_concentration outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_1_row = Cellbeeler_reuter_model_1977FromCellMLOpt_LookupTables::Instance()->IndexTable1(var_chaste_interface__slow_inward_current__Cai);

        const double var_slow_inward_current__i_s_converted = 100.00000000000001 * (-7.6990712032745758 + _lt_1_row[0] + var_chaste_interface__membrane__V) * mParameters[0] * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f; // uA_per_cm2
        ...
        const double var_time_dependent_outward_current__i_x1_converted = 100.00000000000001 * _lt_0_row[0] * (_lt_0_row[1]) * mParameters[6] * var_chaste_interface__time_dependent_outward_current_x1_gate__x1; // uA_per_cm2
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_slow_inward_current_d_gate__d = 0.095000000000000001 * _lt_0_row[3] * (1 - var_chaste_interface__slow_inward_current_d_gate__d) * _lt_0_row[4] - 0.070000000000000007 * _lt_0_row[5] * var_chaste_interface__slow_inward_current_d_gate__d * _lt_0_row[6]; // 1 / ms
        const double d_dt_chaste_interface_var_slow_inward_current_f_gate__f = 0.012 * _lt_0_row[7] * (1 - var_chaste_interface__slow_inward_current_f_gate__f) * _lt_0_row[8] - 0.0064999999999999997 * _lt_0_row[9] * var_chaste_interface__slow_inward_current_f_gate__f * _lt_0_row[10]; // 1 / ms
        const double var_slow_inward_current__i_s = (-7.6990712032745758 + _lt_1_row[0] + var_chaste_interface__membrane__V) * mParameters[0] * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f; // uA_per_mm2
        ...
        const double d_dt_chaste_interface_var_sodium_current_h_gate__h = (1 * var_sodium_current_h_gate__alpha_h + 1 * var_sodium_current_h_gate__beta_h) * (-var_chaste_interface__sodium_current_h_gate__h + 0.01 * mParameters[3] + (1 - 0.01 * mParameters[3]) * var_sodium_current_h_gate__alpha_h / (var_sodium_current_h_gate__alpha_h + var_sodium_current_h_gate__beta_h)); // 1 / ms
...
// LCOV_EXCL_STOP
        ...
        const double var_time_dependent_outward_current__i_x1 = _lt_0_row[0] * (_lt_0_row[1]) * mParameters[6] * var_chaste_interface__time_dependent_outward_current_x1_gate__x1; // uA_per_mm2
