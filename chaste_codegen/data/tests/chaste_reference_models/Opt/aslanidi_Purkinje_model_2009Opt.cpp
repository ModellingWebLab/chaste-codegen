...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return CHASTE_MATH::Exp(-CHASTE_CONST(0.024333324280071702) * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return CHASTE_MATH::Exp(CHASTE_CONST(0.013102559227730915) * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 + CHASTE_CONST(0.27000000000000002) * CHASTE_MATH::Exp(-CHASTE_CONST(0.024333324280071702) * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 + CHASTE_MATH::Exp(-CHASTE_CONST(0.26470588235294124) + CHASTE_CONST(0.049019607843137261) * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return CHASTE_MATH::Exp(-CHASTE_CONST(1.1230765052340785) + CHASTE_CONST(0.074871767015605231) * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return -1 + CHASTE_MATH::Exp(-CHASTE_CONST(1.1230765052340785) + CHASTE_CONST(0.074871767015605231) * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(0.59347181008902072) - CHASTE_CONST(0.14836795252225518) * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return CHASTE_CONST(0.58999999999999997) + CHASTE_CONST(0.80000000000000004) * CHASTE_MATH::Exp(CHASTE_CONST(0.67599999999999993) + CHASTE_CONST(0.051999999999999998) * var_chaste_interface__membrane__V) / (1 + CHASTE_MATH::Exp(CHASTE_CONST(1.7160000000000002) + CHASTE_CONST(0.13200000000000001) * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(1.8) + CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(5.4098360655737707) - CHASTE_CONST(0.16393442622950821) * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(9.0909090909090917) + CHASTE_CONST(0.15151515151515152) * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return CHASTE_CONST(0.014999999999999999) * CHASTE_MATH::Exp(CHASTE_CONST(4.6558441558441563) + CHASTE_CONST(0.064935064935064929) * var_chaste_interface__membrane__V) + CHASTE_CONST(0.014999999999999999) * CHASTE_MATH::Exp(-CHASTE_CONST(0.86074429771908767) - CHASTE_CONST(0.012004801920768308) * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(0.0069387755102040824) - CHASTE_CONST(0.081632653061224483) * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 100 + 900 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(0.20000000000000001) * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(0.65693430656934315) - CHASTE_CONST(0.072992700729927015) * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(11.311475409836067) + CHASTE_CONST(0.16393442622950821) * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 175 + 125 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(4.166666666666667) - CHASTE_CONST(0.16666666666666666) * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 25 * CHASTE_MATH::Exp(-CHASTE_CONST(3.7999999999999998) + CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane__V) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(3.7999999999999998) + CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 25 * CHASTE_MATH::Exp(-CHASTE_CONST(2.7000000000000002) - CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane__V) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(2.7000000000000002) - CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
std::shared_ptr<Cellaslanidi_Purkinje_model_2009FromCellMLOpt_LookupTables> Cellaslanidi_Purkinje_model_2009FromCellMLOpt_LookupTables::mpInstance;
                ...
                pIntracellularStimulus)
    {
        ...
        this->mParameters[0] = CHASTE_CONST(0.0043750000000000004); // (var_q_leak__q_leak_max) [millimolar_per_millisecond]
        this->mParameters[1] = 3000; // (var_q_rel__g_rel_max) [per_millisecond]
        this->mParameters[2] = CHASTE_CONST(0.0043750000000000004); // (var_q_up__q_up_max) [millimolar_per_millisecond]
        this->mParameters[3] = 1; // (var_intracellular_ion_concentrations__conc_clamp) [dimensionless]
        this->mParameters[4] = CHASTE_CONST(1.8); // (var_model_parameters__Ca_o) [millimolar]
        this->mParameters[5] = CHASTE_CONST(5.4000000000000004); // (var_model_parameters__K_o) [millimolar]
        this->mParameters[6] = 140; // (var_model_parameters__Na_o) [millimolar]
        this->mParameters[7] = CHASTE_CONST(0.3392328); // (var_i_Ca_L__g_Ca_L) [dimensionless]
        this->mParameters[8] = 8; // (var_i_Na__g_Na) [milliS_per_microF]
        ...
        this->mParameters[11] = CHASTE_CONST(0.25); // (var_i_K1__g_K1_max) [milliS_per_microF]
        this->mParameters[12] = CHASTE_CONST(0.040008488000000002); // (var_i_Kr__g_Kr_max) [milliS_per_microF]
        this->mParameters[13] = CHASTE_CONST(0.052581329000000003); // (var_i_Ks__g_Ks_max) [milliS_per_microF]
        this->mParameters[14] = CHASTE_CONST(4.5); // (var_i_NaCa__i_NaCa_max) [microA_per_microF]
        this->mParameters[15] = CHASTE_CONST(0.14135944); // (var_i_to_1__g_to_1) [milliS_per_microF]
    }
    ...
    void Cellaslanidi_Purkinje_model_2009FromCellMLOpt::VerifyStateVariables()
    {
...
// LCOV_EXCL_STOP
        ...
        const double var_equilibrium_potentials__E_K = CHASTE_CONST(26.712338705498265) * CHASTE_MATH::Log(mParameters[5] / var_chaste_interface__intracellular_ion_concentrations__K_i); // millivolt
        const double var_equilibrium_potentials__E_Na = CHASTE_CONST(26.712338705498265) * CHASTE_MATH::Log(mParameters[6] / var_chaste_interface__intracellular_ion_concentrations__Na_i); // millivolt
        ...
        const double var_chaste_interface__i_ionic = CHASTE_CAP() * var_membrane__i_tot; // uA_per_cm2
    ...
    void Cellaslanidi_Purkinje_model_2009FromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? CHASTE_THIS(mFixedVoltage) : mp_membrane_voltage_modifier->Calc(rY[0], var_chaste_interface__environment__time));
        // Units: millivolt; Initial value: -83.43812846286808
...
// LCOV_EXCL_STOP
        ...
        const double var_Ca_MK_act__Ca_MK_bound = CHASTE_CONST(0.050000000000000003) * (1 - var_chaste_interface__Ca_MK_act__Ca_MK_trap) / (1 + CHASTE_CONST(0.14999999999999999) / var_chaste_interface__Ca_r__Ca_r); // dimensionless
        ...
        const double var_Ca_r__q_diff = 5 * var_chaste_interface__Ca_r__Ca_r - 5 * var_chaste_interface__Ca_i__Ca_i; // millimolar_per_millisecond
        const double d_dt_chaste_interface_var_Ca_MK_act__Ca_MK_trap = -CHASTE_CONST(0.00068000000000000005) * var_chaste_interface__Ca_MK_act__Ca_MK_trap + CHASTE_CONST(0.050000000000000003) * (var_Ca_MK_act__Ca_MK_bound + var_chaste_interface__Ca_MK_act__Ca_MK_trap) * var_Ca_MK_act__Ca_MK_bound; // 1 / millisecond
        const double var_i_Ca_p__i_Ca_p = CHASTE_CONST(0.057500000000000002) * var_chaste_interface__Ca_i__Ca_i / (CHASTE_CONST(0.00050000000000000001) + var_chaste_interface__Ca_i__Ca_i); // microA_per_microF
        const double d_dt_chaste_interface_var_i_to_2_a_gate__a = 1 / (1 + CHASTE_CONST(0.1502) / var_chaste_interface__Ca_r__Ca_r) - var_chaste_interface__i_to_2_a_gate__a; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_i_Ca_L_f2_gate__f2 = (-var_chaste_interface__i_Ca_L_f2_gate__f2 + _lt_0_row[15]) / (38 + CHASTE_CONST(24.217200000000005) * CHASTE_MATH::Pow((-1 + CHASTE_CONST(0.053763440860215048) * var_chaste_interface__membrane__V), 2)); // 1 / millisecond
        const double d_dt_chaste_interface_var_i_Ca_L_f_gate__f = (-var_chaste_interface__i_Ca_L_f_gate__f + _lt_0_row[15]) / (4 + CHASTE_CONST(0.03125) * CHASTE_MATH::Pow((-1 + CHASTE_CONST(0.40000000000000002) * var_chaste_interface__membrane__V), 2)); // 1 / millisecond
        ...
        const double var_equilibrium_potentials__E_Cl = -CHASTE_CONST(26.712338705498265) * CHASTE_MATH::Log(100 / var_chaste_interface__intracellular_ion_concentrations__Cl_i); // millivolt
        const double var_background_currents__i_Cl_b = CHASTE_CONST(0.00022499999999999999) * var_chaste_interface__membrane__V - CHASTE_CONST(0.00022499999999999999) * var_equilibrium_potentials__E_Cl; // microA_per_microF
        const double var_equilibrium_potentials__E_K = CHASTE_CONST(26.712338705498265) * CHASTE_MATH::Log(mp_extracellular_potassium_concentration_modifier->Calc(mParameters[5], var_chaste_interface__environment__time) / var_chaste_interface__intracellular_ion_concentrations__K_i); // millivolt
        const double var_CT_K_Cl__CT_K_Cl = CHASTE_CONST(7.0755999999999996e-6) * (-var_equilibrium_potentials__E_Cl + var_equilibrium_potentials__E_K) / (CHASTE_CONST(87.825100000000006) - var_equilibrium_potentials__E_Cl + var_equilibrium_potentials__E_K); // millimolar_per_millisecond
        const double var_background_currents__i_K_b = CHASTE_CONST(0.0050000000000000001) * var_chaste_interface__membrane__V - CHASTE_CONST(0.0050000000000000001) * var_equilibrium_potentials__E_K; // microA_per_microF
        const double var_equilibrium_potentials__E_Na = CHASTE_CONST(26.712338705498265) * CHASTE_MATH::Log(mp_extracellular_sodium_concentration_modifier->Calc(mParameters[6], var_chaste_interface__environment__time) / var_chaste_interface__intracellular_ion_concentrations__Na_i); // millivolt
        const double var_CT_Na_Cl__CT_Na_Cl = CHASTE_CONST(9.8442999999999999e-6) * CHASTE_MATH::Pow((-var_equilibrium_potentials__E_Cl + var_equilibrium_potentials__E_Na), 4) / (CHASTE_CONST(59494197.640692554) + CHASTE_MATH::Pow((-var_equilibrium_potentials__E_Cl + var_equilibrium_potentials__E_Na), 4)); // millimolar_per_millisecond
        const double var_background_currents__i_Na_b = CHASTE_CONST(0.0025000000000000001) * var_chaste_interface__membrane__V - CHASTE_CONST(0.0025000000000000001) * var_equilibrium_potentials__E_Na; // microA_per_microF
        const double var_i_K1__i_K1 = mp_i_K1__i_K1_modifier->Calc((CHASTE_CONST(0.0040000000000000001) + CHASTE_CONST(0.4389381125701739) * CHASTE_MATH::Sqrt(mp_extracellular_potassium_concentration_modifier->Calc(mParameters[5], var_chaste_interface__environment__time)) * mp_membrane_inward_rectifier_potassium_current_conductance_modifier->Calc(mParameters[11], var_chaste_interface__environment__time) / ((1 + CHASTE_MATH::Exp(-CHASTE_CONST(14.1227775) + CHASTE_CONST(0.23849999999999999) * var_chaste_interface__membrane__V - CHASTE_CONST(0.23849999999999999) * var_equilibrium_potentials__E_K)) * (CHASTE_CONST(1.02) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(14.1227775) + CHASTE_CONST(0.23849999999999999) * var_chaste_interface__membrane__V - CHASTE_CONST(0.23849999999999999) * var_equilibrium_potentials__E_K)) + (CHASTE_CONST(0.49124000000000001) * CHASTE_MATH::Exp(CHASTE_CONST(0.43983232) + CHASTE_CONST(0.080320000000000003) * var_chaste_interface__membrane__V - CHASTE_CONST(0.080320000000000003) * var_equilibrium_potentials__E_K) + CHASTE_MATH::Exp(-CHASTE_CONST(36.698642499999998) + CHASTE_CONST(0.061749999999999999) * var_chaste_interface__membrane__V - CHASTE_CONST(0.061749999999999999) * var_equilibrium_potentials__E_K)) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(2.4444678999999998) + CHASTE_CONST(0.51429999999999998) * var_equilibrium_potentials__E_K - CHASTE_CONST(0.51429999999999998) * var_chaste_interface__membrane__V))))) * (-var_equilibrium_potentials__E_K + var_chaste_interface__membrane__V), var_chaste_interface__environment__time); // microA_per_microF
        const double var_i_K_p__i_K_p = CHASTE_CONST(0.0027599999999999999) * (-var_equilibrium_potentials__E_K + var_chaste_interface__membrane__V) / (_lt_0_row[0]); // microA_per_microF
        ...
        const double var_i_Na_L__i_Na_L = CHASTE_CONST(0.037374999999999999) * CHASTE_MATH::Pow(var_chaste_interface__i_Na_L_m_L_gate__m_L, 3) * (-var_equilibrium_potentials__E_Na + var_chaste_interface__membrane__V) * var_chaste_interface__i_Na_L_h_L_gate__h_L; // microA_per_microF
        ...
        const double var_i_to_2__i_to_2 = CHASTE_CONST(0.028896009762002683) * (_lt_0_row[8] + var_chaste_interface__intracellular_ion_concentrations__Cl_i) * var_chaste_interface__i_to_2_a_gate__a * var_chaste_interface__membrane__V / (_lt_0_row[9]); // microA_per_microF
        ...
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Na_i = (-CHASTE_CONST(2.0301845151181685e-8) * var_i_NaCa__i_NaCa - CHASTE_CONST(2.0301845151181685e-8) * var_i_NaK__i_NaK - CHASTE_CONST(6.767281717060562e-9) * var_background_currents__i_Na_b - CHASTE_CONST(6.767281717060562e-9) * var_i_Na__i_Na - CHASTE_CONST(6.767281717060562e-9) * var_i_Na_L__i_Na_L + var_CT_Na_Cl__CT_Na_Cl) * mp_concentration_clamp_onoff_modifier->Calc(mParameters[3], var_chaste_interface__environment__time); // millimolar / millisecond
        const double var_background_currents__i_Ca_b = CHASTE_CONST(0.0028824983370007683) * (-CHASTE_CONST(0.34100000000000003) * mp_extracellular_calcium_concentration_modifier->Calc(mParameters[4], var_chaste_interface__environment__time) + var_chaste_interface__Ca_i__Ca_i * _lt_0_row[1]) * var_chaste_interface__membrane__V / (_lt_0_row[2]); // microA_per_microF
        const double var_i_Ca_L__i_Ca_L_max = CHASTE_CONST(3.510865186083326) * (-15 + var_chaste_interface__membrane__V) * (-CHASTE_CONST(0.34100000000000003) * mp_extracellular_calcium_concentration_modifier->Calc(mParameters[4], var_chaste_interface__environment__time) + var_chaste_interface__Ca_r__Ca_r * _lt_0_row[11]) / (_lt_0_row[12]); // microA_per_microF
        ...
        const double d_dt_chaste_interface_var_i_Ca_L_f_Ca2_gate__f_Ca2 = (-var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2 + 1 / (1 - 100 * var_i_Ca_L__i_Ca_L)) / (125 + 300 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(4.375) - 25 * var_i_Ca_L__i_Ca_L))); // 1 / millisecond
        const double d_dt_chaste_interface_var_i_Ca_L_f_Ca_gate__f_Ca = (CHASTE_CONST(0.14999999999999999) - var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca + CHASTE_CONST(0.55000000000000004) / (1 + CHASTE_CONST(333.33333333333331) * var_chaste_interface__Ca_r__Ca_r) + CHASTE_CONST(0.29999999999999999) / (1 - 20 * var_i_Ca_L__i_Ca_L)) / (CHASTE_CONST(0.5) + 1 / (1 + CHASTE_CONST(333.33333333333331) * var_chaste_interface__Ca_r__Ca_r) + 10 * var_Ca_MK_act__Ca_MK_act / (CHASTE_CONST(0.14999999999999999) + var_Ca_MK_act__Ca_MK_act)); // 1 / millisecond
        const double var_q_leak__q_leak = CHASTE_CONST(0.066666666666666666) * var_chaste_interface__Ca_NSR__Ca_NSR * mp_SR_leak_current_max_modifier->Calc(mParameters[0], var_chaste_interface__environment__time); // millimolar_per_millisecond
        const double var_q_rel_ri_gate__Ca_fac = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(3.3333333333333335) + CHASTE_CONST(66.666666666666671) * var_i_Ca_L__i_Ca_L)); // millimolar
        const double d_dt_chaste_interface_var_q_rel_ri_gate__ri = (-var_chaste_interface__q_rel_ri_gate__ri + 1 / (1 + CHASTE_MATH::Exp(-16 + 80 * var_q_rel_ri_gate__Ca_fac + 40000 * var_chaste_interface__Ca_r__Ca_r))) / (3 + (350 - 10 * var_Ca_MK_act__Ca_MK_act / (CHASTE_CONST(0.14999999999999999) + var_Ca_MK_act__Ca_MK_act)) / (1 + CHASTE_MATH::Exp(-15 + 5000 * var_chaste_interface__Ca_r__Ca_r + 15 * var_q_rel_ri_gate__Ca_fac)) + 10 * var_Ca_MK_act__Ca_MK_act / (CHASTE_CONST(0.14999999999999999) + var_Ca_MK_act__Ca_MK_act)); // 1 / millisecond
...
// LCOV_EXCL_STOP
        ...
        // Mathematics
        const double var_Ca_MK_act__Ca_MK_0 = CHASTE_CONST(0.050000000000000003); // dimensionless
        const double var_Ca_MK_act__km_Ca_MK = CHASTE_CONST(0.14999999999999999); // millimolar
        const double var_Ca_MK_act__Ca_MK_bound = (1 - var_chaste_interface__Ca_MK_act__Ca_MK_trap) * var_Ca_MK_act__Ca_MK_0 / (1 + var_Ca_MK_act__km_Ca_MK / var_chaste_interface__Ca_r__Ca_r); // dimensionless
        const double var_Ca_MK_act__Ca_MK_act = var_Ca_MK_act__Ca_MK_bound + var_chaste_interface__Ca_MK_act__Ca_MK_trap; // dimensionless
        const double var_equilibrium_potentials__r_NaK = CHASTE_CONST(0.018329999999999999); // dimensionless
        const double var_i_Ca_L__p_Ca = CHASTE_CONST(0.000243); // cm_per_second
        const double var_i_Ca_L_f_Ca_gate__tau_f_Ca = mp_membrane_L_type_calcium_current_fCa_gate_tau_modifier->Calc(CHASTE_CONST(0.5) + 1 / (1 + CHASTE_CONST(333.33333333333331) * var_chaste_interface__Ca_r__Ca_r) + 10 * var_Ca_MK_act__Ca_MK_act / (var_Ca_MK_act__Ca_MK_act + var_Ca_MK_act__km_Ca_MK), var_chaste_interface__environment__time); // millisecond
        const double var_i_Ks__g_Ks = (1 + CHASTE_CONST(0.59999999999999998) / (1 + CHASTE_CONST(6.4818210260626455e-7) * CHASTE_MATH::Pow((1 / var_chaste_interface__Ca_i__Ca_i), CHASTE_CONST(1.3999999999999999)))) * mp_membrane_slow_delayed_rectifier_potassium_current_conductance_modifier->Calc(mParameters[13], var_chaste_interface__environment__time); // milliS_per_microF
        const double var_i_NaCa__X_NaCa = CHASTE_CONST(0.40000000000000002); // dimensionless
        const double var_i_NaCa__k_sat = CHASTE_CONST(0.27000000000000002); // dimensionless
        const double var_i_NaCa__km_Ca_act = CHASTE_CONST(0.000125); // millimolar
        const double var_i_NaCa__km_Ca_i = CHASTE_CONST(0.0035999999999999999); // millimolar
        const double var_i_NaCa__km_Ca_o = CHASTE_CONST(1.3); // millimolar
        const double var_i_NaCa__km_Na_i_1 = CHASTE_CONST(12.300000000000001); // millimolar
        const double var_i_NaCa__km_Na_o = CHASTE_CONST(87.5); // millimolar
        const double var_i_Ca_L_f2_gate__tau_f2 = mp_membrane_L_type_calcium_current_f2_gate_tau_modifier->Calc(38 + CHASTE_CONST(24.217200000000005) * CHASTE_MATH::Pow((-1 + CHASTE_CONST(0.053763440860215048) * var_chaste_interface__membrane__V), 2), var_chaste_interface__environment__time); // millisecond
        const double var_i_Ca_L_f_gate__tau_f = mp_membrane_L_type_calcium_current_f_gate_tau_modifier->Calc(4 + CHASTE_CONST(0.03125) * CHASTE_MATH::Pow((-1 + CHASTE_CONST(0.40000000000000002) * var_chaste_interface__membrane__V), 2), var_chaste_interface__environment__time); // millisecond
        ...
        const double var_model_parameters__Cm = 1; // microF_per_cm2
        const double var_model_parameters__F = 96485; // coulomb_per_mole
        ...
        const double var_i_Kr__g_Kr = CHASTE_CONST(0.43033148291193518) * CHASTE_MATH::Sqrt(mp_extracellular_potassium_concentration_modifier->Calc(mParameters[5], var_chaste_interface__environment__time)) * mp_membrane_rapid_delayed_rectifier_potassium_current_conductance_modifier->Calc(mParameters[12], var_chaste_interface__environment__time); // milliS_per_microF
        const double var_i_NaCa__dNaCa_2 = CHASTE_MATH::Pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * mp_extracellular_calcium_concentration_modifier->Calc(mParameters[4], var_chaste_interface__environment__time) + CHASTE_CONST(1.5) * CHASTE_MATH::Pow(mp_extracellular_sodium_concentration_modifier->Calc(mParameters[6], var_chaste_interface__environment__time), 3) * var_chaste_interface__Ca_i__Ca_i + CHASTE_MATH::Pow(mp_extracellular_sodium_concentration_modifier->Calc(mParameters[6], var_chaste_interface__environment__time), 3) * (1 + var_chaste_interface__intracellular_ion_concentrations__Na_i / var_i_NaCa__km_Na_i_1) * var_i_NaCa__km_Ca_i; // millimolar4
        const double var_model_parameters__R = 8314; // joule_per_kilomole_kelvin
        const double var_model_parameters__T = 310; // kelvin
        const double var_equilibrium_potentials__E_K = var_model_parameters__R * var_model_parameters__T * CHASTE_MATH::Log(mp_extracellular_potassium_concentration_modifier->Calc(mParameters[5], var_chaste_interface__environment__time) / var_chaste_interface__intracellular_ion_concentrations__K_i) / var_model_parameters__F; // millivolt
        ...
        const double var_equilibrium_potentials__E_Na = var_model_parameters__R * var_model_parameters__T * CHASTE_MATH::Log(mp_extracellular_sodium_concentration_modifier->Calc(mParameters[6], var_chaste_interface__environment__time) / var_chaste_interface__intracellular_ion_concentrations__Na_i) / var_model_parameters__F; // millivolt
        const double var_i_K1_xK1_gate__alpha_xK1 = CHASTE_CONST(1.02) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(14.1227775) + CHASTE_CONST(0.23849999999999999) * var_chaste_interface__membrane__V - CHASTE_CONST(0.23849999999999999) * var_equilibrium_potentials__E_K)); // dimensionless
        const double var_i_K1_xK1_gate__beta_xK1 = (CHASTE_CONST(0.49124000000000001) * CHASTE_MATH::Exp(CHASTE_CONST(0.43983232) + CHASTE_CONST(0.080320000000000003) * var_chaste_interface__membrane__V - CHASTE_CONST(0.080320000000000003) * var_equilibrium_potentials__E_K) + CHASTE_MATH::Exp(-CHASTE_CONST(36.698642499999998) + CHASTE_CONST(0.061749999999999999) * var_chaste_interface__membrane__V - CHASTE_CONST(0.061749999999999999) * var_equilibrium_potentials__E_K)) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(2.4444678999999998) + CHASTE_CONST(0.51429999999999998) * var_equilibrium_potentials__E_K - CHASTE_CONST(0.51429999999999998) * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_i_K1__i_K1 = mp_i_K1__i_K1_modifier->Calc((CHASTE_CONST(0.0040000000000000001) + var_i_K1__g_K1 * var_i_K1_xK1_gate__xK1) * (-var_equilibrium_potentials__E_K + var_chaste_interface__membrane__V), var_chaste_interface__environment__time); // microA_per_microF
        const double var_i_K1__i_K1_converted = CHASTE_CAP() * var_i_K1__i_K1; // uA_per_cm2
        ...
        const double var_i_Kr__i_Kr_converted = CHASTE_CAP() * var_i_Kr__i_Kr; // uA_per_cm2
        ...
        const double var_i_Ks__i_Ks_converted = CHASTE_CAP() * var_i_Ks__i_Ks; // uA_per_cm2
        const double var_i_Na__i_Na = mp_i_Na__i_Na_modifier->Calc(CHASTE_MATH::Pow(var_chaste_interface__i_Na_m_gate__m, 3) * (-var_equilibrium_potentials__E_Na + var_chaste_interface__membrane__V) * (CHASTE_CONST(0.20000000000000001) * var_chaste_interface__i_Na_j_gate__j + CHASTE_CONST(0.80000000000000004) * var_chaste_interface__i_Na_h_gate__h) * mp_membrane_fast_sodium_current_conductance_modifier->Calc(mParameters[8], var_chaste_interface__environment__time), var_chaste_interface__environment__time); // microA_per_microF
        const double var_i_Na__i_Na_converted = CHASTE_CAP() * var_i_Na__i_Na; // uA_per_cm2
        ...
        const double var_i_NaCa__i_NaCa_converted = CHASTE_CAP() * var_i_NaCa__i_NaCa; // uA_per_cm2
        const double var_i_to_1__i_to_1 = mp_i_to_1__i_to_1_modifier->Calc((-var_equilibrium_potentials__E_K + var_chaste_interface__membrane__V) * (CHASTE_CONST(0.20000000000000001) * var_chaste_interface__i_to_1_i2_gate__i2 + CHASTE_CONST(0.80000000000000004) * var_chaste_interface__i_to_1_i_gate__i) * mp_membrane_transient_outward_current_conductance_modifier->Calc(mParameters[15], var_chaste_interface__environment__time) * var_chaste_interface__i_to_1_a_gate__a, var_chaste_interface__environment__time); // microA_per_microF
        const double var_i_to_1__i_to_1_converted = CHASTE_CAP() * var_i_to_1__i_to_1; // uA_per_cm2
        const double var_model_parameters__gamma_Cai = 1; // dimensionless
        const double var_model_parameters__gamma_Cao = CHASTE_CONST(0.34100000000000003); // dimensionless
        const double var_model_parameters__z_Ca = 2; // dimensionless
        const double var_i_Ca_L__i_Ca_L_max = CHASTE_MATH::Pow(var_model_parameters__F, 2) * CHASTE_MATH::Pow(var_model_parameters__z_Ca, 2) * (-15 + var_chaste_interface__membrane__V) * (-mp_extracellular_calcium_concentration_modifier->Calc(mParameters[4], var_chaste_interface__environment__time) * var_model_parameters__gamma_Cao + var_chaste_interface__Ca_r__Ca_r * var_model_parameters__gamma_Cai * CHASTE_MATH::Exp((-15 + var_chaste_interface__membrane__V) * var_model_parameters__F * var_model_parameters__z_Ca / (var_model_parameters__R * var_model_parameters__T))) * var_i_Ca_L__p_Ca / ((-1 + CHASTE_MATH::Exp((-15 + var_chaste_interface__membrane__V) * var_model_parameters__F * var_model_parameters__z_Ca / (var_model_parameters__R * var_model_parameters__T))) * var_model_parameters__Cm * var_model_parameters__R * var_model_parameters__T); // microA_per_microF
        const double var_i_Ca_L__i_Ca_L = mp_i_Ca_L__i_Ca_L_modifier->Calc(mp_membrane_L_type_calcium_current_conductance_modifier->Calc(mParameters[7], var_chaste_interface__environment__time) * var_i_Ca_L__i_Ca_L_max * var_chaste_interface__i_Ca_L_d_gate__d * var_chaste_interface__i_Ca_L_f2_gate__f2 * var_chaste_interface__i_Ca_L_f_Ca2_gate__f_Ca2 * var_chaste_interface__i_Ca_L_f_Ca_gate__f_Ca * var_chaste_interface__i_Ca_L_f_gate__f, var_chaste_interface__environment__time); // microA_per_microF
        const double var_i_Ca_L__i_Ca_L_converted = CHASTE_CAP() * var_i_Ca_L__i_Ca_L; // uA_per_cm2
        const double var_i_Ca_L_f_Ca2_gate__tau_f_Ca2 = mp_membrane_L_type_calcium_current_fCa2_gate_tau_modifier->Calc(125 + 300 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(4.375) - 25 * var_i_Ca_L__i_Ca_L)), var_chaste_interface__environment__time); // millisecond
        const double var_q_rel__vg = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(2.6000000000000001) + CHASTE_CONST(0.20000000000000001) * mp_membrane_L_type_calcium_current_conductance_modifier->Calc(mParameters[7], var_chaste_interface__environment__time) * var_i_Ca_L__i_Ca_L_max)); // dimensionless
