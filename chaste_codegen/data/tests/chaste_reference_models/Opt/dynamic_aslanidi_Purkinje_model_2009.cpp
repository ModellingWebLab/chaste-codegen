...
// LCOV_EXCL_STOP
        ...
        const double var_i_Na_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40) ? (1.0495108254269646e-6 * exp(0.14705882352941177 * mp_membrane_fast_sodium_current_shift_inactivation_modifier->Calc(mParameters[10], var_chaste_interface__environment__time) - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0)); // per_millisecond
        ...
        const double var_i_Ca_L__i_Ca_L_max = 3.510865186083326 * (-15 + var_chaste_interface__membrane__V) * (-0.34100000000000003 * mp_extracellular_calcium_concentration_modifier->Calc(mParameters[4], var_chaste_interface__environment__time) + var_chaste_interface__Ca_r__Ca_r * _lt_0_row[11]) / (_lt_0_row[12]); // microA_per_microF
