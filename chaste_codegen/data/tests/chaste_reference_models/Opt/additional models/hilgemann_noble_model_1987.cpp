...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellhilgemann_noble_model_1987FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_background_current__i_b_Ca = 0.005 * var_chaste_interface__membrane__V - 0.06678440164923913 * log(var_chaste_interface__extracellular_calcium_concentration__Ca_o / var_chaste_interface__intracellular_calcium_concentration__Ca_i); // nanoA
        const double var_fast_sodium_current__i_Na = 50.0 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (-26.71376065969565 * log(140.48 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i)) + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current_h_gate__h; // nanoA
        ...
        const double var_second_inward_calcium_current__i_si = 0.0003743389082274547 * (-50.0 + var_chaste_interface__membrane__V) * (-4.0 * exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372734)) * var_chaste_interface__second_inward_calcium_current_d_gate__d * var_second_inward_calcium_current_f_Ca_gate__CaChon / (1.0 - exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V)) + 0.7486778164549093 * (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(3.743389082274547) - var_chaste_interface__extracellular_calcium_concentration__Ca_o * exp(3.743389082274547 - 0.07486778164549093 * var_chaste_interface__membrane__V)) * var_chaste_interface__second_inward_calcium_current_d_gate__d * var_second_inward_calcium_current_f_Ca_gate__CaChon / (1.0 - exp(3.743389082274547 - 0.07486778164549093 * var_chaste_interface__membrane__V)) + 0.0018716945411372734 * (-50.0 + var_chaste_interface__membrane__V) * (-140.0 * exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(1.8716945411372734)) * var_chaste_interface__second_inward_calcium_current_d_gate__d * var_second_inward_calcium_current_f_Ca_gate__CaChon / (1.0 - exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V)); // nanoA
        ...
        const double var_time_independent_potassium_current__E_K = 26.71376065969565 * log(4.0 / var_chaste_interface__intracellular_potassium_concentration__K_i); // millivolt
        const double var_potassium_background_current__i_b_K = 0.17 * var_chaste_interface__membrane__V - 0.17 * var_time_independent_potassium_current__E_K; // nanoA
        const double var_time_independent_potassium_current__i_K1 = 0.48571428571428565 * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(-0.7486778164549093 + 0.07486778164549093 * var_chaste_interface__membrane__V - 0.07486778164549093 * var_time_independent_potassium_current__E_K)); // nanoA
    ...
    void Cellhilgemann_noble_model_1987FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_calcium_release__ProdFrac = -0.0006 * var_chaste_interface__calcium_release__ProdFrac + 0.001 * var_chaste_interface__calcium_release__ActFrac * var_calcium_release__InactRate; // 1 / millisecond
        ...
        const double var_second_inward_calcium_current__i_siCa = 0.7486778164549093 * (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(3.743389082274547) - var_chaste_interface__extracellular_calcium_concentration__Ca_o * exp(3.743389082274547 - 0.07486778164549093 * var_chaste_interface__membrane__V)) * var_chaste_interface__second_inward_calcium_current_d_gate__d * var_second_inward_calcium_current_f_Ca_gate__CaChon / (1.0 - exp(3.743389082274547 - 0.07486778164549093 * var_chaste_interface__membrane__V)); // nanoA
        const double d_dt_chaste_interface_var_extracellular_calcium_concentration__Ca_o = 1e-06 - 8.054319271538506e-06 * var_Na_Ca_exchanger__i_NaCa - 8.054319271538506e-06 * var_calcium_background_current__i_b_Ca - 8.054319271538506e-06 * var_second_inward_calcium_current__i_siCa - 5e-07 * var_chaste_interface__extracellular_calcium_concentration__Ca_o; // millimolar / millisecond
        const double d_dt_chaste_interface_var_intracellular_calcium_concentration__Ca_i = 0.00020408163265306123 * var_calcium_release__i_rel + 1.3149909014756744e-05 * var_Na_Ca_exchanger__i_NaCa - 0.001 * var_intracellular_calcium_concentration__Ca_Calmod_orig_deriv - 0.001 * var_intracellular_calcium_concentration__Ca_Trop_orig_deriv - 0.001 * var_sarcoplasmic_reticulum_calcium_pump__i_up - 6.574954507378372e-06 * var_calcium_background_current__i_b_Ca - 6.574954507378372e-06 * var_second_inward_calcium_current__i_siCa; // millimolar / millisecond
        const double var_second_inward_calcium_current__i_siK = 0.0003743389082274547 * (-50.0 + var_chaste_interface__membrane__V) * (-4.0 * exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V) + var_chaste_interface__intracellular_potassium_concentration__K_i * exp(1.8716945411372734)) * var_chaste_interface__second_inward_calcium_current_d_gate__d * var_second_inward_calcium_current_f_Ca_gate__CaChon / (1.0 - exp(1.8716945411372734 - 0.037433890822745466 * var_chaste_interface__membrane__V)); // nanoA
        ...
        const double var_sodium_background_current__i_b_Na = 0.012 * var_chaste_interface__membrane__V - 0.32056512791634784 * log(140.0 / var_chaste_interface__intracellular_sodium_concentration__Na_i); // nanoA
        const double var_sodium_potassium_pump__i_NaK = 11.200000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i); // nanoA
        const double d_dt_chaste_interface_var_intracellular_sodium_concentration__Na_i = -3.944972704427023e-05 * var_Na_Ca_exchanger__i_NaCa - 3.944972704427023e-05 * var_sodium_potassium_pump__i_NaK - 1.3149909014756744e-05 * var_fast_sodium_current__i_Na - 1.3149909014756744e-05 * var_second_inward_calcium_current__i_siNa - 1.3149909014756744e-05 * var_sodium_background_current__i_b_Na; // millimolar / millisecond
        const double var_time_independent_potassium_current__E_K = 26.71376065969565 * log(4.0 / var_chaste_interface__intracellular_potassium_concentration__K_i); // millivolt
        const double var_potassium_background_current__i_b_K = 0.17 * var_chaste_interface__membrane__V - 0.17 * var_time_independent_potassium_current__E_K; // nanoA
        const double var_time_independent_potassium_current__i_K1 = 0.48571428571428565 * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) / (1.0 + exp(-0.7486778164549093 + 0.07486778164549093 * var_chaste_interface__membrane__V - 0.07486778164549093 * var_time_independent_potassium_current__E_K)); // nanoA
        const double d_dt_chaste_interface_var_intracellular_potassium_concentration__K_i = 2.629981802951349e-05 * var_sodium_potassium_pump__i_NaK - 1.3149909014756744e-05 * var_potassium_background_current__i_b_K - 1.3149909014756744e-05 * var_second_inward_calcium_current__i_siK - 1.3149909014756744e-05 * var_time_independent_potassium_current__i_K1; // millimolar / millisecond
