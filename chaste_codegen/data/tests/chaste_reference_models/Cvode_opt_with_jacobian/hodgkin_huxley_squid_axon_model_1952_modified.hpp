#ifdef CHASTE_CVODE
#ifndef CELLHODGKIN_HUXLEY_SQUID_AXON_MODEL_1952_MODIFIEDFROMCELLMLCVODEOPT_HPP_
#define CELLHODGKIN_HUXLEY_SQUID_AXON_MODEL_1952_MODIFIEDFROMCELLMLCVODEOPT_HPP_
...
public:
    ...
    Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvodeOpt(std::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, std::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
...
namespace boost
{
    namespace serialization
    {
        ...
        inline void save_construct_data(
            Archive & ar, const Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvodeOpt * t, const unsigned int fileVersion)
        {
        ...
        inline void load_construct_data(
            Archive & ar, Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvodeOpt * t, const unsigned int fileVersion)
        {
            std::shared_ptr<AbstractIvpOdeSolver> p_solver;
            std::shared_ptr<AbstractStimulusFunction> p_stimulus;
            ar >> p_solver;
            ar >> p_stimulus;
            ::new(t)Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvodeOpt(p_solver, p_stimulus);
        }
