...
const double var_x0 = 1 / NV_Ith_S(mParameters, 0);
        ...
        IJth(rJacobian, 1, 1) = ((var_x9) ? (var_x14 + var_x15 - 499999.99998562218 * (50.000000999999997 + var_chaste_interface__membrane__V) * (var_x15 - 1.0000000000287557e-7 * var_x5)) : (var_x14 + var_x13 * var_x8));
        ...
        IJth(rJacobian, 3, 3) = ((var_x23) ? (var_x27 + var_x28 - 499999.99998562218 * (65.000000999999997 + var_chaste_interface__membrane__V) * (var_x28 - 1.0000000000287556e-8 * var_x5)) : (var_x27 + var_x22 * var_x26));
    }
