...
std::shared_ptr<Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvodeOpt_LookupTables> Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvodeOpt_LookupTables::mpInstance;
    ...
    double Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_potassium_channel__i_K = pow(var_chaste_interface__potassium_channel_n_gate__n, 4) * (87 + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 3); // microA_per_cm2
        const double var_sodium_channel__i_Na = pow(var_chaste_interface__sodium_channel_m_gate__m, 3) * (-40 + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 1) * var_chaste_interface__sodium_channel_h_gate__h; // microA_per_cm2
...
const double var_x0 = 1 / NV_Ith_S(mParameters, 0);
        ...
        const double var_x4 = 0.0034453007997798488 * var_x3 * var_chaste_interface__sodium_channel_m_gate__m;
        ...
        const double var_x6 = 1 - var_chaste_interface__sodium_channel_m_gate__m;
        ...
        const double var_x17 = -0.0039899835282233235 * var_x16 * var_chaste_interface__potassium_channel_n_gate__n;
        ...
        IJth(rJacobian, 1, 0) = ((var_x5) ? (0.049999067384036401 + var_x4 - 0.049999067384036401 * var_chaste_interface__sodium_channel_m_gate__m) : (var_x4 - var_x10 * var_x6 - 6.7379469990854672e-5 * var_x11 * var_x6 * var_x8 / pow(var_x9, 2)));
        ...
        IJth(rJacobian, 3, 0) = ((var_x18) ? (0.0049999067383819564 + var_x17 - 0.0049999067383819564 * var_chaste_interface__potassium_channel_n_gate__n) : (var_x17 - var_x19 * var_x21 - 1.5034391929775725e-6 * var_x19 * var_x22 * var_x8 / pow(var_x20, 2)));
        ...
        IJth(rJacobian, 1, 1) = ((var_x5) ? (-3.4999533692061595 + var_x12 - 0.049999067384036401 * var_chaste_interface__membrane__V) : (var_x12 + var_x10 * var_x11));
        ...
        IJth(rJacobian, 3, 3) = ((var_x18) ? (-0.42499393799526108 + var_x23 - 0.0049999067383819564 * var_chaste_interface__membrane__V) : (var_x23 + var_x21 * var_x22));
    }
