...
std::shared_ptr<Dynamicaslanidi_Purkinje_model_2009FromCellMLCvodeOpt_LookupTables> Dynamicaslanidi_Purkinje_model_2009FromCellMLCvodeOpt_LookupTables::mpInstance;
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 0) = CHASTE_CONST(0.0043750000000000004); // (var_q_leak__q_leak_max) [millimolar_per_millisecond]
        NV_Ith_S(this->mParameters, 1) = 3000; // (var_q_rel__g_rel_max) [per_millisecond]
        NV_Ith_S(this->mParameters, 2) = CHASTE_CONST(0.0043750000000000004); // (var_q_up__q_up_max) [millimolar_per_millisecond]
        NV_Ith_S(this->mParameters, 3) = 1; // (var_intracellular_ion_concentrations__conc_clamp) [dimensionless]
        NV_Ith_S(this->mParameters, 4) = CHASTE_CONST(1.8); // (var_model_parameters__Ca_o) [millimolar]
        NV_Ith_S(this->mParameters, 5) = CHASTE_CONST(5.4000000000000004); // (var_model_parameters__K_o) [millimolar]
        NV_Ith_S(this->mParameters, 6) = 140; // (var_model_parameters__Na_o) [millimolar]
        NV_Ith_S(this->mParameters, 7) = CHASTE_CONST(0.3392328); // (var_i_Ca_L__g_Ca_L) [dimensionless]
        ...
        NV_Ith_S(this->mParameters, 11) = CHASTE_CONST(0.25); // (var_i_K1__g_K1_max) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 12) = CHASTE_CONST(0.040008488000000002); // (var_i_Kr__g_Kr_max) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 13) = CHASTE_CONST(0.052581329000000003); // (var_i_Ks__g_Ks_max) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 14) = CHASTE_CONST(4.5); // (var_i_NaCa__i_NaCa_max) [microA_per_microF]
        NV_Ith_S(this->mParameters, 15) = CHASTE_CONST(0.14135944); // (var_i_to_1__g_to_1) [milliS_per_microF]
    }
...
// LCOV_EXCL_STOP
        ...
        const double var_equilibrium_potentials__E_K = CHASTE_CONST(26.712338705498265) * CHASTE_MATH::Log(NV_Ith_S(mParameters, 5) / var_chaste_interface__intracellular_ion_concentrations__K_i); // millivolt
        const double var_equilibrium_potentials__E_Na = CHASTE_CONST(26.712338705498265) * CHASTE_MATH::Log(NV_Ith_S(mParameters, 6) / var_chaste_interface__intracellular_ion_concentrations__Na_i); // millivolt
    ...
    void Dynamicaslanidi_Purkinje_model_2009FromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? CHASTE_THIS(mFixedVoltage) : mp_membrane_voltage_modifier->Calc(NV_Ith_S(rY, 0), var_chaste_interface__environment__time));
        // Units: millivolt; Initial value: -83.43812846286808
...
// LCOV_EXCL_STOP
        ...
        const double var_equilibrium_potentials__E_K = CHASTE_CONST(26.712338705498265) * CHASTE_MATH::Log(mp_extracellular_potassium_concentration_modifier->Calc(NV_Ith_S(mParameters, 5), var_chaste_interface__environment__time) / var_chaste_interface__intracellular_ion_concentrations__K_i); // millivolt
        ...
        const double var_equilibrium_potentials__E_Na = CHASTE_CONST(26.712338705498265) * CHASTE_MATH::Log(mp_extracellular_sodium_concentration_modifier->Calc(NV_Ith_S(mParameters, 6), var_chaste_interface__environment__time) / var_chaste_interface__intracellular_ion_concentrations__Na_i); // millivolt
        ...
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__Na_i = (-CHASTE_CONST(2.0301845151181685e-8) * var_i_NaCa__i_NaCa - CHASTE_CONST(2.0301845151181685e-8) * var_i_NaK__i_NaK - CHASTE_CONST(6.767281717060562e-9) * var_background_currents__i_Na_b - CHASTE_CONST(6.767281717060562e-9) * var_i_Na__i_Na - CHASTE_CONST(6.767281717060562e-9) * var_i_Na_L__i_Na_L + var_CT_Na_Cl__CT_Na_Cl) * mp_concentration_clamp_onoff_modifier->Calc(NV_Ith_S(mParameters, 3), var_chaste_interface__environment__time); // millimolar / millisecond
        const double var_background_currents__i_Ca_b = CHASTE_CONST(0.0028824983370007683) * (-CHASTE_CONST(0.34100000000000003) * mp_extracellular_calcium_concentration_modifier->Calc(NV_Ith_S(mParameters, 4), var_chaste_interface__environment__time) + var_chaste_interface__Ca_i__Ca_i * _lt_0_row[1]) * var_chaste_interface__membrane__V / (_lt_0_row[2]); // microA_per_microF
        ...
        const double var_q_leak__q_leak = CHASTE_CONST(0.066666666666666666) * var_chaste_interface__Ca_NSR__Ca_NSR * mp_SR_leak_current_max_modifier->Calc(NV_Ith_S(mParameters, 0), var_chaste_interface__environment__time); // millimolar_per_millisecond
...
// LCOV_EXCL_STOP
        ...
        const double var_q_rel__vg = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(2.6000000000000001) + CHASTE_CONST(0.20000000000000001) * mp_membrane_L_type_calcium_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 7), var_chaste_interface__environment__time) * var_i_Ca_L__i_Ca_L_max)); // dimensionless
