...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 - 6.4993004051833205 * exp(-0.037433890822745473 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 - 42.240905756816076 * exp(-0.074867781645490947 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 600 * exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return (((var_chaste_interface__membrane__V >= -41.000000999999997) && (var_chaste_interface__membrane__V <= -40.999999000000003)) ? (6099.9235254615414 + 99.998134767143 * var_chaste_interface__membrane__V) : (200 * (41 + var_chaste_interface__membrane__V) / (1 - 0.016572675401761244 * exp(-0.10000000000000001 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return (((var_chaste_interface__membrane__V >= -19.000000400000001) && (var_chaste_interface__membrane__V <= -18.999999599999999)) ? (404.99468408919864 + 14.999720215193575 * var_chaste_interface__membrane__V) : (30 * (19 + var_chaste_interface__membrane__V) / (1 - 0.0086516952031206341 * exp(-0.25 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return (((var_chaste_interface__membrane__V >= -19.000001000000001) && (var_chaste_interface__membrane__V <= -18.999998999999999)) ? (5.9942160172560808 - 6.000304420127998 * var_chaste_interface__membrane__V) : (12 * (19 + var_chaste_interface__membrane__V) / (-1 + 6.6858944422792694 * exp(0.10000000000000001 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 1 + exp(-8.5 - 0.25 * var_chaste_interface__membrane__V);
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return (((var_chaste_interface__membrane__V >= -34.000000399999998) && (var_chaste_interface__membrane__V <= -33.999999600000002)) ? (-81.248018190452797 - 3.1249417114870965 * var_chaste_interface__membrane__V) : (6.25 * (34 + var_chaste_interface__membrane__V) / (-1 + 4914.7688402991344 * exp(0.25 * var_chaste_interface__membrane__V))));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
...
// LCOV_EXCL_STOP
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = 20 * exp(-9.375 + 0.125 * NV_Ith_S(mParameters, 11) - 0.125 * var_chaste_interface__membrane__V); // per_second
        const double var_fast_sodium_current_h_gate__beta_h = 2000 / (1 + 320 * exp(-7.5 + 0.10000000000000001 * NV_Ith_S(mParameters, 11) - 0.10000000000000001 * var_chaste_interface__membrane__V)); // per_second
        ...
        const double d_dt_chaste_interface_var_fast_sodium_current_m_gate__m = 0.001 * (1 - var_chaste_interface__fast_sodium_current_m_gate__m) * _lt_0_row[7] - 8 * var_chaste_interface__fast_sodium_current_m_gate__m * _lt_0_row[8]; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_second_inward_calcium_current_d_gate__d = 0.001 * (1 - var_chaste_interface__second_inward_calcium_current_d_gate__d) * _lt_0_row[9] - 0.001 * _lt_0_row[10] * var_chaste_interface__second_inward_calcium_current_d_gate__d; // 1 / millisecond
        ...
        const double var_second_inward_calcium_current__i_siK = (((var_chaste_interface__membrane__V >= 49.999997328623934) && (var_chaste_interface__membrane__V <= 50.000002671376066)) ? (187169.45411399176 * (-49.999997328623934 + var_chaste_interface__membrane__V) * (0.0020000000999985186 * (1 - var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca) * (1 - var_chaste_interface__intracellular_calcium_concentration__Ca_i / (0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i)) * (6.4993004051833205 * var_chaste_interface__intracellular_potassium_concentration__K_i - 0.99999990000000505 * NV_Ith_S(mParameters, 5)) * NV_Ith_S(mParameters, 7) * var_chaste_interface__second_inward_calcium_current_d_gate__d - 0.0019999998999849018 * (1 - var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca) * (1 - var_chaste_interface__intracellular_calcium_concentration__Ca_i / (0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i)) * (6.4993004051833205 * var_chaste_interface__intracellular_potassium_concentration__K_i - 1.0000001000000049 * NV_Ith_S(mParameters, 5)) * NV_Ith_S(mParameters, 7) * var_chaste_interface__second_inward_calcium_current_d_gate__d) + 0.0019999998999849018 * (1 - var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca) * (1 - var_chaste_interface__intracellular_calcium_concentration__Ca_i / (0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i)) * (6.4993004051833205 * var_chaste_interface__intracellular_potassium_concentration__K_i - 1.0000001000000049 * NV_Ith_S(mParameters, 5)) * NV_Ith_S(mParameters, 7) * var_chaste_interface__second_inward_calcium_current_d_gate__d) : (7.4867781645490941e-5 * (1 - var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca) * (1 - var_chaste_interface__intracellular_calcium_concentration__Ca_i / (0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i)) * (-50 + var_chaste_interface__membrane__V) * (6.4993004051833205 * var_chaste_interface__intracellular_potassium_concentration__K_i - 6.4993004051833205 * NV_Ith_S(mParameters, 5) * _lt_0_row[2]) * NV_Ith_S(mParameters, 7) * var_chaste_interface__second_inward_calcium_current_d_gate__d / (_lt_0_row[3]))); // nanoA
