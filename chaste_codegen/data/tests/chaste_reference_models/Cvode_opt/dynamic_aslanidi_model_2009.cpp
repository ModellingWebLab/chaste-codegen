...
class Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables()
    {
...
protected:
    Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables(const Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables&);
    Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables& operator= (const Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables&);
    Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables()
    {
        ...
        Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables> mpInstance;
...
std::shared_ptr<Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables> Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables::mpInstance;
    ...
    AbstractLookupTableCollection* Dynamicaslanidi_model_2009FromCellMLCvodeOpt::GetLookupTableCollection()
    {
        return Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables::Instance();
    }
    ...
    double Dynamicaslanidi_model_2009FromCellMLCvodeOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicaslanidi_model_2009FromCellMLCvodeOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
