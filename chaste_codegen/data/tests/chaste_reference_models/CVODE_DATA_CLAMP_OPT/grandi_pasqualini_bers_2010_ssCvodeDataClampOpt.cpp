        ...
        if (mNeedsRegeneration[0])
        {
            ...
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(7.4880000000000004) - CHASTE_CONST(0.16722408026755853) * var_chaste_interface__membrane_potential__V_m));
                };
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 + CHASTE_MATH::Exp(CHASTE_CONST(3.0833333333333335) + CHASTE_CONST(0.041666666666666664) * var_chaste_interface__membrane_potential__V_m);
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(0.83333333333333337) - CHASTE_CONST(0.16666666666666666) * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 - CHASTE_MATH::Exp(-CHASTE_CONST(0.83333333333333337) - CHASTE_CONST(0.16666666666666666) * var_chaste_interface__membrane_potential__V_m);
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(3.8888888888888888) + CHASTE_CONST(0.1111111111111111) * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return CHASTE_CONST(0.59999999999999998) / (1 + CHASTE_MATH::Exp(CHASTE_CONST(2.5) - CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return CHASTE_CONST(0.02) + CHASTE_CONST(0.019699999999999999) * CHASTE_MATH::Exp(-CHASTE_CONST(0.23877882250000002) * CHASTE_MATH::Pow((1 + CHASTE_CONST(0.068965517241379309) * var_chaste_interface__membrane_potential__V_m), 2));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + CHASTE_MATH::Exp(-2 - CHASTE_CONST(0.20000000000000001) * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(0.26666666666666666) - CHASTE_CONST(0.070175438596491224) * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return CHASTE_CONST(0.00100999899000101) + CHASTE_CONST(0.00100999899000101) * CHASTE_MATH::Exp(-CHASTE_CONST(0.17252124645892353) - CHASTE_CONST(0.070821529745042494) * var_chaste_interface__membrane_potential__V_m);
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / CHASTE_MATH::Pow((1 + CHASTE_MATH::Exp(-CHASTE_CONST(6.2967884828349945) - CHASTE_CONST(0.11074197120708749) * var_chaste_interface__membrane_potential__V_m)), 2);
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return CHASTE_CONST(0.5) + CHASTE_CONST(8.5) * CHASTE_MATH::Exp(-CHASTE_CONST(0.81000000000000005) * CHASTE_MATH::Pow((1 + CHASTE_CONST(0.022222222222222223) * var_chaste_interface__membrane_potential__V_m), 2));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(3.8999999999999999) + CHASTE_CONST(0.20000000000000001) * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 7 + 85 * CHASTE_MATH::Exp(-CHASTE_CONST(7.2727272727272725) * CHASTE_MATH::Pow((1 + CHASTE_CONST(0.025000000000000001) * var_chaste_interface__membrane_potential__V_m), 2));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 30 + 800 / (1 + CHASTE_MATH::Exp(6 + CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
...
std::shared_ptr<Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables> Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 0) = CHASTE_CONST(5.3480000000000003e-6); // (var_SR_Fluxes__SR_leak_max) [per_msec]
        NV_Ith_S(this->mParameters, 1) = 25; // (var_parameters__ks) [per_msec]
        NV_Ith_S(this->mParameters, 2) = CHASTE_CONST(0.0053114); // (var_parameters__Vmax_SRCaP) [mM_per_msec]
        ...
        NV_Ith_S(this->mParameters, 5) = CHASTE_CONST(1.8); // (var_parameters__Cao) [mM]
        NV_Ith_S(this->mParameters, 6) = 150; // (var_parameters__Clo) [mM]
        NV_Ith_S(this->mParameters, 7) = CHASTE_CONST(5.4000000000000004); // (var_parameters__Ko) [mM]
        ...
        NV_Ith_S(this->mParameters, 11) = CHASTE_CONST(0.5); // (var_parameters__pCa_max) [cm_per_sec]
        ...
        NV_Ith_S(this->mParameters, 17) = CHASTE_CONST(0.34999999999999998); // (var_I_Ki__g_ki_factor) [mS_per_uF]
        NV_Ith_S(this->mParameters, 18) = CHASTE_CONST(0.035000000000000003); // (var_I_Kr__gkr_max) [mS_per_uF]
        ...
        NV_Ith_S(this->mParameters, 21) = CHASTE_CONST(4.5); // (var_parameters__IbarNCX) [uA_per_uF]
        NV_Ith_S(this->mParameters, 22) = CHASTE_CONST(1.8); // (var_parameters__IbarNaK) [uA_per_uF]
        NV_Ith_S(this->mParameters, 23) = CHASTE_CONST(1.3809999999999999e-10); // (var_parameters__Cmem) [farad]
    ...
    double Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? CHASTE_THIS(mFixedVoltage) : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_I_NaK__fnak = 1 / (1 + CHASTE_CONST(0.1245) * CHASTE_MATH::Exp(-CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT) + CHASTE_CONST(0.036499999999999998) * (-CHASTE_CONST(0.14285714285714285) + CHASTE_CONST(0.14285714285714285) * CHASTE_MATH::Exp(CHASTE_CONST(0.01485884101040119) * NV_Ith_S(mParameters, 8))) * CHASTE_MATH::Exp(-var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // dimensionless
        const double var_I_NaK__I_nak_junc = CHASTE_CONST(0.11) * var_I_NaK__fnak * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1 + 14641 / CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_j, 4)) * (CHASTE_CONST(1.5) + NV_Ith_S(mParameters, 7))); // uA_per_uF
        const double var_I_NaK__I_nak_sl = CHASTE_CONST(0.89000000000000001) * var_I_NaK__fnak * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1 + 14641 / CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_sl, 4)) * (CHASTE_CONST(1.5) + NV_Ith_S(mParameters, 7))); // uA_per_uF
        const double var_parameters__Qpow = -31 + CHASTE_CONST(0.10000000000000001) * NV_Ith_S(mParameters, 24); // dimensionless
        const double var_parameters__ecl = CHASTE_MATH::Log(NV_Ith_S(mParameters, 4) / NV_Ith_S(mParameters, 6)) / var_parameters__FoRT; // mV
        const double var_parameters__ek = CHASTE_MATH::Log(NV_Ith_S(mParameters, 7) / var_chaste_interface__K_Concentration__K_i) / var_parameters__FoRT; // mV
        const double var_parameters__ena_junc = CHASTE_MATH::Log(NV_Ith_S(mParameters, 8) / var_chaste_interface__Na_Concentrations__Na_j) / var_parameters__FoRT; // mV
        const double var_parameters__ena_sl = CHASTE_MATH::Log(NV_Ith_S(mParameters, 8) / var_chaste_interface__Na_Concentrations__Na_sl) / var_parameters__FoRT; // mV
        const double var_I_NCX__I_ncx_junc = CHASTE_CONST(0.11) * CHASTE_MATH::Pow(CHASTE_CONST(1.5700000000000001), var_parameters__Qpow) * (CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_j, 3) * NV_Ith_S(mParameters, 5) * CHASTE_MATH::Exp(CHASTE_CONST(0.27000000000000002) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT) - CHASTE_MATH::Pow(NV_Ith_S(mParameters, 8), 3) * var_chaste_interface__Ca_Concentrations__Ca_j * CHASTE_MATH::Exp(-CHASTE_CONST(0.72999999999999998) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * NV_Ith_S(mParameters, 21) / ((1 + CHASTE_CONST(0.32000000000000001) * CHASTE_MATH::Exp(-CHASTE_CONST(0.72999999999999998) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * (1 + CHASTE_CONST(2.2499999999999996e-8) / CHASTE_MATH::Pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2)) * (CHASTE_CONST(1.3) * CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_j, 3) + CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_j, 3) * NV_Ith_S(mParameters, 5) + CHASTE_MATH::Pow(NV_Ith_S(mParameters, 8), 3) * var_chaste_interface__Ca_Concentrations__Ca_j + CHASTE_CONST(669921.875) * (1 + CHASTE_CONST(278.55153203342621) * var_chaste_interface__Ca_Concentrations__Ca_j) * var_chaste_interface__Ca_Concentrations__Ca_j + CHASTE_CONST(0.0035899999999999999) * CHASTE_MATH::Pow(NV_Ith_S(mParameters, 8), 3) * (1 + CHASTE_CONST(0.00053869674493876331) * CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_j, 3)))); // uA_per_uF
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_I_Ca__d = CHASTE_CONST(0.035000000000000003) * (5 + var_chaste_interface__membrane_potential__V_m) * (-var_chaste_interface__I_Ca__d + var_I_Ca__dss) / ((_lt_0_row[3]) * var_I_Ca__dss); // 1 / msec
        ...
        const double var_I_NaK__I_nak_sl = CHASTE_CONST(0.89000000000000001) * var_I_NaK__fnak * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1 + 14641 / CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_sl, 4)) * (CHASTE_CONST(1.5) + NV_Ith_S(mParameters, 7))); // uA_per_uF
        const double var_parameters__Qpow = -31 + CHASTE_CONST(0.10000000000000001) * NV_Ith_S(mParameters, 24); // dimensionless
        const double var_parameters__Vcell = CHASTE_CONST(1.0506250000000001e-11) * CHASTE_CONST(CHASTE_MATH::Pi); // liter
        ...
        const double d_dt_chaste_interface_var_Na_Concentrations__Na_i = CHASTE_CONST(1.6385999999999999e-12) * (-var_chaste_interface__Na_Concentrations__Na_i + var_chaste_interface__Na_Concentrations__Na_sl) * NV_Ith_S(mParameters, 3) / var_parameters__Vmyo; // mM / msec
        ...
        const double var_SR_Fluxes__kCaSR = 15 - 14 / (1 + CHASTE_CONST(0.13584112963311223) * CHASTE_MATH::Pow((1 / var_chaste_interface__SR_Ca_Concentrations__Ca_sr), CHASTE_CONST(2.5))); // dimensionless
        const double var_parameters__ena_junc = CHASTE_MATH::Log(NV_Ith_S(mParameters, 8) / var_chaste_interface__Na_Concentrations__Na_j) / var_parameters__FoRT; // mV
        const double var_parameters__ena_sl = CHASTE_MATH::Log(NV_Ith_S(mParameters, 8) / var_chaste_interface__Na_Concentrations__Na_sl) / var_parameters__FoRT; // mV
        const double var_SR_Fluxes__J_serca = CHASTE_MATH::Pow(CHASTE_CONST(2.6000000000000001), var_parameters__Qpow) * (CHASTE_CONST(2814485.1633595936) * CHASTE_MATH::Pow(var_chaste_interface__Ca_Concentrations__Ca_i, CHASTE_CONST(1.7869999999999999)) - CHASTE_CONST(0.38742512113256738) * CHASTE_MATH::Pow(var_chaste_interface__SR_Ca_Concentrations__Ca_sr, CHASTE_CONST(1.7869999999999999))) * NV_Ith_S(mParameters, 2) / (1 + CHASTE_CONST(0.38742512113256738) * CHASTE_MATH::Pow(var_chaste_interface__SR_Ca_Concentrations__Ca_sr, CHASTE_CONST(1.7869999999999999)) + CHASTE_CONST(2814485.1633595936) * CHASTE_MATH::Pow(var_chaste_interface__Ca_Concentrations__Ca_i, CHASTE_CONST(1.7869999999999999))); // mM_per_msec
        const double var_SR_Fluxes__kiSRCa = CHASTE_CONST(0.5) * var_SR_Fluxes__kCaSR; // per_mM_per_msec
        const double var_SR_Fluxes__koSRCa = 10 / var_SR_Fluxes__kCaSR; // per_mM2_per_msec
        const double d_dt_chaste_interface_var_SR_Fluxes__Ry_Ri = -CHASTE_CONST(0.065000000000000002) * var_chaste_interface__SR_Fluxes__Ry_Ri + CHASTE_MATH::Pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2) * var_SR_Fluxes__RI * var_SR_Fluxes__koSRCa + var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Ro * var_SR_Fluxes__kiSRCa; // mM / msec
        const double d_dt_chaste_interface_var_SR_Fluxes__Ry_Ro = CHASTE_CONST(0.0050000000000000001) * var_chaste_interface__SR_Fluxes__Ry_Ri - CHASTE_CONST(0.059999999999999998) * var_chaste_interface__SR_Fluxes__Ry_Ro + CHASTE_MATH::Pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2) * var_chaste_interface__SR_Fluxes__Ry_Rr * var_SR_Fluxes__koSRCa - var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Ro * var_SR_Fluxes__kiSRCa; // mM / msec
        const double d_dt_chaste_interface_var_SR_Fluxes__Ry_Rr = CHASTE_CONST(0.059999999999999998) * var_chaste_interface__SR_Fluxes__Ry_Ro + CHASTE_CONST(0.0050000000000000001) * var_SR_Fluxes__RI - CHASTE_MATH::Pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2) * var_chaste_interface__SR_Fluxes__Ry_Rr * var_SR_Fluxes__koSRCa - var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Rr * var_SR_Fluxes__kiSRCa; // mM / msec
        const double d_dt_chaste_interface_var_Cytosolic_Ca_Buffers__CaM = -CHASTE_CONST(0.23799999999999999) * var_chaste_interface__Cytosolic_Ca_Buffers__CaM + 34 * (CHASTE_CONST(0.024) - var_chaste_interface__Cytosolic_Ca_Buffers__CaM) * var_chaste_interface__Ca_Concentrations__Ca_i; // mM / msec
        ...
        const double d_dt_chaste_interface_var_Cytosolic_Ca_Buffers__Myo_c = -CHASTE_CONST(0.00046000000000000001) * var_chaste_interface__Cytosolic_Ca_Buffers__Myo_c + CHASTE_CONST(13.800000000000001) * (CHASTE_CONST(0.14000000000000001) - var_chaste_interface__Cytosolic_Ca_Buffers__Myo_c - var_chaste_interface__Cytosolic_Ca_Buffers__Myo_m) * var_chaste_interface__Ca_Concentrations__Ca_i; // mM / msec
        const double d_dt_chaste_interface_var_Cytosolic_Ca_Buffers__Myo_m = CHASTE_CONST(0.0021979999999999999) - CHASTE_CONST(0.015699999999999999) * var_chaste_interface__Cytosolic_Ca_Buffers__Myo_c - CHASTE_CONST(0.015757) * var_chaste_interface__Cytosolic_Ca_Buffers__Myo_m; // mM / msec
        const double var_Na_Buffers__dNa_Bj_dt = -CHASTE_CONST(0.001) * var_chaste_interface__Na_Buffers__Na_Bj + CHASTE_CONST(0.0001) * (CHASTE_CONST(7.5609999999999999) - var_chaste_interface__Na_Buffers__Na_Bj) * var_chaste_interface__Na_Concentrations__Na_j; // mM_per_msec
        const double d_dt_chaste_interface_var_Na_Buffers__Na_Bj = var_Na_Buffers__dNa_Bj_dt; // mM / msec
        const double var_Na_Buffers__dNa_Bsl_dt = -CHASTE_CONST(0.001) * var_chaste_interface__Na_Buffers__Na_Bsl + CHASTE_CONST(0.0001) * (CHASTE_CONST(1.6499999999999999) - var_chaste_interface__Na_Buffers__Na_Bsl) * var_chaste_interface__Na_Concentrations__Na_sl; // mM_per_msec
        const double d_dt_chaste_interface_var_Na_Buffers__Na_Bsl = var_Na_Buffers__dNa_Bsl_dt; // mM / msec
        const double d_dt_chaste_interface_var_Junctional_and_SL_Ca_Buffers__SLH_j = -CHASTE_CONST(0.029999999999999999) * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_j + 100 * (-var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_j + var_parameters__Bmax_SLhighj) * var_chaste_interface__Ca_Concentrations__Ca_j; // mM / msec
        const double d_dt_chaste_interface_var_Junctional_and_SL_Ca_Buffers__SLH_sl = -CHASTE_CONST(0.029999999999999999) * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_sl + 100 * (-var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_sl + var_parameters__Bmax_SLhighsl) * var_chaste_interface__Ca_Concentrations__Ca_sl; // mM / msec
        const double d_dt_chaste_interface_var_Junctional_and_SL_Ca_Buffers__SLL_j = -CHASTE_CONST(1.3) * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_j + 100 * (-var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_j + var_parameters__Bmax_SLlowj) * var_chaste_interface__Ca_Concentrations__Ca_j; // mM / msec
        const double d_dt_chaste_interface_var_Junctional_and_SL_Ca_Buffers__SLL_sl = -CHASTE_CONST(1.3) * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_sl + 100 * (-var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_sl + var_parameters__Bmax_SLlowsl) * var_chaste_interface__Ca_Concentrations__Ca_sl; // mM / msec
        const double d_dt_chaste_interface_var_Cytosolic_Ca_Buffers__SRB = -CHASTE_CONST(0.059999999999999998) * var_chaste_interface__Cytosolic_Ca_Buffers__SRB + 100 * (CHASTE_CONST(0.017100000000000001) - var_chaste_interface__Cytosolic_Ca_Buffers__SRB) * var_chaste_interface__Ca_Concentrations__Ca_i; // mM / msec
        const double d_dt_chaste_interface_var_Cytosolic_Ca_Buffers__Tn_CHc = -CHASTE_CONST(3.1999999999999999e-5) * var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHc + CHASTE_CONST(2.3700000000000001) * (CHASTE_CONST(0.14000000000000001) - var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHc - var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHm) * var_chaste_interface__Ca_Concentrations__Ca_i; // mM / msec
        const double d_dt_chaste_interface_var_Cytosolic_Ca_Buffers__Tn_CHm = CHASTE_CONST(0.00042000000000000007) - CHASTE_CONST(0.0030000000000000001) * var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHc - CHASTE_CONST(0.0063300000000000006) * var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHm; // mM / msec
        const double d_dt_chaste_interface_var_Ca_Concentrations__Ca_i = -CHASTE_CONST(0.0026180000000000001) + CHASTE_CONST(0.23799999999999999) * var_chaste_interface__Cytosolic_Ca_Buffers__CaM + CHASTE_CONST(0.059999999999999998) * var_chaste_interface__Cytosolic_Ca_Buffers__SRB + CHASTE_CONST(0.019599999999999999) * var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CL + CHASTE_CONST(0.0063300000000000006) * var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHm + CHASTE_CONST(0.016159999999999997) * var_chaste_interface__Cytosolic_Ca_Buffers__Myo_c + CHASTE_CONST(0.003032) * var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHc + CHASTE_CONST(0.015757) * var_chaste_interface__Cytosolic_Ca_Buffers__Myo_m + CHASTE_CONST(3.2742999999999999e-12) * (-var_chaste_interface__Ca_Concentrations__Ca_i + var_chaste_interface__Ca_Concentrations__Ca_sl) / var_parameters__Vmyo - 34 * (CHASTE_CONST(0.024) - var_chaste_interface__Cytosolic_Ca_Buffers__CaM) * var_chaste_interface__Ca_Concentrations__Ca_i - 100 * (CHASTE_CONST(0.017100000000000001) - var_chaste_interface__Cytosolic_Ca_Buffers__SRB) * var_chaste_interface__Ca_Concentrations__Ca_i - CHASTE_CONST(32.700000000000003) * (CHASTE_CONST(0.070000000000000007) - var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CL) * var_chaste_interface__Ca_Concentrations__Ca_i - CHASTE_CONST(2.3700000000000001) * (CHASTE_CONST(0.14000000000000001) - var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHc - var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHm) * var_chaste_interface__Ca_Concentrations__Ca_i - CHASTE_CONST(13.800000000000001) * (CHASTE_CONST(0.14000000000000001) - var_chaste_interface__Cytosolic_Ca_Buffers__Myo_c - var_chaste_interface__Cytosolic_Ca_Buffers__Myo_m) * var_chaste_interface__Ca_Concentrations__Ca_i - var_SR_Fluxes__J_serca * var_parameters__Vsr / var_parameters__Vmyo; // mM / msec
        const double d_dt_chaste_interface_var_Cytosolic_Ca_Buffers__Tn_CL = -CHASTE_CONST(0.019599999999999999) * var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CL + CHASTE_CONST(32.700000000000003) * (CHASTE_CONST(0.070000000000000007) - var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CL) * var_chaste_interface__Ca_Concentrations__Ca_i; // mM / msec
        ...
        const double var_I_NCX__I_ncx_sl = CHASTE_CONST(0.89000000000000001) * CHASTE_MATH::Pow(CHASTE_CONST(1.5700000000000001), var_parameters__Qpow) * (CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_sl, 3) * NV_Ith_S(mParameters, 5) * CHASTE_MATH::Exp(CHASTE_CONST(0.27000000000000002) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT) - CHASTE_MATH::Pow(NV_Ith_S(mParameters, 8), 3) * var_chaste_interface__Ca_Concentrations__Ca_sl * CHASTE_MATH::Exp(-CHASTE_CONST(0.72999999999999998) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * NV_Ith_S(mParameters, 21) / ((1 + CHASTE_CONST(0.32000000000000001) * CHASTE_MATH::Exp(-CHASTE_CONST(0.72999999999999998) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * (1 + CHASTE_CONST(2.2499999999999996e-8) / CHASTE_MATH::Pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2)) * (CHASTE_CONST(1.3) * CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_sl, 3) + CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_sl, 3) * NV_Ith_S(mParameters, 5) + CHASTE_MATH::Pow(NV_Ith_S(mParameters, 8), 3) * var_chaste_interface__Ca_Concentrations__Ca_sl + CHASTE_CONST(669921.875) * (1 + CHASTE_CONST(278.55153203342621) * var_chaste_interface__Ca_Concentrations__Ca_sl) * var_chaste_interface__Ca_Concentrations__Ca_sl + CHASTE_CONST(0.0035899999999999999) * CHASTE_MATH::Pow(NV_Ith_S(mParameters, 8), 3) * (1 + CHASTE_CONST(0.00053869674493876331) * CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_sl, 3)))); // uA_per_uF
        const double var_parameters__pCa = CHASTE_CONST(0.00054000000000000001) * NV_Ith_S(mParameters, 11); // cm_per_sec
        const double var_Ca_Concentrations__I_Ca_tot_junc = CHASTE_CONST(6.0643000000000002e-5) * var_chaste_interface__membrane_potential__V_m - 2 * var_I_NCX__I_ncx_junc - CHASTE_CONST(3.0321500000000001e-5) * CHASTE_MATH::Log(NV_Ith_S(mParameters, 5) / var_chaste_interface__Ca_Concentrations__Ca_j) / var_parameters__FoRT + CHASTE_CONST(0.0074029999999999999) * CHASTE_MATH::Pow(CHASTE_CONST(2.3500000000000001), var_parameters__Qpow) * CHASTE_MATH::Pow(var_chaste_interface__Ca_Concentrations__Ca_j, CHASTE_CONST(1.6000000000000001)) / (CHASTE_CONST(5.2281977629563632e-6) + CHASTE_MATH::Pow(var_chaste_interface__Ca_Concentrations__Ca_j, CHASTE_CONST(1.6000000000000001))) + CHASTE_CONST(1.6200000000000001) * CHASTE_MATH::Pow(CHASTE_CONST(1.8), var_parameters__Qpow) * (-CHASTE_CONST(0.34100000000000003) * NV_Ith_S(mParameters, 5) + CHASTE_CONST(0.34100000000000003) * var_chaste_interface__Ca_Concentrations__Ca_j * CHASTE_MATH::Exp(2 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * (1 - var_chaste_interface__I_Ca__f_Ca_Bj + var_I_Ca__fcaCaj) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * NV_Ith_S(mParameters, 9) * var_parameters__pCa / (-1 + CHASTE_MATH::Exp(2 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // uA_per_uF
        const double d_dt_chaste_interface_var_Ca_Concentrations__Ca_j = CHASTE_CONST(0.029999999999999999) * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_j + CHASTE_CONST(1.3) * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_j + CHASTE_CONST(8.2413000000000004e-13) * (-var_chaste_interface__Ca_Concentrations__Ca_j + var_chaste_interface__Ca_Concentrations__Ca_sl) / var_parameters__Vjunc - 100 * (-var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_j + var_parameters__Bmax_SLhighj) * var_chaste_interface__Ca_Concentrations__Ca_j - 100 * (-var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_j + var_parameters__Bmax_SLlowj) * var_chaste_interface__Ca_Concentrations__Ca_j + var_SR_Fluxes__J_SRCarel * var_parameters__Vsr / var_parameters__Vjunc + var_SR_Fluxes__J_SRleak * var_parameters__Vmyo / var_parameters__Vjunc - CHASTE_CONST(0.5) * var_Ca_Concentrations__I_Ca_tot_junc * NV_Ith_S(mParameters, 23) / (NV_Ith_S(mParameters, 9) * var_parameters__Vjunc); // mM / msec
        const double var_Ca_Concentrations__I_Ca_tot_sl = CHASTE_CONST(0.00049065700000000003) * var_chaste_interface__membrane_potential__V_m - 2 * var_I_NCX__I_ncx_sl - CHASTE_CONST(0.00024532850000000001) * CHASTE_MATH::Log(NV_Ith_S(mParameters, 5) / var_chaste_interface__Ca_Concentrations__Ca_sl) / var_parameters__FoRT + CHASTE_CONST(0.059896999999999999) * CHASTE_MATH::Pow(CHASTE_CONST(2.3500000000000001), var_parameters__Qpow) * CHASTE_MATH::Pow(var_chaste_interface__Ca_Concentrations__Ca_sl, CHASTE_CONST(1.6000000000000001)) / (CHASTE_CONST(5.2281977629563632e-6) + CHASTE_MATH::Pow(var_chaste_interface__Ca_Concentrations__Ca_sl, CHASTE_CONST(1.6000000000000001))) + CHASTE_CONST(0.17999999999999997) * CHASTE_MATH::Pow(CHASTE_CONST(1.8), var_parameters__Qpow) * (-CHASTE_CONST(0.34100000000000003) * NV_Ith_S(mParameters, 5) + CHASTE_CONST(0.34100000000000003) * var_chaste_interface__Ca_Concentrations__Ca_sl * CHASTE_MATH::Exp(2 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * (1 - var_chaste_interface__I_Ca__f_Ca_Bsl + var_I_Ca__fcaCaMSL) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * NV_Ith_S(mParameters, 9) * var_parameters__pCa / (-1 + CHASTE_MATH::Exp(2 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // uA_per_uF
        const double d_dt_chaste_interface_var_Ca_Concentrations__Ca_sl = CHASTE_CONST(0.029999999999999999) * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_sl + CHASTE_CONST(1.3) * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_sl + CHASTE_CONST(8.2413000000000004e-13) * (-var_chaste_interface__Ca_Concentrations__Ca_sl + var_chaste_interface__Ca_Concentrations__Ca_j) / var_parameters__Vsl + CHASTE_CONST(3.2742999999999999e-12) * (-var_chaste_interface__Ca_Concentrations__Ca_sl + var_chaste_interface__Ca_Concentrations__Ca_i) / var_parameters__Vsl - 100 * (-var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_sl + var_parameters__Bmax_SLhighsl) * var_chaste_interface__Ca_Concentrations__Ca_sl - 100 * (-var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_sl + var_parameters__Bmax_SLlowsl) * var_chaste_interface__Ca_Concentrations__Ca_sl - CHASTE_CONST(0.5) * var_Ca_Concentrations__I_Ca_tot_sl * NV_Ith_S(mParameters, 23) / (NV_Ith_S(mParameters, 9) * var_parameters__Vsl); // mM / msec
        const double var_Na_Concentrations__I_Na_tot_junc = 3 * var_I_NCX__I_ncx_junc + 3 * var_I_NaK__I_nak_junc + CHASTE_CONST(6.567e-5) * var_chaste_interface__membrane_potential__V_m - CHASTE_CONST(6.567e-5) * var_parameters__ena_junc + CHASTE_CONST(0.11) * CHASTE_MATH::Pow(var_chaste_interface__I_Na__m, 3) * (-var_parameters__ena_junc + var_chaste_interface__membrane_potential__V_m) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * NV_Ith_S(mParameters, 13) + CHASTE_CONST(3.0374999999999999e-9) * CHASTE_MATH::Pow(CHASTE_CONST(1.8), var_parameters__Qpow) * (-CHASTE_CONST(0.75) * NV_Ith_S(mParameters, 8) + CHASTE_CONST(0.75) * var_chaste_interface__Na_Concentrations__Na_j * CHASTE_MATH::Exp(var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * (1 - var_chaste_interface__I_Ca__f_Ca_Bj + var_I_Ca__fcaCaj) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * NV_Ith_S(mParameters, 9) / (-1 + CHASTE_MATH::Exp(var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // uA_per_uF
        const double d_dt_chaste_interface_var_Na_Concentrations__Na_j = (-var_Na_Buffers__dNa_Bj_dt + CHASTE_CONST(1.8312999999999999e-14) * (-var_chaste_interface__Na_Concentrations__Na_j + var_chaste_interface__Na_Concentrations__Na_sl) / var_parameters__Vjunc - var_Na_Concentrations__I_Na_tot_junc * NV_Ith_S(mParameters, 23) / (NV_Ith_S(mParameters, 9) * var_parameters__Vjunc)) * NV_Ith_S(mParameters, 3); // mM / msec
        const double var_Na_Concentrations__I_Na_tot_sl = 3 * var_I_NCX__I_ncx_sl + 3 * var_I_NaK__I_nak_sl + CHASTE_CONST(0.00053133) * var_chaste_interface__membrane_potential__V_m - CHASTE_CONST(0.00053133) * var_parameters__ena_sl + CHASTE_CONST(0.89000000000000001) * CHASTE_MATH::Pow(var_chaste_interface__I_Na__m, 3) * (-var_parameters__ena_sl + var_chaste_interface__membrane_potential__V_m) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * NV_Ith_S(mParameters, 13) + CHASTE_CONST(3.3749999999999992e-10) * CHASTE_MATH::Pow(CHASTE_CONST(1.8), var_parameters__Qpow) * (-CHASTE_CONST(0.75) * NV_Ith_S(mParameters, 8) + CHASTE_CONST(0.75) * var_chaste_interface__Na_Concentrations__Na_sl * CHASTE_MATH::Exp(var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * (1 - var_chaste_interface__I_Ca__f_Ca_Bsl + var_I_Ca__fcaCaMSL) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * NV_Ith_S(mParameters, 9) / (-1 + CHASTE_MATH::Exp(var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // uA_per_uF
        const double d_dt_chaste_interface_var_Na_Concentrations__Na_sl = (-var_Na_Buffers__dNa_Bsl_dt + CHASTE_CONST(1.6385999999999999e-12) * (-var_chaste_interface__Na_Concentrations__Na_sl + var_chaste_interface__Na_Concentrations__Na_i) / var_parameters__Vsl + CHASTE_CONST(1.8312999999999999e-14) * (-var_chaste_interface__Na_Concentrations__Na_sl + var_chaste_interface__Na_Concentrations__Na_j) / var_parameters__Vsl - var_Na_Concentrations__I_Na_tot_sl * NV_Ith_S(mParameters, 23) / (NV_Ith_S(mParameters, 9) * var_parameters__Vsl)) * NV_Ith_S(mParameters, 3); // mM / msec
...
// LCOV_EXCL_STOP
        ...
        const double var_I_Na__ah = ((var_chaste_interface__membrane_potential__V_m >= -40) ? (0) : (CHASTE_CONST(0.057000000000000002) * CHASTE_MATH::Exp(-CHASTE_CONST(11.764705882352942) + CHASTE_CONST(0.14705882352941177) * NV_Ith_S(mParameters, 15) - CHASTE_CONST(0.14705882352941177) * var_chaste_interface__membrane_potential__V_m))); // dimensionless
        ...
        const double var_I_Na__bj = ((var_chaste_interface__membrane_potential__V_m >= -40) ? (CHASTE_CONST(0.59999999999999998) * CHASTE_MATH::Exp(CHASTE_CONST(0.057000000000000002) * var_chaste_interface__membrane_potential__V_m - CHASTE_CONST(0.057000000000000002) * NV_Ith_S(mParameters, 15)) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(3.2000000000000002) + CHASTE_CONST(0.10000000000000001) * NV_Ith_S(mParameters, 15) - CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane_potential__V_m))) : (CHASTE_CONST(0.024240000000000001) * CHASTE_MATH::Exp(CHASTE_CONST(0.01052) * NV_Ith_S(mParameters, 15) - CHASTE_CONST(0.01052) * var_chaste_interface__membrane_potential__V_m) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(5.5312920000000005) + CHASTE_CONST(0.13780000000000001) * NV_Ith_S(mParameters, 15) - CHASTE_CONST(0.13780000000000001) * var_chaste_interface__membrane_potential__V_m)))); // dimensionless
        ...
        if (mDataClampIsOn)
        {
            var_chaste_interface__membrane_data_clamp_current = (-CHASTE_EXP_VOLT(var_chaste_interface__environment__time) + var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 12); // uA_per_cm2
        }
        ...
        const double var_I_Ki__g_K1 = CHASTE_CONST(0.43033148291193518) * CHASTE_MATH::Sqrt(NV_Ith_S(mParameters, 7)) * NV_Ith_S(mParameters, 17); // mS_per_uF
        const double var_I_Kr__gkr = CHASTE_CONST(0.43033148291193518) * CHASTE_MATH::Sqrt(NV_Ith_S(mParameters, 7)) * NV_Ith_S(mParameters, 18); // mS_per_uF
        ...
        const double var_I_NaK__sigma = -CHASTE_CONST(0.14285714285714285) + CHASTE_CONST(0.14285714285714285) * CHASTE_MATH::Exp(CHASTE_CONST(0.01485884101040119) * NV_Ith_S(mParameters, 8)); // dimensionless
        ...
        const double var_I_NaK__I_nak_junc = var_I_NaK__fnak * var_parameters__Fjunc * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1 + CHASTE_MATH::Pow(var_parameters__KmNaip, 4) / CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_j, 4)) * (var_parameters__KmKo + NV_Ith_S(mParameters, 7))); // uA_per_uF
        const double var_I_NaK__I_nak_sl = var_I_NaK__fnak * var_parameters__Fsl * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1 + CHASTE_MATH::Pow(var_parameters__KmNaip, 4) / CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_sl, 4)) * (var_parameters__KmKo + NV_Ith_S(mParameters, 7))); // uA_per_uF
        ...
        const double var_parameters__ena_junc = CHASTE_MATH::Log(NV_Ith_S(mParameters, 8) / var_chaste_interface__Na_Concentrations__Na_j) / var_parameters__FoRT; // mV
        const double var_I_Na__I_Na_junc = CHASTE_MATH::Pow(var_chaste_interface__I_Na__m, 3) * (-var_parameters__ena_junc + var_chaste_interface__membrane_potential__V_m) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * var_parameters__Fjunc * NV_Ith_S(mParameters, 13); // uA_per_uF
        const double var_parameters__ena_sl = CHASTE_MATH::Log(NV_Ith_S(mParameters, 8) / var_chaste_interface__Na_Concentrations__Na_sl) / var_parameters__FoRT; // mV
        const double var_I_Na__I_Na_sl = CHASTE_MATH::Pow(var_chaste_interface__I_Na__m, 3) * (-var_parameters__ena_sl + var_chaste_interface__membrane_potential__V_m) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * var_parameters__Fsl * NV_Ith_S(mParameters, 13); // uA_per_uF
        ...
        const double var_I_to__GtoFast = ((var_parameters__epi == 1) ? (CHASTE_CONST(0.1144) * NV_Ith_S(mParameters, 16)) : (CHASTE_CONST(0.0014039999999999999) * NV_Ith_S(mParameters, 16))); // mS_per_uF
        const double var_I_to__GtoSlow = ((var_parameters__epi == 1) ? (CHASTE_CONST(0.015599999999999999) * NV_Ith_S(mParameters, 20)) : (CHASTE_CONST(0.037595999999999997) * NV_Ith_S(mParameters, 20))); // mS_per_uF
        ...
        const double var_I_NCX__s1_junc = CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_j, 3) * NV_Ith_S(mParameters, 5) * CHASTE_MATH::Exp(var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * var_parameters__nu); // mM4
        const double var_I_NCX__s1_sl = CHASTE_MATH::Pow(var_chaste_interface__Na_Concentrations__Na_sl, 3) * NV_Ith_S(mParameters, 5) * CHASTE_MATH::Exp(var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * var_parameters__nu); // mM4
        const double var_I_NCX__s2_junc = CHASTE_MATH::Pow(NV_Ith_S(mParameters, 8), 3) * var_chaste_interface__Ca_Concentrations__Ca_j * CHASTE_MATH::Exp((-1 + var_parameters__nu) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT); // mM4
        const double var_I_NCX__I_ncx_junc = CHASTE_MATH::Pow(var_parameters__Q10NCX, var_parameters__Qpow) * (-var_I_NCX__s2_junc + var_I_NCX__s1_junc) * var_I_NCX__Ka_junc * var_parameters__Fjunc * NV_Ith_S(mParameters, 21) / ((1 + var_parameters__ksat * CHASTE_MATH::Exp((-1 + var_parameters__nu) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * var_I_NCX__s3_junc); // uA_per_uF
        const double var_I_NCX__s2_sl = CHASTE_MATH::Pow(NV_Ith_S(mParameters, 8), 3) * var_chaste_interface__Ca_Concentrations__Ca_sl * CHASTE_MATH::Exp((-1 + var_parameters__nu) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT); // mM4
        ...
        const double var_I_Ks__eks = CHASTE_MATH::Log((NV_Ith_S(mParameters, 8) * var_parameters__pNaK + NV_Ith_S(mParameters, 7)) / (var_chaste_interface__Na_Concentrations__Na_i * var_parameters__pNaK + var_chaste_interface__K_Concentration__K_i)) / var_parameters__FoRT; // mV
