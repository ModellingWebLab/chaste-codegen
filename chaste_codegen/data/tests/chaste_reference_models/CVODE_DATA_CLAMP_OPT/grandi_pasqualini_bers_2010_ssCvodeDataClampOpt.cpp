...
bool Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt::s_registered = ModelFactory::Register("grandi_pasqualini_bers_2010_ssCvodeDataClampOpt", "CvodeCellWithDataClampOpt", (ModelFactory::TCreateMethod)Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt::CreateMethod);
...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1.0 - exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane_potential__V_m);
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
