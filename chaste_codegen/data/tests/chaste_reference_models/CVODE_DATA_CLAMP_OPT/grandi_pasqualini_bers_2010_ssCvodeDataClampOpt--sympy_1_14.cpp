...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + exp(3.0833333333333335 + 0.041666666666666664 * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 0.02 + 0.019699999999999999 * exp(-pow((0.48865000000000003 + 0.033700000000000001 * var_chaste_interface__membrane_potential__V_m), 2));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (230 / (1 + exp(2 + 0.050000000000000003 * var_chaste_interface__membrane_potential__V_m)) + 3300 / ((1 + exp(1.2222222222222223 + 0.1111111111111111 * var_chaste_interface__membrane_potential__V_m)) * (1 + exp(-2.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane_potential__V_m))));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (0.12920000000000001 * exp(-pow((2.9465894465894467 + 0.064350064350064351 * var_chaste_interface__membrane_potential__V_m), 2)) + 0.064869999999999997 * exp(-pow((-0.094346635367762138 + 0.019561815336463225 * var_chaste_interface__membrane_potential__V_m), 2)));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (0.5 + 8.5 * exp(-pow((0.90000000000000002 + 0.02 * var_chaste_interface__membrane_potential__V_m), 2)));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (0.5 + 9 / (1 + exp(0.20000000000000001 + 0.066666666666666666 * var_chaste_interface__membrane_potential__V_m)));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (7 + 85 * exp(-0.0045454545454545452 * pow((40 + var_chaste_interface__membrane_potential__V_m), 2)));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (30 + 800 / (1 + exp(6 + 0.10000000000000001 * var_chaste_interface__membrane_potential__V_m)));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_I_Ca__d = 0.035000000000000003 * _lt_0_row[3] * (5 + var_chaste_interface__membrane_potential__V_m) * (-var_chaste_interface__I_Ca__d + var_I_Ca__dss) / var_I_Ca__dss; // 1 / msec
        const double d_dt_chaste_interface_var_I_Ca__f = (_lt_0_row[6]) * (-var_chaste_interface__I_Ca__f + _lt_0_row[4] + _lt_0_row[5]); // 1 / msec
        const double d_dt_chaste_interface_var_I_Kr__x_kr = _lt_0_row[8] * (-var_chaste_interface__I_Kr__x_kr + _lt_0_row[7]); // 1 / msec
        ...
        const double d_dt_chaste_interface_var_I_Na__m = _lt_0_row[12] * (-var_chaste_interface__I_Na__m + _lt_0_row[11]); // 1 / msec
        const double var_I_to__xtoss = _lt_0_row[13]; // dimensionless
        const double d_dt_chaste_interface_var_I_to__x_to_f = _lt_0_row[14] * (-var_chaste_interface__I_to__x_to_f + var_I_to__xtoss); // 1 / msec
        const double d_dt_chaste_interface_var_I_to__x_to_s = _lt_0_row[15] * (-var_chaste_interface__I_to__x_to_s + var_I_to__xtoss); // 1 / msec
        const double var_I_to__ytoss = _lt_0_row[16]; // dimensionless
        const double d_dt_chaste_interface_var_I_to__y_to_f = _lt_0_row[17] * (-var_chaste_interface__I_to__y_to_f + var_I_to__ytoss); // 1 / msec
        const double d_dt_chaste_interface_var_I_to__y_to_s = _lt_0_row[18] * (-var_chaste_interface__I_to__y_to_s + var_I_to__ytoss); // 1 / msec
        const double var_parameters__FoRT = NV_Ith_S(mParameters, 9) / (NV_Ith_S(mParameters, 10) * NV_Ith_S(mParameters, 24)); // per_mV
        const double var_I_NaK__fnak = 1 / (1 + 0.1245 * exp(-0.10000000000000001 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * NV_Ith_S(mParameters, 8))) * exp(-var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // dimensionless
        const double var_I_NaK__I_nak_junc = 0.11 * var_I_NaK__fnak * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1 + 14641 / pow(var_chaste_interface__Na_Concentrations__Na_j, 4)) * (1.5 + NV_Ith_S(mParameters, 7))); // uA_per_uF
        const double var_I_NaK__I_nak_sl = 0.89000000000000001 * var_I_NaK__fnak * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1 + 14641 / pow(var_chaste_interface__Na_Concentrations__Na_sl, 4)) * (1.5 + NV_Ith_S(mParameters, 7))); // uA_per_uF
...
// LCOV_EXCL_STOP
        ...
        const double var_I_Kr__rkr = _lt_0_row[1]; // dimensionless
