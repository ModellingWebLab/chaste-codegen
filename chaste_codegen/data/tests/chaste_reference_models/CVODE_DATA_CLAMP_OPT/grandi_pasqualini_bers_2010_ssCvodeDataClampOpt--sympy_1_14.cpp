...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 0.12920000000000001 * exp(-pow((2.9465894465894467 + 0.064350064350064351 * var_chaste_interface__membrane_potential__V_m), 2)) + 0.064869999999999997 * exp(-pow((-0.094346635367762138 + 0.019561815336463225 * var_chaste_interface__membrane_potential__V_m), 2));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 0.5 + 8.5 * exp(-pow((0.90000000000000002 + 0.02 * var_chaste_interface__membrane_potential__V_m), 2));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 7 + 85 * exp(-0.0045454545454545452 * pow((40 + var_chaste_interface__membrane_potential__V_m), 2));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
