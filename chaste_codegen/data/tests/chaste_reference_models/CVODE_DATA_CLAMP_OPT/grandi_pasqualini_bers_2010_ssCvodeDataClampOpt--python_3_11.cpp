...
#include "grandi_pasqualini_bers_2010_ssCvodeDataClampOpt.hpp"
#include <cmath>
#include <cfloat>
#include <cassert>
#include <memory>
...
{
public:
    static Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane_potential__V_m)
    {
        ...
        const double* const _lt_0_row = Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
protected:
    Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables(const Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables& operator= (const Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables&);
    Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables()
    {
        ...
        Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables::RegenerateTables();
    }
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + exp(7.4880000000000004 - 0.16722408026755853 * var_chaste_interface__membrane_potential__V_m));
                };
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 + exp(3.0833333333333335 + 0.041666666666666664 * var_chaste_interface__membrane_potential__V_m);
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 - exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane_potential__V_m);
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + exp(3.8888888888888888 + 0.1111111111111111 * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 0.59999999999999998 / (1 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + exp(-2 - 0.20000000000000001 * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 230 / (1 + exp(2 + 0.050000000000000003 * var_chaste_interface__membrane_potential__V_m)) + 3300 / ((1 + exp(1.2222222222222223 + 0.1111111111111111 * var_chaste_interface__membrane_potential__V_m)) * (1 + exp(-2.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane_potential__V_m)));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / pow((1 + exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane_potential__V_m)), 2);
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 0.5 + 9 / (1 + exp(0.20000000000000001 + 0.066666666666666666 * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 1 / (1 + exp(3.8999999999999999 + 0.20000000000000001 * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 7 + 85 * exp(-7.2727272727272725 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane_potential__V_m), 2));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
            ...
            {
                auto f = [](double var_chaste_interface__membrane_potential__V_m) {
                    return 30 + 800 / (1 + exp(6 + 0.10000000000000001 * var_chaste_interface__membrane_potential__V_m));
                };
                const double var_chaste_interface__membrane_potential__V_m = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane_potential__V_m);
...
private:
    ...
    static std::shared_ptr<Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables> mpInstance;
...
std::shared_ptr<Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables> Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt::Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt>::Instance();
        Init();
        ...
        NV_Ith_S(this->mParameters, 1) = 25; // (var_parameters__ks) [per_msec]
        NV_Ith_S(this->mParameters, 2) = 0.0053114; // (var_parameters__Vmax_SRCaP) [mM_per_msec]
        NV_Ith_S(this->mParameters, 3) = 1; // (var_Na_Concentrations__conc_clamp) [dimensionless]
        NV_Ith_S(this->mParameters, 4) = 15; // (var_parameters__Cli) [mM]
        NV_Ith_S(this->mParameters, 5) = 1.8; // (var_parameters__Cao) [mM]
        NV_Ith_S(this->mParameters, 6) = 150; // (var_parameters__Clo) [mM]
        NV_Ith_S(this->mParameters, 7) = 5.4000000000000004; // (var_parameters__Ko) [mM]
        NV_Ith_S(this->mParameters, 8) = 140; // (var_parameters__Nao) [mM]
        NV_Ith_S(this->mParameters, 9) = 96485; // (var_parameters__Frdy) [coulomb_per_mole]
        NV_Ith_S(this->mParameters, 10) = 8314; // (var_parameters__R) [joule_per_kelvin_per_kilomole]
        NV_Ith_S(this->mParameters, 11) = 0.5; // (var_parameters__pCa_max) [cm_per_sec]
        NV_Ith_S(this->mParameters, 12) = 0; // (var_membrane_data_clamp_current_conductance) [dimensionless]
        NV_Ith_S(this->mParameters, 13) = 23; // (var_parameters__GNa) [mS_per_uF]
        NV_Ith_S(this->mParameters, 14) = 0; // (var_I_Na__perc_reduced_inact_for_IpNa) [dimensionless]
        NV_Ith_S(this->mParameters, 15) = 0; // (var_I_Na__shift_INa_inact) [mV]
        NV_Ith_S(this->mParameters, 16) = 1; // (var_I_to__GtoFast_factor) [dimensionless]
        NV_Ith_S(this->mParameters, 17) = 0.34999999999999998; // (var_I_Ki__g_ki_factor) [mS_per_uF]
        NV_Ith_S(this->mParameters, 18) = 0.035000000000000003; // (var_I_Kr__gkr_max) [mS_per_uF]
        NV_Ith_S(this->mParameters, 19) = 1; // (var_I_Ks__GKs_factor) [dimensionless]
        NV_Ith_S(this->mParameters, 20) = 1; // (var_I_to__GtoSlow_factor) [dimensionless]
        NV_Ith_S(this->mParameters, 21) = 4.5; // (var_parameters__IbarNCX) [uA_per_uF]
        NV_Ith_S(this->mParameters, 22) = 1.8; // (var_parameters__IbarNaK) [uA_per_uF]
        NV_Ith_S(this->mParameters, 23) = 1.3809999999999999e-10; // (var_parameters__Cmem) [farad]
        NV_Ith_S(this->mParameters, 24) = 310; // (var_parameters__Temp) [kelvin]
    }

    Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt::~Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt()
    {
    }

    AbstractLookupTableCollection* Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt::GetLookupTableCollection()
    {
        return Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables::Instance();
    }

    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt::VerifyStateVariables()
    {
    ...
    double Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane_potential__V_m);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane_potential__V_m);
        ...
        const double var_parameters__FoRT = NV_Ith_S(mParameters, 9) / (NV_Ith_S(mParameters, 10) * NV_Ith_S(mParameters, 24)); // per_mV
        const double var_I_NaK__fnak = 1 / (1 + 0.1245 * exp(-0.10000000000000001 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * NV_Ith_S(mParameters, 8))) * exp(-var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // dimensionless
        const double var_I_NaK__I_nak_junc = 0.11 * var_I_NaK__fnak * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1 + 14641 / pow(var_chaste_interface__Na_Concentrations__Na_j, 4)) * (1.5 + NV_Ith_S(mParameters, 7))); // uA_per_uF
        const double var_I_NaK__I_nak_sl = 0.89000000000000001 * var_I_NaK__fnak * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1 + 14641 / pow(var_chaste_interface__Na_Concentrations__Na_sl, 4)) * (1.5 + NV_Ith_S(mParameters, 7))); // uA_per_uF
        const double var_parameters__Qpow = -31 + 0.10000000000000001 * NV_Ith_S(mParameters, 24); // dimensionless
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double d_dt_chaste_interface_var_I_Ca__d = 0.035000000000000003 * (5 + var_chaste_interface__membrane_potential__V_m) * (-var_chaste_interface__I_Ca__d + var_I_Ca__dss) / ((_lt_0_row[3]) * var_I_Ca__dss); // 1 / msec
        ...
        const double var_SR_Fluxes__kCaSR = 15 - 14 / (1 + 0.13584112963311223 * pow((1 / var_chaste_interface__SR_Ca_Concentrations__Ca_sr), 2.5)); // dimensionless
        const double var_parameters__ena_junc = log(NV_Ith_S(mParameters, 8) / var_chaste_interface__Na_Concentrations__Na_j) / var_parameters__FoRT; // mV
        const double var_parameters__ena_sl = log(NV_Ith_S(mParameters, 8) / var_chaste_interface__Na_Concentrations__Na_sl) / var_parameters__FoRT; // mV
        ...
        const double var_SR_Fluxes__koSRCa = 10 / var_SR_Fluxes__kCaSR; // per_mM2_per_msec
        ...
        const double d_dt_chaste_interface_var_Cytosolic_Ca_Buffers__CaM = -0.23799999999999999 * var_chaste_interface__Cytosolic_Ca_Buffers__CaM + 34 * (0.024 - var_chaste_interface__Cytosolic_Ca_Buffers__CaM) * var_chaste_interface__Ca_Concentrations__Ca_i; // mM / msec
        const double d_dt_chaste_interface_var_SR_Ca_Concentrations__Csqn_b = -65 * var_chaste_interface__SR_Ca_Concentrations__Csqn_b + 100 * (-var_chaste_interface__SR_Ca_Concentrations__Csqn_b + var_parameters__Bmax_Csqn) * var_chaste_interface__SR_Ca_Concentrations__Ca_sr; // mM / msec
        ...
        const double d_dt_chaste_interface_var_Junctional_and_SL_Ca_Buffers__SLH_j = -0.029999999999999999 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_j + 100 * (-var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_j + var_parameters__Bmax_SLhighj) * var_chaste_interface__Ca_Concentrations__Ca_j; // mM / msec
        const double d_dt_chaste_interface_var_Junctional_and_SL_Ca_Buffers__SLH_sl = -0.029999999999999999 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_sl + 100 * (-var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_sl + var_parameters__Bmax_SLhighsl) * var_chaste_interface__Ca_Concentrations__Ca_sl; // mM / msec
        const double d_dt_chaste_interface_var_Junctional_and_SL_Ca_Buffers__SLL_j = -1.3 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_j + 100 * (-var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_j + var_parameters__Bmax_SLlowj) * var_chaste_interface__Ca_Concentrations__Ca_j; // mM / msec
        const double d_dt_chaste_interface_var_Junctional_and_SL_Ca_Buffers__SLL_sl = -1.3 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_sl + 100 * (-var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_sl + var_parameters__Bmax_SLlowsl) * var_chaste_interface__Ca_Concentrations__Ca_sl; // mM / msec
        const double d_dt_chaste_interface_var_Cytosolic_Ca_Buffers__SRB = -0.059999999999999998 * var_chaste_interface__Cytosolic_Ca_Buffers__SRB + 100 * (0.017100000000000001 - var_chaste_interface__Cytosolic_Ca_Buffers__SRB) * var_chaste_interface__Ca_Concentrations__Ca_i; // mM / msec
        ...
        const double var_Na_Concentrations__I_Na_tot_junc = 3 * var_I_NCX__I_ncx_junc + 3 * var_I_NaK__I_nak_junc + 6.567e-5 * var_chaste_interface__membrane_potential__V_m - 6.567e-5 * var_parameters__ena_junc + 0.11 * pow(var_chaste_interface__I_Na__m, 3) * (-var_parameters__ena_junc + var_chaste_interface__membrane_potential__V_m) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * NV_Ith_S(mParameters, 13) + 3.0374999999999999e-9 * pow(1.8, var_parameters__Qpow) * (-0.75 * NV_Ith_S(mParameters, 8) + 0.75 * var_chaste_interface__Na_Concentrations__Na_j * exp(var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * (1 - var_chaste_interface__I_Ca__f_Ca_Bj + var_I_Ca__fcaCaj) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * NV_Ith_S(mParameters, 9) / (-1 + exp(var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // uA_per_uF
        ...
        const double var_Na_Concentrations__I_Na_tot_sl = 3 * var_I_NCX__I_ncx_sl + 3 * var_I_NaK__I_nak_sl + 0.00053133 * var_chaste_interface__membrane_potential__V_m - 0.00053133 * var_parameters__ena_sl + 0.89000000000000001 * pow(var_chaste_interface__I_Na__m, 3) * (-var_parameters__ena_sl + var_chaste_interface__membrane_potential__V_m) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * NV_Ith_S(mParameters, 13) + 3.3749999999999992e-10 * pow(1.8, var_parameters__Qpow) * (-0.75 * NV_Ith_S(mParameters, 8) + 0.75 * var_chaste_interface__Na_Concentrations__Na_sl * exp(var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * (1 - var_chaste_interface__I_Ca__f_Ca_Bsl + var_I_Ca__fcaCaMSL) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * NV_Ith_S(mParameters, 9) / (-1 + exp(var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // uA_per_uF
    ...
    N_Vector Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane_potential__V_m = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
...
// LCOV_EXCL_STOP
        ...
        const double var_I_Na__ah = ((var_chaste_interface__membrane_potential__V_m >= -40) ? (0) : (0.057000000000000002 * exp(-11.764705882352942 + 0.14705882352941177 * NV_Ith_S(mParameters, 15) - 0.14705882352941177 * var_chaste_interface__membrane_potential__V_m))); // dimensionless
        const double var_I_Na__aj = ((var_chaste_interface__membrane_potential__V_m >= -40) ? (0) : ((37.780000000000001 + var_chaste_interface__membrane_potential__V_m) * (-25428 * exp(0.24440000000000001 * var_chaste_interface__membrane_potential__V_m - 0.24440000000000001 * NV_Ith_S(mParameters, 15)) - 6.9480000000000002e-6 * exp(0.043909999999999998 * NV_Ith_S(mParameters, 15) - 0.043909999999999998 * var_chaste_interface__membrane_potential__V_m)) / (1 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane_potential__V_m - 0.311 * NV_Ith_S(mParameters, 15))))); // dimensionless
        const double var_I_Na__bh = ((var_chaste_interface__membrane_potential__V_m >= -40) ? (5.9230769230769234 / (1 + exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 15) - 0.0900900900900901 * var_chaste_interface__membrane_potential__V_m))) : (310000 * exp(0.34849999999999998 * var_chaste_interface__membrane_potential__V_m - 0.34849999999999998 * NV_Ith_S(mParameters, 15)) + 2.7000000000000002 * exp(0.079000000000000001 * var_chaste_interface__membrane_potential__V_m - 0.079000000000000001 * NV_Ith_S(mParameters, 15)))); // dimensionless
        const double var_I_Na__bj = ((var_chaste_interface__membrane_potential__V_m >= -40) ? (0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__membrane_potential__V_m - 0.057000000000000002 * NV_Ith_S(mParameters, 15)) / (1 + exp(-3.2000000000000002 + 0.10000000000000001 * NV_Ith_S(mParameters, 15) - 0.10000000000000001 * var_chaste_interface__membrane_potential__V_m))) : (0.024240000000000001 * exp(0.01052 * NV_Ith_S(mParameters, 15) - 0.01052 * var_chaste_interface__membrane_potential__V_m) / (1 + exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 15) - 0.13780000000000001 * var_chaste_interface__membrane_potential__V_m)))); // dimensionless
        ...
        if (mDataClampIsOn)
        {
            var_chaste_interface__membrane_data_clamp_current = (-GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time) + var_chaste_interface__membrane_potential__V_m) * NV_Ith_S(mParameters, 12); // uA_per_cm2
        }
        ...
        const double var_parameters__Cmem_converted = 1000000 * NV_Ith_S(mParameters, 23); // uF
        ...
        const double var_I_Ks__GKs_total = (var_I_Ks__gks_junc * var_parameters__Fjunc + var_I_Ks__gks_sl * var_parameters__Fsl) * NV_Ith_S(mParameters, 19); // mS_per_uF
        ...
        const double var_I_Ki__g_K1 = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 7)) * NV_Ith_S(mParameters, 17); // mS_per_uF
        const double var_I_Kr__gkr = 0.43033148291193518 * sqrt(NV_Ith_S(mParameters, 7)) * NV_Ith_S(mParameters, 18); // mS_per_uF
        ...
        const double var_I_NaK__I_nak_junc = var_I_NaK__fnak * var_parameters__Fjunc * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1 + pow(var_parameters__KmNaip, 4) / pow(var_chaste_interface__Na_Concentrations__Na_j, 4)) * (var_parameters__KmKo + NV_Ith_S(mParameters, 7))); // uA_per_uF
        const double var_I_NaK__I_nak_sl = var_I_NaK__fnak * var_parameters__Fsl * NV_Ith_S(mParameters, 22) * NV_Ith_S(mParameters, 7) / ((1 + pow(var_parameters__KmNaip, 4) / pow(var_chaste_interface__Na_Concentrations__Na_sl, 4)) * (var_parameters__KmKo + NV_Ith_S(mParameters, 7))); // uA_per_uF
        ...
        const double var_parameters__ena_junc = log(NV_Ith_S(mParameters, 8) / var_chaste_interface__Na_Concentrations__Na_j) / var_parameters__FoRT; // mV
        const double var_I_Na__I_Na_junc = pow(var_chaste_interface__I_Na__m, 3) * (-var_parameters__ena_junc + var_chaste_interface__membrane_potential__V_m) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * var_parameters__Fjunc * NV_Ith_S(mParameters, 13); // uA_per_uF
        const double var_parameters__ena_sl = log(NV_Ith_S(mParameters, 8) / var_chaste_interface__Na_Concentrations__Na_sl) / var_parameters__FoRT; // mV
        const double var_I_Na__I_Na_sl = pow(var_chaste_interface__I_Na__m, 3) * (-var_parameters__ena_sl + var_chaste_interface__membrane_potential__V_m) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * var_parameters__Fsl * NV_Ith_S(mParameters, 13); // uA_per_uF
        ...
        const double var_I_to__GtoFast = ((var_parameters__epi == 1) ? (0.1144 * NV_Ith_S(mParameters, 16)) : (0.0014039999999999999 * NV_Ith_S(mParameters, 16))); // mS_per_uF
        const double var_I_to__GtoSlow = ((var_parameters__epi == 1) ? (0.015599999999999999 * NV_Ith_S(mParameters, 20)) : (0.037595999999999997 * NV_Ith_S(mParameters, 20))); // mS_per_uF
        ...
        const double var_I_NCX__s2_junc = pow(NV_Ith_S(mParameters, 8), 3) * var_chaste_interface__Ca_Concentrations__Ca_j * exp((-1 + var_parameters__nu) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT); // mM4
        ...
        const double var_I_NCX__s2_sl = pow(NV_Ith_S(mParameters, 8), 3) * var_chaste_interface__Ca_Concentrations__Ca_sl * exp((-1 + var_parameters__nu) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT); // mM4
        ...
        NV_Ith_S(dqs, 8) = var_chaste_interface__membrane_data_clamp_current;
        NV_Ith_S(dqs, 9) = var_I_Na__I_Na_converted;
        NV_Ith_S(dqs, 10) = var_I_Na__tauh;
        NV_Ith_S(dqs, 11) = var_I_Na__tauj;
        NV_Ith_S(dqs, 12) = var_I_to__I_tof_converted;
        NV_Ith_S(dqs, 13) = var_I_to__GtoFast;
        NV_Ith_S(dqs, 14) = var_I_Ki__I_ki_converted;
        NV_Ith_S(dqs, 15) = var_I_Ki__g_K1;
        NV_Ith_S(dqs, 16) = var_I_Kr__I_kr_converted;
        NV_Ith_S(dqs, 17) = var_I_Ks__I_ks_converted;
        NV_Ith_S(dqs, 18) = var_I_Ks__GKs_total;
        NV_Ith_S(dqs, 19) = var_I_to__I_tos_converted;
        NV_Ith_S(dqs, 20) = var_I_to__GtoSlow;
        NV_Ith_S(dqs, 21) = var_I_NCX__I_ncx_converted;
        NV_Ith_S(dqs, 22) = var_I_NaK__I_nak_converted;
        NV_Ith_S(dqs, 23) = var_membrane_potential__i_Stim_converted;
        NV_Ith_S(dqs, 24) = var_I_to__I_to_converted;
        NV_Ith_S(dqs, 25) = var_parameters__ek;
        NV_Ith_S(dqs, 26) = var_chaste_interface__environment__time;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Cellgrandi_pasqualini_bers_2010_ssFromCellMLCvodeDataClampOpt)
