...
// LCOV_EXCL_STOP
    ...
    double Cellbeeler_reuter_model_1977FromCellMLGRL1Opt::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x6 = exp(3.3999999999999999 + var_x1);
            const double var_x7 = pow(var_x4, (-2));
            const double var_x8 = -1 + var_x6;
            const double var_x9 = -0.040000000000000001 * var_x2 - 0.080000000000000002 * var_x3;
            ...
            const double var_x15 = 1 / exp(1.4000000000000001 + var_x1);
            const double var_x16 = var_x15 * mParameters[6];
            const double var_x17 = -1 + var_x14;
            ...
            const double var_x19 = 0.92000000000000004 + var_x1;
            const double var_x20 = exp(-var_x19);
            const double var_x21 = -1 + var_x20;
            
            partialF = (((var_x19 >= -9.9999999999999995e-8) && (var_x19 <= 9.9999999999999995e-8)) ? (var_x0 * (-var_x18 - (0.10000000000000001 + 0.16 * var_x5 * var_x6 + 4 * var_x7 * var_x8 * var_x9) * mParameters[5])) : (var_x0 * (-var_x18 - (-0.20000000000000001 / var_x21 + 0.16 * var_x5 * var_x6 + 4 * var_x7 * var_x8 * var_x9 - 0.20000000000000001 * var_x19 * var_x20 / pow(var_x21, 2)) * mParameters[5])));
        }
        else
        {
    ...
    double Cellbeeler_reuter_model_1977FromCellMLGRL1Opt::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x10 = mParameters[0] * var_chaste_interface__slow_inward_current_f_gate__f;
            const double var_x11 = var_x10 * var_chaste_interface__slow_inward_current_d_gate__d;
            const double var_x22 = var_x11 / var_chaste_interface__slow_inward_current__Cai;
            
            partialF = -0.070000000000000007 - 0.13028700000000001 * var_x22;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbeeler_reuter_model_1977FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x29 = _lt_0_row[12];
            const double var_x30 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x31 = 4.7000000000000002 + var_x30;
            const double var_x32 = (var_x31 >= -9.9999999999999995e-8) && (var_x31 <= 9.9999999999999995e-8);
            const double var_x33 = exp(-var_x31);
            const double var_x34 = -1 + var_x33;
            const double var_x35 = 1 / var_x34;
            const double var_x37 = 40 * var_x29;
            
            partialF = ((var_x32) ? (-33.5 - var_x37 - 0.5 * var_chaste_interface__membrane__V) : (-var_x37 + 10 * var_x31 * var_x35));
        }
        else
        {
    ...
    double Cellbeeler_reuter_model_1977FromCellMLGRL1Opt::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x38 = 0.25 * var_chaste_interface__membrane__V - 0.25 * mParameters[4];
            ...
            const double var_x44 = var_x40 + 1.7 * var_x43;
    ...
    double Cellbeeler_reuter_model_1977FromCellMLGRL1Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x30 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x38 = 0.25 * var_chaste_interface__membrane__V - 0.25 * mParameters[4];
            const double var_x50 = exp(-3.2000000000000002 - var_x30 + 0.10000000000000001 * mParameters[4]);
            const double var_x51 = 1 + var_x50;
            const double var_x52 = 1 / var_x51;
            const double var_x53 = exp(-15.600000000000001 + 0.20000000000000001 * mParameters[4] - 0.20000000000000001 * var_chaste_interface__membrane__V);
            const double var_x54 = 1 + var_x53;
            const double var_x55 = 1 / var_x54;
            const double var_x56 = exp(-19.5 - var_x38);
            const double var_x57 = var_x55 * var_x56;
            const double var_x58 = 0.055 * var_x57;
            const double var_x59 = var_x58 + 0.29999999999999999 * var_x52;
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbeeler_reuter_model_1977FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x63 = exp(2.2000000000000002 + 0.050000000000000003 * var_chaste_interface__membrane__V);
            const double var_x64 = 1 + var_x63;
            const double var_x65 = _lt_0_row[6];
            const double var_x66 = var_x65 / var_x64;
            const double var_x68 = exp(0.35997120230381568 - 0.071994240460763137 * var_chaste_interface__membrane__V);
            const double var_x69 = 1 + var_x68;
            const double var_x70 = _lt_0_row[4];
            const double var_x71 = var_x70 / var_x69;
            
            partialF = -0.070000000000000007 * var_x66 - 0.095000000000000001 * var_x71;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbeeler_reuter_model_1977FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x73 = exp(4.197901049475262 + 0.14992503748125938 * var_chaste_interface__membrane__V);
            const double var_x74 = 1 + var_x73;
            const double var_x75 = _lt_0_row[8];
            const double var_x76 = var_x75 / var_x74;
            const double var_x77 = exp(-6 - 0.20000000000000001 * var_chaste_interface__membrane__V);
            const double var_x78 = 1 + var_x77;
            const double var_x79 = 1 / var_x78;
            const double var_x80 = _lt_0_row[10];
            
            partialF = -0.012 * var_x76 - 0.0064999999999999997 * var_x79 * var_x80;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Cellbeeler_reuter_model_1977FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
            ...
            const double var_x81 = exp(-0.80000000000000004 - 0.040000000000000001 * var_chaste_interface__membrane__V);
            const double var_x82 = 1 + var_x81;
            const double var_x83 = _lt_0_row[16];
            const double var_x84 = var_x83 / var_x82;
            const double var_x86 = exp(2.8571428571428572 + 0.057142857142857141 * var_chaste_interface__membrane__V);
            const double var_x87 = 1 + var_x86;
            const double var_x88 = _lt_0_row[14];
            const double var_x89 = var_x88 / var_x87;
            
            partialF = -0.00050000000000000001 * var_x89 - 0.0012999999999999999 * var_x84;
        }
        else
        {
