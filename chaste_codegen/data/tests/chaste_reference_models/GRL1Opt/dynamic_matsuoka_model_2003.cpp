...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x36 = 1 + 1.3823999999999997e-8 / pow(var_x35, 3);
            ...
            const double var_x70 = 1 - var_chaste_interface__sodium_potassium_pump_y_gate__y;
            const double var_x71 = _lt_0_row[4];
            const double var_x72 = pow((1 / (var_x71 * mParameters[7])), 1.0600000000000001) * (1 + 4.560221410801109 * pow(mParameters[6], 1.1200000000000001));
            ...
            const double var_x113 = 1 / (0.75 * var_x91 + 3 * var_x94);
            const double var_x114 = var_x113 / pow(var_x95, 3);
            const double var_x115 = var_x112 * var_x114;
            const double var_x116 = var_x79 * (var_x100 + 0.125 * var_x108 + 2 * var_x115) * mParameters[11];
            ...
            const double var_x120 = 3 + var_chaste_interface__membrane__Vm;
            ...
            const double var_x163 = 2 * var_x113 * var_x96;
            ...
            const double var_x185 = 1 / (1 + 2.7439999999999993 * var_x184);
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x202 = var_x201 * (1 + 0.020000293738509214 * pow(var_chaste_interface__internal_ion_concentrations__Ki, 1.1200000000000001));
            const double var_x203 = 1 / var_chaste_interface__ATP_production__ATPi;
            const double var_x204 = 1 + 0.094 * var_x203;
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x329 = 1 - var_chaste_interface__NL_model__pCB - var_chaste_interface__NL_model__pCa - var_chaste_interface__NL_model__pCaCB;
            ...
            const double var_x332 = 1 - var_chaste_interface__SR_calcium_pump_y_gate__y;
            const double var_x333 = 1 + 0.10000000000000001 * var_x203;
            const double var_x334 = 1 / var_x333;
            const double var_x335 = 1 / var_x17;
            const double var_x336 = 1 + 0.00080000000000000004 * var_x335;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x203 = 1 / var_chaste_interface__ATP_production__ATPi;
            const double var_x204 = 1 + 0.094 * var_x203;
            const double var_x245 = 1 / (1 + 4.4045579125871104 * var_x202);
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x370 = 1 / (26 * var_x362 + 0.02 * var_x360);
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x360 = exp(0.00125 * var_chaste_interface__membrane__Vm);
            const double var_x365 = exp(-0.125 * var_chaste_interface__membrane__Vm);
            const double var_x375 = 1 / (5 * var_x357 + 0.0001027 * var_x365);
            const double var_x376 = exp(0.050000000000000003 * var_chaste_interface__membrane__Vm);
            const double var_x377 = 1300 * var_x376 + 0.040000000000000001 * var_x360;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (4000 * var_x395 + 0.014 * var_x394) - 1 / (8000 * var_x391 + 9000000000.0 * var_x393);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x406 = 1 / (480 * var_x403 + 2.2000000000000002 * var_x402);
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x412 = 11 * var_x391 + 2200000 * var_x411;
            const double var_x414 = exp(-var_x410);
            const double var_x415 = 1 / (2 * var_x395 + 0.0018 * var_x414);
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x423 = 1 - var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (58 * var_x402 + 250000 * var_x438) - 1 / (66 * var_x398 + 1800 * var_x439);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (1.5 * var_x442 + 40 * var_x443) - 1 / (0.019 * var_x440 + 0.81999999999999995 * var_x441);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (30 * var_x444 + 62000 * var_x445) - 1 / (1.2 * var_x447 + 0.00059999999999999995 * var_x446);
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (7 * var_x449 + 8000 * var_x450) - var_x100 * var_x455;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (5 * var_x463 + 20 * var_x464) - 1 / (160 * var_x460 + 200 * var_x461) - 0.00040000000000000002 * var_x458;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (20 * var_x463 + 200 * var_x465) - 1 / (1600 * var_x460 + 2000 * var_x461) - 0.0001 * var_x458;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (2 * var_x468 + 0.34999999999999998 * var_x467) - 1 / (2.5 * var_x466 + 10 * var_x362);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative22(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (260 * var_x391 + 1450 * var_x376) - 1 / (85 * var_x469 + 370 * var_x470);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative24(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (11 * var_x471 + 0.20000000000000001 * var_x357) - 1 / (4.4000000000000004 * var_x473 + 0.20000000000000001 * var_x472);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x476 = 1 + 0.051334999999999999 * var_x475;
            const double var_x478 = exp(1.1946902654867255 + var_x474);
            const double var_x479 = 1 + 0.067083000000000004 * var_x478;
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x335 = 1 / var_x17;
            const double var_x482 = 1 + 0.0014927113702623907 * var_x23;
            const double var_x483 = 1 + 0.0013799999999999999 * var_x335 * var_x482;
            
            partialF = var_x279 - 1 / var_x483 - 1 / (1 + 1.3799999999999999 * (1 + 1.4927113702623908e-6 * var_x30) / mParameters[5]);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x205 = 1 / var_x204;
            const double var_x245 = 1 / (1 + 4.4045579125871104 * var_x202);
            const double var_x280 = 1 / (1 + 90.050628437051003 * var_x72);
            ...
            const double var_x487 = 1 + 0.21928759810465578 * var_x485 * (1 + 0.011104864200909382 * var_x486);
            const double var_x488 = pow(var_x80, 1.1200000000000001);
            const double var_x489 = var_x488 * (1 + 0.22703754152993499 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 1.0600000000000001));
            
            partialF = -0.37 * var_x281 - 0.01 / (1 + 49.999265664512095 * var_x489) - 0.040000000000000001 * var_x280 - 0.16500000000000001 / var_x487;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative28(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x336 = 1 + 0.00080000000000000004 * var_x335;
            const double var_x342 = 1 / var_x336;
            const double var_x347 = 1 + 0.080000000000000002 / var_chaste_interface__Ca_concentrations_in_SR__Caup;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x507 = 1 + 0.35999999999999999 / (-5.4000000000000004 + 0.5 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total + 5.4000000000000004 * var_x351);
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x350 = 0.092592592592592587 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total;
            const double var_x351 = sqrt(pow((1 - var_x350), 2) + 0.027434842249657067 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total);
            const double var_x495 = 70000 / pow(mParameters[2], 2);
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative35(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x356 = pow((0.95737999754118841 - var_chaste_interface__NL_model__X), 2);
            const double var_x516 = -0.038879999999999998 * var_x356;
            const double var_x517 = 780 * var_x16;
            const double var_x518 = 780 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
