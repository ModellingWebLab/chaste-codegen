...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x35 = 1.0 + 1.3823999999999997e-8 / pow(var_x34, 3);
            ...
            const double var_x66 = 1.0 + 4.560221410801109 * pow(mParameters[6], 1.1200000000000001);
            ...
            const double var_x110 = 1 / (0.75 * var_x88 + 3.0 * var_x91);
            const double var_x111 = var_x109 * var_x110;
            const double var_x112 = var_x106 * var_x107 * var_x108 * var_x111 * var_x88;
            const double var_x113 = var_x75 * (var_x97 + 0.125 * var_x105 + 2.0 * var_x112) * mParameters[11];
            ...
            const double var_x117 = 3.0 + var_chaste_interface__membrane__Vm;
            ...
            const double var_x148 = -0.0032499999999999994 * var_x105 - 0.0037499999999999999 * var_x140 - 0.192 * var_x96 - 0.218 * var_x112 - var_x131 * var_x134 - 0.0074999999999999997 * var_x141 * var_x81 - 0.029999999999999999 * var_x136 * var_x146 - 0.17999999999999999 * var_x106 * var_x144 * var_x147 * var_x88 + var_x135 * var_x139 * var_x80 * var_x83 * var_x94 + 0.25600000000000001 * var_x106 * var_x78 * var_x83 * var_x93 * var_x94 + 0.125 * var_x100 * var_x102 * var_x103 * var_x135 * var_x139 * var_x98 * var_x99 + 0.016 * var_x100 * var_x102 * var_x78 * var_x79 * var_x93 * var_x98 * var_x99 + 0.22222222222222221 * var_x106 * var_x107 * var_x108 * var_x135 * var_x143 * var_x86 * var_x87 + 2.0 * var_x106 * var_x107 * var_x108 * var_x110 * var_x143 * var_x86 * var_x87 * var_x93 + 0.38400000000000001 * var_x103 * var_x107 * var_x108 * var_x109 * var_x110 * var_x78 * var_x86 * var_x87;
            ...
            const double var_x157 = 1 / (1.0 + 2.7439999999999993 * var_x156);
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x172 = var_x171 * (1.0 + 0.020000293738509214 * pow(var_chaste_interface__internal_ion_concentrations__Ki, 1.1200000000000001));
            const double var_x173 = 1 / var_chaste_interface__ATP_production__ATPi;
            const double var_x174 = 1.0 + 0.094 * var_x173;
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x285 = 1.0 - var_chaste_interface__NL_model__pCB - var_chaste_interface__NL_model__pCa - var_chaste_interface__NL_model__pCaCB;
            ...
            const double var_x289 = 1.0 + 0.10000000000000001 * var_x173;
            ...
            const double var_x293 = 1.0 + 0.00080000000000000004 * var_x292;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x173 = 1 / var_chaste_interface__ATP_production__ATPi;
            const double var_x174 = 1.0 + 0.094 * var_x173;
            const double var_x211 = 1 / (1.0 + 4.4045579125871104 * var_x172);
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x326 = 1 / (26.0 * var_x319 + 0.02 * var_x317);
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x317 = exp(0.00125 * var_chaste_interface__membrane__Vm);
            const double var_x322 = exp(-0.125 * var_chaste_interface__membrane__Vm);
            const double var_x331 = 1 / (5.0 * var_x314 + 0.0001027 * var_x322);
            const double var_x332 = exp(0.050000000000000003 * var_chaste_interface__membrane__Vm);
            const double var_x333 = 1300.0 * var_x332 + 0.040000000000000001 * var_x317;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (4000.0 * var_x348 + 0.014 * var_x346) - 1 / (8000.0 * var_x349 + 9000000000.0 * var_x350);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x360 = 1 / (480.0 * var_x353 + 2.2000000000000002 * var_x352);
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x366 = 11.0 * var_x349 + 2200000.0 * var_x365;
            const double var_x368 = exp(-var_x364);
            const double var_x369 = 1 / (2.0 * var_x348 + 0.0018 * var_x368);
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x291 = -0.026190000000000001 + 0.5 * var_x16 + 0.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
            const double var_x377 = -1.0 + var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (58.0 * var_x352 + 250000.0 * var_x392) - 1 / (66.0 * var_x357 + 1800.0 * var_x391);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (1.5 * var_x393 + 40.0 * var_x394) - 1 / (0.019 * var_x395 + 0.81999999999999995 * var_x396);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (30.0 * var_x399 + 62000.0 * var_x400) - 1 / (1.2 * var_x398 + 0.00059999999999999995 * var_x397);
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (7.0 * var_x403 + 8000.0 * var_x404) - var_x410 * var_x97;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (5.0 * var_x420 + 20.0 * var_x421) - 1 / (160.0 * var_x417 + 200.0 * var_x418) - 0.00040000000000000002 * var_x415;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (20.0 * var_x420 + 200.0 * var_x422) - 1 / (1600.0 * var_x417 + 2000.0 * var_x418) - 0.0001 * var_x415;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (2.0 * var_x424 + 0.34999999999999998 * var_x423) - 1 / (2.5 * var_x425 + 10.0 * var_x319);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative22(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (260.0 * var_x349 + 1450.0 * var_x332) - 1 / (85.0 * var_x426 + 370.0 * var_x427);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative24(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -1 / (11.0 * var_x430 + 0.20000000000000001 * var_x314) - 1 / (4.4000000000000004 * var_x429 + 0.20000000000000001 * var_x428);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x433 = 1.0 + 0.067083000000000004 * var_x432;
            const double var_x434 = var_x432 / var_x433;
            const double var_x436 = exp(-var_x431);
            const double var_x437 = 1.0 + 0.051334999999999999 * var_x436;
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x291 = -0.026190000000000001 + 0.5 * var_x16 + 0.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
            const double var_x292 = 1 / var_x291;
            const double var_x439 = 1.0 + 0.0014927113702623907 * var_x23;
            const double var_x440 = 1.0 + 0.0013799999999999999 * var_x292 * var_x439;
            
            partialF = -var_x246 - 1 / var_x440 - 1 / (1.0 + 1.3799999999999999 * (1.0 + 1.4927113702623908e-6 * var_x30) / mParameters[5]);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x175 = 1 / var_x174;
            const double var_x211 = 1 / (1.0 + 4.4045579125871104 * var_x172);
            const double var_x247 = 1 / (1.0 + 90.050628437051003 * var_x67);
            ...
            const double var_x444 = 1.0 + 0.21928759810465578 * var_x442 * (1.0 + 0.011104864200909382 * var_x443);
            const double var_x445 = pow(var_x76, 1.1200000000000001);
            const double var_x446 = var_x445 * (1.0 + 0.22703754152993499 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 1.0600000000000001));
            
            partialF = -0.37 * var_x248 - 0.01 / (1.0 + 49.999265664512095 * var_x446) - 0.040000000000000001 * var_x247 - 0.16500000000000001 / var_x444;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative28(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x293 = 1.0 + 0.00080000000000000004 * var_x292;
            const double var_x299 = 1 / var_x293;
            const double var_x304 = 1.0 + 0.080000000000000002 / var_chaste_interface__Ca_concentrations_in_SR__Caup;
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x460 = 1.0 + 0.35999999999999999 / (-5.4000000000000004 + 0.5 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total + 5.4000000000000004 * var_x308);
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x461 = 70000.0 * var_x294 * var_x449;
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative35(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x313 = pow((0.95737999754118841 - var_chaste_interface__NL_model__X), 2);
            const double var_x469 = 0.038879999999999998 * var_x313;
            const double var_x470 = 780.0 * var_x16 + 780.0 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
