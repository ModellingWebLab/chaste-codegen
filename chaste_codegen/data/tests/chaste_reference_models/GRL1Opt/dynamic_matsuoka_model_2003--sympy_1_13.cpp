...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (1 - exp(-0.074870384603595908 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (1 - exp(-0.037435192301797954 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / exp(-0.030696857687474322 * var_chaste_interface__membrane__Vm);
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (1 - exp(-0.23076923076923078 - 0.076923076923076927 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
                //Expressions which are part of a piecewise could be inf / nan, this is generally accptable, due to the piecewise, however occasionally interpolation of the lookup table from a nan/inf version can give problems.
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (58 * exp(0.015384615384615385 * var_chaste_interface__membrane__Vm) + 250000 * exp(0.1111111111111111 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (66 * exp(-0.015384615384615385 * var_chaste_interface__membrane__Vm) + 1800 * exp(-0.071428571428571425 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (0.019 * exp(-0.17857142857142858 * var_chaste_interface__membrane__Vm) + 0.81999999999999995 * exp(-0.0040000000000000001 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (1.5 * exp(0.0001 * var_chaste_interface__membrane__Vm) + 40 * exp(0.15873015873015872 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (30 * exp(0.00033333333333333332 * var_chaste_interface__membrane__Vm) + 62000 * exp(0.099009900990099015 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (1.2 * exp(-0.040000000000000001 * var_chaste_interface__membrane__Vm) + 0.00059999999999999995 * exp(-0.14925373134328357 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (5 * exp(-0.0033333333333333335 * var_chaste_interface__membrane__Vm) + 20 * exp(-0.086956521739130432 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (20 * exp(-0.0033333333333333335 * var_chaste_interface__membrane__Vm) + 200 * exp(-0.076923076923076927 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (2.5 * exp(0.0033333333333333335 * var_chaste_interface__membrane__Vm) + 10 * exp(0.058823529411764705 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (2 * exp(-0.0066666666666666671 * var_chaste_interface__membrane__Vm) + 0.34999999999999998 * exp(-0.058823529411764705 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (85 * exp(-0.095238095238095233 * var_chaste_interface__membrane__Vm) + 370 * exp(-0.016129032258064516 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (260 * exp(0.01 * var_chaste_interface__membrane__Vm) + 1450 * exp(0.050000000000000003 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 * exp(0.011979261536575346 * var_chaste_interface__membrane__Vm);
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 * exp(-0.025455930765222609 * var_chaste_interface__membrane__Vm);
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (8000 * exp(0.01 * var_chaste_interface__membrane__Vm) + 9000000000.0 * exp(0.20000000000000001 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (4000 * exp(-0.01 * var_chaste_interface__membrane__Vm) + 0.014 * exp(-0.20000000000000001 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (11 * exp(-0.035714285714285712 * var_chaste_interface__membrane__Vm) + 0.20000000000000001 * exp(-0.0025000000000000001 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (4.4000000000000004 * exp(0.0625 * var_chaste_interface__membrane__Vm) + 0.20000000000000001 * exp(0.002 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (1 + 0.051334999999999999 * exp(-1.1946902654867255 - 0.088495575221238937 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
            ...
            {
                auto f = [](double var_chaste_interface__membrane__Vm) {
                    return 1 / (1 + 0.067083000000000004 * exp(1.1946902654867255 + 0.088495575221238937 * var_chaste_interface__membrane__Vm));
                };
                const double var_chaste_interface__membrane__Vm = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__Vm);
...
// LCOV_EXCL_STOP
        ...
        const double var_constant_field_equations__CF_Ca = ((var_chaste_interface__membrane__Vm == 0) ? (-mParameters[5]) : (0.074870384603595908 * _lt_0_row[1] * (-mParameters[5] * _lt_0_row[0] + var_internal_ion_concentrations__Cai) * var_chaste_interface__membrane__Vm)); // millimolar
        const double var_constant_field_equations__CF_K = ((var_chaste_interface__membrane__Vm == 0) ? (var_chaste_interface__internal_ion_concentrations__Ki) : (0.037435192301797954 * _lt_0_row[3] * (-mParameters[6] * _lt_0_row[2] + var_chaste_interface__internal_ion_concentrations__Ki) * var_chaste_interface__membrane__Vm)); // millimolar
        const double var_constant_field_equations__CF_Na = ((var_chaste_interface__membrane__Vm == 0) ? (-mParameters[7]) : (0.037435192301797954 * _lt_0_row[3] * (-mParameters[7] * _lt_0_row[2] + var_chaste_interface__internal_ion_concentrations__Nai) * var_chaste_interface__membrane__Vm)); // millimolar
        ...
        const double var_chaste_interface__i_ionic = 1 * HeartConfig::Instance()->GetCapacitance() * var_membrane__i_tot / mParameters[9]; // uA_per_cm2
...
// LCOV_EXCL_STOP
        ...
        const double var_background_Kpl_current__i_Kpl = ((var_chaste_interface__membrane__Vm == (-3)) ? (0.0010924717003124302 * pow(mParameters[6], 0.16) * var_constant_field_equations__CF_K) : (8.3986538766456042e-5 * _lt_0_row[7] * pow(mParameters[6], 0.16) * (3 + var_chaste_interface__membrane__Vm) * var_constant_field_equations__CF_K)); // picoA
        ...
        const double var_sodium_potassium_pump__Nao_Eff = mParameters[7] * _lt_0_row[35]; // millimolar
...
// LCOV_EXCL_STOP
        ...
        const double var_SR_calcium_pump__i_SR_U = 1 * (0.01 * var_SR_calcium_pump__p_E1Ca * var_chaste_interface__SR_calcium_pump_y_gate__y - (1 - var_chaste_interface__SR_calcium_pump_y_gate__y) * var_SR_calcium_pump__k2 * var_SR_calcium_pump__p_E2Ca) * mParameters[3]; // picoA
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_channel_ultra_slow_gate__y = 1 * _lt_0_row[8] * (1 - var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y) - 1 * _lt_0_row[9] * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_T_type_Ca_channel_y1_gate__y1 = 1 * _lt_0_row[14] * (1 - var_chaste_interface__T_type_Ca_channel_y1_gate__y1) - 1 * _lt_0_row[15] * var_chaste_interface__T_type_Ca_channel_y1_gate__y1; // 1 / millisecond
        const double d_dt_chaste_interface_var_T_type_Ca_channel_y2_gate__y2 = 1 * _lt_0_row[16] * (1 - var_chaste_interface__T_type_Ca_channel_y2_gate__y2) - 1 * _lt_0_row[17] * var_chaste_interface__T_type_Ca_channel_y2_gate__y2; // 1 / millisecond
        const double var_constant_field_equations__CF_Ca = ((var_chaste_interface__membrane__Vm == 0) ? (-mParameters[5]) : (0.074870384603595908 * _lt_0_row[1] * (-mParameters[5] * _lt_0_row[0] + var_internal_ion_concentrations__Cai) * var_chaste_interface__membrane__Vm)); // millimolar
        const double var_L_type_Ca_channel__i_CaL_Ca = mParameters[8] * var_L_type_Ca_channel__p_open_CaL * var_constant_field_equations__CF_Ca; // picoA
        ...
        const double var_background_lCa_current__i_lCa_Na = 0.11 * var_background_lCa_current__p_open * var_constant_field_equations__CF_Na; // picoA
        const double var_membrane__i_ext = 1 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) * mParameters[9] / HeartConfig::Instance()->GetCapacitance(); // picoA
        const double d_dt_chaste_interface_var_rapid_time_dependent_potassium_current_y1_gate__y1 = -(_lt_0_row[18]) * var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1 + 1 * _lt_0_row[19] * (1 - var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1); // 1 / millisecond
        const double d_dt_chaste_interface_var_rapid_time_dependent_potassium_current_y2_gate__y2 = -(_lt_0_row[20]) * var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2 + 1 * _lt_0_row[21] * (1 - var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2); // 1 / millisecond
        const double d_dt_chaste_interface_var_rapid_time_dependent_potassium_current_y3_gate__y3 = 1 * _lt_0_row[22] * (1 - var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3) - 1 * _lt_0_row[23] * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3; // 1 / millisecond
        const double d_dt_chaste_interface_var_slow_time_dependent_potassium_current_y1_gate__y1 = 1 * _lt_0_row[24] * (1 - var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1) - 1 * _lt_0_row[25] * var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_sodium_current_ultra_slow_gate__y = 1 * _lt_0_row[28] * (1 - var_chaste_interface__sodium_current_ultra_slow_gate__y) - 1 * _lt_0_row[29] * var_chaste_interface__sodium_current_ultra_slow_gate__y; // 1 / millisecond
        ...
        const double var_time_independent_potassium_current__fB = var_time_independent_potassium_current__mu / (var_time_independent_potassium_current__lambda + var_time_independent_potassium_current__mu); // dimensionless
        const double var_time_independent_potassium_current__fO = var_time_independent_potassium_current__lambda / (var_time_independent_potassium_current__lambda + var_time_independent_potassium_current__mu); // dimensionless
        const double d_dt_chaste_interface_var_time_independent_potassium_current_y_gate__y = 1 * (1 - var_chaste_interface__time_independent_potassium_current_y_gate__y) / (7 * exp(-0.32333333333333331 + 0.0033333333333333335 * var_chaste_interface__membrane__Vm - 0.0033333333333333335 * var_time_independent_potassium_current__E_K) + 8000 * exp(-11.411764705882353 + 0.11764705882352941 * var_chaste_interface__membrane__Vm - 0.11764705882352941 * var_time_independent_potassium_current__E_K)) - 1 * pow(var_time_independent_potassium_current__fO, 4) * var_chaste_interface__time_independent_potassium_current_y_gate__y / (0.00013999999999999999 * exp(10.659340659340661 + 0.10989010989010989 * var_time_independent_potassium_current__E_K - 0.10989010989010989 * var_chaste_interface__membrane__Vm) + 0.20000000000000001 * exp(0.19400000000000001 + 0.002 * var_time_independent_potassium_current__E_K - 0.002 * var_chaste_interface__membrane__Vm)); // 1 / millisecond
        const double var_time_independent_potassium_current__i_K1 = 0.50938071193859957 * pow(mParameters[6], 0.40000000000000002) * (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__Vm) * (pow(var_time_independent_potassium_current__fO, 4) + 2 * pow(var_time_independent_potassium_current__fB, 2) * pow(var_time_independent_potassium_current__fO, 2) + 2.6666666666666665 * pow(var_time_independent_potassium_current__fO, 3) * var_time_independent_potassium_current__fB) * mParameters[9] * mParameters[11] * var_chaste_interface__time_independent_potassium_current_y_gate__y; // picoA
        const double d_dt_chaste_interface_var_transient_outward_current_y1_gate__y1 = 1 * _lt_0_row[36] * (1 - var_chaste_interface__transient_outward_current_y1_gate__y1) - 1 * _lt_0_row[37] * var_chaste_interface__transient_outward_current_y1_gate__y1; // 1 / millisecond
        const double d_dt_chaste_interface_var_transient_outward_current_y2_gate__y2 = 0.0038 * _lt_0_row[38] * (1 - var_chaste_interface__transient_outward_current_y2_gate__y2) * _lt_0_row[39] - 0.0038 * _lt_0_row[40] * var_chaste_interface__transient_outward_current_y2_gate__y2 * _lt_0_row[41]; // 1 / millisecond
        const double var_transient_outward_current__i_to_K = pow(var_chaste_interface__transient_outward_current_y1_gate__y1, 3) * var_constant_field_equations__CF_K * mParameters[15] * var_chaste_interface__transient_outward_current_y2_gate__y2; // picoA
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x2 = 0.074870384603595908 * var_chaste_interface__membrane__Vm;
            const double var_x3 = exp(-var_x2);
            const double var_x4 = 1 - var_x3;
            const double var_x5 = 1 / var_x4;
            const double var_x6 = -0.052380000000000003 + var_chaste_interface__internal_ion_concentrations__Ca_Total;
            const double var_x7 = sqrt(pow(var_x6, 2) + 0.0095200000000000007 * var_chaste_interface__internal_ion_concentrations__Ca_Total);
            const double var_x8 = 0.5 * var_x7;
            const double var_x9 = 0.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
            const double var_x10 = var_x3 * mParameters[5];
            const double var_x11 = -0.026190000000000001 + var_x8 + var_x9 - var_x10;
            const double var_x12 = var_x11 * var_x5;
            const double var_x13 = 0.0056055744906903715 * var_chaste_interface__membrane__Vm;
            const double var_x14 = ((var_x1) ? (0) : (0.074870384603595908 * var_x12 + var_x10 * var_x13 * var_x5 - var_x11 * var_x13 * var_x3 / pow(var_x4, 2)));
            const double var_x15 = 1 * mParameters[14];
            const double var_x16 = pow(var_chaste_interface__internal_ion_concentrations__Nai, 3);
            const double var_x17 = 1 / var_x16;
            const double var_x18 = -17.978260869565219 + 362.31884057971018 * var_x7 + 362.31884057971018 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
            const double var_x19 = var_x17 * var_x18;
            const double var_x20 = _lt_0_row[5];
            const double var_x21 = var_x20 / (1 + 669.921875 * var_x19);
            const double var_x22 = pow(mParameters[7], 3);
            const double var_x23 = _lt_0_row[6] / (1 + 669921.875 * (1 + 0.7246376811594204 * mParameters[5]) / var_x22);
            const double var_x24 = 0.011979261536575346 * var_x21 * var_chaste_interface__sodium_calcium_exchanger_y_gate__y + 0.025455930765222609 * var_x23 * (1 - var_chaste_interface__sodium_calcium_exchanger_y_gate__y);
            const double var_x25 = var_x24 * mParameters[9];
            const double var_x26 = 612 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2;
            const double var_x27 = var_x26 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1;
            const double var_x28 = 1 - var_chaste_interface__sodium_potassium_pump_y_gate__y;
            const double var_x29 = _lt_0_row[35];
            const double var_x30 = pow((1 / (var_x29 * mParameters[7])), 1.0600000000000001) * (1 + 4.560221410801109 * pow(mParameters[6], 1.1200000000000001));
            const double var_x31 = var_x30 / pow((0.011104864200909382 + var_x30), 2);
            const double var_x32 = var_x28 * var_x31 * mParameters[9];
            const double var_x33 = var_x14 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
            const double var_x34 = var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U + var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_UCa;
            const double var_x35 = pow(var_chaste_interface__ATP_production__ATPi, (-3));
            const double var_x36 = 1 / (1 + 2.7439999999999993 * var_x35);
            const double var_x37 = var_x36 * mParameters[8] * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y;
            const double var_x38 = var_x34 * var_x37;
            const double var_x39 = var_x33 * var_x38;
            const double var_x40 = 0.037435192301797954 * var_chaste_interface__membrane__Vm;
            const double var_x41 = exp(-var_x40);
            const double var_x42 = var_x41 * mParameters[7];
            const double var_x43 = -var_x42 + var_chaste_interface__internal_ion_concentrations__Nai;
            const double var_x44 = 1 - var_x41;
            const double var_x45 = 1 / var_x44;
            const double var_x46 = 0.037435192301797954 * var_x45;
            const double var_x47 = 0.0014013936226725929 * var_chaste_interface__membrane__Vm;
            const double var_x48 = var_x45 * var_x47;
            const double var_x49 = var_x41 * var_x47 / pow(var_x44, 2);
            const double var_x50 = ((var_x1) ? (0) : (var_x42 * var_x48 + var_x43 * var_x46 - var_x43 * var_x49));
            const double var_x51 = var_x6 + var_x7;
            const double var_x52 = 1 + 1.3823999999999997e-8 / pow(var_x51, 3);
            const double var_x53 = 0.11 / var_x52;
            const double var_x54 = pow(var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1, 2);
            const double var_x55 = 0.10000000000000001 + 0.90000000000000002 * var_chaste_interface__slow_time_dependent_potassium_current_y2_gate__y2;
            const double var_x56 = var_x54 * var_x55;
            const double var_x57 = 0.2016 * var_x56;
            const double var_x58 = pow(var_chaste_interface__transient_outward_current_y1_gate__y1, 3);
            const double var_x59 = 0.00297 * var_x58;
            const double var_x60 = var_x59 * var_chaste_interface__transient_outward_current_y2_gate__y2;
            const double var_x61 = mParameters[10] * var_chaste_interface__sodium_current_ultra_slow_gate__y;
            const double var_x62 = var_x61 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na;
            const double var_x63 = var_x37 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
            const double var_x64 = var_x34 * var_x63;
            const double var_x65 = 1.8499999999999999e-5 * var_x64;
            const double var_x66 = 0.38500000000000001 * var_x50 + var_x50 * var_x53 + var_x50 * var_x57 + var_x50 * var_x60 + var_x50 * var_x62 + var_x50 * var_x65;
            const double var_x67 = var_x41 * mParameters[6];
            const double var_x68 = -var_x67 + var_chaste_interface__internal_ion_concentrations__Ki;
            const double var_x69 = ((var_x1) ? (0) : (var_x46 * var_x68 + var_x48 * var_x67 - var_x49 * var_x68));
            const double var_x70 = pow(var_chaste_interface__ATP_production__ATPi, 2);
            const double var_x71 = pow(mParameters[6], 0.23999999999999999);
            const double var_x72 = var_x71 / (1 + 99.999999999999986 * var_x70);
            const double var_x73 = var_x56 * mParameters[13];
            const double var_x74 = var_x58 * mParameters[15];
            const double var_x75 = var_x74 * var_chaste_interface__transient_outward_current_y2_gate__y2;
            const double var_x76 = 0.10000000000000001 * var_x62;
            const double var_x77 = 0.40000000000000002 * var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2 + 0.59999999999999998 * var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1;
            const double var_x78 = 0.71370912277944121 * var_x77;
            const double var_x79 = pow(mParameters[6], 0.20000000000000001);
            const double var_x80 = var_x79 * mParameters[9] * mParameters[12] * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3;
            const double var_x81 = pow(mParameters[6], 0.40000000000000002);
            const double var_x82 = 1 / var_chaste_interface__internal_ion_concentrations__Ki;
            const double var_x83 = log(var_x82 * mParameters[6]);
            const double var_x84 = exp(-2.4319999999999999 + 0.064000000000000001 * var_chaste_interface__membrane__Vm - 1.7096212431350641 * var_x83);
            const double var_x85 = 1 + var_x84;
            const double var_x86 = pow(var_x85, 4);
            const double var_x87 = exp(-2.1000000000000001 + 0.029999999999999999 * var_chaste_interface__membrane__Vm - 0.80138495771956131 * var_x83);
            const double var_x88 = 1 + var_x87;
            const double var_x89 = pow(var_x88, (-4));
            const double var_x90 = exp(-2.1000000000000001 + 0.014999999999999999 * var_chaste_interface__membrane__Vm - 0.40069247885978065 * var_x83);
            const double var_x91 = 1 + var_x90;
            const double var_x92 = 1 / var_x91;
            const double var_x93 = exp(-0.35000000000000003 + 0.035000000000000003 * var_chaste_interface__membrane__Vm - 0.93494911733948827 * var_x83);
            const double var_x94 = var_x92 * var_x93;
            const double var_x95 = exp(0.47999999999999998 + 1.282215932351298 * var_x83 - 0.048000000000000001 * var_chaste_interface__membrane__Vm);
            const double var_x96 = var_x95 / var_x88;
            const double var_x97 = var_x85 * var_x96;
            const double var_x98 = var_x97 + 0.25 * var_x94;
            const double var_x99 = pow(var_x98, (-4));
            const double var_x100 = pow(var_x95, 4);
            const double var_x101 = var_x100 * var_x89 * var_x99;
            const double var_x102 = var_x101 * var_x86;
            const double var_x103 = 1 * var_x102;
            const double var_x104 = pow(var_x91, (-2));
            const double var_x105 = pow(var_x95, 2);
            const double var_x106 = pow(var_x93, 2);
            const double var_x107 = var_x104 * var_x105 * var_x106 * var_x99;
            const double var_x108 = pow(var_x88, (-2));
            const double var_x109 = pow(var_x85, 2);
            const double var_x110 = var_x108 * var_x109;
            const double var_x111 = var_x107 * var_x110;
            const double var_x112 = pow(var_x85, 3);
            const double var_x113 = pow(var_x88, (-3));
            const double var_x114 = pow(var_x95, 3);
            const double var_x115 = pow(var_x98, (-3));
            const double var_x116 = 1 / (0.75 * var_x94 + 3 * var_x97);
            const double var_x117 = var_x115 * var_x116;
            const double var_x118 = var_x112 * var_x113 * var_x114 * var_x117 * var_x94;
            const double var_x119 = var_x81 * (var_x103 + 0.125 * var_x111 + 2 * var_x118) * mParameters[11];
            const double var_x120 = 0.50938071193859957 * var_x119;
            const double var_x121 = mParameters[9] * var_chaste_interface__time_independent_potassium_current_y_gate__y;
            const double var_x122 = 0.00036499999999999998 * var_x64;
            const double var_x123 = 0.12 * var_x87;
            const double var_x124 = pow(var_x88, (-5));
            const double var_x125 = var_x100 * var_x86;
            const double var_x126 = var_x124 * var_x125 * var_x99;
            const double var_x127 = pow(var_x98, (-5));
            const double var_x128 = var_x104 * var_x90 * var_x93;
            const double var_x129 = var_x84 * var_x96;
            const double var_x130 = var_x108 * var_x85 * var_x95;
            const double var_x131 = 0.014999999999999999 * var_x128 + 0.192 * var_x97 - 0.25600000000000001 * var_x129 - 0.035000000000000003 * var_x94 + var_x123 * var_x130;
            const double var_x132 = var_x105 * var_x106 * var_x110 * var_x90 * var_x99 / pow(var_x91, 3);
            const double var_x133 = var_x107 * var_x109 * var_x113;
            const double var_x134 = var_x130 * var_x87;
            const double var_x135 = 0.01125 * var_x128 + 0.089999999999999997 * var_x134 + 0.14400000000000002 * var_x97 - 0.192 * var_x129 - 0.026250000000000002 * var_x94;
            const double var_x136 = var_x114 * var_x117;
            const double var_x137 = var_x112 * var_x136;
            const double var_x138 = var_x113 * var_x137;
            const double var_x139 = var_x87 * var_x89;
            const double var_x140 = -26.712831923985377 * var_x83 + var_chaste_interface__membrane__Vm;
            const double var_x141 = 0.50938071193859957 * var_x121 * var_x140 * var_x81 * mParameters[11];
            const double var_x142 = pow(mParameters[6], 0.16);
            const double var_x143 = 0.0010924717003124302 * var_x142;
            const double var_x144 = var_chaste_interface__membrane__Vm == (-3);
            const double var_x145 = var_x40 * var_x45;
            const double var_x146 = ((var_x1) ? (var_chaste_interface__internal_ion_concentrations__Ki) : (var_x145 * var_x68));
            const double var_x147 = var_x142 * var_x146;
            const double var_x148 = 0.076923076923076927 * var_chaste_interface__membrane__Vm;
            const double var_x149 = exp(-0.23076923076923078 - var_x148);
            const double var_x150 = 1 - var_x149;
            const double var_x151 = 8.3986538766456042e-5 / var_x150;
            const double var_x152 = 3 + var_chaste_interface__membrane__Vm;
            const double var_x153 = var_x142 * var_x151 * var_x152;
            const double var_x154 = 44.047040000000003 * var_x72 + 0.15400000000000003 * var_x69 + var_x120 * var_x121 + var_x122 * var_x69 + var_x141 * (-0.0032499999999999994 * var_x111 - 0.0037499999999999999 * var_x132 - 0.192 * var_x102 - 0.218 * var_x118 - var_x123 * var_x126 - 0.0074999999999999997 * var_x133 * var_x87 - 0.029999999999999999 * var_x128 * var_x138 - 0.17999999999999999 * var_x112 * var_x136 * var_x139 * var_x94 + 1 * var_x100 * var_x127 * var_x131 * var_x86 * var_x89 + 0.25600000000000001 * var_x100 * var_x112 * var_x84 * var_x89 * var_x99 + 0.125 * var_x104 * var_x105 * var_x106 * var_x108 * var_x109 * var_x127 * var_x131 + 0.016 * var_x104 * var_x105 * var_x106 * var_x108 * var_x84 * var_x85 * var_x99 + 0.22222222222222221 * var_x112 * var_x113 * var_x114 * var_x127 * var_x135 * var_x92 * var_x93 + 2 * var_x112 * var_x113 * var_x114 * var_x116 * var_x135 * var_x92 * var_x93 * var_x99 + 0.38400000000000001 * var_x109 * var_x113 * var_x114 * var_x115 * var_x116 * var_x84 * var_x92 * var_x93) + var_x53 * var_x69 + var_x69 * var_x73 + var_x69 * var_x75 + var_x69 * var_x76 + var_x78 * var_x80 + ((var_x144) ? (var_x143 * var_x69) : (var_x147 * var_x151 + var_x153 * var_x69 - 6.4605029820350801e-6 * var_x147 * var_x149 * var_x152 / pow(var_x150, 2)));
            
            partialF = var_x0 * (-var_x154 - var_x39 - var_x66 - 0.040000000000000001 * var_x14 - 0.0003035235018269044 * var_x32 - var_x14 * var_x27 - var_x15 * var_x25);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x65 = 1.8499999999999999e-5 * var_x64;
            const double var_x145 = var_x40 * var_x45;
            const double var_x155 = 1 / var_chaste_interface__internal_ion_concentrations__Nai;
            const double var_x156 = pow(var_x155, 1.0600000000000001);
            const double var_x157 = 1 + 0.020000293738509214 * pow(var_chaste_interface__internal_ion_concentrations__Ki, 1.1200000000000001);
            const double var_x158 = var_x156 * var_x157;
            const double var_x159 = 1 / var_chaste_interface__ATP_production__ATPi;
            const double var_x160 = 1 + 0.094 * var_x159;
            const double var_x161 = 1 / var_x160;
            const double var_x162 = pow((0.22703754152993499 + var_x158), (-2));
            const double var_x163 = var_x161 * var_x162;
            const double var_x164 = mParameters[9] * var_chaste_interface__sodium_potassium_pump_y_gate__y;
            const double var_x165 = var_x155 * var_x158 * var_x163 * var_x164;
            const double var_x166 = pow(var_chaste_interface__internal_ion_concentrations__Nai, (-4));
            const double var_x167 = pow((0.0014927113702623907 + var_x19), (-2));
            const double var_x168 = var_x167 * var_x20;
            const double var_x169 = var_x166 * var_x168 * var_x18;
            const double var_x170 = mParameters[9] * mParameters[14];
            const double var_x171 = var_x170 * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
            const double var_x172 = ((var_x1) ? (0) : (var_x145));
            const double var_x173 = 0.38500000000000001 * var_x172 + var_x172 * var_x53 + var_x172 * var_x57 + var_x172 * var_x60 + var_x172 * var_x62 + var_x172 * var_x65;
            const double var_x240 = 1.2955153404562495e-6 * mParameters[4];
            const double var_x241 = var_x169 * var_x171;
            
            partialF = -var_x240 * (var_x173 + 5.6097797986465521 * var_x165 + 0.013434402332361517 * var_x241);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x163 = var_x161 * var_x162;
            const double var_x164 = mParameters[9] * var_chaste_interface__sodium_potassium_pump_y_gate__y;
            const double var_x174 = pow(var_chaste_interface__internal_ion_concentrations__Ki, 0.12000000000000011);
            const double var_x175 = ((var_x1) ? (1) : (var_x145));
            const double var_x176 = var_x82 * var_x94;
            const double var_x177 = var_x128 * var_x82;
            const double var_x178 = var_x82 * var_x97;
            const double var_x179 = var_x129 * var_x82;
            const double var_x180 = var_x134 * var_x82;
            const double var_x181 = 0.40069247885978065 * var_x177 + 3.2055398308782452 * var_x180 + 5.1288637294051922 * var_x178 - 6.8384849725402566 * var_x179 - 0.93494911733948827 * var_x176;
            const double var_x182 = var_x82 * var_x87;
            const double var_x183 = 0.30051935914483546 * var_x177 + 2.4041548731586837 * var_x180 + 3.8466477970538944 * var_x178 - 5.1288637294051922 * var_x179 - 0.70121183800461617 * var_x176;
            const double var_x184 = 0.15400000000000003 * var_x175 + var_x122 * var_x175 + var_x141 * (-0.10017311971494516 * var_x132 * var_x82 - 0.20034623942989033 * var_x133 * var_x182 - 0.80138495771956131 * var_x138 * var_x177 - 3.2055398308782452 * var_x126 * var_x182 - 5.1288637294051922 * var_x102 * var_x82 - 0.086816703752952459 * var_x111 * var_x82 - 5.823397359428812 * var_x138 * var_x176 - 4.8083097463173674 * var_x137 * var_x139 * var_x176 + 1 * var_x100 * var_x127 * var_x181 * var_x86 * var_x89 + 6.8384849725402566 * var_x100 * var_x112 * var_x82 * var_x84 * var_x89 * var_x99 + 0.125 * var_x104 * var_x105 * var_x106 * var_x108 * var_x109 * var_x127 * var_x181 + 0.22222222222222221 * var_x112 * var_x113 * var_x114 * var_x127 * var_x183 * var_x92 * var_x93 + 2 * var_x112 * var_x113 * var_x114 * var_x116 * var_x183 * var_x92 * var_x93 * var_x99 + 0.42740531078376603 * var_x104 * var_x105 * var_x106 * var_x108 * var_x82 * var_x84 * var_x85 * var_x99 + 10.257727458810384 * var_x109 * var_x113 * var_x114 * var_x115 * var_x116 * var_x82 * var_x84 * var_x92 * var_x93) + var_x175 * var_x53 + var_x175 * var_x73 + var_x175 * var_x75 + var_x175 * var_x76 + 1176.6211762690609 * var_x72 * var_x82 + 19.065191839422258 * var_x77 * var_x80 * var_x82 + 13.607001343335821 * var_x119 * var_x121 * var_x82 + ((var_x144) ? (var_x143 * var_x175) : (var_x153 * var_x175));
            const double var_x240 = 1.2955153404562495e-6 * mParameters[4];
            const double var_x242 = var_x156 * var_x163 * var_x174;
            const double var_x243 = var_x164 * var_x242;
            
            partialF = -var_x240 * (var_x184 + 0.079032020776755016 * var_x243);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x170 = mParameters[9] * mParameters[14];
            const double var_x171 = var_x170 * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
            const double var_x185 = (-0.047620000000000003 + var_chaste_interface__internal_ion_concentrations__Ca_Total) / var_x7;
            const double var_x186 = 0.5 + 0.5 * var_x185;
            const double var_x187 = ((var_x1) ? (0) : (var_x186 * var_x2 * var_x5));
            const double var_x194 = var_x187 * var_x34;
            const double var_x195 = var_x194 * var_x63;
            const double var_x196 = 362.31884057971018 + 362.31884057971018 * var_x185;
            const double var_x244 = var_x168 * var_x17 * var_x196;
            const double var_x245 = var_x171 * var_x244;
            const double var_x260 = 0.00039642769417961232 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2;
            const double var_x261 = var_x186 * (1 - var_chaste_interface__NL_model__pCB - var_chaste_interface__NL_model__pCa - var_chaste_interface__NL_model__pCaCB);
            const double var_x262 = var_x186 * var_chaste_interface__NL_model__pCB;
            const double var_x263 = -var_x186;
            const double var_x264 = 1 + 0.10000000000000001 * var_x159;
            const double var_x265 = 1 / var_x264;
            const double var_x266 = var_x8 + var_x9;
            const double var_x267 = -0.026190000000000001 + var_x266;
            const double var_x268 = 1 / var_x267;
            const double var_x269 = 1 + 0.00080000000000000004 * var_x268;
            const double var_x270 = pow(var_x269, (-2));
            const double var_x271 = pow(var_x51, 2);
            const double var_x272 = 1 / var_x271;
            const double var_x273 = 1 - var_chaste_interface__SR_calcium_pump_y_gate__y;
            
            partialF = -2.7300000000000004 * var_x261 - 1.9338304790483955e-9 * var_x245 - 109.20000000000002 * var_x262 - 6.4775767022812476e-7 * var_x195 - 2.591030680912499e-8 * var_x187 - var_x187 * var_x260 + 6.4775767022812476e-7 * var_x263 * mParameters[0] + 6.4775767022812476e-7 * var_x263 * mParameters[1] * var_chaste_interface__RyR_channel__p_open_RyR + 2.0728245447299993e-9 * var_x263 * var_x265 * var_x270 * var_x272 * var_x273 * mParameters[3];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x159 = 1 / var_chaste_interface__ATP_production__ATPi;
            const double var_x160 = 1 + 0.094 * var_x159;
            const double var_x198 = 1 / (1 + 4.4045579125871104 * var_x158);
            const double var_x199 = 1 / var_x70;
            const double var_x200 = var_x198 * var_x199 * var_chaste_interface__sodium_potassium_pump_y_gate__y / pow(var_x160, 2);
            const double var_x201 = var_x200 * mParameters[9];
            const double var_x264 = 1 + 0.10000000000000001 * var_x159;
            const double var_x266 = var_x8 + var_x9;
            const double var_x267 = -0.026190000000000001 + var_x266;
            const double var_x268 = 1 / var_x267;
            const double var_x269 = 1 + 0.00080000000000000004 * var_x268;
            const double var_x273 = 1 - var_chaste_interface__SR_calcium_pump_y_gate__y;
            const double var_x274 = 1 / var_x269;
            const double var_x275 = var_x199 * var_x273 * var_x274 / pow(var_x264, 2);
            const double var_x276 = var_x275 * mParameters[3];
            
            partialF = -0.0030000000000000001 - 3.2387883511406238e-8 * var_x276 - 9.4621849436243545e-7 * var_x201;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x299 = exp(-0.0025000000000000001 * var_chaste_interface__membrane__Vm);
            const double var_x300 = 1 / var_x299;
            const double var_x302 = exp(0.00125 * var_chaste_interface__membrane__Vm);
            const double var_x303 = 0.058823529411764705 * var_chaste_interface__membrane__Vm;
            const double var_x304 = exp(var_x303);
            const double var_x312 = 1 / (26 * var_x304 + 0.02 * var_x302);
            const double var_x313 = 1 * var_x312;
            const double var_x314 = 1.25 * var_x300;
            
            partialF = -var_x313 - var_x314;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x308 = exp(-0.125 * var_chaste_interface__membrane__Vm);
            const double var_x309 = exp(-0.02 * var_chaste_interface__membrane__Vm);
            const double var_x315 = 0.25 * var_x309 + 0.1027 * var_x308;
            const double var_x316 = 1 / var_x315;
            
            partialF = -0.01 - var_x316;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x302 = exp(0.00125 * var_chaste_interface__membrane__Vm);
            const double var_x308 = exp(-0.125 * var_chaste_interface__membrane__Vm);
            const double var_x317 = 1 / (5 * var_x299 + 0.0001027 * var_x308);
            const double var_x318 = exp(0.050000000000000003 * var_chaste_interface__membrane__Vm);
            const double var_x319 = 1300 * var_x318 + 0.040000000000000001 * var_x302;
            const double var_x329 = 1 * var_x317;
            
            partialF = -8.7499999999999999e-5 - var_x329 - 1 / var_x319;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x331 = 0.20000000000000001 * var_chaste_interface__membrane__Vm;
            const double var_x332 = exp(-var_x331);
            const double var_x333 = 0.01 * var_chaste_interface__membrane__Vm;
            const double var_x334 = exp(-var_x333);
            const double var_x335 = exp(var_x333);
            const double var_x336 = exp(var_x331);
            
            partialF = -1 / (4000 * var_x334 + 0.014 * var_x332) - 1 / (8000 * var_x335 + 9000000000.0 * var_x336);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x337 = 0.015384615384615385 * var_chaste_interface__membrane__Vm;
            const double var_x338 = exp(var_x337);
            const double var_x339 = exp(0.14285714285714285 * var_chaste_interface__membrane__Vm);
            const double var_x346 = 1 / (480 * var_x339 + 2.2000000000000002 * var_x338);
            const double var_x347 = 1 * var_x346;
            
            partialF = -0.0040000000000000001 - var_x347;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x337 = 0.015384615384615385 * var_chaste_interface__membrane__Vm;
            const double var_x342 = exp(-0.16949152542372881 * var_chaste_interface__membrane__Vm);
            const double var_x343 = exp(-var_x337);
            const double var_x348 = 1.5 * var_x343 + 0.27000000000000002 * var_x342;
            const double var_x349 = 1 / var_x348;
            
            partialF = -0.040000000000000001 - var_x349;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x334 = exp(-var_x333);
            const double var_x335 = exp(var_x333);
            const double var_x350 = 0.13513513513513511 * var_chaste_interface__membrane__Vm;
            const double var_x351 = exp(var_x350);
            const double var_x352 = 11 * var_x335 + 2200000 * var_x351;
            const double var_x354 = exp(-var_x350);
            const double var_x355 = 1 / (2 * var_x334 + 0.0018 * var_x354);
            const double var_x366 = 1 * var_x355;
            
            partialF = -0.001 - var_x366 - 1 / var_x352;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x11 = -0.026190000000000001 + var_x8 + var_x9 - var_x10;
            const double var_x12 = var_x11 * var_x5;
            const double var_x202 = ((var_x1) ? (-mParameters[5]) : (var_x12 * var_x2));
            const double var_x266 = var_x8 + var_x9;
            const double var_x267 = -0.026190000000000001 + var_x266;
            const double var_x363 = -1 + var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
            const double var_x370 = -6.9539999999999997 * var_x363;
            const double var_x371 = 6.9539999999999997 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
            const double var_x376 = var_x371 * (var_x267 - 0.020279999999999996 * var_x202);
            const double var_x377 = var_x376 + var_x267 * var_x370;
            
            partialF = -0.34999999999999998 - var_x377;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x338 = exp(var_x337);
            const double var_x343 = exp(-var_x337);
            const double var_x378 = exp(-0.071428571428571425 * var_chaste_interface__membrane__Vm);
            const double var_x379 = exp(0.1111111111111111 * var_chaste_interface__membrane__Vm);
            
            partialF = -1 / (58 * var_x338 + 250000 * var_x379) - 1 / (66 * var_x343 + 1800 * var_x378);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x380 = exp(0.0001 * var_chaste_interface__membrane__Vm);
            const double var_x381 = exp(0.15873015873015872 * var_chaste_interface__membrane__Vm);
            const double var_x382 = exp(-0.17857142857142858 * var_chaste_interface__membrane__Vm);
            const double var_x383 = exp(-0.0040000000000000001 * var_chaste_interface__membrane__Vm);
            
            partialF = -1 / (1.5 * var_x380 + 40 * var_x381) - 1 / (0.019 * var_x382 + 0.81999999999999995 * var_x383);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x384 = exp(-0.14925373134328357 * var_chaste_interface__membrane__Vm);
            const double var_x385 = exp(-0.040000000000000001 * var_chaste_interface__membrane__Vm);
            const double var_x386 = exp(0.00033333333333333332 * var_chaste_interface__membrane__Vm);
            const double var_x387 = exp(0.099009900990099015 * var_chaste_interface__membrane__Vm);
            
            partialF = -1 / (30 * var_x386 + 62000 * var_x387) - 1 / (1.2 * var_x385 + 0.00059999999999999995 * var_x384);
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x102 = var_x101 * var_x86;
            const double var_x103 = 1 * var_x102;
            const double var_x388 = 0.0033333333333333335 * var_chaste_interface__membrane__Vm;
            const double var_x389 = -var_x388;
            const double var_x390 = exp(-0.32333333333333331 - var_x389 - 0.08904277307995126 * var_x83);
            const double var_x391 = exp(-11.411764705882353 + 0.11764705882352941 * var_chaste_interface__membrane__Vm - 3.142686108704162 * var_x83);
            const double var_x394 = exp(10.659340659340661 + 2.9354760356027887 * var_x83 - 0.10989010989010989 * var_chaste_interface__membrane__Vm);
            const double var_x395 = 0.002 * var_chaste_interface__membrane__Vm;
            const double var_x396 = exp(0.19400000000000001 - var_x395 + 0.053425663847970754 * var_x83);
            const double var_x397 = 1 / (0.00013999999999999999 * var_x394 + 0.20000000000000001 * var_x396);
            
            partialF = -1 / (7 * var_x390 + 8000 * var_x391) - var_x103 * var_x397;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x388 = 0.0033333333333333335 * var_chaste_interface__membrane__Vm;
            const double var_x389 = -var_x388;
            const double var_x402 = 1 / var_x318;
            const double var_x403 = 0.035714285714285712 * var_chaste_interface__membrane__Vm;
            const double var_x404 = exp(var_x403);
            const double var_x405 = exp(0.001 * var_chaste_interface__membrane__Vm);
            const double var_x407 = exp(var_x389);
            const double var_x408 = exp(-0.086956521739130432 * var_chaste_interface__membrane__Vm);
            
            partialF = -1 / (5 * var_x407 + 20 * var_x408) - 1 / (160 * var_x404 + 200 * var_x405) - 0.00040000000000000002 * var_x402;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x405 = exp(0.001 * var_chaste_interface__membrane__Vm);
            const double var_x407 = exp(var_x389);
            const double var_x409 = exp(-var_x148);
            
            partialF = -1 / (20 * var_x407 + 200 * var_x409) - 1 / (1600 * var_x404 + 2000 * var_x405) - 0.0001 * var_x402;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x304 = exp(var_x303);
            const double var_x388 = 0.0033333333333333335 * var_chaste_interface__membrane__Vm;
            const double var_x410 = exp(-var_x303);
            const double var_x411 = exp(-0.0066666666666666671 * var_chaste_interface__membrane__Vm);
            const double var_x412 = exp(var_x388);
            
            partialF = -1 / (2 * var_x411 + 0.34999999999999998 * var_x410) - 1 / (2.5 * var_x412 + 10 * var_x304);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative22(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x333 = 0.01 * var_chaste_interface__membrane__Vm;
            const double var_x335 = exp(var_x333);
            const double var_x413 = exp(-0.095238095238095233 * var_chaste_interface__membrane__Vm);
            const double var_x414 = exp(-0.016129032258064516 * var_chaste_interface__membrane__Vm);
            
            partialF = -1 / (260 * var_x335 + 1450 * var_x318) - 1 / (85 * var_x413 + 370 * var_x414);
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative23(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 0.092459000000000013 - 1.8500000000000001 * var_x7 - 1.8500000000000001 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative24(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x395 = 0.002 * var_chaste_interface__membrane__Vm;
            const double var_x403 = 0.035714285714285712 * var_chaste_interface__membrane__Vm;
            const double var_x415 = exp(var_x395);
            const double var_x416 = exp(0.0625 * var_chaste_interface__membrane__Vm);
            const double var_x417 = exp(-var_x403);
            
            partialF = -1 / (11 * var_x417 + 0.20000000000000001 * var_x299) - 1 / (4.4000000000000004 * var_x416 + 0.20000000000000001 * var_x415);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x418 = 1.1946902654867255 + 0.088495575221238937 * var_chaste_interface__membrane__Vm;
            const double var_x419 = exp(var_x418);
            const double var_x420 = 1 + 0.067083000000000004 * var_x419;
            const double var_x421 = var_x419 / var_x420;
            const double var_x423 = exp(-var_x418);
            const double var_x424 = 1 + 0.051334999999999999 * var_x423;
            const double var_x425 = var_x423 / var_x424;
            
            partialF = -0.0038 * var_x421 - 0.0038 * var_x425;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x22 = pow(mParameters[7], 3);
            const double var_x23 = _lt_0_row[6] / (1 + 669921.875 * (1 + 0.7246376811594204 * mParameters[5]) / var_x22);
            const double var_x237 = 1 * var_x21 + 1 * var_x23;
            const double var_x266 = var_x8 + var_x9;
            const double var_x267 = -0.026190000000000001 + var_x266;
            const double var_x268 = 1 / var_x267;
            const double var_x426 = 1 + 0.0014927113702623907 * var_x16;
            const double var_x427 = 1 + 0.0013799999999999999 * var_x268 * var_x426;
            
            partialF = -var_x237 - 1 / var_x427 - 1 / (1 + 1.3799999999999999 * (1 + 1.4927113702623908e-6 * var_x22) / mParameters[5]);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x161 = 1 / var_x160;
            const double var_x198 = 1 / (1 + 4.4045579125871104 * var_x158);
            const double var_x238 = 1 / (1 + 90.050628437051003 * var_x30);
            const double var_x239 = var_x161 * var_x198;
            const double var_x251 = 0.37 * var_x239 + 0.040000000000000001 * var_x238;
            const double var_x429 = pow((1 / mParameters[6]), 1.1200000000000001);
            const double var_x430 = pow((var_x29 * mParameters[7]), 1.0600000000000001);
            const double var_x431 = 1 + 0.21928759810465578 * var_x429 * (1 + 0.011104864200909382 * var_x430);
            const double var_x432 = pow(var_x82, 1.1200000000000001);
            const double var_x433 = 1 + 0.22703754152993499 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 1.0600000000000001);
            const double var_x434 = var_x432 * var_x433;
            
            partialF = -var_x251 - 0.01 / (1 + 49.999265664512095 * var_x434) - 0.16500000000000001 / var_x431;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative28(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x269 = 1 + 0.00080000000000000004 * var_x268;
            const double var_x274 = 1 / var_x269;
            const double var_x279 = 1 + 0.080000000000000002 / var_chaste_interface__Ca_concentrations_in_SR__Caup;
            const double var_x280 = 1 / var_x279;
            const double var_x281 = 1 * var_x265 * var_x274;
            
            partialF = -1.01 - var_x281 + 0.01 * var_x274 + 0.98999999999999999 * var_x280;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x283 = -1 + 0.092592592592592587 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total;
            const double var_x284 = sqrt(pow(var_x283, 2) + 0.027434842249657067 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total);
            const double var_x448 = 1 + 0.35999999999999999 / (-5.4000000000000004 + 0.5 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total + 5.4000000000000004 * var_x284);
            
            partialF = -0.080000000000000002 / var_x448;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x51 = var_x6 + var_x7;
            const double var_x202 = ((var_x1) ? (-mParameters[5]) : (var_x12 * var_x2));
            const double var_x203 = var_x202 * var_x34;
            const double var_x220 = var_x36 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
            const double var_x271 = pow(var_x51, 2);
            const double var_x283 = -1 + 0.092592592592592587 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total;
            const double var_x284 = sqrt(pow(var_x283, 2) + 0.027434842249657067 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total);
            const double var_x436 = 10.139999999999999 * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y;
            const double var_x439 = pow(mParameters[2], (-2));
            const double var_x440 = var_x220 * var_x436;
            const double var_x449 = 70000 * var_x271 * var_x439;
            const double var_x450 = var_x203 * var_x440;
            const double var_x451 = var_x283 + var_x284;
            const double var_x452 = pow(var_x451, 2);
            const double var_x453 = 0.010993320000000001 * var_x452;
            
            partialF = -0.00084900000000000004 + var_x450 - var_x449 - var_x453;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative31(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x283 = -1 + 0.092592592592592587 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total;
            const double var_x284 = sqrt(pow(var_x283, 2) + 0.027434842249657067 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total);
            const double var_x286 = (-0.078875171467764058 + 0.0085733882030178329 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total) / var_x284;
            const double var_x287 = 0.5 + 5.4000000000000004 * var_x286;
            const double var_x288 = mParameters[1] * var_chaste_interface__RyR_channel__p_open_RyR;
            const double var_x454 = 3.2387883511406234e-5 * var_x288;
            
            partialF = -0.0062508615177014034 - 0.067509304391175154 * var_x286 - var_x287 * var_x454;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative32(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x279 = 1 + 0.080000000000000002 / var_chaste_interface__Ca_concentrations_in_SR__Caup;
            const double var_x289 = var_chaste_interface__SR_calcium_pump_y_gate__y / (pow(var_x279, 2) * pow(var_chaste_interface__Ca_concentrations_in_SR__Caup, 2));
            const double var_x290 = var_x289 * mParameters[3];
            const double var_x455 = 1.2955153404562494e-5 * mParameters[0];
            
            partialF = -0.0050006892141611229 - var_x455 - 1.0364122723649996e-8 * var_x290;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative33(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x6 = -0.052380000000000003 + var_chaste_interface__internal_ion_concentrations__Ca_Total;
            const double var_x7 = sqrt(pow(var_x6, 2) + 0.0095200000000000007 * var_chaste_interface__internal_ion_concentrations__Ca_Total);
            const double var_x456 = 0.0038999999999999998 * exp(-0.86212130841993795);
            const double var_x457 = 19.5 * var_x7 + 19.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
            
            partialF = 0.99141000000000001 - var_x456 - var_x457;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative34(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x292 = pow((0.95737999754118841 - var_chaste_interface__NL_model__X), 2);
            const double var_x459 = 0.038879999999999998 * var_x292;
            
            partialF = -0.0339 - var_x459;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative35(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x292 = pow((0.95737999754118841 - var_chaste_interface__NL_model__X), 2);
            const double var_x459 = 0.038879999999999998 * var_x292;
            const double var_x460 = 780 * var_x7 + 780 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
            
            partialF = 40.736400000000003 - var_x459 - var_x460;
        }
        else
        {
    ...
    std::vector<double> Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        ...
        const double var_Ca_concentrations_in_SR__Carel = 1 * sqrt(0.25 * pow(var_Ca_concentrations_in_SR__b1, 2) + var_Ca_concentrations_in_SR__c1) - 0.5 * var_Ca_concentrations_in_SR__b1; // millimolar
        const double var_L_type_Ca_channel__p_open_CaL = (var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U + var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_UCa) * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL / (1 + 2.7439999999999993 / pow(var_chaste_interface__ATP_production__ATPi, 3)); // dimensionless
        ...
        const double var_internal_ion_concentrations__Cai = 1 * sqrt(0.25 * pow(var_internal_ion_concentrations__b1, 2) + var_internal_ion_concentrations__c1) - 0.5 * var_internal_ion_concentrations__b1; // millimolar
        const double var_RyR_channel__i_RyR = (-var_internal_ion_concentrations__Cai + var_Ca_concentrations_in_SR__Carel) * mParameters[1] * var_chaste_interface__RyR_channel__p_open_RyR; // picoA
        ...
        const double var_L_type_Ca_channel__i_CaL_Ca = mParameters[8] * var_L_type_Ca_channel__p_open_CaL * var_constant_field_equations__CF_Ca; // picoA
        const double var_constant_field_equations__CF_K = ((var_chaste_interface__membrane__Vm == 0) ? (var_chaste_interface__internal_ion_concentrations__Ki) : ((-mParameters[6] * exp(-var_membrane__F * var_chaste_interface__membrane__Vm / (var_membrane__R * var_membrane__T)) + var_chaste_interface__internal_ion_concentrations__Ki) * var_membrane__F * var_chaste_interface__membrane__Vm / ((1 - exp(-var_membrane__F * var_chaste_interface__membrane__Vm / (var_membrane__R * var_membrane__T))) * var_membrane__R * var_membrane__T))); // millimolar
        const double var_L_type_Ca_channel__i_CaL_K = 0.00036499999999999998 * mParameters[8] * var_L_type_Ca_channel__p_open_CaL * var_constant_field_equations__CF_K; // picoA
        ...
        const double var_sodium_calcium_exchanger__k1 = 1 * exp(var_membrane__F * var_chaste_interface__membrane__Vm * var_sodium_calcium_exchanger__Partition / (var_membrane__R * var_membrane__T)); // per_millisecond
        const double var_sodium_calcium_exchanger__k2 = 1 * exp((-1 + var_sodium_calcium_exchanger__Partition) * var_membrane__F * var_chaste_interface__membrane__Vm / (var_membrane__R * var_membrane__T)); // per_millisecond
