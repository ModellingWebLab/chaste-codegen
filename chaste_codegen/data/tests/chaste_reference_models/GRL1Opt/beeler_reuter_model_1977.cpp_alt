...
protected:
    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            {
                auto f = [](double var_chaste_interface__membrane__V) {
                    return 7.2999570997221346 + 0.099998134770640151 * var_chaste_interface__membrane__V + 4 * (-1 + 29.964100047397014 * exp(0.040000000000000001 * var_chaste_interface__membrane__V)) / (8.3311374876876929 * exp(0.040000000000000001 * var_chaste_interface__membrane__V) + 69.407851838755192 * exp(0.080000000000000002 * var_chaste_interface__membrane__V));
                };
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                double val = f(var_chaste_interface__membrane__V);
...
// LCOV_EXCL_STOP
    ...
    double Cellbeeler_reuter_model_1977FromCellMLGRL1Opt::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x8 = pow(var_chaste_interface__sodium_current_m_gate__m, 3);
    ...
    double Cellbeeler_reuter_model_1977FromCellMLGRL1Opt::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.070000000000000007 - 0.13028700000000001 * var_x14;
        }
        else
        {
