...
private:
    static AbstractGeneralizedRushLarsenCardiacCell* CreateMethod(std::shared_ptr<AbstractIvpOdeSolver> p_solver, std::shared_ptr<AbstractStimulusFunction> p_stimulus);
...
public:
    ...
    Dynamicmatsuoka_model_2003FromCellMLGRL1Opt(std::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, std::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
