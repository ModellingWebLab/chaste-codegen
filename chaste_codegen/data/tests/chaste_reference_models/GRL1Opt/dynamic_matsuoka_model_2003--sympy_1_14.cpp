...
// LCOV_EXCL_STOP
        ...
        // Mathematics
        const double var_Ca_concentrations_in_SR__Carel = -5.4000000000000004 + 0.5 * sqrt(pow((10.800000000000001 - var_chaste_interface__Ca_concentrations_in_SR__Ca_Total), 2) + 3.2000000000000002 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total) + 0.5 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total; // millimolar
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x6 = sqrt(pow((0.052380000000000003 - var_chaste_interface__internal_ion_concentrations__Ca_Total), 2) + 0.0095200000000000007 * var_chaste_interface__internal_ion_concentrations__Ca_Total);
            const double var_x7 = 0.5 * var_x6;
            const double var_x8 = 0.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
            const double var_x9 = var_x3 * mParameters[5];
            const double var_x10 = -0.026190000000000001 + var_x7 + var_x8 - var_x9;
            const double var_x11 = var_x10 * var_x5;
            const double var_x12 = 0.0056055744906903715 * var_chaste_interface__membrane__Vm;
            const double var_x13 = ((var_x1) ? (0) : (0.074870384603595908 * var_x11 + var_x12 * var_x5 * var_x9 - var_x10 * var_x12 * var_x3 / pow(var_x4, 2)));
            const double var_x14 = 1 * mParameters[14];
            const double var_x15 = -17.978260869565219 + 362.31884057971018 * var_x6 + 362.31884057971018 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
            const double var_x16 = pow(var_chaste_interface__internal_ion_concentrations__Nai, 3);
            const double var_x17 = 1 / var_x16;
            const double var_x18 = 669.921875 * var_x17;
            const double var_x19 = 1 + var_x15 * var_x18;
            ...
            const double var_x31 = 1 + 90.050628437051003 * var_x30;
            const double var_x32 = var_x30 / pow(var_x31, 2);
            const double var_x33 = var_x28 * var_x32 * mParameters[9];
            const double var_x34 = var_x13 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
            const double var_x35 = var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U + var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_UCa;
            const double var_x36 = 1 + 2.7439999999999993 / pow(var_chaste_interface__ATP_production__ATPi, 3);
            const double var_x37 = 1 / var_x36;
            const double var_x38 = var_x37 * mParameters[8] * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y;
            const double var_x39 = var_x35 * var_x38;
            const double var_x40 = var_x34 * var_x39;
            const double var_x41 = 0.037435192301797954 * var_chaste_interface__membrane__Vm;
            const double var_x42 = exp(-var_x41);
            const double var_x43 = var_x42 * mParameters[7];
            const double var_x44 = -var_x43 + var_chaste_interface__internal_ion_concentrations__Nai;
            const double var_x45 = 1 - var_x42;
            const double var_x46 = 1 / var_x45;
            const double var_x47 = 0.037435192301797954 * var_x46;
            const double var_x48 = 0.0014013936226725929 * var_chaste_interface__membrane__Vm;
            const double var_x49 = var_x46 * var_x48;
            const double var_x50 = var_x42 * var_x48 / pow(var_x45, 2);
            const double var_x51 = ((var_x1) ? (0) : (var_x43 * var_x49 + var_x44 * var_x47 - var_x44 * var_x50));
            const double var_x52 = var_x7 + var_x8;
            const double var_x53 = -0.026190000000000001 + var_x52;
            const double var_x54 = 1 + 1.7279999999999996e-9 / pow(var_x53, 3);
            const double var_x55 = 0.11 / var_x54;
            const double var_x56 = pow(var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1, 2);
            const double var_x57 = 0.10000000000000001 + 0.90000000000000002 * var_chaste_interface__slow_time_dependent_potassium_current_y2_gate__y2;
            const double var_x58 = var_x56 * var_x57;
            const double var_x59 = 0.2016 * var_x58;
            const double var_x60 = pow(var_chaste_interface__transient_outward_current_y1_gate__y1, 3);
            const double var_x61 = 0.00297 * var_x60;
            ...
            const double var_x65 = var_x38 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
            const double var_x66 = var_x35 * var_x65;
            const double var_x67 = 1.8499999999999999e-5 * var_x66;
            const double var_x68 = 0.38500000000000001 * var_x51 + var_x51 * var_x55 + var_x51 * var_x59 + var_x51 * var_x62 + var_x51 * var_x64 + var_x51 * var_x67;
            const double var_x69 = var_x42 * mParameters[6];
            const double var_x70 = -var_x69 + var_chaste_interface__internal_ion_concentrations__Ki;
            const double var_x71 = ((var_x1) ? (0) : (var_x47 * var_x70 + var_x49 * var_x69 - var_x50 * var_x70));
            const double var_x72 = pow(var_chaste_interface__ATP_production__ATPi, 2);
            const double var_x73 = 1 + 99.999999999999986 * var_x72;
            const double var_x74 = pow(mParameters[6], 0.23999999999999999);
            const double var_x75 = var_x74 / var_x73;
            const double var_x76 = var_x58 * mParameters[13];
            const double var_x77 = var_x60 * mParameters[15];
            const double var_x78 = var_x77 * var_chaste_interface__transient_outward_current_y2_gate__y2;
            const double var_x79 = 0.10000000000000001 * var_x64;
            const double var_x80 = 0.40000000000000002 * var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2 + 0.59999999999999998 * var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1;
            const double var_x81 = 0.71370912277944121 * var_x80;
            const double var_x82 = pow(mParameters[6], 0.20000000000000001);
            const double var_x83 = var_x82 * mParameters[9] * mParameters[12] * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3;
            const double var_x84 = pow(mParameters[6], 0.40000000000000002);
            const double var_x85 = 1 / var_chaste_interface__internal_ion_concentrations__Ki;
            const double var_x86 = log(var_x85 * mParameters[6]);
            const double var_x87 = exp(-2.4319999999999999 + 0.064000000000000001 * var_chaste_interface__membrane__Vm - 1.7096212431350641 * var_x86);
            const double var_x88 = 1 + var_x87;
            const double var_x89 = pow(var_x88, 4);
            const double var_x90 = exp(0.47999999999999998 + 1.282215932351298 * var_x86 - 0.048000000000000001 * var_chaste_interface__membrane__Vm);
            const double var_x91 = pow(var_x90, 4);
            const double var_x92 = exp(-2.1000000000000001 + 0.029999999999999999 * var_chaste_interface__membrane__Vm - 0.80138495771956131 * var_x86);
            const double var_x93 = 1 + var_x92;
            const double var_x94 = pow(var_x93, (-4));
            const double var_x95 = exp(-2.1000000000000001 + 0.014999999999999999 * var_chaste_interface__membrane__Vm - 0.40069247885978065 * var_x86);
            const double var_x96 = 1 + var_x95;
            const double var_x97 = 1 / var_x96;
            const double var_x98 = exp(-0.35000000000000003 + 0.035000000000000003 * var_chaste_interface__membrane__Vm - 0.93494911733948827 * var_x86);
            const double var_x99 = var_x97 * var_x98;
            const double var_x100 = var_x90 / var_x93;
            const double var_x101 = var_x100 * var_x88;
            const double var_x102 = 0.75 * var_x99 + 3 * var_x101;
            const double var_x103 = pow(var_x102, (-4));
            const double var_x104 = var_x103 * var_x94;
            const double var_x105 = var_x104 * var_x91;
            const double var_x106 = var_x105 * var_x89;
            const double var_x107 = 81 * var_x106;
            const double var_x108 = pow(var_x88, 3);
            const double var_x109 = pow(var_x90, 3);
            const double var_x110 = var_x108 * var_x109;
            const double var_x111 = var_x110 * var_x99;
            const double var_x112 = pow(var_x93, (-3));
            const double var_x113 = var_x103 * var_x112;
            const double var_x114 = var_x111 * var_x113;
            const double var_x115 = pow(var_x96, (-2));
            const double var_x116 = pow(var_x90, 2);
            const double var_x117 = pow(var_x98, 2);
            const double var_x118 = pow(var_x93, (-2));
            const double var_x119 = pow(var_x88, 2);
            const double var_x120 = var_x118 * var_x119;
            const double var_x121 = var_x103 * var_x115 * var_x116 * var_x117 * var_x120;
            const double var_x122 = var_x84 * (var_x107 + 54 * var_x114 + 10.125 * var_x121) * mParameters[11];
            const double var_x123 = 0.50938071193859957 * var_x122;
            const double var_x124 = mParameters[9] * var_chaste_interface__time_independent_potassium_current_y_gate__y;
            const double var_x125 = 0.00036499999999999998 * var_x66;
            const double var_x126 = pow(var_x93, (-5));
            const double var_x127 = var_x89 * var_x91;
            const double var_x128 = var_x103 * var_x92;
            const double var_x129 = var_x126 * var_x127 * var_x128;
            const double var_x130 = pow(var_x102, (-5));
            const double var_x131 = var_x115 * var_x95 * var_x98;
            const double var_x132 = var_x100 * var_x87;
            const double var_x133 = var_x118 * var_x88 * var_x90 * var_x92;
            const double var_x134 = 0.044999999999999998 * var_x131 + 0.35999999999999999 * var_x133 + 0.57600000000000007 * var_x101 - 0.76800000000000002 * var_x132 - 0.10500000000000001 * var_x99;
            const double var_x135 = var_x110 * var_x113;
            const double var_x136 = var_x103 * var_x116 * var_x117 * var_x120 * var_x95 / pow(var_x96, 3);
            const double var_x137 = var_x112 * var_x115 * var_x116 * var_x117 * var_x119 * var_x128;
            const double var_x138 = var_x104 * var_x92;
            const double var_x139 = -26.712831923985377 * var_x86 + var_chaste_interface__membrane__Vm;
            const double var_x140 = 0.50938071193859957 * var_x124 * var_x139 * var_x84 * mParameters[11];
            const double var_x141 = pow(mParameters[6], 0.16);
            const double var_x142 = 0.0010924717003124302 * var_x141;
            const double var_x143 = var_chaste_interface__membrane__Vm == (-3);
            const double var_x144 = var_x41 * var_x46;
            const double var_x145 = ((var_x1) ? (var_chaste_interface__internal_ion_concentrations__Ki) : (var_x144 * var_x70));
            const double var_x146 = var_x141 * var_x145;
            const double var_x147 = 0.076923076923076927 * var_chaste_interface__membrane__Vm;
            const double var_x148 = exp(-0.23076923076923078 - var_x147);
            const double var_x149 = 1 - var_x148;
            const double var_x150 = 8.3986538766456042e-5 / var_x149;
            const double var_x151 = 3 + var_chaste_interface__membrane__Vm;
            const double var_x152 = var_x141 * var_x150 * var_x151;
            const double var_x153 = 44.047040000000003 * var_x75 + 0.15400000000000003 * var_x71 + var_x123 * var_x124 + var_x125 * var_x71 + var_x140 * (-0.26324999999999993 * var_x121 - 0.30374999999999996 * var_x136 - 0.60749999999999993 * var_x137 - 9.7199999999999989 * var_x129 - 5.8860000000000001 * var_x114 - 15.552 * var_x106 - 0.80999999999999994 * var_x131 * var_x135 - 4.8599999999999994 * var_x111 * var_x138 + 81 * var_x130 * var_x134 * var_x89 * var_x91 * var_x94 + 20.736000000000001 * var_x103 * var_x108 * var_x87 * var_x91 * var_x94 + 54 * var_x108 * var_x109 * var_x112 * var_x130 * var_x134 * var_x97 * var_x98 + 10.125 * var_x115 * var_x116 * var_x117 * var_x118 * var_x119 * var_x130 * var_x134 + 1.296 * var_x103 * var_x115 * var_x116 * var_x117 * var_x118 * var_x87 * var_x88 + 10.368 * var_x103 * var_x109 * var_x112 * var_x119 * var_x87 * var_x97 * var_x98) + var_x55 * var_x71 + var_x71 * var_x76 + var_x71 * var_x78 + var_x71 * var_x79 + var_x81 * var_x83 + ((var_x143) ? (var_x142 * var_x71) : (var_x146 * var_x150 + var_x152 * var_x71 - 6.4605029820350801e-6 * var_x146 * var_x148 * var_x151 / pow(var_x149, 2)));
            
            partialF = var_x0 * (-var_x153 - var_x40 - var_x68 - 0.040000000000000001 * var_x13 - 2.4613071884921265 * var_x33 - var_x13 * var_x27 - var_x14 * var_x25);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x67 = 1.8499999999999999e-5 * var_x66;
            const double var_x144 = var_x41 * var_x46;
            const double var_x154 = pow(var_x19, (-2));
            const double var_x155 = var_x154 * var_x20;
            const double var_x157 = pow(var_chaste_interface__internal_ion_concentrations__Nai, (-4));
            const double var_x158 = var_x15 * var_x157;
            const double var_x159 = mParameters[9] * mParameters[14];
            const double var_x160 = var_x159 * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
            const double var_x161 = 1 / var_chaste_interface__internal_ion_concentrations__Nai;
            const double var_x162 = pow(var_x161, 1.0600000000000001);
            const double var_x163 = 1 + 0.020000293738509214 * pow(var_chaste_interface__internal_ion_concentrations__Ki, 1.1200000000000001);
            const double var_x164 = var_x162 * var_x163;
            const double var_x165 = 1 / var_chaste_interface__ATP_production__ATPi;
            const double var_x166 = 1 + 0.094 * var_x165;
            const double var_x167 = 1 / var_x166;
            const double var_x168 = 1 + 4.4045579125871104 * var_x164;
            const double var_x169 = pow(var_x168, (-2));
            const double var_x170 = var_x167 * var_x169;
            const double var_x171 = mParameters[9] * var_chaste_interface__sodium_potassium_pump_y_gate__y;
            const double var_x172 = var_x161 * var_x164 * var_x170 * var_x171;
            const double var_x173 = ((var_x1) ? (0) : (var_x144));
            const double var_x174 = 0.38500000000000001 * var_x173 + var_x173 * var_x55 + var_x173 * var_x59 + var_x173 * var_x62 + var_x173 * var_x64 + var_x173 * var_x67;
            const double var_x236 = 1.2955153404562495e-6 * mParameters[4];
            const double var_x237 = var_x155 * var_x158 * var_x160;
            
            partialF = -var_x236 * (var_x174 + 6029.296875 * var_x237 + 108.83045963894989 * var_x172);
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x170 = var_x167 * var_x169;
            const double var_x171 = mParameters[9] * var_chaste_interface__sodium_potassium_pump_y_gate__y;
            const double var_x175 = pow(var_chaste_interface__internal_ion_concentrations__Ki, 0.12000000000000011);
            const double var_x176 = ((var_x1) ? (1) : (var_x144));
            const double var_x177 = var_x85 * var_x99;
            const double var_x178 = var_x131 * var_x85;
            const double var_x179 = 1.2020774365793419 * var_x178 - 2.8048473520184647 * var_x177 + 9.6166194926347348 * var_x133 * var_x85 + 15.386591188215577 * var_x101 * var_x85 - 20.515454917620769 * var_x132 * var_x85;
            const double var_x180 = 0.15400000000000003 * var_x176 + var_x125 * var_x176 + var_x140 * (-7.0321530039891496 * var_x121 * var_x85 - 21.637393858428155 * var_x135 * var_x178 - 8.114022696910558 * var_x136 * var_x85 - 16.228045393821116 * var_x137 * var_x85 - 259.64872630113786 * var_x129 * var_x85 - 415.43796208182056 * var_x106 * var_x85 - 157.23172870457793 * var_x135 * var_x177 - 129.82436315056893 * var_x110 * var_x138 * var_x177 + 81 * var_x130 * var_x179 * var_x89 * var_x91 * var_x94 + 553.91728277576078 * var_x103 * var_x108 * var_x85 * var_x87 * var_x91 * var_x94 + 54 * var_x108 * var_x109 * var_x112 * var_x130 * var_x179 * var_x97 * var_x98 + 10.125 * var_x115 * var_x116 * var_x117 * var_x118 * var_x119 * var_x130 * var_x179 + 34.619830173485049 * var_x103 * var_x115 * var_x116 * var_x117 * var_x118 * var_x85 * var_x87 * var_x88 + 276.95864138788039 * var_x103 * var_x109 * var_x112 * var_x119 * var_x85 * var_x87 * var_x97 * var_x98) + var_x176 * var_x55 + var_x176 * var_x76 + var_x176 * var_x78 + var_x176 * var_x79 + 1176.6211762690609 * var_x75 * var_x85 + 19.065191839422258 * var_x80 * var_x83 * var_x85 + 13.607001343335821 * var_x122 * var_x124 * var_x85 + ((var_x143) ? (var_x142 * var_x176) : (var_x152 * var_x176));
            const double var_x236 = 1.2955153404562495e-6 * mParameters[4];
            const double var_x238 = var_x162 * var_x170 * var_x175;
            const double var_x239 = var_x171 * var_x238;
            
            partialF = -var_x236 * (var_x180 + 1.5332315092660918 * var_x239);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x160 = var_x159 * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
            const double var_x165 = 1 / var_chaste_interface__ATP_production__ATPi;
            const double var_x181 = (-0.047620000000000003 + var_chaste_interface__internal_ion_concentrations__Ca_Total) / var_x6;
            const double var_x182 = 0.5 + 0.5 * var_x181;
            const double var_x183 = ((var_x1) ? (0) : (var_x182 * var_x2 * var_x5));
            const double var_x190 = var_x183 * var_x35;
            const double var_x191 = var_x190 * var_x65;
            const double var_x192 = 362.31884057971018 + 362.31884057971018 * var_x181;
            const double var_x240 = var_x160 * var_x17;
            const double var_x255 = 0.00039642769417961232 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2;
            const double var_x256 = var_x182 * (1 - var_chaste_interface__NL_model__pCB - var_chaste_interface__NL_model__pCa - var_chaste_interface__NL_model__pCaCB);
            const double var_x257 = var_x182 * var_chaste_interface__NL_model__pCB;
            const double var_x258 = -var_x182;
            const double var_x259 = 1 + 0.10000000000000001 * var_x165;
            const double var_x260 = 1 / var_x259;
            const double var_x261 = 1 / var_x53;
            const double var_x262 = 1 + 0.00080000000000000004 * var_x261;
            const double var_x263 = pow(var_x262, (-2));
            const double var_x264 = pow(var_x53, 2);
            const double var_x265 = 1 / var_x264;
            const double var_x266 = 1 - var_chaste_interface__SR_calcium_pump_y_gate__y;
            const double var_x267 = var_x155 * var_x192;
            
            partialF = -2.7300000000000004 * var_x256 - 109.20000000000002 * var_x257 - 6.4775767022812476e-7 * var_x191 - 2.591030680912499e-8 * var_x183 - var_x183 * var_x255 + 6.4775767022812476e-7 * var_x258 * mParameters[0] - 0.00086789406596971398 * var_x240 * var_x267 + 6.4775767022812476e-7 * var_x258 * mParameters[1] * var_chaste_interface__RyR_channel__p_open_RyR + 5.1820613618249983e-10 * var_x258 * var_x260 * var_x263 * var_x265 * var_x266 * mParameters[3];
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x166 = 1 + 0.094 * var_x165;
            const double var_x168 = 1 + 4.4045579125871104 * var_x164;
            const double var_x194 = 1 / var_x168;
            const double var_x195 = 1 / var_x72;
            const double var_x196 = var_x194 * var_x195 * var_chaste_interface__sodium_potassium_pump_y_gate__y / pow(var_x166, 2);
            const double var_x197 = var_x196 * mParameters[9];
            const double var_x259 = 1 + 0.10000000000000001 * var_x165;
            const double var_x261 = 1 / var_x53;
            const double var_x262 = 1 + 0.00080000000000000004 * var_x261;
            const double var_x266 = 1 - var_chaste_interface__SR_calcium_pump_y_gate__y;
            const double var_x268 = 1 / var_x262;
            const double var_x269 = var_x195 * var_x266 * var_x268 / pow(var_x259, 2);
            const double var_x270 = var_x269 * mParameters[3];
            
            partialF = -0.0030000000000000001 - 3.2387883511406238e-8 * var_x270 - 9.4621849436243545e-7 * var_x197;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x292 = exp(-0.0025000000000000001 * var_chaste_interface__membrane__Vm);
            const double var_x293 = 1 / var_x292;
            const double var_x295 = 0.058823529411764705 * var_chaste_interface__membrane__Vm;
            const double var_x296 = exp(var_x295);
            const double var_x297 = exp(0.00125 * var_chaste_interface__membrane__Vm);
            const double var_x298 = 26 * var_x296 + 0.02 * var_x297;
            const double var_x307 = 1 / var_x298;
            const double var_x308 = 1 * var_x307;
            const double var_x309 = 1.25 * var_x293;
            
            partialF = -var_x308 - var_x309;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x302 = exp(-0.02 * var_chaste_interface__membrane__Vm);
            const double var_x303 = exp(-0.125 * var_chaste_interface__membrane__Vm);
            const double var_x304 = 0.25 * var_x302 + 0.1027 * var_x303;
            const double var_x310 = 1 / var_x304;
            
            partialF = -0.01 - var_x310;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x297 = exp(0.00125 * var_chaste_interface__membrane__Vm);
            const double var_x303 = exp(-0.125 * var_chaste_interface__membrane__Vm);
            const double var_x311 = 5 * var_x292 + 0.0001027 * var_x303;
            const double var_x312 = 1 / var_x311;
            const double var_x313 = exp(0.050000000000000003 * var_chaste_interface__membrane__Vm);
            const double var_x314 = 1300 * var_x313 + 0.040000000000000001 * var_x297;
            const double var_x323 = 1 * var_x312;
            
            partialF = -8.7499999999999999e-5 - var_x323 - 1 / var_x314;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x326 = exp(-var_x325);
            const double var_x327 = 0.20000000000000001 * var_chaste_interface__membrane__Vm;
            const double var_x328 = exp(-var_x327);
            const double var_x329 = 4000 * var_x326 + 0.014 * var_x328;
            const double var_x330 = exp(var_x325);
            const double var_x331 = exp(var_x327);
            const double var_x332 = 8000 * var_x330 + 9000000000.0 * var_x331;
            
            partialF = -1 / var_x329 - 1 / var_x332;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x333 = exp(0.14285714285714285 * var_chaste_interface__membrane__Vm);
            const double var_x334 = 0.015384615384615385 * var_chaste_interface__membrane__Vm;
            const double var_x335 = exp(var_x334);
            const double var_x336 = 480 * var_x333 + 2.2000000000000002 * var_x335;
            const double var_x344 = 1 / var_x336;
            const double var_x345 = 1 * var_x344;
            
            partialF = -0.0040000000000000001 - var_x345;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x334 = 0.015384615384615385 * var_chaste_interface__membrane__Vm;
            const double var_x339 = exp(-var_x334);
            const double var_x340 = exp(-0.16949152542372881 * var_chaste_interface__membrane__Vm);
            const double var_x341 = 1.5 * var_x339 + 0.27000000000000002 * var_x340;
            const double var_x346 = 1 / var_x341;
            
            partialF = -0.040000000000000001 - var_x346;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x326 = exp(-var_x325);
            const double var_x330 = exp(var_x325);
            const double var_x347 = 0.13513513513513511 * var_chaste_interface__membrane__Vm;
            const double var_x348 = exp(var_x347);
            const double var_x349 = 11 * var_x330 + 2200000 * var_x348;
            const double var_x350 = exp(-var_x347);
            const double var_x351 = 2 * var_x326 + 0.0018 * var_x350;
            const double var_x352 = 1 / var_x351;
            const double var_x363 = 1 * var_x352;
            
            partialF = -0.001 - var_x363 - 1 / var_x349;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x52 = var_x7 + var_x8;
            const double var_x53 = -0.026190000000000001 + var_x52;
            const double var_x198 = ((var_x1) ? (-mParameters[5]) : (var_x11 * var_x2));
            const double var_x360 = -1 + var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
            const double var_x367 = -6.9539999999999997 * var_x360;
            const double var_x368 = 6.9539999999999997 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
            const double var_x373 = var_x368 * (var_x53 - 0.020279999999999996 * var_x198);
            const double var_x374 = var_x373 + var_x367 * var_x53;
            
            partialF = -0.34999999999999998 - var_x374;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x335 = exp(var_x334);
            const double var_x339 = exp(-var_x334);
            const double var_x375 = exp(-0.071428571428571425 * var_chaste_interface__membrane__Vm);
            const double var_x376 = 66 * var_x339 + 1800 * var_x375;
            const double var_x377 = exp(0.1111111111111111 * var_chaste_interface__membrane__Vm);
            const double var_x378 = 58 * var_x335 + 250000 * var_x377;
            
            partialF = -1 / var_x376 - 1 / var_x378;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x379 = exp(0.0001 * var_chaste_interface__membrane__Vm);
            const double var_x380 = exp(0.15873015873015872 * var_chaste_interface__membrane__Vm);
            const double var_x381 = 1.5 * var_x379 + 40 * var_x380;
            ...
            const double var_x384 = 0.019 * var_x382 + 0.81999999999999995 * var_x383;
            
            partialF = -1 / var_x381 - 1 / var_x384;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x386 = exp(-0.14925373134328357 * var_chaste_interface__membrane__Vm);
            const double var_x387 = 1.2 * var_x385 + 0.00059999999999999995 * var_x386;
            const double var_x388 = exp(0.00033333333333333332 * var_chaste_interface__membrane__Vm);
            const double var_x389 = exp(0.099009900990099015 * var_chaste_interface__membrane__Vm);
            const double var_x390 = 30 * var_x388 + 62000 * var_x389;
            
            partialF = -1 / var_x387 - 1 / var_x390;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x106 = var_x105 * var_x89;
            const double var_x107 = 81 * var_x106;
            const double var_x391 = 0.0033333333333333335 * var_chaste_interface__membrane__Vm;
            const double var_x392 = -var_x391;
            const double var_x393 = exp(-0.32333333333333331 - var_x392 - 0.08904277307995126 * var_x86);
            const double var_x394 = exp(-11.411764705882353 + 0.11764705882352941 * var_chaste_interface__membrane__Vm - 3.142686108704162 * var_x86);
            const double var_x395 = 7 * var_x393 + 8000 * var_x394;
            const double var_x398 = exp(10.659340659340661 + 2.9354760356027887 * var_x86 - 0.10989010989010989 * var_chaste_interface__membrane__Vm);
            const double var_x399 = 0.002 * var_chaste_interface__membrane__Vm;
            const double var_x400 = exp(0.19400000000000001 - var_x399 + 0.053425663847970754 * var_x86);
            const double var_x401 = 0.00013999999999999999 * var_x398 + 0.20000000000000001 * var_x400;
            const double var_x402 = 1 / var_x401;
            
            partialF = -1 / var_x395 - var_x107 * var_x402;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x391 = 0.0033333333333333335 * var_chaste_interface__membrane__Vm;
            const double var_x392 = -var_x391;
            const double var_x407 = 1 / var_x313;
            const double var_x408 = 0.035714285714285712 * var_chaste_interface__membrane__Vm;
            const double var_x409 = exp(var_x408);
            const double var_x410 = exp(0.001 * var_chaste_interface__membrane__Vm);
            const double var_x411 = 160 * var_x409 + 200 * var_x410;
            const double var_x412 = exp(var_x392);
            const double var_x413 = exp(-0.086956521739130432 * var_chaste_interface__membrane__Vm);
            const double var_x414 = 5 * var_x412 + 20 * var_x413;
            
            partialF = -1 / var_x411 - 1 / var_x414 - 0.00040000000000000002 * var_x407;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x410 = exp(0.001 * var_chaste_interface__membrane__Vm);
            const double var_x412 = exp(var_x392);
            const double var_x415 = 1600 * var_x409 + 2000 * var_x410;
            const double var_x416 = exp(-var_x147);
            const double var_x417 = 20 * var_x412 + 200 * var_x416;
            
            partialF = -1 / var_x415 - 1 / var_x417 - 0.0001 * var_x407;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative21(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x296 = exp(var_x295);
            const double var_x391 = 0.0033333333333333335 * var_chaste_interface__membrane__Vm;
            const double var_x418 = exp(-0.0066666666666666671 * var_chaste_interface__membrane__Vm);
            const double var_x419 = exp(-var_x295);
            const double var_x420 = 2 * var_x418 + 0.34999999999999998 * var_x419;
            const double var_x421 = exp(var_x391);
            const double var_x422 = 2.5 * var_x421 + 10 * var_x296;
            
            partialF = -1 / var_x420 - 1 / var_x422;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative22(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x325 = 0.01 * var_chaste_interface__membrane__Vm;
            const double var_x330 = exp(var_x325);
            const double var_x423 = 260 * var_x330 + 1450 * var_x313;
            const double var_x424 = exp(-0.095238095238095233 * var_chaste_interface__membrane__Vm);
            const double var_x425 = exp(-0.016129032258064516 * var_chaste_interface__membrane__Vm);
            const double var_x426 = 85 * var_x424 + 370 * var_x425;
            
            partialF = -1 / var_x423 - 1 / var_x426;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative23(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 0.092459000000000013 - 1.8500000000000001 * var_x6 - 1.8500000000000001 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative24(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x399 = 0.002 * var_chaste_interface__membrane__Vm;
            const double var_x408 = 0.035714285714285712 * var_chaste_interface__membrane__Vm;
            const double var_x427 = exp(0.0625 * var_chaste_interface__membrane__Vm);
            const double var_x428 = exp(var_x399);
            const double var_x429 = 4.4000000000000004 * var_x427 + 0.20000000000000001 * var_x428;
            const double var_x430 = exp(-var_x408);
            const double var_x431 = 11 * var_x430 + 0.20000000000000001 * var_x292;
            
            partialF = -1 / var_x429 - 1 / var_x431;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x432 = 1.1946902654867255 + 0.088495575221238937 * var_chaste_interface__membrane__Vm;
            const double var_x433 = exp(var_x432);
            const double var_x434 = 1 + 0.067083000000000004 * var_x433;
            const double var_x435 = var_x433 / var_x434;
            const double var_x437 = exp(-var_x432);
            const double var_x438 = 1 + 0.051334999999999999 * var_x437;
            const double var_x439 = var_x437 / var_x438;
            
            partialF = -0.0038 * var_x435 - 0.0038 * var_x439;
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x52 = var_x7 + var_x8;
            const double var_x53 = -0.026190000000000001 + var_x52;
            const double var_x233 = 1 * var_x21 + 1 * var_x23;
            const double var_x261 = 1 / var_x53;
            const double var_x440 = 0.0013799999999999999 + 2.0599416909620992e-6 * var_x16;
            const double var_x441 = 1 + var_x261 * var_x440;
            
            partialF = -var_x233 - 1 / var_x441 - 1 / (1 + 1.3799999999999999 * (1 + 1.4927113702623908e-6 * var_x22) / mParameters[5]);
        }
        else
        {
...
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Dynamicmatsuoka_model_2003FromCellMLGRL1Opt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__Vm);
            ...
            const double var_x168 = 1 + 4.4045579125871104 * var_x164;
            const double var_x194 = 1 / var_x168;
            const double var_x234 = 1 / var_x31;
            const double var_x235 = var_x167 * var_x194;
            const double var_x246 = 0.37 * var_x235 + 0.040000000000000001 * var_x234;
            const double var_x443 = pow((1 / mParameters[6]), 1.1200000000000001);
            const double var_x444 = pow((var_x29 * mParameters[7]), 1.0600000000000001);
            const double var_x445 = 1 + 0.21928759810465578 * var_x443 * (1 + 0.011104864200909382 * var_x444);
            const double var_x446 = pow(var_x85, 1.1200000000000001);
            const double var_x447 = 1 + 0.22703754152993499 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 1.0600000000000001);
            const double var_x448 = 1 + 49.999265664512095 * var_x446 * var_x447;
            
            partialF = -var_x246 - 0.01 / var_x448 - 0.16500000000000001 / var_x445;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative28(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x262 = 1 + 0.00080000000000000004 * var_x261;
            const double var_x268 = 1 / var_x262;
            const double var_x273 = 1 + 0.080000000000000002 / var_chaste_interface__Ca_concentrations_in_SR__Caup;
            const double var_x274 = 1 / var_x273;
            const double var_x275 = 1 * var_x260 * var_x268;
            
            partialF = -1.01 - var_x275 + 0.01 * var_x268 + 0.98999999999999999 * var_x274;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative29(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x277 = sqrt(pow((10.800000000000001 - var_chaste_interface__Ca_concentrations_in_SR__Ca_Total), 2) + 3.2000000000000002 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total);
            const double var_x462 = -5.4000000000000004 + 0.5 * var_x277 + 0.5 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total;
            const double var_x463 = 1 + 0.35999999999999999 / var_x462;
            
            partialF = -0.080000000000000002 / var_x463;
        }
        else
        {
...
// LCOV_EXCL_STOP
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative30(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x53 = -0.026190000000000001 + var_x52;
            const double var_x198 = ((var_x1) ? (-mParameters[5]) : (var_x11 * var_x2));
            const double var_x199 = var_x198 * var_x35;
            const double var_x216 = var_x37 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
            const double var_x264 = pow(var_x53, 2);
            const double var_x277 = sqrt(pow((10.800000000000001 - var_chaste_interface__Ca_concentrations_in_SR__Ca_Total), 2) + 3.2000000000000002 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total);
            const double var_x450 = 10.139999999999999 * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y;
            const double var_x453 = pow(mParameters[2], (-2));
            const double var_x454 = var_x216 * var_x450;
            const double var_x462 = -5.4000000000000004 + 0.5 * var_x277 + 0.5 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total;
            const double var_x464 = 280000 * var_x264 * var_x453;
            const double var_x465 = var_x199 * var_x454;
            const double var_x466 = pow(var_x462, 2);
            const double var_x467 = 0.000377 * var_x466;
            
            partialF = -0.00084900000000000004 + var_x465 - var_x464 - var_x467;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative31(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x277 = sqrt(pow((10.800000000000001 - var_chaste_interface__Ca_concentrations_in_SR__Ca_Total), 2) + 3.2000000000000002 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total);
            const double var_x279 = (-9.1999999999999993 + var_chaste_interface__Ca_concentrations_in_SR__Ca_Total) / var_x277;
            const double var_x280 = 0.5 + 0.5 * var_x279;
            const double var_x281 = mParameters[1] * var_chaste_interface__RyR_channel__p_open_RyR;
            const double var_x468 = 3.2387883511406234e-5 * var_x281;
            
            partialF = -0.0062508615177014034 - 0.0062508615177014034 * var_x279 - var_x280 * var_x468;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative32(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x273 = 1 + 0.080000000000000002 / var_chaste_interface__Ca_concentrations_in_SR__Caup;
            const double var_x282 = var_chaste_interface__SR_calcium_pump_y_gate__y / (pow(var_x273, 2) * pow(var_chaste_interface__Ca_concentrations_in_SR__Caup, 2));
            const double var_x283 = var_x282 * mParameters[3];
            const double var_x469 = 1.2955153404562494e-5 * mParameters[0];
            
            partialF = -0.0050006892141611229 - var_x469 - 1.0364122723649996e-8 * var_x283;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative33(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x6 = sqrt(pow((0.052380000000000003 - var_chaste_interface__internal_ion_concentrations__Ca_Total), 2) + 0.0095200000000000007 * var_chaste_interface__internal_ion_concentrations__Ca_Total);
            const double var_x470 = 0.0038999999999999998 * exp(-0.86212130841993795);
            const double var_x471 = 19.5 * var_x6 + 19.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
            
            partialF = 0.99141000000000001 - var_x470 - var_x471;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative34(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x285 = pow((1.1488559970494261 - 1.2 * var_chaste_interface__NL_model__X), 2);
            const double var_x473 = 0.027 * var_x285;
            
            partialF = -0.0339 - var_x473;
        }
        else
        {
    ...
    double Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::EvaluatePartialDerivative35(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x285 = pow((1.1488559970494261 - 1.2 * var_chaste_interface__NL_model__X), 2);
            const double var_x473 = 0.027 * var_x285;
            const double var_x474 = 780 * var_x6 + 780 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
            
            partialF = 40.736400000000003 - var_x473 - var_x474;
        }
        else
        {
    ...
    std::vector<double> Dynamicmatsuoka_model_2003FromCellMLGRL1Opt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        ...
        const double var_Ca_concentrations_in_SR__Carel = 0.5 * sqrt(pow(var_Ca_concentrations_in_SR__b1, 2) + 4 * var_Ca_concentrations_in_SR__c1) - 0.5 * var_Ca_concentrations_in_SR__b1; // millimolar
        const double var_L_type_Ca_channel__p_open_CaL = (var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U + var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_UCa) * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL / (1 + 2.7439999999999993 / pow(var_chaste_interface__ATP_production__ATPi, 3)); // dimensionless
        ...
        const double var_internal_ion_concentrations__Cai = 0.5 * sqrt(pow(var_internal_ion_concentrations__b1, 2) + 4 * var_internal_ion_concentrations__c1) - 0.5 * var_internal_ion_concentrations__b1; // millimolar
        const double var_RyR_channel__i_RyR = (-var_internal_ion_concentrations__Cai + var_Ca_concentrations_in_SR__Carel) * mParameters[1] * var_chaste_interface__RyR_channel__p_open_RyR; // picoA
