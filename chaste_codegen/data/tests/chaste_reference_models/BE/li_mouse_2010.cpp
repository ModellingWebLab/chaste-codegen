...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellli_mouse_2010FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_chaste_interface__i_ionic = var_L_type_calcium_current__i_CaL_converted + var_fast_sodium_current__i_Na_converted + var_non_inactivating_steady_state_K_I__i_Kss_converted + var_rapid_delayed_rectifier_K_I__i_Kr_converted + var_slow_delayed_rectifier_K_I__i_Ks_converted + var_sodium_calcium_exchange_current__i_NCX_converted + var_time_independent_K_I__i_K1_converted + HeartConfig::Instance()->GetCapacitance() * var_calcium_activated_chloride_current__i_ClCa + HeartConfig::Instance()->GetCapacitance() * var_calcium_background_current__i_Cab + HeartConfig::Instance()->GetCapacitance() * var_calcium_pump_current__i_pCa + HeartConfig::Instance()->GetCapacitance() * var_fast_transient_outward_K_I__i_Kto_f + HeartConfig::Instance()->GetCapacitance() * var_slow_transient_outward_K_I__i_Kto_s + HeartConfig::Instance()->GetCapacitance() * var_sodium_background_current__i_Nab + HeartConfig::Instance()->GetCapacitance() * var_sodium_potassium_pump_current__i_NaK + HeartConfig::Instance()->GetCapacitance() * var_ultra_rapidly_activating_delayed_rectifier_K_I__i_Kur; // uA_per_cm2
    ...
    void Cellli_mouse_2010FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[26], double rJacobian[26][26])
    {
        ...
        const double var_x33 = var_x22 * var_x31 / pow((1.6974399999999999e-7 + var_x32), 2);
        ...
        const double var_x59 = 1 / (var_x54 + var_x58 + 1400 * var_x53 + 1728000000000.0 * var_x55 + 3.6000000000000001 * var_x56 + 6.81472e+17 * var_chaste_interface__calcium_concentration__Cai_converted);
        const double var_x60 = var_x52 * var_x59 * mParameters[11];
        const double var_x61 = var_x50 * var_x51 * var_x60;
        const double var_x62 = pow((2.0543764087152516e-15 * var_x53 + 5.282682193839219e-18 * var_x56 + 2.535687453042825e-6 * var_x55 + 1.4674117205108941e-18 * var_x54 + 1.4674117205108941e-15 * var_x51 * var_chaste_interface__calcium_concentration__Cai_converted + var_chaste_interface__calcium_concentration__Cai_converted), (-2));
        ...
        const double var_x65 = -6.81472e+17 - var_x57 - 480000000000000.0 * mParameters[1];
        ...
        const double var_x73 = 0.59999999999999998 + var_chaste_interface__calcium_concentration__Cass;
        const double var_x74 = pow(var_x73, (-2));
        const double var_x75 = 1 / (1 + 65.399999999999991 * var_x74);
        const double var_x76 = 0.075369662812530269 * var_chaste_interface__cell__V;
        ...
        const double var_x79 = 0.0023079445283571576 * var_x78 * var_chaste_interface__cell__V / (1 - var_x77);
        const double var_x80 = var_x79 * (-var_chaste_interface__calcium_concentration__Cass + var_x77 * mParameters[1]);
        const double var_x81 = fabs(var_x76) > 1.0000000000000001e-5;
        const double var_x82 = exp(-1.0000000000000001e-5);
        const double var_x83 = 3.062166450310111e-7 * var_x78 / (1 - var_x82);
        ...
        const double var_x86 = 32.656617993405561 * mParameters[5];
        const double var_x87 = 3.5000000000000004 * var_x75;
        ...
        const double var_x90 = 0.2857142857142857 * exp(-0.038580246913580245 * pow((-1 + 0.20000000000000001 * var_chaste_interface__cell__V), 2));
        const double var_x91 = 0.04926108374384236 * var_chaste_interface__cell__V;
        const double var_x92 = 0.20000000000000001 * exp(0.12315270935960591 - var_x91);
        const double var_x93 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__cell__V);
        const double var_x94 = 1 / (0.25 * var_x93 + 0.1027 * exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__cell__V));
        const double var_x95 = 3.802 * var_x94;
        const double var_x96 = 0.008539999999999999 + 2.0000000000000002e-5 * var_chaste_interface__cell__V;
        const double var_x97 = 3.802 / (0.1027 * exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__cell__V) + 0.23000000000000001 * var_x93);
        const double var_x98 = exp(-0.90909090909090906 - 0.12987012987012986 * var_chaste_interface__cell__V);
        const double var_x99 = 6.9999999999999997e-7 * var_x98;
        const double var_x100 = exp(0.36945812807881773 - var_x91);
        const double var_x101 = 0.22 * var_x100;
        const double var_x102 = 3.802 / (0.20000000000000001 * var_x93 + 0.1027 * exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__cell__V));
        const double var_x103 = -var_x102;
        const double var_x104 = 0.19170000000000001 * exp(-0.12315270935960591 - var_x91);
        const double var_x105 = var_x104 + var_x97;
        const double var_x106 = var_x102 + var_x96;
        const double var_x107 = 1 / (0.39395599999999997 + 0.188495 * exp(-0.42168674698795178 - 0.060240963855421679 * var_chaste_interface__cell__V));
        const double var_x108 = 1.0526315789473684e-5 * var_x107;
        const double var_x109 = 1.4e-8 * var_x98;
        const double var_x110 = 0.001 * var_x107;
        const double var_x111 = -var_x96;
        const double var_x112 = 1.2097272727272726e-5 * var_x107 * var_x94 * var_x98 / (var_x100 * var_x96);
        ...
        const double var_x116 = log(var_x115);
        const double var_x117 = -26.535875647668394 * var_x116 + var_chaste_interface__cell__V;
        const double var_x118 = 0.065313235986811116 * mParameters[5];
        const double var_x119 = var_chaste_interface__non_inactivating_steady_state_K_I__aKss * mParameters[8];
        const double var_x120 = 1 / (var_chaste_interface__potassium_concentration__Ki + 0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai);
        const double var_x121 = var_x120 * var_chaste_interface__rapid_delayed_rectifier_K_I__O_K * mParameters[9];
        const double var_x122 = 1.7331439082928402 * var_x114;
        const double var_x123 = exp(0.089599999999999999 * var_chaste_interface__cell__V - 2.3776144580310881 * var_x116);
        ...
        const double var_x127 = pow(var_x126, 2.3999999999999999);
        ...
        const double var_x129 = 0.022348 * exp(0.01176 * var_chaste_interface__cell__V);
        const double var_x130 = -var_x129;
        const double var_x131 = 0.033500000000000002 * exp(0.0109 * var_chaste_interface__cell__V);
        const double var_x132 = 6.8899999999999994e-5 * exp(-0.041779999999999998 * var_chaste_interface__cell__V);
        const double var_x133 = 0.0064970000000000002 * exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__cell__V);
        const double var_x134 = 0.070300000000000001 * exp(0.14349999999999999 + 0.0287 * var_chaste_interface__cell__V);
        const double var_x135 = 0.012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2) * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x136 = pow(var_chaste_interface__calcium_concentration__Cass, 3);
        const double var_x137 = 0.0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4);
        const double var_x138 = 0.0040499999999999998 * var_x136;
        const double var_x139 = 4.2191641619115923e-37 * var_x71;
        const double var_x140 = 1 / (var_chaste_interface__sodium_concentration__Nai + 0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki);
        ...
        rJacobian[3][4] = -(mDt * (-95.238095238095241 * var_x21 - 190.47619047619048 * var_x33 + 190476190.47619048 * var_x31 * var_x35 * var_chaste_interface__calcium_concentration__Cai_converted));
        ...
        rJacobian[4][4] = 1.0 - (mDt * (var_x47 * (-125 + var_x21 + 2 * var_x33 + (-65.313235986811122 * var_x61 - 0.00030330018395124703 * var_x48 + 0.0062374140367404624 * var_x22 / pow((8.3232249999999994e-8 + var_x32), 2) - 6237.4140367404616 * var_x49 * var_chaste_interface__calcium_concentration__Cai_converted + 1.4063880539705308e-37 * var_x52 * var_x62 * var_x64 * var_x65 * mParameters[11]) * mParameters[5] - 2000000 * var_x66 * var_chaste_interface__calcium_concentration__Cai_converted) + 1.3080000000000001e-7 * (0.125 * var_chaste_interface__calcium_concentration__Cass - 125 * var_chaste_interface__calcium_concentration__Cai_converted - var_x34 * var_x66 - 0.032656617993405558 * (0.00069999999999999999 * var_chaste_interface__cell__V - 0.0092875564766839377 * log(0.001 * var_x48 * mParameters[1]) + 95500 * var_x32 * var_x49 - 2 * var_x59 * var_x67) * mParameters[5] + ((var_x12) ? (3.0000000000000001e-5 * var_chaste_interface__calcium_concentration__CaNSR - 0.029999999999999999 * var_chaste_interface__calcium_concentration__Cai_converted) : (0.10000000000000001 * var_chaste_interface__calcium_concentration__CaNSR - 100 * var_chaste_interface__calcium_concentration__Cai_converted))) / (pow(var_x44, 3) * pow(var_x45, 2))));
        ...
        rJacobian[4][23] = 0.0;
        rJacobian[4][24] = 0.0;
        rJacobian[4][25] = -(mDt * (var_x47 * (0.19593970796043336 * var_x72 + 1.4063880539705308e-37 * var_x70 * var_x71) * mParameters[5]));
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = -(mDt * (-var_x75 * var_x85 * var_x86));
        rJacobian[5][2] = -(mDt * (var_x13 * var_x87));
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = -(mDt * (125000 * var_x75));
        rJacobian[5][5] = 1.0 - (mDt * (var_x75 * (-125 + 3.5000000000000004 * var_x16 - var_x86 * var_x88) + 0.030581039755351685 * (125000 * var_chaste_interface__calcium_concentration__Cai_converted + 3.5000000000000004 * var_x15 - 125 * var_chaste_interface__calcium_concentration__Cass - var_x86 * ((var_x81) ? (-var_x80 * var_chaste_interface__L_type_calcium_current__O) : (-var_x84 * var_chaste_interface__L_type_calcium_current__O))) / (pow(var_x73, 3) * pow((0.015290519877675841 + var_x74), 2))));
        rJacobian[5][6] = 0.0;
        ...
        rJacobian[17][17] = 1.0 - (mDt * ((-1.7331439082928402 * var_x121 - var_x119 * var_x122 * var_chaste_interface__non_inactivating_steady_state_K_I__iKss - var_x122 * pow(var_chaste_interface__slow_delayed_rectifier_K_I__nKs, 2) * mParameters[10] - 0.43328597707321004 * var_x114 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__aur * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__iur - 0.92671204776418159 * var_x114 * pow(var_chaste_interface__fast_transient_outward_K_I__ato_f, 3) * var_chaste_interface__fast_transient_outward_K_I__ito_f - 1.7331439082928402 * var_x115 * var_x125 * mParameters[7] / var_x124 + 0.15528969418303848 * var_x114 * var_x117 * var_x123 * var_x125 * mParameters[2] * mParameters[7] / pow(var_x124, 2)) * mParameters[5]));
        rJacobian[17][18] = 0.0;
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = 0.0;
        rJacobian[17][21] = -(mDt * (var_x118 * (-var_chaste_interface__cell__V + 26.535875647668394 * log(var_x120 * (mParameters[2] + 0.020408163265306124 * mParameters[3]))) * mParameters[9]));
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = 0.0;
        rJacobian[17][24] = 0.0;
        rJacobian[17][25] = -(mDt * ((5.8007500451501034e-11 * var_x128 - 0.035370283842711021 * var_x121) * mParameters[5]));
        rJacobian[18][0] = 0.0;
        rJacobian[18][1] = 0.0;
        rJacobian[18][2] = 0.0;
        rJacobian[18][3] = 0.0;
        ...
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-0.023761000000000001 - var_x129 - 0.047002000000000002 * exp(-0.063100000000000003 * var_chaste_interface__cell__V)));
        rJacobian[18][19] = -(mDt * (0.036777999999999998 - var_x129));
        ...
        rJacobian[19][19] = 1.0 - (mDt * (-0.036777999999999998 - var_x131));
        rJacobian[19][20] = 0.0;
        ...
        rJacobian[23][3] = 0.0;
        rJacobian[23][4] = 0.0;
        rJacobian[23][5] = -(mDt * (-var_x135 + 0.024299999999999999 * var_x136 * (1 - var_x9 - var_chaste_interface__ryanodine_receptors__P_C2)));
        rJacobian[23][6] = 0.0;
        rJacobian[23][7] = 0.0;
        rJacobian[23][8] = 0.0;
        rJacobian[23][9] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (0.00080000000000000004 - var_x137));
        rJacobian[23][23] = 1.0 - (mDt * (-0.080249999999999988 - var_x137 - var_x138));
        rJacobian[23][24] = -(mDt * (0.96499999999999997 - var_x137));
        rJacobian[23][25] = 0.0;
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = 0.0;
        rJacobian[24][2] = 0.0;
        ...
        rJacobian[25][2] = 0.0;
        rJacobian[25][3] = 0.0;
        rJacobian[25][4] = -(mDt * ((195.93970796043337 * var_x61 - var_x139 * var_x65) * mParameters[5]));
        rJacobian[25][5] = 0.0;
        rJacobian[25][6] = 0.0;
        rJacobian[25][7] = 0.0;
        rJacobian[25][8] = 0.0;
        ...
        rJacobian[25][13] = 0.0;
        rJacobian[25][14] = 0.0;
        rJacobian[25][15] = -(mDt * (var_x118 * (-var_chaste_interface__cell__V + 26.535875647668394 * log(var_x140 * (mParameters[3] + 0.1111111111111111 * mParameters[2]))) * mParameters[6]));
        rJacobian[25][16] = 0.0;
        rJacobian[25][17] = -(mDt * ((-0.0005006860179512649 * var_x140 - 0.19257154536587112 * var_x141) * mParameters[5]));
        rJacobian[25][18] = 0.0;
        rJacobian[25][19] = 0.0;
        rJacobian[25][20] = 0.0;
        rJacobian[25][21] = 0.0;
        ...
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = 0.0;
        rJacobian[25][25] = 1.0 - (mDt * ((-1.7331439082928402 * var_x141 - 0.004506174161561384 * var_x140 - 0.58781912388130009 * var_x72 - 8.7011250677251544e-11 * var_x128 - var_x139 * var_x70) * mParameters[5]));
    }
