...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellli_mouse_2010FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[26], double rJacobian[26][26])
    {
        ...
        const double var_x79 = 3.0621664503101105e-9 * var_x78;
        const double var_x80 = var_x79 / (1 - var_x77);
        const double var_x81 = var_x80 * (-var_chaste_interface__calcium_concentration__Cass + var_x77 * mParameters[1]);
        const double var_x82 = exp(-9.9999999999999995e-8);
        const double var_x83 = var_x79 / (1 - var_x82);
        const double var_x84 = var_x83 * (-var_chaste_interface__calcium_concentration__Cass + var_x82 * mParameters[1]);
        const double var_x85 = (var_chaste_interface__cell__V >= -1.3267937823834197e-6) && (var_chaste_interface__cell__V <= 1.3267937823834197e-6);
        const double var_x86 = exp(-0.075369662812530269 * var_chaste_interface__cell__V);
        const double var_x87 = 0.0023079445283571576 * var_x78 * var_chaste_interface__cell__V / (1 - var_x86);
        const double var_x88 = var_x87 * (-var_chaste_interface__calcium_concentration__Cass + var_x86 * mParameters[1]);
        const double var_x89 = ((var_x85) ? (var_x81 + var_x76 * (-var_x81 - var_x84)) : (-var_x88));
        const double var_x90 = 32.656617993405561 * mParameters[5];
        const double var_x91 = 3.5000000000000004 * var_x75;
        const double var_x92 = var_x80 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x93 = ((var_x85) ? (-var_x92 + var_x76 * (var_x92 + var_x83 * var_chaste_interface__L_type_calcium_current__O)) : (var_x87 * var_chaste_interface__L_type_calcium_current__O));
        const double var_x94 = var_x81 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x95 = var_x18 * var_x91;
        const double var_x96 = 0.2857142857142857 * exp(-0.038580246913580245 * pow((-1 + 0.20000000000000001 * var_chaste_interface__cell__V), 2));
        const double var_x97 = 0.04926108374384236 * var_chaste_interface__cell__V;
        const double var_x98 = 0.20000000000000001 * exp(0.12315270935960591 - var_x97);
        const double var_x99 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__cell__V);
        const double var_x100 = 1 / (0.25 * var_x99 + 0.1027 * exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__cell__V));
        const double var_x101 = 3.802 * var_x100;
        const double var_x102 = 0.008539999999999999 + 2.0000000000000002e-5 * var_chaste_interface__cell__V;
        const double var_x103 = 3.802 / (0.1027 * exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__cell__V) + 0.23000000000000001 * var_x99);
        const double var_x104 = exp(-0.90909090909090906 - 0.12987012987012986 * var_chaste_interface__cell__V);
        const double var_x105 = 6.9999999999999997e-7 * var_x104;
        const double var_x106 = exp(0.36945812807881773 - var_x97);
        const double var_x107 = 0.22 * var_x106;
        const double var_x108 = 3.802 / (0.20000000000000001 * var_x99 + 0.1027 * exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__cell__V));
        const double var_x109 = -var_x108;
        const double var_x110 = 0.19170000000000001 * exp(-0.12315270935960591 - var_x97);
        const double var_x111 = var_x103 + var_x110;
        const double var_x112 = var_x102 + var_x108;
        ...
        const double var_x115 = 1.4e-8 * var_x104;
        const double var_x116 = 0.001 * var_x113;
        const double var_x117 = -var_x102;
        const double var_x118 = 1.2097272727272726e-5 * var_x100 * var_x104 * var_x113 / (var_x102 * var_x106);
        const double var_x119 = var_x113;
        const double var_x120 = 1 / var_chaste_interface__potassium_concentration__Ki;
        const double var_x121 = var_x120 * mParameters[2];
        const double var_x122 = log(var_x121);
        const double var_x123 = -26.535875647668394 * var_x122 + var_chaste_interface__cell__V;
        const double var_x124 = 0.065313235986811116 * mParameters[5];
        const double var_x125 = var_chaste_interface__non_inactivating_steady_state_K_I__aKss * mParameters[8];
        const double var_x126 = 1 / (var_chaste_interface__potassium_concentration__Ki + 0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai);
        const double var_x127 = var_x126 * var_chaste_interface__rapid_delayed_rectifier_K_I__O_K * mParameters[9];
        const double var_x128 = 1.7331439082928402 * var_x120;
        const double var_x129 = exp(0.089599999999999999 * var_chaste_interface__cell__V - 2.3776144580310881 * var_x122);
        const double var_x130 = 1 + var_x129;
        const double var_x131 = 1 / (210 + mParameters[2]);
        const double var_x132 = 1 / var_chaste_interface__sodium_concentration__Nai;
        const double var_x133 = pow(var_x132, 2.3999999999999999);
        const double var_x134 = var_x132 * var_x133 * mParameters[2] / ((1500 + mParameters[2]) * pow((7.44287265976699e-11 + var_x133), 2) * (1 + 0.1245 * exp(-0.0037684831406265135 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.4858841010401188e-5 * mParameters[3])) * exp(-0.037684831406265135 * var_chaste_interface__cell__V)));
        const double var_x135 = 0.022348 * exp(0.01176 * var_chaste_interface__cell__V);
        ...
        const double var_x141 = 0.012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2) * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x142 = pow(var_chaste_interface__calcium_concentration__Cass, 3);
        const double var_x143 = 0.0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4);
        const double var_x144 = 0.0040499999999999998 * var_x142;
        const double var_x145 = 4.2191641619115923e-37 * var_x71;
        ...
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = -(mDt * (-var_x75 * var_x89 * var_x90));
        rJacobian[5][2] = -(mDt * (var_x13 * var_x91));
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = -(mDt * (125000 * var_x75));
        rJacobian[5][5] = 1.0 - (mDt * (var_x75 * (-125 + 3.5000000000000004 * var_x16 - var_x90 * var_x93) + 0.030581039755351685 * (125000 * var_chaste_interface__calcium_concentration__Cai_converted + 3.5000000000000004 * var_x15 - 125 * var_chaste_interface__calcium_concentration__Cass - var_x90 * ((var_x85) ? (var_x94 + 376848.31406265136 * (1.3267937823834197e-6 + var_chaste_interface__cell__V) * (-var_x94 - var_x84 * var_chaste_interface__L_type_calcium_current__O)) : (-var_x88 * var_chaste_interface__L_type_calcium_current__O))) / (pow(var_x73, 3) * pow((0.015290519877675841 + var_x74), 2))));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = -(mDt * (var_x17 * var_x91));
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = 0.0;
        ...
        rJacobian[5][21] = 0.0;
        rJacobian[5][22] = 0.0;
        rJacobian[5][23] = -(mDt * (var_x95));
        rJacobian[5][24] = -(mDt * (var_x95));
        rJacobian[5][25] = 0.0;
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        ...
        rJacobian[6][25] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = -(mDt * (-var_x89 * var_x96));
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = -(mDt * (-var_x93 * var_x96));
        rJacobian[7][6] = 0.0;
        ...
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (-var_x101 - var_x102 - var_x98));
        rJacobian[8][9] = -(mDt * (var_x103));
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = -(mDt * (var_x105));
        rJacobian[8][15] = -(mDt * (var_x107));
        rJacobian[8][16] = 0.0;
        rJacobian[8][17] = 0.0;
        rJacobian[8][18] = 0.0;
        rJacobian[8][19] = 0.0;
        ...
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = -(mDt * (var_x109 + var_x98));
        rJacobian[9][9] = 1.0 - (mDt * (-var_x111 - var_x112));
        rJacobian[9][10] = -(mDt * (var_x109));
        rJacobian[9][11] = -(mDt * (var_x109));
        rJacobian[9][12] = -(mDt * (var_x105 + var_x109));
        rJacobian[9][13] = -(mDt * (var_x109));
        rJacobian[9][14] = -(mDt * (var_x109));
        rJacobian[9][15] = -(mDt * (var_x109));
        rJacobian[9][16] = 0.0;
        rJacobian[9][17] = 0.0;
        rJacobian[9][18] = 0.0;
        rJacobian[9][19] = 0.0;
        ...
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-var_x105 - var_x114));
        ...
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = -(mDt * (var_x102));
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-var_x105 - var_x111));
        rJacobian[12][13] = -(mDt * (var_x108));
        rJacobian[12][14] = -(mDt * (var_x98));
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        rJacobian[12][17] = 0.0;
        rJacobian[12][18] = 0.0;
        ...
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = -(mDt * (var_x117));
        rJacobian[13][9] = -(mDt * (var_x117));
        rJacobian[13][10] = -(mDt * (var_x117));
        rJacobian[13][11] = -(mDt * (var_x117));
        rJacobian[13][12] = -(mDt * (var_x110 - var_x102));
        rJacobian[13][13] = 1.0 - (mDt * (-var_x105 - var_x112));
        rJacobian[13][14] = -(mDt * (var_x117));
        rJacobian[13][15] = -(mDt * (var_x117));
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        rJacobian[13][18] = 0.0;
        rJacobian[13][19] = 0.0;
        ...
        rJacobian[14][6] = 0.0;
        rJacobian[14][7] = 0.0;
        rJacobian[14][8] = -(mDt * (var_x102));
        rJacobian[14][9] = 0.0;
        rJacobian[14][10] = -(mDt * (var_x105));
        rJacobian[14][11] = 0.0;
        rJacobian[14][12] = -(mDt * (var_x103));
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-var_x105 - var_x116 - var_x118 - var_x98));
        ...
        rJacobian[15][15] = 1.0 - (mDt * (-var_x107 - var_x119));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-0.023761000000000001 - var_x135 - 0.047002000000000002 * exp(-0.063100000000000003 * var_chaste_interface__cell__V)));
        rJacobian[18][19] = -(mDt * (0.036777999999999998 - var_x135));
        ...
        rJacobian[23][3] = 0.0;
        rJacobian[23][4] = 0.0;
        rJacobian[23][5] = -(mDt * (-var_x141 + 0.024299999999999999 * var_x142 * (1 - var_x9 - var_chaste_interface__ryanodine_receptors__P_C2)));
        rJacobian[23][6] = 0.0;
        rJacobian[23][7] = 0.0;
        rJacobian[23][8] = 0.0;
        rJacobian[23][9] = 0.0;
        ...
        rJacobian[25][2] = 0.0;
        rJacobian[25][3] = 0.0;
        rJacobian[25][4] = -(mDt * ((195.93970796043337 * var_x61 - var_x145 * var_x65) * mParameters[5]));
        rJacobian[25][5] = 0.0;
        rJacobian[25][6] = 0.0;
        rJacobian[25][7] = 0.0;
        rJacobian[25][8] = 0.0;
        ...
        rJacobian[25][13] = 0.0;
        rJacobian[25][14] = 0.0;
        rJacobian[25][15] = -(mDt * (var_x124 * (-var_chaste_interface__cell__V + 26.535875647668394 * log(var_x146 * (mParameters[3] + 0.1111111111111111 * mParameters[2]))) * mParameters[6]));
        rJacobian[25][16] = 0.0;
        ...
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = 0.0;
        rJacobian[25][25] = 1.0 - (mDt * ((-1.7331439082928402 * var_x147 - 0.004506174161561384 * var_x146 - 0.58781912388130009 * var_x72 - 8.7011250677251544e-11 * var_x134 - var_x145 * var_x70) * mParameters[5]));
    }
