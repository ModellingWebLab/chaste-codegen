...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellli_mouse_2010FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_calcium_current__i_CaL = (((var_chaste_interface__cell__V >= -1.3267937823834197e-6) && (var_chaste_interface__cell__V <= 1.3267937823834197e-6)) ? (376848.31406265136 * (1.3267937823834197e-6 + var_chaste_interface__cell__V) * (-3.0621664503101105e-9 * (-var_chaste_interface__calcium_concentration__Cass + mParameters[1] * exp(9.9999999999999995e-8)) * var_chaste_interface__L_type_calcium_current__O * mParameters[4] * var_chaste_interface__L_type_calcium_current__y_gate / ((1.0 - exp(9.9999999999999995e-8)) * mParameters[5]) - 3.0621664503101105e-9 * (-var_chaste_interface__calcium_concentration__Cass + mParameters[1] * exp(-9.9999999999999995e-8)) * var_chaste_interface__L_type_calcium_current__O * mParameters[4] * var_chaste_interface__L_type_calcium_current__y_gate / ((1.0 - exp(-9.9999999999999995e-8)) * mParameters[5])) + 3.0621664503101105e-9 * (-var_chaste_interface__calcium_concentration__Cass + mParameters[1] * exp(9.9999999999999995e-8)) * var_chaste_interface__L_type_calcium_current__O * mParameters[4] * var_chaste_interface__L_type_calcium_current__y_gate / ((1.0 - exp(9.9999999999999995e-8)) * mParameters[5])) : (-0.0023079445283571576 * (-var_chaste_interface__calcium_concentration__Cass + mParameters[1] * exp(-0.075369662812530269 * var_chaste_interface__cell__V)) * var_chaste_interface__L_type_calcium_current__O * mParameters[4] * var_chaste_interface__L_type_calcium_current__y_gate * var_chaste_interface__cell__V / ((1.0 - exp(-0.075369662812530269 * var_chaste_interface__cell__V)) * mParameters[5]))); // picoA_per_picoF
    ...
    void Cellli_mouse_2010FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[26], double rJacobian[26][26])
    {
        ...
        const double var_x15 = ((var_x12) ? (var_x11 * var_x14) : (10.0 * var_chaste_interface__calcium_concentration__CaJSR - 10.0 * var_chaste_interface__calcium_concentration__Cass));
        const double var_x16 = ((var_x12) ? (-var_x10 * var_x9) : (-10.0));
        ...
        const double var_x21 = ((var_x12) ? (-0.029999999999999999) : (-100.0));
        const double var_x22 = pow(var_chaste_interface__calcium_concentration__Cai_converted, 3);
        const double var_x23 = 1.0 - var_chaste_interface__calcium_fluxes__CaMKt;
        const double var_x24 = 1.0 + 0.69999999999999996 / var_chaste_interface__calcium_concentration__Cass;
        ...
        const double var_x34 = 1000000.0 * var_x32;
        ...
        const double var_x45 = 1.0 + 6.5400000000000004e-5 / pow(var_x44, 2);
        ...
        const double var_x52 = 1 / (1.0 + 0.27000000000000002 * var_x50);
        const double var_x53 = pow(var_chaste_interface__sodium_concentration__Nai, 3);
        const double var_x54 = var_x53 * mParameters[1];
        const double var_x55 = (1.0 + 277.77777777777777 * var_chaste_interface__calcium_concentration__Cai_converted) * mParameters[1];
        const double var_x56 = var_x51 * (1.0 + 5.7870370370370368e-13 * var_x53);
        const double var_x57 = 1000.0 * var_x51;
        const double var_x58 = var_x57 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x59 = 1 / (var_x54 + var_x58 + 1400.0 * var_x53 + 1728000000000.0 * var_x55 + 3.6000000000000001 * var_x56 + 6.81472e+17 * var_chaste_interface__calcium_concentration__Cai_converted);
        ...
        const double var_x70 = -3 * var_x69 - 4200.0 * var_x68 - 6.2500000000000002e-12 * var_x51 * var_x68;
        ...
        const double var_x75 = 1 / (1.0 + 65.399999999999991 * var_x74);
        ...
        const double var_x83 = var_x79 / (1.0 - var_x82);
        ...
        const double var_x87 = 0.0023079445283571576 * var_x78 * var_chaste_interface__cell__V / (1.0 - var_x86);
        ...
        const double var_x131 = 1 / (210.0 + mParameters[2]);
        ...
        const double var_x141 = 0.012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2.0) * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x142 = pow(var_chaste_interface__calcium_concentration__Cass, 3.0);
        ...
        rJacobian[4][4] = 1.0 - (mDt * (var_x47 * (-125.0 + var_x21 + 2.0 * var_x33 + (-65.313235986811122 * var_x61 - 0.00030330018395124703 * var_x48 + 0.0062374140367404624 * var_x22 / pow((8.3232249999999994e-8 + var_x32), 2) - 6237.4140367404616 * var_x49 * var_chaste_interface__calcium_concentration__Cai_converted + 1.4063880539705308e-37 * var_x52 * var_x62 * var_x64 * var_x65 * mParameters[11]) * mParameters[5] - 2000000.0 * var_x66 * var_chaste_interface__calcium_concentration__Cai_converted) + 1.3080000000000001e-7 * (0.125 * var_chaste_interface__calcium_concentration__Cass - 125.0 * var_chaste_interface__calcium_concentration__Cai_converted - var_x34 * var_x66 - 0.032656617993405558 * (0.00069999999999999999 * var_chaste_interface__cell__V - 0.0092875564766839377 * log(0.001 * var_x48 * mParameters[1]) + 95500.0 * var_x32 * var_x49 - 2.0 * var_x59 * var_x67) * mParameters[5] + ((var_x12) ? (3.0000000000000001e-5 * var_chaste_interface__calcium_concentration__CaNSR - 0.029999999999999999 * var_chaste_interface__calcium_concentration__Cai_converted) : (0.10000000000000001 * var_chaste_interface__calcium_concentration__CaNSR - 100.0 * var_chaste_interface__calcium_concentration__Cai_converted))) / (pow(var_x44, 3) * pow(var_x45, 2))));
        rJacobian[4][5] = -(mDt * (var_x47 * (0.125 - var_x34 * var_x40)));
        rJacobian[4][6] = -(mDt * (-1000.0 * var_x32 * var_x43 * var_x46));
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = 0.0;
        ...
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = -(mDt * (125000.0 * var_x75));
        rJacobian[5][5] = 1.0 - (mDt * (var_x75 * (-125.0 + 3.5000000000000004 * var_x16 - var_x90 * var_x93) + 0.030581039755351685 * (125000.0 * var_chaste_interface__calcium_concentration__Cai_converted + 3.5000000000000004 * var_x15 - 125.0 * var_chaste_interface__calcium_concentration__Cass - var_x90 * ((var_x85) ? (var_x94 + 376848.31406265136 * (1.3267937823834197e-6 + var_chaste_interface__cell__V) * (-var_x94 - var_x84 * var_chaste_interface__L_type_calcium_current__O)) : (-var_x88 * var_chaste_interface__L_type_calcium_current__O))) / (pow(var_x73, 3) * pow((0.015290519877675841 + var_x74), 2))));
        rJacobian[5][6] = 0.0;
        ...
        rJacobian[23][3] = 0.0;
        rJacobian[23][4] = 0.0;
        rJacobian[23][5] = -(mDt * (-var_x141 + 0.024299999999999999 * var_x142 * (1.0 - var_x9 - var_chaste_interface__ryanodine_receptors__P_C2)));
        rJacobian[23][6] = 0.0;
        rJacobian[23][7] = 0.0;
        rJacobian[23][8] = 0.0;
        rJacobian[23][9] = 0.0;
