...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellli_mouse_2010FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[26], double rResidual[26])
    {
        ...
        const double var_cell__prepulses_number = 10000000000; // dimensionless
        const double var_chaste_interface__cell__stim_period = 333.33300000000003; // millisecond
    ...
    void Cellli_mouse_2010FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[26], double rJacobian[26][26])
    {
        ...
        const double var_x59 = 1 / (var_x54 + var_x58 + 1400 * var_x53 + 1728000000000 * var_x55 + 3.6000000000000001 * var_x56 + 681472000000000000 * var_chaste_interface__calcium_concentration__Cai_converted);
        ...
        const double var_x65 = -681472000000000000 - var_x57 - 480000000000000 * mParameters[1];
        ...
        const double var_x76 = 0.5 + 376848.31406265136 * var_chaste_interface__cell__V;
        const double var_x77 = mParameters[4] * var_chaste_interface__L_type_calcium_current__y_gate / mParameters[5];
        const double var_x78 = 0.030621666034204905 * var_x77 * (-var_chaste_interface__calcium_concentration__Cass + 0.99999990000000505 * mParameters[1]);
        const double var_x79 = 0.030621662971829972 * var_x77;
        const double var_x80 = var_x79 * (-var_chaste_interface__calcium_concentration__Cass + 1.0000001000000049 * mParameters[1]);
        const double var_x81 = (var_chaste_interface__cell__V >= -1.3267937823834197e-6) && (var_chaste_interface__cell__V <= 1.3267937823834197e-6);
        const double var_x82 = exp(-0.075369662812530269 * var_chaste_interface__cell__V);
        const double var_x83 = 0.0023079445283571576 * var_chaste_interface__cell__V / (1 - var_x82);
        const double var_x84 = var_x83 * (-var_chaste_interface__calcium_concentration__Cass + var_x82 * mParameters[1]);
        const double var_x85 = ((var_x81) ? (-var_x80 + var_x76 * (var_x80 - var_x78)) : (-var_x77 * var_x84));
        const double var_x86 = 32.656617993405561 * mParameters[5];
        const double var_x87 = 3.5000000000000004 * var_x75;
        const double var_x88 = var_x77 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x89 = ((var_x81) ? (var_x79 * var_chaste_interface__L_type_calcium_current__O + 3.0623749345019217e-9 * var_x76 * var_x88) : (var_x83 * var_x88));
        const double var_x90 = var_x80 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x91 = var_x18 * var_x87;
        const double var_x92 = 0.2857142857142857 * exp(-0.038580246913580245 * pow((-1 + 0.20000000000000001 * var_chaste_interface__cell__V), 2));
        const double var_x93 = 0.04926108374384236 * var_chaste_interface__cell__V;
        const double var_x94 = 0.20000000000000001 * exp(0.12315270935960591 - var_x93);
        const double var_x95 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__cell__V);
        const double var_x96 = 1 / (0.25 * var_x95 + 0.1027 * exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__cell__V));
        const double var_x97 = 3.802 * var_x96;
        const double var_x98 = 0.008539999999999999 + 2.0000000000000002e-5 * var_chaste_interface__cell__V;
        const double var_x99 = 3.802 / (0.1027 * exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__cell__V) + 0.23000000000000001 * var_x95);
        const double var_x100 = exp(-0.90909090909090906 - 0.12987012987012986 * var_chaste_interface__cell__V);
        const double var_x101 = 6.9999999999999997e-7 * var_x100;
        const double var_x102 = exp(0.36945812807881773 - var_x93);
        const double var_x103 = 0.22 * var_x102;
        const double var_x104 = 3.802 / (0.20000000000000001 * var_x95 + 0.1027 * exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__cell__V));
        const double var_x105 = -var_x104;
        const double var_x106 = 0.19170000000000001 * exp(-0.12315270935960591 - var_x93);
        const double var_x107 = var_x106 + var_x99;
        const double var_x108 = var_x104 + var_x98;
        const double var_x109 = 1 / (0.39395599999999997 + 0.188495 * exp(-0.42168674698795178 - 0.060240963855421679 * var_chaste_interface__cell__V));
        const double var_x110 = 1.0526315789473684e-5 * var_x109;
        const double var_x111 = 1.4e-8 * var_x100;
        const double var_x112 = 0.001 * var_x109;
        const double var_x113 = -var_x98;
        const double var_x114 = 1.2097272727272726e-5 * var_x100 * var_x109 * var_x96 / (var_x102 * var_x98);
        const double var_x115 = var_x109;
        const double var_x116 = 1 / var_chaste_interface__potassium_concentration__Ki;
        const double var_x117 = var_x116 * mParameters[2];
        const double var_x118 = log(var_x117);
        const double var_x119 = -26.535875647668394 * var_x118 + var_chaste_interface__cell__V;
        const double var_x120 = 0.065313235986811116 * mParameters[5];
        const double var_x121 = var_chaste_interface__non_inactivating_steady_state_K_I__aKss * mParameters[8];
        const double var_x122 = 1 / (var_chaste_interface__potassium_concentration__Ki + 0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai);
        const double var_x123 = var_x122 * var_chaste_interface__rapid_delayed_rectifier_K_I__O_K * mParameters[9];
        const double var_x124 = 1.7331439082928402 * var_x116;
        const double var_x125 = exp(0.089599999999999999 * var_chaste_interface__cell__V - 2.3776144580310881 * var_x118);
        const double var_x126 = 1 + var_x125;
        const double var_x127 = 1 / (210 + mParameters[2]);
        const double var_x128 = 1 / var_chaste_interface__sodium_concentration__Nai;
        const double var_x129 = pow(var_x128, 2.3999999999999999);
        const double var_x130 = var_x128 * var_x129 * mParameters[2] / ((1500 + mParameters[2]) * pow((7.44287265976699e-11 + var_x129), 2) * (1 + 0.1245 * exp(-0.0037684831406265135 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.4858841010401188e-5 * mParameters[3])) * exp(-0.037684831406265135 * var_chaste_interface__cell__V)));
        const double var_x131 = 0.022348 * exp(0.01176 * var_chaste_interface__cell__V);
        const double var_x132 = -var_x131;
        const double var_x133 = 0.033500000000000002 * exp(0.0109 * var_chaste_interface__cell__V);
        const double var_x134 = 6.8899999999999994e-5 * exp(-0.041779999999999998 * var_chaste_interface__cell__V);
        const double var_x135 = 0.0064970000000000002 * exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__cell__V);
        const double var_x136 = 0.070300000000000001 * exp(0.14349999999999999 + 0.0287 * var_chaste_interface__cell__V);
        const double var_x137 = 0.012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2) * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x138 = pow(var_chaste_interface__calcium_concentration__Cass, 3);
        const double var_x139 = 0.0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4);
        const double var_x140 = 0.0040499999999999998 * var_x138;
        const double var_x141 = 4.2191641619115923e-37 * var_x71;
        const double var_x142 = 1 / (var_chaste_interface__sodium_concentration__Nai + 0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki);
        const double var_x143 = var_x142 * var_chaste_interface__fast_sodium_current__O_Na * mParameters[6];
        ...
        rJacobian[5][5] = 1.0 - (mDt * (var_x75 * (-125 + 3.5000000000000004 * var_x16 - var_x86 * var_x89) + 0.030581039755351685 * (125000 * var_chaste_interface__calcium_concentration__Cai_converted + 3.5000000000000004 * var_x15 - 125 * var_chaste_interface__calcium_concentration__Cass - var_x86 * ((var_x81) ? (-var_x90 + 376848.31406265136 * (1.3267937823834197e-6 + var_chaste_interface__cell__V) * (var_x90 - var_x78 * var_chaste_interface__L_type_calcium_current__O)) : (-var_x84 * var_x88))) / (pow(var_x73, 3) * pow((0.015290519877675841 + var_x74), 2))));
        rJacobian[5][6] = 0.0;
        ...
        rJacobian[6][25] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = -(mDt * (-var_x85 * var_x92));
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = -(mDt * (-var_x89 * var_x92));
        rJacobian[7][6] = 0.0;
        ...
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (-var_x94 - var_x97 - var_x98));
        rJacobian[8][9] = -(mDt * (var_x99));
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = -(mDt * (var_x101));
        rJacobian[8][15] = -(mDt * (var_x103));
        rJacobian[8][16] = 0.0;
        rJacobian[8][17] = 0.0;
        rJacobian[8][18] = 0.0;
        rJacobian[8][19] = 0.0;
        ...
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = -(mDt * (var_x105 + var_x94));
        rJacobian[9][9] = 1.0 - (mDt * (-var_x107 - var_x108));
        rJacobian[9][10] = -(mDt * (var_x105));
        rJacobian[9][11] = -(mDt * (var_x105));
        rJacobian[9][12] = -(mDt * (var_x101 + var_x105));
        rJacobian[9][13] = -(mDt * (var_x105));
        rJacobian[9][14] = -(mDt * (var_x105));
        rJacobian[9][15] = -(mDt * (var_x105));
        rJacobian[9][16] = 0.0;
        rJacobian[9][17] = 0.0;
        rJacobian[9][18] = 0.0;
        rJacobian[9][19] = 0.0;
        ...
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-var_x101 - var_x110));
        rJacobian[10][11] = -(mDt * (var_x111));
        rJacobian[10][12] = 0.0;
        rJacobian[10][13] = 0.0;
        rJacobian[10][14] = -(mDt * (var_x112));
        rJacobian[10][15] = 0.0;
        rJacobian[10][16] = 0.0;
        rJacobian[10][17] = 0.0;
        rJacobian[10][18] = 0.0;
        ...
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = -(mDt * (var_x110));
        rJacobian[11][11] = 1.0 - (mDt * (-var_x111));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = 0.0;
        rJacobian[11][15] = 0.0;
        ...
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = -(mDt * (var_x98));
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-var_x101 - var_x107));
        rJacobian[12][13] = -(mDt * (var_x104));
        rJacobian[12][14] = -(mDt * (var_x94));
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        rJacobian[12][17] = 0.0;
        rJacobian[12][18] = 0.0;
        ...
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = -(mDt * (var_x113));
        rJacobian[13][9] = -(mDt * (var_x113));
        rJacobian[13][10] = -(mDt * (var_x113));
        rJacobian[13][11] = -(mDt * (var_x113));
        rJacobian[13][12] = -(mDt * (var_x106 - var_x98));
        rJacobian[13][13] = 1.0 - (mDt * (-var_x101 - var_x108));
        rJacobian[13][14] = -(mDt * (var_x113));
        rJacobian[13][15] = -(mDt * (var_x113));
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        rJacobian[13][18] = 0.0;
        rJacobian[13][19] = 0.0;
        ...
        rJacobian[14][6] = 0.0;
        rJacobian[14][7] = 0.0;
        rJacobian[14][8] = -(mDt * (var_x98));
        rJacobian[14][9] = 0.0;
        rJacobian[14][10] = -(mDt * (var_x101));
        rJacobian[14][11] = 0.0;
        rJacobian[14][12] = -(mDt * (var_x99));
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-var_x101 - var_x112 - var_x114 - var_x94));
        rJacobian[14][15] = -(mDt * (var_x115));
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        rJacobian[14][19] = 0.0;
        ...
        rJacobian[15][6] = 0.0;
        rJacobian[15][7] = 0.0;
        rJacobian[15][8] = -(mDt * (var_x97));
        rJacobian[15][9] = 0.0;
        rJacobian[15][10] = 0.0;
        rJacobian[15][11] = 0.0;
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = -(mDt * (var_x114));
        rJacobian[15][15] = 1.0 - (mDt * (-var_x103 - var_x115));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-0.023761000000000001 - var_x131 - 0.047002000000000002 * exp(-0.063100000000000003 * var_chaste_interface__cell__V)));
        rJacobian[18][19] = -(mDt * (0.036777999999999998 - var_x131));
        rJacobian[18][20] = -(mDt * (var_x132));
        rJacobian[18][21] = -(mDt * (var_x132));
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        rJacobian[18][25] = 0.0;
        ...
        rJacobian[19][19] = 1.0 - (mDt * (-0.036777999999999998 - var_x133));
        rJacobian[19][20] = 0.0;
        rJacobian[19][21] = -(mDt * (var_x134));
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = 0.0;
        ...
        rJacobian[20][18] = 0.0;
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * (-var_x135));
        rJacobian[20][21] = -(mDt * (var_x136));
        rJacobian[20][22] = 0.0;
        rJacobian[20][23] = 0.0;
        rJacobian[20][24] = 0.0;
        rJacobian[20][25] = 0.0;
        ...
        rJacobian[21][17] = 0.0;
        rJacobian[21][18] = 0.0;
        rJacobian[21][19] = -(mDt * (var_x133));
        rJacobian[21][20] = -(mDt * (var_x135));
        rJacobian[21][21] = 1.0 - (mDt * (-var_x134 - var_x136));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        ...
        rJacobian[23][3] = 0.0;
        rJacobian[23][4] = 0.0;
        rJacobian[23][5] = -(mDt * (-var_x137 + 0.024299999999999999 * var_x138 * (1 - var_x9 - var_chaste_interface__ryanodine_receptors__P_C2)));
        rJacobian[23][6] = 0.0;
        rJacobian[23][7] = 0.0;
        rJacobian[23][8] = 0.0;
        rJacobian[23][9] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (0.00080000000000000004 - var_x139));
        rJacobian[23][23] = 1.0 - (mDt * (-0.080249999999999988 - var_x139 - var_x140));
        rJacobian[23][24] = -(mDt * (0.96499999999999997 - var_x139));
        rJacobian[23][25] = 0.0;
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = 0.0;
        rJacobian[24][2] = 0.0;
        ...
        rJacobian[25][2] = 0.0;
        rJacobian[25][3] = 0.0;
        rJacobian[25][4] = -(mDt * ((195.93970796043337 * var_x61 - var_x141 * var_x65) * mParameters[5]));
        rJacobian[25][5] = 0.0;
        rJacobian[25][6] = 0.0;
        rJacobian[25][7] = 0.0;
        rJacobian[25][8] = 0.0;
        ...
        rJacobian[25][13] = 0.0;
        rJacobian[25][14] = 0.0;
        rJacobian[25][15] = -(mDt * (var_x120 * (-var_chaste_interface__cell__V + 26.535875647668394 * log(var_x142 * (mParameters[3] + 0.1111111111111111 * mParameters[2]))) * mParameters[6]));
        rJacobian[25][16] = 0.0;
        rJacobian[25][17] = -(mDt * ((-0.0005006860179512649 * var_x142 - 0.19257154536587112 * var_x143) * mParameters[5]));
        rJacobian[25][18] = 0.0;
        rJacobian[25][19] = 0.0;
        rJacobian[25][20] = 0.0;
        rJacobian[25][21] = 0.0;
        ...
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = 0.0;
        rJacobian[25][25] = 1.0 - (mDt * ((-1.7331439082928402 * var_x143 - 0.004506174161561384 * var_x142 - 0.58781912388130009 * var_x72 - 8.7011250677251544e-11 * var_x130 - var_x141 * var_x70) * mParameters[5]));
    }
