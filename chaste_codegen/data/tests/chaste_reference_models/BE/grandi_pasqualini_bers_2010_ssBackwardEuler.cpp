...
bool Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::registered = ModelFactory::Register("grandi_pasqualini_bers_2010_ss", "BackwardEuler", (ModelFactory::TCreateMethod)Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::CreateMethod);
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[27], double rJacobian[27][27])
    {
        ...
        const double var_x10 = 1 / (1.0 + var_x7 + var_x9);
        const double var_x11 = -31.0 + 0.10000000000000001 * mParameters[23];
        ...
        const double var_x19 = 0.23799999999999999 + 34.0 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x20 = 13.800000000000001 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x21 = 0.059999999999999998 + 100.0 * var_chaste_interface__Ca_Concentrations__Ca_i;
        ...
        const double var_x43 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_j) * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x44 = var_x38 * (1.0 + 0.00053869674493876331 * var_x40);
        ...
        const double var_x48 = pow(1.5700000000000001, var_x11) * mParameters[20] / (1.0 + 0.32000000000000001 * var_x37);
        ...
        const double var_x60 = var_x59 * (1.0 - var_chaste_interface__I_Ca__f_Ca_Bj);
        const double var_x61 = exp(2.0 * var_x36);
        const double var_x62 = pow(1.8, var_x11) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f;
        const double var_x63 = var_x62 * mParameters[11] / (-1.0 + var_x61);
        ...
        const double var_x74 = 100.0 * var_chaste_interface__Ca_Concentrations__Ca_j;
        ...
        const double var_x91 = var_x38 * (1.0 + 0.00053869674493876331 * var_x87);
        ...
        const double var_x102 = var_x59 * (1.0 - var_chaste_interface__I_Ca__f_Ca_Bsl);
        ...
        const double var_x121 = var_x62 / (-1.0 + var_x119);
        ...
        const double var_x125 = mParameters[21] * mParameters[7] / ((1.5 + mParameters[7]) * (1.0 + 0.1245 * exp(-0.10000000000000001 * var_x36) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[8])) * exp(-var_x36)));
        ...
        const double var_x131 = 100.0 * var_chaste_interface__SR_Ca_Concentrations__Csqn_b;
        const double var_x132 = 65.0 + 100.0 * var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x133 = 1 / var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x134 = pow(var_x133, 2.5);
        const double var_x135 = 1.0 + 0.13584112963311223 * var_x134;
        const double var_x136 = 1 / var_x135;
        const double var_x137 = 7.5 - 7.0 * var_x136;
        const double var_x138 = 1.0 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x139 = 1 / (15.0 - 14.0 * var_x136);
        const double var_x140 = 20.0 * var_x139 * var_chaste_interface__Ca_Concentrations__Ca_j;
        ...
        const double var_x145 = 10.0 * var_x139 * var_x46;
        ...
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (-260.0 + var_x131 - var_x130 - 0.69232869146389786 * var_x25 - 8.7400597733819945e-14 * var_x26));
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (260.0 - var_x131));
