...
bool Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::registered = ModelFactory::Register("grandi_pasqualini_bers_2010_ss", "BackwardEuler", (ModelFactory::TCreateMethod)Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::CreateMethod);
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[27], double rJacobian[27][27])
    {
        ...
        const double var_x14 = -31 + 0.10000000000000001 * mParameters[23];
        const double var_x15 = pow(2.6000000000000001, var_x14) * mParameters[2];
        const double var_x16 = var_x15 / (1 + var_x11 + var_x13);
        ...
        const double var_x20 = 34 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x21 = 13.800000000000001 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x22 = 100 * var_chaste_interface__Ca_Concentrations__Ca_i;
        ...
        const double var_x47 = (1 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_j) * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x48 = var_x42 * (1 + 0.00053869674493876331 * var_x44);
        ...
        const double var_x51 = 1 + 2.2499999999999996e-8 / var_x50;
        const double var_x52 = pow(1.5700000000000001, var_x14) * mParameters[20] / (1 + 0.32000000000000001 * var_x41);
        ...
        const double var_x64 = var_x63 * (1 - var_chaste_interface__I_Ca__f_Ca_Bj);
        const double var_x65 = exp(2 * var_x40);
        const double var_x66 = pow(1.8, var_x14) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f;
        const double var_x67 = var_x66 * mParameters[11] / (-1 + var_x65);
        ...
        const double var_x76 = 100 * var_chaste_interface__Ca_Concentrations__Ca_j;
        ...
        const double var_x91 = var_x42 * (1 + 0.00053869674493876331 * var_x87);
        ...
        const double var_x102 = var_x63 * (1 - var_chaste_interface__I_Ca__f_Ca_Bsl);
        ...
        const double var_x123 = var_x66 / (-1 + var_x121);
        ...
        const double var_x127 = mParameters[21] * mParameters[7] / ((1.5 + mParameters[7]) * (1 + 0.1245 * exp(-0.10000000000000001 * var_x40) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[8])) * exp(-var_x40)));
        ...
        const double var_x134 = 100 * var_chaste_interface__SR_Ca_Concentrations__Csqn_b;
        const double var_x135 = 100 * var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x136 = 1 / var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x137 = pow(var_x136, 2.5);
        const double var_x138 = 1 + 0.13584112963311223 * var_x137;
        const double var_x139 = 1 / var_x138;
        const double var_x140 = 7 * var_x139;
        const double var_x141 = 7.5 - var_x140;
        const double var_x142 = 1 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x143 = 1 / (15 - 14 * var_x139);
        const double var_x144 = 20 * var_x143 * var_chaste_interface__Ca_Concentrations__Ca_j;
        ...
        const double var_x149 = 10 * var_x143 * var_x50;
        ...
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (-260 + var_x134 - var_x132 - var_x133 - 0.69232869146389786 * var_x26 - 8.7400597733819945e-14 * var_x27));
        rJacobian[22][23] = -(mDt * (65 + var_x135));
        rJacobian[22][24] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (260 - var_x134));
        rJacobian[23][23] = 1.0 - (mDt * (-65 - var_x135));
        rJacobian[23][24] = 0.0;
        rJacobian[23][25] = 0.0;
        rJacobian[23][26] = 0.0;
        rJacobian[24][0] = 0.0;
