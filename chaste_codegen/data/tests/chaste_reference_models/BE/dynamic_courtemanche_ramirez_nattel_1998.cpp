...
AbstractBackwardEulerCardiacCell<8>* Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::CreateMethod(boost::shared_ptr<AbstractIvpOdeSolver> p_solver, boost::shared_ptr<AbstractStimulusFunction> p_stimulus) {
    return new Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut(p_solver, p_stimulus);
}

bool Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::s_registered = ModelFactory::Register("dynamic_courtemanche_ramirez_nattel_1998", "BackwardEuler", (ModelFactory::TCreateMethod)Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::CreateMethod);



    boost::shared_ptr<RegularStimulus> Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::UseCellMLDefaultStimulus()
    {
    ...
    double Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut>::Instance();
        Init();
    ...
    Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::~Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut()
    {
    }

    
    double Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[8], double rResidual[8])
    {
    ...
    void Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[8], double rJacobian[8][8])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -81.18
        ...
        const double var_x7 = mParameters[4] * exp(0.013102317305629283 * var_chaste_interface__membrane__V);
        const double var_x8 = exp(-0.024332874996168673 * var_chaste_interface__membrane__V);
        ...
        const double var_x61 = var_x59 * var_x60 * mParameters[5] / ((1.5 + mParameters[5]) * pow((0.031622776601683791 + var_x59), 2) * (1.0 + 0.1245 * exp(-0.0037435192301797956 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[6])) * exp(-0.037435192301797954 * var_chaste_interface__membrane__V)));
    ...
    void Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        const double var_L_type_Ca_channel_d_gate__tau_d = 28.571428571428569 * (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V)) / ((1.0 + exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V)) * (10.0 + var_chaste_interface__membrane__V));
        ...
        CardiacNewtonSolver<8,Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut>* _p_solver = CardiacNewtonSolver<8,Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut>::Instance();
    ...
    std::vector<double> Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut>::Initialise(void)
{
...
CHASTE_CLASS_EXPORT(Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut)
extern "C"
{
    ...
    {
        return new Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEulerNoLut(pSolver, pStimulus);
    }
