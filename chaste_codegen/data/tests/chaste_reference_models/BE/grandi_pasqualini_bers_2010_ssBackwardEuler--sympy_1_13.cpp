...
#include "grandi_pasqualini_bers_2010_ssBackwardEuler.hpp"
#include <cmath>
#include <cfloat>
#include <cassert>
#include <memory>
...
bool Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::registered = ModelFactory::Register("grandi_pasqualini_bers_2010_ss", "BackwardEuler", (ModelFactory::TCreateMethod)Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::CreateMethod);
                ...
                pIntracellularStimulus)
    {
        ...
        this->mParameters[1] = 25; // (var_parameters__ks) [per_msec]
        this->mParameters[2] = 0.0053114; // (var_parameters__Vmax_SRCaP) [mM_per_msec]
        this->mParameters[3] = 1; // (var_Na_Concentrations__conc_clamp) [dimensionless]
        this->mParameters[4] = 15; // (var_parameters__Cli) [mM]
        this->mParameters[5] = 1.8; // (var_parameters__Cao) [mM]
        this->mParameters[6] = 150; // (var_parameters__Clo) [mM]
        this->mParameters[7] = 5.4000000000000004; // (var_parameters__Ko) [mM]
        this->mParameters[8] = 140; // (var_parameters__Nao) [mM]
        this->mParameters[9] = 96485; // (var_parameters__Frdy) [coulomb_per_mole]
        this->mParameters[10] = 8314; // (var_parameters__R) [joule_per_kelvin_per_kilomole]
        this->mParameters[11] = 0.5; // (var_parameters__pCa_max) [cm_per_sec]
        this->mParameters[12] = 23; // (var_parameters__GNa) [mS_per_uF]
        ...
        this->mParameters[15] = 1; // (var_I_to__GtoFast_factor) [dimensionless]
        ...
        this->mParameters[18] = 1; // (var_I_Ks__GKs_factor) [dimensionless]
        this->mParameters[19] = 1; // (var_I_to__GtoSlow_factor) [dimensionless]
        ...
        this->mParameters[23] = 310; // (var_parameters__Temp) [kelvin]
    }
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::VerifyStateVariables()
    {
    ...
    double Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_I_Kp__kp_kp = 1 / (1 + exp(7.4880000000000004 - 0.16722408026755853 * var_chaste_interface__membrane_potential__V_m)); // dimensionless
        const double var_I_Kr__rkr = 1 / (1 + exp(3.0833333333333335 + 0.041666666666666664 * var_chaste_interface__membrane_potential__V_m)); // dimensionless
        ...
        const double var_parameters__Fsl = 1 - var_parameters__Fjunc; // dimensionless
        ...
        const double var_parameters__Fsl_CaL = 1 - var_parameters__Fjunc_CaL; // dimensionless
        ...
        const double var_I_NCX__Ka_junc = 1 / (1 + pow(var_parameters__Kdact, 2) / pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2)); // dimensionless
        const double var_I_NCX__Ka_sl = 1 / (1 + pow(var_parameters__Kdact, 2) / pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2)); // dimensionless
        ...
        const double var_parameters__KmNaip = 11; // mM
        ...
        const double var_I_NaK__fnak = 1 / (1 + 0.1245 * exp(-0.10000000000000001 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT) + 0.036499999999999998 * var_I_NaK__sigma * exp(-var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // dimensionless
        const double var_I_NaK__I_nak_junc = var_I_NaK__fnak * var_parameters__Fjunc * mParameters[21] * mParameters[7] / ((1 + pow(var_parameters__KmNaip, 4) / pow(var_chaste_interface__Na_Concentrations__Na_j, 4)) * (var_parameters__KmKo + mParameters[7])); // uA_per_uF
        const double var_I_NaK__I_nak_sl = var_I_NaK__fnak * var_parameters__Fsl * mParameters[21] * mParameters[7] / ((1 + pow(var_parameters__KmNaip, 4) / pow(var_chaste_interface__Na_Concentrations__Na_sl, 4)) * (var_parameters__KmKo + mParameters[7])); // uA_per_uF
        const double var_I_NaK__I_nak = var_I_NaK__I_nak_junc + var_I_NaK__I_nak_sl; // uA_per_uF
        const double var_parameters__Qpow = -31 + 0.10000000000000001 * mParameters[23]; // dimensionless
        ...
        const double var_parameters__ecl = 1 * log(mParameters[4] / mParameters[6]) / var_parameters__FoRT; // mV
        const double var_I_ClCa__I_ClCa_junc = (-var_parameters__ecl + var_chaste_interface__membrane_potential__V_m) * var_parameters__Fjunc * var_parameters__GClCa / (1 + var_parameters__KdClCa / var_chaste_interface__Ca_Concentrations__Ca_j); // uA_per_uF
        const double var_I_ClCa__I_ClCa_sl = (-var_parameters__ecl + var_chaste_interface__membrane_potential__V_m) * var_parameters__Fsl * var_parameters__GClCa / (1 + var_parameters__KdClCa / var_chaste_interface__Ca_Concentrations__Ca_sl); // uA_per_uF
        ...
        const double var_parameters__ek = 1 * log(mParameters[7] / var_chaste_interface__K_Concentration__K_i) / var_parameters__FoRT; // mV
        const double var_I_Ki__aki = 1.02 / (1 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane_potential__V_m - 0.23849999999999999 * var_parameters__ek)); // dimensionless
        ...
        const double var_parameters__ena_junc = 1 * log(mParameters[8] / var_chaste_interface__Na_Concentrations__Na_j) / var_parameters__FoRT; // mV
        ...
        const double var_parameters__ena_sl = 1 * log(mParameters[8] / var_chaste_interface__Na_Concentrations__Na_sl) / var_parameters__FoRT; // mV
        ...
        const double var_parameters__epi = 1; // dimensionless
        const double var_I_to__GtoFast = ((var_parameters__epi == 1) ? (0.1144 * mParameters[15]) : (0.0014039999999999999 * mParameters[15])); // mS_per_uF
        const double var_I_to__GtoSlow = ((var_parameters__epi == 1) ? (0.015599999999999999 * mParameters[19]) : (0.037595999999999997 * mParameters[19])); // mS_per_uF
        ...
        const double var_I_NCX__s2_junc = pow(mParameters[8], 3) * var_chaste_interface__Ca_Concentrations__Ca_j * exp((-1 + var_parameters__nu) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT); // mM4
        const double var_I_NCX__I_ncx_junc = pow(var_parameters__Q10NCX, var_parameters__Qpow) * (-var_I_NCX__s2_junc + var_I_NCX__s1_junc) * var_I_NCX__Ka_junc * var_parameters__Fjunc * mParameters[20] / ((1 + var_parameters__ksat * exp((-1 + var_parameters__nu) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * var_I_NCX__s3_junc); // uA_per_uF
        const double var_I_NCX__s2_sl = pow(mParameters[8], 3) * var_chaste_interface__Ca_Concentrations__Ca_sl * exp((-1 + var_parameters__nu) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT); // mM4
        ...
        const double var_parameters__pCa = 0.00054000000000000001 * mParameters[11]; // cm_per_sec
        const double var_I_Ca__ibarca_j = 4 * (-0.34100000000000003 * mParameters[5] + 0.34100000000000003 * var_chaste_interface__Ca_Concentrations__Ca_j * exp(2 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * mParameters[9] * var_parameters__pCa / (-1 + exp(2 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // uA_per_uF
        const double var_I_Ca__I_Ca_junc = 0.45000000000000001 * pow(var_parameters__Q10CaL, var_parameters__Qpow) * (1 - var_chaste_interface__I_Ca__f_Ca_Bj + var_I_Ca__fcaCaj) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f * var_I_Ca__ibarca_j * var_parameters__Fjunc_CaL; // uA_per_uF
        const double var_Ca_Concentrations__I_Ca_tot_junc = -2 * var_I_NCX__I_ncx_junc + var_I_Ca__I_Ca_junc + var_I_CaBK__I_cabk_junc + var_I_PCa__I_pca_junc; // uA_per_uF
        const double var_I_Ca__ibarca_sl = 4 * (-0.34100000000000003 * mParameters[5] + 0.34100000000000003 * var_chaste_interface__Ca_Concentrations__Ca_sl * exp(2 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * mParameters[9] * var_parameters__pCa / (-1 + exp(2 * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // uA_per_uF
        const double var_I_Ca__I_Ca_sl = 0.45000000000000001 * pow(var_parameters__Q10CaL, var_parameters__Qpow) * (1 - var_chaste_interface__I_Ca__f_Ca_Bsl + var_I_Ca__fcaCaMSL) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f * var_I_Ca__ibarca_sl * var_parameters__Fsl_CaL; // uA_per_uF
        const double var_Ca_Concentrations__I_Ca_tot_sl = -2 * var_I_NCX__I_ncx_sl + var_I_Ca__I_Ca_sl + var_I_CaBK__I_cabk_sl + var_I_PCa__I_pca_sl; // uA_per_uF
        ...
        const double var_I_Ca__ibarna_j = (-0.75 * mParameters[8] + 0.75 * var_chaste_interface__Na_Concentrations__Na_j * exp(var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)) * var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT * mParameters[9] * var_parameters__pNa / (-1 + exp(var_chaste_interface__membrane_potential__V_m * var_parameters__FoRT)); // uA_per_uF
        const double var_I_Ca__I_CaNa_junc = 0.45000000000000001 * pow(var_parameters__Q10CaL, var_parameters__Qpow) * (1 - var_chaste_interface__I_Ca__f_Ca_Bj + var_I_Ca__fcaCaj) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f * var_I_Ca__ibarna_j * var_parameters__Fjunc_CaL; // uA_per_uF
        ...
        const double var_I_Ca__I_CaNa_sl = 0.45000000000000001 * pow(var_parameters__Q10CaL, var_parameters__Qpow) * (1 - var_chaste_interface__I_Ca__f_Ca_Bsl + var_I_Ca__fcaCaMSL) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f * var_I_Ca__ibarna_sl * var_parameters__Fsl_CaL; // uA_per_uF
        const double var_Na_Concentrations__I_Na_tot_junc = 3 * var_I_NCX__I_ncx_junc + 3 * var_I_NaK__I_nak_junc + var_I_Ca__I_CaNa_junc + var_I_Na__I_Na_junc + var_I_NaBK__I_nabk_junc; // uA_per_uF
        const double var_Na_Concentrations__I_Na_tot_sl = 3 * var_I_NCX__I_ncx_sl + 3 * var_I_NaK__I_nak_sl + var_I_Ca__I_CaNa_sl + var_I_Na__I_Na_sl + var_I_NaBK__I_nabk_sl; // uA_per_uF
        ...
        const double var_I_Ks__eks = 1 * log((mParameters[8] * var_parameters__pNaK + mParameters[7]) / (var_chaste_interface__Na_Concentrations__Na_i * var_parameters__pNaK + var_chaste_interface__K_Concentration__K_i)) / var_parameters__FoRT; // mV
        ...
        const double var_K_Concentration__I_K_tot = -2 * var_I_NaK__I_nak + var_I_Ca__I_CaK + var_I_Ki__I_ki + var_I_Kp__I_kp + var_I_Kr__I_kr + var_I_Ks__I_ks + var_I_to__I_to; // uA_per_uF
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[27], double rResidual[27])
    {
        ...
        const double d_dt_chaste_interface_var_I_Ca__f_Ca_Bj = -0.011900000000000001 * var_chaste_interface__I_Ca__f_Ca_Bj + 1.7 * (1 - var_chaste_interface__I_Ca__f_Ca_Bj) * var_chaste_interface__Ca_Concentrations__Ca_j; // 1 / msec
        const double d_dt_chaste_interface_var_I_Ca__f_Ca_Bsl = -0.011900000000000001 * var_chaste_interface__I_Ca__f_Ca_Bsl + 1.7 * (1 - var_chaste_interface__I_Ca__f_Ca_Bsl) * var_chaste_interface__Ca_Concentrations__Ca_sl; // 1 / msec
        const double var_I_Ca__fcaCaMSL = 0; // dimensionless
        const double var_I_Ca__fcaCaj = 0; // dimensionless
        const double var_SR_Fluxes__MaxSR = 15; // dimensionless
        const double var_SR_Fluxes__MinSR = 1; // dimensionless
        const double var_SR_Fluxes__RI = 1 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr; // mM
        ...
        const double var_parameters__Mgi = 1; // mM
        const double var_I_NCX__s3_junc = pow(var_chaste_interface__Na_Concentrations__Na_j, 3) * mParameters[5] + pow(var_chaste_interface__Na_Concentrations__Na_j, 3) * var_parameters__KmCao + pow(mParameters[8], 3) * var_chaste_interface__Ca_Concentrations__Ca_j + pow(var_parameters__KmNao, 3) * (1 + var_chaste_interface__Ca_Concentrations__Ca_j / var_parameters__KmCai) * var_chaste_interface__Ca_Concentrations__Ca_j + pow(mParameters[8], 3) * (1 + pow(var_chaste_interface__Na_Concentrations__Na_j, 3) / pow(var_parameters__KmNai, 3)) * var_parameters__KmCai; // mM4
        const double var_I_NCX__s3_sl = pow(var_chaste_interface__Na_Concentrations__Na_sl, 3) * mParameters[5] + pow(var_chaste_interface__Na_Concentrations__Na_sl, 3) * var_parameters__KmCao + pow(mParameters[8], 3) * var_chaste_interface__Ca_Concentrations__Ca_sl + pow(var_parameters__KmNao, 3) * (1 + var_chaste_interface__Ca_Concentrations__Ca_sl / var_parameters__KmCai) * var_chaste_interface__Ca_Concentrations__Ca_sl + pow(mParameters[8], 3) * (1 + pow(var_chaste_interface__Na_Concentrations__Na_sl, 3) / pow(var_parameters__KmNai, 3)) * var_parameters__KmCai; // mM4
        const double var_I_NaK__sigma = -0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[8]); // dimensionless
        const double var_parameters__Q10CaL = 1.8; // dimensionless
        ...
        const double var_I_PCa__I_pca_junc = pow(var_chaste_interface__Ca_Concentrations__Ca_j, 1.6000000000000001) * pow(var_parameters__Q10SLCaP, var_parameters__Qpow) * var_parameters__Fjunc * var_parameters__IbarSLCaP / (pow(var_chaste_interface__Ca_Concentrations__Ca_j, 1.6000000000000001) + pow(var_parameters__KmPCa, 1.6000000000000001)); // uA_per_uF
        const double var_I_PCa__I_pca_sl = pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 1.6000000000000001) * pow(var_parameters__Q10SLCaP, var_parameters__Qpow) * var_parameters__Fsl * var_parameters__IbarSLCaP / (pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 1.6000000000000001) + pow(var_parameters__KmPCa, 1.6000000000000001)); // uA_per_uF
        const double var_parameters__cellLength = 100; // um
        ...
        const double var_SR_Fluxes__kCaSR = -(-var_SR_Fluxes__MinSR + var_SR_Fluxes__MaxSR) / (1 + pow((var_parameters__ec50SR / var_chaste_interface__SR_Ca_Concentrations__Ca_sr), 2.5)) + var_SR_Fluxes__MaxSR; // dimensionless
        const double var_parameters__eca_junc = 0.5 * log(mParameters[5] / var_chaste_interface__Ca_Concentrations__Ca_j) / var_parameters__FoRT; // mV
        const double var_I_CaBK__I_cabk_junc = (-var_parameters__eca_junc + var_chaste_interface__membrane_potential__V_m) * var_parameters__Fjunc * var_parameters__GCaB; // uA_per_uF
        const double var_parameters__eca_sl = 0.5 * log(mParameters[5] / var_chaste_interface__Ca_Concentrations__Ca_sl) / var_parameters__FoRT; // mV
        const double var_I_CaBK__I_cabk_sl = (-var_parameters__eca_sl + var_chaste_interface__membrane_potential__V_m) * var_parameters__Fsl * var_parameters__GCaB; // uA_per_uF
        ...
        const double var_parameters__koCa = 10; // per_mM2_per_msec
        ...
        const double var_parameters__koff_csqn = 65; // per_msec
        ...
        const double var_parameters__kon_cam = 34; // per_mM_per_msec
        ...
        const double var_parameters__kon_csqn = 100; // per_mM_per_msec
        ...
        const double var_parameters__kon_slh = 100; // per_mM_per_msec
        ...
        const double var_parameters__kon_sll = 100; // per_mM_per_msec
        ...
        const double var_parameters__kon_sr = 100; // per_mM_per_msec
        ...
        const double var_SR_Fluxes__J_SRCarel = 1 * (-var_chaste_interface__Ca_Concentrations__Ca_j + var_chaste_interface__SR_Ca_Concentrations__Ca_sr) * var_chaste_interface__SR_Fluxes__Ry_Ro * mParameters[1]; // mM_per_msec
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[27], double rJacobian[27][27])
    {
        ...
        const double var_x0 = 34 * var_chaste_interface__Cytosolic_Ca_Buffers__CaM;
        const double var_x1 = 100 * var_chaste_interface__Cytosolic_Ca_Buffers__SRB;
        const double var_x2 = 32.700000000000003 * var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CL;
        const double var_x3 = 1 / M_PI;
        const double var_x4 = 0.4794655196082917 * var_x3;
        const double var_x5 = pow(var_chaste_interface__Ca_Concentrations__Ca_i, 0.78699999999999992);
        const double var_x6 = pow(var_chaste_interface__SR_Ca_Concentrations__Ca_sr, 1.7869999999999999);
        const double var_x7 = 0.38742512113256738 * var_x6;
        const double var_x8 = pow(var_chaste_interface__Ca_Concentrations__Ca_i, 1.7869999999999999);
        const double var_x9 = 2814485.1633595936 * var_x8;
        const double var_x10 = 1 / (1 + var_x7 + var_x9);
        const double var_x11 = -31 + 0.10000000000000001 * mParameters[23];
        const double var_x12 = pow(2.6000000000000001, var_x11);
        const double var_x13 = var_x12 * mParameters[2];
        const double var_x14 = var_x10 * var_x13;
        const double var_x15 = var_x13 * (var_x9 - var_x7) / pow((3.5530476870814998e-7 + var_x8 + 1.3765399305573384e-7 * var_x6), 2);
        const double var_x16 = var_x15 * var_x5;
        const double var_x17 = 13.800000000000001 * var_chaste_interface__Cytosolic_Ca_Buffers__Myo_c + 13.800000000000001 * var_chaste_interface__Cytosolic_Ca_Buffers__Myo_m;
        const double var_x18 = 2.3700000000000001 * var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHc + 2.3700000000000001 * var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHm;
        const double var_x19 = 0.23799999999999999 + 34 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x20 = 13.800000000000001 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x21 = 0.059999999999999998 + 100 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x22 = 2.3700000000000001 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x23 = 0.019599999999999999 + 32.700000000000003 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x24 = pow(var_chaste_interface__SR_Ca_Concentrations__Ca_sr, 0.78699999999999992);
        const double var_x25 = var_x14 * var_x24;
        const double var_x26 = var_x15 * var_x24;
        const double var_x27 = 145.53224458892851 * var_x3;
        const double var_x28 = 100 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_j;
        const double var_x29 = 100 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_j;
        const double var_x30 = 5.2281977629563632e-6 + pow(var_chaste_interface__Ca_Concentrations__Ca_j, 1.6000000000000001);
        const double var_x31 = pow(2.3500000000000001, var_x11);
        const double var_x32 = 0.011844800000000001 * var_x31;
        const double var_x33 = 1 / mParameters[9];
        const double var_x34 = var_x33 * mParameters[10] * mParameters[23];
        const double var_x35 = var_chaste_interface__membrane_potential__V_m / (mParameters[10] * mParameters[23]);
        const double var_x36 = var_x35 * mParameters[9];
        const double var_x37 = exp(-0.72999999999999998 * var_x36);
        const double var_x38 = pow(mParameters[8], 3);
        const double var_x39 = var_x37 * var_x38;
        const double var_x40 = pow(var_chaste_interface__Na_Concentrations__Na_j, 3);
        const double var_x41 = var_x40 * mParameters[5];
        const double var_x42 = var_x38 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x43 = (1 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_j) * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x44 = var_x38 * (1 + 0.00053869674493876331 * var_x40);
        const double var_x45 = 1 / (var_x41 + var_x42 + 669921.875 * var_x43 + 1.3 * var_x40 + 0.0035899999999999999 * var_x44);
        const double var_x46 = pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2);
        const double var_x47 = 1 + 2.2499999999999996e-8 / var_x46;
        const double var_x48 = pow(1.5700000000000001, var_x11) * mParameters[20] / (1 + 0.32000000000000001 * var_x37);
        const double var_x49 = var_x48 / var_x47;
        const double var_x50 = var_x45 * var_x49;
        const double var_x51 = var_x39 * var_x50;
        const double var_x52 = 669921.875 + var_x38;
        const double var_x53 = -var_x52 - 373215529.24791086 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x54 = exp(0.27000000000000002 * var_x36);
        const double var_x55 = -var_x37 * var_x42 + var_x40 * var_x54 * mParameters[5];
        const double var_x56 = var_x49 * var_x55 / pow((var_x43 + 1.9405247813411081e-6 * var_x40 + 5.3588338192419823e-9 * var_x44 + 1.4927113702623908e-6 * var_x41 + 1.4927113702623908e-6 * var_x42), 2);
        const double var_x57 = 4.9020119168033731e-13 * var_x56;
        const double var_x58 = var_x45 * var_x48 * var_x55 / (pow(var_x47, 2) * pow(var_chaste_interface__Ca_Concentrations__Ca_j, 3));
        const double var_x59 = var_x35 * pow(mParameters[9], 2);
        const double var_x60 = var_x59 * (1 - var_chaste_interface__I_Ca__f_Ca_Bj);
        const double var_x61 = exp(2 * var_x36);
        const double var_x62 = pow(1.8, var_x11) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f;
        const double var_x63 = var_x62 * mParameters[11] / (-1 + var_x61);
        const double var_x64 = var_x61 * var_x63;
        const double var_x65 = var_x33 * mParameters[22];
        const double var_x66 = var_x3 * var_x65;
        const double var_x67 = 88294470889864.781 * var_x66;
        const double var_x68 = 64.935064935064929 * mParameters[1];
        const double var_x69 = 1205.9369202226344 * mParameters[0] + var_x68 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x70 = -0.34100000000000003 * mParameters[5];
        const double var_x71 = 0.34100000000000003 * var_x61;
        const double var_x72 = var_x36 * mParameters[22];
        const double var_x73 = var_x3 * var_x63 * var_x72;
        const double var_x74 = 100 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x75 = 0.029999999999999999 + var_x74;
        const double var_x76 = 1.3 + var_x74;
        const double var_x77 = pow(var_chaste_interface__Na_Concentrations__Na_j, 2);
        const double var_x78 = 3 * mParameters[5];
        const double var_x79 = 5.8017639429904805e-6 * var_x38;
        const double var_x80 = -3.9000000000000004 * var_x77 - var_x77 * var_x78 - var_x77 * var_x79;
        const double var_x81 = var_x54 * mParameters[5];
        const double var_x82 = var_x50 * var_x77 * var_x81;
        const double var_x83 = -var_chaste_interface__Ca_Concentrations__Ca_j + var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x84 = 100 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_sl;
        const double var_x85 = 100 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_sl;
        const double var_x86 = 5.2281977629563632e-6 + pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 1.6000000000000001);
        const double var_x87 = 0.095835200000000009 * var_x31;
        const double var_x88 = pow(var_chaste_interface__Na_Concentrations__Na_sl, 3);
        const double var_x89 = var_x88 * mParameters[5];
        const double var_x90 = var_x38 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x91 = (1 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_sl) * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x92 = var_x38 * (1 + 0.00053869674493876331 * var_x88);
        const double var_x93 = 1 / (var_x89 + var_x90 + 669921.875 * var_x91 + 1.3 * var_x88 + 0.0035899999999999999 * var_x92);
        const double var_x94 = 1 + 2.2499999999999996e-8 / pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2);
        const double var_x95 = var_x48 / var_x94;
        const double var_x96 = var_x93 * var_x95;
        const double var_x97 = var_x39 * var_x96;
        const double var_x98 = -var_x52 - 373215529.24791086 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x99 = -var_x37 * var_x90 + var_x54 * var_x88 * mParameters[5];
        const double var_x100 = var_x95 * var_x99 / pow((var_x91 + 1.9405247813411081e-6 * var_x88 + 5.3588338192419823e-9 * var_x92 + 1.4927113702623908e-6 * var_x89 + 1.4927113702623908e-6 * var_x90), 2);
        const double var_x101 = 3.9661732781409103e-12 * var_x100;
        const double var_x102 = var_x48 * var_x93 * var_x99 / (pow(var_x94, 2) * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 3));
        const double var_x103 = var_x59 * (1 - var_chaste_interface__I_Ca__f_Ca_Bsl);
        const double var_x104 = 2379535990481.856 * var_x66;
        const double var_x105 = 100 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x106 = 0.029999999999999999 + var_x105;
        const double var_x107 = 1.3 + var_x105;
        const double var_x108 = pow(var_chaste_interface__Na_Concentrations__Na_sl, 2);
        const double var_x109 = -3.9000000000000004 * var_x108 - var_x108 * var_x78 - var_x108 * var_x79;
        const double var_x110 = var_x108 * var_x81 * var_x96;
        const double var_x111 = 0.001 + 0.0001 * var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x112 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bj;
        const double var_x113 = 0.001 + 0.0001 * var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x114 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bsl;
        const double var_x115 = var_x3 * mParameters[3];
        const double var_x116 = 0.23994508763098885 * var_x115;
        const double var_x117 = 7.3530178752050587e-13 * var_x56;
        const double var_x118 = var_x115 * var_x65;
        const double var_x119 = -0.75 * mParameters[8];
        const double var_x120 = exp(var_x36);
        const double var_x121 = 0.75 * var_x120;
        const double var_x122 = var_x62 / (-1 + var_x120);
        const double var_x123 = var_x115 * var_x122 * var_x72;
        const double var_x124 = 3.2338732908121872 * var_x3;
        const double var_x125 = var_x34 / var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x126 = mParameters[21] * mParameters[7] / ((1.5 + mParameters[7]) * (1 + 0.1245 * exp(-0.10000000000000001 * var_x36) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[8])) * exp(-var_x36)));
        const double var_x127 = pow(var_chaste_interface__I_Na__m, 3) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * mParameters[12];
        const double var_x128 = var_x120 * var_x122;
        const double var_x129 = 5.9492599172113663e-12 * var_x100;
        const double var_x130 = var_x34 / var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x131 = 1 * mParameters[1];
        const double var_x132 = 18.571428571428569 * mParameters[0] + var_x131 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x133 = 100 * var_chaste_interface__SR_Ca_Concentrations__Csqn_b;
        const double var_x134 = 65 + 100 * var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x135 = 1 / var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x136 = pow(var_x135, 2.5);
        const double var_x137 = 1 + 0.13584112963311223 * var_x136;
        const double var_x138 = 1 / var_x137;
        const double var_x139 = 7.5 - 7 * var_x138;
        const double var_x140 = var_x139 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x141 = 1 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x142 = 1 / (15 - 14 * var_x138);
        const double var_x143 = 20 * var_x142 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x144 = pow(var_x137, (-2));
        const double var_x145 = var_x135 * var_x136 * var_x144;
        const double var_x146 = 2.3772197685794643 * var_x145 * var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x147 = 0.21130842387373014 * var_x145 * var_x46 / pow((1 - 0.93333333333333335 * var_x138), 2);
        const double var_x148 = 10 * var_x142 * var_x46;
        const double var_x149 = var_x139 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x150 = var_x143 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x151 = var_x147 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        
        
        rJacobian[0][0] = 1.0 - (mDt * (-7.0788000000000011 + var_x0 + var_x1 + var_x17 + var_x18 + var_x2 - var_x4 + 3.4188518090540365e-8 * var_x16 - 270818.42237280885 * var_x14 * var_x5));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = -(mDt * (var_x4));
        rJacobian[0][3] = -(mDt * (var_x19));
        rJacobian[0][4] = -(mDt * (0.016159999999999997 + var_x20));
        rJacobian[0][5] = -(mDt * (0.015757 + var_x20));
        rJacobian[0][6] = -(mDt * (var_x21));
        rJacobian[0][7] = -(mDt * (0.003032 + var_x22));
        rJacobian[0][8] = -(mDt * (0.0063300000000000006 + var_x22));
        rJacobian[0][9] = -(mDt * (var_x23));
        rJacobian[0][10] = 0.0;
        rJacobian[0][11] = 0.0;
        rJacobian[0][12] = 0.0;
        rJacobian[0][13] = 0.0;
        ...
        rJacobian[1][8] = 0.0;
        rJacobian[1][9] = 0.0;
        rJacobian[1][10] = -(mDt * (77240003134.453705 * var_x73 * (var_x70 + var_x71 * var_chaste_interface__Ca_Concentrations__Ca_j)));
        rJacobian[1][11] = 0.0;
        rJacobian[1][12] = -(mDt * (var_x75));
        rJacobian[1][13] = 0.0;
        rJacobian[1][14] = -(mDt * (var_x76));
        rJacobian[1][15] = 0.0;
        rJacobian[1][16] = 0.0;
        rJacobian[1][17] = 0.0;
        rJacobian[1][18] = 0.0;
        rJacobian[1][19] = 0.0;
        rJacobian[1][20] = -(mDt * (-var_x67 * (-0.66000000000000003 * var_x82 - var_x57 * var_x80)));
        rJacobian[1][21] = 0.0;
        rJacobian[1][22] = -(mDt * (var_x69));
        rJacobian[1][23] = 0.0;
        rJacobian[1][24] = 0.0;
        rJacobian[1][25] = -(mDt * (var_x68 * var_x83));
        rJacobian[1][26] = 0.0;
        rJacobian[2][0] = -(mDt * (15.582629387269481 * var_x3));
        rJacobian[2][1] = -(mDt * (3.9220939916716238 * var_x3));
        rJacobian[2][2] = 1.0 - (mDt * (-165.10000000000002 + var_x84 + var_x85 - 19.504723378941105 * var_x3 - var_x104 * (1.78 * var_x97 - 8.0099999999999983e-8 * var_x102 - var_x101 * var_x98 + 0.00024532850000000001 * var_x34 / var_chaste_interface__Ca_Concentrations__Ca_sl + 3.3145199999999996e-5 * var_x103 * var_x64 + var_x87 * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 0.60000000000000009) / var_x86 - var_x87 * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2.2000000000000002) / pow(var_x86, 2))));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        ...
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = -(mDt * (231290898.27483633 * var_x73 * (var_x70 + var_x71 * var_chaste_interface__Ca_Concentrations__Ca_sl)));
        rJacobian[2][12] = 0.0;
        rJacobian[2][13] = -(mDt * (var_x106));
        rJacobian[2][14] = 0.0;
        rJacobian[2][15] = -(mDt * (var_x107));
        rJacobian[2][16] = 0.0;
        rJacobian[2][17] = 0.0;
        rJacobian[2][18] = 0.0;
        rJacobian[2][19] = 0.0;
        rJacobian[2][20] = 0.0;
        rJacobian[2][21] = -(mDt * (-var_x104 * (-5.3399999999999999 * var_x110 - var_x101 * var_x109)));
        rJacobian[2][22] = 0.0;
        rJacobian[2][23] = 0.0;
        rJacobian[2][24] = 0.0;
        rJacobian[2][25] = 0.0;
        ...
        rJacobian[3][25] = 0.0;
        rJacobian[3][26] = 0.0;
        rJacobian[4][0] = -(mDt * (1.9320000000000004 - var_x17));
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-0.00046000000000000001 - var_x20));
        rJacobian[4][5] = -(mDt * (-var_x20));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        ...
        rJacobian[6][25] = 0.0;
        rJacobian[6][26] = 0.0;
        rJacobian[7][0] = -(mDt * (0.33180000000000004 - var_x18));
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-3.1999999999999999e-5 - var_x22));
        rJacobian[7][8] = -(mDt * (-var_x22));
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[7][12] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-var_x75));
        rJacobian[12][13] = 0.0;
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        ...
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = -(mDt * (43.550000000000004 - var_x84));
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = 0.0;
        ...
        rJacobian[13][11] = 0.0;
        rJacobian[13][12] = 0.0;
        rJacobian[13][13] = 1.0 - (mDt * (-var_x106));
        rJacobian[13][14] = 0.0;
        rJacobian[13][15] = 0.0;
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-var_x76));
        rJacobian[14][15] = 0.0;
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        ...
        rJacobian[15][0] = 0.0;
        rJacobian[15][1] = 0.0;
        rJacobian[15][2] = -(mDt * (121.55000000000001 - var_x85));
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = 0.0;
        rJacobian[15][5] = 0.0;
        rJacobian[15][6] = 0.0;
        ...
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (-var_x107));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = 0.0;
        rJacobian[17][17] = 1.0 - (mDt * (-var_x111));
        rJacobian[17][18] = 0.0;
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = -(mDt * (0.0007561 - var_x112));
        rJacobian[17][21] = 0.0;
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = 0.0;
        rJacobian[17][24] = 0.0;
        ...
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-var_x113));
        rJacobian[18][19] = 0.0;
        rJacobian[18][20] = 0.0;
        rJacobian[18][21] = -(mDt * (0.000165 - var_x114));
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        rJacobian[18][25] = 0.0;
        ...
        rJacobian[19][17] = 0.0;
        rJacobian[19][18] = 0.0;
        rJacobian[19][19] = 1.0 - (mDt * (-var_x116));
        rJacobian[19][20] = 0.0;
        rJacobian[19][21] = -(mDt * (var_x116));
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = 0.0;
        rJacobian[19][26] = 0.0;
        rJacobian[20][0] = 0.0;
        rJacobian[20][1] = -(mDt * (-176588941779729.56 * var_x118 * (1.4849999999999997e-8 * var_x58 - 0.33000000000000002 * var_x51 + var_x117 * var_x53)));
        rJacobian[20][2] = 0.0;
        rJacobian[20][3] = 0.0;
        rJacobian[20][4] = 0.0;
        rJacobian[20][5] = 0.0;
        ...
        rJacobian[20][8] = 0.0;
        rJacobian[20][9] = 0.0;
        rJacobian[20][10] = -(mDt * (536388.91065592843 * var_x123 * (var_x119 + var_x121 * var_chaste_interface__Na_Concentrations__Na_j)));
        rJacobian[20][11] = 0.0;
        rJacobian[20][12] = 0.0;
        rJacobian[20][13] = 0.0;
        rJacobian[20][14] = 0.0;
        rJacobian[20][15] = 0.0;
        rJacobian[20][16] = 0.0;
        rJacobian[20][17] = -(mDt * (var_x111 * mParameters[3]));
        rJacobian[20][18] = 0.0;
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * ((-0.0007561 + var_x112 - var_x124 - 176588941779729.56 * var_x66 * (0.98999999999999999 * var_x82 + 6.567e-5 * var_x125 + var_x117 * var_x80 + 0.11 * var_x125 * var_x127 + 2.2781249999999999e-9 * var_x128 * var_x60 + 9.0157776108189337e-5 * var_x126 / (pow((6.8301345536507063e-5 + pow(var_chaste_interface__Na_Concentrations__Na_j, (-4))), 2) * pow(var_chaste_interface__Na_Concentrations__Na_j, 5)))) * mParameters[3]));
        ...
        rJacobian[21][0] = 0.0;
        rJacobian[21][1] = 0.0;
        rJacobian[21][2] = -(mDt * (-4759071980963.7119 * var_x118 * (1.2014999999999997e-7 * var_x102 - 2.6699999999999999 * var_x97 + var_x129 * var_x98)));
        rJacobian[21][3] = 0.0;
        rJacobian[21][4] = 0.0;
        rJacobian[21][5] = 0.0;
        rJacobian[21][6] = 0.0;
        ...
        rJacobian[21][9] = 0.0;
        rJacobian[21][10] = 0.0;
        rJacobian[21][11] = -(mDt * (1606.1867935752523 * var_x123 * (var_x119 + var_x121 * var_chaste_interface__Na_Concentrations__Na_sl)));
        rJacobian[21][12] = 0.0;
        rJacobian[21][13] = 0.0;
        rJacobian[21][14] = 0.0;
        rJacobian[21][15] = 0.0;
        rJacobian[21][16] = 0.0;
        rJacobian[21][17] = 0.0;
        rJacobian[21][18] = -(mDt * (var_x113 * mParameters[3]));
        rJacobian[21][19] = -(mDt * (7.7982153480071377 * var_x115));
        rJacobian[21][20] = -(mDt * (0.087152885187388451 * var_x115));
        rJacobian[21][21] = 1.0 - (mDt * ((-0.000165 + var_x114 - 7.8853682331945256 * var_x3 - 4759071980963.7119 * var_x66 * (0.00053133 * var_x130 + 8.0099999999999998 * var_x110 + var_x109 * var_x129 + 2.5312499999999994e-10 * var_x103 * var_x128 + 0.89000000000000001 * var_x127 * var_x130 + 0.00072945837032989554 * var_x126 / (pow((6.8301345536507063e-5 + pow(var_chaste_interface__Na_Concentrations__Na_sl, (-4))), 2) * pow(var_chaste_interface__Na_Concentrations__Na_sl, 5)))) * mParameters[3]));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        rJacobian[21][26] = 0.0;
        rJacobian[22][0] = -(mDt * (-6.3492962168146398e-7 * var_x16 + 5029484.9869235931 * var_x10 * var_x12 * var_x5 * mParameters[2]));
        rJacobian[22][1] = -(mDt * (var_x132));
        rJacobian[22][2] = 0.0;
        rJacobian[22][3] = 0.0;
        rJacobian[22][4] = 0.0;
        rJacobian[22][5] = 0.0;
        ...
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (-260 + var_x133 - var_x132 - 0.69232869146389786 * var_x25 - 8.7400597733819945e-14 * var_x26));
        rJacobian[22][23] = -(mDt * (var_x134));
        rJacobian[22][24] = 0.0;
        rJacobian[22][25] = -(mDt * (-var_x131 * var_x83));
        rJacobian[22][26] = 0.0;
        rJacobian[23][0] = 0.0;
        rJacobian[23][1] = 0.0;
        rJacobian[23][2] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (260 - var_x133));
        rJacobian[23][23] = 1.0 - (mDt * (-var_x134));
        rJacobian[23][24] = 0.0;
        rJacobian[23][25] = 0.0;
        rJacobian[23][26] = 0.0;
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = -(mDt * (var_x140 + var_x141 * var_x143));
        rJacobian[24][2] = 0.0;
        rJacobian[24][3] = 0.0;
        rJacobian[24][4] = 0.0;
        rJacobian[24][5] = 0.0;
        ...
        rJacobian[24][20] = 0.0;
        rJacobian[24][21] = 0.0;
        rJacobian[24][22] = -(mDt * (-var_x146 + var_x141 * var_x147));
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-0.065000000000000002 - var_x148));
        rJacobian[24][25] = -(mDt * (var_x149 - var_x148));
        rJacobian[24][26] = -(mDt * (-var_x148));
        rJacobian[25][0] = 0.0;
        rJacobian[25][1] = -(mDt * (var_x150 - var_x140));
        rJacobian[25][2] = 0.0;
        rJacobian[25][3] = 0.0;
        rJacobian[25][4] = 0.0;
        rJacobian[25][5] = 0.0;
        ...
        rJacobian[25][20] = 0.0;
        rJacobian[25][21] = 0.0;
        rJacobian[25][22] = -(mDt * (var_x146 + var_x151));
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = -(mDt * (0.0050000000000000001));
        rJacobian[25][25] = 1.0 - (mDt * (-0.059999999999999998 - var_x149));
        rJacobian[25][26] = -(mDt * (var_x148));
        rJacobian[26][0] = 0.0;
        rJacobian[26][1] = -(mDt * (-var_x150 - var_x139 * var_chaste_interface__SR_Fluxes__Ry_Rr));
        rJacobian[26][2] = 0.0;
        rJacobian[26][3] = 0.0;
        rJacobian[26][4] = 0.0;
        rJacobian[26][5] = 0.0;
        ...
        rJacobian[26][20] = 0.0;
        rJacobian[26][21] = 0.0;
        rJacobian[26][22] = -(mDt * (-var_x151 + 2.3772197685794643 * var_x135 * var_x136 * var_x144 * var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Rr));
        rJacobian[26][23] = 0.0;
        rJacobian[26][24] = -(mDt * (-0.0050000000000000001));
        rJacobian[26][25] = -(mDt * (0.055));
        rJacobian[26][26] = 1.0 - (mDt * (-0.0050000000000000001 - var_x148 - var_x149));
    }
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        ...
        const double var_K_Concentration__I_K_tot = -2 * var_I_NaK__I_nak + var_I_Ca__I_CaK + var_I_Ki__I_ki + var_I_Kp__I_kp + var_I_Kr__I_kr + var_I_Ks__I_ks + var_I_to__I_to; // uA_per_uF
        const double var_membrane_potential__I_tot = var_K_Concentration__I_K_tot + var_membrane_potential__I_Ca_tot + var_membrane_potential__I_Cl_tot + var_membrane_potential__I_Na_tot; // uA_per_uF
        const double d_dt_chaste_interface_var_membrane_potential__V_m = -var_membrane_potential__I_tot - var_membrane_potential__i_Stim; // mV / msec
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_I_Ca__dss = 1 / (1 + exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane_potential__V_m));
        const double var_I_Ca__fss = 1 / (1 + exp(3.8888888888888888 + 0.1111111111111111 * var_chaste_interface__membrane_potential__V_m)) + 0.59999999999999998 / (1 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane_potential__V_m));
        const double var_I_Ca__taud = 28.571428571428569 * (1 - exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane_potential__V_m)) * var_I_Ca__dss / (5 + var_chaste_interface__membrane_potential__V_m);
        const double var_I_Ca__tauf = 1 / (0.02 + 0.019699999999999999 * exp(-0.23877882250000002 * pow((1 + 0.068965517241379309 * var_chaste_interface__membrane_potential__V_m), 2)));
        const double var_I_Kr__tauxr = 230 / (1 + exp(2 + 0.050000000000000003 * var_chaste_interface__membrane_potential__V_m)) + 3300 / ((1 + exp(1.2222222222222223 + 0.1111111111111111 * var_chaste_interface__membrane_potential__V_m)) * (1 + exp(-2.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane_potential__V_m)));
        const double var_I_Kr__xrss = 1 / (1 + exp(-2 - 0.20000000000000001 * var_chaste_interface__membrane_potential__V_m));
        const double var_I_Ks__tauxs = 990.10000000000002 / (1 + exp(-0.17252124645892353 - 0.070821529745042494 * var_chaste_interface__membrane_potential__V_m));
        const double var_I_Ks__xsss = 1 / (1 + exp(-0.26666666666666666 - 0.070175438596491224 * var_chaste_interface__membrane_potential__V_m));
        const double var_I_Na__ah = ((var_chaste_interface__membrane_potential__V_m >= -40) ? (0) : (0.057000000000000002 * exp(-11.764705882352942 + 0.14705882352941177 * mParameters[14] - 0.14705882352941177 * var_chaste_interface__membrane_potential__V_m)));
        const double var_I_Na__aj = ((var_chaste_interface__membrane_potential__V_m >= -40) ? (0) : ((37.780000000000001 + var_chaste_interface__membrane_potential__V_m) * (-25428 * exp(0.24440000000000001 * var_chaste_interface__membrane_potential__V_m - 0.24440000000000001 * mParameters[14]) - 6.9480000000000002e-6 * exp(0.043909999999999998 * mParameters[14] - 0.043909999999999998 * var_chaste_interface__membrane_potential__V_m)) / (1 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane_potential__V_m - 0.311 * mParameters[14]))));
        ...
        const double var_I_Na__bj = ((var_chaste_interface__membrane_potential__V_m >= -40) ? (0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__membrane_potential__V_m - 0.057000000000000002 * mParameters[14]) / (1 + exp(-3.2000000000000002 + 0.10000000000000001 * mParameters[14] - 0.10000000000000001 * var_chaste_interface__membrane_potential__V_m))) : (0.024240000000000001 * exp(0.01052 * mParameters[14] - 0.01052 * var_chaste_interface__membrane_potential__V_m) / (1 + exp(-5.5312920000000005 + 0.13780000000000001 * mParameters[14] - 0.13780000000000001 * var_chaste_interface__membrane_potential__V_m))));
        const double var_I_Na__hss = 0.01 * mParameters[13] + 1 * (1 - 0.01 * mParameters[13]) / pow((1 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * mParameters[14])), 2);
        const double var_I_Na__jss = 0.01 * mParameters[13] + 1 * (1 - 0.01 * mParameters[13]) / pow((1 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * mParameters[14])), 2);
        const double var_I_Na__mss = 1 / pow((1 + exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane_potential__V_m)), 2);
        const double var_I_Na__tauh = 1 / (var_I_Na__ah + var_I_Na__bh);
        const double var_I_Na__tauj = 1 / (var_I_Na__aj + var_I_Na__bj);
        const double var_I_Na__taum = 0.12920000000000001 * exp(-8.682389366752302 * pow((1 + 0.021838829438742085 * var_chaste_interface__membrane_potential__V_m), 2)) + 0.064869999999999997 * exp(-0.0089012876052174655 * pow((-1 + 0.2073398299813394 * var_chaste_interface__membrane_potential__V_m), 2));
        const double var_I_to__tauxtof = 0.5 + 8.5 * exp(-0.81000000000000005 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane_potential__V_m), 2));
        const double var_I_to__tauxtos = 0.5 + 9 / (1 + exp(0.20000000000000001 + 0.066666666666666666 * var_chaste_interface__membrane_potential__V_m));
        const double var_I_to__tauytof = 7 + 85 * exp(-7.2727272727272725 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane_potential__V_m), 2));
        const double var_I_to__tauytos = 30 + 800 / (1 + exp(6 + 0.10000000000000001 * var_chaste_interface__membrane_potential__V_m));
        const double var_I_to__xtoss = 1 / (1 + exp(1.4615384615384615 - 0.076923076923076927 * var_chaste_interface__membrane_potential__V_m));
        const double var_I_to__ytoss = 1 / (1 + exp(3.8999999999999999 + 0.20000000000000001 * var_chaste_interface__membrane_potential__V_m));
    ...
    std::vector<double> Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        ...
        const double var_I_Kr__rkr = 1 / (1 + exp(3.0833333333333335 + 0.041666666666666664 * var_chaste_interface__membrane_potential__V_m)); // dimensionless
        const double var_I_Na__ah = ((var_chaste_interface__membrane_potential__V_m >= -40) ? (0) : (0.057000000000000002 * exp(-11.764705882352942 + 0.14705882352941177 * mParameters[14] - 0.14705882352941177 * var_chaste_interface__membrane_potential__V_m))); // dimensionless
        const double var_I_Na__aj = ((var_chaste_interface__membrane_potential__V_m >= -40) ? (0) : ((37.780000000000001 + var_chaste_interface__membrane_potential__V_m) * (-25428 * exp(0.24440000000000001 * var_chaste_interface__membrane_potential__V_m - 0.24440000000000001 * mParameters[14]) - 6.9480000000000002e-6 * exp(0.043909999999999998 * mParameters[14] - 0.043909999999999998 * var_chaste_interface__membrane_potential__V_m)) / (1 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane_potential__V_m - 0.311 * mParameters[14])))); // dimensionless
        ...
        const double var_I_Na__bj = ((var_chaste_interface__membrane_potential__V_m >= -40) ? (0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__membrane_potential__V_m - 0.057000000000000002 * mParameters[14]) / (1 + exp(-3.2000000000000002 + 0.10000000000000001 * mParameters[14] - 0.10000000000000001 * var_chaste_interface__membrane_potential__V_m))) : (0.024240000000000001 * exp(0.01052 * mParameters[14] - 0.01052 * var_chaste_interface__membrane_potential__V_m) / (1 + exp(-5.5312920000000005 + 0.13780000000000001 * mParameters[14] - 0.13780000000000001 * var_chaste_interface__membrane_potential__V_m)))); // dimensionless
        const double var_I_Na__tauh = 1 / (var_I_Na__ah + var_I_Na__bh); // msec
        const double var_I_Na__tauj = 1 / (var_I_Na__aj + var_I_Na__bj); // msec
        const double var_membrane_potential__i_Stim_converted = GetIntracellularAreaStimulus(var_chaste_interface__environment__time); // uA_per_cm2
        const double var_parameters__Cmem_converted = 1000000 * mParameters[22]; // uF
        const double var_parameters__Fjunc = 0.11; // dimensionless
        const double var_parameters__Fjunc_CaL = 0.90000000000000002; // dimensionless
        const double var_parameters__Fsl = 1 - var_parameters__Fjunc; // dimensionless
        const double var_I_Ks__GKs_total = (var_I_Ks__gks_junc * var_parameters__Fjunc + var_I_Ks__gks_sl * var_parameters__Fsl) * mParameters[18]; // mS_per_uF
