...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_activated_chloride_current__O_ClCa = 0.20000000000000001 / (1 + exp(5.9871794871794881 - 0.12820512820512822 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_sodium_potassium_pump_current__f_NaK = 1 / (1 + 0.1245 * exp(-0.10000000000000001 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + 0.036499999999999998 * var_sodium_potassium_pump_current__sigma * exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))); // dimensionless
        const double var_sodium_potassium_pump_current__i_NaK = 1 * mParameters[5] * var_sodium_potassium_pump_current__f_NaK * var_sodium_potassium_pump_current__i_NaK_max / ((1 + pow((var_sodium_potassium_pump_current__Km_Nai / var_chaste_interface__sodium_concentration__Nai), 1.5)) * (mParameters[5] + var_sodium_potassium_pump_current__Km_Ko)); // picoA_per_picoF
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rResidual[32])
    {
        ...
        const double var_calcium_concentration__Bi = 1 / (1 + var_calcium_concentration__CMDN_tot * var_calcium_concentration__Km_CMDN / pow((var_calcium_concentration__Cai + var_calcium_concentration__Km_CMDN), 2)); // dimensionless
        const double var_calcium_concentration__Bss = 1 / (1 + var_calcium_concentration__CMDN_tot * var_calcium_concentration__Km_CMDN / pow((var_chaste_interface__calcium_concentration__Cass + var_calcium_concentration__Km_CMDN), 2)); // dimensionless
        ...
        const double var_membrane__T = 298; // kelvin
        const double var_calcium_background_current__E_CaN = 0.5 * var_membrane__R * var_membrane__T * log(mParameters[4] / var_calcium_concentration__Cai) / var_membrane__F; // millivolt
        const double var_L_type_calcium_current__Kpcf = 13 - 13 * exp(-0.01 * pow((14.5 + var_chaste_interface__membrane__V), 2)); // per_millisecond
        const double var_L_type_calcium_current__alpha = 0.40000000000000002 * (1 + 0.69999999999999996 * exp(-0.10000000000000001 * pow((40 + var_chaste_interface__membrane__V), 2)) - 0.75 * exp(-0.0025000000000000001 * pow((20 + var_chaste_interface__membrane__V), 2))) * exp(1.2 + 0.10000000000000001 * var_chaste_interface__membrane__V) / (1 + 0.12 * exp(1.2 + 0.10000000000000001 * var_chaste_interface__membrane__V)); // per_millisecond
        ...
        const double d_dt_chaste_interface_var_L_type_calcium_current__I3 = var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__gamma - var_chaste_interface__L_type_calcium_current__I3 * var_L_type_calcium_current__Kpcb + 0.001 * var_chaste_interface__L_type_calcium_current__I1 * var_L_type_calcium_current__Kpcf - 0.001 * var_chaste_interface__L_type_calcium_current__I3 * var_L_type_calcium_current__alpha + 1 * var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__Kpcf * var_L_type_calcium_current__gamma - 4 * var_chaste_interface__L_type_calcium_current__I3 * var_L_type_calcium_current__Kpcb * var_L_type_calcium_current__beta; // 1 / millisecond
        const double d_dt_chaste_interface_var_L_type_calcium_current__O = var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__alpha + var_chaste_interface__L_type_calcium_current__I1 * var_L_type_calcium_current__Kpcb - var_chaste_interface__L_type_calcium_current__O * var_L_type_calcium_current__gamma + 0.001 * var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__alpha - 4 * var_chaste_interface__L_type_calcium_current__O * var_L_type_calcium_current__beta - 0.001 * var_L_type_calcium_current__Kpcf * var_chaste_interface__L_type_calcium_current__O; // 1 / millisecond
        const double var_L_type_calcium_current__i_CaL = (-var_L_type_calcium_current__E_CaL + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_calcium_current__O * mParameters[7]; // picoA_per_picoF
        const double d_dt_chaste_interface_var_calcium_fluxes__P_RyR = -0.040000000000000001 * var_chaste_interface__calcium_fluxes__P_RyR - 0.10000000000000001 * var_L_type_calcium_current__i_CaL * exp(-0.0015432098765432098 * pow((-5 + var_chaste_interface__membrane__V), 2)) / var_L_type_calcium_current__i_CaL_max; // 1 / millisecond
        const double var_calcium_background_current__i_Cab = (-var_calcium_background_current__E_CaN + var_chaste_interface__membrane__V) * var_calcium_background_current__g_Cab; // picoA_per_picoF
        ...
        const double var_sodium_background_current__i_Nab = (-var_fast_sodium_current__E_Na + var_chaste_interface__membrane__V) * var_sodium_background_current__g_Nab; // picoA_per_picoF
        const double var_sodium_calcium_exchange_current__i_NaCa = 1 * (pow(var_chaste_interface__sodium_concentration__Nai, 3) * mParameters[4] * exp(var_membrane__F * var_chaste_interface__membrane__V * var_sodium_calcium_exchange_current__eta / (var_membrane__R * var_membrane__T)) - pow(mParameters[6], 3) * var_calcium_concentration__Cai * exp((-1 + var_sodium_calcium_exchange_current__eta) * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * mParameters[15] / ((1 + var_sodium_calcium_exchange_current__k_sat * exp((-1 + var_sodium_calcium_exchange_current__eta) * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * (pow(mParameters[6], 3) + pow(var_sodium_calcium_exchange_current__K_mNa, 3)) * (mParameters[4] + var_sodium_calcium_exchange_current__K_mCa)); // picoA_per_picoF
        const double var_calcium_concentration__Cai_orig_deriv = (-var_calcium_fluxes__J_trpn - var_calcium_fluxes__J_up - 0.5 * (-2 * var_sodium_calcium_exchange_current__i_NaCa + var_calcium_background_current__i_Cab + var_calcium_pump_current__i_pCa) * var_membrane__Acap * mParameters[8] / (var_membrane__F * var_membrane__Vmyo) + var_calcium_fluxes__J_leak + var_calcium_fluxes__J_xfer) * var_calcium_concentration__Bi; // micromolar / millisecond
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rJacobian[32][32])
    {
        ...
        const double var_x2 = var_x1 * (1 + 0.69999999999999996 * exp(-0.10000000000000001 * pow((40 + var_chaste_interface__membrane__V), 2)) - 0.75 * exp(-0.0025000000000000001 * pow((20 + var_chaste_interface__membrane__V), 2))) / (1 + 0.12 * var_x1);
        ...
        const double var_x7 = exp(-0.01 * pow((14.5 + var_chaste_interface__membrane__V), 2));
        const double var_x8 = 0.026000000000000002 * var_x7;
        const double var_x9 = 13 - 13 * var_x7;
        const double var_x10 = 20 + var_chaste_interface__calcium_concentration__Cass;
        const double var_x11 = 1 / var_x10;
        const double var_x12 = 0.23324 * var_x11;
        const double var_x13 = var_x12 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x14 = var_x13 * var_x9;
        const double var_x15 = 0.40000000000000002 * var_x2;
        const double var_x16 = 0.00093296000000000004 * var_x2;
        const double var_x17 = var_x11 * var_x16;
        const double var_x18 = var_x17 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x19 = 0.00040000000000000002 * var_x0;
        const double var_x20 = 0.0001 * var_x0;
        const double var_x21 = 0.20000000000000001 * var_x0;
        const double var_x22 = var_chaste_interface__calcium_concentration__Cass / pow(var_x10, 2);
        const double var_x23 = -var_x17 * var_chaste_interface__L_type_calcium_current__C4 + var_x16 * var_x22 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x24 = var_x9 * var_chaste_interface__L_type_calcium_current__C4;
        const double var_x25 = 0.23324 * var_x22;
        const double var_x26 = var_x24 * var_x25 - var_x12 * var_x24;
        const double var_x27 = 0.013000000000000001 * var_x7;
        const double var_x28 = -var_x27;
        const double var_x29 = 0.00040000000000000002 * var_x2;
        const double var_x30 = var_x25 * var_chaste_interface__L_type_calcium_current__O - var_x12 * var_chaste_interface__L_type_calcium_current__O;
        const double var_x31 = 0.013000000000000001 - var_x27;
        const double var_x32 = var_x25 * var_chaste_interface__L_type_calcium_current__I2 - var_x12 * var_chaste_interface__L_type_calcium_current__I2;
        const double var_x33 = 2.3700000000000001 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x34 = 3.1999999999999999e-5 + var_x33;
        const double var_x35 = 2.3700000000000001 * var_chaste_interface__calcium_buffering__HTRPN_Ca;
        const double var_x36 = 32.699999999999996 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x37 = 0.019599999999999999 + var_x36;
        const double var_x38 = 32.699999999999996 * var_chaste_interface__calcium_buffering__LTRPN_Ca;
        const double var_x39 = 800 + var_chaste_interface__calcium_concentration__CaJSR;
        const double var_x40 = 1 + 12000000 / pow(var_x39, 2);
        const double var_x41 = 1 / var_x40;
        const double var_x42 = var_chaste_interface__ryanodine_receptors__P_O1 + var_chaste_interface__ryanodine_receptors__P_O2;
        const double var_x43 = var_x42 * mParameters[1];
        const double var_x44 = var_x43 * var_chaste_interface__calcium_fluxes__P_RyR;
        const double var_x45 = -var_chaste_interface__calcium_concentration__Cass + var_chaste_interface__calcium_concentration__CaJSR;
        const double var_x46 = var_x41 * var_x45;
        const double var_x47 = var_chaste_interface__calcium_fluxes__P_RyR * mParameters[1];
        const double var_x48 = -var_x46 * var_x47;
        const double var_x49 = 1000000 * pow(var_chaste_interface__calcium_concentration__Cai_converted, 2);
        const double var_x50 = 0.25 + var_x49;
        const double var_x51 = 1 / var_x50;
        const double var_x52 = var_x51 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x53 = pow(var_x50, (-2));
        const double var_x54 = pow(var_chaste_interface__calcium_concentration__Cai_converted, 3);
        const double var_x55 = var_x53 * var_x54;
        const double var_x56 = 1000 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x57 = 0.23799999999999999 + var_x56;
        const double var_x58 = 1 + 11.899999999999999 / pow(var_x57, 2);
        const double var_x59 = 1 / var_x58;
        const double var_x60 = 0.001 * var_x59;
        const double var_x61 = 1 / var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x62 = 2000000 * var_x52;
        const double var_x63 = exp(-0.025317124991725771 * var_chaste_interface__membrane__V);
        const double var_x64 = pow(mParameters[6], 3);
        const double var_x65 = var_x63 * var_x64;
        const double var_x66 = mParameters[15] / ((1 + 0.10000000000000001 * var_x63) * (1380 + mParameters[4]) * (669921875000000.0 + var_x64));
        const double var_x67 = var_x65 * var_x66;
        const double var_x68 = 0.03075923579139864 * mParameters[8];
        const double var_x69 = var_x49 * var_x51;
        const double var_x70 = exp(0.013632298072467722 * var_chaste_interface__membrane__V);
        const double var_x71 = var_x66 * var_x70 * pow(var_chaste_interface__sodium_concentration__Nai, 2) * mParameters[4];
        const double var_x72 = 0.23799999999999999 + var_chaste_interface__calcium_concentration__Cass;
        const double var_x73 = 1 + 11.899999999999999 / pow(var_x72, 2);
        const double var_x74 = 1 / var_x73;
        const double var_x75 = (-63 + var_chaste_interface__membrane__V) * mParameters[7];
        const double var_x76 = 535.23141606043157 * var_x75 * mParameters[8];
        const double var_x77 = 80.808080808080803 * var_x44;
        const double var_x78 = 80.808080808080803 * var_x45 * var_x74;
        const double var_x79 = var_x47 * var_x78;
        const double var_x80 = 0.04926108374384236 * var_chaste_interface__membrane__V;
        const double var_x81 = 0.20000000000000001 * exp(0.12315270935960591 - var_x80);
        const double var_x82 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__membrane__V);
        const double var_x83 = 1 / (0.25 * var_x82 + 0.1027 * exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__membrane__V));
        const double var_x84 = 3.802 * var_x83;
        const double var_x85 = 0.008539999999999999 + 2.0000000000000002e-5 * var_chaste_interface__membrane__V;
        const double var_x86 = 3.802 / (0.1027 * exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V) + 0.23000000000000001 * var_x82);
        const double var_x87 = exp(-0.90909090909090906 - 0.12987012987012986 * var_chaste_interface__membrane__V);
        const double var_x88 = 6.9999999999999997e-7 * var_x87;
        const double var_x89 = exp(0.36945812807881773 - var_x80);
        const double var_x90 = 0.22 * var_x89;
        const double var_x91 = 3.802 / (0.20000000000000001 * var_x82 + 0.1027 * exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__membrane__V));
        const double var_x92 = -var_x91;
        const double var_x93 = 0.19170000000000001 * exp(-0.12315270935960591 - var_x80);
        const double var_x94 = var_x86 + var_x93;
        const double var_x95 = var_x85 + var_x91;
        const double var_x96 = 1 / (0.39395599999999997 + 0.188495 * exp(-0.42168674698795178 + 0.060240963855421679 * mParameters[10] - 0.060240963855421679 * var_chaste_interface__membrane__V));
        const double var_x97 = 1.0526315789473684e-5 * var_x96;
        const double var_x98 = 1.4e-8 * var_x87;
        const double var_x99 = 0.001 * var_x96;
        const double var_x100 = -var_x85;
        const double var_x101 = 1.2097272727272726e-5 * var_x83 * var_x87 * var_x96 / (var_x85 * var_x89);
        const double var_x102 = 1 * var_x96;
        const double var_x103 = 1 / var_chaste_interface__potassium_concentration__Ki;
        const double var_x104 = var_x103 * mParameters[5];
        const double var_x105 = log(var_x104);
        const double var_x106 = -25.674321243523316 * var_x105 + var_chaste_interface__membrane__V;
        const double var_x107 = mParameters[8] * mParameters[3];
        const double var_x108 = 0.061518471582797281 * var_x107;
        const double var_x109 = var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss * mParameters[12];
        const double var_x110 = 1 / (1 * var_chaste_interface__potassium_concentration__Ki + 0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai);
        const double var_x111 = 25.674321243523316 * var_x103;
        const double var_x112 = exp(0.089599999999999999 * var_chaste_interface__membrane__V - 2.300419183419689 * var_x105);
        const double var_x113 = 1 + var_x112;
        const double var_x114 = var_x104 * mParameters[11] / (210 + mParameters[5]);
        const double var_x115 = 1 / var_chaste_interface__sodium_concentration__Nai;
        const double var_x116 = pow(var_x115, 1.5);
        const double var_x117 = var_x115 * var_x116 * mParameters[5] / (pow((1 + 3043189.1166997822 * var_x116), 2) * (1500 + mParameters[5]) * (1 + 0.1245 * exp(-0.0038949423064193493 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.4858841010401188e-5 * mParameters[6])) * exp(-0.038949423064193495 * var_chaste_interface__membrane__V)));
        const double var_x118 = 0.022348 * exp(0.01176 * var_chaste_interface__membrane__V);
        const double var_x119 = -var_x118;
        const double var_x120 = 0.013733 * exp(0.038198000000000003 * var_chaste_interface__membrane__V);
        const double var_x121 = 6.8899999999999994e-5 * exp(-0.041779999999999998 * var_chaste_interface__membrane__V);
        const double var_x122 = 0.0064970000000000002 * exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x123 = 0.090820999999999999 * exp(0.11695499999999999 + 0.023390999999999999 * var_chaste_interface__membrane__V);
        const double var_x124 = 0.012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2) * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x125 = pow(var_chaste_interface__calcium_concentration__Cass, 3);
        const double var_x126 = 0.0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4);
        const double var_x127 = 0.0040499999999999998 * var_x125;
        const double var_x128 = 1 / (1 * var_chaste_interface__sodium_concentration__Nai + 0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki);
        const double var_x129 = var_x128 * var_chaste_interface__fast_sodium_current__O_Na * mParameters[9];
        ...
        rJacobian[2][2] = 1.0 - (mDt * (-0.026000000000000002 + var_x8 - var_x14 - var_x15 - var_x18 - var_x6));
        rJacobian[2][3] = -(mDt * (1.0000000000000002e-6 * var_x0));
        rJacobian[2][4] = -(mDt * (var_x19));
        rJacobian[2][5] = -(mDt * (var_x20));
        rJacobian[2][6] = -(mDt * (var_x21));
        rJacobian[2][7] = 0.0;
        rJacobian[2][8] = 0.0;
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = 0.0;
        rJacobian[2][12] = -(mDt * (var_x23 + var_x26));
        rJacobian[2][13] = 0.0;
        rJacobian[2][14] = 0.0;
        rJacobian[2][15] = 0.0;
        rJacobian[2][16] = 0.0;
        ...
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = -(mDt * (var_x18));
        rJacobian[3][3] = 1.0 - (mDt * (-0.0135 - var_x28 - 0.002 * var_x0 * var_x9));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (var_x29));
        rJacobian[3][6] = -(mDt * (var_x13));
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = 0.0;
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = 0.0;
        rJacobian[3][12] = -(mDt * (-var_x23 - var_x30));
        rJacobian[3][13] = 0.0;
        rJacobian[3][14] = 0.0;
        rJacobian[3][15] = 0.0;
        rJacobian[3][16] = 0.0;
        ...
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-var_x13 - var_x19 - var_x29));
        rJacobian[4][5] = -(mDt * (0.00050000000000000001));
        rJacobian[4][6] = -(mDt * (var_x31));
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = 0.0;
        rJacobian[4][11] = 0.0;
        rJacobian[4][12] = -(mDt * (var_x32));
        rJacobian[4][13] = 0.0;
        rJacobian[4][14] = 0.0;
        rJacobian[4][15] = 0.0;
        rJacobian[4][16] = 0.0;
        ...
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = -(mDt * (var_x14));
        rJacobian[5][3] = -(mDt * (var_x31));
        rJacobian[5][4] = -(mDt * (var_x13));
        rJacobian[5][5] = 1.0 - (mDt * (-0.00050000000000000001 - var_x20 - var_x29));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = 0.0;
        rJacobian[5][12] = -(mDt * (-var_x26 - var_x32));
        rJacobian[5][13] = 0.0;
        rJacobian[5][14] = 0.0;
        rJacobian[5][15] = 0.0;
        rJacobian[5][16] = 0.0;
        ...
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = -(mDt * (var_x15));
        rJacobian[6][3] = -(mDt * (0.00050000000000000001));
        rJacobian[6][4] = -(mDt * (var_x29));
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.013000000000000001 - var_x13 - var_x21 - var_x28));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = 0.0;
        rJacobian[6][12] = -(mDt * (var_x30));
        rJacobian[6][13] = 0.0;
        rJacobian[6][14] = 0.0;
        rJacobian[6][15] = 0.0;
        rJacobian[6][16] = 0.0;
        ...
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-var_x34));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = -(mDt * (331.80000000000001 - var_x35));
        rJacobian[7][12] = 0.0;
        rJacobian[7][13] = 0.0;
        rJacobian[7][14] = 0.0;
        rJacobian[7][15] = 0.0;
        ...
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (-var_x37));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = -(mDt * (2289 - var_x38));
        rJacobian[8][12] = 0.0;
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = 0.0;
        rJacobian[8][15] = 0.0;
        ...
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        rJacobian[9][9] = 1.0 - (mDt * (var_x41 * (-0.050000000000000003 - var_x44) + 24000000 * (0.050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR - var_x44 * var_x45) / (pow(var_x39, 3) * pow(var_x40, 2))));
        rJacobian[9][10] = -(mDt * (0.050000000000000003 * var_x41));
        rJacobian[9][11] = 0.0;
        rJacobian[9][12] = -(mDt * (var_x41 * var_x44));
        rJacobian[9][13] = -(mDt * (-var_x43 * var_x46));
        rJacobian[9][14] = 0.0;
        rJacobian[9][15] = 0.0;
        rJacobian[9][16] = 0.0;
        rJacobian[9][17] = 0.0;
        ...
        rJacobian[9][27] = 0.0;
        rJacobian[9][28] = 0.0;
        rJacobian[9][29] = -(mDt * (var_x48));
        rJacobian[9][30] = -(mDt * (var_x48));
        rJacobian[9][31] = 0.0;
        rJacobian[10][0] = 0.0;
        rJacobian[10][1] = 0.0;
        rJacobian[10][2] = 0.0;
        ...
        rJacobian[10][11] = -(mDt * (12316.491897044803 * mParameters[0] + 24632983.794089608 * var_x52 * mParameters[2] - 24632983794089.605 * var_x55 * mParameters[2]));
        rJacobian[10][12] = 0.0;
        rJacobian[10][13] = 0.0;
        rJacobian[10][14] = 0.0;
        rJacobian[10][15] = 0.0;
        ...
        rJacobian[11][29] = 0.0;
        rJacobian[11][30] = 0.0;
        rJacobian[11][31] = -(mDt * (0.00018455541474839184 * var_x59 * var_x71 * mParameters[8]));
        rJacobian[12][0] = 0.0;
        rJacobian[12][1] = 0.0;
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = 0.0;
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = -(mDt * (-var_x74 * var_x76));
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = -(mDt * (var_x74 * var_x77));
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = -(mDt * (2175084.1750841751 * var_x74));
        rJacobian[12][12] = 1.0 - (mDt * (var_x74 * (-2175.0841750841751 - var_x77) + 23.799999999999997 * (2175084.1750841751 * var_chaste_interface__calcium_concentration__Cai_converted - 2175.0841750841751 * var_chaste_interface__calcium_concentration__Cass - var_x76 * var_chaste_interface__L_type_calcium_current__O + 80.808080808080803 * var_x42 * var_x45 * var_chaste_interface__calcium_fluxes__P_RyR * mParameters[1]) / (pow(var_x72, 3) * pow(var_x73, 2))));
        rJacobian[12][13] = -(mDt * (var_x43 * var_x78));
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        rJacobian[12][17] = 0.0;
        ...
        rJacobian[12][27] = 0.0;
        rJacobian[12][28] = 0.0;
        rJacobian[12][29] = -(mDt * (var_x79));
        rJacobian[12][30] = -(mDt * (var_x79));
        rJacobian[12][31] = 0.0;
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = 0.0;
        ...
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = -(mDt * (-0.014285714285714287 * var_x75 * exp(-0.0015432098765432098 * pow((-5 + var_chaste_interface__membrane__V), 2))));
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = 0.0;
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-var_x81 - var_x84 - var_x85));
        rJacobian[14][15] = -(mDt * (var_x86));
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        rJacobian[14][19] = 0.0;
        rJacobian[14][20] = -(mDt * (var_x88));
        rJacobian[14][21] = -(mDt * (var_x90));
        rJacobian[14][22] = 0.0;
        rJacobian[14][23] = 0.0;
        rJacobian[14][24] = 0.0;
        rJacobian[14][25] = 0.0;
        ...
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = -(mDt * (var_x81 + var_x92));
        rJacobian[15][15] = 1.0 - (mDt * (-var_x94 - var_x95));
        rJacobian[15][16] = -(mDt * (var_x92));
        rJacobian[15][17] = -(mDt * (var_x92));
        rJacobian[15][18] = -(mDt * (var_x88 + var_x92));
        rJacobian[15][19] = -(mDt * (var_x92));
        rJacobian[15][20] = -(mDt * (var_x92));
        rJacobian[15][21] = -(mDt * (var_x92));
        rJacobian[15][22] = 0.0;
        rJacobian[15][23] = 0.0;
        rJacobian[15][24] = 0.0;
        rJacobian[15][25] = 0.0;
        ...
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (-var_x88 - var_x97));
        rJacobian[16][17] = -(mDt * (var_x98));
        rJacobian[16][18] = 0.0;
        rJacobian[16][19] = 0.0;
        rJacobian[16][20] = -(mDt * (var_x99));
        rJacobian[16][21] = 0.0;
        rJacobian[16][22] = 0.0;
        rJacobian[16][23] = 0.0;
        rJacobian[16][24] = 0.0;
        ...
        rJacobian[17][14] = 0.0;
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = -(mDt * (var_x97));
        rJacobian[17][17] = 1.0 - (mDt * (-var_x98));
        rJacobian[17][18] = 0.0;
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = 0.0;
        rJacobian[17][21] = 0.0;
        ...
        rJacobian[18][13] = 0.0;
        rJacobian[18][14] = 0.0;
        rJacobian[18][15] = -(mDt * (var_x85));
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-var_x88 - var_x94));
        rJacobian[18][19] = -(mDt * (var_x91));
        rJacobian[18][20] = -(mDt * (var_x81));
        rJacobian[18][21] = 0.0;
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        ...
        rJacobian[19][12] = 0.0;
        rJacobian[19][13] = 0.0;
        rJacobian[19][14] = -(mDt * (var_x100));
        rJacobian[19][15] = -(mDt * (var_x100));
        rJacobian[19][16] = -(mDt * (var_x100));
        rJacobian[19][17] = -(mDt * (var_x100));
        rJacobian[19][18] = -(mDt * (var_x93 - var_x85));
        rJacobian[19][19] = 1.0 - (mDt * (-var_x88 - var_x95));
        rJacobian[19][20] = -(mDt * (var_x100));
        rJacobian[19][21] = -(mDt * (var_x100));
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = 0.0;
        ...
        rJacobian[20][12] = 0.0;
        rJacobian[20][13] = 0.0;
        rJacobian[20][14] = -(mDt * (var_x85));
        rJacobian[20][15] = 0.0;
        rJacobian[20][16] = -(mDt * (var_x88));
        rJacobian[20][17] = 0.0;
        rJacobian[20][18] = -(mDt * (var_x86));
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * (-var_x101 - var_x81 - var_x88 - var_x99));
        ...
        rJacobian[21][21] = 1.0 - (mDt * (-var_x102 - var_x90));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (-var_x106 * var_x108 * var_x109));
        rJacobian[23][23] = 1.0 - (mDt * (-var_x108 * (25.674321243523316 * var_x114 / var_x113 + var_x109 * var_x111 * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss + var_x111 * pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 2) * mParameters[14] + 4.1078913989637309 * var_x103 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur + 25.674321243523316 * var_x110 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K * mParameters[13] + var_x111 * pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 3) * mParameters[16] * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 2.300419183419689 * var_x106 * var_x112 * var_x114 / pow(var_x113, 2))));
        rJacobian[23][24] = 0.0;
        rJacobian[23][25] = 0.0;
        rJacobian[23][26] = 0.0;
        rJacobian[23][27] = -(mDt * (-var_x108 * (-25.674321243523316 * log(var_x110 * (1 * mParameters[5] + 0.020408163265306124 * mParameters[6])) + var_chaste_interface__membrane__V) * mParameters[13]));
        rJacobian[23][28] = 0.0;
        rJacobian[23][29] = 0.0;
        rJacobian[23][30] = 0.0;
        rJacobian[23][31] = -(mDt * (-var_x108 * (-8034019.2680874243 * var_x117 + 0.52396573966374116 * var_x110 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K * mParameters[13])));
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = 0.0;
        rJacobian[24][2] = 0.0;
        rJacobian[24][3] = 0.0;
        ...
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-0.023761000000000001 - var_x118 - 0.047002000000000002 * exp(-0.063100000000000003 * var_chaste_interface__membrane__V)));
        rJacobian[24][25] = -(mDt * (0.036777999999999998 - var_x118));
        rJacobian[24][26] = -(mDt * (var_x119));
        rJacobian[24][27] = -(mDt * (var_x119));
        rJacobian[24][28] = 0.0;
        rJacobian[24][29] = 0.0;
        rJacobian[24][30] = 0.0;
        rJacobian[24][31] = 0.0;
        ...
        rJacobian[25][25] = 1.0 - (mDt * (-0.036777999999999998 - var_x120));
        rJacobian[25][26] = 0.0;
        rJacobian[25][27] = -(mDt * (var_x121));
        rJacobian[25][28] = 0.0;
        rJacobian[25][29] = 0.0;
        rJacobian[25][30] = 0.0;
        rJacobian[25][31] = 0.0;
        ...
        rJacobian[26][24] = 0.0;
        rJacobian[26][25] = 0.0;
        rJacobian[26][26] = 1.0 - (mDt * (-var_x122));
        rJacobian[26][27] = -(mDt * (var_x123));
        rJacobian[26][28] = 0.0;
        rJacobian[26][29] = 0.0;
        rJacobian[26][30] = 0.0;
        rJacobian[26][31] = 0.0;
        ...
        rJacobian[27][23] = 0.0;
        rJacobian[27][24] = 0.0;
        rJacobian[27][25] = -(mDt * (var_x120));
        rJacobian[27][26] = -(mDt * (var_x122));
        rJacobian[27][27] = 1.0 - (mDt * (-var_x121 - var_x123));
        rJacobian[27][28] = 0.0;
        rJacobian[27][29] = 0.0;
        rJacobian[27][30] = 0.0;
        rJacobian[27][31] = 0.0;
        ...
        rJacobian[29][10] = 0.0;
        rJacobian[29][11] = 0.0;
        rJacobian[29][12] = -(mDt * (-var_x124 + 0.024299999999999999 * var_x125 * (1 - var_x42 - var_chaste_interface__ryanodine_receptors__P_C2)));
        rJacobian[29][13] = 0.0;
        rJacobian[29][14] = 0.0;
        rJacobian[29][15] = 0.0;
        rJacobian[29][16] = 0.0;
        ...
        rJacobian[29][26] = 0.0;
        rJacobian[29][27] = 0.0;
        rJacobian[29][28] = -(mDt * (0.00080000000000000004 - var_x126));
        rJacobian[29][29] = 1.0 - (mDt * (-0.080249999999999988 - var_x126 - var_x127));
        rJacobian[29][30] = -(mDt * (0.96499999999999997 - var_x126));
        rJacobian[29][31] = 0.0;
        rJacobian[30][0] = 0.0;
        rJacobian[30][1] = 0.0;
        rJacobian[30][2] = 0.0;
        ...
        rJacobian[31][9] = 0.0;
        rJacobian[31][10] = 0.0;
        rJacobian[31][11] = -(mDt * (184.55541474839183 * var_x107 * var_x67));
        rJacobian[31][12] = 0.0;
        rJacobian[31][13] = 0.0;
        rJacobian[31][14] = 0.0;
        rJacobian[31][15] = 0.0;
        ...
        rJacobian[31][19] = 0.0;
        rJacobian[31][20] = 0.0;
        rJacobian[31][21] = -(mDt * (-var_x108 * (-25.674321243523316 * log(var_x128 * (1 * mParameters[6] + 0.1111111111111111 * mParameters[5])) + var_chaste_interface__membrane__V) * mParameters[9]));
        rJacobian[31][22] = 0.0;
        rJacobian[31][23] = -(mDt * (-var_x108 * (2.8527023603914796 * var_x129 + 0.007417026137017846 * var_x128)));
        rJacobian[31][24] = 0.0;
        rJacobian[31][25] = 0.0;
        rJacobian[31][26] = 0.0;
        rJacobian[31][27] = 0.0;
        ...
        rJacobian[31][29] = 0.0;
        rJacobian[31][30] = 0.0;
        rJacobian[31][31] = 1.0 - (mDt * (-var_x108 * (9 * var_x71 + 0.066753235233160624 * var_x128 + 12051028.902131137 * var_x117 + 25.674321243523316 * var_x129)));
    }
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_fast_transient_outward_potassium_current__alpha_i = 0.00015200000000000001 * exp(-1.9285714285714286 - 0.14285714285714285 * var_chaste_interface__membrane__V) / (1 + 0.0067083000000000004 * exp(-4.7857142857142856 - 0.14285714285714285 * var_chaste_interface__membrane__V));
        ...
        const double var_fast_transient_outward_potassium_current__beta_i = 0.00095 * exp(4.7857142857142856 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1 + 0.051334999999999999 * exp(4.7857142857142856 + 0.14285714285714285 * var_chaste_interface__membrane__V));
        ...
        const double var_slow_transient_outward_potassium_current__ass = 1 / (1 + exp(-2.9220779220779218 - 0.12987012987012986 * var_chaste_interface__membrane__V));
        const double var_slow_transient_outward_potassium_current__iss = 1 / (1 + exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V));
