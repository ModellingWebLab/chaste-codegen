...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellespinosa_model_1998_normalFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x33 = exp(var_x27);
        const double var_x34 = 8.2927354147114596e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x35 = 26.713760659695652 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x36 = var_x35 * (9.2878636644768355e-6 + 5.2631227432035401e-5 * var_chaste_interface__transient_outward_current_s_gate__s);
        const double var_x37 = 1.0 + var_chaste_interface__extracellular_potassium_concentration__K_o;
        ...
        const double var_x41 = 0.001083584094188964 * var_x40;
        const double var_x42 = var_chaste_interface__extracellular_potassium_concentration__K_o * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x43 = var_x39 * var_x42 / pow(var_x37, 2);
        const double var_x44 = 1 / var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x45 = var_x44 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x46 = log(var_x45);
        const double var_x47 = exp(0.6251459767398494 + 0.062514597673984929 * var_chaste_interface__membrane__V - 1.6699999999999999 * var_x46);
        const double var_x48 = 1.0 + var_x47;
        const double var_x49 = 1 / var_x48;
        const double var_x50 = 1 / (10.0 + var_chaste_interface__extracellular_potassium_concentration__K_o);
        const double var_x51 = var_x49 * var_x50;
        const double var_x52 = 0.0024811376697271795 * var_x51;
        const double var_x53 = var_x30 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds;
        const double var_x54 = 5.215213115888558e-9 * var_x53;
        const double var_x55 = -26.713760659695652 * var_x46 + var_chaste_interface__membrane__V;
        const double var_x56 = var_x51 * var_x55;
        const double var_x57 = var_x49 * var_x55 * var_chaste_interface__extracellular_potassium_concentration__K_o / pow((1 + 0.10000000000000001 * var_chaste_interface__extracellular_potassium_concentration__K_o), 2);
        const double var_x58 = var_x47 * var_x50 * var_x55 / pow(var_x48, 2);
        const double var_x59 = 0.00015510732319676314 * var_x58;
        const double var_x60 = var_x38 * var_x42 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        ...
        const double var_x66 = exp(3.7433890822745473 - 0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x67 = 2.8382112195311879e-5 * var_x29 / (1.0 - var_x66);
        ...
        const double var_x78 = 0.018716945411372737 * var_chaste_interface__membrane__V;
        const double var_x79 = exp(-var_x78);
        const double var_x80 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x81 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        const double var_x82 = 1 / (1.0 + 0.012500000000000001 * var_x81 + 16373.795625000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x83 = var_x80 * var_x82;
        const double var_x84 = var_x79 * var_x83;
        const double var_x85 = exp(var_x78);
        const double var_x86 = 2.5 * var_x81 * var_x85 - 3274759.125 * var_x79 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x87 = var_x80 * var_x86 / pow((6.1073194200199382e-5 + 7.6341492750249225e-7 * var_x81 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x88 = var_x82 * var_x86 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        ...
        const double var_x91 = var_x83 * var_x85 * var_x90;
        const double var_x92 = var_x87 * var_x90;
        const double var_x93 = 6.7695799303767029e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x94 = var_x35 * (-7.5819295220219063e-6 - 4.2964267291457472e-5 * var_chaste_interface__transient_outward_current_s_gate__s);
        const double var_x95 = 0.00088455844423588909 * var_x40;
        const double var_x96 = 0.0020254185058997385 * var_x51;
        const double var_x97 = 4.2573168292967824e-9 * var_x53;
        const double var_x98 = 0.00012661822301776582 * var_x58;
        ...
        const double var_x102 = 0.0013268376663538336 * var_x40;
        ...
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = -(mDt * (((var_x10) ? (-var_x16 + var_x15 * var_x17) : (-var_x19 + var_x17 * var_x18))));
        rJacobian[2][8] = -(mDt * (((var_x10) ? (-var_x23 + var_x17 * var_x22) : (-var_x25 + var_x17 * var_x24))));
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = 0.0;
        rJacobian[2][12] = 0.0;
        ...
        rJacobian[3][5] = 0.0;
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = -(mDt * (((var_x10) ? (var_x16) : (var_x19))));
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-0.00069999999999999999 + var_x59 - var_x52 + 0.001083584094188964 * var_x43 + 9.2878636644768344e-5 * var_x56 - 8.2704588990905987e-5 * var_x32 - 9.2878636644768348e-7 * var_x57 - var_x28 * var_x54 - var_x32 * var_x36 - var_x33 * var_x34 - var_x41 * var_chaste_interface__intracellular_sodium_concentration__Na_i));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = 0.0;
        rJacobian[4][11] = -(mDt * (var_x34 + 8.2704588990905987e-5 * var_x44 + var_x26 * var_x54 + var_x36 * var_x44 + var_x45 * var_x52 - var_x45 * var_x59));
        rJacobian[4][12] = -(mDt * (6.7724005886810246e-7 * var_x60 - var_x41 * var_chaste_interface__extracellular_potassium_concentration__K_o));
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = 0.0;
        ...
        rJacobian[6][12] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = -(mDt * (-var_x67 * (-2.5 * var_x66 + var_x65 * var_chaste_interface__intracellular_calcium_concentration__Ca_i)));
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        ...
        rJacobian[7][8] = -(mDt * (-var_x65 * var_x67 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds));
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[7][12] = 0.0;
        ...
        rJacobian[8][8] = 1.0 - (mDt * (-7.0000000000000009 + var_x63 + var_x64 + 0.00040000000000000002 * var_x76 - 7.7098266909426358e-12 * var_x87 - 0.41340273157434637 * var_x84 - 7.2e-9 * var_x77 - 1.0549054718227806e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i - 0.00040000000000000002 * var_x74 - 8.7104997313748684e-10 * var_x88));
        ...
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = -(mDt * (var_x96 - var_x98 + 7.5819295220219063e-7 * var_x57 + 6.7513950196657958e-5 * var_x32 - 7.5819295220219067e-5 * var_x56 - 0.00088455844423588909 * var_x43 + var_x28 * var_x97 + var_x33 * var_x93 + var_x95 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x32 * var_x94));
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (-var_x93 - 6.7513950196657958e-5 * var_x44 + var_x44 * var_x94 + var_x45 * var_x98 - var_x26 * var_x97 - var_x45 * var_x96));
        ...
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (0.0013268376663538336 * var_x43 + var_x101 / (148.5 + 0.12 * var_chaste_interface__extracellular_potassium_concentration__K_o) - var_x102 * var_chaste_interface__intracellular_sodium_concentration__Na_i));
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = 0.0;
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = -(mDt * (2.3129480072827907e-11 * var_x87 + 1.240208194723039 * var_x84 + 2.6131499194124605e-9 * var_x88));
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
