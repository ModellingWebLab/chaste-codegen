...
#include "grandi_pasqualini_bers_2010_ssBackwardEulerNoLut.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
AbstractBackwardEulerCardiacCell<27>* Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::CreateMethod(boost::shared_ptr<AbstractIvpOdeSolver> p_solver, boost::shared_ptr<AbstractStimulusFunction> p_stimulus) {
    return new Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut(p_solver, p_stimulus);
}

bool Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::s_registered = ModelFactory::Register("grandi_pasqualini_bers_2010_ss", "BackwardEuler", (ModelFactory::TCreateMethod)Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::CreateMethod);
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[27], double rJacobian[27][27])
    {
        ...
        const double var_x39 = var_chaste_interface__membrane_potential__V_m / (mParameters[10] * mParameters[23]);
        const double var_x40 = var_x39 * mParameters[9];
        const double var_x41 = exp(-0.72999999999999998 * var_x40);
        const double var_x42 = pow(mParameters[8], 3);
        const double var_x43 = var_x41 * var_x42;
        const double var_x44 = pow(var_chaste_interface__Na_Concentrations__Na_j, 3);
        const double var_x45 = var_x44 * mParameters[5];
        const double var_x46 = var_x42 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x47 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_j) * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x48 = var_x42 * (1.0 + 0.00053869674493876331 * var_x44);
        const double var_x49 = 1 / (var_x45 + var_x46 + 669921.875 * var_x47 + 1.3 * var_x44 + 0.0035899999999999999 * var_x48);
        const double var_x50 = pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2);
        const double var_x51 = 1.0 + 2.2499999999999996e-8 / var_x50;
        const double var_x52 = pow(1.5700000000000001, var_x14) * mParameters[20] / (1.0 + 0.32000000000000001 * var_x41);
        const double var_x53 = var_x52 / var_x51;
        const double var_x54 = var_x49 * var_x53;
        const double var_x55 = var_x43 * var_x54;
        const double var_x56 = -669921.875 - var_x42;
        const double var_x57 = var_x56 - 373215529.24791086 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x58 = exp(0.27000000000000002 * var_x40);
        const double var_x59 = var_x45 * var_x58 - var_x41 * var_x46;
        const double var_x60 = var_x53 * var_x59 / pow((var_x47 + 1.9405247813411081e-6 * var_x44 + 5.3588338192419823e-9 * var_x48 + 1.4927113702623908e-6 * var_x45 + 1.4927113702623908e-6 * var_x46), 2);
        const double var_x61 = 4.9020119168033731e-13 * var_x60;
        const double var_x62 = var_x49 * var_x52 * var_x59 / (pow(var_x51, 2) * pow(var_chaste_interface__Ca_Concentrations__Ca_j, 3));
        const double var_x63 = var_x39 * pow(mParameters[9], 2);
        const double var_x64 = var_x63 * (1.0 - var_chaste_interface__I_Ca__f_Ca_Bj);
        const double var_x65 = exp(2.0 * var_x40);
        const double var_x66 = pow(1.8, var_x14) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f;
        const double var_x67 = var_x66 * mParameters[11] / (-1.0 + var_x65);
        const double var_x68 = var_x65 * var_x67;
        const double var_x69 = var_x37 * mParameters[22];
        const double var_x70 = var_x69 * var_x7;
        const double var_x71 = 88294470889864.781 * var_x70;
        const double var_x72 = -0.34100000000000003 * mParameters[5];
        const double var_x73 = 0.34100000000000003 * var_x65;
        const double var_x74 = var_x40 * mParameters[22];
        const double var_x75 = var_x67 * var_x7 * var_x74;
        const double var_x76 = 100.0 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x77 = pow(var_chaste_interface__Na_Concentrations__Na_j, 2);
        const double var_x78 = 3 * mParameters[5];
        const double var_x79 = 5.8017639429904805e-6 * var_x42;
        const double var_x80 = -3.9000000000000004 * var_x77 - var_x77 * var_x78 - var_x77 * var_x79;
        const double var_x81 = var_x58 * mParameters[5];
        const double var_x82 = var_x54 * var_x77 * var_x81;
        const double var_x83 = 100.0 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_sl;
        const double var_x84 = 100.0 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_sl;
        const double var_x85 = 5.2281977629563632e-6 + pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 1.6000000000000001);
        const double var_x86 = 0.095835200000000009 * var_x35;
        const double var_x87 = pow(var_chaste_interface__Na_Concentrations__Na_sl, 3);
        const double var_x88 = var_x87 * mParameters[5];
        const double var_x89 = var_x42 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x90 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_sl) * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x91 = var_x42 * (1.0 + 0.00053869674493876331 * var_x87);
        const double var_x92 = 1 / (var_x88 + var_x89 + 669921.875 * var_x90 + 1.3 * var_x87 + 0.0035899999999999999 * var_x91);
        const double var_x93 = 1.0 + 2.2499999999999996e-8 / pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2);
        const double var_x94 = var_x52 / var_x93;
        const double var_x95 = var_x92 * var_x94;
        const double var_x96 = var_x43 * var_x95;
        const double var_x97 = var_x56 - 373215529.24791086 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x98 = var_x58 * var_x88 - var_x41 * var_x89;
        ...
        const double var_x101 = var_x52 * var_x92 * var_x98 / (pow(var_x93, 2) * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 3));
        const double var_x102 = var_x63 * (1.0 - var_chaste_interface__I_Ca__f_Ca_Bsl);
        const double var_x103 = 2379535990481.856 * var_x70;
        const double var_x104 = 100.0 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x105 = pow(var_chaste_interface__Na_Concentrations__Na_sl, 2);
        const double var_x106 = -3.9000000000000004 * var_x105 - var_x105 * var_x78 - var_x105 * var_x79;
        const double var_x107 = var_x105 * var_x81 * var_x95;
        const double var_x108 = -var_x21;
        const double var_x109 = -var_x23;
        const double var_x110 = -var_x76;
        const double var_x111 = -var_x104;
        const double var_x112 = 0.0001 * var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x113 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bj;
        const double var_x114 = 0.0001 * var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x115 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bsl;
        const double var_x116 = var_x7 * mParameters[3];
        const double var_x117 = 0.23994508763098885 * var_x116;
        const double var_x118 = 7.3530178752050587e-13 * var_x60;
        const double var_x119 = var_x116 * var_x69;
        const double var_x120 = -0.75 * mParameters[8];
        const double var_x121 = exp(var_x40);
        const double var_x122 = 0.75 * var_x121;
        const double var_x123 = var_x66 / (-1.0 + var_x121);
        const double var_x124 = var_x116 * var_x123 * var_x74;
        const double var_x125 = 3.2338732908121872 * var_x7;
        const double var_x126 = var_x38 / var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x127 = mParameters[21] * mParameters[7] / ((1.5 + mParameters[7]) * (1.0 + 0.1245 * exp(-0.10000000000000001 * var_x40) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[8])) * exp(-var_x40)));
        const double var_x128 = pow(var_chaste_interface__I_Na__m, 3) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * mParameters[12];
        const double var_x129 = var_x121 * var_x123;
        const double var_x130 = 5.9492599172113663e-12 * var_x99;
        const double var_x131 = var_x38 / var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x132 = 18.571428571428569 * mParameters[0];
        const double var_x133 = var_x32;
        const double var_x134 = 100.0 * var_chaste_interface__SR_Ca_Concentrations__Csqn_b;
        const double var_x135 = 100.0 * var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x136 = 1 / var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x137 = pow(var_x136, 2.5);
        const double var_x138 = 1.0 + 0.13584112963311223 * var_x137;
        const double var_x139 = 1 / var_x138;
        const double var_x140 = 7.0 * var_x139;
        const double var_x141 = 7.5 - var_x140;
        const double var_x142 = 1.0 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x143 = 1 / (15.0 - 14.0 * var_x139);
        const double var_x144 = 20.0 * var_x143 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x145 = var_x136 * var_x137 / pow(var_x138, 2);
        const double var_x146 = 2.3772197685794643 * var_x145 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x147 = var_x146 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x148 = 0.21130842387373014 * var_x145 * var_x50 / pow((1 - 0.93333333333333335 * var_x139), 2);
        const double var_x149 = 10.0 * var_x143 * var_x50;
        const double var_x150 = -var_x149;
        const double var_x151 = -7.5 + var_x140;
        const double var_x152 = var_x144 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x153 = var_x148 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x154 = var_x151 * var_chaste_interface__Ca_Concentrations__Ca_j;
        ...
        rJacobian[1][8] = 0.0;
        rJacobian[1][9] = 0.0;
        rJacobian[1][10] = -(mDt * (77240003134.453705 * var_x75 * (var_x72 + var_x73 * var_chaste_interface__Ca_Concentrations__Ca_j)));
        rJacobian[1][11] = 0.0;
        rJacobian[1][12] = -(mDt * (0.029999999999999999 + var_x76));
        rJacobian[1][13] = 0.0;
        rJacobian[1][14] = -(mDt * (1.3 + var_x76));
        rJacobian[1][15] = 0.0;
        rJacobian[1][16] = 0.0;
        rJacobian[1][17] = 0.0;
        rJacobian[1][18] = 0.0;
        rJacobian[1][19] = 0.0;
        rJacobian[1][20] = -(mDt * (-var_x71 * (-0.66000000000000003 * var_x82 - var_x61 * var_x80)));
        rJacobian[1][21] = 0.0;
        ...
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = -(mDt * (231290898.27483633 * var_x75 * (var_x72 + var_x73 * var_chaste_interface__Ca_Concentrations__Ca_sl)));
        rJacobian[2][12] = 0.0;
        rJacobian[2][13] = -(mDt * (0.029999999999999999 + var_x104));
        rJacobian[2][14] = 0.0;
        rJacobian[2][15] = -(mDt * (1.3 + var_x104));
        rJacobian[2][16] = 0.0;
        rJacobian[2][17] = 0.0;
        rJacobian[2][18] = 0.0;
        rJacobian[2][19] = 0.0;
        rJacobian[2][20] = 0.0;
        rJacobian[2][21] = -(mDt * (-var_x103 * (-5.3399999999999999 * var_x107 - var_x100 * var_x106)));
        rJacobian[2][22] = 0.0;
        rJacobian[2][23] = 0.0;
        rJacobian[2][24] = 0.0;
        rJacobian[2][25] = 0.0;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-0.00046000000000000001 + var_x108));
        rJacobian[4][5] = -(mDt * (var_x108));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        ...
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-3.1999999999999999e-5 + var_x109));
        rJacobian[7][8] = -(mDt * (var_x109));
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[7][12] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-0.029999999999999999 + var_x110));
        rJacobian[12][13] = 0.0;
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        ...
        rJacobian[13][11] = 0.0;
        rJacobian[13][12] = 0.0;
        rJacobian[13][13] = 1.0 - (mDt * (-0.029999999999999999 + var_x111));
        rJacobian[13][14] = 0.0;
        rJacobian[13][15] = 0.0;
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-1.3 + var_x110));
        rJacobian[14][15] = 0.0;
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        ...
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (-1.3 + var_x111));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = 0.0;
        rJacobian[17][17] = 1.0 - (mDt * (-0.001 - var_x112));
        rJacobian[17][18] = 0.0;
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = -(mDt * (0.0007561 - var_x113));
        rJacobian[17][21] = 0.0;
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = 0.0;
        rJacobian[17][24] = 0.0;
        ...
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-0.001 - var_x114));
        rJacobian[18][19] = 0.0;
        rJacobian[18][20] = 0.0;
        rJacobian[18][21] = -(mDt * (0.000165 - var_x115));
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        rJacobian[18][25] = 0.0;
        ...
        rJacobian[19][17] = 0.0;
        rJacobian[19][18] = 0.0;
        rJacobian[19][19] = 1.0 - (mDt * (-var_x117));
        rJacobian[19][20] = 0.0;
        rJacobian[19][21] = -(mDt * (var_x117));
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = 0.0;
        rJacobian[19][26] = 0.0;
        rJacobian[20][0] = 0.0;
        rJacobian[20][1] = -(mDt * (-176588941779729.56 * var_x119 * (1.4849999999999997e-8 * var_x62 - 0.33000000000000002 * var_x55 + var_x118 * var_x57)));
        rJacobian[20][2] = 0.0;
        rJacobian[20][3] = 0.0;
        rJacobian[20][4] = 0.0;
        rJacobian[20][5] = 0.0;
        ...
        rJacobian[20][8] = 0.0;
        rJacobian[20][9] = 0.0;
        rJacobian[20][10] = -(mDt * (536388.91065592843 * var_x124 * (var_x120 + var_x122 * var_chaste_interface__Na_Concentrations__Na_j)));
        rJacobian[20][11] = 0.0;
        rJacobian[20][12] = 0.0;
        rJacobian[20][13] = 0.0;
        rJacobian[20][14] = 0.0;
        ...
        rJacobian[21][0] = 0.0;
        rJacobian[21][1] = 0.0;
        rJacobian[21][2] = -(mDt * (-4759071980963.7119 * var_x119 * (1.2014999999999997e-7 * var_x101 - 2.6699999999999999 * var_x96 + var_x130 * var_x97)));
        rJacobian[21][3] = 0.0;
        rJacobian[21][4] = 0.0;
        rJacobian[21][5] = 0.0;
        rJacobian[21][6] = 0.0;
        ...
        rJacobian[21][9] = 0.0;
        rJacobian[21][10] = 0.0;
        rJacobian[21][11] = -(mDt * (1606.1867935752523 * var_x124 * (var_x120 + var_x122 * var_chaste_interface__Na_Concentrations__Na_sl)));
        rJacobian[21][12] = 0.0;
        rJacobian[21][13] = 0.0;
        rJacobian[21][14] = 0.0;
        rJacobian[21][15] = 0.0;
        rJacobian[21][16] = 0.0;
        rJacobian[21][17] = 0.0;
        rJacobian[21][18] = -(mDt * ((0.001 + var_x114) * mParameters[3]));
        rJacobian[21][19] = -(mDt * (7.7982153480071377 * var_x116));
        rJacobian[21][20] = -(mDt * (0.087152885187388451 * var_x116));
        rJacobian[21][21] = 1.0 - (mDt * ((-0.000165 + var_x115 - 7.8853682331945256 * var_x7 - 4759071980963.7119 * var_x70 * (0.00053133 * var_x131 + 8.0099999999999998 * var_x107 + var_x106 * var_x130 + 2.5312499999999994e-10 * var_x102 * var_x129 + 0.89000000000000001 * var_x128 * var_x131 + 0.00072945837032989554 * var_x127 / (pow((6.8301345536507063e-5 + pow(var_chaste_interface__Na_Concentrations__Na_sl, (-4))), 2) * pow(var_chaste_interface__Na_Concentrations__Na_sl, 5)))) * mParameters[3]));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        ...
        rJacobian[22][1] = -(mDt * (var_x132 + var_x133));
        rJacobian[22][2] = 0.0;
        rJacobian[22][3] = 0.0;
        rJacobian[22][4] = 0.0;
        rJacobian[22][5] = 0.0;
        ...
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (-260.0 + var_x134 - var_x132 - var_x133 - 0.69232869146389786 * var_x26 - 8.7400597733819945e-14 * var_x27));
        rJacobian[22][23] = -(mDt * (65.0 + var_x135));
        rJacobian[22][24] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (260.0 - var_x134));
        rJacobian[23][23] = 1.0 - (mDt * (-65.0 - var_x135));
        rJacobian[23][24] = 0.0;
        rJacobian[23][25] = 0.0;
        rJacobian[23][26] = 0.0;
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = -(mDt * (var_x141 * var_chaste_interface__SR_Fluxes__Ry_Ro + var_x142 * var_x144));
        rJacobian[24][2] = 0.0;
        rJacobian[24][3] = 0.0;
        rJacobian[24][4] = 0.0;
        rJacobian[24][5] = 0.0;
        ...
        rJacobian[24][20] = 0.0;
        rJacobian[24][21] = 0.0;
        rJacobian[24][22] = -(mDt * (-var_x147 + var_x142 * var_x148));
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-0.065000000000000002 + var_x150));
        rJacobian[24][25] = -(mDt * (var_x150 + var_x141 * var_chaste_interface__Ca_Concentrations__Ca_j));
        rJacobian[24][26] = -(mDt * (var_x150));
        rJacobian[25][0] = 0.0;
        rJacobian[25][1] = -(mDt * (var_x152 + var_x151 * var_chaste_interface__SR_Fluxes__Ry_Ro));
        rJacobian[25][2] = 0.0;
        rJacobian[25][3] = 0.0;
        rJacobian[25][4] = 0.0;
        rJacobian[25][5] = 0.0;
        ...
        rJacobian[25][20] = 0.0;
        rJacobian[25][21] = 0.0;
        rJacobian[25][22] = -(mDt * (var_x147 + var_x153));
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = -(mDt * (0.0050000000000000001));
        rJacobian[25][25] = 1.0 - (mDt * (-0.059999999999999998 + var_x154));
        rJacobian[25][26] = -(mDt * (var_x149));
        rJacobian[26][0] = 0.0;
        rJacobian[26][1] = -(mDt * (-var_x152 + var_x151 * var_chaste_interface__SR_Fluxes__Ry_Rr));
        rJacobian[26][2] = 0.0;
        rJacobian[26][3] = 0.0;
        rJacobian[26][4] = 0.0;
        rJacobian[26][5] = 0.0;
        ...
        rJacobian[26][20] = 0.0;
        rJacobian[26][21] = 0.0;
        rJacobian[26][22] = -(mDt * (-var_x153 + var_x146 * var_chaste_interface__SR_Fluxes__Ry_Rr));
        rJacobian[26][23] = 0.0;
        rJacobian[26][24] = -(mDt * (-0.0050000000000000001));
        rJacobian[26][25] = -(mDt * (0.055));
        rJacobian[26][26] = 1.0 - (mDt * (-0.0050000000000000001 + var_x150 + var_x154));
    }
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEulerNoLut::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_I_Ca__taud = 28.571428571428569 * (1.0 - exp(-0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane_potential__V_m)) * var_I_Ca__dss / (5.0 + var_chaste_interface__membrane_potential__V_m);
