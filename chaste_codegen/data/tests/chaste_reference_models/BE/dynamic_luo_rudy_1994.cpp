...
#include "CardiacNewtonSolver.hpp"
    ...
    void Dynamicluo_rudy_1994FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[5], double rJacobian[5][5])
    {
        ...
        const double var_x17 = 0.75 * var_x16;
        const double var_x18 = 1 / (-1.0 + var_x16);
        const double var_x19 = var_x13 * var_x18;
        const double var_x20 = var_chaste_interface__ionic_concentrations__Ki + var_chaste_interface__ionic_concentrations__Nai;
        const double var_x21 = log(145.40000000000001 / var_x20);
        const double var_x22 = exp(var_x15 - 1.0 * var_x21);
        const double var_x23 = 0.75 * var_x22;
        const double var_x24 = -4.0500000000000007 + var_x23 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x25 = 1.0 + 1.7279999999999996e-9 / pow(var_chaste_interface__ionic_concentrations__Cai_converted, 3);
        const double var_x26 = -1.0 + var_x22;
        const double var_x27 = 1 / var_x26;
        const double var_x28 = -26.614641953637257 * var_x21 + var_chaste_interface__membrane__V;
        const double var_x29 = var_x27 * var_x28;
        const double var_x30 = 1.0025441254350579e-16 * var_x29 / (pow(var_x25, 2) * pow(var_chaste_interface__ionic_concentrations__Cai_converted, 4));
        ...
        const double var_x39 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6434541406371006 * var_x32);
        const double var_x40 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1376880417161446 * var_x32);
        const double var_x41 = var_x39 + 0.49124000000000001 * var_x40;
        ...
        const double var_x47 = (0.0068775790921595595 * var_chaste_interface__ionic_concentrations__Ki + 0.0068775790921595595 * var_chaste_interface__ionic_concentrations__Nai) / pow(var_x20, 2);
        const double var_x48 = var_x22 * var_x47;
        const double var_x49 = 109.05 * var_x48;
        const double var_x50 = 1 / var_x25;
        const double var_x51 = var_x29 * var_x50;
        const double var_x52 = 1.9339199950521953e-8 * var_x51;
        const double var_x53 = var_x12 * var_x16 * var_x18;
        const double var_x54 = var_x24 * var_x50;
        const double var_x55 = 7.4838235294117636e-5 * var_x27 * var_x47;
        const double var_x56 = 2.8119196728058921e-6 * var_x28 * var_x48 / pow(var_x26, 2);
        ...
        const double var_x62 = -105.0 + var_x23 * var_chaste_interface__ionic_concentrations__Nai;
        ...
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = -(mDt * (-var_x24 * var_x30 + 1.5356429857854459e-14 * var_x19 * (-4.0500000000000007 + var_x17 * var_chaste_interface__ionic_concentrations__Ki)));
        rJacobian[3][3] = 1.0 - (mDt * (var_x57 - 1.5996281101931733e-8 * var_x53 - 0.001815786661103715 * var_x46 - var_x52 * (var_x23 + var_x49 * var_chaste_interface__ionic_concentrations__Ki) - 0.00061833800811279696 * var_x35 * var_x43 - 1.4791615096031613e-5 * var_x31 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 0.00014747361493490206 * var_x43 * var_x44 * var_x45 - 2.2330835435855923e-5 * var_x35 * var_x44 * (-var_x38 * (1.0501178736126389 * var_x31 * var_x40 + 1.6434541406371006 * var_x31 * var_x39) + 6.4745439480613349 * var_x31 * var_x45 - 13.687910356755641 * var_x31 * var_x36 * var_x41 / pow(var_x37, 2)) / pow((var_x35 + 0.98039215686274506 * var_x42), 2)));
        ...
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = -(mDt * (0.046057306746527645 * var_x7 - var_x30 * var_x62 + 5.3707721005449532e-14 * var_x19 * (-105.0 + var_x17 * var_chaste_interface__ionic_concentrations__Nai)));
        rJacobian[4][3] = -(mDt * (var_x64 - var_x61 * var_chaste_interface__ionic_concentrations__Nai));
        rJacobian[4][4] = 1.0 - (mDt * (var_x64 - 5.594554271400994e-8 * var_x53 - 5.073320759877697e-6 * var_x60 - 1.139681818874567e-6 * var_x58 - 9.0637557008472766e-8 * var_x14 - var_x52 * (var_x23 + var_x49 * var_chaste_interface__ionic_concentrations__Nai) - 0.012932559646803597 * var_x58 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
