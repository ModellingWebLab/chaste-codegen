...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rJacobian[32][32])
    {
        ...
        const double var_x60 = exp(-0.025317124991725771 * var_chaste_interface__membrane__V);
        ...
        const double var_x68 = exp(0.013632298072467722 * var_chaste_interface__membrane__V);
        ...
        const double var_x80 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__membrane__V);
        const double var_x81 = 1 / (0.25 * var_x80 + 0.1027 * exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__membrane__V));
        ...
        const double var_x84 = 3.802 / (0.1027 * exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V) + 0.23000000000000001 * var_x80);
        const double var_x85 = exp(-0.90909090909090906 - 0.12987012987012986 * var_chaste_interface__membrane__V);
        ...
        const double var_x89 = 3.802 / (0.20000000000000001 * var_x80 + 0.1027 * exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__membrane__V));
        ...
        const double var_x115 = var_x113 * var_x114 * mParameters[5] / ((1500 + mParameters[5]) * pow((3.2860264730588296e-7 + var_x114), 2) * (1 + 0.1245 * exp(-0.0038949423064193493 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.4858841010401188e-5 * mParameters[6])) * exp(-0.038949423064193495 * var_chaste_interface__membrane__V)));
        const double var_x116 = 0.022348 * exp(0.01176 * var_chaste_interface__membrane__V);
        const double var_x117 = -var_x116;
        const double var_x118 = 0.013733 * exp(0.038198000000000003 * var_chaste_interface__membrane__V);
        const double var_x119 = 6.8899999999999994e-5 * exp(-0.041779999999999998 * var_chaste_interface__membrane__V);
        const double var_x120 = 0.0064970000000000002 * exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x121 = 0.090820999999999999 * exp(0.11695499999999999 + 0.023390999999999999 * var_chaste_interface__membrane__V);
        ...
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = -(mDt * (-0.014285714285714287 * var_x73 * exp(-0.038580246913580245 * pow((-1 + 0.20000000000000001 * var_chaste_interface__membrane__V), 2))));
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = 0.0;
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = 0.0;
        ...
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-0.023761000000000001 - var_x116 - 0.047002000000000002 * exp(-0.063100000000000003 * var_chaste_interface__membrane__V)));
