...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_atrial_model_2009FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[14], double rJacobian[14][14])
    {
        ...
        const double var_x18 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 3);
        const double var_x19 = 0.001 * (-815.20000000000005 * var_x17 + 815.20000000000005 * var_x13 * var_x18) * var_chaste_interface__Ca_handling_by_the_SR__F1;
        const double var_x20 = 0.033960000000000004 + 0.33960000000000001 * var_x15;
        const double var_x21 = 0.001 * (-1358.4000000000001 * var_x17 + 1358.4000000000001 * var_x13 * var_x18) * var_chaste_interface__Ca_handling_by_the_SR__F2;
        ...
        const double var_x25 = (0.40000000000000002 + 0.59999999999999998 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3, 6)) * (0.58999999999999997 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1, 3) + 0.40999999999999998 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2, 3)) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x26 = 0.0011002730933088092 * var_x25;
        const double var_x27 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5);
        const double var_x28 = 1 / (36.4828726939094 + var_x27);
        const double var_x29 = 1 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x30 = 1 / var_x29;
        const double var_x31 = 1 / (1.5 + exp(-1.5 - 0.025000000000000001 * var_chaste_interface__membrane__V));
        const double var_x32 = var_x30 * var_x31;
        const double var_x33 = var_x28 * var_x32;
        const double var_x34 = var_x27 * var_x33;
        const double var_x35 = mParameters[7] * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i;
        const double var_x36 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 2);
        const double var_x37 = 0.58999999999999997 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x38 = pow(var_x37, (-3));
        const double var_x39 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x40 = log(var_x39 * var_chaste_interface__cleft_space_ion_concentrations__K_c);
        const double var_x41 = exp(0.18895643383558949 + 0.052487898287663745 * var_chaste_interface__membrane__V - 1.393 * var_x40);
        const double var_x42 = 1 + var_x41;
        const double var_x43 = 1 / var_x42;
        const double var_x44 = var_x43 * mParameters[6];
        const double var_x45 = var_x38 * var_x44;
        const double var_x46 = var_x36 * var_x45;
        const double var_x47 = -26.53945091048535 * var_x40 + var_chaste_interface__membrane__V;
        const double var_x48 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 3);
        const double var_x49 = var_x44 * var_x48 / pow(var_x37, 4);
        const double var_x50 = pow(var_x29, (-2));
        const double var_x51 = pow(var_x42, (-2));
        const double var_x52 = var_x22 * var_x39;
        const double var_x53 = var_x35 * var_x39;
        const double var_x54 = var_x39 * var_x48;
        const double var_x55 = var_x45 * var_x54;
        const double var_x56 = var_x38 * var_x41 * var_x47 * var_x51 * mParameters[6];
        const double var_x57 = var_x33 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 0.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x58 = pow((1 + 0.027410122234342148 * var_x27), (-2));
        const double var_x59 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2);
        const double var_x60 = 200 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x61 = 0.00088070109612833447 * var_x3;
        const double var_x62 = 32 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        ...
        const double var_x65 = var_x64 * mParameters[9];
        const double var_x66 = var_x64 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x67 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * mParameters[1];
        const double var_x68 = 1 + 0.00029999999999999997 * var_x66 + 0.00029999999999999997 * var_x67;
        const double var_x69 = pow(var_x68, (-2));
        const double var_x70 = exp(0.016955889611951675 * var_chaste_interface__membrane__V);
        const double var_x71 = exp(-0.02072386508127427 * var_chaste_interface__membrane__V);
        const double var_x72 = var_x67 * var_x70 - var_x66 * var_x71;
        const double var_x73 = var_x69 * var_x72;
        const double var_x74 = var_x65 * var_x73;
        const double var_x75 = 1 / var_x68;
        const double var_x76 = var_x65 * var_x71 * var_x75;
        const double var_x77 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2);
        const double var_x78 = var_x77 * mParameters[9] * mParameters[1];
        const double var_x79 = 0.021829942145742926 * var_x23;
        const double var_x80 = 0.00021830815343428756 * var_x25;
        const double var_x81 = 0.0049352811901134472 * var_x47;
        const double var_x82 = var_x27 * var_x28 * var_x31 * var_x50 * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x83 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x84 = var_x83 * mParameters[2];
        const double var_x85 = 1 * log(var_x84);
        const double var_x86 = var_x84 * pow(var_chaste_interface__sodium_current_m_gate__m, 3) * (0.36499999999999999 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.63500000000000001 * var_chaste_interface__sodium_current_h1_gate__h1) * mParameters[5];
        const double var_x87 = 0.0096486999999999996 * var_x86;
        const double var_x88 = var_x87 * exp(-9.9999999999999995e-8 - var_x85) / (-1 + exp(-9.9999999999999995e-8));
        const double var_x89 = 0.037679754693225945 * var_chaste_interface__membrane__V;
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.00085446536839159674 * var_x34 - 0.22004581682908866 * var_x46 - var_x22 * var_x24 - var_x23 * var_x26 - var_x24 * var_x35 - 0.024873817198171774 * var_x47 * var_x49 + 0.024873817198171774 * var_x36 * var_x38 * var_x43 * var_x47 * mParameters[6] + 0.00085446536839159674 * var_x27 * var_x28 * var_x31 * var_x50 * var_chaste_interface__cleft_space_ion_concentrations__K_c + 0.011549742452351092 * var_x36 * var_x38 * var_x41 * var_x47 * var_x51 * mParameters[6]));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = 0.0;
        rJacobian[6][12] = -(mDt * (0.11002290841454433 * var_x52 + 0.11002290841454433 * var_x53 + 0.22004581682908866 * var_x55 + var_x26 * var_x39 - 0.011549742452351092 * var_x54 * var_x56));
        rJacobian[6][13] = -(mDt * (-0.0012816980525873951 * var_x57 + 9.6295871719563877e-7 * var_x30 * var_x31 * var_x58 * var_x59 * var_chaste_interface__cleft_space_ion_concentrations__K_c));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        ...
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-0.47599999999999998 - var_x60));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        ...
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        rJacobian[9][9] = 1.0 - (mDt * (-0.0066 - var_x60));
        rJacobian[9][10] = -(mDt * (-var_x60));
        ...
        rJacobian[12][4] = 0.0;
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = -(mDt * (0.043659884291485852 * var_x46 + 0.00016953677944277714 * var_x34 - 0.00016953677944277714 * var_x82 + var_x22 * var_x79 + var_x23 * var_x80 + var_x35 * var_x79 + var_x49 * var_x81 - var_x46 * var_x81 - 0.0022916155659426776 * var_x36 * var_x56));
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-0.021829942145742926 * var_x52 - 0.021829942145742926 * var_x53 - 0.043659884291485852 * var_x55 - var_x39 * var_x80 + 0.0022916155659426776 * var_x38 * var_x39 * var_x41 * var_x47 * var_x48 * var_x51 * mParameters[6]));
        rJacobian[12][13] = -(mDt * (0.00025430516916416572 * var_x57 - 1.9106323753881723e-7 * var_x32 * var_x58 * var_x59 * var_chaste_interface__cleft_space_ion_concentrations__K_c));
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = 0.0;
