...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_atrial_model_2009FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[14], double rJacobian[14][14])
    {
        ...
        const double var_x10 = pow(var_x8, (-2));
        const double var_x11 = 3333.3333333333335 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 0.32000000000000006 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up;
        ...
        const double var_x17 = 0.20380000000000001 * var_x16 + 0.23999999999999999 * exp(-1.6000000000000001 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x18 = var_x15 / pow(var_x13, 5);
        const double var_x19 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 3);
        const double var_x20 = 0.001 * (-815.20000000000005 * var_x18 + 815.20000000000005 * var_x14 * var_x19) * var_chaste_interface__Ca_handling_by_the_SR__F1;
        const double var_x21 = 0.033960000000000004 + 0.33960000000000001 * var_x16;
        const double var_x22 = 0.001 * (-1358.4000000000001 * var_x18 + 1358.4000000000001 * var_x14 * var_x19) * var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x23 = mParameters[8] * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x24 = 1 / var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x25 = 0.11002290841454433 * var_x24;
        ...
        const double var_x27 = 0.0011002730933088092 * var_x26;
        const double var_x28 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5);
        const double var_x29 = 36.4828726939094 + var_x28;
        ...
        const double var_x54 = var_x23 * var_x41;
        ...
        const double var_x59 = var_x35 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 0.5);
        const double var_x60 = pow(var_x29, (-2));
        ...
        const double var_x81 = 0.021829942145742926 * var_x24;
        const double var_x82 = 0.00021830815343428756 * var_x26;
        const double var_x83 = 0.0049352811901134472 * var_x49;
        const double var_x84 = var_x28 * var_x30 * var_x33 * var_x52 * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x85 = 0.00025430516916416572 * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x86 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x87 = var_x86 * mParameters[2];
        const double var_x88 = 1 * log(var_x87);
        const double var_x89 = var_x87 * pow(var_chaste_interface__sodium_current_m_gate__m, 3) * (0.36499999999999999 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.63500000000000001 * var_chaste_interface__sodium_current_h1_gate__h1) * mParameters[5];
        const double var_x90 = 0.0096486999999999996 * var_x89;
        const double var_x91 = var_x90 * exp(-9.9999999999999995e-8 - var_x88) / (-1 + exp(-9.9999999999999995e-8));
        const double var_x92 = 0.037679754693225945 * var_chaste_interface__membrane__V;
        ...
        rJacobian[1][1] = 1.0 - (mDt * (-0.011085915847820609 - 0.011698444302491135 * var_x9 - 0.029246110756227836 * var_x12));
        rJacobian[1][2] = 0.0;
        rJacobian[1][3] = 0.0;
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        ...
        rJacobian[1][9] = 0.0;
        rJacobian[1][10] = 0.0;
        rJacobian[1][11] = -(mDt * (121.85879481761599 * var_x9 - 121.85879481761599 * var_x12));
        rJacobian[1][12] = 0.0;
        rJacobian[1][13] = 0.0;
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = 0.0;
        ...
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = -(mDt * (-var_x20));
        rJacobian[2][12] = 0.0;
        rJacobian[2][13] = 0.0;
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = -(mDt * (var_x17));
        rJacobian[3][3] = 1.0 - (mDt * (-var_x21));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = 0.0;
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = 0.0;
        ...
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = -(mDt * (var_x20 - var_x22));
        rJacobian[3][12] = 0.0;
        rJacobian[3][13] = 0.0;
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = -(mDt * (var_x21));
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.00085446536839159674 * var_x36 - 0.22004581682908866 * var_x48 - var_x23 * var_x25 - var_x24 * var_x27 - var_x25 * var_x37 - 0.024873817198171774 * var_x49 * var_x51 + 0.024873817198171774 * var_x38 * var_x40 * var_x45 * var_x49 * mParameters[6] + 0.00085446536839159674 * var_x28 * var_x30 * var_x33 * var_x52 * var_chaste_interface__cleft_space_ion_concentrations__K_c + 0.011549742452351092 * var_x38 * var_x40 * var_x43 * var_x49 * var_x53 * mParameters[6]));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = 0.0;
        rJacobian[6][12] = -(mDt * (0.11002290841454433 * var_x54 + 0.11002290841454433 * var_x55 + 0.22004581682908866 * var_x57 + var_x27 * var_x41 - 0.011549742452351092 * var_x56 * var_x58));
        rJacobian[6][13] = -(mDt * (-0.0012816980525873951 * var_x59 * var_chaste_interface__cleft_space_ion_concentrations__K_c + 0.0012816980525873951 * var_x32 * var_x33 * var_x60 * var_x61 * var_chaste_interface__cleft_space_ion_concentrations__K_c));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        ...
        rJacobian[11][1] = -(mDt * (0.0019727704553274693 * var_x12 + 0.00078910818213098765 * var_x9));
        rJacobian[11][2] = 0.0;
        ...
        rJacobian[12][4] = 0.0;
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = -(mDt * (0.043659884291485852 * var_x48 + 0.00016953677944277714 * var_x36 - 0.00016953677944277714 * var_x84 + var_x23 * var_x81 + var_x24 * var_x82 + var_x37 * var_x81 + var_x51 * var_x83 - var_x48 * var_x83 - 0.0022916155659426776 * var_x38 * var_x58));
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-0.021829942145742926 * var_x54 - 0.021829942145742926 * var_x55 - 0.043659884291485852 * var_x57 - var_x41 * var_x82 + 0.0022916155659426776 * var_x40 * var_x41 * var_x43 * var_x49 * var_x50 * var_x53 * mParameters[6]));
        rJacobian[12][13] = -(mDt * (var_x59 * var_x85 - var_x34 * var_x60 * var_x61 * var_x85));
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = 0.0;
        ...
        rJacobian[13][12] = 0.0;
        rJacobian[13][13] = 1.0 - (mDt * (-4.3659884291485854e-7 * var_x86 - 0.00082254686501890791 * (((var_chaste_interface__membrane__V >= -2.6539450910485349e-6) && (var_chaste_interface__membrane__V <= 2.6539450910485349e-6)) ? (-var_x91 + 188398.77346612973 * (2.6539450910485349e-6 + var_chaste_interface__membrane__V) * (var_x91 + var_x90 * exp(9.9999999999999995e-8 - var_x88) / (-1 + exp(9.9999999999999995e-8)))) : (3635.606491085292 * var_x89 * var_chaste_interface__membrane__V * exp(var_x92 - var_x88) / (-1 + exp(var_x92)))) - 0.00038145775374624855 * var_x59 * var_chaste_interface__cleft_space_ion_concentrations__K_c - 0.0074029217851701709 * var_x72 * var_x77 * var_x80 + 0.00038145775374624855 * var_x32 * var_x33 * var_x60 * var_x61 * var_chaste_interface__cleft_space_ion_concentrations__K_c + 2.2208765355510512e-6 * var_x71 * var_x74 * var_x79 * mParameters[9] * mParameters[1]));
    }
