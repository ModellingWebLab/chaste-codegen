...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler::UseCellMLDefaultStimulus()
    {
    ...
    double Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }
    
    Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler::Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler>::Instance();
        Init();
    ...
    Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler::~Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler()
    {
    }
    
    double Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[6], double rResidual[6])
    {
    ...
    void Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -86.3189802410563
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (var_chaste_interface__environment__dt * (((((((((((((0.0025819888969999998 * var_t15) * var_t63) * var_t39) * 2577486.3199999998) * var_t313) + (((0.043033148290000003 * var_t47) * var_t40) * (((((( -0.0060000000000000001 * var_t14) * 8314.4719999999998) * 310.0) * var_t313) + ((((1546.4917919999998 * var_t312) * var_t21) + ((257748.63199999998 * var_t312) * var_t26)) * var_t33)) + (((((0.5 * var_t56) * 8314.4719999999998) * 0.0032129232812012176) * var_t4) * var_t31)))) - ((0.043033148290000003 * var_t64) * var_t338)) - (var_t67 * var_t338)) - ((0.43033148290000001 * var_t70) * var_t338)) - ((var_t284 * 0.0032129232812012176) * var_t222)) - ((37631.300272 * var_t312) * var_t202)) * var_membrane__Cm) * 0.00063181349969740233));
        rJacobian[4][5] = -(var_chaste_interface__environment__dt * (((-(((((var_t284 * 0.0032129232812012176) * var_t222) * 0.029999999999999999) - (2.0 * var_t291)) + (2.0 * var_t296))) * var_membrane__Cm) * 0.00063181349969740233));
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = -(var_chaste_interface__environment__dt * ((((((3.0 * var_t264) * 2744000.0) * 2.5) * 2.9291824377205469e-07) * var_t267) * var_t840));
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (var_chaste_interface__environment__dt * (((-(((((((var_t146 * 2577486.3199999998) * 1.0364268649036186e-05) * var_t231) + (0.0077469905913117379 * var_t231)) + (3.0 * var_t291)) - (3.0 * var_t296)) + (9.0 * (((((1000.0 * var_t152) * var_t154) * 2.0) * 2.9291824377205469e-07) * var_t267)))) * var_membrane__Cm) * 0.00063181349969740233));
    }
    
    void Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        CardiacNewtonSolver<6,Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<6,Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler>::Instance();
...
template<>
void OdeSystemInformation<Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler>::Initialise(void)
{
...
extern "C"
{
    ...
    {
        return new Dynamicten_tusscher_model_2004_epiFromCellMLBackwardEuler(pSolver, pStimulus);
    }
