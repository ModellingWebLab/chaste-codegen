...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celltest_piecewises_beFromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[1], double rResidual[1])
    {
        ...
        rResidual[0] = rCurrentGuess[0] - rY[2] - mDt*d_dt_chaste_interface_var_fast_sodium_current_m_gate__m;
    }

    void Celltest_piecewises_beFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[1], double rJacobian[1][1])
    {
        std::vector<double>& rY = rGetStateVariables();
    ...
    void Celltest_piecewises_beFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        double _guess[1] = {rY[2]};
        CardiacNewtonSolver<1,Celltest_piecewises_beFromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<1,Celltest_piecewises_beFromCellMLBackwardEuler>::Instance();
