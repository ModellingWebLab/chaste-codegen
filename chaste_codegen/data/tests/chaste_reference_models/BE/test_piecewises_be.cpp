...
#include "CardiacNewtonSolver.hpp"
    ...
    double Celltest_piecewises_beFromCellMLBackwardEuler::GetIntracellularCalciumConcentration()
    {
    ...
    void Celltest_piecewises_beFromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[8], double rResidual[8])
    {
        ...
        double var_chaste_interface__fast_sodium_current_m_gate__m = rCurrentGuess[0];
        ...
        double var_chaste_interface__second_inward_current_d_gate__d = rCurrentGuess[6];
        double var_chaste_interface__second_inward_current_f2_gate__f2 = rCurrentGuess[7];
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = ((var_fast_sodium_current_m_gate__delta_m > fabs(pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_fast_sodium_current_m_gate__E0_m)) ? (2000.0) : (200.0 * var_fast_sodium_current_m_gate__E0_m / (1.0 - exp(-0.10000000000000001 * var_fast_sodium_current_m_gate__E0_m)))); // per_second
        ...
        const double var_second_inward_current_d_gate__alpha_d = ((var_second_inward_current_d_gate__delta_d > fabs(var_second_inward_current_d_gate__E0_d)) ? (120.0 * pow(var_chaste_interface__second_inward_current_d_gate__d, 2)) : (30.0 * var_second_inward_current_d_gate__E0_d / (1.0 - exp(-0.25 * var_second_inward_current_d_gate__E0_d)))); // per_second
        ...
        rResidual[0] = rCurrentGuess[0] - rY[4] - mDt*d_dt_chaste_interface_var_fast_sodium_current_m_gate__m;
        rResidual[6] = rCurrentGuess[6] - rY[6] - mDt*d_dt_chaste_interface_var_second_inward_current_d_gate__d;
        rResidual[7] = rCurrentGuess[7] - rY[8] - mDt*d_dt_chaste_interface_var_second_inward_current_f2_gate__f2;
        ...
        rResidual[4] = rCurrentGuess[4] - rY[13] - mDt*d_dt_chaste_interface_var_intracellular_potassium_concentration__Ki;
    }

    void Celltest_piecewises_beFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[8], double rJacobian[8][8])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -69.1865
        ...
        const double var_x0 = -8.0 * exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x1 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2);
        const double var_x2 = 41.0 + var_chaste_interface__membrane__V;
        const double var_x3 = 0.0050000000000000001 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x4 = pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 2.0);
        const double var_x5 = 3.9999999999999998e-6 + var_x4;
        const double var_x6 = 1 / var_x5;
        const double var_x7 = var_x4 * var_x6;
        const double var_x8 = 0.20000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x9 = pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 3.0) / pow(var_x5, 2);
        const double var_x10 = var_x6 * pow(var_chaste_interface__intracellular_calcium_concentration__Cai, 1.0);
        const double var_x11 = 0.002 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x12 = 0.0040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x13 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Cai);
        ...
        const double var_x18 = 2.0 * var_x14 * var_x16 - 2744000.0 * var_x17 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        const double var_x19 = var_x13 * var_x18 / pow((0.0036443148688046646 + 7.2886297376093296e-7 * var_x14 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x20 = 1 / (1.0 + 0.00020000000000000001 * var_x14 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Cai);
        const double var_x21 = var_x18 * var_x20 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x22 = var_x13 * var_x20;
        ...
        const double var_x28 = (-50.0 + var_chaste_interface__membrane__V) * var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x29 = var_x28 * var_chaste_interface__second_inward_current_f2_gate__f2;
        const double var_x30 = var_x29 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x31 = pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 2.0);
        const double var_x32 = var_x16 * var_x22 * var_x31;
        const double var_x33 = var_x19 * var_x31;
        const double var_x34 = 1.1761547293737243e-5 * var_x27 * (-2.0 * var_x26 + var_x24 * var_chaste_interface__intracellular_calcium_concentration__Cai);
        const double var_x35 = var_x28 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x36 = 1 / var_chaste_interface__intracellular_potassium_concentration__Ki;
        const double var_x37 = 0.00013114584825700806 * pow(var_chaste_interface__hyperpolarising_activated_current_y_gate__y, 2);
        const double var_x38 = log(3.0 * var_x36);
        const double var_x39 = exp(0.74867781645490938 + var_x25 - 2.0 * var_x38);
        ...
        const double var_x43 = 5.8807736468686214e-8 / (1.0 - var_x42);
        const double var_x44 = -var_x30 * var_x41 * var_x43;
        const double var_x45 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Nai);
        const double var_x46 = var_chaste_interface__intracellular_sodium_concentration__Nai / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Nai), 2);
        const double var_x47 = var_x43 * (-3.0 * var_x42 + var_x41 * var_chaste_interface__intracellular_potassium_concentration__Ki);
        const double var_x48 = 1.0 * var_chaste_interface__intracellular_sodium_concentration__Nai + 0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki;
        const double var_x49 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (0.0008549444286121402 * var_chaste_interface__intracellular_potassium_concentration__Ki + 0.0071245369051011684 * var_chaste_interface__intracellular_sodium_concentration__Nai) * var_chaste_interface__fast_sodium_current_h_gate__h / pow(var_x48, 2);
        const double var_x50 = 1 / var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x51 = var_x43 * (-140.0 * var_x42 + var_x41 * var_chaste_interface__intracellular_sodium_concentration__Nai);
        const double var_x52 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x53 = 20.0 * var_chaste_interface__second_inward_current_f2_gate__f2;
        const double var_x54 = var_chaste_interface__membrane__V > 99999.0;
        const double var_x55 = 20.0 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        
        
        rJacobian[0][0] = 1.0 - (mDt * (((fabs(var_x1 * var_x2) < 1.0000000000000001e-5) ? (-2.0 + var_x0) : (var_x0 - 0.20000000000000001 * var_x2 / (1.0 - exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane__V))))));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = 0.0;
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = 0.0;
        ...
        rJacobian[0][7] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (-var_x3 - 0.10000000000000001 * var_x7));
        rJacobian[1][2] = -(mDt * (var_x3));
        rJacobian[1][3] = -(mDt * (var_x8 * var_x9 - var_x10 * var_x8));
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[1][7] = 0.0;
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = -(mDt * (var_x11));
        rJacobian[2][2] = 1.0 - (mDt * (-var_x11 - 0.79999999999999993 * var_chaste_interface__intracellular_calcium_concentration__Cai));
        ...
        rJacobian[2][7] = 0.0;
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = -(mDt * (0.002 * var_x7));
        rJacobian[3][2] = -(mDt * (0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Cai));
        rJacobian[3][3] = 1.0 - (mDt * (-0.20000000000000001 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 9.5418840923404938e-11 * var_x19 - 1.8066221665073799e-10 * var_x21 - 8.7430565504672044e-7 / var_chaste_interface__intracellular_calcium_concentration__Cai - 0.071845959781105084 * var_x23 + var_x10 * var_x12 - var_x12 * var_x9 - 1.1761547293737243e-5 * var_x24 * var_x27 * var_x30));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (1.5709757969629391e-7 * var_x32 - 2.0864178044476298e-16 * var_x33));
        rJacobian[3][6] = -(mDt * (-var_x29 * var_x34));
        rJacobian[3][7] = -(mDt * (-var_x34 * var_x35));
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (var_x44 - 7.4808371283949473e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - var_x36 * var_x37 - 6.0528853041696024e-5 * var_x36 / var_x40 + 4.5316609527777084e-6 * var_x36 * var_x39 * (-26.713760659695652 * var_x38 + var_chaste_interface__membrane__V) / pow(var_x40, 2)));
        rJacobian[4][5] = -(mDt * (0.00088367388579165321 * var_x45 - 5.5229617861978321e-7 * var_x46));
        rJacobian[4][6] = -(mDt * (-var_x29 * var_x47));
        rJacobian[4][7] = -(mDt * (-var_x35 * var_x47));
        rJacobian[5][0] = -(mDt * (-4.9092993655091846e-5 * var_x1 * (-26.713760659695652 * log(140.36000000000001 / var_x48) + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current_h_gate__h));
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (0.21553787934331523 * var_x23 + 5.4198664995221396e-10 * var_x21 + 2.8625652277021485e-10 * var_x19));
        rJacobian[5][4] = -(mDt * (-0.0073630525045414608 * var_x49));
        rJacobian[5][5] = 1.0 - (mDt * (var_x44 + 6.2592534133428895e-16 * var_x33 + 8.2844426792967482e-7 * var_x46 - 0.061358770871178837 * var_x49 - 0.0013255108286874798 * var_x45 - 2.4480558341308171e-5 * var_x50 - 4.7129273908888172e-7 * var_x32 - var_x37 * var_x50));
        rJacobian[5][6] = -(mDt * (-var_x29 * var_x51));
        rJacobian[5][7] = -(mDt * (-var_x35 * var_x51));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (((fabs(var_x52) < 0.0001) ? (-0.12 - 0.12 * pow(var_chaste_interface__second_inward_current_d_gate__d, 2) + 0.23999999999999999 * (1.0 - var_chaste_interface__second_inward_current_d_gate__d) * var_chaste_interface__second_inward_current_d_gate__d) : (-0.012 * var_x52 / (-1.0 + exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.029999999999999999 * var_x52 / (1.0 - exp(-4.75 - 0.25 * var_chaste_interface__membrane__V))))));
        rJacobian[6][7] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = -(mDt * (((var_x54) ? (var_x53) : (-var_x53))));
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (((var_x54) ? (0.01 + var_x55) : (-0.01 - var_x55))));
    }
    ...
    void Celltest_piecewises_beFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        double _guess[8] = {rY[4],rY[11],rY[10],rY[1],rY[13],rY[9],rY[6],rY[8]};
        CardiacNewtonSolver<8,Celltest_piecewises_beFromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<8,Celltest_piecewises_beFromCellMLBackwardEuler>::Instance();
