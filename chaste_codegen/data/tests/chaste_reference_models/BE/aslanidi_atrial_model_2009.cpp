...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_atrial_model_2009FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[14], double rJacobian[14][14])
    {
        ...
        const double var_x43 = pow(var_x42, (-1.393));
        const double var_x44 = exp(0.052487898287663745 * var_chaste_interface__membrane__V);
        const double var_x45 = var_x43 * var_x44;
        const double var_x46 = 1 / (1 + 1.207988323918572 * var_x45);
        const double var_x47 = var_x46 * mParameters[6];
        const double var_x48 = var_x40 * var_x47;
        const double var_x49 = var_x38 * var_x48;
        const double var_x50 = -26.53945091048535 * log(var_x42) + var_chaste_interface__membrane__V;
        const double var_x51 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 3);
        const double var_x52 = var_x47 * var_x51 / pow(var_x39, 4);
        const double var_x53 = pow(var_x31, (-2));
        const double var_x54 = pow((0.82782257096336631 + var_x45), (-2));
        const double var_x55 = var_x22 * var_x41;
        const double var_x56 = var_x37 * var_x41;
        const double var_x57 = var_x41 * var_x51;
        const double var_x58 = var_x48 * var_x57;
        const double var_x59 = var_x40 * var_x45 * var_x50 * var_x54 * mParameters[6];
        const double var_x60 = var_x35 * sqrt(var_chaste_interface__intracellular_ion_concentrations__Na_i) * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x61 = pow((1 + 0.027410122234342148 * var_x29), (-2));
        const double var_x62 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2);
        const double var_x63 = 200 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x64 = 0.00088070109612833447 * var_x3;
        const double var_x65 = 32 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x66 = 0.00020000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x67 = pow(mParameters[2], 3);
        const double var_x68 = var_x67 * mParameters[9];
        const double var_x69 = var_x67 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x70 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * mParameters[1];
        const double var_x71 = 1 + 0.00029999999999999997 * var_x69 + 0.00029999999999999997 * var_x70;
        ...
        const double var_x75 = var_x70 * var_x73 - var_x69 * var_x74;
        const double var_x76 = var_x72 * var_x75;
        const double var_x77 = var_x68 * var_x76;
        const double var_x78 = 1 / var_x71;
        const double var_x79 = var_x68 * var_x74 * var_x78;
        const double var_x80 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2);
        const double var_x81 = var_x80 * mParameters[9] * mParameters[1];
        const double var_x82 = 0.021829942145742926 * var_x23;
        const double var_x83 = -3.290319067574035e-6 - 4.9354786013610522e-6 * var_x25;
        const double var_x84 = 0.0049352811901134472 * var_x50;
        const double var_x85 = var_x29 * var_x30 * var_x33 * var_x53 * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x86 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x88 = pow(var_chaste_interface__sodium_current_m_gate__m, 3) * (0.36499999999999999 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.63500000000000001 * var_chaste_interface__sodium_current_h1_gate__h1) * mParameters[5];
        const double var_x89 = exp(0.037679754693225945 * var_chaste_interface__membrane__V);
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.00085446536839159674 * var_x36 - 0.22004581682908866 * var_x49 - var_x22 * var_x24 - var_x23 * var_x28 - var_x24 * var_x37 - 0.024873817198171774 * var_x50 * var_x52 + 0.024873817198171774 * var_x38 * var_x40 * var_x46 * var_x50 * mParameters[6] + 0.00085446536839159674 * var_x29 * var_x30 * var_x33 * var_x53 * var_chaste_interface__cleft_space_ion_concentrations__K_c + 0.0095611374908700173 * var_x38 * var_x40 * var_x43 * var_x44 * var_x50 * var_x54 * mParameters[6]));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = 0.0;
        rJacobian[6][12] = -(mDt * (0.11002290841454433 * var_x55 + 0.11002290841454433 * var_x56 + 0.22004581682908866 * var_x58 + var_x28 * var_x41 - 0.0095611374908700173 * var_x57 * var_x59));
        rJacobian[6][13] = -(mDt * (-0.0012816980525873951 * var_x60 + 9.6295871719563877e-7 * var_x32 * var_x33 * var_x61 * var_x62 * var_chaste_interface__cleft_space_ion_concentrations__K_c));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        ...
        rJacobian[12][4] = 0.0;
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = -(mDt * (0.043659884291485852 * var_x49 + 0.00016953677944277714 * var_x36 - 0.00016953677944277714 * var_x85 + var_x22 * var_x82 + var_x37 * var_x82 + var_x52 * var_x84 - var_x49 * var_x84 - 0.0018970510894583371 * var_x38 * var_x59 - var_x23 * var_x27 * var_x83));
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-0.021829942145742926 * var_x55 - 0.021829942145742926 * var_x56 - 0.043659884291485852 * var_x58 + 26.53945091048535 * var_x26 * var_x41 * var_x83 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + 0.0018970510894583371 * var_x40 * var_x41 * var_x43 * var_x44 * var_x50 * var_x51 * var_x54 * mParameters[6]));
        rJacobian[12][13] = -(mDt * (0.00025430516916416572 * var_x60 - 1.9106323753881723e-7 * var_x34 * var_x61 * var_x62 * var_chaste_interface__cleft_space_ion_concentrations__K_c));
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = -(mDt * (0.00025430516916416572 * var_x85 - 0.00025430516916416572 * var_x36));
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = 0.0;
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = 0.0;
        rJacobian[13][11] = -(mDt * (0.0024676405950567236 * var_x79 + 7.4029217851701709e-7 * var_x77));
        rJacobian[13][12] = 0.0;
        rJacobian[13][13] = 1.0 - (mDt * (-0.00038145775374624855 * var_x60 - 4.3659884291485854e-7 * var_x86 - 0.00082254686501890791 * (((var_chaste_interface__membrane__V >= -2.6539450910485349e-6) && (var_chaste_interface__membrane__V <= 2.6539450910485349e-6)) ? (96486.995175714823 * var_x88 + 0.0096480430789824823 * var_x88 * (0.5 + 188398.77346612973 * var_chaste_interface__membrane__V)) : (3635.606491085292 * var_x88 * var_x89 * var_chaste_interface__membrane__V / (-1 + var_x89))) - 0.0074029217851701709 * var_x73 * var_x78 * var_x81 + 2.2208765355510512e-6 * var_x72 * var_x75 * var_x80 * mParameters[9] * mParameters[1] + 2.8659485630822583e-7 * var_x32 * var_x33 * var_x61 * var_x62 * var_chaste_interface__cleft_space_ion_concentrations__K_c));
    }
