...
bool Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::registered = ModelFactory::Register("grandi_pasqualini_bers_2010_ss", "BackwardEuler", (ModelFactory::TCreateMethod)Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::CreateMethod);
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[27], double rJacobian[27][27])
    {
        ...
        const double var_x6 = 0.38742512113256738 * pow(var_chaste_interface__SR_Ca_Concentrations__Ca_sr, 1.7869999999999999);
        const double var_x7 = 2814485.1633595936 * pow(var_chaste_interface__Ca_Concentrations__Ca_i, 1.7869999999999999);
        const double var_x8 = 1 + var_x6 + var_x7;
        const double var_x9 = 1 / var_x8;
        const double var_x10 = -31 + 0.10000000000000001 * mParameters[23];
        const double var_x11 = pow(2.6000000000000001, var_x10);
        const double var_x12 = var_x11 * mParameters[2];
        const double var_x13 = var_x12 * var_x9;
        const double var_x14 = var_x12 * (var_x7 - var_x6) / pow(var_x8, 2);
        const double var_x15 = var_x14 * var_x5;
        const double var_x16 = 13.800000000000001 * var_chaste_interface__Cytosolic_Ca_Buffers__Myo_c + 13.800000000000001 * var_chaste_interface__Cytosolic_Ca_Buffers__Myo_m;
        const double var_x17 = 2.3700000000000001 * var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHc + 2.3700000000000001 * var_chaste_interface__Cytosolic_Ca_Buffers__Tn_CHm;
        const double var_x18 = 0.23799999999999999 + 34 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x19 = 13.800000000000001 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x20 = 0.059999999999999998 + 100 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x21 = 2.3700000000000001 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x22 = 0.019599999999999999 + 32.700000000000003 * var_chaste_interface__Ca_Concentrations__Ca_i;
        const double var_x23 = pow(var_chaste_interface__SR_Ca_Concentrations__Ca_sr, 0.78699999999999992);
        const double var_x24 = var_x13 * var_x23;
        const double var_x25 = var_x14 * var_x23;
        const double var_x26 = 145.53224458892851 * var_x3;
        const double var_x27 = 100 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_j;
        const double var_x28 = 100 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_j;
        const double var_x29 = 5.2281977629563632e-6 + pow(var_chaste_interface__Ca_Concentrations__Ca_j, 1.6000000000000001);
        const double var_x30 = pow(2.3500000000000001, var_x10);
        const double var_x31 = 0.011844800000000001 * var_x30;
        const double var_x32 = 1 / mParameters[9];
        const double var_x33 = var_x32 * mParameters[10] * mParameters[23];
        const double var_x34 = pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2);
        const double var_x35 = 1 + 2.2499999999999996e-8 / var_x34;
        const double var_x36 = 1 / var_x35;
        const double var_x37 = 0.22 * var_x36;
        const double var_x38 = pow(var_chaste_interface__Na_Concentrations__Na_j, 3);
        const double var_x39 = pow(mParameters[8], 3);
        const double var_x40 = var_x39 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x41 = 0.0035899999999999999 * var_x39;
        const double var_x42 = var_x40 + 1.3 * var_x38 + var_x38 * mParameters[5] + var_x41 * (1 + 0.00053869674493876331 * var_x38) + 669921.875 * (1 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_j) * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x43 = var_chaste_interface__membrane_potential__V_m / (mParameters[10] * mParameters[23]);
        const double var_x44 = var_x43 * mParameters[9];
        const double var_x45 = exp(-0.72999999999999998 * var_x44);
        const double var_x46 = pow(1.5700000000000001, var_x10) * mParameters[20] / (1 + 0.32000000000000001 * var_x45);
        const double var_x47 = var_x46 / var_x42;
        const double var_x48 = var_x39 * var_x45;
        const double var_x49 = var_x47 * var_x48;
        const double var_x50 = 669921.875 + var_x39;
        const double var_x51 = -var_x50 - 373215529.24791086 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x52 = exp(0.27000000000000002 * var_x44);
        const double var_x53 = -var_x40 * var_x45 + var_x38 * var_x52 * mParameters[5];
        const double var_x54 = var_x46 * var_x53 / pow(var_x42, 2);
        const double var_x55 = var_x37 * var_x54;
        const double var_x56 = var_x47 * var_x53 / (pow(var_x35, 2) * pow(var_chaste_interface__Ca_Concentrations__Ca_j, 3));
        const double var_x57 = var_x43 * pow(mParameters[9], 2);
        const double var_x58 = var_x57 * (1 - var_chaste_interface__I_Ca__f_Ca_Bj);
        const double var_x59 = exp(2 * var_x44);
        const double var_x60 = pow(1.8, var_x10) * var_chaste_interface__I_Ca__d * var_chaste_interface__I_Ca__f;
        const double var_x61 = var_x60 * mParameters[11] / (-1 + var_x59);
        const double var_x62 = var_x59 * var_x61;
        const double var_x63 = var_x32 * mParameters[22];
        const double var_x64 = var_x3 * var_x63;
        const double var_x65 = 88294470889864.781 * var_x64;
        const double var_x66 = 64.935064935064929 * mParameters[1];
        const double var_x67 = 1205.9369202226344 * mParameters[0] + var_x66 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x68 = -0.34100000000000003 * mParameters[5];
        const double var_x69 = 0.34100000000000003 * var_x59;
        const double var_x70 = var_x44 * mParameters[22];
        const double var_x71 = var_x3 * var_x61 * var_x70;
        const double var_x72 = 100 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x73 = 0.029999999999999999 + var_x72;
        const double var_x74 = 1.3 + var_x72;
        const double var_x75 = pow(var_chaste_interface__Na_Concentrations__Na_j, 2);
        const double var_x76 = 3 * mParameters[5];
        const double var_x77 = 5.8017639429904805e-6 * var_x39;
        const double var_x78 = -3.9000000000000004 * var_x75 - var_x75 * var_x76 - var_x75 * var_x77;
        const double var_x79 = var_x52 * mParameters[5];
        const double var_x80 = var_x36 * var_x47 * var_x75 * var_x79;
        const double var_x81 = -var_chaste_interface__Ca_Concentrations__Ca_j + var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x82 = 100 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_sl;
        const double var_x83 = 100 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_sl;
        const double var_x84 = 5.2281977629563632e-6 + pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 1.6000000000000001);
        const double var_x85 = 0.095835200000000009 * var_x30;
        const double var_x86 = 1 + 2.2499999999999996e-8 / pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2);
        const double var_x87 = 1 / var_x86;
        const double var_x88 = 1.78 * var_x87;
        const double var_x89 = pow(var_chaste_interface__Na_Concentrations__Na_sl, 3);
        const double var_x90 = var_x39 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x91 = var_x90 + 1.3 * var_x89 + var_x41 * (1 + 0.00053869674493876331 * var_x89) + var_x89 * mParameters[5] + 669921.875 * (1 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_sl) * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x92 = var_x46 / var_x91;
        const double var_x93 = var_x48 * var_x92;
        const double var_x94 = -var_x50 - 373215529.24791086 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x95 = -var_x45 * var_x90 + var_x52 * var_x89 * mParameters[5];
        const double var_x96 = var_x46 * var_x95 / pow(var_x91, 2);
        const double var_x97 = var_x88 * var_x96;
        const double var_x98 = var_x92 * var_x95 / (pow(var_x86, 2) * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 3));
        const double var_x99 = var_x57 * (1 - var_chaste_interface__I_Ca__f_Ca_Bsl);
        const double var_x100 = 2379535990481.856 * var_x64;
        const double var_x101 = 100 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x102 = 0.029999999999999999 + var_x101;
        const double var_x103 = 1.3 + var_x101;
        const double var_x104 = pow(var_chaste_interface__Na_Concentrations__Na_sl, 2);
        const double var_x105 = -3.9000000000000004 * var_x104 - var_x104 * var_x76 - var_x104 * var_x77;
        const double var_x106 = var_x104 * var_x79 * var_x87 * var_x92;
        const double var_x107 = 0.001 + 0.0001 * var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x108 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bj;
        const double var_x109 = 0.001 + 0.0001 * var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x110 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bsl;
        const double var_x111 = var_x3 * mParameters[3];
        const double var_x112 = 0.23994508763098885 * var_x111;
        const double var_x113 = 0.33000000000000002 * var_x36;
        const double var_x114 = var_x113 * var_x54;
        const double var_x115 = var_x111 * var_x63;
        const double var_x116 = -0.75 * mParameters[8];
        const double var_x117 = exp(var_x44);
        const double var_x118 = 0.75 * var_x117;
        const double var_x119 = var_x60 / (-1 + var_x117);
        const double var_x120 = var_x111 * var_x119 * var_x70;
        const double var_x121 = 3.2338732908121872 * var_x3;
        const double var_x122 = var_x33 / var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x123 = mParameters[21] * mParameters[7] / ((1.5 + mParameters[7]) * (1 + 0.1245 * exp(-0.10000000000000001 * var_x44) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[8])) * exp(-var_x44)));
        const double var_x124 = pow(var_chaste_interface__I_Na__m, 3) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * mParameters[12];
        const double var_x125 = var_x117 * var_x119;
        const double var_x126 = 2.6699999999999999 * var_x87;
        const double var_x127 = var_x126 * var_x96;
        const double var_x128 = var_x33 / var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x129 = 1 * mParameters[1];
        const double var_x130 = 18.571428571428569 * mParameters[0] + var_x129 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x131 = 100 * var_chaste_interface__SR_Ca_Concentrations__Csqn_b;
        const double var_x132 = 65 + 100 * var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x133 = 1 / var_chaste_interface__SR_Ca_Concentrations__Ca_sr;
        const double var_x134 = pow(var_x133, 2.5);
        const double var_x135 = 1 + 0.13584112963311223 * var_x134;
        const double var_x136 = 1 / var_x135;
        const double var_x137 = 7.5 - 7 * var_x136;
        const double var_x138 = var_x137 * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x139 = 1 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x140 = 15 - 14 * var_x136;
        const double var_x141 = 1 / var_x140;
        const double var_x142 = 20 * var_x141 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x143 = pow(var_x135, (-2));
        const double var_x144 = var_x133 * var_x134 * var_x143;
        const double var_x145 = 2.3772197685794643 * var_x144 * var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x146 = 47.544395371589282 * var_x144 * var_x34 / pow(var_x140, 2);
        const double var_x147 = 10 * var_x141 * var_x34;
        const double var_x148 = var_x137 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x149 = var_x142 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x150 = var_x146 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        
        
        rJacobian[0][0] = 1.0 - (mDt * (-7.0788000000000011 + var_x0 + var_x1 + var_x16 + var_x17 + var_x2 - var_x4 + 270818.42237280885 * var_x15 - 270818.42237280885 * var_x13 * var_x5));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = -(mDt * (var_x4));
        rJacobian[0][3] = -(mDt * (var_x18));
        rJacobian[0][4] = -(mDt * (0.016159999999999997 + var_x19));
        rJacobian[0][5] = -(mDt * (0.015757 + var_x19));
        rJacobian[0][6] = -(mDt * (var_x20));
        rJacobian[0][7] = -(mDt * (0.003032 + var_x21));
        rJacobian[0][8] = -(mDt * (0.0063300000000000006 + var_x21));
        rJacobian[0][9] = -(mDt * (var_x22));
        rJacobian[0][10] = 0.0;
        rJacobian[0][11] = 0.0;
        rJacobian[0][12] = 0.0;
        rJacobian[0][13] = 0.0;
        ...
        rJacobian[0][20] = 0.0;
        rJacobian[0][21] = 0.0;
        rJacobian[0][22] = -(mDt * (0.037279237232671424 * var_x24 + 0.037279237232671424 * var_x25));
        rJacobian[0][23] = 0.0;
        rJacobian[0][24] = 0.0;
        rJacobian[0][25] = 0.0;
        rJacobian[0][26] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (-75.37105751391465 + var_x27 + var_x28 - var_x26 - var_x67 - var_x65 * (-9.8999999999999977e-9 * var_x56 + var_x37 * var_x49 - var_x51 * var_x55 + 3.0321500000000001e-5 * var_x33 / var_chaste_interface__Ca_Concentrations__Ca_j + 0.00029830680000000003 * var_x58 * var_x62 + var_x31 * pow(var_chaste_interface__Ca_Concentrations__Ca_j, 0.60000000000000009) / var_x29 - var_x31 * pow(var_chaste_interface__Ca_Concentrations__Ca_j, 2.2000000000000002) / pow(var_x29, 2))));
        rJacobian[1][2] = -(mDt * (var_x26));
        rJacobian[1][3] = 0.0;
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        ...
        rJacobian[1][8] = 0.0;
        rJacobian[1][9] = 0.0;
        rJacobian[1][10] = -(mDt * (77240003134.453705 * var_x71 * (var_x68 + var_x69 * var_chaste_interface__Ca_Concentrations__Ca_j)));
        rJacobian[1][11] = 0.0;
        rJacobian[1][12] = -(mDt * (var_x73));
        rJacobian[1][13] = 0.0;
        rJacobian[1][14] = -(mDt * (var_x74));
        rJacobian[1][15] = 0.0;
        rJacobian[1][16] = 0.0;
        rJacobian[1][17] = 0.0;
        rJacobian[1][18] = 0.0;
        rJacobian[1][19] = 0.0;
        rJacobian[1][20] = -(mDt * (-var_x65 * (-0.66000000000000003 * var_x80 - var_x55 * var_x78)));
        rJacobian[1][21] = 0.0;
        rJacobian[1][22] = -(mDt * (var_x67));
        rJacobian[1][23] = 0.0;
        rJacobian[1][24] = 0.0;
        rJacobian[1][25] = -(mDt * (var_x66 * var_x81));
        rJacobian[1][26] = 0.0;
        rJacobian[2][0] = -(mDt * (15.582629387269481 * var_x3));
        rJacobian[2][1] = -(mDt * (3.9220939916716238 * var_x3));
        rJacobian[2][2] = 1.0 - (mDt * (-165.10000000000002 + var_x82 + var_x83 - 19.504723378941105 * var_x3 - var_x100 * (-8.0099999999999983e-8 * var_x98 + var_x88 * var_x93 - var_x94 * var_x97 + 0.00024532850000000001 * var_x33 / var_chaste_interface__Ca_Concentrations__Ca_sl + 3.3145199999999996e-5 * var_x62 * var_x99 + var_x85 * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 0.60000000000000009) / var_x84 - var_x85 * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2.2000000000000002) / pow(var_x84, 2))));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        ...
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = -(mDt * (231290898.27483633 * var_x71 * (var_x68 + var_x69 * var_chaste_interface__Ca_Concentrations__Ca_sl)));
        rJacobian[2][12] = 0.0;
        rJacobian[2][13] = -(mDt * (var_x102));
        rJacobian[2][14] = 0.0;
        rJacobian[2][15] = -(mDt * (var_x103));
        rJacobian[2][16] = 0.0;
        rJacobian[2][17] = 0.0;
        rJacobian[2][18] = 0.0;
        rJacobian[2][19] = 0.0;
        rJacobian[2][20] = 0.0;
        rJacobian[2][21] = -(mDt * (-var_x100 * (-5.3399999999999999 * var_x106 - var_x105 * var_x97)));
        rJacobian[2][22] = 0.0;
        rJacobian[2][23] = 0.0;
        rJacobian[2][24] = 0.0;
        rJacobian[2][25] = 0.0;
        ...
        rJacobian[3][25] = 0.0;
        rJacobian[3][26] = 0.0;
        rJacobian[4][0] = -(mDt * (1.9320000000000004 - var_x16));
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-0.00046000000000000001 - var_x19));
        rJacobian[4][5] = -(mDt * (-var_x19));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        ...
        rJacobian[6][25] = 0.0;
        rJacobian[6][26] = 0.0;
        rJacobian[7][0] = -(mDt * (0.33180000000000004 - var_x17));
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-3.1999999999999999e-5 - var_x21));
        rJacobian[7][8] = -(mDt * (-var_x21));
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[7][12] = 0.0;
        ...
        rJacobian[11][26] = 0.0;
        rJacobian[12][0] = 0.0;
        rJacobian[12][1] = -(mDt * (19.897959183673468 - var_x27));
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = 0.0;
        rJacobian[12][5] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-var_x73));
        rJacobian[12][13] = 0.0;
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        ...
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = -(mDt * (43.550000000000004 - var_x82));
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = 0.0;
        ...
        rJacobian[13][11] = 0.0;
        rJacobian[13][12] = 0.0;
        rJacobian[13][13] = 1.0 - (mDt * (-var_x102));
        rJacobian[13][14] = 0.0;
        rJacobian[13][15] = 0.0;
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        ...
        rJacobian[13][26] = 0.0;
        rJacobian[14][0] = 0.0;
        rJacobian[14][1] = -(mDt * (55.473098330241186 - var_x28));
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = 0.0;
        rJacobian[14][4] = 0.0;
        rJacobian[14][5] = 0.0;
        ...
        rJacobian[15][0] = 0.0;
        rJacobian[15][1] = 0.0;
        rJacobian[15][2] = -(mDt * (121.55000000000001 - var_x83));
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = 0.0;
        rJacobian[15][5] = 0.0;
        rJacobian[15][6] = 0.0;
        ...
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (-var_x103));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = 0.0;
        rJacobian[17][17] = 1.0 - (mDt * (-var_x107));
        rJacobian[17][18] = 0.0;
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = -(mDt * (0.0007561 - var_x108));
        rJacobian[17][21] = 0.0;
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = 0.0;
        rJacobian[17][24] = 0.0;
        ...
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-var_x109));
        rJacobian[18][19] = 0.0;
        rJacobian[18][20] = 0.0;
        rJacobian[18][21] = -(mDt * (0.000165 - var_x110));
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        rJacobian[18][25] = 0.0;
        ...
        rJacobian[19][17] = 0.0;
        rJacobian[19][18] = 0.0;
        rJacobian[19][19] = 1.0 - (mDt * (-var_x112));
        rJacobian[19][20] = 0.0;
        rJacobian[19][21] = -(mDt * (var_x112));
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = 0.0;
        rJacobian[19][26] = 0.0;
        rJacobian[20][0] = 0.0;
        rJacobian[20][1] = -(mDt * (-176588941779729.56 * var_x115 * (1.4849999999999997e-8 * var_x56 + var_x114 * var_x51 - var_x113 * var_x49)));
        rJacobian[20][2] = 0.0;
        rJacobian[20][3] = 0.0;
        rJacobian[20][4] = 0.0;
        rJacobian[20][5] = 0.0;
        ...
        rJacobian[20][8] = 0.0;
        rJacobian[20][9] = 0.0;
        rJacobian[20][10] = -(mDt * (536388.91065592843 * var_x120 * (var_x116 + var_x118 * var_chaste_interface__Na_Concentrations__Na_j)));
        rJacobian[20][11] = 0.0;
        rJacobian[20][12] = 0.0;
        rJacobian[20][13] = 0.0;
        rJacobian[20][14] = 0.0;
        rJacobian[20][15] = 0.0;
        rJacobian[20][16] = 0.0;
        rJacobian[20][17] = -(mDt * (var_x107 * mParameters[3]));
        rJacobian[20][18] = 0.0;
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * ((-0.0007561 + var_x108 - var_x121 - 176588941779729.56 * var_x64 * (0.98999999999999999 * var_x80 + 6.567e-5 * var_x122 + var_x114 * var_x78 + 0.11 * var_x122 * var_x124 + 2.2781249999999999e-9 * var_x125 * var_x58 + 19326.119999999999 * var_x123 / (pow((1 + 14641 / pow(var_chaste_interface__Na_Concentrations__Na_j, 4)), 2) * pow(var_chaste_interface__Na_Concentrations__Na_j, 5)))) * mParameters[3]));
        ...
        rJacobian[21][0] = 0.0;
        rJacobian[21][1] = 0.0;
        rJacobian[21][2] = -(mDt * (-4759071980963.7119 * var_x115 * (1.2014999999999997e-7 * var_x98 + var_x127 * var_x94 - var_x126 * var_x93)));
        rJacobian[21][3] = 0.0;
        rJacobian[21][4] = 0.0;
        rJacobian[21][5] = 0.0;
        rJacobian[21][6] = 0.0;
        ...
        rJacobian[21][9] = 0.0;
        rJacobian[21][10] = 0.0;
        rJacobian[21][11] = -(mDt * (1606.1867935752523 * var_x120 * (var_x116 + var_x118 * var_chaste_interface__Na_Concentrations__Na_sl)));
        rJacobian[21][12] = 0.0;
        rJacobian[21][13] = 0.0;
        rJacobian[21][14] = 0.0;
        rJacobian[21][15] = 0.0;
        rJacobian[21][16] = 0.0;
        rJacobian[21][17] = 0.0;
        rJacobian[21][18] = -(mDt * (var_x109 * mParameters[3]));
        rJacobian[21][19] = -(mDt * (7.7982153480071377 * var_x111));
        rJacobian[21][20] = -(mDt * (0.087152885187388451 * var_x111));
        rJacobian[21][21] = 1.0 - (mDt * ((-0.000165 + var_x110 - 7.8853682331945256 * var_x3 - 4759071980963.7119 * var_x64 * (0.00053133 * var_x128 + 8.0099999999999998 * var_x106 + var_x105 * var_x127 + 2.5312499999999994e-10 * var_x125 * var_x99 + 0.89000000000000001 * var_x124 * var_x128 + 156365.88 * var_x123 / (pow((1 + 14641 / pow(var_chaste_interface__Na_Concentrations__Na_sl, 4)), 2) * pow(var_chaste_interface__Na_Concentrations__Na_sl, 5)))) * mParameters[3]));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        rJacobian[21][26] = 0.0;
        rJacobian[22][0] = -(mDt * (-5029484.9869235931 * var_x15 + 5029484.9869235931 * var_x11 * var_x5 * var_x9 * mParameters[2]));
        rJacobian[22][1] = -(mDt * (var_x130));
        rJacobian[22][2] = 0.0;
        rJacobian[22][3] = 0.0;
        rJacobian[22][4] = 0.0;
        rJacobian[22][5] = 0.0;
        ...
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (-260 + var_x131 - var_x130 - 0.69232869146389786 * var_x24 - 0.69232869146389786 * var_x25));
        rJacobian[22][23] = -(mDt * (var_x132));
        rJacobian[22][24] = 0.0;
        rJacobian[22][25] = -(mDt * (-var_x129 * var_x81));
        rJacobian[22][26] = 0.0;
        rJacobian[23][0] = 0.0;
        rJacobian[23][1] = 0.0;
        rJacobian[23][2] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (260 - var_x131));
        rJacobian[23][23] = 1.0 - (mDt * (-var_x132));
        rJacobian[23][24] = 0.0;
        rJacobian[23][25] = 0.0;
        rJacobian[23][26] = 0.0;
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = -(mDt * (var_x138 + var_x139 * var_x142));
        rJacobian[24][2] = 0.0;
        rJacobian[24][3] = 0.0;
        rJacobian[24][4] = 0.0;
        rJacobian[24][5] = 0.0;
        ...
        rJacobian[24][20] = 0.0;
        rJacobian[24][21] = 0.0;
        rJacobian[24][22] = -(mDt * (-var_x145 + var_x139 * var_x146));
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-0.065000000000000002 - var_x147));
        rJacobian[24][25] = -(mDt * (var_x148 - var_x147));
        rJacobian[24][26] = -(mDt * (-var_x147));
        rJacobian[25][0] = 0.0;
        rJacobian[25][1] = -(mDt * (var_x149 - var_x138));
        rJacobian[25][2] = 0.0;
        rJacobian[25][3] = 0.0;
        rJacobian[25][4] = 0.0;
        rJacobian[25][5] = 0.0;
        ...
        rJacobian[25][20] = 0.0;
        rJacobian[25][21] = 0.0;
        rJacobian[25][22] = -(mDt * (var_x145 + var_x150));
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = -(mDt * (0.0050000000000000001));
        rJacobian[25][25] = 1.0 - (mDt * (-0.059999999999999998 - var_x148));
        rJacobian[25][26] = -(mDt * (var_x147));
        rJacobian[26][0] = 0.0;
        rJacobian[26][1] = -(mDt * (-var_x149 - var_x137 * var_chaste_interface__SR_Fluxes__Ry_Rr));
        rJacobian[26][2] = 0.0;
        rJacobian[26][3] = 0.0;
        rJacobian[26][4] = 0.0;
        rJacobian[26][5] = 0.0;
        ...
        rJacobian[26][20] = 0.0;
        rJacobian[26][21] = 0.0;
        rJacobian[26][22] = -(mDt * (-var_x150 + 2.3772197685794643 * var_x133 * var_x134 * var_x143 * var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Rr));
        rJacobian[26][23] = 0.0;
        rJacobian[26][24] = -(mDt * (-0.0050000000000000001));
        rJacobian[26][25] = -(mDt * (0.055));
        rJacobian[26][26] = 1.0 - (mDt * (-0.0050000000000000001 - var_x147 - var_x148));
    }
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_I_Ca__tauf = 1 / (0.02 + 0.019699999999999999 * exp(-pow((0.48865000000000003 + 0.033700000000000001 * var_chaste_interface__membrane_potential__V_m), 2)));
        ...
        const double var_I_Na__taum = 0.12920000000000001 * exp(-pow((2.9465894465894467 + 0.064350064350064351 * var_chaste_interface__membrane_potential__V_m), 2)) + 0.064869999999999997 * exp(-pow((-0.094346635367762138 + 0.019561815336463225 * var_chaste_interface__membrane_potential__V_m), 2));
        const double var_I_to__tauxtof = 0.5 + 8.5 * exp(-pow((0.90000000000000002 + 0.02 * var_chaste_interface__membrane_potential__V_m), 2));
        ...
        const double var_I_to__tauytof = 7 + 85 * exp(-0.0045454545454545452 * pow((40 + var_chaste_interface__membrane_potential__V_m), 2));
    ...
    std::vector<double> Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        ...
        const double var_I_Ks__gks_sl = 0.0035000000000000001; // mS_per_uF
        const double var_SR_Fluxes__J_SRleak = (-var_chaste_interface__Ca_Concentrations__Ca_j + var_chaste_interface__SR_Ca_Concentrations__Ca_sr) * mParameters[0]; // mM_per_msec
        const double var_I_Ca__tauf = 1 / (0.02 + 0.019699999999999999 * exp(-pow((0.48865000000000003 + 0.033700000000000001 * var_chaste_interface__membrane_potential__V_m), 2))); // msec
        const double var_I_Kr__rkr = 1 / (1 + exp(3.0833333333333335 + 0.041666666666666664 * var_chaste_interface__membrane_potential__V_m)); // dimensionless
