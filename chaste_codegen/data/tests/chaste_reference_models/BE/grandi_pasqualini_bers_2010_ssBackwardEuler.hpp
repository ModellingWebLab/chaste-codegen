...
private:
    static AbstractBackwardEulerCardiacCell<27>* CreateMethod(std::shared_ptr<AbstractIvpOdeSolver> p_solver, std::shared_ptr<AbstractStimulusFunction> p_stimulus);
...
public:
    ...
    Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler(std::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, std::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
