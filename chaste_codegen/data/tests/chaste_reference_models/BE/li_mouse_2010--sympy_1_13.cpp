...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellli_mouse_2010FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_activated_chloride_current__O_ClCa = 0.20000000000000001 / (1 + exp(5.9871794871794881 - 0.12820512820512822 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_fast_sodium_current__E_Na = var_cell__R * var_cell__T * log((1 * mParameters[3] + 0.1111111111111111 * mParameters[2]) / (1 * var_chaste_interface__sodium_concentration__Nai + 0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki)) / var_cell__F; // millivolt
        ...
        const double var_sodium_potassium_pump_current__f_NaK = 1 / (1 + 0.1245 * exp(-0.10000000000000001 * var_cell__F * var_chaste_interface__cell__V / (var_cell__R * var_cell__T)) + 0.036499999999999998 * var_sodium_potassium_pump_current__sigma * exp(-var_cell__F * var_chaste_interface__cell__V / (var_cell__R * var_cell__T))); // dimensionless
        const double var_sodium_potassium_pump_current__i_NaK = 1 * mParameters[2] * var_sodium_potassium_pump_current__f_NaK * var_sodium_potassium_pump_current__i_NaK_max / ((1 + pow((var_sodium_potassium_pump_current__Km_Nai / var_chaste_interface__sodium_concentration__Nai), 2.3999999999999999)) * (mParameters[2] + var_sodium_potassium_pump_current__Km_Ko)); // picoA_per_picoF
        const double var_time_independent_K_I__i_K1 = (-var_fast_transient_outward_K_I__E_K + var_chaste_interface__cell__V) * mParameters[2] * mParameters[7] / ((1 + exp(0.089599999999999999 * var_chaste_interface__cell__V - 0.089599999999999999 * var_fast_transient_outward_K_I__E_K)) * (210 + mParameters[2])); // picoA_per_picoF
    ...
    void Cellli_mouse_2010FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[26], double rResidual[26])
    {
        ...
        const double var_calcium_concentration__Bi = 1 / (1 + var_calcium_concentration__Bmax * var_calcium_concentration__Kd / pow((var_calcium_concentration__Cai + var_calcium_concentration__Kd), 2)); // dimensionless
        const double var_calcium_concentration__Bss = 1 / (1 + var_calcium_concentration__Bmax * var_calcium_concentration__Kd / pow((var_chaste_interface__calcium_concentration__Cass + var_calcium_concentration__Kd), 2)); // dimensionless
        const double var_calcium_concentration__Km_CSQN = 630; // micromolar
        const double var_calcium_concentration__BJSR = 1 / (1 + var_calcium_concentration__CSQN_tot * var_calcium_concentration__Km_CSQN / pow((var_chaste_interface__calcium_concentration__CaJSR + var_calcium_concentration__Km_CSQN), 2)); // dimensionless
        const double var_calcium_fluxes__CaMKb = 0.050000000000000003 * (1 - var_chaste_interface__calcium_fluxes__CaMKt) / (1 + 0.69999999999999996 / var_chaste_interface__calcium_concentration__Cass); // dimensionless
        ...
        const double var_calcium_fluxes__vmup = (1 + 2.9982000000000002 * pow(var_calcium_fluxes__CaMKa, 2.5830000000000002) / (1.7590641847756086 + pow(var_calcium_fluxes__CaMKa, 2.5830000000000002))) * var_calcium_fluxes__vmup_init; // micromolar_per_millisecond
        ...
        const double var_sodium_background_current__i_Nab = (-var_fast_sodium_current__E_Na + var_chaste_interface__cell__V) * var_sodium_background_current__g_Nab; // picoA_per_picoF
        const double var_sodium_calcium_exchange_current__i_NCX = (pow(var_chaste_interface__sodium_concentration__Nai, 3) * mParameters[1] * exp(var_cell__F * var_chaste_interface__cell__V * var_sodium_calcium_exchange_current__eta / (var_cell__R * var_cell__T)) - pow(mParameters[3], 3) * var_calcium_concentration__Cai * exp((-1 + var_sodium_calcium_exchange_current__eta) * var_cell__F * var_chaste_interface__cell__V / (var_cell__R * var_cell__T))) * mParameters[11] / ((1 + pow(var_sodium_calcium_exchange_current__K_mAllo, 2) / pow(var_calcium_concentration__Cai, 2)) * (1 + var_sodium_calcium_exchange_current__k_sat * exp((-1 + var_sodium_calcium_exchange_current__eta) * var_cell__F * var_chaste_interface__cell__V / (var_cell__R * var_cell__T))) * (pow(mParameters[3], 3) * var_calcium_concentration__Cai + pow(var_sodium_calcium_exchange_current__K_mNao, 3) * var_calcium_concentration__Cai + pow(var_chaste_interface__sodium_concentration__Nai, 3) * mParameters[1] + pow(var_chaste_interface__sodium_concentration__Nai, 3) * var_sodium_calcium_exchange_current__K_mCao + pow(mParameters[3], 3) * (1 + pow(var_chaste_interface__sodium_concentration__Nai, 3) / pow(var_sodium_calcium_exchange_current__K_mNai, 3)) * var_sodium_calcium_exchange_current__K_mCai + pow(var_sodium_calcium_exchange_current__K_mNai, 3) * (1 + var_calcium_concentration__Cai / var_sodium_calcium_exchange_current__K_mCai) * mParameters[1])); // picoA_per_picoF
        const double var_calcium_concentration__Cai_orig_deriv = (-var_calcium_fluxes__J_serca - 0.5 * (-2 * var_sodium_calcium_exchange_current__i_NCX + var_calcium_background_current__i_Cab + var_calcium_pump_current__i_pCa) * var_cell__Acap * mParameters[5] / (var_cell__F * var_cell__Vmyo) + var_calcium_fluxes__J_leak + var_calcium_fluxes__J_xfer) * var_calcium_concentration__Bi; // micromolar / millisecond
    ...
    void Cellli_mouse_2010FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[26], double rJacobian[26][26])
    {
        ...
        const double var_x8 = 1 / (1 + 79.365079365079367 * var_x7);
        const double var_x9 = var_chaste_interface__ryanodine_receptors__P_O1 + var_chaste_interface__ryanodine_receptors__P_O2;
        const double var_x10 = var_x9 * mParameters[0];
        const double var_x11 = var_x10 * var_chaste_interface__calcium_fluxes__P_RyR;
        ...
        const double var_x16 = ((var_x12) ? (-var_x11) : (-10));
        const double var_x17 = ((var_x12) ? (var_x10 * var_x14) : (0));
        const double var_x18 = ((var_x12) ? (var_x14 * var_chaste_interface__calcium_fluxes__P_RyR * mParameters[0]) : (0));
        const double var_x19 = -var_x18 * var_x8;
        const double var_x20 = ((var_x12) ? (3.0000000000000001e-5) : (0.10000000000000001));
        const double var_x21 = ((var_x12) ? (-0.029999999999999999) : (-100));
        const double var_x22 = pow(var_chaste_interface__calcium_concentration__Cai_converted, 3);
        const double var_x23 = 1 - var_chaste_interface__calcium_fluxes__CaMKt;
        const double var_x24 = 1 + 0.69999999999999996 / var_chaste_interface__calcium_concentration__Cass;
        ...
        const double var_x28 = pow(var_x27, 2.5830000000000002);
        const double var_x29 = 1 / (1.7590641847756086 + var_x28);
        const double var_x30 = 1.5167893800000001 * var_x29;
        const double var_x31 = 0.50590000000000002 + var_x28 * var_x30;
        const double var_x32 = pow(var_chaste_interface__calcium_concentration__Cai_converted, 2);
        const double var_x33 = pow((1.6974399999999999e-7 + var_x32), (-2));
        const double var_x34 = 1000000 * var_x32;
        const double var_x35 = 1 / (0.16974399999999998 + var_x34);
        const double var_x36 = pow(var_x27, 1.5830000000000002);
        const double var_x37 = pow(var_chaste_interface__calcium_concentration__Cass, (-2));
        const double var_x38 = var_x23 * var_x37 / pow(var_x24, 2);
        const double var_x39 = pow(var_x27, 4.1660000000000004) / pow((1 + 0.56848408867329814 * var_x28), 2);
        const double var_x40 = var_x35 * (-0.044315367702357472 * var_x38 * var_x39 + 0.13712534389890002 * var_x29 * var_x36 * var_x38);
        const double var_x41 = 95238095.238095239 * var_x32;
        const double var_x42 = 2.5830000000000002 - 0.12915000000000001 * var_x25;
        const double var_x43 = var_x35 * (-0.49018713237495126 * var_x39 * var_x42 + var_x30 * var_x36 * var_x42);
        const double var_x44 = 0.00059999999999999995 + var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x45 = 1 + 6.5400000000000004e-5 / pow(var_x44, 2);
        const double var_x46 = 1 / var_x45;
        const double var_x47 = 0.001 * var_x46;
        const double var_x48 = 1 / var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x49 = 1 / (0.083232249999999994 + var_x34);
        const double var_x50 = exp(-0.024495140414072337 * var_chaste_interface__cell__V);
        const double var_x51 = pow(mParameters[3], 3);
        const double var_x52 = 1 / (1 + 0.27000000000000002 * var_x50);
        const double var_x53 = pow(var_chaste_interface__sodium_concentration__Nai, 3);
        const double var_x54 = var_x53 * mParameters[1];
        const double var_x55 = (1 + 277.77777777777777 * var_chaste_interface__calcium_concentration__Cai_converted) * mParameters[1];
        const double var_x56 = var_x51 * (1 + 5.7870370370370368e-13 * var_x53);
        const double var_x57 = 1000 * var_x51;
        const double var_x58 = var_x57 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x59 = var_x52 * mParameters[11] / (var_x54 + var_x58 + 1400 * var_x53 + 1728000000000.0 * var_x55 + 3.6000000000000001 * var_x56 + 6.81472e+17 * var_chaste_interface__calcium_concentration__Cai_converted);
        const double var_x60 = var_x50 * var_x51 * var_x59;
        const double var_x61 = -6.81472e+17 - var_x57 - 480000000000000.0 * mParameters[1];
        const double var_x62 = exp(0.013189690992192795 * var_chaste_interface__cell__V);
        const double var_x63 = -var_x50 * var_x58 + var_x53 * var_x62 * mParameters[1];
        const double var_x64 = var_x52 * var_x63 * mParameters[11] / pow((2.0543764087152516e-15 * var_x53 + 5.282682193839219e-18 * var_x56 + 2.535687453042825e-6 * var_x55 + 1.4674117205108941e-18 * var_x54 + 1.4674117205108941e-15 * var_x51 * var_chaste_interface__calcium_concentration__Cai_converted + var_chaste_interface__calcium_concentration__Cai_converted), 2);
        const double var_x65 = 4.3065943149854847e-36 * var_x64;
        const double var_x66 = 0.032656617993405558 * mParameters[5];
        const double var_x67 = var_x31 * var_x35;
        const double var_x68 = pow(var_chaste_interface__sodium_concentration__Nai, 2);
        const double var_x69 = var_x68 * mParameters[1];
        const double var_x70 = -3 * var_x69 - 4200 * var_x68 - 6.2500000000000002e-12 * var_x51 * var_x68;
        const double var_x71 = var_x59 * var_x62 * var_x69;
        const double var_x72 = 0.59999999999999998 + var_chaste_interface__calcium_concentration__Cass;
        const double var_x73 = pow(var_x72, (-2));
        const double var_x74 = 1 / (1 + 65.399999999999991 * var_x73);
        const double var_x75 = 0.075369662812530269 * var_chaste_interface__cell__V;
        const double var_x76 = exp(-var_x75);
        const double var_x77 = mParameters[4] * var_chaste_interface__L_type_calcium_current__y_gate / mParameters[5];
        const double var_x78 = 0.0023079445283571576 * var_x77 * var_chaste_interface__cell__V / (1 - var_x76);
        const double var_x79 = var_x78 * (-var_chaste_interface__calcium_concentration__Cass + var_x76 * mParameters[1]);
        const double var_x80 = fabs(var_x75) > 1.0000000000000001e-5;
        const double var_x81 = exp(-1.0000000000000001e-5);
        const double var_x82 = 3.062166450310111e-7 * var_x77 / (1 - var_x81);
        const double var_x83 = var_x82 * (-var_chaste_interface__calcium_concentration__Cass + var_x81 * mParameters[1]);
        const double var_x84 = ((var_x80) ? (-var_x79) : (-var_x83));
        const double var_x85 = 32.656617993405561 * mParameters[5];
        const double var_x86 = 3.5000000000000004 * var_x74;
        const double var_x87 = ((var_x80) ? (var_x78 * var_chaste_interface__L_type_calcium_current__O) : (var_x82 * var_chaste_interface__L_type_calcium_current__O));
        const double var_x88 = var_x18 * var_x86;
        const double var_x89 = 0.2857142857142857 * exp(-0.038580246913580245 * pow((-1 + 0.20000000000000001 * var_chaste_interface__cell__V), 2));
        const double var_x90 = 0.04926108374384236 * var_chaste_interface__cell__V;
        const double var_x91 = 0.20000000000000001 * exp(0.12315270935960591 - var_x90);
        const double var_x92 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__cell__V);
        const double var_x93 = 1 / (0.25 * var_x92 + 0.1027 * exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__cell__V));
        const double var_x94 = 3.802 * var_x93;
        const double var_x95 = 0.008539999999999999 + 2.0000000000000002e-5 * var_chaste_interface__cell__V;
        const double var_x96 = 3.802 / (0.1027 * exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__cell__V) + 0.23000000000000001 * var_x92);
        const double var_x97 = exp(-0.90909090909090906 - 0.12987012987012986 * var_chaste_interface__cell__V);
        const double var_x98 = 6.9999999999999997e-7 * var_x97;
        const double var_x99 = exp(0.36945812807881773 - var_x90);
        const double var_x100 = 0.22 * var_x99;
        const double var_x101 = 3.802 / (0.20000000000000001 * var_x92 + 0.1027 * exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__cell__V));
        const double var_x102 = -var_x101;
        const double var_x103 = 0.19170000000000001 * exp(-0.12315270935960591 - var_x90);
        const double var_x104 = var_x103 + var_x96;
        const double var_x105 = var_x101 + var_x95;
        const double var_x106 = 1 / (0.39395599999999997 + 0.188495 * exp(-0.42168674698795178 - 0.060240963855421679 * var_chaste_interface__cell__V));
        const double var_x107 = 1.0526315789473684e-5 * var_x106;
        const double var_x108 = 1.4e-8 * var_x97;
        const double var_x109 = 0.001 * var_x106;
        const double var_x110 = -var_x95;
        const double var_x111 = 1.2097272727272726e-5 * var_x106 * var_x93 * var_x97 / (var_x95 * var_x99);
        const double var_x112 = 1 * var_x106;
        const double var_x113 = 1 / var_chaste_interface__potassium_concentration__Ki;
        const double var_x114 = var_x113 * mParameters[2];
        const double var_x115 = log(var_x114);
        const double var_x116 = -26.535875647668394 * var_x115 + var_chaste_interface__cell__V;
        const double var_x117 = 0.065313235986811116 * mParameters[5];
        const double var_x118 = var_chaste_interface__non_inactivating_steady_state_K_I__aKss * mParameters[8];
        const double var_x119 = 1 / (1 * var_chaste_interface__potassium_concentration__Ki + 0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai);
        const double var_x120 = var_x119 * var_chaste_interface__rapid_delayed_rectifier_K_I__O_K * mParameters[9];
        const double var_x121 = 26.535875647668394 * var_x113;
        const double var_x122 = exp(0.089599999999999999 * var_chaste_interface__cell__V - 2.3776144580310881 * var_x115);
        const double var_x123 = 1 + var_x122;
        const double var_x124 = 1 / (210 + mParameters[2]);
        const double var_x125 = 1 / var_chaste_interface__sodium_concentration__Nai;
        const double var_x126 = pow(var_x125, 2.3999999999999999);
        const double var_x127 = var_x125 * var_x126 * mParameters[2] / ((1500 + mParameters[2]) * pow((7.44287265976699e-11 + var_x126), 2) * (1 + 0.1245 * exp(-0.0037684831406265135 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.4858841010401188e-5 * mParameters[3])) * exp(-0.037684831406265135 * var_chaste_interface__cell__V)));
        const double var_x128 = 0.022348 * exp(0.01176 * var_chaste_interface__cell__V);
        const double var_x129 = -var_x128;
        const double var_x130 = 0.033500000000000002 * exp(0.0109 * var_chaste_interface__cell__V);
        const double var_x131 = 6.8899999999999994e-5 * exp(-0.041779999999999998 * var_chaste_interface__cell__V);
        const double var_x132 = 0.0064970000000000002 * exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__cell__V);
        const double var_x133 = 0.070300000000000001 * exp(0.14349999999999999 + 0.0287 * var_chaste_interface__cell__V);
        const double var_x134 = 0.012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2) * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x135 = pow(var_chaste_interface__calcium_concentration__Cass, 3);
        const double var_x136 = 0.0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4);
        const double var_x137 = 0.0040499999999999998 * var_x135;
        const double var_x138 = 6.4598914724782277e-36 * var_x64;
        const double var_x139 = 1 / (1 * var_chaste_interface__sodium_concentration__Nai + 0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki);
        const double var_x140 = var_x139 * var_chaste_interface__fast_sodium_current__O_Na * mParameters[6];
        ...
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (var_x8 * (-0.050000000000000003 - var_x13) + 4.0000000000000003e-5 * (-var_x15 + 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR) / (pow(var_x6, 3) * pow((0.0126 + var_x7), 2))));
        ...
        rJacobian[3][3] = 1.0 - (mDt * (-0.016666666666666666 - 95.238095238095241 * var_x20));
        rJacobian[3][4] = -(mDt * (-95.238095238095241 * var_x21 + 190476190.47619048 * var_x31 * var_x35 * var_chaste_interface__calcium_concentration__Cai_converted - 190.47619047619048 * var_x22 * var_x31 * var_x33));
        ...
        rJacobian[4][4] = 1.0 - (mDt * (var_x47 * (-125 + var_x21 - var_x66 * (0.0092875564766839377 * var_x48 + 2000 * var_x60 - var_x61 * var_x65 + 191000 * var_x49 * var_chaste_interface__calcium_concentration__Cai_converted - 0.191 * var_x22 / pow((8.3232249999999994e-8 + var_x32), 2)) - 2000000 * var_x67 * var_chaste_interface__calcium_concentration__Cai_converted + 2 * var_x22 * var_x31 * var_x33) + 1.3080000000000001e-7 * (0.125 * var_chaste_interface__calcium_concentration__Cass - 125 * var_chaste_interface__calcium_concentration__Cai_converted - var_x34 * var_x67 - var_x66 * (0.00069999999999999999 * var_chaste_interface__cell__V - 0.0092875564766839377 * log(0.001 * var_x48 * mParameters[1]) + 95500 * var_x32 * var_x49 - 2 * var_x59 * var_x63) + ((var_x12) ? (3.0000000000000001e-5 * var_chaste_interface__calcium_concentration__CaNSR - 0.029999999999999999 * var_chaste_interface__calcium_concentration__Cai_converted) : (0.10000000000000001 * var_chaste_interface__calcium_concentration__CaNSR - 100 * var_chaste_interface__calcium_concentration__Cai_converted))) / (pow(var_x44, 3) * pow(var_x45, 2))));
        rJacobian[4][5] = -(mDt * (var_x47 * (0.125 - var_x34 * var_x40)));
        ...
        rJacobian[4][23] = 0.0;
        rJacobian[4][24] = 0.0;
        rJacobian[4][25] = -(mDt * (-3.2656617993405561e-5 * var_x46 * (-6 * var_x71 - var_x65 * var_x70) * mParameters[5]));
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = -(mDt * (-var_x74 * var_x84 * var_x85));
        rJacobian[5][2] = -(mDt * (var_x13 * var_x86));
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = -(mDt * (125000 * var_x74));
        rJacobian[5][5] = 1.0 - (mDt * (var_x74 * (-125 + 3.5000000000000004 * var_x16 - var_x85 * var_x87) + 0.030581039755351685 * (125000 * var_chaste_interface__calcium_concentration__Cai_converted + 3.5000000000000004 * var_x15 - 125 * var_chaste_interface__calcium_concentration__Cass - var_x85 * ((var_x80) ? (-var_x79 * var_chaste_interface__L_type_calcium_current__O) : (-var_x83 * var_chaste_interface__L_type_calcium_current__O))) / (pow(var_x72, 3) * pow((0.015290519877675841 + var_x73), 2))));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = -(mDt * (var_x17 * var_x86));
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = 0.0;
        ...
        rJacobian[5][21] = 0.0;
        rJacobian[5][22] = 0.0;
        rJacobian[5][23] = -(mDt * (var_x88));
        rJacobian[5][24] = -(mDt * (var_x88));
        rJacobian[5][25] = 0.0;
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (0.00175 * var_x27 * var_x38 + 8.7500000000000013e-5 * var_x37 * pow(var_x23, 2) / pow(var_x24, 3)));
        rJacobian[6][6] = 1.0 - (mDt * (-0.00020000000000000001 - 0.0025000000000000005 * var_x25 * var_x27 + 0.0025000000000000005 * var_x23 * var_x25 * (1 - var_x26)));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[6][25] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = -(mDt * (-var_x84 * var_x89));
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = -(mDt * (-var_x87 * var_x89));
        rJacobian[7][6] = 0.0;
        ...
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (-var_x91 - var_x94 - var_x95));
        rJacobian[8][9] = -(mDt * (var_x96));
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = -(mDt * (var_x98));
        rJacobian[8][15] = -(mDt * (var_x100));
        rJacobian[8][16] = 0.0;
        rJacobian[8][17] = 0.0;
        rJacobian[8][18] = 0.0;
        rJacobian[8][19] = 0.0;
        ...
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = -(mDt * (var_x102 + var_x91));
        rJacobian[9][9] = 1.0 - (mDt * (-var_x104 - var_x105));
        rJacobian[9][10] = -(mDt * (var_x102));
        rJacobian[9][11] = -(mDt * (var_x102));
        rJacobian[9][12] = -(mDt * (var_x102 + var_x98));
        rJacobian[9][13] = -(mDt * (var_x102));
        rJacobian[9][14] = -(mDt * (var_x102));
        rJacobian[9][15] = -(mDt * (var_x102));
        rJacobian[9][16] = 0.0;
        rJacobian[9][17] = 0.0;
        rJacobian[9][18] = 0.0;
        rJacobian[9][19] = 0.0;
        ...
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-var_x107 - var_x98));
        rJacobian[10][11] = -(mDt * (var_x108));
        rJacobian[10][12] = 0.0;
        rJacobian[10][13] = 0.0;
        rJacobian[10][14] = -(mDt * (var_x109));
        rJacobian[10][15] = 0.0;
        rJacobian[10][16] = 0.0;
        rJacobian[10][17] = 0.0;
        rJacobian[10][18] = 0.0;
        ...
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = -(mDt * (var_x107));
        rJacobian[11][11] = 1.0 - (mDt * (-var_x108));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = 0.0;
        rJacobian[11][15] = 0.0;
        ...
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = -(mDt * (var_x95));
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-var_x104 - var_x98));
        rJacobian[12][13] = -(mDt * (var_x101));
        rJacobian[12][14] = -(mDt * (var_x91));
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        rJacobian[12][17] = 0.0;
        rJacobian[12][18] = 0.0;
        ...
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = -(mDt * (var_x110));
        rJacobian[13][9] = -(mDt * (var_x110));
        rJacobian[13][10] = -(mDt * (var_x110));
        rJacobian[13][11] = -(mDt * (var_x110));
        rJacobian[13][12] = -(mDt * (var_x103 - var_x95));
        rJacobian[13][13] = 1.0 - (mDt * (-var_x105 - var_x98));
        rJacobian[13][14] = -(mDt * (var_x110));
        rJacobian[13][15] = -(mDt * (var_x110));
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        rJacobian[13][18] = 0.0;
        rJacobian[13][19] = 0.0;
        ...
        rJacobian[14][6] = 0.0;
        rJacobian[14][7] = 0.0;
        rJacobian[14][8] = -(mDt * (var_x95));
        rJacobian[14][9] = 0.0;
        rJacobian[14][10] = -(mDt * (var_x98));
        rJacobian[14][11] = 0.0;
        rJacobian[14][12] = -(mDt * (var_x96));
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-var_x109 - var_x111 - var_x91 - var_x98));
        rJacobian[14][15] = -(mDt * (var_x112));
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        rJacobian[14][19] = 0.0;
        ...
        rJacobian[15][6] = 0.0;
        rJacobian[15][7] = 0.0;
        rJacobian[15][8] = -(mDt * (var_x94));
        rJacobian[15][9] = 0.0;
        rJacobian[15][10] = 0.0;
        rJacobian[15][11] = 0.0;
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = -(mDt * (var_x111));
        rJacobian[15][15] = 1.0 - (mDt * (-var_x100 - var_x112));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[17][14] = 0.0;
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = -(mDt * (-var_x116 * var_x117 * var_x118));
        rJacobian[17][17] = 1.0 - (mDt * (var_x117 * (-26.535875647668394 * var_x120 - var_x118 * var_x121 * var_chaste_interface__non_inactivating_steady_state_K_I__iKss - var_x121 * pow(var_chaste_interface__slow_delayed_rectifier_K_I__nKs, 2) * mParameters[10] - 14.188732708808288 * var_x113 * pow(var_chaste_interface__fast_transient_outward_K_I__ato_f, 3) * var_chaste_interface__fast_transient_outward_K_I__ito_f - 6.6339689119170986 * var_x113 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__aur * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_K_I__iur - 26.535875647668394 * var_x114 * var_x124 * mParameters[7] / var_x123 + 2.3776144580310881 * var_x113 * var_x116 * var_x122 * var_x124 * mParameters[2] * mParameters[7] / pow(var_x123, 2))));
        rJacobian[17][18] = 0.0;
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = 0.0;
        rJacobian[17][21] = -(mDt * (-var_x117 * (-26.535875647668394 * log(var_x119 * (1 * mParameters[2] + 0.020408163265306124 * mParameters[3])) + var_chaste_interface__cell__V) * mParameters[9]));
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = 0.0;
        rJacobian[17][24] = 0.0;
        rJacobian[17][25] = -(mDt * (var_x117 * (8.8814310874467535e-10 * var_x127 - 0.54154848260547739 * var_x120)));
        rJacobian[18][0] = 0.0;
        rJacobian[18][1] = 0.0;
        rJacobian[18][2] = 0.0;
        rJacobian[18][3] = 0.0;
        ...
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-0.023761000000000001 - var_x128 - 0.047002000000000002 * exp(-0.063100000000000003 * var_chaste_interface__cell__V)));
        rJacobian[18][19] = -(mDt * (0.036777999999999998 - var_x128));
        rJacobian[18][20] = -(mDt * (var_x129));
        rJacobian[18][21] = -(mDt * (var_x129));
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        rJacobian[18][25] = 0.0;
        ...
        rJacobian[19][19] = 1.0 - (mDt * (-0.036777999999999998 - var_x130));
        rJacobian[19][20] = 0.0;
        rJacobian[19][21] = -(mDt * (var_x131));
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = 0.0;
        ...
        rJacobian[20][18] = 0.0;
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * (-var_x132));
        rJacobian[20][21] = -(mDt * (var_x133));
        rJacobian[20][22] = 0.0;
        rJacobian[20][23] = 0.0;
        rJacobian[20][24] = 0.0;
        rJacobian[20][25] = 0.0;
        ...
        rJacobian[21][17] = 0.0;
        rJacobian[21][18] = 0.0;
        rJacobian[21][19] = -(mDt * (var_x130));
        rJacobian[21][20] = -(mDt * (var_x132));
        rJacobian[21][21] = 1.0 - (mDt * (-var_x131 - var_x133));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        ...
        rJacobian[23][3] = 0.0;
        rJacobian[23][4] = 0.0;
        rJacobian[23][5] = -(mDt * (-var_x134 + 0.024299999999999999 * var_x135 * (1 - var_x9 - var_chaste_interface__ryanodine_receptors__P_C2)));
        rJacobian[23][6] = 0.0;
        rJacobian[23][7] = 0.0;
        rJacobian[23][8] = 0.0;
        rJacobian[23][9] = 0.0;
        ...
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (0.00080000000000000004 - var_x136));
        rJacobian[23][23] = 1.0 - (mDt * (-0.080249999999999988 - var_x136 - var_x137));
        rJacobian[23][24] = -(mDt * (0.96499999999999997 - var_x136));
        rJacobian[23][25] = 0.0;
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = 0.0;
        rJacobian[24][2] = 0.0;
        ...
        rJacobian[25][2] = 0.0;
        rJacobian[25][3] = 0.0;
        rJacobian[25][4] = -(mDt * (var_x117 * (3000 * var_x60 - var_x138 * var_x61)));
        rJacobian[25][5] = 0.0;
        rJacobian[25][6] = 0.0;
        rJacobian[25][7] = 0.0;
        rJacobian[25][8] = 0.0;
        ...
        rJacobian[25][13] = 0.0;
        rJacobian[25][14] = 0.0;
        rJacobian[25][15] = -(mDt * (-var_x117 * (-26.535875647668394 * log(var_x139 * (1 * mParameters[3] + 0.1111111111111111 * mParameters[2])) + var_chaste_interface__cell__V) * mParameters[6]));
        rJacobian[25][16] = 0.0;
        rJacobian[25][17] = -(mDt * (var_x117 * (-2.9484306275187104 * var_x140 - 0.0076659196315486469 * var_x139)));
        rJacobian[25][18] = 0.0;
        rJacobian[25][19] = 0.0;
        rJacobian[25][20] = 0.0;
        rJacobian[25][21] = 0.0;
        ...
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = 0.0;
        rJacobian[25][25] = 1.0 - (mDt * (var_x117 * (-9 * var_x71 - 0.068993276683937815 * var_x139 - 1.332214663117013e-9 * var_x127 - 26.535875647668394 * var_x140 - var_x138 * var_x70)));
    }
    ...
    void Cellli_mouse_2010FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_L_type_calcium_current__y_gate_inf = 1 / (1 + exp((33 + var_chaste_interface__cell__V) / var_L_type_calcium_current__const5)) + 0.10000000000000001 / (1 + exp(6.666666666666667 - 0.16666666666666666 * var_chaste_interface__cell__V));
        const double var_L_type_calcium_current__y_gate_tau = var_L_type_calcium_current__y_gate_tau_const2 / (1 + exp(7.5 + 0.25 * var_chaste_interface__cell__V)) + var_L_type_calcium_current__y_gate_tau_const1;
        ...
        const double var_fast_transient_outward_K_I__itof_iss = 1 / (1 + exp(10.279999999999999 + 0.20000000000000001 * var_chaste_interface__cell__V));
        ...
        const double var_slow_transient_outward_K_I__tau_ti_s = 270 + 1050 / (1 + exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__cell__V));
        const double var_ultra_rapidly_activating_delayed_rectifier_K_I__ass = 1 / (1 + exp(-0.64479166666666676 - 0.10416666666666667 * var_chaste_interface__cell__V));
        const double var_ultra_rapidly_activating_delayed_rectifier_K_I__iss = 1 / (1 + exp(7.7962962962962958 + 0.18518518518518517 * var_chaste_interface__cell__V));
        ...
        const double var_ultra_rapidly_activating_delayed_rectifier_K_I__tau_iur = 1000 / (1 + exp(7.7962962962962958 + 0.18518518518518517 * var_chaste_interface__cell__V)) + var_ultra_rapidly_activating_delayed_rectifier_K_I__tau_i_const;
        ...
        rY[32] = (var_chaste_interface__fast_transient_outward_K_I__ato_f + ((1 * var_fast_transient_outward_K_I__alpha_a) * mDt)) / (1.0 - ((-var_fast_transient_outward_K_I__alpha_a - var_fast_transient_outward_K_I__beta_a) * mDt));
        ...
        rY[31] = (var_chaste_interface__slow_delayed_rectifier_K_I__nKs + ((1 * var_slow_delayed_rectifier_K_I__alpha_n) * mDt)) / (1.0 - ((-var_slow_delayed_rectifier_K_I__alpha_n - var_slow_delayed_rectifier_K_I__beta_n) * mDt));
