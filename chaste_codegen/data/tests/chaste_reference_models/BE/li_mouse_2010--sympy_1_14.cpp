...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellli_mouse_2010FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[26], double rJacobian[26][26])
    {
        ...
        const double var_x6 = 630 + var_chaste_interface__calcium_concentration__CaJSR;
        const double var_x7 = 1 + 31500000 / pow(var_x6, 2);
        ...
        const double var_x29 = 1.7590641847756086 + var_x28;
        const double var_x30 = 1 / var_x29;
        const double var_x31 = 1.5167893800000001 * var_x30;
        const double var_x32 = 0.50590000000000002 + var_x28 * var_x31;
        const double var_x33 = pow(var_chaste_interface__calcium_concentration__Cai_converted, 2);
        const double var_x34 = 1000000 * var_x33;
        const double var_x35 = 0.16974399999999998 + var_x34;
        const double var_x36 = pow(var_x35, (-2));
        const double var_x37 = 1 / var_x35;
        const double var_x38 = pow(var_x27, 1.5830000000000002);
        const double var_x39 = pow(var_chaste_interface__calcium_concentration__Cass, (-2));
        const double var_x40 = var_x23 * var_x39 / pow(var_x24, 2);
        const double var_x41 = 0.13712534389890002 * var_x40;
        const double var_x42 = pow(var_x27, 4.1660000000000004) / pow(var_x29, 2);
        const double var_x43 = var_x37 * (-var_x41 * var_x42 + var_x30 * var_x38 * var_x41);
        const double var_x44 = 95238095.238095239 * var_x33;
        const double var_x45 = 2.5830000000000002 - 0.12915000000000001 * var_x25;
        const double var_x46 = var_x37 * (-1.5167893800000001 * var_x42 * var_x45 + var_x31 * var_x38 * var_x45);
        const double var_x47 = 1000 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x48 = 0.59999999999999998 + var_x47;
        const double var_x49 = 1 + 65.399999999999991 / pow(var_x48, 2);
        ...
        const double var_x53 = 0.083232249999999994 + var_x34;
        const double var_x54 = 1 / var_x53;
        const double var_x55 = exp(-0.024495140414072337 * var_chaste_interface__cell__V);
        const double var_x56 = pow(mParameters[3], 3);
        const double var_x57 = 1 / (1 + 0.27000000000000002 * var_x55);
        const double var_x58 = pow(var_chaste_interface__sodium_concentration__Nai, 3);
        const double var_x59 = var_x47 * var_x56;
        const double var_x60 = var_x59 + 1400 * var_x58 + 6.81472e+17 * var_chaste_interface__calcium_concentration__Cai_converted + var_x58 * mParameters[1] + 1728000000000.0 * (1 + 277.77777777777777 * var_chaste_interface__calcium_concentration__Cai_converted) * mParameters[1] + 3.6000000000000001 * var_x56 * (1 + 5.7870370370370368e-13 * var_x58);
        const double var_x61 = var_x57 * mParameters[11] / var_x60;
        const double var_x62 = var_x55 * var_x56 * var_x61;
        const double var_x63 = -6.81472e+17 - 480000000000000.0 * mParameters[1] - 1000 * var_x56;
        const double var_x64 = exp(0.013189690992192795 * var_chaste_interface__cell__V);
        const double var_x65 = -var_x55 * var_x59 + var_x58 * var_x64 * mParameters[1];
        const double var_x66 = 2 * var_x65;
        const double var_x67 = var_x57 * mParameters[11] / pow(var_x60, 2);
        const double var_x68 = var_x66 * var_x67;
        const double var_x69 = 0.032656617993405558 * mParameters[5];
        const double var_x70 = var_x32 * var_x37;
        const double var_x71 = pow(var_chaste_interface__sodium_concentration__Nai, 2);
        const double var_x72 = var_x71 * mParameters[1];
        const double var_x73 = -3 * var_x72 - 4200 * var_x71 - 6.2500000000000002e-12 * var_x56 * var_x71;
        const double var_x74 = var_x61 * var_x64 * var_x72;
        const double var_x75 = 0.59999999999999998 + var_chaste_interface__calcium_concentration__Cass;
        const double var_x76 = 1 + 65.399999999999991 / pow(var_x75, 2);
        ...
        const double var_x81 = 0.0023079445283571576 * var_x80 * var_chaste_interface__cell__V / (1 - var_x79);
        const double var_x82 = var_x81 * (-var_chaste_interface__calcium_concentration__Cass + var_x79 * mParameters[1]);
        const double var_x83 = fabs(var_x78) > 1.0000000000000001e-5;
        const double var_x84 = exp(-1.0000000000000001e-5);
        const double var_x85 = 3.062166450310111e-7 * var_x80 / (1 - var_x84);
        const double var_x86 = var_x85 * (-var_chaste_interface__calcium_concentration__Cass + var_x84 * mParameters[1]);
        ...
        const double var_x91 = var_x18 * var_x89;
        const double var_x92 = 0.2857142857142857 * exp(-0.0015432098765432098 * pow((-5 + var_chaste_interface__cell__V), 2));
        ...
        const double var_x115 = 1 * var_x109;
        ...
        const double var_x122 = 1 / (1 * var_chaste_interface__potassium_concentration__Ki + 0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai);
        const double var_x123 = var_x122 * var_chaste_interface__rapid_delayed_rectifier_K_I__O_K * mParameters[9];
        const double var_x124 = 26.535875647668394 * var_x116;
        ...
        const double var_x141 = 3 * var_x65 * var_x67;
        const double var_x142 = 1 / (1 * var_chaste_interface__sodium_concentration__Nai + 0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki);
        ...
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (var_x8 * (-0.050000000000000003 - var_x13) + 63000000 * (-var_x15 + 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaNSR - 0.050000000000000003 * var_chaste_interface__calcium_concentration__CaJSR) / (pow(var_x6, 3) * pow(var_x7, 2))));
        ...
        rJacobian[3][4] = -(mDt * (-95.238095238095241 * var_x21 + 190476190.47619048 * var_x32 * var_x37 * var_chaste_interface__calcium_concentration__Cai_converted - 190476190476190.47 * var_x22 * var_x32 * var_x36));
        rJacobian[3][5] = -(mDt * (var_x43 * var_x44));
        rJacobian[3][6] = -(mDt * (var_x44 * var_x46));
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = 0.0;
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = 0.0;
        ...
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (0.00175 * var_x27 * var_x40 + 8.7500000000000013e-5 * var_x39 * pow(var_x23, 2) / pow(var_x24, 3)));
        ...
        rJacobian[6][25] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = -(mDt * (-var_x87 * var_x92));
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = -(mDt * (-var_x90 * var_x92));
        rJacobian[7][6] = 0.0;
        ...
        rJacobian[25][2] = 0.0;
        rJacobian[25][3] = 0.0;
        rJacobian[25][4] = -(mDt * (var_x120 * (3000 * var_x62 - var_x141 * var_x63)));
        rJacobian[25][5] = 0.0;
        rJacobian[25][6] = 0.0;
        rJacobian[25][7] = 0.0;
        rJacobian[25][8] = 0.0;
        ...
        rJacobian[25][13] = 0.0;
        rJacobian[25][14] = 0.0;
        rJacobian[25][15] = -(mDt * (-var_x120 * (-26.535875647668394 * log(var_x142 * (1 * mParameters[3] + 0.1111111111111111 * mParameters[2])) + var_chaste_interface__cell__V) * mParameters[6]));
        rJacobian[25][16] = 0.0;
        rJacobian[25][17] = -(mDt * (var_x120 * (-2.9484306275187104 * var_x143 - 0.0076659196315486469 * var_x142)));
        rJacobian[25][18] = 0.0;
        rJacobian[25][19] = 0.0;
        rJacobian[25][20] = 0.0;
        rJacobian[25][21] = 0.0;
        ...
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = 0.0;
        rJacobian[25][25] = 1.0 - (mDt * (var_x120 * (-9 * var_x74 - 0.068993276683937815 * var_x142 - 26.535875647668394 * var_x143 - 240487790376.36206 * var_x130 - var_x141 * var_x73)));
    }
