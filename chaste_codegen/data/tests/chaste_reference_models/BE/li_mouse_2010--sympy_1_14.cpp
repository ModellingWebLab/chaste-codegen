...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellli_mouse_2010FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[26], double rJacobian[26][26])
    {
        ...
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = 0.0;
        rJacobian[17][21] = -(mDt * (-var_x120 * (-26.535875647668394 * log(var_x122 * (mParameters[2] + 0.020408163265306124 * mParameters[3])) + var_chaste_interface__cell__V) * mParameters[9]));
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = 0.0;
        rJacobian[17][24] = 0.0;
        ...
        rJacobian[25][13] = 0.0;
        rJacobian[25][14] = 0.0;
        rJacobian[25][15] = -(mDt * (-var_x120 * (-26.535875647668394 * log(var_x142 * (mParameters[3] + 0.1111111111111111 * mParameters[2])) + var_chaste_interface__cell__V) * mParameters[6]));
        rJacobian[25][16] = 0.0;
