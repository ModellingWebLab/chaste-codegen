...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellearm_noble_model_1990FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[10], double rJacobian[10][10])
    {
        ...
        const double var_x8 = 120.0 * var_x7;
        const double var_x9 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x0, 2);
        const double var_x10 = var_x7 * (var_x9 - var_x1);
        ...
        const double var_x17 = 1.0 * var_x13 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x18 = 1.0 * var_x14 / pow(var_x12, 3);
        ...
        const double var_x27 = -2.0 * var_x26 + var_x24 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        ...
        const double var_x45 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        const double var_x46 = 1 / (1.0 + 0.00020000000000000001 * var_x45 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x47 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x48 = var_x46 * var_x47;
        const double var_x49 = var_x44 * var_x48;
        const double var_x50 = exp(var_x43);
        const double var_x51 = 2.0 * var_x45 * var_x50 - 2744000.0 * var_x44 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x52 = var_x47 * var_x51 / pow((0.0036443148688046646 + 7.2886297376093296e-7 * var_x45 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x53 = var_x46 * var_x51 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x54 = var_x10 * var_x29;
        ...
        const double var_x57 = var_x48 * var_x50 * var_x56;
        const double var_x58 = var_x52 * var_x56;
        ...
        const double var_x68 = exp(-0.74867781645490938 + var_x25 - 2.0 * var_x67);
        ...
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = 0.0;
        rJacobian[0][5] = -(mDt * (var_x4 * (var_x10 + var_x1 * var_x8 - var_x8 * var_x9)));
        rJacobian[0][6] = 0.0;
        rJacobian[0][7] = 0.0;
        rJacobian[0][8] = 0.0;
        rJacobian[0][9] = 0.0;
        ...
        rJacobian[1][3] = 0.0;
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = -(mDt * (var_x19 * (1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac) + (var_x18 - var_x17) * var_chaste_interface__calcium_release__ActFrac));
        rJacobian[1][6] = 0.0;
        rJacobian[1][7] = 0.0;
        rJacobian[1][8] = 0.0;
        rJacobian[1][9] = 0.0;
        ...
        rJacobian[5][5] = 1.0 - (mDt * (-17.0 + var_x22 + var_x23 + 0.0030000000000000001 * var_x41 - 0.0030000000000000001 * var_x39 - 2.8102681769358871e-7 / var_chaste_interface__intracellular_calcium_concentration__Ca_i - 5.8069998209165779e-10 * var_x53 - 3.0670341725380159e-10 * var_x52 - 0.23093344215355205 * var_x49 - 5.5200000000000005e-8 * var_x42 - var_x24 * var_x31 * var_x7 - 3.1504144536796187e-6 * var_x27 * var_x28 * var_x54));
        ...
        rJacobian[9][3] = 0.0;
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = -(mDt * (9.2011025176140482e-10 * var_x52 + 0.69280032646065615 * var_x49 + 1.7420999462749735e-9 * var_x53 - var_x65 * var_x73));
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
