...
AbstractBackwardEulerCardiacCell<8>* Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::CreateMethod(boost::shared_ptr<AbstractIvpOdeSolver> p_solver, boost::shared_ptr<AbstractStimulusFunction> p_stimulus) {
    return new Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler(p_solver, p_stimulus);
}

bool Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::registered = ModelFactory::Register("dynamic_courtemanche_ramirez_nattel_1998", "BackwardEuler", (ModelFactory::TCreateMethod)Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::CreateMethod);
    ...
    double Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_sodium_potassium_pump__i_NaK = mParameters[9] * var_sodium_potassium_pump__f_NaK * var_sodium_potassium_pump__i_NaK_max * mParameters[5] / ((1 + pow((var_sodium_potassium_pump__Km_Na_i / var_chaste_interface__intracellular_ion_concentrations__Na_i), 1.5)) * (var_sodium_potassium_pump__Km_K_o + mParameters[5])); // picoA
        ...
        const double var_time_independent_potassium_current__i_K1 = (-var_time_independent_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[9] * mParameters[13] / (1 + exp(5.6000000000000005 + 0.070000000000000007 * var_chaste_interface__membrane__V)); // picoA
        ...
        const double var_ultrarapid_delayed_rectifier_K_current__g_Kur = 0.0050000000000000001 + 0.050000000000000003 / (1 + exp(1.1538461538461537 - 0.076923076923076927 * var_chaste_interface__membrane__V)); // nanoS_per_picoF
    ...
    void Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[8], double rResidual[8])
    {
        ...
        const double var_Ca_leak_current_by_the_NSR__Ca_up_max = 15; // millimolar
        const double var_Ca_release_current_from_JSR_u_gate__tau_u = 8; // millisecond
        ...
        const double var_background_currents__g_B_Na = 0.00067443750000000002; // nanoS_per_picoF
        const double var_Ca_uptake_current_by_the_NSR__i_up = mParameters[2] / (1 + var_Ca_uptake_current_by_the_NSR__K_up / var_chaste_interface__intracellular_ion_concentrations__Ca_i); // millimolar_per_millisecond
        const double var_L_type_Ca_channel_f_Ca_gate__f_Ca_infinity = 1 / (1 + 2857.1428571428573 * var_chaste_interface__intracellular_ion_concentrations__Ca_i); // dimensionless
        ...
        const double var_intracellular_ion_concentrations__B2 = 1 + var_Ca_buffers__CMDN_max * var_Ca_buffers__Km_CMDN / pow((var_Ca_buffers__Km_CMDN + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2) + var_Ca_buffers__Km_TRPN * var_Ca_buffers__TRPN_max / pow((var_Ca_buffers__Km_TRPN + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2); // dimensionless
        ...
        const double var_Ca_release_current_from_JSR_u_gate__u_infinity = 1 / (1 + exp(250 - 731528895391368 * var_Ca_release_current_from_JSR__Fn)); // dimensionless
        const double var_Ca_release_current_from_JSR_v_gate__tau_v = 1.9099999999999999 + 2.0899999999999999 / (1 + exp(250 - 731528895391368 * var_Ca_release_current_from_JSR__Fn)); // millisecond
        const double var_Ca_release_current_from_JSR_v_gate__v_infinity = 1 - 1 / (1 + exp(50 - 731528895391368 * var_Ca_release_current_from_JSR__Fn)); // dimensionless
    ...
    void Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[8], double rJacobian[8][8])
    {
        ...
        const double var_x5 = exp(-0.024332874996168673 * var_chaste_interface__membrane__V);
        const double var_x6 = pow(mParameters[6], 3);
        const double var_x7 = var_x5 * var_x6;
        const double var_x8 = exp(0.013102317305629283 * var_chaste_interface__membrane__V);
        ...
        const double var_x16 = var_x0 * var_x4 + 0.75816552477322585 * var_x14 * var_x9 - 1.8954138119330646 * var_x15 * mParameters[7] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_Ca_gate__f_Ca * var_chaste_interface__L_type_Ca_channel_f_gate__f * mParameters[9];
        const double var_x17 = exp(250 - var_x16);
        const double var_x18 = 1 + var_x17;
        const double var_x19 = var_x17 / pow(var_x18, 2);
        ...
        const double var_x23 = 8822.2384784198985 * var_x19;
        ...
        const double var_x26 = var_x25 * (-123.20189777564919 + 1.8954138119330646 * var_chaste_interface__membrane__V);
        const double var_x27 = var_x19 * var_x26;
        const double var_x28 = var_x14 * var_x7;
        const double var_x29 = var_x4 + 0.75816552477322585 * var_x28;
        const double var_x30 = var_x19 * var_x29;
        const double var_x31 = var_x8 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2) * mParameters[4];
        const double var_x32 = var_x14 * var_x31;
        const double var_x33 = 1 / var_x18;
        const double var_x34 = 1 / (1.9099999999999999 + 2.0899999999999999 * var_x33);
        const double var_x35 = exp(50 - var_x16);
        const double var_x36 = 1 + var_x35;
        const double var_x37 = var_x35 / pow(var_x36, 2);
        const double var_x38 = var_x34 * var_x37;
        const double var_x39 = (1 - 1 / var_x36 - var_chaste_interface__Ca_release_current_from_JSR_v_gate__v) / pow((0.9138755980861244 + var_x33), 2);
        const double var_x40 = var_x19 * var_x39;
        const double var_x41 = 33769.333888688605 * var_x40;
        const double var_x42 = 0.47846889952153115 * var_x39;
        const double var_x43 = 1 / mParameters[8];
        const double var_x44 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x45 = 0.00050000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x46 = pow(var_x45, (-2));
        const double var_x47 = 1 + 0.00011900000000000002 / pow(var_x44, 2) + 3.5000000000000004e-5 * var_x46;
        ...
        const double var_x51 = 1.0426301393780176e-7 * mParameters[9] / var_x45;
        const double var_x52 = 1 + 0.00092000000000000003 * var_x50;
        const double var_x53 = mParameters[2] / (pow(var_x52, 2) * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 2));
        const double var_x54 = 0.0070588235294117632 * var_x3;
        const double var_x55 = mParameters[0] * mParameters[2];
        const double var_x56 = 0.80000000000000004 + var_chaste_interface__intracellular_ion_concentrations__Ca_rel;
        const double var_x57 = pow(var_x56, (-2));
        const double var_x58 = 1 / (1 + 8 * var_x57);
        const double var_x59 = 2.0255711761517402e-5 * mParameters[9] / var_chaste_interface__intracellular_ion_concentrations__K_i;
        ...
        const double var_x63 = var_x61 * var_x62 * mParameters[5] / ((1.5 + mParameters[5]) * pow((0.031622776601683791 + var_x61), 2) * (1 + 0.1245 * exp(-0.0037435192301797956 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[6])) * exp(-0.037435192301797954 * var_chaste_interface__membrane__V)));
        
        
        rJacobian[0][0] = 1.0 - (mDt * (-0.125 + 17644.476956839797 * var_x21));
        rJacobian[0][1] = -(mDt * (var_x22 * var_x23));
        rJacobian[0][2] = -(mDt * (-0.125 * var_x27));
        rJacobian[0][3] = -(mDt * (-0.125 * var_x30));
        rJacobian[0][4] = -(mDt * (var_x23 * var_x3));
        rJacobian[0][5] = 0.0;
        rJacobian[0][6] = 0.0;
        rJacobian[0][7] = -(mDt * (0.28431207178995971 * var_x19 * var_x32));
        rJacobian[1][0] = -(mDt * (-141155.81565471838 * var_x20 * var_x38 - 67538.66777737721 * var_x21 * var_x39));
        rJacobian[1][1] = 1.0 - (mDt * (var_x34 * (-1 - 70577.907827359188 * var_x22 * var_x37) - var_x22 * var_x41));
        ...
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[1][7] = -(mDt * (-1.0882758728802286 * var_x32 * var_x40 - 2.2744965743196777 * var_x32 * var_x38));
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (-var_x43));
        rJacobian[2][3] = -(mDt * (-0.00035 * var_x43 / pow((0.00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2)));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = 0.0;
        rJacobian[3][0] = -(mDt * (0.014117647058823526 * var_x20 * var_x48));
        rJacobian[3][1] = -(mDt * (0.0070588235294117632 * var_x22 * var_x48));
        rJacobian[3][2] = -(mDt * (var_x24 * var_x49 * (2.4643985112571321e-5 - 3.7913823250109726e-7 * var_chaste_interface__membrane__V)));
        rJacobian[3][3] = 1.0 - (mDt * (var_x48 * (-var_x51 - var_x54 - 7.4682352941176462e-5 * var_x53 - 7.5827646500219453e-7 * var_x28 - 5.7273025005690459e-9 * var_x50 * mParameters[9] + 1.0426301393780176e-7 * var_x46 * var_chaste_interface__intracellular_ion_concentrations__Ca_i * mParameters[9]) + (0.00023800000000000004 / pow(var_x44, 3) + 7.0000000000000007e-5 / pow(var_x45, 3)) * (-var_x51 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 0.081176470588235281 * mParameters[2] / var_x52 - 4.2880534095874102e-10 * (-13.356415961992688 * log(var_x50 * mParameters[4]) + var_chaste_interface__membrane__V) * mParameters[9] + 0.0054117647058823529 * mParameters[0] * mParameters[2] * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 3.7913823250109726e-7 * var_x15 * var_x25 * var_chaste_interface__L_type_Ca_channel_f_Ca_gate__f_Ca + 0.0070588235294117632 * var_x0 * var_x1 * mParameters[1] * var_chaste_interface__Ca_release_current_from_JSR_v_gate__v * var_chaste_interface__Ca_release_current_from_JSR_w_gate__w + 7.5827646500219453e-7 * var_x10 * var_x11 * var_x12 * var_x9 * mParameters[16] * mParameters[9]) / pow(var_x47, 2)));
        rJacobian[3][4] = -(mDt * (var_x48 * var_x54));
        rJacobian[3][5] = -(mDt * (0.0054117647058823529 * var_x48 * var_x55));
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = -(mDt * (2.2748293950065834e-6 * var_x13 * var_x31 * var_x49));
        rJacobian[4][0] = -(mDt * (-2 * var_x20 * var_x58));
        rJacobian[4][1] = -(mDt * (-var_x22 * var_x58));
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = -(mDt * (var_x3 * var_x58));
        rJacobian[4][4] = 1.0 - (mDt * (var_x58 * (-0.0055555555555555558 - var_x3) + 0.25 * (0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_rel - var_x0 * var_x3) / (pow(var_x56, 3) * pow((0.125 + var_x57), 2))));
        rJacobian[4][5] = -(mDt * (0.0055555555555555558 * var_x58));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (0.00092000000000000003 * var_x53));
        rJacobian[5][4] = -(mDt * (0.00048309178743961351));
        rJacobian[5][5] = 1.0 - (mDt * (-0.00048309178743961351 - 0.066666666666666666 * var_x55));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
    ...
    void Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        ...
        const double var_membrane__i_st = 1000000 * var_membrane__Cm_converted * var_membrane__i_st_converted / HeartConfig::Instance()->GetCapacitance(); // picoA
        const double var_sarcolemmal_calcium_pump_current__i_CaP_max = 0.27500000000000002; // picoA_per_picoF
        const double var_sarcolemmal_calcium_pump_current__i_CaP = var_chaste_interface__intracellular_ion_concentrations__Ca_i * mParameters[9] * var_sarcolemmal_calcium_pump_current__i_CaP_max / (0.00050000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i); // picoA
        const double var_sodium_potassium_pump__Km_K_o = 1.5; // millimolar
        const double var_sodium_potassium_pump__Km_Na_i = 10; // millimolar
    ...
    void Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_Ca_release_current_from_JSR_w_gate__tau_w = 6 * (1 - exp(1.5800000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V)) / ((1 + 0.29999999999999999 * exp(1.5800000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V)) * (-7.9000000000000004 + var_chaste_interface__membrane__V));
        const double var_Ca_release_current_from_JSR_w_gate__w_infinity = 1 - 1 / (1 + exp(2.3529411764705883 - 0.058823529411764705 * var_chaste_interface__membrane__V));
        const double var_L_type_Ca_channel_d_gate__d_infinity = 1 / (1 + exp(-1.25 - 0.125 * var_chaste_interface__membrane__V));
        const double var_L_type_Ca_channel_d_gate__tau_d = 28.571428571428569 * (1 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V)) / ((1 + exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V)) * (10 + var_chaste_interface__membrane__V));
        const double var_L_type_Ca_channel_f_gate__f_infinity = exp(-4.057971014492753 - 0.14492753623188406 * var_chaste_interface__membrane__V) / (1 + exp(-4.057971014492753 - 0.14492753623188406 * var_chaste_interface__membrane__V));
        const double var_L_type_Ca_channel_f_gate__tau_f = 9 / (0.02 + 0.019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2)));
        ...
        const double var_fast_sodium_current_m_gate__alpha_m = 0.32000000000000001 * (47.130000000000003 + var_chaste_interface__membrane__V) / (1 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V));
        ...
        const double var_rapid_delayed_rectifier_K_current_xr_gate__alpha_xr = 0.00029999999999999997 * (14.1 + var_chaste_interface__membrane__V) / (1 - exp(-2.8199999999999998 - 0.20000000000000001 * var_chaste_interface__membrane__V));
        const double var_rapid_delayed_rectifier_K_current_xr_gate__beta_xr = 7.3898000000000003e-5 * (-3.3328000000000002 + var_chaste_interface__membrane__V) / (-1 + exp(-0.65046743564221166 + 0.19517145812596365 * var_chaste_interface__membrane__V));
        ...
        const double var_rapid_delayed_rectifier_K_current_xr_gate__xr_infinity = 1 / (1 + exp(-2.1692307692307691 - 0.15384615384615385 * var_chaste_interface__membrane__V));
        const double var_slow_delayed_rectifier_K_current_xs_gate__alpha_xs = 4.0000000000000003e-5 * (-19.899999999999999 + var_chaste_interface__membrane__V) / (1 - exp(1.1705882352941175 - 0.058823529411764705 * var_chaste_interface__membrane__V));
        const double var_slow_delayed_rectifier_K_current_xs_gate__beta_xs = 3.4999999999999997e-5 * (-19.899999999999999 + var_chaste_interface__membrane__V) / (-1 + exp(-2.2111111111111108 + 0.1111111111111111 * var_chaste_interface__membrane__V));
        ...
        const double var_slow_delayed_rectifier_K_current_xs_gate__xs_infinity = pow((1 + exp(1.5669291338582676 - 0.07874015748031496 * var_chaste_interface__membrane__V)), (-0.5));
        ...
        const double var_transient_outward_K_current_oa_gate__oa_infinity = 1 / (1 + exp(-1.1670467502850628 - 0.057012542759407071 * var_chaste_interface__membrane__V));
        ...
        const double var_transient_outward_K_current_oi_gate__oi_infinity = 1 / (1 + exp(8.1320754716981138 + 0.18867924528301888 * var_chaste_interface__membrane__V));
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ua_gate__ua_infinity = 1 / (1 + exp(-3.15625 - 0.10416666666666667 * var_chaste_interface__membrane__V));
        ...
        const double var_ultrarapid_delayed_rectifier_K_current_ui_gate__ui_infinity = 1 / (1 + exp(-3.6189956331877728 + 0.036390101892285295 * var_chaste_interface__membrane__V));
    ...
    std::vector<double> Dynamiccourtemanche_ramirez_nattel_1998FromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        ...
        const double var_L_type_Ca_channel__i_Ca_L = (-65 + var_chaste_interface__membrane__V) * mParameters[7] * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_Ca_gate__f_Ca * var_chaste_interface__L_type_Ca_channel_f_gate__f * mParameters[9]; // picoA
        const double var_L_type_Ca_channel__i_Ca_L_converted = 9.9999999999999995e-7 * HeartConfig::Instance()->GetCapacitance() * var_L_type_Ca_channel__i_Ca_L / var_membrane__Cm_converted; // uA_per_cm2
        const double var_L_type_Ca_channel_f_gate__tau_f = 9 / (0.02 + 0.019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2))); // millisecond
