...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rJacobian[32][32])
    {
        ...
        const double var_x42 = 1 / (1 + 18.75 * var_x41);
        ...
        const double var_x52 = 1000000 * var_x51;
        ...
        const double var_x59 = 1 + 1.19e-5 / pow(var_x58, 2);
        ...
        const double var_x68 = 1000 * var_chaste_interface__calcium_concentration__Cai_converted;
        const double var_x69 = var_x52 * var_x53;
        const double var_x70 = mParameters[4] * exp(0.013632298072467722 * var_chaste_interface__membrane__V);
        ...
        const double var_x74 = 1 / (1 + 11.899999999999999 * var_x73);
        ...
        const double var_x84 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__membrane__V);
        const double var_x85 = 1 / (0.25 * var_x84 + 0.1027 * exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__membrane__V));
        ...
        const double var_x89 = 3.802 / (0.1027 * exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V) + 0.23000000000000001 * var_x84);
        const double var_x90 = exp(-0.90909090909090906 - 0.12987012987012986 * var_chaste_interface__membrane__V);
        ...
        const double var_x94 = 3.802 / (0.20000000000000001 * var_x84 + 0.1027 * exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__membrane__V));
        ...
        const double var_x119 = var_x108 * mParameters[11] / (210 + mParameters[5]);
        const double var_x120 = 1 / var_chaste_interface__sodium_concentration__Nai;
        const double var_x121 = pow(var_x120, 1.5);
        const double var_x122 = var_x120 * var_x121 * mParameters[5] / ((1500 + mParameters[5]) * pow((3.2860264730588296e-7 + var_x121), 2) * (1 + 0.1245 * exp(-0.0038949423064193493 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.4858841010401188e-5 * mParameters[6])) * exp(-0.038949423064193495 * var_chaste_interface__membrane__V)));
        const double var_x123 = -0.022348 * exp(0.01176 * var_chaste_interface__membrane__V);
        const double var_x124 = 0.013733 * exp(0.038198000000000003 * var_chaste_interface__membrane__V);
        const double var_x125 = 6.8899999999999994e-5 * exp(-0.041779999999999998 * var_chaste_interface__membrane__V);
        const double var_x126 = 0.0064970000000000002 * exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x127 = 0.090820999999999999 * exp(0.11695499999999999 + 0.023390999999999999 * var_chaste_interface__membrane__V);
        const double var_x128 = pow(var_chaste_interface__calcium_concentration__Cass, 3);
        const double var_x129 = 0.012149999999999999 * pow(var_chaste_interface__calcium_concentration__Cass, 2) * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x130 = -0.0060749999999999997 * pow(var_chaste_interface__calcium_concentration__Cass, 4);
        ...
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = -(mDt * (2289 - var_x39));
        rJacobian[8][12] = 0.0;
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = 0.0;
        rJacobian[8][15] = 0.0;
        ...
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-0.023761000000000001 + var_x123 - 0.047002000000000002 * exp(-0.063100000000000003 * var_chaste_interface__membrane__V)));
        ...
        rJacobian[29][10] = 0.0;
        rJacobian[29][11] = 0.0;
        rJacobian[29][12] = -(mDt * (-var_x129 + 0.024299999999999999 * var_x128 * (1 + var_x43 - var_chaste_interface__ryanodine_receptors__P_C2)));
        rJacobian[29][13] = 0.0;
        rJacobian[29][14] = 0.0;
        rJacobian[29][15] = 0.0;
        rJacobian[29][16] = 0.0;
