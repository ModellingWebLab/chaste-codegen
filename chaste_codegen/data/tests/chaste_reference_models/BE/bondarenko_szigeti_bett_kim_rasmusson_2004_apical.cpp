...
#include "ChasteCpuMacros.hpp"
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEuler::VerifyStateVariables()
    {
    ...
    double Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_pump_current__Km_pCa = CHASTE_CONST(0.5); // micromolar
        const double var_calcium_pump_current__i_pCa_max = 1; // picoA_per_picoF
        ...
        const double var_calcium_background_current__E_CaN = CHASTE_CONST(0.5) * var_membrane__R * var_membrane__T * CHASTE_MATH::Log(mParameters[4] / var_calcium_concentration__Cai) / var_membrane__F; // millivolt
        ...
        const double var_calcium_activated_chloride_current__O_ClCa = CHASTE_CONST(0.20000000000000001) / (1 + CHASTE_MATH::Exp(CHASTE_CONST(5.9871794871794881) - CHASTE_CONST(0.12820512820512822) * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_sodium_potassium_pump_current__Km_Nai = 21000; // micromolar
        const double var_sodium_potassium_pump_current__i_NaK_max = CHASTE_CONST(0.88); // picoA_per_picoF
        const double var_sodium_potassium_pump_current__sigma = -CHASTE_CONST(0.14285714285714285) + CHASTE_CONST(0.14285714285714285) * CHASTE_MATH::Exp(CHASTE_CONST(1.4858841010401188e-5) * mParameters[6]); // dimensionless
        const double var_sodium_potassium_pump_current__f_NaK = 1 / (1 + CHASTE_CONST(0.1245) * CHASTE_MATH::Exp(-CHASTE_CONST(0.10000000000000001) * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + CHASTE_CONST(0.036499999999999998) * var_sodium_potassium_pump_current__sigma * CHASTE_MATH::Exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))); // dimensionless
        const double var_sodium_potassium_pump_current__i_NaK = mParameters[5] * var_sodium_potassium_pump_current__f_NaK * var_sodium_potassium_pump_current__i_NaK_max / ((1 + CHASTE_MATH::Pow((var_sodium_potassium_pump_current__Km_Nai / var_chaste_interface__sodium_concentration__Nai), CHASTE_CONST(1.5))) * (mParameters[5] + var_sodium_potassium_pump_current__Km_Ko)); // picoA_per_picoF
        ...
        const double var_ultra_rapidly_activating_delayed_rectifier_potassium_current__g_Kur = CHASTE_CONST(0.16); // milliS_per_microF
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rResidual[32])
    {
        ...
        const double var_L_type_calcium_current__E_CaL = 63; // millivolt
        const double var_L_type_calcium_current__Kpc_half = 20; // micromolar
        const double var_L_type_calcium_current__Kpc_max = CHASTE_CONST(0.23324); // per_millisecond
        const double var_L_type_calcium_current__Kpcb = CHASTE_CONST(0.00050000000000000001); // per_millisecond
        const double var_L_type_calcium_current__C1 = 1 - var_chaste_interface__L_type_calcium_current__C2 - var_chaste_interface__L_type_calcium_current__C3 - var_chaste_interface__L_type_calcium_current__C4 - var_chaste_interface__L_type_calcium_current__I1 - var_chaste_interface__L_type_calcium_current__I2 - var_chaste_interface__L_type_calcium_current__I3 - var_chaste_interface__L_type_calcium_current__O; // dimensionless
        const double var_L_type_calcium_current__i_CaL_max = 7; // picoA_per_picoF
        const double var_calcium_background_current__g_Cab = CHASTE_CONST(0.00036699999999999998); // milliS_per_microF
        const double var_calcium_buffering__HTRPN_tot = 140; // micromolar
        const double var_calcium_buffering__LTRPN_tot = 70; // micromolar
        const double var_calcium_concentration__CMDN_tot = 50; // micromolar
        const double var_calcium_concentration__CSQN_tot = 15000; // micromolar
        const double var_calcium_concentration__Cai = 1000 * var_chaste_interface__calcium_concentration__Cai_converted; // micromolar
        ...
        const double var_calcium_concentration__Km_CMDN = CHASTE_CONST(0.23799999999999999); // micromolar
        const double var_calcium_concentration__Bi = 1 / (1 + var_calcium_concentration__CMDN_tot * var_calcium_concentration__Km_CMDN / CHASTE_MATH::Pow((var_calcium_concentration__Cai + var_calcium_concentration__Km_CMDN), 2)); // dimensionless
        const double var_calcium_concentration__Bss = 1 / (1 + var_calcium_concentration__CMDN_tot * var_calcium_concentration__Km_CMDN / CHASTE_MATH::Pow((var_chaste_interface__calcium_concentration__Cass + var_calcium_concentration__Km_CMDN), 2)); // dimensionless
        const double var_calcium_concentration__Km_CSQN = 800; // micromolar
        ...
        const double var_calcium_fluxes__Km_up = CHASTE_CONST(0.5); // micromolar
        const double var_calcium_fluxes__k_minus_htrpn = CHASTE_CONST(3.1999999999999999e-5); // per_millisecond
        const double var_calcium_fluxes__k_minus_ltrpn = CHASTE_CONST(0.019599999999999999); // per_millisecond
        const double var_calcium_fluxes__k_plus_htrpn = CHASTE_CONST(0.0023700000000000001); // per_micromolar_millisecond
        ...
        const double var_calcium_fluxes__k_plus_ltrpn = CHASTE_CONST(0.0327); // per_micromolar_millisecond
        ...
        const double var_calcium_fluxes__J_up = CHASTE_MATH::Pow(var_calcium_concentration__Cai, 2) * mParameters[2] / (CHASTE_MATH::Pow(var_calcium_concentration__Cai, 2) + CHASTE_MATH::Pow(var_calcium_fluxes__Km_up, 2)); // micromolar_per_millisecond
        const double var_calcium_pump_current__Km_pCa = CHASTE_CONST(0.5); // micromolar
        const double var_calcium_pump_current__i_pCa_max = 1; // picoA_per_picoF
        const double var_calcium_pump_current__i_pCa = CHASTE_MATH::Pow(var_calcium_concentration__Cai, 2) * var_calcium_pump_current__i_pCa_max / (CHASTE_MATH::Pow(var_calcium_concentration__Cai, 2) + CHASTE_MATH::Pow(var_calcium_pump_current__Km_pCa, 2)); // picoA_per_picoF
        ...
        const double var_membrane__Acap = CHASTE_CONST(0.00015339999999999999); // cm2
        const double var_membrane__F = CHASTE_CONST(96.5); // coulomb_per_millimole
        const double var_membrane__R = CHASTE_CONST(8.3140000000000001); // joule_per_mole_kelvin
        const double var_membrane__T = 298; // kelvin
        const double var_calcium_background_current__E_CaN = CHASTE_CONST(0.5) * var_membrane__R * var_membrane__T * CHASTE_MATH::Log(mParameters[4] / var_calcium_concentration__Cai) / var_membrane__F; // millivolt
        const double var_L_type_calcium_current__Kpcf = 13 - 13 * CHASTE_MATH::Exp(-CHASTE_CONST(2.1025) * CHASTE_MATH::Pow((1 + CHASTE_CONST(0.068965517241379309) * var_chaste_interface__membrane__V), 2)); // per_millisecond
        const double var_L_type_calcium_current__alpha = CHASTE_CONST(0.40000000000000002) * (1 + CHASTE_CONST(0.69999999999999996) * CHASTE_MATH::Exp(-160 * CHASTE_MATH::Pow((1 + CHASTE_CONST(0.025000000000000001) * var_chaste_interface__membrane__V), 2)) - CHASTE_CONST(0.75) * CHASTE_MATH::Exp(-CHASTE_MATH::Pow((1 + CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane__V), 2))) * CHASTE_MATH::Exp(CHASTE_CONST(1.2) + CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane__V) / (1 + CHASTE_CONST(0.12) * CHASTE_MATH::Exp(CHASTE_CONST(1.2) + CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_L_type_calcium_current__beta = CHASTE_CONST(0.050000000000000003) * CHASTE_MATH::Exp(-CHASTE_CONST(0.92307692307692313) - CHASTE_CONST(0.076923076923076927) * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double d_dt_chaste_interface_var_L_type_calcium_current__I3 = var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__gamma - var_chaste_interface__L_type_calcium_current__I3 * var_L_type_calcium_current__Kpcb + CHASTE_CONST(0.001) * var_chaste_interface__L_type_calcium_current__I1 * var_L_type_calcium_current__Kpcf - CHASTE_CONST(0.001) * var_chaste_interface__L_type_calcium_current__I3 * var_L_type_calcium_current__alpha + var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__Kpcf * var_L_type_calcium_current__gamma - 4 * var_chaste_interface__L_type_calcium_current__I3 * var_L_type_calcium_current__Kpcb * var_L_type_calcium_current__beta; // 1 / millisecond
        const double d_dt_chaste_interface_var_L_type_calcium_current__O = var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__alpha + var_chaste_interface__L_type_calcium_current__I1 * var_L_type_calcium_current__Kpcb - var_chaste_interface__L_type_calcium_current__O * var_L_type_calcium_current__gamma + CHASTE_CONST(0.001) * var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__alpha - 4 * var_chaste_interface__L_type_calcium_current__O * var_L_type_calcium_current__beta - CHASTE_CONST(0.001) * var_L_type_calcium_current__Kpcf * var_chaste_interface__L_type_calcium_current__O; // 1 / millisecond
        const double var_L_type_calcium_current__i_CaL = (-var_L_type_calcium_current__E_CaL + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_calcium_current__O * mParameters[7]; // picoA_per_picoF
        const double d_dt_chaste_interface_var_calcium_fluxes__P_RyR = -CHASTE_CONST(0.040000000000000001) * var_chaste_interface__calcium_fluxes__P_RyR - CHASTE_CONST(0.10000000000000001) * var_L_type_calcium_current__i_CaL * CHASTE_MATH::Exp(-CHASTE_CONST(0.038580246913580245) * CHASTE_MATH::Pow((-1 + CHASTE_CONST(0.20000000000000001) * var_chaste_interface__membrane__V), 2)) / var_L_type_calcium_current__i_CaL_max; // 1 / millisecond
        const double var_calcium_background_current__i_Cab = (-var_calcium_background_current__E_CaN + var_chaste_interface__membrane__V) * var_calcium_background_current__g_Cab; // picoA_per_picoF
        ...
        const double var_fast_sodium_current__alpha_Na3 = CHASTE_CONST(6.9999999999999997e-7) * CHASTE_MATH::Exp(-CHASTE_CONST(0.90909090909090906) - CHASTE_CONST(0.12987012987012986) * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double var_fast_sodium_current__beta_Na11 = CHASTE_CONST(0.19170000000000001) * CHASTE_MATH::Exp(-CHASTE_CONST(0.12315270935960591) - CHASTE_CONST(0.04926108374384236) * var_chaste_interface__membrane__V); // per_millisecond
        const double var_fast_sodium_current__beta_Na12 = CHASTE_CONST(0.20000000000000001) * CHASTE_MATH::Exp(CHASTE_CONST(0.12315270935960591) - CHASTE_CONST(0.04926108374384236) * var_chaste_interface__membrane__V); // per_millisecond
        const double var_fast_sodium_current__beta_Na13 = CHASTE_CONST(0.22) * CHASTE_MATH::Exp(CHASTE_CONST(0.36945812807881773) - CHASTE_CONST(0.04926108374384236) * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double var_membrane__VJSR = CHASTE_CONST(1.1999999999999999e-7); // microlitre
        const double var_membrane__VNSR = CHASTE_CONST(2.0980000000000001e-6); // microlitre
        const double var_membrane__Vmyo = CHASTE_CONST(2.584e-5); // microlitre
        ...
        const double var_membrane__Vss = CHASTE_CONST(1.4849999999999999e-9); // microlitre
        const double var_fast_transient_outward_potassium_current__E_K = var_membrane__R * var_membrane__T * CHASTE_MATH::Log(mParameters[5] / var_chaste_interface__potassium_concentration__Ki) / var_membrane__F; // millivolt
        const double var_fast_transient_outward_potassium_current__i_Kto_f = CHASTE_MATH::Pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 3) * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[16] * var_chaste_interface__fast_transient_outward_potassium_current__ito_f; // picoA_per_picoF
        const double var_non_inactivating_steady_state_potassium_current__i_Kss = (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss * mParameters[12] * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss; // picoA_per_picoF
        ...
        const double var_rapid_delayed_rectifier_potassium_current__alpha_a0 = CHASTE_CONST(0.022348) * CHASTE_MATH::Exp(CHASTE_CONST(0.01176) * var_chaste_interface__membrane__V); // per_millisecond
        const double var_rapid_delayed_rectifier_potassium_current__alpha_a1 = CHASTE_CONST(0.013733) * CHASTE_MATH::Exp(CHASTE_CONST(0.038198000000000003) * var_chaste_interface__membrane__V); // per_millisecond
        const double var_rapid_delayed_rectifier_potassium_current__alpha_i = CHASTE_CONST(0.090820999999999999) * CHASTE_MATH::Exp(CHASTE_CONST(0.11695499999999999) + CHASTE_CONST(0.023390999999999999) * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double var_rapid_delayed_rectifier_potassium_current__beta_a1 = CHASTE_CONST(6.8899999999999994e-5) * CHASTE_MATH::Exp(-CHASTE_CONST(0.041779999999999998) * var_chaste_interface__membrane__V); // per_millisecond
        const double var_rapid_delayed_rectifier_potassium_current__beta_i = CHASTE_CONST(0.0064970000000000002) * CHASTE_MATH::Exp(-CHASTE_CONST(0.16339999999999999) - CHASTE_CONST(0.032680000000000001) * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double var_rapid_delayed_rectifier_potassium_current__kb = CHASTE_CONST(0.036777999999999998); // per_millisecond
        const double var_rapid_delayed_rectifier_potassium_current__kf = CHASTE_CONST(0.023761000000000001); // per_millisecond
        ...
        const double d_dt_chaste_interface_var_calcium_concentration__Cass = (var_calcium_fluxes__J_rel * var_membrane__VJSR / var_membrane__Vss - var_calcium_fluxes__J_xfer * var_membrane__Vmyo / var_membrane__Vss - CHASTE_CONST(0.5) * var_L_type_calcium_current__i_CaL * var_membrane__Acap * mParameters[8] / (var_membrane__F * var_membrane__Vss)) * var_calcium_concentration__Bss; // micromolar / millisecond
        ...
        const double var_sodium_background_current__i_Nab = (-var_fast_sodium_current__E_Na + var_chaste_interface__membrane__V) * var_sodium_background_current__g_Nab; // picoA_per_picoF
        const double var_sodium_calcium_exchange_current__i_NaCa = (CHASTE_MATH::Pow(var_chaste_interface__sodium_concentration__Nai, 3) * mParameters[4] * CHASTE_MATH::Exp(var_membrane__F * var_chaste_interface__membrane__V * var_sodium_calcium_exchange_current__eta / (var_membrane__R * var_membrane__T)) - CHASTE_MATH::Pow(mParameters[6], 3) * var_calcium_concentration__Cai * CHASTE_MATH::Exp((-1 + var_sodium_calcium_exchange_current__eta) * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * mParameters[15] / ((1 + var_sodium_calcium_exchange_current__k_sat * CHASTE_MATH::Exp((-1 + var_sodium_calcium_exchange_current__eta) * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * (CHASTE_MATH::Pow(mParameters[6], 3) + CHASTE_MATH::Pow(var_sodium_calcium_exchange_current__K_mNa, 3)) * (mParameters[4] + var_sodium_calcium_exchange_current__K_mCa)); // picoA_per_picoF
        const double var_calcium_concentration__Cai_orig_deriv = (-var_calcium_fluxes__J_trpn - var_calcium_fluxes__J_up - CHASTE_CONST(0.5) * (-2 * var_sodium_calcium_exchange_current__i_NaCa + var_calcium_background_current__i_Cab + var_calcium_pump_current__i_pCa) * var_membrane__Acap * mParameters[8] / (var_membrane__F * var_membrane__Vmyo) + var_calcium_fluxes__J_leak + var_calcium_fluxes__J_xfer) * var_calcium_concentration__Bi; // micromolar / millisecond
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rJacobian[32][32])
    {
        ...
        const double var_x0 = CHASTE_MATH::Exp(-CHASTE_CONST(0.92307692307692313) - CHASTE_CONST(0.076923076923076927) * var_chaste_interface__membrane__V);
        const double var_x1 = CHASTE_MATH::Exp(CHASTE_CONST(1.2) + CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane__V);
        const double var_x2 = var_x1 * (1 + CHASTE_CONST(0.69999999999999996) * CHASTE_MATH::Exp(-160 * CHASTE_MATH::Pow((1 + CHASTE_CONST(0.025000000000000001) * var_chaste_interface__membrane__V), 2)) - CHASTE_CONST(0.75) * CHASTE_MATH::Exp(-CHASTE_MATH::Pow((1 + CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane__V), 2))) / (1 + CHASTE_CONST(0.12) * var_x1);
        ...
        const double var_x7 = CHASTE_MATH::Exp(-CHASTE_CONST(2.1025) * CHASTE_MATH::Pow((1 + CHASTE_CONST(0.068965517241379309) * var_chaste_interface__membrane__V), 2));
        ...
        const double var_x59 = CHASTE_MATH::Exp(-CHASTE_CONST(0.025317124991725771) * var_chaste_interface__membrane__V);
        ...
        const double var_x66 = CHASTE_MATH::Exp(CHASTE_CONST(0.013632298072467722) * var_chaste_interface__membrane__V);
        ...
        const double var_x78 = CHASTE_MATH::Exp(-CHASTE_CONST(0.016666666666666666) - CHASTE_CONST(0.0066666666666666671) * var_chaste_interface__membrane__V);
        const double var_x79 = 1 / (CHASTE_CONST(0.25) * var_x78 + CHASTE_CONST(0.1027) * CHASTE_MATH::Exp(-CHASTE_CONST(0.20833333333333334) - CHASTE_CONST(0.083333333333333329) * var_chaste_interface__membrane__V));
        ...
        const double var_x82 = CHASTE_CONST(3.802) / (CHASTE_CONST(0.1027) * CHASTE_MATH::Exp(-CHASTE_CONST(0.16666666666666666) - CHASTE_CONST(0.066666666666666666) * var_chaste_interface__membrane__V) + CHASTE_CONST(0.23000000000000001) * var_x78);
        const double var_x83 = CHASTE_MATH::Exp(-CHASTE_CONST(0.90909090909090906) - CHASTE_CONST(0.12987012987012986) * var_chaste_interface__membrane__V);
        ...
        const double var_x87 = CHASTE_CONST(3.802) / (CHASTE_CONST(0.20000000000000001) * var_x78 + CHASTE_CONST(0.1027) * CHASTE_MATH::Exp(-CHASTE_CONST(0.14705882352941177) - CHASTE_CONST(0.058823529411764705) * var_chaste_interface__membrane__V));
        ...
        const double var_x114 = var_x112 * var_x113 * mParameters[5] / ((1500 + mParameters[5]) * CHASTE_MATH::Pow((CHASTE_CONST(3.2860264730588296e-7) + var_x113), 2) * (1 + CHASTE_CONST(0.1245) * CHASTE_MATH::Exp(-CHASTE_CONST(0.0038949423064193493) * var_chaste_interface__membrane__V) + CHASTE_CONST(0.036499999999999998) * (-CHASTE_CONST(0.14285714285714285) + CHASTE_CONST(0.14285714285714285) * CHASTE_MATH::Exp(CHASTE_CONST(1.4858841010401188e-5) * mParameters[6])) * CHASTE_MATH::Exp(-CHASTE_CONST(0.038949423064193495) * var_chaste_interface__membrane__V)));
        const double var_x115 = CHASTE_CONST(0.022348) * CHASTE_MATH::Exp(CHASTE_CONST(0.01176) * var_chaste_interface__membrane__V);
        const double var_x116 = -var_x115;
        const double var_x117 = CHASTE_CONST(0.013733) * CHASTE_MATH::Exp(CHASTE_CONST(0.038198000000000003) * var_chaste_interface__membrane__V);
        const double var_x118 = CHASTE_CONST(6.8899999999999994e-5) * CHASTE_MATH::Exp(-CHASTE_CONST(0.041779999999999998) * var_chaste_interface__membrane__V);
        const double var_x119 = CHASTE_CONST(0.0064970000000000002) * CHASTE_MATH::Exp(-CHASTE_CONST(0.16339999999999999) - CHASTE_CONST(0.032680000000000001) * var_chaste_interface__membrane__V);
        const double var_x120 = CHASTE_CONST(0.090820999999999999) * CHASTE_MATH::Exp(CHASTE_CONST(0.11695499999999999) + CHASTE_CONST(0.023390999999999999) * var_chaste_interface__membrane__V);
        ...
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = -(mDt * ((CHASTE_CONST(0.90000000000000002) - CHASTE_CONST(0.014285714285714287) * var_chaste_interface__membrane__V) * mParameters[7] * CHASTE_MATH::Exp(-CHASTE_CONST(0.038580246913580245) * CHASTE_MATH::Pow((-1 + CHASTE_CONST(0.20000000000000001) * var_chaste_interface__membrane__V), 2))));
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = 0.0;
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = 0.0;
        ...
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-CHASTE_CONST(0.023761000000000001) - var_x115 - CHASTE_CONST(0.047002000000000002) * CHASTE_MATH::Exp(-CHASTE_CONST(0.063100000000000003) * var_chaste_interface__membrane__V)));
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        ...
        const double var_membrane__i_stim = var_membrane__i_stim_converted / CHASTE_CAP(); // picoA_per_picoF
        const double var_fast_transient_outward_potassium_current__E_K = var_membrane__R * var_membrane__T * CHASTE_MATH::Log(mParameters[5] / var_chaste_interface__potassium_concentration__Ki) / var_membrane__F; // millivolt
        const double var_fast_transient_outward_potassium_current__i_Kto_f = CHASTE_MATH::Pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 3) * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[16] * var_chaste_interface__fast_transient_outward_potassium_current__ito_f; // picoA_per_picoF
        const double var_non_inactivating_steady_state_potassium_current__i_Kss = (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss * mParameters[12] * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss; // picoA_per_picoF
        const double var_slow_delayed_rectifier_potassium_current__i_Ks = CHASTE_MATH::Pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 2) * (-var_fast_transient_outward_potassium_current__E_K + var_chaste_interface__membrane__V) * mParameters[14]; // picoA_per_picoF
    ...
    void Cellbondarenko_szigeti_bett_kim_rasmusson_2004_apicalFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_fast_transient_outward_potassium_current__alpha_a = CHASTE_CONST(0.18064) * CHASTE_MATH::Exp(CHASTE_CONST(1.0731000000000002) + CHASTE_CONST(0.035770000000000003) * var_chaste_interface__membrane__V);
        ...
        const double var_fast_transient_outward_potassium_current__beta_a = CHASTE_CONST(0.39560000000000001) * CHASTE_MATH::Exp(-CHASTE_CONST(1.8711) - CHASTE_CONST(0.062370000000000002) * var_chaste_interface__membrane__V);
        const double var_fast_transient_outward_potassium_current__beta_i = CHASTE_CONST(0.00095) * CHASTE_MATH::Exp(CHASTE_CONST(4.7857142857142856) + CHASTE_CONST(0.14285714285714285) * var_chaste_interface__membrane__V) / (1 + CHASTE_CONST(0.051334999999999999) * CHASTE_MATH::Exp(CHASTE_CONST(4.7857142857142856) + CHASTE_CONST(0.14285714285714285) * var_chaste_interface__membrane__V));
        const double var_non_inactivating_steady_state_potassium_current__tau_Kss = CHASTE_CONST(13.17) + CHASTE_CONST(39.299999999999997) * CHASTE_MATH::Exp(-CHASTE_CONST(0.086199999999999999) * var_chaste_interface__membrane__V);
        ...
        const double var_slow_delayed_rectifier_potassium_current__beta_n = CHASTE_CONST(9.5333299999999997e-5) * CHASTE_MATH::Exp(-CHASTE_CONST(1.0069999999999999) - CHASTE_CONST(0.037999999999999999) * var_chaste_interface__membrane__V);
        const double var_slow_transient_outward_potassium_current__ass = 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(2.9220779220779218) - CHASTE_CONST(0.12987012987012986) * var_chaste_interface__membrane__V));
        const double var_slow_transient_outward_potassium_current__iss = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(7.9298245614035094) + CHASTE_CONST(0.17543859649122806) * var_chaste_interface__membrane__V));
        const double var_slow_transient_outward_potassium_current__tau_ta_s = CHASTE_CONST(2.0579999999999998) + CHASTE_CONST(0.49299999999999999) * CHASTE_MATH::Exp(-CHASTE_CONST(0.062899999999999998) * var_chaste_interface__membrane__V);
        const double var_slow_transient_outward_potassium_current__tau_ti_s = 270 + 1050 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(7.9298245614035094) + CHASTE_CONST(0.17543859649122806) * var_chaste_interface__membrane__V));
        const double var_ultra_rapidly_activating_delayed_rectifier_potassium_current__tau_aur = CHASTE_CONST(2.0579999999999998) + CHASTE_CONST(0.49299999999999999) * CHASTE_MATH::Exp(-CHASTE_CONST(0.062899999999999998) * var_chaste_interface__membrane__V);
        const double var_ultra_rapidly_activating_delayed_rectifier_potassium_current__tau_iur = 1200 - 170 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(7.9298245614035094) + CHASTE_CONST(0.17543859649122806) * var_chaste_interface__membrane__V));
