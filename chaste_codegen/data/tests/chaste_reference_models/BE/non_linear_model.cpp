...
#include "CardiacNewtonSolver.hpp"
    ...
    Cellnon_linear_modelFromCellMLBackwardEuler::Cellnon_linear_modelFromCellMLBackwardEuler(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractBackwardEulerCardiacCell<66>(
                67,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Cellnon_linear_modelFromCellMLBackwardEuler>::Instance();
        Init();
        
    }

    Cellnon_linear_modelFromCellMLBackwardEuler::~Cellnon_linear_modelFromCellMLBackwardEuler()
    {
    }
    
    double Cellnon_linear_modelFromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellnon_linear_modelFromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[66], double rResidual[66])
    {
        ...
        double var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa = rCurrentGuess[37];
        double var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C1_RyR = rCurrentGuess[38];
        double var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C2_RyR = rCurrentGuess[39];
        double var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR = rCurrentGuess[40];
        double var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O2_RyR = rCurrentGuess[41];
        double var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa = rCurrentGuess[42];
        double var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa = rCurrentGuess[43];
        double var_chaste_interface__IKr__C1Herg = rCurrentGuess[44];
        double var_chaste_interface__IKr__C2Herg = rCurrentGuess[45];
        double var_chaste_interface__IKr__C3Herg = rCurrentGuess[46];
        double var_chaste_interface__IKr__IHerg = rCurrentGuess[47];
        double var_chaste_interface__IKr__OHerg = rCurrentGuess[48];
        double var_chaste_interface__IKs__C0ks = rCurrentGuess[49];
        double var_chaste_interface__IKs__C1ks = rCurrentGuess[50];
        double var_chaste_interface__IKs__O1ks = rCurrentGuess[51];
        double var_chaste_interface__IKs__O2ks = rCurrentGuess[52];
        double var_chaste_interface__INa__na1 = rCurrentGuess[53];
        double var_chaste_interface__INa__na10 = rCurrentGuess[54];
        double var_chaste_interface__INa__na11 = rCurrentGuess[55];
        double var_chaste_interface__INa__na12 = rCurrentGuess[56];
        double var_chaste_interface__INa__na13 = rCurrentGuess[57];
        double var_chaste_interface__INa__na2 = rCurrentGuess[58];
        double var_chaste_interface__INa__na3 = rCurrentGuess[59];
        double var_chaste_interface__INa__na4 = rCurrentGuess[60];
        double var_chaste_interface__INa__na5 = rCurrentGuess[61];
        double var_chaste_interface__INa__na6 = rCurrentGuess[62];
        double var_chaste_interface__INa__na7 = rCurrentGuess[63];
        double var_chaste_interface__INa__na8 = rCurrentGuess[64];
        double var_chaste_interface__INa__na9 = rCurrentGuess[65];
        ...
        const double d_dt_chaste_interface_var_COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa = (-var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa + var_COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa_inf) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa / var_COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__tau_yCa; // 1 / ms
        ...
        rResidual[43] = rCurrentGuess[43] - rY[7] - mDt*d_dt_chaste_interface_var_COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa;
        rResidual[42] = rCurrentGuess[42] - rY[8] - mDt*d_dt_chaste_interface_var_COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa;
        rResidual[38] = rCurrentGuess[38] - rY[9] - mDt*d_dt_chaste_interface_var_COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C1_RyR;
        rResidual[41] = rCurrentGuess[41] - rY[10] - mDt*d_dt_chaste_interface_var_COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O2_RyR;
        rResidual[39] = rCurrentGuess[39] - rY[11] - mDt*d_dt_chaste_interface_var_COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C2_RyR;
        rResidual[40] = rCurrentGuess[40] - rY[12] - mDt*d_dt_chaste_interface_var_COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR;
        ...
        rResidual[37] = rCurrentGuess[37] - rY[24] - mDt*d_dt_chaste_interface_var_COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa;
        ...
        rResidual[53] = rCurrentGuess[53] - rY[45] - mDt*d_dt_chaste_interface_var_INa__na1;
        rResidual[58] = rCurrentGuess[58] - rY[46] - mDt*d_dt_chaste_interface_var_INa__na2;
        rResidual[59] = rCurrentGuess[59] - rY[47] - mDt*d_dt_chaste_interface_var_INa__na3;
        rResidual[60] = rCurrentGuess[60] - rY[48] - mDt*d_dt_chaste_interface_var_INa__na4;
        rResidual[61] = rCurrentGuess[61] - rY[49] - mDt*d_dt_chaste_interface_var_INa__na5;
        rResidual[62] = rCurrentGuess[62] - rY[50] - mDt*d_dt_chaste_interface_var_INa__na6;
        rResidual[63] = rCurrentGuess[63] - rY[51] - mDt*d_dt_chaste_interface_var_INa__na7;
        rResidual[64] = rCurrentGuess[64] - rY[52] - mDt*d_dt_chaste_interface_var_INa__na8;
        rResidual[65] = rCurrentGuess[65] - rY[53] - mDt*d_dt_chaste_interface_var_INa__na9;
        rResidual[54] = rCurrentGuess[54] - rY[54] - mDt*d_dt_chaste_interface_var_INa__na10;
        rResidual[55] = rCurrentGuess[55] - rY[55] - mDt*d_dt_chaste_interface_var_INa__na11;
        rResidual[56] = rCurrentGuess[56] - rY[56] - mDt*d_dt_chaste_interface_var_INa__na12;
        rResidual[57] = rCurrentGuess[57] - rY[57] - mDt*d_dt_chaste_interface_var_INa__na13;
        rResidual[44] = rCurrentGuess[44] - rY[58] - mDt*d_dt_chaste_interface_var_IKr__C1Herg;
        rResidual[45] = rCurrentGuess[45] - rY[59] - mDt*d_dt_chaste_interface_var_IKr__C2Herg;
        rResidual[46] = rCurrentGuess[46] - rY[60] - mDt*d_dt_chaste_interface_var_IKr__C3Herg;
        rResidual[48] = rCurrentGuess[48] - rY[61] - mDt*d_dt_chaste_interface_var_IKr__OHerg;
        rResidual[47] = rCurrentGuess[47] - rY[62] - mDt*d_dt_chaste_interface_var_IKr__IHerg;
        rResidual[49] = rCurrentGuess[49] - rY[63] - mDt*d_dt_chaste_interface_var_IKs__C0ks;
        rResidual[50] = rCurrentGuess[50] - rY[64] - mDt*d_dt_chaste_interface_var_IKs__C1ks;
        rResidual[51] = rCurrentGuess[51] - rY[65] - mDt*d_dt_chaste_interface_var_IKs__O1ks;
        rResidual[52] = rCurrentGuess[52] - rY[66] - mDt*d_dt_chaste_interface_var_IKs__O2ks;
    }

    void Cellnon_linear_modelFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[66], double rJacobian[66][66])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: mV; Initial value: -86.7261544519706
        ...
        const double var_x27 = var_x21 * (240.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR - 240.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS);
        const double var_x28 = 0.0023800000000000002 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x29 = 1.0 + 0.00011900000000000002 / pow(var_x28, 2);
        const double var_x30 = 1 / var_x29;
        const double var_x31 = 1.0 * var_x30;
        const double var_x32 = 0.00050000000000000001 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x33 = 1.5379617895699322e-6 / var_x32;
        const double var_x34 = 1 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x35 = exp(-0.024334180358078095 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x36 = 1 / (1.0 + 0.20000000000000001 * var_x35);
        const double var_x37 = var_x35 * var_x36;
        const double var_x38 = exp(0.013103020192811281 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x39 = 2.8000000000000003 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x40 = var_x36 * var_x38 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai, 2);
        ...
        const double var_x43 = 7.1159095070575419e-7 * var_x22 * var_x41 * var_x42;
        const double var_x44 = 1 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki;
        const double var_x45 = log(4.0 * var_x44);
        const double var_x46 = exp(0.047170872694120618 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V - 1.26 * var_x45);
        const double var_x47 = 0.93999999999999995 + var_x46;
        const double var_x48 = 9.2470395326765519e-9 * var_x42;
        const double var_x49 = var_x41 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
        const double var_x50 = -var_x48 * var_x49 - 0.00012738562343605624 * var_x44 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - 3.0564346548418563e-5 * var_x44 * var_chaste_interface__IKr__OHerg - 5.7513555333045694e-6 * var_x44 * (var_chaste_interface__IKs__O1ks + var_chaste_interface__IKs__O2ks) - 0.00041181390311704764 * var_x44 / var_x47 + 1.9425621197603174e-5 * var_x44 * var_x46 * (-26.71139896373057 * var_x45 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) / pow(var_x47, 2);
        const double var_x51 = 24.975247492871414 * var_x24 >= 0.0;
        const double var_x52 = 1 / (1.0 - 94.246216954231741 * var_x24);
        ...
        const double var_x55 = var_x53 * var_x54 / (pow((0.011180339887498949 + var_x54), 2) * (1.0 + 0.1245 * exp(-0.003743720055088938 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0505200594353643)) * exp(-0.049791476732682874 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V)));
        const double var_x56 = -4.0 + var_x41 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki;
        const double var_x57 = 7.1159095070575419e-7 * var_x42 * var_x56;
        const double var_x58 = var_x57 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa;
        const double var_x59 = var_x57 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open;
        const double var_x60 = 5.7513555333045694e-6 * var_x45 - 2.1531465053979051e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x61 = 1.8494079065353104e-10 * var_x42;
        const double var_x62 = 0.092547526753060952 * log(138.0 * var_x53) - 0.0034647203195431429 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x63 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x64 = 7.3600965821599997 * var_x63;
        const double var_x65 = exp(-0.077933781739999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x66 = 0.010817483399999999 * var_x65;
        const double var_x67 = 5.5200724366199996 * var_x63;
        const double var_x68 = 0.021634966799999999 * var_x65;
        const double var_x69 = 3.6800482910799999 * var_x63;
        const double var_x70 = 0.032452450199999996 * var_x65;
        const double var_x71 = 1.8400241455399999 * var_x63;
        const double var_x72 = 0.043269933599999998 * var_x65;
        const double var_x73 = 7.4298590445392074 * var_x63;
        const double var_x74 = 0.020618446856331008 * var_x65;
        const double var_x75 = 6.4033407827395079 * var_x63;
        const double var_x76 = 0.00064791916666788224 * var_x65;
        const double var_x77 = 2.0082338973371909 * var_x63;
        const double var_x78 = 0.00060572898292340319 * var_x65;
        const double var_x79 = 6.1053726595326019 * var_x63;
        const double var_x80 = 0.00074179401705723534 * var_x65;
        const double var_x81 = exp(0.028982999999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x82 = 2.1748319999999999 * var_x81;
        const double var_x83 = exp(5.3739999999999997e-8 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x84 = 0.00081948199999999996 * var_x83;
        const double var_x85 = exp(-0.046843700000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x86 = 0.080185000000000006 * var_x85;
        const double var_x87 = exp(-0.00037301599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x88 = 0.049842400000000002 * var_x87;
        const double var_x89 = 1.6311239999999998 * var_x81;
        const double var_x90 = 0.0015517711151999999 * var_x83;
        const double var_x91 = 0.16037000000000001 * var_x85;
        const double var_x92 = 0.0073584627104531205 * var_x87;
        const double var_x93 = 1.0874159999999999 * var_x81;
        const double var_x94 = 0.011656842546537791 * var_x83;
        const double var_x95 = 0.24055500000000002 * var_x85;
        const double var_x96 = 0.0031906751727717496 * var_x87;
        const double var_x97 = 0.54370799999999997 * var_x81;
        const double var_x98 = 0.12994884875097448 * var_x83;
        const double var_x99 = 0.0017334521172801731 * var_x87;
        const double var_x100 = 0.32074000000000003 * var_x85;
        const double var_x101 = 14.731181055359999 * var_x81;
        const double var_x102 = 0.042345268272074361 * var_x85;
        const double var_x103 = 3.7617634137599998 * var_x81;
        const double var_x104 = 0.021348622729620501 * var_x85;
        const double var_x105 = 2.0015500855706554 * var_x81;
        const double var_x106 = 0.021578581001175438 * var_x85;
        const double var_x107 = 9.9194413744637924 * var_x81;
        const double var_x108 = 0.35582999726621212 * var_x85;
        const double var_x109 = 9.5014602960251466e-5 * var_x87;
        const double var_x110 = 0.11713400800552819 * var_x83;
        const double var_x111 = 0.055397999999999996 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C0;
        const double var_x112 = 0.055397999999999996 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x113 = exp(-0.41999999999999998 + 0.012 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x114 = 7.9871999999999996 * var_x113;
        const double var_x115 = -var_x114;
        const double var_x116 = exp(1.4300000000000002 - 0.065000000000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x117 = 0.088200000000000001 * var_x116;
        const double var_x118 = 0.11079599999999999 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1;
        const double var_x119 = 5.9903999999999993 * var_x113;
        const double var_x120 = 0.11079599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x121 = -var_x117;
        const double var_x122 = 0.1764 * var_x116;
        const double var_x123 = 0.22159199999999998 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2;
        const double var_x124 = 0.22159199999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x125 = -var_x122;
        const double var_x126 = 3.9935999999999998 * var_x113;
        const double var_x127 = -var_x126;
        const double var_x128 = 0.2646 * var_x116;
        const double var_x129 = 0.44318399999999997 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        const double var_x130 = 0.44318399999999997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x131 = 1.9967999999999999 * var_x113;
        const double var_x132 = 0.3528 * var_x116;
        const double var_x133 = 0.88636799999999993 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C4;
        const double var_x134 = 0.88636799999999993 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x135 = 15.974399999999999 * var_x113;
        const double var_x136 = 0.0441 * var_x116;
        const double var_x137 = 11.980799999999999 * var_x113;
        const double var_x138 = 0.1323 * var_x116;
        const double var_x139 = 0.0033633620945199998 / (0.5 + exp(-0.18053804430634462 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V));
        const double var_x140 = 0.0077904657073700001 * exp(-0.02019777813343069 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x141 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 4.0);
        const double var_x142 = 1 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR;
        const double var_x143 = pow(var_x142, 2.5);
        const double var_x144 = 1.0 + 1.0 * var_x143;
        const double var_x145 = var_x142 * var_x143 / pow(var_x144, 2);
        const double var_x146 = 136687500000.0 * var_x141 * var_x145 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C1_RyR;
        const double var_x147 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 3.0);
        const double var_x148 = 1 / var_x144;
        const double var_x149 = 0.5 + 4.5 * var_x148;
        const double var_x150 = 48600000000.0 * var_x147 * var_x149 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C1_RyR;
        const double var_x151 = 12150000000.0 * var_x141 * var_x149;
        const double var_x152 = 0.0090000000000000011 * var_x145 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C2_RyR;
        const double var_x153 = 0.055555555555555559 * var_x145 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR / pow((0.1111111111111111 + var_x148), 2);
        const double var_x154 = 0.0036000000000000003 * var_x148;
        const double var_x155 = 0.10000000000000001 / var_x149;
        ...
        const double var_x157 = 4050000.0 * var_x147;
        const double var_x158 = 0.091225454037165171 * exp(0.033046080388350003 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x159 = 0.21116826991639448 * exp(-0.043060541639799998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x160 = exp(0.026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x161 = 0.10945626585855089 * var_x160;
        const double var_x162 = exp(6.9808923999999997e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x163 = 0.00042769471831999382 * var_x162;
        const double var_x164 = exp(0.0056890885971700002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x165 = exp(-0.045366429595429997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x166 = exp(-0.026913854983990002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x167 = 1.6926962184371784e-6 * var_x162 * var_x165 * var_x166 / (var_x160 * var_x164);
        const double var_x168 = 0.0071483033566472664 * var_x166;
        const double var_x169 = 0.034388156021070745 * var_x165;
        const double var_x170 = 0.56744803744318484 * var_x164;
        const double var_x171 = 0.21625575895849999 * exp(-1.8891230210000001e-5 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x172 = 0.0070080662892900002 * exp(-0.14999754700285001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x173 = 0.00767254363063 * exp(0.08662945914655 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x174 = 0.0037973799836799999 * exp(-0.014256681268810001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x175 = exp(-23.156677820503301);
        const double var_x176 = 8513540195.0827656 * var_x175;
        const double var_x177 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x178 = 34054160780.331062 * var_x177;
        const double var_x179 = exp(-26.232056238852348 - 0.090161609404259865 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x180 = 8513540195.0827656 * var_x179;
        const double var_x181 = exp(-24.35183300086069);
        const double var_x182 = 8513540195.0827656 * var_x181;
        const double var_x183 = 4340999166.2352047 * var_x181;
        const double var_x184 = 23845170420.535503 * var_x177;
        const double var_x185 = 12158498408.695736 * var_x179;
        const double var_x186 = 18237747613.043602 * var_x179;
        const double var_x187 = 16696701353.239271 * var_x175;
        const double var_x188 = 35767755630.803253 * var_x177;
        const double var_x189 = 11922585210.267752 * var_x177;
        const double var_x190 = 3099769910.3661275 * var_x181;
        const double var_x191 = 24316996817.391472 * var_x179;
        const double var_x192 = 23382498943.197018 * var_x175;
        const double var_x193 = 2213447441.3051791 * var_x181;
        const double var_x194 = 8513540195.0827656 * exp(-21.949261959797553 + 0.030147161449011892 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x195 = 8513540195.0827656 * exp(-38.483942906307405 - 0.14399668707161886 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x196 = 32745465422.278648 * var_x175;
        const double var_x197 = 8513540195.0827656 * exp(-39.744904705650839 + 0.0027019947965296331 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x198 = 8513540195.0827656 * exp(-20.6726464954126 + 0.011394696340402199 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x199 = 11922585210.267752 * var_x175;
        const double var_x200 = 25540620585.248295 * var_x177;
        const double var_x201 = 17027080390.165531 * var_x179;
        const double var_x202 = 6079249204.347868 * var_x181;
        const double var_x203 = 17027080390.165531 * var_x177;
        const double var_x204 = 25540620585.248295 * var_x179;
        const double var_x205 = 8513540195.0827656 * var_x177;
        const double var_x206 = 34054160780.331062 * var_x179;
        const double var_x207 = 8513540195.0827656 * exp(-16.535928437145476 + 0.1097131992444229 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x208 = 8513540195.0827656 * exp(-19.672905196314268 + 0.084272054104636354 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x209 = 8513540195.0827656 * exp(-27.092641999412571 - 0.061469636400174388 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x210 = 8513540195.0827656 * exp(-26.358496255772213 - 0.068762962366201316 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x211 = 8513540195.0827656 * exp(-26.650781465416159);
        const double var_x212 = 8513540195.0827656 * exp(-22.779658962607588);
        const double var_x213 = 47690340841.071007 * var_x177;
        const double var_x214 = 6079249204.347868 * var_x179;
        ...
        rJacobian[2][34] = 0.0;
        rJacobian[2][35] = 0.0;
        rJacobian[2][36] = -(mDt * (-var_x26 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa));
        rJacobian[2][37] = -(mDt * (-var_x26 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open));
        rJacobian[2][38] = 0.0;
        rJacobian[2][39] = 0.0;
        rJacobian[2][40] = -(mDt * (var_x27));
        rJacobian[2][41] = -(mDt * (var_x27));
        rJacobian[2][42] = 0.0;
        rJacobian[2][43] = 0.0;
        rJacobian[2][44] = 0.0;
        rJacobian[2][45] = 0.0;
        ...
        rJacobian[2][65] = 0.0;
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = -(mDt * (var_x31 * (3.1822011198770807e-10 * var_x12 + 0.00011598784194528874 * var_x10)));
        rJacobian[3][2] = -(mDt * (0.037453183520599252 * var_x30));
        rJacobian[3][3] = 1.0 - (mDt * (var_x31 * (-5.6374531835205994 - var_x33 + 2.8000000000000003 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa + 2.8000000000000003 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa + 4.2533745697546539e-5 * var_x15 - 0.03190795213912849 * var_x37 - 3.1566725655651652e-8 * var_x34 - 3.6466405075851775 * var_x14 + 1.5379617895699322e-6 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai / pow(var_x32, 2)) + 0.00023800000000000004 * (0.0028000000000000004 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa + 9.2400000000000013e-6 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa + 3.1566725655651652e-8 * log(2.0 * var_x34) + 0.037453183520599252 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS - 0.037453183520599252 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - 2.3635396782110715e-9 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V - var_x33 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - var_x39 * (1.0 - var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa) - var_x39 * (1.0 - var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa) + 1.2141201663854144e-8 * var_x36 * (2.0 * var_x38 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai, 3) - 2628072.0 * var_x35 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai) - 1.2 * var_x10 * var_x11) / (pow(var_x28, 3) * pow(var_x29, 2))));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (7.2847209983124865e-8 * var_x30 * var_x40));
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = 0.0;
        rJacobian[3][9] = 0.0;
        ...
        rJacobian[3][40] = 0.0;
        rJacobian[3][41] = 0.0;
        rJacobian[3][42] = -(mDt * (var_x31 * (9.2400000000000013e-6 + var_x39)));
        rJacobian[3][43] = -(mDt * (var_x31 * (0.0028000000000000004 + var_x39)));
        rJacobian[3][44] = 0.0;
        rJacobian[3][45] = 0.0;
        rJacobian[3][46] = 0.0;
        rJacobian[3][47] = 0.0;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (((var_x51) ? (var_x50 - var_x43) : (var_x50 - var_x43 * var_x52))));
        rJacobian[4][5] = -(mDt * (3.58204897197986e-6 * var_x55));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        ...
        rJacobian[4][13] = 0.0;
        rJacobian[4][14] = 0.0;
        rJacobian[4][15] = -(mDt * (-var_x48 * var_x56));
        rJacobian[4][16] = 0.0;
        rJacobian[4][17] = 0.0;
        rJacobian[4][18] = 0.0;
        rJacobian[4][19] = 0.0;
        ...
        rJacobian[4][23] = 0.0;
        rJacobian[4][24] = 0.0;
        rJacobian[4][25] = -(mDt * (0.00012738562343605624 * var_x45 - 4.7689611318757119e-6 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V));
        rJacobian[4][26] = 0.0;
        rJacobian[4][27] = 0.0;
        rJacobian[4][28] = 0.0;
        rJacobian[4][29] = 0.0;
        ...
        rJacobian[4][34] = 0.0;
        rJacobian[4][35] = 0.0;
        rJacobian[4][36] = -(mDt * (((var_x51) ? (-var_x58) : (-var_x52 * var_x58))));
        rJacobian[4][37] = -(mDt * (((var_x51) ? (-var_x59) : (-var_x52 * var_x59))));
        rJacobian[4][38] = 0.0;
        rJacobian[4][39] = 0.0;
        rJacobian[4][40] = 0.0;
        rJacobian[4][41] = 0.0;
        ...
        rJacobian[4][46] = 0.0;
        rJacobian[4][47] = 0.0;
        rJacobian[4][48] = -(mDt * (3.0564346548418563e-5 * var_x45 - 1.1442435714400293e-6 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V));
        rJacobian[4][49] = 0.0;
        rJacobian[4][50] = 0.0;
        rJacobian[4][51] = -(mDt * (var_x60));
        rJacobian[4][52] = -(mDt * (var_x60));
        rJacobian[4][53] = 0.0;
        rJacobian[4][54] = 0.0;
        rJacobian[4][55] = 0.0;
        rJacobian[4][56] = 0.0;
        ...
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (0.095723856417385469 * var_x37));
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (-5.3730734579697901e-6 * var_x55 - 1.6432444380870198e-6 * var_x53 - 2.1854162994937459e-7 * var_x40 - var_x49 * var_x61 - 0.092547526753060952 * var_x53 * (var_chaste_interface__INa__na6 + var_chaste_interface__INa__na7)));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        ...
        rJacobian[5][13] = 0.0;
        rJacobian[5][14] = 0.0;
        rJacobian[5][15] = -(mDt * (-var_x61 * (-138.0 + var_x41 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai)));
        rJacobian[5][16] = 0.0;
        rJacobian[5][17] = 0.0;
        rJacobian[5][18] = 0.0;
        rJacobian[5][19] = 0.0;
        ...
        rJacobian[5][60] = 0.0;
        rJacobian[5][61] = 0.0;
        rJacobian[5][62] = -(mDt * (var_x62));
        rJacobian[5][63] = -(mDt * (var_x62));
        rJacobian[5][64] = 0.0;
        rJacobian[5][65] = 0.0;
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-2.44936e-6 - var_x64));
        rJacobian[6][7] = -(mDt * (var_x66));
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        ...
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = -(mDt * (var_x64));
        rJacobian[7][7] = 1.0 - (mDt * (-1.2850585364284256e-6 - var_x66 - var_x67));
        ...
        rJacobian[8][8] = 1.0 - (mDt * (-4.290998044504021e-5 - var_x68 - var_x69));
        ...
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = -(mDt * (var_x69));
        rJacobian[9][9] = 1.0 - (mDt * (-0.0022989390350036006 - var_x70 - var_x71));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = 0.0;
        rJacobian[9][12] = 0.0;
        rJacobian[9][13] = -(mDt * (0.0047848930796401661));
        rJacobian[9][14] = 0.0;
        rJacobian[9][15] = -(mDt * (var_x72));
        rJacobian[9][16] = 0.0;
        rJacobian[9][17] = 0.0;
        rJacobian[9][18] = 0.0;
        rJacobian[9][19] = 0.0;
        ...
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-0.00305767916 - var_x73));
        rJacobian[10][11] = -(mDt * (var_x74));
        rJacobian[10][12] = 0.0;
        rJacobian[10][13] = 0.0;
        rJacobian[10][14] = 0.0;
        rJacobian[10][15] = 0.0;
        ...
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = -(mDt * (var_x73));
        rJacobian[11][11] = 1.0 - (mDt * (-0.0030289691634726814 - var_x74 - var_x75));
        rJacobian[11][12] = -(mDt * (var_x76));
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = 0.0;
        rJacobian[11][15] = 0.0;
        rJacobian[11][16] = 0.0;
        ...
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = -(mDt * (var_x75));
        rJacobian[12][12] = 1.0 - (mDt * (-0.0026111571690401588 - var_x76 - var_x77));
        rJacobian[12][13] = -(mDt * (var_x78));
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        rJacobian[12][17] = 0.0;
        ...
        rJacobian[13][10] = 0.0;
        rJacobian[13][11] = 0.0;
        rJacobian[13][12] = -(mDt * (var_x77));
        rJacobian[13][13] = 1.0 - (mDt * (-0.0047848930796401661 - var_x78 - var_x79));
        rJacobian[13][14] = -(mDt * (var_x80));
        rJacobian[13][15] = 0.0;
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        rJacobian[13][18] = 0.0;
        ...
        rJacobian[14][11] = 0.0;
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = -(mDt * (var_x79));
        rJacobian[14][14] = 1.0 - (mDt * (-0.0014420608358145942 - var_x80));
        ...
        rJacobian[15][7] = 0.0;
        rJacobian[15][8] = 0.0;
        rJacobian[15][9] = -(mDt * (var_x71));
        rJacobian[15][10] = 0.0;
        rJacobian[15][11] = 0.0;
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = -(mDt * (0.0014420608358145942));
        rJacobian[15][15] = 1.0 - (mDt * (-0.13410048761201937 - var_x72));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (-var_x82 - var_x84));
        rJacobian[16][17] = -(mDt * (var_x86));
        rJacobian[16][18] = 0.0;
        rJacobian[16][19] = 0.0;
        rJacobian[16][20] = -(mDt * (var_x88));
        rJacobian[16][21] = 0.0;
        rJacobian[16][22] = 0.0;
        rJacobian[16][23] = 0.0;
        rJacobian[16][24] = 0.0;
        ...
        rJacobian[17][14] = 0.0;
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = -(mDt * (var_x82));
        rJacobian[17][17] = 1.0 - (mDt * (-var_x86 - var_x89 - var_x90));
        rJacobian[17][18] = -(mDt * (var_x91));
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = 0.0;
        rJacobian[17][21] = -(mDt * (var_x92));
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = 0.0;
        rJacobian[17][24] = 0.0;
        rJacobian[17][25] = 0.0;
        ...
        rJacobian[18][15] = 0.0;
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = -(mDt * (var_x89));
        rJacobian[18][18] = 1.0 - (mDt * (-var_x91 - var_x93 - var_x94));
        rJacobian[18][19] = -(mDt * (var_x95));
        rJacobian[18][20] = 0.0;
        rJacobian[18][21] = 0.0;
        rJacobian[18][22] = -(mDt * (var_x96));
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        rJacobian[18][25] = 0.0;
        rJacobian[18][26] = 0.0;
        ...
        rJacobian[19][16] = 0.0;
        rJacobian[19][17] = 0.0;
        rJacobian[19][18] = -(mDt * (var_x93));
        rJacobian[19][19] = 1.0 - (mDt * (-var_x95 - var_x97 - var_x98));
        rJacobian[19][20] = 0.0;
        rJacobian[19][21] = 0.0;
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = -(mDt * (var_x99));
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = -(mDt * (var_x100));
        rJacobian[19][26] = 0.0;
        rJacobian[19][27] = 0.0;
        rJacobian[19][28] = 0.0;
        rJacobian[19][29] = 0.0;
        ...
        rJacobian[20][18] = 0.0;
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * (-var_x101 - var_x88));
        rJacobian[20][21] = -(mDt * (var_x102));
        rJacobian[20][22] = 0.0;
        rJacobian[20][23] = 0.0;
        rJacobian[20][24] = 0.0;
        rJacobian[20][25] = 0.0;
        ...
        rJacobian[21][15] = 0.0;
        rJacobian[21][16] = 0.0;
        rJacobian[21][17] = -(mDt * (var_x90));
        rJacobian[21][18] = 0.0;
        rJacobian[21][19] = 0.0;
        rJacobian[21][20] = -(mDt * (var_x101));
        rJacobian[21][21] = 1.0 - (mDt * (-var_x102 - var_x103 - var_x92));
        rJacobian[21][22] = -(mDt * (var_x104));
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        rJacobian[21][26] = 0.0;
        ...
        rJacobian[22][16] = 0.0;
        rJacobian[22][17] = 0.0;
        rJacobian[22][18] = -(mDt * (var_x94));
        rJacobian[22][19] = 0.0;
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = -(mDt * (var_x103));
        rJacobian[22][22] = 1.0 - (mDt * (-var_x104 - var_x105 - var_x96));
        rJacobian[22][23] = -(mDt * (var_x106));
        rJacobian[22][24] = 0.0;
        rJacobian[22][25] = 0.0;
        rJacobian[22][26] = 0.0;
        rJacobian[22][27] = 0.0;
        ...
        rJacobian[23][17] = 0.0;
        rJacobian[23][18] = 0.0;
        rJacobian[23][19] = -(mDt * (var_x98));
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (var_x105));
        rJacobian[23][23] = 1.0 - (mDt * (-var_x106 - var_x107 - var_x99));
        rJacobian[23][24] = -(mDt * (var_x108));
        rJacobian[23][25] = 0.0;
        rJacobian[23][26] = 0.0;
        rJacobian[23][27] = 0.0;
        rJacobian[23][28] = 0.0;
        ...
        rJacobian[24][21] = 0.0;
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = -(mDt * (var_x107));
        rJacobian[24][24] = 1.0 - (mDt * (-var_x108 - var_x109));
        rJacobian[24][25] = -(mDt * (var_x110));
        rJacobian[24][26] = 0.0;
        rJacobian[24][27] = 0.0;
        rJacobian[24][28] = 0.0;
        rJacobian[24][29] = 0.0;
        ...
        rJacobian[25][17] = 0.0;
        rJacobian[25][18] = 0.0;
        rJacobian[25][19] = -(mDt * (var_x97));
        rJacobian[25][20] = 0.0;
        rJacobian[25][21] = 0.0;
        rJacobian[25][22] = 0.0;
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = -(mDt * (var_x109));
        rJacobian[25][25] = 1.0 - (mDt * (-var_x100 - var_x110));
        rJacobian[25][26] = 0.0;
        rJacobian[25][27] = 0.0;
        rJacobian[25][28] = 0.0;
        rJacobian[25][29] = 0.0;
        ...
        rJacobian[26][24] = 0.0;
        rJacobian[26][25] = 0.0;
        rJacobian[26][26] = 1.0 - (mDt * (var_x115 - var_x112));
        rJacobian[26][27] = -(mDt * (var_x117));
        rJacobian[26][28] = 0.0;
        rJacobian[26][29] = 0.0;
        rJacobian[26][30] = 0.0;
        ...
        rJacobian[27][24] = 0.0;
        rJacobian[27][25] = 0.0;
        rJacobian[27][26] = -(mDt * (var_x114));
        rJacobian[27][27] = 1.0 - (mDt * (var_x121 - var_x119 - var_x120));
        rJacobian[27][28] = -(mDt * (var_x122));
        rJacobian[27][29] = 0.0;
        rJacobian[27][30] = 0.0;
        rJacobian[27][31] = 0.0;
        ...
        rJacobian[28][25] = 0.0;
        rJacobian[28][26] = 0.0;
        rJacobian[28][27] = -(mDt * (var_x119));
        rJacobian[28][28] = 1.0 - (mDt * (var_x125 + var_x127 - var_x124));
        rJacobian[28][29] = -(mDt * (var_x128));
        rJacobian[28][30] = 0.0;
        rJacobian[28][31] = 0.0;
        rJacobian[28][32] = 0.0;
        ...
        rJacobian[29][26] = 0.0;
        rJacobian[29][27] = 0.0;
        rJacobian[29][28] = -(mDt * (var_x126));
        rJacobian[29][29] = 1.0 - (mDt * (-var_x128 - var_x130 - var_x131));
        rJacobian[29][30] = -(mDt * (var_x132));
        rJacobian[29][31] = 0.0;
        rJacobian[29][32] = 0.0;
        rJacobian[29][33] = 0.0;
        ...
        rJacobian[30][30] = 1.0 - (mDt * (-0.29999999999999999 - var_x132 - var_x134));
        rJacobian[30][31] = 0.0;
        rJacobian[30][32] = 0.0;
        rJacobian[30][33] = 0.0;
        rJacobian[30][34] = 0.0;
        ...
        rJacobian[31][24] = 0.0;
        rJacobian[31][25] = 0.0;
        rJacobian[31][26] = -(mDt * (var_x112));
        rJacobian[31][27] = 0.0;
        rJacobian[31][28] = 0.0;
        rJacobian[31][29] = 0.0;
        rJacobian[31][30] = 0.0;
        rJacobian[31][31] = 1.0 - (mDt * (-0.0025000000000000001 - var_x135));
        rJacobian[31][32] = -(mDt * (var_x136));
        rJacobian[31][33] = 0.0;
        rJacobian[31][34] = 0.0;
        rJacobian[31][35] = 0.0;
        rJacobian[31][36] = 0.0;
        ...
        rJacobian[32][25] = 0.0;
        rJacobian[32][26] = 0.0;
        rJacobian[32][27] = -(mDt * (var_x120));
        rJacobian[32][28] = 0.0;
        rJacobian[32][29] = 0.0;
        rJacobian[32][30] = 0.0;
        rJacobian[32][31] = -(mDt * (var_x135));
        rJacobian[32][32] = 1.0 - (mDt * (-0.00125 - var_x136 - var_x137));
        rJacobian[32][33] = -(mDt * (var_x117));
        rJacobian[32][34] = 0.0;
        rJacobian[32][35] = 0.0;
        rJacobian[32][36] = 0.0;
        rJacobian[32][37] = 0.0;
        ...
        rJacobian[33][26] = 0.0;
        rJacobian[33][27] = 0.0;
        rJacobian[33][28] = -(mDt * (var_x124));
        rJacobian[33][29] = 0.0;
        rJacobian[33][30] = 0.0;
        rJacobian[33][31] = 0.0;
        rJacobian[33][32] = -(mDt * (var_x137));
        rJacobian[33][33] = 1.0 - (mDt * (-0.00062500000000000001 + var_x115 + var_x121));
        rJacobian[33][34] = -(mDt * (var_x138));
        rJacobian[33][35] = 0.0;
        rJacobian[33][36] = 0.0;
        rJacobian[33][37] = 0.0;
        rJacobian[33][38] = 0.0;
        ...
        rJacobian[34][27] = 0.0;
        rJacobian[34][28] = 0.0;
        rJacobian[34][29] = -(mDt * (var_x130));
        rJacobian[34][30] = 0.0;
        rJacobian[34][31] = 0.0;
        rJacobian[34][32] = 0.0;
        rJacobian[34][33] = -(mDt * (var_x114));
        rJacobian[34][34] = 1.0 - (mDt * (-0.00031250000000000001 + var_x127 - var_x138));
        rJacobian[34][35] = -(mDt * (var_x122));
        rJacobian[34][36] = 0.0;
        rJacobian[34][37] = 0.0;
        rJacobian[34][38] = 0.0;
        rJacobian[34][39] = 0.0;
        ...
        rJacobian[35][28] = 0.0;
        rJacobian[35][29] = 0.0;
        rJacobian[35][30] = -(mDt * (var_x134));
        rJacobian[35][31] = 0.0;
        rJacobian[35][32] = 0.0;
        rJacobian[35][33] = 0.0;
        rJacobian[35][34] = -(mDt * (var_x126));
        rJacobian[35][35] = 1.0 - (mDt * (-0.00015625 + var_x125));
        rJacobian[35][36] = 0.0;
        rJacobian[35][37] = 0.0;
        rJacobian[35][38] = 0.0;
        rJacobian[35][39] = 0.0;
        ...
        rJacobian[37][35] = 0.0;
        rJacobian[37][36] = 0.0;
        rJacobian[37][37] = 1.0 - (mDt * ((var_x139 + var_x140) * (0.18000000000000005 - var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa + 0.81999999999999995 / (1.0 + exp(3.6538461538461537 + 0.12820512820512822 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V))) + (-var_x139 - var_x140) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa));
        rJacobian[37][38] = 0.0;
        rJacobian[37][39] = 0.0;
        rJacobian[37][40] = 0.0;
        rJacobian[37][41] = 0.0;
        ...
        rJacobian[37][64] = 0.0;
        rJacobian[37][65] = 0.0;
        rJacobian[38][0] = -(mDt * (-var_x146));
        rJacobian[38][1] = 0.0;
        rJacobian[38][2] = -(mDt * (-var_x150));
        rJacobian[38][3] = 0.0;
        rJacobian[38][4] = 0.0;
        rJacobian[38][5] = 0.0;
        rJacobian[38][6] = 0.0;
        ...
        rJacobian[38][36] = 0.0;
        rJacobian[38][37] = 0.0;
        rJacobian[38][38] = 1.0 - (mDt * (-var_x151));
        rJacobian[38][39] = 0.0;
        rJacobian[38][40] = -(mDt * (0.57599999999999996));
        rJacobian[38][41] = 0.0;
        rJacobian[38][42] = 0.0;
        rJacobian[38][43] = 0.0;
        rJacobian[38][44] = 0.0;
        ...
        rJacobian[38][64] = 0.0;
        rJacobian[38][65] = 0.0;
        rJacobian[39][0] = -(mDt * (-var_x152 - var_x153));
        rJacobian[39][1] = 0.0;
        rJacobian[39][2] = 0.0;
        rJacobian[39][3] = 0.0;
        rJacobian[39][4] = 0.0;
        ...
        rJacobian[39][37] = 0.0;
        rJacobian[39][38] = 0.0;
        rJacobian[39][39] = 1.0 - (mDt * (-0.00040000000000000002 - var_x154));
        rJacobian[39][40] = -(mDt * (var_x155));
        rJacobian[39][41] = 0.0;
        rJacobian[39][42] = 0.0;
        rJacobian[39][43] = 0.0;
        rJacobian[39][44] = 0.0;
        ...
        rJacobian[39][64] = 0.0;
        rJacobian[39][65] = 0.0;
        rJacobian[40][0] = -(mDt * (var_x146 + var_x152 + var_x153));
        rJacobian[40][1] = 0.0;
        rJacobian[40][2] = -(mDt * (var_x150 - var_x156));
        rJacobian[40][3] = 0.0;
        rJacobian[40][4] = 0.0;
        rJacobian[40][5] = 0.0;
        rJacobian[40][6] = 0.0;
        ...
        rJacobian[40][36] = 0.0;
        rJacobian[40][37] = 0.0;
        rJacobian[40][38] = -(mDt * (var_x151));
        rJacobian[40][39] = -(mDt * (0.00040000000000000002 + var_x154));
        rJacobian[40][40] = 1.0 - (mDt * (-0.57599999999999996 - var_x155 - var_x157));
        rJacobian[40][41] = -(mDt * (1.9299999999999999));
        rJacobian[40][42] = 0.0;
        rJacobian[40][43] = 0.0;
        rJacobian[40][44] = 0.0;
        rJacobian[40][45] = 0.0;
        ...
        rJacobian[41][38] = 0.0;
        rJacobian[41][39] = 0.0;
        rJacobian[41][40] = -(mDt * (var_x157));
        rJacobian[41][41] = 1.0 - (mDt * (-1.9299999999999999));
        rJacobian[41][42] = 0.0;
        rJacobian[41][43] = 0.0;
        rJacobian[41][44] = 0.0;
        rJacobian[41][45] = 0.0;
        ...
        rJacobian[42][1] = 0.0;
        rJacobian[42][2] = 0.0;
        rJacobian[42][3] = -(mDt * (20.0 - 20.0 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa));
        rJacobian[42][4] = 0.0;
        rJacobian[42][5] = 0.0;
        rJacobian[42][6] = 0.0;
        rJacobian[42][7] = 0.0;
        ...
        rJacobian[42][40] = 0.0;
        rJacobian[42][41] = 0.0;
        rJacobian[42][42] = 1.0 - (mDt * (-6.6000000000000005e-5 - 20.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai));
        rJacobian[42][43] = 0.0;
        rJacobian[42][44] = 0.0;
        rJacobian[42][45] = 0.0;
        rJacobian[42][46] = 0.0;
        ...
        rJacobian[43][1] = 0.0;
        rJacobian[43][2] = 0.0;
        rJacobian[43][3] = -(mDt * (40.0 - 40.0 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa));
        rJacobian[43][4] = 0.0;
        rJacobian[43][5] = 0.0;
        rJacobian[43][6] = 0.0;
        rJacobian[43][7] = 0.0;
        ...
        rJacobian[43][41] = 0.0;
        rJacobian[43][42] = 0.0;
        rJacobian[43][43] = 1.0 - (mDt * (-0.040000000000000001 - 40.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai));
        rJacobian[43][44] = 0.0;
        rJacobian[43][45] = 0.0;
        rJacobian[43][46] = 0.0;
        rJacobian[43][47] = 0.0;
        ...
        rJacobian[44][42] = 0.0;
        rJacobian[44][43] = 0.0;
        rJacobian[44][44] = 1.0 - (mDt * (-var_x158));
        rJacobian[44][45] = -(mDt * (var_x159));
        rJacobian[44][46] = 0.0;
        rJacobian[44][47] = 0.0;
        rJacobian[44][48] = 0.0;
        rJacobian[44][49] = 0.0;
        ...
        rJacobian[45][42] = 0.0;
        rJacobian[45][43] = 0.0;
        rJacobian[45][44] = -(mDt * (var_x158));
        rJacobian[45][45] = 1.0 - (mDt * (-0.13876486073161204 - var_x159));
        rJacobian[45][46] = -(mDt * (0.78911443677844384));
        rJacobian[45][47] = 0.0;
        rJacobian[45][48] = 0.0;
        rJacobian[45][49] = 0.0;
        rJacobian[45][50] = 0.0;
        ...
        rJacobian[46][43] = 0.0;
        rJacobian[46][44] = 0.0;
        rJacobian[46][45] = -(mDt * (0.13876486073161204));
        rJacobian[46][46] = 1.0 - (mDt * (-0.78911443677844384 - var_x161 - var_x163));
        rJacobian[46][47] = -(mDt * (var_x167));
        rJacobian[46][48] = -(mDt * (var_x168));
        rJacobian[46][49] = 0.0;
        rJacobian[46][50] = 0.0;
        rJacobian[46][51] = 0.0;
        rJacobian[46][52] = 0.0;
        ...
        rJacobian[47][44] = 0.0;
        rJacobian[47][45] = 0.0;
        rJacobian[47][46] = -(mDt * (var_x163));
        rJacobian[47][47] = 1.0 - (mDt * (-var_x167 - var_x169));
        rJacobian[47][48] = -(mDt * (var_x170));
        rJacobian[47][49] = 0.0;
        rJacobian[47][50] = 0.0;
        rJacobian[47][51] = 0.0;
        rJacobian[47][52] = 0.0;
        ...
        rJacobian[48][44] = 0.0;
        rJacobian[48][45] = 0.0;
        rJacobian[48][46] = -(mDt * (var_x161));
        rJacobian[48][47] = -(mDt * (var_x169));
        rJacobian[48][48] = 1.0 - (mDt * (-var_x168 - var_x170));
        rJacobian[48][49] = 0.0;
        rJacobian[48][50] = 0.0;
        rJacobian[48][51] = 0.0;
        rJacobian[48][52] = 0.0;
        ...
        rJacobian[49][47] = 0.0;
        rJacobian[49][48] = 0.0;
        rJacobian[49][49] = 1.0 - (mDt * (-0.0079560079800399999));
        rJacobian[49][50] = -(mDt * (var_x171));
        rJacobian[49][51] = 0.0;
        rJacobian[49][52] = 0.0;
        rJacobian[49][53] = 0.0;
        rJacobian[49][54] = 0.0;
        ...
        rJacobian[50][47] = 0.0;
        rJacobian[50][48] = 0.0;
        rJacobian[50][49] = -(mDt * (0.0079560079800399999));
        rJacobian[50][50] = 1.0 - (mDt * (-0.039667206760709998 - var_x171));
        rJacobian[50][51] = -(mDt * (var_x172));
        rJacobian[50][52] = 0.0;
        rJacobian[50][53] = 0.0;
        rJacobian[50][54] = 0.0;
        rJacobian[50][55] = 0.0;
        ...
        rJacobian[51][48] = 0.0;
        rJacobian[51][49] = 0.0;
        rJacobian[51][50] = -(mDt * (0.039667206760709998));
        rJacobian[51][51] = 1.0 - (mDt * (-var_x172 - var_x173));
        rJacobian[51][52] = -(mDt * (var_x174));
        rJacobian[51][53] = 0.0;
        rJacobian[51][54] = 0.0;
        rJacobian[51][55] = 0.0;
        rJacobian[51][56] = 0.0;
        ...
        rJacobian[52][49] = 0.0;
        rJacobian[52][50] = 0.0;
        rJacobian[52][51] = -(mDt * (var_x173));
        rJacobian[52][52] = 1.0 - (mDt * (-var_x174));
        rJacobian[52][53] = 0.0;
        rJacobian[52][54] = 0.0;
        rJacobian[52][55] = 0.0;
        rJacobian[52][56] = 0.0;
        ...
        rJacobian[53][51] = 0.0;
        rJacobian[53][52] = 0.0;
        rJacobian[53][53] = 1.0 - (mDt * (-var_x176 - var_x178));
        rJacobian[53][54] = 0.0;
        rJacobian[53][55] = 0.0;
        rJacobian[53][56] = 0.0;
        rJacobian[53][57] = 0.0;
        ...
        rJacobian[54][52] = 0.0;
        rJacobian[54][53] = 0.0;
        rJacobian[54][54] = 1.0 - (mDt * (-var_x183 - var_x184 - var_x185));
        ...
        rJacobian[55][55] = 1.0 - (mDt * (-var_x186 - var_x189 - var_x190));
        rJacobian[55][56] = -(mDt * (var_x191));
        rJacobian[55][57] = 0.0;
        rJacobian[55][58] = 0.0;
        rJacobian[55][59] = 0.0;
        rJacobian[55][60] = -(mDt * (var_x192));
        rJacobian[55][61] = 0.0;
        rJacobian[55][62] = 0.0;
        rJacobian[55][63] = 0.0;
        rJacobian[55][64] = 0.0;
        ...
        rJacobian[56][56] = 1.0 - (mDt * (-var_x191 - var_x193 - var_x194));
        rJacobian[56][57] = -(mDt * (var_x195));
        rJacobian[56][58] = 0.0;
        rJacobian[56][59] = 0.0;
        rJacobian[56][60] = 0.0;
        rJacobian[56][61] = -(mDt * (var_x196));
        rJacobian[56][62] = 0.0;
        rJacobian[56][63] = 0.0;
        rJacobian[56][64] = 0.0;
        rJacobian[56][65] = 0.0;
        ...
        rJacobian[57][54] = 0.0;
        rJacobian[57][55] = 0.0;
        rJacobian[57][56] = -(mDt * (var_x194));
        rJacobian[57][57] = 1.0 - (mDt * (-var_x195 - var_x197));
        rJacobian[57][58] = 0.0;
        rJacobian[57][59] = 0.0;
        rJacobian[57][60] = 0.0;
        rJacobian[57][61] = 0.0;
        rJacobian[57][62] = -(mDt * (var_x198));
        rJacobian[57][63] = 0.0;
        rJacobian[57][64] = 0.0;
        rJacobian[57][65] = 0.0;
        rJacobian[58][0] = 0.0;
        ...
        rJacobian[58][56] = 0.0;
        rJacobian[58][57] = 0.0;
        rJacobian[58][58] = 1.0 - (mDt * (-var_x180 - var_x199 - var_x200));
        rJacobian[58][59] = -(mDt * (var_x201));
        rJacobian[58][60] = 0.0;
        rJacobian[58][61] = 0.0;
        rJacobian[58][62] = 0.0;
        rJacobian[58][63] = 0.0;
        rJacobian[58][64] = 0.0;
        rJacobian[58][65] = -(mDt * (var_x202));
        rJacobian[59][0] = 0.0;
        rJacobian[59][1] = 0.0;
        rJacobian[59][2] = 0.0;
        rJacobian[59][3] = 0.0;
        ...
        rJacobian[59][56] = 0.0;
        rJacobian[59][57] = 0.0;
        rJacobian[59][58] = -(mDt * (var_x200));
        rJacobian[59][59] = 1.0 - (mDt * (-var_x187 - var_x201 - var_x203));
        rJacobian[59][60] = -(mDt * (var_x204));
        rJacobian[59][61] = 0.0;
        rJacobian[59][62] = 0.0;
        rJacobian[59][63] = 0.0;
        rJacobian[59][64] = 0.0;
        ...
        rJacobian[60][53] = 0.0;
        rJacobian[60][54] = 0.0;
        rJacobian[60][55] = -(mDt * (var_x190));
        rJacobian[60][56] = 0.0;
        rJacobian[60][57] = 0.0;
        rJacobian[60][58] = 0.0;
        rJacobian[60][59] = -(mDt * (var_x203));
        rJacobian[60][60] = 1.0 - (mDt * (-var_x192 - var_x204 - var_x205));
        rJacobian[60][61] = -(mDt * (var_x206));
        rJacobian[60][62] = 0.0;
        rJacobian[60][63] = 0.0;
        rJacobian[60][64] = 0.0;
        rJacobian[60][65] = 0.0;
        ...
        rJacobian[61][54] = 0.0;
        rJacobian[61][55] = 0.0;
        rJacobian[61][56] = -(mDt * (var_x193));
        rJacobian[61][57] = 0.0;
        rJacobian[61][58] = 0.0;
        rJacobian[61][59] = 0.0;
        rJacobian[61][60] = -(mDt * (var_x205));
        rJacobian[61][61] = 1.0 - (mDt * (-var_x196 - var_x206 - var_x207 - var_x208));
        rJacobian[61][62] = -(mDt * (var_x209));
        rJacobian[61][63] = -(mDt * (var_x210));
        rJacobian[61][64] = 0.0;
        rJacobian[61][65] = 0.0;
        rJacobian[62][0] = 0.0;
        rJacobian[62][1] = 0.0;
        ...
        rJacobian[62][55] = 0.0;
        rJacobian[62][56] = 0.0;
        rJacobian[62][57] = -(mDt * (var_x197));
        rJacobian[62][58] = 0.0;
        rJacobian[62][59] = 0.0;
        rJacobian[62][60] = 0.0;
        rJacobian[62][61] = -(mDt * (var_x207));
        rJacobian[62][62] = 1.0 - (mDt * (-var_x198 - var_x209 - var_x211));
        rJacobian[62][63] = -(mDt * (var_x212));
        rJacobian[62][64] = 0.0;
        rJacobian[62][65] = 0.0;
        rJacobian[63][0] = 0.0;
        rJacobian[63][1] = 0.0;
        ...
        rJacobian[63][59] = 0.0;
        rJacobian[63][60] = 0.0;
        rJacobian[63][61] = -(mDt * (var_x208));
        rJacobian[63][62] = -(mDt * (var_x211));
        rJacobian[63][63] = 1.0 - (mDt * (-var_x210 - var_x212));
        rJacobian[63][64] = 0.0;
        rJacobian[63][65] = 0.0;
        rJacobian[64][0] = 0.0;
        rJacobian[64][1] = 0.0;
        ...
        rJacobian[64][62] = 0.0;
        rJacobian[64][63] = 0.0;
        rJacobian[64][64] = 1.0 - (mDt * (-var_x182 - var_x213));
        rJacobian[64][65] = -(mDt * (var_x214));
        rJacobian[65][0] = 0.0;
        rJacobian[65][1] = 0.0;
        rJacobian[65][2] = 0.0;
        rJacobian[65][3] = 0.0;
        ...
        rJacobian[65][52] = 0.0;
        rJacobian[65][53] = 0.0;
        rJacobian[65][54] = -(mDt * (var_x185));
        rJacobian[65][55] = 0.0;
        rJacobian[65][56] = 0.0;
        rJacobian[65][57] = 0.0;
        rJacobian[65][58] = -(mDt * (var_x199));
        rJacobian[65][59] = 0.0;
        rJacobian[65][60] = 0.0;
        rJacobian[65][61] = 0.0;
        rJacobian[65][62] = 0.0;
        rJacobian[65][63] = 0.0;
        rJacobian[65][64] = -(mDt * (var_x213));
        rJacobian[65][65] = 1.0 - (mDt * (-var_x188 - var_x202 - var_x214));
    }

    void Cellnon_linear_modelFromCellMLBackwardEuler::UpdateTransmembranePotential(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    void Cellnon_linear_modelFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        // Time units: millisecond
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        double _guess[66] = {rY[5],rY[6],rY[4],rY[3],rY[2],rY[1],rY[35],rY[36],rY[37],rY[38],rY[40],rY[41],rY[42],rY[43],rY[44],rY[39],rY[25],rY[26],rY[27],rY[28],rY[30],rY[31],rY[32],rY[33],rY[34],rY[29],rY[13],rY[14],rY[15],rY[16],rY[17],rY[18],rY[19],rY[20],rY[21],rY[22],rY[23],rY[24],rY[9],rY[11],rY[12],rY[10],rY[8],rY[7],rY[58],rY[59],rY[60],rY[62],rY[61],rY[63],rY[64],rY[65],rY[66],rY[45],rY[54],rY[55],rY[56],rY[57],rY[46],rY[47],rY[48],rY[49],rY[50],rY[51],rY[52],rY[53]};
        CardiacNewtonSolver<66,Cellnon_linear_modelFromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<66,Cellnon_linear_modelFromCellMLBackwardEuler>::Instance();
...
template<>
void OdeSystemInformation<Cellnon_linear_modelFromCellMLBackwardEuler>::Initialise(void)
{
