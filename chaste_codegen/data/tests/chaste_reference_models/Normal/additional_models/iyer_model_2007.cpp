...
#include "MathsCustomFunctions.hpp"
    ...
    double Celliyer_model_2007FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_I_stimulus__stim_amplitude = -15.0; // uA_per_uF
        const double var_I_stimulus__stim_duration = 3.0; // ms
        const double var_I_stimulus__stim_offset = 100.0; // ms
        const double var_I_stimulus__stim_period = 500.0; // ms
        const double var_environment__iso = 0.0; // dimensionless
        const double var_COMPUTE_ICa_ICaK__PCa = ((var_environment__iso == 0.0) ? (0.0002469 * var_COMPUTE_ICa_ICaK__Pscale) : (0.00037035 * var_COMPUTE_ICa_ICaK__Pscale)); // litre_per_farad_second
        ...
        const double var_I_stimulus__past = var_I_stimulus__stim_period * floor(var_chaste_interface__environment__time / var_I_stimulus__stim_period); // ms
