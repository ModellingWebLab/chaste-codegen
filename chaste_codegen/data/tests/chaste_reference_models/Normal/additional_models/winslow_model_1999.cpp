...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellwinslow_model_1999FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_plateau_potassium_current_Kp_gate__Kp_V = 1.0 / (1.0 + exp(1.2521739130434784 - 0.16722408026755853 * var_chaste_interface__membrane__V)); // dimensionless
    ...
    void Cellwinslow_model_1999FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_L_type_Ca_current_y_gate__tau_y = 0.02 + 0.6 / (1.0 + exp(2.1052631578947367 + 0.10526315789473684 * var_chaste_interface__membrane__V)); // second
        const double var_L_type_Ca_current_y_gate__y_infinity = 0.2 + 0.8 / (1.0 + exp(2.5 + 0.2 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_sarcolemmal_calcium_pump__K_mpCa = 5e-05; // millimolar
        const double var_sarcolemmal_calcium_pump__i_p_Ca = var_chaste_interface__intracellular_ion_concentrations__Cai * var_sarcolemmal_calcium_pump__I_pCa / (var_chaste_interface__intracellular_ion_concentrations__Cai + var_sarcolemmal_calcium_pump__K_mpCa); // microA_per_microF
        const double var_slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks_infinity = 1.0 / (1.0 + exp(1.8161764705882353 - 0.07352941176470588 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_slow_activating_delayed_rectifiyer_K_current_X_ks_gate__tau_X_ks = 0.001 / (0.000131 * (-10.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-0.6869999999999999 + 0.0687 * var_chaste_interface__membrane__V)) + 7.19e-05 * (-10.0 + var_chaste_interface__membrane__V) / (1.0 - exp(1.48 - 0.148 * var_chaste_interface__membrane__V))); // second
        ...
        const double var_transient_outward_potassium_current_Y_to1_gate__alpha_Y_to1 = 5.415 * exp(-6.7 - 0.2 * var_chaste_interface__membrane__V) / (1.0 + 0.051335 * exp(-6.7 - 0.2 * var_chaste_interface__membrane__V)); // per_second
        const double var_transient_outward_potassium_current_Y_to1_gate__beta_Y_to1 = 5.415 * exp(6.7 + 0.2 * var_chaste_interface__membrane__V) / (1.0 + 0.051335 * exp(6.7 + 0.2 * var_chaste_interface__membrane__V)); // per_second
