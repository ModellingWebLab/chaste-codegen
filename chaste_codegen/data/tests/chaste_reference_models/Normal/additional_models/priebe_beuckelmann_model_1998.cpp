...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IK1_K1_gate__alpha_K1 = 0.1 / (1.0 + exp(-12.0 + 0.06 * var_chaste_interface__cell__V - 0.06 * var_IK1__E_K1)); // per_ms
        const double var_IK1_K1_gate__beta_K1 = (1.0 * exp(-1.0 + 0.1 * var_chaste_interface__cell__V - 0.1 * var_IK1__E_K1) + 3.0 * exp(0.02 + 0.0002 * var_chaste_interface__cell__V - 0.0002 * var_IK1__E_K1)) / (1.0 + exp(0.5 * var_IK1__E_K1 - 0.5 * var_chaste_interface__cell__V)); // per_ms
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_Ito__E_to = log((0.043 * var_Ionic_concentrations__Nao + var_Ionic_concentrations__Ko) / (0.043 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki)) / var_cell__FonRT; // mV
        const double var_ICa__i_Ca = (-var_ICa__E_Ca + var_chaste_interface__cell__V) * var_ICa__g_Ca_max * var_chaste_interface__ICa_d_gate__d * var_ICa_f_Ca_gate__f_Ca * var_chaste_interface__ICa_f_gate__f; // uA_per_uF
        const double var_ICa_d_gate__alpha_d = 0.6352401498794149 * exp(-0.8983670549147807 * pow((-1 + 0.044722719141323794 * var_chaste_interface__cell__V), 2.0)) / sqrt(M_PI); // per_ms
        const double var_ICa_d_gate__beta_d = 0.1471 - 0.25101580310038196 * exp(-0.08830693125184777 * pow((-1 + 0.15937778911130945 * var_chaste_interface__cell__V), 2.0)) / sqrt(M_PI); // per_ms
        ...
        const double var_ICa_f_gate__alpha_f = 0.006872 / (1.0 + exp(-1.005275795044346 + 0.1633373078744916 * var_chaste_interface__cell__V)); // per_ms
        const double var_ICa_f_gate__beta_f = 0.0005474 + (0.0112 + 0.0687 * exp(-1.06213655 - 0.1081 * var_chaste_interface__cell__V)) / (1.0 + exp(-2.7305064499999996 - 0.2779 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_IKr__rik = 1.0 / (1.0 + exp(1.1304347826086956 + 0.043478260869565216 * var_chaste_interface__cell__V)); // dimensionless
        const double var_IKr__i_Kr = (-var_IKr__E_K + var_chaste_interface__cell__V) * var_IKr__g_Kr_max * var_IKr__rik * var_chaste_interface__IKr_Xr_gate__Xr; // uA_per_uF
        const double var_IKr_Xr_gate__alpha_Xr = 0.005 * exp(0.0021416822000000003 + 0.0005266 * var_chaste_interface__cell__V) / (1.0 + exp(-0.5132554 - 0.1262 * var_chaste_interface__cell__V)); // per_ms
        const double var_IKr_Xr_gate__beta_Xr = 0.016 * exp(0.105056 + 0.0016 * var_chaste_interface__cell__V) / (1.0 + exp(5.141177999999999 + 0.0783 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_IKs__i_Ks = pow(var_chaste_interface__IKs_Xs_gate__Xs, 2.0) * (-var_IKs__E_Ks + var_chaste_interface__cell__V) * var_IKs__g_Ks_max; // uA_per_uF
        const double var_IKs_Xs_gate__alpha_Xs = 0.003013 / (1.0 + exp(-0.1784299893134783 - 0.06984654713594234 * var_chaste_interface__cell__V)); // per_ms
        const double var_IKs_Xs_gate__beta_Xs = 0.00587 / (1.0 + exp(1.0082174462705435 + 0.0632111251580278 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_INa__i_Na = pow(var_chaste_interface__INa_m_gate__m, 3.0) * (-var_INa__E_Na + var_chaste_interface__cell__V) * var_INa__g_Na * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j; // uA_per_uF
        const double var_INaK__f_NaK = 1.0 / (1.0 + 0.1245 * exp(-0.1 * var_cell__FonRT * var_chaste_interface__cell__V) + 0.0365 * var_INaK__sigma * exp(-var_cell__FonRT * var_chaste_interface__cell__V)); // dimensionless
        const double var_INa_h_gate__alpha_h = ((var_chaste_interface__cell__V < -40.0) ? (0.135 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V)) : (0.0)); // per_ms
        const double var_INa_h_gate__beta_h = ((var_chaste_interface__cell__V < -40.0) ? (310000.0 * exp(0.35 * var_chaste_interface__cell__V) + 3.56 * exp(0.079 * var_chaste_interface__cell__V)) : (7.692307692307692 / (1.0 + exp(-0.9603603603603604 - 0.0900900900900901 * var_chaste_interface__cell__V)))); // per_ms
        ...
        const double var_INa_j_gate__alpha_j = ((var_chaste_interface__cell__V < -40.0) ? ((37.78 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.244 * var_chaste_interface__cell__V) - 3.474e-05 * exp(-0.04391 * var_chaste_interface__cell__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))) : (0.0)); // per_ms
        const double var_INa_j_gate__beta_j = ((var_chaste_interface__cell__V < -40.0) ? (0.1212 * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 + exp(-5.5312920000000005 - 0.1378 * var_chaste_interface__cell__V))) : (0.3 * exp(-2.535e-07 * var_chaste_interface__cell__V) / (1.0 + exp(-3.2 - 0.1 * var_chaste_interface__cell__V)))); // per_ms
        ...
        const double var_INa_m_gate__alpha_m = ((fabs(47.13 + var_chaste_interface__cell__V) > 0.001) ? (0.32 * (47.13 + var_chaste_interface__cell__V) / (1.0 - exp(-4.713 - 0.1 * var_chaste_interface__cell__V))) : (3.2)); // per_ms
        ...
        const double var_Ito_r_gate__alpha_r = 0.5266 * exp(0.7020339200000001 - 0.0166 * var_chaste_interface__cell__V) / (1.0 + exp(3.9880601600000003 - 0.0943 * var_chaste_interface__cell__V)); // per_ms
        const double var_Ito_r_gate__beta_r = (0.5149 * exp(0.67236288 - 0.1344 * var_chaste_interface__cell__V) + 5.186e-05 * var_chaste_interface__cell__V) / (1.0 + exp(6.990728000000001e-06 - 0.1348 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_Ito_t_gate__alpha_t = (5.612e-05 * var_chaste_interface__cell__V + 0.0721 * exp(-5.9257863 - 0.173 * var_chaste_interface__cell__V)) / (1.0 + exp(-5.93263692 - 0.1732 * var_chaste_interface__cell__V)); // per_ms
        const double var_Ito_t_gate__beta_t = (0.0001215 * var_chaste_interface__cell__V + 0.0767 * exp(-5.647901e-08 - 1.66e-09 * var_chaste_interface__cell__V)) / (1.0 + exp(-5.457369399999999 - 0.1604 * var_chaste_interface__cell__V)); // per_ms
