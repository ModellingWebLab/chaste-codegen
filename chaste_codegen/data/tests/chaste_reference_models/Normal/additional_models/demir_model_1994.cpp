...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldemir_model_1994FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_SR_Ca_uptake_and_release__F3_orig_deriv = -0.96 * var_chaste_interface__SR_Ca_uptake_and_release__F3 + var_chaste_interface__SR_Ca_uptake_and_release__F2 * var_SR_Ca_uptake_and_release__r_inact; // 1 / second
        ...
        const double var_L_type_Ca_channel_f_gate__f_L_infinity = 1.0 / (1.0 + exp(6.0 + 0.2 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_SR_Ca_uptake_and_release__r_act = 240.0 * pow((var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i / (var_SR_Ca_uptake_and_release__k_rel + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i)), 4.0) + 240.0 * exp(-3.2 + 0.08 * var_chaste_interface__membrane__V); // per_second
        ...
        const double var_T_type_Ca_channel_d_gate__d_T_infinity = 1.0 / (1.0 + exp(-4.383333333333333 - 0.16666666666666666 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_T_type_Ca_channel_f_gate__alpha_f_T = 15.3 * exp(-0.7406962785114046 - 0.012004801920768308 * var_chaste_interface__membrane__V); // per_second
        const double var_T_type_Ca_channel_f_gate__beta_f_T = 15.0 * exp(4.011703511053316 + 0.06501950585175552 * var_chaste_interface__membrane__V); // per_second
        ...
        const double var_delayed_rectifying_potassium_current_P_a_gate__P_a_infinity = 1.0 / (1.0 + exp(-0.689189189189189 - 0.13513513513513511 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_hyperpolarisation_activated_current__i_f_K = pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2.0) * (85.0 + var_chaste_interface__membrane__V) * var_hyperpolarisation_activated_current__g_f_K; // nanoA
        const double var_hyperpolarisation_activated_current__i_f_Na = pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2.0) * (-75.0 + var_chaste_interface__membrane__V) * var_hyperpolarisation_activated_current__g_f_Na; // nanoA
        const double var_hyperpolarisation_activated_current_y_gate__tau_y = 1.0 / (1.6483 * exp(-2.2219482120838476 - 0.04110152075626799 * var_chaste_interface__membrane__V) + 14.01055 / (0.7 + exp(-10.90909090909091 - 0.18181818181818182 * var_chaste_interface__membrane__V))); // second
        const double var_hyperpolarisation_activated_current_y_gate__y_infinity = 1.0 / (1.0 + exp(8.022222222222222 + 0.1111111111111111 * var_chaste_interface__membrane__V)); // dimensionless
