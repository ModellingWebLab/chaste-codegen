...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellkurata_model_2002FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_background_muscarinic_potassium_channel_current__g_K_ACh = 0.0011 * pow(var_intracellular_ion_concentrations__Ko, 0.41); // picoA
        ...
        const double var_rapidly_activating_delayed_rectifier_potassium_current__g_Kr = 1.0 * pow(var_intracellular_ion_concentrations__Ko, 0.59) * var_rapidly_activating_delayed_rectifier_potassium_current__g_Kr_max; // nanoS
    ...
    void Cellkurata_model_2002FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_membrane__R = 8314400000000000.0; // attojoule_per_millimole_kelvin
        const double var_membrane__T = 310.15; // kelvin
        const double var_AP_sensitive_currents_q_gate__q_infinity = 1.0 / (1.0 + exp(3.7692307692307696 + 0.07692307692307693 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_AP_sensitive_currents_q_gate__tau_q = 6.06 + 39.102 / (0.065 * exp(4.593 + 0.1 * var_chaste_interface__membrane__V) + 0.57 * exp(-3.52 - 0.08 * var_chaste_interface__membrane__V)); // millisecond
        const double var_AP_sensitive_currents_r_gate__r_infinity = 1.0 / (1.0 + exp(1.2866666666666666 - 0.06666666666666667 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_AP_sensitive_currents_r_gate__tau_r = 2.75352 + 14.405159999999999 / (1.037 * exp(2.7548999999999997 + 0.09 * var_chaste_interface__membrane__V) + 0.369 * exp(-2.8608 - 0.12 * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_L_type_calcium_channel_current__i_CaL = (-var_L_type_calcium_channel_current__E_CaL + var_chaste_interface__membrane__V) * var_L_type_calcium_channel_current__g_CaL * var_chaste_interface__L_type_calcium_channel_current_d_gate__d * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa * var_chaste_interface__L_type_calcium_channel_current_f_gate__f; // picoA
        const double var_L_type_calcium_channel_current_d_gate__alpha_d = -0.02839 * (35.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-14.0 - 0.4 * var_chaste_interface__membrane__V)) - 0.0849 * var_chaste_interface__membrane__V / (-1.0 + exp(-0.2079866888519135 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_L_type_calcium_channel_current_d_gate__beta_d = 0.01143 * (-5.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(-2.0 + 0.4 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_L_type_calcium_channel_current_d_gate__d_infinity = 1.0 / (1.0 + exp(-2.3499999999999996 - 0.16666666666666666 * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_L_type_calcium_channel_current_f_gate__f_infinity = 1.0 / (1.0 + exp(6.0 + 0.2 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_L_type_calcium_channel_current_f_gate__tau_f = 44.3 + 257.1 * exp(-5.466849541949173 * pow((1 + 0.03076923076923077 * var_chaste_interface__membrane__V), 2.0)); // millisecond
        ...
        const double var_T_type_calcium_channel_current__i_CaT = (-var_T_type_calcium_channel_current__E_CaT + var_chaste_interface__membrane__V) * var_T_type_calcium_channel_current__g_CaT * var_chaste_interface__T_type_calcium_channel_current_d_gate__d * var_chaste_interface__T_type_calcium_channel_current_f_gate__f; // picoA
        const double var_T_type_calcium_channel_current_d_gate__d_infinity = 1.0 / (1.0 + exp(-4.383333333333333 - 0.16666666666666666 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_T_type_calcium_channel_current_d_gate__tau_d = 1.0 / (1.068 * exp(0.8766666666666667 + 0.03333333333333333 * var_chaste_interface__membrane__V) + 1.068 * exp(-0.8766666666666667 - 0.03333333333333333 * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_T_type_calcium_channel_current_f_gate__tau_f = 1.0 / (0.015 * exp(4.011703511053316 + 0.06501950585175552 * var_chaste_interface__membrane__V) + 0.0153 * exp(-0.7406962785114046 - 0.012004801920768308 * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_background_muscarinic_potassium_channel_current__i_K_ACh = 1.0 * (-var_intracellular_ion_concentrations__Ko * exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + var_chaste_interface__intracellular_ion_concentrations__Ki) * var_background_muscarinic_potassium_channel_current__g_K_ACh; // picoA
        const double var_hyperpolarisation_activated_current_y_gate__tau_y = 0.7166529 / (exp(-8.540461789766457 - 0.022074080614542406 * var_chaste_interface__membrane__V) + exp(-3.800114398627216 + 0.051999376007487906 * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__tau_paF = 0.84655354 / (0.0372 * exp(0.06289308176100629 * var_chaste_interface__membrane__V) + 0.00096 * exp(-0.044444444444444446 * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pa_gate__tau_paS = 0.84655354 / (0.0042 * exp(0.058823529411764705 * var_chaste_interface__membrane__V) + 0.00015 * exp(-0.046296296296296294 * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__pi_infinity = 1.0 / (1.0 + exp(1.672514619883041 + 0.05847953216374269 * var_chaste_interface__membrane__V)); // dimensionless
        const double var_rapidly_activating_delayed_rectifier_potassium_current_pi_gate__tau_pi = 1.0 / (0.1 * exp(-0.018299935950224173 * var_chaste_interface__membrane__V) + 0.656 * exp(0.009420009985210585 * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_sustained_inward_current__E_st = 37.4; // millivolt
        const double var_sustained_inward_current__g_st = 0.015; // nanoS
        const double var_sustained_inward_current_qa_gate__alpha_qa = 1.0 / (0.2 * exp(-0.0014285714285714286 * var_chaste_interface__membrane__V) + 0.15 * exp(-0.09090909090909091 * var_chaste_interface__membrane__V)); // per_millisecond
        ...
        const double var_sustained_inward_current_qa_gate__qa_infinity = 1.0 / (1.0 + exp(-11.4 - 0.2 * var_chaste_interface__membrane__V)); // dimensionless
