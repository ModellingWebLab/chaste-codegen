...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellaslanidi_Purkinje_model_2009FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_i_NaK__i_NaK = var_i_NaK__f_NaK * var_i_NaK__g_NaK * mParameters[5] / ((1 + pow(var_i_NaK__km_Na_i_2, 2) / pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2)) * (var_i_NaK__km_K_o + mParameters[5])); // microA_per_microF
