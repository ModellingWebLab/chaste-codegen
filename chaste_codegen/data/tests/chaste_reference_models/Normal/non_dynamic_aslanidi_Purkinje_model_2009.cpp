...
#include "ChasteCpuMacros.hpp"
    ...
    double Cellaslanidi_Purkinje_model_2009FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_background_currents__g_Cl_b = CHASTE_CONST(0.00022499999999999999); // milliS_per_microF
        const double var_background_currents__g_K_b = CHASTE_CONST(0.0050000000000000001); // milliS_per_microF
        const double var_background_currents__g_Na_b = CHASTE_CONST(0.0025000000000000001); // milliS_per_microF
        const double var_background_currents__p_Ca_b = CHASTE_CONST(1.9950840000000001e-7); // cm_per_second
        ...
        const double var_i_Ca_T__g_Ca_T = CHASTE_CONST(0.13); // milliS_per_microF
        const double var_i_Ca_p__i_Ca_p_max = CHASTE_CONST(0.057500000000000002); // microA_per_microF
        const double var_i_Ca_p__km_Ca_p = CHASTE_CONST(0.00050000000000000001); // millimolar
        ...
        const double var_i_K_p__g_K_p = CHASTE_CONST(0.0027599999999999999); // milliS_per_microF
        const double var_i_Ks__g_Ks = (1 + CHASTE_CONST(0.59999999999999998) / (1 + CHASTE_CONST(6.4818210260626455e-7) * CHASTE_MATH::Pow((1 / var_chaste_interface__Ca_i__Ca_i), CHASTE_CONST(1.3999999999999999)))) * mParameters[13]; // milliS_per_microF
        ...
        const double var_i_NaK__g_NaK = CHASTE_CONST(0.61875000000000002); // microA_per_microF
        const double var_i_NaK__km_K_o = CHASTE_CONST(1.5); // millimolar
        const double var_i_NaK__km_Na_i_2 = 10; // millimolar
        const double var_i_Na_L__g_Na_L = CHASTE_CONST(0.037374999999999999); // milliS_per_microF
        const double var_i_to_2__p_Cl = CHASTE_CONST(3.9999999999999998e-7); // cm_per_second
        ...
        const double var_i_Kr__rr_infinity = 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(0.26470588235294124) + CHASTE_CONST(0.049019607843137261) * var_chaste_interface__membrane__V)); // dimensionless
        const double var_i_NaCa__dNaCa_1 = CHASTE_MATH::Pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * var_i_NaCa__km_Ca_o + CHASTE_CONST(1.5) * CHASTE_MATH::Pow(var_i_NaCa__km_Na_o, 3) * var_chaste_interface__Ca_i__Ca_i + CHASTE_MATH::Pow(var_i_NaCa__km_Na_i_1, 3) * (1 + CHASTE_CONST(1.5) * var_chaste_interface__Ca_i__Ca_i / var_i_NaCa__km_Ca_i) * mParameters[4]; // millimolar4
        ...
        const double var_i_K1__g_K1 = CHASTE_CONST(0.43033148291193518) * CHASTE_MATH::Sqrt(mParameters[5]) * mParameters[11]; // milliS_per_microF
        const double var_i_Kr__g_Kr = CHASTE_CONST(0.43033148291193518) * CHASTE_MATH::Sqrt(mParameters[5]) * mParameters[12]; // milliS_per_microF
        const double var_i_NaCa__dNaCa_2 = CHASTE_MATH::Pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * mParameters[4] + CHASTE_CONST(1.5) * CHASTE_MATH::Pow(mParameters[6], 3) * var_chaste_interface__Ca_i__Ca_i + CHASTE_MATH::Pow(mParameters[6], 3) * (1 + var_chaste_interface__intracellular_ion_concentrations__Na_i / var_i_NaCa__km_Na_i_1) * var_i_NaCa__km_Ca_i; // millimolar4
        const double var_i_NaK__sigma = -CHASTE_CONST(0.14285714285714285) + CHASTE_CONST(0.14285714285714285) * CHASTE_MATH::Exp(CHASTE_CONST(0.01485884101040119) * mParameters[6]); // dimensionless
        const double var_model_parameters__R = 8314; // joule_per_kilomole_kelvin
        const double var_model_parameters__T = 310; // kelvin
        const double var_equilibrium_potentials__E_Cl = -var_model_parameters__R * var_model_parameters__T * CHASTE_MATH::Log(var_model_parameters__Cl_o / var_chaste_interface__intracellular_ion_concentrations__Cl_i) / var_model_parameters__F; // millivolt
        ...
        const double var_equilibrium_potentials__E_K = var_model_parameters__R * var_model_parameters__T * CHASTE_MATH::Log(mParameters[5] / var_chaste_interface__intracellular_ion_concentrations__K_i) / var_model_parameters__F; // millivolt
        ...
        const double var_equilibrium_potentials__E_Ks = var_model_parameters__R * var_model_parameters__T * CHASTE_MATH::Log((var_equilibrium_potentials__r_NaK * mParameters[6] + mParameters[5]) / (var_equilibrium_potentials__r_NaK * var_chaste_interface__intracellular_ion_concentrations__Na_i + var_chaste_interface__intracellular_ion_concentrations__K_i)) / var_model_parameters__F; // millivolt
        const double var_equilibrium_potentials__E_Na = var_model_parameters__R * var_model_parameters__T * CHASTE_MATH::Log(mParameters[6] / var_chaste_interface__intracellular_ion_concentrations__Na_i) / var_model_parameters__F; // millivolt
        ...
        const double var_i_K1__i_K1 = (CHASTE_CONST(0.0040000000000000001) + var_i_K1__g_K1 * var_i_K1_xK1_gate__xK1) * (-var_equilibrium_potentials__E_K + var_chaste_interface__membrane__V); // microA_per_microF
        ...
        const double var_i_Na__i_Na = CHASTE_MATH::Pow(var_chaste_interface__i_Na_m_gate__m, 3) * (-var_equilibrium_potentials__E_Na + var_chaste_interface__membrane__V) * (CHASTE_CONST(0.20000000000000001) * var_chaste_interface__i_Na_j_gate__j + CHASTE_CONST(0.80000000000000004) * var_chaste_interface__i_Na_h_gate__h) * mParameters[8]; // microA_per_microF
        const double var_i_NaCa__i_NaCa = (-CHASTE_CONST(1.5) * CHASTE_MATH::Pow(mParameters[6], 3) * var_chaste_interface__Ca_i__Ca_i * CHASTE_MATH::Exp(-CHASTE_CONST(0.65000000000000002) * var_chaste_interface__membrane__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T)) + CHASTE_MATH::Pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * var_i_NaCa__X_NaCa * mParameters[14] * mParameters[4] * CHASTE_MATH::Exp(CHASTE_CONST(0.34999999999999998) * var_chaste_interface__membrane__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T))) / ((1 + var_i_NaCa__k_sat * CHASTE_MATH::Exp(-CHASTE_CONST(0.65000000000000002) * var_chaste_interface__membrane__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T))) * (1 + CHASTE_CONST(0.44444444444444442) * CHASTE_MATH::Pow(var_i_NaCa__km_Ca_act, 2) / CHASTE_MATH::Pow(var_chaste_interface__Ca_i__Ca_i, 2)) * (var_i_NaCa__dNaCa_1 + var_i_NaCa__dNaCa_2)); // microA_per_microF
        const double var_i_NaK__f_NaK = 1 / (1 + CHASTE_CONST(0.1245) * CHASTE_MATH::Exp(-CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T)) + CHASTE_CONST(0.036499999999999998) * var_i_NaK__sigma * CHASTE_MATH::Exp(-var_chaste_interface__membrane__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T))); // dimensionless
        const double var_i_NaK__i_NaK = var_i_NaK__f_NaK * var_i_NaK__g_NaK * mParameters[5] / ((1 + CHASTE_MATH::Pow(var_i_NaK__km_Na_i_2, 2) / CHASTE_MATH::Pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2)) * (var_i_NaK__km_K_o + mParameters[5])); // microA_per_microF
        const double var_i_Na_L__i_Na_L = CHASTE_MATH::Pow(var_chaste_interface__i_Na_L_m_L_gate__m_L, 3) * (-var_equilibrium_potentials__E_Na + var_chaste_interface__membrane__V) * var_i_Na_L__g_Na_L * var_chaste_interface__i_Na_L_h_L_gate__h_L; // microA_per_microF
        const double var_i_to_1__i_to_1 = (-var_equilibrium_potentials__E_K + var_chaste_interface__membrane__V) * (CHASTE_CONST(0.20000000000000001) * var_chaste_interface__i_to_1_i2_gate__i2 + CHASTE_CONST(0.80000000000000004) * var_chaste_interface__i_to_1_i_gate__i) * mParameters[15] * var_chaste_interface__i_to_1_a_gate__a; // microA_per_microF
        const double var_i_to_2__i_to_2_max = CHASTE_MATH::Pow(var_i_to_2__z_Cl, 2) * CHASTE_MATH::Pow(var_model_parameters__F, 2) * (-var_model_parameters__Cl_o * CHASTE_MATH::Exp(-var_i_to_2__z_Cl * var_chaste_interface__membrane__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T)) + var_chaste_interface__intracellular_ion_concentrations__Cl_i) * var_i_to_2__p_Cl * var_chaste_interface__membrane__V / ((1 - CHASTE_MATH::Exp(-var_i_to_2__z_Cl * var_chaste_interface__membrane__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T))) * var_model_parameters__Cm * var_model_parameters__R * var_model_parameters__T); // microA_per_microF
        ...
        const double var_background_currents__i_Ca_b = CHASTE_MATH::Pow(var_model_parameters__F, 2) * CHASTE_MATH::Pow(var_model_parameters__z_Ca, 2) * (-mParameters[4] * var_model_parameters__gamma_Cao + var_chaste_interface__Ca_i__Ca_i * var_model_parameters__gamma_Cai * CHASTE_MATH::Exp(var_chaste_interface__membrane__V * var_model_parameters__F * var_model_parameters__z_Ca / (var_model_parameters__R * var_model_parameters__T))) * var_background_currents__p_Ca_b * var_chaste_interface__membrane__V / ((-1 + CHASTE_MATH::Exp(var_chaste_interface__membrane__V * var_model_parameters__F * var_model_parameters__z_Ca / (var_model_parameters__R * var_model_parameters__T))) * var_model_parameters__Cm * var_model_parameters__R * var_model_parameters__T); // microA_per_microF
    ...
    void Cellaslanidi_Purkinje_model_2009FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_CT_K_Cl__CT_K_Cl_max = CHASTE_CONST(7.0755999999999996e-6); // millimolar_per_millisecond
        const double var_CT_Na_Cl__CT_Na_Cl_max = CHASTE_CONST(9.8442999999999999e-6); // millimolar_per_millisecond
        const double var_Ca_JSR__CSQN_max = 10; // millimolar
        const double var_Ca_JSR__km_CSQN = CHASTE_CONST(0.80000000000000004); // millimolar
        const double var_Ca_MK_act__Ca_MK_0 = CHASTE_CONST(0.050000000000000003); // dimensionless
        const double var_Ca_MK_act__alpha_Ca_MK = CHASTE_CONST(0.050000000000000003); // per_millisecond
        const double var_Ca_MK_act__beta_Ca_MK = CHASTE_CONST(0.00068000000000000005); // per_millisecond
        const double var_Ca_MK_act__km_Ca_MK = CHASTE_CONST(0.14999999999999999); // millimolar
        const double var_Ca_i__CMDN_max = CHASTE_CONST(0.050000000000000003); // millimolar
        const double var_Ca_i__TRPN_max = CHASTE_CONST(0.070000000000000007); // millimolar
        const double var_Ca_i__km_CMDN = CHASTE_CONST(0.0023800000000000002); // millimolar
        const double var_Ca_i__CMDN = 2 * var_Ca_i__CMDN_max * var_chaste_interface__Ca_i__Ca_i / CHASTE_MATH::Pow((var_chaste_interface__Ca_i__Ca_i + var_Ca_i__km_CMDN), 2); // dimensionless
        const double var_Ca_i__km_TRPN = CHASTE_CONST(0.00050000000000000001); // millimolar
        const double var_Ca_i__TRPN = 2 * var_chaste_interface__Ca_i__Ca_i * var_Ca_i__TRPN_max / CHASTE_MATH::Pow((var_chaste_interface__Ca_i__Ca_i + var_Ca_i__km_TRPN), 2); // dimensionless
        ...
        const double var_Ca_r__b_SL_max = CHASTE_CONST(1.1240000000000001); // millimolar
        const double var_Ca_r__b_SR_max = CHASTE_CONST(0.047); // millimolar
        const double var_Ca_r__km_b_SL = CHASTE_CONST(0.0086999999999999994); // millimolar
        const double var_Ca_r__b_SL = 2 * var_chaste_interface__Ca_r__Ca_r * var_Ca_r__b_SL_max / CHASTE_MATH::Pow((var_chaste_interface__Ca_r__Ca_r + var_Ca_r__km_b_SL), 2); // dimensionless
        const double var_Ca_r__km_b_SR = CHASTE_CONST(0.00087000000000000001); // millimolar
        const double var_Ca_r__b_SR = 2 * var_chaste_interface__Ca_r__Ca_r * var_Ca_r__b_SR_max / CHASTE_MATH::Pow((var_chaste_interface__Ca_r__Ca_r + var_Ca_r__km_b_SR), 2); // dimensionless
        const double var_Ca_r__Ca_r_tot = 1 / (1 + var_Ca_r__b_SL + var_Ca_r__b_SR); // dimensionless
        const double var_Ca_r__tau_ss = CHASTE_CONST(0.20000000000000001); // millisecond
        ...
        const double var_i_to_2__p_Cl = CHASTE_CONST(3.9999999999999998e-7); // cm_per_second
        const double var_i_to_2__z_Cl = -1; // dimensionless
        const double var_i_to_2_a_gate__km_to_2 = CHASTE_CONST(0.1502); // millimolar
        ...
        const double var_i_Ca_L_d_gate__d_infinity = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(0.59347181008902072) - CHASTE_CONST(0.14836795252225518) * var_chaste_interface__membrane__V)); // dimensionless
        const double var_i_Ca_L_d_gate__tau_d = CHASTE_CONST(0.58999999999999997) + CHASTE_CONST(0.80000000000000004) * CHASTE_MATH::Exp(CHASTE_CONST(0.67599999999999993) + CHASTE_CONST(0.051999999999999998) * var_chaste_interface__membrane__V) / (1 + CHASTE_MATH::Exp(CHASTE_CONST(1.7160000000000002) + CHASTE_CONST(0.13200000000000001) * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_i_Ca_L_f2_gate__f2_infinity = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(1.8) + CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_i_Ca_L_f_gate__f_infinity = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(1.8) + CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_i_Ca_T_b_gate__alpha_b = CHASTE_CONST(1.0680000000000001) * CHASTE_MATH::Exp(CHASTE_CONST(0.54333333333333333) + CHASTE_CONST(0.033333333333333333) * var_chaste_interface__membrane__V); // per_millisecond
        const double var_i_Ca_T_b_gate__b_infinity = 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(5.4098360655737707) - CHASTE_CONST(0.16393442622950821) * var_chaste_interface__membrane__V)); // dimensionless
        const double var_i_Ca_T_b_gate__beta_b = CHASTE_CONST(1.0680000000000001) * CHASTE_MATH::Exp(-CHASTE_CONST(0.54333333333333333) - CHASTE_CONST(0.033333333333333333) * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double var_i_Ca_T_g_gate__beta_g = CHASTE_CONST(0.014999999999999999) * CHASTE_MATH::Exp(CHASTE_CONST(4.6558441558441563) + CHASTE_CONST(0.064935064935064929) * var_chaste_interface__membrane__V); // per_millisecond
        const double var_i_Ca_T_g_gate__g_infinity = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(9.0909090909090917) + CHASTE_CONST(0.15151515151515152) * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_i_K_p__kp = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(1.2521739130434781) - CHASTE_CONST(0.16722408026755853) * var_chaste_interface__membrane__V)); // dimensionless
        const double var_i_Kr__rr_infinity = 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(0.26470588235294124) + CHASTE_CONST(0.049019607843137261) * var_chaste_interface__membrane__V)); // dimensionless
        const double var_i_Kr_xr_gate__tau_xr = 100 + 900 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(0.20000000000000001) * var_chaste_interface__membrane__V)); // millisecond
        const double var_i_Kr_xr_gate__xr_infinity = 1 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(0.0069387755102040824) - CHASTE_CONST(0.081632653061224483) * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_i_Ks_xs2_gate__xs2_infinity = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(0.65693430656934315) - CHASTE_CONST(0.072992700729927015) * var_chaste_interface__membrane__V)); // dimensionless
        ...
        const double var_i_Na_L_h_L_gate__h_L_infinity = 1 / (1 + CHASTE_MATH::Exp(CHASTE_CONST(11.311475409836067) + CHASTE_CONST(0.16393442622950821) * var_chaste_interface__membrane__V)); // dimensionless
        const double var_i_Na_L_h_L_gate__tau_h_L = 175 + 125 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(4.166666666666667) - CHASTE_CONST(0.16666666666666666) * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_i_Na_L_m_L_gate__alpha_m_L = CHASTE_CONST(0.32000000000000001) * (CHASTE_CONST(47.130000000000003) + var_chaste_interface__membrane__V) / (1 - CHASTE_MATH::Exp(-CHASTE_CONST(4.7130000000000001) - CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_i_Na_L_m_L_gate__beta_m_L = CHASTE_CONST(0.080000000000000002) * CHASTE_MATH::Exp(-CHASTE_CONST(0.090909090909090912) * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double var_i_Na_m_gate__alpha_m = CHASTE_CONST(0.32000000000000001) * (CHASTE_CONST(47.130000000000003) + var_chaste_interface__membrane__V) / (1 - CHASTE_MATH::Exp(-CHASTE_CONST(4.7130000000000001) - CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_i_Na_m_gate__beta_m = CHASTE_CONST(0.080000000000000002) * CHASTE_MATH::Exp(-CHASTE_CONST(0.090909090909090912) * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double var_i_to_1_a_gate__alpha_a = 25 * CHASTE_MATH::Exp(-CHASTE_CONST(3.7999999999999998) + CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane__V) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(3.7999999999999998) + CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_i_to_1_a_gate__beta_a = 25 * CHASTE_MATH::Exp(-CHASTE_CONST(2.7000000000000002) - CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane__V) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(2.7000000000000002) - CHASTE_CONST(0.050000000000000003) * var_chaste_interface__membrane__V)); // per_millisecond
        ...
        const double var_i_to_1_i2_gate__alpha_i2 = CHASTE_CONST(0.0044200000000000003) / (1 + CHASTE_MATH::Exp(CHASTE_CONST(1.7333333333333334) + CHASTE_CONST(0.066666666666666666) * var_chaste_interface__membrane__V)); // per_millisecond
        ...
        const double var_i_to_1_i2_gate__tau_i2 = CHASTE_CONST(21.5) + 30 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(2.5) + CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_i_to_1_i_gate__alpha_i = CHASTE_CONST(0.029999999999999999) / (1 + CHASTE_MATH::Exp(CHASTE_CONST(1.6666666666666667) + CHASTE_CONST(0.066666666666666666) * var_chaste_interface__membrane__V)); // per_millisecond
        ...
        const double var_i_to_1_i_gate__tau_i = 6 + 5 / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(1.6499999999999999) + CHASTE_CONST(0.10000000000000001) * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_i_NaK__sigma = -CHASTE_CONST(0.14285714285714285) + CHASTE_CONST(0.14285714285714285) * CHASTE_MATH::Exp(CHASTE_CONST(0.01485884101040119) * mp_extracellular_sodium_concentration_modifier->Calc(mParameters[6], var_chaste_interface__environment__time)); // dimensionless
        const double var_model_parameters__R = 8314; // joule_per_kilomole_kelvin
        const double var_model_parameters__T = 310; // kelvin
        const double var_equilibrium_potentials__E_Cl = -var_model_parameters__R * var_model_parameters__T * CHASTE_MATH::Log(var_model_parameters__Cl_o / var_chaste_interface__intracellular_ion_concentrations__Cl_i) / var_model_parameters__F; // millivolt
        const double var_background_currents__i_Cl_b = (-var_equilibrium_potentials__E_Cl + var_chaste_interface__membrane__V) * var_background_currents__g_Cl_b; // microA_per_microF
        ...
        const double var_CT_K_Cl__CT_K_Cl = (-var_equilibrium_potentials__E_Cl + var_equilibrium_potentials__E_K) * var_CT_K_Cl__CT_K_Cl_max / (CHASTE_CONST(87.825100000000006) - var_equilibrium_potentials__E_Cl + var_equilibrium_potentials__E_K); // millimolar_per_millisecond
        const double var_background_currents__i_K_b = (-var_equilibrium_potentials__E_K + var_chaste_interface__membrane__V) * var_background_currents__g_K_b; // microA_per_microF
        ...
        const double var_CT_Na_Cl__CT_Na_Cl = CHASTE_MATH::Pow((-var_equilibrium_potentials__E_Cl + var_equilibrium_potentials__E_Na), 4) * var_CT_Na_Cl__CT_Na_Cl_max / (CHASTE_CONST(59494197.640692554) + CHASTE_MATH::Pow((-var_equilibrium_potentials__E_Cl + var_equilibrium_potentials__E_Na), 4)); // millimolar_per_millisecond
        const double var_background_currents__i_Na_b = (-var_equilibrium_potentials__E_Na + var_chaste_interface__membrane__V) * var_background_currents__g_Na_b; // microA_per_microF
        const double var_i_K1_xK1_gate__alpha_xK1 = CHASTE_CONST(1.02) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(14.1227775) + CHASTE_CONST(0.23849999999999999) * var_chaste_interface__membrane__V - CHASTE_CONST(0.23849999999999999) * var_equilibrium_potentials__E_K)); // dimensionless
        const double var_i_K1_xK1_gate__beta_xK1 = (CHASTE_CONST(0.49124000000000001) * CHASTE_MATH::Exp(CHASTE_CONST(0.43983232) + CHASTE_CONST(0.080320000000000003) * var_chaste_interface__membrane__V - CHASTE_CONST(0.080320000000000003) * var_equilibrium_potentials__E_K) + CHASTE_MATH::Exp(-CHASTE_CONST(36.698642499999998) + CHASTE_CONST(0.061749999999999999) * var_chaste_interface__membrane__V - CHASTE_CONST(0.061749999999999999) * var_equilibrium_potentials__E_K)) / (1 + CHASTE_MATH::Exp(-CHASTE_CONST(2.4444678999999998) + CHASTE_CONST(0.51429999999999998) * var_equilibrium_potentials__E_K - CHASTE_CONST(0.51429999999999998) * var_chaste_interface__membrane__V)); // dimensionless
        const double var_i_K1_xK1_gate__xK1 = var_i_K1_xK1_gate__alpha_xK1 / (var_i_K1_xK1_gate__alpha_xK1 + var_i_K1_xK1_gate__beta_xK1); // dimensionless
        ...
        const double var_i_to_2__i_to_2_max = CHASTE_MATH::Pow(var_i_to_2__z_Cl, 2) * CHASTE_MATH::Pow(var_model_parameters__F, 2) * (-var_model_parameters__Cl_o * CHASTE_MATH::Exp(-var_i_to_2__z_Cl * var_chaste_interface__membrane__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T)) + var_chaste_interface__intracellular_ion_concentrations__Cl_i) * var_i_to_2__p_Cl * var_chaste_interface__membrane__V / ((1 - CHASTE_MATH::Exp(-var_i_to_2__z_Cl * var_chaste_interface__membrane__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T))) * var_model_parameters__Cm * var_model_parameters__R * var_model_parameters__T); // microA_per_microF
        const double var_i_to_2__i_to_2 = 20 * var_i_to_2__i_to_2_max * var_chaste_interface__i_to_2_a_gate__a; // microA_per_microF
        const double var_model_parameters__Vol_cell = CHASTE_CONST(0.34539999999999998); // microlitre
        const double var_model_parameters__Vol_jsr = CHASTE_CONST(0.0047999999999999996) * var_model_parameters__Vol_cell; // microlitre
        const double var_model_parameters__Vol_myo = CHASTE_CONST(0.68000000000000005) * var_model_parameters__Vol_cell; // microlitre
        const double var_model_parameters__Vol_nsr = CHASTE_CONST(0.055199999999999999) * var_model_parameters__Vol_cell; // microlitre
        const double var_model_parameters__Vol_ss = CHASTE_CONST(0.02) * var_model_parameters__Vol_cell; // microlitre
        const double var_model_parameters__gamma_Cai = 1; // dimensionless
        const double var_model_parameters__gamma_Cao = CHASTE_CONST(0.34100000000000003); // dimensionless
        const double var_model_parameters__length = CHASTE_CONST(0.01); // cm
        const double var_model_parameters__radius = CHASTE_CONST(0.0011000000000000001); // cm
        const double var_model_parameters__a_geo = CHASTE_CONST(6.2800000000000002) * CHASTE_MATH::Pow(var_model_parameters__radius, 2) + CHASTE_CONST(6.2800000000000002) * var_model_parameters__length * var_model_parameters__radius; // cm2
        ...
        const double var_model_parameters__z_Ca = 2; // dimensionless
        const double var_background_currents__i_Ca_b = CHASTE_MATH::Pow(var_model_parameters__F, 2) * CHASTE_MATH::Pow(var_model_parameters__z_Ca, 2) * (-mp_extracellular_calcium_concentration_modifier->Calc(mParameters[4], var_chaste_interface__environment__time) * var_model_parameters__gamma_Cao + var_chaste_interface__Ca_i__Ca_i * var_model_parameters__gamma_Cai * CHASTE_MATH::Exp(var_chaste_interface__membrane__V * var_model_parameters__F * var_model_parameters__z_Ca / (var_model_parameters__R * var_model_parameters__T))) * var_background_currents__p_Ca_b * var_chaste_interface__membrane__V / ((-1 + CHASTE_MATH::Exp(var_chaste_interface__membrane__V * var_model_parameters__F * var_model_parameters__z_Ca / (var_model_parameters__R * var_model_parameters__T))) * var_model_parameters__Cm * var_model_parameters__R * var_model_parameters__T); // microA_per_microF
        ...
        const double var_i_Ca_L_f_Ca_gate__f_Ca_infinity = CHASTE_CONST(0.14999999999999999) + CHASTE_CONST(0.55000000000000004) / (1 + CHASTE_CONST(333.33333333333331) * var_chaste_interface__Ca_r__Ca_r) + CHASTE_CONST(0.29999999999999999) / (1 - 20 * var_i_Ca_L__i_Ca_L); // dimensionless
        ...
        const double var_q_rel_ri_gate__ri_infinity = 1 / (1 + CHASTE_MATH::Exp(-16 + 80 * var_q_rel_ri_gate__Ca_fac + 40000 * var_chaste_interface__Ca_r__Ca_r)); // dimensionless
        ...
        const double var_q_rel_ro_gate__ro_infinity_JSR = CHASTE_MATH::Pow(var_chaste_interface__Ca_JSR__Ca_JSR, CHASTE_CONST(1.8999999999999999)) / (CHASTE_MATH::Pow(var_chaste_interface__Ca_JSR__Ca_JSR, CHASTE_CONST(1.8999999999999999)) + CHASTE_CONST(1644.6531773416521) * CHASTE_MATH::Pow((var_chaste_interface__Ca_r__Ca_r / (CHASTE_CONST(0.0028) + var_chaste_interface__Ca_r__Ca_r)), CHASTE_CONST(1.8999999999999999))); // dimensionless
        const double var_q_rel_ro_gate__ro_infinity = CHASTE_MATH::Pow(var_i_Ca_L__i_Ca_L, 2) * var_q_rel_ro_gate__ro_infinity_JSR / (1 + CHASTE_MATH::Pow(var_i_Ca_L__i_Ca_L, 2)); // dimensionless
        ...
        const double d_dt_chaste_interface_var_Ca_JSR__Ca_JSR = (-var_q_rel__q_rel + var_q_tr__q_tr) / (1 + var_Ca_JSR__CSQN_max * var_Ca_JSR__km_CSQN / CHASTE_MATH::Pow((var_chaste_interface__Ca_JSR__Ca_JSR + var_Ca_JSR__km_CSQN), 2)); // millimolar / millisecond
        const double var_q_up__X_q_up = CHASTE_CONST(0.5); // dimensionless
        const double var_q_up__dkm_plb_max = CHASTE_CONST(0.00017000000000000001); // millimolar
        ...
        const double var_q_up__dq_up_Ca_MK_max = CHASTE_CONST(0.75); // dimensionless
