...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Dynamicluo_rudy_1994FromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Dynamicluo_rudy_1994FromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }

    Dynamicluo_rudy_1994FromCellML::Dynamicluo_rudy_1994FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                12,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Dynamicluo_rudy_1994FromCellML>::Instance();
        Init();
    ...
    Dynamicluo_rudy_1994FromCellML::~Dynamicluo_rudy_1994FromCellML()
    {
    }

    double Dynamicluo_rudy_1994FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Dynamicluo_rudy_1994FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Dynamicluo_rudy_1994FromCellML>::Initialise(void)
{
...
extern "C"
{
    ...
    {
        return new Dynamicluo_rudy_1994FromCellML(pSolver, pStimulus);
    }
