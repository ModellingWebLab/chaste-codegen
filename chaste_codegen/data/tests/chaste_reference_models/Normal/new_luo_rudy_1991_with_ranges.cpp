...
#include "new_luo_rudy_1991_with_ranges.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellnew_luo_rudy_1991_with_rangesFromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellnew_luo_rudy_1991_with_rangesFromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[1];
    }

    Cellnew_luo_rudy_1991_with_rangesFromCellML::Cellnew_luo_rudy_1991_with_rangesFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                8,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellnew_luo_rudy_1991_with_rangesFromCellML>::Instance();
        Init();
    ...
    Cellnew_luo_rudy_1991_with_rangesFromCellML::~Cellnew_luo_rudy_1991_with_rangesFromCellML()
    {
    }

    
    void Cellnew_luo_rudy_1991_with_rangesFromCellML::VerifyStateVariables()
    {
    ...
    double Cellnew_luo_rudy_1991_with_rangesFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_slow_inward_current__E_si = 7.7000000000000002 - 13.028700000000001 * log(1.0 * var_chaste_interface__intracellular_calcium_concentration__Cai); // millivolt
    ...
    void Cellnew_luo_rudy_1991_with_rangesFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellnew_luo_rudy_1991_with_rangesFromCellML>::Initialise(void)
{
