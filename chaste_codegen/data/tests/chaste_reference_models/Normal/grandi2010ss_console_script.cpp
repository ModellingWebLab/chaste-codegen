...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellgrandi2010ssFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_cell__Ka_junc = 1 / (1.0 + pow((var_cell__Kdact / var_chaste_interface__cell__sCaj), 2)); // dimensionless
        ...
        const double var_cell__Ka_sl = 1 / (1.0 + pow((var_cell__Kdact / var_chaste_interface__cell__sCasl), 2)); // dimensionless
        ...
        const double var_cell__I_nak_junc = var_cell__Fjunc * var_cell__IbarNaK * var_cell__Ko * var_cell__fnak / ((1.0 + pow((var_cell__KmNaip / var_chaste_interface__cell__sNaj), 4)) * (var_cell__KmKo + var_cell__Ko)); // dimensionless
        const double var_cell__I_nak_sl = var_cell__Fsl * var_cell__IbarNaK * var_cell__Ko * var_cell__fnak / ((1.0 + pow((var_cell__KmNaip / var_chaste_interface__cell__sNasl), 4)) * (var_cell__KmKo + var_cell__Ko)); // dimensionless
