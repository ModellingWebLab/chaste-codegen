...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellbondarenko_model_2004_apexFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_activated_chloride_current__O_ClCa = 0.2 / (1.0 + exp(5.987179487179488 - 0.12820512820512822 * var_chaste_interface__membrane__V)); // dimensionless
    ...
    void Cellbondarenko_model_2004_apexFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_L_type_calcium_current__I2 = var_chaste_interface__L_type_calcium_current__I3 * var_L_type_calcium_current__Kpcb - var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__gamma + 0.001 * var_L_type_calcium_current__Kpcf * var_chaste_interface__L_type_calcium_current__O + 0.002 * var_chaste_interface__L_type_calcium_current__C4 * var_L_type_calcium_current__Kpcf - 0.001 * var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__alpha - 0.008 * var_chaste_interface__L_type_calcium_current__I2 * var_L_type_calcium_current__beta; // 1 / millisecond
        ...
        const double var_L_type_calcium_current__i_CaL = (-var_L_type_calcium_current__E_CaL + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_calcium_current__O * var_L_type_calcium_current__g_CaL; // picoA_per_picoF
        const double d_dt_chaste_interface_var_calcium_fluxes__P_RyR = -0.04 * var_chaste_interface__calcium_fluxes__P_RyR - 0.1 * var_L_type_calcium_current__i_CaL * exp(-0.038580246913580245 * pow((-1 + 0.2 * var_chaste_interface__membrane__V), 2.0)) / var_L_type_calcium_current__i_CaL_max; // 1 / millisecond
        const double var_calcium_background_current__i_Cab = (-var_calcium_background_current__E_CaN + var_chaste_interface__membrane__V) * var_calcium_background_current__g_Cab; // picoA_per_picoF
        ...
        const double var_fast_transient_outward_potassium_current__alpha_a = 0.18064 * exp(1.0731000000000002 + 0.03577 * var_chaste_interface__membrane__V); // per_millisecond
        const double var_fast_transient_outward_potassium_current__alpha_i = 0.000152 * exp(-1.9285714285714284 - 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + 0.0067083 * exp(-4.785714285714286 - 0.14285714285714285 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_fast_transient_outward_potassium_current__beta_a = 0.3956 * exp(-1.8711 - 0.06237 * var_chaste_interface__membrane__V); // per_millisecond
        ...
        const double var_fast_transient_outward_potassium_current__beta_i = 0.00095 * exp(4.785714285714286 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + 0.051335 * exp(4.785714285714286 + 0.14285714285714285 * var_chaste_interface__membrane__V)); // per_millisecond
        ...
        const double var_slow_delayed_rectifier_potassium_current__alpha_n = 4.81333e-06 * (26.5 + var_chaste_interface__membrane__V) / (1.0 - exp(-3.392 - 0.128 * var_chaste_interface__membrane__V)); // per_millisecond
        const double var_slow_delayed_rectifier_potassium_current__beta_n = 9.53333e-05 * exp(-1.007 - 0.038 * var_chaste_interface__membrane__V); // per_millisecond
        const double var_slow_delayed_rectifier_potassium_current__g_Ks = 0.00575; // milliS_per_microF
        ...
        const double var_slow_transient_outward_potassium_current__tau_ti_s = 270.0 + 1050.0 / (1.0 + exp(7.9298245614035086 + 0.17543859649122806 * var_chaste_interface__membrane__V)); // millisecond
        ...
        const double var_ultra_rapidly_activating_delayed_rectifier_potassium_current__tau_iur = 1200.0 - 170.0 / (1.0 + exp(7.9298245614035086 + 0.17543859649122806 * var_chaste_interface__membrane__V)); // millisecond
