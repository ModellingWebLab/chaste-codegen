...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellmahajan_2008FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IKs__gksx = 1.0 + 0.8 / (1.0 + 0.125 * pow(1 / var_Ca__Ca_i, 3.0)); // dimensionless
        ...
        const double var_IK1__aki = 1.02 / (1.0 + exp(-14.1227775 + 0.2385 * var_chaste_interface__cell__V - 0.2385 * var_reversal_potentials__ek)); // per_ms
        const double var_IK1__bki = (1.0 * exp(-36.6986425 + 0.06175 * var_chaste_interface__cell__V - 0.06175 * var_reversal_potentials__ek) + 0.49124 * exp(0.43983232 + 0.08032 * var_chaste_interface__cell__V - 0.08032 * var_reversal_potentials__ek)) / (1.0 + exp(-2.4444679 + 0.5143 * var_reversal_potentials__ek - 0.5143 * var_chaste_interface__cell__V)); // per_ms
    ...
    void Cellmahajan_2008FromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_IKr__xkrv1 = ((fabs(7.0 + var_chaste_interface__cell__V) > 0.001) ? (0.00138 * (7.0 + var_chaste_interface__cell__V) / (1.0 - exp(-0.861 - 0.123 * var_chaste_interface__cell__V))) : (0.011219512195121953)); // per_ms
        const double var_IKr__xkrv2 = ((fabs(10.0 + var_chaste_interface__cell__V) > 0.001) ? (0.00061 * (10.0 + var_chaste_interface__cell__V) / (-1.0 + exp(1.45 + 0.145 * var_chaste_interface__cell__V))) : (0.004206896551724138)); // per_ms
        ...
        const double var_INa__ah = ((var_chaste_interface__cell__V < -40.0) ? (0.135 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V)) : (0.0)); // per_ms
        const double var_INa__aj = ((var_chaste_interface__cell__V < -40.0) ? (1.0 * (37.78 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.2444 * var_chaste_interface__cell__V) - 3.474e-05 * exp(-0.04391 * var_chaste_interface__cell__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))) : (0.0)); // per_ms
        const double var_INa__am = ((fabs(47.13 + var_chaste_interface__cell__V) > 0.001) ? (0.32 * (47.13 + var_chaste_interface__cell__V) / (1.0 - exp(-4.713 - 0.1 * var_chaste_interface__cell__V))) : (3.2)); // per_ms
        const double var_INa__bh = ((var_chaste_interface__cell__V < -40.0) ? (310000.0 * exp(0.35 * var_chaste_interface__cell__V) + 3.56 * exp(0.079 * var_chaste_interface__cell__V)) : (7.692307692307692 / (1.0 + exp(-0.9603603603603604 - 0.0900900900900901 * var_chaste_interface__cell__V)))); // per_ms
        ...
        const double var_INa__bj = ((var_chaste_interface__cell__V < -40.0) ? (0.1212 * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 + exp(-5.5312920000000005 - 0.1378 * var_chaste_interface__cell__V))) : (0.3 * exp(-2.535e-07 * var_chaste_interface__cell__V) / (1.0 + exp(-3.2 - 0.1 * var_chaste_interface__cell__V)))); // per_ms
