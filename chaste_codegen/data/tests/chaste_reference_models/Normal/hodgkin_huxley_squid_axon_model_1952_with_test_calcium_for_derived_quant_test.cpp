...
#include "hodgkin_huxley_squid_axon_model_1952_with_test_calcium_for_derived_quant_test.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
#include "MathsCustomFunctions.hpp"
    ...
    Cellhodgkin_huxley_squid_axon_model_1952_with_test_calcium_for_derived_quant_testFromCellML::Cellhodgkin_huxley_squid_axon_model_1952_with_test_calcium_for_derived_quant_testFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                4,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Cellhodgkin_huxley_squid_axon_model_1952_with_test_calcium_for_derived_quant_testFromCellML>::Instance();
        Init();
        
    }

    Cellhodgkin_huxley_squid_axon_model_1952_with_test_calcium_for_derived_quant_testFromCellML::~Cellhodgkin_huxley_squid_axon_model_1952_with_test_calcium_for_derived_quant_testFromCellML()
    {
    }
    
    double Cellhodgkin_huxley_squid_axon_model_1952_with_test_calcium_for_derived_quant_testFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void Cellhodgkin_huxley_squid_axon_model_1952_with_test_calcium_for_derived_quant_testFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellhodgkin_huxley_squid_axon_model_1952_with_test_calcium_for_derived_quant_testFromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        ...
        // Mathematics
        const double var_membrane__cai = 10.0 * var_chaste_interface__membrane__V; // millimolar

        std::vector<double> dqs(1);
        dqs[0] = var_membrane__cai;
        return dqs;
    }

template<>
void OdeSystemInformation<Cellhodgkin_huxley_squid_axon_model_1952_with_test_calcium_for_derived_quant_testFromCellML>::Initialise(void)
{
