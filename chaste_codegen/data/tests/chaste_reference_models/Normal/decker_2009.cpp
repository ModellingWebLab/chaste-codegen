...
#include "MathsCustomFunctions.hpp"
    ...
    double Celldecker_2009FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IKp__Kp = 1.0 / (1.0 + exp(1.2521739130434784 - 0.16722408026755853 * var_chaste_interface__membrane__Vm)); // dimensionless
        const double var_IKr_r_gate__r = 1.0 / (1.0 + exp(0.6493506493506493 + 0.06493506493506493 * var_chaste_interface__membrane__Vm)); // dimensionless
        const double var_Ito1__rto1 = exp(0.0018181818181818182 * var_chaste_interface__membrane__Vm); // dimensionless
        const double var_membrane__past = var_chaste_interface__membrane__stim_period * floor(var_chaste_interface__environment__time / var_chaste_interface__membrane__stim_period); // ms
        ...
        const double var_IK1_K1_gate__alpha_k1 = 1.02 / (1.0 + exp(-14.1227775 + 0.2385 * var_chaste_interface__membrane__Vm - 0.2385 * var_reversal_potentials__EK)); // dimensionless
        const double var_IK1_K1_gate__beta_k1 = (0.49124 * exp(0.43983232 + 0.08032 * var_chaste_interface__membrane__Vm - 0.08032 * var_reversal_potentials__EK) + exp(-36.6986425 + 0.06175 * var_chaste_interface__membrane__Vm - 0.06175 * var_reversal_potentials__EK)) / (1.0 + exp(-2.4444679 + 0.5143 * var_reversal_potentials__EK - 0.5143 * var_chaste_interface__membrane__Vm)); // dimensionless
    ...
    void Celldecker_2009FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_ICaL__IV_beta_star = 1.0 / ((1.0 + exp(-0.019709447580272044 - 0.09253261774775608 * var_chaste_interface__membrane__Vm)) * var_ICaL__IV_beta_infinity_star); // dimensionless
        ...
        const double var_ICaL__IV_tau_star = 1.0 / (0.040277106492669565 / (1.0 + exp(4.744419750700551 + 0.09662769349695623 * var_chaste_interface__membrane__Vm)) + var_ICaL__IV_beta_star); // ms
        ...
        const double var_IKp__Kp = 1.0 / (1.0 + exp(1.2521739130434784 - 0.16722408026755853 * var_chaste_interface__membrane__Vm)); // dimensionless
        const double var_IKr_r_gate__r = 1.0 / (1.0 + exp(0.6493506493506493 + 0.06493506493506493 * var_chaste_interface__membrane__Vm)); // dimensionless
        const double var_IKr_xr_gate__tau_xr = 1.0 / (0.0003 * (38.3608 + var_chaste_interface__membrane__Vm) / (-1.0 + exp(5.83851376 + 0.1522 * var_chaste_interface__membrane__Vm)) + 0.0006 * (-1.7384 + var_chaste_interface__membrane__Vm) / (1.0 - exp(0.2364224 - 0.136 * var_chaste_interface__membrane__Vm))); // ms
        ...
        const double var_INaL_hL_gate__hL_infinity = 1.0 / (1.0 + exp(14.918032786885247 + 0.1639344262295082 * var_chaste_interface__membrane__Vm)); // dimensionless
        ...
        const double var_INaL_mL_gate__amL = 0.32 * (47.13 + var_chaste_interface__membrane__Vm) / (1.0 - exp(-4.713 - 0.1 * var_chaste_interface__membrane__Vm)); // per_ms
        ...
        const double var_INa_h_gate__ah = ((var_chaste_interface__membrane__Vm >= -40.0) ? (0.0) : (0.135 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__Vm))); // per_ms
        const double var_INa_h_gate__bh = ((var_chaste_interface__membrane__Vm >= -40.0) ? (7.692307692307692 / (1.0 + exp(-0.9603603603603604 - 0.0900900900900901 * var_chaste_interface__membrane__Vm))) : (310000.0 * exp(0.35 * var_chaste_interface__membrane__Vm) + 3.56 * exp(0.079 * var_chaste_interface__membrane__Vm))); // per_ms
        ...
        const double var_INa_j_gate__aj = ((var_chaste_interface__membrane__Vm >= -40.0) ? (0.0) : ((37.78 + var_chaste_interface__membrane__Vm) * (-127140.0 * exp(0.2444 * var_chaste_interface__membrane__Vm) - 6.948e-05 * exp(-0.04391 * var_chaste_interface__membrane__Vm)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__Vm)))); // per_ms
        const double var_INa_j_gate__bj = ((var_chaste_interface__membrane__Vm >= -40.0) ? (0.3 * exp(-2.535e-07 * var_chaste_interface__membrane__Vm) / (1.0 + exp(-3.2 - 0.1 * var_chaste_interface__membrane__Vm))) : (0.1212 * exp(-0.01052 * var_chaste_interface__membrane__Vm) / (1.0 + exp(-5.5312920000000005 - 0.1378 * var_chaste_interface__membrane__Vm)))); // per_ms
        ...
        const double var_INa_m_gate__am = 0.32 * (47.13 + var_chaste_interface__membrane__Vm) / (1.0 - exp(-4.713 - 0.1 * var_chaste_interface__membrane__Vm)); // per_ms
        ...
        const double var_Ito1_a_gate__alpha_a = 0.8271982794275787 / (1.0 + exp(0.6265834847896969 - 0.03403513787634354 * var_chaste_interface__membrane__Vm)); // per_ms
        const double var_Ito1_a_gate__beta_a = 3.5 / (1.0 + exp(3.403513787634354 + 0.03403513787634354 * var_chaste_interface__membrane__Vm)); // per_ms
        ...
        const double var_Ito1_i1f_gate__alpha_i1f = 0.025 / (1.0 + exp(11.600000000000001 + 0.2 * var_chaste_interface__membrane__Vm)); // per_ms
        const double var_Ito1_i1f_gate__beta_i1f = 0.10208977775055385 / (1.0 + exp(-2.111111111111111 - 0.1111111111111111 * var_chaste_interface__membrane__Vm)); // per_ms
        ...
        const double var_Ito1_i1s_gate__alpha_i1s = 0.004 / (1.0 + exp(12.0 + 0.2 * var_chaste_interface__membrane__Vm)); // per_ms
        const double var_Ito1_i1s_gate__beta_i1s = 0.10208977775055385 / (1.0 + exp(-2.111111111111111 - 0.1111111111111111 * var_chaste_interface__membrane__Vm)); // per_ms
        ...
        const double var_Ito2_i2f_gate__alpha_i2f = 0.025 / (1.0 + exp(11.600000000000001 + 0.2 * var_chaste_interface__membrane__Vm)); // per_ms
        const double var_Ito2_i2f_gate__beta_i2f = 0.2 / (1.0 + exp(-2.111111111111111 - 0.1111111111111111 * var_chaste_interface__membrane__Vm)); // per_ms
