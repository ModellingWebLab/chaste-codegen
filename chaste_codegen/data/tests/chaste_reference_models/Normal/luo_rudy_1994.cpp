...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellluo_rudy_1994FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_time_dependent_potassium_current_X_gate__beta_X = ((fabs(30.0 + var_chaste_interface__membrane__V) < 1.455604075689676e-6) ? (1.9068413391534758e-10 / (-1.0 + exp(9.9999999999880736e-8)) - 343500.00000040967 * (29.999998544395925 + var_chaste_interface__membrane__V) * (-1.9068413391534758e-10 / (-1.0 + exp(9.9999999999880736e-8)) - 1.9068413391534758e-10 / (-1.0 + exp(-9.9999999999880736e-8)))) : (0.00013100000000000001 * (30.0 + var_chaste_interface__membrane__V) / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V)))); // per_ms
