...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellluo_rudy_1994FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel_f_Ca_gate__f_Ca = 1 / (1.0 + pow((var_chaste_interface__ionic_concentrations__Cai / var_L_type_Ca_channel_f_Ca_gate__Km_Ca), 2)); // dimensionless
        ...
        const double var_non_specific_calcium_activated_current__i_ns_K = var_non_specific_calcium_activated_current__I_ns_K / (1.0 + pow((var_non_specific_calcium_activated_current__K_m_ns_Ca / var_chaste_interface__ionic_concentrations__Cai), 3)); // uA_per_mm2
        const double var_non_specific_calcium_activated_current__i_ns_Na = var_non_specific_calcium_activated_current__I_ns_Na / (1.0 + pow((var_non_specific_calcium_activated_current__K_m_ns_Ca / var_chaste_interface__ionic_concentrations__Cai), 3)); // uA_per_mm2
