...
#include "test_luo_rudy_1991_with_range.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
class Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables : public AbstractLookupTableCollection
{
public:
    static Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance.get() == NULL)
        {
            mpInstance.reset(new Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables);
        }
    ...
    const double * IndexTable0(double var_chaste_interface__membrane__V)
    {
        ...
        const double* const _lt_0_row = Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        return _lt_0_row;
    }
...
// LCOV_EXCL_STOP
    ...
    ~Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables()
    {
...
protected:
    Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables(const Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables&);
    Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables& operator= (const Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables&);
    Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables()
    {
        ...
        Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables::RegenerateTables();
    }
...
private:
    ...
    static std::shared_ptr<Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables> mpInstance;
...
std::shared_ptr<Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables> Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables::mpInstance;


    boost::shared_ptr<RegularStimulus> Celltest_luo_rudy_1991_with_rangeFromCellMLOpt::UseCellMLDefaultStimulus()
    {
    ...
    double Celltest_luo_rudy_1991_with_rangeFromCellMLOpt::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[7];
    }
    Celltest_luo_rudy_1991_with_rangeFromCellMLOpt::Celltest_luo_rudy_1991_with_rangeFromCellMLOpt(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                8,
                0,
                pIntracellularStimulus)
    {
        ...
        //
        this->mpSystemInfo = OdeSystemInformation<Celltest_luo_rudy_1991_with_rangeFromCellMLOpt>::Instance();
        Init();
    ...
    Celltest_luo_rudy_1991_with_rangeFromCellMLOpt::~Celltest_luo_rudy_1991_with_rangeFromCellMLOpt()
    {
    }

    AbstractLookupTableCollection* Celltest_luo_rudy_1991_with_rangeFromCellMLOpt::GetLookupTableCollection()
    {
        return Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables::Instance();
    }
    
    
    void Celltest_luo_rudy_1991_with_rangeFromCellMLOpt::VerifyStateVariables()
    {
    ...
    double Celltest_luo_rudy_1991_with_rangeFromCellMLOpt::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const bool _oob_0 = Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables::Instance()->CheckIndex0(var_chaste_interface__membrane__V);
// LCOV_EXCL_START
        if (_oob_0)
            EXCEPTION(DumpState("membrane_voltage outside lookup table range", rY));
// LCOV_EXCL_STOP
        const double* const _lt_0_row = Celltest_luo_rudy_1991_with_rangeFromCellMLOpt_LookupTables::Instance()->IndexTable0(var_chaste_interface__membrane__V);
    ...
    void Celltest_luo_rudy_1991_with_rangeFromCellMLOpt::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
// LCOV_EXCL_STOP
    ...
    std::vector<double> Celltest_luo_rudy_1991_with_rangeFromCellMLOpt::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Celltest_luo_rudy_1991_with_rangeFromCellMLOpt>::Initialise(void)
{
