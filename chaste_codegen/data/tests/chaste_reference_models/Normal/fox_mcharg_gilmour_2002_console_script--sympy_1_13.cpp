...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellfox_mcharg_gilmour_2002FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_slow_activating_delayed_rectifiyer_K_current__E_Ks = var_membrane__R * var_membrane__T * log((1 * mParameters[6] + 0.018329999999999999 * mParameters[7]) / (1 * mParameters[3] + 0.018329999999999999 * mParameters[4])) / var_membrane__F; // millivolt
