...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x147 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x224 = exp(-4.0 + var_x147);
            const double var_x225 = 1.0 + var_x224;
            const double var_x226 = 1 / var_x225;
            const double var_x227 = exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2));
            const double var_x230 = 85.0 * var_x227;
            const double var_x231 = 1 / (3.0 + var_x230 + 5.0 * var_x226);
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x238 * (-8.0000000000000007e-5 + var_x118 * (var_x117 - var_x116)) + 9.9963436928702016 * (var_x105 + var_x106 - var_x104 - var_x113) / (pow(var_x236, 3) * pow((0.33333333333333337 + var_x237), 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x244 = (((var_x217) || (var_x240))) && (((var_x217) || (var_x241))) && (((var_x240) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 5.439910241481016e+20 * var_x242)))) && (((var_x241) || (var_chaste_interface__calcium_dynamics__g < 1 / (1.0 + 1.9720198874049176e+55 * var_x243))));
    ...
    double Cellten_tusscher_model_2004_epiFromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x245 = 6.3176611368492499e-5 * var_x43;
            
            partialF = 0.00010126109252331096 * var_x95 - 0.0031224512033090025 * var_x94 - 0.0016876848753885161 * var_x90 - 4.5587787568311439e-5 * var_x89 - 0.00076500054481070561 * var_x83 - 0.0031224512033090025 * var_x91 - var_x245 * var_x93;
        }
        else
        {
