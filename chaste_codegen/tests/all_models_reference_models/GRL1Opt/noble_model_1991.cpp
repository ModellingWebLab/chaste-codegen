...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x17 = -0.037433890822745473 * var_chaste_interface__membrane__V;
            ...
            const double var_x21 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f;
            const double var_x22 = exp(3.7433890822745473 - var_x0);
            const double var_x23 = 1.0 - var_x22;
            const double var_x24 = 1 / var_x23;
            const double var_x25 = exp(3.7433890822745473);
            const double var_x26 = -2.0 * var_x22 + var_x25 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            const double var_x27 = var_x24 * var_x26;
            const double var_x28 = 0.037433890822745473 * var_x27;
            const double var_x29 = exp(1.8716945411372736 + var_x17);
            const double var_x30 = 1.0 - var_x29;
            const double var_x31 = 1 / var_x30;
            const double var_x32 = var_x21 * var_x31;
            const double var_x33 = exp(1.8716945411372736);
            const double var_x34 = -4.0 * var_x29 + var_x33 * var_chaste_interface__intracellular_potassium_concentration__K_i;
            const double var_x35 = 1.8716945411372735e-5 * var_x34;
            const double var_x36 = -140.0 * var_x29 + var_x33 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
            const double var_x37 = 9.3584727056863679e-5 * var_x36;
            const double var_x38 = -50.0 + var_chaste_interface__membrane__V;
            const double var_x39 = var_x21 * var_x38;
            const double var_x40 = var_x24 * var_x39;
            const double var_x41 = var_x22 * var_x40;
            const double var_x42 = var_x32 * var_x38;
            const double var_x43 = var_x29 * var_x42;
            const double var_x44 = var_x22 * var_x26 * var_x39 / pow(var_x23, 2);
            const double var_x45 = var_x29 * var_x39 / pow(var_x30, 2);
            const double var_x46 = var_x34 * var_x45;
            const double var_x47 = var_x36 * var_x45;
            const double var_x48 = 1 / mParameters[0];
            const double var_x49 = 0.001 * var_x48;
            
            partialF = -var_x49 * (0.0014499999999999999 + 2.5 * var_x8 + 0.00050000000000000001 * var_x15 + 0.0050000000000000001 * var_x16 + 0.0056051847285169109 * var_x41 + 0.0010695397377927277 * var_x19 + 0.00049325625610948819 * var_x43 + 0.2857142857142857 * var_x6 - 0.0028025923642584554 * var_x44 - 0.021390794755854554 * var_x20 - 7.0064809106461387e-7 * var_x46 - 3.503240455323069e-6 * var_x47 + var_x21 * var_x28 + var_x32 * var_x35 + var_x32 * var_x37);
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x72 = exp(-0.80000000000000004 - 0.040000000000000001 * var_chaste_interface__membrane__V);
            const double var_x73 = 1.0 + var_x72;
            const double var_x74 = exp(-1.2 - 0.059999999999999998 * var_chaste_interface__membrane__V);
            const double var_x75 = var_x74 / var_x73;
            const double var_x77 = exp(2.8500000000000001 + 0.057000000000000002 * var_chaste_interface__membrane__V);
            const double var_x78 = 1.0 + var_x77;
            const double var_x79 = exp(4.1300000000000008 + 0.082600000000000007 * var_chaste_interface__membrane__V);
            const double var_x80 = var_x79 / var_x78;
            
            partialF = -0.00050000000000000001 * var_x80 - 0.0012999999999999999 * var_x75;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x81 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
            const double var_x83 = 41.0 + var_chaste_interface__membrane__V;
            const double var_x84 = fabs(var_x83) < 1.0000000000000001e-5;
            const double var_x86 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x87 = exp(-4.1000000000000005 + var_x86);
            const double var_x88 = 1.0 - var_x87;
            const double var_x89 = 0.20000000000000001 / var_x88;
            const double var_x90 = -8.0 * var_x81;
            
            partialF = ((var_x84) ? (-2.0 + var_x90) : (var_x90 - var_x83 * var_x89));
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x86 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x91 = -0.125 * var_chaste_interface__membrane__V;
            const double var_x92 = exp(-9.375 + var_x91);
            const double var_x93 = exp(-7.5 + var_x86);
            
            partialF = -2.0 / (1.0 + 320.0 * var_x93) - 0.02 * var_x92;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x94 = 19.0 + var_chaste_interface__membrane__V;
            const double var_x95 = fabs(var_x94) < 0.0001;
            const double var_x97 = 0.25 * var_chaste_interface__membrane__V;
            const double var_x98 = -var_x97;
            const double var_x99 = exp(-4.75 + var_x98);
            const double var_x100 = 1.0 - var_x99;
            const double var_x101 = 0.089999999999999997 / var_x100;
            const double var_x102 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x103 = -1.0 + var_x102;
            const double var_x104 = 0.035999999999999997 / var_x103;
            
            partialF = ((var_x95) ? (-0.71999999999999997) : (-var_x101 * var_x94 - var_x104 * var_x94));
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x97 = 0.25 * var_chaste_interface__membrane__V;
            const double var_x98 = -var_x97;
            const double var_x105 = exp(-8.5 + var_x98);
            const double var_x106 = 1.0 + var_x105;
            const double var_x108 = 34.0 + var_chaste_interface__membrane__V;
            const double var_x109 = fabs(var_x108) < 0.0001;
            const double var_x111 = exp(8.5 + var_x97);
            const double var_x112 = -1.0 + var_x111;
            const double var_x113 = 0.0031250000000000002 / var_x112;
            const double var_x114 = -0.025000000000000001 / var_x106;
            
            partialF = ((var_x109) ? (-0.012500000000000001 + var_x114) : (var_x114 - var_x108 * var_x113));
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x91 = -0.125 * var_chaste_interface__membrane__V;
            const double var_x115 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
            const double var_x116 = exp(-1.25 + var_x91);
            const double var_x117 = 1.0 + var_x116;
            
            partialF = -0.033000000000000002 / var_x117 - 3.3000000000000003e-5 * var_x115;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x119 = 0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            const double var_x120 = pow(var_x119, (-2));
            const double var_x121 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2);
            const double var_x122 = var_x120 * var_x121;
            
            partialF = -0.059999999999999998 - 1.0 * var_x122;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative10(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x38 = -50.0 + var_chaste_interface__membrane__V;
            const double var_x42 = var_x32 * var_x38;
            const double var_x50 = 1 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i);
            const double var_x59 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
            const double var_x60 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
            ...
            const double var_x62 = var_x11 * var_x9 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
            const double var_x63 = var_x50 * var_x8;
            const double var_x64 = var_x33 * var_x42;
            
            partialF = 6.634188331769168e-7 * var_x61 - 0.0010614701330830668 * var_x59 - 1.0127092529498693e-5 * var_x60 - 0.042196218872911223 * var_x63 - 5.6864471415164302e-6 * var_x62 - 5.9129400406899753e-8 * var_x64;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x42 = var_x32 * var_x38;
            const double var_x64 = var_x33 * var_x42;
            const double var_x65 = var_x2 * var_x6;
            const double var_x66 = var_x16 * var_x2;
            const double var_x67 = var_x2 * var_x20;
            
            partialF = 0.00036104426295342415 * var_x67 - 0.0048224250140469962 * var_x65 - 4.5130532869178019e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 1.0127092529498693e-5 * var_x2 - 8.4392437745822447e-5 * var_x66 - 1.182588008137995e-8 * var_x64;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x69 = var_x13 * var_x9;
            const double var_x70 = (2.0 * var_x12 - 2744000.0 * var_x14) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
            const double var_x71 = var_x25 * var_x40;
            const double var_x137 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod;
            const double var_x138 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Trop;
            const double var_x139 = 0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_up + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            ...
            const double var_x143 = var_x141 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
            
            partialF = -7.0 + var_x137 + var_x138 + 0.00040000000000000002 * var_x142 - 0.00040000000000000002 * var_x140 - 0.86686727535117136 * var_x69 - 2.1798047375812981e-9 * var_x70 - 1.1825880081379951e-5 * var_x71 - 1.0549054718227806e-6 * var_x68 - 7.1999999999999991e-9 * var_x143;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.050000000000000003 + 8.4671999999999982e-11 * var_x143 - 4.7039999999999993e-6 * var_x142 - 3.5279999999999993e-7 * var_x140;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x132 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
            const double var_x133 = pow(var_x132, (-2));
            const double var_x135 = pow(var_chaste_interface__calcium_release__ActFrac, 2);
            const double var_x144 = var_x133 * var_x135;
            
            partialF = -0.0050000000000000001 - 0.25 * var_x144;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x145 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            const double var_x147 = -var_x145;
            
            partialF = -0.050000000000000003 + var_x147;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL1::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.20000000000000001 + var_x147;
        }
        else
        {
