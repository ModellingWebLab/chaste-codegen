...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x53 = var_x52 * mParameters[0] * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f;
            const double var_x54 = var_x50 * var_chaste_interface__calcium_dynamics__Ca_ss;
            const double var_x55 = -2.0 + 0.25 * var_x54;
            ...
            const double var_x59 = var_x55 * var_x58 * mParameters[0] * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f / pow(var_x51, 2);
            const double var_x60 = var_x53 * var_x54 * var_x57;
            
            partialF = -0.00088199999999999997 - var_x28 - var_x37 + 1081.6363254030778 * var_x59 + 0.03243 * var_x40 - 0.39200000000000002 * var_x0 - 0.0146 * var_x3 - 0.0024414715719063545 * var_x31 - 270.40908135076944 * var_x60 - 8.6662202299424464e-5 * var_x10 - 0.54050000000000009 * var_x26 - 2.2983750000000001 * var_x49 - 2.1086672225679691e-7 * var_x33 - 1.0 * var_x34 - var_x42 * var_x44 - var_x53 * var_x56;
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x11 = log(10);
            const double var_x32 = 2.0 * var_x9 - 6860000.0 * var_x7;
            const double var_x61 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i;
            const double var_x62 = 1 / var_x61;
            const double var_x63 = 1 / var_chaste_interface__calcium_dynamics__Ca_i;
            const double var_x64 = var_chaste_interface__calcium_dynamics__Ca_i / pow(var_x61, 2);
            const double var_x65 = var_x4 * var_x6;
            const double var_x96 = 0.001 + var_chaste_interface__calcium_dynamics__Ca_i;
            const double var_x97 = 1.0 + 0.00020000000000000001 / pow(var_x96, 2);
            const double var_x98 = 1 / var_x97;
            const double var_x99 = 7.2352122917848019e-6 * var_x62;
            const double var_x100 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
            const double var_x101 = 1 / (pow(var_x100, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
            const double var_x102 = 1 / var_x100;
            
            partialF = var_x98 * (-0.0038240087783467445 - var_x99 + 7.2352122917848019e-6 * var_x64 - 0.069488744729986562 * var_x65 - 5.3144431236283834e-11 * var_x101 - 4.6212277808973232e-7 * var_x63) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027063 * var_x102 - var_x99 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x32 * var_x6 + 4.6212277808973232e-7 * var_x11 * log10(2.0 * var_x63)) / (pow(var_x96, 3) * pow(var_x97, 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x103 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x104 = -var_x103;
            const double var_x105 = exp(-4.5 + var_x104);
            const double var_x106 = 1.0 + var_x105;
            const double var_x111 = exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__membrane__V);
            const double var_x112 = 0.00037037037037037035 + 0.00037037037037037035 * var_x111;
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x114 = 0.050000000000000003 * var_chaste_interface__membrane__V;
            const double var_x115 = -var_x114;
            const double var_x116 = exp(-3.0 + var_x115);
            const double var_x117 = 1.0 + var_x116;
            const double var_x121 = exp(-3.0 + var_x114);
            const double var_x122 = 0.29761904761904762 + 0.29761904761904762 * var_x121;
            const double var_x123 = var_x117 * var_x122;
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x124 = -0.16666666666666666 * var_chaste_interface__membrane__V;
            const double var_x125 = exp(0.83333333333333337 + var_x124);
            const double var_x126 = 1.0 + var_x125;
            const double var_x127 = 1 / sqrt(var_x126);
            const double var_x128 = exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__membrane__V);
            const double var_x129 = 1.0 + var_x128;
            const double var_x130 = 1 / var_x129;
            const double var_x131 = var_x127 * var_x130;
            const double var_x134 = 1 / (80.0 + 1400.0 * var_x131);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x135 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x136 = exp(7.0 + var_x135);
            const double var_x137 = 1.0 + var_x136;
            const double var_x138 = 1 / var_x137;
            const double var_x139 = exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V);
            const double var_x140 = 1.0 + var_x139;
            const double var_x141 = 1 / var_x140;
            const double var_x142 = 1 / (0.10000000000000001 * var_x138 + 0.10000000000000001 * var_x141);
            const double var_x146 = exp(-12.0 - var_x135);
            const double var_x147 = 1.0 + var_x146;
            const double var_x148 = var_x142 * var_x147;
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x152 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x153 = var_chaste_interface__membrane__V < -40.0;
            const double var_x154 = exp(0.34849999999999998 * var_chaste_interface__membrane__V);
            const double var_x155 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
            const double var_x156 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x157 = 1.0 + var_x156;
            const double var_x158 = ((var_x153) ? (0.057000000000000002 * var_x152) : (0));
            const double var_x159 = ((var_x153) ? (310000.0 * var_x154 + 2.7000000000000002 * var_x155) : (5.9230769230769234 / var_x157));
            
            partialF = -var_x158 - var_x159;
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x165 = exp(-3.2000000000000002 - var_x21);
            const double var_x166 = 1.0 + var_x165;
            const double var_x167 = exp(0.057000000000000002 * var_chaste_interface__membrane__V);
            const double var_x168 = var_x167 / var_x166;
            const double var_x169 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
            const double var_x170 = 1.0 + var_x169;
            const double var_x171 = 1 / var_x170;
            const double var_x172 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
            const double var_x173 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x174 = -25428.0 * var_x172 - 6.9480000000000002e-6 * var_x173;
            const double var_x175 = var_x171 * var_x174;
            const double var_x176 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x177 = ((var_x153) ? (0.024240000000000001 * var_x164) : (0.59999999999999998 * var_x168));
            const double var_x178 = ((var_x153) ? (var_x175 * var_x176) : (0));
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x115 = -var_x114;
            const double var_x135 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x179 = exp(2.5 + var_x115);
            const double var_x180 = 1.0 + var_x179;
            const double var_x181 = 1 / var_x180;
            const double var_x182 = exp(1.0 + var_x135);
            ...
            const double var_x191 = 1 / (var_x181 + 1.3999999999999999 * var_x188);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x103 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x104 = -var_x103;
            const double var_x192 = exp(3.0 + var_x103);
            const double var_x193 = 1.0 + var_x192;
            const double var_x194 = 1 / var_x193;
            const double var_x195 = exp(1.3 + var_x104);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x194 = 1 / var_x193;
            const double var_x198 = pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2);
            const double var_x205 = exp(2.5 + var_x104);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x135 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x217 = exp(-4.0 + var_x135);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x235 = var_x213 * var_x234;
            ...
            const double var_x243 = var_x213 * var_x237 * var_x240 * var_x242;
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x57 = -15.0 + var_chaste_interface__membrane__V;
            const double var_x58 = var_x50 * var_x57;
            const double var_x82 = var_x53 * var_x58;
            const double var_x213 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2);
            const double var_x232 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
            const double var_x233 = 1 / (1.0 + 2.25 * var_x232);
            const double var_x234 = 1 / (2.5 - 1.5 * var_x233);
            ...
            const double var_x250 = 0.00025000000000000001 + var_chaste_interface__calcium_dynamics__Ca_ss;
            const double var_x251 = 1.0 + 0.0001 / pow(var_x250, 2);
            const double var_x252 = 1 / var_x251;
            const double var_x253 = 253.30174843481757 * var_x55;
            const double var_x254 = var_x253 * var_x53;
            const double var_x258 = 0.30611192392099484 * var_x238;
            
            partialF = var_x252 * (-1.1399999999999999 - var_x258 + 0.61222384784198969 * var_x248 - 0.65303877103145569 * var_x247 - 63.325437108704392 * var_x82) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x241 * var_x258 - var_x254 * var_x57) / (pow(var_x250, 3) * pow(var_x251, 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x232 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
            const double var_x233 = 1 / (1.0 + 2.25 * var_x232);
            const double var_x259 = -0.11249999999999999 + 0.067500000000000004 * var_x233;
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x88 = var_x37 * var_x70;
            
            partialF = 5.0371257222730904e-7 * var_x86 - 9.0551084895961074e-7 * var_x70 - 1.823319832565245e-7 * var_x87 - 0.0031224512033090025 * var_x88 - 0.00080594011556369446 * var_x85;
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x83 = var_x0 * var_x67;
            ...
            const double var_x260 = 6.3176611368492499e-5 * var_x43;
            
            partialF = 0.00010126109252331096 * var_x95 - 0.001224000871697129 * var_x83 - 0.0031224512033090025 * var_x94 - 0.0016876848753885161 * var_x90 - 4.5587787568311439e-5 * var_x89 - 0.0031224512033090025 * var_x91 - var_x260 * var_x93;
        }
        else
        {
