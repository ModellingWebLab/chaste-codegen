...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x81 = 41.0 + var_chaste_interface__membrane__V;
            const double var_x82 = fabs(var_x81) < 1.0000000000000001e-5;
            const double var_x83 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x84 = exp(-4.1000000000000005 + var_x83);
            const double var_x85 = 1.0 - var_x84;
            const double var_x86 = 200.0 / var_x85;
            const double var_x87 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
            
            partialF = -8.0 * var_x87 - 0.001 * ((var_x82) ? (2000.0) : (var_x81 * var_x86));
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x83 = -0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x88 = -0.125 * var_chaste_interface__membrane__V;
            const double var_x89 = exp(-9.375 + var_x88);
            const double var_x90 = exp(-7.5 + var_x83);
            
            partialF = -2.0 / (1.0 + 320.0 * var_x90) - 0.02 * var_x89;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x94 = 0.25 * var_chaste_interface__membrane__V;
            const double var_x95 = -var_x94;
            const double var_x96 = exp(-4.75 + var_x95);
            const double var_x97 = 1.0 - var_x96;
            const double var_x98 = 30.0 / var_x97;
            const double var_x99 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x100 = -1.0 + var_x99;
            const double var_x101 = 12.0 / var_x100;
            
            partialF = -0.0030000000000000001 * ((var_x93) ? (120.0) : (var_x101 * var_x92)) - 0.0030000000000000001 * ((var_x93) ? (120.0) : (var_x92 * var_x98));
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x94 = 0.25 * var_chaste_interface__membrane__V;
            const double var_x95 = -var_x94;
            const double var_x102 = 34.0 + var_chaste_interface__membrane__V;
            const double var_x103 = fabs(var_x102) < 0.0001;
            const double var_x104 = exp(8.5 + var_x94);
            const double var_x105 = -1.0 + var_x104;
            const double var_x106 = 6.25 / var_x105;
            const double var_x107 = exp(-8.5 + var_x95);
            const double var_x108 = 1.0 + var_x107;
            
            partialF = -0.00050000000000000001 * ((var_x103) ? (25.0) : (var_x102 * var_x106)) - 0.025000000000000001 / var_x108;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x88 = -0.125 * var_chaste_interface__membrane__V;
            const double var_x109 = exp(-0.058823529411764705 * var_chaste_interface__membrane__V);
            const double var_x110 = exp(-1.25 + var_x88);
            const double var_x111 = 1.0 + var_x110;
            
            partialF = -0.033000000000000002 / var_x111 - 3.3000000000000003e-5 * var_x109;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x113 = 0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            const double var_x114 = pow(var_x113, (-2));
            const double var_x115 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2);
            const double var_x116 = var_x114 * var_x115;
            
            partialF = -0.059999999999999998 - 1.0 * var_x116;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 6.634188331769168e-7 * var_x61 - 0.0010614701330830668 * var_x59 - 1.0127092529498693e-5 * var_x60 - 5.6864471415164302e-6 * var_x62 - 0.042196218872911223 * var_x63 - 5.9129400406899753e-8 * var_x64;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 0.00036104426295342415 * var_x67 - 4.5130532869178019e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 1.0127092529498693e-5 * var_x2 - 8.4392437745822447e-5 * var_x66 - 0.0048224250140469962 * var_x65 - 1.182588008137995e-8 * var_x64;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -7.0 + var_x131 + var_x132 + 0.00040000000000000002 * var_x136 - 0.00040000000000000002 * var_x134 - 1.0549054718227806e-6 * var_x68 - 0.86686727535117136 * var_x69 - 2.1798047375812981e-9 * var_x70 - 1.1825880081379951e-5 * var_x71 - 7.1999999999999991e-9 * var_x137;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.050000000000000003 + 8.4671999999999982e-11 * var_x137 - 3.5279999999999993e-7 * var_x134 - 4.7039999999999993e-6 * var_x136;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x127 = pow(var_x126, (-2));
            const double var_x129 = pow(var_chaste_interface__calcium_release__ActFrac, 2);
            const double var_x138 = var_x127 * var_x129;
            
            partialF = -0.0050000000000000001 - 0.25 * var_x138;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x139 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
            const double var_x141 = -var_x139;
            
            partialF = -0.050000000000000003 + var_x141;
        }
        else
        {
    ...
    double Cellnoble_model_1991FromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.20000000000000001 + var_x141;
        }
        else
        {
