...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x96 = log(10);
            const double var_x97 = var_x96 * log10(140.0 * var_x92);
            const double var_x98 = exp(-4.0 + var_x95 + 0.89088499421326284 * var_x97);
            const double var_x99 = 1.0 + var_x98;
            const double var_x100 = var_x98 / (pow(var_x99, 2) * (1.0 + 30.900566853219949 * var_x93));
            
            partialF = -0.0054000000000000003 + var_x4 - 0.375 * var_x0 - 0.014999999999999999 * var_x79 - 0.17999999999999999 * var_x80 - 0.025899999999999999 * var_x1 - 0.57999999999999996 * var_x83 - 0.02 * var_chaste_interface__AP_sensitive_currents_r_gate__r - 0.45800000000000002 * var_x81 - 0.10017396017979863 * var_x100 - 0.00044373633078820127 * var_x2 - var_x66 * var_x78 - var_x89 * var_x91;
        }
        else
        {
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x163 = 0.40000000000000002 * var_chaste_interface__membrane__V;
            const double var_x164 = exp(-2.0 + var_x163);
            const double var_x165 = -1.0 + var_x164;
            const double var_x166 = 0.011429999999999999 / var_x165;
            const double var_x167 = exp(-14.0 - var_x163);
            const double var_x168 = -1.0 + var_x167;
            const double var_x169 = 0.028389999999999999 / var_x168;
            const double var_x170 = exp(-0.20798668885191349 * var_chaste_interface__membrane__V);
            const double var_x171 = -1.0 + var_x170;
            const double var_x172 = 0.084900000000000003 / var_x171;
            const double var_x173 = -5.0 + var_chaste_interface__membrane__V;
            const double var_x174 = 35.0 + var_chaste_interface__membrane__V;
            const double var_x175 = var_x166 * var_x173;
            const double var_x176 = var_x169 * var_x174;
            const double var_x177 = var_x172 * var_chaste_interface__membrane__V;
            
            partialF = var_x176 + var_x177 - var_x175;
        }
        else
        {
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x181 = exp(-5.4668495419491743 * pow((1 + 0.030769230769230771 * var_chaste_interface__membrane__V), 2));
            const double var_x182 = 1 / (44.299999999999997 + 257.10000000000002 * var_x181);
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x183 = 60.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
            
            partialF = -0.021000000000000001 - var_x183;
        }
        else
        {
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x94 = 0.033333333333333333 * var_chaste_interface__membrane__V;
            const double var_x95 = -var_x94;
            const double var_x187 = exp(0.87666666666666671 + var_x94);
            const double var_x188 = exp(-0.87666666666666671 + var_x95);
            const double var_x189 = 1.0680000000000001 * var_x187;
            const double var_x190 = 1.0680000000000001 * var_x188;
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x193 = exp(4.0117035110533159 + 0.065019505851755519 * var_chaste_interface__membrane__V);
            const double var_x194 = exp(-0.74069627851140463 - 0.012004801920768308 * var_chaste_interface__membrane__V);
            const double var_x195 = 0.014999999999999999 * var_x193;
            const double var_x196 = 0.015299999999999999 * var_x194;
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x200 = exp(0.058823529411764705 * var_chaste_interface__membrane__V);
            const double var_x201 = exp(-0.046296296296296294 * var_chaste_interface__membrane__V);
            const double var_x202 = 0.0049612928202981696 * var_x200;
            const double var_x203 = 0.0001771890292963632 * var_x201;
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x205 = exp(0.062893081761006289 * var_chaste_interface__membrane__V);
            const double var_x206 = exp(-0.044444444444444446 * var_chaste_interface__membrane__V);
            const double var_x207 = 0.043942879265498072 * var_x205;
            const double var_x208 = 0.0011340097874967246 * var_x206;
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x211 = exp(0.009420009985210585 * var_chaste_interface__membrane__V);
            const double var_x212 = exp(-0.018299935950224173 * var_chaste_interface__membrane__V);
            const double var_x213 = 0.10000000000000001 * var_x212;
            const double var_x214 = 0.65600000000000003 * var_x211;
            
            partialF = -var_x213 - var_x214;
        }
        else
        {
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x215 = exp(-0.022222222222222223 * var_chaste_interface__membrane__V);
            const double var_x216 = 0.001 * var_x215;
            const double var_x217 = exp(4.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane__V);
            const double var_x218 = 1.0 + var_x217;
            const double var_x219 = 1 / var_x218;
            const double var_x220 = 0.014 * var_x219;
            
            partialF = -var_x216 - var_x220;
        }
        else
        {
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x228 = exp(4.593 + 0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x229 = exp(-3.52 - 0.080000000000000002 * var_chaste_interface__membrane__V);
            const double var_x230 = 1 / (0.065000000000000002 * var_x228 + 0.56999999999999995 * var_x229);
            const double var_x231 = 1 / (6.0599999999999996 + 39.101999999999997 * var_x230);
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x234 = exp(2.7548999999999997 + 0.089999999999999997 * var_chaste_interface__membrane__V);
            const double var_x235 = exp(-2.8607999999999998 - 0.12 * var_chaste_interface__membrane__V);
            const double var_x236 = 1 / (1.0369999999999999 * var_x234 + 0.36899999999999999 * var_x235);
            const double var_x237 = 1 / (2.75352 + 14.40516 * var_x236);
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x240 = exp(-3.8001143986272159 + 0.051999376007487906 * var_chaste_interface__membrane__V);
            const double var_x241 = exp(-8.5404617897664554 - 0.022074080614542406 * var_chaste_interface__membrane__V);
            const double var_x242 = 1.3953756414018557 * var_x241;
            const double var_x243 = 1.3953756414018557 * var_x240;
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative13(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x247 = exp(0.02 * var_chaste_interface__membrane__V);
            const double var_x248 = exp(0.125 * var_chaste_interface__membrane__V);
            const double var_x249 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
            const double var_x250 = exp(-0.0014285714285714286 * var_chaste_interface__membrane__V);
            const double var_x251 = 1 / (16.0 * var_x248 + 15.0 * var_x247);
            const double var_x252 = 1 / (0.20000000000000001 * var_x250 + 0.14999999999999999 * var_x249);
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative14(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x225 = 0.076923076923076927 * var_chaste_interface__membrane__V;
            const double var_x244 = -var_x178;
            const double var_x250 = exp(-0.0014285714285714286 * var_chaste_interface__membrane__V);
            const double var_x253 = exp(0.014285714285714285 * var_chaste_interface__membrane__V);
            const double var_x254 = exp(var_x225);
            const double var_x255 = 1 / (700.0 * var_x253 + 3100.0 * var_x254);
            const double var_x256 = exp(-0.10000000000000001 * var_chaste_interface__membrane__V);
            const double var_x257 = 1 / (50.0 * var_x250 + 95.0 * var_x256);
            const double var_x258 = exp(var_x244);
            const double var_x259 = 1.0 + var_x258;
            const double var_x260 = 1 / var_x259;
            const double var_x269 = 3.4436090225563911e-5 * var_x260;
            const double var_x270 = 0.15037593984962405 * var_x257;
            const double var_x271 = 0.15037593984962405 * var_x255;
            
            partialF = -var_x269 - var_x270 - var_x271;
        }
        else
        {
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x272 = 1 / (pow((1.0 + 0.00059999999999999995 / var_chaste_interface__intracellular_ion_concentrations__Cai), 2) * pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 2));
            
            partialF = -27.670820618882221 + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMi + 2.7527999999999997 * var_chaste_interface__calcium_buffering__fTC + 14.1174 * var_chaste_interface__calcium_buffering__fTMC + 14.1174 * var_chaste_interface__calcium_buffering__fTMM - 7.7327439216924522e-8 * var_x272;
        }
        else
        {
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x12 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_sub, 2);
            const double var_x274 = 1.0 + 1.4399999999999998e-6 / var_x12;
            const double var_x275 = 1 / var_x274;
            const double var_x276 = 0.5 * var_x275;
            
            partialF = -5.3566666666666674 - var_x276 + 5.3399999999999999 * var_chaste_interface__calcium_buffering__fCQ;
        }
        else
        {
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x88 = var_x26 * var_x74;
            const double var_x90 = (var_x50 * var_x76 - var_x35 * var_x57) / pow((var_x45 + 0.0207 * var_x38 + 0.020032765807428299 * var_x54 + 2.2876929743622558e-5 * var_x71 + 0.011302211302211302 * var_x63 + 1.2490816130834047e-5 * var_x75 + 0.013327915425555734 * var_x84 + var_x17 * var_x52 * var_x55), 2);
            const double var_x125 = var_x11 * (-48.309178743961354 - var_x33 - 1.8271247633873431 * var_chaste_interface__intracellular_ion_concentrations__Nai);
            const double var_x126 = 0.0207 * var_x16;
            const double var_x127 = var_x125 * var_x126;
            const double var_x128 = 4.7355244569298691e-7 * var_x26;
            const double var_x129 = var_x127 + var_x34 + var_x125 * var_x128;
            const double var_x130 = var_x129 * var_x31;
            const double var_x131 = var_x34 * var_x42;
            const double var_x132 = var_x127 * var_x42;
            const double var_x133 = var_x50 * (var_x130 + var_x131 + var_x132) - var_x127 * var_x57 - var_x34 * var_x57;
            const double var_x134 = 0.013771830208622637 * var_x16 * var_x72;
            const double var_x135 = 4.7355244569298691e-7 * var_x87;
            const double var_x136 = 2.5855989390826479e-7 * var_x88;
            const double var_x137 = -var_x130 - var_x131 - var_x132 - var_x125 * var_x134 - var_x125 * var_x135 - var_x125 * var_x136 - var_x129 * var_x60 - var_x15 * var_x5 * var_x73;
            const double var_x274 = 1.0 + 1.4399999999999998e-6 / var_x12;
            const double var_x275 = 1 / var_x274;
            const double var_x277 = (-var_chaste_interface__intracellular_ion_concentrations__Ca_sub + var_chaste_interface__intracellular_ion_concentrations__Ca_rel) / (pow(var_x274, 2) * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_sub, 3));
            const double var_x278 = 0.036912022524200436 * var_x77;
            const double var_x279 = 1.5816432531394641e-5 * var_x90;
            const double var_x281 = 0.060150151005755319 * var_x275;
            
            partialF = -35.246499999999997 - var_x281 + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMs + 1.7323243489657528e-7 * var_x277 + (var_x133 * var_x278 + var_x137 * var_x279) * mParameters[0];
        }
        else
        {
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x135 = 4.7355244569298691e-7 * var_x87;
            const double var_x136 = 2.5855989390826479e-7 * var_x88;
            const double var_x138 = var_x29 * var_x37;
            const double var_x139 = var_x11 * (-0.0025297242600556538 - 0.0011051656880977081 * var_x9 - 1.8271247633873431 * var_chaste_interface__intracellular_ion_concentrations__Ca_sub - (0.0011051656880977081 + 8.3598009689690465e-5 * var_chaste_interface__intracellular_ion_concentrations__Nai) * var_chaste_interface__intracellular_ion_concentrations__Nai);
            const double var_x140 = var_x126 * var_x139;
            const double var_x141 = var_x22 * var_x9;
            const double var_x142 = var_x140 + 0.0022103313761954162 * var_x141 + 4.1799004844845232e-5 * var_x23 + var_x128 * var_x139;
            const double var_x143 = var_x142 * var_x31;
            const double var_x144 = pow((1 + var_x6), (-2));
            const double var_x145 = 0.0014304645462223146 * var_x144 * var_chaste_interface__intracellular_ion_concentrations__Nai;
            const double var_x146 = var_x145 * var_x37;
            const double var_x147 = var_x140 * var_x42;
            const double var_x148 = var_x29 - var_x145;
            const double var_x149 = var_x148 * var_x21;
            const double var_x150 = var_x50 * (var_x138 + var_x143 + var_x147 - var_x146) - var_x140 * var_x57 - 26.376837971040871 * var_x149 * var_x17 * var_x61;
            const double var_x152 = var_x0 * var_x92;
            const double var_x153 = var_x146 - var_x138 - var_x143 - var_x147 - 4.1799004844845232e-5 * var_x70 - var_x134 * var_x139 - var_x135 * var_x139 - var_x136 * var_x139 - var_x142 * var_x60 - var_x149 * var_x50 - 0.0033154970642931239 * var_x24 * var_x67 - 0.0012068421382448356 * var_x141 * var_x74 - 2.2822279467564968e-5 * var_x23 * var_x74 + 1.5809003345251601e-6 * var_x144 * var_x53 * var_x86 - 32.140377158446256 * var_x148 * var_x17 * var_x51;
            const double var_x154 = var_x92 * var_x93 / (var_x99 * pow((0.032361865876120534 + var_x93), 2));
            const double var_x155 = var_x100 * var_x92;
            const double var_x282 = 0.0024012228482076215 * var_x77;
            const double var_x283 = 1.0288999782284837e-6 * var_x90;
            
            partialF = (-2.4598814923744084e-5 * var_x152 - 2.4287088639502301e-6 * var_x154 - 5.1430434785105685e-5 * var_x155 - 9.2414019019544699e-7 * var_x92 - var_x150 * var_x282 - var_x153 * var_x283) * mParameters[0];
        }
        else
        {
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x4 = var_x3 * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy;
            const double var_x80 = var_chaste_interface__AP_sensitive_currents_q_gate__q * var_chaste_interface__AP_sensitive_currents_r_gate__r;
            const double var_x109 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ki;
            const double var_x115 = 1 / (0.12 * var_chaste_interface__intracellular_ion_concentrations__Nai + var_chaste_interface__intracellular_ion_concentrations__Ki);
            const double var_x151 = var_x1 * var_x115;
            const double var_x156 = var_x0 * var_x109;
            const double var_x157 = var_x109 * var_chaste_interface__AP_sensitive_currents_r_gate__r;
            const double var_x158 = var_x109 * var_x4;
            const double var_x159 = var_x109 * var_x80;
            
            partialF = (-1.406291416773793e-8 + 0.0001711370722584161 * var_x158 - 4.4324501714929775e-6 * var_x151 - 3.4227414451683221e-6 * var_x157 - 3.0804673006514896e-5 * var_x159 - 3.9577587173161957e-5 * var_x156) * mParameters[0];
        }
        else
        {
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x285 = -227.69999999999999 * var_chaste_interface__intracellular_ion_concentrations__Cai;
            
            partialF = -0.54200000000000004 + var_x285;
        }
        else
        {
    ...
    double Cellkurata_model_2002FromCellMLGRL2::EvaluatePartialDerivative25(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0075100000000000002 + var_x285;
        }
        else
        {
