...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellcourtemanche_ramirez_nattel_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x31 = var_x30 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x34 = var_chaste_interface__L_type_Ca_channel_f_Ca_gate__f_Ca * NV_Ith_S(mParameters, 0);
        ...
        const double var_x39 = var_chaste_interface__fast_sodium_current_j_gate__j * NV_Ith_S(mParameters, 0);
        ...
        const double var_x46 = (0.00046606814415738453 * var_x42 + 0.037435192301797954 * var_x44 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x43)) * NV_Ith_S(mParameters, 0) / (pow(var_x45, 2) * (1.0 + 31.622776601683793 * var_x41));
        const double var_x47 = 1.8 * var_x16 - 2744000.0 * var_x14;
        const double var_x48 = var_x13 * var_x47 * NV_Ith_S(mParameters, 0) / pow(var_x17, 2);
        ...
        const double var_x51 = -var_x29 * log10(140.0 * var_x40) + var_chaste_interface__membrane__V;
        const double var_x52 = var_x51 * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x53 = var_x52 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x54 = var_x30 * pow(var_chaste_interface__transient_outward_K_current_oa_gate__oa, 2);
        const double var_x55 = var_x23 * var_x30 * pow(var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ua_gate__ua, 2);
        const double var_x56 = var_x24 * var_x30;
        const double var_x57 = var_x30 * var_chaste_interface__slow_delayed_rectifier_K_current_xs_gate__xs;
        const double var_x58 = 8.0437499999999993 - 0.12375 * var_chaste_interface__membrane__V;
        const double var_x59 = var_x58 * var_chaste_interface__L_type_Ca_channel_f_Ca_gate__f_Ca;
        const double var_x60 = var_x40 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x65 = NV_Ith_S(mParameters, 0) / var_x64;
        const double var_x66 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x67 = var_x66 * NV_Ith_S(mParameters, 0);
        const double var_x68 = pow(var_x64, (-2));
        const double var_x69 = var_x68 * var_chaste_interface__intracellular_ion_concentrations__Ca_i * NV_Ith_S(mParameters, 0);
        ...
        const double var_x87 = 0.0072727272727272727 * var_x76;
        const double var_x88 = ((var_x78) ? (0) : (var_x83 - 0.032000000000000001 * var_x79 * var_x81 / pow(var_x82, 2)));
        ...
        const double var_x99 = ((var_x90) ? (-0.019852941176470591 * var_x89) : (0));
        const double var_x100 = ((var_x90) ? (0.28123999999999999 * var_x93 + 108500.0 * var_x92) : (0.693000693000693 * var_x94 / pow(var_x95, 2)));
        ...
        const double var_x121 = ((var_x90) ? (-0.001275024 * var_x104 + 0.016701360000000002 * var_x101 * var_x103 / pow(var_x102, 2)) : (-7.6049999999999996e-8 * var_x108 + 0.029999999999999999 * var_x105 * var_x107 / pow(var_x106, 2)));
        const double var_x122 = ((var_x90) ? (var_x117 + var_x110 * var_x113 * (1.5254334000000001e-6 * var_x115 - 31073.016 * var_x114) - 0.311 * var_x110 * var_x111 * var_x116 / pow(var_x112, 2)) : (0));
        const double var_x123 = exp(-1.1670467502850628 - 0.057012542759407071 * var_chaste_interface__membrane__V);
        ...
        const double var_x130 = 1.9500000000000002 * (0.016949152542372881 * var_x125 + 0.11764705882352941 * var_x126) / pow(var_x127, 2) - 0.018352941176470589 * var_x129 / pow((1 + 0.40000000000000002 * var_x129), 2);
        ...
        const double var_x135 = exp(8.1320754716981138 + 0.18867924528301888 * var_chaste_interface__membrane__V);
        ...
        const double var_x141 = exp(-3.15625 - 0.10416666666666667 * var_chaste_interface__membrane__V);
        const double var_x142 = 1.0 + var_x141;
        const double var_x143 = exp(-3.6189956331877728 + 0.036390101892285295 * var_chaste_interface__membrane__V);
        ...
        const double var_x149 = exp(-2.1692307692307691 - 0.15384615384615385 * var_chaste_interface__membrane__V);
        ...
        const double var_x164 = exp(1.5669291338582676 - 0.07874015748031496 * var_chaste_interface__membrane__V);
        ...
        const double var_x177 = exp(-1.25 - 0.125 * var_chaste_interface__membrane__V);
        ...
        const double var_x186 = 0.005608974358974359 * var_x179 * var_x180;
        ...
        const double var_x189 = exp(-4.057971014492753 - 0.14492753623188406 * var_chaste_interface__membrane__V);
        ...
        const double var_x193 = var_x192 - 2.7189219554066812e-7 * var_x48 - 0.00011173862339878819 * var_x19;
        ...
        const double var_x206 = var_x34 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x207 = -15.246234849736588 + 0.23455745922671672 * var_chaste_interface__membrane__V;
        const double var_x208 = var_x205 * var_x207;
        const double var_x209 = var_x34 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x210 = var_x33 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x214 = 264667.15435259696 * var_x204;
        const double var_x215 = var_x196 * var_x211;
        const double var_x216 = var_x199 + 306.61078260627482 * var_x70;
        ...
        const double var_x224 = 0.47846889952153115 * var_x223;
        const double var_x225 = var_x207 * var_x222;
        const double var_x226 = var_x207 * var_x224;
        const double var_x227 = 1013080.0166606582 * var_x223;
        const double var_x228 = exp(2.3529411764705883 + var_x171);
        ...
        const double var_x237 = var_x230 * var_x232;
        const double var_x238 = ((var_x231) ? (1.0833333333333333) : (var_x230 * var_x236));
        const double var_x239 = 5.9145564270171174e-6 * var_x36;
        const double var_x240 = var_x239 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x244 = 4.2880534095874102e-10 * NV_Ith_S(mParameters, 0);
        const double var_x245 = 4.6918356272010785e-8 * var_x35;
        const double var_x246 = var_x243 * (3.0496931576807009e-6 - 4.6918356272010785e-8 * var_chaste_interface__membrane__V);
        const double var_x247 = 0.21176470588235291 * var_x243;
        ...
        const double var_x252 = 1.2526727201836255e-7 * var_x5;
        const double var_x253 = 2.2302249193675268e-8 * var_x10;
        ...
        const double var_x257 = 30.0 * var_x256;
        const double var_x258 = 30.0 * var_x198;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-var_x26 + 0.0063 * var_x32 + 0.0013130252232142858 * var_x49 - 0.12941175999999999 * var_x1 - 0.089999999999999997 * var_x4 - 0.12375 * var_x35 - 0.0018054375000000002 * NV_Ith_S(mParameters, 0) - 0.46904770956521741 * var_x46 - 0.00014738024843876965 * var_x19 - 3.5861851621648651e-7 * var_x48 - 0.0038461538461538464 * var_x50 - var_x11 * var_x12 - var_x38 * var_x39 - var_x6 * var_x7));
        IJth(rJacobian, 1, 0) = var_x85 * (var_x86 * var_x88 + var_x84 * (var_x87 - var_x88) / pow(var_x85, 2)) + (var_x88 - var_x87) * (-var_chaste_interface__fast_sodium_current_m_gate__m + var_x84 * var_x86);
        IJth(rJacobian, 2, 0) = var_x97 * (var_x98 * var_x99 + var_x91 * (-var_x100 - var_x99) / pow(var_x97, 2)) + (var_x100 + var_x99) * (-var_chaste_interface__fast_sodium_current_h_gate__h + var_x91 * var_x98);
        IJth(rJacobian, 3, 0) = var_x119 * (var_x120 * var_x122 + var_x118 * (-var_x121 - var_x122) / pow(var_x119, 2)) + (var_x121 + var_x122) * (-var_chaste_interface__fast_sodium_current_j_gate__j + var_x118 * var_x120);
        IJth(rJacobian, 4, 0) = var_x130 * (1 / var_x124 - var_chaste_interface__transient_outward_K_current_oa_gate__oa) + 0.057012542759407071 * var_x123 * var_x133 / pow(var_x124, 2);
        IJth(rJacobian, 5, 0) = (1 / var_x136 - var_chaste_interface__transient_outward_K_current_oi_gate__oi) * (0.00031887818877678569 * var_x137 / pow((1 + 0.028121484814398197 * var_x137), 2) - 0.00079791438902835471 * var_x138 / pow((1 + 0.053966540744738258 * var_x138), 2)) - 0.18867924528301888 * var_x135 * (var_x139 + var_x140) / pow(var_x136, 2);
        IJth(rJacobian, 6, 0) = var_x130 * (1 / var_x142 - var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ua_gate__ua) + 0.10416666666666667 * var_x133 * var_x141 / pow(var_x142, 2);
        IJth(rJacobian, 7, 0) = (1 / var_x144 - var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ui_gate__ui) * (0.1875 * var_x145 + 0.00024295432458697764 * var_x146 / pow((1 + 0.047619047619047616 * var_x146), 2)) - 0.036390101892285295 * var_x143 * (var_x147 + var_x148) / pow(var_x144, 2);
        IJth(rJacobian, 8, 0) = (1 / var_x150 - var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr) * (((var_x152) ? (0) : (var_x156 - 5.9999999999999995e-5 * var_x151 * var_x154 / pow(var_x155, 2))) + ((var_x158) ? (0) : (var_x161 - 1.4422780412592461e-5 * var_x157 * var_x159 / pow(var_x160, 2)))) + 0.15384615384615385 * var_x149 * (var_x162 + var_x163) / pow(var_x150, 2);
        IJth(rJacobian, 9, 0) = (pow(var_x165, (-0.5)) - var_chaste_interface__slow_delayed_rectifier_K_current_xs_gate__xs) * (2.0 * ((var_x167) ? (0) : (var_x170 - 3.8888888888888887e-6 * var_x166 * var_x168 / pow(var_x169, 2))) + 2.0 * ((var_x167) ? (0) : (var_x174 - 2.3529411764705885e-6 * var_x166 * var_x172 / pow(var_x173, 2)))) + 0.03937007874015748 * var_x164 * pow(var_x165, (-1.5)) * (var_x175 + var_x176);
        IJth(rJacobian, 10, 0) = (1 / var_x178 - var_chaste_interface__L_type_Ca_channel_d_gate__d) * ((var_x181) ? (-0.034998124100548214 * var_x179) : (var_x185 - var_x183 * var_x186 - var_x184 * var_x186 / pow(var_x182, 2))) + 0.125 * var_x177 * var_x187 / pow(var_x178, 2);
        IJth(rJacobian, 11, 0) = (0.0022222222222222222 + var_x188) * (-0.14492753623188406 * var_x191 + 0.14492753623188406 * pow(var_x189, 2) / pow(var_x190, 2)) + var_x188 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V) * (var_x191 - var_chaste_interface__L_type_Ca_channel_f_gate__f);
        IJth(rJacobian, 13, 0) = -var_x193 * var_x205;
        IJth(rJacobian, 14, 0) = var_x193 * var_x222 + var_x193 * var_x224;
        IJth(rJacobian, 15, 0) = (1.0 - 1 / var_x229 - var_chaste_interface__Ca_release_current_from_JSR_w_gate__w) * ((var_x231) ? (0) : (var_x236 - 0.01 * var_x234 * var_x237 - 0.033333333333333333 * var_x235 * var_x237 / pow(var_x233, 2))) - 0.058823529411764705 * var_x228 * var_x238 / pow(var_x229, 2);
        IJth(rJacobian, 16, 0) = -3.3526492139188636e-10 * var_x19 - 8.1579594228290865e-13 * var_x48 - 5.1141008336491763e-10 * NV_Ith_S(mParameters, 0) - 1.0670035173794672e-6 * var_x46 - var_x240 * var_x39;
        IJth(rJacobian, 17, 0) = var_x243 * (-var_x244 - var_x245 + 2.7193198076096957e-13 * var_x48 + 1.1175497379729545e-10 * var_x19);
        IJth(rJacobian, 18, 0) = 7.1133567825297815e-7 * var_x46 + 9.9563612471764592e-10 * var_x49 + 4.7771417295138258e-9 * var_x32 - 6.8244881850197507e-8 * var_x4 - 2.9164479423161327e-9 * var_x50 - 9.8129891902512382e-8 * var_x1 - 7.5827646500219453e-7 * var_x26 - var_x12 * var_x253 - var_x252 * var_x7;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-23.399999999999999 * var_x53);
        IJth(rJacobian, 1, 1) = -var_x77 - var_x84;
        IJth(rJacobian, 16, 1) = -1.7743669281051352e-5 * var_x53 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x37 * var_x52);
        IJth(rJacobian, 2, 2) = -var_x91 - var_x96;
        IJth(rJacobian, 16, 2) = -var_x239 * var_x52 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x38 * var_x51);
        IJth(rJacobian, 3, 3) = -var_x109 - var_x118;
        IJth(rJacobian, 16, 3) = -var_x240 * var_x51 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.49560000000000004 * var_x54 * var_chaste_interface__transient_outward_K_current_oi_gate__oi);
        IJth(rJacobian, 4, 4) = var_x134;
        IJth(rJacobian, 18, 4) = -3.7580181605508762e-7 * var_x54 * var_x7;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x30 * var_x6);
        IJth(rJacobian, 5, 5) = -var_x139 - var_x140;
        IJth(rJacobian, 18, 5) = -var_x252 * var_x31;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x55 * var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ui_gate__ui);
        IJth(rJacobian, 6, 6) = var_x134;
        IJth(rJacobian, 18, 6) = -2.2748293950065834e-6 * var_x25 * var_x55;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x56);
        IJth(rJacobian, 7, 7) = -var_x147 - var_x148;
        IJth(rJacobian, 18, 7) = -7.5827646500219453e-7 * var_x56 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x30);
        IJth(rJacobian, 8, 8) = -var_x162 - var_x163;
        IJth(rJacobian, 18, 8) = -var_x253 * var_x31;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.25882351999999997 * var_x57);
        IJth(rJacobian, 9, 9) = -var_x175 - var_x176;
        IJth(rJacobian, 18, 9) = -1.9625978380502476e-7 * var_x57 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x59 * var_chaste_interface__L_type_Ca_channel_f_gate__f);
        IJth(rJacobian, 10, 10) = -var_x187;
        IJth(rJacobian, 13, 10) = -var_x206 * var_x208;
        IJth(rJacobian, 14, 10) = var_x206 * var_x225 + var_x206 * var_x226;
        IJth(rJacobian, 17, 10) = var_x206 * var_x246;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x59 * var_chaste_interface__L_type_Ca_channel_d_gate__d);
        IJth(rJacobian, 11, 11) = -0.0022222222222222222 - var_x188;
        IJth(rJacobian, 13, 11) = -var_x208 * var_x209;
        IJth(rJacobian, 14, 11) = var_x209 * var_x225 + var_x209 * var_x226;
        IJth(rJacobian, 17, 11) = var_x209 * var_x246;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x33 * var_x58);
        IJth(rJacobian, 12, 12) = -0.5;
        IJth(rJacobian, 13, 12) = -var_x208 * var_x210;
        IJth(rJacobian, 14, 12) = var_x210 * var_x225 + var_x210 * var_x226;
        IJth(rJacobian, 17, 12) = var_x210 * var_x246;
        IJth(rJacobian, 13, 13) = -0.125 + 529334.30870519392 * var_x204 * var_x212;
        IJth(rJacobian, 14, 13) = -4234674.4696415514 * var_x212 * var_x222 - 2026160.0333213164 * var_x212 * var_x223;
        IJth(rJacobian, 17, 13) = 0.42352941176470582 * var_x212 * var_x243;
        IJth(rJacobian, 19, 13) = -60.0 * var_x212 * var_x256;
        IJth(rJacobian, 13, 14) = var_x213 * var_x214;
        IJth(rJacobian, 14, 14) = var_x218 * (-1 - 2117337.2348207757 * var_x213 * var_x221) - var_x213 * var_x227;
        IJth(rJacobian, 17, 14) = var_x213 * var_x247;
        IJth(rJacobian, 19, 14) = -var_x213 * var_x257;
        IJth(rJacobian, 13, 15) = var_x214 * var_x215;
        IJth(rJacobian, 14, 15) = -var_x215 * var_x227 - 2117337.2348207757 * var_x215 * var_x222;
        IJth(rJacobian, 15, 15) = -var_x238;
        IJth(rJacobian, 17, 15) = var_x215 * var_x247;
        IJth(rJacobian, 19, 15) = -var_x215 * var_x257;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-208.36008900708595 * var_x62 - 0.00079585334156935614 * var_x61 - 0.018016135580732888 * var_x60 - 0.022248886402668498 * var_x63));
        IJth(rJacobian, 13, 16) = 7.5423570794182034e-5 * var_x204 * var_x61;
        IJth(rJacobian, 14, 16) = -0.00028870266332701257 * var_x223 * var_x61 - 0.00060338856635345627 * var_x222 * var_x61;
        IJth(rJacobian, 16, 16) = -1.3661211601158392e-8 * var_x60 - 1.8104305755161864e-9 * var_x61 - 0.00015799455173983574 * var_x62 - 5.0612420794952582e-8 * var_x63;
        IJth(rJacobian, 17, 16) = 6.0347685850539541e-10 * var_x243 * var_x61;
        IJth(rJacobian, 18, 16) = 3.3741613863301722e-8 * var_x63;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (0.27500000000000002 * var_x69 + 404.41140171598391 * var_x70 - 0.27500000000000002 * var_x65 - 0.015106106453013732 * var_x67));
        IJth(rJacobian, 12, 17) = -0.000175 / pow((0.00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        IJth(rJacobian, 13, 17) = -var_x205 * var_x216;
        IJth(rJacobian, 14, 17) = var_x216 * var_x222 + var_x216 * var_x224;
        IJth(rJacobian, 16, 17) = 0.00091996694429933613 * var_x70;
        IJth(rJacobian, 17, 17) = var_x243 * (-var_x250 - var_x251 + 1.0426301393780176e-7 * var_x69 - 0.00030665564809977873 * var_x70 - 3.7341176470588232e-7 * var_x249 - 5.7273025005690459e-9 * var_x67) + (0.00023800000000000004 / pow(var_x241, 3) + 7.0000000000000007e-5 / pow(var_x64, 3)) * (2.7058823529411762e-5 * var_chaste_interface__intracellular_ion_concentrations__Ca_up + 1.1175497379729545e-10 * var_x194 - 0.00040588235294117644 / var_x248 + var_x195 * var_x251 - var_x200 * var_x245 - var_x244 * (-13.356415961992688 * var_x28 * log10(1.8 * var_x66) + var_chaste_interface__membrane__V) - var_x250 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) / pow(var_x242, 2);
        IJth(rJacobian, 19, 17) = var_x256 * var_x258;
        IJth(rJacobian, 20, 17) = 4.6e-6 * var_x249;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-3.4569545938671333 * var_x71 - 2.4041548731586837 * var_x72 - 0.78567153503275577 * var_x73 - 26.712831923985377 * var_x75 - 4.4129598338423843 * var_x74));
        IJth(rJacobian, 18, 18) = -2.0255711761517402e-5 * var_x75 - 3.346243583002675e-6 * var_x74 - 5.9575623423748584e-7 * var_x73 - 2.621327309110667e-6 * var_x71 - 1.8230140585365661e-6 * var_x72;
        IJth(rJacobian, 13, 19) = var_x198 * var_x214;
        IJth(rJacobian, 14, 19) = -var_x198 * var_x227 - var_x199 * var_x222;
        IJth(rJacobian, 17, 19) = var_x243 * var_x251;
        IJth(rJacobian, 19, 19) = var_x256 * (-0.0055555555555555558 - var_x258) + 0.25 * (0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_rel - var_x195 * var_x258) / (pow(var_x254, 3) * pow((0.125 + var_x255), 2));
        IJth(rJacobian, 20, 19) = 0.00048309178743961351;
        IJth(rJacobian, 17, 20) = 2.7058823529411762e-5 * var_x243;
        IJth(rJacobian, 19, 20) = 0.0055555555555555558 * var_x256;
