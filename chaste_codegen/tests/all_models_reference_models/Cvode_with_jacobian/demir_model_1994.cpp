...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldemir_model_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x49 = 1 / NV_Ith_S(mParameters, 0);
        ...
        const double var_x55 = 1.2480000000000001e-5 * var_x12;
        const double var_x56 = var_x14 * var_x7;
        const double var_x57 = (var_x17 - var_x15) / pow(var_x11, 2);
        const double var_x58 = 1.2480000000000002e-9 * var_x57;
        const double var_x59 = var_x46 * var_x49;
        const double var_x60 = var_x32 * pow(var_chaste_interface__sodium_current_m_gate__m, 2);
        const double var_x61 = var_x32 * var_x33 * var_chaste_interface__membrane__V;
        const double var_x62 = 0.012424666784589715 * var_x61;
        const double var_x63 = 0.001 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        const double var_x64 = var_x20 * var_x49;
        const double var_x65 = 0.001 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L;
        const double var_x66 = 0.001 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T;
        const double var_x67 = var_x49 * (1.13445 - 0.02521 * var_chaste_interface__membrane__V);
        const double var_x68 = 0.001 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T;
        const double var_x69 = 1 / var_chaste_interface__intracellular_concentrations_and_buffer_equations__K_i;
        const double var_x70 = var_x24 * log10(var_x69 * var_chaste_interface__cleft_space_equations__K_c);
        const double var_x71 = 0.50070344964891056 * var_x70 - 0.018743278268729353 * var_chaste_interface__membrane__V;
        const double var_x72 = 0.001 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        const double var_x73 = (85.0 + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        const double var_x74 = (-75.0 + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        ...
        const double var_x77 = 3.7440000000000003e-9 * var_x57;
        const double var_x78 = 3.7440000000000001e-5 * var_x12;
        ...
        const double var_x84 = 12.424666784589714 * var_x44;
        const double var_x85 = 0.50070344964891056 * var_x19;
        ...
        const double var_x93 = 0.0043093582521187886 * var_x92;
        const double var_x94 = var_x39 / pow(var_x37, 3);
        const double var_x95 = var_x38 * var_chaste_interface__cleft_space_equations__K_c;
        const double var_x96 = 0.0031274360147155781 - 6.7401638248180558e-5 * var_chaste_interface__membrane__V;
        ...
        const double var_x102 = 0.0036153091494396427 - 8.0340203320880944e-5 * var_chaste_interface__membrane__V;
        const double var_x103 = 2.3863048094674991e-7 * var_x12;
        const double var_x104 = 2.3863048094674993e-11 * var_x57;
        const double var_x105 = 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        ...
        const double var_x110 = 0.0031868386878572369 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel;
        const double var_x111 = var_x107 * var_chaste_interface__SR_Ca_uptake_and_release__F2;
        const double var_x112 = var_x108 / pow(var_x106, 3);
        ...
        const double var_x120 = var_x114 * var_x116;
        const double var_x121 = 92.584269662921344 * var_x113 * var_x114 / pow(var_x115, 2);
        const double var_x122 = (var_x117 + var_x121 + 3703.370786516854 * var_x113) / pow((var_x113 - 0.025000000000000001 * var_x120), 2);
        ...
        const double var_x127 = 165.0 * var_x125 + 12360.0 * var_x126;
        const double var_x128 = 1 / var_x127;
        const double var_x129 = 13.095238095238095 * var_x125;
        const double var_x130 = var_x125 / pow((0.0031250000000000002 + var_x125), 2);
        const double var_x131 = 3.0654761904761907 * var_x130;
        const double var_x132 = -0.013095238095238096 * var_x125 * var_x128 + 1.0800578125490936e-9 * var_x125 * (var_x129 - var_x131) / pow((var_x126 + 0.013349514563106795 * var_x125), 2);
        ...
        const double var_x181 = 0.079190817585730572 * var_x29;
        const double var_x182 = 2.3863048094674991e-7 * var_x12;
        const double var_x183 = 2.3863048094674993e-11 * var_x57;
        const double var_x184 = var_x47 * var_x60;
        const double var_x185 = var_x181 * var_x61;
        ...
        const double var_x190 = 8.2399377586133985e-5 * var_x92;
        const double var_x191 = 0.0031913222489694526 * var_x70 - 0.00011946360864812103 * var_chaste_interface__membrane__V;
        const double var_x192 = 0.0031913222489694526 * var_x19;
        const double var_x193 = 5.493291839075599e-5 * var_x92;
        const double var_x194 = -129.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x195 = 0.27076272189238759 * var_x29;
        const double var_x196 = 8.1590568853116704e-7 * var_x12;
        const double var_x197 = 8.159056885311671e-11 * var_x57;
        const double var_x198 = var_x195 * var_x61;
        ...
        const double var_x202 = 0.00028173316601141397 * var_x92;
        ...
        const double var_x207 = 0.00040846013251011971 * var_chaste_interface__membrane__V - 0.010911506218902908 * var_x70;
        const double var_x208 = 0.010911506218902908 * var_x19;
        const double var_x209 = 0.00018782211067427598 * var_x92;
        const double var_x210 = 2.4589804690256458 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel;
        const double var_x211 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x212 = 0.019200000000000002 * var_x211 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        ...
        const double var_x215 = 0.95999999999999996 * var_x214 / pow(var_x213, 5);
        const double var_x216 = pow(var_x213, (-4));
        const double var_x217 = 0.95999999999999996 * var_x216 * pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i, 3);
        const double var_x218 = var_x215 - var_x217;
        ...
        const double var_x222 = var_x217 - var_x215;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x50 * (-0.00026580000000000001 + 0.46510361992332344 * var_x48 - 0.021149999999999999 * var_x5 - 0.02521 * var_x6 - 1.2480000000000001e-5 * var_x18 - 0.019629899999999999 * var_x0 - 0.018743278268729353 * var_x19 - 0.46510361992332344 * var_x45 - 0.0020092499999999998 * var_x4 - 2.3940879178437715e-5 * var_x42 + var_x20 * var_x22 - var_x29 * var_x35));
        IJth(rJacobian, 1, 0) = -1.1600092823800342e-7 + 7.9543493648916641e-8 * var_x18 - 6.4031556335771533e-6 * var_x4 - 6.7401638248180558e-5 * var_x5 - 8.0340203320880944e-5 * var_x6 + var_x22 * var_x96;
        IJth(rJacobian, 2, 0) = var_x124 * (-var_x117 * var_x119 - var_x119 * var_x121 - 7.5849514563106801e-7 * var_x120 * var_x122) - 9.2050381751343198e-13 * var_x122 * (-var_chaste_interface__sodium_current_m_gate__m - var_x118 * var_x119) / pow(var_x123, 2);
        IJth(rJacobian, 3, 0) = var_x127 * var_x132 + (var_x131 - var_x129) * (var_x134 - 0.001 * var_chaste_interface__sodium_current_h_gate__h1);
        IJth(rJacobian, 4, 0) = var_x132 * (8.25 * var_x125 + 618.0 * var_x126) + (var_x134 - 0.001 * var_chaste_interface__sodium_current_h_gate__h2) * (0.15327380952380953 * var_x130 - 0.65476190476190477 * var_x125);
        IJth(rJacobian, 5, 0) = (-var_x65 + 0.001 * var_x4) * (var_x138 - var_x142 - var_x146 - 11.356 * var_x139 * var_x147 / pow(var_x140, 2) - 17.659200000000002 * var_x143 * var_chaste_interface__membrane__V / pow(var_x144, 2) - 4.5720000000000001 * var_x135 * var_x148 / pow(var_x136, 2)) + 0.00016666666666666666 * var_x21 * (var_x138 * var_x148 - var_x142 * var_x147 - var_x146 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 6, 0) = (-var_x63 + 0.001 / var_x150) * (var_x155 + 7.5 * var_x156 / pow(var_x157, 2) - 0.9375 * var_x152 * var_x158 / pow(var_x153, 2)) - 0.00020000000000000001 * var_x149 * (30.0 * var_x159 + var_x155 * var_x158) / pow(var_x150, 2);
        IJth(rJacobian, 7, 0) = (-var_x68 + 0.001 / var_x161) * (35.600000000000001 * var_x163 - 35.600000000000001 * var_x164) + 0.00016666666666666666 * var_x160 * (1068.0 * var_x163 + 1068.0 * var_x164) / pow(var_x161, 2);
        IJth(rJacobian, 8, 0) = (-var_x66 + 0.001 / var_x166) * (0.97529258777633288 * var_x167 - 0.18367346938775511 * var_x168) - 0.00017857142857142857 * var_x165 * (15.0 * var_x167 + 15.300000000000001 * var_x168) / pow(var_x166, 2);
        IJth(rJacobian, 9, 0) = (-var_x72 + 0.001 / var_x172) * (0.67660000000000009 * var_x169 - 0.10760999999999998 * var_x170) + 0.00013513513513513514 * var_x171 * (17.0 * var_x169 + 2.1099999999999999 * var_x170) / pow(var_x172, 2);
        ...
        IJth(rJacobian, 12, 0) = -1.0197883801143159e-6 + 0.0029644204196681901 * var_x48 - 4.5777431992296659e-7 * var_x42 - 0.0029644204196681901 * var_x45 - 2.3863048094674991e-7 * var_x18 - 4.3008300195846126e-5 * var_x0 - var_x181 * var_x34;
        IJth(rJacobian, 13, 0) = -4.4233320987458456e-7 + 3.0518287994864439e-7 * var_x42 - 8.2106349321691435e-5 * var_x0 - 0.00011946360864812103 * var_x19;
        IJth(rJacobian, 18, 0) = 3.486776446714389e-6 + 1.5651842556189666e-6 * var_x42 + 0.010135702170189033 * var_x45 + 8.1590568853116704e-7 * var_x18 + 0.00014705043816962094 * var_x0 - 0.010135702170189033 * var_x48 + var_x195 * var_x34;
        ...
        IJth(rJacobian, 18, 1) = -var_x196 * var_x56 - var_x197 * var_x7;
        IJth(rJacobian, 19, 1) = 5.2976168399354324e-6 * var_x53 + 0.00031261130080073693 * var_x52 - 0.00031261130080073693 * var_x54 + var_x204 * var_x7 + var_x205 * var_x56;
        IJth(rJacobian, 21, 1) = 0.021865102489586532 * var_x98 - 0.27331378111983162 * var_x99;
        IJth(rJacobian, 24, 1) = var_x218 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        IJth(rJacobian, 25, 1) = var_x218 * var_chaste_interface__SR_Ca_uptake_and_release__F2 + var_x222 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        IJth(rJacobian, 26, 1) = var_x222 * var_chaste_interface__SR_Ca_uptake_and_release__F2;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.037274000353769147 * var_x59 * var_x60 * var_chaste_interface__membrane__V * var_chaste_interface__sodium_current_h_gate__h1);
        ...
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x59 * var_x62);
        IJth(rJacobian, 3, 3) = -var_x133 - 12.359999999999999 * var_x126;
        ...
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x29 * var_x49 * var_x62 * var_chaste_interface__sodium_current_h_gate__h1);
        IJth(rJacobian, 4, 4) = -0.61799999999999999 * var_x126 - 0.0082500000000000004 * var_x125;
        ...
        IJth(rJacobian, 1, 5) = var_x96 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        ...
        IJth(rJacobian, 1, 6) = var_x96 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L;
        ...
        IJth(rJacobian, 1, 7) = var_x102 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T;
        ...
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x67 * var_x68);
        IJth(rJacobian, 1, 8) = var_x102 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T;
        ...
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x50 * var_x71 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i);
        ...
        IJth(rJacobian, 20, 9) = var_x207 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x49 * var_x71 * var_x72);
        ...
        IJth(rJacobian, 20, 10) = var_x207 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x50 * (-0.025764200000000001 * var_x73 - 0.0134956 * var_x74));
        IJth(rJacobian, 11, 11) = -0.0016483000000000001 * var_x177 - 0.01401055 * var_x180;
        IJth(rJacobian, 12, 11) = -8.6016600391692252e-5 * var_x74;
        IJth(rJacobian, 13, 11) = -0.00016421269864338287 * var_x73;
        IJth(rJacobian, 18, 11) = 0.00029410087633924189 * var_x74;
        IJth(rJacobian, 20, 11) = 0.00056146253580274287 * var_x73;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x50 * (0.0011838896297029639 * var_x82 - 0.0042742017055513041 * var_x25 - 0.0064640373781781829 * var_x83 + var_x76 * var_x77 - var_x26 * var_x84 - var_x78 * var_x79));
        IJth(rJacobian, 1, 12) = var_x103 * var_x79 - var_x104 * var_x76;
        IJth(rJacobian, 12, 12) = 2.2637191644542304e-5 * var_x82 - 0.00012359906637920097 * var_x83 - 2.7242382709912566e-5 * var_x25 + var_x186 * var_x76 - var_x187 * var_x79 - var_x188 * var_x26;
        IJth(rJacobian, 13, 12) = 8.2399377586133985e-5 * var_x83 - 1.5091461096361535e-5 * var_x82;
        IJth(rJacobian, 18, 12) = 9.3144911471392233e-5 * var_x25 + 0.00042259974901712096 * var_x83 - 7.739922143170714e-5 * var_x82 + var_x199 * var_x79 + var_x201 * var_x26 - var_x200 * var_x76;
        IJth(rJacobian, 19, 12) = var_x197 * var_x76 - var_x196 * var_x79;
        IJth(rJacobian, 20, 12) = 5.1599480954471424e-5 * var_x82 - 0.00028173316601141397 * var_x83;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x50 * (-0.0018539349897828783 * var_x69 - var_x69 * var_x85));
        IJth(rJacobian, 13, 13) = -1.1816383500424576e-5 * var_x69 - var_x192 * var_x69;
        IJth(rJacobian, 20, 13) = 4.040160535071638e-5 * var_x69 + var_x208 * var_x69;
        ...
        IJth(rJacobian, 1, 16) = 0.00026350000000000001 + var_x105;
        IJth(rJacobian, 16, 16) = -0.0042500000000000003 + var_x194;
        IJth(rJacobian, 17, 16) = -3.2250000000000001;
        IJth(rJacobian, 1, 17) = var_x105;
        IJth(rJacobian, 16, 17) = var_x194;
        IJth(rJacobian, 17, 17) = -3.6539999999999999;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x50 * (var_x84 + 0.0042742017055513041 * var_x86 + var_x77 * var_x87 + var_x78 * var_x88 - var_x28 * var_x35 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 1, 18) = -var_x103 * var_x88 - var_x104 * var_x87;
        IJth(rJacobian, 12, 18) = var_x188 + 2.7242382709912566e-5 * var_x86 - 0.079190817585730572 * var_x189 + var_x186 * var_x87 + var_x187 * var_x88;
        IJth(rJacobian, 18, 18) = -0.099999999999999992 - var_x201 + 0.27076272189238759 * var_x189 - 9.3144911471392233e-5 * var_x86 - var_x199 * var_x88 - var_x200 * var_x87;
        IJth(rJacobian, 19, 18) = var_x196 * var_x88 + var_x197 * var_x87;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x50 * (0.00048619044400646078 * var_x89 + var_x58 * var_x9 - var_x55 * var_x90));
        IJth(rJacobian, 1, 19) = 1.5494105166262771e-6 * var_x89 + var_x101 * var_x90 - var_x100 * var_x9;
        IJth(rJacobian, 12, 19) = var_x183 * var_x9 - var_x182 * var_x90;
        IJth(rJacobian, 18, 19) = var_x196 * var_x90 - var_x197 * var_x9;
        IJth(rJacobian, 19, 19) = -0.099999999999999992 - 5.2976168399354324e-6 * var_x89 + var_x204 * var_x9 - var_x205 * var_x90;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (var_x50 * (0.0018539349897828783 * var_x91 + var_x85 * var_x91 + var_x93 * var_x94 - var_x93 * var_x95));
        IJth(rJacobian, 12, 20) = var_x190 * var_x94 - var_x190 * var_x95;
        IJth(rJacobian, 13, 20) = 1.1816383500424576e-5 * var_x91 + var_x192 * var_x91 + var_x193 * var_x95 - var_x193 * var_x94;
        IJth(rJacobian, 18, 20) = var_x202 * var_x95 - var_x202 * var_x94;
        IJth(rJacobian, 20, 20) = -0.099999999999999992 - 4.040160535071638e-5 * var_x91 + var_x209 * var_x94 - var_x208 * var_x91 - var_x209 * var_x95;
        IJth(rJacobian, 1, 21) = 4.6933442493897489e-10 * var_x98 + 6.5185336797079855e-9 * var_x99;
        IJth(rJacobian, 21, 21) = -0.015581177937052042 - 4.0251665946738841e-8 * var_x98 - 5.5905091592692838e-7 * var_x99;
        IJth(rJacobian, 22, 21) = 0.14018251137810708;
        IJth(rJacobian, 1, 22) = 0.0015934193439286184 * var_x109;
        IJth(rJacobian, 21, 22) = 0.015581177937052042;
        IJth(rJacobian, 22, 22) = -8.979782511378108 + 8.8396000000000008 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_Calse - 1.2294902345128229 * var_x109;
        ...
        IJth(rJacobian, 24, 24) = var_x221 - var_x219;
        IJth(rJacobian, 25, 24) = var_x219 + var_x220;
        IJth(rJacobian, 1, 25) = var_x110 * var_x111 - var_x110 * var_x112;
        IJth(rJacobian, 22, 25) = var_x112 * var_x210 - var_x111 * var_x210;
        IJth(rJacobian, 25, 25) = -0.040000000000000001 + var_x221;
        IJth(rJacobian, 26, 25) = 0.040000000000000001 + var_x220;
