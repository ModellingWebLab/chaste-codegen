...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x23 = NV_Ith_S(mParameters, 2) / var_x22;
        ...
        const double var_x40 = var_x39 * NV_Ith_S(mParameters, 1) * var_chaste_interface__INa_j_gate__j;
        ...
        const double var_x45 = var_x44 * NV_Ith_S(mParameters, 0) * var_chaste_interface__ICa_f_gate__f;
        ...
        const double var_x51 = 0.043478260869565216 * var_x21 * var_x36 * NV_Ith_S(mParameters, 2) * var_chaste_interface__IKr_Xr_gate__Xr / pow(var_x22, 2);
        ...
        const double var_x65 = 235.7603210147127 * var_x64;
        ...
        const double var_x68 = 0.00059999999999999995 * var_x67 * NV_Ith_S(mParameters, 0) * var_chaste_interface__ICa_d_gate__d;
        ...
        const double var_x74 = NV_Ith_S(mParameters, 1) * var_chaste_interface__INa_h_gate__h;
        const double var_x75 = var_x73 * var_x74 * pow(var_chaste_interface__INa_m_gate__m, 2) * var_chaste_interface__INa_j_gate__j;
        const double var_x76 = 1.0 * var_x73;
        const double var_x77 = var_x39 * var_x74;
        ...
        const double var_x81 = 8.0177272463458689 * var_x4 * var_x80;
        const double var_x82 = var_x81 - var_x78;
        ...
        const double var_x85 = var_x84 * var_chaste_interface__IKs_Xs_gate__Xs;
        const double var_x86 = var_x23 * var_x36;
        const double var_x87 = 0.026725757487819562 * var_x26;
        const double var_x88 = var_x0 * var_x83;
        const double var_x89 = 0.00979766269503465 * var_x88;
        ...
        const double var_x92 = 0.34476227159287232 * var_x91;
        ...
        const double var_x107 = 0.00084999999999999995 + var_x47;
        ...
        const double var_x127 = 5.7967541047930573e-8 * var_x108 * var_x67;
        const double var_x128 = var_x127 * var_x45;
        const double var_x129 = var_x127 * var_x44 * NV_Ith_S(mParameters, 0) * var_chaste_interface__ICa_d_gate__d;
        const double var_x130 = ((var_x116) ? (var_x115 - var_x114 * var_chaste_interface__Irel__APtrack2) : (0));
        const double var_x131 = var_x106 * (0.0070588235294117632 * var_chaste_interface__Ionic_concentrations__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__Ionic_concentrations__Cai);
        const double var_x132 = 22.0 * var_x110 * var_chaste_interface__Irel__APtrack2;
        const double var_x133 = ((var_x116) ? (var_x112 * var_x132 - var_x113 * var_x132 / pow(var_x111, 2)) : (0));
        const double var_x134 = var_x108 * var_x90;
        ...
        const double var_x178 = 1.0 - var_chaste_interface__Ito_r_gate__r;
        ...
        const double var_x187 = 1.0 - var_chaste_interface__Ito_t_gate__t;
        ...
        const double var_x199 = 1.0 - var_chaste_interface__IKr_Xr_gate__Xr;
        ...
        const double var_x210 = var_x28 * var_x34;
        const double var_x211 = 0.00019322513682643524 * var_x108;
        const double var_x212 = var_x211 * var_x73;
        const double var_x213 = var_x211 * (var_x78 - var_x81);
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0018500000000000001 + var_x38 + var_x51 + var_x61 - var_x1 - var_x20 - var_x25 - var_x3 - var_x42 - var_x47 - var_x50 - var_x29 * var_x34);
        IJth(rJacobian, 1, 0) = -var_x106 * var_x109 * (var_x107 - 4.3636185975418378e-7 * var_x60 - 0.00017941694216498839 * var_x58);
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__INa_m_gate__m) * ((var_x140) ? (var_x138 - 0.032000000000000001 * var_x136 * var_x139 / pow(var_x137, 2)) : (0)) + 0.0072727272727272727 * var_x141 * var_chaste_interface__INa_m_gate__m;
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__INa_h_gate__h) * ((var_x143) ? (-0.019852941176470591 * var_x142) : (0)) - ((var_x143) ? (0.28123999999999999 * var_x144 + 108500.0 * var_x145) : (0.693000693000693 * var_x146 / pow(var_x147, 2))) * var_chaste_interface__INa_h_gate__h;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__INa_j_gate__j) * ((var_x143) ? (var_x154 + var_x150 * var_x155 * (1.5254334000000001e-6 * var_x152 - 31022.16 * var_x151) - 0.311 * var_x148 * var_x153 * var_x155 / pow(var_x149, 2)) : (0)) - ((var_x143) ? (-0.001275024 * var_x159 + 0.016701360000000002 * var_x156 * var_x158 / pow(var_x157, 2)) : (-7.6049999999999996e-8 * var_x163 + 0.029999999999999999 * var_x160 * var_x162 / pow(var_x161, 2))) * var_chaste_interface__INa_j_gate__j;
        IJth(rJacobian, 5, 0) = var_x165 * (0.028148326932247791 - 0.0044862181136439798 * var_chaste_interface__cell__V) * var_chaste_interface__ICa_d_gate__d + var_x166 * (1.0 - var_chaste_interface__ICa_d_gate__d) * (0.080354834965543909 - 0.0035936867158114449 * var_chaste_interface__cell__V);
        IJth(rJacobian, 6, 0) = (0.0074264700000000001 * var_x169 * var_x170 - 0.27789999999999998 * var_x167 * var_x171 / pow(var_x168, 2)) * var_chaste_interface__ICa_f_gate__f - 0.0011224539797135063 * var_x172 * (1.0 - var_chaste_interface__ICa_f_gate__f) / pow(var_x173, 2);
        IJth(rJacobian, 7, 0) = -0.0087415599999999989 * var_x178 * var_x182 - var_x176 * (5.1860000000000002e-5 - 0.069202559999999996 * var_x177) * var_chaste_interface__Ito_r_gate__r + 0.049658379999999995 * var_x178 * var_x179 * var_x181 / pow(var_x180, 2) - 0.1348 * var_x174 * var_x183 * var_chaste_interface__Ito_r_gate__r / pow(var_x175, 2);
        IJth(rJacobian, 8, 0) = var_x186 * var_x187 * (5.6119999999999998e-5 - 0.012473299999999998 * var_x188) - var_x191 * (0.0001215 - 1.2732200000000002e-10 * var_x192) * var_chaste_interface__Ito_t_gate__t + 0.17319999999999999 * var_x184 * var_x187 * var_x193 / pow(var_x185, 2) - 0.16039999999999999 * var_x189 * var_x194 * var_chaste_interface__Ito_t_gate__t / pow(var_x190, 2);
        IJth(rJacobian, 9, 0) = 0.00021044764652059425 * var_x195 * (1.0 - var_chaste_interface__IKs_Xs_gate__Xs) / pow(var_x196, 2) + 0.00037104930467762328 * var_x197 * var_chaste_interface__IKs_Xs_gate__Xs / pow(var_x198, 2);
        IJth(rJacobian, 10, 0) = 2.633e-6 * var_x199 * var_x203 - 2.5600000000000002e-5 * var_x207 * var_chaste_interface__IKr_Xr_gate__Xr + 0.0012527999999999999 * var_x204 * var_x206 * var_chaste_interface__IKr_Xr_gate__Xr / pow(var_x205, 2) + 0.00063100000000000005 * var_x199 * var_x200 * var_x202 / pow(var_x201, 2);
        IJth(rJacobian, 14, 0) = ((var_x209) ? (-var_x109 * (var_x107 + var_x61)) : (0));
        IJth(rJacobian, 18, 0) = -var_x211 * (0.001 + var_x41 + 0.00026912541324748262 * var_x58 + 2.8363636363636364 * var_x210 + 6.545427896312757e-7 * var_x60);
        IJth(rJacobian, 19, 0) = -var_x211 * (var_x1 + var_x20 + var_x24 + var_x3 + var_x50 - var_x38 - var_x51 - 1.8909090909090909 * var_x210);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x65 + var_x69 - var_x63 - var_x70);
        IJth(rJacobian, 1, 1) = var_x106 * (-var_x118 - var_x121 + 0.00036529411764705876 * var_x122 - var_x109 * (var_x123 + 471.5206420294254 * var_x64)) + (0.00023800000000000004 / pow(var_x103, 3) + 7.0000000000000007e-5 / pow(var_x104, 3)) * (2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR + var_x118 * var_x124 - var_x109 * (var_x126 + 0.00084999999999999995 * var_chaste_interface__cell__V - 0.00017941694216498839 * var_x125) - var_x121 * var_chaste_interface__Ionic_concentrations__Cai) / pow(var_x105, 2);
        IJth(rJacobian, 14, 1) = ((var_x209) ? (-var_x109 * (var_x123 + var_x65)) : (0));
        IJth(rJacobian, 18, 1) = 0.13666446085893647 * var_x108 * var_x64;
        IJth(rJacobian, 20, 1) = var_x117 * var_x216;
        IJth(rJacobian, 21, 1) = 0.0044999999999999997 * var_x120 - 0.0044999999999999997 * var_x122;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x75);
        IJth(rJacobian, 2, 2) = -((var_x140) ? (var_x138 * var_x139) : (3.2000000000000002)) - 0.080000000000000002 * var_x141;
        IJth(rJacobian, 18, 2) = -0.0005796754104793058 * var_x108 * var_x75;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x40 * var_x76);
        IJth(rJacobian, 3, 3) = -((var_x143) ? (0.13500000000000001 * var_x142) : (0)) - ((var_x143) ? (310000.0 * var_x145 + 3.5600000000000001 * var_x144) : (7.6923076923076916 / var_x147));
        IJth(rJacobian, 18, 3) = -var_x212 * var_x40;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x76 * var_x77);
        IJth(rJacobian, 4, 4) = -((var_x143) ? (0.1212 * var_x159) : (0.29999999999999999 * var_x163)) - ((var_x143) ? (var_x154 * var_x155) : (0));
        IJth(rJacobian, 18, 4) = -var_x212 * var_x77;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x46 * var_x67);
        IJth(rJacobian, 1, 5) = -var_x106 * var_x128;
        IJth(rJacobian, 5, 5) = -0.14710000000000001 + var_x165 - var_x166;
        IJth(rJacobian, 14, 5) = ((var_x209) ? (-var_x128) : (0));
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x44 * var_x68);
        IJth(rJacobian, 1, 6) = -var_x106 * var_x129;
        IJth(rJacobian, 6, 6) = -0.00054739999999999997 - 0.0068719999999999996 / var_x173 - var_x169 * var_x171;
        IJth(rJacobian, 14, 6) = ((var_x209) ? (-var_x129) : (0));
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x82 * var_chaste_interface__Ito_t_gate__t);
        IJth(rJacobian, 7, 7) = -0.52659999999999996 * var_x182 - var_x176 * var_x183;
        IJth(rJacobian, 19, 7) = -var_x213 * var_chaste_interface__Ito_t_gate__t;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x82 * var_chaste_interface__Ito_r_gate__r);
        IJth(rJacobian, 8, 8) = -var_x186 * var_x193 - var_x191 * var_x194;
        IJth(rJacobian, 19, 8) = -var_x213 * var_chaste_interface__Ito_r_gate__r;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.040000000000000001 * var_x85);
        IJth(rJacobian, 9, 9) = -0.0058700000000000002 / var_x198 - 0.0030130000000000001 / var_x196;
        IJth(rJacobian, 19, 9) = -7.7290054730574101e-6 * var_x108 * var_x85;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-1.0 * var_x86);
        IJth(rJacobian, 10, 10) = -0.016 * var_x207 - 0.0050000000000000001 * var_x203;
        IJth(rJacobian, 19, 10) = -var_x211 * var_x86;
        IJth(rJacobian, 11, 11) = ((var_x126 + 0.0018500000000000001 * var_chaste_interface__cell__V + 8.9708471082494196e-5 * var_x125 + var_x1 * var_x84 + var_x20 * var_x36 + var_x25 * var_x36 + var_x29 * var_x93 + var_x3 * (-var_x72 * var_x80 + var_chaste_interface__cell__V) + var_x42 * var_x73 + 1.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() - 0.026725757487819562 * var_x4 * var_x71 < -150.0) ? (-100.5) : (-0.5));
        IJth(rJacobian, 1, 12) = var_x130 * var_x131;
        IJth(rJacobian, 12, 12) = ((var_x208) ? (-100.5) : (-0.5));
        IJth(rJacobian, 20, 12) = var_x130 * var_x217;
        IJth(rJacobian, 13, 13) = ((var_x208) ? (-100.5) : (-0.01));
        IJth(rJacobian, 1, 14) = var_x131 * var_x133;
        IJth(rJacobian, 14, 14) = (((var_x209) || (var_chaste_interface__Irel__APtrack2 > 0.01)) ? (0) : (-0.5));
        IJth(rJacobian, 20, 14) = var_x133 * var_x217;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x87 - var_x89 - var_x92 - var_x95 - 0.00053825082649496523 * var_x90 - 0.044846846816933378 * var_x94);
        IJth(rJacobian, 1, 18) = 1.040035895964315e-7 * var_x106 * var_x134;
        IJth(rJacobian, 14, 18) = ((var_x209) ? (5.200179479821575e-8 * var_x134) : (0));
        IJth(rJacobian, 18, 18) = -var_x211 * (var_x87 + var_x95 + 0.0016147524794848955 * var_x90 + 0.13454054045080013 * var_x94);
        IJth(rJacobian, 19, 18) = -var_x211 * (var_x89 + var_x92 - 0.089693693633866756 * var_x94);
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x102 - var_x100 - var_x101 - var_x96 - var_x97 - var_x98);
        IJth(rJacobian, 19, 19) = -var_x211 * (var_x100 + var_x101 + var_x96 + var_x97 + var_x98 - var_x102);
        IJth(rJacobian, 1, 20) = var_x106 * var_x118;
        IJth(rJacobian, 20, 20) = var_x216 * (-0.0055555555555555558 - var_x117) + 0.25 * (0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_JSR - var_x117 * var_x124) / (pow(var_x214, 3) * pow((0.125 + var_x215), 2));
        IJth(rJacobian, 21, 20) = 0.00048309178743961351;
        IJth(rJacobian, 1, 21) = 2.1105882352941172e-5 * var_x106;
        IJth(rJacobian, 20, 21) = 0.0055555555555555558 * var_x216;
