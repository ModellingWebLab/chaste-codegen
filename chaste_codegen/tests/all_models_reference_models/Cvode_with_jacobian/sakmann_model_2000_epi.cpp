...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellsakmann_model_2000_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x6 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2) * NV_Ith_S(mParameters, 0);
        ...
        const double var_x10 = NV_Ith_S(mParameters, 0) / var_x9;
        ...
        const double var_x21 = var_chaste_interface__fast_sodium_current_h_gate__h * NV_Ith_S(mParameters, 0);
        ...
        const double var_x26 = NV_Ith_S(mParameters, 0) * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr;
        ...
        const double var_x30 = var_x8 * (-51.539700000000003 + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 0) / pow(var_x9, 2);
        ...
        const double var_x60 = 0.001 / NV_Ith_S(mParameters, 0);
        ...
        const double var_x67 = var_x25 * var_x28;
        ...
        const double var_x69 = 26.713760659695652 * var_x0;
        const double var_x70 = (-var_x69 * log10(8.1999999999999993 * var_x68) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs;
        ...
        const double var_x72 = -var_x69 * log10(140.47999999999999 * var_x71) + var_chaste_interface__membrane__V;
        const double var_x73 = var_x72 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2);
        const double var_x74 = var_x20 * var_x72;
        const double var_x75 = var_x31 * var_x50;
        const double var_x76 = var_x42 * var_x75;
        const double var_x77 = var_x50 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x78 = var_x77 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds;
        const double var_x79 = var_x42 * var_x78;
        const double var_x80 = var_x77 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x81 = var_x42 * var_x80;
        const double var_x82 = var_x60 * (0.0050000000000000001 * var_chaste_interface__membrane__V - 0.13356880329847826 * var_x2);
        ...
        const double var_x104 = var_x103 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x105 = pow(var_chaste_interface__calcium_release__ActFrac, 2);
        const double var_x106 = var_x105 / pow(var_x102, 3);
        ...
        const double var_x109 = exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x114 = 0.60999999999999999 * var_x113;
        ...
        const double var_x118 = 1.3799999999999999 * var_x117;
        ...
        const double var_x121 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V);
        ...
        const double var_x126 = 0.13100000000000001 * var_x125;
        ...
        const double var_x130 = 0.071899999999999992 * var_x129;
        ...
        const double var_x142 = 0.0030000000000000001 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        const double var_x159 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        ...
        const double var_x163 = exp(-0.80000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V);
        const double var_x164 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        ...
        const double var_x167 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x165, 2);
        ...
        const double var_x170 = 2 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        ...
        const double var_x176 = 0.5 * var_x171 * var_x175;
        const double var_x177 = var_x176 * (-2 * var_x167 + 2 * var_x166 + var_x169 * var_x170 * (var_x167 - var_x166));
        ...
        const double var_x181 = var_x176 * (2 * var_x174 - var_x170 * var_x173 / pow(var_x168, 2));
        const double var_x182 = var_x181 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x183 = 2.6016936179035892e-8 * var_x47;
        const double var_x184 = 5.2033872358071785e-9 * var_x45;
        const double var_x185 = 8.4392437745822447e-5 * var_x2 - 3.1591373008424612e-6 * var_chaste_interface__membrane__V;
        const double var_x186 = 5.2033872358071781e-5 * var_x38;
        const double var_x187 = -var_x108;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x60 * (0.00084999999999999995 + 26.600000000000001 * var_x6 + 0.0050000000000000001 * var_x7 + 5.0 * var_x10 + 0.057142857142857148 * var_x5 + 0.0024662812805474406 * var_x53 + 0.71091395097537402 * var_x30 + 21504.724822319993 * var_x22 + 6.6271048368438024 * var_x27 + 0.00021703275268817479 * var_x55 + 0.00011988 * var_x19 - 0.0032086192133781834 * var_x29 - 0.0012331406402737203 * var_x56 - 0.29585289450195545 * var_x49 - 3.0828516006843008e-7 * var_x58 - 1.5414258003421505e-6 * var_x59 + var_x32 * var_x39 + var_x43 * var_x46 + var_x43 * var_x48 + 1.2000000000000002e-7 * var_x11 * (var_x15 + var_x17 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds)));
        IJth(rJacobian, 1, 0) = -7.8978432521061529e-8 + 7.5743475924998844e-8 * var_x19;
        IJth(rJacobian, 2, 0) = (0.001 / var_x110 - 0.001 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr) * (var_x114 + var_x118 - 0.16973999999999997 * var_x115 * var_x119 / pow(var_x116, 2) - 0.088449999999999987 * var_x111 * var_x120 / pow(var_x112, 2)) + 0.00013333333333333334 * var_x109 * (var_x114 * var_x120 + var_x118 * var_x119) / pow(var_x110, 2);
        IJth(rJacobian, 3, 0) = (0.001 / var_x122 - 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs) * (var_x126 + var_x130 - 0.0089997000000000011 * var_x123 * var_x131 / pow(var_x124, 2) - 0.0106412 * var_x127 * var_x131 / pow(var_x128, 2)) + 5.9880239520958083e-5 * var_x121 * (var_x126 * var_x131 + var_x130 * var_x131) / pow(var_x122, 2);
        IJth(rJacobian, 4, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x133) ? (0) : (var_x137 - 20.0 * var_x132 * var_x135 / pow(var_x136, 2))) + 0.44800000000000001 * var_x138 * var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        IJth(rJacobian, 6, 0) = (0.0030000000000000001 - var_x142) * ((var_x144) ? (0) : (var_x147 - 4.166666666666667 * var_x143 * var_x145 / pow(var_x146, 2))) - var_x142 * ((var_x144) ? (0) : (var_x150 - 0.66666666666666663 * var_x143 * var_x148 / pow(var_x149, 2)));
        IJth(rJacobian, 7, 0) = (0.00029999999999999997 - 0.00029999999999999997 * var_chaste_interface__L_type_Ca_channel_f_gate__f) * ((var_x152) ? (0) : (var_x156 - 1.2254901960784315 * var_x151 * var_x154 / pow(var_x155, 2))) - 0.00070588235294117652 * var_x157 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x158, 2);
        IJth(rJacobian, 10, 0) = -0.058823529411764705 * var_x160 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x161 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x162, 2);
        IJth(rJacobian, 11, 0) = 0.066600000000000006 * var_x163 / pow((1.0 + var_x163), 2);
        IJth(rJacobian, 14, 0) = -3.7909647610109532e-7 + 9.7391514846836631e-10 * var_x59 - 1.3634812078557129e-7 * var_x55 - 0.003159137300842461 * var_x10 - 2.2723042777499654e-7 * var_x19 - 13.58727566610877 * var_x22 - 0.00044917495604311853 * var_x30 - var_x183 * var_x43;
        IJth(rJacobian, 15, 0) = 2.0272937282365629e-6 * var_x29 + 0.00018692798291666739 * var_x49 + 1.9478302969367326e-10 * var_x58 - 0.0041871868173333493 * var_x27 - 3.6104426295342415e-5 * var_x5 - 0.016806610440481894 * var_x6 - 3.1591373008424612e-6 * var_x7 - 7.7913211877469303e-10 * var_x55 - var_x184 * var_x43;
        IJth(rJacobian, 16, 0) = 3.8956605938734649e-6 * var_x56 - 7.7913211877469299e-6 * var_x53 - var_x186 * var_x32;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x60 * (0.0033392200824619565 * var_x61 + 0.016470911962008009 * var_x66 - 328.95071999999999 * var_x62 - 8.2717199999999996e-7 * var_x65));
        IJth(rJacobian, 1, 1) = -7.0 + var_x95 + var_x96 + 0.00040000000000000002 * var_x100 - 0.00040000000000000002 * var_x98 - 0.20784009793819685 * var_x62 - 1.0549054718227806e-6 * var_x61 - 5.2262998388249204e-10 * var_x65 - 7.1999999999999991e-9 * var_x101;
        ...
        IJth(rJacobian, 12, 1) = -var_x178 + var_x164 * var_x177;
        IJth(rJacobian, 13, 1) = var_x178;
        IJth(rJacobian, 14, 1) = 1.5678899516474762e-9 * var_x65 + 0.62352029381459051 * var_x62;
        IJth(rJacobian, 16, 1) = -5.2033872358071781e-5 * var_x66;
        IJth(rJacobian, 17, 1) = 0.019599999999999999 * var_x98 + 3.5279999999999993e-7 * var_x101 - 0.019599999999999999 * var_x100;
        IJth(rJacobian, 19, 1) = 2.0 - var_x95;
        IJth(rJacobian, 20, 1) = 5.0 - var_x96;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0066271048368438026 * var_x67);
        IJth(rJacobian, 2, 2) = -0.0013799999999999999 * var_x117 * var_x119 - 0.00060999999999999997 * var_x113 * var_x120;
        IJth(rJacobian, 15, 2) = -0.0041871868173333493 * var_x67 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.053200000000000004 * var_x70);
        IJth(rJacobian, 3, 3) = -0.00013100000000000001 * var_x125 * var_x131 - 7.1899999999999999e-5 * var_x129 * var_x131;
        IJth(rJacobian, 15, 3) = -0.033613220880963787 * var_x70 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-64.514174466959972 * var_x73 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 4, 4) = -8.0 * var_x138 - 0.001 * ((var_x133) ? (2000.0) : (var_x132 * var_x137));
        IJth(rJacobian, 14, 4) = -40.761826998326313 * var_x21 * var_x73;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-21.504724822319993 * var_x74);
        IJth(rJacobian, 5, 5) = -2.0 / (1.0 + 320.0 * var_x141) - 0.02 * var_x140;
        IJth(rJacobian, 14, 5) = -13.58727566610877 * var_x74 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x60 * (var_x39 * var_x75 + var_x46 * var_x76 + var_x48 * var_x76));
        IJth(rJacobian, 6, 6) = -0.0030000000000000001 * ((var_x144) ? (120.0) : (var_x143 * var_x147)) - 0.0030000000000000001 * ((var_x144) ? (120.0) : (var_x143 * var_x150));
        IJth(rJacobian, 14, 6) = -var_x183 * var_x76;
        IJth(rJacobian, 15, 6) = -var_x184 * var_x76;
        IJth(rJacobian, 16, 6) = -var_x186 * var_x75;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x60 * (var_x39 * var_x78 + var_x46 * var_x79 + var_x48 * var_x79));
        IJth(rJacobian, 7, 7) = -0.00029999999999999997 * ((var_x152) ? (25.0) : (var_x151 * var_x156)) - 0.0035999999999999999 / var_x158;
        IJth(rJacobian, 14, 7) = -var_x183 * var_x79;
        IJth(rJacobian, 15, 7) = -var_x184 * var_x79;
        IJth(rJacobian, 16, 7) = -var_x186 * var_x78;
        IJth(rJacobian, 8, 8) = -0.001;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x60 * (var_x39 * var_x80 + var_x46 * var_x81 + var_x48 * var_x81));
        IJth(rJacobian, 9, 9) = -0.02;
        IJth(rJacobian, 14, 9) = -var_x183 * var_x81;
        IJth(rJacobian, 15, 9) = -var_x184 * var_x81;
        IJth(rJacobian, 16, 9) = -var_x186 * var_x80;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x82 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 10, 10) = -0.033000000000000002 / var_x162 - 3.3000000000000003e-5 * var_x160;
        IJth(rJacobian, 15, 10) = var_x185 * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x82 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 11, 11) = -0.33300000000000002;
        IJth(rJacobian, 15, 11) = var_x185 * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 12) = (0.10204081632653063 * var_x104 - 0.10204081632653063 * var_x106) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 12, 12) = var_x180 + var_x171 * (-0.059999999999999998 - var_x179);
        IJth(rJacobian, 13, 12) = var_x171 * (0.059999999999999998 + var_x179);
        IJth(rJacobian, 18, 12) = (0.5 * var_x106 - 0.5 * var_x104) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 12, 13) = var_x180;
        IJth(rJacobian, 13, 13) = -0.001 * var_x171;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x60 * (0.00071927999999999998 * var_x87 + 0.55999999999999994 * var_x83 + 0.016028256395817387 * var_x84 + 574472.07195607235 * var_x89 + 21.31758100643713 * var_x88 + 4.1177279905020022e-5 * var_x90 - 0.00035 * var_x85 + 7.1999999999999999e-7 * var_x11 * var_x86));
        IJth(rJacobian, 1, 14) = 4.5446085554999309e-7 * var_x87;
        IJth(rJacobian, 14, 14) = 6.634188331769168e-7 * var_x85 - 362.9672301617365 * var_x89 - 1.3633825666499792e-6 * var_x87 - 2.6016936179035892e-8 * var_x90 - 1.0127092529498691e-5 * var_x84 - 0.0010614701330830668 * var_x83;
        IJth(rJacobian, 15, 14) = 0.00070764675538871125 * var_x83 - 0.013469033064233261 * var_x88 - 4.4227922211794452e-7 * var_x85;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x60 * (68936.64863472867 * var_x89 + 0.13356880329847826 * var_x92 + 177.03489247815671 * var_x93 + 710.58603354790432 * var_x88 + 8.2354559810040044e-6 * var_x90 + 1.5265006091254658 * var_x91 - 0.085714285714285715 * var_x94));
        IJth(rJacobian, 14, 15) = -43.556067619408374 * var_x89;
        IJth(rJacobian, 15, 15) = 5.4156639443013623e-5 * var_x94 - 0.11185550647567587 * var_x93 - 0.00096448500280939937 * var_x91 - 8.4392437745822447e-5 * var_x92 - 5.2033872358071785e-9 * var_x90 - 0.44896776880777539 * var_x88;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x60 * (-0.32928000000000002 * var_x11 * var_x16 - 8.2800000000000004e-10 * (var_x63 - var_x64 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2)));
        IJth(rJacobian, 1, 16) = 0.001;
        IJth(rJacobian, 9, 16) = -0.02 / var_x159 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x159, 2);
        IJth(rJacobian, 12, 16) = -var_x182 + var_x164 * var_x181;
        IJth(rJacobian, 13, 16) = var_x182;
        IJth(rJacobian, 16, 16) = -0.01;
        IJth(rJacobian, 1, 17) = 9.5999999999999999e-8 * var_x100 + 7.1999999999999991e-9 * var_x98 - 1.7279999999999999e-12 * var_x101;
        IJth(rJacobian, 17, 17) = -0.050000000000000003 + 8.4671999999999982e-11 * var_x101 - 3.5279999999999993e-7 * var_x98 - 4.7039999999999993e-6 * var_x100;
        IJth(rJacobian, 18, 17) = 0.0050000000000000001;
        IJth(rJacobian, 1, 18) = 1.0204081632653063e-5 + 0.051020408163265314 * var_x107;
        IJth(rJacobian, 17, 18) = 0.050000000000000003;
        IJth(rJacobian, 18, 18) = -0.0050499999999999998 - 0.25 * var_x107;
        IJth(rJacobian, 1, 19) = 0.050000000000000003 + var_x108;
        IJth(rJacobian, 19, 19) = -0.050000000000000003 + var_x187;
        IJth(rJacobian, 1, 20) = 0.20000000000000001 + var_x108;
        IJth(rJacobian, 20, 20) = -0.20000000000000001 + var_x187;
    }
