...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellsakmann_model_2000_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x150 = -0.00070588235294117652 * var_x148 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x149, 2);
        ...
        const double var_x171 = var_x166 + var_x170 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x172 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x164, 2);
        const double var_x173 = 2 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x174 = var_x171 * (-2 * var_x172 + 2 * var_x165 + var_x168 * var_x173 * (var_x172 - var_x165));
        ...
        const double var_x180 = pow(var_x171, 2);
        const double var_x181 = 2.5 * var_x180;
        const double var_x182 = 0.5 * var_x180;
        const double var_x183 = var_x171 * (2 * var_x170 - var_x169 * var_x173 / pow(var_x167, 2));
        ...
        const double var_x188 = 0.0016440603555991614 * var_x23;
        const double var_x189 = 2.6016936179035892e-8 * var_x45;
        const double var_x190 = 5.0664960489733526e-7 * var_x11;
        const double var_x191 = 5.2033872358071785e-9 * var_x36;
        const double var_x192 = 8.4392437745822447e-5 * var_x5 - 3.1591373008424612e-6 * var_chaste_interface__membrane__V;
        const double var_x193 = 5.2033872358071781e-5 * var_x43;
        const double var_x194 = -var_x101;
        ...
        IJth(rJacobian, 4, 0) = ((var_x128) ? (var_x126) : (var_x126 + var_x129 * var_x133 - 0.02 * var_x127 * var_x129 * var_x131 / pow(var_x132, 2)));
        IJth(rJacobian, 5, 0) = -0.125 * var_x136 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x137 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x137), 2);
        IJth(rJacobian, 6, 0) = ((var_x139) ? (0) : (var_x140 * var_x143 - var_x146 * var_chaste_interface__L_type_Ca_channel_d_gate__d + 0.002 * var_x138 * var_x144 * var_chaste_interface__L_type_Ca_channel_d_gate__d / pow(var_x145, 2) - 0.012500000000000001 * var_x138 * var_x140 * var_x141 / pow(var_x142, 2)));
        IJth(rJacobian, 7, 0) = ((var_x152) ? (var_x150) : (var_x150 + var_x153 * var_x156 - 0.00036764705882352941 * var_x151 * var_x153 * var_x154 / pow(var_x155, 2)));
        IJth(rJacobian, 10, 0) = -0.058823529411764705 * var_x159 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x160 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x161, 2);
        IJth(rJacobian, 11, 0) = 0.066600000000000006 * var_x162 / pow((1.0 + var_x162), 2);
        IJth(rJacobian, 14, 0) = -3.7909647610109532e-7 + 9.7391514846836631e-10 * var_x56 - 2.2723042777499654e-7 * var_x20 - 1.3634812078557129e-7 * var_x52 - 3.8225561340193784e-7 * var_x2 - 5.4350169681217345e-8 * var_x27 - var_x188 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x189 * var_x34;
        IJth(rJacobian, 15, 0) = 1.9478302969367326e-10 * var_x55 + 2.0272937282365629e-6 * var_x26 + 2.2618285932916757e-8 * var_x28 - 3.1591373008424612e-6 * var_x21 - 2.0335998632983093e-6 * var_x3 - 3.6104426295342415e-5 * var_x8 - 7.7913211877469303e-10 * var_x52 - var_x190 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr - var_x191 * var_x34;
        IJth(rJacobian, 16, 0) = 3.8956605938734649e-6 * var_x53 - 7.7913211877469299e-6 * var_x50 - var_x193 * var_x33;
        ...
        IJth(rJacobian, 12, 1) = ((var_x177) ? (-var_x176 + var_x163 * var_x175) : (-var_x179 + var_x163 * var_x178));
        ...
        IJth(rJacobian, 4, 4) = ((var_x128) ? (-2.0 + var_x134) : (var_x134 - var_x127 * var_x133));
        IJth(rJacobian, 14, 4) = -0.0049321810667974841 * var_x67;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x24 * var_x66);
        IJth(rJacobian, 5, 5) = -0.02 * var_x136 - 2.0 / (1.0 + 320.0 * var_x137);
        ...
        IJth(rJacobian, 6, 6) = ((var_x139) ? (-0.71999999999999997) : (-var_x138 * var_x143 - var_x138 * var_x146));
        ...
        IJth(rJacobian, 7, 7) = ((var_x152) ? (-0.0074999999999999997 + var_x157) : (var_x157 - var_x151 * var_x156));
        ...
        IJth(rJacobian, 10, 10) = -0.033000000000000002 / var_x161 - 3.3000000000000003e-5 * var_x159;
        ...
        IJth(rJacobian, 9, 16) = -0.02 / var_x158 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x158, 2);
        IJth(rJacobian, 12, 16) = ((var_x177) ? (-var_x185 + var_x163 * var_x184) : (-var_x187 + var_x163 * var_x186));
        ...
        IJth(rJacobian, 19, 19) = -0.050000000000000003 + var_x194;
        IJth(rJacobian, 1, 20) = 0.20000000000000001 + var_x101;
        IJth(rJacobian, 20, 20) = -0.20000000000000001 + var_x194;
    }
