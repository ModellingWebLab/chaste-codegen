...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellwinslow_model_1999FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x59 = 26.713760659695648 * var_x4;
        const double var_x60 = -var_x59 * log10(138.0 * var_x24) + var_chaste_interface__membrane__V;
        const double var_x61 = var_x33 * var_x60;
        const double var_x62 = 1 / (0.018329999999999999 * var_chaste_interface__intracellular_ion_concentrations__Nai + var_chaste_interface__intracellular_ion_concentrations__Ki);
        const double var_x63 = 6.3618821011065183 * var_x6 - 0.23815 * var_chaste_interface__membrane__V;
        const double var_x64 = var_x51 * var_x57;
        const double var_x65 = var_x46 * var_x64;
        const double var_x66 = -var_x34 * var_x42 - var_x65 * var_chaste_interface__L_type_Ca_current_y_gate__y;
        const double var_x67 = var_x35 * var_x42;
        const double var_x68 = var_x0 * var_x62;
        const double var_x69 = var_x15 * var_x17 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2);
        ...
        const double var_x77 = 7.2727272727272725 * var_x76 * var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x86 = 0.001 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x93 = 0.001 * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x114 = 0.1691 * var_x111;
        const double var_x115 = (-var_x114 + 0.012800000000000001 * var_x110) / pow(var_x112, 2);
        const double var_x116 = 0.001 / (0.027 + 0.001 * var_x113);
        const double var_x117 = exp(1.8161764705882353 - 0.073529411764705885 * var_chaste_interface__membrane__V);
        ...
        const double var_x122 = 0.13100000000000001 * var_x121;
        ...
        const double var_x126 = 0.071899999999999992 * var_x125;
        ...
        const double var_x135 = 1.0 - var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1;
        ...
        const double var_x139 = 0.0038461538461538464 * var_x138;
        const double var_x140 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x141 = 0.16 * var_x140;
        const double var_x142 = var_x141 * var_chaste_interface__L_type_Ca_current__C0;
        ...
        const double var_x147 = 0.10375 * var_chaste_interface__L_type_Ca_current__C0;
        const double var_x148 = 0.12 * var_x140;
        const double var_x149 = 0.0076923076923076927 * var_x138;
        ...
        const double var_x154 = 0.20749999999999999 * var_chaste_interface__L_type_Ca_current__C1;
        const double var_x155 = 0.080000000000000002 * var_x140;
        ...
        const double var_x162 = 0.41499999999999998 * var_chaste_interface__L_type_Ca_current__C2;
        const double var_x163 = 0.040000000000000001 * var_x140;
        const double var_x164 = 0.015384615384615385 * var_x138 * var_chaste_interface__L_type_Ca_current__C4;
        ...
        const double var_x168 = 0.82999999999999996 * var_chaste_interface__L_type_Ca_current__C3;
        const double var_x169 = 1.6599999999999999 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x170 = 1.6599999999999999 * var_chaste_interface__L_type_Ca_current__C4;
        const double var_x171 = 0.0019230769230769232 * var_x138;
        const double var_x172 = 0.32000000000000001 * var_x140 * var_chaste_interface__L_type_Ca_current__C_Ca0;
        const double var_x173 = 3.2000000000000002 * var_x140;
        const double var_x174 = 0.025000000000000001 * var_x138;
        const double var_x175 = 0.23999999999999999 * var_x140;
        const double var_x176 = 2.3999999999999999 * var_x140;
        const double var_x177 = 0.074999999999999997 * var_x138;
        const double var_x178 = var_x149 * var_chaste_interface__L_type_Ca_current__C_Ca4;
        const double var_x179 = exp(2.5 + var_x130);
        ...
        const double var_x210 = -var_x209 * var_x42 * var_chaste_interface__L_type_Ca_current_y_gate__y;
        ...
        IJth(rJacobian, 1, 0) = 0.001 * ((var_x80) ? (var_x77 + 271.72550724019402 * var_x75 / pow((-1 - 0.036859565057132324 * var_chaste_interface__membrane__V), 2)) : ((var_x78) ? (var_x77 + var_x75 * var_x84 - 32.0 * var_x75 * var_x79 * var_x82 / pow(var_x83, 2)) : (0)));
        IJth(rJacobian, 2, 0) = (0.001 - var_x86) * ((var_x88) ? (-19.852941176470587 * var_x87) : (0)) - var_x86 * ((var_x88) ? (281.24000000000001 * var_x89 + 108500.0 * var_x90) : (693.00069300069299 * var_x91 / pow(var_x92, 2)));
        IJth(rJacobian, 3, 0) = (0.001 - var_x93) * ((var_x88) ? (var_x100 + var_x101 * var_x99 * (1.5254334000000001e-6 * var_x95 - 31073.016 * var_x94) - 311.0 * var_x101 * var_x96 * var_x97 / pow(var_x98, 2)) : (0)) - var_x93 * ((var_x88) ? (-1.2750239999999999 * var_x105 + 16.701360000000001 * var_x102 * var_x104 / pow(var_x103, 2)) : (-7.6049999999999992e-5 * var_x109 + 30.0 * var_x106 * var_x108 / pow(var_x107, 2)));
        IJth(rJacobian, 4, 0) = var_x116 * (var_x111 * var_x115 + var_x113 * var_x114) - 0.0013717421124828533 * var_x115 * (-var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr + var_x111 * var_x113) / pow((1 + 0.037037037037037035 * var_x113), 2);
        IJth(rJacobian, 5, 0) = (0.001 / var_x118 - 0.001 * var_chaste_interface__slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks) * (var_x122 + var_x126 - 0.0089997000000000011 * var_x119 * var_x127 / pow(var_x120, 2) - 0.0106412 * var_x123 * var_x127 / pow(var_x124, 2)) + 7.3529411764705889e-5 * var_x117 * (var_x122 * var_x127 + var_x126 * var_x127) / pow(var_x118, 2);
        IJth(rJacobian, 6, 0) = 0.035770000000000003 * var_x128 * (0.045159999999999999 - 0.045159999999999999 * var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1) + 0.0061683930000000003 * var_x129 * var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1;
        IJth(rJacobian, 7, 0) = -0.001083 * var_x135 * var_x137 - 0.001083 * var_x136 * var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1 + 5.5595805000000001e-5 * var_x135 * pow(var_x133, 2) / pow(var_x134, 2) + 5.5595805000000001e-5 * pow(var_x131, 2) * var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1 / pow(var_x132, 2);
        IJth(rJacobian, 10, 0) = -var_x142 - var_x139 * var_chaste_interface__L_type_Ca_current__C1;
        IJth(rJacobian, 11, 0) = var_x142 + (var_x139 - var_x148) * var_chaste_interface__L_type_Ca_current__C1 - var_x149 * var_chaste_interface__L_type_Ca_current__C2;
        IJth(rJacobian, 12, 0) = var_x148 * var_chaste_interface__L_type_Ca_current__C1 + (var_x149 + var_x156) * var_chaste_interface__L_type_Ca_current__C2 - 0.011538461538461539 * var_x138 * var_chaste_interface__L_type_Ca_current__C3;
        IJth(rJacobian, 13, 0) = -var_x164 + var_x155 * var_chaste_interface__L_type_Ca_current__C2 + (-var_x163 + 0.011538461538461539 * var_x138) * var_chaste_interface__L_type_Ca_current__C3;
        IJth(rJacobian, 14, 0) = var_x164 + var_x163 * var_chaste_interface__L_type_Ca_current__C3;
        IJth(rJacobian, 15, 0) = -var_x172 - var_x171 * var_chaste_interface__L_type_Ca_current__C_Ca1;
        IJth(rJacobian, 16, 0) = var_x172 + (var_x171 - var_x175) * var_chaste_interface__L_type_Ca_current__C_Ca1 - var_x139 * var_chaste_interface__L_type_Ca_current__C_Ca2;
        IJth(rJacobian, 17, 0) = var_x175 * var_chaste_interface__L_type_Ca_current__C_Ca1 + (var_x139 - var_x141) * var_chaste_interface__L_type_Ca_current__C_Ca2 - 0.0057692307692307696 * var_x138 * var_chaste_interface__L_type_Ca_current__C_Ca3;
        IJth(rJacobian, 18, 0) = -var_x178 + var_x141 * var_chaste_interface__L_type_Ca_current__C_Ca2 + (var_x156 + 0.0057692307692307696 * var_x138) * var_chaste_interface__L_type_Ca_current__C_Ca3;
        IJth(rJacobian, 19, 0) = var_x178 + var_x155 * var_chaste_interface__L_type_Ca_current__C_Ca3;
        IJth(rJacobian, 20, 0) = -0.00016000000000000001 * var_x179 * var_x184 / pow(var_x180, 2) + 0.00017543859649122806 * var_x181 * (0.20000000000000001 - var_chaste_interface__L_type_Ca_current_y_gate__y + 0.80000000000000004 / var_x180) / (pow(var_x182, 2) * pow((0.033333333333333333 + var_x183), 2));
        IJth(rJacobian, 28, 0) = var_x193 * (-1.181949379053441e-5 + 4.0290675407414237e-8 * var_x23 + 8.279349689624225e-6 * var_x19);
        IJth(rJacobian, 30, 0) = var_x208 * (223.91545243606618 * var_x56 - 0.22391545243606617 * var_x54 - var_x204 * var_x41);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-38.399999999999999 * var_x31 * var_x60 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2));
        IJth(rJacobian, 1, 1) = 0.001 * ((var_x80) ? (var_x85 - 1000.0 / (-0.13565000000000002 - 0.0050000000000000001 * var_chaste_interface__membrane__V)) : ((var_x78) ? (var_x85 - var_x79 * var_x84) : (0)));
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x61 * var_chaste_interface__fast_sodium_current_j_gate__j);
        IJth(rJacobian, 2, 2) = -0.001 * ((var_x88) ? (135.0 * var_x87) : (0)) - 0.001 * ((var_x88) ? (3560.0 * var_x89 + 310000.0 * var_x90) : (7692.3076923076924 / var_x92));
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x61 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 3, 3) = -0.001 * ((var_x88) ? (121.2 * var_x105) : (300.0 * var_x109)) - 0.001 * ((var_x88) ? (var_x100 * var_x101) : (0));
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x20);
        IJth(rJacobian, 4, 4) = -var_x116;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0054267999999999999 * (-var_x59 * log10(6.5295399999999999 * var_x62) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks);
        IJth(rJacobian, 5, 5) = -0.00013100000000000001 * var_x121 * var_x127 - 7.1899999999999999e-5 * var_x125 * var_x127;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x63 * var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1);
        IJth(rJacobian, 6, 6) = -0.045159999999999999 * var_x128 - 0.098900000000000002 * var_x129;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x63 * var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1);
        IJth(rJacobian, 7, 7) = -0.0054149999999999997 * var_x136 - 0.0054149999999999997 * var_x137;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x66);
        IJth(rJacobian, 8, 8) = -2.0;
        IJth(rJacobian, 14, 8) = 2.0;
        IJth(rJacobian, 30, 8) = var_x210;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x66);
        IJth(rJacobian, 9, 9) = -7.0;
        IJth(rJacobian, 19, 9) = 7.0;
        IJth(rJacobian, 30, 9) = var_x210;
        IJth(rJacobian, 10, 10) = var_x144 - var_x145;
        IJth(rJacobian, 11, 10) = var_x143;
        IJth(rJacobian, 15, 10) = var_x145;
        IJth(rJacobian, 10, 11) = var_x146;
        IJth(rJacobian, 11, 11) = var_x151 - var_x150 - var_x152;
        IJth(rJacobian, 12, 11) = var_x150;
        IJth(rJacobian, 16, 11) = var_x152;
        IJth(rJacobian, 11, 12) = var_x153;
        IJth(rJacobian, 12, 12) = var_x157 + var_x159 - var_x160;
        IJth(rJacobian, 13, 12) = var_x158;
        IJth(rJacobian, 17, 12) = var_x160;
        IJth(rJacobian, 12, 13) = var_x161;
        IJth(rJacobian, 13, 13) = -var_x161 - var_x165 - var_x166;
        IJth(rJacobian, 14, 13) = var_x165;
        IJth(rJacobian, 18, 13) = var_x166;
        IJth(rJacobian, 8, 14) = 0.29999999999999999;
        IJth(rJacobian, 13, 14) = var_x167;
        IJth(rJacobian, 14, 14) = -0.29999999999999999 - var_x167 - var_x169;
        IJth(rJacobian, 19, 14) = var_x169;
        IJth(rJacobian, 10, 15) = 0.01;
        IJth(rJacobian, 15, 15) = -0.01 - var_x173;
        IJth(rJacobian, 16, 15) = var_x173;
        IJth(rJacobian, 11, 16) = 0.0050000000000000001;
        IJth(rJacobian, 15, 16) = var_x174;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 - var_x174 - var_x176;
        IJth(rJacobian, 17, 16) = var_x176;
        IJth(rJacobian, 12, 17) = 0.0025000000000000001;
        IJth(rJacobian, 16, 17) = var_x146;
        IJth(rJacobian, 17, 17) = -0.0025000000000000001 + var_x144 + var_x151;
        IJth(rJacobian, 18, 17) = var_x143;
        IJth(rJacobian, 13, 18) = 0.00125;
        IJth(rJacobian, 17, 18) = var_x177;
        IJth(rJacobian, 18, 18) = -0.00125 + var_x159 - var_x177;
        IJth(rJacobian, 19, 18) = var_x158;
        IJth(rJacobian, 9, 19) = 0.0070000000000000001;
        IJth(rJacobian, 14, 19) = 0.00062500000000000001;
        IJth(rJacobian, 18, 19) = var_x153;
        IJth(rJacobian, 19, 19) = -0.0076249999999999998 + var_x157;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-4.5147771746328917 * var_x67 - var_x35 * var_x65);
        IJth(rJacobian, 20, 20) = -0.001 * var_x184;
        IJth(rJacobian, 30, 20) = -var_x209 * var_x67;
        ...
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-0.001328652216129753 * var_x68 - 0.082812658045056511 * var_x24 - 0.00080737623974244774 * var_x69 - 341.93613644410431 * var_x24 * var_x31 * var_x32 - 0.023906819110872946 * var_x24 * var_x25 / (var_x30 * pow((0.031622776601683791 + var_x25), 2)));
        IJth(rJacobian, 28, 27) = 4.9676098137745351e-8 * var_x192 * var_x69;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (353.64048152206902 * var_x73 + 0.050000000000000003 * var_x74 - 0.050000000000000003 * var_x71 - 0.005131713422727534 * var_x72);
        ...
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-0.072485118174018176 * var_x68 + 0.24705882352941175 * var_x21 * var_x5 - 6.3618821011065183 * var_x12 * var_x5 - 17.599654081681837 * var_x5 * var_x8 - 0.05919769362188556 * var_x3 * var_x5 - var_x44 * var_x47 * var_x64 - 0.090826786242965196 * var_x10 * var_x5 * var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr);
        IJth(rJacobian, 10, 30) = -var_x147;
        IJth(rJacobian, 11, 30) = -var_x154;
        IJth(rJacobian, 12, 30) = -var_x162;
        IJth(rJacobian, 13, 30) = -var_x168;
        IJth(rJacobian, 14, 30) = -var_x170;
        IJth(rJacobian, 15, 30) = var_x147;
        IJth(rJacobian, 16, 30) = var_x154;
        IJth(rJacobian, 17, 30) = var_x162;
        IJth(rJacobian, 18, 30) = var_x168;
        IJth(rJacobian, 19, 30) = var_x170;
        ...
        IJth(rJacobian, 32, 32) = -0.13257434520702313 - 0.0011893356491532784 * var_x198 - 3.2630189260961817e-12 * var_x202;
    }
