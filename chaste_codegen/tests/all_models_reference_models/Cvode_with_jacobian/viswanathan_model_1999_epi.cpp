...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellviswanathan_model_1999_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x101 = 1 / NV_Ith_S(mParameters, 0);
        ...
        const double var_x113 = 2.3575679435995052e-7 * var_x112 * var_x25 * var_x26 * var_x30 / pow(var_x27, 2);
        ...
        const double var_x117 = 1.4628604942013857e-6 * var_x116 * var_x75;
        const double var_x118 = 4.1826974130498884e-7 * var_x116 * var_x78;
        ...
        const double var_x126 = var_x125 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x128 = var_x125 * var_x33;
        const double var_x129 = 0.016 * var_x101;
        const double var_x130 = var_x126 * var_x32;
        const double var_x131 = var_x71 * var_chaste_interface__membrane__V;
        const double var_x132 = var_x131 * var_x69;
        const double var_x133 = var_x114 * var_x70;
        const double var_x134 = var_x133 * var_x69;
        ...
        const double var_x137 = var_x136 * var_chaste_interface__T_type_Ca_channel_b_gate__b * var_chaste_interface__T_type_Ca_channel_g_gate__g;
        const double var_x138 = var_x136 * var_x88;
        const double var_x139 = var_x22 * var_x57;
        const double var_x140 = 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        const double var_x141 = var_x101 * var_x112 * var_x29;
        const double var_x142 = 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
        ...
        const double var_x148 = 0.010800000000000001 * var_x147;
        const double var_x149 = var_x110 * var_x31;
        const double var_x150 = 427.39741928797224 * var_x123 * var_x34;
        const double var_x151 = var_x108 * var_x146;
        const double var_x152 = 2.0416447122894152e-12 * var_x151;
        ...
        const double var_x162 = 0.003016 + var_x100 - var_x56;
        ...
        const double var_x168 = 9.0316078310111333e-5 * var_x167;
        ...
        const double var_x189 = var_x131 * var_x96;
        const double var_x190 = 0.00070463905573898956 * var_x167;
        const double var_x191 = var_x133 * var_x96;
        const double var_x192 = ((var_x178) ? (var_x177 - var_x176 * var_chaste_interface__calcium_dynamics__APtrack2) : (0));
        const double var_x193 = var_x185 * (0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x194 = 60000.0 * var_x172 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x195 = ((var_x178) ? (var_x174 * var_x194 - var_x175 * var_x194 / pow(var_x173, 2)) : (0));
        const double var_x196 = ((var_x178) ? (0) : ((var_x179) ? (4000.0 - 8000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        const double var_x197 = var_x152 - var_x148;
        ...
        const double var_x205 = 0.001 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x212 = 0.001 * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        const double var_x238 = 5.6089743589743595 * var_x229 * var_x233;
        const double var_x239 = ((var_x234) ? (0) : (var_x237 - var_x236 * var_x238 - var_x230 * var_x238 / pow(var_x235, 2)));
        const double var_x240 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x241 = ((var_x234) ? (218.40000000000003) : (var_x233 * var_x237));
        const double var_x242 = 0.00016025641025641026 * var_x229 * var_x241 / pow(var_x230, 2);
        ...
        const double var_x334 = var_x333 * (-var_chaste_interface__calcium_dynamics__Ca_JSR + var_chaste_interface__calcium_dynamics__Cai);
        ...
        const double var_x337 = 0.70463905573898955 * var_x166;
        const double var_x338 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        const double var_x339 = var_x37 * var_x44;
        const double var_x340 = 0.00018063215662022267 * var_x166;
        const double var_x341 = 0.0028901145059235626 * var_x166;
        const double var_x342 = var_x132 * var_x166;
        const double var_x343 = 4.4039940983686847e-7 * var_x75;
        const double var_x344 = var_x134 * var_x166;
        const double var_x345 = -0.433 - var_x28;
        const double var_x346 = var_x30 * var_x345;
        const double var_x347 = 1.2592160903483795e-7 * var_x78;
        const double var_x348 = var_x112 * var_x340 * var_x345;
        const double var_x349 = var_x110 * var_x346;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x102 * (0.0070160275741043606 + var_x100 + var_x19 + var_x24 + var_x3 + var_x31 + var_x35 + var_x56 + var_x58 + var_x63 + var_x77 + var_x80 + var_x82 + var_x83 - var_x64 - var_x66 - var_x86 - var_x87 + var_x38 * var_x44));
        IJth(rJacobian, 1, 0) = -var_x162 * var_x168;
        IJth(rJacobian, 2, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x203) ? (var_x201 - 32.0 * var_x199 * var_x202 / pow(var_x200, 2)) : (0)) + 0.0072727272727272727 * var_x204 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 3, 0) = (0.001 - var_x205) * ((var_x207) ? (-19.852941176470587 * var_x206) : (0)) - var_x205 * ((var_x207) ? (281.24000000000001 * var_x208 + 108500000.0 * var_x209) : (693.0006930006931 * var_x210 / pow(var_x211, 2)));
        IJth(rJacobian, 4, 0) = (0.001 - var_x212) * ((var_x207) ? (var_x219 + var_x218 * var_x220 * (1.5254334000000001e-6 * var_x214 - 31073.016 * var_x213) - 311.0 * var_x215 * var_x216 * var_x220 / pow(var_x217, 2)) : (0)) - var_x212 * ((var_x207) ? (-1.2750239999999999 * var_x224 + 16.701360000000001 * var_x221 * var_x223 / pow(var_x222, 2)) : (-7.6049999999999992e-5 * var_x228 + 30.0 * var_x225 * var_x227 / pow(var_x226, 2)));
        IJth(rJacobian, 5, 0) = var_x240 * var_x242 + var_x242 * var_chaste_interface__L_type_Ca_channel_d_gate__d + var_x231 * var_x239 * var_x240 + var_x232 * var_x239 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        ...
        IJth(rJacobian, 7, 0) = 9.2592592592592588e-5 * var_x259 * var_x264 / pow(var_x260, 2) + 0.036429872495446262 * var_x261 * (1 / var_x260 - var_chaste_interface__T_type_Ca_channel_b_gate__b) / (pow(var_x262, 2) * pow((0.60655737704918034 + var_x263), 2));
        IJth(rJacobian, 8, 0) = (0.001 / var_x266 - 0.001 * var_chaste_interface__T_type_Ca_channel_g_gate__g) * ((var_x267) ? (6.0763888888888884 / pow((1 - 0.072916666666666671 * var_chaste_interface__membrane__V), 2)) : (0)) - 0.00017857142857142857 * var_x265 * var_x268 / pow(var_x266, 2);
        ...
        IJth(rJacobian, 10, 0) = var_x295 * (var_x287 * var_x292 + var_x291 * var_x292) + (var_x283 - var_x142) * (var_x287 + var_x291 - 0.0089997000000000011 * var_x293 - 0.0106412 * var_x294);
        IJth(rJacobian, 11, 0) = var_x295 * (var_x292 * var_x298 + var_x292 * var_x299) + (var_x283 - var_x140) * (var_x298 + var_x299 - 0.0022499250000000003 * var_x293 - 0.0026603 * var_x294);
        ...
        IJth(rJacobian, 19, 0) = 0.001 * ((var_x336) ? (-var_x162 * var_x183) : (0));
        IJth(rJacobian, 23, 0) = var_x340 * (-0.0040000000000000001 + var_x87 - var_x35 - var_x77 - var_x82 - 4.5 * var_x339 - 0.0060000000000000001 * var_x51 * var_x54);
        IJth(rJacobian, 24, 0) = var_x340 * (-2.7574104360798206e-8 + var_x346 + var_x64 + var_x66 + var_x86 - var_x19 - var_x24 - var_x3 - var_x58 - var_x63 - var_x80 - var_x83 + 3.0 * var_x339);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x102 * (var_x113 + var_x122 - var_x104 - var_x107 - var_x109 - var_x117 - var_x118));
        IJth(rJacobian, 1, 1) = var_x185 * (var_x184 - var_x171 - var_x181 + 0.40588235294117642 * var_x182) + 0.001 * (0.00023800000000000004 / pow(var_x163, 3) + 7.0000000000000007e-5 / pow(var_x119, 3)) * (0.027058823529411764 * var_chaste_interface__calcium_dynamics__Ca_NSR + var_x181 * var_x186 - var_x171 * var_chaste_interface__calcium_dynamics__Cai - var_x183 * (var_x188 - var_x187 + 0.003016 * var_chaste_interface__membrane__V)) / pow(var_x164, 2);
        IJth(rJacobian, 14, 1) = var_x180 * var_x333;
        IJth(rJacobian, 15, 1) = 0.0050000000000000001 * var_x170 - 0.0050000000000000001 * var_x182;
        IJth(rJacobian, 19, 1) = 0.001 * ((var_x336) ? (var_x184) : (0));
        IJth(rJacobian, 23, 1) = var_x340 * (var_x117 + 2.6087319475749228e-6 * var_x108 + 4.1400000000000003e-5 * var_x106 + 13799.808000000001 * var_x103);
        IJth(rJacobian, 24, 1) = var_x340 * (var_x118 - var_x113);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.048000000000000001 * var_x101 * var_x127);
        IJth(rJacobian, 2, 2) = -0.001 * ((var_x203) ? (var_x201 * var_x202) : (3200.0)) - 0.080000000000000002 * var_x204;
        IJth(rJacobian, 23, 2) = -0.0086703435177706879 * var_x127 * var_x166;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x128 * var_x129);
        IJth(rJacobian, 3, 3) = -0.001 * ((var_x207) ? (135.0 * var_x206) : (0)) - 0.001 * ((var_x207) ? (3560.0 * var_x208 + 310000000.0 * var_x209) : (7692.3076923076933 / var_x211));
        IJth(rJacobian, 23, 3) = -var_x128 * var_x341;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x129 * var_x130);
        IJth(rJacobian, 4, 4) = -0.001 * ((var_x207) ? (121.2 * var_x224) : (300.0 * var_x228)) - 0.001 * ((var_x207) ? (var_x219 * var_x220) : (0));
        IJth(rJacobian, 23, 4) = -var_x130 * var_x341;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x102 * (var_x131 * var_x97 + var_x132 * var_x76 + var_x132 * var_x79));
        IJth(rJacobian, 1, 5) = -var_x189 * var_x190;
        IJth(rJacobian, 5, 5) = var_x232 * var_x241 - var_x231 * var_x241;
        IJth(rJacobian, 19, 5) = 0.001 * ((var_x336) ? (-var_x189 * var_x337) : (0));
        IJth(rJacobian, 23, 5) = -var_x342 * var_x343;
        IJth(rJacobian, 24, 5) = -var_x342 * var_x347;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x102 * (var_x133 * var_x97 + var_x134 * var_x76 + var_x134 * var_x79));
        IJth(rJacobian, 1, 6) = -var_x190 * var_x191;
        IJth(rJacobian, 6, 6) = var_x253 * var_x256 + var_x253 * var_x258;
        IJth(rJacobian, 19, 6) = 0.001 * ((var_x336) ? (-var_x191 * var_x337) : (0));
        IJth(rJacobian, 23, 6) = -var_x343 * var_x344;
        IJth(rJacobian, 24, 6) = -var_x344 * var_x347;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0001 * var_x101 * var_x137);
        IJth(rJacobian, 1, 7) = -9.0316078310111336e-6 * var_x137 * var_x167;
        IJth(rJacobian, 7, 7) = -0.001 * var_x264;
        IJth(rJacobian, 19, 7) = 0.001 * ((var_x336) ? (-0.0090316078310111337 * var_x137 * var_x166) : (0));
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-5.0000000000000002e-5 * var_x101 * var_x138);
        IJth(rJacobian, 1, 8) = -4.5158039155055668e-6 * var_x138 * var_x167;
        IJth(rJacobian, 8, 8) = -0.001 * var_x268;
        IJth(rJacobian, 19, 8) = 0.001 * ((var_x336) ? (-0.0045158039155055668 * var_x138 * var_x166) : (0));
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-2.3862446088641737e-5 * var_x101 * var_x139);
        IJth(rJacobian, 9, 9) = -0.0013799999999999999 * var_x277 * var_x279 - 0.00060999999999999997 * var_x273 * var_x280;
        IJth(rJacobian, 24, 9) = -4.3103250992251538e-6 * var_x139 * var_x166;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x140 * var_x141);
        IJth(rJacobian, 10, 10) = -0.00013100000000000001 * var_x296 - 7.1899999999999999e-5 * var_x297;
        IJth(rJacobian, 24, 10) = var_x348 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x141 * var_x142);
        IJth(rJacobian, 11, 11) = -3.2750000000000003e-5 * var_x296 - 1.7975e-5 * var_x297;
        IJth(rJacobian, 24, 11) = var_x348 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
        IJth(rJacobian, 12, 12) = -var_x309 - 10.0 * var_x306;
        IJth(rJacobian, 13, 13) = -var_x329 - 0.10000000000000001 * var_x322;
        IJth(rJacobian, 1, 14) = 7.0588235294117632e-6 * var_x165 * var_x180;
        IJth(rJacobian, 14, 14) = var_x333 * (-5.5555555555555554 - var_x180) + 0.00025000000000000001 * (5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR - var_x180 * var_x186) / (pow(var_x330, 3) * pow((0.125 + var_x331), 2));
        IJth(rJacobian, 15, 14) = 0.00048309178743961351;
        IJth(rJacobian, 1, 15) = 2.7058823529411762e-5 * var_x165;
        IJth(rJacobian, 14, 15) = 0.0055555555555555558 * var_x332;
        IJth(rJacobian, 15, 15) = -0.00081642512077294684;
        IJth(rJacobian, 16, 16) = 0.001 * ((1.0 * var_x101 * (var_x187 + var_x188 + 0.0070160275741043606 * var_chaste_interface__membrane__V - 7.3656881518639831e-7 * var_x6 + var_x112 * var_x31 + var_x125 * var_x35 + var_x144 * var_x38 + var_x19 * var_x57 + var_x24 * var_x57 + var_x3 * var_x57 + var_x77 * var_chaste_interface__membrane__V + var_x80 * var_chaste_interface__membrane__V + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() - 0.10684935482199306 * var_x124 * var_x4) < -150000.0) ? (-100500.0) : (-500.0));
        IJth(rJacobian, 1, 17) = var_x192 * var_x193;
        IJth(rJacobian, 14, 17) = var_x192 * var_x334;
        IJth(rJacobian, 17, 17) = 0.001 * ((var_x335) ? (-100500.0) : (-500.0));
        IJth(rJacobian, 18, 18) = 0.001 * ((var_x335) ? (-100500.0) : (-10.0));
        IJth(rJacobian, 1, 19) = var_x193 * var_x195;
        IJth(rJacobian, 14, 19) = var_x195 * var_x334;
        IJth(rJacobian, 19, 19) = 0.001 * (((var_x336) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-500.0));
        ...
        IJth(rJacobian, 1, 21) = var_x193 * var_x196;
        IJth(rJacobian, 14, 21) = var_x196 * var_x334;
        IJth(rJacobian, 21, 21) = 0.001 * (((var_x338) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50000.0) : (-500.0));
        IJth(rJacobian, 22, 22) = 0.001 * (((var_x338) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50000.0) : (-10.0));
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x102 * (var_x143 + var_x148 + var_x150 + var_x153 - var_x152 + 0.48963716847178318 * var_x149 + 0.029999999999999999 * var_x145));
        IJth(rJacobian, 1, 23) = -var_x168 * var_x197;
        IJth(rJacobian, 19, 23) = 0.001 * ((var_x336) ? (-var_x183 * var_x197) : (0));
        IJth(rJacobian, 23, 23) = var_x340 * (-var_x143 - var_x150 - var_x153 + 6.124934136868245e-12 * var_x151 - 0.032399999999999998 * var_x147 - 0.089999999999999997 * var_x145);
        IJth(rJacobian, 24, 23) = var_x340 * (0.48963716847178318 * var_x349 + 0.059999999999999998 * var_x145);
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x102 * (var_x154 + var_x155 + var_x156 + var_x157 + var_x159 + var_x161 - var_x160 + 26.712338705498265 * var_x149));
        IJth(rJacobian, 24, 24) = var_x340 * (var_x160 - var_x154 - var_x155 - var_x156 - var_x157 - var_x159 - var_x161 + 26.712338705498265 * var_x349);
    }
