...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellluo_rudy_1994FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_background_current__E_CaN = 0.5 * var_membrane__R * var_membrane__T * log(10) * log10(NV_Ith_S(mParameters, 0) / var_chaste_interface__ionic_concentrations__Cai) / var_membrane__F; // mV
        const double var_fast_sodium_current__E_Na = var_membrane__R * var_membrane__T * log(10) * log10(NV_Ith_S(mParameters, 2) / var_chaste_interface__ionic_concentrations__Nai) / var_membrane__F; // mV
        ...
        const double var_non_specific_calcium_activated_current__EnsCa = var_membrane__R * var_membrane__T * log(10) * log10((NV_Ith_S(mParameters, 1) + NV_Ith_S(mParameters, 2)) / (var_chaste_interface__ionic_concentrations__Ki + var_chaste_interface__ionic_concentrations__Nai)) / var_membrane__F; // mV
        ...
        const double var_time_independent_potassium_current__E_K1 = var_membrane__R * var_membrane__T * log(10) * log10(NV_Ith_S(mParameters, 1) / var_chaste_interface__ionic_concentrations__Ki) / var_membrane__F; // mV
    ...
    void Cellluo_rudy_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x6 = log(10);
        const double var_x7 = 1 / (var_chaste_interface__ionic_concentrations__Ki + var_chaste_interface__ionic_concentrations__Nai);
        const double var_x8 = var_x6 * log10(var_x7 * (NV_Ith_S(mParameters, 1) + NV_Ith_S(mParameters, 2)));
        const double var_x9 = exp(var_x5 - 1.0 * var_x8);
        const double var_x10 = 0.75 * var_x9;
        const double var_x11 = var_x10 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x12 = var_x11 + var_x4;
        const double var_x13 = 1.0 + 1.7279999999999996e-9 / pow(var_chaste_interface__ionic_concentrations__Cai, 3);
        const double var_x14 = 1 / var_x13;
        const double var_x15 = -1.0 + var_x9;
        const double var_x16 = 1 / var_x15;
        const double var_x17 = var_x14 * var_x16;
        const double var_x18 = 6.3678763853082156e-6 * var_x17;
        const double var_x19 = -0.75 * NV_Ith_S(mParameters, 2);
        const double var_x20 = var_x10 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x21 = var_x19 + var_x20;
        const double var_x22 = 1 / var_chaste_interface__ionic_concentrations__Ki;
        const double var_x23 = var_x6 * log10(var_x22 * NV_Ith_S(mParameters, 1));
        const double var_x24 = -26.614641953637257 * var_x23 + var_chaste_interface__membrane__V;
        ...
        const double var_x29 = sqrt(NV_Ith_S(mParameters, 1));
        ...
        const double var_x35 = exp(-0.024422646794659157 * var_chaste_interface__membrane__V);
        const double var_x36 = pow(NV_Ith_S(mParameters, 2), 3);
        const double var_x37 = var_x35 * var_x36;
        const double var_x38 = var_x37 * var_chaste_interface__ionic_concentrations__Cai;
        const double var_x39 = NV_Ith_S(mParameters, 0) * exp(0.013150655966354929 * var_chaste_interface__membrane__V);
        const double var_x40 = var_x39 * pow(var_chaste_interface__ionic_concentrations__Nai, 3);
        const double var_x41 = 1.0 + 0.10000000000000001 * var_x35;
        const double var_x42 = 1 / ((669921.875 + var_x36) * (1.3799999999999999 + NV_Ith_S(mParameters, 0)));
        const double var_x43 = var_x42 / var_x41;
        const double var_x44 = var_x43 * (0.024422646794659157 * var_x38 + 0.013150655966354929 * var_x40);
        const double var_x45 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3475921059424856 * var_x23);
        const double var_x46 = 1.0 + var_x45;
        const double var_x47 = 1 / var_x46;
        const double var_x48 = exp(-2.4444678999999998 + 13.687910356755641 * var_x23 - 0.51429999999999998 * var_chaste_interface__membrane__V);
        const double var_x49 = 1.0 + var_x48;
        const double var_x50 = 1 / var_x49;
        const double var_x51 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1376880417161446 * var_x23);
        const double var_x52 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6434541406371006 * var_x23);
        const double var_x53 = var_x52 + 0.49124000000000001 * var_x51;
        const double var_x54 = var_x50 * var_x53;
        const double var_x55 = var_x29 * NV_Ith_S(mParameters, 5) / (var_x54 + 1.02 * var_x47);
        const double var_x56 = var_x47 * var_x55;
        const double var_x57 = -26.614641953637257 * var_x8 + var_chaste_interface__membrane__V;
        const double var_x58 = var_x57 * var_x9;
        const double var_x59 = var_x14 * var_x58 / pow(var_x15, 2);
        const double var_x60 = 2.3926214736989759e-7 * var_x59;
        ...
        const double var_x62 = 26.614641953637257 * var_x6;
        const double var_x63 = -var_x62 * log10(var_x61 * (0.018329999999999999 * NV_Ith_S(mParameters, 2) + NV_Ith_S(mParameters, 1))) + var_chaste_interface__membrane__V;
        const double var_x64 = var_x26 * var_x27 * var_x29 * var_x63 / pow(var_x28, 2);
        const double var_x65 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x66 = pow(var_x65, 1.5);
        const double var_x67 = exp(-0.0037573302761014088 * var_chaste_interface__membrane__V);
        const double var_x68 = exp(0.01485884101040119 * NV_Ith_S(mParameters, 2));
        const double var_x69 = exp(-var_x5);
        const double var_x70 = 1.0 + 0.1245 * var_x67 + 0.036499999999999998 * var_x69 * (-0.14285714285714285 + 0.14285714285714285 * var_x68);
        const double var_x71 = NV_Ith_S(mParameters, 1) / (1.5 + NV_Ith_S(mParameters, 1));
        const double var_x72 = var_x71 * (0.00046778761937462537 * var_x67 + 0.037573302761014088 * var_x69 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x68)) / (pow(var_x70, 2) * (1.0 + 31.622776601683793 * var_x66));
        const double var_x73 = var_x35 * var_x42 * (var_x40 - var_x38) / pow(var_x41, 2);
        const double var_x74 = exp(var_x5);
        ...
        const double var_x83 = var_x4 + var_x82 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x84 = 7.0228579563684903e-6 * var_x83;
        const double var_x85 = exp(0.075146605522028176 * var_chaste_interface__membrane__V);
        const double var_x86 = -1.0 + var_x85;
        const double var_x87 = 1 / var_x86;
        const double var_x88 = var_x85 * var_chaste_interface__ionic_concentrations__Cai;
        const double var_x89 = 1.0 * var_x88 - 0.34000000000000002 * NV_Ith_S(mParameters, 0);
        const double var_x90 = var_x87 * var_x89;
        const double var_x91 = 0.078597788527232842 * var_x90;
        const double var_x92 = var_x17 * var_x58;
        const double var_x93 = 1.7944661052742319e-7 * var_x92;
        const double var_x94 = var_x19 + var_x82 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x95 = 2.4561808914760263e-5 * var_x94;
        const double var_x96 = var_x45 / pow(var_x46, 2);
        const double var_x97 = var_x24 * var_x55;
        const double var_x98 = var_x96 * var_x97;
        const double var_x99 = var_x48 * var_x53 / pow(var_x49, 2);
        const double var_x100 = 0.24326999999999999 * var_x96 - 0.51429999999999998 * var_x99 - var_x50 * (0.061749999999999999 * var_x52 + 0.039456396800000001 * var_x51);
        const double var_x101 = var_x24 * var_x29 * var_x47 * NV_Ith_S(mParameters, 5) / pow((var_x47 + 0.98039215686274506 * var_x54), 2);
        const double var_x102 = 0.42189361069797565 * var_x101;
        const double var_x103 = var_x80 * var_chaste_interface__membrane__V;
        const double var_x104 = var_x103 * var_x74 / pow(var_x75, 2);
        const double var_x105 = var_x104 * var_x94;
        const double var_x106 = var_x104 * var_x83;
        const double var_x107 = var_x103 * var_x85;
        const double var_x108 = var_x107 * var_x89 / pow(var_x86, 2);
        const double var_x109 = var_x74 * var_x81 * var_chaste_interface__membrane__V;
        const double var_x110 = var_x109 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x111 = var_x109 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x112 = var_x103 * var_x87 * var_x88;
        const double var_x113 = 0.00050000000000000001 + var_chaste_interface__ionic_concentrations__Cai;
        const double var_x114 = 1 / var_x113;
        const double var_x115 = 1 / var_chaste_interface__ionic_concentrations__Cai;
        const double var_x116 = var_chaste_interface__ionic_concentrations__Cai / pow(var_x113, 2);
        const double var_x117 = var_x37 * var_x43;
        const double var_x118 = var_x16 * var_x57 / (pow(var_x13, 2) * pow(var_chaste_interface__ionic_concentrations__Cai, 4));
        const double var_x119 = 3.301107118143778e-14 * var_x118;
        const double var_x120 = var_x107 * var_x87;
        const double var_x121 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__membrane__V;
        const double var_x122 = var_x121 * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__ionic_concentrations__Cai / pow((3.5999999999999994e-7 + var_x77), 2);
        const double var_x123 = var_x122 * var_x76;
        const double var_x124 = var_x123 * var_x83;
        const double var_x125 = var_x122 * var_x90;
        const double var_x126 = var_x123 * var_x94;
        const double var_x127 = -var_x62 * log10(var_x65 * NV_Ith_S(mParameters, 2)) + var_chaste_interface__membrane__V;
        const double var_x128 = var_x0 * var_x127;
        const double var_x129 = NV_Ith_S(mParameters, 4) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x130 = var_x129 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x131 = var_x129 * var_x32;
        const double var_x132 = var_x79 * var_chaste_interface__membrane__V;
        const double var_x133 = var_x132 * var_x76;
        const double var_x134 = var_x121 * var_x78;
        const double var_x135 = var_x134 * var_x76;
        const double var_x136 = var_x30 * var_x63 * var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        const double var_x137 = var_x10 + var_x20 * var_x7;
        const double var_x138 = var_x18 * var_x57;
        const double var_x139 = var_x31 * var_x61;
        const double var_x140 = var_x34 * var_x65;
        const double var_x141 = var_x39 * var_x43 * pow(var_chaste_interface__ionic_concentrations__Nai, 2);
        const double var_x142 = var_x17 * var_x7;
        const double var_x143 = var_x142 * var_x58;
        const double var_x144 = 4.7759072889811619e-6 * var_x143;
        const double var_x145 = var_x65 * var_x66 * var_x71 / (var_x70 * pow((0.031622776601683791 + var_x66), 2));
        const double var_x146 = 0.00016947874999999999 * var_x142;
        const double var_x147 = var_x59 * var_x7;
        const double var_x148 = 6.3678763853082156e-6 * var_x147;
        const double var_x149 = var_x12 * var_x148 + var_x148 * var_x21 - var_x12 * var_x146 - var_x146 * var_x21;
        const double var_x150 = var_x22 * var_x3;
        const double var_x151 = var_x10 + var_x11 * var_x7;
        const double var_x152 = var_x22 * var_x56;
        const double var_x153 = var_x22 * var_x96;
        const double var_x154 = 6.4745439480613349 * var_x153 - var_x50 * (1.0501178736126389 * var_x22 * var_x51 + 1.6434541406371006 * var_x22 * var_x52) - 13.687910356755641 * var_x22 * var_x99;
        const double var_x155 = var_x153 * var_x97;
        const double var_x156 = 0.00011935049112322121 * var_x90;
        const double var_x157 = 0.00092000000000000003 + var_chaste_interface__ionic_concentrations__Cai;
        const double var_x158 = 1 / var_x157;
        const double var_x159 = var_chaste_interface__ionic_concentrations__Cai / pow(var_x157, 2);
        const double var_x160 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x161 = -0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x162 = exp(-4.7130000000000001 + var_x161);
        const double var_x163 = 1.0 - var_x162;
        const double var_x164 = 0.32000000000000001 / var_x163;
        const double var_x165 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
        const double var_x166 = 47.130000000000003 + var_chaste_interface__membrane__V;
        ...
        const double var_x169 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
        const double var_x170 = exp(0.34999999999999998 * var_chaste_interface__membrane__V);
        ...
        const double var_x176 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
        const double var_x177 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x178 = -127140.0 * var_x176 - 3.4740000000000003e-5 * var_x177;
        const double var_x179 = var_x175 * var_x178;
        const double var_x180 = 37.780000000000001 + var_chaste_interface__membrane__V;
        const double var_x181 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x182 = 1.0 + var_x181;
        const double var_x183 = exp(-0.01052 * var_chaste_interface__membrane__V);
        const double var_x184 = var_x183 / var_x182;
        const double var_x185 = exp(-3.2000000000000002 + var_x161);
        ...
        const double var_x226 = 1.9339199950521953e-8 * var_x17;
        const double var_x227 = 7.2663761489674998e-10 * var_x59;
        const double var_x228 = 5.4497821117256254e-10 * var_x92;
        const double var_x229 = 7.4594056952013249e-8 * var_x94;
        const double var_x230 = 1.0025441254350579e-16 * var_x118;
        const double var_x231 = 0.0030369936192764057 * var_x127;
        const double var_x232 = var_x226 * var_x57;
        const double var_x233 = 5.1470588235294113e-7 * var_x142;
        const double var_x234 = 1.9339199950521953e-8 * var_x147;
        const double var_x235 = var_x21 * var_x234 - var_x21 * var_x233;
        const double var_x236 = 1.4504399962891466e-8 * var_x143;
        const double var_x237 = 2.1328374802575643e-8 * var_x83;
        const double var_x238 = 0.0012812882037032361 * var_x101;
        const double var_x239 = var_x12 * var_x234 - var_x12 * var_x233;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-4.426e-5 - var_x34 + 9.2286828271246209e-7 * var_x105 + 0.10468673984798647 * var_x98 + 2.6387196824222991e-7 * var_x106 + 3.7804821863291499e-5 * var_x64 + 0.0059063570093597579 * var_x108 - 20.0 * var_x44 - 0.000183 * var_x3 - 0.014999999999999999 * var_x72 - 6.9215121203434662e-7 * var_x110 - 0.048845293589318314 * var_x73 - 1.9790397618167244e-7 * var_x111 - 3.0602006688963209e-5 * var_x25 - 0.0012135347818116574 * var_x31 - 0.0059063570093597579 * var_x112 - 0.4389381125701739 * var_x56 + var_x12 * var_x60 + var_x21 * var_x60 - var_x100 * var_x102 - var_x12 * var_x18 - var_x18 * var_x21 - var_x80 * var_x91 - var_x81 * var_x84 - var_x81 * var_x95 - var_x93 * var_chaste_interface__ionic_concentrations__Ki - var_x93 * var_chaste_interface__ionic_concentrations__Nai));
        IJth(rJacobian, 1, 0) = -4.5797863778688198e-8 + 0.030369936192764058 * var_x44 + 7.4171422481221223e-5 * var_x73 + 8.9687842752970284e-6 * var_x108 - 8.9687842752970284e-6 * var_x112 - var_x156 * var_x80;
        IJth(rJacobian, 2, 0) = var_x160 * var_x164 + 0.0072727272727272727 * var_x165 * var_chaste_interface__fast_sodium_current_m_gate__m - 0.032000000000000001 * var_x160 * var_x162 * var_x166 / pow(var_x163, 2);
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) * ((var_x168) ? (-0.019852941176470591 * var_x167) : (0)) - ((var_x168) ? (0.28123999999999999 * var_x169 + 108500.0 * var_x170) : (0.693000693000693 * var_x171 / pow(var_x172, 2))) * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__fast_sodium_current_j_gate__j) * ((var_x168) ? (var_x179 + var_x175 * var_x180 * (1.5254334000000001e-6 * var_x177 - 31073.016 * var_x176) - 0.311 * var_x173 * var_x178 * var_x180 / pow(var_x174, 2)) : (0)) - ((var_x168) ? (-0.001275024 * var_x184 + 0.016701360000000002 * var_x181 * var_x183 / pow(var_x182, 2)) : (-7.6049999999999996e-8 * var_x188 + 0.029999999999999999 * var_x185 * var_x187 / pow(var_x186, 2))) * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        IJth(rJacobian, 8, 0) = -4.2821610031797325e-8 + 2.8027450860303217e-9 * var_x105 - 2.1020588145227411e-9 * var_x110 - 0.00013666471286743825 * var_x72 - 0.18221961715658433 * var_x44 - 0.0030369936192764057 * var_x34 - 0.00044502853488732734 * var_x73 + var_x21 * var_x227 - var_x21 * var_x226 - var_x228 * var_chaste_interface__ionic_concentrations__Nai - var_x229 * var_x81;
        IJth(rJacobian, 9, 0) = 9.110980857829217e-5 * var_x72 + 1.1481300277669745e-7 * var_x64 + 0.00031793296094118393 * var_x98 + 8.0137748385755867e-10 * var_x106 - 5.5576983232758224e-7 * var_x3 - 9.2938099051435146e-8 * var_x25 - 0.0013330522471328469 * var_x56 - 3.6854973891319883e-6 * var_x31 - 6.0103311289316898e-10 * var_x111 + var_x12 * var_x227 - var_x100 * var_x238 - var_x12 * var_x226 - var_x228 * var_chaste_interface__ionic_concentrations__Ki - var_x237 * var_x81;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (20.0 * var_x117 + 0.0115 * var_x116 + 5.0564577285853121e-12 * var_x124 + 5.659040773960763e-8 * var_x125 + 1.7684502418627385e-11 * var_x126 - 0.0115 * var_x114 - 0.078597788527232842 * var_x120 - 0.00040134880066084979 * var_x115 - var_x119 * var_x12 - var_x119 * var_x21));
        IJth(rJacobian, 1, 1) = 8.5932353608719255e-11 * var_x125 + 1.7462713310839333e-5 * var_x116 + 0.00040588235294117644 * var_x159 - 0.030369936192764058 * var_x117 - 0.00011935049112322121 * var_x120 - 6.0944687335561951e-7 * var_x115 - 1.7462713310839333e-5 * var_x114 - 0.00040588235294117644 * var_x158;
        IJth(rJacobian, 8, 1) = 0.18221961715658433 * var_x117 + 5.3707721005449532e-14 * var_x126 - var_x21 * var_x230;
        IJth(rJacobian, 9, 1) = 1.5356429857854459e-14 * var_x124 - var_x12 * var_x230;
        IJth(rJacobian, 11, 1) = 0.0050000000000000001 * var_x158 - 0.0050000000000000001 * var_x159;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x128 * var_x130);
        IJth(rJacobian, 2, 2) = -0.080000000000000002 * var_x165 - var_x164 * var_x166;
        IJth(rJacobian, 8, 2) = -0.0091109808578292168 * var_x127 * var_x130;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x128 * var_x33);
        IJth(rJacobian, 3, 3) = -((var_x168) ? (0.13500000000000001 * var_x167) : (0)) - ((var_x168) ? (310000.0 * var_x170 + 3.5600000000000001 * var_x169) : (7.6923076923076916 / var_x172));
        IJth(rJacobian, 8, 3) = -var_x231 * var_x33;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x128 * var_x131);
        IJth(rJacobian, 4, 4) = -((var_x168) ? (0.1212 * var_x184) : (0.29999999999999999 * var_x188)) - ((var_x168) ? (var_x179 * var_x180) : (0));
        IJth(rJacobian, 8, 4) = -var_x131 * var_x231;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-var_x132 * var_x91 - var_x133 * var_x84 - var_x133 * var_x95));
        IJth(rJacobian, 1, 5) = -var_x132 * var_x156;
        IJth(rJacobian, 5, 5) = -var_x203 - var_x197 * var_x203;
        IJth(rJacobian, 8, 5) = -var_x133 * var_x229;
        IJth(rJacobian, 9, 5) = -var_x133 * var_x237;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (-var_x134 * var_x91 - var_x135 * var_x84 - var_x135 * var_x95));
        IJth(rJacobian, 1, 6) = -var_x134 * var_x156;
        IJth(rJacobian, 6, 6) = var_x212 * var_x215 + var_x212 * var_x217;
        IJth(rJacobian, 8, 6) = -var_x135 * var_x229;
        IJth(rJacobian, 9, 6) = -var_x135 * var_x237;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0024270695636233147 * var_x0 * var_x136);
        IJth(rJacobian, 7, 7) = -var_x221 * var_x225 - var_x224 * var_x225;
        IJth(rJacobian, 9, 7) = -7.3709947782639767e-6 * var_x136;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (var_x149 - 60.0 * var_x141 - 1.8421356686070195e-5 * var_x109 - 0.000592018558817993 * var_x139 - 0.00071151247353788531 * var_x145 - 0.0003752664515462853 * var_x65 - 26.614641953637257 * var_x140 - var_x137 * var_x138 - var_x144 * var_chaste_interface__ionic_concentrations__Ki));
        IJth(rJacobian, 1, 8) = 0.091109808578292165 * var_x141;
        IJth(rJacobian, 8, 8) = var_x235 - 5.594554271400994e-8 * var_x109 - 0.54665885146975302 * var_x141 - 1.139681818874567e-6 * var_x65 - 0.080828497792522477 * var_x140 - 6.4825765265103909e-6 * var_x145 - var_x137 * var_x232;
        IJth(rJacobian, 9, 8) = var_x239 + 4.3217176843402606e-6 * var_x145 - 1.7979565856234583e-6 * var_x139 - var_x236 * var_chaste_interface__ionic_concentrations__Ki;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * (var_x149 + 2.78620009834773 * var_x155 - 11.682180705860503 * var_x152 - 0.032297793716202568 * var_x139 - 0.0048704794775156178 * var_x150 - 5.2671434672763675e-6 * var_x109 - var_x102 * var_x154 - var_x138 * var_x151 - var_x144 * var_chaste_interface__ionic_concentrations__Nai));
        IJth(rJacobian, 8, 9) = var_x235 - var_x236 * var_chaste_interface__ionic_concentrations__Nai;
        IJth(rJacobian, 9, 9) = var_x239 + 0.0084616719207093495 * var_x155 - 1.5996281101931733e-8 * var_x109 - 0.035478708262932285 * var_x152 - 9.808819343281279e-5 * var_x139 - 1.4791615096031613e-5 * var_x150 - var_x151 * var_x232 - var_x154 * var_x238;
