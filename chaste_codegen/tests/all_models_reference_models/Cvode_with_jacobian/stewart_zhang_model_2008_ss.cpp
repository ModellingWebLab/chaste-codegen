...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x12 = log(10);
        const double var_x13 = 1 / var_chaste_interface__potassium_dynamics__K_i;
        const double var_x14 = var_x12 * log10(5.4000000000000004 * var_x13);
        const double var_x15 = -26.713760659695652 * var_x14 + var_chaste_interface__membrane__V;
        const double var_x16 = var_x1 * (-8.0 + var_x15) / pow(var_x2, 2);
        const double var_x17 = exp(-0.024332029034784559 * var_chaste_interface__membrane__V);
        const double var_x18 = var_x17 * var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x19 = exp(0.013101861787960915 * var_chaste_interface__membrane__V);
        const double var_x20 = var_x19 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3);
        const double var_x21 = 1.0 + 0.10000000000000001 * var_x17;
        const double var_x22 = NV_Ith_S(mParameters, 5) / var_x21;
        const double var_x23 = var_x22 * (166917.71917862206 * var_x18 + 0.026203723575921829 * var_x20);
        const double var_x24 = var_x15 * var_x7 / pow(var_x8, 2);
        const double var_x25 = var_x15 * var_x4 / pow(var_x5, 2);
        const double var_x26 = NV_Ith_S(mParameters, 4) * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x27 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3);
        const double var_x28 = var_x27 * NV_Ith_S(mParameters, 1) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x29 = 1.0 * var_x28;
        const double var_x30 = 2.0 * var_x20 - 6860000.0 * var_x18;
        const double var_x31 = var_x17 * var_x30 * NV_Ith_S(mParameters, 5) / pow(var_x21, 2);
        const double var_x32 = 1 / (40.0 + var_chaste_interface__sodium_dynamics__Na_i);
        const double var_x33 = exp(-0.037433890822745473 * var_chaste_interface__membrane__V);
        const double var_x34 = exp(-0.0037433890822745472 * var_chaste_interface__membrane__V);
        const double var_x35 = 1.0 + 0.035299999999999998 * var_x33 + 0.1245 * var_x34;
        const double var_x36 = var_x32 * (0.001321416346042915 * var_x33 + 0.00046605194074318115 * var_x34) * var_chaste_interface__sodium_dynamics__Na_i / pow(var_x35, 2);
        const double var_x37 = exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x38 = -1.0 + var_x37;
        const double var_x39 = 1 / var_x38;
        const double var_x40 = var_x39 * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x41 = var_x37 * var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x42 = -2.0 + 0.25 * var_x41;
        const double var_x43 = 14447.286958825251 * var_x42;
        const double var_x44 = -15.0 + var_chaste_interface__membrane__V;
        const double var_x45 = var_x37 * var_x44;
        const double var_x46 = var_x42 * var_x45 * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f / pow(var_x38, 2);
        const double var_x47 = var_x40 * var_x41 * var_x44;
        const double var_x48 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x49 = 1 / var_x48;
        const double var_x50 = 1 / var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x51 = var_chaste_interface__calcium_dynamics__Ca_i / pow(var_x48, 2);
        const double var_x52 = var_x17 * var_x22;
        const double var_x53 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        const double var_x54 = var_x12 * log10(140.0 * var_x53);
        const double var_x55 = (26.713760659695648 * var_x14 - 1.0 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 4);
        const double var_x56 = 1 / (0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i);
        const double var_x57 = (-26.713760659695652 * var_x12 * log10(9.5999999999999996 * var_x56) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs;
        const double var_x58 = -26.713760659695652 * var_x54 + var_chaste_interface__membrane__V;
        const double var_x59 = var_x58 * NV_Ith_S(mParameters, 1) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x60 = var_x59 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x61 = var_x27 * var_x59;
        const double var_x62 = var_x39 * var_x44 * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x63 = var_x43 * var_x62;
        const double var_x64 = var_x39 * var_x44 * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x65 = var_x43 * var_x64;
        const double var_x66 = 2.1862541723894919 * var_x14 - 0.081839999999999996 * var_chaste_interface__membrane__V;
        const double var_x67 = var_x40 * var_x45;
        const double var_x68 = var_x53 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y;
        const double var_x69 = 1 / var_x35;
        const double var_x70 = var_x32 * var_x69;
        const double var_x71 = var_x10 * var_x56;
        const double var_x72 = var_x69 * var_chaste_interface__sodium_dynamics__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        const double var_x73 = var_x19 * var_x22 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2);
        const double var_x74 = var_x28 * var_x53 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x75 = var_x13 * var_x3;
        const double var_x76 = var_x13 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y;
        const double var_x77 = var_x13 * var_x6;
        const double var_x78 = var_x13 * var_x9;
        const double var_x79 = var_x11 * var_x13;
        const double var_x80 = var_x13 * var_x26;
        const double var_x81 = 0.001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x82 = 1.0 + 0.00020000000000000001 / pow(var_x81, 2);
        const double var_x83 = 1 / var_x82;
        const double var_x84 = 7.2352122917848019e-6 * var_x49;
        ...
        const double var_x102 = 1 / var_x101 - var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        const double var_x112 = 1 / var_x111 - var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        const double var_x136 = pow(var_x135, (-2)) - var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        const double var_x165 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 3));
        const double var_x166 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 3) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        ...
        const double var_x227 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
        const double var_x228 = 1 / (1.0 + 2.25 * var_x227);
        const double var_x229 = 1 / (2.5 - 1.5 * var_x228);
        const double var_x230 = var_x208 * var_x229;
        const double var_x231 = 1 / (0.059999999999999998 + 0.14999999999999999 * var_x230);
        const double var_x232 = var_x231 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x233 = var_x230 * var_x232;
        const double var_x234 = 0.015299999999999998 * var_x233;
        const double var_x235 = 1 / (pow((0.44444444444444442 + var_x227), 2) * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3));
        const double var_x236 = -var_chaste_interface__calcium_dynamics__Ca_ss + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x237 = var_x236 / pow((1 - 0.59999999999999998 * var_x228), 2);
        const double var_x238 = var_x208 * var_x232 * var_x235 * var_x237;
        const double var_x239 = var_x235 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x240 = var_x237 / pow((0.40000000000000002 + var_x230), 2);
        const double var_x241 = var_x229 * var_x239 * var_x240 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4);
        const double var_x242 = var_x240 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3) * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x243 = var_x229 * var_x232 * var_x236 * var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x244 = var_x230 * var_x231 * var_x236;
        const double var_x245 = 0.00025000000000000001 + var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x246 = 1.0 + 0.0001 / pow(var_x245, 2);
        const double var_x247 = 1 / var_x246;
        const double var_x248 = 253.30174843481757 * var_x42;
        const double var_x249 = var_x248 * var_x40;
        const double var_x250 = var_x247 * var_x248;
        const double var_x251 = var_x250 * var_x62;
        const double var_x252 = var_x250 * var_x64;
        const double var_x253 = 0.30611192392099484 * var_x233;
        const double var_x254 = -0.11249999999999999 + 0.067500000000000004 * var_x228;
        const double var_x255 = 0.00011688549744401942 * var_x28;
        const double var_x256 = (0.0031224512033090025 * var_x14 - 0.00011688549744401942 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 4);
        const double var_x257 = 0.00025554140647880875 * var_x14 - 9.5659091108185493e-6 * var_chaste_interface__membrane__V;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00088199999999999997 + 1081.6363254030778 * var_x46 + 0.0065000000000000006 * var_x16 - 0.065000000000000002 * var_x3 - 0.081839999999999996 * var_x11 - 0.037999999999999999 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 0.022700000000000001 * var_x6 - 0.0146 * var_x9 - 0.23519999999999999 * var_x10 - 8.666220229942447e-8 * var_x23 - 0.0024414715719063545 * var_x24 - 270.40908135076944 * var_x47 - 2.1086672225679693e-10 * var_x31 - 2.2983750000000001 * var_x36 - 0.0013352941176470589 * var_x25 - 1.0 * var_x26 - var_x29 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x40 * var_x43);
        IJth(rJacobian, 1, 0) = var_x83 * (-3.4598107243429746e-8 + 1.0129554625362472e-11 * var_x23 + 2.464726172537559e-14 * var_x31);
        IJth(rJacobian, 2, 0) = (1 / var_x90 - var_chaste_interface__hyperpolarization_activated_current_y_gate__y) * (2.7500000000000001e-5 * var_x91 - 1.0000000000000001e-5 * var_x92) - 0.14705882352941177 * var_x89 * (var_x93 + var_x94) / pow(var_x90, 2);
        ...
        IJth(rJacobian, 5, 0) = 5.1020408163265302e-7 * (1 / var_x124 - var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs) * (93.333333333333329 * var_x118 * var_x119 / pow(var_x120, 2) - 116.66666666666667 * var_x116 * var_x121 / pow(var_x117, (3 / 2))) / pow((0.057142857142857141 + var_x122), 2) + 0.071428571428571425 * var_x123 * var_x125 / pow(var_x124, 2);
        ...
        IJth(rJacobian, 13, 0) = 0.00013840830449826991 * (1 / var_x217 - var_chaste_interface__transient_outward_current_s_gate__s) * (-var_x218 * (-0.15625 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + 1.0 * var_x212 / pow(var_x213, 2)) / pow((0.49411764705882355 + var_x215 + 0.058823529411764705 * var_x214), 2) - 0.076923076923076927 * var_x216 * var_x219 / pow(var_x217, 2);
        IJth(rJacobian, 14, 0) = 0.076923076923076927 * var_x220 * var_x223 / pow(var_x221, 2) - 0.09569377990430622 * var_x222 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (1 / var_x221 - var_chaste_interface__transient_outward_current_r_gate__r) / pow((0.69856459330143539 + var_x222), 2);
        IJth(rJacobian, 16, 0) = var_x247 * (-var_x249 + 18.964139992238998 * var_x46 - 4.7410349980597495 * var_x47);
        IJth(rJacobian, 18, 0) = -3.389679425876563e-8 - 1.7024840244711204e-6 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 3.0388663876087416e-11 * var_x23 - 7.3941785176126764e-14 * var_x31 - 0.00080594011556369446 * var_x36 - var_x255 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 19, 0) = 7.5975573338612627e-7 * var_x16 + 0.00053729341037579627 * var_x36 - 2.6533007919792409e-6 * var_x6 - 1.5607651717524947e-7 * var_x25 - 2.8537261917770623e-7 * var_x24 - 2.7491468998833366e-5 * var_x10 - 9.5659091108185493e-6 * var_x11 - 2.7391648784016175e-6 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 1.7065282626826835e-6 * var_x9 - 0.00011688549744401942 * var_x26 - 7.5975573338612623e-6 * var_x3;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.12379999999999999 * var_x51 + 0.59450270777405179 * var_x52 - 0.12379999999999999 * var_x49 - 0.0079072731552699126 * var_x50);
        IJth(rJacobian, 1, 1) = var_x83 * (-0.0038240087783467445 - var_x84 + 7.2352122917848019e-6 * var_x51 - 6.9488744729986565e-5 * var_x52 - 5.3144431236283834e-11 * var_x86 - 4.6212277808973232e-7 * var_x50) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027063 * var_x87 - var_x84 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-11 * var_x22 * var_x30 + 4.6212277808973232e-7 * var_x12 * log10(2.0 * var_x50)) / (pow(var_x81, 3) * pow(var_x82, 2));
        IJth(rJacobian, 15, 1) = var_x226 * (0.00036000000000000002 + 7.96875e-10 * var_x86);
        IJth(rJacobian, 16, 1) = 1.1399999999999999 * var_x247;
        IJth(rJacobian, 18, 1) = 0.00020846623418995967 * var_x52;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (0.38909660951273101 * var_x54 + 0.62602629555570366 * var_x14 - 0.037999999999999999 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 2, 2) = -var_x93 - var_x94;
        IJth(rJacobian, 18, 2) = 4.5479750756676942e-5 * var_x54 - 1.7024840244711204e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 19, 2) = 7.3173394969065143e-5 * var_x14 - 2.7391648784016175e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (var_x55 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2);
        ...
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x55 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1);
        ...
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-0.47039999999999998 * var_x57);
        IJth(rJacobian, 5, 5) = -var_x125;
        IJth(rJacobian, 19, 5) = -5.4982937997666732e-5 * var_x57;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x60);
        IJth(rJacobian, 6, 6) = -var_x139;
        IJth(rJacobian, 18, 6) = -0.00035065649233205829 * var_x60;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x29 * var_x58);
        IJth(rJacobian, 7, 7) = -var_x151 - var_x152;
        IJth(rJacobian, 18, 7) = -var_x255 * var_x58;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-1.0 * var_x61);
        IJth(rJacobian, 8, 8) = -var_x170 - var_x171;
        IJth(rJacobian, 18, 8) = -0.00011688549744401942 * var_x61;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x63 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 9, 9) = -var_x186;
        IJth(rJacobian, 16, 9) = -var_x251 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x63 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 10, 10) = -var_x199;
        IJth(rJacobian, 16, 10) = -var_x251 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass);
        IJth(rJacobian, 11, 11) = -var_x207;
        IJth(rJacobian, 16, 11) = -var_x252 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 12, 12) = -var_x210;
        IJth(rJacobian, 16, 12) = -var_x252 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x66 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 13, 13) = -var_x219;
        IJth(rJacobian, 19, 13) = var_x257 * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x66 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 14, 14) = -var_x223;
        IJth(rJacobian, 19, 14) = var_x257 * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 15) = 2.40087783467447e-5 * var_x83;
        IJth(rJacobian, 15, 15) = var_x226 * (-0.00036000000000000002 - var_x234 + 0.021759999999999998 * var_x241 - 0.0032639999999999995 * var_x238) + 0.66666666666666674 * (0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0.0063749999999999996 * var_x87 - 0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x234 * var_x236) / (pow(var_x224, 3) * pow((0.33333333333333337 + var_x225), 2));
        IJth(rJacobian, 16, 15) = var_x247 * (var_x253 + 0.065303877103145572 * var_x238 - 0.43535918068763713 * var_x241);
        IJth(rJacobian, 17, 15) = 0.059999999999999998 * var_x239 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-3611.8217397063127 * var_x67);
        IJth(rJacobian, 1, 16) = 0.0038 * var_x83;
        ...
        IJth(rJacobian, 15, 16) = var_x226 * (var_x234 + 0.032639999999999995 * var_x242 - 0.030599999999999995 * var_x243);
        IJth(rJacobian, 16, 16) = var_x247 * (-1.1399999999999999 - var_x253 + 0.61222384784198969 * var_x243 - 0.65303877103145569 * var_x242 - 63.325437108704392 * var_x67) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x236 * var_x253 - var_x249 * var_x44) / (pow(var_x245, 3) * pow(var_x246, 2));
        IJth(rJacobian, 17, 16) = var_x254 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 15, 17) = -0.015299999999999998 * var_x226 * var_x244;
        IJth(rJacobian, 16, 17) = 0.30611192392099484 * var_x244 * var_x247;
        IJth(rJacobian, 17, 17) = -0.0050000000000000001 + var_x254 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (0.001436484375 * var_x72 - 26.713760659695652 * var_x74 - 0.38909660951273101 * var_x68 - 5.1997321379654684e-7 * var_x73 - 2.2983750000000001 * var_x70 - 0.18849229521481251 * var_x71 - 0.0077469905913117388 * var_x53);
        IJth(rJacobian, 1, 18) = 6.0777327752174832e-11 * var_x73 * var_x83;
        IJth(rJacobian, 18, 18) = 5.0371257222730904e-7 * var_x72 - 4.5479750756676942e-5 * var_x68 - 1.823319832565245e-10 * var_x73 - 9.0551084895961074e-7 * var_x53 - 0.0031224512033090025 * var_x74 - 0.00080594011556369446 * var_x70;
        IJth(rJacobian, 19, 18) = 0.00053729341037579627 * var_x70 - 3.3580838148487267e-7 * var_x72 - 2.2032015690548319e-5 * var_x71;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-2.1862541723894919 * var_x79 - 1.7363944428802174 * var_x75 - 0.62602629555570366 * var_x76 - 0.60640236697509131 * var_x77 - 0.3900209056315565 * var_x78 - 6.2830765071604162 * var_x71 - 26.713760659695648 * var_x80);
        IJth(rJacobian, 19, 19) = -7.3173394969065143e-5 * var_x76 - 0.0007344005230182773 * var_x71 - 0.0031224512033090025 * var_x80 - 0.00025554140647880875 * var_x79 - 7.0879642315114355e-5 * var_x77 - 4.5587787568311439e-5 * var_x78 - 0.00020295932821508516 * var_x75;
    }
