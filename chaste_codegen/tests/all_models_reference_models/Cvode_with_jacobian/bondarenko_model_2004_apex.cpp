...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellbondarenko_model_2004_apexFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x49 = var_x1 * log10(140600.0 * var_x43);
        ...
        const double var_x56 = var_x18 * pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 2) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x57 = var_x18 * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        const double var_x58 = 4.1078913989637309 * var_x3 - 0.16 * var_chaste_interface__membrane__V;
        const double var_x59 = 1.2837160621761659 * var_x3 - 0.050000000000000003 * var_chaste_interface__membrane__V;
        const double var_x60 = var_x1 * log10(8257.1428571428569 * var_x45);
        ...
        const double var_x246 = 0.025019562392723654 * var_x9;
        const double var_x247 = 0.25271120029236765 * var_x3 - 0.0098429554532475649 * var_chaste_interface__membrane__V;
        const double var_x248 = 0.078972250091364882 * var_x3 - 0.003075923579139864 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 18, 0) = -0.00015994802611527293 - 0.12710251172237072 * var_x34 - 4.9775675863698838e-18 * var_x17 - 0.79974013057636462 * var_chaste_interface__fast_sodium_current__O_Na - 1.2601770073888912e-20 * var_x27;
        ...
        IJth(rJacobian, 27, 0) = 0.084735007814913818 * var_x34 + 0.0015588209597120041 * var_x19 - 0.0047984407834581883 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K - 0.017397555353928618 * var_x6 - 0.00035373121160108434 * var_x0 - 0.0098429554532475649 * var_x8 - 0.003075923579139864 * var_x7 - var_x246 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        ...
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (2.0 * var_x39 + 0.074007286514025064 * var_x40 - 2.0 * var_x42 - 0.0047112379481865285 * var_x36 - var_x22 * var_x25 * var_x35 + 0.02 * var_x23 * var_x35 / pow((1 + 0.10000000000000001 * var_chaste_interface__calcium_concentration__Cai), 2));
        ...
        IJth(rJacobian, 4, 1) = 0.0002143069590085796 + 11.084842707340323 * var_x42 - 11.084842707340323 * var_x39;
        IJth(rJacobian, 6, 1) = 2.2890000000000001 - var_x64;
        IJth(rJacobian, 7, 1) = 0.33180000000000004 - var_x65;
        IJth(rJacobian, 18, 1) = 0.013658445456998961 * var_x40;
        ...
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-3.3946082173859908e-7 * var_x48 - 1.4564116150719218e-13 * var_x47 - 333.76617616580313 * var_x44 - 0.066753235233160624 * var_x43 - 0.040869327693771808 * var_x46);
        IJth(rJacobian, 1, 18) = 8.9596216554657907e-15 * var_x47 * var_x63;
        IJth(rJacobian, 18, 18) = -6.2649332746797061e-8 * var_x48 - 0.0041065570047509742 * var_x43 - 20.532785023754869 * var_x44 - 2.6878864966397372e-14 * var_x47;
        IJth(rJacobian, 27, 18) = 4.1766221831198043e-8 * var_x48 - 0.0025142185743373311 * var_x46;
        ...
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (0.65056346575383339 * var_x55 - 4.1078913989637309 * var_x52 - 0.14762734715025908 * var_x50 - 7.2607529660026051 * var_x51 - 37.085130685089233 * var_x44 - 2.0025970569948188 * var_x46 - 1.2837160621761659 * var_x53 - 10.441746449740933 * var_x54 - 0.007417026137017846 * var_x43);
        IJth(rJacobian, 18, 27) = -0.00045628411163899709 * var_x43 - 2.2814205581949856 * var_x44;
        IJth(rJacobian, 27, 27) = 0.040021670080783313 * var_x55 - 0.0090818087605069615 * var_x50 - 0.078972250091364882 * var_x53 - 0.642360282243162 * var_x54 - 0.12319671014252923 * var_x46 - 0.25271120029236765 * var_x52 - 0.44667042500874232 * var_x51;
        ...
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x10 * var_x18);
        IJth(rJacobian, 27, 29) = -var_x18 * var_x246;
