...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x53 = var_x52 * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f;
        ...
        const double var_x59 = var_x55 * var_x58 * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f / pow(var_x51, 2);
        ...
        const double var_x66 = (26.713760659695648 * var_x13 - 1.0 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2);
        ...
        const double var_x68 = 26.713760659695652 * var_x11;
        const double var_x69 = (-var_x68 * log10(9.5999999999999996 * var_x67) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs;
        const double var_x70 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        const double var_x71 = -var_x68 * log10(140.0 * var_x70) + var_chaste_interface__membrane__V;
        const double var_x72 = var_x71 * NV_Ith_S(mParameters, 1) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x73 = var_x72 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x74 = var_x36 * var_x71;
        const double var_x75 = var_x35 * var_x72;
        const double var_x76 = var_x52 * var_x57 * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x77 = var_x56 * var_x76;
        const double var_x78 = var_x52 * var_x57 * NV_Ith_S(mParameters, 0) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x79 = var_x56 * var_x78;
        const double var_x80 = var_x29 - var_chaste_interface__membrane__V;
        const double var_x81 = NV_Ith_S(mParameters, 3) * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        const double var_x107 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x108 = exp(-3.7142857142857144 - var_x107);
        const double var_x109 = 1.0 + var_x108;
        const double var_x110 = 1 / var_x109 - var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        const double var_x118 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x119 = 1.0 + var_x118;
        const double var_x120 = 1 / var_x119 - var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        const double var_x132 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        ...
        const double var_x143 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x144 = 1.0 + var_x143;
        const double var_x145 = pow(var_x144, (-2)) - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x146 = exp(-12.0 - var_x135);
        const double var_x147 = 1.0 + var_x146;
        const double var_x148 = var_x142 * var_x147;
        const double var_x149 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V);
        const double var_x150 = 1.0 + var_x149;
        const double var_x151 = pow(var_x150, (-2));
        ...
        const double var_x160 = 0.26917900403768508 * var_x149 / pow(var_x150, 3);
        ...
        const double var_x200 = exp(2.8571428571428572 + var_x107);
        ...
        const double var_x209 = exp(5.0 + var_x107);
        ...
        const double var_x256 = var_x255 * var_x76;
        const double var_x257 = var_x255 * var_x78;
        ...
        const double var_x261 = (0.0031224512033090025 * var_x13 - 0.00011688549744401942 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2);
        const double var_x262 = 0.0031224512033090025 * var_x13 - 0.00011688549744401942 * var_chaste_interface__membrane__V;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00088199999999999997 - var_x28 - var_x37 + 1081.6363254030778 * var_x59 + 0.03243 * var_x40 - 0.39200000000000002 * var_x0 - 0.0146 * var_x3 - 0.0024414715719063545 * var_x31 - 270.40908135076944 * var_x60 - 8.6662202299424464e-5 * var_x10 - 0.54050000000000009 * var_x26 - 2.2983750000000001 * var_x49 - 2.1086672225679691e-7 * var_x33 - 1.0 * var_x34 - var_x42 * var_x44 - var_x53 * var_x56);
        IJth(rJacobian, 1, 0) = var_x98 * (-3.4598107243429746e-8 + 2.464726172537559e-11 * var_x33 + 1.0129554625362472e-8 * var_x10);
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x106 * var_x110 * var_x111 + 0.14285714285714285 * var_x108 * var_x113 / pow(var_x109, 2) - 0.10000000000000001 * var_x105 * var_x110 * var_x112;
        IJth(rJacobian, 3, 0) = 0.01488095238095238 * var_x117 * var_x120 * var_x121 - 0.041666666666666664 * var_x118 * var_x123 / pow(var_x119, 2) - 0.050000000000000003 * var_x116 * var_x120 * var_x122;
        IJth(rJacobian, 4, 0) = 5.1020408163265302e-7 * (1 / var_x133 - var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs) * (93.333333333333329 * var_x127 * var_x128 / pow(var_x129, 2) - 116.66666666666667 * var_x125 * var_x130 / pow(var_x126, (3 / 2))) / pow((0.057142857142857141 + var_x131), 2) + 0.071428571428571425 * var_x132 * var_x134 / pow(var_x133, 2);
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x143 * var_x148 / pow(var_x144, 3) - 0.20000000000000001 * var_x142 * var_x145 * var_x146 + 99.999999999999986 * var_x145 * var_x147 * (0.02 * var_x136 / pow(var_x137, 2) + 0.00050000000000000001 * var_x139 / pow(var_x140, 2)) / pow((var_x138 + var_x141), 2);
        IJth(rJacobian, 6, 0) = (var_x151 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x153) ? (-0.008382352941176471 * var_x152) : (0)) + ((var_x153) ? (108035.0 * var_x154 + 0.21330000000000002 * var_x155) : (0.53361053361053368 * var_x156 / pow(var_x157, 2)))) - var_x160 * (var_x158 + var_x159);
        IJth(rJacobian, 7, 0) = (var_x151 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x153) ? (-0.00025500480000000003 * var_x164 + 0.0033402720000000005 * var_x161 * var_x163 / pow(var_x162, 2)) : (0.034200000000000001 * var_x168 + 0.059999999999999998 * var_x165 * var_x167 / pow(var_x166, 2))) + ((var_x153) ? (var_x175 + var_x171 * var_x176 * (3.0508668000000001e-7 * var_x173 - 6214.6032000000005 * var_x172) - 0.311 * var_x169 * var_x174 * var_x176 / pow(var_x170, 2)) : (0))) - var_x160 * (var_x177 + var_x178);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (1 / var_x190 - var_chaste_interface__L_type_Ca_current_d_gate__d) * (-0.050000000000000003 * var_x179 / pow(var_x180, 2) + 0.27999999999999997 * var_x182 * var_x187 / pow(var_x183, 2) - 0.15076923076923074 * var_x184 * var_x185 / pow(var_x186, 2)) / pow((var_x188 + 0.7142857142857143 * var_x181), 2) + 0.13333333333333333 * var_x189 * var_x191 / pow(var_x190, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (1 / var_x201 - var_chaste_interface__L_type_Ca_current_f_gate__f) * (18.0 * var_x202 - var_x203 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x195 / pow(var_x196, 2)) / pow((0.018140589569160998 + var_x199 + 0.16326530612244897 * var_x194 + 0.18140589569160998 * var_x197), 2) - 0.14285714285714285 * var_x200 * var_x204 / pow(var_x201, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x210) * (8.0 * var_x202 - var_x211 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x205 / pow(var_x206, 2)) / pow((var_x208 + 0.055160142348754451 * var_x207 + 0.14234875444839859 * var_x194), 2) - 0.095714285714285724 * var_x209 * var_x212 / pow(var_x210, 2);
        ...
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x225 * var_x228 / pow(var_x226, 2) - 0.10526315789473684 * var_x227 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (1 / var_x226 - var_chaste_interface__transient_outward_current_r_gate__r) / pow((0.084210526315789472 + var_x227), 2);
        IJth(rJacobian, 15, 0) = var_x252 * (-var_x254 + 18.964139992238998 * var_x59 - 4.7410349980597495 * var_x60);
        IJth(rJacobian, 17, 0) = -3.389679425876563e-8 - 3.0388663876087418e-8 * var_x10 - 0.00011688549744401942 * var_x37 - 7.3941785176126768e-11 * var_x33 - 0.00080594011556369446 * var_x49;
        IJth(rJacobian, 18, 0) = 0.00053729341037579627 * var_x49 + 3.79059668210955e-6 * var_x40 - 2.8537261917770623e-7 * var_x31 - 0.00011688549744401942 * var_x28 - 6.3176611368492499e-5 * var_x26 - 4.5819114998055616e-5 * var_x0 - 1.7065282626826835e-6 * var_x3 - 0.00011688549744401942 * var_x34 - var_x260 * var_x42;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.12379999999999999 * var_x64 + 594.50270777405183 * var_x65 - 0.12379999999999999 * var_x62 - 0.0079072731552699126 * var_x63);
        IJth(rJacobian, 1, 1) = var_x98 * (-0.0038240087783467445 - var_x99 + 7.2352122917848019e-6 * var_x64 - 0.069488744729986562 * var_x65 - 5.3144431236283834e-11 * var_x101 - 4.6212277808973232e-7 * var_x63) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027063 * var_x102 - var_x99 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x32 * var_x6 + 4.6212277808973232e-7 * var_x11 * log10(2.0 * var_x63)) / (pow(var_x96, 3) * pow(var_x97, 2));
        IJth(rJacobian, 14, 1) = var_x231 * (0.00036000000000000002 + 7.96875e-10 * var_x101);
        IJth(rJacobian, 15, 1) = 1.1399999999999999 * var_x252;
        IJth(rJacobian, 17, 1) = 0.20846623418995969 * var_x65;
        ...
        IJth(rJacobian, 2, 2) = -var_x113;
        IJth(rJacobian, 18, 2) = var_x261 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        IJth(rJacobian, 3, 3) = -var_x123;
        IJth(rJacobian, 18, 3) = var_x261 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.78400000000000003 * var_x69);
        IJth(rJacobian, 4, 4) = -var_x134;
        IJth(rJacobian, 18, 4) = -9.1638229996111233e-5 * var_x69;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x73);
        IJth(rJacobian, 5, 5) = -var_x148;
        IJth(rJacobian, 17, 5) = -0.00035065649233205829 * var_x73;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x74);
        IJth(rJacobian, 6, 6) = -var_x158 - var_x159;
        IJth(rJacobian, 17, 6) = -0.00011688549744401942 * var_x74;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x75);
        IJth(rJacobian, 7, 7) = -var_x177 - var_x178;
        IJth(rJacobian, 17, 7) = -0.00011688549744401942 * var_x75;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x77 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 8, 8) = -var_x191;
        IJth(rJacobian, 15, 8) = -var_x256 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x77 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 9, 9) = -var_x204;
        IJth(rJacobian, 15, 9) = -var_x256 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x79 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass);
        IJth(rJacobian, 10, 10) = -var_x212;
        IJth(rJacobian, 15, 10) = -var_x257 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x79 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 11, 11) = -var_x215;
        IJth(rJacobian, 15, 11) = -var_x257 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x27 * var_x80);
        IJth(rJacobian, 12, 12) = -var_x224;
        IJth(rJacobian, 18, 12) = var_x262 * var_x27;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x80 * var_x81);
        IJth(rJacobian, 13, 13) = -var_x228;
        IJth(rJacobian, 18, 13) = var_x262 * var_x81;
        IJth(rJacobian, 1, 14) = 2.40087783467447e-5 * var_x98;
        ...
        IJth(rJacobian, 15, 14) = var_x252 * (var_x258 + 0.065303877103145572 * var_x243 - 0.43535918068763713 * var_x246);
        IJth(rJacobian, 16, 14) = 0.059999999999999998 * var_x244 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-3611.8217397063127 * var_x82);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x98;
        IJth(rJacobian, 11, 15) = -0.0030000000000000001 * var_x215 * var_x216 + 6.2500000000000001e-5 * var_x216 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x214) / pow((0.025000000000000001 + var_x214), 2);
        IJth(rJacobian, 14, 15) = var_x231 * (var_x239 + 0.032639999999999995 * var_x247 - 0.030599999999999995 * var_x248);
        IJth(rJacobian, 15, 15) = var_x252 * (-1.1399999999999999 - var_x258 + 0.61222384784198969 * var_x248 - 0.65303877103145569 * var_x247 - 63.325437108704392 * var_x82) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x241 * var_x258 - var_x254 * var_x57) / (pow(var_x250, 3) * pow(var_x251, 2));
        IJth(rJacobian, 16, 15) = var_x259 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -0.015299999999999998 * var_x231 * var_x249;
        IJth(rJacobian, 15, 16) = 0.30611192392099484 * var_x249 * var_x252;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x259 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (0.001436484375 * var_x86 - 26.713760659695652 * var_x88 - 0.00051997321379654684 * var_x87 - 0.31415382535802083 * var_x83 - 2.2983750000000001 * var_x85 - 0.0077469905913117388 * var_x70);
        IJth(rJacobian, 1, 17) = 6.0777327752174836e-8 * var_x87 * var_x98;
        IJth(rJacobian, 17, 17) = 5.0371257222730904e-7 * var_x86 - 9.0551084895961074e-7 * var_x70 - 1.823319832565245e-7 * var_x87 - 0.0031224512033090025 * var_x88 - 0.00080594011556369446 * var_x85;
        IJth(rJacobian, 18, 17) = 0.00053729341037579627 * var_x85 - 3.6720026150913867e-5 * var_x83 - 3.3580838148487267e-7 * var_x86;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (0.86632725819392997 * var_x95 - 26.713760659695652 * var_x91 - 14.4387876365655 * var_x90 - 10.471794178600694 * var_x83 - 0.3900209056315565 * var_x89 - 26.713760659695648 * var_x94 - var_x44 * var_x93);
        IJth(rJacobian, 18, 18) = 0.00010126109252331096 * var_x95 - 0.001224000871697129 * var_x83 - 0.0031224512033090025 * var_x94 - 0.0016876848753885161 * var_x90 - 4.5587787568311439e-5 * var_x89 - 0.0031224512033090025 * var_x91 - var_x260 * var_x93;
    }
