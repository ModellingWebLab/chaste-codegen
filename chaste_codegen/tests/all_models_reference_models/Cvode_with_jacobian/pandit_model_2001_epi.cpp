...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpandit_model_2001_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x44 = 1 / NV_Ith_S(mParameters, 0);
        const double var_x45 = 0.001 * var_x44;
        const double var_x46 = var_x8 * log10(140.0 * var_x35);
        const double var_x47 = -25.420807984495319 * var_x46 + var_chaste_interface__membrane__V;
        const double var_x48 = var_x44 * var_x47;
        const double var_x49 = pow(var_chaste_interface__sodium_current_m_gate__m, 2) * var_chaste_interface__sodium_current_h_gate__h * var_chaste_interface__sodium_current_j_gate__j;
        const double var_x50 = 0.00080000000000000004 * var_x48;
        const double var_x51 = var_x23 * var_chaste_interface__sodium_current_h_gate__h;
        const double var_x52 = var_x4 + var_x6;
        const double var_x53 = var_x45 * (2.0150000000000001 - 0.031 * var_chaste_interface__membrane__V);
        const double var_x54 = var_x53 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x55 = 0.10000000000000001 * var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11 - 0.10000000000000001 * var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12;
        const double var_x56 = 0.001 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x57 = var_x44 * var_x56;
        const double var_x58 = 0.17794565589146724 * var_x10 - 0.0070000000000000001 * var_chaste_interface__membrane__V;
        const double var_x59 = 0.001 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss;
        ...
        const double var_x79 = exp(-6.9230769230769234 - 0.15384615384615385 * var_chaste_interface__membrane__V);
        ...
        const double var_x85 = 235.29411764705881 * var_x84;
        ...
        const double var_x97 = 0.00016474464579901152 * var_x88 / pow(var_x89, 2);
        ...
        const double var_x130 = exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__membrane__V);
        const double var_x131 = 1.0 + var_x130;
        const double var_x132 = 1 / var_x131;
        const double var_x133 = 0.00059999999999999995 * var_x126 / pow(var_x127, 2);
        ...
        const double var_x137 = 0.00018518518518518518 * var_x130 / pow(var_x131, 2);
        ...
        const double var_x144 = exp(-0.92819614711033271 - 0.087565674255691769 * var_chaste_interface__membrane__V);
        ...
        const double var_x151 = exp(6.5803808776746413 + 0.14526227103034528 * var_chaste_interface__membrane__V);
        const double var_x152 = 1.0 + var_x151;
        const double var_x153 = 0.00014526227103034528 * var_x151 / pow(var_x152, 2);
        ...
        const double var_x170 = 0.00088581970078959317 * var_x47;
        ...
        const double var_x189 = 0.00019703470957323427 * var_x10 - 7.7509223819089404e-6 * var_chaste_interface__membrane__V;
        ...
        const double var_x195 = 870.15176483187713 - 13.386950228182727 * var_chaste_interface__membrane__V;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x45 * (-0.00025054999999999999 + var_x1 + 0.0015228469537086019 * var_x43 - 0.0014499999999999999 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.024 * var_x13 - 0.80000000000000004 * var_x25 - 9.9839999999999996e-6 * var_x21 - 0.0070000000000000001 * var_x22 - 0.0048000000000000004 * var_x33 - 5.8823529411764709e-6 * var_x34 - 0.062608695652173918 * var_x41 + (-0.031 * var_x4 - 0.031 * var_x6) * var_chaste_interface__L_type_Ca_channel_d_gate__d));
        IJth(rJacobian, 1, 0) = (0.001 / var_x80 - 0.001 * var_chaste_interface__sodium_current_m_gate__m) * (var_x85 - 5.3475935828877006 * var_x86 - 23.529411764705884 * var_x82 * var_x87 / pow(var_x83, 2)) + 0.00015384615384615385 * var_x79 * (58.823529411764703 * var_x86 + var_x85 * var_x87) / pow(var_x80, 2);
        IJth(rJacobian, 2, 0) = (var_x90 - 0.001 * var_chaste_interface__sodium_current_h_gate__h) * ((var_x92) ? (198.5675338110868 * var_x91 / pow((1 + var_x91), 2)) : (80.584527220630378 * var_x93 + 31088825.214899711 * var_x94 - 5.6885218270689366 * var_x95)) - var_x96 * var_x97;
        IJth(rJacobian, 3, 0) = (var_x90 - 0.001 * var_chaste_interface__sodium_current_j_gate__j) * ((var_x92) ? (-2.1797076526225279e-5 * var_x101 + 8.5984522785898552 * var_x100 * var_x98 / pow(var_x99, 2)) : (var_x108 - 0.36533638968481374 * var_x112 + var_x107 * var_x113 * (1.5254334000000001e-6 * var_x103 - 31073.016 * var_x102) + 4.7854899713467054 * var_x109 * var_x111 / pow(var_x110, 2) - 89.11174785100286 * var_x104 * var_x105 * var_x113 / pow(var_x106, 2))) - var_x114 * var_x97;
        IJth(rJacobian, 4, 0) = 107.49798441279225 * (1 / var_x119 - var_chaste_interface__L_type_Ca_channel_d_gate__d) * (-var_x120 * (0.072000000000000008 - 0.0040000000000000001 * var_chaste_interface__membrane__V) - var_x121 * (-0.063 - 0.0089999999999999993 * var_chaste_interface__membrane__V)) / pow((0.081967213114754092 + var_x116 + 0.34426229508196715 * var_x115), 2) + 0.00020000000000000001 * var_x118 * var_x122 / pow(var_x119, 2);
        IJth(rJacobian, 5, 0) = -var_x136 * var_x137 + 0.090702947845805001 * (var_x132 - var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11) * (var_x133 - var_x134 * (-0.625 - 0.013888888888888888 * var_chaste_interface__membrane__V) - 0.0016000000000000001 * var_x123 / pow(var_x124, 2)) / pow((0.016190476190476189 + var_x129 + 0.38095238095238099 * var_x125 + 0.14285714285714285 * var_x128), 2);
        IJth(rJacobian, 6, 0) = -var_x137 * var_x143 + 0.15625 * (var_x132 - var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12) * (var_x133 - var_x142 * (-0.65277777777777779 - 0.013888888888888888 * var_chaste_interface__membrane__V) - 0.016 * var_x138 / pow(var_x139, 2)) / pow((0.021249999999999998 + var_x140 + 0.51249999999999996 * var_x141 + 0.1875 * var_x128), 2);
        IJth(rJacobian, 8, 0) = (-var_x56 + 0.001 / var_x145) * (1.6153732000000001 * var_x146 - 9.8900000000000006 * var_x147) + 8.7565674255691772e-5 * var_x144 * (45.159999999999997 * var_x146 + 98.900000000000006 * var_x147) / pow(var_x145, 2);
        IJth(rJacobian, 9, 0) = -var_x150 * var_x153 - 0.0028571428571428571 * var_x149 * (-0.62222222222222223 - 0.0088888888888888889 * var_chaste_interface__membrane__V) * (var_x154 - var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s) / pow((0.10000000000000002 + var_x149), 2);
        IJth(rJacobian, 10, 0) = -var_x153 * var_x156 - 0.00027027027027027027 * var_x155 * (-0.15555555555555556 - 0.0022222222222222222 * var_chaste_interface__membrane__V) * (var_x154 - var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow) / pow((0.00945945945945946 + var_x155), 2);
        IJth(rJacobian, 11, 0) = (-var_x59 + 0.001 / var_x158) * (0.16153732000000001 * var_x146 - 0.9890000000000001 * var_x147) + 8.4602368866328257e-5 * var_x157 * (9.8900000000000006 * var_x147 + 4.516 * var_x146) / pow(var_x158, 2);
        ...
        IJth(rJacobian, 20, 0) = -8.8748061272857348e-8 - 3.3165089597562367e-8 * var_x21 - 3.2110964153622751e-7 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.00020797506018538275 * var_x41 - 0.00088581970078959317 * var_x25;
        IJth(rJacobian, 21, 0) = var_x175 * (-1.7937848940989261e-5 + 1.1055029865854122e-5 * var_x21);
        IJth(rJacobian, 22, 0) = -1.528038983862048e-7 + var_x188 + 0.00013865004012358849 * var_x41 + 1.6862097911031213e-6 * var_x43 - 5.3149182047375591e-6 * var_x33 - 2.6574591023687795e-5 * var_x13 - 6.5133801528646552e-9 * var_x34 - 7.7509223819089404e-6 * var_x22 - 1.2844385661449098e-6 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        IJth(rJacobian, 23, 0) = var_x194 * (-13.386950228182727 * var_x4 - 13.386950228182727 * var_x6);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0024000000000000002 * var_x48 * var_x49);
        IJth(rJacobian, 1, 1) = -0.058823529411764705 * var_x86 - 0.23529411764705882 * var_x84 * var_x87;
        IJth(rJacobian, 20, 1) = -0.0026574591023687793 * var_x47 * var_x49;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x24 * var_x50);
        IJth(rJacobian, 2, 2) = -0.001 * var_x96;
        IJth(rJacobian, 20, 2) = -var_x170 * var_x24;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x50 * var_x51);
        IJth(rJacobian, 3, 3) = -0.001 * var_x114;
        IJth(rJacobian, 20, 3) = -var_x170 * var_x51;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x52 * var_x53);
        IJth(rJacobian, 4, 4) = -0.001 * var_x122;
        IJth(rJacobian, 23, 4) = var_x193 * var_x195 * var_x52;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x5 * var_x54);
        IJth(rJacobian, 5, 5) = -0.001 * var_x136;
        IJth(rJacobian, 23, 5) = var_x196 * var_x5;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x3 * var_x54);
        IJth(rJacobian, 6, 6) = -0.001 * var_x143;
        IJth(rJacobian, 23, 6) = var_x196 * var_x3;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x54 * var_x55);
        IJth(rJacobian, 7, 7) = -0.11111111111111112;
        IJth(rJacobian, 23, 7) = var_x196 * var_x55;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * var_x42 * var_x45);
        IJth(rJacobian, 8, 8) = -0.045159999999999999 * var_x146 - 0.098900000000000002 * var_x147;
        IJth(rJacobian, 22, 8) = var_x187 * var_x42;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x57 * (0.7882992555992 * var_x10 - 0.031010000000000003 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 9, 9) = -0.001 * var_x150;
        IJth(rJacobian, 22, 9) = (0.00087286376340942788 * var_x10 - 3.4336586151856603e-5 * var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x57 * (0.10142902385813635 * var_x10 - 0.0039900000000000005 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 10, 10) = -0.001 * var_x156;
        IJth(rJacobian, 22, 10) = (0.00011230978445674354 * var_x10 - 4.4180257576880957e-6 * var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x45 * var_x58 * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss);
        IJth(rJacobian, 11, 11) = -0.0098900000000000012 * var_x147 - 0.004516 * var_x146;
        IJth(rJacobian, 22, 11) = var_x189 * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x44 * var_x58 * var_x59);
        ...
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x45 * (0.0073720343155036427 * var_x46 + 0.029488137262014571 * var_x10 - 0.0014499999999999999 * var_chaste_interface__membrane__V));
        IJth(rJacobian, 13, 13) = -0.00056230000000000006 * var_x163 - 0.00011885 * var_x162;
        IJth(rJacobian, 20, 13) = 8.1628665394625614e-6 * var_x46 - 3.2110964153622751e-7 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 22, 13) = 3.2651466157850246e-5 * var_x10 - 1.2844385661449098e-6 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (var_x45 * (4.7735212368995909e-14 * var_x64 - 0.0020374777599573 * var_x35 - 0.0029697911938972605 * var_x66 - 0.0073720343155036427 * var_x60 - 3.5942399999999997e-5 * var_x65 - 20.336646387596257 * var_x67));
        IJth(rJacobian, 20, 20) = 1.5856796826686865e-16 * var_x64 - 2.2560474246135324e-6 * var_x35 - 1.193943225512245e-7 * var_x65 - 0.022518252522655345 * var_x67 - 8.1628665394625614e-6 * var_x60 - 9.8651233004461501e-6 * var_x66;
        IJth(rJacobian, 21, 20) = var_x175 * (3.9798107517074834e-5 * var_x65 - 5.2855989422289547e-14 * var_x64);
        IJth(rJacobian, 22, 20) = 6.5767488669640998e-6 * var_x66;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (var_x45 * (0.0040000000000000001 * var_x71 + 3.6384839650145766e-8 * var_x63 + 27.396096 * var_x72 - 0.0040000000000000001 * var_x69 - 0.00041181708934882422 * var_x70));
        ...
        IJth(rJacobian, 20, 21) = 0.091005005855711127 * var_x72 + 1.2086402914563544e-10 * var_x63;
        ...
        IJth(rJacobian, 25, 21) = 3.0179734274641783 * var_x183 - 6.5826035008107738e-8 * var_x186;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (var_x45 * (0.038712000000000003 * var_x78 - 0.17794565589146724 * var_x75 - 0.61009939162788773 * var_x76 - 0.00014953416461467836 * var_x77 - 0.0035080715018603542 * var_x9 - 0.029488137262014571 * var_x73 + var_x1 * var_x74));
        IJth(rJacobian, 22, 22) = 4.286481532120841e-5 * var_x78 - 3.2651466157850246e-5 * var_x73 - 3.8843985601580465e-6 * var_x9 - 0.00019703470957323427 * var_x75 - 0.00067554757567966038 * var_x76 - 1.6557538619599519e-7 * var_x77 + var_x188 * var_x74;
        ...
        IJth(rJacobian, 21, 23) = 0.037453183520599252 * var_x174;
        IJth(rJacobian, 23, 23) = var_x193 * (-29213.483146067414 - var_x198 - var_x199) + 2.3800000000000004e-7 * (29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 84000.0 * var_x200 - 29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 13.386950228182727 * var_x52 * (-65.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_channel_d_gate__d) / (pow(var_x190, 3) * pow(var_x191, 2));
        IJth(rJacobian, 24, 23) = var_x204 * (var_x206 + var_x207);
        IJth(rJacobian, 23, 24) = var_x193 * (var_x198 + var_x199);
        IJth(rJacobian, 24, 24) = var_x204 * (-1740.0382808421784 - var_x206 - var_x207) + 0.00016666666666666666 * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800.0 * var_x200 - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / (pow(var_x201, 3) * pow((0.083333333333333329 + var_x202), 2));
        IJth(rJacobian, 25, 24) = 0.19333758676024207;
        IJth(rJacobian, 21, 25) = var_x175 * (0.2735562310030395 * var_x181 + 2.651834266564234e-10 * var_x185);
        IJth(rJacobian, 24, 25) = 1.7400382808421784 * var_x203;
        IJth(rJacobian, 25, 25) = -0.19333758676024207 - 4.9248350664764349e-13 * var_x185 - 0.00050803300043421621 * var_x181;
    }
