...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnoble_SAN_model_1989FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_fast_sodium_current__E_mh = var_membrane__RTONF * log(10) * log10((0.12 * var_extracellular_potassium_concentration__Kc + var_extracellular_sodium_concentration__Nao) / (0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki + var_chaste_interface__intracellular_sodium_concentration__Nai)); // millivolt
        const double var_hyperpolarising_activated_current__E_K = var_membrane__RTONF * log(10) * log10(var_extracellular_potassium_concentration__Kc / var_chaste_interface__intracellular_potassium_concentration__Ki); // millivolt
    ...
    void Cellnoble_SAN_model_1989FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x52 = 1 / NV_Ith_S(mParameters, 0);
        ...
        const double var_x60 = 0.0074999999999999997 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        const double var_x61 = 1 / var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x62 = 26.713760659695652 * var_x2;
        const double var_x63 = -var_x62 * log10(140.0 * var_x61) + var_chaste_interface__membrane__V;
        ...
        const double var_x65 = -var_x62 * log10(140.36000000000001 * var_x64) + var_chaste_interface__membrane__V;
        ...
        const double var_x67 = var_x65 * var_x8;
        const double var_x68 = var_x25 * var_x43;
        const double var_x69 = var_x37 * var_x39;
        const double var_x70 = var_x43 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x71 = var_x70 * var_chaste_interface__second_inward_current_f2_gate__f2;
        const double var_x72 = var_x70 * var_chaste_interface__second_inward_current_f_gate__f;
        ...
        const double var_x75 = 0.10017660247385868 * var_x0;
        ...
        const double var_x84 = 1.1761547293737243e-5 * var_x32;
        ...
        const double var_x99 = exp(-4.1000000000000005 + var_x98);
        const double var_x100 = 1.0 - var_x99;
        const double var_x101 = 200.0 / var_x100;
        const double var_x102 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x103 = exp(-9.375 - 0.125 * var_chaste_interface__membrane__V);
        const double var_x104 = exp(-7.5 + var_x98);
        const double var_x105 = 0.001 * var_chaste_interface__second_inward_current_d_gate__d;
        const double var_x106 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x107 = fabs(var_x106) < 0.0001;
        const double var_x108 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x109 = -var_x108;
        const double var_x110 = exp(-4.75 + var_x109);
        const double var_x111 = 1.0 - var_x110;
        const double var_x112 = 30.0 / var_x111;
        const double var_x113 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x114 = -1.0 + var_x113;
        const double var_x115 = 12.0 / var_x114;
        const double var_x116 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x117 = fabs(var_x116) < 0.0001;
        const double var_x118 = exp(8.5 + var_x108);
        const double var_x119 = -1.0 + var_x118;
        const double var_x120 = 6.25 / var_x119;
        const double var_x121 = exp(-8.5 + var_x109);
        const double var_x122 = 1.0 + var_x121;
        const double var_x123 = -4.9092993655091836e-6 * var_x0;
        const double var_x124 = 5.8807736468686208e-8 * var_x36;
        const double var_x125 = 2.2014023865015868e-9 * var_x49;
        const double var_x126 = 9.8185987310183671e-6 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        const double var_x127 = var_x124 * var_x41;
        const double var_x128 = 0.00013114584825700806 * var_x0;
        const double var_x129 = -var_x124 * var_x80;
        const double var_x130 = 0.002 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x131 = 0.19999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x132 = 0.0050000000000000001 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x133 = 1.0 - var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x134 = exp(16.0 + var_x108);
        const double var_x135 = -1.0 + var_x134;
        const double var_x136 = 0.00062500000000000001 / var_x135;
        const double var_x137 = exp(-16.0 + var_x109);
        const double var_x138 = 1.0 + var_x137;
        const double var_x139 = 64.0 + var_chaste_interface__membrane__V;
        const double var_x140 = var_x124 * var_x39;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x53 * (-0.00080000000000000004 + 0.00012957885284796509 * var_x14 + 0.0013452443348440585 * var_x48 - 0.0074999999999999997 * var_x0 - 0.012500000000000001 * var_x9 - 2.0000000000000002e-5 * var_x24 - 0.0017307692307692306 * var_x7 - 0.002690488669688117 * var_x46 - 0.0006417238426756367 * var_x12 - 0.00024046242485337545 * var_x47 + var_x40 * var_x50 + var_x50 * var_x51 - var_x26 * var_x33 - var_x26 * var_x42 - var_x37 * var_x40));
        IJth(rJacobian, 1, 0) = -6.5457324873455795e-8 + 2.6182929949382318e-8 * var_x24 + 8.8056095460063478e-7 * var_x48 - 1.7611219092012696e-6 * var_x46 - var_x26 * var_x84;
        IJth(rJacobian, 2, 0) = -0.0625 * var_x92 * (2.8e-5 - 2.8e-5 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y) - 0.0010263157894736842 * var_x93 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y;
        IJth(rJacobian, 3, 0) = 0.035714285714285712 * var_x94 * (0.0021000000000000003 - 0.0021000000000000003 * var_chaste_interface__time_dependent_potassium_current_x_gate__x) + 3.9999999999999996e-5 * var_x95 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        IJth(rJacobian, 4, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x97) ? (0) : (var_x101 - 20.0 * var_x96 * var_x99 / pow(var_x100, 2))) + 0.44800000000000001 * var_x102 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 5, 0) = -0.125 * var_x103 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x104 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x104), 2);
        IJth(rJacobian, 6, 0) = (0.001 - var_x105) * ((var_x107) ? (0) : (var_x112 - 7.5 * var_x106 * var_x110 / pow(var_x111, 2))) - var_x105 * ((var_x107) ? (0) : (var_x115 - 1.2 * var_x106 * var_x113 / pow(var_x114, 2)));
        IJth(rJacobian, 7, 0) = (0.001 - 0.001 * var_chaste_interface__second_inward_current_f_gate__f) * ((var_x117) ? (0) : (var_x120 - 1.5625 * var_x116 * var_x118 / pow(var_x119, 2))) - 0.012500000000000001 * var_x121 * var_chaste_interface__second_inward_current_f_gate__f / pow(var_x122, 2);
        IJth(rJacobian, 9, 0) = -9.16402548228381e-7 + var_x123 - 1.6364331218363949e-5 * var_x9 - 3.0819633411022218e-7 * var_x47 - 7.8548789848146954e-8 * var_x24 + var_x125 * var_x51 - var_x124 * var_x51;
        IJth(rJacobian, 12, 0) = var_x133 * var_x136 - 0.00125 * var_x137 * var_chaste_interface__intracellular_calcium_concentration__p / pow(var_x138, 2) - 0.00015625 * var_x133 * var_x134 * var_x139 / pow(var_x135, 2);
        IJth(rJacobian, 13, 0) = var_x123 + 1.6963770135197946e-7 * var_x14 - 2.2658304763888542e-6 * var_x7 - 8.4011052098123161e-7 * var_x12 - 6.6042071595047608e-9 * var_x47 + var_x125 * var_x40 - var_x124 * var_x40;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x53 * (1.3800000000000002e-7 * var_x56 + 7.2886297376093296e-8 * var_x57 + 54.880000000000003 * var_x58 - 0.017968267594917826 * var_x59 - 0.0013356880329847825 * var_x54));
        IJth(rJacobian, 1, 1) = -0.19999999999999998 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 1.1761547293737243e-5 * var_x59 - 1.8066221665073799e-10 * var_x56 - 0.071845959781105084 * var_x58 - 9.5418840923404938e-11 * var_x57 - 8.7430565504672044e-7 * var_x54 + var_x85 * var_x89 - var_x85 * var_x90;
        IJth(rJacobian, 8, 1) = -20.0 * var_chaste_interface__second_inward_current_f2_gate__f2;
        IJth(rJacobian, 9, 1) = 0.21553787934331523 * var_x58 + 5.4198664995221396e-10 * var_x56 + 2.862565227702148e-10 * var_x57;
        ...
        IJth(rJacobian, 11, 1) = var_x131 * var_x90 - var_x131 * var_x89;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x53 * (-var_x13 * var_x60 - var_x60 * var_x63));
        IJth(rJacobian, 2, 2) = -2.8e-5 * var_x92 - 0.0195 * var_x93;
        IJth(rJacobian, 9, 2) = -var_x126 * var_x63;
        IJth(rJacobian, 13, 2) = -var_x126 * var_x13;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (var_x53 * (0.017142857142857144 * var_x11 - 0.0057142857142857143 * var_chaste_interface__intracellular_potassium_concentration__Ki));
        IJth(rJacobian, 3, 3) = -0.00095999999999999992 * var_x95 - 0.0021000000000000003 * var_x94;
        IJth(rJacobian, 13, 3) = 2.2442511385184842e-5 * var_x11 - 7.4808371283949473e-6 * var_chaste_interface__intracellular_potassium_concentration__Ki;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-3.7500000000000003e-5 * var_x52 * var_x66);
        IJth(rJacobian, 4, 4) = -8.0 * var_x102 - 0.001 * ((var_x97) ? (2000.0) : (var_x101 * var_x96));
        IJth(rJacobian, 9, 4) = -4.9092993655091846e-5 * var_x66;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-1.2500000000000001e-5 * var_x52 * var_x67);
        IJth(rJacobian, 5, 5) = -2.0 / (1.0 + 320.0 * var_x104) - 0.02 * var_x103;
        IJth(rJacobian, 9, 5) = -1.6364331218363949e-5 * var_x67;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x53 * (-var_x33 * var_x68 - var_x42 * var_x68 - var_x68 * var_x69));
        IJth(rJacobian, 1, 6) = -var_x68 * var_x84;
        IJth(rJacobian, 6, 6) = -0.001 * ((var_x107) ? (120.0) : (var_x106 * var_x112)) - 0.001 * ((var_x107) ? (120.0) : (var_x106 * var_x115));
        IJth(rJacobian, 9, 6) = -var_x127 * var_x68;
        IJth(rJacobian, 13, 6) = -var_x140 * var_x68;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x53 * (-var_x33 * var_x71 - var_x42 * var_x71 - var_x69 * var_x71));
        IJth(rJacobian, 1, 7) = -var_x71 * var_x84;
        IJth(rJacobian, 7, 7) = -0.001 * ((var_x117) ? (25.0) : (var_x116 * var_x120)) - 0.050000000000000003 / var_x122;
        IJth(rJacobian, 9, 7) = -var_x127 * var_x71;
        IJth(rJacobian, 13, 7) = -var_x140 * var_x71;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x53 * (-var_x33 * var_x72 - var_x42 * var_x72 - var_x69 * var_x72));
        IJth(rJacobian, 1, 8) = -var_x72 * var_x84;
        IJth(rJacobian, 8, 8) = -0.01 - 20.0 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 9, 8) = -var_x127 * var_x72;
        IJth(rJacobian, 13, 8) = -var_x140 * var_x72;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x53 * (var_x81 + 1.5937237035588913e-13 * var_x78 + 0.0002109375 * var_x74 - 0.00012000000000000002 * var_x79 - 0.33750000000000002 * var_x73 - 0.018699632461786953 * var_x61 - 0.33392200824619567 * var_x76 - var_x61 * var_x75));
        IJth(rJacobian, 1, 9) = 1.5709757969629391e-7 * var_x79 - 2.0864178044476298e-16 * var_x78;
        IJth(rJacobian, 9, 9) = var_x129 + 8.2844426792967482e-7 * var_x74 + 6.2592534133428895e-16 * var_x78 - 4.7129273908888172e-7 * var_x79 - 0.0013255108286874798 * var_x73 - 2.4480558341308171e-5 * var_x61 - 0.00043715282752336023 * var_x76 - var_x128 * var_x61;
        IJth(rJacobian, 13, 9) = 0.0008836738857916531 * var_x73 - 5.5229617861978321e-7 * var_x74;
        IJth(rJacobian, 1, 10) = 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 10, 10) = -var_x130 - 0.79999999999999993 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 11, 10) = var_x132;
        IJth(rJacobian, 1, 11) = 0.002 * var_x91;
        IJth(rJacobian, 10, 11) = var_x130;
        IJth(rJacobian, 11, 11) = -var_x132 - 0.099999999999999992 * var_x91;
        ...
        IJth(rJacobian, 12, 12) = -0.0050000000000000001 / var_x138 - var_x136 * var_x139;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x53 * (var_x81 + 0.0034615384615384612 * var_x83 - 0.0057142857142857143 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 0.040070640989543473 * var_x76 - 0.046235354987934775 * var_x82 - var_x3 * var_x75));
        IJth(rJacobian, 9, 13) = -5.2458339302803225e-5 * var_x76;
        IJth(rJacobian, 13, 13) = var_x129 + 4.5316609527777084e-6 * var_x83 - 7.4808371283949473e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 6.0528853041696024e-5 * var_x82 - var_x128 * var_x3;
    }
