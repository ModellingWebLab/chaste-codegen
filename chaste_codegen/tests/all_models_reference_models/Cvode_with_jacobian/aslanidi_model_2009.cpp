...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellaslanidi_model_2009FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_Ca_independent_transient_outward_K_current__E_K = var_membrane__R * var_membrane__T * log(10) * log10(var_chaste_interface__cleft_space_ion_concentrations__K_c / var_chaste_interface__intracellular_ion_concentrations__K_i) / var_membrane__F; // millivolt
        const double var_background_currents__E_Ca = 0.5 * var_membrane__R * var_membrane__T * log(10) * log10(var_cleft_space_ion_concentrations__Ca_c / var_chaste_interface__intracellular_ion_concentrations__Ca_i) / var_membrane__F; // millivolt
        ...
        const double var_sodium_current__E_Na = var_membrane__R * var_membrane__T * log(10) * log10(var_cleft_space_ion_concentrations__Na_c / var_chaste_interface__intracellular_ion_concentrations__Na_i) / var_membrane__F; // millivolt
    ...
    void Cellaslanidi_model_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x20 = log(10);
        const double var_x21 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x22 = var_x20 * log10(var_x21 * var_chaste_interface__cleft_space_ion_concentrations__K_c);
        const double var_x23 = exp(0.18895643383558949 + 0.052487898287663745 * var_chaste_interface__membrane__V - 1.393 * var_x22);
        const double var_x24 = 1.0 + var_x23;
        const double var_x25 = 1 / var_x24;
        const double var_x26 = 0.58999999999999997 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x27 = pow(var_x26, (-3));
        const double var_x28 = var_x25 * var_x27;
        const double var_x29 = var_x19 * var_x28;
        const double var_x30 = -0.36000000000000004 + 0.0072000000000000007 * var_chaste_interface__membrane__V;
        const double var_x31 = 0.083333333333333329 * var_x1 / pow(var_x2, 2);
        ...
        const double var_x37 = pow(var_chaste_interface__sodium_current_m_gate__m, 3);
        const double var_x38 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x39 = exp(var_x33 - 1.0 * var_x20 * log10(140.0 * var_x38));
        const double var_x40 = -1.0 + var_x39;
        const double var_x41 = var_x36 * var_x37 * var_x40;
        const double var_x42 = var_x32 * var_x41;
        const double var_x43 = 0.026849797106057973 * var_x37;
        const double var_x44 = var_x32 * var_x36 * var_chaste_interface__membrane__V;
        const double var_x45 = var_x39 * var_x44;
        const double var_x46 = -26.53945091048535 * var_x22 + var_chaste_interface__membrane__V;
        const double var_x47 = var_x23 * var_x27 * var_x46 / pow(var_x24, 2);
        const double var_x48 = var_x19 * var_x47;
        ...
        const double var_x56 = var_x32 * var_x34 * var_x40 * var_chaste_interface__membrane__V / pow(var_x35, 2);
        const double var_x57 = 1 / NV_Ith_S(mParameters, 0);
        const double var_x58 = 0.001 * var_x57;
        const double var_x59 = var_x40 * var_x44 * pow(var_chaste_interface__sodium_current_m_gate__m, 2);
        const double var_x60 = var_x41 * var_chaste_interface__membrane__V;
        const double var_x61 = var_x57 * var_x60;
        const double var_x62 = 0.001 * var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L;
        const double var_x63 = var_x30 * var_x57;
        const double var_x64 = 0.001 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        const double var_x65 = 0.001 * var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T;
        const double var_x66 = var_x57 * (-0.22800000000000001 + 0.0060000000000000001 * var_chaste_interface__membrane__V);
        const double var_x67 = 0.001 * var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T;
        const double var_x68 = var_x16 * var_x46;
        const double var_x69 = pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1, 2);
        const double var_x70 = var_x46 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x71 = var_x15 * var_x57 * var_x70;
        const double var_x72 = pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2, 2);
        const double var_x73 = var_x17 * var_x46 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3, 5);
        const double var_x74 = 0.001 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i;
        const double var_x75 = var_x57 * (0.0035000000000000001 * var_chaste_interface__membrane__V - 0.092888078186698725 * var_x22);
        const double var_x76 = 0.001 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a;
        const double var_x77 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2);
        const double var_x78 = var_x6 * var_x7 * var_x77;
        const double var_x79 = (2.5 * var_x8 - 2744000.0 * var_x10) / pow((0.0012147716229348883 + 9.1107871720116623e-7 * var_x5 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x80 = var_x77 * var_x79;
        const double var_x81 = 1 / (1.5 + var_x49);
        const double var_x82 = var_x51 * var_x81;
        const double var_x83 = var_x53 * var_x82;
        const double var_x84 = var_x83 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 0.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x85 = var_x82 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0) * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow((1 + 0.027410122234342148 * var_x52), 2);
        const double var_x86 = var_x37 * var_x45;
        const double var_x87 = var_x38 * var_x86;
        const double var_x88 = 0.00020000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x89 = 1 / var_x88;
        const double var_x90 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x91 = var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x88, 2);
        const double var_x92 = var_x6 * var_x9;
        const double var_x93 = 0.066348627276213379 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x94 = 0.092888078186698725 * var_x12;
        const double var_x95 = var_x21 * var_x29;
        const double var_x96 = 26.53945091048535 * var_x18;
        const double var_x97 = var_x21 * var_x48;
        const double var_x98 = 1 / var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x99 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 2);
        const double var_x100 = var_x28 * var_x99;
        const double var_x101 = 0.03048 * var_x46;
        const double var_x102 = var_x52 * var_x83;
        const double var_x103 = var_x19 * var_x25 / pow(var_x26, 4);
        const double var_x104 = var_x47 * var_x99;
        const double var_x105 = var_x54 * var_x81 / pow(var_x50, 2);
        const double var_x106 = exp(-3.5035114021936398 - 0.078907914463820727 * var_chaste_interface__membrane__V);
        const double var_x107 = 1.0 - var_chaste_interface__sodium_current_m_gate__m;
        const double var_x108 = -1.0 + var_x106;
        const double var_x109 = 0.46000000000000002 / var_x108;
        const double var_x110 = 44.399999999999999 + var_chaste_interface__membrane__V;
        const double var_x111 = exp(-7.333333333333333 - 0.077519379844961239 * var_chaste_interface__membrane__V);
        const double var_x112 = 1 / (1.0 + 323.30000000000001 * var_x111);
        const double var_x113 = exp(-12.010771992818672 - 0.17953321364452424 * var_chaste_interface__membrane__V);
        const double var_x114 = 44.899999999999999 * var_x113;
        const double var_x115 = 1 / (var_x114 + 1491.0 * var_x112);
        const double var_x116 = 8.0610412926391373 * var_x113;
        const double var_x117 = -var_x115 * var_x116 + 2.019719479407183e-5 * var_x113 * (var_x116 - 0.35750508923240704 * var_x111 / pow((0.0030931023816888337 + var_x111), 2)) / pow((var_x112 + 0.030114017437961098 * var_x113), 2);
        const double var_x118 = exp(6.666666666666667 + 0.16666666666666666 * var_chaste_interface__membrane__V);
        const double var_x119 = 1.0 + var_x118;
        const double var_x120 = 1 / var_x119;
        const double var_x121 = 0.001 / (0.00014999999999999999 + 0.029999999999999999 * var_x120);
        const double var_x122 = var_x114 * var_x115;
        const double var_x123 = exp(30.0 + 0.5 * var_chaste_interface__membrane__V);
        const double var_x124 = 1.0 + var_x123;
        const double var_x125 = 1 / var_x124;
        const double var_x126 = 0.001 / (0.00044999999999999999 + 0.12 * var_x125);
        const double var_x127 = exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V);
        const double var_x128 = 1.0 + var_x127;
        const double var_x129 = 0.40000000000000002 * var_chaste_interface__membrane__V;
        const double var_x130 = exp(2.0 + var_x129);
        const double var_x131 = -1.0 + var_x130;
        const double var_x132 = 1 / var_x131;
        const double var_x133 = 4.4800000000000004 * var_x132;
        const double var_x134 = exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V);
        const double var_x135 = -1.0 + var_x134;
        const double var_x136 = 1 / var_x135;
        const double var_x137 = 50.0 * var_x136;
        const double var_x138 = exp(-18.0 - var_x129);
        const double var_x139 = -1.0 + var_x138;
        const double var_x140 = 1 / var_x139;
        const double var_x141 = 16.719999999999999 * var_x140;
        const double var_x142 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x143 = 45.0 + var_chaste_interface__membrane__V;
        const double var_x144 = 5.0 + var_chaste_interface__membrane__V;
        const double var_x145 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x146 = exp(-4.5 - var_x145);
        const double var_x147 = 1.0 + var_x146;
        const double var_x148 = 1 / var_x147;
        const double var_x149 = 18.0 + var_chaste_interface__membrane__V;
        const double var_x150 = exp(4.5 + var_x145);
        const double var_x151 = -1.0 + var_x150;
        const double var_x152 = 1 / var_x151;
        const double var_x153 = 8.4900000000000002 * var_x152;
        const double var_x154 = 67.921999999999997 * var_x148 + var_x149 * var_x153;
        const double var_x155 = 1 / var_x154;
        const double var_x156 = 0.008490000000000001 * var_x152;
        const double var_x157 = var_x155 * var_x156;
        const double var_x158 = var_x149 * var_x152;
        const double var_x159 = 16.980499999999999 * var_x146 / pow(var_x147, 2);
        const double var_x160 = var_x149 * var_x150 / pow(var_x151, 2);
        const double var_x161 = 2.1225000000000001 * var_x160;
        const double var_x162 = exp(-3.7704918032786887 - 0.16393442622950821 * var_chaste_interface__membrane__V);
        const double var_x163 = 1.0 + var_x162;
        const double var_x164 = 0.033333333333333333 * var_chaste_interface__membrane__V;
        const double var_x165 = exp(0.77666666666666673 + var_x164);
        const double var_x166 = exp(-0.77666666666666673 - var_x164);
        const double var_x167 = exp(4.876462938881664 + 0.065019505851755519 * var_chaste_interface__membrane__V);
        const double var_x168 = exp(-0.9003601440576231 - 0.012004801920768308 * var_chaste_interface__membrane__V);
        const double var_x169 = 9.6370000000000005 * var_x167 + 9.6370000000000005 * var_x168;
        const double var_x170 = 1 / var_x169;
        const double var_x171 = 0.11569027611044419 * var_x168;
        const double var_x172 = 0.62659297789336799 * var_x167;
        const double var_x173 = 0.0096369999999999997 * var_x168;
        const double var_x174 = exp(-2.6628794603230959 - 0.17752529735487307 * var_chaste_interface__membrane__V);
        const double var_x175 = 1.0 + var_x174;
        const double var_x176 = exp(-0.1388888888888889 * var_chaste_interface__membrane__V);
        const double var_x177 = exp(var_x0);
        const double var_x178 = 0.00040000000000000002 + 1 / (8.0109999999999992 * var_x176 + 386.60000000000002 * var_x177);
        const double var_x179 = 1 / var_x178;
        const double var_x180 = exp(327.99999999999994 + 10.0 * var_chaste_interface__membrane__V);
        const double var_x181 = 1.0 + var_x180;
        const double var_x182 = 1 / var_x181;
        const double var_x183 = 1 / (0.020400000000000001 + 0.54659999999999997 * var_x182);
        const double var_x184 = exp(4.0070821529745047 + 0.14164305949008499 * var_chaste_interface__membrane__V);
        const double var_x185 = 1.0 + var_x184;
        const double var_x186 = 0.000141643059490085 * var_x184 / pow(var_x185, 2);
        const double var_x187 = 1 / var_x185;
        const double var_x188 = var_x180 / pow(var_x181, 2);
        const double var_x189 = exp(0.96921975662133131 - 0.071581961345740866 * var_chaste_interface__membrane__V);
        const double var_x190 = 1.0 + var_x189;
        const double var_x191 = 1 / var_x190;
        const double var_x192 = 1 / (5.75 * var_x182 + 0.45000000000000001 * var_x191);
        const double var_x193 = exp(46.0 + 2.0 * var_chaste_interface__membrane__V);
        const double var_x194 = 1.0 + var_x193;
        const double var_x195 = 1 / var_x194;
        const double var_x196 = 1 / (0.5 + 7.5 * var_x195);
        const double var_x197 = exp(1.8506208911614319 + 0.036523009495982472 * var_chaste_interface__membrane__V);
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = exp(0.065217391304347824 - 0.072463768115942032 * var_chaste_interface__membrane__V);
        const double var_x200 = 1.0 + var_x199;
        const double var_x201 = exp(-0.045816915605241454 * var_chaste_interface__membrane__V);
        const double var_x202 = exp(0.014398433450440593 * var_chaste_interface__membrane__V);
        const double var_x203 = 0.059999999999999998 + 1 / (0.29999999999999999 * var_x201 + 1.6599999999999999 * var_x202);
        const double var_x204 = 1 / var_x203;
        const double var_x205 = exp(-0.68918918918918914 - 0.13513513513513511 * var_chaste_interface__membrane__V);
        const double var_x206 = 1.0 + var_x205;
        const double var_x207 = exp(0.03941508020968823 * var_chaste_interface__membrane__V);
        const double var_x208 = exp(-0.076769537847382163 * var_chaste_interface__membrane__V);
        const double var_x209 = exp(0.009420009985210585 * var_chaste_interface__membrane__V);
        const double var_x210 = exp(-0.018299935950224173 * var_chaste_interface__membrane__V);
        const double var_x211 = exp(2.539728728905752 + 0.05358970648917756 * var_chaste_interface__membrane__V);
        const double var_x212 = 1.0 + var_x211;
        const double var_x213 = 0.00031705239460620043 - 6.3410478921240078e-6 * var_chaste_interface__membrane__V;
        const double var_x214 = 0.00020079984991726025 - 5.2842065767700066e-6 * var_chaste_interface__membrane__V;
        const double var_x215 = 3333.3333333333335 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x216 = 1 / (1.3999999999999999 + var_x215 + 0.80000000000000004 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up);
        const double var_x217 = (var_x215 - 0.32000000000000006 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up) / pow((0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x218 = 0.25 + var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x219 = pow(var_x218, (-2));
        const double var_x220 = pow(var_chaste_interface__Ca_handling_by_the_SR__F2, 2);
        const double var_x221 = var_x219 * var_x220;
        const double var_x222 = 0.17614021922566689 * var_x221;
        const double var_x223 = 32.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x224 = -var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_chaste_interface__Ca_handling_by_the_SR__Ca_rel;
        const double var_x225 = 0.35228043845133378 * var_x224;
        const double var_x226 = var_x219 * var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x227 = var_x220 / pow(var_x218, 3);
        const double var_x228 = -3.290319067574035e-6 - 4.9354786013610522e-6 * var_x14;
        const double var_x229 = var_x17 * var_x228;
        const double var_x230 = var_x228 * var_x70;
        const double var_x231 = 1.77 * var_x69;
        const double var_x232 = 1.23 * var_x72;
        const double var_x233 = 7.6404797510100245e-5 * var_x22 - 2.8789140275661778e-6 * var_chaste_interface__membrane__V;
        const double var_x234 = 5.4574855364357316e-5 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x235 = 7.6404797510100245e-5 * var_x12;
        const double var_x236 = 26.53945091048535 * var_x229;
        const double var_x237 = 2.5071228445776315e-5 * var_x46;
        const double var_x238 = -200.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x239 = 1.6583208100573134e-5 + 2.4874812150859699e-5 * var_x14;
        const double var_x240 = var_x17 * var_x239;
        const double var_x241 = var_x239 * var_x70;
        const double var_x242 = 1.4509726698933535e-5 * var_chaste_interface__membrane__V - 0.00038508017945090519 * var_x22;
        const double var_x243 = 0.00027505727103636083 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x244 = 0.00038508017945090519 * var_x12;
        const double var_x245 = 26.53945091048535 * var_x240;
        const double var_x246 = 0.00012635899136671262 * var_x46;
        const double var_x247 = 23.554751134632365 * var_x221;
        const double var_x248 = 47.109502269264731 * var_x224;
        const double var_x249 = exp(-1.6000000000000001 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x250 = 0.019200000000000002 * var_x249 * var_chaste_interface__Ca_handling_by_the_SR__F1;
        const double var_x251 = 0.00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x252 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 4);
        const double var_x253 = var_x252 / pow(var_x251, 5);
        const double var_x254 = 0.81520000000000004 * var_x253;
        const double var_x255 = pow(var_x251, (-4));
        const double var_x256 = var_x255 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 3);
        const double var_x257 = 0.81520000000000004 * var_x256;
        const double var_x258 = 0.23999999999999999 * var_x249;
        const double var_x259 = var_x252 * var_x255;
        const double var_x260 = 0.20380000000000001 * var_x259;
        const double var_x261 = 1.3584000000000001 * var_x253;
        const double var_x262 = 1.3584000000000001 * var_x256;
        const double var_x263 = 0.33960000000000001 * var_x259;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x58 * (0.0014400000000000001 + var_x18 + 0.0060000000000000001 * var_x4 + 0.0025000000000000001 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z + 0.010160000000000001 * var_x29 + 2.0000000000000002e-5 * var_x11 + 0.0035000000000000001 * var_x12 + 0.0011450666666666667 * var_x55 + 0.71257887225271721 * var_x42 + 0.0072000000000000007 * var_x13 + 0.0072000000000000007 * var_x3 - 0.00053327704660266365 * var_x48 + var_x30 * var_x31 + var_x43 * var_x45 - var_x43 * var_x56));
        IJth(rJacobian, 1, 0) = -var_x107 * var_x109 + 1.4519056261343013 * var_x106 * var_chaste_interface__sodium_current_m_gate__m - 0.036297640653357534 * var_x106 * var_x107 * var_x110 / pow(var_x108, 2);
        IJth(rJacobian, 2, 0) = var_x117 * var_x121 + 0.0055555555555555558 * var_x118 * (var_x122 - var_chaste_interface__sodium_current_h1_gate__h1) / (pow(var_x119, 2) * pow((0.0050000000000000001 + var_x120), 2));
        IJth(rJacobian, 3, 0) = var_x117 * var_x126 + 0.0041666666666666666 * var_x123 * (var_x122 - var_chaste_interface__sodium_current_h2_gate__h2) / (pow(var_x124, 2) * pow((0.0037499999999999999 + var_x125), 2));
        IJth(rJacobian, 4, 0) = (-var_x64 + 0.001 / var_x128) * (var_x133 - var_x137 - var_x141 - 10.399334442595674 * var_x134 * var_x142 / pow(var_x135, 2) - 6.6879999999999997 * var_x138 * var_x143 / pow(var_x139, 2) - 1.7920000000000003 * var_x130 * var_x144 / pow(var_x131, 2)) + 0.00015151515151515152 * var_x127 * (var_x133 * var_x144 - var_x137 * var_x142 - var_x141 * var_x143) / pow(var_x128, 2);
        IJth(rJacobian, 5, 0) = var_x154 * (var_x157 - 0.0021225000000000003 * var_x155 * var_x160 + 1.8402920895651027e-6 * var_x158 * (var_x161 - var_x153 - var_x159) / pow((var_x148 + 0.1249963193074409 * var_x158), 2)) + (-var_x62 + var_x149 * var_x157) * (var_x153 + var_x159 - var_x161);
        IJth(rJacobian, 6, 0) = (-var_x67 + 0.001 / var_x163) * (22.472433333333335 * var_x165 - 22.472433333333335 * var_x166) + 0.0001639344262295082 * var_x162 * (674.173 * var_x165 + 674.173 * var_x166) / pow(var_x163, 2);
        IJth(rJacobian, 7, 0) = var_x169 * (-0.00011569027611044419 * var_x168 * var_x170 + 0.00010376673238559718 * var_x168 * (var_x171 - var_x172) / pow((var_x167 + var_x168), 2)) + (var_x172 - var_x171) * (-var_x65 + var_x170 * var_x173);
        IJth(rJacobian, 8, 0) = 0.00017752529735487306 * var_x174 * var_x179 / pow(var_x175, 2) - 6.6907730760079843e-9 * (1 / var_x175 - var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r) * (1.1126388888888887 * var_x176 - 32.216666666666669 * var_x177) / (pow(var_x178, 2) * pow((var_x177 + 0.020721676151060523 * var_x176), 2));
        IJth(rJacobian, 9, 0) = -var_x183 * var_x186 + 0.018294914013904134 * var_x188 * (var_x187 - var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1) / pow((0.037321624588364438 + var_x182), 2);
        IJth(rJacobian, 10, 0) = -var_x186 * var_x192 + 3.0245746691871456e-5 * (var_x187 - var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2) * (57.5 * var_x188 - 0.032211882605583393 * var_x189 / pow(var_x190, 2)) / pow((var_x182 + 0.078260869565217397 * var_x191), 2);
        IJth(rJacobian, 11, 0) = -2.1922574727480476e-5 * var_x196 * var_x197 / pow(var_x198, 2) + 0.00026666666666666668 * var_x193 * (0.39975990396158467 - var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3 + 0.60024009603841544 / var_x198) / (pow(var_x194, 2) * pow((0.066666666666666666 + var_x195), 2));
        IJth(rJacobian, 12, 0) = 7.2463768115942027e-5 * var_x199 * var_x204 / pow(var_x200, 2) - 0.00036289737262302222 * (1 / var_x200 - var_chaste_interface__delayed_rectifier_K_current_z_gate__z) * (0.013745074681572435 * var_x201 - 0.023901399527731383 * var_x202) / (pow(var_x203, 2) * pow((var_x202 + 0.18072289156626506 * var_x201), 2));
        IJth(rJacobian, 13, 0) = (-var_x76 + 0.001 / var_x206) * (0.35473572188719404 * var_x207 - 0.099800399201596807 * var_x208) + 0.00013513513513513514 * var_x205 * (9.0 * var_x207 + 1.3 * var_x208) / pow(var_x206, 2);
        IJth(rJacobian, 14, 0) = (-var_x74 + 0.001 / var_x212) * (6.1795265502981431 * var_x209 - 1.8299935950224173 * var_x210) - 5.3589706489177562e-5 * var_x211 * (100.0 * var_x210 + 656.0 * var_x209) / pow(var_x212, 2);
        IJth(rJacobian, 15, 0) = -1.6450937300378158e-8 - 2.2085216435981733e-5 * var_x86 - 4.9352811901134478e-8 * var_x11 - 0.00058612951745018135 * var_x42 - 2.8256129907129523e-6 * var_x55 + 2.2085216435981733e-5 * var_x37 * var_x56;
        IJth(rJacobian, 16, 0) = -1.7614021922566692e-8 + 3.5228043845133383e-8 * var_x11 - 5.2842065767700066e-6 * var_x4 - 6.3410478921240078e-6 * var_x13 - 6.3410478921240078e-6 * var_x3 + var_x213 * var_x31;
        IJth(rJacobian, 17, 0) = -1.151565611026471e-6 + var_x229 + 4.3864536286956306e-7 * var_x48 + 1.8837419938086349e-6 * var_x55 - 2.0563671625472697e-6 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z - 8.3570761485921043e-6 * var_x29 - 2.8789140275661778e-6 * var_x12;
        IJth(rJacobian, 22, 0) = 5.8038906795734136e-6 + var_x240 + 1.4509726698933535e-5 * var_x12 + 1.0364090499238238e-5 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z + 4.2119663788904201e-5 * var_x29 - 9.4940596487955185e-6 * var_x55 - 2.2107726288625975e-6 * var_x48;
        IJth(rJacobian, 26, 0) = -var_x250;
        IJth(rJacobian, 27, 0) = var_x250;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0021377366167581514 * var_x57 * var_x59);
        IJth(rJacobian, 1, 1) = -18.399999999999999 * var_x106 + var_x109 * var_x110;
        IJth(rJacobian, 15, 1) = -0.001758388552350544 * var_x59;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00045248758388047544 * var_x61);
        IJth(rJacobian, 2, 2) = -var_x121;
        IJth(rJacobian, 15, 2) = -0.0003721922435808652 * var_x60;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00026009128837224178 * var_x61);
        IJth(rJacobian, 3, 3) = -var_x126;
        IJth(rJacobian, 15, 3) = -0.0002139372738693162 * var_x60;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x62 * var_x63);
        IJth(rJacobian, 4, 4) = 0.016719999999999999 * var_x140 * var_x143 + 0.050000000000000003 * var_x136 * var_x142 - 0.0044800000000000005 * var_x132 * var_x144;
        IJth(rJacobian, 16, 4) = var_x213 * var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x63 * var_x64);
        IJth(rJacobian, 5, 5) = -0.067921999999999996 * var_x148 - var_x149 * var_x156;
        IJth(rJacobian, 16, 5) = var_x213 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x65 * var_x66);
        IJth(rJacobian, 6, 6) = -0.67417300000000002 * var_x165 - 0.67417300000000002 * var_x166;
        IJth(rJacobian, 16, 6) = var_x214 * var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x66 * var_x67);
        IJth(rJacobian, 7, 7) = -var_x173 - 0.0096369999999999997 * var_x167;
        IJth(rJacobian, 16, 7) = var_x214 * var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x15 * var_x58 * var_x68);
        IJth(rJacobian, 8, 8) = -0.001 * var_x179;
        IJth(rJacobian, 17, 8) = var_x228 * var_x68;
        IJth(rJacobian, 22, 8) = var_x239 * var_x68;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0017699999999999999 * var_x69 * var_x71);
        IJth(rJacobian, 9, 9) = -0.001 * var_x183;
        IJth(rJacobian, 17, 9) = var_x230 * var_x231;
        IJth(rJacobian, 22, 9) = var_x231 * var_x241;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00123 * var_x71 * var_x72);
        IJth(rJacobian, 10, 10) = -0.001 * var_x192;
        IJth(rJacobian, 17, 10) = var_x230 * var_x232;
        IJth(rJacobian, 22, 10) = var_x232 * var_x241;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-3.600144e-5 * var_x57 * var_x73);
        IJth(rJacobian, 11, 11) = -0.001 * var_x196;
        IJth(rJacobian, 17, 11) = -2.9612871608166312e-5 * var_x73;
        IJth(rJacobian, 22, 11) = 0.00014924887290515819 * var_x73;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x58 * (0.0025000000000000001 * var_chaste_interface__membrane__V - 0.066348627276213379 * var_x22));
        IJth(rJacobian, 12, 12) = -0.001 * var_x204;
        IJth(rJacobian, 17, 12) = 5.4574855364357316e-5 * var_x22 - 2.0563671625472697e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 22, 12) = 1.0364090499238238e-5 * var_chaste_interface__membrane__V - 0.00027505727103636083 * var_x22;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x74 * var_x75);
        IJth(rJacobian, 13, 13) = -0.0089999999999999993 * var_x207 - 0.0012999999999999999 * var_x208;
        IJth(rJacobian, 17, 13) = var_x233 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i;
        IJth(rJacobian, 22, 13) = var_x242 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x75 * var_x76);
        IJth(rJacobian, 14, 14) = -0.65600000000000003 * var_x209 - 0.10000000000000001 * var_x210;
        IJth(rJacobian, 17, 14) = var_x233 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a;
        IJth(rJacobian, 22, 14) = var_x242 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x58 * (0.00015000000000000001 * var_x78 + 0.00053078901820970701 * var_x38 + 0.154584 * var_x84 + 0.71257887225271721 * var_x87 - 6.640515431495382e-14 * var_x80 - 0.0001161412471825695 * var_x85));
        IJth(rJacobian, 15, 15) = 2.8659485630822583e-7 * var_x85 + 1.638640545085862e-16 * var_x80 - 0.00038145775374624855 * var_x84 - 4.3659884291485854e-7 * var_x38 - 0.00058612951745018135 * var_x87 - 3.701460892585086e-7 * var_x78;
        IJth(rJacobian, 16, 15) = 2.6421032883850034e-7 * var_x78 - 1.1696618438750204e-16 * var_x80;
        IJth(rJacobian, 17, 15) = 0.00025430516916416572 * var_x84 - 1.9106323753881723e-7 * var_x85;
        IJth(rJacobian, 22, 15) = 9.6295871719563877e-7 * var_x85 - 0.0012816980525873951 * var_x84;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x58 * (0.0095090000000000001 * var_x89 + 0.0002653945091048535 * var_x90 - 0.0095090000000000001 * var_x91 - 2.4295432458697768e-8 * var_x79 - 54.880000000000003 * var_x92));
        IJth(rJacobian, 15, 16) = 5.9952395409541403e-11 * var_x79 + 0.13542411585671302 * var_x92;
        IJth(rJacobian, 16, 16) = -47.271999999999998 - var_x222 + 8.3745867230843319e-6 * var_x91 + 6.2720000000000002 * var_chaste_interface__intracellular_Ca_buffering__O_TC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 9.0 * var_chaste_interface__intracellular_Ca_buffering__O_C + 7.3978892074780085e-7 * var_x217 - 8.3745867230843319e-6 * var_x89 - 0.096665752311045988 * var_x92 - 8.2198768971977874 * var_x216 - 4.2794027994574083e-11 * var_x79 - 2.3373323507508574e-7 * var_x90;
        ...
        IJth(rJacobian, 23, 16) = var_x247;
        IJth(rJacobian, 24, 16) = 121.85879481761599 * var_x216 - 1.0967291533585437e-5 * var_x217;
        IJth(rJacobian, 26, 16) = (var_x254 - var_x257) * var_chaste_interface__Ca_handling_by_the_SR__F1;
        IJth(rJacobian, 27, 16) = (var_x257 - var_x254) * var_chaste_interface__Ca_handling_by_the_SR__F1 + (var_x261 - var_x262) * var_chaste_interface__Ca_handling_by_the_SR__F2;
        IJth(rJacobian, 28, 16) = (var_x262 - var_x261) * var_chaste_interface__Ca_handling_by_the_SR__F2;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x58 * (0.26964082125053118 * var_x95 - 0.014152880000000001 * var_x97 + var_x21 * var_x93 + var_x21 * var_x94 + var_x21 * var_x96));
        IJth(rJacobian, 17, 17) = 1.1641407074988802e-5 * var_x97 - 0.00022179221220074814 * var_x95 + var_x21 * var_x236 - var_x21 * var_x234 - var_x21 * var_x235;
        IJth(rJacobian, 22, 17) = 0.0011178327494917705 * var_x95 - 5.8672691657943555e-5 * var_x97 + var_x21 * var_x243 + var_x21 * var_x244 + var_x21 * var_x245;
        IJth(rJacobian, 16, 18) = 0.021419999999999998 + 9.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        IJth(rJacobian, 18, 18) = -0.47599999999999998 + var_x238;
        ...
        IJth(rJacobian, 16, 20) = 0.0010559999999999999 + var_x223;
        IJth(rJacobian, 20, 20) = -0.0066 + var_x238;
        IJth(rJacobian, 21, 20) = -5.0;
        IJth(rJacobian, 16, 21) = var_x223;
        IJth(rJacobian, 20, 21) = var_x238;
        IJth(rJacobian, 21, 21) = -5.6660000000000004;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x58 * (0.10305599999999999 * var_x102 + 0.014152880000000001 * var_x104 - 0.26964082125053118 * var_x100 - 0.10305599999999999 * var_x105 + var_x100 * var_x101 - var_x101 * var_x103 - var_x93 * var_x98 - var_x94 * var_x98 - var_x96 * var_x98));
        IJth(rJacobian, 15, 22) = 0.00025430516916416572 * var_x105 - 0.00025430516916416572 * var_x102;
        IJth(rJacobian, 17, 22) = 0.00016953677944277714 * var_x102 + 0.00022179221220074814 * var_x100 - 1.1641407074988802e-5 * var_x104 - 0.00016953677944277714 * var_x105 + var_x103 * var_x237 + var_x234 * var_x98 + var_x235 * var_x98 - var_x100 * var_x237 - var_x236 * var_x98;
        IJth(rJacobian, 22, 22) = 0.00085446536839159674 * var_x105 + 5.8672691657943555e-5 * var_x104 - 0.0011178327494917705 * var_x100 - 0.00085446536839159674 * var_x102 + var_x100 * var_x246 - var_x103 * var_x246 - var_x243 * var_x98 - var_x244 * var_x98 - var_x245 * var_x98;
        IJth(rJacobian, 16, 23) = var_x222;
        IJth(rJacobian, 23, 23) = -14.98 - var_x247 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse;
        ...
        IJth(rJacobian, 16, 24) = 1.7754934097947219e-10 * var_x217 + 0.00078910818213098765 * var_x216;
        IJth(rJacobian, 23, 24) = 0.099999999999999992;
        IJth(rJacobian, 24, 24) = -0.011085915847820609 - 2.6321499680605046e-9 * var_x217 - 0.011698444302491135 * var_x216;
        ...
        IJth(rJacobian, 26, 26) = -var_x258 - var_x260;
        IJth(rJacobian, 27, 26) = var_x258 + var_x260;
        IJth(rJacobian, 16, 27) = var_x225 * var_x226 - var_x225 * var_x227;
        IJth(rJacobian, 23, 27) = var_x227 * var_x248 - var_x226 * var_x248;
        IJth(rJacobian, 27, 27) = -0.033960000000000004 - var_x263;
        IJth(rJacobian, 28, 27) = 0.033960000000000004 + var_x263;
