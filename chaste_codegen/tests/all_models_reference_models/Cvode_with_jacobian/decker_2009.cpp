...
#include "MathsCustomFunctions.hpp"
    ...
    double Celldecker_2009FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_reversal_potentials__ECl = -var_model_parameters__R * var_model_parameters__T * log(10) * log10(var_model_parameters__Cl_o / var_chaste_interface__Cl__Cl_i) / var_model_parameters__F; // mV
        ...
        const double var_reversal_potentials__EK = var_model_parameters__R * var_model_parameters__T * log(10) * log10(var_model_parameters__K_o / var_chaste_interface__K__K_i) / var_model_parameters__F; // mV
        ...
        const double var_reversal_potentials__ENa = var_model_parameters__R * var_model_parameters__T * log(10) * log10(var_model_parameters__Na_o / var_chaste_interface__Na__Na_i) / var_model_parameters__F; // mV
        ...
        const double var_reversal_potentials__EKs = var_model_parameters__R * var_model_parameters__T * log(10) * log10((var_model_parameters__Na_o * var_reversal_potentials__prnak + var_model_parameters__K_o) / (var_chaste_interface__Na__Na_i * var_reversal_potentials__prnak + var_chaste_interface__K__K_i)) / var_model_parameters__F; // mV
    ...
    void Celldecker_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x19 = log(10);
        const double var_x20 = 1 / var_chaste_interface__K__K_i;
        const double var_x21 = var_x19 * log10(5.4000000000000004 * var_x20);
        const double var_x22 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__Vm - 6.3707607242426434 * var_x21);
        const double var_x23 = 1.0 + var_x22;
        const double var_x24 = 1 / var_x23;
        const double var_x25 = exp(-2.4444678999999998 + 13.737871029257827 * var_x21 - 0.51429999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x26 = 1.0 + var_x25;
        const double var_x27 = 1 / var_x26;
        const double var_x28 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__Vm - 2.1454905717868731 * var_x21);
        const double var_x29 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__Vm - 1.6494527242011876 * var_x21);
        const double var_x30 = var_x29 + 0.49124000000000001 * var_x28;
        const double var_x31 = var_x27 * var_x30;
        const double var_x32 = 1 / (var_x31 + 1.02 * var_x24);
        const double var_x33 = var_x24 * var_x32;
        const double var_x34 = exp(0.074873319003313496 * var_chaste_interface__membrane__Vm);
        const double var_x35 = -1.0 + var_x34;
        const double var_x36 = 1 / var_x35;
        const double var_x37 = 1.0 * var_x34;
        const double var_x38 = -0.61380000000000001 + var_x37 * var_chaste_interface__Ca__Ca_i;
        const double var_x39 = var_x36 * var_x38;
        const double var_x40 = 26.711785007306684 * var_x21;
        const double var_x41 = -var_x40 + var_chaste_interface__membrane__Vm;
        const double var_x42 = var_x0 * var_x41 / pow(var_x1, 2);
        const double var_x43 = exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__membrane__Vm);
        const double var_x44 = 1.0 + var_x43;
        const double var_x45 = NV_Ith_S(mParameters, 2) / var_x44;
        const double var_x46 = 1.0 * var_x45;
        const double var_x47 = pow(var_chaste_interface__INa_m_gate__m, 3);
        const double var_x48 = var_x47 * NV_Ith_S(mParameters, 1) * var_chaste_interface__INa_j_gate__j;
        const double var_x49 = var_x48 * var_chaste_interface__INa_h_gate__h;
        const double var_x50 = var_x34 * var_chaste_interface__membrane__Vm;
        const double var_x51 = var_x50 / pow(var_x35, 2);
        const double var_x52 = var_x38 * var_x51;
        const double var_x53 = var_x13 * var_chaste_interface__membrane__Vm;
        const double var_x54 = var_x17 * var_x53 / pow(var_x14, 2);
        const double var_x55 = var_x22 / pow(var_x23, 2);
        const double var_x56 = var_x32 * var_x41;
        const double var_x57 = var_x55 * var_x56;
        const double var_x58 = exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm);
        const double var_x59 = 1.0 + 0.32000000000000001 * var_x58;
        const double var_x60 = 1 / var_x59;
        const double var_x61 = 1.0 * var_x60;
        const double var_x62 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x63 = exp(0.010107898065447322 * var_chaste_interface__membrane__Vm);
        const double var_x64 = var_x62 * var_x63;
        const double var_x65 = var_x58 * var_chaste_interface__Ca__Ca_i;
        const double var_x66 = 1.0 + 1.5624999999999999e-8 / pow(var_chaste_interface__Ca__Ca_i, 2);
        const double var_x67 = 1 / var_x66;
        const double var_x68 = 1 / (13227.9606 + 8.4084932990912282 * var_x62 + 4344355.375 * var_chaste_interface__Ca__Ca_i);
        const double var_x69 = var_x67 * var_x68;
        const double var_x70 = var_x69 * (0.065499179464098653 * var_x64 + 269964.43697145121 * var_x65);
        const double var_x71 = pow(var_chaste_interface__Na__Na_ss_sr, 3);
        const double var_x72 = var_x63 * var_x71;
        const double var_x73 = var_x58 * var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x74 = pow(var_chaste_interface__Ca__Ca_ss_sr, (-2));
        const double var_x75 = 1.0 + 1.5624999999999999e-8 * var_x74;
        const double var_x76 = 1 / var_x75;
        const double var_x77 = 1 / (13227.9606 + 8.4084932990912282 * var_x71 + 4344355.375 * var_chaste_interface__Ca__Ca_ss_sr);
        const double var_x78 = var_x76 * var_x77;
        const double var_x79 = var_x78 * (0.016374794866024663 * var_x72 + 67491.109242862804 * var_x73);
        const double var_x80 = pow(var_chaste_interface__Ito1_a_gate__a, 3);
        const double var_x81 = exp(0.0018181818181818182 * var_chaste_interface__membrane__Vm);
        const double var_x82 = var_x80 * var_x81 * var_chaste_interface__Ito1_i1s_gate__i1s;
        const double var_x83 = 0.4975 * var_x82;
        const double var_x84 = (var_chaste_interface__ICaL__O + var_chaste_interface__ICaL__O_star) * NV_Ith_S(mParameters, 0);
        const double var_x85 = 14448.603861345418 * var_x84;
        const double var_x86 = -0.61380000000000001 + var_x37 * var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x87 = var_x36 * var_x86;
        const double var_x88 = var_x85 * var_x87;
        const double var_x89 = var_x36 * var_x50;
        ...
        const double var_x92 = var_x25 * var_x30 / pow(var_x26, 2);
        const double var_x93 = 0.24326999999999999 * var_x55 - 0.51429999999999998 * var_x92 - var_x27 * (0.061749999999999999 * var_x29 + 0.039456396800000001 * var_x28);
        const double var_x94 = var_x24 * var_x41 / pow((var_x24 + 0.98039215686274506 * var_x31), 2);
        ...
        const double var_x100 = var_x62 * var_x97 * var_x98 / pow(var_x99, 2);
        ...
        const double var_x110 = var_x109 * var_x53;
        const double var_x111 = var_x41 * var_x43 * NV_Ith_S(mParameters, 2) * var_chaste_interface__IKr_xr_gate__xr / pow(var_x44, 2);
        const double var_x112 = var_x41 * var_chaste_interface__Ito1_i1f_gate__i1f;
        const double var_x113 = var_x112 * var_x82;
        const double var_x114 = 6.4800000000000004 * var_x64 - 9878400.0 * var_x65;
        const double var_x115 = var_x114 * var_x69;
        const double var_x116 = var_x58 / pow(var_x59, 2);
        const double var_x117 = 0.0087452036595870152 * var_x116;
        const double var_x118 = 1.6200000000000001 * var_x72 - 2469600.0 * var_x73;
        const double var_x119 = var_x118 * var_x78;
        const double var_x120 = 1081.8149260630225 * var_x84;
        const double var_x121 = var_x51 * var_x86;
        const double var_x122 = var_x120 * var_x121;
        const double var_x123 = var_x105 * var_x108 * var_x53 / pow(var_x101, 2);
        const double var_x124 = var_x89 * var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x125 = var_x120 * var_x124;
        const double var_x126 = 0.00050000000000000001 + var_chaste_interface__Ca__Ca_i;
        const double var_x127 = 1 / var_x126;
        const double var_x128 = pow(var_x126, (-2));
        const double var_x129 = var_x128 * var_chaste_interface__Ca__Ca_i;
        const double var_x130 = var_x58 * var_x60;
        const double var_x131 = var_x130 * var_x69;
        const double var_x132 = 2.3018374734134173e-7 * var_x60;
        const double var_x133 = var_x114 * var_x67 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x62 + var_chaste_interface__Ca__Ca_i), 2);
        const double var_x134 = 3.1249999999999999e-8 * var_x60;
        const double var_x135 = var_x114 * var_x68 / (pow(var_x66, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
        const double var_x136 = 1 / (0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i);
        const double var_x137 = -26.711785007306684 * var_x19 * log10(7.9662000000000006 * var_x136) + var_chaste_interface__membrane__Vm;
        const double var_x138 = var_x137 * var_x3 * var_x4 * var_x8 / pow(var_x5, 2);
        const double var_x139 = var_x137 * var_x7;
        const double var_x140 = var_x87 * var_chaste_interface__membrane__Vm;
        const double var_x141 = var_x140 * NV_Ith_S(mParameters, 0);
        const double var_x142 = 14448.603861345418 * var_x141;
        const double var_x143 = -var_x142;
        const double var_x144 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x145 = var_x19 * log10(140.0 * var_x144);
        const double var_x146 = -26.711785007306684 * var_x145 + var_chaste_interface__membrane__Vm;
        const double var_x147 = var_x146 * NV_Ith_S(mParameters, 1) * var_chaste_interface__INa_h_gate__h;
        const double var_x148 = var_x147 * pow(var_chaste_interface__INa_m_gate__m, 2) * var_chaste_interface__INa_j_gate__j;
        const double var_x149 = var_x146 * var_x48;
        const double var_x150 = var_x147 * var_x47;
        const double var_x151 = var_x146 * pow(var_chaste_interface__INaL_mL_gate__mL, 2) * var_chaste_interface__INaL_hL_gate__hL;
        const double var_x152 = var_x112 * var_x81;
        const double var_x153 = var_x152 * pow(var_chaste_interface__Ito1_a_gate__a, 2) * var_chaste_interface__Ito1_i1s_gate__i1s;
        const double var_x154 = var_x152 * var_x80;
        const double var_x155 = var_x102 * var_x105 * var_chaste_interface__Irel__Irel * var_chaste_interface__Ito2_i2f_gate__i2f * var_chaste_interface__membrane__Vm / pow((0.16000000000000003 + var_x103), 2);
        const double var_x156 = var_x130 * var_x78;
        const double var_x157 = var_x118 * var_x76 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x71 + var_chaste_interface__Ca__Ca_ss_sr), 2);
        const double var_x158 = var_x118 * var_x77 / (pow(var_x75, 2) * pow(var_chaste_interface__Ca__Ca_ss_sr, 3));
        const double var_x159 = var_x85 * var_x89;
        const double var_x160 = 1 / var_x99;
        const double var_x161 = var_x160 * var_x62 / pow(var_x96, 4);
        const double var_x162 = var_x136 * var_x9;
        const double var_x163 = pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x164 = var_x160 * var_x163 * var_x97;
        const double var_x165 = var_x15 * var_x53;
        const double var_x166 = var_x10 * var_x144 * var_chaste_interface__INaL_hL_gate__hL;
        const double var_x167 = var_x133 * var_x60;
        const double var_x168 = var_x163 * var_x167;
        const double var_x169 = var_x144 * var_x49;
        const double var_x170 = var_x60 * var_x63;
        const double var_x171 = var_x163 * var_x170 * var_x69;
        const double var_x172 = pow(var_chaste_interface__Na__Na_ss_sr, 2);
        const double var_x173 = var_x157 * var_x60;
        const double var_x174 = var_x172 * var_x173;
        const double var_x175 = var_x170 * var_x172 * var_x78;
        const double var_x176 = 1 / var_chaste_interface__Cl__Cl_i;
        const double var_x177 = var_x109 * var_chaste_interface__membrane__Vm;
        const double var_x178 = var_x2 * var_x20;
        const double var_x179 = var_x20 * var_x33;
        const double var_x180 = var_x20 * var_x55;
        const double var_x181 = 6.4981759387274964 * var_x180 - var_x27 * (1.0539507884845836 * var_x20 * var_x28 + 1.6494527242011876 * var_x20 * var_x29) - 13.737871029257827 * var_x20 * var_x92;
        const double var_x182 = var_x20 * var_x45 * var_chaste_interface__IKr_xr_gate__xr;
        const double var_x183 = var_x180 * var_x56;
        const double var_x184 = var_x20 * var_x82 * var_chaste_interface__Ito1_i1f_gate__i1f;
        const double var_x185 = 0.0023800000000000002 + var_chaste_interface__Ca__Ca_i;
        const double var_x186 = 1.0 + 0.00011900000000000002 / pow(var_x185, 2) + 3.5000000000000004e-5 * var_x128;
        const double var_x187 = 1 / var_x186;
        const double var_x188 = 8.8930116629204303e-8 * var_x39;
        const double var_x189 = 6.1700941025231664e-5 * var_x60;
        const double var_x190 = var_x115 * var_x116;
        const double var_x191 = 1.7739020544754105e-6 * var_x127;
        ...
        const double var_x208 = var_x135 * var_x60;
        const double var_x209 = var_x192 * var_x74 / pow(var_x193, 2);
        ...
        const double var_x452 = var_x451 * var_x88;
        ...
        const double var_x457 = -var_x142 * var_x456;
        ...
        const double var_x460 = var_x140 * var_x455 * var_x84;
        ...
        const double var_x477 = 0.0020916619007553534 * var_x60;
        const double var_x478 = var_x116 * var_x119;
        const double var_x479 = var_x158 * var_x60;
        ...
        const double var_x484 = 151.10797107941448 * var_x84;
        const double var_x485 = 11.313955322572472 * var_x84;
        const double var_x486 = -151.10797107941448 * var_x141 * var_x483;
        const double var_x487 = 4.0105611666400582e-7 * var_x10;
        const double var_x488 = var_x19 * log10(100.0 * var_x176);
        const double var_x489 = var_x145 + var_x488;
        ...
        const double var_x493 = var_x144 * var_x491 - var_x144 * var_x492;
        const double var_x494 = var_x176 * var_x491 - var_x176 * var_x492;
        const double var_x495 = var_x40 + 26.711785007306684 * var_x488;
        const double var_x496 = 0.00047279859462932828 / (87.825100000000006 + var_x495);
        const double var_x497 = 6.1296950776416711e-8 * var_x495 / pow((1 + 0.30414750461208334 * var_x21 + 0.30414750461208334 * var_x488), 2);
        const double var_x498 = var_x176 * var_x497 - var_x176 * var_x496;
        const double var_x499 = var_x20 * var_x497 - var_x20 * var_x496;
        const double var_x500 = 6.799858698573652e-6 * var_x106;
        const double var_x501 = -5.0964977286841363e-6 - 3.0578986372104813e-6 * var_x6;
        const double var_x502 = var_x501 * var_x8;
        const double var_x503 = 6.1700941025231664e-5 * var_x45;
        const double var_x504 = 3.0696218160052752e-5 * var_x82;
        const double var_x505 = 3.0245559326093954e-5 * var_x94;
        const double var_x506 = var_x137 * var_x501;
        const double var_x507 = var_x136 * var_x502;
        const double var_x508 = 0.0025000000000000005 * var_x194;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00022499999999999999 + var_x122 + var_x9 - var_x125 - var_x49 - var_x88 + 0.012170417918209005 * var_x110 + 0.064935064935064929 * var_x111 + 0.00021583116499495196 * var_x52 + 4.3272597042520909e-7 * var_x54 + 0.12163499999999999 * var_x57 - 0.0027599999999999999 * var_x2 - 0.00012170417918209004 * var_x123 - 1.1558883089076335e-5 * var_x18 - 0.00021583116499495196 * var_x90 - 4.3272597042520909e-7 * var_x91 - 0.00090454545454545453 * var_x113 - 0.51000000000000001 * var_x33 - 0.00233372538501551 * var_x100 - 0.0028826178386108462 * var_x39 - 0.00046153846153846147 * var_x42 - var_x107 * var_chaste_interface__Ito2_i2f_gate__i2f - var_x11 * var_chaste_interface__INaL_hL_gate__hL - var_x115 * var_x117 - var_x117 * var_x119 - var_x46 * var_chaste_interface__IKr_xr_gate__xr - var_x61 * var_x70 - var_x61 * var_x79 - var_x83 * var_chaste_interface__Ito1_i1f_gate__i1f - var_x93 * var_x95);
        IJth(rJacobian, 1, 0) = var_x187 * (-var_x188 + 6.6584929913802883e-9 * var_x52 + 5.3958729525381867e-7 * var_x190 - 6.6584929913802883e-9 * var_x90 + var_x189 * var_x70);
        ...
        IJth(rJacobian, 37, 0) = var_x455 * (-var_x452 + var_x122 * var_x451 - var_x125 * var_x451);
        IJth(rJacobian, 40, 0) = var_x476 * (1.8292009309104452e-5 * var_x478 + var_x477 * var_x79);
        IJth(rJacobian, 41, 0) = var_x483 * (var_x121 * var_x485 - var_x124 * var_x485 - var_x484 * var_x87);
        IJth(rJacobian, 42, 0) = 2.6699599581291967e-11 * var_x54 - 7.1319396379664657e-10 * var_x18 - 6.1700941025231664e-5 * var_x49 - 1.6187618857614559e-6 * var_x190 - 4.3197915704978414e-7 * var_x100 - 2.6699599581291967e-11 * var_x91 - var_x487 * var_chaste_interface__INaL_hL_gate__hL - 0.00018510282307569501 * var_x60 * var_x70;
        IJth(rJacobian, 43, 0) = -5.4876027927313356e-5 * var_x478 - 0.0062749857022660607 * var_x60 * var_x79;
        IJth(rJacobian, 44, 0) = 1.3882711730677125e-8;
        IJth(rJacobian, 45, 0) = 2.5456399475788057e-7 * var_x123 - 2.5456399475788059e-5 * var_x110 + var_x500 * var_chaste_interface__Ito2_i2f_gate__i2f;
        IJth(rJacobian, 46, 0) = var_x502 + 7.5049939616040537e-6 * var_x57 + 4.00655461202803e-6 * var_x111 + 2.8798610469985608e-7 * var_x100 - 2.8477357396260765e-8 * var_x42 - 3.1467479922868152e-5 * var_x33 - 1.7029459722963939e-7 * var_x2 - 5.5811305745550463e-8 * var_x113 - var_x503 * var_chaste_interface__IKr_xr_gate__xr - var_x504 * var_chaste_interface__Ito1_i1f_gate__i1f - var_x505 * var_x93;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.057500000000000002 * var_x129 + 9878400.0 * var_x131 - 0.057500000000000002 * var_x127 - 0.0028826178386108462 * var_x89 - 4.4973467007233054e-8 * var_x138 + var_x132 * var_x133 - var_x134 * var_x135);
        IJth(rJacobian, 1, 1) = var_x187 * (-0.014749262536873154 + var_x207 - var_x191 - var_x204 + 1.9281544070384897e-12 * var_x208 + 1.7739020544754105e-6 * var_x129 - 609.50657582364852 * var_x131 - 1.4202553819674954e-11 * var_x167 - 8.8930116629204303e-8 * var_x89) + (0.00023800000000000004 / pow(var_x185, 3) + 7.0000000000000007e-5 / pow(var_x126, 3)) * (2.3746312684365782e-5 * var_chaste_interface__Ca__Ca_NSR + 0.014749262536873154 * var_chaste_interface__Ca__Ca_ss_sr - 0.014749262536873154 * var_chaste_interface__Ca__Ca_i + var_x115 * var_x189 - var_x188 * var_chaste_interface__membrane__Vm - var_x191 * var_chaste_interface__Ca__Ca_i - var_x204 * var_chaste_interface__Ca__Ca_i) / pow(var_x186, 2);
        IJth(rJacobian, 39, 1) = -var_x471 + 0.0043750000000000004 * var_x203;
        IJth(rJacobian, 40, 1) = 5.0 * var_x476;
        IJth(rJacobian, 42, 1) = 4.2607661459024858e-11 * var_x167 + 1828.5197274709456 * var_x131 - 5.784463221115469e-12 * var_x208;
        IJth(rJacobian, 46, 1) = -2.774905235513489e-12 * var_x138;
        ...
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x139);
        ...
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x139);
        ...
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (var_x143);
        ...
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (var_x143);
        ...
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x148);
        IJth(rJacobian, 27, 27) = var_x381;
        IJth(rJacobian, 42, 27) = -0.00018510282307569501 * var_x148;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x149);
        ...
        IJth(rJacobian, 42, 28) = -6.1700941025231664e-5 * var_x149;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x150);
        IJth(rJacobian, 29, 29) = -((var_x382) ? (0) : (var_x394 * var_x395)) - ((var_x382) ? (0.29999999999999999 * var_x399) : (0.1212 * var_x403));
        IJth(rJacobian, 42, 29) = -6.1700941025231664e-5 * var_x150;
        IJth(rJacobian, 0, 30) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0195 * var_x151);
        IJth(rJacobian, 30, 30) = var_x381;
        IJth(rJacobian, 42, 30) = -1.2031683499920175e-6 * var_x151;
        IJth(rJacobian, 0, 31) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x146);
        IJth(rJacobian, 31, 31) = -0.0016666666666666668;
        IJth(rJacobian, 42, 31) = -var_x146 * var_x487;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x41 * var_x46);
        IJth(rJacobian, 32, 32) = -var_x416 - var_x417;
        IJth(rJacobian, 46, 32) = -var_x41 * var_x503;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-1.4924999999999999 * var_x153);
        IJth(rJacobian, 33, 33) = -var_x425 - var_x426;
        IJth(rJacobian, 46, 33) = -9.2088654480158264e-5 * var_x153;
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x41 * var_x83);
        IJth(rJacobian, 34, 34) = var_x439 - var_x437;
        IJth(rJacobian, 46, 34) = -var_x41 * var_x504;
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (-0.4975 * var_x154);
        IJth(rJacobian, 35, 35) = var_x439 - 0.0040000000000000001 / var_x441;
        IJth(rJacobian, 46, 35) = -3.0696218160052752e-5 * var_x154;
        ...
        IJth(rJacobian, 0, 37) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0010402994780168702 * var_x155);
        IJth(rJacobian, 37, 37) = -var_x455;
        IJth(rJacobian, 38, 37) = -var_x468;
        IJth(rJacobian, 40, 37) = 0.23999999999999996 * var_x476;
        IJth(rJacobian, 45, 37) = 2.175954783543569e-6 * var_x155;
        ...
        IJth(rJacobian, 0, 40) = mSetVoltageDerivativeToZero ? 0.0 : (2469600.0 * var_x156 + var_x132 * var_x157 - var_x134 * var_x158);
        ...
        IJth(rJacobian, 40, 40) = var_x476 * (-5.5 + 6.53644343986048e-11 * var_x479 - 4.8146657448698097e-10 * var_x173 - 5165.5682301054212 * var_x156) + (0.019557600000000001 / pow(var_x473, 3) + 8.1780000000000006e-5 / pow(var_x474, 3)) * (0.5 * var_chaste_interface__Ca__Ca_ss_CaL + 0.23999999999999996 * var_chaste_interface__Irel__Irel + 5.0 * var_chaste_interface__Ca__Ca_i - 5.5 * var_chaste_interface__Ca__Ca_ss_sr + var_x119 * var_x477) / pow(var_x475, 2);
        IJth(rJacobian, 41, 40) = 5.0 * var_x483;
        IJth(rJacobian, 43, 40) = 15496.704690316265 * var_x156 + 1.4443997234609428e-9 * var_x173 - 1.960933031958144e-10 * var_x479;
        IJth(rJacobian, 47, 40) = 3.7500000000000005e-6 * var_x196 * var_x209 + 1.8750000000000003e-7 * var_x74 * pow(var_x192, 2) / pow(var_x193, 3);
        IJth(rJacobian, 0, 41) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x159);
        ...
        IJth(rJacobian, 37, 41) = -var_x159 * var_x456;
        IJth(rJacobian, 40, 41) = 0.5 * var_x476;
        IJth(rJacobian, 41, 41) = var_x483 * (-5.0 - var_x484 * var_x89) + (0.019557600000000001 / pow(var_x480, 3) + 8.1780000000000006e-5 / pow(var_x481, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x140 * var_x484) / pow(var_x482, 2);
        IJth(rJacobian, 0, 42) = mSetVoltageDerivativeToZero ? 0.0 : (0.071928427789186525 * var_x161 + 1.3365608910938003e-12 * var_x168 + 0.48962701918393148 * var_x162 - 26.711785007306684 * var_x169 - 19.440000000000001 * var_x171 - 0.18701391225188496 * var_x164 - 1.1558883089076335e-5 * var_x165 - 0.17362660254749343 * var_x166);
        IJth(rJacobian, 1, 42) = var_x187 * (0.0011994662935305037 * var_x171 - 8.2467064718009662e-17 * var_x168);
        IJth(rJacobian, 42, 42) = -0.14749262536873156 + var_x493 + 2.4740119415402899e-16 * var_x168 + 1.3314155043174696e-5 * var_x161 - 3.4616803112254212e-5 * var_x164 - 7.1319396379664657e-10 * var_x165 - 0.0016481422714144972 * var_x169 - 1.0712924764194231e-5 * var_x166 - 0.0035983988805915112 * var_x171;
        IJth(rJacobian, 43, 42) = 5.0;
        IJth(rJacobian, 44, 42) = var_x493;
        IJth(rJacobian, 46, 42) = 2.3077868741502807e-5 * var_x164 + 0.48962701918393148 * var_x507 - 8.8761033621164642e-6 * var_x161;
        ...
        IJth(rJacobian, 0, 46) = mSetVoltageDerivativeToZero ? 0.0 : (3.2490879693637482 * var_x183 + 26.711785007306684 * var_x162 - 13.289113041135074 * var_x184 - 0.073724526620166445 * var_x178 - 26.711785007306684 * var_x182 - 13.623010353726409 * var_x179 - var_x181 * var_x95);
        IJth(rJacobian, 44, 46) = var_x499;
        IJth(rJacobian, 46, 46) = var_x499 + 0.00020047178518350236 * var_x183 + 26.711785007306684 * var_x507 - 4.5488726691040119e-6 * var_x178 - 0.00081995078002871237 * var_x184 - 0.0016481422714144972 * var_x182 - 0.0008405525584213936 * var_x179 - var_x181 * var_x505;
