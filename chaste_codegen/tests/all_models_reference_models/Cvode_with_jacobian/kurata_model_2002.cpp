...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellkurata_model_2002FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x101 = 26.099999999999998 - 0.57999999999999996 * var_chaste_interface__membrane__V;
        const double var_x102 = var_x101 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa;
        const double var_x103 = var_x102 * var_chaste_interface__L_type_calcium_channel_current_f_gate__f;
        const double var_x104 = var_x102 * var_chaste_interface__L_type_calcium_channel_current_d_gate__d;
        const double var_x105 = var_x101 * var_x82;
        const double var_x106 = 20.609999999999999 - 0.45800000000000002 * var_chaste_interface__membrane__V;
        const double var_x107 = var_x106 * var_chaste_interface__T_type_calcium_channel_current_f_gate__f;
        const double var_x108 = var_x106 * var_chaste_interface__T_type_calcium_channel_current_d_gate__d;
        const double var_x109 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ki;
        const double var_x110 = var_x96 * log10(5.4000000000000004 * var_x109);
        const double var_x111 = (0.72286170354868073 * var_x110 - 0.027046577588354045 * var_chaste_interface__membrane__V) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy;
        const double var_x112 = (1.0842925553230209 * var_x110 - 0.040569866382531065 * var_chaste_interface__membrane__V) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy;
        const double var_x113 = -26.726549826397882 * var_x110 + var_chaste_interface__membrane__V;
        const double var_x114 = var_x113 * var_x3;
        ...
        const double var_x116 = (-26.726549826397882 * var_x96 * log10(22.199999999999999 * var_x115) + var_chaste_interface__membrane__V) * var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n;
        const double var_x117 = 4.8107789687516185 * var_x110 - 0.17999999999999999 * var_chaste_interface__membrane__V;
        const double var_x118 = var_x117 * var_chaste_interface__AP_sensitive_currents_r_gate__r;
        const double var_x119 = var_x117 * var_chaste_interface__AP_sensitive_currents_q_gate__q;
        const double var_x120 = (-26.726549826397882 * var_x97 + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        const double var_x121 = var_x113 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        const double var_x122 = 0.56099999999999994 - 0.014999999999999999 * var_chaste_interface__membrane__V;
        const double var_x123 = var_x122 * var_chaste_interface__sustained_inward_current_qi_gate__qi;
        const double var_x124 = var_x122 * var_chaste_interface__sustained_inward_current_qa_gate__qa;
        ...
        const double var_x160 = -0.16666666666666666 * var_chaste_interface__membrane__V;
        const double var_x161 = exp(-2.3500000000000001 + var_x160);
        ...
        const double var_x179 = exp(6.0 + var_x178);
        ...
        const double var_x184 = 0.00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x185 = exp(-4.3833333333333337 + var_x160);
        ...
        const double var_x191 = exp(11.017857142857144 + 0.17857142857142858 * var_chaste_interface__membrane__V);
        ...
        const double var_x197 = exp(-2.1886792452830188 - 0.094339622641509441 * var_chaste_interface__membrane__V);
        ...
        const double var_x204 = 0.094339622641509441 * var_x197 / pow(var_x198, 2);
        ...
        const double var_x209 = exp(1.672514619883041 + 0.058479532163742687 * var_chaste_interface__membrane__V);
        ...
        const double var_x223 = 2.2222222222222223e-5 * var_x215;
        const double var_x224 = 0.0015555555555555557 * var_x217 / pow(var_x218, 2);
        const double var_x225 = 0.076923076923076927 * var_chaste_interface__membrane__V;
        const double var_x226 = exp(3.7692307692307692 + var_x225);
        ...
        const double var_x232 = exp(1.2866666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        ...
        const double var_x238 = exp(4.7407407407407405 + 0.07407407407407407 * var_chaste_interface__membrane__V);
        ...
        const double var_x245 = exp(-11.4 + var_x244);
        ...
        const double var_x261 = var_x255 + var_x257 + 0.00022900000000000001 * var_x260;
        const double var_x262 = 1 / var_x261;
        const double var_x263 = var_x258 / pow(var_x259, 2);
        const double var_x264 = pow((var_x256 + 0.52631578947368418 * var_x250), (-2));
        const double var_x265 = 9.5 * var_x256 + 0.071428571428571425 * var_x250;
        const double var_x266 = pow((var_x254 + 0.22580645161290322 * var_x253), (-2));
        const double var_x267 = -10.0 * var_x253 - 238.46153846153845 * var_x254;
        const double var_x268 = 1.0405827263267429e-7 * var_x266;
        ...
        const double var_x273 = 14.1174 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        ...
        const double var_x280 = 0.00014764809009680174 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x284 = 6.4032609285536579e-6 * NV_Ith_S(mParameters, 0);
        ...
        IJth(rJacobian, 1, 0) = (1 / var_x162 - var_chaste_interface__L_type_calcium_channel_current_d_gate__d) * (var_x166 - var_x169 - var_x172 - 0.0045719999999999997 * var_x164 * var_x173 / pow(var_x165, 2) - 0.017658069883527455 * var_x170 * var_chaste_interface__membrane__V / pow(var_x171, 2) - 0.011356 * var_x167 * var_x174 / pow(var_x168, 2)) + 0.16666666666666666 * var_x161 * (var_x175 - var_x176 - var_x177) / pow(var_x162, 2);
        IJth(rJacobian, 2, 0) = -0.20000000000000001 * var_x179 * var_x182 / pow(var_x180, 2) - 0.0038895371450797353 * var_x181 * (-0.33642151027379535 - 0.010351431085347548 * var_chaste_interface__membrane__V) * (1 / var_x180 - var_chaste_interface__L_type_calcium_channel_current_f_gate__f) / pow((0.17230649552703226 + var_x181), 2);
        IJth(rJacobian, 4, 0) = (1 / var_x186 - var_chaste_interface__T_type_calcium_channel_current_d_gate__d) * (0.0356 * var_x187 - 0.0356 * var_x188) + 0.16666666666666666 * var_x185 * (var_x189 + var_x190) / pow(var_x186, 2);
        IJth(rJacobian, 5, 0) = (1 / var_x192 - var_chaste_interface__T_type_calcium_channel_current_f_gate__f) * (0.00097529258777633281 * var_x193 - 0.00018367346938775509 * var_x194) - 0.17857142857142858 * var_x191 * (var_x195 + var_x196) / pow(var_x192, 2);
        IJth(rJacobian, 6, 0) = var_x204 * (var_x202 + var_x203) + (var_x199 - var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS) * (0.00029184075413518645 * var_x200 - 8.2031958007575546e-6 * var_x201);
        IJth(rJacobian, 7, 0) = var_x204 * (var_x207 + var_x208) + (var_x199 - var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF) * (0.0027637030984589985 * var_x205 - 5.0400434999854427e-5 * var_x206);
        IJth(rJacobian, 8, 0) = (1 / var_x210 - var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy) * (0.0061795265502981441 * var_x211 - 0.0018299935950224174 * var_x212) - 0.058479532163742687 * var_x209 * (var_x213 + var_x214) / pow(var_x210, 2);
        IJth(rJacobian, 9, 0) = var_x221 * (var_x222 * var_x224 + 71.428571428571431 * var_x219 * (var_x223 - var_x224) / pow((var_x219 + 0.071428571428571425 * var_x215), 2)) + (var_x224 - var_x223) * (-var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n + var_x220 * var_x222);
        IJth(rJacobian, 10, 0) = -0.076923076923076927 * var_x226 * var_x231 / pow(var_x227, 2) - 0.078713879440468384 * (1 / var_x227 - var_chaste_interface__AP_sensitive_currents_q_gate__q) * (0.045599999999999995 * var_x229 - 0.0065000000000000006 * var_x228) / (pow((0.15497928494706154 + var_x230), 2) * pow((var_x229 + 0.11403508771929825 * var_x228), 2));
        IJth(rJacobian, 11, 0) = 0.066666666666666666 * var_x232 * var_x237 / pow(var_x233, 2) - 0.064554184748538135 * (1 / var_x233 - var_chaste_interface__AP_sensitive_currents_r_gate__r) * (0.04428 * var_x235 - 0.093329999999999996 * var_x234) / (pow((0.19114817190506736 + var_x236), 2) * pow((var_x234 + 0.35583413693346194 * var_x235), 2));
        IJth(rJacobian, 12, 0) = (1 / var_x239 - var_chaste_interface__hyperpolarisation_activated_current_y_gate__y) * (0.0725586626489447 * var_x240 - 0.030801634395873377 * var_x241) - 0.07407407407407407 * var_x238 * (var_x242 + var_x243) / pow(var_x239, 2);
        IJth(rJacobian, 13, 0) = (1 / var_x246 - var_chaste_interface__sustained_inward_current_qa_gate__qa) * (0.00390625 * (-2.0 * var_x248 - 0.29999999999999999 * var_x247) / pow((var_x248 + 0.9375 * var_x247), 2) + 24.999999999999996 * (0.013636363636363636 * var_x249 + 0.00028571428571428574 * var_x250) / pow((var_x250 + 0.74999999999999989 * var_x249), 2)) + 0.20000000000000001 * var_x245 * (var_x251 + var_x252) / pow(var_x246, 2);
        IJth(rJacobian, 14, 0) = (-var_chaste_interface__sustained_inward_current_qi_gate__qi + var_x255 * var_x262) * (6.8872180451127816e-6 * var_x263 + 1.6662153999958345e-5 * var_x264 * var_x265 + 1.5647860546266811e-8 * var_x266 * var_x267) + (var_x255 * (-4.5800000000000002e-5 * var_x263 - var_x267 * var_x268 - 0.00011080332409972299 * var_x264 * var_x265) / pow(var_x261, 2) + var_x262 * var_x267 * var_x268) * (var_x269 + var_x270 + var_x271);
        IJth(rJacobian, 18, 0) = (-6.7622825264335192e-5 * var_x81 - 8.5635892256145002e-5 * var_x83 + var_x278 * var_x66 + var_x279 * var_x89) * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 19, 0) = (-3.4577609014189752e-8 - 1.9243200158333837e-6 * var_x100 - 9.6048913928304863e-8 * var_x79 - 9.2038871771798129e-7 * var_x0 - var_x282 * var_x66 - var_x283 * var_x89) * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 20, 0) = (1.282880010555589e-6 * var_x100 + 6.4032609285536579e-6 * var_x4 - 2.8413595095158507e-9 * var_x2 - 1.2806521857107316e-7 * var_chaste_interface__AP_sensitive_currents_r_gate__r - 1.6584445804953973e-7 * var_x1 - 1.4808341304896403e-6 * var_x0 - 1.1525869671396584e-6 * var_x80) * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x103);
        IJth(rJacobian, 1, 1) = var_x176 + var_x177 - var_x175;
        IJth(rJacobian, 18, 1) = var_x103 * var_x280;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x104);
        IJth(rJacobian, 2, 2) = -var_x182;
        IJth(rJacobian, 18, 2) = var_x104 * var_x280;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (var_x105);
        IJth(rJacobian, 3, 3) = -0.021000000000000001 - var_x183;
        IJth(rJacobian, 18, 3) = var_x105 * var_x280;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x107);
        IJth(rJacobian, 4, 4) = -var_x189 - var_x190;
        IJth(rJacobian, 18, 4) = var_x107 * var_x280;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x108);
        IJth(rJacobian, 5, 5) = -var_x195 - var_x196;
        IJth(rJacobian, 18, 5) = var_x108 * var_x280;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x111);
        IJth(rJacobian, 6, 6) = -var_x202 - var_x203;
        IJth(rJacobian, 20, 6) = var_x111 * var_x284;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x112);
        IJth(rJacobian, 7, 7) = -var_x207 - var_x208;
        IJth(rJacobian, 20, 7) = var_x112 * var_x284;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x114);
        IJth(rJacobian, 8, 8) = -var_x213 - var_x214;
        IJth(rJacobian, 20, 8) = var_x114 * var_x284;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.051799999999999999 * var_x116);
        IJth(rJacobian, 9, 9) = -var_x216 - var_x220;
        IJth(rJacobian, 20, 9) = -3.3168891609907947e-7 * var_x116 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x118);
        IJth(rJacobian, 10, 10) = -var_x231;
        IJth(rJacobian, 20, 10) = var_x118 * var_x284;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x119 + 0.53453099652795766 * var_x110 - 0.02 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 11, 11) = -var_x237;
        IJth(rJacobian, 20, 11) = (3.4227414451683221e-6 * var_x110 + 6.4032609285536579e-6 * var_x119 - 1.2806521857107316e-7 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-0.28747499999999998 * var_x120 - 0.46252500000000002 * var_x121);
        IJth(rJacobian, 12, 12) = -var_x242 - var_x243;
        IJth(rJacobian, 19, 12) = -1.8407774354359626e-6 * var_x120 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 20, 12) = -2.9616682609792806e-6 * var_x121 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x123);
        IJth(rJacobian, 13, 13) = -var_x251 - var_x252;
        IJth(rJacobian, 19, 13) = var_x123 * var_x284;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x124);
        IJth(rJacobian, 14, 14) = -var_x269 - var_x270 - var_x271;
        IJth(rJacobian, 19, 14) = var_x124 * var_x284;
        IJth(rJacobian, 15, 15) = -27.670820618882221 + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMi + 2.7527999999999997 * var_chaste_interface__calcium_buffering__fTC + 14.1174 * var_chaste_interface__calcium_buffering__fTMC + 14.1174 * var_chaste_interface__calcium_buffering__fTMM - 7.7327439216924522e-8 * var_x272;
        IJth(rJacobian, 16, 15) = 2.9999999999999997e-6 * var_x272;
        ...
        IJth(rJacobian, 17, 17) = -5.3566666666666674 - var_x276 + 5.3399999999999999 * var_chaste_interface__calcium_buffering__fCQ;
        ...
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x133 * var_x78 - var_x137 * var_x91);
        IJth(rJacobian, 3, 18) = 0.021000000000000001 / var_x184 - 60.0 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa - 0.00035 * (0.021000000000000001 + var_x183) / pow(var_x184, 2);
        IJth(rJacobian, 15, 18) = 0.55412061888222286;
        IJth(rJacobian, 17, 18) = var_x276 - 1.4399999999999998e-6 * var_x277;
        IJth(rJacobian, 18, 18) = -35.246499999999997 - var_x281 + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMs + 1.7323243489657528e-7 * var_x277 + (var_x133 * var_x278 + var_x137 * var_x279) * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 19, 18) = (-var_x133 * var_x282 - var_x137 * var_x283) * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 23, 18) = 227.69999999999999 - 227.69999999999999 * var_chaste_interface__calcium_buffering__fCMs;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-0.14432336906254858 * var_x92 - 0.12643083428112081 * var_x154 - 0.083066116860444614 * var_x151 - 2.6773043380529855 * var_x155 - 3.8416074556718653 * var_x152 - var_x150 * var_x78 - var_x153 * var_x91);
        IJth(rJacobian, 18, 19) = (var_x150 * var_x278 + var_x153 * var_x279) * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 19, 19) = (-2.4598814923744084e-5 * var_x152 - 2.4287088639502301e-6 * var_x154 - 5.1430434785105685e-5 * var_x155 - 9.2414019019544699e-7 * var_x92 - var_x150 * var_x282 - var_x153 * var_x283) * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 20, 19) = (3.4286956523403795e-5 * var_x155 + 1.6191392426334868e-6 * var_x154 - 5.3189402057915725e-7 * var_x151) * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0021962113249247841 + 26.726549826397882 * var_x158 - 6.1808487292273409 * var_x156 - 0.53453099652795766 * var_x157 - 4.8107789687516185 * var_x159 - 0.69221764050370516 * var_x151);
        IJth(rJacobian, 20, 20) = (-1.406291416773793e-8 + 0.0001711370722584161 * var_x158 - 4.4324501714929775e-6 * var_x151 - 3.4227414451683221e-6 * var_x157 - 3.0804673006514896e-5 * var_x159 - 3.9577587173161957e-5 * var_x156) * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 15, 21) = var_x273;
        IJth(rJacobian, 21, 21) = -6.4435000000000002;
        IJth(rJacobian, 25, 21) = var_x285;
        IJth(rJacobian, 15, 22) = 0.024390000000000002 + 10.246499999999999 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        IJth(rJacobian, 22, 22) = -0.54200000000000004 + var_x285;
        ...
        IJth(rJacobian, 15, 25) = 0.00046562000000000003 + var_x273;
        IJth(rJacobian, 21, 25) = -5.6925000000000008;
        IJth(rJacobian, 25, 25) = -0.0075100000000000002 + var_x285;
