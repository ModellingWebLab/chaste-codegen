...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 8.5932353608719255e-11 * var_x125 + 1.7462713310839333e-5 * var_x116 + 0.00040588235294117644 * var_x159 - 0.030369936192764058 * var_x117 - 0.00011935049112322121 * var_x120 - 6.0944687335561951e-7 * var_x115 - 1.7462713310839333e-5 * var_x114 - 0.00040588235294117644 * var_x158;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.080000000000000002 * var_x165 - var_x164 * var_x166;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative3(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x169 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
            ...
            partialF = ((var_x170) ? (-310000.0 * var_x168 - 0.13500000000000001 * var_x169 - 3.5600000000000001 * var_x167) : (-7.6923076923076916 / var_x172));
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative4(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x187 = exp(-3.2000000000000002 + var_x161);
            const double var_x188 = 1.0 + var_x187;
            const double var_x189 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V);
            const double var_x190 = var_x189 / var_x188;
            
            partialF = ((var_x170) ? (-0.1212 * var_x184 - var_x180 * var_x185) : (-0.29999999999999999 * var_x190));
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative5(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x192 = exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V);
            const double var_x193 = 1.0 - var_x192;
            const double var_x194 = 1 / var_x193;
            const double var_x195 = 0.035000000000000003 * var_x194;
            const double var_x196 = 1.0 + var_x192;
            ...
            const double var_x205 = var_x195 * var_x201;
            
            partialF = -var_x205 - var_x199 * var_x205;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x207 = 0.019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
            const double var_x208 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V);
            const double var_x209 = 1.0 + var_x208;
            const double var_x211 = exp(4.0767441860465121 + 0.11627906976744186 * var_chaste_interface__membrane__V);
            const double var_x212 = 1.0 + var_x211;
            const double var_x214 = -0.02 - var_x207;
            const double var_x215 = 1 / var_x212;
            const double var_x216 = 0.59999999999999998 / var_x209;
            const double var_x217 = var_x215 + var_x216;
            const double var_x219 = 1.0 - var_x215 - var_x216;
            
            partialF = var_x214 * var_x217 + var_x214 * var_x219;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x223 = 7.1899999999999999e-5 / var_x222;
            const double var_x224 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V);
            const double var_x225 = -1.0 + var_x224;
            const double var_x226 = 0.00013100000000000001 / var_x225;
            const double var_x227 = 30.0 + var_chaste_interface__membrane__V;
            
            partialF = -var_x223 * var_x227 - var_x226 * var_x227;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x228 = 1.9339199950521953e-8 * var_x17;
            const double var_x234 = var_x228 * var_x57;
            const double var_x235 = 5.1470588235294113e-7 * var_x142;
            const double var_x236 = 1.9339199950521953e-8 * var_x147;
            const double var_x237 = var_x21 * var_x236 - var_x21 * var_x235;
            
            partialF = var_x237 - 5.594554271400994e-8 * var_x109 - 0.54665885146975302 * var_x141 - 1.139681818874567e-6 * var_x65 - 0.080828497792522477 * var_x140 - 6.4825765265103909e-6 * var_x145 - var_x137 * var_x234;
        }
        else
        {
    ...
    double Cellluo_rudy_1994FromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x235 = 5.1470588235294113e-7 * var_x142;
            const double var_x236 = 1.9339199950521953e-8 * var_x147;
            const double var_x240 = 0.0012812882037032361 * var_x101;
            const double var_x241 = var_x12 * var_x236 - var_x12 * var_x235;
            
            partialF = var_x241 + 0.0084616719207093495 * var_x155 - 1.5996281101931733e-8 * var_x109 - 0.035478708262932285 * var_x152 - 9.808819343281279e-5 * var_x139 - 1.4791615096031613e-5 * var_x150 - var_x151 * var_x234 - var_x154 * var_x240;
        }
        else
        {
