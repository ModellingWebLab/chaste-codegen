...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x164 = exp(0.34849999999999998 * var_chaste_interface__cell__V);
            ...
            const double var_x167 = 310000.0 * var_x164;
            const double var_x168 = 2.7000000000000002 * var_x165;
            const double var_x169 = 0.057000000000000002 * var_x166;
            const double var_x172 = var_chaste_interface__cell__V < -40.0;
            const double var_x173 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V);
            const double var_x174 = 1.0 + var_x173;
            const double var_x175 = 1 / var_x174;
            
            partialF = ((var_x172) ? (-var_x167 - var_x168 - var_x169) : (-5.9230769230769234 * var_x175));
        }
        else
        {
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative16(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x180 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
            const double var_x181 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
            const double var_x182 = -25428.0 * var_x180 - 6.9480000000000002e-6 * var_x181;
            const double var_x183 = var_x179 * var_x182;
            const double var_x184 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V);
            const double var_x185 = 1.0 + var_x184;
            const double var_x186 = exp(-0.01052 * var_chaste_interface__cell__V);
            const double var_x187 = var_x186 / var_x185;
            const double var_x188 = 37.780000000000001 + var_chaste_interface__cell__V;
            const double var_x189 = 0.024240000000000001 * var_x187;
            const double var_x190 = var_x183 * var_x188;
            const double var_x191 = exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__cell__V);
            const double var_x192 = 1.0 + var_x191;
            const double var_x193 = exp(0.057000000000000002 * var_chaste_interface__cell__V);
            const double var_x194 = var_x193 / var_x192;
            
            partialF = ((var_x172) ? (-var_x189 - var_x190) : (-0.59999999999999998 * var_x194));
        }
        else
        {
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x11 = -0.050000000000000003 * var_chaste_interface__cell__V;
            const double var_x134 = 0.20000000000000001 * var_chaste_interface__cell__V;
            const double var_x195 = exp(2.5 + var_x11);
            const double var_x196 = 1.0 + var_x195;
            const double var_x197 = 1 / var_x196;
            const double var_x198 = exp(1.0 + var_x134);
            const double var_x199 = 1.0 + var_x198;
            const double var_x200 = 1 / var_x199;
            const double var_x201 = exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__cell__V);
            const double var_x202 = 1.0 + var_x201;
            const double var_x203 = 0.25 + 1.3999999999999999 / var_x202;
            const double var_x204 = var_x200 * var_x203;
            const double var_x207 = 1 / (var_x197 + 1.3999999999999999 * var_x204);
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x208 = 0.10000000000000001 * var_chaste_interface__cell__V;
            ...
            const double var_x213 = exp(1.3 + var_x212);
            const double var_x214 = 1.0 + var_x213;
            const double var_x215 = 1 / var_x214;
            const double var_x216 = pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2);
            const double var_x217 = exp(-3.2400000000000002 * var_x216);
            const double var_x222 = 275.625 * var_x217;
            const double var_x223 = 1 / (5.0 + var_x222 + 50.0 * var_x215 + 45.0 * var_x211);
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative19(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x212 = -var_x208;
            const double var_x216 = pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2);
            const double var_x224 = exp(2.5 + var_x212);
            const double var_x225 = 1.0 + var_x224;
            const double var_x226 = 1 / var_x225;
            const double var_x227 = exp(-3.0375000000000001 * var_x216);
            const double var_x230 = 281.0 * var_x227;
            const double var_x231 = 1 / (var_x230 + 40.0 * var_x211 + 15.5 * var_x226);
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative20(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x232 = pow(var_chaste_interface__Ca__Ca_ss, 2);
            const double var_x233 = 1 / (1.0 + 399.99999999999994 * var_x232);
            const double var_x234 = 1 / (2.0 + 80.0 * var_x233);
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative21(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x236 = 0.001 + var_chaste_interface__Ca__Ca_i;
            const double var_x237 = 1.0 + 0.00020000000000000001 / pow(var_x236, 2);
            const double var_x238 = 1 / var_x237;
            const double var_x239 = 2.2487821987979791e-6 * var_x71;
            const double var_x240 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__Ca__Ca_i, 2);
            const double var_x241 = 1 / (pow(var_x240, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
            const double var_x242 = 1 / var_x240;
            
            partialF = var_x238 * (-0.0038240087783467445 - var_x239 + 2.2487821987979791e-6 * var_x73 - 0.0086391412367010315 * var_x74 - 5.3144431236283834e-11 * var_x241 - 2.298124085635426e-7 * var_x72) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__Ca__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__Ca__Ca_SR - 0.0038240087783467445 * var_chaste_interface__Ca__Ca_i - 1.7205545223759661e-8 * var_chaste_interface__cell__V - 0.00042515544989027063 * var_x242 - var_x239 * var_chaste_interface__Ca__Ca_i + 1.2593500345045236e-9 * var_x27 * var_x35 + 2.298124085635426e-7 * var_x4 * log10(2.0 * var_x72)) / (pow(var_x236, 3) * pow(var_x237, 2));
        }
        else
        {
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative22(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x249 = var_x232 * var_x248;
            ...
            const double var_x257 = var_x232 * var_x251 * var_x254 * var_x256;
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative23(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x264 = 0.00025000000000000001 + var_chaste_interface__Ca__Ca_ss;
            const double var_x265 = 1.0 + 0.0001 / pow(var_x264, 2);
            const double var_x266 = 1 / var_x265;
            const double var_x267 = 0.0031491568724328674 * var_x48;
            const double var_x268 = var_x267 * var_x46;
            const double var_x272 = 0.91833577176298453 * var_x252;
            
            partialF = var_x266 * (-1.1399999999999999 - var_x272 + 1.8366715435259691 * var_x262 - 0.00078728921810821686 * var_x75 - 1.9591163130943672 * var_x261) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__Ca__Ca_i - 1.1399999999999999 * var_chaste_interface__Ca__Ca_ss + var_x255 * var_x272 - var_x268 * var_x50) / (pow(var_x264, 3) * pow(var_x265, 2));
        }
        else
        {
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative24(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x246 = pow(var_chaste_interface__Ca__Ca_SR, (-2));
            const double var_x247 = 1 / (1.0 + 2.25 * var_x246);
            const double var_x273 = -0.11249999999999999 + 0.067500000000000004 * var_x247;
            
            partialF = -0.0050000000000000001 + var_x273 * var_chaste_interface__Ca__Ca_ss;
        }
        else
        {
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative25(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 1.4908768645188767e-7 * var_x79 - 5.6288512232624455e-7 * var_x61 - 0.021350814984788587 * var_x81 - 2.2668300621081427e-8 * var_x80 - 0.00023854029832302029 * var_x78;
        }
        else
        {
    ...
    double Cellfink_noble_giles_model_2008FromCellMLGRL2::EvaluatePartialDerivative26(double var_chaste_interface__Environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x275 = 1.0050926558006126e-5 * var_x22;
            const double var_x276 = -4.3801480314950888e-5 * var_x55 - 5.7589183215629007e-6 * var_x54;
            
            partialF = -4.6583596330447822e-5 * var_x86 - 7.6086540673064781e-5 * var_x76 - 1.8885766345635723e-5 * var_x87 - 0.00038819663608706523 * var_x88 + var_x276 * var_x85 + var_x7 * (6.576305692690868e-7 * var_x82 - 9.8566502268897146e-6 * var_x84 - var_x275 * var_x83);
        }
        else
        {
