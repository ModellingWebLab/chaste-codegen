...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmahajan_2008FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__Environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double var_IKr__taukr = (((fabs(7.0 + var_chaste_interface__cell__V) > 0.001) && (fabs(10.0 + var_chaste_interface__cell__V) > 0.001)) ? (1.0 / (0.00060999999999999997 * (10.0 + var_chaste_interface__cell__V) / (-1.0 + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V)) + 0.0013799999999999999 * (7.0 + var_chaste_interface__cell__V) / (1.0 - exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V)))) : ((fabs(7.0 + var_chaste_interface__cell__V) > 0.001) ? (1.0 / (0.0042068965517241376 + 0.0013799999999999999 * (7.0 + var_chaste_interface__cell__V) / (1.0 - exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V)))) : ((fabs(10.0 + var_chaste_interface__cell__V) > 0.001) ? (1.0 / (0.011219512195121951 + 0.00060999999999999997 * (10.0 + var_chaste_interface__cell__V) / (-1.0 + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V)))) : (64.823901428415653)))); // ms
        ...
        const double var_IKs__tauxs2 = ((fabs(30.0 + var_chaste_interface__cell__V) < 0.014556040756914121) ? (1671.7850106443193) : (4.0 / (0.00013100000000000001 * (30.0 + var_chaste_interface__cell__V) / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V)) + 7.1899999999999999e-5 * (30.0 + var_chaste_interface__cell__V) / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V))))); // ms
        ...
        const double d_dt_chaste_interface_var_Ca__Ca_submem = ((fabs(0.075353936071760372 * var_chaste_interface__cell__V) < 0.001) ? (1.0 * (50.0 * var_chaste_interface__Irel__xir + 12500.0 * var_chaste_interface__Ca__Ca_i_converted + 0.019599999999999999 * var_chaste_interface__Ca__trops - 12.5 * var_chaste_interface__Ca__Ca_submem - 9100.0 * (-0.063960518821716009 + 0.00010420416882000001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) - 0.0327 * (70.0 - var_chaste_interface__Ca__trops) * var_chaste_interface__Ca__Ca_submem + 42.0 * (1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(0.013186938812558063 * var_chaste_interface__cell__V) - 2515.4560000000001 * var_chaste_interface__Ca__Ca_submem * exp(-0.024490029223322121 * var_chaste_interface__cell__V)) / ((1.0 + 0.20000000000000001 * exp(-0.024490029223322121 * var_chaste_interface__cell__V)) * (1.0 + 0.026999999999999996 / pow(var_chaste_interface__Ca__Ca_submem, 3)) * (12405.2022 + 7.9663561662386391 * pow(var_chaste_interface__Na__Na_i, 3) + 4115.8113750000002 * var_chaste_interface__Ca__Ca_submem))) / (1.0 + 4.5 / pow((0.29999999999999999 + var_chaste_interface__Ca__Ca_submem), 2) + 3.2307692307692308 / pow((1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem), 2) + 28.199999999999999 / pow((0.59999999999999998 + var_chaste_interface__Ca__Ca_submem), 2) + 3.4285714285714284 / pow((1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem), 2))) : (1.0 * (50.0 * var_chaste_interface__Irel__xir + 12500.0 * var_chaste_interface__Ca__Ca_i_converted + 0.019599999999999999 * var_chaste_interface__Ca__trops - 12.5 * var_chaste_interface__Ca__Ca_submem - 0.0327 * (70.0 - var_chaste_interface__Ca__trops) * var_chaste_interface__Ca__Ca_submem + 42.0 * (1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(0.013186938812558063 * var_chaste_interface__cell__V) - 2515.4560000000001 * var_chaste_interface__Ca__Ca_submem * exp(-0.024490029223322121 * var_chaste_interface__cell__V)) / ((1.0 + 0.20000000000000001 * exp(-0.024490029223322121 * var_chaste_interface__cell__V)) * (1.0 + 0.026999999999999996 / pow(var_chaste_interface__Ca__Ca_submem, 3)) * (12405.2022 + 7.9663561662386391 * pow(var_chaste_interface__Na__Na_i, 3) + 4115.8113750000002 * var_chaste_interface__Ca__Ca_submem)) - 71.454967908626173 * (-0.61380000000000001 + 0.001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * var_chaste_interface__cell__V / (-1.0 + exp(0.075353936071760372 * var_chaste_interface__cell__V))) / (1.0 + 4.5 / pow((0.29999999999999999 + var_chaste_interface__Ca__Ca_submem), 2) + 3.2307692307692308 / pow((1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem), 2) + 28.199999999999999 / pow((0.59999999999999998 + var_chaste_interface__Ca__Ca_submem), 2) + 3.4285714285714284 / pow((1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem), 2)))); // uM / ms
        const double d_dt_chaste_interface_var_Irel__xir = (((var_chaste_interface__Irel__Ca_JSR > 50.0) && (var_chaste_interface__Irel__Ca_JSR < 90.0) && (fabs(0.075353936071760372 * var_chaste_interface__cell__V) < 0.001)) ? (-0.033333333333333333 * (1.0 - 30.0 * (-var_chaste_interface__Irel__xir + 400000.0 * pow(var_chaste_interface__Ca__Ca_i_converted, 2) / (0.25 + 1000000.0 * pow(var_chaste_interface__Ca__Ca_i_converted, 2)) - 2.069e-5 * pow(var_chaste_interface__Ca__Ca_NSR, 2) * (16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted) / (2500.0 + pow(var_chaste_interface__Ca__Ca_NSR, 2))) / var_chaste_interface__Ca__Ca_NSR) * var_chaste_interface__Irel__xir + 0.028675444444444444 * (-50.0 + 1.0 * var_chaste_interface__Irel__Ca_JSR) * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * var_chaste_interface__Ca__Ca_NSR * fabs(-0.063960518821716009 + 0.00010420416882000001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V) / (1.0 + exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V))) : (((var_chaste_interface__Irel__Ca_JSR >= 90.0) && (fabs(0.075353936071760372 * var_chaste_interface__cell__V) < 0.001)) ? (-0.033333333333333333 * (1.0 - 30.0 * (-var_chaste_interface__Irel__xir + 400000.0 * pow(var_chaste_interface__Ca__Ca_i_converted, 2) / (0.25 + 1000000.0 * pow(var_chaste_interface__Ca__Ca_i_converted, 2)) - 2.069e-5 * pow(var_chaste_interface__Ca__Ca_NSR, 2) * (16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted) / (2500.0 + pow(var_chaste_interface__Ca__Ca_NSR, 2))) / var_chaste_interface__Ca__Ca_NSR) * var_chaste_interface__Irel__xir + 0.028675444444444444 * (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR) * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * var_chaste_interface__Ca__Ca_NSR * fabs(-0.063960518821716009 + 0.00010420416882000001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V) / (1.0 + exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V))) : ((fabs(0.075353936071760372 * var_chaste_interface__cell__V) < 0.001) ? (-0.033333333333333333 * (1.0 - 30.0 * (-var_chaste_interface__Irel__xir + 400000.0 * pow(var_chaste_interface__Ca__Ca_i_converted, 2) / (0.25 + 1000000.0 * pow(var_chaste_interface__Ca__Ca_i_converted, 2)) - 2.069e-5 * pow(var_chaste_interface__Ca__Ca_NSR, 2) * (16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted) / (2500.0 + pow(var_chaste_interface__Ca__Ca_NSR, 2))) / var_chaste_interface__Ca__Ca_NSR) * var_chaste_interface__Irel__xir) : (((var_chaste_interface__Irel__Ca_JSR > 50.0) && (var_chaste_interface__Irel__Ca_JSR < 90.0)) ? (-0.033333333333333333 * (1.0 - 30.0 * (-var_chaste_interface__Irel__xir + 400000.0 * pow(var_chaste_interface__Ca__Ca_i_converted, 2) / (0.25 + 1000000.0 * pow(var_chaste_interface__Ca__Ca_i_converted, 2)) - 2.069e-5 * pow(var_chaste_interface__Ca__Ca_NSR, 2) * (16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted) / (2500.0 + pow(var_chaste_interface__Ca__Ca_NSR, 2))) / var_chaste_interface__Ca__Ca_NSR) * var_chaste_interface__Irel__xir + 0.028675444444444444 * (-50.0 + 1.0 * var_chaste_interface__Irel__Ca_JSR) * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * var_chaste_interface__Ca__Ca_NSR * fabs(0.0078521942756732046 * (-0.61380000000000001 + 0.001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(0.075353936071760372 * var_chaste_interface__cell__V))) * exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V) / (1.0 + exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V))) : ((var_chaste_interface__Irel__Ca_JSR >= 90.0) ? (-0.033333333333333333 * (1.0 - 30.0 * (-var_chaste_interface__Irel__xir + 400000.0 * pow(var_chaste_interface__Ca__Ca_i_converted, 2) / (0.25 + 1000000.0 * pow(var_chaste_interface__Ca__Ca_i_converted, 2)) - 2.069e-5 * pow(var_chaste_interface__Ca__Ca_NSR, 2) * (16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted) / (2500.0 + pow(var_chaste_interface__Ca__Ca_NSR, 2))) / var_chaste_interface__Ca__Ca_NSR) * var_chaste_interface__Irel__xir + 0.028675444444444444 * (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR) * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * var_chaste_interface__Ca__Ca_NSR * fabs(0.0078521942756732046 * (-0.61380000000000001 + 0.001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(0.075353936071760372 * var_chaste_interface__cell__V))) * exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V) / (1.0 + exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V))) : (-0.033333333333333333 * (1.0 - 30.0 * (-var_chaste_interface__Irel__xir + 400000.0 * pow(var_chaste_interface__Ca__Ca_i_converted, 2) / (0.25 + 1000000.0 * pow(var_chaste_interface__Ca__Ca_i_converted, 2)) - 2.069e-5 * pow(var_chaste_interface__Ca__Ca_NSR, 2) * (16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted) / (2500.0 + pow(var_chaste_interface__Ca__Ca_NSR, 2))) / var_chaste_interface__Ca__Ca_NSR) * var_chaste_interface__Irel__xir)))))); // uM_per_ms / ms
        const double d_dt_chaste_interface_var_Ca__Ca_dyad = (((var_chaste_interface__Irel__Ca_JSR > 50.0) && (var_chaste_interface__Irel__Ca_JSR < 90.0) && (fabs(0.075353936071760372 * var_chaste_interface__cell__V) < 0.001)) ? (2.0 * var_chaste_interface__Ca__Ca_submem - 2.0 * var_chaste_interface__Ca__Ca_dyad + 9000.0 * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * fabs(-0.063960518821716009 + 0.00010420416882000001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) + 298.24222222222221 * (-50.0 + 1.0 * var_chaste_interface__Irel__Ca_JSR) * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * var_chaste_interface__Ca__Ca_NSR * fabs(-0.063960518821716009 + 0.00010420416882000001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V) / (1.0 + exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V))) : (((var_chaste_interface__Irel__Ca_JSR >= 90.0) && (fabs(0.075353936071760372 * var_chaste_interface__cell__V) < 0.001)) ? (2.0 * var_chaste_interface__Ca__Ca_submem - 2.0 * var_chaste_interface__Ca__Ca_dyad + 9000.0 * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * fabs(-0.063960518821716009 + 0.00010420416882000001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) + 298.24222222222221 * (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR) * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * var_chaste_interface__Ca__Ca_NSR * fabs(-0.063960518821716009 + 0.00010420416882000001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V) / (1.0 + exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V))) : ((fabs(0.075353936071760372 * var_chaste_interface__cell__V) < 0.001) ? (2.0 * var_chaste_interface__Ca__Ca_submem - 2.0 * var_chaste_interface__Ca__Ca_dyad + 9000.0 * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * fabs(-0.063960518821716009 + 0.00010420416882000001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V))) : (((var_chaste_interface__Irel__Ca_JSR > 50.0) && (var_chaste_interface__Irel__Ca_JSR < 90.0)) ? (2.0 * var_chaste_interface__Ca__Ca_submem - 2.0 * var_chaste_interface__Ca__Ca_dyad + 9000.0 * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * fabs(0.0078521942756732046 * (-0.61380000000000001 + 0.001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(0.075353936071760372 * var_chaste_interface__cell__V))) + 298.24222222222221 * (-50.0 + 1.0 * var_chaste_interface__Irel__Ca_JSR) * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * var_chaste_interface__Ca__Ca_NSR * fabs(0.0078521942756732046 * (-0.61380000000000001 + 0.001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(0.075353936071760372 * var_chaste_interface__cell__V))) * exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V) / (1.0 + exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V))) : ((var_chaste_interface__Irel__Ca_JSR >= 90.0) ? (2.0 * var_chaste_interface__Ca__Ca_submem - 2.0 * var_chaste_interface__Ca__Ca_dyad + 9000.0 * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * fabs(0.0078521942756732046 * (-0.61380000000000001 + 0.001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(0.075353936071760372 * var_chaste_interface__cell__V))) + 298.24222222222221 * (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR) * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * var_chaste_interface__Ca__Ca_NSR * fabs(0.0078521942756732046 * (-0.61380000000000001 + 0.001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(0.075353936071760372 * var_chaste_interface__cell__V))) * exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V) / (1.0 + exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V))) : (2.0 * var_chaste_interface__Ca__Ca_submem - 2.0 * var_chaste_interface__Ca__Ca_dyad + 9000.0 * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * fabs(0.0078521942756732046 * (-0.61380000000000001 + 0.001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * var_chaste_interface__cell__V / (-1.0 + exp(0.075353936071760372 * var_chaste_interface__cell__V))))))))); // uM / ms
        ...
        {
            d_dt_chaste_interface_var_cell__V = ((fabs(0.075353936071760372 * var_chaste_interface__cell__V) < 0.001) ? (-GetIntracellularAreaStimulus(var_chaste_interface__Environment__time) / HeartConfig::Instance()->GetCapacitance() - 2912.0 * (-0.063960518821716009 + 0.00010420416882000001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) - 0.040000000000000001 * (86.398763985973389 + var_chaste_interface__cell__V) * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof - 1.173913043478261 * var_chaste_interface__Na__Na_i / ((12.0 + var_chaste_interface__Na__Na_i) * (1.0 + 0.1245 * exp(-0.0037676968035880187 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0208023774145616)) * exp(-0.037676968035880186 * var_chaste_interface__cell__V))) - 0.30599999999999999 * (86.398763985973389 + var_chaste_interface__cell__V) / ((1.0 + exp(6.4833277106546534 + 0.23849999999999999 * var_chaste_interface__cell__V)) * (1.02 / (1.0 + exp(6.4833277106546534 + 0.23849999999999999 * var_chaste_interface__cell__V)) + (1.0 * exp(-31.363518823866141 + 0.061749999999999999 * var_chaste_interface__cell__V) + 0.49124000000000001 * exp(7.3793810433533835 + 0.080320000000000003 * var_chaste_interface__cell__V)) / (1.0 + exp(-46.879352217986117 - 0.51429999999999998 * var_chaste_interface__cell__V)))) - 12.0 * pow(var_chaste_interface__INa__xm, 3) * (-26.541413816729872 * log(136.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__cell__V) * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj - 6.7199999999999998 * (1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(0.013186938812558063 * var_chaste_interface__cell__V) - 2515.4560000000001 * var_chaste_interface__Ca__Ca_submem * exp(-0.024490029223322121 * var_chaste_interface__cell__V)) / ((1.0 + 0.20000000000000001 * exp(-0.024490029223322121 * var_chaste_interface__cell__V)) * (1.0 + 0.026999999999999996 / pow(var_chaste_interface__Ca__Ca_submem, 3)) * (12405.2022 + 7.9663561662386391 * pow(var_chaste_interface__Na__Na_i, 3) + 4115.8113750000002 * var_chaste_interface__Ca__Ca_submem)) - 0.11 * (86.398763985973389 + var_chaste_interface__cell__V) * (0.5 / (1.0 + exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V)) + var_chaste_interface__Ito__ytos) * mParameters[2] * var_chaste_interface__Ito__xtos - 0.012500000000000001 * (86.398763985973389 + var_chaste_interface__cell__V) * mParameters[0] * var_chaste_interface__IKr__xr / (1.0 + exp(1.4732142857142858 + 0.044642857142857144 * var_chaste_interface__cell__V)) - 0.1386 * (1.0 + 0.80000000000000004 / (1.0 + 1.2500000000000001e-10 / pow(var_chaste_interface__Ca__Ca_i_converted, 3))) * (-26.541413816729872 * log(7.8928799999999999 / (140.0 + 0.018329999999999999 * var_chaste_interface__Na__Na_i)) + var_chaste_interface__cell__V) * mParameters[1] * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2) : (-GetIntracellularAreaStimulus(var_chaste_interface__Environment__time) / HeartConfig::Instance()->GetCapacitance() - 0.040000000000000001 * (86.398763985973389 + var_chaste_interface__cell__V) * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof - 1.173913043478261 * var_chaste_interface__Na__Na_i / ((12.0 + var_chaste_interface__Na__Na_i) * (1.0 + 0.1245 * exp(-0.0037676968035880187 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0208023774145616)) * exp(-0.037676968035880186 * var_chaste_interface__cell__V))) - 0.30599999999999999 * (86.398763985973389 + var_chaste_interface__cell__V) / ((1.0 + exp(6.4833277106546534 + 0.23849999999999999 * var_chaste_interface__cell__V)) * (1.02 / (1.0 + exp(6.4833277106546534 + 0.23849999999999999 * var_chaste_interface__cell__V)) + (1.0 * exp(-31.363518823866141 + 0.061749999999999999 * var_chaste_interface__cell__V) + 0.49124000000000001 * exp(7.3793810433533835 + 0.080320000000000003 * var_chaste_interface__cell__V)) / (1.0 + exp(-46.879352217986117 - 0.51429999999999998 * var_chaste_interface__cell__V)))) - 12.0 * pow(var_chaste_interface__INa__xm, 3) * (-26.541413816729872 * log(136.0 / var_chaste_interface__Na__Na_i) + var_chaste_interface__cell__V) * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj - 6.7199999999999998 * (1.8 * pow(var_chaste_interface__Na__Na_i, 3) * exp(0.013186938812558063 * var_chaste_interface__cell__V) - 2515.4560000000001 * var_chaste_interface__Ca__Ca_submem * exp(-0.024490029223322121 * var_chaste_interface__cell__V)) / ((1.0 + 0.20000000000000001 * exp(-0.024490029223322121 * var_chaste_interface__cell__V)) * (1.0 + 0.026999999999999996 / pow(var_chaste_interface__Ca__Ca_submem, 3)) * (12405.2022 + 7.9663561662386391 * pow(var_chaste_interface__Na__Na_i, 3) + 4115.8113750000002 * var_chaste_interface__Ca__Ca_submem)) - 0.11 * (86.398763985973389 + var_chaste_interface__cell__V) * (0.5 / (1.0 + exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V)) + var_chaste_interface__Ito__ytos) * mParameters[2] * var_chaste_interface__Ito__xtos - 22.865589730760373 * (-0.61380000000000001 + 0.001 * var_chaste_interface__Ca__Ca_submem * exp(0.075353936071760372 * var_chaste_interface__cell__V)) * (1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca) * var_chaste_interface__cell__V / (-1.0 + exp(0.075353936071760372 * var_chaste_interface__cell__V)) - 0.012500000000000001 * (86.398763985973389 + var_chaste_interface__cell__V) * mParameters[0] * var_chaste_interface__IKr__xr / (1.0 + exp(1.4732142857142858 + 0.044642857142857144 * var_chaste_interface__cell__V)) - 0.1386 * (1.0 + 0.80000000000000004 / (1.0 + 1.2500000000000001e-10 / pow(var_chaste_interface__Ca__Ca_i_converted, 3))) * (-26.541413816729872 * log(7.8928799999999999 / (140.0 + 0.018329999999999999 * var_chaste_interface__Na__Na_i)) + var_chaste_interface__cell__V) * mParameters[1] * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2)); // mV / ms
        }
