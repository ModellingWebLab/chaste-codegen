...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellcourtemanche_ramirez_nattel_model_1998FromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__K_i = 7.1133567825297815e-7 * mParameters[0] / ((1.0 + 31.622776601683793 * pow(1 / var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5)) * (1.0 + 0.1245 * exp(-0.0037435192301797956 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.037435192301797954 * var_chaste_interface__membrane__V))) - 6.8244881850197507e-8 * (-26.712831923985377 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * mParameters[0] / (1.0 + exp(5.6000000000000005 + 0.070000000000000007 * var_chaste_interface__membrane__V)) - 9.8129891902512382e-8 * pow(var_chaste_interface__slow_delayed_rectifier_K_current_xs_gate__xs, 2) * (-26.712831923985377 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * mParameters[0] - 1.2526727201836255e-7 * pow(var_chaste_interface__transient_outward_K_current_oa_gate__oa, 3) * (-26.712831923985377 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * mParameters[0] * var_chaste_interface__transient_outward_K_current_oi_gate__oi - 2.2302249193675268e-8 * (-26.712831923985377 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * mParameters[0] * var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr / (1.0 + exp(0.66964285714285721 + 0.044642857142857144 * var_chaste_interface__membrane__V)) - 7.5827646500219453e-7 * pow(var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ua_gate__ua, 3) * (0.0050000000000000001 + 0.050000000000000003 / (1.0 + exp(1.1538461538461537 - 0.076923076923076927 * var_chaste_interface__membrane__V))) * (-26.712831923985377 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * mParameters[0] * var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ui_gate__ui; // millimolar / millisecond
        ...
        {
            d_dt_chaste_interface_var_membrane__V = (-0.0011310000000000001 * (-13.356415961992688 * log(10) * log10(1.8 / var_chaste_interface__intracellular_ion_concentrations__Ca_i) + var_chaste_interface__membrane__V) * mParameters[0] - 0.00067443750000000002 * (-26.712831923985377 * log(10) * log10(140.0 / var_chaste_interface__intracellular_ion_concentrations__Na_i) + var_chaste_interface__membrane__V) * mParameters[0] - 0.12941175999999999 * pow(var_chaste_interface__slow_delayed_rectifier_K_current_xs_gate__xs, 2) * (-26.712831923985377 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * mParameters[0] - 0.27500000000000002 * var_chaste_interface__intracellular_ion_concentrations__Ca_i * mParameters[0] / (0.00050000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i) - 0.089999999999999997 * (-26.712831923985377 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * mParameters[0] / (1.0 + exp(5.6000000000000005 + 0.070000000000000007 * var_chaste_interface__membrane__V)) - 1.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) * mParameters[0] / HeartConfig::Instance()->GetCapacitance() - 0.46904770956521741 * mParameters[0] / ((1.0 + 31.622776601683793 * pow(1 / var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5)) * (1.0 + 0.1245 * exp(-0.0037435192301797956 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.037435192301797954 * var_chaste_interface__membrane__V))) - 0.00014738024843876965 * (1.8 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * exp(0.013102317305629283 * var_chaste_interface__membrane__V) - 2744000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i * exp(-0.024332874996168673 * var_chaste_interface__membrane__V)) * mParameters[0] / (1.0 + 0.10000000000000001 * exp(-0.024332874996168673 * var_chaste_interface__membrane__V)) - 0.16520000000000001 * pow(var_chaste_interface__transient_outward_K_current_oa_gate__oa, 3) * (-26.712831923985377 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * mParameters[0] * var_chaste_interface__transient_outward_K_current_oi_gate__oi - 0.029411764999999999 * (-26.712831923985377 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * mParameters[0] * var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr / (1.0 + exp(0.66964285714285721 + 0.044642857142857144 * var_chaste_interface__membrane__V)) - pow(var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ua_gate__ua, 3) * (0.0050000000000000001 + 0.050000000000000003 / (1.0 + exp(1.1538461538461537 - 0.076923076923076927 * var_chaste_interface__membrane__V))) * (-26.712831923985377 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * mParameters[0] * var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ui_gate__ui - 0.12375 * (-65.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_Ca_gate__f_Ca * var_chaste_interface__L_type_Ca_channel_f_gate__f * mParameters[0] - 7.7999999999999998 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-26.712831923985377 * log(10) * log10(140.0 / var_chaste_interface__intracellular_ion_concentrations__Na_i) + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j * mParameters[0]) / mParameters[0]; // millivolt / millisecond
        }
