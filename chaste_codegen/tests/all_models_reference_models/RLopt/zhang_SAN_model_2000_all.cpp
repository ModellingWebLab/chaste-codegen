...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellzhang_SAN_model_2000_allFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        {
            d_dt_chaste_interface_var_membrane__V = 0.033065025136302481 * exp(-0.018714999999999999 * var_chaste_interface__membrane__V) + 0.086637293444554189 * log(10) - 0.0048327079999999998 * var_chaste_interface__membrane__V - 0.62090644426714181 / (1.5 + exp(-1.5 - 0.025000000000000001 * var_chaste_interface__membrane__V)) - 0.12339134744742616 * exp(0.018714999999999999 * var_chaste_interface__membrane__V) - 0.28969 * (-46.399999999999999 + var_chaste_interface__membrane__V) * (0.0060000000000000001 / (1.0 + exp(-2.3500000000000001 - 0.16666666666666666 * var_chaste_interface__membrane__V)) + var_chaste_interface__L_type_Ca_channel_d_gate__d_L * var_chaste_interface__L_type_Ca_channel_f_gate__f_L) - 0.027324999999999999 * (37.623768893931747 * log(10) + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.027324999999999999 * (-33.081023123559646 * log(10) + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.017225000000000001 * pow(var_chaste_interface__slow_delayed_rectifying_potassium_current_xs_gate__xs, 2) * (30.993565913953184 * log(10) + var_chaste_interface__membrane__V) - 0.003322752 * (37.623768893931747 * log(10) + var_chaste_interface__membrane__V) * var_chaste_interface__four_AP_sensitive_currents_r_gate__r - 0.039851999999999999 * (0.40000000000000002 * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_as_gate__P_as + 0.59999999999999998 * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_af_gate__P_af) * (37.623768893931747 * log(10) + var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_i_gate__P_i - 0.21390299999999998 * (-45.0 + var_chaste_interface__membrane__V) * var_chaste_interface__T_type_Ca_channel_d_gate__d_T * var_chaste_interface__T_type_Ca_channel_f_gate__f_T - 0.24524999999999997 * (37.623768893931747 * log(10) + var_chaste_interface__membrane__V) * var_chaste_interface__four_AP_sensitive_currents_q_gate__q * var_chaste_interface__four_AP_sensitive_currents_r_gate__r; // millivolt / millisecond
        }
