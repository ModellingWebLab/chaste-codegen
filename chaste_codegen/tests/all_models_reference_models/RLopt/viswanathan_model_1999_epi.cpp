...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellviswanathan_model_1999_epiFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_ionic_concentrations__Ki = 0.00018063215662022267 * (-2.7574104360798206e-8 * var_chaste_interface__membrane__V + 3.0 / ((1.0 + 100.0 / pow(var_chaste_interface__ionic_concentrations__Nai, 2)) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.961367013372957)) * exp(-0.037435883507802616 * var_chaste_interface__membrane__V))) + 7.3656881518639831e-7 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki) - 0.0055199999999999997 * (-26.712338705498265 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki) + var_chaste_interface__membrane__V) / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V)) - 698.34626081908675 * (-26.712338705498265 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki) + var_chaste_interface__membrane__V) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki))) * (1020.0 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki))) + 1000.0 * (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki)) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki))) / (1.0 + exp(-2.4444678999999998 - 0.51429999999999998 * var_chaste_interface__membrane__V + 13.738155796237757 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki))))) - 0.023862446088641735 * (-26.712338705498265 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki) + var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V)) - (0.433 + 0.25979999999999998 / (1.0 + 6.4818210260626455e-7 * pow(1 / var_chaste_interface__calcium_dynamics__Cai, 1.3999999999999999))) * (-26.712338705498265 * log(10) * log10(6.9195599999999997 / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki)) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2 - 0.00069711623550831479 * (-3.375 + 0.75 * var_chaste_interface__ionic_concentrations__Ki * exp(0.037435883507802616 * var_chaste_interface__membrane__V)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V / ((1.0 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai) * (-1.0 + exp(0.037435883507802616 * var_chaste_interface__membrane__V)))) / M_PI; // millimolar / millisecond
        const double d_dt_chaste_interface_var_calcium_dynamics__APtrack = 0.001 * ((1.0 * (0.0070160275741043606 * var_chaste_interface__membrane__V + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 1.5 / ((1.0 + 100.0 / pow(var_chaste_interface__ionic_concentrations__Nai, 2)) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.961367013372957)) * exp(-0.037435883507802616 * var_chaste_interface__membrane__V))) + 1.1499999999999999 * var_chaste_interface__calcium_dynamics__Cai / (0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai) + 0.0055199999999999997 * (-26.712338705498265 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki) + var_chaste_interface__membrane__V) / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V)) - 0.040282206767891383 * log(10) * log10(1.8 / var_chaste_interface__calcium_dynamics__Cai) - 0.10684935482199306 * log(10) * log10(132.0 / var_chaste_interface__ionic_concentrations__Nai) - 7.3656881518639831e-7 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki) + 0.002 * (1.8 * pow(var_chaste_interface__ionic_concentrations__Nai, 3.0) * exp(0.018717941753901308 * var_chaste_interface__membrane__V) - 2299968.0 * var_chaste_interface__calcium_dynamics__Cai * exp(-0.018717941753901308 * var_chaste_interface__membrane__V)) / ((1.0 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai) * (1.0 + 2299.9679999999998 * var_chaste_interface__calcium_dynamics__Cai + 0.0018000000000000002 * pow(var_chaste_interface__ionic_concentrations__Nai, 3.0))) + 0.050000000000000003 * pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2) * (-13.356169352749133 * log(10) * log10(1.8 / var_chaste_interface__calcium_dynamics__Cai) + var_chaste_interface__membrane__V) * var_chaste_interface__T_type_Ca_channel_g_gate__g + 698.34626081908675 * (-26.712338705498265 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki) + var_chaste_interface__membrane__V) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki))) * (1020.0 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki))) + 1000.0 * (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki)) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki))) / (1.0 + exp(-2.4444678999999998 - 0.51429999999999998 * var_chaste_interface__membrane__V + 13.738155796237757 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki))))) + 0.023862446088641735 * (-26.712338705498265 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki) + var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V)) + (0.433 + 0.25979999999999998 / (1.0 + 6.4818210260626455e-7 * pow(1 / var_chaste_interface__calcium_dynamics__Cai, 1.3999999999999999))) * (-26.712338705498265 * log(10) * log10(6.9195599999999997 / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki)) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2 + 16.0 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-26.712338705498265 * log(10) * log10(132.0 / var_chaste_interface__ionic_concentrations__Nai) + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j + 7.8019226357407252 * (-0.61380000000000001 + 1.0 * var_chaste_interface__calcium_dynamics__Cai * exp(0.074871767015605231 * var_chaste_interface__membrane__V)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V / ((1.0 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai) * (-1.0 + exp(0.074871767015605231 * var_chaste_interface__membrane__V))) + 0.0024381008236689767 * (-99.0 + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(0.037435883507802616 * var_chaste_interface__membrane__V)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V / ((1.0 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai) * (-1.0 + exp(0.037435883507802616 * var_chaste_interface__membrane__V))) + 0.00069711623550831479 * (-3.375 + 0.75 * var_chaste_interface__ionic_concentrations__Ki * exp(0.037435883507802616 * var_chaste_interface__membrane__V)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V / ((1.0 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai) * (-1.0 + exp(0.037435883507802616 * var_chaste_interface__membrane__V)))) / mParameters[0] < -150000.0) ? (100000.0 - 100500.0 * var_chaste_interface__calcium_dynamics__APtrack) : (-500.0 * var_chaste_interface__calcium_dynamics__APtrack)); // 1 / millisecond
        ...
        {
            d_dt_chaste_interface_var_membrane__V = -0.001 * (0.0070160275741043606 * var_chaste_interface__membrane__V + GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 1.5 / ((1.0 + 100.0 / pow(var_chaste_interface__ionic_concentrations__Nai, 2)) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.961367013372957)) * exp(-0.037435883507802616 * var_chaste_interface__membrane__V))) + 1.1499999999999999 * var_chaste_interface__calcium_dynamics__Cai / (0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai) + 0.0055199999999999997 * (-26.712338705498265 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki) + var_chaste_interface__membrane__V) / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V)) - 0.040282206767891383 * log(10) * log10(1.8 / var_chaste_interface__calcium_dynamics__Cai) - 0.10684935482199306 * log(10) * log10(132.0 / var_chaste_interface__ionic_concentrations__Nai) - 7.3656881518639831e-7 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki) + 0.002 * (1.8 * pow(var_chaste_interface__ionic_concentrations__Nai, 3.0) * exp(0.018717941753901308 * var_chaste_interface__membrane__V) - 2299968.0 * var_chaste_interface__calcium_dynamics__Cai * exp(-0.018717941753901308 * var_chaste_interface__membrane__V)) / ((1.0 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai) * (1.0 + 2299.9679999999998 * var_chaste_interface__calcium_dynamics__Cai + 0.0018000000000000002 * pow(var_chaste_interface__ionic_concentrations__Nai, 3.0))) + 0.050000000000000003 * pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2) * (-13.356169352749133 * log(10) * log10(1.8 / var_chaste_interface__calcium_dynamics__Cai) + var_chaste_interface__membrane__V) * var_chaste_interface__T_type_Ca_channel_g_gate__g + 698.34626081908675 * (-26.712338705498265 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki) + var_chaste_interface__membrane__V) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki))) * (1020.0 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki))) + 1000.0 * (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki)) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki))) / (1.0 + exp(-2.4444678999999998 - 0.51429999999999998 * var_chaste_interface__membrane__V + 13.738155796237757 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki))))) + 0.023862446088641735 * (-26.712338705498265 * log(10) * log10(4.5 / var_chaste_interface__ionic_concentrations__Ki) + var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V)) + (0.433 + 0.25979999999999998 / (1.0 + 6.4818210260626455e-7 * pow(1 / var_chaste_interface__calcium_dynamics__Cai, 1.3999999999999999))) * (-26.712338705498265 * log(10) * log10(6.9195599999999997 / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki)) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2 + 16.0 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-26.712338705498265 * log(10) * log10(132.0 / var_chaste_interface__ionic_concentrations__Nai) + var_chaste_interface__membrane__V) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j + 7.8019226357407252 * (-0.61380000000000001 + 1.0 * var_chaste_interface__calcium_dynamics__Cai * exp(0.074871767015605231 * var_chaste_interface__membrane__V)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V / ((1.0 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai) * (-1.0 + exp(0.074871767015605231 * var_chaste_interface__membrane__V))) + 0.0024381008236689767 * (-99.0 + 0.75 * var_chaste_interface__ionic_concentrations__Nai * exp(0.037435883507802616 * var_chaste_interface__membrane__V)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V / ((1.0 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai) * (-1.0 + exp(0.037435883507802616 * var_chaste_interface__membrane__V))) + 0.00069711623550831479 * (-3.375 + 0.75 * var_chaste_interface__ionic_concentrations__Ki * exp(0.037435883507802616 * var_chaste_interface__membrane__V)) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V / ((1.0 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai) * (-1.0 + exp(0.037435883507802616 * var_chaste_interface__membrane__V)))) / mParameters[0]; // millivolt / millisecond
        }
