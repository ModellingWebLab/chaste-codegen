...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpandit_model_2001_epiFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time_converted, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_intracellular_ion_concentrations__K_i = -1.528038983862048e-7 * var_chaste_interface__membrane__V + 0.00013865004012358849 / ((1.0 + 31.622776601683793 * pow(1 / var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5)) * (1.0 + 0.1245 * exp(-0.0039337852699643568 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.039337852699643565 * var_chaste_interface__membrane__V))) + 3.8843985601580465e-6 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) - 1.2844385661449098e-6 * (-25.420807984495319 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 1.1072746259869914e-7 * (10.0 + 48.0 / (exp(1.48 + 0.040000000000000001 * var_chaste_interface__membrane__V) + exp(-1.48 - 0.040000000000000001 * var_chaste_interface__membrane__V))) / (1.0 + exp(4.5158823529411762 - 0.058823529411764705 * var_chaste_interface__membrane__V + 1.4953416461467837 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i))) - 2.6574591023687795e-5 * (-1.73 - 25.420807984495319 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) / ((1.0 + exp(-35.49354838709678)) * (1.0 + exp(-0.10977188457982838 + 0.06345195640452507 * var_chaste_interface__membrane__V - 1.613 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i)))) - 7.7509223819089404e-6 * (-25.420807984495319 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss - 3.8754611909544704e-5 * (0.88600000000000001 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s + 0.114 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow) * (-25.420807984495319 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r; // millimolar / millisecond
        ...
        {
            d_dt_chaste_interface_var_membrane__V = 0.001 * (-0.00025054999999999999 * var_chaste_interface__membrane__V + 0.0020374777599573 * log(10) * log10(140.0 / var_chaste_interface__intracellular_ion_concentrations__Na_i) + 0.00041181708934882422 * log(10) * log10(1.2 / var_chaste_interface__intracellular_ion_concentrations__Ca_i) + 0.0035080715018603542 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) - 0.0040000000000000001 * var_chaste_interface__intracellular_ion_concentrations__Ca_i / (0.00040000000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i) - 9.9839999999999996e-6 * (1.2 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) * exp(0.018714999999999999 * var_chaste_interface__membrane__V) - 2744000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i * exp(-0.018714999999999999 * var_chaste_interface__membrane__V)) / (1.0 + 0.00012 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3) + 274.40000000000003 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) - 0.0001 * (10.0 + 48.0 / (exp(1.48 + 0.040000000000000001 * var_chaste_interface__membrane__V) + exp(-1.48 - 0.040000000000000001 * var_chaste_interface__membrane__V))) / (1.0 + exp(4.5158823529411762 - 0.058823529411764705 * var_chaste_interface__membrane__V + 1.4953416461467837 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i))) - 0.062608695652173918 / ((1.0 + 31.622776601683793 * pow(1 / var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5)) * (1.0 + 0.1245 * exp(-0.0039337852699643568 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.039337852699643565 * var_chaste_interface__membrane__V))) - 0.00116 * (-25.420807984495319 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.00029 * (-25.420807984495319 * log(10) * log10(140.0 / var_chaste_interface__intracellular_ion_concentrations__Na_i) + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 1000.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) * mParameters[0] / HeartConfig::Instance()->GetCapacitance() - 0.031 * (-65.0 + var_chaste_interface__membrane__V) * ((0.10000000000000001 - 0.10000000000000001 * var_chaste_interface__L_type_Ca_channel_Ca_inact_gate__Ca_inact) * var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12 + (0.90000000000000002 + 0.10000000000000001 * var_chaste_interface__L_type_Ca_channel_Ca_inact_gate__Ca_inact) * var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11) * var_chaste_interface__L_type_Ca_channel_d_gate__d - 0.035000000000000003 * (0.88600000000000001 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s + 0.114 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow) * (-25.420807984495319 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r - 0.024 * (-1.73 - 25.420807984495319 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) / ((1.0 + exp(-35.49354838709678)) * (1.0 + exp(-0.10977188457982838 + 0.06345195640452507 * var_chaste_interface__membrane__V - 1.613 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i)))) - 0.0070000000000000001 * (-25.420807984495319 * log(10) * log10(5.4000000000000004 / var_chaste_interface__intracellular_ion_concentrations__K_i) + var_chaste_interface__membrane__V) * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss - 0.80000000000000004 * pow(var_chaste_interface__sodium_current_m_gate__m, 3) * (-25.420807984495319 * log(10) * log10(140.0 / var_chaste_interface__intracellular_ion_concentrations__Na_i) + var_chaste_interface__membrane__V) * var_chaste_interface__sodium_current_h_gate__h * var_chaste_interface__sodium_current_j_gate__j) / mParameters[0]; // millivolt / millisecond
        }
