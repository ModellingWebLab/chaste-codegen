...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellgrandi2010ssFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__cell__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double d_dt_chaste_interface_var_cell__sCasl = 0.029999999999999999 * var_chaste_interface__cell__sSLHsl + 1.3 * var_chaste_interface__cell__sSLLsl + 17.724002759538607 * (-var_chaste_interface__cell__sCasl + var_chaste_interface__cell__sCai) / M_PI + 3.9220965724111685 * (-var_chaste_interface__cell__sCasl + var_chaste_interface__cell__sCaj) / M_PI - 100.0 * (1.2155 - var_chaste_interface__cell__sSLLsl) * var_chaste_interface__cell__sCasl - 100.0 * (0.4355 - var_chaste_interface__cell__sSLHsl) * var_chaste_interface__cell__sCasl - 0.0034058550063278672 * (0.00049065700000000003 * var_chaste_interface__cell__sVm + 0.059896999999999999 * pow(var_chaste_interface__cell__sCasl, 1.6000000000000001) / (5.2281977629563632e-6 + pow(var_chaste_interface__cell__sCasl, 1.6000000000000001)) - 0.0065532979861118307 * log(10) * log10(1.8 / var_chaste_interface__cell__sCasl) - 8.0099999999999998 * (1.8 * pow(var_chaste_interface__cell__sNasl, 3) * exp(0.010107688547106707 * var_chaste_interface__cell__sVm) - 2744000.0 * var_chaste_interface__cell__sCasl * exp(-0.027328194960695912 * var_chaste_interface__cell__sVm)) / ((1.0 + 0.32000000000000001 * exp(-0.027328194960695912 * var_chaste_interface__cell__sVm)) * (1.0 + 2.2499999999999996e-8 / pow(var_chaste_interface__cell__sCasl, 2)) * (9850.9599999999991 + 2744000.0 * var_chaste_interface__cell__sCasl + 8.4066800865219591 * pow(var_chaste_interface__cell__sNasl, 3) + 669921.875 * (1.0 + 278.55153203342621 * var_chaste_interface__cell__sCasl) * var_chaste_interface__cell__sCasl)) + 0.17554325930416628 * (1.0 - var_chaste_interface__cell__sfcaBsl) * (-0.61380000000000001 + 0.34100000000000003 * var_chaste_interface__cell__sCasl * exp(0.074871767015605231 * var_chaste_interface__cell__sVm)) * mParameters[0] * var_chaste_interface__cell__sVm * var_chaste_interface__cell__sd * var_chaste_interface__cell__sf / (-1.0 + exp(0.074871767015605231 * var_chaste_interface__cell__sVm))) / M_PI; // 1 / ms
        const double d_dt_chaste_interface_var_cell__sNaj = 0.001 * var_chaste_interface__cell__sNaBj + 3.2338348512952546 * (-var_chaste_interface__cell__sNaj + var_chaste_interface__cell__sNasl) / M_PI - 0.0001 * (7.5609999999999999 - var_chaste_interface__cell__sNaBj) * var_chaste_interface__cell__sNaj - 0.25275361828036119 * (6.567e-5 * var_chaste_interface__cell__sVm + 0.46486956521739131 / ((1.0 + 14641.0 / pow(var_chaste_interface__cell__sNaj, 4)) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__cell__sVm) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.037435883507802616 * var_chaste_interface__cell__sVm))) - 0.001754199282790071 * log(10) * log10(140.0 / var_chaste_interface__cell__sNaj) + 1.4850000000000001 * (1.8 * pow(var_chaste_interface__cell__sNaj, 3) * exp(0.010107688547106707 * var_chaste_interface__cell__sVm) - 2744000.0 * var_chaste_interface__cell__sCaj * exp(-0.027328194960695912 * var_chaste_interface__cell__sVm)) / ((1.0 + 0.32000000000000001 * exp(-0.027328194960695912 * var_chaste_interface__cell__sVm)) * (1.0 + 2.2499999999999996e-8 / pow(var_chaste_interface__cell__sCaj, 2)) * (9850.9599999999991 + 2744000.0 * var_chaste_interface__cell__sCaj + 8.4066800865219591 * pow(var_chaste_interface__cell__sNaj, 3) + 669921.875 * (1.0 + 278.55153203342621 * var_chaste_interface__cell__sCaj) * var_chaste_interface__cell__sCaj)) + 0.11 * pow(var_chaste_interface__cell__sm, 3) * (-26.712338705498265 * log(10) * log10(140.0 / var_chaste_interface__cell__sNaj) + var_chaste_interface__cell__sVm) * mParameters[1] * var_chaste_interface__cell__sh * var_chaste_interface__cell__sj + 1.0971453706510394e-5 * (1.0 - var_chaste_interface__cell__sfcaBj) * (-105.0 + 0.75 * var_chaste_interface__cell__sNaj * exp(0.037435883507802616 * var_chaste_interface__cell__sVm)) * mParameters[0] * var_chaste_interface__cell__sVm * var_chaste_interface__cell__sd * var_chaste_interface__cell__sf / (-1.0 + exp(0.037435883507802616 * var_chaste_interface__cell__sVm))) / M_PI; // 1 / ms
        const double d_dt_chaste_interface_var_cell__sNasl = 0.001 * var_chaste_interface__cell__sNaBsl + 0.087151849242407126 * (-var_chaste_interface__cell__sNasl + var_chaste_interface__cell__sNaj) / M_PI + 7.7983482318610085 * (-var_chaste_interface__cell__sNasl + var_chaste_interface__cell__sNai) / M_PI - 0.0001 * (1.6499999999999999 - var_chaste_interface__cell__sNaBsl) * var_chaste_interface__cell__sNasl - 0.0068117100126557344 * (0.00053133 * var_chaste_interface__cell__sVm + 3.7612173913043478 / ((1.0 + 14641.0 / pow(var_chaste_interface__cell__sNasl, 4)) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__cell__sVm) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.037435883507802616 * var_chaste_interface__cell__sVm))) - 0.014193066924392391 * log(10) * log10(140.0 / var_chaste_interface__cell__sNasl) + 12.015000000000001 * (1.8 * pow(var_chaste_interface__cell__sNasl, 3) * exp(0.010107688547106707 * var_chaste_interface__cell__sVm) - 2744000.0 * var_chaste_interface__cell__sCasl * exp(-0.027328194960695912 * var_chaste_interface__cell__sVm)) / ((1.0 + 0.32000000000000001 * exp(-0.027328194960695912 * var_chaste_interface__cell__sVm)) * (1.0 + 2.2499999999999996e-8 / pow(var_chaste_interface__cell__sCasl, 2)) * (9850.9599999999991 + 2744000.0 * var_chaste_interface__cell__sCasl + 8.4066800865219591 * pow(var_chaste_interface__cell__sNasl, 3) + 669921.875 * (1.0 + 278.55153203342621 * var_chaste_interface__cell__sCasl) * var_chaste_interface__cell__sCasl)) + 0.89000000000000001 * pow(var_chaste_interface__cell__sm, 3) * (-26.712338705498265 * log(10) * log10(140.0 / var_chaste_interface__cell__sNasl) + var_chaste_interface__cell__sVm) * mParameters[1] * var_chaste_interface__cell__sh * var_chaste_interface__cell__sj + 1.2190504118344879e-6 * (1.0 - var_chaste_interface__cell__sfcaBsl) * (-105.0 + 0.75 * var_chaste_interface__cell__sNasl * exp(0.037435883507802616 * var_chaste_interface__cell__sVm)) * mParameters[0] * var_chaste_interface__cell__sVm * var_chaste_interface__cell__sd * var_chaste_interface__cell__sf / (-1.0 + exp(0.037435883507802616 * var_chaste_interface__cell__sVm))) / M_PI; // 1 / ms
        ...
        {
            d_dt_chaste_interface_var_cell__sVm = -0.010148299999999999 * var_chaste_interface__cell__sVm - 0.24041104834948435 * log(10) - GetIntracellularAreaStimulus(var_chaste_interface__cell__time) / HeartConfig::Instance()->GetCapacitance() + 0.014193066924392391 * log(10) * log10(140.0 / var_chaste_interface__cell__sNasl) + 0.00080995817805876559 * log(10) * log10(1.8 / var_chaste_interface__cell__sCaj) + 0.0065532979861118307 * log(10) * log10(1.8 / var_chaste_interface__cell__sCasl) + 0.001754199282790071 * log(10) * log10(140.0 / var_chaste_interface__cell__sNaj) - 0.002 * (35.975843496359595 * log(10) + var_chaste_interface__cell__sVm) / (1.0 + exp(7.4880000000000004 - 0.16722408026755853 * var_chaste_interface__cell__sVm)) - 0.0035000000000000001 * pow(var_chaste_interface__cell__sxks, 2) * (-26.712338705498265 * log(10) * log10(7.9662000000000006 / (120.0 + 0.018329999999999999 * var_chaste_interface__cell__sNai)) + var_chaste_interface__cell__sVm) - 0.15495652173913044 / ((1.0 + 14641.0 / pow(var_chaste_interface__cell__sNaj, 4)) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__cell__sVm) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.037435883507802616 * var_chaste_interface__cell__sVm))) - 1.2537391304347827 / ((1.0 + 14641.0 / pow(var_chaste_interface__cell__sNasl, 4)) * (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__cell__sVm) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.037435883507802616 * var_chaste_interface__cell__sVm))) - 0.006029375 * (26.712338705498265 * log(10) + var_chaste_interface__cell__sVm) / (1.0 + 0.10000000000000001 / var_chaste_interface__cell__sCaj) - 0.0074029999999999999 * pow(var_chaste_interface__cell__sCaj, 1.6000000000000001) / (5.2281977629563632e-6 + pow(var_chaste_interface__cell__sCaj, 1.6000000000000001)) - 0.048783124999999997 * (26.712338705498265 * log(10) + var_chaste_interface__cell__sVm) / (1.0 + 0.10000000000000001 / var_chaste_interface__cell__sCasl) - 0.059896999999999999 * pow(var_chaste_interface__cell__sCasl, 1.6000000000000001) / (5.2281977629563632e-6 + pow(var_chaste_interface__cell__sCasl, 1.6000000000000001)) - 0.1144 * (35.975843496359595 * log(10) + var_chaste_interface__cell__sVm) * var_chaste_interface__cell__sxtof * var_chaste_interface__cell__sytof - 0.015599999999999999 * (35.975843496359595 * log(10) + var_chaste_interface__cell__sVm) * var_chaste_interface__cell__sxtos * var_chaste_interface__cell__sytos - 0.35699999999999998 * (35.975843496359595 * log(10) + var_chaste_interface__cell__sVm) / ((1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__sVm + 8.5802386738817642 * log(10))) * (1.02 / (1.0 + exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__cell__sVm + 8.5802386738817642 * log(10))) + (0.49124000000000001 * exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__sVm + 2.889579749627603 * log(10)) + exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__sVm + 2.221508335900205 * log(10))) / (1.0 + exp(-2.4444678999999998 - 0.51429999999999998 * var_chaste_interface__cell__sVm - 18.502376310177741 * log(10))))) - 0.035000000000000003 * (35.975843496359595 * log(10) + var_chaste_interface__cell__sVm) * mParameters[2] * var_chaste_interface__cell__sxkr / (1.0 + exp(3.0833333333333335 + 0.041666666666666664 * var_chaste_interface__cell__sVm)) - 0.495 * (1.8 * pow(var_chaste_interface__cell__sNaj, 3) * exp(0.010107688547106707 * var_chaste_interface__cell__sVm) - 2744000.0 * var_chaste_interface__cell__sCaj * exp(-0.027328194960695912 * var_chaste_interface__cell__sVm)) / ((1.0 + 0.32000000000000001 * exp(-0.027328194960695912 * var_chaste_interface__cell__sVm)) * (1.0 + 2.2499999999999996e-8 / pow(var_chaste_interface__cell__sCaj, 2)) * (9850.9599999999991 + 2744000.0 * var_chaste_interface__cell__sCaj + 8.4066800865219591 * pow(var_chaste_interface__cell__sNaj, 3) + 669921.875 * (1.0 + 278.55153203342621 * var_chaste_interface__cell__sCaj) * var_chaste_interface__cell__sCaj)) - 4.0049999999999999 * (1.8 * pow(var_chaste_interface__cell__sNasl, 3) * exp(0.010107688547106707 * var_chaste_interface__cell__sVm) - 2744000.0 * var_chaste_interface__cell__sCasl * exp(-0.027328194960695912 * var_chaste_interface__cell__sVm)) / ((1.0 + 0.32000000000000001 * exp(-0.027328194960695912 * var_chaste_interface__cell__sVm)) * (1.0 + 2.2499999999999996e-8 / pow(var_chaste_interface__cell__sCasl, 2)) * (9850.9599999999991 + 2744000.0 * var_chaste_interface__cell__sCasl + 8.4066800865219591 * pow(var_chaste_interface__cell__sNasl, 3) + 669921.875 * (1.0 + 278.55153203342621 * var_chaste_interface__cell__sCasl) * var_chaste_interface__cell__sCasl)) - 0.11 * pow(var_chaste_interface__cell__sm, 3) * (-26.712338705498265 * log(10) * log10(140.0 / var_chaste_interface__cell__sNaj) + var_chaste_interface__cell__sVm) * mParameters[1] * var_chaste_interface__cell__sh * var_chaste_interface__cell__sj - 0.89000000000000001 * pow(var_chaste_interface__cell__sm, 3) * (-26.712338705498265 * log(10) * log10(140.0 / var_chaste_interface__cell__sNasl) + var_chaste_interface__cell__sVm) * mParameters[1] * var_chaste_interface__cell__sh * var_chaste_interface__cell__sj - 1.2190504118344879e-6 * (1.0 - var_chaste_interface__cell__sfcaBsl) * (-105.0 + 0.75 * var_chaste_interface__cell__sNasl * exp(0.037435883507802616 * var_chaste_interface__cell__sVm)) * mParameters[0] * var_chaste_interface__cell__sVm * var_chaste_interface__cell__sd * var_chaste_interface__cell__sf / (-1.0 + exp(0.037435883507802616 * var_chaste_interface__cell__sVm)) - 1.0971453706510394e-5 * (1.0 - var_chaste_interface__cell__sfcaBj) * (-105.0 + 0.75 * var_chaste_interface__cell__sNaj * exp(0.037435883507802616 * var_chaste_interface__cell__sVm)) * mParameters[0] * var_chaste_interface__cell__sVm * var_chaste_interface__cell__sd * var_chaste_interface__cell__sf / (-1.0 + exp(0.037435883507802616 * var_chaste_interface__cell__sVm)) - 1.5798893337374968 * (1.0 - var_chaste_interface__cell__sfcaBj) * (-0.61380000000000001 + 0.34100000000000003 * var_chaste_interface__cell__sCaj * exp(0.074871767015605231 * var_chaste_interface__cell__sVm)) * mParameters[0] * var_chaste_interface__cell__sVm * var_chaste_interface__cell__sd * var_chaste_interface__cell__sf / (-1.0 + exp(0.074871767015605231 * var_chaste_interface__cell__sVm)) - 0.17554325930416628 * (1.0 - var_chaste_interface__cell__sfcaBsl) * (-0.61380000000000001 + 0.34100000000000003 * var_chaste_interface__cell__sCasl * exp(0.074871767015605231 * var_chaste_interface__cell__sVm)) * mParameters[0] * var_chaste_interface__cell__sVm * var_chaste_interface__cell__sd * var_chaste_interface__cell__sf / (-1.0 + exp(0.074871767015605231 * var_chaste_interface__cell__sVm)) - 0.0002194290741302079 * (-4.0500000000000007 + 90.0 * exp(0.037435883507802616 * var_chaste_interface__cell__sVm)) * (1.0 - 0.099999999999999978 * var_chaste_interface__cell__sfcaBsl - 0.90000000000000002 * var_chaste_interface__cell__sfcaBj) * mParameters[0] * var_chaste_interface__cell__sVm * var_chaste_interface__cell__sd * var_chaste_interface__cell__sf / (-1.0 + exp(0.037435883507802616 * var_chaste_interface__cell__sVm)); // millivolt / ms
        }
