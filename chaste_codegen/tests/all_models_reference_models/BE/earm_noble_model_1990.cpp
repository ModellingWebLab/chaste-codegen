...
#include "CardiacNewtonSolver.hpp"
    ...
    double Cellearm_noble_model_1990FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_background_current__E_Ca = 0.5 * var_membrane__RTONF * log(10) * log10(var_extracellular_calcium_concentration__Ca_o / var_chaste_interface__intracellular_calcium_concentration__Ca_i); // millivolt
        ...
        const double var_transient_outward_current__E_K = var_membrane__RTONF * log(10) * log10(var_extracellular_potassium_concentration__K_c / var_chaste_interface__intracellular_potassium_concentration__K_i); // millivolt
    ...
    void Cellearm_noble_model_1990FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[10], double rJacobian[10][10])
    {
        ...
        const double var_x66 = log(10) * log10(4.0 * var_x65);
        ...
        const double var_x73 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * var_chaste_interface__fast_sodium_current_h_gate__h / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        ...
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = -(mDt * (-0.0013489287249292257 * var_x73));
        rJacobian[9][9] = 1.0 - (mDt * (1.7673477715833064e-7 * var_x71 + 2.0119028828602145e-15 * var_x57 - 0.00028277564345332906 * var_x70 - 1.5752072268398093e-8 * var_x69 - 2.6978574498584515e-6 / var_chaste_interface__intracellular_sodium_concentration__Na_i - 0.011241072707743547 * var_x73 - 1.5148695184999769e-6 * var_x56));
    }
