...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellbondarenko_model_2004_apexFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[32], double rJacobian[32][32])
    {
        ...
        const double var_x63 = log(10);
        const double var_x64 = var_x60 * var_x62 * pow(var_chaste_interface__sodium_concentration__Nai, 2);
        const double var_x65 = 0.23799999999999999 + var_chaste_interface__calcium_concentration__Cass;
        const double var_x66 = pow(var_x65, (-2));
        const double var_x67 = 1 / (1.0 + 11.899999999999999 * var_x66);
        const double var_x68 = 363.63636363636363 * var_chaste_interface__ryanodine_receptors__P_O1;
        const double var_x69 = 363.63636363636363 * var_chaste_interface__ryanodine_receptors__P_O2;
        const double var_x70 = var_x67 * var_chaste_interface__calcium_fluxes__P_RyR;
        const double var_x71 = 363.63636363636363 * var_chaste_interface__calcium_concentration__CaJSR - 363.63636363636363 * var_chaste_interface__calcium_concentration__Cass;
        const double var_x72 = var_x70 * var_x71;
        const double var_x73 = -0.04926108374384236 * var_chaste_interface__membrane__V;
        const double var_x74 = 0.20000000000000001 * exp(0.12315270935960591 + var_x73);
        const double var_x75 = -var_x74;
        const double var_x76 = exp(-0.016666666666666666 - 0.0066666666666666671 * var_chaste_interface__membrane__V);
        const double var_x77 = 1 / (0.25 * var_x76 + 0.1027 * exp(-0.20833333333333334 - 0.083333333333333329 * var_chaste_interface__membrane__V));
        const double var_x78 = 3.802 * var_x77;
        const double var_x79 = 2.0000000000000002e-5 * var_chaste_interface__membrane__V;
        const double var_x80 = -0.008539999999999999 - var_x79;
        const double var_x81 = 3.802 / (0.1027 * exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V) + 0.23000000000000001 * var_x76);
        const double var_x82 = exp(-0.90909090909090906 - 0.12987012987012986 * var_chaste_interface__membrane__V);
        const double var_x83 = 6.9999999999999997e-7 * var_x82;
        const double var_x84 = exp(0.36945812807881773 + var_x73);
        const double var_x85 = 0.22 * var_x84;
        const double var_x86 = 3.802 / (0.20000000000000001 * var_x76 + 0.1027 * exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__membrane__V));
        const double var_x87 = -var_x86;
        const double var_x88 = 0.19170000000000001 * exp(-0.12315270935960591 + var_x73);
        const double var_x89 = -var_x81 - var_x88;
        const double var_x90 = var_x80 + var_x87;
        const double var_x91 = -var_x83;
        const double var_x92 = 1 / (0.39395599999999997 + 0.188495 * exp(-0.42168674698795178 - 0.060240963855421679 * var_chaste_interface__membrane__V));
        const double var_x93 = 1.0526315789473684e-5 * var_x92;
        const double var_x94 = 1.4e-8 * var_x82;
        const double var_x95 = 0.001 * var_x92;
        const double var_x96 = 0.008539999999999999 + var_x79;
        const double var_x97 = 1.2097272727272726e-5 * var_x77 * var_x82 * var_x92 / (var_x84 * var_x96);
        const double var_x98 = 1 / var_chaste_interface__potassium_concentration__Ki;
        const double var_x99 = var_x63 * log10(5400.0 * var_x98);
        const double var_x100 = 1 / (0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai + var_chaste_interface__potassium_concentration__Ki);
        const double var_x101 = var_x100 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x102 = exp(0.089599999999999999 * var_chaste_interface__membrane__V - 2.300419183419689 * var_x99);
        ...
        const double var_x116 = 1 / (0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki + var_chaste_interface__sodium_concentration__Nai);
        ...
        rJacobian[11][29] = 0.0;
        rJacobian[11][30] = 0.0;
        rJacobian[11][31] = -(mDt * (8.9596216554657907e-15 * var_x57 * var_x64));
        rJacobian[12][0] = 0.0;
        rJacobian[12][1] = 0.0;
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = 0.0;
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = -(mDt * (var_x67 * (5830.115245721463 - 92.541511836848613 * var_chaste_interface__membrane__V)));
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = -(mDt * (var_x70 * (var_x68 + var_x69)));
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = -(mDt * (2175.0841750841751 * var_x67));
        rJacobian[12][12] = 1.0 - (mDt * (var_x67 * (-2175.0841750841751 + (-var_x68 - var_x69) * var_chaste_interface__calcium_fluxes__P_RyR) + 0.16806722689075632 * (363.63636363636363 * var_x46 + 2175.0841750841751 * var_chaste_interface__calcium_concentration__Cai - 2175.0841750841751 * var_chaste_interface__calcium_concentration__Cass - 92.541511836848613 * (-63.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_calcium_current__O) / (pow(var_x65, 3) * pow((0.084033613445378158 + var_x66), 2))));
        rJacobian[12][13] = -(mDt * (var_x45 * var_x67 * var_x71));
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        rJacobian[12][17] = 0.0;
        ...
        rJacobian[12][27] = 0.0;
        rJacobian[12][28] = 0.0;
        rJacobian[12][29] = -(mDt * (var_x72));
        rJacobian[12][30] = -(mDt * (var_x72));
        rJacobian[12][31] = 0.0;
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (var_x75 + var_x80 - var_x78));
        rJacobian[14][15] = -(mDt * (var_x81));
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        rJacobian[14][19] = 0.0;
        rJacobian[14][20] = -(mDt * (var_x83));
        rJacobian[14][21] = -(mDt * (var_x85));
        rJacobian[14][22] = 0.0;
        rJacobian[14][23] = 0.0;
        rJacobian[14][24] = 0.0;
        rJacobian[14][25] = 0.0;
        ...
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = -(mDt * (var_x74 + var_x87));
        rJacobian[15][15] = 1.0 - (mDt * (var_x89 + var_x90));
        rJacobian[15][16] = -(mDt * (var_x87));
        rJacobian[15][17] = -(mDt * (var_x87));
        rJacobian[15][18] = -(mDt * (var_x83 + var_x87));
        rJacobian[15][19] = -(mDt * (var_x87));
        rJacobian[15][20] = -(mDt * (var_x87));
        rJacobian[15][21] = -(mDt * (var_x87));
        rJacobian[15][22] = 0.0;
        rJacobian[15][23] = 0.0;
        rJacobian[15][24] = 0.0;
        rJacobian[15][25] = 0.0;
        ...
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (var_x91 - var_x93));
        ...
        rJacobian[18][13] = 0.0;
        rJacobian[18][14] = 0.0;
        rJacobian[18][15] = -(mDt * (var_x96));
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (var_x89 + var_x91));
        rJacobian[18][19] = -(mDt * (var_x86));
        rJacobian[18][20] = -(mDt * (var_x74));
        rJacobian[18][21] = 0.0;
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        ...
        rJacobian[19][12] = 0.0;
        rJacobian[19][13] = 0.0;
        rJacobian[19][14] = -(mDt * (var_x80));
        rJacobian[19][15] = -(mDt * (var_x80));
        rJacobian[19][16] = -(mDt * (var_x80));
        rJacobian[19][17] = -(mDt * (var_x80));
        rJacobian[19][18] = -(mDt * (var_x80 + var_x88));
        rJacobian[19][19] = 1.0 - (mDt * (var_x90 + var_x91));
        rJacobian[19][20] = -(mDt * (var_x80));
        rJacobian[19][21] = -(mDt * (var_x80));
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = 0.0;
        ...
        rJacobian[20][12] = 0.0;
        rJacobian[20][13] = 0.0;
        rJacobian[20][14] = -(mDt * (var_x96));
        rJacobian[20][15] = 0.0;
        rJacobian[20][16] = -(mDt * (var_x83));
        rJacobian[20][17] = 0.0;
        rJacobian[20][18] = -(mDt * (var_x81));
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * (var_x75 + var_x91 - var_x95 - var_x97));
        rJacobian[20][21] = -(mDt * (var_x92));
        rJacobian[20][22] = 0.0;
        rJacobian[20][23] = 0.0;
        rJacobian[20][24] = 0.0;
        rJacobian[20][25] = 0.0;
        ...
        rJacobian[21][21] = 1.0 - (mDt * (-var_x85 - var_x92));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        ...
        rJacobian[23][23] = 1.0 - (mDt * (-0.12319671014252923 * var_x101 - 0.0090818087605069615 * var_x98 * pow(var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs, 2) - 0.44667042500874232 * var_x98 / var_x103 - 0.078972250091364882 * var_x98 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss - 0.642360282243162 * var_x98 * pow(var_chaste_interface__fast_transient_outward_potassium_current__ato_f, 3) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 0.25271120029236765 * var_x98 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur + 0.040021670080783313 * var_x102 * var_x98 * (-25.674321243523316 * var_x99 + var_chaste_interface__membrane__V) / pow(var_x103, 2)));
        rJacobian[23][24] = 0.0;
        rJacobian[23][25] = 0.0;
        rJacobian[23][26] = 0.0;
        rJacobian[23][27] = -(mDt * (-0.0047984407834581883 * var_chaste_interface__membrane__V + 0.12319671014252923 * var_x63 * log10(8257.1428571428569 * var_x100)));
        rJacobian[23][28] = 0.0;
        rJacobian[23][29] = 0.0;
        rJacobian[23][30] = 0.0;
        rJacobian[23][31] = -(mDt * (4.1766221831198043e-8 * var_x106 - 0.0025142185743373311 * var_x101));
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = 0.0;
        rJacobian[24][2] = 0.0;
        rJacobian[24][3] = 0.0;
        ...
        rJacobian[31][19] = 0.0;
        rJacobian[31][20] = 0.0;
        rJacobian[31][21] = -(mDt * (-0.79974013057636462 * var_chaste_interface__membrane__V + 20.532785023754869 * var_x63 * log10(140600.0 * var_x116)));
        rJacobian[31][22] = 0.0;
        rJacobian[31][23] = -(mDt * (-0.00045628411163899709 * var_x116 - 2.2814205581949856 * var_x117));
        rJacobian[31][24] = 0.0;
        rJacobian[31][25] = 0.0;
        rJacobian[31][26] = 0.0;
        rJacobian[31][27] = 0.0;
        ...
        rJacobian[31][29] = 0.0;
        rJacobian[31][30] = 0.0;
        rJacobian[31][31] = 1.0 - (mDt * (-6.2649332746797061e-8 * var_x106 - 0.0041065570047509742 * var_x116 - 20.532785023754869 * var_x117 - 2.6878864966397372e-14 * var_x64));
    }
