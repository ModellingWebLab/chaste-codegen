...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnoble_model_1991FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[9], double rJacobian[9][9])
    {
        ...
        const double var_x35 = log(10) * log10(4.0 * var_x34);
        ...
        const double var_x41 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * var_chaste_interface__fast_sodium_current_h_gate__h / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        ...
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = -(mDt * (-0.0050635462647493461 * var_x41));
        rJacobian[8][8] = 1.0 - (mDt * (6.634188331769168e-7 * var_x40 - 0.0010614701330830668 * var_x39 - 1.0127092529498693e-5 / var_chaste_interface__intracellular_sodium_concentration__Na_i - 5.6864471415164302e-6 * var_x32 - 0.042196218872911223 * var_x41 - 5.9129400406899753e-8 * var_x38));
    }
