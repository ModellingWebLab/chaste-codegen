...
#include "MathsCustomFunctions.hpp"
    ...
    double Celldecker_2009FromCellMLGRL1::EvaluatePartialDerivative0(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x45 = mParameters[2] / var_x44;
            const double var_x46 = 1.0 * var_x45;
            const double var_x47 = pow(var_chaste_interface__INa_m_gate__m, 3);
            const double var_x48 = var_x47 * mParameters[1] * var_chaste_interface__INa_j_gate__j;
            ...
            const double var_x84 = (var_chaste_interface__ICaL__O + var_chaste_interface__ICaL__O_star) * mParameters[0];
            ...
            const double var_x111 = var_x41 * var_x43 * mParameters[2] * var_chaste_interface__IKr_xr_gate__xr / pow(var_x44, 2);
    ...
    double Celldecker_2009FromCellMLGRL1::EvaluatePartialDerivative41(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x483 * (-5.0 - var_x484 * var_x89) + (0.019557600000000001 / pow(var_x480, 3) + 8.1780000000000006e-5 / pow(var_x481, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x140 * var_x484) / pow(var_x482, 2);
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL1::EvaluatePartialDerivative42(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.14749262536873156 + var_x493 + 2.4740119415402899e-16 * var_x168 + 1.3314155043174696e-5 * var_x161 - 3.4616803112254212e-5 * var_x164 - 7.1319396379664657e-10 * var_x165 - 0.0016481422714144972 * var_x169 - 1.0712924764194231e-5 * var_x166 - 0.0035983988805915112 * var_x171;
        }
        else
        {
    ...
    double Celldecker_2009FromCellMLGRL1::EvaluatePartialDerivative46(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x499 + 0.00020047178518350236 * var_x183 + 26.711785007306684 * var_x507 - 4.5488726691040119e-6 * var_x178 - 0.00081995078002871237 * var_x184 - 0.0016481422714144972 * var_x182 - 0.0008405525584213936 * var_x179 - var_x181 * var_x505;
        }
        else
        {
