...
#include "MathsCustomFunctions.hpp"
    ...
    double Celllivshitz_rudy_2007FromCellMLGRL1::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_ICab__icab = (-0.5 * log(10) * log10(var_Environment__Ca_o / var_Ca__Ca_i) / var_Environment__FonRT + var_chaste_interface__cell__V) * var_ICab__gcab; // uA_per_uF
        ...
        const double var_reversal_potentials__ECa = 0.5 * log(10) * log10(var_Environment__Ca_o / var_Ca__Ca_i) / var_Environment__FonRT; // mV
        ...
        const double var_reversal_potentials__EK = log(10) * log10(var_Environment__K_o / var_chaste_interface__K__K_i) / var_Environment__FonRT; // mV
        ...
        const double var_reversal_potentials__EKs = log(10) * log10((var_Environment__Na_o * var_reversal_potentials__prnak + var_Environment__K_o) / (var_chaste_interface__Na__Na_i * var_reversal_potentials__prnak + var_chaste_interface__K__K_i)) / var_Environment__FonRT; // mV
