...
bool Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::registered = ModelFactory::Register("grandi_pasqualini_bers_2010_ss", "BackwardEuler", (ModelFactory::TCreateMethod)Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::CreateMethod);
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[27], double rJacobian[27][27])
    {
        ...
        const double var_x68 = var_chaste_interface__SR_Fluxes__Ry_Ro * mParameters[1];
        const double var_x69 = 64.935064935064929 * var_x68 + 1205.9369202226344 * mParameters[0];
        ...
        const double var_x83 = 100 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLH_sl;
        const double var_x84 = 100 * var_chaste_interface__Junctional_and_SL_Ca_Buffers__SLL_sl;
        const double var_x85 = 5.2281977629563632e-6 + pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 1.6000000000000001);
        const double var_x86 = 0.095835200000000009 * var_x31;
        const double var_x87 = pow(var_chaste_interface__Na_Concentrations__Na_sl, 3);
        const double var_x88 = var_x87 * mParameters[5];
        const double var_x89 = var_x38 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x90 = (1 + 278.55153203342621 * var_chaste_interface__Ca_Concentrations__Ca_sl) * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x91 = var_x38 * (1 + 0.00053869674493876331 * var_x87);
        const double var_x92 = 1 / (var_x88 + var_x89 + 669921.875 * var_x90 + 1.3 * var_x87 + 0.0035899999999999999 * var_x91);
        const double var_x93 = 1 + 2.2499999999999996e-8 / pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2);
        const double var_x94 = var_x48 / var_x93;
        const double var_x95 = var_x92 * var_x94;
        const double var_x96 = var_x39 * var_x95;
        const double var_x97 = -var_x52 - 373215529.24791086 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x98 = -var_x37 * var_x89 + var_x54 * var_x87 * mParameters[5];
        const double var_x99 = var_x94 * var_x98 / pow((var_x90 + 1.9405247813411081e-6 * var_x87 + 5.3588338192419823e-9 * var_x91 + 1.4927113702623908e-6 * var_x88 + 1.4927113702623908e-6 * var_x89), 2);
        const double var_x100 = 3.9661732781409103e-12 * var_x99;
        const double var_x101 = var_x48 * var_x92 * var_x98 / (pow(var_x93, 2) * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 3));
        const double var_x102 = var_x59 * (1 - var_chaste_interface__I_Ca__f_Ca_Bsl);
        const double var_x103 = 2379535990481.856 * var_x66;
        const double var_x104 = 100 * var_chaste_interface__Ca_Concentrations__Ca_sl;
        const double var_x105 = 0.029999999999999999 + var_x104;
        const double var_x106 = 1.3 + var_x104;
        const double var_x107 = pow(var_chaste_interface__Na_Concentrations__Na_sl, 2);
        const double var_x108 = -3.9000000000000004 * var_x107 - var_x107 * var_x78 - var_x107 * var_x79;
        const double var_x109 = var_x107 * var_x81 * var_x95;
        const double var_x110 = 0.001 + 0.0001 * var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x111 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bj;
        const double var_x112 = 0.001 + 0.0001 * var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x113 = 0.0001 * var_chaste_interface__Na_Buffers__Na_Bsl;
        const double var_x114 = var_x3 * mParameters[3];
        const double var_x115 = 0.23994508763098885 * var_x114;
        const double var_x116 = 7.3530178752050587e-13 * var_x56;
        const double var_x117 = var_x114 * var_x65;
        const double var_x118 = -0.75 * mParameters[8];
        const double var_x119 = exp(var_x36);
        const double var_x120 = 0.75 * var_x119;
        const double var_x121 = var_x62 / (-1 + var_x119);
        const double var_x122 = var_x114 * var_x121 * var_x72;
        const double var_x123 = 3.2338732908121872 * var_x3;
        const double var_x124 = var_x34 / var_chaste_interface__Na_Concentrations__Na_j;
        const double var_x125 = mParameters[21] * mParameters[7] / ((1.5 + mParameters[7]) * (1 + 0.1245 * exp(-0.10000000000000001 * var_x36) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * mParameters[8])) * exp(-var_x36)));
        const double var_x126 = pow(var_chaste_interface__I_Na__m, 3) * var_chaste_interface__I_Na__h * var_chaste_interface__I_Na__j * mParameters[12];
        const double var_x127 = var_x119 * var_x121;
        const double var_x128 = 5.9492599172113663e-12 * var_x99;
        const double var_x129 = var_x34 / var_chaste_interface__Na_Concentrations__Na_sl;
        const double var_x130 = var_x68 + 18.571428571428569 * mParameters[0];
        ...
        const double var_x138 = 1 - var_chaste_interface__SR_Fluxes__Ry_Ri - var_chaste_interface__SR_Fluxes__Ry_Ro - var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x139 = 1 / (15 - 14 * var_x136);
        const double var_x140 = 20 * var_x139 * var_chaste_interface__Ca_Concentrations__Ca_j;
        const double var_x141 = pow(var_x135, (-2));
        const double var_x142 = var_x133 * var_x134 * var_x141;
        const double var_x143 = 2.3772197685794643 * var_x142 * var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Ro;
        const double var_x144 = 0.21130842387373014 * var_x142 * var_x46 / pow((1 - 0.93333333333333335 * var_x136), 2);
        const double var_x145 = 10 * var_x139 * var_x46;
        const double var_x146 = -var_x137;
        const double var_x147 = var_x140 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        const double var_x148 = var_x144 * var_chaste_interface__SR_Fluxes__Ry_Rr;
        ...
        rJacobian[2][2] = 1.0 - (mDt * (-165.10000000000002 + var_x83 + var_x84 - 19.504723378941105 * var_x3 - var_x103 * (1.78 * var_x96 - 8.0099999999999983e-8 * var_x101 - var_x100 * var_x97 + 0.00024532850000000001 * var_x34 / var_chaste_interface__Ca_Concentrations__Ca_sl + 3.3145199999999996e-5 * var_x102 * var_x64 + var_x86 * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 0.60000000000000009) / var_x85 - var_x86 * pow(var_chaste_interface__Ca_Concentrations__Ca_sl, 2.2000000000000002) / pow(var_x85, 2))));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        ...
        rJacobian[2][12] = 0.0;
        rJacobian[2][13] = -(mDt * (var_x105));
        rJacobian[2][14] = 0.0;
        rJacobian[2][15] = -(mDt * (var_x106));
        rJacobian[2][16] = 0.0;
        rJacobian[2][17] = 0.0;
        rJacobian[2][18] = 0.0;
        rJacobian[2][19] = 0.0;
        rJacobian[2][20] = 0.0;
        rJacobian[2][21] = -(mDt * (-var_x103 * (-5.3399999999999999 * var_x109 - var_x100 * var_x108)));
        rJacobian[2][22] = 0.0;
        rJacobian[2][23] = 0.0;
        rJacobian[2][24] = 0.0;
        rJacobian[2][25] = 0.0;
        ...
        rJacobian[13][0] = 0.0;
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = -(mDt * (43.550000000000004 - var_x83));
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = 0.0;
        ...
        rJacobian[13][11] = 0.0;
        rJacobian[13][12] = 0.0;
        rJacobian[13][13] = 1.0 - (mDt * (-var_x105));
        rJacobian[13][14] = 0.0;
        rJacobian[13][15] = 0.0;
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        ...
        rJacobian[15][0] = 0.0;
        rJacobian[15][1] = 0.0;
        rJacobian[15][2] = -(mDt * (121.55000000000001 - var_x84));
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = 0.0;
        rJacobian[15][5] = 0.0;
        rJacobian[15][6] = 0.0;
        ...
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = 0.0;
        rJacobian[17][17] = 1.0 - (mDt * (-var_x110));
        rJacobian[17][18] = 0.0;
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = -(mDt * (0.0007561 - var_x111));
        rJacobian[17][21] = 0.0;
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = 0.0;
        rJacobian[17][24] = 0.0;
        ...
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-var_x112));
        rJacobian[18][19] = 0.0;
        rJacobian[18][20] = 0.0;
        rJacobian[18][21] = -(mDt * (0.000165 - var_x113));
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        rJacobian[18][25] = 0.0;
        ...
        rJacobian[19][17] = 0.0;
        rJacobian[19][18] = 0.0;
        rJacobian[19][19] = 1.0 - (mDt * (-var_x115));
        rJacobian[19][20] = 0.0;
        rJacobian[19][21] = -(mDt * (var_x115));
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = 0.0;
        rJacobian[19][26] = 0.0;
        rJacobian[20][0] = 0.0;
        rJacobian[20][1] = -(mDt * (-176588941779729.56 * var_x117 * (1.4849999999999997e-8 * var_x58 - 0.33000000000000002 * var_x51 + var_x116 * var_x53)));
        rJacobian[20][2] = 0.0;
        rJacobian[20][3] = 0.0;
        rJacobian[20][4] = 0.0;
        rJacobian[20][5] = 0.0;
        ...
        rJacobian[20][8] = 0.0;
        rJacobian[20][9] = 0.0;
        rJacobian[20][10] = -(mDt * (536388.91065592843 * var_x122 * (var_x118 + var_x120 * var_chaste_interface__Na_Concentrations__Na_j)));
        rJacobian[20][11] = 0.0;
        rJacobian[20][12] = 0.0;
        rJacobian[20][13] = 0.0;
        rJacobian[20][14] = 0.0;
        ...
        rJacobian[21][0] = 0.0;
        rJacobian[21][1] = 0.0;
        rJacobian[21][2] = -(mDt * (-4759071980963.7119 * var_x117 * (1.2014999999999997e-7 * var_x101 - 2.6699999999999999 * var_x96 + var_x128 * var_x97)));
        rJacobian[21][3] = 0.0;
        rJacobian[21][4] = 0.0;
        rJacobian[21][5] = 0.0;
        rJacobian[21][6] = 0.0;
        ...
        rJacobian[21][9] = 0.0;
        rJacobian[21][10] = 0.0;
        rJacobian[21][11] = -(mDt * (1606.1867935752523 * var_x122 * (var_x118 + var_x120 * var_chaste_interface__Na_Concentrations__Na_sl)));
        rJacobian[21][12] = 0.0;
        rJacobian[21][13] = 0.0;
        rJacobian[21][14] = 0.0;
        rJacobian[21][15] = 0.0;
        rJacobian[21][16] = 0.0;
        rJacobian[21][17] = 0.0;
        rJacobian[21][18] = -(mDt * (var_x112 * mParameters[3]));
        rJacobian[21][19] = -(mDt * (7.7982153480071377 * var_x114));
        rJacobian[21][20] = -(mDt * (0.087152885187388451 * var_x114));
        rJacobian[21][21] = 1.0 - (mDt * ((-0.000165 + var_x113 - 7.8853682331945256 * var_x3 - 4759071980963.7119 * var_x66 * (0.00053133 * var_x129 + 8.0099999999999998 * var_x109 + var_x108 * var_x128 + 2.5312499999999994e-10 * var_x102 * var_x127 + 0.89000000000000001 * var_x126 * var_x129 + 0.00072945837032989554 * var_x125 / (pow((6.8301345536507063e-5 + pow(var_chaste_interface__Na_Concentrations__Na_sl, (-4))), 2) * pow(var_chaste_interface__Na_Concentrations__Na_sl, 5)))) * mParameters[3]));
        rJacobian[21][22] = 0.0;
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        ...
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (-260 + var_x131 - var_x130 - 0.69232869146389786 * var_x25 - 8.7400597733819945e-14 * var_x26));
        ...
        rJacobian[23][26] = 0.0;
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = -(mDt * (var_x137 * var_chaste_interface__SR_Fluxes__Ry_Ro + var_x138 * var_x140));
        rJacobian[24][2] = 0.0;
        rJacobian[24][3] = 0.0;
        rJacobian[24][4] = 0.0;
        rJacobian[24][5] = 0.0;
        ...
        rJacobian[24][20] = 0.0;
        rJacobian[24][21] = 0.0;
        rJacobian[24][22] = -(mDt * (-var_x143 + var_x138 * var_x144));
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-0.065000000000000002 - var_x145));
        rJacobian[24][25] = -(mDt * (-var_x145 + var_x137 * var_chaste_interface__Ca_Concentrations__Ca_j));
        rJacobian[24][26] = -(mDt * (-var_x145));
        rJacobian[25][0] = 0.0;
        rJacobian[25][1] = -(mDt * (var_x147 + var_x146 * var_chaste_interface__SR_Fluxes__Ry_Ro));
        rJacobian[25][2] = 0.0;
        rJacobian[25][3] = 0.0;
        rJacobian[25][4] = 0.0;
        rJacobian[25][5] = 0.0;
        ...
        rJacobian[25][20] = 0.0;
        rJacobian[25][21] = 0.0;
        rJacobian[25][22] = -(mDt * (var_x143 + var_x148));
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = -(mDt * (0.0050000000000000001));
        rJacobian[25][25] = 1.0 - (mDt * (-0.059999999999999998 + var_x146 * var_chaste_interface__Ca_Concentrations__Ca_j));
        rJacobian[25][26] = -(mDt * (var_x145));
        rJacobian[26][0] = 0.0;
        rJacobian[26][1] = -(mDt * (-var_x147 + var_x146 * var_chaste_interface__SR_Fluxes__Ry_Rr));
        rJacobian[26][2] = 0.0;
        rJacobian[26][3] = 0.0;
        rJacobian[26][4] = 0.0;
        rJacobian[26][5] = 0.0;
        ...
        rJacobian[26][20] = 0.0;
        rJacobian[26][21] = 0.0;
        rJacobian[26][22] = -(mDt * (-var_x148 + 2.3772197685794643 * var_x133 * var_x134 * var_x141 * var_chaste_interface__Ca_Concentrations__Ca_j * var_chaste_interface__SR_Fluxes__Ry_Rr));
        rJacobian[26][23] = 0.0;
        rJacobian[26][24] = -(mDt * (-0.0050000000000000001));
        rJacobian[26][25] = -(mDt * (0.055));
        rJacobian[26][26] = 1.0 - (mDt * (-0.0050000000000000001 - var_x145 + var_x146 * var_chaste_interface__Ca_Concentrations__Ca_j));
    }
    ...
    void Cellgrandi_pasqualini_bers_2010_ssFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_I_Na__hss = 0.01 * mParameters[13] + (1 - 0.01 * mParameters[13]) / pow((1 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * mParameters[14])), 2);
        const double var_I_Na__jss = 0.01 * mParameters[13] + (1 - 0.01 * mParameters[13]) / pow((1 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane_potential__V_m - 0.13458950201884254 * mParameters[14])), 2);
