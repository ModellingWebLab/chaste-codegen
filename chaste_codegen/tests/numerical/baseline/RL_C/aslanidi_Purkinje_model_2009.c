...
void compute()
{
   // time: time (millisecond)
    ...
    g_leak = 1 / R_seal;
    tau_f_Ca = 0.5 + 1 / (1 + 333.33333333333331 * Y[27]) + 10 * Ca_MK_act / (Ca_MK_act + km_Ca_MK);
    ...
    if ((Y[0] >= -1.3356169352749131e-6) && (Y[0] <= 1.3356169352749131e-6))
        i_Ca_b = 374358.83507802623 * (1.3356169352749131e-6 + Y[0]) * (3.8499135947999997e-9 * (-0.34100000000000003 * Ca_o + Y[1] * exp(9.9999999999999995e-8)) / (-1 + exp(9.9999999999999995e-8)) + 3.8499135947999997e-9 * (-0.34100000000000003 * Ca_o + Y[1] * exp(-9.9999999999999995e-8)) / (-1 + exp(-9.9999999999999995e-8))) - 3.8499135947999997e-9 * (-0.34100000000000003 * Ca_o + Y[1] * exp(-9.9999999999999995e-8)) / (-1 + exp(-9.9999999999999995e-8))
    else 
        i_Ca_b = 0.0028824983370007683 * (-0.34100000000000003 * Ca_o + Y[1] * exp(0.074871767015605231 * Y[0])) * Y[0] / (-1 + exp(0.074871767015605231 * Y[0]))

    if ((Y[0] >= 14.999998664383064) && (Y[0] <= 15.000001335616936))
        i_Ca_L_max = 374358.83507888648 * (-14.999998664383064 + Y[0]) * (4.6891709999892238e-6 * (-0.34100000000000003 * Ca_o + Y[27] * exp(9.9999999999770198e-8)) / (-1 + exp(9.9999999999770198e-8)) + 4.6891709999892238e-6 * (-0.34100000000000003 * Ca_o + Y[27] * exp(-9.9999999999770198e-8)) / (-1 + exp(-9.9999999999770198e-8))) - 4.6891709999892238e-6 * (-0.34100000000000003 * Ca_o + Y[27] * exp(-9.9999999999770198e-8)) / (-1 + exp(-9.9999999999770198e-8))
    else 
        i_Ca_L_max = 3.510865186083326 * (-15 + Y[0]) * (-0.34100000000000003 * Ca_o + Y[27] * exp(-1.1230765052340785 + 0.074871767015605231 * Y[0])) / (-1 + exp(-1.1230765052340785 + 0.074871767015605231 * Y[0]))
    ...
    i_NaK = f_NaK * g_NaK * K_o / ((1 + pow(km_Na_i_2, 2) / pow(Y[21], 2)) * (km_K_o + K_o));
