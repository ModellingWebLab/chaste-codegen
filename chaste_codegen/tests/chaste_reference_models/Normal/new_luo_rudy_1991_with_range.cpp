...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnew_luo_rudy_1991_with_rangeFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_fast_sodium_current__g_Na = 23.0; // milliS_per_cm2
        ...
        const double var_slow_inward_current__P_si = 0.089999999999999997; // milliS_per_cm2
        const double var_slow_inward_current__i_si = (-var_slow_inward_current__E_si + var_chaste_interface__membrane__V) * var_slow_inward_current__P_si * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f; // microA_per_cm2
        ...
        const double var_time_dependent_potassium_current__g_K_max = 0.28199999999999997; // milliS_per_cm2
        const double var_time_dependent_potassium_current__g_K = 0.43033148291193518 * sqrt(var_ionic_concentrations__Ko) * var_time_dependent_potassium_current__g_K_max; // milliS_per_cm2
        ...
        const double var_time_independent_potassium_current__g_K1_max = 0.60470000000000002; // milliS_per_cm2
    ...
    void Cellnew_luo_rudy_1991_with_rangeFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = ((var_chaste_interface__membrane__V < -40.0) ? (0.13500000000000001 * exp(-11.764705882352942 + 0.14705882352941177 * var_fast_sodium_current__shift_INa_inact - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0.0)); // per_millisecond
        const double var_fast_sodium_current_h_gate__beta_h = ((var_chaste_interface__membrane__V < -40.0) ? (310000.0 * exp(0.34999999999999998 * var_chaste_interface__membrane__V - 0.34999999999999998 * var_fast_sodium_current__shift_INa_inact) + 3.5600000000000001 * exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * var_fast_sodium_current__shift_INa_inact)) : (7.6923076923076916 / (1.0 + exp(-0.96036036036036043 + 0.0900900900900901 * var_fast_sodium_current__shift_INa_inact - 0.0900900900900901 * var_chaste_interface__membrane__V)))); // per_millisecond
        ...
        const double var_fast_sodium_current_j_gate__alpha_j = ((var_chaste_interface__membrane__V < -40.0) ? ((37.780000000000001 + var_chaste_interface__membrane__V) * (-127140.0 * exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * var_fast_sodium_current__shift_INa_inact) - 3.4740000000000003e-5 * exp(0.043909999999999998 * var_fast_sodium_current__shift_INa_inact - 0.043909999999999998 * var_chaste_interface__membrane__V)) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * var_fast_sodium_current__shift_INa_inact))) : (0.0)); // per_millisecond
        const double var_fast_sodium_current_j_gate__beta_j = ((var_chaste_interface__membrane__V < -40.0) ? (0.1212 * exp(0.01052 * var_fast_sodium_current__shift_INa_inact - 0.01052 * var_chaste_interface__membrane__V) / (1.0 + exp(-5.5312920000000005 + 0.13780000000000001 * var_fast_sodium_current__shift_INa_inact - 0.13780000000000001 * var_chaste_interface__membrane__V))) : (0.29999999999999999 * exp(2.5349999999999999e-7 * var_fast_sodium_current__shift_INa_inact - 2.5349999999999999e-7 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.2000000000000002 + 0.10000000000000001 * var_fast_sodium_current__shift_INa_inact - 0.10000000000000001 * var_chaste_interface__membrane__V)))); // per_millisecond
