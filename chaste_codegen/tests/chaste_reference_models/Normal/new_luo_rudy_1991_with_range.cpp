...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnew_luo_rudy_1991_with_rangeFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_fast_sodium_current__E_Na = var_membrane__R * var_membrane__T * log(10) * log10(mParameters[3] / mParameters[1]) / var_membrane__F; // millivolt
        ...
        const double var_slow_inward_current__E_si = 7.7000000000000002 - 13.028700000000001 * log(10) * log10(var_chaste_interface__intracellular_calcium_concentration__Cai); // millivolt
        ...
        const double var_time_dependent_potassium_current__E_K = var_membrane__R * var_membrane__T * log(10) * log10((mParameters[3] * var_time_dependent_potassium_current__PR_NaK + mParameters[2]) / (mParameters[1] * var_time_dependent_potassium_current__PR_NaK + mParameters[0])) / var_membrane__F; // millivolt
        ...
        const double var_time_independent_potassium_current__E_K1 = var_membrane__R * var_membrane__T * log(10) * log10(mParameters[2] / mParameters[0]) / var_membrane__F; // millivolt
