...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmahajan_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x28 = pow(var_chaste_interface__Ca__Ca_i_converted, 3);
        const double var_x29 = 1.0 + 1.2500000000000001e-10 / var_x28;
        const double var_x30 = -0.1386 - 0.11088000000000001 / var_x29;
        const double var_x31 = var_x30 * NV_Ith_S(mParameters, 1) * var_chaste_interface__IKs__xs2;
        const double var_x32 = var_x31 * var_chaste_interface__IKs__xs1;
        const double var_x33 = 86.398763985973389 + var_chaste_interface__cell__V;
        const double var_x34 = var_x5 / pow(var_x6, 2);
        const double var_x35 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x36 = exp(0.013186938812558063 * var_chaste_interface__cell__V);
        const double var_x37 = var_x35 * var_x36;
        const double var_x38 = exp(-0.024490029223322121 * var_chaste_interface__cell__V);
        const double var_x39 = var_x38 * var_chaste_interface__Ca__Ca_submem;
        const double var_x40 = 1 / (12405.2022 + 7.9663561662386391 * var_x35 + 4115.8113750000002 * var_chaste_interface__Ca__Ca_submem);
        const double var_x41 = 1.0 + 0.20000000000000001 * var_x38;
        const double var_x42 = 1 / var_x41;
        const double var_x43 = 1.0 + 0.026999999999999996 / pow(var_chaste_interface__Ca__Ca_submem, 3);
        const double var_x44 = 1 / var_x43;
        const double var_x45 = var_x42 * var_x44;
        const double var_x46 = var_x40 * var_x45;
        const double var_x47 = var_x46 * (0.023736489862604515 * var_x37 + 61.603590949980969 * var_x39);
        const double var_x48 = 1 / (12.0 + var_chaste_interface__Na__Na_i);
        const double var_x49 = exp(-0.0037676968035880187 * var_chaste_interface__cell__V);
        const double var_x50 = exp(2.0208023774145616);
        const double var_x51 = exp(-0.037676968035880186 * var_chaste_interface__cell__V);
        const double var_x52 = 1.0 + 0.1245 * var_x49 + 0.036499999999999998 * var_x51 * (-0.14285714285714285 + 0.14285714285714285 * var_x50);
        const double var_x53 = var_x48 * (0.00046907825204670832 * var_x49 + 0.037676968035880186 * var_x51 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x50)) * var_chaste_interface__Na__Na_i / pow(var_x52, 2);
        const double var_x54 = 1.8 * var_x37 - 2515.4560000000001 * var_x39;
        const double var_x55 = var_x40 * var_x54;
        const double var_x56 = var_x38 * var_x44 * var_x55 / pow(var_x41, 2);
        const double var_x57 = -9.5038640384570741 - 0.11 * var_chaste_interface__cell__V;
        const double var_x58 = var_x20 * var_x57;
        const double var_x59 = var_x17 / pow(var_x18, 2);
        const double var_x60 = var_x32 - 6.7199999999999998 * var_x47 - 1.173913043478261 * var_x53 - 0.032914599276144929 * var_x56 + var_x20 * (-0.055 * var_x19 - 0.11 * var_chaste_interface__Ito__ytos) - var_x23 * var_chaste_interface__INa__xh - var_x24 * var_x27 - 0.040000000000000001 * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof - 0.30599999999999999 * var_x15 * var_x7 - 0.050000000000000003 * var_x58 * var_x59 + 0.07298099999999999 * var_x15 * var_x33 * var_x34 + 0.00055803571428571436 * var_x24 * var_x25 * var_x33 / pow(var_x26, 2) - 0.29411764705882354 * var_x33 * var_x7 * (0.24326999999999999 * var_x34 - var_x10 * (0.061749999999999999 * var_x11 + 0.039456396800000001 * var_x12) - 0.51429999999999998 * var_x13 * var_x8 / pow(var_x9, 2)) / pow((var_x7 + 0.98039215686274506 * var_x14), 2);
        const double var_x61 = fabs(var_x1) < 0.001;
        const double var_x62 = -1.0 + var_x2;
        const double var_x63 = 1 / var_x62;
        const double var_x64 = -0.61380000000000001 + 0.001 * var_x3;
        const double var_x65 = var_x63 * var_x64;
        const double var_x66 = var_x0 * var_x65;
        const double var_x67 = var_x0 * var_x2;
        const double var_x68 = var_x64 * var_chaste_interface__cell__V / pow(var_x62, 2);
        const double var_x69 = var_x67 * var_x68;
        const double var_x70 = var_x63 * var_chaste_interface__cell__V;
        const double var_x71 = var_x4 * var_x70;
        const double var_x72 = -26.541413816729872 * log(7.8928799999999999 / (140.0 + 0.018329999999999999 * var_chaste_interface__Na__Na_i)) + var_chaste_interface__cell__V;
        const double var_x73 = var_x72 * NV_Ith_S(mParameters, 1) * var_chaste_interface__IKs__xs1;
        const double var_x74 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x75 = -26.541413816729872 * log(136.0 * var_x74) + var_chaste_interface__cell__V;
        const double var_x76 = var_x75 * var_chaste_interface__INa__xh;
        const double var_x77 = var_x76 * pow(var_chaste_interface__INa__xm, 2) * var_chaste_interface__INa__xj;
        const double var_x78 = var_x21 * var_x76;
        const double var_x79 = var_x65 * var_chaste_interface__cell__V;
        const double var_x80 = ((var_x61) ? (-186.25303080883702 + 0.30344253960384004 * var_x3) : (22.865589730760373 * var_x79));
        const double var_x81 = -3.4559505594389357 - 0.040000000000000001 * var_chaste_interface__cell__V;
        const double var_x82 = 1 / var_x52;
        const double var_x83 = var_x48 * var_x82;
        const double var_x84 = var_x82 * var_chaste_interface__Na__Na_i / pow((1 + 0.083333333333333329 * var_chaste_interface__Na__Na_i), 2);
        const double var_x85 = var_x22 * var_x74 * var_chaste_interface__INa__xh;
        const double var_x86 = pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x87 = var_x45 * var_x54 / pow((1 + 0.0006421786632577935 * var_x35 + 0.33178107931203249 * var_chaste_interface__Ca__Ca_submem), 2);
        const double var_x88 = var_x86 * var_x87;
        const double var_x89 = var_x36 * var_x46 * var_x86;
        const double var_x90 = var_x38 * var_x46;
        const double var_x91 = var_x42 * var_x55 / (pow(var_x43, 2) * pow(var_chaste_interface__Ca__Ca_submem, 4));
        const double var_x92 = 16903.864320000001 * var_x90 + 0.00017972853783688092 * var_x87 - 0.54431999999999992 * var_x91;
        const double var_x93 = var_x67 * var_x70;
        const double var_x94 = 32.700000000000003 * var_chaste_interface__Ca__tropi;
        const double var_x95 = pow(var_chaste_interface__Ca__Ca_i_converted, 2);
        const double var_x96 = 0.80000000000000004 * var_x28 / pow((2.4999999999999999e-7 + var_x95), 2);
        const double var_x97 = pow(var_chaste_interface__Ca__Ca_NSR, 2);
        const double var_x98 = 1 / (2500.0 + var_x97);
        const double var_x99 = var_x97 * var_x98;
        const double var_x100 = 0.02069 * var_x99;
        const double var_x101 = 1 / (0.25 + 1000000.0 * var_x95);
        const double var_x102 = 800000.0 * var_x101 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x103 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x104 = 0.012999999999999999 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x105 = 0.00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x106 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x107 = 1.0 + 0.00016799999999999999 / pow(var_x103, 2) + 0.00054599999999999994 / pow(var_x104, 2) + 4.4999999999999993e-6 / pow(var_x105, 2) + 2.8199999999999998e-5 / pow(var_x106, 2);
        const double var_x108 = 1 / var_x107;
        const double var_x109 = 0.001 * var_x108;
        const double var_x110 = 32.700000000000003 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x111 = 400000.0 * var_x101 * var_x95;
        const double var_x112 = 16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x113 = 2.069e-5 * var_x112 * var_x99;
        const double var_x114 = 0.00034484023000000001 * var_x99;
        const double var_x115 = 4.138e-5 * var_x112 * var_x98 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x116 = 6.6208000000000002e-12 * var_x112 * pow(var_chaste_interface__Ca__Ca_NSR, 3) / pow((1 + 0.00040000000000000002 * var_x97), 2);
        const double var_x117 = 1.0 - var_chaste_interface__INa__xm;
        const double var_x118 = -0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x119 = exp(-4.7130000000000001 + var_x118);
        const double var_x120 = 1.0 - var_x119;
        const double var_x121 = 0.32000000000000001 / var_x120;
        const double var_x122 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x123 = 0.0072727272727272727 * var_x122 * var_chaste_interface__INa__xm;
        const double var_x124 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x125 = fabs(var_x124) > 0.001;
        const double var_x126 = -0.080000000000000002 * var_x122;
        const double var_x127 = exp(0.079000000000000001 * var_chaste_interface__cell__V);
        const double var_x128 = exp(0.34999999999999998 * var_chaste_interface__cell__V);
        const double var_x129 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x130 = var_chaste_interface__cell__V < -40.0;
        const double var_x131 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x132 = 1.0 + var_x131;
        const double var_x133 = 1.0 - var_chaste_interface__INa__xj;
        const double var_x134 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
        const double var_x135 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x136 = -127140.0 * var_x134 - 3.4740000000000003e-5 * var_x135;
        const double var_x137 = var_x133 * var_x136;
        const double var_x138 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V);
        const double var_x139 = 1.0 + var_x138;
        const double var_x140 = 1.0 / var_x139;
        const double var_x141 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x142 = 1.0 + var_x141;
        const double var_x143 = exp(-0.01052 * var_chaste_interface__cell__V);
        const double var_x144 = var_x143 / var_x142;
        const double var_x145 = 37.780000000000001 + var_chaste_interface__cell__V;
        const double var_x146 = var_x140 * var_x145;
        const double var_x147 = exp(-3.2000000000000002 + var_x118);
        const double var_x148 = 1.0 + var_x147;
        const double var_x149 = exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V);
        const double var_x150 = var_x149 / var_x148;
        const double var_x151 = exp(-0.125 * var_chaste_interface__cell__V);
        const double var_x152 = 1.0 + var_x151;
        const double var_x153 = var_x151 / pow(var_x152, 2);
        const double var_x154 = 0.125 * var_x153;
        const double var_x155 = var_x154 * var_chaste_interface__ICaL__c1;
        const double var_x156 = 1 / var_x152;
        const double var_x157 = 1.0 * var_x156;
        const double var_x158 = pow(var_chaste_interface__Ca__Ca_dyad, 3);
        const double var_x159 = 1 / var_x158;
        const double var_x160 = 1 / (1.0 + 27.0 * var_x159);
        const double var_x161 = pow(var_chaste_interface__Ca__Ca_dyad, 4);
        const double var_x162 = 1 / var_x161;
        const double var_x163 = var_x162 / pow((0.037037037037037035 + var_x159), 2);
        const double var_x164 = 0.002685333333333333 * var_x163 * var_chaste_interface__ICaL__c1;
        const double var_x165 = exp(-10.0 - 0.25 * var_chaste_interface__cell__V);
        const double var_x166 = 1.0 + var_x165;
        const double var_x167 = 1.0 - 1.0 / var_x166;
        const double var_x168 = exp(0.064102564102564111 * var_chaste_interface__cell__V);
        const double var_x169 = 4954.0 * var_x168;
        const double var_x170 = -440.0 + var_x169;
        const double var_x171 = var_x167 * var_x170;
        const double var_x172 = 1 / (450.0 + var_x171);
        const double var_x173 = exp(-3.5335689045936394 - 0.088339222614840993 * var_chaste_interface__cell__V);
        const double var_x174 = 1.0 + var_x173;
        const double var_x175 = 0.088339222614840993 * var_x173 / pow(var_x174, 2);
        const double var_x176 = var_x172 * var_x175;
        const double var_x177 = 1 / var_x174;
        const double var_x178 = -317.5641025641026 * var_x167 * var_x168;
        const double var_x179 = 0.25 * var_x165 / pow(var_x166, 2);
        const double var_x180 = 4.9382716049382717e-6 * (var_x178 + var_x170 * var_x179) / pow((1 + 0.0022222222222222222 * var_x171), 2);
        const double var_x181 = var_x177 * var_x180;
        const double var_x182 = 1.0 + 0.00072525373756441506 * var_x161;
        const double var_x183 = 1 / var_x182;
        const double var_x184 = 78.032899999999998 * var_x183;
        const double var_x185 = 9.9000000000000004 + var_x169 - var_x184;
        const double var_x186 = var_x167 * var_x185;
        const double var_x187 = 1 / (0.10000000000000001 + var_x184 + var_x186);
        const double var_x188 = var_x160 * var_x187;
        const double var_x189 = var_x175 * var_x188;
        const double var_x190 = 0.00016422697956757767 / pow((0.0012815107473898831 + var_x183 + 0.012815107473898831 * var_x186), 2);
        const double var_x191 = var_x190 * (var_x178 + var_x179 * var_x185);
        const double var_x192 = var_x160 * var_x177;
        const double var_x193 = var_x191 * var_x192;
        const double var_x194 = 1.0 * var_x177;
        const double var_x195 = 1.0 - var_x194;
        const double var_x196 = var_x180 * var_x195;
        const double var_x197 = var_x191 * var_x195;
        const double var_x198 = var_x175 * var_x187;
        const double var_x199 = -var_x157;
        const double var_x200 = 1.0 + var_x199;
        const double var_x201 = var_x172 * var_x194;
        const double var_x202 = var_x188 * var_x194;
        const double var_x203 = var_x187 * var_x195;
        const double var_x204 = var_x172 * var_x195;
        const double var_x205 = 0.22637460951196098 * var_x158 / pow(var_x182, 2);
        const double var_x206 = var_x190 * (var_x205 - var_x167 * var_x205);
        const double var_x207 = var_x192 * var_x206;
        const double var_x208 = 0.1111111111111111 * var_x163 * var_x177 * var_x187;
        const double var_x209 = var_x195 * var_chaste_interface__ICaL__xi2ca;
        const double var_x210 = var_x206 * var_x209;
        const double var_x211 = exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V);
        const double var_x212 = 1.0 + var_x211;
        const double var_x213 = var_x211 / pow(var_x212, 2);
        const double var_x214 = 0.1111111111111111 * var_x213;
        const double var_x215 = var_x214 * var_chaste_interface__ICaL__xi1ca;
        const double var_x216 = 0.33333333333333331 / var_x212;
        const double var_x217 = 0.33333333333333331 - var_x216;
        const double var_x218 = 1 / var_x200;
        const double var_x219 = var_x156 * var_x218;
        const double var_x220 = var_x173 * var_x217 * var_x219;
        const double var_x221 = 20.604954226274931 * var_x220;
        const double var_x222 = var_x177 * var_x221;
        const double var_x223 = var_x153 * var_x218;
        const double var_x224 = var_x174 * var_x217;
        const double var_x225 = 29.156010230179024 * var_x209 * var_x224;
        const double var_x226 = var_x151 / (pow(var_x152, 3) * pow(var_x200, 2));
        const double var_x227 = -0.018268800000000002 * var_x160;
        const double var_x228 = 41.377027474346242 + 1117.1797418073486 * var_x159;
        const double var_x229 = var_x195 * var_x224;
        const double var_x230 = var_x219 * var_x229;
        const double var_x231 = 233.2480818414322 * var_x230;
        const double var_x232 = var_x214 * var_chaste_interface__ICaL__xi1ba;
        const double var_x233 = 0.16287544169611309 * var_x220;
        const double var_x234 = var_x177 * var_x233;
        const double var_x235 = var_x195 * var_x233;
        const double var_x236 = 0.23046875000000003 * var_x229;
        const double var_x237 = var_x223 * var_x236;
        const double var_x238 = var_x226 * var_x236;
        const double var_x239 = var_x174 * var_x195 * var_x213 * var_x219;
        const double var_x240 = 0.20486111111111113 * var_x239;
        const double var_x241 = 1.8437500000000002 * var_x230;
        const double var_x242 = 29.156010230179024 * var_x229;
        const double var_x243 = exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x244 = 1.0 + var_x243;
        const double var_x245 = -var_chaste_interface__IKr__xr + 1.0 / var_x244;
        ...
        const double var_x250 = var_x248 - 0.00016973999999999998 * var_x246 * var_x249 / pow(var_x247, 2);
        const double var_x251 = exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V);
        ...
        const double var_x255 = var_x253 - 8.8449999999999995e-5 * var_x251 * var_x254 / pow(var_x252, 2);
        const double var_x256 = var_x253 * var_x254;
        const double var_x257 = var_x248 * var_x249;
        const double var_x258 = var_x243 / pow(var_x244, 2);
        const double var_x259 = 0.13333333333333333 * var_x258;
        const double var_x260 = fabs(var_x249) > 0.001;
        const double var_x261 = fabs(var_x254) > 0.001;
        const double var_x262 = (var_x260) && (var_x261);
        const double var_x263 = -var_x256;
        const double var_x264 = -var_x257;
        const double var_x265 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        const double var_x266 = 1.0 + var_x265;
        const double var_x267 = var_x265 / pow(var_x266, 2);
        const double var_x268 = 30.0 + var_chaste_interface__cell__V;
        const double var_x269 = fabs(var_x268) < 0.014556040756914121;
        const double var_x270 = 1.0 / var_x266;
        const double var_x271 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V);
        const double var_x272 = -1.0 + var_x271;
        const double var_x273 = 1 / var_x272;
        const double var_x274 = 0.00013100000000000001 * var_x273;
        const double var_x275 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V);
        const double var_x276 = 1.0 - var_x275;
        const double var_x277 = 1 / var_x276;
        const double var_x278 = 7.1899999999999999e-5 * var_x277;
        const double var_x279 = var_x268 * var_x271 / pow(var_x272, 2);
        const double var_x280 = var_x268 * var_x275 / pow(var_x276, 2);
        const double var_x281 = var_x268 * var_x274;
        const double var_x282 = var_x268 * var_x278;
        const double var_x283 = 0.059880239520958084 * var_x267;
        const double var_x284 = 3.2750000000000003e-5 * var_x273;
        const double var_x285 = 1.7975e-5 * var_x277;
        const double var_x286 = var_x268 * var_x284;
        const double var_x287 = var_x268 * var_x285;
        ...
        const double var_x296 = 1.0 / var_x294;
        const double var_x297 = exp(6.0 + var_x16);
        const double var_x298 = 1.0 + var_x297;
        const double var_x299 = 1 / var_x298;
        const double var_x300 = 1 / (30.0 + 3000.0 * var_x299);
        const double var_x301 = 0.10000000000000001 * var_x59;
        const double var_x302 = 1.0 * var_x19;
        const double var_x303 = exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2));
        const double var_x304 = 1 / (1.5 + 3.5 * var_x303);
        const double var_x305 = 1 / (20.0 + 20.0 * var_x19);
        const double var_x306 = -50.0 + 1.0 * var_chaste_interface__Irel__Ca_JSR;
        const double var_x307 = -0.063960518821716009 + 0.00010420416882000001 * var_x3;
        const double var_x308 = fabs(var_x307);
        const double var_x309 = var_x308 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x310 = var_x306 * var_x309;
        const double var_x311 = var_x0 * var_x310;
        const double var_x312 = 0.0014337722222222222 * var_x311;
        const double var_x313 = exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        ...
        const double var_x317 = Signum(var_x307);
        const double var_x318 = var_x317 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x319 = var_x318 * var_x4;
        const double var_x320 = var_x306 * var_x316;
        const double var_x321 = 2.2516516071905168e-7 * var_x320;
        const double var_x322 = var_chaste_interface__Irel__Ca_JSR > 50.0;
        const double var_x323 = var_chaste_interface__Irel__Ca_JSR < 90.0;
        const double var_x324 = (var_x322) && (var_x323) && (var_x61);
        const double var_x325 = 0.0014337722222222222 * var_x315;
        const double var_x326 = -977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR;
        const double var_x327 = var_x0 * var_x309;
        const double var_x328 = var_x326 * var_x327;
        const double var_x329 = 0.0014337722222222222 * var_x316;
        const double var_x330 = var_x316 * var_x326;
        const double var_x331 = 2.2516516071905168e-7 * var_x330;
        const double var_x332 = var_chaste_interface__Irel__Ca_JSR >= 90.0;
        const double var_x333 = (var_x332) && (var_x61);
        const double var_x334 = 0.0078521942756732046 * var_x65;
        const double var_x335 = fabs(var_x334 * var_chaste_interface__cell__V);
        const double var_x336 = var_x335 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x337 = var_x0 * var_x336;
        const double var_x338 = var_x306 * var_x337;
        const double var_x339 = 0.028675444444444444 * var_x316;
        const double var_x340 = var_x306 * var_x339;
        const double var_x341 = var_x334 + 5.916937454721214e-7 * var_x3 * var_x70 - 0.00059169374547212144 * var_x2 * var_x68;
        const double var_x342 = Signum(var_x79);
        const double var_x343 = var_x342 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x344 = var_x0 * var_x341 * var_x343;
        const double var_x345 = (var_x322) && (var_x323);
        const double var_x346 = var_x326 * var_x337;
        const double var_x347 = var_x326 * var_x339;
        const double var_x348 = var_x100 + var_x102 - var_x96;
        const double var_x349 = 1.0 / var_chaste_interface__Ca__Ca_NSR;
        const double var_x350 = var_x349 * var_chaste_interface__Irel__xir;
        const double var_x351 = ((var_x324) ? (-var_x310 * var_x339) : ((var_x333) ? (-var_x309 * var_x347) : ((var_x61) ? (0) : ((var_x345) ? (-var_x336 * var_x340) : ((var_x332) ? (-var_x336 * var_x347) : (0))))));
        const double var_x352 = 0.32403252222222223 * var_x316;
        const double var_x353 = var_x111 - var_x113 - var_chaste_interface__Irel__xir;
        const double var_x354 = var_x318 * var_x67;
        const double var_x355 = 2.9881008538774201e-6 * var_x354;
        const double var_x356 = var_x343 * var_x93;
        const double var_x357 = var_x116 - var_x114 - var_x115;
        const double var_x358 = (var_x349 * var_x357 - 1.0 * var_x353 / var_x97) * var_chaste_interface__Irel__xir;
        const double var_x359 = var_x0 * var_x308;
        const double var_x360 = var_x0 * var_x335;
        const double var_x361 = 0.0015 * var_x22;
        const double var_x362 = 9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca;
        const double var_x363 = var_x317 * var_x362;
        const double var_x364 = 7.8521942756732062e-6 * var_x3 * var_x363;
        const double var_x365 = 106.65141866666666 * var_x311;
        const double var_x366 = exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V);
        ...
        const double var_x370 = var_x306 * var_x369;
        const double var_x371 = 0.0023418558700973894 * var_x319;
        const double var_x372 = 106.65141866666666 * var_x328;
        const double var_x373 = var_x326 * var_x369;
        const double var_x374 = var_x342 * var_x362;
        const double var_x375 = var_x341 * var_x374;
        const double var_x376 = 106.65141866666666 * var_x338;
        const double var_x377 = 298.24222222222221 * var_x369;
        const double var_x378 = var_x306 * var_x377;
        const double var_x379 = 106.65141866666666 * var_x346;
        const double var_x380 = var_x326 * var_x377;
        const double var_x381 = -9000.0 * var_x308;
        const double var_x382 = -9000.0 * var_x335;
        const double var_x383 = ((var_x324) ? (var_x381 - var_x310 * var_x377) : ((var_x333) ? (var_x381 - var_x309 * var_x380) : ((var_x61) ? (var_x381) : ((var_x345) ? (var_x382 - var_x336 * var_x378) : ((var_x332) ? (var_x382 - var_x336 * var_x380) : (var_x382))))));
        const double var_x384 = 3370.1371111111112 * var_x369;
        const double var_x385 = 0.0310780828736964 * var_x354;
        const double var_x386 = 2.0 + 0.00010420416882000001 * var_x2 * var_x363;
        const double var_x387 = 0.0023418558700973894 * var_x356;
        const double var_x388 = 2.0 + 7.8521942756732062e-6 * var_x2 * var_x374 * var_x70;
        const double var_x389 = 42.0 * var_x47 + 0.20571624547590581 * var_x56;
        const double var_x390 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_submem;
        const double var_x391 = pow(var_x390, (-2));
        const double var_x392 = 1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem;
        const double var_x393 = pow(var_x392, (-2));
        const double var_x394 = 0.59999999999999998 + var_chaste_interface__Ca__Ca_submem;
        const double var_x395 = pow(var_x394, (-2));
        const double var_x396 = 1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem;
        const double var_x397 = pow(var_x396, (-2));
        const double var_x398 = 1 / (1.0 + 4.5 * var_x391 + 3.2307692307692308 * var_x393 + 28.199999999999999 * var_x395 + 3.4285714285714284 * var_x397);
        const double var_x399 = 1.0 * var_x398;
        const double var_x400 = 71.454967908626173 * var_x79;
        const double var_x401 = ((var_x61) ? (var_x399 * (-582.04072127761572 + 0.94825793626200006 * var_x3)) : (var_x398 * var_x400));
        const double var_x402 = 0.0327 * var_chaste_interface__Ca__trops;
        const double var_x403 = -14.789 + var_x402 + 3.4019999999999997 * var_x91 - 0.0011233033614805057 * var_x87 - 105649.152 * var_x90;
        const double var_x404 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
        const double var_x405 = 50.0 * var_chaste_interface__Irel__xir + 12500.0 * var_chaste_interface__Ca__Ca_i_converted + 0.019599999999999999 * var_chaste_interface__Ca__trops - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x404 * (70.0 - var_chaste_interface__Ca__trops) + 42.0 * var_x46 * var_x54;
        const double var_x406 = 0.0012574820180071425 * (9.0 / pow(var_x390, 3) + 56.399999999999999 / pow(var_x394, 3) + 0.97959183673469385 / pow(var_x396, 3) + 0.49704142011834318 / pow(var_x392, 3)) / pow((0.035460992907801421 + var_x395 + 0.15957446808510639 * var_x391 + 0.12158054711246201 * var_x397 + 0.11456628477905074 * var_x393), 2);
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x61) ? (var_x60 - 0.022865589730760374 * var_x4) : (var_x60 + 1.7230121868148176 * var_x69 - 22.865589730760373 * var_x66 - 0.0017230121868148176 * var_x71)));
        IJth(rJacobian, 2, 0) = ((var_x125) ? (var_x123 + var_x117 * var_x121 - 0.032000000000000001 * var_x117 * var_x119 * var_x124 / pow(var_x120, 2)) : (var_x123));
        IJth(rJacobian, 3, 0) = ((var_x130) ? ((-0.28123999999999999 * var_x127 - 108500.0 * var_x128) * var_chaste_interface__INa__xh - 0.14705882352941177 * var_x129 * (0.13500000000000001 - 0.13500000000000001 * var_chaste_interface__INa__xh)) : (-0.693000693000693 * var_x131 * var_chaste_interface__INa__xh / pow(var_x132, 2)));
        IJth(rJacobian, 4, 0) = ((var_x130) ? (var_x137 * var_x140 + 0.001275024 * var_x144 * var_chaste_interface__INa__xj + var_x133 * var_x146 * (1.5254334000000001e-6 * var_x135 - 31073.016 * var_x134) - 0.311 * var_x137 * var_x138 * var_x145 / pow(var_x139, 2) - 0.016701360000000002 * var_x141 * var_x143 * var_chaste_interface__INa__xj / pow(var_x142, 2)) : (7.6049999999999996e-8 * var_x150 * var_chaste_interface__INa__xj - 0.029999999999999999 * var_x147 * var_x149 * var_chaste_interface__INa__xj / pow(var_x148, 2)));
        IJth(rJacobian, 5, 0) = var_x155 + var_x154 * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 6, 0) = -var_x155 + var_x196 * var_chaste_interface__ICaL__xi2ba + var_x197 * var_chaste_interface__ICaL__xi2ca + (-var_x154 - var_x176 - var_x181 - var_x189 - var_x193) * var_chaste_interface__ICaL__c2 - var_x176 * var_chaste_interface__ICaL__xi2ba - var_x198 * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 7, 0) = var_x215 + var_x223 * var_x225 + var_x225 * var_x226 - var_x209 * var_x221 - var_x222 * var_chaste_interface__ICaL__xi2ca - 25.91645353793691 * var_x174 * var_x209 * var_x213 * var_x219;
        IJth(rJacobian, 8, 0) = var_x232 + var_x237 * var_chaste_interface__ICaL__xi2ba + var_x238 * var_chaste_interface__ICaL__xi2ba - var_x234 * var_chaste_interface__ICaL__xi2ba - var_x235 * var_chaste_interface__ICaL__xi2ba - var_x240 * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 9, 0) = -var_x215 + var_x189 * var_chaste_interface__ICaL__c2 + var_x193 * var_chaste_interface__ICaL__c2 + (var_x198 + var_x222 - var_x197 + 25.91645353793691 * var_x239 + var_x195 * var_x221 - var_x223 * var_x242 - var_x226 * var_x242) * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 10, 0) = -var_x232 + var_x176 * var_chaste_interface__ICaL__c2 + var_x181 * var_chaste_interface__ICaL__c2 + (var_x176 + var_x234 + var_x235 + var_x240 - var_x196 - var_x237 - var_x238) * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 11, 0) = ((var_x262) ? (var_x245 * (var_x250 + var_x255) + var_x259 * (var_x256 + var_x257)) : ((var_x260) ? (var_x245 * var_x250 + var_x259 * (0.0042068965517241376 + var_x257)) : ((var_x261) ? (var_x245 * var_x255 + var_x259 * (0.011219512195121951 + var_x256)) : (0.0020568544995794784 * var_x258))));
        IJth(rJacobian, 12, 0) = ((var_x269) ? (0.00014327258383033299 * var_x267) : (var_x283 * (var_x281 + var_x282) + (var_x270 - var_chaste_interface__IKs__xs1) * (var_x274 + var_x278 - 8.9997000000000013e-6 * var_x279 - 1.0641199999999999e-5 * var_x280)));
        IJth(rJacobian, 13, 0) = ((var_x269) ? (3.5818145957583247e-5 * var_x267) : (var_x283 * (var_x286 + var_x287) + (var_x270 - var_chaste_interface__IKs__xs2) * (var_x284 + var_x285 - 2.2499250000000003e-6 * var_x279 - 2.6602999999999998e-6 * var_x280)));
        IJth(rJacobian, 14, 0) = var_x292 * var_x295 + 0.0074074074074074077 * var_x289 * (var_x296 - var_chaste_interface__Ito__xtos) / (pow(var_x290, 2) * pow((0.055555555555555552 + var_x291), 2));
        IJth(rJacobian, 15, 0) = -var_x300 * var_x301 + 3.3333333333333335e-5 * var_x297 * (var_x302 - var_chaste_interface__Ito__ytos) / (pow(var_x298, 2) * pow((0.01 + var_x299), 2));
        IJth(rJacobian, 16, 0) = var_x295 * var_x304 + 0.00063492063492063492 * var_x303 * (var_x296 - var_chaste_interface__Ito__xtof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x303), 2);
        IJth(rJacobian, 17, 0) = -var_x301 * var_x305 + 0.0050000000000000001 * var_x59 * (var_x302 - var_chaste_interface__Ito__ytof) / pow((1 + var_x19), 2);
        IJth(rJacobian, 19, 0) = ((var_x324) ? (var_x312 * var_x315 + var_x319 * var_x321 - var_x312 * var_x316) : ((var_x333) ? (var_x319 * var_x331 + var_x325 * var_x328 - var_x328 * var_x329) : ((var_x61) ? (0) : ((var_x345) ? (var_x325 * var_x338 + var_x340 * var_x344 - var_x329 * var_x338) : ((var_x332) ? (var_x325 * var_x346 + var_x344 * var_x347 - var_x329 * var_x346) : (0))))));
        IJth(rJacobian, 20, 0) = -1.2342974728554348e-5 * var_x56 - 0.0025200000000000001 * var_x47 - 0.00044021739130434783 * var_x53 - var_x361 * var_chaste_interface__INa__xh;
        IJth(rJacobian, 21, 0) = ((var_x324) ? (var_x364 + var_x365 * var_x368 + var_x370 * var_x371 - var_x365 * var_x369) : ((var_x333) ? (var_x364 + var_x368 * var_x372 + var_x371 * var_x373 - var_x369 * var_x372) : ((var_x61) ? (var_x364) : ((var_x345) ? (var_x375 + var_x344 * var_x378 + var_x368 * var_x376 - var_x369 * var_x376) : ((var_x332) ? (var_x375 + var_x344 * var_x380 + var_x368 * var_x379 - var_x369 * var_x379) : (var_x375))))));
        IJth(rJacobian, 22, 0) = ((var_x61) ? (var_x399 * (var_x389 - 0.071454967908626169 * var_x4)) : (var_x399 * (var_x389 + 5.3844130837963045 * var_x69 - 0.0053844130837963052 * var_x71 - 71.454967908626173 * var_x66)));
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-4.1580000000000007e-11 * var_x73 * var_chaste_interface__IKs__xs2 / (pow(var_x29, 2) * pow(var_chaste_interface__Ca__Ca_i_converted, 4)));
        IJth(rJacobian, 1, 1) = var_x109 * (-2539.0 + var_x94 + var_x96 - var_x100 - var_x102) + 0.001 * (0.00033599999999999998 / pow(var_x103, 3) + 0.0010919999999999999 / pow(var_x104, 3) + 8.9999999999999985e-6 / pow(var_x105, 3) + 5.6399999999999995e-5 / pow(var_x106, 3)) * (var_x113 - var_x111 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x110 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x107, 2);
        IJth(rJacobian, 19, 1) = var_x348 * var_x350;
        IJth(rJacobian, 22, 1) = 12500.0 * var_x398;
        IJth(rJacobian, 23, 1) = var_x348;
        IJth(rJacobian, 24, 1) = 2289.0 - var_x94;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-36.0 * var_x77);
        IJth(rJacobian, 2, 2) = ((var_x125) ? (var_x126 - var_x121 * var_x124) : (-3.2000000000000002 + var_x126));
        IJth(rJacobian, 20, 2) = -0.0044999999999999997 * var_x77;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x23 * var_x75);
        IJth(rJacobian, 3, 3) = ((var_x130) ? (-310000.0 * var_x128 - 0.13500000000000001 * var_x129 - 3.5600000000000001 * var_x127) : (-7.6923076923076916 / var_x132));
        IJth(rJacobian, 20, 3) = -var_x361 * var_x75;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-12.0 * var_x78);
        IJth(rJacobian, 4, 4) = ((var_x130) ? (-0.1212 * var_x144 - var_x136 * var_x146) : (-0.29999999999999999 * var_x150));
        IJth(rJacobian, 20, 4) = -0.0015 * var_x78;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x80);
        IJth(rJacobian, 5, 5) = -4.3041299999999998 + var_x157 - 0.024167999999999999 * var_x160;
        IJth(rJacobian, 6, 5) = var_x200;
        IJth(rJacobian, 7, 5) = 0.0058991999999999968 * var_x160;
        IJth(rJacobian, 8, 5) = 0.0021800000000000001;
        IJth(rJacobian, 19, 5) = var_x351;
        IJth(rJacobian, 21, 5) = var_x383;
        IJth(rJacobian, 22, 5) = var_x401;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x80);
        IJth(rJacobian, 5, 6) = -3.0 + var_x157;
        IJth(rJacobian, 6, 6) = var_x199 - var_x201 - var_x202;
        IJth(rJacobian, 7, 6) = var_x227;
        IJth(rJacobian, 8, 6) = -0.0019499999999999999;
        IJth(rJacobian, 9, 6) = var_x202;
        IJth(rJacobian, 10, 6) = var_x201;
        IJth(rJacobian, 19, 6) = var_x351;
        IJth(rJacobian, 21, 6) = var_x383;
        IJth(rJacobian, 22, 6) = var_x401;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x80);
        IJth(rJacobian, 5, 7) = -2.999896385;
        IJth(rJacobian, 7, 7) = -0.33343694833333332 + var_x216 + var_x227 - 1.8929217120000003e-7 * var_x160 * var_x228;
        IJth(rJacobian, 8, 7) = -0.0019499999999999999;
        IJth(rJacobian, 9, 7) = var_x217;
        IJth(rJacobian, 19, 7) = var_x351;
        IJth(rJacobian, 21, 7) = var_x383;
        IJth(rJacobian, 22, 7) = var_x401;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x80);
        IJth(rJacobian, 5, 8) = -2.99776;
        IJth(rJacobian, 7, 8) = var_x227;
        IJth(rJacobian, 8, 8) = -0.33762909604519775 + var_x216;
        IJth(rJacobian, 10, 8) = var_x217;
        IJth(rJacobian, 19, 8) = var_x351;
        IJth(rJacobian, 21, 8) = var_x383;
        IJth(rJacobian, 22, 8) = var_x401;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x80);
        IJth(rJacobian, 5, 9) = -3.0;
        IJth(rJacobian, 6, 9) = var_x203;
        IJth(rJacobian, 7, 9) = var_x227 + var_x231;
        IJth(rJacobian, 8, 9) = -0.0019499999999999999;
        IJth(rJacobian, 9, 9) = -var_x203 - var_x231;
        IJth(rJacobian, 19, 9) = var_x351;
        IJth(rJacobian, 21, 9) = var_x383;
        IJth(rJacobian, 22, 9) = var_x401;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x80);
        IJth(rJacobian, 5, 10) = -3.0;
        IJth(rJacobian, 6, 10) = var_x204;
        IJth(rJacobian, 7, 10) = var_x227;
        IJth(rJacobian, 8, 10) = -0.0019499999999999999 + var_x241;
        IJth(rJacobian, 10, 10) = -var_x204 - var_x241;
        IJth(rJacobian, 19, 10) = var_x351;
        IJth(rJacobian, 21, 10) = var_x383;
        IJth(rJacobian, 22, 10) = var_x401;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x27 * var_x33 * NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 11, 11) = ((var_x262) ? (var_x263 + var_x264) : ((var_x260) ? (-0.0042068965517241376 + var_x264) : ((var_x261) ? (-0.011219512195121951 + var_x263) : (-0.015426408746846089))));
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x31 * var_x72);
        IJth(rJacobian, 12, 12) = ((var_x269) ? (-0.0023926521499665608) : (-var_x281 - var_x282));
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x30 * var_x73);
        IJth(rJacobian, 13, 13) = ((var_x269) ? (-0.00059816303749164019) : (-var_x286 - var_x287));
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x57 * (0.5 * var_x19 + var_chaste_interface__Ito__ytos) * NV_Ith_S(mParameters, 2));
        IJth(rJacobian, 14, 14) = -var_x292;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (var_x58);
        IJth(rJacobian, 15, 15) = -var_x300;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x81 * var_chaste_interface__Ito__ytof);
        IJth(rJacobian, 16, 16) = -var_x304;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x81 * var_chaste_interface__Ito__xtof);
        IJth(rJacobian, 17, 17) = -var_x305;
        IJth(rJacobian, 18, 18) = -0.01;
        IJth(rJacobian, 19, 18) = ((var_x324) ? (var_x327 * var_x339) : ((var_x333) ? (var_x327 * var_x352) : ((var_x61) ? (0) : ((var_x345) ? (var_x337 * var_x339) : ((var_x332) ? (var_x337 * var_x352) : (0))))));
        IJth(rJacobian, 21, 18) = ((var_x324) ? (var_x327 * var_x377) : ((var_x333) ? (var_x327 * var_x384) : ((var_x61) ? (0) : ((var_x345) ? (var_x337 * var_x377) : ((var_x332) ? (var_x337 * var_x384) : (0))))));
        IJth(rJacobian, 19, 19) = -0.033333333333333333 - var_x350 + var_x349 * var_x353;
        IJth(rJacobian, 22, 19) = 50.0 * var_x398;
        IJth(rJacobian, 23, 19) = -1;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (1.0436203813975009e-6 * var_x88 + 0.008152173913043478 * var_x84 - 1.173913043478261 * var_x83 - 318.49696580075846 * var_x85 - 36.287999999999997 * var_x89 + 0.00019591421434992582 * var_x32 * (17.737505194555091 + 0.0023223462158299631 * var_chaste_interface__Na__Na_i) / pow((1 + 0.00013092857142857142 * var_chaste_interface__Na__Na_i), 2));
        IJth(rJacobian, 20, 20) = 3.0570652173913045e-6 * var_x84 + 3.9135764302406278e-10 * var_x88 - 0.013608 * var_x89 - 0.00044021739130434783 * var_x83 - 0.039812120725094803 * var_x85;
        IJth(rJacobian, 22, 20) = var_x399 * (226.80000000000001 * var_x89 - 6.52262738373438e-6 * var_x88);
        IJth(rJacobian, 5, 21) = -var_x164;
        IJth(rJacobian, 6, 21) = var_x210 + (-var_x207 - var_x208) * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 7, 21) = var_x164 + (0.00063442013684210537 * var_x160 * var_x162 - 2.1032463466666669e-8 * var_x163 * var_x228) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x0 * var_x163;
        IJth(rJacobian, 9, 21) = -var_x210 + var_x207 * var_chaste_interface__ICaL__c2 + var_x208 * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 21, 21) = -2.0;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (((var_x61) ? (var_x92 - 0.30344253960384004 * var_x67) : (var_x92 - 0.022865589730760374 * var_x93)));
        IJth(rJacobian, 1, 22) = 0.00025000000000000001 * var_x108;
        IJth(rJacobian, 19, 22) = ((var_x324) ? (var_x320 * var_x355) : ((var_x333) ? (var_x330 * var_x355) : ((var_x61) ? (0) : ((var_x345) ? (var_x321 * var_x356) : ((var_x332) ? (var_x331 * var_x356) : (0))))));
        IJth(rJacobian, 20, 22) = 6.3389491199999997 * var_x90 + 6.7398201688830334e-8 * var_x87 - 0.00020411999999999996 * var_x91;
        IJth(rJacobian, 21, 22) = ((var_x324) ? (var_x386 + var_x370 * var_x385) : ((var_x333) ? (var_x386 + var_x373 * var_x385) : ((var_x61) ? (var_x386) : ((var_x345) ? (var_x388 + var_x370 * var_x387) : ((var_x332) ? (var_x388 + var_x373 * var_x387) : (var_x388))))));
        IJth(rJacobian, 22, 22) = ((var_x61) ? (var_x399 * (var_x403 - 0.94825793626200006 * var_x67) + var_x406 * (var_x405 - 9100.0 * var_x0 * var_x307)) : (var_x399 * (var_x403 - 0.071454967908626169 * var_x93) + var_x406 * (var_x405 - var_x0 * var_x400)));
        IJth(rJacobian, 25, 22) = 2.2890000000000001 - var_x402;
        IJth(rJacobian, 1, 23) = var_x109 * (var_x114 + var_x115 - var_x116);
        IJth(rJacobian, 18, 23) = 0.01;
        IJth(rJacobian, 19, 23) = ((var_x324) ? (var_x358 + var_x340 * var_x359) : ((var_x333) ? (var_x358 + var_x347 * var_x359) : ((var_x61) ? (var_x358) : ((var_x345) ? (var_x358 + var_x340 * var_x360) : ((var_x332) ? (var_x358 + var_x347 * var_x360) : (var_x358))))));
        IJth(rJacobian, 21, 23) = ((var_x324) ? (var_x359 * var_x378) : ((var_x333) ? (var_x359 * var_x380) : ((var_x61) ? (0) : ((var_x345) ? (var_x360 * var_x378) : ((var_x332) ? (var_x360 * var_x380) : (0))))));
        IJth(rJacobian, 23, 23) = var_x357;
        IJth(rJacobian, 1, 24) = var_x109 * (0.019599999999999999 + var_x110);
        IJth(rJacobian, 24, 24) = -0.019599999999999999 - var_x110;
        IJth(rJacobian, 22, 25) = var_x399 * (0.019599999999999999 + var_x404);
        IJth(rJacobian, 25, 25) = -0.019599999999999999 - var_x404;
    }
